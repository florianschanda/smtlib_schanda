...
(assert (= z ((_ to_fp 8 24) #x58B25171)))
;; z should be Float32(0x58B25171 [Rational(1568502863364096), 1568502863364096.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10110001 #b01100100101000101110001))))
(check-sat)
(exit)
