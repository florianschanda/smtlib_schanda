...
(assert (= z ((_ to_fp 8 24) #xCAA78405)))
;; z should be Float32(0xCAA78405 [Rational(-10978309, 2), -5489154.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010101 #b01001111000001111111101))))
(check-sat)
(exit)
