...
(assert (= z (fp #b0 #b00000000 #b10101001111000100101010)))
;; z should be Float32(0x0054F12A [Rational(2783381, 356811923176489970264571492362373784095686656), 0.000000])
