...
(assert (= z ((_ to_fp 8 24) #xCADE0E23)))
;; z should be Float32(0xCADE0E23 [Rational(-14552611, 2), -7276305.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010101 #b10111100000111000100011)))
(check-sat)
(exit)
