...
(assert (= x (fp #b0 #b00000000 #b01000111111011001000110)))
;; x should be Float32(0x0023F646 [Rational(1178403, 356811923176489970264571492362373784095686656), 0.000000])
