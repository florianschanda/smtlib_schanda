...
(assert (= x ((_ to_fp 8 24) #xCAB7B807)))
;; x should be Float32(0xCAB7B807 [Rational(-12040199, 2), -6020099.500000])
...
(assert (= result (fp #b0 #b00010111 #b01101111011100000001001)))
(check-sat)
(exit)
