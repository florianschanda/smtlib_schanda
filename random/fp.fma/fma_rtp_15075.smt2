...
(assert (= z ((_ to_fp 8 24) #x6E84D03A)))
;; z should be Float32(0x6E84D03A [Rational(20551875882076699189716189184), 20551875882076699189716189184.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x6E84D03A)))
(check-sat)
(exit)
