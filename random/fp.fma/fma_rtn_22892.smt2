...
(assert (= y (fp #b0 #b11010111 #b11100011100110000110011)))
;; y should be Float32(0x6BF1CC33 [Rational(584630852147157595829829632), 584630852147157595829829632.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x2171CC32))))
(check-sat)
(exit)
