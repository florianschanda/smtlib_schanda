...
(assert (= y ((_ to_fp 8 24) #x807D56EE)))
;; y should be Float32(0x807D56EE [Rational(-4107127, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b11110101010110111011011))))
(check-sat)
(exit)
