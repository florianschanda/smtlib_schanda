...
(assert (= z (fp #b1 #b00011011 #b01101010110110011111100)))
;; z should be Float32(0x8DB56CFC [Rational(-2972479, 2658455991569831745807614120560689152), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x8DB56CFC)))
(check-sat)
(exit)
