...
(assert (= x (fp #b1 #b00000000 #b00100000011111001011100)))
;; x should be Float32(0x80103E5C [Rational(-266135, 178405961588244985132285746181186892047843328), -0.000000])
