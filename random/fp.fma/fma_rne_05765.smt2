...
(assert (= y ((_ to_fp 8 24) #x7FB552AD)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b0 #b01100110 #b10011010110010111111111)))
;; z should be Float32(0x334D65FF [Rational(13460991, 281474976710656), 0.000000])
