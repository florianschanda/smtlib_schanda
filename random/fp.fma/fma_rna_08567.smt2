...
(assert (= z (fp #b1 #b00110111 #b10110100000000011010111)))
;; z should be Float32(0x9BDA00D7 [Rational(-14287063, 39614081257132168796771975168), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x9BDA00D7)))
(check-sat)
(exit)
