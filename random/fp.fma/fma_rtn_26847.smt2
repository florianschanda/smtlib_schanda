...
(assert (= x (fp #b1 #b00000000 #b01000100100010011111111)))
;; x should be Float32(0x802244FF [Rational(-2245887, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7FB2210D)))
