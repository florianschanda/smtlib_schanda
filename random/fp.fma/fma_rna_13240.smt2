...
(assert (= x (fp #b1 #b00000000 #b01001101111101000110010)))
;; x should be Float32(0x8026FA32 [Rational(-1277209, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result (fp #b0 #b01111111 #b00110111110100011000111)))
(check-sat)
(exit)
