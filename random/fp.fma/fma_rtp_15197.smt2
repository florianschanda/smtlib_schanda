...
(assert (= y (fp #b0 #b10010101 #b00111101111011110001011)))
;; y should be Float32(0x4A9EF78B [Rational(10418059, 2), 5209029.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b00111101111011110001010))))
(check-sat)
(exit)
