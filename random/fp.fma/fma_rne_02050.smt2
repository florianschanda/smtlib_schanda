...
(assert (= z ((_ to_fp 8 24) #xE5C49CEE)))
;; z should be Float32(0xE5C49CEE [Rational(-116059834053166272348160), -116059834053166272348160.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xE5C49CEE))))
(check-sat)
(exit)
