...
(assert (= y (fp #b1 #b00000000 #b10110011101010010110001)))
;; y should be Float32(0x8059D4B1 [Rational(-5887153, 713623846352979940529142984724747568191373312), -0.000000])
