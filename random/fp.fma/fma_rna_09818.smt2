...
(assert (= x (fp #b0 #b00000000 #b10101101100001000001011)))
;; x should be Float32(0x0056C20B [Rational(5685771, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result (fp #b0 #b10000000 #b01011011000010000010101)))
(check-sat)
(exit)
