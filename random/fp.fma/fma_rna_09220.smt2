...
(assert (= y (fp #b1 #b10010101 #b01000010000101100111111)))
;; y should be Float32(0xCAA10B3F [Rational(-10554175, 2), -5277087.500000])
...
(assert (= result (fp #b0 #b00000000 #b01011110111101001100000)))
(check-sat)
(exit)
