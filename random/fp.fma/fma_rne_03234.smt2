...
(assert (= x (fp #b0 #b00000000 #b00110010111100001010101)))
;; x should be Float32(0x00197855 [Rational(1669205, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b01000100101011011001011)))
