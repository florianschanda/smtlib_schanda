...
(assert (= x ((_ to_fp 8 24) #x7BEF916D)))
;; x should be Float32(0x7BEF916D [Rational(2487817068904134700486117340821323776), 2487817068904134700486117340821323776.000000])
