...
(assert (= x ((_ to_fp 8 24) #xDC8F13D7)))
;; x should be Float32(0xDC8F13D7 [Rational(-322181886468161536), -322181886468161536.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b11011111010110011101101)))
