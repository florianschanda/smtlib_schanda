...
(assert (= x ((_ to_fp 8 24) #xFC69983C)))
;; x should be Float32(0xFC69983C [Rational(-4851571391952482988849204958163107840), -4851571391952482988849204958163107840.000000])
...
(assert (= z (fp #b0 #b11111111 #b10111111110000000010010)))
