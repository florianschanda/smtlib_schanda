...
(assert (= x (fp #b1 #b00000000 #b00001100111111000011101)))
;; x should be Float32(0x80067E1D [Rational(-425501, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3E4FC39F))))
(check-sat)
(exit)
