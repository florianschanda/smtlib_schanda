...
(assert (= z ((_ to_fp 8 24) #x805C4EEC)))
;; z should be Float32(0x805C4EEC [Rational(-1512379, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x805C4EEC))))
(check-sat)
(exit)
