...
(assert (= y (fp #b0 #b10010101 #b10011011011011101011101)))
;; y should be Float32(0x4ACDB75D [Rational(13481821, 2), 6740910.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b00110010010010001010001))))
(check-sat)
(exit)
