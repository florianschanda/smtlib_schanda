...
(assert (= z ((_ to_fp 8 24) #x8016FCDB)))
;; z should be Float32(0x8016FCDB [Rational(-1506523, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b00000000 #b00101101111110011011011)))
(check-sat)
(exit)
