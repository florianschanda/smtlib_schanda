...
(assert (= y ((_ to_fp 8 24) #x623F4810)))
;; y should be Float32(0x623F4810 [Rational(882130192112220635136), 882130192112220635136.000000])
...
(assert (= result ((_ to_fp 8 24) #x233F4810)))
(check-sat)
(exit)
