...
(assert (= x ((_ to_fp 8 24) #xCA3EA1C2)))
;; x should be Float32(0xCA3EA1C2 [Rational(-6246625, 2), -3123312.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b10100000101011110001111))))
(check-sat)
(exit)
