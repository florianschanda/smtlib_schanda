...
(assert (= x (fp #b1 #b10010101 #b11101100100011000000011)))
;; x should be Float32(0xCAF64603 [Rational(-16139779, 2), -8069889.500000])
...
(assert (= z (fp #b0 #b11111111 #b11011001101001111001001)))
