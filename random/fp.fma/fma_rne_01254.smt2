...
(assert (= y ((_ to_fp 8 24) #x0000C197)))
;; y should be Float32(0x0000C197 [Rational(49559, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b01101100010101001001001)))
