...
(assert (= z ((_ to_fp 8 24) #x1E3697C3)))
;; z should be Float32(0x1E3697C3 [Rational(11966403, 1237940039285380274899124224), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x1E3697C3))))
(check-sat)
(exit)
