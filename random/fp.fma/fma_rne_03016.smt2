...
(assert (= x (fp #b0 #b00000000 #b10000100000000100011011)))
;; x should be Float32(0x0042011B [Rational(4325659, 713623846352979940529142984724747568191373312), 0.000000])
