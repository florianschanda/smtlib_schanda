...
(assert (= x ((_ to_fp 8 24) #x0024C81F)))
;; x should be Float32(0x0024C81F [Rational(2410527, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result (fp #b0 #b01111111 #b00100110010000001111011)))
(check-sat)
(exit)
