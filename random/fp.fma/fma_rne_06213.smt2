...
(assert (= x ((_ to_fp 8 24) #x803ABF13)))
;; x should be Float32(0x803ABF13 [Rational(-3850003, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= z (fp #b1 #b11111111 #b01010100101101100011000)))
