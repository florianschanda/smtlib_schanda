...
(assert (= x (fp #b1 #b00000000 #b00100101010111000001110)))
;; x should be Float32(0x8012AE0E [Rational(-612103, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result (fp #b0 #b01111110 #b00101010111000001110000)))
(check-sat)
(exit)
