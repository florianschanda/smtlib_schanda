...
(assert (= x (fp #b0 #b00100000 #b11010010110111111001101)))
;; x should be Float32(0x10696FCD [Rational(15298509, 332306998946228968225951765070086144), 0.000000])
...
(assert (not (= result (fp #b1 #b10100000 #b11010010110111111001101))))
(check-sat)
(exit)
