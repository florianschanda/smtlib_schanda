...
(assert (= x ((_ to_fp 8 24) #xB8EA0803)))
;; x should be Float32(0xB8EA0803 [Rational(-15337475, 137438953472), -0.000112])
...
(assert (not (= result (fp #b0 #b00000000 #b11111111111110001010111))))
(check-sat)
(exit)
