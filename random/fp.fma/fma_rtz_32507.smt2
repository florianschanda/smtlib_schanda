...
(assert (= z (fp #b1 #b01000101 #b00110001110010010110111)))
;; z should be Float32(0xA298E4B7 [Rational(-10020023, 2417851639229258349412352), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b01000101 #b00110001110010010110111))))
(check-sat)
(exit)
