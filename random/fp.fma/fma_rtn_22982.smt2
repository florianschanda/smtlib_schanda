...
(assert (= z (fp #b1 #b10010101 #b11011011110111100110111)))
;; z should be Float32(0xCAEDEF37 [Rational(-15593271, 2), -7796635.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAEDEF38))))
(check-sat)
(exit)
