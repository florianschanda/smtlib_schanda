...
(assert (= x (fp #b0 #b11111111 #b01111011111000101110111)))
...
(assert (= z (fp #b1 #b00000000 #b01011011011101001000101)))
;; z should be Float32(0x802DBA45 [Rational(-2996805, 713623846352979940529142984724747568191373312), -0.000000])
