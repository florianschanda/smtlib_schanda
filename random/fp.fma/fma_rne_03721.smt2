...
(assert (= x ((_ to_fp 8 24) #xCADD0BA7)))
;; x should be Float32(0xCADD0BA7 [Rational(-14486439, 2), -7243219.500000])
...
(assert (= result (fp #b1 #b00010111 #b10111010000101110100111)))
(check-sat)
(exit)
