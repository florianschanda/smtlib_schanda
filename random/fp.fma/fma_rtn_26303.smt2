...
(assert (= y (fp #b1 #b10101100 #b11101000100010110110110)))
;; y should be Float32(0xD67445B6 [Rational(-67145060843520), -67145060843520.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BF445B6))))
(check-sat)
(exit)
