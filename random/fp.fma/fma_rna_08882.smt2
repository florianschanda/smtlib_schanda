...
(assert (= z (fp #b0 #b00000000 #b11001101011110101001010)))
;; z should be Float32(0x0066BD4A [Rational(3366565, 356811923176489970264571492362373784095686656), 0.000000])
