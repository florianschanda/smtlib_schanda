...
(assert (= x (fp #b0 #b00000000 #b01011001100000010011011)))
;; x should be Float32(0x002CC09B [Rational(2932891, 713623846352979940529142984724747568191373312), 0.000000])
