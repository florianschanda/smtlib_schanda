...
(assert (= z ((_ to_fp 8 24) #xC9E54FD4)))
;; z should be Float32(0xC9E54FD4 [Rational(-3757045, 2), -1878522.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010011 #b11001010100111111010011))))
(check-sat)
(exit)
