...
(assert (= z ((_ to_fp 8 24) #x4CC9E84B)))
;; z should be Float32(0x4CC9E84B [Rational(105857624), 105857624.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10011001 #b10010011110100001001011)))
(check-sat)
(exit)
