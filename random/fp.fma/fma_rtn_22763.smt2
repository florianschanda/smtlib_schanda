...
(assert (= y ((_ to_fp 8 24) #x4A868B41)))
;; y should be Float32(0x4A868B41 [Rational(8817473, 2), 4408736.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b10000110100010110100000))))
(check-sat)
(exit)
