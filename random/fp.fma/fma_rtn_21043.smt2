...
(assert (= x (fp #b0 #b10010101 #b11011000000000111001011)))
;; x should be Float32(0x4AEC01CB [Rational(15466955, 2), 7733477.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b11011000000000111001011))))
(check-sat)
(exit)
