...
(assert (= y (fp #b0 #b00000000 #b00010101100000000001010)))
;; y should be Float32(0x000AC00A [Rational(352261, 356811923176489970264571492362373784095686656), 0.000000])
