...
(assert (= z ((_ to_fp 8 24) #xFC95E7E8)))
;; z should be Float32(0xFC95E7E8 [Rational(-6226846795790689294762379762378735616), -6226846795790689294762379762378735616.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xFC95E7E8))))
(check-sat)
(exit)
