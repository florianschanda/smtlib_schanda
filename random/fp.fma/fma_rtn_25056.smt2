...
(assert (= y (fp #b0 #b01000001 #b11111010100011111101001)))
;; y should be Float32(0x20FD47E9 [Rational(16599017, 38685626227668133590597632), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xE0FD47E9)))
(check-sat)
(exit)
