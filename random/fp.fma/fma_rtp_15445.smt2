...
(assert (= z ((_ to_fp 8 24) #xFC64E33E)))
;; z should be Float32(0xFC64E33E [Rational(-4753810811488182051520479955316113408), -4753810811488182051520479955316113408.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xFC64E33E))))
(check-sat)
(exit)
