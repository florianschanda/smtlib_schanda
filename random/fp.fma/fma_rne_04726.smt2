...
(assert (= y (fp #b0 #b10010101 #b11011110100000010110111)))
;; y should be Float32(0x4AEF40B7 [Rational(15679671, 2), 7839835.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8BEF40B7))))
(check-sat)
(exit)
