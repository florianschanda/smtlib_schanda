...
(assert (= x (fp #b0 #b10010100 #b00000010101100101010110)))
;; x should be Float32(0x4A015956 [Rational(4238507, 2), 2119253.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b01000000101011001010100))))
(check-sat)
(exit)
