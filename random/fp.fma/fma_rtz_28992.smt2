...
(assert (= z ((_ to_fp 8 24) #xA83B08B5)))
;; z should be Float32(0xA83B08B5 [Rational(-12257461, 1180591620717411303424), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b01010000 #b01110110000100010110100)))
(check-sat)
(exit)
