...
(assert (= z ((_ to_fp 8 24) #x8023055B)))
;; z should be Float32(0x8023055B [Rational(-2295131, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x8023055B))))
(check-sat)
(exit)
