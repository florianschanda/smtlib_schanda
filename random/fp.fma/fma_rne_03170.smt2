...
(assert (= x (fp #b0 #b00000000 #b11011011011101001111010)))
;; x should be Float32(0x006DBA7A [Rational(3595581, 356811923176489970264571492362373784095686656), 0.000000])
