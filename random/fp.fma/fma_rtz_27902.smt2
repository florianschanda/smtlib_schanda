...
(assert (= x (fp #b0 #b10010101 #b00001101001110111100001)))
;; x should be Float32(0x4A869DE1 [Rational(8822241, 2), 4411120.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0B869DE1))))
(check-sat)
(exit)
