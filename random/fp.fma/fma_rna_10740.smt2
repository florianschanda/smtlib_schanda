...
(assert (= x (fp #b1 #b10010101 #b11011010110010111011011)))
;; x should be Float32(0xCAED65DB [Rational(-15558107, 2), -7779053.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b11011010110010111011101))))
(check-sat)
(exit)
