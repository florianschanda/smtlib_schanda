...
(assert (= x (fp #b1 #b10010101 #b00010011011111011011101)))
;; x should be Float32(0xCA89BEDD [Rational(-9027293, 2), -4513646.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b00010011011111011011100))))
(check-sat)
(exit)
