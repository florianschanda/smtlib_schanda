...
(assert (= x (fp #b0 #b00000000 #b00101001001000010100110)))
;; x should be Float32(0x001490A6 [Rational(673875, 356811923176489970264571492362373784095686656), 0.000000])
