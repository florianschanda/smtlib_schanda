...
(assert (= x ((_ to_fp 8 24) #x0044ABA8)))
;; x should be Float32(0x0044ABA8 [Rational(562549, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x40095750))))
(check-sat)
(exit)
