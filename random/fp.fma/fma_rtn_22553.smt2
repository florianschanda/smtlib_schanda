...
(assert (= y (fp #b0 #b00000000 #b11110000101111010001110)))
;; y should be Float32(0x00785E8E [Rational(3944263, 356811923176489970264571492362373784095686656), 0.000000])
