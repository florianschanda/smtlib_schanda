...
(assert (= z ((_ to_fp 8 24) #xCADB7B5D)))
;; z should be Float32(0xCADB7B5D [Rational(-14383965, 2), -7191982.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10010101 #b10110110111101101011101)))
(check-sat)
(exit)
