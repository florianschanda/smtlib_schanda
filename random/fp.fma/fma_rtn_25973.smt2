...
(assert (= y ((_ to_fp 8 24) #x80376935)))
;; y should be Float32(0x80376935 [Rational(-3631413, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFC066D0)))
