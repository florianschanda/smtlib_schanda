...
(assert (= x (fp #b0 #b00000000 #b00111111101100001101001)))
;; x should be Float32(0x001FD869 [Rational(2087017, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b0 #b01111110 #b11111101100001101000111))))
(check-sat)
(exit)
