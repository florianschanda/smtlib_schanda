...
(assert (= x (fp #b0 #b11001010 #b10101100100010111110000)))
;; x should be Float32(0x655645F0 [Rational(63242284156109946093568), 63242284156109946093568.000000])
...
(assert (not (= result (fp #b0 #b01001100 #b10101100100010111110000))))
(check-sat)
(exit)
