...
(assert (= x (fp #b1 #b11100011 #b11111110001110101000010)))
;; x should be Float32(0xF1FF1D42 [Rational(-2526529536940789957359032074240), -2526529536940789957359032074240.000000])
