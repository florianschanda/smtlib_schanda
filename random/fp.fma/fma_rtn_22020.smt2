...
(assert (= y ((_ to_fp 8 24) #xFF8D06F5)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b00000000 #b10011000001111100011000)))
;; z should be Float32(0x804C1F18 [Rational(-623587, 89202980794122492566142873090593446023921664), -0.000000])
