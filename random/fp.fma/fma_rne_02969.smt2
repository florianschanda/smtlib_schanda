...
(assert (= x (fp #b0 #b00000000 #b01101100101011000101011)))
;; x should be Float32(0x0036562B [Rational(3561003, 713623846352979940529142984724747568191373312), 0.000000])
