...
(assert (= y (fp #b0 #b00000000 #b00001000101001110010110)))
;; y should be Float32(0x00045396 [Rational(141771, 356811923176489970264571492362373784095686656), 0.000000])
