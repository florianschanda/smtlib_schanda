...
(assert (= z (fp #b1 #b01010100 #b01101100001011101101010)))
;; z should be Float32(0xAA36176A [Rational(-5966773, 36893488147419103232), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b01010100 #b01101100001011101101010))))
(check-sat)
(exit)
