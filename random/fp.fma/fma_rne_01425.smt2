...
(assert (= y ((_ to_fp 8 24) #x807F8E6E)))
;; y should be Float32(0x807F8E6E [Rational(-4179767, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b00100100100001010011001)))
