...
(assert (= z ((_ to_fp 8 24) #x48CF2319)))
;; z should be Float32(0x48CF2319 [Rational(13574937, 32), 424216.781250])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10010001 #b10011110010001100011010)))
(check-sat)
(exit)
