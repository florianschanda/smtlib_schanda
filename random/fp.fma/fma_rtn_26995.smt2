...
(assert (= x (fp #b1 #b00000000 #b10101111010101000000110)))
;; x should be Float32(0x8057AA06 [Rational(-2872579, 356811923176489970264571492362373784095686656), -0.000000])
