...
(assert (= y ((_ to_fp 8 24) #x8025ABB3)))
;; y should be Float32(0x8025ABB3 [Rational(-2468787, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3F96AECB))))
(check-sat)
(exit)
