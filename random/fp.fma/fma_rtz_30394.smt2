...
(assert (= x (fp #b0 #b00000000 #b00010010010010111101110)))
;; x should be Float32(0x000925EE [Rational(299767, 356811923176489970264571492362373784095686656), 0.000000])
