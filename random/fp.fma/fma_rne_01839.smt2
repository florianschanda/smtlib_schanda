...
(assert (= y (fp #b0 #b10010101 #b11010001101011010001011)))
;; y should be Float32(0x4AE8D68B [Rational(15259275, 2), 7629637.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BE8D689))))
(check-sat)
(exit)
