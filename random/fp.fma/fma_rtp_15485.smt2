...
(assert (= y (fp #b1 #b00111110 #b10000010001001110001110)))
;; y should be Float32(0x9F41138E [Rational(-6326727, 154742504910672534362390528), -0.000000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b11101010101100000110111)))
