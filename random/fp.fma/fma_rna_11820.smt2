...
(assert (= z ((_ to_fp 8 24) #x4AEAE337)))
;; z should be Float32(0x4AEAE337 [Rational(15393591, 2), 7696795.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11010101110001100110111))))
(check-sat)
(exit)
