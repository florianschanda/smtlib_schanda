...
(assert (= x (fp #b1 #b01101010 #b11010101000101110110100)))
;; x should be Float32(0xB56A8BB4 [Rational(-3842797, 4398046511104), -0.000001])
...
(assert (not (= result ((_ to_fp 8 24) #x00800006))))
(check-sat)
(exit)
