...
(assert (= z (fp #b0 #b00000000 #b11101010000010001011101)))
;; z should be Float32(0x0075045D [Rational(7668829, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00000000 #b11101010000010001011110)))
(check-sat)
(exit)
