...
(assert (= z (fp #b0 #b00000000 #b11000100110010010001001)))
;; z should be Float32(0x00626489 [Rational(6448265, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x00626489))))
(check-sat)
(exit)
