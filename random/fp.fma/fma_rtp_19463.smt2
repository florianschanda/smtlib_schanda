...
(assert (= y (fp #b1 #b00000000 #b11000011010011110011110)))
;; y should be Float32(0x8061A79E [Rational(-3199951, 356811923176489970264571492362373784095686656), -0.000000])
