...
(assert (= x (fp #b1 #b00000000 #b01110001000101011001010)))
;; x should be Float32(0x80388ACA [Rational(-1852773, 356811923176489970264571492362373784095686656), -0.000000])
