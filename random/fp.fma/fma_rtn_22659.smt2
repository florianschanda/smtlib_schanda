...
(assert (= z (fp #b1 #b10010101 #b11011111101100011001111)))
;; z should be Float32(0xCAEFD8CF [Rational(-15718607, 2), -7859303.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAEFD8D0))))
(check-sat)
(exit)
