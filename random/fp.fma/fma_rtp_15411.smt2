...
(assert (= z ((_ to_fp 8 24) #x49AE6134)))
;; z should be Float32(0x49AE6134 [Rational(2857037, 2), 1428518.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010011 #b01011100110000100110100))))
(check-sat)
(exit)
