...
(assert (= z (fp #b1 #b01101110 #b10111101101010001011111)))
;; z should be Float32(0xB75ED45F [Rational(-14603359, 1099511627776), -0.000013])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b01101110 #b10111101101010001011111))))
(check-sat)
(exit)
