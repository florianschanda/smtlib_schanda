...
(assert (= z (fp #b0 #b00000000 #b11100000110100100110100)))
;; z should be Float32(0x00706934 [Rational(1841741, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00000000 #b11100000110100100110100)))
(check-sat)
(exit)
