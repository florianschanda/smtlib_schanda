...
(assert (= z ((_ to_fp 8 24) #x8060DB12)))
;; z should be Float32(0x8060DB12 [Rational(-3173769, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b00000000 #b11000001101101100010001))))
(check-sat)
(exit)
