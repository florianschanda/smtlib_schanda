...
(assert (= z ((_ to_fp 8 24) #xE222E2C3)))
;; z should be Float32(0xE222E2C3 [Rational(-751178110953494413312), -751178110953494413312.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b11000100 #b01000101110001011000010))))
(check-sat)
(exit)
