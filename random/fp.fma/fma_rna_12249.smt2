...
(assert (= y (fp #b1 #b00000000 #b00100111101011000000110)))
;; y should be Float32(0x8013D606 [Rational(-649987, 356811923176489970264571492362373784095686656), -0.000000])
