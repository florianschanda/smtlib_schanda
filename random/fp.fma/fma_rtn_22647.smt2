...
(assert (= z ((_ to_fp 8 24) #x804E6819)))
;; z should be Float32(0x804E6819 [Rational(-5138457, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x804E681A)))
(check-sat)
(exit)
