...
(assert (= y (fp #b1 #b11111111 #b01000000100100000011011)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b0 #b00011010 #b00101110101000101001000)))
;; z should be Float32(0x0D175148 [Rational(1239593, 2658455991569831745807614120560689152), 0.000000])
