...
(assert (= z (fp #b1 #b10010000 #b11011111000110100100000)))
;; z should be Float32(0xC86F8D20 [Rational(-490601, 2), -245300.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b10010000 #b11011111000110000100000)))
(check-sat)
(exit)
