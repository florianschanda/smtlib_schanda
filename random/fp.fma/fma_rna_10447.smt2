...
(assert (= y (fp #b1 #b00000000 #b10111001100011101010100)))
;; y should be Float32(0x805CC754 [Rational(-1520085, 178405961588244985132285746181186892047843328), -0.000000])
