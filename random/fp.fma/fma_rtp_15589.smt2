...
(assert (= z (fp #b0 #b00000000 #b01110001001101110100001)))
;; z should be Float32(0x00389BA1 [Rational(3709857, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10000001 #b00000000000000000000000)))
(check-sat)
(exit)
