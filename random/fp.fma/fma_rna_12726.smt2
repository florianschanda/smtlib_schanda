...
(assert (= x (fp #b1 #b11110110 #b01001101100010000010000)))
;; x should be Float32(0xFB26C410 [Rational(-865897898449697341968557548605800448), -865897898449697341968557548605800448.000000])
...
(assert (= result ((_ to_fp 8 24) #xBC26C40F)))
(check-sat)
(exit)
