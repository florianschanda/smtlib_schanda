...
(assert (= y (fp #b1 #b01101111 #b01010111100010101101101)))
;; y should be Float32(0xB7ABC56D [Rational(-11257197, 549755813888), -0.000020])
...
(assert (not (= result (fp #b1 #b00000000 #b00000000000000010101101))))
(check-sat)
(exit)
