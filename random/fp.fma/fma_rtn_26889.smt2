...
(assert (= x (fp #b1 #b00000000 #b10001001000000000110010)))
;; x should be Float32(0x80448032 [Rational(-2244633, 356811923176489970264571492362373784095686656), -0.000000])
