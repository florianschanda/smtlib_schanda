...
(assert (= y ((_ to_fp 8 24) #x80060F0B)))
;; y should be Float32(0x80060F0B [Rational(-397067, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result (fp #b0 #b01111100 #b10000011110000101100000))))
(check-sat)
(exit)
