...
(assert (= z ((_ to_fp 8 24) #x64AE82C7)))
;; z should be Float32(0x64AE82C7 [Rational(25753255756566064267264), 25753255756566064267264.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x64AE82C6))))
(check-sat)
(exit)
