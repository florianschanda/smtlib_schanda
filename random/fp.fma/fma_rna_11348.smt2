...
(assert (= y ((_ to_fp 8 24) #x0055292C)))
;; y should be Float32(0x0055292C [Rational(1395275, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b01010100101001001010111))))
(check-sat)
(exit)
