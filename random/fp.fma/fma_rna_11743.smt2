...
(assert (= y (fp #b1 #b10010101 #b11110110010110011000011)))
;; y should be Float32(0xCAFB2CC3 [Rational(-16460995, 2), -8230497.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b11110110010110011000001))))
(check-sat)
(exit)
