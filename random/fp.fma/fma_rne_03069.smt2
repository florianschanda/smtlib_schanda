...
(assert (= x (fp #b0 #b00000000 #b11101011000100010000100)))
;; x should be Float32(0x00758884 [Rational(1925665, 178405961588244985132285746181186892047843328), 0.000000])
