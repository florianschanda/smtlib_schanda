...
(assert (= x ((_ to_fp 8 24) #x807D456D)))
;; x should be Float32(0x807D456D [Rational(-8209773, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b1 #b10000000 #b11110101000101011011010)))
(check-sat)
(exit)
