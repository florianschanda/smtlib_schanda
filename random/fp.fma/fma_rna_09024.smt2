...
(assert (= y ((_ to_fp 8 24) #xFFFD947C)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b00000000 #b01010001111100101100111)))
;; z should be Float32(0x8028F967 [Rational(-2685287, 713623846352979940529142984724747568191373312), -0.000000])
