...
(assert (= x (fp #b1 #b00000000 #b11000100101111011110010)))
;; x should be Float32(0x80625EF2 [Rational(-3223417, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result (fp #b1 #b10000000 #b10001001011110111100011)))
(check-sat)
(exit)
