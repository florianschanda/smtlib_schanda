...
(assert (= y ((_ to_fp 8 24) #xF95CB001)))
;; y should be Float32(0xF95CB001 [Rational(-71617193262254205408478843887419392), -71617193262254205408478843887419392.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x2EDCB001))))
(check-sat)
(exit)
