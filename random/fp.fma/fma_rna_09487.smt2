...
(assert (= x ((_ to_fp 8 24) #x76A2CAA4)))
;; x should be Float32(0x76A2CAA4 [Rational(1650902600080531352732310725197824), 1650902600080531352732310725197824.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x37A2CAA4))))
(check-sat)
(exit)
