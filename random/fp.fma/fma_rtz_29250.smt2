...
(assert (= z ((_ to_fp 8 24) #x007499EC)))
;; z should be Float32(0x007499EC [Rational(1910395, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x007499EC)))
(check-sat)
(exit)
