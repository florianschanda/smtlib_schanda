...
(assert (= z (fp #b0 #b00000000 #b11001001001010011100001)))
;; z should be Float32(0x006494E1 [Rational(6591713, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x006494E1)))
(check-sat)
(exit)
