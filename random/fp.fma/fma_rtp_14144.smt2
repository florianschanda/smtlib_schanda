...
(assert (= x ((_ to_fp 8 24) #x4ABD4A75)))
;; x should be Float32(0x4ABD4A75 [Rational(12405365, 2), 6202682.500000])
...
(assert (= z ((_ to_fp 8 24) #x4DB3DD59)))
;; z should be Float32(0x4DB3DD59 [Rational(377203488), 377203488.000000])
