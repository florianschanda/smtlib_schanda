...
(assert (= z (fp #b1 #b00111111 #b00000110001000101110111)))
;; z should be Float32(0x9F831177 [Rational(-8589687, 154742504910672534362390528), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b00111111 #b00000110001000101110111)))
(check-sat)
(exit)
