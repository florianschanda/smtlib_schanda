...
(assert (= x (fp #b1 #b10010101 #b11110101101011100100101)))
;; x should be Float32(0xCAFAD725 [Rational(-16439077, 2), -8219538.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b11111010110101110010011))))
(check-sat)
(exit)
