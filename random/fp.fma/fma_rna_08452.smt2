...
(assert (= y (fp #b0 #b01110000 #b00111110011110110111000)))
;; y should be Float32(0x381F3DB8 [Rational(1304503, 34359738368), 0.000038])
...
(assert (not (= result (fp #b0 #b00000000 #b00000000000000100111101))))
(check-sat)
(exit)
