...
(assert (= x ((_ to_fp 8 24) #xFC5742A1)))
;; x should be Float32(0xFC5742A1 [Rational(-4470780877411974987761559159772807168), -4470780877411974987761559159772807168.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xB1D742A1))))
(check-sat)
(exit)
