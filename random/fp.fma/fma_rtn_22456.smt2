...
(assert (= z (fp #b1 #b11000110 #b11110110010110101010001)))
;; z should be Float32(0xE37B2D51 [Rational(-4633398153705917775872), -4633398153705917775872.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xE37B2D51))))
(check-sat)
(exit)
