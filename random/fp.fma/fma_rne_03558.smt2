...
(assert (= y (fp #b1 #b11011100 #b10100101100001001000011)))
;; y should be Float32(0xEE52C243 [Rational(-16306675017510513689581584384), -16306675017510513689581584384.000000])
