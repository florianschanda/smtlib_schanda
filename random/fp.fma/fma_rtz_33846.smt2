...
(assert (= x (fp #b1 #b00000000 #b10001100110110000001111)))
;; x should be Float32(0x80466C0F [Rational(-4615183, 713623846352979940529142984724747568191373312), -0.000000])
