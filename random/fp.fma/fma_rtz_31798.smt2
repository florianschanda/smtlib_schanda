...
(assert (= y (fp #b0 #b10010101 #b10011000000101011101111)))
;; y should be Float32(0x4ACC0AEF [Rational(13372143, 2), 6686071.500000])

(declare-const z Float32)
(assert (= z (fp #b1 #b10010101 #b00010101110101001001011)))
;; z should be Float32(0xCA8AEA4B [Rational(-9103947, 2), -4551973.500000])
