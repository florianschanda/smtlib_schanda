...
(assert (= y ((_ to_fp 8 24) #xFFAE4968)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b0 #b11011000 #b01010001101011011101000)))
;; z should be Float32(0x6C28D6E8 [Rational(816457615068867624169373696), 816457615068867624169373696.000000])
