...
(assert (= z (fp #b1 #b01100111 #b00000111000111101011101)))
;; z should be Float32(0xB3838F5D [Rational(-8621917, 140737488355328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xB3838F5D))))
(check-sat)
(exit)
