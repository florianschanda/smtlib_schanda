...
(assert (= z ((_ to_fp 8 24) #x1E50AB16)))
;; z should be Float32(0x1E50AB16 [Rational(6837643, 618970019642690137449562112), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x1E50AB17))))
(check-sat)
(exit)
