...
(assert (= z (fp #b1 #b10010010 #b10101010101111001001000)))
;; z should be Float32(0xC9555E48 [Rational(-1747913, 2), -873956.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10010010 #b10101010101111001001001)))
(check-sat)
(exit)
