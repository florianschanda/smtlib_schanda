...
(assert (= z (fp #b0 #b10010101 #b11110101000010100100011)))
;; z should be Float32(0x4AFA8523 [Rational(16418083, 2), 8209041.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b10010101 #b11110101000010100100011)))
(check-sat)
(exit)
