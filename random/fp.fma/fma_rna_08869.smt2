...
(assert (= y ((_ to_fp 8 24) #xCAF77561)))
;; y should be Float32(0xCAF77561 [Rational(-16217441, 2), -8108720.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b11101110111010101100011))))
(check-sat)
(exit)
