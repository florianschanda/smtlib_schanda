...
(assert (= z ((_ to_fp 8 24) #x004F34CF)))
;; z should be Float32(0x004F34CF [Rational(5190863, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b00000000 #b10011110011010011001111)))
(check-sat)
(exit)
