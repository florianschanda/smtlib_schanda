...
(assert (= x (fp #b0 #b10010011 #b10010001111110011101100)))
;; x should be Float32(0x49C8FCEC [Rational(3292987, 2), 1646493.500000])
...
(assert (= result (fp #b1 #b00010101 #b10010001111110011110011)))
(check-sat)
(exit)
