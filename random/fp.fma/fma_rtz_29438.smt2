...
(assert (= y ((_ to_fp 8 24) #xCA4473C2)))
;; y should be Float32(0xCA4473C2 [Rational(-6437345, 2), -3218672.500000])
...
(assert (not (= result (fp #b1 #b00010110 #b10001000111001111000001))))
(check-sat)
(exit)
