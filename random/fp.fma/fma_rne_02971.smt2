...
(assert (= x (fp #b0 #b00000000 #b01000011001100111000011)))
;; x should be Float32(0x002199C3 [Rational(2202051, 713623846352979940529142984724747568191373312), 0.000000])
