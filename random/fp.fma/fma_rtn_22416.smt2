...
(assert (= y (fp #b0 #b10010101 #b11111111001110101100101)))
;; y should be Float32(0x4AFF9D65 [Rational(16751973, 2), 8375986.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BFF9D63))))
(check-sat)
(exit)
