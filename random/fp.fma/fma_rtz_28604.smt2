...
(assert (= z (fp #b0 #b00000000 #b11010111001101001000110)))
;; z should be Float32(0x006B9A46 [Rational(3525923, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x407FFFFD))))
(check-sat)
(exit)
