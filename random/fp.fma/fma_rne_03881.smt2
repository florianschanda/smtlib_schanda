...
(assert (= x (fp #b1 #b10010101 #b00100101010010101001101)))
;; x should be Float32(0xCA92A54D [Rational(-9610573, 2), -4805286.500000])
...
(assert (= result (fp #b0 #b00010111 #b00100101010010101001111)))
(check-sat)
(exit)
