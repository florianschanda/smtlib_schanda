...
(assert (= x (fp #b1 #b10010101 #b00110101110101110011011)))
;; x should be Float32(0xCA9AEB9B [Rational(-10152859, 2), -5076429.500000])
...
(assert (= result ((_ to_fp 8 24) #x80328A32)))
(check-sat)
(exit)
