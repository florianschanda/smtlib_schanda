...
(assert (= x (fp #b1 #b00000000 #b11011000011010110000010)))
;; x should be Float32(0x806C3582 [Rational(-3545793, 356811923176489970264571492362373784095686656), -0.000000])
