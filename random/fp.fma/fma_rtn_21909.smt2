...
(assert (= z (fp #b0 #b10010101 #b10100101001111001000101)))
;; z should be Float32(0x4AD29E45 [Rational(13803077, 2), 6901538.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b10100101001111000111101)))
(check-sat)
(exit)
