...
(assert (= x (fp #b0 #b10101010 #b00101110110111011110011)))
;; x should be Float32(0x55176EF3 [Rational(10406423691264), 10406423691264.000000])
...
(assert (= z ((_ to_fp 8 24) #xFF9E1425)))
