...
(assert (= x (fp #b0 #b11011111 #b10110010101000111011001)))
;; x should be Float32(0x6FD951D9 [Rational(134514389752294895178880122880), 134514389752294895178880122880.000000])
