...
(assert (= z ((_ to_fp 8 24) #xFCB48A30)))
;; z should be Float32(0xFCB48A30 [Rational(-7499329680106988706737588400373628928), -7499329680106988706737588400373628928.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b11111001 #b01101001000101000110000))))
(check-sat)
(exit)
