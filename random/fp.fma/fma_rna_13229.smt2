...
(assert (= x (fp #b1 #b00000000 #b01111110111000110111110)))
;; x should be Float32(0x803F71BE [Rational(-2078943, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3FFDC6F7)))
(check-sat)
(exit)
