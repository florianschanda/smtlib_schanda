...
(assert (= z (fp #b1 #b00000000 #b01111011101000010111010)))
;; z should be Float32(0x803DD0BA [Rational(-2025565, 356811923176489970264571492362373784095686656), -0.000000])
