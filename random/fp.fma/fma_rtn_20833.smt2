...
(assert (= z ((_ to_fp 8 24) #x006DABA8)))
;; z should be Float32(0x006DABA8 [Rational(898421, 89202980794122492566142873090593446023921664), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x006DABA8))))
(check-sat)
(exit)
