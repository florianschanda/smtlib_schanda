...
(assert (= x ((_ to_fp 8 24) #x87A82DBD)))
;; x should be Float32(0x87A82DBD [Rational(-11021757, 43556142965880123323311949751266331066368), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7FE4095C)))
