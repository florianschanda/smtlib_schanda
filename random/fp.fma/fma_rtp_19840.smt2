...
(assert (= x ((_ to_fp 8 24) #xE0FBE1D2)))
;; x should be Float32(0xE0FBE1D2 [Rational(-145200150965773139968), -145200150965773139968.000000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b00110010011011100000111)))
