...
(assert (= y (fp #b1 #b01010001 #b00010111111101001101111)))
;; y should be Float32(0xA88BFA6F [Rational(-9173615, 590295810358705651712), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xE88BFA6E))))
(check-sat)
(exit)
