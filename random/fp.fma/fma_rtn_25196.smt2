...
(assert (= z (fp #b0 #b10010101 #b11001011001001001010101)))
;; z should be Float32(0x4AE59255 [Rational(15045205, 2), 7522602.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b11001011001001001010101)))
(check-sat)
(exit)
