...
(assert (= z (fp #b1 #b00000000 #b11101110101000111100111)))
;; z should be Float32(0x807751E7 [Rational(-7819751, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x807751E6)))
(check-sat)
(exit)
