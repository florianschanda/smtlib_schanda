...
(assert (= z (fp #b1 #b01001001 #b11001011101101111001000)))
;; z should be Float32(0xA4E5DBC8 [Rational(-1883001, 18889465931478580854784), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xA4E5DBC8))))
(check-sat)
(exit)
