...
(assert (= y ((_ to_fp 8 24) #x9F94E47E)))
;; y should be Float32(0x9F94E47E [Rational(-4878911, 77371252455336267181195264), -0.000000])
...
(assert (= result (fp #b1 #b10111111 #b00101001110010001111101)))
(check-sat)
(exit)
