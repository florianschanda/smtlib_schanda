...
(assert (= z (fp #b0 #b10111001 #b10111111111101001111100)))
;; z should be Float32(0x5CDFFA7C [Rational(504354642314919936), 504354642314919936.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10111001 #b10111111111101001111100))))
(check-sat)
(exit)
