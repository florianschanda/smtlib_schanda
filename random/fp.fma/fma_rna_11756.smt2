...
(assert (= y (fp #b1 #b10010101 #b01001010100101011110101)))
;; y should be Float32(0xCAA54AF5 [Rational(-10832629, 2), -5416314.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b01001010100101011110010))))
(check-sat)
(exit)
