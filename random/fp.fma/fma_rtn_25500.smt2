...
(assert (= z (fp #b0 #b10010101 #b00000011101101110001011)))
;; z should be Float32(0x4A81DB8B [Rational(8510347, 2), 4255173.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b00000011101101110010010)))
(check-sat)
(exit)
