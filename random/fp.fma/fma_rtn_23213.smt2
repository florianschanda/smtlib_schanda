...
(assert (= x (fp #b0 #b00000010 #b11011001011101110110101)))
;; x should be Float32(0x016CBBB5 [Rational(15514549, 356811923176489970264571492362373784095686656), 0.000000])
