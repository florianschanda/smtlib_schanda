...
(assert (= z (fp #b0 #b10010101 #b10000010100011111111001)))
;; z should be Float32(0x4AC147F9 [Rational(12666873, 2), 6333436.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10010101 #b10000010100011111111001)))
(check-sat)
(exit)
