...
(assert (= x (fp #b0 #b11110110 #b00000101111110111101000)))
;; x should be Float32(0x7B02FDE8 [Rational(680148422172954773652544879570452480), 680148422172954773652544879570452480.000000])
