...
(assert (= z ((_ to_fp 8 24) #x6F2BE71E)))
;; z should be Float32(0x6F2BE71E [Rational(53201340214775472180651098112), 53201340214775472180651098112.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b11011110 #b01010111110011100011110))))
(check-sat)
(exit)
