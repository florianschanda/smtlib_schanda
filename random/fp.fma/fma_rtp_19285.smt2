...
(assert (= y ((_ to_fp 8 24) #x13538F21)))
;; y should be Float32(0x13538F21 [Rational(13864737, 5192296858534827628530496329220096), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFB5D91D)))
