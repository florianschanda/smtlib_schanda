...
(assert (= z ((_ to_fp 8 24) #x4AEFF453)))
;; z should be Float32(0x4AEFF453 [Rational(15725651, 2), 7862825.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010101 #b11011111111010001010011)))
(check-sat)
(exit)
