...
(assert (= y (fp #b0 #b11111111 #b10100011000100110100011)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x0B45ABD2)))
;; z should be Float32(0x0B45ABD2 [Rational(6477289, 170141183460469231731687303715884105728), 0.000000])
