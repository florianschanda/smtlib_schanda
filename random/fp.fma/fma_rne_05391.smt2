...
(assert (= y (fp #b1 #b00000000 #b00101010101010101110110)))
;; y should be Float32(0x80155576 [Rational(-699067, 356811923176489970264571492362373784095686656), -0.000000])
