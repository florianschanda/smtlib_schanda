...
(assert (= z (fp #b0 #b10001010 #b01110100111111110100011)))
;; z should be Float32(0x453A7FA3 [Rational(12222371, 4096), 2983.977295])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x453A3FA3))))
(check-sat)
(exit)
