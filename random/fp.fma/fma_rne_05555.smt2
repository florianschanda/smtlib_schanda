...
(assert (= y ((_ to_fp 8 24) #x6BA6AE5F)))
;; y should be Float32(0x6BA6AE5F [Rational(403010260529469527351623680), 403010260529469527351623680.000000])
...
(assert (not (= result (fp #b1 #b01000010 #b01001101010111001011111))))
(check-sat)
(exit)
