...
(assert (= x (fp #b1 #b00011110 #b10010000111011010001100)))
;; x should be Float32(0x8F48768C [Rational(-3284387, 332306998946228968225951765070086144), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x4F48768B))))
(check-sat)
(exit)
