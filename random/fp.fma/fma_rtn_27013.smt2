...
(assert (= x (fp #b1 #b00000000 #b00010110100100011101010)))
;; x should be Float32(0x800B48EA [Rational(-369781, 356811923176489970264571492362373784095686656), -0.000000])
