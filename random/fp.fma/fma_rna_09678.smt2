...
(assert (= x ((_ to_fp 8 24) #x5AD010D7)))
;; x should be Float32(0x5AD010D7 [Rational(29282655379914752), 29282655379914752.000000])
...
(assert (= result (fp #b1 #b00100000 #b10100000001000011010111)))
(check-sat)
(exit)
