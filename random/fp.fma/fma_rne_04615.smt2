...
(assert (= z ((_ to_fp 8 24) #xFC0C20A0)))
;; z should be Float32(0xFC0C20A0 [Rational(-2910333095232780014967403060656078848), -2910333095232780014967403060656078848.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xFC0C20A0))))
(check-sat)
(exit)
