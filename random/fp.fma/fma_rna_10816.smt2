...
(assert (= x (fp #b1 #b10001111 #b11010000000101011000000)))
;; x should be Float32(0xC7E80AC0 [Rational(-237611, 2), -118805.500000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b11010001110001110011100)))
