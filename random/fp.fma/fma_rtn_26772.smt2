...
(assert (= x ((_ to_fp 8 24) #x80512FFA)))
;; x should be Float32(0x80512FFA [Rational(-2660349, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result (fp #b1 #b10000000 #b01000100101111111110100)))
(check-sat)
(exit)
