...
(assert (= x (fp #b0 #b10010101 #b00110100100011011111001)))
;; x should be Float32(0x4A9A46F9 [Rational(10110713, 2), 5055356.500000])
...
(assert (= result (fp #b1 #b00000001 #b10011010010001101111100)))
(check-sat)
(exit)
