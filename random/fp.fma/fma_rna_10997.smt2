...
(assert (= y (fp #b0 #b00000000 #b10111110100111010000110)))
;; y should be Float32(0x005F4E86 [Rational(3123011, 356811923176489970264571492362373784095686656), 0.000000])
