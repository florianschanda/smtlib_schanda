...
(assert (= z (fp #b0 #b00000000 #b01001001100000001110101)))
;; z should be Float32(0x0024C075 [Rational(2408565, 713623846352979940529142984724747568191373312), 0.000000])
