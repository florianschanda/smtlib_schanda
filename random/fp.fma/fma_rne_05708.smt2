...
(assert (= z (fp #b0 #b00100010 #b10011101100100101011100)))
;; z should be Float32(0x114EC95C [Rational(3387991, 20769187434139310514121985316880384), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b00100010 #b10011101100100101011100))))
(check-sat)
(exit)
