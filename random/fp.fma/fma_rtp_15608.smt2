...
(assert (= z ((_ to_fp 8 24) #x0056F779)))
;; z should be Float32(0x0056F779 [Rational(5699449, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x0056F77A)))
(check-sat)
(exit)
