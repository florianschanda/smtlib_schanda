...
(assert (= y (fp #b1 #b00101001 #b11000010110100001110101)))
;; y should be Float32(0x94E16875 [Rational(-14772341, 649037107316853453566312041152512), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FCA932A)))
