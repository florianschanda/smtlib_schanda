...
(assert (= x ((_ to_fp 8 24) #xCA609916)))
;; x should be Float32(0xCA609916 [Rational(-7359627, 2), -3679813.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b01110000010011001000101))))
(check-sat)
(exit)
