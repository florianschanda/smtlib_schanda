...
(assert (= z ((_ to_fp 8 24) #x8807B9AD)))
;; z should be Float32(0x8807B9AD [Rational(-8894893, 21778071482940061661655974875633165533184), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x8807B9AD))))
(check-sat)
(exit)
