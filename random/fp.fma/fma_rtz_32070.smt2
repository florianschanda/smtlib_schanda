...
(assert (= z (fp #b1 #b11111101 #b11110100010010001101111)))
;; z should be Float32(0xFEFA246F [Rational(-166248086490301113677997960541415407616), -166248086490301113677997960541415407616.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xFEFA246E))))
(check-sat)
(exit)
