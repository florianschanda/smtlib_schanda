...
(assert (= y (fp #b0 #b01100101 #b11100011101000011000011)))
;; y should be Float32(0x32F1D0C3 [Rational(15847619, 562949953421312), 0.000000])
...
(assert (not (= result (fp #b0 #b11100101 #b11100011101000011000011))))
(check-sat)
(exit)
