...
(assert (= x (fp #b1 #b10010101 #b11100101011000111101011)))
;; x should be Float32(0xCAF2B1EB [Rational(-15905259, 2), -7952629.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8006A70A))))
(check-sat)
(exit)
