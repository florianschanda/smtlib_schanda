...
(assert (= z (fp #b0 #b01001001 #b01100001001101110000100)))
;; z should be Float32(0x24B09B84 [Rational(2893537, 37778931862957161709568), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x24B09B84)))
(check-sat)
(exit)
