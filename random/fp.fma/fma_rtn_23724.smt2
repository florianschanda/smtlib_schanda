...
(assert (= x (fp #b0 #b00000000 #b11000100110110000110010)))
;; x should be Float32(0x00626C32 [Rational(3225113, 356811923176489970264571492362373784095686656), 0.000000])
