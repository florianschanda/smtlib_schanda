...
(assert (= x ((_ to_fp 8 24) #x754EB26C)))
;; x should be Float32(0x754EB26C [Rational(262019525978802741543262929027072), 262019525978802741543262929027072.000000])
...
(assert (= z ((_ to_fp 8 24) #xFFA11048)))
