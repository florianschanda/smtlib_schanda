...
(assert (= x ((_ to_fp 8 24) #xE24BD452)))
;; x should be Float32(0xE24BD452 [Rational(-939997084461792493568), -939997084461792493568.000000])
...
(assert (= z ((_ to_fp 8 24) #xFF8DDFEB)))
