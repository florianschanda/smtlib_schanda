...
(assert (= y (fp #b1 #b00110111 #b01111101101011100011011)))
;; y should be Float32(0x9BBED71B [Rational(-12506907, 39614081257132168796771975168), -0.000000])
...
(assert (not (= result (fp #b1 #b10110111 #b01111101101011100011010))))
(check-sat)
(exit)
