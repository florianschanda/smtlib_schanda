...
(assert (= x (fp #b0 #b00000000 #b00011100011011001001001)))
;; x should be Float32(0x000E3649 [Rational(931401, 713623846352979940529142984724747568191373312), 0.000000])
