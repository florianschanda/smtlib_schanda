...
(assert (= z ((_ to_fp 8 24) #x2DBE5CC7)))
;; z should be Float32(0x2DBE5CC7 [Rational(12475591, 576460752303423488), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b01101001 #b11111111111110100000110)))
(check-sat)
(exit)
