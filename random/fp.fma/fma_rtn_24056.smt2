...
(assert (= z (fp #b0 #b10001010 #b10000101011100000000000)))
;; z should be Float32(0x4542B800 [Rational(6231, 2), 3115.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10001010 #b10000101011100000000000)))
(check-sat)
(exit)
