...
(assert (= y (fp #b0 #b00000000 #b01000011011101101100010)))
;; y should be Float32(0x0021BB62 [Rational(1105329, 356811923176489970264571492362373784095686656), 0.000000])
