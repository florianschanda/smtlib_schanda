...
(assert (= x ((_ to_fp 8 24) #x007E1802)))
;; x should be Float32(0x007E1802 [Rational(4131841, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result (fp #b0 #b10000000 #b11111000011000000000011)))
(check-sat)
(exit)
