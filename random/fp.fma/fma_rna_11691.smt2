...
(assert (= y ((_ to_fp 8 24) #x7EB79FA7)))
;; y should be Float32(0x7EB79FA7 [Rational(122038842795775226081646920069306908672), 122038842795775226081646920069306908672.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBFB79FA6))))
(check-sat)
(exit)
