...
(assert (= x ((_ to_fp 8 24) #x805D48A4)))
;; x should be Float32(0x805D48A4 [Rational(-1528361, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (= z (fp #b0 #b11111111 #b01100111010110111001001)))
