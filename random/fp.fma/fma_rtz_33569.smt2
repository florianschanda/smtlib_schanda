...
(assert (= x ((_ to_fp 8 24) #xE5729F3E)))
;; x should be Float32(0xE5729F3E [Rational(-71609386795812769497088), -71609386795812769497088.000000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b00011101110001001010111)))
