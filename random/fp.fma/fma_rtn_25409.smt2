...
(assert (= y (fp #b0 #b11011110 #b11100101101101110011010)))
;; y should be Float32(0x6F72DB9A [Rational(75160854375699472346020577280), 75160854375699472346020577280.000000])
...
(assert (= result ((_ to_fp 8 24) #xB072DB99)))
(check-sat)
(exit)
