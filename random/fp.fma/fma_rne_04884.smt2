...
(assert (= y ((_ to_fp 8 24) #xCAFAA877)))
;; y should be Float32(0xCAFAA877 [Rational(-16427127, 2), -8213563.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b11110101010100001110101))))
(check-sat)
(exit)
