...
(assert (= z (fp #b1 #b10010100 #b10111100110100000101010)))
;; z should be Float32(0xCA5E682A [Rational(-7287829, 2), -3643914.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA5E682A))))
(check-sat)
(exit)
