...
(assert (= z (fp #b0 #b10011111 #b00100011000010010000001)))
;; z should be Float32(0x4F918481 [Rational(4882760192), 4882760192.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b10011111 #b00100011000010010000000)))
(check-sat)
(exit)
