...
(assert (= z (fp #b1 #b10010101 #b11110010011000000000101)))
;; z should be Float32(0xCAF93005 [Rational(-16330757, 2), -8165378.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #xCAF93005)))
(check-sat)
(exit)
