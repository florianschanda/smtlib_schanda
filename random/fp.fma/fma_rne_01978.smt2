...
(assert (= z (fp #b0 #b10010101 #b00101100010011001011101)))
;; z should be Float32(0x4A96265D [Rational(9840221, 2), 4920110.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010101 #b00101100010011001011101))))
(check-sat)
(exit)
