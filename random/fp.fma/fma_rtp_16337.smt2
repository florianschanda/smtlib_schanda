...
(assert (= x (fp #b0 #b10000000 #b01111001001110000011001)))
;; x should be Float32(0x403C9C19 [Rational(12360729, 4194304), 2.947027])
...
(assert (= result ((_ to_fp 8 24) #x013C9C18)))
(check-sat)
(exit)
