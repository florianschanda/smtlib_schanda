...
(assert (= z (fp #b1 #b11110010 #b00110101101110111000101)))
;; z should be Float32(0xF91ADDC5 [Rational(-50256983542799111501993419087020032), -50256983542799111501993419087020032.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #xF91ADDC5))))
(check-sat)
(exit)
