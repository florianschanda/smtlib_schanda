...
(assert (= y (fp #b1 #b11111111 #b01100000001100001011000)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b0 #b10010101 #b11110111110100011110100)))
;; z should be Float32(0x4AFBE8F4 [Rational(8254586), 8254586.000000])
