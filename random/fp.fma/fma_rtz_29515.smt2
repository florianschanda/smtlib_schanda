...
(assert (= z ((_ to_fp 8 24) #x5CC87251)))
;; z should be Float32(0x5CC87251 [Rational(451365500480389120), 451365500480389120.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x5CC87250)))
(check-sat)
(exit)
