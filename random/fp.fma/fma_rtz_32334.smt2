...
(assert (= y (fp #b1 #b10010101 #b01111000001011111111011)))
;; y should be Float32(0xCABC17FB [Rational(-12326907, 2), -6163453.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b01111000001011111110111))))
(check-sat)
(exit)
