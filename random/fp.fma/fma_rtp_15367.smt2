...
(assert (= y ((_ to_fp 8 24) #xC8932270)))
;; y should be Float32(0xC8932270 [Rational(-602663, 2), -301331.500000])
...
(assert (not (= result (fp #b1 #b00010011 #b00100110010001010001110))))
(check-sat)
(exit)
