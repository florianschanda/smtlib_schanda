...
(assert (= x ((_ to_fp 8 24) #x7FEF69E2)))
...
(assert (= z (fp #b1 #b00100101 #b01001000100001010111011)))
;; z should be Float32(0x92A442BB [Rational(-10764987, 10384593717069655257060992658440192), -0.000000])
