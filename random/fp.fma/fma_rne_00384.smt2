...
(assert (= x ((_ to_fp 8 24) #x4AC28ADF)))
;; x should be Float32(0x4AC28ADF [Rational(12749535, 2), 6374767.500000])

(declare-const y Float32)
(assert (= y (fp #b0 #b10010100 #b11001001010011110101010)))
;; y should be Float32(0x4A64A7AA [Rational(7492565, 2), 3746282.500000])
