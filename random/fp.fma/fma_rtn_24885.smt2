...
(assert (= y (fp #b1 #b00000000 #b11011100010100011001110)))
;; y should be Float32(0x806E28CE [Rational(-3609703, 356811923176489970264571492362373784095686656), -0.000000])
