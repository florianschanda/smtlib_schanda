...
(assert (= z ((_ to_fp 8 24) #x9D1F4FAC)))
;; z should be Float32(0x9D1F4FAC [Rational(-2610155, 1237940039285380274899124224), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b00111010 #b00111110100111110101100)))
(check-sat)
(exit)
