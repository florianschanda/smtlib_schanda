...
(assert (= x (fp #b0 #b00000000 #b00011000110000001000010)))
;; x should be Float32(0x000C6042 [Rational(405537, 356811923176489970264571492362373784095686656), 0.000000])
