...
(assert (= x ((_ to_fp 8 24) #x0020AFA6)))
;; x should be Float32(0x0020AFA6 [Rational(1071059, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result (fp #b0 #b01111111 #b00000101011111010010111)))
(check-sat)
(exit)
