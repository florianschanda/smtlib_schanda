...
(assert (= x (fp #b1 #b00001010 #b11010100100000011011101)))
;; x should be Float32(0x856A40DD [Rational(-15352029, 1393796574908163946345982392040522594123776), -0.000000])
