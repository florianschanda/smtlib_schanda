...
(assert (= x (fp #b1 #b10100010 #b10100101101010010101001)))
;; x should be Float32(0xD152D4A9 [Rational(-56594436096), -56594436096.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7F8CC72B)))
