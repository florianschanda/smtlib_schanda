...
(assert (= z ((_ to_fp 8 24) #xB47AD3F5)))
;; z should be Float32(0xB47AD3F5 [Rational(-16438261, 70368744177664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b01101000 #b11110101101001111110101))))
(check-sat)
(exit)
