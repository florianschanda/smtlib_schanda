...
(assert (= y (fp #b0 #b00000000 #b01001100000111000011110)))
;; y should be Float32(0x00260E1E [Rational(1246991, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBF983877))))
(check-sat)
(exit)
