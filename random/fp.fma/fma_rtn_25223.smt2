...
(assert (= y ((_ to_fp 8 24) #xA2C1C20C)))
;; y should be Float32(0xA2C1C20C [Rational(-3174531, 604462909807314587353088), -0.000000])
...
(assert (= result (fp #b0 #b11000101 #b10000011100001000001011)))
(check-sat)
(exit)
