...
(assert (= y (fp #b0 #b10110011 #b10111111000100101100011)))
;; y should be Float32(0x59DF8963 [Rational(7864997262655488), 7864997262655488.000000])
...
(assert (= result (fp #b1 #b00011110 #b10111111000100101100100)))
(check-sat)
(exit)
