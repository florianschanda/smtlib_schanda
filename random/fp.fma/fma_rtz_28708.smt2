...
(assert (= z (fp #b1 #b00000000 #b10010100010010100010110)))
;; z should be Float32(0x804A2516 [Rational(-2429579, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x804A2516))))
(check-sat)
(exit)
