...
(assert (= x (fp #b1 #b00001001 #b00100001110011001100111)))
;; x should be Float32(0x8490E667 [Rational(-9496167, 2787593149816327892691964784081045188247552), -0.000000])
...
(assert (= result (fp #b0 #b10001001 #b00100001110011001100111)))
(check-sat)
(exit)
