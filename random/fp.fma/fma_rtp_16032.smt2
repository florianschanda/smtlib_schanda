...
(assert (= y ((_ to_fp 8 24) #x64222BFD)))
;; y should be Float32(0x64222BFD [Rational(11966168918614744236032), 11966168918614744236032.000000])
...
(assert (not (= result (fp #b0 #b00110011 #b01000100010101111111101))))
(check-sat)
(exit)
