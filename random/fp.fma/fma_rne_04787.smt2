...
(assert (= z ((_ to_fp 8 24) #x80765572)))
;; z should be Float32(0x80765572 [Rational(-3877561, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b00000000 #b11101100101010101110010))))
(check-sat)
(exit)
