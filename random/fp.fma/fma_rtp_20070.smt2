...
(assert (= x (fp #b1 #b00000000 #b01001110001001011010010)))
;; x should be Float32(0x802712D2 [Rational(-1280361, 356811923176489970264571492362373784095686656), -0.000000])
