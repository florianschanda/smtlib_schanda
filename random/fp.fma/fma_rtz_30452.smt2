...
(assert (= x (fp #b0 #b00000000 #b11000110000110011111110)))
;; x should be Float32(0x00630CFE [Rational(3245695, 356811923176489970264571492362373784095686656), 0.000000])
