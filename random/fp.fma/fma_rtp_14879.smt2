...
(assert (= z (fp #b0 #b10010011 #b10000101110001100010100)))
;; z should be Float32(0x49C2E314 [Rational(3193029, 2), 1596514.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x49C2E334))))
(check-sat)
(exit)
