...
(assert (= z (fp #b0 #b10010100 #b00110000101000011010010)))
;; z should be Float32(0x4A1850D2 [Rational(4991081, 2), 2495540.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4A1850D1))))
(check-sat)
(exit)
