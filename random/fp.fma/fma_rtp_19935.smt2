...
(assert (= x (fp #b1 #b00000000 #b10111000101001110101111)))
;; x should be Float32(0x805C53AF [Rational(-6050735, 713623846352979940529142984724747568191373312), -0.000000])
