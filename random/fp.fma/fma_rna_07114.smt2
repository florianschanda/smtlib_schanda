...
(assert (= z ((_ to_fp 8 24) #x05F7FB16)))
;; z should be Float32(0x05F7FB16 [Rational(8125835, 348449143727040986586495598010130648530944), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x05F7FB16)))
(check-sat)
(exit)
