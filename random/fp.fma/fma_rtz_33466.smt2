...
(assert (= x ((_ to_fp 8 24) #xFCA89169)))
;; x should be Float32(0xFCA89169 [Rational(-7002041124667556252480344454881869824), -7002041124667556252480344454881869824.000000])
...
(assert (not (= result (fp #b0 #b01111011 #b01010001001000101100111))))
(check-sat)
(exit)
