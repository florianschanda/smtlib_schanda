...
(assert (= y (fp #b1 #b01001100 #b11001001011101100100100)))
;; y should be Float32(0xA664BB24 [Rational(-3747529, 4722366482869645213696), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FEB9454)))
