...
(assert (= z (fp #b0 #b10011011 #b00011010100000001111000)))
;; z should be Float32(0x4D8D4078 [Rational(296226560), 296226560.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b10011011 #b00011010100000001111000)))
(check-sat)
(exit)
