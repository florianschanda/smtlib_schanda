...
(assert (= y (fp #b0 #b10010101 #b00001000010011101100101)))
;; y should be Float32(0x4A842765 [Rational(8660837, 2), 4330418.500000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b10011010111011101111010)))
