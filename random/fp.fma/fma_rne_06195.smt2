...
(assert (= x ((_ to_fp 8 24) #x802BA998)))
;; x should be Float32(0x802BA998 [Rational(-357683, 89202980794122492566142873090593446023921664), -0.000000])
...
(assert (= result (fp #b1 #b01111111 #b01011101010011001011111)))
(check-sat)
(exit)
