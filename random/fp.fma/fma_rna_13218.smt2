...
(assert (= x (fp #b1 #b00000000 #b10011100110101110100110)))
;; x should be Float32(0x804E6BA6 [Rational(-2569683, 356811923176489970264571492362373784095686656), -0.000000])
