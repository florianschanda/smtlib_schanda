...
(assert (= x ((_ to_fp 8 24) #x001956D6)))
;; x should be Float32(0x001956D6 [Rational(830315, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7FAA8FDF)))
