...
(assert (= x ((_ to_fp 8 24) #x8065AE6A)))
;; x should be Float32(0x8065AE6A [Rational(-3331893, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x404B5CD3))))
(check-sat)
(exit)
