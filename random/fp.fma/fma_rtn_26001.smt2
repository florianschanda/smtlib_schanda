...
(assert (= z ((_ to_fp 8 24) #x00709552)))
;; z should be Float32(0x00709552 [Rational(3689129, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x00709552))))
(check-sat)
(exit)
