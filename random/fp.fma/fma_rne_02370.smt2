...
(assert (= y (fp #b1 #b10010001 #b10000100101011100010000)))
;; y should be Float32(0xC8C25710 [Rational(-796017, 2), -398008.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x808612B8))))
(check-sat)
(exit)
