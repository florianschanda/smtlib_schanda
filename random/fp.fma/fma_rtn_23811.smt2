...
(assert (= x (fp #b0 #b00000000 #b00001001000000100011001)))
;; x should be Float32(0x00048119 [Rational(295193, 713623846352979940529142984724747568191373312), 0.000000])
