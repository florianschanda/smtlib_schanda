...
(assert (= z (fp #b0 #b00010010 #b10100110111110010011000)))
;; z should be Float32(0x09537C98 [Rational(1732499, 680564733841876926926749214863536422912), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x09537C98)))
(check-sat)
(exit)
