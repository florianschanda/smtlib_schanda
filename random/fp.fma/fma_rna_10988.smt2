...
(assert (= y (fp #b0 #b00000000 #b11001011100001111101110)))
;; y should be Float32(0x0065C3EE [Rational(3334647, 356811923176489970264571492362373784095686656), 0.000000])
