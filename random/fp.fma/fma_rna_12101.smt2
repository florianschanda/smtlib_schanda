...
(assert (= z ((_ to_fp 8 24) #xAFDDEA06)))
;; z should be Float32(0xAFDDEA06 [Rational(-7271683, 18014398509481984), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b01011111 #b10111011110101000000110)))
(check-sat)
(exit)
