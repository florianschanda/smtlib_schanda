...
(assert (= y (fp #b1 #b01001001 #b11001011111100101110111)))
;; y should be Float32(0xA4E5F977 [Rational(-15071607, 151115727451828646838272), -0.000000])
...
(assert (= result (fp #b0 #b11001001 #b11001011111100101110110)))
(check-sat)
(exit)
