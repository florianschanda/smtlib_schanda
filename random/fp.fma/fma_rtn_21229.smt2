...
(assert (= x (fp #b0 #b10010100 #b01001111001001000110110)))
;; x should be Float32(0x4A279236 [Rational(5490971, 2), 2745485.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b10101100001101101110010))))
(check-sat)
(exit)
