...
(assert (= y (fp #b0 #b11010000 #b11111110010110001001101)))
;; y should be Float32(0x687F2C4D [Rational(4820082633222974680858624), 4820082633222974680858624.000000])
...
(assert (= result (fp #b0 #b00111011 #b11111110010110001001101)))
(check-sat)
(exit)
