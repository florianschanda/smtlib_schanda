...
(assert (= z ((_ to_fp 8 24) #xA12AC410)))
;; z should be Float32(0xA12AC410 [Rational(-699457, 1208925819614629174706176), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xA12AC410))))
(check-sat)
(exit)
