...
(assert (= x ((_ to_fp 8 24) #xCA9CB01B)))
;; x should be Float32(0xCA9CB01B [Rational(-10268699, 2), -5134349.500000])
...
(assert (= result (fp #b0 #b00010111 #b00111001011000000011100)))
(check-sat)
(exit)
