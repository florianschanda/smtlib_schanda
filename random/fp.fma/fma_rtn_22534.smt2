...
(assert (= y (fp #b0 #b01010100 #b01101010001100000110100)))
;; y should be Float32(0x2A351834 [Rational(2967053, 18446744073709551616), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FD2B6BF)))
