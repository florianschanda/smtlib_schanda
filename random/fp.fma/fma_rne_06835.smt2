...
(assert (= x ((_ to_fp 8 24) #xFFA24404)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x803380C7)))
;; y should be Float32(0x803380C7 [Rational(-3375303, 713623846352979940529142984724747568191373312), -0.000000])
