...
(assert (= z (fp #b0 #b10010101 #b01110000100001000100001)))
;; z should be Float32(0x4AB84221 [Rational(12075553, 2), 6037776.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4AB84220))))
(check-sat)
(exit)
