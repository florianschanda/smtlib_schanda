...
(assert (= z (fp #b0 #b10110100 #b11010111111110101101011)))
;; z should be Float32(0x5A6BFD6B [Rational(16606313882583040), 16606313882583040.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10110100 #b11010111111110101101010)))
(check-sat)
(exit)
