...
(assert (= z (fp #b0 #b11000100 #b00000101110100111100100)))
;; z should be Float32(0x6202E9E4 [Rational(603732581321942237184), 603732581321942237184.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x6202E9E4)))
(check-sat)
(exit)
