...
(assert (= z ((_ to_fp 8 24) #xCF1B1C75)))
;; z should be Float32(0xCF1B1C75 [Rational(-2602333440), -2602333440.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10011110 #b00110110001110001110101)))
(check-sat)
(exit)
