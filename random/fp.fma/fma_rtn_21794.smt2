...
(assert (= y ((_ to_fp 8 24) #x24DE1BC8)))
;; y should be Float32(0x24DE1BC8 [Rational(1819513, 18889465931478580854784), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x64DE1BC7))))
(check-sat)
(exit)
