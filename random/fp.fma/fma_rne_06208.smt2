...
(assert (= x ((_ to_fp 8 24) #x8073C1BD)))
;; x should be Float32(0x8073C1BD [Rational(-7586237, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC0678379)))
(check-sat)
(exit)
