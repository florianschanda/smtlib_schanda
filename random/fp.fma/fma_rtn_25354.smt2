...
(assert (= z (fp #b0 #b01110000 #b10001100010100011000010)))
;; z should be Float32(0x384628C2 [Rational(6493281, 137438953472), 0.000047])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x384628C1))))
(check-sat)
(exit)
