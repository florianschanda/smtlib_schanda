...
(assert (= z (fp #b0 #b00000000 #b01001011110000011010001)))
;; z should be Float32(0x0025E0D1 [Rational(2482385, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b00000000 #b01001011110000011010001))))
(check-sat)
(exit)
