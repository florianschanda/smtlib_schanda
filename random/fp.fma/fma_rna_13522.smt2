...
(assert (= x ((_ to_fp 8 24) #xFFE1E4FE)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b00000000 #b01001110011011100101111)))
;; y should be Float32(0x0027372F [Rational(2570031, 713623846352979940529142984724747568191373312), 0.000000])
