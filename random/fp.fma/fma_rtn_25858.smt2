...
(assert (= z (fp #b1 #b00000000 #b10111100100101010111010)))
;; z should be Float32(0x805E4ABA [Rational(-3089757, 356811923176489970264571492362373784095686656), -0.000000])
