...
(assert (= y ((_ to_fp 8 24) #x7F8F554C)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b00000000 #b10100111000011011101111)))
;; z should be Float32(0x805386EF [Rational(-5474031, 713623846352979940529142984724747568191373312), -0.000000])
