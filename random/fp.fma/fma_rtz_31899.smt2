...
(assert (= z ((_ to_fp 8 24) #xF89F4BFF)))
;; z should be Float32(0xF89F4BFF [Rational(-25847393262773518925757228559368192), -25847393262773518925757228559368192.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b11110001 #b00111110100101111111111))))
(check-sat)
(exit)
