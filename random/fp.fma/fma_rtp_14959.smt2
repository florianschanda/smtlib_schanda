...
(assert (= y ((_ to_fp 8 24) #x002F3AC1)))
;; y should be Float32(0x002F3AC1 [Rational(3095233, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3FBCEB04)))
(check-sat)
(exit)
