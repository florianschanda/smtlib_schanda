...
(assert (= y (fp #b1 #b00000000 #b11110111100001110001010)))
;; y should be Float32(0x807BC38A [Rational(-4055493, 356811923176489970264571492362373784095686656), -0.000000])
