...
(assert (= z ((_ to_fp 8 24) #x800A3871)))
;; z should be Float32(0x800A3871 [Rational(-669809, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b00000000 #b00010100011100001110001)))
(check-sat)
(exit)
