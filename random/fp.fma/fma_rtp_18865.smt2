...
(assert (= z (fp #b1 #b00010110 #b10010000111001111100000)))
;; z should be Float32(0x8B4873E0 [Rational(-410527, 10633823966279326983230456482242756608), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b00010110 #b10010000111001111100000))))
(check-sat)
(exit)
