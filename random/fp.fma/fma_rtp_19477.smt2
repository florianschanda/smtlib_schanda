...
(assert (= y (fp #b1 #b11111111 #b10101011100101011111110)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b0 #b10010001 #b01100001101010011110000)))
;; z should be Float32(0x48B0D4F0 [Rational(724303, 2), 362151.500000])
