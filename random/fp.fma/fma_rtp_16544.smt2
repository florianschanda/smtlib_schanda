...
(assert (= x ((_ to_fp 8 24) #x6193F9E9)))
;; x should be Float32(0x6193F9E9 [Rational(341209912927540215808), 341209912927540215808.000000])
...
(assert (= result ((_ to_fp 8 24) #x9713F9E9)))
(check-sat)
(exit)
