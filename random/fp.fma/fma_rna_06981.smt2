...
(assert (= z ((_ to_fp 8 24) #x25F9FC56)))
;; z should be Float32(0x25F9FC56 [Rational(8191531, 18889465931478580854784), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x25F9FC56))))
(check-sat)
(exit)
