...
(assert (= x (fp #b1 #b00000000 #b10111100011001101001001)))
;; x should be Float32(0x805E3349 [Rational(-6173513, 713623846352979940529142984724747568191373312), -0.000000])
