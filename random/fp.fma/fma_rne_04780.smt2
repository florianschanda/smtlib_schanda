...
(assert (= z (fp #b1 #b10010010 #b00000010010110000101000)))
;; z should be Float32(0xC9012C28 [Rational(-1058181, 2), -529090.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xC9012C28))))
(check-sat)
(exit)
