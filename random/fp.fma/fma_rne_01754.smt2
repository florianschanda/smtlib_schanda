...
(assert (= y (fp #b1 #b10011110 #b10010101011111110111010)))
;; y should be Float32(0xCF4ABFBA [Rational(-3401562624), -3401562624.000000])
...
(assert (not (= result (fp #b1 #b00100000 #b10010101011111110111000))))
(check-sat)
(exit)
