...
(assert (= x (fp #b1 #b00000000 #b11110011111001111101101)))
;; x should be Float32(0x8079F3ED [Rational(-7992301, 713623846352979940529142984724747568191373312), -0.000000])
