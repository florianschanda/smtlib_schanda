...
(assert (= x (fp #b0 #b10000111 #b11101011100010001100011)))
;; x should be Float32(0x43F5C463 [Rational(16106595, 32768), 491.534271])
...
(assert (not (= result ((_ to_fp 8 24) #x800001EA))))
(check-sat)
(exit)
