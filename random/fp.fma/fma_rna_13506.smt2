...
(assert (= x (fp #b0 #b11111111 #b10010001111101001110000)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b01011110 #b01011101010101001011101)))
;; y should be Float32(0x2F2EAA5D [Rational(11446877, 72057594037927936), 0.000000])
