...
(assert (= z (fp #b0 #b00000000 #b10010001010111000111111)))
;; z should be Float32(0x0048AE3F [Rational(4763199, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x0048AE3F)))
(check-sat)
(exit)
