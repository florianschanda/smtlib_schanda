...
(assert (= z ((_ to_fp 8 24) #x4A8D72A1)))
;; z should be Float32(0x4A8D72A1 [Rational(9269921, 2), 4634960.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010101 #b00011010111001010100001))))
(check-sat)
(exit)
