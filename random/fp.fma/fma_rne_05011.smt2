...
(assert (= y ((_ to_fp 8 24) #xF24073C4)))
;; y should be Float32(0xF24073C4 [Rational(-3811908732082212992045507674112), -3811908732082212992045507674112.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x334073C2))))
(check-sat)
(exit)
