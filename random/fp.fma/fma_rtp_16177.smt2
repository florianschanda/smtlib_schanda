...
(assert (= z (fp #b0 #b11011100 #b00111101101100100100001)))
;; z should be Float32(0x6E1ED921 [Rational(12290281073180707521929674752), 12290281073180707521929674752.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x6E1ED921))))
(check-sat)
(exit)
