...
(assert (= x ((_ to_fp 8 24) #x0022838E)))
;; x should be Float32(0x0022838E [Rational(1130951, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBF8A0E37))))
(check-sat)
(exit)
