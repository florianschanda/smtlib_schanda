...
(assert (= y (fp #b0 #b00000000 #b01100000110101111010010)))
;; y should be Float32(0x00306BD2 [Rational(1586665, 356811923176489970264571492362373784095686656), 0.000000])
