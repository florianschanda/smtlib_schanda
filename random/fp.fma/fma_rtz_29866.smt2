...
(assert (= z ((_ to_fp 8 24) #xED3D3F83)))
;; z should be Float32(0xED3D3F83 [Rational(-3660590488304949721907068928), -3660590488304949721907068928.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b11011010 #b01111010011111110000011)))
(check-sat)
(exit)
