...
(assert (= z (fp #b1 #b10101101 #b01010011010100101110100)))
;; z should be Float32(0xD6A9A974 [Rational(-93272630362112), -93272630362112.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #xD6A9A974)))
(check-sat)
(exit)
