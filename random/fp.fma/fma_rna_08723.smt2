...
(assert (= z ((_ to_fp 8 24) #x4AFA5C4F)))
;; z should be Float32(0x4AFA5C4F [Rational(16407631, 2), 8203815.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11110100101110001010111))))
(check-sat)
(exit)
