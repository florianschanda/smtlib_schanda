...
(assert (= y (fp #b0 #b10010011 #b01100001101011010001100)))
;; y should be Float32(0x49B0D68C [Rational(2897315, 2), 1448657.500000])
...
(assert (= result (fp #b1 #b00010101 #b01100001101011010001100)))
(check-sat)
(exit)
