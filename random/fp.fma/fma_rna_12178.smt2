...
(assert (= z (fp #b1 #b00000000 #b00101000010000100101001)))
;; z should be Float32(0x80142129 [Rational(-1319209, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00101000010000100101001))))
(check-sat)
(exit)
