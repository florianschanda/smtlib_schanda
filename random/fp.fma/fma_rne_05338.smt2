...
(assert (= z ((_ to_fp 8 24) #x801FFC4F)))
;; z should be Float32(0x801FFC4F [Rational(-2096207, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x801FFC4F))))
(check-sat)
(exit)
