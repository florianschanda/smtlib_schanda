...
(assert (= y ((_ to_fp 8 24) #xD31EC913)))
;; y should be Float32(0xD31EC913 [Rational(-681978298368), -681978298368.000000])
...
(assert (not (= result (fp #b0 #b00010001 #b00111101100100100010011))))
(check-sat)
(exit)
