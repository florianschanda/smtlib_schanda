...
(assert (= z (fp #b0 #b00000000 #b01100010010010000011011)))
;; z should be Float32(0x0031241B [Rational(3220507, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x0031241A)))
(check-sat)
(exit)
