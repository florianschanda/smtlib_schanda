...
(assert (= y (fp #b1 #b10010101 #b10100100011101100100111)))
;; y should be Float32(0xCAD23B27 [Rational(-13777703, 2), -6888851.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8016E26B))))
(check-sat)
(exit)
