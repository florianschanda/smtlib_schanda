...
(assert (= x (fp #b0 #b00000000 #b11001010101110100101011)))
;; x should be Float32(0x00655D2B [Rational(6642987, 713623846352979940529142984724747568191373312), 0.000000])
