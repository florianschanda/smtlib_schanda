...
(assert (= y (fp #b0 #b00000000 #b11001001001000101101010)))
;; y should be Float32(0x0064916A [Rational(3295413, 356811923176489970264571492362373784095686656), 0.000000])
