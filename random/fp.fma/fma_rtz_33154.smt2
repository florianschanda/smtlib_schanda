...
(assert (= z ((_ to_fp 8 24) #x800202CF)))
;; z should be Float32(0x800202CF [Rational(-131791, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00000100000001011001110))))
(check-sat)
(exit)
