...
(assert (= x (fp #b0 #b00000000 #b11111101000001000010010)))
;; x should be Float32(0x007E8212 [Rational(4145417, 356811923176489970264571492362373784095686656), 0.000000])
