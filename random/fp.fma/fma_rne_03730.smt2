...
(assert (= x (fp #b1 #b10010000 #b11011110111110001100000)))
;; x should be Float32(0xC86F7C60 [Rational(-490467, 2), -245233.500000])
...
(assert (= result (fp #b0 #b00000000 #b11111000100001000001110)))
(check-sat)
(exit)
