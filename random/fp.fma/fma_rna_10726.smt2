...
(assert (= x ((_ to_fp 8 24) #xCA977E7D)))
;; x should be Float32(0xCA977E7D [Rational(-9928317, 2), -4964158.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b00101110111111001111100))))
(check-sat)
(exit)
