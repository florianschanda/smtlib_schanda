...
(assert (= x (fp #b1 #b10010011 #b00000100101100111100100)))
;; x should be Float32(0xC98259E4 [Rational(-2135673, 2), -1067836.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8A8259E4))))
(check-sat)
(exit)
