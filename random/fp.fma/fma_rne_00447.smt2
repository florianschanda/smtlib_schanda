...
(assert (= x ((_ to_fp 8 24) #x4ACF1891)))
;; x should be Float32(0x4ACF1891 [Rational(13572241, 2), 6786120.500000])
...
(assert (= result (fp #b0 #b00010111 #b10011110001100010001111)))
(check-sat)
(exit)
