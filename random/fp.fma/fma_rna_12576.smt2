...
(assert (= z (fp #b1 #b10100011 #b11011111111010101001111)))
;; z should be Float32(0xD1EFF54F [Rational(-128826597376), -128826597376.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b10100011 #b11011111111010101001111)))
(check-sat)
(exit)
