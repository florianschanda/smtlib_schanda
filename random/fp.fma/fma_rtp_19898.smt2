...
(assert (= x (fp #b1 #b00000000 #b11100010100100000111110)))
;; x should be Float32(0x8071483E [Rational(-3712031, 356811923176489970264571492362373784095686656), -0.000000])
