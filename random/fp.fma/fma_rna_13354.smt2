...
(assert (= x (fp #b1 #b00000000 #b10101001101010110110111)))
;; x should be Float32(0x8054D5B7 [Rational(-5559735, 713623846352979940529142984724747568191373312), -0.000000])
