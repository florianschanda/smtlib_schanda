...
(assert (= y (fp #b0 #b10010101 #b00110001011111000001001)))
;; y should be Float32(0x4A98BE09 [Rational(10010121, 2), 5005060.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0B98BE09))))
(check-sat)
(exit)
