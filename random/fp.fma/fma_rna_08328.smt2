...
(assert (= y ((_ to_fp 8 24) #x4AF1CE47)))
;; y should be Float32(0x4AF1CE47 [Rational(15846983, 2), 7923491.500000])
...
(assert (= result (fp #b0 #b00010111 #b11100011100111001000111)))
(check-sat)
(exit)
