...
(assert (= x (fp #b0 #b11111111 #b01001001011011101000101)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b10010101 #b10100110111101101000111)))
;; y should be Float32(0x4AD37B47 [Rational(13859655, 2), 6929827.500000])
