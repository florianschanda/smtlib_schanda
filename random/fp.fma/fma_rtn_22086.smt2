...
(assert (= z (fp #b0 #b10110001 #b01000110101101011011001)))
;; z should be Float32(0x58A35AD9 [Rational(1436884664320000), 1436884664320000.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x58A35AD9))))
(check-sat)
(exit)
