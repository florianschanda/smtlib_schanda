...
(assert (= x ((_ to_fp 8 24) #xFC69322D)))
;; x should be Float32(0xFC69322D [Rational(-4843291415144442251455978867001393152), -4843291415144442251455978867001393152.000000])
