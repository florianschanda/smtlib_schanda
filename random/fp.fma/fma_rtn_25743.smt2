...
(assert (= z (fp #b1 #b01100110 #b00001000111101110011111)))
;; z should be Float32(0xB3047B9F [Rational(-8682399, 281474976710656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b01100110 #b00001000111101110100000))))
(check-sat)
(exit)
