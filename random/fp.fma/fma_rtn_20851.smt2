...
(assert (= z ((_ to_fp 8 24) #x5CCBE073)))
;; z should be Float32(0x5CCBE073 [Rational(459089638384992256), 459089638384992256.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10111001 #b10010111110000001110011)))
(check-sat)
(exit)
