...
(assert (= y (fp #b1 #b10010100 #b01100101001001010001010)))
;; y should be Float32(0xCA32928A [Rational(-5851461, 2), -2925730.500000])
...
(assert (= result (fp #b0 #b00000001 #b01011001010010010100010)))
(check-sat)
(exit)
