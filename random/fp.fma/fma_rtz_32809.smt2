...
(assert (= y (fp #b1 #b10100011 #b01000011000001100000011)))
;; y should be Float32(0xD1A18303 [Rational(-86710968320), -86710968320.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x12A18302))))
(check-sat)
(exit)
