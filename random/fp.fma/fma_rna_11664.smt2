...
(assert (= z ((_ to_fp 8 24) #xE858F66F)))
;; z should be Float32(0xE858F66F [Rational(-4098308230939656503427072), -4098308230939656503427072.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b11010000 #b10110001111011001101111)))
(check-sat)
(exit)
