...
(assert (= z ((_ to_fp 8 24) #x8445FA2E)))
;; z should be Float32(0x8445FA2E [Rational(-6487319, 2787593149816327892691964784081045188247552), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x8445FA2E)))
(check-sat)
(exit)
