...
(assert (= z ((_ to_fp 8 24) #x2AE7091B)))
;; z should be Float32(0x2AE7091B [Rational(15141147, 36893488147419103232), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b01010101 #b11001110000100100011011))))
(check-sat)
(exit)
