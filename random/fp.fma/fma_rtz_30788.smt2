...
(assert (= z ((_ to_fp 8 24) #x5B75996C)))
;; z should be Float32(0x5B75996C [Rational(69130058429628416), 69130058429628416.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x5B75996C))))
(check-sat)
(exit)
