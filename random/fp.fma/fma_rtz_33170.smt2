...
(assert (= y (fp #b1 #b11011100 #b11011001101110010111001)))
;; y should be Float32(0xEE6CDCB9 [Rational(-18326324908987996380462055424), -18326324908987996380462055424.000000])
...
(assert (= result (fp #b0 #b01000111 #b11011001101110010111000)))
(check-sat)
(exit)
