...
(assert (= x (fp #b1 #b10010101 #b10000010101101111100001)))
;; x should be Float32(0xCAC15BE1 [Rational(-12671969, 2), -6335984.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x00E0ADEF))))
(check-sat)
(exit)
