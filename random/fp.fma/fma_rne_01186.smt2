...
(assert (= z ((_ to_fp 8 24) #x765D9C17)))
;; z should be Float32(0x765D9C17 [Rational(1123694808478617572823379015106560), 1123694808478617572823379015106560.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b11101100 #b10111011001110000010111)))
(check-sat)
(exit)
