...
(assert (= y (fp #b1 #b10010100 #b00000111100001101011010)))
;; y should be Float32(0xCA03C35A [Rational(-4317613, 2), -2158806.500000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x4AAB08BF)))
;; z should be Float32(0x4AAB08BF [Rational(11208895, 2), 5604447.500000])
