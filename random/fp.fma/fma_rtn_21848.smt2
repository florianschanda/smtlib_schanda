...
(assert (= z (fp #b1 #b00011011 #b00100011000101011011101)))
;; z should be Float32(0x8D918ADD [Rational(-9538269, 10633823966279326983230456482242756608), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x8D918ADD))))
(check-sat)
(exit)
