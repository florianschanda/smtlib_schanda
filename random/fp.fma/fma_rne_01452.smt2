...
(assert (= z ((_ to_fp 8 24) #x6A989737)))
;; z should be Float32(0x6A989737 [Rational(92235408245630502503972864), 92235408245630502503972864.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x6A989737)))
(check-sat)
(exit)
