...
(assert (= y (fp #b1 #b10010100 #b00011010111000101001010)))
;; y should be Float32(0xCA0D714A [Rational(-4634789, 2), -2317394.500000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b01000011001100110001111)))
