...
(assert (= z (fp #b0 #b01000011 #b00101001001110110001101)))
;; z should be Float32(0x21949D8D [Rational(9739661, 9671406556917033397649408), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b01000011 #b00101001001110110001101))))
(check-sat)
(exit)
