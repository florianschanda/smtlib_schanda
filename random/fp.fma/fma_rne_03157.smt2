...
(assert (= x (fp #b0 #b00000000 #b11011011001100011001010)))
;; x should be Float32(0x006D98CA [Rational(3591269, 356811923176489970264571492362373784095686656), 0.000000])
