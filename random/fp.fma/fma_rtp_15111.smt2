...
(assert (= y ((_ to_fp 8 24) #x9DCBFB26)))
;; y should be Float32(0x9DCBFB26 [Rational(-6684051, 1237940039285380274899124224), -0.000000])
...
(assert (not (= result (fp #b1 #b10111011 #b10010111111101100100101))))
(check-sat)
(exit)
