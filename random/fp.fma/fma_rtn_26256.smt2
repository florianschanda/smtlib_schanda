...
(assert (= z ((_ to_fp 8 24) #xF420AC1E)))
;; z should be Float32(0xF420AC1E [Rational(-50919094766984615222651742322688), -50919094766984615222651742322688.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #xF420AC1E)))
(check-sat)
(exit)
