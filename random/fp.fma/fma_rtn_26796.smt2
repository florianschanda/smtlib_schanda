...
(assert (= x (fp #b1 #b00000000 #b00111101110010011111101)))
;; x should be Float32(0x801EE4FD [Rational(-2024701, 713623846352979940529142984724747568191373312), -0.000000])
