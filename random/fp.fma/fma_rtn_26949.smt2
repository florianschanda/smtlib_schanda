...
(assert (= x ((_ to_fp 8 24) #x800B41DD)))
;; x should be Float32(0x800B41DD [Rational(-737757, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b0 #b01111101 #b01101000001110111001111)))
(check-sat)
(exit)
