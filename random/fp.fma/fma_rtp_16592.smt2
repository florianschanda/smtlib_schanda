...
(assert (= x (fp #b0 #b11011010 #b11101101100001110110100)))
;; x should be Float32(0x6D76C3B4 [Rational(4773118936052666008218894336), 4773118936052666008218894336.000000])
