...
(assert (= z ((_ to_fp 8 24) #x801BEB89)))
;; z should be Float32(0x801BEB89 [Rational(-1829769, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x801BEB89)))
(check-sat)
(exit)
