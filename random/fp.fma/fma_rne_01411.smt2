...
(assert (= y (fp #b1 #b00000000 #b01110000011001011000100)))
;; y should be Float32(0x803832C4 [Rational(-920753, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBFE0CB0F))))
(check-sat)
(exit)
