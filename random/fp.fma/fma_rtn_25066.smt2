...
(assert (= y ((_ to_fp 8 24) #x002CEDFA)))
;; y should be Float32(0x002CEDFA [Rational(1472253, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result (fp #b1 #b01111111 #b01100111011011111101000))))
(check-sat)
(exit)
