...
(assert (= z ((_ to_fp 8 24) #x4959EC78)))
;; z should be Float32(0x4959EC78 [Rational(1785231, 2), 892615.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010010 #b10110011110110001111000))))
(check-sat)
(exit)
