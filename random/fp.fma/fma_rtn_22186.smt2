...
(assert (= y (fp #b0 #b00000000 #b11010111110110100001011)))
;; y should be Float32(0x006BED0B [Rational(7073035, 713623846352979940529142984724747568191373312), 0.000000])
