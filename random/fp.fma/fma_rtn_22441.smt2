...
(assert (= z (fp #b0 #b10010101 #b11011010110100110011001)))
;; z should be Float32(0x4AED6999 [Rational(15559065, 2), 7779532.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11011010110100110100000))))
(check-sat)
(exit)
