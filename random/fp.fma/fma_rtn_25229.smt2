...
(assert (= y (fp #b1 #b00011111 #b10110010011000111101100)))
;; y should be Float32(0x8FD931EC [Rational(-3558523, 166153499473114484112975882535043072), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x4FD931EB)))
(check-sat)
(exit)
