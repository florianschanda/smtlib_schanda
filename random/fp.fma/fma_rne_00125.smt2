...
(assert (= z ((_ to_fp 8 24) #xCAAD0F85)))
;; z should be Float32(0xCAAD0F85 [Rational(-11341701, 2), -5670850.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010101 #b01011010000111110000101))))
(check-sat)
(exit)
