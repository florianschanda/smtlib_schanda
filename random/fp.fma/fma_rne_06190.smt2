...
(assert (= x (fp #b1 #b00000000 #b00000100010000111101111)))
;; x should be Float32(0x800221EF [Rational(-139759, 713623846352979940529142984724747568191373312), -0.000000])
