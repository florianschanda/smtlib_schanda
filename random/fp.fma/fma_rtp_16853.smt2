...
(assert (= x ((_ to_fp 8 24) #x0015ABAD)))
;; x should be Float32(0x0015ABAD [Rational(1420205, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= z (fp #b1 #b11111111 #b11101000100100111101011)))
