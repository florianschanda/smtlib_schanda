...
(assert (= z ((_ to_fp 8 24) #xB61262EB)))
;; z should be Float32(0xB61262EB [Rational(-9593579, 4398046511104), -0.000002])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b01101100 #b00100100110001011101011))))
(check-sat)
(exit)
