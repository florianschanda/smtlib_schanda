...
(assert (= z ((_ to_fp 8 24) #x4ACC5ED9)))
;; z should be Float32(0x4ACC5ED9 [Rational(13393625, 2), 6696812.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010101 #b10011000101111011100001))))
(check-sat)
(exit)
