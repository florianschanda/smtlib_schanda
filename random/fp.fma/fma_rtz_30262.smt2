...
(assert (= x (fp #b0 #b11000011 #b11011000010110101000011)))
;; x should be Float32(0x61EC2D43 [Rational(544586631493825069056), 544586631493825069056.000000])
...
(assert (= result (fp #b1 #b00101110 #b11011000010110101000011)))
(check-sat)
(exit)
