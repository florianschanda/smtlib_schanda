...
(assert (= z (fp #b0 #b10010101 #b01010100111000100100101)))
;; z should be Float32(0x4AAA7125 [Rational(11170085, 2), 5585042.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4AAA7125))))
(check-sat)
(exit)
