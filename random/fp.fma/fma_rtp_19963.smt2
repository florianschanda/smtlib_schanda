...
(assert (= x (fp #b1 #b00000000 #b11000110001101000011100)))
;; x should be Float32(0x80631A1C [Rational(-1623687, 178405961588244985132285746181186892047843328), -0.000000])
