...
(assert (= x (fp #b1 #b00000000 #b01101011110010010101010)))
;; x should be Float32(0x8035E4AA [Rational(-1765973, 356811923176489970264571492362373784095686656), -0.000000])
