...
(assert (= x (fp #b0 #b00000000 #b00111010101111010010100)))
;; x should be Float32(0x001D5E94 [Rational(481189, 178405961588244985132285746181186892047843328), 0.000000])
