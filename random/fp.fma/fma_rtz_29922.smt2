...
(assert (= y (fp #b1 #b10110011 #b11110101011000100010001)))
;; y should be Float32(0xD9FAB111 [Rational(-8820428843778048), -8820428843778048.000000])
...
(assert (= result ((_ to_fp 8 24) #x8F7AB111)))
(check-sat)
(exit)
