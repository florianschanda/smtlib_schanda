...
(assert (= x (fp #b0 #b10010101 #b11111000111001011010011)))
;; x should be Float32(0x4AFC72D3 [Rational(16544467, 2), 8272233.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8BFC72D1))))
(check-sat)
(exit)
