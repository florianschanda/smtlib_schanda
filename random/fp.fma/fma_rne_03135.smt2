...
(assert (= x (fp #b0 #b00000000 #b00101001101110101010111)))
;; x should be Float32(0x0014DD57 [Rational(1367383, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7F950FC5)))
