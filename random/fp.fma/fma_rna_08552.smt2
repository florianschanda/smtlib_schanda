...
(assert (= z (fp #b0 #b10010100 #b10100101101000100010110)))
;; z should be Float32(0x4A52D116 [Rational(6908043, 2), 3454021.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4A52D116))))
(check-sat)
(exit)
