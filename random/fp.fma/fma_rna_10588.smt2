...
(assert (= x (fp #b1 #b10010101 #b00110101010101101010001)))
;; x should be Float32(0xCA9AAB51 [Rational(-10136401, 2), -5068200.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0032AA57))))
(check-sat)
(exit)
