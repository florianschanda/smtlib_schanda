...
(assert (= y (fp #b0 #b10010101 #b10100111110100010101011)))
;; y should be Float32(0x4AD3E8AB [Rational(13887659, 2), 6943829.500000])
...
(assert (= result (fp #b1 #b00000000 #b11010011111010001010110)))
(check-sat)
(exit)
