...
(assert (= z ((_ to_fp 8 24) #xD5F0F58D)))
;; z should be Float32(0xD5F0F58D [Rational(-33117177905152), -33117177905152.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10101011 #b11100001111010110001101))))
(check-sat)
(exit)
