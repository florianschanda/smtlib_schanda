...
(assert (= x ((_ to_fp 8 24) #xD593FC43)))
;; x should be Float32(0xD593FC43 [Rational(-20338958139392), -20338958139392.000000])
...
(assert (= z ((_ to_fp 8 24) #xCAE303B1)))
;; z should be Float32(0xCAE303B1 [Rational(-14877617, 2), -7438808.500000])
