...
(assert (= z (fp #b0 #b10010101 #b01101001111011100010011)))
;; z should be Float32(0x4AB4F713 [Rational(11859731, 2), 5929865.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4AB4F713))))
(check-sat)
(exit)
