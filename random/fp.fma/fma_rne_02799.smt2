...
(assert (= x (fp #b0 #b11011100 #b00100110100001100001011)))
;; x should be Float32(0x6E13430B [Rational(11393836604920804205836369920), 11393836604920804205836369920.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xAF13430B))))
(check-sat)
(exit)
