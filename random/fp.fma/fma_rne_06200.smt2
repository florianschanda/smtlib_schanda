...
(assert (= x ((_ to_fp 8 24) #x8020F53A)))
;; x should be Float32(0x8020F53A [Rational(-1079965, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBF83D4E7))))
(check-sat)
(exit)
