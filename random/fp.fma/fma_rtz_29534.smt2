...
(assert (= z (fp #b0 #b00001001 #b11110001111100010100100)))
;; z should be Float32(0x04F8F8A4 [Rational(4079145, 696898287454081973172991196020261297061888), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x04F8F8A3))))
(check-sat)
(exit)
