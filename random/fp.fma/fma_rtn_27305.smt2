...
(assert (= x (fp #b0 #b11111111 #b10001011001011011110011)))
...
(assert (= z (fp #b0 #b10010101 #b10000111011000000110011)))
;; z should be Float32(0x4AC3B033 [Rational(12824627, 2), 6412313.500000])
