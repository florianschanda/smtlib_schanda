...
(assert (= z ((_ to_fp 8 24) #xC8D88770)))
;; z should be Float32(0xC8D88770 [Rational(-886903, 2), -443451.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010001 #b10110001000011101110000))))
(check-sat)
(exit)
