...
(assert (= z (fp #b1 #b10010100 #b10100011000000001111010)))
;; z should be Float32(0xCA51807A [Rational(-6864957, 2), -3432478.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10010100 #b10100011000000001111010)))
(check-sat)
(exit)
