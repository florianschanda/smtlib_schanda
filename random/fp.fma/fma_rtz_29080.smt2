...
(assert (= y (fp #b1 #b10010101 #b01101000110111001111111)))
;; y should be Float32(0xCAB46E7F [Rational(-11824767, 2), -5912383.500000])
...
(assert (= result (fp #b1 #b00010111 #b01101000110111001111101)))
(check-sat)
(exit)
