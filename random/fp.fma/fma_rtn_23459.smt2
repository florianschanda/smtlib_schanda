...
(assert (= x ((_ to_fp 8 24) #x09202CE1)))
;; x should be Float32(0x09202CE1 [Rational(10497249, 5444517870735015415413993718908291383296), 0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xFFCD95CC)))
