...
(assert (= y (fp #b0 #b00000000 #b00100110000010110001010)))
;; y should be Float32(0x0013058A [Rational(623301, 356811923176489970264571492362373784095686656), 0.000000])
