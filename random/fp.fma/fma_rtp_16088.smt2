...
(assert (= y (fp #b1 #b10010101 #b10101111011100110111101)))
;; y should be Float32(0xCAD7B9BD [Rational(-14137789, 2), -7068894.500000])
...
(assert (= result ((_ to_fp 8 24) #x80EBDCDD)))
(check-sat)
(exit)
