...
(assert (= z (fp #b1 #b10010101 #b11010111111101011111001)))
;; z should be Float32(0xCAEBFAF9 [Rational(-15465209, 2), -7732604.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #xCAEBFAF9)))
(check-sat)
(exit)
