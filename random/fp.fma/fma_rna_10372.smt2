...
(assert (= z (fp #b1 #b11001000 #b11110110111101011100010)))
;; z should be Float32(0xE47B7AE2 [Rational(-18555949609273845088256), -18555949609273845088256.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #xE47B7AE2)))
(check-sat)
(exit)
