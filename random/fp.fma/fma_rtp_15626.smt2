...
(assert (= z (fp #b0 #b11010101 #b10000101111101010110010)))
;; z should be Float32(0x6AC2FAB2 [Rational(117857742073200295748304896), 117857742073200295748304896.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x6AC2FAB3)))
(check-sat)
(exit)
