...
(assert (= y ((_ to_fp 8 24) #x4AE773C5)))
;; y should be Float32(0x4AE773C5 [Rational(15168453, 2), 7584226.500000])
...
(assert (= result (fp #b0 #b00010111 #b11001110111001111000110)))
(check-sat)
(exit)
