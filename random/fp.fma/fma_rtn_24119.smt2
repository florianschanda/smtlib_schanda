...
(assert (= z ((_ to_fp 8 24) #x2DD6FA00)))
;; z should be Float32(0x2DD6FA00 [Rational(27517, 1125899906842624), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b01011011 #b10101101111101000000000)))
(check-sat)
(exit)
