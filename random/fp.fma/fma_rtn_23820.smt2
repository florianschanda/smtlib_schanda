...
(assert (= x (fp #b0 #b00000000 #b10110110001100000011110)))
;; x should be Float32(0x005B181E [Rational(2984975, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b11010110010010111000110)))
