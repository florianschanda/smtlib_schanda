...
(assert (= z (fp #b1 #b10010101 #b00000011010110111001011)))
;; z should be Float32(0xCA81ADCB [Rational(-8498635, 2), -4249317.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA81ADC3))))
(check-sat)
(exit)
