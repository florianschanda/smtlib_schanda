...
(assert (= z (fp #b0 #b00000000 #b01110000101100000001011)))
;; z should be Float32(0x0038580B [Rational(3692555, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x0038580B)))
(check-sat)
(exit)
