...
(assert (= z ((_ to_fp 8 24) #x9ADA5792)))
;; z should be Float32(0x9ADA5792 [Rational(-7154633, 79228162514264337593543950336), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x9ADA5792)))
(check-sat)
(exit)
