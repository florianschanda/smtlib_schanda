...
(assert (= y (fp #b0 #b00000000 #b10000110000111100011001)))
;; y should be Float32(0x00430F19 [Rational(4394777, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result (fp #b1 #b10000000 #b00001100001111000110001)))
(check-sat)
(exit)
