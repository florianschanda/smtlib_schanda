...
(assert (= y (fp #b0 #b10010010 #b11100000110010010101000)))
;; y should be Float32(0x497064A8 [Rational(1969301, 2), 984650.500000])
...
(assert (not (= result (fp #b0 #b00010100 #b11100000110010010100110))))
(check-sat)
(exit)
