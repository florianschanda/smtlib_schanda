...
(assert (= y ((_ to_fp 8 24) #x800D0157)))
;; y should be Float32(0x800D0157 [Rational(-852311, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBED0156F)))
(check-sat)
(exit)
