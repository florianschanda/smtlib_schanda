...
(assert (= x (fp #b1 #b00000000 #b11111101011110010000111)))
;; x should be Float32(0x807EBC87 [Rational(-8305799, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b11111010111100100001101))))
(check-sat)
(exit)
