...
(assert (= y (fp #b1 #b10010100 #b01001011111111001110110)))
;; y should be Float32(0xCA25FE76 [Rational(-5439291, 2), -2719645.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8B25FE7A))))
(check-sat)
(exit)
