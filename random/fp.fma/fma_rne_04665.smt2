...
(assert (= y ((_ to_fp 8 24) #x805DE83D)))
;; y should be Float32(0x805DE83D [Rational(-6154301, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x403BD079))))
(check-sat)
(exit)
