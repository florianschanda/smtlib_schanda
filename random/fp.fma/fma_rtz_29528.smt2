...
(assert (= z ((_ to_fp 8 24) #x478128C0)))
;; z should be Float32(0x478128C0 [Rational(132259, 2), 66129.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10001111 #b00000010010100010111111))))
(check-sat)
(exit)
