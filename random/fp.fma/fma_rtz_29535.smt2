...
(assert (= z (fp #b0 #b00000000 #b10011101100111110001100)))
;; z should be Float32(0x004ECF8C [Rational(1291235, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x004ECF8B)))
(check-sat)
(exit)
