...
(assert (= z (fp #b1 #b01011101 #b00111011000001110011101)))
;; z should be Float32(0xAE9D839D [Rational(-10322845, 144115188075855872), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x407FFFFC)))
(check-sat)
(exit)
