...
(assert (= y ((_ to_fp 8 24) #xE3F216C0)))
;; y should be Float32(0xE3F216C0 [Rational(-8931502752204148703232), -8931502752204148703232.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x24F216BE))))
(check-sat)
(exit)
