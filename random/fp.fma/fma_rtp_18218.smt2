...
(assert (= y ((_ to_fp 8 24) #x0062908A)))
;; y should be Float32(0x0062908A [Rational(3229765, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result (fp #b1 #b10000000 #b10001010010000100010011)))
(check-sat)
(exit)
