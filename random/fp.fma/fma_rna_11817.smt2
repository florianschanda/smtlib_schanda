...
(assert (= z (fp #b1 #b00000000 #b00001111011011000100001)))
;; z should be Float32(0x8007B621 [Rational(-505377, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x8007B621)))
(check-sat)
(exit)
