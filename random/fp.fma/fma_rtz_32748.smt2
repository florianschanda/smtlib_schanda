...
(assert (= z (fp #b1 #b10010101 #b00111110110011110110001)))
;; z should be Float32(0xCA9F67B1 [Rational(-10446769, 2), -5223384.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010101 #b00111110110011110110000)))
(check-sat)
(exit)
