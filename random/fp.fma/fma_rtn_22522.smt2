...
(assert (= y (fp #b0 #b10011111 #b10110011101000000011000)))
;; y should be Float32(0x4FD9D018 [Rational(7308587008), 7308587008.000000])
...
(assert (not (= result (fp #b0 #b00100001 #b10110011101000000011000))))
(check-sat)
(exit)
