...
(assert (= y ((_ to_fp 8 24) #x36B1CD5B)))
;; y should be Float32(0x36B1CD5B [Rational(11652443, 2199023255552), 0.000005])
...
(assert (= result (fp #b0 #b11101101 #b01100011100110101011011)))
(check-sat)
(exit)
