...
(assert (= z (fp #b1 #b10001111 #b11110111011000010100110)))
;; z should be Float32(0xC7FBB0A6 [Rational(-8247379, 64), -128865.296875])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10001111 #b11110111011000010100110)))
(check-sat)
(exit)
