...
(assert (= y (fp #b0 #b11010011 #b10100011010110110111110)))
;; y should be Float32(0x69D1ADBE [Rational(31685746322795993868795904), 31685746322795993868795904.000000])
...
(assert (= result (fp #b0 #b00111110 #b10100011010110110111101)))
(check-sat)
(exit)
