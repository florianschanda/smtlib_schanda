...
(assert (= z ((_ to_fp 8 24) #x4ACE47F9)))
;; z should be Float32(0x4ACE47F9 [Rational(13518841, 2), 6759420.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010101 #b10011100100011111111001))))
(check-sat)
(exit)
