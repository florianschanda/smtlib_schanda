...
(assert (= z ((_ to_fp 8 24) #xDE410D66)))
;; z should be Float32(0xDE410D66 [Rational(-3477721743550840832), -3477721743550840832.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #xDE410D66)))
(check-sat)
(exit)
