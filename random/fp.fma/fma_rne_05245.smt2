...
(assert (= y ((_ to_fp 8 24) #xCA12AB9A)))
;; y should be Float32(0xCA12AB9A [Rational(-4806093, 2), -2403046.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b00100101010101110011010))))
(check-sat)
(exit)
