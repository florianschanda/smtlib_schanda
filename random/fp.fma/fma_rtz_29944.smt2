...
(assert (= y ((_ to_fp 8 24) #x8050FE96)))
;; y should be Float32(0x8050FE96 [Rational(-2654027, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFB2F0AF)))
