...
(assert (= x (fp #b1 #b00000000 #b00001010000010011111110)))
;; x should be Float32(0x800504FE [Rational(-164479, 356811923176489970264571492362373784095686656), -0.000000])
