...
(assert (= y (fp #b1 #b00000000 #b11111101011001000101010)))
;; y should be Float32(0x807EB22A [Rational(-4151573, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFD15904)))
