...
(assert (= z (fp #b0 #b11000110 #b00110001100010000100100)))
;; z should be Float32(0x6318C424 [Rational(2818038520734447304704), 2818038520734447304704.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b11000110 #b00110001100010000100100))))
(check-sat)
(exit)
