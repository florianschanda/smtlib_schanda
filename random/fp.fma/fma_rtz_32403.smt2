...
(assert (= z (fp #b0 #b11001101 #b11101100011101110111111)))
;; z should be Float32(0x66F63BBF [Rational(581402137843371415175168), 581402137843371415175168.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x66F63BBF))))
(check-sat)
(exit)
