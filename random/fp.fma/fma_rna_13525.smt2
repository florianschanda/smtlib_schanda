...
(assert (= x ((_ to_fp 8 24) #xFFC1D1A8)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b00000000 #b01111010010010110111110)))
;; y should be Float32(0x003D25BE [Rational(2003679, 356811923176489970264571492362373784095686656), 0.000000])
