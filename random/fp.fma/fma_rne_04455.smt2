...
(assert (= z (fp #b0 #b00000000 #b10011010110011110101111)))
;; z should be Float32(0x004D67AF [Rational(5072815, 713623846352979940529142984724747568191373312), 0.000000])
