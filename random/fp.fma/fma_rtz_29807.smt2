...
(assert (= y ((_ to_fp 8 24) #xC9FAB324)))
;; y should be Float32(0xC9FAB324 [Rational(-4107465, 2), -2053732.500000])
...
(assert (not (= result (fp #b1 #b00000001 #b00111110101011001100100))))
(check-sat)
(exit)
