...
(assert (= z (fp #b1 #b00000000 #b01001110100010000011101)))
;; z should be Float32(0x8027441D [Rational(-2573341, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x8027441D)))
(check-sat)
(exit)
