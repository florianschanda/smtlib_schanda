...
(assert (= y ((_ to_fp 8 24) #x80168D44)))
;; y should be Float32(0x80168D44 [Rational(-369489, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBF346A1F)))
(check-sat)
(exit)
