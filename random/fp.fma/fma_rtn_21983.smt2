...
(assert (= y ((_ to_fp 8 24) #x9B018D65)))
;; y should be Float32(0x9B018D65 [Rational(-8490341, 79228162514264337593543950336), -0.000000])

(declare-const z Float32)
(assert (= z (fp #b0 #b11111111 #b01110111001001110010010)))
