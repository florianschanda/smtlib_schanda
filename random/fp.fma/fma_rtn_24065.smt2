...
(assert (= z (fp #b1 #b10010100 #b01001111100010010111110)))
;; z should be Float32(0xCA27C4BE [Rational(-5497439, 2), -2748719.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10010100 #b01001111100010010111110)))
(check-sat)
(exit)
