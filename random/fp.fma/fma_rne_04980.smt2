...
(assert (= z (fp #b0 #b10010101 #b11010000010011111010101)))
;; z should be Float32(0x4AE827D5 [Rational(15214549, 2), 7607274.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10010101 #b11010000010011111010101)))
(check-sat)
(exit)
