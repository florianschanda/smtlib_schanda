...
(assert (= x (fp #b0 #b00000011 #b01110111010111100100111)))
;; x should be Float32(0x01BBAF27 [Rational(12300071, 178405961588244985132285746181186892047843328), 0.000000])
