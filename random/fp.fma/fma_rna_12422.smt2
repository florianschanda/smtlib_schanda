...
(assert (= y (fp #b0 #b10011001 #b10010101000111110011001)))
;; y should be Float32(0x4CCA8F99 [Rational(106200264), 106200264.000000])
...
(assert (= result ((_ to_fp 8 24) #x825A8F99)))
(check-sat)
(exit)
