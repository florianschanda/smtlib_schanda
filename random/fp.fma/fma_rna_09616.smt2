...
(assert (= x ((_ to_fp 8 24) #x5026E75E)))
;; x should be Float32(0x5026E75E [Rational(11200722944), 11200722944.000000])
...
(assert (= z ((_ to_fp 8 24) #x49C60F8C)))
;; z should be Float32(0x49C60F8C [Rational(3245027, 2), 1622513.500000])
