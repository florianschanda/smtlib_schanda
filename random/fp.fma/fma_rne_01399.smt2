...
(assert (= y (fp #b1 #b11101011 #b00111010110101010011111)))
;; y should be Float32(0xF59D6A9F [Rational(-399098212639548233776320168853504), -399098212639548233776320168853504.000000])
