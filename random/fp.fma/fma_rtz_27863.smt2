...
(assert (= x ((_ to_fp 8 24) #x4A852D47)))
;; x should be Float32(0x4A852D47 [Rational(8727879, 2), 4363939.500000])
...
(assert (= z ((_ to_fp 8 24) #x0046C9BC)))
;; z should be Float32(0x0046C9BC [Rational(1159791, 178405961588244985132285746181186892047843328), 0.000000])
