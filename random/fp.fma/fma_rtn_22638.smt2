...
(assert (= z ((_ to_fp 8 24) #x00770124)))
;; z should be Float32(0x00770124 [Rational(1949769, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x00770123)))
(check-sat)
(exit)
