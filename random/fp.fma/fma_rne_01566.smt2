...
(assert (= z ((_ to_fp 8 24) #x5D750969)))
;; z should be Float32(0x5D750969 [Rational(1103547453925228544), 1103547453925228544.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10111010 #b11101010000100101101001)))
(check-sat)
(exit)
