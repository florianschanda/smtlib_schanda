...
(assert (= z ((_ to_fp 8 24) #x8048E1BB)))
;; z should be Float32(0x8048E1BB [Rational(-4776379, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x8048E1BB))))
(check-sat)
(exit)
