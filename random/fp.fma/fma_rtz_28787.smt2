...
(assert (= z (fp #b0 #b10010100 #b00011110100111011111010)))
;; z should be Float32(0x4A0F4EFA [Rational(4695933, 2), 2347966.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b10010100 #b00011110100111011101010)))
(check-sat)
(exit)
