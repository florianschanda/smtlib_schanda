...
(assert (= z (fp #b0 #b11000000 #b00111100100110111010000)))
;; z should be Float32(0x601E4DD0 [Rational(45628008518471647232), 45628008518471647232.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x601E4DD0))))
(check-sat)
(exit)
