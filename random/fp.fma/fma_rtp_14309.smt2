...
(assert (= x (fp #b0 #b10010101 #b00100010010011101010001)))
;; x should be Float32(0x4A912751 [Rational(9512785, 2), 4756392.500000])
...
(assert (= z ((_ to_fp 8 24) #x4ACF371B)))
;; z should be Float32(0x4ACF371B [Rational(13580059, 2), 6790029.500000])
