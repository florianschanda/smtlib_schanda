...
(assert (= y (fp #b1 #b00000000 #b00110111000000100001010)))
;; y should be Float32(0x801B810A [Rational(-901253, 356811923176489970264571492362373784095686656), -0.000000])
