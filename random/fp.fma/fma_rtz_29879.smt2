...
(assert (= z (fp #b1 #b10010101 #b11101011111111010101101)))
;; z should be Float32(0xCAF5FEAD [Rational(-16121517, 2), -8060758.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #xCAF5FEAD)))
(check-sat)
(exit)
