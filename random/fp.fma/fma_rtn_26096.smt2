...
(assert (= z (fp #b0 #b00000000 #b00011000010110100011110)))
;; z should be Float32(0x000C2D1E [Rational(398991, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x000C2D1D)))
(check-sat)
(exit)
