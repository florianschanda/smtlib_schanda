...
(assert (= y ((_ to_fp 8 24) #xC2581643)))
;; y should be Float32(0xC2581643 [Rational(-14161475, 262144), -54.021740])
...
(assert (not (= result (fp #b0 #b00000110 #b10111000001011001000011))))
(check-sat)
(exit)
