...
(assert (= y ((_ to_fp 8 24) #x800E57C6)))
;; y should be Float32(0x800E57C6 [Rational(-469987, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3EE57C5F)))
(check-sat)
(exit)
