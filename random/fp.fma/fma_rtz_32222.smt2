...
(assert (= z (fp #b1 #b11010001 #b10100011001111110101001)))
;; z should be Float32(0xE8D19FA9 [Rational(-7919358439686944625524736), -7919358439686944625524736.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xE8D19FA9))))
(check-sat)
(exit)
