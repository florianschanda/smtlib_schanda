...
(assert (= z ((_ to_fp 8 24) #x001505EE)))
;; z should be Float32(0x001505EE [Rational(688887, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b00000000 #b00101010000010111101110)))
(check-sat)
(exit)
