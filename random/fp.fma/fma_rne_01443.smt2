...
(assert (= y (fp #b0 #b11111111 #b10010101010101111100001)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b00000000 #b10001000110010001010011)))
;; z should be Float32(0x80446453 [Rational(-4482131, 713623846352979940529142984724747568191373312), -0.000000])
