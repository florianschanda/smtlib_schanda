...
(assert (= x (fp #b1 #b00000000 #b00000110100101101101001)))
;; x should be Float32(0x80034B69 [Rational(-215913, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result (fp #b0 #b01111011 #b10100101101101000111111))))
(check-sat)
(exit)
