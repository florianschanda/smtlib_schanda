...
(assert (= x (fp #b0 #b10010100 #b10100110011001011000010)))
;; x should be Float32(0x4A5332C2 [Rational(6920545, 2), 3460272.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x804B334F))))
(check-sat)
(exit)
