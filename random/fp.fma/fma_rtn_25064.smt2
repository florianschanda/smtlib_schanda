...
(assert (= y (fp #b0 #b00000000 #b11101011011100001111010)))
;; y should be Float32(0x0075B87A [Rational(3857469, 356811923176489970264571492362373784095686656), 0.000000])
