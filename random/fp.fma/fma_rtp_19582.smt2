...
(assert (= x (fp #b1 #b00001000 #b10001000110000101000001)))
;; x should be Float32(0x84446141 [Rational(-12869953, 5575186299632655785383929568162090376495104), -0.000000])
