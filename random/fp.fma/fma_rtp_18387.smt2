...
(assert (= y ((_ to_fp 8 24) #x80781A55)))
;; y should be Float32(0x80781A55 [Rational(-7871061, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b0 #b10000000 #b11100000011010010101010)))
(check-sat)
(exit)
