...
(assert (= x (fp #b0 #b00000000 #b10111111011110111011011)))
;; x should be Float32(0x005FBDDB [Rational(6274523, 713623846352979940529142984724747568191373312), 0.000000])
