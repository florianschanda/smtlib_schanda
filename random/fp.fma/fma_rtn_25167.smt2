...
(assert (= z ((_ to_fp 8 24) #xC968F178)))
;; z should be Float32(0xC968F178 [Rational(-1908271, 2), -954135.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10010010 #b11010001111000100111001))))
(check-sat)
(exit)
