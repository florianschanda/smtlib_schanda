...
(assert (= y ((_ to_fp 8 24) #xE2FB6E02)))
;; y should be Float32(0xE2FB6E02 [Rational(-2319029830397611474944), -2319029830397611474944.000000])
...
(assert (= result ((_ to_fp 8 24) #x987B6E02)))
(check-sat)
(exit)
