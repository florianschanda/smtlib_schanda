...
(assert (= z ((_ to_fp 8 24) #xCA01C1DA)))
;; z should be Float32(0xCA01C1DA [Rational(-4251885, 2), -2125942.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010100 #b00000011100000111011010))))
(check-sat)
(exit)
