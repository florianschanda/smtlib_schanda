...
(assert (= y (fp #b1 #b00000000 #b00100010100110001000110)))
;; y should be Float32(0x80114C46 [Rational(-566819, 356811923176489970264571492362373784095686656), -0.000000])
