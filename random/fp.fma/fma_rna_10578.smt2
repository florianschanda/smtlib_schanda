...
(assert (= x ((_ to_fp 8 24) #xCAC707F3)))
;; x should be Float32(0xCAC707F3 [Rational(-13043699, 2), -6521849.500000])
...
(assert (= result (fp #b1 #b00010111 #b10001110000011111110101)))
(check-sat)
(exit)
