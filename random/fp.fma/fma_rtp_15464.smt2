...
(assert (= z ((_ to_fp 8 24) #xFDBEC74B)))
;; z should be Float32(0xFDBEC74B [Rational(-31698513431837840053135338283328339968), -31698513431837840053135338283328339968.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xFDBEC74B))))
(check-sat)
(exit)
