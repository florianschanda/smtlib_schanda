...
(assert (= x ((_ to_fp 8 24) #xC888B5D0)))
;; x should be Float32(0xC888B5D0 [Rational(-559965, 2), -279982.500000])
...
(assert (not (= result (fp #b1 #b00010011 #b00010001011010110110000))))
(check-sat)
(exit)
