...
(assert (= z ((_ to_fp 8 24) #x7B9B76FF)))
;; z should be Float32(0x7B9B76FF [Rational(1614439081175140633876678120776400896), 1614439081175140633876678120776400896.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x7B9B7700)))
(check-sat)
(exit)
