...
(assert (= x (fp #b0 #b11111111 #b11010000111100100000001)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b10001101 #b11011110000101011100101)))
;; y should be Float32(0x46EF0AE5 [Rational(15665893, 512), 30597.447266])
