...
(assert (= y ((_ to_fp 8 24) #xFD497C7E)))
;; y should be Float32(0xFD497C7E [Rational(-16738826721677279324379776125927161856), -16738826721677279324379776125927161856.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FCAEE8E)))
