...
(assert (= y ((_ to_fp 8 24) #x6F6C507B)))
;; y should be Float32(0x6F6C507B [Rational(73135757234483999519386107904), 73135757234483999519386107904.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xB06C507C))))
(check-sat)
(exit)
