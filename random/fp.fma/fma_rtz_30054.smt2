...
(assert (= x (fp #b0 #b10101100 #b00111000100110010101110)))
;; x should be Float32(0x561C4CAE [Rational(42963287670784), 42963287670784.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x171C4CAC))))
(check-sat)
(exit)
