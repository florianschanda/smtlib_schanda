...
(assert (= x ((_ to_fp 8 24) #x4ADAA671)))
;; x should be Float32(0x4ADAA671 [Rational(14329457, 2), 7164728.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b10110101010011001110000))))
(check-sat)
(exit)
