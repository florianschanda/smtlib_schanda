...
(assert (= z ((_ to_fp 8 24) #xEFB9ED63)))
;; z should be Float32(0xEFB9ED63 [Rational(-115083419500958617846732029952), -115083419500958617846732029952.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b11011111 #b01110011110110101100011)))
(check-sat)
(exit)
