...
(assert (= z (fp #b0 #b10101010 #b00100110111001110011011)))
;; z should be Float32(0x5513739B [Rational(10132795686912), 10132795686912.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x5513739B))))
(check-sat)
(exit)
