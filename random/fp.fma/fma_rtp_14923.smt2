...
(assert (= z (fp #b0 #b01010110 #b01010010100010000000101)))
;; z should be Float32(0x2B294405 [Rational(11092997, 18446744073709551616), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x3500000B)))
(check-sat)
(exit)
