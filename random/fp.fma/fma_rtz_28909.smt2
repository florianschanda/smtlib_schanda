...
(assert (= y (fp #b0 #b10010100 #b01000101101000000001110)))
;; y should be Float32(0x4A22D00E [Rational(5335047, 2), 2667523.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b01000101101000000001100))))
(check-sat)
(exit)
