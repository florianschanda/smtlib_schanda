...
(assert (= x (fp #b1 #b10010101 #b10010101110111100000011)))
;; x should be Float32(0xCACAEF03 [Rational(-13299459, 2), -6649729.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8BCAEF03))))
(check-sat)
(exit)
