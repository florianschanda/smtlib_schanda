...
(assert (= z (fp #b1 #b00000000 #b01110000101110110001100)))
;; z should be Float32(0x80385D8C [Rational(-923491, 178405961588244985132285746181186892047843328), -0.000000])
