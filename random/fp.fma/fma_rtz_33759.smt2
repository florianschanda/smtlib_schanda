...
(assert (= x (fp #b1 #b00000000 #b00001011000110000011011)))
;; x should be Float32(0x80058C1B [Rational(-363547, 713623846352979940529142984724747568191373312), -0.000000])
