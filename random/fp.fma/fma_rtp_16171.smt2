...
(assert (= z (fp #b0 #b10010101 #b11001011100110101111001)))
;; z should be Float32(0x4AE5CD79 [Rational(15060345, 2), 7530172.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x4AE5CD79)))
(check-sat)
(exit)
