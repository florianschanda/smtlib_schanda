...
(assert (= y ((_ to_fp 8 24) #x4AF595BD)))
;; y should be Float32(0x4AF595BD [Rational(16094653, 2), 8047326.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b11101011001010110111011))))
(check-sat)
(exit)
