...
(assert (= y ((_ to_fp 8 24) #xFFCA7012)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b0 #b00000000 #b11100100000101010001101)))
;; z should be Float32(0x00720A8D [Rational(7473805, 713623846352979940529142984724747568191373312), 0.000000])
