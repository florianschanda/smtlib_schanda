...
(assert (= z (fp #b0 #b10010101 #b11001101111110011110001)))
;; z should be Float32(0x4AE6FCF1 [Rational(15138033, 2), 7569016.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10010101 #b11001101111110011101001)))
(check-sat)
(exit)
