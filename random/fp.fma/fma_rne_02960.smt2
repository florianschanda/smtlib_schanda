...
(assert (= x ((_ to_fp 8 24) #x001806E6)))
;; x should be Float32(0x001806E6 [Rational(787315, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result (fp #b0 #b01111110 #b10000000011011100101111)))
(check-sat)
(exit)
