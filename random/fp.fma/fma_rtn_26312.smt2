...
(assert (= y (fp #b1 #b10101010 #b00110000101100011001011)))
;; y should be Float32(0xD51858CB [Rational(-10469195644928), -10469195644928.000000])
...
(assert (= result (fp #b0 #b00010101 #b00110000101100011001010)))
(check-sat)
(exit)
