...
(assert (= z (fp #b0 #b01011010 #b10101100010111010101110)))
;; z should be Float32(0x2D562EAE [Rational(7018327, 576460752303423488), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b01011010 #b10101100010111010101110)))
(check-sat)
(exit)
