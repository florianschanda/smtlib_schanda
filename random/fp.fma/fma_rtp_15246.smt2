...
(assert (= z ((_ to_fp 8 24) #x66C7B6BF)))
;; z should be Float32(0x66C7B6BF [Rational(471561000256467890077696), 471561000256467890077696.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x66C7B6C0)))
(check-sat)
(exit)
