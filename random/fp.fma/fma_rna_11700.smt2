...
(assert (= y ((_ to_fp 8 24) #x4F16069D)))
;; y should be Float32(0x4F16069D [Rational(2517015808), 2517015808.000000])
...
(assert (= result (fp #b1 #b00100000 #b00101100000011010011100)))
(check-sat)
(exit)
