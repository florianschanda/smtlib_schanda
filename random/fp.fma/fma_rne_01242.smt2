...
(assert (= y ((_ to_fp 8 24) #x001E5450)))
;; y should be Float32(0x001E5450 [Rational(124229, 44601490397061246283071436545296723011960832), 0.000000])
...
(assert (not (= result (fp #b0 #b01111110 #b11100101010001001111111))))
(check-sat)
(exit)
