...
(assert (= z (fp #b1 #b00000000 #b00111110111111100111010)))
;; z should be Float32(0x801F7F3A [Rational(-1032093, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b00000000 #b00111110111111100111010)))
(check-sat)
(exit)
