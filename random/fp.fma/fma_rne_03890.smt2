...
(assert (= x ((_ to_fp 8 24) #xC88D31F0)))
;; x should be Float32(0xC88D31F0 [Rational(-578335, 2), -289167.500000])
...
(assert (not (= result (fp #b0 #b00010011 #b00011010011000111010000))))
(check-sat)
(exit)
