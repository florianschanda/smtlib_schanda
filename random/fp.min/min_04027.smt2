...
(assert (= y ((_ to_fp 8 24) #x0009AA51)))
;; y should be Float32(0x0009AA51 [Rational(633425, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.min x y)))
(assert (not (= result (fp #b0 #b00000000 #b00010011010101001010001))))
(check-sat)
(exit)
