...
(assert (= x (fp #b1 #b10010010 #b11011010100111101011000)))
;; x should be Float32(0xC96D4F58 [Rational(-1944043, 2), -972021.500000])
...
(assert (= result (fp #b1 #b10010010 #b11011010100111101011000)))
(check-sat)
(exit)
