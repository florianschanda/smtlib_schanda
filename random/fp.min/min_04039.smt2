...
(assert (= y ((_ to_fp 8 24) #x9BD2518F)))
;; y should be Float32(0x9BD2518F [Rational(-13783439, 39614081257132168796771975168), -0.000000])

(declare-const result Float32)
(assert (= result (fp.min x y)))
(assert (= result ((_ to_fp 8 24) #x9BD2518F)))
(check-sat)
(exit)
