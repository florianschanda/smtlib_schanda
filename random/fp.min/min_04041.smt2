...
(assert (= y ((_ to_fp 8 24) #x807FEB86)))
;; y should be Float32(0x807FEB86 [Rational(-4191683, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.min x y)))
(assert (= result ((_ to_fp 8 24) #x807FEB86)))
(check-sat)
(exit)
