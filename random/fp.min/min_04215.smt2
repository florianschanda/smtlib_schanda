...
(assert (= x (fp #b0 #b00000000 #b01101100111000111011001)))
;; x should be Float32(0x003671D9 [Rational(3568089, 713623846352979940529142984724747568191373312), 0.000000])
