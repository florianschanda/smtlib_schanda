...
(assert (= x (fp #b1 #b00000000 #b00001001010111101100110)))
;; x should be Float32(0x8004AF66 [Rational(-153523, 356811923176489970264571492362373784095686656), -0.000000])
