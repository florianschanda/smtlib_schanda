...
(assert (= x ((_ to_fp 8 24) #xCA9F69FF)))
;; x should be Float32(0xCA9F69FF [Rational(-10447359, 2), -5223679.500000])
...
(assert (not (= result (fp #b1 #b10010101 #b00111110110100111111111))))
(check-sat)
(exit)
