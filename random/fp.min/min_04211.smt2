...
(assert (= x (fp #b0 #b00000000 #b11000011100110100100110)))
;; x should be Float32(0x0061CD26 [Rational(3204755, 356811923176489970264571492362373784095686656), 0.000000])
