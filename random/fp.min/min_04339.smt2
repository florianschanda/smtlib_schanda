...
(assert (= y (fp #b0 #b11100110 #b01000100100001011011100)))
;; y should be Float32(0x732242DC [Rational(12855654301639346683108390862848), 12855654301639346683108390862848.000000])
