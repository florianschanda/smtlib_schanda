...
(assert (= x (fp #b1 #b10010101 #b01110011000110101001011)))
;; x should be Float32(0xCAB98D4B [Rational(-12160331, 2), -6080165.500000])
...
(assert (= result ((_ to_fp 8 24) #xCAB98D4B)))
(check-sat)
(exit)
