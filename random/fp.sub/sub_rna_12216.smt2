...
(assert (= y (fp #b0 #b10010101 #b00010010011111000010011)))
;; y should be Float32(0x4A893E13 [Rational(8994323, 2), 4497161.500000])

(declare-const result Float32)
(assert (= result (fp.sub RNA x y)))
(assert (not (= result (fp #b1 #b10010101 #b00010010011111000010011))))
(check-sat)
(exit)
