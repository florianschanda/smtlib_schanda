...
(assert (= y ((_ to_fp 8 24) #x4A47B13A)))
;; y should be Float32(0x4A47B13A [Rational(6543517, 2), 3271758.500000])

(declare-const result Float32)
(assert (= result (fp.sub RNA x y)))
(assert (not (= result (fp #b1 #b10010100 #b10001111011000100111010))))
(check-sat)
(exit)
