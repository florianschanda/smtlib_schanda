...
(assert (= x (fp #b0 #b10001011 #b00111110110100101000101)))
;; x should be Float32(0x459F6945 [Rational(10447173, 2048), 5101.158691])
...
(assert (= result ((_ to_fp 8 24) #x459F6945)))
(check-sat)
(exit)
