...
(assert (= y ((_ to_fp 8 24) #x80381745)))
;; y should be Float32(0x80381745 [Rational(-3675973, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #x00381746))))
(check-sat)
(exit)
