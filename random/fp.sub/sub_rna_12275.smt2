...
(assert (= x ((_ to_fp 8 24) #xC0D041AF)))
;; x should be Float32(0xC0D041AF [Rational(-13648303, 2097152), -6.508018])
...
(assert (= result (fp #b1 #b10000001 #b10100000100000110101111)))
(check-sat)
(exit)
