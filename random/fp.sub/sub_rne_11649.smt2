...
(assert (= x ((_ to_fp 8 24) #x8009E946)))
;; x should be Float32(0x8009E946 [Rational(-324771, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x8089E945))))
(check-sat)
(exit)
