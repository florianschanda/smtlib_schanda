...
(assert (= x ((_ to_fp 8 24) #x802DC957)))
;; x should be Float32(0x802DC957 [Rational(-3000663, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x80ADC956)))
(check-sat)
(exit)
