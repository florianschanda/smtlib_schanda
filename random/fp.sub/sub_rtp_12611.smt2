...
(assert (= x ((_ to_fp 8 24) #x34D5E538)))
;; x should be Float32(0x34D5E538 [Rational(1752231, 4398046511104), 0.000000])
...
(assert (not (= result (fp #b0 #b01101001 #b10101011110010100111001))))
(check-sat)
(exit)
