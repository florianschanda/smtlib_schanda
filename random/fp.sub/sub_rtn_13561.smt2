...
(assert (= x ((_ to_fp 8 24) #x9CA9121D)))
;; x should be Float32(0x9CA9121D [Rational(-11080221, 9903520314283042199192993792), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x9CA9121D))))
(check-sat)
(exit)
