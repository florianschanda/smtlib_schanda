...
(assert (= y (fp #b0 #b10100010 #b11011000000011101111110)))
;; y should be Float32(0x516C077E [Rational(63358623744), 63358623744.000000])

(declare-const result Float32)
(assert (= result (fp.sub RTN x y)))
(assert (= result ((_ to_fp 8 24) #xD16C077E)))
(check-sat)
(exit)
