...
(assert (= y (fp #b1 #b10010101 #b01110110101001100000001)))
;; y should be Float32(0xCABB5301 [Rational(-12276481, 2), -6138240.500000])

(declare-const result Float32)
(assert (= result (fp.sub RTP x y)))
(assert (= result (fp #b0 #b10010101 #b01110110101001100000010)))
(check-sat)
(exit)
