...
(assert (= x (fp #b1 #b10010101 #b10011001100000101000111)))
;; x should be Float32(0xCACCC147 [Rational(-13418823, 2), -6709411.500000])
...
(assert (= result (fp #b1 #b10010101 #b10011001100000101000111)))
(check-sat)
(exit)
