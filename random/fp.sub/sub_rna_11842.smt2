...
(assert (= y (fp #b1 #b00000000 #b00010110000110100001110)))
;; y should be Float32(0x800B0D0E [Rational(-362119, 356811923176489970264571492362373784095686656), -0.000000])
