...
(assert (= x (fp #b0 #b10010101 #b11011110101101111000111)))
;; x should be Float32(0x4AEF5BC7 [Rational(15686599, 2), 7843299.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x4AEF5BC7))))
(check-sat)
(exit)
