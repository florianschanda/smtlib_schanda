...
(assert (= x (fp #b0 #b00000000 #b11010100101011011110101)))
;; x should be Float32(0x006A56F5 [Rational(6969077, 713623846352979940529142984724747568191373312), 0.000000])
