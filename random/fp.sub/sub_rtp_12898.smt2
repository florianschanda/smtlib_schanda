...
(assert (= x ((_ to_fp 8 24) #xC63B8671)))
;; x should be Float32(0xC63B8671 [Rational(-12289649, 1024), -12001.610352])
...
(assert (= result (fp #b1 #b10001100 #b01110111000011001110001)))
(check-sat)
(exit)
