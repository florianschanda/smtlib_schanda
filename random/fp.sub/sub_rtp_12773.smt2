...
(assert (= y (fp #b0 #b00000000 #b11010010000111010011010)))
;; y should be Float32(0x00690E9A [Rational(3442509, 356811923176489970264571492362373784095686656), 0.000000])
