...
(assert (= y (fp #b0 #b00000000 #b10001011111000001011010)))
;; y should be Float32(0x0045F05A [Rational(2291757, 356811923176489970264571492362373784095686656), 0.000000])
