...
(assert (= y ((_ to_fp 8 24) #x687436FD)))
;; y should be Float32(0x687436FD [Rational(4613087106285861374787584), 4613087106285861374787584.000000])

(declare-const result Float32)
(assert (= result (fp.sub RNE x y)))
(assert (= result ((_ to_fp 8 24) #xE87436FD)))
(check-sat)
(exit)
