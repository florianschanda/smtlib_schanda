...
(assert (= y (fp #b0 #b01010110 #b11111100001100110011101)))
;; y should be Float32(0x2B7E199D [Rational(16652701, 18446744073709551616), 0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #xAB7E199C))))
(check-sat)
(exit)
