...
(assert (= y ((_ to_fp 8 24) #xC93485B8)))
;; y should be Float32(0xC93485B8 [Rational(-1478839, 2), -739419.500000])

(declare-const result Float32)
(assert (= result (fp.sub RNE x y)))
(assert (not (= result (fp #b0 #b10010010 #b01101001000010110111000))))
(check-sat)
(exit)
