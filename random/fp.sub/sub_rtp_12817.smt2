...
(assert (= y ((_ to_fp 8 24) #x96E4E3F3)))
;; y should be Float32(0x96E4E3F3 [Rational(-15000563, 40564819207303340847894502572032), -0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RTP x y)))
(assert (= result ((_ to_fp 8 24) #x16E4E3F3)))
(check-sat)
(exit)
