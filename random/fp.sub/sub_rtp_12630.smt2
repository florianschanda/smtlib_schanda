...
(assert (= x ((_ to_fp 8 24) #x001446CE)))
;; x should be Float32(0x001446CE [Rational(664423, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x806BB931)))
(check-sat)
(exit)
