...
(assert (= x (fp #b0 #b01101000 #b11000010111011001100111)))
;; x should be Float32(0x34617667 [Rational(14775911, 70368744177664), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x34617666)))
(check-sat)
(exit)
