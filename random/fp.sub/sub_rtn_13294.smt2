...
(assert (= x (fp #b0 #b00000000 #b00100111101011100110101)))
;; x should be Float32(0x0013D735 [Rational(1300277, 713623846352979940529142984724747568191373312), 0.000000])
