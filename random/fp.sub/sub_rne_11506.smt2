...
(assert (= y (fp #b1 #b00000000 #b10001001000111100010100)))
;; y should be Float32(0x80448F14 [Rational(-1123269, 178405961588244985132285746181186892047843328), -0.000000])
