...
(assert (= x (fp #b1 #b10010101 #b00110100110110001000101)))
;; x should be Float32(0xCA9A6C45 [Rational(-10120261, 2), -5060130.500000])
...
(assert (= result (fp #b1 #b10010101 #b00110100110110001000101)))
(check-sat)
(exit)
