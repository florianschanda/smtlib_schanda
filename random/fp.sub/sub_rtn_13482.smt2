...
(assert (= y (fp #b0 #b01100110 #b11011111000100000111100)))
;; y should be Float32(0x336F883C [Rational(3924495, 70368744177664), 0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RTN x y)))
(assert (not (= result ((_ to_fp 8 24) #xB36F883D))))
(check-sat)
(exit)
