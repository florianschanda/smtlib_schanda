...
(assert (= x ((_ to_fp 8 24) #x4AC346B9)))
;; x should be Float32(0x4AC346B9 [Rational(12797625, 2), 6398812.500000])
...
(assert (= result (fp #b0 #b10010101 #b10000110100011010111001)))
(check-sat)
(exit)
