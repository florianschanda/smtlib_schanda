...
(assert (= x (fp #b1 #b10010101 #b11110001111001100101111)))
;; x should be Float32(0xCAF8F32F [Rational(-16315183, 2), -8157591.500000])
...
(assert (not (= result ((_ to_fp 8 24) #xCAF8F32F))))
(check-sat)
(exit)
