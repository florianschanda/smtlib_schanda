...
(assert (= y (fp #b1 #b10010100 #b11010001001100011100110)))
;; y should be Float32(0xCA6898E6 [Rational(-7621747, 2), -3810873.500000])

(declare-const result Float32)
(assert (= result (fp.sub RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #x4A6898E5))))
(check-sat)
(exit)
