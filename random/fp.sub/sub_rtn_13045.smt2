...
(assert (= x (fp #b0 #b10010101 #b11000001100011001000001)))
;; x should be Float32(0x4AE0C641 [Rational(14730817, 2), 7365408.500000])
...
(assert (= result ((_ to_fp 8 24) #x4AE0C640)))
(check-sat)
(exit)
