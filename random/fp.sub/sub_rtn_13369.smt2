...
(assert (= x (fp #b1 #b10010010 #b00101010101111110011000)))
;; x should be Float32(0xC9155F98 [Rational(-1223667, 2), -611833.500000])
...
(assert (= result (fp #b1 #b10010010 #b00101010101111110011000)))
(check-sat)
(exit)
