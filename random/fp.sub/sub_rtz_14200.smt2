...
(assert (= x ((_ to_fp 8 24) #xE9781FAC)))
;; x should be Float32(0xE9781FAC [Rational(-18747698091586104523227136), -18747698091586104523227136.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xE9781FAB))))
(check-sat)
(exit)
