...
(assert (= x (fp #b1 #b10010101 #b00110110101111110011111)))
;; x should be Float32(0xCA9B5F9F [Rational(-10182559, 2), -5091279.500000])
...
(assert (not (= result ((_ to_fp 8 24) #xCA9B5FA0))))
(check-sat)
(exit)
