...
(assert (= x ((_ to_fp 8 24) #x4AFF031B)))
;; x should be Float32(0x4AFF031B [Rational(16712475, 2), 8356237.500000])
...
(assert (not (= result (fp #b0 #b10010101 #b11111110000001100011010))))
(check-sat)
(exit)
