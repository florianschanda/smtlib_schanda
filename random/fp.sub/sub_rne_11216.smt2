...
(assert (= y (fp #b0 #b01001001 #b11001011111111010001011)))
;; y should be Float32(0x24E5FE8B [Rational(15072907, 151115727451828646838272), 0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RNE x y)))
(assert (= result ((_ to_fp 8 24) #xA4E5FE8B)))
(check-sat)
(exit)
