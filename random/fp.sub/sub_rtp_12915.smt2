...
(assert (= x ((_ to_fp 8 24) #xCDAB885B)))
;; x should be Float32(0xCDAB885B [Rational(-359730016), -359730016.000000])
...
(assert (not (= result (fp #b1 #b10011011 #b01010111000100001011010))))
(check-sat)
(exit)
