...
(assert (= y ((_ to_fp 8 24) #xC9287008)))
;; y should be Float32(0xC9287008 [Rational(-1379841, 2), -689920.500000])

(declare-const result Float32)
(assert (= result (fp.sub RNE x y)))
(assert (not (= result (fp #b0 #b10010010 #b01010000111000000001000))))
(check-sat)
(exit)
