...
(assert (= y ((_ to_fp 8 24) #x4AEADACF)))
;; y should be Float32(0x4AEADACF [Rational(15391439, 2), 7695719.500000])

(declare-const result Float32)
(assert (= result (fp.sub RNA x y)))
(assert (= result (fp #b1 #b10010101 #b11010101101101011001111)))
(check-sat)
(exit)
