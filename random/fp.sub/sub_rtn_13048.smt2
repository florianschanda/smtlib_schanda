...
(assert (= x ((_ to_fp 8 24) #x4AD7E625)))
;; x should be Float32(0x4AD7E625 [Rational(14149157, 2), 7074578.500000])
...
(assert (not (= result (fp #b0 #b10010101 #b10101111110011000100100))))
(check-sat)
(exit)
