...
(assert (= y ((_ to_fp 8 24) #x006A7B84)))
;; y should be Float32(0x006A7B84 [Rational(1744609, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #x80EA7B83))))
(check-sat)
(exit)
