...
(assert (= x (fp #b1 #b00000000 #b10010010011100110111010)))
;; x should be Float32(0x804939BA [Rational(-2399453, 356811923176489970264571492362373784095686656), -0.000000])
