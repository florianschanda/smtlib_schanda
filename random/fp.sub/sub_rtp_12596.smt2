...
(assert (= x ((_ to_fp 8 24) #x225FCB35)))
;; x should be Float32(0x225FCB35 [Rational(14666549, 4835703278458516698824704), 0.000000])
...
(assert (= result (fp #b0 #b01000100 #b10111111100101100110101)))
(check-sat)
(exit)
