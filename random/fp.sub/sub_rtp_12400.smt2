...
(assert (= x (fp #b0 #b10010101 #b00010110100000010101111)))
;; x should be Float32(0x4A8B40AF [Rational(9126063, 2), 4563031.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x4A8B40AF))))
(check-sat)
(exit)
