...
(assert (= x ((_ to_fp 8 24) #xD067D9DF)))
;; x should be Float32(0xD067D9DF [Rational(-15559261184), -15559261184.000000])
...
(assert (= result (fp #b1 #b10100000 #b11001111101100111011111)))
(check-sat)
(exit)
