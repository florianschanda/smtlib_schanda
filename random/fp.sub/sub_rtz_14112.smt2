...
(assert (= y ((_ to_fp 8 24) #x4AD31231)))
;; y should be Float32(0x4AD31231 [Rational(13832753, 2), 6916376.500000])

(declare-const result Float32)
(assert (= result (fp.sub RTZ x y)))
(assert (= result (fp #b1 #b10010101 #b10100110001001000110001)))
(check-sat)
(exit)
