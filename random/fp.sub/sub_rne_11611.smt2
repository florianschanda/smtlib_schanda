...
(assert (= x ((_ to_fp 8 24) #x809F8972)))
;; x should be Float32(0x809F8972 [Rational(-5227705, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x810FC4B8)))
(check-sat)
(exit)
