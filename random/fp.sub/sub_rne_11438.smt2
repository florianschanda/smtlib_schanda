...
(assert (= x (fp #b1 #b10010000 #b10111000001000110100000)))
;; x should be Float32(0xC85C11A0 [Rational(-450701, 2), -225350.500000])
...
(assert (= result (fp #b1 #b10010000 #b10111000001000110100000)))
(check-sat)
(exit)
