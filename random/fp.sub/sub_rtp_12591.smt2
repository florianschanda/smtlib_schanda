...
(assert (= x ((_ to_fp 8 24) #x2750DF62)))
;; x should be Float32(0x2750DF62 [Rational(6844337, 2361183241434822606848), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x2750DF62))))
(check-sat)
(exit)
