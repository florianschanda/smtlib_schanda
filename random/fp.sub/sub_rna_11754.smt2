...
(assert (= x (fp #b0 #b10010101 #b10000110101010000011111)))
;; x should be Float32(0x4AC3541F [Rational(12801055, 2), 6400527.500000])
...
(assert (not (= result (fp #b0 #b10010101 #b10000110101010000011111))))
(check-sat)
(exit)
