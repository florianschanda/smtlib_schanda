...
(assert (= x (fp #b0 #b10010100 #b00001111001101001100110)))
;; x should be Float32(0x4A079A66 [Rational(4443443, 2), 2221721.500000])
...
(assert (not (= result (fp #b0 #b10010100 #b00001111001101001100110))))
(check-sat)
(exit)
