...
(assert (= y (fp #b1 #b01011100 #b00101110111011101100010)))
;; y should be Float32(0xAE177762 [Rational(-4963249, 144115188075855872), -0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RNE x y)))
(assert (not (= result ((_ to_fp 8 24) #x2E177762))))
(check-sat)
(exit)
