...
(assert (= x (fp #b1 #b11000010 #b01001101111000011100111)))
;; x should be Float32(0xE126F0E7 [Rational(-192469897470281777152), -192469897470281777152.000000])
...
(assert (= result ((_ to_fp 8 24) #xE126F0E7)))
(check-sat)
(exit)
