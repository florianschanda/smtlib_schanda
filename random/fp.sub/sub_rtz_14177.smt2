...
(assert (= x (fp #b1 #b10000011 #b11001011110000010100111)))
;; x should be Float32(0xC1E5E0A7 [Rational(-15065255, 524288), -28.734694])
...
(assert (= result ((_ to_fp 8 24) #xC1E5E0A7)))
(check-sat)
(exit)
