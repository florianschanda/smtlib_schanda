...
(assert (= y ((_ to_fp 8 24) #xCA188AC6)))
;; y should be Float32(0xCA188AC6 [Rational(-4998499, 2), -2499249.500000])

(declare-const result Float32)
(assert (= result (fp.sub RTN x y)))
(assert (not (= result (fp #b0 #b10010100 #b00110001000101011000101))))
(check-sat)
(exit)
