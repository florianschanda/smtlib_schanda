...
(assert (= x (fp #b1 #b00000000 #b10100000100101000001111)))
;; x should be Float32(0x80504A0F [Rational(-5261839, 713623846352979940529142984724747568191373312), -0.000000])
