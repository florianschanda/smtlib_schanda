...
(assert (= x (fp #b1 #b10010101 #b01001000011011100100011)))
;; x should be Float32(0xCAA43723 [Rational(-10762019, 2), -5381009.500000])
...
(assert (not (= result ((_ to_fp 8 24) #xCAA43722))))
(check-sat)
(exit)
