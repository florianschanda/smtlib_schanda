...
(assert (= x (fp #b0 #b01101101 #b01011011100111100001010)))
;; x should be Float32(0x36ADCF0A [Rational(5695365, 1099511627776), 0.000005])
...
(assert (not (= result (fp #b0 #b01101101 #b01011011100111100001010))))
(check-sat)
(exit)
