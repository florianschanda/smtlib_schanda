...
(assert (= y (fp #b0 #b10110111 #b00000000101111010001111)))
;; y should be Float32(0x5B805E8F [Rational(72265530584596480), 72265530584596480.000000])

(declare-const result Float32)
(assert (= result (fp.sub RNA x y)))
(assert (= result ((_ to_fp 8 24) #xDB805E8F)))
(check-sat)
(exit)
