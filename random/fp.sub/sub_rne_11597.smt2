...
(assert (= y (fp #b1 #b10110010 #b10001110011001101100100)))
;; y should be Float32(0xD9473364 [Rational(-3504376559697920), -3504376559697920.000000])

(declare-const result Float32)
(assert (= result (fp.sub RNE x y)))
(assert (not (= result ((_ to_fp 8 24) #x59473364))))
(check-sat)
(exit)
