...
(assert (= y (fp #b0 #b00000000 #b10101000001000110101001)))
;; y should be Float32(0x005411A9 [Rational(5509545, 713623846352979940529142984724747568191373312), 0.000000])
