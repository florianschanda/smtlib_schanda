...
(assert (= y (fp #b1 #b01101101 #b00110111001101000011110)))
;; y should be Float32(0xB69B9A1E [Rational(-5098767, 1099511627776), -0.000005])

(declare-const result Float32)
(assert (= result (fp.sub RNA x y)))
(assert (not (= result ((_ to_fp 8 24) #x369B9A1E))))
(check-sat)
(exit)
