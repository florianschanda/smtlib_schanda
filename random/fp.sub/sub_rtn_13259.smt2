...
(assert (= x ((_ to_fp 8 24) #x59428B5E)))
;; x should be Float32(0x59428B5E [Rational(3422461332815872), 3422461332815872.000000])
...
(assert (not (= result (fp #b0 #b10110010 #b10000101000101101011110))))
(check-sat)
(exit)
