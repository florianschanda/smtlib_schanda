...
(assert (= y ((_ to_fp 8 24) #x4AD0B693)))
;; y should be Float32(0x4AD0B693 [Rational(13678227, 2), 6839113.500000])

(declare-const result Float32)
(assert (= result (fp.sub RTP x y)))
(assert (not (= result (fp #b1 #b10010101 #b10100001011011010010010))))
(check-sat)
(exit)
