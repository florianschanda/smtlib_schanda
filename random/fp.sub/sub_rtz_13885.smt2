...
(assert (= x ((_ to_fp 8 24) #x5CA79B7C)))
;; x should be Float32(0x5CA79B7C [Rational(377418223911436288), 377418223911436288.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x5CA79B7B))))
(check-sat)
(exit)
