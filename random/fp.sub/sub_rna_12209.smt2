...
(assert (= y (fp #b1 #b01001110 #b10001111111101101010100)))
;; y should be Float32(0xA747FB54 [Rational(-3276501, 1180591620717411303424), -0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RNA x y)))
(assert (= result ((_ to_fp 8 24) #x2747FB54)))
(check-sat)
(exit)
