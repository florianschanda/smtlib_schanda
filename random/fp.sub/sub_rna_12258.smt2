...
(assert (= x ((_ to_fp 8 24) #x9815F246)))
;; x should be Float32(0x9815F246 [Rational(-4913443, 2535301200456458802993406410752), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x9815F246))))
(check-sat)
(exit)
