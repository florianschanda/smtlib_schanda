...
(assert (= y ((_ to_fp 8 24) #xC9BBDFEC)))
;; y should be Float32(0xC9BBDFEC [Rational(-3078139, 2), -1539069.500000])

(declare-const result Float32)
(assert (= result (fp.sub RNE x y)))
(assert (not (= result (fp #b0 #b10010011 #b01110111101111111101100))))
(check-sat)
(exit)
