...
(assert (= x (fp #b0 #b10010101 #b11011011011001110010111)))
;; x should be Float32(0x4AEDB397 [Rational(15578007, 2), 7789003.500000])
...
(assert (= result ((_ to_fp 8 24) #x4AEDB397)))
(check-sat)
(exit)
