...
(assert (= x (fp #b1 #b10010101 #b11001111010110001000011)))
;; x should be Float32(0xCAE7AC43 [Rational(-15182915, 2), -7591457.500000])
...
(assert (not (= result ((_ to_fp 8 24) #xCAE7AC44))))
(check-sat)
(exit)
