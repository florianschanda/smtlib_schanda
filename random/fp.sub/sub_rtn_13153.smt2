...
(assert (= y ((_ to_fp 8 24) #xCAFC502B)))
;; y should be Float32(0xCAFC502B [Rational(-16535595, 2), -8267797.500000])

(declare-const result Float32)
(assert (= result (fp.sub RTN x y)))
(assert (not (= result (fp #b0 #b10010101 #b11111000101000000101011))))
(check-sat)
(exit)
