...
(assert (= x (fp #b0 #b10010100 #b10100010100001111111010)))
;; x should be Float32(0x4A5143FA [Rational(6857213, 2), 3428606.500000])
...
(assert (not (= result (fp #b0 #b10010100 #b10100010100001111111010))))
(check-sat)
(exit)
