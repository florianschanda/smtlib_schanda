...
(assert (= x ((_ to_fp 8 24) #x001693B7)))
;; x should be Float32(0x001693B7 [Rational(1479607, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x001693B8))))
(check-sat)
(exit)
