...
(assert (= x (fp #b0 #b00000000 #b11010000010110011001110)))
;; x should be Float32(0x00682CCE [Rational(3413607, 356811923176489970264571492362373784095686656), 0.000000])
