...
(assert (= x (fp #b0 #b10010101 #b00001011001101100001101)))
;; x should be Float32(0x4A859B0D [Rational(8755981, 2), 4377990.500000])
...
(assert (= result (fp #b0 #b00010101 #b00001011001101100001101)))
(check-sat)
(exit)
