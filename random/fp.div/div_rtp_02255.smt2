...
(assert (= x (fp #b0 #b00000000 #b01000111011001001010101)))
;; x should be Float32(0x0023B255 [Rational(2339413, 713623846352979940529142984724747568191373312), 0.000000])
