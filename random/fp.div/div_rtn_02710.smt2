...
(assert (= y (fp #b0 #b10010101 #b10100100101011011000001)))
;; y should be Float32(0x4AD256C1 [Rational(13784769, 2), 6892384.500000])

(declare-const result Float32)
(assert (= result (fp.div RTN x y)))
(assert (not (= result (fp #b0 #b11101000 #b00110111100100101100100))))
(check-sat)
(exit)
