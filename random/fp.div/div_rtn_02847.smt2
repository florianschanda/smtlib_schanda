...
(assert (= x (fp #b0 #b11100010 #b11011111001100011010100)))
;; x should be Float32(0x716F98D4 [Rational(1186426803417236214793013035008), 1186426803417236214793013035008.000000])
