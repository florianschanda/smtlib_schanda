...
(assert (= y (fp #b0 #b10010001 #b11101001011000001110000)))
;; y should be Float32(0x48F4B070 [Rational(1002247, 2), 501123.500000])

(declare-const result Float32)
(assert (= result (fp.div RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #x00000010))))
(check-sat)
(exit)
