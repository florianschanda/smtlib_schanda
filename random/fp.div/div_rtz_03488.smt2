...
(assert (= y ((_ to_fp 8 24) #xFEE768EB)))
;; y should be Float32(0xFEE768EB [Rational(-153798216132930023428348115073525350400), -153798216132930023428348115073525350400.000000])
