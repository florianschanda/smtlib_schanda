...
(assert (= x (fp #b0 #b00000000 #b11101001110001111100101)))
;; x should be Float32(0x0074E3E5 [Rational(7660517, 713623846352979940529142984724747568191373312), 0.000000])
