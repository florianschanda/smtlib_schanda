...
(assert (= y (fp #b1 #b10010010 #b11010000110000111011000)))
;; y should be Float32(0xC96861D8 [Rational(-1903675, 2), -951837.500000])

(declare-const result Float32)
(assert (= result (fp.div RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #xF58D0252))))
(check-sat)
(exit)
