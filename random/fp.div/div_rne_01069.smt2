...
(assert (= y (fp #b0 #b00000000 #b10101111010010001001100)))
;; y should be Float32(0x0057A44C [Rational(1435923, 178405961588244985132285746181186892047843328), 0.000000])
