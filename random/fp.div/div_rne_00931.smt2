...
(assert (= x ((_ to_fp 8 24) #x00693F29)))
;; x should be Float32(0x00693F29 [Rational(6897449, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x4AD27E52)))
(check-sat)
(exit)
