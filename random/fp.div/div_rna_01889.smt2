...
(assert (= x (fp #b1 #b00000000 #b10111011011001001011010)))
;; x should be Float32(0x805DB25A [Rational(-3070253, 356811923176489970264571492362373784095686656), -0.000000])
