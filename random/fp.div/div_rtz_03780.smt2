...
(assert (= y ((_ to_fp 8 24) #x0062D020)))
;; y should be Float32(0x0062D020 [Rational(202369, 22300745198530623141535718272648361505980416), 0.000000])

(declare-const result Float32)
(assert (= result (fp.div RTZ x y)))
(assert (= result ((_ to_fp 8 24) #xB425CEE3)))
(check-sat)
(exit)
