...
(assert (= x (fp #b1 #b10010101 #b11110001101110111110101)))
;; x should be Float32(0xCAF8DDF5 [Rational(-16309749, 2), -8154874.500000])
...
(assert (= result (fp #b1 #b00010101 #b11110001101110111110101)))
(check-sat)
(exit)
