...
(assert (= x ((_ to_fp 8 24) #xC5F71096)))
;; x should be Float32(0xC5F71096 [Rational(-8095819, 1024), -7906.073242])
...
(assert (not (= result (fp #b1 #b00001011 #b11101110001000010010111))))
(check-sat)
(exit)
