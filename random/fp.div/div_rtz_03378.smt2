...
(assert (= y (fp #b0 #b00000000 #b11010100000000111101010)))
;; y should be Float32(0x006A01EA [Rational(3473653, 356811923176489970264571492362373784095686656), 0.000000])
