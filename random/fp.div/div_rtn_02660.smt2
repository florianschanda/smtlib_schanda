...
(assert (= x ((_ to_fp 8 24) #x4AA1287D)))
;; x should be Float32(0x4AA1287D [Rational(10561661, 2), 5280830.500000])
...
(assert (= result (fp #b1 #b00010101 #b01000010010100001111110)))
(check-sat)
(exit)
