...
(assert (= y ((_ to_fp 8 24) #x002C0251)))
;; y should be Float32(0x002C0251 [Rational(2884177, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.div RNA x y)))
(assert (not (= result ((_ to_fp 8 24) #xB4BA24BF))))
(check-sat)
(exit)
