...
(assert (= x ((_ to_fp 8 24) #x49C58BAC)))
;; x should be Float32(0x49C58BAC [Rational(3236587, 2), 1618293.500000])
...
(assert (not (= result (fp #b1 #b00010011 #b10001011000101110101100))))
(check-sat)
(exit)
