...
(assert (= y (fp #b1 #b00000000 #b10011011110101111100100)))
;; y should be Float32(0x804DEBE4 [Rational(-1276665, 178405961588244985132285746181186892047843328), -0.000000])
