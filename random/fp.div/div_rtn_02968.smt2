...
(assert (= x ((_ to_fp 8 24) #xCAE7611D)))
;; x should be Float32(0xCAE7611D [Rational(-15163677, 2), -7581838.500000])
...
(assert (not (= result (fp #b0 #b00010101 #b11001110110000100011101))))
(check-sat)
(exit)
