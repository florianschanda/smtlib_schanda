...
(assert (= x ((_ to_fp 8 24) #x807893CA)))
;; x should be Float32(0x807893CA [Rational(-3951077, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3F712795))))
(check-sat)
(exit)
