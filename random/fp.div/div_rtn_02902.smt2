...
(assert (= x ((_ to_fp 8 24) #x00093C1F)))
;; x should be Float32(0x00093C1F [Rational(605215, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC913C1F0)))
(check-sat)
(exit)
