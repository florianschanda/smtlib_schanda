...
(assert (= x ((_ to_fp 8 24) #xFC199211)))
;; x should be Float32(0xFC199211 [Rational(-3189535992146898054163205309222354944), -3189535992146898054163205309222354944.000000])
...
(assert (= result ((_ to_fp 8 24) #x3C199211)))
(check-sat)
(exit)
