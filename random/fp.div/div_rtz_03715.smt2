...
(assert (= y (fp #b0 #b01111100 #b11100111100000001000010)))
;; y should be Float32(0x3E73C042 [Rational(7987233, 33554432), 0.238038])

(declare-const result Float32)
(assert (= result (fp.div RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #x81866EA7))))
(check-sat)
(exit)
