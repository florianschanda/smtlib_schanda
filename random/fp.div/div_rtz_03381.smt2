...
(assert (= y (fp #b1 #b10010101 #b01100101110010101111001)))
;; y should be Float32(0xCAB2E579 [Rational(-11724153, 2), -5862076.500000])

(declare-const result Float32)
(assert (= result (fp.div RTZ x y)))
(assert (not (= result (fp #b1 #b11101000 #b01101110010101011011111))))
(check-sat)
(exit)
