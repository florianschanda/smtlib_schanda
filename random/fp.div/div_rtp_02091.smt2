...
(assert (= y (fp #b1 #b00000000 #b00010000001010101001110)))
;; y should be Float32(0x8008154E [Rational(-264871, 356811923176489970264571492362373784095686656), -0.000000])
