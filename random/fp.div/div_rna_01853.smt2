...
(assert (= x (fp #b1 #b00111000 #b11101101010111101100011)))
;; x should be Float32(0x9C76AF63 [Rational(-16166755, 19807040628566084398385987584), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xDB76AF65)))
(check-sat)
(exit)
