...
(assert (= y (fp #b0 #b10000101 #b11101110101011000101110)))
;; y should be Float32(0x42F7562E [Rational(8104727, 65536), 123.668320])

(declare-const result Float32)
(assert (= result (fp.div RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #x7C047BBF))))
(check-sat)
(exit)
