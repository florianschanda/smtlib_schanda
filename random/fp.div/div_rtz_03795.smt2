...
(assert (= y ((_ to_fp 8 24) #x802CEA86)))
;; y should be Float32(0x802CEA86 [Rational(-1471811, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.div RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #x34B6626C))))
(check-sat)
(exit)
