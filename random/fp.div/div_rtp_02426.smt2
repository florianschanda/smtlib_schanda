...
(assert (= y ((_ to_fp 8 24) #x96C1A92B)))
;; y should be Float32(0x96C1A92B [Rational(-12691755, 40564819207303340847894502572032), -0.000000])

(declare-const result Float32)
(assert (= result (fp.div RTP x y)))
(assert (= result ((_ to_fp 8 24) #x292933FA)))
(check-sat)
(exit)
