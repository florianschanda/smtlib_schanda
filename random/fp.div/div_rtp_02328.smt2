...
(assert (= x (fp #b1 #b10010100 #b01011001111111000011010)))
;; x should be Float32(0xCA2CFE1A [Rational(-5668621, 2), -2834310.500000])
...
(assert (not (= result (fp #b0 #b00010100 #b01011001111111000011011))))
(check-sat)
(exit)
