...
(assert (= y (fp #b0 #b10111101 #b10000111100001100000111)))
;; y should be Float32(0x5EC3C307 [Rational(7053063077217959936), 7053063077217959936.000000])

(declare-const result Float32)
(assert (= result (fp.div RTN x y)))
(assert (= result ((_ to_fp 8 24) #x60276316)))
(check-sat)
(exit)
