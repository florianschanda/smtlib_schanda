...
(assert (= y ((_ to_fp 8 24) #x80604EA6)))
;; y should be Float32(0x80604EA6 [Rational(-3155795, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.div RTZ x y)))
(assert (= result ((_ to_fp 8 24) #x3FAA1F49)))
(check-sat)
(exit)
