...
(assert (= y ((_ to_fp 8 24) #x731CE46E)))
;; y should be Float32(0x731CE46E [Rational(12430288916304660949471324012544), 12430288916304660949471324012544.000000])

(declare-const result Float32)
(assert (= result (fp.div RTP x y)))
(assert (= result ((_ to_fp 8 24) #xCBD0DB4C)))
(check-sat)
(exit)
