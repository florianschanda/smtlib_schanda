...
(assert (= x (fp #b1 #b00000000 #b11000101001001100011101)))
;; x should be Float32(0x8062931D [Rational(-6460189, 713623846352979940529142984724747568191373312), -0.000000])
