...
(assert (= x ((_ to_fp 8 24) #xCEB7D8F5)))
;; x should be Float32(0xCEB7D8F5 [Rational(-1542224512), -1542224512.000000])
...
(assert (not (= result (fp #b0 #b00011101 #b01101111101100011110110))))
(check-sat)
(exit)
