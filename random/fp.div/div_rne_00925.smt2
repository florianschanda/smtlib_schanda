...
(assert (= x (fp #b0 #b00000000 #b01010101011101011111011)))
;; x should be Float32(0x002ABAFB [Rational(2800379, 713623846352979940529142984724747568191373312), 0.000000])
