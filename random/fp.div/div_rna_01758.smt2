...
(assert (= y ((_ to_fp 8 24) #x3B139E6D)))
;; y should be Float32(0x3B139E6D [Rational(9674349, 4294967296), 0.002252])

(declare-const result Float32)
(assert (= result (fp.div RNA x y)))
(assert (= result (fp #b1 #b00001001 #b10111011111101000100000)))
(check-sat)
(exit)
