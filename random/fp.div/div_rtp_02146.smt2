...
(assert (= y (fp #b1 #b10010010 #b10010010110001111001000)))
;; y should be Float32(0xC94963C8 [Rational(-1649785, 2), -824892.500000])

(declare-const result Float32)
(assert (= result (fp.div RTP x y)))
(assert (= result (fp #b1 #b00000000 #b00000000000000000001010)))
(check-sat)
(exit)
