...
(assert (= x ((_ to_fp 8 24) #x982C30AC)))
;; x should be Float32(0x982C30AC [Rational(-2821163, 1267650600228229401496703205376), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xD72C30AD)))
(check-sat)
(exit)
