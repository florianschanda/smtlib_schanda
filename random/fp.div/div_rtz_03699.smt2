...
(assert (= y (fp #b1 #b00000000 #b00101110000001110011100)))
;; y should be Float32(0x8017039C [Rational(-377063, 178405961588244985132285746181186892047843328), -0.000000])
