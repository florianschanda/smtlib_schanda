...
(assert (= y ((_ to_fp 8 24) #xC28AFF44)))
;; y should be Float32(0xC28AFF44 [Rational(-2277329, 32768), -69.498566])

(declare-const result Float32)
(assert (= result (fp.div RNA x y)))
(assert (not (= result (fp #b0 #b00000000 #b00000011101011101111110))))
(check-sat)
(exit)
