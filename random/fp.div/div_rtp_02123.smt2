...
(assert (= y ((_ to_fp 8 24) #x94310D2A)))
;; y should be Float32(0x94310D2A [Rational(-5801621, 649037107316853453566312041152512), -0.000000])

(declare-const result Float32)
(assert (= result (fp.div RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #xABB9137E))))
(check-sat)
(exit)
