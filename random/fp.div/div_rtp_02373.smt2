...
(assert (= y ((_ to_fp 8 24) #x49C1E9BC)))
;; y should be Float32(0x49C1E9BC [Rational(3177071, 2), 1588535.500000])

(declare-const result Float32)
(assert (= result (fp.div RTP x y)))
(assert (not (= result (fp #b1 #b11101010 #b01010001111101110100011))))
(check-sat)
(exit)
