...
(assert (= y (fp #b0 #b10010011 #b10011001001111011100100)))
;; y should be Float32(0x49CC9EE4 [Rational(3352505, 2), 1676252.500000])

(declare-const result Float32)
(assert (= result (fp.div RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #x80000005))))
(check-sat)
(exit)
