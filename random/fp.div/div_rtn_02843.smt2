...
(assert (= x ((_ to_fp 8 24) #x1E045E69)))
;; x should be Float32(0x1E045E69 [Rational(8674921, 1237940039285380274899124224), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x5D045E6A)))
(check-sat)
(exit)
