...
(assert (= x (fp #b0 #b01000000 #b01011000010000101000001)))
;; x should be Float32(0x202C2141 [Rational(11280705, 77371252455336267181195264), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xEAAC2141)))
(check-sat)
(exit)
