...
(assert (= x ((_ to_fp 8 24) #x800E202B)))
;; x should be Float32(0x800E202B [Rational(-925739, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3DE202B2)))
(check-sat)
(exit)
