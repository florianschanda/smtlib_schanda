...
(assert (= x ((_ to_fp 8 24) #x8001E6B2)))
;; x should be Float32(0x8001E6B2 [Rational(-62297, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBC735902))))
(check-sat)
(exit)
