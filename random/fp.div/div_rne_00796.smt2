...
(assert (= y (fp #b0 #b10000110 #b01111100001110101001111)))
;; y should be Float32(0x433E1D4F [Rational(12459343, 65536), 190.114487])

(declare-const result Float32)
(assert (= result (fp.div RNE x y)))
(assert (not (= result (fp #b0 #b00000000 #b00000001010110001011100))))
(check-sat)
(exit)
