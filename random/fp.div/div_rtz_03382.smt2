...
(assert (= y (fp #b1 #b10010011 #b11011001101100000101100)))
;; y should be Float32(0xC9ECD82C [Rational(-3880459, 2), -1940229.500000])

(declare-const result Float32)
(assert (= result (fp.div RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #xF50A5A37))))
(check-sat)
(exit)
