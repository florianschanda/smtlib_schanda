...
(assert (= x ((_ to_fp 8 24) #xFAF65BBA)))
;; x should be Float32(0xFAF65BBA [Rational(-639582731455863775896936848014966784), -639582731455863775896936848014966784.000000])
