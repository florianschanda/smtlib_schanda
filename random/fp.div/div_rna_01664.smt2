...
(assert (= x (fp #b1 #b10010101 #b01011110110001011100111)))
;; x should be Float32(0xCAAF62E7 [Rational(-11494119, 2), -5747059.500000])
...
(assert (not (= result (fp #b0 #b00010101 #b01011110110001011101000))))
(check-sat)
(exit)
