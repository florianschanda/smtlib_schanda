...
(assert (= y (fp #b0 #b01100111 #b01110100101001001101110)))
;; y should be Float32(0x33BA526E [Rational(6105399, 70368744177664), 0.000000])

(declare-const result Float32)
(assert (= result (fp.div RNA x y)))
(assert (= result (fp #b0 #b00011000 #b01011111101111000011001)))
(check-sat)
(exit)
