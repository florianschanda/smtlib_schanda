...
(assert (= x ((_ to_fp 8 24) #x679E022C)))
;; x should be Float32(0x679E022C [Rational(1492347936631378063392768), 1492347936631378063392768.000000])
...
(assert (= result (fp #b0 #b01001111 #b00111100000001000101101)))
(check-sat)
(exit)
