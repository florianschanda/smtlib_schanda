...
(assert (= y ((_ to_fp 8 24) #x003DAE72)))
;; y should be Float32(0x003DAE72 [Rational(2021177, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.div RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #x4004CFBB))))
(check-sat)
(exit)
