...
(assert (= x (fp #b0 #b00000000 #b11110010110010100011001)))
;; x should be Float32(0x00796519 [Rational(7955737, 713623846352979940529142984724747568191373312), 0.000000])
