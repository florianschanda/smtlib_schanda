...
(assert (= x (fp #b0 #b10010100 #b11010000111101111011110)))
;; x should be Float32(0x4A687BDE [Rational(7618031, 2), 3809015.500000])
...
(assert (not (= result (fp #b1 #b00010100 #b11010000111101111011111))))
(check-sat)
(exit)
