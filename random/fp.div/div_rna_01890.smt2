...
(assert (= x (fp #b1 #b00000000 #b01010110011011011110010)))
;; x should be Float32(0x802B36F2 [Rational(-1416057, 356811923176489970264571492362373784095686656), -0.000000])
