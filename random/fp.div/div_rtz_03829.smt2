...
(assert (= x ((_ to_fp 8 24) #x86742A20)))
;; x should be Float32(0x86742A20 [Rational(-500049, 10889035741470030830827987437816582766592), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x50F42A20))))
(check-sat)
(exit)
