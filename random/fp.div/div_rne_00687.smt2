...
(assert (= x (fp #b0 #b10010101 #b00111100110111100111111)))
;; x should be Float32(0x4A9E6F3F [Rational(10383167, 2), 5191583.500000])
...
(assert (= result ((_ to_fp 8 24) #x0A9E6F40)))
(check-sat)
(exit)
