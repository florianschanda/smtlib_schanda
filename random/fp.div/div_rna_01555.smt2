...
(assert (= x (fp #b0 #b11010110 #b00010000101101000100010)))
;; x should be Float32(0x6B085A22 [Rational(164839551640346341954027520), 164839551640346341954027520.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xAB085A23))))
(check-sat)
(exit)
