...
(assert (= y ((_ to_fp 8 24) #x19AFB4B7)))
;; y should be Float32(0x19AFB4B7 [Rational(11515063, 633825300114114700748351602688), 0.000000])

(declare-const result Float32)
(assert (= result (fp.div RTZ x y)))
(assert (= result ((_ to_fp 8 24) #x263A7E51)))
(check-sat)
(exit)
