...
(assert (= y (fp #b0 #b10010011 #b00001101010001111011100)))
;; y should be Float32(0x4986A3DC [Rational(2205943, 2), 1102971.500000])

(declare-const result Float32)
(assert (= result (fp.div RNE x y)))
(assert (not (= result ((_ to_fp 8 24) #x00000008))))
(check-sat)
(exit)
