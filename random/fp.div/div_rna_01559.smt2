...
(assert (= x ((_ to_fp 8 24) #x7BEA9A06)))
;; x should be Float32(0x7BEA9A06 [Rational(2436242862690174215814899157998501888), 2436242862690174215814899157998501888.000000])
