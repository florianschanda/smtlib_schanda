...
(assert (= x (fp #b0 #b10010100 #b01110010001000111111010)))
;; x should be Float32(0x4A3911FA [Rational(6064381, 2), 3032190.500000])
...
(assert (= result (fp #b1 #b00010100 #b01110010001000111111011)))
(check-sat)
(exit)
