...
(assert (= y ((_ to_fp 8 24) #x46CC2CB5)))
;; y should be Float32(0x46CC2CB5 [Rational(13380789, 512), 26134.353516])

(declare-const result Float32)
(assert (= result (fp.div RNA x y)))
(assert (not (= result (fp #b1 #b11110000 #b01000000111110101110100))))
(check-sat)
(exit)
