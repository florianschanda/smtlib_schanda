...
(assert (= y ((_ to_fp 8 24) #x74061C22)))
;; y should be Float32(0x74061C22 [Rational(42501121842657143187404492898304), 42501121842657143187404492898304.000000])

(declare-const result Float32)
(assert (= result (fp.div RTN x y)))
(assert (= result ((_ to_fp 8 24) #xCAF45641)))
(check-sat)
(exit)
