...
(assert (= x (fp #b0 #b10011111 #b01011101100000001100100)))
;; x should be Float32(0x4FAEC064 [Rational(5863688192), 5863688192.000000])
...
(assert (= result (fp #b1 #b00011111 #b01011101100000001100100)))
(check-sat)
(exit)
