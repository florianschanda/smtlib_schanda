...
(assert (= x ((_ to_fp 8 24) #x0072D91A)))
;; x should be Float32(0x0072D91A [Rational(3763341, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3F65B236)))
(check-sat)
(exit)
