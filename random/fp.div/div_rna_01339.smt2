...
(assert (= x (fp #b0 #b10010100 #b00001100011101100111010)))
;; x should be Float32(0x4A063B3A [Rational(4398493, 2), 2199246.500000])
...
(assert (= result (fp #b0 #b00010100 #b00001100011101100111011)))
(check-sat)
(exit)
