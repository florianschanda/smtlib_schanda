...
(assert (= w ((_ to_fp 8 24) RTP (- 37079897104133033911135997263872.0))))
;; w should be Float32(0xF3EA01CE [Rational(-37079897104133033911135997263872), -37079897104133033911135997263872.000000])
