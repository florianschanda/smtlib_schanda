...
(assert (= x (fp #b1 #b00000000 #b10101101001101100010110)))
;; x should be Float32(0x80569B16 [Rational(-2837899, 356811923176489970264571492362373784095686656), -0.000000])
