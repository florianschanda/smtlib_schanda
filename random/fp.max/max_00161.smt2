...
(assert (= y (fp #b1 #b00000000 #b11100001100101000011110)))
;; y should be Float32(0x8070CA1E [Rational(-3695887, 356811923176489970264571492362373784095686656), -0.000000])
