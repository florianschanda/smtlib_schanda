...
(assert (= x (fp #b1 #b11010110 #b10101101011010011110001)))
;; x should be Float32(0xEB56B4F1 [Rational(-259564597029768943527526400), -259564597029768943527526400.000000])
