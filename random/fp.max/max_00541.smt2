...
(assert (= x (fp #b1 #b11111011 #b00011100001011000101010)))
;; x should be Float32(0xFD8E162A [Rational(-23608182224193646691290759907950723072), -23608182224193646691290759907950723072.000000])
