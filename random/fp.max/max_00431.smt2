...
(assert (= y ((_ to_fp 8 24) #xDFCD5378)))
;; y should be Float32(0xDFCD5378 [Rational(-29590602284475088896), -29590602284475088896.000000])

(declare-const result Float32)
(assert (= result (fp.max x y)))
(assert (= result (fp #b1 #b10111111 #b10011010101001101111000)))
(check-sat)
(exit)
