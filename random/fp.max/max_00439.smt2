...
(assert (= y (fp #b0 #b10010101 #b01010111010101101110101)))
;; y should be Float32(0x4AABAB75 [Rational(11250549, 2), 5625274.500000])

(declare-const result Float32)
(assert (= result (fp.max x y)))
(assert (= result ((_ to_fp 8 24) #x4AABAB75)))
(check-sat)
(exit)
