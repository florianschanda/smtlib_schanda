...
(assert (= y (fp #b0 #b00000000 #b01000110000100000110001)))
;; y should be Float32(0x00230831 [Rational(2295857, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.max x y)))
(assert (= result ((_ to_fp 8 24) #x00230831)))
(check-sat)
(exit)
