...
(assert (= x ((_ to_fp 8 24) #x4A0D8BFE)))
;; x should be Float32(0x4A0D8BFE [Rational(4638207, 2), 2319103.500000])
...
(assert (not (= result (fp #b0 #b10010100 #b00011011000101111111110))))
(check-sat)
(exit)
