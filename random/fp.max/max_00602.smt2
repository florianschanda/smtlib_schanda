...
(assert (= x (fp #b1 #b00000000 #b00010001111010011100011)))
;; x should be Float32(0x8008F4E3 [Rational(-586979, 713623846352979940529142984724747568191373312), -0.000000])
