...
(assert (= y ((_ to_fp 8 24) #x80719B19)))
;; y should be Float32(0x80719B19 [Rational(-7445273, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.max x y)))
(assert (not (= result ((_ to_fp 8 24) #x80719B19))))
(check-sat)
(exit)
