...
(assert (= x ((_ to_fp 8 24) #x003858F7)))
;; x should be Float32(0x003858F7 [Rational(3692791, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x003858F7))))
(check-sat)
(exit)
