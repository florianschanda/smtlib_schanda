...
(assert (= y ((_ to_fp 8 24) #xF3FA0320)))
;; y should be Float32(0xF3FA0320 [Rational(-39616015538443552203451505049600), -39616015538443552203451505049600.000000])

(declare-const result Float32)
(assert (= result (fp.rem x y)))
(assert (= result ((_ to_fp 8 24) #x7324F4C0)))
(check-sat)
(exit)
