...
(assert (= x (fp #b1 #b00000000 #b01101100110000111100011)))
;; x should be Float32(0x803661E3 [Rational(-3564003, 713623846352979940529142984724747568191373312), -0.000000])
