...
(assert (= y ((_ to_fp 8 24) #x0006C3DE)))
;; y should be Float32(0x0006C3DE [Rational(221679, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.rem x y)))
(assert (not (= result ((_ to_fp 8 24) #x0000B11E))))
(check-sat)
(exit)
