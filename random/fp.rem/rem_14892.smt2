...
(assert (= x ((_ to_fp 8 24) #x804DB2D6)))
;; x should be Float32(0x804DB2D6 [Rational(-2546027, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result (fp #b1 #b00000000 #b10011011011001011010110)))
(check-sat)
(exit)
