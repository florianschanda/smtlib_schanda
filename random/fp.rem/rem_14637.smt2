...
(assert (= x (fp #b1 #b10010100 #b11110111001011010110010)))
;; x should be Float32(0xCA7B96B2 [Rational(-8244057, 2), -4122028.500000])
...
(assert (not (= result (fp #b1 #b10010100 #b11110111001011010110010))))
(check-sat)
(exit)
