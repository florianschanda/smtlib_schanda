...
(assert (= x ((_ to_fp 8 24) #xC903C468)))
;; x should be Float32(0xC903C468 [Rational(-1079437, 2), -539718.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b00111011100101101111100))))
(check-sat)
(exit)
