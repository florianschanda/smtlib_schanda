...
(assert (= x (fp #b0 #b11101011 #b11111001110100111101001)))
;; x should be Float32(0x75FCE9E9 [Rational(641212436499166613861876992311296), 641212436499166613861876992311296.000000])
