...
(assert (= x ((_ to_fp 8 24) #x006073B8)))
;; x should be Float32(0x006073B8 [Rational(790135, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x006073B8))))
(check-sat)
(exit)
