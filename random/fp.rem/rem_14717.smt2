...
(assert (= y ((_ to_fp 8 24) #xCAD0C049)))
;; y should be Float32(0xCAD0C049 [Rational(-13680713, 2), -6840356.500000])

(declare-const result Float32)
(assert (= result (fp.rem x y)))
(assert (not (= result (fp #b0 #b10010001 #b11110111110001100100000))))
(check-sat)
(exit)
