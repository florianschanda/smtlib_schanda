...
(assert (= y ((_ to_fp 8 24) #x8058ADAE)))
;; y should be Float32(0x8058ADAE [Rational(-2905815, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.rem x y)))
(assert (not (= result ((_ to_fp 8 24) #x8020F472))))
(check-sat)
(exit)
