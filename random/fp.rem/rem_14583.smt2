...
(assert (= x ((_ to_fp 8 24) #x005836CF)))
;; x should be Float32(0x005836CF [Rational(5781199, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b0 #b00000000 #b10110000011011011001111))))
(check-sat)
(exit)
