...
(assert (= x ((_ to_fp 8 24) #x4408953F)))
;; x should be Float32(0x4408953F [Rational(8951103, 16384), 546.331970])
...
(assert (not (= result (fp #b0 #b10001000 #b00010001001010100111111))))
(check-sat)
(exit)
