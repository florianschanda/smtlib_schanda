...
(assert (= y (fp #b0 #b00000000 #b11001101110101100011011)))
;; y should be Float32(0x0066EB1B [Rational(6744859, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.rem x y)))
(assert (not (= result ((_ to_fp 8 24) #x80078753))))
(check-sat)
(exit)
