...
(assert (= x (fp #b0 #b01100110 #b00101111011110111010100)))
;; x should be Float32(0x3317BDD4 [Rational(2486133, 70368744177664), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x800455A1))))
(check-sat)
(exit)
