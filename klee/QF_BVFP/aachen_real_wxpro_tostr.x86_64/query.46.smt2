...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.46.smt2
|)
...
(let ((?x46 ((_ sign_extend 32) ?x45)))
(let ((?x48 (bvudiv ((_ extract 31 0) ?x46) (_ bv10 32))))
(not (not (= (_ bv45 8) ((_ extract 7 0) (bvadd (_ bv48 32) (bvurem ?x48 (_ bv10 32))))))))))))))))
(check-sat)
(exit)
