...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.69.smt2
|)
...
(let ((?x56 ((_ sign_extend 32) (bvadd ((_ fp.to_sbv 32) roundTowardZero ?x40) (bvmul (_ bv4294967196 32) ?x42)))))
(let ((?x58 (bvudiv ((_ extract 31 0) ?x56) (_ bv10 32))))
(not (bvult (bvurem ?x58 (_ bv10 32)) (_ bv10 32))))))))))))
(check-sat)
(exit)
