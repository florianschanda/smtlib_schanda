...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.12.smt2
|)
...
(assert
 (let ((?x19 ((_ sign_extend 32) ((_ fp.to_sbv 32) roundTowardZero (fp.abs ((_ to_fp 11 53) meters_ackermann!0))))))
(let ((?x22 (bvudiv ((_ extract 31 0) ?x19) (_ bv10 32))))
(not (not (= (_ bv48 8) ((_ extract 7 0) (bvadd (_ bv48 32) (bvurem ?x22 (_ bv10 32))))))))))
(check-sat)
(exit)
