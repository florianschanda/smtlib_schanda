...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.39.smt2
|)
...
(not (not (bvult (_ bv9223372036854775807 64) ((_ sign_extend 32) ?x46)))))))))))
(check-sat)
(exit)
