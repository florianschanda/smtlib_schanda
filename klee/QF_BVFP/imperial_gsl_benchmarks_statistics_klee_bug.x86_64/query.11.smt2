...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_statistics_klee_bug.x86_64/query.11.smt2
|)
...
(assert
 ...
 (let ((?x52 ((_ to_fp 11 53) (ite (fp.lt ((_ to_fp 11 53) (_ bv4623282787467866931 64)) ((_ to_fp 11 53) ?x48)) (_ bv4623282787467866931 64) ?x48))))
 (not (fp.isNaN ?x52)))))))
(assert
 (let ((?x42 (ite (fp.lt ((_ to_fp 11 53) (_ bv4625787914760591770 64)) ((_ to_fp 11 53) data_ackermann!0)) (_ bv4625787914760591770 64) data_ackermann!0)))
 (let ((?x45 (ite (fp.lt ((_ to_fp 11 53) data_ackermann!1) ((_ to_fp 11 53) ?x42)) data_ackermann!1 ?x42)))
 (let ((?x48 (ite (fp.lt ((_ to_fp 11 53) (_ bv4625844209755933901 64)) ((_ to_fp 11 53) ?x45)) (_ bv4625844209755933901 64) ?x45)))
 (let ((?x52 ((_ to_fp 11 53) (ite (fp.lt ((_ to_fp 11 53) (_ bv4623282787467866931 64)) ((_ to_fp 11 53) ?x48)) (_ bv4623282787467866931 64) ?x48))))
 (not (fp.lt ?x52 ((_ to_fp 11 53) (_ bv4621819117588971520 64)))))))))
(assert
 (let ((?x14 ((_ to_fp 11 53) (_ bv4626322717216342016 64))))
(let ((?x42 (ite (fp.lt ((_ to_fp 11 53) (_ bv4625787914760591770 64)) ((_ to_fp 11 53) data_ackermann!0)) (_ bv4625787914760591770 64) data_ackermann!0)))
(let ((?x45 (ite (fp.lt ((_ to_fp 11 53) data_ackermann!1) ((_ to_fp 11 53) ?x42)) data_ackermann!1 ?x42)))
