...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_statistics_klee_bug.x86_64/query.12.smt2
|)
...
(assert
 ...
 (let ((?x45 (ite (fp.lt ((_ to_fp 11 53) data_ackermann!1) ((_ to_fp 11 53) ?x42)) data_ackermann!1 ?x42)))
 (let ((?x48 (ite (fp.lt ((_ to_fp 11 53) (_ bv4625844209755933901 64)) ((_ to_fp 11 53) ?x45)) (_ bv4625844209755933901 64) ?x45)))
 (not (fp.lt ((_ to_fp 11 53) (ite (fp.lt ((_ to_fp 11 53) (_ bv4623282787467866931 64)) ((_ to_fp 11 53) ?x48)) (_ bv4623282787467866931 64) ?x48)) ?x11)))))))
(assert
 (let ((?x11 ((_ to_fp 11 53) (_ bv4621819117588971520 64))))
...
(not (and (not (fp.isNaN ?x84)) (not (fp.lt ?x84 ?x11))))))))))))))))))))
(check-sat)
(exit)
