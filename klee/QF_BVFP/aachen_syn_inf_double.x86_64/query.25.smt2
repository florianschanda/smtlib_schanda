...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_syn_inf_double.x86_64/query.25.smt2
|)
...
(not (fp.gt ?x20 ((_ to_fp 11 53) (_ bv0 64))))))))
(check-sat)
(exit)
