...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_exp_loop.c.x86_64/query.127.smt2
|)
...
(assert
 (not (fp.gt ((_ to_fp 8 24) (_ bv822083584 32)) ((_ to_fp 8 24) symbolic_0_float_ackermann!0))))
(assert
 (let ((?x8 ((_ to_fp 8 24) symbolic_0_float_ackermann!0)))
(let ((?x111 (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x8 ((_ to_fp 8 24) (_ bv830472192 32))) ((_ to_fp 8 24) (_ bv947912704 32)))))
