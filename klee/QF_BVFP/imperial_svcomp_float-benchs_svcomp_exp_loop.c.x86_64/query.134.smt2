...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_exp_loop.c.x86_64/query.134.smt2
|)
...
(assert
 (not (fp.gt ((_ to_fp 8 24) (_ bv805306368 32)) ((_ to_fp 8 24) symbolic_0_float_ackermann!0))))
(assert
 (let ((?x8 ((_ to_fp 8 24) symbolic_0_float_ackermann!0)))
(let ((?x117 (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x8 ((_ to_fp 8 24) (_ bv813694976 32))) ((_ to_fp 8 24) (_ bv939524096 32)))))
(let (($x119 (not (fp.isNaN ?x117))))
(let (($x130 (and (and $x119 (not (fp.lt ?x117 ((_ to_fp 8 24) (_ bv0 32))))) (and $x119 (not (fp.gt ?x117 ((_ to_fp 8 24) (_ bv1232348160 32))))))))
(not $x130))))))
(check-sat)
(exit)
