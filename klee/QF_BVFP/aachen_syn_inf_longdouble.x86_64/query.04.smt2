...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_syn_inf_longdouble.x86_64/query.04.smt2
|)
...
(assert
 ...
 (= ((_ extract 63 63) ld_ackermann!0) (ite (or (fp.isSubnormal ?x15) (fp.isZero ?x15)) (_ bv0 1) (_ bv1 1))))))
(assert
 (let ((?x55 (concat (concat ((_ extract 79 79) (concat (_ bv32767 16) (_ bv9223372036854775808 64))) ((_ extract 78 64) (concat (_ bv32767 16) (_ bv9223372036854775808 64)))) ((_ extract 62 0) (concat (_ bv32767 16) (_ bv9223372036854775808 64))))))
 (let ((?x56 ((_ to_fp 15 64) ?x55)))
 (= ((_ extract 63 63) (concat (_ bv32767 16) (_ bv9223372036854775808 64))) (ite (or (fp.isSubnormal ?x56) (fp.isZero ?x56)) (_ bv0 1) (_ bv1 1))))))
(assert
 (let ((?x55 (concat (concat ((_ extract 79 79) (concat (_ bv32767 16) (_ bv9223372036854775808 64))) ((_ extract 78 64) (concat (_ bv32767 16) (_ bv9223372036854775808 64)))) ((_ extract 62 0) (concat (_ bv32767 16) (_ bv9223372036854775808 64))))))
(let ((?x56 ((_ to_fp 15 64) ?x55)))
(let ((?x14 (concat (concat ((_ extract 79 79) ld_ackermann!0) ((_ extract 78 64) ld_ackermann!0)) ((_ extract 62 0) ld_ackermann!0))))
(let ((?x15 ((_ to_fp 15 64) ?x14)))
(not (fp.eq (fp.abs ?x15) ?x56)))))))
(check-sat)
(exit)
