...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_syn_inf_longdouble.x86_64/query.07.smt2
|)
...
(let ((?x14 (concat (concat ((_ extract 79 79) ld_ackermann!0) ((_ extract 78 64) ld_ackermann!0)) ((_ extract 62 0) ld_ackermann!0))))
(let ((?x15 ((_ to_fp 15 64) ?x14)))
(not (not (fp.isNaN (fp.add roundNearestTiesToEven (fp.abs ?x15) ?x56)))))))))
(check-sat)
(exit)
