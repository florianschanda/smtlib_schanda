...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_syn_inf_longdouble.x86_64/query.05.smt2
|)
...
(let ((?x15 ((_ to_fp 15 64) ?x14)))
(let ((?x54 (fp.abs ?x15)))
(not (fp.isNaN (fp.sub roundNearestTiesToEven ?x54 ?x54)))))))
(check-sat)
(exit)
