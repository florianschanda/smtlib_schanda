...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_syn_mod_float.x86_64/query.08.smt2
|)
...
(assert
 ...
 (bvslt (bvxor ?x28 (bvand ?x28 (_ bv2147483648 32))) (bvand ((_ extract 63 32) fresh_to_ieee_bv_!3) (_ bv2147483647 32)))))
(assert
 (not (fp.isNaN ((_ to_fp 8 24) g_ackermann!1))))
(assert
 (let ((?x45 (ite (fp.isInfinite ((_ to_fp 8 24) g_ackermann!1)) (ite (fp.gt ((_ to_fp 8 24) g_ackermann!1) ((_ to_fp 8 24) (_ bv0 32))) (_ bv1 32) (_ bv4294967295 32)) (_ bv0 32))))
 (= (_ bv0 32) ?x45)))
(assert
 (let ((?x21 ((_ to_fp 8 24) g_ackermann!1)))
...
(assert
 (let ((?x9 ((_ to_fp 8 24) f_ackermann!0)))
(let (($x48 (fp.eq ((_ to_fp 8 24) roundNearestTiesToEven ((_ to_fp 11 53) roundNearestTiesToEven ?x9)) ?x9)))
(not $x48))))
(check-sat)
(exit)
