...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_prefix_sum_klee_bug_float.x86_64/query.15.smt2
|)
...
(assert
 (not (fp.lt ((_ to_fp 8 24) data_in_ackermann!2) ((_ to_fp 8 24) data_in_ackermann!2))))
(assert
...
(not (and (not (fp.isNaN ?x33)) (not (fp.lt ?x33 ?x28))))))))))
(check-sat)
(exit)
