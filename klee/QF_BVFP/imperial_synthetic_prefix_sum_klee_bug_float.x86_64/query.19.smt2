...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_prefix_sum_klee_bug_float.x86_64/query.19.smt2
|)
...
(assert
 (not (fp.lt ((_ to_fp 8 24) data_in_ackermann!4) ((_ to_fp 8 24) data_in_ackermann!4))))
(assert
