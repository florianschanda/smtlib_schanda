...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_fadd_to_exact_zero_klee_double.x86_64/query.23.smt2
|)
...
(assert
 ...
 (not (= (_ bv0 32) ?x39))))
(assert
 (let (($x44 (fp.isNaN (fp.add roundTowardZero ((_ to_fp 11 53) f_ackermann!0) ((_ to_fp 11 53) g_ackermann!1)))))
(not $x44)))
(check-sat)
(exit)
