...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_fadd_to_exact_zero_klee_double.x86_64/query.21.smt2
|)
...
(assert
 ...
 (= (fp.add roundNearestTiesToEven ?x9 ?x12) ((_ to_fp 11 53) fresh_to_ieee_bv_!2)))))
(assert
