...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_fadd_to_exact_zero_klee_double.x86_64/query.22.smt2
|)
...
(assert
 ...
 (= (_ bv0 32) ?x39)))
(assert
 (let (($x43 (fp.eq (fp.add roundTowardZero ((_ to_fp 11 53) f_ackermann!0) ((_ to_fp 11 53) g_ackermann!1)) ((_ to_fp 11 53) (_ bv0 64)))))
(not $x43)))
(check-sat)
(exit)
