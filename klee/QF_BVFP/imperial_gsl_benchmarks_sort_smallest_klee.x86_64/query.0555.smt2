...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0555.smt2
|)
...
(assert
 (let (($x42 (and (not (fp.isNaN ((_ to_fp 11 53) x_ackermann!0))) (not (fp.gt ((_ to_fp 11 53) x_ackermann!0) ((_ to_fp 11 53) x_ackermann!3))))))
(not $x42)))
(check-sat)
(exit)
