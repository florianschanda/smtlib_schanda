...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2119.smt2
|)
...
(let ((?x13 ((_ to_fp 11 53) x_ackermann!0)))
(let (($x14 (fp.isNaN ?x13)))
(not (not (and (not $x34) (or (or $x14 $x34) (fp.gt ?x13 ?x33))))))))))
(check-sat)
(exit)
