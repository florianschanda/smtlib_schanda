...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2396.smt2
|)
...
(assert
 ...
 (or (or $x34 (fp.isNaN ((_ to_fp 11 53) x_ackermann!1))) (fp.lt ?x33 ((_ to_fp 11 53) x_ackermann!1))))))
(assert
