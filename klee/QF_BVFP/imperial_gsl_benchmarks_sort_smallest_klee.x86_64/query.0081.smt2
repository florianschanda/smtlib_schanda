...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0081.smt2
|)
...
(assert
 ...
 (fp.gt ?x13 ((_ to_fp 11 53) x_ackermann!4))))
(assert
 (not (fp.gt ((_ to_fp 11 53) x_ackermann!2) ((_ to_fp 11 53) x_ackermann!0))))
(assert
 (let ((?x18 ((_ to_fp 11 53) x_ackermann!2)))
 (fp.gt ?x18 ((_ to_fp 11 53) x_ackermann!4))))
(assert
 (not (fp.isNaN ((_ to_fp 11 53) x_ackermann!3))))
(assert
 (let (($x35 (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5)) (fp.lt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!1)))))
(not $x35)))
(check-sat)
(exit)
