...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2329.smt2
|)
...
(assert
 ...
 (let (($x26 (fp.isNaN ?x20)))
 (or $x26 (fp.lt ((_ to_fp 11 53) x_ackermann!4) ?x20)))))
(assert
...
(assert
 (let ((?x20 ((_ to_fp 11 53) x_ackermann!2)))
 (let (($x26 (fp.isNaN ?x20)))
 (or (or $x26 (fp.isNaN ((_ to_fp 11 53) x_ackermann!5))) (fp.lt ?x20 ((_ to_fp 11 53) x_ackermann!5))))))
(assert
