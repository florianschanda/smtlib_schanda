...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2128.smt2
|)
...
(assert
 ...
 (or (or $x33 (fp.isNaN ((_ to_fp 11 53) x_ackermann!0))) (fp.lt ?x32 ((_ to_fp 11 53) x_ackermann!0))))))
(assert
 (let ((?x14 ((_ to_fp 11 53) x_ackermann!1)))
 (let ((?x32 ((_ to_fp 11 53) x_ackermann!5)))
 (fp.gt ?x32 ?x14))))
...
(assert
 (let ((?x32 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x33 (fp.isNaN ?x32)))
(let (($x45 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)) $x33) (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x32))))
