...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1407.smt2
|)
...
(assert
 (let ((?x33 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x34 (fp.isNaN ?x33)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!2)) $x34) (fp.lt ((_ to_fp 11 53) x_ackermann!2) ?x33)))))
(assert
