...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1135.smt2
|)
...
(assert
 (let ((?x19 ((_ to_fp 11 53) x_ackermann!3)))
(let (($x20 (fp.isNaN ?x19)))
(let (($x47 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x20) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x19))))
(not (not (and (not $x20) $x47)))))))
(check-sat)
(exit)
