...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1565.smt2
|)
...
(assert
 ...
 (fp.gt ?x26 ?x13))))
(assert
 (let (($x37 (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5)) (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)))))
 (or $x37 (fp.lt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!1)))))
(assert
 (let ((?x26 ((_ to_fp 11 53) x_ackermann!4)))
...
(assert
 (let ((?x26 ((_ to_fp 11 53) x_ackermann!4)))
(let (($x27 (fp.isNaN ?x26)))
(let (($x45 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x27) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x26))))
(not (not (and (not $x27) $x45)))))))
(check-sat)
(exit)
