...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1430.smt2
|)
...
(assert
 (let ((?x14 ((_ to_fp 11 53) x_ackermann!1)))
(let (($x39 (fp.isNaN ?x14)))
(let ((?x29 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x30 (fp.isNaN ?x29)))
(not (not (and (not $x39) (or $x30 $x39)))))))))
(check-sat)
(exit)
