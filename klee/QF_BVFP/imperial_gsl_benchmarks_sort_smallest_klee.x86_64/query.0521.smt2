...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0521.smt2
|)
...
(assert
 (let ((?x28 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x29 (fp.isNaN ?x28)))
(let (($x44 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x29) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x28))))
