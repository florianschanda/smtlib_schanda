...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2544.smt2
|)
...
(let ((?x39 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x40 (fp.isNaN ?x39)))
(not (not (and (not $x48) (or $x40 $x48)))))))))
(check-sat)
(exit)
