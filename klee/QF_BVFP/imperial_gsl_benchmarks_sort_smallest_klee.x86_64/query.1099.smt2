...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1099.smt2
|)
...
(assert
 (let ((?x26 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x27 (fp.isNaN ?x26)))
 (or $x27 (fp.lt ?x26 ((_ to_fp 11 53) x_ackermann!2))))))
(assert
