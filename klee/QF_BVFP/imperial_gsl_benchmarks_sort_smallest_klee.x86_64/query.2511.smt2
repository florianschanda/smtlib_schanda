...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2511.smt2
|)
...
(assert
 (let ((?x18 ((_ to_fp 11 53) x_ackermann!3)))
 (let (($x19 (fp.isNaN ?x18)))
 (or $x19 (fp.lt ((_ to_fp 11 53) x_ackermann!5) ?x18)))))
(assert
