...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1668.smt2
|)
...
(assert
 ...
 (or (or $x20 (fp.isNaN ((_ to_fp 11 53) x_ackermann!1))) (fp.lt ?x19 ((_ to_fp 11 53) x_ackermann!1))))))
(assert
 (let ((?x13 ((_ to_fp 11 53) x_ackermann!0)))
 (let ((?x19 ((_ to_fp 11 53) x_ackermann!3)))
 (fp.gt ?x19 ?x13))))
...
(assert
 (let ((?x13 ((_ to_fp 11 53) x_ackermann!0)))
(let (($x42 (fp.isNaN ?x13)))
(let ((?x32 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x33 (fp.isNaN ?x32)))
(not (not (and (not $x42) (or $x33 $x42)))))))))
(check-sat)
(exit)
