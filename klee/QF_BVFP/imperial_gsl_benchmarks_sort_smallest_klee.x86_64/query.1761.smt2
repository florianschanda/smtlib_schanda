...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1761.smt2
|)
...
(assert
 (let ((?x31 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x32 (fp.isNaN ?x31)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!2)) $x32) (fp.lt ((_ to_fp 11 53) x_ackermann!2) ?x31)))))
(assert
