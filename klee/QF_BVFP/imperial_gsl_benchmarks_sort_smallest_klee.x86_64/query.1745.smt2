...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1745.smt2
|)
...
(assert
 (let ((?x37 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x38 (fp.isNaN ?x37)))
(let (($x49 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x38) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x37))))
