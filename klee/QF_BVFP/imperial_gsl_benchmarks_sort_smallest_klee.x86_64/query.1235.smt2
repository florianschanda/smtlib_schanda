...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1235.smt2
|)
...
(assert
 (let ((?x27 ((_ to_fp 11 53) x_ackermann!4)))
(let (($x28 (fp.isNaN ?x27)))
(let (($x47 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x28) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x27))))
(not (not (and (not $x28) $x47)))))))
(check-sat)
(exit)
