...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2188.smt2
|)
...
(assert
 (let (($x48 (and (not (fp.isNaN ((_ to_fp 11 53) x_ackermann!1))) (not (fp.gt ((_ to_fp 11 53) x_ackermann!1) ((_ to_fp 11 53) x_ackermann!3))))))
(not $x48)))
(check-sat)
(exit)
