...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0075.smt2
|)
...
(assert
 ...
 (or (or $x19 (fp.isNaN ((_ to_fp 11 53) x_ackermann!1))) (fp.lt ?x18 ((_ to_fp 11 53) x_ackermann!1))))))
(assert
 (let ((?x12 ((_ to_fp 11 53) x_ackermann!0)))
 (let ((?x18 ((_ to_fp 11 53) x_ackermann!3)))
 (fp.gt ?x18 ?x12))))
