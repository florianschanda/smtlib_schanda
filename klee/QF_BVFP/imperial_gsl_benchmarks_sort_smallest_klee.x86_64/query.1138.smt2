...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1138.smt2
|)
...
(assert
 (let ((?x18 ((_ to_fp 11 53) x_ackermann!3)))
(let (($x19 (fp.isNaN ?x18)))
(let (($x43 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)) $x19) (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x18))))
(not (not (and (not $x19) $x43)))))))
(check-sat)
(exit)
