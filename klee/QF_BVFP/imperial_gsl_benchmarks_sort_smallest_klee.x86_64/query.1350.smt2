...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1350.smt2
|)
...
(assert
 (let ((?x16 ((_ to_fp 11 53) x_ackermann!2)))
(let (($x40 (fp.isNaN ?x16)))
(let (($x45 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)) $x40) (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x16))))
