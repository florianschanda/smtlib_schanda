...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0119.smt2
|)
...
(assert
 ...
 (fp.gt ?x19 ((_ to_fp 11 53) x_ackermann!0))))
(assert
...
(assert
 (let (($x38 (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5)) (fp.lt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!1)))))
(not $x38)))
(check-sat)
(exit)
