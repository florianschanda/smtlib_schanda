...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1441.smt2
|)
...
(assert
 ...
 (or $x31 (fp.lt ?x30 ((_ to_fp 11 53) x_ackermann!1))))))
(assert
...
(let (($x41 (fp.isNaN ?x13)))
(let ((?x30 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x31 (fp.isNaN ?x30)))
(not (not (and (not $x41) (or $x31 $x41)))))))))
(check-sat)
(exit)
