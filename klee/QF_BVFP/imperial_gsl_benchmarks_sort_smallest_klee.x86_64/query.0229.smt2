...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.0229.smt2
|)
...
(assert
 ...
 (fp.gt ?x13 ?x20))))
(assert
 (not (fp.gt ((_ to_fp 11 53) x_ackermann!2) ((_ to_fp 11 53) x_ackermann!3))))
(assert
...
(assert
 (let ((?x15 ((_ to_fp 11 53) x_ackermann!1)))
 (let (($x16 (fp.isNaN ?x15)))
 (or (or $x16 (fp.isNaN ((_ to_fp 11 53) x_ackermann!3))) (fp.lt ?x15 ((_ to_fp 11 53) x_ackermann!3))))))
(assert
 (let ((?x20 ((_ to_fp 11 53) x_ackermann!2)))
 (let ((?x15 ((_ to_fp 11 53) x_ackermann!1)))
 (fp.gt ?x15 ?x20))))
(assert
 (let ((?x13 ((_ to_fp 11 53) x_ackermann!0)))
(let (($x14 (fp.isNaN ?x13)))
(let (($x39 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5)) $x14) (fp.lt ((_ to_fp 11 53) x_ackermann!5) ?x13))))
(not $x39)))))
(check-sat)
(exit)
