...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2349.smt2
|)
...
(assert
 ...
 (or (or $x35 (fp.isNaN ((_ to_fp 11 53) x_ackermann!3))) (fp.lt ?x34 ((_ to_fp 11 53) x_ackermann!3))))))
(assert
 (let ((?x13 ((_ to_fp 11 53) x_ackermann!0)))
 (let ((?x34 ((_ to_fp 11 53) x_ackermann!5)))
 (fp.gt ?x34 ?x13))))
...
(let ((?x13 ((_ to_fp 11 53) x_ackermann!0)))
(let (($x14 (fp.isNaN ?x13)))
(not (not (and (not $x35) (or (or $x14 $x35) (fp.gt ?x13 ?x34))))))))))
(check-sat)
(exit)
