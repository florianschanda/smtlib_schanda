...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1781.smt2
|)
...
(assert
 ...
 (or (or $x24 (fp.isNaN ((_ to_fp 11 53) x_ackermann!2))) (fp.lt ?x23 ((_ to_fp 11 53) x_ackermann!2))))))
(assert
 (let ((?x13 ((_ to_fp 11 53) x_ackermann!0)))
 (let ((?x23 ((_ to_fp 11 53) x_ackermann!4)))
 (fp.gt ?x23 ?x13))))
...
(let ((?x13 ((_ to_fp 11 53) x_ackermann!0)))
(let (($x14 (fp.isNaN ?x13)))
(not (not (and (not $x24) (or (or $x14 $x24) (fp.gt ?x13 ?x23))))))))))
(check-sat)
(exit)
