...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1970.smt2
|)
...
(let ((?x30 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x31 (fp.isNaN ?x30)))
(not (not (and (not $x14) (or $x31 $x14)))))))))
(check-sat)
(exit)
