...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.2215.smt2
|)
...
(assert
 (let ((?x26 ((_ to_fp 11 53) x_ackermann!4)))
(let (($x27 (fp.isNaN ?x26)))
(let (($x48 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x27) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x26))))
(not (not (and (not $x27) $x48)))))))
(check-sat)
(exit)
