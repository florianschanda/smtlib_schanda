...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_interval_klee_bug.x86_64/query.24.smt2
|)
...
(not (and (not (fp.isNaN ?x39)) (fp.leq ?x39 ?x39))))))))))
(check-sat)
(exit)
