...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_interval_klee_bug.x86_64/query.16.smt2
|)
...
(not (fp.geq ?x32 (fp.add roundNearestTiesToEven ?x29 ((_ to_fp 11 53) (_ bv4707126720094797824 64))))))))))
(check-sat)
(exit)
