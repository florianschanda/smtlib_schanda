...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_differentiation_klee.x86_64/query.05.smt2
|)
...
(assert
 (not (not (= (_ bv0 32) ((_ extract 31 0) fresh_to_ieee_bv_!1)))))
(check-sat)
(exit)
