...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_histogram2d_klee_bug.x86_64/query.009.smt2
|)
...
(not (bvult (bvmul (_ bv8 64) (bvadd (_ bv3 64) (bvmul (_ bv10 64) ?x28))) (_ bv793 64)))))))
(check-sat)
(exit)
