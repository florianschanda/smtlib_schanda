...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_syn_inf_float.x86_64/query.21.smt2
|)
...
(not (fp.eq (fp.mul roundNearestTiesToEven ?x18 ?x18) ((_ to_fp 8 24) (_ bv2139095040 32))))))))
(check-sat)
(exit)
