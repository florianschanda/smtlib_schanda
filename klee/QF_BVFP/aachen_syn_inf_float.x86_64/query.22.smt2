...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_syn_inf_float.x86_64/query.22.smt2
|)
...
(let ((?x19 (fp.mul roundNearestTiesToEven ?x18 ?x18)))
