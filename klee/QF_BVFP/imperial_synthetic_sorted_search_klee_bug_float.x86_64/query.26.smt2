...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sorted_search_klee_bug_float.x86_64/query.26.smt2
|)
...
(assert
 (not (fp.eq ((_ to_fp 8 24) data_ackermann!2) ((_ to_fp 8 24) elem_ackermann!5))))
(assert
 (not (fp.eq ((_ to_fp 8 24) data_ackermann!3) ((_ to_fp 8 24) elem_ackermann!5))))
(assert
...
(assert
 (let ((?x25 ((_ to_fp 8 24) elem_ackermann!5)))
(let ((?x13 ((_ to_fp 8 24) data_ackermann!0)))
(let (($x45 (fp.gt ?x13 ?x25)))
(let ((?x53 ((_ sign_extend 32) (bvsdiv (bvadd (ite $x45 (_ bv0 32) (_ bv2 32)) (ite $x45 (_ bv2 32) (_ bv5 32))) (_ bv2 32)))))
(not (bvult (bvmul (_ bv4 64) ?x53) (_ bv17 64))))))))
(check-sat)
(exit)
