...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_numerical_recipes_gaussj.x86_64/query.16.smt2
|)
...
(assert
 ...
 (let ((?x37 (fp.sub roundNearestTiesToEven ((_ to_fp 8 24) (_ bv1073741824 32)) ?x36)))
 (let ((?x38 (fp.abs ?x37)))
...
(let ((?x36 (fp.mul roundNearestTiesToEven ?x19 (fp.mul roundNearestTiesToEven ?x23 ((_ to_fp 8 24) (_ bv0 32))))))
(let ((?x37 (fp.sub roundNearestTiesToEven ((_ to_fp 8 24) (_ bv1073741824 32)) ?x36)))
(not (not (fp.eq ?x37 ((_ to_fp 8 24) (_ bv0 32))))))))))))
(check-sat)
(exit)
