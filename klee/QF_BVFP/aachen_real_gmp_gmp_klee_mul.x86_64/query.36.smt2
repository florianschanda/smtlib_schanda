...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mul.x86_64/query.36.smt2
|)
...
(not (not (= (_ bv1 64) (ite (bvslt (_ bv4294967295 32) ?x22) ?x24 (bvsub (_ bv0 64) ?x24))))))))
(check-sat)
(exit)
