...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_numerical_recipes_qrdcmp.x86_64/query.6.smt2
|)
...
(assert
 ...
 (fp.eq (fp.sub roundNearestTiesToEven ?x26 ?x46) ((_ to_fp 8 24) (_ bv0 32))))))))))))
(assert
 (not (fp.eq ((_ to_fp 8 24) sym_f_ackermann!0) ((_ to_fp 8 24) (_ bv1098907648 32)))))
(check-sat)
(exit)
