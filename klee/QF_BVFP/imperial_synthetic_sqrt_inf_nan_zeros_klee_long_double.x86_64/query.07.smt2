...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_inf_nan_zeros_klee_long_double.x86_64/query.07.smt2
|)
...
(assert
 ...
 (let ((?x13 (concat (concat ((_ extract 79 79) x_ackermann!0) ((_ extract 78 64) x_ackermann!0)) ((_ extract 62 0) x_ackermann!0))))
 (let ((?x14 ((_ to_fp 15 64) ?x13)))
 (let (($x45 (fp.gt ?x14 ?x33)))
 (= (_ bv0 32) (ite (fp.isInfinite ?x14) (ite $x45 (_ bv1 32) (_ bv4294967295 32)) (_ bv0 32)))))))))
(assert
 (let ((?x31 (concat (concat ((_ extract 79 79) (concat (_ bv0 16) (_ bv0 64))) ((_ extract 78 64) (concat (_ bv0 16) (_ bv0 64)))) ((_ extract 62 0) (concat (_ bv0 16) (_ bv0 64))))))
 (let ((?x33 ((_ to_fp 15 64) ?x31)))
 (let ((?x13 (concat (concat ((_ extract 79 79) x_ackermann!0) ((_ extract 78 64) x_ackermann!0)) ((_ extract 62 0) x_ackermann!0))))
