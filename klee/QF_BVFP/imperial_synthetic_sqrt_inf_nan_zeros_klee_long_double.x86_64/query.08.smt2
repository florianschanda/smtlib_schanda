...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_inf_nan_zeros_klee_long_double.x86_64/query.08.smt2
|)
...
(let ((?x13 (concat (concat ((_ extract 79 79) x_ackermann!0) ((_ extract 78 64) x_ackermann!0)) ((_ extract 62 0) x_ackermann!0))))
(let ((?x14 ((_ to_fp 15 64) ?x13)))
(not (fp.eq (fp.sqrt roundNearestTiesToEven ?x14) ?x33)))))))
(check-sat)
(exit)
