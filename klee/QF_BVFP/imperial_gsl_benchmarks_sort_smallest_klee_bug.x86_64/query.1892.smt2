...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1892.smt2
|)
...
(assert
 ...
 (let (($x14 (fp.isNaN ?x13)))
 (let (($x26 (not $x14)))
 (not (and $x26 (or $x14 (fp.gt ((_ to_fp 11 53) x_ackermann!3) ?x13))))))))
(assert
...
(assert
 (let ((?x15 ((_ to_fp 11 53) x_ackermann!1)))
 (let ((?x32 ((_ to_fp 11 53) x_ackermann!4)))
 (fp.gt ?x32 ?x15))))
(assert
