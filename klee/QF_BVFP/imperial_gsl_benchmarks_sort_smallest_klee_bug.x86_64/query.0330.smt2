...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0330.smt2
|)
...
(not (not (and (not $x41) (or $x41 (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x17))))))))
(check-sat)
(exit)
