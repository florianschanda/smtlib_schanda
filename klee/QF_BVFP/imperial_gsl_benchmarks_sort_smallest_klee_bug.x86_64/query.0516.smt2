...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0516.smt2
|)
...
(assert
 (let (($x32 (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5)) (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)))))
 (or $x32 (fp.lt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!0)))))
(assert
 (let ((?x14 ((_ to_fp 11 53) x_ackermann!1)))
...
(assert
 (let ((?x23 ((_ to_fp 11 53) x_ackermann!4)))
 (let (($x36 (fp.isNaN ?x23)))
 (not $x36))))
(assert
 (let ((?x23 ((_ to_fp 11 53) x_ackermann!4)))
 (let (($x36 (fp.isNaN ?x23)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)) $x36) (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x23)))))
(assert
