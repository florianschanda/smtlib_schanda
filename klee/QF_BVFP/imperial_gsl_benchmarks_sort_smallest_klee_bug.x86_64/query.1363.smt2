...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1363.smt2
|)
...
(assert
 (let ((?x20 ((_ to_fp 11 53) x_ackermann!3)))
(let (($x21 (fp.isNaN ?x20)))
(let (($x47 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)) $x21) (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x20))))
(not (and (not $x21) $x47))))))
(check-sat)
(exit)
