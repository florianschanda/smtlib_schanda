...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1410.smt2
|)
...
(assert
 (let ((?x19 ((_ to_fp 11 53) x_ackermann!3)))
(let (($x20 (fp.isNaN ?x19)))
(let (($x46 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x20) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x19))))
(not (and (not $x20) $x46))))))
(check-sat)
(exit)
