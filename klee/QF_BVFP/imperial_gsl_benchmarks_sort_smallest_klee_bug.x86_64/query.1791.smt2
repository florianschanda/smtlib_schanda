...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1791.smt2
|)
...
(assert
 ...
 (let (($x14 (fp.isNaN ?x13)))
 (let ((?x23 ((_ to_fp 11 53) x_ackermann!3)))
 (let (($x34 (fp.isNaN ?x23)))
 (let (($x33 (not $x14)))
 (not (and $x33 (or (or $x34 $x14) (fp.gt ?x23 ?x13))))))))))
(assert
 (not (fp.gt ((_ to_fp 11 53) x_ackermann!2) ((_ to_fp 11 53) x_ackermann!1))))
(assert
 (let ((?x15 ((_ to_fp 11 53) x_ackermann!1)))
 (let ((?x42 ((_ to_fp 11 53) x_ackermann!5)))
 (fp.gt ?x42 ?x15))))
(assert
 (let ((?x23 ((_ to_fp 11 53) x_ackermann!3)))
 (let (($x34 (fp.isNaN ?x23)))
 (or (or $x34 (fp.isNaN ((_ to_fp 11 53) x_ackermann!5))) (fp.lt ?x23 ((_ to_fp 11 53) x_ackermann!5))))))
(assert
