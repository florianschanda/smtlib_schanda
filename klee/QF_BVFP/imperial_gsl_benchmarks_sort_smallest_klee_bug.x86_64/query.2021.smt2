...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.2021.smt2
|)
...
(assert
 ...
 (or (or $x37 (fp.isNaN ((_ to_fp 11 53) x_ackermann!4))) (fp.lt ?x36 ((_ to_fp 11 53) x_ackermann!4))))))
(assert
 (let ((?x15 ((_ to_fp 11 53) x_ackermann!1)))
 (let ((?x36 ((_ to_fp 11 53) x_ackermann!5)))
 (fp.gt ?x36 ?x15))))
(assert
 (let ((?x36 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x37 (fp.isNaN ?x36)))
 (or $x37 (fp.lt ((_ to_fp 11 53) x_ackermann!3) ?x36)))))
(assert
