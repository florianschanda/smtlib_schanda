...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0544.smt2
|)
...
(let (($x39 (fp.isNaN ?x16)))
(let (($x44 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)) $x39) (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x16))))
(not (and (not $x39) $x44))))))
(check-sat)
(exit)
