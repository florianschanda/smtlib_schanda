...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1757.smt2
|)
...
(assert
 (let ((?x22 ((_ to_fp 11 53) x_ackermann!3)))
 (let (($x23 (fp.isNaN ?x22)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5)) $x23) (fp.lt ((_ to_fp 11 53) x_ackermann!5) ?x22)))))
(assert
 (let ((?x17 ((_ to_fp 11 53) x_ackermann!2)))
...
(assert
 ...
 (let (($x45 (fp.isNaN ?x32)))
 (not $x45))))
(assert
 (let ((?x32 ((_ to_fp 11 53) x_ackermann!4)))
 (let (($x45 (fp.isNaN ?x32)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!2)) $x45) (fp.gt ((_ to_fp 11 53) x_ackermann!2) ?x32)))))
(assert
 (not false))
(check-sat)
(exit)
