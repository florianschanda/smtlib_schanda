...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.2197.smt2
|)
...
(assert
 (let (($x25 (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!3)) (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)))))
 (or $x25 (fp.lt ((_ to_fp 11 53) x_ackermann!3) ((_ to_fp 11 53) x_ackermann!1)))))
(assert
...
(assert
 ...
 (let (($x50 (fp.isNaN ?x41)))
 (not $x50))))
(assert
 (let ((?x41 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x50 (fp.isNaN ?x41)))
 (or $x50 (fp.gt ((_ to_fp 11 53) x_ackermann!4) ?x41)))))
(assert
 (not false))
(check-sat)
(exit)
