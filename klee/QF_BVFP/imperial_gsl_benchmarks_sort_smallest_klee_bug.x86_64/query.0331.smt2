...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0331.smt2
|)
...
(assert
 ...
 (let (($x35 (fp.isNaN ?x17)))
 (not $x35))))
(assert
 (let ((?x17 ((_ to_fp 11 53) x_ackermann!2)))
 (let (($x35 (fp.isNaN ?x17)))
 (or $x35 (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x17)))))
(assert
