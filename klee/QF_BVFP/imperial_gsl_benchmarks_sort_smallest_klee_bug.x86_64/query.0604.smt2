...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0604.smt2
|)
...
(assert
 (let ((?x13 ((_ to_fp 11 53) x_ackermann!0)))
 (let (($x14 (fp.isNaN ?x13)))
 (let (($x33 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!3)) $x14) (fp.gt ((_ to_fp 11 53) x_ackermann!3) ?x13))))
 (let (($x29 (not $x14)))
 (not (and $x29 $x33)))))))
(assert
