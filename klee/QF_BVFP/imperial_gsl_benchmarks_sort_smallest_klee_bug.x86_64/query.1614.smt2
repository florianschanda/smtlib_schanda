...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1614.smt2
|)
...
(assert
 (let ((?x36 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x37 (fp.isNaN ?x36)))
(let (($x51 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x37) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x36))))
(not (not (and (not $x37) $x51)))))))
(check-sat)
(exit)
