...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0456.smt2
|)
...
(assert
 ...
 (let (($x37 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)) $x32) (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x13))))
 (let (($x33 (not $x32)))
 (not (and $x33 $x37)))))))
(assert
