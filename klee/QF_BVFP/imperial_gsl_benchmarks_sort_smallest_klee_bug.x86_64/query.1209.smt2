...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1209.smt2
|)
...
(assert
 ...
 (or $x36 (fp.lt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!0)))))
(assert
...
(assert
 (let ((?x27 ((_ to_fp 11 53) x_ackermann!4)))
 (let (($x40 (fp.isNaN ?x27)))
 (not $x40))))
(assert
 (let ((?x27 ((_ to_fp 11 53) x_ackermann!4)))
 (let (($x40 (fp.isNaN ?x27)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!2)) $x40) (fp.gt ((_ to_fp 11 53) x_ackermann!2) ?x27)))))
(assert
