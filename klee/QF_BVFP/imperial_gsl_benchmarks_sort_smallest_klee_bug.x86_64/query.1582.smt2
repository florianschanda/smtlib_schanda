...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1582.smt2
|)
...
(assert
 (let ((?x21 ((_ to_fp 11 53) x_ackermann!3)))
 (let (($x22 (fp.isNaN ?x21)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5)) $x22) (fp.lt ((_ to_fp 11 53) x_ackermann!5) ?x21)))))
(assert
 (let ((?x13 ((_ to_fp 11 53) x_ackermann!0)))
...
(assert
 ...
 (let (($x44 (fp.isNaN ?x31)))
 (not $x44))))
(assert
 (let ((?x31 ((_ to_fp 11 53) x_ackermann!4)))
 (let (($x44 (fp.isNaN ?x31)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x44) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x31)))))
(assert
 (not false))
(check-sat)
(exit)
