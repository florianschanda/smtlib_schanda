...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1181.smt2
|)
...
(assert
 (let ((?x34 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x41 (fp.isNaN ?x34)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!2)) $x41) (fp.gt ((_ to_fp 11 53) x_ackermann!2) ?x34)))))
(assert
