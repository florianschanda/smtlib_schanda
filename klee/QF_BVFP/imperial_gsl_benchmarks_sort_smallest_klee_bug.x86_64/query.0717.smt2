...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0717.smt2
|)
...
(assert
 (let ((?x25 ((_ to_fp 11 53) x_ackermann!4)))
(let (($x26 (fp.isNaN ?x25)))
(not (and (not $x26) (or $x26 (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x25)))))))
(check-sat)
(exit)
