...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1849.smt2
|)
...
(assert
 (let ((?x39 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x40 (fp.isNaN ?x39)))
 (or $x40 (fp.lt ((_ to_fp 11 53) x_ackermann!3) ?x39)))))
(assert
