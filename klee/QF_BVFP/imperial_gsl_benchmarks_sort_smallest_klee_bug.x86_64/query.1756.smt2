...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1756.smt2
|)
...
(assert
 (let ((?x22 ((_ to_fp 11 53) x_ackermann!4)))
(let (($x23 (fp.isNaN ?x22)))
(not (and (not $x23) (or $x23 (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x22)))))))
(check-sat)
(exit)
