...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1706.smt2
|)
...
(assert
 ...
 (or (or $x37 (fp.isNaN ((_ to_fp 11 53) x_ackermann!2))) (fp.lt ?x36 ((_ to_fp 11 53) x_ackermann!2))))))
(assert
...
(assert
 (let ((?x36 ((_ to_fp 11 53) x_ackermann!5)))
(let (($x37 (fp.isNaN ?x36)))
(let (($x50 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x37) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x36))))
(not (and (not $x37) $x50))))))
(check-sat)
(exit)
