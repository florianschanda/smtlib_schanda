...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1018.smt2
|)
...
(assert
 (let (($x35 (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5)) (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)))))
 (or $x35 (fp.lt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!0)))))
(assert
 (let ((?x14 ((_ to_fp 11 53) x_ackermann!1)))
...
(assert
 ...
 (let (($x39 (fp.isNaN ?x25)))
 (not $x39))))
(assert
 (let ((?x25 ((_ to_fp 11 53) x_ackermann!4)))
 (let (($x39 (fp.isNaN ?x25)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1)) $x39) (fp.gt ((_ to_fp 11 53) x_ackermann!1) ?x25)))))
(assert
 (not false))
(check-sat)
(exit)
