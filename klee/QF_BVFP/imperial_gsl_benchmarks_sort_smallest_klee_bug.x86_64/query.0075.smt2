...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.0075.smt2
|)
...
(assert
 (fp.gt ((_ to_fp 11 53) x_ackermann!0) ((_ to_fp 11 53) x_ackermann!1)))
(assert
 (let ((?x16 ((_ to_fp 11 53) x_ackermann!2)))
 (fp.gt ?x16 ((_ to_fp 11 53) x_ackermann!0))))
(assert
