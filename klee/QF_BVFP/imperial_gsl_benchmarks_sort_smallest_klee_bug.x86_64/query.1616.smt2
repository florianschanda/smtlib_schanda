...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1616.smt2
|)
...
(assert
 ...
 (let ((?x35 ((_ to_fp 11 53) x_ackermann!4)))
 (fp.gt ?x35 ?x15))))
(assert
 (let ((?x37 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x38 (fp.isNaN ?x37)))
 (or (or $x38 (fp.isNaN ((_ to_fp 11 53) x_ackermann!4))) (fp.lt ?x37 ((_ to_fp 11 53) x_ackermann!4))))))
(assert
 (let ((?x15 ((_ to_fp 11 53) x_ackermann!1)))
 (let ((?x37 ((_ to_fp 11 53) x_ackermann!5)))
 (fp.gt ?x37 ?x15))))
(assert
 (let ((?x37 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x38 (fp.isNaN ?x37)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!2)) $x38) (fp.lt ((_ to_fp 11 53) x_ackermann!2) ?x37)))))
(assert
