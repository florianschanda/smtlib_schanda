...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1495.smt2
|)
...
(assert
 (let ((?x39 ((_ to_fp 11 53) x_ackermann!5)))
 (let (($x46 (fp.isNaN ?x39)))
 (or (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0)) $x46) (fp.gt ((_ to_fp 11 53) x_ackermann!0) ?x39)))))
(assert
 (not false))
(check-sat)
(exit)
