...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_filter1.x86_64/query.12.smt2
|)
...
(assert
 (let ((?x9 ((_ to_fp 11 53) symbolic_0_double_2_ackermann!0)))
 (fp.geq ?x9 ((_ to_fp 11 53) (_ bv13830554455654793216 64)))))
(assert
 (let ((?x9 ((_ to_fp 11 53) symbolic_0_double_2_ackermann!0)))
 (fp.leq ?x9 ((_ to_fp 11 53) (_ bv4607182418800017408 64)))))
(assert
 (let ((?x16 ((_ to_fp 11 53) symbolic_0_double_3_ackermann!1)))
