...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_interval_klee_no_bug.x86_64/query.11.smt2
|)
...
(let ((?x25 ((_ to_fp 11 53) roundNearestTiesToEven (fp.add roundTowardPositive ((_ to_fp 8 24) initial_ackermann!0) ((_ to_fp 8 24) (_ bv1251513984 32))))))
(not (fp.geq ?x25 ?x29)))))
(check-sat)
(exit)
