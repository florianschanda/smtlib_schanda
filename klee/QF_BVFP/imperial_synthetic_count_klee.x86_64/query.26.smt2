...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_count_klee.x86_64/query.26.smt2
|)
...
(assert
 (let ((?x12 ((_ to_fp 8 24) end_ackermann!1)))
(not (not (fp.eq ((_ to_fp 8 24) (bvadd (_ bv23 32) start_ackermann!0)) ?x12)))))
(check-sat)
(exit)
