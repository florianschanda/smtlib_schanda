...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_diction_style.x86_64/query.35.smt2
|)
...
(assert
 (let ((?x13 ((_ to_fp 11 53) roundNearestTiesToEven words_ackermann!0)))
(let ((?x20 (fp.add roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x13 ((_ to_fp 11 53) (_ bv4625759767262920704 64))) (fp.div roundNearestTiesToEven ((_ to_fp 11 53) (_ bv4667547806188175360 64)) ?x13))))
(let (($x33 (= (_ bv4 32) (ite (fp.isNormal ((_ to_fp 8 24) roundNearestTiesToEven ?x20)) (_ bv4 32) (_ bv3 32)))))
(not $x33)))))
(check-sat)
(exit)
