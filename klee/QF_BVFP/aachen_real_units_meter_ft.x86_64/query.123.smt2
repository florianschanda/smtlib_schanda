...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_units_meter_ft.x86_64/query.123.smt2
|)
...
(assert
 (let ((?x71 (concat (concat ((_ extract 79 79) (concat (_ bv16385 16) (_ bv9223372036854775808 64))) ((_ extract 78 64) (concat (_ bv16385 16) (_ bv9223372036854775808 64)))) ((_ extract 62 0) (concat (_ bv16385 16) (_ bv9223372036854775808 64))))))
 (let ((?x72 ((_ to_fp 15 64) ?x71)))
 (= ((_ extract 63 63) (concat (_ bv16385 16) (_ bv9223372036854775808 64))) (ite (or (fp.isSubnormal ?x72) (fp.isZero ?x72)) (_ bv0 1) (_ bv1 1))))))
(assert
 (let ((?x71 (concat (concat ((_ extract 79 79) (concat (_ bv16385 16) (_ bv9223372036854775808 64))) ((_ extract 78 64) (concat (_ bv16385 16) (_ bv9223372036854775808 64)))) ((_ extract 62 0) (concat (_ bv16385 16) (_ bv9223372036854775808 64))))))
(let ((?x72 ((_ to_fp 15 64) ?x71)))
...
(let ((?x49 (concat (concat ((_ extract 79 79) (concat (_ bv0 16) (_ bv0 64))) ((_ extract 78 64) (concat (_ bv0 16) (_ bv0 64)))) ((_ extract 62 0) (concat (_ bv0 16) (_ bv0 64))))))
(let ((?x50 ((_ to_fp 15 64) ?x49)))
(let ((?x59 (fp.add roundNearestTiesToEven ?x50 ?x60)))
(not (not (fp.eq ?x59 (fp.div roundNearestTiesToEven ?x59 ?x72)))))))))))
(check-sat)
(exit)
