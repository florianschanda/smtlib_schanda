...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sorted_search_klee_no_bug_float.x86_64/query.27.smt2
|)
...
(assert
 ...
 (let ((?x22 ((_ to_fp 8 24) data_ackermann!3)))
 (fp.eq ?x22 ?x26))))
(assert
...
(let (($x46 (fp.gt ?x13 ?x26)))
(not (not (= (ite $x46 (_ bv0 32) (_ bv2 32)) (ite $x46 (_ bv2 32) (_ bv5 32)))))))))
(check-sat)
(exit)
