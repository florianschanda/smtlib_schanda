...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_syn_nan_longdouble.x86_64/query.02.smt2
|)
...
(let ((?x13 (concat (concat ((_ extract 79 79) f_ackermann!0) ((_ extract 78 64) f_ackermann!0)) ((_ extract 62 0) f_ackermann!0))))
(let ((?x14 ((_ to_fp 15 64) ?x13)))
(not (not (not (fp.isNaN (fp.add roundNearestTiesToEven ?x14 ?x32))))))))))
(check-sat)
(exit)
