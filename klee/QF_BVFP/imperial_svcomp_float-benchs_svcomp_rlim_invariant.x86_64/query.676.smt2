...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.676.smt2
|)
...
(assert
 ...
 (fp.leq ?x24 ?x22))))
(assert
 (let ((?x70 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x71 (fp.sub roundNearestTiesToEven ?x29 ?x70)))
 (let ((?x67 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x68 (fp.sub roundNearestTiesToEven ?x24 ?x67)))
 (or (or (fp.isNaN ?x68) (fp.isNaN ?x71)) (fp.gt ?x68 ?x71)))))))))
(assert
 (let ((?x70 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x67 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x68 (fp.sub roundNearestTiesToEven ?x24 ?x67)))
 (or (or (fp.isNaN ?x68) (fp.isNaN ?x70)) (fp.lt ?x68 ?x70)))))))
(assert
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x30 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (fp.geq ?x30 ?x42))))
...
(assert
 ...
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x67 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x86 (fp.sub roundNearestTiesToEven ?x67 ?x42)))
...
(assert
 (let ((?x62 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x105 (fp.sub roundNearestTiesToEven ?x29 ?x62)))
(let ((?x40 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
(let ((?x59 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x103 (fp.sub roundNearestTiesToEven ?x59 (fp.add roundNearestTiesToEven ?x17 ?x40))))
(not (or (or (fp.isNaN ?x103) (fp.isNaN ?x105)) (fp.gt ?x103 ?x105)))))))))))
(check-sat)
(exit)
