...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.320.smt2
|)
...
(let ((?x42 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x52 (fp.sub roundNearestTiesToEven ?x42 ?x17)))
(let (($x111 (and (and (not (fp.isNaN ?x52)) (not (fp.isNaN ?x45))) (not (fp.lt ?x52 ?x45)))))
(not $x111)))))))
(check-sat)
(exit)
