...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.488.smt2
|)
...
(assert
 ...
 (let ((?x82 (fp.sub roundNearestTiesToEven ?x81 ?x30)))
 (not (fp.isNaN ?x82))))))))))
(assert
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x38 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x85 (fp.sub roundNearestTiesToEven ?x38 ?x31)))
 (not (fp.isNaN ?x85))))))
(assert
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x38 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 (let ((?x33 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x38 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x92 (fp.sub roundNearestTiesToEven ?x38 ?x33)))
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 ...
 (let ((?x30 (fp.add roundNearestTiesToEven ?x28 ?x29)))
 (let ((?x32 (fp.sub roundNearestTiesToEven ?x30 ?x31)))
 (let ((?x94 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!2)))
 (let ((?x95 (fp.sub roundNearestTiesToEven ?x94 ?x32)))
