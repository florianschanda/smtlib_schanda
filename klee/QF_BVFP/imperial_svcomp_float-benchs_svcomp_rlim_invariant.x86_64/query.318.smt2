...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.318.smt2
|)
...
(let ((?x64 (fp.sub roundNearestTiesToEven ?x51 ?x47)))
(let ((?x77 (fp.sub roundNearestTiesToEven ?x64 ?x60)))
(let ((?x102 (fp.sub roundNearestTiesToEven ?x77 ?x73)))
(not (and (fp.geq ?x102 ((_ to_fp 8 24) (_ bv3271622656 32))) (fp.leq ?x102 ((_ to_fp 8 24) (_ bv1124139008 32)))))))))))))))))
(check-sat)
(exit)
