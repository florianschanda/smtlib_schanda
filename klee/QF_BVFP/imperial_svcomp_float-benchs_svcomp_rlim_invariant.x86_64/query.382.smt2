...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.382.smt2
|)
...
(assert
 ...
 (let ((?x42 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x67 (fp.sub roundNearestTiesToEven ?x42 (fp.sub roundNearestTiesToEven ?x64 ?x65))))
...
(assert
 ...
 (let ((?x56 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x64 (fp.add roundNearestTiesToEven ?x56 ?x63)))
 (let ((?x97 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x98 (fp.sub roundNearestTiesToEven ?x97 ?x64)))
 (not (fp.isNaN ?x98))))))))
(assert
 (let ((?x65 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x101 (fp.sub roundNearestTiesToEven ?x29 ?x65)))
 (not (fp.isNaN ?x101))))))
(assert
 (let ((?x65 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
