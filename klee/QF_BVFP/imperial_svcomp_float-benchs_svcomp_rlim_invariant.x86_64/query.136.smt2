...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.136.smt2
|)
...
(assert
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
 (let ((?x30 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x66 (fp.sub roundNearestTiesToEven ?x30 ?x24)))
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x68 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x69 (fp.sub roundNearestTiesToEven ?x68 ?x23)))
...
(assert
 (let ((?x61 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
(let ((?x30 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x87 (fp.sub roundNearestTiesToEven ?x30 ?x61)))
(let ((?x41 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
(let ((?x58 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x85 (fp.sub roundNearestTiesToEven ?x58 (fp.add roundNearestTiesToEven ?x15 ?x41))))
(not (or (or (fp.isNaN ?x85) (fp.isNaN ?x87)) (fp.gt ?x85 ?x87)))))))))))
(check-sat)
(exit)
