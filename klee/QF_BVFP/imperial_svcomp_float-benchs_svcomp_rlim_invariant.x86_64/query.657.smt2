...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.657.smt2
|)
...
(let ((?x87 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x94 (fp.sub roundNearestTiesToEven ?x87 (fp.sub roundNearestTiesToEven ?x78 ?x74))))
(not (or (or (fp.isNaN ?x94) (fp.isNaN ?x90)) (fp.lt ?x94 ?x90)))))))))))))
(check-sat)
(exit)
