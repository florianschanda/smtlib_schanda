...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.361.smt2
|)
...
(assert
 ...
 (let ((?x56 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x63 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x82 (fp.sub roundNearestTiesToEven ?x63 (fp.sub roundNearestTiesToEven ?x56 ?x80))))
...
(assert
 ...
 (let ((?x102 (fp.sub roundNearestTiesToEven ?x101 ?x56)))
 (not (fp.gt ?x102 ?x98)))))))))
(assert
 (let ((?x56 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x84 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
