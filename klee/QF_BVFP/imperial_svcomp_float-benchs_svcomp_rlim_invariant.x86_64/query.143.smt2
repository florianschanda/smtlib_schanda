...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.143.smt2
|)
...
(assert
 (let ((?x69 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
(let ((?x28 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x82 (fp.sub roundNearestTiesToEven ?x28 ?x69)))
(let ((?x53 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
(let ((?x39 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
(let ((?x57 (fp.sub roundNearestTiesToEven ?x15 ?x39)))
(let ((?x66 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x79 (fp.sub roundNearestTiesToEven ?x66 (fp.sub roundNearestTiesToEven ?x57 ?x53))))
(let (($x88 (and (and (not (fp.isNaN ?x79)) (not (fp.isNaN ?x82))) (not (fp.gt ?x79 ?x82)))))
(not $x88))))))))))))
(check-sat)
(exit)
