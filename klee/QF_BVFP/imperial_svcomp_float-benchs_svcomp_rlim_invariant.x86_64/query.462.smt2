...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.462.smt2
|)
...
(assert
 ...
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!2)))
 (let ((?x45 (fp.sub roundNearestTiesToEven ?x24 (fp.add roundNearestTiesToEven ?x42 ?x43))))
...
(assert
 ...
 (let ((?x58 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x42 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x67 (fp.sub roundNearestTiesToEven ?x42 (fp.sub roundNearestTiesToEven ?x58 ?x65))))
...
(assert
 ...
 (let ((?x101 (fp.sub roundNearestTiesToEven ?x100 ?x58)))
 (not (fp.gt ?x101 ?x97)))))))))
(assert
 (let ((?x58 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x69 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
