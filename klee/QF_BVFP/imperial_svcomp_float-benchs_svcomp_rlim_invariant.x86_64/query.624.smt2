...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.624.smt2
|)
...
(assert
 ...
 (let ((?x42 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x44 (fp.add roundNearestTiesToEven ?x42 ?x43)))
 (let ((?x95 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x96 (fp.sub roundNearestTiesToEven ?x95 ?x44)))
 (not (fp.isNaN ?x96))))))))
(assert
 (let ((?x45 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x99 (fp.sub roundNearestTiesToEven ?x29 ?x45)))
 (not (fp.isNaN ?x99))))))
(assert
 (let ((?x45 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
