...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.614.smt2
|)
...
(assert
 ...
 (let ((?x64 (fp.sub roundNearestTiesToEven ?x36 ?x26)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x67 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x68 (fp.sub roundNearestTiesToEven ?x67 ?x25)))
 (not (fp.gt ?x68 ?x64)))))))))
(assert
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
...
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x73 (fp.sub roundNearestTiesToEven ?x36 ?x29)))
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x28 (fp.sub roundNearestTiesToEven ?x25 ?x26)))
...
(assert
 ...
 (let ((?x28 (fp.sub roundNearestTiesToEven ?x25 ?x26)))
 (let ((?x30 (fp.add roundNearestTiesToEven ?x28 ?x29)))
 (let ((?x87 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x88 (fp.sub roundNearestTiesToEven ?x87 ?x30)))
 (not (fp.isNaN ?x88))))))))))
(assert
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
