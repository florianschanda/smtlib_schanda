...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.634.smt2
|)
...
(assert
 ...
 (let ((?x60 (fp.sub roundNearestTiesToEven ?x59 ?x25)))
 (or (fp.isNaN ?x57) (fp.gt ?x60 ?x57)))))))))
(assert
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x59 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x60 (fp.sub roundNearestTiesToEven ?x59 ?x25)))
...
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x71 (fp.sub roundNearestTiesToEven ?x36 ?x29)))
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x28 (fp.add roundNearestTiesToEven ?x25 ?x26)))
 (let ((?x73 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x74 (fp.sub roundNearestTiesToEven ?x73 ?x28)))
...
(assert
 ...
 (let ((?x28 (fp.add roundNearestTiesToEven ?x25 ?x26)))
 (let ((?x30 (fp.add roundNearestTiesToEven ?x28 ?x29)))
 (let ((?x85 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x86 (fp.sub roundNearestTiesToEven ?x85 ?x30)))
 (not (fp.isNaN ?x86))))))))))
(assert
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 (let ((?x50 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x105 (fp.sub roundNearestTiesToEven ?x36 ?x50)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!2)))
(let ((?x47 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x102 (fp.sub roundNearestTiesToEven ?x47 ?x17)))
