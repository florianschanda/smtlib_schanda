...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.057.smt2
|)
...
(assert
 ...
 (let ((?x55 (fp.sub roundNearestTiesToEven ?x28 ?x22)))
 (let ((?x21 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x58 ((_ to_fp 8 24) symbolic_0_float_ackermann!5)))
 (let ((?x59 (fp.sub roundNearestTiesToEven ?x58 ?x21)))
 (not (fp.gt ?x59 ?x55)))))))))
(assert
 (let ((?x21 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
