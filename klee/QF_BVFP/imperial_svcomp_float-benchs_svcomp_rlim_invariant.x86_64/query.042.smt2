...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.042.smt2
|)
...
(assert
 (let ((?x55 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!2)))
(let ((?x21 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x66 (fp.sub roundNearestTiesToEven ?x21 ?x55)))
(let ((?x35 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
(let ((?x13 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!4)))
(let ((?x15 ((_ to_fp 8 24) (_ bv0 32))))
(let ((?x39 (fp.add roundNearestTiesToEven ?x15 ?x13)))
(let ((?x48 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!3)))
(let ((?x63 (fp.sub roundNearestTiesToEven ?x48 (fp.sub roundNearestTiesToEven ?x39 ?x35))))
(let (($x72 (and (and (not (fp.isNaN ?x63)) (not (fp.isNaN ?x66))) (not (fp.gt ?x63 ?x66)))))
(not $x72))))))))))))
(check-sat)
(exit)
