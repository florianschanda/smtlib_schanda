...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.041.smt2
|)
...
(assert
 (let ((?x51 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!2)))
 (let ((?x21 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x54 (fp.sub roundNearestTiesToEven ?x21 ?x51)))
 (let ((?x35 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x13 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!4)))
 (let ((?x15 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x41 (fp.add roundNearestTiesToEven ?x15 ?x13)))
 (let ((?x57 (fp.add roundNearestTiesToEven ?x41 ?x35)))
...
(let ((?x41 (fp.add roundNearestTiesToEven ?x15 ?x13)))
(let ((?x57 (fp.add roundNearestTiesToEven ?x41 ?x35)))
(let ((?x77 (fp.add roundNearestTiesToEven ?x57 ?x51)))
(not (and (fp.geq ?x77 ((_ to_fp 8 24) (_ bv3271622656 32))) (fp.leq ?x77 ((_ to_fp 8 24) (_ bv1124139008 32)))))))))))))
(check-sat)
(exit)
