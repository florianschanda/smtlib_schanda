...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.171.smt2
|)
...
(assert
 ...
 (let ((?x56 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
 (let ((?x40 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x22 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
 (let ((?x58 (fp.sub roundNearestTiesToEven ?x22 (fp.sub roundNearestTiesToEven ?x40 ?x56))))
...
(assert
 (let ((?x56 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
 (let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x76 (fp.sub roundNearestTiesToEven ?x27 ?x56)))
 (not (fp.isNaN ?x76))))))
(assert
 (let ((?x56 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
 (let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x76 (fp.sub roundNearestTiesToEven ?x27 ?x56)))
 (let ((?x40 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x79 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
...
(assert
 (let ((?x38 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!4)))
(let ((?x89 (fp.sub roundNearestTiesToEven ?x15 ?x38)))
