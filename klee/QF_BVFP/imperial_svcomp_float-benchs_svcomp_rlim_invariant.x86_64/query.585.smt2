...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.585.smt2
|)
...
(assert
 ...
 (let ((?x59 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x77 (fp.sub roundNearestTiesToEven ?x59 ?x76)))
...
(assert
 ...
 (let ((?x45 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x76 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x93 (fp.sub roundNearestTiesToEven ?x76 ?x45)))
