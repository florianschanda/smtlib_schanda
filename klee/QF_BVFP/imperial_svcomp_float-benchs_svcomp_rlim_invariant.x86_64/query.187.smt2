...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.187.smt2
|)
...
(assert
 ...
 (not (fp.gt ?x58 ?x61)))))))))))))
(assert
 (let ((?x68 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x66 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
 (fp.geq ?x66 ?x68))))
(assert
 (let ((?x71 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x66 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
 (fp.leq ?x66 ?x71))))
(assert
 (let ((?x17 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x73 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (fp.geq ?x73 ?x17))))
(assert
 (let ((?x20 ((_ to_fp 8 24) (_ bv1098907648 32))))
 (let ((?x73 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
...
(assert
 (let ((?x73 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
(let ((?x23 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x86 (fp.sub roundNearestTiesToEven ?x23 ?x73)))
(let ((?x53 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
(let ((?x37 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
(let ((?x17 ((_ to_fp 8 24) (_ bv0 32))))
...
(let ((?x57 (fp.add roundNearestTiesToEven ?x43 ?x37)))
(let ((?x66 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x83 (fp.sub roundNearestTiesToEven ?x66 (fp.sub roundNearestTiesToEven ?x57 ?x53))))
