...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.612.smt2
|)
...
(assert
 ...
 (let ((?x56 (fp.sub roundNearestTiesToEven ?x43 ?x39)))
 (let ((?x71 (fp.sub roundNearestTiesToEven ?x56 ?x52)))
 (let ((?x87 (fp.add roundNearestTiesToEven ?x71 ?x65)))
