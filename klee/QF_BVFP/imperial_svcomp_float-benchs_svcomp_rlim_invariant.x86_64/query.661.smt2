...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.661.smt2
|)
...
(assert
 ...
 (let ((?x64 (fp.add roundNearestTiesToEven ?x17 ?x41)))
 (let ((?x78 (fp.add roundNearestTiesToEven ?x64 ?x58)))
 (let ((?x93 (fp.sub roundNearestTiesToEven ?x78 ?x74)))
