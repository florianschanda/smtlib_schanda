...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.487.smt2
|)
...
(let ((?x84 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x95 (fp.sub roundNearestTiesToEven ?x84 (fp.add roundNearestTiesToEven ?x74 ?x68))))
(not (or (or (fp.isNaN ?x95) (fp.isNaN ?x91)) (fp.lt ?x95 ?x91)))))))))))))))
(check-sat)
(exit)
