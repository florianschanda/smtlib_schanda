...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.163.smt2
|)
...
(let ((?x59 (fp.add roundNearestTiesToEven ?x43 ?x37)))
(let ((?x75 (fp.add roundNearestTiesToEven ?x59 ?x53)))
(let ((?x97 (fp.add roundNearestTiesToEven ?x75 ?x69)))
(not (and (fp.geq ?x97 ((_ to_fp 8 24) (_ bv3271622656 32))) (fp.leq ?x97 ((_ to_fp 8 24) (_ bv1124139008 32)))))))))))))))
(check-sat)
(exit)
