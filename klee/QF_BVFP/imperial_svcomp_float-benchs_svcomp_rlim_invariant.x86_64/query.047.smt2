...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.047.smt2
|)
...
(assert
 ...
 (let ((?x55 (fp.sub roundNearestTiesToEven ?x53 (fp.sub roundNearestTiesToEven ?x39 ?x35))))
