...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.236.smt2
|)
...
(assert
 ...
 (let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x65 (fp.sub roundNearestTiesToEven ?x27 ?x64)))
 (let ((?x61 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x40 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
 (let ((?x62 (fp.sub roundNearestTiesToEven ?x40 ?x61)))
...
(assert
 ...
 (fp.leq ?x61 ?x20))))
(assert
 (let ((?x80 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
 (let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x81 (fp.sub roundNearestTiesToEven ?x27 ?x80)))
 (let ((?x54 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x61 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x78 (fp.sub roundNearestTiesToEven ?x61 ?x54)))
