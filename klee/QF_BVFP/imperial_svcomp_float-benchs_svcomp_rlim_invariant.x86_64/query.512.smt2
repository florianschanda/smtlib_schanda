...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.512.smt2
|)
...
(assert
 (let ((?x58 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x61 (fp.sub roundNearestTiesToEven ?x31 ?x58)))
 (let ((?x42 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x64 (fp.sub roundNearestTiesToEven ?x17 ?x42)))
 (let ((?x63 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
...
(assert
 ...
 (fp.leq ?x24 ?x22))))
(assert
 (let ((?x78 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x79 (fp.sub roundNearestTiesToEven ?x31 ?x78)))
 (let ((?x44 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x76 (fp.sub roundNearestTiesToEven ?x24 ?x44)))
 (or (or (fp.isNaN ?x76) (fp.isNaN ?x79)) (fp.gt ?x76 ?x79)))))))))
(assert
 (let ((?x78 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x44 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x76 (fp.sub roundNearestTiesToEven ?x24 ?x44)))
 (or (or (fp.isNaN ?x76) (fp.isNaN ?x78)) (fp.lt ?x76 ?x78)))))))
(assert
 (let ((?x44 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x25 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (fp.geq ?x25 ?x44))))
...
(assert
 (let ((?x25 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x94 (fp.sub roundNearestTiesToEven ?x31 ?x25)))
 (not (fp.isNaN ?x94))))))
(assert
 (let ((?x25 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
(let ((?x64 (fp.sub roundNearestTiesToEven ?x17 ?x42)))
(let ((?x109 (fp.add roundNearestTiesToEven ?x64 ?x58)))
