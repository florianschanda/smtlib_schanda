...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.610.smt2
|)
...
(assert
 ...
 (let ((?x86 (fp.sub roundNearestTiesToEven ?x84 (fp.add roundNearestTiesToEven ?x71 ?x65))))
 (not (fp.isNaN ?x86)))))))))))))
(assert
 (let ((?x81 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv2147483648 32))))
