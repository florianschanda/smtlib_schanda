...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.027.smt2
|)
...
(assert
 (let ((?x35 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x41 (fp.sub roundNearestTiesToEven ((_ to_fp 8 24) (_ bv2147483648 32)) ?x35)))
 (let ((?x11 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!2)))
 (let ((?x13 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x28 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!1)))
 (let ((?x39 (fp.sub roundNearestTiesToEven ?x28 (fp.sub roundNearestTiesToEven ?x13 ?x11))))
 (or (or (fp.isNaN ?x39) (fp.isNaN ?x41)) (fp.gt ?x39 ?x41)))))))))
(assert
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_ackermann!3)))
...
(let ((?x28 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!1)))
(let ((?x39 (fp.sub roundNearestTiesToEven ?x28 (fp.sub roundNearestTiesToEven ?x13 ?x11))))
(let (($x56 (and (and (not (fp.isNaN ?x39)) (not (fp.isNaN ?x35))) (not (fp.lt ?x39 ?x35)))))
(not $x56))))))))
(check-sat)
(exit)
