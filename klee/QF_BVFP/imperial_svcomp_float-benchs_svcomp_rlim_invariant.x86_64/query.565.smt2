...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.565.smt2
|)
...
(assert
 ...
 (let ((?x100 (fp.sub roundNearestTiesToEven ?x99 ?x47)))
 (not (fp.gt ?x100 ?x96)))))))))
(assert
 (let ((?x47 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x52 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
