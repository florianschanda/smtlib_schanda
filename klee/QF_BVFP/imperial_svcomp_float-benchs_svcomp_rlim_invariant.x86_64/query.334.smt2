...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.334.smt2
|)
...
(assert
 (let ((?x76 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x102 (fp.sub roundNearestTiesToEven ?x32 ?x76)))
(let ((?x60 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
(let ((?x43 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
(let ((?x64 (fp.add roundNearestTiesToEven ?x17 ?x43)))
(let ((?x73 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x99 (fp.sub roundNearestTiesToEven ?x73 (fp.sub roundNearestTiesToEven ?x64 ?x60))))
