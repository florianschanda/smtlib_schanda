...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.499.smt2
|)
...
(assert
 ...
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x55 (fp.sub roundNearestTiesToEven ?x24 (fp.sub roundNearestTiesToEven ?x52 ?x53))))
...
(assert
 ...
 (let ((?x86 (fp.sub roundNearestTiesToEven ?x85 ?x52)))
 (not (fp.isNaN ?x86))))))
(assert
 (let ((?x53 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x89 (fp.sub roundNearestTiesToEven ?x29 ?x53)))
 (not (fp.isNaN ?x89))))))
(assert
 (let ((?x53 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 (let ((?x43 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x102 (fp.sub roundNearestTiesToEven ?x29 ?x43)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!2)))
(let ((?x40 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
