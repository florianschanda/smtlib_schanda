...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.366.smt2
|)
...
(assert
 ...
 (let ((?x78 (fp.sub roundNearestTiesToEven ?x77 ?x25)))
...
(assert
 ...
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x28 (fp.add roundNearestTiesToEven ?x25 ?x26)))
 (let ((?x89 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x90 (fp.sub roundNearestTiesToEven ?x89 ?x28)))
 (not (fp.isNaN ?x90))))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x93 (fp.sub roundNearestTiesToEven ?x34 ?x29)))
 (not (fp.isNaN ?x93))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x59 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x66 (fp.sub roundNearestTiesToEven ?x59 (fp.sub roundNearestTiesToEven ?x17 ?x45))))
(not (or (or (fp.isNaN ?x66) (fp.isNaN ?x62)) (fp.lt ?x66 ?x62)))))))))
(check-sat)
(exit)
