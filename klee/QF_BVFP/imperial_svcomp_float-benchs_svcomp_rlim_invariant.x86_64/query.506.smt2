...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.506.smt2
|)
...
(assert
 ...
 (let ((?x81 (fp.sub roundNearestTiesToEven ?x80 ?x24)))
 (not (fp.isNaN ?x81))))))
(assert
 (let ((?x25 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x84 (fp.sub roundNearestTiesToEven ?x31 ?x25)))
 (not (fp.isNaN ?x84))))))
(assert
 (let ((?x25 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 (let ((?x61 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x100 (fp.sub roundNearestTiesToEven ?x31 ?x61)))
(let ((?x42 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
(let ((?x58 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x98 (fp.sub roundNearestTiesToEven ?x58 (fp.sub roundNearestTiesToEven ?x17 ?x42))))
