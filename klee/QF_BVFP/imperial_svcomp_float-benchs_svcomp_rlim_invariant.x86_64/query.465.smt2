...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.465.smt2
|)
...
(assert
 ...
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x63 (fp.add roundNearestTiesToEven ?x17 ?x40)))
 (let ((?x76 (fp.sub roundNearestTiesToEven ?x63 ?x59)))
 (let ((?x75 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
 (let ((?x77 (fp.sub roundNearestTiesToEven ?x75 ?x76)))
 (not (fp.isNaN ?x77))))))))))
(assert
 (let ((?x72 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x80 (fp.sub roundNearestTiesToEven ?x29 ?x72)))
 (not (fp.isNaN ?x80))))))
(assert
 (let ((?x72 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 ...
 (fp.leq ?x24 ?x22))))
(assert
 (let ((?x89 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x90 (fp.sub roundNearestTiesToEven ?x29 ?x89)))
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x87 (fp.sub roundNearestTiesToEven ?x24 ?x42)))
 (or (or (fp.isNaN ?x87) (fp.isNaN ?x90)) (fp.gt ?x87 ?x90)))))))))
(assert
 (let ((?x89 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x87 (fp.sub roundNearestTiesToEven ?x24 ?x42)))
 (or (or (fp.isNaN ?x87) (fp.isNaN ?x89)) (fp.lt ?x87 ?x89)))))))
(assert
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x30 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (fp.geq ?x30 ?x42))))
...
(let ((?x63 (fp.add roundNearestTiesToEven ?x17 ?x40)))
(let ((?x76 (fp.sub roundNearestTiesToEven ?x63 ?x59)))
(let ((?x109 (fp.sub roundNearestTiesToEven ?x76 ?x72)))
