...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.642.smt2
|)
...
(assert
 ...
 (let ((?x88 (fp.sub roundNearestTiesToEven ?x87 ?x28)))
 (not (fp.isNaN ?x88))))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x91 (fp.sub roundNearestTiesToEven ?x34 ?x29)))
 (not (fp.isNaN ?x91))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x62 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x69 (fp.sub roundNearestTiesToEven ?x62 (fp.add roundNearestTiesToEven ?x17 ?x45))))
(let (($x112 (and (and (not (fp.isNaN ?x69)) (not (fp.isNaN ?x65))) (not (fp.lt ?x69 ?x65)))))
(not $x112))))))))
(check-sat)
(exit)
