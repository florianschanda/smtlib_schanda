...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.450.smt2
|)
...
(assert
 (let ((?x94 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x25 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x109 (fp.sub roundNearestTiesToEven ?x25 ?x94)))
(let ((?x71 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
(let ((?x55 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
(let ((?x39 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
...
(let ((?x77 (fp.add roundNearestTiesToEven ?x61 ?x55)))
(let ((?x87 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x106 (fp.sub roundNearestTiesToEven ?x87 (fp.add roundNearestTiesToEven ?x77 ?x71))))
(let (($x115 (and (and (not (fp.isNaN ?x106)) (not (fp.isNaN ?x109))) (not (fp.gt ?x106 ?x109)))))
(not $x115))))))))))))))))
(check-sat)
(exit)
