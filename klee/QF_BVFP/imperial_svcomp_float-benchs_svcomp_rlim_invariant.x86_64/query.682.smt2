...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.682.smt2
|)
...
(assert
 ...
 (fp.leq ?x44 ?x22))))
(assert
 (let ((?x82 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x83 (fp.sub roundNearestTiesToEven ?x31 ?x82)))
 (let ((?x79 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x44 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x80 (fp.sub roundNearestTiesToEven ?x44 ?x79)))
 (or (or (fp.isNaN ?x80) (fp.isNaN ?x83)) (fp.gt ?x80 ?x83)))))))))
(assert
 (let ((?x82 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x79 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x44 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x80 (fp.sub roundNearestTiesToEven ?x44 ?x79)))
 (or (or (fp.isNaN ?x80) (fp.isNaN ?x82)) (fp.lt ?x80 ?x82)))))))
(assert
 (let ((?x58 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x47 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (fp.geq ?x47 ?x58))))
...
(assert
 ...
 (fp.leq ?x79 ?x22))))
(assert
 (let ((?x100 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x101 (fp.sub roundNearestTiesToEven ?x31 ?x100)))
 (let ((?x58 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x79 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x98 (fp.sub roundNearestTiesToEven ?x79 ?x58)))
 (or (or (fp.isNaN ?x98) (fp.isNaN ?x101)) (fp.gt ?x98 ?x101)))))))))
(assert
 (let ((?x100 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x58 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x79 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x98 (fp.sub roundNearestTiesToEven ?x79 ?x58)))
 (or (or (fp.isNaN ?x98) (fp.isNaN ?x100)) (fp.lt ?x98 ?x100)))))))
(assert
 (let ((?x58 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x82 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (fp.geq ?x82 ?x58))))
