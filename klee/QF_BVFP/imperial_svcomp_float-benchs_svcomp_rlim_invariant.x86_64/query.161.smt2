...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.161.smt2
|)
...
(assert
 (let ((?x69 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x23 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x77 (fp.sub roundNearestTiesToEven ?x23 ?x69)))
 (not (fp.isNaN ?x77))))))
(assert
 (let ((?x69 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x23 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x59 (fp.add roundNearestTiesToEven ?x43 ?x37)))
(let ((?x73 (fp.add roundNearestTiesToEven ?x59 ?x53)))
(let ((?x94 (fp.sub roundNearestTiesToEven ?x73 ?x69)))
