...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.255.smt2
|)
...
(assert
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x75 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (fp.geq ?x75 ?x23))))
(assert
 (let ((?x42 ((_ to_fp 8 24) (_ bv1098907648 32))))
 (let ((?x75 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
...
(assert
 (let ((?x75 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x28 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x81 (fp.sub roundNearestTiesToEven ?x28 ?x75)))
 (let ((?x56 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
 (let ((?x39 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x15 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x62 (fp.add roundNearestTiesToEven ?x15 ?x39)))
 (let ((?x72 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
 (let ((?x79 (fp.sub roundNearestTiesToEven ?x72 (fp.add roundNearestTiesToEven ?x62 ?x56))))
 (or (or (fp.isNaN ?x79) (fp.isNaN ?x81)) (fp.gt ?x79 ?x81))))))))))))
(assert
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
 (fp.geq ?x29 ?x23))))
...
(let ((?x72 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x79 (fp.sub roundNearestTiesToEven ?x72 (fp.add roundNearestTiesToEven ?x62 ?x56))))
(not (or (or (fp.isNaN ?x79) (fp.isNaN ?x75)) (fp.lt ?x79 ?x75)))))))))))
(check-sat)
(exit)
