...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.103.smt2
|)
...
(assert
 ...
 (let ((?x63 (fp.sub roundNearestTiesToEven ?x61 (fp.sub roundNearestTiesToEven ?x49 ?x45))))
 (not (fp.isNaN ?x63)))))))))))
(assert
 (let ((?x58 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x23 ((_ to_fp 8 24) (_ bv2147483648 32))))
