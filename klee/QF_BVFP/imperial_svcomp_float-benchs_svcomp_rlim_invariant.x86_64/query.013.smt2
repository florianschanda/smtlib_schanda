...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.013.smt2
|)
...
(assert
 (let ((?x40 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x46 (fp.sub roundNearestTiesToEven ((_ to_fp 8 24) (_ bv2147483648 32)) ?x40)))
 (let ((?x11 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!2)))
 (let ((?x13 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x33 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!1)))
 (let ((?x44 (fp.sub roundNearestTiesToEven ?x33 (fp.add roundNearestTiesToEven ?x13 ?x11))))
 (or (or (fp.isNaN ?x44) (fp.isNaN ?x46)) (fp.gt ?x44 ?x46)))))))))
(assert
 (let ((?x23 ((_ to_fp 8 24) symbolic_0_float_ackermann!3)))
