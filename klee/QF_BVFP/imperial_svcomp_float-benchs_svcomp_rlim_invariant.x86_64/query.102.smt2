...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.102.smt2
|)
...
(assert
 (let ((?x65 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x23 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x71 (fp.sub roundNearestTiesToEven ?x23 ?x65)))
 (let ((?x45 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
 (let ((?x32 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x15 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
 (let ((?x17 ((_ to_fp 8 24) (_ bv0 32))))
 ...
 (let ((?x49 (fp.sub roundNearestTiesToEven ?x36 ?x32)))
 (let ((?x58 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
 (let ((?x69 (fp.sub roundNearestTiesToEven ?x58 (fp.sub roundNearestTiesToEven ?x49 ?x45))))
...
(let ((?x58 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x69 (fp.sub roundNearestTiesToEven ?x58 (fp.sub roundNearestTiesToEven ?x49 ?x45))))
(let (($x90 (and (and (not (fp.isNaN ?x69)) (not (fp.isNaN ?x65))) (not (fp.lt ?x69 ?x65)))))
(not $x90))))))))))))
(check-sat)
(exit)
