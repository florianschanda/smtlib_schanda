...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.313.smt2
|)
...
(assert
 (let ((?x19 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x80 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (fp.geq ?x80 ?x19))))
(assert
 (let ((?x22 ((_ to_fp 8 24) (_ bv1098907648 32))))
 (let ((?x80 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
...
(assert
 (let ((?x80 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x86 (fp.sub roundNearestTiesToEven ?x25 ?x80)))
 (let ((?x60 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x47 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x34 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 ...
 (let ((?x64 (fp.sub roundNearestTiesToEven ?x51 ?x47)))
 (let ((?x73 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
 (let ((?x84 (fp.sub roundNearestTiesToEven ?x73 (fp.sub roundNearestTiesToEven ?x64 ?x60))))
...
(let ((?x73 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x84 (fp.sub roundNearestTiesToEven ?x73 (fp.sub roundNearestTiesToEven ?x64 ?x60))))
(let (($x107 (and (and (not (fp.isNaN ?x84)) (not (fp.isNaN ?x80))) (not (fp.lt ?x84 ?x80)))))
(not $x107))))))))))))))
(check-sat)
(exit)
