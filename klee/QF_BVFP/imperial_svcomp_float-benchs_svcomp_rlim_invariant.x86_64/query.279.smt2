...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.279.smt2
|)
...
(assert
 (let ((?x38 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
 (let ((?x15 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
 (let ((?x58 (fp.sub roundNearestTiesToEven ?x15 ?x38)))
...
(assert
 (let ((?x54 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x62 (fp.sub roundNearestTiesToEven ?x27 ?x54)))
 (not (fp.isNaN ?x62))))))
(assert
 (let ((?x54 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 ...
 (fp.leq ?x22 ?x20))))
(assert
 (let ((?x71 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
 (let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x72 (fp.sub roundNearestTiesToEven ?x27 ?x71)))
 (let ((?x40 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x22 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x69 (fp.sub roundNearestTiesToEven ?x22 ?x40)))
...
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
(let ((?x58 (fp.sub roundNearestTiesToEven ?x15 ?x38)))
(let ((?x89 (fp.sub roundNearestTiesToEven ?x58 ?x54)))
(not (and (fp.geq ?x89 ((_ to_fp 8 24) (_ bv3271622656 32))) (fp.leq ?x89 ((_ to_fp 8 24) (_ bv1124139008 32)))))))))))
(check-sat)
(exit)
