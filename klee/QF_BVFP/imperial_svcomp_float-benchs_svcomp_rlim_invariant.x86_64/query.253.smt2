...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.253.smt2
|)
...
(assert
 (let ((?x75 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
(let ((?x28 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x88 (fp.sub roundNearestTiesToEven ?x28 ?x75)))
(let ((?x56 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
(let ((?x39 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
(let ((?x62 (fp.add roundNearestTiesToEven ?x15 ?x39)))
(let ((?x72 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x85 (fp.sub roundNearestTiesToEven ?x72 (fp.add roundNearestTiesToEven ?x62 ?x56))))
(let (($x94 (and (and (not (fp.isNaN ?x85)) (not (fp.isNaN ?x88))) (not (fp.gt ?x85 ?x88)))))
(not $x94))))))))))))
(check-sat)
(exit)
