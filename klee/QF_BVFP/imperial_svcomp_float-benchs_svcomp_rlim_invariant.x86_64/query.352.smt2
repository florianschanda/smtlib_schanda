...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.352.smt2
|)
...
(assert
 ...
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x61 (fp.sub roundNearestTiesToEven ?x17 ?x43)))
 (let ((?x74 (fp.sub roundNearestTiesToEven ?x61 ?x57)))
...
(assert
 (let ((?x70 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x78 (fp.sub roundNearestTiesToEven ?x32 ?x70)))
 (not (fp.isNaN ?x78))))))
(assert
 (let ((?x70 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x85 (fp.sub roundNearestTiesToEven ?x32 ?x26)))
 (not (fp.isNaN ?x85))))))
(assert
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
 ...
 (let ((?x89 (fp.sub roundNearestTiesToEven ?x88 ?x25)))
 (not (fp.gt ?x89 ?x85)))))))))
(assert
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x33 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
...
(let ((?x61 (fp.sub roundNearestTiesToEven ?x17 ?x43)))
(let ((?x74 (fp.sub roundNearestTiesToEven ?x61 ?x57)))
(let ((?x104 (fp.sub roundNearestTiesToEven ?x74 ?x70)))
