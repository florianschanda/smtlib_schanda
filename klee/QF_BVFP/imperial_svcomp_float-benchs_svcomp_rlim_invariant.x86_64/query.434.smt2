...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.434.smt2
|)
...
(assert
 (let ((?x62 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x65 (fp.sub roundNearestTiesToEven ?x34 ?x62)))
 (let ((?x45 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x68 (fp.add roundNearestTiesToEven ?x17 ?x45)))
 (let ((?x67 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
 (let ((?x69 (fp.sub roundNearestTiesToEven ?x67 ?x68)))
 (or (fp.isNaN ?x65) (fp.gt ?x69 ?x65)))))))))))
(assert
 (let ((?x45 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x68 (fp.add roundNearestTiesToEven ?x17 ?x45)))
...
(assert
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x80 (fp.sub roundNearestTiesToEven ?x34 ?x26)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x82 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x83 (fp.sub roundNearestTiesToEven ?x82 ?x25)))
...
(assert
 ...
 (let ((?x95 (fp.sub roundNearestTiesToEven ?x94 ?x28)))
 (not (fp.isNaN ?x95))))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x98 (fp.sub roundNearestTiesToEven ?x34 ?x29)))
 (not (fp.isNaN ?x98))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
(let ((?x68 (fp.add roundNearestTiesToEven ?x17 ?x45)))
(let ((?x113 (fp.add roundNearestTiesToEven ?x68 ?x62)))
