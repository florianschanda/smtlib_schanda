...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.648.smt2
|)
...
(assert
 ...
 (fp.leq ?x24 ?x22))))
(assert
 (let ((?x57 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x58 (fp.sub roundNearestTiesToEven ?x29 ?x57)))
 (let ((?x53 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x52 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x55 (fp.sub roundNearestTiesToEven ?x24 (fp.add roundNearestTiesToEven ?x52 ?x53))))
...
(assert
 ...
 (fp.leq ?x52 ?x22))))
(assert
 (let ((?x73 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x74 (fp.sub roundNearestTiesToEven ?x29 ?x73)))
 (let ((?x45 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x52 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x71 (fp.sub roundNearestTiesToEven ?x52 ?x45)))
...
(assert
 (let ((?x53 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x85 (fp.sub roundNearestTiesToEven ?x29 ?x53)))
 (let ((?x52 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x87 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x88 (fp.sub roundNearestTiesToEven ?x87 ?x52)))
 (or (fp.isNaN ?x85) (fp.gt ?x88 ?x85)))))))))
(assert
 (let ((?x52 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x87 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x88 (fp.sub roundNearestTiesToEven ?x87 ?x52)))
