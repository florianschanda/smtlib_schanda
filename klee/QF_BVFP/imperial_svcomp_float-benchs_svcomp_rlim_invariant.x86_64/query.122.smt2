...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.122.smt2
|)
...
(assert
 ...
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x55 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x56 (fp.sub roundNearestTiesToEven ?x55 ?x23)))
...
(assert
 ...
 (let ((?x23 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x26 (fp.add roundNearestTiesToEven ?x23 ?x24)))
 (let ((?x67 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
 (let ((?x68 (fp.sub roundNearestTiesToEven ?x67 ?x26)))
 (not (fp.isNaN ?x68))))))))
(assert
 (let ((?x27 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x71 (fp.sub roundNearestTiesToEven ?x32 ?x27)))
 (not (fp.isNaN ?x71))))))
(assert
 (let ((?x27 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 (let ((?x46 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
(let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x84 (fp.sub roundNearestTiesToEven ?x32 ?x46)))
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!4)))
(let ((?x43 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x82 (fp.sub roundNearestTiesToEven ?x43 ?x15)))
(not (or (or (fp.isNaN ?x82) (fp.isNaN ?x84)) (fp.gt ?x82 ?x84))))))))))
(check-sat)
(exit)
