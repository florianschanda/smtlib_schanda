...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.210.smt2
|)
...
(assert
 ...
 (let ((?x15 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!4)))
 (let ((?x40 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
 (let ((?x50 (fp.sub roundNearestTiesToEven ?x40 ?x15)))
...
(assert
 ...
 (let ((?x45 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x22 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x59 (fp.sub roundNearestTiesToEven ?x22 ?x45)))
...
(assert
 (let ((?x23 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x73 (fp.sub roundNearestTiesToEven ?x29 ?x23)))
 (let ((?x22 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
...
(let ((?x40 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x50 (fp.sub roundNearestTiesToEven ?x40 ?x15)))
(let (($x97 (and (and (not (fp.isNaN ?x50)) (not (fp.isNaN ?x43))) (not (fp.lt ?x50 ?x43)))))
(not $x97)))))))
(check-sat)
(exit)
