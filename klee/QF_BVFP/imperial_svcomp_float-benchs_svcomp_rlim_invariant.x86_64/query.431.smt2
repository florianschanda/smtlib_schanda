...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.431.smt2
|)
...
(assert
 (let ((?x65 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x71 (fp.sub roundNearestTiesToEven ?x34 ?x65)))
 (let ((?x45 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x62 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
 (let ((?x69 (fp.sub roundNearestTiesToEven ?x62 (fp.add roundNearestTiesToEven ?x17 ?x45))))
 (or (or (fp.isNaN ?x69) (fp.isNaN ?x71)) (fp.gt ?x69 ?x71))))))))))
(assert
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (fp.geq ?x26 ?x25))))
...
(assert
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x78 (fp.sub roundNearestTiesToEven ?x34 ?x26)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
...
(assert
 ...
 (let ((?x93 (fp.sub roundNearestTiesToEven ?x92 ?x28)))
 (not (fp.isNaN ?x93))))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x96 (fp.sub roundNearestTiesToEven ?x34 ?x29)))
 (not (fp.isNaN ?x96))))))
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x34 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x62 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x69 (fp.sub roundNearestTiesToEven ?x62 (fp.add roundNearestTiesToEven ?x17 ?x45))))
(let (($x115 (and (and (not (fp.isNaN ?x69)) (not (fp.isNaN ?x65))) (not (fp.lt ?x69 ?x65)))))
(not $x115))))))))
(check-sat)
(exit)
