...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.321.smt2
|)
...
(assert
 ...
 (let ((?x98 (fp.sub roundNearestTiesToEven ?x97 ?x58)))
 (not (fp.gt ?x98 ?x94)))))))))
(assert
 (let ((?x58 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x69 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
