...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.555.smt2
|)
...
(assert
 (let ((?x79 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x82 (fp.sub roundNearestTiesToEven ?x25 ?x79)))
 (let ((?x63 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x47 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x34 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
...
(assert
 ...
 (not (fp.lt ?x86 ?x79)))))))))))))))
(assert
 (let ((?x96 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x30 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (fp.geq ?x30 ?x96))))
(assert
 (let ((?x99 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x30 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (fp.leq ?x30 ?x99))))
(assert
 (let ((?x19 ((_ to_fp 8 24) (_ bv0 32))))
...
(let ((?x69 (fp.add roundNearestTiesToEven ?x53 ?x47)))
(let ((?x85 (fp.add roundNearestTiesToEven ?x69 ?x63)))
(let ((?x111 (fp.add roundNearestTiesToEven ?x85 ?x79)))
