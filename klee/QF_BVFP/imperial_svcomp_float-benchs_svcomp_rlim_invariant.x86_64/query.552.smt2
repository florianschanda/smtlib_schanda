...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.552.smt2
|)
...
(assert
 (let ((?x86 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x92 (fp.sub roundNearestTiesToEven ?x25 ?x86)))
 (let ((?x63 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x47 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x34 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 ...
 (let ((?x69 (fp.add roundNearestTiesToEven ?x53 ?x47)))
 (let ((?x79 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
 (let ((?x90 (fp.sub roundNearestTiesToEven ?x79 (fp.add roundNearestTiesToEven ?x69 ?x63))))
 (or (or (fp.isNaN ?x90) (fp.isNaN ?x92)) (fp.gt ?x90 ?x92))))))))))))))))
(assert
 (let ((?x81 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x30 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (fp.geq ?x30 ?x81))))
...
(let ((?x79 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x90 (fp.sub roundNearestTiesToEven ?x79 (fp.add roundNearestTiesToEven ?x69 ?x63))))
(let (($x113 (and (and (not (fp.isNaN ?x90)) (not (fp.isNaN ?x86))) (not (fp.lt ?x90 ?x86)))))
(not $x113))))))))))))))
(check-sat)
(exit)
