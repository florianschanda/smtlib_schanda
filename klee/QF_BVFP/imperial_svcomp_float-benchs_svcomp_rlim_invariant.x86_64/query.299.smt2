...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.299.smt2
|)
...
(assert
 ...
 (let ((?x85 (fp.sub roundNearestTiesToEven ?x84 ?x30)))
 (not (fp.isNaN ?x85))))))))))
(assert
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x88 (fp.sub roundNearestTiesToEven ?x36 ?x31)))
 (not (fp.isNaN ?x88))))))
(assert
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x47 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x55 (fp.sub roundNearestTiesToEven ?x47 ?x17)))
(let (($x109 (and (and (not (fp.isNaN ?x55)) (not (fp.isNaN ?x50))) (not (fp.lt ?x55 ?x50)))))
(not $x109)))))))
(check-sat)
(exit)
