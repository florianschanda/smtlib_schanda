...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.225.smt2
|)
...
(assert
 ...
 (let ((?x74 (fp.sub roundNearestTiesToEven ?x73 ?x22)))
 (not (fp.isNaN ?x74))))))
(assert
 (let ((?x23 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x77 (fp.sub roundNearestTiesToEven ?x29 ?x23)))
 (not (fp.isNaN ?x77))))))
(assert
 (let ((?x23 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x40 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x50 (fp.sub roundNearestTiesToEven ?x40 ?x15)))
(let (($x94 (and (and (not (fp.isNaN ?x50)) (not (fp.isNaN ?x43))) (not (fp.lt ?x50 ?x43)))))
(not $x94)))))))
(check-sat)
(exit)
