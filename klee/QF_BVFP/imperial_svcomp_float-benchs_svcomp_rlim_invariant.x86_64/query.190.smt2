...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.190.smt2
|)
...
(assert
 ...
 (let ((?x43 (fp.add roundNearestTiesToEven ?x17 ?x15)))
 (let ((?x57 (fp.add roundNearestTiesToEven ?x43 ?x37)))
 (let ((?x70 (fp.sub roundNearestTiesToEven ?x57 ?x53)))
