...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.622.smt2
|)
...
(assert
 ...
 (let ((?x92 (fp.sub roundNearestTiesToEven ?x91 ?x27)))
 (not (fp.isNaN ?x92))))))))
(assert
 (let ((?x28 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x33 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x95 (fp.sub roundNearestTiesToEven ?x33 ?x28)))
 (not (fp.isNaN ?x95))))))
(assert
 (let ((?x28 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x33 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x44 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x54 (fp.sub roundNearestTiesToEven ?x44 ?x17)))
(let (($x114 (and (and (not (fp.isNaN ?x54)) (not (fp.isNaN ?x47))) (not (fp.lt ?x54 ?x47)))))
(not $x114)))))))
(check-sat)
(exit)
