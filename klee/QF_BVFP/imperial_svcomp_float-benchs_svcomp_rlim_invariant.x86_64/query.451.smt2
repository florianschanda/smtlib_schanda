...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.451.smt2
|)
...
(assert
 ...
 (let ((?x61 (fp.add roundNearestTiesToEven ?x45 ?x39)))
 (let ((?x77 (fp.add roundNearestTiesToEven ?x61 ?x55)))
 (let ((?x91 (fp.add roundNearestTiesToEven ?x77 ?x71)))
 (let ((?x90 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
 (let ((?x92 (fp.sub roundNearestTiesToEven ?x90 ?x91)))
 (not (fp.isNaN ?x92))))))))))))))
(assert
 (let ((?x87 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x95 (fp.sub roundNearestTiesToEven ?x25 ?x87)))
 (not (fp.isNaN ?x95))))))
(assert
 (let ((?x87 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x77 (fp.add roundNearestTiesToEven ?x61 ?x55)))
(let ((?x91 (fp.add roundNearestTiesToEven ?x77 ?x71)))
(let ((?x114 (fp.sub roundNearestTiesToEven ?x91 ?x87)))
