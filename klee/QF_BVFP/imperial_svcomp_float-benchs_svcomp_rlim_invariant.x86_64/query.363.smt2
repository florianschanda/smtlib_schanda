...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.363.smt2
|)
...
(assert
 ...
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x61 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x82 (fp.sub roundNearestTiesToEven ?x61 (fp.sub roundNearestTiesToEven ?x42 ?x80))))
...
(assert
 ...
 (let ((?x98 (fp.sub roundNearestTiesToEven ?x29 ?x80)))
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x101 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x102 (fp.sub roundNearestTiesToEven ?x101 ?x42)))
 (not (fp.gt ?x102 ?x98)))))))))
(assert
 (let ((?x42 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x84 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
...
(assert
 (let ((?x40 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!2)))
(let ((?x111 (fp.add roundNearestTiesToEven ?x17 ?x40)))
