...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.375.smt2
|)
...
(assert
 (let ((?x48 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x93 (fp.sub roundNearestTiesToEven ?x29 ?x48)))
 (let ((?x46 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x44 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x43 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x45 (fp.add roundNearestTiesToEven ?x43 ?x44)))
