...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.381.smt2
|)
...
(assert
 ...
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
 (let ((?x63 (fp.sub roundNearestTiesToEven ?x24 (fp.sub roundNearestTiesToEven ?x60 ?x61))))
...
(assert
 ...
 (let ((?x94 (fp.sub roundNearestTiesToEven ?x93 ?x60)))
 (not (fp.isNaN ?x94))))))))
(assert
 (let ((?x61 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x97 (fp.sub roundNearestTiesToEven ?x29 ?x61)))
 (not (fp.isNaN ?x97))))))
(assert
 (let ((?x61 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
