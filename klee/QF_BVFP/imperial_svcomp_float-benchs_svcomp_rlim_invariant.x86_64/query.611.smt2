...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.611.smt2
|)
...
(assert
 ...
 (let ((?x56 (fp.sub roundNearestTiesToEven ?x43 ?x39)))
 (let ((?x71 (fp.sub roundNearestTiesToEven ?x56 ?x52)))
 (let ((?x85 (fp.add roundNearestTiesToEven ?x71 ?x65)))
 (let ((?x84 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
 (let ((?x86 (fp.sub roundNearestTiesToEven ?x84 ?x85)))
 (not (fp.isNaN ?x86))))))))))))))
(assert
 (let ((?x81 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x89 (fp.sub roundNearestTiesToEven ?x25 ?x81)))
 (not (fp.isNaN ?x89))))))
(assert
 (let ((?x81 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv2147483648 32))))
 ...
 (not (fp.gt ?x86 ?x89)))))))))))))))))
(assert
 (let ((?x95 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (fp.geq ?x29 ?x95))))
(assert
 (let ((?x98 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (fp.leq ?x29 ?x98))))
(assert
 (let ((?x95 ((_ to_fp 8 24) (_ bv3271557120 32))))
...
(let ((?x71 (fp.sub roundNearestTiesToEven ?x56 ?x52)))
(let ((?x85 (fp.add roundNearestTiesToEven ?x71 ?x65)))
(let ((?x108 (fp.sub roundNearestTiesToEven ?x85 ?x81)))
