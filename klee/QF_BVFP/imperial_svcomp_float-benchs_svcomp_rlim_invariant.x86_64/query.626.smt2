...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.626.smt2
|)
...
(assert
 (let ((?x44 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x33 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x55 (fp.sub roundNearestTiesToEven ?x33 ?x44)))
 (not (fp.isNaN ?x55))))))
(assert
 (let ((?x44 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x33 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 ...
 (fp.leq ?x24 ?x22))))
(assert
 (let ((?x64 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x33 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x65 (fp.sub roundNearestTiesToEven ?x33 ?x64)))
 (let ((?x46 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x62 (fp.sub roundNearestTiesToEven ?x24 ?x46)))
...
(assert
 (let ((?x44 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!2)))
(let ((?x109 (fp.sub roundNearestTiesToEven ?x17 ?x44)))
