...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.396.smt2
|)
...
(assert
 (let ((?x45 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x92 (fp.sub roundNearestTiesToEven ?x29 ?x45)))
 (let ((?x43 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x42 ((_ to_fp 8 24) symbolic_0_float_ackermann!8)))
 (let ((?x44 (fp.sub roundNearestTiesToEven ?x42 ?x43)))
