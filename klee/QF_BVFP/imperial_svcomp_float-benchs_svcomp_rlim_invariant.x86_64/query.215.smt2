...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.215.smt2
|)
...
(assert
 ...
 (let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x46 (fp.sub roundNearestTiesToEven ?x27 ?x45)))
 (let ((?x41 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x40 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x22 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!4)))
 (let ((?x43 (fp.sub roundNearestTiesToEven ?x22 (fp.add roundNearestTiesToEven ?x40 ?x41))))
...
(assert
 ...
 (fp.leq ?x40 ?x20))))
(assert
 (let ((?x65 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
 (let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x66 (fp.sub roundNearestTiesToEven ?x27 ?x65)))
 (let ((?x56 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x40 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x63 (fp.sub roundNearestTiesToEven ?x40 ?x56)))
...
(assert
 (let ((?x41 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x77 (fp.sub roundNearestTiesToEven ?x27 ?x41)))
 (let ((?x40 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x79 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
 (let ((?x80 (fp.sub roundNearestTiesToEven ?x79 ?x40)))
