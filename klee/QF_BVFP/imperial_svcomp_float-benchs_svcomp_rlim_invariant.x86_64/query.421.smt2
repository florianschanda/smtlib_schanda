...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.421.smt2
|)
...
(assert
 ...
 (let ((?x85 (fp.sub roundNearestTiesToEven ?x84 ?x25)))
 (not (fp.gt ?x85 ?x81)))))))))
(assert
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x33 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
...
(assert
 (let ((?x76 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x32 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x101 (fp.sub roundNearestTiesToEven ?x32 ?x76)))
(let ((?x57 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
(let ((?x43 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
(let ((?x63 (fp.sub roundNearestTiesToEven ?x17 ?x43)))
(let ((?x73 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x99 (fp.sub roundNearestTiesToEven ?x73 (fp.add roundNearestTiesToEven ?x63 ?x57))))
(not (or (or (fp.isNaN ?x99) (fp.isNaN ?x101)) (fp.gt ?x99 ?x101)))))))))))))
(check-sat)
(exit)
