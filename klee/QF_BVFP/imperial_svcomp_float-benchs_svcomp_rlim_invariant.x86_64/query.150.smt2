...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.150.smt2
|)
...
(assert
 (let ((?x70 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
(let ((?x23 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x83 (fp.sub roundNearestTiesToEven ?x23 ?x70)))
(let ((?x50 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
(let ((?x37 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
(let ((?x17 ((_ to_fp 8 24) (_ bv0 32))))
...
(let ((?x54 (fp.sub roundNearestTiesToEven ?x41 ?x37)))
(let ((?x63 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x80 (fp.sub roundNearestTiesToEven ?x63 (fp.sub roundNearestTiesToEven ?x54 ?x50))))
(let (($x89 (and (and (not (fp.isNaN ?x80)) (not (fp.isNaN ?x83))) (not (fp.gt ?x80 ?x83)))))
(not $x89))))))))))))))
(check-sat)
(exit)
