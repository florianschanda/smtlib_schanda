...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.448.smt2
|)
...
(assert
 (let ((?x78 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x81 (fp.sub roundNearestTiesToEven ?x25 ?x78)))
 (let ((?x65 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x52 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x39 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x17 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 ...
 (let ((?x56 (fp.sub roundNearestTiesToEven ?x43 ?x39)))
 (let ((?x69 (fp.sub roundNearestTiesToEven ?x56 ?x52)))
 (let ((?x84 (fp.sub roundNearestTiesToEven ?x69 ?x65)))
 (let ((?x83 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
 (let ((?x85 (fp.sub roundNearestTiesToEven ?x83 ?x84)))
 (or (fp.isNaN ?x81) (fp.gt ?x85 ?x81)))))))))))))))))
(assert
 (let ((?x65 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!6)))
 (let ((?x52 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x39 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
...
(let ((?x69 (fp.sub roundNearestTiesToEven ?x56 ?x52)))
(let ((?x84 (fp.sub roundNearestTiesToEven ?x69 ?x65)))
(let ((?x108 (fp.add roundNearestTiesToEven ?x84 ?x78)))
