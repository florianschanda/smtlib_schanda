...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.530.smt2
|)
...
(assert
 ...
 (let ((?x45 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x60 (fp.sub roundNearestTiesToEven ?x45 ?x59)))
 (let ((?x24 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!5)))
...
(assert
 (let ((?x61 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x88 (fp.sub roundNearestTiesToEven ?x29 ?x61)))
 (let ((?x59 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x45 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x60 (fp.sub roundNearestTiesToEven ?x45 ?x59)))
 (let ((?x90 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x91 (fp.sub roundNearestTiesToEven ?x90 ?x60)))
...
(let ((?x40 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x50 (fp.sub roundNearestTiesToEven ?x40 ?x17)))
(let (($x114 (and (and (not (fp.isNaN ?x50)) (not (fp.isNaN ?x43))) (not (fp.lt ?x50 ?x43)))))
(not $x114)))))))
(check-sat)
(exit)
