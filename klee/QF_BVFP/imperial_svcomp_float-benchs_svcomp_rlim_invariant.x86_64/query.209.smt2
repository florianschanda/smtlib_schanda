...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.209.smt2
|)
...
(assert
 ...
 (let ((?x69 (fp.sub roundNearestTiesToEven ?x68 ?x22)))
...
(assert
 (let ((?x43 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
(let ((?x29 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x86 (fp.sub roundNearestTiesToEven ?x29 ?x43)))
(let ((?x15 ((_ to_fp 8 24) symbolic_0_float_4_ackermann!4)))
(let ((?x40 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)))
(let ((?x84 (fp.sub roundNearestTiesToEven ?x40 ?x15)))
(not (or (or (fp.isNaN ?x84) (fp.isNaN ?x86)) (fp.gt ?x84 ?x86))))))))))
(check-sat)
(exit)
