...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.336.smt2
|)
...
(let ((?x73 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x80 (fp.sub roundNearestTiesToEven ?x73 (fp.sub roundNearestTiesToEven ?x64 ?x60))))
(not (or (or (fp.isNaN ?x80) (fp.isNaN ?x76)) (fp.lt ?x80 ?x76)))))))))))
(check-sat)
(exit)
