...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.205.smt2
|)
...
(assert
 (let ((?x44 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x27 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x73 (fp.sub roundNearestTiesToEven ?x27 ?x44)))
 (let ((?x42 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!6)))
 (let ((?x41 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x43 (fp.sub roundNearestTiesToEven ?x41 ?x42)))
 (let ((?x75 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!2)))
 (let ((?x76 (fp.sub roundNearestTiesToEven ?x75 ?x43)))
