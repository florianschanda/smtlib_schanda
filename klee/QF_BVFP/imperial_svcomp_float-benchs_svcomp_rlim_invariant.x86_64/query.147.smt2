...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.147.smt2
|)
...
(assert
 (let ((?x39 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x15 ((_ to_fp 8 24) symbolic_0_float_ackermann!7)))
 (let ((?x57 (fp.sub roundNearestTiesToEven ?x15 ?x39)))
...
(assert
 (let ((?x53 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
 (let ((?x28 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x61 (fp.sub roundNearestTiesToEven ?x28 ?x53)))
 (not (fp.isNaN ?x61))))))
(assert
 (let ((?x53 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))
 (let ((?x28 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(assert
 (let ((?x66 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x28 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x74 (fp.sub roundNearestTiesToEven ?x28 ?x66)))
 (not (fp.isNaN ?x74))))))
(assert
 (let ((?x66 ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))
 (let ((?x28 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x57 (fp.sub roundNearestTiesToEven ?x15 ?x39)))
(let ((?x70 (fp.sub roundNearestTiesToEven ?x57 ?x53)))
(let ((?x87 (fp.sub roundNearestTiesToEven ?x70 ?x66)))
