...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.637.smt2
|)
...
(assert
 (let ((?x29 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x78 (fp.sub roundNearestTiesToEven ?x36 ?x29)))
 (let ((?x26 ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7)))
 (let ((?x25 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x28 (fp.add roundNearestTiesToEven ?x25 ?x26)))
 (let ((?x80 ((_ to_fp 8 24) symbolic_0_float_2_ackermann!3)))
 (let ((?x81 (fp.sub roundNearestTiesToEven ?x80 ?x28)))
...
(assert
 ...
 (let ((?x93 (fp.sub roundNearestTiesToEven ?x92 ?x30)))
 (not (fp.isNaN ?x93))))))))))
(assert
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x96 (fp.sub roundNearestTiesToEven ?x36 ?x31)))
 (not (fp.isNaN ?x96))))))
(assert
 (let ((?x31 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4)))
 (let ((?x36 ((_ to_fp 8 24) (_ bv2147483648 32))))
...
(let ((?x47 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x55 (fp.sub roundNearestTiesToEven ?x47 ?x17)))
(not (or (or (fp.isNaN ?x55) (fp.isNaN ?x50)) (fp.lt ?x55 ?x50))))))))
(check-sat)
(exit)
