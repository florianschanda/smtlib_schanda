...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.415.smt2
|)
...
(assert
 ...
 (let ((?x74 (fp.sub roundNearestTiesToEven ?x59 ?x55)))
 (let ((?x84 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
 (let ((?x91 (fp.sub roundNearestTiesToEven ?x84 (fp.add roundNearestTiesToEven ?x74 ?x68))))
