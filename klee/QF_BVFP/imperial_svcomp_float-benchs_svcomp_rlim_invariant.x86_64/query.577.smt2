...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.577.smt2
|)
...
(assert
 ...
 (let ((?x87 (fp.sub roundNearestTiesToEven ?x86 ?x27)))
...
(assert
 (let ((?x47 ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)))
(let ((?x33 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x106 (fp.sub roundNearestTiesToEven ?x33 ?x47)))
(let ((?x17 ((_ to_fp 8 24) symbolic_0_float_6_ackermann!2)))
(let ((?x44 ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)))
(let ((?x104 (fp.sub roundNearestTiesToEven ?x44 ?x17)))
