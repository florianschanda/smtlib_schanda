...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.463.smt2
|)
...
(assert
 ...
 (let ((?x101 (fp.sub roundNearestTiesToEven ?x100 ?x44)))
 (not (fp.gt ?x101 ?x97)))))))))
(assert
 (let ((?x44 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x67 ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))
