...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_fadd_to_exact_zero_klee_float.x86_64/query.20.smt2
|)
...
(not (fp.isNaN (fp.add roundTowardNegative ?x9 ?x12))))))
(check-sat)
(exit)
