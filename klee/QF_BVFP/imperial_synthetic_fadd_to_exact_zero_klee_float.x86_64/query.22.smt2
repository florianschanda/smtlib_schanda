...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_fadd_to_exact_zero_klee_float.x86_64/query.22.smt2
|)
...
(assert
 ...
 (= (_ bv0 32) ?x37)))
(assert
 (let (($x41 (fp.eq (fp.add roundTowardZero ((_ to_fp 8 24) f_ackermann!1) ((_ to_fp 8 24) g_ackermann!0)) ((_ to_fp 8 24) (_ bv0 32)))))
(not $x41)))
(check-sat)
(exit)
