...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee_bug.x86_64/query.07.smt2
|)
...
(let (($x38 (fp.eq (ite $x31 ((_ to_fp 8 24) (_ bv0 32)) ?x23) ((_ to_fp 8 24) (ite $x31 fresh_to_ieee_bv_!1 x_ackermann!0)))))
(not (not $x38)))))))
(check-sat)
(exit)
