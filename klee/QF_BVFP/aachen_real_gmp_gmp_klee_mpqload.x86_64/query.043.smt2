...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mpqload.x86_64/query.043.smt2
|)
...
(not (bvult (concat ((_ extract 60 0) ?x37) (_ bv0 3)) (_ bv32 64))))))
(check-sat)
(exit)
