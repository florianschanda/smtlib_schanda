...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mpqload.x86_64/query.039.smt2
|)
...
(let (($x62 (bvult (concat ((_ extract 60 0) (bvadd (ite $x54 (bvadd (_ bv2 64) ?x37) (_ bv0 64)) ?x37)) (_ bv0 3)) (_ bv32513 64))))
(not $x62))))))))))))
(check-sat)
(exit)
