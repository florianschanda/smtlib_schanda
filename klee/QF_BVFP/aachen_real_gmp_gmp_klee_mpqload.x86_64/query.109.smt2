...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mpqload.x86_64/query.109.smt2
|)
...
(not (not (bvslt (bvsub (_ bv1 64) (ite (bvslt (_ bv0 64) ?x40) ?x40 (_ bv0 64))) (_ bv0 64))))))))
(check-sat)
(exit)
