...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mpqload.x86_64/query.091.smt2
|)
...
(not (not (= (_ bv11 64) (concat ((_ extract 60 0) (bvadd (_ bv2 64) (bvsub ?x53 ?x26))) (_ bv0 3))))))))))))))
(check-sat)
(exit)
