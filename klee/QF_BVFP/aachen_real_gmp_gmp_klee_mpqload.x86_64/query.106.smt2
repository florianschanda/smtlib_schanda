...
Corresponding query: An equisatisfiable query (bitvectors replaced with reads from arrays of bitvectors) is available at QF_ABVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mpqload.x86_64/query.106.smt2
|)
...
(let ((?x41 (bvsub (_ bv18446744073709551615 64) ?x39)))
(let ((?x43 (ite (bvslt (_ bv0 64) ?x41) ?x41 (_ bv0 64))))
(let (($x53 (= (bvadd (_ bv70941840 64) (bvmul (_ bv8 64) (bvadd (_ bv1 64) (bvadd (bvadd ?x39 ?x43) ?x39)))) (bvadd (_ bv41901504 64) (bvmul (_ bv8 64) ?x43)))))
(not (not $x53))))))))
(check-sat)
(exit)
