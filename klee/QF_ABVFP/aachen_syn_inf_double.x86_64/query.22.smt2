...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_syn_inf_double.x86_64/query.22.smt2
|)
...
(not (fp.isNaN (fp.sub roundNearestTiesToEven ?x40 ?x40))))))))))
(check-sat)
(exit)
