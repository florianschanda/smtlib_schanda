...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee_bug.x86_64/query.07.smt2
|)
...
(let (($x48 (fp.eq (ite $x41 ((_ to_fp 8 24) (_ bv0 32)) ?x33) ((_ to_fp 8 24) (ite $x41 fresh_to_ieee_bv_!0 ?x18)))))
(not (not $x48)))))))))
(check-sat)
(exit)
