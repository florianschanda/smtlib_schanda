...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee_bug.x86_64/query.10.smt2
|)
...
(let ((?x50 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x48 ((_ to_fp 8 24) (_ bv1056964608 32))) ?x19)))
(not (not (fp.lt (fp.abs ?x50) ((_ to_fp 8 24) (_ bv869711765 32))))))))))))))
(check-sat)
(exit)
