...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee_bug.x86_64/query.22.smt2
|)
...
(let (($x90 (fp.eq (ite $x83 ?x75 ?x77) ((_ to_fp 8 24) (ite $x83 fresh_to_ieee_bv_!3 ?x73)))))
(not (not $x90)))))))))))))))))))))))
(check-sat)
(exit)
