...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee_bug.x86_64/query.17.smt2
|)
...
(let (($x76 (fp.eq (ite $x69 (ite $x55 ?x47 ?x49) ?x63) ((_ to_fp 8 24) (ite $x69 fresh_to_ieee_bv_!2 ?x59)))))
(not (not $x76))))))))))))))))))
(check-sat)
(exit)
