...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_filter2_set.x86_64/query.13.smt2
|)
...
(declare-fun symbolic_0_double_88 () (Array (_ BitVec 32) (_ BitVec 8)))
(declare-fun symbolic_0_double_99 () (Array (_ BitVec 32) (_ BitVec 8)))
(assert
...
(assert
 (let ((?x148 ((_ to_fp 11 53) (_ bv0 64))))
 (let ((?x194 (concat (select symbolic_0_double_88 (_ bv1 32)) (select symbolic_0_double_88 (_ bv0 32)))))
 (let ((?x198 (concat (select symbolic_0_double_88 (_ bv3 32)) (concat (select symbolic_0_double_88 (_ bv2 32)) ?x194))))
 (let ((?x202 (concat (select symbolic_0_double_88 (_ bv5 32)) (concat (select symbolic_0_double_88 (_ bv4 32)) ?x198))))
 (let ((?x206 (concat (select symbolic_0_double_88 (_ bv7 32)) (concat (select symbolic_0_double_88 (_ bv6 32)) ?x202))))
 (let ((?x207 ((_ to_fp 11 53) ?x206)))
 (fp.geq ?x207 ?x148))))))))
(assert
 (let ((?x151 ((_ to_fp 11 53) (_ bv4607182418800017408 64))))
 (let ((?x194 (concat (select symbolic_0_double_88 (_ bv1 32)) (select symbolic_0_double_88 (_ bv0 32)))))
...
(assert
 (let ((?x148 ((_ to_fp 11 53) (_ bv0 64))))
 (let ((?x213 (concat (select symbolic_0_double_99 (_ bv1 32)) (select symbolic_0_double_99 (_ bv0 32)))))
 (let ((?x217 (concat (select symbolic_0_double_99 (_ bv3 32)) (concat (select symbolic_0_double_99 (_ bv2 32)) ?x213))))
 (let ((?x221 (concat (select symbolic_0_double_99 (_ bv5 32)) (concat (select symbolic_0_double_99 (_ bv4 32)) ?x217))))
 (let ((?x225 (concat (select symbolic_0_double_99 (_ bv7 32)) (concat (select symbolic_0_double_99 (_ bv6 32)) ?x221))))
 (let ((?x226 ((_ to_fp 11 53) ?x225)))
 (fp.geq ?x226 ?x148))))))))
(assert
 (let ((?x151 ((_ to_fp 11 53) (_ bv4607182418800017408 64))))
 (let ((?x213 (concat (select symbolic_0_double_99 (_ bv1 32)) (select symbolic_0_double_99 (_ bv0 32)))))
...
(let ((?x30 (concat (select symbolic_0_double0 (_ bv7 32)) (concat (select symbolic_0_double0 (_ bv6 32)) ?x24))))
(let ((?x31 ((_ to_fp 11 53) ?x30)))
(let ((?x252 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x31 ?x226) (fp.mul roundNearestTiesToEven ?x54 ?x207))))
(let ((?x175 (concat (select symbolic_0_double_77 (_ bv1 32)) (select symbolic_0_double_77 (_ bv0 32)))))
(let ((?x179 (concat (select symbolic_0_double_77 (_ bv3 32)) (concat (select symbolic_0_double_77 (_ bv2 32)) ?x175))))
(let ((?x183 (concat (select symbolic_0_double_77 (_ bv5 32)) (concat (select symbolic_0_double_77 (_ bv4 32)) ?x179))))
(let ((?x187 (concat (select symbolic_0_double_77 (_ bv7 32)) (concat (select symbolic_0_double_77 (_ bv6 32)) ?x183))))
...
(let ((?x76 (concat (select symbolic_0_double_22 (_ bv7 32)) (concat (select symbolic_0_double_22 (_ bv6 32)) ?x72))))
(let ((?x77 ((_ to_fp 11 53) ?x76)))
(let ((?x253 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x77 ?x188) ?x252)))
(let ((?x244 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x31 ?x207) (fp.mul roundNearestTiesToEven ?x54 ?x188))))
(let ((?x133 (concat (select symbolic_0_double_55 (_ bv1 32)) (select symbolic_0_double_55 (_ bv0 32)))))
(let ((?x137 (concat (select symbolic_0_double_55 (_ bv3 32)) (concat (select symbolic_0_double_55 (_ bv2 32)) ?x133))))
(let ((?x141 (concat (select symbolic_0_double_55 (_ bv5 32)) (concat (select symbolic_0_double_55 (_ bv4 32)) ?x137))))
(let ((?x145 (concat (select symbolic_0_double_55 (_ bv7 32)) (concat (select symbolic_0_double_55 (_ bv6 32)) ?x141))))
(let ((?x146 ((_ to_fp 11 53) ?x145)))
(let ((?x245 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x77 ?x146) ?x244)))
(let ((?x235 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x31 ?x188) (fp.mul roundNearestTiesToEven ?x54 ?x146))))
(let ((?x156 (concat (select symbolic_0_double_66 (_ bv1 32)) (select symbolic_0_double_66 (_ bv0 32)))))
(let ((?x160 (concat (select symbolic_0_double_66 (_ bv3 32)) (concat (select symbolic_0_double_66 (_ bv2 32)) ?x156))))
(let ((?x164 (concat (select symbolic_0_double_66 (_ bv5 32)) (concat (select symbolic_0_double_66 (_ bv4 32)) ?x160))))
(let ((?x168 (concat (select symbolic_0_double_66 (_ bv7 32)) (concat (select symbolic_0_double_66 (_ bv6 32)) ?x164))))
(let ((?x169 ((_ to_fp 11 53) ?x168)))
(let ((?x236 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x77 ?x169) ?x235)))
(let ((?x148 ((_ to_fp 11 53) (_ bv0 64))))
(let ((?x87 (concat (select symbolic_0_double_33 (_ bv1 32)) (select symbolic_0_double_33 (_ bv0 32)))))
(let ((?x91 (concat (select symbolic_0_double_33 (_ bv3 32)) (concat (select symbolic_0_double_33 (_ bv2 32)) ?x87))))
(let ((?x95 (concat (select symbolic_0_double_33 (_ bv5 32)) (concat (select symbolic_0_double_33 (_ bv4 32)) ?x91))))
(let ((?x99 (concat (select symbolic_0_double_33 (_ bv7 32)) (concat (select symbolic_0_double_33 (_ bv6 32)) ?x95))))
(let ((?x100 ((_ to_fp 11 53) ?x99)))
(let ((?x237 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x100 ?x148) ?x236)))
(let ((?x110 (concat (select symbolic_0_double_44 (_ bv1 32)) (select symbolic_0_double_44 (_ bv0 32)))))
(let ((?x114 (concat (select symbolic_0_double_44 (_ bv3 32)) (concat (select symbolic_0_double_44 (_ bv2 32)) ?x110))))
(let ((?x118 (concat (select symbolic_0_double_44 (_ bv5 32)) (concat (select symbolic_0_double_44 (_ bv4 32)) ?x114))))
(let ((?x122 (concat (select symbolic_0_double_44 (_ bv7 32)) (concat (select symbolic_0_double_44 (_ bv6 32)) ?x118))))
(let ((?x123 ((_ to_fp 11 53) ?x122)))
(let ((?x230 (fp.mul roundNearestTiesToEven ?x123 ?x148)))
(let ((?x238 (fp.add roundNearestTiesToEven ?x230 ?x237)))
(let ((?x246 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x100 ?x238) ?x245)))
(let ((?x248 (fp.mul roundNearestTiesToEven ?x100 (fp.add roundNearestTiesToEven ?x230 ?x246))))
(let ((?x255 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x123 ?x238) (fp.add roundNearestTiesToEven ?x248 ?x253))))
(not (and (fp.geq ?x255 ((_ to_fp 11 53) (_ bv13860109328209412096 64))) (fp.leq ?x255 ((_ to_fp 11 53) (_ bv4636737291354636288 64)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
