...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_non_terminating_klee_bug.x86_64/query.05.smt2
|)
...
(let ((?x29 (fp.sub roundNearestTiesToEven ((_ to_fp 8 24) (_ bv1120403456 32)) ?x19)))
(let ((?x32 (fp.sub roundNearestTiesToEven ?x29 ?x19)))
(not (fp.gt (fp.sub roundNearestTiesToEven ?x32 ?x19) ?x30))))))))
(check-sat)
(exit)
