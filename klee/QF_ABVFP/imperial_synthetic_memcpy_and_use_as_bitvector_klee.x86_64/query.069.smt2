...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_memcpy_and_use_as_bitvector_klee.x86_64/query.069.smt2
|)
...
(assert
 (not (bvslt (_ bv0 32) (bvadd (_ bv1 32) fresh_to_ieee_bv_!0))))
(check-sat)
(exit)
