...
(assert
 ...
 (let ((?x67 (store (store (store (store ?x60 (_ bv8 32) (_ bv0 8)) (_ bv9 32) (_ bv0 8)) (_ bv10 32) (_ bv0 8)) (_ bv11 32) (_ bv0 8))))
...
(let ((?x1714 (concat (select ?x1709 (_ bv10 32)) (concat (select ?x1709 (_ bv9 32)) (select ?x1709 (_ bv8 32))))))
(let ((?x1720 (concat (select ?x1709 (_ bv13 32)) (concat (select ?x1709 (_ bv12 32)) (concat (select ?x1709 (_ bv11 32)) ?x1714)))))
(let (($x1726 (fp.lt ((_ to_fp 11 53) (concat (select ?x1709 (_ bv15 32)) (concat (select ?x1709 (_ bv14 32)) ?x1720))) ((_ to_fp 11 53) (_ bv0 64)))))
(not (not $x1726))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
