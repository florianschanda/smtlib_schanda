...
(assert
 ...
 (let ((?x323 (store (store (store (store ?x316 (_ bv136 32) (_ bv0 8)) (_ bv137 32) (_ bv0 8)) (_ bv138 32) (_ bv0 8)) (_ bv139 32) (_ bv0 8))))
...
(let ((?x1714 (concat (select ?x1709 (_ bv138 32)) (concat (select ?x1709 (_ bv137 32)) (select ?x1709 (_ bv136 32))))))
(let ((?x1720 (concat (select ?x1709 (_ bv141 32)) (concat (select ?x1709 (_ bv140 32)) (concat (select ?x1709 (_ bv139 32)) ?x1714)))))
(let (($x1726 (fp.lt ((_ to_fp 11 53) (concat (select ?x1709 (_ bv143 32)) (concat (select ?x1709 (_ bv142 32)) ?x1720))) ((_ to_fp 11 53) (_ bv0 64)))))
(not (not $x1726))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
