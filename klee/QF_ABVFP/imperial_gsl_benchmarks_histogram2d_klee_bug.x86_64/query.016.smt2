...
(assert
 ...
 (let ((?x147 (store (store (store (store ?x140 (_ bv48 32) (_ bv0 8)) (_ bv49 32) (_ bv0 8)) (_ bv50 32) (_ bv0 8)) (_ bv51 32) (_ bv0 8))))
...
(let ((?x1714 (concat (select ?x1709 (_ bv50 32)) (concat (select ?x1709 (_ bv49 32)) (select ?x1709 (_ bv48 32))))))
(let ((?x1720 (concat (select ?x1709 (_ bv53 32)) (concat (select ?x1709 (_ bv52 32)) (concat (select ?x1709 (_ bv51 32)) ?x1714)))))
(let (($x1726 (fp.lt ((_ to_fp 11 53) (concat (select ?x1709 (_ bv55 32)) (concat (select ?x1709 (_ bv54 32)) ?x1720))) ((_ to_fp 11 53) (_ bv0 64)))))
(not (not $x1726))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
