...
(assert
 ...
 (let ((?x1011 (store (store (store (store ?x1004 (_ bv480 32) (_ bv0 8)) (_ bv481 32) (_ bv0 8)) (_ bv482 32) (_ bv0 8)) (_ bv483 32) (_ bv0 8))))
...
(let ((?x1714 (concat (select ?x1709 (_ bv482 32)) (concat (select ?x1709 (_ bv481 32)) (select ?x1709 (_ bv480 32))))))
(let ((?x1720 (concat (select ?x1709 (_ bv485 32)) (concat (select ?x1709 (_ bv484 32)) (concat (select ?x1709 (_ bv483 32)) ?x1714)))))
(let (($x1726 (fp.lt ((_ to_fp 11 53) (concat (select ?x1709 (_ bv487 32)) (concat (select ?x1709 (_ bv486 32)) ?x1720))) ((_ to_fp 11 53) (_ bv0 64)))))
(not (not $x1726))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
