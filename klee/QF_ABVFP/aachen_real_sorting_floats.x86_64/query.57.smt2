...
(let ((?x1411 (concat (select ?x1398 (_ bv38 32)) (concat (select ?x1398 (_ bv37 32)) (select ?x1398 (_ bv36 32))))))
(let ((?x1403 (concat (select ?x1398 (_ bv34 32)) (concat (select ?x1398 (_ bv33 32)) (select ?x1398 (_ bv32 32))))))
(let (($x1415 (fp.lt ((_ to_fp 8 24) (concat (select ?x1398 (_ bv35 32)) ?x1403)) ((_ to_fp 8 24) (concat (select ?x1398 (_ bv39 32)) ?x1411)))))
(not (bvult (bvmul (_ bv4 64) ((_ sign_extend 32) (ite $x1415 (_ bv8 32) (_ bv9 32)))) (_ bv37 64))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
