...
(let ((?x783 (concat (select ?x778 (_ bv18 32)) (concat (select ?x778 (_ bv17 32)) (select ?x778 (_ bv16 32))))))
(let ((?x791 (concat (select ?x778 (_ bv14 32)) (concat (select ?x778 (_ bv13 32)) (select ?x778 (_ bv12 32))))))
(let (($x795 (fp.lt ((_ to_fp 8 24) (concat (select ?x778 (_ bv15 32)) ?x791)) ((_ to_fp 8 24) (concat (select ?x778 (_ bv19 32)) ?x783)))))
(let ((?x796 (ite $x795 (_ bv3 32) (_ bv4 32))))
(let ((?x803 (concat (select ?x778 (bvadd (_ bv1 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x796))))) (select ?x778 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x796)))))))
(let ((?x806 (concat (select ?x778 (bvadd (_ bv2 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x796))))) ?x803)))
(let ((?x809 (concat (select ?x778 (bvadd (_ bv3 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x796))))) ?x806)))
(let ((?x812 (ite (fp.lt ((_ to_fp 8 24) (concat (select ?x778 (_ bv19 32)) ?x783)) ((_ to_fp 8 24) ?x809)) (_ bv4 32) ?x796)))
(not (bvult (bvmul (_ bv4 64) ((_ sign_extend 32) ?x812)) (_ bv37 64))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
