...
(let ((?x1227 (concat (select ?x1222 (_ bv30 32)) (concat (select ?x1222 (_ bv29 32)) (select ?x1222 (_ bv28 32))))))
(let ((?x1235 (concat (select ?x1222 (_ bv26 32)) (concat (select ?x1222 (_ bv25 32)) (select ?x1222 (_ bv24 32))))))
(let (($x1239 (fp.lt ((_ to_fp 8 24) (concat (select ?x1222 (_ bv27 32)) ?x1235)) ((_ to_fp 8 24) (concat (select ?x1222 (_ bv31 32)) ?x1227)))))
(let ((?x1240 (ite $x1239 (_ bv6 32) (_ bv7 32))))
(let ((?x1247 (concat (select ?x1222 (bvadd (_ bv1 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1240))))) (select ?x1222 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1240)))))))
(let ((?x1250 (concat (select ?x1222 (bvadd (_ bv2 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1240))))) ?x1247)))
(let ((?x1253 (concat (select ?x1222 (bvadd (_ bv3 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1240))))) ?x1250)))
(let ((?x1256 (ite (fp.lt ((_ to_fp 8 24) (concat (select ?x1222 (_ bv31 32)) ?x1227)) ((_ to_fp 8 24) ?x1253)) (_ bv7 32) ?x1240)))
(not (bvult (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1256)) (_ bv37 64))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
