...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_statistics_klee_bug.x86_64/query.12.smt2
|)
...
(assert
 ...
 (let ((?x90 (ite (fp.lt ((_ to_fp 11 53) ?x60) ((_ to_fp 11 53) ?x87)) ?x60 ?x87)))
 (let ((?x93 (ite (fp.lt ((_ to_fp 11 53) (_ bv4625844209755933901 64)) ((_ to_fp 11 53) ?x90)) (_ bv4625844209755933901 64) ?x90)))
 (not (fp.lt ((_ to_fp 11 53) (ite (fp.lt ((_ to_fp 11 53) (_ bv4623282787467866931 64)) ((_ to_fp 11 53) ?x93)) (_ bv4623282787467866931 64) ?x93)) ?x33)))))))))))))
(assert
 (let ((?x33 ((_ to_fp 11 53) (_ bv4621819117588971520 64))))
(let ((?x15 (concat (select data0 (_ bv2 32)) (concat (select data0 (_ bv1 32)) (select data0 (_ bv0 32))))))
(let ((?x24 (concat (select data0 (_ bv5 32)) (concat (select data0 (_ bv4 32)) (concat (select data0 (_ bv3 32)) ?x15)))))
...
(not (and (not (fp.isNaN ?x129)) (not (fp.lt ?x129 ?x33)))))))))))))))))))))))))))
(check-sat)
(exit)
