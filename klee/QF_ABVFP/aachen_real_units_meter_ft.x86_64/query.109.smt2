...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_units_meter_ft.x86_64/query.109.smt2
|)
...
(assert
 ...
 (bvsle ?x11 (_ bv57 32))))
(assert
 (= (_ bv52 8) ((_ extract 7 0) ((_ sign_extend 24) (select |argv[1]0| (_ bv0 32))))))
(assert
