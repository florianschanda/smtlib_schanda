...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.265.smt2
|)
...
(assert
 ...
 (let ((?x115 (fp.sub roundNearestTiesToEven ?x113 (fp.add roundNearestTiesToEven ?x19 ?x66))))
