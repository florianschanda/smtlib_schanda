...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.056.smt2
|)
...
(assert
 ...
 (let ((?x86 (fp.sub roundNearestTiesToEven ?x41 ?x35)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x92 (concat (select symbolic_0_float5 (_ bv1 32)) (select symbolic_0_float5 (_ bv0 32)))))
 (let ((?x96 (concat (select symbolic_0_float5 (_ bv3 32)) (concat (select symbolic_0_float5 (_ bv2 32)) ?x92))))
 (let ((?x97 ((_ to_fp 8 24) ?x96)))
 (let ((?x98 (fp.sub roundNearestTiesToEven ?x97 ?x26)))
 (not (fp.gt ?x98 ?x86)))))))))))))
(assert
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x45 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
...
(let ((?x79 ((_ to_fp 8 24) ?x78)))
(let ((?x41 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x109 (fp.sub roundNearestTiesToEven ?x41 ?x79)))
(let ((?x12 (concat (select symbolic_0_float_20 (_ bv1 32)) (select symbolic_0_float_20 (_ bv0 32)))))
(let ((?x18 (concat (select symbolic_0_float_20 (_ bv3 32)) (concat (select symbolic_0_float_20 (_ bv2 32)) ?x12))))
(let ((?x19 ((_ to_fp 8 24) ?x18)))
(let ((?x63 (concat (select symbolic_0_float_43 (_ bv1 32)) (select symbolic_0_float_43 (_ bv0 32)))))
(let ((?x67 (concat (select symbolic_0_float_43 (_ bv3 32)) (concat (select symbolic_0_float_43 (_ bv2 32)) ?x63))))
(let ((?x68 ((_ to_fp 8 24) ?x67)))
(let ((?x107 (fp.sub roundNearestTiesToEven ?x68 ?x19)))
(not (or (or (fp.isNaN ?x107) (fp.isNaN ?x109)) (fp.gt ?x107 ?x109))))))))))))))))
(check-sat)
(exit)
