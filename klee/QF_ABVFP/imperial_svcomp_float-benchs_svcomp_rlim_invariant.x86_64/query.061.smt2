...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.061.smt2
|)
...
(assert
 ...
 (let ((?x33 (concat (select symbolic_0_float_21 (_ bv3 32)) (concat (select symbolic_0_float_21 (_ bv2 32)) ?x29))))
 (let ((?x34 ((_ to_fp 8 24) ?x33)))
 (let ((?x71 (fp.sub roundNearestTiesToEven ?x34 (fp.sub roundNearestTiesToEven ?x60 ?x69))))
...
(assert
 ...
 (let ((?x97 (fp.sub roundNearestTiesToEven ?x39 ?x69)))
 (let ((?x60 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x103 (concat (select symbolic_0_float5 (_ bv1 32)) (select symbolic_0_float5 (_ bv0 32)))))
 (let ((?x107 (concat (select symbolic_0_float5 (_ bv3 32)) (concat (select symbolic_0_float5 (_ bv2 32)) ?x103))))
 (let ((?x108 ((_ to_fp 8 24) ?x107)))
 (let ((?x109 (fp.sub roundNearestTiesToEven ?x108 ?x60)))
 (not (fp.gt ?x109 ?x97)))))))))))))
(assert
 (let ((?x60 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x76 (concat (select symbolic_0_float_34 (_ bv1 32)) (select symbolic_0_float_34 (_ bv0 32)))))
