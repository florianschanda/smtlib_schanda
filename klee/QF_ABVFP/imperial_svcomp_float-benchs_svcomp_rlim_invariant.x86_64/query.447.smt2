...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.447.smt2
|)
...
(assert
 (let ((?x20 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x138 (concat (select symbolic_0_float_98 (_ bv1 32)) (select symbolic_0_float_98 (_ bv0 32)))))
 (let ((?x142 (concat (select symbolic_0_float_98 (_ bv3 32)) (concat (select symbolic_0_float_98 (_ bv2 32)) ?x138))))
...
(assert
 ...
 (let ((?x143 ((_ to_fp 8 24) ?x142)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x146 (fp.sub roundNearestTiesToEven ?x26 ?x143)))
 (let ((?x109 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x113 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x109))))
 (let ((?x114 ((_ to_fp 8 24) ?x113)))
 (let ((?x80 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
 ...
 (let ((?x97 (fp.sub roundNearestTiesToEven ?x68 ?x56)))
 (let ((?x126 (fp.sub roundNearestTiesToEven ?x97 ?x85)))
 (let ((?x151 (concat (select symbolic_0_float_89 (_ bv1 32)) (select symbolic_0_float_89 (_ bv0 32)))))
 (let ((?x155 (concat (select symbolic_0_float_89 (_ bv3 32)) (concat (select symbolic_0_float_89 (_ bv2 32)) ?x151))))
 (let ((?x156 ((_ to_fp 8 24) ?x155)))
 (let ((?x158 (fp.sub roundNearestTiesToEven ?x156 (fp.sub roundNearestTiesToEven ?x126 ?x114))))
 (or (fp.isNaN ?x146) (fp.gt ?x158 ?x146))))))))))))))))))))))))))))
(assert
 (let ((?x109 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x113 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x109))))
 (let ((?x114 ((_ to_fp 8 24) ?x113)))
