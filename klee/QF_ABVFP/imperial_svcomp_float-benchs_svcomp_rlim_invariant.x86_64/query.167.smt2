...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.167.smt2
|)
...
(assert
 ...
 (let ((?x67 (concat (select symbolic_0_float_23 (_ bv3 32)) (concat (select symbolic_0_float_23 (_ bv2 32)) ?x63))))
 (let ((?x68 ((_ to_fp 8 24) ?x67)))
 (let ((?x106 (fp.sub roundNearestTiesToEven ?x68 (fp.sub roundNearestTiesToEven ?x89 ?x104))))
...
(assert
 ...
 (let ((?x130 (fp.sub roundNearestTiesToEven ?x39 ?x104)))
 (let ((?x89 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x136 (concat (select symbolic_0_float7 (_ bv1 32)) (select symbolic_0_float7 (_ bv0 32)))))
 (let ((?x140 (concat (select symbolic_0_float7 (_ bv3 32)) (concat (select symbolic_0_float7 (_ bv2 32)) ?x136))))
 (let ((?x141 ((_ to_fp 8 24) ?x140)))
 (let ((?x142 (fp.sub roundNearestTiesToEven ?x141 ?x89)))
 (not (fp.gt ?x142 ?x130)))))))))))))
(assert
 (let ((?x89 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x111 (concat (select symbolic_0_float_36 (_ bv1 32)) (select symbolic_0_float_36 (_ bv0 32)))))
