...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.512.smt2
|)
...
(assert
 ...
 (let ((?x43 ((_ to_fp 8 24) ?x42)))
 (let ((?x49 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x167 (fp.sub roundNearestTiesToEven ?x49 ?x43)))
 (not (fp.isNaN ?x167))))))))
(assert
 (let ((?x38 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 (let ((?x42 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x38))))
...
(let ((?x19 ((_ to_fp 8 24) ?x18)))
(let ((?x121 (fp.sub roundNearestTiesToEven ?x19 ?x76)))
(let ((?x182 (fp.add roundNearestTiesToEven ?x121 ?x107)))
