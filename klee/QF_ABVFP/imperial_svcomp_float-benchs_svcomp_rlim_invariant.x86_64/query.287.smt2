...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.287.smt2
|)
...
(assert
 ...
 (let ((?x111 (fp.sub roundNearestTiesToEven ?x109 (fp.sub roundNearestTiesToEven ?x19 ?x68))))
 (not (fp.isNaN ?x111)))))))))))))
(assert
 (let ((?x93 (concat (select symbolic_0_float_75 (_ bv1 32)) (select symbolic_0_float_75 (_ bv0 32)))))
 (let ((?x97 (concat (select symbolic_0_float_75 (_ bv3 32)) (concat (select symbolic_0_float_75 (_ bv2 32)) ?x93))))
