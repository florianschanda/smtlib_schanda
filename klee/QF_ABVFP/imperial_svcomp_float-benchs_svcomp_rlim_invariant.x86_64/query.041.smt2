...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.041.smt2
|)
...
(assert
 ...
 (let ((?x20 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x70 (fp.add roundNearestTiesToEven ?x20 ?x19)))
 (let ((?x102 (fp.add roundNearestTiesToEven ?x70 ?x56)))
...
(let ((?x70 (fp.add roundNearestTiesToEven ?x20 ?x19)))
(let ((?x102 (fp.add roundNearestTiesToEven ?x70 ?x56)))
(let ((?x122 (fp.add roundNearestTiesToEven ?x102 ?x88)))
(not (and (fp.geq ?x122 ((_ to_fp 8 24) (_ bv3271622656 32))) (fp.leq ?x122 ((_ to_fp 8 24) (_ bv1124139008 32)))))))))))))))))))
(check-sat)
(exit)
