...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.341.smt2
|)
...
(assert
 (let ((?x21 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x125 (concat (select symbolic_0_float_87 (_ bv1 32)) (select symbolic_0_float_87 (_ bv0 32)))))
 (let ((?x129 (concat (select symbolic_0_float_87 (_ bv3 32)) (concat (select symbolic_0_float_87 (_ bv2 32)) ?x125))))
...
(assert
 ...
 (let ((?x35 ((_ to_fp 8 24) ?x34)))
 (let ((?x41 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x146 (fp.sub roundNearestTiesToEven ?x41 ?x35)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x151 (concat (select symbolic_0_float9 (_ bv1 32)) (select symbolic_0_float9 (_ bv0 32)))))
 (let ((?x155 (concat (select symbolic_0_float9 (_ bv3 32)) (concat (select symbolic_0_float9 (_ bv2 32)) ?x151))))
 (let ((?x156 ((_ to_fp 8 24) ?x155)))
 (let ((?x157 (fp.sub roundNearestTiesToEven ?x156 ?x26)))
...
(let ((?x141 ((_ to_fp 8 24) ?x140)))
(let ((?x41 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x178 (fp.sub roundNearestTiesToEven ?x41 ?x141)))
(let ((?x96 (concat (select symbolic_0_float_75 (_ bv1 32)) (select symbolic_0_float_75 (_ bv0 32)))))
(let ((?x100 (concat (select symbolic_0_float_75 (_ bv3 32)) (concat (select symbolic_0_float_75 (_ bv2 32)) ?x96))))
(let ((?x101 ((_ to_fp 8 24) ?x100)))
(let ((?x63 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
...
(let ((?x129 (concat (select symbolic_0_float_87 (_ bv3 32)) (concat (select symbolic_0_float_87 (_ bv2 32)) ?x125))))
(let ((?x130 ((_ to_fp 8 24) ?x129)))
(let ((?x175 (fp.sub roundNearestTiesToEven ?x130 (fp.sub roundNearestTiesToEven ?x113 ?x101))))
