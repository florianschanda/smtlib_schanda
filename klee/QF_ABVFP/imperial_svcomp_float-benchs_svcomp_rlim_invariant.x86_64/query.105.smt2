...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.105.smt2
|)
...
(assert
 ...
 (let ((?x37 (fp.sub roundNearestTiesToEven ?x26 ?x35)))
 (let ((?x47 (fp.sub roundNearestTiesToEven ?x37 ?x46)))
 (let ((?x123 (concat (select symbolic_0_float_47 (_ bv1 32)) (select symbolic_0_float_47 (_ bv0 32)))))
 (let ((?x127 (concat (select symbolic_0_float_47 (_ bv3 32)) (concat (select symbolic_0_float_47 (_ bv2 32)) ?x123))))
 (let ((?x128 ((_ to_fp 8 24) ?x127)))
 (let ((?x129 (fp.sub roundNearestTiesToEven ?x128 ?x47)))
 (not (fp.isNaN ?x129))))))))))))))))
(assert
 (let ((?x51 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
 (let ((?x55 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x51))))
 (let ((?x56 ((_ to_fp 8 24) ?x55)))
 (let ((?x61 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x132 (fp.sub roundNearestTiesToEven ?x61 ?x56)))
 (not (fp.isNaN ?x132))))))))
(assert
 (let ((?x51 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
 (let ((?x55 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x51))))
