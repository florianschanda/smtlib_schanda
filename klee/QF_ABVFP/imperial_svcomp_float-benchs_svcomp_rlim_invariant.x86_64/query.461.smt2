...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.461.smt2
|)
...
(assert
 ...
 (let ((?x174 (fp.sub roundNearestTiesToEven ?x173 ?x99)))
 (not (fp.gt ?x174 ?x162)))))))))))))
(assert
 (let ((?x99 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x121 (concat (select symbolic_0_float_37 (_ bv1 32)) (select symbolic_0_float_37 (_ bv0 32)))))
