...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.290.smt2
|)
...
(assert
 ...
 (let ((?x130 ((_ to_fp 8 24) ?x129)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x136 (fp.sub roundNearestTiesToEven ?x26 ?x130)))
 (let ((?x78 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
 (let ((?x82 (concat (select symbolic_0_float_54 (_ bv3 32)) (concat (select symbolic_0_float_54 (_ bv2 32)) ?x78))))
 (let ((?x83 ((_ to_fp 8 24) ?x82)))
 (let ((?x46 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 ...
 (let ((?x114 (concat (select symbolic_0_float_66 (_ bv3 32)) (concat (select symbolic_0_float_66 (_ bv2 32)) ?x110))))
 (let ((?x115 ((_ to_fp 8 24) ?x114)))
 (let ((?x134 (fp.sub roundNearestTiesToEven ?x115 (fp.add roundNearestTiesToEven ?x97 ?x83))))
 (or (or (fp.isNaN ?x134) (fp.isNaN ?x136)) (fp.gt ?x134 ?x136))))))))))))))))))))))))
(assert
 (let ((?x117 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x34 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x38 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x34))))
...
(let ((?x115 ((_ to_fp 8 24) ?x114)))
(let ((?x134 (fp.sub roundNearestTiesToEven ?x115 (fp.add roundNearestTiesToEven ?x97 ?x83))))
(let (($x155 (and (and (not (fp.isNaN ?x134)) (not (fp.isNaN ?x130))) (not (fp.lt ?x134 ?x130)))))
(not $x155))))))))))))))))))))))
(check-sat)
(exit)
