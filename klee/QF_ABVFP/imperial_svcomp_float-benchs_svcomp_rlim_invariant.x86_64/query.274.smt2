...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.274.smt2
|)
...
(assert
 ...
 (fp.leq ?x34 ?x24))))))
(assert
 (let ((?x118 (concat (select symbolic_0_float_17 (_ bv1 32)) (select symbolic_0_float_17 (_ bv0 32)))))
 (let ((?x122 (concat (select symbolic_0_float_17 (_ bv3 32)) (concat (select symbolic_0_float_17 (_ bv2 32)) ?x118))))
 ...
 (let ((?x33 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x29))))
 (let ((?x34 ((_ to_fp 8 24) ?x33)))
 (let ((?x113 (fp.sub roundNearestTiesToEven ?x34 ?x67)))
...
(let ((?x108 ((_ to_fp 8 24) ?x107)))
(let ((?x39 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x143 (fp.sub roundNearestTiesToEven ?x39 ?x108)))
(let ((?x61 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
(let ((?x65 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x61))))
(let ((?x66 ((_ to_fp 8 24) ?x65)))
(let ((?x12 (concat (select symbolic_0_float_20 (_ bv1 32)) (select symbolic_0_float_20 (_ bv0 32)))))
...
(let ((?x96 (concat (select symbolic_0_float_65 (_ bv3 32)) (concat (select symbolic_0_float_65 (_ bv2 32)) ?x92))))
(let ((?x97 ((_ to_fp 8 24) ?x96)))
(let ((?x140 (fp.sub roundNearestTiesToEven ?x97 (fp.sub roundNearestTiesToEven ?x19 ?x66))))
