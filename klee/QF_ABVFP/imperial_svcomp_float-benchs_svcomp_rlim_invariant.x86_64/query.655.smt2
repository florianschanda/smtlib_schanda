...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.655.smt2
|)
...
(let ((?x151 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x147))))
(let ((?x152 ((_ to_fp 8 24) ?x151)))
(let ((?x175 (fp.sub roundNearestTiesToEven ?x152 (fp.sub roundNearestTiesToEven ?x135 ?x123))))
