...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.428.smt2
|)
...
(assert
 ...
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x132 (concat (select symbolic_0_float8 (_ bv1 32)) (select symbolic_0_float8 (_ bv0 32)))))
 (let ((?x136 (concat (select symbolic_0_float8 (_ bv3 32)) (concat (select symbolic_0_float8 (_ bv2 32)) ?x132))))
 (let ((?x137 ((_ to_fp 8 24) ?x136)))
 (let ((?x138 (fp.sub roundNearestTiesToEven ?x137 ?x26)))
...
(assert
 ...
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x37 (fp.add roundNearestTiesToEven ?x26 ?x35)))
 (let ((?x152 (concat (select symbolic_0_float_29 (_ bv1 32)) (select symbolic_0_float_29 (_ bv0 32)))))
 (let ((?x156 (concat (select symbolic_0_float_29 (_ bv3 32)) (concat (select symbolic_0_float_29 (_ bv2 32)) ?x152))))
 (let ((?x157 ((_ to_fp 8 24) ?x156)))
 (let ((?x158 (fp.sub roundNearestTiesToEven ?x157 ?x37)))
 (not (fp.isNaN ?x158))))))))))))
(assert
 (let ((?x41 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 (let ((?x45 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x41))))
 (let ((?x46 ((_ to_fp 8 24) ?x45)))
 (let ((?x51 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x161 (fp.sub roundNearestTiesToEven ?x51 ?x46)))
 (not (fp.isNaN ?x161))))))))
(assert
 (let ((?x41 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 (let ((?x45 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x41))))
...
(let ((?x122 ((_ to_fp 8 24) ?x121)))
(let ((?x51 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x177 (fp.sub roundNearestTiesToEven ?x51 ?x122)))
(let ((?x73 (concat (select symbolic_0_float_74 (_ bv1 32)) (select symbolic_0_float_74 (_ bv0 32)))))
(let ((?x77 (concat (select symbolic_0_float_74 (_ bv3 32)) (concat (select symbolic_0_float_74 (_ bv2 32)) ?x73))))
(let ((?x78 ((_ to_fp 8 24) ?x77)))
(let ((?x12 (concat (select symbolic_0_float_40 (_ bv1 32)) (select symbolic_0_float_40 (_ bv0 32)))))
...
(let ((?x110 (concat (select symbolic_0_float_86 (_ bv3 32)) (concat (select symbolic_0_float_86 (_ bv2 32)) ?x106))))
(let ((?x111 ((_ to_fp 8 24) ?x110)))
(let ((?x175 (fp.sub roundNearestTiesToEven ?x111 (fp.add roundNearestTiesToEven ?x19 ?x78))))
