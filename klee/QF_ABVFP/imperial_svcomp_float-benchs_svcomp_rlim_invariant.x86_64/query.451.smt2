...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.451.smt2
|)
...
(assert
 ...
 (let ((?x152 ((_ to_fp 8 24) ?x151)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x168 (fp.sub roundNearestTiesToEven ?x26 ?x152)))
 (not (fp.isNaN ?x168))))))))
(assert
 (let ((?x147 (concat (select symbolic_0_float_98 (_ bv1 32)) (select symbolic_0_float_98 (_ bv0 32)))))
 (let ((?x151 (concat (select symbolic_0_float_98 (_ bv3 32)) (concat (select symbolic_0_float_98 (_ bv2 32)) ?x147))))
...
(let ((?x134 (fp.add roundNearestTiesToEven ?x102 ?x88)))
(let ((?x164 (fp.add roundNearestTiesToEven ?x134 ?x120)))
(let ((?x187 (fp.sub roundNearestTiesToEven ?x164 ?x152)))
