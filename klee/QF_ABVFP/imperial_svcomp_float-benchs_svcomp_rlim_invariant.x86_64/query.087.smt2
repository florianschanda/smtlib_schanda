...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.087.smt2
|)
...
(let ((?x91 ((_ to_fp 8 24) ?x90)))
(let ((?x106 (fp.sub roundNearestTiesToEven ?x91 (fp.add roundNearestTiesToEven ?x19 ?x58))))
(not (or (or (fp.isNaN ?x106) (fp.isNaN ?x102)) (fp.lt ?x106 ?x102)))))))))))))))))
(check-sat)
(exit)
