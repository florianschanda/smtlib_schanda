...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.709.smt2
|)
...
(assert
 ...
 (let ((?x156 (fp.sub roundNearestTiesToEven ?x154 (fp.sub roundNearestTiesToEven ?x124 ?x112))))
