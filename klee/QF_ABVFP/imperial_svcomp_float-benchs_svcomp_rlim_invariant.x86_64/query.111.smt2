...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.111.smt2
|)
...
(let ((?x19 ((_ to_fp 8 24) ?x18)))
(let ((?x110 (fp.sub roundNearestTiesToEven ?x19 ?x68)))
(let ((?x146 (fp.sub roundNearestTiesToEven ?x110 ?x98)))
