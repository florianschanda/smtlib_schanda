...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.272.smt2
|)
...
(assert
 ...
 (let ((?x65 (fp.sub roundNearestTiesToEven ?x20 ?x19)))
 (let ((?x95 (fp.add roundNearestTiesToEven ?x65 ?x51)))
 (let ((?x124 (fp.sub roundNearestTiesToEven ?x95 ?x83)))
