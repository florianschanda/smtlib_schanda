...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.286.smt2
|)
...
(assert
 ...
 (let ((?x135 (fp.sub roundNearestTiesToEven ?x134 ?x26)))
...
(let ((?x19 ((_ to_fp 8 24) ?x18)))
(let ((?x112 (fp.sub roundNearestTiesToEven ?x19 ?x68)))
(let ((?x152 (fp.add roundNearestTiesToEven ?x112 ?x98)))
