...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.529.smt2
|)
...
(assert
 ...
 (let ((?x103 ((_ to_fp 8 24) ?x102)))
 (let ((?x39 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x151 (fp.sub roundNearestTiesToEven ?x39 ?x103)))
 (let ((?x88 (concat (select symbolic_0_float_15 (_ bv1 32)) (select symbolic_0_float_15 (_ bv0 32)))))
 (let ((?x92 (concat (select symbolic_0_float_15 (_ bv3 32)) (concat (select symbolic_0_float_15 (_ bv2 32)) ?x88))))
 (let ((?x93 ((_ to_fp 8 24) ?x92)))
 (let ((?x78 ((_ to_fp 8 24) (_ bv0 32))))
 ...
 (let ((?x162 (fp.sub roundNearestTiesToEven ?x161 ?x94)))
...
(let ((?x65 (concat (select symbolic_0_float_83 (_ bv3 32)) (concat (select symbolic_0_float_83 (_ bv2 32)) ?x61))))
(let ((?x66 ((_ to_fp 8 24) ?x65)))
(let ((?x177 (fp.sub roundNearestTiesToEven ?x66 ?x19)))
