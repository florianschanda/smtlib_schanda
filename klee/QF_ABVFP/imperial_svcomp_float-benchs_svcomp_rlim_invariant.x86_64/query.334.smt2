...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.334.smt2
|)
...
(let ((?x141 ((_ to_fp 8 24) ?x140)))
(let ((?x41 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x175 (fp.sub roundNearestTiesToEven ?x41 ?x141)))
(let ((?x96 (concat (select symbolic_0_float_75 (_ bv1 32)) (select symbolic_0_float_75 (_ bv0 32)))))
(let ((?x100 (concat (select symbolic_0_float_75 (_ bv3 32)) (concat (select symbolic_0_float_75 (_ bv2 32)) ?x96))))
(let ((?x101 ((_ to_fp 8 24) ?x100)))
(let ((?x63 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
...
(let ((?x129 (concat (select symbolic_0_float_87 (_ bv3 32)) (concat (select symbolic_0_float_87 (_ bv2 32)) ?x125))))
(let ((?x130 ((_ to_fp 8 24) ?x129)))
(let ((?x172 (fp.sub roundNearestTiesToEven ?x130 (fp.sub roundNearestTiesToEven ?x113 ?x101))))
