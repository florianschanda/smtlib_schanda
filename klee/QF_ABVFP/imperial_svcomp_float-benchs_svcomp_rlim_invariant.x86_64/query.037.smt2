...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.037.smt2
|)
...
(assert
 ...
 (not (fp.lt ?x71 ?x56)))))))))))))))
(assert
 (let ((?x90 ((_ to_fp 8 24) (_ bv3271557120 32))))
 ...
 (fp.geq ?x88 ?x90))))))
(assert
 (let ((?x93 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x83 (concat (select symbolic_0_float_44 (_ bv1 32)) (select symbolic_0_float_44 (_ bv0 32)))))
 (let ((?x87 (concat (select symbolic_0_float_44 (_ bv3 32)) (concat (select symbolic_0_float_44 (_ bv2 32)) ?x83))))
 (let ((?x88 ((_ to_fp 8 24) ?x87)))
 (fp.leq ?x88 ?x93))))))
(assert
 (let ((?x20 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x98 (concat (select symbolic_0_float_55 (_ bv1 32)) (select symbolic_0_float_55 (_ bv0 32)))))
 (let ((?x102 (concat (select symbolic_0_float_55 (_ bv3 32)) (concat (select symbolic_0_float_55 (_ bv2 32)) ?x98))))
...
(assert
 ...
 (let ((?x103 ((_ to_fp 8 24) ?x102)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x109 (fp.sub roundNearestTiesToEven ?x26 ?x103)))
 (let ((?x51 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 (let ((?x55 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x51))))
 (let ((?x56 ((_ to_fp 8 24) ?x55)))
 (let ((?x12 (concat (select symbolic_0_float_10 (_ bv1 32)) (select symbolic_0_float_10 (_ bv0 32)))))
 ...
 (let ((?x87 (concat (select symbolic_0_float_44 (_ bv3 32)) (concat (select symbolic_0_float_44 (_ bv2 32)) ?x83))))
 (let ((?x88 ((_ to_fp 8 24) ?x87)))
 (let ((?x107 (fp.sub roundNearestTiesToEven ?x88 (fp.add roundNearestTiesToEven ?x70 ?x56))))
 (or (or (fp.isNaN ?x107) (fp.isNaN ?x109)) (fp.gt ?x107 ?x109))))))))))))))))))))
(assert
 (let ((?x90 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x33 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x37 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x33))))
...
(let ((?x88 ((_ to_fp 8 24) ?x87)))
(let ((?x107 (fp.sub roundNearestTiesToEven ?x88 (fp.add roundNearestTiesToEven ?x70 ?x56))))
(not (or (or (fp.isNaN ?x107) (fp.isNaN ?x103)) (fp.lt ?x107 ?x103)))))))))))))))))))
(check-sat)
(exit)
