...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.448.smt2
|)
...
(assert
 ...
 (let ((?x97 (fp.sub roundNearestTiesToEven ?x68 ?x56)))
 (let ((?x126 (fp.sub roundNearestTiesToEven ?x97 ?x85)))
 (let ((?x157 (fp.sub roundNearestTiesToEven ?x126 ?x114)))
 ...
 (let ((?x158 (fp.sub roundNearestTiesToEven ?x156 ?x157)))
...
(let ((?x126 (fp.sub roundNearestTiesToEven ?x97 ?x85)))
(let ((?x157 (fp.sub roundNearestTiesToEven ?x126 ?x114)))
(let ((?x181 (fp.add roundNearestTiesToEven ?x157 ?x143)))
