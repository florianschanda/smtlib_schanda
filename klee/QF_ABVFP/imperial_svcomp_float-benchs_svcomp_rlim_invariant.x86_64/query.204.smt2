...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.204.smt2
|)
...
(let ((?x78 ((_ to_fp 8 24) ?x77)))
(let ((?x94 (fp.sub roundNearestTiesToEven ?x78 ?x19)))
(not (or (or (fp.isNaN ?x94) (fp.isNaN ?x89)) (fp.lt ?x94 ?x89))))))))))))))
(check-sat)
(exit)
