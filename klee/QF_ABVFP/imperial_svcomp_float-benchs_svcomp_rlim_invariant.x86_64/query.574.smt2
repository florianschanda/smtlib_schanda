...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.574.smt2
|)
...
(assert
 ...
 (let ((?x102 (fp.sub roundNearestTiesToEven ?x19 ?x58)))
 (let ((?x132 (fp.add roundNearestTiesToEven ?x102 ?x88)))
 (let ((?x161 (fp.sub roundNearestTiesToEven ?x132 ?x120)))
