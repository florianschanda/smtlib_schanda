...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.049.smt2
|)
...
(assert
 ...
 (not (fp.gt ?x64 ?x67)))))))))))))))))
(assert
 (let ((?x82 ((_ to_fp 8 24) (_ bv3271557120 32))))
 ...
 (fp.geq ?x80 ?x82))))))
(assert
 (let ((?x85 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x75 (concat (select symbolic_0_float_44 (_ bv1 32)) (select symbolic_0_float_44 (_ bv0 32)))))
 (let ((?x79 (concat (select symbolic_0_float_44 (_ bv3 32)) (concat (select symbolic_0_float_44 (_ bv2 32)) ?x75))))
 (let ((?x80 ((_ to_fp 8 24) ?x79)))
 (fp.leq ?x80 ?x85))))))
(assert
 (let ((?x20 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x90 (concat (select symbolic_0_float_55 (_ bv1 32)) (select symbolic_0_float_55 (_ bv0 32)))))
 (let ((?x94 (concat (select symbolic_0_float_55 (_ bv3 32)) (concat (select symbolic_0_float_55 (_ bv2 32)) ?x90))))
...
(let ((?x95 ((_ to_fp 8 24) ?x94)))
(let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x107 (fp.sub roundNearestTiesToEven ?x26 ?x95)))
(let ((?x46 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
(let ((?x50 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x46))))
(let ((?x51 ((_ to_fp 8 24) ?x50)))
(let ((?x12 (concat (select symbolic_0_float_10 (_ bv1 32)) (select symbolic_0_float_10 (_ bv0 32)))))
...
(let ((?x79 (concat (select symbolic_0_float_44 (_ bv3 32)) (concat (select symbolic_0_float_44 (_ bv2 32)) ?x75))))
(let ((?x80 ((_ to_fp 8 24) ?x79)))
(let ((?x105 (fp.sub roundNearestTiesToEven ?x80 (fp.sub roundNearestTiesToEven ?x63 ?x51))))
(not (or (or (fp.isNaN ?x105) (fp.isNaN ?x107)) (fp.gt ?x105 ?x107)))))))))))))))))))))
(check-sat)
(exit)
