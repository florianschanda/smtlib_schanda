...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.497.smt2
|)
...
(assert
 ...
 (let ((?x99 (fp.sub roundNearestTiesToEven ?x68 ?x56)))
 (let ((?x129 (fp.add roundNearestTiesToEven ?x99 ?x85)))
 (let ((?x158 (fp.sub roundNearestTiesToEven ?x129 ?x117)))
