...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.018.smt2
|)
...
(let ((?x20 ((_ to_fp 8 24) (_ bv0 32))))
(let ((?x70 (fp.add roundNearestTiesToEven ?x20 ?x19)))
(let ((?x88 (fp.add roundNearestTiesToEven ?x70 ?x56)))
