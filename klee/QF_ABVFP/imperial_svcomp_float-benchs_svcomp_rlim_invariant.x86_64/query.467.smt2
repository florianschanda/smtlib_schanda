...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.467.smt2
|)
...
(let ((?x129 ((_ to_fp 8 24) ?x128)))
(let ((?x144 (fp.sub roundNearestTiesToEven ?x129 (fp.sub roundNearestTiesToEven ?x112 ?x100))))
(not (or (or (fp.isNaN ?x144) (fp.isNaN ?x140)) (fp.lt ?x144 ?x140)))))))))))))))))))))
(check-sat)
(exit)
