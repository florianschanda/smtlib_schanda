...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.440.smt2
|)
...
(assert
 ...
 (let ((?x147 (fp.sub roundNearestTiesToEven ?x146 ?x47)))
 (not (fp.isNaN ?x147))))))))))))))))
(assert
 (let ((?x51 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
 (let ((?x55 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x51))))
 (let ((?x56 ((_ to_fp 8 24) ?x55)))
 (let ((?x71 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x150 (fp.sub roundNearestTiesToEven ?x71 ?x56)))
 (not (fp.isNaN ?x150))))))))
(assert
 (let ((?x51 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
 (let ((?x55 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x51))))
...
(assert
 ...
 (let ((?x47 (fp.add roundNearestTiesToEven ?x37 ?x46)))
 (let ((?x57 (fp.sub roundNearestTiesToEven ?x47 ?x56)))
 (let ((?x160 (concat (select symbolic_0_float_69 (_ bv1 32)) (select symbolic_0_float_69 (_ bv0 32)))))
 (let ((?x164 (concat (select symbolic_0_float_69 (_ bv3 32)) (concat (select symbolic_0_float_69 (_ bv2 32)) ?x160))))
 (let ((?x165 ((_ to_fp 8 24) ?x164)))
 (let ((?x166 (fp.sub roundNearestTiesToEven ?x165 ?x57)))
 (not (fp.isNaN ?x166))))))))))))))))))))
(assert
 (let ((?x61 (concat (select symbolic_0_float_74 (_ bv1 32)) (select symbolic_0_float_74 (_ bv0 32)))))
 (let ((?x65 (concat (select symbolic_0_float_74 (_ bv3 32)) (concat (select symbolic_0_float_74 (_ bv2 32)) ?x61))))
 (let ((?x66 ((_ to_fp 8 24) ?x65)))
 (let ((?x71 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x169 (fp.sub roundNearestTiesToEven ?x71 ?x66)))
 (not (fp.isNaN ?x169))))))))
(assert
 (let ((?x61 (concat (select symbolic_0_float_74 (_ bv1 32)) (select symbolic_0_float_74 (_ bv0 32)))))
 (let ((?x65 (concat (select symbolic_0_float_74 (_ bv3 32)) (concat (select symbolic_0_float_74 (_ bv2 32)) ?x61))))
