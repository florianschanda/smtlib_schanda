...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.391.smt2
|)
...
(assert
 ...
 (let ((?x33 (concat (select symbolic_0_float_21 (_ bv3 32)) (concat (select symbolic_0_float_21 (_ bv2 32)) ?x29))))
 (let ((?x34 ((_ to_fp 8 24) ?x33)))
 (let ((?x111 (fp.sub roundNearestTiesToEven ?x34 (fp.add roundNearestTiesToEven ?x77 ?x109))))
...
(assert
 ...
 (let ((?x43 ((_ to_fp 8 24) ?x42)))
 (let ((?x49 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x133 (fp.sub roundNearestTiesToEven ?x49 ?x43)))
 (let ((?x29 (concat (select symbolic_0_float_21 (_ bv1 32)) (select symbolic_0_float_21 (_ bv0 32)))))
 (let ((?x33 (concat (select symbolic_0_float_21 (_ bv3 32)) (concat (select symbolic_0_float_21 (_ bv2 32)) ?x29))))
 (let ((?x34 ((_ to_fp 8 24) ?x33)))
...
(assert
 ...
 (let ((?x109 ((_ to_fp 8 24) ?x108)))
 (let ((?x49 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x159 (fp.sub roundNearestTiesToEven ?x49 ?x109)))
 (let ((?x77 ((_ to_fp 8 24) (_ bv0 32))))
 ...
 (let ((?x170 (fp.sub roundNearestTiesToEven ?x169 ?x77)))
