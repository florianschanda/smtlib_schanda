...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.417.smt2
|)
...
(assert
 ...
 (let ((?x100 (fp.sub roundNearestTiesToEven ?x19 ?x58)))
 (let ((?x131 (fp.sub roundNearestTiesToEven ?x100 ?x88)))
 (let ((?x161 (fp.add roundNearestTiesToEven ?x131 ?x117)))
 ...
 (let ((?x162 (fp.sub roundNearestTiesToEven ?x160 ?x161)))
 (not (fp.isNaN ?x162))))))))))))))))))))))
(assert
 (let ((?x144 (concat (select symbolic_0_float_98 (_ bv1 32)) (select symbolic_0_float_98 (_ bv0 32)))))
 (let ((?x148 (concat (select symbolic_0_float_98 (_ bv3 32)) (concat (select symbolic_0_float_98 (_ bv2 32)) ?x144))))
 (let ((?x149 ((_ to_fp 8 24) ?x148)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x165 (fp.sub roundNearestTiesToEven ?x31 ?x149)))
 (not (fp.isNaN ?x165))))))))
(assert
 (let ((?x144 (concat (select symbolic_0_float_98 (_ bv1 32)) (select symbolic_0_float_98 (_ bv0 32)))))
 (let ((?x148 (concat (select symbolic_0_float_98 (_ bv3 32)) (concat (select symbolic_0_float_98 (_ bv2 32)) ?x144))))
...
(let ((?x131 (fp.sub roundNearestTiesToEven ?x100 ?x88)))
(let ((?x161 (fp.add roundNearestTiesToEven ?x131 ?x117)))
(let ((?x180 (fp.sub roundNearestTiesToEven ?x161 ?x149)))
