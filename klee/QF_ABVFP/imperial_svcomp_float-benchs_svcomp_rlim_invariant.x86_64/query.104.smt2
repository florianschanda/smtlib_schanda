...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.104.smt2
|)
...
(assert
 ...
 (not (fp.gt ?x122 ?x125)))))))))))))))))))))))))
(assert
 (let ((?x131 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x34 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x38 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x34))))
 (let ((?x39 ((_ to_fp 8 24) ?x38)))
 (fp.geq ?x39 ?x131))))))
(assert
 (let ((?x134 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x34 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x38 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x34))))
 (let ((?x39 ((_ to_fp 8 24) ?x38)))
 (fp.leq ?x39 ?x134))))))
...
(let ((?x92 (fp.sub roundNearestTiesToEven ?x63 ?x51)))
(let ((?x121 (fp.sub roundNearestTiesToEven ?x92 ?x80)))
(let ((?x144 (fp.sub roundNearestTiesToEven ?x121 ?x109)))
(not (and (fp.geq ?x144 ((_ to_fp 8 24) (_ bv3271622656 32))) (fp.leq ?x144 ((_ to_fp 8 24) (_ bv1124139008 32)))))))))))))))))))))))
(check-sat)
(exit)
