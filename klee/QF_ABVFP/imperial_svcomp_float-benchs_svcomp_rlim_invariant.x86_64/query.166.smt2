...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.166.smt2
|)
...
(let ((?x66 ((_ to_fp 8 24) ?x65)))
(let ((?x83 (fp.sub roundNearestTiesToEven ?x66 ?x19)))
(let (($x153 (and (and (not (fp.isNaN ?x83)) (not (fp.isNaN ?x77))) (not (fp.lt ?x83 ?x77)))))
(not $x153)))))))))))))
(check-sat)
(exit)
