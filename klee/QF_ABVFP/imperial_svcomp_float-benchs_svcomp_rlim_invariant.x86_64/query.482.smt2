...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.482.smt2
|)
...
(assert
 ...
 (let ((?x146 ((_ to_fp 8 24) ?x145)))
 (let ((?x31 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x162 (fp.sub roundNearestTiesToEven ?x31 ?x146)))
 (not (fp.isNaN ?x162))))))))
(assert
 (let ((?x141 (concat (select symbolic_0_float_98 (_ bv1 32)) (select symbolic_0_float_98 (_ bv0 32)))))
 (let ((?x145 (concat (select symbolic_0_float_98 (_ bv3 32)) (concat (select symbolic_0_float_98 (_ bv2 32)) ?x141))))
...
(let ((?x129 (fp.sub roundNearestTiesToEven ?x100 ?x88)))
(let ((?x158 (fp.sub roundNearestTiesToEven ?x129 ?x117)))
(let ((?x177 (fp.sub roundNearestTiesToEven ?x158 ?x146)))
