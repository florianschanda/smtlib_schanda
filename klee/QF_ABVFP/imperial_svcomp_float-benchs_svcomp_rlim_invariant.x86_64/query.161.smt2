...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.161.smt2
|)
...
(let ((?x102 (fp.add roundNearestTiesToEven ?x70 ?x56)))
(let ((?x132 (fp.add roundNearestTiesToEven ?x102 ?x88)))
(let ((?x153 (fp.sub roundNearestTiesToEven ?x132 ?x120)))
