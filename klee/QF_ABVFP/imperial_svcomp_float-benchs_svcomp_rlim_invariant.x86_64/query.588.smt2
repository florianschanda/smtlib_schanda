...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.588.smt2
|)
...
(assert
 ...
 (let ((?x98 (concat (select symbolic_0_float_25 (_ bv3 32)) (concat (select symbolic_0_float_25 (_ bv2 32)) ?x94))))
 (let ((?x99 ((_ to_fp 8 24) ?x98)))
 (let ((?x135 (fp.sub roundNearestTiesToEven ?x99 ?x134)))
...
(assert
 ...
 (let ((?x133 (concat (select symbolic_0_float7 (_ bv3 32)) (concat (select symbolic_0_float7 (_ bv2 32)) ?x129))))
 (let ((?x134 ((_ to_fp 8 24) ?x133)))
 (let ((?x159 (fp.sub roundNearestTiesToEven ?x134 ?x67)))
...
(let ((?x18 (concat (select symbolic_0_float_60 (_ bv3 32)) (concat (select symbolic_0_float_60 (_ bv2 32)) ?x12))))
(let ((?x19 ((_ to_fp 8 24) ?x18)))
(let ((?x183 (fp.sub roundNearestTiesToEven ?x19 ?x66)))
