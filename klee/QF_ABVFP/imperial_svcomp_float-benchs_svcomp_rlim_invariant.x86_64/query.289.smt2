...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.289.smt2
|)
...
(assert
 ...
 (not (fp.lt ?x98 ?x83)))))))))))))))))))
(assert
 (let ((?x117 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x110 (concat (select symbolic_0_float_66 (_ bv1 32)) (select symbolic_0_float_66 (_ bv0 32)))))
 (let ((?x114 (concat (select symbolic_0_float_66 (_ bv3 32)) (concat (select symbolic_0_float_66 (_ bv2 32)) ?x110))))
 (let ((?x115 ((_ to_fp 8 24) ?x114)))
 (fp.geq ?x115 ?x117))))))
(assert
 (let ((?x120 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x110 (concat (select symbolic_0_float_66 (_ bv1 32)) (select symbolic_0_float_66 (_ bv0 32)))))
 (let ((?x114 (concat (select symbolic_0_float_66 (_ bv3 32)) (concat (select symbolic_0_float_66 (_ bv2 32)) ?x110))))
 (let ((?x115 ((_ to_fp 8 24) ?x114)))
 (fp.leq ?x115 ?x120))))))
(assert
 (let ((?x20 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x125 (concat (select symbolic_0_float_77 (_ bv1 32)) (select symbolic_0_float_77 (_ bv0 32)))))
 (let ((?x129 (concat (select symbolic_0_float_77 (_ bv3 32)) (concat (select symbolic_0_float_77 (_ bv2 32)) ?x125))))
...
(let ((?x130 ((_ to_fp 8 24) ?x129)))
(let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x144 (fp.sub roundNearestTiesToEven ?x26 ?x130)))
(let ((?x78 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
(let ((?x82 (concat (select symbolic_0_float_54 (_ bv3 32)) (concat (select symbolic_0_float_54 (_ bv2 32)) ?x78))))
(let ((?x83 ((_ to_fp 8 24) ?x82)))
(let ((?x46 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
...
(let ((?x114 (concat (select symbolic_0_float_66 (_ bv3 32)) (concat (select symbolic_0_float_66 (_ bv2 32)) ?x110))))
(let ((?x115 ((_ to_fp 8 24) ?x114)))
(let ((?x142 (fp.sub roundNearestTiesToEven ?x115 (fp.add roundNearestTiesToEven ?x97 ?x83))))
