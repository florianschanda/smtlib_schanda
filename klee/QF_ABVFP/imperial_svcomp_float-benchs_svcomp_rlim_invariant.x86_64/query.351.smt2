...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.351.smt2
|)
...
(let ((?x127 ((_ to_fp 8 24) ?x126)))
(let ((?x142 (fp.sub roundNearestTiesToEven ?x127 (fp.sub roundNearestTiesToEven ?x110 ?x98))))
(not (or (or (fp.isNaN ?x142) (fp.isNaN ?x138)) (fp.lt ?x142 ?x138)))))))))))))))))))))
(check-sat)
(exit)
