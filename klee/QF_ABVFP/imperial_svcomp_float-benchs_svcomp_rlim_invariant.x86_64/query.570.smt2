...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.570.smt2
|)
...
(let ((?x148 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x144))))
(let ((?x149 ((_ to_fp 8 24) ?x148)))
(let ((?x172 (fp.sub roundNearestTiesToEven ?x149 (fp.sub roundNearestTiesToEven ?x132 ?x120))))
