...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.525.smt2
|)
...
(assert
 ...
 (let ((?x54 ((_ to_fp 8 24) ?x53)))
 (let ((?x59 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x137 (fp.sub roundNearestTiesToEven ?x59 ?x54)))
 (let ((?x38 (concat (select symbolic_0_float_52 (_ bv1 32)) (select symbolic_0_float_52 (_ bv0 32)))))
 (let ((?x42 (concat (select symbolic_0_float_52 (_ bv3 32)) (concat (select symbolic_0_float_52 (_ bv2 32)) ?x38))))
 (let ((?x43 ((_ to_fp 8 24) ?x42)))
 (let ((?x29 (concat (select symbolic_0_float_21 (_ bv1 32)) (select symbolic_0_float_21 (_ bv0 32)))))
 ...
 (let ((?x34 ((_ to_fp 8 24) ?x33)))
 (let ((?x45 (fp.add roundNearestTiesToEven ?x34 ?x43)))
 (let ((?x142 (concat (select symbolic_0_float_68 (_ bv1 32)) (select symbolic_0_float_68 (_ bv0 32)))))
 (let ((?x146 (concat (select symbolic_0_float_68 (_ bv3 32)) (concat (select symbolic_0_float_68 (_ bv2 32)) ?x142))))
 (let ((?x147 ((_ to_fp 8 24) ?x146)))
 (let ((?x148 (fp.sub roundNearestTiesToEven ?x147 ?x45)))
...
(assert
 ...
 (let ((?x89 ((_ to_fp 8 24) ?x88)))
 (let ((?x59 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x161 (fp.sub roundNearestTiesToEven ?x59 ?x89)))
 (let ((?x80 ((_ to_fp 8 24) (_ bv0 32))))
 ...
 (let ((?x172 (fp.sub roundNearestTiesToEven ?x171 ?x80)))
