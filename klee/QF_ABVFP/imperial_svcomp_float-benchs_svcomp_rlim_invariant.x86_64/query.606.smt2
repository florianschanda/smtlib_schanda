...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.606.smt2
|)
...
(let ((?x161 ((_ to_fp 8 24) ?x160)))
(let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x175 (fp.sub roundNearestTiesToEven ?x26 ?x161)))
(let ((?x109 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
(let ((?x113 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x109))))
(let ((?x114 ((_ to_fp 8 24) ?x113)))
(let ((?x80 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
...
(let ((?x145 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x141))))
(let ((?x146 ((_ to_fp 8 24) ?x145)))
(let ((?x173 (fp.sub roundNearestTiesToEven ?x146 (fp.add roundNearestTiesToEven ?x128 ?x114))))
