...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_numerical_recipes_qrdcmp.x86_64/query.1.smt2
|)
...
(not (not (fp.eq (fp.sub roundNearestTiesToEven ?x37 ?x56) ((_ to_fp 8 24) (_ bv0 32)))))))))))))))
(check-sat)
(exit)
