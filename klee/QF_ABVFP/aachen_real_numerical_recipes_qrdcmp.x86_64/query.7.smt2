...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_numerical_recipes_qrdcmp.x86_64/query.7.smt2
|)
...
(let ((?x56 (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x52 ((_ to_fp 8 24) (_ bv1075285470 32))) ((_ to_fp 8 24) (_ bv3204448256 32)))))
(let ((?x57 (fp.sub roundNearestTiesToEven ?x37 ?x56)))
(not (= (_ bv4 32) (ite (fp.isNormal ?x57) (_ bv4 32) (_ bv3 32)))))))))))))))
(check-sat)
(exit)
