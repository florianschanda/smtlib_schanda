...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.34.smt2
|)
...
(not (not (= (_ bv45 8) ((_ extract 7 0) (bvadd (_ bv48 32) (bvurem ?x68 (_ bv10 32))))))))))))))))))
(check-sat)
(exit)
