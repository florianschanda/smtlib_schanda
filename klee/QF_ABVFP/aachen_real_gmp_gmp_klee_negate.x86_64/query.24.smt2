...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_negate.x86_64/query.24.smt2
|)
...
(let ((?x54 (bvmul (_ bv8 64) (bvadd (_ bv18446744073709551614 64) (ite (bvslt (_ bv4294967295 32) ?x47) ?x49 (bvsub (_ bv0 64) ?x49))))))
(not (bvult ?x54 (_ bv17 64))))))))))
(check-sat)
(exit)
