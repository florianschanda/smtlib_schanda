...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_bary_diverge.x86_64/query.15.smt2
|)
...
(let ((?x37 (fp.add roundNearestTiesToEven ?x33 (fp.mul roundNearestTiesToEven ?x19 ((_ to_fp 8 24) (_ bv1045220557 32))))))
(not (and (fp.geq ?x37 ((_ to_fp 8 24) (_ bv3231711232 32))) (fp.leq ?x37 ((_ to_fp 8 24) (_ bv1084227584 32)))))))))))
(check-sat)
(exit)
