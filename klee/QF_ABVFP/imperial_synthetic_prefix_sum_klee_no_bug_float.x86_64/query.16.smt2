...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_prefix_sum_klee_no_bug_float.x86_64/query.16.smt2
|)
...
(not (and (not (fp.isNaN ?x76)) (not (fp.lt ?x76 ?x68)))))))))))))))
(check-sat)
(exit)
