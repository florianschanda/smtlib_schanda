...
(let ((?x83 (ite $x70 (ite (fp.lt ((_ to_fp 11 53) ?x30) ((_ to_fp 11 53) (_ bv0 64))) (_ bv4294967294 32) (_ bv2 32)) (ite (fp.lt ((_ to_fp 11 53) ?x61) ((_ to_fp 11 53) (_ bv0 64))) (_ bv4294967294 32) (_ bv2 32)))))
(let ((?x85 ((_ sign_extend 32) ?x83)))
(let ((?x88 (bvadd (bvsub (ite $x70 ?x69 ?x59) (ite $x70 ?x59 ?x69)) (ite (bvslt (_ bv4294967295 32) ?x83) ?x85 (bvsub (_ bv0 64) ?x85)))))
(not (not (bvslt (_ bv2 64) ?x88))))))))))))))))
(check-sat)
(exit)
