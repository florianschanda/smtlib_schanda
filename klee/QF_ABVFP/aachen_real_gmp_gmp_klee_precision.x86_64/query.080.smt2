...
(let ((?x24 (concat (select d0 (_ bv5 32)) (concat (select d0 (_ bv4 32)) (concat (select d0 (_ bv3 32)) ?x15)))))
(let ((?x30 (concat (select d0 (_ bv7 32)) (concat (select d0 (_ bv6 32)) ?x24))))
(let ((?x53 (fp.mul roundNearestTiesToEven (fp.add roundNearestTiesToEven ((_ to_fp 11 53) (bvor ?x30 (_ bv1 64))) ((_ to_fp 11 53) ?x30)) ((_ to_fp 11 53) (_ bv4602678819172646912 64)))))
(not (not (fp.eq ?x53 ((_ to_fp 11 53) (bvor ?x30 (_ bv1 64)))))))))))
(check-sat)
(exit)
