...
(let ((?x79 (ite $x70 (ite (fp.lt ((_ to_fp 11 53) (bvor ?x30 (_ bv1 64))) ((_ to_fp 11 53) (_ bv0 64))) (_ bv4294967294 32) (_ bv2 32)) (ite (fp.lt ?x31 ((_ to_fp 11 53) (_ bv0 64))) (_ bv4294967294 32) (_ bv2 32)))))
(let ((?x81 ((_ sign_extend 32) ?x79)))
(not (not (bvslt (ite (bvslt (_ bv4294967295 32) ?x79) ?x81 (bvsub (_ bv0 64) ?x81)) (_ bv0 64))))))))))))))
(check-sat)
(exit)
