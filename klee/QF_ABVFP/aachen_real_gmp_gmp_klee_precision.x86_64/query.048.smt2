...
(let (($x70 (bvslt ((_ sign_extend 32) ((_ extract 31 0) ?x58)) ((_ sign_extend 32) ((_ extract 31 0) (bvadd (_ bv18446744073709551553 64) ?x66))))))
...
(not (not (= (_ bv1 64) (ite (bvslt (_ bv4294967295 32) ?x79) ?x81 (bvsub (_ bv0 64) ?x81)))))))))))))))
(check-sat)
(exit)
