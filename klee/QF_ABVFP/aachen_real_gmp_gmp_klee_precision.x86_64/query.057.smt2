...
(let ((?x94 (ite (bvslt (_ bv4294967295 32) ?x90) ?x92 (bvsub (_ bv0 64) ?x92))))
(let (($x103 (and (bvult (_ bv49593264 64) (bvadd (_ bv48919440 64) (bvmul (_ bv8 64) (bvadd (_ bv2 64) ?x94)))) (bvult (_ bv48919440 64) (bvadd (_ bv49593264 64) (bvmul (_ bv8 64) ?x94))))))
(not (not $x103))))))))))))))))))
(check-sat)
(exit)
