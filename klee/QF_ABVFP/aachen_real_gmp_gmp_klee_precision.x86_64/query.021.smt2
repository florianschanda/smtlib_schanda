...
(let ((?x24 (concat (select d0 (_ bv5 32)) (concat (select d0 (_ bv4 32)) (concat (select d0 (_ bv3 32)) ?x15)))))
(let ((?x30 (concat (select d0 (_ bv7 32)) (concat (select d0 (_ bv6 32)) ?x24))))
(let ((?x66 (bvsdiv (bvadd (_ bv3074 64) (bvand (concat (_ bv0 52) ((_ extract 63 52) (bvor ?x30 (_ bv1 64)))) (_ bv2047 64))) (_ bv64 64))))
...
(let (($x70 (bvslt ((_ sign_extend 32) ((_ extract 31 0) ?x57)) ((_ sign_extend 32) ((_ extract 31 0) (bvadd (_ bv18446744073709551553 64) ?x66))))))
(not (bvult (bvadd (_ bv18446744073663167008 64) (ite $x70 (_ bv41343728 64) (_ bv46384624 64))) (_ bv17 64))))))))))
(check-sat)
(exit)
