...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_syn_nan_double.x86_64/query.03.smt2
|)
...
(not (fp.isNaN (fp.sub roundNearestTiesToEven ?x36 ?x36)))))))
(check-sat)
(exit)
