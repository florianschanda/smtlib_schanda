...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_non_terminating_klee_no_bug.x86_64/query.34.smt2
|)
...
(let ((?x52 (fp.sub roundNearestTiesToEven (fp.sub roundNearestTiesToEven ?x50 ?x19) ?x19)))
(let ((?x54 (fp.sub roundNearestTiesToEven (fp.sub roundNearestTiesToEven ?x52 ?x19) ?x19)))
(let ((?x56 (fp.sub roundNearestTiesToEven (fp.sub roundNearestTiesToEven ?x54 ?x19) ?x19)))
(let ((?x58 (fp.sub roundNearestTiesToEven (fp.sub roundNearestTiesToEven ?x56 ?x19) ?x19)))
(let ((?x60 (fp.sub roundNearestTiesToEven (fp.sub roundNearestTiesToEven ?x58 ?x19) ?x19)))
(not (fp.gt ?x60 ((_ to_fp 8 24) (_ bv0 32)))))))))))))))))))))))
(check-sat)
(exit)
