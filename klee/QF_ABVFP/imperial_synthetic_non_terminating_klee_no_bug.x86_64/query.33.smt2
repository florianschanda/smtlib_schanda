...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_non_terminating_klee_no_bug.x86_64/query.33.smt2
|)
...
(not (fp.gt (fp.sub roundNearestTiesToEven ?x58 ?x19) ((_ to_fp 8 24) (_ bv0 32))))))))))))))))))))))
(check-sat)
(exit)
