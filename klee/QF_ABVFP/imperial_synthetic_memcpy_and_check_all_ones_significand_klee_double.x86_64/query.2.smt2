...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_memcpy_and_check_all_ones_significand_klee_double.x86_64/query.2.smt2
|)
...
(assert
 (not (not (= (_ bv0 64) (bvand fresh_to_ieee_bv_!1 (_ bv4503599627370495 64))))))
(check-sat)
(exit)
