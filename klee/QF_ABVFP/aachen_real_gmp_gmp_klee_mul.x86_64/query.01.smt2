...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mul.x86_64/query.01.smt2
|)
...
(assert
 (let ((?x15 (concat (select d10 (_ bv2 32)) (concat (select d10 (_ bv1 32)) (select d10 (_ bv0 32))))))
(let ((?x24 (concat (select d10 (_ bv5 32)) (concat (select d10 (_ bv4 32)) (concat (select d10 (_ bv3 32)) ?x15)))))
(let (($x37 (fp.leq ((_ to_fp 11 53) (concat (select d10 (_ bv7 32)) (concat (select d10 (_ bv6 32)) ?x24))) ((_ to_fp 11 53) (_ bv4611686018427387904 64)))))
(not (not $x37))))))
(check-sat)
(exit)
