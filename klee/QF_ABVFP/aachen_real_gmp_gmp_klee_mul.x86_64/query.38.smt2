...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mul.x86_64/query.38.smt2
|)
...
(let (($x51 (bvult (bvmul (_ bv8 64) (ite (bvslt (_ bv4294967295 32) ?x43) ?x45 (bvsub (_ bv0 64) ?x45))) (_ bv25 64))))
(not $x51))))))))
(check-sat)
(exit)
