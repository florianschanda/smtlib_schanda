...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mul.x86_64/query.39.smt2
|)
...
(let (($x50 (bvslt (_ bv0 64) (bvadd (_ bv18446744073709551615 64) (ite (bvslt (_ bv4294967295 32) ?x44) ?x46 (bvsub (_ bv0 64) ?x46))))))
(not $x50))))))))
(check-sat)
(exit)
