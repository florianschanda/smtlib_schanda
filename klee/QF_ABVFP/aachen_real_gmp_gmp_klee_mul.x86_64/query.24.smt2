...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mul.x86_64/query.24.smt2
|)
...
(let (($x73 (bvslt (ite (bvslt (_ bv4294967295 32) ?x62) ?x64 (bvsub (_ bv0 64) ?x64)) (ite (bvslt (_ bv4294967295 32) ?x68) ?x70 (bvsub (_ bv0 64) ?x70)))))
(not (not $x73))))))))))))))
(check-sat)
(exit)
