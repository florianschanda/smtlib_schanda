...
(let ((?x1637 (ite (= (_ bv0 64) (concat (select ?x1602 (bvadd (_ bv7 32) ?x1613)) ?x1632)) (_ bv1 64) (_ bv0 64))))
(let ((?x1638 (bvsub ?x1610 ?x1637)))
(let ((?x1749 ((_ extract 31 0) (ite (bvslt (_ bv4294967295 32) (bvxor ?x1605 ?x1359)) ?x1638 (bvsub (_ bv0 64) ?x1638)))))
(let ((?x1751 ((_ sign_extend 32) ?x1749)))
(not (not (bvslt (ite (bvslt (_ bv4294967295 32) ?x1749) ?x1751 (bvsub (_ bv0 64) ?x1751)) (_ bv2 64)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
