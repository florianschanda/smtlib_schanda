...
(let ((?x15 (select x0 (_ bv6 32))))
(let ((?x18 (select x0 (_ bv7 32))))
(let (($x49 (fp.gt ((_ to_fp 11 53) (concat ?x18 (concat ?x15 (concat ?x12 (concat ?x10 ?x35))))) ((_ to_fp 11 53) (_ bv0 64)))))
(let (($x46 (fp.isInfinite ((_ to_fp 11 53) (concat ?x18 (concat ?x15 (concat ?x12 (concat ?x10 ?x35))))))))
(not (= (_ bv0 32) (ite $x46 (ite $x49 (_ bv1 32) (_ bv4294967295 32)) (_ bv0 32)))))))))))))
(check-sat)
(exit)
