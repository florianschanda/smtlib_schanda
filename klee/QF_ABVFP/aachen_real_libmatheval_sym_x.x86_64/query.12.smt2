...
(let ((?x15 (select x0 (_ bv6 32))))
(let ((?x18 (select x0 (_ bv7 32))))
(let ((?x50 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) (concat ?x18 (concat ?x15 (concat ?x12 (concat ?x10 ?x35))))) ((_ to_fp 11 53) (concat ?x18 (concat ?x15 (concat ?x12 (concat ?x10 ?x35))))))))
(not (not (fp.isNaN (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) (_ bv4614162998222441677 64)) ?x50))))))))))))
(check-sat)
(exit)
