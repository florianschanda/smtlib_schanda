...
(let ((?x18 (select x0 (_ bv7 32))))
(let ((?x45 ((_ to_fp 11 53) (concat ?x18 (concat ?x15 (concat ?x12 (concat ?x10 ?x35)))))))
(let ((?x59 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) (_ bv4614162998222441677 64)) (fp.mul roundNearestTiesToEven ?x45 ?x45))))
(let ((?x63 (ite (fp.isInfinite ?x59) (ite (fp.gt ?x59 ((_ to_fp 11 53) (_ bv0 64))) (_ bv1 32) (_ bv4294967295 32)) (_ bv0 32))))
(not (not (= (_ bv0 32) ?x63)))))))))))))
(check-sat)
(exit)
