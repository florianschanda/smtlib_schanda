...
(let ((?x1624 ((_ to_fp 15 64) roundNearestTiesToEven ((_ to_fp 11 53) roundNearestTiesToEven ?x1623))))
(let ((?x1633 (concat (concat ((_ extract 79 79) (concat (_ bv16385 16) (_ bv9223372036854775808 64))) ((_ extract 78 64) (concat (_ bv16385 16) (_ bv9223372036854775808 64)))) ((_ extract 62 0) (concat (_ bv16385 16) (_ bv9223372036854775808 64))))))
(let ((?x1634 ((_ to_fp 15 64) ?x1633)))
(let (($x1646 (and (fp.eq ?x1624 (fp.div roundNearestTiesToEven ?x1624 ?x1634)) (not (fp.eq ?x1624 ?x1594)))))
(not (not $x1646)))))))))))))
(check-sat)
(exit)
