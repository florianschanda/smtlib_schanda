...
(assert
 (let ((?x1631 (concat (concat ((_ extract 79 79) (concat (_ bv16396 16) (_ bv11258999068426240000 64))) ((_ extract 78 64) (concat (_ bv16396 16) (_ bv11258999068426240000 64)))) ((_ extract 62 0) (concat (_ bv16396 16) (_ bv11258999068426240000 64))))))
 (let ((?x1632 ((_ to_fp 15 64) ?x1631)))
 (= ((_ extract 63 63) (concat (_ bv16396 16) (_ bv11258999068426240000 64))) (ite (or (fp.isSubnormal ?x1632) (fp.isZero ?x1632)) (_ bv0 1) (_ bv1 1))))))
(assert
...
(let ((?x1641 (fp.mul roundNearestTiesToEven ?x1623 ?x1632)))
(not (not (fp.eq ?x1641 (fp.div roundNearestTiesToEven ?x1641 ?x1648))))))))))))))))
(check-sat)
(exit)
