...
(assert
 (let ((?x1649 (concat (concat ((_ extract 79 79) (concat (_ bv16385 16) (_ bv9223372036854775808 64))) ((_ extract 78 64) (concat (_ bv16385 16) (_ bv9223372036854775808 64)))) ((_ extract 62 0) (concat (_ bv16385 16) (_ bv9223372036854775808 64))))))
 (let ((?x1650 ((_ to_fp 15 64) ?x1649)))
 (= ((_ extract 63 63) (concat (_ bv16385 16) (_ bv9223372036854775808 64))) (ite (or (fp.isSubnormal ?x1650) (fp.isZero ?x1650)) (_ bv0 1) (_ bv1 1))))))
(assert
 (let ((?x1593 (concat (concat ((_ extract 79 79) (concat (_ bv0 16) (_ bv0 64))) ((_ extract 78 64) (concat (_ bv0 16) (_ bv0 64)))) ((_ extract 62 0) (concat (_ bv0 16) (_ bv0 64))))))
 (let ((?x1594 ((_ to_fp 15 64) ?x1593)))
 (= ((_ extract 63 63) (concat (_ bv0 16) (_ bv0 64))) (ite (or (fp.isSubnormal ?x1594) (fp.isZero ?x1594)) (_ bv0 1) (_ bv1 1))))))
...
(let ((?x1640 ((_ to_fp 11 53) roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x1623 ?x1632))))
(let ((?x1641 ((_ to_fp 15 64) roundNearestTiesToEven ?x1640)))
(let ((?x1649 (concat (concat ((_ extract 79 79) (concat (_ bv16385 16) (_ bv9223372036854775808 64))) ((_ extract 78 64) (concat (_ bv16385 16) (_ bv9223372036854775808 64)))) ((_ extract 62 0) (concat (_ bv16385 16) (_ bv9223372036854775808 64))))))
(let ((?x1650 ((_ to_fp 15 64) ?x1649)))
(let (($x1662 (and (fp.eq ?x1641 (fp.div roundNearestTiesToEven ?x1641 ?x1650)) (not (fp.eq ?x1641 ?x1594)))))
(not (not $x1662))))))))))))))))
(check-sat)
(exit)
