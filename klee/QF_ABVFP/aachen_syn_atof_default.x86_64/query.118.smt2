...
(assert
 (let ((?x22 (bvadd (_ bv256 64) (bvmul (_ bv2 64) ((_ sign_extend 32) ((_ sign_extend 24) (select input0 (_ bv5 32))))))))
...
(assert
 (let ((?x1593 (concat (concat ((_ extract 79 79) (concat (_ bv0 16) (_ bv0 64))) ((_ extract 78 64) (concat (_ bv0 16) (_ bv0 64)))) ((_ extract 62 0) (concat (_ bv0 16) (_ bv0 64))))))
(let ((?x1594 ((_ to_fp 15 64) ?x1593)))
(let ((?x1604 ((_ to_fp 15 64) roundNearestTiesToEven (bvadd (_ bv4294967248 32) ((_ sign_extend 24) (select input0 (_ bv5 32)))))))
