...
(let ((?x317 (concat (select ?x312 (_ bv10 32)) (concat (select ?x312 (_ bv9 32)) (select ?x312 (_ bv8 32))))))
(let ((?x325 (concat (select ?x312 (_ bv6 32)) (concat (select ?x312 (_ bv5 32)) (select ?x312 (_ bv4 32))))))
(let (($x329 (fp.lt ((_ to_fp 8 24) (concat (select ?x312 (_ bv7 32)) ?x325)) ((_ to_fp 8 24) (concat (select ?x312 (_ bv11 32)) ?x317)))))
(let ((?x330 (ite $x329 (_ bv1 32) (_ bv2 32))))
(let ((?x337 (concat (select ?x312 (bvadd (_ bv1 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x330))))) (select ?x312 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x330)))))))
(let ((?x340 (concat (select ?x312 (bvadd (_ bv2 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x330))))) ?x337)))
(let ((?x343 (concat (select ?x312 (bvadd (_ bv3 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x330))))) ?x340)))
(let ((?x346 (ite (fp.lt ((_ to_fp 8 24) (concat (select ?x312 (_ bv11 32)) ?x317)) ((_ to_fp 8 24) ?x343)) (_ bv2 32) ?x330)))
(not (bvult (bvmul (_ bv4 64) ((_ sign_extend 32) ?x346)) (_ bv37 64)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
