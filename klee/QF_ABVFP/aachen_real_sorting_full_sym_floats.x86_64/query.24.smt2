...
(let ((?x341 (concat (select ?x312 (_ bv10 32)) (concat (select ?x312 (_ bv9 32)) (select ?x312 (_ bv8 32))))))
(let ((?x349 (concat (select ?x312 (_ bv6 32)) (concat (select ?x312 (_ bv5 32)) (select ?x312 (_ bv4 32))))))
(let (($x353 (fp.lt ((_ to_fp 8 24) (concat (select ?x312 (_ bv7 32)) ?x349)) ((_ to_fp 8 24) (concat (select ?x312 (_ bv11 32)) ?x341)))))
(let ((?x354 (ite $x353 (_ bv1 32) (_ bv2 32))))
...
(let ((?x370 (ite (fp.lt ((_ to_fp 8 24) (concat (select ?x312 (_ bv11 32)) ?x341)) ((_ to_fp 8 24) ?x367)) (_ bv2 32) ?x354)))
...
(let ((?x333 (concat (select ?x312 (_ bv14 32)) (concat (select ?x312 (_ bv13 32)) (select ?x312 (_ bv12 32))))))
(let ((?x386 (ite (fp.lt ((_ to_fp 8 24) (concat (select ?x312 (_ bv15 32)) ?x333)) ((_ to_fp 8 24) ?x383)) (_ bv3 32) ?x370)))
...
(let ((?x325 (concat (select ?x312 (_ bv18 32)) (concat (select ?x312 (_ bv17 32)) (select ?x312 (_ bv16 32))))))
(let ((?x402 (ite (fp.lt ((_ to_fp 8 24) (concat (select ?x312 (_ bv19 32)) ?x325)) ((_ to_fp 8 24) ?x399)) (_ bv4 32) ?x386)))
...
(let ((?x317 (concat (select ?x312 (_ bv22 32)) (concat (select ?x312 (_ bv21 32)) (select ?x312 (_ bv20 32))))))
(let ((?x418 (ite (fp.lt ((_ to_fp 8 24) (concat (select ?x312 (_ bv23 32)) ?x317)) ((_ to_fp 8 24) ?x415)) (_ bv5 32) ?x402)))
(not (bvult (bvmul (_ bv4 64) ((_ sign_extend 32) ?x418)) (_ bv37 64))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
