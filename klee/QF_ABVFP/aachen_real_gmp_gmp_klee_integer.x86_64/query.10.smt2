...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_integer.x86_64/query.10.smt2
|)
...
(not (not (= (_ bv0 64) (ite (bvult ?x54 (_ bv64 64)) ?x431 (_ bv0 64))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
