...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_numerical_recipes_gaussj.x86_64/query.20.smt2
|)
...
(let ((?x63 (fp.abs ?x62)))
(not (and (not (fp.isNaN ?x63)) (not (fp.lt ?x63 ?x44))))))))))))))))))))
(check-sat)
(exit)
