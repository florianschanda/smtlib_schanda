...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_numerical_recipes_gaussj.x86_64/query.24.smt2
|)
...
(let ((?x51 (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven ((_ to_fp 8 24) (_ bv1065353216 32)) ?x49) ?x37)))
(let ((?x53 (fp.sub roundNearestTiesToEven ((_ to_fp 8 24) (_ bv1069547520 32)) (fp.mul roundNearestTiesToEven ((_ to_fp 8 24) (_ bv1048576000 32)) ?x51))))
(not (not (fp.eq ?x53 ((_ to_fp 8 24) (_ bv0 32))))))))))))
(check-sat)
(exit)
