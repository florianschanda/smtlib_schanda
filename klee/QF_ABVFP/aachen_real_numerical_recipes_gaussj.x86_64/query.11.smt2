...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_numerical_recipes_gaussj.x86_64/query.11.smt2
|)
...
(assert
 ...
 (let ((?x37 (fp.sub roundNearestTiesToEven ((_ to_fp 8 24) (_ bv0 32)) (fp.mul roundNearestTiesToEven ?x19 ((_ to_fp 8 24) (_ bv1056964608 32))))))
 (let ((?x38 (fp.abs ?x37)))
 (not (fp.lt ?x38 ((_ to_fp 8 24) (_ bv1069547520 32)))))))))
(assert
 (let ((?x15 (concat (select sym_f0 (_ bv2 32)) (concat (select sym_f0 (_ bv1 32)) (select sym_f0 (_ bv0 32))))))
(let ((?x19 ((_ to_fp 8 24) (concat (select sym_f0 (_ bv3 32)) ?x15))))
(let ((?x37 (fp.sub roundNearestTiesToEven ((_ to_fp 8 24) (_ bv0 32)) (fp.mul roundNearestTiesToEven ?x19 ((_ to_fp 8 24) (_ bv1056964608 32))))))
(let ((?x38 (fp.abs ?x37)))
(let ((?x50 (fp.sub roundNearestTiesToEven ((_ to_fp 8 24) (_ bv1079194419 32)) (fp.mul roundNearestTiesToEven ?x19 ((_ to_fp 8 24) (_ bv1048576000 32))))))
(let ((?x51 (fp.abs ?x50)))
(not (and (not (fp.isNaN ?x51)) (not (fp.lt ?x51 ?x38)))))))))))
(check-sat)
(exit)
