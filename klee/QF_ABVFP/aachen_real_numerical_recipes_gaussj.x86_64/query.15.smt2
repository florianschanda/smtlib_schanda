...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_numerical_recipes_gaussj.x86_64/query.15.smt2
|)
...
(not (not (fp.eq ?x50 ((_ to_fp 8 24) (_ bv0 32)))))))))
(check-sat)
(exit)
