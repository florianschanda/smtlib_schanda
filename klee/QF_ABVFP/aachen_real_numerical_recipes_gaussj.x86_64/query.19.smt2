...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_numerical_recipes_gaussj.x86_64/query.19.smt2
|)
...
(let ((?x54 (fp.abs ?x53)))
(not (and (not (fp.isNaN ?x54)) (not (fp.lt ?x54 ((_ to_fp 8 24) (_ bv0 32))))))))))))))
(check-sat)
(exit)
