...
(let ((?x112 ((_ extract 31 0) (bvmul (_ bv4 64) ?x109))))
(let ((?x119 (concat (select data0 (bvadd (_ bv2 32) ?x112)) (concat (select data0 (bvadd (_ bv1 32) ?x112)) (select data0 ?x112)))))
(let (($x125 (not (fp.eq ((_ to_fp 8 24) (concat (select data0 (bvadd (_ bv3 32) ?x112)) ?x119)) ?x94))))
(not $x125)))))))))))
(check-sat)
(exit)
