...
(let ((?x45 (concat (select data0 (_ bv10 32)) (concat (select data0 (_ bv9 32)) (select data0 (_ bv8 32))))))
(let ((?x49 ((_ to_fp 8 24) (concat (select data0 (_ bv11 32)) ?x45))))
(let (($x102 (fp.gt ?x49 ?x94)))
(let ((?x107 ((_ sign_extend 32) (bvsdiv (bvadd (ite $x102 (_ bv0 32) (_ bv2 32)) (ite $x102 (_ bv2 32) (_ bv5 32))) (_ bv2 32)))))
(let ((?x110 ((_ extract 31 0) (bvmul (_ bv4 64) ?x107))))
(let ((?x117 (concat (select data0 (bvadd (_ bv2 32) ?x110)) (concat (select data0 (bvadd (_ bv1 32) ?x110)) (select data0 ?x110)))))
(not (fp.eq ((_ to_fp 8 24) (concat (select data0 (bvadd (_ bv3 32) ?x110)) ?x117)) ?x94)))))))))))
(check-sat)
(exit)
