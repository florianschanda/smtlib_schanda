...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_differentiation_klee.x86_64/query.06.smt2
|)
...
(assert
 (not (not (= (_ bv1 32) (concat (_ bv0 31) ((_ extract 31 31) ((_ extract 63 32) fresh_to_ieee_bv_!0)))))))
(check-sat)
(exit)
