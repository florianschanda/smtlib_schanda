...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_differentiation_klee.x86_64/query.04.smt2
|)
...
(assert
 (not (not (bvslt ((_ extract 63 32) fresh_to_ieee_bv_!0) (_ bv0 32)))))
(check-sat)
(exit)
