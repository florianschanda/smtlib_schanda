...
(let ((?x362 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x359)))))
(let ((?x369 (concat (select data0 (bvadd (_ bv2 32) ?x362)) (concat (select data0 (bvadd (_ bv1 32) ?x362)) (select data0 ?x362)))))
(let (($x375 (not (fp.eq ((_ to_fp 8 24) (concat (select data0 (bvadd (_ bv3 32) ?x362)) ?x369)) ?x94))))
(not $x375)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
