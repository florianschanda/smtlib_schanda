...
(let ((?x207 (bvsdiv (bvadd (ite $x203 (ite $x184 ?x166 ?x169) ?x188) (ite $x203 ?x188 ?x186)) (_ bv2 32))))
(let ((?x210 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x207)))))
(let ((?x217 (concat (select data0 (bvadd (_ bv2 32) ?x210)) (concat (select data0 (bvadd (_ bv1 32) ?x210)) (select data0 ?x210)))))
(let (($x223 (not (fp.eq ((_ to_fp 8 24) (concat (select data0 (bvadd (_ bv3 32) ?x210)) ?x217)) ?x94))))
(not $x223)))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
