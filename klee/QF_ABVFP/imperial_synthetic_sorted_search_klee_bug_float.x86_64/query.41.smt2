...
(let ((?x191 ((_ extract 31 0) (bvmul (_ bv4 64) ?x189))))
(let ((?x198 (concat (select data0 (bvadd (_ bv2 32) ?x191)) (concat (select data0 (bvadd (_ bv1 32) ?x191)) (select data0 ?x191)))))
(let (($x204 (not (fp.eq ((_ to_fp 8 24) (concat (select data0 (bvadd (_ bv3 32) ?x191)) ?x198)) ?x94))))
(not $x204)))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
