...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1527.smt2
|)
...
(assert
 ...
 (let ((?x49 (concat (select x0 (_ bv13 32)) (concat (select x0 (_ bv12 32)) (concat (select x0 (_ bv11 32)) ?x40)))))
 (let ((?x56 ((_ to_fp 11 53) (concat (select x0 (_ bv15 32)) (concat (select x0 (_ bv14 32)) ?x49)))))
 (let ((?x161 (concat (select x0 (_ bv26 32)) (concat (select x0 (_ bv25 32)) (select x0 (_ bv24 32))))))
 (let ((?x170 (concat (select x0 (_ bv29 32)) (concat (select x0 (_ bv28 32)) (concat (select x0 (_ bv27 32)) ?x161)))))
 (let (($x178 (fp.lt ((_ to_fp 11 53) (concat (select x0 (_ bv31 32)) (concat (select x0 (_ bv30 32)) ?x170))) ?x56)))
 (not $x178))))))))
(assert
 (let ((?x161 (concat (select x0 (_ bv26 32)) (concat (select x0 (_ bv25 32)) (select x0 (_ bv24 32))))))
 (let ((?x170 (concat (select x0 (_ bv29 32)) (concat (select x0 (_ bv28 32)) (concat (select x0 (_ bv27 32)) ?x161)))))
 (let (($x180 (fp.isNaN ((_ to_fp 11 53) (concat (select x0 (_ bv31 32)) (concat (select x0 (_ bv30 32)) ?x170))))))
 (not $x180)))))
(assert
 (let ((?x15 (concat (select x0 (_ bv34 32)) (concat (select x0 (_ bv33 32)) (select x0 (_ bv32 32))))))
(let ((?x24 (concat (select x0 (_ bv37 32)) (concat (select x0 (_ bv36 32)) (concat (select x0 (_ bv35 32)) ?x15)))))
