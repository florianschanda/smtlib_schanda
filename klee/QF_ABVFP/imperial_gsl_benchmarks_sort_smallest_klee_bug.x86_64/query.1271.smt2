...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee_bug.x86_64/query.1271.smt2
|)
...
(not (not (and (not $x167) (or $x167 (fp.gt ?x31 ?x166)))))))))))))
(check-sat)
(exit)
