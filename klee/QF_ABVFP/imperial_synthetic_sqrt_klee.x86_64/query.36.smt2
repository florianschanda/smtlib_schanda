...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee.x86_64/query.36.smt2
|)
...
(assert
 ...
 (let ((?x117 (ite $x111 ?x103 ?x105)))
 (let ((?x101 (ite $x97 fresh_to_ieee_bv_!4 ?x87)))
 (let ((?x115 (ite $x111 fresh_to_ieee_bv_!5 ?x101)))
 (let ((?x119 (fp.mul roundNearestTiesToEven (fp.add roundNearestTiesToEven ((_ to_fp 8 24) ?x115) ?x117) ?x32)))
 (let ((?x120 (fp.mul roundNearestTiesToEven ?x119 ?x119)))
 (not (fp.lt (fp.abs (fp.sub roundNearestTiesToEven ?x120 ?x19)) ?x38))))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x32 ((_ to_fp 8 24) (_ bv1056964608 32))))
 (let ((?x22 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x15 (concat (select x0 (_ bv2 32)) (concat (select x0 (_ bv1 32)) (select x0 (_ bv0 32))))))
...
(assert
 ...
 (let ((?x115 (ite $x111 fresh_to_ieee_bv_!5 ?x101)))
 (let ((?x119 (fp.mul roundNearestTiesToEven (fp.add roundNearestTiesToEven ((_ to_fp 8 24) ?x115) ?x117) ?x32)))
 (= ?x119 ((_ to_fp 8 24) fresh_to_ieee_bv_!6))))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x15 (concat (select x0 (_ bv2 32)) (concat (select x0 (_ bv1 32)) (select x0 (_ bv0 32))))))
(let ((?x18 (concat (select x0 (_ bv3 32)) ?x15)))
(let ((?x19 ((_ to_fp 8 24) ?x18)))
...
(let (($x111 (fp.gt ?x106 ?x19)))
(let ((?x115 (ite $x111 fresh_to_ieee_bv_!5 ?x101)))
(let ((?x119 (fp.mul roundNearestTiesToEven (fp.add roundNearestTiesToEven ((_ to_fp 8 24) ?x115) (ite $x111 ?x103 ?x105)) ?x32)))
(let ((?x120 (fp.mul roundNearestTiesToEven ?x119 ?x119)))
(let (($x125 (fp.gt ?x120 ?x19)))
(let (($x132 (fp.eq (ite $x125 (ite $x111 ?x103 ?x105) ?x119) ((_ to_fp 8 24) (ite $x125 fresh_to_ieee_bv_!6 ?x115)))))
(not (not $x132)))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
