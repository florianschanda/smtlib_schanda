...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee.x86_64/query.27.smt2
|)
...
(let (($x104 (fp.eq (ite $x97 (ite $x83 ?x75 ?x77) ?x91) ((_ to_fp 8 24) (ite $x97 fresh_to_ieee_bv_!4 ?x87)))))
(not (not $x104)))))))))))))))))))))))))))))))
(check-sat)
(exit)
