...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee.x86_64/query.30.smt2
|)
...
(let ((?x107 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x105 ?x105) ?x19)))
(not (not (fp.lt (fp.abs ?x107) ?x38))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
