...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee.x86_64/query.37.smt2
|)
...
(assert
 ...
 (not (fp.lt (fp.abs (fp.sub roundNearestTiesToEven ?x92 ?x19)) ?x38)))))))))))))))))))))))))))))))))
(assert
 (let ((?x38 ((_ to_fp 8 24) (_ bv869711765 32))))
 (let ((?x15 (concat (select x0 (_ bv2 32)) (concat (select x0 (_ bv1 32)) (select x0 (_ bv0 32))))))
 (let ((?x18 (concat (select x0 (_ bv3 32)) ?x15)))
 ...
 (let ((?x106 (fp.mul roundNearestTiesToEven ?x105 ?x105)))
 (not (fp.lt (fp.abs (fp.sub roundNearestTiesToEven ?x106 ?x19)) ?x38))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x38 ((_ to_fp 8 24) (_ bv869711765 32))))
 (let ((?x15 (concat (select x0 (_ bv2 32)) (concat (select x0 (_ bv1 32)) (select x0 (_ bv0 32))))))
 (let ((?x18 (concat (select x0 (_ bv3 32)) ?x15)))
 ...
 (let ((?x105 (fp.mul roundNearestTiesToEven ?x104 ?x32)))
 (let ((?x106 (fp.mul roundNearestTiesToEven ?x105 ?x105)))
 (let (($x111 (fp.gt ?x106 ?x19)))
 (let ((?x116 ((_ to_fp 8 24) (ite $x111 fresh_to_ieee_bv_!5 (ite $x97 fresh_to_ieee_bv_!4 ?x87)))))
 (let ((?x119 (fp.mul roundNearestTiesToEven (fp.add roundNearestTiesToEven ?x116 (ite $x111 ?x103 ?x105)) ?x32)))
 (let ((?x121 (fp.sub roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x119 ?x119) ?x19)))
 (fp.lt (fp.abs ?x121) ?x38)))))))))))))))))))))))))))))))))))))))))
(assert
 (let ((?x32 ((_ to_fp 8 24) (_ bv1056964608 32))))
 (let ((?x22 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x15 (concat (select x0 (_ bv2 32)) (concat (select x0 (_ bv1 32)) (select x0 (_ bv0 32))))))
...
(let ((?x116 ((_ to_fp 8 24) (ite $x111 fresh_to_ieee_bv_!5 (ite $x97 fresh_to_ieee_bv_!4 ?x87)))))
(let ((?x119 (fp.mul roundNearestTiesToEven (fp.add roundNearestTiesToEven ?x116 (ite $x111 ?x103 ?x105)) ?x32)))
(not (and (not (fp.isNaN ?x119)) (not (fp.gt ?x119 ?x19))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
