...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_sin_interpolated_bigrange_tight.x86_64/query.00.smt2
|)
...
(let (($x38 (and (fp.geq ((_ to_fp 11 53) ?x30) ((_ to_fp 11 53) (_ bv13979912523730649088 64))) (fp.leq ((_ to_fp 11 53) ?x30) ((_ to_fp 11 53) (_ bv4756540486875873280 64))))))
(not (not $x38))))))))
(check-sat)
(exit)
