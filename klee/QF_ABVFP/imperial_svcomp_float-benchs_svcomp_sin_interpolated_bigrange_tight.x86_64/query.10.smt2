...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_sin_interpolated_bigrange_tight.x86_64/query.10.smt2
|)
...
(not (bvult (bvmul (_ bv8 64) ((_ sign_extend 32) (bvadd (_ bv1 32) ?x51))) (_ bv2889 64))))))))))
(check-sat)
(exit)
