...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_syn_sqr_double-flow.x86_64/query.1.smt2
|)
...
(not (not (fp.eq ?x36 ((_ to_fp 11 53) (_ bv9218868437227405312 64))))))))))
(check-sat)
(exit)
