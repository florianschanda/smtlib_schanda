...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_syn_nan_longdouble.x86_64/query.02.smt2
|)
...
(let ((?x36 (concat (select f0 (_ bv9 32)) ?x33)))
(let ((?x43 ((_ to_fp 15 64) (concat (concat ((_ extract 79 79) ?x36) ((_ extract 78 64) ?x36)) ((_ extract 62 0) ?x36)))))
(not (not (not (fp.isNaN (fp.add roundNearestTiesToEven ?x43 ?x76)))))))))))))
(check-sat)
(exit)
