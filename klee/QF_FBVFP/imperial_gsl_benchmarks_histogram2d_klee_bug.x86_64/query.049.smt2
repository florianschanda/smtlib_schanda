...
(assert
 ...
 (let ((?x675 (store (store (store (store ?x668 (_ bv312 32) (_ bv0 8)) (_ bv313 32) (_ bv0 8)) (_ bv314 32) (_ bv0 8)) (_ bv315 32) (_ bv0 8))))
...
(let ((?x1714 (concat (select ?x1709 (_ bv314 32)) (concat (select ?x1709 (_ bv313 32)) (select ?x1709 (_ bv312 32))))))
(let ((?x1720 (concat (select ?x1709 (_ bv317 32)) (concat (select ?x1709 (_ bv316 32)) (concat (select ?x1709 (_ bv315 32)) ?x1714)))))
(let (($x1726 (fp.lt ((_ to_fp 11 53) (concat (select ?x1709 (_ bv319 32)) (concat (select ?x1709 (_ bv318 32)) ?x1720))) ((_ to_fp 11 53) (_ bv0 64)))))
(not (not $x1726))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
