...
(assert
 ...
 (let ((?x963 (store (store (store (store ?x956 (_ bv456 32) (_ bv0 8)) (_ bv457 32) (_ bv0 8)) (_ bv458 32) (_ bv0 8)) (_ bv459 32) (_ bv0 8))))
...
(let ((?x1714 (concat (select ?x1709 (_ bv458 32)) (concat (select ?x1709 (_ bv457 32)) (select ?x1709 (_ bv456 32))))))
(let ((?x1720 (concat (select ?x1709 (_ bv461 32)) (concat (select ?x1709 (_ bv460 32)) (concat (select ?x1709 (_ bv459 32)) ?x1714)))))
(let (($x1726 (fp.lt ((_ to_fp 11 53) (concat (select ?x1709 (_ bv463 32)) (concat (select ?x1709 (_ bv462 32)) ?x1720))) ((_ to_fp 11 53) (_ bv0 64)))))
(not (not $x1726))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
