...
(assert
 ...
 (let ((?x387 (store (store (store (store ?x380 (_ bv168 32) (_ bv0 8)) (_ bv169 32) (_ bv0 8)) (_ bv170 32) (_ bv0 8)) (_ bv171 32) (_ bv0 8))))
...
(let ((?x1714 (concat (select ?x1709 (_ bv170 32)) (concat (select ?x1709 (_ bv169 32)) (select ?x1709 (_ bv168 32))))))
(let ((?x1720 (concat (select ?x1709 (_ bv173 32)) (concat (select ?x1709 (_ bv172 32)) (concat (select ?x1709 (_ bv171 32)) ?x1714)))))
(let (($x1726 (fp.lt ((_ to_fp 11 53) (concat (select ?x1709 (_ bv175 32)) (concat (select ?x1709 (_ bv174 32)) ?x1720))) ((_ to_fp 11 53) (_ bv0 64)))))
(not (not $x1726))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
