...
(assert
 ...
 (let ((?x995 (store (store (store (store ?x988 (_ bv472 32) (_ bv0 8)) (_ bv473 32) (_ bv0 8)) (_ bv474 32) (_ bv0 8)) (_ bv475 32) (_ bv0 8))))
...
(let ((?x1714 (concat (select ?x1709 (_ bv474 32)) (concat (select ?x1709 (_ bv473 32)) (select ?x1709 (_ bv472 32))))))
(let ((?x1720 (concat (select ?x1709 (_ bv477 32)) (concat (select ?x1709 (_ bv476 32)) (concat (select ?x1709 (_ bv475 32)) ?x1714)))))
(let (($x1726 (fp.lt ((_ to_fp 11 53) (concat (select ?x1709 (_ bv479 32)) (concat (select ?x1709 (_ bv478 32)) ?x1720))) ((_ to_fp 11 53) (_ bv0 64)))))
(not (not $x1726))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
