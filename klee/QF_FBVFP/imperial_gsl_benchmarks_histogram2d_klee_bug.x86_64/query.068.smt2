...
(assert
 ...
 (let ((?x979 (store (store (store (store ?x972 (_ bv464 32) (_ bv0 8)) (_ bv465 32) (_ bv0 8)) (_ bv466 32) (_ bv0 8)) (_ bv467 32) (_ bv0 8))))
...
(let ((?x1714 (concat (select ?x1709 (_ bv466 32)) (concat (select ?x1709 (_ bv465 32)) (select ?x1709 (_ bv464 32))))))
(let ((?x1720 (concat (select ?x1709 (_ bv469 32)) (concat (select ?x1709 (_ bv468 32)) (concat (select ?x1709 (_ bv467 32)) ?x1714)))))
(let (($x1726 (fp.lt ((_ to_fp 11 53) (concat (select ?x1709 (_ bv471 32)) (concat (select ?x1709 (_ bv470 32)) ?x1720))) ((_ to_fp 11 53) (_ bv0 64)))))
(not (not $x1726))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
