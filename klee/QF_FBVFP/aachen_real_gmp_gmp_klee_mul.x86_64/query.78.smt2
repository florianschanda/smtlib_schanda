...
(declare-fun const_arr34 () (Array (_ BitVec 32) (_ BitVec 8)))
(assert
...
(let ((?x1779 (store (store (store (store const_arr34 (_ bv0 32) (_ bv0 8)) (_ bv1 32) (_ bv0 8)) (_ bv2 32) (_ bv0 8)) (_ bv3 32) (_ bv0 8))))
(let ((?x1783 (store (store (store (store ?x1779 (_ bv4 32) (_ bv0 8)) (_ bv5 32) (_ bv0 8)) (_ bv6 32) (_ bv0 8)) (_ bv7 32) (_ bv0 8))))
(let ((?x1788 (store (store (store (store ?x1783 (_ bv8 32) (_ bv1 8)) (_ bv9 32) (_ bv0 8)) (_ bv10 32) (_ bv0 8)) (_ bv11 32) (_ bv0 8))))
...
(let (($x1860 (bvslt (_ bv0 32) (ite (bvslt (_ bv0 32) (ite $x1847 (_ bv1 32) (_ bv4294967295 32))) ?x1857 (bvsub (_ bv0 32) ?x1857)))))
(not $x1860))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
