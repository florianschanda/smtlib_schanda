...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mul.x86_64/query.28.smt2
|)
...
(let ((?x49 (concat (select d21 (_ bv5 32)) (concat (select d21 (_ bv4 32)) (concat (select d21 (_ bv3 32)) ?x43)))))
(let ((?x54 ((_ to_fp 11 53) (concat (select d21 (_ bv7 32)) (concat (select d21 (_ bv6 32)) ?x49)))))
(let ((?x68 (ite (fp.lt ?x54 ((_ to_fp 11 53) (_ bv0 64))) (_ bv4294967294 32) (_ bv2 32))))
...
(let (($x73 (= (ite (bvslt (_ bv4294967295 32) ?x62) ?x64 (bvsub (_ bv0 64) ?x64)) (ite (bvslt (_ bv4294967295 32) ?x68) ?x70 (bvsub (_ bv0 64) ?x70)))))
(not $x73)))))))))))))
(check-sat)
(exit)
