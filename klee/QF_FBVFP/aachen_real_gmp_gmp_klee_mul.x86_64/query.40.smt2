...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_mul.x86_64/query.40.smt2
|)
...
(let ((?x50 (bvmul (_ bv8 64) (ite (bvslt (_ bv4294967295 32) ?x44) ?x46 (bvsub (_ bv0 64) ?x46)))))
(not (or (bvule (bvadd (_ bv44001640 64) ?x50) (_ bv45268640 64)) (bvule (bvadd (_ bv45268640 64) ?x50) (_ bv44001640 64)))))))))))
(check-sat)
(exit)
