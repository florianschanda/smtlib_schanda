...
(let ((?x383 (concat (select ?x362 (_ bv6 32)) (concat (select ?x362 (_ bv5 32)) (select ?x362 (_ bv4 32))))))
(let (($x387 (fp.lt ((_ to_fp 8 24) (concat (select ?x362 (_ bv7 32)) ?x383)) ((_ to_fp 8 24) (concat (select ?x362 (_ bv11 32)) ?x375)))))
(let ((?x388 (ite $x387 (_ bv1 32) (_ bv2 32))))
(let ((?x395 (concat (select ?x362 (bvadd (_ bv1 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x388))))) (select ?x362 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x388)))))))
(let ((?x398 (concat (select ?x362 (bvadd (_ bv2 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x388))))) ?x395)))
(let ((?x401 (concat (select ?x362 (bvadd (_ bv3 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x388))))) ?x398)))
(let ((?x404 (ite (fp.lt ((_ to_fp 8 24) (concat (select ?x362 (_ bv11 32)) ?x375)) ((_ to_fp 8 24) ?x401)) (_ bv2 32) ?x388)))
(let ((?x411 (concat (select ?x362 (bvadd (_ bv1 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x404))))) (select ?x362 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x404)))))))
(let ((?x414 (concat (select ?x362 (bvadd (_ bv2 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x404))))) ?x411)))
(let ((?x417 (concat (select ?x362 (bvadd (_ bv3 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x404))))) ?x414)))
(let ((?x367 (concat (select ?x362 (_ bv14 32)) (concat (select ?x362 (_ bv13 32)) (select ?x362 (_ bv12 32))))))
(let ((?x420 (ite (fp.lt ((_ to_fp 8 24) (concat (select ?x362 (_ bv15 32)) ?x367)) ((_ to_fp 8 24) ?x417)) (_ bv3 32) ?x404)))
(not (bvult (bvmul (_ bv4 64) ((_ sign_extend 32) ?x420)) (_ bv37 64))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
