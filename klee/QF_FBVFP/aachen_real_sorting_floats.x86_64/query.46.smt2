...
(let ((?x1103 (concat (select ?x1098 (_ bv26 32)) (concat (select ?x1098 (_ bv25 32)) (select ?x1098 (_ bv24 32))))))
(let ((?x1111 (concat (select ?x1098 (_ bv22 32)) (concat (select ?x1098 (_ bv21 32)) (select ?x1098 (_ bv20 32))))))
(let (($x1115 (fp.lt ((_ to_fp 8 24) (concat (select ?x1098 (_ bv23 32)) ?x1111)) ((_ to_fp 8 24) (concat (select ?x1098 (_ bv27 32)) ?x1103)))))
(let ((?x1116 (ite $x1115 (_ bv5 32) (_ bv6 32))))
(let ((?x1123 (concat (select ?x1098 (bvadd (_ bv1 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1116))))) (select ?x1098 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1116)))))))
(let ((?x1126 (concat (select ?x1098 (bvadd (_ bv2 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1116))))) ?x1123)))
(let ((?x1129 (concat (select ?x1098 (bvadd (_ bv3 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1116))))) ?x1126)))
(let ((?x1132 (ite (fp.lt ((_ to_fp 8 24) (concat (select ?x1098 (_ bv27 32)) ?x1103)) ((_ to_fp 8 24) ?x1129)) (_ bv6 32) ?x1116)))
(not (bvult (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1132)) (_ bv37 64)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
