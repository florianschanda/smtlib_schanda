...
(let ((?x1243 (concat (select ?x1222 (_ bv26 32)) (concat (select ?x1222 (_ bv25 32)) (select ?x1222 (_ bv24 32))))))
(let (($x1247 (fp.lt ((_ to_fp 8 24) (concat (select ?x1222 (_ bv27 32)) ?x1243)) ((_ to_fp 8 24) (concat (select ?x1222 (_ bv31 32)) ?x1235)))))
(let ((?x1248 (ite $x1247 (_ bv6 32) (_ bv7 32))))
(let ((?x1255 (concat (select ?x1222 (bvadd (_ bv1 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1248))))) (select ?x1222 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1248)))))))
(let ((?x1258 (concat (select ?x1222 (bvadd (_ bv2 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1248))))) ?x1255)))
(let ((?x1261 (concat (select ?x1222 (bvadd (_ bv3 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1248))))) ?x1258)))
(let ((?x1264 (ite (fp.lt ((_ to_fp 8 24) (concat (select ?x1222 (_ bv31 32)) ?x1235)) ((_ to_fp 8 24) ?x1261)) (_ bv7 32) ?x1248)))
(let ((?x1271 (concat (select ?x1222 (bvadd (_ bv1 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1264))))) (select ?x1222 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1264)))))))
(let ((?x1274 (concat (select ?x1222 (bvadd (_ bv2 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1264))))) ?x1271)))
(let ((?x1277 (concat (select ?x1222 (bvadd (_ bv3 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1264))))) ?x1274)))
(let ((?x1227 (concat (select ?x1222 (_ bv34 32)) (concat (select ?x1222 (_ bv33 32)) (select ?x1222 (_ bv32 32))))))
(let ((?x1280 (ite (fp.lt ((_ to_fp 8 24) (concat (select ?x1222 (_ bv35 32)) ?x1227)) ((_ to_fp 8 24) ?x1277)) (_ bv8 32) ?x1264)))
(not (bvult (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1280)) (_ bv37 64)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
