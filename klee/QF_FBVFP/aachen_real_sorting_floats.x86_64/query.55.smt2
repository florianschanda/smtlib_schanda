...
(let ((?x1327 (concat (select ?x1322 (_ bv34 32)) (concat (select ?x1322 (_ bv33 32)) (select ?x1322 (_ bv32 32))))))
(let ((?x1335 (concat (select ?x1322 (_ bv30 32)) (concat (select ?x1322 (_ bv29 32)) (select ?x1322 (_ bv28 32))))))
(let (($x1339 (fp.lt ((_ to_fp 8 24) (concat (select ?x1322 (_ bv31 32)) ?x1335)) ((_ to_fp 8 24) (concat (select ?x1322 (_ bv35 32)) ?x1327)))))
(let ((?x1340 (ite $x1339 (_ bv7 32) (_ bv8 32))))
(let ((?x1347 (concat (select ?x1322 (bvadd (_ bv1 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1340))))) (select ?x1322 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1340)))))))
(let ((?x1350 (concat (select ?x1322 (bvadd (_ bv2 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1340))))) ?x1347)))
(let ((?x1353 (concat (select ?x1322 (bvadd (_ bv3 32) ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1340))))) ?x1350)))
(let ((?x1356 (ite (fp.lt ((_ to_fp 8 24) (concat (select ?x1322 (_ bv35 32)) ?x1327)) ((_ to_fp 8 24) ?x1353)) (_ bv8 32) ?x1340)))
(not (bvult (bvmul (_ bv4 64) ((_ sign_extend 32) ?x1356)) (_ bv37 64))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
