...
(let ((?x124 (ite $x123 ?x104 ?x107)))
(let ((?x145 (ite $x144 ?x124 ?x127)))
(let ((?x153 ((_ extract 31 0) (bvmul (_ bv4 64) ((_ sign_extend 32) (bvsdiv (bvadd ?x145 ?x146) (_ bv2 32)))))))
(let ((?x160 (concat (select data0 (bvadd (_ bv2 32) ?x153)) (concat (select data0 (bvadd (_ bv1 32) ?x153)) (select data0 ?x153)))))
(let (($x166 (not (fp.eq ((_ to_fp 8 24) (concat (select data0 (bvadd (_ bv3 32) ?x153)) ?x160)) ?x94))))
(not $x166))))))))))))))))))))))))))
(check-sat)
(exit)
