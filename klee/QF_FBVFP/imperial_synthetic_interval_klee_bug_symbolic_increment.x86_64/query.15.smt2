...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_interval_klee_bug_symbolic_increment.x86_64/query.15.smt2
|)
...
(assert
 (let ((?x27 (concat (select increment1 (_ bv2 32)) (concat (select increment1 (_ bv1 32)) (select increment1 (_ bv0 32))))))
 (let ((?x30 ((_ to_fp 8 24) (concat (select increment1 (_ bv3 32)) ?x27))))
 (let ((?x50 ((_ to_fp 11 53) roundNearestTiesToEven ?x30)))
 (let ((?x15 (concat (select initial0 (_ bv2 32)) (concat (select initial0 (_ bv1 32)) (select initial0 (_ bv0 32))))))
 (let ((?x19 ((_ to_fp 8 24) (concat (select initial0 (_ bv3 32)) ?x15))))
 (let ((?x51 (fp.add roundNearestTiesToEven ((_ to_fp 11 53) roundNearestTiesToEven ?x19) ?x50)))
 (fp.geq ((_ to_fp 11 53) roundNearestTiesToEven (fp.add roundTowardNegative ?x19 ?x30)) ?x51))))))))
(assert
 (let ((?x27 (concat (select increment1 (_ bv2 32)) (concat (select increment1 (_ bv1 32)) (select increment1 (_ bv0 32))))))
(let ((?x30 ((_ to_fp 8 24) (concat (select increment1 (_ bv3 32)) ?x27))))
(let ((?x50 ((_ to_fp 11 53) roundNearestTiesToEven ?x30)))
...
(let ((?x19 ((_ to_fp 8 24) (concat (select initial0 (_ bv3 32)) ?x15))))
(let ((?x51 (fp.add roundNearestTiesToEven ((_ to_fp 11 53) roundNearestTiesToEven ?x19) ?x50)))
(not (not (fp.isNaN (fp.add roundNearestTiesToEven ?x51 ?x50)))))))))))
(check-sat)
(exit)
