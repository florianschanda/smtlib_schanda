...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_statistics_klee_bug.x86_64/query.08.smt2
|)
...
(let (($x99 (fp.lt ((_ to_fp 11 53) (ite (fp.lt ((_ to_fp 11 53) (_ bv4623282787467866931 64)) ((_ to_fp 11 53) ?x93)) (_ bv4623282787467866931 64) ?x93)) ((_ to_fp 11 53) (_ bv4621819117588971520 64)))))
(let (($x100 (or (fp.isNaN ((_ to_fp 11 53) (ite (fp.lt ((_ to_fp 11 53) (_ bv4623282787467866931 64)) ((_ to_fp 11 53) ?x93)) (_ bv4623282787467866931 64) ?x93))) $x99)))
(not $x100)))))))))))))
(check-sat)
(exit)
