...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_statistics_klee_bug.x86_64/query.06.smt2
|)
...
(let (($x84 (fp.lt ((_ to_fp 11 53) (ite (fp.gt ((_ to_fp 11 53) (_ bv4623282787467866931 64)) ((_ to_fp 11 53) ?x77)) (_ bv4623282787467866931 64) ?x77)) ((_ to_fp 11 53) (_ bv4621819117588971520 64)))))
