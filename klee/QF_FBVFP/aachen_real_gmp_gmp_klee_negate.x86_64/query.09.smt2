...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_negate.x86_64/query.09.smt2
|)
...
(not (not (bvslt (ite (bvslt (_ bv4294967295 32) ?x46) ?x48 (bvsub (_ bv0 64) ?x48)) (_ bv0 64))))))))))
(check-sat)
(exit)
