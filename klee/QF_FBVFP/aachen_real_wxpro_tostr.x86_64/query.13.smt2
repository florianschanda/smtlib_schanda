...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.13.smt2
|)
...
(let ((?x44 (bvudiv ((_ extract 31 0) ?x41) (_ bv10 32))))
(let ((?x51 (bvudiv ?x44 (_ bv10 32))))
(not (not (= (_ bv45 8) ((_ extract 7 0) (bvadd (_ bv48 32) (bvurem ?x51 (_ bv10 32))))))))))))))
(check-sat)
(exit)
