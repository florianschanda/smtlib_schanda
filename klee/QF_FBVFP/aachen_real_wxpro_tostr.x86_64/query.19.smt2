...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.19.smt2
|)
...
(let ((?x38 (fp.abs ?x31)))
(let ((?x40 ((_ fp.to_sbv 32) roundTowardZero ?x38)))
(let ((?x57 (fp.sub roundNearestTiesToEven ?x38 ((_ to_fp 11 53) roundNearestTiesToEven ?x40))))
(let ((?x63 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x57 ((_ to_fp 11 53) (_ bv4636737291354636288 64))) ((_ to_fp 11 53) (_ bv4633641066610819072 64)))))
(let ((?x65 ((_ fp.to_sbv 32) roundTowardZero (fp.div roundNearestTiesToEven ?x63 ((_ to_fp 11 53) (_ bv4636737291354636288 64))))))
(not (not (bvult (_ bv9223372036854775807 64) ((_ sign_extend 32) ?x65)))))))))))))
(check-sat)
(exit)
