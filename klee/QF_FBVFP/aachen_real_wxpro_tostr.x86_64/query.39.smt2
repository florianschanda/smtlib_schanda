...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.39.smt2
|)
...
(not (not (bvult (_ bv9223372036854775807 64) ((_ sign_extend 32) ?x68)))))))))))))
(check-sat)
(exit)
