...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.33.smt2
|)
...
(let ((?x67 ((_ sign_extend 32) ?x66)))
(let ((?x69 (bvudiv ((_ extract 31 0) ?x67) (_ bv10 32))))
(not (bvult (bvurem ?x69 (_ bv10 32)) (_ bv10 32))))))))))))))
(check-sat)
(exit)
