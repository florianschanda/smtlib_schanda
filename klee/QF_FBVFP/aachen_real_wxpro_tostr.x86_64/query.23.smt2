...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_wxpro_tostr.x86_64/query.23.smt2
|)
...
(let ((?x65 ((_ sign_extend 32) ?x64)))
(let ((?x67 (bvudiv ((_ extract 31 0) ?x65) (_ bv10 32))))
(not (bvult (bvurem ?x67 (_ bv10 32)) (_ bv10 32))))))))))))))
(check-sat)
(exit)
