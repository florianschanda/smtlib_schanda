...
(let ((?x52 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) (_ bv4614162998222441677 64)) (fp.mul roundNearestTiesToEven ?x46 ?x46))))
(not (or (fp.isNaN ?x46) (fp.geq ?x52 ((_ to_fp 11 53) (_ bv0 64))))))))))))))
(check-sat)
(exit)
