...
(assert
 (let ((?x1647 (concat (concat ((_ extract 79 79) (concat (_ bv16396 16) (_ bv11258999068426240000 64))) ((_ extract 78 64) (concat (_ bv16396 16) (_ bv11258999068426240000 64)))) ((_ extract 62 0) (concat (_ bv16396 16) (_ bv11258999068426240000 64))))))
 (let ((?x1648 ((_ to_fp 15 64) ?x1647)))
 (= ((_ extract 63 63) (concat (_ bv16396 16) (_ bv11258999068426240000 64))) (ite (or (fp.isSubnormal ?x1648) (fp.isZero ?x1648)) (_ bv0 1) (_ bv1 1))))))
(assert
 (let ((?x1663 (concat (concat ((_ extract 79 79) (concat (_ bv16385 16) (_ bv9223372036854775808 64))) ((_ extract 78 64) (concat (_ bv16385 16) (_ bv9223372036854775808 64)))) ((_ extract 62 0) (concat (_ bv16385 16) (_ bv9223372036854775808 64))))))
 (let ((?x1664 ((_ to_fp 15 64) ?x1663)))
 (= ((_ extract 63 63) (concat (_ bv16385 16) (_ bv9223372036854775808 64))) (ite (or (fp.isSubnormal ?x1664) (fp.isZero ?x1664)) (_ bv0 1) (_ bv1 1))))))
(assert
 (let ((?x1663 (concat (concat ((_ extract 79 79) (concat (_ bv16385 16) (_ bv9223372036854775808 64))) ((_ extract 78 64) (concat (_ bv16385 16) (_ bv9223372036854775808 64)))) ((_ extract 62 0) (concat (_ bv16385 16) (_ bv9223372036854775808 64))))))
(let ((?x1664 ((_ to_fp 15 64) ?x1663)))
(let ((?x1647 (concat (concat ((_ extract 79 79) (concat (_ bv16396 16) (_ bv11258999068426240000 64))) ((_ extract 78 64) (concat (_ bv16396 16) (_ bv11258999068426240000 64)))) ((_ extract 62 0) (concat (_ bv16396 16) (_ bv11258999068426240000 64))))))
...
(let ((?x1593 (concat (concat ((_ extract 79 79) (concat (_ bv0 16) (_ bv0 64))) ((_ extract 78 64) (concat (_ bv0 16) (_ bv0 64)))) ((_ extract 62 0) (concat (_ bv0 16) (_ bv0 64))))))
(let ((?x1594 ((_ to_fp 15 64) ?x1593)))
(let ((?x1623 (fp.mul roundNearestTiesToEven (fp.add roundNearestTiesToEven ?x1594 ?x1604) ?x1616)))
(let ((?x1657 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven ?x1623 ?x1632) ?x1648)))
(not (not (fp.eq ?x1657 (fp.div roundNearestTiesToEven ?x1657 ?x1664))))))))))))))))))
(check-sat)
(exit)
