...
(assert
 (let ((?x1615 (concat (concat ((_ extract 79 79) (concat (_ bv16396 16) (_ bv11258999068426240000 64))) ((_ extract 78 64) (concat (_ bv16396 16) (_ bv11258999068426240000 64)))) ((_ extract 62 0) (concat (_ bv16396 16) (_ bv11258999068426240000 64))))))
 (let ((?x1616 ((_ to_fp 15 64) ?x1615)))
 (= ((_ extract 63 63) (concat (_ bv16396 16) (_ bv11258999068426240000 64))) (ite (or (fp.isSubnormal ?x1616) (fp.isZero ?x1616)) (_ bv0 1) (_ bv1 1))))))
(assert
 (let ((?x1631 (concat (concat ((_ extract 79 79) (concat (_ bv16385 16) (_ bv9223372036854775808 64))) ((_ extract 78 64) (concat (_ bv16385 16) (_ bv9223372036854775808 64)))) ((_ extract 62 0) (concat (_ bv16385 16) (_ bv9223372036854775808 64))))))
 (let ((?x1632 ((_ to_fp 15 64) ?x1631)))
 (= ((_ extract 63 63) (concat (_ bv16385 16) (_ bv9223372036854775808 64))) (ite (or (fp.isSubnormal ?x1632) (fp.isZero ?x1632)) (_ bv0 1) (_ bv1 1))))))
(assert
 (let ((?x1631 (concat (concat ((_ extract 79 79) (concat (_ bv16385 16) (_ bv9223372036854775808 64))) ((_ extract 78 64) (concat (_ bv16385 16) (_ bv9223372036854775808 64)))) ((_ extract 62 0) (concat (_ bv16385 16) (_ bv9223372036854775808 64))))))
(let ((?x1632 ((_ to_fp 15 64) ?x1631)))
(let ((?x1615 (concat (concat ((_ extract 79 79) (concat (_ bv16396 16) (_ bv11258999068426240000 64))) ((_ extract 78 64) (concat (_ bv16396 16) (_ bv11258999068426240000 64)))) ((_ extract 62 0) (concat (_ bv16396 16) (_ bv11258999068426240000 64))))))
...
(let ((?x1593 (concat (concat ((_ extract 79 79) (concat (_ bv0 16) (_ bv0 64))) ((_ extract 78 64) (concat (_ bv0 16) (_ bv0 64)))) ((_ extract 62 0) (concat (_ bv0 16) (_ bv0 64))))))
(let ((?x1594 ((_ to_fp 15 64) ?x1593)))
(let ((?x1625 (fp.mul roundNearestTiesToEven (fp.add roundNearestTiesToEven ?x1594 ?x1604) ?x1616)))
(not (not (fp.eq ?x1625 (fp.div roundNearestTiesToEven ?x1625 ?x1632)))))))))))))
(check-sat)
(exit)
