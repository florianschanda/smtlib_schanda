...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_syn_ld-add_default.x86_64/query.1.smt2
|)
...
(assert
 ...
 (let ((?x24 (concat (select b0 (_ bv5 32)) (concat (select b0 (_ bv4 32)) (concat (select b0 (_ bv3 32)) ?x15)))))
 (let ((?x33 (concat (select b0 (_ bv8 32)) (concat (select b0 (_ bv7 32)) (concat (select b0 (_ bv6 32)) ?x24)))))
 (let ((?x36 (concat (select b0 (_ bv9 32)) ?x33)))
