...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_syn_inf_float.x86_64/query.33.smt2
|)
...
(let ((?x36 (fp.add roundNearestTiesToEven ?x33 ((_ to_fp 8 24) (_ bv4286578687 32)))))
