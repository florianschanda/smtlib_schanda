...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_syn_inf_float.x86_64/query.22.smt2
|)
...
(not (fp.isNaN (fp.sub roundNearestTiesToEven ?x30 ?x30)))))))))
(check-sat)
(exit)
