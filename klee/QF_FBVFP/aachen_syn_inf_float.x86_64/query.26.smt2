...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_syn_inf_float.x86_64/query.26.smt2
|)
...
(not (fp.gt ?x33 ((_ to_fp 8 24) (_ bv2139095039 32))))))))))
(check-sat)
(exit)
