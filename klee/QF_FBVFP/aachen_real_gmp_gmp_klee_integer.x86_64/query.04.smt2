...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_gmp_gmp_klee_integer.x86_64/query.04.smt2
|)
...
(let ((?x24 (concat (select d0 (_ bv5 32)) (concat (select d0 (_ bv4 32)) (concat (select d0 (_ bv3 32)) ?x15)))))
(let ((?x31 ((_ to_fp 11 53) (concat (select d0 (_ bv7 32)) (concat (select d0 (_ bv6 32)) ?x24)))))
(not (and (not (fp.isNaN ?x31)) (not (fp.lt ?x31 ((_ to_fp 11 53) (_ bv0 64))))))))))
(check-sat)
(exit)
