...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_differentiation_klee.x86_64/query.07.smt2
|)
...
(assert
 (not (not (bvslt (bvand ((_ extract 63 32) fresh_to_ieee_bv_!0) (_ bv2147483647 32)) (_ bv1048576 32)))))
(check-sat)
(exit)
