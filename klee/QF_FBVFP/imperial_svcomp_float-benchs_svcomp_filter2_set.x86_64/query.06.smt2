...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_filter2_set.x86_64/query.06.smt2
|)
...
(let (($x38 (and (fp.geq ((_ to_fp 11 53) ?x30) ((_ to_fp 11 53) (_ bv0 64))) (fp.leq ((_ to_fp 11 53) ?x30) ((_ to_fp 11 53) (_ bv4607182418800017408 64))))))
(not (not $x38))))))))
(check-sat)
(exit)
