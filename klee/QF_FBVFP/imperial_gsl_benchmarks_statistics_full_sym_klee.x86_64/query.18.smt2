...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_statistics_full_sym_klee.x86_64/query.18.smt2
|)
...
(let ((?x132 (concat (select data0 (_ bv37 32)) (concat (select data0 (_ bv36 32)) (concat (select data0 (_ bv35 32)) ?x123)))))
(let ((?x138 (concat (select data0 (_ bv39 32)) (concat (select data0 (_ bv38 32)) ?x132))))
(let (($x157 (not (fp.gt ((_ to_fp 11 53) (ite (fp.gt ((_ to_fp 11 53) ?x138) ((_ to_fp 11 53) ?x149)) ?x138 ?x149)) ?x36))))
