...
(let ((?x113 ((_ extract 31 0) (bvmul (_ bv4 64) ?x110))))
(let ((?x120 (concat (select data0 (bvadd (_ bv2 32) ?x113)) (concat (select data0 (bvadd (_ bv1 32) ?x113)) (select data0 ?x113)))))
(let (($x126 (not (fp.eq ((_ to_fp 8 24) (concat (select data0 (bvadd (_ bv3 32) ?x113)) ?x120)) ?x94))))
(not $x126)))))))))))
(check-sat)
(exit)
