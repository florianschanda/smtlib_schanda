...
(let ((?x168 (bvadd (ite $x165 (ite $x144 (ite $x125 (ite $x105 (_ bv0 32) (_ bv2 32)) ?x109) ?x129) ?x150) (ite $x165 ?x150 ?x146))))
(not (bvult (bvmul (_ bv4 64) ((_ sign_extend 32) (bvsdiv ?x168 (_ bv2 32)))) (_ bv17 64))))))))))))))))))))))))))))
(check-sat)
(exit)
