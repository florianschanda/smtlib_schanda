...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee_bug.x86_64/query.31.smt2
|)
...
(assert
 ...
 (let ((?x104 (fp.add roundNearestTiesToEven ((_ to_fp 8 24) (ite $x97 fresh_to_ieee_bv_!4 ?x87)) (ite $x97 ?x89 ?x91))))
 (let ((?x105 (fp.mul roundNearestTiesToEven ?x104 ?x32)))
 (fp.lt (fp.abs (fp.sub roundNearestTiesToEven ?x105 ?x19)) ?x37))))))))))))))))))))))))))))))
(assert
 (let ((?x32 ((_ to_fp 8 24) (_ bv1056964608 32))))
 (let ((?x22 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x15 (concat (select x0 (_ bv2 32)) (concat (select x0 (_ bv1 32)) (select x0 (_ bv0 32))))))
...
(let ((?x104 (fp.add roundNearestTiesToEven ((_ to_fp 8 24) (ite $x97 fresh_to_ieee_bv_!4 ?x87)) (ite $x97 ?x89 ?x91))))
(let ((?x105 (fp.mul roundNearestTiesToEven ?x104 ?x32)))
(not (and (not (fp.isNaN ?x105)) (not (fp.gt ?x105 ?x19))))))))))))))))))))))))))))))))
(check-sat)
(exit)
