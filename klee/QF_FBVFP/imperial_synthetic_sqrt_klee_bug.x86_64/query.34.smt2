...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_sqrt_klee_bug.x86_64/query.34.smt2
|)
...
(let ((?x104 (fp.add roundNearestTiesToEven ((_ to_fp 8 24) (ite $x97 fresh_to_ieee_bv_!4 ?x87)) (ite $x97 ?x89 ?x91))))
(let ((?x105 (fp.mul roundNearestTiesToEven ?x104 ?x32)))
(let ((?x110 (fp.sub roundNearestTiesToEven ?x19 (fp.mul roundNearestTiesToEven ?x105 ?x105))))
(not (not (fp.lt (fp.abs ?x110) ?x37)))))))))))))))))))))))))))))))))
(check-sat)
(exit)
