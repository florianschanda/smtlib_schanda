...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_numerical_recipes_gaussj.x86_64/query.09.smt2
|)
...
(let ((?x50 (fp.abs ?x49)))
(not (and (not (fp.isNaN ?x50)) (not (fp.lt ?x50 ((_ to_fp 8 24) (_ bv1069547520 32)))))))))))
(check-sat)
(exit)
