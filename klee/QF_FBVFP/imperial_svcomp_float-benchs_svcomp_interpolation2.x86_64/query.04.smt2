...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_interpolation2.x86_64/query.04.smt2
|)
...
(let ((?x19 ((_ to_fp 8 24) ?x18)))
(let (($x26 (fp.isNaN ?x19)))
(not (or $x26 (fp.gt ?x19 ((_ to_fp 8 24) (_ bv1094713344 32))))))))))
(check-sat)
(exit)
