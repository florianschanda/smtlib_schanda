...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_sin_interpolated_bigrange_tight.x86_64/query.05.smt2
|)
...
(let ((?x31 ((_ to_fp 11 53) ?x30)))
(let ((?x44 (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) (_ bv9223372036854775808 64)) ?x31)))
(not (not (fp.lt ?x44 ((_ to_fp 11 53) (_ bv0 64))))))))))))
(check-sat)
(exit)
