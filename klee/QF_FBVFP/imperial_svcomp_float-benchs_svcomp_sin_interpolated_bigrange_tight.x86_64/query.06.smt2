...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_sin_interpolated_bigrange_tight.x86_64/query.06.smt2
|)
...
(assert
 ...
 (not (fp.gt ?x44 ((_ to_fp 11 53) (_ bv4640537203540230144 64)))))))))))
(assert
 (let ((?x12 (concat (select symbolic_0_double0 (_ bv1 32)) (select symbolic_0_double0 (_ bv0 32)))))
(let ((?x18 (concat (select symbolic_0_double0 (_ bv3 32)) (concat (select symbolic_0_double0 (_ bv2 32)) ?x12))))
(let ((?x24 (concat (select symbolic_0_double0 (_ bv5 32)) (concat (select symbolic_0_double0 (_ bv4 32)) ?x18))))
...
(let ((?x31 ((_ to_fp 11 53) ?x30)))
(let ((?x44 (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) (_ bv9223372036854775808 64)) ?x31)))
(let ((?x53 ((_ fp.to_sbv 32) roundTowardZero (fp.mul roundNearestTiesToEven ?x44 ((_ to_fp 11 53) (_ bv4611686018427387904 64))))))
(not (bvult (bvmul (_ bv8 64) ((_ sign_extend 32) ?x53)) (_ bv2889 64)))))))))))
(check-sat)
(exit)
