...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.307.smt2
|)
...
(assert
 ...
 (let ((?x154 (fp.sub roundNearestTiesToEven ?x152 (fp.add roundNearestTiesToEven ?x123 ?x109))))
 (not (fp.isNaN ?x154)))))))))))))))))))))))
(assert
 (let ((?x136 (concat (select symbolic_0_float_98 (_ bv1 32)) (select symbolic_0_float_98 (_ bv0 32)))))
 (let ((?x140 (concat (select symbolic_0_float_98 (_ bv3 32)) (concat (select symbolic_0_float_98 (_ bv2 32)) ?x136))))
