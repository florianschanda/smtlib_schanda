...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.159.smt2
|)
...
(let ((?x120 ((_ to_fp 8 24) ?x119)))
(let ((?x139 (fp.sub roundNearestTiesToEven ?x120 (fp.add roundNearestTiesToEven ?x102 ?x88))))
(not (or (or (fp.isNaN ?x139) (fp.isNaN ?x135)) (fp.lt ?x139 ?x135)))))))))))))))))))))))
(check-sat)
(exit)
