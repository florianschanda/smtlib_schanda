...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.343.smt2
|)
...
(let ((?x130 ((_ to_fp 8 24) ?x129)))
(let ((?x145 (fp.sub roundNearestTiesToEven ?x130 (fp.sub roundNearestTiesToEven ?x113 ?x101))))
(let (($x188 (and (and (not (fp.isNaN ?x145)) (not (fp.isNaN ?x141))) (not (fp.lt ?x145 ?x141)))))
(not $x188))))))))))))))))))))
(check-sat)
(exit)
