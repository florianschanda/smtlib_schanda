...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.481.smt2
|)
...
(assert
 ...
 (let ((?x45 (fp.sub roundNearestTiesToEven ?x34 ?x43)))
 (let ((?x55 (fp.sub roundNearestTiesToEven ?x45 ?x54)))
 (let ((?x156 (concat (select symbolic_0_float_69 (_ bv1 32)) (select symbolic_0_float_69 (_ bv0 32)))))
 (let ((?x160 (concat (select symbolic_0_float_69 (_ bv3 32)) (concat (select symbolic_0_float_69 (_ bv2 32)) ?x156))))
 (let ((?x161 ((_ to_fp 8 24) ?x160)))
 (let ((?x162 (fp.sub roundNearestTiesToEven ?x161 ?x55)))
 (not (fp.isNaN ?x162))))))))))))))))))
(assert
 (let ((?x59 (concat (select symbolic_0_float_74 (_ bv1 32)) (select symbolic_0_float_74 (_ bv0 32)))))
 (let ((?x63 (concat (select symbolic_0_float_74 (_ bv3 32)) (concat (select symbolic_0_float_74 (_ bv2 32)) ?x59))))
 (let ((?x64 ((_ to_fp 8 24) ?x63)))
 (let ((?x69 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x165 (fp.sub roundNearestTiesToEven ?x69 ?x64)))
 (not (fp.isNaN ?x165))))))))
(assert
 (let ((?x59 (concat (select symbolic_0_float_74 (_ bv1 32)) (select symbolic_0_float_74 (_ bv0 32)))))
 (let ((?x63 (concat (select symbolic_0_float_74 (_ bv3 32)) (concat (select symbolic_0_float_74 (_ bv2 32)) ?x59))))
