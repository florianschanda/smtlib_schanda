...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.083.smt2
|)
...
(assert
 ...
 (let ((?x96 (fp.sub roundNearestTiesToEven ?x94 (fp.add roundNearestTiesToEven ?x65 ?x51))))
 (not (fp.isNaN ?x96)))))))))))))))
(assert
 (let ((?x78 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
 (let ((?x82 (concat (select symbolic_0_float_54 (_ bv3 32)) (concat (select symbolic_0_float_54 (_ bv2 32)) ?x78))))
