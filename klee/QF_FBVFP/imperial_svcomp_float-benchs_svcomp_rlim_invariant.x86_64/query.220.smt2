...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.220.smt2
|)
...
(assert
 ...
 (let ((?x135 (fp.sub roundNearestTiesToEven ?x133 (fp.sub roundNearestTiesToEven ?x103 ?x91))))
