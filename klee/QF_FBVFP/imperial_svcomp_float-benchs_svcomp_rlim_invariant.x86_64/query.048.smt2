...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.048.smt2
|)
...
(let ((?x68 (fp.add roundNearestTiesToEven ?x20 ?x19)))
(let ((?x99 (fp.sub roundNearestTiesToEven ?x68 ?x56)))
(let ((?x119 (fp.add roundNearestTiesToEven ?x99 ?x85)))
