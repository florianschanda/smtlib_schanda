...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.331.smt2
|)
...
(assert
 ...
 (let ((?x56 ((_ to_fp 8 24) ?x55)))
 (let ((?x61 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x165 (fp.sub roundNearestTiesToEven ?x61 ?x56)))
 (not (fp.isNaN ?x165))))))))
(assert
 (let ((?x51 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
 (let ((?x55 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x51))))
