...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.559.smt2
|)
...
(assert
 ...
 (let ((?x46 ((_ to_fp 8 24) ?x45)))
 (let ((?x71 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x111 (fp.sub roundNearestTiesToEven ?x71 ?x46)))
 (let ((?x30 (concat (select symbolic_0_float_11 (_ bv1 32)) (select symbolic_0_float_11 (_ bv0 32)))))
 (let ((?x34 (concat (select symbolic_0_float_11 (_ bv3 32)) (concat (select symbolic_0_float_11 (_ bv2 32)) ?x30))))
 (let ((?x35 ((_ to_fp 8 24) ?x34)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x37 (fp.sub roundNearestTiesToEven ?x26 ?x35)))
 (let ((?x116 (concat (select symbolic_0_float_27 (_ bv1 32)) (select symbolic_0_float_27 (_ bv0 32)))))
 (let ((?x120 (concat (select symbolic_0_float_27 (_ bv3 32)) (concat (select symbolic_0_float_27 (_ bv2 32)) ?x116))))
 (let ((?x121 ((_ to_fp 8 24) ?x120)))
 (let ((?x122 (fp.sub roundNearestTiesToEven ?x121 ?x37)))
 (or (fp.isNaN ?x111) (fp.gt ?x122 ?x111)))))))))))))))))
(assert
 (let ((?x30 (concat (select symbolic_0_float_11 (_ bv1 32)) (select symbolic_0_float_11 (_ bv0 32)))))
 (let ((?x34 (concat (select symbolic_0_float_11 (_ bv3 32)) (concat (select symbolic_0_float_11 (_ bv2 32)) ?x30))))
 (let ((?x35 ((_ to_fp 8 24) ?x34)))
...
(assert
 ...
 (let ((?x142 (fp.sub roundNearestTiesToEven ?x141 ?x47)))
 (not (fp.isNaN ?x142))))))))))))))))
(assert
 (let ((?x51 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
 (let ((?x55 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x51))))
 (let ((?x56 ((_ to_fp 8 24) ?x55)))
 (let ((?x71 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x145 (fp.sub roundNearestTiesToEven ?x71 ?x56)))
 (not (fp.isNaN ?x145))))))))
(assert
 (let ((?x51 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
 (let ((?x55 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x51))))
