...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.456.smt2
|)
...
(assert
 ...
 (let ((?x152 ((_ to_fp 8 24) ?x151)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x155 (fp.sub roundNearestTiesToEven ?x26 ?x152)))
 (let ((?x115 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x119 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x115))))
 (let ((?x120 ((_ to_fp 8 24) ?x119)))
 (let ((?x83 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
...
(assert
 ...
 (not (fp.lt ?x167 ?x152)))))))))))))))))))))))))))
(assert
 (let ((?x177 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x33 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x37 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x33))))
 (let ((?x38 ((_ to_fp 8 24) ?x37)))
 (fp.geq ?x38 ?x177))))))
(assert
 (let ((?x180 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x33 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x37 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x33))))
 (let ((?x38 ((_ to_fp 8 24) ?x37)))
 (fp.leq ?x38 ?x180))))))
...
(let ((?x134 (fp.add roundNearestTiesToEven ?x102 ?x88)))
(let ((?x166 (fp.add roundNearestTiesToEven ?x134 ?x120)))
(let ((?x190 (fp.add roundNearestTiesToEven ?x166 ?x152)))
(not (and (fp.geq ?x190 ((_ to_fp 8 24) (_ bv3271622656 32))) (fp.leq ?x190 ((_ to_fp 8 24) (_ bv1124139008 32)))))))))))))))))))))))))))
(check-sat)
(exit)
