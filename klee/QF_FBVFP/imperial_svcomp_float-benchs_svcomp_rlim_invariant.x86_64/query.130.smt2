...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.130.smt2
|)
...
(assert
 ...
 (let ((?x137 (fp.sub roundNearestTiesToEven ?x136 ?x26)))
 (not (fp.gt ?x137 ?x125)))))))))))))
(assert
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x45 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
...
(let ((?x101 ((_ to_fp 8 24) ?x100)))
(let ((?x116 (fp.sub roundNearestTiesToEven ?x101 (fp.add roundNearestTiesToEven ?x19 ?x68))))
(let (($x154 (and (and (not (fp.isNaN ?x116)) (not (fp.isNaN ?x112))) (not (fp.lt ?x116 ?x112)))))
(not $x154))))))))))))))))
(check-sat)
(exit)
