...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.607.smt2
|)
...
(assert
 ...
 (let ((?x145 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x141))))
 (let ((?x146 ((_ to_fp 8 24) ?x145)))
 (let ((?x165 (fp.sub roundNearestTiesToEven ?x146 (fp.add roundNearestTiesToEven ?x128 ?x114))))
...
(let ((?x146 ((_ to_fp 8 24) ?x145)))
(let ((?x165 (fp.sub roundNearestTiesToEven ?x146 (fp.add roundNearestTiesToEven ?x128 ?x114))))
(let (($x186 (and (and (not (fp.isNaN ?x165)) (not (fp.isNaN ?x161))) (not (fp.lt ?x165 ?x161)))))
(not $x186))))))))))))))))))))))))))
(check-sat)
(exit)
