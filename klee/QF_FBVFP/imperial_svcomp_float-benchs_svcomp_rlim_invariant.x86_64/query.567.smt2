...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.567.smt2
|)
...
(assert
 ...
 (let ((?x146 (fp.sub roundNearestTiesToEven ?x144 (fp.add roundNearestTiesToEven ?x115 ?x101))))
 (not (fp.isNaN ?x146)))))))))))))))))
(assert
 (let ((?x128 (concat (select symbolic_0_float_97 (_ bv1 32)) (select symbolic_0_float_97 (_ bv0 32)))))
 (let ((?x132 (concat (select symbolic_0_float_97 (_ bv3 32)) (concat (select symbolic_0_float_97 (_ bv2 32)) ?x128))))
