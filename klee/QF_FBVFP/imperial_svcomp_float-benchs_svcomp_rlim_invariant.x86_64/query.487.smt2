...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.487.smt2
|)
...
(assert
 ...
 (not (fp.lt ?x132 ?x117)))))))))))))))))))))))
(assert
 (let ((?x151 ((_ to_fp 8 24) (_ bv3271557120 32))))
 ...
 (fp.geq ?x149 ?x151))))))
(assert
 (let ((?x154 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x144 (concat (select symbolic_0_float_88 (_ bv1 32)) (select symbolic_0_float_88 (_ bv0 32)))))
 (let ((?x148 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x144))))
 (let ((?x149 ((_ to_fp 8 24) ?x148)))
 (fp.leq ?x149 ?x154))))))
(assert
 (let ((?x20 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x159 (concat (select symbolic_0_float_99 (_ bv1 32)) (select symbolic_0_float_99 (_ bv0 32)))))
 (let ((?x163 (concat (select symbolic_0_float_99 (_ bv3 32)) (concat (select symbolic_0_float_99 (_ bv2 32)) ?x159))))
...
(assert
 ...
 (let ((?x164 ((_ to_fp 8 24) ?x163)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x170 (fp.sub roundNearestTiesToEven ?x26 ?x164)))
 (let ((?x112 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x116 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x112))))
 (let ((?x117 ((_ to_fp 8 24) ?x116)))
 (let ((?x83 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
 ...
 (let ((?x148 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x144))))
 (let ((?x149 ((_ to_fp 8 24) ?x148)))
 (let ((?x168 (fp.sub roundNearestTiesToEven ?x149 (fp.add roundNearestTiesToEven ?x131 ?x117))))
 (or (or (fp.isNaN ?x168) (fp.isNaN ?x170)) (fp.gt ?x168 ?x170))))))))))))))))))))))))))))
(assert
 (let ((?x151 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x33 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x37 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x33))))
...
(let ((?x149 ((_ to_fp 8 24) ?x148)))
(let ((?x168 (fp.sub roundNearestTiesToEven ?x149 (fp.add roundNearestTiesToEven ?x131 ?x117))))
(not (or (or (fp.isNaN ?x168) (fp.isNaN ?x164)) (fp.lt ?x168 ?x164)))))))))))))))))))))))))))
(check-sat)
(exit)
