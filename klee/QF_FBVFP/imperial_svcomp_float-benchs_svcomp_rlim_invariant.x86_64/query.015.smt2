...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.015.smt2
|)
...
(assert
 ...
 (let ((?x55 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x51))))
 (let ((?x56 ((_ to_fp 8 24) ?x55)))
 (let ((?x72 (fp.sub roundNearestTiesToEven ((_ to_fp 8 24) (_ bv2147483648 32)) ?x56)))
 (not (fp.isNaN ?x72)))))))
(assert
 (let ((?x51 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 (let ((?x55 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x51))))
...
(assert
 ...
 (let ((?x66 (concat (select symbolic_0_float_23 (_ bv3 32)) (concat (select symbolic_0_float_23 (_ bv2 32)) ?x62))))
 (let ((?x67 ((_ to_fp 8 24) ?x66)))
 (fp.geq ?x67 ((_ to_fp 8 24) (_ bv3271557120 32)))))))
(assert
 (let ((?x62 (concat (select symbolic_0_float_23 (_ bv1 32)) (select symbolic_0_float_23 (_ bv0 32)))))
 (let ((?x66 (concat (select symbolic_0_float_23 (_ bv3 32)) (concat (select symbolic_0_float_23 (_ bv2 32)) ?x62))))
 (let ((?x67 ((_ to_fp 8 24) ?x66)))
 (fp.leq ?x67 ((_ to_fp 8 24) (_ bv1124073472 32)))))))
(assert
 (let ((?x51 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
(let ((?x55 (concat (select symbolic_0_float_32 (_ bv3 32)) (concat (select symbolic_0_float_32 (_ bv2 32)) ?x51))))
(let ((?x56 ((_ to_fp 8 24) ?x55)))
...
(let ((?x20 ((_ to_fp 8 24) (_ bv0 32))))
(let ((?x68 (fp.add roundNearestTiesToEven ?x20 ?x19)))
(let ((?x85 (fp.sub roundNearestTiesToEven ?x68 ?x56)))
(not (and (fp.geq ?x85 ((_ to_fp 8 24) (_ bv3271622656 32))) (fp.leq ?x85 ((_ to_fp 8 24) (_ bv1124139008 32)))))))))))))))
(check-sat)
(exit)
