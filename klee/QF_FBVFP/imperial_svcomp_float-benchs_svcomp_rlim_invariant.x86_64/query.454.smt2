...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.454.smt2
|)
...
(assert
 ...
 (let ((?x66 ((_ to_fp 8 24) ?x65)))
 (let ((?x71 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x160 (fp.sub roundNearestTiesToEven ?x71 ?x66)))
 (let ((?x51 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
 (let ((?x55 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x51))))
 (let ((?x56 ((_ to_fp 8 24) ?x55)))
 (let ((?x41 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
 ...
 (let ((?x47 (fp.add roundNearestTiesToEven ?x37 ?x46)))
 (let ((?x57 (fp.add roundNearestTiesToEven ?x47 ?x56)))
 (let ((?x165 (concat (select symbolic_0_float_69 (_ bv1 32)) (select symbolic_0_float_69 (_ bv0 32)))))
 (let ((?x169 (concat (select symbolic_0_float_69 (_ bv3 32)) (concat (select symbolic_0_float_69 (_ bv2 32)) ?x165))))
 (let ((?x170 ((_ to_fp 8 24) ?x169)))
 (let ((?x171 (fp.sub roundNearestTiesToEven ?x170 ?x57)))
 (or (fp.isNaN ?x160) (fp.gt ?x171 ?x160)))))))))))))))))))))))))
(assert
 (let ((?x51 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
 (let ((?x55 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x51))))
 (let ((?x56 ((_ to_fp 8 24) ?x55)))
