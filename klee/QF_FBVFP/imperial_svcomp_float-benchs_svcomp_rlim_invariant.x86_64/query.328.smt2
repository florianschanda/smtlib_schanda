...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.328.smt2
|)
...
(let ((?x88 ((_ to_fp 8 24) ?x87)))
(let ((?x104 (fp.sub roundNearestTiesToEven ?x88 ?x19)))
(let (($x185 (and (and (not (fp.isNaN ?x104)) (not (fp.isNaN ?x99))) (not (fp.lt ?x104 ?x99)))))
(not $x185)))))))))))))
(check-sat)
(exit)
