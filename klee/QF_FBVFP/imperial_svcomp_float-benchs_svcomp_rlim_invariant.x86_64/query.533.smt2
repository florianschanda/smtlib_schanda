...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.533.smt2
|)
...
(assert
 ...
 (let ((?x110 ((_ to_fp 8 24) ?x109)))
 (let ((?x39 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x158 (fp.sub roundNearestTiesToEven ?x39 ?x110)))
 (let ((?x95 (concat (select symbolic_0_float_15 (_ bv1 32)) (select symbolic_0_float_15 (_ bv0 32)))))
 (let ((?x99 (concat (select symbolic_0_float_15 (_ bv3 32)) (concat (select symbolic_0_float_15 (_ bv2 32)) ?x95))))
 (let ((?x100 ((_ to_fp 8 24) ?x99)))
 (let ((?x78 ((_ to_fp 8 24) (_ bv0 32))))
 ...
 (let ((?x169 (fp.sub roundNearestTiesToEven ?x168 ?x101)))
...
(let ((?x66 ((_ to_fp 8 24) ?x65)))
(let ((?x83 (fp.sub roundNearestTiesToEven ?x66 ?x19)))
(let (($x190 (and (and (not (fp.isNaN ?x83)) (not (fp.isNaN ?x77))) (not (fp.lt ?x83 ?x77)))))
(not $x190)))))))))))))
(check-sat)
(exit)
