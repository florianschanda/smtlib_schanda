...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.632.smt2
|)
...
(assert
 ...
 (let ((?x165 (fp.sub roundNearestTiesToEven ?x163 (fp.add roundNearestTiesToEven ?x134 ?x120))))
 (not (fp.isNaN ?x165)))))))))))))))))))))
(assert
 (let ((?x147 (concat (select symbolic_0_float_98 (_ bv1 32)) (select symbolic_0_float_98 (_ bv0 32)))))
 (let ((?x151 (concat (select symbolic_0_float_98 (_ bv3 32)) (concat (select symbolic_0_float_98 (_ bv2 32)) ?x147))))
