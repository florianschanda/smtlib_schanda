...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.684.smt2
|)
...
(assert
 ...
 (let ((?x98 (concat (select symbolic_0_float_25 (_ bv3 32)) (concat (select symbolic_0_float_25 (_ bv2 32)) ?x94))))
 (let ((?x99 ((_ to_fp 8 24) ?x98)))
 (let ((?x136 (fp.sub roundNearestTiesToEven ?x99 (fp.add roundNearestTiesToEven ?x67 ?x134))))
...
(assert
 ...
 (let ((?x171 (fp.sub roundNearestTiesToEven ?x170 ?x67)))
