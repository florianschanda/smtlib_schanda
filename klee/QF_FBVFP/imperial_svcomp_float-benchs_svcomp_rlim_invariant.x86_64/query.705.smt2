...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.705.smt2
|)
...
(assert
 ...
 (let ((?x140 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x136))))
 (let ((?x141 ((_ to_fp 8 24) ?x140)))
 (let ((?x160 (fp.sub roundNearestTiesToEven ?x141 (fp.sub roundNearestTiesToEven ?x124 ?x112))))
