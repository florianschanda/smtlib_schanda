...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.336.smt2
|)
...
(let ((?x130 ((_ to_fp 8 24) ?x129)))
(let ((?x145 (fp.sub roundNearestTiesToEven ?x130 (fp.sub roundNearestTiesToEven ?x113 ?x101))))
(not (or (or (fp.isNaN ?x145) (fp.isNaN ?x141)) (fp.lt ?x145 ?x141)))))))))))))))))))))
(check-sat)
(exit)
