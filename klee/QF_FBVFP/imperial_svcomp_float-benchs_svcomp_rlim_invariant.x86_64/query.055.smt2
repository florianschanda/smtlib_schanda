...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.055.smt2
|)
...
(let ((?x63 (fp.sub roundNearestTiesToEven ?x20 ?x19)))
(let ((?x94 (fp.sub roundNearestTiesToEven ?x63 ?x51)))
(let ((?x116 (fp.add roundNearestTiesToEven ?x94 ?x80)))
