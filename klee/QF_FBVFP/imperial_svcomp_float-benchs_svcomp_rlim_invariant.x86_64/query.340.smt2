...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.340.smt2
|)
...
(assert
 ...
 (let ((?x168 (fp.sub roundNearestTiesToEven ?x167 ?x26)))
 (not (fp.gt ?x168 ?x156)))))))))))))
(assert
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x45 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
...
(let ((?x113 (fp.add roundNearestTiesToEven ?x19 ?x68)))
(let ((?x144 (fp.sub roundNearestTiesToEven ?x113 ?x101)))
(let ((?x183 (fp.add roundNearestTiesToEven ?x144 ?x130)))
