...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.600.smt2
|)
...
(let ((?x149 ((_ to_fp 8 24) ?x148)))
(let ((?x168 (fp.sub roundNearestTiesToEven ?x149 (fp.sub roundNearestTiesToEven ?x132 ?x120))))
(let (($x189 (and (and (not (fp.isNaN ?x168)) (not (fp.isNaN ?x164))) (not (fp.lt ?x168 ?x164)))))
(not $x189))))))))))))))))))))))))))
(check-sat)
(exit)
