...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.110.smt2
|)
...
(assert
 ...
 (let ((?x134 (fp.sub roundNearestTiesToEven ?x133 ?x26)))
 (not (fp.gt ?x134 ?x122)))))))))))))
(assert
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x45 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
...
(let ((?x98 ((_ to_fp 8 24) ?x97)))
(let ((?x113 (fp.sub roundNearestTiesToEven ?x98 (fp.sub roundNearestTiesToEven ?x19 ?x68))))
(not (or (or (fp.isNaN ?x113) (fp.isNaN ?x109)) (fp.lt ?x113 ?x109)))))))))))))))))
(check-sat)
(exit)
