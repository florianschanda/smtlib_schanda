...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.257.smt2
|)
...
(let ((?x105 (fp.add roundNearestTiesToEven ?x19 ?x58)))
(let ((?x135 (fp.add roundNearestTiesToEven ?x105 ?x91)))
(let ((?x152 (fp.sub roundNearestTiesToEven ?x135 ?x123)))
