...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.379.smt2
|)
...
(assert
 ...
 (let ((?x78 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x94 (fp.add roundNearestTiesToEven ?x78 ?x93)))
 (let ((?x29 (concat (select symbolic_0_float_41 (_ bv1 32)) (select symbolic_0_float_41 (_ bv0 32)))))
 (let ((?x33 (concat (select symbolic_0_float_41 (_ bv3 32)) (concat (select symbolic_0_float_41 (_ bv2 32)) ?x29))))
 (let ((?x34 ((_ to_fp 8 24) ?x33)))
 (let ((?x105 (fp.sub roundNearestTiesToEven ?x34 (fp.sub roundNearestTiesToEven ?x94 ?x103))))
...
(assert
 ...
 (let ((?x78 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x134 (concat (select symbolic_0_float8 (_ bv1 32)) (select symbolic_0_float8 (_ bv0 32)))))
 (let ((?x138 (concat (select symbolic_0_float8 (_ bv3 32)) (concat (select symbolic_0_float8 (_ bv2 32)) ?x134))))
 (let ((?x139 ((_ to_fp 8 24) ?x138)))
 (let ((?x140 (fp.sub roundNearestTiesToEven ?x139 ?x78)))
...
(assert
 ...
 (let ((?x160 (fp.sub roundNearestTiesToEven ?x159 ?x94)))
 (not (fp.isNaN ?x160))))))))))))
(assert
 (let ((?x98 (concat (select symbolic_0_float_36 (_ bv1 32)) (select symbolic_0_float_36 (_ bv0 32)))))
 (let ((?x102 (concat (select symbolic_0_float_36 (_ bv3 32)) (concat (select symbolic_0_float_36 (_ bv2 32)) ?x98))))
 (let ((?x103 ((_ to_fp 8 24) ?x102)))
 (let ((?x39 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x163 (fp.sub roundNearestTiesToEven ?x39 ?x103)))
 (not (fp.isNaN ?x163))))))))
(assert
 (let ((?x98 (concat (select symbolic_0_float_36 (_ bv1 32)) (select symbolic_0_float_36 (_ bv0 32)))))
 (let ((?x102 (concat (select symbolic_0_float_36 (_ bv3 32)) (concat (select symbolic_0_float_36 (_ bv2 32)) ?x98))))
...
(let ((?x77 ((_ to_fp 8 24) ?x76)))
(let ((?x39 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x177 (fp.sub roundNearestTiesToEven ?x39 ?x77)))
(let ((?x12 (concat (select symbolic_0_float_60 (_ bv1 32)) (select symbolic_0_float_60 (_ bv0 32)))))
(let ((?x18 (concat (select symbolic_0_float_60 (_ bv3 32)) (concat (select symbolic_0_float_60 (_ bv2 32)) ?x12))))
(let ((?x19 ((_ to_fp 8 24) ?x18)))
(let ((?x61 (concat (select symbolic_0_float_83 (_ bv1 32)) (select symbolic_0_float_83 (_ bv0 32)))))
