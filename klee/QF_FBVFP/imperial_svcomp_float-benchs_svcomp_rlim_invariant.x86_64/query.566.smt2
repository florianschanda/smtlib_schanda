...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.566.smt2
|)
...
(assert
 ...
 (let ((?x173 (fp.sub roundNearestTiesToEven ?x172 ?x80)))
 (not (fp.gt ?x173 ?x161)))))))))))))
(assert
 (let ((?x80 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x96 (concat (select symbolic_0_float_36 (_ bv1 32)) (select symbolic_0_float_36 (_ bv0 32)))))
