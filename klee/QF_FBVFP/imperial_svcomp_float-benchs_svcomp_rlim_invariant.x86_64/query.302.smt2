...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.302.smt2
|)
...
(assert
 ...
 (fp.leq ?x34 ?x24))))))
(assert
 (let ((?x96 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x100 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x96))))
...
(assert
 ...
 (let ((?x69 ((_ to_fp 8 24) ?x68)))
 (let ((?x39 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x117 (fp.sub roundNearestTiesToEven ?x39 ?x69)))
 (not (fp.isNaN ?x117))))))))
(assert
 (let ((?x64 (concat (select symbolic_0_float_13 (_ bv1 32)) (select symbolic_0_float_13 (_ bv0 32)))))
 (let ((?x68 (concat (select symbolic_0_float_13 (_ bv3 32)) (concat (select symbolic_0_float_13 (_ bv2 32)) ?x64))))
 ...
 (let ((?x129 (fp.sub roundNearestTiesToEven ?x128 ?x60)))
 (not (fp.gt ?x129 ?x117)))))))))))))
(assert
 (let ((?x60 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x74 (concat (select symbolic_0_float_34 (_ bv1 32)) (select symbolic_0_float_34 (_ bv0 32)))))
...
(assert
 ...
 (let ((?x143 (fp.sub roundNearestTiesToEven ?x142 ?x70)))
 (not (fp.isNaN ?x143))))))))))))
(assert
 (let ((?x74 (concat (select symbolic_0_float_34 (_ bv1 32)) (select symbolic_0_float_34 (_ bv0 32)))))
 (let ((?x78 (concat (select symbolic_0_float_34 (_ bv3 32)) (concat (select symbolic_0_float_34 (_ bv2 32)) ?x74))))
 (let ((?x79 ((_ to_fp 8 24) ?x78)))
 (let ((?x39 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x146 (fp.sub roundNearestTiesToEven ?x39 ?x79)))
 (not (fp.isNaN ?x146))))))))
(assert
 (let ((?x74 (concat (select symbolic_0_float_34 (_ bv1 32)) (select symbolic_0_float_34 (_ bv0 32)))))
 (let ((?x78 (concat (select symbolic_0_float_34 (_ bv3 32)) (concat (select symbolic_0_float_34 (_ bv2 32)) ?x74))))
...
(assert
 ...
 (let ((?x162 (fp.sub roundNearestTiesToEven ?x161 ?x80)))
 (not (fp.isNaN ?x162))))))))))))))))
(assert
 (let ((?x84 (concat (select symbolic_0_float_55 (_ bv1 32)) (select symbolic_0_float_55 (_ bv0 32)))))
 (let ((?x88 (concat (select symbolic_0_float_55 (_ bv3 32)) (concat (select symbolic_0_float_55 (_ bv2 32)) ?x84))))
 (let ((?x89 ((_ to_fp 8 24) ?x88)))
 (let ((?x39 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x165 (fp.sub roundNearestTiesToEven ?x39 ?x89)))
 (not (fp.isNaN ?x165))))))))
(assert
 (let ((?x84 (concat (select symbolic_0_float_55 (_ bv1 32)) (select symbolic_0_float_55 (_ bv0 32)))))
 (let ((?x88 (concat (select symbolic_0_float_55 (_ bv3 32)) (concat (select symbolic_0_float_55 (_ bv2 32)) ?x84))))
