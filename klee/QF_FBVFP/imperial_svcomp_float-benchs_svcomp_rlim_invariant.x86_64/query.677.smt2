...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.677.smt2
|)
...
(assert
 ...
 (let ((?x33 (concat (select symbolic_0_float_21 (_ bv3 32)) (concat (select symbolic_0_float_21 (_ bv2 32)) ?x29))))
 (let ((?x34 ((_ to_fp 8 24) ?x33)))
 (let ((?x133 (fp.sub roundNearestTiesToEven ?x34 ?x132)))
...
(assert
 ...
 (fp.leq ?x132 ?x24))))))
(assert
 (let ((?x164 (concat (select symbolic_0_float_19 (_ bv1 32)) (select symbolic_0_float_19 (_ bv0 32)))))
 (let ((?x168 (concat (select symbolic_0_float_19 (_ bv3 32)) (concat (select symbolic_0_float_19 (_ bv2 32)) ?x164))))
 (let ((?x169 ((_ to_fp 8 24) ?x168)))
 (let ((?x39 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x170 (fp.sub roundNearestTiesToEven ?x39 ?x169)))
 (let ((?x67 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x127 (concat (select symbolic_0_float7 (_ bv1 32)) (select symbolic_0_float7 (_ bv0 32)))))
 (let ((?x131 (concat (select symbolic_0_float7 (_ bv3 32)) (concat (select symbolic_0_float7 (_ bv2 32)) ?x127))))
 (let ((?x132 ((_ to_fp 8 24) ?x131)))
 (let ((?x159 (fp.sub roundNearestTiesToEven ?x132 ?x67)))
 (or (or (fp.isNaN ?x159) (fp.isNaN ?x170)) (fp.gt ?x159 ?x170)))))))))))))
(assert
 (let ((?x164 (concat (select symbolic_0_float_19 (_ bv1 32)) (select symbolic_0_float_19 (_ bv0 32)))))
 (let ((?x168 (concat (select symbolic_0_float_19 (_ bv3 32)) (concat (select symbolic_0_float_19 (_ bv2 32)) ?x164))))
 (let ((?x169 ((_ to_fp 8 24) ?x168)))
 ...
 (let ((?x132 ((_ to_fp 8 24) ?x131)))
 (let ((?x159 (fp.sub roundNearestTiesToEven ?x132 ?x67)))
 (or (or (fp.isNaN ?x159) (fp.isNaN ?x169)) (fp.lt ?x159 ?x169)))))))))))
(assert
 (let ((?x67 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x138 (concat (select symbolic_0_float_38 (_ bv1 32)) (select symbolic_0_float_38 (_ bv0 32)))))
 (let ((?x142 (concat (select symbolic_0_float_38 (_ bv3 32)) (concat (select symbolic_0_float_38 (_ bv2 32)) ?x138))))
...
(let ((?x100 ((_ to_fp 8 24) ?x99)))
(let ((?x115 (fp.sub roundNearestTiesToEven ?x100 (fp.add roundNearestTiesToEven ?x19 ?x66))))
(let (($x189 (and (and (not (fp.isNaN ?x115)) (not (fp.isNaN ?x111))) (not (fp.lt ?x115 ?x111)))))
(not $x189))))))))))))))))
(check-sat)
(exit)
