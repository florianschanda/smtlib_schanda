...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.569.smt2
|)
...
(assert
 ...
 (let ((?x171 (fp.sub roundNearestTiesToEven ?x170 ?x26)))
 (not (fp.gt ?x171 ?x159)))))))))))))
(assert
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x45 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
...
(let ((?x115 (fp.add roundNearestTiesToEven ?x19 ?x68)))
(let ((?x147 (fp.add roundNearestTiesToEven ?x115 ?x101)))
(let ((?x186 (fp.add roundNearestTiesToEven ?x147 ?x133)))
