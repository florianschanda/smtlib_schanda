...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.421.smt2
|)
...
(assert
 ...
 (let ((?x146 (fp.sub roundNearestTiesToEven ?x41 ?x35)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x152 (concat (select symbolic_0_float9 (_ bv1 32)) (select symbolic_0_float9 (_ bv0 32)))))
 (let ((?x156 (concat (select symbolic_0_float9 (_ bv3 32)) (concat (select symbolic_0_float9 (_ bv2 32)) ?x152))))
 (let ((?x157 ((_ to_fp 8 24) ?x156)))
 (let ((?x158 (fp.sub roundNearestTiesToEven ?x157 ?x26)))
 (not (fp.gt ?x158 ?x146)))))))))))))
(assert
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x45 (concat (select symbolic_0_float_32 (_ bv1 32)) (select symbolic_0_float_32 (_ bv0 32)))))
...
(let ((?x141 ((_ to_fp 8 24) ?x140)))
(let ((?x41 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x174 (fp.sub roundNearestTiesToEven ?x41 ?x141)))
(let ((?x93 (concat (select symbolic_0_float_75 (_ bv1 32)) (select symbolic_0_float_75 (_ bv0 32)))))
(let ((?x97 (concat (select symbolic_0_float_75 (_ bv3 32)) (concat (select symbolic_0_float_75 (_ bv2 32)) ?x93))))
(let ((?x98 ((_ to_fp 8 24) ?x97)))
(let ((?x63 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
...
(let ((?x129 (concat (select symbolic_0_float_87 (_ bv3 32)) (concat (select symbolic_0_float_87 (_ bv2 32)) ?x125))))
(let ((?x130 ((_ to_fp 8 24) ?x129)))
(let ((?x172 (fp.sub roundNearestTiesToEven ?x130 (fp.add roundNearestTiesToEven ?x112 ?x98))))
