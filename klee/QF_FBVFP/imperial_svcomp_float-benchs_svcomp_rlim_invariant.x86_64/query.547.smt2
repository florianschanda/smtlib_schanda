...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.547.smt2
|)
...
(let ((?x131 (fp.add roundNearestTiesToEven ?x99 ?x85)))
(let ((?x161 (fp.add roundNearestTiesToEven ?x131 ?x117)))
(let ((?x184 (fp.sub roundNearestTiesToEven ?x161 ?x149)))
