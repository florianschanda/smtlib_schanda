...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.136.smt2
|)
...
(assert
 (let ((?x21 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x96 (concat (select symbolic_0_float_65 (_ bv1 32)) (select symbolic_0_float_65 (_ bv0 32)))))
 (let ((?x100 (concat (select symbolic_0_float_65 (_ bv3 32)) (concat (select symbolic_0_float_65 (_ bv2 32)) ?x96))))
...
(assert
 ...
 (let ((?x35 ((_ to_fp 8 24) ?x34)))
 (let ((?x41 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x117 (fp.sub roundNearestTiesToEven ?x41 ?x35)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x122 (concat (select symbolic_0_float7 (_ bv1 32)) (select symbolic_0_float7 (_ bv0 32)))))
 (let ((?x126 (concat (select symbolic_0_float7 (_ bv3 32)) (concat (select symbolic_0_float7 (_ bv2 32)) ?x122))))
 (let ((?x127 ((_ to_fp 8 24) ?x126)))
 (let ((?x128 (fp.sub roundNearestTiesToEven ?x127 ?x26)))
...
(let ((?x112 ((_ to_fp 8 24) ?x111)))
(let ((?x41 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x146 (fp.sub roundNearestTiesToEven ?x41 ?x112)))
(let ((?x63 (concat (select symbolic_0_float_53 (_ bv1 32)) (select symbolic_0_float_53 (_ bv0 32)))))
(let ((?x67 (concat (select symbolic_0_float_53 (_ bv3 32)) (concat (select symbolic_0_float_53 (_ bv2 32)) ?x63))))
(let ((?x68 ((_ to_fp 8 24) ?x67)))
(let ((?x12 (concat (select symbolic_0_float_20 (_ bv1 32)) (select symbolic_0_float_20 (_ bv0 32)))))
...
(let ((?x100 (concat (select symbolic_0_float_65 (_ bv3 32)) (concat (select symbolic_0_float_65 (_ bv2 32)) ?x96))))
(let ((?x101 ((_ to_fp 8 24) ?x100)))
(let ((?x144 (fp.sub roundNearestTiesToEven ?x101 (fp.add roundNearestTiesToEven ?x19 ?x68))))
(not (or (or (fp.isNaN ?x144) (fp.isNaN ?x146)) (fp.gt ?x144 ?x146)))))))))))))))))))
(check-sat)
(exit)
