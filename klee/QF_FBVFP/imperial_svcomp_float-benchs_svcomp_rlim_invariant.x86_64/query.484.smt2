...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.484.smt2
|)
...
(let ((?x129 (fp.sub roundNearestTiesToEven ?x100 ?x88)))
(let ((?x160 (fp.sub roundNearestTiesToEven ?x129 ?x117)))
(let ((?x180 (fp.add roundNearestTiesToEven ?x160 ?x146)))
