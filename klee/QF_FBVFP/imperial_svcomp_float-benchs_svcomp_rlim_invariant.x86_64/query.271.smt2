...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.271.smt2
|)
...
(assert
 ...
 (let ((?x125 (fp.sub roundNearestTiesToEven ?x123 (fp.sub roundNearestTiesToEven ?x95 ?x83))))
 (not (fp.isNaN ?x125)))))))))))))))))))
(assert
 (let ((?x107 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x111 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x107))))
