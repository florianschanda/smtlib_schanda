...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.103.smt2
|)
...
(assert
 ...
 (let ((?x122 (fp.sub roundNearestTiesToEven ?x120 (fp.sub roundNearestTiesToEven ?x92 ?x80))))
 (not (fp.isNaN ?x122)))))))))))))))))))
(assert
 (let ((?x104 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x108 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x104))))
