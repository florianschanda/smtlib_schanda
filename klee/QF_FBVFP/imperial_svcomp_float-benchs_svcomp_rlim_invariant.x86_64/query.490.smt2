...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.490.smt2
|)
...
(assert
 ...
 (let ((?x149 ((_ to_fp 8 24) ?x148)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x152 (fp.sub roundNearestTiesToEven ?x26 ?x149)))
 (let ((?x112 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x116 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x112))))
 (let ((?x117 ((_ to_fp 8 24) ?x116)))
 (let ((?x83 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
...
(assert
 ...
 (not (fp.lt ?x164 ?x149)))))))))))))))))))))))))))
(assert
 (let ((?x174 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x33 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x37 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x33))))
 (let ((?x38 ((_ to_fp 8 24) ?x37)))
 (fp.geq ?x38 ?x174))))))
(assert
 (let ((?x177 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x33 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x37 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x33))))
 (let ((?x38 ((_ to_fp 8 24) ?x37)))
 (fp.leq ?x38 ?x177))))))
...
(let ((?x131 (fp.sub roundNearestTiesToEven ?x100 ?x88)))
(let ((?x163 (fp.add roundNearestTiesToEven ?x131 ?x117)))
(let ((?x187 (fp.add roundNearestTiesToEven ?x163 ?x149)))
