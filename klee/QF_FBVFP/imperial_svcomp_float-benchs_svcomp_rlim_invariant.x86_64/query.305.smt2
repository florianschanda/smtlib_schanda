...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.305.smt2
|)
...
(assert
 ...
 (not (fp.lt ?x124 ?x109)))))))))))))))))))))))
(assert
 (let ((?x143 ((_ to_fp 8 24) (_ bv3271557120 32))))
 ...
 (fp.geq ?x141 ?x143))))))
(assert
 (let ((?x146 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x136 (concat (select symbolic_0_float_88 (_ bv1 32)) (select symbolic_0_float_88 (_ bv0 32)))))
 (let ((?x140 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x136))))
 (let ((?x141 ((_ to_fp 8 24) ?x140)))
 (fp.leq ?x141 ?x146))))))
(assert
 (let ((?x20 ((_ to_fp 8 24) (_ bv0 32))))
 (let ((?x151 (concat (select symbolic_0_float_99 (_ bv1 32)) (select symbolic_0_float_99 (_ bv0 32)))))
 (let ((?x155 (concat (select symbolic_0_float_99 (_ bv3 32)) (concat (select symbolic_0_float_99 (_ bv2 32)) ?x151))))
...
(let ((?x156 ((_ to_fp 8 24) ?x155)))
(let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
(let ((?x172 (fp.sub roundNearestTiesToEven ?x26 ?x156)))
(let ((?x104 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
(let ((?x108 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x104))))
(let ((?x109 ((_ to_fp 8 24) ?x108)))
(let ((?x75 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
...
(let ((?x140 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x136))))
(let ((?x141 ((_ to_fp 8 24) ?x140)))
(let ((?x170 (fp.sub roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x123 ?x109))))
(not (or (or (fp.isNaN ?x170) (fp.isNaN ?x172)) (fp.gt ?x170 ?x172)))))))))))))))))))))))))))))
(check-sat)
(exit)
