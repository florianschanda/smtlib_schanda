...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.562.smt2
|)
...
(assert
 ...
 (let ((?x95 (fp.add roundNearestTiesToEven ?x65 ?x51)))
 (let ((?x126 (fp.sub roundNearestTiesToEven ?x95 ?x83)))
 (let ((?x156 (fp.add roundNearestTiesToEven ?x126 ?x112)))
 (let ((?x150 (concat (select symbolic_0_float_89 (_ bv1 32)) (select symbolic_0_float_89 (_ bv0 32)))))
 (let ((?x154 (concat (select symbolic_0_float_89 (_ bv3 32)) (concat (select symbolic_0_float_89 (_ bv2 32)) ?x150))))
 (let ((?x155 ((_ to_fp 8 24) ?x154)))
 (let ((?x157 (fp.sub roundNearestTiesToEven ?x155 ?x156)))
 (not (fp.isNaN ?x157))))))))))))))))))))))))
(assert
 (let ((?x139 (concat (select symbolic_0_float_98 (_ bv1 32)) (select symbolic_0_float_98 (_ bv0 32)))))
 (let ((?x143 (concat (select symbolic_0_float_98 (_ bv3 32)) (concat (select symbolic_0_float_98 (_ bv2 32)) ?x139))))
 (let ((?x144 ((_ to_fp 8 24) ?x143)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x160 (fp.sub roundNearestTiesToEven ?x26 ?x144)))
 (not (fp.isNaN ?x160))))))))
(assert
 (let ((?x139 (concat (select symbolic_0_float_98 (_ bv1 32)) (select symbolic_0_float_98 (_ bv0 32)))))
 (let ((?x143 (concat (select symbolic_0_float_98 (_ bv3 32)) (concat (select symbolic_0_float_98 (_ bv2 32)) ?x139))))
 ...
 (not (fp.gt ?x157 ?x160)))))))))))))))))))))))))))))
(assert
 (let ((?x166 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x34 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x38 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x34))))
 (let ((?x39 ((_ to_fp 8 24) ?x38)))
 (fp.geq ?x39 ?x166))))))
(assert
 (let ((?x169 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x34 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x38 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x34))))
 (let ((?x39 ((_ to_fp 8 24) ?x38)))
 (fp.leq ?x39 ?x169))))))
...
(let ((?x126 (fp.sub roundNearestTiesToEven ?x95 ?x83)))
(let ((?x156 (fp.add roundNearestTiesToEven ?x126 ?x112)))
(let ((?x181 (fp.sub roundNearestTiesToEven ?x156 ?x144)))
