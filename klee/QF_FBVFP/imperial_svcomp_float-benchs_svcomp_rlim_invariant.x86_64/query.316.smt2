...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.316.smt2
|)
...
(assert
 ...
 (let ((?x138 ((_ to_fp 8 24) ?x137)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x141 (fp.sub roundNearestTiesToEven ?x26 ?x138)))
 (let ((?x104 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x108 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x104))))
 (let ((?x109 ((_ to_fp 8 24) ?x108)))
 (let ((?x75 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
 ...
 (let ((?x92 (fp.sub roundNearestTiesToEven ?x63 ?x51)))
 (let ((?x121 (fp.sub roundNearestTiesToEven ?x92 ?x80)))
 (let ((?x152 (fp.sub roundNearestTiesToEven ?x121 ?x109)))
 (let ((?x146 (concat (select symbolic_0_float_89 (_ bv1 32)) (select symbolic_0_float_89 (_ bv0 32)))))
 (let ((?x150 (concat (select symbolic_0_float_89 (_ bv3 32)) (concat (select symbolic_0_float_89 (_ bv2 32)) ?x146))))
 (let ((?x151 ((_ to_fp 8 24) ?x150)))
 (let ((?x153 (fp.sub roundNearestTiesToEven ?x151 ?x152)))
 (or (fp.isNaN ?x141) (fp.gt ?x153 ?x141)))))))))))))))))))))))))))))
(assert
 (let ((?x104 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x108 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x104))))
 (let ((?x109 ((_ to_fp 8 24) ?x108)))
...
(let ((?x121 (fp.sub roundNearestTiesToEven ?x92 ?x80)))
(let ((?x152 (fp.sub roundNearestTiesToEven ?x121 ?x109)))
(let ((?x178 (fp.add roundNearestTiesToEven ?x152 ?x138)))
