...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.552.smt2
|)
...
(assert
 ...
 (let ((?x159 ((_ to_fp 8 24) ?x158)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x165 (fp.sub roundNearestTiesToEven ?x26 ?x159)))
 (let ((?x107 (concat (select symbolic_0_float_76 (_ bv1 32)) (select symbolic_0_float_76 (_ bv0 32)))))
 (let ((?x111 (concat (select symbolic_0_float_76 (_ bv3 32)) (concat (select symbolic_0_float_76 (_ bv2 32)) ?x107))))
 (let ((?x112 ((_ to_fp 8 24) ?x111)))
 (let ((?x75 (concat (select symbolic_0_float_54 (_ bv1 32)) (select symbolic_0_float_54 (_ bv0 32)))))
 ...
 (let ((?x143 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x139))))
 (let ((?x144 ((_ to_fp 8 24) ?x143)))
 (let ((?x163 (fp.sub roundNearestTiesToEven ?x144 (fp.add roundNearestTiesToEven ?x126 ?x112))))
 (or (or (fp.isNaN ?x163) (fp.isNaN ?x165)) (fp.gt ?x163 ?x165))))))))))))))))))))))))))))
(assert
 (let ((?x146 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x34 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x38 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x34))))
...
(let ((?x144 ((_ to_fp 8 24) ?x143)))
(let ((?x163 (fp.sub roundNearestTiesToEven ?x144 (fp.add roundNearestTiesToEven ?x126 ?x112))))
(let (($x186 (and (and (not (fp.isNaN ?x163)) (not (fp.isNaN ?x159))) (not (fp.lt ?x163 ?x159)))))
(not $x186))))))))))))))))))))))))))
(check-sat)
(exit)
