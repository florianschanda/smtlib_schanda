...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.713.smt2
|)
...
(assert
 ...
 (let ((?x151 (concat (select symbolic_0_float_88 (_ bv3 32)) (concat (select symbolic_0_float_88 (_ bv2 32)) ?x147))))
 (let ((?x152 ((_ to_fp 8 24) ?x151)))
 (let ((?x167 (fp.sub roundNearestTiesToEven ?x152 (fp.add roundNearestTiesToEven ?x134 ?x120))))
...
(let ((?x152 ((_ to_fp 8 24) ?x151)))
(let ((?x167 (fp.sub roundNearestTiesToEven ?x152 (fp.add roundNearestTiesToEven ?x134 ?x120))))
(let (($x188 (and (and (not (fp.isNaN ?x167)) (not (fp.isNaN ?x163))) (not (fp.lt ?x167 ?x163)))))
(not $x188))))))))))))))))))))))))
(check-sat)
(exit)
