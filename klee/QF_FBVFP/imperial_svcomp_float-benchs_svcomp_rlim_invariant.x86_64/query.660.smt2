...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.660.smt2
|)
...
(assert
 ...
 (let ((?x167 (fp.sub roundNearestTiesToEven ?x165 (fp.sub roundNearestTiesToEven ?x135 ?x123))))
