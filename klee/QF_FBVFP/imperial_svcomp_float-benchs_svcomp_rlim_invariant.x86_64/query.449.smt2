...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.449.smt2
|)
...
(assert
 ...
 (let ((?x97 (fp.sub roundNearestTiesToEven ?x68 ?x56)))
 (let ((?x126 (fp.sub roundNearestTiesToEven ?x97 ?x85)))
 (let ((?x155 (fp.sub roundNearestTiesToEven ?x126 ?x114)))
 (let ((?x149 (concat (select symbolic_0_float_89 (_ bv1 32)) (select symbolic_0_float_89 (_ bv0 32)))))
 (let ((?x153 (concat (select symbolic_0_float_89 (_ bv3 32)) (concat (select symbolic_0_float_89 (_ bv2 32)) ?x149))))
 (let ((?x154 ((_ to_fp 8 24) ?x153)))
 (let ((?x156 (fp.sub roundNearestTiesToEven ?x154 ?x155)))
 (not (fp.isNaN ?x156))))))))))))))))))))))))
(assert
 (let ((?x138 (concat (select symbolic_0_float_98 (_ bv1 32)) (select symbolic_0_float_98 (_ bv0 32)))))
 (let ((?x142 (concat (select symbolic_0_float_98 (_ bv3 32)) (concat (select symbolic_0_float_98 (_ bv2 32)) ?x138))))
 (let ((?x143 ((_ to_fp 8 24) ?x142)))
 (let ((?x26 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x159 (fp.sub roundNearestTiesToEven ?x26 ?x143)))
 (not (fp.isNaN ?x159))))))))
(assert
 (let ((?x138 (concat (select symbolic_0_float_98 (_ bv1 32)) (select symbolic_0_float_98 (_ bv0 32)))))
 (let ((?x142 (concat (select symbolic_0_float_98 (_ bv3 32)) (concat (select symbolic_0_float_98 (_ bv2 32)) ?x138))))
 ...
 (not (fp.gt ?x156 ?x159)))))))))))))))))))))))))))))
(assert
 (let ((?x165 ((_ to_fp 8 24) (_ bv3271557120 32))))
 (let ((?x33 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x37 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x33))))
 (let ((?x38 ((_ to_fp 8 24) ?x37)))
 (fp.geq ?x38 ?x165))))))
(assert
 (let ((?x168 ((_ to_fp 8 24) (_ bv1124073472 32))))
 (let ((?x33 (concat (select symbolic_0_float1 (_ bv1 32)) (select symbolic_0_float1 (_ bv0 32)))))
 (let ((?x37 (concat (select symbolic_0_float1 (_ bv3 32)) (concat (select symbolic_0_float1 (_ bv2 32)) ?x33))))
 (let ((?x38 ((_ to_fp 8 24) ?x37)))
 (fp.leq ?x38 ?x168))))))
...
(let ((?x126 (fp.sub roundNearestTiesToEven ?x97 ?x85)))
(let ((?x155 (fp.sub roundNearestTiesToEven ?x126 ?x114)))
(let ((?x178 (fp.sub roundNearestTiesToEven ?x155 ?x143)))
