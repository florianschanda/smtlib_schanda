...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_rlim_invariant.x86_64/query.404.smt2
|)
...
(assert
 ...
 (let ((?x87 ((_ to_fp 8 24) ?x86)))
 (let ((?x49 ((_ to_fp 8 24) (_ bv2147483648 32))))
 (let ((?x157 (fp.sub roundNearestTiesToEven ?x49 ?x87)))
 (let ((?x73 (concat (select symbolic_0_float4 (_ bv1 32)) (select symbolic_0_float4 (_ bv0 32)))))
 (let ((?x77 (concat (select symbolic_0_float4 (_ bv3 32)) (concat (select symbolic_0_float4 (_ bv2 32)) ?x73))))
 (let ((?x78 ((_ to_fp 8 24) ?x77)))
 ...
 (let ((?x168 (fp.sub roundNearestTiesToEven ?x167 ?x78)))
