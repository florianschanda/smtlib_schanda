...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_synthetic_memcpy_and_check_all_ones_significand_klee_double.x86_64/query.4.smt2
|)
...
(assert
 (not (= (_ bv9218868437227405312 64) (bvand fresh_to_ieee_bv_!0 (_ bv9218868437227405312 64)))))
(assert
...
(let ((?x25 (concat (select f0 (_ bv5 32)) (concat (select f0 (_ bv4 32)) (concat (select f0 (_ bv3 32)) ?x16)))))
(let ((?x36 (fp.add roundNearestTiesToEven ((_ to_fp 11 53) (concat (select f0 (_ bv7 32)) (concat (select f0 (_ bv6 32)) ?x25))) ((_ to_fp 11 53) (_ bv4607182418800017408 64)))))
(let ((?x49 (bvand (bvxor (_ bv1 32) (ite (fp.isInfinite ?x36) (_ bv1 32) (_ bv0 32))) (bvxor (_ bv1 32) (ite (fp.isNaN ?x36) (_ bv1 32) (_ bv0 32))))))
(not (not (= (_ bv0 32) ?x49))))))))
(check-sat)
(exit)
