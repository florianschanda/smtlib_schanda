...
(let ((?x30 (concat (select d0 (_ bv7 32)) (concat (select d0 (_ bv6 32)) ?x24))))
(let ((?x31 ((_ to_fp 11 53) ?x30)))
(let ((?x56 (bvxor (ite (fp.lt ((_ to_fp 11 53) (bvor ?x30 (_ bv1 64))) ((_ to_fp 11 53) (_ bv0 64))) (_ bv4294967294 32) (_ bv2 32)) (ite (fp.lt ?x31 ((_ to_fp 11 53) (_ bv0 64))) (_ bv4294967294 32) (_ bv2 32)))))
(not (not (bvslt ?x56 (_ bv0 32))))))))))
(check-sat)
(exit)
