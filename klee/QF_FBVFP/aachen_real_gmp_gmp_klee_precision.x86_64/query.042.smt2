...
(let ((?x80 (ite (bvslt ((_ sign_extend 32) ((_ extract 31 0) ?x58)) ((_ sign_extend 32) ((_ extract 31 0) ?x68))) (ite (fp.lt ((_ to_fp 11 53) ?x30) ((_ to_fp 11 53) (_ bv0 64))) (_ bv4294967294 32) (_ bv2 32)) (ite (fp.lt ((_ to_fp 11 53) ?x62) ((_ to_fp 11 53) (_ bv0 64))) (_ bv4294967294 32) (_ bv2 32)))))
