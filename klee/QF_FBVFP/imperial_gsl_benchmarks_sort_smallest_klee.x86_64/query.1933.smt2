...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1933.smt2
|)
...
(let ((?x168 ((_ to_fp 11 53) (concat (select x0 (_ bv47 32)) (concat (select x0 (_ bv46 32)) ?x161)))))
(let (($x169 (fp.isNaN ?x168)))
(not (not (and (not $x179) (or $x169 $x179)))))))))))))
(check-sat)
(exit)
