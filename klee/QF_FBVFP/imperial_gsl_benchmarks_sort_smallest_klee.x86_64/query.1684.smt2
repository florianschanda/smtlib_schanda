...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_gsl_benchmarks_sort_smallest_klee.x86_64/query.1684.smt2
|)
...
(not (not (and (not $x179) (or $x167 $x179)))))))))))))
(check-sat)
(exit)
