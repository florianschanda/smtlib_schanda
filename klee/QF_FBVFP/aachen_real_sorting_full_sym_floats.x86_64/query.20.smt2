...
(let ((?x317 (concat (select ?x312 (_ bv6 32)) (concat (select ?x312 (_ bv5 32)) (select ?x312 (_ bv4 32))))))
(let (($x329 (fp.lt ((_ to_fp 8 24) (concat (select ?x312 (_ bv7 32)) ?x317)) ((_ to_fp 8 24) (concat (select ?x312 (_ bv11 32)) ?x325)))))
(not (bvult (bvmul (_ bv4 64) ((_ sign_extend 32) (ite $x329 (_ bv1 32) (_ bv2 32)))) (_ bv37 64))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
