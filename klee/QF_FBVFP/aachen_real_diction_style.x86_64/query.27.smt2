...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/aachen_real_diction_style.x86_64/query.27.smt2
|)
...
(let ((?x24 ((_ to_fp 11 53) roundNearestTiesToEven ?x19)))
(let ((?x31 (fp.add roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x24 ((_ to_fp 11 53) (_ bv4625759767262920704 64))) (fp.div roundNearestTiesToEven ((_ to_fp 11 53) (_ bv4667547806188175360 64)) ?x24))))
(not (not (fp.lt ?x31 ((_ to_fp 11 53) (_ bv4632796641680687104 64))))))))))
(check-sat)
(exit)
