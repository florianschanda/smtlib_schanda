...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_exp_loop.c.x86_64/query.096.smt2
|)
...
(assert
 ...
 (let ((?x18 (concat (select symbolic_0_float0 (_ bv3 32)) (concat (select symbolic_0_float0 (_ bv2 32)) ?x12))))
 (let ((?x19 ((_ to_fp 8 24) ?x18)))
 (fp.gt ((_ to_fp 8 24) (_ bv1216348160 32)) ?x19)))))
(assert
 (let ((?x12 (concat (select symbolic_0_float0 (_ bv1 32)) (select symbolic_0_float0 (_ bv0 32)))))
(let ((?x18 (concat (select symbolic_0_float0 (_ bv3 32)) (concat (select symbolic_0_float0 (_ bv2 32)) ?x12))))
(let ((?x19 ((_ to_fp 8 24) ?x18)))
(let ((?x106 (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x19 ((_ to_fp 8 24) (_ bv1216348160 32))) ((_ to_fp 8 24) (_ bv1140850688 32)))))
(let (($x108 (not (fp.isNaN ?x106))))
(let (($x118 (and (and $x108 (not (fp.lt ?x106 ((_ to_fp 8 24) (_ bv0 32))))) (and $x108 (not (fp.gt ?x106 ((_ to_fp 8 24) (_ bv1232348160 32))))))))
(not $x118))))))))
(check-sat)
(exit)
