...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_exp_loop.c.x86_64/query.121.smt2
|)
...
(assert
 ...
 (let ((?x18 (concat (select symbolic_0_float0 (_ bv3 32)) (concat (select symbolic_0_float0 (_ bv2 32)) ?x12))))
 (let ((?x19 ((_ to_fp 8 24) ?x18)))
 (fp.gt ((_ to_fp 8 24) (_ bv1300234240 32)) ?x19)))))
(assert
 (let ((?x12 (concat (select symbolic_0_float0 (_ bv1 32)) (select symbolic_0_float0 (_ bv0 32)))))
(let ((?x18 (concat (select symbolic_0_float0 (_ bv3 32)) (concat (select symbolic_0_float0 (_ bv2 32)) ?x12))))
(let ((?x19 ((_ to_fp 8 24) ?x18)))
(let ((?x146 (fp.mul roundNearestTiesToEven (fp.div roundNearestTiesToEven ?x19 ((_ to_fp 8 24) (_ bv1300234240 32))) ((_ to_fp 8 24) (_ bv1182793728 32)))))
(let (($x148 (not (fp.isNaN ?x146))))
(let (($x158 (and (and $x148 (not (fp.lt ?x146 ((_ to_fp 8 24) (_ bv0 32))))) (and $x148 (not (fp.gt ?x146 ((_ to_fp 8 24) (_ bv1232348160 32))))))))
(not $x158))))))))
(check-sat)
(exit)
