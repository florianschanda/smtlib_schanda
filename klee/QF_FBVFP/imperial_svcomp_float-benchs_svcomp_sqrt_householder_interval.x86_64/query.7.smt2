...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_sqrt_householder_interval.x86_64/query.7.smt2
|)
...
(assert
 ...
 (let ((?x70 (fp.mul roundNearestTiesToEven ((_ to_fp 11 53) (_ bv4517329193108106637 64)) (fp.add roundNearestTiesToEven ?x62 ?x62))))
 (let ((?x66 (fp.mul roundNearestTiesToEven (fp.sub roundNearestTiesToEven ?x62 ?x41) ((_ to_fp 11 53) (_ bv4611686018427387904 64)))))
 (not (fp.lt ?x66 (fp.sub roundNearestTiesToEven ((_ to_fp 11 53) (_ bv9223372036854775808 64)) ?x70)))))))))))))))))
(assert
 (not false))
(check-sat)
(exit)
