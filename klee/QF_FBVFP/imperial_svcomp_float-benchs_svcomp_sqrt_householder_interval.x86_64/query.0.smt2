...
Corresponding query: An equisatisfiable query (arrays replaced with bitvectors) is available at QF_BVFP/20170428-Liew-KLEE/imperial_svcomp_float-benchs_svcomp_sqrt_householder_interval.x86_64/query.0.smt2
|)
...
(let (($x38 (and (fp.geq ((_ to_fp 11 53) ?x30) ((_ to_fp 11 53) (_ bv4591870180066957722 64))) (fp.leq ((_ to_fp 11 53) ?x30) ((_ to_fp 11 53) (_ bv4626322717216342016 64))))))
(not (not $x38))))))))
(check-sat)
(exit)
