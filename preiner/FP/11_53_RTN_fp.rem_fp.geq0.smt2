...
(define-fun IC ((s FP) (t FP)) Bool (and (ite (fp.isNegative t) (not (fp.isNaN s)) (and (fp.leq (fp.abs (fp.add RNE t t)) (fp.abs s)) (not (fp.isInfinite t)))) (not (fp.isZero s))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (fp.geq (fp.rem x s) t))
 )
)
