...
(define-fun IC ((s FP) (t FP)) Bool (and (or (fp.isNormal t) (fp.isSubnormal t) (ite (fp.isSubnormal s) (or (fp.isZero t) (fp.isInfinite t)) (ite (fp.isInfinite t) (not (fp.isZero s)) (and (fp.isZero t) (not (fp.isInfinite s)))))) (not (fp.isNaN s))))

(assert
 (distinct
  (IC s u)
  (exists ((x FP)) (fp.isInfinite (fp.fma RNE s u x)))
 )
)
