...
(define-fun IC ((s FP) (t FP)) Bool (and (or (fp.isPositive s) (ite (fp.isInfinite s) (and (fp.isInfinite t) (fp.isNegative t)) (fp.isNegative s))) (not (fp.isNaN t))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (fp.geq (fp.sub RTN s x) t))
 )
)
