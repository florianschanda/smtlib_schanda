...
(define-fun IC ((s FP)) Bool (ite (fp.isSubnormal s) (or (fp.isNegative s) (not (= (fp.abs s) (fp.mul RTP s s)))) (and (not (and (fp.isZero s) (fp.isPositive s))) (not (fp.isInfinite s)) (not (fp.isNaN s)))))

(assert
 (distinct
  (IC s)
  (exists ((x FP)) (fp.isNegative (fp.rem s x)))
 )
)
