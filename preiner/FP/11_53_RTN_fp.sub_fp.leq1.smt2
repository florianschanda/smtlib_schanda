...
(define-fun IC ((s FP) (t FP)) Bool (and (or (fp.isNormal s) (fp.isNegative s) (fp.isSubnormal s) (fp.isZero s) (and (fp.isInfinite t) (fp.isPositive s) (not (fp.isNegative t)))) (not (fp.isNaN t))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (fp.leq (fp.sub RTN s x) t))
 )
)
