...
(define-fun IC ((s FP) (t FP)) Bool (or (= t (fp.sub R (fp.add RTP s t) s)) (= t (fp.sub R (fp.add RTN s t) s)) (and (not (= s t)) (fp.isInfinite s) (fp.isInfinite t))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (= (fp.sub RNA x s) t))
 )
)
