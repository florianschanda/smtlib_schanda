...
(define-fun IC ((s FP) (t FP)) Bool (or (fp.isZero (fp.fma R (fp.neg (fp.div RTP t s)) s t))  (fp.isZero (fp.fma R (fp.neg (fp.div RTN t s)) s t)) (and (fp.isZero s) (fp.isZero t))))

(assert
 (distinct
  (IC s u)
  (exists ((x FP)) (fp.isZero (fp.fma RNE x s u)))
 )
)
