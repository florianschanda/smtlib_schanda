...
(define-fun IC ((s FP) (t FP)) Bool (and (ite (fp.isInfinite t) (and (or (fp.isPositive s) (not (fp.isInfinite s))) (not (fp.isNegative t))) (and (or (fp.isPositive s) (not (fp.isInfinite s))) (not (fp.isNaN t)))) (not (fp.isNaN s))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (fp.lt (fp.sub RTZ x s) t))
 )
)
