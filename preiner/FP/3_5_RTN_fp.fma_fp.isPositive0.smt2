...
(define-fun IC ((s FP) (t FP)) Bool (ite (fp.isNegative t) (and (ite (= R RTN) (and (not (fp.isNaN s)) (not (fp.isZero s))) (ite (fp.isZero s) (fp.isZero t) (not (fp.isNaN s)))) (not (fp.isInfinite t))) (and (not (fp.isNaN s)) (not (fp.isNaN t)))))

(assert
 (distinct
  (IC s u)
  (exists ((x FP)) (fp.isPositive (fp.fma RTN x s u)))
 )
)
