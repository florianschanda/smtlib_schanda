...
(define-fun IC ((s FP) (t FP)) Bool (and (or (and (fp.isInfinite t) (not (fp.isNegative t))) (not (fp.isNegative s)) (not (fp.isInfinite s))) (not (fp.isNaN s)) (not (fp.isNaN t))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (fp.leq (fp.sub RTP x s) t))
 )
)
