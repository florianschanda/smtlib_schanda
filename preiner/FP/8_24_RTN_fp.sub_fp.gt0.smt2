...
(define-fun IC ((s FP) (t FP)) Bool (and (ite (fp.isInfinite s) (and (or (fp.isNegative t) (not (fp.isInfinite t))) (not (fp.isPositive s))) (or (fp.isNegative t) (not (fp.isInfinite t)))) (not (fp.isNaN s)) (not (fp.isNaN t))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (fp.gt (fp.sub RTN x s) t))
 )
)
