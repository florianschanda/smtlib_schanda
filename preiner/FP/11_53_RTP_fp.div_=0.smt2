...
(define-fun IC ((s FP) (t FP)) Bool (or (= t (fp.div R (fp.mul RTP s t) s)) (= t (fp.div R (fp.mul RTN s t) s)) (and (fp.isInfinite s) (fp.isZero t)) (and (fp.isInfinite t) (fp.isZero s))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (= (fp.div RTP x s) t))
 )
)
