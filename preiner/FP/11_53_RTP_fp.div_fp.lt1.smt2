...
(define-fun IC ((s FP) (t FP)) Bool (ite (fp.isNegative t) (and (not (fp.isNaN s)) (not (fp.isZero s)) (not (fp.isInfinite t))) (and (not (fp.isNaN s)) (or (not (fp.isZero s)) (not (fp.isZero t))) (not (fp.isNaN t)))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (fp.lt (fp.div RTP s x) t))
 )
)
