...
(define-fun IC ((s FP) (t FP)) Bool (and (ite (fp.isInfinite s) (ite (fp.isNegative s) (and (not (fp.isZero t)) (not (fp.isNegative t))) (and (fp.isNegative t) (not (fp.isZero t)))) (or (and (ite (fp.isNegative t) (fp.isPositive s) (fp.isNegative s)) (not (fp.isZero s))) (not (fp.isInfinite t)))) (not (fp.isNaN s)) (not (fp.isNaN t))))

(assert
 (distinct
  (IC s u)
  (exists ((x FP)) (fp.isNegative (fp.fma RNE s u x)))
 )
)
