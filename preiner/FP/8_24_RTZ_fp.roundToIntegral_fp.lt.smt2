...
(define-fun IC ((t FP)) Bool (or (and (not (fp.isNegative t)) (fp.isPositive t)) (and (fp.isNegative t) (not (fp.isInfinite t)))))

(assert
 (distinct
  (IC t)
  (exists ((x FP)) (fp.lt (fp.roundToIntegral RTZ x) t))
 )
)
