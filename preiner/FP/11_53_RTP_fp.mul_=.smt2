...
(define-fun IC ((s FP) (t FP)) Bool (or (= t (fp.mul R (fp.div RTP t s) s)) (= t (fp.mul R (fp.div RTN t s) s)) (and (fp.isInfinite s) (fp.isInfinite t)) (and (fp.isZero s) (fp.isZero t))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (= (fp.mul RTP x s) t))
 )
)
