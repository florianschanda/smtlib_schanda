...
(define-fun IC ((s FP) (t FP)) Bool (and (not (fp.isInfinite t)) (not (fp.isInfinite s)) (not (fp.isNaN t)) (not (fp.isNaN s)) (not (and (fp.isZero s) (or (fp.isZero t) (fp.isSubnormal t)))) (or (fp.isNormal t) (fp.isNormal s) (fp.isNormal (fp.fma (ite (or (= R RTN) (= R RTP)) RNE R) s (ite (= (fp.isPositive s) (fp.isPositive t)) posMaxNormal (fp.neg posMaxNormal)) t)))))

(assert
 (distinct
  (IC s u)
  (exists ((x FP)) (fp.isNormal (fp.fma RTZ x s u)))
 )
)
