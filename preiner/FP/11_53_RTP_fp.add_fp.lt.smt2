...
(define-fun IC ((s FP) (t FP)) Bool (and (ite (and (not (fp.isZero s)) (not (fp.isNegative s)) (not (fp.isNormal s))) (and (fp.isSubnormal s) (or (not (fp.isNegative t)) (not (fp.isInfinite t)))) (or (not (fp.isNegative t)) (not (fp.isInfinite t)))) (not (fp.isNaN t))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (fp.lt (fp.add RTP x s) t))
 )
)
