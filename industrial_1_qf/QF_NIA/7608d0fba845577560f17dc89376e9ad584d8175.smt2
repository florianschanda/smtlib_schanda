...
(assert (=> (not (= (spoon_1 cat_5 10) 0)) (and (= cat_10 (* cat_28 10)) (spoon_2 (* cat_28 10)))))
...
(assert (=> (not (= (spoon_1 cat_5 10) 0)) (=> (not (= cat_15 true)) (and (= cat_11 (* cat_28 10)) (spoon_2 (* cat_28 10))))))
