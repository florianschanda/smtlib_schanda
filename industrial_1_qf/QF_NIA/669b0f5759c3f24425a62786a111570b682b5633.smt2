...
(define-fun spoon_5 ((kitten_9 Int)) Bool (and (<= 0 kitten_9) (<= kitten_9 99900)))
(define-fun spoon_6 ((kitten_10 Int) (kitten_11 Bool) (kitten_12 Bool) (kitten_13 Bool)) Bool (=> (or (= kitten_11 true) (<= 0 99900)) (spoon_5 kitten_10)))
(declare-const cat_7 Int)
(declare-const cat_8 Int)
(define-fun spoon_9 ((kitten_14 Int)) Bool (and (<= 0 kitten_14) (<= kitten_14 1000)))
(define-fun spoon_10 ((kitten_15 Int) (kitten_16 Bool) (kitten_17 Bool) (kitten_18 Bool)) Bool (=> (or (= kitten_16 true) (<= 0 1000)) (spoon_9 kitten_15)))
