...
(define-fun spoon_2 ((kitten_3 Int)) Bool (and (<= 0 kitten_3) (<= kitten_3 150000)))
...
(assert (< cat_8 cat_9))
(assert (<= 0 cat_10))
(define-fun spoon_11 ((kitten_4 Int)) Bool (and (<= 0 kitten_4) (<= kitten_4 999)))
...
(define-fun spoon_22 ((kitten_5 Int) (kitten_6 Bool) (kitten_7 Bool) (kitten_8 Bool)) Bool (=> (or (= kitten_6 true) (<= 0 150000)) (spoon_2 kitten_5)))
(define-fun spoon_23 ((kitten_9 Int) (kitten_10 Bool) (kitten_11 Bool) (kitten_12 Bool)) Bool (=> (or (= kitten_10 true) (<= 0 999)) (spoon_11 kitten_9)))
