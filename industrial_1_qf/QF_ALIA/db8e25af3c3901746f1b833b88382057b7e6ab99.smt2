...
(assert (<= 0 cat_28))
(assert (<= cat_28 999))
(assert (not (= cat_29 true)))
(assert (and (=> (<= 0 999) (spoon_4 cat_30)) (and (<= 0 cat_30) (<= cat_30 999))))
(assert (not (= (select cat_16 cat_30) true)))
(assert (not (= cat_30 999)))
(assert (= cat_32 cat_30))
(assert (= cat_33 (+ cat_30 1)))
(assert (not (not (= cat_31 true))))
(check-sat)
