...
(define-fun spoon_9 ((kitten_8 Int) (kitten_9 Bool) (kitten_10 Bool) (kitten_11 Bool)) Bool (=> (or (= kitten_9 true) (<= 0 500000)) (spoon_4 kitten_8)))
(declare-const cat_10 Int)
(declare-const cat_11 Int)
(assert (spoon_2 cat_5))
(assert (spoon_2 cat_7))
(assert (not (spoon_1 (abs (- cat_5 cat_7)))))
(check-sat)
