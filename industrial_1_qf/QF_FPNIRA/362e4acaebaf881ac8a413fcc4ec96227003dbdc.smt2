...
(define-fun spoon_16 ((kitten_23 Float32)) Bool (and (spoon_1 kitten_23) (and (fp.leq (fp #b0 #b01110101 #b00000110001001001000100) kitten_23) (fp.leq kitten_23 (fp #b0 #b10010010 #b11101000010010000000000)))))
(define-fun spoon_17 ((kitten_24 Float32) (kitten_25 Bool) (kitten_26 Bool) (kitten_27 Bool)) Bool (=> (or (= kitten_25 true) (fp.leq (fp #b0 #b01110101 #b00000110001001001000100) (fp #b0 #b10010010 #b11101000010010000000000))) (spoon_16 kitten_24)))
(define-fun spoon_18 ((kitten_28 Float32)) Bool (and (spoon_1 kitten_28) (and (fp.leq (fp.neg (fp #b0 #b10000000 #b01000000000000000000000)) kitten_28) (fp.leq kitten_28 (fp #b0 #b10000001 #b01100000000000000000000)))))
(define-fun spoon_19 ((kitten_29 Float32) (kitten_30 Bool) (kitten_31 Bool) (kitten_32 Bool)) Bool (=> (or (= kitten_30 true) (fp.leq (fp.neg (fp #b0 #b10000000 #b01000000000000000000000)) (fp #b0 #b10000001 #b01100000000000000000000))) (spoon_18 kitten_29)))
(define-fun spoon_20 ((kitten_33 Float32)) Bool (and (spoon_1 kitten_33) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_33) (fp.leq kitten_33 (fp #b0 #b11111110 #b11111111111111111111111)))))
(define-fun spoon_21 ((kitten_34 Float32) (kitten_35 Bool) (kitten_36 Bool) (kitten_37 Bool)) Bool (=> (or (= kitten_35 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (spoon_20 kitten_34)))
...
(assert (not (fp.lt (fp.abs cat_24) (fp #b0 #b01100100 #b01010111100110001110111))))
