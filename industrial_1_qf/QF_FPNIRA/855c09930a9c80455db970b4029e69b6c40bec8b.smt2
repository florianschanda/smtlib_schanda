...
(assert (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_38)))
(assert (fp.lt cat_38 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (not (spoon_29 (fp.add RNE cat_38 (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
