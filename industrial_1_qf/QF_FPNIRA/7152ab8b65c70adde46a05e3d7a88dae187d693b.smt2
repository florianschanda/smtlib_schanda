...
(assert (and (= cat_34 cat_42) (and (spoon_1 cat_34) (=> (fp.eq cat_29 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq cat_34 (fp #b0 #b00000000 #b00000000000000000000000))))))
(assert (= cat_36 cat_33))
(assert (= cat_37 cat_34))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_37) (= cat_38 cat_37)))
(assert (=> (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_37) (= cat_39 (fp #b0 #b10000101 #b01101000000000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_37)) (=> (fp.lt cat_37 (fp.neg (fp #b0 #b10000101 #b01101000000000000000000))) (= cat_40 cat_37))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_37)) (=> (fp.lt cat_37 (fp.neg (fp #b0 #b10000101 #b01101000000000000000000))) (= cat_41 (fp.neg (fp #b0 #b10000101 #b01101000000000000000000))))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_37)) (=> (not (fp.lt cat_37 (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)))) (= cat_41 cat_37))))
(assert (=> (not (fp.lt (fp #b0 #b10000101 #b01101000000000000000000) cat_37)) (= cat_39 cat_41)))
