...
(define-fun spoon_28 ((kitten_27 Int)) Bool (and (<= 1 kitten_27) (<= kitten_27 30)))
...
(define-fun spoon_49 ((kitten_29 Float32) (kitten_30 Bool) (kitten_31 Bool) (kitten_32 Bool)) Bool (=> (or (= kitten_30 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_17 kitten_29)))
(define-fun spoon_50 ((kitten_33 Int) (kitten_34 Bool) (kitten_35 Bool) (kitten_36 Bool)) Bool (=> (or (= kitten_34 true) (<= 1 30)) (spoon_28 kitten_33)))
(define-fun spoon_51 ((kitten_37 Int) (kitten_38 Bool) (kitten_39 Bool) (kitten_40 Bool)) Bool (=> (or (= kitten_38 true) (<= 3 30)) (spoon_29 kitten_37)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_26 cat_52)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_26 cat_53)))
(assert (not (= cat_55 true)))
(assert (= cat_56 cat_53))
(assert (= cat_57 (fp #b0 #b10001100 #b01101010100000000000000)))
