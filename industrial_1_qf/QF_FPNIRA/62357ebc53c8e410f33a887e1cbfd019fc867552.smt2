...
(define-fun spoon_32 ((kitten_27 Float32) (kitten_28 Bool) (kitten_29 Bool) (kitten_30 Bool)) Bool (=> (or (= kitten_28 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_17 kitten_27)))
...
(assert (=> (fp.leq (fp.neg (fp #b0 #b10011010 #b00000000000000000000000)) (fp #b0 #b10011010 #b00000000000000000000000)) (spoon_28 cat_33)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b10011010 #b00000000000000000000000)) (fp #b0 #b10011010 #b00000000000000000000000)) (spoon_28 cat_34)))
(assert (= cat_37 cat_33))
(assert (= cat_39 cat_34))
(assert (=> (not (fp.lt cat_38 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_38)) (=> (not (fp.lt cat_40 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_40)))))
(assert (not false))
(check-sat)
