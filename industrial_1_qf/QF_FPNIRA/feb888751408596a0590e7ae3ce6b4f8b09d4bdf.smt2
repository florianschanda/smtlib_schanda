...
(define-fun spoon_22 ((kitten_32 Float32)) Bool (and (spoon_1 kitten_32) (and (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) kitten_32) (fp.leq kitten_32 (fp #b0 #b10000110 #b01101000000000000000000)))))
(define-fun spoon_23 ((kitten_33 Float32) (kitten_34 Float32)) Bool (ite (fp.eq kitten_33 kitten_34) true false))
(define-fun spoon_24 ((kitten_35 Float32) (kitten_36 Bool) (kitten_37 Bool) (kitten_38 Bool)) Bool (=> (or (= kitten_36 true) (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) (fp #b0 #b10000110 #b01101000000000000000000))) (spoon_22 kitten_35)))
...
(assert (=> (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) (fp #b0 #b10000110 #b01101000000000000000000)) (spoon_22 cat_30)))
(assert (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) (fp.add RNE cat_25 cat_27)))
(assert (not (spoon_22 (fp.sub RNE (fp.add RNE cat_25 cat_27) (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
