...
(define-fun spoon_14 ((kitten_18 Float32)) Bool (and (spoon_1 kitten_18) (and (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) kitten_18) (fp.leq kitten_18 (fp #b0 #b10000110 #b01101000000000000000000)))))
(define-fun spoon_15 ((kitten_19 Float32) (kitten_20 Bool) (kitten_21 Bool) (kitten_22 Bool)) Bool (=> (or (= kitten_20 true) (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) (fp #b0 #b10000110 #b01101000000000000000000))) (spoon_14 kitten_19)))
...
(assert (=> (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) (fp #b0 #b10000110 #b01101000000000000000000)) (spoon_14 cat_21)))
(assert (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) (fp.add RNE cat_16 cat_18)))
(assert (not (spoon_14 (fp.sub RNE (fp.add RNE cat_16 cat_18) (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
