...
(define-fun spoon_16 ((kitten_20 Float32) (kitten_21 Bool) (kitten_22 Bool) (kitten_23 Bool)) Bool (=> (or (= kitten_21 true) (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) (fp #b0 #b10000110 #b01101000000000000000000))) (spoon_15 kitten_20)))
...
(assert (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) (fp.add RNE cat_17 cat_19)))
(assert (not (spoon_15 (fp.sub RNE (fp.add RNE cat_17 cat_19) (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
