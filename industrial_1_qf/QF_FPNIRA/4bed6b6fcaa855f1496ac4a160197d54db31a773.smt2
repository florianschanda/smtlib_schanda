...
(assert (and (= cat_139 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_161)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_161))))
(assert (= cat_140 (ite (fp.leq cat_171 cat_139) true false)))
