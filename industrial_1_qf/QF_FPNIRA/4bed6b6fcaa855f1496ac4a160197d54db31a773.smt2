...
(assert (and (= cat_165 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_187)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_187))))
(assert (= cat_166 (ite (fp.leq cat_197 cat_165) true false)))
