...
(define-fun spoon_60 ((kitten_47 Float32) (kitten_48 Bool) (kitten_49 Bool) (kitten_50 Bool)) Bool (=> (or (= kitten_48 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_25 kitten_47)))
(define-fun spoon_61 ((kitten_51 Int) (kitten_52 Bool) (kitten_53 Bool) (kitten_54 Bool)) Bool (=> (or (= kitten_52 true) (<= 1 30)) (spoon_38 kitten_51)))
(define-fun spoon_62 ((kitten_55 Int) (kitten_56 Bool) (kitten_57 Bool) (kitten_58 Bool)) Bool (=> (or (= kitten_56 true) (<= 3 30)) (spoon_39 kitten_55)))
...
(assert (spoon_35 cat_53))
(assert (= cat_68 cat_63))
(assert (= cat_69 (spoon_23 0)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000)) (spoon_35 cat_64)))
(assert (not false))
(check-sat)
