...
(define-fun spoon_51 ((kitten_30 Float32) (kitten_31 Bool) (kitten_32 Bool) (kitten_33 Bool)) Bool (=> (or (= kitten_31 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_18 kitten_30)))
(define-fun spoon_52 ((kitten_34 Int) (kitten_35 Bool) (kitten_36 Bool) (kitten_37 Bool)) Bool (=> (or (= kitten_35 true) (<= 1 30)) (spoon_29 kitten_34)))
(define-fun spoon_53 ((kitten_38 Int) (kitten_39 Bool) (kitten_40 Bool) (kitten_41 Bool)) Bool (=> (or (= kitten_39 true) (<= 3 30)) (spoon_30 kitten_38)))
...
(assert (spoon_27 cat_44))
(assert (= cat_59 cat_54))
(assert (= cat_60 (spoon_16 0)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000)) (spoon_27 cat_55)))
(assert (not false))
(check-sat)
