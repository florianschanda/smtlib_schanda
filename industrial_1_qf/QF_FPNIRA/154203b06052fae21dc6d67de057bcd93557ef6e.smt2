...
(define-fun spoon_50 ((kitten_29 Float32) (kitten_30 Bool) (kitten_31 Bool) (kitten_32 Bool)) Bool (=> (or (= kitten_30 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_17 kitten_29)))
(define-fun spoon_51 ((kitten_33 Int) (kitten_34 Bool) (kitten_35 Bool) (kitten_36 Bool)) Bool (=> (or (= kitten_34 true) (<= 1 30)) (spoon_28 kitten_33)))
(define-fun spoon_52 ((kitten_37 Int) (kitten_38 Bool) (kitten_39 Bool) (kitten_40 Bool)) Bool (=> (or (= kitten_38 true) (<= 3 30)) (spoon_29 kitten_37)))
...
(assert (spoon_26 cat_43))
(assert (= cat_58 cat_53))
(assert (= cat_59 (spoon_15 0)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000)) (spoon_26 cat_54)))
(assert (not false))
(check-sat)
