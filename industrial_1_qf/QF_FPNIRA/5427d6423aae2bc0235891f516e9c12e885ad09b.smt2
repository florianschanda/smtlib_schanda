...
(define-fun spoon_15 ((kitten_22 Float32)) Bool (and (spoon_1 kitten_22) (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) kitten_22) (fp.leq kitten_22 (fp #b0 #b10000101 #b01101000000000000000000)))))
(define-fun spoon_16 ((kitten_23 Float32)) Bool (and (spoon_1 kitten_23) (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) kitten_23) (fp.leq kitten_23 (fp #b0 #b01111111 #b00000000000000000000000)))))
(define-fun spoon_17 ((kitten_24 Float32) (kitten_25 Bool) (kitten_26 Bool) (kitten_27 Bool)) Bool (=> (or (= kitten_25 true) (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_16 kitten_24)))
(declare-const cat_18 Float32)
(declare-const cat_19 Int)
(declare-const cat_20 Int)
(define-fun spoon_21 ((kitten_28 Float32) (kitten_29 Bool) (kitten_30 Bool) (kitten_31 Bool)) Bool (=> (or (= kitten_29 true) (fp.leq (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) (fp #b0 #b10000101 #b01101000000000000000000))) (spoon_15 kitten_28)))
