...
(define-fun spoon_16 ((kitten_23 Float32)) Bool (and (spoon_1 kitten_23) (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) kitten_23) (fp.leq kitten_23 (fp #b0 #b10000101 #b01101000000000000000000)))))
(define-fun spoon_17 ((kitten_24 Float32)) Bool (and (spoon_1 kitten_24) (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) kitten_24) (fp.leq kitten_24 (fp #b0 #b01111111 #b00000000000000000000000)))))
(define-fun spoon_18 ((kitten_25 Float32) (kitten_26 Bool) (kitten_27 Bool) (kitten_28 Bool)) Bool (=> (or (= kitten_26 true) (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_17 kitten_25)))
(declare-const cat_19 Float32)
(declare-const cat_20 Int)
(declare-const cat_21 Int)
(define-fun spoon_22 ((kitten_29 Float32) (kitten_30 Bool) (kitten_31 Bool) (kitten_32 Bool)) Bool (=> (or (= kitten_30 true) (fp.leq (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) (fp #b0 #b10000101 #b01101000000000000000000))) (spoon_16 kitten_29)))
