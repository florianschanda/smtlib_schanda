...
(define-fun spoon_24 ((kitten_38 Float32)) Bool (and (spoon_1 kitten_38) (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) kitten_38) (fp.leq kitten_38 (fp #b0 #b10000101 #b01101000000000000000000)))))
(define-fun spoon_25 ((kitten_39 Float32) (kitten_40 Float32)) Bool (ite (fp.eq kitten_39 kitten_40) true false))
(define-fun spoon_26 ((kitten_41 Float32)) Bool (and (spoon_1 kitten_41) (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) kitten_41) (fp.leq kitten_41 (fp #b0 #b01111111 #b00000000000000000000000)))))
(define-fun spoon_27 ((kitten_42 Float32) (kitten_43 Float32)) Bool (ite (fp.eq kitten_42 kitten_43) true false))
(define-fun spoon_28 ((kitten_44 Float32) (kitten_45 Bool) (kitten_46 Bool) (kitten_47 Bool)) Bool (=> (or (= kitten_45 true) (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_26 kitten_44)))
(declare-const cat_29 Float32)
(declare-const cat_30 Int)
(declare-const cat_31 Int)
(define-fun spoon_32 ((kitten_48 Float32) (kitten_49 Bool) (kitten_50 Bool) (kitten_51 Bool)) Bool (=> (or (= kitten_49 true) (fp.leq (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) (fp #b0 #b10000101 #b01101000000000000000000))) (spoon_24 kitten_48)))
...
(assert (spoon_26 cat_29))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (spoon_1 cat_33)))
