...
(assert (= cat_45 cat_40))
(assert (spoon_1 cat_40))
(assert (and (= cat_46 (fp.add RNE cat_38 cat_40)) (spoon_1 (fp.add RNE cat_38 cat_40))))
(assert (not (or (fp.isZero cat_46) (fp.isPositive cat_46))))
(check-sat)
