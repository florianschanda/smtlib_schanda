...
(assert (=> (= cat_160 true) (and (= cat_108 (fp.sub RNE cat_161 cat_159)) (spoon_1 (fp.sub RNE cat_161 cat_159)))))
(assert (=> (= cat_160 true) (= cat_109 (fp.add RNE cat_108 (fp.mul RNE cat_156 cat_156)))))
(assert (=> (= cat_160 true) (and (= cat_110 cat_109) (spoon_1 cat_109))))
(assert (=> (= cat_160 true) (= cat_163 cat_110)))
(assert (=> (= cat_160 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_163) (and (= cat_111 cat_163) (spoon_1 cat_163)))))
(declare-const cat_172 Float32)
(assert (=> (= cat_160 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_163) (and (= cat_112 cat_172) (spoon_59 cat_112)))))
(assert (=> (= cat_160 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_163) (= cat_164 cat_112))))
(assert (=> (= cat_160 true) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_163) (= cat_165 cat_160))))
(assert (=> (= cat_160 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_163)) (= cat_165 (spoon_29 0)))))
(assert (=> (= cat_160 true) (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_163)) (= cat_164 cat_149))))
(assert (=> (not (= cat_160 true)) (= cat_163 cat_150)))
(assert (=> (not (= cat_160 true)) (= cat_164 cat_149)))
(assert (=> (not (= cat_160 true)) (= cat_165 cat_160)))
(assert (= cat_165 true))
(assert (and (= cat_117 (fp.mul RNE cat_164 cat_72)) (spoon_1 (fp.mul RNE cat_164 cat_72))))
(assert (and (= cat_113 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_68 cat_68)) cat_159)) (spoon_1 (fp.add RNE ((_ to_fp 8 24) RNE (fp.mul RNE cat_68 cat_68)) cat_159))))
(assert (= cat_114 (fp.mul RNE cat_162 cat_113)))
(assert (and (= cat_115 cat_114) (spoon_1 cat_114)))
(assert (= cat_116 (fp.mul RNE cat_115 cat_156)))
(assert (and (= cat_118 cat_116) (spoon_1 cat_116)))
(assert (= cat_119 (fp.sub RNE cat_118 cat_117)))
(assert (and (= cat_120 cat_119) (spoon_1 cat_119)))
(assert (= cat_166 cat_120))
(assert (and (= cat_121 (fp.mul RNE cat_164 cat_72)) (spoon_1 (fp.mul RNE cat_164 cat_72))))
(assert (= cat_122 (fp.mul RNE cat_121 cat_156)))
(assert (and (= cat_123 cat_122) (spoon_1 cat_122)))
(assert (and (= cat_124 (fp.mul RNE cat_162 cat_163)) (spoon_1 (fp.mul RNE cat_162 cat_163))))
(assert (= cat_125 (fp.sub RNE cat_124 cat_123)))
(assert (and (= cat_126 cat_125) (spoon_1 cat_125)))
(assert (= cat_167 cat_126))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_167) (and (= cat_135 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_167)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_167)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_167) (and (= cat_136 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_167) (= cat_137 (ite (fp.leq cat_136 cat_135) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_167) (and (= cat_133 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_167) (and (= cat_134 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_167)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_167)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_167) (= cat_138 (ite (fp.leq cat_134 cat_133) true false))))
(declare-const cat_173 Bool)
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_167) (= cat_169 cat_173)))
(assert (=> (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_167)) (= cat_169 false)))
(assert (not (= cat_169 true)))
(assert (fp.lt cat_167 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (and (= cat_129 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_167)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_167))))
(assert (and (= cat_130 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166))))
(assert (= cat_131 (ite (fp.leq cat_130 cat_129) true false)))
(assert (and (= cat_127 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166))))
(assert (not (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_167))))
(check-sat)
