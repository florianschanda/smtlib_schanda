...
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_165) (and (= cat_133 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_165)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_165)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_165) (and (= cat_134 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_164)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_164)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_165) (= cat_135 (ite (fp.leq cat_134 cat_133) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_165) (and (= cat_131 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_164)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_164)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_165) (and (= cat_132 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_165)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_165)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_165) (= cat_136 (ite (fp.leq cat_132 cat_131) true false))))
(declare-const cat_171 Bool)
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_165) (= cat_167 cat_171)))
(assert (=> (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_165)) (= cat_167 false)))
(assert (not (= cat_167 true)))
(assert (fp.lt cat_165 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (and (= cat_127 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_165)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_165))))
(assert (and (= cat_128 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_164)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_164))))
(assert (= cat_129 (ite (fp.leq cat_128 cat_127) true false)))
(assert (and (= cat_125 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_164)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_164))))
(assert (not (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_165))))
(check-sat)
