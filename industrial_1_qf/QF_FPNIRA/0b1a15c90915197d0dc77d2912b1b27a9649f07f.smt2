...
(assert (and (= cat_146 (fp.mul RNE cat_189 cat_96)) (spoon_1 (fp.mul RNE cat_189 cat_96))))
(assert (= cat_147 (fp.mul RNE cat_146 cat_181)))
(assert (and (= cat_148 cat_147) (spoon_1 cat_147)))
(assert (and (= cat_149 (fp.mul RNE cat_187 cat_188)) (spoon_1 (fp.mul RNE cat_187 cat_188))))
(assert (= cat_150 (fp.sub RNE cat_149 cat_148)))
(assert (and (= cat_151 cat_150) (spoon_1 cat_150)))
(assert (= cat_192 cat_151))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_192) (and (= cat_160 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_192)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_192)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_192) (and (= cat_161 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_192) (= cat_162 (ite (fp.leq cat_161 cat_160) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_192) (and (= cat_158 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_192) (and (= cat_159 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_192)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_192)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_192) (= cat_163 (ite (fp.leq cat_159 cat_158) true false))))
(declare-const cat_198 Bool)
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_192) (= cat_194 cat_198)))
(assert (=> (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_192)) (= cat_194 false)))
(assert (not (= cat_194 true)))
(assert (fp.lt cat_192 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (and (= cat_154 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_192)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_192))))
(assert (and (= cat_155 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191))))
(assert (= cat_156 (ite (fp.leq cat_155 cat_154) true false)))
(assert (and (= cat_152 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191))))
(assert (not (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_192))))
(check-sat)
