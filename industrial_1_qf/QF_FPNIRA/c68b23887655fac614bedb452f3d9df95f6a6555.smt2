...
(assert (not (fp.lt cat_159 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_159)))
(assert (not (spoon_61 cat_159)))
(check-sat)
