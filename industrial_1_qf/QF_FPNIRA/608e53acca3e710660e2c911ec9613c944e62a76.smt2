...
(define-fun spoon_16 ((kitten_20 Float32) (kitten_21 Bool) (kitten_22 Bool) (kitten_23 Bool)) Bool (=> (or (= kitten_21 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000))) (spoon_15 kitten_20)))
...
(assert (fp.leq cat_17 (fp.sub RNE (fp #b0 #b10010011 #b00000001101101110000000) cat_19)))
(assert (not (spoon_15 (fp.add RNE cat_17 cat_19))))
(check-sat)
