...
(define-fun spoon_14 ((kitten_18 Float32)) Bool (and (spoon_1 kitten_18) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_18) (fp.leq kitten_18 (fp #b0 #b10010011 #b00000001101101110000000)))))
(define-fun spoon_15 ((kitten_19 Float32) (kitten_20 Bool) (kitten_21 Bool) (kitten_22 Bool)) Bool (=> (or (= kitten_20 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000))) (spoon_14 kitten_19)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000)) (spoon_14 cat_21)))
(assert (fp.leq cat_16 (fp.sub RNE (fp #b0 #b10010011 #b00000001101101110000000) cat_18)))
(assert (not (spoon_14 (fp.add RNE cat_16 cat_18))))
(check-sat)
