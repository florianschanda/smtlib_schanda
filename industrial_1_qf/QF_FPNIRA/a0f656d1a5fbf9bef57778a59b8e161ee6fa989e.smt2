...
(assert (=> (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_38) (and (= cat_34 (fp.sub RNE cat_38 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.sub RNE cat_38 (fp #b0 #b10000111 #b01101000000000000000000))))))
(assert (=> (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_38) (= cat_39 cat_38)))
(assert (=> (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_38) (= cat_40 cat_34)))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_38)) (=> (fp.lt cat_38 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_35 (fp.add RNE cat_38 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.add RNE cat_38 (fp #b0 #b10000111 #b01101000000000000000000)))))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_38)) (=> (fp.lt cat_38 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_41 cat_38))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_38)) (=> (fp.lt cat_38 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_42 cat_35))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_38)) (=> (not (fp.lt cat_38 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_42 cat_38))))
(assert (=> (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_38)) (= cat_40 cat_42)))
(assert (not (spoon_22 cat_40)))
(check-sat)
