...
(define-fun spoon_24 ((kitten_38 Float32)) Bool (and (spoon_1 kitten_38) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_38) (fp.leq kitten_38 (fp #b0 #b10000110 #b01101000000000000000000)))))
...
(define-fun spoon_32 ((kitten_48 Float32) (kitten_49 Bool) (kitten_50 Bool) (kitten_51 Bool)) Bool (=> (or (= kitten_49 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000110 #b01101000000000000000000))) (spoon_24 kitten_48)))
...
(assert (not (fp.leq (fp.abs cat_29) (fp #b0 #b01111111 #b00000000000000000000000))))
(check-sat)
