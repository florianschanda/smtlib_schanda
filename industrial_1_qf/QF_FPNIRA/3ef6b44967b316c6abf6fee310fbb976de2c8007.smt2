...
(define-fun spoon_15 ((kitten_22 Float32)) Bool (and (spoon_1 kitten_22) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_22) (fp.leq kitten_22 (fp #b0 #b10000110 #b01101000000000000000000)))))
...
(define-fun spoon_21 ((kitten_28 Float32) (kitten_29 Bool) (kitten_30 Bool) (kitten_31 Bool)) Bool (=> (or (= kitten_29 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000110 #b01101000000000000000000))) (spoon_15 kitten_28)))
...
(assert (not (fp.leq (fp.abs cat_18) (fp #b0 #b01111111 #b00000000000000000000000))))
(check-sat)
