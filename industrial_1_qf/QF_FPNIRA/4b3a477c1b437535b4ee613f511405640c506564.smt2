...
(assert (and (= cat_135 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_162)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_162))))
(assert (= cat_136 (ite (fp.leq cat_161 cat_135) true false)))
