...
(assert (not (= cat_193 true)))
(assert (fp.lt cat_191 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))
(assert (and (= cat_164 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_191)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_191))))
(assert (= cat_165 (ite (fp.leq cat_190 cat_164) true false)))
