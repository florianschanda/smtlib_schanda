...
(assert (=> (fp.lt cat_115 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_121 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (fp.lt cat_115 (fp #b0 #b01101011 #b00001100011011110111101))) (and (= cat_83 (fp.div RNE cat_112 cat_115)) (spoon_1 (fp.div RNE cat_112 cat_115)))))
(assert (=> (not (fp.lt cat_115 (fp #b0 #b01101011 #b00001100011011110111101))) (and (= cat_84 cat_83) (spoon_1 cat_83))))
(assert (=> (not (fp.lt cat_115 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_122 cat_84)))
(assert (=> (not (fp.lt cat_115 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_121 cat_122)))
(assert (=> (fp.lt cat_102 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_123 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (fp.lt cat_102 (fp #b0 #b01101011 #b00001100011011110111101))) (and (= cat_85 (fp.div RNE cat_111 cat_102)) (spoon_1 (fp.div RNE cat_111 cat_102)))))
(assert (=> (not (fp.lt cat_102 (fp #b0 #b01101011 #b00001100011011110111101))) (and (= cat_86 cat_85) (spoon_1 cat_85))))
(assert (=> (not (fp.lt cat_102 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_124 cat_86)))
(assert (=> (not (fp.lt cat_102 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_123 cat_124)))
(assert (not false))
(check-sat)
