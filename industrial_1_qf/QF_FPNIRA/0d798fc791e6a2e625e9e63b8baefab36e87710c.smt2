...
(define-fun spoon_28 ((kitten_27 Float32)) Bool (and (spoon_1 kitten_27) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_27) (fp.leq kitten_27 (fp #b0 #b10001001 #b01110111000000000000000)))))
...
(assert (<= 0 cat_36))
(define-fun spoon_37 ((kitten_28 Int)) Bool (and (<= 1 kitten_28) (<= kitten_28 100)))
(define-fun spoon_38 ((kitten_29 Int)) Bool (and (<= 3 kitten_29) (<= kitten_29 100)))
...
(assert (<= 0 cat_49))
(define-fun spoon_50 ((kitten_30 Float32)) Bool (and (spoon_1 kitten_30) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_30) (fp.leq kitten_30 (fp #b0 #b01111111 #b00000000000000000000000)))))
(define-fun spoon_51 ((kitten_31 Float32) (kitten_32 Bool) (kitten_33 Bool) (kitten_34 Bool)) Bool (=> (or (= kitten_32 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_50 kitten_31)))
...
(define-fun spoon_60 ((kitten_35 Float32) (kitten_36 Bool) (kitten_37 Bool) (kitten_38 Bool)) Bool (=> (or (= kitten_36 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_17 kitten_35)))
(define-fun spoon_61 ((kitten_39 Float32) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool)) Bool (=> (or (= kitten_40 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001001 #b01110111000000000000000))) (spoon_28 kitten_39)))
(define-fun spoon_62 ((kitten_43 Int) (kitten_44 Bool) (kitten_45 Bool) (kitten_46 Bool)) Bool (=> (or (= kitten_44 true) (<= 1 100)) (spoon_37 kitten_43)))
(define-fun spoon_63 ((kitten_47 Int) (kitten_48 Bool) (kitten_49 Bool) (kitten_50 Bool)) Bool (=> (or (= kitten_48 true) (<= 3 100)) (spoon_38 kitten_47)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_26 cat_64)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_26 cat_65)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000)) (spoon_50 cat_66)))
(assert (not (= cat_69 true)))
(assert (= cat_70 cat_64))
(assert (= cat_71 (fp #b0 #b10001100 #b01101010100000000000000)))
(assert (= cat_72 cat_67))
(assert (= cat_73 1))
(assert (<= 1 cat_73))
(assert (and (spoon_50 cat_79) (spoon_26 cat_78)))
(assert (not false))
(check-sat)
