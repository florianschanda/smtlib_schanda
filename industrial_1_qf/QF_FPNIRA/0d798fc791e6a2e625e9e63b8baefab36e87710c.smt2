...
(define-fun spoon_29 ((kitten_28 Float32)) Bool (and (spoon_1 kitten_28) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_28) (fp.leq kitten_28 (fp #b0 #b10001001 #b01110111000000000000000)))))
...
(assert (<= 0 cat_37))
(define-fun spoon_38 ((kitten_29 Int)) Bool (and (<= 1 kitten_29) (<= kitten_29 100)))
(define-fun spoon_39 ((kitten_30 Int)) Bool (and (<= 3 kitten_30) (<= kitten_30 100)))
...
(assert (<= 0 cat_50))
(define-fun spoon_51 ((kitten_31 Float32)) Bool (and (spoon_1 kitten_31) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_31) (fp.leq kitten_31 (fp #b0 #b01111111 #b00000000000000000000000)))))
(define-fun spoon_52 ((kitten_32 Float32) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool)) Bool (=> (or (= kitten_33 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_51 kitten_32)))
...
(define-fun spoon_61 ((kitten_36 Float32) (kitten_37 Bool) (kitten_38 Bool) (kitten_39 Bool)) Bool (=> (or (= kitten_37 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_18 kitten_36)))
(define-fun spoon_62 ((kitten_40 Float32) (kitten_41 Bool) (kitten_42 Bool) (kitten_43 Bool)) Bool (=> (or (= kitten_41 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001001 #b01110111000000000000000))) (spoon_29 kitten_40)))
(define-fun spoon_63 ((kitten_44 Int) (kitten_45 Bool) (kitten_46 Bool) (kitten_47 Bool)) Bool (=> (or (= kitten_45 true) (<= 1 100)) (spoon_38 kitten_44)))
(define-fun spoon_64 ((kitten_48 Int) (kitten_49 Bool) (kitten_50 Bool) (kitten_51 Bool)) Bool (=> (or (= kitten_49 true) (<= 3 100)) (spoon_39 kitten_48)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_27 cat_66)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000)) (spoon_51 cat_67)))
(assert (not (= cat_70 true)))
(assert (= cat_71 cat_65))
(assert (= cat_72 (fp #b0 #b10001100 #b01101010100000000000000)))
(assert (= cat_73 cat_68))
(assert (= cat_74 1))
(assert (<= 1 cat_74))
(assert (and (spoon_51 cat_80) (spoon_27 cat_79)))
(assert (not false))
(check-sat)
