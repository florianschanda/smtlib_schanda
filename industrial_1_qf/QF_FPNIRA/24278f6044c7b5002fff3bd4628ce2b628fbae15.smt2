...
(assert (=> (fp.lt cat_16 cat_18) (= cat_24 cat_21)))
(assert (=> (fp.lt cat_16 cat_18) (= cat_25 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (fp.lt cat_16 cat_18)) (and (= cat_23 (fp.sub RNE cat_16 cat_18)) (spoon_1 (fp.sub RNE cat_16 cat_18)))))
(assert (=> (not (fp.lt cat_16 cat_18)) (= cat_26 cat_21)))
(assert (=> (not (fp.lt cat_16 cat_18)) (= cat_27 cat_23)))
(assert (=> (not (fp.lt cat_16 cat_18)) (= cat_25 cat_27)))
(assert (= cat_29 cat_30))
(assert (= cat_31 cat_29))
(assert (= cat_28 cat_22))
(assert (= cat_29 cat_25))
(assert (= cat_32 cat_25))
(assert (= cat_35 cat_31))
(assert (= cat_34 cat_25))
(assert (= cat_36 cat_33))
(assert (not (fp.eq cat_33 (fp.max (fp #b0 #b00000000 #b00000000000000000000000) (fp.sub RNE cat_16 cat_18)))))
(check-sat)
