...
(assert (and (= cat_134 (fp.sub RNE cat_169 cat_170)) (spoon_2 (fp.sub RNE cat_169 cat_170))))
(assert (= cat_135 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_54) cat_134)))
(assert (and (= cat_136 cat_135) (spoon_2 cat_135)))
(assert (= cat_171 cat_136))
(assert (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_161)))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_161) (and (= cat_143 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_161)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_161)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_161) (= cat_144 (ite (fp.leq cat_171 cat_143) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_161) (and (= cat_142 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_161)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_161)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_161) (= cat_145 (ite (fp.leq cat_142 cat_171) true false))))
(declare-const cat_183 Bool)
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_161) (= cat_173 cat_183)))
(assert (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_161)) (= cat_173 false)))
(assert (not (= cat_173 true)))
(assert (fp.lt cat_161 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))
