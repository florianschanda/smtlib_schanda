...
(define-fun spoon_48 ((kitten_28 Float32) (kitten_29 Bool) (kitten_30 Bool) (kitten_31 Bool)) Bool (=> (or (= kitten_29 true) (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000))) (spoon_28 kitten_28)))
(define-fun spoon_49 ((kitten_32 Float32) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool)) Bool (=> (or (= kitten_33 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_17 kitten_32)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_26 cat_50)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_26 cat_51)))
(assert (= cat_55 cat_52))
(assert (= cat_56 (spoon_15 0)))
(assert (= cat_57 cat_53))
(assert (= cat_58 cat_54))
(assert (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_57))
(assert (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_58))
(assert (not (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_58)))
(check-sat)
