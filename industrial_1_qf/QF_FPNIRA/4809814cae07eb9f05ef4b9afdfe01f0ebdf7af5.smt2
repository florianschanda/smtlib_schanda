...
(assert (and (= cat_34 cat_38) (and (spoon_1 cat_34) (and (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) cat_34) (fp.leq cat_34 (fp #b0 #b01111111 #b00000000000000000000000))) (=> (fp.eq cat_29 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq cat_34 (fp #b0 #b00000000 #b00000000000000000000000)))))))
