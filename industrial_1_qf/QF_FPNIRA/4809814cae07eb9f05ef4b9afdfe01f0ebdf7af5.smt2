...
(assert (and (= cat_24 cat_28) (and (spoon_1 cat_24) (and (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) cat_24) (fp.leq cat_24 (fp #b0 #b01111111 #b00000000000000000000000))) (=> (fp.eq cat_19 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq cat_24 (fp #b0 #b00000000 #b00000000000000000000000)))))))
