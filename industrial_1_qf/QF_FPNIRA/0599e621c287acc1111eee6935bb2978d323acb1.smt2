...
(assert (=> (= cat_173 true) (= cat_172 true)))
(assert (=> (not (= cat_173 true)) (=> (fp.lt cat_161 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_139 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_161)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_161))))))
(assert (=> (not (= cat_173 true)) (=> (fp.lt cat_161 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_140 (ite (fp.leq cat_171 cat_139) true false)))))
(assert (=> (not (= cat_173 true)) (=> (fp.lt cat_161 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_138 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_161)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_161))))))
(assert (=> (not (= cat_173 true)) (=> (fp.lt cat_161 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_141 (ite (fp.leq cat_138 cat_171) true false)))))
(declare-const cat_184 Bool)
(assert (=> (not (= cat_173 true)) (=> (fp.lt cat_161 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_172 cat_184))))
(assert (=> (not (= cat_173 true)) (=> (not (fp.lt cat_161 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_172 false))))
(assert (= cat_172 true))
(assert (not (spoon_2 (fp.div RNE cat_171 cat_161))))
(check-sat)
