...
(assert (=> (= cat_199 true) (= cat_198 true)))
(assert (=> (not (= cat_199 true)) (=> (fp.lt cat_187 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_165 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_187)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_187))))))
(assert (=> (not (= cat_199 true)) (=> (fp.lt cat_187 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_166 (ite (fp.leq cat_197 cat_165) true false)))))
(assert (=> (not (= cat_199 true)) (=> (fp.lt cat_187 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_164 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_187)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_187))))))
(assert (=> (not (= cat_199 true)) (=> (fp.lt cat_187 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_167 (ite (fp.leq cat_164 cat_197) true false)))))
(declare-const cat_210 Bool)
(assert (=> (not (= cat_199 true)) (=> (fp.lt cat_187 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_198 cat_210))))
(assert (=> (not (= cat_199 true)) (=> (not (fp.lt cat_187 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_198 false))))
(assert (= cat_198 true))
(assert (not (spoon_2 (fp.div RNE cat_197 cat_187))))
(check-sat)
