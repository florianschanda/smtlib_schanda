...
(assert (and (= cat_135 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_167)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_167))))
(assert (and (= cat_136 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166))))
(assert (= cat_137 (ite (fp.leq cat_136 cat_135) true false)))
(assert (and (= cat_133 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166))))
(assert (not (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_167))))
(check-sat)
