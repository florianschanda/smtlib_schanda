...
(assert (and (= cat_160 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_192)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_192))))
(assert (and (= cat_161 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191))))
(assert (= cat_162 (ite (fp.leq cat_161 cat_160) true false)))
(assert (and (= cat_158 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191))))
(assert (not (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_192))))
(check-sat)
