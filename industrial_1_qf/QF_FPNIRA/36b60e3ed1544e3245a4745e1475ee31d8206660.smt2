...
(define-fun spoon_24 ((kitten_38 Float32)) Bool (and (spoon_1 kitten_38) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_38) (fp.leq kitten_38 (fp #b0 #b11111110 #b11111111111111111111111)))))
(define-fun spoon_25 ((kitten_39 Float32) (kitten_40 Float32)) Bool (ite (fp.eq kitten_39 kitten_40) true false))
(define-fun spoon_26 ((kitten_41 Float32) (kitten_42 Bool) (kitten_43 Bool) (kitten_44 Bool)) Bool (=> (or (= kitten_42 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (spoon_24 kitten_41)))
(define-fun spoon_27 ((kitten_45 Float32)) Bool (and (spoon_1 kitten_45) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_45) (fp.leq kitten_45 (fp #b0 #b10111111 #b00000000000000000110000)))))
...
(define-fun spoon_32 ((kitten_48 Float32) (kitten_49 Bool) (kitten_50 Bool) (kitten_51 Bool)) Bool (=> (or (= kitten_49 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10111111 #b00000000000000000110000))) (spoon_27 kitten_48)))
(declare-const cat_33 Float32)
(declare-const cat_34 Float32)
(declare-const cat_35 Float32)
(declare-const cat_36 Float32)
(assert (spoon_24 cat_29))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (spoon_1 cat_33)))
(assert (= cat_35 cat_33))
(assert (= cat_36 (fp.sqrt RNE cat_29)))
(assert (not (spoon_27 cat_36)))
(check-sat)
