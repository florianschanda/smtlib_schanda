...
(define-fun spoon_15 ((kitten_22 Float32)) Bool (and (spoon_1 kitten_22) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_22) (fp.leq kitten_22 (fp #b0 #b11111110 #b11111111111111111111111)))))
(define-fun spoon_16 ((kitten_23 Float32) (kitten_24 Bool) (kitten_25 Bool) (kitten_26 Bool)) Bool (=> (or (= kitten_24 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (spoon_15 kitten_23)))
(define-fun spoon_17 ((kitten_27 Float32)) Bool (and (spoon_1 kitten_27) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_27) (fp.leq kitten_27 (fp #b0 #b10111111 #b00000000000000000110000)))))
(declare-const cat_18 Float32)
(declare-const cat_19 Int)
(declare-const cat_20 Int)
(define-fun spoon_21 ((kitten_28 Float32) (kitten_29 Bool) (kitten_30 Bool) (kitten_31 Bool)) Bool (=> (or (= kitten_29 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10111111 #b00000000000000000110000))) (spoon_17 kitten_28)))
...
(assert (= cat_24 cat_22))
(assert (= cat_25 (fp.sqrt RNE cat_18)))
(assert (not (spoon_17 cat_25)))
(check-sat)
