...
(assert (and (= cat_169 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_187)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_187))))
(assert (= cat_170 (ite (fp.leq cat_197 cat_169) true false)))
