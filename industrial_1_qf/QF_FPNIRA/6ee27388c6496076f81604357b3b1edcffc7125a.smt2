...
(assert (and (= cat_143 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_161)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_161))))
(assert (= cat_144 (ite (fp.leq cat_171 cat_143) true false)))
