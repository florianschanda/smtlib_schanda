...
(assert (= cat_71 1))
(assert (= cat_80 true))
(assert (=> (fp.lt cat_53 (fp #b0 #b01110111 #b01000111101011100001010)) (= cat_84 cat_64)))
(assert (=> (fp.lt cat_53 (fp #b0 #b01110111 #b01000111101011100001010)) (= cat_85 (fp #b0 #b01110111 #b01000111101011100001010))))
(assert (=> (fp.lt cat_53 (fp #b0 #b01110111 #b01000111101011100001010)) (= cat_85 cat_88)))
(assert (=> (fp.lt cat_53 (fp #b0 #b01110111 #b01000111101011100001010)) (= cat_89 cat_85)))
(assert (=> (not (fp.lt cat_53 (fp #b0 #b01110111 #b01000111101011100001010))) (= cat_86 cat_64)))
(assert (=> (not (fp.lt cat_53 (fp #b0 #b01110111 #b01000111101011100001010))) (= cat_87 cat_53)))
(assert (=> (not (fp.lt cat_53 (fp #b0 #b01110111 #b01000111101011100001010))) (= cat_87 cat_88)))
(assert (=> (not (fp.lt cat_53 (fp #b0 #b01110111 #b01000111101011100001010))) (= cat_89 cat_87)))
(assert (not false))
(check-sat)
