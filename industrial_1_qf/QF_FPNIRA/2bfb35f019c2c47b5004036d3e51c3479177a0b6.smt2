...
(assert (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_73)))
(assert (fp.leq cat_73 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))))
(assert (not (spoon_35 (fp.add RNE cat_73 (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
