...
(assert (= cat_185 true))
(assert (and (= cat_133 (fp.sub RNE cat_186 cat_184)) (spoon_1 (fp.sub RNE cat_186 cat_184))))
(assert (= cat_134 (fp.add RNE cat_133 (fp.mul RNE cat_181 cat_181))))
(assert (and (= cat_135 cat_134) (spoon_1 cat_134)))
(assert (= cat_188 cat_135))
(assert (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_188))
(assert (not (spoon_72 cat_188)))
(check-sat)
