...
(assert (= cat_158 true))
(assert (and (= cat_106 (fp.sub RNE cat_159 cat_157)) (spoon_1 (fp.sub RNE cat_159 cat_157))))
(assert (= cat_107 (fp.add RNE cat_106 (fp.mul RNE cat_154 cat_154))))
(assert (and (= cat_108 cat_107) (spoon_1 cat_107)))
(assert (= cat_161 cat_108))
(assert (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_161))
(assert (not (spoon_52 cat_161)))
(check-sat)
