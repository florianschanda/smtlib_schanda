...
(assert (and (= cat_53 (fp.add RNE cat_59 cat_69)) (spoon_1 (fp.add RNE cat_59 cat_69))))
(assert (= cat_70 cat_69))
(assert (= cat_71 cat_53))
(assert (not (fp.lt (fp #b0 #b10000111 #b01101000000000000000000) cat_71)))
(assert (not (spoon_24 cat_71)))
(check-sat)
