...
(assert (and (= cat_139 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_162)) (spoon_2 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_162))))
(assert (= cat_140 (ite (fp.leq cat_161 cat_139) true false)))
(assert (not (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_162))))
(check-sat)
