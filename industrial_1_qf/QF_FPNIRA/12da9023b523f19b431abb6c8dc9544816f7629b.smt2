...
(define-fun spoon_22 ((kitten_32 Float32)) Bool (and (spoon_1 kitten_32) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_32) (fp.leq kitten_32 (fp #b0 #b10000111 #b01101000000000000000000)))))
(define-fun spoon_23 ((kitten_33 Float32) (kitten_34 Float32)) Bool (ite (fp.eq kitten_33 kitten_34) true false))
(define-fun spoon_24 ((kitten_35 Float32) (kitten_36 Bool) (kitten_37 Bool) (kitten_38 Bool)) Bool (=> (or (= kitten_36 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_22 kitten_35)))
(declare-const cat_25 Float32)
(declare-const cat_26 Int)
(declare-const cat_27 Float32)
(declare-const cat_28 Int)
(define-fun spoon_29 ((kitten_39 Float32)) Bool (and (spoon_1 kitten_39) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_39) (fp.leq kitten_39 (fp #b0 #b10001000 #b01101000000000000000000)))))
(define-fun spoon_30 ((kitten_40 Float32) (kitten_41 Float32)) Bool (ite (fp.eq kitten_40 kitten_41) true false))
(define-fun spoon_31 ((kitten_42 Float32) (kitten_43 Bool) (kitten_44 Bool) (kitten_45 Bool)) Bool (=> (or (= kitten_43 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001000 #b01101000000000000000000))) (spoon_29 kitten_42)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001000 #b01101000000000000000000)) (spoon_29 cat_33)))
(assert (= cat_37 cat_33))
(assert (= cat_38 (fp.add RNE cat_25 cat_27)))
(assert (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_38))
(assert (not (spoon_29 (fp.sub RNE cat_38 (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
