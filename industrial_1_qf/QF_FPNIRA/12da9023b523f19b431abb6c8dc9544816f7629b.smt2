...
(define-fun spoon_14 ((kitten_18 Float32)) Bool (and (spoon_1 kitten_18) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_18) (fp.leq kitten_18 (fp #b0 #b10000111 #b01101000000000000000000)))))
(define-fun spoon_15 ((kitten_19 Float32) (kitten_20 Bool) (kitten_21 Bool) (kitten_22 Bool)) Bool (=> (or (= kitten_20 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_14 kitten_19)))
(declare-const cat_16 Float32)
(declare-const cat_17 Int)
(declare-const cat_18 Float32)
(declare-const cat_19 Int)
(define-fun spoon_20 ((kitten_23 Float32)) Bool (and (spoon_1 kitten_23) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_23) (fp.leq kitten_23 (fp #b0 #b10001000 #b01101000000000000000000)))))
(define-fun spoon_21 ((kitten_24 Float32) (kitten_25 Bool) (kitten_26 Bool) (kitten_27 Bool)) Bool (=> (or (= kitten_25 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001000 #b01101000000000000000000))) (spoon_20 kitten_24)))
...
(assert (spoon_14 cat_16))
(assert (spoon_14 cat_18))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001000 #b01101000000000000000000)) (spoon_20 cat_23)))
(assert (= cat_27 cat_23))
(assert (= cat_28 (fp.add RNE cat_16 cat_18)))
(assert (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_28))
(assert (not (spoon_20 (fp.sub RNE cat_28 (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
