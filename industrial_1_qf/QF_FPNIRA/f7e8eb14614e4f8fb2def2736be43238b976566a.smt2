...
(assert (=> (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_71) (fp.abs cat_70)) (= cat_72 (fp #b0 #b10110110 #b00000000000000000000000))))
(assert (=> (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_71) (fp.abs cat_70))) (and (= cat_66 (fp.div RNE (fp.abs cat_70) cat_71)) (spoon_1 (fp.div RNE (fp.abs cat_70) cat_71)))))
(assert (=> (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_71) (fp.abs cat_70))) (and (= cat_67 cat_66) (spoon_1 cat_66))))
(assert (=> (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_71) (fp.abs cat_70))) (= cat_73 cat_67)))
(assert (=> (not (fp.leq (fp.mul RNE (fp #b0 #b10110110 #b00000000000000000000000) cat_71) (fp.abs cat_70))) (= cat_72 cat_73)))
(assert (not (fp.lt cat_72 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (not (fp.lt (fp #b0 #b10001100 #b01101010100000000000000) cat_72)))
(assert (not (spoon_24 cat_72)))
(check-sat)
