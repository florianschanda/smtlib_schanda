...
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_73) (and (= cat_62 (fp.sub RNE cat_73 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.sub RNE cat_73 (fp #b0 #b10000111 #b01101000000000000000000))))))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_73) (= cat_74 cat_54)))
(assert (=> (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_73) (= cat_75 cat_62)))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_73)) (=> (fp.leq cat_73 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (and (= cat_63 (fp.add RNE cat_73 (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_1 (fp.add RNE cat_73 (fp #b0 #b10000111 #b01101000000000000000000)))))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_73)) (=> (fp.leq cat_73 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_76 cat_54))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_73)) (=> (fp.leq cat_73 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_77 cat_63))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_73)) (=> (not (fp.leq cat_73 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (and (= cat_64 cat_73) (spoon_1 cat_73)))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_73)) (=> (not (fp.leq cat_73 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_78 cat_54))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_73)) (=> (not (fp.leq cat_73 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_79 cat_64))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_73)) (=> (not (fp.leq cat_73 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_77 cat_79))))
(assert (=> (not (fp.leq (fp #b0 #b10000110 #b01101000000000000000000) cat_73)) (= cat_75 cat_77)))
(assert (= cat_80 cat_56))
(assert (= cat_81 (fp.div RNE (fp.sub RNE (fp #b0 #b10000110 #b01101000000000000000000) cat_75) (fp #b0 #b10000000 #b00000000000000000000000))))
(assert (and (= cat_65 (fp.add RNE cat_71 cat_81)) (spoon_1 (fp.add RNE cat_71 cat_81))))
(assert (= cat_82 cat_81))
(assert (= cat_83 cat_65))
(assert (fp.lt (fp #b0 #b10000111 #b01101000000000000000000) cat_83))
(assert (not (spoon_32 (fp.sub RNE cat_83 (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
