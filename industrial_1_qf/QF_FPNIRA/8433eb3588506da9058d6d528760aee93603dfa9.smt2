...
(define-fun spoon_29 ((kitten_28 Float32)) Bool (and (spoon_1 kitten_28) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_28) (fp.leq kitten_28 (fp #b0 #b10001100 #b01101010100000000000000)))))
(define-fun spoon_30 ((kitten_29 Float32) (kitten_30 Bool) (kitten_31 Bool) (kitten_32 Bool)) Bool (=> (or (= kitten_30 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000))) (spoon_29 kitten_29)))
(define-fun spoon_31 ((kitten_33 Int)) Bool (and (<= 1 kitten_33) (<= kitten_33 30)))
(define-fun spoon_32 ((kitten_34 Int) (kitten_35 Bool) (kitten_36 Bool) (kitten_37 Bool)) Bool (=> (or (= kitten_35 true) (<= 1 30)) (spoon_31 kitten_34)))
(define-fun spoon_33 ((kitten_38 Int)) Bool (and (<= 3 kitten_38) (<= kitten_38 30)))
...
(assert (<= 0 cat_44))
(define-fun spoon_45 ((kitten_39 Float32)) Bool (and (spoon_1 kitten_39) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_39) (fp.leq kitten_39 (fp #b0 #b01111111 #b00000000000000000000000)))))
(define-fun spoon_46 ((kitten_40 Float32) (kitten_41 Bool) (kitten_42 Bool) (kitten_43 Bool)) Bool (=> (or (= kitten_41 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_45 kitten_40)))
...
(define-fun spoon_56 ((kitten_44 Float32) (kitten_45 Bool) (kitten_46 Bool) (kitten_47 Bool)) Bool (=> (or (= kitten_45 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_18 kitten_44)))
(define-fun spoon_57 ((kitten_48 Int) (kitten_49 Bool) (kitten_50 Bool) (kitten_51 Bool)) Bool (=> (or (= kitten_49 true) (<= 3 30)) (spoon_33 kitten_48)))
...
(assert (spoon_27 cat_49))
(assert (= cat_62 cat_58))
(assert (= cat_63 (spoon_16 0)))
(assert (=> (<= 1 30) (spoon_31 cat_59)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000)) (spoon_45 cat_60)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_29 cat_61)))
(assert (= cat_64 cat_59))
(assert (not false))
(check-sat)
