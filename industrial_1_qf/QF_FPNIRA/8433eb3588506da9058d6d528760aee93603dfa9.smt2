...
(assert (<= 0 cat_43))
(define-fun spoon_44 ((kitten_38 Float32)) Bool (and (spoon_1 kitten_38) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_38) (fp.leq kitten_38 (fp #b0 #b01111111 #b00000000000000000000000)))))
(define-fun spoon_45 ((kitten_39 Float32) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool)) Bool (=> (or (= kitten_40 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_44 kitten_39)))
...
(define-fun spoon_55 ((kitten_43 Float32) (kitten_44 Bool) (kitten_45 Bool) (kitten_46 Bool)) Bool (=> (or (= kitten_44 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_17 kitten_43)))
(define-fun spoon_56 ((kitten_47 Int) (kitten_48 Bool) (kitten_49 Bool) (kitten_50 Bool)) Bool (=> (or (= kitten_48 true) (<= 3 30)) (spoon_32 kitten_47)))
...
(assert (spoon_26 cat_48))
(assert (= cat_61 cat_57))
(assert (= cat_62 (spoon_15 0)))
(assert (=> (<= 1 30) (spoon_30 cat_58)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000)) (spoon_44 cat_59)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_28 cat_60)))
(assert (= cat_63 cat_58))
(assert (not false))
(check-sat)
