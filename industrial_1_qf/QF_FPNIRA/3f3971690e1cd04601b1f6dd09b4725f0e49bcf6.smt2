...
(assert (= cat_179 true))
(assert (= cat_180 true))
(assert (=> (spoon_110 cat_96) (and (= cat_130 (fp.mul RNE cat_96 cat_96)) (spoon_1 (fp.mul RNE cat_96 cat_96)))))
(assert (=> (spoon_110 cat_96) (= cat_184 cat_130)))
(assert (=> (spoon_110 cat_96) (= cat_185 cat_180)))
(assert (=> (not (spoon_110 cat_96)) (= cat_185 (spoon_43 0))))
(assert (=> (not (spoon_110 cat_96)) (= cat_184 cat_176)))
(assert (= cat_186 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_92 cat_92)))))
(assert (not (spoon_72 cat_186)))
(check-sat)
