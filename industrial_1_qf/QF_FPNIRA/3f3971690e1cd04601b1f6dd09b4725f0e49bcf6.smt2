...
(assert (= cat_152 true))
(assert (= cat_153 true))
(assert (=> (spoon_84 cat_70) (and (= cat_103 (fp.mul RNE cat_70 cat_70)) (spoon_1 (fp.mul RNE cat_70 cat_70)))))
(assert (=> (spoon_84 cat_70) (= cat_157 cat_103)))
(assert (=> (spoon_84 cat_70) (= cat_158 cat_153)))
(assert (=> (not (spoon_84 cat_70)) (= cat_158 (spoon_27 0))))
(assert (=> (not (spoon_84 cat_70)) (= cat_157 cat_149)))
(assert (= cat_159 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_66 cat_66)))))
(assert (not (spoon_52 cat_159)))
(check-sat)
