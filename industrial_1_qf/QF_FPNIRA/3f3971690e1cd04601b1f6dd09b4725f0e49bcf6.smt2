...
(assert (= cat_154 true))
(assert (= cat_155 true))
(assert (=> (spoon_86 cat_72) (and (= cat_105 (fp.mul RNE cat_72 cat_72)) (spoon_1 (fp.mul RNE cat_72 cat_72)))))
(assert (=> (spoon_86 cat_72) (= cat_159 cat_105)))
(assert (=> (spoon_86 cat_72) (= cat_160 cat_155)))
(assert (=> (not (spoon_86 cat_72)) (= cat_160 (spoon_29 0))))
(assert (=> (not (spoon_86 cat_72)) (= cat_159 cat_151)))
(assert (= cat_161 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_68 cat_68)))))
(assert (not (spoon_54 cat_161)))
(check-sat)
