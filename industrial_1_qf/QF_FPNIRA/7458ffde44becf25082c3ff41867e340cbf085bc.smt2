...
(assert (and (= cat_39 cat_38) (spoon_1 cat_38)))
(assert (= cat_66 cat_39))
(assert (=> (fp.lt cat_35 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_68 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (fp.lt cat_35 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_70 cat_40)))
(assert (=> (not (fp.lt cat_35 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_35) (= cat_72 (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.lt cat_35 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_35) (= cat_74 cat_41))))
(assert (=> (not (fp.lt cat_35 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_35)) (= cat_74 cat_36))))
(assert (=> (not (fp.lt cat_35 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_35)) (= cat_72 cat_35))))
(assert (=> (not (fp.lt cat_35 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_35)) (= cat_74 cat_51))))
(assert (=> (not (fp.lt cat_35 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_35)) (= cat_72 cat_50))))
(assert (=> (not (fp.lt cat_35 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (= cat_70 cat_74)))
(assert (=> (not (fp.lt cat_35 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (= cat_68 cat_72)))
(assert (fp.lt cat_70 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))))
(assert (= cat_70 cat_75))
(assert (= cat_76 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))))
(assert (not (spoon_1 cat_43)))
(check-sat)
