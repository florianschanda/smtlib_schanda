...
(define-fun spoon_38 ((kitten_40 Float32)) Bool (and (spoon_1 kitten_40) (and (fp.leq (fp.neg (fp #b0 #b10011010 #b00000000000000000000000)) kitten_40) (fp.leq kitten_40 (fp #b0 #b10011010 #b00000000000000000000000)))))
(define-fun spoon_39 ((kitten_41 Float32) (kitten_42 Float32)) Bool (ite (fp.eq kitten_41 kitten_42) true false))
(define-fun spoon_40 ((kitten_43 Float32) (kitten_44 Bool) (kitten_45 Bool) (kitten_46 Bool)) Bool (=> (or (= kitten_44 true) (fp.leq (fp.neg (fp #b0 #b10011010 #b00000000000000000000000)) (fp #b0 #b10011010 #b00000000000000000000000))) (spoon_38 kitten_43)))
(declare-const cat_41 Int)
(declare-const cat_42 Int)
(declare-const cat_43 Int)
(define-fun spoon_44 ((kitten_47 Float32) (kitten_48 Bool) (kitten_49 Bool) (kitten_50 Bool)) Bool (=> (or (= kitten_48 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (spoon_1 kitten_47)))
(define-fun spoon_45 ((kitten_51 Float32) (kitten_52 Bool) (kitten_53 Bool) (kitten_54 Bool)) Bool (=> (or (= kitten_52 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_26 kitten_51)))
...
(assert (spoon_38 cat_46))
(assert (spoon_38 cat_47))
(assert (=> (fp.leq (fp.neg (fp #b0 #b10011010 #b00000000000000000000000)) (fp #b0 #b10011010 #b00000000000000000000000)) (spoon_38 cat_48)))
(assert (and (= cat_50 cat_49) (spoon_1 cat_49)))
(assert (= cat_77 cat_50))
(assert (=> (fp.lt cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_79 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (fp.lt cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_81 cat_51)))
(assert (=> (not (fp.lt cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_46) (= cat_83 (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.lt cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_46) (= cat_85 cat_52))))
(assert (=> (not (fp.lt cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_46)) (= cat_85 cat_47))))
(assert (=> (not (fp.lt cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_46)) (= cat_83 cat_46))))
(assert (=> (not (fp.lt cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_46)) (= cat_85 cat_62))))
(assert (=> (not (fp.lt cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_46)) (= cat_83 cat_61))))
(assert (=> (not (fp.lt cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (= cat_81 cat_85)))
(assert (=> (not (fp.lt cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (= cat_79 cat_83)))
(assert (fp.lt cat_81 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))))
(assert (= cat_81 cat_86))
(assert (= cat_87 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))))
(assert (not (spoon_1 cat_54)))
(check-sat)
