...
(assert (and (= cat_40 cat_39) (spoon_1 cat_39)))
(assert (= cat_67 cat_40))
(assert (=> (fp.lt cat_36 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_69 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (fp.lt cat_36 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_71 cat_41)))
(assert (=> (not (fp.lt cat_36 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_36) (= cat_73 (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.lt cat_36 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_36) (= cat_75 cat_42))))
(assert (=> (not (fp.lt cat_36 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_36)) (= cat_75 cat_37))))
(assert (=> (not (fp.lt cat_36 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_36)) (= cat_73 cat_36))))
(assert (=> (not (fp.lt cat_36 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_36)) (= cat_75 cat_52))))
(assert (=> (not (fp.lt cat_36 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_36)) (= cat_73 cat_51))))
(assert (=> (not (fp.lt cat_36 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (= cat_71 cat_75)))
(assert (=> (not (fp.lt cat_36 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (= cat_69 cat_73)))
(assert (fp.lt cat_71 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))))
(assert (= cat_71 cat_76))
(assert (= cat_77 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))))
(assert (not (spoon_1 cat_44)))
(check-sat)
