...
(assert (not (fp.lt cat_34 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_34))
(assert (= cat_71 (fp #b0 #b10001011 #b00000000000000000000000)))
(assert (not false))
(check-sat)
