...
(assert (and (<= (- cat_97) cat_96) (<= cat_96 cat_97)))
(assert (and (and (=> (<= 1 cat_59) (spoon_62 1 cat_59 cat_97)) (=> (<= (- 100) 100) (spoon_53 cat_96))) (and (<= 1 cat_97) (<= cat_97 cat_59))))
(assert (not (= cat_97 cat_59)))
(assert (= cat_98 (+ cat_97 1)))
(assert (not (<= (- cat_98) cat_100)))
(check-sat)
