...
(assert (and (= cat_66 cat_47) (spoon_1 cat_47)))
(declare-const cat_99 Float32)
(assert (and (= cat_67 cat_99) (spoon_37 cat_67)))
(assert (= cat_67 cat_51))
(assert (spoon_37 cat_51))
(assert (= ((_ to_fp 8 24) RNE (fp.mul RNE cat_43 cat_43)) cat_53))
(assert (spoon_34 cat_53))
(assert (and (= cat_68 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_53)) (spoon_1 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) cat_53))))
(assert (= cat_69 (fp.mul RNE cat_68 (fp.mul RNE cat_51 cat_51))))
...
(assert (spoon_34 cat_55))
(assert (not (or (fp.isZero cat_55) (fp.isPositive cat_55))))
(check-sat)
