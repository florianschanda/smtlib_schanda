...
(assert (not (fp.lt cat_81 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_81))
(assert (= cat_81 cat_90))
(assert (= cat_91 (fp #b0 #b10001011 #b00000000000000000000000)))
(assert (not false))
(check-sat)
