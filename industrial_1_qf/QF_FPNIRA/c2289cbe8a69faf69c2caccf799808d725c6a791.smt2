...
(assert (not (fp.lt cat_70 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_70))
(assert (= cat_70 cat_79))
(assert (= cat_80 (fp #b0 #b10001011 #b00000000000000000000000)))
(assert (not false))
(check-sat)
