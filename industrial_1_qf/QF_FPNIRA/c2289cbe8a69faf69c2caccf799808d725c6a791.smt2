...
(assert (not (fp.lt cat_71 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_71))
(assert (= cat_71 cat_80))
(assert (= cat_81 (fp #b0 #b10001011 #b00000000000000000000000)))
(assert (not false))
(check-sat)
