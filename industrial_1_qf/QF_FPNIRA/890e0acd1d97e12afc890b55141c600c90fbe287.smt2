...
(assert (and (= cat_80 (fp.mul RNE cat_88 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110))) (spoon_2 (fp.mul RNE cat_88 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110)))))
(assert (= cat_88 cat_91))
(assert (= cat_92 cat_80))
(assert (and (= cat_81 (fp.div RNE cat_92 cat_90)) (spoon_2 (fp.div RNE cat_92 cat_90))))
(assert (= cat_82 ((_ to_fp 8 24) RNE cat_81)))
(assert (not (spoon_30 cat_82)))
(check-sat)
