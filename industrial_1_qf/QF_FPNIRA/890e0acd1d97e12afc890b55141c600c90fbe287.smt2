...
(assert (and (= cat_104 (fp.mul RNE cat_112 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110))) (spoon_2 (fp.mul RNE cat_112 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110)))))
(assert (= cat_112 cat_115))
(assert (= cat_116 cat_104))
(assert (and (= cat_105 (fp.div RNE cat_116 cat_114)) (spoon_2 (fp.div RNE cat_116 cat_114))))
(assert (= cat_106 ((_ to_fp 8 24) RNE cat_105)))
(assert (not (spoon_47 cat_106)))
(check-sat)
