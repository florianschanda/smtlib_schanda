...
(define-fun spoon_36 ((kitten_39 Int)) Bool (and (<= 3 kitten_39) (<= kitten_39 100)))
...
(define-fun spoon_54 ((kitten_44 Int) (kitten_45 Bool) (kitten_46 Bool) (kitten_47 Bool)) Bool (=> (or (= kitten_45 true) (<= 1 100)) (spoon_35 kitten_44)))
(define-fun spoon_55 ((kitten_48 Int) (kitten_49 Bool) (kitten_50 Bool) (kitten_51 Bool)) Bool (=> (or (= kitten_49 true) (<= 3 100)) (spoon_36 kitten_48)))
