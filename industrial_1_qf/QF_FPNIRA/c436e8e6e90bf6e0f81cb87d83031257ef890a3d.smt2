...
(define-fun spoon_28 ((kitten_24 Int)) Bool (and (<= 3 kitten_24) (<= kitten_24 100)))
...
(define-fun spoon_46 ((kitten_29 Int) (kitten_30 Bool) (kitten_31 Bool) (kitten_32 Bool)) Bool (=> (or (= kitten_30 true) (<= 1 100)) (spoon_27 kitten_29)))
(define-fun spoon_47 ((kitten_33 Int) (kitten_34 Bool) (kitten_35 Bool) (kitten_36 Bool)) Bool (=> (or (= kitten_34 true) (<= 3 100)) (spoon_28 kitten_33)))
