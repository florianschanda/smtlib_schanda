...
(define-fun spoon_27 ((kitten_23 Int)) Bool (and (<= 3 kitten_23) (<= kitten_23 100)))
...
(define-fun spoon_45 ((kitten_28 Int) (kitten_29 Bool) (kitten_30 Bool) (kitten_31 Bool)) Bool (=> (or (= kitten_29 true) (<= 1 100)) (spoon_26 kitten_28)))
(define-fun spoon_46 ((kitten_32 Int) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool)) Bool (=> (or (= kitten_33 true) (<= 3 100)) (spoon_27 kitten_32)))
