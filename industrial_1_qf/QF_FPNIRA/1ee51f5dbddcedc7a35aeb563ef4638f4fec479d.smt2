...
(assert (= cat_96 cat_77))
(assert (= cat_67 cat_95))
(assert (= cat_65 cat_94))
(assert (= cat_99 cat_77))
(assert (= cat_98 cat_67))
(assert (= cat_97 cat_65))
(assert (not (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_95)))
(check-sat)
