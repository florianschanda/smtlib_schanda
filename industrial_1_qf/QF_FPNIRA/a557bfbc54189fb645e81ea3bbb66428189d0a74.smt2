...
(assert (and (= cat_119 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_56) cat_161)) (spoon_3 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_56) cat_161))))
(assert (= cat_120 (fp.mul RNE cat_119 cat_158)))
(assert (and (= cat_121 cat_120) (spoon_3 cat_120)))
(assert (= cat_164 cat_121))
(assert (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_163)))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_163) (and (= cat_128 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_163)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_163)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_163) (= cat_129 (ite (fp.leq cat_164 cat_128) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_163) (and (= cat_127 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_163)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_163)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_163) (= cat_130 (ite (fp.leq cat_127 cat_164) true false))))
(declare-const cat_183 Bool)
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_163) (= cat_167 cat_183)))
(assert (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_163)) (= cat_167 false)))
(assert (=> (= cat_167 true) (= cat_166 true)))
(assert (=> (not (= cat_167 true)) (=> (fp.lt cat_163 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_124 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_163)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_163))))))
(assert (=> (not (= cat_167 true)) (=> (fp.lt cat_163 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_125 (ite (fp.leq cat_164 cat_124) true false)))))
(assert (=> (not (= cat_167 true)) (=> (fp.lt cat_163 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_123 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_163)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_163))))))
(assert (=> (not (= cat_167 true)) (=> (fp.lt cat_163 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_126 (ite (fp.leq cat_123 cat_164) true false)))))
(declare-const cat_184 Bool)
(assert (=> (not (= cat_167 true)) (=> (fp.lt cat_163 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_166 cat_184))))
(assert (=> (not (= cat_167 true)) (=> (not (fp.lt cat_163 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_166 false))))
(assert (= cat_166 true))
(assert (not (not (fp.isZero cat_163))))
(check-sat)
