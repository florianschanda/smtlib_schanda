...
(assert (and (= cat_137 (fp.mul RNE cat_182 cat_184)) (spoon_2 (fp.mul RNE cat_182 cat_184))))
(assert (= cat_138 (fp.mul RNE cat_137 cat_186)))
(assert (and (= cat_139 cat_138) (spoon_2 cat_138)))
(assert (and (= cat_135 (fp.mul RNE cat_180 cat_183)) (spoon_2 (fp.mul RNE cat_180 cat_183))))
(assert (= cat_136 (fp.add RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_135)))
(assert (and (= cat_140 cat_136) (spoon_2 cat_136)))
(assert (= cat_141 (fp.add RNE cat_140 cat_139)))
(assert (and (= cat_142 cat_141) (spoon_2 cat_141)))
(assert (= cat_187 cat_142))
(assert (and (= cat_143 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_79) cat_185)) (spoon_2 (fp.mul RNE (fp.mul RNE (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000) cat_79) cat_185))))
(assert (= cat_144 (fp.mul RNE cat_143 cat_182)))
(assert (and (= cat_145 cat_144) (spoon_2 cat_144)))
(assert (= cat_188 cat_145))
(assert (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_187)))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_187) (and (= cat_152 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_187)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_187)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_187) (= cat_153 (ite (fp.leq cat_188 cat_152) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_187) (and (= cat_151 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_187)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_187)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_187) (= cat_154 (ite (fp.leq cat_151 cat_188) true false))))
(declare-const cat_207 Bool)
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_187) (= cat_191 cat_207)))
(assert (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_187)) (= cat_191 false)))
(assert (=> (= cat_191 true) (= cat_190 true)))
(assert (=> (not (= cat_191 true)) (=> (fp.lt cat_187 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_148 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_187)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_187))))))
(assert (=> (not (= cat_191 true)) (=> (fp.lt cat_187 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_149 (ite (fp.leq cat_188 cat_148) true false)))))
(assert (=> (not (= cat_191 true)) (=> (fp.lt cat_187 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_147 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_187)) (spoon_2 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_187))))))
(assert (=> (not (= cat_191 true)) (=> (fp.lt cat_187 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_150 (ite (fp.leq cat_147 cat_188) true false)))))
(declare-const cat_208 Bool)
(assert (=> (not (= cat_191 true)) (=> (fp.lt cat_187 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_190 cat_208))))
(assert (=> (not (= cat_191 true)) (=> (not (fp.lt cat_187 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_190 false))))
(assert (= cat_190 true))
(assert (not (not (fp.isZero cat_187))))
(check-sat)
