...
(define-fun spoon_38 ((kitten_45 Int)) Bool (and (<= 1 kitten_45) (<= kitten_45 100)))
(define-fun spoon_39 ((kitten_46 Int)) Bool (and (<= 3 kitten_46) (<= kitten_46 100)))
...
(define-fun spoon_60 ((kitten_51 Int) (kitten_52 Bool) (kitten_53 Bool) (kitten_54 Bool)) Bool (=> (or (= kitten_52 true) (<= 1 100)) (spoon_38 kitten_51)))
(define-fun spoon_61 ((kitten_55 Int) (kitten_56 Bool) (kitten_57 Bool) (kitten_58 Bool)) Bool (=> (or (= kitten_56 true) (<= 3 100)) (spoon_39 kitten_55)))
