...
(define-fun spoon_29 ((kitten_28 Int)) Bool (and (<= 1 kitten_28) (<= kitten_28 100)))
(define-fun spoon_30 ((kitten_29 Int)) Bool (and (<= 3 kitten_29) (<= kitten_29 100)))
...
(define-fun spoon_51 ((kitten_34 Int) (kitten_35 Bool) (kitten_36 Bool) (kitten_37 Bool)) Bool (=> (or (= kitten_35 true) (<= 1 100)) (spoon_29 kitten_34)))
(define-fun spoon_52 ((kitten_38 Int) (kitten_39 Bool) (kitten_40 Bool) (kitten_41 Bool)) Bool (=> (or (= kitten_39 true) (<= 3 100)) (spoon_30 kitten_38)))
