...
(define-fun spoon_28 ((kitten_27 Int)) Bool (and (<= 1 kitten_27) (<= kitten_27 100)))
...
(define-fun spoon_50 ((kitten_33 Int) (kitten_34 Bool) (kitten_35 Bool) (kitten_36 Bool)) Bool (=> (or (= kitten_34 true) (<= 1 100)) (spoon_28 kitten_33)))
(define-fun spoon_51 ((kitten_37 Int) (kitten_38 Bool) (kitten_39 Bool) (kitten_40 Bool)) Bool (=> (or (= kitten_38 true) (<= 3 100)) (spoon_29 kitten_37)))
