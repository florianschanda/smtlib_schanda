...
(define-fun spoon_16 ((kitten_23 Float32)) Bool (and (spoon_1 kitten_23) (and (fp.leq (fp.neg (fp #b0 #b10000111 #b01101000000000000000000)) kitten_23) (fp.leq kitten_23 (fp #b0 #b10000111 #b01101000000000000000000)))))
(define-fun spoon_17 ((kitten_24 Float32) (kitten_25 Bool) (kitten_26 Bool) (kitten_27 Bool)) Bool (=> (or (= kitten_25 true) (fp.leq (fp.neg (fp #b0 #b10000111 #b01101000000000000000000)) (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_16 kitten_24)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000)) (spoon_14 cat_21)))
(assert (fp.lt cat_18 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (not (spoon_14 (fp.add RNE cat_18 (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
