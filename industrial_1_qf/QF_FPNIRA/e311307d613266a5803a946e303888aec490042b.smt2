...
(define-fun spoon_25 ((kitten_39 Float32)) Bool (and (spoon_1 kitten_39) (and (fp.leq (fp.neg (fp #b0 #b10000111 #b01101000000000000000000)) kitten_39) (fp.leq kitten_39 (fp #b0 #b10000111 #b01101000000000000000000)))))
(define-fun spoon_26 ((kitten_40 Float32) (kitten_41 Float32)) Bool (ite (fp.eq kitten_40 kitten_41) true false))
(define-fun spoon_27 ((kitten_42 Float32) (kitten_43 Bool) (kitten_44 Bool) (kitten_45 Bool)) Bool (=> (or (= kitten_43 true) (fp.leq (fp.neg (fp #b0 #b10000111 #b01101000000000000000000)) (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_25 kitten_42)))
...
(assert (spoon_25 cat_28))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000)) (spoon_22 cat_31)))
(assert (fp.lt cat_28 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (not (spoon_22 (fp.add RNE cat_28 (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
