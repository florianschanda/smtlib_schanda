...
(define-fun spoon_35 ((kitten_35 Float32)) Bool (and (spoon_1 kitten_35) (and (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) kitten_35) (fp.leq kitten_35 (fp #b0 #b10001100 #b00000000000000000000000)))))
(define-fun spoon_36 ((kitten_36 Float32) (kitten_37 Float32)) Bool (ite (fp.eq kitten_36 kitten_37) true false))
(define-fun spoon_37 ((kitten_38 Float32) (kitten_39 Bool) (kitten_40 Bool) (kitten_41 Bool)) Bool (=> (or (= kitten_39 true) (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000))) (spoon_35 kitten_38)))
(declare-const cat_38 Int)
(declare-const cat_39 Int)
(define-fun spoon_40 ((kitten_42 Float32) (kitten_43 Bool) (kitten_44 Bool) (kitten_45 Bool)) Bool (=> (or (= kitten_43 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_22 kitten_42)))
...
(assert (=> (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000)) (spoon_35 cat_41)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000)) (spoon_35 cat_42)))
(assert (= cat_45 cat_41))
(assert (= cat_47 cat_42))
(assert (=> (fp.leq cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_49 cat_46)))
(assert (=> (fp.leq cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_50 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.leq cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_46) (= cat_51 cat_46))))
(assert (=> (not (fp.leq cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_46) (= cat_52 (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.leq cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_46)) (= cat_52 cat_46))))
(assert (=> (not (fp.leq cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (= cat_50 cat_52)))
(assert (=> (fp.leq cat_48 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_53 cat_48)))
(assert (=> (fp.leq cat_48 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))) (= cat_54 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.leq cat_48 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_48) (= cat_55 cat_48))))
(assert (=> (not (fp.leq cat_48 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_48) (= cat_56 (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (=> (not (fp.leq cat_48 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.leq (fp #b0 #b10001011 #b00000000000000000000000) cat_48)) (= cat_56 cat_48))))
(assert (=> (not (fp.leq cat_48 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (= cat_54 cat_56)))
(assert (and (= cat_44 cat_54) (spoon_1 cat_54)))
(assert (not (spoon_22 cat_50)))
(check-sat)
