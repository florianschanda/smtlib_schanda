...
(assert (= cat_59 cat_54))
(assert (= cat_60 1))
(assert (= cat_69 true))
(assert (=> (fp.lt cat_42 (fp #b0 #b01110111 #b01000111101011100001010)) (= cat_73 cat_53)))
(assert (=> (fp.lt cat_42 (fp #b0 #b01110111 #b01000111101011100001010)) (= cat_74 (fp #b0 #b01110111 #b01000111101011100001010))))
(assert (=> (fp.lt cat_42 (fp #b0 #b01110111 #b01000111101011100001010)) (= cat_74 cat_77)))
(assert (=> (fp.lt cat_42 (fp #b0 #b01110111 #b01000111101011100001010)) (= cat_78 cat_74)))
(assert (=> (not (fp.lt cat_42 (fp #b0 #b01110111 #b01000111101011100001010))) (= cat_75 cat_53)))
(assert (=> (not (fp.lt cat_42 (fp #b0 #b01110111 #b01000111101011100001010))) (= cat_76 cat_42)))
(assert (=> (not (fp.lt cat_42 (fp #b0 #b01110111 #b01000111101011100001010))) (= cat_76 cat_77)))
(assert (=> (not (fp.lt cat_42 (fp #b0 #b01110111 #b01000111101011100001010))) (= cat_78 cat_76)))
(assert (not false))
(check-sat)
