...
(assert (= cat_80 cat_73))
(assert (not (fp.lt cat_80 (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)))))
(assert (not (fp.lt (fp #b0 #b01111111 #b00000000000000000000000) cat_80)))
(assert (not (spoon_32 cat_80)))
(check-sat)
