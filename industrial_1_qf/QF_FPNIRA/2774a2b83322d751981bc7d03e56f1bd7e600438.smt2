...
(assert (and (= cat_89 cat_88) (spoon_1 cat_88)))
(assert (= cat_96 cat_89))
(assert (not (fp.lt cat_96 (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)))))
(assert (not (fp.lt (fp #b0 #b01111111 #b00000000000000000000000) cat_96)))
(assert (not (spoon_43 cat_96)))
(check-sat)
