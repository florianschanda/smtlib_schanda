...
(assert (= cat_79 cat_72))
(assert (not (fp.lt cat_79 (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)))))
(assert (not (fp.lt (fp #b0 #b01111111 #b00000000000000000000000) cat_79)))
