...
(define-fun spoon_27 ((kitten_41 Float32)) Bool (and (spoon_1 kitten_41) (and (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) kitten_41) (fp.leq kitten_41 (fp #b0 #b10000110 #b01101000000000000000000)))))
(define-fun spoon_28 ((kitten_42 Float32) (kitten_43 Float32)) Bool (ite (fp.eq kitten_42 kitten_43) true false))
(define-fun spoon_29 ((kitten_44 Float32)) Bool (and (spoon_1 kitten_44) (and (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) kitten_44) (fp.leq kitten_44 (fp #b0 #b10001100 #b00000000000000000000000)))))
(define-fun spoon_30 ((kitten_45 Float32) (kitten_46 Float32)) Bool (ite (fp.eq kitten_45 kitten_46) true false))
(define-fun spoon_31 ((kitten_47 Float32) (kitten_48 Bool) (kitten_49 Bool) (kitten_50 Bool)) Bool (=> (or (= kitten_48 true) (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000))) (spoon_29 kitten_47)))
...
(define-fun spoon_37 ((kitten_51 Float32) (kitten_52 Bool) (kitten_53 Bool) (kitten_54 Bool)) Bool (=> (or (= kitten_52 true) (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) (fp #b0 #b10000110 #b01101000000000000000000))) (spoon_27 kitten_51)))
...
(assert (spoon_29 cat_32))
(assert (spoon_29 cat_34))
(assert (or (spoon_14 cat_32 (fp #b0 #b00000000 #b00000000000000000000000)) (spoon_14 cat_34 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (spoon_1 cat_38)))
