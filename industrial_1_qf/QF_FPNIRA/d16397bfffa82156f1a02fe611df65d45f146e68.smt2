...
(assert (=> (=> (not (fp.lt cat_48 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_48)) (=> (not (fp.lt cat_50 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_50)))) (and (and (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_51) (fp.leq cat_51 (fp #b0 #b10001011 #b00000000000000000000000))) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_52) (fp.leq cat_52 (fp #b0 #b10001011 #b00000000000000000000000)))) (and (spoon_37 cat_51) (spoon_37 cat_52)))))
(assert (=> (not (=> (not (fp.lt cat_48 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_48)) (=> (not (fp.lt cat_50 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_50))))) (= cat_52 cat_50)))
(assert (=> (not (=> (not (fp.lt cat_48 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_48)) (=> (not (fp.lt cat_50 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_50))))) (= cat_51 cat_48)))
(assert (and (= cat_46 cat_52) (spoon_1 cat_52)))
(assert (not (spoon_25 cat_51)))
(check-sat)
