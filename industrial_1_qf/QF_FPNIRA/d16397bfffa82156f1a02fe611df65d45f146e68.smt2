...
(assert (=> (=> (not (fp.lt cat_38 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_38)) (=> (not (fp.lt cat_40 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_40)))) (and (and (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_41) (fp.leq cat_41 (fp #b0 #b10001011 #b00000000000000000000000))) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_42) (fp.leq cat_42 (fp #b0 #b10001011 #b00000000000000000000000)))) (and (spoon_28 cat_41) (spoon_28 cat_42)))))
(assert (=> (not (=> (not (fp.lt cat_38 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_38)) (=> (not (fp.lt cat_40 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_40))))) (= cat_42 cat_40)))
(assert (=> (not (=> (not (fp.lt cat_38 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_38)) (=> (not (fp.lt cat_40 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_40))))) (= cat_41 cat_38)))
(assert (and (= cat_36 cat_42) (spoon_1 cat_42)))
(assert (not (spoon_17 cat_41)))
(check-sat)
