...
(assert (and (= cat_41 cat_43) (and (spoon_1 cat_41) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_41) (and (=> (fp.eq cat_35 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq cat_41 (fp #b0 #b01111111 #b00000000000000000000000))) (and (=> (fp.eq cat_35 (fp #b0 #b01111111 #b00000000000000000000000)) (fp.eq cat_41 cat_33)) (and (=> (fp.eq cat_33 (fp #b0 #b01111111 #b00000000000000000000000)) (fp.eq cat_41 (fp #b0 #b01111111 #b00000000000000000000000))) (=> (fp.eq cat_33 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq cat_41 (fp #b0 #b00000000 #b00000000000000000000000))))))))))
(assert (not (spoon_30 cat_41)))
(check-sat)
