...
(define-fun spoon_38 ((kitten_45 Int)) Bool (and (<= (- 128) kitten_45) (<= kitten_45 127)))
(define-fun spoon_39 ((kitten_46 Int)) Bool (and (<= 1 kitten_46) (<= kitten_46 30)))
(define-fun spoon_40 ((kitten_47 Int)) Bool (and (<= 3 kitten_47) (<= kitten_47 30)))
...
(assert (<= 0 cat_51))
(define-fun spoon_52 ((kitten_48 Float32)) Bool (and (spoon_1 kitten_48) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_48) (fp.leq kitten_48 (fp #b0 #b10001100 #b01101010100000000000000)))))
(define-fun spoon_53 ((kitten_49 Float32) (kitten_50 Float32)) Bool (ite (fp.eq kitten_49 kitten_50) true false))
(define-fun spoon_54 ((kitten_51 Float32) (kitten_52 Bool) (kitten_53 Bool) (kitten_54 Bool)) Bool (=> (or (= kitten_52 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000))) (spoon_52 kitten_51)))
(declare-const cat_55 Int)
(declare-const cat_56 Int)
(declare-const cat_57 Int)
(define-fun spoon_58 ((kitten_55 Float32) (kitten_56 Bool) (kitten_57 Bool) (kitten_58 Bool)) Bool (=> (or (= kitten_56 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_25 kitten_55)))
(define-fun spoon_59 ((kitten_59 Int) (kitten_60 Bool) (kitten_61 Bool) (kitten_62 Bool)) Bool (=> (or (= kitten_60 true) (<= 1 30)) (spoon_39 kitten_59)))
(define-fun spoon_60 ((kitten_63 Int) (kitten_64 Bool) (kitten_65 Bool) (kitten_66 Bool)) Bool (=> (or (= kitten_64 true) (<= 3 30)) (spoon_40 kitten_63)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000)) (spoon_35 cat_61)))
(assert (= cat_65 cat_61))
(assert (= cat_66 cat_63))
(assert (= cat_67 cat_62))
(assert (= cat_68 1))
(assert (<= 1 cat_68))
(assert (not (spoon_38 (+ cat_70 1))))
(check-sat)
