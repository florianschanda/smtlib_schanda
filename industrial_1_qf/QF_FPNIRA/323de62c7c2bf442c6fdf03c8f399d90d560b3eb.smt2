...
(define-fun spoon_18 ((kitten_22 Float32) (kitten_23 Bool) (kitten_24 Bool) (kitten_25 Bool)) Bool (=> (or (= kitten_23 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_17 kitten_22)))
...
(assert (<= 0 cat_34))
(define-fun spoon_35 ((kitten_26 Int)) Bool (and (<= 1 kitten_26) (<= kitten_26 30)))
(define-fun spoon_36 ((kitten_27 Int)) Bool (and (<= 3 kitten_27) (<= kitten_27 30)))
...
(define-fun spoon_54 ((kitten_28 Int) (kitten_29 Bool) (kitten_30 Bool) (kitten_31 Bool)) Bool (=> (or (= kitten_29 true) (<= 1 30)) (spoon_35 kitten_28)))
(define-fun spoon_55 ((kitten_32 Int) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool)) Bool (=> (or (= kitten_33 true) (<= 3 30)) (spoon_36 kitten_32)))
...
(assert (=> (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000)) (spoon_17 cat_59)))
(assert (not false))
(check-sat)
