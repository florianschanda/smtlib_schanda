...
(assert (=> (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) (fp #b0 #b10000110 #b01101000000000000000000)) (spoon_15 cat_22)))
(assert (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) (fp.add RNE cat_17 cat_19))))
(assert (fp.lt (fp.add RNE cat_17 cat_19) (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))))
(assert (not (spoon_15 (fp.add RNE (fp.add RNE cat_17 cat_19) (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
