...
(assert (and (= cat_39 cat_47) (and (spoon_1 cat_39) (=> (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_34) (fp.eq cat_32 (fp #b0 #b00000000 #b00000000000000000000000))) (fp.eq cat_39 (fp #b0 #b00000000 #b00000000000000000000000))))))
(assert (= cat_41 cat_38))
(assert (= cat_42 cat_39))
(assert (=> (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_42) (= cat_43 cat_42)))
(assert (=> (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_42) (= cat_44 (fp #b0 #b10000110 #b01101000000000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_42)) (=> (fp.lt cat_42 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_45 cat_42))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_42)) (=> (fp.lt cat_42 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))) (= cat_46 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_42)) (=> (not (fp.lt cat_42 (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)))) (= cat_46 cat_42))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_42)) (= cat_44 cat_46)))
(assert (not (spoon_27 cat_44)))
(check-sat)
