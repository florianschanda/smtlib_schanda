...
(assert (and (= cat_127 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_162)) (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_162))))
(assert (= cat_128 (ite (fp.leq cat_163 cat_127) true false)))
