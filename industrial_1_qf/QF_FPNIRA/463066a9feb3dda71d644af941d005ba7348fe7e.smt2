...
(define-fun spoon_16 ((kitten_24 Float32)) Bool (and (spoon_1 kitten_24) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_24) (fp.leq kitten_24 (fp #b0 #b11111110 #b11111111111111111111111)))))
(define-fun spoon_17 ((kitten_25 Float32) (kitten_26 Bool) (kitten_27 Bool) (kitten_28 Bool) (kitten_29 Bool)) Bool (=> (or (= kitten_26 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (spoon_16 kitten_25)))
(define-fun spoon_18 ((kitten_30 Float32)) Bool (and (spoon_1 kitten_30) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_30) (fp.leq kitten_30 (fp #b0 #b10111111 #b00000000000000000110000)))))
(declare-const cat_19 Float32)
(declare-const cat_20 Int)
(declare-const cat_21 Int)
(define-fun spoon_22 ((kitten_31 Float32) (kitten_32 Bool) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool)) Bool (=> (or (= kitten_32 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10111111 #b00000000000000000110000))) (spoon_18 kitten_31)))
...
(assert (not (or (fp.isZero cat_19) (fp.isPositive cat_19))))
(check-sat)
