...
(define-fun spoon_38 ((kitten_49 Float32)) Bool (and (spoon_1 kitten_49) (and (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) kitten_49) (fp.leq kitten_49 (fp #b0 #b10001100 #b00000000000000000000000)))))
(define-fun spoon_39 ((kitten_50 Float32) (kitten_51 Float32)) Bool (ite (fp.eq kitten_50 kitten_51) true false))
(define-fun spoon_40 ((kitten_52 Float32) (kitten_53 Bool) (kitten_54 Bool) (kitten_55 Bool)) Bool (=> (or (= kitten_53 true) (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000))) (spoon_38 kitten_52)))
...
(define-fun spoon_47 ((kitten_56 Float32) (kitten_57 Bool) (kitten_58 Bool) (kitten_59 Bool)) Bool (=> (or (= kitten_57 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_22 kitten_56)))
...
(assert (=> (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000)) (spoon_38 cat_48)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000)) (spoon_38 cat_49)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) (fp #b0 #b10000110 #b01101000000000000000000)) (spoon_35 cat_50)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000)) (spoon_32 cat_51)))
(assert (= cat_55 cat_48))
(assert (= cat_57 cat_49))
(declare-const cat_61 Float32)
(assert (and (= cat_52 cat_61) (spoon_35 cat_52)))
(assert (= cat_59 cat_50))
(assert (= cat_60 cat_52))
(assert (not (fp.lt cat_60 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (not (spoon_32 cat_60)))
(check-sat)
