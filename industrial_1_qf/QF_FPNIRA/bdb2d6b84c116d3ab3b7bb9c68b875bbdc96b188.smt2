...
(assert (=> (not (= cat_167 true)) (=> (fp.lt cat_165 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_127 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_165)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_165))))))
(assert (=> (not (= cat_167 true)) (=> (fp.lt cat_165 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_128 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_164)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_164))))))
(assert (=> (not (= cat_167 true)) (=> (fp.lt cat_165 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_129 (ite (fp.leq cat_128 cat_127) true false)))))
(assert (=> (not (= cat_167 true)) (=> (fp.lt cat_165 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_125 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_164)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_164))))))
(assert (=> (not (= cat_167 true)) (=> (fp.lt cat_165 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_126 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_165)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_165))))))
(assert (=> (not (= cat_167 true)) (=> (fp.lt cat_165 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_130 (ite (fp.leq cat_126 cat_125) true false)))))
(declare-const cat_172 Bool)
(assert (=> (not (= cat_167 true)) (=> (fp.lt cat_165 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_166 cat_172))))
(assert (=> (not (= cat_167 true)) (=> (not (fp.lt cat_165 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_166 false))))
(assert (= cat_166 true))
(assert (and (= cat_137 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_164)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_164))))
(assert (= cat_138 (fp.div RNE cat_137 cat_165)))
(assert (not (spoon_1 cat_138)))
(check-sat)
