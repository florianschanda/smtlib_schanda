...
(assert (=> (= cat_194 true) (= cat_193 true)))
(assert (=> (not (= cat_194 true)) (=> (fp.lt cat_192 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_154 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_192)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_192))))))
(assert (=> (not (= cat_194 true)) (=> (fp.lt cat_192 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_155 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191))))))
(assert (=> (not (= cat_194 true)) (=> (fp.lt cat_192 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_156 (ite (fp.leq cat_155 cat_154) true false)))))
(assert (=> (not (= cat_194 true)) (=> (fp.lt cat_192 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_152 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191))))))
(assert (=> (not (= cat_194 true)) (=> (fp.lt cat_192 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_153 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_192)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_192))))))
(assert (=> (not (= cat_194 true)) (=> (fp.lt cat_192 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_157 (ite (fp.leq cat_153 cat_152) true false)))))
(declare-const cat_199 Bool)
(assert (=> (not (= cat_194 true)) (=> (fp.lt cat_192 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_193 cat_199))))
(assert (=> (not (= cat_194 true)) (=> (not (fp.lt cat_192 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_193 false))))
(assert (= cat_193 true))
(assert (and (= cat_164 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_191))))
(assert (= cat_165 (fp.div RNE cat_164 cat_192)))
(assert (not (spoon_1 cat_165)))
(check-sat)
