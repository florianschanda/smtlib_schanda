...
(assert (=> (= cat_169 true) (= cat_168 true)))
(assert (=> (not (= cat_169 true)) (=> (fp.lt cat_167 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_129 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_167)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_167))))))
(assert (=> (not (= cat_169 true)) (=> (fp.lt cat_167 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_130 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166))))))
(assert (=> (not (= cat_169 true)) (=> (fp.lt cat_167 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_131 (ite (fp.leq cat_130 cat_129) true false)))))
(assert (=> (not (= cat_169 true)) (=> (fp.lt cat_167 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_127 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166))))))
(assert (=> (not (= cat_169 true)) (=> (fp.lt cat_167 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_128 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_167)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_167))))))
(assert (=> (not (= cat_169 true)) (=> (fp.lt cat_167 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_132 (ite (fp.leq cat_128 cat_127) true false)))))
(declare-const cat_174 Bool)
(assert (=> (not (= cat_169 true)) (=> (fp.lt cat_167 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_168 cat_174))))
(assert (=> (not (= cat_169 true)) (=> (not (fp.lt cat_167 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_168 false))))
(assert (= cat_168 true))
(assert (and (= cat_139 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_166))))
(assert (= cat_140 (fp.div RNE cat_139 cat_167)))
(assert (not (spoon_1 cat_140)))
(check-sat)
