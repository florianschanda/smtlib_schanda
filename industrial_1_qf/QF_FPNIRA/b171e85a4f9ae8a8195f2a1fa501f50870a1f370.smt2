...
(assert (<= 0 cat_26))
(define-fun spoon_27 ((kitten_23 Int)) Bool (and (<= 1 kitten_23) (<= kitten_23 100)))
(define-fun spoon_28 ((kitten_24 Int) (kitten_25 Bool) (kitten_26 Bool) (kitten_27 Bool)) Bool (=> (or (= kitten_25 true) (<= 1 100)) (spoon_27 kitten_24)))
(define-fun spoon_29 ((kitten_28 Int)) Bool (and (<= 3 kitten_28) (<= kitten_28 100)))
...
(define-fun spoon_45 ((kitten_34 Int)) Bool (and (<= (- 100) kitten_34) (<= kitten_34 100)))
(define-fun spoon_46 ((kitten_35 Int) (kitten_36 Bool) (kitten_37 Bool) (kitten_38 Bool)) Bool (=> (or (= kitten_36 true) (<= (- 100) 100)) (spoon_45 kitten_35)))
...
(define-fun spoon_53 ((kitten_39 Int)) Bool (and (<= (- 128) kitten_39) (<= kitten_39 127)))
(define-fun spoon_54 ((kitten_40 Int) (kitten_41 Int) (kitten_42 Int)) Bool (and (<= kitten_40 kitten_42) (<= kitten_42 kitten_41)))
(declare-const cat_55 Int)
(define-fun spoon_56 ((kitten_43 Float32) (kitten_44 Bool) (kitten_45 Bool) (kitten_46 Bool)) Bool (=> (or (= kitten_44 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_18 kitten_43)))
(define-fun spoon_57 ((kitten_47 Int) (kitten_48 Bool) (kitten_49 Bool) (kitten_50 Bool)) Bool (=> (or (= kitten_48 true) (<= 3 100)) (spoon_29 kitten_47)))
