...
(assert (<= 0 cat_34))
(define-fun spoon_35 ((kitten_38 Int)) Bool (and (<= 1 kitten_38) (<= kitten_38 100)))
(define-fun spoon_36 ((kitten_39 Int) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool)) Bool (=> (or (= kitten_40 true) (<= 1 100)) (spoon_35 kitten_39)))
(define-fun spoon_37 ((kitten_43 Int)) Bool (and (<= 3 kitten_43) (<= kitten_43 100)))
...
(define-fun spoon_53 ((kitten_49 Int)) Bool (and (<= (- 100) kitten_49) (<= kitten_49 100)))
(define-fun spoon_54 ((kitten_50 Int) (kitten_51 Bool) (kitten_52 Bool) (kitten_53 Bool)) Bool (=> (or (= kitten_51 true) (<= (- 100) 100)) (spoon_53 kitten_50)))
...
(define-fun spoon_61 ((kitten_54 Int)) Bool (and (<= (- 128) kitten_54) (<= kitten_54 127)))
(define-fun spoon_62 ((kitten_55 Int) (kitten_56 Int) (kitten_57 Int)) Bool (and (<= kitten_55 kitten_57) (<= kitten_57 kitten_56)))
(declare-const cat_63 Int)
(define-fun spoon_64 ((kitten_58 Float32) (kitten_59 Bool) (kitten_60 Bool) (kitten_61 Bool)) Bool (=> (or (= kitten_59 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_25 kitten_58)))
(define-fun spoon_65 ((kitten_62 Int) (kitten_63 Bool) (kitten_64 Bool) (kitten_65 Bool)) Bool (=> (or (= kitten_63 true) (<= 3 100)) (spoon_37 kitten_62)))
...
(declare-const cat_99 Bool)
(declare-const cat_100 Int)
(declare-const cat_101 Bool)
(declare-const cat_102 Int)
(assert (= cat_81 cat_66))
(assert (= cat_82 0))
(assert (spoon_53 cat_82))
(assert (=> (<= 1 100) (spoon_35 cat_67)))
(assert (= cat_83 cat_67))
(assert (=> (= cat_85 true) (and (= cat_69 (- cat_84 1)) (spoon_35 (- cat_84 1)))))
(assert (=> (= cat_85 true) (= cat_86 cat_84)))
(assert (=> (= cat_85 true) (= cat_87 cat_69)))
(assert (=> (not (= cat_85 true)) (= cat_87 cat_84)))
(assert (= cat_87 cat_59))
(assert (spoon_35 cat_59))
(assert (= cat_88 cat_68))
(assert (= cat_89 1))
(assert (<= 1 cat_89))
(assert (<= cat_89 cat_59))
(assert (= cat_90 true))
(assert (not (spoon_53 (+ cat_82 1))))
(check-sat)
