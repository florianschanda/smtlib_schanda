...
(assert (<= 0 cat_25))
(define-fun spoon_26 ((kitten_22 Int)) Bool (and (<= 1 kitten_22) (<= kitten_22 100)))
(define-fun spoon_27 ((kitten_23 Int) (kitten_24 Bool) (kitten_25 Bool) (kitten_26 Bool)) Bool (=> (or (= kitten_24 true) (<= 1 100)) (spoon_26 kitten_23)))
(define-fun spoon_28 ((kitten_27 Int)) Bool (and (<= 3 kitten_27) (<= kitten_27 100)))
...
(define-fun spoon_44 ((kitten_33 Int)) Bool (and (<= (- 100) kitten_33) (<= kitten_33 100)))
(define-fun spoon_45 ((kitten_34 Int) (kitten_35 Bool) (kitten_36 Bool) (kitten_37 Bool)) Bool (=> (or (= kitten_35 true) (<= (- 100) 100)) (spoon_44 kitten_34)))
...
(define-fun spoon_52 ((kitten_38 Int)) Bool (and (<= (- 128) kitten_38) (<= kitten_38 127)))
(define-fun spoon_53 ((kitten_39 Int) (kitten_40 Int) (kitten_41 Int)) Bool (and (<= kitten_39 kitten_41) (<= kitten_41 kitten_40)))
(declare-const cat_54 Int)
(define-fun spoon_55 ((kitten_42 Float32) (kitten_43 Bool) (kitten_44 Bool) (kitten_45 Bool)) Bool (=> (or (= kitten_43 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_17 kitten_42)))
(define-fun spoon_56 ((kitten_46 Int) (kitten_47 Bool) (kitten_48 Bool) (kitten_49 Bool)) Bool (=> (or (= kitten_47 true) (<= 3 100)) (spoon_28 kitten_46)))
