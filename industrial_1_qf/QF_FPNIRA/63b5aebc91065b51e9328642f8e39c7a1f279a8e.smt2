...
(assert (=> (fp.lt cat_130 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_136 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (fp.lt cat_130 (fp #b0 #b01101011 #b00001100011011110111101))) (and (= cat_98 (fp.div RNE cat_127 cat_130)) (spoon_1 (fp.div RNE cat_127 cat_130)))))
(assert (=> (not (fp.lt cat_130 (fp #b0 #b01101011 #b00001100011011110111101))) (and (= cat_99 cat_98) (spoon_1 cat_98))))
(assert (=> (not (fp.lt cat_130 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_137 cat_99)))
(assert (=> (not (fp.lt cat_130 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_136 cat_137)))
(assert (not (fp.lt cat_117 (fp #b0 #b01101011 #b00001100011011110111101))))
(assert (not (spoon_1 (fp.div RNE cat_126 cat_117))))
(check-sat)
