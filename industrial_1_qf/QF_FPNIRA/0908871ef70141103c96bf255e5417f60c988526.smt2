...
(assert (=> (fp.lt cat_105 cat_49) (= cat_126 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (fp.lt cat_105 cat_49)) (and (= cat_88 (fp.div RNE cat_114 cat_105)) (spoon_1 (fp.div RNE cat_114 cat_105)))))
(assert (=> (not (fp.lt cat_105 cat_49)) (and (= cat_89 cat_88) (spoon_1 cat_88))))
(assert (=> (not (fp.lt cat_105 cat_49)) (= cat_127 cat_89)))
(assert (=> (not (fp.lt cat_105 cat_49)) (= cat_126 cat_127)))
(assert (not false))
(check-sat)
