...
(define-fun spoon_40 ((kitten_29 Int) (kitten_30 Bool) (kitten_31 Bool) (kitten_32 Bool) (kitten_33 Bool)) Bool (=> (or (= kitten_30 true) (<= 1 30)) (spoon_39 kitten_29)))
(declare-const cat_41 Int)
(declare-const cat_42 Int)
(define-fun spoon_43 ((kitten_34 Int)) Bool (and (<= (- 30) kitten_34) (<= kitten_34 30)))
(define-fun spoon_44 ((kitten_35 Int) (kitten_36 Bool) (kitten_37 Bool) (kitten_38 Bool) (kitten_39 Bool)) Bool (=> (or (= kitten_36 true) (<= (- 30) 30)) (spoon_43 kitten_35)))
...
(define-fun spoon_52 ((kitten_40 Int)) Bool (and (<= (- 128) kitten_40) (<= kitten_40 127)))
(define-fun spoon_53 ((kitten_41 Int) (kitten_42 Int) (kitten_43 Int)) Bool (and (<= kitten_41 kitten_43) (<= kitten_43 kitten_42)))
(declare-const cat_54 Int)
(define-fun spoon_55 ((kitten_44 Float32) (kitten_45 Bool) (kitten_46 Bool) (kitten_47 Bool) (kitten_48 Bool)) Bool (=> (or (= kitten_45 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_17 kitten_44)))
(define-fun spoon_56 ((kitten_49 Int) (kitten_50 Bool) (kitten_51 Bool) (kitten_52 Bool) (kitten_53 Bool)) Bool (=> (or (= kitten_50 true) (<= 3 30)) (spoon_16 kitten_49)))
...
(assert (= cat_73 0))
(assert (spoon_43 cat_73))
(assert (=> (<= 1 30) (spoon_39 cat_58)))
(assert (= cat_74 cat_58))
(assert (=> (= cat_76 true) (and (= cat_60 (- cat_75 1)) (spoon_39 (- cat_75 1)))))
(assert (=> (= cat_76 true) (= cat_77 cat_75)))
(assert (=> (= cat_76 true) (= cat_78 cat_60)))
(assert (=> (not (= cat_76 true)) (= cat_78 cat_75)))
(assert (= cat_78 cat_50))
(assert (spoon_39 cat_50))
(assert (= cat_79 cat_59))
(assert (= cat_80 1))
(assert (<= 1 cat_80))
(assert (<= cat_80 cat_50))
(assert (and (<= (- cat_88) cat_87) (<= cat_87 cat_88)))
(assert (and (and (=> (<= 1 cat_50) (spoon_53 1 cat_50 cat_88)) (=> (<= (- 30) 30) (spoon_43 cat_87))) (and (<= 1 cat_88) (<= cat_88 cat_50))))
(assert (not (= cat_88 cat_50)))
(assert (= cat_89 (+ cat_88 1)))
(assert (not (<= (- cat_89) cat_91)))
(check-sat)
