...
(assert (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) (fp.add RNE cat_25 cat_27))))
(assert (fp.lt (fp.add RNE cat_25 cat_27) (fp.neg (fp #b0 #b10000110 #b01101000000000000000000))))
(assert (not (spoon_22 (fp.add RNE (fp.add RNE cat_25 cat_27) (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
