...
(assert (=> (fp.lt cat_103 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_124 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (fp.lt cat_103 (fp #b0 #b01101011 #b00001100011011110111101))) (and (= cat_86 (fp.div RNE cat_112 cat_103)) (spoon_1 (fp.div RNE cat_112 cat_103)))))
(assert (=> (not (fp.lt cat_103 (fp #b0 #b01101011 #b00001100011011110111101))) (and (= cat_87 cat_86) (spoon_1 cat_86))))
(assert (=> (not (fp.lt cat_103 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_125 cat_87)))
(assert (=> (not (fp.lt cat_103 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_124 cat_125)))
(assert (not false))
(check-sat)
