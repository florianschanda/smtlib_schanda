...
(assert (=> (fp.lt cat_117 (fp #b0 #b01101011 #b00001100011011110111101)) (= cat_138 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (fp.lt cat_117 (fp #b0 #b01101011 #b00001100011011110111101))) (and (= cat_100 (fp.div RNE cat_126 cat_117)) (spoon_1 (fp.div RNE cat_126 cat_117)))))
(assert (=> (not (fp.lt cat_117 (fp #b0 #b01101011 #b00001100011011110111101))) (and (= cat_101 cat_100) (spoon_1 cat_100))))
(assert (=> (not (fp.lt cat_117 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_139 cat_101)))
(assert (=> (not (fp.lt cat_117 (fp #b0 #b01101011 #b00001100011011110111101))) (= cat_138 cat_139)))
(assert (not false))
(check-sat)
