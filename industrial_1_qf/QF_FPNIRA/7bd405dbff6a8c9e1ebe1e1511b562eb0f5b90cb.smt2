...
(assert (and (= cat_123 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_162)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_162))))
(assert (= cat_124 (ite (fp.leq cat_163 cat_123) true false)))
