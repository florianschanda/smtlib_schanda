...
(assert (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_93))
(assert (and (= cat_80 cat_79) (spoon_2 cat_79)))
(assert (= cat_94 cat_80))
(assert (not false))
(check-sat)
