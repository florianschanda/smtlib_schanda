...
(assert (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_73))
(assert (and (= cat_60 cat_59) (spoon_2 cat_59)))
(assert (= cat_74 cat_60))
(assert (not false))
(check-sat)
