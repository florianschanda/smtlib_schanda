...
(assert (fp.lt (fp #b0 #b10000001011 #b0000000000000000000000000000000000000000000000000000) cat_75))
(assert (and (= cat_62 cat_61) (spoon_3 cat_61)))
(assert (= cat_76 cat_62))
(assert (not false))
(check-sat)
