...
(assert (= cat_61 1))
(assert (= cat_70 true))
(assert (=> (fp.lt cat_43 (fp #b0 #b01110111 #b01000111101011100001010)) (= cat_74 cat_54)))
(assert (=> (fp.lt cat_43 (fp #b0 #b01110111 #b01000111101011100001010)) (= cat_75 (fp #b0 #b01110111 #b01000111101011100001010))))
(assert (=> (fp.lt cat_43 (fp #b0 #b01110111 #b01000111101011100001010)) (= cat_75 cat_78)))
(assert (=> (fp.lt cat_43 (fp #b0 #b01110111 #b01000111101011100001010)) (= cat_79 cat_75)))
(assert (=> (not (fp.lt cat_43 (fp #b0 #b01110111 #b01000111101011100001010))) (= cat_76 cat_54)))
(assert (=> (not (fp.lt cat_43 (fp #b0 #b01110111 #b01000111101011100001010))) (= cat_77 cat_43)))
(assert (=> (not (fp.lt cat_43 (fp #b0 #b01110111 #b01000111101011100001010))) (= cat_77 cat_78)))
(assert (=> (not (fp.lt cat_43 (fp #b0 #b01110111 #b01000111101011100001010))) (= cat_79 cat_77)))
(assert (not (<= 1 1)))
(check-sat)
