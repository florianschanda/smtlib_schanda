...
(assert (and (= cat_124 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_163)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_163))))
(assert (= cat_125 (ite (fp.leq cat_164 cat_124) true false)))
(assert (not (spoon_3 (fp.mul RNE (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111) cat_163))))
(check-sat)
