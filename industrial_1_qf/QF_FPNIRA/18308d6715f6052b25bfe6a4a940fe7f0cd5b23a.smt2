...
(assert (<= 0 cat_47))
(define-fun spoon_48 ((kitten_40 Int)) Bool (and (<= 3 kitten_40) (<= kitten_40 100)))
...
(define-fun spoon_63 ((kitten_41 Float32) (kitten_42 Bool) (kitten_43 Bool) (kitten_44 Bool)) Bool (=> (or (= kitten_42 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_25 kitten_41)))
(define-fun spoon_64 ((kitten_45 Int) (kitten_46 Bool) (kitten_47 Bool) (kitten_48 Bool)) Bool (=> (or (= kitten_46 true) (<= 1 30)) (spoon_35 kitten_45)))
(define-fun spoon_65 ((kitten_49 Int) (kitten_50 Bool) (kitten_51 Bool) (kitten_52 Bool)) Bool (=> (or (= kitten_50 true) (<= 3 30)) (spoon_36 kitten_49)))
(define-fun spoon_66 ((kitten_53 Int) (kitten_54 Bool) (kitten_55 Bool) (kitten_56 Bool)) Bool (=> (or (= kitten_54 true) (<= 3 100)) (spoon_48 kitten_53)))
(assert (not (<= 1 1)))
(check-sat)
