...
(assert (and (= cat_27 cat_35) (and (spoon_1 cat_27) (=> (fp.eq cat_22 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq cat_27 (fp #b0 #b00000000 #b00000000000000000000000))))))
(assert (= cat_29 cat_26))
(assert (= cat_30 cat_27))
(assert (=> (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_30) (= cat_31 cat_30)))
(assert (=> (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_30) (= cat_32 (fp #b0 #b10001011 #b01101010100000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_30)) (=> (fp.lt cat_30 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))) (= cat_33 cat_30))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_30)) (=> (fp.lt cat_30 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))) (= cat_34 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_30)) (=> (not (fp.lt cat_30 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)))) (= cat_34 cat_30))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_30)) (= cat_32 cat_34)))
(assert (not (spoon_21 cat_32)))
(check-sat)
