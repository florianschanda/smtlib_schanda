...
(assert (and (= cat_37 cat_45) (and (spoon_1 cat_37) (=> (fp.eq cat_32 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq cat_37 (fp #b0 #b00000000 #b00000000000000000000000))))))
(assert (= cat_39 cat_36))
(assert (= cat_40 cat_37))
(assert (=> (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_40) (= cat_41 cat_40)))
(assert (=> (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_40) (= cat_42 (fp #b0 #b10001011 #b01101010100000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_40)) (=> (fp.lt cat_40 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))) (= cat_43 cat_40))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_40)) (=> (fp.lt cat_40 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))) (= cat_44 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000))))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_40)) (=> (not (fp.lt cat_40 (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)))) (= cat_44 cat_40))))
(assert (=> (not (fp.lt (fp #b0 #b10001011 #b01101010100000000000000) cat_40)) (= cat_42 cat_44)))
(assert (not (spoon_30 cat_42)))
(check-sat)
