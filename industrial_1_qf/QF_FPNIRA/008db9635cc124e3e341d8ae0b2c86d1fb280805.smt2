...
(assert (and (= cat_120 cat_200) (spoon_59 cat_120)))
(assert (= cat_173 cat_106))
(assert (= cat_174 cat_120))
(assert (= cat_175 cat_105))
(assert (= cat_176 cat_121))
(assert (= cat_177 cat_107))
(assert (= cat_178 cat_122))
(declare-const cat_201 Float32)
(assert (and (= cat_123 cat_201) (spoon_62 cat_123)))
(assert (= cat_124 ((_ to_fp 11 53) RNE cat_123)))
(assert (= cat_179 cat_108))
(assert (= cat_180 cat_124))
(declare-const cat_202 Float32)
(assert (and (= cat_125 cat_202) (spoon_62 cat_125)))
(assert (= cat_126 ((_ to_fp 11 53) RNE cat_125)))
(assert (= cat_181 cat_109))
(assert (= cat_182 cat_126))
(declare-const cat_203 Float32)
(assert (and (= cat_127 cat_203) (spoon_62 cat_127)))
(assert (= cat_128 ((_ to_fp 11 53) RNE cat_127)))
(assert (= cat_183 cat_128))
(declare-const cat_204 Float32)
(assert (and (= cat_129 cat_204) (spoon_62 cat_129)))
(assert (= cat_130 ((_ to_fp 11 53) RNE cat_129)))
(assert (= cat_184 cat_130))
(declare-const cat_205 Float32)
(assert (and (= cat_131 cat_205) (spoon_62 cat_131)))
(assert (= cat_132 ((_ to_fp 11 53) RNE cat_131)))
(assert (= cat_185 cat_132))
(declare-const cat_206 Float32)
(assert (and (= cat_133 cat_206) (spoon_62 cat_133)))
(assert (= cat_134 ((_ to_fp 11 53) RNE cat_133)))
(assert (= cat_186 cat_134))
(assert (not (spoon_2 (fp.mul RNE cat_182 cat_184))))
(check-sat)
