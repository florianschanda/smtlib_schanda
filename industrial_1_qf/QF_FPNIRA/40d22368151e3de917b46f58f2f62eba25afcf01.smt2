...
(assert (not (fp.lt cat_46 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_46))
(assert (= cat_83 (fp #b0 #b10001011 #b00000000000000000000000)))
(assert (not false))
(check-sat)
