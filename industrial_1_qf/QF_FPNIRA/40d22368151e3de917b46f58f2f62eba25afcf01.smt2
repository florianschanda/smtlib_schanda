...
(assert (not (fp.lt cat_35 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))))
(assert (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_35))
(assert (= cat_72 (fp #b0 #b10001011 #b00000000000000000000000)))
(assert (not false))
(check-sat)
