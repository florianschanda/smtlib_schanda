...
(define-fun spoon_43 ((kitten_24 Float32) (kitten_25 Bool) (kitten_26 Bool) (kitten_27 Bool)) Bool (=> (or (= kitten_25 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_17 kitten_24)))
(define-fun spoon_44 ((kitten_28 Int) (kitten_29 Bool) (kitten_30 Bool) (kitten_31 Bool)) Bool (=> (or (= kitten_29 true) (<= 1 30)) (spoon_26 kitten_28)))
(define-fun spoon_45 ((kitten_32 Int) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool)) Bool (=> (or (= kitten_33 true) (<= 3 30)) (spoon_27 kitten_32)))
(declare-const cat_46 Bool)
(declare-const cat_47 Bool)
(declare-const cat_48 Bool)
(assert (= cat_47 cat_46))
(assert (= cat_48 (spoon_3 0)))
(assert (not (<= 1 1)))
(check-sat)
