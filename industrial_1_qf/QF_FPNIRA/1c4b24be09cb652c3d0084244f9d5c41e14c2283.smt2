...
(define-fun spoon_44 ((kitten_25 Float32) (kitten_26 Bool) (kitten_27 Bool) (kitten_28 Bool)) Bool (=> (or (= kitten_26 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_18 kitten_25)))
(define-fun spoon_45 ((kitten_29 Int) (kitten_30 Bool) (kitten_31 Bool) (kitten_32 Bool)) Bool (=> (or (= kitten_30 true) (<= 1 30)) (spoon_27 kitten_29)))
(define-fun spoon_46 ((kitten_33 Int) (kitten_34 Bool) (kitten_35 Bool) (kitten_36 Bool)) Bool (=> (or (= kitten_34 true) (<= 3 30)) (spoon_28 kitten_33)))
(declare-const cat_47 Bool)
(declare-const cat_48 Bool)
(declare-const cat_49 Bool)
(assert (= cat_48 cat_47))
(assert (= cat_49 (spoon_4 0)))
(assert (not (<= 1 1)))
(check-sat)
