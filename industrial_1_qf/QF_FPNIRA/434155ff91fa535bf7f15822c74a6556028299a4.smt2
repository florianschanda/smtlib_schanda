...
(define-fun spoon_27 ((kitten_41 Float32)) Bool (and (spoon_1 kitten_41) (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)) kitten_41) (fp.leq kitten_41 (fp #b0 #b10000101 #b01100111111101011101000)))))
(define-fun spoon_28 ((kitten_42 Float32) (kitten_43 Float32)) Bool (ite (fp.eq kitten_42 kitten_43) true false))
(define-fun spoon_29 ((kitten_44 Float32) (kitten_45 Bool) (kitten_46 Bool) (kitten_47 Bool)) Bool (=> (or (= kitten_45 true) (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)) (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_27 kitten_44)))
(define-fun spoon_30 ((kitten_48 Float32)) Bool (and (spoon_1 kitten_48) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)) kitten_48) (fp.leq kitten_48 (fp #b0 #b10001011 #b01101010100000000000000)))))
(define-fun spoon_31 ((kitten_49 Float32) (kitten_50 Float32)) Bool (ite (fp.eq kitten_49 kitten_50) true false))
(declare-const cat_32 Float32)
(declare-const cat_33 Int)
(declare-const cat_34 Int)
(define-fun spoon_35 ((kitten_51 Float32) (kitten_52 Bool) (kitten_53 Bool) (kitten_54 Bool)) Bool (=> (or (= kitten_52 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)) (fp #b0 #b10001011 #b01101010100000000000000))) (spoon_30 kitten_51)))
...
(assert (spoon_27 cat_32))
(assert (and (fp.lt (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_32) (fp.lt cat_32 (fp #b0 #b10000101 #b01101000000000000000000))))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (spoon_1 cat_36)))
(declare-const cat_45 Float32)
(assert (not (spoon_14 (fp.abs cat_45) (fp.mul RNE (fp #b0 #b01111101 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
