...
(assert (and (fp.lt (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_22) (fp.lt cat_22 (fp #b0 #b10000101 #b01101000000000000000000))))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (spoon_1 cat_26)))
(assert (not (not (fp.eq (fp.abs (fp.rem cat_22 (fp #b0 #b10000111 #b01101000000000000000000))) (fp.mul RNE (fp #b0 #b01111101 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000))))))
(check-sat)
