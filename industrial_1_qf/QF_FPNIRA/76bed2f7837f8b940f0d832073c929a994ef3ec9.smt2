...
(assert (and (= cat_96 (fp.sqrt RNE cat_77)) (spoon_1 (fp.sqrt RNE cat_77))))
(assert (= cat_96 cat_79))
(assert (spoon_50 cat_79))
...
(assert (and (= cat_97 (fp.mul RNE cat_75 cat_73)) (spoon_1 (fp.mul RNE cat_75 cat_73))))
(assert (= cat_98 ((_ to_fp 11 53) RNE cat_97)))
(assert (= cat_99 (fp.sub RNE cat_98 (fp.mul RNE ((_ to_fp 11 53) RNE cat_67) ((_ to_fp 11 53) RNE cat_79)))))
(assert (= cat_112 cat_99))
(assert (and (= cat_100 (fp.mul RNE cat_79 cat_73)) (spoon_1 (fp.mul RNE cat_79 cat_73))))
(assert (= cat_101 ((_ to_fp 11 53) RNE cat_100)))
(assert (= cat_102 (fp.mul RNE ((_ to_fp 11 53) RNE cat_67) cat_101)))
(assert (= cat_103 (fp.add RNE ((_ to_fp 11 53) RNE cat_77) cat_102)))
(assert (= cat_114 cat_103))
(assert (not (spoon_2 (fp.mul RNE cat_112 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110)))))
(check-sat)
