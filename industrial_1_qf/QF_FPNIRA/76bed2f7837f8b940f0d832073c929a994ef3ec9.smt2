...
(assert (and (= cat_72 (fp.sqrt RNE cat_53)) (spoon_1 (fp.sqrt RNE cat_53))))
(assert (= cat_72 cat_55))
(assert (spoon_32 cat_55))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (spoon_2 cat_62)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (spoon_2 cat_63)))
(assert (and (= cat_73 (fp.mul RNE cat_51 cat_49)) (spoon_1 (fp.mul RNE cat_51 cat_49))))
(assert (= cat_74 ((_ to_fp 11 53) RNE cat_73)))
(assert (= cat_75 (fp.sub RNE cat_74 (fp.mul RNE ((_ to_fp 11 53) RNE cat_43) ((_ to_fp 11 53) RNE cat_55)))))
(assert (= cat_88 cat_75))
(assert (and (= cat_76 (fp.mul RNE cat_55 cat_49)) (spoon_1 (fp.mul RNE cat_55 cat_49))))
(assert (= cat_77 ((_ to_fp 11 53) RNE cat_76)))
(assert (= cat_78 (fp.mul RNE ((_ to_fp 11 53) RNE cat_43) cat_77)))
(assert (= cat_79 (fp.add RNE ((_ to_fp 11 53) RNE cat_53) cat_78)))
(assert (= cat_90 cat_79))
(assert (not (spoon_2 (fp.mul RNE cat_88 (fp #b0 #b10000000100 #b1100101001011101110000001101000000111100111100100110)))))
(check-sat)
