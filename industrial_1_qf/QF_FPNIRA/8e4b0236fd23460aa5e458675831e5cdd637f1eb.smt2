...
(assert (and (= cat_122 cat_121) (spoon_3 cat_121)))
(assert (= cat_158 cat_122))
(assert (and (= cat_123 (fp.div RNE cat_157 cat_158)) (spoon_3 (fp.div RNE cat_157 cat_158))))
(assert (= cat_159 cat_123))
(assert (=> (fp.lt cat_159 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_160 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_159 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_159) (= cat_161 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_159 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_159)) (and (= cat_124 cat_159) (spoon_3 cat_159)))))
(assert (=> (not (fp.lt cat_159 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_159)) (= cat_162 cat_124))))
(assert (=> (not (fp.lt cat_159 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_159)) (= cat_161 cat_162))))
(assert (=> (not (fp.lt cat_159 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (= cat_160 cat_161)))
(assert (and (= cat_125 (fp.mul RNE cat_153 ((_ to_fp 11 53) RNE cat_63))) (spoon_3 (fp.mul RNE cat_153 ((_ to_fp 11 53) RNE cat_63)))))
(assert (= cat_163 cat_125))
(assert (and (= cat_130 (fp.mul RNE cat_153 ((_ to_fp 11 53) RNE cat_65))) (spoon_3 (fp.mul RNE cat_153 ((_ to_fp 11 53) RNE cat_65)))))
(assert (= cat_131 (fp.mul RNE cat_130 cat_155)))
(assert (and (= cat_132 cat_131) (spoon_3 cat_131)))
(assert (and (= cat_126 (fp.sub RNE cat_154 cat_151)) (spoon_3 (fp.sub RNE cat_154 cat_151))))
(assert (= cat_127 (fp.sub RNE cat_126 cat_152)))
(assert (and (= cat_128 cat_127) (spoon_3 cat_127)))
(assert (= cat_129 (fp.mul RNE cat_128 cat_156)))
(assert (and (= cat_133 cat_129) (spoon_3 cat_129)))
(assert (= cat_134 (fp.sub RNE cat_133 cat_132)))
(assert (and (= cat_135 cat_134) (spoon_3 cat_134)))
(assert (= cat_164 cat_135))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_164) (and (= cat_141 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_164)) (spoon_3 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_164)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_164) (= cat_142 (ite (fp.leq cat_163 cat_141) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_164) (and (= cat_140 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_164)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_164)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_164) (= cat_143 (ite (fp.leq cat_140 cat_163) true false))))
(declare-const cat_169 Bool)
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_164) (= cat_166 cat_169)))
(assert (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_164)) (= cat_166 false)))
(assert (=> (= cat_166 true) (= cat_165 true)))
(assert (=> (not (= cat_166 true)) (=> (fp.lt cat_164 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_137 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_164)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_164))))))
(assert (=> (not (= cat_166 true)) (=> (fp.lt cat_164 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_138 (ite (fp.leq cat_163 cat_137) true false)))))
(assert (=> (not (= cat_166 true)) (=> (fp.lt cat_164 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_136 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_164)) (spoon_3 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_164))))))
(assert (=> (not (= cat_166 true)) (=> (fp.lt cat_164 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_139 (ite (fp.leq cat_136 cat_163) true false)))))
(declare-const cat_170 Bool)
(assert (=> (not (= cat_166 true)) (=> (fp.lt cat_164 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_165 cat_170))))
(assert (=> (not (= cat_166 true)) (=> (not (fp.lt cat_164 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_165 false))))
(assert (= cat_165 true))
