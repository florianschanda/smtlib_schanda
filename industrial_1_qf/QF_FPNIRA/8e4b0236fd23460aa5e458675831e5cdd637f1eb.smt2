...
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_191) (and (= cat_168 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_191)) (spoon_2 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_191)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_191) (= cat_169 (ite (fp.leq cat_190 cat_168) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_191) (and (= cat_167 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_191)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_191)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_191) (= cat_170 (ite (fp.leq cat_167 cat_190) true false))))
(declare-const cat_196 Bool)
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_191) (= cat_193 cat_196)))
(assert (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_191)) (= cat_193 false)))
(assert (=> (= cat_193 true) (= cat_192 true)))
(assert (=> (not (= cat_193 true)) (=> (fp.lt cat_191 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_164 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_191)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_191))))))
(assert (=> (not (= cat_193 true)) (=> (fp.lt cat_191 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_165 (ite (fp.leq cat_190 cat_164) true false)))))
(assert (=> (not (= cat_193 true)) (=> (fp.lt cat_191 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_163 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_191)) (spoon_2 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_191))))))
(assert (=> (not (= cat_193 true)) (=> (fp.lt cat_191 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_166 (ite (fp.leq cat_163 cat_190) true false)))))
(declare-const cat_197 Bool)
(assert (=> (not (= cat_193 true)) (=> (fp.lt cat_191 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_192 cat_197))))
(assert (=> (not (= cat_193 true)) (=> (not (fp.lt cat_191 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_192 false))))
(assert (= cat_192 true))
(assert (not (not (fp.isZero cat_191))))
(check-sat)
