...
(assert (and (= cat_117 cat_116) (spoon_2 cat_116)))
(assert (= cat_155 cat_117))
(assert (and (= cat_118 (fp.add RNE cat_152 cat_149)) (spoon_2 (fp.add RNE cat_152 cat_149))))
(assert (= cat_119 (fp.add RNE cat_118 cat_150)))
(assert (and (= cat_120 cat_119) (spoon_2 cat_119)))
(assert (= cat_156 cat_120))
(assert (and (= cat_121 (fp.div RNE cat_155 cat_156)) (spoon_2 (fp.div RNE cat_155 cat_156))))
...
(assert (=> (not (fp.lt cat_157 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_157)) (and (= cat_122 cat_157) (spoon_2 cat_157)))))
...
(assert (and (= cat_123 (fp.mul RNE cat_151 ((_ to_fp 11 53) RNE cat_61))) (spoon_2 (fp.mul RNE cat_151 ((_ to_fp 11 53) RNE cat_61)))))
(assert (= cat_161 cat_123))
(assert (and (= cat_128 (fp.mul RNE cat_151 ((_ to_fp 11 53) RNE cat_63))) (spoon_2 (fp.mul RNE cat_151 ((_ to_fp 11 53) RNE cat_63)))))
(assert (= cat_129 (fp.mul RNE cat_128 cat_153)))
(assert (and (= cat_130 cat_129) (spoon_2 cat_129)))
(assert (and (= cat_124 (fp.sub RNE cat_152 cat_149)) (spoon_2 (fp.sub RNE cat_152 cat_149))))
(assert (= cat_125 (fp.sub RNE cat_124 cat_150)))
(assert (and (= cat_126 cat_125) (spoon_2 cat_125)))
(assert (= cat_127 (fp.mul RNE cat_126 cat_154)))
(assert (and (= cat_131 cat_127) (spoon_2 cat_127)))
(assert (= cat_132 (fp.sub RNE cat_131 cat_130)))
(assert (and (= cat_133 cat_132) (spoon_2 cat_132)))
(assert (= cat_162 cat_133))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_162) (and (= cat_139 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_162)) (spoon_2 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_162)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_162) (= cat_140 (ite (fp.leq cat_161 cat_139) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_162) (and (= cat_138 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_162)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_162)))))
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_162) (= cat_141 (ite (fp.leq cat_138 cat_161) true false))))
(declare-const cat_167 Bool)
(assert (=> (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_162) (= cat_164 cat_167)))
(assert (=> (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_162)) (= cat_164 false)))
(assert (=> (= cat_164 true) (= cat_163 true)))
(assert (=> (not (= cat_164 true)) (=> (fp.lt cat_162 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_135 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_162)) (spoon_2 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_162))))))
(assert (=> (not (= cat_164 true)) (=> (fp.lt cat_162 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_136 (ite (fp.leq cat_161 cat_135) true false)))))
(assert (=> (not (= cat_164 true)) (=> (fp.lt cat_162 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (= cat_134 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_162)) (spoon_2 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_162))))))
(assert (=> (not (= cat_164 true)) (=> (fp.lt cat_162 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_137 (ite (fp.leq cat_134 cat_161) true false)))))
(declare-const cat_168 Bool)
(assert (=> (not (= cat_164 true)) (=> (fp.lt cat_162 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (= cat_163 cat_168))))
(assert (=> (not (= cat_164 true)) (=> (not (fp.lt cat_162 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (= cat_163 false))))
(assert (= cat_163 true))
