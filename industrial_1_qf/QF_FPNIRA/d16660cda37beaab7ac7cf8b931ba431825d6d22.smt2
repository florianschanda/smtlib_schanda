...
(define-fun spoon_54 ((kitten_39 Float32) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool)) Bool (=> (or (= kitten_40 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_18 kitten_39)))
(define-fun spoon_55 ((kitten_43 Int) (kitten_44 Bool) (kitten_45 Bool) (kitten_46 Bool)) Bool (=> (or (= kitten_44 true) (<= 3 30)) (spoon_33 kitten_43)))
...
(assert (spoon_27 cat_48))
(assert (= cat_59 cat_56))
(assert (= cat_60 (spoon_16 0)))
(assert (=> (<= 1 30) (spoon_31 cat_57)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_29 cat_58)))
