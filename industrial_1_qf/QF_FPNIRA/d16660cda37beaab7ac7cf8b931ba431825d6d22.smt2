...
(define-fun spoon_65 ((kitten_62 Int) (kitten_63 Bool) (kitten_64 Bool) (kitten_65 Bool)) Bool (=> (or (= kitten_63 true) (<= 3 30)) (spoon_43 kitten_62)))
...
(assert (spoon_35 cat_58))
(assert (= cat_69 cat_66))
(assert (= cat_70 (spoon_23 0)))
(assert (=> (<= 1 30) (spoon_41 cat_67)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_38 cat_68)))
