...
(assert (<= 0 cat_31))
(define-fun spoon_32 ((kitten_35 Float32)) Bool (and (spoon_1 kitten_35) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_35) (fp.leq kitten_35 (fp #b0 #b01111111 #b00000000000000000000000)))))
(define-fun spoon_33 ((kitten_36 Float32) (kitten_37 Float32)) Bool (ite (fp.eq kitten_36 kitten_37) true false))
(define-fun spoon_34 ((kitten_38 Float32) (kitten_39 Bool) (kitten_40 Bool) (kitten_41 Bool)) Bool (=> (or (= kitten_39 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_32 kitten_38)))
(declare-const cat_35 Int)
(declare-const cat_36 Int)
(declare-const cat_37 Float32)
(declare-const cat_38 Int)
(define-fun spoon_39 ((kitten_42 Float32) (kitten_43 Bool) (kitten_44 Bool) (kitten_45 Bool)) Bool (=> (or (= kitten_43 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_22 kitten_42)))
(declare-const cat_40 Float32)
(declare-const cat_41 Float32)
(assert (spoon_32 cat_37))
(assert (not false))
(check-sat)
