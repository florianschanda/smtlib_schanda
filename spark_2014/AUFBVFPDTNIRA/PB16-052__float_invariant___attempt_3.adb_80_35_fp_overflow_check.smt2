...
;; H
  (assert
  (and (= o42 (low_bound o41))
  (and (fp.isFinite64 o42)
  (= o42 (fp.mul RNE (of_int RNE o41) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))))

;; H
  (assert
  (and (= o39 (low_bound n))
  (and (fp.isFinite64 o39)
  (= o39 (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))))
