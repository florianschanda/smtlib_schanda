...
;; H
  (assert (and (= o5 (+ j divisor_index2)) (in_range1 (+ j divisor_index2))))

;; H
  (assert (= temp___1306 (- o5 1)))

;; H
  (assert (= o6 temp___1306))

;; H
  (assert (= o11 ((_ zero_extend 8) o7)))

;; H
  (assert (= o12 (bvadd o11 o10)))

;; H
  (assert (= o13 (bvadd o12 carry2)))

;; H
  (assert (= sum3 o13))

(declare-fun abstr14 () (_ BitVec 8))
...
;; H
  (assert
  (and (= o14 (+ j divisor_index2)) (in_range1 (+ j divisor_index2))))

;; H
  (assert (= temp___1309 (- o14 1)))
