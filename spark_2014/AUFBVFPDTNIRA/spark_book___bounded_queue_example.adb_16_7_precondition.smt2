...
(define-fun in_range7 ((rec__bounded_queue_example__char_queue__queue_type__max_size1 Int)
...
(define-fun bounded_queue_example__char_queue__clear__queue__fields5 () us_split_fields
...
;; H
  (assert (and (<= 102 char2) (<= char2 112)))
