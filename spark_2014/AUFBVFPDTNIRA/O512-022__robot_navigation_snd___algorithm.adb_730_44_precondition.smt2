...
;; H
  (assert
  (=> (= (of_int1 0) true)
  (and (= o43 (norm (mk___rep1 disttogoal__split_fields2)))
  (and (fp.isFinite32 o43)
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o43)
  (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) o43)
  (not (= (oeq (mk___rep1 disttogoal__split_fields2) zero_position) true))))))))

;; H
  (assert (=> (= (of_int1 0) true) (= o44 (attr__ATTRIBUTE_IMAGE5 o43))))

;; H
  (assert (=> (= (of_int1 0) true) (= o45 (to_string o44))))

;; H
  (assert
  (=> (= (of_int1 0) true)
  (= o46 (bearing (mk___rep1 disttogoal__split_fields2)))))

;; H
  (assert
  (=> (= (of_int1 0) true)
  (and (= o47 (print o46)) (dynamic_invariant4 o47 true false true))))
