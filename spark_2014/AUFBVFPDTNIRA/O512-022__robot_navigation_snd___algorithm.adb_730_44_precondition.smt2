...
(declare-fun o8 () us_image)

(declare-fun o9 () us_t)

(declare-fun o10 () us_rep)

(declare-fun o11 () us_t)
...
;; H
  ...
  (=> (= (of_int1 0) true)
  (and
  (and (= o7 (norm (mk___rep1 disttogoal__split_fields)))
  (norm__function_guard o7 (mk___rep1 disttogoal__split_fields)))
  (and (not (or (fp.isInfinite o7) (fp.isNaN o7)))
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o7)
  (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) o7)
  (not (= (oeq (mk___rep1 disttogoal__split_fields) zero_position) true))))))))

;; H
  (assert (=> (= (of_int1 0) true) (= o8 (attr__ATTRIBUTE_IMAGE5 o7))))

;; H
  (assert (=> (= (of_int1 0) true) (= o9 (to_string o8))))

;; H
  (assert
  (=> (= (of_int1 0) true)
  (and (= o10 (bearing (mk___rep1 disttogoal__split_fields)))
  (bearing__function_guard o10 (mk___rep1 disttogoal__split_fields)))))

;; H
  (assert
  (=> (= (of_int1 0) true)
  (and (and (= o11 (print o10)) (print__function_guard o11 o10))
  (dynamic_invariant4 o11 true false true))))
