...
;; H
  (assert (=> (= (distinct 0 0) true) (= o8 (attr__ATTRIBUTE_IMAGE5 o7))))

;; H
  (assert (=> (= (distinct 0 0) true) (= o9 (to_string o8))))

;; H
  (assert
  (=> (= (distinct 0 0) true)
  (= o10 (bearing (mk___rep1 disttogoal__split_fields)))))

;; H
  (assert
  (=> (= (distinct 0 0) true)
  (and (= o11 (print o10)) (dynamic_invariant4 o11 true false true true))))
