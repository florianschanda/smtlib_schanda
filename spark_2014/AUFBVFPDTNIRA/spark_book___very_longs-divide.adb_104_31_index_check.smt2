...
(declare-fun temp___1234 () digit_index_type)

(declare-fun temp___12341 () (Array Int octet))

(declare-fun temp___12342 () t)
...
;; H
  ...
  (=>
  (and (<= (to_rep1 (first number__split_fields3)) temp___1242)
  (<= temp___1242 (to_rep1 (last number__split_fields3))))
  (=> (<= temp___1242 i2)
  (= (select number__split_fields2 temp___1242) (select number__split_fields temp___1242))))))
  (and (<= 1 i2) (<= i2 r123b))))
...
;; H
  (assert (= number__split_discrs (mk___split_discrs temp___1234)))

;; H
  (assert (= temp___12341 o14))

;; H
  (assert (= temp___12342 o15))
...
;; H
  ...
  (= number__split_fields4 (mk___split_fields
                           (mk___t temp___12341 temp___12342))))
