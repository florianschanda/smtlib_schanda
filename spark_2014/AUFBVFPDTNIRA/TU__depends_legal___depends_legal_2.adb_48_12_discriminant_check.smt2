...
(define-fun depends_legal_2__dis_rec__a__pred ((a us_rep)) Bool (= (to_int1
                                                                   (rec__depends_legal_2__dis_rec__d
                                                                   (us_split_discrs1
                                                                   a))) 1))

(define-fun depends_legal_2__dis_rec__b__pred ((a us_rep)) Bool (= (to_int1
                                                                   (rec__depends_legal_2__dis_rec__d
                                                                   (us_split_discrs1
                                                                   a))) 1))

(define-fun depends_legal_2__dis_rec__x__pred ((a us_rep)) Bool (= (to_int1
                                                                   (rec__depends_legal_2__dis_rec__d
                                                                   (us_split_discrs1
                                                                   a))) 0))

(define-fun depends_legal_2__dis_rec__y__pred ((a us_rep)) Bool (= (to_int1
                                                                   (rec__depends_legal_2__dis_rec__d
                                                                   (us_split_discrs1
                                                                   a))) 0))

(define-fun depends_legal_2__dis_rec__z__pred ((a us_rep)) Bool (= (to_int1
                                                                   (rec__depends_legal_2__dis_rec__d
                                                                   (us_split_discrs1
                                                                   a))) 0))
