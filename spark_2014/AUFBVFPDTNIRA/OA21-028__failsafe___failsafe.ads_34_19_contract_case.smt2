...
;; WP_parameter_def
 ;; File "failsafe.ads", line 16, characters 0-0
  ...
  (fp.leq battery_threshold (to_rep
                            (select battery_level_at (let ((temp___308 (bvsub
                                                     current_time (t__content
                                                                  failsafe__model__time_below_threshold__result4))))
                                                     (ite (bvult current_time
                                                     (t__content
                                                     failsafe__model__time_below_threshold__result4))
                                                     (bvadd temp___308 #x32)
                                                     temp___308)))))))
(check-sat)
(exit)
