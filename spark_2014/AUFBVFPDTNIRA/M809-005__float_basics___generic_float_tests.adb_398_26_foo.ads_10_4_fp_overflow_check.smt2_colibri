...
;; H
  (assert
  (and (= o1 (fp.add RNE x (fp #b0 #b01111110 #b00000000000000000000000)))
  (not (or (fp.isInfinite (fp.add RNE x (fp #b0 #b01111110 #b00000000000000000000000))) (fp.isNaN (fp.add RNE
  x (fp #b0 #b01111110 #b00000000000000000000000)))))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (not (or (fp.isInfinite (fp.sub RNE x (fp #b0 #b01111110 #b00000000000000000000000))) (fp.isNaN (fp.sub RNE
  x (fp #b0 #b01111110 #b00000000000000000000000)))))))
(check-sat)
(exit)
