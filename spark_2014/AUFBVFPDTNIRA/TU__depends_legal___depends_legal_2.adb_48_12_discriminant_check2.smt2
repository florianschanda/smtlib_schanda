...
;; H
  (assert
  (=> (not (= par1__split_discrs true))
  (= (mk___rep (mk___split_discrs usq_7)
     (mk___split_fields usq_8 usq_9 usq_10 usq_11 usq_12) usq_13) (mk___rep
                                                                  (mk___split_discrs
                                                                  temp___185)
                                                                  (mk___split_fields
                                                                  temp___1851
...
;; H
  (assert
  (=> (not (= par1__split_discrs true))
  (= temp___187 (mk___rep (mk___split_discrs usq_7)
                (mk___split_fields usq_8 usq_9 usq_10 usq_11 usq_12)
