...
(define-fun us_split_fields_C__projection ((a us_split_fields)) float
...
;; dummy__def_axiom
  ...
  (= dummy7 (let ((temp___160 (t__dummy__aggregate_def
                              (mk___rep
                              (mk___split_fields rliteral (distinct 1 0)
                              (of_rep
                              (fp #b0 #b01111111 #b00000000000000000000000))))
                              0 (__cdiv value__size 8))))
...
;; H
  (assert
  (= temp___1902 (t__dummy__aggregate_def
                 (mk___rep (mk___split_fields o4 o5 o6)) 0
                 (__cdiv value__size 8))))
...
;; H
  (assert (= (to_rep1 (last2 temp___1901)) (__cdiv value__size 8)))
...
;; WP_parameter_def
 ;; File "t.ads", line 15, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 temp___1911)) (to_rep1 (last2 temp___1911)))
     (+ (- (to_rep1 (last2 temp___1911)) (to_rep1 (first2 temp___1911))) 1)
     0) (ite (<= 0 (__cdiv value__size 8)) (+ (- (__cdiv value__size 8) 0) 1)
        0))))
(check-sat)
(exit)
