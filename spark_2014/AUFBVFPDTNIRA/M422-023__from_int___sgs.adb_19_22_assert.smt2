...
;; H
  (assert (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (a x3)))

;; H
  (assert (fp.leq (a x3) (fp #b0 #b10000010 #b11000000000000000000000)))
...
;; H
  (assert (fp.leq o (fp #b0 #b10000010 #b11000000000000000000000)))
...
;; H
  (assert (fp.leq o1 (fp #b0 #b10000010 #b11000000000000000000000)))
...
;; WP_parameter_def
 ;; File "sgs.ads", line 3, characters 0-0
  (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) r11)))
(check-sat)
(exit)
