...
;; H
  (assert
  (= o6 (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000))))
...
;; H
  (assert
  (= o9 (fp.add RNE o8 (fp #b0 #b10000000 #b10000000000000000000000))))
...
;; H
  (assert
  (= o11 (fp.add RNE o10 (fp #b0 #b10000001 #b00000000000000000000000))))
...
;; H
  (assert
  (= o15 (fp.add RNE o14 (fp #b0 #b10000001 #b01000000000000000000000))))
