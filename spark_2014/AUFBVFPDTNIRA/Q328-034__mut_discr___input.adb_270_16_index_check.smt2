...
;; H
  (assert (<= (to_rep1 s__first) i1))

;; H
  (assert (<= i1 (to_rep1 s__last)))
...
;; H
  ...
  (=> (<= i2 temp___619) (= (select s2 temp___619) (select s1 temp___619)))))
  (and (<= (to_rep1 s__first) i2) (<= i2 (to_rep1 s__last)))))

;; H
  (assert (and (<= (to_rep1 s__first) i2) (<= i2 (to_rep1 s__last))))

;; H
  (assert (= o10 i2))

;; H
  (assert (= o11 (select s2 o10)))

;; H
  (assert (= o12 (to_rep o11)))

;; H
  (assert (and (= o13 (to_upper o12)) (in_range3 o13)))
