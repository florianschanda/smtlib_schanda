...
;; H
  ...
  (=> (and (<= 1 temp___1000) (<= temp___1000 1000))
  (=> (<= (let ((subject i)) i2) temp___1000)
  (= (select (rec__algorithm__controller__laserscan
             (let ((subject this__split_fields)) this__split_fields2)) temp___1000) (select
  (rec__algorithm__controller__laserscan
  (let ((subject this__split_fields)) this__split_fields1)) temp___1000))))))
  (= (rec__algorithm__controller__gapvec
...
;; H
  (assert (= temp___992 (mk___rep10 o8)))
