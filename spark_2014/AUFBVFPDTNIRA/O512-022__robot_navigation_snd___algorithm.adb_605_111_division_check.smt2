...
;; H
  ...
  (=> (and (<= 1 temp___1002) (<= temp___1002 1000))
  (=>
  (or (< 1000 temp___1002)
  (or (< temp___1002 1) (<= (let ((subject i)) i2) temp___1002)))
  (= (select (rec__algorithm__controller__laserscan
             (let ((subject this__split_fields)) this__split_fields2)) temp___1002) (select
  (rec__algorithm__controller__laserscan
  (let ((subject this__split_fields)) this__split_fields1)) temp___1002))))))
  (= (rec__algorithm__controller__gapvec
