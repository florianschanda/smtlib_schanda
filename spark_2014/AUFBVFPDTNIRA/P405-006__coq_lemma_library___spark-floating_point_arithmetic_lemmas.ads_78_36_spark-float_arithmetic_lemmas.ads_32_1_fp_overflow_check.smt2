...
;; H
  (assert
  (fp.leq (fp.neg (fp #b0 #b10111110 #b00000000000000000000000)) val1))
...
;; H
  (assert
  (fp.leq (fp.neg (fp #b0 #b10111110 #b00000000000000000000000)) val2))

;; H
  (assert (fp.leq val2 fl_last_sqrt))

;; H
  (assert (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) val3))

;; H
  (assert (fp.leq val3 fl_last_sqrt))
...
(assert
;; WP_parameter_def
 ;; File "spark-floating_point_arithmetic_lemmas.ads", line 57, characters 0-0
  (not (fp.isFinite32 (fp.mul RNE val2 val3))))
(check-sat)
(exit)
