...
;; H
  (assert
  (= (to_fixed1 o20) (+ (- (to_fixed1 a101) (* (to_fixed1 a91) 2)) (to_fixed1
                                                                   a81))))
...
;; H
  (assert
  (= (to_fixed1 o21) (fxp_div (to_fixed1 num1)
                     (to_fixed1 (let ((subject den)) den1)))))
...
;; H
  (assert
  (= pi_compute__shanks_fixed__result2 (let ((subject pi_compute__shanks_fixed__result))
                                       (mk_fixed__ref
                                       pi_compute__shanks_fixed__result1))))

;; H
  (assert
  (= pi_compute__shanks_fixed__result3 pi_compute__shanks_fixed__result1))
...
;; H
  (assert
  (= (let ((subject pi_compute__shanks_fixed__result))
     pi_compute__shanks_fixed__result1) (let ((subject res)) res1)))

;; H
  (assert
  (= pi_compute__shanks_fixed__result4 pi_compute__shanks_fixed__result2))
...
;; H
  (assert
  (= pi_compute__shanks_fixed__result5 pi_compute__shanks_fixed__result3))
