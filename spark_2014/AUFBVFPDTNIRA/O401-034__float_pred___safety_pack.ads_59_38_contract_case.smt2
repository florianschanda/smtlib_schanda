...
;; H
  ...
  (or
  (or
  (fp.eq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b00000000 #b00000000000000000000000))
  (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp.neg (fp #b0 #b00110101 #b00000000000000000000000))))
  (fp.leq (fp #b0 #b00110101 #b00000000000000000000000) (fp #b0 #b00000000 #b00000000000000000000000)))))

;; H
  (assert
  (=> (fp.eq x (fp #b0 #b00000000 #b00000000000000000000000))
  (= o (fp #b0 #b00000000 #b00000000000000000000000))))
...
;; H
  (assert
  (=> (fp.eq x (fp #b0 #b00000000 #b00000000000000000000000)) (= res1 o)))
...
;; H
  ...
  (or
  (or (fp.eq temp___1352 (fp #b0 #b00000000 #b00000000000000000000000))
  (fp.leq temp___1352 (fp.neg (fp #b0 #b00110101 #b00000000000000000000000))))
  (fp.leq (fp #b0 #b00110101 #b00000000000000000000000) temp___1352))))))
...
;; H
  ...
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x)
  (fp.leq x (fp #b0 #b00110101 #b00000000000000000000000)))
  (= o2 (fp #b0 #b00110101 #b00000000000000000000000))))))
...
;; H
  ...
  (=>
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x)
  (fp.leq x (fp #b0 #b00110101 #b00000000000000000000000))) (= res3 o2)))))
...
;; H
  ...
  (not
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x)
  (fp.leq x (fp #b0 #b00110101 #b00000000000000000000000)))) (= o3 x)))))
...
;; H
  (assert (= (bool_eq x (fp #b0 #b00000000 #b00000000000000000000000)) true))
