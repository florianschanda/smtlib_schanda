...
;; H
  ...
  (not (or (fp.isInfinite (fp.add RNE speed2 delta_speed2)) (fp.isNaN (fp.add RNE
  speed2 delta_speed2))))))
...
;; H
  (assert (and (= o11 (+ distance2 5)) (in_range2 (+ distance2 5))))

;; H
  (assert (= distance2 result4))

;; H
  (assert (= distance3 o11))

;; H
  (assert (fp.lt final_speed speed3))

;; H
  (assert (fp.lt (fp #b0 #b01111011 #b10011001100110011001101) speed3))
...
;; WP_parameter_def
 ;; File "units.ads", line 27, characters 0-0
  (not (fp.lt (fp #b0 #b01111011 #b10011001100110011001101) speed3)))
(check-sat)
(exit)
