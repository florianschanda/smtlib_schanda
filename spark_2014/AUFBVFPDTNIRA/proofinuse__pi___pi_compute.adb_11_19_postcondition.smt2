...
(declare-fun res () fixed)

(declare-fun pi_compute__leibniz_fixed__result () fixed)
...
(declare-fun pi_compute__leibniz_fixed__result1 () fixed)

(declare-fun pi_compute__leibniz_fixed__result2 () fixed__ref)

(declare-fun pi_compute__leibniz_fixed__result3 () fixed)
...
(declare-fun pi_compute__leibniz_fixed__result4 () fixed__ref)
...
(declare-fun pi_compute__leibniz_fixed__result5 () fixed)

(declare-fun result12 () fixed)
...
;; H
  (assert
  (= (to_fixed1 o10) (* (- (+ (- (+ (- (+ (- (+ (- (to_fixed1 t11) (to_fixed1
                                                                   t21)) 
  (to_fixed1 t31)) (to_fixed1 t41)) (to_fixed1 t51)) (to_fixed1 t61)) 
  (to_fixed1 t71)) (to_fixed1 t81)) (to_fixed1 t91)) (to_fixed1 t101)) 4)))

;; H
  (assert (= result10 (mk_fixed__ref res)))

;; H
  (assert (= res1 o10))

;; H
  (assert (= (to_fixed1 res1) 3189596))

;; H
  (assert
  (= pi_compute__leibniz_fixed__result2 (mk_fixed__ref
                                        pi_compute__leibniz_fixed__result1)))

;; H
  (assert
  (= pi_compute__leibniz_fixed__result3 pi_compute__leibniz_fixed__result1))

;; H
  (assert (= result11 (mk_fixed__ref pi_compute__leibniz_fixed__result)))

;; H
  (assert (= pi_compute__leibniz_fixed__result1 res1))

;; H
  (assert
  (= pi_compute__leibniz_fixed__result4 pi_compute__leibniz_fixed__result2))

;; H
  (assert (= res2 (mk_fixed__ref res1)))

;; H
  (assert (= t102 (mk_fixed__ref t101)))

;; H
  (assert (= t92 (mk_fixed__ref t91)))

;; H
  (assert (= t82 (mk_fixed__ref t81)))

;; H
  (assert (= t72 (mk_fixed__ref t71)))

;; H
  (assert (= t62 (mk_fixed__ref t61)))

;; H
  (assert (= t52 (mk_fixed__ref t51)))

;; H
  (assert (= t42 (mk_fixed__ref t41)))

;; H
  (assert (= t32 (mk_fixed__ref t31)))

;; H
  (assert (= t22 (mk_fixed__ref t21)))

;; H
  (assert (= t12 (mk_fixed__ref t11)))

;; H
  (assert
  (= pi_compute__leibniz_fixed__result5 pi_compute__leibniz_fixed__result3))
...
;; H
  (assert (= result12 (fixed__content pi_compute__leibniz_fixed__result4)))

(assert
;; WP_parameter_def
 ;; File "pi_compute.adb", line 7, characters 0-0
  (not
  (= (to_fixed1 (fixed__content pi_compute__leibniz_fixed__result4)) 3189596)))
(check-sat)
