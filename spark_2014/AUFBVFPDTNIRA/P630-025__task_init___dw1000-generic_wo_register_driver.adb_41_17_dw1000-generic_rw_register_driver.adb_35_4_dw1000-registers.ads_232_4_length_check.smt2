...
(define-fun us_split_fields_Reserved_13__projection ((a us_split_fields)) bits_1 
  (rec__dw1000__register_types__sys_mask_type__reserved_1 a))

(define-fun us_split_fields_Reserved_23__projection ((a us_split_fields)) bits_1 
  (rec__dw1000__register_types__sys_mask_type__reserved_2 a))

(define-fun us_split_fields_Reserved_32__projection ((a us_split_fields)) bits_2 
...
(define-fun register_type__ref_27__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_19__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_19__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2578 us_t1)
  (temp___is_init_2575 Bool) (temp___skip_constant_2576 Bool)
  (temp___do_toplevel_2577 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2576 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_2578)
                                       (last4 temp___expr_2578))
                                       (and (= (first3 temp___expr_2578) 1)
                                       (= (last4 temp___expr_2578) 4)))))
...
(define-fun target__ref_9__projection ((a target__ref)) us_t2 (target__content
                                                              a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_9__projection ((a source__ref)) us_rep (source__content
                                                               a))

(define-fun dynamic_invariant1 ((temp___expr_2624 us_t2)
  (temp___is_init_2621 Bool) (temp___skip_constant_2622 Bool)
  (temp___do_toplevel_2623 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2622 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_2624)
                                       (last6 temp___expr_2624))
                                       (and (= (first5 temp___expr_2624) 1)
                                       (= (last6 temp___expr_2624) 4)))))
...
(declare-fun temp___7603 () (Array Int bits_8))

(declare-fun temp___76031 () t2)

(declare-fun temp___7604 () (Array Int bits_8))

(declare-fun temp___76041 () t1)

(define-fun temp___76032 () us_t2 (mk___t2 temp___7603 temp___76031))
...
;; H
  (assert
  (and
  (and (= temp___76032 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___76032 reg)) (dynamic_invariant1
  temp___76032 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___76031)) (to_rep (last5 temp___76031)))
     (+ (- (to_rep (last5 temp___76031)) (to_rep (first4 temp___76031))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___7603 temp___7604))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76031)) (to_rep (last5 temp___76031))) 
  temp___76041))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___76041)) (to_rep (last3 temp___76041)))
     (+ (- (to_rep (last3 temp___76041)) (to_rep (first2 temp___76041))) 1)
