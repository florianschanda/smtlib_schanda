...
(define-fun bool_eq17 ((x Float32)
  (y Float32)) Bool (ite (fp.eq x y) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_696 Float32)
...
(define-fun dynamic_invariant9 ((temp___expr_149 Float32)
...
(define-fun dynamic_invariant10 ((temp___expr_167 Float32)
...
(define-fun dynamic_invariant11 ((temp___expr_179 Float32)
...
(declare-fun temp___902 () Float32)

(declare-fun temp___901 () Float32)

(declare-fun temp___900 () Float32)

(declare-fun temp___899 () Float32)

(declare-fun temp___898 () Int)

(declare-fun temp___897 () Float32)
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 1000)) (= temp___901 deltaareasum1)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 1000)) (= temp___900 deltaangle)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 1000)) (= temp___899 deltamag)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 1000)) (= temp___898 i1)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 1000)) (= temp___897 obstacleavoiddelta1)))
...
;; H
  ...
  (limit__function_guard o6 o5 (fp #b0 #b00000000 #b00000000000000000000000)
  (fp #b0 #b01111111 #b00000000000000000000000)))
...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 1000))
  (=> (= result3 true)
  (and (= o16 (create__2 (fp #b0 #b10000000 #b10010010000111111011011)))
  (create__2__function_guard o16
...
;; H
  ...
  (= o15 (oadd
         ...
         (select (rec__algorithm__controller__laserscan
                 (us_split_fields11 this)) i2)))
         o16))
  (oadd__function_guard o15
  (rec__algorithm__laser_scan_data__second
  (us_split_fields7
  (select (rec__algorithm__controller__laserscan (us_split_fields11 this)) 
  i2))) o16)))))
...
;; H
  ...
  (= o10 (aldiff
         ...
         o15))
  (aldiff__function_guard o10
  (rec__algorithm__controller__driveangle (us_split_fields11 this)) o15))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (not (or (fp.isInfinite (fp.div RNE (t__content obstacleavoiddelta6) 
  (t__content deltaareasum6))) (fp.isNaN (fp.div RNE (t__content
                                                     obstacleavoiddelta6) 
  (t__content deltaareasum6)))))))
(check-sat)
