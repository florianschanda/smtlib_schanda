...
(declare-const this__split_fields3 us_split_fields__ref10)

(declare-const this__split_fields4 us_split_fields20)
...
;; H
  ...
  (=>
  (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))
  (in_range6 disttoclosestobstacle2)))
  (and
  (= (attr__constrained
     (rec__robot_iface__proxy__speed
     (us_split_fields9
...
;; WP_parameter_def
 ;; File "algorithm.ads", line 107, characters 0-0
  ...
  (fp.isFinite32 (fp.add RNE (to_rep3
                             ...
                             (us_split_fields9
                             (rec__algorithm__controller__robot
                             (us_split_fields__content10 this__split_fields3)))))
  (to_rep3
  (rec__robot_iface__proxy__robot_radius
  (us_split_fields9
  (rec__algorithm__controller__robot
