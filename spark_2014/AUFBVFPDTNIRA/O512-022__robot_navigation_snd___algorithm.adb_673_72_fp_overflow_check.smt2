...
(declare-fun rho () us_split_fields8)

(declare-fun this__split_fields3 () us_split_fields__ref10)

(declare-fun this__split_fields4 () us_split_fields20)

(declare-fun rho1 () us_split_fields8)
...
;; H
  ...
  (fp.lt (to_rep3
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content10 this__split_fields1))))) (to_rep3
                                                              (rec__robot_iface__proxy__max_range
                                                              (us_split_fields9
                                                              (rec__algorithm__controller__robot
...
;; H
  (assert
  (= disttoclosestobstacle1 (to_rep3
                            (rec__robot_iface__proxy__max_range
                            (us_split_fields9
                            (rec__algorithm__controller__robot
                            (us_split_fields__content10 this__split_fields1)))))))
...
;; H
  ...
  (fp.lt (to_rep3
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content10 this__split_fields1))))) disttoclosestobstacle1))
...
;; H
  (assert (<= 1 (let ((subject i)) i1)))

;; H
  (assert (<= (let ((subject i)) i1) 1000))
...
;; H
  ...
  (and
  (and
  (and (=> (<= 1 1000) (dynamic_property1 1 1000 (let ((subject i)) i2)))
  (=>
  (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))
  (in_range7 disttoclosestobstacle2)))
  (and
  (= (attr__constrained
     (rec__robot_iface__proxy__speed
     (us_split_fields9
  ...
  (= (rec__algorithm__controller__laserscan
     (let ((subject this__split_fields)) this__split_fields2)) (rec__algorithm__controller__laserscan
                                                               ...
                                                               this__split_fields1)))
  (= (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields2)) (rec__algorithm__controller__gapvec
                                                               (us_split_fields__content10
                                                               this__split_fields1))))
  (= (rec__algorithm__controller__obsavoiddelta
  ...
  (= (rec__algorithm__controller__driveangle
     (let ((subject this__split_fields)) this__split_fields2)) (rec__algorithm__controller__driveangle
                                                               (us_split_fields__content10
                                                               this__split_fields1)))))
  (and (<= 1 (let ((subject i)) i2)) (<= (let ((subject i)) i2) 1000))))
...
;; H
  ...
  (fp.lt (to_rep3
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content10 this__split_fields3))))) (to_rep4
                                                              (rec__algorithm__laser_scan_data__first
                                                              (us_split_fields19
                                                              (select 
                                                              (rec__algorithm__controller__laserscan
...
;; WP_parameter_def
 ;; File "algorithm.ads", line 107, characters 0-0
  ...
  (not (or (fp.isInfinite (fp.add RNE (to_rep3
                                      ...
                                      (rec__algorithm__controller__robot
                                      (us_split_fields__content10
                                      this__split_fields3))))) (to_rep3
                                                               (rec__robot_iface__proxy__robot_radius
                                                               (us_split_fields9
                                                               (rec__algorithm__controller__robot
                                                               (us_split_fields__content10
                                                               this__split_fields3))))))) (fp.isNaN (fp.add RNE 
  (to_rep3
  (rec__robot_iface__proxy__obstacle_avoid_dist
  (us_split_fields9
  (rec__algorithm__controller__robot
  (us_split_fields__content10 this__split_fields3))))) (to_rep3
                                                       (rec__robot_iface__proxy__robot_radius
                                                       (us_split_fields9
                                                       (rec__algorithm__controller__robot
                                                       (us_split_fields__content10
