...
;; H
  ...
  (fp.lt (to_rep3
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content10 this__split_fields8))))) (to_rep3
                                                              (rec__robot_iface__proxy__max_range
                                                              (us_split_fields9
                                                              (rec__algorithm__controller__robot
...
;; H
  ...
  (= (attr__constrained
     ...
     (us_split_fields9
     (rec__algorithm__controller__robot
     (us_split_fields__content10 this__split_fields8))))) false)
  (= 1000 (to_rep11
          (rec__algorithm__gap_vectors__list__capacity
          (us_split_discrs5
          (rec__algorithm__controller__gapvec
          (us_split_fields__content10 this__split_fields8))))))))
...
;; H
  ...
  (fp.lt (to_rep3
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content10 this__split_fields8))))) disttoclosestobstacle1))
...
;; H
  (assert (<= 1 (let ((subject i1)) i4)))

;; H
  (assert (<= (let ((subject i1)) i4) 1000))
...
;; H
  ...
  (fp.lt (to_rep3
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (let ((subject this__split_fields)) this__split_fields10)))))
...
;; H
  ...
  (and
  (and
  (and (=> (<= 1 1000) (dynamic_property1 1 1000 (let ((subject i1)) i5)))
  (=>
  (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))
  ...
  (= (attr__constrained
     ...
     (us_split_fields9
     (rec__algorithm__controller__robot
     (let ((subject this__split_fields)) this__split_fields10))))) false)
  (= 1000 (to_rep11
          (rec__algorithm__gap_vectors__list__capacity
          (us_split_discrs5
          (rec__algorithm__controller__gapvec
  ...
  (= (rec__algorithm__controller__laserscan
     (let ((subject this__split_fields)) this__split_fields10)) (rec__algorithm__controller__laserscan
                                                                ...
                                                                this__split_fields8)))
  (= (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields10)) (rec__algorithm__controller__gapvec
                                                                (us_split_fields__content10
                                                                this__split_fields8))))
  (= (rec__algorithm__controller__obsavoiddelta
     (let ((subject this__split_fields)) this__split_fields10)) (rec__algorithm__controller__obsavoiddelta
                                                                (us_split_fields__content10
                                                                this__split_fields8))))
  (= (rec__algorithm__controller__driveangle
     (let ((subject this__split_fields)) this__split_fields10)) (rec__algorithm__controller__driveangle
                                                                (us_split_fields__content10
                                                                this__split_fields8)))))
  (and (<= 1 (let ((subject i1)) i5)) (<= (let ((subject i1)) i5) 1000))))
...
;; H
  ...
  (fp.leq (to_rep4
          ...
          (select (rec__algorithm__controller__laserscan
                  (let ((subject this__split_fields)) this__split_fields10))
          (let ((subject i1)) i5))))) (to_rep3
                                      (rec__robot_iface__proxy__robot_radius
                                      (us_split_fields9
                                      (rec__algorithm__controller__robot
                                      (let ((subject this__split_fields))
                                      this__split_fields10))))))))
...
;; H
  (assert (= this__split_fields12 this__split_fields10))
...
;; H
  ...
  (fp.lt (to_rep3
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content10 this__split_fields11))))) (to_rep4
                                                               (rec__algorithm__laser_scan_data__first
                                                               (us_split_fields19
                                                               (select
                                                               (rec__algorithm__controller__laserscan
