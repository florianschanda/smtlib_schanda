...
;; H
  (assert (fp.leq abstr2 (fp #b0 #b10000010 #b11000000000000000000000)))

;; H
  (assert (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) abstr2))

(declare-fun abstr3 () Float32)

;; H
  (assert
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) abstr3)
  (fp.leq abstr3 (fp #b0 #b10000010 #b11000000000000000000000))))
...
;; WP_parameter_def
 ;; File "sgs.ads", line 3, characters 0-0
  (not (fp.leq r21 (fp #b0 #b10000010 #b11000000000000000000000))))
(check-sat)
(exit)
