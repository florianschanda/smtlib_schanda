...
(declare-fun o9 () battery_level_type)
...
;; H
  (assert (and (= o6 counter1) (in_range2 counter1)))

;; H
  (assert (= temp___290 (bvsub current_time1 o6)))
...
;; H
  (assert (=> (= result5 true) (= o8 (bvadd temp___290 ((_ int2bv 8) 50)))))

;; H
  (assert (=> (not (= result5 true)) (= o8 temp___290)))
...
;; WP_parameter_def
 ;; File "failsafe.adb", line 31, characters 0-0
  (not (in_range2 (bvsub counter1 ((_ int2bv 8) 1)))))
(check-sat)
