...
;; H
  (assert (=> abstr (= region_checks__in_unit_square__result16 0)))

(declare-fun abstr1 () Bool)

;; H
  (assert (=> abstr1 (= region_checks__in_unit_square__result16 (- 1))))

(declare-fun abstr2 () Bool)

;; H
  (assert (=> abstr2 (= region_checks__in_unit_square__result16 0)))

(declare-fun abstr3 () Bool)

;; H
  (assert (=> abstr3 (= region_checks__in_unit_square__result16 (- 1))))
...
(declare-fun abstr14 () Bool)

;; H
  (assert (not abstr14))

(declare-fun abstr15 () Bool)

;; H
  (assert (not abstr15))

(declare-fun abstr16 () Bool)

;; H
  (assert (not abstr16))

(declare-fun abstr17 () Bool)
