...
(declare-fun temp___280 () positive)

(declare-fun temp___2801 () natural)

(declare-fun temp___2802 () positive)

(declare-fun temp___2803 () positive)

(declare-fun temp___2804 () (Array Int element_type))

(declare-fun temp___2805 () t)
...
(declare-fun temp___2841 () natural)

(declare-fun temp___2842 () positive)

(declare-fun temp___2843 () positive)

(declare-fun temp___2844 () (Array Int element_type))

(declare-fun temp___2845 () t)
...
;; H
  ...
  (= o (+ (mod1 (to_rep1 queue__split_fields2)
          (to_rep1
          (rec__bounded_queue_v2__queue_type__max_size queue__split_discrs))) 1))
  (in_range
...
;; H
  (assert (= queue__split_discrs (mk___split_discrs temp___280)))

;; H
  (assert (= temp___2801 o3))

;; H
  (assert (= temp___2802 o4))

;; H
  (assert (= temp___2803 o5))

;; H
  (assert (= temp___2804 o6))

;; H
  (assert (= temp___2805 o7))
...
;; H
  (assert
  (= queue__split_fields5 (mk___split_fields temp___2801 temp___2802
                          temp___2803 (mk___t temp___2804 temp___2805))))
...
;; H
  ...
  (<= (to_rep3
      (first
      (rt (rec__bounded_queue_v2__queue_type__items queue__split_fields5))))
  (to_rep1 (rec__bounded_queue_v2__queue_type__rear queue__split_fields5)))
  (<= (to_rep1
      (rec__bounded_queue_v2__queue_type__rear queue__split_fields5))
  (to_rep3
  (last (rt (rec__bounded_queue_v2__queue_type__items queue__split_fields5)))))))
...
;; H
  (assert
  (= (rec__bounded_queue_v2__queue_type__count queue__split_fields5)
  o13))

;; H
  (assert
  (= (rec__bounded_queue_v2__queue_type__front queue__split_fields5)
  o14))

;; H
  (assert
  (= (rec__bounded_queue_v2__queue_type__rear queue__split_fields5) o15))
...
;; H
  (assert (= queue__split_discrs (mk___split_discrs temp___284)))

;; H
  (assert (= temp___2841 o13))

;; H
  (assert (= temp___2842 o14))

;; H
  (assert (= temp___2843 o15))

;; H
  (assert (= temp___2844 o16))

;; H
  (assert (= temp___2845 o17))
...
;; H
  (assert
  (= queue__split_fields6 (mk___split_fields temp___2841 temp___2842
                          temp___2843 (mk___t temp___2844 temp___2845))))
...
;; WP_parameter_def
 ;; File "bounded_queue_v2.ads", line 23, characters 0-0
  (not (in_range
  (+ (to_rep (rec__bounded_queue_v2__queue_type__count queue__split_fields6)) 1))))
(check-sat)
(exit)
