...
;; H
  (assert (=> (and (<= 0 i3) (<= i3 r10b)) (= temp___277 min1)))

;; H
  (assert (=> (and (<= 0 i3) (<= i3 r10b)) (= temp___276 i3)))
...
;; H
  (assert (=> (and (<= 0 i3) (<= i3 r10b)) (= i4 r10b)))

;; H
  (assert (=> (and (<= 0 i3) (<= i3 r10b)) (= i6 i4)))

;; H
  (assert (=> (and (<= 0 i3) (<= i3 r10b)) (= min4 min3)))

;; H
  (assert (=> (and (<= 0 i3) (<= i3 r10b)) (= i7 i6)))

;; H
  (assert (=> (and (<= 0 i3) (<= i3 r10b)) (= min5 min4)))

;; H
  (assert (=> (not (and (<= 0 i3) (<= i3 r10b))) (= i7 i3)))

;; H
  (assert (=> (not (and (<= 0 i3) (<= i3 r10b))) (= min5 min1)))

;; H
  (assert
  (= step_function__minimum_until_point__result2 step_function__minimum_until_point__result1))

;; H
  (assert
  (= step_function__minimum_until_point__result3 step_function__minimum_until_point__result2))
