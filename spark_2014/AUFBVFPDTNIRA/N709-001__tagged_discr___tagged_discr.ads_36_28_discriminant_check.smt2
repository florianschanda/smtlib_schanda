...
;; H
  (assert
  (= (to_int2 (rec__tagged_discr__t__z1 (us_split_fields3 v))) (to_int2
                                                               (of_int1 0))))

;; H
  (assert
  (=>
  (not (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs2 v))) 0))
  (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs2 v))) 2)))

(assert
;; WP_parameter_def
 ;; File "tagged_discr.ads", line 33, characters 0-0
  (not (tagged_discr__t__x__pred1 v)))
(check-sat)
