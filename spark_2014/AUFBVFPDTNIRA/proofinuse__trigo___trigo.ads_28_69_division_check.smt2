...
;; H
  ...
  (= o3 (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE 
  x x) x) x) x) x) x) x) x)))))

;; H
  (assert
  (= o4 (fp.mul RNE (fp #b0 #b10000100 #b11110000000000000000000) o3)))
...
;; H
  (assert
  (= o6 (fp.div RNE o5 (fp #b0 #b10001010 #b01100010011000000000000))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (not
  (fp.eq (fp #b0 #b10000111 #b00111011000000000000000) ((_ to_fp 8 24) #x00000000)))))
(check-sat)
