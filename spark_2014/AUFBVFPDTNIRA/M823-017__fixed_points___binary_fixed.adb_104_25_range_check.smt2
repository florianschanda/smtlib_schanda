...
;; to_int_def
  ...
  (forall ((x Int))
  (! (ite (= x 0) (= (to_int3 x) 0)
     (ite (< 0 x) (pos_div_relation (to_int3 x) x 256) (pos_div_relation
...
;; to_int_def
  ...
  (forall ((x Int))
  (! (ite (= x 0) (= (to_int4 x) 0)
     (ite (< 0 x) (pos_div_relation1 (to_int4 x) x 256) (pos_div_relation1
...
;; WP_parameter_def
 ;; File "binary_fixed.adb", line 57, characters 0-0
  (not (in_range3 (of_float32 (fp.sub RNE (fp.add RNE z31 z31) z31)))))
(check-sat)
(exit)
