...
;; classwide__t__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (d_is_zero v)) (to_int1 (d_is_zero1 us_tag v))) :pattern (
  (d_is_zero1 us_tag v)) )))

;; classwide__u1__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (d_is_zero__2 v)) (to_int1 (d_is_zero1 us_tag1 v))) :pattern (
  (d_is_zero1 us_tag1 v)) )))

;; classwide__u2__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (d_is_zero v)) (to_int1 (d_is_zero1 us_tag2 v))) :pattern (
...
;; classwide__u1__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (d_is_zero__2 v)) (to_int1 (d_is_zero__21 us_tag1 v))) :pattern (
