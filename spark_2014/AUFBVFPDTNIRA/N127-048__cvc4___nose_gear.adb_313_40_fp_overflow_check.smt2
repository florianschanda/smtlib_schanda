...
;; H
  ...
  to_int32_left_1_out11)) (in_range1
...
;; H
  ...
  (let ((subject to_int32_left_2_out1)) to_int32_left_2_out11))) (in_range1
...
;; H
  ...
  (let ((subject to_int32_right_2_out1)) to_int32_right_2_out11))) (in_range1
...
;; H
  ...
  (ite (fp.leq ((_ to_fp 11 53) RNE (to_real (let ((subject sum_out1))
                                             sum_out11))) (fp #b0 #b10000001010 #b0111011100000000000000000000000000000000000000000000))
  true false)))

;; H
  (assert
  (and (= o7 (- max_uint16_out11 (let ((subject sum1_out1)) sum1_out11)))
  (in_range1 (- max_uint16_out11 (let ((subject sum1_out1)) sum1_out11)))))
...
;; H
  (assert
  (= estimatedgroundvelocityisavailable1 (let ((subject relational_operator_out1))
                                         relational_operator_out11)))
...
;; H
  ...
  (ite (= (to_int5
          ...
          relational_operator_out11)) (to_int5
