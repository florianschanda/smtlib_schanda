...
;; H
  (assert
  (and
  (= o17 (fp.div RNE ((_ to_fp_unsigned 11 53) RNA (let ((subject to_uint16_result_1_out1))
...
;; WP_parameter_def
 ;; File "nose_gear.adb", line 24, characters 0-0
  (not
  (not (or (fp.isInfinite (fp.div RNE (let ((subject distance_km_out1))
                                      distance_km_out11) (let ((subject 
                                                         avoid_div_by_zero_out1))
                                                         avoid_div_by_zero_out11))) (fp.isNaN (fp.div RNE 
  (let ((subject distance_km_out1)) distance_km_out11) (let ((subject 
                                                       avoid_div_by_zero_out1))
