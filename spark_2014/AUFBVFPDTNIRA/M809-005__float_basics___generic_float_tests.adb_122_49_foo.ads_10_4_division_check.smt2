...
;; H
  (assert (not (fp.eq b (fp #b0 #b00000000 #b00000000000000000000000))))
...
;; H
  ...
  b)) (fp.isNaN (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) 
  b))))))
...
;; WP_parameter_def
 ;; File "generic_float_tests.ads", line 2, characters 0-0
  (not (not (fp.eq b ((_ to_fp 8 24) #x00000000)))))
(check-sat)
