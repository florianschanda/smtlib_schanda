...
(define-fun dynamic_invariant2 ((temp___expr_1005 us_rep1)
  (temp___is_init_1002 Bool) (temp___skip_constant_1003 Bool)
  (temp___do_toplevel_1004 Bool)) Bool (and
                                       (=>
                                       (not
                                       ...
                                       (first3
                                       (rec__aco__math__very_longs__very_long__long_digits1
                                       (us_split_fields3 temp___expr_1005)))
                                       (last5
                                       (rec__aco__math__very_longs__very_long__long_digits1
                                       (us_split_fields3 temp___expr_1005))))
                                       (and
                                       (= (first3
                                          (rec__aco__math__very_longs__very_long__long_digits1
                                          (us_split_fields3 temp___expr_1005))) 1)
                                       (= (last5
                                          (rec__aco__math__very_longs__very_long__long_digits1
                                          (us_split_fields3 temp___expr_1005))) 
                                       (to_rep
...
(define-fun default_initial_assumption ((temp___expr_1008 us_rep1)
  (temp___skip_top_level_1009 Bool)) Bool (= (to_rep
                                             (rec__aco__math__very_longs__very_long__octet_length
                                             (us_split_discrs2
                                             temp___expr_1008))) (to_rep
                                                                 (rec__aco__math__very_longs__very_long__octet_length
                                                                 (us_split_discrs1
                                                                 l)))))
...
(declare-fun aco__math__very_longs__subtract_fp__result () digit_index_type)

(declare-fun aco__math__very_longs__subtract_fp__result1 () (Array Int octet))

(declare-fun aco__math__very_longs__subtract_fp__result2 () t)
...
(declare-fun o3 () digit_index_type)

(declare-fun o4 () (Array Int octet))

(declare-fun o5 () t)

(declare-fun temp___1363 () digit_index_type)

(declare-fun temp___13631 () (Array Int octet))

(declare-fun temp___13632 () t1)
...
(declare-fun result2 () very_long__ref)

(declare-fun aco__math__very_longs__subtract_fp__result3 () us_rep)

(declare-fun aco__math__very_longs__subtract_fp__result4 () very_long__ref)

(declare-fun aco__math__very_longs__subtract_fp__result5 () us_rep)

(declare-fun result____split_fields4 () us_split_fields__ref1)

(declare-fun borrow1 () t__ref)

(declare-fun aco__math__very_longs__subtract_fp__result6 () very_long__ref)

(declare-fun result____split_fields5 () us_split_fields2)

(declare-fun borrow2 () (_ BitVec 16))

(declare-fun aco__math__very_longs__subtract_fp__result7 () us_rep)
...
(declare-fun result3 () digit_index_type)
...
;; H
  (assert
  (=> (= borrow ((_ int2bv 16) 1))
  (= (mk___rep1 (mk___split_discrs temp___1363)
     (mk___split_fields1 (mk___t1 temp___13631 temp___13632))) (of_base o6))))
...
;; H
  ...
  (= result____split_fields3 (mk___split_fields1
                             (mk___t1 temp___13631 temp___13632)))))

;; H
  (assert
  (=> (= borrow ((_ int2bv 16) 1))
  (= result____split_discrs (mk___split_discrs temp___1363))))
