...
;; H
  (assert (and (= o13 (+ k1 2)) (in_range1 (+ k1 2))))

;; H
  (assert (= result7 (ite (< n o13) true false)))
...
;; H
  (assert
  (=> (not (= result7 true))
  (and (= temp___660 (+ k1 2)) (in_range1 (+ k1 2)))))

;; H
  (assert
  (=> (not (= result7 true)) (and (<= 1 temp___660) (<= temp___660 80))))

;; H
  (assert (=> (not (= result7 true)) (= o9 temp___660)))

;; H
  (assert (=> (not (= result7 true)) (= o10 (select buf3 o9))))

;; H
  (assert (=> (not (= result7 true)) (= o11 (to_rep o10))))

;; H
  (assert (=> (not (= result7 true)) (= o12 (ite (= o11 0) true false))))

;; H
  (assert
  (=> (not (= result7 true)) (= result6 (ite (not (= o12 true)) true false))))

;; H
  (assert (=> (= result6 true) (= (to_rep (select buf3 k1)) 0)))

;; H
  (assert (=> (= result6 true) (and (= o14 (- k1 1)) (in_range4 (- k1 1)))))

;; H
  (assert (=> (= result6 true) (= k1 result8)))

;; H
  (assert (=> (= result6 true) (= k2 o14)))

;; H
  (assert (=> (not (= result6 true)) (= k2 k1)))

;; H
  (assert (and (= o15 (+ last2 1)) (in_range1 (+ last2 1))))
