...
(declare-fun old_overflow4 () (_ BitVec 8))

(declare-fun new_overflow4 () (_ BitVec 8))
...
;; H
  (assert (=> (< (- 8 distance) 8) (= o (bvshl abstr7 abstr8))))

;; H
  (assert (=> (not (< (- 8 distance) 8)) (= o abstr6)))
...
;; H
  (assert
  (and (= o4 abstr10)
  (= o4 (bvudiv o3 (ite (< (- 8 distance) 256) (bvshl abstr9 abstr8) abstr6)))))

;; H
  (assert (= new_overflow3 o4))

;; H
  (assert (=> (< distance 8) (= o5 i2)))

(declare-fun abstr11 () (_ BitVec 8))

;; H
  (assert (=> (< distance 8) (= o7 (bvshl o6 abstr11))))

;; H
  (assert (=> (not (< distance 8)) (= o7 abstr6)))
...
;; H
  (assert (= o11 (bvor o10 old_overflow2)))
