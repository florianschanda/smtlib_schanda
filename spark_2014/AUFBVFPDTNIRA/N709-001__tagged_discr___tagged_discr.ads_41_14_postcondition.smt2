...
;; H
  (assert
  (= 0 (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs1 r7b)))))
...
;; H
  (assert (= temp___2421 v__split_fields))

;; H
  (assert (= temp___2422 v__split_fields1))

;; H
  (assert (= temp___2423 v__split_fields2))

;; H
  (assert (= temp___2424 v__split_fields3))

;; H
  (assert (= temp___2425 v__split_fields4))

;; H
  (assert (= v__split_fields5 v__split_fields))

;; H
  (assert (= v__split_fields6 v__split_fields1))

;; H
  (assert (= v__split_fields7 v__split_fields2))

;; H
  (assert (= v__split_fields8 v__split_fields3))

;; H
  (assert (= v__split_fields9 v__split_fields4))
...
;; WP_parameter_def
 ;; File "tagged_discr.ads", line 33, characters 0-0
  ...
  (= (is_zero__2
     ...
     v__split_fields8 v__split_fields9) v__attr__tag)) true)))
(check-sat)
(exit)
