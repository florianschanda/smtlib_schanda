...
;; tagged_discr__u2__compat_axiom
  (assert
  (forall ((v us_rep1))
  (! (= (to_int1 (is_zero__3 v)) (to_int1 (is_zero__31 us_tag1 v))) :pattern (
...
;; tagged_discr__u1__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (is_zero__2 (of_base1 v))) (to_int1 (is_zero1 us_tag4 v))) :pattern (
  (is_zero1 us_tag4 v)) )))

;; tagged_discr__u2__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (is_zero__3 (of_base v))) (to_int1 (is_zero1 us_tag1 v))) :pattern (
  (is_zero1 us_tag1 v)) )))

;; tagged_discr__init__T3b__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (is_zero v)) (to_int1 (is_zero1 us_tag5 v))) :pattern (
  (is_zero1 us_tag5 v)) )))
...
;; tagged_discr__init__2__T8b__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (is_zero__2 (of_base1 v))) (to_int1 (is_zero1 us_tag7 v))) :pattern (
  (is_zero1 us_tag7 v)) )))
...
;; tagged_discr__u1__compat_axiom
  (assert
  (forall ((v us_rep2))
  (! (= (to_int1 (is_zero__2 v)) (to_int1 (is_zero__21 us_tag4 v))) :pattern (
  (is_zero__21 us_tag4 v)) )))

;; tagged_discr__init__2__T8b__compat_axiom
  (assert
  (forall ((v us_rep2))
  (! (= (to_int1 (is_zero__2 v)) (to_int1 (is_zero__21 us_tag7 v))) :pattern (
