...
;; dummy__def_axiom
  (assert
  (= dummy7 (let ((temp___160 (t__dummy__aggregate_def
                              (mk___rep
                              (mk___split_fields (of_rep 0) (distinct 1 0)
                              (of_rep1
                              (fp #b0 #b01111111 #b00000000000000000000000))))
                              0 (div1 value__size 8))))
            (of_array (to_array1 temp___160) (first3 temp___160)
            (last3 temp___160)))))
...
;; def_axiom
  ...
  (let ((temp___155 (t__dummy__aggregate_def temp___156 temp___157
                    temp___158)))
  (and
  (=> (dynamic_property4 (- 2147483648) 2147483647 temp___157 temp___158)
  (and (= (first3 temp___155) temp___157) (= (last3 temp___155) temp___158)))
  (forall ((temp___159 Int))
  (= (select (to_array1 temp___155) temp___159) temp___156)))))))
