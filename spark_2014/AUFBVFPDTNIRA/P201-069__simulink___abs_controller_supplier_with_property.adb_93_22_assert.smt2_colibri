...
;; H
  (assert
  (=> (bvugt vehicle_speed abstr7) (and (= o abstr6) (in_range3 abstr6))))

(declare-fun abstr8 () Int)

;; H
  (assert
  (=> (bvugt vehicle_speed abstr7) (and (= o1 abstr8) (in_range3 abstr8))))

;; H
  (assert (=> (bvugt vehicle_speed abstr7) (= o2 (- o1 o))))

;; H
  (assert (=> (bvugt vehicle_speed abstr7) (and (= o3 o2) (in_range2 o2))))

;; H
  (assert (=> (bvugt vehicle_speed abstr7) (= sum_out12 o3)))

(declare-fun abstr9 () Int)

;; H
  (assert
  (=> (bvugt vehicle_speed abstr7) (and (= o4 abstr9) (in_range1 o4))))

(declare-fun abstr10 () Int)

;; H
  (assert
  (=> (bvugt vehicle_speed abstr7) (and (= o5 abstr10) (in_range1 o5))))

;; H
  (assert (=> (bvugt vehicle_speed abstr7) (= o6 (- o5 o4))))

;; H
  (assert (=> (bvugt vehicle_speed abstr7) (and (= o7 o6) (in_range o6))))

;; H
  (assert (=> (bvugt vehicle_speed abstr7) (= sum_1_out1_sat2 o7)))

;; H
  (assert
  (=> (bvugt vehicle_speed abstr7)
...
;; H
  (assert (=> (bvugt vehicle_speed abstr7) (= result5 at_rest_switch_out1)))

;; H
  (assert
  (=> (bvugt vehicle_speed abstr7) (= at_rest_switch_out11 sum_1_out12)))

;; H
  (assert
  (=> (not (bvugt vehicle_speed abstr7)) (= result6 at_rest_switch_out1)))

;; H
  (assert (=> (not (bvugt vehicle_speed abstr7)) (= at_rest_switch_out12 1)))

;; H
  (assert
  (=> (not (bvugt vehicle_speed abstr7)) (= sum_1_out1_sat2 sum_1_out1_sat)))

;; H
  (assert
  (=> (not (bvugt vehicle_speed abstr7))
  (= at_rest_switch_out11 at_rest_switch_out12)))

;; H
  (assert (=> (not (bvugt vehicle_speed abstr7)) (= sum_1_out12 sum_1_out1)))

;; H
  (assert (=> (not (bvugt vehicle_speed abstr7)) (= sum_out12 sum_out1)))

;; H
  (assert
  (=> (not (bvugt vehicle_speed abstr7)) (= sum_1_out1_sat2 sum_1_out1_sat1)))
...
;; H
  (assert
  (=> (not (bvugt vehicle_speed abstr7)) (= sum_1_out12 sum_1_out11)))

;; H
  (assert (=> (not (bvugt vehicle_speed abstr7)) (= sum_out12 sum_out11)))

(assert
;; WP_parameter_def
 ;; File "abs_controller_supplier_with_property.ads", line 22, characters 0-0
  (not (or (not (= vehicle_speed abstr7)) (= at_rest_switch_out11 1))))
(check-sat)
(exit)
