...
(declare-fun temp___988 () us_rep7)
...
;; H
  (assert (= usq_ temp___986))

;; H
  (assert
  (= temp___988 (mk___rep7 (us_split_discrs3 usq_) (us_split_fields15 usq_)
