...
;; H
  (assert
  (= foo__float_tests__underflow_1__result foo__float_tests__underflow_1__result1))

;; H
  (assert (= o (fp.div RNE a b)))

;; H
  (assert (= foo__float_tests__underflow_1__result o))
...
;; H
  (assert
  (= (mk_t__ref foo__float_tests__underflow_1__result2) (mk_t__ref
                                                        foo__float_tests__underflow_1__result1)))

(assert
;; WP_parameter_def
 ;; File "generic_float_tests.ads", line 2, characters 0-0
  (not
  (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) foo__float_tests__underflow_1__result2)))
(check-sat)
(exit)
