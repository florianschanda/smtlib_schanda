...
(declare-fun state () Float64)

(declare-fun o () Float64)

(declare-fun result () Float64)

(declare-fun state1 () Float64)

(declare-fun state2 () Float64)

(declare-fun state3 () Float64)
...
(assert
;; WP_parameter_def
 ;; File "wibble.adb", line 15, characters 0-0
  (not
  (fp.leq state2 (fp.mul RNE ((_ to_fp_unsigned 11 53) RNE (bvadd x ((_ int2bv 32) 1))) (fp #b0 #b10000000010 #b0110000000000000000000000000000000000000000000000000)))))
(check-sat)
(exit)
