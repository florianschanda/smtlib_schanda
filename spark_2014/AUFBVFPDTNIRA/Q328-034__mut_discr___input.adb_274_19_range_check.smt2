...
(declare-fun v () (Array Int character))
...
(declare-fun temp___6281 () t2)

(declare-fun temp___629 () (Array Int character))

(declare-fun temp___6291 () t2)
...
(declare-fun temp___630 () (Array Int character))

(declare-fun temp___6301 () t)

(declare-fun temp___631 () (Array Int character))

(declare-fun temp___6311 () t)
...
(declare-fun v1 () (Array Int character))
...
;; H
  ...
  (= o18 (+ (- (to_rep1 v__last) (to_rep1 v__first)) 1))))
...
;; H
  (assert
  (= (to_rep1 (last4 temp___6281)) (- (ite (<= (to_rep1 v__first) (to_rep1
                                                                  v__last))
                                      (+ (- (to_rep1 v__last) (to_rep1
                                                              v__first)) 1)
                                      0) (ite (<= (to_rep1 s__first)
                                         (to_rep1 s__last))
...
;; H
  (assert
  (=> (<= (to_rep1 s__first) (to_rep1 s__last))
  (= o20 (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1))))
...
;; H
  (assert
  (=> (= result9 true)
  (= (mk (to_rep1 (first4 temp___6291)) (to_rep1 (last4 temp___6291)))
  temp___6301)))

;; H
  (assert
  (=> (not (= result9 true))
  (=> (<= (to_rep1 (first4 temp___6291)) (to_rep1 (last4 temp___6291)))
  (= o21 (+ (- (to_rep1 (last4 temp___6291)) (to_rep1 (first4 temp___6291))) 1)))))

;; H
  (assert
  (=> (not (= result9 true))
  (=> (not (<= (to_rep1 (first4 temp___6291)) (to_rep1 (last4 temp___6291))))
  (= o21 0))))
...
;; H
  ...
  (=> (not (= result9 true))
  (=> (<= (to_rep1 s__first) (to_rep1 s__last))
  (= o22 (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1)))))

;; H
  (assert
  (=> (not (= result9 true))
  (=> (not (<= (to_rep1 s__first) (to_rep1 s__last))) (= o22 0))))
...
;; H
  (assert
  (=> (not (= result9 true))
  (= (concat1 (map__content s6) (to_rep1 s__first) (to_rep1 s__last)
     temp___629 (to_rep1 (first4 temp___6291)) (to_rep1 (last4 temp___6291)))
  temp___630)))

;; H
  (assert
  (=> (not (= result9 true)) (= (mk (to_rep1 s__first) o28) temp___6301)))

;; H
  (assert
  (= (ite (<= (to_rep1 (first temp___6301)) (to_rep1 (last temp___6301)))
     (+ (- (to_rep1 (last temp___6301)) (to_rep1 (first temp___6301))) 1) 0)
  (ite (<= (to_rep1 v__first) (to_rep1 v__last))
  (+ (- (to_rep1 v__last) (to_rep1 v__first)) 1) 0)))

;; H
  (assert
  (= (mk___t temp___631 temp___6311) (mk___t temp___630 temp___6301)))

;; H
  (assert
  (= o29 (slide temp___631 (to_rep1 (first temp___6311)) (to_rep1 v__first))))
...
;; H
  (assert
  (=> (<= (to_rep1 s__first) (to_rep1 s__last))
  (= o30 (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1))))
