...
(define-fun dynamic_invariant3 ((temp___expr_214 us_t1)
...
(declare-const o3 (Array Int float))
...
;; H
  (assert (dynamic_invariant arr true false true))

;; H
  (assert (<= (+ (to_rep1 (first (rt arr))) 1) i))
