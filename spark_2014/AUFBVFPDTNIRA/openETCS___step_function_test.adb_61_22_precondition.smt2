...
;; H
  (assert
  (and
  (and (= o108 (get_value (mk___rep1 sfun4__split_fields2) i2))
  (get_value__function_guard o108 (mk___rep1 sfun4__split_fields2) i2))
...
;; H
  (assert
  (and
  (and (= o107 (get_value (mk___rep1 sfun3__split_fields2) i2))
  (get_value__function_guard o107 (mk___rep1 sfun3__split_fields2) i2))
...
;; H
  (assert
  (and (and (= o109 (min o107 o108)) (min__function_guard o109 o107 o108))
