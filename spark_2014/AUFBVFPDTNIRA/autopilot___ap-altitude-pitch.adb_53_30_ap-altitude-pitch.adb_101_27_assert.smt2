...
(declare-fun floor_climb_rate2 () Int)

(declare-fun result7 () Int)

(declare-fun floor_climb_rate3 () Int)
...
;; H
  (assert (=> (< 1000 c13b) (= result5 floor_climb_rate)))

;; H
  (assert (=> (< 1000 c13b) (= floor_climb_rate1 1000)))

;; H
  (assert
  (=> (not (< 1000 c13b))
  (=> (< c13b (- 1000)) (= result6 floor_climb_rate))))

;; H
  (assert
  (=> (not (< 1000 c13b))
  (=> (< c13b (- 1000)) (= floor_climb_rate2 (- 1000)))))

;; H
  (assert
  (=> (not (< 1000 c13b))
  (=> (not (< c13b (- 1000))) (and (= o1 c13b) (in_range8 c13b)))))

;; H
  (assert
  (=> (not (< 1000 c13b))
  (=> (not (< c13b (- 1000))) (= result7 floor_climb_rate))))

;; H
  (assert
  (=> (not (< 1000 c13b))
  (=> (not (< c13b (- 1000))) (= floor_climb_rate3 o1))))

;; H
  (assert
  (=> (not (< 1000 c13b))
  (=> (not (< c13b (- 1000))) (= floor_climb_rate2 floor_climb_rate3))))

;; H
  (assert (=> (not (< 1000 c13b)) (= floor_climb_rate1 floor_climb_rate2)))
