...
(declare-fun o24 () float)

(declare-fun o25 () float)

(declare-fun o26 () float)

(declare-fun o27 () float)

(declare-fun o28 () float)

(declare-fun o29 () float)

(declare-fun o30 () float)

(declare-fun o31 () float)
...
(declare-fun o36 () float)

(declare-fun o37 () float)

(declare-fun o38 () float)

(declare-fun o39 () (Array Int us_rep))

(declare-fun o40 () float)

(declare-fun o41 () float)

(declare-fun o42 () float)
...
(declare-fun tl4 () (Array Int us_rep1))
...
;; H
  ...
  (= o1 (fp.add RNE (to_rep
                    ...
                    (us_split_fields1
                    (select (rec__untangle_tests__triangle__vertices
                            (us_split_fields3 (select tl2 t2))) v2))))
...
;; H
  ...
  (= (rec__untangle_tests__coordinate__y
     (us_split_fields1
     (select (rec__untangle_tests__triangle__vertices
             (us_split_fields3 (select tl2 t2))) v2))) o4))
...
;; H
  ...
  (= (rec__untangle_tests__coordinate__z
     (us_split_fields1
     (select (rec__untangle_tests__triangle__vertices
             (us_split_fields3 (select tl2 t2))) v2))) o5))
...
;; H
  ...
  (= (rec__untangle_tests__coordinate__w
     (us_split_fields1
     (select (rec__untangle_tests__triangle__vertices
             (us_split_fields3 (select tl2 t2))) v2))) o6))
...
;; H
  ...
  (= o11 (store (rec__untangle_tests__triangle__vertices
                (us_split_fields3 (select tl2 t2))) v2 (mk___rep
                                                       (mk___split_fields
                                                       o7 o8 o9 o10)))))
...
;; H
  ...
  (= o23 (fp.add RNE (to_rep
                     ...
                     (us_split_fields1
                     (select (rec__untangle_tests__triangle__vertices
                             (us_split_fields3 (select tl3 t2))) v2))))
  ...
  (us_split_fields1
  (select (rec__untangle_tests__triangle__vertices
          (us_split_fields3 (select tl3 t2))) v2)))) (to_rep
                                                     (rec__untangle_tests__coordinate__y
                                                     (us_split_fields1 o)))))))))
...
;; H
  ...
  (= (rec__untangle_tests__coordinate__x
     (us_split_fields1
     (select (rec__untangle_tests__triangle__vertices
             (us_split_fields3 (select tl3 t2))) v2))) o25))
...
;; H
  ...
  (= (rec__untangle_tests__coordinate__z
     (us_split_fields1
     (select (rec__untangle_tests__triangle__vertices
             (us_split_fields3 (select tl3 t2))) v2))) o27))
...
;; H
  ...
  (= (rec__untangle_tests__coordinate__w
     (us_split_fields1
     (select (rec__untangle_tests__triangle__vertices
             (us_split_fields3 (select tl3 t2))) v2))) o28))
...
;; H
  ...
  (= o33 (store (rec__untangle_tests__triangle__vertices
                (us_split_fields3 (select tl3 t2))) v2 (mk___rep
                                                       (mk___split_fields
                                                       o29 o30 o31 o32)))))
...
;; H
  (assert
  (= (rec__untangle_tests__triangle__normal
     (us_split_fields3 (select tl3 t2))) (mk___rep
 ...
 ;; File "untangle_tests.adb", line 44, characters 0-0
  ...
  (not (or (fp.isInfinite (fp.add RNE (to_rep
                                      ...
                                      (select (rec__untangle_tests__triangle__vertices
                                              (us_split_fields3
                                              (select tl4 t2))) v2))))
  (to_rep (rec__untangle_tests__coordinate__z (us_split_fields1 o))))) (fp.isNaN (fp.add RNE
  (to_rep
  (rec__untangle_tests__coordinate__z
  (us_split_fields1
  (select (rec__untangle_tests__triangle__vertices
          (us_split_fields3 (select tl4 t2))) v2)))) (to_rep
                                                     (rec__untangle_tests__coordinate__z
                                                     (us_split_fields1 o)))))))))
(check-sat)
(exit)
