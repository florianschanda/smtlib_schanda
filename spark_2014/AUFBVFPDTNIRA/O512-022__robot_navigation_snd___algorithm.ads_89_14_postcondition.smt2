...
(define-fun dynamic_invariant6 ((temp___expr_149 Float32)
  ...
  (temp___do_toplevel_148 Bool)) Bool (=>
                                      ...
                                      (in_range1 temp___expr_149)))

(define-fun dynamic_invariant7 ((temp___expr_155 Float32)
...
(define-fun dynamic_invariant8 ((temp___expr_167 Float32)
...
(define-fun dynamic_invariant9 ((temp___expr_179 Float32)
