...
;; H
  (assert
  (=> (and (<= 0 index1) (<= index1 100000)) (= result__10 result__8)))

;; H
  (assert
  (=> (not (and (<= 0 index1) (<= index1 100000))) (= index1 index8)))

;; H
  (assert
  (=> (not (and (<= 0 index1) (<= index1 100000))) (= index9 index1)))

;; H
  (assert
  (=> (not (and (<= 0 index1) (<= index1 100000))) (= result__10 result__1)))
...
;; H
  (assert
  (= result4 test_prime_and_coprime_numbers__p__initialize_coprime_list__result))
...
;; H
  (assert
  (= result5 test_prime_and_coprime_numbers__p__initialize_coprime_list__result4))
