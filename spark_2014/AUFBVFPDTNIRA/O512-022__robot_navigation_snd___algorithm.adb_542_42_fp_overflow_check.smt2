...
;; H
  (assert
  (and (= o12 (create__2 (fp #b0 #b10000000 #b10010010000111111011011)))
  (create__2__function_guard o12
...
;; H
  ...
  (rec__algorithm__controller__driveangle (us_split_fields11 this)) o11))
