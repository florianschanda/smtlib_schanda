...
;; H
  ...
  (= o (ite (= event_log__split_fields3 true) 0
       (+ (bv2nat (let ((temp___276 (bvsub (to_rep2 event_log__split_fields2)
...
;; H
  ...
  (<= (bv2nat (to_rep2 (first8 temp___3131))) (bv2nat (to_rep2
                                                      (last8 temp___3131))))
  (= o5 (+ (- (bv2nat (to_rep2 (last8 temp___3131))) (bv2nat (to_rep2
                                                             (first8
                                                             temp___3131)))) 1)))))
...
;; H
  ...
  (<= (bv2nat (to_rep2 (first6 temp___3121))) (bv2nat (to_rep2
                                                      (last6 temp___3121))))
  (= o6 (+ (- (bv2nat (to_rep2 (last6 temp___3121))) (bv2nat (to_rep2
                                                             (first6
                                                             temp___3121)))) 1)))))
...
;; H
  (assert
  (=> (not (= (length3 (mk___t3 temp___312 temp___3121)) 0))
  (= o8 (+ (bv2nat (to_rep2 (first6 temp___3121))) o7))))
...
;; H
  (assert
  (=> (not (= (length3 (mk___t3 temp___312 temp___3121)) 0))
  (= (mk (to_rep2 (first6 temp___3121)) o11) temp___3141)))
