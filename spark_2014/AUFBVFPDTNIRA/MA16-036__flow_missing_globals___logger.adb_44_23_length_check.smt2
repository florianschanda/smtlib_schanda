...
(define-fun dynamic_invariant4 ((temp___expr_288 us_t1)
  (temp___is_init_284 Bool) (temp___skip_constant_285 Bool)
  (temp___do_toplevel_286 Bool)
  (temp___do_typ_inv_287 Bool)) Bool (=>
                                     (not (= temp___skip_constant_285 true))
                                     (and (dynamic_property2 #x0000 tmp
                                     (first3 temp___expr_288)
                                     (last3 temp___expr_288))
                                     (and (= (first3 temp___expr_288) #x0000)
                                     (= (last3 temp___expr_288) tmp)))))
...
;; H
  ...
  (<= (bv2nat (to_rep (first8 temp___3131))) (bv2nat (to_rep
                                                     (last8 temp___3131))))
  (= o5 (+ (- (bv2nat (to_rep (last8 temp___3131))) (bv2nat (to_rep
                                                            (first8
                                                            temp___3131)))) 1)))))
...
;; H
  ...
  (<= (bv2nat (to_rep (first6 temp___3121))) (bv2nat (to_rep
                                                     (last6 temp___3121))))
  (= o6 (+ (- (bv2nat (to_rep (last6 temp___3121))) (bv2nat (to_rep
                                                            (first6
                                                            temp___3121)))) 1)))))
...
;; H
  (assert
  (=> (not (= (length3 (mk___t3 temp___312 temp___3121)) 0))
  (= o8 (+ (bv2nat (to_rep (first6 temp___3121))) o7))))

;; H
  (assert
  (=> (not (= (length3 (mk___t3 temp___312 temp___3121)) 0)) (= o9 (- o8 1))))
...
;; H
  (assert
  (=> (not (= (length3 (mk___t3 temp___312 temp___3121)) 0))
  (= (mk (to_rep (first6 temp___3121)) o11) temp___3141)))
...
;; H
  (assert (= (mk1 #x0000 tmp) temp___3151))
