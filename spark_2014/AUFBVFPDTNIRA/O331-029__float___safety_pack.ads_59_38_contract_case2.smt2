...
;; H
  (assert
  (= safety_pack__lift_away_from_zero__result safety_pack__lift_away_from_zero__result1))

;; H
  (assert (= safety_pack__lift_away_from_zero__result res1))

;; H
  (assert
  (= (mk_t__ref safety_pack__lift_away_from_zero__result2) (mk_t__ref
                                                           safety_pack__lift_away_from_zero__result1)))
...
;; WP_parameter_def
 ;; File "imu_pack.ads", line 16, characters 0-0
  (not
  (fp.eq safety_pack__lift_away_from_zero__result2 (fp #b0 #b00000000 #b00000000000000000000000))))
(check-sat)
(exit)
