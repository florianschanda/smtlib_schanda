...
;; H
  ...
  (=> (= result2 true)
  (=> (= result3 true)
  (=> (= (of_int 0) true) (= o25 (us_split_fields7 o24))))))

;; H
  (assert
  (=> (= result2 true)
  (=> (= result3 true)
  (=> (= (of_int 0) true) (= o26 (rec__gaps__gap__bearing o25))))))
...
;; H
  (assert (=> (= (of_int 0) true) (= o51 (us_split_fields7 o50))))

;; H
  (assert (=> (= (of_int 0) true) (= o52 (rec__gaps__gap__bearing o51))))
