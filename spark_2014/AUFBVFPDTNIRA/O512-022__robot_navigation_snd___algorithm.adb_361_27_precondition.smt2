...
(define-fun o54 () us_rep4 (mk___rep3
                           (mk___split_fields3
                           (mk___rep (mk___split_fields o9)) o10 o11)))

(define-fun o55 () us_rep4 (mk___rep3
                           (mk___split_fields3
                           (mk___rep (mk___split_fields o1)) o2 o3)))

(define-fun temp___11121 () us_rep2 (mk___rep2
                                    (mk___split_fields2 temp___1112)))
...
;; H
  ...
  (= (bool_eq4 temp___11121 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
...
;; H
  ...
  (= result (mk___split_fields__ref2
            (mk___split_fields2 riterr__split_fields))))
...
;; H
  ...
  (= result1 (mk___split_fields__ref2
             (mk___split_fields2 riterl__split_fields))))
...
;; H
  (assert
  (ite (= (ite (= (bool_eq4 (mk___rep2 riterr__split_fields1) no_element) false) (=
          (get1
          (positions
          (rec__algorithm__controller__gapvec
          (us_split_fields__content7 this__split_fields)))
          (mk___rep2 riterr__split_fields1)) 1) true) true)
  (= (bool_eq4 (mk___rep2 riterr__split_fields2) no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
     (us_split_fields__content7 this__split_fields)))
     (mk___rep2 riterr__split_fields2)) true)
  (= (get1
     (positions
     (rec__algorithm__controller__gapvec
     (us_split_fields__content7 this__split_fields)))
     (mk___rep2 riterr__split_fields2)) (- (get1
                                           (positions
                                           (rec__algorithm__controller__gapvec
                                           (us_split_fields__content7
                                           this__split_fields)))
                                           (mk___rep2 riterr__split_fields1)) 1)))))

;; H
  (assert
  (=>
  (and (not (= (bool_eq4 (mk___rep2 riterl__split_fields1) no_element) true))
  (not (= (bool_eq4 (mk___rep2 riterr__split_fields2) no_element) true)))
  (and
  (= o (length1
       (rec__algorithm__controller__gapvec
       (us_split_fields__content7 this__split_fields))))
...
;; H
  (assert
  (=> (= result2 true)
  (= riterr__split_fields2 (mk___split_fields2 temp___1120))))
...
;; H
  (assert
  (=> (= result2 true)
  (= temp___1119 (mk___rep7 (us_split_fields__content7 this__split_fields)))))

;; H
  (assert
  (=> (= result2 true)
  (= riterl__split_fields1 (mk___split_fields2 temp___1118))))
...
;; H
  ...
  (= (has_key
     ...
     (mk___rep2 riterr__split_fields3)) true)
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields2)))
     (mk___rep2 riterl__split_fields2)) true))
  (= (bool_eq4 (mk___rep2 riterl__split_fields2)
     (next
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields2))
     (mk___rep2 riterr__split_fields3))) true))
...
;; H
  ...
  (= (rec__algorithm__controller__driveangle
     (let ((subject this__split_fields)) this__split_fields2)) (rec__algorithm__controller__driveangle
                                                               ...
                                                               temp___1119)))))
  (and
  (and (not (= (bool_eq4 (mk___rep2 riterl__split_fields2) no_element) true))
  (not (= (bool_eq4 (mk___rep2 riterr__split_fields3) no_element) true)))
  (< 1 (length1
       (rec__algorithm__controller__gapvec
       (let ((subject this__split_fields)) this__split_fields2))))))))
...
;; H
  ...
  (= o18 (element
         (rec__algorithm__controller__gapvec
         (let ((subject this__split_fields)) this__split_fields2))
         (mk___rep2 riterl__split_fields2)))
  (= (bool_eq6 o18
     (get
     (model__
     (rec__algorithm__controller__gapvec
...
;; H
  ...
  (= o15 (element
         (rec__algorithm__controller__gapvec
         (let ((subject this__split_fields)) this__split_fields2))
         (mk___rep2 riterr__split_fields3)))
  (= (bool_eq6 o15
     (get
     (model__
     (rec__algorithm__controller__gapvec
...
;; H
  (assert
  (=> (= result2 true)
  (=> (= result4 true) (= result3 (ite (= o8 (- 1)) true false)))))
...
;; H
  ...
  (= o23 (previous
         ...
         (let ((subject this__split_fields)) this__split_fields2))
         (mk___rep2 riterl__split_fields2)))
  (ite (= (ite (= (bool_eq4 (mk___rep2 riterl__split_fields2) no_element) false) (=
          (get1
          (positions
          (rec__algorithm__controller__gapvec
          (let ((subject this__split_fields)) this__split_fields2)))
          (mk___rep2 riterl__split_fields2)) 1) true) true)
  (= (bool_eq4 o23 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
  ...
  (rec__algorithm__controller__gapvec
  (let ((subject this__split_fields)) this__split_fields2)))
  (mk___rep2 riterl__split_fields2)) 1)))))))))
...
;; H
  ...
  (=> (= result2 true)
  (=> (= result3 true)
  (=> (= (distinct 0 0) true) (= o25 (us_split_fields7 o24))))))

;; H
  (assert
  (=> (= result2 true)
  (=> (= result3 true)
  (=> (= (distinct 0 0) true) (= o26 (rec__gaps__gap__bearing o25))))))
...
;; H
  ...
  (= (bool_eq4 (mk___rep2 riterl__split_fields3) no_element) true))
  (= (range_equal
     (model__
     (mk___rep1
     (us_split_discrs1
     ...
     (- (get1
        ...
        (rec__algorithm__controller__gapvec
        (let ((subject this__split_fields)) this__split_fields2)))))
        (mk___rep2 riterl__split_fields2)) 1)) true))
  (= (range_shifted
     (model__
     (mk___rep1
     (us_split_discrs1
...
;; H
  (assert
  (=> (= result2 true)
  (= result7 (mk___split_fields__ref2 riterl__split_fields3))))
...
;; H
  (assert
  (=> (= result2 true)
  (ite (= (ite (= (bool_eq4 (mk___rep2 riterr__split_fields3) no_element) false) (=
          (get1
          (positions
          (rec__algorithm__controller__gapvec
          (let ((subject this__split_fields)) this__split_fields3)))
          (mk___rep2 riterr__split_fields3)) 1) true) true)
  (= (bool_eq4 (mk___rep2 riterr__split_fields4) no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields3)))
     (mk___rep2 riterr__split_fields4)) true)
  (= (get1
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields3)))
     (mk___rep2 riterr__split_fields4)) (- (get1
                                           (positions
                                           (rec__algorithm__controller__gapvec
                                           (let ((subject this__split_fields))
                                           this__split_fields3)))
                                           (mk___rep2 riterr__split_fields3)) 1))))))

;; H
  (assert
  (=> (= result2 true)
  (=>
  (and (not (= (bool_eq4 (mk___rep2 riterl__split_fields4) no_element) true))
  (not (= (bool_eq4 (mk___rep2 riterr__split_fields4) no_element) true)))
  (and
  (= o28 (length1
         (rec__algorithm__controller__gapvec
         (let ((subject this__split_fields)) this__split_fields3))))
...
;; H
  (assert
  (=> (= result2 true)
  (= riterl__split_fields5 (mk___split_fields__ref2 riterl__split_fields4))))

;; H
  (assert
  (=> (= result2 true)
  (= riterr__split_fields5 (mk___split_fields__ref2 riterr__split_fields4))))
...
;; H
  (assert
  (=> (not (= result2 true))
  (= riterl__split_fields7 (mk___split_fields__ref2 riterl__split_fields1))))

;; H
  (assert
  (=> (not (= result2 true))
  (= riterr__split_fields7 (mk___split_fields__ref2 riterr__split_fields2))))
...
;; H
  (assert
  (= o32 (bool_eq4
         (mk___rep2 (us_split_fields__content2 riterl__split_fields7))
         o31)))
...
;; H
  ...
  (ite (= (= (length1
             (rec__algorithm__controller__gapvec
             (us_split_fields__content7 this__split_fields6))) 0) true)
  (= (bool_eq4 temp___1122 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
     (us_split_fields__content7 this__split_fields6))) temp___1122) true)
  (= (get1
     (positions
     (rec__algorithm__controller__gapvec
     (us_split_fields__content7 this__split_fields6))) temp___1122) (length1
                                                                    (rec__algorithm__controller__gapvec
                                                                    (us_split_fields__content7
                                                                    this__split_fields6))))))))
...
;; H
  (assert
  (and
  (= o47 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep6
                                                                   (rec__robot_iface__proxy__scan_res
                                                                   (us_split_fields11
                                                                   (rec__algorithm__controller__robot
                                                                   (us_split_fields__content7
...
;; H
  ...
  (= (bool_eq6 o44
     ...
     (rec__algorithm__controller__gapvec
     (us_split_fields__content7 this__split_fields6)))
     (mk___rep2 (us_split_fields__content2 riterl__split_fields7))))) true)))
...
;; H
  ...
  (= o41 (element
         (rec__algorithm__controller__gapvec
         (us_split_fields__content7 this__split_fields6))
         (mk___rep2 riterr__split_fields9)))
  (= (bool_eq6 o41
     (get
     (model__
     (rec__algorithm__controller__gapvec
     ...
     (rec__algorithm__controller__gapvec
     (us_split_fields__content7 this__split_fields6)))
     (mk___rep2 riterr__split_fields9)))) true)))
...
;; H
  ...
  (ite (= (ite (= (bool_eq4
                  (mk___rep2
                  (us_split_fields__content2 riterl__split_fields7))
...
;; H
  (assert
  (=> (= (distinct 0 0) true)
  (and (= o53 (print o52)) (dynamic_invariant1 o53 true false true true))))
