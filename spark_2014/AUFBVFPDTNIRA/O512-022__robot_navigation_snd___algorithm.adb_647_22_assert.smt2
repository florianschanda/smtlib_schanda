...
;; H
  (assert
  (=> (not (= result4 true)) (= driveturnrate4 (mk_t__ref driveturnrate))))

;; H
  (assert
  (=> (not (= result4 true)) (= this__split_fields8 this__split_fields4)))
...
;; H
  (assert
  (=> (not (= result4 true)) (= this__split_fields9 this__split_fields5)))
...
;; H
  ...
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o26)
  (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) o26)
  (not (= (oeq o25 zero_position) true)))))))

;; H
  (assert
  (and (= temp___943 (create__4 o26 o30))
  (=> (not (fp.eq o26 (fp #b0 #b00000000 #b00000000000000000000000)))
  (not (= (oeq temp___943 zero_position) true)))))
