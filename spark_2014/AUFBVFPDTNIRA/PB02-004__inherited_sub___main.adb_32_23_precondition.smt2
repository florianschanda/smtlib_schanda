...
(define-fun dynamic_invariant ((temp___expr_181 us_rep1)
  (temp___is_init_177 Bool) (temp___skip_constant_178 Bool)
  (temp___do_toplevel_179 Bool) (temp___do_typ_inv_180 Bool)) Bool (in_range3
  (to_rep (rec__rec__sub_rec__z (us_split_discrs3 temp___expr_181)))
  (rec__rec__sub_rec__plop (us_split_fields3 temp___expr_181))))
...
(define-fun dynamic_invariant1 ((temp___expr_188 us_rep2)
  ...
  (temp___do_typ_inv_187 Bool)) Bool (=> (rec__sub_rec_ok__plop__pred
                                     temp___expr_188) (in_range4
                                     (to_rep
                                     (rec__rec__sub_rec_ok__z
                                     (us_split_discrs5 temp___expr_188)))
                                     (rec__rec__sub_rec_ok__plop
                                     (us_split_fields5 temp___expr_188)))))
...
(define-fun dynamic_invariant2 ((temp___expr_201 us_rep3)
  ...
  (temp___do_typ_inv_200 Bool)) Bool (let ((temp___203 (rec__rec__sub_arr__l
                                                       (us_split_discrs7
                                                       temp___expr_201))))
                                     (let ((temp___202 (rec__rec__sub_arr__f
                                                       (us_split_discrs7
                                                       temp___expr_201))))
...
;; build_rec__post_axiom
  (assert
  (forall ((a Int))
  (! (=> (dynamic_invariant3 a true true true true) (dynamic_invariant
     (build_rec a) true false true true)) :pattern ((build_rec a)) )))
...
;; build_rec_ok__post_axiom
  (assert
  (forall ((a Int))
  (! (=> (dynamic_invariant3 a true true true true) (dynamic_invariant1
     (build_rec_ok a) true false true true)) :pattern ((build_rec_ok a)) )))
...
;; build_arr__post_axiom
  ...
  (forall ((f Int) (l Int))
  (! (=>
     (and (dynamic_invariant4 f true true true true) (dynamic_invariant4 l
     true true true true)) (dynamic_invariant2 (build_arr f l) true false
     true true)) :pattern ((build_arr f l)) )))
