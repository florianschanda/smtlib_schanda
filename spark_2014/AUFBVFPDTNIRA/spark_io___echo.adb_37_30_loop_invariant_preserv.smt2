...
;; range_axiom
  (assert
  (forall ((x file_status)) (! (in_range4
...
(define-fun default_initial_assumption ((temp___expr_603 us_rep1)
  (temp___skip_top_level_604 Bool)) Bool (and
                                         (= (attr__constrained
                                            temp___expr_603) false)
                                         (= (to_rep2
                                            (rec__spark__text_io__character_result__status
                                            (us_split_discrs1
                                            temp___expr_603))) 3)))
...
;; temp___String_Literal_811__def_axiom
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 1)) 69)
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 2)) 114))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 3)) 114))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 4)) 111))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 5)) 114))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 6)) 32))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 7)) 111))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 8)) 110))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 9)) 32))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 10)) 83))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 11)) 116))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 12)) 97))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 13)) 110))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 14)) 100))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 15)) 97))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 16)) 114))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 17)) 100))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 18)) 95))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 19)) 73))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 20)) 110))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 21)) 112))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 22)) 117))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 23)) 116)) :pattern (
...
;; temp___String_Literal_812__def_axiom
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 1)) 69)
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 2)) 114))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 3)) 114))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 4)) 111))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 5)) 114))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 6)) 32))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 7)) 111))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 8)) 110))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 9)) 32))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 10)) 83))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 11)) 116))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 12)) 97))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 13)) 110))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 14)) 100))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 15)) 97))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 16)) 114))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 17)) 100))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 18)) 95))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 19)) 79))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 20)) 117))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 21)) 116))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 22)) 112))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 23)) 117))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 24)) 116)) :pattern (
...
(declare-fun c__split_discrs1 () file_status)
...
;; H
  (assert
  (and (= o (end_of_file__2 standard_input))
  (= (= o true) (= (end_of_file standard_input) true))))
...
;; H
  ...
  (= (let ((temp___720 (name standard_input1)))
     (let ((temp___719 (name standard_input2)))
     (bool_eq (elts temp___719) (to_rep1 (first (rt temp___719)))
     (to_rep1 (last (rt temp___719))) (elts temp___720)
     (to_rep1 (first (rt temp___720))) (to_rep1 (last (rt temp___720)))))) true))
  (= (let ((temp___722 (form standard_input1)))
     (let ((temp___721 (form standard_input2)))
     (bool_eq (elts temp___721) (to_rep1 (first (rt temp___721)))
     (to_rep1 (last (rt temp___721))) (elts temp___722)
     (to_rep1 (first (rt temp___722))) (to_rep1 (last (rt temp___722)))))) true))
  (= (is_standard_file standard_input2) true))
  (= (is_standard_input standard_input2) true))
  (=> (= (to_rep2 c__split_discrs1) 1) (= (status standard_input2) 1))))
...
;; H
  ...
  (= (let ((temp___729 (name standard_output1)))
     (let ((temp___728 (name standard_output2)))
  ...
  (= (let ((temp___731 (form standard_output1)))
     (let ((temp___730 (form standard_output2)))
     (bool_eq (elts temp___730) (to_rep1 (first (rt temp___730)))
     (to_rep1 (last (rt temp___730))) (elts temp___731)
     (to_rep1 (first (rt temp___731))) (to_rep1 (last (rt temp___731)))))) true))
...
;; H
  (assert
  (and (= o2 (end_of_file__2 standard_input2))
  (= (= o2 true) (= (end_of_file standard_input2) true))))
