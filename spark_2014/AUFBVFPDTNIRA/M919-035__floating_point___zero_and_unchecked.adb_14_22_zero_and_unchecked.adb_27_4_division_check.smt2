...
;; H
  (assert (= zero_and_unchecked__zero_plus__assume (convert #x00000000)))

;; H
  (assert (fp.isFinite32 zero_and_unchecked__zero_plus__assume))
...
;; H
  (assert (= zero_and_unchecked__zero_neg__assume (convert #x80000000)))

;; H
  (assert (fp.isFinite32 zero_and_unchecked__zero_neg__assume))
