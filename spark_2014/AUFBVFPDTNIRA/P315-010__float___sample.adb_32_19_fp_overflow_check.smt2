...
(declare-const dummy1 nb_float_type)

(declare-datatypes ((nb_float_type__ref 0))
...
(declare-const dummy2 ttmpS)

(declare-datatypes ((ttmpS__ref 0))
(((mk_ttmpS__ref (ttmpS__content ttmpS)))))
...
;; WP_parameter_def
 ;; File "sample.ads", line 37, characters 0-0
  (not (fp.isFinite32 (fp.add RNE time tmp1))))
(check-sat)
(exit)
