...
;; H
  ...
  (and (= o18 (t__content failsafe__model__time_below_threshold__result4))
...
;; H
  ...
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) ((_ int2bv 8) 50))
  (= temp___265 (bvsub current_time o18))))

;; H
  (assert
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) ((_ int2bv 8) 50))
  (and (= o19 (t__content failsafe__model__time_below_threshold__result4))
  (in_range1 (t__content failsafe__model__time_below_threshold__result4)))))
...
;; H
  ...
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) ((_ int2bv 8) 50))
  (= result11 (ite (bvult current_time o19) true false))))

;; H
  (assert
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) ((_ int2bv 8) 50))
  (=> (= result11 true) (= o20 (bvadd temp___265 ((_ int2bv 8) 50))))))

;; H
  (assert
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) ((_ int2bv 8) 50))
  (=> (not (= result11 true)) (= o20 temp___265))))

;; H
  (assert
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) ((_ int2bv 8) 50))
  (= o21 (select battery_level_at o20))))
...
;; H
  ...
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) ((_ int2bv 8) 50))
  (= result10 (ite (fp.leq (fp #b0 #b01111100 #b10011001100110011001101)
              o22) true false))))
...
;; H
  (assert
  (and
  (= o13 (bvsub (t__content failsafe__model__time_below_threshold__result4) ((_ int2bv 8) 1)))
  (in_range1
