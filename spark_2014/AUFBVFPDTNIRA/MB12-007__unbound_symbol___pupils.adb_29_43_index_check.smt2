...
;; H
  ...
  (and
  (and
  (= (rec__pupils__pupildata__numberofpupils p__split_fields2) p__split_fields)
  ...
  (= (rec__pupils__pupiltype__surname
     (us_split_fields3
     (select (rec__pupils__pupildata__pupilentries p__split_fields2) temp___418))) 
  (rec__pupils__pupiltype__surname
  (us_split_fields3 (select p__split_fields1 temp___418))))
  (= (rec__pupils__pupiltype__forename
     (us_split_fields3
     (select (rec__pupils__pupildata__pupilentries p__split_fields2) temp___418))) 
  (rec__pupils__pupiltype__forename
  ...
  (= (rec__pupils__participation__studying
     ...
     (select (rec__pupils__pupiltype__scores
             (us_split_fields3
             (select (rec__pupils__pupildata__pupilentries p__split_fields2) temp___418))) temp___419))) 
  (rec__pupils__participation__studying
  (us_split_fields1
  (select (rec__pupils__pupiltype__scores
          (us_split_fields3 (select p__split_fields1 temp___418))) temp___419))))))))))
  (and (<= 0 i2) (<= i2 9))))
...
;; H
  ...
  (and
  (<= 1 (+ (to_rep4
           (rec__pupils__pupildata__numberofpupils p__split_fields2)) 1))
  (<= (+ (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields2)) 1) 250)))
...
;; H
  (assert
  (= o55 (select (rec__pupils__pupildata__pupilentries p__split_fields2) 
  o54)))

;; H
  (assert (= o56 (us_split_fields3 o55)))

;; H
  (assert (= temp___405 (rec__pupils__pupiltype__scores o56)))
...
;; H
  (assert (= o59 (rec__pupils__participation__studying o58)))

;; H
  (assert (= o60 (ite (not (= o59 true)) true false)))
...
;; H
  ...
  (= o65 (mk___split_fields1
         (rec__pupils__pupiltype__surname
         (us_split_fields3
         (select (rec__pupils__pupildata__pupilentries p__split_fields2) (+ 
         (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields2)) 1))))
         (rec__pupils__pupiltype__forename
         (us_split_fields3
         (select (rec__pupils__pupildata__pupilentries p__split_fields2) (+ 
         (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields2)) 1))))
