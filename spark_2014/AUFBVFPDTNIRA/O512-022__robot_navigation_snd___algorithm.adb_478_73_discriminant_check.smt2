...
(declare-fun candidate_valley_ids__split_fields () us_split_fields22)

(declare-fun candidate_valley_ids__split_discrs () us_split_discrs6)

(declare-fun result4 () Bool)

(declare-fun result5 () us_split_fields__ref11)

(declare-fun candidate_valley_ids__split_fields1 () us_split_fields22)
...
;; H
  (assert (= result4 (bool_eq18 (mk___rep6 ir__split_fields2) o7)))
...
;; H
  (assert (=> (= result7 true) (=> (= result8 true) (= usq_ temp___858))))
...
;; H
  ...
  (=> (= result7 true)
  (=> (= result8 true)
  (= candidate_valley_ids__split_fields2 (us_split_fields23 temp___860)))))
...
;; H
  ...
  (=> (= result7 true)
  (=> (= result8 true)
  (= candidate_valley_ids__split_discrs2 (us_split_discrs7 temp___860)))))
...
;; H
  ...
  (= (to_rep6
     ...
     candidate_valley_ids__split_discrs2)) 1)
  (=> (= result13 true)
  (= candidate_valley_ids__split_fields3 (us_split_fields23 temp___868)))))))
...
;; H
  ...
  (= (to_rep6
     ...
     candidate_valley_ids__split_discrs2)) 1)
  (=> (= result13 true)
  (= candidate_valley_ids__split_discrs3 (us_split_discrs7 temp___868)))))))
...
;; H
  ...
  (= (to_rep6
     (rec__algorithm__findbestvalley__gap_id_pair__opt
     candidate_valley_ids__split_discrs2)) 1))
  (= candidate_valley_ids__split_fields4 (us_split_fields23 temp___865))))))
...
;; H
  ...
  (= (to_rep6
     (rec__algorithm__findbestvalley__gap_id_pair__opt
     candidate_valley_ids__split_discrs2)) 1))
  (= candidate_valley_ids__split_discrs4 (us_split_discrs7 temp___865))))))
...
;; H
  (assert (=> (= (of_int1 0) true) (= o54 (rec__gaps__gap__bearing o53))))
...
;; H
  (assert (=> (= (of_int1 0) true) (= o57 (fp.abs o56))))

;; H
  (assert (=> (= (of_int1 0) true) (= o58 (attr__ATTRIBUTE_IMAGE4 o57))))

;; H
  (assert (=> (= (of_int1 0) true) (= o59 (to_string o58))))
...
;; H
  (assert (=> (= (of_int1 0) true) (= o61 (us_split_fields5 o60))))

;; H
  (assert (=> (= (of_int1 0) true) (= o62 (rec__gaps__gap__bearing o61))))
...
;; H
  (assert (=> (= (of_int1 0) true) (= o65 (us_split_fields5 o64))))

;; H
  (assert (=> (= (of_int1 0) true) (= o66 (rec__gaps__gap__bearing o65))))
...
;; H
  (assert (=> (= (of_int1 0) true) (= o69 (fp.abs o68))))

;; H
  (assert (=> (= (of_int1 0) true) (= o70 (attr__ATTRIBUTE_IMAGE4 o69))))
...
;; H
  (assert
  (and (= o72 (bearing disttogoal)) (bearing__function_guard o72 disttogoal)))
