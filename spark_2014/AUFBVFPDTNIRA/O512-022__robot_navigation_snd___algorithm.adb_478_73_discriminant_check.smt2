...
;; H
  (assert (=> (= (of_int 0) true) (= o46 (bearing disttogoal))))
...
;; H
  (assert (=> (= (of_int 0) true) (= o49 (us_split_fields5 o48))))

;; H
  (assert (=> (= (of_int 0) true) (= o50 (rec__gaps__gap__bearing o49))))
...
;; H
  (assert (=> (= (of_int 0) true) (= o55 (bearing disttogoal))))
...
;; H
  (assert (=> (= (of_int 0) true) (= o53 (us_split_fields5 o52))))

;; H
  (assert (=> (= (of_int 0) true) (= o54 (rec__gaps__gap__bearing o53))))
...
;; H
  (assert (=> (= (of_int 0) true) (= o57 (fp.abs o56))))

;; H
  (assert (=> (= (of_int 0) true) (= o58 (attr__ATTRIBUTE_IMAGE4 o57))))

;; H
  (assert (=> (= (of_int 0) true) (= o59 (to_string o58))))
...
;; H
  (assert (=> (= (of_int 0) true) (= o61 (us_split_fields5 o60))))

;; H
  (assert (=> (= (of_int 0) true) (= o62 (rec__gaps__gap__bearing o61))))
...
;; H
  (assert (=> (= (of_int 0) true) (= o67 (bearing disttogoal))))
...
;; H
  (assert (=> (= (of_int 0) true) (= o65 (us_split_fields5 o64))))

;; H
  (assert (=> (= (of_int 0) true) (= o66 (rec__gaps__gap__bearing o65))))
...
;; H
  (assert (=> (= (of_int 0) true) (= o69 (fp.abs o68))))

;; H
  (assert (=> (= (of_int 0) true) (= o70 (attr__ATTRIBUTE_IMAGE4 o69))))

;; H
  (assert (=> (= (of_int 0) true) (= o71 (to_string o70))))
