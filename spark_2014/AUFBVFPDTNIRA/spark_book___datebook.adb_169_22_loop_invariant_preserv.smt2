...
;; H
  (assert
  (and (<= (to_rep1 description__first) temp___401)
  (<= temp___401 (to_rep1 description__last))))

;; H
  (assert (= o4 temp___401))

;; H
  (assert (= o5 (store description2 o4 o3)))

;; H
  (assert (= result5 description2))

;; H
  (assert (= description3 o5))
