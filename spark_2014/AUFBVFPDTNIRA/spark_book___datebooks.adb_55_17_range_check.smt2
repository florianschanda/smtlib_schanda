...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 64))
  (and (=> (<= 1 64) (in_range12 i2)) (and (<= 1 i2) (<= i2 64)))))
...
;; H
  ...
  (and
  (and (and (= (to_rep9 o3) i2) (and (= o3 o4) (= (of_int 1) o5)))
  ...
  (= find_result__split_fields5 (mk___split_fields__ref4
                                find_result__split_fields4))
  (= find_result__split_fields6 find_result__split_fields4)) (= i2 64))))))
...
;; WP_parameter_def
 ;; File "datebooks.adb", line 14, characters 0-0
  (not (<= 1 (to_rep1 (first (rt description))))))
(check-sat)
