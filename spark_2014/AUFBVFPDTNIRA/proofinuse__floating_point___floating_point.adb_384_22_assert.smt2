...
(declare-datatypes ((tfloat_32B__ref 0))
(((mk_tfloat_32B__ref (tfloat_32B__content tfloat_32B)))))
...
(declare-datatypes ((float_32__ref 0))
(((mk_float_32__ref (float_32__content float_32)))))
...
;; H
  (assert
  (and (= o (fp.sub RNE y x))
  (not (or (fp.isInfinite (fp.sub RNE y x)) (fp.isNaN (fp.sub RNE y x))))))
