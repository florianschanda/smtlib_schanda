...
;; H
  (assert
  (=> (= result2 true) (=> (= result4 true) (= temp___1063 (mk___rep10 o9)))))
...
;; H
  (assert
  (=> (not (= result2 true))
  (=> (= result6 true) (= temp___1057 (mk___rep10 o13)))))
...
;; H
  ...
  (=> (not (= result2 true))
  (=> (= result6 true)
  (=> (= result8 true) (= temp___1059 (mk___rep10 o16))))))
...
;; H
  (assert
  (=> (not (= result2 true))
  (=> (not (= result6 true)) (= temp___1055 (mk___rep10 o19)))))
