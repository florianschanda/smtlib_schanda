...
(define-fun dynamic_invariant1 ((temp___expr_149 Float32)
...
(declare-fun bool_eq12 (us_rep5 us_rep5) Bool)
...
(define-fun dynamic_invariant3 ((temp___expr_593 us_rep2)
...
(define-fun default_initial_assumption ((temp___expr_595 us_rep2)
...
(define-fun bool_eq13 ((a us_rep6)
...
(define-fun bool_eq14 ((a (Array Int us_rep6)) (a__first Int) (a__last Int)
...
(define-fun dynamic_invariant4 ((temp___expr_155 Float32)
...
(define-fun dynamic_invariant5 ((temp___expr_179 Float32)
...
(define-fun dynamic_invariant6 ((temp___expr_302 Int)
...
(define-fun default_initial_assumption1 ((temp___expr_429 us_rep3)
  (temp___skip_top_level_430 Bool)) Bool (= (to_rep4
                                            (rec__algorithm__gap_vectors__cursor__node
                                            (us_split_fields7
                                            temp___expr_429))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_465 us_rep4)
...
(define-fun default_initial_assumption3 ((temp___expr_484 us_rep5)
...
(define-fun default_initial_assumption4 ((temp___expr_472 us_rep3)
  (temp___skip_top_level_473 Bool)) Bool (= (to_rep4
                                            (rec__algorithm__gap_vectors__cursor__node
                                            (us_split_fields7
                                            temp___expr_472))) 0))
...
;; last__post_axiom
  ...
  (! (let ((result (last1 container)))
     (ite (= (length container) 0) (= (bool_eq10 result no_element) true)
...
(define-fun dynamic_invariant7 ((temp___expr_458 Int)
...
(define-fun dynamic_invariant8 ((temp___expr_477 Int)
...
(declare-fun temp___837 () nonnegative_float)

(declare-fun temp___8371 () normalized2pi)

(declare-fun temp___836 () nonnegative_float)

(declare-fun temp___8361 () normalized2pi)

(declare-fun temp___835 () us_rep2)
...
(declare-fun rayr__split_fields () us_split_fields8)

(declare-fun rayl__split_fields () us_split_fields8)

(declare-fun gapvec__split_fields () us_split_fields4)
...
(declare-fun rayr__split_fields1 () us_split_fields8)

(declare-fun rayl__split_fields1 () us_split_fields8)

(declare-fun i2 () Int)

(declare-fun rho () us_split_fields4)

(declare-fun rho1 () us_split_fields4)
...
(declare-fun algorithm__gap_vectors__append__container__fields () us_split_fields4)

(declare-fun result3 () us_split_fields__ref2)

(declare-fun gapvec__split_fields2 () us_split_fields4)

(declare-fun algorithm__gap_vectors__append__container__fields1 () us_split_fields4)

(declare-fun result4 () us_split_fields__ref2)

(declare-fun gapvec__split_fields3 () us_split_fields4)

(declare-fun gapvec__split_fields4 () us_split_fields__ref2)

(declare-fun rayr__split_fields3 () us_split_fields__ref4)

(declare-fun rayl__split_fields3 () us_split_fields__ref4)

(declare-fun i3 () int__ref)

(declare-fun gapvec__split_fields5 () us_split_fields4)

(declare-fun rayr__split_fields4 () us_split_fields8)

(declare-fun rayl__split_fields4 () us_split_fields8)

(declare-fun i4 () Int)

(declare-fun gapvec__split_fields6 () us_split_fields__ref2)

(declare-fun rayr__split_fields5 () us_split_fields__ref4)

(declare-fun rayl__split_fields5 () us_split_fields__ref4)

(declare-fun i5 () int__ref)

(declare-fun gapvec__split_fields7 () us_split_fields4)

(declare-fun rayr__split_fields6 () us_split_fields8)

(declare-fun rayl__split_fields6 () us_split_fields8)

(declare-fun i6 () Int)

(declare-fun result5 () us_split_fields__ref4)

(declare-fun rayr__split_fields7 () us_split_fields8)

(declare-fun result6 () us_split_fields__ref4)

(declare-fun rayl__split_fields7 () us_split_fields8)
...
;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 999))
  (= (mk___split_fields4 temp___837
     (mk___rep (mk___split_fields temp___8371))) rayl__split_fields)))

;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 999))
  (= (mk___split_fields4 temp___836
     (mk___rep (mk___split_fields temp___8361))) rayr__split_fields)))

;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 999))
  (= temp___835 (mk___rep2 gapvec__split_discrs gapvec__split_fields))))

;; H
  (assert (=> (and (<= 2 i1) (<= i1 999)) (= temp___834 i1)))
...
;; H
  ...
  (not (or (fp.isInfinite (fp.sub RNE (to_rep
                                      ...
                                      rayl__split_fields2)) (to_rep
                                                            (rec__algorithm__laser_scan_data__first
                                                            rayr__split_fields2)))) (fp.isNaN (fp.sub RNE 
...
;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 999))
  (not (or (fp.isInfinite dist1) (fp.isNaN dist1)))))
...
;; H
  ...
  (= o1 (create__2
        ...
        (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields2))
        1))
  (create__2__function_guard o1
  (rec__algorithm__laser_scan_data__second rayl__split_fields2)
  (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields2)) 1))))))
...
;; H
  (assert
  (and (and (= o8 (cos1 o7)) (cos__function_guard o8 o7))
...
;; H
  ...
  (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields7)))) (fp.isNaN (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) 
...
;; H
  (assert (and (= o9 o6) (not (or (fp.isInfinite o6) (fp.isNaN o6)))))
...
;; H
  ...
  (not (or (fp.isInfinite (fp.mul RNE (to_rep
                                      ...
                                      rayl__split_fields7)) (to_rep
                                                            (rec__algorithm__laser_scan_data__first
                                                            rayl__split_fields7)))) (fp.isNaN (fp.mul RNE 
  (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields7)) 
  (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields7))))))))
...
;; H
  ...
  (not (or (fp.isInfinite (fp.mul RNE (to_rep
                                      ...
                                      rayr__split_fields7)) (to_rep
                                                            (rec__algorithm__laser_scan_data__first
                                                            rayr__split_fields7)))) (fp.isNaN (fp.mul RNE 
  (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields7)) 
  (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields7))))))))
...
;; H
  (assert (and (= o12 o4) (not (or (fp.isInfinite o4) (fp.isNaN o4)))))
...
;; H
  ...
  (not (or (fp.isInfinite o13) (fp.isNaN o13)))))

;; H
  (assert (= algorithm__buildgapvector__B_10__dist__assume dist2))

;; H
  (assert (not (or (fp.isInfinite dist2) (fp.isNaN dist2))))
