...
;; H
  (assert
  (and
  (= o5 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep4
                                                                  (rec__algorithm__laser_scan_data__first
                                                                  rayr__split_fields7))))
...
;; H
  (assert
  (and
  (= o3 (fp.mul RNE (to_rep4
                    (rec__algorithm__laser_scan_data__first
                    rayr__split_fields7)) (to_rep4
                                          (rec__algorithm__laser_scan_data__first
                                          rayr__split_fields7))))
  (fp.isFinite32 (fp.mul RNE (to_rep4
                             (rec__algorithm__laser_scan_data__first
...
;; WP_parameter_def
 ;; File "algorithm.adb", line 132, characters 0-0
  ...
  (< (length
     (mk___rep2 gapvec__split_discrs
     (us_split_fields__content2 gapvec__split_fields6))) (to_rep3
                                                         (rec__algorithm__gap_vectors__list__capacity
                                                         gapvec__split_discrs)))))
(check-sat)
(exit)
