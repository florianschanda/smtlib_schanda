...
;; H
  (assert
  (bvule (let ((temp___299 (bvsub current_time (bvsub res2 #x01))))
         (ite (bvult current_time (bvsub res2 #x01)) (bvadd temp___299 #x32)
         temp___299)) s2))
...
;; WP_parameter_def
 ;; File "failsafe.ads", line 16, characters 0-0
  (not
  (fp.lt (to_rep (select battery_level_at s2)) (fp #b0 #b01111100 #b10011001100110011001101))))
(check-sat)
(exit)
