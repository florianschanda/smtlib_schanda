...
(declare-datatypes ()
((tT79bP1__ref (mk_tT79bP1__ref (tT79bP1__content tdigit_count_typeB)))))
(define-fun tT79bP1__ref___projection ((a tT79bP1__ref)) tdigit_count_typeB 
  (tT79bP1__content a))
...
(define-fun us_split_fields_Long_Digits21__projection ((a us_split_fields2)) us_t1 
...
(define-fun us_rep_41__projection ((a us_rep1)) us_split_discrs (us_split_discrs2
                                                                a))

(define-fun us_rep_42__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                 a))

(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a)
                                         (mk___split_fields
                                         (let ((temp___172 (rec__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
                                         (of_array (to_array1 temp___172)
                                         (first3 temp___172)
                                         (last3 temp___172))))))

(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1)
                                          (mk___split_fields1
                                          (let ((temp___171 (rec__very_longs__very_long__long_digits
                                                            (us_split_fields1
                                                            r1))))
                                          (of_array1 (to_array temp___171)
                                          (first1 temp___171)
                                          (last1 temp___171))))))
...
(define-fun dynamic_invariant3 ((temp___expr_582 us_rep1)
  (temp___is_init_579 Bool) (temp___skip_constant_580 Bool)
  (temp___do_toplevel_581 Bool)) Bool (and
                                      (=>
                                      ...
                                      (first3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_582)))
                                      (last3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_582))))
                                      (and
                                      (= (first3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_582))) 1)
                                      (= (last3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_582))) 
                                      (to_rep
...
(define-fun default_initial_assumption ((temp___expr_585 us_rep1)
  (temp___skip_top_level_586 Bool)) Bool (= (to_rep
                                            (rec__very_longs__very_long__length
                                            (us_split_discrs2
                                            temp___expr_585))) (to_rep
                                                               (rec__very_longs__very_long__length
                                                               (us_split_discrs1
                                                               l)))))
...
(declare-datatypes ()
((t80b__ref (mk_t80b__ref (t80b__content tdigit_count_typeB)))))
(define-fun t80b__ref___projection ((a t80b__ref)) tdigit_count_typeB 
  (t80b__content a))
...
;; def_axiom
  (assert
  (forall ((temp___931 (_ BitVec 8)))
  (forall ((temp___932 Int) (temp___933 Int))
  (let ((temp___930 (temp___929 temp___931 temp___932 temp___933)))
  (and
  (=> (dynamic_property6 1 65536 temp___932 temp___933)
  (and (= (first5 temp___930) temp___932) (= (last5 temp___930) temp___933)))
  (forall ((temp___934 Int))
  (= (select (to_array2 temp___930) temp___934) (of_rep1 temp___931))))))))
...
(declare-fun very_longs__modsubtract__result () digit_index_type)

(declare-fun very_longs__modsubtract__result1 () (Array Int octet))

(declare-fun very_longs__modsubtract__result2 () t)
...
(declare-fun temp___936 () (Array Int octet))

(declare-fun temp___9361 () t2)

(declare-fun temp___937 () (Array Int octet))

(declare-fun temp___9371 () t1)
...
(declare-fun temp___940 () digit_index_type)

(declare-fun temp___9401 () (Array Int octet))

(declare-fun temp___9402 () t1)

(declare-fun temp___950 () us_rep1)
...
(declare-fun o13 () octet)

(declare-fun o14 () Int)

(declare-fun o15 () (Array Int octet))

(declare-fun o16 () us_t1)

(declare-fun o17 () us_split_fields2)

(declare-fun temp___945 () us_rep1)
...
(declare-fun l_digit7 () (_ BitVec 16))
...
(declare-fun result9 () very_long__ref)

(declare-fun very_longs__modsubtract__result3 () us_rep)

(declare-fun very_longs__modsubtract__result4 () very_long__ref)

(declare-fun very_longs__modsubtract__result5 () us_rep)

(declare-fun result____split_fields9 () us_split_fields__ref1)

(declare-fun l_digit8 () t__ref1)
...
(declare-fun very_longs__modsubtract__result6 () very_long__ref)

(declare-fun result____split_fields10 () us_split_fields2)

(declare-fun l_digit9 () (_ BitVec 16))
...
(declare-fun very_longs__modsubtract__result7 () us_rep)

(declare-fun result10 () digit_index_type)

(declare-fun result11 () (Array Int octet))

(declare-fun result12 () t)
...
;; H
  (assert
  (and
  (= us2 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))
  (in_range1
  (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))
...
;; H
  (assert
  (= (mk___t2 temp___936 temp___9361) (temp___929 ((_ int2bv 8) 0) 1
                                      (to_rep
                                      (rec__very_longs__very_long__length
                                      (us_split_discrs1 l))))))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___9361)) (to_rep2 (last4 temp___9361)))
     (+ (- (to_rep2 (last4 temp___9361)) (to_rep2 (first4 temp___9361))) 1)
     0) (ite (<= 1 (to_rep
                   (rec__very_longs__very_long__length (us_split_discrs1 l))))
        (+ (- (to_rep
              (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1)
        0)))
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___9361)) (to_rep2 (last4 temp___9361))) 
  temp___9371))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___9371)) (to_rep2 (last2 temp___9371)))
     (+ (- (to_rep2 (last2 temp___9371)) (to_rep2 (first2 temp___9371))) 1)
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___9401 temp___9402))))
...
;; H
  ...
  (= temp___950 (mk___rep1 result____split_discrs result____split_fields2))))
...
;; H
  ...
  (<= (to_rep2
      (first2
      (rt1
      (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___952)
  (<= temp___952 (to_rep2
                 (last2
                 (rt1
                 (rec__very_longs__very_long__long_digits1
  ...
  (= (select (elts1
             (rec__very_longs__very_long__long_digits1
             result____split_fields3)) temp___952) (select (elts1
                                                           (rec__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           temp___950))) temp___952))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))))))
...
;; H
  ...
  (= o15 (store (elts1
                (rec__very_longs__very_long__long_digits1
                result____split_fields3)) o14 o13))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= temp___945 (mk___rep1 result____split_discrs o17))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= result8 (mk___split_fields__ref1 result____split_fields3))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= result____split_fields4 (us_split_fields3 temp___945))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= result____split_discrs (us_split_discrs2 temp___945))))
...
;; H
  (assert
  (= very_longs__modsubtract__result4 (mk_very_long__ref
                                      very_longs__modsubtract__result3)))

;; H
  (assert
  (= very_longs__modsubtract__result5 very_longs__modsubtract__result3))

;; H
  (assert
  (= result9 (mk_very_long__ref
             (mk___rep (mk___split_discrs very_longs__modsubtract__result)
             (mk___split_fields
             (mk___t very_longs__modsubtract__result1
             very_longs__modsubtract__result2))))))

;; H
  (assert
  (= very_longs__modsubtract__result3 (to_base
                                      (mk___rep1 result____split_discrs
...
;; H
  (assert
  (= very_longs__modsubtract__result6 very_longs__modsubtract__result4))
...
;; H
  (assert
  (= very_longs__modsubtract__result7 very_longs__modsubtract__result5))
...
;; H
  (assert
  (= (mk___rep (mk___split_discrs result10)
     (mk___split_fields (mk___t result11 result12))) (very_long__content
                                                     very_longs__modsubtract__result6)))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 84, characters 0-0
  ...
  (= (to_rep
     (rec__very_longs__very_long__length
     (us_split_discrs1 (very_long__content very_longs__modsubtract__result6)))) 
  (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))
(check-sat)
