...
;; H
  (assert (fib__function_guard (fib (- i3 2)) (- i3 2)))
...
;; H
  (assert
  (=> (not (=> (not (= n 0)) (= n 1)))
  (=> (and (<= 2 i2) (<= i2 n)) (= temp___200 temp))))

;; H
  (assert
  (=> (not (=> (not (= n 0)) (= n 1)))
  (=> (and (<= 2 i2) (<= i2 n)) (= temp___199 oldest2))))

;; H
  (assert
  (=> (not (=> (not (= n 0)) (= n 1)))
  (=> (and (<= 2 i2) (<= i2 n)) (= temp___198 old__2))))

;; H
  (assert
  (=> (not (=> (not (= n 0)) (= n 1)))
  (=> (and (<= 2 i2) (<= i2 n)) (= temp___197 i2))))
...
;; H
  (assert (fib__function_guard (fib n) n))
