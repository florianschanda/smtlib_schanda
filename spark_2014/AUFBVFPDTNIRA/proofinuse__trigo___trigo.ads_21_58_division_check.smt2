...
;; H
  (assert
  (and (and (= o1 (pow8 x)) (pow8__function_guard o1 x))
...
;; H
  (assert
  (= o2 (fp.div RNE o1 (fp #b0 #b10001110 #b00111011000000000000000))))

;; H
  (assert
  (and (and (= o (pow6 x)) (pow6__function_guard o x))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (not
  (fp.eq (fp #b0 #b10001000 #b01101000000000000000000) ((_ to_fp 8 24) #x00000000)))))
(check-sat)
