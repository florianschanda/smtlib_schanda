...
;; H
  (assert (= temp___332 (mk___rep1 o94)))

;; H
  (assert (= result12 (mk___split_fields__ref1 merge__split_fields3)))

;; H
  (assert (= merge__split_fields10 (us_split_fields3 temp___332)))
