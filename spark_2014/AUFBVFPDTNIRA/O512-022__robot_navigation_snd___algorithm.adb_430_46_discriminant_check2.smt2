...
;; H
  (assert (= o32 (rec__gaps__gap__bearing o31)))

;; H
  (assert (= o34 (aldiff o32 o33)))
...
;; H
  (assert (fp.leq o34 (fp #b0 #b10000000 #b10010010000111111011011)))

;; H
  (assert (= o35 (fp.abs o34)))
...
;; H
  (assert (= o36 (fp.abs o29)))

;; H
  (assert (= result8 (ite (fp.lt o36 o35) true false)))

;; H
  (assert (= result8 true))

;; H
  (assert (= (to_rep11 o37) 1))

;; H
  (assert (= o38 (mk___split_discrs3 o37)))
