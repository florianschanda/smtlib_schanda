...
;; WP_parameter_def
 ;; File "generic_float_tests.ads", line 2, characters 0-0
  (not
  (<= 1 (+ (+ (+ (+ (+ (+ (+ (+ (+ 0 (ite (= (bool_eq x
                                             (fp.neg (fp #b0 #b01111111 #b10011001100110011001101))) true)
                                     1 0)) (ite (= (bool_eq x
                                                   (fp.neg (fp #b0 #b01111111 #b10000000000000000000000))) true)
                                           1 0)) (ite (= (bool_eq x
                                                         (fp.neg (fp #b0 #b01111111 #b01100110011001100110011))) true)
                                                 1 0)) (ite (= (bool_eq 
                                                               x
                                                               (fp.neg (fp #b0 #b01111111 #b00000000000000000000000))) true)
                                                       1 0)) (ite (= 
                                                             (bool_eq 
                                                             x
                                                             (fp #b0 #b00000000 #b00000000000000000000000)) true)
                                                             1 0)) (ite (= 
                                                                   (bool_eq 
                                                                   x
                                                                   (fp #b0 #b01111111 #b00000000000000000000000)) true)
                                                                   1 0)) 
  (ite (= (bool_eq x (fp #b0 #b01111111 #b01100110011001100110011)) true) 1
  0)) (ite (= (bool_eq x (fp #b0 #b01111111 #b10000000000000000000000)) true)
      1 0)) (ite (= (bool_eq x (fp #b0 #b01111111 #b10011001100110011001101)) true)
            1 0)))))
(check-sat)
