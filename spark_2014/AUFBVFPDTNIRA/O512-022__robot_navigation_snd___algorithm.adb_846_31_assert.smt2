...
;; H
  ...
  (= o95 (print
         (rec__algorithm__controller__driveangle
         (us_split_fields__content10 this__split_fields45))))
  (dynamic_invariant4 o95 true false true))))
...
;; H
  ...
  (and
  (= o96 (print
         (mk___rep (us_split_fields__content midvalleyangle__split_fields8))))
  (dynamic_invariant4 o96 true false true))))
...
;; H
  ...
  (= o97 (print
         (mk___rep
         (us_split_fields__content saferisinggapangle__split_fields5))))
  (dynamic_invariant4 o97 true false true))))
