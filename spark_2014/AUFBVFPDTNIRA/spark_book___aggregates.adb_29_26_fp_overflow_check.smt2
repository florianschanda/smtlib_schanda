...
;; H
  (assert
  (=> (= result7 true)
  (and (= o8 (fp.div RNE c13b approx2))
  (not (or (fp.isInfinite (fp.div RNE c13b approx2)) (fp.isNaN (fp.div RNE 
  c13b approx2)))))))

;; H
  (assert (=> (= result7 true) (= o9 (fp.add RNE approx2 o8))))
...
;; H
  (assert
  (=> (= result7 true)
  (= o11 (fp.mul RNE (fp #b0 #b01111110 #b00000000000000000000000) o10))))
...
;; H
  (assert
  (=> (= result7 true)
  (and (= o12 (fp.mul RNE approx3 approx3))
  (not (or (fp.isInfinite (fp.mul RNE approx3 approx3)) (fp.isNaN (fp.mul RNE 
  approx3 approx3)))))))

;; H
  (assert (=> (= result7 true) (= o13 (fp.sub RNE c13b o12))))
...
;; H
  (assert (=> (= result7 true) (= o15 (fp.abs o14))))

;; H
  (assert
  (=> (= result7 true) (= o16 (ite (fp.lt tolerance o15) true false))))
