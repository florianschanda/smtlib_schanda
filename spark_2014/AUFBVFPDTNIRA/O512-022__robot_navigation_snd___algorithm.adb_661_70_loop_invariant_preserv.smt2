...
(define-fun bool_eq11 ((a (Array Int us_rep7)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq10 (select a temp___idx_155)
...
(declare-fun isfilterclear ((Array Int us_rep7) us_rep Float32 Float32
  Bool) Bool)

(declare-fun isfilterclear__function_guard (Bool (Array Int us_rep7) us_rep
...
(define-fun bool_eq12 ((a us_rep8)
...
(define-fun dynamic_invariant11 ((temp___expr_414 Int)
  ...
  (temp___do_typ_inv_413 Bool)) Bool (=>
                                     ...
                                     (<= 0 1)) (in_range13 temp___expr_414)))
...
(declare-const this__split_fields3 us_split_fields__ref9)

(declare-const this__split_fields4 us_split_fields18)
...
(declare-const this__split_fields5 us_split_fields__ref9)

(declare-const disttoclosestobstacle6 t__ref)

(declare-const i4 int__ref)

(declare-const this__split_fields6 us_split_fields18)
...
;; H
  ...
  (fp.lt (to_rep5
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content9 this__split_fields1))))) (to_rep5
                                                             (rec__robot_iface__proxy__max_range
                                                             (us_split_fields9
                                                             (rec__algorithm__controller__robot
...
;; H
  (assert
  (= disttoclosestobstacle1 (to_rep5
                            (rec__robot_iface__proxy__max_range
                            (us_split_fields9
                            (rec__algorithm__controller__robot
                            (us_split_fields__content9 this__split_fields1)))))))
...
;; H
  ...
  (fp.lt (to_rep5
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content9 this__split_fields1))))) disttoclosestobstacle1))
...
;; H
  ...
  (= this__split_fields3 (let ((subject this__split_fields))
                         (mk___split_fields__ref9 this__split_fields2))))
...
;; H
  ...
  (fp.lt (to_rep5
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content9 this__split_fields3))))) (to_rep6
                                                             (rec__algorithm__laser_scan_data__first
                                                             (us_split_fields15
                                                             (select
                                                             (rec__algorithm__controller__laserscan
...
;; H
  (assert
  (and
  (= o3 (fp.add RNE (to_rep5
                    (rec__robot_iface__proxy__obstacle_avoid_dist
                    (us_split_fields9
                    (rec__algorithm__controller__robot
                    (us_split_fields__content9 this__split_fields3)))))
  (to_rep5
  (rec__robot_iface__proxy__robot_radius
  (us_split_fields9
  (rec__algorithm__controller__robot
  (us_split_fields__content9 this__split_fields3)))))))
  (fp.isFinite32 (fp.add RNE (to_rep5
                             (rec__robot_iface__proxy__obstacle_avoid_dist
                             (us_split_fields9
                             (rec__algorithm__controller__robot
                             (us_split_fields__content9 this__split_fields3)))))
...
;; H
  ...
  (=> (= result4 true)
  (and
  (= o4 (fp.min disttoclosestobstacle2 (to_rep6
                                       (rec__algorithm__laser_scan_data__first
                                       (us_split_fields15
                                       (select (rec__algorithm__controller__laserscan
                                               (us_split_fields__content9
                                               this__split_fields3))
                                       (let ((subject i)) i2)))))))
  (fp.isFinite32 (fp.min disttoclosestobstacle2 (to_rep6
                                                (rec__algorithm__laser_scan_data__first
                                                (us_split_fields15
                                                (select (rec__algorithm__controller__laserscan
                                                        (us_split_fields__content9
...
;; WP_parameter_def
 ;; File "algorithm.ads", line 107, characters 0-0
  ...
  (fp.lt (to_rep5
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content9 this__split_fields5))))) (t__content
                                                             disttoclosestobstacle6))))
(check-sat)
(exit)
