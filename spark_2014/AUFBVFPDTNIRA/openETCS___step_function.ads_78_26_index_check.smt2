...
;; H
  (assert
  (= (mk___rep (mk___split_fields o30 o31)) (select (rec__step_function__step_function_t__step
                                                    (us_split_fields3 sfun))
  o29)))
...
;; H
  (assert
  (= o36 (ite (fp.eq (t__content step_function__minimum_until_point__result4)
         o35) true false)))
