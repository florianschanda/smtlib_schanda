...
;; H
  ...
  value (abs (- value (int__content
                      test_prime_and_coprime_numbers__p__nearest_number__result19)))) 1) 0) v)
  (<= v value)) (not (= (select number_list v) true))))
  (forall ((v Int))
  (=>
  (and (<= value v)
  (<= v (ite (< 100000 (- (+ value (abs (- value (int__content
                                                 test_prime_and_coprime_numbers__p__nearest_number__result19)))) 1)) 100000 (- (+ 
  value (abs (- value (int__content
                      test_prime_and_coprime_numbers__p__nearest_number__result19)))) 1))))
  (not (= (select number_list v) true)))))))
