...
;; H
  (assert (< 1 (int__content n7)))

;; H
  (assert (<= (int__content cur_position6) 10000))
...
;; H
  (assert (and (= o8 (int__content n7)) (in_range2 (int__content n7))))
...
;; H
  (assert (= result6 rest6))

;; H
  (assert (= rest8 textio__get_line__get_chunk__rest1))
