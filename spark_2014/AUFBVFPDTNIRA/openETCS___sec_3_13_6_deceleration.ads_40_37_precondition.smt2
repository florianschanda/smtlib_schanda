...
(declare-fun dummy4 () num_delimiters_range)
...
(declare-fun dummy5 () function_range)
...
;; get_value__post_axiom
  ...
  (! (and (is_valid__function_guard (is_valid sfun) sfun)
     (=> (and (dynamic_invariant3 x true true true) (= (is_valid sfun) true))
...
(declare-fun dummy9 () speed_km_per_h_t)
...
(define-fun dynamic_invariant6 ((temp___expr_194 Int)
  ...
  (temp___do_toplevel_193 Bool)) Bool (=>
                                      ...
                                      (<= 0 10)) (in_range4 temp___expr_194)))
...
(declare-fun sec_3_13_6_deceleration__a_brake_emergency__result () Float32)
...
(declare-fun temp___360 () num_delimiters_range)

(declare-fun temp___3601 () (Array Int us_rep))
...
(declare-fun sec_3_13_6_deceleration__a_brake_emergency__result1 () Float32)

(declare-fun sec_3_13_6_deceleration__a_brake_emergency__result2 () Float32)

(declare-fun sec_3_13_6_deceleration__a_brake_emergency__result3 () Float32)

(declare-fun sec_3_13_6_deceleration__a_brake_emergency__result4 () Float32)

(declare-fun sec_3_13_6_deceleration__a_brake_emergency__result5 () Float32)
...
;; H
  (assert (= temp___360 o14))

;; H
  (assert (= temp___3601 o15))

;; H
  (assert
  (= (mk___rep1 (mk___split_fields1 temp___360 temp___3601)) a_brake_emergency_model))
...
;; H
  (assert (is_valid_deceleration_model__function_guard
  (is_valid_deceleration_model a_brake_emergency_model)
  a_brake_emergency_model))

;; H
  (assert (is_valid_speed__function_guard (is_valid_speed v) v))
...
;; H
  (assert
  (= sec_3_13_6_deceleration__a_brake_emergency__result1 sec_3_13_6_deceleration__a_brake_emergency__result2))
...
;; H
  (assert (and (= o16 (to_int1 RNA v)) (in_range5 (to_int1 RNA v))))

;; H
  (assert
  (and
  (and (= o17 (get_value a_brake_emergency_model o16))
  (get_value__function_guard o17 a_brake_emergency_model o16))
...
;; H
  ...
  (= (mk_t__ref result) (mk_t__ref
                        sec_3_13_6_deceleration__a_brake_emergency__result)))
...
;; H
  (assert
  (= (mk_t__ref sec_3_13_6_deceleration__a_brake_emergency__result4) 
  (mk_t__ref sec_3_13_6_deceleration__a_brake_emergency__result2)))
...
;; H
  (assert (and (= o19 (to_int1 RNA v)) (in_range5 (to_int1 RNA v))))

;; H
  (assert (is_valid__function_guard (is_valid a_brake_emergency_model)
  a_brake_emergency_model))

(assert
;; WP_parameter_def
 ;; File "units.ads", line 26, characters 0-0
  (not (= (is_valid a_brake_emergency_model) true)))
(check-sat)
