...
(declare-fun temp___4605 () us_rep)

(declare-fun o51 () (Array (_ BitVec 8) us_rep1))

(declare-fun o52 () rx_frame_queue_index)

(declare-fun o53 () natural)

(declare-fun o54 () Bool)

(declare-fun o55 () Bool)

(declare-fun o56 () bits_1)

(declare-fun o57 () us_split_fields)

(declare-fun temp___4607 () us_rep)

(declare-fun o58 () (Array (_ BitVec 8) us_rep1))

(declare-fun o59 () rx_frame_queue_index)

(declare-fun o60 () natural)
...
(declare-fun sys_status_clear__split_fields3 () us_split_fields)

(declare-fun receiver20 () (Array (_ BitVec 8) us_rep1))

(declare-fun receiver21 () rx_frame_queue_index)

(declare-fun receiver22 () natural)

(declare-fun receiver23 () Bool)

(declare-fun receiver24 () Bool)

(declare-fun result4 () us_split_fields__ref)

(declare-fun sys_status_clear__split_fields4 () us_split_fields)

(declare-fun receiver25 () us_rep2)

(define-fun receiver26 () us_rep2 (mk___rep2
                                  (mk___split_fields2 receiver20 receiver21
                                  receiver22 receiver23 receiver24)))

(define-fun receiver27 () us_rep2 (mk___rep2
                                  (mk___split_fields2 receiver15 receiver16
                                  receiver17 receiver18 receiver19)))

(define-fun receiver28 () us_rep2 (mk___rep2
                                  (mk___split_fields2 receiver10 receiver11
                                  receiver12 receiver13 receiver14)))

(define-fun receiver29 () us_rep2 (mk___rep2
...
;; H
  ...
  (dynamic_invariant receiver28 true true true))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_frame_timeout
     (us_split_fields11 (driver_type__content self__))) true)
  (= (mk___rep2 (mk___split_fields2 o37 o38 o39 o40 o41)) receiver28))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_sfd_timeout
     (us_split_fields11 (driver_type__content self__))) true)
  (dynamic_invariant receiver27 true true true))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_sfd_timeout
     (us_split_fields11 (driver_type__content self__))) true)
  (= (mk___rep2 (mk___split_fields2 o44 o45 o46 o47 o48)) receiver27))))
...
;; H
  ...
  (= o50 (mk___split_fields
         (rec__dw1000__register_types__sys_status_type__irqs
         (let ((subject sys_status_clear__split_fields))
         sys_status_clear__split_fields2))
         (rec__dw1000__register_types__sys_status_type__cplock
         (let ((subject sys_status_clear__split_fields))
         sys_status_clear__split_fields2))
         (rec__dw1000__register_types__sys_status_type__esyncr
         ...
         (rec__dw1000__register_types__sys_status_type__clkpll_ll
         (let ((subject sys_status_clear__split_fields))
         sys_status_clear__split_fields2)) o49
         (rec__dw1000__register_types__sys_status_type__hpdwarn
         (let ((subject sys_status_clear__split_fields))
         sys_status_clear__split_fields2))
         (rec__dw1000__register_types__sys_status_type__txberr
...
;; H
  ...
  (= (to_rep
     ...
     (let ((subject sys_status_reg__split_fields))
     sys_status_reg__split_fields1))) ((_ int2bv 8) 1))
  (= result3 (let ((subject sys_status_clear__split_fields))
             (mk___split_fields__ref sys_status_clear__split_fields2)))))
...
;; H
  ...
  (= (to_rep
     ...
     sys_status_reg__split_fields1))) ((_ int2bv 8) 1))
  (= (let ((subject sys_status_clear__split_fields))
     sys_status_clear__split_fields3) (us_split_fields1 temp___4605))))
...
;; H
  ...
  (= (to_rep
     ...
     sys_status_reg__split_fields1))) ((_ int2bv 8) 1)))
  (= (let ((subject sys_status_clear__split_fields))
     (mk___split_fields__ref sys_status_clear__split_fields3)) (let ((subject 
                                                               sys_status_clear__split_fields))
                                                               (mk___split_fields__ref
                                                               sys_status_clear__split_fields2)))))
...
;; H
  ...
  (= (to_rep
     ...
     (let ((subject sys_status_reg__split_fields))
     sys_status_reg__split_fields1))) ((_ int2bv 8) 1)))
  (= sys_status_clear__split_fields3 sys_status_clear__split_fields2)))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_rs_error
     (us_split_fields11 (driver_type__content self__))) true)
  (dynamic_invariant receiver26 true true true))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_rs_error
     (us_split_fields11 (driver_type__content self__))) true)
  (= (mk___rep2 (mk___split_fields2 o51 o52 o53 o54 o55)) receiver26))))
...
;; H
  ...
  (= o57 (mk___split_fields
         (rec__dw1000__register_types__sys_status_type__irqs
         (let ((subject sys_status_clear__split_fields))
         sys_status_clear__split_fields3))
         (rec__dw1000__register_types__sys_status_type__cplock
         (let ((subject sys_status_clear__split_fields))
         sys_status_clear__split_fields3))
         (rec__dw1000__register_types__sys_status_type__esyncr
         ...
         (rec__dw1000__register_types__sys_status_type__rxfce
         (let ((subject sys_status_clear__split_fields))
         sys_status_clear__split_fields3)) o56
         (rec__dw1000__register_types__sys_status_type__rxrfto
         (let ((subject sys_status_clear__split_fields))
         sys_status_clear__split_fields3))
         (rec__dw1000__register_types__sys_status_type__ldeerr
...
;; H
  ...
  (= (to_rep
     ...
     (let ((subject sys_status_reg__split_fields))
     sys_status_reg__split_fields1))) ((_ int2bv 8) 1))
  (= result4 (let ((subject sys_status_clear__split_fields))
             (mk___split_fields__ref sys_status_clear__split_fields3)))))
...
;; H
  ...
  (= (to_rep
     ...
     sys_status_reg__split_fields1))) ((_ int2bv 8) 1))
  (= (let ((subject sys_status_clear__split_fields))
     sys_status_clear__split_fields4) (us_split_fields1 temp___4607))))
...
;; H
  ...
  (= (to_rep
     ...
     sys_status_reg__split_fields1))) ((_ int2bv 8) 1)))
  (= (let ((subject sys_status_clear__split_fields))
     (mk___split_fields__ref sys_status_clear__split_fields4)) (let ((subject 
                                                               sys_status_clear__split_fields))
                                                               (mk___split_fields__ref
                                                               sys_status_clear__split_fields3)))))
...
;; H
  ...
  (= (to_rep
     ...
     (let ((subject sys_status_reg__split_fields))
     sys_status_reg__split_fields1))) ((_ int2bv 8) 1)))
  (= sys_status_clear__split_fields4 sys_status_clear__split_fields3)))
...
;; H
  (assert (dynamic_invariant receiver25 true true true))

;; H
  (assert
  (= (mk___rep2 (mk___split_fields2 o58 o59 o60 o61 o62)) receiver25))
