...
(declare-const temp___236 ft)

(declare-const temp___2361 ft)

(declare-const temp___2362 ft)
...
(declare-const temp___238 ft)

(declare-const temp___2381 ft)

(declare-const temp___2382 ft)
...
;; H
  (assert (= temp___2361 o4))

;; H
  (assert (= temp___2362 o5))
...
;; H
  (assert (= temp___236 r__split_fields3))

;; H
  (assert (= temp___2361 r__split_fields4))

;; H
  (assert (= temp___2362 r__split_fields5))
...
;; H
  (assert (= temp___238 r__split_fields6))

;; H
  (assert (= temp___2381 r__split_fields7))

;; H
  (assert (= temp___2382 r__split_fields8))
