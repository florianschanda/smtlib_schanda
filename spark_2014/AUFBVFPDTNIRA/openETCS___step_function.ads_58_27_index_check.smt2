...
(declare-fun dummy1 () tnum_delimiters_rangeB)
...
;; range_axiom
  (assert
  (forall ((x1 tnum_delimiters_rangeB)) (! (in_range2
...
(declare-datatypes ()
((t3b__ref (mk_t3b__ref (t3b__content tnum_delimiters_rangeB)))))
(define-fun t3b__ref___projection ((a t3b__ref)) tnum_delimiters_rangeB 
  (t3b__content a))
...
(declare-fun o11 () function_range)
...
(declare-fun o19 () function_range)
...
(declare-fun step_function__get_value__result9 () t__ref)

(declare-fun step_function__get_value__result10 () Float32)

(declare-fun i8 () int__ref)

(declare-fun step_function__get_value__result11 () t__ref)
...
(declare-fun step_function__get_value__result13 () t__ref)

(declare-fun i11 () Int)

(declare-fun step_function__get_value__result14 () Float32)
...
(define-fun o24 () us_rep (mk___rep (mk___split_fields o1 o2)))
...
;; H
  ...
  (= temp___258 (- (to_rep1
                   (rec__step_function__step_function_t__number_of_delimiters
                   (us_split_fields3 sfun))) 1))
  (and (and (= result4 i13) (= i2 temp___257))
  (and (and (<= temp___257 i2) (<= i2 temp___258))
  (and (= temp___253 i2)
  (and
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j i3))
  ...
  (and
  (and
  (and (and (= temp___251 (+ i3 1)) (in_range2 (+ i3 1)))
  (and (and (<= 0 temp___251) (<= temp___251 10)) (= o temp___251)))
  (= o24 (select (rec__step_function__step_function_t__step
  ...
  (= step_function__get_value__result3 (to_rep
                                       (rec__step_function__delimiter_entry__value
                                       (us_split_fields1
                                       (select (rec__step_function__step_function_t__step
                                               (us_split_fields3 sfun)) 
...
;; H
  (assert
  (= (mk___rep (mk___split_fields o17 o18)) (select (rec__step_function__step_function_t__step
                                                    (us_split_fields3 sfun)) 
  o16)))
...
;; H
  (assert
  (= o23 (ite (fp.eq (t__content step_function__get_value__result13) 
         o22) true false)))

;; H
  (assert (and (<= 0 (+ i1 1)) (<= (+ i1 1) 10)))
...
;; H
  (assert
  (= (mk___rep (mk___split_fields o9 o10)) (select (rec__step_function__step_function_t__step
                                                   (us_split_fields3 sfun)) 
  o8)))
...
;; H
  (assert (= o15 (ite (< x o14) true false)))
