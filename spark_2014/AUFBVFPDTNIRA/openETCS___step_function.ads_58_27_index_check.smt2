...
;; range_axiom
  (assert
  (forall ((x1 tnum_delimiters_rangeB)) (! (in_range1
  (to_rep3 x1)) :pattern ((to_rep3 x1)) )))

;; coerce_axiom
  (assert
  (forall ((x1 Int))
  (! (=> (in_range1 x1) (= (to_rep3 (of_rep3 x1)) x1)) :pattern ((to_rep3
                                                                 (of_rep3 x1))) )))
...
;; H
  ...
  (= temp___275 (- (to_rep1
                   (rec__step_function__step_function_t__number_of_delimiters
                   (us_split_fields3 sfun))) 1))
  (and (and (= result4 i13) (= i2 temp___274))
  (and (and (<= temp___274 i2) (<= i2 temp___275))
  (and (= temp___270 i2)
  (and
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j i3))
  ...
  (and
  (and
  (and (and (= temp___268 (+ i3 1)) (in_range1 (+ i3 1)))
  (and (and (<= 0 temp___268) (<= temp___268 10)) (= o temp___268)))
