...
;; H
  (assert (= o45 (bearing disttogoal)))

;; H
  (assert (= o46 (print o45)))

;; H
  (assert (dynamic_invariant1 o46 true false true true))
...
;; H
  (assert (= o49 (rec__gaps__gap__bearing o48)))

;; H
  (assert (= o50 (print o49)))

;; H
  (assert (dynamic_invariant1 o50 true false true true))

;; H
  (assert (= o54 (bearing disttogoal)))
...
;; H
  (assert (= o52 (us_split_fields5 o51)))

;; H
  (assert (= o53 (rec__gaps__gap__bearing o52)))

;; H
  (assert (= o55 (aldiff o53 o54)))

;; H
  (assert (fp.isFinite32 o55))

;; H
  (assert (fp.lt (fp.neg (fp #b0 #b10000000 #b10010010000111111011011))
  o55))

;; H
  (assert (fp.leq o55 (fp #b0 #b10000000 #b10010010000111111011011)))
...
;; H
  (assert (= o57 (us_split_fields5 o56)))

;; H
  (assert (= o58 (rec__gaps__gap__bearing o57)))

;; H
  (assert (= o59 (print o58)))

;; H
  (assert (dynamic_invariant1 o59 true false true true))
