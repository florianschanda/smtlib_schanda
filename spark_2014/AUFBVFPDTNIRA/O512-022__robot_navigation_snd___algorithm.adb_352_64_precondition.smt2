...
(declare-fun o40 () us_rep3)

(declare-fun o41 () us_split_fields6)
...
(define-fun o45 () us_rep3 (mk___rep3
                           (mk___split_fields3
...
;; H
  (assert
  (and
  (= o43 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep2
                                                                   (rec__robot_iface__proxy__scan_res
                                                                   (us_split_fields5
                                                                   (rec__algorithm__controller__robot
                                                                   (us_split_fields__content7
...
;; H
  (assert (= o38 (us_split_fields7 o37)))

;; H
  (assert (= o39 (rec__gaps__gap__bearing o38)))

;; H
  (assert
  (and (and (= o44 (ccwdiff o39 o42)) (ccwdiff__function_guard o44 o39 o42))
  (not (or (fp.isInfinite o44) (fp.isNaN o44)))))

;; H
  (assert (= result13 (ite (fp.lt o44 o43) true false)))
