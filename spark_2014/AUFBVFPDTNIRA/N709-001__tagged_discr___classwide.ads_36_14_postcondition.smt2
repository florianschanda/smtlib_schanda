...
;; classwide__u1__compat_axiom
  ...
  (! (=> (init__specific_post us_tag1 classwide__init__v__fields v__attr__tag
     classwide__init__v__old__fields)
     (= (is_zero__2 (mk___rep classwide__init__v__fields v__attr__tag)) true)) :pattern ((init__specific_post
...
;; classwide__u2__compat_axiom
  ...
  (! (=> (init__specific_post us_tag2 classwide__init__v__fields v__attr__tag
     classwide__init__v__old__fields)
     (= (is_zero__3
        (of_base (mk___rep classwide__init__v__fields v__attr__tag))) true)) :pattern ((init__specific_post
...
;; classwide__u1__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (is_zero__2 v)) (to_int1 (is_zero1 us_tag1 v))) :pattern (
  (is_zero1 us_tag1 v)) )))

;; classwide__u2__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (is_zero__3 (of_base v))) (to_int1 (is_zero1 us_tag2 v))) :pattern (
  (is_zero1 us_tag2 v)) )))
