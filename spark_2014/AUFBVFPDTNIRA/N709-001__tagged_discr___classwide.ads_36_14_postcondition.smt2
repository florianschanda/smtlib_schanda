...
(declare-fun init__specific_post (Int us_split_fields Int
  us_split_fields) Bool)

;; classwide__t__compat_axiom
  (assert
  (forall ((classwide__init__v__fields us_split_fields)
  (classwide__init__v__old__fields us_split_fields))
  (forall ((v__attr__tag Int))
  (! (=> (init__specific_post us_tag classwide__init__v__fields v__attr__tag
     classwide__init__v__old__fields)
     (and (is_zero__function_guard
     (is_zero (mk___rep classwide__init__v__fields v__attr__tag))
     (mk___rep classwide__init__v__fields v__attr__tag))
     (= (is_zero (mk___rep classwide__init__v__fields v__attr__tag)) true))) :pattern ((init__specific_post
  us_tag classwide__init__v__fields v__attr__tag
  classwide__init__v__old__fields)) ))))
...
;; classwide__u1__compat_axiom
  ...
  (classwide__init__v__old__fields us_split_fields))
  (forall ((v__attr__tag Int))
  (! (=> (init__specific_post us_tag1 classwide__init__v__fields v__attr__tag
     classwide__init__v__old__fields)
     (let ((temp___v_166 (mk___rep classwide__init__v__fields v__attr__tag)))
     (and (is_zero__2__function_guard (is_zero__2 temp___v_166) temp___v_166)
     (= (is_zero__2 temp___v_166) true)))) :pattern ((init__specific_post
  us_tag1 classwide__init__v__fields v__attr__tag
  classwide__init__v__old__fields)) ))))
...
;; classwide__u2__compat_axiom
  ...
  (classwide__init__v__old__fields us_split_fields))
  (forall ((v__attr__tag Int))
  (! (=> (init__specific_post us_tag2 classwide__init__v__fields v__attr__tag
     classwide__init__v__old__fields)
     (let ((temp___v_168 (of_base
                         (mk___rep classwide__init__v__fields v__attr__tag))))
     (and (is_zero__3__function_guard (is_zero__3 temp___v_168) temp___v_168)
     (= (is_zero__3 temp___v_168) true)))) :pattern ((init__specific_post
  us_tag2 classwide__init__v__fields v__attr__tag
  classwide__init__v__old__fields)) ))))
...
;; H
  (assert (init__specific_post v__attr__tag
...
(assert
;; WP_parameter_def
 ;; File "classwide.ads", line 31, characters 0-0
  (not
  (= (c_is_zero
     (mk___rep
     (mk___split_fields v__split_fields8 v__split_fields9 v__split_fields10
