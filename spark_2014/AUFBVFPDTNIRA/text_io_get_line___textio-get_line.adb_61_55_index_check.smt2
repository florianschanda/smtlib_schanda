...
;; H
  (assert (no_char_in_slice__function_guard
  (no_char_in_slice 10 cur_position (- o30 1) the_file) 10 cur_position
  (- o30 1) the_file))
...
;; H
  (assert
  (and
  (and (= o30 (find_char_in_slice 10 cur_position o29 the_file))
  (find_char_in_slice__function_guard o30 10 cur_position o29 the_file))
  (and (in_range2 o30)
  (and (and (<= cur_position o30) (<= o30 o29))
  (and (= (no_char_in_slice 10 cur_position (- o30 1) the_file) true)
  (= (to_rep (select the_file o30)) 10))))))
