...
(declare-fun user_eq1 (natural_float natural_float) Bool)
...
(declare-const dummy1 natural_float)

(declare-datatypes ((natural_float__ref 0))
(((mk_natural_float__ref (natural_float__content natural_float)))))
(define-fun natural_float__ref___projection ((a natural_float__ref)) natural_float
  (natural_float__content a))
