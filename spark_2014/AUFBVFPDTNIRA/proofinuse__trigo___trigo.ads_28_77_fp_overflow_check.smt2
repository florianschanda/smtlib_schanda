...
;; H
  (assert
  (and (and (= o15 (pow9 x)) (pow9__function_guard o15 x))
...
;; H
  (assert (and (= o13 o8) (not (or (fp.isInfinite o8) (fp.isNaN o8)))))

;; H
  (assert (= o14 (fp.add RNE o13 o12)))

;; H
  (assert (and (= o19 o14) (not (or (fp.isInfinite o14) (fp.isNaN o14)))))

;; H
  (assert (= o20 (fp.add RNE o19 o18)))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (not (or (fp.isInfinite o20) (fp.isNaN o20)))))
(check-sat)
