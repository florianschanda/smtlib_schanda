...
;; H
  ...
  (fp.lt (to_rep3
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content10 this__split_fields19))))) (t__content
...
;; H
  ...
  (= (attr__constrained
     ...
     (us_split_fields9
     (rec__algorithm__controller__robot
     (us_split_fields__content10 this__split_fields19))))) false)
  (= 1000 (to_rep11
          (rec__algorithm__gap_vectors__list__capacity
          (us_split_discrs5
          (rec__algorithm__controller__gapvec
          (us_split_fields__content10 this__split_fields19))))))))
...
;; H
  ...
  (fp.leq (fp.div RNE (to_rep3
                      ...
                      (us_split_fields9
                      (rec__algorithm__controller__robot
                      (us_split_fields__content10 this__split_fields19))))) (fp #b0 #b10000010 #b01000000000000000000000))
  (to_rep3
  (rec__robot_iface__proxy__obstacle_avoid_dist
  (us_split_fields9
  (rec__algorithm__controller__robot
...
;; H
  (assert
  (and
  (= o34 (fp.sub RNE (t__content disttoclosestobstacle12) (to_rep3
                                                          (rec__robot_iface__proxy__robot_radius
                                                          (us_split_fields9
                                                          (rec__algorithm__controller__robot
...
;; H
  (assert
  (= o35 (fp.mul RNE (fp #b0 #b10000000 #b10000000000000000000000) o34)))
...
;; H
  (assert (and (= o38 o37) (fp.isFinite32 o37)))

;; H
  (assert (= result13 (mk_t__ref safetydist)))

;; H
  (assert (= safetydist1 o38))

;; H
  (assert (= result14 this__split_fields19))

;; H
  (assert
  (= (let ((subject this__split_fields)) this__split_fields21) (mk___split_fields10
                                                               (rec__algorithm__controller__robot
                                                               (us_split_fields__content10
                                                               this__split_fields19))
                                                               (rec__algorithm__controller__laserscan
