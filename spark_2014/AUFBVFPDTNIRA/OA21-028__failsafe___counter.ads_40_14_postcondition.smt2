...
;; H
  (assert
  (=> (not (not (= input true)))
  (=> (bvult count ((_ int2bv 8) 10)) (= (mk_t__ref result1) count6))))
...
;; H
  (assert
  (=> (and (= input true) (bvult count2 ((_ int2bv 8) 10)))
  (= (current_chain_length inputs1) count2)))
...
;; WP_parameter_def
 ;; File "counter.ads", line 35, characters 0-0
  (not (= (current_chain_length inputs2) count4)))
(check-sat)
(exit)
