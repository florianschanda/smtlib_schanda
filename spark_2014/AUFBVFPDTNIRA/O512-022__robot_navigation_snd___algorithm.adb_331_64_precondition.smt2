...
(declare-fun o8 () us_split_fields6)

(declare-fun o9 () us_rep)

(declare-fun o10 () us_rep3)

(declare-fun o11 () us_split_fields6)
...
;; H
  (assert
  (and
  (= o13 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep2
                                                                   (rec__robot_iface__proxy__scan_res
                                                                   (us_split_fields5
                                                                   (rec__algorithm__controller__robot
                                                                   (let ((subject 
  ...
  (us_split_fields5
  (rec__algorithm__controller__robot
  (let ((subject this__split_fields)) this__split_fields1))))))) (fp.isNaN (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) 
  (to_rep2
  (rec__robot_iface__proxy__scan_res
  (us_split_fields5
  (rec__algorithm__controller__robot
...
;; H
  (assert
  (and (and (= o14 (ccwdiff o9 o12)) (ccwdiff__function_guard o14 o9 o12))
  (not (or (fp.isInfinite o14) (fp.isNaN o14)))))
...
;; H
  (assert (=> (= result4 true) (= o4 (us_split_fields7 o3))))

;; H
  (assert (=> (= result4 true) (= o5 (rec__gaps__gap__idir o4))))

;; H
  (assert (=> (= result4 true) (= o6 (to_rep9 o5))))
