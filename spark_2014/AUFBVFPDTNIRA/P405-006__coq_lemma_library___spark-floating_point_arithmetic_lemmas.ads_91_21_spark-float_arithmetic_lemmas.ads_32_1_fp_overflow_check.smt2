...
;; H
  (assert
  (fp.leq (fp.neg (fp #b0 #b10111110 #b00000000000000000000000)) val3))

;; H
  (assert (fp.leq val3 (fp #b0 #b00000000 #b00000000000000000000000)))

;; H
  (assert (fp.leq val1 val2))

;; H
  (assert (fp.isFinite32 (fp.mul RNE val1 val3)))
