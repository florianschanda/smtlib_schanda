...
;; H
  ...
  (olt (fp.abs o8) (fp #b0 #b10011000 #b00110001001111000100110)) (fp.abs 
  o8) (fp #b0 #b10011000 #b00110001001111000100110)))
...
;; H
  (assert (olt__function_guard
  (olt (fp.abs o9) (fp #b0 #b10011000 #b00110001001111000100110)) (fp.abs 
  o9) (fp #b0 #b10011000 #b00110001001111000100110)))
