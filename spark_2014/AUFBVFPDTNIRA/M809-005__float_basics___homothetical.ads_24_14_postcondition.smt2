...
;; H
  ...
  (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep
                                                       (select ka i13)))
  (neq (to_rep (select kvp2 i13))
  (fp #b0 #b00000000 #b00000000000000000000000))) (neq
  (to_rep (select d i13)) (fp #b0 #b00000000 #b00000000000000000000000))))))
