...
(declare-fun o13 () (Array Int float))
...
(declare-fun kvmax3 () map__ref)

(declare-fun kamax3 () map__ref)
...
(declare-fun kvmax4 () (Array Int float))

(declare-fun kamax4 () (Array Int float))
...
(declare-fun kvmax5 () map__ref)

(declare-fun kamax5 () map__ref)
...
(declare-fun kvmax6 () (Array Int float))

(declare-fun kamax6 () (Array Int float))
...
(declare-fun kvmax7 () map__ref)

(declare-fun kamax7 () map__ref)

(declare-fun lambda15 () map__ref)

(declare-fun upsilon15 () map__ref)

(declare-fun kvp4 () map__ref)
...
(declare-fun kvmax8 () (Array Int float))

(declare-fun kamax8 () (Array Int float))
...
;; H
  ...
  (and
  (and
  (not (fp.eq (to_rep (select d j15)) (fp #b0 #b00000000 #b00000000000000000000000)))
...
;; H
  ...
  (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep
                                                       (select ka i13)))
  (not (fp.eq (to_rep (select kvp2 i13)) (fp #b0 #b00000000 #b00000000000000000000000))))
  (not (fp.eq (to_rep (select d i13)) (fp #b0 #b00000000 #b00000000000000000000000)))))))
...
;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= temp___193 upsilon1)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= temp___191 kamax)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= temp___189 lambda1)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= temp___187 kvmax)))
...
;; H
  ...
  (=> (<= i4 temp___188)
  (= (select kvmax1 temp___188) (select temp___187 temp___188)))))
  (forall ((temp___190 Int))
  (=> (and (<= 1 temp___190) (<= temp___190 2))
  (=> (<= i4 temp___190)
  (= (select lambda2 temp___190) (select temp___189 temp___190))))))
  (forall ((temp___192 Int))
  (=> (and (<= 1 temp___192) (<= temp___192 2))
  (=> (<= i4 temp___192)
  (= (select kamax1 temp___192) (select temp___191 temp___192))))))
  (forall ((temp___194 Int))
  (=> (and (<= 1 temp___194) (<= temp___194 2))
  (=> (<= i4 temp___194)
  (= (select upsilon2 temp___194) (select temp___193 temp___194))))))
  (and (<= 1 i4) (<= i4 2)))))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= result4 (mk_int__ref j2))))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= j3 1)))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (= temp___183 upsilon2))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (= temp___181 lambda2))))
...
;; H
  ...
  (=> (not (= i4 j4))
  (and
  (= o1 (fp.mul RNE (to_rep (select kvp2 i4)) (fp.abs (to_rep (select d j4)))))
...
;; H
  ...
  (=> (not (= i4 j4))
  (and
  (= o (fp.mul RNE (to_rep (select kvp2 j4)) (fp.abs (to_rep (select d i4)))))
...
;; H
  ...
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (= o4 (fp.min (to_rep (select lambda3 i4)) o3))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (=> (not (= i4 j4)) (= (to_rep o5) o4)))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (= o6 (store lambda3 i4 o5))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (= result5 (mk_map__ref lambda3))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (=> (not (= i4 j4)) (= lambda4 o6)))))
...
;; H
  ...
  (=> (not (= i4 j4))
  (and
  (= o8 (fp.mul RNE (to_rep (select ka i4)) (fp.abs (to_rep (select d j4)))))
...
;; H
  ...
  (=> (not (= i4 j4))
  (and
  (= o7 (fp.mul RNE (to_rep (select ka j4)) (fp.abs (to_rep (select d i4)))))
...
;; H
  ...
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (= o11 (fp.min (to_rep (select upsilon3 i4)) o10))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (=> (not (= i4 j4)) (= (to_rep o12) o11)))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (= o13 (store upsilon3 i4 o12))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (= result6 (mk_map__ref upsilon3))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (=> (not (= i4 j4)) (= upsilon4 o13)))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (= upsilon5 (mk_map__ref upsilon4))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (= lambda5 (mk_map__ref lambda4))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (=> (not (= i4 j4)) (= upsilon6 upsilon4)))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (=> (not (= i4 j4)) (= lambda6 lambda4)))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (not (= i4 j4))) (= upsilon5 (mk_map__ref upsilon3))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (not (= i4 j4))) (= lambda5 (mk_map__ref lambda3))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (not (= i4 j4))) (= upsilon6 upsilon3)))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (not (= i4 j4))) (= lambda6 lambda3)))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2)) (=> (and (<= 1 j3) (<= j3 2)) (= j4 2))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (= j5 (mk_int__ref j4)))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (= upsilon7 upsilon5))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (= lambda7 lambda5))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2)) (=> (and (<= 1 j3) (<= j3 2)) (= j6 j4))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (= upsilon8 upsilon6))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (= lambda8 lambda6))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2)) (=> (and (<= 1 j3) (<= j3 2)) (= j7 j5))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (= upsilon9 upsilon7))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (= lambda9 lambda7))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2)) (=> (and (<= 1 j3) (<= j3 2)) (= j8 j6))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (= upsilon10 upsilon8))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (= lambda10 lambda8))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (not (and (<= 1 j3) (<= j3 2))) (= j7 (mk_int__ref j3)))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (not (and (<= 1 j3) (<= j3 2))) (= upsilon9 (mk_map__ref upsilon2)))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (not (and (<= 1 j3) (<= j3 2))) (= lambda9 (mk_map__ref lambda2)))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (not (and (<= 1 j3) (<= j3 2))) (= j8 j3))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (not (and (<= 1 j3) (<= j3 2))) (= upsilon10 upsilon2))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (not (and (<= 1 j3) (<= j3 2))) (= lambda10 lambda2))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (and
  (= o14 (fp.mul RNE (to_rep (select (map__content lambda9) i4)) (to_rep
                                                                 (select
                                                                 kvp2
                                                                 i4))))
  ...
  (to_rep (select (map__content lambda9) i4)) (to_rep (select kvp2 i4)))))))))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= (to_rep o15) o14)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= o16 (store kvmax1 i4 o15))))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= result7 (mk_map__ref kvmax1))))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= kvmax2 o16)))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (and
  (= o17 (fp.mul RNE (to_rep (select (map__content upsilon9) i4)) (to_rep
                                                                  (select
                                                                  ka
                                                                  i4))))
  (not (or (fp.isInfinite (fp.mul RNE (to_rep
  ...
  (to_rep (select (map__content upsilon9) i4)) (to_rep (select ka i4)))))))))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= (to_rep o18) o17)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= o19 (store kamax1 i4 o18))))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= result8 (mk_map__ref kamax1))))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= kamax2 o19)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= i4 2)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= j9 j7)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= i5 (mk_int__ref i4))))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= upsilon11 upsilon9)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= lambda11 lambda9)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= kamax3 (mk_map__ref kamax2))))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= kvmax3 (mk_map__ref kvmax2))))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= j10 j8)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= i6 i4)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= upsilon12 upsilon10)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= lambda12 lambda10)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= kamax4 kamax2)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= kvmax4 kvmax2)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= j11 j9)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= i7 i5)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= upsilon13 upsilon11)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= lambda13 lambda11)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= kamax5 kamax3)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= kvmax5 kvmax3)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= j12 j10)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= i8 i6)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= upsilon14 upsilon12)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= lambda14 lambda12)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= kamax6 kamax4)))

;; H
  (assert (=> (and (<= 1 i3) (<= i3 2)) (= kvmax6 kvmax4)))

;; H
  (assert (=> (not (and (<= 1 i3) (<= i3 2))) (= j11 (mk_int__ref j))))

;; H
  (assert (=> (not (and (<= 1 i3) (<= i3 2))) (= i7 (mk_int__ref i3))))

;; H
  (assert
  (=> (not (and (<= 1 i3) (<= i3 2))) (= upsilon13 (mk_map__ref upsilon1))))

;; H
  (assert
  (=> (not (and (<= 1 i3) (<= i3 2))) (= lambda13 (mk_map__ref lambda1))))

;; H
  (assert
  (=> (not (and (<= 1 i3) (<= i3 2))) (= kamax5 (mk_map__ref kamax))))

;; H
  (assert
  (=> (not (and (<= 1 i3) (<= i3 2))) (= kvmax5 (mk_map__ref kvmax))))

;; H
  (assert (=> (not (and (<= 1 i3) (<= i3 2))) (= j12 j1)))

;; H
  (assert (=> (not (and (<= 1 i3) (<= i3 2))) (= i8 i3)))

;; H
  (assert (=> (not (and (<= 1 i3) (<= i3 2))) (= upsilon14 upsilon1)))

;; H
  (assert (=> (not (and (<= 1 i3) (<= i3 2))) (= lambda14 lambda1)))

;; H
  (assert (=> (not (and (<= 1 i3) (<= i3 2))) (= kamax6 kamax)))

;; H
  (assert (=> (not (and (<= 1 i3) (<= i3 2))) (= kvmax6 kvmax)))
...
;; H
  (assert (= kamax7 kamax5))

;; H
  (assert (= kvmax7 kvmax5))
...
;; H
  (assert (= upsilon16 upsilon14))

;; H
  (assert (= lambda16 lambda14))

;; H
  (assert (= kamax8 kamax6))

;; H
  (assert (= kvmax8 kvmax6))
