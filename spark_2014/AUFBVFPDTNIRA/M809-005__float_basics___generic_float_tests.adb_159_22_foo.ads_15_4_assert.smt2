...
;; WP_parameter_def
 ;; File "generic_float_tests.adb", line 148, characters 0-0
  (not
  (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) (fp.div RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)
  x))))
(check-sat)
(exit)
