...
;; H
  (assert
  (= o81 (select (rec__step_function__step_function_t__step
                 (us_split_fields__content1 merge__split_fields19)) o80)))
...
;; H
  (assert
  (and (= o85 (get_value sfun2 o84))
  (and (fp.isFinite32 o85)
  (or
  (exists ((i3 Int))
  (and
  (and (<= 0 i3)
