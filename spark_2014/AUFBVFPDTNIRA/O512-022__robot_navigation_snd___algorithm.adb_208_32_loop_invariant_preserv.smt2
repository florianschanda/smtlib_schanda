...
;; H
  ...
  fmaxrange)))
  (= o (create__2
       (rec__algorithm__laser_scan_data__second rayr__split_fields1)
       (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields1))
       (- 1)))))
...
;; H
  ...
  (= o1 (create__2
        ...
        (to_rep4
        (rec__algorithm__laser_scan_data__first rayl__split_fields1)) 1)))))
...
;; WP_parameter_def
 ;; File "algorithm.adb", line 132, characters 0-0
  (not
  (< (length (mk___rep2 gapvec__split_discrs gapvec__split_fields2))
  i3)))
(check-sat)
(exit)
