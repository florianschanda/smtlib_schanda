...
;; H
  (assert
  (and (= o82 (get_value (mk___rep1 sfun4__split_fields2) i1))
  ...
  (<= (to_rep2
      ...
      (us_split_fields1
      (select (rec__step_function__step_function_t__step
              sfun4__split_fields2) i2)))) i1)
  (< i1 (to_rep2
        (rec__step_function__delimiter_entry__delimiter
        (us_split_fields1
        (select (rec__step_function__step_function_t__step
                sfun4__split_fields2) (+ i2 1)))))))
  (fp.eq o82 (to_rep
             (rec__step_function__delimiter_entry__value
             (us_split_fields1
             (select (rec__step_function__step_function_t__step
...
;; H
  (assert
  (and (= o81 (get_value (mk___rep1 sfun3__split_fields2) i1))
  ...
  (<= (to_rep2
      ...
      (us_split_fields1
      (select (rec__step_function__step_function_t__step
              sfun3__split_fields2) i2)))) i1)
  (< i1 (to_rep2
        (rec__step_function__delimiter_entry__delimiter
        (us_split_fields1
        (select (rec__step_function__step_function_t__step
                sfun3__split_fields2) (+ i2 1)))))))
  (fp.eq o81 (to_rep
             (rec__step_function__delimiter_entry__value
             (us_split_fields1
             (select (rec__step_function__step_function_t__step
