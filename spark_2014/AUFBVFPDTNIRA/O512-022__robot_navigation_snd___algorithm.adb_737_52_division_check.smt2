...
;; H
  (assert (= o52 (create__2 (fp #b0 #b01111111 #b10010010000111111011011))))

;; H
  (assert
  (= o53 (mk___split_fields10
         (rec__algorithm__controller__robot
         (let ((subject this__split_fields)) this__split_fields22))
         (rec__algorithm__controller__laserscan
         (let ((subject this__split_fields)) this__split_fields22))
         ...
         (let ((subject this__split_fields)) this__split_fields22))
         (rec__algorithm__controller__obsavoiddelta
         (let ((subject this__split_fields)) this__split_fields22)) o52)))

;; H
  (assert (= temp___974 (mk___rep10 o53)))

;; H
  (assert
  (= result19 (let ((subject this__split_fields))
              (mk___split_fields__ref10 this__split_fields22))))

;; H
  (assert
  (= (let ((subject this__split_fields)) this__split_fields24) (us_split_fields21
                                                               temp___974)))
