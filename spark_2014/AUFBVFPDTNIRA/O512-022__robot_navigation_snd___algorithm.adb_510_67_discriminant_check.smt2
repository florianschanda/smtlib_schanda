...
(declare-datatypes ((gap__ref 0)) (((mk_gap__ref (gap__content us_rep2)))))
...
(((mk_valley__ref (valley__content us_rep3)))))
...
(declare-datatypes ((gap_id__ref 0))
(((mk_gap_id__ref (gap_id__content gap_id)))))
...
(((mk_element_type__ref (element_type__content us_rep2)))))
...
(((mk_list__ref (list__content us_rep5)))))
...
(((mk_cursor__ref (cursor__content us_rep6)))))
...
(((mk_sequence__ref (sequence__content us_rep8)))))
...
(((mk_speed_option__ref (speed_option__content us_rep9)))))
...
(((mk_proxy__ref (proxy__content us_rep10)))))
...
(((mk_map__ref3 (map__content3 (Array Int us_rep11))))))
...
(((mk_controller__ref (controller__content us_rep12)))))
...
(((mk_t252s__ref (t252s__content us_rep9)))))
...
(declare-datatypes ((gap_id_pair__ref 0))
(((mk_gap_id_pair__ref (gap_id_pair__content us_rep13)))))
...
(((mk_t42b__ref (t42b__content us_rep13)))))
...
(((mk_t43b__ref (t43b__content us_rep13)))))
...
(((mk_t44b__ref (t44b__content us_rep13)))))
...
(((mk_t47b__ref (t47b__content us_rep13)))))
...
(((mk_t48b__ref (t48b__content us_rep13)))))
...
(((mk_t61b__ref (t61b__content us_rep4)))))
...
(((mk_t63b__ref (t63b__content us_rep4)))))
...
;; H
  (assert
  (=> (= result3 true)
  (= temp___868 (rec__algorithm__controller__gapvec (us_split_fields21 this)))))
...
;; H
  (assert
  (=> (= result3 true)
  (= temp___866 (mk___rep11 best_valley_ids__split_discrs1
...
;; H
  (assert
  (=> (= result3 true)
  (=> (= result7 true) (=> (= result8 true) (= usq_ temp___841)))))
...
;; H
  ...
  (=> (= result7 true)
  (=> (= result8 true)
  (= temp___843 (mk___rep11 (us_split_discrs7 usq_) (us_split_fields23 usq_)
...
;; H
  ...
  (=> (not (= result8 true))
  (=> (= (of_int1 0) true)
  (and (= o20 (print o19)) (dynamic_invariant1 o20 true false true)))))))
...
;; H
  ...
  (=> (not (= result12 true))
  (=> (= (of_int1 0) true)
  (and (= o45 (print o44)) (dynamic_invariant1 o45 true false true)))))))
...
;; H
  ...
  (=> (= (of_int1 0) true) (= o46 (bearing disttogoal)))))))
...
;; H
  ...
  (= (to_rep6
     ...
     best_valley_ids__split_discrs2)) 1)
  (=> (= (of_int1 0) true)
  (and (= o47 (print o46)) (dynamic_invariant1 o47 true false true)))))))
...
;; H
  ...
  (= (to_rep6
     ...
     best_valley_ids__split_discrs2)) 1)
  (=> (= (of_int1 0) true)
  (and (= o51 (print o50)) (dynamic_invariant1 o51 true false true)))))))
...
;; H
  ...
  (= (to_rep6
     (rec__algorithm__findbestvalley__gap_id_pair__opt
     best_valley_ids__split_discrs2)) 1)
  (=> (= (of_int1 0) true) (= o55 (bearing disttogoal)))))))
...
;; H
  ...
  (= (to_rep6
     ...
     best_valley_ids__split_discrs2)) 1)
  (=> (= (of_int1 0) true)
  (and (= o63 (print o62)) (dynamic_invariant1 o63 true false true)))))))
...
;; H
  ...
  (= (to_rep6
     (rec__algorithm__findbestvalley__gap_id_pair__opt
     best_valley_ids__split_discrs2)) 1)
  (=> (= (of_int1 0) true) (= o67 (bearing disttogoal)))))))
...
;; H
  ...
  (= (to_rep6
     ...
     best_valley_ids__split_discrs2)) 1)
  (=> (= result18 true)
  (= temp___865 (mk___rep11 (us_split_discrs7 usq_3)
...
;; H
  ...
  (= (to_rep6
     ...
     best_valley_ids__split_discrs2)) 1)
  (=> (= result18 true)
  (= best_valley_ids__split_fields4 (us_split_fields23 temp___865)))))))
...
;; H
  ...
  (= (to_rep6
     ...
     best_valley_ids__split_discrs2)) 1)
  (=> (= result18 true)
  (= best_valley_ids__split_discrs3 (us_split_discrs7 temp___865)))))))
...
;; H
  ...
  (= (to_rep6
     (rec__algorithm__findbestvalley__gap_id_pair__opt
     best_valley_ids__split_discrs2)) 1))
  (= temp___855 (mk___rep11 (us_split_discrs7 usq_4)
...
;; H
  ...
  (= (to_rep6
     (rec__algorithm__findbestvalley__gap_id_pair__opt
     best_valley_ids__split_discrs2)) 1))
  (= best_valley_ids__split_fields5 (us_split_fields23 temp___855))))))
...
;; H
  ...
  (= (to_rep6
     (rec__algorithm__findbestvalley__gap_id_pair__opt
     best_valley_ids__split_discrs2)) 1))
  (= best_valley_ids__split_discrs4 (us_split_discrs7 temp___855))))))
