...
;; H
  (assert (fp.leq x1 (fp #b0 #b11111101 #b11111111111111111111111)))

;; H
  (assert (fp.leq (fp.neg (fp #b0 #b11111101 #b11111111111111111111111))
  x1))

;; H
  (assert (fp.leq x2 (fp #b0 #b11111101 #b11111111111111111111111)))
...
;; WP_parameter_def
 ;; File "proof.ads", line 9, characters 0-0
  (not (fp.isFinite32 (fp.sub RNE x1 x2))))
(check-sat)
(exit)
