...
;; H
  (assert
  (ite (< 0 (to_fixed1 x)) (< (to_fixed1 x) (to_fixed1 z1))
  (ite (< (to_fixed1 x) 0) (< (to_fixed1 z1) (to_fixed1 x))
  (= (to_fixed1 z1) (to_fixed1 x)))))

(assert
;; WP_parameter_def
 ;; File "binary_fixed.adb", line 3, characters 0-0
  (not (in_range2 (+ (to_fixed1 x) 1280))))
(check-sat)
(exit)
