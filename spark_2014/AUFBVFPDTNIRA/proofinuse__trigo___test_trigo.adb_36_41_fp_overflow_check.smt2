...
;; H
  (assert (approx_tan__function_guard (approx_tan f23) f23))
...
;; H
  (assert
  (and (and (= o7 (tan1 f23)) (tan__function_guard o7 f23))
  (and (not (or (fp.isInfinite o7) (fp.isNaN o7)))
  (fp.lt (fp.abs (fp.sub RNE o7 (approx_tan f23))) (fp #b0 #b01110001 #b10100011011011100010111)))))
