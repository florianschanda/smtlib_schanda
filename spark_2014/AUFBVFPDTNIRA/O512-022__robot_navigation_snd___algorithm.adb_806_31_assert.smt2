...
;; H
  ...
  (and
  (= o66 (obsavoiddelta
         (mk___rep10 (us_split_fields__content10 this__split_fields31))
         safetydist1))
  (fp.isFinite32 o66)))

;; H
  (assert (= (to_rep2 o67) o66))

;; H
  (assert
  (= o68 (mk___split_fields10
         (rec__algorithm__controller__robot
         (us_split_fields__content10 this__split_fields31))
         (rec__algorithm__controller__laserscan
         (us_split_fields__content10 this__split_fields31))
         (rec__algorithm__controller__gapvec
         (us_split_fields__content10 this__split_fields31)) o67
         (rec__algorithm__controller__driveangle
         (us_split_fields__content10 this__split_fields31)))))

;; H
  (assert (= temp___983 (mk___rep10 o68)))

;; H
  (assert (= result26 this__split_fields31))

;; H
  (assert
  (= (let ((subject this__split_fields)) this__split_fields33) (us_split_fields21
                                                               temp___983)))
...
;; H
  ...
  (dynamic_invariant4 o69 true false true))))
...
;; H
  (assert (=> (= (of_int1 0) true) (= o71 (attr__ATTRIBUTE_IMAGE5 o70))))

;; H
  (assert (=> (= (of_int1 0) true) (= o72 (to_string o71))))
