...
(declare-fun o5 () us_split_fields20)

(declare-fun temp___1011 () us_rep10)
...
(declare-fun result2 () us_split_fields__ref10)
...
;; H
  ...
  (and
  (= o3 (obsavoiddelta
        (mk___rep10 (us_split_fields__content10 this__split_fields1))
        safetydist1))
  (obsavoiddelta__function_guard o3
  (mk___rep10 (us_split_fields__content10 this__split_fields1)) safetydist1))
...
;; H
  (assert
  (= o5 (mk___split_fields10
        (rec__algorithm__controller__robot
        (us_split_fields__content10 this__split_fields1))
        (rec__algorithm__controller__laserscan
        (us_split_fields__content10 this__split_fields1))
        (rec__algorithm__controller__gapvec
        (us_split_fields__content10 this__split_fields1)) o4
        (rec__algorithm__controller__driveangle
        (us_split_fields__content10 this__split_fields1)))))

;; H
  (assert (= temp___1011 (mk___rep10 o5)))
...
;; H
  ...
  (print__function_guard o6
  (rec__algorithm__controller__driveangle
  (let ((subject this__split_fields)) this__split_fields2))))
  (dynamic_invariant4 o6 true false true))))
