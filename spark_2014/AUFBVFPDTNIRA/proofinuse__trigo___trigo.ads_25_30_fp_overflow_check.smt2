...
;; pow4__post_axiom
  ...
  (forall ((x1 Float32))
  (! (=> (dynamic_invariant x1 true true true true) (dynamic_invariant
     (pow4 x1) true false true true)) :pattern ((pow4 x1)) )))
...
;; pow6__post_axiom
  ...
  (forall ((x1 Float32))
  (! (=> (dynamic_invariant x1 true true true true) (dynamic_invariant
     (pow6 x1) true false true true)) :pattern ((pow6 x1)) )))
...
;; pow8__post_axiom
  ...
  (forall ((x1 Float32))
  (! (=> (dynamic_invariant x1 true true true true) (dynamic_invariant
     (pow8 x1) true false true true)) :pattern ((pow8 x1)) )))
...
(declare-const trigo__cos__result Float32)
...
(declare-const trigo__cos__result1 Float32)

(declare-const trigo__cos__result2 Float32)

(declare-const trigo__cos__result3 Float32)

(declare-const trigo__cos__result4 Float32)

(declare-const trigo__cos__result5 Float32)
...
;; H
  (assert (= trigo__cos__result1 trigo__cos__result2))

;; H
  (assert (= trigo__cos__result3 trigo__cos__result1))
...
;; H
  (assert (= (mk_t__ref result) (mk_t__ref trigo__cos__result)))

;; H
  (assert (= trigo__cos__result1 o))

;; H
  (assert
  (= (mk_t__ref trigo__cos__result4) (mk_t__ref trigo__cos__result2)))

;; H
  (assert (= trigo__cos__result5 trigo__cos__result3))

;; H
  (assert
  (and (= o1 (approx_cos x))
  (and (fp.isFinite32 o1)
  (= o1 (fp.add RNE (fp.sub RNE (fp.add RNE (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) (fp.div RNE
  (pow21 x) (fp #b0 #b10000000 #b00000000000000000000000))) (fp.div RNE
  (pow4 x) (fp #b0 #b10000011 #b10000000000000000000000))) (fp.div RNE
  (pow6 x) (fp #b0 #b10001000 #b01101000000000000000000))) (fp.div RNE
  (pow8 x) (fp #b0 #b10001110 #b00111011000000000000000)))))))

;; H
  (assert (= o2 (fp.sub RNE trigo__cos__result4 o1)))

(assert
;; WP_parameter_def
 ;; File "/home/florian/adacore/spark2014/testsuite/gnatprove/tests/proofinuse__trigo/gnatprove/trigo.mlw", line 5412, characters 5-8
