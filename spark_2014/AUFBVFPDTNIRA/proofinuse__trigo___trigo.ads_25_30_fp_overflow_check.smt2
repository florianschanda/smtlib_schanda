...
(declare-fun trigo__cos__result () Float32)
...
(declare-fun trigo__cos__result1 () Float32)

(declare-fun trigo__cos__result2 () Float32)

(declare-fun trigo__cos__result3 () Float32)

(declare-fun trigo__cos__result4 () Float32)

(declare-fun trigo__cos__result5 () Float32)
...
;; H
  (assert (pow2__function_guard (pow21 x) x))

;; H
  (assert (pow4__function_guard (pow4 x) x))

;; H
  (assert (pow6__function_guard (pow6 x) x))

;; H
  (assert (pow8__function_guard (pow8 x) x))

;; H
  (assert
  (and (and (= o1 (approx_cos x)) (approx_cos__function_guard o1 x))
