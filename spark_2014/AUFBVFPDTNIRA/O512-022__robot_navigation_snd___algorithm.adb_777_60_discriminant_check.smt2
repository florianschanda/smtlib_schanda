...
;; H
  ...
  (and
  (= o63 (aldiff
         (mk___rep (us_split_fields__content midvalleyangle__split_fields4))
         ...
         (let ((subject pbestvalley__split_fields))
         pbestvalley__split_fields1))))))))
  (and (fp.isFinite32 o63)
  (and (fp.lt (fp.neg (fp #b0 #b10000000 #b10010010000111111011011))
  o63) (fp.leq o63 (fp #b0 #b10000000 #b10010010000111111011011))))))

;; H
  (assert (= o64 (fp.abs o63)))
