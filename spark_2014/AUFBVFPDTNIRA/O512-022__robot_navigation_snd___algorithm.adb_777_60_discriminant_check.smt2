...
(define-fun dynamic_invariant2 ((temp___expr_149 Float32)
...
(define-fun bool_eq10 ((x Float32)
  (y Float32)) Bool (ite (fp.eq x y) true false))
...
(define-fun bool_eq15 ((x Float32)
  (y Float32)) Bool (ite (fp.eq x y) true false))
...
(define-fun dynamic_invariant14 ((temp___expr_167 Float32)
...
(define-fun dynamic_invariant15 ((temp___expr_179 Float32)
...
(declare-fun pbestvalley__split_fields () us_split_fields__ref7)
...
(declare-fun algorithm__step__B_18__safetydeltaangle__assume () us_rep)
...
(declare-fun pbestvalley__split_fields1 () us_split_fields14)

(declare-fun pbestvalley__split_discrs1 () us_split_discrs2)

(declare-fun result2 () Bool)

(declare-fun midvalleyangle__split_fields2 () us_split_fields__ref)
...
;; H
  ...
  (not (or (fp.isInfinite (fp.sub RNE (to_rep3
                                      ...
                                      (us_split_fields9
                                      (rec__algorithm__controller__robot
                                      (let ((subject this__split_fields))
                                      this__split_fields1))))) (to_rep3
                                                               ...
                                                               (let ((subject 
                                                               this__split_fields))
                                                               this__split_fields1))))))) (fp.isNaN (fp.sub RNE 
  (to_rep3
  (rec__robot_iface__proxy__max_range
  (us_split_fields9
  (rec__algorithm__controller__robot
  (let ((subject this__split_fields)) this__split_fields1))))) (to_rep3
                                                               (rec__robot_iface__proxy__robot_radius
                                                               (us_split_fields9
                                                               (rec__algorithm__controller__robot
                                                               (let ((subject 
...
;; H
  ...
  (rec__algorithm__controller__robot
  (let ((subject this__split_fields)) this__split_fields1)))))))
  (not (or (fp.isInfinite (fp.add RNE (to_rep3
                                      (rec__robot_iface__proxy__obstacle_avoid_dist
                                      (us_split_fields9
                                      (rec__algorithm__controller__robot
                                      (let ((subject this__split_fields))
                                      this__split_fields1))))) (to_rep3
                                                               ...
                                                               (let ((subject 
                                                               this__split_fields))
                                                               this__split_fields1))))))) (fp.isNaN (fp.add RNE 
  (to_rep3
  (rec__robot_iface__proxy__obstacle_avoid_dist
  (us_split_fields9
  (rec__algorithm__controller__robot
...
;; H
  ...
  (= o8 (arctan o7
        ...
        (us_split_fields13
        (rec__algorithm__valley_option__value
        (let ((subject pbestvalley__split_fields))
        pbestvalley__split_fields1))))))))))
  (arctan__function_guard o8 o7
  (fp.max (to_rep3
          (rec__robot_iface__proxy__robot_radius
          (us_split_fields9
          (rec__algorithm__controller__robot
  ...
  (us_split_fields13
  (rec__algorithm__valley_option__value
  (let ((subject pbestvalley__split_fields)) pbestvalley__split_fields1))))))))))
  (and (not (or (fp.isInfinite o8) (fp.isNaN o8)))
  (=>
  (and
  (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (fp.max (to_rep3
                                                               (rec__robot_iface__proxy__robot_radius
                                                               (us_split_fields9
                                                               (rec__algorithm__controller__robot
                                                               (let ((subject 
...
;; H
  (assert
  (and (= algorithm__step__B_18__safetydeltaangle__assume (create__2 o8))
  (create__2__function_guard algorithm__step__B_18__safetydeltaangle__assume
  o8)))

;; H
  (assert
  (= algorithm__step__B_18__safetydeltaangle__assume safetydeltaangle))
...
;; H
  ...
  (= (to_rep10
     (rec__algorithm__valley_option__opt
     (let ((subject pbestvalley__split_discrs)) pbestvalley__split_discrs1))) 1)))
...
;; H
  ...
  (and
  (= o9 (aldiff
        (mk___rep (us_split_fields__content midvalleyangle__split_fields2))
  ...
  o9) (fp.leq o9 (fp #b0 #b10000000 #b10010010000111111011011))))))

;; H
  (assert (= o10 (fp.abs o9)))
