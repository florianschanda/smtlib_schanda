...
(declare-fun dummy5 () minute_type)
...
(declare-fun dummy6 () second_type)
...
(define-fun bool_eq3 ((a (Array Int character)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (to_rep6 (select a temp___idx_78)) (to_rep6
...
(declare-fun dummy11 () description_count_type)
...
(declare-fun dummy13 () event_index_type)
...
(declare-fun dummy14 () event_count_type)
...
(define-fun dynamic_invariant5 ((temp___expr_142 Int)
  ...
  (temp___do_toplevel_141 Bool)) Bool (=>
                                      ...
                                      (<= 1 12)) (in_range2 temp___expr_142)))
...
(define-fun dynamic_invariant6 ((temp___expr_148 Int)
  ...
  (temp___do_toplevel_147 Bool)) Bool (=>
                                      ...
                                      (<= 1 31)) (in_range3 temp___expr_148)))
...
;; H
  (assert
  (and (and (=> (<= 0 64) (in_range10 count2)) (=> (<= 1 64) (in_range9 i2)))
  (and (<= 1 i2) (<= i2 64))))

;; H
  (assert
  (= (rec__datebooks__event_record__is_used
     (us_split_fields7 (select book i2))) true))

(assert
;; WP_parameter_def
 ;; File "datebooks.ads", line 20, characters 0-0
  (not (in_range10 (+ count2 1))))
(check-sat)
(exit)
