...
(declare-fun temp___986 () us_rep7)
...
;; H
  (assert
  (and
  (= temp___986 (findbestvalley
                (mk___rep10
                (let ((subject this__split_fields)) this__split_fields2))
                (mk___rep1 disttogoal__split_fields)))
  (findbestvalley__function_guard temp___986
  (mk___rep10 (let ((subject this__split_fields)) this__split_fields2))
  (mk___rep1 disttogoal__split_fields))))
...
;; WP_parameter_def
 ;; File "algorithm.ads", line 107, characters 0-0
  (not
  (= (rec__algorithm__valley_option__opt (us_split_discrs3 temp___986)) 
  (rec__algorithm__valley_option__opt
  (us_split_discrs__content1 pbestvalley__split_discrs)))))
(check-sat)
