...
(((mk_input_t__ref (input_t__content input_t)))))
...
(((mk_scale_t__ref (scale_t__content scale_t)))))
...
(((mk_output_t__ref (output_t__content output_t)))))
...
;; H
  ...
  (fp.isFinite32 (fp.sub RNE x1 (fp #b0 #b10000011 #b01000000000000000000000))))))
...
;; H
  (assert
  (=> (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) x1) (= x2 o)))

;; H
  (assert
  (=> (not (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) x1))
  (= x2 x1)))
...
;; H
  (assert
  (and (= o1 (fp.div RNE x2 scale)) (fp.isFinite32 (fp.div RNE x2 scale))))
...
;; H
  (assert
  (not (fp.leq x3 (fp.neg (fp #b0 #b10000100 #b00000000000000000000000)))))
