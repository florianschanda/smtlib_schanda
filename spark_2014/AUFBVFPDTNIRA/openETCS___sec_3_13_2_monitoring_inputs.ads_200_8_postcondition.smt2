...
;; H
  (assert
  (= o10 (temp_____aggregate_def_165 (mk___rep (mk___split_fields o8 o9))
...
;; H
  (assert
  (and (= o14 (get_value kwet_rst_model o13))
  ...
  (<= (to_rep2
      ...
      (select (rec__step_function__step_function_t__step
              (us_split_fields3 kwet_rst_model)) i)))) o13)
  (< o13 (to_rep2
         (rec__step_function__delimiter_entry__delimiter
         (us_split_fields1
         (select (rec__step_function__step_function_t__step
...
;; H
  (assert (= sec_3_13_2_monitoring_inputs__kwet_rst__result1 o14))
...
;; WP_parameter_def
 ;; File "/home/florian/adacore/spark2014/testsuite/gnatprove/tests/openETCS/gnatprove/sec_3_13_2_monitoring_inputs.mlw", line 7290, characters 5-8
  (not
  (fp.eq sec_3_13_2_monitoring_inputs__kwet_rst__result4 (get_value
                                                         kwet_rst_model
