...
;; H
  (assert
  (and (= o26 (low_bound o25))
  (and (fp.isFinite64 o26)
  (= o26 (fp.mul RNE (of_int RNE o25) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))))

;; H
  (assert
  (and (= o23 (low_bound n))
  (and (fp.isFinite64 o23)
  (= o23 (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))))
