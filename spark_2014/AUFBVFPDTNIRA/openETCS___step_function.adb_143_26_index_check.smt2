...
;; H
  (assert
  (= o45 (select (rec__step_function__step_function_t__step
                 merge__split_fields3) o44)))

;; H
  (assert (= o46 (us_split_fields1 o45)))

;; H
  (assert (= o47 (rec__step_function__delimiter_entry__delimiter o46)))

;; H
  (assert (= o48 (to_rep2 o47)))

;; H
  (assert
  (and (= o49 (get_value sfun2 o48))
  ...
  (<= (to_rep2
      ...
      (us_split_fields1
      (select (rec__step_function__step_function_t__step
              (us_split_fields3 sfun2)) i30)))) o48)
  (< o48 (to_rep2
         (rec__step_function__delimiter_entry__delimiter
         (us_split_fields1
         (select (rec__step_function__step_function_t__step
...
;; H
  (assert
  (= o39 (select (rec__step_function__step_function_t__step
...
;; H
  (assert (= o41 (rec__step_function__delimiter_entry__delimiter o40)))

;; H
  (assert (= o42 (to_rep2 o41)))

;; H
  (assert
  (and (= o43 (get_value sfun1 o42))
  ...
  (<= (to_rep2
      ...
      (us_split_fields1
      (select (rec__step_function__step_function_t__step
              (us_split_fields3 sfun1)) i30)))) o42)
  (< o42 (to_rep2
         (rec__step_function__delimiter_entry__delimiter
         (us_split_fields1
         (select (rec__step_function__step_function_t__step
...
;; H
  (assert
  (and (= o50 (min o43 o49))
  (and (fp.isFinite32 o50)
  (ite (fp.leq o43 o49) (fp.eq o50 o43) (fp.eq o50 o49)))))
