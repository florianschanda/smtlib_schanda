...
(declare-fun o12 () function_range)
...
;; H
  (assert
  (= o16 (select (rec__step_function__step_function_t__step
                 merge__split_fields3) o15)))

;; H
  (assert (= o17 (us_split_fields1 o16)))

;; H
  (assert (= o18 (rec__step_function__delimiter_entry__delimiter o17)))
...
;; H
  (assert
  (and
  (and (= o20 (get_value sfun2 o19)) (get_value__function_guard o20 sfun2
  o19))
...
;; H
  (assert
  (= o10 (select (rec__step_function__step_function_t__step
                 merge__split_fields3) o9)))

;; H
  (assert (= o11 (us_split_fields1 o10)))

;; H
  (assert (= o12 (rec__step_function__delimiter_entry__delimiter o11)))
...
;; H
  (assert
  (and
  (and (= o14 (get_value sfun1 o13)) (get_value__function_guard o14 sfun1
  o13))
...
;; H
  (assert
  (and (and (= o21 (min o14 o20)) (min__function_guard o21 o14 o20))
  (and (not (or (fp.isInfinite o21) (fp.isNaN o21)))
  (ite (fp.leq o14 o20) (fp.eq o21 o14) (fp.eq o21 o20)))))
