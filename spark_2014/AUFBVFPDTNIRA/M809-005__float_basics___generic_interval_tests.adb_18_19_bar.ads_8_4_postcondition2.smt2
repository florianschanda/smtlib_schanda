...
;; H
  (assert (fp.leq (fp #b0 #b10000001 #b01000000000000000000000) y))

;; H
  (assert (fp.leq y (fp #b0 #b10000010 #b01000000000000000000000)))
...
(assert
;; WP_parameter_def
 ;; File "generic_interval_tests.adb", line 8, characters 0-0
  (not (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) z2)))
(check-sat)
(exit)
