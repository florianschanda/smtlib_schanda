...
;; H
  (assert
  (and
  (= (mk___rep1 (mk___split_discrs1 main__x__assume)
     (mk___split_fields1
     (mk___rep (mk___split_discrs main__x__assume1)
     (mk___split_fields main__x__assume2 main__x__assume3)))) (build_rec 2))
  (= (to_rep main__x__assume) (to_rep3 main__x__assume1))))

;; H
  (assert
  (= result (mk___split_fields__ref1
            (mk___split_fields1
            (mk___rep (mk___split_discrs x__split_fields)
            (mk___split_fields x__split_fields1 x__split_fields2))))))

;; H
  (assert
  (= x__split_fields3 (mk___split_fields1
                      (mk___rep (mk___split_discrs main__x__assume1)
                      (mk___split_fields main__x__assume2 main__x__assume3)))))
...
;; H
  (assert
  (= (to_rep (rec__rec__sub_rec__z x__split_discrs)) (to_rep3
                                                     (rec__rec__my_rec__e
                                                     (us_split_discrs1
