...
(declare-datatypes ((t2s__ref 0)) (((mk_t2s__ref (t2s__content us_rep)))))
(define-fun t2s__ref___projection ((a t2s__ref)) us_rep (t2s__content a))

(declare-datatypes ((us_split_discrs4 0))
(((mk___split_discrs2 (rec__rec__sub_rec_ok__z enum)))))
...
(((mk___split_fields2 (rec__rec__sub_rec_ok__plop us_rep)))))
...
(((mk_sub_rec_ok__ref (sub_rec_ok__content us_rep2)))))
...
(((mk___split_fields3 (rec__rec__sub_arr__content us_t)))))
...
(((mk_sub_arr__ref (sub_arr__content us_rep3)))))
