...
;; H
  (assert
  (= result10 (ite (fp.lt (fp #b0 #b10000000 #b10010010000111111011011)
              o36) true false)))

;; H
  (assert
  (=> (= result10 true)
  (= o38 (fp.sub RNE o37 (fp #b0 #b10000001 #b10010010000111111011011)))))

;; H
  (assert
  (=> (= result10 true)
  (and (= o39 o38) (not (or (fp.isInfinite o38) (fp.isNaN o38))))))

;; H
  (assert (=> (= result10 true) (= theta1 o39)))

;; H
  (assert (=> (= result10 true) (= theta3 theta1)))

;; H
  (assert (=> (not (= result10 true)) (= theta2 o40)))

;; H
  (assert (=> (not (= result10 true)) (= theta3 theta2)))
