...
;; H
  (assert
  (and (= o141 (get_value sfun1 o140))
  (and (fp.isFinite32 o141)
  (or
  (exists ((i30 Int))
  (and
  (and (<= 0 i30)
  ...
  (<= (to_rep2
      ...
      (us_split_fields1
      (select (rec__step_function__step_function_t__step
              (us_split_fields3 sfun1)) i30)))) o140)
  (< o140 (to_rep2
          (rec__step_function__delimiter_entry__delimiter
          (us_split_fields1
          (select (rec__step_function__step_function_t__step
...
;; H
  (assert
  (and (= o148 (min o141 o147))
  (and (fp.isFinite32 o148)
  (ite (fp.leq o141 o147) (fp.eq o148 o141) (fp.eq o148 o147)))))
