...
(declare-fun o79 () function_range)
...
(declare-fun o85 () function_range)
...
(declare-fun im3 () int__ref)

(declare-fun im4 () Int)

(declare-fun merge__split_fields14 () us_split_fields__ref1)

(declare-fun i16 () int__ref)

(declare-fun i26 () int__ref)

(declare-fun im5 () int__ref)

(declare-fun scan_sfun16 () bool__ref)

(declare-fun scan_sfun26 () bool__ref)

(declare-fun merge__split_fields15 () us_split_fields2)
...
(declare-fun merge__split_fields16 () us_split_fields__ref1)

(declare-fun i18 () int__ref)

(declare-fun i28 () int__ref)

(declare-fun im7 () int__ref)

(declare-fun scan_sfun18 () bool__ref)

(declare-fun scan_sfun28 () bool__ref)

(declare-fun merge__split_fields17 () us_split_fields2)
...
(declare-fun scan_sfun19 () Bool)

(declare-fun scan_sfun29 () Bool)

(declare-fun result16 () us_split_fields__ref1)

(declare-fun merge__split_fields18 () us_split_fields2)

(declare-fun merge__split_fields19 () us_split_fields__ref1)

(declare-fun i110 () int__ref)

(declare-fun i210 () int__ref)

(declare-fun im9 () int__ref)

(declare-fun scan_sfun110 () bool__ref)

(declare-fun scan_sfun210 () bool__ref)

(declare-fun merge__split_fields20 () us_split_fields2)

(declare-fun i111 () Int)

(declare-fun i211 () Int)

(declare-fun im10 () Int)

(declare-fun scan_sfun111 () Bool)
...
;; H
  (assert
  (forall ((i3 Int)) (get_value__function_guard
  (get_value sfun1
  (to_rep2
  (rec__step_function__delimiter_entry__delimiter
  (us_split_fields1
...
;; H
  (assert
  (forall ((i3 Int)) (min__function_guard
  (min
  (get_value sfun1
  (to_rep2
  (rec__step_function__delimiter_entry__delimiter
     ...
     (select (rec__step_function__step_function_t__step
             (us_split_fields3 sfun1)) i12)))) (to_rep2
                                               ...
                                               (select (rec__step_function__step_function_t__step
                                                       (us_split_fields3
                                                       sfun2)) i22)))))
  (and (and (= o16 (min o14 o15)) (min__function_guard o16 o14 o15))
     ...
     (select (rec__step_function__step_function_t__step
             (us_split_fields3 sfun2)) i22)))) (to_rep2
                                               ...
                                               (select (rec__step_function__step_function_t__step
                                                       (us_split_fields3
                                                       sfun1)) i12)))))
  (and (and (= o29 (min o27 o28)) (min__function_guard o29 o27 o28))
     ...
     (select (rec__step_function__step_function_t__step
             (us_split_fields3 sfun2)) i22)))) (to_rep2
                                               ...
                                               (select (rec__step_function__step_function_t__step
                                                       (us_split_fields3
                                                       sfun1)) i12))))))
  (and (and (= o42 (min o40 o41)) (min__function_guard o42 o40 o41))
...
;; H
  ...
  (=> (not (and (= scan_sfun12 true) (= scan_sfun22 true)))
  (=> (= scan_sfun12 true)
  (and (and (= o55 (min o53 o54)) (min__function_guard o55 o53 o54))
...
;; H
  ...
  (=> (not (and (= scan_sfun12 true) (= scan_sfun22 true)))
  (=> (not (= scan_sfun12 true))
  (and (and (= o68 (min o66 o67)) (min__function_guard o68 o66 o67))
...
;; H
  (assert
  (= o83 (select (rec__step_function__step_function_t__step
                 (us_split_fields__content1 merge__split_fields19)) o82)))

;; H
  (assert (= o84 (us_split_fields1 o83)))

;; H
  (assert (= o85 (rec__step_function__delimiter_entry__delimiter o84)))

;; H
  (assert (= o86 (to_rep2 o85)))

;; H
  (assert
  (and
  (and (= o87 (get_value sfun2 o86)) (get_value__function_guard o87 sfun2
  o86))
...
;; H
  (assert
  (= o77 (select (rec__step_function__step_function_t__step
                 (us_split_fields__content1 merge__split_fields19)) o76)))
...
;; H
  (assert
  (and
  (and (= o81 (get_value sfun1 o80)) (get_value__function_guard o81 sfun1
  o80))
...
;; H
  (assert
  (and (and (= o88 (min o81 o87)) (min__function_guard o88 o81 o87))
