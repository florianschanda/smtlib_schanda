...
;; H
  (assert
  (= o82 (select (rec__step_function__step_function_t__step
                 (us_split_fields__content1 merge__split_fields19)) o81)))
...
;; H
  (assert
  (and (= o86 (get_value sfun2 o85))
  (and (fp.isFinite32 o86)
  (or
  (exists ((i3 Int))
  (and
  (and (<= 0 i3)
...
;; H
  (assert
  (= o76 (select (rec__step_function__step_function_t__step
                 (us_split_fields__content1 merge__split_fields19)) o75)))
...
;; H
  (assert
  (and (= o80 (get_value sfun1 o79))
  (and (fp.isFinite32 o80)
  (or
  (exists ((i3 Int))
  (and
  (and (<= 0 i3)
...
;; H
  ...
  (ite (fp.leq o80 o86) (fp.eq o87 o80) (fp.eq o87 o86)))))
