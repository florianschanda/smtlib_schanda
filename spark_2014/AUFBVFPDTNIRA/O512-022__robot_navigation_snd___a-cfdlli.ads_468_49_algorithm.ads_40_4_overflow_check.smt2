...
(define-fun default_initial_assumption ((temp___expr_466 us_rep1)
  (temp___skip_top_level_467 Bool)) Bool (= (to_rep
                                            (rec__algorithm__gap_vectors__cursor__node
                                            (us_split_fields3
                                            temp___expr_466))) 0))
...
(define-fun default_initial_assumption1 ((temp___expr_529 us_rep2)
  (temp___skip_top_level_530 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_530 true))
                                         (and
                                         (= (is_empty temp___expr_529) true)
                                         (= (length1 temp___expr_529) 0))))

(declare-fun get (us_rep2 us_rep1) Int)

(declare-fun get__function_guard (Int us_rep2 us_rep1) Bool)

(define-fun default_initial_assumption2 ((temp___expr_515 us_rep1)
  (temp___skip_top_level_516 Bool)) Bool (= (to_rep
                                            (rec__algorithm__gap_vectors__cursor__node
                                            (us_split_fields3
                                            temp___expr_515))) 0))
...
(define-fun element_type__ref___3__projection ((a element_type__ref1)) element_type
...
(declare-const temp___783 count_type)
...
;; H
  (assert (= temp___783 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___783)) no_element))
