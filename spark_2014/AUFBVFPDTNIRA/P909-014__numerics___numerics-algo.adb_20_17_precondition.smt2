...
;; H
  (assert
  (and
  (and (= o4 (odivide (fp #b0 #b01111111 #b00000000000000000000000) o3))
  (odivide__function_guard o4 (fp #b0 #b01111111 #b00000000000000000000000)
  o3))
...
;; WP_parameter_def
 ;; File "numerics-algo.ads", line 10, characters 0-0
  (not (neq x (fp #b0 #b00000000 #b00000000000000000000000))))
(check-sat)
