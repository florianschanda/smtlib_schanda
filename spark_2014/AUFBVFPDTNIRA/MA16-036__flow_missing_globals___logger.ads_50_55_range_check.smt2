...
(declare-fun dummy9 () log_index)

(declare-datatypes ()
((tTresultSP1__ref (mk_tTresultSP1__ref (tTresultSP1__content log_index)))))
...
(declare-datatypes ()
((us_t1 (mk___t1 (elts1 (Array (_ BitVec 16) us_rep))(rt1 t1)))))
...
(declare-fun result____last () log_index)
...
(declare-datatypes ()
((us_t2 (mk___t2 (elts2 (Array (_ BitVec 16) us_rep))(rt2 t2)))))
...
(declare-datatypes ()
((us_t3 (mk___t3 (elts3 (Array (_ BitVec 16) us_rep))(rt3 t3)))))
...
(declare-datatypes ()
((us_t4 (mk___t4 (elts4 (Array (_ BitVec 16) us_rep))(rt4 t4)))))
...
(declare-fun event_log__split_fields1 () log_index)

(declare-fun event_log__split_fields2 () log_index)

(declare-fun event_log__split_fields3 () Bool)

(declare-fun result__ () (Array (_ BitVec 16) us_rep))

(declare-fun logger__log_content__result () (Array (_ BitVec 16) us_rep))

(declare-fun logger__log_content__result1 () t)

(declare-fun o () unsigned_16)
...
(declare-fun o5 () (Array (_ BitVec 16) us_rep))

(declare-fun o6 () (Array (_ BitVec 16) us_rep))
...
(declare-fun o11 () (Array (_ BitVec 16) us_rep))

(declare-fun temp___282 () (Array (_ BitVec 16) us_rep))

(declare-fun temp___2821 () t2)

(declare-fun temp___283 () (Array (_ BitVec 16) us_rep))

(declare-fun temp___2831 () t1)

(declare-fun o12 () (Array (_ BitVec 16) us_rep))

(declare-fun o13 () t1)

(declare-fun o14 () (Array (_ BitVec 16) us_rep))

(declare-fun o15 () (Array (_ BitVec 16) us_rep))

(declare-fun temp___278 () (Array (_ BitVec 16) us_rep))

(declare-fun temp___2781 () t4)

(declare-fun o16 () (Array (_ BitVec 16) us_rep))
...
(declare-fun temp___279 () (Array (_ BitVec 16) us_rep))

(declare-fun temp___2791 () t)

(declare-fun temp___280 () (Array (_ BitVec 16) us_rep))

(declare-fun temp___2801 () t1)

(declare-fun o24 () (Array (_ BitVec 16) us_rep))

(declare-fun o25 () t1)

(declare-fun o26 () (Array (_ BitVec 16) us_rep))

(declare-fun o27 () Int)

(declare-fun o28 () Int)

(declare-fun result__1 () (Array (_ BitVec 16) us_rep))

(declare-fun result () (Array (_ BitVec 16) us_rep))

(declare-fun result1 () t)

(declare-fun logger__log_content__result2 () (Array (_ BitVec 16) us_rep))

(declare-fun logger__log_content__result3 () t)

(declare-fun result2 () (Array (_ BitVec 16) us_rep))

(declare-fun result__2 () (Array (_ BitVec 16) us_rep))

(declare-fun result3 () (Array (_ BitVec 16) us_rep))

(declare-fun result__3 () (Array (_ BitVec 16) us_rep))

(declare-fun result4 () log_array__ref)

(declare-fun logger__log_content__result4 () us_t)

(declare-fun result__4 () map__ref)

(declare-fun logger__log_content__result5 () log_array__ref)

(declare-fun result__5 () (Array (_ BitVec 16) us_rep))

(declare-fun logger__log_content__result6 () us_t)

(declare-fun result__6 () map__ref)

(declare-fun logger__log_content__result7 () log_array__ref)

(declare-fun result__7 () (Array (_ BitVec 16) us_rep))

(declare-fun logger__log_content__result8 () us_t)

(declare-fun result__8 () map__ref)

(declare-fun logger__log_content__result9 () log_array__ref)

(declare-fun result__9 () (Array (_ BitVec 16) us_rep))

(declare-fun logger__log_content__result10 () us_t)

(define-fun logger__log_content__result11 () us_t (mk___t
                                                  logger__log_content__result2
                                                  logger__log_content__result3))

(define-fun o29 () us_rep (mk___rep (mk___split_fields o o1 o2 o3 o4)))
...
;; H
  ...
  (and
  (and
  (= o29 (make_entry ((_ int2bv 16) 0) ((_ int2bv 16) 0) ((_ int2bv 16) 0)
         (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)
         (of_int1 0)))
  (make_entry__function_guard o29 ((_ int2bv 16) 0) ((_ int2bv 16) 0)
  ((_ int2bv 16) 0)
  (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)
  (of_int1 0)))
...
;; H
  (assert (=> (= event_log__split_fields3 true) (= o5 (temp___287 o29))))
...
;; H
  ...
  (log_size__function_guard o8
  (mk___split_fields1 event_log__split_fields event_log__split_fields1
  event_log__split_fields2 event_log__split_fields3)))
  (and (in_range4 o8)
  (= o8 (ite (= event_log__split_fields3 true) 0
        (+ (bv2nat (let ((temp___240 (bvsub (to_rep2
...
;; H
  (assert (=> (not (= event_log__split_fields3 true)) (in_range2 tmp)))
...
;; H
  ...
  (bvule (to_rep2 event_log__split_fields1) (to_rep2
                                            event_log__split_fields2))
  (= (ite (<= (bv2nat (to_rep2 (first5 temp___2821))) (bv2nat (to_rep2
                                                              (last6
                                                              temp___2821))))
     (+ (- (bv2nat (to_rep2 (last6 temp___2821))) (bv2nat (to_rep2
                                                          (first5
                                                          temp___2821)))) 1)
...
;; H
  ...
  (bvule (to_rep2 event_log__split_fields1) (to_rep2
                                            event_log__split_fields2))
  (= (slide temp___282 (to_rep2 (first5 temp___2821)) ((_ int2bv 16) 0)) 
  temp___283))))
...
;; H
  ...
  (bvule (to_rep2 event_log__split_fields1) (to_rep2
                                            event_log__split_fields2))
  (= (mk1 ((_ int2bv 16) 0) tmp) temp___2831))))
...
;; H
  ...
  (bvule (to_rep2 event_log__split_fields1) (to_rep2
                                            event_log__split_fields2))
  (= (ite (<= (bv2nat (to_rep2 (first2 temp___2831))) (bv2nat (to_rep2
                                                              (last3
                                                              temp___2831))))
     (+ (- (bv2nat (to_rep2 (last3 temp___2831))) (bv2nat (to_rep2
                                                          (first2
                                                          temp___2831)))) 1)
...
;; H
  ...
  (bvule (to_rep2 event_log__split_fields1) (to_rep2
                                            event_log__split_fields2))
  (= (mk___t1 o12 o13) (mk___t1 temp___283 temp___2831)))))
...
;; H
  ...
  (bvule (to_rep2 event_log__split_fields1) (to_rep2
                                            event_log__split_fields2)))
  (= (mk4 ((_ int2bv 16) 0) r11b) temp___2781))))
...
;; H
  ...
  (bvule (to_rep2 event_log__split_fields1) (to_rep2
                                            event_log__split_fields2)))
  (= (mk3 r8b ((_ int2bv 16) 599)) temp___2771))))
...
;; H
  ...
  (bvule (to_rep2 event_log__split_fields1) (to_rep2
                                            event_log__split_fields2)))
  (=> (= (length3 (mk___t3 temp___277 temp___2771)) 0)
...
;; H
  ...
  (bvule (to_rep2 event_log__split_fields1) (to_rep2
                                            event_log__split_fields2)))
  (=> (= (length3 (mk___t3 temp___277 temp___2771)) 0)
  (= (mk (to_rep2 (first10 temp___2781)) (to_rep2 (last11 temp___2781))) 
  temp___2791)))))
...
;; H
  ...
  (bvule (to_rep2 event_log__split_fields1) (to_rep2
                                            event_log__split_fields2)))
  (=> (not (= (length3 (mk___t3 temp___277 temp___2771)) 0))
  (=>
  (<= (bv2nat (to_rep2 (first10 temp___2781))) (bv2nat (to_rep2
                                                       (last11 temp___2781))))
  (= o17 (+ (- (bv2nat (to_rep2 (last11 temp___2781))) (bv2nat (to_rep2
                                                               (first10
                                                               temp___2781)))) 1)))))))
...
;; H
  ...
  (<= (bv2nat (to_rep2 (first8 temp___2771))) (bv2nat (to_rep2
                                                      (last8 temp___2771))))
  (= o18 (+ (- (bv2nat (to_rep2 (last8 temp___2771))) (bv2nat (to_rep2
                                                              (first8
                                                              temp___2771)))) 1)))))))
...
;; H
  ...
  (bvule (to_rep2 event_log__split_fields1) (to_rep2
                                            event_log__split_fields2)))
  (=> (not (= (length3 (mk___t3 temp___277 temp___2771)) 0))
  (= o20 (+ (bv2nat (to_rep2 (first8 temp___2771))) o19))))))
...
;; H
  ...
  (bvule (to_rep2 event_log__split_fields1) (to_rep2
                                            event_log__split_fields2)))
  (=> (not (= (length3 (mk___t3 temp___277 temp___2771)) 0))
  (= (concat1 temp___277 (to_rep2 (first8 temp___2771))
     (to_rep2 (last8 temp___2771)) temp___278 (to_rep2 (first10 temp___2781))
     (to_rep2 (last11 temp___2781))) temp___279)))))
...
;; H
  ...
  (bvule (to_rep2 event_log__split_fields1) (to_rep2
                                            event_log__split_fields2)))
  (=> (not (= (length3 (mk___t3 temp___277 temp___2771)) 0))
  (= (mk (to_rep2 (first8 temp___2771)) o23) temp___2791)))))
...
;; H
  ...
  (bvule (to_rep2 event_log__split_fields1) (to_rep2
                                            event_log__split_fields2)))
  (= (ite (<= (bv2nat (to_rep2 (first temp___2791))) (bv2nat (to_rep2
                                                             (last
                                                             temp___2791))))
     (+ (- (bv2nat (to_rep2 (last temp___2791))) (bv2nat (to_rep2
                                                         (first temp___2791)))) 1)
     0) (ite (<= (bv2nat ((_ int2bv 16) 0)) (bv2nat tmp))
        (+ (- (bv2nat tmp) (bv2nat ((_ int2bv 16) 0))) 1) 0)))))
...
;; H
  ...
  (bvule (to_rep2 event_log__split_fields1) (to_rep2
                                            event_log__split_fields2)))
  (= (slide temp___279 (to_rep2 (first temp___2791)) ((_ int2bv 16) 0)) 
  temp___280))))
...
;; H
  ...
  (= (ite (<= (bv2nat (to_rep2 (first2 temp___2801))) (bv2nat (to_rep2
                                                              (last3
                                                              temp___2801))))
     (+ (- (bv2nat (to_rep2 (last3 temp___2801))) (bv2nat (to_rep2
                                                          (first2
                                                          temp___2801)))) 1)
     0) (ite (<= (bv2nat (to_rep2 result____first)) (bv2nat (to_rep2
                                                            result____last)))
...
;; H
  ...
  (bvule (to_rep2 event_log__split_fields1) (to_rep2
                                            event_log__split_fields2)))
  (= (mk___t1 o24 o25) (mk___t1 temp___280 temp___2801)))))
...
;; H
  ...
  (= o27 (log_size
         (mk___split_fields1 event_log__split_fields event_log__split_fields1
         event_log__split_fields2 event_log__split_fields3)))
  (log_size__function_guard o27
  (mk___split_fields1 event_log__split_fields event_log__split_fields1
  event_log__split_fields2 event_log__split_fields3)))
  (and (in_range4 o27)
  (= o27 (ite (= event_log__split_fields3 true) 0
         (+ (bv2nat (let ((temp___240 (bvsub (to_rep2
                                             event_log__split_fields2) 
                    (to_rep2 event_log__split_fields1))))
                    (ite (bvult (to_rep2 event_log__split_fields2) (to_rep2
