...
(declare-fun temp___276 () (Array (_ BitVec 16) us_rep))

(declare-fun temp___2761 () t)

(declare-fun temp___277 () (Array (_ BitVec 16) us_rep))

(declare-fun temp___2771 () t1)
...
;; H
  (assert (=> (= event_log__split_fields3 true) (= o5 (temp___284 o29))))
...
;; H
  ...
  (= (ite (<= (bv2nat (to_rep2 (first4 temp___2791))) (bv2nat (to_rep2
                                                              (last4
                                                              temp___2791))))
     (+ (- (bv2nat (to_rep2 (last4 temp___2791))) (bv2nat (to_rep2
                                                          (first4
                                                          temp___2791)))) 1)
...
;; H
  ...
  (= (ite (<= (bv2nat (to_rep2 (first2 temp___2801))) (bv2nat (to_rep2
                                                              (last2
                                                              temp___2801))))
     (+ (- (bv2nat (to_rep2 (last2 temp___2801))) (bv2nat (to_rep2
                                                          (first2
                                                          temp___2801)))) 1)
...
;; H
  ...
  (= (ite (<= (bv2nat (to_rep2 (first2 temp___2771))) (bv2nat (to_rep2
                                                              (last2
                                                              temp___2771))))
     (+ (- (bv2nat (to_rep2 (last2 temp___2771))) (bv2nat (to_rep2
                                                          (first2
                                                          temp___2771)))) 1)
     0) (ite (<= (bv2nat (to_rep2 result____first)) (bv2nat (to_rep2
                                                            result____last)))
