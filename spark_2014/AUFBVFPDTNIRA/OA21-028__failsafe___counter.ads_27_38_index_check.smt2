...
;; H
  ...
  (=>
  (and
  (bvule (bvadd (bvsub ((_ int2bv 8) 10) counter__model__current_chain_length__result4) ((_ int2bv 8) 1)) i)
  (bvule i ((_ int2bv 8) 10))) (= (select inputs i) true)))))
...
;; H
  (assert
  (not (= counter__model__current_chain_length__result4 ((_ int2bv 8) 10))))

(assert
;; WP_parameter_def
 ;; File "counter.ads", line 9, characters 0-0
  (not
  (bvule ((_ int2bv 8) 1) (bvsub ((_ int2bv 8) 10) counter__model__current_chain_length__result4))))
(check-sat)
