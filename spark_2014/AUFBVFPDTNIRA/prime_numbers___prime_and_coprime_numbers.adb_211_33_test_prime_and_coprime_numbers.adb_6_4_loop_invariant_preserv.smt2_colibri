...
;; H
  (assert
  (=> (= result4 true)
  (and (= o5 (* 2 index_13)) (in_range2 (* 2 index_13)))))
...
;; H
  (assert
  (=> (= result4 true) (=> (<= index_33 100000) (= temp___255 is_prime4))))
...
;; H
  (assert
  (=> (= result4 true)
  (=> (<= index_33 100000) (= o7 (store is_prime4 o6 (of_int 0))))))
