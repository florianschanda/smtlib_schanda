...
(declare-const dummy6 nonnegative_float)
...
(declare-const dummy7 normalized2pi)
...
(declare-const dummy11 unbounded_float)
...
(declare-const dummy12 (Array Int nonnegative_float))
...
(((mk_speed_option__ref (speed_option__content us_rep2)))))
...
(((mk_proxy__ref (proxy__content us_rep3)))))
...
(((mk_map__ref2 (map__content2 (Array Int us_rep5))))))
...
(((mk_list__ref (list__content us_rep6)))))
...
(((mk_list__ref1 (list__content1 us_rep6)))))
(define-fun list__ref_2__projection ((a list__ref1)) us_rep6 (list__content1
                                                             a))

(declare-const dummy22 (Array Int us_rep5))
...
(declare-fun user_eq22 ((Array Int us_rep5) (Array Int us_rep5)) Bool)
...
(declare-fun user_eq23 (us_rep7 us_rep7) Bool)

(declare-const dummy23 us_rep7)

(declare-datatypes ((controller__ref 0))
(((mk_controller__ref (controller__content us_rep7)))))
...
(((mk_t252s__ref (t252s__content us_rep2)))))
...
(declare-const this us_rep7)

(declare-const attr__ATTRIBUTE_ADDRESS2 Int)

(declare-const risinggap us_rep4)

(declare-const attr__ATTRIBUTE_ADDRESS3 Int)

(declare-const posgapcorner us_rep1)
...
(declare-const algorithm__isrisinggapsafe__B_4__posgapcorner__assume float)

(declare-const algorithm__isrisinggapsafe__B_4__posgapcorner__assume1 float)
