...
(declare-fun user_eq6 (nonnegative_float nonnegative_float) Bool)
...
(declare-fun dummy6 () nonnegative_float)
...
;; range_axiom
  (assert
  (forall ((x nonnegative_float)) (! (in_range6
...
(declare-fun user_eq7 (normalized2pi normalized2pi) Bool)
...
(declare-fun dummy7 () normalized2pi)
...
;; range_axiom
  (assert
  (forall ((x normalized2pi)) (! (in_range7
...
(declare-fun dist (us_rep1 us_rep1) Float32)

(declare-fun dist__function_guard (Float32 us_rep1 us_rep1) Bool)
...
;; range_axiom
  (assert
  (forall ((x natural)) (! (in_range8 (to_rep6 x)) :pattern ((to_rep6 x)) )))
...
(define-fun bool_eq13 ((x Float32)
  (y Float32)) Bool (ite (fp.eq x y) true false))

(declare-fun user_eq11 (unbounded_float unbounded_float) Bool)
...
(declare-fun dummy11 () unbounded_float)
...
(define-fun bool_eq14 ((a (Array Int nonnegative_float)) (a__first Int)
...
(declare-fun dummy12 () (Array Int nonnegative_float))

(declare-fun value__size3 () Int)

(declare-fun object__size3 ((Array Int nonnegative_float)) Int)
...
(declare-fun object__alignment3 ((Array Int nonnegative_float)) Int)
...
;; object__size_axiom
  (assert
  (forall ((a (Array Int nonnegative_float))) (<= 0 (object__size3 a))))
...
;; object__alignment_axiom
  (assert
  (forall ((a (Array Int nonnegative_float))) (<= 0 (object__alignment3 a))))

(declare-fun user_eq12 ((Array Int nonnegative_float)
...
(declare-fun user_eq13 (option option) Bool)

(declare-fun dummy13 () option)
...
(define-fun us_rep_4__projection ((a us_rep2)) us_split_discrs (us_split_discrs1
                                                               a))

(define-fun us_rep_5__projection ((a us_rep2)) us_split_fields4 (us_split_fields5
                                                                a))

(define-fun us_rep_6__projection ((a us_rep2)) Bool (attr__constrained a))

(define-fun robot_iface__speed_option__modulus__pred ((a us_rep2)) Bool (= 
  (to_rep8 (rec__robot_iface__speed_option__opt (us_split_discrs1 a))) 1))

(define-fun robot_iface__speed_option__angle__pred ((a us_rep2)) Bool (= 
  (to_rep8 (rec__robot_iface__speed_option__opt (us_split_discrs1 a))) 1))
...
(define-fun bool_eq17 ((a us_rep3)
  (b us_rep3)) Bool (ite (and
                         ...
                         (= (bool_eq14
                            ...
                            (us_split_fields7 a)) 1 1000
                            (rec__robot_iface__proxy__scans
                            (us_split_fields7 b)) 1 1000) true))
                         (= (to_rep7
                            (rec__robot_iface__proxy__x (us_split_fields7 a))) 
                         (to_rep7
                         (rec__robot_iface__proxy__x (us_split_fields7 b)))))
                         (= (to_rep7
                            (rec__robot_iface__proxy__y (us_split_fields7 a))) 
                         (to_rep7
                         (rec__robot_iface__proxy__y (us_split_fields7 b)))))
                         (= (to_rep7
                         ...
                         (= (rec__robot_iface__proxy__goal_reached
                            (us_split_fields7 a)) (rec__robot_iface__proxy__goal_reached
                                                  (us_split_fields7 b))))
                    true false))
...
(declare-fun dummy15 () us_rep3)

(declare-datatypes ()
((proxy__ref (mk_proxy__ref (proxy__content us_rep3)))))
(define-fun proxy__ref___projection ((a proxy__ref)) us_rep3 (proxy__content
                                                             a))
...
(declare-fun user_eq16 (idir_t idir_t) Bool)

(declare-fun dummy16 () idir_t)
...
(define-fun us_split_fields_bearing__projection ((a us_split_fields8)) us_rep 
  (rec__gaps__gap__bearing a))

(define-fun us_split_fields_iDir__projection ((a us_split_fields8)) idir_t 
  (rec__gaps__gap__idir a))

(declare-datatypes ()
((us_split_fields__ref4
 (mk___split_fields__ref4 (us_split_fields__content4 us_split_fields8)))))
(define-fun us_split_fields__ref_6__projection ((a us_split_fields__ref4)) us_split_fields8 
  (us_split_fields__content4 a))

(declare-datatypes ()
((us_rep4 (mk___rep4 (us_split_fields9 us_split_fields8)))))
(define-fun us_rep_8__projection ((a us_rep4)) us_split_fields8 (us_split_fields9
                                                                a))
...
(define-fun bool_eq19 ((a us_rep4)
  (b us_rep4)) Bool (ite (and
                         (and
                         (= (bool_eq10
                            (rec__gaps__gap__bearing (us_split_fields9 a))
                            (rec__gaps__gap__bearing (us_split_fields9 b))) true)
                         (= (to_rep2
                            (rec__gaps__gap__distance (us_split_fields9 a))) 
                         (to_rep2
                         (rec__gaps__gap__distance (us_split_fields9 b)))))
                         (= (to_rep9
                            (rec__gaps__gap__idir (us_split_fields9 a))) 
                         (to_rep9
                         (rec__gaps__gap__idir (us_split_fields9 b)))))
                    true false))
...
(define-fun us_split_fields_second__projection ((a us_split_fields10)) us_rep 
...
(define-fun us_rep_16__projection ((a us_rep5)) us_split_fields10 (us_split_fields11
                                                                  a))

(define-fun bool_eq20 ((a us_rep5)
...
((laser_scan_data__ref
 (mk_laser_scan_data__ref (laser_scan_data__content us_rep5)))))
(define-fun laser_scan_data__ref___projection ((a laser_scan_data__ref)) us_rep5 
  (laser_scan_data__content a))

(declare-datatypes ()
((map__ref2 (mk_map__ref2 (map__content2 (Array Int us_rep5))))))
...
(declare-fun concat3 ((Array Int us_rep5) Int Int (Array Int us_rep5) Int
...
(declare-fun singleton3 (us_rep5 Int) (Array Int us_rep5))
...
(define-fun bool_eq21 ((a (Array Int us_rep5)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq20 (select a temp___idx_133)
...
(declare-fun dummy19 () count_type)
...
(declare-datatypes ()
((us_split_fields12
 (mk___split_fields6 (rec__algorithm__gap_vectors__list us_main_type)))))
(define-fun us_split_fields_List__projection ((a us_split_fields12)) us_main_type 
...
(define-fun us_split_fields__ref_9__projection ((a us_split_fields__ref6)) us_split_fields12 
  (us_split_fields__content6 a))

(declare-datatypes ()
((us_rep6
 (mk___rep6
 (us_split_discrs3 us_split_discrs2)(us_split_fields13 us_split_fields12)))))
(define-fun us_rep_13__projection ((a us_rep6)) us_split_discrs2 (us_split_discrs3
                                                                 a))
...
(declare-datatypes () ((list__ref (mk_list__ref (list__content us_rep6)))))
(define-fun list__ref___projection ((a list__ref)) us_rep6 (list__content a))

(define-fun in_range12 ((rec__algorithm__gap_vectors__list__capacity1 Int)
  (a us_rep6)) Bool (= rec__algorithm__gap_vectors__list__capacity1 (to_rep10
                                                                    (rec__algorithm__gap_vectors__list__capacity
                                                                    (us_split_discrs3
                                                                    a)))))
...
(declare-datatypes ()
((list__ref1 (mk_list__ref1 (list__content1 us_rep6)))))
(define-fun list__ref_2__projection ((a list__ref1)) us_rep6 (list__content1
                                                             a))

(declare-fun dummy22 () (Array Int us_rep5))

(declare-fun value__size10 () Int)

(declare-fun object__size10 ((Array Int us_rep5)) Int)

(declare-fun value__component__size2 () Int)

(declare-fun object__component__size2 ((Array Int us_rep5)) Int)

(declare-fun value__alignment10 () Int)

(declare-fun object__alignment10 ((Array Int us_rep5)) Int)

;; value__size_axiom
  (assert (<= 0 value__size10))

;; object__size_axiom
  (assert (forall ((a (Array Int us_rep5))) (<= 0 (object__size10 a))))
...
;; object__component__size_axiom
  (assert
  (forall ((a (Array Int us_rep5))) (<= 0 (object__component__size2 a))))

;; value__alignment_axiom
  (assert (<= 0 value__alignment10))

;; object__alignment_axiom
  (assert (forall ((a (Array Int us_rep5))) (<= 0 (object__alignment10 a))))

(declare-fun user_eq21 ((Array Int us_rep5) (Array Int us_rep5)) Bool)

(declare-datatypes ()
((us_split_fields14
 (mk___split_fields7
 (rec__algorithm__controller__robot us_rep3)(rec__algorithm__controller__laserscan (Array Int us_rep5))(rec__algorithm__controller__gapvec us_rep6)(rec__algorithm__controller__obsavoiddelta float)(rec__algorithm__controller__driveangle us_rep)))))
(define-fun us_split_fields_robot__projection ((a us_split_fields14)) us_rep3 
  (rec__algorithm__controller__robot a))

(define-fun us_split_fields_laserScan__projection ((a us_split_fields14)) (Array Int us_rep5) 
  (rec__algorithm__controller__laserscan a))

(define-fun us_split_fields_gapVec__projection ((a us_split_fields14)) us_rep6 
...
(define-fun us_rep_17__projection ((a us_rep7)) us_split_fields14 (us_split_fields15
                                                                  a))
...
(declare-fun dummy23 () us_rep7)

(declare-datatypes ()
((controller__ref (mk_controller__ref (controller__content us_rep7)))))
(define-fun controller__ref___projection ((a controller__ref)) us_rep7 
...
(declare-fun is_empty (us_rep6) Bool)

(declare-fun is_empty__function_guard (Bool us_rep6) Bool)

(define-fun in_range13 ((rec__robot_iface__speed_option__opt1 Int)
  (a us_rep2)) Bool (= rec__robot_iface__speed_option__opt1 (to_rep8
                                                            (rec__robot_iface__speed_option__opt
                                                            (us_split_discrs1
                                                            a)))))
...
(declare-fun object__size12 (us_rep2) Int)

(declare-fun value__alignment12 () Int)

(declare-fun object__alignment12 (us_rep2) Int)

;; value__size_axiom
  (assert (<= 0 value__size12))

;; object__size_axiom
  (assert (forall ((a us_rep2)) (<= 0 (object__size12 a))))

;; value__alignment_axiom
  (assert (<= 0 value__alignment12))

;; object__alignment_axiom
  (assert (forall ((a us_rep2)) (<= 0 (object__alignment12 a))))
...
(declare-fun dummy24 () us_rep2)

(declare-datatypes ()
((t252s__ref (mk_t252s__ref (t252s__content us_rep2)))))
(define-fun t252s__ref___projection ((a t252s__ref)) us_rep2 (t252s__content
                                                             a))
...
(declare-fun temp___634 (us_rep5) (Array Int us_rep5))

;; def_axiom
  (assert
  (forall ((temp___636 us_rep5))
  (forall ((temp___637 Int))
  (= (select (temp___634 temp___636) temp___637) temp___636))))

(define-fun dynamic_invariant2 ((temp___expr_623 us_rep7)
...
(define-fun default_initial_assumption ((temp___expr_628 us_rep7)
...
(declare-fun this () us_rep7)

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun risinggap () us_rep4)

(declare-fun attr__ATTRIBUTE_ADDRESS3 () Int)

(declare-fun posgapcorner () us_rep1)
...
;; temp___String_Literal_811__def_axiom
  ...
  (! (and
     ...
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 2)) 32))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 3)) 32))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 4)) 32))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 5)) 71))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 6)) 97))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 7)) 112))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 8)) 32))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 9)) 97))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 10)) 116))
     (= (to_rep (select (temp___String_Literal_811 us_void_param) 11)) 32)) :pattern (
  (temp___String_Literal_811 us_void_param)) )))

(declare-fun temp___String_Literal_812 (tuple0) (Array Int character))

;; temp___String_Literal_812__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (and
     (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 1)) 32)
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 2)) 114))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 3)) 117))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 4)) 108))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 5)) 101))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 6)) 100))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 7)) 32))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 8)) 117))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 9)) 110))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 10)) 115))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 11)) 97))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 12)) 102))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 13)) 101))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 14)) 32))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 15)) 98))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 16)) 121))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 17)) 32))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 18)) 111))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 19)) 98))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 20)) 115))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 21)) 116))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 22)) 97))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 23)) 99))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 24)) 108))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 25)) 101))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 26)) 32))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 27)) 97))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 28)) 116))
     (= (to_rep (select (temp___String_Literal_812 us_void_param) 29)) 32)) :pattern (
  (temp___String_Literal_812 us_void_param)) )))
...
;; posgapcorner__def_axiom
  (assert
  (and (create__4__function_guard
  (create__4
  (to_rep2 (rec__gaps__gap__distance (us_split_fields9 risinggap)))
  (rec__gaps__gap__bearing (us_split_fields9 risinggap)))
  (to_rep2 (rec__gaps__gap__distance (us_split_fields9 risinggap)))
  (rec__gaps__gap__bearing (us_split_fields9 risinggap)))
  (= posgapcorner (create__4
                  (to_rep2
                  (rec__gaps__gap__distance (us_split_fields9 risinggap)))
                  (rec__gaps__gap__bearing (us_split_fields9 risinggap))))))

(define-fun dynamic_invariant7 ((temp___expr_593 us_rep6)
...
(define-fun default_initial_assumption1 ((temp___expr_595 us_rep6)
...
(define-fun dynamic_invariant9 ((temp___expr_252 us_rep3)
  (temp___is_init_249 Bool) (temp___skip_constant_250 Bool)
  (temp___do_toplevel_251 Bool)) Bool (= (attr__constrained
                                         (rec__robot_iface__proxy__speed
                                         (us_split_fields7 temp___expr_252))) false))

(define-fun default_initial_assumption3 ((temp___expr_255 us_rep3)
...
(define-fun dynamic_invariant10 ((temp___expr_149 Float32)
...
(define-fun dynamic_invariant11 ((temp___expr_155 Float32)
  (temp___is_init_152 Bool) (temp___skip_constant_153 Bool)
  (temp___do_toplevel_154 Bool)) Bool (=>
                                      (or (= temp___is_init_152 true)
                                      (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111)))
                                      (in_range6 temp___expr_155)))

(define-fun dynamic_invariant12 ((temp___expr_167 Float32)
...
(define-fun dynamic_invariant13 ((temp___expr_179 Float32)
...
(define-fun dynamic_invariant14 ((temp___expr_302 Int)
...
(define-fun dynamic_invariant15 ((temp___expr_340 Int)
...
(declare-fun length__function_guard (Int us_rep6) Bool)
...
;; length__post_axiom
  ...
  (! (let ((result (length1 container)))
     ...
     (dynamic_invariant15 result true false true))) :pattern ((length1
                                                              container)) )))
...
(declare-fun algorithm__isrisinggapsafe__B_4__posgapcorner__assume () float)

(declare-fun algorithm__isrisinggapsafe__B_4__posgapcorner__assume1 () float)

(declare-fun o () Float32)

(declare-fun o1 () Float32)

(declare-fun algorithm__isrisinggapsafe__B_4__B_6__deltaangle__assume () Float32)
...
;; H
  ...
  (= (attr__constrained
     (rec__robot_iface__proxy__speed
     (us_split_fields7
     (rec__algorithm__controller__robot (us_split_fields15 this))))) false)
  (= 1000 (to_rep10
          (rec__algorithm__gap_vectors__list__capacity
          (us_split_discrs3
          (rec__algorithm__controller__gapvec (us_split_fields15 this))))))))

;; H
  (assert (oeq__function_guard
  (oeq algorithm__isrisinggapsafe__B_4__posgapcorner__assume2 zero_position)
  algorithm__isrisinggapsafe__B_4__posgapcorner__assume2 zero_position))
...
;; H
  ...
  (= algorithm__isrisinggapsafe__B_4__posgapcorner__assume2 (create__4
                                                            ...
                                                            (us_split_fields9
                                                            risinggap))))
  (create__4__function_guard
  algorithm__isrisinggapsafe__B_4__posgapcorner__assume2
  (to_rep2 (rec__gaps__gap__distance (us_split_fields9 risinggap)))
  (rec__gaps__gap__bearing (us_split_fields9 risinggap))))
...
;; H
  ...
  (= o (aldiff
       ...
       (rec__gaps__gap__bearing (us_split_fields9 risinggap))))
  (aldiff__function_guard o
  (rec__algorithm__laser_scan_data__second
  (us_split_fields11
  (select (rec__algorithm__controller__laserscan (us_split_fields15 this)) 
  i2))) (rec__gaps__gap__bearing (us_split_fields9 risinggap))))
...
;; H
  (assert
  (= o1 (fp.mul RNE (of_int RNE
                    (to_rep9
                    (rec__gaps__gap__idir (us_split_fields9 risinggap)))) 
  o)))
...
;; H
  (assert (fp.lt deltaangle (fp #b0 #b01111111 #b10010010000111111011011)))
