...
(define-fun bool_eq4 ((a (Array Int nonnegative_float)) (a__first Int)
...
(define-fun bool_eq9 ((a (Array Int us_rep5)) (a__first Int) (a__last Int)
...
(define-fun bool_eq11 ((a us_rep7)
