...
(define-fun o43 () us_rep3 (mk___rep3
                           (mk___split_fields3
...
;; H
  (assert
  (and
  (= o41 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep2
                                                                   (rec__robot_iface__proxy__scan_res
                                                                   (us_split_fields5
                                                                   (rec__algorithm__controller__robot
                                                                   (us_split_fields__content7
...
;; H
  (assert (= o39 (us_split_fields7 o38)))

;; H
  (assert (= o40 (rec__gaps__gap__bearing o39)))
...
;; H
  (assert (= o36 (us_split_fields7 o35)))

;; H
  (assert (= o37 (rec__gaps__gap__bearing o36)))

;; H
  (assert
  (and (and (= o42 (ccwdiff o37 o40)) (ccwdiff__function_guard o42 o37 o40))
  (not (or (fp.isInfinite o42) (fp.isNaN o42)))))

;; H
  (assert (= result16 (ite (fp.lt o42 o41) true false)))
