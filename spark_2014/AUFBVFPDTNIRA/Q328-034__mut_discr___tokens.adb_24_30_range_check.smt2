...
(declare-fun dummy4 () instruction)
...
(declare-fun dummy9 () tTword_bufferSP1)
...
(declare-fun word__first () integer)

(declare-fun word__last () integer)
...
(declare-fun word_buffer () (Array Int character))

(declare-fun word_size1 () Int)

(declare-fun word_size2 () Int)

(declare-fun input__next_word__v () (Array Int character))

(declare-fun result () map__ref)

(declare-fun word_buffer1 () (Array Int character))
