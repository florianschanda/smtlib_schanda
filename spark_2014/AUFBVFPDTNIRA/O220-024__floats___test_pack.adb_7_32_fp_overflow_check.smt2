...
(declare-fun pid__split_fields () float)
...
;; H
  ...
  measured) (to_rep pid__split_fields))
  (fp.leq (to_rep pid__split_fields) (fp.add RNE (fp #b0 #b11111110 #b11111111111111111111111) 
  measured))))
...
;; WP_parameter_def
 ;; File "test_pack.ads", line 9, characters 0-0
  (not
  (not (or (fp.isInfinite (fp.sub RNE (to_rep pid__split_fields) measured)) (fp.isNaN (fp.sub RNE 
  (to_rep pid__split_fields) measured))))))
(check-sat)
