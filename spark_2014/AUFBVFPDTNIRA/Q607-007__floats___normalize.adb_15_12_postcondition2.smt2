...
;; H
  (assert (= normalize__r3__result normalize__r3__result1))
...
;; H
  (assert
  (= (mk_t__ref normalize__r3__result2) (mk_t__ref normalize__r3__result1)))

(assert
;; WP_parameter_def
 ;; File "normalize.ads", line 5, characters 0-0
  (not (fp.leq normalize__r3__result2 x)))
(check-sat)
(exit)
