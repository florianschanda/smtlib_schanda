...
;; H
  (assert
  (and (and (= o13 (pow9 x)) (pow9__function_guard o13 x))
  (and (not (or (fp.isInfinite o13) (fp.isNaN o13)))
  (= o13 (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE 
  x x) x) x) x) x) x) x) x)))))

;; H
  (assert
  (= o14 (fp.mul RNE (fp #b0 #b10000100 #b11110000000000000000000) o13)))
...
;; H
  (assert
  (= o16 (fp.div RNE o15 (fp #b0 #b10001010 #b01100010011000000000000))))

;; H
  (assert
  (and (and (= o9 (pow7 x)) (pow7__function_guard o9 x))
...
;; H
  (assert
  (and (and (= o3 (pow5 x)) (pow5__function_guard o3 x))
...
;; H
  (assert
  (= o6 (fp.div RNE o5 (fp #b0 #b10000010 #b11100000000000000000000))))

;; H
  (assert
  (and (and (= o (pow3 x)) (pow3__function_guard o x))
  (and (not (or (fp.isInfinite o) (fp.isNaN o)))
  (= o (fp.mul RNE (fp.mul RNE x x) x)))))

;; H
  (assert
  (= o1 (fp.div RNE o (fp #b0 #b10000000 #b10000000000000000000000))))

;; H
  (assert (= o2 (fp.add RNE x o1)))

;; H
  (assert (and (= o7 o2) (not (or (fp.isInfinite o2) (fp.isNaN o2)))))
