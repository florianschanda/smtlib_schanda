...
(define-fun dynamic_invariant1 ((temp___expr_263 us_rep2)
  (temp___is_init_259 Bool) (temp___skip_constant_260 Bool)
  (temp___do_toplevel_261 Bool)
  (temp___do_typ_inv_262 Bool)) Bool (and
                                     (=>
                                     (not (= temp___skip_constant_260 true))
                                     (in_range6 a (to_base temp___expr_263)))
                                     (in_range5 a
                                     (rec__rec__sub_rec__plop1
                                     (us_split_fields5 temp___expr_263)))))
...
(define-fun dynamic_invariant5 ((temp___expr_181 us_rep1)
  (temp___is_init_177 Bool) (temp___skip_constant_178 Bool)
  (temp___do_toplevel_179 Bool) (temp___do_typ_inv_180 Bool)) Bool (in_range4
