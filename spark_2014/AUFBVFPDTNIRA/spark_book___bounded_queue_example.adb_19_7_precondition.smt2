...
(declare-fun temp___645 () positive)

(declare-fun temp___6451 () natural)

(declare-fun temp___6452 () positive)

(declare-fun temp___6453 () positive)

(declare-fun temp___6454 () (Array Int element_type))
...
(define-fun bounded_queue_example__char_queue__enqueue__queue__fields5 () us_split_fields 
  (mk___split_fields
...
(define-fun my_queue__split_fields18 () us_split_fields2 (mk___split_fields1
...
;; H
  (assert
  (=> (and (<= 102 char1) (<= char1 112))
  (and (= (mk___split_discrs temp___645) my_queue__split_discrs)
  (and (= temp___6451 my_queue__split_fields4)
  (and (= temp___6452 my_queue__split_fields5)
  (and (= temp___6453 my_queue__split_fields6)
  (= temp___6454 my_queue__split_fields7)))))))

;; H
  (assert
  (=> (and (<= 102 char1) (<= char1 112))
  (and (<= 102 char2) (<= char2 112))))
...
;; H
  ...
  (= (empty
     (mk___rep my_queue__split_discrs
     bounded_queue_example__char_queue__enqueue__queue__fields5)) true))
  (and
  (= (size
     (mk___rep my_queue__split_discrs
  ...
  (= (last_element
     (mk___rep my_queue__split_discrs
     bounded_queue_example__char_queue__enqueue__queue__fields5)) char2)))
  (dynamic_invariant3
  (mk___rep my_queue__split_discrs
  bounded_queue_example__char_queue__enqueue__queue__fields5) true true
  true))))
...
;; H
  ...
  (= result5 (mk___split_fields__ref1
             (mk___split_fields1 my_queue__split_fields8
             my_queue__split_fields9 my_queue__split_fields10
...
;; H
  ...
  (= my_queue__split_fields12 (mk___split_fields1
                              ...
                              bounded_queue_example__char_queue__enqueue__queue__fields1
                              bounded_queue_example__char_queue__enqueue__queue__fields2
                              bounded_queue_example__char_queue__enqueue__queue__fields3))))

;; H
  (assert (=> (and (<= 102 char1) (<= char1 112)) (= char2 112)))

;; H
  (assert
  (=> (and (<= 102 char1) (<= char1 112)) (= char3 (mk_int__ref char2))))
...
;; H
  (assert (=> (and (<= 102 char1) (<= char1 112)) (= char4 char2)))
...
;; H
  (assert (=> (and (<= 102 char1) (<= char1 112)) (= char5 char3)))
...
;; H
  (assert (=> (and (<= 102 char1) (<= char1 112)) (= char6 char4)))
...
;; H
  (assert
  (=> (not (and (<= 102 char1) (<= char1 112)))
  (= char5 (mk_int__ref char1))))
...
;; H
  (assert (=> (not (and (<= 102 char1) (<= char1 112))) (= char6 char1)))

;; H
  (assert
  (=> (not (and (<= 102 char1) (<= char1 112)))
  (= my_queue__split_fields16 my_queue__split_fields18)))

;; H
  (assert (= result6 (mk_int__ref count)))
...
;; H
  (assert
  (and (=> (<= 0 255) (in_range3 value1)) (and (<= 1 count2) (<= count2 5))))
...
;; WP_parameter_def
 ;; File "bounded_queue.ads", line 36, characters 0-0
  ...
  (= (empty
     ...
     (mk___t1
     (rec__bounded_queue_example__char_queue__queue_type__items1
     my_queue__split_fields17) (mk1 1 100))))) true))))
(check-sat)
