...
(((mk_latitude__ref (latitude__content latitude)))))
...
(((mk_longitude__ref (longitude__content longitude)))))
...
(((mk_coordinates__ref (coordinates__content us_rep)))))
...
;; WP_parameter_def
 ;; File "lat_long.ads", line 6, characters 0-0
  (not (fp.isFinite32 (fp.mul RNE delta_lat1 delta_lat1))))
(check-sat)
(exit)
