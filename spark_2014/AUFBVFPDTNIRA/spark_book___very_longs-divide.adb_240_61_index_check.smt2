...
(declare-fun temp___1104 () us_rep1)
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r138b))
  (= temp___1104 (mk___rep1 u__split_discrs u__split_fields2))))
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r138b))
  (= temp___1101 (mk___rep quotient__split_discrs quotient__split_fields2))))
...
;; H
  ...
  true)) (and (<= 1 j2) (<= j2 r138b)))))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (= o10 j2) (in_range2 j2))))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (= o11 j2) (in_range2 j2))))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r138b)) (dynamic_invariant7
  (mk___rep1 u__split_discrs u__split_fields4) true true true)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (= o12 j2) (in_range2 j2))))
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r138b)) (= current_borrow4 current_borrow2)))
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r138b)) (= u__split_fields7 u__split_fields5)))
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r138b)) (= current_borrow5 current_borrow3)))
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r138b)) (= u__split_fields8 u__split_fields6)))
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r138b)) (= current_borrow6 current_borrow4)))
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r138b)) (= u__split_fields9 u__split_fields7)))
...
;; H
  (assert
  (=> (not (and (<= 1 j1) (<= j1 r138b))) (= q_hat5 (mk_t__ref1 q_hat))))
...
;; H
  (assert (dynamic_property2 1 last2 r140b))
...
;; H
  ...
  true)
  (forall ((temp___1113 Int))
  (=>
  (and
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))) temp___1113)
  (<= temp___1113 (to_rep2
                  (last
                  (rt
                  (rec__very_longs__very_long__long_digits
                  remainder__split_fields3))))))
  (=> (<= divisor_index2 temp___1113)
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             remainder__split_fields3)) temp___1113) (select (elts
                                                             (rec__very_longs__very_long__long_digits
                                                             remainder__split_fields2)) temp___1113))))))
  (and (<= 1 divisor_index2) (<= divisor_index2 r140b))))
