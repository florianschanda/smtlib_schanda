...
(define-fun source__ref_10__projection ((a source__ref)) source (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_321 (_ BitVec 32))
...
(define-fun target__ref_10__projection ((a target__ref)) target (target__content
                                                                a))
...
;; u32toint8__post_axiom
  ...
  (! (=> (dynamic_invariant1 s true true true) (dynamic_invariant2
     (u32toint8 s) true false true)) :pattern ((u32toint8 s)) )))
