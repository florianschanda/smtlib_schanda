...
;; H
  (assert
  (=> (not (= right_is_out2 true)) (and (<= 0 right2) (<= right2 100000))))
...
;; H
  (assert
  (=> (not (= right_is_out2 true)) (= result6 (select number_list o3))))
...
;; H
  (assert (and (= o5 right3) (not (= right3 2147483647))))

;; H
  (assert (= o6 (+ o5 1)))

;; H
  (assert (= right3 result7))

;; H
  (assert (= right4 o6))

;; H
  (assert (= right_is_out3 result8))

;; H
  (assert (= right_is_out4 (ite (< 100000 right4) true false)))

;; H
  (assert (=> (= right_is_out4 true) (= result9 true)))

;; H
  (assert
  (=> (not (= right_is_out4 true)) (and (<= 0 right4) (<= right4 100000))))

;; H
  (assert (=> (not (= right_is_out4 true)) (= o7 right4)))

;; H
  (assert
  (=> (not (= right_is_out4 true)) (= result9 (select number_list o7))))
...
;; WP_parameter_def
 ;; File "prime_and_coprime_numbers.ads", line 3, characters 0-0
  (not (not (= (select number_list v6) true))))
(check-sat)
(exit)
