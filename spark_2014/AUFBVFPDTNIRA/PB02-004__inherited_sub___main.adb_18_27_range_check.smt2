...
(define-fun dynamic_invariant1 ((temp___expr_281 us_rep2)
  ...
  (temp___do_typ_inv_280 Bool)) Bool (and
                                     ...
                                     (in_range6 a (to_base temp___expr_281)))
                                     (=> (rec__sub_rec_ok__plop__pred1
                                     temp___expr_281) (in_range5 a
                                     (rec__rec__sub_rec_ok__plop1
...
(define-fun dynamic_invariant5 ((temp___expr_188 us_rep1)
  ...
  (temp___do_typ_inv_187 Bool)) Bool (=> (rec__sub_rec_ok__plop__pred
                                     ...
                                     (to_rep
                                     (rec__rec__sub_rec_ok__z
                                     (us_split_discrs3 temp___expr_188)))
                                     (rec__rec__sub_rec_ok__plop
