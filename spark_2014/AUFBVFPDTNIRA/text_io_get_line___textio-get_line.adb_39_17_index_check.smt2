...
;; H
  (assert (<= idx (int__content last14)))

;; H
  (assert
  (and (<= 1 (+ (- (- idx last2) 1) cur_position))
  (<= (+ (- (- idx last2) 1) cur_position) 2147483647)))

;; H
  (assert (= o19 (+ (- (- idx last2) 1) cur_position)))

;; H
  (assert (= o20 (select the_file o19)))
