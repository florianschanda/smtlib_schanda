...
;; H
  (assert
  (= o9 (select (rec__step_function__step_function_t__step
                merge__split_fields3) o8)))

;; H
  (assert (= o10 (us_split_fields1 o9)))

;; H
  (assert (= o11 (rec__step_function__delimiter_entry__delimiter o10)))
