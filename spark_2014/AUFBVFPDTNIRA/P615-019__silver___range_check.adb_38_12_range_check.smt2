...
(declare-fun dummy1 () natural_fixed)
...
(declare-datatypes ()
((natural_fixed__ref
 (mk_natural_fixed__ref (natural_fixed__content natural_fixed)))))
(define-fun natural_fixed__ref___projection ((a natural_fixed__ref)) natural_fixed
