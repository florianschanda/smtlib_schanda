...
(define-fun dynamic_invariant3 ((temp___expr_194 Int)
  ...
  (temp___do_toplevel_193 Bool)) Bool (=>
                                      ...
                                      (<= 0 10)) (in_range1 temp___expr_194)))
...
(declare-fun temp___356 () num_delimiters_range)

(declare-fun temp___3561 () (Array Int us_rep))
...
;; H
  (assert (is_valid_kdry_rst__function_guard (is_valid_kdry_rst Tuple0)
  Tuple0))
...
;; H
  (assert
  (= (mk___rep1 (mk___split_fields1 temp___356 temp___3561)) kdry_rst_model))
...
;; H
  (assert
  (and
  (and (= o17 (get_value kdry_rst_model o16)) (get_value__function_guard 
  o17 kdry_rst_model o16))
...
;; H
  (assert (= result1 sec_3_13_2_monitoring_inputs__kdry_rst__result4))

;; H
  (assert (get_value__function_guard
  (get_value kdry_rst_model (to_int1 RNA v)) kdry_rst_model (to_int1 RNA v)))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (fp.eq sec_3_13_2_monitoring_inputs__kdry_rst__result4 (get_value
                                                         kdry_rst_model
                                                         (to_int1 RNA v)))))
(check-sat)
