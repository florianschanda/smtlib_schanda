...
;; H
  (assert
  (= o4 (fp.div RNE o3 (fp #b0 #b10001011 #b00111011000000000000000))))
...
;; H
  (assert
  (= o2 (fp.div RNE o1 (fp #b0 #b10000101 #b11100000000000000000000))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (not
  (fp.eq (fp #b0 #b10000001 #b10000000000000000000000) ((_ to_fp 8 24) #x00000000)))))
(check-sat)
