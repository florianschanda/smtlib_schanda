...
(declare-const riterl__split_fields9 us_split_fields4)
...
(declare-const riterl__split_fields10 us_split_fields__ref2)

(declare-const this__split_fields10 us_split_fields14)

(declare-const riterl__split_fields11 us_split_fields4)

(declare-const this__split_fields11 us_split_fields__ref7)

(declare-const riterr__split_fields10 us_split_fields__ref2)

(declare-const riterl__split_fields12 us_split_fields__ref2)

(declare-const this__split_fields12 us_split_fields14)

(declare-const riterr__split_fields11 us_split_fields4)

(declare-const riterl__split_fields13 us_split_fields4)

(declare-const this__split_fields13 us_split_fields__ref7)

(declare-const riterr__split_fields12 us_split_fields__ref2)

(declare-const riterl__split_fields14 us_split_fields__ref2)

(declare-const this__split_fields14 us_split_fields14)

(declare-const riterr__split_fields13 us_split_fields4)

(declare-const riterl__split_fields15 us_split_fields4)
...
;; H
  (assert
  (=> (= result9 true)
  (= riterr__split_fields9 (us_split_fields5 temp___1122))))
...
;; H
  (assert (=> (= result9 true) (=> (= result14 true) (= o40 (to_rep5 o39)))))
...
;; H
  (assert (=> (= result9 true) (=> (= result13 true) (= o36 (to_rep5 o35)))))
...
;; H
  ...
  (=> (= result9 true)
  (=> (= result12 true)
  (=> (= (distinct 0 0) true) (= o51 (us_split_fields7 o50))))))

;; H
  (assert
  (=> (= result9 true)
  (=> (= result12 true)
  (=> (= (distinct 0 0) true) (= o52 (rec__gaps__gap__bearing o51))))))
...
;; H
  ...
  (= (bool_eq4 (mk___rep2 riterl__split_fields9) no_element) true))
  (= (range_equal
     (model__
     (mk___rep1
     (us_split_discrs1
     ...
     (- (get1
        ...
        (rec__algorithm__controller__gapvec
        (us_split_fields__content7 this__split_fields6)))))
        (mk___rep2 (us_split_fields__content2 riterl__split_fields7))) 1)) true))
  (= (range_shifted
     (model__
     (mk___rep1
     (us_split_discrs1
...
;; H
  ...
  (=> (= result9 true)
  (=> (= result12 true)
  (= riterl__split_fields10 (mk___split_fields__ref2 riterl__split_fields9)))))
...
;; H
  (assert
  (=> (= result9 true)
  (= riterr__split_fields10 (mk___split_fields__ref2 riterr__split_fields9))))
...
;; WP_parameter_def
 ;; File "algorithm.ads", line 53, characters 0-0
  ...
  (fp.eq (to_rep6
         ...
         (us_split_fields11
         (rec__algorithm__controller__robot
         (us_split_fields__content7 this__split_fields13))))) (to_rep6
                                                              (rec__robot_iface__proxy__robot_radius
                                                              (us_split_fields11
                                                              (rec__algorithm__controller__robot
                                                              (us_split_fields__content7
