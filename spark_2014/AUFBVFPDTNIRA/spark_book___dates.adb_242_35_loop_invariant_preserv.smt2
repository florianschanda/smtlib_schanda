...
(declare-fun o3 () day_type)

(declare-fun o4 () month_type)

(declare-fun o5 () year_type)
...
(declare-fun current_date__split_fields3 () us_split_fields)

(declare-fun valid3 () Bool)

(declare-fun i2 () Int)

(declare-fun current_date__split_fields4 () us_split_fields)
...
(define-fun o6 () us_rep (mk___rep (mk___split_fields o3 o4 o5)))

(define-fun o7 () us_rep (mk___rep (mk___split_fields o o1 o2)))
...
;; H
  (assert
  (and (= o7 (minimum_date Tuple0))
  (and (= (of_rep2 1) o) (and (= (of_rep1 1) o1) (= (of_rep 2000) o2)))))
...
;; H
  (assert
  (not
  (= (bool_eq (mk___rep current_date__split_fields3) (minimum_date Tuple0)) true)))

;; H
  (assert
  (and (=> (<= 1 r38b) (dynamic_property1 1 r38b i2))
  (and (<= 1 i2) (<= i2 r38b))))
...
;; H
  (assert
  (and (= o6 (minimum_date Tuple0))
  (and (= (of_rep2 1) o3) (and (= (of_rep1 1) o4) (= (of_rep 2000) o5)))))

;; H
  (assert (= result5 (bool_eq (mk___rep current_date__split_fields4) o6)))

;; H
  (assert (not (= result5 true)))

;; H
  (assert (= valid4 valid3))
...
;; WP_parameter_def
 ;; File "dates.ads", line 89, characters 0-0
  (not
  (not
  (= (bool_eq (mk___rep current_date__split_fields4) (minimum_date Tuple0)) true))))
(check-sat)
