...
;; H
  ...
  (limit__function_guard o3 (t__content theta1)
  (fp.neg (fp #b0 #b01111111 #b10010010000111111011011))
  (fp #b0 #b01111111 #b10010010000111111011011)))
...
;; H
  (assert
  (and (and (= o9 (sqrt1 o8)) (sqrt__function_guard o9 o8))
...
;; H
  ...
  (limit__function_guard o10 o9 (fp #b0 #b01111100 #b10011001100110011001101)
  (fp #b0 #b01111111 #b00000000000000000000000)))
...
;; H
  (assert
  (and (and (= o16 (sqrt1 o15)) (sqrt__function_guard o16 o15))
...
;; H
  ...
  (limit__function_guard o20 theta2
  (fp.neg (fp #b0 #b01111110 #b10010010000111111011011))
  (fp #b0 #b01111110 #b10010010000111111011011)))
...
;; H
  (assert
  (and (and (= o22 (sqrt1 o21)) (sqrt__function_guard o22 o21))
...
;; H
  (assert
  (and (and (= o29 (sqrt1 o28)) (sqrt__function_guard o29 o28))
