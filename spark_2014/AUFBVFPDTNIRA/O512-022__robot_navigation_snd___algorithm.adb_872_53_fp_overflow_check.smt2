...
(define-fun dynamic_invariant7 ((temp___expr_577 us_rep8)
  ...
  (temp___do_toplevel_576 Bool)) Bool (=>
                                      ...
                                      (in_range13 1000 temp___expr_577)))
...
;; H
  ...
  (= (attr__constrained
     ...
     (us_split_fields9
     (rec__algorithm__controller__robot
     (us_split_fields__content10 this__split_fields45))))) false)
  (= 1000 (to_rep11
          (rec__algorithm__gap_vectors__list__capacity
          (us_split_discrs5
          (rec__algorithm__controller__gapvec
          (us_split_fields__content10 this__split_fields45))))))))

;; H
  (assert
  (and
  (= o101 (limit (t__content theta3)
          (fp.neg (fp #b0 #b01111111 #b10010010000111111011011))
          (fp #b0 #b01111111 #b10010010000111111011011)))
  (and (fp.isFinite32 o101)
  (and (fp.leq (fp.neg (fp #b0 #b01111111 #b10010010000111111011011))
  o101) (fp.leq o101 (fp #b0 #b01111111 #b10010010000111111011011))))))
...
;; H
  (assert
  (and
  (= o102 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) theta5))
  (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000)
  theta5))))

;; H
  (assert
  (= o103 (fp.div RNE o102 (fp #b0 #b10000000 #b10010010000111111011011))))

;; H
  (assert
  (= o104 (fp.mul RNE (to_rep3
                      (rec__robot_iface__proxy__max_turn_rate
                      (us_split_fields9
                      (rec__algorithm__controller__robot
                      (us_split_fields__content10 this__split_fields45)))))
...
;; H
  (assert
  (and (= o106 (norm (mk___rep1 disttogoal__split_fields2)))
  (and (fp.isFinite32 o106)
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o106)
  (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) o106)
  (not (= (oeq (mk___rep1 disttogoal__split_fields2) zero_position) true)))))))

;; H
  (assert
  (and (= o107 (sqrt1 o106))
  (and (fp.isFinite32 o107)
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o107)
  (and
  (=> (fp.eq o106 (fp #b0 #b00000000 #b00000000000000000000000))
  (fp.eq o107 (fp #b0 #b00000000 #b00000000000000000000000)))
  (=> (fp.eq o106 (fp #b0 #b01111111 #b00000000000000000000000))
  (fp.eq o107 (fp #b0 #b01111111 #b00000000000000000000000))))))))

;; H
  (assert
  (and
  (= o108 (limit o107 (fp #b0 #b01111100 #b10011001100110011001101)
          (fp #b0 #b01111111 #b00000000000000000000000)))
  (and (fp.isFinite32 o108)
  (and (fp.leq (fp #b0 #b01111100 #b10011001100110011001101) o108)
  (fp.leq o108 (fp #b0 #b01111111 #b00000000000000000000000))))))
...
;; H
  ...
  (t__content disttoclosestobstacle12) (to_rep3
                                       (rec__robot_iface__proxy__robot_radius
                                       (us_split_fields9
                                       (rec__algorithm__controller__robot
                                       (us_split_fields__content10
                                       this__split_fields45)))))) (to_rep3
                                                                  (rec__robot_iface__proxy__obstacle_avoid_dist
                                                                  (us_split_fields9
                                                                  (rec__algorithm__controller__robot
                                                                  (us_split_fields__content10
...
;; H
  (assert
  (and
  (= o119 (fp.sub RNE (t__content disttoclosestobstacle12) (to_rep3
                                                           (rec__robot_iface__proxy__robot_radius
                                                           (us_split_fields9
                                                           (rec__algorithm__controller__robot
                                                           (us_split_fields__content10
                                                           this__split_fields45)))))))
  (fp.isFinite32 (fp.sub RNE (t__content disttoclosestobstacle12) (to_rep3
                                                                  (rec__robot_iface__proxy__robot_radius
                                                                  (us_split_fields9
                                                                  (rec__algorithm__controller__robot
                                                                  (us_split_fields__content10
...
;; H
  (assert
  (and (= o122 (sqrt1 o121))
  (and (fp.isFinite32 o122)
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o122)
  (and
  (=> (fp.eq o121 (fp #b0 #b00000000 #b00000000000000000000000))
  (fp.eq o122 (fp #b0 #b00000000 #b00000000000000000000000)))
  (=> (fp.eq o121 (fp #b0 #b01111111 #b00000000000000000000000))
  (fp.eq o122 (fp #b0 #b01111111 #b00000000000000000000000))))))))

;; H
  (assert
  (and
  (= o123 (limit o122 (fp #b0 #b01111110 #b00000000000000000000000)
          (fp #b0 #b01111111 #b00000000000000000000000)))
  (and (fp.isFinite32 o123)
  (and (fp.leq (fp #b0 #b01111110 #b00000000000000000000000) o123)
  (fp.leq o123 (fp #b0 #b01111111 #b00000000000000000000000))))))
...
;; H
  ...
  (and (fp.isFinite32 o126)
  (and (fp.leq (fp.neg (fp #b0 #b01111110 #b10010010000111111011011))
  o126) (fp.leq o126 (fp #b0 #b01111110 #b10010010000111111011011))))))
...
;; H
  (assert
  (and (= o127 (norm (mk___rep1 disttogoal__split_fields2)))
  (and (fp.isFinite32 o127)
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o127)
  (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) o127)
  (not (= (oeq (mk___rep1 disttogoal__split_fields2) zero_position) true)))))))

;; H
  (assert
  (and (= o128 (sqrt1 o127))
  (and (fp.isFinite32 o128)
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o128)
  (and
  (=> (fp.eq o127 (fp #b0 #b00000000 #b00000000000000000000000))
  (fp.eq o128 (fp #b0 #b00000000 #b00000000000000000000000)))
  (=> (fp.eq o127 (fp #b0 #b01111111 #b00000000000000000000000))
  (fp.eq o128 (fp #b0 #b01111111 #b00000000000000000000000))))))))

;; H
  (assert
  (and
  (= o129 (limit o128 (fp #b0 #b00000000 #b00000000000000000000000)
          (fp #b0 #b01111111 #b00000000000000000000000)))
  (and (fp.isFinite32 o129)
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o129)
  (fp.leq o129 (fp #b0 #b01111111 #b00000000000000000000000))))))
...
;; H
  (assert
  (and
  (= o132 (fp.sub RNE (t__content disttoclosestobstacle12) (to_rep3
                                                           (rec__robot_iface__proxy__robot_radius
                                                           (us_split_fields9
                                                           (rec__algorithm__controller__robot
                                                           (us_split_fields__content10
...
;; H
  (assert
  (and (= o135 (sqrt1 o134))
  (and (fp.isFinite32 o135)
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o135)
  (and
  (=> (fp.eq o134 (fp #b0 #b00000000 #b00000000000000000000000))
  (fp.eq o135 (fp #b0 #b00000000 #b00000000000000000000000)))
  (=> (fp.eq o134 (fp #b0 #b01111111 #b00000000000000000000000))
  (fp.eq o135 (fp #b0 #b01111111 #b00000000000000000000000))))))))

;; H
  (assert
  (and
  (= o136 (limit o135 (fp #b0 #b00000000 #b00000000000000000000000)
          (fp #b0 #b01111111 #b00000000000000000000000)))
  (and (fp.isFinite32 o136)
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o136)
  (fp.leq o136 (fp #b0 #b01111111 #b00000000000000000000000))))))
...
;; WP_parameter_def
 ;; File "algorithm.ads", line 107, characters 0-0
  (not
  (fp.isFinite32 (fp.sub RNE (fp #b0 #b01111110 #b00001100000101010010010) (fp.abs
  theta6)))))
(check-sat)
(exit)
