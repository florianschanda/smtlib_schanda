...
(define-fun failsafe_state8 () us_private__ref (mk___private__ref
                                               failsafe_state5))
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 49))
  (= failsafe_state8 (mk___private__ref failsafe_state3))))
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 49)) (= current_time9 (mk_t__ref current_time4))))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 49))
  (= battery_level_at8 (mk_map__ref battery_level_at3))))
...
;; H
  (assert
  (=> (not (and (<= 1 j1) (<= j1 49)))
  (= failsafe_state8 (mk___private__ref failsafe_state))))
...
;; H
  (assert
  (=> (not (and (<= 1 j1) (<= j1 49)))
  (= current_time9 (mk_t__ref current_time))))

;; H
  (assert
  (=> (not (and (<= 1 j1) (<= j1 49)))
  (= battery_level_at8 (mk_map__ref battery_level_at))))
...
;; H
  ...
  (and
  (= current_time8 (let ((temp___273 (bvadd current_time6 #x01)))
...
;; WP_parameter_def
 ;; File "failsafe.ads", line 20, characters 0-0
  (not (= (is_valid failsafe_state7 battery_level_at7 current_time8) true)))
(check-sat)
(exit)
