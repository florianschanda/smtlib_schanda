...
;; H
  (assert
  (= lat_long__delta_long_in_meters__result lat_long__delta_long_in_meters__result1))

;; H
  (assert (= o2 o1))

;; H
  (assert (= lat_long__delta_long_in_meters__result o2))
...
;; H
  (assert
  (= (mk_t__ref lat_long__delta_long_in_meters__result2) (mk_t__ref
                                                         lat_long__delta_long_in_meters__result1)))

(assert
;; WP_parameter_def
 ;; File "lat_long.ads", line 6, characters 0-0
  (not
  (= (olt (fp.abs lat_long__delta_long_in_meters__result2)
