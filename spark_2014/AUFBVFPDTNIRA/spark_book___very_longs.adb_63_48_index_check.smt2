...
(declare-fun temp___1134 () (Array Int octet))

(declare-fun temp___11341 () t1)
...
(declare-fun temp___1136 () digit_index_type)

(declare-fun temp___11361 () (Array Int octet))

(declare-fun temp___11362 () t)
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___11311)) (to_rep2 (last4 temp___11311))) 
  temp___11321))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___11321)) (to_rep2 (last2 temp___11321)))
     (+ (- (to_rep2 (last2 temp___11321)) (to_rep2 (first2 temp___11321))) 1)
...
;; H
  (assert
  (= (mk___t1 temp___1134 temp___11341) (mk___t1 temp___1132 temp___11321)))
...
;; H
  (assert
  (= (mk (to_rep2 (first2 temp___11341)) (to_rep2 (last2 temp___11341))) 
  o1))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___11361 temp___11362))))
...
;; H
  ...
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1144)
  (<= temp___1144 (to_rep2
                  (last
                  (rt
                  (rec__very_longs__very_long__long_digits
  ...
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             result____split_fields3)) temp___1144) (select (elts
                                                            (rec__very_longs__very_long__long_digits
                                                            result____split_fields2)) temp___1144))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
