...
(declare-fun saferisinggapangle__split_fields2 () us_split_fields)
...
;; H
  (assert
  (= saferisinggapangle__split_fields2 (us_split_fields1 temp___965)))
