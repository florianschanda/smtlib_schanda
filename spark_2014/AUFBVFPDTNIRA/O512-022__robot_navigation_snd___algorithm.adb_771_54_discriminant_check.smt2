...
;; sqrt__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant1 result true false true true)))) :pattern ((sqrt1 x)) )))
...
;; arctan__post_axiom
  ...
  (! (=>
     ...
     (fp.eq result (fp #b0 #b00000000 #b00000000000000000000000)))
     (dynamic_invariant1 result true false true true)))) :pattern ((arctan y
                                                                   x)) )))
...
;; range_axiom
  (assert
  (forall ((x natural)) (! (in_range4 (to_rep6 x)) :pattern ((to_rep6 x)) )))
...
(define-fun dynamic_invariant5 ((temp___expr_272 us_rep4)
...
(define-fun us_split_discrs___2__projection ((a us_split_discrs2)) option1
...
(define-fun us_rep___10__projection ((a us_rep7)) us_split_discrs2 (us_split_discrs3
                                                                   a))
...
(define-fun default_initial_assumption1 ((temp___expr_423 us_rep7)
...
;; range_axiom
  (assert
  (forall ((x count_type)) (! (in_range12
...
(define-fun us_split_discrs___3__projection ((a us_split_discrs4)) count_type
...
(define-fun us_rep___13__projection ((a us_rep8)) us_split_discrs4 (us_split_discrs5
                                                                   a))
...
(define-fun in_range13 ((rec__algorithm__gap_vectors__list__capacity1 Int)
...
(define-fun us_rep___16__projection ((a us_rep9)) us_split_fields18 (us_split_fields19
                                                                    a))
...
(define-fun bool_eq13 ((a (Array Int us_rep9)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq12 (select a temp___idx_155)
...
(define-fun us_rep___17__projection ((a us_rep10)) us_split_fields20
  (us_split_fields21 a))
...
(define-fun dynamic_invariant6 ((temp___expr_673 us_rep10)
...
(define-fun default_initial_assumption2 ((temp___expr_678 us_rep10)
...
(define-fun dynamic_invariant7 ((temp___expr_640 us_rep8)
  ...
  (temp___do_typ_inv_639 Bool)) Bool (=>
                                     ...
                                     (in_range13 1000 temp___expr_640)))

(define-fun default_initial_assumption3 ((temp___expr_642 us_rep8)
...
;; temp___String_Literal_1015__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (and
     (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 1)) 32)
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 2)) 79))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 3)) 98))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 4)) 115))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 5)) 116))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 6)) 97))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 7)) 99))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 8)) 108))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 9)) 101))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 10)) 32))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 11)) 105))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 12)) 110))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 13)) 115))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 14)) 105))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 15)) 100))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 16)) 101))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 17)) 32))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 18)) 111))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 19)) 102))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 20)) 32))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 21)) 114))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 22)) 111))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 23)) 98))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 24)) 111))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 25)) 116))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 26)) 39))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 27)) 115))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 28)) 32))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 29)) 98))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 30)) 111))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 31)) 117))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 32)) 110))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 33)) 100))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 34)) 97))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 35)) 114))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 36)) 121))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 37)) 33))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 38)) 32))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 39)) 32))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 40)) 83))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 41)) 116))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 42)) 111))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 43)) 112))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 44)) 112))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 45)) 105))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 46)) 110))
     (= (to_rep (select (temp___String_Literal_1015 us_void_param) 47)) 103)) :pattern (
  (temp___String_Literal_1015 us_void_param)) )))
...
(define-fun dynamic_invariant14 ((temp___expr_184 Float32)
...
(define-fun dynamic_invariant15 ((temp___expr_198 Float32)
...
;; H
  ...
  (rec__algorithm__controller__robot
  (let ((subject this__split_fields)) this__split_fields1)))))))
  (fp.isFinite32 (fp.add RNE (to_rep3
                             (rec__robot_iface__proxy__obstacle_avoid_dist
                             (us_split_fields9
                             (rec__algorithm__controller__robot
                             (let ((subject this__split_fields))
...
;; H
  ...
  (= temp___1034 (osubtract
                 ...
                 (rec__algorithm__valley_option__value
                 (let ((subject pbestvalley__split_fields))
                 pbestvalley__split_fields1)))))) o12)))

;; H
  (assert
  (= result3 (mk___split_fields__ref saferisinggapangle__split_fields1)))

;; H
  (assert
  (= saferisinggapangle__split_fields2 (us_split_fields1 temp___1034)))
