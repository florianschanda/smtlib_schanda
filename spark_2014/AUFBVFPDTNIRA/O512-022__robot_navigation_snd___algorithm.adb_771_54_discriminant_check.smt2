...
;; H
  ...
  (fp.lt (to_rep3
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (let ((subject this__split_fields)) this__split_fields22)))))
...
;; H
  ...
  (= (attr__constrained
     ...
     (us_split_fields9
     (rec__algorithm__controller__robot
     (let ((subject this__split_fields)) this__split_fields22))))) false)
  (= 1000 (to_rep11
          (rec__algorithm__gap_vectors__list__capacity
          (us_split_discrs5
          (rec__algorithm__controller__gapvec
...
;; H
  (assert
  (and (= o40 (norm (mk___rep1 disttogoal__split_fields2)))
  (and (fp.isFinite32 o40)
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o40)
  (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) o40)
  (not (= (oeq (mk___rep1 disttogoal__split_fields2) zero_position) true)))))))

;; H
  (assert
  (and
  (= o41 (fp.sub RNE (to_rep3
                     (rec__robot_iface__proxy__max_range
                     (us_split_fields9
                     (rec__algorithm__controller__robot
                     (let ((subject this__split_fields))
                     this__split_fields22))))) (to_rep3
                                               (rec__robot_iface__proxy__robot_radius
                                               (us_split_fields9
                                               (rec__algorithm__controller__robot
                                               (let ((subject this__split_fields))
                                               this__split_fields22)))))))
...
;; H
  (assert (= o42 (fp.min o41 o40)))

;; H
  (assert (= o39 (bearing (mk___rep1 disttogoal__split_fields2))))

;; H
  (assert
  (= result17 (isfilterclear
              (rec__algorithm__controller__laserscan
              (let ((subject this__split_fields)) this__split_fields22))
              o39
              (to_rep3
...
;; H
  ...
  (fp.eq o54 (fp #b0 #b00000000 #b00000000000000000000000)))
  (fp.eq o55 (fp #b0 #b00000000 #b00000000000000000000000))))))

;; H
  (assert
  (= algorithm__step__B_18__safetydeltaangle__assume (create__2 o55)))
...
;; H
  (assert (and (= o58 (dcast safetydeltaangle)) (fp.isFinite32 o58)))

;; H
  (assert
  (= o59 (fp.mul RNE (of_int RNE
                     (to_rep9
                     ...
                     (rec__algorithm__valley_option__value
                     (let ((subject pbestvalley__split_fields))
                     pbestvalley__split_fields1)))))))) o58)))

;; H
  (assert (and (= o60 o59) (fp.isFinite32 o59)))

;; H
  (assert (= o61 (create__2 o60)))
...
;; H
  ...
  (= temp___965 (osubtract
                ...
                (rec__algorithm__valley_option__value
                (let ((subject pbestvalley__split_fields))
                pbestvalley__split_fields1)))))) o61)))

;; H
  (assert
  (= result20 (mk___split_fields__ref saferisinggapangle__split_fields1)))
