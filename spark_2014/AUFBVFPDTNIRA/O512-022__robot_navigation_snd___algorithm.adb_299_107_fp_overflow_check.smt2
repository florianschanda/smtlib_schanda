...
(define-fun o31 () us_rep4 (mk___rep3
                           (mk___split_fields3
                           (mk___rep (mk___split_fields o9)) o10 o11)))

(define-fun o32 () us_rep4 (mk___rep3
                           (mk___split_fields3
...
;; H
  (assert
  (=> (= result2 true)
  (= temp___1100 (mk___rep7 (us_split_fields__content7 this__split_fields)))))

;; H
  (assert
  (=> (= result2 true)
  (= iterl__split_fields2 (mk___split_fields2 temp___1099))))

;; H
  (assert
  (=> (= result2 true)
  (= iterr__split_fields1 (mk___split_fields2 temp___1098))))
...
;; H
  ...
  (=> (= result2 true)
  (=> (= result3 true)
  (=> (= (distinct 0 0) true) (= o24 (us_split_fields7 o23))))))

;; H
  (assert
  (=> (= result2 true)
  (=> (= result3 true)
  (=> (= (distinct 0 0) true) (= o25 (rec__gaps__gap__bearing o24))))))
...
;; H
  ...
  (=> (= result2 true)
  (=> (= result3 true)
  (= result6 (bool_eq4 (mk___rep2 iterr__split_fields2) o27)))))
...
;; H
  ...
  (= (bool_eq4 (mk___rep2 iterr__split_fields3) no_element) true))
  (= (range_equal
     (model__
     (mk___rep1
     (us_split_discrs1
     ...
     (- (get1
        ...
        (rec__algorithm__controller__gapvec
        (let ((subject this__split_fields)) this__split_fields2)))))
        (mk___rep2 iterr__split_fields2)) 1)) true))
  (= (range_shifted
     (model__
     (mk___rep1
     (us_split_discrs1
...
;; H
  ...
  (= (bool_eq4 temp___1096 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields3))) temp___1096) true)
  (= (get1
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields3))) temp___1096) 1))))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (= result6 true)
  (= result8 (mk___split_fields__ref2 iterl__split_fields3))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (= result6 true)
  (= iterl__split_fields4 (us_split_fields5 temp___1096))))))
...
;; H
  ...
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields2))) temp___1091) true)
  (= (get1
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields2))) temp___1091) (-
  (get1
  (positions
  (rec__algorithm__controller__gapvec
  (let ((subject this__split_fields)) this__split_fields2)))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result6 true))
  (= result9 (mk___split_fields__ref2 iterl__split_fields3))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result6 true))
  (= iterl__split_fields5 (us_split_fields5 temp___1091))))))
...
;; H
  ...
  (= (length1
     ...
     algorithm__gap_vectors__delete__container__fields1)) (- (length1
                                                             ...
                                                             this__split_fields))
                                                             this__split_fields2))))) 1))
  (= (bool_eq4 (mk___rep2 iterr__split_fields4) no_element) true))
  (= (range_equal
     (model__
     (mk___rep1
     (us_split_discrs1
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result6 true))
  (ite (= (ite (= (bool_eq4 (mk___rep2 iterl__split_fields5) no_element) false) (=
          (get1
          (positions
          (rec__algorithm__controller__gapvec
          (let ((subject this__split_fields)) this__split_fields4)))
          (mk___rep2 iterl__split_fields5)) (length1
                                            (rec__algorithm__controller__gapvec
                                            (let ((subject this__split_fields))
                                            this__split_fields4)))) true) true)
  (= (bool_eq4 (mk___rep2 iterl__split_fields6) no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields4)))
     (mk___rep2 iterl__split_fields6)) true)
  (= (get1
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields4)))
     (mk___rep2 iterl__split_fields6)) (+ (get1
                                          (positions
                                          (rec__algorithm__controller__gapvec
                                          (let ((subject this__split_fields))
                                          this__split_fields4)))
                                          (mk___rep2 iterl__split_fields5)) 1))))))))
...
;; H
  (assert
  (=> (= result2 true)
  (= result11 (mk___split_fields__ref2 iterr__split_fields3))))
...
;; H
  (assert
  (=> (= result2 true)
  (ite (= (ite (= (bool_eq4 (mk___rep2 iterl__split_fields4) no_element) false) (=
          (get1
          (positions
          (rec__algorithm__controller__gapvec
          (let ((subject this__split_fields)) this__split_fields3)))
          (mk___rep2 iterl__split_fields4)) (length1
                                            (rec__algorithm__controller__gapvec
                                            (let ((subject this__split_fields))
                                            this__split_fields3)))) true) true)
  (= (bool_eq4 (mk___rep2 iterl__split_fields7) no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields3)))
     (mk___rep2 iterl__split_fields7)) true)
  (= (get1
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields3)))
     (mk___rep2 iterl__split_fields7)) (+ (get1
                                          (positions
                                          (rec__algorithm__controller__gapvec
                                          (let ((subject this__split_fields))
                                          this__split_fields3)))
                                          (mk___rep2 iterl__split_fields4)) 1))))))

;; H
  (assert
  (=> (= result2 true)
  (=>
  (and (not (= (bool_eq4 (mk___rep2 iterl__split_fields7) no_element) true))
  (not (= (bool_eq4 (mk___rep2 iterr__split_fields5) no_element) true)))
  (and
  (= o28 (length1
         (rec__algorithm__controller__gapvec
         (let ((subject this__split_fields)) this__split_fields3))))
...
;; H
  (assert
  (=> (= result2 true)
  (= iterl__split_fields8 (mk___split_fields__ref2 iterl__split_fields7))))

;; H
  (assert
  (=> (= result2 true)
  (= iterr__split_fields6 (mk___split_fields__ref2 iterr__split_fields5))))
...
;; H
  (assert
  (=> (not (= result2 true))
  (= iterl__split_fields10 (mk___split_fields__ref2 iterl__split_fields2))))

;; H
  (assert
  (=> (not (= result2 true))
  (= iterr__split_fields8 (mk___split_fields__ref2 iterr__split_fields1))))
...
;; H
  ...
  (=>
  (not
  (= (bool_eq4 (mk___rep2 (us_split_fields__content2 iterr__split_fields8))
     no_element) true))
  (and
  (= o30 (length1
         (rec__algorithm__controller__gapvec
...
;; H
  ...
  (= (bool_eq4 temp___1102 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
     (us_split_fields__content7 this__split_fields7))) temp___1102) true)
  (= (get1
     (positions
     (rec__algorithm__controller__gapvec
     (us_split_fields__content7 this__split_fields7))) temp___1102) 1)))))
