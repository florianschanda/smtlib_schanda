...
(define-fun temp___10881 () us_rep5 (mk___rep5
                                    (mk___split_fields5 temp___1088)))
...
;; H
  ...
  (= (bool_eq8 temp___10881 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
...
;; H
  (assert
  (=> (= result2 true)
  (= iterl__split_fields2 (mk___split_fields5 temp___1099))))

;; H
  (assert
  (=> (= result2 true)
  (= iterr__split_fields1 (mk___split_fields5 temp___1098))))
...
;; H
  ...
  (= (bool_eq8 temp___1096 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
...
;; H
  ...
  (=> (= result3 true)
  (=> (= result6 true)
  (= iterl__split_fields4 (us_split_fields11 temp___1096))))))
...
;; H
  ...
  (= (bool_eq8 temp___1091 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result6 true))
  (= iterl__split_fields5 (us_split_fields11 temp___1091))))))
...
;; H
  ...
  (= (bool_eq8 temp___1102 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
