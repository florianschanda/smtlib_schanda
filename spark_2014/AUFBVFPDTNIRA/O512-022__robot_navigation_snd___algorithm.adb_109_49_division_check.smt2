...
(define-fun dynamic_invariant5 ((temp___expr_155 Float32)
  ...
  (temp___do_toplevel_154 Bool)) Bool (=>
                                      ...
                                      (in_range5 temp___expr_155)))

(define-fun dynamic_invariant6 ((temp___expr_179 Float32)
