...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 2)) (= temp___169 kvp1)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 2)) (= temp___168 i1)))
...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 2))
  (and
  (and (=> (<= 1 2) (in_range3 i2))
  (forall ((temp___170 Int))
  (=> (and (<= 1 temp___170) (<= temp___170 2))
  (=> (<= i2 temp___170)
  (= (select kvp2 temp___170) (select temp___169 temp___170))))))
  (and (<= 1 i2) (<= i2 2)))))
...
;; H
  (assert
  (= kvmax1 (temp___173 (fp #b0 #b00000000 #b00000000000000000000000))))
...
;; H
  (assert
  (= kamax1 (temp___177 (fp #b0 #b00000000 #b00000000000000000000000))))
