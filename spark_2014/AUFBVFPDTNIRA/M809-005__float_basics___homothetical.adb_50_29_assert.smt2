...
(declare-const temp___196 (Array Int float))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 2)) (= temp___196 kvp1)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 2)) (= temp___195 i1)))
...
;; H
  ...
  (=> (and (<= 1 temp___197) (<= temp___197 2))
  (=> (or (< 2 temp___197) (or (< temp___197 1) (<= i2 temp___197)))
  (= (select kvp2 temp___197) (select temp___196 temp___197))))))
  (and (<= 1 i2) (<= i2 2)))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 2)) (= (to_rep o1) o)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 2)) (= o2 (store kvp2 i2 o1))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 2)) (= kvp2 result4)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 2)) (= kvp3 o2)))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 2)) (= kvp3 kvp4)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 2)) (= i4 i2)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 2)) (= kvp5 kvp3)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 2)) (= (mk_int__ref i5) (mk_int__ref i3))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 2)) (= (mk_map__ref kvp6) (mk_map__ref kvp4))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 2)) (= i6 i4)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 2)) (= kvp7 kvp5)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 2))) (= i1 i5)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 2))) (= kvp1 kvp6)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 2))) (= i6 i1)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 2))) (= kvp7 kvp1)))

;; H
  (assert (= result5 kvmax))

;; H
  (assert
  (= kvmax1 (temp_____aggregate_def_198
            (fp #b0 #b00000000 #b00000000000000000000000))))

;; H
  (assert (= result6 (mk_map__ref kamax)))

;; H
  (assert
  (= kamax1 (temp_____aggregate_def_202
            (fp #b0 #b00000000 #b00000000000000000000000))))
...
;; WP_parameter_def
 ;; File "homothetical.adb", line 48, characters 0-0
  (not
  (not (fp.eq (to_rep (select kvp6 i7)) (fp #b0 #b00000000 #b00000000000000000000000)))))
(check-sat)
(exit)
