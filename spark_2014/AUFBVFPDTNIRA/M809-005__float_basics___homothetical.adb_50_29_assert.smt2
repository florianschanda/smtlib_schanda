...
;; H
  ...
  (fp.leq o (to_rep (select kv i3)))))) (= (to_rep o1) o))
  (= o2 (store kvp2 i3 o1))) (and (= kvp2 result4) (= kvp3 o2))) (= i3 2))))))
  (and (and (= i3 i7) (= kvp3 kvp6)) (and (= i8 i3) (= kvp7 kvp3))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 2)) (= (mk_int__ref i9) (mk_int__ref i7))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 2)) (= (mk_map__ref kvp8) (mk_map__ref kvp6))))

;; H
  (assert (=> (and (<= 1 i2) (<= i2 2)) (= i10 i8)))

;; H
  (assert (=> (and (<= 1 i2) (<= i2 2)) (= kvp9 kvp7)))

;; H
  (assert (=> (not (and (<= 1 i2) (<= i2 2))) (= i2 i9)))

;; H
  (assert (=> (not (and (<= 1 i2) (<= i2 2))) (= kvp1 kvp8)))

;; H
  (assert (=> (not (and (<= 1 i2) (<= i2 2))) (= i10 i2)))

;; H
  (assert (=> (not (and (<= 1 i2) (<= i2 2))) (= kvp9 kvp1)))

;; H
  (assert (= result6 kvmax))
...
;; H
  (assert (= result7 (mk_map__ref kamax)))
