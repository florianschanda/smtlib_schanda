...
(declare-const temp___194 (Array Int float))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 2)) (= temp___194 kvp1)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 2)) (= temp___193 i1)))
...
;; H
  ...
  (=> (<= i2 temp___195)
  (= (select kvp2 temp___195) (select temp___194 temp___195))))))
  (and (<= 1 i2) (<= i2 2)))))
...
;; H
  (assert
  (= kvmax1 (temp___198 (fp #b0 #b00000000 #b00000000000000000000000))))
...
;; H
  (assert
  (= kamax1 (temp___202 (fp #b0 #b00000000 #b00000000000000000000000))))
