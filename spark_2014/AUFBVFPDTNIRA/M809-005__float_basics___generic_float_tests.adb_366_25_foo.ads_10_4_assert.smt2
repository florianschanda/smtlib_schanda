...
;; H
  (assert (fp.eq x (fp #b0 #b01111110 #b00110011001100110011010)))

;; H
  (assert
  (fp.eq (fp.roundToIntegral RTN x) (fp #b0 #b00000000 #b00000000000000000000000)))

(assert
;; WP_parameter_def
 ;; File "generic_float_tests.adb", line 345, characters 0-0
  (not
  (fp.eq (fp.roundToIntegral RTP x) (fp #b0 #b01111111 #b00000000000000000000000))))
(check-sat)
(exit)
