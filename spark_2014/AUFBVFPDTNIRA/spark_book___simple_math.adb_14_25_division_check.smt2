...
(declare-fun dummy () square_root_domain)
...
(declare-fun dummy1 () square_root_range)
...
;; H
  (assert
  (and (=> (<= 0 1000000) (in_range r1)) (=> (<= 0 1000000) (in_range q2))))

;; H
  (assert (and (= o (div1 n q2)) (in_range (div1 n q2))))
