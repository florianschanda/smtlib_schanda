...
;; H
  (assert (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111))
  x))

;; H
  (assert (fp.leq x (fp #b0 #b11111110 #b11111111111111111111111)))

;; H
  (assert
  (= type_conversion__float_to_long_float__result type_conversion__float_to_long_float__result1))

;; H
  (assert
  (= type_conversion__float_to_long_float__result ((_ to_fp 11 53) RNE
  x)))

;; H
  (assert
  (= (mk_t__ref1 type_conversion__float_to_long_float__result2) (mk_t__ref1
                                                                type_conversion__float_to_long_float__result1)))

(assert
;; WP_parameter_def
 ;; File "/home/florian/adacore/spark2014/testsuite/gnatprove/tests/NC04-023__float_conversion/gnatprove/type_conversion.mlw", line 2072, characters 5-8
  (not
