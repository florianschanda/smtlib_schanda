...
;; H
  (assert
  (and
  (and (= o9 (dcast safetydeltaangle)) (dcast__function_guard o9
  safetydeltaangle)) (not (or (fp.isInfinite o9) (fp.isNaN o9)))))
...
;; H
  (assert (and (= o12 (create__2 o11)) (create__2__function_guard o12 o11)))

;; H
  (assert
  (and
  (= temp___993 (osubtract
  ...
  (osubtract__function_guard temp___993
  (rec__gaps__gap__bearing
  (us_split_fields11
  (rec__valleys__valley__risinggap
  (us_split_fields13
...
;; H
  (assert
  (= saferisinggapangle__split_fields2 (us_split_fields1 temp___993)))
