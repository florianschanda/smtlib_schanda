...
(declare-fun count19 () int__ref)

(declare-fun count20 () Int)
...
;; H
  (assert
  (=> (and (<= 5 count3) (<= count3 8)) (and (<= 5 count4) (<= count4 8))))

;; H
  (assert (=> (and (<= 5 count3) (<= count3 8)) (= count4 8)))

;; H
  (assert
  (=> (and (<= 5 count3) (<= count3 8)) (= count5 (mk_int__ref count4))))

;; H
  (assert (=> (and (<= 5 count3) (<= count3 8)) (= count6 count4)))

;; H
  (assert (=> (and (<= 5 count3) (<= count3 8)) (= count7 count5)))

;; H
  (assert (=> (and (<= 5 count3) (<= count3 8)) (= count8 count6)))

;; H
  (assert
  (=> (not (and (<= 5 count3) (<= count3 8)))
  (= count7 (mk_int__ref count3))))

;; H
  (assert (=> (not (and (<= 5 count3) (<= count3 8))) (= count8 count3)))

;; H
  (assert (= result51 count1))

;; H
  (assert (= (let ((subject count1)) count9) 8))

;; H
  (assert
  (=>
  (and (<= 5 (let ((subject count1)) count9))
  (<= (let ((subject count1)) count9) 8))
...
;; H
  ...
  (and (<= 5 (let ((subject count1)) count9))
  (<= (let ((subject count1)) count9) 8))
  (= count11 (let ((subject count1)) (mk_int__ref count10)))))

;; H
  (assert
  (=>
  (and (<= 5 (let ((subject count1)) count9))
  (<= (let ((subject count1)) count9) 8)) (= count12 count10)))

;; H
  (assert
  (=>
  (and (<= 5 (let ((subject count1)) count9))
  (<= (let ((subject count1)) count9) 8)) (= count13 count11)))

;; H
  (assert
  (=>
  (and (<= 5 (let ((subject count1)) count9))
  (<= (let ((subject count1)) count9) 8)) (= count14 count12)))
...
;; H
  ...
  (and (<= 5 (let ((subject count1)) count9))
  (<= (let ((subject count1)) count9) 8)))
  (= count13 (let ((subject count1)) (mk_int__ref count9)))))
...
;; H
  ...
  (not
  (and (<= 5 (let ((subject count1)) count9))
  (<= (let ((subject count1)) count9) 8))) (= count14 count9)))
...
;; H
  (assert (= (let ((subject count2)) count15) r4b))

;; H
  (assert
  (=>
  (and (<= r4b (let ((subject count2)) count15))
  (<= (let ((subject count2)) count15) r5b))
...
;; H
  ...
  (and (<= r4b (let ((subject count2)) count15))
  (<= (let ((subject count2)) count15) r5b))
  (= count17 (let ((subject count2)) (mk_int__ref count16)))))

;; H
  (assert
  (=>
  (and (<= r4b (let ((subject count2)) count15))
  (<= (let ((subject count2)) count15) r5b)) (= count18 count16)))

;; H
  (assert
  (=>
  (and (<= r4b (let ((subject count2)) count15))
  (<= (let ((subject count2)) count15) r5b)) (= count19 count17)))

;; H
  (assert
  (=>
  (and (<= r4b (let ((subject count2)) count15))
  (<= (let ((subject count2)) count15) r5b)) (= count20 count18)))
...
;; H
  ...
  (and (<= r4b (let ((subject count2)) count15))
  (<= (let ((subject count2)) count15) r5b)))
  (= count19 (let ((subject count2)) (mk_int__ref count15)))))
...
;; H
  ...
  (not
  (and (<= r4b (let ((subject count2)) count15))
  (<= (let ((subject count2)) count15) r5b))) (= count20 count15)))
