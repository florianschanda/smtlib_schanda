...
;; H
  (assert (=> (not (= result39 true)) (= result38 (of_int 1))))
...
;; H
  (assert (=> (not (< a2 0)) (= result42 (of_int 1))))
...
;; H
  (assert
  (=>
  (and (<= r4b (let ((subject count2)) count11))
  (<= (let ((subject count2)) count11) r5b))
...
;; H
  ...
  (and (<= r4b (let ((subject count2)) count11))
  (<= (let ((subject count2)) count11) r5b))
  (= count13 (let ((subject count2)) (mk_int__ref count12)))))

;; H
  (assert
  (=>
  (and (<= r4b (let ((subject count2)) count11))
  (<= (let ((subject count2)) count11) r5b)) (= count14 count12)))

;; H
  (assert
  (=>
  (and (<= r4b (let ((subject count2)) count11))
  (<= (let ((subject count2)) count11) r5b)) (= count15 count13)))

;; H
  (assert
  (=>
  (and (<= r4b (let ((subject count2)) count11))
  (<= (let ((subject count2)) count11) r5b)) (= count16 count14)))
...
;; H
  ...
  (and (<= r4b (let ((subject count2)) count11))
  (<= (let ((subject count2)) count11) r5b)))
  (= count15 (let ((subject count2)) (mk_int__ref count11)))))
...
;; H
  ...
  (not
  (and (<= r4b (let ((subject count2)) count11))
  (<= (let ((subject count2)) count11) r5b))) (= count16 count11)))
