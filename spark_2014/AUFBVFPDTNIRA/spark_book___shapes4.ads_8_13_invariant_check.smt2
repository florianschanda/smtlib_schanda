...
(declare-fun shapes4__make_circle__result () coordinate_type)

(declare-fun shapes4__make_circle__result1 () coordinate_type)

(declare-fun shapes4__make_circle__result2 () radius_type)
...
(declare-fun shapes4__make_circle__result3 () coordinate_type)

(declare-fun shapes4__make_circle__result4 () coordinate_type)

(declare-fun shapes4__make_circle__result5 () radius_type)

(declare-fun shapes4__make_circle__result6 () coordinate_type)

(declare-fun shapes4__make_circle__result7 () coordinate_type)

(declare-fun shapes4__make_circle__result8 () radius_type)

(declare-fun shapes4__make_circle__result9 () coordinate_type)

(declare-fun shapes4__make_circle__result10 () coordinate_type)

(declare-fun shapes4__make_circle__result11 () radius_type)

(declare-fun r6 () int__ref)

(declare-fun shapes4__make_circle__result12 () circle__ref)

(declare-fun r7 () Int)

(declare-fun shapes4__make_circle__result13 () us_rep)

(define-fun shapes4__make_circle__result14 () us_rep (mk___rep
                                                     (mk___split_fields
                                                     shapes4__make_circle__result9
                                                     shapes4__make_circle__result10
                                                     shapes4__make_circle__result11)))

(define-fun shapes4__make_circle__result15 () us_rep (mk___rep
                                                     (mk___split_fields
                                                     shapes4__make_circle__result3
                                                     shapes4__make_circle__result4
                                                     shapes4__make_circle__result5)))
...
;; H
  (assert (= shapes4__make_circle__result6 shapes4__make_circle__result3))

;; H
  (assert (= shapes4__make_circle__result7 shapes4__make_circle__result4))

;; H
  (assert (= shapes4__make_circle__result8 shapes4__make_circle__result5))

;; H
  (assert (= shapes4__make_circle__result14 shapes4__make_circle__result15))
...
;; H
  (assert (= result5 shapes4__make_circle__result))

;; H
  (assert (= result6 shapes4__make_circle__result1))

;; H
  (assert (= result7 shapes4__make_circle__result2))

;; H
  (assert
  (= shapes4__make_circle__result15 (mk___rep
                                    (mk___split_fields o10 o11 o12))))

;; H
  (assert
  (= shapes4__make_circle__result12 (mk_circle__ref
                                    (mk___rep
                                    (mk___split_fields
                                    shapes4__make_circle__result6
                                    shapes4__make_circle__result7
                                    shapes4__make_circle__result8)))))

;; H
  (assert (= r6 (mk_int__ref r5)))

;; H
  (assert (= shapes4__make_circle__result13 shapes4__make_circle__result14))
...
;; WP_parameter_def
 ;; File "shapes4.ads", line 16, characters 0-0
  (not
  (= (in_bounds (circle__content shapes4__make_circle__result12)) true)))
(check-sat)
