...
;; H
  (assert (= result6 (bool_eq21 (mk___rep5 iterr__split_fields2) o27)))
...
;; H
  (assert (= result7 (mk___split_fields__ref5 iterl__split_fields3)))

;; H
  (assert (= iterl__split_fields4 (us_split_fields11 temp___1022)))
