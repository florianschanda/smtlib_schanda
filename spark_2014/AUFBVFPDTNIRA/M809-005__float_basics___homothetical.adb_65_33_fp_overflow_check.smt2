...
(declare-fun o20 () (Array Int float))
...
(declare-fun o27 () (Array Int float))

(declare-fun o28 () Float32)

(declare-fun o29 () float)

(declare-fun o30 () (Array Int float))
...
(declare-fun lambda3 () map__ref)

(declare-fun upsilon3 () map__ref)
...
(declare-fun lambda5 () (Array Int float))

(declare-fun result9 () map__ref)

(declare-fun upsilon5 () (Array Int float))

(declare-fun lambda6 () map__ref)

(declare-fun upsilon6 () map__ref)

(declare-fun lambda7 () (Array Int float))

(declare-fun upsilon7 () (Array Int float))
...
;; H
  ...
  (not (or (fp.isInfinite (fp.mul RNE (to_rep (select kvp2 i1)) (fp.abs
  (to_rep (select d j2))))) (fp.isNaN (fp.mul RNE (to_rep (select kvp2 i1)) (fp.abs
  (to_rep (select d j2))))))))))
...
;; H
  ...
  (to_rep (select d i1))))) (fp.isNaN (fp.mul RNE (to_rep (select kvp2 j2)) (fp.abs
  (to_rep (select d i1))))))))))
...
;; H
  ...
  (not (or (fp.isInfinite (fp.mul RNE (to_rep (select ka i1)) (fp.abs
  (to_rep (select d j2))))) (fp.isNaN (fp.mul RNE (to_rep (select ka i1)) (fp.abs
  (to_rep (select d j2))))))))))
...
;; H
  ...
  (to_rep (select d i1))))) (fp.isNaN (fp.mul RNE (to_rep (select ka j2)) (fp.abs
  (to_rep (select d i1))))))))))
...
;; H
  ...
  (not (or (fp.isInfinite (fp.mul RNE (to_rep
                                      ...
                                      i1)) (to_rep (select kvp2 i1)))) (fp.isNaN (fp.mul RNE
  (to_rep (select (map__content lambda6) i1)) (to_rep (select kvp2 i1))))))))
...
;; WP_parameter_def
 ;; File "homothetical.ads", line 5, characters 0-0
  ...
  (not (or (fp.isInfinite (fp.mul RNE (to_rep
                                      ...
                                      i1)) (to_rep (select ka i1)))) (fp.isNaN (fp.mul RNE
  (to_rep (select (map__content upsilon6) i1)) (to_rep (select ka i1))))))))
(check-sat)
(exit)
