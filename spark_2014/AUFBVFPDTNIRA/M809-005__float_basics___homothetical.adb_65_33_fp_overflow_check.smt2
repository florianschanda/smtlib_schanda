...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 2))
  (=> (not (= i2 j2)) (= o4 (fp.min (to_rep (select lambda3 i2)) o3)))))
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 2))
  (=> (not (= i2 j2)) (= o11 (fp.min (to_rep (select upsilon3 i2)) o10)))))
...
;; H
  (assert
  (and
  (= o14 (fp.mul RNE (to_rep (select (map__content lambda9) i2)) (to_rep
                                                                 (select 
                                                                 kvp2 
                                                                 i2))))
