...
;; H
  (assert
  (and
  (= (mk___rep2 (mk___split_discrs2 main__y__assume)
     (mk___split_fields2
     (mk___rep (mk___split_discrs main__y__assume1)
     (mk___split_fields main__y__assume2 main__y__assume3)))) (build_rec_ok
                                                              2))
  (dynamic_invariant1
  (mk___rep2 (mk___split_discrs2 main__y__assume)
  (mk___split_fields2
  (mk___rep (mk___split_discrs main__y__assume1)
  (mk___split_fields main__y__assume2 main__y__assume3)))) true false true)))

;; H
  (assert
  (= result1 (mk___split_fields__ref2
             (mk___split_fields2
             (mk___rep (mk___split_discrs y__split_fields)
             (mk___split_fields y__split_fields1 y__split_fields2))))))

;; H
  (assert
  (= y__split_fields3 (mk___split_fields2
                      (mk___rep (mk___split_discrs main__y__assume1)
                      (mk___split_fields main__y__assume2 main__y__assume3)))))

;; H
  (assert (= y__split_discrs (mk___split_discrs2 main__y__assume)))

;; H
  (assert (dynamic_invariant1 (mk___rep2 y__split_discrs y__split_fields3)
  true false true))
