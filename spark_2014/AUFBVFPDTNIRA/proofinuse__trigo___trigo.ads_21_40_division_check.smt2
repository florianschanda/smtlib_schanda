...
;; H
  (assert
  (and (and (= o3 (pow8 x)) (pow8__function_guard o3 x))
  (and (not (or (fp.isInfinite o3) (fp.isNaN o3)))
  (= o3 (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE 
  x x) x) x) x) x) x) x)))))

;; H
  (assert
  (= o4 (fp.div RNE o3 (fp #b0 #b10001110 #b00111011000000000000000))))

;; H
  (assert
  (and (and (= o1 (pow6 x)) (pow6__function_guard o1 x))
  (and (not (or (fp.isInfinite o1) (fp.isNaN o1)))
  (= o1 (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE x 
  x) x) x) x) x)))))

;; H
  (assert
  (= o2 (fp.div RNE o1 (fp #b0 #b10001000 #b01101000000000000000000))))

;; H
  (assert
  (and (and (= o (pow4 x)) (pow4__function_guard o x))
  (and (not (or (fp.isInfinite o) (fp.isNaN o)))
  (= o (fp.mul RNE (fp.mul RNE (fp.mul RNE x x) x) x)))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (not
  (fp.eq (fp #b0 #b10000011 #b10000000000000000000000) ((_ to_fp 8 24) #x00000000)))))
(check-sat)
