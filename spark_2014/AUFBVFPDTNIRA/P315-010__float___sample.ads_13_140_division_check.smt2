...
(declare-fun float_tested () Float32)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun float_ref () Float32)
...
;; H
  (assert (not (or (fp.isInfinite float_tested) (fp.isNaN float_tested))))

;; H
  (assert (not (or (fp.isInfinite float_ref) (fp.isNaN float_ref))))

;; H
  (assert (neq float_ref (fp #b0 #b00000000 #b00000000000000000000000)))
