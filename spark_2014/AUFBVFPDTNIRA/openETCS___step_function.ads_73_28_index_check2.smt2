...
;; H
  (assert (=> (and (<= 0 i2) (<= i2 r10b)) (= temp___306 min1)))

;; H
  (assert (=> (and (<= 0 i2) (<= i2 r10b)) (= temp___305 i2)))
...
;; H
  ...
  (<= (to_rep2
      ...
      (us_split_fields1
      (select (rec__step_function__step_function_t__step
              (us_split_fields3 sfun)) i10)))) x)
  (fp.eq (t__content step_function__minimum_until_point__result4) (to_rep
                                                                  (rec__step_function__delimiter_entry__value
                                                                  (us_split_fields1
                                                                  (select
                                                                  (rec__step_function__step_function_t__step
