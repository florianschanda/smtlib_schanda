...
(declare-const dummy3 r_raw_index)

(declare-datatypes ((r_raw_index__ref 0))
(((mk_r_raw_index__ref (r_raw_index__content r_raw_index)))))
...
;; def_axiom
  ...
  (= (select (p__null_raw_r__aggregate_def temp___134) temp___135) (of_rep2
                                                                   temp___134)))))
...
;; null_raw_r__def_axiom
  (assert (= null_raw_r (p__null_raw_r__aggregate_def ((_ int2bv 8) 0))))
...
(declare-const temp___268 integer)

(declare-const temp___2681 float)
...
(declare-const full_s__split_fields4 integer)

(declare-const full_s__split_fields5 float)

(declare-const raw_s1 (Array Int unsigned_8))

(declare-const full_s__split_fields6 integer)

(declare-const full_s__split_fields7 float)

(declare-const raw_s2 (Array Int unsigned_8))
...
;; H
  (assert (= temp___268 o2))

;; H
  (assert (= temp___2681 o3))

;; H
  (assert (= (mk___rep (mk___split_fields temp___268 temp___2681)) null_r))

;; H
  (assert (= (p__null_raw_r__aggregate_def ((_ int2bv 8) 0)) null_raw_r))
