...
(declare-fun dummy4 () tname_stringP1)

(declare-datatypes ()
((tname_stringP1__ref
 (mk_tname_stringP1__ref (tname_stringP1__content tname_stringP1)))))
(define-fun tname_stringP1__ref___projection ((a tname_stringP1__ref)) tname_stringP1 
  (tname_stringP1__content a))

(declare-fun currency () us_t)
...
;; temp___String_Literal_151__def_axiom
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 1)) 68)
     ...
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 5)) 97))
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 6)) 114))
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 7)) 115)) :pattern (
...
(declare-fun dummy5 () tTaddressSP1)

(declare-datatypes ()
((tTaddressSP1__ref
 (mk_tTaddressSP1__ref (tTaddressSP1__content tTaddressSP1)))))
(define-fun tTaddressSP1__ref___projection ((a tTaddressSP1__ref)) tTaddressSP1 
  (tTaddressSP1__content a))
...
(declare-fun dummy6 () tTcitySP1)

(declare-datatypes ()
((tTcitySP1__ref (mk_tTcitySP1__ref (tTcitySP1__content tTcitySP1)))))
(define-fun tTcitySP1__ref___projection ((a tTcitySP1__ref)) tTcitySP1 
  (tTcitySP1__content a))
...
(declare-fun temp___539 (Int) (Array Int character))

;; def_axiom
  (assert
  (forall ((temp___541 Int))
  (forall ((temp___542 Int))
  (= (select (temp___539 temp___541) temp___542) (of_rep temp___541)))))

(declare-fun temp___String_Literal_543 (tuple0) (Array Int character))

;; temp___String_Literal_543__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (and
     (and
     (and
     (and
     (= (to_rep (select (temp___String_Literal_543 us_void_param) 1)) 80)
     (= (to_rep (select (temp___String_Literal_543 us_void_param) 2)) 101))
     (= (to_rep (select (temp___String_Literal_543 us_void_param) 3)) 116))
     (= (to_rep (select (temp___String_Literal_543 us_void_param) 4)) 101))
     (= (to_rep (select (temp___String_Literal_543 us_void_param) 5)) 114)) :pattern (
  (temp___String_Literal_543 us_void_param)) )))
...
;; temp___String_Literal_549__def_axiom
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_549 us_void_param) 1)) 80)
     (= (to_rep (select (temp___String_Literal_549 us_void_param) 2)) 101))
     (= (to_rep (select (temp___String_Literal_549 us_void_param) 3)) 116))
     (= (to_rep (select (temp___String_Literal_549 us_void_param) 4)) 101))
     (= (to_rep (select (temp___String_Literal_549 us_void_param) 5)) 114)) :pattern (
...
;; currency__def_axiom
  (assert (= currency (of_array (temp___String_Literal_151 Tuple0) 1 7)))

(declare-fun count () Int)

(declare-fun name () (Array Int character))

(declare-fun address () (Array Int character))

(declare-fun city () (Array Int character))
...
(declare-fun address1 () (Array Int character))

(declare-fun result1 () (Array Int character))

(declare-fun name1 () (Array Int character))

(declare-fun result2 () (Array Int character))

(declare-fun name2 () (Array Int character))

(declare-fun result3 () (Array Int character))

(declare-fun address2 () (Array Int character))

(declare-fun result4 () (Array Int character))

(declare-fun city1 () (Array Int character))

(declare-fun result5 () (Array Int character))

(declare-fun name3 () (Array Int character))

;; H
  (assert (=> (<= (- 2147483648) 2147483647) (in_range count)))

;; H
  (assert (dynamic_invariant1 currency true false true))

;; H
  (assert (= result address))

;; H
  (assert (= address1 (temp___539 32)))
...
;; H
  (assert (= o1 (temp___String_Literal_543 Tuple0)))
