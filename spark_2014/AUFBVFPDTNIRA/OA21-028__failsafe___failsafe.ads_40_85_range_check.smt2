...
;; H
  ...
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) #x32)
  (= temp___303 (bvsub current_time o9))))

;; H
  (assert
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) #x32)
  (and (= o10 (t__content failsafe__model__time_below_threshold__result4))
  (in_range1 (t__content failsafe__model__time_below_threshold__result4)))))
...
;; H
  ...
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) #x32)
  (= result8 (ite (bvult current_time o10) true false))))

;; H
  (assert
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) #x32)
  (=> (= result8 true) (= o11 (bvadd temp___303 #x32)))))

;; H
  (assert
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) #x32)
  (=> (not (= result8 true)) (= o11 temp___303))))

;; H
  (assert
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) #x32)
  (= o12 (select battery_level_at o11))))
...
;; H
  ...
  (=>
  (bvult (t__content failsafe__model__time_below_threshold__result4) #x32)
  (= result7 (ite (fp.leq battery_threshold o13) true false))))
...
;; H
  (assert
  (and
  (= o8 (bvsub (t__content failsafe__model__time_below_threshold__result4) #x01))
  (in_range1
  (bvsub (t__content failsafe__model__time_below_threshold__result4) #x01))))

;; H
  (assert (= temp___304 (bvsub current_time o8)))
