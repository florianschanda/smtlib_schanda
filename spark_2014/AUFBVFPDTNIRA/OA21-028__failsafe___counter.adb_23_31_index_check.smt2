...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 8) 1) k1) (bvule k1 (bvsub i2 ((_ int2bv 8) 1))))
  (= (= (select inputs1 k1) true)
  (= (select inputs (bvadd k1 ((_ int2bv 8) 1))) true))))
  (forall ((k1 (_ BitVec 8)))
  (=> (and (bvule i2 k1) (bvule k1 ((_ int2bv 8) 10)))
  (= (= (select inputs1 k1) true) (= (select inputs k1) true))))))
...
;; H
  (assert (bvule k ((_ int2bv 8) 10)))

;; H
  (assert (and (bvule ((_ int2bv 8) 1) k) (bvule k ((_ int2bv 8) 10))))

;; H
  (assert (= o k))

;; H
  (assert (= o1 (select inputs o)))

;; H
  (assert (= o2 (to_int2 o1)))
