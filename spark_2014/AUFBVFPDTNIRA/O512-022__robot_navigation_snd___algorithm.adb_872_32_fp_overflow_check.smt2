...
;; H
  (assert
  (= o140 (fp.div RNE o139 (fp #b0 #b01111110 #b00001100000101010010010))))
...
;; H
  (assert
  (and
  (= o142 (limit o141 (fp #b0 #b00000000 #b00000000000000000000000)
          (fp #b0 #b01111111 #b00000000000000000000000)))
  (and (fp.isFinite32 o142)
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o142)
  (fp.leq o142 (fp #b0 #b01111111 #b00000000000000000000000))))))
