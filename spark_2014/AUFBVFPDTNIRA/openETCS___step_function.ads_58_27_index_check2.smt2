...
;; H
  ...
  (= temp___267 (- (to_rep1
                   (rec__step_function__step_function_t__number_of_delimiters
                   (us_split_fields3 sfun))) 1))
  (and (and (= result4 i13) (= i2 temp___266))
  (and (and (<= temp___266 i2) (<= i2 temp___267))
  (and (= temp___272 i2)
  (and
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j i3))
  ...
  (and
  (and
  (and (and (= temp___270 (+ i3 1)) (in_range3 (+ i3 1)))
  (and (and (<= 0 temp___270) (<= temp___270 10)) (= o temp___270)))
