...
;; H
  (assert (no_char_in_slice__function_guard
  (no_char_in_slice 10 cur_position (- o24 1) the_file) 10 cur_position
  (- o24 1) the_file))
...
;; H
  (assert
  (and
  (and (= o24 (find_char_in_slice 10 cur_position o23 the_file))
  (find_char_in_slice__function_guard o24 10 cur_position o23 the_file))
  (and (in_range2 o24)
  (and (and (<= cur_position o24) (<= o24 o23))
  (and (= (no_char_in_slice 10 cur_position (- o24 1) the_file) true)
  (= (to_rep (select the_file o24)) 10))))))
