...
(define-fun bool_eq3 ((x1 Float32)
...
(define-fun dynamic_invariant2 ((temp___expr_1351 Float32)
  (temp___is_init_1348 Bool) (temp___skip_constant_1349 Bool)
  (temp___do_toplevel_1350 Bool)) Bool (=>
                                       (or (= temp___is_init_1348 true)
                                       (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)))
                                       (not (or (fp.isInfinite temp___expr_1351) (fp.isNaN temp___expr_1351)))))
...
(define-fun dynamic_invariant5 ((temp___expr_1369 Float32)
  (temp___is_init_1366 Bool) (temp___skip_constant_1367 Bool)
  (temp___do_toplevel_1368 Bool)) Bool (=>
                                       (or (= temp___is_init_1366 true)
                                       (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)))
                                       (not (or (fp.isInfinite temp___expr_1369) (fp.isNaN temp___expr_1369)))))
