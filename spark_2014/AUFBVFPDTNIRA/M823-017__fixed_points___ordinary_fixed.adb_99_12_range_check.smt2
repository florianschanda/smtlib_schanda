...
;; fxp_mult_def
  ...
  (! (ite (or (= x 0) (= y 0)) (= (fxp_mult x y) 0)
     ...
     (fxp_mult x y) (* x y) 400) (pos_div_relation (- (fxp_mult x y))
     (- (* x y)) 400))) :pattern ((fxp_mult x y)) ))))
...
;; fxp_div_def
  ...
  (! (ite (= x 0) (= (fxp_div x y) 0)
     (ite (and (< 0 x) (< 0 y)) (pos_div_relation (fxp_div x y) (* x 400) y)
     (ite (and (< x 0) (< y 0)) (pos_div_relation (fxp_div x y) (* (- x) 400)
     (- y))
     (ite (and (< x 0) (< 0 y)) (pos_div_relation (- (fxp_div x y))
     (* (- x) 400) y)
     (=> (and (< 0 x) (< y 0)) (pos_div_relation (- (fxp_div x y)) (* x 400)
...
;; to_int_def
  ...
  (forall ((x Int))
  (! (ite (= x 0) (= (to_int3 x) 0)
     (ite (< 0 x) (pos_div_relation (to_int3 x) x 400) (pos_div_relation
     (- (to_int3 x)) (- x) 400))) :pattern ((to_int3 x)) )))
...
;; fxp_mult_def
  ...
  (! (ite (or (= x 0) (= y 0)) (= (fxp_mult1 x y) 0)
     ...
     (fxp_mult1 x y) (* x y) 400) (pos_div_relation1 (- (fxp_mult1 x y))
     (- (* x y)) 400))) :pattern ((fxp_mult1 x y)) ))))
...
;; fxp_div_def
  ...
  (! (ite (= x 0) (= (fxp_div1 x y) 0)
     (ite (and (< 0 x) (< 0 y)) (pos_div_relation1 (fxp_div1 x y) (* x 400)
     y)
...
;; to_int_def
  ...
  (forall ((x Int))
  (! (ite (= x 0) (= (to_int4 x) 0)
     (ite (< 0 x) (pos_div_relation1 (to_int4 x) x 400) (pos_div_relation1
     (- (to_int4 x)) (- x) 400))) :pattern ((to_int4 x)) )))
...
(define-fun in_range6 ((x1 Float32)) Bool (and (fp.isFinite32 x1)
                                          (and
...
(define-fun in_range7 ((x1 Float32)) Bool (and (fp.isFinite32 x1)
                                          (and
                                          (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x1)
                                          (fp.leq x1 (fp #b0 #b10000010 #b01000000000000000000000)))))
...
;; H
  (assert
  (and (= o (to_int4 (to_fixed1 x))) (in_range1 (to_int4 (to_fixed1 x)))))
...
;; H
  (assert
  (and (= o1 (to_int4 (to_fixed1 x))) (in_range1 (to_int4 (to_fixed1 x)))))
...
;; H
  (assert
  (and (= o3 (to_int3 (+ (to_fixed1 x) (to_fixed1 x)))) (in_range1
  (to_int3 (+ (to_fixed1 x) (to_fixed1 x))))))
...
;; H
  (assert
  (and (= o5 (to_int3 (- (+ (to_fixed1 x) (to_fixed1 x)) (to_fixed1 x))))
  (in_range5 (to_int3 (- (+ (to_fixed1 x) (to_fixed1 x)) (to_fixed1 x))))))
...
(assert
;; WP_parameter_def
 ;; File "ordinary_fixed.adb", line 57, characters 0-0
  (not (in_range3 (* y32 400))))
(check-sat)
(exit)
