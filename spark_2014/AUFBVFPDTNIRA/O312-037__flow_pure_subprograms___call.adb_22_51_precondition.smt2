...
;; pure_function__post_axiom
  ...
  (! (=> (dynamic_invariant x true true true true) (dynamic_invariant
     (pure_function x) true false true true)) :pattern ((pure_function x)) )))
...
;; impure_function__post_axiom
  ...
  (forall ((x Int))
  (! (=> (dynamic_invariant x true true true true) (dynamic_invariant
     (impure_function x) true false true true)) :pattern ((impure_function x)) )))
...
;; pure_function__post_axiom
  ...
  (forall ((x Int))
  (! (=> (dynamic_invariant x true true true true) (dynamic_invariant
     (pure_function1 x) true false true true)) :pattern ((pure_function1 x)) )))
...
;; pure_function__post_axiom
  ...
  (forall ((x Int))
  (! (=> (dynamic_invariant x true true true true) (dynamic_invariant
     (pure_function2 x) true false true true)) :pattern ((pure_function2 x)) )))
