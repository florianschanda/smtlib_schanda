...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (<= (+ (+ (+ 0 (ite (and (fp.leq (fp.neg threshold) value)
                      (fp.leq value threshold))
                 1 0)) (ite (= (fp.gt value threshold) true) 1 0)) (ite (= (fp.lt
                                                                   value (fp.neg
                                                                   threshold)) true)
                                                                   1 0)) 1)))
(check-sat)
