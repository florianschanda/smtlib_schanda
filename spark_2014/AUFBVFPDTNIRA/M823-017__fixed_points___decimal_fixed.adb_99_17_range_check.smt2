...
;; H
  (assert
  (and (= o (to_int3 (to_fixed1 x))) (in_range1 (to_int3 (to_fixed1 x)))))
...
;; H
  (assert
  (and (= o1 (to_int3 (to_fixed1 x))) (in_range1 (to_int3 (to_fixed1 x)))))
...
;; H
  (assert
  (and (= o3 (to_int2 (+ (to_fixed1 x) (to_fixed1 x)))) (in_range1
  (to_int2 (+ (to_fixed1 x) (to_fixed1 x))))))
...
;; H
  (assert
  (and (= o5 (to_int2 (- (+ (to_fixed1 x) (to_fixed1 x)) (to_fixed1 x))))
  (in_range5 (to_int2 (- (+ (to_fixed1 x) (to_fixed1 x)) (to_fixed1 x))))))
