...
;; H
  (assert
  (=> (not (< (to_rep (last (rt list))) position3))
  (and (<= (to_rep (first (rt list))) position3)
  (<= position3 (to_rep (last (rt list)))))))

;; H
  (assert
  (=> (not (< (to_rep (last (rt list))) position3)) (= o5 position3)))

;; H
  (assert
  (=> (not (< (to_rep (last (rt list))) position3))
  (= o6 (select (elts list) o5))))

;; H
  (assert
  (=> (not (< (to_rep (last (rt list))) position3)) (= o7 (to_rep o6))))

;; H
  (assert
  (=> (not (< (to_rep (last (rt list))) position3))
  (= result3 (ite (= o7 value) true false))))
