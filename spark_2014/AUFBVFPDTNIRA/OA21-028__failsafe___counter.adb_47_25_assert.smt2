...
;; H
  (assert
  (=> (not (not (= input true)))
  (=> (bvult count ((_ int2bv 8) 10))
  (and (= o (bvadd count ((_ int2bv 8) 1))) (in_range1
  (bvadd count ((_ int2bv 8) 1)))))))

;; H
  (assert
  (=> (not (not (= input true)))
  (=> (bvult count ((_ int2bv 8) 10)) (= (mk_t__ref result1) count4))))

;; H
  (assert
  (=> (not (not (= input true)))
  (=> (bvult count ((_ int2bv 8) 10)) (= count3 o))))

;; H
  (assert
  (=> (not (not (= input true)))
  (=> (not (bvult count ((_ int2bv 8) 10))) (= count3 count))))

;; H
  (assert
  (=> (not (not (= input true)))
  (=> (not (bvult count ((_ int2bv 8) 10))) (= count3 count1))))
...
;; H
  ...
  (=>
  (and
  (bvule (bvadd (bvsub ((_ int2bv 8) 10) counter__p__B_3__a__assume) ((_ int2bv 8) 1)) i)
  (bvule i ((_ int2bv 8) 10))) (= (select inputs1 i) true)))
  (or (= counter__p__B_3__a__assume ((_ int2bv 8) 10))
  (not
  (= (select inputs1 (bvsub ((_ int2bv 8) 10) counter__p__B_3__a__assume)) true))))))))
...
;; H
  ...
  (forall ((i (_ BitVec 8)))
  (=>
  (and (bvule (bvadd (bvsub ((_ int2bv 8) 10) a) ((_ int2bv 8) 1)) i)
  (bvule i ((_ int2bv 8) 10))) (= (select inputs1 i) true)))))
...
;; WP_parameter_def
 ;; File "counter.ads", line 35, characters 0-0
  (not
  (or (= a ((_ int2bv 8) 10))
  (not (= (select inputs1 (bvsub ((_ int2bv 8) 10) a)) true)))))
(check-sat)
