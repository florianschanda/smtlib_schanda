...
(declare-const temp___228 e)

(declare-const temp___2281 Bool)

(declare-const temp___2282 integer)

(declare-const temp___2283 float)

(declare-const temp___2284 us_private)
...
;; H
  (assert (= temp___226 (rec__tagged_discr__t__discr v__split_discrs)))
...
;; H
  (assert (= usq_ temp___228))

;; H
  (assert (= usq_1 temp___2281))

;; H
  (assert (= usq_2 temp___2282))

;; H
  (assert (= usq_3 temp___2283))

;; H
  (assert (= usq_4 temp___2284))

;; H
  (assert (= v__attr__tag temp___2285))
...
;; H
  (assert (= temp___2281 v__split_fields4))

;; H
  (assert (= temp___2282 v__split_fields5))

;; H
  (assert (= temp___2283 v__split_fields6))

;; H
  (assert (= temp___2284 v__split_fields7))

;; H
  (assert (= v__split_discrs (mk___split_discrs temp___228)))
