...
;; pow2__def_axiom
  ...
  (! (=>
     ...
     (pow21 x) x)) (= (pow21 x) (fp.mul RNE x x))) :pattern ((pow21 x)) )))
...
(declare-fun temp___547 () Float32)

(declare-fun temp___546 () Float32)

(declare-fun o () Float32)

(declare-fun temp___551 () Float32)

(declare-fun temp___550 () Float32)
...
(define-fun dummy21 () t__ref (mk_t__ref dummy17))

(define-fun dummy22 () t__ref (mk_t__ref dummy11))
...
;; H
  (assert (= result7 (mk_t__ref dummy19)))
...
;; WP_parameter_def
 ;; File "test_trigo.adb", line 5, characters 0-0
  (not (not (= f16 (fp #b0 #b11111110 #b11111111111111111111111)))))
(check-sat)
