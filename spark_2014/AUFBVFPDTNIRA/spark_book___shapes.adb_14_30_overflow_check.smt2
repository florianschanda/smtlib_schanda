...
;; H
  (assert
  (and
  (= o7 (* (to_rep1 (rec__shapes__circle__radius (us_split_fields1 c))) 
...
;; H
  (assert
  (and (= o4 (* delta_y1 delta_y1)) (in_range1 (* delta_y1 delta_y1))))

;; H
  (assert
  (and (= o5 (* delta_x1 delta_x1)) (in_range1 (* delta_x1 delta_x1))))
