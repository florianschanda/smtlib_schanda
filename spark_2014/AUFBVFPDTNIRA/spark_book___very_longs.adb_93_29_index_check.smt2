...
(declare-fun temp___1163 () digit_index_type)

(declare-fun temp___11631 () (Array Int octet))

(declare-fun temp___11632 () t)
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___11581)) (to_rep2 (last4 temp___11581))) 
  temp___11591))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___11591)) (to_rep2 (last2 temp___11591)))
     (+ (- (to_rep2 (last2 temp___11591)) (to_rep2 (first2 temp___11591))) 1)
...
;; H
  (assert
  (= (mk___t1 temp___1161 temp___11611) (mk___t1 temp___1159 temp___11591)))
...
;; H
  (assert
  (= (mk (to_rep2 (first2 temp___11611)) (to_rep2 (last2 temp___11611))) 
  o1))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___11631 temp___11632))))
...
;; H
  ...
  (forall ((temp___1171 Int))
  (=>
  (and
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1171)
  (<= temp___1171 (to_rep2
                  (last
                  (rt
                  (rec__very_longs__very_long__long_digits
  ...
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             result____split_fields3)) temp___1171) (select (elts
                                                            (rec__very_longs__very_long__long_digits
                                                            result____split_fields2)) temp___1171))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
