...
;; H
  (assert (fp.leq (fp #b0 #b01000000 #b00000000000000000000000) val3))

;; H
  (assert (fp.leq val3 (fp #b0 #b11111110 #b11111111111111111111111)))

;; H
  (assert (fp.leq val1 val2))

;; H
  (assert (fp.isFinite32 (fp.div RNE val2 val3)))

(assert
;; WP_parameter_def
 ;; File "spark-floating_point_arithmetic_lemmas.ads", line 83, characters 0-0
  (not (fp.isFinite32 (fp.div RNE val1 val3))))
(check-sat)
(exit)
