...
(define-fun us_split_fields_Low__projection ((a us_split_fields)) float
  (rec__interval__interval__low a))

(define-fun us_split_fields_High__projection ((a us_split_fields)) float
  (rec__interval__interval__high a))
