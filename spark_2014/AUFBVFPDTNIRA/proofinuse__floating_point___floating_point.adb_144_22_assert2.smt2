...
;; H
  (assert (= o1 (- 1597463007 (__cdiv i1 2))))

;; H
  (assert (= i2 o1))

;; H
  (assert (in_range1 (- 1597463007 (__cdiv i1 2))))

;; H
  (assert (= o2 (to_float i2)))
...
;; H
  (assert (= o3 (fp.mul RNE y1 y1)))

;; H
  (assert (fp.isFinite32 (fp.mul RNE y1 y1)))
