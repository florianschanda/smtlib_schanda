...
;; H
  (assert
  (and
  (= o3 (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))
  (in_range1
  (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))))
...
;; H
  (assert (= o10 (ite (< 0 o9) o9 0)))

;; H
  (assert (= o11 (ite (<= o10 v) true false)))

;; H
  (assert (= result2 (ite (= o11 true) (ite (<= v value) true false) false)))
