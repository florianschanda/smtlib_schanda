...
(declare-fun o20 () operation)

(declare-fun o21 () instruction)

(declare-fun o22 () token_kind)

(declare-fun temp___232 () token_kind)

(declare-fun temp___2321 () integer)

(declare-fun temp___2322 () operation)

(declare-fun temp___2323 () instruction)

(declare-fun temp___2324 () Bool)
...
;; H
  (assert (= (to_rep4 (rec__tokens__token__kind v__split_discrs)) r5b))
...
;; H
  (assert
  (= (mk___rep (mk___split_fields o18)) (read1
                                        (mk___t word1
                                        (mk (to_rep1 word__first)
                                        (to_rep1 word__last))))))
...
;; H
  (assert (= (to_rep4 o17) 0))

;; H
  (assert (= o17 o22))

;; H
  (assert (= temp___232 o22))

;; H
  (assert (= temp___2321 o19))

;; H
  (assert (= temp___2322 o20))

;; H
  (assert (= temp___2323 o21))

;; H
  (assert (= true temp___2324))
...
;; WP_parameter_def
 ;; File "tokens.ads", line 14, characters 0-0
  (not (= temp___232 (rec__tokens__token__kind v__split_discrs))))
(check-sat)
(exit)
