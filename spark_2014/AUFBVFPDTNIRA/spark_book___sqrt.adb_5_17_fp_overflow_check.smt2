...
;; H
  (assert (= o4 (fp.div RNE x approx2)))

;; H
  (assert (fp.isFinite32 (fp.div RNE x approx2)))
...
;; H
  (assert (= o8 (fp.mul RNE approx3 approx3)))

;; H
  (assert (fp.isFinite32 (fp.mul RNE approx3 approx3)))
