...
;; H
  (assert
  (and (= o (fp.add RNE val2 val3)) (fp.isFinite32 (fp.add RNE val2 val3))))

(assert
;; WP_parameter_def
 ;; File "spark-floating_point_arithmetic_lemmas.ads", line 32, characters 0-0
  (not (fp.isFinite32 (fp.add RNE val1 val3))))
(check-sat)
(exit)
