...
;; H
  (assert
  (=> (and (<= 5 count2) (<= count2 8)) (and (<= 5 count3) (<= count3 8))))

;; H
  (assert (=> (and (<= 5 count2) (<= count2 8)) (= count3 8)))

;; H
  (assert
  (=> (and (<= 5 count2) (<= count2 8)) (= count4 (mk_int__ref count3))))

;; H
  (assert (=> (and (<= 5 count2) (<= count2 8)) (= count5 count3)))

;; H
  (assert (=> (and (<= 5 count2) (<= count2 8)) (= count6 count4)))

;; H
  (assert (=> (and (<= 5 count2) (<= count2 8)) (= count7 count5)))

;; H
  (assert
  (=> (not (and (<= 5 count2) (<= count2 8)))
  (= count6 (mk_int__ref count2))))

;; H
  (assert (=> (not (and (<= 5 count2) (<= count2 8))) (= count7 count2)))
...
;; H
  (assert
  (=>
  (and (<= 5 (let ((subject count1)) count8))
  (<= (let ((subject count1)) count8) 8))
...
;; H
  ...
  (and (<= 5 (let ((subject count1)) count8))
  (<= (let ((subject count1)) count8) 8))
  (= count10 (let ((subject count1)) (mk_int__ref count9)))))

;; H
  (assert
  (=>
  (and (<= 5 (let ((subject count1)) count8))
  (<= (let ((subject count1)) count8) 8)) (= count11 count9)))

;; H
  (assert
  (=>
  (and (<= 5 (let ((subject count1)) count8))
  (<= (let ((subject count1)) count8) 8)) (= count12 count10)))

;; H
  (assert
  (=>
  (and (<= 5 (let ((subject count1)) count8))
  (<= (let ((subject count1)) count8) 8)) (= count13 count11)))
...
;; H
  ...
  (and (<= 5 (let ((subject count1)) count8))
  (<= (let ((subject count1)) count8) 8)))
  (= count12 (let ((subject count1)) (mk_int__ref count8)))))
...
;; H
  ...
  (not
  (and (<= 5 (let ((subject count1)) count8))
  (<= (let ((subject count1)) count8) 8))) (= count13 count8)))
