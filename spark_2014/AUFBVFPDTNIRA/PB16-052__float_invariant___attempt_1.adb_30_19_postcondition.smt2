...
;; low_bound__post_axiom
  (assert
  (forall ((n1 Int))
  (! (=> (dynamic_invariant1 n1 true true true true) (dynamic_invariant
     (low_bound n1) true false true true)) :pattern ((low_bound n1)) )))
...
;; high_bound__post_axiom
  ...
  (forall ((n1 Int))
  (! (=> (dynamic_invariant1 n1 true true true true) (dynamic_invariant
     (high_bound n1) true false true true)) :pattern ((high_bound n1)) )))
