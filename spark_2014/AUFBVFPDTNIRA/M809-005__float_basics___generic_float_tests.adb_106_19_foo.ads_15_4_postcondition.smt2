...
;; H
  (assert
  (= foo__double_tests__underflow_3__result foo__double_tests__underflow_3__result1))

;; H
  (assert (= o (fp.mul RNE a b)))

;; H
  (assert (= foo__double_tests__underflow_3__result o))
...
;; H
  (assert
  (= (mk_t__ref foo__double_tests__underflow_3__result2) (mk_t__ref
                                                         foo__double_tests__underflow_3__result1)))
