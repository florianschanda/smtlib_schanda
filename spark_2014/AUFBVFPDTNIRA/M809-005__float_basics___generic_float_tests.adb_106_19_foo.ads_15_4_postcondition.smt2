...
(declare-const foo__double_tests__underflow_3__result Float64)

(declare-const o Float64)

(declare-const result Float64)

(declare-const foo__double_tests__underflow_3__result1 Float64)

(declare-const foo__double_tests__underflow_3__result2 Float64)

(declare-const foo__double_tests__underflow_3__result3 Float64)

(declare-const foo__double_tests__underflow_3__result4 Float64)

(declare-const foo__double_tests__underflow_3__result5 Float64)
...
;; H
  (assert
  (= foo__double_tests__underflow_3__result1 foo__double_tests__underflow_3__result2))

;; H
  (assert
  (= foo__double_tests__underflow_3__result3 foo__double_tests__underflow_3__result1))

;; H
  (assert (and (= o (fp.mul RNE a b)) (fp.isFinite64 (fp.mul RNE a b))))

;; H
  (assert (= result foo__double_tests__underflow_3__result))

;; H
  (assert (= foo__double_tests__underflow_3__result1 o))

;; H
  (assert
  (= (mk_t__ref foo__double_tests__underflow_3__result4) (mk_t__ref
                                                         foo__double_tests__underflow_3__result2)))

;; H
  (assert
  (= foo__double_tests__underflow_3__result5 foo__double_tests__underflow_3__result3))

;; H
  (assert (= result1 foo__double_tests__underflow_3__result4))
...
;; WP_parameter_def
 ;; File "generic_float_tests.ads", line 2, characters 0-0
  (not
  (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)
  foo__double_tests__underflow_3__result4)))
(check-sat)
(exit)
