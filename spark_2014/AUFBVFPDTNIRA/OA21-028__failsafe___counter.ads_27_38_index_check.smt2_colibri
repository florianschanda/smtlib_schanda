...
;; H
  (assert
  (=> (bvult res1 abstr6)
  (and (bvule abstr8 (bvsub abstr6 res1)) (bvule (bvsub abstr6 res1) abstr6))))

;; H
  (assert (=> (bvult res1 abstr6) (= o (bvsub abstr6 res1))))

;; H
  (assert (=> (bvult res1 abstr6) (= result1 (select inputs o))))

;; H
  (assert (=> (not (bvult res1 abstr6)) (= result1 false)))
...
;; H
  (assert (= (select inputs abstr6) true))

;; H
  (assert (and (=> (= result6 true) true) (=> false (= result6 true))))

;; H
  (assert (= result6 true))

;; H
  (assert (not (= counter__model__current_chain_length__result4 abstr6)))

(assert
;; WP_parameter_def
 ;; File "counter.ads", line 9, characters 0-0
  (not
  (bvule abstr8 (bvsub abstr6 counter__model__current_chain_length__result4))))
(check-sat)
(exit)
