...
;; H
  ...
  (= o4 (fp.mul RNE ((_ to_fp 11 53) RNE (to_real o3)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))

;; H
  (assert (= o5 (ite (fp.leq old_speed o4) true false)))
