...
;; H
  (assert (and (= o4 (+ n 1)) (in_range1 (+ n 1))))

;; H
  (assert
  (and (= o5 (high_bound o4))
  (and (fp.isFinite64 o5)
  (= o5 (fp.mul RNE (of_int RNE o4) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))

;; H
  (assert (= o6 (ite (fp.leq old_speed o5) true false)))
