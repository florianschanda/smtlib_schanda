...
;; H
  ...
  (=>
  (= (rec__students3__student_record__part_time (us_split_fields3 student)) true)
  (= (mk_money_type__ref result2) fees10)))
...
;; H
  ...
  (not
  (= (rec__students3__student_record__part_time (us_split_fields3 student)) true))
  (= (mk_money_type__ref result3) fees10)))
...
;; H
  ...
  (= (to_fixed2 o4) (+ (to_fixed2 fees1) 400000))))
...
;; H
  ...
  (= (to_fixed2 o5) (+ (to_fixed2 fees3) 10000))))))
...
;; H
  ...
  (= (to_fixed2 o6) (+ (to_fixed2 fees3) 100000)))))))
...
;; H
  ...
  (= (to_rep1
     (rec__students3__student_record__meal_plan (us_split_fields3 student))) 2))
  (= (to_fixed2 o7) (+ (to_fixed2 fees3) 300000)))))))
...
;; H
  ...
  (= (to_rep1
     (rec__students3__student_record__meal_plan (us_split_fields3 student))) 1)
  (= (to_fixed2 o8) (+ (to_fixed2 fees1) 20000))))))
...
;; H
  ...
  (= (to_rep1
     (rec__students3__student_record__meal_plan (us_split_fields3 student))) 2)
  (= (to_fixed2 o9) (+ (to_fixed2 fees1) 150000)))))))
...
;; H
  ...
  (= (to_rep1
     (rec__students3__student_record__meal_plan (us_split_fields3 student))) 2))
  (= (to_fixed2 o10) (+ (to_fixed2 fees1) 450000)))))))
