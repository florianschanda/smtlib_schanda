...
;; H
  (assert
  (and (= o (fp.div RNE right left))
  (not (or (fp.isInfinite (fp.div RNE right left)) (fp.isNaN (fp.div RNE
  right left))))))
...
;; H
  (assert
  (and (= o2 (atan__2 o1)) (not (or (fp.isInfinite o2) (fp.isNaN o2)))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (not (or (fp.isInfinite (fp.sub RNE result__1 (fp #b0 #b01111111111 #b1001001000011111101101010100010001000010110100011000))) (fp.isNaN (fp.sub RNE
  result__1 (fp #b0 #b01111111111 #b1001001000011111101101010100010001000010110100011000)))))))
(check-sat)
(exit)
