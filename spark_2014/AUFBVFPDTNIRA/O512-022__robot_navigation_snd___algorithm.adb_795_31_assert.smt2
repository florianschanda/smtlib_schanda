...
;; H
  (assert
  (=> (= result2 true)
  (=> (= (distinct 0 0) true) (= o8 (attr__ATTRIBUTE_IMAGE5 o7)))))

;; H
  (assert
  (=> (= result2 true) (=> (= (distinct 0 0) true) (= o9 (to_string o8)))))
...
;; H
  ...
  (=> (= result2 true)
  (=> (= (distinct 0 0) true)
  (and (= o11 (print o10)) (dynamic_invariant2 o11 true false true true)))))
...
;; H
  ...
  (= result3 (let ((subject this__split_fields))
             (mk___split_fields__ref9 this__split_fields1)))))

;; H
  (assert
  (=> (= result2 true)
  (= (let ((subject this__split_fields)) this__split_fields2) (us_split_fields19
                                                              temp___1050))))
...
;; H
  ...
  (=> (not (= result2 true))
  (=> (= result4 true)
  (= (let ((subject this__split_fields)) this__split_fields3) (mk___split_fields9
                                                              (rec__algorithm__controller__robot
                                                              (let ((subject
                                                              this__split_fields))
                                                              this__split_fields1))
...
;; H
  ...
  (= this__split_fields5 (let ((subject this__split_fields))
                         (mk___split_fields__ref9 this__split_fields3))))))
...
;; H
  ...
  (=> (not (= result2 true))
  (=> (not (= result4 true))
  (= (let ((subject this__split_fields)) this__split_fields4) (mk___split_fields9
                                                              (rec__algorithm__controller__robot
                                                              (let ((subject
                                                              this__split_fields))
                                                              this__split_fields1))
...
;; H
  ...
  (=> (not (= result4 true))
  (= this__split_fields5 (let ((subject this__split_fields))
                         (mk___split_fields__ref9 this__split_fields4))))))
...
;; WP_parameter_def
 ;; File "algorithm.ads", line 107, characters 0-0
  ...
  (fp.lt (to_rep5
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content9 this__split_fields9))))) (t__content
