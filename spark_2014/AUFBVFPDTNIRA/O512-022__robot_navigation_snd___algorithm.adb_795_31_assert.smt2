...
;; H
  (assert
  (=> (= result17 true)
  (=> (= (of_int1 0) true) (= o44 (attr__ATTRIBUTE_IMAGE5 o43)))))

;; H
  (assert
  (=> (= result17 true) (=> (= (of_int1 0) true) (= o45 (to_string o44)))))
...
;; H
  (assert
  (=> (= result17 true)
  (= o48 (bearing (mk___rep1 disttogoal__split_fields2)))))

;; H
  (assert
  (=> (= result17 true) (and (= o49 (dcast o48)) (fp.isFinite32 o49))))
...
;; H
  (assert
  (=> (= result17 true)
  (= result18 (let ((subject this__split_fields))
              (mk___split_fields__ref10 this__split_fields22)))))

;; H
  (assert
  (=> (= result17 true)
  (= (let ((subject this__split_fields)) this__split_fields23) (us_split_fields21
                                                               temp___981))))

;; H
  (assert
  (=> (= result17 true)
  (= midvalleyangle__split_fields8 (mk___split_fields__ref
...
;; H
  (assert
  (=> (= result17 true)
  (= this__split_fields31 (let ((subject this__split_fields))
                          (mk___split_fields__ref10 this__split_fields23)))))

;; H
  (assert
  (=> (= result17 true)
  (= midvalleyangle__split_fields9 midvalleyangle__split_fields1)))
...
;; H
  (assert
  (=> (= result17 true) (= this__split_fields32 this__split_fields23)))
...
;; H
  ...
  (=> (not (= result17 true))
  (and
  (= o62 (aldiff (mk___rep saferisinggapangle__split_fields2)
         (rec__gaps__gap__bearing
         (us_split_fields11
         (rec__valleys__valley__risinggap
         (us_split_fields13
  ...
  (and (fp.lt (fp.neg (fp #b0 #b10000000 #b10010010000111111011011))
  o62) (fp.leq o62 (fp #b0 #b10000000 #b10010010000111111011011)))))))
...
;; H
  (assert
  (=> (not (= result17 true)) (= result23 (ite (fp.lt o65 o64) true false))))

;; H
  (assert
  (=> (not (= result17 true))
  (=> (= result23 true)
  (= result24 (let ((subject this__split_fields))
              (mk___split_fields__ref10 this__split_fields22))))))
...
;; H
  ...
  (=> (not (= result17 true))
  (=> (= result23 true)
  (= (let ((subject this__split_fields)) this__split_fields25) (mk___split_fields10
                                                               (rec__algorithm__controller__robot
                                                               (let ((subject
                                                               this__split_fields))
                                                               this__split_fields22))
...
;; H
  ...
  (=> (not (= result17 true))
  (=> (= result23 true)
  (= this__split_fields27 (let ((subject this__split_fields))
                          (mk___split_fields__ref10 this__split_fields25))))))

;; H
  (assert
  (=> (not (= result17 true))
  (=> (= result23 true) (= this__split_fields28 this__split_fields25))))

;; H
  (assert
  (=> (not (= result17 true))
  (=> (not (= result23 true))
  (= result25 (let ((subject this__split_fields))
              (mk___split_fields__ref10 this__split_fields22))))))
...
;; H
  ...
  (=> (not (= result17 true))
  (=> (not (= result23 true))
  (= (let ((subject this__split_fields)) this__split_fields26) (mk___split_fields10
                                                               (rec__algorithm__controller__robot
                                                               (let ((subject
                                                               this__split_fields))
                                                               this__split_fields22))
...
;; H
  ...
  (=> (not (= result23 true))
  (= this__split_fields27 (let ((subject this__split_fields))
                          (mk___split_fields__ref10 this__split_fields26))))))

;; H
  (assert
  (=> (not (= result17 true))
  (=> (not (= result23 true)) (= this__split_fields28 this__split_fields26))))
...
;; H
  (assert
  (=> (not (= result17 true)) (= this__split_fields29 this__split_fields27)))
...
;; H
  (assert
  (=> (not (= result17 true)) (= this__split_fields30 this__split_fields28)))

;; H
  (assert
  (=> (not (= result17 true))
  (= midvalleyangle__split_fields8 midvalleyangle__split_fields6)))
...
;; H
  (assert
  (=> (not (= result17 true)) (= this__split_fields31 this__split_fields29)))

;; H
  (assert
  (=> (not (= result17 true))
  (= midvalleyangle__split_fields9 midvalleyangle__split_fields7)))
...
;; H
  (assert
  (=> (not (= result17 true)) (= this__split_fields32 this__split_fields30)))
