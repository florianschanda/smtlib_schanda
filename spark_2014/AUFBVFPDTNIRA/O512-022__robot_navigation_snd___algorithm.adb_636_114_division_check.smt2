...
(declare-fun goal____split_fields () us_split_fields__ref2)
...
(declare-fun robotpose__split_fields () us_split_fields4)

(declare-fun goal____split_fields1 () us_split_fields4)

(declare-fun this__split_fields1 () us_split_fields__ref10)

(declare-fun relgoal__split_fields () us_split_fields4)
...
;; H
  (assert (oeq__function_guard (oeq o3 zero_position) o3 zero_position))

;; H
  (assert
  (and (= o3 (pos (mk___rep2 relgoal__split_fields))) (pos__function_guard 
  o3 (mk___rep2 relgoal__split_fields))))

;; H
  (assert
  (and (and (= o4 (norm o3)) (norm__function_guard o4 o3))
  ...
  (not (= (oeq o3 zero_position) true)))))))

;; H
  (assert
  (= result2 (ite (fp.leq o4 (to_rep4
                             (rec__robot_iface__proxy__goal_position_tol
                             (us_split_fields9
                             (rec__algorithm__controller__robot
...
;; H
  ...
  (= o6 (ori
        (mk___rep2
        (let ((subject goal____split_fields)) goal____split_fields1))))
  (ori__function_guard o6
  (mk___rep2 (let ((subject goal____split_fields)) goal____split_fields1)))))

;; H
  (assert
  (and (= o5 (ori (mk___rep2 robotpose__split_fields))) (ori__function_guard
  o5 (mk___rep2 robotpose__split_fields))))

;; H
  (assert
  (and
  (= result3 (almostequal o5 o6
             (to_rep4
             (rec__robot_iface__proxy__goal_angle_tol
             (us_split_fields9
             (rec__algorithm__controller__robot
             (us_split_fields__content10 this__split_fields1)))))))
  (almostequal__function_guard result3 o5 o6
  (to_rep4
  (rec__robot_iface__proxy__goal_angle_tol
  (us_split_fields9
  (rec__algorithm__controller__robot
...
;; H
  ...
  (= o8 (ori
        (mk___rep2
        (let ((subject goal____split_fields)) goal____split_fields1))))
  (ori__function_guard o8
  (mk___rep2 (let ((subject goal____split_fields)) goal____split_fields1)))))

;; H
  (assert
  (and (= o7 (ori (mk___rep2 robotpose__split_fields))) (ori__function_guard
  o7 (mk___rep2 robotpose__split_fields))))

;; H
  (assert
  (and (and (= o9 (ccwdiff o7 o8)) (ccwdiff__function_guard o9 o7 o8))
  (not (or (fp.isInfinite o9) (fp.isNaN o9)))))

;; H
  (assert
  (= result4 (ite (fp.lt o9 (fp #b0 #b10000000 #b10010010000111111011011))
             true false)))
...
;; H
  ...
  (= o11 (ori
         (mk___rep2
         (let ((subject goal____split_fields)) goal____split_fields1))))
  (ori__function_guard o11
  (mk___rep2 (let ((subject goal____split_fields)) goal____split_fields1)))))

;; H
  (assert
  (and (= o10 (ori (mk___rep2 robotpose__split_fields))) (ori__function_guard
  o10 (mk___rep2 robotpose__split_fields))))

;; H
  (assert
  (and (and (= o12 (cwdiff o10 o11)) (cwdiff__function_guard o12 o10 o11))
  (not (or (fp.isInfinite o12) (fp.isNaN o12)))))
...
;; WP_parameter_def
 ;; File "algorithm.ads", line 107, characters 0-0
  (not
  (not
  (fp.eq (fp #b0 #b10000000 #b10000000000000000000000) ((_ to_fp 8 24) #x00000000)))))
(check-sat)
