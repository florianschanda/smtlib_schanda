...
;; H
  ...
  (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o11)
  (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) o11)
  (not (= (oeq o10 zero_position) true)))))))

;; H
  (assert
  (= result4 (ite (fp.leq o11 (to_rep4
                              (rec__robot_iface__proxy__goal_position_tol
                              (us_split_fields9
                              (rec__algorithm__controller__robot
...
;; H
  (assert
  (= result6 (ite (fp.lt o16 (fp #b0 #b10000000 #b10010010000111111011011))
             true false)))
