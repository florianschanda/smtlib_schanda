...
(declare-fun abstr8 () Float64)

;; H
  (assert
  (fp.leq abstr8 (fp.sub RNE abstr7 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))

(assert
;; WP_parameter_def
 ;; File "simple_trajectory.ads", line 27, characters 0-0
  (not (fp.leq abstr8 new_speed1)))
(check-sat)
(exit)
