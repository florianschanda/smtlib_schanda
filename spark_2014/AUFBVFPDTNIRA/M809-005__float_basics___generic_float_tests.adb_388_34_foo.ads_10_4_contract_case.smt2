...
;; H
  (assert
  (=>
  (= (bool_eq x (fp.neg (fp #b0 #b01111111 #b10011001100110011001101))) true)
  (= i2 (- 2))))

;; H
  (assert
  (=>
  (= (bool_eq x (fp.neg (fp #b0 #b01111111 #b10000000000000000000000))) true)
  (= i2 (- 2))))

;; H
  (assert
  (=>
  (= (bool_eq x (fp.neg (fp #b0 #b01111111 #b01100110011001100110011))) true)
  (= i2 (- 1))))

;; H
  (assert
  (=>
  (= (bool_eq x (fp.neg (fp #b0 #b01111111 #b00000000000000000000000))) true)
  (= i2 (- 1))))

;; H
  (assert
  (=> (= (bool_eq x (fp #b0 #b00000000 #b00000000000000000000000)) true)
  (= i2 0)))

;; H
  (assert
  (=> (= (bool_eq x (fp #b0 #b01111111 #b00000000000000000000000)) true)
  (= i2 1)))

;; H
  (assert
  (=> (= (bool_eq x (fp #b0 #b01111111 #b01100110011001100110011)) true)
  (= i2 1)))

;; H
  (assert (= (bool_eq x (fp #b0 #b01111111 #b10000000000000000000000)) true))
