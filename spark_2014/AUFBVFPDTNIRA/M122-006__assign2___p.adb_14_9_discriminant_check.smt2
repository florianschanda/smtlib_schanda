...
(declare-fun x__split_discrs () enum)
...
(declare-fun p__good_2__x__assume () enum)

(declare-fun p__good_2__x__assume1 () integer)

(declare-fun p__good_2__x__assume2 () float)

(declare-fun p__good_2__x__assume3 () Bool)
...
(declare-fun temp___151 () enum)

(declare-fun temp___1511 () integer)

(declare-fun temp___1512 () float)

(declare-fun temp___1513 () Bool)
...
(declare-fun result2 () enum)

(declare-fun x__split_discrs1 () enum)
...
;; WP_parameter_def
 ;; File "p.adb", line 5, characters 0-0
  (not (= temp___151 x__split_discrs1)))
(check-sat)
