...
;; H
  ...
  (forall ((idx1 Int))
  (=> (and (<= (to_rep1 item__first) idx1) (<= idx1 last7))
  (= (to_rep (select item3 idx1)) (to_rep (select item2 idx1)))))
  (and (= (- cur_position3 cur_position2) (- last8 last7))
  (and
  (forall ((idx1 Int))
  (=> (and (<= (+ last7 1) idx1) (<= idx1 last8))
  (= (to_rep (select item3 idx1)) (to_rep
                                  (select the_file (+ (- (- idx1 last7) 1) 
                                  cur_position2))))))
  ...
  (forall ((idx1 Int))
  (=> (and (<= 1 idx1) (<= idx1 (- 80 1)))
  (= (to_rep (select item3 (+ last7 idx1))) (to_rep
                                            (select the_file (- (+ cur_position2 idx1) 1)))))))
  ...
  (forall ((idx1 Int))
  (=>
  (and (<= cur_position2 idx1)
  (<= idx1 (- (find_char_in_slice 10 cur_position2 (- (+ cur_position2 80) 2)
              the_file) 1)))
  (= (to_rep (select item3 (+ (- (+ last7 idx1) cur_position2) 1))) (to_rep
                                                                    (select 
                                                                    the_file idx1))))))
  ...
  (=>
  (and (<= cur_position2 idx1)
  (<= idx1 (- (find_char_in_slice eof_ch cur_position2
  ...
  (and
  (forall ((idx1 Int))
  (=> (and (<= (to_rep1 item__first) idx1) (<= idx1 (int__content last11)))
  (= (to_rep (select item8 idx1)) (to_rep (select (map__content item6) idx1)))))
  (and
  (= (- cur_position8 (int__content cur_position6)) (- last13 (int__content
                                                              last11)))
  (and
  (forall ((idx1 Int))
  (=> (and (<= (+ (int__content last11) 1) idx1) (<= idx1 last13))
  (= (to_rep (select item8 idx1)) (to_rep
                                  (select the_file (+ (- (- idx1 (int__content
                                                                 last11)) 1) 
  ...
  (forall ((idx1 Int))
  (=> (and (<= 1 idx1) (<= idx1 (- o8 1)))
  (= (to_rep (select item8 (+ (int__content last11) idx1))) (to_rep
                                                            (select the_file (- (+ 
                                                            (int__content
                                                            cur_position6) idx1) 1)))))))
  (= textio__get_line__get_chunk__rest1 1))
  ...
  (forall ((idx1 Int))
  (=>
  (and (<= (int__content cur_position6) idx1)
  (<= idx1 (- (find_char_in_slice 10 (int__content cur_position6)
              (- (+ (int__content cur_position6) o8) 2) the_file) 1)))
  (= (to_rep
     (select item8 (+ (- (+ (int__content last11) idx1) (int__content
                                                        cur_position6)) 1))) 
  ...
  (=>
  (and (<= (int__content cur_position6) idx1)
  (<= idx1 (- (find_char_in_slice eof_ch (int__content cur_position6)
              (- (+ (int__content cur_position6) o8) 2) the_file) 1)))
  (= (to_rep
     (select item8 (+ (- (+ (int__content last11) idx1) (int__content
                                                        cur_position6)) 1))) 
...
;; H
  ...
  (= (int__content last29) (- (to_rep1 item__first) 1))))
...
;; H
  ...
  (<= (to_rep1 item__first) (int__content last29))))

;; H
  (assert
  (=> (not (= (int__content last29) (- (to_rep1 item__first) 1)))
  (<= (int__content last29) (to_rep1 item__last))))

;; H
  (assert (<= (to_rep1 item__first) idx))

;; H
  (assert (<= idx (int__content last29)))
