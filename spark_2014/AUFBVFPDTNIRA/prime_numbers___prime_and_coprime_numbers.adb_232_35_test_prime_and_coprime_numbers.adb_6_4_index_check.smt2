...
;; H
  (assert (and (= o10 (+ index_22 1)) (in_range1 (+ index_22 1))))
...
;; H
  (assert
  (= result8 (ite (= o11 true) (ite (<= v3 index_34) true false) false)))

;; H
  (assert
  (=> (= result8 true)
  (= o12 (ite (not (= (mod2 v3 index_22) 0)) true false))))

;; H
  (assert (=> (not (= result8 true)) (= o12 (of_int1 1))))

;; H
  (assert
  (= (= o13 true)
  (forall ((div4 Int))
  (=> (and (<= 2 div4) (<= div4 (- index_22 1))) (not (= (mod2 v3 div4) 0))))))

;; H
  (assert (= o14 (ite (= o13 true) o12 false)))

;; H
  (assert (= o15 (to_int2 o14)))
