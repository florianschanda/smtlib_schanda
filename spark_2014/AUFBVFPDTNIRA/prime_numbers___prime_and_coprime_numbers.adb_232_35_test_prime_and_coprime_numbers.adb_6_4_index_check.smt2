...
(declare-fun temp___285 (Bool) (Array Int Bool))

;; def_axiom
  (assert
  (forall ((temp___287 Bool))
  (forall ((temp___288 Int))
  (= (select (temp___285 temp___287) temp___288) temp___287))))
...
;; H
  (assert (= is_prime2 (temp___285 (distinct 1 0))))
...
;; H
  ...
  (forall ((div2 Int))
  (=> (and (<= 2 div2) (<= div2 (- index_22 1))) (not (= (mod2 v1 div2) 0))))))))
...
;; H
  (assert (= o3 (store is_prime5 o2 (distinct 0 0))))
...
;; H
  (assert (and (= o4 (+ index_22 1)) (in_range1 (+ index_22 1))))

;; H
  (assert (= o5 (ite (<= o4 v) true false)))

;; H
  (assert
  (= result8 (ite (= o5 true) (ite (<= v index_33) true false) false)))

;; H
  (assert
  (=> (= result8 true) (= o6 (ite (not (= (mod2 v index_22) 0)) true false))))

;; H
  (assert (=> (not (= result8 true)) (= o6 (distinct 1 0))))
