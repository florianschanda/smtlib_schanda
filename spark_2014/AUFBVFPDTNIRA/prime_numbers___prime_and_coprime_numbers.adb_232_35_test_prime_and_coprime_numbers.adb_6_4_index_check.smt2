...
;; H
  (assert (= is_prime2 (temp___250 (of_int 1))))

;; H
  (assert (= is_prime2 result1))

;; H
  (assert (= is_prime3 (store is_prime2 0 (of_int 0))))

;; H
  (assert (= is_prime3 result2))

;; H
  (assert (= is_prime4 (store is_prime3 1 (of_int 0))))
...
;; H
  (assert (= o3 (store is_prime5 o2 (of_int 0))))
...
;; H
  (assert (=> (not (= result8 true)) (= o6 (of_int 1))))
