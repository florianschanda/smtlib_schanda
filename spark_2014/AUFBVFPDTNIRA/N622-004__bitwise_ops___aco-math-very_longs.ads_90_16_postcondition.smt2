...
(declare-fun aco__math__very_longs__add_fp__result () digit_index_type)

(declare-fun aco__math__very_longs__add_fp__result1 () (Array Int octet))

(declare-fun aco__math__very_longs__add_fp__result2 () t)
...
(declare-fun temp___1350 () digit_index_type)

(declare-fun temp___13501 () (Array Int octet))

(declare-fun temp___13502 () t1)
...
(declare-fun result3 () very_long__ref)

(declare-fun aco__math__very_longs__add_fp__result3 () us_rep)

(declare-fun aco__math__very_longs__add_fp__result4 () very_long__ref)

(declare-fun aco__math__very_longs__add_fp__result5 () us_rep)

(declare-fun result____split_fields4 () us_split_fields__ref1)

(declare-fun carry1 () t__ref)

(declare-fun aco__math__very_longs__add_fp__result6 () very_long__ref)

(declare-fun result____split_fields5 () us_split_fields2)

(declare-fun carry2 () (_ BitVec 16))

(declare-fun aco__math__very_longs__add_fp__result7 () us_rep)
...
(declare-fun result4 () digit_index_type)

(declare-fun result5 () (Array Int octet))
...
;; H
  ...
  (= o7 (modsubtract
        (to_base (mk___rep1 result____split_discrs result____split_fields2))
        p))
  (modsubtract__function_guard o7
  (to_base (mk___rep1 result____split_discrs result____split_fields2)) 
  p))
...
;; H
  (assert (=> (= result1 true) (= o6 o7)))

;; H
  (assert
  (=> (= result1 true)
  (= (mk___rep1 (mk___split_discrs temp___1350)
     (mk___split_fields1 (mk___t1 temp___13501 temp___13502))) (of_base o6))))

;; H
  (assert
  (=> (= result1 true)
  (= result2 (mk___split_fields__ref1 result____split_fields2))))

;; H
  (assert
  (=> (= result1 true)
  (= result____split_fields3 (mk___split_fields1
                             (mk___t1 temp___13501 temp___13502)))))

;; H
  (assert
  (=> (= result1 true)
  (= result____split_discrs (mk___split_discrs temp___1350))))
...
;; H
  (assert
  (= aco__math__very_longs__add_fp__result4 (mk_very_long__ref
                                            aco__math__very_longs__add_fp__result3)))

;; H
  (assert
  (= aco__math__very_longs__add_fp__result5 aco__math__very_longs__add_fp__result3))

;; H
  (assert
  (= result3 (mk_very_long__ref
             (mk___rep
             (mk___split_discrs aco__math__very_longs__add_fp__result)
             (mk___split_fields
             (mk___t aco__math__very_longs__add_fp__result1
             aco__math__very_longs__add_fp__result2))))))

;; H
  (assert
  (= aco__math__very_longs__add_fp__result3 (to_base
                                            (mk___rep1 result____split_discrs
                                            result____split_fields3))))

;; H
  (assert
  (= aco__math__very_longs__add_fp__result6 aco__math__very_longs__add_fp__result4))

;; H
  (assert (= carry1 (mk_t__ref carry)))
...
;; H
  (assert
  (= aco__math__very_longs__add_fp__result7 aco__math__very_longs__add_fp__result5))
...
;; H
  ...
  (= (mk___rep (mk___split_discrs result4)
     (mk___split_fields (mk___t result5 result6))) (very_long__content
                                                   aco__math__very_longs__add_fp__result6)))
...
;; WP_parameter_def
 ;; File "aco-math-very_longs.ads", line 108, characters 0-0
  ...
  (= (to_rep
     (rec__aco__math__very_longs__very_long__octet_length
     (us_split_discrs1
     (very_long__content aco__math__very_longs__add_fp__result6)))) (to_rep
                                                                    (rec__aco__math__very_longs__very_long__octet_length
                                                                    (us_split_discrs1
                                                                    l))))))
(check-sat)
