...
(declare-fun arctanh (Float64) Float64)

(declare-fun arctanh__function_guard (Float64 Float64) Bool)
...
;; arctanh__post_axiom
  ...
  (! (=>
     ...
     (fp.lt (fp.abs x) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))
...
(assert
;; WP_parameter_def
 ;; File "/home/florian/adacore/spark2014/testsuite/gnatprove/tests/P201-069__simulink/gnatprove/simulink_functions.mlw", line 23936, characters 5-8
  (not
  (fp.lt (fp.abs lf) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(check-sat)
(exit)
