...
(define-fun dynamic_invariant ((temp___expr_214 us_t)
  ...
  (temp___do_toplevel_213 Bool)) Bool (=>
                                      ...
                                      2147483647 (first1 temp___expr_214)
...
;; H
  ...
  (forall ((i2 Int))
  (=>
  (and (<= (to_rep1 (first (rt arr))) i2) (<= i2 (to_rep1 (last (rt arr)))))
  (=> (not (= i2 (to_rep1 (first (rt arr)))))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt arr))) j) (<= j (to_rep1 (last (rt arr))))))

;; H
  (assert (= o4 j))

;; H
  (assert (= o5 (select (elts arr) o4)))
