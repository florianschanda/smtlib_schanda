...
;; H
  (assert
  (=> (and (<= 1 (let ((subject i1)) i4)) (<= (let ((subject i1)) i4) 1000))
  (and
  (and
  (= temp___955 (mk___rep10 (us_split_fields__content10 this__split_fields8)))
  (and (= temp___954 disttoclosestobstacle1)
  (and (= temp___953 (let ((subject i1)) i4))
  (and
  (and
  (not (= (oeq (mk___rep1 disttogoal__split_fields2) zero_position) true))
  (fp.lt (to_rep3
  ...
  (and (= rho1 rho) (= this__split_fields12 this__split_fields10))))
  (and
  (fp.lt (to_rep3
         (rec__robot_iface__proxy__robot_radius
         (us_split_fields9
  ...
  (and
  (and
  (= o32 (fp.add RNE (to_rep3
                     (rec__robot_iface__proxy__obstacle_avoid_dist
                     (us_split_fields9
                     (rec__algorithm__controller__robot
                     (us_split_fields__content10 this__split_fields11)))))
  (to_rep3
  (rec__robot_iface__proxy__robot_radius
  (us_split_fields9
  (rec__algorithm__controller__robot
  ...
  (fp.isFinite32 (fp.add RNE (to_rep3
                             ...
                             this__split_fields11))))) (to_rep3
                                                       ...
                                                       (us_split_fields__content10
                                                       this__split_fields11))))))))
  (= result10 (ite (fp.leq (to_rep4
                           (rec__algorithm__laser_scan_data__first
                           (us_split_fields19
                           (select (rec__algorithm__controller__laserscan
                                   (us_split_fields__content10
                                   this__split_fields11)) (let ((subject
                                                          i1)) i5)))))
              o32) true false)))
  (ite (= result10 true)
  (and
  (and
  (and
  (= o33 (fp.min disttoclosestobstacle2 (to_rep4
                                        (rec__algorithm__laser_scan_data__first
                                        (us_split_fields19
                                        (select (rec__algorithm__controller__laserscan
                                                (us_split_fields__content10
  ...
  (fp.isFinite32 (fp.min disttoclosestobstacle2 (to_rep4
                                                ...
                                                (select (rec__algorithm__controller__laserscan
                                                        ...
                                                        this__split_fields11))
                                                (let ((subject i1)) i5))))))))
  (and (= result11 (mk_t__ref disttoclosestobstacle2))
  (= disttoclosestobstacle3 o33)))
  (and (= disttoclosestobstacle4 (mk_t__ref disttoclosestobstacle3))
  (= disttoclosestobstacle5 disttoclosestobstacle3)))
  (and (= disttoclosestobstacle4 (mk_t__ref disttoclosestobstacle2))
  (= disttoclosestobstacle5 disttoclosestobstacle2))))
  (= (let ((subject i1)) i5) 1000)))))))))
  (and
  (and (= i11 (let ((subject i1)) (mk_int__ref i5)))
  (and (= disttoclosestobstacle10 disttoclosestobstacle4)
  (= this__split_fields17 this__split_fields11)))
  (and (= i12 i5)
  (and (= disttoclosestobstacle11 disttoclosestobstacle5)
  (= this__split_fields18 this__split_fields12)))))))
...
;; H
  (assert
  (=> (and (<= 1 (let ((subject i1)) i4)) (<= (let ((subject i1)) i4) 1000))
  (= disttoclosestobstacle12 disttoclosestobstacle10)))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i1)) i4)) (<= (let ((subject i1)) i4) 1000))
  (= this__split_fields19 this__split_fields17)))
...
;; H
  (assert
  (=> (and (<= 1 (let ((subject i1)) i4)) (<= (let ((subject i1)) i4) 1000))
  (= disttoclosestobstacle13 disttoclosestobstacle11)))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i1)) i4)) (<= (let ((subject i1)) i4) 1000))
  (= this__split_fields20 this__split_fields18)))
...
;; H
  ...
  (not
  (and (<= 1 (let ((subject i1)) i4)) (<= (let ((subject i1)) i4) 1000)))
  (= i13 (let ((subject i1)) (mk_int__ref i4)))))
...
;; H
  ...
  (not
  (and (<= 1 (let ((subject i1)) i4)) (<= (let ((subject i1)) i4) 1000)))
  (= disttoclosestobstacle12 (mk_t__ref disttoclosestobstacle1))))
...
;; H
  ...
  (not
  (and (<= 1 (let ((subject i1)) i4)) (<= (let ((subject i1)) i4) 1000)))
  (= this__split_fields19 this__split_fields8)))
...
;; H
  ...
  (not
  (and (<= 1 (let ((subject i1)) i4)) (<= (let ((subject i1)) i4) 1000)))
  (= disttoclosestobstacle13 disttoclosestobstacle1)))
...
;; H
  ...
  (not
  (and (<= 1 (let ((subject i1)) i4)) (<= (let ((subject i1)) i4) 1000)))
  (= this__split_fields20 this__split_fields9)))
