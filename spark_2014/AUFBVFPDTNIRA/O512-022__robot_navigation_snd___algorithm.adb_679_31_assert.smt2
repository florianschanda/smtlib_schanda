...
(declare-fun temp___976 () us_rep10)

(declare-fun temp___975 () Float32)
...
;; H
  ...
  (= temp___976 (mk___rep10 (us_split_fields__content10 this__split_fields1)))))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= temp___975 disttoclosestobstacle1)))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= temp___974 (let ((subject i)) i1))))
