...
;; H
  (assert
  (= o34 (select (rec__step_function__step_function_t__step
                 merge__split_fields3) o33)))

;; H
  (assert (= o35 (us_split_fields1 o34)))

;; H
  (assert (= o36 (rec__step_function__delimiter_entry__delimiter o35)))

;; H
  (assert (= o37 (to_rep2 o36)))
