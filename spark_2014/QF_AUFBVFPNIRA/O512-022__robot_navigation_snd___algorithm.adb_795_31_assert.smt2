...
;; H
  (assert (=> (= result4 true) (= driveturnrate5 driveturnrate3)))

;; H
  (assert (=> (not (= result4 true)) (= o28 (fp.abs o27))))

;; H
  (assert (=> (not (= result4 true)) (= o29 (fp.abs o26))))

;; H
  (assert
  (=> (not (= result4 true)) (= result5 (ite (fp.lt o29 o28) true false))))

;; H
  (assert (=> (not (= result4 true)) (= driveturnrate4 driveturnrate3)))

;; H
  (assert (=> (not (= result4 true)) (= driveturnrate5 driveturnrate4)))
