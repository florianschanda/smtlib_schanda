...
;; H
  (assert (=> (= abstr12 true) (and true true)))

;; H
  (assert
  (= result5 test_prime_and_coprime_numbers__p__nearest_prime_number__result4))

(assert
;; WP_parameter_def
 ;; File "prime_and_coprime_numbers.ads", line 3, characters 0-0
  (not
  (<= 0 test_prime_and_coprime_numbers__p__nearest_prime_number__result4)))
(check-sat)
(exit)
