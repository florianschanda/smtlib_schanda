...
;; H
  (assert
  (= result6 (ite (fp.lt (fp #b0 #b01111111 #b10010010000111111011011)
             o32) true false)))

;; H
  (assert
  (=> (= result6 true)
  (= result7 (ite (fp.lt o33 (fp #b0 #b00000000 #b00000000000000000000000))
             true false))))

;; H
  (assert
  (=> (not (= result6 true))
  (= result8 (ite (fp.lt o34 (fp.neg (fp #b0 #b01111111 #b10010010000111111011011)))
             true false))))
...
;; H
  ...
  (=> (not (= result6 true))
  (=> (= result8 true)
  (= result9 (ite (fp.lt (fp #b0 #b00000000 #b00000000000000000000000)
             o35) true false)))))
