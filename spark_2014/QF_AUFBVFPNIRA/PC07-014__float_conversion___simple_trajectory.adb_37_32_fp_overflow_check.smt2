...
(declare-const abstr4 Float64)

;; H
  (assert (fp.leq old_speed abstr4))

;; H
  (assert
  (fp.leq (fp.add RNE old_speed (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.add RNE
  abstr4 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))

;; H
  (assert
  (fp.leq new_speed1 (fp.add RNE abstr4 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))

;; H
  (assert
  (fp.leq (fp.add RNE (fp.mul RNE ((_ to_fp 11 53) RNE (to_real n)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.mul RNE ((_ to_fp 11 53) RNE (to_real (+
  n 1))) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))

(declare-const abstr5 Float64)

;; H
  (assert
  (fp.leq (fp.add RNE abstr4 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))
  abstr5))

;; H
  (assert (fp.leq new_speed1 abstr5))
...
;; H
  (assert (fp.leq abstr6 old_speed))

;; H
  (assert
  (and (= o16 abstr6)
  (and (fp.isFinite64 o16)
  (= o16 (fp.mul RNE ((_ to_fp 11 53) RNE (to_real n)) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))))

;; H
  (assert
  (= o17 (fp.sub RNE o16 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))

;; H
  (assert (and (= o18 o17) (fp.isFinite64 o17)))
