...
;; WP_parameter_def
 ;; File "simple_trajectory.ads", line 27, characters 0-0
  (not
  (not (or (fp.isInfinite (fp.sub RNE old_speed (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (fp.isNaN (fp.sub RNE
