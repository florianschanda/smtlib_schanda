...
;; H
  ...
  (and (= o31 abstr2)
  (and (not (or (fp.isInfinite o31) (fp.isNaN o31)))
...
;; H
  (assert (not (= abstr3 true)))

;; H
  (assert (= scan_sfun26 scan_sfun23))

;; H
  (assert (= scan_sfun16 scan_sfun13))
...
;; H
  (assert (= scan_sfun27 scan_sfun26))

;; H
  (assert (= scan_sfun17 scan_sfun16))
...
;; H
  (assert (= scan_sfun28 scan_sfun27))

;; H
  (assert (= scan_sfun18 scan_sfun17))
