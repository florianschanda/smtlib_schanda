...
;; H
  (assert
  (and (= very_longs__divide__L_7__R138b__assume (+ m1 1)) (in_range1
  (+ m1 1))))
...
;; H
  (assert (in_range1 r138b))

;; H
  (assert (= j1 r138b))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r138b)) (= temp___1103 current_borrow)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r138b)) (= temp___1102 q_hat)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (= o8 j2) (in_range2 j2))))

;; H
  (assert true)

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (= o9 j2) (in_range2 j2))))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (= o10 j2) (in_range2 j2))))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r138b)) (= j2 1)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r138b)) (= j3 j2)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r138b)) (= current_borrow4 current_borrow3)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r138b)) (= q_hat4 q_hat3)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r138b)) (= j4 j3)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r138b)) (= current_borrow5 current_borrow4)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r138b)) (= q_hat5 q_hat4)))

;; H
  (assert (=> (not (and (<= 1 j1) (<= j1 r138b))) (= j4 j1)))

;; H
  (assert
  (=> (not (and (<= 1 j1) (<= j1 r138b)))
  (= current_borrow5 current_borrow1)))

;; H
  (assert (=> (not (and (<= 1 j1) (<= j1 r138b))) (= q_hat5 q_hat1)))

;; H
  (assert (= n1 r140b))

;; H
  (assert (dynamic_property2 1 last r140b))
