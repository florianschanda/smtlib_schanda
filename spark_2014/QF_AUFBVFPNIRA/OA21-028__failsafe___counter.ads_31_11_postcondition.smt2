...
;; H
  (assert (=> (and (bvule abstr8 i1) (bvule i1 abstr10)) (= i9 i7)))

;; H
  (assert
  (=> (and (bvule abstr8 i1) (bvule i1 abstr10)) (= inputs9 inputs7)))

;; H
  (assert (=> (not (and (bvule abstr8 i1) (bvule i1 abstr10))) (= i1 i8)))

;; H
  (assert (=> (not (and (bvule abstr8 i1) (bvule i1 abstr10))) (= i9 i1)))

;; H
  (assert
  (=> (not (and (bvule abstr8 i1) (bvule i1 abstr10))) (= inputs9 inputs1)))

;; H
  (assert (= result4 inputs8))

;; H
  (assert (= inputs10 (store inputs8 abstr6 input)))
