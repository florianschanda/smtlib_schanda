...
;; H
  (assert (and (= o1 abstr1) (in_range2 o1)))
...
;; H
  (assert (and (= o4 abstr2) (in_range2 o4)))
...
;; H
  (assert
  (= o6 (fp.div RNE o5 (fp #b0 #b10000000 #b10010010000111111011011))))
...
;; H
  (assert (and (= o7 abstr3) (in_range2 o7)))

;; H
  (assert
  (= o8 (fp.mul RNE o7 (fp #b0 #b10000110 #b01101000000000000000000))))
