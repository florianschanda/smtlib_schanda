...
;; H
  (assert (and (= o11 (+ n 1)) (in_range2 (+ n 1))))
...
;; H
  ...
  (= o12 (fp.mul RNE ((_ to_fp 11 53) RNE (to_real o11)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))

;; H
  (assert
  (and (= o9 abstr5)
  (and (fp.isFinite64 o9)
  (= o9 (fp.mul RNE ((_ to_fp 11 53) RNE (to_real n)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))
