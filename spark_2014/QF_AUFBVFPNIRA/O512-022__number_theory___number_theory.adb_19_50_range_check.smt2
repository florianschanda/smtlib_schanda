...
;; H
  ...
  (and (= o2 abstr6)
  (and (in_range2 o2)
  (and (= o2 (ite (or (= o1 0) (= o1 1)) o1 (+ abstr4 abstr5)))
  (fp.lt ((_ to_fp 8 24) RNE (to_real o2)) (fp.add RNE (fp.div RNE abstr3 (fp #b0 #b10000000 #b00011110001101010100000)) (fp #b0 #b01111111 #b00000000000000000000000)))))))
