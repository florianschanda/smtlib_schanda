...
;; H
  (assert
  (=> (= result28 true) (= count_limit_reached12 count_limit_reached11)))

;; H
  (assert (=> (= result28 true) (= count12 count11)))

;; H
  (assert
  (=> (not (= result28 true)) (= count_limit_reached12 count_limit_reached1)))

;; H
  (assert (=> (not (= result28 true)) (= count12 count1)))

;; H
  (assert (= result35 (ite (= o108 1) true false)))

;; H
  (assert (= result36 (ite (= o109 1) true false)))

;; H
  (assert (= result37 (ite (= o110 1) true false)))
