...
;; H
  (assert (and (= o11 left3) (not (= left3 (- 2147483648)))))
...
;; H
  (assert (= left_is_out4 (ite (< left4 0) true false)))

;; H
  (assert (=> (= left_is_out4 true) (= result11 true)))

;; H
  (assert
  (=> (not (= left_is_out4 true)) (and (<= 0 left4) (<= left4 100000))))

;; H
  (assert (=> (not (= left_is_out4 true)) (= o13 left4)))

;; H
  (assert
  (=> (not (= left_is_out4 true)) (= result11 (select number_list o13))))

;; H
  (assert (not (= result11 true)))

;; H
  (assert (= left_is_out6 left_is_out4))
