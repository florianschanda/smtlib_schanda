...
;; H
  (assert
  (or
  (and (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) x)
  (fp.leq x (fp #b0 #b10000001 #b01000000000000000000000)))
  (and (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) x)
  (fp.leq x (fp #b0 #b10000011 #b01000000000000000000000)))))
