...
;; H
  (assert
  (and (= o abstr5) (and (in_range4 o) (= o (fp.add RNE abstr3 abstr4)))))
...
;; H
  ...
  (not (or (fp.isInfinite (fp.mul RNE speed2 speed2)) (fp.isNaN (fp.mul RNE
  speed2 speed2))))))
...
;; H
  (assert (= o8 (fp.sqrt RNE o7)))

;; H
  (assert (= o9 (fp.add RNE speed2 o8)))
...
;; H
  (assert
  (= o11 (fp.div RNE o10 (fp #b0 #b10000000 #b00000000000000000000000))))
...
;; H
  (assert
  (=> (fp.lt maximum_valid_speed speed3) (= speed4 maximum_valid_speed)))

;; H
  (assert (=> (not (fp.lt maximum_valid_speed speed3)) (= speed4 speed3)))
