...
;; H
  (assert (=> (= result4 true) (= index_12 result5)))

;; H
  (assert (=> (= result4 true) (= index_13 index_22)))

;; H
  (assert
  (=> (= result4 true)
  (and (= o5 (* 2 index_13)) (in_range1 (* 2 index_13)))))

;; H
  (assert (=> (= result4 true) (= index_32 result6)))

;; H
  (assert (=> (= result4 true) (= index_33 o5)))
...
;; H
  (assert (=> (= result4 true) (=> (<= index_33 100000) (= o6 index_33))))

;; H
  (assert
  (=> (= result4 true)
  (=> (<= index_33 100000) (= o7 (store is_prime4 o6 (distinct 0 0))))))

;; H
  (assert
  (=> (= result4 true) (=> (<= index_33 100000) (= is_prime4 result7))))

;; H
  (assert (=> (= result4 true) (=> (<= index_33 100000) (= is_prime5 o7))))

;; H
  (assert (=> (= result4 true) (=> (<= index_33 100000) true)))
...
;; H
  (assert
  (=> (= result4 true)
  (=> (<= index_33 100000) (= (mod1 index_34 index_22) 0))))

;; H
  (assert
  (=> (= result4 true)
  (=> (<= index_33 100000)
  (=> (<= (- 2147483648) 2147483647) (in_range1 index_34)))))
...
;; H
  (assert
  (=> (= result4 true) (=> (<= index_33 100000) (= index_34 result9))))

;; H
  (assert (=> (= result4 true) (=> (<= index_33 100000) (= index_35 o16))))
...
;; H
  (assert
  (=> (= result4 true) (=> (<= index_33 100000) (= is_prime6 is_prime8))))
...
;; H
  (assert
  (=> (= result4 true) (=> (<= index_33 100000) (= is_prime9 is_prime6))))
...
;; H
  (assert
  (=> (= result4 true)
  (=> (not (<= index_33 100000)) (= is_prime4 is_prime10))))
...
;; H
  (assert
  (=> (= result4 true)
  (=> (not (<= index_33 100000)) (= is_prime11 is_prime4))))

;; H
  (assert (=> (= result4 true) (= index_13 index_14)))

;; H
  (assert (=> (= result4 true) (= index_310 index_39)))

;; H
  (assert (=> (= result4 true) (= index_15 index_13)))

;; H
  (assert (=> (= result4 true) (= is_prime13 is_prime11)))

;; H
  (assert (=> (not (= result4 true)) (= index_12 index_14)))

;; H
  (assert (=> (not (= result4 true)) (= is_prime4 is_prime12)))

;; H
  (assert (=> (not (= result4 true)) (= index_310 index_32)))

;; H
  (assert (=> (not (= result4 true)) (= index_15 index_12)))

;; H
  (assert (=> (not (= result4 true)) (= is_prime13 is_prime4)))
...
;; H
  (assert (= index_24 index_23))

;; H
  (assert (= index_311 index_310))

;; H
  (assert (= index_16 index_15))

;; H
  (assert (= is_prime14 is_prime13))
