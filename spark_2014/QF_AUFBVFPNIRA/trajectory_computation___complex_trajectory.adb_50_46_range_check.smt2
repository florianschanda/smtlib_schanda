...
;; H
  (assert (and (= o8 (+ n 1)) (in_range2 (+ n 1))))

(declare-fun abstr32 () Float64)

;; H
  (assert
  (and (= o9 abstr32)
  (and (not (or (fp.isInfinite o9) (fp.isNaN o9)))
  (= o9 (fp.mul RNE ((_ to_fp 11 53) RNE (to_real o8)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))
