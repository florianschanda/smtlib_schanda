...
;; H
  (assert (=> (<= 0 2147483647) (in_range4 last1)))
...
;; H
  (assert (= result2 (ite (= o4 1) true false)))

;; H
  (assert (not (= result2 true)))

;; H
  (assert (= result3 (ite (= o5 5) true false)))

;; H
  (assert (= result3 true))

;; H
  (assert (= result4 (ite (= o6 1) true false)))
...
;; H
  (assert (=> (<= 1 16) (= o8 (+ (- 16 1) 1))))

;; H
  (assert (=> (not (<= 1 16)) (= o8 0)))
