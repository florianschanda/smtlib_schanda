...
;; H
  (assert
  (and (= o36 abstr7)
  (and (not (or (fp.isInfinite o36) (fp.isNaN o36)))
  (= o36 (fp.mul RNE ((_ to_fp 11 53) RNE (to_real n)) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))))
...
;; WP_parameter_def
 ;; File "attempt_3.adb", line 25, characters 0-0
  (not (not (or (fp.isInfinite o37) (fp.isNaN o37)))))
(check-sat)
(exit)
