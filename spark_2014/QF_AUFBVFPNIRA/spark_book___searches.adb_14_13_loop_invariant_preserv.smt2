...
;; H
  (assert (= result1 (ite (= o2 value) true false)))

;; H
  (assert (not (= result1 true)))

;; H
  (assert (and (= o3 (+ position1 1)) (in_range1 (+ position1 1))))
...
;; H
  (assert (= result3 (ite (= o5 value) true false)))

;; H
  (assert (not (= result3 true)))

;; H
  (assert (and (= o6 (+ position3 1)) (in_range1 (+ position3 1))))
