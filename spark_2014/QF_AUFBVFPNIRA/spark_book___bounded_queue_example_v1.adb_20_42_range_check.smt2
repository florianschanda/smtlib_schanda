...
;; H
  (assert (=> (and (<= 1 count6) (<= count6 5)) (= temp___586 value)))

;; H
  (assert
  (=> (and (<= 1 count6) (<= count6 5))
...
;; H
  (assert (=> (and (<= 1 count6) (<= count6 5)) (= count7 5)))

;; H
  (assert (=> (and (<= 1 count6) (<= count6 5)) (= count8 count7)))

;; H
  (assert (=> (and (<= 1 count6) (<= count6 5)) (= value4 value3)))

;; H
  (assert (=> (and (<= 1 count6) (<= count6 5)) (= count9 count8)))

;; H
  (assert (=> (and (<= 1 count6) (<= count6 5)) (= value5 value4)))

;; H
  (assert (=> (not (and (<= 1 count6) (<= count6 5))) (= count9 count6)))

;; H
  (assert (=> (not (and (<= 1 count6) (<= count6 5))) (= value5 value1)))
