...
;; H
  ...
  (= o28 (fp.mul RNE ((_ to_fp 11 53) RNE (to_real o27)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))

;; H
  (assert
  (and (= o25 abstr5)
  (and (not (or (fp.isInfinite o25) (fp.isNaN o25)))
  (= o25 (fp.mul RNE ((_ to_fp 11 53) RNE (to_real n)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))
...
;; WP_parameter_def
 ;; File "attempt_3.adb", line 25, characters 0-0
  (not (not (or (fp.isInfinite o26) (fp.isNaN o26)))))
(check-sat)
(exit)
