...
;; H
  (assert (=> (= result19 true) (in_range4 length_of_yes_no)))
...
;; H
  ...
  (=> (= result19 true)
  (=> (and (< 0 length_of_yes_no) (<= length_of_yes_no 3))
  (=> (not (< length_of_yes_no 3)) (= result20 false)))))
...
;; H
  ...
  (=> (= result19 true)
  (=> (and (< 0 length_of_yes_no) (<= length_of_yes_no 3))
  (=> (= result21 true) (= result22 (ite (= o74 1) true false))))))

;; H
  (assert
  (=> (= result19 true)
  (=> (and (< 0 length_of_yes_no) (<= length_of_yes_no 3))
  (=> (= result21 true) (not (= result22 true))))))

;; H
  (assert
  (=> (= result19 true)
  (=> (and (< 0 length_of_yes_no) (<= length_of_yes_no 3))
  (=> (= result21 true) (= result23 (ite (= o75 1) true false))))))
...
;; H
  ...
  (=> (and (< 0 length_of_yes_no) (<= length_of_yes_no 3))
  (=> (= result21 true)
  (=> (= result23 true) (and (= o81 o80) (in_range2 o80)))))))

;; H
  (assert
  (=> (= result19 true)
  (=> (and (< 0 length_of_yes_no) (<= length_of_yes_no 3))
  (=> (= result21 true) (not (= result23 true))))))

;; H
  (assert
  (=> (= result19 true)
  (=> (and (< 0 length_of_yes_no) (<= length_of_yes_no 3))
  (=> (= result21 true) (= result23 true)))))

;; H
  (assert (=> (= result19 true) (= result24 (ite (= o82 1) true false))))

;; H
  (assert (=> (= result19 true) (= result24 true)))

;; H
  (assert (= last_of_yes_no4 last_of_yes_no3))
