...
;; H
  (assert (and (= o1 (bvadd res2 abstr8)) (in_range1 (bvadd res2 abstr8))))
...
;; H
  (assert
  (=> (bvult res3 abstr6)
  (and (bvule abstr8 (bvsub abstr6 res3)) (bvule (bvsub abstr6 res3) abstr6))))

;; H
  (assert (=> (bvult res3 abstr6) (= o2 (bvsub abstr6 res3))))

;; H
  (assert (=> (bvult res3 abstr6) (= o3 (select inputs o2))))

;; H
  (assert (=> (not (bvult res3 abstr6)) (= o3 false)))
...
;; H
  (assert (bvule (bvsub abstr6 res3) i2))

;; H
  (assert (bvule i2 abstr6))

(assert
;; WP_parameter_def
 ;; File "counter.ads", line 9, characters 0-0
  (not (= (select inputs i2) true)))
(check-sat)
(exit)
