...
;; H
  (assert (= o22 (ite (< 0 o21) o21 0)))

;; H
  (assert (= o23 (ite (<= o22 v3) true false)))

(declare-fun abstr13 () Bool)

;; H
  (assert (= result3 abstr13))

;; H
  (assert (and (=> (= result2 true) true) (=> false (= result2 true))))
...
;; H
  (assert (= o12 (ite (< 100000 o11) 100000 o11)))

;; H
  (assert (= o13 (ite (<= v2 o12) true false)))

;; H
  (assert (= result4 (ite (<= value v2) o13 false)))
