...
;; H
  (assert
  (and (= o (fp.add RNE x (fp #b0 #b01111101 #b10011001100110011001101)))
  (not (or (fp.isInfinite (fp.add RNE x (fp #b0 #b01111101 #b10011001100110011001101))) (fp.isNaN (fp.add RNE
  x (fp #b0 #b01111101 #b10011001100110011001101)))))))
...
;; WP_parameter_def
 ;; File "test_float.adb", line 3, characters 0-0
  (not
  (fp.eq x2 (fp.add RNE x (fp #b0 #b01111101 #b10011001100110011001101)))))
(check-sat)
(exit)
