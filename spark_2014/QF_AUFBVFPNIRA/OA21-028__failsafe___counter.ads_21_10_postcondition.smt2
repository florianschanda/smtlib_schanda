...
;; H
  (assert (= result7 counter__model__current_chain_length__result4))

;; H
  (assert (not (= (select inputs abstr6) true)))

(assert
;; WP_parameter_def
 ;; File "counter.ads", line 9, characters 0-0
  (not (= counter__model__current_chain_length__result4 abstr7)))
(check-sat)
(exit)
