...
;; H
  (assert
  (=> (or (= mode 1) (= mode 2))
  (and (= o8 value) (not (= value (- 2147483648))))))
...
;; H
  (assert (=> (or (= mode 1) (= mode 2)) (= left_is_out8 left_is_out7)))

;; H
  (assert (=> (or (= mode 1) (= mode 2)) (= left7 left6)))

;; H
  (assert (=> (or (= mode 1) (= mode 2)) (= left_is_out9 left_is_out8)))

;; H
  (assert (=> (or (= mode 1) (= mode 2)) (= left8 left7)))

;; H
  (assert (=> (or (= mode 1) (= mode 2)) (= left_is_out11 left_is_out9)))

;; H
  (assert (=> (or (= mode 1) (= mode 2)) (= left9 left8)))

;; H
  (assert (=> (not (or (= mode 1) (= mode 2))) (= left_is_out10 (of_int 1))))

;; H
  (assert
  (=> (not (or (= mode 1) (= mode 2))) (= left_is_out11 left_is_out10)))

;; H
  (assert (=> (not (or (= mode 1) (= mode 2))) (= left9 left1)))
...
;; H
  (assert (and (= o19 o15) (in_range1 o15)))

;; H
  (assert (= result12 (ite (<= o19 o18) true false)))
