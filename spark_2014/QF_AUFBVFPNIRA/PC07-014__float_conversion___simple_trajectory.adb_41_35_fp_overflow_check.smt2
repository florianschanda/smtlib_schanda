...
;; H
  (assert (and (= o25 (+ n 1)) (in_range2 (+ n 1))))
...
;; H
  (assert
  (and (= o26 abstr8)
  (and (not (or (fp.isInfinite o26) (fp.isNaN o26)))
  (= o26 (fp.mul RNE ((_ to_fp 11 53) RNE (to_real o25)) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))))

;; H
  (assert
  (and (= o23 abstr7)
  (and (not (or (fp.isInfinite o23) (fp.isNaN o23)))
  (= o23 (fp.mul RNE ((_ to_fp 11 53) RNE (to_real n)) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))))

;; H
  (assert
  (= o24 (fp.sub RNE o23 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
