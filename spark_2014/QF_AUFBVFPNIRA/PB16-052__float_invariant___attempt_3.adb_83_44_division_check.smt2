...
;; H
  (assert
  (fp.leq abstr7 (fp.sub RNE abstr6 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))

;; H
  (assert (fp.leq abstr7 new_speed1))

;; H
  (assert
  (and (= o45 (fp.add RNE old_speed new_speed1))
