...
(define-fun dynamic_invariant8 ((temp___expr_237 Int)
...
(define-fun dynamic_invariant12 ((temp___expr_323 Int)
...
(define-fun dynamic_invariant13 ((temp___expr_365 Int)
...
;; H
  (assert (and (= o62 o61) (fp.isFinite32 o61)))
...
;; H
  (assert (and (= o66 o65) (fp.isFinite32 o65)))
...
;; H
  (assert (and (= o72 o71) (fp.isFinite32 o71)))

;; H
  (assert (= drivespeed2 o72))

;; H
  (assert (and (= o75 o74) (fp.isFinite32 o74)))
...
;; H
  (assert (and (= o79 o78) (fp.isFinite32 o78)))
...
;; H
  (assert (and (= o82 o81) (fp.isFinite32 o81)))
