...
;; H
  (assert
  (and (= o abstr1) (and (fp.isFinite32 o) (= o (fp.add RNE x11 x11)))))
...
;; H
  (assert
  (and (= o2 abstr3) (and (fp.isFinite32 o2) (= o2 (fp.mul RNE x31 x31)))))
...
;; H
  (assert
  (and (= o3 abstr4) (and (fp.isFinite32 o3) (= o3 (fp.sub RNE x41 x41)))))
