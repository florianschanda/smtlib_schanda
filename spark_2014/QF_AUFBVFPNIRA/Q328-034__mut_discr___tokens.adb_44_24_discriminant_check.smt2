...
;; H
  (assert (= o19 (ite (= o18 47) true false)))

;; H
  (assert (= o15 (ite (= o14 42) true false)))

;; H
  (assert (= o16 (ite (= o12 43) true false)))
...
;; H
  (assert (= result2 abstr3))

;; H
  (assert (not (= result2 true)))

;; H
  (assert (= result3 (ite (= o23 45) true false)))

;; H
  (assert (= result3 true))

;; H
  (assert (= result4 (ite (< 1 o24) true false)))

;; H
  (assert (= result4 true))

;; H
  (assert (in_range6 r13b))
