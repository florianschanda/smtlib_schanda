...
;; H
  (assert (and (= o6 abstr1) (not (or (fp.isInfinite o6) (fp.isNaN o6)))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (not (or (fp.isInfinite (fp.add RNE result__2 (fp #b0 #b01111111111 #b1001001000011111101101010100010001000010110100011000))) (fp.isNaN (fp.add RNE
  result__2 (fp #b0 #b01111111111 #b1001001000011111101101010100010001000010110100011000)))))))
(check-sat)
(exit)
