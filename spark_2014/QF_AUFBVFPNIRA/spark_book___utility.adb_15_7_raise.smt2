...
;; H
  (assert
  (=> (and (<= 0 index1) (<= index1 1023))
  (= utility__search_for_zero__result12 utility__search_for_zero__result10)))

;; H
  (assert (=> (and (<= 0 index1) (<= index1 1023)) (= index11 index9)))

;; H
  (assert (=> (not (and (<= 0 index1) (<= index1 1023))) (= index1 index10)))

;; H
  (assert
  (=> (not (and (<= 0 index1) (<= index1 1023)))
  (= utility__search_for_zero__result12 utility__search_for_zero__result1)))

;; H
  (assert (=> (not (and (<= 0 index1) (<= index1 1023))) (= index11 index1)))
