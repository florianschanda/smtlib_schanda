...
;; H
  (assert
  (fp.leq (fp.sub RNE abstr6 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.sub RNE
...
;; WP_parameter_def
 ;; File "simple_trajectory.ads", line 27, characters 0-0
  (not
  (fp.leq (fp.sub RNE abstr6 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))
  new_speed1)))
(check-sat)
(exit)
