...
;; H
  (assert
  (=> (and (<= 1 j4) (<= j4 2))
  (=> (not (= i12 j5)) (= o3 (fp.div RNE o1 o2)))))

;; H
  (assert
  (=> (and (<= 1 j4) (<= j4 2))
  (=> (not (= i12 j5))
  (and (= o4 o3) (not (or (fp.isInfinite o3) (fp.isNaN o3)))))))

;; H
  (assert
  (=> (and (<= 1 j4) (<= j4 2))
  (=> (not (= i12 j5)) (= o8 (fp.div RNE o6 o7)))))
...
;; H
  (assert (=> (and (<= 1 j4) (<= j4 2)) (= j6 j5)))

;; H
  (assert (=> (and (<= 1 j4) (<= j4 2)) (= j7 j6)))

;; H
  (assert (=> (not (and (<= 1 j4) (<= j4 2))) (= j7 j4)))
