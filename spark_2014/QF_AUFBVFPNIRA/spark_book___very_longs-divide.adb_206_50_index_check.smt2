...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b))
  (= o10 ((_ zero_extend 8) o9))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b))
  (and (= o5 (+ j divisor_index2)) (in_range1 (+ j divisor_index2)))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b))
  (= o13 (bvadd o12 carry2))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= sum3 o13)))

(declare-fun abstr14 () (_ BitVec 8))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= o15 abstr14)))
...
;; H
  ...
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b))
  (and (= o17 abstr17)
  (= o17 (bvudiv sum3 (ite (< 8 65536) (bvshl abstr15 abstr16) abstr12))))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= carry3 o17)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= sum4 sum3)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= sum5 sum4)))
