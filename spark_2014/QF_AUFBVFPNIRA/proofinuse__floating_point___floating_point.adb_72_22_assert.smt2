...
;; H
  (assert
  (fp.lt y (fp.add RNE (fp.div RNE abstr1 (fp #b0 #b10000000 #b00011110001101010100000)) (fp #b0 #b01111111 #b00000000000000000000000))))
...
;; WP_parameter_def
 ;; File "floating_point.adb", line 55, characters 0-0
  (not
  (fp.lt res1 (fp.add RNE (fp.div RNE abstr2 (fp #b0 #b10000000 #b00011110001101010100000)) (fp #b0 #b01111111 #b00000000000000000000000)))))
(check-sat)
(exit)
