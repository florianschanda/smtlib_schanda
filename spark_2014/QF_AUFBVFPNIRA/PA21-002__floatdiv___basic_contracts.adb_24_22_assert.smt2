...
;; H
  ...
  denominator))))
  (not (or (fp.isInfinite (fp.div RNE ((_ to_fp 8 24) RNE (to_real numerator)) ((_ to_fp 8 24) RNE (to_real
  denominator)))) (fp.isNaN (fp.div RNE ((_ to_fp 8 24) RNE (to_real
  numerator)) ((_ to_fp 8 24) RNE (to_real denominator))))))))
