...
(define-fun dynamic_invariant7 ((temp___expr_414 Int)
...
(define-fun dynamic_invariant12 ((temp___expr_198 Float32)
...
(define-fun dynamic_invariant13 ((temp___expr_323 Int)
...
(define-fun dynamic_invariant14 ((temp___expr_499 Int)
...
(define-fun dynamic_invariant15 ((temp___expr_521 Int)
...
;; H
  (assert (not (= candidate_valley_ids__attr__constrained true)))
