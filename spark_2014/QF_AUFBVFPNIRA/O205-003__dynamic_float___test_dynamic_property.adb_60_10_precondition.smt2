...
;; H
  (assert
  (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y)
  (and (= us1 y) (dynamic_property1
  (fp #b0 #b01111111 #b00000000000000000000000) last1 y))))

;; H
  (assert
  (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (= o3 y)))

;; H
  (assert
  (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y)
  (= o3 test_dynamic_property__dyn_param__x)))
...
;; H
  (assert
  (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y)
  (and (= us2 test_dynamic_property__dyn_param__x1) (dynamic_property
  (fp #b0 #b00000000 #b00000000000000000000000) last
  test_dynamic_property__dyn_param__x1))))

;; H
  (assert
  (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y)
  (= o4 test_dynamic_property__dyn_param__x1)))

;; H
  (assert
  (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (= y2 o4)))

;; H
  (assert
  (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (fp.leq y2 c)))

;; H
  (assert
  (=> (not (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y))
  (= y2 y)))
...
;; H
  (assert
  (and (= us3 x3) (dynamic_property
  (fp #b0 #b00000000 #b00000000000000000000000) last x3)))

;; H
  (assert (= o5 x3))

;; H
  (assert (= o5 test_dynamic_property__nested__dyn_param__x))
