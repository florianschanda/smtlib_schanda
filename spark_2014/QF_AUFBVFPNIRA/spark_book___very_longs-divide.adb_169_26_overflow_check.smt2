...
;; H
  (assert (= o3 (bvmul q_hat o2)))

;; H
  (assert (= o4 (bvadd o3 carry2)))
...
;; H
  (assert (= temporary_digit3 (bvand product3 abstr16)))

;; H
  (assert (and (= o6 (+ j divisor_index2)) (in_range1 (+ j divisor_index2))))

;; H
  (assert (= temp___1267 (- o6 1)))

;; H
  (assert (= o7 temp___1267))
...
;; H
  (assert (=> (= result true) (= future_borrow3 abstr12)))

;; H
  (assert (=> (not (= result true)) (= future_borrow4 abstr13)))

;; H
  (assert (=> (not (= result true)) (= future_borrow3 future_borrow4)))
...
;; H
  (assert (= temp___1269 (- o11 1)))

;; H
  (assert (= o12 temp___1269))

;; H
  (assert (= o14 ((_ zero_extend 8) o13)))

;; H
  (assert (= o15 (bvsub o14 temporary_digit3)))

;; H
  (assert (= o16 (bvsub o15 current_borrow2)))

;; H
  (assert (= o17 (bvand o16 abstr16)))

;; H
  (assert (= o18 o17))

;; H
  (assert (= o19 ((_ extract 7 0) o18)))
