...
;; H
  (assert (= last_of_yes_no17 last_of_yes_no16))

;; H
  (assert (= last11 last10))

;; H
  (assert (= result28 (ite (not (= o87 true)) true false)))

;; H
  (assert (= result28 true))

;; H
  (assert (= result29 (ite (= o88 1) true false)))

;; H
  (assert (not (= result29 true)))

;; H
  (assert (= result30 (ite (= o90 1) true false)))

;; H
  (assert (= result30 true))

;; H
  (assert (=> (<= 1 51) (= o92 (+ (- 51 1) 1))))

;; H
  (assert (=> (not (<= 1 51)) (= o92 0)))
