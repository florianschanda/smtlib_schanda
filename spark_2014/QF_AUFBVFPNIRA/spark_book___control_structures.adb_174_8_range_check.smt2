...
;; H
  (assert
  (= result5 (ite (fp.lt (fp #b0 #b01110001 #b10100011011011100010111)
             o19) true false)))

;; H
  (assert (=> (= result5 true) (= temp___534 approx1)))
...
;; H
  (assert
  (=> (and (<= 5 count1) (<= count1 8)) (and (<= 5 count2) (<= count2 8))))

;; H
  (assert (=> (and (<= 5 count1) (<= count1 8)) (= count2 8)))

;; H
  (assert (=> (and (<= 5 count1) (<= count1 8)) (= count3 count2)))

;; H
  (assert (=> (and (<= 5 count1) (<= count1 8)) (= count4 count3)))

;; H
  (assert (=> (not (and (<= 5 count1) (<= count1 8))) (= count4 count1)))
