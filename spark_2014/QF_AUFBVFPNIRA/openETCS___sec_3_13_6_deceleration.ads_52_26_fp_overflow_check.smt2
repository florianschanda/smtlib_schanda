...
;; H
  ...
  (and (= o1 abstr4)
  (and (in_range1 o1)
  (= o1 (fp.mul RNE (fp.mul RNE abstr1 (fp.add RNE abstr2 (fp.mul RNE (fp #b0 #b00000000 #b00000000000000000000000) (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000)
  abstr2)))) abstr3)))))
