...
;; H
  ...
  (and (= o1 abstr5)
  (and (in_range2 o1)
  (= o1 (fp.mul RNE (fp.mul RNE abstr2 (fp.add RNE abstr3 (fp.mul RNE (fp #b0 #b00000000 #b00000000000000000000000) (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000)
  abstr3)))) abstr4)))))
