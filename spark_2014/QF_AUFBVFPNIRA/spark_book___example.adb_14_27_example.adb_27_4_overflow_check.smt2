...
(define-fun dynamic_invariant1 ((temp___expr_478 Int)
...
;; H
  (assert (= value1 ada__integer_text_io__get__2__item))
...
(assert
;; WP_parameter_def
 ;; File "a-tiinio.ads", line 49, characters 0-0
  (not (in_range1 (+ value1 1))))
(check-sat)
(exit)
