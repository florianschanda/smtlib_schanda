...
;; H
  (assert
  (and (= o32 abstr6)
  (and (fp.isFinite64 o32)
  (= o32 (fp.mul RNE ((_ to_fp 11 53) RNE (to_real n)) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))))

;; H
  (assert
  (= o33 (fp.sub RNE o32 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))

(assert
;; WP_parameter_def
 ;; File "attempt_3.adb", line 25, characters 0-0
  (not (fp.isFinite64 o33)))
(check-sat)
(exit)
