...
;; H
  (assert (=> (= result3 true) (= deltamag2 result4)))

;; H
  (assert (=> (= result3 true) (= deltamag3 o7)))

;; H
  (assert (=> (= result3 true) (= deltaangle2 result5)))

;; H
  (assert (=> (= result3 true) (= deltaangle3 o8)))
...
;; H
  (assert (=> (= result3 true) (= deltaareasum3 o9)))
...
;; H
  (assert (=> (= result3 true) (= o11 (fp.add RNE obstacleavoiddelta2 o10))))

;; H
  (assert (=> (= result3 true) (and (= o12 o11) (fp.isFinite32 o11))))

;; H
  (assert (=> (= result3 true) (= obstacleavoiddelta2 result7)))

;; H
  (assert (=> (= result3 true) (= obstacleavoiddelta3 o12)))
...
;; H
  (assert (=> (not (= result3 true)) (= deltaareasum3 deltaareasum2)))

;; H
  (assert (=> (not (= result3 true)) (= deltaangle3 deltaangle2)))

;; H
  (assert (=> (not (= result3 true)) (= deltamag3 deltamag2)))
