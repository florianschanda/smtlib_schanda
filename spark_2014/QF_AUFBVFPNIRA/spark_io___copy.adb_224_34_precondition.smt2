...
;; H
  (assert (= result10 (ite (= o37 1) true false)))

;; H
  (assert (= result10 true))

;; H
  (assert (= o39 (ite (= o38 1) true false)))
...
;; H
  (assert (= result12 (ite (= o41 1) true false)))

;; H
  (assert (not (= result12 true)))

;; H
  (assert (= result13 (ite (= o42 5) true false)))

;; H
  (assert (not (= result13 true)))

;; H
  (assert (= result15 (ite (= o50 6) true false)))

;; H
  (assert (= result15 true))

;; H
  (assert (= result16 (ite (= o51 1) true false)))
...
;; H
  (assert (=> (= result16 true) (=> (<= 1 24) (= o53 (+ (- 24 1) 1)))))

;; H
  (assert (=> (= result16 true) (=> (not (<= 1 24)) (= o53 0))))

;; H
  (assert (=> (= result16 true) (= o54 (+ o53 o52))))

;; H
  (assert (=> (= result16 true) (= o55 (+ 1 o54))))

;; H
  (assert (=> (= result16 true) (= o56 (- o55 1))))

;; H
  (assert (=> (= result16 true) (and (= o57 o56) (in_range2 o56))))

;; H
  (assert (= result16 true))

;; H
  (assert (= result17 (ite (= o58 1) true false)))
...
;; H
  (assert (=> (= result17 true) (=> (<= 1 9) (= o60 (+ (- 9 1) 1)))))

;; H
  (assert (=> (= result17 true) (=> (not (<= 1 9)) (= o60 0))))

;; H
  (assert (=> (= result17 true) (= o61 (+ o60 o59))))

;; H
  (assert (=> (= result17 true) (= o62 (+ 1 o61))))

;; H
  (assert (=> (= result17 true) (= o63 (- o62 1))))

;; H
  (assert (=> (= result17 true) (and (= o64 o63) (in_range2 o63))))

;; H
  (assert (= result18 (ite (= o71 1) true false)))
...
;; H
  (assert (= result19 (ite (= o72 1) true false)))
...
;; H
  (assert
  (and (= o73 (+ (- last_of_yes_no3 1) 1)) (in_range1
  (+ (- last_of_yes_no3 1) 1))))

;; H
  (assert
  (and (= copy__B_3__B_4__length_of_yes_no__assume o73) (in_range4 o73)))
...
;; H
  (assert (=> (not (< length_of_yes_no 3)) (= result20 false)))
...
;; H
  (assert (= result22 (ite (= o74 1) true false)))

;; H
  (assert (not (= result22 true)))

;; H
  (assert (= result23 (ite (= o75 1) true false)))
