...
;; H
  (assert
  (=> (not (= (bvand difference3 abstr14) abstr12)) (= borrow3 abstr13)))

;; H
  (assert (=> (= (bvand difference3 abstr14) abstr12) (= borrow4 abstr12)))

;; H
  (assert (=> (= (bvand difference3 abstr14) abstr12) (= borrow3 borrow4)))
