...
;; H
  ...
  (= o1 (fp.sub RNE (fp.add RNE (fp.sub RNE x (fp.div RNE abstr1 (fp #b0 #b10000001 #b10000000000000000000000))) (fp.div RNE
  abstr2 (fp #b0 #b10000101 #b11100000000000000000000))) (fp.div RNE
  abstr3 (fp #b0 #b10001011 #b00111011000000000000000)))))))
