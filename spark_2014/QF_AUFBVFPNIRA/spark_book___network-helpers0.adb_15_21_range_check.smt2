...
;; H
  (assert (= msb1 ((_ extract 7 0) (bvand value abstr12))))

(declare-fun abstr13 () (_ BitVec 16))

;; H
  (assert (=> (< 8 16) (= o (bvlshr value abstr13))))

(declare-fun abstr14 () (_ BitVec 16))

;; H
  (assert (=> (not (< 8 16)) (= o abstr14)))

(declare-fun abstr15 () (_ BitVec 8))

(assert
;; WP_parameter_def
 ;; File "network-helpers0.ads", line 6, characters 0-0
  (not (bvule ((_ zero_extend 8) abstr15) o)))
(check-sat)
(exit)
