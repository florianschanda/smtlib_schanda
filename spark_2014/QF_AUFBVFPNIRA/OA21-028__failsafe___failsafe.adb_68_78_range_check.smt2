...
;; H
  (assert (and (= o9 counter1) (in_range2 counter1)))

;; H
  (assert (= temp___279 (bvsub current_time1 o9)))

;; H
  (assert (and (= o10 counter1) (in_range2 counter1)))

;; H
  (assert (= result4 (ite (bvult current_time1 o10) true false)))

;; H
  (assert (=> (= result4 true) (= o11 (bvadd temp___279 abstr9))))

;; H
  (assert (=> (not (= result4 true)) (= o11 temp___279)))
...
;; H
  (assert
  (and (= o4 (bvsub counter1 abstr10)) (in_range2 (bvsub counter1 abstr10))))
...
;; WP_parameter_def
 ;; File "failsafe.adb", line 31, characters 0-0
  (not (in_range2 (bvsub counter1 abstr10))))
(check-sat)
(exit)
