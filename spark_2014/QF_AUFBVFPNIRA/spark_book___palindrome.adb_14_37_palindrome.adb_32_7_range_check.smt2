...
;; H
  (assert (=> (<= right_index2 left_index2) (= result2 true)))
...
;; H
  (assert (=> (not (<= right_index2 left_index2)) (= o3 left_index2)))
...
;; H
  (assert (=> (not (<= right_index2 left_index2)) (= o2 right_index2)))

;; H
  (assert
  (=> (not (<= right_index2 left_index2)) (= o6 (ite (= o5 o4) true false))))
...
;; H
  (assert (and (= o7 (+ left_index2 1)) (in_range (+ left_index2 1))))

;; H
  (assert (= result3 left_index2))

;; H
  (assert (= left_index3 o7))
