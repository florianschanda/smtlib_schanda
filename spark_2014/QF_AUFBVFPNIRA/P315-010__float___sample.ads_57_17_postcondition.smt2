...
(define-fun dynamic_invariant2 ((temp___expr_177 Float32)
  (temp___is_init_174 Bool) (temp___skip_constant_175 Bool)
  (temp___do_toplevel_176 Bool)) Bool (=>
                                      (or (= temp___is_init_174 true)
                                      (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000010 #b00000000000000000000000)))
...
;; H
  (assert
  (= tmp1 (fp.mul RNE (fp #b0 #b01111110 #b00000000000000000000000) nb)))
...
(assert
;; WP_parameter_def
 ;; File "sample.ads", line 37, characters 0-0
