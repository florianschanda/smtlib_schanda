...
;; H
  (assert (=> (= result1 true) (= last2 clast)))

;; H
  (assert (=> (= result1 true) (in_range4 clast)))
...
;; H
  (assert (=> (= result1 true) (= result2 (ite (= o4 1) true false))))

;; H
  (assert (=> (= result1 true) (not (= result2 true))))

;; H
  (assert (=> (= result1 true) (= result3 (ite (= o5 5) true false))))

;; H
  (assert
  (=> (= result1 true)
  (=> (= result3 true) (= result4 (ite (= o6 1) true false)))))
...
;; H
  ...
  (=> (= result1 true)
  (=> (= result3 true)
  (=> (= result4 true) (=> (<= 1 16) (= o8 (+ (- 16 1) 1)))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (= result3 true) (=> (= result4 true) (=> (not (<= 1 16)) (= o8 0))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (= result3 true) (=> (= result4 true) (= o9 (+ o8 o7))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (= result3 true) (=> (= result4 true) (= o10 (+ 1 o9))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (= result3 true) (=> (= result4 true) (= o11 (- o10 1))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (= result3 true)
  (=> (= result4 true) (and (= o12 o11) (in_range2 o11))))))

;; H
  (assert (=> (= result1 true) (=> (= result3 true) (= result4 true))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= result3 true)) (= result5 (ite (= o19 6) true false)))))

;; H
  (assert (=> (= result1 true) (=> (not (= result3 true)) (= result5 true))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= result3 true)) (= result6 (ite (= o20 1) true false)))))
...
;; H
  ...
  (=> (= result1 true)
  (=> (not (= result3 true))
  (=> (= result6 true) (=> (<= 1 16) (= o22 (+ (- 16 1) 1)))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= result3 true))
  (=> (= result6 true) (=> (not (<= 1 16)) (= o22 0))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= result3 true)) (=> (= result6 true) (= o23 (+ o22 o21))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= result3 true)) (=> (= result6 true) (= o24 (+ 1 o23))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= result3 true)) (=> (= result6 true) (= o25 (- o24 1))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= result3 true))
  (=> (= result6 true) (and (= o26 o25) (in_range2 o25))))))

;; H
  (assert (=> (= result1 true) (=> (not (= result3 true)) (= result6 true))))

;; H
  (assert (=> (not (= result1 true)) (= o35 (ite (= o34 1) true false))))

;; H
  (assert
  (=> (not (= result1 true)) (= result8 (ite (not (= o35 true)) true false))))

;; H
  (assert (=> (not (= result1 true)) (not (= result8 true))))
