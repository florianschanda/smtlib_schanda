...
;; H
  (assert (not (or (fp.isInfinite cycle) (fp.isNaN cycle))))

;; H
  (assert (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cycle))
...
(assert
;; WP_parameter_def
 ;; File "a-ngelfu.ads", line 121, characters 0-0
