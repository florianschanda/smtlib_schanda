...
;; H
  (assert (= o3 (ite (= o2 abstr6) true false)))

;; H
  (assert (= result3 (ite (not (= o3 true)) true false)))

;; H
  (assert (=> (= result3 true) (and (= o4 index2) (in_range1 index2))))

;; H
  (assert (=> (= result3 true) (= digit_count1 result4)))

;; H
  (assert (=> (= result3 true) (= digit_count2 o4)))

;; H
  (assert (=> (not (= result3 true)) (= digit_count2 digit_count1)))

;; H
  (assert (= index3 result5))
...
;; H
  (assert (= o8 (ite (= o7 abstr6) true false)))

;; H
  (assert (= result6 (ite (not (= o8 true)) true false)))

;; H
  (assert (=> (= result6 true) (and (= o9 index4) (in_range1 index4))))

;; H
  (assert (=> (= result6 true) (= result7 digit_count3)))

;; H
  (assert (=> (= result6 true) (= digit_count4 o9)))
