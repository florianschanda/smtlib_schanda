...
;; H
  (assert (=> (= (mod1 c8b 4) 0) (= result1 result__1)))

;; H
  (assert (=> (= (mod1 c8b 4) 0) (= result__2 (of_int 1))))

;; H
  (assert (=> (not (= (mod1 c8b 4) 0)) (= result__2 result__1)))
...
;; H
  (assert (=> abstr (= result3 length)))

;; H
  (assert (=> abstr (= length1 29)))

;; H
  (assert (=> (not abstr) (= result4 length)))

;; H
  (assert (=> (not abstr) (= length1 length2)))
