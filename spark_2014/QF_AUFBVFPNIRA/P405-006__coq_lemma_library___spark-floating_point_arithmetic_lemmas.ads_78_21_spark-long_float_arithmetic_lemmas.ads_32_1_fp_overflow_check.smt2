...
;; H
  ...
  val3)
  (fp.leq val3 (fp #b0 #b10111111110 #b0000000000000000000000000000000000000000000000000000)))
  (fp.leq val1 val2)))))

;; H
  (assert
  (and (= o (fp.mul RNE val2 val3)) (fp.isFinite64 (fp.mul RNE val2 val3))))

(assert
;; WP_parameter_def
 ;; File "spark-floating_point_arithmetic_lemmas.ads", line 57, characters 0-0
  (not (fp.isFinite64 (fp.mul RNE val1 val3))))
(check-sat)
(exit)
