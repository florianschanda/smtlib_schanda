...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 1000)) (= i6 i5)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 1000))
  (= obstacleavoiddelta7 obstacleavoiddelta6)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 1000)) (= deltaareasum7 deltaareasum6)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 1000)) (= deltaangle7 deltaangle6)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 1000)) (= deltamag7 deltamag6)))
