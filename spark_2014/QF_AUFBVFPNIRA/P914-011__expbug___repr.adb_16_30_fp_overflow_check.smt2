...
;; H
  (assert (and (<= 0 temp___1591) (<= temp___1591 3)))

;; H
  (assert (= o2 temp___1591))

;; H
  (assert (= o4 ((_ to_fp 11 53) RNE o3)))

;; H
  (assert (and (<= 0 temp___159) (<= temp___159 3)))

;; H
  (assert (= o temp___159))

;; H
  (assert (= o5 ((_ to_fp 11 53) RNE o1)))
