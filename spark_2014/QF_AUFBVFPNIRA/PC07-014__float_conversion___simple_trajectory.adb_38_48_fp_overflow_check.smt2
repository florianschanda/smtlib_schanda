...
;; H
  (assert
  (and (= o20 abstr6)
  (and (fp.isFinite64 o20)
  (= o20 (fp.mul RNE ((_ to_fp 11 53) RNE (to_real n)) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))))

;; H
  (assert
  (= o21 (fp.sub RNE o20 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))

(assert
;; WP_parameter_def
 ;; File "simple_trajectory.ads", line 27, characters 0-0
  (not (fp.isFinite64 o21)))
(check-sat)
(exit)
