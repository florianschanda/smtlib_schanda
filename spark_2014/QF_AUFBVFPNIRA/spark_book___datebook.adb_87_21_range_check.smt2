...
(define-fun dynamic_invariant5 ((temp___expr_251 Int)
...
;; H
  (assert (=> (and (<= 1 index1) (<= index1 64)) (= index3 index2)))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 64)) (= available5 available4)))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 64)) (= found5 found4)))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 64)) (= index4 index3)))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 64)) (= available6 available5)))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 64)) (= found6 found5)))

;; H
  (assert (=> (not (and (<= 1 index1) (<= index1 64))) (= index4 index1)))

;; H
  (assert
  (=> (not (and (<= 1 index1) (<= index1 64))) (= available6 available1)))

;; H
  (assert (=> (not (and (<= 1 index1) (<= index1 64))) (= found6 found1)))
