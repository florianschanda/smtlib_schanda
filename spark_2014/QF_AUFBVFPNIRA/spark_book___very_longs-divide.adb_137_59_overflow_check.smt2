...
;; H
  (assert (=> (= result3 true) (= q_hat2 (bvsub q_hat1 abstr13))))

;; H
  (assert (=> (= result3 true) (= o28 n)))

;; H
  (assert (=> (= result3 true) (= o30 ((_ zero_extend 8) o29))))

;; H
  (assert (=> (= result3 true) (= o31 (bvadd r_hat1 o30))))

;; H
  (assert (=> (= result3 true) (= result5 r_hat1)))

;; H
  (assert (=> (= result3 true) (= r_hat2 o31)))
