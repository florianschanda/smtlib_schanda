...
;; H
  (assert
  (and (= o6 abstr4)
  (and (fp.isFinite64 o6)
  (= o6 (fp.mul RNE ((_ to_fp 11 53) RNE (to_real n)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))

;; H
  (assert
  (= o7 (fp.add RNE o6 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))

(assert
;; WP_parameter_def
 ;; File "attempt_3.adb", line 25, characters 0-0
  (not (fp.isFinite64 o7)))
(check-sat)
(exit)
