...
;; H
  (assert (=> (= result3 true) (= temp___268 approx1)))
...
;; H
  (assert (=> (= result3 true) (= o5 (fp.add RNE approx2 o4))))

;; H
  (assert (=> (= result3 true) (and (= o6 o5) (fp.isFinite32 o5))))
...
;; H
  (assert (=> (= result3 true) (= approx2 result4)))

;; H
  (assert (=> (= result3 true) (= approx3 o7)))

;; H
  (assert
  (=> (= result3 true)
  (and (= o8 (fp.mul RNE approx3 approx3))
  (fp.isFinite32 (fp.mul RNE approx3 approx3)))))

;; H
  (assert (=> (= result3 true) (= o9 (fp.sub RNE c13b o8))))

;; H
  (assert (=> (= result3 true) (and (= o10 o9) (fp.isFinite32 o9))))

;; H
  (assert (=> (= result3 true) (= o11 (fp.abs o10))))

;; H
  (assert
  (=> (= result3 true) (= o12 (ite (fp.lt tolerance o11) true false))))

;; H
  (assert
  (=> (= result3 true) (= result5 (ite (not (= o12 true)) true false))))

;; H
  (assert (=> (= result3 true) (= result5 true)))

;; H
  (assert (=> (= result3 true) (= approx3 approx4)))

;; H
  (assert (=> (= result3 true) (= approx5 approx3)))

;; H
  (assert (=> (= result3 true) (= approx7 approx5)))

;; H
  (assert (=> (not (= result3 true)) (= approx1 approx6)))

;; H
  (assert (=> (not (= result3 true)) (= approx7 approx1)))
...
;; WP_parameter_def
 ;; File "aggregates.adb", line 44, characters 0-0
  (not (fp.isFinite32 (fp.add RNE a1 c14b1))))
(check-sat)
(exit)
