...
(declare-fun temp___2007 () (Array Int us_rep1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2007 (parent
                      (rec__search_trees__search_tree__struct
                      t__split_fields10) i2))))
  (position (rec__search_trees__search_tree__struct t__split_fields10) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2007 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2007 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= temp___2007 (model__
                 (rec__search_trees__search_tree__struct t__split_fields10)
                 o33))
  (model____function_guard temp___2007
  (rec__search_trees__search_tree__struct t__split_fields10) o33))
  (and (dynamic_invariant6 temp___2007 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2007 o33))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2007 o33)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o33))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2007 (parent
                              ...
                              t__split_fields10) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2007 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2007 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2007 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2007 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2007 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2007 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o34 (select temp___2007 x1)))
