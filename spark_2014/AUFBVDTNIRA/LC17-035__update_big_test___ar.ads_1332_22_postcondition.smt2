...
(define-fun bool_eq7 ((a (Array Int us_rep1)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq6 (select a temp___idx_137)
...
(declare-fun o9 () (Array Int us_rep1))
...
(declare-fun o22 () enum1ta)

(declare-fun o23 () (Array Int us_rep1))
...
(declare-fun o31 () (Array Int us_rep1))

(declare-fun o32 () enum1ta)

(declare-fun o33 () us_split_fields2)

(declare-fun o34 () us_rep1)

(declare-fun o35 () (Array Int us_rep1))
...
(declare-fun a4 () (Array Int us_rep1))

(declare-fun a5 () map__ref)

(declare-fun a6 () (Array Int us_rep1))
