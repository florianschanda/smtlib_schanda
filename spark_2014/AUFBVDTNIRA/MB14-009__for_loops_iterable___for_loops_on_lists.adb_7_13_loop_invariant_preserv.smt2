...
;; H
  (assert
  (and (= o9 (first l))
  (ite (= (= (length2 l) 0) true) (= (bool_eq2 o9 no_element) true)
...
;; H
  (assert
  (and (= o8 (next l cu2))
  (ite (= (ite (= (bool_eq2 cu2 no_element) false) (= (get1 (positions l)
                                                      cu2) (length2 l)) true) true)
  (= (bool_eq2 o8 no_element) true)
