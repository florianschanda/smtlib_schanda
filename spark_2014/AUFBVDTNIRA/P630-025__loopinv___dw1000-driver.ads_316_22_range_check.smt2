...
(define-fun bool_eq4 ((a (Array Int bits_8)) (a__first Int) (a__last Int)
...
(define-fun dynamic_invariant2 ((temp___expr_316 (_ BitVec 8))
  (temp___is_init_313 Bool) (temp___skip_constant_314 Bool)
  (temp___do_toplevel_315 Bool)) Bool true)

(define-fun dynamic_invariant3 ((temp___expr_358 (_ BitVec 16))
  ...
  (temp___do_toplevel_357 Bool)) Bool (=>
                                      ...
                                      (in_range2 temp___expr_358)))

(define-fun dynamic_invariant4 ((temp___expr_658 us_t)
...
(assert
;; WP_parameter_def
 ;; File "dw1000-driver.adb", line 463, characters 0-0
  (not (in_range o)))
(check-sat)
