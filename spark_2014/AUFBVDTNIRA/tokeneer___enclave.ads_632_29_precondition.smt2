...
;; adminlogoncanstart__def_axiom
  ...
  (forall ((enclave__status Int))
  (! (=> (adminlogoncanstart__function_guard
     ...
     (ispresent (mk___rep enclave__startadminactivity__theadmin__fields))
     (mk___rep enclave__startadminactivity__theadmin__fields))
...
(define-fun dynamic_invariant3 ((temp___expr_2155 Int)
...
;; H
  ...
  (statusisgotadmintoken status) status))

;; H
  (assert (statusiswaitingremoveadmintokenfail__function_guard
  (statusiswaitingremoveadmintokenfail status) status))
...
;; H
  ...
  (statusiswaitingstartadminop status) status))

;; H
  (assert (statusiswaitingfinishadminop__function_guard
  (statusiswaitingfinishadminop status) status))
...
;; H
  ...
  (statusisenclavequiescent status) status))
...
;; H
  (assert (statusisshutdown__function_guard (statusisshutdown status)
  status))
...
;; H
  ...
  (= (ispresent
     (mk___rep
     (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))) true))
  (not
  (= (isdoingop
     (mk___rep
     (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))) true))))
  (=> (or (= status1 5) (= status1 4))
  (not
  (= (ispresent
     (mk___rep
     (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))) true))))
  ...
  (= (rolepresent
     (mk___rep
     (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))) 0))))
  (=>
  (and
  (= (isdoingop
     (mk___rep
  ...
  (= (thecurrentop
     (mk___rep
     (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))) 4))
  (= status1 6)))
  (=>
  (= (rolepresent
     (mk___rep
     (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))) 1)
  (and (and (= (isgood state) true) (= (authcertvalid state) true))
  (= (theauthcertrole state) 1))))
  (=>
  (and
  ...
  (= (thecurrentop
     (mk___rep
     (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))) 3))
  (= (rolepresent
     (mk___rep
     (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))) 1)))
  (=>
...
;; H
  (assert (= result (ite (= o12 1) true false)))
...
;; H
  ...
  (= o16 (isdoingop
         (mk___rep
         (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))))
  (isdoingop__function_guard o16
  (mk___rep
  (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))))))

;; H
  (assert (=> (= result true) (= o17 (ite (not (= o16 true)) true false))))
...
;; H
  ...
  (= o13 (thecurrentop
         (mk___rep
         (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))))
  (thecurrentop__function_guard o13
  (mk___rep
  (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))))
  (in_range3 o13))))

;; H
  (assert (=> (= result true) (= o14 (ite (= o13 3) true false))))
...
;; H
  (assert (=> (= result true) (= o18 (ite (= o15 true) o14 false))))

;; H
  (assert (=> (= result true) (= o19 (ite (= o18 false) o17 true))))

;; H
  (assert (=> (not (= result true)) (= o19 (of_int 1))))
...
;; H
  ...
  (= o7 (thecurrentop
        (mk___rep
        (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))))
  (thecurrentop__function_guard o7
  (mk___rep
  (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))))
  (in_range3 o7)))
...
;; H
  ...
  (= o10 (rolepresent
         (mk___rep
         (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))))
  (rolepresent__function_guard o10
  (mk___rep
  (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))))
  (in_range1 o10))))

;; H
  (assert (=> (= result1 true) (= o11 (ite (= o10 1) true false))))

;; H
  (assert (=> (not (= result1 true)) (= o11 (of_int 1))))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (and (= o3 (theauthcertrole state)) (theauthcertrole__function_guard 
  o3 state)) (in_range1 o3))))

;; H
  (assert (=> (= result2 true) (= o4 (ite (= o3 1) true false))))

;; H
  (assert
  (=> (= result2 true)
  (and (= o1 (authcertvalid state)) (authcertvalid__function_guard o1 state))))

;; H
  (assert
  (=> (= result2 true)
  (and (= o2 (isgood state)) (isgood__function_guard o2 state))))

;; H
  (assert (=> (= result2 true) (= o5 (ite (= o2 true) o1 false))))

;; H
  (assert (=> (= result2 true) (= o6 (ite (= o5 true) o4 false))))

;; H
  (assert (=> (not (= result2 true)) (= o6 (of_int 1))))
