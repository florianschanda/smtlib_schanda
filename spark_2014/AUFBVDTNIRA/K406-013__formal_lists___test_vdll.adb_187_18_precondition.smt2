...
;; H
  (assert (= temp___437 o14))

;; H
  (assert (= result17 (mk___split_fields__ref l4__split_fields2)))

;; H
  (assert (= l4__split_fields3 (us_split_fields1 temp___437)))

;; H
  (assert (= l4__split_discrs (us_split_discrs1 temp___437)))
...
;; H
  ...
  (first (mk___rep l4__split_discrs l4__split_fields4)) 4)
  (mk___rep l4__split_discrs l4__split_fields4)
  (first (mk___rep l4__split_discrs l4__split_fields4)) 4))
...
;; H
  (assert
  (and (= o15 (first (mk___rep l4__split_discrs l4__split_fields4)))
  (ite (= (= (length (mk___rep l4__split_discrs l4__split_fields4)) 0) true)
  (= (bool_eq3 o15 no_element) true)
  (and
  (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields4)) o15) true)
  (= (get1 (positions (mk___rep l4__split_discrs l4__split_fields4)) o15) 1)))))
...
;; WP_parameter_def
 ;; File "test_vdll.adb", line 18, characters 0-0
  (not
  (or
  (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o15) true)
  (= (bool_eq3 o15 no_element) true))))
(check-sat)
