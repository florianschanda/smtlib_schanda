...
;; H
  (assert (invariant____function_guard (invariant__ temp___294) temp___294))
...
;; H
  ...
  (remove__function_guard o23 (mk___t interm1 (mk 1 100)) o22))
...
;; H
  (assert
  (and
  (and (= temp___294 (remove o23 o24)) (remove__function_guard temp___294 
  o23 o24))
  (and (dynamic_invariant4 temp___294 true false true)
  (and (= (invariant__ temp___294) true)
  (and (= (to_rep1 (last (rt temp___294))) (- (to_rep1 (last (rt o23))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o24 1)))
  (= (to_rep (select (elts o23) k)) (to_rep (select (elts temp___294) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o24 1) k) (<= k (to_rep1 (last (rt o23)))))
  (= (to_rep (select (elts o23) k)) (to_rep
                                    (select (elts temp___294) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o24 k) (<= k (- (to_rep1 (last (rt o23))) 1)))
  (= (to_rep (select (elts o23) (+ k 1))) (to_rep
                                          (select (elts temp___294) k))))))))))))
