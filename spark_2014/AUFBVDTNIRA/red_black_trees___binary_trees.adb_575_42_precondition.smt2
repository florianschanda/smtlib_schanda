...
;; H
  (assert (= o49 (select temp___1893 o48)))
...
;; H
  (assert (= o45 (select temp___1892 ki1)))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o41))
  (and (dynamic_invariant3 temp___1891 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1891 o41))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1891 o41)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i o41))
...
;; H
  (assert (= o42 (select temp___1891 ki1)))
...
;; H
  (assert (= o37 (select temp___1888 o36)))
