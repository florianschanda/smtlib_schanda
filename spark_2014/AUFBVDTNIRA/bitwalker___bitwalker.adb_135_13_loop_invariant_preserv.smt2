...
;; H
  (assert
  (forall ((i4 Int)) (nth8_stream__function_guard
  (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last)))
  i4) (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) i4)))

;; H
  (assert
  (forall ((i4 Int)) (nth8_stream__function_guard
  (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last)))
  i4) (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i4)))

;; H
  (assert (nth8_stream__function_guard
  (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last)))
  o9) (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) o9))

;; H
  (assert (nth8_stream__function_guard
  (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last)))
  (+ start i2)) (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last)))
  (+ start i2)))
...
;; H
  ...
  (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last)))
  k) (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) k)))
...
;; H
  ...
  (=>
  (and (<= 0 i4)
  (<= i4 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last))
                 (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1)))
  (=> (not (= i4 o9))
  (=
  (= (nth8_stream
     (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) i4) true)
  (= (nth8_stream
     (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i4) true)))))
  (=
  (= (nth8_stream
...
;; H
  ...
  (=
  (= (nth8_stream
     (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) k) true)
  (= (nth value (- (- (+ start len) k) 1)) true))))))
...
;; WP_parameter_def
 ;; File "bitwalker.ads", line 77, characters 0-0
  (not (= (nth value (+ (- (- len j) 1) start)) true)))
(check-sat)
