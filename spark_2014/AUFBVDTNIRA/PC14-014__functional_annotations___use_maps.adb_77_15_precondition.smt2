...
;; H
  ...
  (=> (and (in_range4 temp___431) (= (iter_has_element o8 temp___431) true))
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2))
     (get1 o8 temp___431)) true))))
  (forall ((key2 Int))
  (=>
  (and (in_range2 key2)
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) key2) true))
  (and (< 0 (find o8 key2)) (= (get1 o8 (find o8 key2)) key2)))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s__split_discrs s__split_fields2))))
  (= (find o8 (get1 o8 i1)) i1))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s__split_discrs s__split_fields2))))
