...
;; H
  ...
  (= o28 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
;; H
  (assert (= o31 (ite (< o30 (+ start len)) true false)))

;; H
  (assert (= o32 (to_int2 o31)))
...
;; H
  (assert
  (=> (<= (to_rep addr__first) (to_rep addr__last))
  (= o21 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))

;; H
  (assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o21 0)))
...
;; H
  (assert (= o24 (ite (<= (+ start len) o23) true false)))

;; H
  (assert
  (and (and (= o20 (maxvalue len)) (maxvalue__function_guard o20 len))
  (= o20 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))))

;; H
  (assert (= o25 (ite (bvule o20 value) true false)))

;; H
  (assert (= o26 (ite (= o25 true) o24 false)))

;; H
  (assert (= o27 (to_int2 o26)))
...
;; H
  (assert
  (=> (<= (to_rep addr__first) (to_rep addr__last))
  (= o13 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))

;; H
  (assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o13 0)))
...
;; H
  (assert (= o16 (ite (<= (+ start len) o15) true false)))

;; H
  (assert
  (and (and (= o12 (maxvalue len)) (maxvalue__function_guard o12 len))
  (= o12 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))))

;; H
  (assert (= o17 (ite (bvugt o12 value) true false)))

;; H
  (assert (= o18 (ite (= o17 true) o16 false)))

;; H
  (assert (= o19 (to_int2 o18)))
...
;; H
  ...
  (= o10 (nth8_stream
         ...
         (mk (to_rep addr__first) (to_rep addr__last))) i1))
  (nth8_stream__function_guard o10
  (mk___t (map__content addr10)
  (mk (to_rep addr__first) (to_rep addr__last))) i1))
  (= (= o10 true)
  (= (nth1 (to_rep1 (select (map__content addr10) (div1 i1 8)))
     (- 7 (mod1 i1 8))) true))))

;; H
  (assert (= o11 (to_int2 o10)))
