...
(declare-fun agg () (Array Int integer))
...
(declare-fun agg1 () (Array Int integer))

(declare-fun result1 () (Array Int integer))

(declare-fun agg2 () (Array Int integer))

(declare-fun result2 () (Array Int integer))

(declare-fun k1 () (Array Int integer))

(declare-fun k2 () (Array Int integer))

(declare-fun agg3 () (Array Int integer))

(declare-fun k3 () (Array Int integer))

(declare-fun agg4 () (Array Int integer))
...
;; H
  (assert (= o1 (temp___152 (div1 1 x) o)))

;; H
  (assert (= (mk_map__ref result) (mk_map__ref agg)))
...
;; H
  (assert
  (and (= o2 (+ (to_rep (select agg1 1)) 1)) (in_range1
  (+ (to_rep (select agg1 1)) 1))))

;; H
  (assert (= (to_rep o3) o2))

;; H
  (assert (= o4 (store agg1 1 o3)))
