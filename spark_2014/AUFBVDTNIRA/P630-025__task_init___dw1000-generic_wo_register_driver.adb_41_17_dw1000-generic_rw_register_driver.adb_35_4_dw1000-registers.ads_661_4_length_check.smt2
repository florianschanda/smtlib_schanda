...
(define-fun dynamic_invariant ((temp___expr_7219 us_t1)
  ...
  (temp___do_toplevel_7218 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_7219))
                                       (and (= (first3 temp___expr_7219) 1)
                                       (= (last4 temp___expr_7219) 4)))))
...
(define-fun dynamic_invariant1 ((temp___expr_7250 us_t2)
  ...
  (temp___do_toplevel_7249 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_7250))
                                       (and (= (first5 temp___expr_7250) 1)
                                       (= (last6 temp___expr_7250) 4)))))
...
(declare-fun temp___8070 () (Array Int bits_8))

(declare-fun temp___80701 () t2)

(declare-fun temp___8071 () (Array Int bits_8))

(declare-fun temp___80711 () t1)
...
;; H
  (assert
  (and
  (and (= temp___80702 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___80702 reg)) (dynamic_invariant1
  temp___80702 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80701)) (to_rep (last5 temp___80701)))
     (+ (- (to_rep (last5 temp___80701)) (to_rep (first4 temp___80701))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___8070 temp___8071))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80701)) (to_rep (last5 temp___80701))) 
  temp___80711))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___80711)) (to_rep (last3 temp___80711)))
     (+ (- (to_rep (last3 temp___80711)) (to_rep (first2 temp___80711))) 1)
