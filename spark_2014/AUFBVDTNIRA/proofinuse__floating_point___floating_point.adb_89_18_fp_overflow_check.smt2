...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral3) (/ 3276800048828125.0 1000000000000.0))))
...
;; H
  (assert (and (le fliteral2 y) (le y fliteral)))

;; H
  (assert (= result res))

;; H
  (assert (= res1 (div1 RNE2 (of_ubv16 RNA2 x) fliteral3)))

;; H
  (assert
  (=> (le fliteral4 res1)
  (and (= o (sub RNE2 res1 fliteral5)) (tqtisFinite
  (sub RNE2 res1 fliteral5)))))

;; H
  (assert (=> (le fliteral4 res1) (= result1 res1)))

;; H
  (assert (=> (le fliteral4 res1) (= res2 o)))

;; H
  (assert (=> (not (le fliteral4 res1)) (= res2 res1)))

(assert
;; WP_parameter_def
 ;; File "floating_point.adb", line 66, characters 0-0
  (not (tqtisFinite (div1 RNE2 res2 y))))
(check-sat)
