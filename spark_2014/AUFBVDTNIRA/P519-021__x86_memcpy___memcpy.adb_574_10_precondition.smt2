...
;; ax__post_axiom
  ...
  (! (=> (dynamic_invariant x86__rax true true true)
     ...
     (and (readreg16__function_guard (readreg16 x86__rax) x86__rax)
...
;; H
  (assert
  (and
  (and (= o (readmem64 rsp (map__content memory))) (readmem64__function_guard
  o rsp (map__content memory)))
  (and
  (and
  (and
  (and
...
;; H
  (assert
  (and
  (and (= o3 (readmem8 rsp (map__content memory))) (readmem8__function_guard
  o3 rsp (map__content memory)))
...
;; H
  ...
  (readmem8__function_guard o5 (bvadd rsp ((_ int2bv 64) 1))
  (map__content memory)))
...
;; H
  ...
  (readmem8__function_guard o7 (bvadd rsp ((_ int2bv 64) 2))
  (map__content memory)))
...
;; H
  ...
  (readmem8__function_guard o9 (bvadd rsp ((_ int2bv 64) 3))
  (map__content memory)))
...
;; H
  ...
  (readmem8__function_guard o11 (bvadd rsp ((_ int2bv 64) 4))
  (map__content memory)))
  (= o11 (to_rep
...
;; H
  ...
  (readmem8__function_guard o13 (bvadd rsp ((_ int2bv 64) 5))
  (map__content memory)))
  (= o13 (to_rep
...
;; H
  ...
  (readmem8__function_guard o15 (bvadd rsp ((_ int2bv 64) 6))
  (map__content memory)))
  (= o15 (to_rep
...
;; H
  ...
  (readmem8__function_guard o17 (bvadd rsp ((_ int2bv 64) 7))
  (map__content memory)))
  (= o17 (to_rep
...
;; H
  (assert (= rsp2 (bvsub rsp1 ((_ int2bv 64) 144))))
...
;; H
  (assert
  (and (and (= o19 (edi rdi)) (edi__function_guard o19 rdi))
  (= o19 (readreg32 rdi))))
...
;; H
  (assert (= rdx1 (bvadd rbp1 ((_ int2bv 64) 18446744073709551560))))
...
;; H
  (assert (writereg32post__function_guard
  (writereg32post rcx ((_ int2bv 32) 5)) rcx ((_ int2bv 32) 5)))

;; H
  (assert (= (writereg32post rcx ((_ int2bv 32) 5)) true))
...
;; H
  ...
  (and
  (and
  (= (bvand rax ((_ int2bv 64) 255)) ((_ zero_extend 56) (to_rep
                                                         (select (let ((subject 
                                                                 memory))
                                                                 memory5) 
                                                         rdi1))))
  (= (bvand rax ((_ int2bv 64) 65280)) (bvmul ((_ zero_extend 56) (to_rep
                                                                  (select 
                                                                  (let ((subject 
                                                                  memory))
                                                                  memory5) (bvadd 
                                                                  rdi1 ((_ int2bv 64) 1))))) ((_ int2bv 64) 256))))
  (= (bvand rax ((_ int2bv 64) 16711680)) (bvmul ((_ zero_extend 56) 
  (to_rep
  (select (let ((subject memory)) memory5) (bvadd rdi1 ((_ int2bv 64) 2))))) ((_ int2bv 64) 65536))))
  (= (bvand rax ((_ int2bv 64) 4278190080)) (bvmul ((_ zero_extend 56) 
  (to_rep
  (select (let ((subject memory)) memory5) (bvadd rdi1 ((_ int2bv 64) 3))))) ((_ int2bv 64) 16777216))))
  (= (bvand rax ((_ int2bv 64) 1095216660480)) (bvmul ((_ zero_extend 56) 
  (to_rep
  (select (let ((subject memory)) memory5) (bvadd rdi1 ((_ int2bv 64) 4))))) ((_ int2bv 64) 4294967296))))
  (= (bvand rax ((_ int2bv 64) 280375465082880)) (bvmul ((_ zero_extend 56) 
  (to_rep
  (select (let ((subject memory)) memory5) (bvadd rdi1 ((_ int2bv 64) 5))))) ((_ int2bv 64) 1099511627776))))
  (= (bvand rax ((_ int2bv 64) 71776119061217280)) (bvmul ((_ zero_extend 56) 
  (to_rep
  (select (let ((subject memory)) memory5) (bvadd rdi1 ((_ int2bv 64) 6))))) ((_ int2bv 64) 281474976710656))))
  (= (bvand rax ((_ int2bv 64) 18374686479671623680)) (bvmul ((_ zero_extend 56) 
  (to_rep
...
;; H
  (assert (readreg16__function_guard (readreg16 rax) rax))

;; H
  (assert
  (and (and (= o20 (ax rax)) (ax__function_guard o20 rax))
  (= o20 (readreg16 rax))))
...
;; H
  (assert (= rdx3 (bvadd rdx2 ((_ int2bv 64) 2))))

;; H
  (assert (= result21 (mk_t__ref3 rax)))

;; H
  (assert (= rax1 (bvadd rbp1 ((_ int2bv 64) 18446744073709551488))))
...
;; H
  (assert (writereg32post__function_guard
  (writereg32post rdi2 ((_ int2bv 32) 4196228)) rdi2
  ((_ int2bv 32) 4196228)))

;; H
  (assert (= (writereg32post rdi2 ((_ int2bv 32) 4196228)) true))
...
;; H
  (assert (= rax3 (bvadd rbp1 ((_ int2bv 64) 18446744073709551552))))
...
;; H
  (assert (= rsp5 (bvsub rsp4 ((_ int2bv 64) 8))))

;; H
  (assert (= rsp6 (bvadd rsp5 ((_ int2bv 64) 8))))

;; H
  (assert (= result27 (mk_t__ref3 rax3)))

;; H
  (assert (= rax4 ((_ int2bv 64) 50)))

;; H
  (assert (= result28 (mk_t__ref3 rdx3)))

;; H
  (assert (= rdx4 (bvadd rax4 ((_ int2bv 64) 1))))

;; H
  (assert (= result29 (mk_t__ref3 rcx)))

;; H
  (assert (= rcx1 (bvadd rbp1 ((_ int2bv 64) 18446744073709551552))))

;; H
  (assert (= result30 (mk_t__ref3 rax4)))

;; H
  (assert (= rax5 (bvadd rbp1 ((_ int2bv 64) 18446744073709551488))))
...
;; H
  (assert (inrange64__function_guard (inrange64 i rdi4 rdx4) i rdi4 rdx4))

;; H
  (assert (= (inrange64 i rdi4 rdx4) true))

;; H
  (assert (insaferegion64__function_guard (insaferegion64 i rsp7) i rsp7))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 334, characters 0-0
  (not (= (insaferegion64 i rsp7) true)))
(check-sat)
