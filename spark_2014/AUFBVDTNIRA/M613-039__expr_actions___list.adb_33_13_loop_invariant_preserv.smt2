...
;; H
  (assert (to____function_guard (to__ (mk___rep s__split_fields11))
  (mk___rep s__split_fields11)))

;; H
  (assert (to_but_top__function_guard
  (to_but_top (mk___rep s__split_fields10)) (mk___rep s__split_fields10)))
...
;; H
  (assert
  (and
  (and (= o3 (top (mk___rep s__split_fields10))) (top__function_guard 
  o3 (mk___rep s__split_fields10)))
  (and (in_range1 o3)
  (= o3 (to_rep1 (rec__stack__stack__top s__split_fields10))))))
...
;; H
  ...
  (= (get
     ...
     (+ (last2 (model__ (mk___rep1 res__split_discrs res__split_fields2))) 1)) 
  o3)))
...
;; H
  (assert
  (= (let ((temp___194 (to__ (mk___rep s__split_fields11))))
     (let ((temp___193 (to_but_top (mk___rep s__split_fields10))))
     (bool_eq1 (elts temp___193) (to_rep (first (rt temp___193)))
     (to_rep (last (rt temp___193))) (elts temp___194)
     (to_rep (first (rt temp___194))) (to_rep (last (rt temp___194)))))) true))
...
;; H
  (assert (to____function_guard
  (to__ (mk___rep (us_split_fields__content s__split_fields12)))
  (mk___rep (us_split_fields__content s__split_fields12))))
...
;; WP_parameter_def
 ;; File "list.ads", line 10, characters 0-0
  ...
  (= (to_rep
     (last
     (rt (to__ (mk___rep (us_split_fields__content s__split_fields12)))))) (- 
  last3 (int__content i11)))))
(check-sat)
