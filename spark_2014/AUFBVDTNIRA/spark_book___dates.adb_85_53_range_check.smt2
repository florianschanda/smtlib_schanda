...
(declare-fun o1 () day_type)

(declare-fun o2 () day_type)

(declare-fun o3 () month_type)
...
(declare-fun o6 () day_type)

(declare-fun o7 () month_type)
...
(declare-fun result1 () day_type)

(declare-fun result2 () month_type)

(declare-fun result3 () year_type)
...
(declare-fun result4 () day_type)

(declare-fun result5 () month_type)

(declare-fun result6 () year_type)

(declare-fun current_date__split_fields6 () day_type)

(declare-fun current_date__split_fields7 () month_type)
...
;; H
  (assert (= current_date__split_fields3 o6))
...
;; H
  (assert (= result5 current_date__split_fields4))
