...
;; H
  (assert (=> (and (<= 1 e3) (<= e3 3)) (= temp___446 e3)))
...
;; H
  (assert
  (=> (and (<= 1 e3) (<= e3 3))
  (= (length (mk___rep l1__split_discrs l1__split_fields6)) (- e4 1))))

;; H
  (assert
  (=> (and (<= 1 e3) (<= e3 3))
  (and (=> (<= 1 3) (in_range8 e4)) (and (<= 1 e4) (<= e4 3)))))
...
;; H
  ...
  (= (get
     ...
     (length
     (mk___rep l1__split_discrs
     formal_container__vdll__append__container__fields3))) e4))
...
;; H
  (assert
  (=> (and (<= 1 e3) (<= e3 3)) (= l1__split_fields9 l1__split_fields7)))
...
;; H
  (assert
  (=> (and (<= 1 e3) (<= e3 3)) (= l1__split_fields10 l1__split_fields8)))
...
;; H
  (assert
  (=> (and (<= 1 e3) (<= e3 3)) (= l1__split_fields11 l1__split_fields9)))
