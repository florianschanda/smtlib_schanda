...
;; def_axiom
  (assert
  (forall ((temp___149 Int) (temp___150 Int) (temp___151 Int))
...
(define-fun dynamic_invariant3 ((temp___expr_142 us_t)
  ...
  (temp___do_toplevel_141 Bool)) Bool (and
                                      ...
                                      (last2 temp___expr_142))
                                      (and (= (first1 temp___expr_142) 1)
                                      (= (last2 temp___expr_142) limit))))
                                      (forall ((temp___143 Int))
                                      (=>
                                      (and
                                      (<= (first1 temp___expr_142) temp___143)
                                      (<= temp___143 (last2 temp___expr_142)))
                                      (=>
                                      (or (= temp___is_init_139 true)
                                      (<= 1 last)) (dynamic_property 1 
                                      last
                                      (to_rep
                                      (select (to_array temp___expr_142) temp___143))))))))
