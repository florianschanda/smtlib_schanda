...
(define-fun default_initial_assumption ((temp___expr_281 us_rep1)
...
(define-fun default_initial_assumption1 ((temp___expr_265 us_rep)
...
(define-fun default_initial_assumption2 ((temp___expr_272 (Array Int us_rep))
...
;; tree_structure__def_axiom
  ...
  (! (=> (tree_structure__function_guard (tree_structure f1) f1)
     ...
     (=>
     (and
     (<= (+ (to_rep (rec__binary_trees__forest__s (us_split_fields3 f1))) 1) i1)
     (<= i1 100))
     (= (bool_eq3
...
(declare-fun binary_trees__valid_root__result () Bool)

(declare-fun result () Bool)

(declare-fun binary_trees__valid_root__result1 () Bool)

(declare-fun binary_trees__valid_root__result2 () Bool)

(declare-fun binary_trees__valid_root__result3 () Bool)

(declare-fun binary_trees__valid_root__result4 () Bool)

(declare-fun binary_trees__valid_root__result5 () Bool)
...
;; H
  (assert
  (= binary_trees__valid_root__result1 binary_trees__valid_root__result2))

;; H
  (assert
  (= binary_trees__valid_root__result3 binary_trees__valid_root__result1))

;; H
  (assert
  (= (mk_bool__ref result) (mk_bool__ref binary_trees__valid_root__result)))

;; H
  (assert
  (= binary_trees__valid_root__result1 (ite (and
                                            (<= i (to_rep
                                                  (rec__binary_trees__forest__s
                                                  (us_split_fields3 f))))
                                            (= (to_rep1
...
;; H
  (assert
  (= (mk_bool__ref binary_trees__valid_root__result4) (mk_bool__ref
                                                      binary_trees__valid_root__result2)))

;; H
  (assert
  (= binary_trees__valid_root__result5 binary_trees__valid_root__result3))

;; H
  (assert (= result1 binary_trees__valid_root__result4))
...
(assert
;; WP_parameter_def
 ;; File "binary_trees.ads", line 20, characters 0-0
  (not (not (= binary_trees__valid_root__result4 true))))
(check-sat)
