...
;; H
  (assert (incr_priv_priv__function_guard (incr_priv_priv x1) x1))

;; H
  (assert (= (incr_priv_priv x1) (+ x1 1)))

;; H
  (assert (incr_priv_body__function_guard (incr_priv_body x1) x1))

;; H
  (assert (= (incr_priv_body x1) (+ x1 1)))

;; H
  (assert (incr_body__function_guard (incr_body x1) x1))

;; H
  (assert (= (incr_body x1) (+ x1 1)))

;; H
  (assert (incr_body_body__function_guard (incr_body_body x1) x1))
