...
;; is_finite
  (assert (forall ((x t)) (=> (tqtisFinite x) (in_range4 (tqtreal x)))))

(define-fun no_overflow ((m mode) (x Real)) Bool (in_range4 (round m x)))

;; Bounded_real_no_overflow
  (assert (forall ((m mode) (x Real)) (=> (in_range4 x) (no_overflow m x))))
...
(define-fun dynamic_invariant4 ((temp___expr_179 t) (temp___is_init_176 Bool)
