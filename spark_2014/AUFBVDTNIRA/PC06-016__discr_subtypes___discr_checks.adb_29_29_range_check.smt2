...
(declare-fun discr_checks__check_subtype_prot__R7b__assume () Int)

;; H
  (assert
  (and
  (and (= discr_checks__check_subtype_prot__R7b__assume (bad Tuple0))
  (bad__function_guard discr_checks__check_subtype_prot__R7b__assume 
  Tuple0))
  (and (in_range discr_checks__check_subtype_prot__R7b__assume)
  (= discr_checks__check_subtype_prot__R7b__assume 6))))

;; H
  (assert (= discr_checks__check_subtype_prot__R7b__assume r7b))
...
(assert
;; WP_parameter_def
 ;; File "discr_checks.adb", line 22, characters 0-0
  (not (in_range1 r7b)))
(check-sat)
