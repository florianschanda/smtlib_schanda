...
(define-fun dynamic_invariant4 ((temp___expr_167 Int)
  (temp___is_init_164 Bool) (temp___skip_constant_165 Bool)
  (temp___do_toplevel_166 Bool)) Bool (=>
                                      (or (= temp___is_init_164 true)
                                      (<= 0 2)) (in_range4 temp___expr_167)))
...
(define-fun instructions__read__result8 () int__ref (mk_int__ref
                                                    instructions__read__result6))
...
;; WP_parameter_def
 ;; File "instructions.ads", line 7, characters 0-0
  ...
  (and
  (not
  (= (bool_eq3 (elts (to_string (attr__ATTRIBUTE_IMAGE4 i2)))
     (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 i2)))))
     (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 i2)))))
     (elts word) (to_rep1 (first (rt word))) (to_rep1 (last (rt word)))) true))
  (= instructions__read__result3 instructions__read__result2)) (= i2 2)))
  (and
  (and (= instructions__read__result3 instructions__read__result4) (= i2 i3))
  (and (= instructions__read__result5 instructions__read__result3) (= i4 i2))))
  (and
  (and
  (= instructions__read__result8 (mk_int__ref instructions__read__result4))
  (= (mk_int__ref i5) (mk_int__ref i3)))
  (and (= instructions__read__result7 instructions__read__result5) (= i6 i4))))
  (and
  (and
  (= instructions__read__result8 (mk_int__ref instructions__read__result))
  (= i1 i5))
  (and (= instructions__read__result7 instructions__read__result1) (= i6 i1))))))))
(check-sat)
