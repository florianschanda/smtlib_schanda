...
;; H
  (assert
  (=>
  (= (ite (= (not (= (to_rep1 (select a 1)) val__)) true) (value_found_in_range
                                                          a val__ 2 10) false) true)
  (= (rec__linear_search__search_result__found
     (us_split_discrs1
     (search_result__content linear_search__search__result18))) true)))

;; H
  (assert
  (=>
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j 10)) (not (= (to_rep1 (select a j)) val__))))
  (not
  (= (rec__linear_search__search_result__found
     (us_split_discrs1
     (search_result__content linear_search__search__result18))) true))))
...
;; H
  (assert
  (= (mk___rep (mk___split_discrs result14) (mk___split_fields result15)
     result16) (search_result__content linear_search__search__result18)))
 ...
 ;; File "linear_search.ads", line 18, characters 0-0
  ...
  (= (to_rep1
     (select a (to_rep
               (rec__linear_search__search_result__at_index
               (us_split_fields1
               (search_result__content linear_search__search__result18)))))) 
  val__)))
(check-sat)
