...
(define-fun bool_eq6 ((a (Array Int fruits_and_weapons)) (a__first Int)
...
(define-fun bool_eq9 ((x us_t3)
  (y us_t3)) Bool (bool_eq6 (elts3 x) (to_rep (first6 (rt3 x)))
...
;; H
  (assert
  (forall ((i Int)) (found_none__function_guard
  (found_none (to_rep1 (select initial_crate i)))
  (to_rep1 (select initial_crate i)))))
