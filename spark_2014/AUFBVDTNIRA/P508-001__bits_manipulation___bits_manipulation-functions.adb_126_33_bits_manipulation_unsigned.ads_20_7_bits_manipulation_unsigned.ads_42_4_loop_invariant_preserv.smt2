...
;; H
  (assert (= result2 (ite (= o ((_ int2bv 8) 1)) true false)))
...
;; H
  (assert
  (and (and (=> (<= 0 7) (in_range1 i2)) (=> (<= 0 7) (in_range1 result__2)))
  (and (<= 0 i2) (<= i2 7))))
...
;; H
  (assert (= result5 (ite (= o1 ((_ int2bv 8) 1)) true false)))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 10, characters 0-0
  (not (bvugt (shift_right value j) ((_ int2bv 8) 1))))
(check-sat)
