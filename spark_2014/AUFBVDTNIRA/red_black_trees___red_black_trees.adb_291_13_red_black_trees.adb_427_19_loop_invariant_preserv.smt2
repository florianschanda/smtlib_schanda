...
;; H
  (assert (parent__function_guard
  (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) y)
  (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) y))
...
;; H
  (assert (= result13 (mk_int__ref n6)))
...
;; H
  ...
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c80b) c82b)))) (int__content n8)))
