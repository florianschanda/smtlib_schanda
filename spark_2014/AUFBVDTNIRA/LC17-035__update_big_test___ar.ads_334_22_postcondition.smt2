...
;; H
  (assert
  (= (bool_eq4 a1 5 50 (temp___4639 t j (temp___4645 (select t j) i e)) 5 50) true))
...
;; WP_parameter_def
 ;; File "ar.ads", line 329, characters 0-0
  ...
  (and (< 0 e)
  (= (bool_eq4 a3 5 50
     (temp___967 a j (temp___975 (select a j) i e) (+ j 1)
     (temp___982 (select a (+ j 1)) i (- e 1))) 5 50) true))
  (and (= e 0)
  (= (bool_eq4 a3 5 50
     (temp___990 a j (temp___998 (select a j) i e) (+ j 1)
     (temp___1005 (select a (+ j 1)) i 99)) 5 50) true))))
  (and (= j 50)
  (or
  (and (< 0 e)
  (= (bool_eq4 a3 5 50
     (temp___1013 a j (temp___1021 (select a j) i e) 5
     (temp___1028 (select a 5) i (- e 1))) 5 50) true))
  (and (= e 0)
  (= (bool_eq4 a3 5 50
     (temp___1036 a j (temp___1044 (select a j) i e) 5
     (temp___1051 (select a 5) i 99)) 5 50) true)))))))
(check-sat)
