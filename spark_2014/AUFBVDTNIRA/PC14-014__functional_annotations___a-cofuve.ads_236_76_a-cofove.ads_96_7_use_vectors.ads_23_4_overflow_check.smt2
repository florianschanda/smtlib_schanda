...
(define-fun dynamic_invariant1 ((temp___expr_252 Int)
...
;; H
  (assert
  (and (= o10 (last2 left))
  (and (dynamic_property1 first1 last1 o10)
  (= o10 (+ (- first 1) (length left))))))

;; H
  (assert (= result (ite (<= lst1 o10) true false)))

;; H
  (assert (= result true))

;; H
  (assert (=> (< offset 0) (and (= o8 first) (in_range1 first))))

;; H
  (assert
  (=> (< offset 0)
  (and (= o9 (- (- 2147483648) offset)) (in_range1
  (- (- 2147483648) offset)))))

;; H
  (assert (=> (< offset 0) (= result1 (ite (<= o9 o8) true false))))
