...
;; H
  (assert
  (forall ((ib1 Int)) (remove__function_guard (remove bb ib1) bb ib1)))
...
;; H
  (assert
  (forall ((ia2 Int) (ib1 Int)) (is_perm__function_guard
  (is_perm (remove aa ia2) (remove bb ib1)) (remove aa ia2) (remove bb ib1))))
