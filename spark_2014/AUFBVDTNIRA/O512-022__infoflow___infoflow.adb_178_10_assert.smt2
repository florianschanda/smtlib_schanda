...
(declare-fun temp___431 () (Array Int integer))
...
(declare-fun a_v12 () (Array Int integer))

(declare-fun i_v12 () Int)

(declare-fun result1 () (Array Int integer))

(declare-fun a_v13 () (Array Int integer))

(declare-fun a_v14 () (Array Int integer))

(declare-fun i_v13 () Int)

(declare-fun a_v15 () (Array Int integer))

(declare-fun i_v14 () Int)

(declare-fun a_v16 () (Array Int integer))

(declare-fun i_v15 () Int)

(declare-fun a_v17 () (Array Int integer))

(declare-fun i_v16 () Int)
...
;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1))
  (= temp___433 i_v11)))
...
;; H
  ...
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1))
  (forall ((m Int))
  (=> (and (<= (to_rep a_v1__first) m) (<= m (- i_v12 1)))
  (= (to_rep (select a_v12 m)) (to_rep (select (elts b_v1) m)))))))
...
;; H
  ...
  (=>
  (and (<= (to_rep a_v1__first) temp___432)
  (<= temp___432 (to_rep a_v1__last)))
  (=> (<= i_v12 temp___432)
  (= (select a_v12 temp___432) (select temp___431 temp___432)))))
  (=> (<= (to_rep a_v1__first) k_1) (dynamic_property1 (to_rep a_v1__first)
  k_1 i_v12))) (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 k_1)))))

;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1))
  (and (<= (to_rep (first (rt b_v1))) i_v12)
  (<= i_v12 (to_rep (last (rt b_v1)))))))

;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= o i_v12)))

;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1))
  (= o1 (select (elts b_v1) o))))
...
;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1))
  (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 (to_rep a_v1__last)))))

;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= o4 i_v12)))

;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1))
  (= o5 (store a_v12 o4 o3))))

;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= a_v12 result1)))

;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= a_v13 o5)))

;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= i_v12 k_1)))

;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= i_v12 i_v13)))

;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= a_v13 a_v14)))

;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= i_v14 i_v12)))

;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= a_v15 a_v13)))

;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1))
  (= (mk_int__ref i_v15) (mk_int__ref i_v13))))

;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1))
  (= a_v18 (mk_map__ref a_v14))))

;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= i_v16 i_v14)))

;; H
  (assert
  (=> (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)) (= a_v17 a_v15)))

;; H
  (assert
  (=> (not (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)))
  (= i_v11 i_v15)))

;; H
  (assert
  (=> (not (and (<= (to_rep a_v1__first) i_v11) (<= i_v11 k_1)))
  (= a_v18 (mk_map__ref a_v1))))
...
;; WP_parameter_def
 ;; File "infoflow.ads", line 89, characters 0-0
  (not (= (to_rep (select a_v16 m)) (to_rep (select (elts b_v1) m)))))
(check-sat)
