...
(declare-fun temp___414 () count_type)
...
;; H
  (assert (= temp___414 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___414)) no_element))
...
;; H
  ...
  (and (in_range1 o2)
  (<= o2 (to_rep
         (rec__linked_list__mylists__list__capacity target__split_discrs))))))
