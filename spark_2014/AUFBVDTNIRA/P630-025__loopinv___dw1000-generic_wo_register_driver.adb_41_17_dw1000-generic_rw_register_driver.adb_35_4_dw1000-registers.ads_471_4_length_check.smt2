...
(define-fun dynamic_invariant ((temp___expr_5512 us_t1)
  ...
  (temp___do_toplevel_5511 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_5512))
                                       (and (= (first3 temp___expr_5512) 1)
                                       (= (last4 temp___expr_5512) 1)))))
...
(define-fun dynamic_invariant1 ((temp___expr_5528 us_t2)
  ...
  (temp___do_toplevel_5527 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_5528))
                                       (and (= (first5 temp___expr_5528) 1)
                                       (= (last6 temp___expr_5528) 1)))))
...
;; H
  (assert
  (and
  (and (= temp___78842 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___78842 reg)) (dynamic_invariant1
  temp___78842 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___78841)) (to_rep (last5 temp___78841)))
     (+ (- (to_rep (last5 temp___78841)) (to_rep (first4 temp___78841))) 1)
     0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78841)) (to_rep (last5 temp___78841))) 
  temp___78851))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___78851)) (to_rep (last3 temp___78851)))
     (+ (- (to_rep (last3 temp___78851)) (to_rep (first2 temp___78851))) 1)
