...
;; H
  ...
  (= o26 (ispresent
         (mk___rep (us_split_fields__content theadmin__split_fields))))
  (ispresent__function_guard o26
  (mk___rep (us_split_fields__content theadmin__split_fields))))))

;; H
  (assert (=> (= result true) (= o29 (ite (not (= o26 true)) true false))))

;; H
  (assert (=> (= result true) (= o30 (ite (= o29 true) o28 false))))
...
;; H
  (assert (=> (= result1 true) (= o23 (ite (= o22 0) true false))))
...
;; H
  (assert (=> (= result1 true) (= o24 (ite (not (= o21 true)) true false))))
...
;; H
  ...
  (= o19 (isdoingop
         (mk___rep (us_split_fields__content theadmin__split_fields))))
  (isdoingop__function_guard o19
  (mk___rep (us_split_fields__content theadmin__split_fields))))))

;; H
  (assert (=> (= result2 true) (= o20 (ite (not (= o19 true)) true false))))

;; H
  (assert (=> (not (= result2 true)) (= o20 (of_int 1))))

;; H
  (assert
  (and (= o14 (statusiswaitingfinishadminop (us_private__content state)))
  (statusiswaitingfinishadminop__function_guard o14
  (us_private__content state))))

;; H
  (assert
  (and (= o15 (statusiswaitingstartadminop (us_private__content state)))
...
;; H
  (assert (=> (= result3 true) (= o18 (ite (= o17 true) o16 false))))

;; H
  (assert (=> (not (= result3 true)) (= o18 (of_int 1))))

;; H
  (assert
  (and
  (= o10 (statusiswaitingremoveadmintokenfail (us_private__content state)))
  (statusiswaitingremoveadmintokenfail__function_guard o10
  (us_private__content state))))

;; H
  (assert
  (and (= o11 (statusisgotadmintoken (us_private__content state)))
  (statusisgotadmintoken__function_guard o11 (us_private__content state))))
...
;; H
  ...
  (= o6 (thecurrentop
        (mk___rep (us_split_fields__content theadmin__split_fields))))
  (thecurrentop__function_guard o6
...
;; H
  (assert
  (=> (= result5 true)
  (and (= o9 (statusiswaitingstartadminop (us_private__content state)))
  (statusiswaitingstartadminop__function_guard o9
  (us_private__content state)))))
