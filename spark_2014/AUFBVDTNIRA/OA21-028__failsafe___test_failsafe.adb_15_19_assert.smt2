...
;; H
  (assert (is_valid__function_guard
  (is_valid failsafe_state9 battery_level_at9 current_time10) failsafe_state9
  battery_level_at9 current_time10))
...
;; H
  ...
  (and
  (= current_time10 (let ((temp___237 (bvadd current_time9 ((_ int2bv 8) 1))))
                    (ite (bvule (bvsub ((_ int2bv 8) 50) current_time9) ((_ int2bv 8) 1))
                    (bvsub temp___237 ((_ int2bv 8) 50)) temp___237)))
  (eq (to_rep (select battery_level_at9 current_time10)) fliteral)))
  (in_range2 current_time10)))

;; H
  (assert (is_raised__function_guard
  (is_raised failsafe_state9 battery_level_at9 current_time10)
  failsafe_state9 battery_level_at9 current_time10))
