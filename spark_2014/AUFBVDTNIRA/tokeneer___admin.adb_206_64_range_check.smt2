...
;; range_axiom
  (assert
  (forall ((x opandnullt)) (! (in_range (to_rep x)) :pattern ((to_rep x)) )))
...
;; isdoingop__def_axiom
  ...
  (! (=> (isdoingop__function_guard (isdoingop theadmin) theadmin)
     (= (= (isdoingop theadmin) true) (in_range1
...
(define-fun dynamic_invariant2 ((temp___expr_169 Int)
  ...
  (temp___do_toplevel_168 Bool)) Bool (=>
                                      ...
                                      (<= 0 3)) (in_range2 temp___expr_169)))

;; H
  (assert (isdoingop__function_guard (isdoingop theadmin) theadmin))
...
(assert
;; WP_parameter_def
 ;; File "admin.ads", line 37, characters 0-0
  (not (in_range1
  (to_rep (rec__admin__t__currentop (us_split_fields1 theadmin))))))
(check-sat)
