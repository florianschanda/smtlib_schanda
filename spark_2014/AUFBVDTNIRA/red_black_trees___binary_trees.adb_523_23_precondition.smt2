...
(declare-fun temp___2003 () (Array Int us_rep1))
...
(declare-fun temp___2002 () (Array Int us_rep1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2002 (parent
                      (mk___rep2
                      (mk___split_fields2 f__split_fields f__split_fields1))
                      i1))))
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2002 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2002 (parent
                      (mk___rep2
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2003 (parent
                      (mk___rep2
                      (mk___split_fields2 f__split_fields f__split_fields1))
                      i1))))
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2003 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2003 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___2002 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 o7))
  (model____function_guard temp___2002
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o7))
  (and (dynamic_invariant3 temp___2002 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2002 o7))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2002 o7)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o7))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2002 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2002 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2002 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2002 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2002 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2002 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o8 (select temp___2002 i)))
...
;; H
  ...
  (= temp___2003 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 o1))
  (model____function_guard temp___2003
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o1))
  (and (dynamic_invariant3 temp___2003 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2003 o1))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2003 o1)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o1))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2003 (parent
                              ...
                              f__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2003 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2003 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2003 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2003 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2003 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2003 j)))) true))
  (= j i1)))))))))))))))

;; H
  (assert (=> (= result2 true) (= o2 (select temp___2003 i))))
