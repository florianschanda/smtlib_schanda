...
;; H
  (assert
  (and (= o33 (sub RNE1 fliteral10 (abs1 theta3))) (tqtisFinite
  (sub RNE1 fliteral10 (abs1 theta3)))))

;; H
  (assert (= o34 (div2 RNE1 o33 fliteral10)))

;; H
  (assert (and (= o35 o34) (tqtisFinite o34)))
