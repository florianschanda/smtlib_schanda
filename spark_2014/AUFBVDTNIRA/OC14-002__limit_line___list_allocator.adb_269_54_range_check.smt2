...
;; H
  ...
  (rec__list_allocator__m__t__allocated model____split_fields3) o65))
  (in_range7 o66)))))
...
;; H
  ...
  (= temp___849 (get
                (rec__list_allocator__m__t__allocated model____split_fields3)
                j))
  (get__function_guard temp___849
  (rec__list_allocator__m__t__allocated model____split_fields3) j))
  (in_range7 temp___849))))

;; H
  (assert (=> (= result12 true) (and (<= 1 temp___849) (<= temp___849 3))))

;; H
  (assert (=> (= result12 true) (= o60 temp___849)))
