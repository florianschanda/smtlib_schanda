...
;; H
  ...
  (= (to_rep2 (select simple_unc_arrays__swap_cells__a o8)) (to_rep2
                                                            ...
                                                            i4))))
  (forall ((k1 Int))
  (=> (and (<= (to_rep1 o6) k1) (<= k1 (to_rep1 o7)))
  (=> (and (not (= k1 i4)) (not (= k1 o8)))
  (= (to_rep2 (select simple_unc_arrays__swap_cells__a k1)) (to_rep2
                                                            (select simple_unc_arrays__swap_cells__a__compl k1)))))))))))
...
;; H
  ...
  (<= (to_rep2
      (select (elts1
              (rec__simple_unc_arrays__table__v
              (us_split_fields1
              (table__content simple_unc_arrays__bubble_sort__result6)))) j1)) 
  (to_rep2
  (select (elts1
          (rec__simple_unc_arrays__table__v
          (us_split_fields1
...
;; H
  (assert
  (<= k (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a)))))
...
;; WP_parameter_def
 ;; File "simple_unc_arrays.ads", line 10, characters 0-0
  ...
  (<= (to_rep1
      ...
      (rec__simple_unc_arrays__table__v
      (us_split_fields1
      (table__content simple_unc_arrays__bubble_sort__result6)))))) k)))
(check-sat)
