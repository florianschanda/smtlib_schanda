...
(declare-fun o41 () us_split_fields10)

(declare-fun o42 () extended_index_type)
...
;; H
  ...
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 0)
  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 0)))

;; H
  (assert
  (forall ((i1 Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 1)
  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 1)))
...
;; H
  ...
  (and
  (and
  (= o37 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0))
  (peek__function_guard o37
...
;; H
  (assert (= (mk___rep5 (mk___split_fields5 o38 o39 o40)) (select res2 
  o37)))

;; H
  (assert (= o41 (mk___split_fields5 o38 o39 o40)))

;; H
  (assert (= o42 (rec__red_black_trees__black_count__count o41)))
...
;; H
  ...
  (= o47 (ite (= (to_rep
                 (rec__red_black_trees__black_count__count
                 (us_split_fields11 (select res2 i)))) o46)
         true false)))
...
;; H
  ...
  (and
  (and
  (= o25 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 1))
  (peek__function_guard o25
...
;; H
  (assert (= (mk___rep5 (mk___split_fields5 o26 o27 o28)) (select res2 
  o25)))
...
;; H
  (assert (= o34 (to_rep o24)))

;; H
  (assert (= o35 (ite (< o34 o33) o33 o34)))
