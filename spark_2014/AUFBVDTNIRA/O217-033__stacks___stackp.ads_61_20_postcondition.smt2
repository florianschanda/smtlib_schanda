...
;; last__post_axiom
  ...
  (forall ((s us_rep1))
  (! (let ((result (last2 s)))
     (=> (last__function_guard result s) (dynamic_invariant1 result true
     false true))) :pattern ((last2 s)) )))

;; last__post__dispatch_axiom
  (assert
  (forall ((attr__tag2 Int))
  (forall ((s us_rep1))
  (! (let ((result (last3 attr__tag2 s)))
     (=> (last__function_guard1 result attr__tag2 s) (dynamic_invariant1
     result true false true))) :pattern ((last3 attr__tag2 s)) ))))

;; stackp__buffer__compat_axiom
  (assert
  (forall ((s us_rep1))
  (! (=> (last__function_guard1 (last3 us_tag1 s) us_tag1 s)
     (and (last__function_guard (last2 s) s) (= (last2 s) (last3 us_tag1 s)))) :pattern (
  (last3 us_tag1 s)) )))

;; last__def_axiom
  (assert
  (forall ((s us_rep1))
  (! (=> (last__function_guard (last2 s) s)
...
;; def_axiom
  ...
  (= (select (temp___304 temp___306) 1) (of_rep1 temp___306))))
...
(define-fun dynamic_invariant4 ((temp___expr_169 us_t)
...
(define-fun bool_eq15 ((x us_t3)
  (y us_t3)) Bool (bool_eq3 (elts3 x) (to_rep2 (first7 (rt3 x)))
                  ...
                  (to_rep2 (first7 (rt3 y))) (to_rep2 (last9 (rt3 y)))))
...
;; mk_def
  ...
  (! (=> (in_range3 f)
     ...
     (= (to_rep2 (last12 (mk4 f l))) l)))) :pattern ((mk4 f l)) )))
...
(define-fun first11 ((a us_t4)) Int (to_rep2 (first10 (rt4 a))))

(define-fun last13 ((a us_t4)) Int (to_rep2 (last12 (rt4 a))))
...
(define-fun bool_eq17 ((x us_t4)
  (y us_t4)) Bool (bool_eq3 (elts4 x) (to_rep2 (first10 (rt4 x)))
                  (to_rep2 (last12 (rt4 x))) (elts4 y)
                  (to_rep2 (first10 (rt4 y))) (to_rep2 (last12 (rt4 y)))))
...
;; get_model__3__def_axiom
  ...
  (! (=> (get_model__3__function_guard (get_model__3 s) s)
     (and (wraps_around__function_guard (wraps_around s) s)
     (and (last__function_guard (last2 s) s)
     (and (last__function_guard (last2 s) s)
...
(declare-fun temp___738 () positive_less_than_max)

(declare-fun temp___7381 () (Array Int element))

(declare-fun temp___7382 () less_than_max)

(declare-fun temp___7383 () us_private)

(declare-fun temp___7384 () Int)

(declare-fun temp___740 () Int)
...
(declare-fun temp___742 () positive_less_than_max)

(declare-fun temp___7421 () (Array Int element))

(declare-fun temp___7422 () less_than_max)

(declare-fun temp___7423 () us_private)

(declare-fun temp___7424 () Int)
...
;; H
  ...
  (hide_ext__ s__split_fields s__split_fields3)) s__attr__tag))
  (mk___rep
  (mk___split_fields s__split_fields1 s__split_fields2
  (hide_ext__ s__split_fields s__split_fields3)) s__attr__tag)))

;; H
  (assert (wraps_around__function_guard
  (wraps_around (mk___rep1 s__split_fields20 s__attr__tag))
  (mk___rep1 s__split_fields20 s__attr__tag)))
...
;; H
  (assert (= temp___738 o2))

;; H
  (assert (= temp___7381 o3))

;; H
  (assert (= temp___7382 o4))

;; H
  (assert (= temp___7383 o5))

;; H
  (assert (= s__attr__tag temp___7384))
...
;; H
  (assert (= temp___738 s__split_fields4))

;; H
  (assert (= temp___7381 s__split_fields5))

;; H
  (assert (= temp___7382 s__split_fields6))

;; H
  (assert (= temp___7383 s__split_fields7))
...
;; H
  (assert
  (and
  (and (= temp___740 (last2 (mk___rep1 s__split_fields20 s__attr__tag)))
  (last__function_guard temp___740
  (mk___rep1 s__split_fields20 s__attr__tag)))
  (and (in_range temp___740)
  (= temp___740 (ite (not
                     (= (wraps_around
...
;; H
  (assert (and (<= 1 temp___740) (<= temp___740 100)))

;; H
  (assert (= o7 temp___740))
...
;; H
  (assert (= temp___742 o9))

;; H
  (assert (= temp___7421 o10))

;; H
  (assert (= temp___7422 o11))

;; H
  (assert (= temp___7423 o12))

;; H
  (assert (= s__attr__tag temp___7424))
...
;; H
  (assert (= temp___742 s__split_fields8))

;; H
  (assert (= temp___7421 s__split_fields9))

;; H
  (assert (= temp___7422 s__split_fields10))

;; H
  (assert (= temp___7423 s__split_fields11))
...
;; H
  ...
  (get_model__3
  (mk___rep1
  (mk___split_fields1 s__split_fields12 s__split_fields13 s__split_fields14
  s__split_fields15) s__attr__tag))
  (mk___rep1
  (mk___split_fields1 s__split_fields12 s__split_fields13 s__split_fields14
  s__split_fields15) s__attr__tag)))
...
;; WP_parameter_def
 ;; File "stackp.ads", line 39, characters 0-0
  (not
  (= (let ((temp___750 (get_model__3
                       (mk___rep1
                       (mk___split_fields1 s__split_fields12
                       s__split_fields13 s__split_fields14 s__split_fields15)
                       s__attr__tag))))
     (bool_eq3 (elts temp___750) (to_rep2 (first (rt temp___750)))
     (to_rep2 (last (rt temp___750)))
     (let ((temp___749 (temp___304 e)))
     (let ((temp___748 (get_model__3
                       (mk___rep1
                       (mk___split_fields1 s__split_fields s__split_fields1
                       s__split_fields2 s__split_fields3) s__attr__tag))))
     (ite (= (length temp___748) 0) temp___749
     (concat1 (elts temp___748) (to_rep2 (first (rt temp___748)))
     (to_rep2 (last (rt temp___748))) temp___749 1 1))))
     (to_rep2
     (first
     (let ((temp___748 (get_model__3
                       (mk___rep1
                       (mk___split_fields1 s__split_fields s__split_fields1
                       s__split_fields2 s__split_fields3) s__attr__tag))))
     (ite (= (length temp___748) 0) (mk 1 1)
     (mk (to_rep2 (first (rt temp___748)))
     (- (+ (to_rep2 (first (rt temp___748))) (+ (ite (<= (to_rep2
                                                         (first
                                                         (rt temp___748))) 
                                                (to_rep2
                                                (last (rt temp___748))))
