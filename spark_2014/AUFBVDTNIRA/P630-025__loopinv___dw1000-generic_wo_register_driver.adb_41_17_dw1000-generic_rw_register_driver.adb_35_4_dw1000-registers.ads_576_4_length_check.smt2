...
(define-fun dynamic_invariant ((temp___expr_6679 us_t1)
  ...
  (temp___do_toplevel_6678 Bool)) Bool (=>
                                       ...
                                       (last3 temp___expr_6679))
                                       (and (= (first3 temp___expr_6679) 1)
                                       (= (last3 temp___expr_6679) 2)))))
...
(define-fun dynamic_invariant1 ((temp___expr_6695 us_t2)
  ...
  (temp___do_toplevel_6694 Bool)) Bool (=>
                                       ...
                                       (last5 temp___expr_6695))
                                       (and (= (first5 temp___expr_6695) 1)
                                       (= (last5 temp___expr_6695) 2)))))
...
;; H
  (assert
  (and (= temp___80112 (register_to_bytes reg)) (dynamic_invariant1
  temp___80112 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80111)) (to_rep (last4 temp___80111)))
     (+ (- (to_rep (last4 temp___80111)) (to_rep (first4 temp___80111))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80111)) (to_rep (last4 temp___80111))) 
  temp___80121))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___80121)) (to_rep (last2 temp___80121)))
     (+ (- (to_rep (last2 temp___80121)) (to_rep (first2 temp___80121))) 1)
