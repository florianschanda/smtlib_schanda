...
(define-fun tint_arrayD1__ref_4__projection ((a tint_arrayD1__ref)) integer 
...
(define-fun tint_arrayT__ref_4__projection ((a tint_arrayT__ref)) us_t1 
...
(declare-datatypes ()
((t104b__ref (mk_t104b__ref (t104b__content integer)))))
(define-fun t104b__ref___projection ((a t104b__ref)) integer (t104b__content
                                                             a))
...
(define-fun tnumber_array_typeD1__ref_4__projection ((a tnumber_array_typeD1__ref)) integer 
...
(define-fun number_array_type__ref_4__projection ((a number_array_type__ref)) us_t3 
...
(declare-datatypes ()
((t108b__ref (mk_t108b__ref (t108b__content integer)))))
(define-fun t108b__ref___projection ((a t108b__ref)) integer (t108b__content
                                                             a))
...
(declare-datatypes ()
((t110b__ref (mk_t110b__ref (t110b__content integer)))))
(define-fun t110b__ref___projection ((a t110b__ref)) integer (t110b__content
                                                             a))
...
(define-fun tint_arrayB__ref_4__projection ((a tint_arrayB__ref)) us_t5 
  (tint_arrayB__content a))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__aggregate_def (Int
  Int Int Int Int Int Int Int Int Int Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___1458 Int) (temp___1459 Int) (temp___1460 Int)
  (temp___1461 Int) (temp___1462 Int) (temp___1463 Int) (temp___1464 Int)
  (temp___1465 Int) (temp___1466 Int) (temp___1467 Int) (temp___1468 Int)
  (temp___1469 Int))
  (let ((temp___1457 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__aggregate_def
                     temp___1458 temp___1459 temp___1460 temp___1461
                     temp___1462 temp___1463 temp___1464 temp___1465
                     temp___1466 temp___1467 temp___1468 temp___1469)))
  (and
  (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1468
  temp___1469)
  (and (= (first7 temp___1457) temp___1468)
  (= (last7 temp___1457) temp___1469)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___1457) (+ (first1 source) 0)) (of_rep1
                                                            temp___1458))
  (= (select (to_array2 temp___1457) (+ (first1 source) 1)) (of_rep1
                                                            temp___1459)))
  (= (select (to_array2 temp___1457) (+ (first1 source) 2)) (of_rep1
                                                            temp___1460)))
  (= (select (to_array2 temp___1457) (+ (first1 source) 3)) (of_rep1
                                                            temp___1461)))
  (= (select (to_array2 temp___1457) (+ (first1 source) 4)) (of_rep1
                                                            temp___1462)))
  (= (select (to_array2 temp___1457) (+ (first1 source) 5)) (of_rep1
                                                            temp___1463)))
  (= (select (to_array2 temp___1457) (+ (first1 source) 6)) (of_rep1
                                                            temp___1464)))
  (= (select (to_array2 temp___1457) (+ (first1 source) 7)) (of_rep1
                                                            temp___1465)))
  (= (select (to_array2 temp___1457) (+ (first1 source) 8)) (of_rep1
                                                            temp___1466)))
  (= (select (to_array2 temp___1457) (+ (first1 source) 9)) (of_rep1
                                                            temp___1467)))))))
...
(define-fun tnumber_array_typeB__ref_4__projection ((a tnumber_array_typeB__ref)) us_t6 
  (tnumber_array_typeB__content a))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__aggregate_def (Int
  Int Int) us_t4)

;; def_axiom
  (assert
  (forall ((temp___1475 Int) (temp___1476 Int) (temp___1477 Int))
  (let ((temp___1474 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__aggregate_def
                     temp___1475 temp___1476 temp___1477)))
  (and
  (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1476
  temp___1477)
  (and (= (first13 temp___1474) temp___1476)
  (= (last13 temp___1474) temp___1477)))
  (forall ((temp___1478 Int))
  (= (select (to_array4 temp___1474) temp___1478) (of_rep1 temp___1475)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_239 us_t3)
  ...
  (temp___do_toplevel_238 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 9)
                                      (first10 temp___expr_239)
                                      (last10 temp___expr_239))
                                      (and
                                      (= (first10 temp___expr_239) (first1
                                                                   source))
                                      (= (last10 temp___expr_239) (+ 
                                      (first1 source) 9))))))
...
(declare-fun temp___1472 () (Array Int integer))

(declare-fun temp___14721 () t2)

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__assume1 () t1)

(declare-fun temp___1480 () (Array Int integer))

(declare-fun temp___14801 () t4)

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__assume1 () t3)

(declare-fun temp___1487 () Int)

(declare-fun temp___1485 () Int)

(declare-fun temp___1483 () (Array Int integer))
...
;; H
  ...
  (= (to_rep1
     ...
     2 1 4 7 4 8 2 9 9 9 (to_rep1 (first (rt source)))
...
;; H
  (assert
  (= (mk___t2 temp___1472 temp___14721) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__aggregate_def
                                        2 1 4 7 4 8 2 9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___14721)) (to_rep1 (last6 temp___14721)))
     (+ (- (to_rep1 (last6 temp___14721)) (to_rep1 (first6 temp___14721))) 1)
...
;; H
  (assert
  (= (slide1 temp___1472 (to_rep1 (first6 temp___14721))
     (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__assume))

;; H
  (assert
  (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) 
  aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__assume1))
...
;; H
  (assert
  (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__assume))
...
;; H
  (assert
  (= (mk___t4 temp___1480 temp___14801) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__aggregate_def
                                        0 (to_rep1 (first (rt source)))
                                        (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___14801)) (to_rep1
                                               (last12 temp___14801)))
     (+ (- (to_rep1 (last12 temp___14801)) (to_rep1 (first12 temp___14801))) 1)
     0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1
                                                  (first (rt source))) 9))
        (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1
                                                  (first (rt source)))) 1)
...
;; H
  (assert
  (= (slide1 temp___1480 (to_rep1 (first12 temp___14801))
     (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__assume))

;; H
  (assert
  (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) 
  aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__assume1))
...
;; H
  (assert
  (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__assume))
...
;; H
  (assert
  (and (= temp___1487 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1487))
  (= temp___1485 index1)))
...
;; H
  ...
  (and
  (and
  (forall ((temp___1484 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___1484)
  (<= temp___1484 (to_rep1 n__last)))
  (=> (< index2 temp___1484)
  (= (select n3 temp___1484) (select temp___1483 temp___1484)))))
...
;; H
  (assert
  (and (= temp___1488 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1488)
  (<= temp___1488 (to_rep1 n__last))))

;; H
  (assert (= o9 temp___1488))
...
;; H
  (assert
  (and (= temp___1489 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1489)
  (<= temp___1489 (to_rep1 n__last))))

;; H
  (assert (= o12 temp___1489))
...
;; H
  (assert
  (and (= temp___1490 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1490)
  (<= temp___1490 (to_rep1 n__last))))

;; H
  (assert (= o19 temp___1490))
...
;; H
  (assert
  (and (= temp___1491 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1491)
  (<= temp___1491 (to_rep1 n__last))))

;; H
  (assert (= o26 temp___1491))
...
(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 308, characters 0-0
  (not (<= target4 2999)))
(check-sat)
