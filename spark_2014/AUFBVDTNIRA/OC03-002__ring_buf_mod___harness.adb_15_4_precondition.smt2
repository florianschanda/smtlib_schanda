...
;; H
  (assert
  (= (let ((temp___224 (to_model (mk___rep r__split_fields19))))
...
;; H
  ...
  (func_push (to_model (mk___rep r__split_fields19)) x)
  (to_model (mk___rep r__split_fields19)) x))
...
;; H
  (assert
  (= (let ((temp___242 (func_push (to_model (mk___rep r__split_fields19)) x)))
     (let ((temp___241 (to_model (mk___rep r__split_fields18))))
...
;; H
  (assert (func_push__function_guard
  (func_push (to_model (mk___rep r__split_fields18)) y)
  (to_model (mk___rep r__split_fields18)) y))

;; H
  (assert (to_model__function_guard (to_model (mk___rep r__split_fields17))
  (mk___rep r__split_fields17)))

;; H
  (assert
  (= (let ((temp___242 (func_push (to_model (mk___rep r__split_fields18)) y)))
     (let ((temp___241 (to_model (mk___rep r__split_fields17))))
     (bool_eq3 (elts temp___241) (to_rep (first (rt temp___241)))
     (to_rep (last (rt temp___241))) (elts temp___242)
     (to_rep (first (rt temp___242))) (to_rep (last (rt temp___242)))))) true))
...
;; H
  ...
  (func_pop (to_model (mk___rep r__split_fields17)))
  (to_model (mk___rep r__split_fields17))))

;; H
  (assert (to_model__function_guard (to_model (mk___rep r__split_fields16))
...
;; H
  ...
  (func_head (to_model (mk___rep r__split_fields17)))
  (to_model (mk___rep r__split_fields17))))
...
;; H
  ...
  (and
  (and
  (= (let ((temp___250 (func_pop (to_model (mk___rep r__split_fields17)))))
     (let ((temp___249 (to_model (mk___rep r__split_fields16))))
...
;; H
  (assert (func_push__function_guard
  (func_push (to_model (mk___rep r__split_fields16)) z)
  (to_model (mk___rep r__split_fields16)) z))
...
;; H
  (assert
  (= (let ((temp___242 (func_push (to_model (mk___rep r__split_fields16)) z)))
     (let ((temp___241 (to_model (mk___rep r__split_fields15))))
     (bool_eq3 (elts temp___241) (to_rep (first (rt temp___241)))
     (to_rep (last (rt temp___241))) (elts temp___242)
     (to_rep (first (rt temp___242))) (to_rep (last (rt temp___242)))))) true))

;; H
  (assert (is_empty__function_guard (is_empty (mk___rep r__split_fields15))
  (mk___rep r__split_fields15)))
