...
(declare-fun pack__add__result () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun pack__add__result1 () t)

(declare-fun pack__add__result2 () t)

(declare-fun pack__add__result3 () t)

(declare-fun pack__add__result4 () t)

(declare-fun pack__add__result5 () t)
...
;; H
  (assert (tqtisFinite r2))

;; H
  (assert
  (and (lt r1 fliteral)
  (and (lt r2 fliteral) (and (lt (neg fliteral) r1) (lt (neg fliteral) r2)))))
...
;; H
  (assert (and (= o (add RNE1 r1 r2)) (tqtisFinite (add RNE1 r1 r2))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (eq pack__add__result4 (add RNE1 r1 r2))))
(check-sat)
