...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (bool_eq2 (elts a)
     (to_rep (first3 (mk1 x (- (+ x (int__content lcp__result4)) 1))))
     (to_rep (last3 (mk1 x (- (+ x (int__content lcp__result4)) 1))))
     (elts a)
     (to_rep (first6 (mk2 y (- (+ y (int__content lcp__result4)) 1))))
     (to_rep (last6 (mk2 y (- (+ y (int__content lcp__result4)) 1))))) true)))
(check-sat)
