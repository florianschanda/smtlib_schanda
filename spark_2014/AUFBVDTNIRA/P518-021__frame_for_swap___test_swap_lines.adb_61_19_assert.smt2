...
;; H
  ...
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i c9))
  (and (= (to_rep (get m10 5 i)) (to_rep (get temp___248 7 i)))
  (= (to_rep (get m10 7 i)) (to_rep (get temp___249 5 i))))))))
...
;; H
  ...
  (forall ((i Int))
  (=> (and (<= (+ c9 1) i) (<= i 10))
  (and (= (to_rep (get m10 5 i)) (to_rep (get temp___250 5 i)))
  (= (to_rep (get m10 7 i)) (to_rep (get temp___251 7 i))))))))
...
;; WP_parameter_def
 ;; File "test_swap_lines.adb", line 1, characters 0-0
  (not (= (to_rep (get (map__content m15) i j)) 2)))
(check-sat)
