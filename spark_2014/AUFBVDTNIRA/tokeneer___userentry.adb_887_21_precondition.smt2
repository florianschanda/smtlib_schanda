...
(declare-fun user_eq10 (t1 t1) Bool)

(declare-fun dummy10 () t1)
...
(define-fun dynamic_invariant1 ((temp___expr_316 Int)
  ...
  (temp___do_toplevel_315 Bool)) Bool (=>
                                      ...
                                      (<= 0 1)) (in_range10 temp___expr_316)))
...
(declare-fun dummy12 () statscount)
...
;; range_axiom
  (assert
  (forall ((x statscount)) (! (in_range11
...
;; H
  (assert
  (and (= o (ispresent state3)) (ispresent__function_guard o state3)))
...
;; H
  ...
  (= result1 (greaterthan o6
             (mk___rep
             (mk___split_fields tokenremovaltimeout__split_fields
  ...
  (mk___rep
  (mk___split_fields tokenremovaltimeout__split_fields
  tokenremovaltimeout__split_fields1 tokenremovaltimeout__split_fields2
  tokenremovaltimeout__split_fields3)))))
...
;; H
  (assert
  (and (= o5 (extractuser state3)) (extractuser__function_guard o5 state3)))
...
(assert
;; WP_parameter_def
 ;; File "userentry.adb", line 711, characters 0-0
