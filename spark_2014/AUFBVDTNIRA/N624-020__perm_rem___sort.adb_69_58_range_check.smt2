...
;; H
  (assert (invariant____function_guard (invariant__ o23) o23))

;; H
  (assert (invariant____function_guard (invariant__ temp___302) temp___302))
...
;; H
  ...
  (remove__function_guard o23 (mk___t values2 (mk 1 100)) o22))
...
;; H
  (assert
  (and
  (and (= temp___302 (remove o23 o24)) (remove__function_guard temp___302 
  o23 o24))
  (and (dynamic_invariant4 temp___302 true false true)
  (and (= (invariant__ temp___302) true)
  (and (= (to_rep1 (last (rt temp___302))) (- (to_rep1 (last (rt o23))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o24 1)))
  (= (to_rep (select (elts o23) k)) (to_rep (select (elts temp___302) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o24 1) k) (<= k (to_rep1 (last (rt o23)))))
  (= (to_rep (select (elts o23) k)) (to_rep
                                    (select (elts temp___302) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o24 k) (<= k (- (to_rep1 (last (rt o23))) 1)))
  (= (to_rep (select (elts o23) (+ k 1))) (to_rep
                                          (select (elts temp___302) k))))))))))))
