...
(define-fun temp___7491 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___749)))
...
;; H
  (assert
  (and
  (= temp___7491 (next (mk___rep s__split_discrs s__split_fields3)
                 (mk___rep1 cu__split_fields4)))
  ...
  (= (bool_eq2 temp___7491 no_element) true)
  (and
