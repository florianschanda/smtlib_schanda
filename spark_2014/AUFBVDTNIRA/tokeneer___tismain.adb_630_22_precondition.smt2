...
;; H
  (assert (=> (not (= result5 true)) (= o24 (of_int 1))))
...
;; H
  (assert (=> (not (= result6 true)) (= o19 (of_int 1))))
...
;; H
  (assert (=> (not (= result7 true)) (= o14 (of_int 1))))

;; H
  (assert
  (and (= o4 (statusiswaitingfinishadminop (us_private__content state68)))
  (statusiswaitingfinishadminop__function_guard o4
  (us_private__content state68))))

;; H
  (assert
  (and (= o5 (statusiswaitingstartadminop (us_private__content state68)))
...
;; H
  (assert
  (and
  (= o (statusiswaitingremoveadmintokenfail (us_private__content state68)))
  (statusiswaitingremoveadmintokenfail__function_guard o
  (us_private__content state68))))

;; H
  (assert
  (and (= o1 (statusisgotadmintoken (us_private__content state68)))
  (statusisgotadmintoken__function_guard o1 (us_private__content state68))))
...
;; H
  (assert (=> (not (= result9 true)) (= o3 (of_int 1))))
