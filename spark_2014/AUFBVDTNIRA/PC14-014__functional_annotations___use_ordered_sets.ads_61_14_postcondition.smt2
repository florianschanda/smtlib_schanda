...
(declare-fun use_ordered_sets__move_2__cu__assume () count_type)

(declare-fun temp___792 () count_type)

(declare-fun temp___7921 () us_main_type)

(declare-fun temp___795 () us_rep3)

(declare-fun temp___791 () count_type)

(declare-fun temp___793 () Int)

(declare-fun temp___794 () us_rep3)

(declare-fun temp___790 () count_type)

(declare-fun temp___7901 () us_main_type)
...
(define-fun use_ordered_sets__move_2__cu__assume1 () us_rep1 (mk___rep1
                                                             (mk___split_fields1
                                                             use_ordered_sets__move_2__cu__assume)))
...
;; H
  (assert
  (and
  (= use_ordered_sets__move_2__cu__assume1 (first
                                           (mk___rep s1__split_discrs
                                           (mk___split_fields
                                           s1__split_fields))))
  (ite (= (= (length
             (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) 0) true)
  (= (bool_eq3 use_ordered_sets__move_2__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
     use_ordered_sets__move_2__cu__assume1) true)
  (= (get1
     (positions
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
     use_ordered_sets__move_2__cu__assume1) 1)))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= (mk___split_discrs temp___792) s1__split_discrs)
  (= temp___7921 s1__split_fields))))
...
;; H
  (assert
  (=> (= result1 true) (= (mk___split_fields1 temp___791) cu__split_fields1)))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= (mk___split_discrs temp___790) s2__split_discrs)
  (= (mk___split_fields temp___7901) s2__split_fields))))
...
;; H
  (assert
  (=> (= result1 true)
  (= (length (mk___rep s1__split_discrs s1__split_fields2)) (- temp___793 
...
;; H
  ...
  (=>
  (and (<= 1 i)
  (<= i (length (mk___rep s2__split_discrs s2__split_fields1))))
  (= (get (elements (mk___rep s2__split_discrs s2__split_fields1)) i) 
  (get temp___794 i))))))
...
;; H
  ...
  (=>
  (and (<= 1 i)
  (<= i (length (mk___rep s1__split_discrs s1__split_fields2))))
  (= (get (elements (mk___rep s1__split_discrs s1__split_fields2)) i) 
  (get temp___795
  (+ (length (mk___rep s2__split_discrs s2__split_fields1)) i)))))))
...
;; H
  ...
  (= (oeq3 (elements (mk___rep s1__split_discrs s1__split_fields3))
     (elements (mk___rep s1__split_discrs s1__split_fields2))) true))
  (= (oeq4 (positions (mk___rep s1__split_discrs s1__split_fields3))
  ...
  (= (range_equal (elements (mk___rep s1__split_discrs s1__split_fields2))
     (elements (mk___rep s1__split_discrs s1__split_fields3)) 1
     (- (find (elements (mk___rep s1__split_discrs s1__split_fields2)) o1) 1)) true))
  (= (range_shifted (elements (mk___rep s1__split_discrs s1__split_fields3))
     (elements (mk___rep s1__split_discrs s1__split_fields2))
     (find (elements (mk___rep s1__split_discrs s1__split_fields2)) o1)
     (length (mk___rep s1__split_discrs s1__split_fields3)) 1) true))
  (= (p_positions_shifted
...
;; H
  (assert
  (=> (= result1 true)
  (and (= temp___7891 (first (mk___rep s1__split_discrs s1__split_fields3)))
...
;; H
  (assert
  (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___789))))
...
;; H
  (assert
  (=> (not (= result1 true))
  (= s2__split_fields5 (mk___split_fields__ref s2__split_fields))))
...
(assert
;; WP_parameter_def
 ;; File "use_ordered_sets.ads", line 53, characters 0-0
  (not
  (= (oeq2
     (model__
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
