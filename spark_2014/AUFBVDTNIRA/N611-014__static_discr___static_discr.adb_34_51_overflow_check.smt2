...
;; H
  ...
  (= (mk___split_fields4
     (mk___rep3
     (mk___split_discrs current__split_fields4 current__split_fields5)
     (mk___split_fields3 current__split_fields6)) current__split_fields7) 
  (us_split_fields9 a)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range1
  (+ (to_rep (rec__static_discr__holder__length1 current__split_fields8)) 1))))
(check-sat)
