...
;; temp___String_Literal_132__def_axiom
  ...
  (! (and
     (and
     (and
     (= (to_rep (select (temp___String_Literal_132 us_void_param) 1)) 116)
     (= (to_rep (select (temp___String_Literal_132 us_void_param) 2)) 111))
     (= (to_rep (select (temp___String_Literal_132 us_void_param) 3)) 116))
     (= (to_rep (select (temp___String_Literal_132 us_void_param) 4)) 111)) :pattern (
...
(assert
;; WP_parameter_def
 ;; File "test_ascii.ads", line 2, characters 0-0
  (not (in_range1 o3)))
(check-sat)
