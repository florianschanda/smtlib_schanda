...
(declare-fun s__split_fields1 () us_split_fields)
...
;; H
  ...
  (= (bool_eq4 use_ordered_sets__double_size__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
...
;; H
  ...
  (=> (and (<= 1 i) (<= i n2))
  (and
  (= (get (elements (mk___rep s__split_discrs s__split_fields1)) (* 2 i)) (+ 
  (get
  ...
  (= (get (elements (mk___rep s__split_discrs s__split_fields1))
     (- (* 2 i) 1)) (get
                    (elements
                    (mk___rep s__split_discrs
                    (mk___split_fields s__split_fields))) i))))))
...
;; H
  ...
  (=>
  (and (<= (+ (* 2 n2) 1) i)
  (<= i (length (mk___rep s__split_discrs s__split_fields1))))
  (= (get (elements (mk___rep s__split_discrs s__split_fields1)) i) (get
                                                                    (elements
                                                                    (mk___rep
                                                                    s__split_discrs
                                                                    (mk___split_fields
...
;; H
  ...
  (<= i (length
        (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
  (= (get (elements (mk___rep s__split_discrs s__split_fields1)) (+ i n2)) 
  (get
  (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
  i)))))
...
;; H
  ...
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields1))
     (+ (element (mk___rep s__split_discrs s__split_fields1)
        (mk___rep1 cu__split_fields2)) 1)) true)))

;; H
  (assert
  (and
  (= o (element (mk___rep s__split_discrs s__split_fields1)
       (mk___rep1 cu__split_fields2)))
  (and (in_range8 o)
  (= o (get (elements (mk___rep s__split_discrs s__split_fields1))
       (get1 (positions (mk___rep s__split_discrs s__split_fields1))
       (mk___rep1 cu__split_fields2)))))))
...
;; H
  (assert
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) o2) true)
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) o2) true)
  (and
  (and
  (and
  (= (oeq3 (model__ (mk___rep s__split_discrs s__split_fields1))
     (model__ (mk___rep s__split_discrs s__split_fields2))) true)
  (= (oeq4 (positions (mk___rep s__split_discrs s__split_fields2))
     (positions (mk___rep s__split_discrs s__split_fields1))) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields2))
     (find (elements (mk___rep s__split_discrs s__split_fields2)) o2)) 
  o2))
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields1))
     (elements (mk___rep s__split_discrs s__split_fields2))
     (find (elements (mk___rep s__split_discrs s__split_fields2)) o2)) true))
  (and
  (and
  (and
  (and
  (and
  (and
  (= (length (mk___rep s__split_discrs s__split_fields2)) (+ (length
                                                             (mk___rep
                                                             s__split_discrs
                                                             s__split_fields1)) 1))
  (= (ole (model__ (mk___rep s__split_discrs s__split_fields1))
     (model__ (mk___rep s__split_discrs s__split_fields2))) true))
  (= (included_except (model__ (mk___rep s__split_discrs s__split_fields2))
     (model__ (mk___rep s__split_discrs s__split_fields1)) o2) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields2))
     (find (elements (mk___rep s__split_discrs s__split_fields2)) o2)) 
  o2))
  (= (range_equal (elements (mk___rep s__split_discrs s__split_fields1))
     (elements (mk___rep s__split_discrs s__split_fields2)) 1
     (- (find (elements (mk___rep s__split_discrs s__split_fields2)) o2) 1)) true))
  (= (range_shifted (elements (mk___rep s__split_discrs s__split_fields1))
     (elements (mk___rep s__split_discrs s__split_fields2))
     (find (elements (mk___rep s__split_discrs s__split_fields2)) o2)
     (length (mk___rep s__split_discrs s__split_fields1)) 1) true))
  (= (p_positions_shifted
     (positions (mk___rep s__split_discrs s__split_fields1))
...
;; H
  (assert
  (and
  (= o6 (next (mk___rep s__split_discrs s__split_fields2)
        (mk___rep1 cu__split_fields2)))
  (ite (= (ite (= (bool_eq4 (mk___rep1 cu__split_fields2) no_element) false) (= 
          (get1 (positions (mk___rep s__split_discrs s__split_fields2))
          (mk___rep1 cu__split_fields2)) (length
                                         (mk___rep s__split_discrs
                                         s__split_fields2))) true) true)
  (= (bool_eq4 o6 no_element) true)
  (and
  (= (has_key (positions (mk___rep s__split_discrs s__split_fields2)) o6) true)
  (= (get1 (positions (mk___rep s__split_discrs s__split_fields2)) o6) (+ 
  (get1 (positions (mk___rep s__split_discrs s__split_fields2))
  (mk___rep1 cu__split_fields2)) 1))))))

;; H
  (assert
  (and (= temp___8221 (next (mk___rep s__split_discrs s__split_fields2) o6))
  (ite (= (ite (= (bool_eq4 o6 no_element) false) (= (get1
                                                     (positions
                                                     (mk___rep
                                                     s__split_discrs
                                                     s__split_fields2)) 
...
;; H
  (assert
  (and
  (= o5 (has_key (positions (mk___rep s__split_discrs s__split_fields2))
...
;; H
  (assert (<= i (length (mk___rep s__split_discrs s__split_fields2))))

(assert
;; WP_parameter_def
 ;; File "use_ordered_sets.ads", line 71, characters 0-0
  (not
  (= (get (elements (mk___rep s__split_discrs s__split_fields2)) i) (get
                                                                    (elements
                                                                    (mk___rep
                                                                    s__split_discrs
                                                                    (mk___split_fields
