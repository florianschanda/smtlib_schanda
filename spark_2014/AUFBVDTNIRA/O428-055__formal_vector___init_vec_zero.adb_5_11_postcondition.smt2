...
;; H
  (assert
  (=> (and (<= r4b j1) (<= j1 r5b)) (= v__split_fields5 v__split_fields10)))
...
;; H
  (assert
  (=> (and (<= r4b j1) (<= j1 r5b)) (= v__split_fields6 v__split_fields4)))
...
;; H
  (assert
  (=> (and (<= r4b j1) (<= j1 r5b)) (= v__split_fields7 v__split_fields5)))
