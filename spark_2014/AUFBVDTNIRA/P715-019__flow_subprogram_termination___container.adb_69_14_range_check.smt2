...
;; H
  (assert (=> (< i1 10) (= temp___567 i1)))

;; H
  (assert (=> (< i1 10) (= temp___566 r1)))

;; H
  (assert (=> (< i1 10) (= 0 temp___569)))

;; H
  (assert (=> (< i1 10) (= 0 temp___568)))
...
;; H
  (assert (=> (< i1 10) (= result8 (mk_int__ref temp___5691))))

;; H
  (assert (=> (< i1 10) (= temp___5692 i2)))

;; H
  (assert (=> (< i1 10) (= result9 (mk_int__ref temp___5681))))

;; H
  (assert (=> (< i1 10) (= temp___5682 r2)))

;; H
  (assert (=> (< i1 10) (and (= o4 (- r2 i2)) (in_range3 (- r2 i2)))))
...
;; H
  (assert (=> (< i1 10) (and (= o5 (+ i2 1)) (in_range4 (+ i2 1)))))
