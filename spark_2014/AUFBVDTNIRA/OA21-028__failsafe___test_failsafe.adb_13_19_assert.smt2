...
(declare-fun to_rep (battery_level_type) t)

(declare-fun of_rep (t) battery_level_type)
...
;; range_axiom
  (assert
  (forall ((x battery_level_type)) (! (tqtisFinite
...
(define-fun dynamic_invariant1 ((temp___expr_202 t) (temp___is_init_199 Bool)
  (temp___skip_constant_200 Bool)
  (temp___do_toplevel_201 Bool)) Bool (=>
                                      (or (= temp___is_init_199 true) (le
                                      (neg fliteral1) fliteral1))
                                      (tqtisFinite temp___expr_202)))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral2) (/ 20000000298023223876953125.0 100000000000000000000000000.0))))
...
;; time_below_threshold__post_axiom
  ...
  (! (=> (dynamic_invariant failsafe__model__current_time true true true)
     ...
     (ite (forall ((s (_ BitVec 8)))
          ...
          (lt (to_rep (select failsafe__model__battery_level_at s))
          fliteral2)))
     (= result ((_ int2bv 8) 50))
     (and
     (and (bvult result ((_ int2bv 8) 50)) (le fliteral2
     (to_rep
     (select failsafe__model__battery_level_at (let ((temp___230 (bvsub failsafe__model__current_time result)))
     ...
     (bvule s failsafe__model__current_time)) (lt
     ...
     (lt (to_rep (select failsafe__model__battery_level_at s)) fliteral2)))
     (forall ((s (_ BitVec 8)))
     (=>
     (and
...
(declare-fun battery_level_at1 () (Array (_ BitVec 8) battery_level_type))
...
(declare-fun failsafe_state2 () us_private)

(declare-fun battery_level_at2 () (Array (_ BitVec 8) battery_level_type))

(declare-fun current_time3 () (_ BitVec 8))

(declare-fun failsafe_state3 () us_private)

(declare-fun battery_level_at3 () (Array (_ BitVec 8) battery_level_type))

(declare-fun current_time4 () (_ BitVec 8))

(declare-fun j3 () Int)

(declare-fun failsafe_state4 () us_private)

(declare-fun battery_level_at4 () (Array (_ BitVec 8) battery_level_type))

(declare-fun current_time5 () (_ BitVec 8))

(declare-fun j4 () Int)

(declare-fun failsafe_state5 () us_private)

(declare-fun battery_level_at5 () (Array (_ BitVec 8) battery_level_type))

(declare-fun current_time6 () (_ BitVec 8))

(declare-fun j5 () Int)

(declare-fun failsafe_state6 () us_private)

(declare-fun battery_level_at6 () (Array (_ BitVec 8) battery_level_type))

(declare-fun current_time7 () (_ BitVec 8))

(declare-fun j6 () Int)

(declare-fun failsafe_state7 () us_private)

(declare-fun battery_level_at7 () (Array (_ BitVec 8) battery_level_type))

(declare-fun current_time8 () (_ BitVec 8))

(declare-fun failsafe_state8 () us_private)

(declare-fun battery_level_at8 () (Array (_ BitVec 8) battery_level_type))
...
(define-fun failsafe_state9 () us_private__ref (mk___private__ref
                                               failsafe_state5))
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 49))
  (= current_time10 (mk_t__ref current_time4))))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 49))
  (= battery_level_at9 (mk_map__ref battery_level_at3))))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 49))
  (= failsafe_state9 (mk___private__ref failsafe_state3))))
...
;; H
  (assert
  (=> (not (and (<= 1 j1) (<= j1 49)))
  (= current_time10 (mk_t__ref current_time))))

;; H
  (assert
  (=> (not (and (<= 1 j1) (<= j1 49)))
  (= battery_level_at9 (mk_map__ref battery_level_at))))

;; H
  (assert
  (=> (not (and (<= 1 j1) (<= j1 49)))
  (= failsafe_state9 (mk___private__ref failsafe_state))))
...
;; H
  (assert (is_valid__function_guard
  (is_valid failsafe_state8 battery_level_at8 current_time9) failsafe_state8
  battery_level_at8 current_time9))
...
;; H
  ...
  (and
  (= current_time9 (let ((temp___237 (bvadd current_time8 ((_ int2bv 8) 1))))
                   (ite (bvule (bvsub ((_ int2bv 8) 50) current_time8) ((_ int2bv 8) 1))
                   (bvsub temp___237 ((_ int2bv 8) 50)) temp___237)))
  (eq (to_rep (select battery_level_at8 current_time9)) fliteral3)))
  (in_range2 current_time9)))

;; H
  (assert (is_raised__function_guard
  (is_raised failsafe_state8 battery_level_at8 current_time9) failsafe_state8
  battery_level_at8 current_time9))

(assert
;; WP_parameter_def
 ;; File "failsafe.ads", line 20, characters 0-0
  (not (= (is_raised failsafe_state8 battery_level_at8 current_time9) true)))
(check-sat)
