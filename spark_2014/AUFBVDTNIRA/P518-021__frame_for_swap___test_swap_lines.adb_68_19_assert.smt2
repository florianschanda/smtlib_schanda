...
(declare-fun m22 () map__ref)

(declare-fun i5 () int__ref)

(declare-fun m23 () map1)
...
;; H
  ...
  (forall ((i7 Int))
  (=> (and (<= 1 i7) (<= i7 (- c3 1)))
  (and (= (to_rep (get m2 5 i7)) (to_rep (get temp___232 7 i7)))
  (= (to_rep (get m2 7 i7)) (to_rep (get temp___233 5 i7))))))))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j 10))
  (ite (= i7 5) (= (to_rep (get m7 i7 j)) 2)
  (ite (= i7 7) (= (to_rep (get m7 i7 j)) 1) (= (to_rep (get m7 i7 j)) 0))))))))
...
;; H
  ...
  (forall ((i7 Int))
  (=> (and (<= 1 i7) (<= i7 c9))
  (and (= (to_rep (get m10 5 i7)) (to_rep (get temp___248 7 i7)))
  (= (to_rep (get m10 7 i7)) (to_rep (get temp___249 5 i7))))))))
...
;; H
  ...
  (forall ((i7 Int))
  (=> (and (<= (+ c9 1) i7) (<= i7 10))
  (and (= (to_rep (get m10 5 i7)) (to_rep (get temp___250 5 i7)))
  (= (to_rep (get m10 7 i7)) (to_rep (get temp___251 7 i7))))))))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j 10))
  (ite (= i7 5) (= (to_rep (get (map__content m15) i7 j)) 2)
  (ite (= i7 7) (= (to_rep (get (map__content m15) i7 j)) 1)
  (= (to_rep (get (map__content m15) i7 j)) 0))))))))
...
;; H
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- i2 1)))
  (= (to_rep (get m18 k k)) (+ (to_rep (get temp___263 k k)) 1))))))
...
;; H
  ...
  (forall ((h Int))
  (=> (and (<= 1 h) (<= h (- i2 1)))
  (=> (not (= k h)) (= (to_rep (get m18 k h)) (to_rep (get temp___264 k h))))))))))
...
;; H
  ...
  (= (get m18 temp___261 temp___262) (get temp___260 temp___261 temp___262))))))
  (and (<= 1 i2) (<= i2 10)))))
...
;; WP_parameter_def
 ;; File "test_swap_lines.adb", line 1, characters 0-0
  (not (= (to_rep (get (map__content m22) i7 j)) 1)))
(check-sat)
