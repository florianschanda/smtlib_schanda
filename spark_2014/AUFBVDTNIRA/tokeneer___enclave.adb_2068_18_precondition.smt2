...
;; H
  ...
  (=> (= result5 true)
  (and
  (and (= o3 (theauthcertrole state1)) (theauthcertrole__function_guard 
  o3 state1)) (in_range1 o3))))
...
;; H
  (assert
  (=> (= result5 true)
  (and (= o1 (authcertvalid state1)) (authcertvalid__function_guard o1
  state1))))

;; H
  (assert
  (=> (= result5 true)
  (and (= o2 (isgood state1)) (isgood__function_guard o2 state1))))
