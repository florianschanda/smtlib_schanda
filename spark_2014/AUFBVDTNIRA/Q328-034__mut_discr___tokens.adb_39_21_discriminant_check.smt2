...
(declare-fun temp___248 () us_rep1)
...
;; H
  ...
  (read__function_guard2 o31
  (mk___t word1 (mk (to_rep1 word__first) (to_rep1 word__last))))) (in_range5
  o31)))
...
;; H
  (assert (= temp___248 (mk___rep1 o34 o33 true)))
...
;; WP_parameter_def
 ;; File "tokens.ads", line 14, characters 0-0
  (not
  (= (rec__tokens__token__kind (us_split_discrs1 temp___248)) (rec__tokens__token__kind
                                                              v__split_discrs))))
(check-sat)
