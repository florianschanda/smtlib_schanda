...
(declare-fun user_eq17 (t71s t71s) Bool)

(declare-fun dummy17 () t71s)
...
;; H
  ...
  (= (length
     ...
     (mk___rep1
     (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2
     s__split_fields3) s__attr__tag))) 0)))
...
;; H
  ...
  (<= (to_rep1
      ...
      (mk___rep1
      (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2
      s__split_fields3) s__attr__tag))))) (to_rep1
                                          (last
                                          (rt
                                          (get_model__3
                                          (mk___rep1
                                          (mk___split_fields1 s__split_fields
                                          s__split_fields1 s__split_fields2
                                          s__split_fields3) s__attr__tag))))))
  (= o1 (+ (- (to_rep1
              (last
              (rt
              ...
              s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep1
                                                                   (first
                                                                   (rt
                                                                   (get_model__3
                                                                   (mk___rep1
...
;; H
  ...
  (= o3 (+ (to_rep1
           ...
           (mk___rep1
           (mk___split_fields1 s__split_fields s__split_fields1
           s__split_fields2 s__split_fields3) s__attr__tag))))) o2)))
