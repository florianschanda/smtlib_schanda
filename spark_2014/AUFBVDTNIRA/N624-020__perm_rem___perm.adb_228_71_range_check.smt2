...
;; H
  (assert (invariant____function_guard (invariant__ o19) o19))
...
;; H
  (assert (invariant____function_guard (invariant__ o21) o21))

;; H
  (assert (is_perm__function_guard (is_perm o18 o20) o18 o20))
...
;; H
  (assert
  (and (and (= o19 (remove a o10)) (remove__function_guard o19 a o10))
...
;; H
  (assert
  (and (and (= o18 (remove o19 o13)) (remove__function_guard o18 o19 o13))
...
;; H
  (assert
  (and (and (= o20 (remove bb ib1)) (remove__function_guard o20 bb ib1))
...
;; H
  (assert
  (and (and (= o21 (remove aa o5)) (remove__function_guard o21 aa o5))
...
;; H
  (assert
  (and
  (and (= o16 (shift_perm_l o21 o20 o18)) (shift_perm_l__function_guard 
  o16 o21 o20 o18))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o18 o20) true)))))
...
;; H
  ...
  (= o17 (remove_swap b ib1
         (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
  (remove_swap__function_guard o17 b ib1
  (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
  (and (in_range3 o17)
  (=> (= (of_int o17) true)
  (= (let ((temp___196 (remove
