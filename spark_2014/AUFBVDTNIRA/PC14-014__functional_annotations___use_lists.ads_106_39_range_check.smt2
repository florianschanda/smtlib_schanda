...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o9 j) true)
  (=> (= (get1 o9 i1) (get1 o9 j)) (= (bool_eq3 i1 j) true))))))))))
...
;; H
  ...
  (forall ((k us_rep1))
  (=> (= (has_key o9 k) true)
  (= (= (bool_eq3 k cu) true) (= (witness o9 cu) (witness o9 k))))))))))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o7 j) true)
  (=> (= (get1 o7 i1) (get1 o7 j)) (= (bool_eq3 i1 j) true))))))))))
...
;; H
  ...
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o7 k) true) (= (bool_eq3 k cu) true))) (= o8 true)))))
