...
;; H
  ...
  e1) (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last)))
  e1))
...
;; H
  ...
  (occ
  (mk___t (elts1 init)
  (mk (to_rep1 (first3 (rt1 init))) (to_rep1 (last3 (rt1 init))))) e1)
  (mk___t (elts1 init)
  (mk (to_rep1 (first3 (rt1 init))) (to_rep1 (last3 (rt1 init))))) e1))
...
;; H
  ...
  e1) (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last)))
  e1))
...
;; H
  (assert
  (forall ((f Int)) (occ__function_guard
  (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) f)
  (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) f)))
...
;; H
  ...
  (occ
  (mk___t (elts1 init)
  (mk (to_rep1 (first3 (rt1 init))) (to_rep1 (last3 (rt1 init))))) f)
  (mk___t (elts1 init)
  (mk (to_rep1 (first3 (rt1 init))) (to_rep1 (last3 (rt1 init))))) f)))
...
;; H
  (assert (occ__function_guard
  (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last)))
  e3) (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last)))
  e3))
...
;; H
  ...
  (occ
  (mk___t (elts1 init)
  (mk (to_rep1 (first3 (rt1 init))) (to_rep1 (last3 (rt1 init))))) e3)
  (mk___t (elts1 init)
  (mk (to_rep1 (first3 (rt1 init))) (to_rep1 (last3 (rt1 init))))) e3))
...
;; H
  (assert (occ__function_guard
  (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last)))
  e3) (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last)))
  e3))
...
;; H
  (assert
  (ite (= o11 (to_rep (select (elts1 init) o8)))
  (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last)))
     e3) (occ
         (mk___t (elts1 init)
         (mk (to_rep1 (first3 (rt1 init))) (to_rep1 (last3 (rt1 init))))) 
  ...
  (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last)))
     e3) (+ (occ
            ...
            (mk (to_rep1 (first3 (rt1 init))) (to_rep1 (last3 (rt1 init)))))
            e3) 1))
  (ite (= (to_rep (select (elts1 init) o8)) e3)
  (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last)))
     e3) (- (occ
            (mk___t (elts1 init)
            (mk (to_rep1 (first3 (rt1 init))) (to_rep1 (last3 (rt1 init)))))
...
;; H
  (assert
  (ite (= o15 (to_rep (select interm o12)))
  (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last)))
     e3) (occ
         (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last)))
         e3))
  ...
  (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last)))
     e3) (+ (occ
            (mk___t interm
            (mk (to_rep1 interm__first) (to_rep1 interm__last))) e3) 1))
  (ite (= (to_rep (select interm o12)) e3)
  (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last)))
     e3) (- (occ
            (mk___t interm
            (mk (to_rep1 interm__first) (to_rep1 interm__last))) e3) 1))
