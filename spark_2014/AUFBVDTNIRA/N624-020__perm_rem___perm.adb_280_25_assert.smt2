...
;; H
  ...
  (remove_swap__function_guard o15 b
  (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) ib2))
  (and (in_range3 o15)
  (=> (= (of_int o15) true)
...
;; H
  (assert (is_perm__function_guard (is_perm o18 o22) o18 o22))

;; H
  (assert
  (and (and (= o21 (remove b ib2)) (remove__function_guard o21 b ib2))
...
;; H
  ...
  (= o22 (remove o21
         (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
  (remove__function_guard o22 o21
  (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
...
;; H
  (assert
  (and (and (= o20 (remove bb o19)) (remove__function_guard o20 bb o19))
...
;; H
  (assert
  (and (and (= o17 (remove a o16)) (remove__function_guard o17 a o16))
...
;; H
  ...
  (= o18 (remove o17
         (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))))
  (remove__function_guard o18 o17
  (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))))
...
;; H
  (assert
  (and
  (and (= o23 (shift_perm_r o18 o20 o22)) (shift_perm_r__function_guard 
  o23 o18 o20 o22))
