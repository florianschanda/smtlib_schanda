...
(declare-fun temp___2002 () int__ref)
...
;; H
  (assert (=> (= (mod1 k22 2) 0) (= result12 (mk_int__ref k22))))

;; H
  (assert (=> (= (mod1 k22 2) 0) (= k23 (div1 k22 2))))
...
;; H
  (assert (=> (= (mod1 k22 2) 0) (= result13 (mk_int__ref b22))))

;; H
  (assert (=> (= (mod1 k22 2) 0) (= b23 o3)))

;; H
  (assert (=> (= (mod1 k22 2) 0) (= k25 (mk_int__ref k23))))

;; H
  (assert (=> (= (mod1 k22 2) 0) (= b24 (mk_int__ref b23))))

;; H
  (assert (=> (= (mod1 k22 2) 0) (= p24 (mk_int__ref p22))))

;; H
  (assert (=> (= (mod1 k22 2) 0) (= k26 k23)))

;; H
  (assert (=> (= (mod1 k22 2) 0) (= b25 b23)))

;; H
  (assert (=> (= (mod1 k22 2) 0) (= p25 p22)))
...
;; H
  (assert (=> (not (= (mod1 k22 2) 0)) (= result14 (mk_int__ref k22))))

;; H
  (assert (=> (not (= (mod1 k22 2) 0)) (= k24 o4)))
...
;; H
  (assert (=> (not (= (mod1 k22 2) 0)) (= result15 (mk_int__ref p22))))

;; H
  (assert (=> (not (= (mod1 k22 2) 0)) (= p23 o5)))

;; H
  (assert (=> (not (= (mod1 k22 2) 0)) (= k25 (mk_int__ref k24))))

;; H
  (assert (=> (not (= (mod1 k22 2) 0)) (= b24 (mk_int__ref b22))))

;; H
  (assert (=> (not (= (mod1 k22 2) 0)) (= p24 (mk_int__ref p23))))

;; H
  (assert (=> (not (= (mod1 k22 2) 0)) (= k26 k24)))

;; H
  (assert (=> (not (= (mod1 k22 2) 0)) (= b25 b22)))

;; H
  (assert (=> (not (= (mod1 k22 2) 0)) (= p25 p23)))

;; H
  (assert (< 0 (int__content k25)))

;; H
  (assert (= temp___2002 (mk_int__ref temp___2001)))
...
;; H
  (assert (= temp___2003 temp___2001))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (power a2 n2) (* (int__content p26) (power (int__content b26)
                                         (int__content k27))))))
(check-sat)
