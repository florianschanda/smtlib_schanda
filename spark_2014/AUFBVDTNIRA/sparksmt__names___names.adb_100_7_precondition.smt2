...
(define-fun dynamic_invariant4 ((temp___expr_298 Int)
...
(define-fun dynamic_invariant5 ((temp___expr_292 Int)
...
(define-fun dynamic_invariant7 ((temp___expr_358 Int)
...
;; valid_name_table__post_axiom
  ...
  (valid_tables names__char_table__fields names__entry_table__fields)
  names__char_table__fields
  names__entry_table__fields) :pattern ((valid_name_table
                                        names__char_table__fields
                                        names__entry_table__fields)) ))))
...
;; valid_name_table__def_axiom
  ...
  (! (=> (valid_name_table__function_guard
     ...
     names__char_table__fields names__entry_table__fields)
     (and
     (forall ((i Int)) (valid_entry__function_guard
     (valid_entry
     (element
...
(define-fun dynamic_invariant12 ((temp___expr_274 Int)
...
(define-fun default_initial_assumption2 ((temp___expr_328 us_rep2)
  (temp___skip_top_level_329 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_329 true))
                                         (= (length2 temp___expr_328) 0)))
...
(define-fun dynamic_invariant14 ((temp___expr_315 Int)
...
(define-fun default_initial_assumption3 ((temp___expr_397 us_rep4)
  (temp___skip_top_level_398 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_398 true))
                                         (= (length4 temp___expr_397) 0)))
...
(define-fun dynamic_invariant15 ((temp___expr_343 Int)
...
(define-fun dynamic_invariant16 ((temp___expr_390 Int)
...
(declare-fun temp___538 () Int)

(declare-fun temp___534 () Int)

(declare-fun temp___535 () Int)

(declare-fun temp___533 () capacity_range)

(declare-fun temp___5331 () us_main_type)
...
(define-fun char_table__split_fields8 () us_split_fields (mk___split_fields
...
(define-fun char_table__split_fields9 () us_split_fields__ref (mk___split_fields__ref
                                                              (mk___split_fields
...
;; H
  ...
  (mk___split_fields1 entry_table__split_fields)) hash_table
...
;; H
  (assert (invariant____function_guard
  (invariant__ hash_table char_table__split_fields8
  (mk___split_fields1 entry_table__split_fields)) hash_table
  char_table__split_fields8 (mk___split_fields1 entry_table__split_fields)))
...
;; H
  (assert (and (= temp___538 (length s)) (in_range1 (length s))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___538)) (= temp___534 i1)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___538))
  (= temp___535 (length1
                (mk___rep char_table__split_discrs
                (mk___split_fields char_table__split_fields))))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___538))
  (and (= char_table__split_discrs (mk___split_discrs temp___533))
  (= char_table__split_fields temp___5331))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___538)) (= o1 (+ i1 o))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___538))
  (and (= temp___531 o1) (in_range1 o1))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___538))
  (and (<= (to_rep1 (first (rt s))) temp___531)
  (<= temp___531 (to_rep1 (last (rt s)))))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___538)) (= o2 temp___531)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___538)) (= o3 (select (elts s) o2))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___538)) (= o4 (to_rep o3))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___538))
  (= (mk___split_fields__ref (mk___split_fields result1)) char_table__split_fields9)))
...
;; H
  ...
  (= (invariant__ hash_table char_table__split_fields8
     (mk___split_fields1 entry_table__split_fields)) true)
  (= (length1 (mk___rep char_table__split_discrs char_table__split_fields8)) (+ 
  temp___535 i2)))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___538)) (= i2 temp___538)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___538)) (= i3 (mk_int__ref i2))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___538))
  (= char_table__split_fields4 (mk___split_fields__ref
                               char_table__split_fields8))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___538)) (= i4 i2)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___538))
  (= char_table__split_fields5 char_table__split_fields8)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___538)) (= i5 i3)))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___538)) (= i6 i4)))
...
;; H
  (assert
  (=> (not (and (<= 1 i1) (<= i1 temp___538))) (= i5 (mk_int__ref i1))))

;; H
  (assert
  (=> (not (and (<= 1 i1) (<= i1 temp___538)))
  (= char_table__split_fields6 char_table__split_fields9)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 temp___538))) (= i6 i1)))
...
;; WP_parameter_def
 ;; File "names.adb", line 64, characters 0-0
  ...
  (< (length3
     (mk___rep1 entry_table__split_discrs
     (mk___split_fields1 entry_table__split_fields))) (capacity1
                                                      (mk___rep1
                                                      entry_table__split_discrs
                                                      (mk___split_fields1
                                                      entry_table__split_fields))))))
(check-sat)
