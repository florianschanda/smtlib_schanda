...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 10)) (= (mk_map__ref result1) outkeys_v19)))
...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 10)) (= (mk_int__ref i6) (mk_int__ref i4))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 10)) (= outkeys_v18 (mk_map__ref outkeys_v14))))
...
;; WP_parameter_def
 ;; File "infoflow.ads", line 43, characters 0-0
  (not (= (to_rep (select outkeys_v21 k)) (to_rep (select inkeys_v2 k)))))
(check-sat)
