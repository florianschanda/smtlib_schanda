...
(declare-fun records__init_c__result () unsigned_byte)

(declare-fun records__init_c__result1 () unsigned_byte)
...
(declare-fun records__init_c__result2 () unsigned_byte)

(declare-fun records__init_c__result3 () unsigned_byte)

(declare-fun records__init_c__result4 () unsigned_byte)

(declare-fun records__init_c__result5 () unsigned_byte)

(declare-fun records__init_c__result6 () us_rep)

(declare-fun r__split_fields4 () us_split_fields__ref)

(declare-fun records__init_c__result7 () pair__ref)

(declare-fun r__split_fields5 () us_split_fields)

(declare-fun records__init_c__result8 () us_rep)
...
;; H
  (assert
  (= records__init_c__result6 (mk___rep
                              (mk___split_fields records__init_c__result2
                              records__init_c__result3))))
...
;; H
  (assert
  (= records__init_c__result7 (mk_pair__ref
                              (mk___rep
                              (mk___split_fields records__init_c__result4
                              records__init_c__result5)))))

;; H
  (assert (= r__split_fields4 (mk___split_fields__ref r__split_fields6)))

;; H
  (assert (= records__init_c__result8 records__init_c__result6))
...
;; H
  ...
  (= (mk___rep (mk___split_fields result4 result5)) (pair__content
                                                    records__init_c__result7)))

(assert
;; WP_parameter_def
 ;; File "records_prooffuncs.ads", line 11, characters 0-0
  (not
  (= (bool_eq1 (pair__content records__init_c__result7) null_pair) true)))
(check-sat)
