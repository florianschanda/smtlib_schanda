...
(define-fun dynamic_invariant1 ((temp___expr_142 (_ BitVec 64))
...
(define-fun dynamic_invariant2 ((temp___expr_154 us_t)
...
(define-fun dynamic_invariant4 ((temp___expr_136 (_ BitVec 32))
...
;; H
  (assert
  (and (= temp___168 (bv2nat (bvurem i ((_ int2bv 64) 32)))) (in_range1
  (bv2nat (bvurem i ((_ int2bv 64) 32))))))

;; H
  (assert
  (=> (< temp___168 4294967296)
  (= o2 (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___168)))))
...
;; H
  (assert
  (and (= o (bv2nat (bvudiv i ((_ int2bv 64) 32)))) (in_range1
