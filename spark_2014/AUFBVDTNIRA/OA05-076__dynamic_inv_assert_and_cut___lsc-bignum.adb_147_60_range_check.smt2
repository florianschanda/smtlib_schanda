...
;; H
  (assert (= o53 (ite (<= o52 k) true false)))

;; H
  (assert
  (= result7 (ite (= o53 true) (ite (<= k a_last) true false) false)))
...
;; H
  (assert
  (and (= o49 (num_of_boolean carry3)) (num_of_boolean__function_guard 
  o49 carry3)))
...
;; H
  (assert
  (and (= o50 (omultiply o48 o49)) (omultiply__function_guard o50 o48 o49)))
...
;; H
  (assert
  (and (= o51 (osubtract o42 o50)) (osubtract__function_guard o51 o42 o50)))
...
;; H
  (assert
  (and (= o37 (num_of_big_int b b_first o36)) (num_of_big_int__function_guard
  o37 b b_first o36)))
