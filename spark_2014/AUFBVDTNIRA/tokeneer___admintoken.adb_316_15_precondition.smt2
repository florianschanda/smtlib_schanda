...
;; temp___String_Literal_1446__def_axiom
  (assert
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 1)) 73)
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 2)) 68))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 3)) 32))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 4)) 67))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 5)) 101))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 6)) 114))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 7)) 116))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 8)) 105))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 9)) 102))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 10)) 105))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 11)) 99))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 12)) 97))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 13)) 116))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 14)) 101))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 15)) 32))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 16)) 78))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 17)) 111))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 18)) 116))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 19)) 32))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 20)) 86))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 21)) 101))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 22)) 114))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 23)) 105))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 24)) 102))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 25)) 105))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 26)) 97))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 27)) 98))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 28)) 108))
     (= (to_rep (select (temp___String_Literal_1446 us_void_param) 29)) 101)) :pattern (
  (temp___String_Literal_1446 us_void_param)) )))

(declare-fun temp___String_Literal_1447 (tuple0) (Array Int character))

;; temp___String_Literal_1447__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (and
     (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 1)) 73)
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 2)) 68))
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 3)) 32))
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 4)) 67))
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 5)) 101))
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 6)) 114))
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 7)) 116))
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 8)) 105))
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 9)) 102))
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 10)) 105))
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 11)) 99))
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 12)) 97))
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 13)) 116))
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 14)) 101))
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 15)) 32))
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 16)) 66))
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 17)) 97))
     (= (to_rep (select (temp___String_Literal_1447 us_void_param) 18)) 100)) :pattern (
  (temp___String_Literal_1447 us_void_param)) )))
...
(define-fun o13 () us_rep1 (mk___rep1
                           (mk___split_fields1
                           (mk___rep (mk___split_fields o1 o2 o3)) o4)))
...
;; H
  ...
  (= o12 (cert_id_to_cert
         ...
         (let ((subject idcertcontents__split_fields))
         idcertcontents__split_fields2))))
  (cert_id_to_cert__function_guard o12
  (mk___rep5
  (let ((subject idcertcontents__split_fields))
  idcertcontents__split_fields2)))))))
