...
(define-fun o5 () us_t (mk___t o1 o2))
...
;; H
  (assert
  (and (= temp___180 (- (to_rep values__last) 1)) (in_range1
...
;; H
  (assert
  (= (mk (to_rep (first4 temp___1731)) (to_rep (last4 temp___1731))) 
  o2))

;; H
  (assert
  (and
  (and (= o3 (index_of_minimum o5)) (index_of_minimum__function_guard o3 o5))
  (and (in_range2 o3)
...
;; H
  (assert
  (=> (not (= smallest1 current1))
  (and (= (to_rep (select values2 o4)) (to_rep (select values smallest1)))
  (and (= (to_rep (select values2 smallest1)) (to_rep (select values o4)))
  (forall ((j1 Int))
  (=> (and (<= (to_rep values__first) j1) (<= j1 (to_rep values__last)))
  (=> (and (not (= j1 o4)) (not (= j1 smallest1)))
...
(assert
;; WP_parameter_def
 ;; File "sorters.adb", line 48, characters 0-0
