...
(define-fun us_split_fields_AON_ADDR__projection ((a us_split_fields)) bits_8 
...
(declare-datatypes ()
((aon_addr_type__ref (mk_aon_addr_type__ref (aon_addr_type__content us_rep)))))
(define-fun aon_addr_type__ref___projection ((a aon_addr_type__ref)) us_rep 
  (aon_addr_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_169__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_119__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_119__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5965 us_t1)
  (temp___is_init_5962 Bool) (temp___skip_constant_5963 Bool)
  (temp___do_toplevel_5964 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5963 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5965)
                                       (last4 temp___expr_5965))
                                       (and (= (first3 temp___expr_5965) 1)
                                       (= (last4 temp___expr_5965) 1)))))
...
(define-fun target__ref_51__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_51__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_5981 us_t2)
  (temp___is_init_5978 Bool) (temp___skip_constant_5979 Bool)
  (temp___do_toplevel_5980 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5979 true))
                                       (and (dynamic_property3 1 1
                                       (first5 temp___expr_5981)
                                       (last6 temp___expr_5981))
                                       (and (= (first5 temp___expr_5981) 1)
                                       (= (last6 temp___expr_5981) 1)))))
...
(declare-fun temp___7933 () (Array Int bits_8))

(declare-fun temp___79331 () t2)

(declare-fun temp___7934 () (Array Int bits_8))

(declare-fun temp___79341 () t1)

(define-fun temp___79332 () us_t2 (mk___t2 temp___7933 temp___79331))
...
;; H
  (assert
  (and
  (and (= temp___79332 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___79332 reg)) (dynamic_invariant1
  temp___79332 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___79331)) (to_rep (last5 temp___79331)))
     (+ (- (to_rep (last5 temp___79331)) (to_rep (first4 temp___79331))) 1)
     0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))

;; H
  (assert (= temp___7933 temp___7934))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___79331)) (to_rep (last5 temp___79331))) 
  temp___79341))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___79341)) (to_rep (last3 temp___79341)))
     (+ (- (to_rep (last3 temp___79341)) (to_rep (first2 temp___79341))) 1)
