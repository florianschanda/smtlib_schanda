...
(define-fun dynamic_invariant ((temp___expr_5965 us_t1)
  ...
  (temp___do_toplevel_5964 Bool)) Bool (=>
                                       ...
                                       (last3 temp___expr_5965))
                                       (and (= (first3 temp___expr_5965) 1)
                                       (= (last3 temp___expr_5965) 1)))))
...
(define-fun dynamic_invariant1 ((temp___expr_5981 us_t2)
  ...
  (temp___do_toplevel_5980 Bool)) Bool (=>
                                       ...
                                       (last5 temp___expr_5981))
                                       (and (= (first5 temp___expr_5981) 1)
                                       (= (last5 temp___expr_5981) 1)))))
...
;; H
  (assert
  (and (= temp___79332 (register_to_bytes reg)) (dynamic_invariant1
  temp___79332 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___79331)) (to_rep (last4 temp___79331)))
     (+ (- (to_rep (last4 temp___79331)) (to_rep (first4 temp___79331))) 1)
     0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___79331)) (to_rep (last4 temp___79331))) 
  temp___79341))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___79341)) (to_rep (last2 temp___79341)))
     (+ (- (to_rep (last2 temp___79341)) (to_rep (first2 temp___79341))) 1)
