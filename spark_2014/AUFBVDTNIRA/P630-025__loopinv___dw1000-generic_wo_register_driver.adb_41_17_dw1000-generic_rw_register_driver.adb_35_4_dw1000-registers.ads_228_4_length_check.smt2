...
(define-fun dynamic_invariant ((temp___expr_2422 us_t1)
  ...
  (temp___do_toplevel_2421 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_2422))
                                       (and (= (first3 temp___expr_2422) 1)
                                       (= (last4 temp___expr_2422) 4)))))
...
(define-fun dynamic_invariant1 ((temp___expr_2449 us_t2)
  ...
  (temp___do_toplevel_2448 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_2449))
                                       (and (= (first5 temp___expr_2449) 1)
                                       (= (last6 temp___expr_2449) 4)))))
...
;; H
  (assert
  (and
  (and (= temp___75962 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___75962 reg)) (dynamic_invariant1
  temp___75962 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___75961)) (to_rep (last5 temp___75961)))
     (+ (- (to_rep (last5 temp___75961)) (to_rep (first4 temp___75961))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___75961)) (to_rep (last5 temp___75961))) 
  temp___75971))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___75971)) (to_rep (last3 temp___75971)))
     (+ (- (to_rep (last3 temp___75971)) (to_rep (first2 temp___75971))) 1)
