...
(declare-fun dummy1 () (Array Int et1))
...
(declare-fun user_eq1 ((Array Int et1) (Array Int et1)) Bool)
...
(define-fun bool_eq2 ((a (Array Int (Array Int et1))) (a__first Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq1 (select a temp___idx_133) 1 10
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 361, characters 0-0
  (not (in_range1 (to_rep (select (select a2 n) m)))))
(check-sat)
