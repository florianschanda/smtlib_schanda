...
(define-fun o24 () us_rep (mk___rep (mk___split_fields o16 o17)))
...
;; H
  (assert
  (and
  (and (= o19 (state__2 (us_split_fields__content my_stack__split_fields4)))
  (state__2__function_guard o19
  (us_split_fields__content my_stack__split_fields4)))
  (= o19 (mk___rep (us_split_fields__content my_stack__split_fields4)))))

;; H
  (assert
  (and (and (= o20 (count o19)) (count__function_guard o20 o19))
  (and (in_range2 o20)
  (= o20 (to_rep1
         (rec__stack_functional_spec__stack_type__pointer
...
;; H
  (assert (= o22 (ite (<= i o21) true false)))

;; H
  (assert (= result3 (ite (<= 1 i) o22 false)))
...
;; H
  (assert
  (and
  (and (= o24 (state__2 (us_split_fields__content my_stack__split_fields4)))
  (state__2__function_guard o24
  (us_split_fields__content my_stack__split_fields4)))
...
;; H
  (assert
  (and (and (= o18 (count o24)) (count__function_guard o18 o24))
