...
(declare-fun temp___1266 () (Array Int us_rep1))
...
(declare-fun temp___1265 () (Array Int us_rep1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1266 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i1))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1266 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1266 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1267 o11))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1267 o11)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o11))
...
;; H
  (assert
  (= (mk___rep (mk___split_fields o13 o14)) (select temp___1267 o12)))
...
;; H
  ...
  (model____function_guard temp___1266
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o5))
  (and (dynamic_invariant9 temp___1266 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1266 o5))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1266 o5)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o5))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___1266 (parent
                              ...
                              (us_split_fields7 t)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1266 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1266 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1266 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1266 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1266 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1266 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o6 o7)) (select temp___1266 i)))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1265 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i1))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1265 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1265 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= temp___1265 (model__
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7 t)) o18))
  (model____function_guard temp___1265
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o18))
  (and (dynamic_invariant9 temp___1265 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1265 o18))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1265 o18)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o18))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___1265 (parent
                              ...
                              (us_split_fields7 t)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1265 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1265 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1265 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1265 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1265 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1265 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o19 o20)) (select temp___1265 
  i)))
