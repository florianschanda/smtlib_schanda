...
(declare-fun temp___2042 () (Array Int us_rep1))
...
(declare-fun temp___2043 () (Array Int us_rep1))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2043 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2043 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___2043 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (model____function_guard temp___2043
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  root))
  (and (dynamic_invariant3 temp___2043 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2043 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2043 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2043 (parent
                              ...
                              f_old__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2043 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2043 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2043 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2043 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2043 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2043 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o15 (select temp___2043 i)))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2042 (parent
                      (mk___rep2
                      (mk___split_fields2 f__split_fields f__split_fields1))
                      i1))))
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2042 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2042 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___2042 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 o11))
  (model____function_guard temp___2042
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o11))
  (and (dynamic_invariant3 temp___2042 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2042 o11))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2042 o11)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o11))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2042 (parent
                              ...
                              f__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2042 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2042 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2042 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2042 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2042 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2042 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o12 (select temp___2042 i)))
