...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__flag
     (us_split_fields1 (select b 5))) o9))

;; H
  (assert
  (= (rec__arrays_of_records__basic_record__first_value
     (us_split_fields1 (select b 5))) o10))
...
;; H
  (assert (= o15 (store b 5 (mk___rep (mk___split_fields o12 o13 o14)))))
...
(assert
;; WP_parameter_def
 ;; File "arrays_of_records.adb", line 232, characters 0-0
