...
(declare-fun q_v23 () Int)

(declare-fun h_v24 () map__ref)

(declare-fun t_v23 () int__ref)

(declare-fun q_v24 () int__ref)

(declare-fun h_v25 () (Array Int content))

(declare-fun t_v24 () Int)

(declare-fun q_v25 () Int)
...
;; H
  (assert (and (= temp___393 (+ q_v22 m_v21)) (in_range1 (+ q_v22 m_v21))))
...
;; WP_parameter_def
 ;; File "infoflow.ads", line 61, characters 0-0
  (not
  (= (to_rep1 (select (map__content h_v24) k)) (to_rep1
                                               (select h_v2 (+ k m_v21))))))
(check-sat)
