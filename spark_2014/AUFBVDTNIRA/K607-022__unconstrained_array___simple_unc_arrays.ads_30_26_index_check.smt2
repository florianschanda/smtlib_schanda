...
(define-fun dynamic_invariant6 ((temp___expr_693 us_t2)
  ...
  (temp___do_toplevel_692 Bool)) Bool (=>
                                      ...
                                      (first5 temp___expr_693)
                                      (last7 temp___expr_693))
                                      (and (= (first5 temp___expr_693) 1)
                                      (= (last7 temp___expr_693) r22b)))))
...
(declare-fun temp___849 () (Array Int value))

(declare-fun temp___8491 () t1)

(declare-fun temp___842 () natural)

(declare-fun temp___8421 () (Array Int value))

(declare-fun temp___8422 () t1)

(declare-fun temp___841 () Int)

(declare-fun temp___845 () (Array Int value))

(declare-fun temp___8451 () t1)
...
;; H
  (assert
  (=> (< low1 high1)
  (and (= a__split_fields temp___849) (= a__split_fields1 temp___8491))))

;; H
  (assert
  (=> (< low1 high1)
  (and (= a__split_discrs (mk___split_discrs temp___842))
  (and (= a__split_fields temp___8421) (= a__split_fields1 temp___8422)))))

;; H
  (assert (=> (< low1 high1) (= temp___841 high1)))

;; H
  (assert
  (=> (< low1 high1)
  (and (= a__split_fields temp___845) (= a__split_fields1 temp___8451))))

;; H
  (assert (=> (< low1 high1) (= temp___840 low1)))
...
;; H
  ...
  (= (to_rep2 (select a__split_fields4 j1)) (to_rep2 (select temp___849 j1))))))))
...
;; H
  ...
  true))
  (= (rec__simple_unc_arrays__table__last a__split_discrs) temp___842))
  (< low2 high2))))
...
;; H
  ...
  (= (ite (<= (to_rep1 (first2 a__split_fields5)) (to_rep1
                                                  (last3 a__split_fields5)))
     (+ (- (to_rep1 (last3 a__split_fields5)) (to_rep1
...
;; H
  ...
  (= (mk2 (to_rep1 (first2 a__split_fields5))
     (to_rep1 (last3 a__split_fields5))) simple_unc_arrays__swap_cells__a__compl1)))
...
;; H
  (assert
  (=> (< low1 high1)
  (= (to_rep1 o1) (to_rep1 (last6 simple_unc_arrays__swap_cells__a__compl1)))))
...
;; H
  ...
  (= a__split_fields6 (mk___split_fields
                      ...
                      (to_rep1
                      (last6 simple_unc_arrays__swap_cells__a__compl1))))) 1)
                      (mk1 (to_rep1 (first4 (mk2 1 r22b)))
                      (to_rep1 (last6 (mk2 1 r22b)))))))))
...
;; H
  (assert
  (and (<= (to_rep1 (first2 a__split_fields1)) temp___857)
  (<= temp___857 (to_rep1 (last3 a__split_fields1)))))

;; H
  (assert (= o5 temp___857))
