...
;; H
  (assert
  (and (= o33 (+ 48 (div1 localvalue3 10))) (in_range3
...
;; H
  (assert (= o35 (store localtext3 1 o34)))

;; H
  (assert (= result3 (mk_map__ref localtext3)))

;; H
  (assert (= localtext4 o35))

;; H
  (assert (= (to_rep o36) (+ 48 (mod2 localvalue3 10))))

;; H
  (assert (= o37 (store localtext4 2 o36)))

;; H
  (assert (= result4 (mk_map__ref localtext4)))

;; H
  (assert (= localtext5 o37))
...
;; H
  (assert
  (and (= o38 (+ 48 (div1 localvalue4 10))) (in_range3
...
;; H
  (assert (= o40 (store localtext5 4 o39)))

;; H
  (assert (= result6 (mk_map__ref localtext5)))

;; H
  (assert (= localtext6 o40))

;; H
  (assert (= (to_rep o41) (+ 48 (mod2 localvalue4 10))))

;; H
  (assert (= o42 (store localtext6 5 o41)))

;; H
  (assert (= result7 (mk_map__ref localtext6)))

;; H
  (assert (= localtext7 o42))
...
;; H
  (assert
  (and (= o44 (+ 48 (div1 localvalue5 10))) (in_range3
...
;; H
  (assert (= o46 (store localtext8 1 o45)))
...
;; H
  (assert (= (to_rep o47) (+ 48 (mod2 localvalue5 10))))

;; H
  (assert (= o48 (store localtext9 2 o47)))

;; H
  (assert (= result12 (mk_map__ref localtext9)))

;; H
  (assert (= localtext10 o48))
...
;; H
  (assert
  (and (= o49 (+ 48 (div1 localvalue6 10))) (in_range3
...
;; H
  (assert (= o51 (store localtext10 4 o50)))

;; H
  (assert (= result14 (mk_map__ref localtext10)))

;; H
  (assert (= localtext11 o51))

;; H
  (assert (= (to_rep o52) (+ 48 (mod2 localvalue6 10))))

;; H
  (assert (= o53 (store localtext11 5 o52)))

;; H
  (assert (= result15 (mk_map__ref localtext11)))

;; H
  (assert (= localtext12 o53))
...
;; H
  (assert (= o54 (temp___String_Literal_1149 Tuple0)))

;; H
  (assert (= result17 (mk_map__ref localtext2)))

;; H
  (assert (= localtext13 o54))
...
;; WP_parameter_def
 ;; File "configdata.adb", line 1359, characters 0-0
  (not (in_range3 (+ 48 (div1 localvalue7 10)))))
(check-sat)
