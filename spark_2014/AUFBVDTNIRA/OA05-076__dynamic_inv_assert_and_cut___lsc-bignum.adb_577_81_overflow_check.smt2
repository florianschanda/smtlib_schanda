...
;; H
  (assert
  (and (= o30 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o30 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o29 (from_word64 i2)) (from_word64__function_guard o29 i2)))

;; H
  (assert (and (= o31 (oadd o29 o30)) (oadd__function_guard o31 o29 o30)))
...
;; H
  (assert (and (= o32 (ole o28 o31)) (ole__function_guard o32 o28 o31)))
...
;; H
  (assert
  (and (= o23 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o23 ((_ int2bv 32) 2))))

;; H
  (assert (and (= o24 (oexpon o23 j3)) (oexpon__function_guard o24 o23 j3)))

;; H
  (assert
  (and (= o18 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o18 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o17 (from_integer j3)) (from_integer__function_guard o17 j3)))

;; H
  (assert
  (and (= o19 (osubtract o17 o18)) (osubtract__function_guard o19 o17 o18)))

;; H
  (assert
  (and (= o16 (from_word64 i2)) (from_word64__function_guard o16 i2)))

;; H
  (assert
  (and (= o20 (osubtract o16 o19)) (osubtract__function_guard o20 o16 o19)))

;; H
  (assert
  (and (= o15 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o15 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o21 (oexpon__2 o15 o20)) (oexpon__2__function_guard o21 o15 o20)))
...
;; H
  (assert
  (and (= o14 (num_of_big_int e e_first o13)) (num_of_big_int__function_guard
  o14 e e_first o13)))

;; H
  (assert
  (and (= o22 (odivide o14 o21)) (odivide__function_guard o22 o14 o21)))

;; H
  (assert (and (= o25 (omod o22 o24)) (omod__function_guard o25 o22 o24)))
