...
(define-fun dynamic_invariant ((temp___expr_144 us_rep)
  ...
  (temp___do_toplevel_143 Bool)) Bool (=> (= temp___do_toplevel_143 true)
                                      (=> (= temp___is_init_141 true)
                                      (<= (let ((temp___147 (rec__messages__message__received
                                                            (us_split_fields1
                                                            temp___expr_144))))
                                          (let ((temp___146 (rec__messages__message__sent
                                                            (us_split_fields1
                                                            temp___expr_144))))
                                          (compare temp___146 1 10 temp___147
                                          1 10))) 0))))

(define-fun dynamic_predicate ((temp___158 us_rep)) Bool (<= (let ((temp___161 
                                                             (rec__messages__message__received
                                                             (us_split_fields1
                                                             temp___158))))
                                                             (let ((temp___160 
...
(declare-fun m__split_fields () (Array Int character))

(declare-fun m__split_fields1 () (Array Int character))

;; H
  (assert
  (let ((temp___145 i1s))
  (<= (compare (rec__messages__message__sent (us_split_fields1 temp___145)) 1
      10 (rec__messages__message__received (us_split_fields1 temp___145)) 1
      10) 0)))
...
(assert
;; WP_parameter_def
 ;; File "messages.ads", line 6, characters 0-0
  (not (<= (compare m__split_fields1 1 10 m__split_fields 1 10) 0)))
(check-sat)
