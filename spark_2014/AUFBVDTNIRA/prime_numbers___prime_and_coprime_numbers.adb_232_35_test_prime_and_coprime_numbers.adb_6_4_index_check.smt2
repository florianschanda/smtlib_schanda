...
;; H
  (assert
  (forall ((v1 Int))
  (=> (and (<= 0 v1) (<= v1 index_22))
  (= (= (select is_prime5 v1) true) (= (is_prime v1) true)))))

;; H
  (assert
  (forall ((v1 Int))
  (=> (and (<= index_22 v1) (<= v1 100000))
  (= (= (select is_prime5 v1) true)
  (forall ((div3 Int))
  (=> (and (<= 2 div3) (<= div3 (- index_22 1))) (not (= (mod2 v1 div3) 0))))))))
...
;; H
  (assert (and (= o4 (* 2 index_12)) (in_range2 (* 2 index_12))))
...
;; H
  (assert (= o6 (store is_prime5 o5 (of_int1 0))))
...
;; H
  ...
  (forall ((v1 Int))
  (=> (and (<= 0 v1) (<= v1 index_22))
  (= (= (select is_prime7 v1) true) (= (is_prime v1) true)))))

;; H
  (assert
  (forall ((v1 Int))
  (=> (and (<= index_22 v1) (<= v1 100000))
  (= (= (select is_prime7 v1) true)
  (and
  (forall ((div3 Int))
  (=> (and (<= 2 div3) (<= div3 (- index_22 1))) (not (= (mod2 v1 div3) 0))))
  (=> (and (<= (+ index_22 1) v1) (<= v1 index_33))
  (not (= (mod2 v1 index_22) 0))))))))
...
;; H
  (assert (and (= o7 (+ index_22 1)) (in_range2 (+ index_22 1))))

;; H
  (assert (= o8 (ite (<= o7 v) true false)))

;; H
  (assert
  (= result8 (ite (= o8 true) (ite (<= v index_33) true false) false)))

;; H
  (assert
  (=> (= result8 true) (= o9 (ite (not (= (mod2 v index_22) 0)) true false))))

;; H
  (assert (=> (not (= result8 true)) (= o9 (of_int1 1))))
...
;; H
  (assert (= o11 (ite (= o10 true) o9 false)))
