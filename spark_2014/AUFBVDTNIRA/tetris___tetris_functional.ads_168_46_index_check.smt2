...
;; range_axiom
  (assert
  (forall ((x shape)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)) )))
...
(declare-fun dummy1 () three_shape)

(declare-datatypes ()
((three_shape__ref (mk_three_shape__ref (three_shape__content three_shape)))))
...
;; range_axiom
  (assert
  (forall ((x cell)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
(define-fun bool_eq3 ((a (Array Int cell)) (a__first Int) (a__last Int)
...
(declare-fun dummy3 () (Array Int cell))
...
(define-fun bool_eq4 ((a (Array Int (Array Int cell))) (a__first Int)
...
(define-fun bool_eq9 ((a map1) (a__first Int) (a__last Int) (a__first_2 Int)
...
(define-fun bool_eq10 ((a (Array Int map1)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq9 (select a temp___idx_136) 0 3 0 3
...
(define-fun bool_eq11 ((a map2) (a__first Int) (a__last Int) (a__first_2 Int)
...
;; bool_eq_rev
  ...
  (b__first Int) (b__last Int) (b__first_2 Int) (b__last_2 Int))
  (=>
  (= (bool_eq11 b b__first b__last b__first_2 b__last_2 a a__first a__last
     a__first_2 a__last_2) true)
  (and
  (and
  (ite (<= a__first a__last)
  ...
  (= (bool_eq9 (get1 a temp___idx_223 temp___idx_224) 0 2 0 2
...
;; is_empty__def_axiom
  ...
  (! (= (= (is_empty b y x) true)
     ...
     (= (to_rep1 (let ((temp___635 (select b y))) (select temp___635 x))) 0))) :pattern (
  (is_empty b y x)) ))))
...
(define-fun dynamic_invariant4 ((temp___expr_532 Int)
  ...
  (temp___do_toplevel_531 Bool)) Bool (=>
                                      ...
                                      (<= 1 10)) (in_range8 temp___expr_532)))

(define-fun dynamic_invariant5 ((temp___expr_538 Int)
  (temp___is_init_535 Bool) (temp___skip_constant_536 Bool)
  (temp___do_toplevel_537 Bool)) Bool (=>
                                      (or (= temp___is_init_535 true)
                                      (<= 1 50)) (in_range9 temp___expr_538)))

(define-fun dynamic_invariant6 ((temp___expr_565 Int)
...
(define-fun dynamic_invariant7 ((temp___expr_571 Int)
...
;; H
  (assert
  (= (tetris_functional__possible_three_shapes__aggregate_def
...
;; H
  (assert
  (not
  (= (to_rep (rec__tetris_functional__piece__s (us_split_fields1 p))) 2)))

;; H
  (assert
  (not
  (= (to_rep (rec__tetris_functional__piece__s (us_split_fields1 p))) 1)))
...
;; WP_parameter_def
 ;; File "tetris_functional.ads", line 157, characters 0-0
  (not
  (<= 3 (to_rep (rec__tetris_functional__piece__s (us_split_fields1 p))))))
(check-sat)
