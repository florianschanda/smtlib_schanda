...
(declare-fun user_eq2 (t37b t37b) Bool)

(declare-fun dummy2 () t37b)
...
(declare-fun temp___424 (Int) (Array Int unsigned_byte))

;; def_axiom
  (assert
  (forall ((temp___426 Int))
  (forall ((temp___427 Int))
  (= (select (temp___424 temp___426) temp___427) (of_rep temp___426)))))
