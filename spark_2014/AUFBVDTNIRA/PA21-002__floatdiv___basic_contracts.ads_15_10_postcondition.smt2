...
;; num__def_axiom
  (assert (= num (of_int RNE2 numerator)))

;; den__def_axiom
  (assert (= den (of_int RNE2 denominator)))

(declare-fun basic_contracts__average__result () t)

(declare-fun basic_contracts__average__num__assume () t)

(declare-fun basic_contracts__average__den__assume () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun basic_contracts__average__result1 () t)

(declare-fun basic_contracts__average__result2 () t)

(declare-fun basic_contracts__average__result3 () t)

(declare-fun basic_contracts__average__result4 () t)

(declare-fun basic_contracts__average__result5 () t)
...
;; H
  (assert
  (and (= basic_contracts__average__num__assume (of_int RNE2 numerator))
  (tqtisFinite (of_int RNE2 numerator))))

;; H
  (assert (= basic_contracts__average__num__assume num))

;; H
  (assert (in_range4 num))

;; H
  (assert
  (and (= basic_contracts__average__den__assume (of_int RNE2 denominator))
  (tqtisFinite (of_int RNE2 denominator))))

;; H
  (assert (= basic_contracts__average__den__assume den))

;; H
  (assert (in_range3 den))
...
;; H
  (assert (and (= o (div1 RNE2 num den)) (tqtisFinite (div1 RNE2 num den))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (le fliteral2 basic_contracts__average__result4)))
(check-sat)
