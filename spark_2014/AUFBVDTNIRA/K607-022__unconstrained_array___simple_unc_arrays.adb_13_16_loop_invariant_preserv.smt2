...
;; H
  ...
  (and
  (<= (to_rep2
      (first2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields2)))) temp___805)
  (<= temp___805 (to_rep2
                 (last4
                 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields2))))))
  (=> (<= i2 temp___805)
  (= (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields2)) temp___805) (select 
  c__split_fields temp___805))))))
...
;; H
  ...
  i2)
  (<= i2 (to_rep2
         (last4 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields2)))))))
...
;; H
  (assert (= c__split_discrs (mk___split_discrs temp___802)))

;; H
  (assert (= temp___8021 o13))

;; H
  (assert (= temp___8022 o14))
...
;; H
  (assert
  (= c__split_fields3 (mk___split_fields1 (mk___t1 temp___8021 temp___8022))))
