...
(define-fun bool_eq11 ((a (Array Int counter_range_t)) (a__first Int)
...
(define-fun bool_eq12 ((a (Array Int Bool)) (a__first Int) (a__last Int)
...
;; H
  (assert
  (and (= o (+ total2 (to_rep2 (select counters i2)))) (in_range8
  (+ total2 (to_rep2 (select counters i2))))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= (to_rep2 (select counters 0)) total3)))
(check-sat)
