...
;; H
  ...
  (=> (and (bvule ((_ int2bv 64) 0) k) (bvule k i4))
...
;; H
  (assert
  (and
  (=> (bvule ((_ int2bv 64) 0) (bvsub range_size ((_ int2bv 64) 1)))
  (dynamic_property ((_ int2bv 64) 0) (bvsub range_size ((_ int2bv 64) 1))
  i4))
  (and (bvule ((_ int2bv 64) 0) i4)
  (bvule i4 (bvsub range_size ((_ int2bv 64) 1))))))
