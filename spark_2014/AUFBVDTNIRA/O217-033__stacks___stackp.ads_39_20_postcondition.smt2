...
(declare-fun temp___591 () (Array Int element))

(declare-fun temp___5911 () less_than_max)

(declare-fun temp___5912 () us_private)

(declare-fun temp___5913 () Int)
...
;; H
  (assert (= temp___591 o5))

;; H
  (assert (= temp___5911 o6))

;; H
  (assert (= temp___5912 o7))

;; H
  (assert (= s__attr__tag temp___5913))
...
;; H
  (assert (= temp___591 s__split_fields3))

;; H
  (assert (= temp___5911 s__split_fields4))

;; H
  (assert (= temp___5912 s__split_fields5))
...
;; WP_parameter_def
 ;; File "stackp.ads", line 36, characters 0-0
  (not
  (= (let ((temp___600 (get_model__2
                       (mk___rep
                       (mk___split_fields s__split_fields s__split_fields1
                       s__split_fields2) s__attr__tag))))
     (bool_eq3
     (let ((temp___597 (temp___239 e2)))
     (let ((temp___596 (get_model__2
                       (mk___rep
                       (mk___split_fields s__split_fields6 s__split_fields7
                       s__split_fields8) s__attr__tag))))
     (ite (= (length temp___596) 0) temp___597
     (concat1 (elts temp___596) (to_rep2 (first (rt temp___596)))
     (to_rep2 (last (rt temp___596))) temp___597 1 1))))
     (to_rep2
     (first
     (let ((temp___596 (get_model__2
                       (mk___rep
                       (mk___split_fields s__split_fields6 s__split_fields7
                       s__split_fields8) s__attr__tag))))
     (ite (= (length temp___596) 0) (mk 1 1)
     (mk (to_rep2 (first (rt temp___596)))
     (- (+ (to_rep2 (first (rt temp___596))) (+ (ite (<= (to_rep2
                                                         (first
                                                         (rt temp___596))) 
                                                (to_rep2
                                                (last (rt temp___596))))
     ...
     (- (+ (to_rep2 (first (rt temp___596))) (+ (ite (<= (to_rep2
                                                ...
                                                0) (ite (<= 1 1)
                                                   (+ (- 1 1) 1) 0))) 1))))))
     (elts temp___600) (to_rep2 (first (rt temp___600)))
     (to_rep2 (last (rt temp___600))))) true)))
(check-sat)
