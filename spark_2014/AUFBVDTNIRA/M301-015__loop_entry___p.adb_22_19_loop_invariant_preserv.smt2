...
(declare-fun o10 () (Array Int map1))
...
;; H
  (assert (= o4 (store (get (select x4 i32) i212 i222) i11 o3)))

;; H
  (assert (= o5 (set (select x4 i32) i212 i222 o4)))
...
;; H
  (assert (= o8 (store (get (select x6 i32) i212 i222) i13 o7)))

;; H
  (assert (= o9 (set (select x6 i32) i212 i222 o8)))

;; H
  (assert (= o10 (store x6 i32 o9)))
...
;; WP_parameter_def
 ;; File "p.adb", line 1, characters 0-0
  (not
  (= (bool_eq4 x7 (to_rep (first19 (mk6 (+ i32 1) 3)))
     (to_rep (last12 (mk6 (+ i32 1) 3))) x4
     (to_rep (first22 (mk7 (+ i32 1) 3)))
     (to_rep (last14 (mk7 (+ i32 1) 3)))) true)))
(check-sat)
