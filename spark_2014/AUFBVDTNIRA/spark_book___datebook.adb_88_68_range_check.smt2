...
(declare-fun o17 () description_count_type)

(declare-fun o18 () day_type)

(declare-fun o19 () month_type)

(declare-fun o20 () year_type)

(declare-fun o21 () hour_type)

(declare-fun o22 () minute_type)

(declare-fun o23 () second_type)

(declare-fun o24 () Bool)

(declare-fun o25 () (Array Int us_rep3))
...
(declare-fun event_array1 () (Array Int us_rep3))
...
;; H
  (assert (= o6 (slide temp___366 (to_rep1 (first temp___3661)) 1)))
...
;; H
  (assert
  (= (rec__datebook__event_record__description_size
     (us_split_fields7 (select event_array (int__content available8)))) 
  o8))
...
;; H
  (assert
  (= o25 (store event_array (int__content available8) (mk___rep3
                                                      (mk___split_fields3 
                                                      o16 o17
                                                      (mk___rep2
                                                      (mk___split_fields2
...
;; H
  (assert (= result5 (mk_map__ref1 event_array)))

;; H
  (assert (= event_array1 o25))
