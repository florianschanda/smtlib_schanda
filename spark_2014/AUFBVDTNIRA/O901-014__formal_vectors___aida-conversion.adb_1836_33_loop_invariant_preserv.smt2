...
;; H
  ...
  (forall ((index4 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 1) index4)
...
;; H
  (assert (<= temp___2496 index1))

;; H
  (assert (<= index1 temp___2497))
...
;; H
  ...
  (=> (< index2 temp___2494)
  (= (select n3 temp___2494) (select n1 temp___2494)))))
  (=>
