...
;; H
  (assert
  (and (= o83 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o83 ((_ int2bv 32) 1))))
...
;; H
  (assert
  (and (= o81 (num_of_big_int m m_first o80)) (num_of_big_int__function_guard
  o81 m m_first o80)))

;; H
  (assert
  (and (= o76 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o76 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o82 (omultiply o76 o81)) (omultiply__function_guard o82 o76 o81)))

;; H
  (assert
  (and (= o84 (osubtract o82 o83)) (osubtract__function_guard o84 o82 o83)))

;; H
  (assert
  (and (= o73 (from_word32 a_msw3)) (from_word32__function_guard o73 a_msw3)))
...
;; H
  (assert
  (and (and (= o67 (base Tuple0)) (base__function_guard o67 Tuple0))
  (= o67 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o72 (oexpon o67 o71)) (oexpon__function_guard o72 o67 o71)))

;; H
  (assert
  (and (= o74 (omultiply o72 o73)) (omultiply__function_guard o74 o72 o73)))
...
;; H
  ...
  (= o66 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))
         a_first o65))
  (num_of_big_int__function_guard o66
  (mk___t a4 (mk (to_rep a__first) (to_rep a__last))) a_first o65)))

;; H
  (assert (and (= o75 (oadd o66 o74)) (oadd__function_guard o75 o66 o74)))

;; H
  (assert (and (= o85 (olt o75 o84)) (olt__function_guard o85 o75 o84)))
...
;; H
  (assert
  (and (= o61 (num_of_big_int m m_first o60)) (num_of_big_int__function_guard
  o61 m m_first o60)))
...
;; H
  (assert
  (and (= o49 (num_of_big_int m m_first o48)) (num_of_big_int__function_guard
  o49 m m_first o48)))

;; H
  (assert
  (and (= o51 (inverse o49 o50)) (inverse__function_guard o51 o49 o50)))

;; H
  (assert
  (and (= o56 (oexpon o51 o55)) (oexpon__function_guard o56 o51 o55)))
...
;; H
  (assert
  (and (= o44 (num_of_big_int c c_first o43)) (num_of_big_int__function_guard
  o44 c c_first o43)))
