...
;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50))
  (=> (= result3 true) (= (mk_map__ref1 result4) cur_board11))))
...
;; H
  (assert (and (= o2 (+ num_deleted2 1)) (in_range1 (+ num_deleted2 1))))

;; H
  (assert (= result13 (mk_int__ref num_deleted2)))

;; H
  (assert (= num_deleted3 o2))

(assert
;; WP_parameter_def
 ;; File "tetris_functional.ads", line 170, characters 0-0
  (not (= (to_rep (select (select cur_board10 from_line2) 1)) 0)))
(check-sat)
