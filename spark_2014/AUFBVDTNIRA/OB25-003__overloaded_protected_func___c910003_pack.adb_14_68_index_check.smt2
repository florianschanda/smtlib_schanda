...
;; H
  (assert (= o4 (mk___rep (mk___split_fields po po1 po2 po3))))

;; H
  (assert
  (and
  (and (= temp___2282 (tc_items_buffered o4 1))
  (tc_items_buffered__function_guard temp___2282 o4 1))
...
;; WP_parameter_def
 ;; File "c910003_pack.ads", line 6, characters 0-0
  (not (<= (to_rep1 (first temp___2281)) 1)))
(check-sat)
