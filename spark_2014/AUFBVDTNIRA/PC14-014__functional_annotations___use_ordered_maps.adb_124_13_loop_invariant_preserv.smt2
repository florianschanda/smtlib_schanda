...
;; H
  (assert
  (let ((temp___836 (keys (mk___rep s1__split_discrs s1__split_fields4))))
...
;; H
  (assert
  (and (= temp___8261 (next s2 (mk___rep1 cu__split_fields4)))
...
;; H
  (assert (= cu__split_fields3 (mk___split_fields1 temp___826)))
