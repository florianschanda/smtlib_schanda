...
(declare-fun temp___903 () (Array Int octet))

(declare-fun temp___9031 () t1)
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___9021)) (to_rep2 (last7 temp___9021))) 
  temp___9031))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 84, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first2 temp___9031)) (to_rep2 (last4 temp___9031)))
     (+ (- (to_rep2 (last4 temp___9031)) (to_rep2 (first2 temp___9031))) 1)
