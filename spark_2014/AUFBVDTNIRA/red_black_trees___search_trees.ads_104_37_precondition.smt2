...
;; H
  (assert
  (=> (not (= (int__content i14) 0)) (= o35 (select temp___1438 o34))))
...
;; H
  ...
  (=> (= result21 true)
  (and
  (and (= result20 (is_add__2 o29 v o30)) (is_add__2__function_guard 
  result20 o29 v o30))
  (= (= result20 true)
  (and
