...
;; H
  (assert (=> (<= initial_bit_rate1 remaining_bits2) (= o22 (elts data))))

;; H
  (assert
  (=> (<= initial_bit_rate1 remaining_bits2)
  (= temp___833 (mk___t6 o22 (mk6 r91s r92s)))))
...
;; H
  (assert (=> (<= initial_bit_rate1 remaining_bits2) (= offset4 o24)))
...
;; H
  (assert
  (=> (<= initial_bit_rate1 remaining_bits2) (= remaining_bytes4 o25)))
...
;; H
  (assert
  (=> (<= initial_bit_rate1 remaining_bits2) (= remaining_bits4 o26)))
