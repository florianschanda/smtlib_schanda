...
;; H
  (assert
  (and (= temp___1579 (+ (to_rep1 (first (rt source))) 6)) (in_range1
...
;; H
  (assert
  (and (= temp___1580 (+ (to_rep1 (first (rt source))) 5)) (in_range1
...
;; H
  (assert
  (and (= temp___1581 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1581)
  (<= temp___1581 (to_rep1 n__last))))

;; H
  (assert (= o40 temp___1581))
