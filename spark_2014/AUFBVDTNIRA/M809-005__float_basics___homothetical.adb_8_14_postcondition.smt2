...
(declare-fun homothetical__adjust2triangle__result () t)
...
(declare-fun homothetical__adjust2triangle__result1 () t)

(declare-fun result2 () t)

(declare-fun homothetical__adjust2triangle__result2 () t)

(declare-fun homothetical__adjust2triangle__result3 () t)

(declare-fun homothetical__adjust2triangle__result4 () t)

(declare-fun homothetical__adjust2triangle__result5 () t)

(declare-fun homothetical__adjust2triangle__result6 () t)

(declare-fun homothetical__adjust2triangle__result7 () t)

(declare-fun homothetical__adjust2triangle__result8 () t)
...
;; H
  (assert (and (= o (mul RNE1 kv kv)) (tqtisFinite (mul RNE1 kv kv))))

;; H
  (assert (= o1 (div1 RNE1 o ka)))
...
;; H
  (assert
  (=> (= result true)
  (and (= o3 (mul RNE1 (abs1 d) ka)) (tqtisFinite (mul RNE1 (abs1 d) ka)))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (lt fliteral2 homothetical__adjust2triangle__result7)))
(check-sat)
