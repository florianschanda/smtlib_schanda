...
;; H
  (assert (and (= o57 o56) (in_range12 o56)))
...
;; H
  (assert (and (= o59 o58) (in_range12 o58)))

;; H
  (assert (and (= o60 o59) (in_range8 o59)))

;; H
  (assert (= result24 (mk_int__ref numberlogentries)))

;; H
  (assert (= numberlogentries1 o60))

;; H
  (assert (= result25 (mk_int__ref auditalarm)))
...
;; H
  (assert (= usedlogfiles__split_fields49 usedlogfiles__split_fields47))
...
;; H
  (assert (= usedlogfiles__split_fields50 usedlogfiles__split_fields48))
...
;; H
  ...
  (= o61 (- (to_rep3
            (rec__auditlog__logfilelistt__length
            (us_split_fields__content usedlogfiles__split_fields49))) 1))
  (in_range8
  (- (to_rep3
     (rec__auditlog__logfilelistt__length
     (us_split_fields__content usedlogfiles__split_fields49))) 1))))
...
;; H
  (assert (and (= o63 o62) (in_range12 o62)))

;; H
  (assert
  (= o64 (+ o63 (to_rep2
                (select (map__content1 logfileentries1) (int__content
                                                        currentlogfile5))))))
