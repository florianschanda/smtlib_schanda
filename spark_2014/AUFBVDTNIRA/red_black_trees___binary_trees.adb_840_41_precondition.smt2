...
(declare-fun temp___2306 () (Array Int us_rep1))
...
;; H
  (assert (= o77 (select temp___2307 o76)))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2306 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2306 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___2306 (model__
                 (mk___rep2
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) o71))
  (model____function_guard temp___2306
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  o71))
  (and (dynamic_invariant3 temp___2306 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2306 o71))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2306 o71)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o71))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2306 (parent
                              ...
                              f_old__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2306 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2306 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2306 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2306 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2306 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2306 j)))) true))
  (= j i1))))))))))))))
...
;; H
  (assert (= o73 (select temp___2306 o72)))
