...
(declare-fun stackp__get_model__3__result () (Array Int element))

(declare-fun stackp__get_model__3__result1 () t1)
...
(declare-fun stackp__get_model__3__result2 () (Array Int element))

(declare-fun stackp__get_model__3__result3 () t1)

(declare-fun stackp__get_model__3__result4 () (Array Int element))

(declare-fun stackp__get_model__3__result5 () t1)

(declare-fun stackp__get_model__3__result6 () (Array Int element))

(declare-fun stackp__get_model__3__result7 () t1)

(declare-fun stackp__get_model__3__result8 () (Array Int element))

(declare-fun stackp__get_model__3__result9 () t1)

(declare-fun stackp__get_model__3__result10 () (Array Int element))

(declare-fun stackp__get_model__3__result11 () t1)

(define-fun stackp__get_model__3__result12 () us_t1 (mk___t1
                                                    stackp__get_model__3__result2
                                                    stackp__get_model__3__result3))

(declare-fun result3 () (Array Int element))

(declare-fun result4 () t1)
...
;; H
  (assert
  (= (mk___t1 stackp__get_model__3__result6 stackp__get_model__3__result7) 
  stackp__get_model__3__result12))
...
;; H
  (assert
  (=> (= result true)
  (= o (rec__stackp__stack_root__content1 (us_split_fields3 s)))))

;; H
  (assert (=> (= result true) (= o temp___663)))

;; H
  (assert
  (=> (= result true) (= (mk3 1 stackp__get_model__3__R84s) temp___6631)))
...
;; H
  (assert
  (=> (= result true)
  (= o1 (rec__stackp__stack_root__content1 (us_split_fields3 s)))))

;; H
  (assert (=> (= result true) (= o1 temp___662)))
...
;; H
  (assert
  (=> (= result true) (dynamic_property1 1 2147483647
  (to_rep1 (first temp___6641)) (to_rep1 (last temp___6641)))))

;; H
  (assert (=> (= result true) (= temp___664 o9)))

;; H
  (assert
  (=> (= result true)
  (= (mk1 (to_rep1 (first temp___6641)) (to_rep1 (last temp___6641))) 
  o10)))
...
;; H
  (assert
  (=> (not (= result true))
  (= o8 (rec__stackp__stack_root__content1 (us_split_fields3 s)))))

;; H
  (assert (=> (not (= result true)) (= o8 temp___667)))
...
;; H
  (assert
  (=> (not (= result true)) (dynamic_property1 1 2147483647
  (to_rep1 (first10 temp___6671)) (to_rep1 (last12 temp___6671)))))

;; H
  (assert (=> (not (= result true)) (= temp___667 o9)))

;; H
  (assert
  (=> (not (= result true))
  (= (mk1 (to_rep1 (first10 temp___6671)) (to_rep1 (last12 temp___6671))) 
  o10)))
...
;; H
  (assert
  (= (mk_model____ref
     (mk___t1 stackp__get_model__3__result8 stackp__get_model__3__result9)) 
  (mk_model____ref
  (mk___t1 stackp__get_model__3__result4 stackp__get_model__3__result5))))
...
;; H
  ...
  (size
  (mk___rep
  (mk___split_fields (rec__stackp__stack_root__content1 (us_split_fields3 s))
  (rec__stackp__stack_root__length1 (us_split_fields3 s))
  (hide_ext__ (rec__stackp__buffer__first (us_split_fields3 s))
  (rec__ext__1 (us_split_fields3 s)))) (attr__tag1 s)))
  (mk___rep
  (mk___split_fields (rec__stackp__stack_root__content1 (us_split_fields3 s))
  (rec__stackp__stack_root__length1 (us_split_fields3 s))
  (hide_ext__ (rec__stackp__buffer__first (us_split_fields3 s))
