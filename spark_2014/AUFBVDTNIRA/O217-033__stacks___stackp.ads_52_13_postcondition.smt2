...
;; H
  (assert (=> (= result true) (= o temp___526)))

;; H
  (assert
  (=> (= result true) (= (mk3 1 stackp__get_model__3__R84s) temp___5261)))
...
;; H
  (assert (=> (= result true) (= o1 temp___525)))
...
;; H
  ...
  (to_rep1 (first temp___5271)) (to_rep1 (last temp___5271)))))

;; H
  (assert (=> (= result true) (= temp___527 o9)))

;; H
  (assert
  (=> (= result true)
  (= (mk1 (to_rep1 (first temp___5271)) (to_rep1 (last temp___5271))) 
  o10)))
...
;; H
  (assert (=> (not (= result true)) (= o8 temp___530)))
...
;; H
  ...
  (to_rep1 (first8 temp___5301)) (to_rep1 (last10 temp___5301)))))

;; H
  (assert (=> (not (= result true)) (= temp___530 o9)))

;; H
  (assert
  (=> (not (= result true))
  (= (mk1 (to_rep1 (first8 temp___5301)) (to_rep1 (last10 temp___5301))) 
  o10)))
