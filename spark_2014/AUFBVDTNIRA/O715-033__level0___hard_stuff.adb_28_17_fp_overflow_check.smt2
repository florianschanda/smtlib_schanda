...
;; H
  ...
  (and (= o2 (mul RNE1 x3 x3)) (tqtisFinite (mul RNE1 x3 x3)))))
...
;; H
  ...
  (mul RNE1 (div1 RNE1 (of_int RNE1 y) fliteral3)
  (div1 RNE1 (of_int RNE1 y) fliteral3)))))))
...
;; H
  (assert (and (= o3 (mul RNE1 x4 x4)) (tqtisFinite (mul RNE1 x4 x4))))

;; H
  (assert (= o4 (sub RNE1 x4 o3)))
