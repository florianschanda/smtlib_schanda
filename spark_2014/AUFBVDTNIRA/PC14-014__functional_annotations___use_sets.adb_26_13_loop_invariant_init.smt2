...
;; H
  (assert
  (and (= (length (mk___rep r__split_discrs r__split_fields2)) 0)
  (= (is_empty1 (model__ (mk___rep r__split_discrs r__split_fields2))) true)))
...
;; WP_parameter_def
 ;; File "use_sets.ads", line 6, characters 0-0
  (not
  (= (contains (model__ (mk___rep r__split_discrs r__split_fields2))
