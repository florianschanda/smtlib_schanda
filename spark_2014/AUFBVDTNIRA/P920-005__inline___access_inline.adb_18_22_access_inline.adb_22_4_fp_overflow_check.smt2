...
(define-fun dynamic_invariant ((temp___expr_172 t) (temp___is_init_169 Bool)
  (temp___skip_constant_170 Bool)
  (temp___do_toplevel_171 Bool)) Bool (=>
                                      (or (= temp___is_init_169 true) (le
                                      (neg fliteral1) fliteral1)) (in_range1
                                      temp___expr_172)))

(declare-fun c_2pi_in_degrees () t)
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 360.0)))
...
(declare-fun to_rep (t_angle_360) t)

(declare-fun of_rep (t) t_angle_360)
...
(declare-fun access_inline__angle__aggregate_def (t) (Array Int t_angle_360))
...
;; c_2pi_in_degrees__def_axiom
  (assert (= c_2pi_in_degrees fliteral3))

(define-fun dynamic_invariant1 ((temp___expr_178 t) (temp___is_init_175 Bool)
  (temp___skip_constant_176 Bool)
  (temp___do_toplevel_177 Bool)) Bool (=>
                                      (or (= temp___is_init_175 true) (le
...
;; H
  (assert (= angle1 (access_inline__angle__aggregate_def fliteral2)))
...
;; WP_parameter_def
 ;; File "access_inline.adb", line 1, characters 0-0
  (not (tqtisFinite
  (sub RNE1 (to_rep (select angle1 3)) (to_rep (select angle1 3))))))
(check-sat)
