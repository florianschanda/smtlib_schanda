...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2391 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2391 (parent
                      (mk___rep2
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2392 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2392 (parent
                      (mk___rep2
...
;; H
  ...
  (model____function_guard temp___2391
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  o7))
  (and (dynamic_invariant3 temp___2391 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2391 o7))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2391 o7)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o7))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2391 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2391 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2391 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2391 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2391 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2391 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o8 (select temp___2391 i)))
...
;; H
  ...
  (= temp___2392 (model__
                 (mk___rep2
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) o1))
  (model____function_guard temp___2392
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  o1))
  (and (dynamic_invariant3 temp___2392 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2392 o1))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2392 o1)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o1))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2392 (parent
                              ...
                              f_old__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2392 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2392 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2392 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2392 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2392 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2392 j)))) true))
  (= j i1)))))))))))))))

;; H
  (assert (=> (= result2 true) (= o2 (select temp___2392 i))))
