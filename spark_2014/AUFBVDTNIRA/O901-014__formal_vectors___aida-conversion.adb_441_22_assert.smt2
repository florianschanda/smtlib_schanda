...
;; H
  (assert
  (and (= temp___1536 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1536)
  (<= temp___1536 (to_rep1 n__last))))

;; H
  (assert (= o33 temp___1536))
