...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o15) i1))) true)
  (ite (and (not (= x1 0))
       (= (ole1
          (rec__tree_model__path_type__a
          (us_split_fields1
...
;; H
  (assert
  (forall ((i1 Int)) (parent__function_guard
  (parent (rec__search_trees__search_tree__struct t__split_fields10) i1)
  (rec__search_trees__search_tree__struct t__split_fields10) i1)))
...
;; H
  ...
  (select (model__
          (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2))
          (to_rep1 (rec__search_trees__search_tree__root t__split_fields10))) i1)))))))))
