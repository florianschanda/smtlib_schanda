...
(define-fun dynamic_invariant2 ((temp___expr_313 (_ BitVec 16))
...
(declare-fun last5 (t1) tdigit_count_typeB)
...
(define-fun dynamic_invariant5 ((temp___expr_709 us_rep1)
...
(define-fun default_initial_assumption ((temp___expr_712 us_rep1)
  (temp___skip_top_level_713 Bool)) Bool (= (to_rep1
                                            (rec__very_longs__very_long__length
                                            (us_split_discrs2
                                            temp___expr_712))) (+ (to_rep1
                                                                  (rec__very_longs__very_long__length
                                                                  (us_split_discrs1
                                                                  dividend))) 1)))
...
(declare-fun last8 (t2) tdigit_count_typeB)
...
(define-fun dynamic_invariant6 ((temp___expr_721 us_rep2)
...
(define-fun default_initial_assumption1 ((temp___expr_724 us_rep2)
  (temp___skip_top_level_725 Bool)) Bool (= (to_rep1
                                            (rec__very_longs__very_long__length
                                            (us_split_discrs3
                                            temp___expr_724))) (to_rep1
                                                               (rec__very_longs__very_long__length
                                                               (us_split_discrs1
                                                               divisor)))))
...
;; H
  (assert (dynamic_property2 1 last3 r125b))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b))
  (= temp___1281 carry1)))
...
;; H
  ...
  true true) (and (<= 1 divisor_index2) (<= divisor_index2 r125b)))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= product3 o5)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= carry3 o6)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= o21 o20)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= o25 o26)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= o28 o26)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= o29 o27)))
...
;; H
  (assert
  (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r125b)))
