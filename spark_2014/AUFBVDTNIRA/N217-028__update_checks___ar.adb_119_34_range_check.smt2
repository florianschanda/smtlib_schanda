...
;; def_axiom
  (assert
  (forall ((temp___273 (Array Int et1)))
  ...
  (ite (and (<= temp___274 temp___277) (<= temp___277 temp___275))
  (= (select temp___272 temp___277) (of_rep temp___276))
  (= (select temp___272 temp___277) (select temp___273 temp___277))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.adb", line 106, characters 0-0
  (not (in_range (+ j 1))))
(check-sat)
