...
(declare-datatypes ()
((salary__ref (mk_salary__ref (salary__content tmoneyB)))))
(define-fun salary__ref___projection ((a salary__ref)) tmoneyB (salary__content
                                                               a))

(define-fun dynamic_invariant ((temp___expr_147 tmoneyB)
  (temp___is_init_144 Bool) (temp___skip_constant_145 Bool)
  (temp___do_toplevel_146 Bool)) Bool (=>
                                      (or (= temp___is_init_144 true)
                                      (<= first 9999999999))
                                      (dynamic_property first 9999999999
                                      (to_fixed2 temp___expr_147))))

;; first__def_axiom
  (assert
  (= first (to_fixed1 (of_fixed1 (of_real1 (- (/ 9999999999.0 100.0)))))))

(declare-fun init_stash () money)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun init_pocket () money)

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun default_salary () tmoneyB)
...
;; init_stash__def_axiom
  (assert (= init_stash (of_fixed1 1000000)))

;; init_pocket__def_axiom
  (assert (= init_pocket (of_fixed1 0)))

;; default_salary__def_axiom
  (assert (= default_salary (of_fixed2 0)))

(declare-fun default_v () volt)

(declare-fun o () volt)

(declare-fun result () volt)

(declare-fun default_v1 () volt)
...
;; H
  (assert
  (<= (to_fixed1 (of_fixed1 (of_real1 (- (/ 9999999999.0 100.0))))) 9999999999))

(assert
;; WP_parameter_def
 ;; File "pack.ads", line 14, characters 0-0
  (not
  (<= (- 999999999999999) (to_fixed1
                          (of_fixed1 (of_real1 (- (/ 9999999999.0 100.0))))))))
(check-sat)
