...
;; H
  (assert
  (forall ((ib3 Int)) (is_perm__function_guard
  (is_perm (remove a ia) (remove b ib3)) (remove a ia) (remove b ib3))))
...
;; H
  (assert
  (forall ((ia1 Int)) (remove__function_guard (remove o9 ia1) o9 ia1)))

;; H
  (assert
  (forall ((ib3 Int)) (remove__function_guard (remove o8 ib3) o8 ib3)))
...
;; H
  (assert
  (forall ((ia1 Int) (ib3 Int)) (is_perm__function_guard
  (is_perm (remove o9 ia1) (remove o8 ib3)) (remove o9 ia1) (remove o8 ib3))))
...
;; H
  (assert
  (=> (= result2 true)
  (and (and (= o8 (remove b o2)) (remove__function_guard o8 b o2))
...
;; H
  (assert
  (=> (= result2 true)
  (and (and (= o9 (remove a ia)) (remove__function_guard o9 a ia))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (and (= result1 (is_perm o9 o8)) (is_perm__function_guard result1 o9 o8))
  (= (= result1 true)
  ...
  (= (is_perm (remove o9 ia1) (remove o8 ib3)) true)))))))))))
...
;; H
  (assert
  (forall ((kb1 Int)) (is_perm__function_guard
  (is_perm (remove a ia) (remove b kb1)) (remove a ia) (remove b kb1))))
