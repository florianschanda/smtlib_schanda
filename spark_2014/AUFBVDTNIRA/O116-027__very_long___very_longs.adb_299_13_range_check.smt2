...
;; def_axiom
  (assert
  (forall ((temp___965 (_ BitVec 8)))
  (forall ((temp___966 Int) (temp___967 Int))
  (let ((temp___964 (temp___963 temp___965 temp___966 temp___967)))
  (and
  (=> (dynamic_property6 1 65536 temp___966 temp___967)
  (and (= (first5 temp___964) temp___966) (= (last8 temp___964) temp___967)))
  (forall ((temp___968 Int))
  (= (select (to_array2 temp___964) temp___968) (of_rep1 temp___965))))))))
