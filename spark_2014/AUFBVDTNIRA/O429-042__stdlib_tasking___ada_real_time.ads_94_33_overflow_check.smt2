...
(declare-fun to_duration (us_rep) duration)

(declare-fun to_duration__function_guard (duration us_rep) Bool)
...
(declare-fun o2 () duration)

(declare-fun o3 () Int)

(declare-fun o4 () duration)
...
;; H
  (assert
  (and (= o (to_duration right)) (to_duration__function_guard o right)))
...
;; H
  (assert
  (and (= o2 (to_duration right)) (to_duration__function_guard o2 right)))

;; H
  (assert (= o3 (to_fixed o2)))

;; H
  (assert (= result1 (ite (< 0 o3) true false)))
...
;; H
  (assert
  (and (= o4 (to_duration right)) (to_duration__function_guard o4 right)))

;; H
  (assert (= o5 (to_fixed o4)))

;; H
  (assert (= o6 (+ (- 9223372036854775808) o5)))
