...
;; H
  (assert (= o24 (+ last2 o23)))

;; H
  (assert (= o25 (- o24 cur_position)))

;; H
  (assert (= result20 (ite (= (int__content last14) o25) true false)))
...
;; WP_parameter_def
 ;; File "textio.adb", line 102, characters 0-0
  (not (= (has_char_in_slice eof_ch cur_position o21 the_file) true)))
(check-sat)
