...
(define-fun tint_arrayD1__ref_26__projection ((a tint_arrayD1__ref)) integer 
...
(define-fun tint_arrayT__ref_26__projection ((a tint_arrayT__ref)) us_t1 
...
(declare-datatypes ()
((t811b__ref (mk_t811b__ref (t811b__content integer)))))
(define-fun t811b__ref___projection ((a t811b__ref)) integer (t811b__content
                                                             a))
...
(define-fun tnumber_array_typeD1__ref_35__projection ((a tnumber_array_typeD1__ref)) integer 
...
(define-fun number_array_type__ref_35__projection ((a number_array_type__ref)) us_t3 
...
(declare-datatypes ()
((t815b__ref (mk_t815b__ref (t815b__content integer)))))
(define-fun t815b__ref___projection ((a t815b__ref)) integer (t815b__content
                                                             a))
...
(declare-datatypes ()
((t817b__ref (mk_t817b__ref (t817b__content integer)))))
(define-fun t817b__ref___projection ((a t817b__ref)) integer (t817b__content
                                                             a))
...
(define-fun tint_arrayB__ref_26__projection ((a tint_arrayB__ref)) us_t5 
  (tint_arrayB__content a))

(declare-fun aida__conversion__calculate_negative_target_length_3__int_array__aggregate_def (Int
  Int Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___2764 Int) (temp___2765 Int) (temp___2766 Int)
  (temp___2767 Int))
  (let ((temp___2763 (aida__conversion__calculate_negative_target_length_3__int_array__aggregate_def
                     temp___2764 temp___2765 temp___2766 temp___2767)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 2)
  temp___2766 temp___2767)
  (and (= (first7 temp___2763) temp___2766)
  (= (last7 temp___2763) temp___2767)))
  (and
  (= (select (to_array2 temp___2763) (+ (+ (first1 source) 1) 0)) (of_rep1
                                                                  temp___2764))
  (= (select (to_array2 temp___2763) (+ (+ (first1 source) 1) 1)) (of_rep1
                                                                  temp___2765)))))))
...
(define-fun tnumber_array_typeB__ref_35__projection ((a tnumber_array_typeB__ref)) us_t6 
  (tnumber_array_typeB__content a))

(declare-fun aida__conversion__calculate_negative_target_length_3__n__aggregate_def (Int
  Int Int) us_t4)

;; def_axiom
  (assert
  (forall ((temp___2773 Int) (temp___2774 Int) (temp___2775 Int))
  (let ((temp___2772 (aida__conversion__calculate_negative_target_length_3__n__aggregate_def
                     temp___2773 temp___2774 temp___2775)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 2)
  temp___2774 temp___2775)
  (and (= (first13 temp___2772) temp___2774)
  (= (last13 temp___2772) temp___2775)))
  (forall ((temp___2776 Int))
  (= (select (to_array4 temp___2772) temp___2776) (of_rep1 temp___2773)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_957 us_t3)
  (temp___is_init_954 Bool) (temp___skip_constant_955 Bool)
  (temp___do_toplevel_956 Bool)) Bool (=>
                                      (not (= temp___skip_constant_955 true))
                                      (and (dynamic_property6
                                      (+ (first1 source) 1)
                                      (+ (first1 source) 2)
                                      (first10 temp___expr_957)
                                      (last10 temp___expr_957))
                                      (and
                                      (= (first10 temp___expr_957) (+ 
                                      (first1 source) 1))
                                      (= (last10 temp___expr_957) (+ 
...
(declare-fun temp___2770 () (Array Int integer))

(declare-fun temp___27701 () t2)

(declare-fun aida__conversion__calculate_negative_target_length_3__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_length_3__int_array__assume1 () t1)

(declare-fun temp___2778 () (Array Int integer))

(declare-fun temp___27781 () t4)

(declare-fun aida__conversion__calculate_negative_target_length_3__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_length_3__n__assume1 () t3)

(declare-fun temp___2784 () Int)

(declare-fun temp___2785 () Int)

(declare-fun temp___2783 () Int)

(declare-fun temp___2781 () (Array Int integer))
...
;; H
  ...
  (<= index7 (+ (to_rep1 (first (rt source))) 2)))
...
;; H
  ...
  (= (to_rep1
     (first6
     (rt2
     (aida__conversion__calculate_negative_target_length_3__int_array__aggregate_def
     9 9 (+ (to_rep1 (first (rt source))) 1)
     (+ (+ (to_rep1 (first (rt source))) 1) 1))))) (+ (to_rep1
                                                      (first (rt source))) 1)))
...
;; H
  (assert
  (= (mk___t2 temp___2770 temp___27701) (aida__conversion__calculate_negative_target_length_3__int_array__aggregate_def
                                        9 9
                                        (+ (to_rep1 (first (rt source))) 1)
                                        (+ (+ (to_rep1 (first (rt source))) 1) 1))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___27701)) (to_rep1 (last6 temp___27701)))
     (+ (- (to_rep1 (last6 temp___27701)) (to_rep1 (first6 temp___27701))) 1)
...
;; H
  (assert
  (= (slide1 temp___2770 (to_rep1 (first6 temp___27701))
     (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_3__int_array__assume))

;; H
  (assert
  (= (mk1 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 2)) aida__conversion__calculate_negative_target_length_3__int_array__assume1))
...
;; H
  (assert
  (= int_array1 aida__conversion__calculate_negative_target_length_3__int_array__assume))
...
;; H
  ...
  (+ (to_rep1 (first (rt source))) 2) (to_rep1 int_array__first)
  (to_rep1 int_array__last))
  (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 1))
  (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 2)))))
...
;; H
  ...
  (= (to_rep1
     (first12
     (rt4
     (aida__conversion__calculate_negative_target_length_3__n__aggregate_def
     0 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 2))))) (+ (to_rep1 (first (rt source))) 1)))
...
;; H
  ...
  (= (to_rep1
     ...
     (aida__conversion__calculate_negative_target_length_3__n__aggregate_def
     0 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 2))))) (+ (to_rep1 (first (rt source))) 2)))

;; H
  (assert
  (= (mk___t4 temp___2778 temp___27781) (aida__conversion__calculate_negative_target_length_3__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 1)
                                        (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___27781)) (to_rep1
                                               (last12 temp___27781)))
     (+ (- (to_rep1 (last12 temp___27781)) (to_rep1 (first12 temp___27781))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1
                                                        (first (rt source))) 2))
        (+ (- (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1
                                                     (first (rt source))) 1)) 1)
...
;; H
  (assert
  (= (slide1 temp___2778 (to_rep1 (first12 temp___27781))
     (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_3__n__assume))

;; H
  (assert
  (= (mk3 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 2)) aida__conversion__calculate_negative_target_length_3__n__assume1))
...
;; H
  (assert
  (= n1 aida__conversion__calculate_negative_target_length_3__n__assume))

;; H
  (assert
  (= (to_rep1 n__first) (to_rep1
                        (first9
                        aida__conversion__calculate_negative_target_length_3__n__assume1))))
...
;; H
  (assert
  (and (= temp___2784 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (= temp___2785 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))
...
;; H
  (assert (= index1 temp___2784))

;; H
  (assert
  (=> (and (<= temp___2784 index1) (<= index1 temp___2785))
  (= temp___2783 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2784 index1) (<= index1 temp___2785)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___2784 index1) (<= index1 temp___2785)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2784 index1) (<= index1 temp___2785)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2784 index1) (<= index1 temp___2785)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___2784 index1) (<= index1 temp___2785)) (= n2 o8)))
...
;; H
  ...
  (and
  (and
  (forall ((temp___2782 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___2782)
  (<= temp___2782 (to_rep1 n__last)))
  (=> (< index2 temp___2782)
  (= (select n3 temp___2782) (select temp___2781 temp___2782)))))
  (=>
  (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2))
...
;; H
  (assert
  (=> (and (<= temp___2784 index1) (<= index1 temp___2785)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___2784 index1) (<= index1 temp___2785)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___2784 index1) (<= index1 temp___2785)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___2784 index1) (<= index1 temp___2785)))
...
;; H
  (assert
  (=> (not (and (<= temp___2784 index1) (<= index1 temp___2785))) (= n7 n1)))
...
(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 2177, characters 0-0
