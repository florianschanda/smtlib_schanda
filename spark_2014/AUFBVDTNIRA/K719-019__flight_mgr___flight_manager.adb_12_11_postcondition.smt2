...
;; H
  (assert
  (=> (lt distance_to_target fliteral2)
  (and (= o (mul RNE1 f distance_to_target)) (tqtisFinite
  (mul RNE1 f distance_to_target)))))

;; H
  (assert
  (=> (lt distance_to_target fliteral2) (= o1 (div1 RNE1 o fliteral2))))

;; H
  (assert
  (=> (lt distance_to_target fliteral2) (= (mk_t__ref result) (mk_t__ref f))))

;; H
  (assert (=> (lt distance_to_target fliteral2) (= f2 o1)))

;; H
  (assert (=> (not (lt distance_to_target fliteral2)) (= f2 f)))

;; H
  (assert (=> (not (lt distance_to_target fliteral2)) (= f2 f1)))
...
;; WP_parameter_def
 ;; File "flight_manager.ads", line 3, characters 0-0
  (not (eq f3 (div1 RNE1 (mul RNE1 f distance_to_target) fliteral2))))
(check-sat)
