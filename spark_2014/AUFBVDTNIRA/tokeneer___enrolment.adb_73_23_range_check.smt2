...
(declare-fun temp___1057 () (Array Int character))

(declare-fun temp___10571 () t)
...
(declare-fun enrolment__validate__makedescription__thedesc__assume () (Array Int character))

(declare-fun enrolment__validate__makedescription__thedesc__assume1 () t)
...
;; H
  (assert
  (= (concat1 (temp___String_Literal_152 Tuple0) 1 31
...
;; H
  (assert
  (=> (= (length (mk___t temp___1055 temp___10551)) 0)
  (= (temp___String_Literal_155 Tuple0) temp___1057)))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1055 temp___10551)) 0))
  (=> (<= 1 3) (= o6 (+ (- 3 1) 1)))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1055 temp___10551)) 0))
  (= o9 (+ (to_rep1 (first temp___10551)) o8))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1055 temp___10551)) 0))
  (= (concat1 temp___1055 (to_rep1 (first temp___10551))
     (to_rep1 (last temp___10551)) (temp___String_Literal_155 Tuple0) 1 3) 
  temp___1057)))

;; H
  (assert
  (=> (not (= (length (mk___t temp___1055 temp___10551)) 0))
  (= (mk (to_rep1 (first temp___10551)) o11) temp___10571)))

;; H
  (assert
  (=> (= (length (mk___t temp___1057 temp___10571)) 0)
  (= (elts detail) enrolment__validate__makedescription__thedesc__assume)))

;; H
  (assert
  (=> (= (length (mk___t temp___1057 temp___10571)) 0)
  (= (mk (to_rep1 (first (rt detail))) (to_rep1 (last (rt detail)))) 
  enrolment__validate__makedescription__thedesc__assume1)))

;; H
  (assert
  (=> (not (= (length (mk___t temp___1057 temp___10571)) 0))
  (=> (<= (to_rep1 (first (rt detail))) (to_rep1 (last (rt detail))))
  (= o12 (+ (- (to_rep1 (last (rt detail))) (to_rep1 (first (rt detail)))) 1)))))

;; H
  (assert
  (=> (not (= (length (mk___t temp___1057 temp___10571)) 0))
  (=> (not (<= (to_rep1 (first (rt detail))) (to_rep1 (last (rt detail)))))
  (= o12 0))))

;; H
  (assert
  (=> (not (= (length (mk___t temp___1057 temp___10571)) 0))
  (=> (<= (to_rep1 (first temp___10571)) (to_rep1 (last temp___10571)))
  (= o13 (+ (- (to_rep1 (last temp___10571)) (to_rep1 (first temp___10571))) 1)))))

;; H
  (assert
  (=> (not (= (length (mk___t temp___1057 temp___10571)) 0))
  (=> (not (<= (to_rep1 (first temp___10571)) (to_rep1 (last temp___10571))))
  (= o13 0))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1057 temp___10571)) 0))
  (= o15 (+ (to_rep1 (first temp___10571)) o14))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1057 temp___10571)) 0))
  (= (concat1 temp___1057 (to_rep1 (first temp___10571))
     (to_rep1 (last temp___10571)) (elts detail)
     (to_rep1 (first (rt detail))) (to_rep1 (last (rt detail)))) enrolment__validate__makedescription__thedesc__assume)))

;; H
  (assert
  (=> (not (= (length (mk___t temp___1057 temp___10571)) 0))
  (= (mk (to_rep1 (first temp___10571)) o17) enrolment__validate__makedescription__thedesc__assume1)))

;; H
  (assert
  (= (mk___t enrolment__validate__makedescription__thedesc__assume
     enrolment__validate__makedescription__thedesc__assume1) thedesc))

;; H
  (assert (dynamic_invariant1 thedesc true false true))

;; H
  (assert (not (< (to_rep1 (last (rt thedesc))) 150)))
...
;; WP_parameter_def
 ;; File "audittypes.ads", line 92, characters 0-0
  (not (<= (to_rep1 (first (rt thedesc))) 1)))
(check-sat)
