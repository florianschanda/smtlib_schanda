...
;; def_axiom
  ...
  (and (= (first5 temp___192) temp___194) (= (last3 temp___192) temp___195)))
...
;; WP_parameter_def
 ;; File "p.adb", line 10, characters 0-0
  (not
  (= (ite (<= (to_rep (first4 temp___1981)) (to_rep (last2 temp___1981)))
     (+ (- (to_rep (last2 temp___1981)) (to_rep (first4 temp___1981))) 1) 0) 
