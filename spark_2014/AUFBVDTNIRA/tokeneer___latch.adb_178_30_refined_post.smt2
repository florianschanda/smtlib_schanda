...
(declare-fun latchtimeout__split_fields4 () yearst)

(declare-fun latchtimeout__split_fields5 () monthst)

(declare-fun latchtimeout__split_fields6 () dayst)

(declare-fun latchtimeout__split_fields7 () millisecst)

(declare-fun latchtimeout__split_fields8 () yearst)

(declare-fun latchtimeout__split_fields9 () monthst)

(declare-fun latchtimeout__split_fields10 () dayst)

(declare-fun latchtimeout__split_fields11 () millisecst)

(declare-fun latchtimeout__split_fields12 () yearst)

(declare-fun latchtimeout__split_fields13 () monthst)

(declare-fun latchtimeout__split_fields14 () dayst)

(declare-fun latchtimeout__split_fields15 () millisecst)
...
;; H
  (assert
  (= (mk___split_fields latchtimeout__split_fields4
     latchtimeout__split_fields5 latchtimeout__split_fields6
     latchtimeout__split_fields7) (us_split_fields1 time)))
...
;; WP_parameter_def
 ;; File "latch.ads", line 120, characters 0-0
  ...
  (= (bool_eq4
     (mk___rep
     (mk___split_fields latchtimeout__split_fields8
     latchtimeout__split_fields9 latchtimeout__split_fields10
     latchtimeout__split_fields11)) time) true)))
(check-sat)
