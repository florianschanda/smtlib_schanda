...
;; range_axiom
  (assert
  (forall ((x et4)) (! (in_range3 (to_rep4 x)) :pattern ((to_rep4 x)) )))
...
;; range_axiom
  (assert
  (forall ((x enum1t)) (! (in_range4 (to_rep5 x)) :pattern ((to_rep5 x)) )))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1029, characters 0-0
  (not
  (= (bool_eq9 (mk___rep3 (us_split_fields__content3 r__split_fields7))
     (mk___rep3
     (mk___split_fields3
     (mk___rep2
     (mk___split_fields2
     (mk___rep1
     (mk___split_fields1 r__split_fields
     (mk___rep (mk___split_fields (of_rep e) r__split_fields2))
     r__split_fields3)) r__split_fields4)) r__split_fields5))) true)))
(check-sat)
