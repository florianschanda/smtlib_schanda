...
(declare-fun approx3 () t)

(declare-fun result9 () Bool)

(declare-fun approx4 () t)

(declare-fun approx5 () t)

(declare-fun approx6 () t)

(declare-fun approx7 () t)
...
;; H
  (assert
  (= o (temp___208 fliteral4 fliteral fliteral5 fliteral6 fliteral7 fliteral8
       fliteral7 fliteral6 fliteral5 fliteral)))
...
;; H
  (assert (= o1 (temp___221 fliteral4)))
...
;; H
  (assert (= o2 (temp___225 fliteral4 fliteral)))
...
;; H
  (assert (= o3 (temp___230 fliteral4 fliteral)))
...
;; H
  (assert (= (mul RNE2 fliteral9 c13b) tolerance))
...
;; H
  (assert (= approx1 (div1 RNE2 c13b fliteral5)))

;; H
  (assert
  (and (= o4 (mul RNE2 approx1 approx1)) (tqtisFinite
  (mul RNE2 approx1 approx1))))

;; H
  (assert (= o5 (sub RNE2 c13b o4)))
...
;; H
  (assert (= result7 (ite (lt tolerance o7) true false)))
...
;; H
  ...
  tolerance (abs1 (sub RNE2 c13b (mul RNE2 approx2 approx2)))))))

;; H
  (assert
  (=> (= result7 true)
  (and (= o8 (div1 RNE2 c13b approx2)) (tqtisFinite
  (div1 RNE2 c13b approx2)))))

;; H
  (assert (=> (= result7 true) (= o9 (add RNE2 approx2 o8))))

;; H
  (assert (=> (= result7 true) (and (= o10 o9) (tqtisFinite o9))))

;; H
  (assert (=> (= result7 true) (= o11 (mul RNE2 fliteral10 o10))))

;; H
  (assert (=> (= result7 true) (= approx2 result8)))

;; H
  (assert (=> (= result7 true) (= approx3 o11)))

;; H
  (assert
  (=> (= result7 true)
  (and (= o12 (mul RNE2 approx3 approx3)) (tqtisFinite
  (mul RNE2 approx3 approx3)))))

;; H
  (assert (=> (= result7 true) (= o13 (sub RNE2 c13b o12))))

;; H
  (assert (=> (= result7 true) (and (= o14 o13) (tqtisFinite o13))))

;; H
  (assert (=> (= result7 true) (= o15 (abs1 o14))))

;; H
  (assert (=> (= result7 true) (= o16 (ite (lt tolerance o15) true false))))

;; H
  (assert
  (=> (= result7 true) (= result9 (ite (not (= o16 true)) true false))))
...
;; WP_parameter_def
 ;; File "aggregates.adb", line 1, characters 0-0
  (not (tqtisFinite (add RNE2 a1 c14b1))))
(check-sat)
