...
;; H
  (assert
  (=> (= result7 true)
  (and (= o4 (div1 RNE1 c13b approx2)) (tqtisFinite
  (div1 RNE1 c13b approx2)))))

;; H
  (assert (=> (= result7 true) (= o5 (add RNE1 approx2 o4))))

;; H
  (assert (=> (= result7 true) (and (= o6 o5) (tqtisFinite o5))))

;; H
  (assert (=> (= result7 true) (= o7 (mul RNE1 fliteral10 o6))))
...
;; H
  (assert
  (=> (= result7 true)
  (and (= o8 (mul RNE1 approx3 approx3)) (tqtisFinite
  (mul RNE1 approx3 approx3)))))

;; H
  (assert (=> (= result7 true) (= o9 (sub RNE1 c13b o8))))

;; H
  (assert (=> (= result7 true) (and (= o10 o9) (tqtisFinite o9))))

;; H
  (assert (=> (= result7 true) (= o11 (abs1 o10))))

;; H
  (assert (=> (= result7 true) (= o12 (ite (lt tolerance o11) true false))))

;; H
  (assert
  (=> (= result7 true) (= result9 (ite (not (= o12 true)) true false))))
...
;; WP_parameter_def
 ;; File "aggregates.adb", line 1, characters 0-0
  (not (tqtisFinite (add RNE1 a1 c14b1))))
(check-sat)
