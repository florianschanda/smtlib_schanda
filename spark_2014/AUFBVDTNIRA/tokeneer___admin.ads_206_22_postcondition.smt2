...
(declare-fun temp___425 () privileget)

(declare-fun temp___4251 () opandnullt)
...
;; H
  (assert (= temp___425 theadmin__split_fields2))

;; H
  (assert (= temp___4251 theadmin__split_fields3))
...
(assert
;; WP_parameter_def
 ;; File "admin.ads", line 183, characters 0-0
  (not
  (not
  (= (isdoingop
     (mk___rep
