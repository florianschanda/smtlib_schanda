...
(declare-fun b () (Array Int enum_t))
...
(declare-fun b1 () (Array Int enum_t))

(declare-fun a2 () (Array Int enum_t))

(declare-fun b2 () (Array Int enum_t))

(declare-fun tmp2 () Int)

(declare-fun a3 () (Array Int enum_t))

(declare-fun b3 () (Array Int enum_t))
...
(assert
;; WP_parameter_def
 ;; File "simple_arrays.adb", line 489, characters 0-0
  (not (not (= (bool_eq1 a2 0 2 a 0 2) true))))
(check-sat)
