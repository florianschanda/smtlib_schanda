...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) v) i2)))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) v)))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) v) i2)))
...
;; H
  ...
  (= o45 (size
         (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))))
  (size__function_guard o45
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))))
  (and (in_range2 o45) (= o45 (to_rep f__split_fields)))))
...
;; H
  ...
  (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o44)
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) o44))

;; H
  (assert (parent__function_guard
  (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o44)
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) o44))
...
;; H
  ...
  (and
  (and
  (= o44 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d))
  (peek__function_guard o44
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1251 (parent
                      (mk___rep2
                      (us_split_fields__content2 f__split_fields7)) i2))))
  (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1251 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1251 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___1251 (model__
                 (mk___rep2 (us_split_fields__content2 f__split_fields7))
                 root))
  (model____function_guard temp___1251
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) root))
  (and (dynamic_invariant3 temp___1251 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___1251 (parent
                              ...
                              i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1251 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1251 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1251 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1251 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1251 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1251 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o42 (select temp___1251 i1)))
