...
(define-fun dynamic_invariant1 ((temp___expr_167 t) (temp___is_init_164 Bool)
...
;; maximum_valid_speed__def_axiom
  ...
  (m_per_s_from_km_per_h fliteral2) fliteral2)
  (= maximum_valid_speed (m_per_s_from_km_per_h fliteral2))))
...
(define-fun dynamic_invariant4 ((temp___expr_161 t) (temp___is_init_158 Bool)
...
;; m_per_s_from_km_per_h__def_axiom
  ...
  (! (=>
     ...
     speed))
     (= (m_per_s_from_km_per_h speed) (div1 RNE2 (mul RNE2 speed fliteral4)
...
;; H
  (assert
  (and (lt fliteral3 (div1 RNE2 fliteral speed2)) (lt
  (div1 RNE2 fliteral speed2) fliteral6)))

;; H
  (assert (le (neg fliteral8) (div1 RNE2 acceleration speed2)))

;; H
  (assert
  (and (= o (div1 RNE2 acceleration speed2)) (tqtisFinite
  (div1 RNE2 acceleration speed2))))

;; H
  (assert (= o1 (mul RNE2 o fliteral9)))
