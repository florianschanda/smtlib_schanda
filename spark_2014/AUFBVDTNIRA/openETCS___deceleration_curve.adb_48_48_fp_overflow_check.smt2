...
(define-fun dynamic_invariant ((temp___expr_152 t) (temp___is_init_149 Bool)
  (temp___skip_constant_150 Bool)
  (temp___do_toplevel_151 Bool)) Bool (=>
                                      (or (= temp___is_init_149 true) (le
                                      (neg fliteral1) fliteral1))
                                      (tqtisFinite temp___expr_152)))
...
(define-fun dynamic_invariant1 ((temp___expr_164 t) (temp___is_init_161 Bool)
  (temp___skip_constant_162 Bool)
  (temp___do_toplevel_163 Bool)) Bool (=>
                                      (or (= temp___is_init_161 true) (le
                                      (neg fliteral1) fliteral1))
                                      (tqtisFinite temp___expr_164)))
...
(declare-fun initial_speed () t)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun final_speed () t)

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun acceleration () t)
...
(define-fun dynamic_invariant3 ((temp___expr_51 t) (temp___is_init_48 Bool)
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral2) (= (tqtreal fliteral2) 500.0)))

;; maximum_valid_speed__def_axiom
  (assert (= maximum_valid_speed (m_per_s_from_km_per_h fliteral2)))
...
(define-fun dynamic_invariant4 ((temp___expr_158 t) (temp___is_init_155 Bool)
...
;; is_valid_speed_km_per_h__def_axiom
  ...
  (! (= (= (is_valid_speed_km_per_h speed) true)
     (and (le fliteral3 speed) (le speed fliteral2))) :pattern ((is_valid_speed_km_per_h
                                                                speed)) )))
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral4) (= (tqtreal fliteral4) 1000.0)))

(declare-fun fliteral5 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral5) (= (tqtreal fliteral5) 3600.0)))

;; m_per_s_from_km_per_h__def_axiom
  (assert
  (forall ((speed t))
  (! (=> (dynamic_invariant4 speed true true true)
     (= (m_per_s_from_km_per_h speed) (div1 RNE1 (mul RNE1 speed fliteral4)
                                      fliteral5))) :pattern ((m_per_s_from_km_per_h
                                                             speed)) )))

(declare-fun fliteral6 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral6) (= (tqtreal fliteral6) 10.0)))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral7) (/ 100000001490116119384765625.0 1000000000000000000000000000.0))))

(declare-fun fliteral8 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral8) (= (tqtreal fliteral8) 100.0)))

(declare-fun fliteral9 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral9) (= (tqtreal fliteral9) 5.0)))
...
;; H
  (assert (= (m_per_s_from_km_per_h fliteral2) maximum_valid_speed))

;; H
  (assert (tqtisFinite initial_speed))

;; H
  (assert (tqtisFinite final_speed))

;; H
  (assert (tqtisFinite acceleration))
...
;; H
  ...
  (and
  (and
  (and (and (lt fliteral3 initial_speed) (le fliteral3 final_speed)) (le
  initial_speed maximum_valid_speed)) (lt final_speed initial_speed)) (lt
  acceleration fliteral3)) (le (neg fliteral6) acceleration)))
...
;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite delta_speed)))
...
;; H
  (assert (lt final_speed speed1))

;; H
  (assert (lt fliteral7 speed1))

;; H
  (assert
  (and (le (neg fliteral6) acceleration) (lt acceleration fliteral3)))

;; H
  (assert (and (lt fliteral7 speed2) (le speed2 initial_speed)))

;; H
  (assert
  (and
  (and (=> (le (neg fliteral1) fliteral1) (tqtisFinite delta_speed1))
  (=> (<= 0 2147483647) (in_range3 distance2)))
  (=> (le (neg fliteral1) fliteral1) (tqtisFinite speed2))))

;; H
  (assert
  (and (lt fliteral3 (div1 RNE1 fliteral speed2)) (lt
  (div1 RNE1 fliteral speed2) fliteral6)))

;; H
  (assert (le (neg fliteral8) (div1 RNE1 acceleration speed2)))

;; H
  (assert
  (and (= o (div1 RNE1 acceleration speed2)) (tqtisFinite
  (div1 RNE1 acceleration speed2))))

;; H
  (assert (= o1 (mul RNE1 o fliteral9)))
