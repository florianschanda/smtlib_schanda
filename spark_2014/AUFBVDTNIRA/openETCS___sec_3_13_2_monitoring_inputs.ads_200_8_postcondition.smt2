...
(declare-fun sec_3_13_2_monitoring_inputs__kwet_rst__result () t)
...
(declare-fun sec_3_13_2_monitoring_inputs__kwet_rst__result1 () t)

(declare-fun sec_3_13_2_monitoring_inputs__kwet_rst__result2 () t)

(declare-fun sec_3_13_2_monitoring_inputs__kwet_rst__result3 () t)

(declare-fun sec_3_13_2_monitoring_inputs__kwet_rst__result4 () t)

(declare-fun sec_3_13_2_monitoring_inputs__kwet_rst__result5 () t)
...
;; H
  (assert (and (= o16 (to_int1 RNA2 v)) (in_range2 (to_int1 RNA2 v))))

;; H
  (assert
  (and
  (and (= o17 (get_value kwet_rst_model o16)) (get_value__function_guard 
  o17 kwet_rst_model o16))
  (and (tqtisFinite o17)
  (or
  (exists ((i Int))
  (and
  ...
  (<= i (- (to_rep1
           (rec__step_function__step_function_t__number_of_delimiters
           (us_split_fields3 kwet_rst_model))) 1)))
  (and
  (and
  (<= (to_rep2
      (rec__step_function__delimiter_entry__delimiter
      ...
      (select (rec__step_function__step_function_t__step
              (us_split_fields3 kwet_rst_model)) i)))) o16)
  (< o16 (to_rep2
         (rec__step_function__delimiter_entry__delimiter
         (us_split_fields1
         (select (rec__step_function__step_function_t__step
                 (us_split_fields3 kwet_rst_model)) (+ i 1)))))))
  (eq o17
  (to_rep
  (rec__step_function__delimiter_entry__value
  (us_split_fields1
  (select (rec__step_function__step_function_t__step
          (us_split_fields3 kwet_rst_model)) i))))))))
  (and
  (<= (to_rep2
      (rec__step_function__delimiter_entry__delimiter
      (us_split_fields1
      (select (rec__step_function__step_function_t__step
              (us_split_fields3 kwet_rst_model)) (to_rep1
                                                 (rec__step_function__step_function_t__number_of_delimiters
                                                 (us_split_fields3
                                                 kwet_rst_model))))))) 
  o16) (eq o17
...
;; H
  ...
  (= (mk_t__ref result) (mk_t__ref
                        sec_3_13_2_monitoring_inputs__kwet_rst__result)))

;; H
  (assert (= sec_3_13_2_monitoring_inputs__kwet_rst__result1 o17))

;; H
  (assert
  (= (mk_t__ref sec_3_13_2_monitoring_inputs__kwet_rst__result4) (mk_t__ref
                                                                 sec_3_13_2_monitoring_inputs__kwet_rst__result2)))
...
;; H
  (assert (= result1 sec_3_13_2_monitoring_inputs__kwet_rst__result4))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (eq sec_3_13_2_monitoring_inputs__kwet_rst__result4
  (get_value kwet_rst_model (to_int1 RNA2 v)))))
(check-sat)
