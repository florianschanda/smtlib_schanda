...
;; H
  (assert (= (mk_t__ref result) (mk_t__ref min1)))
...
;; H
  ...
  (rec__step_function__delimiter_entry__value
  (us_split_fields1
  (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j)))))))))
...
;; H
  ...
  (=> (le (neg fliteral1) fliteral1) (tqtisFinite min3)))
  (and (<= 0 i2) (<= i2 r10b))))
