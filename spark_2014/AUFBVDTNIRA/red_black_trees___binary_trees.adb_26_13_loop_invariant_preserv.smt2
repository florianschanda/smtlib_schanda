...
;; H
  (assert
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (- i2 1))) (= (contains s1 j) true))))

;; H
  (assert
  (forall ((j Int))
  (=> (and (in_range2 j) (= (contains s1 j) true)) (< j i2))))
...
;; H
  ...
  (and (= o (add s1 i2))
  (and
  (and (and (= (length o) (+ (length s1) 1)) (= (contains o i2) true))
  (= (ole s1 o) true)) (= (included_except o s1 i2) true))))
