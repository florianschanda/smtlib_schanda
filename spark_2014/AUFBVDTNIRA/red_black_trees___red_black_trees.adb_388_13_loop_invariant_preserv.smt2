...
;; H
  ...
  (parent
  (rec__red_black_trees__rbt__struct
  (us_split_fields__content4 t__split_fields32)) i)
  (rec__red_black_trees__rbt__struct
  (us_split_fields__content4 t__split_fields32)) i))
...
;; H
  ...
  (= (parent
     (rec__red_black_trees__rbt__struct
     (us_split_fields__content4 t__split_fields32)) i) 0)
  (= (to_rep3
     (select (rec__red_black_trees__rbt__color
             (us_split_fields__content4 t__split_fields32)) (parent
                                                            (rec__red_black_trees__rbt__struct
