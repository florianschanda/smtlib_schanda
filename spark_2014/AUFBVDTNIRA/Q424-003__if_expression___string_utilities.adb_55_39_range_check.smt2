...
;; H
  ...
  (=> (or (<= x24 temp___295) (not (= x12 temp___294)))
...
;; H
  ...
  (not (= (to_rep (select (elts s1) x12)) (to_rep (select (elts s2) x24))))
  (and
  (and (= o12 (get_length x12 o11 lengths3)) (get_length__function_guard 
  o12 x12 o11 lengths3))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (dynamic_property1 first2 last2 last2)))
(check-sat)
