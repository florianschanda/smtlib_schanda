...
(declare-fun temp___9701 () t2)

(declare-fun temp___971 () (Array Int octet))

(declare-fun temp___9711 () t1)
...
(declare-fun temp___974 () digit_index_type)

(declare-fun temp___9741 () (Array Int octet))

(declare-fun temp___9742 () t1)
...
;; H
  (assert
  (= (mk___t2 temp___970 temp___9701) (temp___963 ((_ int2bv 8) 0) 1
                                      (to_rep
                                      (rec__very_longs__very_long__length
                                      (us_split_discrs1 l))))))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___9701)) (to_rep2 (last7 temp___9701)))
     (+ (- (to_rep2 (last7 temp___9701)) (to_rep2 (first4 temp___9701))) 1)
     0) (ite (<= 1 (to_rep
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___9701)) (to_rep2 (last7 temp___9701))) 
  temp___9711))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___9711)) (to_rep2 (last4 temp___9711)))
     (+ (- (to_rep2 (last4 temp___9711)) (to_rep2 (first2 temp___9711))) 1)
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___9741 temp___9742))))
