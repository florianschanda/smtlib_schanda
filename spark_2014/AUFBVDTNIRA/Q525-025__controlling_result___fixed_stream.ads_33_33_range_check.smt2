...
(declare-fun dummy2 () tstream_element_offsetB)
...
(declare-fun dummy3 () stream_element_offset)
...
(declare-fun dummy4 () stream_element)
...
(declare-datatypes ()
((map__ref (mk_map__ref (map__content (Array Int stream_element))))))
...
(define-fun bool_eq5 ((a (Array Int stream_element)) (a__first Int)
...
(declare-datatypes ()
((us_t (mk___t (elts (Array Int stream_element))(rt t)))))
...
(declare-fun dummy9 () tstream_element_offsetB)
...
(declare-fun dummy11 () tstream_element_offsetB)

(declare-datatypes ()
((t15b__ref (mk_t15b__ref (t15b__content tstream_element_offsetB)))))
...
(declare-datatypes ()
((us_t2 (mk___t2 (elts2 (Array Int stream_element))(rt2 t2)))))
...
(declare-fun value__first () tstream_element_offsetB)

(declare-fun value__last () tstream_element_offsetB)
...
(declare-fun value () (Array Int stream_element))

(declare-fun fixed_stream__null_string__result () (Array Int stream_element))
...
(declare-fun fixed_stream__null_string__value__assume1 () t1)

(declare-fun o () Int)

(declare-fun result () (Array Int stream_element))

(declare-fun value1 () (Array Int stream_element))

(declare-fun result1 () (Array Int stream_element))

(declare-fun result2 () t)

(declare-fun fixed_stream__null_string__result2 () (Array Int stream_element))

(declare-fun fixed_stream__null_string__result3 () t)

(declare-fun fixed_stream__null_string__result4 () (Array Int stream_element))

(declare-fun fixed_stream__null_string__result5 () t)

(declare-fun fixed_stream__null_string__result6 () (Array Int stream_element))

(declare-fun fixed_stream__null_string__result7 () t)

(declare-fun value2 () (Array Int stream_element))

(declare-fun fixed_stream__null_string__result8 () (Array Int stream_element))

(declare-fun fixed_stream__null_string__result9 () t)

(declare-fun value3 () (Array Int stream_element))

(declare-fun fixed_stream__null_string__result10 () (Array Int stream_element))

(declare-fun fixed_stream__null_string__result11 () t)
...
;; H
  ...
  (= (to_rep1 value__last) (to_rep
                           (rec__fixed_stream__object__width
                           (us_split_fields1 this)))))))

;; H
  (assert
  (= fixed_stream__null_string__result4 fixed_stream__null_string__result2))

;; H
  (assert
  (= fixed_stream__null_string__result5 fixed_stream__null_string__result3))

;; H
  (assert
  (= fixed_stream__null_string__result12 (mk___t
                                         fixed_stream__null_string__result2
                                         fixed_stream__null_string__result3)))

;; H
  (assert
  (= (mk_stream_element_array__ref (mk___t result1 result2)) (mk_stream_element_array__ref
                                                             (mk___t
                                                             fixed_stream__null_string__result
...
;; H
  (assert
  (= (mk (to_rep1 value__first) (to_rep1 value__last)) fixed_stream__null_string__result3))

;; H
  (assert
  (= (mk_stream_element_array__ref
     (mk___t fixed_stream__null_string__result8
     fixed_stream__null_string__result9)) (mk_stream_element_array__ref
                                          (mk___t
                                          fixed_stream__null_string__result4
...
;; H
  (assert
  (= (mk___t fixed_stream__null_string__result10
     fixed_stream__null_string__result11) fixed_stream__null_string__result12))
