...
(define-fun dynamic_invariant ((temp___expr_2768 us_t1)
  ...
  (temp___do_toplevel_2767 Bool)) Bool (=>
                                       ...
                                       (last3 temp___expr_2768))
                                       (and (= (first3 temp___expr_2768) 1)
                                       (= (last3 temp___expr_2768) 5)))))
...
(define-fun dynamic_invariant1 ((temp___expr_2819 us_t2)
  ...
  (temp___do_toplevel_2818 Bool)) Bool (=>
                                       ...
                                       (last5 temp___expr_2819))
                                       (and (= (first5 temp___expr_2819) 1)
                                       (= (last5 temp___expr_2819) 5)))))
...
;; H
  (assert
  (and (= temp___76102 (register_to_bytes reg)) (dynamic_invariant1
  temp___76102 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___76101)) (to_rep (last4 temp___76101)))
     (+ (- (to_rep (last4 temp___76101)) (to_rep (first4 temp___76101))) 1)
     0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76101)) (to_rep (last4 temp___76101))) 
  temp___76111))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___76111)) (to_rep (last2 temp___76111)))
     (+ (- (to_rep (last2 temp___76111)) (to_rep (first2 temp___76111))) 1)
