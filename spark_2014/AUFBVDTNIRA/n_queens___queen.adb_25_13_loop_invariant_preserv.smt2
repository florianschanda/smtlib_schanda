...
(declare-fun r1 () (Array Int index))

(declare-fun result1 () Int)

(declare-fun j1 () Int)

(declare-fun r2 () (Array Int index))

(declare-fun j2 () Int)

(declare-fun result2 () (Array Int index))

(declare-fun r3 () (Array Int index))
...
;; H
  ...
  (=> (<= j2 temp___189) (= (select r2 temp___189) (select r1 temp___189)))))
  (=> (<= 1 i) (dynamic_property 1 i j2))) (and (<= 1 j2) (<= j2 i))))

;; H
  (assert (= (to_rep o1) (to_rep (select b j2))))

;; H
  (assert (= o2 (store r2 j2 o1)))
