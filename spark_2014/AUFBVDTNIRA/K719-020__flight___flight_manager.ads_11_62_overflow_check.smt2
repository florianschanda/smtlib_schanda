...
(declare-fun flight_manager__set_engine_speed__result () integer)

(declare-fun flight_manager__set_engine_speed__result1 () integer)
...
;; H
  ...
  (my_abs__function_guard flight_manager__set_engine_speed__C7b__assume 
  o18)) (in_range1 flight_manager__set_engine_speed__C7b__assume)))
...
;; H
  (assert (= o28 (- o27 target_y)))

;; H
  (assert (and (= o30 o28) (in_range1 o28)))

;; H
  (assert (= o31 (ite (< o30 o29) true false)))

;; H
  (assert
  (and
  (= o26 (+ position_x (to_rep
                       (rec__flight_manager__engine_values__x_speed
                       (us_split_fields1
                       (engine_values__content
                       flight_manager__set_engine_speed__result5))))))
