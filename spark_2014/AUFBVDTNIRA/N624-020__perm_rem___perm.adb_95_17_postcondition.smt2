...
(declare-fun perm__perm_symmetric__induction_hypothesis__result () Int)

(declare-fun perm__perm_symmetric__induction_hypothesis__B_4__w__assume () index)

(declare-fun perm__perm_symmetric__induction_hypothesis__B_4__w__assume1 () index)
...
(declare-fun perm__perm_symmetric__induction_hypothesis__B_4__ih__assume () Int)

(declare-fun perm__perm_symmetric__induction_hypothesis__result1 () Int)

(declare-fun result () Int)

(declare-fun perm__perm_symmetric__induction_hypothesis__result2 () Int)

(declare-fun result1 () Int)

(declare-fun perm__perm_symmetric__induction_hypothesis__result3 () Int)

(declare-fun perm__perm_symmetric__induction_hypothesis__result4 () Int)

(declare-fun perm__perm_symmetric__induction_hypothesis__result5 () Int)

(declare-fun perm__perm_symmetric__induction_hypothesis__result6 () Int)

(declare-fun perm__perm_symmetric__induction_hypothesis__result7 () Int)

(declare-fun perm__perm_symmetric__induction_hypothesis__result8 () Int)

(declare-fun perm__perm_symmetric__induction_hypothesis__result9 () Int)

(define-fun perm__perm_symmetric__induction_hypothesis__result10 () int__ref 
  (mk_int__ref perm__perm_symmetric__induction_hypothesis__result6))

(define-fun o4 () us_t (mk___t o2 o3))

(define-fun o5 () us_t (mk___t o o1))

(define-fun perm__perm_symmetric__induction_hypothesis__B_4__w__assume2 () us_rep 
  (mk___rep
  (mk___split_fields
...
;; H
  ...
  a (to_rep1 perm__perm_symmetric__induction_hypothesis__B_4__w__assume)))

;; H
  (assert (remove__function_guard
  (remove b
  (to_rep1 perm__perm_symmetric__induction_hypothesis__B_4__w__assume1)) 
  b (to_rep1 perm__perm_symmetric__induction_hypothesis__B_4__w__assume1)))
...
;; H
  (assert (invariant____function_guard (invariant__ o4) o4))

;; H
  (assert (invariant____function_guard (invariant__ o5) o5))

;; H
  (assert (is_perm__function_guard (is_perm o4 o5) o4 o5))
...
;; H
  ...
  (and
  (and
  (= perm__perm_symmetric__induction_hypothesis__result2 perm__perm_symmetric__induction_hypothesis__result6)
  (= perm__perm_symmetric__induction_hypothesis__result7 perm__perm_symmetric__induction_hypothesis__result2))
  (and (= (length a) 0)
  (and
  (= (mk_int__ref result) (mk_int__ref
                          perm__perm_symmetric__induction_hypothesis__result))
  (= perm__perm_symmetric__induction_hypothesis__result2 1))))
  (and
  (and (not (= (length a) 0))
  (and
  (= perm__perm_symmetric__induction_hypothesis__result2 perm__perm_symmetric__induction_hypothesis__result)
  (= perm__perm_symmetric__induction_hypothesis__result2 perm__perm_symmetric__induction_hypothesis__result1)))
  (and
  (and
  (= perm__perm_symmetric__induction_hypothesis__result10 (mk_int__ref
                                                          perm__perm_symmetric__induction_hypothesis__result4))
  (= perm__perm_symmetric__induction_hypothesis__result7 perm__perm_symmetric__induction_hypothesis__result5))
  (and
  (and
  (= perm__perm_symmetric__induction_hypothesis__result3 perm__perm_symmetric__induction_hypothesis__result4)
  (= perm__perm_symmetric__induction_hypothesis__result5 perm__perm_symmetric__induction_hypothesis__result3))
  (and
  (and
  (and
  (and
  (= perm__perm_symmetric__induction_hypothesis__B_4__w__assume2 (get_witnesses
                                                                 a b))
  (get_witnesses__function_guard
  perm__perm_symmetric__induction_hypothesis__B_4__w__assume2 a b))
  (and
  (and
  ...
  (and
  (= (to_rep
     (select (elts a) (to_rep1
                      perm__perm_symmetric__induction_hypothesis__B_4__w__assume))) 
  (to_rep
  (select (elts b) (to_rep1
                   perm__perm_symmetric__induction_hypothesis__B_4__w__assume1))))
  (= (is_perm
     (remove a
     (to_rep1 perm__perm_symmetric__induction_hypothesis__B_4__w__assume))
     (remove b
     (to_rep1 perm__perm_symmetric__induction_hypothesis__B_4__w__assume1))) true)))))
  (= perm__perm_symmetric__induction_hypothesis__B_4__w__assume2 w))
  (and
  (and
  (and
  (and
  (and
  (= o4 (remove b (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
  (remove__function_guard o4 b
  (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
  (and (dynamic_invariant1 o4 true false true)
  (and (= (invariant__ o4) true)
  (and (= (to_rep2 (last o3)) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select o2 k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select o2 (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o2 k)))))))))))
  (and
  (and
  (and
  (= o5 (remove a (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))))
  (remove__function_guard o5 a
  (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))))
  (and (dynamic_invariant1 o5 true false true)
  (and (= (invariant__ o5) true)
  (and (= (to_rep2 (last o1)) (- (to_rep2 (last (rt a))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  ...
  (and
  (and
  (= perm__perm_symmetric__induction_hypothesis__B_4__ih__assume (induction_hypothesis
                                                                 o5 o4))
  (induction_hypothesis__function_guard
  perm__perm_symmetric__induction_hypothesis__B_4__ih__assume o5 o4))
  (and (in_range2
  perm__perm_symmetric__induction_hypothesis__B_4__ih__assume)
  (=>
  (= (of_int perm__perm_symmetric__induction_hypothesis__B_4__ih__assume) true)
  (= (is_perm o4 o5) true))))))
  (= perm__perm_symmetric__induction_hypothesis__B_4__ih__assume ih))
  (and (in_range2 ih)
  (and (= (of_int ih) true)
  (and
  (= (to_rep
  ...
  (to_rep
  (select (elts a) (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))))))
  (and (= perm__perm_symmetric__induction_hypothesis__result2 result1)
  (= perm__perm_symmetric__induction_hypothesis__result3 ih))))))))))))

;; H
  (assert
  (= (mk_int__ref perm__perm_symmetric__induction_hypothesis__result8) 
  perm__perm_symmetric__induction_hypothesis__result10))

;; H
  (assert
  (= perm__perm_symmetric__induction_hypothesis__result9 perm__perm_symmetric__induction_hypothesis__result7))
...
;; H
  (assert
  (= (of_int perm__perm_symmetric__induction_hypothesis__result8) true))

;; H
  (assert (is_perm__function_guard (is_perm b a) b a))

(assert
;; WP_parameter_def
 ;; File "perm.ads", line 2, characters 0-0
  (not (= (is_perm b a) true)))
(check-sat)
