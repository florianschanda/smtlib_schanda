...
;; H
  (assert
  (and (and (= o2 (pow9 x)) (pow9__function_guard o2 x))
  (and (tqtisFinite o2)
  (= o2 (mul RNE2
        (mul RNE2
        (mul RNE2
...
;; H
  (assert (= o3 (mul RNE2 fliteral2 o2)))

;; H
  (assert (and (= o4 o3) (tqtisFinite o3)))

;; H
  (assert (= o5 (div1 RNE2 o4 fliteral3)))

;; H
  (assert
  (and (and (= o (pow7 x)) (pow7__function_guard o x))
  (and (tqtisFinite o)
  (= o (mul RNE2
       (mul RNE2 (mul RNE2 (mul RNE2 (mul RNE2 (mul RNE2 x x) x) x) x) x) 
       x)))))
...
;; H
  (assert (= o1 (mul RNE2 fliteral4 o)))
