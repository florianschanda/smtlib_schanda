...
;; str_comp__def_axiom
  ...
  (forall ((op Int))
  (! (=> (str_comp__function_guard (str_comp keyedop op) keyedop op)
     ...
     (= (to_rep2
        (let ((temp___274 (rec__admin__datat__text
                          (us_split_fields5 (select optokeyed op)))))
        (select temp___274 i))) (to_rep2
                                (let ((temp___275 (rec__keyboard__datat__text
                                                  (us_split_fields1 keyedop))))
                                (select temp___275 i))))))))) :pattern (
  (str_comp keyedop op)) ))))
...
(define-fun bool_eq14 ((a (Array Int (Array Int Bool))) (a__first Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq13 (select a temp___idx_133) 1 4
...
;; allowedop__def_axiom
  ...
  (forall ((theadmin us_rep1))
  (forall ((op Int))
  (! (=> (allowedop__function_guard (allowedop theadmin op) theadmin op)
     (= (= (allowedop theadmin op) true)
     (= (let ((temp___279 (select isavailable (to_rep
                                              (rec__admin__t__rolepresent
                                              (us_split_fields3 theadmin))))))
        (select temp___279 op)) true))) :pattern ((allowedop theadmin op)) ))))
...
(define-fun dynamic_invariant3 ((temp___expr_332 Int)
  ...
  (temp___do_toplevel_331 Bool)) Bool (=>
                                      ...
                                      (<= 0 18)) (in_range7 temp___expr_332)))
...
(define-fun dynamic_invariant4 ((temp___expr_338 Int)
  ...
  (temp___do_toplevel_337 Bool)) Bool (=>
                                      ...
                                      (<= 1 18)) (in_range8 temp___expr_338)))
...
;; H
  (assert
  (and
  (and (= result2 (str_comp keyedop op2)) (str_comp__function_guard result2
  keyedop op2))
  (= (= result2 true)
  (and
  (and
