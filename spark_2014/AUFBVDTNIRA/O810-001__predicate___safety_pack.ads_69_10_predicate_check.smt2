...
;; H
  (assert (not (eq x fliteral2)))

;; H
  (assert (not (and (le (neg fliteral3) x) (le x fliteral2))))

;; H
  (assert (not (and (le fliteral2 x) (le x fliteral3))))

(define-fun temp___1355 () t x)

(assert
;; WP_parameter_def
 ;; File "types.ads", line 65, characters 0-0
  (not
  (or (or (eq temp___1355 fliteral2) (le temp___1355 (neg fliteral3))) (le
  fliteral3 temp___1355))))
(check-sat)
