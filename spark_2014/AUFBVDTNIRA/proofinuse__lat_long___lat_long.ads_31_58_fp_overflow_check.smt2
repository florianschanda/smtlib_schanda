...
;; H
  (assert
  (and (= o4 (mul RNE1 delta_lat1 delta_lat1)) (tqtisFinite
  (mul RNE1 delta_lat1 delta_lat1))))
...
;; H
  (assert (and (= o7 (sqrt2 o6)) (and (tqtisFinite o7) (= o7 (sqrt3 o6)))))
