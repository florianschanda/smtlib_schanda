...
;; sqrt__def_axiom
  ...
  (! (=>
     ...
     (sqrt2 x) x)) (= (sqrt2 x) (sqrt3 x))) :pattern ((sqrt2 x)) )))
...
;; delta_lat_in_meters__post_axiom
  ...
  (! (let ((result (delta_lat_in_meters source1 destination1)))
     (and (olt__function_guard (olt (abs1 result) fliteral6) (abs1 result)
     fliteral6)
     ...
     true false true))))) :pattern ((delta_lat_in_meters source1
                                    destination1)) )))
...
;; delta_lat_in_meters__def_axiom
  ...
  (! (=> (delta_lat_in_meters__function_guard
     ...
     (= (delta_lat_in_meters source1 destination1) (mul RNE2
                                                   (mul RNE2
                                                   (sub RNE2
                                                   (to_rep
                                                   (rec__lat_long__coordinates__lat
...
;; delta_long_in_meters__post_axiom
  ...
  (! (let ((result (delta_long_in_meters source1 destination1)))
     (and (olt__function_guard (olt (abs1 result) fliteral9) (abs1 result)
     fliteral9)
     ...
     true false true))))) :pattern ((delta_long_in_meters source1
                                    destination1)) )))
...
;; delta_long_in_meters__def_axiom
  ...
  (! (=> (delta_long_in_meters__function_guard
     ...
     (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source1))))
     (= (delta_long_in_meters source1 destination1) (div1 RNE2
                                                    (mul RNE2
                                                    (sub RNE2
                                                    (to_rep1
                                                    (rec__lat_long__coordinates__long
...
;; olt__def_axiom
  ...
  (! (=> (olt__function_guard (olt left right) left right)
     (= (= (olt left right) true) (lt left (add RNE2 right fliteral10)))) :pattern (
  (olt left right)) )))
...
(declare-fun lat_long__distance__result () t)
...
(declare-fun lat_long__distance__result1 () t)

(declare-fun lat_long__distance__result2 () t)

(declare-fun lat_long__distance__result3 () t)

(declare-fun delta_lat2 () t)

(declare-fun delta_long2 () t)

(declare-fun lat_long__distance__result4 () t)

(declare-fun delta_lat3 () t)

(declare-fun delta_long3 () t)

(declare-fun lat_long__distance__result5 () t)
...
;; H
  (assert
  (and (= o3 (mul RNE2 delta_long1 delta_long1)) (tqtisFinite
  (mul RNE2 delta_long1 delta_long1))))

;; H
  (assert
  (and (= o4 (mul RNE2 delta_lat1 delta_lat1)) (tqtisFinite
  (mul RNE2 delta_lat1 delta_lat1))))
...
;; H
  (assert
  (and (and (= o7 (sqrt2 o6)) (sqrt__function_guard o7 o6))
  (and (tqtisFinite o7) (= o7 (sqrt3 o6)))))
...
;; H
  (assert (cos__function_guard
  (cos1 (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source))))
  (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source)))))

;; H
  (assert (olt__function_guard (olt (abs1 o8) fliteral9) (abs1 o8)
  fliteral9))
...
;; H
  (assert (olt__function_guard (olt (abs1 o9) fliteral9) (abs1 o9)
  fliteral9))
...
;; H
  ...
  (delta_long_in_meters__function_guard o8 source destination))
  (and (tqtisFinite o8)
  (and
  (= o8 (div1 RNE2
        (mul RNE2
        ...
        (cos1
        (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source))))))
  (= (olt (abs1 o8) fliteral9) true)))))

;; H
  (assert
  (and
  (and (= o9 (delta_long_in_meters source destination))
  (delta_long_in_meters__function_guard o9 source destination))
  (and (tqtisFinite o9)
  (and
  (= o9 (div1 RNE2
        (mul RNE2
        ...
        (cos1
        (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source))))))
  (= (olt (abs1 o9) fliteral9) true)))))

;; H
  (assert (= o10 (mul RNE2 o9 o8)))
