...
(declare-fun shutdowncompleted2 () Bool)
...
;; H
  (assert
  (and (= o15 (statusiswaitingfinishadminop (let ((subject state)) state12)))
  (statusiswaitingfinishadminop__function_guard o15
  (let ((subject state)) state12))))

;; H
  (assert
  (and (= o16 (statusiswaitingstartadminop (let ((subject state)) state12)))
  (statusiswaitingstartadminop__function_guard o16
  (let ((subject state)) state12))))
...
;; H
  ...
  (= o11 (statusiswaitingremoveadmintokenfail
         (let ((subject state)) state12)))
  (statusiswaitingremoveadmintokenfail__function_guard o11
  (let ((subject state)) state12))))

;; H
  (assert
  (and (= o12 (statusisgotadmintoken (let ((subject state)) state12)))
  (statusisgotadmintoken__function_guard o12
  (let ((subject state)) state12))))
...
;; H
  (assert
  (=> (= result6 true)
  (and (= o10 (statusiswaitingstartadminop (let ((subject state)) state12)))
  (statusiswaitingstartadminop__function_guard o10
  (let ((subject state)) state12)))))
