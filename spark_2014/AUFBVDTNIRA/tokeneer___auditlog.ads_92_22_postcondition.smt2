...
(declare-fun user_eq5 (severityt severityt) Bool)

(declare-fun dummy5 () severityt)
...
;; range_axiom
  (assert
  (forall ((x fileentrycountt)) (! (in_range7
...
;; range_axiom
  (assert
  (forall ((x logfilecountt)) (! (in_range8
...
;; range_axiom
  (assert
  (forall ((x logfileindext)) (! (in_range9
...
(define-fun dynamic_invariant5 ((temp___expr_1056 Int)
...
(declare-fun bool_eq15 (us_rep1 us_rep1) Bool)
...
(define-fun bool_eq16 ((a (Array Int us_rep1)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq15 (select a temp___idx_149)
...
(declare-fun dummy14 () filestatust)
...
;; range_axiom
  (assert
  (forall ((x filestatust)) (! (in_range11
...
(define-fun bool_eq18 ((a (Array Int filestatust)) (a__first Int)
...
;; H
  (assert (in_range9 currentlogfile))
...
;; H
  ...
  (= (to_rep1 (first (rt description))) 1)))

;; H
  (assert
  (and (<= 1 (to_rep3 usedlogfiles__split_fields7))
  (= numberlogentries1 (+ (* (- (to_rep3 usedlogfiles__split_fields7) 1) 1024) 
  (to_rep2 (select logfileentries1 currentlogfile1))))))

;; H
  (assert
  (and (and (in_range10 numberlogentries1) (in_range6 auditalarm1))
  (in_range9 currentlogfile1)))

;; H
  (assert (valid_numberlogentries__function_guard
  (valid_numberlogentries logfileentries1 numberlogentries1 currentlogfile1
  (mk___split_fields usedlogfiles__split_fields4 usedlogfiles__split_fields5
  usedlogfiles__split_fields6 usedlogfiles__split_fields7)) logfileentries1
  numberlogentries1 currentlogfile1
  (mk___split_fields usedlogfiles__split_fields4 usedlogfiles__split_fields5
  usedlogfiles__split_fields6 usedlogfiles__split_fields7)))

(assert
;; WP_parameter_def
 ;; File "auditlog.ads", line 33, characters 0-0
  (not
  (= (valid_numberlogentries logfileentries1 numberlogentries1
     currentlogfile1
     (mk___split_fields usedlogfiles__split_fields4
     usedlogfiles__split_fields5 usedlogfiles__split_fields6
     usedlogfiles__split_fields7)) true)))
(check-sat)
