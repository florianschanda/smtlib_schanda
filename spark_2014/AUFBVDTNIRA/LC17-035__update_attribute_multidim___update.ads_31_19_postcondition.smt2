...
(declare-fun temp___161 (map1 Int Int Int Int) map1)

;; def_axiom
  (assert
  (forall ((temp___163 map1))
  (forall ((temp___164 Int) (temp___165 Int) (temp___166 Int)
  (temp___167 Int))
  (let ((temp___162 (temp___161 temp___163 temp___164 temp___165 temp___166
                    temp___167)))
  (forall ((temp___168 Int) (temp___169 Int) (temp___170 Int))
  (ite (and (and (= temp___168 temp___164) (= temp___169 temp___165))
       (= temp___170 temp___166))
  (= (get temp___162 temp___168 temp___169 temp___170) (of_rep temp___167))
  (= (get temp___162 temp___168 temp___169 temp___170) (get temp___163
                                                       temp___168 temp___169
                                                       temp___170))))))))
...
(assert
;; WP_parameter_def
 ;; File "update.ads", line 17, characters 0-0
  (not
  (= (bool_eq2 a2 1 8 1 8 1 8 (temp___161 a i i i new_val) 1 8 1 8 1 8) true)))
(check-sat)
