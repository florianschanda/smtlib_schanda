...
;; H
  ...
  (forall ((g2 Int))
  (=> (and (<= 1 g2) (<= g2 64))
  (= (bool_eq7 (select o3 g2) 1 64 (invert_1 (select ranking_2 g2)) 1 64) true)))))
...
;; H
  (assert (=> (and (<= 1 g11) (<= g11 64)) (= temp___500 g11)))
...
;; H
  (assert (=> (and (<= 1 g11) (<= g11 64)) (= temp___495 o6)))

;; H
  (assert (=> (and (<= 1 g11) (<= g11 64)) (= temp___4951 o7)))
...
;; H
  (assert (=> (and (<= 1 g11) (<= g11 64)) (= temp___499 o11)))

;; H
  (assert (=> (and (<= 1 g11) (<= g11 64)) (= temp___4991 o12)))
