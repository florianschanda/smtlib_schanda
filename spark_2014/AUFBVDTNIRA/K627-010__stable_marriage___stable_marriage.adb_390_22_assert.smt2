...
(define-fun bool_eq4 ((a (Array Int (Array Int group2_id))) (a__first Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq3 (select a temp___idx_134) 1 64
...
(define-fun bool_eq5 ((a (Array Int (Array Int group1_id))) (a__first Int)
...
(define-fun bool_eq8 ((a (Array Int (Array Int ranking))) (a__first Int)
...
(define-fun bool_eq11 ((a (Array Int count)) (a__first Int) (a__last Int)
...
(define-fun bool_eq13 ((a (Array Int Bool)) (a__first Int) (a__last Int)
...
(declare-fun unmatched_g1_set__split_fields6 () us_split_fields__ref)

(declare-fun g13 () int__ref)

(declare-fun unmatched_g1_set__split_fields7 () us_split_fields)

(declare-fun g14 () Int)

(declare-fun unmatched_g1_set__split_fields8 () us_split_fields__ref)

(declare-fun g15 () int__ref)

(declare-fun unmatched_g1_set__split_fields9 () us_split_fields)

(declare-fun g16 () Int)

;; H
  (assert
  (forall ((g17 Int)) (is_permutation_2__function_guard
  (is_permutation_2 (select ranking_1 g17)) (select ranking_1 g17))))
...
;; H
  ...
  (forall ((g17 Int))
  (=> (and (<= 1 g17) (<= g17 64))
  (= (is_permutation_2 (select ranking_1 g17)) true)))
  (forall ((g2 Int))
  (=> (and (<= 1 g2) (<= g2 64))
  (= (is_permutation_1 (select ranking_2 g2)) true)))))
...
;; H
  (assert
  (forall ((g2 Int)) (invert_1__function_guard
  (invert_1 (select ranking_2 g2)) (select ranking_2 g2))))
...
;; H
  ...
  (forall ((g2 Int))
  (=> (and (<= 1 g2) (<= g2 64))
  (= (bool_eq7 (select o7 g2) 1 64 (invert_1 (select ranking_2 g2)) 1 64) true)))))
...
;; H
  (assert (=> (and (<= 1 g11) (<= g11 64)) (= temp___547 g11)))
...
;; H
  ...
  (=> (and (<= 1 g11) (<= g11 64))
  (forall ((prev Int))
  (=> (and (<= 1 prev) (<= prev (- g12 1)))
  (= (to_rep
     (select (rec__stable_marriage__matching__group1_set__elements
             unmatched_g1_set__split_fields3) prev)) prev)))))

;; H
  (assert
  (=> (and (<= 1 g11) (<= g11 64))
  (and (=> (<= 1 64) (in_range1 g12)) (and (<= 1 g12) (<= g12 64)))))
...
;; H
  (assert (=> (and (<= 1 g11) (<= g11 64)) (= (to_rep3 o9) o8)))
...
;; H
  (assert (=> (and (<= 1 g11) (<= g11 64)) (= o9 o11)))

;; H
  (assert (=> (and (<= 1 g11) (<= g11 64)) (= temp___542 o10)))

;; H
  (assert (=> (and (<= 1 g11) (<= g11 64)) (= temp___5421 o11)))

;; H
  (assert
  (=> (and (<= 1 g11) (<= g11 64))
  (= result6 (mk___split_fields__ref unmatched_g1_set__split_fields3))))
...
;; H
  (assert (=> (and (<= 1 g11) (<= g11 64)) (= (to_rep o12) c175b)))
...
;; H
  ...
  (<= (to_rep3
      (rec__stable_marriage__matching__group1_set__cardinality
      unmatched_g1_set__split_fields4)) 64))))
...
;; H
  (assert (=> (and (<= 1 g11) (<= g11 64)) (= o14 o15)))
...
;; H
  (assert (=> (and (<= 1 g11) (<= g11 64)) (= temp___546 o15)))

;; H
  (assert (=> (and (<= 1 g11) (<= g11 64)) (= temp___5461 o16)))

;; H
  (assert
  (=> (and (<= 1 g11) (<= g11 64))
  (= result7 (mk___split_fields__ref unmatched_g1_set__split_fields4))))
...
;; H
  (assert
  (=> (and (<= 1 g11) (<= g11 64))
  (= unmatched_g1_set__split_fields6 (mk___split_fields__ref
...
;; H
  (assert
  (=> (and (<= 1 g11) (<= g11 64))
  (= unmatched_g1_set__split_fields7 unmatched_g1_set__split_fields5)))
...
;; H
  (assert
  (=> (and (<= 1 g11) (<= g11 64))
  (= unmatched_g1_set__split_fields8 unmatched_g1_set__split_fields6)))
...
;; H
  (assert
  (=> (and (<= 1 g11) (<= g11 64))
  (= unmatched_g1_set__split_fields9 unmatched_g1_set__split_fields7)))
...
;; H
  (assert
  (=> (not (and (<= 1 g11) (<= g11 64)))
  (= unmatched_g1_set__split_fields8 (mk___split_fields__ref
...
;; H
  (assert
  (=> (not (and (<= 1 g11) (<= g11 64)))
  (= unmatched_g1_set__split_fields9 unmatched_g1_set__split_fields2)))
...
;; H
  (assert
  (= (all_unmatched_g1_set_elements_distinct
     (us_split_fields__content unmatched_g1_set__split_fields8)) true))
...
;; WP_parameter_def
 ;; File "stable_marriage.ads", line 18, characters 0-0
  (not (= (to_rep3 (select proposals_made1 g1_id)) 0)))
(check-sat)
