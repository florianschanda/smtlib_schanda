...
;; H
  ...
  (= o6 (ite (or
        ...
        0
        (ite (= (head o9) (head s2))
        (+ 1 (slow_lcs_length (tail o9) (tail s2)))
        (ite (< (slow_lcs_length o9 (tail s2)) (slow_lcs_length (tail o9) s2)) 
        (slow_lcs_length (tail o9) s2) (slow_lcs_length o9 (tail s2)))))))))
...
;; H
  ...
  (= o7 (ite (or
        ...
        (ite (< (slow_lcs_length s1 (tail o10)) (slow_lcs_length (tail s1)
                                                o10)) (slow_lcs_length
                                                      (tail s1) o10) 
        (slow_lcs_length s1 (tail o10)))))))))
