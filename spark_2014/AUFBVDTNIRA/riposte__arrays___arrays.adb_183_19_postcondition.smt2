...
(declare-fun arrays__single_char_set__result () (Array Int Bool))

(declare-fun temp___311 () Int)

(declare-fun temp___309 () (Array Int Bool))
...
(declare-fun r4 () (Array Int Bool))

(declare-fun x3 () Int)

(declare-fun r5 () (Array Int Bool))

(declare-fun x4 () Int)

(declare-fun r6 () (Array Int Bool))

(declare-fun x5 () Int)

(declare-fun r7 () (Array Int Bool))

(declare-fun x6 () Int)

(declare-fun result2 () (Array Int Bool))

(declare-fun arrays__single_char_set__result1 () (Array Int Bool))

(declare-fun arrays__single_char_set__result2 () (Array Int Bool))

(declare-fun arrays__single_char_set__result3 () (Array Int Bool))

(declare-fun r8 () (Array Int Bool))

(declare-fun x7 () Int)

(declare-fun arrays__single_char_set__result4 () (Array Int Bool))

(declare-fun r9 () (Array Int Bool))

(declare-fun x8 () Int)

(declare-fun arrays__single_char_set__result5 () (Array Int Bool))
...
;; H
  (assert (=> (and (<= 0 x1) (<= x1 255)) (= temp___311 x1)))

;; H
  (assert (=> (and (<= 0 x1) (<= x1 255)) (= temp___309 r)))
...
;; H
  ...
  (=> (and (<= 0 x1) (<= x1 255))
  (forall ((i Int))
  (=> (and (<= 0 i) (<= i x2)) (= (= (select r3 i) true) (= i c))))))
...
;; H
  ...
  (=> (and (<= 0 temp___310) (<= temp___310 255))
  (=> (< x2 temp___310)
  (= (select r3 temp___310) (select temp___309 temp___310)))))
  (=> (<= 0 255) (in_range1 x2))) (and (<= 0 x2) (<= x2 255)))))
...
;; H
  (assert
  (=> (and (<= 0 x1) (<= x1 255)) (= (mk_int__ref x5) (mk_int__ref x3))))
...
;; H
  (assert
  (= arrays__single_char_set__result1 arrays__single_char_set__result2))

;; H
  (assert
  (= arrays__single_char_set__result3 arrays__single_char_set__result1))
...
;; H
  (assert
  (= (mk_map__ref arrays__single_char_set__result4) (mk_map__ref
                                                    arrays__single_char_set__result2)))
...
;; H
  (assert
  (= arrays__single_char_set__result5 arrays__single_char_set__result3))
