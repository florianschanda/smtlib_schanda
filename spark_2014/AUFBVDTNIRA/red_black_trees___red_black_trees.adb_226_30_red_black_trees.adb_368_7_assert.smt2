...
;; H
  (assert
  (=> (= result3 true) (=> (and (<= 1 n6) (<= n6 100)) (= temp___1090 n6))))
...
;; H
  ...
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c66b) i)))) n7))
  (not
...
;; H
  ...
  (=> (= result3 true)
  (=> (and (<= 1 n6) (<= n6 100))
  (and (=> (<= 1 100) (in_range2 n7)) (and (<= 1 n7) (<= n7 100))))))
...
;; H
  (assert
  (=> (= result3 true)
  (=> (and (<= 1 n6) (<= n6 100)) (= n8 (mk_int__ref n7)))))
...
;; H
  (assert
  (=> (= result3 true)
  (=> (not (and (<= 1 n6) (<= n6 100))) (= n10 (mk_int__ref n6)))))

;; H
  (assert
  (=> (= result3 true) (=> (not (and (<= 1 n6) (<= n6 100))) (= n11 n6))))

;; H
  (assert (=> (= result3 true) (= (same_nb_blacks c67b) true)))
