...
;; H
  (assert
  (forall ((ib2 Int)) (remove__function_guard (remove bb ib2) bb ib2)))
...
;; H
  (assert
  (forall ((ia2 Int) (ib2 Int)) (is_perm__function_guard
  (is_perm (remove aa ia2) (remove bb ib2)) (remove aa ia2) (remove bb ib2))))
...
;; H
  ...
  (exists ((ib2 Int))
  (and
  (and (<= (to_rep2 (first (rt bb))) ib2) (<= ib2 (to_rep2 (last (rt bb)))))
  (and (= (to_rep (select (elts aa) ia2)) (to_rep (select (elts bb) ib2)))
  (= (is_perm (remove aa ia2) (remove bb ib2)) true))))))))))
...
;; H
  (assert (remove__function_guard
  (remove (remove a o1)
  (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))) (remove a o1)
  (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))))
...
;; H
  ...
  (remove_swap__function_guard o2 a
  (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) o1))
  (and (in_range3 o2)
  (=> (= (of_int o2) true)
  (= (let ((temp___196 (remove (remove a o1)
                       (to_rep1
...
;; H
  (assert (remove__function_guard (remove aa o4) aa o4))

;; H
  (assert (remove__function_guard (remove bb o5) bb o5))
...
;; H
  (assert (is_perm__function_guard (is_perm (remove aa o4) (remove bb o5))
  (remove aa o4) (remove bb o5)))
...
;; H
  (assert
  (and
  (and (= o5 (get_witness aa bb o4)) (get_witness__function_guard o5 
  aa bb o4))
  (and (in_range4 o5)
  (and
...
;; H
  (assert (invariant____function_guard (invariant__ o11) o11))

;; H
  (assert (invariant____function_guard (invariant__ o12) o12))
...
;; H
  (assert (is_perm__function_guard (is_perm o12 o9) o12 o9))
...
;; H
  (assert
  (and (and (= o11 (remove a o10)) (remove__function_guard o11 a o10))
...
;; H
  ...
  (= o12 (remove o11
         (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))))
  (remove__function_guard o12 o11
  (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))))
...
;; H
  (assert
  (and (and (= o9 (remove bb ib1)) (remove__function_guard o9 bb ib1))
...
;; H
  (assert
  (and (and (= o8 (remove aa o7)) (remove__function_guard o8 aa o7))
...
;; H
  (assert
  (and
  (and (= o13 (shift_perm_l o8 o9 o12)) (shift_perm_l__function_guard 
  o13 o8 o9 o12))
...
;; H
  ...
  (remove
  (remove b (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))) 
  ib1) (remove b (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))))
  ib1))

;; H
  (assert (remove__function_guard (remove b ib1) b ib1))
...
;; H
  ...
  (and
  (and
  (= o14 (remove_swap b ib1
         (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
  (remove_swap__function_guard o14 b ib1
  (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
  (and (in_range3 o14)
  (=> (= (of_int o14) true)
  (= (let ((temp___196 (remove
                       ...
                       ib1)))
     (let ((temp___195 (remove (remove b ib1)
                       (- (to_rep1
...
;; H
  (assert (invariant____function_guard (invariant__ o15) o15))

;; H
  (assert (invariant____function_guard (invariant__ o17) o17))

;; H
  (assert
  (and
  (= o16 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))

;; H
  (assert
  (and (and (= o15 (remove b ib1)) (remove__function_guard o15 b ib1))
  (and (dynamic_invariant2 o15 true false true)
  (and (= (invariant__ o15) true)
  (and (= (to_rep2 (last (rt o15))) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o15) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o15) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o15) k))))))))))))

;; H
  (assert
  (and (and (= o17 (remove o15 o16)) (remove__function_guard o17 o15 o16))
  (and (dynamic_invariant2 o17 true false true)
  (and (= (invariant__ o17) true)
  (and (= (to_rep2 (last (rt o17))) (- (to_rep2 (last (rt o15))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o16 1)))
  (= (to_rep (select (elts o15) k)) (to_rep (select (elts o17) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o16 1) k) (<= k (to_rep2 (last (rt o15)))))
  (= (to_rep (select (elts o15) k)) (to_rep (select (elts o17) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o16 k) (<= k (- (to_rep2 (last (rt o15))) 1)))
  (= (to_rep (select (elts o15) (+ k 1))) (to_rep (select (elts o17) k))))))))))))

;; H
  (assert (invariant____function_guard (invariant__ bb) bb))

(assert
;; WP_parameter_def
 ;; File "perm.ads", line 2, characters 0-0
  (not (= (invariant__ bb) true)))
(check-sat)
