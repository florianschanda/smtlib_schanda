...
(declare-fun temp___474 () Bool)

(declare-fun temp___4741 () unsigned_byte)

(declare-fun temp___4742 () unsigned_byte)
...
;; H
  (assert
  (= (bool_eq2 (mk___rep1 r__split_fields3)
     (mk___rep1
     (mk___split_fields1
     (rec__records_prooffuncs__optional_pair__exists
     (us_split_fields3 r_old))
     (mk___rep
     (mk___split_fields (of_rep x)
     (rec__records_prooffuncs__pair__b
     (us_split_fields1
     (rec__records_prooffuncs__optional_pair__the_pair
...
;; H
  ...
  (= (rec__records_prooffuncs__pair__a
     (us_split_fields1
     (rec__records_prooffuncs__optional_pair__the_pair r__split_fields3))) 
  o1))
...
;; H
  (assert
  (= (rec__records_prooffuncs__optional_pair__exists r__split_fields3) 
  o5))
...
;; H
  (assert (= temp___474 o5))

;; H
  (assert (= temp___4741 o6))

;; H
  (assert (= temp___4742 o7))

;; H
  (assert (= result (mk___split_fields__ref1 r__split_fields3)))

;; H
  (assert
  (= r__split_fields4 (mk___split_fields1 temp___474
                      (mk___rep (mk___split_fields temp___4741 temp___4742)))))
...
(assert
;; WP_parameter_def
 ;; File "records.adb", line 464, characters 0-0
  (not
  (= (bool_eq2 (mk___rep1 (us_split_fields__content1 r__split_fields5))
     (mk___rep1
     (mk___split_fields1 r__split_fields
     (mk___rep (mk___split_fields (of_rep x) (of_rep x)))))) true)))
(check-sat)
