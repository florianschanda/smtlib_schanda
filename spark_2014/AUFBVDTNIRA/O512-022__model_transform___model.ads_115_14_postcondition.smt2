...
(declare-fun temp___454 () uml_action_access)

(declare-fun temp___4541 () uml_action_access)
...
;; H
  (assert (= temp___454 self__split_fields2))

;; H
  (assert (= temp___4541 self__split_fields3))
