...
(define-fun bool_eq5 ((a (Array Int num)) (a__first Int) (a__last Int)
...
(define-fun bool_eq12 ((a (Array Int us_rep1)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq11 (select a temp___idx_141)
...
(define-fun bool_eq14 ((a (Array Int us_rep2)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq13 (select a temp___idx_142)
...
(define-fun bool_eq16 ((a (Array Int us_rep3)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq15 (select a temp___idx_143)
...
(define-fun o11 () us_rep (mk___rep (mk___split_fields o4 o5)))
...
;; H
  (assert (= result (ite (not (= o10 true)) true false)))
...
;; H
  ...
  (= (bool_eq1
     (rec__database__account_rec__owner_name
     (us_split_fields5 (select accounts account))) 1 255 customer 1 255) true))

;; H
  (assert
  (= (bool_eq5
     (rec__database__account_rec__owner_id
     (us_split_fields5 (select accounts account))) 0 2 id 0 2) true))
...
;; WP_parameter_def
 ;; File "database.ads", line 26, characters 0-0
  (not (not (= (is_available account links) true))))
(check-sat)
