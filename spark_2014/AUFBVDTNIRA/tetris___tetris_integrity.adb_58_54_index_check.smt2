...
;; H
  (assert
  (and
  (forall ((temp___782 Int))
  (=> (and (<= 1 temp___782) (<= temp___782 50))
  (=> (not (= (+ (to_rep3 cur_piece__split_fields3) y2) temp___782))
  (= (select cur_board1 temp___782) (select cur_board temp___782)))))
  (and (<= 0 x2) (<= x2 2))))
