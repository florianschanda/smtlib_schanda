...
;; H
  (assert
  (and (= o23 (extract_unsigned_16 query 10))
  (extract_unsigned_16__function_guard o23 query 10)))
...
;; H
  (assert
  (= (to_rep2
     (rec__parse__parse_result_t__return_code result____split_discrs7)) 
  r26b))
...
;; H
  (assert (= temp___338 (mk___rep2 o25 (mk___split_fields2 dummy6) true)))
...
;; WP_parameter_def
 ;; File "parse.ads", line 16, characters 0-0
  (not
  (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___338)) 
  (rec__parse__parse_result_t__return_code result____split_discrs7))))
(check-sat)
