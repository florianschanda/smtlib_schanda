...
(define-fun unbounded__vect__append__2__container__fields2 () us_split_fields 
...
;; H
  (assert (= v__split_fields5 unbounded__vect__clear__container__fields1))
...
;; H
  (assert
  (= (oeq (mk___rep v__split_discrs v__split_fields5) (empty_vector Tuple0)) true))
...
;; H
  ...
  (= (get
     ...
     (+ (last (model__ (mk___rep v__split_discrs v__split_fields5))) 1)) 1)))
...
;; H
  (assert
  (= v__split_fields4 unbounded__vect__append__2__container__fields3))
...
;; H
  ...
  (= (length
     ...
     unbounded__vect__append__2__container__fields2)) (+ (length
                                                         ...
                                                         v__split_discrs
                                                         v__split_fields4)) 1))
  (= (olt (model__ (mk___rep v__split_discrs v__split_fields4))
     (model__
     (mk___rep v__split_discrs
  ...
  (= (get
     ...
     (+ (last (model__ (mk___rep v__split_discrs v__split_fields4))) 1)) 2)))
...
;; H
  (assert
  (= v__split_fields3 unbounded__vect__append__2__container__fields2))

(assert
;; WP_parameter_def
 ;; File "a-cofove.ads", line 807, characters 0-0
  (not
  (< (length (mk___rep v__split_discrs v__split_fields3)) (capacity
                                                          (mk___rep
                                                          v__split_discrs
                                                          v__split_fields3)))))
(check-sat)
