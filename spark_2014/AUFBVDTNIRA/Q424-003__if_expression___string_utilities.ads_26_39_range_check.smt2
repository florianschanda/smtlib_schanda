...
(declare-fun temp___314 () (Array Int character))
...
(declare-fun result5 () string__ref)

(declare-fun string_utilities__longest_common_subsequence__result4 () us_t)

(declare-fun string_utilities__longest_common_subsequence__result5 () string__ref)
...
(declare-fun string_utilities__longest_common_subsequence__result7 () us_t)

(declare-fun result9 () map__ref)

(declare-fun result__3 () (Array Int character))

(declare-fun result10 () string__ref)

(declare-fun string_utilities__longest_common_subsequence__result8 () us_t)

(declare-fun result__4 () map__ref)

(declare-fun rx4 () int__ref)

(declare-fun x111 () int__ref)

(declare-fun x217 () int__ref)

(declare-fun string_utilities__longest_common_subsequence__result9 () string__ref)
...
(declare-fun string_utilities__longest_common_subsequence__result10 () us_t)

(declare-fun result__6 () map__ref)

(declare-fun rx6 () int__ref)

(declare-fun x113 () int__ref)

(declare-fun x219 () int__ref)

(declare-fun string_utilities__longest_common_subsequence__result11 () string__ref)
...
(declare-fun string_utilities__longest_common_subsequence__result12 () us_t)

(declare-fun lengths14 () map__ref1)

(declare-fun x115 () int__ref)

(declare-fun x221 () int__ref)

(declare-fun result__8 () map__ref)

(declare-fun rx8 () int__ref)

(declare-fun x116 () int__ref)

(declare-fun x222 () int__ref)

(declare-fun string_utilities__longest_common_subsequence__result13 () string__ref)

(declare-fun lengths15 () map1)
...
(declare-fun string_utilities__longest_common_subsequence__result14 () us_t)

(define-fun x225 () int__ref (mk_int__ref x29))

(define-fun lengths16 () map__ref1 (mk_map__ref1 lengths8))

(define-fun string_utilities__longest_common_subsequence__result15 () string__ref 
  (mk_string__ref
  (mk___t string_utilities__longest_common_subsequence__result
...
;; H
  ...
  (= (get lengths2 temp___301 temp___302) (get temp___300 temp___301
                                          temp___302))))))
  (and (<= (to_rep1 (first (rt s1))) x14) (<= x14 (to_rep1 (last (rt s1))))))))
...
;; H
  ...
  (=> (or (<= x26 temp___295) (not (= x14 temp___294)))
  (= (get lengths3 temp___294 temp___295) (get temp___293 temp___294
                                          temp___295))))))
  (and (<= (to_rep1 (first (rt s2))) x26) (<= x26 (to_rep1 (last (rt s2)))))))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 (first (rt s2))) x25) (<= x25 (to_rep1 (last (rt s2)))))
  (=> (= (to_rep (select (elts s1) x14)) (to_rep (select (elts s2) x26)))
  (and (= o1 (- x26 1)) (in_range1 (- x26 1)))))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt s2))) x25) (<= x25 (to_rep1 (last (rt s2)))))
  (=>
  (not (= (to_rep (select (elts s1) x14)) (to_rep (select (elts s2) x26))))
  (and (= o10 (- x26 1)) (in_range1 (- x26 1)))))))
...
;; H
  ...
  (not (= (to_rep (select (elts s1) x14)) (to_rep (select (elts s2) x26))))
  (and
  (and (= o12 (get_length x14 o11 lengths3)) (get_length__function_guard 
  o12 x14 o11 lengths3))
  (and (dynamic_property3 0 last4 o12)
  (= o12 (ite (and (dynamic_property1 first2 last2 x14) (dynamic_property2
              first3 last3 o11))
         (to_rep2 (get lengths3 x14 o11)) 0))))))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 (first (rt s2))) x25) (<= x25 (to_rep1 (last (rt s2)))))
  (= lengths16 (mk_map__ref1 lengths6)))))
...
;; H
  ...
  (and
  (and
  (= string_utilities__longest_common_subsequence__result11 (mk_string__ref
                                                            string_utilities__longest_common_subsequence__result4))
  (and (= x219 x226)
  (and (= x113 x119) (and (= rx6 rx10) (= result__6 (mk_map__ref result__))))))
  (and
  (= string_utilities__longest_common_subsequence__result12 string_utilities__longest_common_subsequence__result4)
  (and (= x220 x23)
  (and (= x114 x12) (and (= rx7 rx1) (= result__7 result__1))))))
  (and
  (and
  (and
  ...
  (= result4 (ite (= o18 0) true false)))
  (and (= result4 true)
  (and (= result5 string_utilities__longest_common_subsequence__result15)
  (= string_utilities__longest_common_subsequence__result4 (mk___t
                                                           (temp___String_Literal_305
                                                           Tuple0) (mk 1 0)))))))
  (and
  (and
  (and
  ...
  (and
  (= string_utilities__longest_common_subsequence__result5 string_utilities__longest_common_subsequence__result15)
  (= string_utilities__longest_common_subsequence__result6 (mk___t
                                                           string_utilities__longest_common_subsequence__result2
                                                           string_utilities__longest_common_subsequence__result3)))))
  (and
  (and
  (and
  (= string_utilities__longest_common_subsequence__result11 string_utilities__longest_common_subsequence__result9)
  (and (= x219 x217)
  (and (= x113 x111) (and (= rx6 rx4) (= result__6 result__4)))))
  (and
  (= string_utilities__longest_common_subsequence__result12 string_utilities__longest_common_subsequence__result10)
  (and (= x220 x218)
  (and (= x114 x112) (and (= rx7 rx5) (= result__7 result__5))))))
  (and
  (and
  (and
  (= string_utilities__longest_common_subsequence__result9 (mk_string__ref
                                                           string_utilities__longest_common_subsequence__result8))
  (and (= x217 (mk_int__ref x216))
  (and (= x111 (mk_int__ref x110))
  (and (= rx4 (mk_int__ref rx3)) (= result__4 (mk_map__ref result__3))))))
  (and
  (= string_utilities__longest_common_subsequence__result10 string_utilities__longest_common_subsequence__result8)
  (and (= x218 x216)
  (and (= x112 x110) (and (= rx5 rx3) (= result__5 result__3))))))
  (and
  (and
  (and
  ...
  (to_rep1 result____last))) (= o20 (to_rep1 result____last)))
  (and (= result6 rx10) (= rx2 o20)))
  (and (dynamic_property9 1 last12 rx2)
  (and
  (and
  (and (and (= us3 last2) (dynamic_property1 first2 last2 last2))
  (= o21 last2)) (and (= result7 x119) (= x19 o21)))
  (and (dynamic_property1 first2 last2 x19)
  (and
  (and
  (and (and (= us4 last3) (dynamic_property2 first3 last3 last3))
  (= o22 last3)) (and (= result8 x226) (= x215 o22)))
  (and (dynamic_property2 first3 last3 x215)
  (and (= temp___316 rx2)
  (and (= temp___314 result__)
  (and (= temp___312 x215)
  (and (= temp___311 x19)
  (and
  (and
  (and (=> (<= first2 last2) (dynamic_property1 first2 last2 x110))
  (=> (<= first3 last3) (dynamic_property2 first3 last3 x216)))
  (=> (<= 1 last12) (dynamic_property9 1 last12 rx3)))
  (and (= (to_rep (select (elts s1) x110)) (to_rep (select (elts s2) x216)))
  (and
  (and
  (and (= (to_rep o23) (to_rep (select (elts s1) x110)))
  (= o24 (store result__2 rx3 o23)))
  (and (= result9 (mk_map__ref result__2)) (= result__3 o24)))
  (and (= rx3 1)
  (and
  (= result10 (mk_string__ref
              string_utilities__longest_common_subsequence__result7))
  (= string_utilities__longest_common_subsequence__result8 (mk___t result__3
                                                           (mk
                                                           (to_rep1
                                                           result____first)
                                                           (to_rep1
...
;; H
  (assert
  (= string_utilities__longest_common_subsequence__result13 string_utilities__longest_common_subsequence__result11))
...
;; H
  (assert
  (= string_utilities__longest_common_subsequence__result14 string_utilities__longest_common_subsequence__result12))
...
;; H
  (assert (slow_lcs_length__function_guard (slow_lcs_length s1 (tail s2)) 
  s1 (tail s2)))
...
;; H
  (assert (slow_lcs_length__function_guard (slow_lcs_length (tail s1) s2)
  (tail s1) s2))

;; H
  (assert
  (and
  (and (= o25 (slow_lcs_length s1 s2)) (slow_lcs_length__function_guard 
  o25 s1 s2))
  (and (in_range4 o25)
  (= o25 (ite (or
              (= (bool_eq3 (elts s1) (to_rep1 (first (rt s1)))
                 (to_rep1 (last (rt s1))) (temp___String_Literal_178 Tuple0)
                 1 0) true)
              (= (bool_eq3 (elts s2) (to_rep1 (first (rt s2)))
                 (to_rep1 (last (rt s2))) (temp___String_Literal_180 Tuple0)
                 1 0) true))
         0
         (ite (= (head s1) (head s2))
         (+ 1 (slow_lcs_length (tail s1) (tail s2)))
         (ite (< (slow_lcs_length s1 (tail s2)) (slow_lcs_length (tail s1)
                                                s2)) (slow_lcs_length
                                                     (tail s1) s2) (slow_lcs_length
                                                                   s1
                                                                   (tail s2)))))))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range1
  (length
  (string__content string_utilities__longest_common_subsequence__result13)))))
(check-sat)
