...
(declare-fun usedlogfiles__split_fields7 () us_split_fields__ref)

(declare-fun k1 () int__ref)
...
;; H
  (assert
  (= usedlogfiles__split_fields7 (mk___split_fields__ref
...
;; H
  (assert (= usedlogfiles__split_fields8 usedlogfiles__split_fields6))
...
;; H
  ...
  (= o7 (+ (to_rep4
           (rec__auditlog__logfilelistt__lasti
           (us_split_fields__content usedlogfiles__split_fields7))) 1))
  (in_range7
  (+ (to_rep4
     (rec__auditlog__logfilelistt__lasti
     (us_split_fields__content usedlogfiles__split_fields7))) 1))))
...
;; H
  ...
  (= o9 (mk___split_fields
        ...
        (us_split_fields__content usedlogfiles__split_fields7))
        (rec__auditlog__logfilelistt__head
        (us_split_fields__content usedlogfiles__split_fields7)) o8
        (rec__auditlog__logfilelistt__length
        (us_split_fields__content usedlogfiles__split_fields7)))))
...
;; WP_parameter_def
 ;; File "auditlog.adb", line 174, characters 0-0
  (not (in_range6
  (+ (to_rep3
     (rec__auditlog__logfilelistt__length usedlogfiles__split_fields9)) 1))))
(check-sat)
