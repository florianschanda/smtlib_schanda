...
;; H
  (assert
  (and (and (= o5 (pow7 x)) (pow7__function_guard o5 x))
  (and (tqtisFinite o5)
  (= o5 (mul RNE2
...
;; H
  (assert (= o6 (div1 RNE2 o5 fliteral2)))
...
;; H
  (assert (= o4 (div1 RNE2 o3 fliteral3)))
...
;; H
  (assert (= o1 (div1 RNE2 o fliteral4)))

;; H
  (assert (= o2 (sub RNE2 x o1)))
