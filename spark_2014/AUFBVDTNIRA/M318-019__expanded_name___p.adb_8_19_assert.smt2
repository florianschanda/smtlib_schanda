...
;; H
  (assert
  (= (slide temp___148 (to_rep (first4 temp___1481)) a) p__x__assume))
...
;; H
  (assert (= (to_rep x__first) (to_rep (first1 p__x__assume1))))

;; H
  (assert (= (to_rep x__last) (to_rep (last1 p__x__assume1))))
