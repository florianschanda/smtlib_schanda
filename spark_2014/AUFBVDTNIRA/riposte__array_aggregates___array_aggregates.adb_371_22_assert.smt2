...
;; def_axiom
  (assert
  (forall ((temp___616 Int) (temp___617 Int))
  (let ((temp___615 (temp___614 temp___616 temp___617)))
  (and (= (select temp___615 0) (of_rep temp___616))
  (= (select temp___615 1) (of_rep temp___617))))))
