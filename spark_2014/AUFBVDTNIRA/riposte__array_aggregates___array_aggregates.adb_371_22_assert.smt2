...
(declare-fun user_eq1 (t109b t109b) Bool)

(declare-fun dummy1 () t109b)
...
(declare-fun temp___622 (Int Int) (Array Int unsigned_byte))

;; def_axiom
  (assert
  (forall ((temp___624 Int) (temp___625 Int))
  (let ((temp___623 (temp___622 temp___624 temp___625)))
  (and (= (select temp___623 0) (of_rep temp___624))
  (= (select temp___623 1) (of_rep temp___625))))))
