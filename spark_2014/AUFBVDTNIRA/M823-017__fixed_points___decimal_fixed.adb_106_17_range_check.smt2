...
(declare-fun result10 () t2)

(declare-fun u4 () t2)

(declare-fun result11 () t2)

(declare-fun u5 () t2)

(declare-fun result12 () t2)

(declare-fun u6 () t2)

(declare-fun result13 () t2)
...
;; H
  (assert (= (to_fixed1 o11) (of_float32 (add RNE2 z31 z31))))
...
;; H
  (assert (= (to_fixed1 o12) (of_float32 (sub RNE2 (add RNE2 z31 z31) z31))))
