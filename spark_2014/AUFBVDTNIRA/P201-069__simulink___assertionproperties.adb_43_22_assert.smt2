...
(declare-fun pow__2 (t t) t)

(declare-fun pow__2__function_guard (t t t) Bool)
...
(define-fun dynamic_invariant1 ((temp___expr_213 t) (temp___is_init_210 Bool)
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral4) (/ 50000000000000000000000000000000000000000000000000000.0 100000000000000000000000000000000000000000000000000000.0))))
...
(declare-fun sqrt_out1 () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun sqrt_out11 () t)
...
;; H
  (assert (neq x fliteral3))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite sqrt_out1)))

;; H
  (assert
  (and
  (and (= o (pow__2 x fliteral4)) (pow__2__function_guard o x fliteral4))
  (tqtisFinite o)))
