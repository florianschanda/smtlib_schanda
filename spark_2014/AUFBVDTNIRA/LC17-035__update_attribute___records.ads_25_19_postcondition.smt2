...
(declare-fun o3 () my_range)

(declare-fun o4 () integer)

(declare-fun temp___222 () integer)

(declare-fun temp___2221 () natural)

(declare-fun temp___2222 () my_range)
...
(declare-fun o8 () my_range)

(declare-fun o9 () integer)

(declare-fun temp___224 () integer)

(declare-fun temp___2241 () natural)

(declare-fun temp___2242 () my_range)

(declare-fun temp___2243 () integer)
...
(declare-fun o13 () my_range)

(declare-fun o14 () integer)

(declare-fun temp___226 () integer)

(declare-fun temp___2261 () natural)

(declare-fun temp___2262 () my_range)

(declare-fun temp___2263 () integer)
...
(declare-fun result9 () natural)

(declare-fun result10 () my_range)
...
(declare-fun r__split_fields20 () us_split_fields)
...
;; H
  (assert (= temp___222 o1))

;; H
  (assert (= temp___2221 o2))

;; H
  (assert (= temp___2222 o3))

;; H
  (assert (= temp___2223 o4))
...
;; H
  (assert (= temp___222 r__split_fields4))

;; H
  (assert (= temp___2221 r__split_fields5))

;; H
  (assert (= temp___2222 r__split_fields6))

;; H
  (assert (= temp___2223 r__split_fields7))

;; H
  (assert (= (to_rep1 o5) new_data))
...
;; H
  (assert (= temp___224 o6))

;; H
  (assert (= temp___2241 o7))

;; H
  (assert (= temp___2242 o8))

;; H
  (assert (= temp___2243 o9))
...
;; H
  (assert (= temp___224 r__split_fields8))

;; H
  (assert (= temp___2241 r__split_fields9))

;; H
  (assert (= temp___2242 r__split_fields10))

;; H
  (assert (= temp___2243 r__split_fields11))

;; H
  (assert (= (to_rep2 o10) 10))
...
;; H
  (assert (= temp___226 o11))

;; H
  (assert (= temp___2261 o12))

;; H
  (assert (= temp___2262 o13))

;; H
  (assert (= temp___2263 o14))
...
;; H
  (assert (= temp___226 r__split_fields12))

;; H
  (assert (= temp___2261 r__split_fields13))

;; H
  (assert (= temp___2262 r__split_fields14))

;; H
  (assert (= temp___2263 r__split_fields15))
...
(assert
;; WP_parameter_def
 ;; File "records.ads", line 20, characters 0-0
  (not
  (= (bool_eq3
     (mk___rep
     ...
     r__split_fields19))
     (mk___rep
     (mk___split_fields (of_rep 10) (of_rep1 new_data) (of_rep2 10)
     r__split_fields3))) true)))
(check-sat)
