...
(declare-fun dummy9 () minute_type)
...
(declare-fun dummy10 () second_type)
...
(declare-fun dummy13 () status_type)
...
(define-fun dynamic_invariant1 ((temp___expr_226 Int)
  ...
  (temp___do_toplevel_225 Bool)) Bool (=>
                                      ...
                                      (<= 0 3)) (in_range10 temp___expr_226)))
...
(declare-fun dummy14 () description_count_type)
...
(declare-fun dummy15 () (Array Int character))
...
(define-fun bool_eq17 ((a (Array Int us_rep3)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq16 (select a temp___idx_132)
...
(declare-fun description () us_t)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun date () us_rep2)
...
(declare-fun dummy17 () description_index_type)
...
(declare-fun dummy18 () event_index_type)
...
(define-fun dynamic_invariant2 ((temp___expr_297 Int)
...
(declare-fun temp___358 (Int Int Int) us_t1)

;; def_axiom
  (assert
  (forall ((temp___360 Int) (temp___361 Int) (temp___362 Int))
  (let ((temp___359 (temp___358 temp___360 temp___361 temp___362)))
  (and
  (=> (dynamic_property 1 2147483647 temp___361 temp___362)
  (and (= (first3 temp___359) temp___361) (= (last4 temp___359) temp___362)))
  (forall ((temp___363 Int))
  (= (select (to_array1 temp___359) temp___363) (of_rep temp___360)))))))
...
(declare-fun temp___355 () Int)

(declare-fun temp___354 () Bool)

(declare-fun temp___365 () (Array Int character))

(declare-fun temp___3651 () t1)
...
(declare-fun temp___366 () (Array Int character))

(declare-fun temp___3661 () t)

(declare-fun result () int__ref)

(declare-fun available1 () Int)
...
(declare-fun available2 () Int)

(declare-fun index2 () Int)

(declare-fun result3 () int__ref)

(declare-fun available3 () Int)

(declare-fun result4 () bool__ref)

(declare-fun found3 () Bool)

(declare-fun found4 () bool__ref)

(declare-fun available4 () int__ref)

(declare-fun found5 () Bool)

(declare-fun available5 () Int)

(declare-fun found6 () bool__ref)

(declare-fun available6 () int__ref)

(declare-fun index3 () int__ref)

(declare-fun found7 () Bool)

(declare-fun available7 () Int)

(declare-fun index4 () Int)

(declare-fun found8 () bool__ref)

(declare-fun available8 () int__ref)

(declare-fun index5 () int__ref)

(declare-fun found9 () Bool)

(declare-fun available9 () Int)
...
;; H
  (assert (=> (and (<= 1 index1) (<= index1 64)) (= temp___355 available1)))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 64)) (= temp___354 found1)))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 64))
  (and (=> (<= 1 64) (in_range13 available2))
...
;; H
  ...
  (and
  (and
  (and (= available4 (mk_int__ref available3))
  (= found4 (mk_bool__ref found3)))
  (and (= available5 available3) (= found5 found3)))
  (and
  (not
  (= (rec__datebook__event_record__is_used
     (us_split_fields7 (select event_array index2))) true))
  (and (and (= result3 (mk_int__ref available2)) (= available3 index2))
  (and (= result4 (mk_bool__ref found2)) (= found3 (of_int 1))))))
  (and
  (and
  (= (rec__datebook__event_record__is_used
     (us_split_fields7 (select event_array index2))) true)
  (and (= available3 available2) (= found3 found2)))
  (and
  (and
  (and (= available4 (mk_int__ref available3))
  (= found4 (mk_bool__ref found3)))
  (and (= available5 available3) (= found5 found3))) (= index2 64))))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 64)) (= index3 (mk_int__ref index2))))
...
;; H
  (assert
  (=> (not (and (<= 1 index1) (<= index1 64)))
  (= index5 (mk_int__ref index1))))

;; H
  (assert
  (=> (not (and (<= 1 index1) (<= index1 64)))
  (= available8 (mk_int__ref available1))))

;; H
  (assert
  (=> (not (and (<= 1 index1) (<= index1 64)))
  (= found8 (mk_bool__ref found1))))
...
;; H
  (assert
  (=> (not (and (<= 1 index1) (<= index1 64))) (= available9 available1)))
...
;; H
  (assert
  (= (to_rep1 (first2 (rt1 (temp___358 32 1 (- 128 (length description)))))) 1))

;; H
  (assert
  (= (to_rep1 (last3 (rt1 (temp___358 32 1 (- 128 (length description)))))) (- 128 
  (length description))))

;; H
  (assert
  (= (mk___t1 temp___365 temp___3651) (temp___358 32 1
                                      (- 128 (length description)))))

;; H
  (assert (=> (= (length description) 0) (= temp___365 temp___366)))

;; H
  (assert
  (=> (= (length description) 0)
  (= (mk (to_rep1 (first2 temp___3651)) (to_rep1 (last3 temp___3651))) 
  temp___3661)))

;; H
  (assert
  (=> (not (= (length description) 0))
  (=> (<= (to_rep1 (first2 temp___3651)) (to_rep1 (last3 temp___3651)))
  (= o (+ (- (to_rep1 (last3 temp___3651)) (to_rep1 (first2 temp___3651))) 1)))))

;; H
  (assert
  (=> (not (= (length description) 0))
  (=> (not (<= (to_rep1 (first2 temp___3651)) (to_rep1 (last3 temp___3651))))
  (= o 0))))
...
;; H
  ...
  (= o1 (+ (- (to_rep1 (last (rt description))) (to_rep1
                                                (first (rt description)))) 1)))))
...
;; H
  (assert (=> (not (= (length description) 0)) (= o2 (+ o1 o))))

;; H
  (assert
  (=> (not (= (length description) 0))
  (= o3 (+ (to_rep1 (first (rt description))) o2))))

;; H
  (assert (=> (not (= (length description) 0)) (= o4 (- o3 1))))

;; H
  (assert
  (=> (not (= (length description) 0)) (and (= o5 o4) (in_range2 o4))))

;; H
  (assert
  (=> (not (= (length description) 0))
  (= (concat1 (elts description) (to_rep1 (first (rt description)))
     (to_rep1 (last (rt description))) temp___365
     (to_rep1 (first2 temp___3651)) (to_rep1 (last3 temp___3651))) temp___366)))

;; H
  (assert
  (=> (not (= (length description) 0))
  (= (mk (to_rep1 (first (rt description))) o5) temp___3661)))

(assert
;; WP_parameter_def
 ;; File "datebook.adb", line 38, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first temp___3661)) (to_rep1 (last temp___3661)))
     (+ (- (to_rep1 (last temp___3661)) (to_rep1 (first temp___3661))) 1) 0) 
  (ite (<= 1 128) (+ (- 128 1) 1) 0))))
(check-sat)
