...
(declare-fun user_eq1 (nb_float_type nb_float_type) Bool)
...
(declare-fun dummy1 () nb_float_type)
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral4) (= (tqtreal fliteral4) 8.0)))

(define-fun in_range3 ((x t)) Bool (and (tqtisFinite x)
                                   (and (le fliteral2 x) (le x fliteral4))))

(define-fun bool_eq3 ((x t) (y t)) Bool (ite (eq x y) true false))

(declare-fun user_eq2 (ttmpS ttmpS) Bool)
...
(define-fun dynamic_invariant2 ((temp___expr_177 t) (temp___is_init_174 Bool)
  (temp___skip_constant_175 Bool)
  (temp___do_toplevel_176 Bool)) Bool (=>
                                      (or (= temp___is_init_174 true) (le
                                      fliteral2 fliteral4)) (in_range3
                                      temp___expr_177)))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral6) (/ 500000000000000000000000.0 1000000000000000000000000.0))))
...
;; H
  (assert (and (lt fliteral2 time) (lt time fliteral5)))

;; H
  (assert (= (mk_t__ref result) (mk_t__ref tmp)))

;; H
  (assert (= tmp1 (mul RNE2 fliteral6 nb)))
...
;; H
  (assert
  (and (= o (add RNE2 time tmp1)) (tqtisFinite (add RNE2 time tmp1))))
