...
(declare-fun dummy5 () vector_element)
...
(define-fun bool_eq6 ((a (Array Int vector_element)) (af Int) (al Int)
...
(declare-fun temp___156 () index)

(declare-fun temp___1561 () extended_index)
...
(declare-fun temp___160 () slice_bounds)

(declare-fun temp___159 () slice_bounds)

(declare-fun o4 () Int)

(declare-fun o5 () Int)

(declare-fun o6 () extended_index)

(declare-fun o7 () index)

(declare-fun o8 () us_split_fields)

(declare-fun temp___157 () slice_bounds)
...
(declare-fun current_slice__split_fields () us_split_fields)
...
(declare-fun current_slice__split_fields1 () us_split_fields)
...
(declare-fun current_slice__split_fields2 () us_split_fields)
...
(declare-fun max_sum4 () Int)

(declare-fun max_sum5 () int__ref)

(declare-fun result____split_fields6 () us_split_fields__ref)

(declare-fun current_slice__split_fields3 () us_split_fields__ref)

(declare-fun current_sum4 () int__ref)

(declare-fun hi3 () int__ref)

(declare-fun max_sum6 () Int)

(declare-fun result____split_fields7 () us_split_fields)

(declare-fun current_slice__split_fields4 () us_split_fields)

(declare-fun current_sum5 () Int)

(declare-fun hi4 () Int)

(declare-fun max_sum7 () int__ref)

(declare-fun result____split_fields8 () us_split_fields__ref)

(declare-fun current_slice__split_fields5 () us_split_fields__ref)

(declare-fun current_sum6 () int__ref)

(declare-fun hi5 () int__ref)

(declare-fun max_sum8 () Int)

(declare-fun result____split_fields9 () us_split_fields)

(declare-fun current_slice__split_fields6 () us_split_fields)

(declare-fun current_sum7 () Int)
...
(declare-fun max_sum9 () int__ref)

(declare-fun result____split_fields10 () us_split_fields__ref)

(declare-fun current_slice__split_fields7 () us_split_fields__ref)

(declare-fun current_sum8 () int__ref)

(declare-fun lo4 () int__ref)

(declare-fun hi7 () int__ref)

(declare-fun max_sum10 () Int)

(declare-fun result____split_fields11 () us_split_fields)

(declare-fun current_slice__split_fields8 () us_split_fields)

(declare-fun current_sum9 () Int)
...
;; H
  (assert
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (= temp___163 max_sum2)))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (= temp___161 current_sum1)))

;; H
  (assert
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (= temp___160 (mk_slice_bounds current_slice__split_fields))))
...
;; H
  ...
  (forall ((hi_index Int))
  (=> (and (<= (to_rep3 (first (rt x))) hi_index) (<= hi_index (- hi2 1)))
  (<= (sum__logic x
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (= result4 (mk___split_fields__ref current_slice__split_fields1))))

;; H
  (assert
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (= current_slice__split_fields2 (us_split_fields1 temp___157))))

;; H
  (assert
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (= result5 (mk_int__ref current_sum2))))

;; H
  (assert
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (= current_sum3 (sum__logic x
                  (mk_slice_bounds current_slice__split_fields2)))))

;; H
  (assert
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (=> (< max_sum3 current_sum3)
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (=> (< max_sum3 current_sum3)
  (= result____split_fields5 current_slice__split_fields2))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (=> (< max_sum3 current_sum3)
  (and (= o9 current_sum3) (in_range2 current_sum3)))))

;; H
  (assert
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (=> (< max_sum3 current_sum3) (= result7 (mk_int__ref max_sum3)))))

;; H
  (assert
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (=> (< max_sum3 current_sum3) (= max_sum4 o9))))

;; H
  (assert
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (=> (not (< max_sum3 current_sum3))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (=> (not (< max_sum3 current_sum3)) (= max_sum4 max_sum3))))

;; H
  (assert
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (= hi2 (to_rep3 (last (rt x))))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (= current_sum4 (mk_int__ref current_sum3))))

;; H
  (assert
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (= current_slice__split_fields3 (mk___split_fields__ref
                                  current_slice__split_fields2))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (= current_sum5 current_sum3)))

;; H
  (assert
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (= current_slice__split_fields4 current_slice__split_fields2)))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (= current_slice__split_fields5 current_slice__split_fields3)))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x)))))
  (= current_slice__split_fields6 current_slice__split_fields4)))
...
;; H
  ...
  (not
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x))))))
  (= current_sum6 (mk_int__ref current_sum1))))
...
;; H
  ...
  (not
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x))))))
  (= current_slice__split_fields5 (mk___split_fields__ref
...
;; H
  ...
  (not
  (and (<= (to_rep3 (first (rt x))) hi1) (<= hi1 (to_rep3 (last (rt x))))))
  (= current_slice__split_fields6 current_slice__split_fields)))
...
;; H
  (assert (not (= lo2 (to_rep3 (last (rt x))))))
...
(declare-fun lo_index () Int)

;; H
  (assert (<= (to_rep3 (first (rt x))) lo_index))

;; H
  (assert (<= lo_index (- (int__content lo4) 1)))

(declare-fun hi_index () Int)

;; H
  (assert (<= (to_rep3 (first (rt x))) hi_index))

;; H
  (assert (<= hi_index (to_rep3 (last (rt x)))))
...
;; WP_parameter_def
 ;; File "sums.ads", line 12, characters 0-0
  ...
  (<= (sum__logic x
      (mk_slice_bounds
      (mk___split_fields (of_rep lo_index) (of_rep1 hi_index)))) (int__content
                                                                 max_sum9))))
(check-sat)
