...
(declare-fun temp___166 () (Array Int character))

(declare-fun temp___1661 () t1)
...
;; H
  (assert (dynamic_invariant2 name true false true))
...
;; H
  (assert
  (and (= o (to_rep1 (first (rt text)))) (in_range1
  (to_rep1 (first (rt text))))))
...
;; H
  (assert
  (=> (<= (to_rep1 (first (rt text))) r5b)
  (and
  (and (<= (to_rep1 (first (rt text))) (to_rep1 (first (rt text))))
  (<= (to_rep1 (first (rt text))) (to_rep1 (last (rt text)))))
  (and (<= (to_rep1 (first (rt text))) r5b)
  (<= r5b (to_rep1 (last (rt text))))))))

;; H
  (assert (= o1 (elts text)))

;; H
  (assert (= o1 temp___166))

;; H
  (assert (= (mk1 (to_rep1 (first (rt text))) r5b) temp___1661))

;; H
  (assert
  (= result (bool_eq3 (elts name) (to_rep1 (first (rt name)))
            (to_rep1 (last (rt name))) temp___166
            (to_rep1 (first3 temp___1661)) (to_rep1 (last3 temp___1661)))))
