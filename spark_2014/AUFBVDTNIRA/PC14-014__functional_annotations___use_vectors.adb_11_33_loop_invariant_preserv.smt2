...
(define-fun dynamic_invariant6 ((temp___expr_197 Int)
...
(define-fun dynamic_invariant7 ((temp___expr_143 Int)
...
(define-fun dynamic_invariant8 ((temp___expr_209 Int)
...
(define-fun dynamic_invariant9 ((temp___expr_254 Int)
  ...
  (temp___do_toplevel_253 Bool)) Bool (=>
                                      ...
                                      (<= first5 last7)) (dynamic_property6
                                      first5 last7 temp___expr_254)))

;; first__def_axiom
  (assert (= first5 (- first2 1)))
...
(define-fun dynamic_invariant11 ((temp___expr_242 Int)
...
(define-fun v2__split_fields4 () us_split_fields (mk___split_fields
                                                 v2__split_fields3))

(define-fun v2__split_fields5 () us_split_fields (mk___split_fields
                                                 v2__split_fields2))

(define-fun v2__split_fields6 () us_split_fields (mk___split_fields
                                                 v2__split_fields1))
...
;; H
  ...
  (and
  (= (length
     (mk___rep v2__split_discrs (mk___split_fields v2__split_fields))) 0)
...
;; H
  ...
  (is_incr (get (model__ v1) n)
  (get (model__ (mk___rep v2__split_discrs v2__split_fields6)) n))
  (get (model__ v1) n)
  (get (model__ (mk___rep v2__split_discrs v2__split_fields6)) n))))

;; H
  (assert
  (= (length (mk___rep v2__split_discrs v2__split_fields6)) (- i2 first)))
...
;; H
  ...
  (=>
  (and (<= first n)
  (<= n (last4 (model__ (mk___rep v2__split_discrs v2__split_fields6)))))
  (= (is_incr (get (model__ v1) n)
     (get (model__ (mk___rep v2__split_discrs v2__split_fields6)) n)) true))))
...
;; H
  (assert (=> (= result2 true) (= o5 (+ o4 1))))

;; H
  (assert (=> (= result2 true) (and (= o6 o5) (in_range2 o5))))
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep v2__split_discrs v2__split_fields5)) (+ (length
                                                               (mk___rep
                                                               v2__split_discrs
                                                               v2__split_fields6)) 1))
  (= (olt (model__ (mk___rep v2__split_discrs v2__split_fields6))
     (model__ (mk___rep v2__split_discrs v2__split_fields5))) true))
  (= (get (model__ (mk___rep v2__split_discrs v2__split_fields5))
     (+ (last4 (model__ (mk___rep v2__split_discrs v2__split_fields6))) 1)) 
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep v2__split_discrs v2__split_fields4)) (+ (length
                                                               (mk___rep
                                                               v2__split_discrs
                                                               v2__split_fields6)) 1))
  (= (olt (model__ (mk___rep v2__split_discrs v2__split_fields6))
     (model__ (mk___rep v2__split_discrs v2__split_fields4))) true))
  (= (get (model__ (mk___rep v2__split_discrs v2__split_fields4))
     (+ (last4 (model__ (mk___rep v2__split_discrs v2__split_fields6))) 1)) 
...
;; H
  (assert
  (=> (not (= result2 true)) (= v2__split_fields5 v2__split_fields4)))
...
;; WP_parameter_def
 ;; File "use_vectors.ads", line 33, characters 0-0
  (not
  (= (length (mk___rep v2__split_discrs v2__split_fields5)) (- i3 first))))
(check-sat)
