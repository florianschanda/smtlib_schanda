...
(declare-fun current4 () int__ref)

(declare-fun previous4 () int__ref)

(declare-fun d5 () int__ref)

(declare-fun i6 () Int)

(declare-fun current5 () Int)

(declare-fun previous5 () Int)

(declare-fun d6 () Int)

(declare-fun i7 () int__ref)

(declare-fun current6 () int__ref)

(declare-fun previous6 () int__ref)
...
;; H
  (assert (model____function_guard1 (model__1 (mk___rep3 t__split_fields5))
  (mk___rep3 t__split_fields5)))

;; H
  (assert (contains__function_guard1
  (contains1 (mk___rep3 t__split_fields5) v) (mk___rep3 t__split_fields5) 
  v))
...
;; H
  ...
  (rec__search_trees__search_tree__struct t__split_fields5) j)))
...
;; H
  (assert (=> (not (= current1 0)) (= temp___1327 current1)))

;; H
  (assert (=> (not (= current1 0)) (= temp___1326 i2)))

;; H
  (assert (=> (not (= current1 0)) (= temp___1325 d1)))

;; H
  (assert (=> (not (= current1 0)) (= temp___1324 previous1)))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             (rec__search_trees__search_tree__struct t__split_fields5)
             (to_rep1
             (rec__search_trees__search_tree__root t__split_fields5))) i9))) true)
  (=>
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct t__split_fields5)
             (to_rep1
             (rec__search_trees__search_tree__root t__split_fields5))) i9)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct t__split_fields5)
  ...
  (ite (= (get
          ...
          (+ (length
             ...
             (select (model__
                     ...
                     t__split_fields5)
                     (to_rep1
                     (rec__search_trees__search_tree__root t__split_fields5))) i9)))) 1)) 0)
  (< v (to_rep
       (select (rec__search_trees__search_tree__values t__split_fields5) i9)))
  (< (to_rep
     (select (rec__search_trees__search_tree__values t__split_fields5) i9)) 
  v))))))))
...
;; H
  (assert
  (=> (not (= current1 0)) (and (<= 1 previous3) (<= previous3 100))))
...
;; H
  (assert
  (=> (not (= current1 0))
  (=> (= result6 true) (= result7 (mk_int__ref d2)))))
...
;; H
  (assert
  (=> (not (= current1 0))
  (=> (not (= result6 true)) (= result8 (mk_int__ref d2)))))
...
;; H
  (assert
  (=> (not (= current1 0)) (and (= o6 previous3) (in_range3 previous3))))
...
;; H
  ...
  (= o7 (peek (rec__search_trees__search_tree__struct t__split_fields5) 
        o6 d3))
  (peek__function_guard o7
  (rec__search_trees__search_tree__struct t__split_fields5) o6 d3))
  (and (in_range4 o7)
  (and
  (ite (not (= o7 0))
  (and
...
;; H
  (assert
  (=> (not (not (= current1 0))) (= previous6 (mk_int__ref previous1))))

;; H
  (assert
  (=> (not (not (= current1 0))) (= current6 (mk_int__ref current1))))
...
;; WP_parameter_def
 ;; File "search_trees.adb", line 1175, characters 0-0
  (not (in_range3 (int__content previous6))))
(check-sat)
