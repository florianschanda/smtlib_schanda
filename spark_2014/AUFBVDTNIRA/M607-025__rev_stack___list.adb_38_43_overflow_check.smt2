...
;; H
  (assert (and (= o9 (- i9 first4)) (in_range1 (- i9 first4))))

;; H
  (assert
  (and (= o10 (length2 (mk___rep1 res__split_discrs res__split_fields2)))
  (and (in_range6 o10)
  (<= o10 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
...
;; H
  (assert
  (=> (= result5 true) (and (= o5 (- last6 i9)) (in_range1 (- last6 i9)))))

;; H
  (assert (=> (= result5 true) (= o6 (+ o5 1))))

;; H
  (assert (=> (= result5 true) (and (= o7 o6) (in_range1 o6))))

;; H
  (assert
  (=> (= result5 true)
  (and
  (and (= o4 (to__ (mk___rep s__split_fields9))) (to____function_guard 
  o4 (mk___rep s__split_fields9)))
  (and (dynamic_invariant1 o4 true false true)
  (and (= (to_rep (first (rt o4))) 1) (<= 0 (to_rep (last (rt o4)))))))))

;; H
  (assert (=> (= result5 true) (= o8 (to_rep (last (rt o4))))))

;; H
  (assert (=> (= result5 true) (= result4 (ite (= o8 o7) true false))))
...
;; H
  (assert (and (= o2 (- last6 i9)) (in_range1 (- last6 i9))))
