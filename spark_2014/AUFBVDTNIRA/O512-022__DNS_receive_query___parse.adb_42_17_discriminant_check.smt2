...
(declare-fun o17 () return_code_t)

(declare-fun o18 () us_split_discrs)

(declare-fun temp___324 () us_rep2)
...
;; H
  (assert
  (= (to_rep2
     (rec__parse__parse_result_t__return_code result____split_discrs3)) 
  r10b))
...
;; WP_parameter_def
 ;; File "parse.ads", line 16, characters 0-0
  (not
  (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___324)) 
  (rec__parse__parse_result_t__return_code result____split_discrs3))))
(check-sat)
