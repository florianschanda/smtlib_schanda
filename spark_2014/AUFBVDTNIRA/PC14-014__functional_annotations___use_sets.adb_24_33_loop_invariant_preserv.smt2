...
;; H
  (assert
  (let ((temp___892 (elements (mk___rep r__split_discrs r__split_fields5))))
...
;; H
  (assert
  (and (= temp___8801 (next s (mk___rep1 cu__split_fields4)))
...
;; H
  (assert (= cu__split_fields3 (mk___split_fields1 temp___880)))
