...
(define-fun dynamic_invariant ((temp___expr_7117 us_t1)
  ...
  (temp___do_toplevel_7116 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_7117))
                                       (and (= (first3 temp___expr_7117) 1)
                                       (= (last4 temp___expr_7117) 2)))))
...
(define-fun dynamic_invariant1 ((temp___expr_7135 us_t2)
  ...
  (temp___do_toplevel_7134 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_7135))
                                       (and (= (first5 temp___expr_7135) 1)
                                       (= (last6 temp___expr_7135) 2)))))
...
;; H
  (assert
  (and
  (and (= temp___80632 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___80632 reg)) (dynamic_invariant1
  temp___80632 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80631)) (to_rep (last5 temp___80631)))
     (+ (- (to_rep (last5 temp___80631)) (to_rep (first4 temp___80631))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80631)) (to_rep (last5 temp___80631))) 
  temp___80641))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___80641)) (to_rep (last3 temp___80641)))
     (+ (- (to_rep (last3 temp___80641)) (to_rep (first2 temp___80641))) 1)
