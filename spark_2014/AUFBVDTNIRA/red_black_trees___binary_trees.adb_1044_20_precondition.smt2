...
(declare-fun o32 () (Array Int us_rep1))
...
;; H
  ...
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i) (rec__tree_model__path_type__a (us_split_fields1 (select o32 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select o32 (parent
              (mk___rep2
...
;; H
  ...
  (= o32 (model__
         (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
         o31))
  (model____function_guard o32
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o31))
  (and (dynamic_invariant3 o32 true false true)
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o32 o31))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select o32 o31)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i o31))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select o32 (parent
                      ...
                      (mk___split_fields2 f__split_fields f__split_fields1))
                      i)))) true))
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o32 i))) true)
  (not
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o32 i))) true))))))
  (and
  (forall ((i Int))
  ...
  (= (is_add
     ...
     (position
     (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i)
     (rec__tree_model__path_type__a (us_split_fields1 (select o32 i)))) true)
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select o32 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o32 i))) true)
  ...
  (=>
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o32 j))) true)
  (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o32 i)))
     (rec__tree_model__path_type__a (us_split_fields1 (select o32 j)))) true))
  (= j i))))))))))))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  ...
  (= (valid_root
     (mk___rep2
     (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o29) true)))
(check-sat)
