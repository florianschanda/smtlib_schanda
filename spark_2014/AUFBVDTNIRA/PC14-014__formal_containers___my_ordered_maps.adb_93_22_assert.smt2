...
(declare-fun temp___960 () us_rep2)
...
(define-fun o39 () us_rep (mk___rep (mk___split_fields o12 o13)))

(define-fun o40 () us_rep (mk___rep (mk___split_fields o6 o7)))
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o40) true))
  (= (bool_eq2
     (get
     (keys
     (mk___rep1 l__split_discrs
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o40)) o40) true))
  (= (get2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o40) 1))
  (= (ole
     (model__
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (model__
  ...
  (= (range_equal
     ...
     (- (find
        (keys
        (mk___rep1 l__split_discrs
        my_ordered_maps__n__insert__2__container__fields)) o40) 1)) true))
  (= (range_shifted
     (keys (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (keys
     (mk___rep1 l__split_discrs
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o40)
     (length
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1)) o39) true))
  (= (bool_eq2
     (get
     (keys
     (mk___rep1 l__split_discrs
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1)) o39)) o39) true))
  (= (get2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1)) o39) 2))
  ...
  (= (keys_included_except
     ...
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields1)) o39) true))
  (= (range_equal (keys (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (- (find
        (keys
        (mk___rep1 l__split_discrs
        my_ordered_maps__n__insert__2__container__fields1)) o39) 1)) true))
  (= (range_shifted (keys (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1)) o39)
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields)) o26) true)
  (= (get2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields)) o26) 3))
  ...
  (= (bool_eq2
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields)) o26)) o26) true))
  ...
  (= (range_equal (keys (mk___rep1 l__split_discrs l__split_fields6))
     ...
     (- (find
        (keys
        (mk___rep1 l__split_discrs
        my_ordered_maps__n__include__container__fields)) o26) 1)) true))
  (= (range_shifted (keys (mk___rep1 l__split_discrs l__split_fields6))
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields)) o26)
...
;; H
  ...
  (= (has_key1 (model__ (mk___rep1 l__split_discrs l__split_fields7))
     (mk___rep (mk___split_fields (of_rep 3) (of_rep 3)))) true)))
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields1)) o30) true)
  (= (get2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields1)) o30) 3))
  ...
  (= (bool_eq2
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields1)) o30)) o30) true))
  ...
  (= (range_equal (keys (mk___rep1 l__split_discrs l__split_fields7))
     ...
     (- (find
        (keys
        (mk___rep1 l__split_discrs
        my_ordered_maps__n__include__container__fields1)) o30) 1)) true))
  (= (range_shifted (keys (mk___rep1 l__split_discrs l__split_fields7))
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields1)) o30)
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__delete__container__fields)) o34) true)))
  (= (ole
     (model__
     (mk___rep1 l__split_discrs
  ...
  (= (range_equal (keys (mk___rep1 l__split_discrs l__split_fields8))
     ...
     (- (find (keys (mk___rep1 l__split_discrs l__split_fields8)) o34) 1)) true))
  (= (range_shifted
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__delete__container__fields))
     (keys (mk___rep1 l__split_discrs l__split_fields8))
     (find (keys (mk___rep1 l__split_discrs l__split_fields8)) o34)
     (length
     (mk___rep1 l__split_discrs
...
;; H
  (assert
  (and
  (= temp___960 (find1 (mk___rep1 l__split_discrs l__split_fields9) o38))
  (ite (ite (= (has_key1
  ...
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___960) true))
  (= (bool_eq4 temp___960 no_element) true))
  (and
  (and
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___960) true)
  (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___960) (find (keys (mk___rep1 l__split_discrs l__split_fields9))
                 o38)))
  (= (equivalent_keys
     (key (mk___rep1 l__split_discrs l__split_fields9) temp___960) o38) true)))))
...
;; WP_parameter_def
 ;; File "my_ordered_maps.adb", line 4, characters 0-0
  ...
  (= (has_key1 (model__ (mk___rep1 l__split_discrs l__split_fields10))
     (mk___rep (mk___split_fields (of_rep 2) (of_rep 2)))) true))))
(check-sat)
