...
;; H
  (assert (and (= o1 (length m)) (and (in_range6 o1) (<= (+ 0 o1) 100))))

;; H
  (assert (and (= o2 o1) (in_range3 o1)))

;; H
  (assert (= result (ite (= length1 o2) true false)))
...
;; H
  (assert (<= i (- (- (+ first length1) 1) 100)))

;; H
  (assert
  (and (= o (+ (- (+ i 100) first) 1)) (in_range5 (+ (- (+ i 100) first) 1))))
