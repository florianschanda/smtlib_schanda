...
;; H
  (assert
  (and (= o11 (first l))
  (ite (= (= (length1 l) 0) true) (= (bool_eq5 o11 no_element) true)
...
;; H
  ...
  (ite (= (ite (= (bool_eq5 temp___5051 no_element) false) (= (get1
                                                              (positions l)
                                                              temp___5051) 
          (length1 l)) true) true)
  (= (bool_eq5 o10 no_element) true)
