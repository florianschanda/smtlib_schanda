...
;; H
  ...
  (rec__list_allocator__m__t__available model____split_fields3) j2)))
...
;; H
  ...
  (+ j2 1)) (rec__list_allocator__m__t__available model____split_fields3)
  (+ j2 1))))
...
;; H
  ...
  (rec__list_allocator__m__t__allocated model____split_fields3) j2)))
...
;; H
  ...
  (+ j2 1)) (rec__list_allocator__m__t__allocated model____split_fields3)
  (+ j2 1))))
...
;; H
  (assert
  (forall ((j2 Int)) (get__function_guard (get ma1 (+ j2 1)) ma1 (+ j2 1))))
...
;; H
  (assert
  (forall ((j2 Int)) (get__function_guard (get ma1 (+ j2 2)) ma1 (+ j2 2))))
