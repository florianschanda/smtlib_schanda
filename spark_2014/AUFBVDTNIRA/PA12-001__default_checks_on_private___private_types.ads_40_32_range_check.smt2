...
(declare-datatypes ()
((us_split_discrs (mk___split_discrs (rec__private_types__p3__t__d Bool)))))
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (rec__private_types__p3__t__d
                           (us_split_discrs1 a)) (rec__private_types__p3__t__d
                                                 (us_split_discrs1 b)))
...
(declare-fun private_types__p3__t__d__first__bit () Int)

(declare-fun private_types__p3__t__d__last__bit () Int)

(declare-fun private_types__p3__t__d__position () Int)
...
(declare-fun private_types__p3__t__f__first__bit () Int)

(declare-fun private_types__p3__t__f__last__bit () Int)

(declare-fun private_types__p3__t__f__position () Int)
...
(declare-fun private_types__p3__t__d__first__bit1 () Int)

(declare-fun private_types__p3__t__d__last__bit1 () Int)

(declare-fun private_types__p3__t__d__position1 () Int)
...
(declare-fun private_types__p3__t__f__first__bit1 () Int)

(declare-fun private_types__p3__t__f__last__bit1 () Int)

(declare-fun private_types__p3__t__f__position1 () Int)
...
(define-fun dynamic_invariant1 ((temp___expr_181 us_rep)
  ...
  (temp___do_toplevel_180 Bool)) Bool (and
                                      ...
                                      (in_range3 (of_int 1) temp___expr_181))
                                      (= (attr__constrained temp___expr_181) true)))

;; temp___result_186_def
...
(define-fun default_initial_assumption ((temp___expr_183 us_rep)
  (temp___skip_top_level_184 Bool)) Bool (and
                                         ...
                                         (= (rec__private_types__p3__t__d
                                            (us_split_discrs1
                                            temp___expr_183)) (of_int 1))
                                         (=> (private_types__p3__t__f__pred
                                         temp___expr_183)
                                         (= (to_rep
                                            (rec__private_types__p3__t__f
                                            (us_split_fields1
                                            temp___expr_183))) (id 0))))))
