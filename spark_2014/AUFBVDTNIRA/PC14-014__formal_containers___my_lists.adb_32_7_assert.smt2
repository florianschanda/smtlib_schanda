...
(declare-fun my_lists__m__prepend__2__container__fields () us_split_fields)

(declare-fun result10 () us_split_fields__ref)

(declare-fun l__split_fields7 () us_split_fields)

(declare-fun my_lists__m__delete_first__container__fields () us_split_fields)
...
;; H
  ...
  (and
  (= (length
     (mk___rep l__split_discrs my_lists__m__prepend__2__container__fields)) (+ 
  (length (mk___rep l__split_discrs l__split_fields6)) 4))
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields6))
     (model__
     (mk___rep l__split_discrs my_lists__m__prepend__2__container__fields)) 1
     (length (mk___rep l__split_discrs l__split_fields6)) 4) true))
  (= (constant_range
     (model__
     (mk___rep l__split_discrs my_lists__m__prepend__2__container__fields)) 1
     4 9) true))
...
;; H
  ...
  (and
  (= (length
     (mk___rep l__split_discrs my_lists__m__delete_first__container__fields)) (- 
  (length (mk___rep l__split_discrs l__split_fields7)) 1))
  (= (range_shifted
     (model__
     (mk___rep l__split_discrs my_lists__m__delete_first__container__fields))
     (model__ (mk___rep l__split_discrs l__split_fields7)) 1
     (length
     (mk___rep l__split_discrs my_lists__m__delete_first__container__fields))
     1) true))
  (= (p_positions_shifted
...
;; H
  (assert (< 3 (length (mk___rep l__split_discrs l__split_fields8))))

;; H
  (assert
  (ite (= (<= (length (mk___rep l__split_discrs l__split_fields8)) 3) true)
  (= (length
     (mk___rep l__split_discrs
  ...
  (= (range_shifted
     ...
     (length
     (mk___rep l__split_discrs
     my_lists__m__delete_first__2__container__fields)) 3) true))
  (= (p_positions_shifted
     (positions
     (mk___rep l__split_discrs
     my_lists__m__delete_first__2__container__fields))
     (positions (mk___rep l__split_discrs l__split_fields8)) 1 3) true))))
...
;; H
  (assert
  (= l__split_fields9 my_lists__m__delete_first__2__container__fields))

;; H
  (assert (<= (length (mk___rep l__split_discrs l__split_fields9)) 3))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 1572, characters 0-0
  ...
  (= (range_shifted
     ...
     (length
     (mk___rep l__split_discrs
     my_lists__m__delete_first__2__container__fields1)) 3) true))
  (= (p_positions_shifted
     (positions
     (mk___rep l__split_discrs
     my_lists__m__delete_first__2__container__fields1))
     (positions (mk___rep l__split_discrs l__split_fields9)) 1 3) true)))
  (and (= result13 (mk___split_fields__ref l__split_fields9))
  (= l__split_fields10 my_lists__m__delete_first__2__container__fields1))))))
(check-sat)
