...
(declare-fun r__split_fields7 () (Array Int integer))

(declare-fun r__split_fields8 () ar_index)

(declare-fun r__split_fields9 () length_type)
...
;; H
  (assert (is_empty__function_guard (is_empty (mk___rep r__split_fields12))
  (mk___rep r__split_fields12)))

;; H
  (assert (= (is_empty (mk___rep r__split_fields12)) true))
...
;; H
  (assert (head__function_guard (head (mk___rep r__split_fields11))
...
;; H
  ...
  (= (head (mk___rep r__split_fields11)) h1)) (in_range h1)))

;; H
  (assert (= h1 x))

;; H
  (assert (is_full__function_guard (is_full (mk___rep r__split_fields10))
  (mk___rep r__split_fields10)))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (not (= (is_full (mk___rep r__split_fields10)) true))))
(check-sat)
