...
;; H
  (assert (=> (and (<= 1 r2) (<= r2 r289b)) (= temp___1791 r2)))
...
;; H
  ...
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___1809 (parent
                              ...
                              f__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1809 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1809 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1809 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1809 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1809 j)))) true))
  (= j i))))))))))))))

;; H
  (assert (= o33 (select temp___1809 v)))
