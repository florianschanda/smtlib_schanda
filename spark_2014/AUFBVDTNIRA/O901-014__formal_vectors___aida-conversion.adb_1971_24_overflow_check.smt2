...
;; H
  (assert
  (and (= temp___2586 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2586)
  (<= temp___2586 (to_rep1 n__last))))

;; H
  (assert (= o35 temp___2586))
