...
(declare-fun position_x () t)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun position_y () t)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun target_x () t)

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun target_y () t)
...
(declare-fun flight_manager__set_engine_speed__adjust_speed__f () t)
...
;; H
  (assert (tqtisFinite position_x))

;; H
  (assert (tqtisFinite position_y))

;; H
  (assert (tqtisFinite target_x))

;; H
  (assert (tqtisFinite target_y))

;; H
  (assert (=> (lt target_x position_x) (= (to_rep o) (neg fliteral2))))

;; H
  (assert (=> (lt target_x position_x) (= o o1)))

;; H
  (assert (=> (lt target_x position_x) (= result____split_fields1 o2)))

;; H
  (assert (=> (lt target_x position_x) (= temp___145 o1)))

;; H
  (assert (=> (lt target_x position_x) (= temp___1451 o2)))

;; H
  (assert (=> (lt target_x position_x) (= result result____split_fields8)))

;; H
  (assert
  (=> (lt target_x position_x)
  (= result____split_fields3 (mk___split_fields temp___145 temp___1451))))

;; H
  (assert
  (=> (not (lt target_x position_x))
  (=> (lt position_x target_x) (= (to_rep o3) fliteral2))))

;; H
  (assert
  (=> (not (lt target_x position_x)) (=> (lt position_x target_x) (= o3 o4))))

;; H
  (assert
  (=> (not (lt target_x position_x))
  (=> (lt position_x target_x) (= result____split_fields1 o5))))

;; H
  (assert
  (=> (not (lt target_x position_x))
  (=> (lt position_x target_x) (= temp___143 o4))))

;; H
  (assert
  (=> (not (lt target_x position_x))
  (=> (lt position_x target_x) (= temp___1431 o5))))

;; H
  (assert
  (=> (not (lt target_x position_x))
  (=> (lt position_x target_x) (= result1 result____split_fields8))))

;; H
  (assert
  (=> (not (lt target_x position_x))
  (=> (lt position_x target_x)
  (= result____split_fields4 (mk___split_fields temp___143 temp___1431)))))

;; H
  (assert
  (=> (not (lt target_x position_x))
  (=> (not (lt position_x target_x))
...
;; H
  (assert (=> (lt target_y position_y) (= (to_rep o6) (neg fliteral2))))

;; H
  (assert
  (=> (lt target_y position_y)
  (= (rec__flight_manager__engine_values__x_speed result____split_fields3) 
  o7)))

;; H
  (assert (=> (lt target_y position_y) (= o6 o8)))

;; H
  (assert (=> (lt target_y position_y) (= temp___149 o7)))

;; H
  (assert (=> (lt target_y position_y) (= temp___1491 o8)))
...
;; H
  (assert
  (=> (not (lt target_y position_y))
  (=> (lt position_y target_y) (= (to_rep o9) fliteral2))))

;; H
  (assert
  (=> (not (lt target_y position_y))
  (=> (lt position_y target_y)
  (= (rec__flight_manager__engine_values__x_speed result____split_fields3) 
  o10))))
...
;; H
  (assert
  (=> (not (lt target_y position_y))
  (=> (lt position_y target_y) (= o9 o11))))

;; H
  (assert
  (=> (not (lt target_y position_y))
  (=> (lt position_y target_y) (= temp___147 o10))))

;; H
  (assert
  (=> (not (lt target_y position_y))
  (=> (lt position_y target_y) (= temp___1471 o11))))
...
;; H
  (assert
  (and (= o12 (sub RNE2 position_x target_x)) (tqtisFinite
  (sub RNE2 position_x target_x))))
...
;; WP_parameter_def
 ;; File "flight_manager.ads", line 3, characters 0-0
  (not (tqtisFinite (sub RNE2 position_y target_y))))
(check-sat)
