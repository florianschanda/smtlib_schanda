...
(declare-fun temp___1520 () Int)

(declare-fun temp___1519 () Int)

(declare-fun temp___1518 () (Array Int word32))

(declare-fun temp___1516 () (_ BitVec 32))

(declare-fun temp___1515 () (_ BitVec 64))

(declare-fun temp___1514 () (Array Int word32))
...
(declare-fun aux32 () map__ref)

(declare-fun j2 () int__ref)

(declare-fun s2 () int__ref)

(declare-fun w1 () t__ref)

(declare-fun h7 () int__ref)
...
(declare-fun a15 () (Array Int word32))

(declare-fun aux12 () (Array Int word32))
...
;; H
  (assert
  (forall ((n Int)) (num_of_big_int__function_guard
  (num_of_big_int
  (mk___t aux41 (mk (to_rep aux4__first) (to_rep aux4__last)))
  (+ aux4_first (* n (+ l1 1))) (+ l1 1))
  (mk___t aux41 (mk (to_rep aux4__first) (to_rep aux4__last)))
  (+ aux4_first (* n (+ l1 1))) (+ l1 1))))
...
;; H
  (assert
  (forall ((n Int)) (oexpon__function_guard
  (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n) 1))
  (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n) 1))))
...
;; H
  (assert
  (forall ((n Int)) (omultiply__function_guard
  (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n) 1))
  (oexpon (base Tuple0) (+ l1 1)))
  (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n) 1))
  (oexpon (base Tuple0) (+ l1 1)))))
...
;; H
  (assert
  (forall ((n Int)) (omod__function_guard
  (omod
  (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n) 1))
  (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))
  (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n) 1))
...
;; H
  (assert
  (forall ((n Int)) (oeq__function_guard
  (oeq
  (num_of_big_int
  (mk___t aux41 (mk (to_rep aux4__first) (to_rep aux4__last)))
  (+ aux4_first (* n (+ l1 1))) (+ l1 1))
...
;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int
  (mk___t (map__content aux32) (mk (to_rep aux3__first) (to_rep aux3__last)))
  aux3_first (+ l1 1))
  (mk___t (map__content aux32) (mk (to_rep aux3__first) (to_rep aux3__last)))
  aux3_first (+ l1 1)))
...
;; H
  (assert (from_integer__function_guard (from_integer (int__content s2))
  (int__content s2)))
...
;; H
  ...
  (from_word64 i2) (from_integer (int__content s2))))
...
;; H
  (assert (oadd__function_guard
  (oadd (osubtract (from_word64 i2) (from_integer (int__content s2)))
  (from_word32 ((_ int2bv 32) 1)))
  (osubtract (from_word64 i2) (from_integer (int__content s2)))
  (from_word32 ((_ int2bv 32) 1))))
...
;; H
  ...
  (oexpon__2 (from_word32 ((_ int2bv 32) 2))
  (oadd (osubtract (from_word64 i2) (from_integer (int__content s2)))
  (from_word32 ((_ int2bv 32) 1)))) (from_word32 ((_ int2bv 32) 2))
  (oadd (osubtract (from_word64 i2) (from_integer (int__content s2)))
  (from_word32 ((_ int2bv 32) 1)))))
...
;; H
  ...
  (oexpon__2 (from_word32 ((_ int2bv 32) 2))
  (oadd (osubtract (from_word64 i2) (from_integer (int__content s2)))
  (from_word32 ((_ int2bv 32) 1)))))) (num_of_big_int x x_first (+ l1 1))
  (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1))
  (oexpon__2 (from_word32 ((_ int2bv 32) 2))
  (oadd (osubtract (from_word64 i2) (from_integer (int__content s2)))
  (from_word32 ((_ int2bv 32) 1)))))))
...
;; H
  ...
  (oexpon__2 (from_word32 ((_ int2bv 32) 2))
  (oadd (osubtract (from_word64 i2) (from_integer (int__content s2)))
  (from_word32 ((_ int2bv 32) 1)))))) (oexpon (base Tuple0) (+ l1 1)))
  (oexpon__2 (num_of_big_int x x_first (+ l1 1))
  (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1))
  (oexpon__2 (from_word32 ((_ int2bv 32) 2))
  (oadd (osubtract (from_word64 i2) (from_integer (int__content s2)))
...
;; H
  ...
  (ole (from_integer (int__content s2))
  (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1))))
  (from_integer (int__content s2))
  (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))))
...
;; H
  ...
  (mk___t a13 (mk (to_rep a__first) (to_rep a__last))) a_first
  (+ (- a_last a_first) 1)))

;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int
  (mk___t (map__content aux36) (mk (to_rep aux3__first) (to_rep aux3__last)))
  aux3_first (+ (- a_last a_first) 1))
  (mk___t (map__content aux36) (mk (to_rep aux3__first) (to_rep aux3__last)))
  aux3_first (+ (- a_last a_first) 1)))
...
;; H
  (assert (inverse__function_guard
  (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0))
  (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)))
...
;; H
  (assert (= temp___1520 s))

;; H
  (assert (= temp___1519 j))

;; H
  (assert (= temp___1518 aux3))

;; H
  (assert (= temp___1516 w))

;; H
  (assert (= temp___1515 i1))

;; H
  (assert (= temp___1514 (map__content a5)))
