...
(declare-fun temp___726 () positive)

(declare-fun temp___7261 () natural)

(declare-fun temp___7262 () positive)

(declare-fun temp___7263 () positive)

(declare-fun temp___7264 () (Array Int element_type))

(declare-fun temp___7265 () t)
...
(declare-fun temp___728 () positive)

(declare-fun temp___7281 () natural)

(declare-fun temp___7282 () positive)

(declare-fun temp___7283 () positive)

(declare-fun temp___7284 () (Array Int element_type))

(declare-fun temp___7285 () t)
...
;; H
  (assert (= queue__split_discrs (mk___split_discrs temp___726)))

;; H
  (assert (= temp___7261 o6))

;; H
  (assert (= temp___7262 o7))

;; H
  (assert (= temp___7263 o8))

;; H
  (assert (= temp___7264 o9))

;; H
  (assert (= temp___7265 o10))
...
;; H
  (assert (= temp___7261 queue__split_fields5))

;; H
  (assert (= temp___7262 queue__split_fields6))

;; H
  (assert (= temp___7263 queue__split_fields7))

;; H
  (assert (= temp___7264 queue__split_fields8))

;; H
  (assert (= temp___7265 queue__split_fields9))
...
;; H
  (assert (= queue__split_discrs (mk___split_discrs temp___728)))

;; H
  (assert (= temp___7281 o13))

;; H
  (assert (= temp___7282 o14))

;; H
  (assert (= temp___7283 o15))

;; H
  (assert (= temp___7284 o16))

;; H
  (assert (= temp___7285 o17))
...
;; H
  (assert
  (= queue__split_fields10 (mk___split_fields temp___7281 temp___7282
                           temp___7283 (mk___t temp___7284 temp___7285))))
