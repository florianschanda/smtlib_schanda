...
(declare-fun bool_eq8 (us_rep1 us_rep1) Bool)
...
(define-fun dynamic_invariant7 ((temp___expr_169 (_ BitVec 32))
  (temp___is_init_166 Bool) (temp___skip_constant_167 Bool)
  (temp___do_toplevel_168 Bool)) Bool true)

(define-fun dynamic_invariant8 ((temp___expr_175 Int)
...
;; H
  (assert
  (=> (= result1 true)
  (= o2 (ite (<= o1 (to_rep1 (last (rt a)))) true false))))
...
;; H
  (assert
  (=> (= result1 true)
  (= o3 (ite (<= (to_rep1 (first (rt a))) o) true false))))
