...
(define-fun dynamic_invariant3 ((temp___expr_805 Int)
...
;; extract_bits_inline_always__post_axiom
  ...
  (! (=>
     (and
     (and
     (and (dynamic_invariant value true true true) (dynamic_invariant1 from
     true true true)) (dynamic_invariant1 to__ true true true))
     (<= from to__))
     (let ((result (extract_bits_inline_always value from to__)))
     (and (shift_right__function_guard (shift_right value from) value from)
     (and (make_mask__function_guard (make_mask (+ (- to__ from) 1))
     (+ (- to__ from) 1))
     (and (make_mask__function_guard (make_mask (+ (- to__ from) 1))
     (+ (- to__ from) 1))
     (and (shift_left__function_guard (shift_left result from) result from)
     (and (make_mask__function_guard (make_mask (+ (- to__ from) 1))
     (+ (- to__ from) 1))
     (and (make_mask__function_guard (make_mask (+ (- to__ from) 1))
     (+ (- to__ from) 1))
...
(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result () (_ BitVec 64))

(declare-fun o () (_ BitVec 64))

(declare-fun result () (_ BitVec 64))

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result1 () (_ BitVec 64))

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result2 () (_ BitVec 64))

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result3 () (_ BitVec 64))

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result4 () (_ BitVec 64))

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result5 () (_ BitVec 64))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result1 
  bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result2))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result3 
  bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result1))
...
;; H
  ...
  (extract_bits_inline_always__function_guard o value from to__))
...
;; H
  ...
  (= (mk_t__ref result) (mk_t__ref
                        bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result)))
...
;; H
  (assert
  (= (mk_t__ref
     bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result4) 
  (mk_t__ref
  bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result2)))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result5 
  bits_manipulation_unsigned__unsigned_64__functions__extract_bits_not_inline__result3))
