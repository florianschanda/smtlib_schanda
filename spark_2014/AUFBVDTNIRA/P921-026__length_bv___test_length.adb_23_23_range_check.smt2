...
(declare-fun test_length__p3__a2__assume () (Array (_ BitVec 16) natural))

(declare-fun test_length__p3__a2__assume1 () t)

(declare-fun o () Int)

(declare-fun result () (Array (_ BitVec 16) natural))

(declare-fun a21 () (Array (_ BitVec 16) natural))
