...
;; H
  (assert (=> (= result8 true) (= a12 (mk_map__ref a4))))
...
;; H
  (assert (=> (not (= result8 true)) (= a12 (mk_map__ref a))))
...
;; H
  (assert (=> (not (= result11 true)) (= a9 a12)))
...
;; H
  (assert (sorted__function_guard
  (sorted (mk___t a11 (mk (to_rep a__first) (to_rep a__last)))
  (+ (int__content j6) 1) (+ i1 1))
  (mk___t a11 (mk (to_rep a__first) (to_rep a__last)))
  (+ (int__content j6) 1) (+ i1 1)))
