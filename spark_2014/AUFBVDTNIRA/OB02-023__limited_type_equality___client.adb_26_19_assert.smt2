...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__p1__normal_record__x integer)))))
...
(declare-fun p1__normal_record__x__first__bit () Int)

(declare-fun p1__normal_record__x__last__bit () Int)

(declare-fun p1__normal_record__x__position () Int)
...
(declare-datatypes ()
((normal_record__ref (mk_normal_record__ref (normal_record__content us_rep)))))
(define-fun normal_record__ref___projection ((a normal_record__ref)) us_rep 
  (normal_record__content a))

(declare-datatypes ()
((us_split_fields2 (mk___split_fields1 (rec__p2__limited_record__x integer)))))
...
(declare-fun p2__limited_record__x__first__bit () Int)

(declare-fun p2__limited_record__x__last__bit () Int)

(declare-fun p2__limited_record__x__position () Int)
...
(declare-fun p3__limited_record_with_user_eq__x__first__bit () Int)

(declare-fun p3__limited_record_with_user_eq__x__last__bit () Int)

(declare-fun p3__limited_record_with_user_eq__x__position () Int)
...
(declare-fun bool_eq4 ((Array Int us_rep1) Int Int (Array Int us_rep1) Int
  Int) Bool)
...
(declare-fun bool_eq5 ((Array Int us_rep2) Int Int (Array Int us_rep2) Int
  Int) Bool)
...
(declare-fun c () (Array Int us_rep2))
...
;; H
  (assert
  (= (oeq (mk___rep2 (mk___split_fields2 z__split_fields))
     (mk___rep2 (mk___split_fields2 z__split_fields))) true))

;; H
  (assert (= (bool_eq3 a 1 3 a 1 3) true))

;; H
  (assert (oeq__function_guard1 (oeq1 c c) c c))
