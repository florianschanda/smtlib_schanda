...
(declare-fun user_eq2 (t39b t39b) Bool)

(declare-fun dummy2 () t39b)
...
(declare-fun temp___428 (Int) (Array Int unsigned_byte))

;; def_axiom
  (assert
  (forall ((temp___430 Int))
  (forall ((temp___431 Int))
  (= (select (temp___428 temp___430) temp___431) (of_rep temp___430)))))
