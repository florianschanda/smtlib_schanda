...
;; H
  ...
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2096 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2096 (parent
                      (mk___rep2
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o58))
  (and (dynamic_invariant3 temp___2096 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2096 o58))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2096 o58)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o58))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2096 (parent
                              ...
                              f__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2096 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2096 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2096 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2096 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2096 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2096 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o59 (select temp___2096 i)))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2095 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2095 (parent
                      (mk___rep2
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  root))
  (and (dynamic_invariant3 temp___2095 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2095 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2095 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2095 (parent
                              ...
                              f_old__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2095 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2095 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2095 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2095 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2095 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2095 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o63 (select temp___2095 i)))
...
;; H
  ...
  (valid_root
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o62)
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o62))
