...
;; H
  ...
  (= temp___1356 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 o58))
  (and (dynamic_invariant3 temp___1356 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1356 o58))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1356 o58)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o58))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1356 (parent
                              (mk___rep2
                              (mk___split_fields2 f__split_fields
                              f__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1356 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1356 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1356 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1356 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1356 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1356 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o59 (select temp___1356 i)))
...
;; H
  ...
  (= temp___1355 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___1355 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1355 (parent
                              (mk___rep2
                              (mk___split_fields2 f_old__split_fields
                              f_old__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1355 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1355 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1355 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1355 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1355 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1355 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o63 (select temp___1355 i)))
