...
(define-fun dynamic_invariant1 ((temp___expr_313 (_ BitVec 16))
...
;; mk_def
  ...
  (! (=> (in_range1 f)
     ...
     (= (to_rep2 (last4 (mk1 f l1))) l1)))) :pattern ((mk1 f l1)) )))
...
(define-fun dynamic_invariant4 ((temp___expr_655 us_rep1)
  ...
  (temp___do_toplevel_654 Bool)) Bool (and
                                      ...
                                      (first3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_655)))
                                      (last5
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_655))))
                                      (and
                                      (= (first3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_655))) 1)
                                      (= (last5
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_655))) (+ 
                                      (to_rep
...
(define-fun default_initial_assumption ((temp___expr_658 us_rep1)
  (temp___skip_top_level_659 Bool)) Bool (= (to_rep
                                            (rec__very_longs__very_long__length
                                            (us_split_discrs2
...
(declare-fun last7 (t2) tdigit_count_typeB)
...
;; mk_def
  ...
  (! (=> (in_range1 f)
     ...
     (= (to_rep2 (last7 (mk2 f l1))) l1)))) :pattern ((mk2 f l1)) )))
...
(declare-fun last9 (t3) tdigit_count_typeB)
...
;; mk_def
  ...
  (! (=> (in_range1 f)
     ...
     (= (to_rep2 (last9 (mk3 f l1))) l1)))) :pattern ((mk3 f l1)) )))
...
(declare-fun temp___1012 ((_ BitVec 8) Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___1014 (_ BitVec 8)))
  (forall ((temp___1015 Int) (temp___1016 Int))
  (let ((temp___1013 (temp___1012 temp___1014 temp___1015 temp___1016)))
  (and
  (=> (dynamic_property6 1 65536 temp___1015 temp___1016)
  (and (= (first5 temp___1013) temp___1015)
  (= (last8 temp___1013) temp___1016)))
  (forall ((temp___1017 Int))
  (= (select (to_array2 temp___1013) temp___1017) (of_rep1 temp___1014))))))))
...
(declare-fun temp___10191 () t2)

(declare-fun temp___1020 () (Array Int octet))

(declare-fun temp___10201 () t1)
...
(declare-fun temp___1023 () digit_index_type)

(declare-fun temp___10231 () (Array Int octet))

(declare-fun temp___10232 () t1)

(declare-fun temp___1039 () (_ BitVec 16))

(declare-fun temp___1036 () us_rep1)

(declare-fun temp___1035 () (_ BitVec 16))
...
(declare-fun temp___1031 () us_rep1)
...
;; H
  (assert
  (= (mk___t2 temp___1019 temp___10191) (temp___1012 ((_ int2bv 8) 0) 1
                                        (+ (to_rep
                                           (rec__very_longs__very_long__length
                                           (us_split_discrs1 l))) (to_rep
                                                                  (rec__very_longs__very_long__length
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___10191)) (to_rep2 (last7 temp___10191)))
     (+ (- (to_rep2 (last7 temp___10191)) (to_rep2 (first4 temp___10191))) 1)
     0) (ite (<= 1 (+ (to_rep
                      (rec__very_longs__very_long__length
                      (us_split_discrs1 l))) (to_rep
                                             (rec__very_longs__very_long__length
...
;; H
  (assert (= temp___1019 temp___1020))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___10191)) (to_rep2 (last7 temp___10191))) 
  temp___10201))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___10201)) (to_rep2 (last4 temp___10201)))
     (+ (- (to_rep2 (last4 temp___10201)) (to_rep2 (first2 temp___10201))) 1)
     0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2
                                                            (last4
                                                            result____split_fields1)))
        (+ (- (to_rep2 (last4 result____split_fields1)) (to_rep2
                                                        (first2
                                                        result____split_fields1))) 1)
        0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___1020 temp___10201)))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___1023)))

;; H
  (assert (= temp___10231 o2))

;; H
  (assert (= temp___10232 o3))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___10231 temp___10232))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last1
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= temp___1036 (mk___rep1 result____split_discrs result____split_fields3))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last1
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (and (= o18 (takelsb_from16 temp2)) (takelsb_from16__function_guard 
  o18 temp2))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last1
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= temp___1031 (mk___rep1 result____split_discrs o23))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last1
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= result____split_fields5 (us_split_fields3 temp___1031))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last1
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= result____split_discrs (us_split_discrs2 temp___1031))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (and
  (and (= o24 (shift_right temp2 8)) (shift_right__function_guard o24 
  temp2 8))
  (= o24 (bvudiv temp2 (ite (< 8 65536)
...
;; H
  (assert
  (and (= o25 (takelsb_from16 (t__content1 carry6)))
  (takelsb_from16__function_guard o25 (t__content1 carry6))))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 84, characters 0-0
  ...
  (<= (to_rep2
      ...
      (rt1
      (rec__very_longs__very_long__long_digits1
      (us_split_fields__content1 result____split_fields8))))) temp___1043)))
(check-sat)
