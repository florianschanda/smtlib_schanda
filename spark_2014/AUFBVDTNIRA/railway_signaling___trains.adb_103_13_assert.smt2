...
;; H
  (assert (get_previous_track__function_guard
...
(define-fun temp___454 () Int (to_rep5
                              (select (map__content4 track_signals6) 
                              (get_previous_track (select trains1 train1)
                              id7))))

(assert
;; WP_parameter_def
 ;; File "trains.ads", line 191, characters 0-0
  (not (or (= temp___454 1) (= temp___454 2))))
(check-sat)
