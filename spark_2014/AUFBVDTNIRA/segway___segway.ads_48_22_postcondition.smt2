...
;; H
  (assert (speed_is_valid__function_guard (speed_is_valid speed status) 
  speed status))

;; H
  (assert (speed_is_valid__function_guard (speed_is_valid speed2 status2)
  speed2 status2))
...
;; H
  (assert (speed_is_valid__function_guard (speed_is_valid speed3 status3)
  speed3 status3))

;; H
  (assert (speed_is_valid__function_guard (speed_is_valid speed4 status4)
  speed4 status4))
...
;; H
  (assert (=> (not (= status 0)) (= temp___176 status)))

;; H
  (assert (=> (not (= status 0)) (= temp___175 speed)))
...
;; H
  (assert (speed_is_valid__function_guard (speed_is_valid speed9 status9)
  speed9 status9))
