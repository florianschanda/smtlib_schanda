...
(declare-fun result11 () us_split_fields__ref3)
...
;; H
  (assert
  (= result11 (mk___split_fields__ref3
              (mk___split_fields3 t__split_fields
              (mk___rep2
              (mk___split_fields2 t__split_fields1 t__split_fields2))
              t__split_fields3))))
...
;; H
  (assert
  (= t__split_fields4 (mk___split_fields3 t__split_fields
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range3 binary_trees__extract__v)))
(check-sat)
