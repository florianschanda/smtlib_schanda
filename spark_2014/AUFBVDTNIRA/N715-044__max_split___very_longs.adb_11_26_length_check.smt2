...
;; H
  (assert
  (= (to_rep2 (last7 (rt2 (temp___192 ((_ int2bv 8) 0) 1 digit_length)))) 
  digit_length))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___1991)) (to_rep2 (last7 temp___1991)))
     (+ (- (to_rep2 (last7 temp___1991)) (to_rep2 (first4 temp___1991))) 1)
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___1991)) (to_rep2 (last7 temp___1991))) 
  temp___2001))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 20, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first2 temp___2001)) (to_rep2 (last4 temp___2001)))
     (+ (- (to_rep2 (last4 temp___2001)) (to_rep2 (first2 temp___2001))) 1)
