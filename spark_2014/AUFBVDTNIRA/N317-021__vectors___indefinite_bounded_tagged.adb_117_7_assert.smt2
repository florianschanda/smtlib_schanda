...
(define-fun dynamic_invariant2 ((temp___expr_233 Int)
...
;; find_index__post_axiom
  ...
  (! (=> (dynamic_invariant2 index true true true)
     ...
     (= (let ((temp___442 (get (model__ container) result)))
        (and (ite (= (attr__tag temp___442) (attr__tag item)) true false) 
        (us_dispatch_eq temp___442 item))) true))
...
;; reverse_find_index__post_axiom
  ...
  (! (=> (dynamic_invariant2 index true true true)
     ...
     (= (let ((temp___446 (get (model__ container) result)))
        (and (ite (= (attr__tag temp___446) (attr__tag item)) true false) 
        (us_dispatch_eq temp___446 item))) true))
     (not
...
;; f__def_axiom
  ...
  (forall ((x Int))
  (! (=>
     (and (dynamic_invariant3 x true true true) (f__function_guard (f x) x))
...
;; temp___result_166_def
  (assert
  (forall ((container us_rep2) (i Int) (j Int)) (lt__function_guard
...
(define-fun in_range5 ((rec__indefinite_bounded_tagged__vect__vector__capacity1 Int)
  (a us_rep1)) Bool (= rec__indefinite_bounded_tagged__vect__vector__capacity1 
  (to_rep1
  (rec__indefinite_bounded_tagged__vect__vector__capacity
  (us_split_discrs1 a)))))
...
(declare-fun indefinite_bounded_tagged__vect__vector__capacity__first__bit1 () Int)

(declare-fun indefinite_bounded_tagged__vect__vector__capacity__last__bit1 () Int)

(declare-fun indefinite_bounded_tagged__vect__vector__capacity__position1 () Int)
...
(define-fun dynamic_invariant4 ((temp___expr_461 us_rep1)
  (temp___is_init_458 Bool) (temp___skip_constant_459 Bool)
  (temp___do_toplevel_460 Bool)) Bool (=>
                                      (not (= temp___skip_constant_459 true))
                                      (in_range5 5 temp___expr_461)))

(define-fun default_initial_assumption1 ((temp___expr_463 us_rep1)
  (temp___skip_top_level_464 Bool)) Bool (and
                                         (= (to_rep1
                                            (rec__indefinite_bounded_tagged__vect__vector__capacity
                                            (us_split_discrs1
                                            temp___expr_463))) 5)
                                         (=>
                                         (not
                                         (= temp___skip_top_level_464 true))
                                         (= (is_empty temp___expr_463) true))))
...
;; lt__def_axiom
  ...
  (! (=> (lt__function_guard (lt left right) left right)
     (= (= (lt left right) true)
     (< (to_rep
        (rec__indefinite_bounded_tagged__t__c (us_split_fields1 left))) 
     (to_rep (rec__indefinite_bounded_tagged__t__c (us_split_fields1 right)))))) :pattern (
  (lt left right)) )))
...
(define-fun default_initial_assumption2 ((temp___expr_281 us_rep2)
...
(define-fun dynamic_invariant6 ((temp___expr_274 Int)
...
(declare-fun indefinite_bounded_tagged__test__B_1__w__assume () us_rep1)
...
(declare-fun indefinite_bounded_tagged__vect__clear__container__fields () us_split_fields2)

(declare-fun result () us_split_fields__ref1)

(declare-fun v__split_fields1 () us_split_fields2)

(declare-fun indefinite_bounded_tagged__vect__append__2__container__fields () us_split_fields2)

(declare-fun result1 () us_split_fields__ref1)

(declare-fun v__split_fields2 () us_split_fields2)

(declare-fun indefinite_bounded_tagged__vect__append__2__container__fields1 () us_split_fields2)

(declare-fun result2 () us_split_fields__ref1)

(declare-fun v__split_fields3 () us_split_fields2)

(declare-fun indefinite_bounded_tagged__vect__append__2__container__fields2 () us_split_fields2)

(declare-fun result3 () us_split_fields__ref1)

(declare-fun v__split_fields4 () us_split_fields2)

(declare-fun indefinite_bounded_tagged__vect__reserve_capacity__container__fields () us_split_fields2)

(declare-fun result4 () us_split_fields__ref1)

(declare-fun v__split_fields5 () us_split_fields2)

(declare-fun result5 () us_split_fields__ref1)

(declare-fun w__split_fields1 () us_split_fields2)

(declare-fun w__split_fields2 () us_split_fields2)

(declare-fun w__split_fields3 () us_split_fields2)

(declare-fun indefinite_bounded_tagged__vect__replace_element__container__fields () us_split_fields2)

(declare-fun result6 () us_split_fields__ref1)

(declare-fun v__split_fields6 () us_split_fields2)

(declare-fun indefinite_bounded_tagged__vect__swap__container__fields () us_split_fields2)

(declare-fun result7 () us_split_fields__ref1)

(declare-fun v__split_fields7 () us_split_fields2)

(declare-fun indefinite_bounded_tagged__vect__delete_last__container__fields () us_split_fields2)

(declare-fun result8 () us_split_fields__ref1)

(declare-fun v__split_fields8 () us_split_fields2)

(declare-fun indefinite_bounded_tagged__vect__reverse_elements__container__fields () us_split_fields2)

(declare-fun result9 () us_split_fields__ref1)

(declare-fun v__split_fields9 () us_split_fields2)

(declare-fun indefinite_bounded_tagged__sort__sort__container__fields () us_split_fields2)

(declare-fun result10 () us_split_fields__ref1)

(declare-fun v__split_fields10 () us_split_fields2)

(declare-fun indefinite_bounded_tagged__vect__replace_element__container__fields1 () us_split_fields2)

(declare-fun result11 () us_split_fields__ref1)

(declare-fun v__split_fields11 () us_split_fields2)

(define-fun o12 () us_rep (mk___rep (mk___split_fields o6 o7) o8))

(define-fun o13 () us_rep (mk___rep (mk___split_fields o3 o4) o5))

(define-fun o14 () us_rep (mk___rep (mk___split_fields o o1) o2))
...
;; H
  (assert
  (and (and (= o14 (f 1)) (f__function_guard o14 1))
...
;; H
  ...
  (= (olt (model__ (mk___rep1 v__split_discrs v__split_fields1))
     (model__
     (mk___rep1 v__split_discrs
     indefinite_bounded_tagged__vect__append__2__container__fields))) true))
  (= (let ((temp___411 (get
                       (model__
                       (mk___rep1 v__split_discrs
                       indefinite_bounded_tagged__vect__append__2__container__fields))
     ...
     (ite (= (attr__tag temp___411) o2) (us_dispatch_eq temp___411 o14)
     false)) true)))
...
;; H
  (assert
  (and (and (= o13 (f 2)) (f__function_guard o13 2))
...
;; H
  ...
  (= (olt (model__ (mk___rep1 v__split_discrs v__split_fields2))
     (model__
     (mk___rep1 v__split_discrs
     indefinite_bounded_tagged__vect__append__2__container__fields1))) true))
  (= (let ((temp___411 (get
                       (model__
                       (mk___rep1 v__split_discrs
                       indefinite_bounded_tagged__vect__append__2__container__fields1))
     ...
     (ite (= (attr__tag temp___411) o5) (us_dispatch_eq temp___411 o13)
     false)) true)))
...
;; H
  (assert
  (and (and (= o12 (f 3)) (f__function_guard o12 3))
...
;; H
  ...
  (= (olt (model__ (mk___rep1 v__split_discrs v__split_fields3))
     (model__
     (mk___rep1 v__split_discrs
     indefinite_bounded_tagged__vect__append__2__container__fields2))) true))
  (= (let ((temp___411 (get
                       (model__
                       (mk___rep1 v__split_discrs
                       indefinite_bounded_tagged__vect__append__2__container__fields2))
     ...
     (ite (= (attr__tag temp___411) o8) (us_dispatch_eq temp___411 o12)
     false)) true)))
...
;; H
  (assert (f__function_guard (f 1) 1))
...
;; H
  (assert (f__function_guard (f 2) 2))
...
;; H
  ...
  (= (let ((temp___539 (f 2)))
     (let ((temp___538 (get
                       (model__ (mk___rep1 v__split_discrs v__split_fields4))
                       2)))
     (ite (= (attr__tag temp___538) (attr__tag temp___539))
     (us_dispatch_eq temp___538 temp___539) false))) true))

;; H
  (assert (f__function_guard (f 3) 3))
...
;; H
  ...
  (= (let ((temp___544 (f 3)))
     (let ((temp___543 (get
                       (model__ (mk___rep1 v__split_discrs v__split_fields4))
                       3)))
     (ite (= (attr__tag temp___543) (attr__tag temp___544))
     (us_dispatch_eq temp___543 temp___544) false))) true))
...
;; H
  (assert
  (and
  (= indefinite_bounded_tagged__test__B_1__w__assume (copy
                                                     (mk___rep1
                                                     v__split_discrs
                                                     v__split_fields5) 6))
  (and
  (= (oeq1 (model__ indefinite_bounded_tagged__test__B_1__w__assume)
  ...
  (= (to_rep1
     (rec__indefinite_bounded_tagged__vect__vector__capacity
     (us_split_discrs1 indefinite_bounded_tagged__test__B_1__w__assume))) 6)))))
...
;; H
  ...
  (= w__split_fields1 (us_split_fields3
                      indefinite_bounded_tagged__test__B_1__w__assume)))
...
;; H
  ...
  (= (let ((temp___550 (f 1)))
     (let ((temp___549 (get
                       ...
                       1)))
     (ite (= (attr__tag temp___549) (attr__tag temp___550))
     (us_dispatch_eq temp___549 temp___550) false))) true))
...
;; H
  ...
  (= (let ((temp___560 (f 3)))
     (let ((temp___559 (get
                       (model__ (mk___rep1 w__split_discrs w__split_fields1))
                       3)))
     (ite (= (attr__tag temp___559) (attr__tag temp___560))
     (us_dispatch_eq temp___559 temp___560) false))) true))
...
;; H
  ...
  (= (let ((temp___565 (f 1)))
     (let ((temp___564 (get
                       ...
                       1)))
     (ite (= (attr__tag temp___564) (attr__tag temp___565))
     (us_dispatch_eq temp___564 temp___565) false))) true))
...
;; H
  ...
  (= (let ((temp___570 (f 2)))
     (let ((temp___569 (get
                       (model__ (mk___rep1 w__split_discrs w__split_fields2))
                       2)))
     (ite (= (attr__tag temp___569) (attr__tag temp___570))
     (us_dispatch_eq temp___569 temp___570) false))) true))
...
;; H
  ...
  (= (let ((temp___585 (f 2)))
     (let ((temp___584 (get
                       (model__ (mk___rep1 w__split_discrs w__split_fields2))
                       5)))
     (ite (= (attr__tag temp___584) (attr__tag temp___585))
     (us_dispatch_eq temp___584 temp___585) false))) true))
...
;; H
  ...
  (= (let ((temp___590 (f 3)))
     (let ((temp___589 (get
                       (model__ (mk___rep1 w__split_discrs w__split_fields2))
                       6)))
     (ite (= (attr__tag temp___589) (attr__tag temp___590))
     (us_dispatch_eq temp___589 temp___590) false))) true))
...
;; H
  (assert
  (and (and (= o10 (f 4)) (f__function_guard o10 4))
...
;; H
  ...
  (= (length
     (mk___rep1 v__split_discrs
     indefinite_bounded_tagged__vect__replace_element__container__fields)) 
  (length (mk___rep1 v__split_discrs v__split_fields5)))
  (= (let ((temp___389 (get
                       (model__
                       (mk___rep1 v__split_discrs
                       indefinite_bounded_tagged__vect__replace_element__container__fields))
                       2)))
     (ite (= (attr__tag temp___389) (attr__tag o10))
     (us_dispatch_eq temp___389 o10) false)) true))
  (= (equal_except (model__ (mk___rep1 v__split_discrs v__split_fields5))
     (model__
     (mk___rep1 v__split_discrs
     indefinite_bounded_tagged__vect__replace_element__container__fields)) 2) true)))
...
;; H
  (assert
  (= v__split_fields6 indefinite_bounded_tagged__vect__replace_element__container__fields))
...
;; H
  (assert (f__function_guard (f 4) 4))
...
;; H
  ...
  (= (let ((temp___606 (f 3)))
     (let ((temp___605 (get
                       (model__ (mk___rep1 v__split_discrs v__split_fields6))
                       3)))
     (ite (= (attr__tag temp___605) (attr__tag temp___606))
     (us_dispatch_eq temp___605 temp___606) false))) true))
...
;; H
  ...
  (= (m_elements_swapped
     ...
     (model__
     (mk___rep1 v__split_discrs
     indefinite_bounded_tagged__vect__swap__container__fields)) 1 3) true))
...
;; H
  (assert
  (= v__split_fields7 indefinite_bounded_tagged__vect__swap__container__fields))
...
;; H
  ...
  (= (let ((temp___612 (f 3)))
     (let ((temp___611 (get
                       ...
                       1)))
     (ite (= (attr__tag temp___611) (attr__tag temp___612))
     (us_dispatch_eq temp___611 temp___612) false))) true))
...
;; H
  ...
  (= (let ((temp___617 (f 4)))
     (let ((temp___616 (get
                       (model__ (mk___rep1 v__split_discrs v__split_fields7))
                       2)))
     (ite (= (attr__tag temp___616) (attr__tag temp___617))
     (us_dispatch_eq temp___616 temp___617) false))) true))
...
;; H
  ...
  (= (let ((temp___622 (f 1)))
     (let ((temp___621 (get
                       (model__ (mk___rep1 v__split_discrs v__split_fields7))
                       3)))
     (ite (= (attr__tag temp___621) (attr__tag temp___622))
     (us_dispatch_eq temp___621 temp___622) false))) true))
...
;; H
  ...
  (= (length
     (mk___rep1 v__split_discrs
     indefinite_bounded_tagged__vect__delete_last__container__fields)) (- 
...
;; H
  (assert
  (= v__split_fields8 indefinite_bounded_tagged__vect__delete_last__container__fields))
...
;; H
  ...
  (= (let ((temp___628 (f 3)))
     (let ((temp___627 (get
                       ...
                       1)))
     (ite (= (attr__tag temp___627) (attr__tag temp___628))
     (us_dispatch_eq temp___627 temp___628) false))) true))
...
;; H
  ...
  (= (let ((temp___633 (f 4)))
     (let ((temp___632 (get
                       (model__ (mk___rep1 v__split_discrs v__split_fields8))
                       2)))
     (ite (= (attr__tag temp___632) (attr__tag temp___633))
     (us_dispatch_eq temp___632 temp___633) false))) true))
...
;; H
  ...
  (= (m_elements_reversed
     ...
     (model__
     (mk___rep1 v__split_discrs
     indefinite_bounded_tagged__vect__reverse_elements__container__fields))) true))
...
;; H
  (assert
  (= v__split_fields9 indefinite_bounded_tagged__vect__reverse_elements__container__fields))
...
;; H
  ...
  (= (let ((temp___639 (f 4)))
     (let ((temp___638 (get
                       ...
                       1)))
     (ite (= (attr__tag temp___638) (attr__tag temp___639))
     (us_dispatch_eq temp___638 temp___639) false))) true))
...
;; H
  ...
  (= (let ((temp___644 (f 3)))
     (let ((temp___643 (get
                       (model__ (mk___rep1 v__split_discrs v__split_fields9))
                       2)))
     (ite (= (attr__tag temp___643) (attr__tag temp___644))
     (us_dispatch_eq temp___643 temp___644) false))) true))
...
;; H
  ...
  (= (let ((temp___649 (f 4)))
     (let ((temp___648 (get
                       (model__ (mk___rep1 v__split_discrs v__split_fields9))
                       1)))
     (ite (= (attr__tag temp___648) (attr__tag temp___649))
     (us_dispatch_eq temp___648 temp___649) false))) true))
...
;; H
  (assert
  (= (let ((temp___654 (f 3)))
     (let ((temp___653 (last_element
                       (mk___rep1 v__split_discrs v__split_fields9))))
     (ite (= (attr__tag temp___653) (attr__tag temp___654))
     (us_dispatch_eq temp___653 temp___654) false))) true))

;; H
  (assert (f__function_guard (f 0) 0))
...
;; H
  (assert
  (not (= (is_sorted (mk___rep1 v__split_discrs v__split_fields9)) true)))
...
;; H
  ...
  (= (length
     (mk___rep1 v__split_discrs
     indefinite_bounded_tagged__sort__sort__container__fields)) (length
                                                                (mk___rep1
                                                                v__split_discrs
                                                                v__split_fields9)))
  (= (m_elements_sorted
     (model__
     (mk___rep1 v__split_discrs
     indefinite_bounded_tagged__sort__sort__container__fields))) true))
  (= (m_elements_included
     (model__ (mk___rep1 v__split_discrs v__split_fields9)) 1
     (last
     (model__
     (mk___rep1 v__split_discrs
     indefinite_bounded_tagged__sort__sort__container__fields)))
     (model__
     (mk___rep1 v__split_discrs
     indefinite_bounded_tagged__sort__sort__container__fields)) 1
     (last
     (model__
     (mk___rep1 v__split_discrs
     indefinite_bounded_tagged__sort__sort__container__fields)))) true))
...
;; H
  (assert
  (= v__split_fields10 indefinite_bounded_tagged__sort__sort__container__fields))

;; H
  (assert
  (not (= (is_empty (mk___rep1 v__split_discrs v__split_fields10)) true)))
...
;; H
  ...
  (= (let ((temp___668 (f 3)))
     (let ((temp___667 (get
                       (model__
                       (mk___rep1 v__split_discrs v__split_fields10)) 1)))
     (ite (= (attr__tag temp___667) (attr__tag temp___668))
     (us_dispatch_eq temp___667 temp___668) false))) true))
...
;; H
  ...
  (= (let ((temp___673 (f 4)))
     (let ((temp___672 (get
                       (model__
                       (mk___rep1 v__split_discrs v__split_fields10)) 2)))
     (ite (= (attr__tag temp___672) (attr__tag temp___673))
     (us_dispatch_eq temp___672 temp___673) false))) true))
...
;; H
  (assert
  (and
  (= o11 (get (model__ (mk___rep1 v__split_discrs v__split_fields10)) 2))
  (= (let ((temp___385 (get
                       (model__
                       (mk___rep1 v__split_discrs v__split_fields10)) 2)))
     (ite (= (attr__tag o11) (attr__tag temp___385))
     (us_dispatch_eq o11 temp___385) false)) true)))
...
;; H
  ...
  (= (length
     (mk___rep1 v__split_discrs
     indefinite_bounded_tagged__vect__replace_element__container__fields1)) 
  (length (mk___rep1 v__split_discrs v__split_fields10)))
  (= (let ((temp___389 (get
                       (model__
                       (mk___rep1 v__split_discrs
                       indefinite_bounded_tagged__vect__replace_element__container__fields1))
                       1)))
     (ite (= (attr__tag temp___389) (attr__tag o11))
     (us_dispatch_eq temp___389 o11) false)) true))
  (= (equal_except (model__ (mk___rep1 v__split_discrs v__split_fields10))
     (model__
     (mk___rep1 v__split_discrs
     indefinite_bounded_tagged__vect__replace_element__container__fields1))
     1) true)))
...
;; H
  (assert (= result11 (mk___split_fields__ref1 v__split_fields10)))

;; H
  (assert
  (= v__split_fields11 indefinite_bounded_tagged__vect__replace_element__container__fields1))

(assert
;; WP_parameter_def
 ;; File "a-cfinve.ads", line 813, characters 0-0
  (not (not (= (capacity (mk___rep1 v__split_discrs v__split_fields11)) 5))))
(check-sat)
