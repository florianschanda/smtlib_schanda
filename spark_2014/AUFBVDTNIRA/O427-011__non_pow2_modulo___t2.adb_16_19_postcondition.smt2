...
(declare-fun t2__madd__result () (_ BitVec 8))

(declare-fun o () (_ BitVec 8))

(declare-fun result () (_ BitVec 8))

(declare-fun t2__madd__result1 () (_ BitVec 8))

(declare-fun t2__madd__result2 () (_ BitVec 8))

(declare-fun t2__madd__result3 () (_ BitVec 8))

(declare-fun t2__madd__result4 () (_ BitVec 8))

(declare-fun t2__madd__result5 () (_ BitVec 8))
...
;; H
  (assert (= t2__madd__result1 t2__madd__result2))

;; H
  (assert (= t2__madd__result3 t2__madd__result1))

;; H
  (assert
  (=> (bvule (bvsub ((_ int2bv 8) 230) x) y)
  (= o (bvsub (bvadd x y) ((_ int2bv 8) 230)))))

;; H
  (assert
  (=> (not (bvule (bvsub ((_ int2bv 8) 230) x) y)) (= o (bvadd x y))))

;; H
  (assert (= (mk_t__ref result) (mk_t__ref t2__madd__result)))

;; H
  (assert (= t2__madd__result1 o))

;; H
  (assert (= (mk_t__ref t2__madd__result4) (mk_t__ref t2__madd__result2)))

;; H
  (assert (= t2__madd__result5 t2__madd__result3))

;; H
  (assert (= result1 t2__madd__result4))

(assert
;; WP_parameter_def
 ;; File "t2.adb", line 6, characters 0-0
  (not
  (= ((_ zero_extend 56) t2__madd__result4) (bvurem (bvurem (bvadd ((_ zero_extend 56) 
  x) ((_ zero_extend 56) y)) ((_ int2bv 64) 65536)) ((_ int2bv 64) 230)))))
(check-sat)
