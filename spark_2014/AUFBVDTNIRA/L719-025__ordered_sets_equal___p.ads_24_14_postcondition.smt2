...
;; H
  ...
  (= (range_shifted (elements (mk___rep l__split_discrs l__split_fields6))
     ...
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (mk___rep1 (mk___split_fields1 cu__split_fields)))
     (length1 (mk___rep l__split_discrs l__split_fields6)) 1) true))
  (= (p_positions_shifted
...
;; H
  ...
  (= (e_is_find (elements (mk___rep l__split_discrs l__split_fields5)) 
     e1
  ...
  (and
  (and (not (= i true))
  (= (oeq4 (model__ (mk___rep l__split_discrs l__split_fields5))
  ...
  (= (oeq2 (positions (mk___rep l__split_discrs l__split_fields5))
