...
;; H
  (assert
  (and (and (= o8 (g4 3 g6)) (g4__function_guard o8 3 g6))
  (= (= o8 true) (< 0 g6))))
...
;; H
  (assert (g5__function_guard (g5 3 g6) 3 g6))

;; H
  (assert (g5__function_guard (g5 3 g6) 3 g6))

;; H
  (assert (and (= o9 (g5 3 g6)) (g5__function_guard o9 3 g6)))
...
;; H
  (assert
  (and (and (= o10 (p2 3)) (p2__function_guard o10 3))
  (= (= o10 true) (< 0 3))))
...
;; H
  (assert (p4__function_guard (p4 3) 3))
