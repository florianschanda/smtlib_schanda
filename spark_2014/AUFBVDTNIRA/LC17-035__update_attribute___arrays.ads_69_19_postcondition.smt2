...
(declare-fun arrays__swap_fun__result () (Array Int integer))
...
(declare-fun arrays__swap_fun__result1 () (Array Int integer))

(declare-fun arrays__swap_fun__result2 () (Array Int integer))

(declare-fun arrays__swap_fun__result3 () (Array Int integer))

(declare-fun arr4 () (Array Int integer))

(declare-fun arrays__swap_fun__result4 () (Array Int integer))

(declare-fun arr5 () (Array Int integer))

(declare-fun arrays__swap_fun__result5 () (Array Int integer))
