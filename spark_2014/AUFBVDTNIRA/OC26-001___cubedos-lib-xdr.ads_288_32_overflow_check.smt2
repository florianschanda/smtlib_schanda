...
;; H
  ...
  (= o5 (+ (- (to_rep1 value__last) (to_rep1 value__first)) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 value__first) (to_rep1 value__last))) (= o5 0)))

;; H
  (assert (and (= o6 o5) (in_range1 o5)))

;; H
  (assert (= result (ite (<= o6 65536) true false)))

;; H
  (assert (= result true))

;; H
  (assert (<= (to_rep1 (first2 (rt1 data))) position))

;; H
  (assert (<= position (to_rep1 (last2 (rt1 data)))))
...
;; H
  (assert (and (= o1 o) (in_range6 o)))

;; H
  (assert
  (and
  (and (= o2 (length_with_padding o1)) (length_with_padding__function_guard
  o2 o1))
  (and (in_range6 o2)
...
;; H
  (assert (= o4 (- (to_rep1 (last2 (rt1 data))) o3)))
