...
;; H
  ...
  (=> (and (<= 1 j) (<= j (- i1 1)))
  (and
  (and (not (= (to_rep (select b i1)) (to_rep (select b j))))
  (not (= (- i1 j) (- (to_rep (select b i1)) (to_rep (select b j))))))
  (not (= (- i1 j) (- (to_rep (select b j)) (to_rep (select b i1))))))))))))
  (and (= result true)
  (ite (= 8 i)
  (and
  (and (= (mk_bool__ref result1) (mk_bool__ref done__))
  (= done__2 (of_int 1))) (and (= b2 b) (= b2 b1)))
  (and
  (and (and (= o (+ i 1)) (in_range1 (+ i 1)))
  (and
  (ite (= done__3 true) (= (consistent b2 8) true)
  ...
  (and (not (= result true))
  (and
  (and (not (= (consistent c i) true))
  (not
  (forall ((j Int)) (=> (and (<= i j) (<= j 8)) (= (consistent c j) true)))))
  (and (and (= done__2 done__) (= b2 b)) (and (= done__2 done__1) (= b2 b1))))))
  (and (and (= done__2 done__4) (= b2 b3))
  (and (= done__5 done__2) (= b4 b2))))))
