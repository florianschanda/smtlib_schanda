...
;; H
  (assert
  (and
  (and (= result2 (state_c flag num)) (state_c__function_guard result2 
  flag num)) (= (= result2 true) (and (not (= flag true)) (< 0 num)))))
...
;; H
  (assert
  (and
  (and (= result3 (state_d flag num)) (state_d__function_guard result3 
  flag num)) (= (= result3 true) (and (not (= flag true)) (< num 0)))))
