...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral5) (/ 100000001490116119384765625.0 1000000000000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral6) (/ 20000000298023223876953125.0 100000000000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral7) (/ 20999999344348907470703125.0 100000000000000000000000000.0))))
...
;; H
  (assert (= z1 (add RNE2 (add RNE2 (add RNE2 x fliteral5) y) fliteral6)))

(assert
;; WP_parameter_def
 ;; File "fr.adb", line 1, characters 0-0
  (not (in_range3 (add RNE2 (add RNE2 (add RNE2 x fliteral5) y) fliteral7))))
(check-sat)
