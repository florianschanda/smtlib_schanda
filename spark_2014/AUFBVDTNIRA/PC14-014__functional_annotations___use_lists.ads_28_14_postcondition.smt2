...
(declare-fun l2__split_fields4 () us_split_fields__ref)
...
(declare-fun l2__split_fields6 () us_split_fields__ref)
...
(declare-fun l2__split_fields8 () us_split_fields__ref)

(declare-fun cu__split_fields8 () us_split_fields__ref1)

(declare-fun l2__split_fields9 () us_split_fields)
...
;; H
  ...
  (=>
  (and (<= 1 n)
  (<= n (length (mk___rep l2__split_discrs l2__split_fields12))))
  (= (is_incr (get (model__ l1) n)
     (get (model__ (mk___rep l2__split_discrs l2__split_fields12)) n)) true)))))
...
;; H
  (assert
  (=> (= result1 true)
  (ite (= (ite (= (bool_eq4 (mk___rep1 cu__split_fields11) no_element) false) (= 
          (get1 (positions l1) (mk___rep1 cu__split_fields11)) (length l1)) true) true)
  (= (bool_eq4 (mk___rep1 cu__split_fields10) no_element) true)
...
;; WP_parameter_def
 ;; File "use_lists.ads", line 23, characters 0-0
  (not
  (= (length
     (mk___rep l2__split_discrs (us_split_fields__content l2__split_fields8))) 
  (length l1))))
(check-sat)
