...
(define-fun dynamic_invariant ((temp___expr_5032 us_t1)
  ...
  (temp___do_toplevel_5031 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_5032))
                                       (and (= (first3 temp___expr_5032) 1)
                                       (= (last4 temp___expr_5032) 2)))))
...
(define-fun dynamic_invariant1 ((temp___expr_5048 us_t2)
  ...
  (temp___do_toplevel_5047 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_5048))
                                       (and (= (first5 temp___expr_5048) 1)
                                       (= (last6 temp___expr_5048) 2)))))
...
;; H
  (assert
  (and
  (and (= temp___78272 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___78272 reg)) (dynamic_invariant1
  temp___78272 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___78271)) (to_rep (last5 temp___78271)))
     (+ (- (to_rep (last5 temp___78271)) (to_rep (first4 temp___78271))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78271)) (to_rep (last5 temp___78271))) 
  temp___78281))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___78281)) (to_rep (last3 temp___78281)))
     (+ (- (to_rep (last3 temp___78281)) (to_rep (first2 temp___78281))) 1)
