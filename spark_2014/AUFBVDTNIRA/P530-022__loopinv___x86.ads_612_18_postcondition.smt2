...
;; H
  (assert
  (and
  (= (to_rep (select memory1 addr)) ((_ extract 7 0) (bvand val__ ((_ int2bv 16) 255))))
  (forall ((i (_ BitVec 64)))
  (=>
...
;; H
  (assert
  (and (= (to_rep (select memory2 (bvadd addr ((_ int2bv 64) 1)))) o3)
  (forall ((i (_ BitVec 64)))
  (=>
  (and (bvule ((_ int2bv 64) 0) i)
  (bvule i ((_ int2bv 64) 18446744073709551615)))
...
;; WP_parameter_def
 ;; File "x86.ads", line 9, characters 0-0
  (not
  (= (bvand val__ ((_ int2bv 16) 255)) ((_ zero_extend 8) (to_rep
                                                          (select memory3 
                                                          addr))))))
(check-sat)
