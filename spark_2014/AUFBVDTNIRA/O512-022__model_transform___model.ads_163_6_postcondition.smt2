...
(define-fun bool_eq10 ((a (Array Int us_rep3)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq8 (select a temp___idx_134)
...
(define-fun bool_eq13 ((a (Array Int us_rep4)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq11 (select a temp___idx_138)
...
(declare-fun model__transform__result () (Array Int us_rep3))

(declare-fun model__transform__result1 () (Array Int us_rep4))
...
(declare-fun s10 () int__ref)

(declare-fun cfv6 () (Array Int us_rep4))

(declare-fun s11 () Int)

(declare-fun cfv7 () map__ref3)

(declare-fun s12 () int__ref)

(declare-fun cfv8 () (Array Int us_rep4))

(declare-fun s13 () Int)

(declare-fun act__split_fields3 () us_split_fields10)

(declare-fun act__split_fields4 () us_split_fields10)

(declare-fun result8 () uml_activity__ref)

(declare-fun model__transform__result2 () us_rep5)

(declare-fun model__transform__result3 () uml_activity__ref)

(declare-fun model__transform__result4 () us_rep5)

(declare-fun av8 () map__ref2)

(declare-fun cfv9 () map__ref3)

(declare-fun act__split_fields5 () us_split_fields__ref5)

(declare-fun s14 () int__ref)

(declare-fun s15 () int__ref)

(declare-fun model__transform__result5 () uml_activity__ref)

(declare-fun av9 () (Array Int us_rep3))

(declare-fun cfv10 () (Array Int us_rep4))

(declare-fun act__split_fields6 () us_split_fields10)

(declare-fun s16 () Int)

(declare-fun s17 () Int)

(declare-fun model__transform__result6 () us_rep5)

(define-fun o10 () us_rep (mk___rep (mk___split_fields o)))

(declare-fun result9 () (Array Int us_rep3))
...
;; H
  (assert
  (=> (and (<= 0 s8) (<= s8 100))
  (and (=> (<= 0 100) (in_range7 s9)) (and (<= 0 s9) (<= s9 100)))))
...
;; H
  (assert
  (=> (not (and (<= 0 s8) (<= s8 100))) (= cfv7 (mk_map__ref3 cfv1))))
...
;; H
  (assert
  (and
  (= (bool_eq10 (owned_action (mk___rep5 act__split_fields3)) 0 100
     (map__content2 av6) 0 100) true)
  (= (bool_eq13 (owned_flow (mk___rep5 act__split_fields3)) 0 100
     (owned_flow (mk___rep5 act__split_fields2)) 0 100) true)))

;; H
  (assert
  (and
  (= (bool_eq13 (owned_flow (mk___rep5 act__split_fields4)) 0 100
     (map__content3 cfv7) 0 100) true)
  (= (bool_eq10 (owned_action (mk___rep5 act__split_fields4)) 0 100
     (owned_action (mk___rep5 act__split_fields3)) 0 100) true)))

;; H
  (assert
  (= model__transform__result3 (mk_uml_activity__ref
                               model__transform__result2)))
...
;; H
  (assert
  (= result8 (mk_uml_activity__ref
             (mk___rep5
             (mk___split_fields5 model__transform__result
             model__transform__result1)))))
...
;; H
  (assert
  (= act__split_fields5 (mk___split_fields__ref5 act__split_fields4)))
...
;; H
  (assert
  (= (mk___rep5 (mk___split_fields5 result9 result10)) (uml_activity__content
                                                       model__transform__result5)))
