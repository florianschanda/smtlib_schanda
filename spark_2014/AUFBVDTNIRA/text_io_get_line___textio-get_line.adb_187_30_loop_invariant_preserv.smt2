...
;; H
  ...
  (and (= (- cur_position2 cur_position1) (- last7 last6))
  (and
  (forall ((idx Int))
  ...
  (and
  (and
  (= last7 (- (+ last6 (find_char_in_slice 10 cur_position1
  ...
  (<= idx (- (find_char_in_slice 10 cur_position1 (- (+ cur_position1 80) 2)
             the_file) 1)))
  (= (to_rep (select item3 (+ (- (+ last6 idx) cur_position1) 1))) (to_rep
                                                                   (select 
                                                                   the_file idx))))))
  (= textio__get_line__get_chunk__rest 0))
  (and
  (and
  (= last7 (- (+ last6 (find_char_in_slice eof_ch cur_position1
                       (- (+ cur_position1 80) 2) the_file)) cur_position1))
  (forall ((idx Int))
  (=>
  (and (<= cur_position1 idx)
...
;; WP_parameter_def
 ;; File "i-cstrea.ads", line 56, characters 0-0
  (not (<= (to_rep1 item__first) (+ last7 1))))
(check-sat)
