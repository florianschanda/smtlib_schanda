...
;; def_axiom
  ...
  (= (select (temp___250 temp___252) 1) (of_rep temp___252))))

(declare-fun temp___719 (Int) (Array Int element))

;; def_axiom
  (assert
  (forall ((temp___721 Int))
  (= (select (temp___719 temp___721) 1) (of_rep temp___721))))
...
;; H
  (assert
  (= (bool_eq2
     (let ((temp___729 (temp___250 e2)))
     (let ((temp___728 (get_model__3
                       (mk___rep1 s__split_fields8 s__attr__tag))))
     (ite (= (length temp___728) 0) temp___729
     (concat1 (elts temp___728) (to_rep1 (first (rt temp___728)))
     (to_rep1 (last (rt temp___728))) temp___729 1 1))))
     (to_rep1
     (first
     (let ((temp___728 (get_model__3
                       (mk___rep1 s__split_fields8 s__attr__tag))))
     (ite (= (length temp___728) 0) (mk 1 1)
     (mk (to_rep1 (first (rt temp___728)))
     (- (+ (to_rep1 (first (rt temp___728))) (+ (ite (<= (to_rep1
                                                         (first
                                                         (rt temp___728))) 
                                                (to_rep1
                                                (last (rt temp___728))))
...
;; WP_parameter_def
 ;; File "stackp.adb", line 26, characters 0-0
  (not
  (= (bool_eq2
     (let ((temp___724 (temp___719 e2)))
     (let ((temp___723 (get_model__3
                       (mk___rep1 s__split_fields8 s__attr__tag))))
     (ite (= (length temp___723) 0) temp___724
     (concat1 (elts temp___723) (to_rep1 (first (rt temp___723)))
     (to_rep1 (last (rt temp___723))) temp___724 1 1))))
     (to_rep1
     (first
     (let ((temp___723 (get_model__3
                       (mk___rep1 s__split_fields8 s__attr__tag))))
     (ite (= (length temp___723) 0) (mk 1 1)
     (mk (to_rep1 (first (rt temp___723)))
     (- (+ (to_rep1 (first (rt temp___723))) (+ (ite (<= (to_rep1
                                                         (first
                                                         (rt temp___723))) 
                                                (to_rep1
                                                (last (rt temp___723))))
