...
(declare-fun temp___1126 ((_ BitVec 8) Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___1128 (_ BitVec 8)))
  (forall ((temp___1129 Int) (temp___1130 Int))
  (let ((temp___1127 (temp___1126 temp___1128 temp___1129 temp___1130)))
  (and
  (=> (dynamic_property6 1 65536 temp___1129 temp___1130)
  (and (= (first5 temp___1127) temp___1129)
  (= (last8 temp___1127) temp___1130)))
  (forall ((temp___1131 Int))
  (= (select (to_array2 temp___1127) temp___1131) (of_rep1 temp___1128))))))))

(define-fun dynamic_invariant5 ((temp___expr_343 us_t1)
  ...
  (temp___do_toplevel_342 Bool)) Bool (=>
                                      ...
                                      (first3 temp___expr_343)
                                      (last5 temp___expr_343))
                                      (and (= (first3 temp___expr_343) 1)
                                      (= (last5 temp___expr_343) r9b)))))
