...
;; H
  (assert
  (and (= o (sqrt2 (of_ubv8 RNA2 i)))
  (and (tqtisFinite o)
  (and (le fliteral2 o)
  (and (=> (eq (of_ubv8 RNA2 i) fliteral2) (eq o fliteral2))
  (and (=> (eq (of_ubv8 RNA2 i) fliteral) (eq o fliteral))
  (=> (le fliteral3 (of_ubv8 RNA2 i)) (lt fliteral2 o))))))))
...
;; WP_parameter_def
 ;; File "interfac.ads", line 63, characters 0-0
  (not (le (of_ubv8 RTP2 ((_ int2bv 8) 0)) o1)))
(check-sat)
