...
;; H
  (assert
  (and (<= (to_rep (first (rt b))) temp___763)
  (<= temp___763 (to_rep (last (rt b))))))

;; H
  (assert (= o2 temp___763))
...
;; H
  ...
  (from_word32 lsc__bignum__single_add_mult_mult__a)
  lsc__bignum__single_add_mult_mult__a))

;; H
  (assert (from_word32__function_guard (from_word32 bi1) bi1))

;; H
  (assert (from_word32__function_guard (from_word32 o19) o19))
...
;; H
  (assert (omultiply__function_guard
  (omultiply (from_word32 bi1) (from_word32 o19)) (from_word32 bi1)
  (from_word32 o19)))
...
;; H
  (assert (from_word32__function_guard (from_word32 o22) o22))

;; H
  (assert (from_word32__function_guard (from_word32 u1) u1))
...
;; H
  (assert (omultiply__function_guard
  (omultiply (from_word32 o22) (from_word32 u1)) (from_word32 o22)
  (from_word32 u1)))
...
;; H
  ...
  (oadd (from_word32 lsc__bignum__single_add_mult_mult__a)
  (omultiply (from_word32 bi1) (from_word32 o19)))
  (omultiply (from_word32 o22) (from_word32 u1)))
  (oadd (from_word32 lsc__bignum__single_add_mult_mult__a)
  (omultiply (from_word32 bi1) (from_word32 o19)))
  (omultiply (from_word32 o22) (from_word32 u1))))
...
;; H
  (assert (from_word32__function_guard
  (from_word32 lsc__bignum__single_add_mult_mult__a1)
  lsc__bignum__single_add_mult_mult__a1))
...
;; H
  ...
  (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (+ a_first 1)
  (+ (- o26 a_first) 1)))

;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int c o27 (+ (- o26 a_first) 1)) c o27 (+ (- o26 a_first) 1)))
...
;; H
  (assert (omultiply__function_guard
  (omultiply (num_of_big_int c o27 (+ (- o26 a_first) 1)) (from_word32 bi1))
  (num_of_big_int c o27 (+ (- o26 a_first) 1)) (from_word32 bi1)))
...
;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int m o28 (+ (- o26 a_first) 1)) m o28 (+ (- o26 a_first) 1)))
...
;; H
  (assert (omultiply__function_guard
  (omultiply (num_of_big_int m o28 (+ (- o26 a_first) 1)) (from_word32 u1))
  (num_of_big_int m o28 (+ (- o26 a_first) 1)) (from_word32 u1)))
...
;; H
  ...
  (omultiply (num_of_big_int c o27 (+ (- o26 a_first) 1)) (from_word32 bi1)))
  (omultiply (num_of_big_int m o28 (+ (- o26 a_first) 1)) (from_word32 u1)))
  (from_word32 carry12)) (omultiply (base Tuple0) (from_word32 carry22)))
  (oadd
  (oadd
  (oadd
  (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))
...
;; H
  (assert (oexpon__function_guard
  (oexpon (base Tuple0) (+ (- o26 a_first) 1)) (base Tuple0)
  (+ (- o26 a_first) 1)))
...
;; H
  ...
  (oadd (from_word32 carry13)
  (omultiply (base Tuple0) (from_word32 carry23))))
  (oexpon (base Tuple0) (+ (- o26 a_first) 1))
  (oadd (from_word32 carry13)
  (omultiply (base Tuple0) (from_word32 carry23)))))
...
;; H
  (assert (from_word32__function_guard (from_word32 o36) o36))

;; H
  (assert (num_of_boolean__function_guard (num_of_boolean o35) o35))
...
;; H
  (assert (oeq__function_guard (oeq (from_word32 o36) (num_of_boolean o35))
  (from_word32 o36) (num_of_boolean o35)))
...
;; H
  (assert
  (and
  (and (= o36 (word_of_boolean o35)) (word_of_boolean__function_guard 
  o36 o35)) (= (oeq (from_word32 o36) (num_of_boolean o35)) true)))
...
;; H
  (assert
  (and (= o84 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o84 ((_ int2bv 32) 1))))
...
;; H
  (assert
  (and (= o82 (num_of_big_int m m_first o81)) (num_of_big_int__function_guard
  o82 m m_first o81)))

;; H
  (assert
  (and (= o77 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o77 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o83 (omultiply o77 o82)) (omultiply__function_guard o83 o77 o82)))

;; H
  (assert
  (and (= o85 (osubtract o83 o84)) (osubtract__function_guard o85 o83 o84)))

;; H
  (assert
  (and (= o74 (from_word32 a_msw3)) (from_word32__function_guard o74 a_msw3)))
...
;; H
  (assert
  (and (and (= o68 (base Tuple0)) (base__function_guard o68 Tuple0))
  (= o68 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o73 (oexpon o68 o72)) (oexpon__function_guard o73 o68 o72)))

;; H
  (assert
  (and (= o75 (omultiply o73 o74)) (omultiply__function_guard o75 o73 o74)))
...
;; H
  ...
  (= o67 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))
         a_first o66))
  (num_of_big_int__function_guard o67
  (mk___t a4 (mk (to_rep a__first) (to_rep a__last))) a_first o66)))

;; H
  (assert (and (= o76 (oadd o67 o75)) (oadd__function_guard o76 o67 o75)))

;; H
  (assert (and (= o86 (olt o76 o85)) (olt__function_guard o86 o76 o85)))
...
;; H
  (assert
  (and (= o62 (num_of_big_int m m_first o61)) (num_of_big_int__function_guard
  o62 m m_first o61)))
...
;; H
  (assert
  (and (and (= o51 (base Tuple0)) (base__function_guard o51 Tuple0))
...
;; H
  (assert
  (and (= o50 (num_of_big_int m m_first o49)) (num_of_big_int__function_guard
  o50 m m_first o49)))

;; H
  (assert
  (and (= o52 (inverse o50 o51)) (inverse__function_guard o52 o50 o51)))

;; H
  (assert
  (and (= o57 (oexpon o52 o56)) (oexpon__function_guard o57 o52 o56)))
...
;; H
  (assert
  (and (= o45 (num_of_big_int c c_first o44)) (num_of_big_int__function_guard
  o45 c c_first o44)))
