...
(declare-fun temp___245 () token_kind)

(declare-fun temp___2451 () integer)

(declare-fun temp___2452 () operation)

(declare-fun temp___2453 () instruction)

(declare-fun temp___2454 () Bool)
...
(define-fun o23 () us_rep (mk___rep (mk___split_fields o18)))
...
;; H
  (assert (= temp___245 o22))

;; H
  (assert (= temp___2451 o19))

;; H
  (assert (= temp___2452 o20))

;; H
  (assert (= temp___2453 o21))

;; H
  (assert (= true temp___2454))
...
;; WP_parameter_def
 ;; File "tokens.ads", line 14, characters 0-0
  (not (= temp___245 (rec__tokens__token__kind v__split_discrs))))
(check-sat)
