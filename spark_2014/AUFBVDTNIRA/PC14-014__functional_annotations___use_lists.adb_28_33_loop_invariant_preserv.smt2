...
(declare-fun l2__split_fields1 () us_main_type)

(declare-fun cu__split_fields2 () count_type)

(declare-fun result2 () Bool)

(declare-fun l2__split_fields2 () us_main_type)

(declare-fun l2__split_fields3 () us_main_type)
...
(define-fun l2__split_fields4 () us_split_fields (mk___split_fields
                                                 l2__split_fields3))

(define-fun l2__split_fields5 () us_split_fields (mk___split_fields
                                                 l2__split_fields2))

(define-fun cu__split_fields5 () us_split_fields2 (mk___split_fields1
                                                  cu__split_fields2))

(define-fun l2__split_fields6 () us_split_fields (mk___split_fields
                                                 l2__split_fields1))
...
;; H
  ...
  (= (bool_eq4 use_lists__incr_all__cu__assume1 no_element) true)
...
;; H
  (assert
  (= (length
     (mk___rep l2__split_discrs (mk___split_fields l2__split_fields))) 0))

;; H
  (assert
  (and (= result1 (has_key (positions l1) (mk___rep1 cu__split_fields6)))
  (= (= result1 true)
  (= (has_key (positions l1) (mk___rep1 cu__split_fields6)) true))))
...
;; H
  ...
  (get (model__ (mk___rep l2__split_discrs l2__split_fields6)) n))
  (get (model__ l1) n)
  (get (model__ (mk___rep l2__split_discrs l2__split_fields6)) n))))
...
;; H
  ...
  (=>
  (and (<= 1 n)
  (<= n (length (mk___rep l2__split_discrs l2__split_fields6))))
  (= (is_incr (get (model__ l1) n)
     (get (model__ (mk___rep l2__split_discrs l2__split_fields6)) n)) true))))

;; H
  (assert
  (= (get1 (positions l1) (mk___rep1 cu__split_fields5)) (+ (length
                                                            (mk___rep
                                                            l2__split_discrs
                                                            l2__split_fields6)) 1)))

;; H
  (assert (= (has_key (positions l1) (mk___rep1 cu__split_fields5)) true))

;; H
  (assert
  (and (= o (element l1 (mk___rep1 cu__split_fields5)))
  (and (in_range7 o)
  (= o (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields5)))))))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= o1 (element l1 (mk___rep1 cu__split_fields5)))
  (and (in_range7 o1)
  (= o1 (get (model__ l1)
        (get1 (positions l1) (mk___rep1 cu__split_fields5))))))))

;; H
  (assert (=> (= result2 true) (= o2 (+ o1 1))))

;; H
  (assert (=> (= result2 true) (and (= o3 o2) (in_range3 o2))))
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep l2__split_discrs l2__split_fields5)) (+ (length
                                                               (mk___rep
                                                               l2__split_discrs
                                                               l2__split_fields6)) 1))
  (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields5))
     (last1 (mk___rep l2__split_discrs l2__split_fields5))) (length
                                                            (mk___rep
                                                            l2__split_discrs
                                                            l2__split_fields5))))
  (= (keys_included_except
     (positions (mk___rep l2__split_discrs l2__split_fields5))
     (positions (mk___rep l2__split_discrs l2__split_fields6))
     (last1 (mk___rep l2__split_discrs l2__split_fields5))) true))
  (= (ole1 (positions (mk___rep l2__split_discrs l2__split_fields6))
     (positions (mk___rep l2__split_discrs l2__split_fields5))) true))
  (= (get (model__ (mk___rep l2__split_discrs l2__split_fields5))
     (length (mk___rep l2__split_discrs l2__split_fields5))) o3))
  (= (ole (model__ (mk___rep l2__split_discrs l2__split_fields6))
     (model__ (mk___rep l2__split_discrs l2__split_fields5))) true))))

;; H
  (assert
  (=> (not (= result2 true))
  (and (= o4 (element l1 (mk___rep1 cu__split_fields5)))
  (and (in_range7 o4)
  (= o4 (get (model__ l1)
        (get1 (positions l1) (mk___rep1 cu__split_fields5))))))))
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep l2__split_discrs l2__split_fields4)) (+ (length
                                                               (mk___rep
                                                               l2__split_discrs
                                                               l2__split_fields6)) 1))
  (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields4))
     (last1 (mk___rep l2__split_discrs l2__split_fields4))) (length
                                                            (mk___rep
                                                            l2__split_discrs
                                                            l2__split_fields4))))
  (= (keys_included_except
     (positions (mk___rep l2__split_discrs l2__split_fields4))
     (positions (mk___rep l2__split_discrs l2__split_fields6))
     (last1 (mk___rep l2__split_discrs l2__split_fields4))) true))
  (= (ole1 (positions (mk___rep l2__split_discrs l2__split_fields6))
     (positions (mk___rep l2__split_discrs l2__split_fields4))) true))
  (= (get (model__ (mk___rep l2__split_discrs l2__split_fields4))
     (length (mk___rep l2__split_discrs l2__split_fields4))) o4))
  (= (ole (model__ (mk___rep l2__split_discrs l2__split_fields6))
     (model__ (mk___rep l2__split_discrs l2__split_fields4))) true))))

;; H
  (assert
  (=> (not (= result2 true)) (= l2__split_fields5 l2__split_fields4)))

;; H
  (assert
  (ite (= (ite (= (bool_eq4 (mk___rep1 cu__split_fields5) no_element) false) (= 
          (get1 (positions l1) (mk___rep1 cu__split_fields5)) (length l1)) true) true)
  (= (bool_eq4 (mk___rep1 cu__split_fields4) no_element) true)
  (and (= (has_key (positions l1) (mk___rep1 cu__split_fields4)) true)
  (= (get1 (positions l1) (mk___rep1 cu__split_fields4)) (+ (get1
                                                            (positions l1)
                                                            (mk___rep1
                                                            cu__split_fields5)) 1)))))
...
;; H
  (assert
  (and (= o5 (has_key (positions l1) (mk___rep1 cu__split_fields4)))
  (= (= o5 true)
  (= (has_key (positions l1) (mk___rep1 cu__split_fields4)) true))))
...
;; WP_parameter_def
 ;; File "use_lists.ads", line 23, characters 0-0
  (not
  (= (get1 (positions l1) (mk___rep1 cu__split_fields4)) (+ (length
                                                            (mk___rep
                                                            l2__split_discrs
                                                            l2__split_fields5)) 1))))
(check-sat)
