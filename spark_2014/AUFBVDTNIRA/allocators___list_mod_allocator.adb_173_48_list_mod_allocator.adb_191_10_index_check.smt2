...
(declare-fun list_mod_allocator__alloc__ma__assume () us_rep1)
...
(declare-fun o19 () us_rep3)

(declare-fun o20 () us_split_fields2)

(declare-fun list_mod_allocator__alloc__C83b__assume () us_rep1)

(declare-fun list_mod_allocator__alloc__B85b__L_4__R86b__assume () Int)
...
;; H
  (assert (model_is_well_formed__function_guard
  (model_is_well_formed o19 data1 first_available1) o19 data1
  first_available1))

;; H
  (assert
  (and
  (and (= o19 (model__ data1 first_available1)) (model____function_guard 
  o19 data1 first_available1))
  (= (model_is_well_formed o19 data1 first_available1) true)))
...
;; H
  (assert
  (= list_mod_allocator__alloc__C83b__assume (rec__list_mod_allocator__m__t__available
                                             o20)))

;; H
  (assert (= list_mod_allocator__alloc__C83b__assume c83b))
...
;; H
  (assert
  (and (= list_mod_allocator__alloc__B85b__L_4__R86b__assume (length c83b))
  (and (in_range5 list_mod_allocator__alloc__B85b__L_4__R86b__assume)
  (<= (+ 0 list_mod_allocator__alloc__B85b__L_4__R86b__assume) 2147483647))))

;; H
  (assert (= list_mod_allocator__alloc__B85b__L_4__R86b__assume r86b))

;; H
  (assert (in_range1 r86b))
...
;; H
  (assert (<= (+ i2 1) (length c84b)))

;; H
  (assert
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 i2)) (= (get c83b j1) (get c84b (+ j1 1))))))

;; H
  (assert
  (forall ((j1 Int))
  (=> (and (<= 2 j1) (<= j1 (+ i2 1))) (= (get c83b (- j1 1)) (get c84b j1)))))

;; H
  (assert
  (and (=> (<= 1 r86b) (dynamic_property 1 r86b i2))
  (and (<= 1 i2) (<= i2 r86b))))

;; H
  (assert (and (= o21 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert (= o22 (ite (<= j o21) true false)))

;; H
  (assert (= result5 (ite (<= 1 j) o22 false)))

;; H
  (assert (= result5 true))

;; H
  (assert (and (= temp___365 (get c83b i2)) (in_range6 temp___365)))
