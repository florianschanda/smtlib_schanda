...
(declare-fun temp___1580 () (Array Int us_rep7))
...
;; H
  ...
  (eq (select (nb_blacks c75b) i) (select (nb_blacks c74b) i))
  (select (nb_blacks c75b) i) (select (nb_blacks c74b) i))))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
             (rec__red_black_trees__rbt__struct (us_split_fields9 c74b))) i))) true)
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c74b) i)))) n6))
  (ite (= (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))
          i) c76b)
  (and
  (= (rec__red_black_trees__black_count__status
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select (nb_blacks c75b) i)))) (+ (to_rep
                                                          (rec__red_black_trees__black_count__count
                                                          (us_split_fields11
                                                          (select (nb_blacks
                                                                  c74b) i)))) 1)))
  (= (eq (select (nb_blacks c75b) i) (select (nb_blacks c74b) i)) true))))))
...
;; H
  (assert
  (forall ((i Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c74b)) i 0)
  (rec__red_black_trees__rbt__struct (us_split_fields9 c74b)) i 0)))

;; H
  (assert
  (forall ((i Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c74b)) i 1)
  (rec__red_black_trees__rbt__struct (us_split_fields9 c74b)) i 1)))
...
;; H
  (assert
  (and
  (and (= temp___1580 (nb_blacks c74b)) (nb_blacks__function_guard
  temp___1580 c74b))
  (and
  (= (bool_eq17 (select temp___1580 0)
     (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true)
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  ...
  (=
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select temp___1580 i))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11
     (select temp___1580 (peek
                         (rec__red_black_trees__rbt__struct
                         (us_split_fields9 c74b)) i 0))))) (to_rep
                                                           (rec__red_black_trees__black_count__count
                                                           (us_split_fields11
                                                           (select temp___1580 
                                                           (peek
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select temp___1580 i)))) (+ 1 (ite (< (to_rep
                                                               (rec__red_black_trees__black_count__depth
                                                               (us_split_fields11
                                                               (select 
                                                               temp___1580 
  ...
  (select temp___1580 (peek
                      (rec__red_black_trees__rbt__struct
                      (us_split_fields9 c74b)) i 1)))))) (to_rep
                                                         (rec__red_black_trees__black_count__depth
                                                         (us_split_fields11
                                                         (select temp___1580 
                                                         (peek
  ...
  (select temp___1580 (peek
                      (rec__red_black_trees__rbt__struct
                      (us_split_fields9 c74b)) i 0)))))))))
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select temp___1580 i)))) (+ (ite (= (to_rep3
                                                             (select 
                                                             (rec__red_black_trees__rbt__color
                                                             (us_split_fields9
                                                             c74b)) i)) 0)
...
;; H
  (assert (= o38 (select temp___1580 c76b)))
...
;; H
  (assert
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select (nb_blacks c75b) c76b))) true))
...
;; WP_parameter_def
 ;; File "red_black_trees.ads", line 59, characters 0-0
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select (nb_blacks c75b) c76b)))) (to_rep
                                                          (rec__red_black_trees__black_count__count
                                                          (us_split_fields11
                                                          (select (nb_blacks
                                                                  c74b) 
