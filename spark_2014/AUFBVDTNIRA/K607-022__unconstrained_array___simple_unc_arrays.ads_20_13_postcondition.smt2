...
(declare-fun dummy1 () tvalueB)

(declare-datatypes ()
((tvalueB__ref (mk_tvalueB__ref (tvalueB__content tvalueB)))))
...
;; same_range__def_axiom
  ...
  (! (=> (same_range__function_guard (same_range a1 b1) a1 b1)
...
(declare-datatypes ()
((tT6bP1__ref (mk_tT6bP1__ref (tT6bP1__content integer)))))
(define-fun tT6bP1__ref___projection ((a1 tT6bP1__ref)) integer (tT6bP1__content
                                                                a1))
...
(define-fun of_array1 ((a1 (Array Int value)) (f Int)
  (l Int)) us_t1 (mk___t1 a1 (mk1 f l)))

(define-fun first3 ((a1 us_t1)) Int (to_rep2 (first2 (rt1 a1))))

(define-fun last5 ((a1 us_t1)) Int (to_rep2 (last4 (rt1 a1))))

(define-fun length1 ((a1 us_t1)) Int (ite (<= (first3 a1) (last5 a1))
                                     (+ (- (last5 a1) (first3 a1)) 1) 0))
...
;; object__component__size_axiom
  (assert
  (forall ((a1 (Array Int value))) (<= 0 (object__component__size1 a1))))
...
(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1 (rec__simple_unc_arrays__table__v1 us_t1)))))
(define-fun us_split_fields_V4__projection ((a1 us_split_fields2)) us_t1 
  (rec__simple_unc_arrays__table__v1 a1))

(declare-datatypes ()
((us_split_fields__ref1
 (mk___split_fields__ref1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref_5__projection ((a1 us_split_fields__ref1)) us_split_fields2 
...
(define-fun us_rep_9__projection ((a1 us_rep1)) us_split_discrs (us_split_discrs2
                                                                a1))

(define-fun us_rep_10__projection ((a1 us_rep1)) us_split_fields2 (us_split_fields3
                                                                  a1))

(define-fun to_base ((a1 us_rep1)) us_rep (mk___rep (us_split_discrs2 a1)
                                          (mk___split_fields
                                          (let ((temp___157 (rec__simple_unc_arrays__table__v1
                                                            (us_split_fields3
                                                            a1))))
                                          (of_array (to_array1 temp___157)
                                          (first3 temp___157)
                                          (last5 temp___157))))))
...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r)
                                         ...
                                         (let ((temp___156 (rec__simple_unc_arrays__table__v
                                                           (us_split_fields1
                                                           r))))
                                         (of_array1 (to_array temp___156)
                                         (first1 temp___156)
                                         (last2 temp___156))))))

(define-fun bool_eq10 ((a1 us_rep1)
...
(declare-fun simple_unc_arrays__table__last__first__bit1 () Int)

(declare-fun simple_unc_arrays__table__last__last__bit1 () Int)

(declare-fun simple_unc_arrays__table__last__position1 () Int)
...
(declare-fun simple_unc_arrays__table__v__first__bit1 () Int)

(declare-fun simple_unc_arrays__table__v__last__bit1 () Int)

(declare-fun simple_unc_arrays__table__v__position1 () Int)
...
(define-fun dynamic_invariant2 ((temp___expr_681 us_rep1)
  (temp___is_init_678 Bool) (temp___skip_constant_679 Bool)
  (temp___do_toplevel_680 Bool)) Bool (and
                                      (=>
                                      ...
                                      (first3
                                      (rec__simple_unc_arrays__table__v1
                                      (us_split_fields3 temp___expr_681)))
                                      (last5
                                      (rec__simple_unc_arrays__table__v1
                                      (us_split_fields3 temp___expr_681))))
                                      (and
                                      (= (first3
                                         (rec__simple_unc_arrays__table__v1
                                         (us_split_fields3 temp___expr_681))) 1)
                                      (= (last5
                                         (rec__simple_unc_arrays__table__v1
                                         (us_split_fields3 temp___expr_681))) 
                                      (to_rep
...
(define-fun default_initial_assumption ((temp___expr_684 us_rep1)
  (temp___skip_top_level_685 Bool)) Bool (= (to_rep
                                            (rec__simple_unc_arrays__table__last
                                            (us_split_discrs2
                                            temp___expr_684))) (to_rep
                                                               (rec__simple_unc_arrays__table__last
                                                               (us_split_discrs1
                                                               a)))))
...
(declare-fun c__split_fields () (Array Int value))

(declare-fun c__split_fields1 () t1)

(declare-fun i () Int)

(declare-fun simple_unc_arrays__add__result () natural)

(declare-fun simple_unc_arrays__add__result1 () (Array Int value))

(declare-fun simple_unc_arrays__add__result2 () t)
...
(declare-fun temp___806 () Int)

(declare-fun temp___803 () natural)

(declare-fun temp___8031 () (Array Int value))

(declare-fun temp___8032 () t1)
...
(declare-fun o10 () (Array Int value))
...
(declare-fun temp___802 () natural)

(declare-fun temp___8021 () (Array Int value))

(declare-fun temp___8022 () t1)

(declare-fun c__split_fields2 () (Array Int value))

(declare-fun c__split_fields3 () t1)
...
(declare-fun c__split_fields6 () us_split_fields__ref1)
...
(declare-fun c__split_fields8 () us_split_fields__ref1)
...
(declare-fun result2 () table__ref)

(declare-fun simple_unc_arrays__add__result3 () us_rep)

(declare-fun c__split_fields10 () us_split_fields__ref1)

(declare-fun i7 () int__ref)

(declare-fun simple_unc_arrays__add__result4 () table__ref)

(declare-fun c__split_fields11 () us_split_fields2)

(declare-fun i8 () Int)

(declare-fun simple_unc_arrays__add__result5 () us_rep)

(declare-fun c__split_fields12 () us_split_fields__ref1)

(declare-fun i9 () int__ref)

(declare-fun simple_unc_arrays__add__result6 () table__ref)

(declare-fun c__split_fields13 () us_split_fields2)

(declare-fun i10 () Int)

(declare-fun simple_unc_arrays__add__result7 () us_rep)

(declare-fun result3 () natural)
...
;; H
  (assert
  (and
  (= us (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 b))))
  (in_range1
  (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 b))))))

;; H
  (assert
  (and
  (= us1 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))
  (in_range1
  (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))))

;; H
  (assert
  (= simple_unc_arrays__add__result4 (mk_table__ref
                                     simple_unc_arrays__add__result3)))
...
;; H
  (assert
  (= simple_unc_arrays__add__result5 simple_unc_arrays__add__result3))
...
;; H
  (assert
  (and
  (= us2 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))
  (in_range1
  (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))))

;; H
  (assert
  (= (to_rep (rec__simple_unc_arrays__table__last c__split_discrs)) (to_rep
                                                                    (rec__simple_unc_arrays__table__last
                                                                    (us_split_discrs1
                                                                    a)))))
...
;; H
  ...
  (mk___rep1 c__split_discrs
  (mk___split_fields1 (mk___t1 c__split_fields c__split_fields1))) false
  false true))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 r7b)) (= temp___806 i1)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r7b))
  (and (= c__split_discrs (mk___split_discrs temp___803))
  (and (= c__split_fields temp___8031) (= c__split_fields1 temp___8032)))))
...
;; H
  ...
  (=> (and (<= 1 j) (<= j (- i2 1)))
  (= (to_rep1
     (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields4)) j)) (+ 
  (to_rep1
  (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j)) 
  (to_rep1
  (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 b))) j))))))))
...
;; H
  ...
  (and
  (and
  (and (dynamic_invariant2 (mk___rep1 c__split_discrs c__split_fields4) false
  true true)
  (forall ((temp___805 Int))
  (=>
  (and
  (<= (to_rep2
      (first2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4)))) temp___805)
  (<= temp___805 (to_rep2
                 (last4
                 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4))))))
  (=> (<= i2 temp___805)
  (= (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields4)) temp___805) (select 
  temp___8031 temp___805)))))) (=> (<= 1 r7b) (dynamic_property4 1 r7b i2)))
  (and (<= 1 i2) (<= i2 r7b)))))
...
;; H
  ...
  (and
  (<= (to_rep2
      (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 b))))) 
  i2)
  (<= i2 (to_rep2
         (last1 (rt (rec__simple_unc_arrays__table__v (us_split_fields1 b)))))))))
...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 r7b))
  (= o3 (select (elts
                (rec__simple_unc_arrays__table__v (us_split_fields1 b))) 
  o2))))
...
;; H
  ...
  (and
  (<= (to_rep2
      (first2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4)))) 
  i2)
  (<= i2 (to_rep2
         (last4 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4))))))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r7b))
  (= o10 (store (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields4)) 
  o9 o8))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r7b))
  (= (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4)) o12)))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r7b))
  (= c__split_discrs (mk___split_discrs temp___802))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r7b)) (= temp___8021 o13)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r7b)) (= temp___8022 o14)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r7b))
  (= result1 (mk___split_fields__ref1 c__split_fields4))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r7b))
  (= c__split_fields5 (mk___split_fields1 (mk___t1 temp___8021 temp___8022)))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r7b))
  (= c__split_fields6 (mk___split_fields__ref1 c__split_fields5))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r7b)) (= c__split_fields7 c__split_fields5)))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r7b)) (= c__split_fields8 c__split_fields6)))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r7b)) (= c__split_fields9 c__split_fields7)))
...
;; H
  (assert
  (=> (not (and (<= 1 i1) (<= i1 r7b)))
  (= c__split_fields8 (mk___split_fields__ref1
                      (mk___split_fields1
                      (mk___t1 c__split_fields c__split_fields1))))))
...
;; H
  (assert
  (=> (not (and (<= 1 i1) (<= i1 r7b)))
  (= c__split_fields9 (mk___split_fields1
                      (mk___t1 c__split_fields2 c__split_fields3)))))

;; H
  (assert
  (= result2 (mk_table__ref
             (mk___rep (mk___split_discrs simple_unc_arrays__add__result)
             (mk___split_fields
             (mk___t simple_unc_arrays__add__result1
             simple_unc_arrays__add__result2))))))

;; H
  (assert
  (= simple_unc_arrays__add__result3 (to_base
                                     (mk___rep1 c__split_discrs
...
;; H
  (assert
  (= simple_unc_arrays__add__result6 simple_unc_arrays__add__result4))
...
;; H
  (assert
  (= simple_unc_arrays__add__result7 simple_unc_arrays__add__result5))
...
;; H
  ...
  (= (mk___rep (mk___split_discrs result3)
     (mk___split_fields (mk___t result4 result5))) (table__content
                                                   simple_unc_arrays__add__result6)))

;; H
  (assert (same_range__function_guard
  (same_range (table__content simple_unc_arrays__add__result6) a)
  (table__content simple_unc_arrays__add__result6) a))

(assert
;; WP_parameter_def
 ;; File "simple_unc_arrays.ads", line 10, characters 0-0
  (not
  (= (same_range (table__content simple_unc_arrays__add__result6) a) true)))
(check-sat)
