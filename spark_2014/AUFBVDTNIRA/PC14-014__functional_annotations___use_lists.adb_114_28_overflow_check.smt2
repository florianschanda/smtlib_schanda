...
;; H
  ...
  (= (bool_eq3 use_lists__double_size_2__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
...
;; H
  ...
  (=> (and (<= 1 i) (<= i n2))
  (and
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (* 2 i)) 
  (get
  (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2))
     (- (* 2 i) 1)) (get
                    (model__
                    (mk___rep l__split_discrs
                    (mk___split_fields l__split_fields))) i))))))
...
;; H
  ...
  (<= i (length
        (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (+ i n2)) 
  (get
  (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)))))
