...
;; H
  (assert
  (and (= o6 (num_of_big_int m m_first o5)) (num_of_big_int__function_guard
  o6 m m_first o5)))
...
;; H
  (assert
  (and (and (= o2 (base Tuple0)) (base__function_guard o2 Tuple0))
  (= o2 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (and (= o4 (oexpon o2 o3)) (oexpon__function_guard o4 o2 o3)))
