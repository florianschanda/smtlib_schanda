...
(declare-fun result3 () count_type)
...
;; H
  (assert
  (and (= result1 (has_key1 (positions s1) (mk___rep1 cu__split_fields6)))
  (= (= result1 true)
  (= (has_key1 (positions s1) (mk___rep1 cu__split_fields6)) true))))
...
;; H
  ...
  (=>
  (and (<= 1 i)
  (<= i (- (get1 (positions s1) (mk___rep1 cu__split_fields5)) 1)))
  (not (= (has_key (model__ s2) (get (keys s1) i)) true)))))

;; H
  (assert (= (has_key1 (positions s1) (mk___rep1 cu__split_fields5)) true))

;; H
  (assert
  (and (= o (key s1 (mk___rep1 cu__split_fields5)))
  (and (in_range6 o)
  (= o (get (keys s1) (get1 (positions s1) (mk___rep1 cu__split_fields5)))))))
...
;; H
  (assert
  (and (= o1 (has_key1 (positions s1) (mk___rep1 cu__split_fields4)))
  (= (= o1 true)
  (= (has_key1 (positions s1) (mk___rep1 cu__split_fields4)) true))))
...
;; H
  (assert (<= i (- (get1 (positions s1) (mk___rep1 cu__split_fields4)) 1)))

(assert
;; WP_parameter_def
 ;; File "use_maps.ads", line 70, characters 0-0
  (not (not (= (has_key (model__ s2) (get (keys s1) i)) true))))
(check-sat)
