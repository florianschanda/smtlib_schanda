...
;; H
  ...
  (forall ((index4 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 6) index4)
...
;; H
  (assert (<= temp___2282 index1))

;; H
  (assert (<= index1 temp___2283))
...
;; H
  ...
  (=> (< index2 temp___2280)
  (= (select n3 temp___2280) (select n1 temp___2280)))))
  (=>
...
;; H
  (assert (<= (+ (to_rep1 (first (rt source))) 6) i))
