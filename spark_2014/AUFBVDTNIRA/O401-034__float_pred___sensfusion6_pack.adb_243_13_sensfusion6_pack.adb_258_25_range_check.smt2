...
;; H
  (assert
  (and (= o106 (mul RNE2 (let ((subject q3_tmp)) q3_tmp1) recip_norm3))
  (tqtisFinite (mul RNE2 (let ((subject q3_tmp)) q3_tmp1) recip_norm3))))

;; H
  (assert
  (and
  (and (= o107 (saturate o106 (neg fliteral) fliteral))
  (saturate__function_guard o107 o106 (neg fliteral) fliteral))
  (and (tqtisFinite o107)
  (ite (lt o106 (neg fliteral)) (eq o107 (neg fliteral))
  (ite (lt fliteral o106) (eq o107 fliteral) (eq o107 o106))))))
