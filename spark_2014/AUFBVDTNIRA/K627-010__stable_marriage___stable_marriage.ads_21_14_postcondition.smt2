...
(declare-fun stable_marriage__is_permutation_1__result () Bool)

(declare-fun o () (Array Int Bool))

(declare-fun temp___440 () Int)

(declare-fun temp___438 () (Array Int Bool))

(declare-fun temp___453 () (Array Int Bool))
...
(declare-fun stable_marriage__is_permutation_1__result1 () Bool)

(declare-fun stable_marriage__is_permutation_1__result2 () Bool)

(declare-fun stable_marriage__is_permutation_1__result3 () Bool)

(declare-fun seen8 () (Array Int Bool))

(declare-fun rank7 () Int)

(declare-fun stable_marriage__is_permutation_1__result4 () Bool)

(declare-fun seen9 () (Array Int Bool))

(declare-fun rank8 () Int)

(declare-fun stable_marriage__is_permutation_1__result5 () Bool)
...
;; H
  (assert (=> (and (<= 1 rank1) (<= rank1 64)) (= temp___440 rank1)))

;; H
  (assert (=> (and (<= 1 rank1) (<= rank1 64)) (= temp___438 seen1)))
...
;; H
  (assert
  (= (= (bool_eq3 seen6 1 64 (temp___443 (of_int 1)) 1 64) true)
  (forall ((g1 Int))
  (=> (and (<= 1 g1) (<= g1 64))
  (and (= (select seen6 g1) true)
  (exists ((rank10 Int))
  (and (and (<= 1 rank10) (<= rank10 64)) (= (to_rep (select r1 rank10)) g1))))))))

;; H
  (assert
  (= stable_marriage__is_permutation_1__result1 stable_marriage__is_permutation_1__result2))

;; H
  (assert
  (= stable_marriage__is_permutation_1__result3 stable_marriage__is_permutation_1__result1))

;; H
  (assert (= temp___453 (temp___449 (of_int 1))))

;; H
  (assert (= o1 (bool_eq3 seen6 1 64 temp___453 1 64)))

;; H
  (assert (= result3 stable_marriage__is_permutation_1__result))

;; H
  (assert (= stable_marriage__is_permutation_1__result1 o1))

;; H
  (assert
  (= (mk_bool__ref stable_marriage__is_permutation_1__result4) (mk_bool__ref
                                                               stable_marriage__is_permutation_1__result2)))
...
;; H
  (assert
  (= stable_marriage__is_permutation_1__result5 stable_marriage__is_permutation_1__result3))
...
;; H
  (assert (= result4 stable_marriage__is_permutation_1__result4))

;; H
  (assert (= stable_marriage__is_permutation_1__result4 true))
