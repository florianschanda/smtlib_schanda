...
;; def_axiom
  ...
  (and
  (=> (dynamic_property 1 2147483647 temp___174 temp___175)
  (and (= (first4 temp___171) temp___174) (= (last4 temp___171) temp___175)))
  (and
  (= (select (to_array1 temp___171) (+ (to_rep a__first) 0)) (of_rep
                                                             temp___172))
  (= (select (to_array1 temp___171) (+ (to_rep a__first) 1)) (of_rep
                                                             temp___173)))))))
...
(declare-fun temp___178 () (Array Int integer))

(declare-fun temp___1781 () t1)
...
;; H
  ...
  (= (to_rep
     (first3
     (rt1 (temp___170 84 36 (to_rep a__first) (+ (to_rep a__first) 1))))) 
  (to_rep a__first)))
...
;; H
  (assert
  (= (mk___t1 temp___178 temp___1781) (temp___170 84 36 (to_rep a__first)
                                      (+ (to_rep a__first) 1))))
...
;; H
  (assert
  (= (mk (to_rep (first3 temp___1781)) (to_rep (last3 temp___1781))) 
  temp___1791))

(assert
;; WP_parameter_def
 ;; File "c330002_0.ads", line 5, characters 0-0
  (not
  (= (ite (<= (to_rep (first temp___1791)) (to_rep (last temp___1791)))
     (+ (- (to_rep (last temp___1791)) (to_rep (first temp___1791))) 1) 0) 
