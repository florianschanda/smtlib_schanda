...
;; x2__def_axiom
  (assert (= x2 (mul RNE1 x fliteral2)))
...
;; H
  (assert (= (mul RNE1 x fliteral2) x2))
...
;; H
  (assert (and (= o2 (to_float i2)) (tqtisFinite o2)))
...
;; H
  (assert (and (= o3 (mul RNE1 y1 y1)) (tqtisFinite (mul RNE1 y1 y1))))

;; H
  (assert (= o4 (mul RNE1 x2 o3)))

;; H
  (assert (and (= o5 o4) (tqtisFinite o4)))

;; H
  (assert (= o6 (sub RNE1 fliteral3 o5)))

;; H
  (assert (and (= o7 o6) (tqtisFinite o6)))

;; H
  (assert (= o8 (mul RNE1 y1 o7)))
...
;; H
  (assert (and (= o10 (mul RNE1 y2 y2)) (tqtisFinite (mul RNE1 y2 y2))))
