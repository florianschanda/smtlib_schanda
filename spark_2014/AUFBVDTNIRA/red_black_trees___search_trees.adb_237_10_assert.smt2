...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2390 j13))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (and (<= 1 j3) (<= j3 100)) (= o8 (select temp___2390 i2)))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2391 j13))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2393 j13))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2392 j13))) true)
  (= (oeq
     (rec__tree_model__path_type__a
