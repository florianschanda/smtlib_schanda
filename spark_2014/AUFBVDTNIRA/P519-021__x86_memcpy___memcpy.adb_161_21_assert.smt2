...
;; H
  ...
  (let ((subject saved_rdx)) saved_rdx1)) i
  (let ((subject saved_rdi)) saved_rdi1)
  (let ((subject saved_rdx)) saved_rdx1)))

;; H
  (assert (insaferegion64__function_guard
  (insaferegion64 i (let ((subject savestackptr)) savestackptr1)) i
  (let ((subject savestackptr)) savestackptr1)))
