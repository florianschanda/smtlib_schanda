...
;; H
  (assert
  (and (= o17 (sub RNE2 position_y target_y)) (tqtisFinite
  (sub RNE2 position_y target_y))))
...
;; H
  (assert (= o23 (sub RNE2 o22 target_y)))
