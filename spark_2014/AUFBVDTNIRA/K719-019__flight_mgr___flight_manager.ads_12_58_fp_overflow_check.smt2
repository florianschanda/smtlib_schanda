...
(declare-fun flight_manager__set_engine_speed__adjust_speed__f1 () t)
...
;; H
  (assert (=> (lt target_x position_x) (= result result____split_fields11)))
...
;; H
  (assert
  (=> (not (lt target_x position_x))
  (=> (lt position_x target_x) (= result1 result____split_fields11))))
...
;; H
  (assert
  (and (= o17 (sub RNE1 position_y target_y)) (tqtisFinite
  (sub RNE1 position_y target_y))))
...
;; H
  (assert
  (and
  (= o24 (add RNE1 position_y
         (to_rep
         (rec__flight_manager__engine_values__y_speed
         (us_split_fields1
         (engine_values__content flight_manager__set_engine_speed__result5))))))
  (tqtisFinite
  (add RNE1 position_y
  (to_rep
  (rec__flight_manager__engine_values__y_speed
...
;; H
  (assert (= o23 (sub RNE1 o22 target_y)))
