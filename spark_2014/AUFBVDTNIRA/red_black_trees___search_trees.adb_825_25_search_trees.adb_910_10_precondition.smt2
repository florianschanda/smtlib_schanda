...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select o17 (parent (mk___rep2 f_1__split_fields3) i1))))
  (position (mk___rep2 f_1__split_fields3) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select o17 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select o17 (parent (mk___rep2 f_1__split_fields3) i1))))
  (position (mk___rep2 f_1__split_fields3) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select o17 i1))))))
...
;; H
  ...
  (model____function_guard o17 (mk___rep2 f_1__split_fields3) o16))
...
;; H
  ...
  o15) (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2))
  o15))
