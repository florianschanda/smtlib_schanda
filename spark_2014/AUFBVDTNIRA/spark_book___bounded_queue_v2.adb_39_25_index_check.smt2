...
(declare-fun temp___2991 () natural)

(declare-fun temp___2992 () positive)

(declare-fun temp___2993 () positive)

(declare-fun temp___2994 () (Array Int element_type))

(declare-fun temp___2995 () t)
...
;; H
  (assert (= temp___2991 o3))

;; H
  (assert (= temp___2992 o4))

;; H
  (assert (= temp___2993 o5))

;; H
  (assert (= temp___2994 o6))

;; H
  (assert (= temp___2995 o7))
...
;; H
  (assert
  (= queue__split_fields5 (mk___split_fields temp___2991 temp___2992
                          temp___2993 (mk___t temp___2994 temp___2995))))
