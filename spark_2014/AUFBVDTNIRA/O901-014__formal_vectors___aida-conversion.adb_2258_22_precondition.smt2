...
;; H
  (assert
  (and (= temp___2791 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___2791)
  (<= temp___2791 (to_rep1 (last (rt source))))))

;; H
  (assert (= o temp___2791))
