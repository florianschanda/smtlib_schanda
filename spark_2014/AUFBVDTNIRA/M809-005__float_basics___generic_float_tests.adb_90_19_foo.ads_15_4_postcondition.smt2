...
(declare-fun foo__double_tests__inverse_reciprocal__result () t)
...
(declare-fun foo__double_tests__inverse_reciprocal__result1 () t)

(declare-fun foo__double_tests__inverse_reciprocal__result2 () t)

(declare-fun foo__double_tests__inverse_reciprocal__result3 () t)

(declare-fun foo__double_tests__inverse_reciprocal__result4 () t)

(declare-fun foo__double_tests__inverse_reciprocal__result5 () t)
...
;; WP_parameter_def
 ;; File "generic_float_tests.ads", line 2, characters 0-0
  (not (eq foo__double_tests__inverse_reciprocal__result4 a)))
(check-sat)
