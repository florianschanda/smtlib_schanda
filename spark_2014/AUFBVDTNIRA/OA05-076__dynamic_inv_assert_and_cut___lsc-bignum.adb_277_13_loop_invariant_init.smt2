...
;; H
  ...
  (num_of_big_int b b_first (- i1 a_first)) (from_word32 x)))
...
;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int c c_first (- i1 a_first)) c c_first (- i1 a_first)))
...
;; H
  ...
  (num_of_big_int c c_first (- i1 a_first)) (from_word32 y)))
...
;; H
  (assert (oadd__function_guard
  (oadd (from_word32 carry1) (omultiply (base Tuple0) (from_word32 carry2)))
  (from_word32 carry1) (omultiply (base Tuple0) (from_word32 carry2))))
