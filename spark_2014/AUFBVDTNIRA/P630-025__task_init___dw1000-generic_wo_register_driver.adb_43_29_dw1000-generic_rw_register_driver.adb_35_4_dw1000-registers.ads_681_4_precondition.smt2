...
(declare-fun user_eq5 (bits_4 bits_4) Bool)

(declare-fun dummy5 () bits_4)
...
;; range_axiom
  (assert
  (forall ((x bits_4)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
(declare-fun user_eq6 (bits_7 bits_7) Bool)

(declare-fun dummy6 () bits_7)
...
;; range_axiom
  (assert
  (forall ((x bits_7)) (! (in_range4 (to_rep4 x)) :pattern ((to_rep4 x)) )))
...
(define-fun in_range5 ((x (_ BitVec 16))) Bool (and
...
(declare-fun user_eq7 (bits_12 bits_12) Bool)

(declare-fun dummy7 () bits_12)
...
;; range_axiom
  (assert
  (forall ((x bits_12)) (! (in_range5 (to_rep5 x)) :pattern ((to_rep5 x)) )))
...
;; range_int_axiom
  (assert
  (forall ((x bits_12)) (! (in_range_int3
  (to_int7 x)) :pattern ((to_int7 x)) )))

(declare-datatypes ()
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__pmsc_ledc_type__blink_tim bits_8)(rec__dw1000__register_types__pmsc_ledc_type__blnken bits_1)(rec__dw1000__register_types__pmsc_ledc_type__blnknow bits_4)(rec__dw1000__register_types__pmsc_ledc_type__reserved_1 bits_7)(rec__dw1000__register_types__pmsc_ledc_type__reserved_2 bits_12)))))
(define-fun us_split_fields_BLINK_TIM__projection ((a us_split_fields)) bits_8 
  (rec__dw1000__register_types__pmsc_ledc_type__blink_tim a))

(define-fun us_split_fields_BLNKEN__projection ((a us_split_fields)) bits_1 
  (rec__dw1000__register_types__pmsc_ledc_type__blnken a))

(define-fun us_split_fields_BLNKNOW__projection ((a us_split_fields)) bits_4 
  (rec__dw1000__register_types__pmsc_ledc_type__blnknow a))

(define-fun us_split_fields_Reserved_118__projection ((a us_split_fields)) bits_7 
  (rec__dw1000__register_types__pmsc_ledc_type__reserved_1 a))

(define-fun us_split_fields_Reserved_218__projection ((a us_split_fields)) bits_12 
  (rec__dw1000__register_types__pmsc_ledc_type__reserved_2 a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_105__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_105__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                a))
  ...
  (b us_rep)) Bool (ite (and
                        ...
                        (= (to_rep1
                           ...
                           (us_split_fields1 a))) (to_rep1
                                                  ...
                                                  (us_split_fields1 b))))
                        (= (to_rep2
                           (rec__dw1000__register_types__pmsc_ledc_type__blnken
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__pmsc_ledc_type__blnken
                                                  (us_split_fields1 b)))))
                        (= (to_rep3
                           (rec__dw1000__register_types__pmsc_ledc_type__blnknow
                           (us_split_fields1 a))) (to_rep3
                                                  (rec__dw1000__register_types__pmsc_ledc_type__blnknow
                                                  (us_split_fields1 b)))))
                        (= (to_rep4
                           (rec__dw1000__register_types__pmsc_ledc_type__reserved_1
...
(declare-fun dw1000__register_types__pmsc_ledc_type__blink_tim__first__bit () Int)

(declare-fun dw1000__register_types__pmsc_ledc_type__blink_tim__last__bit () Int)

(declare-fun dw1000__register_types__pmsc_ledc_type__blink_tim__position () Int)

;; dw1000__register_types__pmsc_ledc_type__blink_tim__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__pmsc_ledc_type__blink_tim__first__bit))

;; dw1000__register_types__pmsc_ledc_type__blink_tim__last__bit_axiom
  (assert
  (< dw1000__register_types__pmsc_ledc_type__blink_tim__first__bit dw1000__register_types__pmsc_ledc_type__blink_tim__last__bit))

;; dw1000__register_types__pmsc_ledc_type__blink_tim__position_axiom
  (assert (<= 0 dw1000__register_types__pmsc_ledc_type__blink_tim__position))

(declare-fun dw1000__register_types__pmsc_ledc_type__blnken__first__bit () Int)

(declare-fun dw1000__register_types__pmsc_ledc_type__blnken__last__bit () Int)

(declare-fun dw1000__register_types__pmsc_ledc_type__blnken__position () Int)

;; dw1000__register_types__pmsc_ledc_type__blnken__first__bit_axiom
  (assert (<= 0 dw1000__register_types__pmsc_ledc_type__blnken__first__bit))

;; dw1000__register_types__pmsc_ledc_type__blnken__last__bit_axiom
  (assert
  (< dw1000__register_types__pmsc_ledc_type__blnken__first__bit dw1000__register_types__pmsc_ledc_type__blnken__last__bit))

;; dw1000__register_types__pmsc_ledc_type__blnken__position_axiom
  (assert (<= 0 dw1000__register_types__pmsc_ledc_type__blnken__position))

(declare-fun dw1000__register_types__pmsc_ledc_type__blnknow__first__bit () Int)

(declare-fun dw1000__register_types__pmsc_ledc_type__blnknow__last__bit () Int)

(declare-fun dw1000__register_types__pmsc_ledc_type__blnknow__position () Int)

;; dw1000__register_types__pmsc_ledc_type__blnknow__first__bit_axiom
  (assert (<= 0 dw1000__register_types__pmsc_ledc_type__blnknow__first__bit))

;; dw1000__register_types__pmsc_ledc_type__blnknow__last__bit_axiom
  (assert
  (< dw1000__register_types__pmsc_ledc_type__blnknow__first__bit dw1000__register_types__pmsc_ledc_type__blnknow__last__bit))

;; dw1000__register_types__pmsc_ledc_type__blnknow__position_axiom
  (assert (<= 0 dw1000__register_types__pmsc_ledc_type__blnknow__position))

(declare-fun dw1000__register_types__pmsc_ledc_type__reserved_1__first__bit () Int)

(declare-fun dw1000__register_types__pmsc_ledc_type__reserved_1__last__bit () Int)

(declare-fun dw1000__register_types__pmsc_ledc_type__reserved_1__position () Int)

;; dw1000__register_types__pmsc_ledc_type__reserved_1__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__pmsc_ledc_type__reserved_1__first__bit))

;; dw1000__register_types__pmsc_ledc_type__reserved_1__last__bit_axiom
  (assert
  (< dw1000__register_types__pmsc_ledc_type__reserved_1__first__bit dw1000__register_types__pmsc_ledc_type__reserved_1__last__bit))

;; dw1000__register_types__pmsc_ledc_type__reserved_1__position_axiom
  (assert
  (<= 0 dw1000__register_types__pmsc_ledc_type__reserved_1__position))

(declare-fun dw1000__register_types__pmsc_ledc_type__reserved_2__first__bit () Int)

(declare-fun dw1000__register_types__pmsc_ledc_type__reserved_2__last__bit () Int)

(declare-fun dw1000__register_types__pmsc_ledc_type__reserved_2__position () Int)

;; dw1000__register_types__pmsc_ledc_type__reserved_2__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__pmsc_ledc_type__reserved_2__first__bit))

;; dw1000__register_types__pmsc_ledc_type__reserved_2__last__bit_axiom
  (assert
  (< dw1000__register_types__pmsc_ledc_type__reserved_2__first__bit dw1000__register_types__pmsc_ledc_type__reserved_2__last__bit))

;; dw1000__register_types__pmsc_ledc_type__reserved_2__position_axiom
  (assert
  (<= 0 dw1000__register_types__pmsc_ledc_type__reserved_2__position))

(declare-fun dummy8 () us_rep)

(declare-datatypes ()
((pmsc_ledc_type__ref
 (mk_pmsc_ledc_type__ref (pmsc_ledc_type__content us_rep)))))
(define-fun pmsc_ledc_type__ref___projection ((a pmsc_ledc_type__ref)) us_rep 
  (pmsc_ledc_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_242__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_173__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_173__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_7514 us_t1)
  (temp___is_init_7511 Bool) (temp___skip_constant_7512 Bool)
  (temp___do_toplevel_7513 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7512 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_7514)
                                       (last4 temp___expr_7514))
                                       (and (= (first3 temp___expr_7514) 1)
                                       (= (last4 temp___expr_7514) 4)))))
...
(define-fun target__ref_70__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_70__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_7534 us_t2)
  (temp___is_init_7531 Bool) (temp___skip_constant_7532 Bool)
  (temp___do_toplevel_7533 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7532 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_7534)
                                       (last6 temp___expr_7534))
                                       (and (= (first5 temp___expr_7534) 1)
                                       (= (last6 temp___expr_7534) 4)))))
...
(declare-fun temp___8098 () (Array Int bits_8))

(declare-fun temp___80981 () t2)

(declare-fun temp___8099 () (Array Int bits_8))

(declare-fun temp___80991 () t1)
...
(define-fun temp___80982 () us_t2 (mk___t2 temp___8098 temp___80981))
...
;; H
  (assert
  (and
  (and (= temp___80982 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___80982 reg)) (dynamic_invariant1
  temp___80982 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80981)) (to_rep (last5 temp___80981)))
     (+ (- (to_rep (last5 temp___80981)) (to_rep (first4 temp___80981))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___8098 temp___8099))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80981)) (to_rep (last5 temp___80981))) 
  temp___80991))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___80991)) (to_rep (last3 temp___80991)))
     (+ (- (to_rep (last3 temp___80991)) (to_rep (first2 temp___80991))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___8099 temp___80991)))
