...
;; H
  ...
  (= (let ((temp___260 (remove (remove (mk___t values2 (mk 1 100)) x) y)))
     ...
     (bool_eq5 (elts temp___259) (to_rep1 (first (rt temp___259)))
...
;; H
  (assert (and (= o29 (- x 1)) (in_range5 (- x 1))))
...
;; H
  (assert
  (and (= o28 (remove (mk___t values2 (mk 1 100)) o27))
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o27 1)))
  (= (to_rep (select values2 k)) (to_rep (select (elts o28) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select values2 k)) (to_rep (select (elts o28) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o27 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o28) k))))))))))))

;; H
  (assert
  (and (= o30 (remove o28 o29))
  (and (dynamic_invariant4 o30 true false true)
  (and (= (invariant__ o30) true)
  (and (= (to_rep1 (last (rt o30))) (- (to_rep1 (last (rt o28))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o29 1)))
  (= (to_rep (select (elts o28) k)) (to_rep (select (elts o30) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o29 1) k) (<= k (to_rep1 (last (rt o28)))))
  (= (to_rep (select (elts o28) k)) (to_rep (select (elts o30) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o29 k) (<= k (- (to_rep1 (last (rt o28))) 1)))
  (= (to_rep (select (elts o28) (+ k 1))) (to_rep (select (elts o30) k))))))))))))

;; H
  (assert (and (= o26 y) (in_range5 y)))
