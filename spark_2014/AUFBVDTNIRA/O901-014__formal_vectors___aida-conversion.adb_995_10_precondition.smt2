...
;; H
  (assert
  (and (= temp___1966 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1966)
  (<= temp___1966 (to_rep1 (last (rt source))))))

;; H
  (assert (= o42 temp___1966))
...
;; H
  (assert
  (and
  (and (= o45 (convert_character_digit_to_integer o44))
  (convert_character_digit_to_integer__function_guard o45 o44))
  (and (in_range1 o45)
  (and (and (<= 0 o45) (<= o45 9))
  (ite (= (= o44 48) true) (= o45 0)
  (ite (= (= o44 49) true) (= o45 1)
  (ite (= (= o44 50) true) (= o45 2)
  (ite (= (= o44 51) true) (= o45 3)
  (ite (= (= o44 52) true) (= o45 4)
  (ite (= (= o44 53) true) (= o45 5)
  (ite (= (= o44 54) true) (= o45 6)
  (ite (= (= o44 55) true) (= o45 7)
  (ite (= (= o44 56) true) (= o45 8) (=> (= (= o44 57) true) (= o45 9)))))))))))))))
...
;; H
  (assert
  (and (= temp___1965 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1965)
  (<= temp___1965 (to_rep1 (last (rt source))))))

;; H
  (assert (= o36 temp___1965))
...
;; H
  ...
  (convert_character_digit_to_integer__function_guard o39 o38))
  (and (in_range1 o39)
  (and (and (<= 0 o39) (<= o39 9))
...
;; H
  (assert
  (and (= temp___1964 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1964)
  (<= temp___1964 (to_rep1 (last (rt source))))))

;; H
  (assert (= o33 temp___1964))
...
;; H
  (assert (is_digit__function_guard (is_digit o35) o35))
