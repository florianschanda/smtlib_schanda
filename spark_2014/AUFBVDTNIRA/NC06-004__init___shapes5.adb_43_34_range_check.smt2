...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral4) (= (tqtreal fliteral4) 0.0)))
...
(define-fun in_range4 ((x1 t)) Bool (and (tqtisFinite x1)
                                    (and (le fliteral4 x1) (le x1 fliteral5))))

(define-fun bool_eq5 ((x1 t) (y1 t)) Bool (ite (eq x1 y1) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_156 t) (temp___is_init_153 Bool)
  (temp___skip_constant_154 Bool)
  (temp___do_toplevel_155 Bool)) Bool (=>
                                      (or (= temp___is_init_153 true) (le
                                      fliteral4 fliteral5)) (in_range4
                                      temp___expr_156)))
...
(define-fun dynamic_invariant3 ((temp___expr_141 t) (temp___is_init_138 Bool)
...
(declare-fun delta_x () t)

(declare-fun delta_y () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun delta_x1 () t)
...
;; H
  (assert (=> (le fliteral4 fliteral5) (in_range4 delta_x)))

;; H
  (assert (=> (le fliteral4 fliteral5) (in_range4 delta_y)))
...
;; H
  ...
  (= o (abs1
       (sub RNE1 x
       (to_rep (rec__shapes5__circle__center_x (us_split_fields1 c))))))
  (tqtisFinite
  (abs1
  (sub RNE1 x (to_rep (rec__shapes5__circle__center_x (us_split_fields1 c))))))))
...
;; WP_parameter_def
 ;; File "shapes5.ads", line 16, characters 0-0
  (not (in_range4
  (abs1
  (sub RNE1 y (to_rep (rec__shapes5__circle__center_y (us_split_fields1 c))))))))
(check-sat)
