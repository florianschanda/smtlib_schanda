...
(define-fun dynamic_invariant2 ((temp___expr_160 t) (temp___is_init_157 Bool)
  (temp___skip_constant_158 Bool)
  (temp___do_toplevel_159 Bool)) Bool (=>
                                      (or (= temp___is_init_157 true) (le
...
;; H
  ...
  (tqtisFinite
  (abs1
  (sub RNE2 x (to_rep (rec__shapes5__circle__center_x (us_split_fields1 c))))))))
...
;; WP_parameter_def
 ;; File "shapes5.ads", line 16, characters 0-0
  (not (in_range4
  (abs1
  (sub RNE2 y (to_rep (rec__shapes5__circle__center_y (us_split_fields1 c))))))))
(check-sat)
