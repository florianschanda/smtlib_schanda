...
(declare-fun dummy1 () enum_type)

(declare-datatypes ()
((enum_type__ref (mk_enum_type__ref (enum_type__content enum_type)))))
...
(declare-fun my_package_2__variant_type__m_v__first__bit () Int)

(declare-fun my_package_2__variant_type__m_v__last__bit () Int)

(declare-fun my_package_2__variant_type__m_v__position () Int)
...
(declare-fun my_package_2__variant_type__m_c__first__bit () Int)

(declare-fun my_package_2__variant_type__m_c__last__bit () Int)

(declare-fun my_package_2__variant_type__m_c__position () Int)
...
(declare-fun my_package_2__variant_type__m_a__first__bit () Int)

(declare-fun my_package_2__variant_type__m_a__last__bit () Int)

(declare-fun my_package_2__variant_type__m_a__position () Int)
...
(declare-fun my_package_2__variant_type__m_b__first__bit () Int)

(declare-fun my_package_2__variant_type__m_b__last__bit () Int)

(declare-fun my_package_2__variant_type__m_b__position () Int)
...
(declare-datatypes ()
((variant_type__ref (mk_variant_type__ref (variant_type__content us_rep)))))
...
(declare-fun temp___146 () enum_type)

(declare-fun temp___1461 () integer)

(declare-fun temp___1462 () integer)

(declare-fun temp___1463 () integer)
...
(declare-fun v__split_fields3 () integer)
