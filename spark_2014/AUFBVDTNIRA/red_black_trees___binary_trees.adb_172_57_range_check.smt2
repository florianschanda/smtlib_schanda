...
;; H
  (assert
  (forall ((j1 Int)) (is_add__function_guard
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select r2 (to_rep
             (rec__binary_trees__cell__parent
             (us_split_fields3
             (select (rec__binary_trees__forest__c (us_split_fields5 f)) j1)))))))
  (to_rep1
  (rec__binary_trees__cell__position
  (us_split_fields3
  (select (rec__binary_trees__forest__c (us_split_fields5 f)) j1))))
...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 100))
  (=> (= (select todo3 j1) true)
  (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j1))) true)))))
...
;; H
  ...
  (not
  (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select r2 j1)))
...
;; H
  ...
  (= (to_rep
     (rec__binary_trees__cell__parent
     (us_split_fields3
     (select (rec__binary_trees__forest__c (us_split_fields5 f)) j1)))) 0))
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select r2 (to_rep
                (rec__binary_trees__cell__parent
                (us_split_fields3
                (select (rec__binary_trees__forest__c (us_split_fields5 f)) j1))))))) true))))))
...
;; H
  ...
  (= (is_add
     ...
     (us_split_fields3
     (select (rec__binary_trees__forest__c (us_split_fields5 f)) j1))))
     (rec__tree_model__path_type__a (us_split_fields1 (select r2 j1)))) true)
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select r2 j1)))) 0)))))
...
;; H
  (assert
  (ite (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j))) true) 
  (not (= j root)) true))

;; H
  (assert
  (ite (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j))) true) true false))
...
;; WP_parameter_def
 ;; File "tree_model.ads", line 49, characters 0-0
  ...
  (rec__binary_trees__cell__position
  (us_split_fields3
  (select (rec__binary_trees__forest__c (us_split_fields5 f)) j)))))))
(check-sat)
