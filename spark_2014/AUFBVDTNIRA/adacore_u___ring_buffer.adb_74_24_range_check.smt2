...
(define-fun content3 () map__ref (mk_map__ref content))
...
;; H
  (assert (=> (<= first (- 100 length1)) (= (mk_map__ref result1) content3)))
...
;; H
  (assert
  (=> (not (<= first (- 100 length1))) (= (mk_map__ref result2) content3)))
