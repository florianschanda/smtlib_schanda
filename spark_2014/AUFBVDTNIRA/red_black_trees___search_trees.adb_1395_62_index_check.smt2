...
;; H
  (assert
  (forall ((i4 Int)) (parent__function_guard
  (parent (rec__search_trees__search_tree__struct t__split_fields5) i4)
  (rec__search_trees__search_tree__struct t__split_fields5) i4)))
...
;; H
  (assert
  (forall ((i4 Int)) (position__function_guard
  (position (rec__search_trees__search_tree__struct t__split_fields5) i4)
  (rec__search_trees__search_tree__struct t__split_fields5) i4)))
...
;; H
  (assert
  (forall ((i4 Int)) (is_add__function_guard
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1328 (parent
                      ...
                      t__split_fields5) i4))))
  (position (rec__search_trees__search_tree__struct t__split_fields5) i4)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1328 i4))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1328 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= temp___1328 (model__
                 (rec__search_trees__search_tree__struct t__split_fields5) 
                 o))
  (model____function_guard temp___1328
  (rec__search_trees__search_tree__struct t__split_fields5) o))
  (and (dynamic_invariant9 temp___1328 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1328 o))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1328 o)))) 0)
  (and
  (forall ((i4 Int))
  (=> (and (<= 1 i4) (<= i4 100))
  (=> (not (= i4 o))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___1328 (parent
                              (rec__search_trees__search_tree__struct
                              t__split_fields5) i4)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1328 i4))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1328 i4))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1328 i4)))) 0))))
  (forall ((i4 Int))
  (=> (and (<= 1 i4) (<= i4 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1328 i4)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1328 j)))) true))
  (= j i4))))))))))))))
