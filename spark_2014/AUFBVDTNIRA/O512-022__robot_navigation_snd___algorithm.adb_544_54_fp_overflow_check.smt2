...
;; H
  (assert (= o4 (div1 RNE2 o3 safetydist)))
...
;; H
  (assert
  (and
  (and (= o6 (limit o5 fliteral2 fliteral)) (limit__function_guard o6 
  o5 fliteral2 fliteral))
...
;; H
  (assert
  (and (= o15 (create__2 fliteral4)) (create__2__function_guard o15
  fliteral4)))
...
;; H
  ...
  (rec__algorithm__controller__driveangle (us_split_fields11 this)) o14))
...
;; H
  (assert
  (and (= o11 (add RNE2 deltaareasum2 (mul RNE2 deltamag2 deltamag2)))
  (tqtisFinite (add RNE2 deltaareasum2 (mul RNE2 deltamag2 deltamag2)))))
...
;; H
  (assert
  (and
  (= o12 (mul RNE2 (mul RNE2 (mul RNE2 deltamag2 deltamag2) deltamag2)
         deltaangle2))
  (tqtisFinite
  (mul RNE2 (mul RNE2 (mul RNE2 deltamag2 deltamag2) deltamag2) deltaangle2))))

;; H
  (assert (= o13 (add RNE2 obstacleavoiddelta2 o12)))
