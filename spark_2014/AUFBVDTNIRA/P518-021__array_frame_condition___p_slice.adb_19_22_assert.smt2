...
(define-fun bool_eq10 ((x us_t)
  (y1 us_t)) Bool (bool_eq2 (elts x) (to_rep (first1 (rt x)))
...
(define-fun bool_eq12 ((x us_t1)
  (y1 us_t1)) Bool (bool_eq2 (elts1 x) (to_rep (first4 (rt1 x)))
...
;; mk_def
  ...
  (! (=> (in_range1 f)
     (=> (in_range1 l)
     (and (= (to_rep (first6 (mk2 f l))) f) (= (to_rep (last4 (mk2 f l))) l)))) :pattern (
  (mk2 f l)) )))
...
(define-fun bool_eq13 ((x us_t2)
  (y1 us_t2)) Bool (bool_eq2 (elts2 x) (to_rep (first6 (rt2 x)))
                   (to_rep (last4 (rt2 x))) (elts2 y1)
                   (to_rep (first6 (rt2 y1))) (to_rep (last4 (rt2 y1)))))
...
;; def_axiom
  ...
  (and (= (first5 temp___231) temp___233) (= (last3 temp___231) temp___234)))
...
(declare-fun temp___263 () (Array Int map1))

(declare-fun temp___256 () (Array Int map1))

(declare-fun temp___249 () (Array Int map1))
...
(declare-fun temp___2381 () t)

(declare-fun temp___246 () (Array Int integer))

(declare-fun temp___2461 () t)

(declare-fun o3 () (Array Int integer))

(declare-fun o4 () map1)

(declare-fun o5 () (Array Int map1))
...
;; H
  (assert (= o2 (p_slice__x__aggregate_def o1)))
...
;; H
  ...
  (=> (and (<= 1 temp___291) (<= temp___291 3))
  (ite (<= i32 temp___291) (= (select x2 temp___291) (select x1 temp___291))
  (forall ((temp___292 Int) (temp___293 Int))
  (=>
  (and (and (<= 1 temp___292) (<= temp___292 3))
  (and (<= 1 temp___293) (<= temp___293 3)))
  (forall ((temp___294 Int))
  (=> (and (<= 1 temp___294) (<= temp___294 3))
  (=> (< 2 temp___294)
  (= (select (get (select x2 temp___291) temp___292 temp___293) temp___294) (select 
  (get (select x1 temp___291) temp___292 temp___293) temp___294))))))))))
  (and (<= 1 i32) (<= i32 3))))
...
;; H
  (assert (=> (and (<= 1 i211) (<= i211 3)) (= temp___263 x2)))
...
;; H
  ...
  (=> (and (<= 1 temp___264) (<= temp___264 3))
  (ite (not (= i32 temp___264))
  (= (select x3 temp___264) (select temp___263 temp___264))
  (forall ((temp___265 Int) (temp___266 Int))
  (=>
  (and (and (<= 1 temp___265) (<= temp___265 3))
  (and (<= 1 temp___266) (<= temp___266 3)))
  (ite (<= i212 temp___265)
  (= (get (select x3 temp___264) temp___265 temp___266) (get
                                                        (select temp___263 temp___264)
                                                        temp___265
                                                        temp___266))
  (forall ((temp___267 Int))
  (=> (and (<= 1 temp___267) (<= temp___267 3))
  (=> (< 2 temp___267)
  (= (select (get (select x3 temp___264) temp___265 temp___266) temp___267) (select 
  (get (select temp___263 temp___264) temp___265 temp___266) temp___267)))))))))))
  (and (<= 1 i212) (<= i212 3)))))
...
;; H
  (assert
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3)) (= temp___256 x3))))
...
;; H
  ...
  (=> (and (<= 1 temp___257) (<= temp___257 3))
  (ite (not (= i32 temp___257))
  (= (select x4 temp___257) (select temp___256 temp___257))
  (forall ((temp___258 Int) (temp___259 Int))
  (=>
  (and (and (<= 1 temp___258) (<= temp___258 3))
  (and (<= 1 temp___259) (<= temp___259 3)))
  (ite (or (<= i223 temp___259) (not (= i212 temp___258)))
  (= (get (select x4 temp___257) temp___258 temp___259) (get
                                                        (select temp___256 temp___257)
                                                        temp___258
                                                        temp___259))
  (forall ((temp___260 Int))
  (=> (and (<= 1 temp___260) (<= temp___260 3))
  (=> (< 2 temp___260)
  (= (select (get (select x4 temp___257) temp___258 temp___259) temp___260) (select 
  (get (select temp___256 temp___257) temp___258 temp___259) temp___260)))))))))))
  (and (<= 1 i223) (<= i223 3))))))

;; H
  (assert
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3)) (= i12 result4))))
...
;; H
  ...
  (ite (not (= i32 temp___250))
  (= (select x5 temp___250) (select temp___249 temp___250))
  (forall ((temp___251 Int) (temp___252 Int))
  (=>
  (and (and (<= 1 temp___251) (<= temp___251 3))
  (and (<= 1 temp___252) (<= temp___252 3)))
  (ite (or (not (= i223 temp___252)) (not (= i212 temp___251)))
  (= (get (select x5 temp___250) temp___251 temp___252) (get
                                                        (select temp___249 temp___250)
                                                        temp___251
                                                        temp___252))
  (forall ((temp___253 Int))
  (=> (and (<= 1 temp___253) (<= temp___253 3))
  (=> (< 2 temp___253)
  (= (select (get (select x5 temp___250) temp___251 temp___252) temp___253) (select 
  (get (select temp___249 temp___250) temp___251 temp___252) temp___253)))))))))))
  (and (<= 1 i14) (<= i14 3)))))))
...
;; H
  ...
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3))
  (= (to_rep (first4 (rt1 (temp___230 1 i14 2)))) i14)))))
...
;; H
  ...
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3))
  (= (to_rep (last2 (rt1 (temp___230 1 i14 2)))) 2)))))
...
;; H
  ...
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3))
  (= (mk___t1 temp___237 temp___2371) (temp___230 1 i14 2))))))
...
;; H
  ...
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3))
  (= (ite (<= (to_rep (first4 temp___2371)) (to_rep (last2 temp___2371)))
     (+ (- (to_rep (last2 temp___2371)) (to_rep (first4 temp___2371))) 1) 0) 
  (ite (<= i14 2) (+ (- 2 i14) 1) 0))))))
...
;; H
  ...
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3))
  (= (slide temp___237 (to_rep (first4 temp___2371)) i14) temp___238)))))

;; H
  (assert
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3)) (= (mk i14 2) temp___2381)))))
...
;; H
  ...
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3))
  (= (ite (<= (to_rep (first1 temp___2381)) (to_rep (last temp___2381)))
     (+ (- (to_rep (last temp___2381)) (to_rep (first1 temp___2381))) 1) 0) 
  (ite (<= (to_rep (first1 (mk i14 2))) (to_rep (last (mk i14 2))))
  (+ (- (to_rep (last (mk i14 2))) (to_rep (first1 (mk i14 2)))) 1) 0))))))
...
;; H
  ...
  (= (select o3 temp___247) (select temp___246 temp___247))
  (= (select o3 temp___247) (select (get (select x5 i32) i212 i223) temp___247))))))))

;; H
  (assert
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3)) (= o4 (set (select x5 i32) i212 i223 o3))))))

;; H
  (assert
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3)) (= o5 (store x5 i32 o4))))))
...
;; WP_parameter_def
 ;; File "p_slice.adb", line 1, characters 0-0
  (not
  (= (to_rep (select (get (select (map__content2 x17) i33) i217 i2212) 3)) 
  (to_rep (select (get (select y i33) i217 i2212) 3)))))
(check-sat)
