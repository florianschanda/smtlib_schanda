...
;; H
  (assert (= result (mk_int__ref temp___835)))

;; H
  (assert (= temp___8351 current_idx2))
...
;; H
  (assert (= o7 (concat1 (temp___String_Literal_815 Tuple0) 1 19 o1 1 1)))

;; H
  (assert (= temp___818 (mk___t o7 (mk 1 o6))))

;; H
  (assert (not (= (length temp___818) 0)))
...
;; H
  (assert
  (=> (<= (to_rep1 (first (rt temp___818))) (to_rep1 (last (rt temp___818))))
  (= o9 (+ (- (to_rep1 (last (rt temp___818))) (to_rep1
...
;; H
  (assert (= o11 (+ (to_rep1 (first (rt temp___818))) o10)))
