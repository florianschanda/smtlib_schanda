...
;; H
  (assert
  (and (and (= o7 (remove_last b)) (remove_last__function_guard o7 b))
...
;; H
  (assert
  (and (and (= o8 (remove_last a)) (remove_last__function_guard o8 a))
...
;; WP_parameter_def
 ;; File "perm.ads", line 45, characters 0-0
  (not
  (= (bool_eq1 o3 (to_rep (first o4)) (to_rep (last o4)) o5
     (to_rep (first o6)) (to_rep (last o6))) true)))
(check-sat)
