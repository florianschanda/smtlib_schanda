...
;; H
  (assert
  (and (= o11 (- (int__content location13) 1)) (in_range2
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt b))) (int__content location13))
  (<= (int__content location13) (to_rep1 (last (rt b))))))
