...
;; H
  ...
  (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1)
  (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e1))

;; H
  (assert (occ__function_guard
  (occ
  (mk___t (elts1 init)
  (mk (to_rep (first3 (rt1 init))) (to_rep (last3 (rt1 init))))) e1)
  (mk___t (elts1 init)
  (mk (to_rep (first3 (rt1 init))) (to_rep (last3 (rt1 init))))) e1))
...
;; H
  (assert (occ__function_guard
  (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) e1)
  (mk___t values (mk (to_rep values__first) (to_rep values__last))) e1))
...
;; H
  ...
  (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) f)
  (mk___t values (mk (to_rep values__first) (to_rep values__last))) f)))
...
;; H
  ...
  (occ
  (mk___t (elts1 init)
  (mk (to_rep (first3 (rt1 init))) (to_rep (last3 (rt1 init))))) f)
  (mk___t (elts1 init)
  (mk (to_rep (first3 (rt1 init))) (to_rep (last3 (rt1 init))))) f)))
...
;; H
  (assert
  (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= temp___358 e1)))

;; H
  (assert
  (=> (and (<= (- 2147483648) e1) (<= e1 2147483647))
  (and (<= (to_rep (first3 (rt1 init))) y)
  (<= y (to_rep (last3 (rt1 init)))))))

;; H
  (assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= o y)))

;; H
  (assert
  (=> (and (<= (- 2147483648) e1) (<= e1 2147483647))
  (= o1 (select (elts1 init) o))))

;; H
  (assert
  (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= o2 (to_rep o1))))
...
;; H
  (assert
  (=> (and (<= (- 2147483648) e1) (<= e1 2147483647))
  (and (<= (to_rep (first3 (rt1 init))) x)
  (<= x (to_rep (last3 (rt1 init)))))))

;; H
  (assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= o3 x)))

;; H
  (assert
  (=> (and (<= (- 2147483648) e1) (<= e1 2147483647))
  (= o4 (select (elts1 init) o3))))

;; H
  (assert
  (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= o5 (to_rep o4))))

;; H
  (assert
  (=> (and (<= (- 2147483648) e1) (<= e1 2147483647))
  (ite (= o5 (to_rep (select interm y)))
...
;; H
  (assert
  (=> (and (<= (- 2147483648) e1) (<= e1 2147483647))
  (and (=> (<= (- 2147483648) 2147483647) (in_range1 e2))
  (and (<= (- 2147483648) e2) (<= e2 2147483647)))))

;; H
  (assert
  (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= e2 2147483647)))

;; H
  (assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= e2 e3)))

;; H
  (assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= e4 e2)))
...
;; H
  (assert (=> (and (<= (- 2147483648) e1) (<= e1 2147483647)) (= e6 e4)))

;; H
  (assert
  (=> (not (and (<= (- 2147483648) e1) (<= e1 2147483647))) (= e1 e5)))

;; H
  (assert
  (=> (not (and (<= (- 2147483648) e1) (<= e1 2147483647))) (= e6 e1)))
