...
;; H
  ...
  (=> (and (in_range3 temp___431) (= (iter_has_element o7 temp___431) true))
  (= (has_key (model__ s) (get o7 temp___431)) true))))
  (forall ((key2 Int))
  (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true))
  (and (< 0 (find o7 key2)) (= (get o7 (find o7 key2)) key2)))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o7 (get o7 i1)) i1))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length s)))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (length s)))
  (=> (= (get o7 i1) (get o7 j)) (= i1 j)))))))))
...
;; H
  ...
  (=>
  (exists ((k Int))
  (and (and (in_range2 k) (= (has_key o6 k) true)) (= k o8)))
  (= result3 true)))))
...
;; H
  ...
  (forall ((temp___431 Int))
  (=> (and (in_range3 temp___431) (= (iter_has_element o4 temp___431) true))
  (= (has_key (model__ s) (get o4 temp___431)) true))))
  (forall ((key2 Int))
  (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true))
  (and (< 0 (find o4 key2)) (= (get o4 (find o4 key2)) key2)))))
  (forall ((i1 Int))
