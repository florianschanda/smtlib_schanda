...
;; H
  ...
  (num_of_big_int a (+ i1 1) (- a_last i1)) a (+ i1 1) (- a_last i1)))

;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int b (+ (+ b_first (- i1 a_first)) 1) (- a_last i1)) b
  (+ (+ b_first (- i1 a_first)) 1) (- a_last i1)))
...
;; H
  ...
  (num_of_big_int b (+ (+ b_first (- i1 a_first)) 1) (- a_last i1)))
  (num_of_big_int a (+ i1 1) (- a_last i1))
  (num_of_big_int b (+ (+ b_first (- i1 a_first)) 1) (- a_last i1))))
