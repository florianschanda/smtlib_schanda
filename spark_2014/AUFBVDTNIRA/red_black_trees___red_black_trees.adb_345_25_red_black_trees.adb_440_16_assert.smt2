...
;; H
  (assert (and (<= 1 temp___1452) (<= temp___1452 100)))

;; H
  (assert (= o30 temp___1452))
...
;; H
  (assert (= temp___1454 (mk___rep4 o32)))

;; H
  (assert (= result13 t__split_fields9))

;; H
  (assert (= t__split_fields11 (us_split_fields9 temp___1454)))
...
;; H
  (assert (and (<= 1 temp___1456) (<= temp___1456 100)))

;; H
  (assert (= o37 temp___1456))
...
;; H
  (assert (= temp___1458 (mk___rep4 o39)))

;; H
  (assert (= result14 (mk___split_fields__ref4 t__split_fields11)))

;; H
  (assert (= t__split_fields12 (us_split_fields9 temp___1458)))
...
;; H
  (assert (parent__function_guard
  (parent (mk___rep3 search_trees__right_rotate__t__fields) o44)
  (mk___rep3 search_trees__right_rotate__t__fields) o44))
...
;; H
  (assert (position__function_guard1
  (position1 (mk___rep3 search_trees__right_rotate__t__fields) o44)
  (mk___rep3 search_trees__right_rotate__t__fields) o44))
...
;; H
  ...
  (mk___rep3
  (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields12)))
  o44 0)) (mk___rep3 search_trees__right_rotate__t__fields)
  (peek
  (mk___rep3
  (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields12)))
  o44 0)))
...
;; H
  ...
  (mk___rep3
  (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields12)))
  o44 0) 1)) (mk___rep3 search_trees__right_rotate__t__fields)
  (peek
  (mk___rep3
  (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields12)))
  (peek
...
;; H
  (assert (peek__function_guard
  (peek (mk___rep3 search_trees__right_rotate__t__fields) o44 0)
  (mk___rep3 search_trees__right_rotate__t__fields) o44 0))
...
;; H
  ...
  (mk___rep3
  (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields12)))
  o44)) (mk___rep3 search_trees__right_rotate__t__fields)
  (parent
  (mk___rep3
  (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields12)))
  o44)
...
;; H
  (assert (model____function_guard
  (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c86b)))
  (rec__red_black_trees__rbt__struct (us_split_fields9 c86b))))
...
;; H
  (assert (nb_blacks__function_guard (nb_blacks c86b) c86b))

;; H
  (assert (nb_blacks__function_guard (nb_blacks c87b) c87b))
...
;; H
  ...
  (eq (select (nb_blacks c87b) i) (select (nb_blacks c86b) i))
  (select (nb_blacks c87b) i) (select (nb_blacks c86b) i))))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
             (rec__red_black_trees__rbt__struct (us_split_fields9 c86b))) i))) true)
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c86b) i)))) n11))
  (not (= i y1))) (not (= i c88b)))
  (= (eq (select (nb_blacks c87b) i) (select (nb_blacks c86b) i)) true)))))
...
;; H
  ...
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c86b) c88b)))) n11)
  (and
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select (nb_blacks c87b) c88b))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select (nb_blacks c87b) c88b)))) (to_rep
                                                          (rec__red_black_trees__black_count__count
                                                          (us_split_fields11
                                                          (select (nb_blacks
                                                                  c86b) 
...
;; H
  ...
  (and
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select (nb_blacks c87b) y1))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select (nb_blacks c87b) y1)))) (to_rep
                                                        (rec__red_black_trees__black_count__count
                                                        (us_split_fields11
                                                        (select (nb_blacks
                                                                c86b) 
...
;; H
  (assert
  (and (=> (<= 1 100) (in_range2 n11)) (and (<= 1 n11) (<= n11 100))))
