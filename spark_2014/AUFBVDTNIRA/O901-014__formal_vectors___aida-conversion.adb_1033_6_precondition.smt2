...
(define-fun tnumber_array_typeD1__ref_17__projection ((a tnumber_array_typeD1__ref)) integer 
...
(define-fun number_array_type__ref_17__projection ((a number_array_type__ref)) us_t1 
...
(define-fun tnumber_array_typeB__ref_17__projection ((a tnumber_array_typeB__ref)) us_t3 
...
;; def_axiom
  (assert
  (forall ((temp___1974 Int) (temp___1975 Int) (temp___1976 Int))
  (let ((temp___1973 (aida__conversion__calculate_positive_target_length_3__n__aggregate_def
                     temp___1974 temp___1975 temp___1976)))
  (and
  (=> (dynamic_property6 (first1 source) (+ (first1 source) 2) temp___1975
  temp___1976)
  (and (= (first7 temp___1973) temp___1975)
  (= (last7 temp___1973) temp___1976)))
  (forall ((temp___1977 Int))
  (= (select (to_array2 temp___1973) temp___1977) (of_rep1 temp___1974)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_528 us_t1)
  ...
  (temp___do_toplevel_527 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 2)
                                      (first4 temp___expr_528)
                                      (last4 temp___expr_528))
                                      (and
                                      (= (first4 temp___expr_528) (first1
                                                                  source))
                                      (= (last4 temp___expr_528) (+ (first1
                                                                    source) 2))))))
...
(declare-fun temp___1979 () (Array Int integer))

(declare-fun temp___19791 () t2)

(declare-fun aida__conversion__calculate_positive_target_length_3__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_positive_target_length_3__n__assume1 () t1)

(declare-fun temp___1988 () Int)

(declare-fun temp___1983 () (Array Int integer))

(declare-fun temp___1981 () Int)
...
;; H
  (assert
  (= (mk___t2 temp___1979 temp___19791) (aida__conversion__calculate_positive_target_length_3__n__aggregate_def
                                        0 (to_rep1 (first (rt source)))
                                        (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___19791)) (to_rep1 (last6 temp___19791)))
     (+ (- (to_rep1 (last6 temp___19791)) (to_rep1 (first6 temp___19791))) 1)
...
;; H
  (assert
  (= (slide1 temp___1979 (to_rep1 (first6 temp___19791))
...
;; H
  (assert
  (and (= temp___1988 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1988))
  (= temp___1983 n1)))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 n__first) temp___1984)
  (<= temp___1984 (to_rep1 n__last)))
  (=> (< index2 temp___1984)
  (= (select n3 temp___1984) (select temp___1983 temp___1984))))))
...
;; H
  (assert
  (and (= temp___1989 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1989)
  (<= temp___1989 (to_rep1 n__last))))

;; H
  (assert (= o9 temp___1989))
...
;; H
  (assert
  (and (= temp___1990 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1990)
  (<= temp___1990 (to_rep1 n__last))))

;; H
  (assert (= o12 temp___1990))
...
;; H
  (assert
  (and (= temp___1991 (+ (to_rep1 (first (rt source))) 0)) (in_range1
  (+ (to_rep1 (first (rt source))) 0))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1991)
  (<= temp___1991 (to_rep1 n__last))))

;; H
  (assert (= o19 temp___1991))
...
;; H
  (assert
  (and (= temp___1994 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1994)
  (<= temp___1994 (to_rep1 (last (rt source))))))

;; H
  (assert (= o35 temp___1994))
...
;; H
  ...
  (convert_character_digit_to_integer__function_guard o38 o37))
  (and (in_range1 o38)
  (and (and (<= 0 o38) (<= o38 9))
...
;; H
  (assert
  (and (= temp___1993 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1993)
  (<= temp___1993 (to_rep1 (last (rt source))))))

;; H
  (assert (= o29 temp___1993))
...
;; H
  ...
  (convert_character_digit_to_integer__function_guard o32 o31))
  (and (in_range1 o32)
  (and (and (<= 0 o32) (<= o32 9))
...
;; H
  (assert
  (and (= temp___1992 (+ (to_rep1 (first (rt source))) 0)) (in_range1
  (+ (to_rep1 (first (rt source))) 0))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1992)
  (<= temp___1992 (to_rep1 (last (rt source))))))

;; H
  (assert (= o26 temp___1992))
...
;; H
  (assert (is_digit__function_guard (is_digit o28) o28))

(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 997, characters 0-0
  (not (= (is_digit o28) true)))
(check-sat)
