...
(declare-fun temp___1045 () (Array Int character))

(declare-fun temp___10451 () t)
...
;; H
  (assert
  (=> (= (length (mk___t temp___1043 temp___10431)) 0)
  (= (temp___String_Literal_1042 Tuple0) temp___1045)))

;; H
  (assert
  (=> (= (length (mk___t temp___1043 temp___10431)) 0)
  (= (mk 1 12) temp___10451)))

;; H
  (assert
  (=> (not (= (length (mk___t temp___1043 temp___10431)) 0))
  (=> (<= 1 12) (= o7 (+ (- 12 1) 1)))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1043 temp___10431)) 0))
  (= o10 (+ (to_rep1 (first temp___10431)) o9))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1043 temp___10431)) 0))
  (= (concat1 temp___1043 (to_rep1 (first temp___10431))
     (to_rep1 (last temp___10431)) (temp___String_Literal_1042 Tuple0) 1 12) 
  temp___1045)))

;; H
  (assert
  (=> (not (= (length (mk___t temp___1043 temp___10431)) 0))
  (= (mk (to_rep1 (first temp___10431)) o12) temp___10451)))

;; H
  (assert (not (= (length (mk___t temp___1045 temp___10451)) 0)))
...
;; H
  (assert
  (=> (<= (to_rep1 (first temp___10451)) (to_rep1 (last temp___10451)))
  (= o14 (+ (- (to_rep1 (last temp___10451)) (to_rep1 (first temp___10451))) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 (first temp___10451)) (to_rep1 (last temp___10451))))
  (= o14 0)))
...
;; H
  (assert (= o16 (+ (to_rep1 (first temp___10451)) o15)))
