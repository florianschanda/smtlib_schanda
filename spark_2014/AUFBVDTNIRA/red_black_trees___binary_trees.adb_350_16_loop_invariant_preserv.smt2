...
(declare-fun temp___16121 () (Array Int us_rep1))

(declare-fun o23 () us_rep1)

(declare-fun o24 () us_split_fields)

(declare-fun temp___16131 () (Array Int us_rep1))
...
(declare-fun temp___16141 () (Array Int us_rep1))
...
(declare-fun temp___16171 () (Array Int us_rep1))
...
(declare-fun temp___16201 () (Array Int us_rep1))
...
(declare-fun temp___16211 () (Array Int us_rep1))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1613 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1612 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1621 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1620 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1617 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1614 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___16131 (parent f1 i)))) (position f1 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___16131 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___16131 (parent f1 i)))) (position f1 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___16131 i))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___16121 (parent f1 i)))) (position f1 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___16121 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___16121 (parent f1 i)))) (position f1 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___16121 i))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___16211 (parent f2 i)))) (position f2 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___16211 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___16211 (parent f2 i)))) (position f2 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___16211 i))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___16201 (parent f1 i)))) (position f1 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___16201 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___16201 (parent f1 i)))) (position f1 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___16201 i))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___16171 (parent f2 i)))) (position f2 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___16171 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___16171 (parent f2 i)))) (position f2 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___16171 i))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___16141 (parent f1 i)))) (position f1 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___16141 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___16141 (parent f1 i)))) (position f1 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___16141 i))))))
...
;; H
  (assert
  (and
  (and (= temp___16131 (model__ f1 root)) (model____function_guard
  temp___16131 f1 root))
  (and (dynamic_invariant2 temp___16131 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16131 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16131 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and (not (= (parent f1 i) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___16131 (parent f1 i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16131 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16131 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16131 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16131 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16131 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16131 j4)))) true))
  (= j4 i))))))))))))))

;; H
  (assert (= o25 (select temp___16131 j3)))
...
;; H
  (assert
  (and
  (and (= temp___16121 (model__ f1 root)) (model____function_guard
  temp___16121 f1 root))
  (and (dynamic_invariant2 temp___16121 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16121 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16121 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and (not (= (parent f1 i) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___16121 (parent f1 i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16121 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16121 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16121 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16121 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16121 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16121 j4)))) true))
  (= j4 i))))))))))))))

;; H
  (assert (= o23 (select temp___16121 j3)))
...
;; H
  (assert (=> (= result4 true) (type_invariant f2)))

;; H
  (assert
  (=> (= result4 true)
  (and
  (and (= temp___16211 (model__ f2 root)) (model____function_guard
  temp___16211 f2 root))
  (and (dynamic_invariant2 temp___16211 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16211 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16211 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and (not (= (parent f2 i) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___16211 (parent f2 i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16211 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16211 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16211 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16211 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16211 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16211 j4)))) true))
  (= j4 i)))))))))))))))

;; H
  (assert (=> (= result4 true) (= o42 (select temp___16211 j3))))
...
;; H
  (assert (=> (= result4 true) (type_invariant f1)))

;; H
  (assert
  (=> (= result4 true)
  (and
  (and (= temp___16201 (model__ f1 root)) (model____function_guard
  temp___16201 f1 root))
  (and (dynamic_invariant2 temp___16201 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16201 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16201 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and (not (= (parent f1 i) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___16201 (parent f1 i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16201 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16201 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16201 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16201 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16201 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16201 j4)))) true))
  (= j4 i)))))))))))))))

;; H
  (assert (=> (= result4 true) (= o39 (select temp___16201 j3))))
...
;; H
  ...
  (=> (= result4 true)
  (and
  (and (= temp___16171 (model__ f2 root)) (model____function_guard
  temp___16171 f2 root))
  (and (dynamic_invariant2 temp___16171 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16171 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16171 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and (not (= (parent f2 i) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___16171 (parent f2 i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16171 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16171 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16171 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16171 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16171 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16171 j4)))) true))
  (= j4 i)))))))))))))))
...
;; H
  (assert (=> (= result4 true) (= o36 (select temp___16171 o35))))
...
;; H
  ...
  (=> (= result4 true)
  (and
  (and (= temp___16141 (model__ f1 root)) (model____function_guard
  temp___16141 f1 root))
  (and (dynamic_invariant2 temp___16141 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16141 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16141 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and (not (= (parent f1 i) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___16141 (parent f1 i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16141 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16141 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16141 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___16141 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16141 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___16141 j4)))) true))
  (= j4 i)))))))))))))))
...
;; H
  (assert (=> (= result4 true) (= o32 (select temp___16141 o31))))
