...
(define-fun l2__split_fields2 () us_split_fields (mk___split_fields
                                                 l2__split_fields1))
...
;; H
  (assert
  (and (= result1 (has_key (positions l1) (mk___rep1 cu__split_fields4)))
  (= (= result1 true)
...
;; H
  ...
  (get (model__ (mk___rep l2__split_discrs l2__split_fields2)) n))
  (get (model__ l1) n)
  (get (model__ (mk___rep l2__split_discrs l2__split_fields2)) n))))
...
;; H
  ...
  (=>
  (and (<= 1 n)
  (<= n (length (mk___rep l2__split_discrs l2__split_fields2))))
  (= (is_incr (get (model__ l1) n)
     (get (model__ (mk___rep l2__split_discrs l2__split_fields2)) n)) true))))

;; H
  (assert
  (= (get1 (positions l1) (mk___rep1 cu__split_fields3)) (+ (length
                                                            (mk___rep
                                                            l2__split_discrs
                                                            l2__split_fields2)) 1)))

;; H
  (assert (= (has_key (positions l1) (mk___rep1 cu__split_fields3)) true))

;; H
  (assert
  (and (= o (element l1 (mk___rep1 cu__split_fields3)))
  (and (in_range7 o)
  (= o (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields3)))))))
...
;; H
  (assert
  (and (= o1 (element l1 (mk___rep1 cu__split_fields3)))
  (and (in_range7 o1)
  (= o1 (get (model__ l1)
        (get1 (positions l1) (mk___rep1 cu__split_fields3)))))))
