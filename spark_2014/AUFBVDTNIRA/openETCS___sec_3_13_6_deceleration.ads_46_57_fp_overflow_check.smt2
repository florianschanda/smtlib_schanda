...
;; H
  (assert
  (and
  (and (= o2 (a_brake_emergency v d)) (a_brake_emergency__function_guard 
  o2 v d))
  (and (in_range1 o2) (eq o2
  (get_value a_brake_emergency_model (to_int1 RNA2 v))))))
...
;; H
  (assert
  (and (and (= o (kwet_rst v)) (kwet_rst__function_guard o v))
  (and (tqtisFinite o) (eq o (get_value kwet_rst_model (to_int1 RNA2 v))))))

;; H
  (assert (= o1 (sub RNE2 fliteral o)))
