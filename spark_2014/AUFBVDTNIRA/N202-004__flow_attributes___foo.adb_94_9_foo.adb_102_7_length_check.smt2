...
;; def_axiom
  ...
  (and (= (first4 temp___285) temp___287) (= (last4 temp___285) temp___288)))
...
;; H
  (assert
  (= (to_rep1
     (first3 (rt1 (temp___284 32 (to_rep1 a__first) (to_rep1 a__last))))) 
  (to_rep1 a__first)))

;; H
  (assert
  (= (to_rep1
     (last3 (rt1 (temp___284 32 (to_rep1 a__first) (to_rep1 a__last))))) 
  (to_rep1 a__last)))
...
;; H
  (assert
  (= (mk (to_rep1 (first3 temp___2911)) (to_rep1 (last3 temp___2911))) 
  temp___2921))
