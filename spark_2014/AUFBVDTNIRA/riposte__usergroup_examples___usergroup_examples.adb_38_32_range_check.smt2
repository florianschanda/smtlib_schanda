...
(declare-fun ar () (Array Int us_rep))
...
(declare-fun ar1 () (Array Int us_rep))
...
;; H
  (assert
  (= (rec__usergroup_examples__rec_t__b
     (us_split_fields1 (select ar current))) o2))

;; H
  (assert
  (= (rec__usergroup_examples__rec_t__c
     (us_split_fields1 (select ar current))) o3))
...
(assert
;; WP_parameter_def
 ;; File "usergroup_examples.adb", line 28, characters 0-0
