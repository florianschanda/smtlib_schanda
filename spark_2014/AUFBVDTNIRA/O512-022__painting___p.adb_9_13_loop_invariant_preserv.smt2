...
;; H
  ...
  (exists ((c4 Int))
  (and (and (<= 0 c4) (<= c4 2))
  (= (bool_eq1 (select p__split_fields c4) d) true))))
...
;; H
  (assert
  (and (= (bool_eq3 p__split_fields2 0 2 p__split_fields 0 2) true)
  (forall ((j Int))
  (=> (and (<= 0 j) (<= j (- c2 1)))
  (=> (= (bool_eq1 (select p__split_fields2 j) d) true)
  (= (bool_eq1 (select p__split_fields3 j) d) true))))))
...
;; H
  (assert
  (=> (= (bool_eq1 (select p__split_fields2 c2) d) true)
  (= result1 p__split_fields2)))

;; H
  (assert
  (=> (= (bool_eq1 (select p__split_fields2 c2) d) true)
  (= result2 p__split_fields3)))

;; H
  (assert
  (=> (= (bool_eq1 (select p__split_fields2 c2) d) true)
  (= p__split_fields2 p__split_fields4)))

;; H
  (assert
  (=> (= (bool_eq1 (select p__split_fields2 c2) d) true)
  (= (store p__split_fields3 c2 d) p__split_fields5)))

;; H
  (assert
  (=> (not (= (bool_eq1 (select p__split_fields2 c2) d) true))
  (= (mk___split_fields1 p__split_fields4 p__split_fields5) (mk___split_fields1
                                                            p__split_fields2
                                                            p__split_fields3))))
...
;; WP_parameter_def
 ;; File "p.ads", line 31, characters 0-0
  (not (= (bool_eq3 p__split_fields4 0 2 p__split_fields 0 2) true)))
(check-sat)
