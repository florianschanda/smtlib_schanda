...
(define-fun bool_eq7 ((a (Array Int scalar_with_default)) (a__first Int)
...
(define-fun bool_eq9 ((a (Array Int tscalar_with_defaultB)) (a__first Int)
...
(define-fun bool_eq11 ((x us_t)
  (y us_t)) Bool (bool_eq10 (elts x) (to_rep1 (first2 (rt x)))
...
(declare-fun all_0 () (Array Int scalar_with_default))

(declare-fun all_1 () (Array Int natural))

(declare-fun all_2 () (Array Int tscalar_with_defaultB))
