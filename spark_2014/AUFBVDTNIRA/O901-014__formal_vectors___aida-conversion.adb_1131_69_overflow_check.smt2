...
;; H
  (assert
  (and (= temp___2068 (+ (to_rep1 (first (rt source))) 0)) (in_range1
  (+ (to_rep1 (first (rt source))) 0))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___2068)
  (<= temp___2068 (to_rep1 (last (rt source))))))

;; H
  (assert (= o temp___2068))
