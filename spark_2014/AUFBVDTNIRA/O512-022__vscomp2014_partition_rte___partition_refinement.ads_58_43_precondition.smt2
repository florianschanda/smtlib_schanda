...
(declare-fun o4 () index_count)

(declare-fun o5 () index)

(declare-fun o6 () index)

(declare-fun o7 () index_count)
...
(define-fun o20 () us_rep9 (mk___rep4 (mk___split_fields4 o2 o3 o4)))
...
;; H
  (assert (and (= o19 o17) (in_range2 o17)))

;; H
  (assert (= result (ite (<= o19 o18) true false)))
...
;; H
  (assert (= result1 (ite (<= o15 5000) true false)))
...
;; H
  (assert
  (and (= o11 (has_key (positions x) c3))
  (= (= o11 true) (= (has_key (positions x) c3) true))))

;; H
  (assert (= o12 true))

;; H
  (assert (= result6 (ite (= o12 true) o11 false)))
