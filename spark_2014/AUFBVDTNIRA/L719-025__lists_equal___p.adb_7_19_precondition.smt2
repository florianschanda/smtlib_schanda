...
(declare-fun user_eq5 (positive_count_type positive_count_type) Bool)

(declare-fun dummy5 () positive_count_type)
...
;; p_positions_shifted__post_axiom
  ...
  (! (=>
     (and (dynamic_invariant1 cut true true true) (dynamic_invariant count
     true true true))
...
(declare-fun temp___471 () count_type)
...
;; H
  (assert (= temp___471 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___471)) no_element))

;; H
  (assert
  (and
  (< (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 
  (to_rep (rec__p__my_lists__list__capacity l__split_discrs)))
  (or
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (mk___rep1 (mk___split_fields1 cu__split_fields))) true)
  (= (bool_eq2 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true))))
...
;; H
  ...
  (= (length (mk___rep l__split_discrs l__split_fields2)) (+ (length
                                                             ...
                                                             (mk___split_fields
                                                             l__split_fields))) 1))
  (ite (= (bool_eq2 (mk___rep1 (mk___split_fields1 cu__split_fields))
          no_element) true)
  (and
  (and
  (and
  ...
  (= (range_equal
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (model__ (mk___rep l__split_discrs l__split_fields2)) 1
     (- (get1
        (positions
        (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
  ...
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2))
     ...
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (mk___rep1 (mk___split_fields1 cu__split_fields)))) 1))
  (= (p_positions_shifted
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (positions (mk___rep l__split_discrs l__split_fields2))
