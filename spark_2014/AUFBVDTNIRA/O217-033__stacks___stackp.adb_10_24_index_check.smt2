...
(declare-fun user_eq8 (t19s t19s) Bool)
...
;; def_axiom
  ...
  (= (select (temp___239 temp___241) 1) (of_rep1 temp___241))))
...
;; stackp__stack__compat_axiom
  (assert
  (forall ((s us_rep))
  (! (=> (get_model__2__function_guard1 (get_model__21 us_tag1 s) us_tag1 s)
...
;; get_model__2__def_axiom
  ...
  (! (=> (get_model__2__function_guard (get_model__2 s) s)
     (= (get_model__2 s) (let ((temp___346 (let ((temp___344 (to_rep
                                                             (rec__stackp__stack_root__length
                                                             (us_split_fields1
                                                             s)))))
                                           (let ((temp___343 1))
...
(define-fun bool_eq17 ((x us_t4)
  (y us_t4)) Bool (bool_eq3 (elts4 x) (to_rep2 (first9 (rt4 x)))
                  ...
                  (to_rep2 (first9 (rt4 y))) (to_rep2 (last12 (rt4 y)))))
...
;; mk_def
  ...
  (! (=> (in_range3 f)
     (=> (in_range3 l)
     (and (= (to_rep2 (first12 (mk5 f l))) f)
     (= (to_rep2 (last15 (mk5 f l))) l)))) :pattern ((mk5 f l)) )))
...
(define-fun first13 ((a us_t5)) Int (to_rep2 (first12 (rt5 a))))

(define-fun last16 ((a us_t5)) Int (to_rep2 (last15 (rt5 a))))
...
(define-fun bool_eq19 ((x us_t5)
  (y us_t5)) Bool (bool_eq3 (elts5 x) (to_rep2 (first12 (rt5 x)))
                  (to_rep2 (last15 (rt5 x))) (elts5 y)
                  (to_rep2 (first12 (rt5 y))) (to_rep2 (last15 (rt5 y)))))
