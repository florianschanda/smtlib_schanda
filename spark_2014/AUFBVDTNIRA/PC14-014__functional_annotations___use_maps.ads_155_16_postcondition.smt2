...
(define-fun temp___1072 () us_rep2 (keys s))

(declare-fun temp___1071 () Int)

;; H
  (assert (in_range2 temp___1071))

;; H
  (assert (= (iter_has_element temp___1072 temp___1071) true))

(define-fun k () Int (get temp___1072 temp___1071))
