...
;; H
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields10))
     (mk___rep1 cu__split_fields10)) i2)))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r27b)) (= cu__split_fields5 cu__split_fields3)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r27b)) (= l__split_fields5 l__split_fields3)))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r27b)) (= cu__split_fields6 cu__split_fields4)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r27b)) (= l__split_fields6 l__split_fields4)))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r27b)) (= cu__split_fields7 cu__split_fields5)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r27b)) (= l__split_fields7 l__split_fields5)))
