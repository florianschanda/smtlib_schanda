...
(define-fun dynamic_invariant ((temp___expr_571 Int)
...
(define-fun dynamic_invariant1 ((temp___expr_585 Int)
...
;; range_axiom
  (assert
  (forall ((x natural)) (! (in_range5 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
(define-fun default_initial_assumption ((temp___expr_592 us_rep)
  (temp___skip_top_level_593 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_593 true))
                                         (= (length temp___expr_592) 0)))
