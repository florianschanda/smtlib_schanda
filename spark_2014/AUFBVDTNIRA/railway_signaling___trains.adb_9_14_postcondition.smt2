...
(declare-fun train4 () Int)

(declare-fun train5 () Int)

(declare-fun train6 () Int)

(declare-fun train7 () Int)

(declare-fun train8 () Int)

(declare-fun train9 () Int)
...
;; H
  (assert
  (forall ((id Int)) (get_previous_track__function_guard
  (get_previous_track (select trains train3) id) (select trains train3) id)))

;; H
  (assert
  (forall ((id Int)) (get_other_previous_track__function_guard
  (get_other_previous_track (select trains train3) id) (select trains 
  train3) id)))
...
;; H
  ...
  (and
  (and
  (and (= train14 (mk_int__ref train4)) (= track_signals7 track_signals8))
  (and (= train11 train5) (= track_signals4 track_signals1)))
  (and (= temp___478 1)
  (and (= temp___479 r7b)
  (and (and (= result5 train16) (= train1 temp___478))
  (and (and (<= temp___478 train1) (<= train1 temp___479))
  (and (= temp___475 train1)
  (or
  (and (and (= train1 train4) (= train5 train1))
  (and
  (and
  ...
  (= track (get_other_previous_track (select trains train1) id)))))))
  (not (= result1 true)))
  (and (and (= train3 train4) (= train5 train3))
  (and
  (forall ((t Int))
  (=> (and (<= 1 t) (<= t train2))
  ...
  (and (not (= train2 temp___479))
  (and (and (= train2 result2) (= train3 (+ train2 1)))
  (and
  (and
  (and (= result3 (is_previous_track (select trains train3) track))
  (is_previous_track__function_guard result3 (select trains train3) track))
  (= (= result3 true)
  (exists ((id Int))
  (and (and (<= 1 id) (<= id 3))
  ...
  (= result3 true)))))))))))))))
  (and
  (and (and (= result5 train16) (= train1 1))
  (ite (and (<= 1 train1) (<= train1 r7b))
  (and
  (and
  (and (= temp___475 train1)
  (and
  ...
  (and
  (and (=> (<= 1 r7b) (dynamic_property 1 r7b train2))
  (and (<= 1 train2) (<= train2 r7b))) (= train2 r7b)))))
  (and (= train2 train6) (= train7 train2)))
  (and (= train15 (mk_int__ref train6)) (= train9 train7)))
  (and (= train1 train8) (= train9 train1))))
  (and
  (and (and (= train14 train15) (= track_signals2 track_signals3))
  (and (= train11 train9) (= track_signals4 track_signals2)))
  (and (and (= (to_rep2 o) 0) (= o1 (store track_signals track o)))
  (and (= (mk_map__ref1 result4) track_signals8) (= track_signals2 o1)))))))
...
;; H
  ...
  (= (is_previous_track (select trains t) track) true))))

(assert
;; WP_parameter_def
 ;; File "trains.ads", line 155, characters 0-0
  (not (= (to_rep2 (select track_signals5 track)) 1)))
(check-sat)
