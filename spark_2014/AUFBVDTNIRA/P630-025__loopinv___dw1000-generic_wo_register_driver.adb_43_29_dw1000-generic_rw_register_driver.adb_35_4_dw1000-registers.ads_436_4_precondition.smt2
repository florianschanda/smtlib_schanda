...
(define-fun dynamic_invariant ((temp___expr_5233 us_t1)
  ...
  (temp___do_toplevel_5232 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_5233))
                                       (and (= (first3 temp___expr_5233) 1)
                                       (= (last4 temp___expr_5233) 4)))))
...
(define-fun dynamic_invariant1 ((temp___expr_5249 us_t2)
  ...
  (temp___do_toplevel_5248 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_5249))
                                       (and (= (first5 temp___expr_5249) 1)
                                       (= (last6 temp___expr_5249) 4)))))
...
;; H
  (assert
  (and
  (and (= temp___78502 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___78502 reg)) (dynamic_invariant1
  temp___78502 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___78501)) (to_rep (last5 temp___78501)))
     (+ (- (to_rep (last5 temp___78501)) (to_rep (first4 temp___78501))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78501)) (to_rep (last5 temp___78501))) 
  temp___78511))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___78511)) (to_rep (last3 temp___78511)))
     (+ (- (to_rep (last3 temp___78511)) (to_rep (first2 temp___78511))) 1)
