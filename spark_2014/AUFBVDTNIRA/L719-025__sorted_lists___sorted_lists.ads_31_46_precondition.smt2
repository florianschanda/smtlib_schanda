...
(define-fun dynamic_invariant3 ((temp___expr_227 Int)
...
(define-fun default_initial_assumption1 ((temp___expr_234 us_rep2)
  (temp___skip_top_level_235 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_235 true))
                                         (= (length1 temp___expr_234) 0)))
...
(define-fun default_initial_assumption3 ((temp___expr_241 us_rep1)
...
(define-fun dynamic_invariant5 ((temp___expr_190 Int)
...
;; temp___result_132_def
  (assert
  (forall ((container us_rep2) (i Int) (j Int)) (my_lt__function_guard
...
;; p_positions_shifted__post_axiom
  ...
  (! (=>
     (and (dynamic_invariant6 cut true true true) (dynamic_invariant1 count
     true true true))
...
(declare-fun sorted_lists__my_insert__current__assume () count_type)

(declare-fun o () Int)

(declare-fun temp___475 () count_type)
...
(declare-fun current__split_fields3 () count_type)

(declare-fun result3 () Bool)

(declare-fun result4 () Bool)

(declare-fun current__split_fields4 () us_split_fields__ref1)

(declare-fun current__split_fields5 () us_split_fields2)

(declare-fun current__split_fields6 () us_split_fields__ref1)

(declare-fun current__split_fields7 () us_split_fields2)

(declare-fun container__split_fields1 () us_split_fields)

(declare-fun position__split_fields () us_split_fields2)

(declare-fun container__split_fields2 () us_split_fields__ref)

(declare-fun position__split_fields1 () us_split_fields__ref1)

(declare-fun current__split_fields8 () us_split_fields__ref1)

(declare-fun container__split_fields3 () us_split_fields)

(declare-fun position__split_fields2 () us_split_fields2)

(declare-fun current__split_fields9 () us_split_fields2)
...
(define-fun current__split_fields10 () us_split_fields2 (mk___split_fields1
                                                        current__split_fields3))

(define-fun current__split_fields11 () us_split_fields2 (mk___split_fields1
                                                        current__split_fields2))

(define-fun current__split_fields12 () us_split_fields2 (mk___split_fields1
                                                        current__split_fields1))

(define-fun sorted_lists__my_insert__current__assume1 () us_rep1 (mk___rep1
                                                                 (mk___split_fields1
                                                                 sorted_lists__my_insert__current__assume)))
...
;; H
  ...
  (< (length
     ...
     (mk___split_fields container__split_fields))) (to_rep
                                                   (rec__sorted_lists__my_lists__list__capacity
...
;; H
  (assert
  (and
  (= sorted_lists__my_insert__current__assume1 (first
                                               (mk___rep
                                               container__split_discrs
                                               (mk___split_fields
  ...
  (ite (= (= (length
             (mk___rep container__split_discrs
             (mk___split_fields container__split_fields))) 0) true)
  (= (bool_eq4 sorted_lists__my_insert__current__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))
     sorted_lists__my_insert__current__assume1) true)
  (= (get1
     (positions
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))
     sorted_lists__my_insert__current__assume1) 1)))))
...
;; H
  (assert
  (= sorted_lists__my_insert__current__assume current__split_fields1))
...
;; H
  ...
  (= result2 (has_key
             ...
             (mk___rep container__split_discrs
             (mk___split_fields container__split_fields)))
             (mk___rep1 current__split_fields12)))
  (= (= result2 true)
  (= (has_key
     (positions
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))
     (mk___rep1 current__split_fields12)) true))))
...
;; H
  (assert (=> (= result1 true) (= temp___475 current__split_fields1)))

;; H
  (assert
  (=> (= result1 true)
  (or
  (= (bool_eq4 (mk___rep1 current__split_fields11)
     (first
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))) true)
  (< (element
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields))
     (previous
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields))
     (mk___rep1 current__split_fields11))) new_item))))
...
;; H
  ...
  (= (has_key
     ...
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))
     (mk___rep1 current__split_fields11)) true)
  (< (element
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields))
     (mk___rep1 current__split_fields11)) new_item))))
...
;; H
  (assert
  (=> (= result1 true)
  (ite (= (ite (= (bool_eq4 (mk___rep1 current__split_fields11) no_element) false) (= 
          (get1
          (positions
          (mk___rep container__split_discrs
          (mk___split_fields container__split_fields)))
          (mk___rep1 current__split_fields11)) (length
                                               (mk___rep
                                               container__split_discrs
                                               (mk___split_fields
                                               container__split_fields)))) true) true)
  (= (bool_eq4 (mk___rep1 current__split_fields10) no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))
     (mk___rep1 current__split_fields10)) true)
  (= (get1
     (positions
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))
     (mk___rep1 current__split_fields10)) (+ (get1
                                             (positions
                                             (mk___rep
                                             container__split_discrs
                                             (mk___split_fields
...
;; H
  ...
  (= result4 (has_key
             ...
             (mk___rep container__split_discrs
             (mk___split_fields container__split_fields)))
             (mk___rep1 current__split_fields10)))
  (= (= result4 true)
  (= (has_key
     (positions
     (mk___rep container__split_discrs
...
;; H
  (assert
  (=> (= result1 true)
  (=> (= result4 true) (= o2 (ite (< o1 new_item) true false)))))
...
;; H
  (assert
  (=> (= result1 true)
  (= current__split_fields4 (mk___split_fields__ref1 current__split_fields10))))

;; H
  (assert
  (=> (= result1 true) (= current__split_fields5 current__split_fields10)))

;; H
  (assert
  (=> (= result1 true) (= current__split_fields6 current__split_fields4)))

;; H
  (assert
  (=> (= result1 true) (= current__split_fields7 current__split_fields5)))

;; H
  (assert
  (=> (not (= result1 true))
  (= current__split_fields6 (mk___split_fields__ref1 current__split_fields12))))

;; H
  (assert
  (=> (not (= result1 true))
  (= current__split_fields7 current__split_fields12)))
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep container__split_discrs container__split_fields1)) (+ 
  (length
  (mk___rep container__split_discrs
  (mk___split_fields container__split_fields))) 1))
  (= (has_key
     (positions (mk___rep container__split_discrs container__split_fields1))
     (mk___rep1 position__split_fields)) true))
  (ite (= (bool_eq4
          (mk___rep1 (us_split_fields__content1 current__split_fields6))
          no_element) true)
  (= (get1
     (positions (mk___rep container__split_discrs container__split_fields1))
     (mk___rep1 position__split_fields)) (length
                                         (mk___rep container__split_discrs
                                         container__split_fields1)))
  (= (get1
     (positions (mk___rep container__split_discrs container__split_fields1))
     (mk___rep1 position__split_fields)) (get1
                                         (positions
                                         (mk___rep container__split_discrs
                                         (mk___split_fields
                                         container__split_fields)))
  ...
  (= (range_equal
     ...
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))
     (model__ (mk___rep container__split_discrs container__split_fields1)) 1
     (- (get1
        (positions
        (mk___rep container__split_discrs container__split_fields1))
        (mk___rep1 position__split_fields)) 1)) true))
  (= (range_shifted
     (model__
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))
     (model__ (mk___rep container__split_discrs container__split_fields1))
     (get1
     (positions (mk___rep container__split_discrs container__split_fields1))
     (mk___rep1 position__split_fields))
     (length
     (mk___rep container__split_discrs
  ...
  (= (get
     ...
     (get1
     (positions (mk___rep container__split_discrs container__split_fields1))
     (mk___rep1 position__split_fields))) new_item))
  (= (p_positions_shifted
     (positions
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))
...
;; H
  (assert
  (= position__split_fields1 (mk___split_fields__ref1 position__split_fields)))

;; H
  (assert
  (= container__split_fields2 (mk___split_fields__ref
                              container__split_fields1)))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o11 j) true)
  (=> (= (get1 o11 i2) (get1 o11 j)) (= (bool_eq4 i2 j) true))))))))))
...
;; H
  ...
  (<= i2 (- (get1
            ...
            (mk___rep container__split_discrs
            (us_split_fields__content container__split_fields2)))
            (mk___rep1 (us_split_fields__content1 position__split_fields1))) 1)))
  (= (get
     (model__
     (mk___rep container__split_discrs
     (us_split_fields__content container__split_fields2))) i2) (get
                                                               (model__
                                                               (mk___rep
                                                               container__split_discrs
                                                               (mk___split_fields
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o3 j) true)
  (=> (= (get1 o3 i2) (get1 o3 j)) (= (bool_eq4 i2 j) true))))))))))
