...
(define-fun t36b__ref___projection ((a1 t36b__ref)) integer (t36b__content
                                                            a1))
...
(declare-fun simple_unc_arrays__max__result () Int)
...
(declare-fun simple_unc_arrays__max__result1 () Int)

(declare-fun res8 () Int)

(declare-fun i7 () Int)

(declare-fun simple_unc_arrays__max__result2 () Int)

(declare-fun res9 () Int)

(declare-fun i8 () Int)

(declare-fun simple_unc_arrays__max__result3 () Int)

(declare-fun res10 () Int)

(declare-fun i9 () Int)

(declare-fun simple_unc_arrays__max__result4 () Int)

(declare-fun res11 () Int)

(declare-fun i10 () Int)

(declare-fun simple_unc_arrays__max__result5 () Int)
...
;; H
  (assert (empty__function_guard (empty a) a))
...
;; H
  (assert
  (= simple_unc_arrays__max__result1 simple_unc_arrays__max__result2))
...
;; H
  (assert
  (= simple_unc_arrays__max__result3 simple_unc_arrays__max__result1))
...
;; H
  (assert (=> (and (<= 2 i1) (<= i1 r35b)) (= temp___890 i1)))

;; H
  (assert (=> (and (<= 2 i1) (<= i1 r35b)) (= temp___889 res1)))
...
;; H
  ...
  (=> (and (<= 2 i1) (<= i1 r35b))
  (and
  (and (=> (<= (- 2147483648) 2147483647) (in_range2 res2))
  (=> (<= 2 r35b) (dynamic_property2 2 r35b i2)))
  (and (<= 2 i2) (<= i2 r35b)))))
...
;; H
  (assert (=> (and (<= 2 i1) (<= i1 r35b)) (= o5 (to_rep1 o4))))

;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 r35b)) (= result2 (ite (< res2 o5) true false))))
...
;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 r35b)) (=> (= result2 true) (= o8 (to_rep1 o7)))))

;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 r35b)) (=> (= result2 true) (= res2 result3))))

;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 r35b)) (=> (= result2 true) (= res3 o8))))

;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 r35b)) (=> (not (= result2 true)) (= res3 res2))))
...
;; H
  (assert
  (= (mk_int__ref result4) (mk_int__ref simple_unc_arrays__max__result)))
...
;; H
  (assert
  (= (mk_int__ref simple_unc_arrays__max__result4) (mk_int__ref
                                                   simple_unc_arrays__max__result2)))
...
;; H
  (assert
  (= simple_unc_arrays__max__result5 simple_unc_arrays__max__result3))
...
;; H
  (assert (= result5 simple_unc_arrays__max__result4))
...
;; WP_parameter_def
 ;; File "simple_unc_arrays.ads", line 4, characters 0-0
  ...
  (<= (to_rep1
      ...
      j)) simple_unc_arrays__max__result4)))
(check-sat)
