...
(declare-fun temp___839 () extended_index_type)

(declare-fun temp___8391 () (Array Int us_rep))

;; H
  (assert
  (and (= (to_rep temp___839) 0) (default_initial_assumption temp___8391
  false)))
...
;; WP_parameter_def
 ;; File "binary_trees.ads", line 418, characters 0-0
  (not (type_invariant
  (mk___rep1 (mk___split_fields1 temp___839 temp___8391)))))
(check-sat)
