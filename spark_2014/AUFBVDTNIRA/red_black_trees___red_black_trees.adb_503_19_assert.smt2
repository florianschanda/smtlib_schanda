...
;; H
  (assert (= (same_nb_blacks c106b) true))

;; H
  (assert (parent__function_guard
  (parent (rec__red_black_trees__rbt__struct t__split_fields13)
  (int__content x4)) (rec__red_black_trees__rbt__struct t__split_fields13)
  (int__content x4)))
...
;; H
  ...
  (parent (rec__red_black_trees__rbt__struct t__split_fields13)
  (int__content x4))) (mk___rep4 t__split_fields13)
  (parent (rec__red_black_trees__rbt__struct t__split_fields13)
  (int__content x4))))
...
;; H
  (assert (parent__function_guard
  (parent (rec__red_black_trees__rbt__struct t__split_fields13) i)
...
;; H
  (assert
  (or (= (parent (rec__red_black_trees__rbt__struct t__split_fields13) i) 0)
  (= (to_rep3
     (select (rec__red_black_trees__rbt__color t__split_fields13) (parent
                                                                  (rec__red_black_trees__rbt__struct
                                                                  t__split_fields13)
                                                                  i))) 1)))
...
;; WP_parameter_def
 ;; File "red_black_trees.ads", line 59, characters 0-0
  (not
  (= (to_rep3
     (select (rec__red_black_trees__rbt__color t__split_fields13) i)) 0)))
(check-sat)
