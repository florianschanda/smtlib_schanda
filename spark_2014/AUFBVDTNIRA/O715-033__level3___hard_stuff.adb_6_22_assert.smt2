...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral2) (= (tqtreal fliteral2) 100000.0)))
...
;; H
  ...
  (= (= result true)
  (exists ((y Int))
  (and (and (<= 0 y) (<= y 100000)) (eq x
  (mul RNE2 (div1 RNE2 (of_int RNE2 y) fliteral2)
  (div1 RNE2 (of_int RNE2 y) fliteral2)))))))
