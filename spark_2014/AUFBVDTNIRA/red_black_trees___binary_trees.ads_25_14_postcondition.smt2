...
;; valid_root__def_axiom
  ...
  (! (=> (valid_root__function_guard (valid_root f i) f i)
     (= (= (valid_root f i) true)
     (and (<= i (to_rep (rec__binary_trees__forest__s (us_split_fields3 f))))
     (= (to_rep1
        (rec__binary_trees__cell__position
        (us_split_fields1
        (let ((temp___298 (rec__binary_trees__forest__c (us_split_fields3 f))))
...
(declare-fun binary_trees__parent__result () Int)

(declare-fun result () Int)

(declare-fun binary_trees__parent__result1 () Int)

(declare-fun binary_trees__parent__result2 () Int)

(declare-fun binary_trees__parent__result3 () Int)

(declare-fun binary_trees__parent__result4 () Int)

(declare-fun binary_trees__parent__result5 () Int)
...
;; H
  (assert
  (= (mk_int__ref result) (mk_int__ref binary_trees__parent__result)))

;; H
  (assert
  (= binary_trees__parent__result1 (to_rep
                                   (rec__binary_trees__cell__parent
                                   (us_split_fields1
                                   (select (rec__binary_trees__forest__c
...
;; H
  (assert
  (= (mk_int__ref binary_trees__parent__result4) (mk_int__ref
                                                 binary_trees__parent__result2)))
...
;; H
  (assert (valid_root__function_guard (valid_root f i) f i))
...
;; WP_parameter_def
 ;; File "tree_model.ads", line 15, characters 0-0
  (not (= binary_trees__parent__result4 0)))
(check-sat)
