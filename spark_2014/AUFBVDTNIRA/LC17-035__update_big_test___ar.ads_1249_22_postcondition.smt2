...
;; inversion_axiom
  (assert
  (forall ((x et2)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)) )))

;; range_axiom
  (assert
  (forall ((x et2)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)) )))
...
;; range_axiom
  (assert
  (forall ((x et1)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
(define-fun bool_eq3 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        ...
                        (= (to_rep (rec__ar__rec1t__g1 (us_split_fields1 a))) 
                        (to_rep (rec__ar__rec1t__g1 (us_split_fields1 b)))))
                   true false))
...
(declare-fun temp___2835 ((Array Int us_rep) Int us_rep Int
  us_rep) (Array Int us_rep))

;; def_axiom
  (assert
  (forall ((temp___2837 (Array Int us_rep)))
  (forall ((temp___2838 Int) (temp___2840 Int))
  (forall ((temp___2839 us_rep) (temp___2841 us_rep))
  (let ((temp___2836 (temp___2835 temp___2837 temp___2838 temp___2839
                     temp___2840 temp___2841)))
  (forall ((temp___2842 Int))
  (ite (= temp___2842 temp___2840)
  (= (select temp___2836 temp___2842) temp___2841)
  (ite (= temp___2842 temp___2838)
  (= (select temp___2836 temp___2842) temp___2839)
  (= (select temp___2836 temp___2842) (select temp___2837 temp___2842))))))))))
...
;; H
  (assert
  (= temp1 (to_rep (rec__ar__rec1t__g1 (us_split_fields1 (select a i))))))

;; H
  (assert
  (= (to_rep o) (to_rep (rec__ar__rec1t__g1 (us_split_fields1 (select a j))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1242, characters 0-0
  (not
  (= (bool_eq4 a3 1 10
     (temp___2835 a i
     (mk___rep
     (mk___split_fields (rec__ar__rec1t__f1 (us_split_fields1 (select a i)))
     (rec__ar__rec1t__g1 (us_split_fields1 (select a j))))) j
     (mk___rep
     (mk___split_fields (rec__ar__rec1t__f1 (us_split_fields1 (select a j)))
     (rec__ar__rec1t__g1 (us_split_fields1 (select a i)))))) 1 10) true)))
(check-sat)
