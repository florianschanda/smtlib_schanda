...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__fs_plltune_type__fs_plltune bits_8)))))
(define-fun us_split_fields_FS_PLLTUNE__projection ((a us_split_fields)) bits_8 
  (rec__dw1000__register_types__fs_plltune_type__fs_plltune a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_65__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_65__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq5 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep1
                           (rec__dw1000__register_types__fs_plltune_type__fs_plltune
...
(declare-fun dw1000__register_types__fs_plltune_type__fs_plltune__first__bit () Int)

(declare-fun dw1000__register_types__fs_plltune_type__fs_plltune__last__bit () Int)

(declare-fun dw1000__register_types__fs_plltune_type__fs_plltune__position () Int)

;; dw1000__register_types__fs_plltune_type__fs_plltune__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__fs_plltune_type__fs_plltune__first__bit))

;; dw1000__register_types__fs_plltune_type__fs_plltune__last__bit_axiom
  (assert
  (< dw1000__register_types__fs_plltune_type__fs_plltune__first__bit 
  dw1000__register_types__fs_plltune_type__fs_plltune__last__bit))

;; dw1000__register_types__fs_plltune_type__fs_plltune__position_axiom
  (assert
  (<= 0 dw1000__register_types__fs_plltune_type__fs_plltune__position))

(declare-fun dummy4 () us_rep)

(declare-datatypes ()
((fs_plltune_type__ref
 (mk_fs_plltune_type__ref (fs_plltune_type__content us_rep)))))
(define-fun fs_plltune_type__ref___projection ((a fs_plltune_type__ref)) us_rep 
  (fs_plltune_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_154__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_109__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_109__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5622 us_t1)
  (temp___is_init_5619 Bool) (temp___skip_constant_5620 Bool)
  (temp___do_toplevel_5621 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5620 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5622)
                                       (last4 temp___expr_5622))
                                       (and (= (first3 temp___expr_5622) 1)
                                       (= (last4 temp___expr_5622) 1)))))
...
(define-fun target__ref_46__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_46__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_5638 us_t2)
  (temp___is_init_5635 Bool) (temp___skip_constant_5636 Bool)
  (temp___do_toplevel_5637 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5636 true))
                                       (and (dynamic_property3 1 1
                                       (first5 temp___expr_5638)
                                       (last6 temp___expr_5638))
                                       (and (= (first5 temp___expr_5638) 1)
                                       (= (last6 temp___expr_5638) 1)))))
...
(declare-fun temp___7898 () (Array Int bits_8))

(declare-fun temp___78981 () t2)

(declare-fun temp___7899 () (Array Int bits_8))

(declare-fun temp___78991 () t1)
...
(define-fun temp___78982 () us_t2 (mk___t2 temp___7898 temp___78981))
...
;; H
  (assert
  (and
  (and (= temp___78982 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___78982 reg)) (dynamic_invariant1
  temp___78982 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___78981)) (to_rep (last5 temp___78981)))
     (+ (- (to_rep (last5 temp___78981)) (to_rep (first4 temp___78981))) 1)
     0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))

;; H
  (assert (= temp___7898 temp___7899))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78981)) (to_rep (last5 temp___78981))) 
  temp___78991))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___78991)) (to_rep (last3 temp___78991)))
     (+ (- (to_rep (last3 temp___78991)) (to_rep (first2 temp___78991))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7899 temp___78991)))
