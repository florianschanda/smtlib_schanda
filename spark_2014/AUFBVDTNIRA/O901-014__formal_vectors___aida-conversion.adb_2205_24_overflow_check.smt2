...
(define-fun tint_arrayD1__ref_25__projection ((a tint_arrayD1__ref)) integer 
...
(define-fun tint_arrayT__ref_25__projection ((a tint_arrayT__ref)) us_t1 
...
(declare-datatypes ()
((t786b__ref (mk_t786b__ref (t786b__content integer)))))
(define-fun t786b__ref___projection ((a t786b__ref)) integer (t786b__content
                                                             a))
...
(define-fun tnumber_array_typeD1__ref_34__projection ((a tnumber_array_typeD1__ref)) integer 
...
(define-fun number_array_type__ref_34__projection ((a number_array_type__ref)) us_t3 
...
(declare-datatypes ()
((t790b__ref (mk_t790b__ref (t790b__content integer)))))
(define-fun t790b__ref___projection ((a t790b__ref)) integer (t790b__content
                                                             a))
...
(declare-datatypes ()
((t792b__ref (mk_t792b__ref (t792b__content integer)))))
(define-fun t792b__ref___projection ((a t792b__ref)) integer (t792b__content
                                                             a))
...
(define-fun tint_arrayB__ref_25__projection ((a tint_arrayB__ref)) us_t5 
  (tint_arrayB__content a))

(declare-fun aida__conversion__calculate_negative_target_length_4__int_array__aggregate_def (Int
  Int Int Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___2734 Int) (temp___2735 Int) (temp___2736 Int)
  (temp___2737 Int) (temp___2738 Int))
  (let ((temp___2733 (aida__conversion__calculate_negative_target_length_4__int_array__aggregate_def
                     temp___2734 temp___2735 temp___2736 temp___2737
                     temp___2738)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 3)
  temp___2737 temp___2738)
  (and (= (first7 temp___2733) temp___2737)
  (= (last7 temp___2733) temp___2738)))
  (and
  (and
  (= (select (to_array2 temp___2733) (+ (+ (first1 source) 1) 0)) (of_rep1
                                                                  temp___2734))
  (= (select (to_array2 temp___2733) (+ (+ (first1 source) 1) 1)) (of_rep1
                                                                  temp___2735)))
  (= (select (to_array2 temp___2733) (+ (+ (first1 source) 1) 2)) (of_rep1
                                                                  temp___2736)))))))
...
(define-fun tnumber_array_typeB__ref_34__projection ((a tnumber_array_typeB__ref)) us_t6 
  (tnumber_array_typeB__content a))

(declare-fun aida__conversion__calculate_negative_target_length_4__n__aggregate_def (Int
  Int Int) us_t4)

;; def_axiom
  (assert
  (forall ((temp___2744 Int) (temp___2745 Int) (temp___2746 Int))
  (let ((temp___2743 (aida__conversion__calculate_negative_target_length_4__n__aggregate_def
                     temp___2744 temp___2745 temp___2746)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 3)
  temp___2745 temp___2746)
  (and (= (first13 temp___2743) temp___2745)
  (= (last13 temp___2743) temp___2746)))
  (forall ((temp___2747 Int))
  (= (select (to_array4 temp___2743) temp___2747) (of_rep1 temp___2744)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_938 us_t3)
  (temp___is_init_935 Bool) (temp___skip_constant_936 Bool)
  (temp___do_toplevel_937 Bool)) Bool (=>
                                      (not (= temp___skip_constant_936 true))
                                      (and (dynamic_property6
                                      (+ (first1 source) 1)
                                      (+ (first1 source) 3)
                                      (first10 temp___expr_938)
                                      (last10 temp___expr_938))
                                      (and
                                      (= (first10 temp___expr_938) (+ 
                                      (first1 source) 1))
                                      (= (last10 temp___expr_938) (+ 
...
(declare-fun temp___2741 () (Array Int integer))

(declare-fun temp___27411 () t2)

(declare-fun aida__conversion__calculate_negative_target_length_4__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_length_4__int_array__assume1 () t1)

(declare-fun temp___2749 () (Array Int integer))

(declare-fun temp___27491 () t4)

(declare-fun aida__conversion__calculate_negative_target_length_4__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_length_4__n__assume1 () t3)

(declare-fun temp___2755 () Int)

(declare-fun temp___2756 () Int)

(declare-fun temp___2753 () (Array Int integer))

(declare-fun temp___2751 () Int)
...
;; H
  ...
  (<= index7 (+ (to_rep1 (first (rt source))) 3)))
...
;; H
  ...
  (= (to_rep1
     (first6
     (rt2
     (aida__conversion__calculate_negative_target_length_4__int_array__aggregate_def
     9 9 9 (+ (to_rep1 (first (rt source))) 1)
     (+ (+ (to_rep1 (first (rt source))) 1) 2))))) (+ (to_rep1
                                                      (first (rt source))) 1)))
...
;; H
  (assert
  (= (mk___t2 temp___2741 temp___27411) (aida__conversion__calculate_negative_target_length_4__int_array__aggregate_def
                                        9 9 9
                                        (+ (to_rep1 (first (rt source))) 1)
                                        (+ (+ (to_rep1 (first (rt source))) 1) 2))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___27411)) (to_rep1 (last6 temp___27411)))
     (+ (- (to_rep1 (last6 temp___27411)) (to_rep1 (first6 temp___27411))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1
                                                        (first (rt source))) 3))
        (+ (- (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1
                                                     (first (rt source))) 1)) 1)
        0)))

;; H
  (assert
  (= (slide1 temp___2741 (to_rep1 (first6 temp___27411))
     (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_4__int_array__assume))

;; H
  (assert
  (= (mk1 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 3)) aida__conversion__calculate_negative_target_length_4__int_array__assume1))
...
;; H
  (assert
  (= int_array1 aida__conversion__calculate_negative_target_length_4__int_array__assume))

;; H
  (assert
  (= (to_rep1 int_array__first) (to_rep1
                                (first3
                                aida__conversion__calculate_negative_target_length_4__int_array__assume1))))
...
;; H
  ...
  (+ (to_rep1 (first (rt source))) 3) (to_rep1 int_array__first)
  (to_rep1 int_array__last))
  (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 1))
  (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 3)))))
...
;; H
  ...
  (= (to_rep1
     (first12
     (rt4
     (aida__conversion__calculate_negative_target_length_4__n__aggregate_def
     0 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 3))))) (+ (to_rep1 (first (rt source))) 1)))
...
;; H
  ...
  (= (to_rep1
     ...
     (aida__conversion__calculate_negative_target_length_4__n__aggregate_def
     0 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 3))))) (+ (to_rep1 (first (rt source))) 3)))

;; H
  (assert
  (= (mk___t4 temp___2749 temp___27491) (aida__conversion__calculate_negative_target_length_4__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 1)
                                        (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___27491)) (to_rep1
                                               (last12 temp___27491)))
     (+ (- (to_rep1 (last12 temp___27491)) (to_rep1 (first12 temp___27491))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1
                                                        (first (rt source))) 3))
        (+ (- (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1
                                                     (first (rt source))) 1)) 1)
...
;; H
  (assert
  (= (slide1 temp___2749 (to_rep1 (first12 temp___27491))
     (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_4__n__assume))

;; H
  (assert
  (= (mk3 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 3)) aida__conversion__calculate_negative_target_length_4__n__assume1))
...
;; H
  (assert
  (= n1 aida__conversion__calculate_negative_target_length_4__n__assume))

;; H
  (assert
  (= (to_rep1 n__first) (to_rep1
                        (first9
                        aida__conversion__calculate_negative_target_length_4__n__assume1))))
...
;; H
  ...
  (+ (to_rep1 (first (rt source))) 3) (to_rep1 n__first) (to_rep1 n__last))
  (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 1))
  (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 3)))))
...
;; H
  (assert
  (and (= temp___2755 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (= temp___2756 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))
...
;; H
  (assert (= index1 temp___2755))

;; H
  (assert
  (=> (and (<= temp___2755 index1) (<= index1 temp___2756))
  (= temp___2753 n1)))
...
;; H
  (assert
  (=> (and (<= temp___2755 index1) (<= index1 temp___2756)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___2755 index1) (<= index1 temp___2756)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2755 index1) (<= index1 temp___2756)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2755 index1) (<= index1 temp___2756)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___2755 index1) (<= index1 temp___2756)) (= n2 o8)))
...
;; H
  ...
  (and
  (=>
  (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3))
  (dynamic_property9 (+ (to_rep1 (first (rt source))) 1)
  (+ (to_rep1 (first (rt source))) 3) index2))
  (forall ((temp___2754 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___2754)
  (<= temp___2754 (to_rep1 n__last)))
  (=> (< index2 temp___2754)
  (= (select n3 temp___2754) (select temp___2753 temp___2754))))))
  (and (<= (+ (to_rep1 (first (rt source))) 1) index2)
  (<= index2 (+ (to_rep1 (first (rt source))) 3))))))
...
;; H
  (assert
  (=> (and (<= temp___2755 index1) (<= index1 temp___2756)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___2755 index1) (<= index1 temp___2756)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___2755 index1) (<= index1 temp___2756)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___2755 index1) (<= index1 temp___2756)))
...
;; H
  (assert
  (=> (not (and (<= temp___2755 index1) (<= index1 temp___2756))) (= n7 n1)))
...
;; H
  (assert
  (and (= temp___2757 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2757)
  (<= temp___2757 (to_rep1 n__last))))

;; H
  (assert (= o9 temp___2757))
...
;; H
  (assert
  (and (= temp___2758 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2758)
  (<= temp___2758 (to_rep1 n__last))))

;; H
  (assert (= o14 temp___2758))
...
;; H
  (assert
  (and (= temp___2759 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2759)
  (<= temp___2759 (to_rep1 n__last))))

;; H
  (assert (= o21 temp___2759))
...
(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 2135, characters 0-0
  (not (in_range1 o26)))
(check-sat)
