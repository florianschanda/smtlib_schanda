...
;; H
  ...
  (mem (rec__list_allocator__m__t__available model____split_fields2) rr)
  (rec__list_allocator__m__t__available model____split_fields2) rr))

(assert
;; WP_parameter_def
 ;; File "list_allocator.adb", line 16, characters 0-0
  (not
  (= (mem (rec__list_allocator__m__t__available model____split_fields2) rr) true)))
(check-sat)
