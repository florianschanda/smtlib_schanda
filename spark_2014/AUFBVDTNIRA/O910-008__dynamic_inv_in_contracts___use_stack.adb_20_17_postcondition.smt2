...
(declare-fun content4 () (Array Int positive))

(declare-fun i3 () Int)

(declare-fun content5 () (Array Int positive))

(declare-fun i4 () Int)

(declare-fun content6 () (Array Int positive))

(declare-fun i5 () Int)

(declare-fun content7 () (Array Int positive))

(declare-fun i6 () Int)

(declare-fun top2 () Int)

(declare-fun content8 () (Array Int positive))

(declare-fun i7 () Int)

(declare-fun top3 () Int)

(declare-fun content9 () (Array Int positive))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= (to_rep o1) e)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last)))
  (= o2 (store content i1 o1))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last)))
  (= (mk_map__ref result2) content11)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= content2 o2)))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= content3 content4)))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= content5 content3)))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last)))
  (= content10 (mk_map__ref content4))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 (to_rep1 content__last))) (= content7 content5)))

;; H
  (assert
  (=> (not (and (<= 1 i1) (<= i1 (to_rep1 content__last)))) (= i1 i5)))

;; H
  (assert
  (=> (not (and (<= 1 i1) (<= i1 (to_rep1 content__last))))
  (= content10 content11)))

;; H
  (assert
  (=> (not (and (<= 1 i1) (<= i1 (to_rep1 content__last)))) (= i6 i1)))
