...
;; def_axiom
  (assert
  (forall ((temp___1370 Int) (temp___1371 Int) (temp___1372 Int)
  (temp___1373 Int) (temp___1374 Int) (temp___1375 Int) (temp___1376 Int)
  (temp___1377 Int) (temp___1378 Int) (temp___1379 Int) (temp___1380 Int)
  (temp___1381 Int))
  (let ((temp___1369 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__aggregate_def
                     temp___1370 temp___1371 temp___1372 temp___1373
                     temp___1374 temp___1375 temp___1376 temp___1377
                     temp___1378 temp___1379 temp___1380 temp___1381)))
  (and
  (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1380
  temp___1381)
  (and (= (first7 temp___1369) temp___1380)
  (= (last7 temp___1369) temp___1381)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___1369) (+ (first1 source) 0)) (of_rep1
                                                            temp___1370))
  (= (select (to_array2 temp___1369) (+ (first1 source) 1)) (of_rep1
                                                            temp___1371)))
  (= (select (to_array2 temp___1369) (+ (first1 source) 2)) (of_rep1
                                                            temp___1372)))
  (= (select (to_array2 temp___1369) (+ (first1 source) 3)) (of_rep1
                                                            temp___1373)))
  (= (select (to_array2 temp___1369) (+ (first1 source) 4)) (of_rep1
                                                            temp___1374)))
  (= (select (to_array2 temp___1369) (+ (first1 source) 5)) (of_rep1
                                                            temp___1375)))
  (= (select (to_array2 temp___1369) (+ (first1 source) 6)) (of_rep1
                                                            temp___1376)))
  (= (select (to_array2 temp___1369) (+ (first1 source) 7)) (of_rep1
                                                            temp___1377)))
  (= (select (to_array2 temp___1369) (+ (first1 source) 8)) (of_rep1
                                                            temp___1378)))
  (= (select (to_array2 temp___1369) (+ (first1 source) 9)) (of_rep1
                                                            temp___1379)))))))
...
;; def_axiom
  (assert
  (forall ((temp___1387 Int) (temp___1388 Int) (temp___1389 Int))
  (let ((temp___1386 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__aggregate_def
                     temp___1387 temp___1388 temp___1389)))
  (and
  (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1388
  temp___1389)
  (and (= (first13 temp___1386) temp___1388)
  (= (last13 temp___1386) temp___1389)))
  (forall ((temp___1390 Int))
  (= (select (to_array4 temp___1386) temp___1390) (of_rep1 temp___1387)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_201 us_t3)
  (temp___is_init_198 Bool) (temp___skip_constant_199 Bool)
  (temp___do_toplevel_200 Bool)) Bool (=>
                                      (not (= temp___skip_constant_199 true))
                                      (and (dynamic_property6 (first1 source)
                                      (+ (first1 source) 9)
                                      (first10 temp___expr_201)
                                      (last10 temp___expr_201))
                                      (and
                                      (= (first10 temp___expr_201) (first1
                                                                   source))
                                      (= (last10 temp___expr_201) (+ 
                                      (first1 source) 9))))))
...
(declare-fun temp___1384 () (Array Int integer))

(declare-fun temp___13841 () t2)
...
(declare-fun temp___1392 () (Array Int integer))

(declare-fun temp___13921 () t4)
...
(declare-fun temp___1396 () (Array Int integer))
...
;; H
  (assert
  (= (mk___t2 temp___1384 temp___13841) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__aggregate_def
                                        2 1 4 7 4 8 3 6 3 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___13841)) (to_rep1 (last6 temp___13841)))
     (+ (- (to_rep1 (last6 temp___13841)) (to_rep1 (first6 temp___13841))) 1)
...
;; H
  (assert
  (= (slide1 temp___1384 (to_rep1 (first6 temp___13841))
...
;; H
  (assert
  (= (mk___t4 temp___1392 temp___13921) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__aggregate_def
                                        0 (to_rep1 (first (rt source)))
                                        (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___13921)) (to_rep1
                                               (last12 temp___13921)))
     (+ (- (to_rep1 (last12 temp___13921)) (to_rep1 (first12 temp___13921))) 1)
     0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1
                                                  (first (rt source))) 9))
        (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1
                                                  (first (rt source)))) 1)
...
;; H
  (assert
  (= (slide1 temp___1392 (to_rep1 (first12 temp___13921))
...
;; H
  (assert
  (and (= temp___1399 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1399))
  (= temp___1396 n1)))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 n__first) temp___1397)
  (<= temp___1397 (to_rep1 n__last)))
  (=> (< index2 temp___1397)
  (= (select n3 temp___1397) (select temp___1396 temp___1397))))))
...
;; H
  (assert
  (and (= temp___1400 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))
...
;; H
  (assert
  (and (= temp___1401 (+ (to_rep1 (first (rt source))) 8)) (in_range1
