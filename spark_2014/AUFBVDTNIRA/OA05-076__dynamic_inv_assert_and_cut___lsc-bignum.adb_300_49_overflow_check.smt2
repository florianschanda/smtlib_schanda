...
;; H
  (assert
  (and (= o43 (from_word32 carry22)) (from_word32__function_guard o43
  carry22)))
...
;; H
  (assert
  (and (= o41 (from_word32 carry12)) (from_word32__function_guard o41
  carry12)))

;; H
  (assert (and (= o45 (oadd o41 o44)) (oadd__function_guard o45 o41 o44)))
...
;; H
  (assert
  (and (= o40 (oexpon o35 o39)) (oexpon__function_guard o40 o35 o39)))

;; H
  (assert
  (and (= o46 (omultiply o40 o45)) (omultiply__function_guard o46 o40 o45)))
...
;; H
  ...
  (= o34 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))
         a_first o33))
  (num_of_big_int__function_guard o34
  (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o33)))

;; H
  (assert (and (= o47 (oadd o34 o46)) (oadd__function_guard o47 o34 o46)))
...
;; H
  (assert
  (and (= o28 (from_word32 carry2)) (from_word32__function_guard o28 carry2)))
...
;; H
  (assert
  (and (= o29 (omultiply o27 o28)) (omultiply__function_guard o29 o27 o28)))

;; H
  (assert
  (and (= o26 (from_word32 carry1)) (from_word32__function_guard o26 carry1)))

;; H
  (assert (and (= o24 (from_word32 y)) (from_word32__function_guard o24 y)))
...
;; H
  (assert
  (and (= o23 (num_of_big_int c c_first o22)) (num_of_big_int__function_guard
  o23 c c_first o22)))
...
;; H
  (assert (and (= o18 (from_word32 x)) (from_word32__function_guard o18 x)))
