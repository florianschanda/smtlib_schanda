...
(define-fun dynamic_invariant1 ((temp___expr_299 Int)
...
;; temp___result_135_def
  (assert
  (forall ((container us_rep3) (item Int) (i Int)) (my_lt__function_guard
  (my_lt (get1 container i) item) (get1 container i) item)))
...
;; temp___result_136_def
  (assert
  (forall ((container us_rep3) (item Int) (i Int)) (my_lt__function_guard
  (my_lt item (get1 container i)) item (get1 container i))))
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container)))
     ...
     (= (contains (model__ container) (get1 result temp___405)) true))))
     (forall ((item Int))
...
;; H
  ...
  (and
  (and
  (= (bool_eq3 (mk___rep1 (mk___split_fields1 cu__split_fields1)) no_element) true)
