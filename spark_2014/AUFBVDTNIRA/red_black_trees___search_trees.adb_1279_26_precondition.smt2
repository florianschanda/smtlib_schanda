...
(declare-fun temp___3637 () (Array Int us_rep1))
...
(declare-fun temp___3638 () (Array Int us_rep1))
...
;; H
  (assert
  (and (= o20 (to_rep1 t_old__split_fields)) (in_range3
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3680 o20))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3680 o20)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o20))
...
;; H
  (assert (= o21 (select temp___3680 l)))
...
;; H
  ...
  (and
  (and
  (= o18 (size (rec__search_trees__search_tree__struct (us_split_fields7 t))))
  (size__function_guard o18
...
;; H
  ...
  o14) (rec__search_trees__search_tree__struct (us_split_fields7 t)) 
  o14))

;; H
  (assert (parent__function_guard
  (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o14)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o14))
...
;; H
  ...
  (and
  (and
  (= o14 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t))
         l d))
  (peek__function_guard o14
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3638 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i1))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3638 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3638 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3637 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i1))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3637 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3637 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= temp___3638 (model__
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7 t)) o7))
  (model____function_guard temp___3638
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o7))
  (and (dynamic_invariant8 temp___3638 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3638 o7))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3638 o7)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o7))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3638 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3638 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3638 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3638 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3638 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3638 j1)))) true))
  (= j1 i1))))))))))))))
...
;; H
  (assert (= (mk___rep (mk___split_fields o9 o10)) (select temp___3638 
  o8)))
...
;; H
  ...
  (model____function_guard temp___3637
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1))
  (and (dynamic_invariant8 temp___3637 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3637 o1))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3637 o1)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o1))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___3637 (parent
                              ...
                              (us_split_fields7 t)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3637 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3637 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3637 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3637 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3637 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3637 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o2 o3)) (select temp___3637 l)))
...
;; H
  (assert
  (and
  (and (= result11 (is_add o6 d o13)) (is_add__function_guard result11 
  o6 d o13))
  (= (= result11 true)
  (and (and (= (- (length o13) 1) (length o6)) (= (olt o6 o13) true))
  (= (get o13 (length o13)) d)))))
