...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2092 o20))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2092 o20)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o20))
...
;; H
  (assert (= o21 (select temp___2092 l)))
...
;; H
  ...
  (and (dynamic_invariant8 temp___2062 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2062 o7))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2062 o7)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o7))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2062 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2062 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2062 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2062 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2062 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2062 j1)))) true))
  (= j1 i1))))))))))))))
...
;; H
  (assert (= (mk___rep (mk___split_fields o9 o10)) (select temp___2062 
  o8)))
...
;; H
  ...
  (and (dynamic_invariant8 temp___2061 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2061 o1))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2061 o1)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o1))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2061 (parent
                              ...
                              (us_split_fields7 t)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2061 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2061 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2061 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2061 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2061 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2061 j1)))) true))
  (= j1 i1))))))))))))))
