...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral4) (= (tqtreal fliteral4) 24.0)))

(declare-fun fliteral5 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral5) (= (tqtreal fliteral5) 720.0)))

(declare-fun fliteral6 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral6) (= (tqtreal fliteral6) 40320.0)))
...
;; approx_cos__def_axiom
  ...
  (! (=>
     ...
     (= (approx_cos x) (add RNE2
                       (sub RNE2
                       (add RNE2
                       (sub RNE2 fliteral (div1 RNE2 (pow21 x) fliteral3))
                       (div1 RNE2 (pow4 x) fliteral4))
                       (div1 RNE2 (pow6 x) fliteral5))
                       (div1 RNE2 (pow8 x) fliteral6)))))))) :pattern (
  (approx_cos x)) )))
...
;; pow2__def_axiom
  ...
  (! (=>
     ...
     (pow21 x1) x1)) (= (pow21 x1) (mul RNE2 x1 x1))) :pattern ((pow21 x1)) )))
...
;; pow4__def_axiom
  ...
  (! (=>
     ...
     (pow4 x1) x1))
     (= (pow4 x1) (mul RNE2 (mul RNE2 (mul RNE2 x1 x1) x1) x1))) :pattern (
  (pow4 x1)) )))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral7) (/ 3000000106112565845251083374023437500.0 1000000000000000000000000000000000000000000.0))))

(declare-fun trigo__cos__result () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun trigo__cos__result1 () t)

(declare-fun trigo__cos__result2 () t)

(declare-fun trigo__cos__result3 () t)

(declare-fun trigo__cos__result4 () t)

(declare-fun trigo__cos__result5 () t)
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (lt (abs1 (sub RNE2 trigo__cos__result4 (approx_cos x))) fliteral7)))
(check-sat)
