...
;; H
  (assert (add2__function_guard
  (add2 (mk___rep1 (mk___split_fields1 r__split_fields r__split_fields1)))
  (mk___rep1 (mk___split_fields1 r__split_fields r__split_fields1))))
