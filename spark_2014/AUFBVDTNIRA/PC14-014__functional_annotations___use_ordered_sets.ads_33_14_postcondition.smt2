...
(define-fun element_type__ref_5__projection ((a element_type__ref2)) element_type2 
...
;; first__post_axiom
  ...
  (! (let ((result (first container)))
     (ite (= (length3 container) 0) (= (bool_eq2 result no_element) true)
...
(declare-fun use_ordered_sets__are_disjoint__result () Bool)

(declare-fun use_ordered_sets__are_disjoint__cu__assume () count_type)

(declare-fun temp___739 () count_type)

(declare-fun o () Int)

(declare-fun temp___738 () count_type)

(declare-fun o1 () Bool)

(declare-fun use_ordered_sets__are_disjoint__result1 () Bool)
...
(declare-fun use_ordered_sets__are_disjoint__result2 () Bool)

(declare-fun result2 () Bool)

(declare-fun result3 () Bool)

(declare-fun use_ordered_sets__are_disjoint__result3 () Bool)

(declare-fun result4 () count_type)

(declare-fun cu__split_fields3 () count_type)

(declare-fun result5 () Bool)

(declare-fun cu__split_fields4 () us_split_fields__ref1)

(declare-fun use_ordered_sets__are_disjoint__result4 () bool__ref)

(declare-fun cu__split_fields5 () us_split_fields2)

(declare-fun use_ordered_sets__are_disjoint__result5 () Bool)

(declare-fun cu__split_fields6 () us_split_fields__ref1)

(declare-fun use_ordered_sets__are_disjoint__result6 () bool__ref)

(declare-fun cu__split_fields7 () us_split_fields2)

(declare-fun use_ordered_sets__are_disjoint__result7 () Bool)

(declare-fun result6 () bool__ref)

(declare-fun use_ordered_sets__are_disjoint__result8 () Bool)

(declare-fun use_ordered_sets__are_disjoint__result9 () bool__ref)

(declare-fun use_ordered_sets__are_disjoint__result10 () Bool)

(declare-fun cu__split_fields8 () us_split_fields__ref1)

(declare-fun use_ordered_sets__are_disjoint__result11 () bool__ref)

(declare-fun cu__split_fields9 () us_split_fields2)

(declare-fun use_ordered_sets__are_disjoint__result12 () Bool)

(declare-fun cu__split_fields10 () us_split_fields__ref1)

(declare-fun use_ordered_sets__are_disjoint__result13 () bool__ref)

(declare-fun cu__split_fields11 () us_split_fields2)

(declare-fun use_ordered_sets__are_disjoint__result14 () Bool)
...
(define-fun temp___7381 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___738)))
...
;; H
  ...
  (= (bool_eq2 use_ordered_sets__are_disjoint__cu__assume1 no_element) true)
  (and
...
;; H
  ...
  (and
  (and
  (= use_ordered_sets__are_disjoint__result11 (mk_bool__ref
                                              use_ordered_sets__are_disjoint__result3))
  (= cu__split_fields8 (mk___split_fields__ref1 cu__split_fields13)))
  (and
  (= use_ordered_sets__are_disjoint__result12 use_ordered_sets__are_disjoint__result3)
  (= cu__split_fields9 cu__split_fields13)))
  (and
  (and (= result1 (has_key (positions s1) (mk___rep1 cu__split_fields14)))
  (= (= result1 true)
  (= (has_key (positions s1) (mk___rep1 cu__split_fields14)) true)))
  (and (= result1 true)
  (and (= temp___739 cu__split_fields1)
  (and
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (- (get1 (positions s1) (mk___rep1 cu__split_fields13)) 1)))
  (not (= (contains (model__ s2) (get (elements s1) i)) true))))
  (and (= (has_key (positions s1) (mk___rep1 cu__split_fields13)) true)
  (and
  (and
  (and (= o (element s1 (mk___rep1 cu__split_fields13)))
  (and (in_range6 o)
  (= o (get (elements s1)
       (get1 (positions s1) (mk___rep1 cu__split_fields13))))))
  (and (= result2 (contains (model__ s2) o))
  (= (= result2 true) (= (contains (model__ s2) o) true))))
  (and (= result2 true)
  (and (= result3 use_ordered_sets__are_disjoint__result2)
  (= use_ordered_sets__are_disjoint__result3 (of_int 0)))))))))))
  (and
  (and
  (and (= result1 (has_key (positions s1) (mk___rep1 cu__split_fields14)))
  (= (= result1 true)
  ...
  (= use_ordered_sets__are_disjoint__result3 use_ordered_sets__are_disjoint__result2)))
  (and
  (and
  (and (= temp___7381 (next s1 (mk___rep1 cu__split_fields13)))
  ...
  (= (bool_eq2 temp___7381 no_element) true)
  (and (= (has_key (positions s1) temp___7381) true)
  (= (get1 (positions s1) temp___7381) (+ (get1 (positions s1)
                                          (mk___rep1 cu__split_fields13)) 1)))))
  (and (= result4 cu__split_fields2) (= temp___738 cu__split_fields3)))
  (and
  (and
  (and (= o1 (has_key (positions s1) (mk___rep1 cu__split_fields12)))
  (= (= o1 true)
  (= (has_key (positions s1) (mk___rep1 cu__split_fields12)) true)))
  (= result5 (ite (not (= o1 true)) true false))) (= result5 true)))))))
  (and
  (and
  (= use_ordered_sets__are_disjoint__result4 (mk_bool__ref
                                             use_ordered_sets__are_disjoint__result3))
  (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields12)))
  (and
  (= use_ordered_sets__are_disjoint__result5 use_ordered_sets__are_disjoint__result3)
  (= cu__split_fields5 cu__split_fields12))))
  (and
  (and
  (= use_ordered_sets__are_disjoint__result6 use_ordered_sets__are_disjoint__result4)
  (= cu__split_fields6 cu__split_fields4))
  (and
  (= use_ordered_sets__are_disjoint__result7 use_ordered_sets__are_disjoint__result5)
  (= cu__split_fields7 cu__split_fields5))))
  (and
  (and
  (= use_ordered_sets__are_disjoint__result6 (mk_bool__ref
                                             use_ordered_sets__are_disjoint__result))
  (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields14)))
  (and
  (= use_ordered_sets__are_disjoint__result7 use_ordered_sets__are_disjoint__result1)
  (= cu__split_fields7 cu__split_fields14)))))
  (and
  (and
  (and
  (= use_ordered_sets__are_disjoint__result11 use_ordered_sets__are_disjoint__result9)
  (= cu__split_fields8 cu__split_fields6))
  (and
  (= use_ordered_sets__are_disjoint__result12 use_ordered_sets__are_disjoint__result10)
  (= cu__split_fields9 cu__split_fields7)))
  (and
  (and
  (= use_ordered_sets__are_disjoint__result9 (mk_bool__ref
                                             use_ordered_sets__are_disjoint__result8))
  (= use_ordered_sets__are_disjoint__result10 use_ordered_sets__are_disjoint__result8))
  (and (= result6 use_ordered_sets__are_disjoint__result6)
  (= use_ordered_sets__are_disjoint__result8 (of_int 1))))))))

;; H
  (assert
  (= use_ordered_sets__are_disjoint__result13 use_ordered_sets__are_disjoint__result11))
...
;; H
  (assert
  (= use_ordered_sets__are_disjoint__result14 use_ordered_sets__are_disjoint__result12))
...
;; H
  (assert
  (= result7 (bool__content use_ordered_sets__are_disjoint__result13)))

;; H
  (assert (= (bool__content use_ordered_sets__are_disjoint__result13) true))

(assert
;; WP_parameter_def
 ;; File "use_ordered_sets.ads", line 32, characters 0-0
  (not (= (is_empty (intersection1 (model__ s1) (model__ s2))) true)))
(check-sat)
