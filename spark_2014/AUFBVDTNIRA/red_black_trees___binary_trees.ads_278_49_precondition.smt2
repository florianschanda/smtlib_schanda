...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1250 (parent
                      (mk___rep2
                      (us_split_fields__content2 f__split_fields7)) i2))))
  (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1250 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1250 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___1250 (model__
                 (mk___rep2 (us_split_fields__content2 f__split_fields7))
                 root))
  (model____function_guard temp___1250
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) root))
  (and (dynamic_invariant3 temp___1250 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___1250 (parent
                              ...
                              i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1250 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1250 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1250 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1250 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1250 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1250 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o44 (select temp___1250 i1)))
