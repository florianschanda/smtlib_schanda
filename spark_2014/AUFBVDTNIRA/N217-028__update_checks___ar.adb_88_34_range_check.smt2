...
;; def_axiom
  (assert
  (forall ((temp___254 (Array Int et1)))
  (forall ((temp___255 Int) (temp___256 Int))
  (let ((temp___253 (temp___252 temp___254 temp___255 temp___256)))
  (forall ((temp___257 Int))
  (ite (= temp___257 temp___255)
  (= (select temp___253 temp___257) (of_rep temp___256))
  (= (select temp___253 temp___257) (select temp___254 temp___257))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.adb", line 76, characters 0-0
  (not (in_range1 (- e 1))))
(check-sat)
