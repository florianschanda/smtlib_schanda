...
(define-fun dynamic_invariant ((temp___expr_3343 us_t1)
  ...
  (temp___do_toplevel_3342 Bool)) Bool (=>
                                       ...
                                       (last3 temp___expr_3343))
                                       (and (= (first3 temp___expr_3343) 1)
                                       (= (last3 temp___expr_3343) 41)))))
...
(define-fun dynamic_invariant1 ((temp___expr_3362 us_t2)
  ...
  (temp___do_toplevel_3361 Bool)) Bool (=>
                                       ...
                                       (last5 temp___expr_3362))
                                       (and (= (first5 temp___expr_3362) 1)
                                       (= (last5 temp___expr_3362) 41)))))
...
;; H
  (assert
  (and (= temp___76692 (register_to_bytes reg)) (dynamic_invariant1
  temp___76692 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___76691)) (to_rep (last4 temp___76691)))
     (+ (- (to_rep (last4 temp___76691)) (to_rep (first4 temp___76691))) 1)
     0) (ite (<= 1 41) (+ (- 41 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76691)) (to_rep (last4 temp___76691))) 
  temp___76701))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___76701)) (to_rep (last2 temp___76701)))
     (+ (- (to_rep (last2 temp___76701)) (to_rep (first2 temp___76701))) 1)
