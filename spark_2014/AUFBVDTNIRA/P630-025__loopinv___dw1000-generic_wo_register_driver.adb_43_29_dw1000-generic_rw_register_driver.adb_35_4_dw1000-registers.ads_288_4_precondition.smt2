...
(define-fun register_type__ref_55__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_40__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_40__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3343 us_t1)
  (temp___is_init_3340 Bool) (temp___skip_constant_3341 Bool)
  (temp___do_toplevel_3342 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3341 true))
                                       (and (dynamic_property2 1 41
                                       (first3 temp___expr_3343)
                                       (last4 temp___expr_3343))
                                       (and (= (first3 temp___expr_3343) 1)
                                       (= (last4 temp___expr_3343) 41)))))
...
(define-fun target__ref_16__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_16__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_3362 us_t2)
  (temp___is_init_3359 Bool) (temp___skip_constant_3360 Bool)
  (temp___do_toplevel_3361 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3360 true))
                                       (and (dynamic_property3 1 41
                                       (first5 temp___expr_3362)
                                       (last6 temp___expr_3362))
                                       (and (= (first5 temp___expr_3362) 1)
                                       (= (last6 temp___expr_3362) 41)))))
...
(declare-fun temp___7669 () (Array Int bits_8))

(declare-fun temp___76691 () t2)

(declare-fun temp___7670 () (Array Int bits_8))

(declare-fun temp___76701 () t1)
...
(define-fun temp___76692 () us_t2 (mk___t2 temp___7669 temp___76691))
...
;; H
  (assert
  (and
  (and (= temp___76692 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___76692 reg)) (dynamic_invariant1
  temp___76692 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___76691)) (to_rep (last5 temp___76691)))
     (+ (- (to_rep (last5 temp___76691)) (to_rep (first4 temp___76691))) 1)
     0) (ite (<= 1 41) (+ (- 41 1) 1) 0)))

;; H
  (assert (= temp___7669 temp___7670))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76691)) (to_rep (last5 temp___76691))) 
  temp___76701))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___76701)) (to_rep (last3 temp___76701)))
     (+ (- (to_rep (last3 temp___76701)) (to_rep (first2 temp___76701))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7670 temp___76701)))
