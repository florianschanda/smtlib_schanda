...
(declare-fun use_ordered_sets__move_3__cu__assume () count_type)

(declare-fun temp___804 () count_type)

(declare-fun temp___8041 () us_main_type)

(declare-fun temp___803 () count_type)

(declare-fun o () Int)

(declare-fun temp___802 () count_type)
...
(declare-fun s2__split_fields3 () us_split_fields__ref)

(declare-fun cu__split_fields4 () us_split_fields__ref1)

(declare-fun s2__split_fields4 () us_split_fields)

(declare-fun cu__split_fields5 () us_split_fields2)

(declare-fun s2__split_fields5 () us_split_fields__ref)

(declare-fun cu__split_fields6 () us_split_fields__ref1)

(declare-fun s2__split_fields6 () us_split_fields)

(declare-fun cu__split_fields7 () us_split_fields2)

(declare-fun s1__split_fields1 () us_split_fields)

(declare-fun s1__split_fields2 () us_split_fields__ref)

(declare-fun s2__split_fields7 () us_split_fields__ref)

(declare-fun cu__split_fields8 () us_split_fields__ref1)

(declare-fun s1__split_fields3 () us_split_fields)

(declare-fun s2__split_fields8 () us_split_fields)
...
(define-fun s2__split_fields9 () us_split_fields (mk___split_fields
                                                 s2__split_fields1))

(define-fun s2__split_fields10 () us_split_fields (mk___split_fields
                                                  s2__split_fields))

(define-fun cu__split_fields11 () us_split_fields2 (mk___split_fields1
                                                   cu__split_fields1))

(define-fun temp___8021 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___802)))

(define-fun use_ordered_sets__move_3__cu__assume1 () us_rep1 (mk___rep1
                                                             (mk___split_fields1
                                                             use_ordered_sets__move_3__cu__assume)))
...
;; H
  (assert
  (and
  (= use_ordered_sets__move_3__cu__assume1 (first
                                           (mk___rep s1__split_discrs
                                           (mk___split_fields
                                           s1__split_fields))))
  (ite (= (= (length
             (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) 0) true)
  (= (bool_eq3 use_ordered_sets__move_3__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
     use_ordered_sets__move_3__cu__assume1) true)
  (= (get1
     (positions
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
     use_ordered_sets__move_3__cu__assume1) 1)))))
...
;; H
  (assert
  (and (= (length (mk___rep s2__split_discrs s2__split_fields10)) 0)
  (= (is_empty (model__ (mk___rep s2__split_discrs s2__split_fields10))) true)))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= (mk___split_discrs temp___804) s2__split_discrs)
  (= temp___8041 s2__split_fields))))

;; H
  (assert (=> (= result1 true) (= temp___803 cu__split_fields1)))
...
;; H
  ...
  (=>
  (and (<= 1 i)
  (<= i (length (mk___rep s2__split_discrs s2__split_fields9))))
  (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields9))
     (get
     (elements
...
;; H
  ...
  (=>
  (and (in_range3 e)
  (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields9)) e) true))
  (exists ((i Int))
  (and
  (and (<= 1 i)
  (<= i (length (mk___rep s2__split_discrs s2__split_fields9))))
  (= (get
     (elements
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i) e)))))))
...
;; H
  ...
  (ite (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields9))
          o) true)
  (and
  (and
  (and
  (= (oeq2 (model__ (mk___rep s2__split_discrs s2__split_fields9))
     (model__ (mk___rep s2__split_discrs s2__split_fields2))) true)
  (= (oeq4 (positions (mk___rep s2__split_discrs s2__split_fields2))
     (positions (mk___rep s2__split_discrs s2__split_fields9))) true))
  (= (get (elements (mk___rep s2__split_discrs s2__split_fields2))
     (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o)) 
  o))
  (= (equal_except (elements (mk___rep s2__split_discrs s2__split_fields9))
  ...
  (= (length (mk___rep s2__split_discrs s2__split_fields2)) (+ (length
                                                               ...
                                                               s2__split_discrs
                                                               s2__split_fields9)) 1))
  (= (ole (model__ (mk___rep s2__split_discrs s2__split_fields9))
     (model__ (mk___rep s2__split_discrs s2__split_fields2))) true))
  (= (included_except (model__ (mk___rep s2__split_discrs s2__split_fields2))
     (model__ (mk___rep s2__split_discrs s2__split_fields9)) o) true))
  (= (get (elements (mk___rep s2__split_discrs s2__split_fields2))
     (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o)) 
  o))
  (= (range_equal (elements (mk___rep s2__split_discrs s2__split_fields9))
     (elements (mk___rep s2__split_discrs s2__split_fields2)) 1
     (- (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o) 1)) true))
  (= (range_shifted (elements (mk___rep s2__split_discrs s2__split_fields9))
     (elements (mk___rep s2__split_discrs s2__split_fields2))
     (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o)
     (length (mk___rep s2__split_discrs s2__split_fields9)) 1) true))
  (= (p_positions_shifted
     (positions (mk___rep s2__split_discrs s2__split_fields9))
...
;; H
  ...
  (= (bool_eq3 temp___8021 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
...
;; H
  (assert
  (=> (= result1 true)
  (= result2 (mk___split_fields__ref1 cu__split_fields10))))

;; H
  (assert
  (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___802))))
...
;; H
  (assert
  (=> (= result1 true) (= result3 (ite (not (= o1 true)) true false))))
...
;; H
  (assert
  (=> (= result1 true)
  (= s2__split_fields3 (mk___split_fields__ref s2__split_fields2))))
...
;; H
  (assert
  (=> (not (= result1 true))
  (= s2__split_fields5 (mk___split_fields__ref s2__split_fields10))))
...
;; H
  (assert
  (=> (not (= result1 true)) (= s2__split_fields6 s2__split_fields10)))

;; H
  (assert
  (and (= (length (mk___rep s1__split_discrs s1__split_fields1)) 0)
  (= (is_empty (model__ (mk___rep s1__split_discrs s1__split_fields1))) true)))
...
(assert
;; WP_parameter_def
 ;; File "use_ordered_sets.ads", line 59, characters 0-0
  (not
  (= (oeq2
     (model__
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
     (model__
     (mk___rep s2__split_discrs (us_split_fields__content s2__split_fields7)))) true)))
(check-sat)
