...
(define-fun dynamic_invariant4 ((temp___expr_281 us_rep3)
...
(define-fun default_initial_assumption1 ((temp___expr_285 us_rep3)
...
(define-fun default_initial_assumption2 ((temp___expr_221 (Array Int us_rep1))
...
;; ordered_leafs__post_axiom
  (assert
  (forall ((f us_rep3))
  (forall ((root Int)) (valid_root__function_guard (valid_root f root) f
  root))))
...
;; ordered_leafs__def_axiom
  ...
  (! (=> (ordered_leafs__function_guard (ordered_leafs f root values) f root
     values)
     ...
     (= (rec__tree_model__path_type__k
        (us_split_fields1
        (let ((temp___909 (model__ f root))) (select temp___909 i)))) true)
     (= (rec__tree_model__path_type__k
        (us_split_fields1
        (let ((temp___911 (model__ f root))) (select temp___911 j)))) true))
     (= (olt
        (rec__tree_model__path_type__a
        (us_split_fields1
        (let ((temp___913 (model__ f root))) (select temp___913 i))))
        (rec__tree_model__path_type__a
        (us_split_fields1
        (let ((temp___915 (model__ f root))) (select temp___915 j))))) true))
     (ite (= (get
             (rec__tree_model__path_type__a
             (us_split_fields1
             (let ((temp___905 (model__ f root))) (select temp___905 j))))
             (+ (length
                (rec__tree_model__path_type__a
                (us_split_fields1
                (let ((temp___907 (model__ f root))) (select temp___907 i))))) 1)) 0)
...
(define-fun dynamic_invariant7 ((temp___expr_158 Int)
...
(define-fun dynamic_invariant9 ((temp___expr_170 Int)
  (temp___is_init_167 Bool) (temp___skip_constant_168 Bool)
  (temp___do_toplevel_169 Bool)) Bool (=>
                                      (or (= temp___is_init_167 true)
                                      (<= 0 1)) (in_range9 temp___expr_170)))
...
;; size__post_axiom
  (assert
  (forall ((f1 us_rep3))
  (! (=> (dynamic_invariant4 f1 true true true)
     (let ((result (size f1)))
     (=> (size__function_guard result f1) (dynamic_invariant7 result true
...
;; parent__post_axiom
  ...
  (! (=>
     ...
     (and (valid_root__function_guard (valid_root f1 i) f1 i)
     (and (size__function_guard (size f1) f1)
     (=> (parent__function_guard result f1 i)
     (and
...
;; position__post_axiom
  ...
  (forall ((f1 us_rep3))
  (forall ((i Int))
  (! (and (parent__function_guard (parent f1 i) f1 i)
     (=>
     (and
     (and (dynamic_invariant4 f1 true true true) (dynamic_invariant i true
     true true)) (not (= (parent f1 i) 0)))
     (let ((result (position f1 i)))
     (=> (position__function_guard result f1 i) (dynamic_invariant9 result
     true false true))))) :pattern ((position f1 i)) ))))
...
(declare-fun temp___2914 () Int)

(declare-fun temp___2881 () Int)

(declare-fun temp___2797 () (Array Int us_rep1))
...
(declare-fun temp___2798 () (Array Int us_rep1))
...
(declare-fun temp___2796 () (Array Int us_rep1))

(declare-fun o6 () us_rep1)

(declare-fun o7 () us_split_fields)

(declare-fun temp___2795 () (Array Int us_rep1))

(declare-fun o8 () us_rep1)

(declare-fun o9 () us_split_fields)

(declare-fun temp___2813 () (Array Int us_rep1))
...
(declare-fun temp___2814 () (Array Int us_rep1))
...
(declare-fun temp___2812 () (Array Int us_rep1))

(declare-fun o16 () us_rep1)

(declare-fun o17 () us_split_fields)

(declare-fun temp___2811 () (Array Int us_rep1))

(declare-fun o18 () us_rep1)

(declare-fun o19 () us_split_fields)

(declare-fun temp___2841 () (Array Int us_rep1))
...
(declare-fun temp___2842 () (Array Int us_rep1))
...
(declare-fun temp___2840 () (Array Int us_rep1))

(declare-fun o26 () us_rep1)

(declare-fun o27 () us_split_fields)

(declare-fun temp___2839 () (Array Int us_rep1))

(declare-fun o28 () us_rep1)

(declare-fun o29 () us_split_fields)

(declare-fun temp___2874 () (Array Int us_rep1))

(declare-fun o30 () us_rep1)

(declare-fun o31 () us_split_fields)

(declare-fun temp___2873 () (Array Int us_rep1))

(declare-fun o32 () us_rep1)
...
(declare-fun temp___2963 () (Array Int us_rep1))
...
(declare-fun temp___2964 () (Array Int us_rep1))
...
(declare-fun temp___2962 () (Array Int us_rep1))

(declare-fun o40 () us_rep1)

(declare-fun o41 () us_split_fields)

(declare-fun temp___2961 () (Array Int us_rep1))

(declare-fun o42 () us_rep1)

(declare-fun o43 () us_split_fields)

(declare-fun temp___2960 () (Array Int us_rep1))
...
;; H
  (assert (dynamic_invariant4 f true false true))

;; H
  (assert (dynamic_invariant4 f_old true false true))
...
;; H
  (assert (valid_root__function_guard (valid_root f_old root) f_old root))

;; H
  (assert (valid_root__function_guard (valid_root f root) f root))

;; H
  (assert (valid_root__function_guard (valid_root f_old v) f_old v))

;; H
  (assert (valid_root__function_guard (valid_root f v) f v))

;; H
  (assert (model____function_guard (model__ f root) f root))

;; H
  (assert (ordered_leafs__function_guard (ordered_leafs f_old root values)
  f_old root values))

;; H
  (assert (ordered_leafs__function_guard (ordered_leafs f_old v values) 
  f_old v values))

;; H
  (assert (model____function_guard (model__ f_old root) f_old root))
...
;; H
  (assert (model____function_guard (model__ f_old v) f_old v))
...
;; H
  (assert
  (forall ((i8 Int)) (is_concat__function_guard
  (is_concat
  (rec__tree_model__path_type__a
  (us_split_fields1 (select (model__ f root) v)))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select (model__ f_old v) i8)))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select (model__ f root) i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select (model__ f root) v)))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select (model__ f_old v) i8)))
...
;; H
  ...
  (and (= (valid_root f_old v) true)
  (and (not (= (valid_root f v) true))
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ f root) v))) true)
  (and (= (ordered_leafs f_old root values) true)
  (and (= (ordered_leafs f_old v values) true)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ f_old root) i8))) true)
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f_old root) i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f root) v)))) true))
  (ite (= (get
          (rec__tree_model__path_type__a
          ...
          (+ (length
             (rec__tree_model__path_type__a
             (us_split_fields1 (select (model__ f_old root) i8)))) 1)) 0)
  (forall ((j14 Int))
  (=> (and (<= 1 j14) (<= j14 100))
  (=>
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ f_old v) j14))) true)
  (< (to_rep (select values j14)) (to_rep (select values i8))))))
  (forall ((j14 Int))
  (=> (and (<= 1 j14) (<= j14 100))
  (=>
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ f_old v) j14))) true)
  (< (to_rep (select values i8)) (to_rep (select values j14))))))))))
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ f root) i8))) true)
  (ite (= (ole
          (rec__tree_model__path_type__a
          (us_split_fields1 (select (model__ f root) v)))
          (rec__tree_model__path_type__a
          (us_split_fields1 (select (model__ f root) i8)))) true)
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ f_old v) i8))) true)
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ f_old root) i8))) true)))))
  (and
  (forall ((i8 Int))
...
;; H
  (assert
  (forall ((i8 Int)) (parent__function_guard (parent f_old i8) f_old i8)))
...
;; H
  (assert
  (forall ((i8 Int)) (position__function_guard (position f_old i8) f_old i8)))
...
;; H
  (assert
  (forall ((i8 Int)) (is_add__function_guard
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2795 (parent f_old i8))))
  (position f_old i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2795 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2795 (parent f_old i8))))
  (position f_old i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2795 i8))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2796 (parent f_old i8))))
  (position f_old i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2796 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2796 (parent f_old i8))))
  (position f_old i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2796 i8))))))
...
;; H
  (assert (forall ((i8 Int)) (parent__function_guard (parent f i8) f i8)))
...
;; H
  (assert
  (forall ((i8 Int)) (position__function_guard (position f i8) f i8)))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2798 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2798 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2798 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2798 i8))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2797 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2797 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2797 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2797 i8))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2811 (parent f_old i8))))
  (position f_old i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2811 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2811 (parent f_old i8))))
  (position f_old i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2811 i8))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2812 (parent f_old i8))))
  (position f_old i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2812 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2812 (parent f_old i8))))
  (position f_old i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2812 i8))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2814 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2814 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2814 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2814 i8))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2813 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2813 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2813 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2813 i8))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2839 (parent f_old i8))))
  (position f_old i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2839 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2839 (parent f_old i8))))
  (position f_old i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2839 i8))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2840 (parent f_old i8))))
  (position f_old i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2840 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2840 (parent f_old i8))))
  (position f_old i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2840 i8))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2842 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2842 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2842 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2842 i8))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2841 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2841 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2841 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2841 i8))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2873 (parent f_old i8))))
  (position f_old i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2873 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2873 (parent f_old i8))))
  (position f_old i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2873 i8))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2874 (parent f_old i8))))
  (position f_old i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2874 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2874 (parent f_old i8))))
  (position f_old i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2874 i8))))))
...
;; H
  (assert (=> (and (<= 1 i2) (<= i2 100)) (= temp___2914 i2)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ f root) k))) true)
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ f root) j14))) true))
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f root) k)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f root) j14)))) true))
  (ite (= (get
          (rec__tree_model__path_type__a
          (us_split_fields1 (select (model__ f root) j14)))
          (+ (length
             (rec__tree_model__path_type__a
             (us_split_fields1 (select (model__ f root) k)))) 1)) 0)
  (< (to_rep (select values j14)) (to_rep (select values k)))
  (< (to_rep (select values k)) (to_rep (select values j14)))))))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (and (=> (<= 1 100) (in_range3 i3)) (and (<= 1 i3) (<= i3 100)))))
...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100)) (= temp___2881 j4))))
...
;; H
  ...
  (=> (and (<= 1 j4) (<= j4 100))
  (and
  (and (= temp___2795 (model__ f_old root)) (model____function_guard
  temp___2795 f_old root))
  (and (dynamic_invariant5 temp___2795 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2795 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2795 root)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 root))
  (ite (and (not (= (parent f_old i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2795 (parent f_old i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2795 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2795 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2795 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2795 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2795 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2795 j14)))) true))
  (= j14 i8))))))))))))))))
...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100)) (= o8 (select temp___2795 i3)))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100)) (= o9 (us_split_fields1 o8)))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (= result4 (rec__tree_model__path_type__k o9)))))
...
;; H
  ...
  (=> (= result4 true)
  (and
  (and (= temp___2796 (model__ f_old root)) (model____function_guard
  temp___2796 f_old root))
  (and (dynamic_invariant5 temp___2796 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2796 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2796 root)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 root))
  (ite (and (not (= (parent f_old i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2796 (parent f_old i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2796 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2796 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2796 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2796 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2796 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2796 j14)))) true))
  (= j14 i8)))))))))))))))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result4 true) (= o6 (select temp___2796 j4))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result4 true) (= o7 (us_split_fields1 o6))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result4 true) (= result3 (rec__tree_model__path_type__k o7))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (not (= result4 true)) (= result3 false)))))
...
;; H
  ...
  (=> (= result3 true)
  (and
  (and (= temp___2798 (model__ f root)) (model____function_guard temp___2798
  f root))
  (and (dynamic_invariant5 temp___2798 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2798 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2798 root)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 root))
  (ite (and (not (= (parent f i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2798 (parent f i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2798 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2798 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2798 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2798 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2798 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2798 j14)))) true))
  (= j14 i8)))))))))))))))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result3 true) (= o3 (select temp___2798 j4))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result3 true) (= o4 (us_split_fields1 o3))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result3 true) (= o5 (rec__tree_model__path_type__a o4))))))
...
;; H
  ...
  (=> (= result3 true)
  (and
  (and (= temp___2797 (model__ f root)) (model____function_guard temp___2797
  f root))
  (and (dynamic_invariant5 temp___2797 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2797 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2797 root)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 root))
  (ite (and (not (= (parent f i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2797 (parent f i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2797 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2797 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2797 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2797 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2797 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2797 j14)))) true))
  (= j14 i8)))))))))))))))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result3 true) (= o (select temp___2797 i3))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result3 true) (= o1 (us_split_fields1 o))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result3 true) (= o2 (rec__tree_model__path_type__a o1))))))
...
;; H
  ...
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result3 true)
  (and (= result2 (olt o2 o5))
  (= (= result2 true)
  (and (< (length o2) (length o5))
  (forall ((n Int))
  (=> (and (<= 1 n) (<= n (last o2))) (= (get o2 n) (get o5 n)))))))))))
...
;; H
  ...
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f_old root) i3)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f_old root) j4)))) true)))))
...
;; H
  ...
  (ite (= (get
          (rec__tree_model__path_type__a
          (us_split_fields1 (select (model__ f root) j4)))
          (+ (length
             (rec__tree_model__path_type__a
             (us_split_fields1 (select (model__ f root) i3)))) 1)) 0)
  (< (to_rep (select values j4)) (to_rep (select values i3)))
  (< (to_rep (select values i3)) (to_rep (select values j4))))))))
...
;; H
  ...
  (=> (and (<= 1 j4) (<= j4 100))
  (and
  (and (= temp___2811 (model__ f_old v)) (model____function_guard temp___2811
  f_old v))
  (and (dynamic_invariant5 temp___2811 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2811 v))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2811 v)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 v))
  (ite (and (not (= (parent f_old i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2811 (parent f_old i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2811 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2811 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2811 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2811 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2811 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2811 j14)))) true))
  (= j14 i8))))))))))))))))
...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100)) (= o18 (select temp___2811 i3)))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100)) (= o19 (us_split_fields1 o18)))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (= result7 (rec__tree_model__path_type__k o19)))))
...
;; H
  ...
  (=> (= result7 true)
  (and
  (and (= temp___2812 (model__ f_old v)) (model____function_guard temp___2812
  f_old v))
  (and (dynamic_invariant5 temp___2812 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2812 v))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2812 v)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 v))
  (ite (and (not (= (parent f_old i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2812 (parent f_old i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2812 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2812 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2812 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2812 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2812 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2812 j14)))) true))
  (= j14 i8)))))))))))))))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result7 true) (= o16 (select temp___2812 j4))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result7 true) (= o17 (us_split_fields1 o16))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result7 true) (= result6 (rec__tree_model__path_type__k o17))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (not (= result7 true)) (= result6 false)))))
...
;; H
  ...
  (=> (= result6 true)
  (and
  (and (= temp___2814 (model__ f root)) (model____function_guard temp___2814
  f root))
  (and (dynamic_invariant5 temp___2814 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2814 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2814 root)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 root))
  (ite (and (not (= (parent f i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2814 (parent f i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2814 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2814 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2814 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2814 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2814 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2814 j14)))) true))
  (= j14 i8)))))))))))))))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result6 true) (= o13 (select temp___2814 j4))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result6 true) (= o14 (us_split_fields1 o13))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result6 true) (= o15 (rec__tree_model__path_type__a o14))))))
...
;; H
  ...
  (=> (= result6 true)
  (and
  (and (= temp___2813 (model__ f root)) (model____function_guard temp___2813
  f root))
  (and (dynamic_invariant5 temp___2813 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2813 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2813 root)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 root))
  (ite (and (not (= (parent f i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2813 (parent f i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2813 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2813 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2813 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2813 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2813 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2813 j14)))) true))
  (= j14 i8)))))))))))))))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result6 true) (= o10 (select temp___2813 i3))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result6 true) (= o11 (us_split_fields1 o10))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result6 true) (= o12 (rec__tree_model__path_type__a o11))))))
...
;; H
  ...
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result6 true)
  (and (= result5 (olt o12 o15))
  (= (= result5 true)
  (and (< (length o12) (length o15))
  (forall ((n Int))
  (=> (and (<= 1 n) (<= n (last o12))) (= (get o12 n) (get o15 n)))))))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (not (= result6 true)) (= result5 false)))))
...
;; H
  ...
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f_old v) i3)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f_old v) j4)))) true)))))
...
;; H
  ...
  (= (get
     ...
     (+ (length
        (rec__tree_model__path_type__a
        (us_split_fields1 (select (model__ f root) i3)))) 1)) (get
                                                              (rec__tree_model__path_type__a
                                                              (us_split_fields1
                                                              (select 
                                                              (model__ 
...
;; H
  ...
  (=> (and (<= 1 j4) (<= j4 100))
  (and
  (and (= temp___2839 (model__ f_old root)) (model____function_guard
  temp___2839 f_old root))
  (and (dynamic_invariant5 temp___2839 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2839 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2839 root)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 root))
  (ite (and (not (= (parent f_old i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2839 (parent f_old i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2839 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2839 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2839 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2839 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2839 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2839 j14)))) true))
  (= j14 i8))))))))))))))))
...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100)) (= o28 (select temp___2839 i3)))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100)) (= o29 (us_split_fields1 o28)))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (= result10 (rec__tree_model__path_type__k o29)))))
...
;; H
  ...
  (=> (= result10 true)
  (and
  (and (= temp___2840 (model__ f_old v)) (model____function_guard temp___2840
  f_old v))
  (and (dynamic_invariant5 temp___2840 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2840 v))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2840 v)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 v))
  (ite (and (not (= (parent f_old i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2840 (parent f_old i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2840 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2840 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2840 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2840 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2840 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2840 j14)))) true))
  (= j14 i8)))))))))))))))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result10 true) (= o26 (select temp___2840 j4))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result10 true) (= o27 (us_split_fields1 o26))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result10 true) (= result9 (rec__tree_model__path_type__k o27))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (not (= result10 true)) (= result9 false)))))
...
;; H
  ...
  (=> (= result9 true)
  (and
  (and (= temp___2842 (model__ f root)) (model____function_guard temp___2842
  f root))
  (and (dynamic_invariant5 temp___2842 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2842 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2842 root)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 root))
  (ite (and (not (= (parent f i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2842 (parent f i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2842 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2842 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2842 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2842 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2842 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2842 j14)))) true))
  (= j14 i8)))))))))))))))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result9 true) (= o23 (select temp___2842 j4))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result9 true) (= o24 (us_split_fields1 o23))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result9 true) (= o25 (rec__tree_model__path_type__a o24))))))
...
;; H
  ...
  (=> (= result9 true)
  (and
  (and (= temp___2841 (model__ f root)) (model____function_guard temp___2841
  f root))
  (and (dynamic_invariant5 temp___2841 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2841 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2841 root)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 root))
  (ite (and (not (= (parent f i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2841 (parent f i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2841 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2841 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2841 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2841 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2841 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2841 j14)))) true))
  (= j14 i8)))))))))))))))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result9 true) (= o20 (select temp___2841 i3))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result9 true) (= o21 (us_split_fields1 o20))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result9 true) (= o22 (rec__tree_model__path_type__a o21))))))
...
;; H
  ...
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result9 true)
  (and (= result8 (olt o22 o25))
  (= (= result8 true)
  (and (< (length o22) (length o25))
  (forall ((n Int))
  (=> (and (<= 1 n) (<= n (last o22))) (= (get o22 n) (get o25 n)))))))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (not (= result9 true)) (= result8 false)))))
...
;; H
  ...
  (= (ole
     ...
     (us_split_fields1 (select (model__ f root) v)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f root) j4)))) true)))))
...
;; H
  ...
  (=> (and (<= 1 j4) (<= j4 100))
  (and
  (and (= temp___2873 (model__ f_old v)) (model____function_guard temp___2873
  f_old v))
  (and (dynamic_invariant5 temp___2873 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2873 v))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2873 v)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 v))
  (ite (and (not (= (parent f_old i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2873 (parent f_old i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2873 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2873 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2873 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2873 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2873 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2873 j14)))) true))
  (= j14 i8))))))))))))))))
...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100)) (= o32 (select temp___2873 i3)))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100)) (= o33 (us_split_fields1 o32)))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (= result12 (rec__tree_model__path_type__k o33)))))
...
;; H
  ...
  (=> (= result12 true)
  (and
  (and (= temp___2874 (model__ f_old root)) (model____function_guard
  temp___2874 f_old root))
  (and (dynamic_invariant5 temp___2874 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2874 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2874 root)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 root))
  (ite (and (not (= (parent f_old i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2874 (parent f_old i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2874 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2874 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2874 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2874 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2874 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2874 j14)))) true))
  (= j14 i8)))))))))))))))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result12 true) (= o30 (select temp___2874 j4))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result12 true) (= o31 (us_split_fields1 o30))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (= result12 true) (= result11 (rec__tree_model__path_type__k o31))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (=> (not (= result12 true)) (= result11 false)))))
...
;; H
  ...
  (ite (= (get
          ...
          (+ (length
             (rec__tree_model__path_type__a
             (us_split_fields1 (select (model__ f root) i3)))) 1)) 0)
  (< (to_rep (select values k)) (to_rep (select values i3)))
  (< (to_rep (select values i3)) (to_rep (select values k))))))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100))
  (and (=> (<= 1 100) (in_range3 j5)) (and (<= 1 j5) (<= j5 100))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100)) (= j5 100))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j4) (<= j4 100)) (= j6 (mk_int__ref j5)))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100)) (=> (and (<= 1 j4) (<= j4 100)) (= j7 j5))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100)) (=> (and (<= 1 j4) (<= j4 100)) (= j8 j6))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100)) (=> (and (<= 1 j4) (<= j4 100)) (= j9 j7))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (and (<= 1 j4) (<= j4 100))) (= j8 (mk_int__ref j4)))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (and (<= 1 j4) (<= j4 100))) (= j9 j4))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2961 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2961 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2961 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2961 i8))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2962 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2962 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2962 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2962 i8))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2964 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2964 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2964 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2964 i8))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2963 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2963 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2963 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2963 i8))))))
...
;; H
  (assert
  (and
  (and (= temp___2961 (model__ f root)) (model____function_guard temp___2961
  f root))
  (and (dynamic_invariant5 temp___2961 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2961 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2961 root)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 root))
  (ite (and (not (= (parent f i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2961 (parent f i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2961 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2961 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2961 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2961 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2961 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2961 j14)))) true))
  (= j14 i8))))))))))))))

;; H
  (assert (= o42 (select temp___2961 i1)))
...
;; H
  ...
  (=> (= result15 true)
  (and
  (and (= temp___2962 (model__ f root)) (model____function_guard temp___2962
  f root))
  (and (dynamic_invariant5 temp___2962 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2962 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2962 root)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 root))
  (ite (and (not (= (parent f i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2962 (parent f i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2962 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2962 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2962 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2962 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2962 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2962 j14)))) true))
  (= j14 i8)))))))))))))))

;; H
  (assert (=> (= result15 true) (= o40 (select temp___2962 j1))))

;; H
  (assert (=> (= result15 true) (= o41 (us_split_fields1 o40))))

;; H
  (assert
  (=> (= result15 true) (= result14 (rec__tree_model__path_type__k o41))))
...
;; H
  ...
  (=> (= result14 true)
  (and
  (and (= temp___2964 (model__ f root)) (model____function_guard temp___2964
  f root))
  (and (dynamic_invariant5 temp___2964 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2964 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2964 root)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 root))
  (ite (and (not (= (parent f i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2964 (parent f i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2964 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2964 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2964 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2964 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2964 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2964 j14)))) true))
  (= j14 i8)))))))))))))))

;; H
  (assert (=> (= result14 true) (= o37 (select temp___2964 j1))))

;; H
  (assert (=> (= result14 true) (= o38 (us_split_fields1 o37))))
...
;; H
  ...
  (=> (= result14 true)
  (and
  (and (= temp___2963 (model__ f root)) (model____function_guard temp___2963
  f root))
  (and (dynamic_invariant5 temp___2963 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2963 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2963 root)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 root))
  (ite (and (not (= (parent f i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2963 (parent f i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2963 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2963 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2963 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2963 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2963 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2963 j14)))) true))
  (= j14 i8)))))))))))))))

;; H
  (assert (=> (= result14 true) (= o34 (select temp___2963 i1))))
...
;; H
  (assert
  (=> (= result14 true)
  (and (= result13 (olt o36 o39))
  (= (= result13 true)
  (and (< (length o36) (length o39))
  (forall ((n Int))
  (=> (and (<= 1 n) (<= n (last o36))) (= (get o36 n) (get o39 n)))))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2960 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2960 i8))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2960 (parent f i8)))) (position f i8)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2960 i8))))))
...
;; H
  (assert
  (and
  (and (= temp___2960 (model__ f root)) (model____function_guard temp___2960
  f root))
  (and (dynamic_invariant5 temp___2960 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2960 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2960 root)))) 0)
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (= i8 root))
  (ite (and (not (= (parent f i8) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2960 (parent f i8)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2960 i8))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2960 i8))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2960 i8)))) 0))))
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2960 j14))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2960 i8)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2960 j14)))) true))
  (= j14 i8))))))))))))))

;; H
  (assert (= o44 (select temp___2960 i1)))
...
;; H
  (assert
  (and (= o47 (length o46)) (and (in_range4 o47) (<= (+ 0 o47) 2147483647))))
