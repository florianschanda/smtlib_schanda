...
(declare-fun p__my_maps__map__capacity__first__bit () Int)

(declare-fun p__my_maps__map__capacity__last__bit () Int)

(declare-fun p__my_maps__map__capacity__position () Int)
...
(declare-fun p__my_maps__map__modulus__first__bit () Int)

(declare-fun p__my_maps__map__modulus__last__bit () Int)

(declare-fun p__my_maps__map__modulus__position () Int)
...
(declare-fun p__my_maps__cursor__node__first__bit () Int)

(declare-fun p__my_maps__cursor__node__last__bit () Int)

(declare-fun p__my_maps__cursor__node__position () Int)
...
(define-fun dynamic_invariant2 ((temp___expr_337 Int)
...
;; length__post_axiom
  ...
  (! (let ((result (length container)))
     ...
     (dynamic_invariant5 result true false true))) :pattern ((length
                                                             container)) )))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant3 key2 true true true)
     ...
     (= (my_eq key2 (get1 container result)) true)))) (dynamic_invariant5
...
(define-fun default_initial_assumption2 ((temp___expr_379 us_rep2)
...
(declare-fun dummy11 () key_type2)

(declare-datatypes ()
((key_type__ref3 (mk_key_type__ref3 (key_type__content3 key_type2)))))
(define-fun key_type__ref_3__projection ((a key_type__ref3)) key_type2 
...
;; positions__post_axiom
  ...
  (! (let ((result (positions container)))
     ...
     (=> (= (get2 result i) (get2 result j)) (= (bool_eq5 i j) true))))))))) :pattern (
  (positions container)) )))
...
;; ole__post_axiom
  ...
  (! (= (= (ole left right) true)
     (forall ((key2 Int))
     (=> (and (in_range6 key2) (= (has_key1 left key2) true))
     (and (= (has_key1 right key2) true)
     (= (get right key2) (get left key2)))))) :pattern ((ole left right)) )))
...
;; oeq__post_axiom
  ...
  (! (= (= (oeq2 left right) true)
     ...
     (=> (and (in_range6 key2) (= (has_key1 left key2) true))
     (and (= (has_key1 right key2) true)
     (= (get right key2) (get left key2)))))
     (forall ((key2 Int))
     (=> (and (in_range6 key2) (= (has_key1 right key2) true))
...
;; is_empty__post_axiom
  ...
  (! (= (= (is_empty1 container) true)
     (forall ((key2 Int))
     (not (and (in_range6 key2) (= (has_key1 container key2) true))))) :pattern (
  (is_empty1 container)) )))
...
(define-fun dynamic_invariant8 ((temp___expr_419 Int)
...
(define-fun dynamic_invariant9 ((temp___expr_413 Int)
...
;; has_key__post_axiom
  ...
  (! (=> (= (of_int 0) true)
     (=>
     (exists ((k1 us_rep1))
     (and (= (has_key container k1) true) (= (bool_eq5 k1 key2) true)))
...
(declare-fun dummy15 () element_type4)
...
(define-fun dynamic_invariant10 ((temp___expr_441 Int)
...
;; keys_included_except__post_axiom
  ...
  (! (= (= (keys_included_except1 left right new_key) true)
     ...
     (=> (not (= (bool_eq5 key2 new_key) true))
...
;; H
  ...
  (= (length (mk___rep l__split_discrs l__split_fields6)) (- (length
                                                             ...
                                                             l__split_fields))) 1))
  (not
  (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields6)) k) true)))
  ...
  (= (keys_included_except
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (model__ (mk___rep l__split_discrs l__split_fields6)) k) true))
  ...
  (= (keys_included_except1
     ...
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (positions (mk___rep l__split_discrs l__split_fields6))
     (find (mk___rep l__split_discrs (mk___split_fields l__split_fields)) k)) true)))
...
;; H
  ...
  (= (length (mk___rep l__split_discrs l__split_fields5)) (+ (length
                                                             ...
                                                             l__split_discrs
                                                             l__split_fields6)) 1))
  (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields5)) k) true))
  (= (key (mk___rep l__split_discrs l__split_fields5)
     (find (mk___rep l__split_discrs l__split_fields5) k)) k))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields5)) k) e1))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields6))
...
;; WP_parameter_def
 ;; File "p.ads", line 21, characters 0-0
  (not
  (= (oeq (mk___rep l__split_discrs (mk___split_fields l__split_fields3))
     (mk___rep l__split_discrs (mk___split_fields l__split_fields))) true)))
(check-sat)
