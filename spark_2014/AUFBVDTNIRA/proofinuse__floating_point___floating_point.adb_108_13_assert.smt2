...
;; fliteral_axiom
  (assert
  (and (tqtisFinite1 fliteral4)
  (= (tqtreal1 fliteral4) 340282346638528859811704183484516925440.0)))

(declare-fun tmp () t1)

(declare-fun result () t1)
...
;; H
  (assert (=> (le1 (neg1 fliteral3) fliteral3) (tqtisFinite1 tmp)))
...
;; H
  (assert (= tmp1 (to_float64 RNE2 x)))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (le1 (neg1 fliteral4) tmp1)))
(check-sat)
