...
(declare-fun temp___339 () us_rep2)

(declare-fun temp___338 () us_rep2)
...
(declare-fun temp___353 () Int)

(declare-fun result8 () int__ref)

(declare-fun temp___3531 () Int)

(declare-fun result9 () Bool)

(declare-fun result10 () set__ref)

(declare-fun unseen10 () us_rep2)

(declare-fun result11 () sequence__ref)

(declare-fun avail3 () us_rep1)

(declare-fun result12 () int__ref)

(declare-fun r11 () Int)

(declare-fun avail4 () sequence__ref)

(declare-fun unseen11 () set__ref)

(declare-fun r12 () int__ref)

(declare-fun temp___3532 () int__ref)

(declare-fun avail5 () us_rep1)

(declare-fun unseen12 () us_rep2)

(declare-fun r13 () Int)

(declare-fun temp___3533 () Int)
...
;; H
  (assert (=> (and (<= 1 r2) (<= r2 10000)) (= temp___340 r2)))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 10000)) (= temp___339 unseen)))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 10000)) (= temp___338 alloc)))
...
;; H
  (assert
  (and
  (and (= o2 (contains1 avail r8)) (contains__function_guard1 o2 avail r8))
  (= (= o2 true)
  (exists ((i Int))
...
;; H
  (assert
  (forall ((e Int)) (contains__function_guard1 (contains1 avail2 e) avail2
  e)))
...
;; H
  (assert
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (length avail2))) (in_range3 (get avail2 j)))))
...
;; H
  (assert
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (- (length avail2) 1)))
  (= (to_rep
     (rec__list_mod_allocator__cell__next
     (us_split_fields1 (select data (get avail2 j))))) (get avail2 (+ j 1))))))

;; H
  (assert
  (forall ((j Int))
  (=> (and (<= 2 j) (<= j (length avail2)))
  (= (get avail2 j) (to_rep
                    (rec__list_mod_allocator__cell__next
                    (us_split_fields1 (select data (get avail2 (- j 1))))))))))

;; H
  (assert
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (length avail2)))
  (forall ((k Int))
...
;; H
  (assert (= result8 (mk_int__ref temp___353)))

;; H
  (assert (= temp___3531 (length avail2)))

;; H
  (assert
  (and
  (and (= o13 (contains1 avail2 r10)) (contains__function_guard1 o13 
  avail2 r10))
  (= (= o13 true)
  (exists ((i Int))
  (and (and (<= 1 i) (<= i (length avail2))) (= (get avail2 i) r10))))))
...
;; H
  (assert
  (and (= o16 (remove unseen9 r10))
  (and
  (and
  (and (= (length1 o16) (- (length1 unseen9) 1))
  (not (= (contains o16 r10) true))) (= (ole1 o16 unseen9) true))
  (= (included_except unseen9 o16 r10) true))))
...
;; H
  (assert
  (and (= o17 (add avail2 r10))
  (and (= (length o17) (+ (length avail2) 1))
  (and (= (get o17 (last o17)) r10) (= (ole avail2 o17) true)))))
...
;; H
  (assert (= temp___3532 (mk_int__ref temp___3531)))
...
;; H
  (assert (= temp___3533 temp___3531))
...
;; WP_parameter_def
 ;; File "list_mod_allocator.ads", line 36, characters 0-0
  (not (in_range3 (get (sequence__content avail4) j))))
(check-sat)
