...
;; H
  (assert
  (and (<= (to_rep1 (first (rt a))) temp___736)
  (<= temp___736 (to_rep1 (last (rt a))))))

;; H
  (assert (= o2 temp___736))
...
;; H
  (assert (and (= temp___737 (+ j 1)) (in_range1 (+ j 1))))

(assert
;; WP_parameter_def
 ;; File "perm.ads", line 2, characters 0-0
  (not (<= (to_rep1 (first (rt b))) temp___737)))
(check-sat)
