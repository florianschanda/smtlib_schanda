...
(declare-fun temp___1248 () (Array Int byte))

(declare-fun temp___12481 () t3)
...
;; H
  ...
  (ite (and (<= 0 temp___1246) (<= temp___1246 r196s))
  (= (select o9 temp___1246) (select (slide
                                     ...
                                     keccak__padding__pad101_single_block__block__compl1)))))
                                     0) temp___1246))
  (= (select o9 temp___1246) (select block2 temp___1246)))))
...
;; H
  (assert (= o10 ctx__split_fields))

;; H
  (assert
  (= o10 keccak__keccak_1600__keccakf_1600_lanes__xor_bits_into_state__a))
...
;; H
  ...
  (= o14 (rate_of
         (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))))
  (rate_of__function_guard o14
  (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))))
  (and (in_range5 o14) (= o14 (to_rep3 ctx__split_fields1)))))

;; H
  (assert
  (=> (<= 0 r199s)
  (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r199s) (<= r199s 199)))))

;; H
  (assert (= o11 block3))

;; H
  (assert (= o11 temp___1248))

;; H
  (assert (= (mk3 0 r199s) temp___12481))

;; H
  (assert (= temp___1248 o12))

;; H
  (assert
  (= (mk (to_rep (first6 temp___12481)) (to_rep (last9 temp___12481))) 
  o13))
...
;; H
  (assert (= o15 ctx__split_fields2))

;; H
  (assert (= o15 keccak__keccak_1600__keccakf_1600_permutation__permute__a))
