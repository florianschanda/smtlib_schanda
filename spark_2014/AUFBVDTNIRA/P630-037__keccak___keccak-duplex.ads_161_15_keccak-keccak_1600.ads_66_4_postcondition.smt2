...
(declare-fun temp___1114 () (Array Int byte))

(declare-fun temp___11141 () t3)
...
;; H
  ...
  (= o12 (rate_of
         (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))))
  (and (in_range3 o12) (= o12 (to_rep3 ctx__split_fields1)))))
...
;; H
  (assert (= o9 temp___1114))

;; H
  (assert (= (mk3 0 r199s) temp___11141))

;; H
  (assert (= temp___1114 o10))

;; H
  (assert
  (= (mk (to_rep (first6 temp___11141)) (to_rep (last6 temp___11141))) 
  o11))
