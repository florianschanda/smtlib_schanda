...
(declare-fun value8 () (Array Int character))

(declare-fun last9 () Int)

(declare-fun i7 () Int)

(declare-fun value9 () (Array Int character))
...
;; H
  (assert
  (=> (and (<= position i1) (<= i1 temp___571)) (= i9 (mk_int__ref i3))))

;; H
  (assert
  (=> (and (<= position i1) (<= i1 temp___571))
  (= value10 (mk_map__ref value4))))
...
;; H
  (assert
  (and
  (and (= o16 (length_with_padding o15)) (length_with_padding__function_guard
  o16 o15))
  (and (in_range6 o16)
...
;; H
  (assert (= (mk_int__ref result3) (mk_int__ref last7)))
...
;; WP_parameter_def
 ;; File "cubedos-lib-xdr.ads", line 261, characters 0-0
  ...
  (= last9 (+ position (- (length_with_padding
                          (ite (<= (to_rep1 value__first) (to_rep1
                                                          value__last))
                          (+ (- (to_rep1 value__last) (to_rep1 value__first)) 1)
                          0)) 1)))))
(check-sat)
