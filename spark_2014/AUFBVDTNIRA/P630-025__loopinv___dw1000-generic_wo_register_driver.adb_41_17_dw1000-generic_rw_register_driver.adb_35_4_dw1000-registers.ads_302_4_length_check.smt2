...
(define-fun dynamic_invariant ((temp___expr_3515 us_t1)
  ...
  (temp___do_toplevel_3514 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_3515))
                                       (and (= (first3 temp___expr_3515) 1)
                                       (= (last4 temp___expr_3515) 4)))))
...
(define-fun dynamic_invariant1 ((temp___expr_3531 us_t2)
  ...
  (temp___do_toplevel_3530 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_3531))
                                       (and (= (first5 temp___expr_3531) 1)
                                       (= (last6 temp___expr_3531) 4)))))
...
;; H
  (assert
  (and
  (and (= temp___76902 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___76902 reg)) (dynamic_invariant1
  temp___76902 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___76901)) (to_rep (last5 temp___76901)))
     (+ (- (to_rep (last5 temp___76901)) (to_rep (first4 temp___76901))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76901)) (to_rep (last5 temp___76901))) 
  temp___76911))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___76911)) (to_rep (last3 temp___76911)))
     (+ (- (to_rep (last3 temp___76911)) (to_rep (first2 temp___76911))) 1)
