...
(declare-fun r52b () (Array Int natural))

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS3 () Int)

(declare-fun for_loop_iterable__p5__a__aggregate_def (Int) (Array Int natural))
...
(declare-fun c25b1 () Int)

(declare-fun a2 () (Array Int natural))

(declare-fun c25b2 () Int)
...
;; H
  (assert
  (= (for_loop_iterable__p5__L_5__R54b__aggregate_def (to_rep (select a2 1))) 
  r54b))
...
;; WP_parameter_def
 ;; File "for_loop_iterable.adb", line 37, characters 0-0
  (not (= (to_rep (select r54b c25b2)) 1)))
(check-sat)
