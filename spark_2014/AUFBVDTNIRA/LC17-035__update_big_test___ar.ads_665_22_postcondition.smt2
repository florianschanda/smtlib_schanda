...
(define-fun bool_eq7 ((a (Array Int (Array Int (Array Int (Array Int et1)))))
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq6 (select a temp___idx_135) 1 16
...
(declare-fun temp___2565 ((Array Int (Array Int (Array Int (Array Int et1))))
  Int
  (Array Int (Array Int (Array Int et1)))) (Array Int (Array Int (Array Int (Array Int et1)))))

;; def_axiom
  (assert
  (forall ((temp___2567 (Array Int (Array Int (Array Int (Array Int et1))))))
  (forall ((temp___2568 Int))
  (forall ((temp___2569 (Array Int (Array Int (Array Int et1)))))
  (let ((temp___2566 (temp___2565 temp___2567 temp___2568 temp___2569)))
  (forall ((temp___2570 Int))
  (ite (= temp___2570 temp___2568)
  (= (select temp___2566 temp___2570) temp___2569)
  (= (select temp___2566 temp___2570) (select temp___2567 temp___2570)))))))))

(declare-fun temp___2571 ((Array Int (Array Int (Array Int et1))) Int
  (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))

;; def_axiom
  (assert
  (forall ((temp___2573 (Array Int (Array Int (Array Int et1)))))
  (forall ((temp___2574 Int))
  (forall ((temp___2575 (Array Int (Array Int et1))))
  (let ((temp___2572 (temp___2571 temp___2573 temp___2574 temp___2575)))
  (forall ((temp___2576 Int))
  (ite (= temp___2576 temp___2574)
  (= (select temp___2572 temp___2576) temp___2575)
  (= (select temp___2572 temp___2576) (select temp___2573 temp___2576)))))))))

(declare-fun temp___2577 ((Array Int (Array Int et1)) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___2579 (Array Int (Array Int et1))))
  (forall ((temp___2580 Int))
  (forall ((temp___2581 (Array Int et1)))
  (let ((temp___2578 (temp___2577 temp___2579 temp___2580 temp___2581)))
  (forall ((temp___2582 Int))
  (ite (= temp___2582 temp___2580)
  (= (select temp___2578 temp___2582) temp___2581)
  (= (select temp___2578 temp___2582) (select temp___2579 temp___2582)))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 657, characters 0-0
  (not
  (= (bool_eq7 a4 90 99
     (temp___2565 a i (temp___2571 b j (temp___2577 c k d))) 90 99) true)))
(check-sat)
