...
;; H
  (assert (to_model__function_guard (to_model (mk___rep r__split_fields3))
  (mk___rep r__split_fields3)))

;; H
  (assert
  (= (let ((temp___224 (to_model (mk___rep r__split_fields3))))
     (bool_eq3 (elts temp___224) (to_rep (first (rt temp___224)))
     (to_rep (last (rt temp___224))) (temp___220 0) ((_ int2bv 16) 1)
     ((_ int2bv 16) 0))) true))

;; H
  (assert (is_full__function_guard (is_full (mk___rep r__split_fields3))
  (mk___rep r__split_fields3)))
