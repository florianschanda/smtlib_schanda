...
(declare-fun cur_exp2 () (_ BitVec 32))

(declare-fun cur_val2 () (_ BitVec 32))

(declare-fun result__2 () (_ BitVec 32))

(declare-fun iter2 () Int)
...
(declare-fun cur_exp3 () (_ BitVec 32))

(declare-fun result6 () (_ BitVec 32))

(declare-fun cur_val3 () (_ BitVec 32))

(declare-fun result7 () Int)

(declare-fun iter3 () Int)
...
;; H
  (assert (and (= o (+ iter2 1)) (in_range2 (+ iter2 1))))
...
;; WP_parameter_def
 ;; File "interfac.ads", line 74, characters 0-0
  (not
  (= result__3 (power val__
               (bv2nat (bvurem ((_ int2bv 32) exp) (pow21 iter3)))))))
(check-sat)
