...
;; H
  ...
  (convert_character_digit_to_integer o2) o2))
...
;; H
  ...
  (and
  (and
  (and (and (<= 0 target1) (<= target1 9))
  (= target1 (convert_character_digit_to_integer o2)))
  (ite (= (= o2 48) true) (= target1 0)
  (ite (= (= o2 49) true) (= target1 1)
  (ite (= (= o2 50) true) (= target1 2)
  (ite (= (= o2 51) true) (= target1 3)
  (ite (= (= o2 52) true) (= target1 4)
  (ite (= (= o2 53) true) (= target1 5)
  (ite (= (= o2 54) true) (= target1 6)
  (ite (= (= o2 55) true) (= target1 7)
  (ite (= (= o2 56) true) (= target1 8)
  (=> (= (= o2 57) true) (= target1 9)))))))))))) (in_range1 target1)))

;; H
  (assert (<= target1 9))

;; H
  (assert (= (mk_bool__ref result) (mk_bool__ref has_failed)))
...
(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 1067, characters 0-0
