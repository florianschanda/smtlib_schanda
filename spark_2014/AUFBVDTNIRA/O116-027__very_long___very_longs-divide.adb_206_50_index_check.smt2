...
(declare-fun temp___1315 () us_rep1)
...
(declare-fun temp___1313 () us_rep1)
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b))
  (= temp___1318 carry1)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b))
  (= temp___1315 (mk___rep1 u__split_discrs
                 (mk___split_fields1
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= sum3 o26)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b))
  (= temp___1313 (mk___rep1 u__split_discrs o33))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b))
  (= u__split_fields4 (us_split_fields3 temp___1313))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b))
  (= u__split_discrs (us_split_discrs2 temp___1313))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= carry3 o34)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b))
  (= divisor_index2 r129b)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= sum5 sum3)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= sum6 sum4)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= sum7 sum5)))
...
;; H
  (assert
  (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r129b)))
