...
(declare-fun temp___2166 () (Array Int us_rep1))
...
;; H
  (assert
  (= (mk___rep1 (mk___split_fields1 o6 o7 o8 o9)) (select f__split_fields1 
  o5)))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2166 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2166 (parent
                      (mk___rep2
...
;; H
  ...
  (model____function_guard temp___2166
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  root))
  (and (dynamic_invariant3 temp___2166 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2166 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2166 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2166 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2166 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2166 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2166 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2166 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2166 j1)))) true))
  (= j1 i))))))))))))))
...
;; H
  (assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___2166 o)))
