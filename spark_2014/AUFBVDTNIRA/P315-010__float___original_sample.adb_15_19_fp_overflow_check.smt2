...
;; H
  ...
  (mul RNE2 (mul RNE2 fliteral4 (of_int RNE2 (+ nb_of_fp nb_of_pp)))
  delta_time) time)) (lt time
  (sub RNE2 fliteral1
  (mul RNE2 (of_int RNE2 (+ nb_of_fp nb_of_pp)) delta_time)))))
...
;; WP_parameter_def
 ;; File "original_sample.ads", line 15, characters 0-0
  (not (tqtisFinite (sub RNE2 time (div1 RNE2 d1 fliteral5)))))
(check-sat)
