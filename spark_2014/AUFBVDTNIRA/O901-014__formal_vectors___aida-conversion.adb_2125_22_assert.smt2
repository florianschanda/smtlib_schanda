...
;; H
  (assert
  (and (= temp___2697 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2697)
  (<= temp___2697 (to_rep1 n__last))))

;; H
  (assert (= o35 temp___2697))
