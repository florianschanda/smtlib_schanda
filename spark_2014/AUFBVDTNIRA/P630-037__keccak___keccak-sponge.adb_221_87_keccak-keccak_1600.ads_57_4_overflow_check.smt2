...
(declare-fun temp___975 () (Array Int byte))

(declare-fun temp___9751 () t1)
...
(define-fun ctx__split_fields19 () us_split_fields (mk___split_fields
                                                   ctx__split_fields12
                                                   ctx__split_fields13
                                                   ctx__split_fields14
                                                   ctx__split_fields15
...
;; H
  (assert (state_of__function_guard (state_of (mk___rep ctx__split_fields19))
  (mk___rep ctx__split_fields19)))

;; H
  (assert (rate_of__function_guard (rate_of (mk___rep ctx__split_fields19))
  (mk___rep ctx__split_fields19)))
...
;; H
  (assert (in_queue_bit_length__function_guard
  (in_queue_bit_length (mk___rep ctx__split_fields19))
  (mk___rep ctx__split_fields19)))
...
;; H
  (assert
  (=> (< 1 message_byte_length1)
  (< (to_rep1 (first (rt message))) message_last1)))
...
;; H
  (assert
  (=> (< 1 message_byte_length1)
  (and (= o15 (- bit_length (mod2 bit_length 8))) (in_range1
  (- bit_length (mod2 bit_length 8))))))

;; H
  (assert (=> (< 1 message_byte_length1) (and (= o16 o15) (in_range2 o15))))

;; H
  (assert
  (=> (< 1 message_byte_length1)
  (=> (<= (to_rep1 (first (rt message))) r105s)
  (and
  (and (<= (to_rep1 (first (rt message))) (to_rep1 (first (rt message))))
  (<= (to_rep1 (first (rt message))) (to_rep1 (last (rt message)))))
  (and (<= (to_rep1 (first (rt message))) r105s)
  (<= r105s (to_rep1 (last (rt message)))))))))

;; H
  (assert (=> (< 1 message_byte_length1) (= o12 (elts message))))

;; H
  (assert (=> (< 1 message_byte_length1) (= o12 temp___975)))

;; H
  (assert
  (=> (< 1 message_byte_length1)
  (= (mk1 (to_rep1 (first (rt message))) r105s) temp___9751)))

;; H
  (assert (=> (< 1 message_byte_length1) (= temp___975 o13)))

;; H
  (assert
  (=> (< 1 message_byte_length1)
  (= (mk (to_rep1 (first3 temp___9751)) (to_rep1 (last3 temp___9751))) 
  o14)))
...
;; H
  ...
  (and
  (and
  (and (= (state_of (mk___rep ctx__split_fields19)) 0)
  (= (rate_of (mk___rep ctx__split_fields19)) (rate_of
                                              (mk___rep
                                              (mk___split_fields
                                              ctx__split_fields
                                              ctx__split_fields1
                                              ...
                                              ctx__split_fields4
                                              ctx__split_fields5)))))
  (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields19)) 8) (mod2 
                                                                   o16 8)))
  (< (in_queue_bit_length (mk___rep ctx__split_fields19)) (rate_of
                                                          (mk___rep
                                                          ctx__split_fields19))))))

;; H
  (assert
  (=> (not (< 1 message_byte_length1))
  (= ctx__split_fields ctx__split_fields12)))

;; H
  (assert
  (=> (not (< 1 message_byte_length1))
  (= ctx__split_fields1 ctx__split_fields13)))

;; H
  (assert
  (=> (not (< 1 message_byte_length1))
  (= ctx__split_fields2 ctx__split_fields14)))

;; H
  (assert
  (=> (not (< 1 message_byte_length1))
  (= ctx__split_fields3 ctx__split_fields15)))

;; H
  (assert
  (=> (not (< 1 message_byte_length1))
  (= ctx__split_fields4 ctx__split_fields16)))

;; H
  (assert
  (=> (not (< 1 message_byte_length1))
  (= ctx__split_fields5 ctx__split_fields17)))

;; H
  (assert
  (=> (not (< 1 message_byte_length1))
  (= ctx__split_fields19 (mk___split_fields ctx__split_fields6
...
;; H
  (assert
  (=> (< (mod2 bit_length 8) 8)
  (= o22 (bvshl suffix ((_ int2bv 8) (mod2 bit_length 8))))))

;; H
  (assert (=> (not (< (mod2 bit_length 8) 8)) (= o22 ((_ int2bv 8) 0))))

;; H
  (assert
  (=> (< (mod2 bit_length 8) 256)
  (= o19 (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (mod2 bit_length 8))))))

;; H
  (assert (=> (not (< (mod2 bit_length 8) 256)) (= o19 ((_ int2bv 8) 0))))

;; H
  (assert (= o20 (bvsub o19 ((_ int2bv 8) 1))))
...
;; H
  (assert (= o17 message_last1))

;; H
  (assert (= o18 (select (elts message) o17)))

;; H
  (assert (= o21 (to_rep o18)))

;; H
  (assert (= o23 (bvand o21 o20)))

;; H
  (assert (= o24 (bvor o23 o22)))

;; H
  (assert (= (to_rep o25) o24))

;; H
  (assert (= o26 (store suffix_array1 0 o25)))

;; H
  (assert (= result5 (mk_map__ref suffix_array1)))

;; H
  (assert (= suffix_array2 o26))

;; H
  (assert (< 0 (+ (mod2 bit_length 8) suffix_len)))

;; H
  (assert (state_of__function_guard (state_of (mk___rep ctx__split_fields18))
  (mk___rep ctx__split_fields18)))

;; H
  (assert (rate_of__function_guard (rate_of (mk___rep ctx__split_fields18))
  (mk___rep ctx__split_fields18)))
...
;; H
  (assert (in_queue_bit_length__function_guard
  (in_queue_bit_length (mk___rep ctx__split_fields18))
  (mk___rep ctx__split_fields18)))
...
;; H
  (assert
  (and (= o27 (+ (mod2 bit_length 8) suffix_len)) (in_range1
  (+ (mod2 bit_length 8) suffix_len))))
...
;; H
  ...
  (and
  (and
  (and (= (state_of (mk___rep ctx__split_fields18)) 0)
  (= (rate_of (mk___rep ctx__split_fields18)) (rate_of
                                              (mk___rep ctx__split_fields19))))
  (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields18)) 8) (mod2 
                                                                   o27 8)))
  (< (in_queue_bit_length (mk___rep ctx__split_fields18)) (rate_of
                                                          (mk___rep
                                                          ctx__split_fields18)))))
...
;; H
  (assert
  (and
  (and (= o31 (rate_of (mk___rep ctx__split_fields18)))
  (rate_of__function_guard o31 (mk___rep ctx__split_fields18)))
  (and (in_range3 o31)
  (and
  (= o31 (* (to_rep6
            (rec__keccak__keccak_1600__sponge__context__rate
            ctx__split_fields18)) 8))
  (< o31 1600)))))

;; H
  (assert (= o32 (ite (= o31 initial_rate1) true false)))

;; H
  (assert
  (and
  (and (= o28 (rate_of (mk___rep ctx__split_fields18)))
  (rate_of__function_guard o28 (mk___rep ctx__split_fields18)))
  (and (in_range3 o28)
  (and
  (= o28 (* (to_rep6
            (rec__keccak__keccak_1600__sponge__context__rate
...
;; H
  (assert
  (and
  (and (= o29 (in_queue_bit_length (mk___rep ctx__split_fields18)))
  (in_queue_bit_length__function_guard o29 (mk___rep ctx__split_fields18)))
  (and (in_range2 o29)
  (and
  (= o29 (to_rep5
         (rec__keccak__keccak_1600__sponge__context__bits_absorbed
...
;; H
  (assert (= o30 (ite (< o29 o28) true false)))

(assert
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not (in_range1 (+ bit_length suffix_len))))
(check-sat)
