...
;; range_axiom
  (assert
  (forall ((x tcount_typeB)) (! (in_range1
...
(declare-datatypes ()
((t28b__ref (mk_t28b__ref (t28b__content tcount_typeB)))))
(define-fun t28b__ref___projection ((a t28b__ref)) tcount_typeB (t28b__content
                                                                a))
...
(declare-fun lgth () Int)

(declare-fun i () Int)

(declare-fun use_lists__double_size__cu__assume () count_type)
...
(define-fun use_lists__double_size__cu__assume1 () us_rep1 (mk___rep1
                                                           (mk___split_fields1
                                                           use_lists__double_size__cu__assume)))
...
;; H
  (assert
  (and
  (= use_lists__double_size__cu__assume1 (first
  ...
  (= (bool_eq3 use_lists__double_size__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     use_lists__double_size__cu__assume1) true)
  (= (get1
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     use_lists__double_size__cu__assume1) 1)))))
...
;; H
  ...
  (= o (length
       (mk___rep l__split_discrs (mk___split_fields l__split_fields))))
  (and (in_range2 o)
  (<= o (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
...
;; H
  ...
  (<= i4 (length
         (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) i4) (get
                                                                    (model__
                                                                    (mk___rep
                                                                    l__split_discrs
                                                                    (mk___split_fields
...
;; H
  ...
  (= (get (model__ (mk___rep l__split_discrs l__split_fields3))
     (+ j (length
          (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) 
  (get
  (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) j)))))

;; H
  (assert
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields3))
     (mk___rep1 cu__split_fields4)) i2))

;; H
  (assert
  (and (=> (<= 1 r27b) (dynamic_property 1 r27b i2))
  (and (<= 1 i2) (<= i2 r27b))))

;; H
  (assert
  (and
  (= o1 (element (mk___rep l__split_discrs l__split_fields3)
        (mk___rep1 cu__split_fields4)))
  (and (in_range6 o1)
  (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields3))
        (get1 (positions (mk___rep l__split_discrs l__split_fields3))
        (mk___rep1 cu__split_fields4)))))))
...
;; H
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields2))
     (last1 (mk___rep l__split_discrs l__split_fields2))) (length
                                                          (mk___rep
                                                          l__split_discrs
                                                          l__split_fields2))))
  ...
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2))
     (length (mk___rep l__split_discrs l__split_fields2))) o1))
...
;; H
  ...
  (= (bool_eq3 (mk___rep1 cu__split_fields3) no_element) true)
  (and
...
(assert
;; WP_parameter_def
 ;; File "use_lists.ads", line 42, characters 0-0
  (not
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i4) (get
                                                                    (model__
                                                                    (mk___rep
                                                                    l__split_discrs
                                                                    (mk___split_fields
