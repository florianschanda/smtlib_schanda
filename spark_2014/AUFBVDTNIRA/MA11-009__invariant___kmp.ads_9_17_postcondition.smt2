...
(declare-fun temp___167 () (Array Int integer))
...
(declare-fun next5 () map__ref)

(declare-fun i5 () int__ref)

(declare-fun j6 () int__ref)

(declare-fun r8b4 () int__ref)

(declare-fun r9b4 () int__ref)

(declare-fun r12b4 () int__ref)

(declare-fun next6 () (Array Int integer))

(declare-fun i6 () Int)

(declare-fun j7 () Int)

(declare-fun r8b5 () Int)

(declare-fun r9b5 () Int)

(declare-fun r12b5 () Int)

(declare-fun next7 () map__ref)

(declare-fun i7 () int__ref)

(declare-fun j8 () int__ref)

(declare-fun r8b6 () int__ref)

(declare-fun r9b6 () int__ref)

(declare-fun r12b6 () int__ref)

(declare-fun next8 () (Array Int integer))

(declare-fun i8 () Int)

(declare-fun j9 () Int)

(declare-fun r8b7 () Int)

(declare-fun r9b7 () Int)

(declare-fun r12b7 () Int)

(declare-fun next9 () map__ref)

(declare-fun i9 () int__ref)

(declare-fun j10 () int__ref)

(declare-fun r8b8 () int__ref)

(declare-fun r9b8 () int__ref)

(declare-fun r12b8 () int__ref)

(declare-fun next10 () (Array Int integer))

(declare-fun i10 () Int)

(declare-fun j11 () Int)

(declare-fun r8b9 () Int)

(declare-fun r9b9 () Int)

(declare-fun r12b9 () Int)

(declare-fun result15 () a__ref)

(declare-fun kmp__init_next__result2 () us_t)

(declare-fun kmp__init_next__result3 () a__ref)

(declare-fun kmp__init_next__result4 () us_t)

(declare-fun next11 () map__ref)

(declare-fun i11 () int__ref)

(declare-fun j12 () int__ref)

(declare-fun r8b10 () int__ref)

(declare-fun r9b10 () int__ref)

(declare-fun r12b10 () int__ref)

(declare-fun kmp__init_next__result5 () a__ref)

(declare-fun next12 () (Array Int integer))

(declare-fun i12 () Int)

(declare-fun j13 () Int)

(declare-fun r8b11 () Int)

(declare-fun r9b11 () Int)

(declare-fun r12b11 () Int)

(declare-fun kmp__init_next__result6 () us_t)
...
(declare-fun result16 () (Array Int integer))

(declare-fun result17 () t)
...
;; H
  (assert
  (=> (< 1 (length p))
  (= result3 (ite (<= (to_rep (first (rt p))) i1) o2 false))))
...
;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (and (= o3 (- i1 j2)) (in_range1 (- i1 j2))))))

;; H
  (assert
  (=> (< 1 (length p)) (=> (= result3 true) (= (mk_int__ref result4) r8b12))))
...
;; H
  (assert
  (=> (< 1 (length p)) (=> (= result3 true) (= (mk_int__ref result5) r9b12))))
...
;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (and (= o4 (- j2 1)) (in_range1 (- j2 1))))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (= (mk_int__ref result6) r12b12))))
...
;; H
  ...
  (=> (< 1 (length p))
  (=> (= result3 true)
  (and (and (<= (to_rep (first (rt p))) j3) (<= j3 (to_rep (last (rt p)))))
  (< i2 j3)))))
...
;; H
  ...
  (=> (<= (- 2147483648) 2147483647) (in_range1 j3))))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true)
  (and (<= (to_rep (first (rt p))) j3) (<= j3 (to_rep (last (rt p))))))))
...
;; H
  (assert
  (=> (< 1 (length p)) (=> (= result3 true) (= o8 (select (elts p) o7)))))
...
;; H
  (assert
  (=> (< 1 (length p)) (=> (= result3 true) (= o6 (select (elts p) o5)))))
...
;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (= result7 (ite (= o10 o9) true false)))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true)
  (=> (= result7 true) (and (= o11 (+ i2 1)) (in_range1 (+ i2 1)))))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (=> (= result7 true) (= i2 result8)))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (=> (= result7 true) (= i3 o11)))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true)
  (=> (= result7 true) (and (= o12 (+ j3 1)) (in_range1 (+ j3 1)))))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (=> (= result7 true) (= j3 result9)))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (=> (= result7 true) (= j4 o12)))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (=> (= result7 true) (= (to_rep o13) j4)))))
...
;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (=> (= result7 true) (= o14 i3)))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (=> (= result7 true) (= o15 (store next2 o14 o13))))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (=> (= result7 true) (= next2 result10)))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (=> (= result7 true) (= next3 o15)))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result7 true))
  (=> (= j3 (to_rep (first (rt p)))) (= i2 result11))))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true)
  (=> (not (= result7 true)) (=> (= j3 (to_rep (first (rt p)))) (= i4 o16))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result7 true))
  (=> (= j3 (to_rep (first (rt p)))) (= (to_rep o17) 0))))))
...
;; H
  ...
  (=> (< 1 (length p))
  (=> (= result3 true)
  (=> (not (= result7 true)) (=> (= j3 (to_rep (first (rt p)))) (= o18 i4))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result7 true))
  (=> (= j3 (to_rep (first (rt p)))) (= o19 (store next2 o18 o17)))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result7 true))
  (=> (= j3 (to_rep (first (rt p)))) (= result12 (mk_map__ref next2)))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result7 true))
  (=> (= j3 (to_rep (first (rt p)))) (= next4 o19))))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true)
  (=> (not (= result7 true)) (=> (= j3 (to_rep (first (rt p)))) (= j5 j3))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result7 true))
  (=> (not (= j3 (to_rep (first (rt p)))))
  (and (<= (to_rep next__first) j3) (<= j3 (to_rep next__last))))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result7 true))
  (=> (not (= j3 (to_rep (first (rt p))))) (= o20 j3))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result7 true))
  (=> (not (= j3 (to_rep (first (rt p))))) (= o21 (select next2 o20)))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result7 true))
  (=> (not (= j3 (to_rep (first (rt p))))) (= o22 (to_rep o21)))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result7 true))
  (=> (not (= j3 (to_rep (first (rt p))))) (= result13 (mk_int__ref j3)))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result7 true))
  (=> (not (= j3 (to_rep (first (rt p))))) (= j5 o22))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result7 true))
  (=> (not (= j3 (to_rep (first (rt p))))) (= i4 i2))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result7 true))
  (=> (not (= j3 (to_rep (first (rt p))))) (= next4 next2))))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (=> (not (= result7 true)) (= j4 j5)))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (=> (not (= result7 true)) (= i3 i4)))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (=> (not (= result7 true)) (= next3 next4)))))
...
;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (= o24 (ite (<= i3 o23) true false)))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true)
  (= o25 (ite (<= (to_rep (first (rt p))) i3) o24 false)))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (= result3 true) (= result14 (ite (not (= o25 true)) true false)))))
...
;; H
  (assert
  (=> (< 1 (length p)) (=> (= result3 true) (= r12b4 (mk_int__ref r12b3)))))

;; H
  (assert
  (=> (< 1 (length p)) (=> (= result3 true) (= r9b4 (mk_int__ref r9b3)))))

;; H
  (assert
  (=> (< 1 (length p)) (=> (= result3 true) (= r8b4 (mk_int__ref r8b3)))))

;; H
  (assert
  (=> (< 1 (length p)) (=> (= result3 true) (= j6 (mk_int__ref j4)))))

;; H
  (assert
  (=> (< 1 (length p)) (=> (= result3 true) (= i5 (mk_int__ref i3)))))

;; H
  (assert
  (=> (< 1 (length p)) (=> (= result3 true) (= next5 (mk_map__ref next3)))))
...
;; H
  (assert
  (=> (< 1 (length p)) (=> (not (= result3 true)) (= j8 (mk_int__ref j2)))))

;; H
  (assert
  (=> (< 1 (length p)) (=> (not (= result3 true)) (= i7 (mk_int__ref i1)))))

;; H
  (assert
  (=> (< 1 (length p))
  (=> (not (= result3 true)) (= next7 (mk_map__ref next1)))))
...
;; H
  (assert
  (= result15 (mk_a__ref
              (mk___t kmp__init_next__result kmp__init_next__result1))))

;; H
  (assert
  (= kmp__init_next__result2 (mk___t (map__content next9)
                             (mk (to_rep next__first) (to_rep next__last)))))
...
;; H
  (assert
  (= (mk___t result16 result17) (a__content kmp__init_next__result5)))

(assert
;; WP_parameter_def
 ;; File "kmp.ads", line 5, characters 0-0
  (not (= (length (a__content kmp__init_next__result5)) (length p))))
(check-sat)
