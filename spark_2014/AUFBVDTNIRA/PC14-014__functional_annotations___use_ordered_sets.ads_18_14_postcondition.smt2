...
(declare-fun temp___696 () count_type)

(declare-fun o2 () Int)

(declare-fun temp___695 () count_type)

(declare-fun o3 () Bool)

(declare-fun use_ordered_sets__my_find__result1 () count_type)
...
(declare-fun use_ordered_sets__my_find__result2 () count_type)

(declare-fun result2 () Bool)

(declare-fun result3 () cursor__ref)

(declare-fun use_ordered_sets__my_find__result3 () us_rep1)
...
(declare-fun use_ordered_sets__my_find__result4 () cursor__ref)

(declare-fun cu__split_fields5 () us_split_fields2)

(declare-fun use_ordered_sets__my_find__result5 () us_rep1)

(declare-fun cu__split_fields6 () us_split_fields__ref1)

(declare-fun use_ordered_sets__my_find__result6 () cursor__ref)

(declare-fun cu__split_fields7 () us_split_fields2)

(declare-fun use_ordered_sets__my_find__result7 () us_rep1)

(declare-fun result6 () cursor__ref)

(declare-fun use_ordered_sets__my_find__result8 () us_rep1)

(declare-fun use_ordered_sets__my_find__result9 () cursor__ref)

(declare-fun use_ordered_sets__my_find__result10 () us_rep1)

(declare-fun cu__split_fields8 () us_split_fields__ref1)

(declare-fun use_ordered_sets__my_find__result11 () cursor__ref)

(declare-fun cu__split_fields9 () us_split_fields2)

(declare-fun use_ordered_sets__my_find__result12 () us_rep1)

(declare-fun cu__split_fields10 () us_split_fields__ref1)

(declare-fun use_ordered_sets__my_find__result13 () cursor__ref)

(declare-fun cu__split_fields11 () us_split_fields2)

(declare-fun use_ordered_sets__my_find__result14 () us_rep1)

(define-fun use_ordered_sets__my_find__result15 () us_rep1 (mk___rep1
                                                           (mk___split_fields1
                                                           use_ordered_sets__my_find__result2)))
...
(define-fun temp___6951 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___695)))
...
;; H
  ...
  (and
  (and
  (= use_ordered_sets__my_find__result11 (mk_cursor__ref
                                         use_ordered_sets__my_find__result3))
  (= cu__split_fields8 (mk___split_fields__ref1 cu__split_fields12)))
  (and
  (= use_ordered_sets__my_find__result12 use_ordered_sets__my_find__result3)
  ...
  (and (= result1 true)
  (and (= temp___696 cu__split_fields1)
  (and
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  ...
  (and (= result2 true)
  (and (= result3 (mk_cursor__ref use_ordered_sets__my_find__result15))
  (= use_ordered_sets__my_find__result3 (mk___rep1 cu__split_fields12)))))))))))
  (and
  (and
  (and (= result1 (has_key (positions s) (mk___rep1 cu__split_fields13)))
  (= (= result1 true)
  ...
  (= use_ordered_sets__my_find__result3 use_ordered_sets__my_find__result15)))
  (and
  (and
  (and (= temp___6951 (next s (mk___rep1 cu__split_fields12)))
  ...
  (= (bool_eq3 temp___6951 no_element) true)
  (and (= (has_key (positions s) temp___6951) true)
  (= (get1 (positions s) temp___6951) (+ (get1 (positions s)
                                         (mk___rep1 cu__split_fields12)) 1)))))
  (and (= result4 (mk___split_fields__ref1 cu__split_fields12))
  (= cu__split_fields3 (mk___split_fields1 temp___695))))
  (and
  (and
  ...
  (and
  (and
  (= use_ordered_sets__my_find__result4 (mk_cursor__ref
                                        use_ordered_sets__my_find__result3))
  (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields3)))
  (and
  (= use_ordered_sets__my_find__result5 use_ordered_sets__my_find__result3)
  (= cu__split_fields5 cu__split_fields3))))
  (and
  (and
  (= use_ordered_sets__my_find__result6 use_ordered_sets__my_find__result4)
  (= cu__split_fields6 cu__split_fields4))
  (and
  (= use_ordered_sets__my_find__result7 use_ordered_sets__my_find__result5)
  (= cu__split_fields7 cu__split_fields5))))
  (and
  (and
  (= use_ordered_sets__my_find__result6 (mk_cursor__ref
                                        (mk___rep1
                                        (mk___split_fields1
                                        use_ordered_sets__my_find__result))))
  (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields13)))
  (and
  (= use_ordered_sets__my_find__result7 (mk___rep1
                                        (mk___split_fields1
                                        use_ordered_sets__my_find__result1)))
  (= cu__split_fields7 cu__split_fields13)))))
  (and
  (and
  (and
  (= use_ordered_sets__my_find__result11 use_ordered_sets__my_find__result9)
  (= cu__split_fields8 cu__split_fields6))
  (and
  (= use_ordered_sets__my_find__result12 use_ordered_sets__my_find__result10)
  (= cu__split_fields9 cu__split_fields7)))
  (and
  (and
  (= use_ordered_sets__my_find__result9 (mk_cursor__ref
                                        use_ordered_sets__my_find__result8))
  (= use_ordered_sets__my_find__result10 use_ordered_sets__my_find__result8))
  (and (= result6 use_ordered_sets__my_find__result6)
  (= use_ordered_sets__my_find__result8 no_element)))))))

;; H
  (assert
  (= use_ordered_sets__my_find__result13 use_ordered_sets__my_find__result11))
...
;; H
  (assert
  (= use_ordered_sets__my_find__result14 use_ordered_sets__my_find__result12))
...
;; H
  ...
  (= (mk___rep1 (mk___split_fields1 result7)) (cursor__content
                                              use_ordered_sets__my_find__result13)))

(assert
;; WP_parameter_def
 ;; File "a-cforse.ads", line 80, characters 0-0
  (not
  (= (bool_eq3 (cursor__content use_ordered_sets__my_find__result13)
     (find1 s e)) true)))
(check-sat)
