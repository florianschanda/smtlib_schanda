...
;; H
  (assert (=> (lt battery_level fliteral2) (= counter1 o3)))
...
;; H
  (assert (=> (not (lt battery_level fliteral2)) (= result3 counter)))

;; H
  (assert
  (=> (not (lt battery_level fliteral2)) (= counter2 ((_ int2bv 8) 0))))

;; H
  (assert (=> (not (lt battery_level fliteral2)) (= counter1 counter2)))
...
;; H
  (assert (is_valid__function_guard
  (is_valid battery_level_at2 current_time2 counter3) battery_level_at2
  current_time2 counter3))

(assert
;; WP_parameter_def
 ;; File "failsafe.adb", line 31, characters 0-0
  (not (= (is_valid battery_level_at2 current_time2 counter3) true)))
(check-sat)
