...
(declare-fun temp___895 ((_ BitVec 8) Int Int) us_t2)
...
;; def_axiom
  ...
  (and
  (=> (dynamic_property6 1 65536 temp___898 temp___899)
  (and (= (first5 temp___896) temp___898) (= (last8 temp___896) temp___899)))
  (forall ((temp___900 Int))
  (= (select (to_array2 temp___896) temp___900) (of_rep1 temp___897))))))))
...
;; H
  (assert
  (= (mk___t2 temp___902 temp___9021) (temp___895 ((_ int2bv 8) 0) 1
                                      (to_rep
                                      (rec__very_longs__very_long__length
                                      (us_split_discrs1 l))))))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 84, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first4 temp___9021)) (to_rep2 (last7 temp___9021)))
     (+ (- (to_rep2 (last7 temp___9021)) (to_rep2 (first4 temp___9021))) 1)
     0) (ite (<= 1 (to_rep
