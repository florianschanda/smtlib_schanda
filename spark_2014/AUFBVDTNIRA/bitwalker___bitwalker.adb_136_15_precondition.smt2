...
;; H
  (assert
  (forall ((j1 Int)) (nth8_stream__function_guard
  (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last)))
  j1) (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) j1)))

;; H
  (assert
  (forall ((j1 Int)) (nth8_stream__function_guard
  (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last)))
  j1) (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) j1)))
...
;; H
  ...
  (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last)))
     j1) true)
  (= (nth8_stream
     (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) j1) true)))))

;; H
  (assert
  (forall ((j1 Int))
  (=> (and (<= start j1) (<= j1 (- (+ start i2) 1)))
  (=
  (= (nth8_stream
     (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) j1) true)
  (= (nth value (+ (- (- len j1) 1) start)) true)))))
...
;; H
  ...
  (=>
  (and (<= (+ start i2) j1)
  (<= j1 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last))
...
;; H
  (assert
  (and (= o7 (+ (- (- len j) 1) start)) (in_range2
  (+ (- (- len j) 1) start))))

;; H
  (assert (= o8 (nth value o7)))

;; H
  (assert (= o9 (to_int2 o8)))

;; H
  (assert (and (= o6 j) (in_range2 j)))
