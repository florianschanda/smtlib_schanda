...
(define-fun default_initial_assumption1 ((temp___expr_361 us_rep1)
...
;; H
  ...
  (and (in_range1 o)
  (<= o (to_rep (rec__use_sets__my_sets__set__capacity target__split_discrs))))))

;; H
  (assert
  (= o1 (- (to_rep
           (rec__use_sets__my_sets__set__capacity target__split_discrs)) 
  o)))
