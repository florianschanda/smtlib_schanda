...
;; H
  ...
  (= o32 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
;; H
  (assert
  (=> (<= (to_rep addr__first) (to_rep addr__last))
  (= o25 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
;; H
  (assert
  (and (and (= o24 (maxvalue len)) (maxvalue__function_guard o24 len))
  (= o24 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))))
...
;; H
  (assert
  (=> (<= (to_rep addr__first) (to_rep addr__last))
  (= o17 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
;; H
  (assert
  (and (and (= o16 (maxvalue len)) (maxvalue__function_guard o16 len))
  (= o16 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))))
