...
(declare-fun temp___1354 () (Array Int character))

(declare-fun temp___13541 () t)
...
;; H
  (assert
  (= (concat1 (temp___String_Literal_1351 Tuple0) 1 6 firsttime1 1 21) 
  temp___1354))

;; H
  (assert (= (mk 1 o7) temp___13541))

;; H
  (assert (not (= (length (mk___t temp___1354 temp___13541)) 0)))
...
;; H
  (assert
  (=> (<= (to_rep1 (first temp___13541)) (to_rep1 (last temp___13541)))
  (= o9 (+ (- (to_rep1 (last temp___13541)) (to_rep1 (first temp___13541))) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 (first temp___13541)) (to_rep1 (last temp___13541))))
  (= o9 0)))
...
;; H
  (assert (= o11 (+ (to_rep1 (first temp___13541)) o10)))
