...
;; H
  (assert (readmem8__function_guard (readmem8 addr memory3) addr memory3))

;; H
  (assert (readmem8__function_guard
  (readmem8 (bvadd addr ((_ int2bv 64) 1)) memory3)
  (bvadd addr ((_ int2bv 64) 1)) memory3))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 34, characters 0-0
  (not
  (= (bvor ((_ zero_extend 8) (readmem8 addr memory3)) (ite (< 8 16)
                                                       (bvshl ((_ zero_extend 8) 
                                                       (readmem8
                                                       (bvadd addr ((_ int2bv 64) 1))
                                                       memory3)) ((_ int2bv 16) 8))
                                                       ((_ int2bv 16) 0))) 
  val__)))
(check-sat)
