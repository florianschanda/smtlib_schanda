...
(declare-fun dummy2 () fruits_and_weapons)
...
(define-fun bool_eq4 ((a (Array Int fruits)) (a__first Int) (a__last Int)
...
(define-fun bool_eq5 ((a (Array Int fruits_and_weapons)) (a__first Int)
...
(declare-fun dummy5 () new_item_t)

(declare-datatypes ()
((new_item_t__ref (mk_new_item_t__ref (new_item_t__content new_item_t)))))
...
(declare-fun old_inventory () us_t)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun new_inventory__first () integer)

(declare-fun new_inventory__last () integer)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun new_content () Int)
...
(declare-fun o1 () fruits_and_weapons)

(declare-fun result () Int)

(declare-fun i1 () Int)

(declare-fun new_inventory1 () (Array Int fruits_and_weapons))
