...
;; H
  (assert
  (and
  (and (= o4 (is_digit (to_rep (select (elts source) i3))))
  (is_digit__function_guard o4 (to_rep (select (elts source) i3))))
  (ite (= (= (to_rep (select (elts source) i3)) 48) true) (= o4 true)
  (ite (= (= (to_rep (select (elts source) i3)) 49) true) (= o4 true)
  (ite (= (= (to_rep (select (elts source) i3)) 50) true) (= o4 true)
  (ite (= (= (to_rep (select (elts source) i3)) 51) true) (= o4 true)
  (ite (= (= (to_rep (select (elts source) i3)) 52) true) (= o4 true)
  (ite (= (= (to_rep (select (elts source) i3)) 53) true) (= o4 true)
  (ite (= (= (to_rep (select (elts source) i3)) 54) true) (= o4 true)
  (ite (= (= (to_rep (select (elts source) i3)) 55) true) (= o4 true)
  (ite (= (= (to_rep (select (elts source) i3)) 56) true) (= o4 true)
  (ite (= (= (to_rep (select (elts source) i3)) 57) true) (= o4 true)
  (ite (= (> (to_rep (select (elts source) i3)) 57) true) (not (= o4 true))
  (=> (= (< (to_rep (select (elts source) i3)) 48) true) (not (= o4 true))))))))))))))))
