...
;; H
  ...
  (us_split_fields__content my_stack__split_fields4)))
  (= o24 (mk___rep (us_split_fields__content my_stack__split_fields4)))))

;; H
  (assert
  (and (and (= o25 (count o24)) (count__function_guard o25 o24))
  (and (in_range2 o25)
  (= o25 (to_rep1
         (rec__stack_functional_spec__stack_type__pointer
         (us_split_fields1 o24)))))))
...
;; H
  (assert
  (and
  (and (= o29 (state__2 (us_split_fields__content my_stack__split_fields4)))
  (state__2__function_guard o29
  (us_split_fields__content my_stack__split_fields4)))
...
;; H
  (assert
  (and (and (= o22 (count o29)) (count__function_guard o22 o29))
  (and (in_range2 o22) (= o22 (to_rep1 o21)))))
...
;; H
  ...
  (= o23 (stack_entry
         ...
         (mk___split_fields my_stack__split_fields my_stack__split_fields1))
         o22))
  (stack_entry__function_guard o23
  (state__2
  (mk___split_fields my_stack__split_fields my_stack__split_fields1)) 
  o22))
  (and (in_range1 o23)
  (= o23 (to_rep
         (select (rec__stack_functional_spec__stack_type__s
                 ...
                 (state__2
                 (mk___split_fields my_stack__split_fields
                 my_stack__split_fields1)))) o22))))))

;; H
  (assert
  (and
  (and (= o30 (state__2 (us_split_fields__content my_stack__split_fields4)))
  (state__2__function_guard o30
  (us_split_fields__content my_stack__split_fields4)))
  (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields
                                                        o16 o17))))
...
;; H
  (assert
  (and (and (= o18 (count o30)) (count__function_guard o18 o30))
