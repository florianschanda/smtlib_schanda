...
(declare-fun dummy2 () tTb_contentSP1)

(declare-datatypes ()
((tTb_contentSP1__ref
 (mk_tTb_contentSP1__ref (tTb_contentSP1__content tTb_contentSP1)))))
(define-fun tTb_contentSP1__ref___projection ((a tTb_contentSP1__ref)) tTb_contentSP1 
  (tTb_contentSP1__content a))

(declare-fun b_top () Int)

;; H
  (assert (in_range1 b_top))
...
(assert
;; WP_parameter_def
 ;; File "stack.adb", line 18, characters 0-0
  (not (in_range1 (+ b_top 1))))
(check-sat)
