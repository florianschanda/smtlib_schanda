...
;; H
  (assert
  (= (mk___split_fields result____split_fields1) amortized_queue__my_vectors__append__2__container__fields2))
...
;; H
  (assert (= result2 (mk_int__ref idx2)))

;; H
  (assert (= idx3 (+ idx2 1)))

;; H
  (assert (and (= o4 idx3) (in_range3 idx3)))
...
;; H
  (assert (= result3 (mk___split_fields__ref result____split_fields4)))

;; H
  (assert
  (= result____split_fields3 amortized_queue__my_vectors__append__2__container__fields1))
