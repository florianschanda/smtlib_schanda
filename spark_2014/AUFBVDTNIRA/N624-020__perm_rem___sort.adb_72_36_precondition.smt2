...
;; H
  (assert (remove__function_guard
  (remove (remove (mk___t values2 (mk 1 100)) y) x)
  (remove (mk___t values2 (mk 1 100)) y) x))
...
;; H
  (assert
  (= (let ((temp___308 (remove (remove (mk___t values2 (mk 1 100)) y) x)))
     (let ((temp___307 (remove (remove (mk___t interm1 (mk 1 100)) x)
                       (- y 1))))
     (bool_eq5 (elts temp___307) (to_rep1 (first (rt temp___307)))
     (to_rep1 (last (rt temp___307))) (elts temp___308)
     (to_rep1 (first (rt temp___308))) (to_rep1 (last (rt temp___308)))))) true))
...
;; H
  (assert (invariant____function_guard (invariant__ temp___310) temp___310))
...
;; H
  (assert
  (and
  (and (= temp___310 (remove o26 o27)) (remove__function_guard temp___310 
  o26 o27))
  (and (dynamic_invariant4 temp___310 true false true)
  (and (= (invariant__ temp___310) true)
  (and (= (to_rep1 (last (rt temp___310))) (- (to_rep1 (last (rt o26))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o27 1)))
  (= (to_rep (select (elts o26) k)) (to_rep (select (elts temp___310) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last (rt o26)))))
  (= (to_rep (select (elts o26) k)) (to_rep
                                    (select (elts temp___310) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o27 k) (<= k (- (to_rep1 (last (rt o26))) 1)))
  (= (to_rep (select (elts o26) (+ k 1))) (to_rep
                                          (select (elts temp___310) k))))))))))))
