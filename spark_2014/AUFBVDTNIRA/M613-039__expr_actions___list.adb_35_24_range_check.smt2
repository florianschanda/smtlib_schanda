...
;; H
  (assert
  (and
  (and (= o3 (to__ (mk___rep s__split_fields10))) (to____function_guard 
  o3 (mk___rep s__split_fields10))) (dynamic_invariant1 o3 true false true)))
