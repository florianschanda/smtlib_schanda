...
;; H
  (assert
  (and (and (in_range1 formal2) (=> (<= 1 2) (in_range2 i2)))
  (and (<= 1 i2) (<= i2 2))))

;; H
  (assert (= temp___136 result2))

;; H
  (assert (= temp___1361 (+ formal2 (ghost_func Tuple0))))
...
;; H
  (assert (and (= o2 (ghost_func Tuple0)) (in_range1 o2)))

;; H
  (assert (= o3 (+ formal3 o2)))
