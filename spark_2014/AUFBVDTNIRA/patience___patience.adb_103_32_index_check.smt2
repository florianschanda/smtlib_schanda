...
(declare-fun temp___676 () (Array Int cardindex))
...
;; H
  (assert
  (= temp___676 (select (rec__patience__state__stacks
                        (us_split_fields__content s__split_fields20)) 
  o110)))
...
;; H
  (assert (= o112 (select temp___676 o111)))

;; H
  (assert (= temp___677 (to_rep1 o112)))
