...
(declare-fun o33 () us_image)

(declare-fun temp___528 () (Array Int character))

(declare-fun temp___5281 () t1)
...
;; H
  (assert
  (and
  (and (= o11 (leibniz_float Tuple0)) (leibniz_float__function_guard 
  o11 Tuple0)) (and (tqtisFinite o11) (eq o11 fliteral2))))
...
;; H
  (assert
  (and
  (and (= o21 (shanks_fixed Tuple0)) (shanks_fixed__function_guard o21
  Tuple0)) (= (to_fixed o21) 3293842)))
...
;; H
  (assert
  (= o30 (concat1 (temp___String_Literal_523 Tuple0) 1 28 temp___525
         (to_rep1 (first temp___5251)) (to_rep1 (last temp___5251)))))
...
;; H
  (assert
  (and
  (and (= o32 (shanks_float Tuple0)) (shanks_float__function_guard o32
  Tuple0)) (and (tqtisFinite o32) (eq o32 fliteral3))))

;; H
  (assert (= o33 (attr__ATTRIBUTE_IMAGE3 o32)))

;; H
  (assert (= (mk___t temp___528 temp___5281) (to_string o33)))

;; H
  (assert
  (=> (<= (to_rep1 (first temp___5281)) (to_rep1 (last temp___5281)))
  (= o34 (+ (- (to_rep1 (last temp___5281)) (to_rep1 (first temp___5281))) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 (first temp___5281)) (to_rep1 (last temp___5281))))
  (= o34 0)))

;; H
  (assert (=> (<= 1 28) (= o35 (+ (- 28 1) 1))))

;; H
  (assert (=> (not (<= 1 28)) (= o35 0)))
