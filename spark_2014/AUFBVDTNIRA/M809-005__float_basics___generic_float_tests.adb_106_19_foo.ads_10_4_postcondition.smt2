...
(declare-fun foo__float_tests__underflow_3__result () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun foo__float_tests__underflow_3__result1 () t)

(declare-fun foo__float_tests__underflow_3__result2 () t)

(declare-fun foo__float_tests__underflow_3__result3 () t)

(declare-fun foo__float_tests__underflow_3__result4 () t)

(declare-fun foo__float_tests__underflow_3__result5 () t)
...
;; WP_parameter_def
 ;; File "generic_float_tests.ads", line 2, characters 0-0
  (not (lt fliteral2 foo__float_tests__underflow_3__result4)))
(check-sat)
