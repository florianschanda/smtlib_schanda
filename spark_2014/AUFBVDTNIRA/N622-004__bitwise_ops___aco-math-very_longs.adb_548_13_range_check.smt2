...
(define-fun dynamic_invariant2 ((temp___expr_957 us_rep1)
  (temp___is_init_954 Bool) (temp___skip_constant_955 Bool)
  (temp___do_toplevel_956 Bool)) Bool (and
                                      (=>
                                      ...
                                      (first3
                                      (rec__aco__math__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_957)))
                                      (last5
                                      (rec__aco__math__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_957))))
                                      (and
                                      (= (first3
                                         (rec__aco__math__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_957))) 1)
                                      (= (last5
                                         (rec__aco__math__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_957))) 
                                      (to_rep
...
(define-fun default_initial_assumption ((temp___expr_960 us_rep1)
  (temp___skip_top_level_961 Bool)) Bool (= (to_rep
                                            (rec__aco__math__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_960))) (to_rep
                                                               (rec__aco__math__very_longs__very_long__octet_length
                                                               (us_split_discrs1
                                                               l)))))
