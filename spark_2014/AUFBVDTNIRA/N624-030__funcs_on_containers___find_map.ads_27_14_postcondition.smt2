...
(define-fun dynamic_invariant ((temp___expr_327 us_t)
...
;; equivalent_keys__def_axiom
  ...
  (! (=> (equivalent_keys__function_guard (equivalent_keys e1 e2) e1 e2)
...
(declare-fun bool_eq9 (us_rep1 us_rep1) Bool)
...
(declare-fun find_map__index_maps__cursor__node__first__bit () Int)

(declare-fun find_map__index_maps__cursor__node__last__bit () Int)

(declare-fun find_map__index_maps__cursor__node__position () Int)
...
(declare-fun bool_eq12 (us_rep3 us_rep3) Bool)
...
(define-fun key_type__ref_3__projection ((a key_type__ref1)) us_rep2 
...
(define-fun dynamic_invariant5 ((temp___expr_601 us_rep)
  (temp___is_init_598 Bool) (temp___skip_constant_599 Bool)
  (temp___do_toplevel_600 Bool)) Bool (=>
                                      (not (= temp___skip_constant_599 true))
                                      (in_range7 100 r258s temp___expr_601)))

(define-fun default_initial_assumption ((temp___expr_604 us_rep)
  (temp___skip_top_level_605 Bool)) Bool (and
                                         (and
                                         (= (to_rep3
                                            (rec__find_map__index_maps__map__capacity
                                            (us_split_discrs1
                                         ...
                                         (= (to_rep2
                                            (rec__find_map__index_maps__map__modulus
                                            (us_split_discrs1
                                            temp___expr_604))) r258s))
                                         (=>
                                         (not
                                         (= temp___skip_top_level_605 true))
                                         (= (is_empty1 temp___expr_604) true))))
...
(define-fun dynamic_invariant8 ((temp___expr_169 (_ BitVec 32))
  (temp___is_init_166 Bool) (temp___skip_constant_167 Bool)
  (temp___do_toplevel_168 Bool)) Bool true)
...
(define-fun default_initial_assumption1 ((temp___expr_427 us_rep3)
  (temp___skip_top_level_428 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_428 true))
                                         (= (length3 temp___expr_427) 0)))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant3 key2 true true true)
     ...
     (and
     (and (equivalent_keys__function_guard
     (equivalent_keys key2 (get1 container result)) key2
...
(define-fun default_initial_assumption2 ((temp___expr_449 us_rep4)
  (temp___skip_top_level_450 Bool)) Bool (=>
                                         ...
                                         (and
                                         (= (is_empty3 temp___expr_449) true)
                                         (= (length4 temp___expr_449) 0))))
...
(define-fun default_initial_assumption3 ((temp___expr_380 us_rep1)
  (temp___skip_top_level_381 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_381 true))
                                         (and
                                         (= (is_empty temp___expr_380) true)
                                         (= (length5 temp___expr_380) 0))))
...
(declare-fun user_eq14 (key_type1 key_type1) Bool)

(declare-fun dummy15 () key_type1)

(declare-datatypes ()
((key_type__ref2 (mk_key_type__ref2 (key_type__content2 key_type1)))))
(define-fun key_type__ref_2__projection ((a1 key_type__ref2)) key_type1 
...
(declare-fun dummy16 () extended_index)
...
;; keys__post_axiom
  ...
  (! (let ((result (keys container)))
     ...
     (=>
     (and (in_range9 temp___468)
     (= (iter_has_element result temp___468) true))
     (= (has_key (model__ container) (get1 result temp___468)) true))))
     (forall ((key2 Int))
     (=> (and (in_range8 key2) (= (has_key (model__ container) key2) true))
     (and (< 0 (find2 result key2))
     (and (equivalent_keys__function_guard
     (equivalent_keys (get1 result (find2 result key2)) key2)
     ...
     (and (equivalent_keys__function_guard
     (equivalent_keys (get1 result i) (get1 result j)) (get1 result i)
     (get1 result j))
...
;; positions__post_axiom
  ...
  (! (let ((result (positions container)))
     ...
     (=> (= (get2 result i) (get2 result j)) (= (bool_eq11 i j) true))))))))) :pattern (
  (positions container)) )))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant3 key2 true true true)
     ...
     (and (equivalent_keys__function_guard
     (equivalent_keys (key container result) key2) (key container result)
     key2)
     (ite (not (= (has_key (model__ container) key2) true))
     (= (bool_eq11 result no_element) true)
     (and
...
(define-fun dynamic_invariant9 ((temp___expr_367 Int)
...
;; has_key__post_axiom
  ...
  (! (=> (dynamic_invariant9 key2 true true true)
     (and
     (forall ((k Int)) (equivalent_keys__function_guard
...
(define-fun dynamic_invariant10 ((temp___expr_373 Int)
...
;; keys_included_except__post_axiom
  ...
  (! (=> (dynamic_invariant9 new_key true true true)
     (and
     (forall ((key2 Int)) (equivalent_keys__function_guard
     (equivalent_keys key2 new_key) key2 new_key))
...
(define-fun dynamic_invariant11 ((temp___expr_420 Int)
...
(define-fun element_type__ref_3__projection ((a1 element_type__ref2)) element_type2 
  (element_type__content2 a1))

(define-fun dynamic_invariant12 ((temp___expr_414 Int)
...
(declare-fun user_eq18 (element_type3 element_type3) Bool)

(declare-fun dummy19 () element_type3)

(declare-datatypes ()
((element_type__ref3
 (mk_element_type__ref3 (element_type__content3 element_type3)))))
(define-fun element_type__ref_4__projection ((a1 element_type__ref3)) element_type3 
...
;; keys_included_except__post_axiom
  ...
  (! (= (= (keys_included_except1 left right new_key) true)
     ...
     (=> (not (= (bool_eq11 key2 new_key) true))
...
(declare-fun find_map__find_all__result () count_type)

(declare-fun find_map__find_all__result1 () hash_type)

(declare-fun find_map__find_all__result2 () us_main_type)

(declare-fun temp___732 () Int)

(declare-fun temp___731 () count_type)

(declare-fun temp___7311 () hash_type)

(declare-fun temp___7312 () us_main_type)

(declare-fun o () Bool)

(declare-fun o1 () Int)

(declare-fun find_map__index_maps__clear__container__fields () us_main_type)
...
(declare-fun find_map__index_maps__insert__2__container__fields () us_main_type)
...
(declare-fun result4 () index_map__ref)

(declare-fun find_map__find_all__result3 () us_rep)

(declare-fun find_map__find_all__result4 () index_map__ref)

(declare-fun find_map__find_all__result5 () us_rep)

(declare-fun result____split_fields8 () us_split_fields__ref)

(declare-fun k7 () int__ref)

(declare-fun find_map__find_all__result6 () index_map__ref)

(declare-fun result____split_fields9 () us_split_fields)

(declare-fun k8 () Int)

(declare-fun find_map__find_all__result7 () us_rep)

(define-fun result____split_fields10 () us_split_fields (mk___split_fields
                                                        result____split_fields3))

(define-fun result____split_fields11 () us_split_fields (mk___split_fields
...
(define-fun result____split_fields12 () us_split_fields (mk___split_fields
...
(declare-fun result6 () hash_type)

(declare-fun result7 () us_main_type)

;; H
  (assert
  (forall ((e Int)) (equivalent_keys__function_guard
  (equivalent_keys
  (to_rep
  (select (elts a) (get
                   (model__
                   (mk___rep result____split_discrs result____split_fields10))
                   e)))
  e)
  (to_rep
  (select (elts a) (get
...
;; H
  (assert
  (= result____split_fields12 find_map__index_maps__clear__container__fields1))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) k1) (<= k1 (to_rep1 (last (rt a)))))
  (= temp___732 k1)))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) k1) (<= k1 (to_rep1 (last (rt a)))))
  (and (= result____split_discrs (mk___split_discrs temp___731 temp___7311))
  (= temp___7312 result____split_fields1))))
...
;; H
  ...
  (and
  (= o (has_key
       (model__ (mk___rep result____split_discrs result____split_fields12))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) k1) (<= k1 (to_rep1 (last (rt a)))))
  (= result2 (ite (not (= o true)) true false))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) k1) (<= k1 (to_rep1 (last (rt a)))))
  (=> (= result2 true) (and (= o1 k1) (in_range5 k1)))))
...
;; H
  ...
  (= (keys_included_except
     ...
     (to_rep (select (elts a) k1))) true))
  (= (mapping_preserved
     (keys (mk___rep result____split_discrs result____split_fields12))
     (keys
     (mk___rep result____split_discrs
     find_map__index_maps__insert__2__container__fields1))
     (positions (mk___rep result____split_discrs result____split_fields12))
     (positions
     (mk___rep result____split_discrs
     find_map__index_maps__insert__2__container__fields1))) true))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) k1) (<= k1 (to_rep1 (last (rt a)))))
  (=> (= result2 true) (= result3 result____split_fields1))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) k1) (<= k1 (to_rep1 (last (rt a)))))
  (=> (= result2 true)
  (= result____split_fields11 find_map__index_maps__insert__2__container__fields1))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) k1) (<= k1 (to_rep1 (last (rt a)))))
  (=> (not (= result2 true))
  (= result____split_fields11 result____split_fields12))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) k1) (<= k1 (to_rep1 (last (rt a)))))
  (<= (length1 (mk___rep result____split_discrs result____split_fields10)) 
  k2)))
...
;; H
  ...
  (=> (and (<= (to_rep1 (first (rt a))) k1) (<= k1 (to_rep1 (last (rt a)))))
  (forall ((i Int))
  (=> (and (<= (to_rep1 (first (rt a))) i) (<= i k2))
  (and
  (and
  (= (has_key
     (model__ (mk___rep result____split_discrs result____split_fields10))
     (to_rep (select (elts a) i))) true)
  (and
  (<= (to_rep1 (first (rt a))) (get
                               (model__
                               (mk___rep result____split_discrs
                               result____split_fields10))
                               (to_rep (select (elts a) i))))
  (<= (get
      (model__ (mk___rep result____split_discrs result____split_fields10))
      (to_rep (select (elts a) i))) i)))
  (= (to_rep
     (select (elts a) (get
                      (model__
                      (mk___rep result____split_discrs
                      result____split_fields10))
                      (to_rep (select (elts a) i))))) (to_rep
                                                      (select (elts a) i))))))))
...
;; H
  ...
  (=>
  (= (has_key
     (model__ (mk___rep result____split_discrs result____split_fields10)) e) true)
  (and
  (and
  (<= (to_rep1 (first (rt a))) (get
                               (model__
                               (mk___rep result____split_discrs
                               result____split_fields10)) e))
  (<= (get
      (model__ (mk___rep result____split_discrs result____split_fields10)) e) 
  k2))
  (= (equivalent_keys
     (to_rep
     (select (elts a) (get
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) k1) (<= k1 (to_rep1 (last (rt a)))))
  (= result____split_fields5 result____split_fields10)))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt a))) k1) (<= k1 (to_rep1 (last (rt a))))))
  (= result____split_fields6 (mk___split_fields__ref
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt a))) k1) (<= k1 (to_rep1 (last (rt a))))))
  (= result____split_fields7 result____split_fields12)))

;; H
  (assert
  (= find_map__find_all__result4 (mk_index_map__ref
                                 find_map__find_all__result3)))

;; H
  (assert (= find_map__find_all__result5 find_map__find_all__result3))

;; H
  (assert
  (= result4 (mk_index_map__ref
             (mk___rep
             (mk___split_discrs find_map__find_all__result
             find_map__find_all__result1)
             (mk___split_fields find_map__find_all__result2)))))

;; H
  (assert
  (= find_map__find_all__result3 (mk___rep result____split_discrs
                                 (us_split_fields__content
                                 result____split_fields6))))

;; H
  (assert (= find_map__find_all__result6 find_map__find_all__result4))

;; H
  (assert (= k7 k5))

;; H
  (assert (= result____split_fields8 result____split_fields6))

;; H
  (assert (= find_map__find_all__result7 find_map__find_all__result5))
...
;; H
  (assert
  (= (mk___rep (mk___split_discrs result5 result6)
     (mk___split_fields result7)) (index_map__content
                                  find_map__find_all__result6)))
...
;; WP_parameter_def
 ;; File "find_map.ads", line 23, characters 0-0
  (not
  (= (has_key (model__ (index_map__content find_map__find_all__result6))
     (to_rep (select (elts a) i))) true)))
(check-sat)
