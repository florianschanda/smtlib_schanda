...
;; H
  (assert
  (and
  (and (= o24 (rate_of (mk___rep ctx__split_fields10)))
  (rate_of__function_guard o24 (mk___rep ctx__split_fields10)))
  (and (in_range3 o24)
  (and
  (= o24 (* (to_rep4
            (rec__keccak__keccak_1600__sponge__context__rate
...
;; H
  (assert (= o25 (ite (= o24 initial_bit_rate1) true false)))

;; H
  (assert
  (and
  (and (= o22 (state_of (mk___rep ctx__split_fields10)))
  (state_of__function_guard o22 (mk___rep ctx__split_fields10)))
  (and (in_range7 o22)
  (= o22 (to_rep5
         (rec__keccak__keccak_1600__sponge__context__curr_state
         ctx__split_fields10))))))
...
;; H
  (assert (= o23 (ite (= o22 0) true false)))

(assert
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not (in_range1 (+ remaining_bits3 7))))
(check-sat)
