...
(define-fun dynamic_invariant5 ((temp___expr_188 Int)
...
(declare-fun dummy10 () position_type)
...
(define-fun bool_eq13 ((a (Array Int us_rep2)) (a__first Int) (a__last Int)
...
(declare-fun dummy12 () (Array Int us_rep2))
...
(define-fun dynamic_invariant7 ((temp___expr_281 us_rep3)
...
;; size__post_axiom
  ...
  (! (=> (dynamic_invariant7 f true true true)
     (let ((result (size f)))
     (=> (size__function_guard result f) (dynamic_invariant2 result true
...
;; valid_root__post_axiom
  ...
  (forall ((i Int))
  (! (=>
     (and (dynamic_invariant7 f true true true) (dynamic_invariant1 i true
     true true))
...
;; peek__post_axiom
  ...
  (! (=>
     (and
     (and (dynamic_invariant7 f true true true) (dynamic_invariant1 i true
     true true)) (dynamic_invariant3 d true true true))
...
(define-fun dynamic_invariant8 ((temp___expr_218 (Array Int us_rep1))
...
;; model____post_axiom
  ...
  (! (and (valid_root__function_guard (valid_root f root) f root)
     (=>
     (and
     (and (dynamic_invariant7 f true true true) (dynamic_invariant1 root true
     ...
     (= j i))))))))))) (dynamic_invariant8 result true false true))))))))))))) :pattern (
  (model__ f root)) ))))
...
(define-fun bool_eq15 ((a (Array Int natural)) (a__first Int) (a__last Int)
...
(declare-fun dummy14 () (Array Int natural))
...
;; temp___result_564_def
  (assert
  (forall ((temp___563 us_rep3)) (tree_structure__function_guard
  (tree_structure temp___563) temp___563)))

(define-fun dynamic_invariant9 ((temp___expr_562 us_rep4)
...
;; temp___result_574_def
  (assert
  (forall ((temp___573 us_rep3)) (size__function_guard (size temp___573)
  temp___573)))

;; temp___result_580_def
  (assert
  (forall ((temp___579 us_rep4)) (size__function_guard1 (size1 temp___579)
  temp___579)))

(define-fun default_initial_assumption3 ((temp___expr_567 us_rep4)
...
;; temp___result_585_def
  (assert
  (forall ((temp___582 us_rep4)) (size__function_guard
  (size
...
;; temp___result_583_def
  (assert
  (forall ((temp___582 us_rep4)) (valid_root__function_guard
  (valid_root
  (rec__search_trees__search_tree__struct (us_split_fields7 temp___582))
  (to_rep1
...
;; temp___result_584_def
  (assert
  (forall ((temp___582 us_rep4)) (ordered_leafs__function_guard
  (ordered_leafs
  (rec__search_trees__search_tree__struct (us_split_fields7 temp___582))
  (to_rep1
  (rec__search_trees__search_tree__root (us_split_fields7 temp___582)))
...
(define-fun type_invariant1 ((temp___581 us_rep4)) Bool (ite (= (size
                                                                (rec__search_trees__search_tree__struct
                                                                (us_split_fields7
                                                                temp___581))) 0)
                                                        (= (to_rep1
...
;; size__post_axiom
  (assert
  (forall ((t1 us_rep4))
  (! (=> (and (dynamic_invariant9 t1 true true true) (type_invariant1 t1))
     (let ((result (size1 t1)))
     (=> (size__function_guard1 result t1) (dynamic_invariant2 result true
...
;; size__def_axiom
  ...
  (forall ((t1 us_rep4))
  (! (=>
     (and (dynamic_invariant9 t1 true true true) (size__function_guard1
     (size1 t1) t1))
     (and (size__function_guard
     (size (rec__search_trees__search_tree__struct (us_split_fields7 t1)))
     (rec__search_trees__search_tree__struct (us_split_fields7 t1)))
     (= (size1 t1) (size
                   (rec__search_trees__search_tree__struct
                   (us_split_fields7 t1)))))) :pattern ((size1 t1)) )))
...
;; parent__post_axiom
  ...
  (! (=>
     ...
     (=> (= (size f) 0) (= result 0))) (dynamic_invariant2 result true false
...
;; position__post_axiom
  ...
  (! (and (parent__function_guard (parent f i) f i)
     ...
     (=> (position__function_guard result f i) (dynamic_invariant3 result
     true false true))))) :pattern ((position f i)) ))))

(define-fun default_initial_assumption5 ((temp___expr_267 us_rep2)
...
(define-fun default_initial_assumption6 ((temp___expr_274 (Array Int us_rep2))
...
(declare-fun t_old__split_fields2 () (Array Int us_rep2))
...
(declare-fun temp___3377 () (Array Int us_rep1))
...
(declare-fun temp___3378 () (Array Int us_rep1))

(declare-fun o5 () us_rep1)

(declare-fun o6 () us_split_fields)

(declare-fun o7 () us_rep)

(declare-fun o8 () Int)

(declare-fun temp___3376 () (Array Int us_rep1))
...
(declare-fun temp___3375 () (Array Int us_rep1))

(declare-fun o12 () us_rep1)
...
(declare-fun temp___3374 () (Array Int us_rep1))
...
;; H
  ...
  (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t))
...
;; H
  (assert (peek__function_guard
  (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) l d)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) l d))
...
;; H
  ...
  (select (model__
          (rec__search_trees__search_tree__struct (us_split_fields7 t))
          (to_rep1
          (rec__search_trees__search_tree__root (us_split_fields7 t)))) 
  l))) d
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__
...
;; H
  ...
  (and (not (= (to_rep (select t_old__split_fields3 l)) v))
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
             (mk___rep2
             (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
             (to_rep1 t_old__split_fields)) l))) true)
  (and (ite (< v (to_rep (select t_old__split_fields3 l))) (= d 0) (= d 1))
  (and
  (= (peek
     (mk___rep2
     (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) 
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             (mk___rep2
             (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
             (to_rep1 t_old__split_fields)) i1))) true)
  (=>
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (mk___rep2
             (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
             (to_rep1 t_old__split_fields)) i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (mk___rep2
  ...
  (ite (= (get
          ...
          (select (model__
                  (mk___rep2
                  (mk___split_fields2 t_old__split_fields1
                  t_old__split_fields2)) (to_rep1 t_old__split_fields)) 
          l)))
          (+ (length
             (rec__tree_model__path_type__a
             (us_split_fields1
             (select (model__
                     (mk___rep2
                     (mk___split_fields2 t_old__split_fields1
                     t_old__split_fields2)) (to_rep1 t_old__split_fields)) i1)))) 1)) 0)
  (< v (to_rep (select t_old__split_fields3 i1)))
  (< (to_rep (select t_old__split_fields3 i1)) v))))))
  (and
  (= (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) (+ 
  (size
  (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))) 1))
  (and
  (= (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) 
  (to_rep1 t_old__split_fields))
  (and
  (= (valid_root
     (rec__search_trees__search_tree__struct (us_split_fields7 t))
     (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) true)
  (and (not (= i 0))
  (and
  (= (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) l d) 
  i)
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t))
             (to_rep1
             (rec__search_trees__search_tree__root (us_split_fields7 t)))) j1))) true)
  (or
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
  ...
  (= (oeq
     ...
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t))
             (to_rep1
             (rec__search_trees__search_tree__root (us_split_fields7 t)))) j1)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (mk___rep2
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             ...
             (rec__search_trees__search_tree__root (us_split_fields7 t)))) j1))) true)
  (= (to_rep
     (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j1)) 
  (to_rep (select t_old__split_fields3 j1))))))
  (= (to_rep
     (select (rec__search_trees__search_tree__values (us_split_fields7 t)) 
     i)) v))))))))))))))))))
...
;; H
  ...
  (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))
...
;; H
  ...
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3375 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i1))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3375 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3375 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3376 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i1))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3376 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3376 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3378 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i1))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3378 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3378 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3377 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i1))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3377 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3377 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= temp___3375 (model__
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7 t)) o11))
  (model____function_guard temp___3375
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o11))
  (and (dynamic_invariant8 temp___3375 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3375 o11))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3375 o11)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o11))
  (ite (and
       (not
       (= (parent
          (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___3375 (parent
                              (rec__search_trees__search_tree__struct
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3375 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3375 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3375 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3375 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3375 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3375 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= o12 (select temp___3375 ki1)))
...
;; H
  ...
  (=> (= result3 true)
  (and
  (= o8 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))))))
...
;; H
  ...
  (= temp___3376 (model__
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7 t)) o8))
  (model____function_guard temp___3376
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o8))
  (and (dynamic_invariant8 temp___3376 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3376 o8))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3376 o8)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o8))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___3376 (parent
                              ...
                              (us_split_fields7 t)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3376 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3376 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3376 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3376 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3376 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3376 j1)))) true))
  (= j1 i1)))))))))))))))

;; H
  (assert (=> (= result3 true) (= o9 (select temp___3376 j))))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o4 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))))))
...
;; H
  ...
  (= temp___3378 (model__
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7 t)) o4))
  (model____function_guard temp___3378
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o4))
  (and (dynamic_invariant8 temp___3378 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3378 o4))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3378 o4)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o4))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___3378 (parent
                              ...
                              (us_split_fields7 t)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3378 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3378 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3378 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3378 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3378 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3378 j1)))) true))
  (= j1 i1)))))))))))))))

;; H
  (assert (=> (= result2 true) (= o5 (select temp___3378 j))))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))))))
...
;; H
  ...
  (= temp___3377 (model__
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7 t)) o))
  (model____function_guard temp___3377
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o))
  (and (dynamic_invariant8 temp___3377 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3377 o))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3377 o)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___3377 (parent
                              ...
                              (us_split_fields7 t)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3377 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3377 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3377 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3377 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3377 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3377 j1)))) true))
  (= j1 i1)))))))))))))))

;; H
  (assert (=> (= result2 true) (= o1 (select temp___3377 ki1))))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= result1 (olt o3 o7))
  (= (= result1 true)
  (and (< (length o3) (length o7))
  (forall ((n Int))
  (=> (and (<= 1 n) (<= n (last o3))) (= (get o3 n) (get o7 n)))))))))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3374 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i1))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3374 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3374 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= temp___3374 (model__
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7 t)) o15))
  (model____function_guard temp___3374
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o15))
  (and (dynamic_invariant8 temp___3374 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3374 o15))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3374 o15)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o15))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___3374 (parent
                              ...
                              (us_split_fields7 t)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3374 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3374 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3374 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3374 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3374 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3374 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= o16 (select temp___3374 ki1)))
...
;; H
  (assert
  (and (= o19 (length o18)) (and (in_range6 o19) (<= (+ 0 o19) 2147483647))))
