...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral4) (/ 1000000047497451305389404296875.0 1000000000000000000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral5) (/ 319990005493164062500.0 10000000000000000000.0))))
...
;; H
  (assert (and (le (neg fliteral3) value2) (le value2 (neg fliteral4))))
