...
;; def_axiom
  ...
  (= (select (temp___213 temp___215) 1) (of_rep temp___215))))

(declare-fun temp___477 (Int) (Array Int element))

;; def_axiom
  (assert
  (forall ((temp___479 Int))
  (= (select (temp___477 temp___479) 1) (of_rep temp___479))))
...
(declare-fun temp___489 () (Array Int element))

(declare-fun temp___4891 () t)
...
(define-fun temp___4892 () us_t (mk___t temp___489 temp___4891))
...
;; H
  (assert
  (and
  (= temp___4892 (get_model__2 (mk___rep s__split_fields3 s__attr__tag)))
  (and (dynamic_invariant1 temp___4892 true false true)
  (and
  (and (= s__split_fields temp___489)
  (= (mk (to_rep1 (first2 (mk1 1 (to_rep2 s__split_fields1))))
     (to_rep1 (last2 (mk1 1 (to_rep2 s__split_fields1))))) temp___4891))
  (= (length temp___4892) (size (mk___rep s__split_fields3 s__attr__tag)))))))

;; H
  (assert (not (= (length temp___4892) 0)))
...
;; H
  (assert
  (=> (<= (to_rep1 (first temp___4891)) (to_rep1 (last temp___4891)))
  (= o1 (+ (- (to_rep1 (last temp___4891)) (to_rep1 (first temp___4891))) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 (first temp___4891)) (to_rep1 (last temp___4891))))
  (= o1 0)))
...
;; H
  (assert (= o3 (+ (to_rep1 (first temp___4891)) o2)))
