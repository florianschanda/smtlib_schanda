...
(declare-fun temp___1294 () (Array Int octet))

(declare-fun temp___12941 () t4)

(declare-fun temp___1295 () (Array Int octet))

(declare-fun temp___12951 () t3)

(declare-fun temp___1297 () us_t3)

(declare-fun o3 () us_t)

(declare-fun o4 () us_split_fields)

(declare-fun temp___1299 () us_rep)

(declare-fun temp___1307 () us_t6)

(declare-fun temp___1308 () us_t5)

(declare-fun temp___1310 () us_t5)

(declare-fun o5 () us_t)

(declare-fun o6 () us_split_fields)

(declare-fun temp___1312 () us_rep)
...
;; H
  (assert
  (= (to_rep2 (first9 (rt4 (temp___1287 ((_ int2bv 8) 0) 1 r135b)))) 1))

;; H
  (assert
  (= (to_rep2 (last10 (rt4 (temp___1287 ((_ int2bv 8) 0) 1 r135b)))) 
  r135b))

;; H
  (assert
  (= (mk___t4 temp___1294 temp___12941) (temp___1287 ((_ int2bv 8) 0) 1
                                        r135b)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first9 temp___12941)) (to_rep2 (last10 temp___12941)))
     (+ (- (to_rep2 (last10 temp___12941)) (to_rep2 (first9 temp___12941))) 1)
...
;; H
  (assert
  (= (mk3 (to_rep2 (first9 temp___12941)) (to_rep2 (last10 temp___12941))) 
  temp___12951))

;; H
  (assert
  (= (ite (<= (to_rep2 (first7 temp___12951)) (to_rep2 (last8 temp___12951)))
     (+ (- (to_rep2 (last8 temp___12951)) (to_rep2 (first7 temp___12951))) 1)
...
;; H
  (assert
  (= o3 (mk___t (elts3 temp___1297)
        (mk (to_rep2 (first7 (rt3 temp___1297)))
        (to_rep2 (last8 (rt3 temp___1297)))))))
...
;; H
  (assert
  (= (to_rep2 (first13 (rt6 (temp___1300 ((_ int2bv 8) 0) 1 r139b)))) 1))

;; H
  (assert
  (= (to_rep2 (last14 (rt6 (temp___1300 ((_ int2bv 8) 0) 1 r139b)))) 
  r139b))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first13 (rt6 temp___1307))) (to_rep2
                                                    (last14
                                                    (rt6 temp___1307))))
     (+ (- (to_rep2 (last14 (rt6 temp___1307))) (to_rep2
                                                (first13 (rt6 temp___1307)))) 1)
     0) (ite (<= 1 r139b) (+ (- r139b 1) 1) 0)))

;; H
  (assert
  (= temp___1308 (mk___t5 (elts6 temp___1307)
                 (mk5 (to_rep2 (first13 (rt6 temp___1307)))
                 (to_rep2 (last14 (rt6 temp___1307)))))))

;; H
  (assert
  (= (ite (<= (to_rep2 (first11 (rt5 temp___1308))) (to_rep2
                                                    (last12
                                                    (rt5 temp___1308))))
     (+ (- (to_rep2 (last12 (rt5 temp___1308))) (to_rep2
                                                (first11 (rt5 temp___1308)))) 1)
...
;; H
  (assert
  (= o5 (mk___t (elts5 temp___1310)
        (mk (to_rep2 (first11 (rt5 temp___1310)))
        (to_rep2 (last12 (rt5 temp___1310)))))))
