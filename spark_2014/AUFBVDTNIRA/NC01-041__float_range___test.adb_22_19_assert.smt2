...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral1) (= (tqtreal fliteral1) 32.0)))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral2) (/ 999999974737875163555145263671875.0 10000000000000000000000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral3) (/ 1500000013038516044616699218750.0 1000000000000000000000000000000000.0))))

(declare-fun value () t)

(declare-fun value1 () t)

(declare-fun value2 () t)

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (in_range2 value)))

;; H
  (assert (in_range2 value1))

;; H
  (assert (and (le (neg fliteral2) value1) (le value1 fliteral2)))

;; H
  (assert (in_range2 value2))

(assert
;; WP_parameter_def
 ;; File "test.adb", line 7, characters 0-0
  (not (le (neg fliteral3) value2)))
(check-sat)
