...
;; H
  (assert (islocked__function_guard (islocked currentlatch1) currentlatch1))
...
;; H
  (assert (in_range10 currentlatch1))

;; H
  (assert (islocked__function_guard (islocked currentlatch1) currentlatch1))

;; H
  (assert (= (islocked currentlatch1) true))
