...
(declare-fun temp___536 () Int)

(declare-fun temp___534 () (Array Int us_rep))
...
(declare-fun temp___541 () us_rep2)

(declare-fun o27 () us_rep1)

(declare-fun o28 () us_split_fields2)

(declare-fun temp___540 () us_rep2)
...
(declare-fun data8 () (Array Int us_rep))
...
(declare-fun model____split_fields7 () us_split_fields__ref1)

(declare-fun r12 () int__ref)

(declare-fun model____split_fields8 () us_split_fields2)

(declare-fun r13 () Int)

(define-fun model____split_fields9 () us_split_fields__ref1 (mk___split_fields__ref1
                                                            (mk___split_fields1
...
;; H
  (assert (is_add__function_guard (is_add model____split_fields r8 o27)
  model____split_fields r8 o27))

;; H
  (assert
  (forall ((rr Int)) (mem__function_guard
  (mem (rec__list_allocator__m__t__available model____split_fields4) rr)
  (rec__list_allocator__m__t__available model____split_fields4) rr)))
...
;; H
  (assert (=> (and (<= 1 r2) (<= r2 3)) (= temp___536 r2)))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 3)) (= temp___534 data1)))

;; H
  (assert
  (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= (to_rep o10) (- r2 1)))))

;; H
  (assert
  (=> (and (<= 1 r2) (<= r2 3))
  (=> (< 1 r2)
  (= (rec__list_allocator__cell__stat (us_split_fields1 (select data1 r2))) 
  o11))))
...
;; H
  ...
  (=> (and (<= 1 r2) (<= r2 3))
  (=> (< 1 r2)
  (= (rec__list_allocator__cell__next (us_split_fields1 (select data1 r2))) 
  o13))))
...
;; H
  ...
  (=> (and (<= 1 r2) (<= r2 3))
  (=> (< 1 r2)
  (= o17 (store data1 r2 (mk___rep (mk___split_fields o14 o15 o16)))))))

;; H
  (assert
  (=> (and (<= 1 r2) (<= r2 3))
  (=> (< 1 r2) (= result4 (mk_map__ref data1)))))
...
;; H
  (assert
  (=> (and (<= 1 r2) (<= r2 3))
  (=> (< r2 3) (and (= o18 (+ r2 1)) (in_range2 (+ r2 1))))))
...
;; H
  ...
  (=> (and (<= 1 r2) (<= r2 3))
  (=> (< r2 3)
  (= (rec__list_allocator__cell__stat (us_split_fields1 (select data2 r2))) 
  o20))))
...
;; H
  ...
  (=> (and (<= 1 r2) (<= r2 3))
  (=> (< r2 3)
  (= (rec__list_allocator__cell__prev (us_split_fields1 (select data2 r2))) 
  o21))))
...
;; H
  ...
  (=> (and (<= 1 r2) (<= r2 3))
  (=> (< r2 3)
  (= o26 (store data2 r2 (mk___rep (mk___split_fields o23 o24 o25)))))))

;; H
  (assert
  (=> (and (<= 1 r2) (<= r2 3))
  (=> (< r2 3) (= result5 (mk_map__ref data2)))))
...
;; H
  ...
  (ite (< r3 temp___535)
  (= (select data4 temp___535) (select temp___534 temp___535))
  (= (rec__list_allocator__cell__stat
     (us_split_fields1 (select data4 temp___535))) (rec__list_allocator__cell__stat
                                                   (us_split_fields1
                                                   (select temp___534 temp___535)))))))
...
;; H
  (assert (=> (and (<= 1 r8) (<= r8 3)) (= temp___542 r8)))

;; H
  (assert
  (=> (and (<= 1 r8) (<= r8 3))
  (= temp___541 (mk___rep1
...
;; H
  ...
  (=> (and (<= 1 r8) (<= r8 3))
  (and
  (and (= o27 (add model____split_fields r8)) (add__function_guard o27
  model____split_fields r8)) (= (is_add model____split_fields r8 o27) true))))

;; H
  (assert
  (=> (and (<= 1 r8) (<= r8 3))
  (= o28 (mk___split_fields1 o27 model____split_fields1))))

;; H
  (assert (=> (and (<= 1 r8) (<= r8 3)) (= temp___540 (mk___rep1 o28))))

;; H
  (assert (=> (and (<= 1 r8) (<= r8 3)) (= result7 model____split_fields9)))

;; H
  (assert
  (=> (and (<= 1 r8) (<= r8 3))
  (= model____split_fields3 (us_split_fields3 temp___540))))
...
;; H
  ...
  (forall ((rr Int))
  (=> (and (<= 1 rr) (<= rr r9))
  (= (mem (rec__list_allocator__m__t__available model____split_fields4) rr) true)))))
...
;; H
  ...
  (and
  (and
  (= (rec__list_allocator__m__t__allocated model____split_fields4) (rec__list_allocator__m__t__allocated
                                                                   (us_split_fields3
                                                                   temp___541)))
  (=> (<= 1 3) (in_range3 r9))) (and (<= 1 r9) (<= r9 3)))))

;; H
  (assert (=> (and (<= 1 r8) (<= r8 3)) (= r9 3)))

;; H
  (assert (=> (and (<= 1 r8) (<= r8 3)) (= r10 (mk_int__ref r9))))
...
;; H
  (assert (=> (and (<= 1 r8) (<= r8 3)) (= r11 r9)))

;; H
  (assert
  (=> (and (<= 1 r8) (<= r8 3))
  (= model____split_fields6 model____split_fields4)))

;; H
  (assert (=> (and (<= 1 r8) (<= r8 3)) (= r12 r10)))

;; H
  (assert
  (=> (and (<= 1 r8) (<= r8 3))
  (= model____split_fields7 model____split_fields5)))

;; H
  (assert (=> (and (<= 1 r8) (<= r8 3)) (= r13 r11)))

;; H
  (assert
  (=> (and (<= 1 r8) (<= r8 3))
  (= model____split_fields8 model____split_fields6)))

;; H
  (assert (=> (not (and (<= 1 r8) (<= r8 3))) (= r12 (mk_int__ref r8))))

;; H
  (assert
  (=> (not (and (<= 1 r8) (<= r8 3)))
  (= model____split_fields7 model____split_fields9)))

;; H
  (assert (=> (not (and (<= 1 r8) (<= r8 3))) (= r13 r8)))

;; H
  (assert
  (=> (not (and (<= 1 r8) (<= r8 3)))
  (= model____split_fields8 model____split_fields2)))

;; H
  (assert
  (and
  (and (= result8 (all_available (map__content data7)))
  (all_available__function_guard result8 (map__content data7)))
  (= (= result8 true)
  (forall ((r14 Int))
  (=> (and (<= 1 r14) (<= r14 3))
  (= (to_rep1
     (rec__list_allocator__cell__stat
     (us_split_fields1 (select (map__content data7) r14)))) 0))))))

;; H
  (assert (all_available__function_guard (all_available (map__content data7))
  (map__content data7)))

(assert
;; WP_parameter_def
 ;; File "list_allocator.adb", line 16, characters 0-0
  (not (= (all_available (map__content data7)) true)))
(check-sat)
