...
;; H
  (assert
  (forall ((j1 Int)) (get__function_guard (get ma1 (+ j1 1)) ma1 (+ j1 1))))
...
;; H
  ...
  (= (bool_eq5
     (select data3 (get
                   (rec__list_allocator__m__t__available
                   model____split_fields3) j1))
     (select data3 (get ma1 (+ j1 1)))) true))))
...
;; H
  (assert
  (forall ((j1 Int)) (get__function_guard (get ma1 (+ j1 2)) ma1 (+ j1 2))))

;; H
  (assert
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 (- (length ma1) 2)))
  (= (to_rep
     (rec__list_allocator__cell__next
     (us_split_fields1 (select data3 (get ma1 (+ j1 1)))))) (get ma1
                                                            (+ j1 2))))))
...
;; H
  ...
  (and (<= 1 j1)
  (<= j1 (- (length
            (rec__list_allocator__m__t__available model____split_fields3)) 1)))
  (= (to_rep
     (rec__list_allocator__cell__next
     (us_split_fields1 (select data3 (get ma1 (+ j1 1)))))) (get ma1
                                                            (+ j1 2))))))
...
;; H
  ...
  (= (to_rep
     (rec__list_allocator__cell__next
     (us_split_fields1 (select data3 (get ma1 (+ j1 1)))))) (ite (< j1 
                                                            (length
                                                            (rec__list_allocator__m__t__available
                                                            model____split_fields3)))
                                                            (get ma1
...
;; H
  (assert
  (forall ((r Int)) (mem__function_guard
  (mem (rec__list_allocator__m__t__available model____split_fields3) r)
  (rec__list_allocator__m__t__available model____split_fields3) r)))

;; H
  (assert
  (forall ((r Int)) (mem__function_guard
  (mem (rec__list_allocator__m__t__allocated model____split_fields3) r)
  (rec__list_allocator__m__t__allocated model____split_fields3) r)))
...
;; H
  ...
  (= o51 (length
         (rec__list_allocator__m__t__available model____split_fields3)))
  (length__function_guard o51
  (rec__list_allocator__m__t__available model____split_fields3))) (in_range6
  o51))))

;; H
  (assert
  (=> (not (= first_available1 0)) (= result12 (ite (< 0 o51) true false))))
...
;; H
  ...
  (and
  (and
  (= o50 (get (rec__list_allocator__m__t__available model____split_fields3)
         1))
  (get__function_guard o50
  (rec__list_allocator__m__t__available model____split_fields3) 1))
  (in_range7 o50)))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result12 true)
  (= result11 (ite (= o50 first_available1) true false)))))
...
;; H
  (assert
  (=> (not (not (= first_available1 0)))
  (= result11 (ite (= o52 0) true false))))

;; H
  (assert
  (=> (= result11 true)
  (=> (not (= first_allocated1 0))
  (and
  (and
  (= o48 (length
         (rec__list_allocator__m__t__allocated model____split_fields3)))
  (length__function_guard o48
  (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6
  o48)))))

;; H
  (assert
  (=> (= result11 true)
  (=> (not (= first_allocated1 0)) (= result13 (ite (< 0 o48) true false)))))
...
;; H
  ...
  (= o47 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         1))
  (get__function_guard o47
  (rec__list_allocator__m__t__allocated model____split_fields3) 1))
  (in_range7 o47))))))
...
;; H
  ...
  (=> (not (= first_allocated1 0))
  (=> (= result13 true)
  (= result10 (ite (= o47 first_allocated1) true false))))))

;; H
  (assert
  (=> (= result11 true)
  (=> (not (= first_allocated1 0))
  (=> (not (= result13 true)) (= result10 false)))))

;; H
  (assert
  (=> (= result11 true)
  (=> (not (not (= first_allocated1 0)))
  (and
  (and
  (= o49 (length
         (rec__list_allocator__m__t__allocated model____split_fields3)))
  (length__function_guard o49
  (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6
  o49)))))
...
;; H
  (assert (= result14 (ite (<= 1 j) o44 false)))
...
;; H
  ...
  (and
  (and
  (= o46 (get (rec__list_allocator__m__t__available model____split_fields3)
         j))
  (get__function_guard o46
  (rec__list_allocator__m__t__available model____split_fields3) j))
  (in_range7 o46)))

;; H
  (assert (= result15 (ite (in_range4 o46) true false)))
...
;; H
  ...
  (= o45 (length
         (rec__list_allocator__m__t__available model____split_fields3)))
  (length__function_guard o45
  (rec__list_allocator__m__t__available model____split_fields3))) (in_range6
  o45)))

;; H
  (assert (= result16 (ite (< j o45) true false)))
