...
;; H
  (assert (=> (= result17 true) (= temp___1239 temp___1235)))
...
;; H
  ...
  (= (select o25 temp___1240) (select result__10 temp___1240))))))
...
;; H
  (assert (=> (not (= result17 true)) (= temp___1234 thestring1)))

;; H
  (assert (=> (not (= result17 true)) (= o26 (elts temp___1234))))
