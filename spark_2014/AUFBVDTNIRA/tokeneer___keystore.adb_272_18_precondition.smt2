...
(define-fun result__15 () map__ref (mk_map__ref result__))
...
;; H
  (assert (=> (= (select issystem retvalini1) true) (= result11 result__15)))
...
;; H
  (assert
  (=> (not (= (select issystem retvalini1) true)) (= result__8 result__15)))
...
;; H
  (assert (=> (= result17 true) (= temp___1257 temp___1253)))
...
;; H
  ...
  (= (select o25 temp___1258) (select result__10 temp___1258))))))

;; H
  (assert (=> (= result17 true) (= result18 (mk_map__ref result__10))))

;; H
  (assert (=> (= result17 true) (= result__11 o25)))

;; H
  (assert (=> (= result17 true) (= result__13 (mk_map__ref result__11))))

;; H
  (assert (=> (= result17 true) (= result__14 result__11)))
...
;; H
  (assert (=> (not (= result17 true)) (= temp___1252 thestring1)))

;; H
  (assert (=> (not (= result17 true)) (= o26 (elts temp___1252))))

;; H
  (assert (=> (not (= result17 true)) (= result19 (mk_map__ref result__10))))

;; H
  (assert (=> (not (= result17 true)) (= result__12 o26)))

;; H
  (assert
  (=> (not (= result17 true)) (= result__13 (mk_map__ref result__12))))

;; H
  (assert (=> (not (= result17 true)) (= result__14 result__12)))

;; H
  (assert (= result20 (mk_map__ref c46b)))

;; H
  (assert (= c46b1 (map__content result__13)))

;; H
  (assert (valid_numberlogentries__function_guard
  (valid_numberlogentries (us_private__content state3))
  (us_private__content state3)))

(assert
;; WP_parameter_def
 ;; File "keystore.ads", line 100, characters 0-0
  (not (= (valid_numberlogentries (us_private__content state3)) true)))
(check-sat)
