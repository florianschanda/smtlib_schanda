...
(define-fun dynamic_invariant ((temp___expr_155 Int)
...
(declare-fun x__split_fields () length_t)
...
(declare-fun x__split_fields2 () length_t)

(declare-fun x__split_fields3 () (Array Int integer))
...
(assert
;; WP_parameter_def
 ;; File "private_a.adb", line 77, characters 0-0
  (not (<= 0 (get_length (mk___rep x__split_fields4)))))
(check-sat)
