...
;; H
  (assert
  (=> (<= (to_rep addr__first) (to_rep addr__last))
  (= o6 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
;; H
  ...
  (= o13 (nth8_stream
         ...
         o12))
  (nth8_stream__function_guard o13
  (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) o12))
  (= (= o13 true)
  (= (nth1 (to_rep1 (select addr (div1 o12 8))) (- 7 (mod1 o12 8))) true))))

;; H
  (assert (= o14 (to_int2 o13)))
