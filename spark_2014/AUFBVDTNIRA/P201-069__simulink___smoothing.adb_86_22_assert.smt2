...
(declare-fun smoother_value_out11 () t)

(declare-fun result3 () t)

(declare-fun abs_new_delta_out11 () t)
...
;; H
  (assert
  (and (= o7 (sub RNE2 smoother_value_out11 prior_value)) (tqtisFinite
  (sub RNE2 smoother_value_out11 prior_value))))
...
;; WP_parameter_def
 ;; File "smoothing.ads", line 20, characters 0-0
  (not
  (or (= compare_to_zero_out11 true) (lt abs_new_delta_out11
  abs_delta_out11))))
(check-sat)
