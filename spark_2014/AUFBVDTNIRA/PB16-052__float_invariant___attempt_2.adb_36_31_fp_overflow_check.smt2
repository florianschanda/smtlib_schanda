...
;; low_bound__def_axiom
  ...
  (! (=>
     ...
     (low_bound n1) n1))
     (= (low_bound n1) (sub RNE2
                       (mul RNE2 (of_int RNE2 (* n1 n1)) (neg fliteral2))
...
;; high_bound__def_axiom
  ...
  (! (=>
     ...
     (high_bound n1) n1))
     (= (high_bound n1) (add RNE2
                        (mul RNE2 (of_int RNE2 (* n1 n1)) fliteral2)
...
;; H
  (assert
  (and
  (= o (add RNE2 old_speed (mul RNE2 (mul RNE2 factor fliteral4) fliteral5)))
  (tqtisFinite
  (add RNE2 old_speed (mul RNE2 (mul RNE2 factor fliteral4) fliteral5)))))
...
;; WP_parameter_def
 ;; File "attempt_2.adb", line 21, characters 0-0
  (not (tqtisFinite (add RNE2 old_speed new_speed1))))
(check-sat)
