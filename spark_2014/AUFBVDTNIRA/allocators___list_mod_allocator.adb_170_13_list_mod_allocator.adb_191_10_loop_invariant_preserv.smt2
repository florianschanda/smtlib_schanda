...
;; H
  ...
  (model_is_well_formed o21 data first_available) o21 data first_available))

;; H
  (assert
  (and
  (and (= o21 (model__ data first_available)) (model____function_guard 
  o21 data first_available))
  (= (model_is_well_formed o21 data first_available) true)))
...
;; H
  (assert
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j i2)) (= (get c83b j) (get c84b (+ j 1))))))

;; H
  (assert
  (forall ((j Int))
  (=> (and (<= 2 j) (<= j (+ i2 1))) (= (get c83b (- j 1)) (get c84b j)))))
...
;; H
  ...
  (= (get c84b j) (to_rep
                  (rec__list_mod_allocator__cell__next
                  (us_split_fields1 (select data1 (get c83b i2))))))))))
