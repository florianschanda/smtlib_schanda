...
(define-fun dynamic_invariant1 ((temp___expr_171 Int)
  ...
  (temp___do_toplevel_170 Bool)) Bool (=>
                                      ...
                                      (<= 1 5)) (in_range1 temp___expr_171)))

(declare-fun discr_checks__check_subtype_rec__R1b__assume () Int)

;; H
  (assert
  (and
  (and (= discr_checks__check_subtype_rec__R1b__assume (bad Tuple0))
  (bad__function_guard discr_checks__check_subtype_rec__R1b__assume Tuple0))
  (and (in_range discr_checks__check_subtype_rec__R1b__assume)
