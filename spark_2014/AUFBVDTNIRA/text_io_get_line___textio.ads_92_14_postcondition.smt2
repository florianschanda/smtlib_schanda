...
(declare-fun file__split_fields21 () file_descr)

(declare-fun file__split_fields22 () Bool)

(declare-fun file__split_fields23 () Bool)

(declare-fun file__split_fields24 () count)

(declare-fun file__split_fields25 () count)

(declare-fun file__split_fields26 () count)

(declare-fun file__split_fields27 () Bool)
...
;; H
  ...
  (forall ((idx Int))
  (=> (and (<= 1 idx) (<= idx num1))
  (= (to_rep (select result__ idx)) (to_rep
                                    (select the_file1 (+ (- idx 1) cur_position_at_start))))))
  (and (= cur_position1 (+ cur_position_at_start num1))
  (or (= (to_rep (select the_file1 cur_position1)) eof_ch)
  (= (to_rep (select the_file1 cur_position1)) 10))))
...
;; H
  (assert
  (= (mk___split_fields file__split_fields21 file__split_fields22
     file__split_fields23 file__split_fields24 file__split_fields25
     file__split_fields26 file__split_fields27) (mk___split_fields
                                                file__split_fields7
                                                file__split_fields8
                                                file__split_fields9
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  ...
  (= (to_rep (select result__1 idx)) (to_rep
                                     (select the_file2 (+ (- idx 1) cur_position))))))
(check-sat)
