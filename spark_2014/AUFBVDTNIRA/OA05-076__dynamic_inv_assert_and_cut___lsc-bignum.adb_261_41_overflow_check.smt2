...
(declare-fun temp () (_ BitVec 32))

(declare-fun i () Int)

(declare-fun temp___1704 () (Array Int word32))

(declare-fun temp___1645 () (Array Int word32))

(declare-fun temp___1706 () (Array Int word32))

(declare-fun temp___1708 () (_ BitVec 32))

(declare-fun temp___1709 () (Array Int word32))

(declare-fun temp___1644 () (_ BitVec 32))

(declare-fun temp___1702 () (_ BitVec 32))

(declare-fun temp___1642 () (Array Int word32))

(declare-fun temp___1707 () (_ BitVec 32))

(declare-fun temp___1643 () (_ BitVec 32))

(declare-fun temp___1701 () (_ BitVec 32))

(declare-fun temp___1700 () Int)

(declare-fun temp___1699 () (_ BitVec 32))
...
(declare-fun temp3 () (_ BitVec 32))

(declare-fun i3 () Int)

(declare-fun a5 () (Array Int word32))

(declare-fun carry15 () (_ BitVec 32))

(declare-fun carry25 () (_ BitVec 32))

(declare-fun temp4 () (_ BitVec 32))
...
(declare-fun carry26 () t__ref)

(declare-fun temp5 () t__ref)

(declare-fun i5 () int__ref)

(declare-fun a7 () (Array Int word32))

(declare-fun carry17 () (_ BitVec 32))

(declare-fun carry27 () (_ BitVec 32))

(declare-fun temp6 () (_ BitVec 32))

(declare-fun i6 () Int)

(declare-fun a8 () map__ref)

(declare-fun carry18 () t__ref)

(declare-fun carry28 () t__ref)

(declare-fun temp7 () t__ref)

(declare-fun i7 () int__ref)

(declare-fun a9 () (Array Int word32))

(declare-fun carry19 () (_ BitVec 32))

(declare-fun carry29 () (_ BitVec 32))

(declare-fun temp8 () (_ BitVec 32))
...
;; H
  (assert (from_word32__function_guard (from_word32 carry12) carry12))

;; H
  (assert (base__function_guard (base Tuple0) Tuple0))

;; H
  (assert (from_word32__function_guard (from_word32 carry22) carry22))
...
;; H
  (assert (omultiply__function_guard
  (omultiply (base Tuple0) (from_word32 carry22)) (base Tuple0)
  (from_word32 carry22)))
...
;; H
  ...
  (omultiply (base Tuple0) (from_word32 carry22))) (from_word32 carry12)
...
;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int
  (mk___t temp___1706 (mk (to_rep a__first) (to_rep a__last))) (+ a_first 1)
  (- i2 a_first))
  (mk___t temp___1706 (mk (to_rep a__first) (to_rep a__last))) (+ a_first 1)
  (- i2 a_first)))
...
;; H
  (assert (from_word32__function_guard (from_word32 temp___1707)
  temp___1707))
...
;; H
  (assert (from_word32__function_guard (from_word32 temp___1708)
  temp___1708))
...
;; H
  (assert (omultiply__function_guard
  (omultiply (base Tuple0) (from_word32 temp___1708)) (base Tuple0)
  (from_word32 temp___1708)))
...
;; H
  ...
  (omultiply (num_of_big_int c c_first (- i2 a_first)) (from_word32 y)))
  (from_word32 temp___1707))
  (omultiply (base Tuple0) (from_word32 temp___1708)))
  (oadd
  (oadd
  (oadd
  (num_of_big_int
...
;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int
  (mk___t temp___1642 (mk (to_rep a__first) (to_rep a__last))) (+ a_first 1)
  (- (+ i2 1) a_first))
  (mk___t temp___1642 (mk (to_rep a__first) (to_rep a__last))) (+ a_first 1)
  (- (+ i2 1) a_first)))
...
;; H
  (assert (omultiply__function_guard
  (omultiply (num_of_big_int b b_first (- (+ i2 1) a_first)) (from_word32 x))
  (num_of_big_int b b_first (- (+ i2 1) a_first)) (from_word32 x)))
...
;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int c c_first (- (+ i2 1) a_first)) c c_first
  (- (+ i2 1) a_first)))
...
;; H
  (assert (omultiply__function_guard
  (omultiply (num_of_big_int c c_first (- (+ i2 1) a_first)) (from_word32 y))
  (num_of_big_int c c_first (- (+ i2 1) a_first)) (from_word32 y)))
...
;; H
  (assert (from_word32__function_guard (from_word32 temp___1643)
  temp___1643))
...
;; H
  (assert (from_word32__function_guard (from_word32 temp___1644)
  temp___1644))
...
;; H
  (assert (omultiply__function_guard
  (omultiply (base Tuple0) (from_word32 temp___1644)) (base Tuple0)
  (from_word32 temp___1644)))
...
;; H
  ...
  (omultiply (num_of_big_int c c_first (- (+ i2 1) a_first)) (from_word32 y)))
  (from_word32 temp___1643))
  (omultiply (base Tuple0) (from_word32 temp___1644)))
  (oadd
  (oadd
  (oadd
  (num_of_big_int
...
;; H
  (assert (from_word32__function_guard (from_word32 carry13) carry13))

;; H
  (assert (base__function_guard (base Tuple0) Tuple0))

;; H
  (assert (from_word32__function_guard (from_word32 carry23) carry23))
...
;; H
  (assert (omultiply__function_guard
  (omultiply (base Tuple0) (from_word32 carry23)) (base Tuple0)
  (from_word32 carry23)))
...
;; H
  ...
  (omultiply (base Tuple0) (from_word32 carry23))) (from_word32 carry13)
  (omultiply (base Tuple0) (from_word32 carry23))))
...
;; H
  ...
  (oadd (from_word32 carry13)
  (omultiply (base Tuple0) (from_word32 carry23))))
  (oexpon (base Tuple0) (- (+ i2 1) a_first))
  (oadd (from_word32 carry13)
  (omultiply (base Tuple0) (from_word32 carry23)))))
...
;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___1704 a)))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___1645 a)))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___1706 a)))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___1708 carry2)))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___1709 a)))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___1644 carry2)))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___1702 carry2)))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___1642 a)))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___1707 carry1)))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___1643 carry1)))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___1701 carry1)))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___1700 i1)))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___1699 temp)))
...
;; H
  ...
  (= (oeq
     ...
     (oadd
     (num_of_big_int
     (mk___t temp___1706 (mk (to_rep a__first) (to_rep a__last)))
     (+ a_first 1) (- i2 a_first))
     (omultiply (num_of_big_int b b_first (- i2 a_first)) (from_word32 x)))
     (omultiply (num_of_big_int c c_first (- i2 a_first)) (from_word32 y)))
     (from_word32 temp___1707))
  ...
  (forall ((k Int))
  (=> (and (<= i2 k) (<= k (+ a_last 1)))
  (= (to_rep1 (select a2 k)) (to_rep1 (select temp___1709 k))))))))
...
;; H
  ...
  (=> (<= i2 temp___1705)
  (= (select a2 temp___1705) (select temp___1704 temp___1705))))))
...
;; H
  ...
  (= (to_rep1 (select a3 k)) (to_rep1 (select temp___1645 k))))))))
...
;; H
  (assert
  (and (= o35 (from_word32 (t__content carry28)))
  (from_word32__function_guard o35 (t__content carry28))))

;; H
  (assert
  (and (and (= o34 (base Tuple0)) (base__function_guard o34 Tuple0))
  (= o34 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o36 (omultiply o34 o35)) (omultiply__function_guard o36 o34 o35)))

;; H
  (assert
  (and (= o33 (from_word32 (t__content carry18)))
  (from_word32__function_guard o33 (t__content carry18))))

;; H
  (assert (and (= o37 (oadd o33 o36)) (oadd__function_guard o37 o33 o36)))

;; H
  (assert (and (= o28 (- a_last a_first)) (in_range1 (- a_last a_first))))
...
;; H
  (assert
  (and (and (= o27 (base Tuple0)) (base__function_guard o27 Tuple0))
  (= o27 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o32 (oexpon o27 o31)) (oexpon__function_guard o32 o27 o31)))

;; H
  (assert
  (and (= o38 (omultiply o32 o37)) (omultiply__function_guard o38 o32 o37)))

;; H
  (assert (and (= o22 (- a_last a_first)) (in_range1 (- a_last a_first))))
...
;; H
  ...
  (= o26 (num_of_big_int
         ...
         a_first o25))
  (num_of_big_int__function_guard o26
  (mk___t (map__content a8) (mk (to_rep a__first) (to_rep a__last))) 
  a_first o25)))

;; H
  (assert (and (= o39 (oadd o26 o38)) (oadd__function_guard o39 o26 o38)))
...
;; H
  (assert
  (and (= o20 (from_word32 carry2)) (from_word32__function_guard o20 carry2)))

;; H
  (assert
  (and (and (= o19 (base Tuple0)) (base__function_guard o19 Tuple0))
  (= o19 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o21 (omultiply o19 o20)) (omultiply__function_guard o21 o19 o20)))

;; H
  (assert
  (and (= o18 (from_word32 carry1)) (from_word32__function_guard o18 carry1)))

;; H
  (assert (and (= o16 (from_word32 y)) (from_word32__function_guard o16 y)))

;; H
  (assert (and (= o11 (- a_last a_first)) (in_range1 (- a_last a_first))))
...
;; H
  (assert
  (and (= o15 (num_of_big_int c c_first o14)) (num_of_big_int__function_guard
  o15 c c_first o14)))

;; H
  (assert
  (and (= o17 (omultiply o15 o16)) (omultiply__function_guard o17 o15 o16)))

;; H
  (assert (and (= o9 (from_word32 x)) (from_word32__function_guard o9 x)))

;; H
  (assert (and (= o4 (- a_last a_first)) (in_range1 (- a_last a_first))))
...
;; H
  (assert
  (and (= o8 (num_of_big_int b b_first o7)) (num_of_big_int__function_guard
  o8 b b_first o7)))

;; H
  (assert
  (and (= o10 (omultiply o8 o9)) (omultiply__function_guard o10 o8 o9)))
