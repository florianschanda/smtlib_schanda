...
;; low_bound__def_axiom
  ...
  (! (=> (dynamic_invariant1 n1 true true true)
     (= (low_bound n1) (mul RNE1 (mul RNE1 (of_int RNE1 n1) (neg fliteral2))
...
;; high_bound__def_axiom
  ...
  (forall ((n1 Int))
  (! (=> (dynamic_invariant1 n1 true true true)
     (= (high_bound n1) (mul RNE1 (mul RNE1 (of_int RNE1 n1) fliteral2)
...
;; H
  (assert
  (and
  (= o (add RNE1 old_speed (mul RNE1 (mul RNE1 factor fliteral2) fliteral3)))
  (tqtisFinite
  (add RNE1 old_speed (mul RNE1 (mul RNE1 factor fliteral2) fliteral3)))))
...
;; H
  (assert (= o2 (div1 RNE1 o1 fliteral4)))
