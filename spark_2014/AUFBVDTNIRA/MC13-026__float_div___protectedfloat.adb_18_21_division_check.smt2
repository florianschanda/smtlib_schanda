...
(declare-fun dummy () trealB)

(declare-datatypes ()
((trealB__ref (mk_trealB__ref (trealB__content trealB)))))
(define-fun trealB__ref___projection ((a trealB__ref)) trealB (trealB__content
                                                              a))
...
(declare-fun dummy1 () real__)

(declare-datatypes ()
((real____ref (mk_real____ref (real____content real__)))))
(define-fun real____ref___projection ((a real____ref)) real__ (real____content
                                                              a))
...
;; H
  (assert (and (le fliteral2 left) (le fliteral2 right)))

;; H
  (assert (not (lt right fliteral)))
