...
(declare-fun temp___2977 ((Array Int us_rep2) Int
  us_rep2) (Array Int us_rep2))

;; def_axiom
  (assert
  (forall ((temp___2979 (Array Int us_rep2)))
  (forall ((temp___2980 Int))
  (forall ((temp___2981 us_rep2))
  (let ((temp___2978 (temp___2977 temp___2979 temp___2980 temp___2981)))
  (forall ((temp___2982 Int))
  (ite (= temp___2982 temp___2980)
  (= (select temp___2978 temp___2982) temp___2981)
  (= (select temp___2978 temp___2982) (select temp___2979 temp___2982)))))))))
...
(declare-fun o33 () (Array Int us_rep2))
...
;; H
  ...
  (= (rec__ar__rec1t__g1
     (us_split_fields1
     (rec__ar__rec2t__g2
     (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select a i))))))) 
  o2))
...
;; H
  (assert
  (= (rec__ar__rec5t__h5 (us_split_fields5 (select a i))) (mk___rep
                                                          (mk___split_fields
                                                          o18 o19))))
...
;; H
  (assert
  (= o27 (store a i (mk___rep2
                    (mk___split_fields2
                    (mk___rep1
                    (mk___split_fields1 o20
                    (mk___rep (mk___split_fields o21 o22)) o23)) o24
...
;; H
  ...
  (= o29 (mk___split_fields o28
         (rec__ar__rec1t__g1
         (us_split_fields1
         (rec__ar__rec5t__h5 (us_split_fields5 (select a1 i))))))))
...
;; H
  ...
  (= o31 (mk___split_fields2
         (rec__ar__rec5t__f5 (us_split_fields5 (select a1 i)))
         (rec__ar__rec5t__g5 (us_split_fields5 (select a1 i))) o30)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1395, characters 0-0
  (not
  (= (bool_eq8 (map__content a3) 90 99
     (temp___2977 a i
     (mk___rep2
     (mk___split_fields2
     (mk___rep1
     (let ((usq_ (us_split_fields3
                 (rec__ar__rec5t__f5 (us_split_fields5 (select a i))))))
     ...
     (rec__ar__rec2t__g2
     (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select a i)))))))))
     (rec__ar__rec2t__h2 usq_))))
     (rec__ar__rec5t__g5 (us_split_fields5 (select a i)))
     (mk___rep
     (mk___split_fields (of_rep g)
     (rec__ar__rec1t__g1
     (us_split_fields1 (rec__ar__rec5t__h5 (us_split_fields5 (select a i))))))))))
     90 99) true)))
(check-sat)
