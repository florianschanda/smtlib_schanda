...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral4) (= (tqtreal fliteral4) 17.0)))

(declare-fun fliteral5 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral5) (= (tqtreal fliteral5) 315.0)))
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral7) (= (tqtreal fliteral7) 15.0)))

(declare-fun fliteral8 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral8) (= (tqtreal fliteral8) 3.0)))
...
;; H
  (assert (= o14 (mul RNE2 fliteral2 o13)))

;; H
  (assert (and (= o15 o14) (tqtisFinite o14)))

;; H
  (assert (= o16 (div1 RNE2 o15 fliteral3)))
...
;; H
  (assert (= o10 (mul RNE2 fliteral4 o9)))

;; H
  (assert (and (= o11 o10) (tqtisFinite o10)))

;; H
  (assert (= o12 (div1 RNE2 o11 fliteral5)))

;; H
  (assert
  (and (and (= o3 (pow5 x)) (pow5__function_guard o3 x))
  (and (tqtisFinite o3)
  (= o3 (mul RNE2 (mul RNE2 (mul RNE2 (mul RNE2 x x) x) x) x)))))

;; H
  (assert (= o4 (mul RNE2 fliteral6 o3)))

;; H
  (assert (and (= o5 o4) (tqtisFinite o4)))

;; H
  (assert (= o6 (div1 RNE2 o5 fliteral7)))
...
;; H
  (assert (= o1 (div1 RNE2 o fliteral8)))

;; H
  (assert (= o2 (add RNE2 x o1)))

;; H
  (assert (and (= o7 o2) (tqtisFinite o2)))

;; H
  (assert (= o8 (add RNE2 o7 o6)))
