...
(define-fun o30 () us_rep3 (mk___rep3
                           (mk___split_fields3
...
;; H
  ...
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields2))) temp___1055) true)
  (= (get1
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields2))) temp___1055) 1)))))))
...
;; WP_parameter_def
 ;; File "algorithm.adb", line 556, characters 0-0
  ...
  (= (has_key
     ...
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields2)))
     (mk___rep5 iterr__split_fields5)) true)))
(check-sat)
