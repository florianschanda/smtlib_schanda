...
;; H
  ...
  (<= j (last5
        (model__
        (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields4)) j) (get
                                                                   (model__
                                                                   (mk___rep
                                                                   v__split_discrs
                                                                   (mk___split_fields
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= first j) (<= j (- i2 1)))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields4))
     (+ j (length
          (mk___rep v__split_discrs (mk___split_fields v__split_fields))))) 
  (get
  (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) j)))))

;; H
  (assert
  (and
  (and (=> (<= first r17b) (dynamic_property6 first r17b i2))
...
;; H
  ...
  (= (olt (model__ (mk___rep v__split_discrs v__split_fields4))
     (model__ (mk___rep v__split_discrs v__split_fields3))) true))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields3))
     (+ (last5 (model__ (mk___rep v__split_discrs v__split_fields4))) 1)) 
...
;; WP_parameter_def
 ;; File "use_vectors.ads", line 43, characters 0-0
  (not
  (= (get (model__ (mk___rep v__split_discrs v__split_fields3)) j) (get
                                                                   (model__
                                                                   (mk___rep
                                                                   v__split_discrs
                                                                   (mk___split_fields
