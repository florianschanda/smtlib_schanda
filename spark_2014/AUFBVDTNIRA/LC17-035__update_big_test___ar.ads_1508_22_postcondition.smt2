...
(declare-fun user_eq (enum2t enum2t) Bool)

(declare-fun dummy () enum2t)
...
(define-fun dynamic_invariant ((temp___expr_206 Int)
  ...
  (temp___do_toplevel_205 Bool)) Bool (=>
                                      ...
                                      (<= 0 5)) (in_range temp___expr_206)))

(declare-fun to_rep (enum2t) Int)

(declare-fun of_rep (Int) enum2t)

;; inversion_axiom
  (assert
  (forall ((x enum2t)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)) )))

;; range_axiom
  (assert
  (forall ((x enum2t)) (! (in_range (to_rep x)) :pattern ((to_rep x)) )))
...
(define-fun bool_eq3 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        ...
                        (= (to_rep (rec__ar__rofa1__t1 (us_split_fields1 a))) 
                        (to_rep (rec__ar__rofa1__t1 (us_split_fields1 b)))))
                   true false))
...
(declare-fun temp___8081 () (Array Int et1))

(declare-fun temp___80811 () enum2t)
...
;; H
  (assert (= temp___8081 o1))

;; H
  (assert (= temp___80811 o2))
...
;; H
  (assert (= temp___8081 r__split_fields4))

;; H
  (assert (= temp___80811 r__split_fields5))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1501, characters 0-0
  (not
  (= (bool_eq3
     (mk___rep (mk___split_fields r__split_fields6 r__split_fields7))
     (mk___rep (mk___split_fields a (of_rep e)))) true)))
(check-sat)
