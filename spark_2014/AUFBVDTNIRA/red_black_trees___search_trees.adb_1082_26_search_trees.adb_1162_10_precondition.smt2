...
;; H
  (assert
  (and
  (= o25 (to_rep1 (rec__search_trees__search_tree__root t__split_fields10)))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root t__split_fields10)))))
...
;; H
  (assert
  (and
  (and (= temp___1991 (model__ (mk___rep2 f_old__split_fields2) o25))
  (model____function_guard temp___1991 (mk___rep2 f_old__split_fields2) 
  o25))
  (and (dynamic_invariant6 temp___1991 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1991 o25))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1991 o25)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o25))
...
;; H
  (assert (= o26 (select temp___1991 y1)))
...
;; H
  (assert
  (and
  (= o21 (to_rep1 (rec__search_trees__search_tree__root t__split_fields10)))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root t__split_fields10)))))
...
;; H
  ...
  (rec__search_trees__search_tree__struct t__split_fields10) o21))
  (and (dynamic_invariant6 temp___1990 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1990 o21))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1990 o21)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o21))
...
;; H
  (assert (= o22 (select temp___1990 x1)))
...
;; H
  (assert
  (and
  (and (= temp___1989 (model__ (mk___rep2 f_old__split_fields2) o17))
  (model____function_guard temp___1989 (mk___rep2 f_old__split_fields2) 
  o17))
  (and (dynamic_invariant6 temp___1989 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1989 o17))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1989 o17)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o17))
...
;; H
  (assert (= o18 (select temp___1989 j2)))
...
;; H
  (assert (valid_root__function_guard
  (valid_root (rec__search_trees__search_tree__struct t__split_fields10) o16)
