...
;; H
  (assert
  (and (= o20 (- offset8 initial_offset1)) (in_range1
...
;; H
  (assert (= o23 (ite (= shift2 o22) true false)))

;; H
  (assert
  (=> (<= (to_rep data__first) (to_rep data__last))
  (= o19 (+ (- (to_rep data__last) (to_rep data__first)) 1))))

;; H
  (assert (=> (not (<= (to_rep data__first) (to_rep data__last))) (= o19 0)))
