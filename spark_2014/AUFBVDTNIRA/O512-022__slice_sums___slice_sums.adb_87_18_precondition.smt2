...
;; H
  ...
  (<= (sum__logic x
      (mk_slice_bounds
      (mk___split_fields (of_rep1 lo_index1) (of_rep2 hi_index)))) max_sum2))))))
...
;; WP_parameter_def
 ;; File "sums.ads", line 12, characters 0-0
  (not
  (or
  (< (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o8))) (to_rep1
                                                                   (rec__sums__slice_bounds__lo
                                                                   (us_split_fields1
                                                                   o8))))
  (and
  (<= (to_rep3 (first (rt x))) (to_rep1
                               (rec__sums__slice_bounds__lo
                               (us_split_fields1 o8))))
  (<= (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o8))) (to_rep3
                                                                    (last
                                                                    (rt x))))))))
(check-sat)
