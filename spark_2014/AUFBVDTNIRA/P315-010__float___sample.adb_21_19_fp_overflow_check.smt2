...
;; H
  (assert (= tmp11 (mul RNE1 (of_int RNE1 nb_of_fp) delta_time)))

;; H
  (assert
  (and (= o2 (add RNE1 t_fp1 tmp11)) (tqtisFinite (add RNE1 t_fp1 tmp11))))
...
;; H
  (assert
  (= tmp21 (mul RNE1 (mul RNE1 fliteral7 (of_int RNE1 nb_of_fp)) delta_time)))

(assert
;; WP_parameter_def
 ;; File "sample.ads", line 13, characters 0-0
  (not (tqtisFinite (add RNE1 t_pp1 tmp21))))
(check-sat)
