...
(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result () Int)

(declare-fun o () Int)

(declare-fun result () Int)

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result1 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result2 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result3 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result4 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result5 () Int)
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result1 
  bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result2))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result3 
  bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result1))
...
;; H
  (assert
  (= result bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result))
...
;; H
  (assert
  (= (mk_int__ref
     bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result4) 
  (mk_int__ref
  bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result2)))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result5 
  bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result3))

;; H
  (assert
  (= result1 bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result4))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 10, characters 0-0
  (not
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_64__functions__msb_index_fast_inline__result4) ((_ int2bv 64) 1))))
(check-sat)
