...
;; H
  (assert
  (and
  (and (= temp___1592 (model__ (mk___rep2 f_old__split_fields2) o24))
  (model____function_guard temp___1592 (mk___rep2 f_old__split_fields2) 
  o24))
  (and (dynamic_invariant6 temp___1592 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1592 o24))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1592 o24)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o24))
...
;; H
  (assert (= o25 (select temp___1592 x1)))
...
;; H
  ...
  (rec__search_trees__search_tree__struct t__split_fields10) o20))
  (and (dynamic_invariant6 temp___1591 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1591 o20))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1591 o20)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o20))
...
;; H
  (assert (= o21 (select temp___1591 y1)))
...
;; H
  (assert
  (and
  (and (= temp___1590 (model__ (mk___rep2 f_old__split_fields2) o16))
  (model____function_guard temp___1590 (mk___rep2 f_old__split_fields2) 
  o16))
  (and (dynamic_invariant6 temp___1590 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1590 o16))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1590 o16)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o16))
...
;; H
  (assert (= o17 (select temp___1590 j2)))
