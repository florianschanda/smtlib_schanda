...
;; H
  (assert
  (and (= temp___864 (model__ (mk___rep2 f_old__split_fields2) o24))
  (and (dynamic_invariant6 temp___864 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___864 o24))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___864 o24)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o24))
...
;; H
  (assert (= o25 (select temp___864 x1)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___863 o20))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___863 o20)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o20))
...
;; H
  (assert (= o21 (select temp___863 y1)))
...
;; H
  (assert
  (and (= temp___862 (model__ (mk___rep2 f_old__split_fields2) o16))
  (and (dynamic_invariant6 temp___862 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___862 o16))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___862 o16)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o16))
...
;; H
  (assert (= o17 (select temp___862 j2)))
