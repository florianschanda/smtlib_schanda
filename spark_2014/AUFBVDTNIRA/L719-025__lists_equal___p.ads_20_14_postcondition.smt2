...
;; H
  ...
  (ite (= (ite (= (bool_eq3 (mk___rep1 (mk___split_fields1 cu__split_fields))
  ...
  (= (bool_eq3 p__nearly_identity__prev__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
...
;; H
  ...
  (= (bool_eq3 p__nearly_identity__nxt__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
...
;; H
  ...
  (and
  (and
  (= (length2 (mk___rep l__split_discrs l__split_fields6)) (- (length2
                                                              (mk___rep
                                                              l__split_discrs
                                                              (mk___split_fields
                                                              l__split_fields))) 1))
  ...
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields6))
     ...
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (mk___rep1 (mk___split_fields1 cu__split_fields)))
     (length2 (mk___rep l__split_discrs l__split_fields6)) 1) true))
  (= (p_positions_shifted
...
;; H
  ...
  (and
  (and
  (= (length2 (mk___rep l__split_discrs l__split_fields5)) (+ (length2
                                                              (mk___rep
                                                              l__split_discrs
                                                              l__split_fields6)) 1))
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields5))
     (mk___rep1 cu__split_fields5)) true))
  (ite (= (bool_eq3 nxt no_element) true)
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields5))
     (mk___rep1 cu__split_fields5)) (length2
                                    (mk___rep l__split_discrs
                                    l__split_fields5)))
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields5))
     (mk___rep1 cu__split_fields5)) (get1
                                    (positions
                                    (mk___rep l__split_discrs
                                    l__split_fields6)) nxt))))
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields6))
     (model__ (mk___rep l__split_discrs l__split_fields5)) 1
     (- (get1 (positions (mk___rep l__split_discrs l__split_fields5))
  ...
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields6))
     ...
     (length2 (mk___rep l__split_discrs l__split_fields6)) 1) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields5))
     (get1 (positions (mk___rep l__split_discrs l__split_fields5))
