...
(declare-fun temp___776 () (Array Int us_rep1))
...
;; H
  ...
  (= temp___776 (model__1
                (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (and (dynamic_invariant9 temp___776 true false true)
  (= temp___776 (model__
                (rec__search_trees__search_tree__struct
                (us_split_fields__content3 t__split_fields14))
                (to_rep1
...
;; H
  (assert
  (=> (not (= (int__content i14) 0)) (= o31 (select temp___776 o30))))

;; H
  (assert (=> (not (= (int__content i14) 0)) (= o32 (us_split_fields1 o31))))

;; H
  (assert
  (=> (not (= (int__content i14) 0))
  (= result18 (rec__tree_model__path_type__k o32))))
...
;; H
  ...
  (= o29 (root
         ...
         (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
         t__split_fields3))))
  (and (in_range3 o29) (= o29 (to_rep1 t__split_fields)))))
