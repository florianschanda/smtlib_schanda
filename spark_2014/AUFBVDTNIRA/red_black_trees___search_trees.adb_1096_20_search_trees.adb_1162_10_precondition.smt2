...
(declare-fun temp___1118 () (Array Int us_rep1))
...
;; H
  ...
  (= temp___1118 (model__
                 (rec__search_trees__search_tree__struct t__split_fields10)
                 o33))
  (and (dynamic_invariant6 temp___1118 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1118 o33))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1118 o33)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o33))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1118 (parent
                              (rec__search_trees__search_tree__struct
                              t__split_fields10) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1118 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1118 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1118 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1118 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1118 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1118 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o34 (select temp___1118 x1)))
