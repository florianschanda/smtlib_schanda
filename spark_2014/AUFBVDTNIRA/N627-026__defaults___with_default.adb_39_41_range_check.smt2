...
(define-fun dynamic_invariant1 ((temp___expr_212 (Array Int integer))
  (temp___is_init_209 Bool) (temp___skip_constant_210 Bool)
  (temp___do_toplevel_211 Bool)) Bool (forall ((temp___213 Int))
                                      (=>
                                      (and (<= 1 temp___213)
                                      (<= temp___213 100))
                                      (=>
                                      ...
                                      (to_rep
                                      (select temp___expr_212 temp___213)))))))
...
(define-fun default_initial_assumption ((temp___expr_214 (Array Int integer))
  (temp___skip_top_level_215 Bool)) Bool (forall ((temp___216 Int))
                                         ...
                                         (<= temp___216 100))
                                         (= (to_rep
                                            (select temp___expr_214 temp___216)) 0))))
...
(assert
;; WP_parameter_def
 ;; File "with_default.adb", line 26, characters 0-0
