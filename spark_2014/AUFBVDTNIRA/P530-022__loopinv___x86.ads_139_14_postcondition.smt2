...
(declare-fun x86__writereg16post__result () Bool)
...
(declare-fun x86__writereg16post__result1 () Bool)

(declare-fun x86__writereg16post__result2 () Bool)

(declare-fun x86__writereg16post__result3 () Bool)

(declare-fun x86__writereg16post__result4 () Bool)

(declare-fun x86__writereg16post__result5 () Bool)
...
;; H
  (assert
  (and (and (= o (readreg16 regnew)) (readreg16__function_guard o regnew))
  (= o ((_ extract 15 0) (bvand regnew ((_ int2bv 64) 65535))))))
...
;; H
  (assert
  (= o2 (ite (= o1 true) (ite (= (bvand regnew ((_ int2bv 64) 18446744073709486080)) (bvand 
                         regold ((_ int2bv 64) 18446744073709486080))) true
                         false) false)))
...
;; H
  (assert
  (= (mk_bool__ref x86__writereg16post__result4) (mk_bool__ref
                                                 x86__writereg16post__result2)))
...
;; H
  (assert (readreg16__function_guard (readreg16 regnew) regnew))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 137, characters 0-0
  (not (= (readreg16 regnew) val__)))
(check-sat)
