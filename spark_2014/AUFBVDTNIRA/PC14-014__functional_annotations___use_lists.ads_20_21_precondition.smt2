...
;; H
  (assert (= temp___489 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___489)) no_element))
...
;; H
  ...
  (and (= result1 true)
  (and (= temp___487 cu__split_fields1)
  (and
  (forall ((i Int))
  (=>
  (and (<= 1 i)
...
;; H
  (assert
  (and (= o6 (find l e no_element))
  (ite (ite (= (contains (model__ l)
               (ite (= (bool_eq3 no_element no_element) true) 1
               (get1 (positions l) no_element)) (length2 l) e) false) true false)
  (= (bool_eq3 o6 no_element) true)
  (and
  (and
  (and (= (has_key (positions l) o6) true)
  (= (get (model__ l) (get1 (positions l) o6)) e))
  (=> (not (= (bool_eq3 no_element no_element) true))
  (<= (get1 (positions l) no_element) (get1 (positions l) o6))))
  (not
  (= (contains (model__ l)
     (ite (= (bool_eq3 no_element no_element) true) 1
     (get1 (positions l) no_element)) (- (get1 (positions l) o6) 1) e) true))))))

;; H
  (assert (= result6 (bool_eq3 o6 no_element)))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o5 j) true)
  (=> (= (get1 o5 i) (get1 o5 j)) (= (bool_eq3 i j) true))))))))))

(assert
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 51, characters 0-0
  (not (= (has_key o5 (cursor__content use_lists__my_find__result13)) true)))
(check-sat)
