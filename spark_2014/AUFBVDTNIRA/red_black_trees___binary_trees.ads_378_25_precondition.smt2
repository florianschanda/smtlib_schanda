...
(declare-fun o42 () (Array Int us_rep1))
...
;; H
  ...
  (and
  (and
  (= o54 (size (mk___rep2 (us_split_fields__content2 f__split_fields7))))
  (size__function_guard o54
  (mk___rep2 (us_split_fields__content2 f__split_fields7))))
  (and (in_range2 o54)
  (= o54 (to_rep
         (rec__binary_trees__forest__s
...
;; H
  ...
  (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1443 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1443 (parent
                      (mk___rep2
...
;; H
  ...
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___1443 (parent
                              ...
                              i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1443 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1443 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1443 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1443 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1443 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o52 (select temp___1443 i)))
...
;; H
  ...
  (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o51)
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) o51))

;; H
  (assert (parent__function_guard
  (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o51)
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) o51))
...
;; H
  ...
  (and
  (and
  (= o51 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d))
  (peek__function_guard o51
...
;; H
  (assert
  (forall ((i2 Int)) (valid_root__function_guard
  (valid_root
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2)
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2)))

;; H
  (assert
  (forall ((i2 Int)) (valid_root__function_guard
  (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)))
...
;; H
  ...
  (ite (= (valid_root
          (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
          i2) true)
  (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2) true)
  (not
  (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2) true)))))))
...
;; H
  ...
  (select temp___1438 (parent
                      ...
                      (us_split_fields__content2 f__split_fields7)) i2))))
  (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1438 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1438 (parent
                      (mk___rep2
...
;; H
  ...
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___1438 (parent
                              ...
                              i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1438 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1438 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1438 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1438 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1438 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o49 (select temp___1438 (int__content v2))))
...
;; H
  ...
  (select temp___1408 (parent
                      ...
                      (us_split_fields__content2 f__split_fields7)) i2))))
  (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1408 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1408 (parent
                      (mk___rep2
...
;; H
  ...
  (select temp___1407 (parent
                      ...
                      (us_split_fields__content2 f__split_fields7)) i2))))
  (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1407 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1407 (parent
                      (mk___rep2
...
;; H
  ...
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___1408 (parent
                              ...
                              i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1408 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1408 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1408 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1408 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1408 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o46 (select temp___1408 (int__content v2))))
...
;; H
  ...
  (= temp___1407 (model__
                 (mk___rep2 (us_split_fields__content2 f__split_fields7))
                 root))
  (model____function_guard temp___1407
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) root))
  (and (dynamic_invariant2 temp___1407 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___1407 (parent
                              ...
                              i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1407 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1407 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1407 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1407 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1407 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1407 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o43 (select temp___1407 i)))
...
;; H
  (assert
  (and
  (and (= result18 (is_add o45 d o48)) (is_add__function_guard result18 
  o45 d o48))
  (= (= result18 true)
  (and (and (= (- (length o48) 1) (length o45)) (= (olt o45 o48) true))
  (= (get o48 (length o48)) d)))))
...
;; H
  ...
  (= o41 (valid_root
         (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
         i1))
  (valid_root__function_guard o41
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1))
  (and
  (= (= o41 true)
  (and (<= i1 (to_rep f__split_fields))
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3 (select f__split_fields1 i1)))) 2)))
  (=>
  (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 
  i1) (not (= o41 true))))))
...
;; H
  ...
  (forall ((i2 Int)) (parent__function_guard
  (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i2) (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2)))
...
;; H
  ...
  (select o42 (parent
              (mk___rep2
              (mk___split_fields2 f__split_fields f__split_fields1)) i2))))
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i2) (rec__tree_model__path_type__a (us_split_fields1 (select o42 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select o42 (parent
              (mk___rep2
...
;; H
  ...
  (= o42 (model__
         (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
         i1))
  (model____function_guard o42
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1))
  (and (dynamic_invariant2 o42 true false true)
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o42 i1))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select o42 i1)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 i1))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select o42 (parent
                      ...
                      (mk___split_fields2 f__split_fields f__split_fields1))
                      i2)))) true))
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o42 i2))) true)
  (not
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o42 i2))) true))))))
  (and
  (forall ((i2 Int))
  ...
  (= (is_add
     ...
     (position
     (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2)
     (rec__tree_model__path_type__a (us_split_fields1 (select o42 i2)))) true)
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select o42 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o42 i2))) true)
  ...
  (=>
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o42 j))) true)
  (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o42 i2)))
     (rec__tree_model__path_type__a (us_split_fields1 (select o42 j)))) true))
  (= j i2))))))))))))))
