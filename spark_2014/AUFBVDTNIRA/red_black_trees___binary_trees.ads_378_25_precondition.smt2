...
(declare-fun temp___937 () (Array Int us_rep1))
...
;; H
  ...
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___957 (parent
                             ...
                             i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___957 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___957 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___957 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
...
;; H
  ...
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___955 (parent
                             ...
                             i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___955 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___955 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___955 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___955 i2)))
     (rec__tree_model__path_type__a (us_split_fields1 (select temp___955 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o49 (select temp___955 (int__content v2))))
...
;; H
  ...
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___938 (parent
                             ...
                             i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___938 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___938 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___938 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___938 i2)))
     (rec__tree_model__path_type__a (us_split_fields1 (select temp___938 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o46 (select temp___938 (int__content v2))))
...
;; H
  ...
  (= temp___937 (model__
                (mk___rep2 (us_split_fields__content2 f__split_fields7))
                root))
  (and (dynamic_invariant2 temp___937 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___937 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___937 root)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___937 (parent
                             (mk___rep2
                             (us_split_fields__content2 f__split_fields7))
                             i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___937 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___937 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___937 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (=>
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___937 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___937 i2)))
     (rec__tree_model__path_type__a (us_split_fields1 (select temp___937 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o43 (select temp___937 i)))
