...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o3))
  (and (dynamic_invariant3 temp___2002 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2002 o3))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2002 o3)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o3))
...
;; H
  (assert (= o4 (select temp___2002 i)))
