...
(declare-fun user_eq2 (t111b t111b) Bool)

(declare-fun dummy2 () t111b)

(declare-datatypes () ((t111b__ref (mk_t111b__ref (t111b__content t111b)))))
(define-fun t111b__ref___projection ((a t111b__ref)) t111b (t111b__content a))

(declare-fun temp___627 (Int Int) (Array Int unsigned_byte))

;; def_axiom
  (assert
  (forall ((temp___629 Int) (temp___630 Int))
  (let ((temp___628 (temp___627 temp___629 temp___630)))
  (forall ((temp___631 Int))
  (ite (= temp___631 2)
  (= (select temp___628 temp___631) (of_rep temp___629))
  (= (select temp___628 temp___631) (of_rep temp___630)))))))
