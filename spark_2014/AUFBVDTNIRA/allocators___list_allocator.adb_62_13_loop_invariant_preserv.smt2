...
;; H
  (assert (contains__function_guard1 (contains1 model____split_fields6 rr)
  model____split_fields6 rr))

(assert
;; WP_parameter_def
 ;; File "list_allocator.adb", line 21, characters 0-0
  (not (= (contains1 model____split_fields6 rr) true)))
(check-sat)
