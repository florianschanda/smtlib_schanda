...
;; H
  ...
  (and (= temp___571 1)
  (and (= temp___572 r19b)
  (and (and (= result8 j16) (= j1 temp___571))
...
;; H
  (assert
  (and (and (= o2 (length s)) (length__function_guard o2 s)) (in_range1 o2)))

;; H
  (assert (= o3 (ite (<= list_allocator__m__find__result16 o2) true false)))

;; H
  (assert
  (= result7 (ite (<= 1 list_allocator__m__find__result16) o3 false)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range2 list_allocator__m__find__result16)))
(check-sat)
