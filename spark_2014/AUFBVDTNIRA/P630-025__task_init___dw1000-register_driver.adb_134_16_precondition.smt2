...
(declare-fun o () bits_8)

(declare-fun o1 () extended_address_type)

(declare-fun o2 () bits_7)

(declare-fun o3 () operation_type)

(declare-fun o4 () sub_index_type)

(declare-fun o5 () bits_6)

(declare-fun o6 () bits_6)

(declare-fun o7 () sub_index_type)

(declare-fun o8 () operation_type)

(declare-fun o9 () bits_7)

(declare-fun o10 () extended_address_type)

(declare-fun o11 () bits_8)

(declare-fun temp___749 () bits_6)

(declare-fun temp___7491 () sub_index_type)

(declare-fun temp___7492 () operation_type)

(declare-fun temp___7493 () bits_7)

(declare-fun temp___7494 () extended_address_type)

(declare-fun temp___7495 () bits_8)

(declare-fun dw1000__register_driver__write_register__B_6__header__assume () bits_6)

(declare-fun dw1000__register_driver__write_register__B_6__header__assume1 () sub_index_type)

(declare-fun dw1000__register_driver__write_register__B_6__header__assume2 () operation_type)

(declare-fun dw1000__register_driver__write_register__B_6__header__assume3 () bits_7)

(declare-fun dw1000__register_driver__write_register__B_6__header__assume4 () extended_address_type)

(declare-fun dw1000__register_driver__write_register__B_6__header__assume5 () bits_8)

(declare-fun o12 () us_rep2)

(declare-fun o13 () (Array Int bits_8))
...
;; H
  (assert
  (let ((temp___712 header2))
  (and
  (= (to_rep5
     (rec__dw1000__register_driver__long_indexed_header__sub_index
     (us_split_fields5 temp___712))) 1)
  (= (to_rep6
     (rec__dw1000__register_driver__long_indexed_header__extended_address
     (us_split_fields5 temp___712))) 1))))
