...
;; H
  (assert (and (= o31 o30) (uint_in_range1 o30)))

;; H
  (assert (= o32 ((_ int2bv 64) o31)))

;; H
  (assert (= o33 (bvadd o32 ((_ int2bv 64) 1))))

;; H
  (assert (= o34 (bvmul o33 ((_ int2bv 64) 32))))

;; H
  (assert (= o35 (ite (bvult i2 o34) true false)))
