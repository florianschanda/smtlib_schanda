...
(declare-fun dynamic_preds__update_even_pair__x__fields () even)

(declare-fun dynamic_preds__update_even_pair__x__fields1 () even)
...
(declare-fun dynamic_preds__update_constant_even_pair__x__fields () even)

(declare-fun dynamic_preds__update_constant_even_pair__x__fields1 () even)

(declare-fun result2 () even)

(declare-fun result3 () even)

(declare-fun x__split_fields4 () even)

(declare-fun x__split_fields5 () even)

(define-fun dynamic_preds__update_constant_even_pair__x__fields2 () us_split_fields 
  (mk___split_fields dynamic_preds__update_constant_even_pair__x__fields
  dynamic_preds__update_constant_even_pair__x__fields1))

(define-fun dynamic_preds__update_even_pair__x__fields2 () us_split_fields 
  (mk___split_fields dynamic_preds__update_even_pair__x__fields
  dynamic_preds__update_even_pair__x__fields1))
...
;; H
  ...
  (mk___rep dynamic_preds__update_even_pair__x__fields2) true true true))
...
;; H
  (assert
  (= (mk___split_fields x__split_fields2 x__split_fields3) dynamic_preds__update_even_pair__x__fields2))
...
;; H
  (assert
  (and
  (and (= (to_rep dynamic_preds__update_constant_even_pair__x__fields) 0)
  (= (to_rep dynamic_preds__update_constant_even_pair__x__fields1) 2))
  (dynamic_invariant2
  (mk___rep dynamic_preds__update_constant_even_pair__x__fields2) true true
  true)))
...
;; H
  (assert
  (= (mk___split_fields x__split_fields4 x__split_fields5) dynamic_preds__update_constant_even_pair__x__fields2))

(assert
;; WP_parameter_def
 ;; File "dynamic_preds.ads", line 6, characters 0-0
  (not (= (to_rep x__split_fields5) (+ (to_rep x__split_fields4) 2))))
(check-sat)
