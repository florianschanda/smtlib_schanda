...
;; H
  ...
  (and
  (= o (abs (- x (to_rep
                 (rec__shapes3__circle__center_x (us_split_fields1 c))))))
  (in_range
  (abs (- x (to_rep (rec__shapes3__circle__center_x (us_split_fields1 c))))))))
...
;; H
  ...
  (and
  (= o2 (abs (- y (to_rep
                  (rec__shapes3__circle__center_y (us_split_fields1 c))))))
  (in_range
  (abs (- y (to_rep (rec__shapes3__circle__center_y (us_split_fields1 c))))))))
...
;; H
  (assert
  (and
  (= o5 (* (to_rep1 (rec__shapes3__circle__radius (us_split_fields1 c))) 
  (to_rep1 (rec__shapes3__circle__radius (us_split_fields1 c))))) (in_range
  (* (to_rep1 (rec__shapes3__circle__radius (us_split_fields1 c))) (to_rep1
                                                                   (rec__shapes3__circle__radius
                                                                   (us_split_fields1
                                                                   c)))))))
...
;; H
  (assert
  (and (= o4 (* delta_y1 delta_y1)) (in_range (* delta_y1 delta_y1))))

(assert
;; WP_parameter_def
 ;; File "shapes3.ads", line 14, characters 0-0
  (not (in_range (* delta_x1 delta_x1))))
(check-sat)
