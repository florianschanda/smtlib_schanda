...
(declare-fun patience__playgame__result () cardindex)

(declare-fun patience__playgame__result1 () (Array Int card))

(declare-fun patience__playgame__result2 () cardindex)

(declare-fun patience__playgame__result3 () (Array Int cardindex))

(declare-fun patience__playgame__result4 () (Array Int (Array Int cardindex)))

(declare-fun patience__playgame__result5 () (Array Int cardindex))

(declare-fun patience__playgame__result6 () (Array Int cardindex))

(declare-fun patience__playgame__result7 () (Array Int cardindex))
...
(declare-fun s__split_fields32 () us_split_fields__ref)

(declare-fun i3 () int__ref)

(declare-fun s__split_fields33 () us_split_fields)

(declare-fun i4 () Int)

(declare-fun s__split_fields34 () us_split_fields__ref)

(declare-fun i5 () int__ref)

(declare-fun s__split_fields35 () us_split_fields)

(declare-fun i6 () Int)

(declare-fun result9 () state__ref)

(declare-fun patience__playgame__result8 () us_rep)

(declare-fun patience__playgame__result9 () state__ref)

(declare-fun patience__playgame__result10 () us_rep)

(declare-fun s__split_fields36 () us_split_fields__ref)

(declare-fun i7 () int__ref)

(declare-fun patience__playgame__result11 () state__ref)

(declare-fun s__split_fields37 () us_split_fields)

(declare-fun i8 () Int)

(declare-fun patience__playgame__result12 () us_rep)

(define-fun s__split_fields38 () us_split_fields (mk___split_fields
                                                 s__split_fields24
                                                 s__split_fields25
                                                 s__split_fields26
                                                 s__split_fields27
...
(declare-fun result10 () cardindex)

(declare-fun result11 () (Array Int card))

(declare-fun result12 () cardindex)

(declare-fun result13 () (Array Int cardindex))

(declare-fun result14 () (Array Int (Array Int cardindex)))

(declare-fun result15 () (Array Int cardindex))
...
;; H
  ...
  (<= i1 (to_rep1 (last (rt cards)))))
  (and
  (and (= (inv (mk___rep s__split_fields38)) true)
...
;; H
  ...
  (=>
  (and (<= (to_rep1 (first (rt cards))) i1)
  (<= i1 (to_rep1 (last (rt cards))))) (= i2 (to_rep1 (last (rt cards))))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt cards))) i1)
  (<= i1 (to_rep1 (last (rt cards))))) (= i3 (mk_int__ref i2))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt cards))) i1)
  (<= i1 (to_rep1 (last (rt cards)))))
  (= s__split_fields32 (mk___split_fields__ref s__split_fields38))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt cards))) i1)
  (<= i1 (to_rep1 (last (rt cards))))) (= i4 i2)))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt cards))) i1)
  (<= i1 (to_rep1 (last (rt cards)))))
  (= s__split_fields33 s__split_fields38)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt cards))) i1)
  (<= i1 (to_rep1 (last (rt cards))))) (= i5 i3)))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt cards))) i1)
  (<= i1 (to_rep1 (last (rt cards)))))
  (= s__split_fields34 s__split_fields32)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt cards))) i1)
  (<= i1 (to_rep1 (last (rt cards))))) (= i6 i4)))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt cards))) i1)
  (<= i1 (to_rep1 (last (rt cards)))))
  (= s__split_fields35 s__split_fields33)))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt cards))) i1)
  (<= i1 (to_rep1 (last (rt cards)))))) (= i5 (mk_int__ref i1))))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt cards))) i1)
  (<= i1 (to_rep1 (last (rt cards)))))) (= i6 i1)))
...
;; H
  (assert
  (= patience__playgame__result9 (mk_state__ref patience__playgame__result8)))

;; H
  (assert (= patience__playgame__result10 patience__playgame__result8))

;; H
  (assert
  (= result9 (mk_state__ref
             (mk___rep
             (mk___split_fields patience__playgame__result
             patience__playgame__result1 patience__playgame__result2
             patience__playgame__result3 patience__playgame__result4
             patience__playgame__result5 patience__playgame__result6
             patience__playgame__result7)))))

;; H
  (assert
  (= patience__playgame__result8 (mk___rep
                                 (us_split_fields__content s__split_fields34))))

;; H
  (assert (= patience__playgame__result11 patience__playgame__result9))

;; H
  (assert (= i7 i5))

;; H
  (assert (= s__split_fields36 s__split_fields34))

;; H
  (assert (= patience__playgame__result12 patience__playgame__result10))

;; H
  (assert (= i8 i6))

;; H
  (assert (= s__split_fields37 s__split_fields35))
...
;; WP_parameter_def
 ;; File "patience.ads", line 27, characters 0-0
  (not (= (inv (state__content patience__playgame__result11)) true)))
(check-sat)
