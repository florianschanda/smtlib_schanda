...
(declare-fun lat_long__delta_long_in_meters__result () t)
...
(declare-fun lat_long__delta_long_in_meters__result1 () t)

(declare-fun lat_long__delta_long_in_meters__result2 () t)

(declare-fun lat_long__delta_long_in_meters__result3 () t)

(declare-fun lat_long__delta_long_in_meters__result4 () t)

(declare-fun lat_long__delta_long_in_meters__result5 () t)
...
;; H
  (assert
  (= (mk_t__ref lat_long__delta_long_in_meters__result4) (mk_t__ref
                                                         lat_long__delta_long_in_meters__result2)))
...
;; H
  ...
  (olt (abs1 lat_long__delta_long_in_meters__result4) fliteral9)
  (abs1 lat_long__delta_long_in_meters__result4) fliteral9))

(assert
;; WP_parameter_def
 ;; File "lat_long.ads", line 6, characters 0-0
  (not
  (= (olt (abs1 lat_long__delta_long_in_meters__result4) fliteral9) true)))
(check-sat)
