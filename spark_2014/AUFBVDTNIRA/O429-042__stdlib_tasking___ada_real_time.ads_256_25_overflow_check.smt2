...
(declare-fun dummy2 () seconds_count)
...
;; H
  (assert
  (and (and (= o1 (ts_sc ts)) (ts_sc__function_guard o1 ts))
  (and (in_range1 o1) (= o1 (to_int1 (to_fixed (to_duration__2 ts)))))))
