...
;; H
  (assert (= o42 (ite (<= o41 k) true false)))

;; H
  (assert
  (= result7 (ite (= o42 true) (ite (<= k a_last) true false) false)))
...
;; H
  (assert
  (and (= o39 (num_of_boolean carry3)) (num_of_boolean__function_guard 
  o39 carry3)))
...
;; H
  (assert
  (and (and (= o33 (base Tuple0)) (base__function_guard o33 Tuple0))
  (= o33 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o38 (oexpon o33 o37)) (oexpon__function_guard o38 o33 o37)))

;; H
  (assert
  (and (= o40 (omultiply o38 o39)) (omultiply__function_guard o40 o38 o39)))
