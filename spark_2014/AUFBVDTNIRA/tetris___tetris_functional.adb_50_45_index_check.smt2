...
(define-fun bool_eq12 ((a map1) (a__first Int) (a__last Int) (a__first_2 Int)
...
;; bool_eq_rev
  ...
  (=>
  (= (bool_eq12 b b__first b__last b__first_2 b__last_2 a a__first a__last
...
(define-fun bool_eq13 ((a (Array Int map1)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq12 (select a temp___idx_136) 0 3 0 3
...
(define-fun bool_eq14 ((a map2) (a__first Int) (a__last Int) (a__first_2 Int)
...
;; bool_eq_rev
  ...
  (= (bool_eq12 (get1 a temp___idx_223 temp___idx_224) 0 2 0 2
...
;; H
  ...
  (=> (not (= (+ (to_rep3 cur_piece__split_fields3) y2) temp___771))
  (= (select cur_board2 temp___771) (select cur_board1 temp___771)))))
  (and (<= 0 x2) (<= x2 3))))
...
;; H
  (assert
  (= o2 (store (select cur_board2 (+ (to_rep3 cur_piece__split_fields3) 
  y2)) o1 o)))
