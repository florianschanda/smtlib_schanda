...
(define-fun dynamic_invariant5 ((temp___expr_387 us_rep1)
  (temp___is_init_384 Bool) (temp___skip_constant_385 Bool)
  (temp___do_toplevel_386 Bool)) Bool (=>
                                      (not (= temp___skip_constant_385 true))
                                      (in_range8 100 temp___expr_387)))

(define-fun default_initial_assumption1 ((temp___expr_389 us_rep1)
  (temp___skip_top_level_390 Bool)) Bool (and
                                         (= (to_rep2
                                            (rec__list__my_lists__vector__capacity
                                            (us_split_discrs1
                                            temp___expr_389))) 100)
...
;; mk_def
  ...
  (! (=> (in_range1 f)
     (=> (in_range1 l1)
     (and (= (to_rep (first3 (mk1 f l1))) f)
     (= (to_rep (last4 (mk1 f l1))) l1)))) :pattern ((mk1 f l1)) )))
...
(define-fun length3 ((a us_t1)) Int (ite (<= (first4 a) (last5 a))
...
(define-fun bool_eq14 ((x us_t1)
  (y us_t1)) Bool (bool_eq1 (elts1 x) (to_rep (first3 (rt1 x)))
                  ...
                  (to_rep (first3 (rt1 y))) (to_rep (last4 (rt1 y)))))
...
;; mk_def
  ...
  (! (=> (in_range1 f)
     (=> (in_range1 l1)
     (and (= (to_rep (first5 (mk2 f l1))) f)
     (= (to_rep (last6 (mk2 f l1))) l1)))) :pattern ((mk2 f l1)) )))
...
(define-fun length4 ((a us_t2)) Int (ite (<= (first6 a) (last7 a))
...
(define-fun bool_eq16 ((x us_t2)
  (y us_t2)) Bool (bool_eq1 (elts2 x) (to_rep (first5 (rt2 x)))
...
(define-fun dynamic_invariant9 ((temp___expr_263 Int)
...
(define-fun default_initial_assumption2 ((temp___expr_297 us_rep2)
  (temp___skip_top_level_298 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_298 true))
                                         (= (length1 temp___expr_297) 0)))
...
(define-fun dynamic_invariant10 ((temp___expr_290 Int)
...
(declare-fun temp___459 () r1)

(declare-fun temp___4591 () (Array Int integer))

(declare-fun temp___458 () Int)
...
;; H
  ...
  (and (= s__split_fields temp___459) (= s__split_fields1 temp___4591))))
...
;; H
  ...
  (= (let ((temp___181 (to__
     ...
     (let ((temp___180 (to_but_top (mk___rep s__split_fields3))))
     (bool_eq1 (elts temp___180) (to_rep (first (rt temp___180)))
     (to_rep (last (rt temp___180))) (elts temp___181)
     (to_rep (first (rt temp___181))) (to_rep (last (rt temp___181)))))) true))))
...
;; H
  (assert
  (= (let ((temp___185 (to__ (mk___rep s__split_fields9))))
     (let ((temp___184 (to_but_top
                       (mk___rep (us_split_fields__content s__split_fields7)))))
     (bool_eq1 (elts temp___184) (to_rep (first (rt temp___184)))
     (to_rep (last (rt temp___184))) (elts temp___185)
     (to_rep (first (rt temp___185))) (to_rep (last (rt temp___185)))))) true))
...
;; H
  ...
  (= (bool_eq1 (elts (to__ (mk___rep s__split_fields10)))
     (to_rep (first3 (mk1 first2 (- last3 i9))))
     (to_rep (last4 (mk1 first2 (- last3 i9))))
     (elts (to__ (mk___rep (us_split_fields__content s__split_fields7))))
     (to_rep (first5 (mk2 first2 (- last3 i9))))
     (to_rep (last6 (mk2 first2 (- last3 i9))))) true))
  (forall ((j1 Int))
  (=> (and (<= first2 j1) (<= j1 i9))
...
;; H
  ...
  (dynamic_invariant1 list__reverse_list__L_2__R16b true false true)))
...
;; H
  (assert
  (and (= o12 (to__ (mk___rep s__split_fields10))) (dynamic_invariant1 
  o12 true false true)))
...
;; H
  (assert
  (=> (= result4 true)
  (and (= temp___470 (- last3 i9)) (in_range1 (- last3 i9)))))
...
;; H
  ...
  (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) temp___470)
  (<= temp___470 (to_rep (last (rt list__reverse_list__L_2__R20b)))))))))
...
;; H
  (assert
  (=> (= result4 true) (= temp___472 (mk___t2 o10 (mk2 first2 temp___470)))))

;; H
  (assert
  (=> (= result4 true)
  (and (= temp___469 (- last3 i9)) (in_range1 (- last3 i9)))))
...
;; H
  ...
  (and (<= (to_rep (first (rt list__reverse_list__L_2__R16b))) temp___469)
  (<= temp___469 (to_rep (last (rt list__reverse_list__L_2__R16b)))))))))
...
;; H
  (assert
  (=> (= result4 true) (= temp___471 (mk___t1 o11 (mk1 first2 temp___469)))))

;; H
  (assert
  (=> (= result4 true)
  (= result3 (bool_eq1 (elts1 temp___471) (to_rep (first3 (rt1 temp___471)))
             (to_rep (last4 (rt1 temp___471))) (elts2 temp___472)
             (to_rep (first5 (rt2 temp___472)))
             (to_rep (last6 (rt2 temp___472)))))))
