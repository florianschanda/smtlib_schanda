...
(declare-fun list__reverse_list__L_2__R20b () us_t)

(declare-fun list__reverse_list__L_2__R16b () us_t)

(declare-fun temp___482 () Int)

(declare-fun o10 () (Array Int integer))

(declare-fun temp___484 () us_t2)

(declare-fun temp___481 () Int)

(declare-fun o11 () (Array Int integer))

(declare-fun temp___483 () us_t1)

(declare-fun o12 () us_t)
...
;; H
  (assert
  (=> (and (<= first2 i2) (<= i2 last3))
  (and (= s__split_fields temp___468) (= s__split_fields1 temp___4681))))

;; H
  (assert (=> (and (<= first2 i2) (<= i2 last3)) (= temp___467 i2)))

;; H
  (assert
  (=> (and (<= first2 i2) (<= i2 last3)) (and (= o i2) (in_range4 i2))))
...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= first2 j1) (<= j1 i3))
  (= (to_rep (select (elts (to__ (mk___rep s__split_fields4))) j1)) (get
                                                                    (model__
                                                                    l) j1)))))))
...
;; H
  (assert
  (=> (and (<= first2 i2) (<= i2 last3))
  (and (=> (<= first2 last3) (dynamic_property1 first2 last3 i3))
...
;; H
  (assert
  (=> (not (and (<= first2 i2) (<= i2 last3))) (= i6 (mk_int__ref i2))))

;; H
  (assert
  (=> (not (and (<= first2 i2) (<= i2 last3)))
...
;; H
  (assert
  (= result2 (mk___split_fields__ref1 (mk___split_fields1 res__split_fields))))
...
;; H
  ...
  (= (bool_eq1 (elts (to__ (mk___rep s__split_fields10)))
     (to_rep (first6 (mk1 first2 (- last3 i9))))
     (to_rep (last7 (mk1 first2 (- last3 i9))))
     (elts (to__ (mk___rep (us_split_fields__content s__split_fields7))))
     (to_rep (first9 (mk2 first2 (- last3 i9))))
     (to_rep (last10 (mk2 first2 (- last3 i9))))) true))
  (forall ((j1 Int))
  (=> (and (<= first2 j1) (<= j1 i9))
  (= (get (model__ (mk___rep1 res__split_discrs res__split_fields2)) j1) 
  (get (model__ l) (+ (- (last2 (model__ l)) j1) 1)))))))

;; H
  (assert
  (and (=> (<= first2 last3) (dynamic_property2 first2 last3 i9))
...
;; H
  ...
  (and
  (and
  (= list__reverse_list__L_2__R20b (to__
                                   (mk___rep
                                   (us_split_fields__content
                                   s__split_fields7))))
  (to____function_guard list__reverse_list__L_2__R20b
  (mk___rep (us_split_fields__content s__split_fields7))))
  (dynamic_invariant1 list__reverse_list__L_2__R20b true false true)))

;; H
  (assert
  (and
  (and (= list__reverse_list__L_2__R16b (to__ (mk___rep s__split_fields10)))
  (to____function_guard list__reverse_list__L_2__R16b
  (mk___rep s__split_fields10))) (dynamic_invariant1
  list__reverse_list__L_2__R16b true false true)))

;; H
  (assert (and (= o13 (- last3 i9)) (in_range1 (- last3 i9))))

;; H
  (assert
  (and
  (and (= o12 (to__ (mk___rep s__split_fields10))) (to____function_guard 
  o12 (mk___rep s__split_fields10))) (dynamic_invariant1 o12 true false
  true)))

;; H
  (assert (= o14 (to_rep (last (rt o12)))))

;; H
  (assert (= result4 (ite (= o14 o13) true false)))

;; H
  (assert
  (=> (= result4 true)
  (and (= temp___482 (- last3 i9)) (in_range1 (- last3 i9)))))
...
;; H
  ...
  (=> (<= first2 temp___482)
  (and
  (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) first2)
  (<= first2 (to_rep (last (rt list__reverse_list__L_2__R20b)))))
  (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) temp___482)
  (<= temp___482 (to_rep (last (rt list__reverse_list__L_2__R20b)))))))))

;; H
  (assert (=> (= result4 true) (= o10 (elts list__reverse_list__L_2__R20b))))

;; H
  (assert
  (=> (= result4 true) (= temp___484 (mk___t2 o10 (mk2 first2 temp___482)))))

;; H
  (assert
  (=> (= result4 true)
  (and (= temp___481 (- last3 i9)) (in_range1 (- last3 i9)))))
...
;; H
  ...
  (=> (<= first2 temp___481)
  (and
  (and (<= (to_rep (first (rt list__reverse_list__L_2__R16b))) first2)
  (<= first2 (to_rep (last (rt list__reverse_list__L_2__R16b)))))
  (and (<= (to_rep (first (rt list__reverse_list__L_2__R16b))) temp___481)
  (<= temp___481 (to_rep (last (rt list__reverse_list__L_2__R16b)))))))))

;; H
  (assert (=> (= result4 true) (= o11 (elts list__reverse_list__L_2__R16b))))

;; H
  (assert
  (=> (= result4 true) (= temp___483 (mk___t1 o11 (mk1 first2 temp___481)))))

;; H
  (assert
  (=> (= result4 true)
  (= result3 (bool_eq1 (elts1 temp___483) (to_rep (first6 (rt1 temp___483)))
             (to_rep (last7 (rt1 temp___483))) (elts2 temp___484)
             (to_rep (first9 (rt2 temp___484)))
             (to_rep (last10 (rt2 temp___484)))))))
...
;; H
  (assert
  (and (= o3 (last2 (model__ l)))
  (and (in_range6 o3) (= o3 (last2 (model__ l))))))
...
;; H
  (assert (and (= o8 o7) (in_range4 o7)))

;; H
  (assert
  (and (= o9 (get (model__ l) o8))
  (and (in_range7 o9) (= o9 (get (model__ l) o8)))))
