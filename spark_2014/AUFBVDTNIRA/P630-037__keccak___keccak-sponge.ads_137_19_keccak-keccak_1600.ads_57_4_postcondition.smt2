...
(declare-fun dummy2 () rate_number)
...
;; range_axiom
  (assert
  (forall ((x rate_number)) (! (in_range2
...
;; range_axiom
  (assert
  (forall ((x states)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
(declare-fun keccak__keccak_1600__sponge__rate_of__result () Int)
...
(declare-fun keccak__keccak_1600__sponge__rate_of__result1 () Int)

(declare-fun keccak__keccak_1600__sponge__rate_of__result2 () Int)

(declare-fun keccak__keccak_1600__sponge__rate_of__result3 () Int)

(declare-fun keccak__keccak_1600__sponge__rate_of__result4 () Int)

(declare-fun keccak__keccak_1600__sponge__rate_of__result5 () Int)

(declare-fun result1 () Int)

;; H
  (assert
  (= keccak__keccak_1600__sponge__rate_of__result1 keccak__keccak_1600__sponge__rate_of__result2))

;; H
  (assert
  (= keccak__keccak_1600__sponge__rate_of__result3 keccak__keccak_1600__sponge__rate_of__result1))
...
;; H
  ...
  (= o (* (to_rep
          (rec__keccak__keccak_1600__sponge__context__rate
          (us_split_fields1 ctx))) 8))
  (in_range
  (* (to_rep
     (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields1 ctx))) 8))))
...
;; H
  (assert
  (= (mk_int__ref keccak__keccak_1600__sponge__rate_of__result4) (mk_int__ref
                                                                 keccak__keccak_1600__sponge__rate_of__result2)))

;; H
  (assert
  (= keccak__keccak_1600__sponge__rate_of__result5 keccak__keccak_1600__sponge__rate_of__result3))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (< keccak__keccak_1600__sponge__rate_of__result4 1600)))
(check-sat)
