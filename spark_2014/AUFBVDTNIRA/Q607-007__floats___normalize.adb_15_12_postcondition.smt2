...
(declare-fun normalize__r3__result () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun normalize__r3__result1 () t)

(declare-fun normalize__r3__result2 () t)

(declare-fun normalize__r3__result3 () t)

(declare-fun normalize__r3__result4 () t)

(declare-fun normalize__r3__result5 () t)
...
;; H
  (assert
  (and (= o (roundToIntegral RTN2 x)) (tqtisFinite (roundToIntegral RTN2 x))))
...
;; H
  (assert
  (= (mk_t__ref normalize__r3__result4) (mk_t__ref normalize__r3__result2)))
...
;; WP_parameter_def
 ;; File "normalize.ads", line 5, characters 0-0
  (not (le normalize__r3__result4 x)))
(check-sat)
