...
(declare-fun h__first () integer)

(declare-fun h__last () integer)
...
(declare-fun h () (Array Int content))
...
(declare-fun temp___483 () (Array Int content))

(declare-fun temp___481 () (Array Int content))

(declare-fun temp___479 () Int)

(declare-fun temp___487 () (Array Int content))

(declare-fun temp___478 () Int)

(declare-fun temp___485 () (Array Int content))
...
(declare-fun h1 () (Array Int content))
...
(declare-fun h2 () (Array Int content))
...
(declare-fun h3 () (Array Int content))

(declare-fun result4 () (Array Int content))

(declare-fun h4 () (Array Int content))

(declare-fun h5 () (Array Int content))

(declare-fun t5 () Int)

(declare-fun q3 () Int)

(declare-fun h6 () (Array Int content))

(declare-fun t6 () Int)

(declare-fun q4 () Int)

(declare-fun h7 () (Array Int content))

(declare-fun t7 () Int)

(declare-fun q5 () Int)

(declare-fun h8 () (Array Int content))

(declare-fun t8 () Int)

(declare-fun q6 () Int)

(declare-fun h9 () (Array Int content))

(declare-fun t9 () Int)

(declare-fun m2 () int__ref)

(declare-fun q7 () int__ref)

(declare-fun h10 () (Array Int content))
...
;; WP_parameter_def
 ;; File "infoflow.ads", line 114, characters 0-0
  (not (<= (to_rep h__first) (+ k (div1 (to_rep h__last) 2)))))
(check-sat)
