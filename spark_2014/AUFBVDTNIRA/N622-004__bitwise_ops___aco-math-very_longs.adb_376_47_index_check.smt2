...
(declare-fun temp___1469 () (Array Int octet))

(declare-fun temp___14691 () t1)
...
(declare-fun temp___1471 () digit_index_type)

(declare-fun temp___14711 () (Array Int octet))

(declare-fun temp___14712 () t)

(declare-fun o4 () (_ BitVec 8))

(declare-fun temp___1483 () digit_index_type)

(declare-fun temp___14831 () (Array Int octet))

(declare-fun temp___14832 () t)

(declare-fun temp___1482 () (_ BitVec 8))

(declare-fun temp___1481 () (_ BitVec 8))
...
(declare-fun temp___1476 () us_rep)
...
;; H
  (assert
  (= (mk___t1 temp___1469 temp___14691) (mk___t1 temp___1467 temp___14671)))

;; H
  (assert (= temp___1469 o))

;; H
  (assert
  (= (mk (to_rep2 (first2 temp___14691)) (to_rep2 (last4 temp___14691))) 
  o1))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___1471)))

;; H
  (assert (= temp___14711 o2))

;; H
  (assert (= temp___14712 o3))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___14711 temp___14712))))
...
;; H
  ...
  (and (= result____split_discrs (mk___split_discrs temp___1483))
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___14831 temp___14832))))))
...
;; H
  ...
  (and
  (= (rec__aco__math__very_longs__very_long__octet_length
     result____split_discrs) temp___1483)
  ...
  (<= (to_rep2
      ...
      (rt
      (rec__aco__math__very_longs__very_long__long_digits
      result____split_fields3)))) temp___1485)
  (<= temp___1485 (to_rep2
                  (last1
                  (rt
                  (rec__aco__math__very_longs__very_long__long_digits
  ...
  (= (select (elts
             (rec__aco__math__very_longs__very_long__long_digits
             result____split_fields3)) temp___1485) (select temp___14831 temp___1485)))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last1
         (rt
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (us_split_fields1 number)))))))
  (and
  (and (= o9 (shift_right o8 (- 8 distance))) (shift_right__function_guard 
  o9 o8 (- 8 distance)))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 number)))))))
  (= temp___1476 (mk___rep result____split_discrs o18))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 number)))))))
  (= result____split_fields4 (us_split_fields1 temp___1476))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 number)))))))
  (= result____split_discrs (us_split_discrs1 temp___1476))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 number)))))))
  (= temp___1480 (mk___rep result____split_discrs o27))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 number)))))))
  (= result____split_fields5 (us_split_fields1 temp___1480))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 number)))))))
  (= result____split_discrs (us_split_discrs1 temp___1480))))
