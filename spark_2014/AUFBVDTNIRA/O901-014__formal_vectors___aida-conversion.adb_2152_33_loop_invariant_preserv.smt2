...
(define-fun tint_arrayD1__ref_24__projection ((a tint_arrayD1__ref)) integer 
...
(define-fun tint_arrayT__ref_24__projection ((a tint_arrayT__ref)) us_t1 
...
(declare-datatypes ()
((t761b__ref (mk_t761b__ref (t761b__content integer)))))
...
(define-fun tnumber_array_typeD1__ref_33__projection ((a tnumber_array_typeD1__ref)) integer 
...
(define-fun number_array_type__ref_33__projection ((a number_array_type__ref)) us_t3 
...
(declare-datatypes ()
((t765b__ref (mk_t765b__ref (t765b__content integer)))))
...
(declare-datatypes ()
((t767b__ref (mk_t767b__ref (t767b__content integer)))))
...
(define-fun tint_arrayB__ref_24__projection ((a tint_arrayB__ref)) us_t5 
...
;; def_axiom
  (assert
  (forall ((temp___2702 Int) (temp___2703 Int) (temp___2704 Int)
  (temp___2705 Int) (temp___2706 Int) (temp___2707 Int))
  (let ((temp___2701 (aida__conversion__calculate_negative_target_length_5__int_array__aggregate_def
                     temp___2702 temp___2703 temp___2704 temp___2705
                     temp___2706 temp___2707)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 4)
  temp___2706 temp___2707)
  (and (= (first7 temp___2701) temp___2706)
  (= (last7 temp___2701) temp___2707)))
  (and
  (and
  (and
  (= (select (to_array2 temp___2701) (+ (+ (first1 source) 1) 0)) (of_rep1
                                                                  temp___2702))
  (= (select (to_array2 temp___2701) (+ (+ (first1 source) 1) 1)) (of_rep1
                                                                  temp___2703)))
  (= (select (to_array2 temp___2701) (+ (+ (first1 source) 1) 2)) (of_rep1
                                                                  temp___2704)))
  (= (select (to_array2 temp___2701) (+ (+ (first1 source) 1) 3)) (of_rep1
                                                                  temp___2705)))))))
...
(define-fun tnumber_array_typeB__ref_33__projection ((a tnumber_array_typeB__ref)) us_t6 
...
;; def_axiom
  (assert
  (forall ((temp___2713 Int) (temp___2714 Int) (temp___2715 Int))
  (let ((temp___2712 (aida__conversion__calculate_negative_target_length_5__n__aggregate_def
                     temp___2713 temp___2714 temp___2715)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 4)
  temp___2714 temp___2715)
  (and (= (first13 temp___2712) temp___2714)
  (= (last13 temp___2712) temp___2715)))
  (forall ((temp___2716 Int))
  (= (select (to_array4 temp___2712) temp___2716) (of_rep1 temp___2713)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_919 us_t3)
  (temp___is_init_916 Bool) (temp___skip_constant_917 Bool)
  (temp___do_toplevel_918 Bool)) Bool (=>
                                      (not (= temp___skip_constant_917 true))
                                      (and (dynamic_property6
                                      (+ (first1 source) 1)
                                      (+ (first1 source) 4)
                                      (first10 temp___expr_919)
                                      (last10 temp___expr_919))
                                      (and
                                      (= (first10 temp___expr_919) (+ 
                                      (first1 source) 1))
                                      (= (last10 temp___expr_919) (+ 
...
(declare-fun temp___2710 () (Array Int integer))

(declare-fun temp___27101 () t2)

(declare-fun aida__conversion__calculate_negative_target_length_5__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_length_5__int_array__assume1 () t1)

(declare-fun temp___2718 () (Array Int integer))

(declare-fun temp___27181 () t4)

(declare-fun aida__conversion__calculate_negative_target_length_5__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_length_5__n__assume1 () t3)

(declare-fun temp___2724 () Int)

(declare-fun temp___2725 () Int)
...
;; H
  ...
  (<= index4 (+ (to_rep1 (first (rt source))) 4)))
...
;; H
  (assert
  (= (mk___t2 temp___2710 temp___27101) (aida__conversion__calculate_negative_target_length_5__int_array__aggregate_def
                                        9 9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___27101)) (to_rep1 (last6 temp___27101)))
     (+ (- (to_rep1 (last6 temp___27101)) (to_rep1 (first6 temp___27101))) 1)
...
;; H
  (assert
  (= (slide1 temp___2710 (to_rep1 (first6 temp___27101))
...
;; H
  (assert
  (= (mk___t4 temp___2718 temp___27181) (aida__conversion__calculate_negative_target_length_5__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 1)
                                        (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___27181)) (to_rep1
                                               (last12 temp___27181)))
     (+ (- (to_rep1 (last12 temp___27181)) (to_rep1 (first12 temp___27181))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1
                                                        (first (rt source))) 4))
        (+ (- (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1
                                                     (first (rt source))) 1)) 1)
...
;; H
  (assert
  (= (slide1 temp___2718 (to_rep1 (first12 temp___27181))
...
;; H
  (assert
  (and (= temp___2724 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (= temp___2725 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))
...
;; H
  (assert (= index1 temp___2724))

;; H
  (assert (<= temp___2724 index1))

;; H
  (assert (<= index1 temp___2725))
...
;; H
  ...
  (and
  (and
  (forall ((temp___2722 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___2722)
  (<= temp___2722 (to_rep1 n__last)))
  (=> (< index2 temp___2722)
  (= (select n3 temp___2722) (select n1 temp___2722)))))
  (=>
