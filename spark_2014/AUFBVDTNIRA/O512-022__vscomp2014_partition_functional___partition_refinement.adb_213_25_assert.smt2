...
;; H
  ...
  (<= k (- (length
           (mk___rep1 p__split_discrs
           (us_split_fields__content1 p__split_fields4))) 1)))
...
;; H
  ...
  (<= (to_rep1
      ...
      (model__
      (mk___rep1 p__split_discrs
      (us_split_fields__content1 p__split_fields4))) k)))) l))
...
;; H
  ...
  (<= l (to_rep1
        ...
        (model__
        (mk___rep1 p__split_discrs
        (us_split_fields__content1 p__split_fields4))) k))))))

(assert
;; WP_parameter_def
 ;; File "partition_refinement.adb", line 18, characters 0-0
  (not (= (to_rep2 (select (map__content f8) l)) k)))
(check-sat)
