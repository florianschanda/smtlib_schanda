...
(define-fun char_table__split_fields2 () us_split_fields (mk___split_fields
...
;; H
  (assert
  (= char_table__split_fields2 names__data__char_tables__append__2__container__fields1))

(assert
;; WP_parameter_def
 ;; File "names.adb", line 64, characters 0-0
  (not
  (= (invariant__ hash_table char_table__split_fields2
     (mk___split_fields1 entry_table__split_fields)) true)))
(check-sat)
