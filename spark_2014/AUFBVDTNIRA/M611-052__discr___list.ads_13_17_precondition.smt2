...
(declare-fun temp___493 () Int)

(declare-fun temp___492 () index)

(declare-fun temp___4921 () index)

(declare-fun temp___4922 () (Array Int integer))

(declare-fun temp___4923 () t2)
...
;; H
  (assert
  (=> (and (<= r7b i9) (<= i9 r8b))
  (and (= res__split_discrs (mk___split_discrs1 temp___494))
  (= res__split_fields temp___4941))))

;; H
  (assert (=> (and (<= r7b i9) (<= i9 r8b)) (= temp___493 i9)))

;; H
  (assert
  (=> (and (<= r7b i9) (<= i9 r8b))
  (and (= s__split_discrs (mk___split_discrs temp___492))
...
;; H
  ...
  (get (model__ l) (+ (- (last5 (model__ l)) j) 1)))))))
...
;; H
  ...
  (and (in_range5 o8) (= o8 (last5 (model__ l))))))
...
;; H
  (assert
  (and
  (= o14 (get (model__ (list__content list__reverse_list__result5)) o13))
  (and (in_range7 o14)
  (= o14 (get (model__ (list__content list__reverse_list__result5)) o13)))))

;; H
  (assert (and (= o7 i2) (in_range4 i2)))
