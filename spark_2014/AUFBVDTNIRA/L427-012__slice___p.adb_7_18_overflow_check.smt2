...
;; H
  (assert (= o (temp___String_Literal_186 Tuple0)))
...
;; H
  (assert
  (= o3 (bool_eq2 temp___189 (to_rep1 (first1 temp___1891))
...
;; H
  ...
  (not
  (= (bool_eq2 new_str1 (to_rep1 (first1 (mk pos2 5)))
