...
(define-fun dynamic_invariant2 ((temp___expr_147 t) (temp___is_init_144 Bool)
  ...
  (temp___do_toplevel_146 Bool)) Bool (=>
                                      ...
                                      fliteral3 last)) (dynamic_property
                                      fliteral3 last temp___expr_147)))
...
;; H
  (assert (dynamic_property fliteral3 last x))

;; H
  (assert
  (and (= o (add RNE1 x fliteral)) (tqtisFinite (add RNE1 x fliteral))))

;; H
  (assert (= result (ite (le o c) true false)))

;; H
  (assert
  (=> (= result true)
  (and (= temp___152 (add RNE1 x fliteral)) (tqtisFinite
  (add RNE1 x fliteral)))))

;; H
  (assert
  (=> (= result true)
  (and (= us temp___152) (dynamic_property fliteral3 last temp___152))))
...
;; H
  (assert
  (=> (not (= result true))
  (and (= us1 fliteral) (dynamic_property fliteral3 last fliteral))))

;; H
  (assert (=> (not (= result true)) (= o2 fliteral)))
