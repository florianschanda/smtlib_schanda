...
;; H
  (assert
  (and (= o (add RNE2 x fliteral)) (tqtisFinite (add RNE2 x fliteral))))
...
;; H
  (assert
  (=> (= result true)
  (and (= temp___153 (add RNE2 x fliteral)) (tqtisFinite
  (add RNE2 x fliteral)))))

;; H
  (assert
  (=> (= result true)
  (and (= us temp___153) (dynamic_property fliteral3 last temp___153))))
