...
(declare-fun data__t_strong_data_type__data_type__first__bit1 () Int)

(declare-fun data__t_strong_data_type__data_type__last__bit1 () Int)

(declare-fun data__t_strong_data_type__data_type__position1 () Int)
...
(declare-fun data__t_strong_data_type__min_nat32__first__bit1 () Int)

(declare-fun data__t_strong_data_type__min_nat32__last__bit1 () Int)

(declare-fun data__t_strong_data_type__min_nat32__position1 () Int)
...
(declare-datatypes () ((t8s__ref (mk_t8s__ref (t8s__content us_rep)))))
...
(declare-fun data__create_type__result () t_data_type)

(declare-fun data__create_type__result1 () t_nat32)

(declare-fun data__create_type__result2 () Bool)

(declare-fun o () t_data_type)

(declare-fun o1 () t_nat32)

(declare-fun o2 () t_nat32)

(declare-fun o3 () t_data_type)

(declare-fun o4 () t_data_type)

(declare-fun o5 () t_nat32)

(declare-fun o6 () Bool)

(declare-fun result () t_data_type)

(declare-fun result1 () t_nat32)

(declare-fun result2 () Bool)

(declare-fun data__create_type__result3 () t_data_type)

(declare-fun data__create_type__result4 () t_nat32)

(declare-fun data__create_type__result5 () Bool)

(declare-fun data__create_type__result6 () t_data_type)

(declare-fun data__create_type__result7 () t_nat32)

(declare-fun data__create_type__result8 () Bool)

(declare-fun data__create_type__result9 () t_data_type)

(declare-fun data__create_type__result10 () t_nat32)

(declare-fun data__create_type__result11 () Bool)

(declare-fun data__create_type__result12 () t_strong_data_type__ref)

(declare-fun data__create_type__result13 () us_rep)
...
(declare-fun result3 () t_data_type)

(declare-fun result4 () t_nat32)
