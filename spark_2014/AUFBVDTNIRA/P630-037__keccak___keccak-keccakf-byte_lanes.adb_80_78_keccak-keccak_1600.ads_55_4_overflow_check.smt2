...
(declare-fun temp___775 () map1)

(declare-fun temp___774 () Int)

(declare-fun temp___773 () Int)

(declare-fun temp___772 () (_ BitVec 8))

(declare-fun temp___771 () (_ BitVec 8))
...
(declare-fun temp___7792 () Int)

(declare-fun result6 () Int)

(declare-fun temp___7782 () Int)
...
;; H
  (assert (=> (<= 64 remaining_bits1) (= temp___775 a)))

;; H
  (assert (=> (<= 64 remaining_bits1) (= temp___774 offset1)))

;; H
  (assert (=> (<= 64 remaining_bits1) (= temp___773 remaining_bits1)))

;; H
  (assert (=> (<= 64 remaining_bits1) (= temp___772 y1)))

;; H
  (assert (=> (<= 64 remaining_bits1) (= temp___771 x1)))

;; H
  (assert (=> (<= 64 remaining_bits1) (= 0 temp___779)))

;; H
  (assert (=> (<= 64 remaining_bits1) (= 0 temp___778)))
...
;; H
  (assert (=> (<= 64 remaining_bits1) (= temp___7791 result5)))

;; H
  (assert (=> (<= 64 remaining_bits1) (= temp___7792 offset2)))

;; H
  (assert (=> (<= 64 remaining_bits1) (= temp___7781 result6)))

;; H
  (assert (=> (<= 64 remaining_bits1) (= temp___7782 remaining_bits2)))
...
;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i4) (<= i4 7)) (= temp___766 lane3))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i4) (<= i4 7)) (and (<= 0 i5) (<= i5 7)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i4) (<= i4 7)) (and (= o8 (* i5 8)) (in_range1 (* i5 8))))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i4) (<= i4 7)) (and (= o9 o8) (in_range2 o8)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i4) (<= i4 7)) (= o10 ((_ int2bv 64) o9)))))
...
;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i4) (<= i4 7)) (= o4 (+ o3 i5)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i4) (<= i4 7)) (and (= temp___765 o4) (in_range1 o4)))))
...
;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i4) (<= i4 7)) (= o5 temp___765))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i4) (<= i4 7)) (= o6 (select (elts data) o5)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i4) (<= i4 7)) (= o7 (to_rep o6)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i4) (<= i4 7)) (= o11 ((_ zero_extend 56) o7)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i4) (<= i4 7)) (= o12 (bvshl o11 o10)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i4) (<= i4 7)) (= o13 (bvor lane4 o12)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i4) (<= i4 7)) (= result9 (mk_t__ref1 lane4)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (and (<= 0 i4) (<= i4 7)) (= lane5 o13))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (and (<= 0 i4) (<= i4 7)) (= i5 7))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i4) (<= i4 7)) (= i6 (mk_int__ref i5)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i4) (<= i4 7)) (= lane6 (mk_t__ref1 lane5)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (and (<= 0 i4) (<= i4 7)) (= i7 i5))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (and (<= 0 i4) (<= i4 7)) (= lane7 lane5))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (and (<= 0 i4) (<= i4 7)) (= i8 i6))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (and (<= 0 i4) (<= i4 7)) (= lane8 lane6))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (and (<= 0 i4) (<= i4 7)) (= i9 i7))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (and (<= 0 i4) (<= i4 7)) (= lane9 lane7))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (not (and (<= 0 i4) (<= i4 7))) (= i8 (mk_int__ref i4)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (not (and (<= 0 i4) (<= i4 7))) (= lane8 (mk_t__ref1 lane3)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (not (and (<= 0 i4) (<= i4 7))) (= i9 i4))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (not (and (<= 0 i4) (<= i4 7))) (= lane9 lane3))))
...
;; H
  (assert (=> (not (<= 64 remaining_bits1)) (= i12 (mk_int__ref i))))
...
;; H
  (assert (=> (not (<= 64 remaining_bits1)) (= i13 i2)))
...
;; H
  (assert (= result16 (mk_int__ref remaining_bytes)))

;; H
  (assert (= remaining_bytes1 o22))
...
;; H
  (assert (= result17 (mk_int__ref i1)))
...
;; H
  (assert (and (<= 0 i15) (<= i15 r64s)))

;; H
  (assert (and (= o25 (* i15 8)) (in_range1 (* i15 8))))
...
;; H
  (assert
  (and (= o23 (+ (to_rep1 (first (rt data))) (int__content offset6)))
  (in_range1 (+ (to_rep1 (first (rt data))) (int__content offset6)))))
