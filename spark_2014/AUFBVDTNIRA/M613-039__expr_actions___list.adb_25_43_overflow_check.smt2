...
;; H
  (assert (top__function_guard (top (mk___rep s__split_fields2))
...
;; H
  ...
  (to_but_top (mk___rep s__split_fields2)) (mk___rep s__split_fields2)))
...
;; H
  ...
  (= (let ((temp___187 (to__
     ...
     (let ((temp___186 (to_but_top (mk___rep s__split_fields2))))
