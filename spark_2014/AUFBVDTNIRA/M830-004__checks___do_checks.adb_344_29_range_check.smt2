...
(declare-fun user_eq4 (tT60bP1 tT60bP1) Bool)

(declare-fun dummy4 () tT60bP1)

(declare-datatypes ()
((tT60bP1__ref (mk_tT60bP1__ref (tT60bP1__content tT60bP1)))))
(define-fun tT60bP1__ref___projection ((a tT60bP1__ref)) tT60bP1 (tT60bP1__content
                                                                 a))

(declare-fun dummy5 () (Array Int Bool))
...
(define-fun us_split_fields_Arr4__projection ((a us_split_fields2)) (Array Int Bool) 
...
(define-fun us_rep_13__projection ((a us_rep1)) us_split_discrs (us_split_discrs2
                                                                a))
...
(define-fun dynamic_invariant1 ((temp___expr_527 us_rep1)
  (temp___is_init_524 Bool) (temp___skip_constant_525 Bool)
  (temp___do_toplevel_526 Bool)) Bool (=>
                                      (not (= temp___skip_constant_525 true))
                                      (in_range3 10
                                      (to_base temp___expr_527))))

(define-fun default_initial_assumption ((temp___expr_530 us_rep1)
...
;; H
  (assert
  (= 10 (to_rep
        (rec__do_checks__do_discriminant_check__r1__j y__split_discrs))))

(assert
;; WP_parameter_def
 ;; File "do_checks.adb", line 324, characters 0-0
  (not (in_range1
  (to_rep
  (rec__do_checks__do_discriminant_check__r1__j (us_split_discrs1 x))))))
(check-sat)
