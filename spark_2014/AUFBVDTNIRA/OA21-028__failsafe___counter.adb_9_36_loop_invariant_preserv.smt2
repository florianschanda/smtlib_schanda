...
;; H
  (assert (= temp___234 result2))

;; H
  (assert (= temp___2341 res2))
...
;; H
  (assert (=> (bvult res3 ((_ int2bv 8) 10)) (= o3 (select inputs o2))))

;; H
  (assert (=> (not (bvult res3 ((_ int2bv 8) 10))) (= o3 false)))
...
;; H
  (assert (bvule (bvsub ((_ int2bv 8) 10) res3) i))
