...
(declare-fun temp___1038 () count_type)

(declare-fun temp___1019 () count_type)

(declare-fun o2 () Int)

(declare-fun temp___1031 () us_rep9)

(declare-fun temp___1030 () count_type)

(declare-fun temp___1029 () count_type)

(declare-fun temp___1032 () t)
...
(declare-fun temp___1027 () us_rep5)

(declare-fun temp___1022 () us_rep5)
...
(declare-fun temp___1033 () us_rep5)
...
(define-fun temp___10191 () us_rep5 (mk___rep5
                                    (mk___split_fields5 temp___1019)))
...
;; H
  ...
  (= (bool_eq21 temp___10191 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
     (us_split_fields__content7 this__split_fields))) temp___10191) true)
  (= (get1
     (positions
     (rec__algorithm__controller__gapvec
     (us_split_fields__content7 this__split_fields))) temp___10191) 1)))))
...
;; H
  (assert
  (=> (= result2 true)
  (= temp___1031 (mk___rep7 (us_split_fields__content7 this__split_fields)))))

;; H
  (assert
  (=> (= result2 true)
  (= iterl__split_fields2 (mk___split_fields5 temp___1030))))

;; H
  (assert
  (=> (= result2 true)
  (= iterr__split_fields1 (mk___split_fields5 temp___1029))))
...
;; H
  ...
  (us_split_fields5
  (rec__algorithm__controller__robot
  (let ((subject this__split_fields)) this__split_fields2))))) temp___1032))))
...
;; H
  (assert
  (=> (= result2 true) (and (= o22 (ccwdiff o17 o20)) (tqtisFinite o22))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (= (of_int1 0) true)
  (and (= o26 (print o25)) (dynamic_invariant1 o26 true false true))))))
...
;; H
  ...
  (= (bool_eq21 temp___1027 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields3))) temp___1027) true)
  (= (get1
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields3))) temp___1027) 1))))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (= result6 true)
  (= iterl__split_fields4 (us_split_fields11 temp___1027))))))
...
;; H
  ...
  (= (bool_eq21 temp___1022 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields2))) temp___1022) true)
  (= (get1
     (positions
     (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields2))) temp___1022) (- 
  (get1
  (positions
  (rec__algorithm__controller__gapvec
  (let ((subject this__split_fields)) this__split_fields2)))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result6 true))
  (= iterl__split_fields5 (us_split_fields11 temp___1022))))))
...
;; H
  ...
  (= (bool_eq21 temp___1033 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
     (us_split_fields__content7 this__split_fields7))) temp___1033) true)
  (= (get1
     (positions
     (rec__algorithm__controller__gapvec
     (us_split_fields__content7 this__split_fields7))) temp___1033) 1))))))
...
;; H
  (assert
  (=> (= result13 true)
  (= iterl__split_fields12 (us_split_fields11 temp___1033))))

;; H
  (assert
  (=> (= result13 true)
  (and
  (= o45 (mul RNE1 fliteral4
         (to_rep2
         (rec__robot_iface__proxy__scan_res
         (us_split_fields5
         (rec__algorithm__controller__robot
...
;; H
  (assert
  (=> (= result13 true) (and (= o46 (ccwdiff o41 o44)) (tqtisFinite o46))))
...
;; H
  ...
  (=> (= result15 true)
  (=> (= (of_int1 0) true)
  (and (= o50 (print o49)) (dynamic_invariant1 o50 true false true))))))
