...
;; H
  ...
  (rolepresent__function_guard o54
...
;; H
  ...
  (= o55 (thecurrentop
         (mk___rep (us_split_fields__content theadmin__split_fields5))))
  (thecurrentop__function_guard o55
...
;; H
  ...
  (= o49 (thecurrentop
         (mk___rep (us_split_fields__content theadmin__split_fields5))))
  (thecurrentop__function_guard o49
  (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range6
  o49)))
...
;; H
  ...
  (= o52 (rolepresent
         (mk___rep (us_split_fields__content theadmin__split_fields5))))
  (rolepresent__function_guard o52
  (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range4
  o52))))
...
;; H
  (assert
  (and (= o41 (islocked (us_private__content state21)))
  (islocked__function_guard o41 (us_private__content state21))))
...
;; H
  ...
  (=> (= result4 true)
  (and
  (and (= o45 (theauthcertrole (us_private__content state20)))
  (theauthcertrole__function_guard o45 (us_private__content state20)))
  (in_range4 o45))))
...
;; H
  (assert
  (=> (= result4 true)
  (and (= o43 (authcertvalid (us_private__content state20)))
  (authcertvalid__function_guard o43 (us_private__content state20)))))

;; H
  (assert
  (=> (= result4 true)
  (and (= o44 (isgood (us_private__content state20))) (isgood__function_guard
  o44 (us_private__content state20)))))
...
;; H
  ...
  (=> (= result5 true)
  (and
  (and (= o37 (theauthcertrole (us_private__content state20)))
  (theauthcertrole__function_guard o37 (us_private__content state20)))
  (in_range4 o37))))
...
;; H
  (assert
  (=> (= result5 true)
  (and (= o35 (authcertvalid (us_private__content state20)))
  (authcertvalid__function_guard o35 (us_private__content state20)))))

;; H
  (assert
  (=> (= result5 true)
  (and (= o36 (isgood (us_private__content state20))) (isgood__function_guard
  o36 (us_private__content state20)))))
...
;; H
  (assert
  (and
  (and (= o29 (thedooralarm (us_private__content state22)))
  (thedooralarm__function_guard o29 (us_private__content state22)))
  (in_range15 o29)))
...
;; H
  (assert
  (and (= o62 (alarm_timeout (us_private__content state22)))
  (alarm_timeout__function_guard o62 (us_private__content state22))))

;; H
  (assert
  (and (= o63 (thecurrenttime currenttime)) (thecurrenttime__function_guard
  o63 currenttime)))

;; H
  (assert
  (and (= o26 (greaterthanorequal o63 o62))
  (greaterthanorequal__function_guard o26 o63 o62)))

;; H
  (assert
  (and
  (and (= o15 (thecurrentdoor (us_private__content state22)))
  (thecurrentdoor__function_guard o15 (us_private__content state22)))
  (in_range14 o15)))
...
;; H
  (assert
  (and (= o17 (islocked (us_private__content state21)))
  (islocked__function_guard o17 (us_private__content state21))))
...
;; H
  (assert
  (=> (= (int__content status3) 8)
  (and (= o3 (islocked (us_private__content state21)))
  (islocked__function_guard o3 (us_private__content state21)))))
