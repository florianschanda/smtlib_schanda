...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 75.0)))
...
(declare-fun lat_long__cos__result () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun lat_long__cos__result1 () t)

(declare-fun lat_long__cos__result2 () t)

(declare-fun lat_long__cos__result3 () t)

(declare-fun lat_long__cos__result4 () t)

(declare-fun lat_long__cos__result5 () t)
...
;; H
  ...
  (and (= o (sin1 x))
  (and (tqtisFinite o)
  (and (and (le (neg fliteral) o) (le o fliteral))
  (=> (eq x fliteral2) (eq o fliteral2))))))
...
;; H
  (assert (le (neg fliteral3) x))

;; H
  (assert (le x fliteral3))

(assert
;; WP_parameter_def
 ;; File "lat_long.ads", line 6, characters 0-0
  (not (le fliteral4 lat_long__cos__result4)))
(check-sat)
