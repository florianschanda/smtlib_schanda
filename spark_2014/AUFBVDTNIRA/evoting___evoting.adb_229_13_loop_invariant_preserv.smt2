...
;; H
  ...
  (forall ((j12 Int))
  (=> (and (<= 1 j12) (<= j12 (- i2 1)))
  (=> (< latest_highest_score2 j12)
  (< (to_rep (select counters j12)) (to_rep
                                    (select counters latest_highest_score2)))))))
  (forall ((j12 Int))
  (=> (and (<= 1 j12) (<= j12 (- i2 1)))
  (ite (= (select winners3 j12) true)
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters 
                                                      i2)))
  (=> (and (<= 0 j1) (<= j1 (- i2 1))) (= temp___706 winners3))))
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters 
                                                      i2)))
  (=> (and (<= 0 j1) (<= j1 (- i2 1))) (= temp___705 j1))))
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters 
                                                      i2)))
  (=> (and (<= 0 j1) (<= j1 (- i2 1))) (and (<= 0 j2) (<= j2 20)))))
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters 
                                                      i2)))
  (=> (and (<= 0 j1) (<= j1 (- i2 1))) (= o1 (store winners4 o (of_int 0))))))
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters 
                                                      i2)))
  (=> (and (<= 0 j1) (<= j1 (- i2 1))) (= winners4 result5))))
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters 
                                                      i2)))
  (=> (and (<= 0 j1) (<= j1 (- i2 1))) (= winners5 winners6))))
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters 
                                                      i2)))
  (=> (and (<= 0 j1) (<= j1 (- i2 1))) (= winners7 winners5))))
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters 
                                                      i2)))
  (=> (and (<= 0 j1) (<= j1 (- i2 1))) (= j11 (mk_int__ref j3)))))
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters 
                                                      i2)))
  (=> (and (<= 0 j1) (<= j1 (- i2 1))) (= winners17 (mk_map__ref1 winners6)))))
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters 
                                                      i2)))
  (=> (and (<= 0 j1) (<= j1 (- i2 1))) (= winners9 winners7))))
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters 
                                                      i2)))
  (=> (not (and (<= 0 j1) (<= j1 (- i2 1)))) (= winners3 winners8))))
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters 
                                                      i2)))
  (=> (not (and (<= 0 j1) (<= j1 (- i2 1)))) (= winners9 winners3))))
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters 
                                                      i2)))
  (= (mk_map__ref1 result6) winners17)))
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters 
                                                      i2)))
  (= winners10 (store winners8 i2 (of_int 1)))))
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      ...
                                                      i2))))
  (=>
  (= (to_rep (select counters i2)) (to_rep
                                   (select counters latest_highest_score2)))
  (= winners3 result8))))
...
;; H
  ...
  (= (to_rep (select counters i2)) (to_rep
                                   (select counters latest_highest_score2)))
  (= winners11 (store winners3 i2 (of_int 1))))))
...
;; H
  ...
  (= (to_rep (select counters i2)) (to_rep
                                   (select counters latest_highest_score2))))
  (= winners12 (store winners3 i2 (of_int 0))))))
...
;; WP_parameter_def
 ;; File "evoting.ads", line 48, characters 0-0
  (not (not (= (select (map__content1 winners15) 0) true))))
(check-sat)
