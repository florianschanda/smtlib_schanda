...
;; H
  (assert
  (= (concat1 (temp___String_Literal_180 Tuple0) 1 11 temp___182
     (to_rep1 (first temp___1821)) (to_rep1 (last temp___1821))) o6))
...
;; H
  (assert (size__function_guard (size last4) last4))
