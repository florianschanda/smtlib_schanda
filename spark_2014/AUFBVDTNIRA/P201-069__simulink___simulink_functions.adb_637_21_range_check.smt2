...
;; H
  (assert
  (and (= o (sqrt3 (to_float64 RNE1 f)))
  (and (tqtisFinite1 o)
  (and (le1 fliteral4 o)
  (and (=> (eq1 (to_float64 RNE1 f) fliteral4) (eq1 o fliteral4))
  (and (=> (eq1 (to_float64 RNE1 f) fliteral1) (eq1 o fliteral1))
  (=> (le1 fliteral5 (to_float64 RNE1 f)) (lt1 fliteral4 o))))))))
