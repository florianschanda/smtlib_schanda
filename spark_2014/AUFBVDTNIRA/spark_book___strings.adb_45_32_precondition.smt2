...
(declare-fun temp___1681 () t2)

(declare-fun o3 () (Array Int character))

(declare-fun o4 () t)

(declare-fun o5 () us_image)
...
;; H
  (assert
  (=> (<= r8b (to_rep1 (last (rt text))))
  (and
  (and (<= (to_rep1 (first (rt text))) r8b)
  (<= r8b (to_rep1 (last (rt text)))))
  (and (<= (to_rep1 (first (rt text))) (to_rep1 (last (rt text))))
  (<= (to_rep1 (last (rt text))) (to_rep1 (last (rt text))))))))

;; H
  (assert (= o2 (elts text)))

;; H
  (assert (= o2 temp___168))

;; H
  (assert (= (mk2 r8b (to_rep1 (last (rt text)))) temp___1681))
...
;; H
  (assert
  (= (mk (to_rep1 (first6 temp___1681)) (to_rep1 (last6 temp___1681))) 
  o4))
...
;; WP_parameter_def
 ;; File "strings.adb", line 5, characters 0-0
  (not (attr__ATTRIBUTE_VALUE__pre_check o5)))
(check-sat)
