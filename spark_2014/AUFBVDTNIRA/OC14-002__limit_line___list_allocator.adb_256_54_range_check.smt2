...
;; H
  (assert (= result12 (ite (in_range4 o68) true false)))
...
;; H
  (assert
  (=> (= result12 true)
  (=> (= result13 true) (and (= o65 (+ j 1)) (in_range1 (+ j 1))))))
...
;; H
  (assert (=> (= result12 true) (= o62 (us_split_fields1 o61))))

;; H
  (assert
  (=> (= result12 true) (= o63 (rec__list_allocator__cell__next o62))))
