...
(declare-fun temp___2818 () (Array Int us_rep1))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2822 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2822 (parent
                      (mk___rep2
...
;; H
  ...
  (model____function_guard temp___2822
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  root))
  (and (dynamic_invariant3 temp___2822 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2822 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2822 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2822 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2822 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2822 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2822 j)))) true))
  (= j i))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o o1)) (select temp___2822 v)))
...
;; H
  (assert (= result (ite (not (= o4 true)) true false)))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2818 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2818 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___2818 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (model____function_guard temp___2818
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  root))
  (and (dynamic_invariant3 temp___2818 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2818 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2818 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2818 (parent
                              ...
                              f_old__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2818 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2818 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2818 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2818 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2818 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2818 j)))) true))
  (= j i))))))))))))))
