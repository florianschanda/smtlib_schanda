...
(define-fun o14 () us_t (mk___t o7 o8))

(define-fun o15 () us_t (mk___t o5 o6))

(define-fun o16 () us_t (mk___t o o1))
...
;; H
  (assert (occ__function_guard
  (occ (mk___t b1 (mk (to_rep b__first) (to_rep b__last))) e)
  (mk___t b1 (mk (to_rep b__first) (to_rep b__last))) e))

;; H
  (assert (occ__function_guard (occ o16 e) o16 e))

;; H
  (assert (occ__function_guard (occ o15 e) o15 e))

;; H
  (assert (occ__function_guard
  (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e)
  (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e))
...
;; H
  (assert (occ__function_guard (occ o14 e) o14 e))
...
;; H
  ...
  (and (not (= (length a) 0))
  (and (and (= b2 b3) (= b4 b2))
  (ite (= i (to_rep (last (rt a))))
  (and
  (and
  (and (and (= o16 (remove_last r)) (remove_last__function_guard o16 r))
  ...
  o1))))
  (= (occ (mk___t b1 (mk (to_rep b__first) (to_rep b__last))) e) (occ o16 e)))
  (= b2 b1))
  (and
  (and
  (and
  (and (= (to_rep o2) v)
  (and (and (and (<= (to_rep b__first) i) (<= i (to_rep b__last))) (= o3 i))
  (= temp___263 (store b1 o3 o2))))
  (and (= (to_rep b__first) 0) (= o4 temp___263)))
  (and (= b1 result1) (= b2 o4)))
  (and
  (and
  (and (and (= o15 (remove_last r)) (remove_last__function_guard o15 r))
  ...
  (= (mk
     ...
     (last3 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1))))) 
  o6))))
  (= (occ o15 e) (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e)))
  (and
  (and (and (= o14 (remove_last a)) (remove_last__function_guard o14 a))
  ...
  (= (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e) (occ o14 e))
  (ite (= v e)
  (= (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e) (+ (occ 
                                                                    o14 
                                                                    e) 1))
...
;; H
  (assert (and (<= (to_rep (first (rt a))) i) (<= i (to_rep (last (rt a))))))
...
;; H
  (assert (occ_def__function_guard (occ_def a e) a e))

;; H
  (assert
  (and (and (= o12 (occ a e)) (occ__function_guard o12 a e))
  (and (in_range3 o12) (and (= o12 (occ_def a e)) (<= o12 (length a))))))
