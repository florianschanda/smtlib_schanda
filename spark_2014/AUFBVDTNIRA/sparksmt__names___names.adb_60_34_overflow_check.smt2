...
(define-fun dynamic_invariant ((temp___expr_403 us_rep)
  ...
  (temp___do_toplevel_402 Bool)) Bool (=>
                                      ...
                                      (in_range4 1024 temp___expr_403)))
...
(declare-fun user_eq6 (tchar_table_indexB tchar_table_indexB) Bool)
...
(define-fun dynamic_invariant2 ((temp___expr_292 Int)
...
(define-fun dynamic_invariant11 ((temp___expr_364 Int)
...
(define-fun dynamic_invariant12 ((temp___expr_390 Int)
