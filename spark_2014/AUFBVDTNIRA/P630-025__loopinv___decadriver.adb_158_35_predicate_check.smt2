...
(declare-fun o42 () (Array Int bits_8))

(declare-fun o43 () rx_errors)

(declare-fun o44 () Bool)

(declare-fun o45 () (Array (_ BitVec 8) us_rep))

(declare-fun o46 () (Array (_ BitVec 8) us_rep))

(declare-fun o47 () rx_frame_queue_index)
