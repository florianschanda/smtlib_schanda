...
;; H
  (assert
  (and
  (= o92 (mul RNE1 (let ((subject q3_tmp)) q3_tmp1)
...
;; H
  (assert
  (and
  (= o89 (mul RNE1 (let ((subject q2_tmp)) q2_tmp1)
...
;; H
  (assert
  (and
  (= o87 (mul RNE1 (let ((subject q0_tmp)) q0_tmp1)
...
;; H
  (assert (= o88 (add RNE1 o87 o86)))

;; H
  (assert (and (= o90 o88) (tqtisFinite o88)))

;; H
  (assert (= o91 (add RNE1 o90 o89)))

;; H
  (assert (and (= o93 o91) (tqtisFinite o91)))

;; H
  (assert (= o94 (add RNE1 o93 o92)))
...
;; H
  (assert
  (and (= o97 (mul RNE1 (let ((subject q0_tmp)) q0_tmp1) recip_norm3))
  (tqtisFinite (mul RNE1 (let ((subject q0_tmp)) q0_tmp1) recip_norm3))))
