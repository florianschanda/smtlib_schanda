...
(define-fun dynamic_invariant4 ((temp___expr_658 us_rep1)
  (temp___is_init_655 Bool) (temp___skip_constant_656 Bool)
  (temp___do_toplevel_657 Bool)) Bool (and
                                      (=>
                                      ...
                                      (first3
                                      (rec__aco__math__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_658)))
                                      (last5
                                      (rec__aco__math__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_658))))
                                      (and
                                      (= (first3
                                         (rec__aco__math__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_658))) 1)
                                      (= (last5
                                         (rec__aco__math__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_658))) 
                                      (to_rep1
...
(define-fun default_initial_assumption ((temp___expr_661 us_rep1)
  (temp___skip_top_level_662 Bool)) Bool (= (to_rep1
                                            (rec__aco__math__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_661))) (to_rep1
                                                               (rec__aco__math__very_longs__very_long__octet_length
                                                               (us_split_discrs1
                                                               l)))))
...
(declare-fun temp___1115 ((_ BitVec 8) Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___1117 (_ BitVec 8)))
  (forall ((temp___1118 Int) (temp___1119 Int))
  (let ((temp___1116 (temp___1115 temp___1117 temp___1118 temp___1119)))
  (and
  (=> (dynamic_property6 1 2147483647 temp___1118 temp___1119)
  (and (= (first5 temp___1116) temp___1118)
  (= (last8 temp___1116) temp___1119)))
  (forall ((temp___1120 Int))
  (= (select (to_array2 temp___1116) temp___1120) (of_rep temp___1117))))))))
...
(declare-fun temp___1122 () (Array Int octet))

(declare-fun temp___11221 () t2)

(declare-fun temp___1123 () (Array Int octet))

(declare-fun temp___11231 () t1)
...
;; H
  (assert
  (= (mk___t2 temp___1122 temp___11221) (temp___1115 ((_ int2bv 8) 0) 1
                                        (to_rep1
                                        (rec__aco__math__very_longs__very_long__octet_length
                                        (us_split_discrs1 l))))))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___11221)) (to_rep2 (last7 temp___11221)))
     (+ (- (to_rep2 (last7 temp___11221)) (to_rep2 (first4 temp___11221))) 1)
     0) (ite (<= 1 (to_rep1
                   (rec__aco__math__very_longs__very_long__octet_length
                   (us_split_discrs1 l))))
        (+ (- (to_rep1
...
;; H
  (assert (= temp___1122 temp___1123))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___11221)) (to_rep2 (last7 temp___11221))) 
  temp___11231))
...
;; WP_parameter_def
 ;; File "aco-math-very_longs.ads", line 108, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first2 temp___11231)) (to_rep2 (last4 temp___11231)))
     (+ (- (to_rep2 (last4 temp___11231)) (to_rep2 (first2 temp___11231))) 1)
