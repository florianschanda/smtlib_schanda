...
(declare-fun inline_init__rec__c__first__bit () Int)

(declare-fun inline_init__rec__c__last__bit () Int)

(declare-fun inline_init__rec__c__position () Int)
...
(assert
;; WP_parameter_def
 ;; File "inline_init.adb", line 4, characters 0-0
  (not (= y1 3)))
(check-sat)
