...
;; H
  (assert (invariant____function_guard (invariant__ o24) o24))

;; H
  (assert (invariant____function_guard (invariant__ o25) o25))

;; H
  (assert (remove__function_guard (remove o24 o19) o24 o19))

;; H
  (assert (remove__function_guard (remove o25 o19) o25 o19))
...
;; H
  (assert
  (and
  (and (= o24 (remove (mk___t values2 (mk 1 100)) o16))
  (remove__function_guard o24 (mk___t values2 (mk 1 100)) o16))
...
;; H
  (assert
  (and
  (and (= o25 (remove (mk___t interm1 (mk 1 100)) o13))
  (remove__function_guard o25 (mk___t interm1 (mk 1 100)) o13))
  (and (dynamic_invariant4 o25 true false true)
...
;; H
  (assert
  (and
  (and (= o20 (remove_eq o25 o24 o19)) (remove_eq__function_guard o20 
  o25 o24 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___181 (remove o24 o19)))
     (let ((temp___180 (remove o25 o19)))
