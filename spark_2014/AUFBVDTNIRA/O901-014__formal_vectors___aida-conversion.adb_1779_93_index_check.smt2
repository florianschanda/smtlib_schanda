...
;; H
  (assert (<= temp___2452 index1))

;; H
  (assert (<= index1 temp___2453))
...
;; H
  (assert
  (forall ((j1 Int))
  (=> (and (<= (+ (to_rep1 (first (rt source))) 2) j1) (<= j1 index2))
...
;; H
  ...
  (=> (< index2 temp___2451)
  (= (select n3 temp___2451) (select n1 temp___2451))))))
  (and (<= (+ (to_rep1 (first (rt source))) 2) index2)
  (<= index2 (+ (to_rep1 (first (rt source))) 10)))))

;; H
  (assert
  (and (= o9 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))
