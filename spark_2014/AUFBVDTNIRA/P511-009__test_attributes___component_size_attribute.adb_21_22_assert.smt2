...
(define-fun bool_eq7 ((x1 us_t1)
  (y us_t1)) Bool (bool_eq1 (elts1 x1) (to_rep (first2 (rt1 x1)))
...
(define-fun bool_eq9 ((x1 us_t2)
  (y us_t2)) Bool (bool_eq1 (elts2 x1) (to_rep (first4 (rt2 x1)))
...
;; def_axiom
  ...
  (and (= (first3 temp___209) temp___211) (= (last5 temp___209) temp___212)))
...
(define-fun dynamic_invariant2 ((temp___expr_168 us_t)
  ...
  (temp___do_toplevel_167 Bool)) Bool (=>
                                      ...
                                      (last2 temp___expr_168))
                                      (and (= (first1 temp___expr_168) 1)
                                      (= (last2 temp___expr_168) x)))))

(declare-fun a1 () (Array Int integer))

(declare-fun a2 () (Array Int us_t))

(declare-fun temp___215 () (Array Int integer))

(declare-fun temp___2151 () t1)

(declare-fun component_size_attribute__p__a1__assume () (Array Int integer))

(declare-fun component_size_attribute__p__a1__assume1 () t)

(declare-fun o () (Array Int us_t))

(declare-fun result () (Array Int integer))

(declare-fun a11 () (Array Int integer))

(declare-fun result1 () (Array Int us_t))

(declare-fun a21 () (Array Int us_t))
...
;; H
  (assert
  (= (to_rep
     (last4 (rt1 (component_size_attribute__p__a1__aggregate_def 1 1 x)))) 
  x))
...
;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___2151)) (to_rep (last4 temp___2151)))
     (+ (- (to_rep (last4 temp___2151)) (to_rep (first2 temp___2151))) 1) 0) 
  (ite (<= 1 x) (+ (- x 1) 1) 0)))
...
;; H
  (assert
  (= (mk (to_rep (first2 temp___2151)) (to_rep (last4 temp___2151))) 
...
;; H
  ...
  (= (to_rep a1__last) (to_rep
                       (last1 component_size_attribute__p__a1__assume1))))
...
;; H
  (assert
  (= o (component_size_attribute__p__a2__aggregate_def
