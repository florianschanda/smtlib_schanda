...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__otp_wdat_type__otp_wdat bits_32)))))
(define-fun us_split_fields_OTP_WDAT__projection ((a us_split_fields)) bits_32 
  (rec__dw1000__register_types__otp_wdat_type__otp_wdat a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_73__projection ((a us_split_fields__ref)) us_split_fields 
...
(define-fun bool_eq6 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__otp_wdat_type__otp_wdat
...
(declare-fun dw1000__register_types__otp_wdat_type__otp_wdat__first__bit () Int)

(declare-fun dw1000__register_types__otp_wdat_type__otp_wdat__last__bit () Int)

(declare-fun dw1000__register_types__otp_wdat_type__otp_wdat__position () Int)

;; dw1000__register_types__otp_wdat_type__otp_wdat__first__bit_axiom
  (assert (<= 0 dw1000__register_types__otp_wdat_type__otp_wdat__first__bit))

;; dw1000__register_types__otp_wdat_type__otp_wdat__last__bit_axiom
  (assert
  (< dw1000__register_types__otp_wdat_type__otp_wdat__first__bit dw1000__register_types__otp_wdat_type__otp_wdat__last__bit))

;; dw1000__register_types__otp_wdat_type__otp_wdat__position_axiom
  (assert (<= 0 dw1000__register_types__otp_wdat_type__otp_wdat__position))

(declare-fun dummy5 () us_rep)

(declare-datatypes ()
((otp_wdat_type__ref (mk_otp_wdat_type__ref (otp_wdat_type__content us_rep)))))
(define-fun otp_wdat_type__ref___projection ((a otp_wdat_type__ref)) us_rep 
  (otp_wdat_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_178__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_125__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_125__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6166 us_t1)
  (temp___is_init_6163 Bool) (temp___skip_constant_6164 Bool)
  (temp___do_toplevel_6165 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6164 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_6166)
                                       (last4 temp___expr_6166))
                                       (and (= (first3 temp___expr_6166) 1)
                                       (= (last4 temp___expr_6166) 4)))))
...
(define-fun target__ref_54__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_54__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_6182 us_t2)
  (temp___is_init_6179 Bool) (temp___skip_constant_6180 Bool)
  (temp___do_toplevel_6181 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6180 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_6182)
                                       (last6 temp___expr_6182))
                                       (and (= (first5 temp___expr_6182) 1)
                                       (= (last6 temp___expr_6182) 4)))))
...
(declare-fun temp___7954 () (Array Int bits_8))

(declare-fun temp___79541 () t2)

(declare-fun temp___7955 () (Array Int bits_8))

(declare-fun temp___79551 () t1)
...
(define-fun temp___79542 () us_t2 (mk___t2 temp___7954 temp___79541))
...
;; H
  (assert
  (and
  (and (= temp___79542 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___79542 reg)) (dynamic_invariant1
  temp___79542 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___79541)) (to_rep (last5 temp___79541)))
     (+ (- (to_rep (last5 temp___79541)) (to_rep (first4 temp___79541))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___7954 temp___7955))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___79541)) (to_rep (last5 temp___79541))) 
  temp___79551))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___79551)) (to_rep (last3 temp___79551)))
     (+ (- (to_rep (last3 temp___79551)) (to_rep (first2 temp___79551))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7955 temp___79551)))
