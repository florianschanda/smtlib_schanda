...
;; H
  (assert (= temp___1570 (mk___rep4 o23)))

;; H
  (assert (= result9 (mk___split_fields__ref4 t__split_fields7)))

;; H
  (assert (= t__split_fields8 (us_split_fields9 temp___1570)))
...
;; H
  (assert (and (<= 1 temp___1572) (<= temp___1572 100)))

;; H
  (assert (= o26 temp___1572))
...
;; H
  (assert (= temp___1574 (mk___rep4 o28)))

;; H
  (assert (= result10 (mk___split_fields__ref4 t__split_fields8)))

;; H
  (assert (= t__split_fields9 (us_split_fields9 temp___1574)))
...
;; H
  (assert (and (<= 1 temp___1576) (<= temp___1576 100)))

;; H
  (assert (= o31 temp___1576))
...
;; H
  (assert (= temp___1578 (mk___rep4 o33)))

;; H
  (assert (= result11 (mk___split_fields__ref4 t__split_fields9)))

;; H
  (assert (= t__split_fields10 (us_split_fields9 temp___1578)))
...
;; H
  (assert (= (mk___rep4 t_old__split_fields7) c74b))

;; H
  (assert (dynamic_invariant6 c74b true false true))

;; H
  (assert (= (mk___rep4 t__split_fields10) c75b))
...
;; H
  (assert (= red_black_trees__insert__L_8__C76b__assume c76b))

;; H
  (assert (in_range2 c76b))

;; H
  (assert (same_nb_blacks__function_guard (same_nb_blacks c74b) c74b))

;; H
  (assert (= (same_nb_blacks c74b) true))
...
;; H
  (assert (model____function_guard
  (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c74b)))
  (rec__red_black_trees__rbt__struct (us_split_fields9 c74b))))

;; H
  (assert (nb_blacks__function_guard (nb_blacks c74b) c74b))
...
;; H
  ...
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c74b) i)))) n5))

;; H
  (assert (parent__function_guard
  (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i)
  (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i))
...
;; H
  (assert (nb_blacks__function_guard (nb_blacks c75b) c75b))
...
;; WP_parameter_def
 ;; File "red_black_trees.ads", line 59, characters 0-0
  (not
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select (nb_blacks c75b) i))) true)))
(check-sat)
