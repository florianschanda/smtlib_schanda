...
;; H
  ...
  (and (= o4 (abs a)) (in_range1 (abs a)))))

;; H
  (assert
  (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648))))
  (and (= o5 (abs an2)) (in_range1 (abs an2)))))

;; H
  (assert
  (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648))))
  (= result3 (ite (<= o5 o4) true false))))
...
;; H
  (assert
  (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648))))
  (=> (not (= result3 true)) (and (= o2 (abs b)) (in_range1 (abs b))))))

;; H
  (assert
  (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648))))
  (=> (not (= result3 true)) (and (= o3 (abs an2)) (in_range1 (abs an2))))))

;; H
  (assert
  (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648))))
  (=> (not (= result3 true)) (= result2 (ite (<= o3 o2) true false)))))
