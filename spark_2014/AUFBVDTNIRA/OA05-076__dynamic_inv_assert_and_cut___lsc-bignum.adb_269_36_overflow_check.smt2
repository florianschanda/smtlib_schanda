...
;; H
  (assert
  (and (= o4 (from_word32 (t__content carry28))) (from_word32__function_guard
  o4 (t__content carry28))))

;; H
  (assert
  (and (and (= o3 (base Tuple0)) (base__function_guard o3 Tuple0))
  (= o3 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o5 (omultiply o3 o4)) (omultiply__function_guard o5 o3 o4)))

;; H
  (assert
  (and (= o2 (from_word32 (t__content carry18))) (from_word32__function_guard
  o2 (t__content carry18))))

;; H
  (assert (and (= o6 (oadd o2 o5)) (oadd__function_guard o6 o2 o5)))
