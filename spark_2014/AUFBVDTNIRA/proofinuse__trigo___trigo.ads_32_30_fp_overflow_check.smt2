...
;; tan__post_axiom
  ...
  (! (=> (dynamic_invariant x true true true)
     ...
     result true false true)))) :pattern ((tan1 x)) )))
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral5) (= (tqtreal fliteral5) 15.0)))

(declare-fun fliteral6 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral6) (= (tqtreal fliteral6) 17.0)))

(declare-fun fliteral7 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral7) (= (tqtreal fliteral7) 315.0)))

(declare-fun fliteral8 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral8) (= (tqtreal fliteral8) 62.0)))

(declare-fun fliteral9 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral9) (= (tqtreal fliteral9) 2835.0)))
...
;; approx_tan__def_axiom
  ...
  (! (=>
     ...
     (= (approx_tan x) (add RNE2
                       (add RNE2
                       (add RNE2 (add RNE2 x (div1 RNE2 (pow3 x) fliteral3))
                       (div1 RNE2 (mul RNE2 fliteral4 (pow5 x)) fliteral5))
                       (div1 RNE2 (mul RNE2 fliteral6 (pow7 x)) fliteral7))
                       (div1 RNE2 (mul RNE2 fliteral8 (pow9 x)) fliteral9)))))))) :pattern (
  (approx_tan x)) )))
...
;; pow3__def_axiom
  ...
  (! (=>
     ...
     (pow3 x1) x1)) (= (pow3 x1) (mul RNE2 (mul RNE2 x1 x1) x1))) :pattern (
  (pow3 x1)) )))
...
;; pow5__def_axiom
  ...
  (! (=>
     ...
     (pow5 x1) x1))
     (= (pow5 x1) (mul RNE2 (mul RNE2 (mul RNE2 (mul RNE2 x1 x1) x1) x1) x1))) :pattern (
  (pow5 x1)) )))
...
;; pow7__def_axiom
  ...
  (! (=>
     ...
     (= (pow7 x1) (mul RNE2
                  (mul RNE2
                  (mul RNE2 (mul RNE2 (mul RNE2 (mul RNE2 x1 x1) x1) x1) x1)
                  x1) x1))) :pattern ((pow7 x1)) )))
...
(declare-fun trigo__tan__result () t)
...
(declare-fun trigo__tan__result1 () t)

(declare-fun trigo__tan__result2 () t)

(declare-fun trigo__tan__result3 () t)

(declare-fun trigo__tan__result4 () t)

(declare-fun trigo__tan__result5 () t)

;; H
  (assert (tqtisFinite x))

;; H
  (assert (and (le (neg fliteral10) x) (le x fliteral10)))
...
;; H
  (assert
  (and (= o (tan1 x))
  (and (tqtisFinite o) (=> (eq x fliteral2) (eq o fliteral2)))))
...
;; H
  ...
  (= o1 (add RNE2
        ...
        (div1 RNE2 (mul RNE2 fliteral4 (pow5 x)) fliteral5))
        (div1 RNE2 (mul RNE2 fliteral6 (pow7 x)) fliteral7))
        (div1 RNE2 (mul RNE2 fliteral8 (pow9 x)) fliteral9))))))

;; H
  (assert (= o2 (sub RNE2 trigo__tan__result4 o1)))
