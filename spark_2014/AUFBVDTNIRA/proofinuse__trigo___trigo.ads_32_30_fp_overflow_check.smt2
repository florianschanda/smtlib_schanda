...
;; approx_tan__def_axiom
  ...
  (! (=> (dynamic_invariant x true true true)
     (= (approx_tan x) (add RNE1
                       (add RNE1
                       (add RNE1 (add RNE1 x (div1 RNE1 (pow3 x) fliteral3))
                       (div1 RNE1 (mul RNE1 fliteral4 (pow5 x)) fliteral5))
                       (div1 RNE1 (mul RNE1 fliteral6 (pow7 x)) fliteral7))
                       (div1 RNE1 (mul RNE1 fliteral8 (pow9 x)) fliteral9)))) :pattern (
  (approx_tan x)) )))
...
;; pow3__def_axiom
  ...
  (! (=> (dynamic_invariant x1 true true true)
     (= (pow3 x1) (mul RNE1 (mul RNE1 x1 x1) x1))) :pattern ((pow3 x1)) )))
...
;; pow5__def_axiom
  ...
  (forall ((x1 t))
  (! (=> (dynamic_invariant x1 true true true)
     (= (pow5 x1) (mul RNE1 (mul RNE1 (mul RNE1 (mul RNE1 x1 x1) x1) x1) x1))) :pattern (
  (pow5 x1)) )))
...
;; pow7__def_axiom
  ...
  (! (=> (dynamic_invariant x1 true true true)
     (= (pow7 x1) (mul RNE1
                  (mul RNE1
                  (mul RNE1 (mul RNE1 (mul RNE1 (mul RNE1 x1 x1) x1) x1) x1)
...
;; H
  ...
  (= o1 (add RNE1
        ...
        (div1 RNE1 (mul RNE1 fliteral4 (pow5 x)) fliteral5))
        (div1 RNE1 (mul RNE1 fliteral6 (pow7 x)) fliteral7))
        (div1 RNE1 (mul RNE1 fliteral8 (pow9 x)) fliteral9))))))

;; H
  (assert (= o2 (sub RNE1 trigo__tan__result4 o1)))
