...
;; H
  (assert
  (=> (= result6 true) (and (= o12 (- last6 i9)) (in_range1 (- last6 i9)))))
...
;; H
  ...
  (=> (= result6 true)
  (and
  (and (= o11 (to__ (mk___rep s__split_fields9))) (to____function_guard 
  o11 (mk___rep s__split_fields9)))
...
;; H
  (assert
  (=> (= result5 true) (and (= o7 (- last6 i9)) (in_range1 (- last6 i9)))))
