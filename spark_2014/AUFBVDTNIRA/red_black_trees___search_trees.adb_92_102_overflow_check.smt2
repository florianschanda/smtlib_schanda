...
(declare-fun temp___1272 () (Array Int us_rep1))
...
(declare-fun temp___1273 () (Array Int us_rep1))
...
;; H
  (assert
  (= o46 (select temp___1279 (int__content search_trees__find_root__result4))))
...
;; H
  (assert (= o43 (select temp___1278 i)))
...
;; H
  (assert
  (= o40 (select temp___1277 (int__content search_trees__find_root__result4))))
...
;; H
  (assert (= o37 (select temp___1276 j)))
...
;; H
  (assert
  (= (mk___rep (mk___split_fields o33 o34)) (select temp___1275 (int__content
...
;; H
  (assert
  (= (mk___rep (mk___split_fields o24 o25)) (select temp___1274 (int__content
                                                                search_trees__find_root__result4))))
...
;; H
  (assert
  (and (= temp___1273 (model__ f root))
  (and (dynamic_invariant4 temp___1273 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1273 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1273 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1273 (parent f i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1273 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1273 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1273 (parent f i1)))) (position f i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1273 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1273 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1273 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1273 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1273 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o19 o20)) (select temp___1273 
  j)))
...
;; H
  (assert
  (and (= temp___1272 (model__ f root))
  (and (dynamic_invariant4 temp___1272 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1272 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1272 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1272 (parent f i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1272 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1272 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1272 (parent f i1)))) (position f i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1272 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1272 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1272 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1272 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1272 j1)))) true))
  (= j1 i1))))))))))))))
...
;; H
  (assert
  (= (mk___rep (mk___split_fields o12 o13)) (select temp___1272 (int__content
                                                                search_trees__find_root__result4))))
