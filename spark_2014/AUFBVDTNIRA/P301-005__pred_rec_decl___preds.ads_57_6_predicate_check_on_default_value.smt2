...
(declare-fun dummy1 () tarr_okD1)

(declare-datatypes ()
((tarr_okD1__ref (mk_tarr_okD1__ref (tarr_okD1__content tarr_okD1)))))
...
(declare-fun i19s () (Array Int integer))
...
(declare-fun preds__rec_ok__i__first__bit () Int)

(declare-fun preds__rec_ok__i__last__bit () Int)

(declare-fun preds__rec_ok__i__position () Int)
...
(declare-fun preds__rec_ok__x__first__bit () Int)

(declare-fun preds__rec_ok__x__last__bit () Int)

(declare-fun preds__rec_ok__x__position () Int)
...
(declare-fun preds__rec_ok__a__first__bit () Int)

(declare-fun preds__rec_ok__a__last__bit () Int)

(declare-fun preds__rec_ok__a__position () Int)
...
(declare-datatypes ()
((rec_ok__ref (mk_rec_ok__ref (rec_ok__content us_rep)))))
...
(declare-fun x__split_fields1 () int_ok)

(declare-fun x__split_fields2 () (Array Int integer))

(declare-fun temp___363 () integer)

(declare-fun temp___3631 () int_ok)

(declare-fun temp___3632 () (Array Int integer))
