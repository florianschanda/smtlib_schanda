...
;; H
  ...
  (= (bool_eq2 (elts a) (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))
     ...
     (rec__static_discr__i_holder__content2
     (us_split_fields7
     (rec__static_discr__holder__content1 current__split_fields6))))
     (to_rep1
     (first6
     (rt3
     (rec__static_discr__i_holder__content2
     ...
     (rec__static_discr__i_holder__content2
     (us_split_fields7
     (rec__static_discr__holder__content1 current__split_fields6))))))) true))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range1
  (+ (to_rep (rec__static_discr__holder__length1 current__split_fields6)) 1))))
(check-sat)
