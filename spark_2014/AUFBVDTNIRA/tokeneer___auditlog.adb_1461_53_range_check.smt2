...
;; H
  (assert (not (not (not (= (to_rep3 usedlogfiles__split_fields3) 0)))))
...
;; H
  (assert (= fileindexinusedlist1 (to_rep4 usedlogfiles__split_fields1)))

;; H
  (assert (< archivedfilecount1 4))

;; H
  (assert (< archivedfilecount1 (to_rep3 usedlogfiles__split_fields3)))
...
;; H
  ...
  (and
  (and
  (and (=> (<= 0 17) (in_range7 archivedfilecount2))
  (=> (<= 1 17) (in_range8 fileindex1)))
  (=> (<= 1 17) (in_range8 fileindexinusedlist2)))
...
;; WP_parameter_def
 ;; File "auditlog.ads", line 33, characters 0-0
  (not (in_range9 (- (to_rep3 usedlogfiles__split_fields3) 1))))
(check-sat)
