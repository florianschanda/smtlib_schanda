...
(declare-fun temp___875 () (Array Int us_rep1))
...
(declare-fun temp___876 () (Array Int us_rep1))
...
;; H
  (assert
  (and
  (= o36 (to_rep1 (rec__search_trees__search_tree__root t__split_fields10)))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root t__split_fields10)))))
...
;; H
  ...
  (= temp___876 (model__
                (rec__search_trees__search_tree__struct t__split_fields10)
                o36))
  (and (dynamic_invariant6 temp___876 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___876 o36))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___876 o36)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o36))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___876 (parent
                             (rec__search_trees__search_tree__struct
                             t__split_fields10) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___876 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___876 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___876 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___876 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___876 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___876 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o37 (select temp___876 y1)))
...
;; H
  ...
  (= temp___875 (model__
                ...
                (let ((subject f_5__split_fields)) f_5__split_fields2)) 
                o32))
  (and (dynamic_invariant6 temp___875 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___875 o32))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___875 o32)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o32))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___875 (parent
                             (mk___rep2
                             (let ((subject f_5__split_fields))
                             f_5__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___875 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___875 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___875 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___875 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___875 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___875 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o33 (select temp___875 i1)))
...
;; H
  ...
  (and (= o40 (olt o35 o39))
  (= (= o40 true)
  (and (< (length o35) (length o39))
  (forall ((n Int))
  (=> (and (<= 1 n) (<= n (last o35))) (= (get o35 n) (get o39 n))))))))
