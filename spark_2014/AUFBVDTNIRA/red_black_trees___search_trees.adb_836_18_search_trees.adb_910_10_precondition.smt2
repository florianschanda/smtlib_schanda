...
(declare-fun temp___1607 () (Array Int us_rep1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1607 (parent
                      (mk___rep2
                      (let ((subject f_5__split_fields)) f_5__split_fields2))
                      i2))))
  (position
  (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1607 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1607 (parent
                      (mk___rep2
...
;; H
  ...
  (rec__search_trees__search_tree__struct t__split_fields10) o36))
  (and (dynamic_invariant6 temp___1608 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1608 o36))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1608 o36)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o36))
...
;; H
  (assert (= o37 (select temp___1608 y1)))
...
;; H
  ...
  (= temp___1607 (model__
                 ...
                 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
                 o32))
  (model____function_guard temp___1607
  (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
  o32))
  (and (dynamic_invariant6 temp___1607 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1607 o32))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1607 o32)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o32))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1607 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1607 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1607 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1607 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1607 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1607 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o33 (select temp___1607 i1)))
