...
;; H
  (assert (state_of__function_guard (state_of (mk___rep ctx__split_fields6))
  (mk___rep ctx__split_fields6)))

;; H
  (assert (in_queue_bit_length__function_guard
  (in_queue_bit_length (mk___rep ctx__split_fields6))
  (mk___rep ctx__split_fields6)))
...
;; H
  (assert (rate_of__function_guard (rate_of (mk___rep ctx__split_fields6))
  (mk___rep ctx__split_fields6)))
...
;; H
  ...
  (= o12 (bvlshr suffix ((_ int2bv 8) (- 8 (mod2 bit_length 8)))))))

;; H
  (assert
  (=> (not (< (- 8 (mod2 bit_length 8)) 8)) (= o12 ((_ int2bv 8) 0))))

;; H
  (assert (= (to_rep o13) o12))

;; H
  (assert (= o14 (store suffix_array2 0 o13)))

;; H
  (assert (= result5 (mk_map__ref suffix_array2)))

;; H
  (assert (= suffix_array3 o14))
