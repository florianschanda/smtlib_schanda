...
(define-fun last8 ((a1 us_t2)) Int (to_rep1 (last7 (rt2 a1))))

(define-fun length2 ((a1 us_t2)) Int (ite (<= (first5 a1) (last8 a1))
                                     (+ (- (last8 a1) (first5 a1)) 1) 0))
...
(define-fun last11 ((a1 us_t3)) Int (to_rep1 (last10 (rt3 a1))))

(define-fun length3 ((a1 us_t3)) Int (ite (<= (first7 a1) (last11 a1))
                                     (+ (- (last11 a1) (first7 a1)) 1) 0))
...
;; H
  ...
  (= (let ((temp___349 (rec__static_discr__i_holder__content1
     ...
     (to_rep1 (last4 (rt1 temp___348))) (elts1 temp___349)
     (to_rep1 (first2 (rt1 temp___349))) (to_rep1 (last4 (rt1 temp___349)))))) true))
  (forall ((i Int))
  (=>
  (and
  (<= (+ (to_rep (rec__static_discr__holder__length current__split_fields6)) 1) i)
...
;; H
  ...
  (= (let ((temp___268 (rec__static_discr__i_holder__content1
     ...
     (bool_eq2 (elts1 temp___267) (to_rep1 (first2 (rt1 temp___267)))
     (to_rep1 (last4 (rt1 temp___267))) (elts1 temp___268)
     (to_rep1 (first2 (rt1 temp___268))) (to_rep1 (last4 (rt1 temp___268)))))) true)
  (and
  ...
  (=>
  (and
  (<= (+ (to_rep (rec__static_discr__holder__length current__split_fields7)) 1) i)
  (<= i (to_rep (rec__static_discr__holder__length current__split_fields6))))
  (not
  (= (to_rep
     (select (elts1
             (rec__static_discr__i_holder__content1
             (us_split_fields3
             (rec__static_discr__holder__content current__split_fields7)))) i)) 
  e))))
  (and
  (and
  (<= (to_rep (rec__static_discr__holder__length current__split_fields7)) 
...
;; H
  ...
  (and (= result__1 0)
  (< 0 (to_rep (rec__static_discr__holder__length current__split_fields5))))
  (= (to_rep (rec__static_discr__holder__c current__split_discrs)) r55b)))
...
;; H
  ...
  (= (let ((temp___341 (rec__static_discr__i_holder__content3
     ...
     (let ((temp___340 (rec__static_discr__i_holder__content2
                       ...
                       (rec__static_discr__holder__content
                       (us_split_fields5 a))))))))
     (bool_eq2 (elts2 temp___340) (to_rep1 (first4 (rt2 temp___340)))
     (to_rep1 (last7 (rt2 temp___340))) (elts3 temp___341)
     (to_rep1 (first6 (rt3 temp___341))) (to_rep1 (last10 (rt3 temp___341)))))) true)))
...
;; H
  (assert (= result7 (int__content static_discr__search__result4)))
