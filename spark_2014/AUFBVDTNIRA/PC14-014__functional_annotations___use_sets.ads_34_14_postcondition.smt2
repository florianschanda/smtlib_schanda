...
(declare-fun temp___926 () count_type)
...
(declare-fun use_sets__are_disjoint__result2 () Bool)

(declare-fun result2 () Bool)

(declare-fun result3 () Bool)

(declare-fun use_sets__are_disjoint__result3 () Bool)
...
(declare-fun use_sets__are_disjoint__result4 () bool__ref)

(declare-fun cu__split_fields5 () us_split_fields2)

(declare-fun use_sets__are_disjoint__result5 () Bool)

(declare-fun cu__split_fields6 () us_split_fields__ref1)

(declare-fun use_sets__are_disjoint__result6 () bool__ref)

(declare-fun cu__split_fields7 () us_split_fields2)

(declare-fun use_sets__are_disjoint__result7 () Bool)

(declare-fun result6 () bool__ref)

(declare-fun use_sets__are_disjoint__result8 () Bool)

(declare-fun use_sets__are_disjoint__result9 () bool__ref)

(declare-fun use_sets__are_disjoint__result10 () Bool)

(declare-fun cu__split_fields8 () us_split_fields__ref1)

(declare-fun use_sets__are_disjoint__result11 () bool__ref)

(declare-fun cu__split_fields9 () us_split_fields2)

(declare-fun use_sets__are_disjoint__result12 () Bool)

(declare-fun cu__split_fields10 () us_split_fields__ref1)

(declare-fun use_sets__are_disjoint__result13 () bool__ref)

(declare-fun cu__split_fields11 () us_split_fields2)

(declare-fun use_sets__are_disjoint__result14 () Bool)
...
;; H
  ...
  (and
  (and
  (= use_sets__are_disjoint__result11 (mk_bool__ref
                                      use_sets__are_disjoint__result3))
  (= cu__split_fields8 (mk___split_fields__ref1 cu__split_fields13)))
  (and (= use_sets__are_disjoint__result12 use_sets__are_disjoint__result3)
  ...
  (and (= result1 true)
  (and (= temp___926 cu__split_fields1)
  (and
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  ...
  (and (= result2 true)
  (and (= result3 use_sets__are_disjoint__result2)
  (= use_sets__are_disjoint__result3 (of_int 0)))))))))))
  (and
  (and
  (and (= result1 (has_key (positions s1) (mk___rep1 cu__split_fields14)))
  (= (= result1 true)
  ...
  (= use_sets__are_disjoint__result3 use_sets__are_disjoint__result2)))
  (and
  (and
  (and (= temp___9251 (next s1 (mk___rep1 cu__split_fields13)))
  ...
  (and (= result4 cu__split_fields2) (= temp___925 cu__split_fields3)))
  (and
  (and
  ...
  (and
  (and
  (= use_sets__are_disjoint__result4 (mk_bool__ref
                                     use_sets__are_disjoint__result3))
  (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields12)))
  (and (= use_sets__are_disjoint__result5 use_sets__are_disjoint__result3)
  (= cu__split_fields5 cu__split_fields12))))
  (and
  (and (= use_sets__are_disjoint__result6 use_sets__are_disjoint__result4)
  (= cu__split_fields6 cu__split_fields4))
  (and (= use_sets__are_disjoint__result7 use_sets__are_disjoint__result5)
  (= cu__split_fields7 cu__split_fields5))))
  (and
  (and
  (= use_sets__are_disjoint__result6 (mk_bool__ref
                                     use_sets__are_disjoint__result))
  (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields14)))
  (and (= use_sets__are_disjoint__result7 use_sets__are_disjoint__result1)
  (= cu__split_fields7 cu__split_fields14)))))
  (and
  (and
  (and (= use_sets__are_disjoint__result11 use_sets__are_disjoint__result9)
  (= cu__split_fields8 cu__split_fields6))
  (and (= use_sets__are_disjoint__result12 use_sets__are_disjoint__result10)
  (= cu__split_fields9 cu__split_fields7)))
  (and
  (and
  (= use_sets__are_disjoint__result9 (mk_bool__ref
                                     use_sets__are_disjoint__result8))
  (= use_sets__are_disjoint__result10 use_sets__are_disjoint__result8))
  (and (= result6 use_sets__are_disjoint__result6)
  (= use_sets__are_disjoint__result8 (of_int 1))))))))

;; H
  (assert
  (= use_sets__are_disjoint__result13 use_sets__are_disjoint__result11))
...
;; H
  (assert
  (= use_sets__are_disjoint__result14 use_sets__are_disjoint__result12))

;; H
  (assert (= cu__split_fields11 cu__split_fields9))

;; H
  (assert (= result7 (bool__content use_sets__are_disjoint__result13)))

;; H
  (assert (= (bool__content use_sets__are_disjoint__result13) true))
