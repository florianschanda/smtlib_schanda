...
;; H
  (assert
  (and
  (and (= o13 (to__ (mk___rep s__split_fields10))) (to____function_guard 
  o13 (mk___rep s__split_fields10))) (dynamic_invariant1 o13 true false
  true)))
...
;; H
  (assert
  (=> (= result4 true) (= temp___484 (mk___t2 o11 (mk2 first2 temp___482)))))
...
;; H
  (assert
  (=> (= result4 true) (= temp___483 (mk___t1 o12 (mk1 first2 temp___481)))))
