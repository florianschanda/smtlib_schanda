...
;; H
  ...
  (is_permutation_1 (select ranking_2 g22)) (select ranking_2 g22))))
...
;; H
  (assert
  (forall ((g1_id1 Int) (rank3 Int)) (is_preferred_1__function_guard
  (is_preferred_1 g1_id1
  (to_rep
  (select result__2 (to_rep1 (select (select ranking_1 g1_id1) rank3))))
  (select ranking_2 (to_rep1 (select (select ranking_1 g1_id1) rank3))))
  g1_id1
  (to_rep
  (select result__2 (to_rep1 (select (select ranking_1 g1_id1) rank3))))
  (select ranking_2 (to_rep1 (select (select ranking_1 g1_id1) rank3))))))
...
;; H
  ...
  (= (to_rep
     (select (rec__stable_marriage__matching__group1_set__elements
             unmatched_g1_set__split_fields4) idx)) g1_id1)))))))
...
;; H
  (assert (< 0 (to_rep3 (select proposals_made1 g1_id))))

(assert
;; WP_parameter_def
 ;; File "stable_marriage.adb", line 194, characters 0-0
  (not (in_range3 (to_rep3 (select proposals_made1 g1_id)))))
(check-sat)
