...
(declare-fun r4 () (Array Int index))

(declare-fun j4 () Int)

(declare-fun r5 () (Array Int index))

(declare-fun j5 () Int)

(declare-fun r6 () (Array Int index))

(declare-fun j6 () Int)

(declare-fun r7 () (Array Int index))
...
(declare-fun r8 () (Array Int index))

(declare-fun j9 () Int)

(declare-fun result4 () (Array Int index))

(declare-fun r9 () (Array Int index))

(declare-fun r10 () map__ref)

(declare-fun j10 () int__ref)

(declare-fun r11 () (Array Int index))

(declare-fun j11 () Int)

(declare-fun r12 () map__ref)

(declare-fun j12 () int__ref)

(declare-fun r13 () (Array Int index))

(declare-fun j13 () Int)

(declare-fun result5 () map__ref)

(declare-fun queen__copy_until__result1 () (Array Int index))

(declare-fun queen__copy_until__result2 () map__ref)

(declare-fun queen__copy_until__result3 () (Array Int index))

(declare-fun r14 () map__ref)

(declare-fun j14 () int__ref)

(declare-fun j15 () int__ref)

(declare-fun queen__copy_until__result4 () map__ref)

(declare-fun r15 () (Array Int index))

(declare-fun j16 () Int)

(declare-fun j17 () Int)

(declare-fun queen__copy_until__result5 () (Array Int index))

(define-fun j18 () int__ref (mk_int__ref j6))

(define-fun r16 () map__ref (mk_map__ref r6))

(declare-fun result6 () (Array Int index))
...
;; H
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k i))
  (= (to_rep (select r8 k)) (to_rep (select b k)))))))
...
;; H
  (assert
  (=> (not (and (<= (+ i 1) j8) (<= j8 8))) (= j12 (mk_int__ref j8))))
...
;; H
  (assert
  (= queen__copy_until__result2 (mk_map__ref queen__copy_until__result1)))
...
;; WP_parameter_def
 ;; File "queen.ads", line 19, characters 0-0
  (not
  (= (to_rep (select (map__content queen__copy_until__result4) j19)) 
  (to_rep (select b j19)))))
(check-sat)
