...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral5) (= (tqtreal fliteral5) 20.0)))
...
;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite z)))

;; H
  (assert
  (and (and (le fliteral2 x) (le x fliteral3))
  (and (le fliteral4 x) (le x fliteral5))))

;; H
  (assert
  (and (= o (mul RNE2 x fliteral6)) (tqtisFinite (mul RNE2 x fliteral6))))

;; H
  (assert (= o1 (sub RNE2 o fliteral4)))

(assert
;; WP_parameter_def
 ;; File "generic_interval_tests.adb", line 153, characters 0-0
  (not (tqtisFinite o1)))
(check-sat)
