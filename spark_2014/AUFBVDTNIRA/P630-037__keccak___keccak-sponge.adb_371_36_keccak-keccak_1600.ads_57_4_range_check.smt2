...
;; H
  (assert
  (and (= o25 (+ offset1 bytes_to_squeeze2)) (in_range1
...
;; H
  (assert (= o27 (+ (to_rep digest__first) o26)))
...
;; H
  (assert (= o28 temp___1034))

;; H
  (assert (= (mk4 r144s r145s) temp___10341))
...
;; H
  (assert (= (mk3 r140s r141s) temp___10351))
...
;; H
  (assert (= temp___1040 (mk___rep o33)))

;; H
  (assert (= result11 (mk___split_fields__ref ctx__split_fields10)))

;; H
  (assert (= ctx__split_fields11 (us_split_fields1 temp___1040)))

;; H
  (assert
  (and (= o34 (+ offset1 bytes_to_squeeze2)) (in_range1
  (+ offset1 bytes_to_squeeze2))))
...
;; H
  (assert
  (and (= o35 (- remaining1 bytes_to_squeeze2)) (in_range1
