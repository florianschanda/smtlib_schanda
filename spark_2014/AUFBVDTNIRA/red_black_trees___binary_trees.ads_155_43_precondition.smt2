...
;; H
  ...
  (and
  (and
  (= o44 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j))
  (parent__function_guard o44
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) j))
  (and (in_range2 o44)
  (and
  (= o44 (to_rep
         ...
         (us_split_fields3
         (select (rec__binary_trees__forest__c
                 (us_split_fields__content2 f__split_fields7)) j)))))
  (and
  (=>
  (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) true)
  (= o44 0))
  (=> (= (size (mk___rep2 (us_split_fields__content2 f__split_fields7))) 0)
  (= o44 0)))))))
...
;; H
  (assert (= o46 (ite (not (= o45 true)) true false)))

;; H
  (assert (= result10 (ite (not (= j (int__content v2))) o46 false)))
...
;; H
  (assert (parent__function_guard
  (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  j) (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) 
  j))
