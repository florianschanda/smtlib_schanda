...
(declare-fun add_field__x__assume () (Array Int integer))

(declare-fun add_field__x__assume1 () t)

(declare-fun result () (Array Int integer))

(declare-fun x1 () (Array Int integer))

(define-fun add_field__x__assume2 () us_t (mk___t add_field__x__assume
                                          add_field__x__assume1))
...
;; H
  ...
  (=>
  (and (<= (to_rep x__first) temp___164) (<= temp___164 (to_rep x__last)))
  (dynamic_property d 2147483647 (to_rep (select x1 temp___164)))))))
