...
(declare-fun dummy () positive_float)
...
(declare-fun dummy3 () nonnegative_float)
...
(declare-fun to_rep3 (nonnegative_float) t)

(declare-fun of_rep3 (t) nonnegative_float)
...
(declare-fun dummy4 () unbounded_float)
...
(declare-fun to_rep4 (unbounded_float) t)

(declare-fun of_rep4 (t) unbounded_float)
...
(define-fun bool_eq6 ((a (Array Int nonnegative_float)) (a__first Int)
...
(declare-fun dummy5 () (Array Int nonnegative_float))
...
;; range_axiom
  (assert
  (forall ((x option)) (! (in_range4 (to_rep5 x)) :pattern ((to_rep5 x)) )))
...
(declare-fun dummy9 () normalized2pi)
...
(declare-fun to_rep6 (normalized2pi) t)

(declare-fun of_rep6 (t) normalized2pi)
...
(define-fun us_rep_13__projection ((a us_rep3)) us_split_discrs2 (us_split_discrs3
                                                                 a))
...
(define-fun list__ref_2__projection ((a list__ref1)) us_rep3 (list__content1
                                                             a))
...
(define-fun us_rep_16__projection ((a us_rep4)) us_split_fields8 (us_split_fields9
                                                                 a))
...
(declare-fun concat2 ((Array Int us_rep4) Int Int (Array Int us_rep4) Int
...
(declare-fun singleton2 (us_rep4 Int) (Array Int us_rep4))
...
(define-fun bool_eq15 ((a (Array Int us_rep4)) (a__first Int) (a__last Int)
...
(declare-fun dummy15 () (Array Int us_rep4))
...
(declare-fun user_eq14 ((Array Int us_rep4) (Array Int us_rep4)) Bool)
...
(declare-fun null_angle () us_rep2)
...
;; length__post_axiom
  ...
  (! (let ((result (length container)))
     ...
     (dynamic_invariant10 result true false true))) :pattern ((length
                                                              container)) )))
...
(declare-fun this__split_fields () us_split_fields__ref5)

(declare-fun this__split_fields1 () us_split_fields10)

(declare-fun this__split_fields2 () us_split_fields10)

(declare-fun this__split_fields3 () us_split_fields__ref5)

(declare-fun this__split_fields4 () us_split_fields10)
...
;; WP_parameter_def
 ;; File "algorithm.adb", line 175, characters 0-0
  ...
  (us_split_fields3
  (rec__algorithm__controller__robot
  (us_split_fields__content5 this__split_fields3)))))
  (to_rep
  (rec__robot_iface__proxy__robot_radius
  (us_split_fields3
  (rec__algorithm__controller__robot
