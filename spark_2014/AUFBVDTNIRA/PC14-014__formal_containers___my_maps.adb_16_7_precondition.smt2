...
;; H
  ...
  (ite (= (ite (= (bool_eq3 (mk___rep1 c__split_fields3) no_element) false) (= 
          ...
          (positions
          (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
          (mk___rep1 c__split_fields3)) (length
                                        (mk___rep l__split_discrs
...
;; WP_parameter_def
 ;; File "my_maps.adb", line 127, characters 0-0
  (not
  (or
  (< (length (mk___rep l__split_discrs l__split_fields2)) (to_rep1
                                                          (rec__my_maps__m__map__capacity
                                                          l__split_discrs)))
  (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields2)) 1) true))))
(check-sat)
