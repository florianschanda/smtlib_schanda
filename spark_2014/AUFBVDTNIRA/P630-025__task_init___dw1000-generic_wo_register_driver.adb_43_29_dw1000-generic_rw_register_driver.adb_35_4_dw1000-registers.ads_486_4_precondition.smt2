...
;; range_axiom
  (assert
  (forall ((x bits_3)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__fs_xtalt_type__xtalt bits_5)(rec__dw1000__register_types__fs_xtalt_type__reserved bits_3)))))
(define-fun us_split_fields_XTALT__projection ((a us_split_fields)) bits_5 
  (rec__dw1000__register_types__fs_xtalt_type__xtalt a))

(define-fun us_split_fields_Reserved17__projection ((a us_split_fields)) bits_3 
  (rec__dw1000__register_types__fs_xtalt_type__reserved a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_66__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_66__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq7 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (to_rep3
                           (rec__dw1000__register_types__fs_xtalt_type__xtalt
                           (us_split_fields1 a))) (to_rep3
                                                  (rec__dw1000__register_types__fs_xtalt_type__xtalt
                                                  (us_split_fields1 b))))
                        (= (to_rep2
                           (rec__dw1000__register_types__fs_xtalt_type__reserved
...
(declare-fun dw1000__register_types__fs_xtalt_type__xtalt__first__bit () Int)

(declare-fun dw1000__register_types__fs_xtalt_type__xtalt__last__bit () Int)

(declare-fun dw1000__register_types__fs_xtalt_type__xtalt__position () Int)

;; dw1000__register_types__fs_xtalt_type__xtalt__first__bit_axiom
  (assert (<= 0 dw1000__register_types__fs_xtalt_type__xtalt__first__bit))

;; dw1000__register_types__fs_xtalt_type__xtalt__last__bit_axiom
  (assert
  (< dw1000__register_types__fs_xtalt_type__xtalt__first__bit dw1000__register_types__fs_xtalt_type__xtalt__last__bit))

;; dw1000__register_types__fs_xtalt_type__xtalt__position_axiom
  (assert (<= 0 dw1000__register_types__fs_xtalt_type__xtalt__position))

(declare-fun dw1000__register_types__fs_xtalt_type__reserved__first__bit () Int)

(declare-fun dw1000__register_types__fs_xtalt_type__reserved__last__bit () Int)

(declare-fun dw1000__register_types__fs_xtalt_type__reserved__position () Int)

;; dw1000__register_types__fs_xtalt_type__reserved__first__bit_axiom
  (assert (<= 0 dw1000__register_types__fs_xtalt_type__reserved__first__bit))

;; dw1000__register_types__fs_xtalt_type__reserved__last__bit_axiom
  (assert
  (< dw1000__register_types__fs_xtalt_type__reserved__first__bit dw1000__register_types__fs_xtalt_type__reserved__last__bit))

;; dw1000__register_types__fs_xtalt_type__reserved__position_axiom
  (assert (<= 0 dw1000__register_types__fs_xtalt_type__reserved__position))

(declare-fun dummy6 () us_rep)

(declare-datatypes ()
((fs_xtalt_type__ref (mk_fs_xtalt_type__ref (fs_xtalt_type__content us_rep)))))
(define-fun fs_xtalt_type__ref___projection ((a fs_xtalt_type__ref)) us_rep 
  (fs_xtalt_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_157__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_111__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_111__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5680 us_t1)
  (temp___is_init_5677 Bool) (temp___skip_constant_5678 Bool)
  (temp___do_toplevel_5679 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5678 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5680)
                                       (last4 temp___expr_5680))
                                       (and (= (first3 temp___expr_5680) 1)
                                       (= (last4 temp___expr_5680) 1)))))
...
(define-fun target__ref_47__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_47__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_5697 us_t2)
  (temp___is_init_5694 Bool) (temp___skip_constant_5695 Bool)
  (temp___do_toplevel_5696 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5695 true))
                                       (and (dynamic_property3 1 1
                                       (first5 temp___expr_5697)
                                       (last6 temp___expr_5697))
                                       (and (= (first5 temp___expr_5697) 1)
                                       (= (last6 temp___expr_5697) 1)))))
...
(declare-fun temp___7905 () (Array Int bits_8))

(declare-fun temp___79051 () t2)

(declare-fun temp___7906 () (Array Int bits_8))

(declare-fun temp___79061 () t1)
...
;; H
  (assert
  (and
  (and (= temp___79052 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___79052 reg)) (dynamic_invariant1
  temp___79052 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___79051)) (to_rep (last5 temp___79051)))
     (+ (- (to_rep (last5 temp___79051)) (to_rep (first4 temp___79051))) 1)
     0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___79051)) (to_rep (last5 temp___79051))) 
  temp___79061))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___79061)) (to_rep (last3 temp___79061)))
     (+ (- (to_rep (last3 temp___79061)) (to_rep (first2 temp___79061))) 1)
