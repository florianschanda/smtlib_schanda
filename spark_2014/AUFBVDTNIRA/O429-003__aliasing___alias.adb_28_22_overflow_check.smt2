...
(define-fun dynamic_invariant4 ((temp___expr_156 us_t1)
  ...
  (temp___do_toplevel_155 Bool)) Bool (=>
                                      ...
                                      (last4 temp___expr_156))
                                      (and (= (first3 temp___expr_156) 1)
                                      (= (last4 temp___expr_156) c)))))

(declare-fun i () (Array Int natural))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt x))) 1) (<= 1 (to_rep1 (last (rt x))))))
...
(assert
;; WP_parameter_def
 ;; File "alias.adb", line 22, characters 0-0
  (not (in_range o6)))
(check-sat)
