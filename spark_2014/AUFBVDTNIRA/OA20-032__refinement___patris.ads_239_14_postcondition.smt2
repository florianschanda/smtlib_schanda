...
(define-fun bool_eq11 ((a (Array Int map1)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq10 (select a temp___idx_143) 0 3 0 3
...
(define-fun bool_eq12 ((a map2) (a__first Int) (a__last Int) (a__first_2 Int)
...
;; bool_eq_rev
  ...
  (= (bool_eq10 (get1 a temp___idx_230 temp___idx_231) 0 2 0 2
...
(declare-fun user_eq11 (action action) Bool)

(declare-fun dummy11 () action)
...
(define-fun dynamic_invariant2 ((temp___expr_2044 Int)
...
;; move__post_axiom
  (assert
  (forall ((p us_rep))
  (forall ((a Int)) (! (move_is_possible__function_guard
  (move_is_possible p a) p a) :pattern ((move p a)) ))))
...
;; move__def_axiom
  ...
  (forall ((a Int))
  (! (=>
     (and (dynamic_invariant2 a true true true) (move__function_guard
     (move p a) p a))
     (and (turn_direction__function_guard
     (turn_direction (to_rep4 (rec__patris__piece__d (us_split_fields1 p)))
     a) (to_rep4 (rec__patris__piece__d (us_split_fields1 p))) a)
     (= (move p a) (ite (= a 0)
                   (mk___rep
...
(declare-fun user_eq14 (y_coord y_coord) Bool)

(declare-fun dummy14 () y_coord)
...
(define-fun in_range12 ((x Int)) Bool (and (<= 3 x) (<= x 4)))
...
(declare-fun user_eq15 (turn_action turn_action) Bool)

(declare-fun dummy15 () turn_action)
...
(define-fun dynamic_invariant11 ((temp___expr_2056 Int)
...
;; turn_direction__post_axiom
  ...
  (forall ((d Int) (t Int))
  (! (=>
     (and (dynamic_invariant10 d true true true) (dynamic_invariant11 t true
     true true))
     (let ((result (turn_direction d t)))
     (=> (turn_direction__function_guard result d t) (dynamic_invariant10
...
(declare-fun candidate__split_fields () shape)

(declare-fun candidate__split_fields1 () direction)

(declare-fun candidate__split_fields2 () px_coord)

(declare-fun candidate__split_fields3 () py_coord)

(declare-fun temp___2168 () shape)

(declare-fun temp___21681 () direction)

(declare-fun temp___21682 () px_coord)

(declare-fun temp___21683 () py_coord)
...
(declare-fun candidate__split_fields4 () shape)

(declare-fun candidate__split_fields5 () direction)

(declare-fun candidate__split_fields6 () px_coord)

(declare-fun candidate__split_fields7 () py_coord)
...
(declare-fun candidate__split_fields8 () shape)

(declare-fun candidate__split_fields9 () direction)

(declare-fun candidate__split_fields10 () px_coord)

(declare-fun candidate__split_fields11 () py_coord)

(declare-fun result5 () Bool)

(declare-fun result6 () shape)

(declare-fun result7 () direction)

(declare-fun result8 () px_coord)

(declare-fun result9 () py_coord)
...
(declare-fun cur_piece__split_fields12 () us_split_fields__ref)

(declare-fun candidate__split_fields12 () us_split_fields__ref)

(declare-fun success5 () Bool)

(declare-fun cur_piece__split_fields13 () us_split_fields)

(declare-fun candidate__split_fields13 () us_split_fields)

(declare-fun success6 () bool__ref)

(declare-fun cur_piece__split_fields14 () us_split_fields__ref)

(declare-fun candidate__split_fields14 () us_split_fields__ref)

(declare-fun success7 () Bool)

(declare-fun cur_piece__split_fields15 () us_split_fields)

(declare-fun candidate__split_fields15 () us_split_fields)

(define-fun cur_piece__split_fields16 () us_split_fields (mk___split_fields
                                                         cur_piece__split_fields8
                                                         cur_piece__split_fields9
                                                         cur_piece__split_fields10
                                                         cur_piece__split_fields11))

(define-fun candidate__split_fields16 () us_split_fields (mk___split_fields
                                                         candidate__split_fields8
                                                         candidate__split_fields9
                                                         candidate__split_fields10
                                                         candidate__split_fields11))

(define-fun result12 () us_split_fields__ref (mk___split_fields__ref
                                             (mk___split_fields result1
                                             result2 result3 result4)))

(define-fun cur_piece__split_fields17 () us_split_fields (mk___split_fields
                                                         cur_piece__split_fields4
                                                         cur_piece__split_fields5
                                                         cur_piece__split_fields6
                                                         cur_piece__split_fields7))

(define-fun temp___21684 () us_rep (mk___rep
                                   (mk___split_fields temp___2168
                                   temp___21681 temp___21682 temp___21683)))

(define-fun candidate__split_fields17 () us_split_fields__ref (mk___split_fields__ref
                                                              (mk___split_fields
                                                              candidate__split_fields
                                                              candidate__split_fields1
                                                              candidate__split_fields2
                                                              candidate__split_fields3)))
...
;; H
  (assert (turn_direction__function_guard
  (turn_direction (to_rep4 cur_piece__split_fields1) a)
  (to_rep4 cur_piece__split_fields1) a))

;; H
  (assert (is_empty__function_guard
  (is_empty cur_board (to_rep3 candidate__split_fields11)
  (to_rep2 candidate__split_fields10)) cur_board
  (to_rep3 candidate__split_fields11) (to_rep2 candidate__split_fields10)))

;; H
  (assert (is_empty__function_guard
  (is_empty cur_board (to_rep3 candidate__split_fields11)
  (+ (to_rep2 candidate__split_fields10) 1)) cur_board
  (to_rep3 candidate__split_fields11)
  (+ (to_rep2 candidate__split_fields10) 1)))

;; H
  (assert (is_empty__function_guard
  (is_empty cur_board (+ (to_rep3 candidate__split_fields11) 1)
  (to_rep2 candidate__split_fields10)) cur_board
  (+ (to_rep3 candidate__split_fields11) 1)
  (to_rep2 candidate__split_fields10)))
...
;; H
  (assert
  (forall ((y Int) (x Int)) (is_empty__function_guard
  (is_empty cur_board (+ (to_rep3 candidate__split_fields11) y)
  (+ (to_rep2 candidate__split_fields10) x)) cur_board
  (+ (to_rep3 candidate__split_fields11) y)
  (+ (to_rep2 candidate__split_fields10) x))))
...
;; H
  ...
  (and
  (and
  (= candidate__split_fields12 (mk___split_fields__ref
                               candidate__split_fields16))
  (and
  (= cur_piece__split_fields12 (mk___split_fields__ref
                               cur_piece__split_fields16))
  (= success4 (mk_bool__ref success2))))
  (and (= candidate__split_fields13 candidate__split_fields16)
  (and (= cur_piece__split_fields13 cur_piece__split_fields16)
  (= success5 success2))))
  (and
  (and
  (and
  ...
  (move_is_possible__function_guard result
  (mk___rep
  (mk___split_fields cur_piece__split_fields cur_piece__split_fields1
  cur_piece__split_fields2 cur_piece__split_fields3)) a))
  (= (= result true)
  (ite (= a 0) (in_range4 (- (to_rep2 cur_piece__split_fields2) 1))
  (ite (= a 1) (in_range4 (+ (to_rep2 cur_piece__split_fields2) 1))
  (=> (= a 2) (in_range5 (+ (to_rep3 cur_piece__split_fields3) 1)))))))
  (and (= result true)
  (and
  (and
  (and
  ...
  (= temp___21684 (move
                  ...
                  cur_piece__split_fields1 cur_piece__split_fields2
                  cur_piece__split_fields3)) a))
  (move__function_guard temp___21684
  (mk___rep
  (mk___split_fields cur_piece__split_fields cur_piece__split_fields1
  cur_piece__split_fields2 cur_piece__split_fields3)) a))
  (= temp___21684 (ite (= a 0)
                  (mk___rep
                  (mk___split_fields cur_piece__split_fields
                  cur_piece__split_fields1
                  (of_rep2 (- (to_rep2 cur_piece__split_fields2) 1))
                  ...
                  (mk___split_fields cur_piece__split_fields
                  cur_piece__split_fields1 cur_piece__split_fields2
                  (of_rep3 (+ (to_rep3 cur_piece__split_fields3) 1))))
                  (mk___rep
                  (mk___split_fields cur_piece__split_fields
                  (of_rep4
                  (turn_direction (to_rep4 cur_piece__split_fields1) a))
                  cur_piece__split_fields2 cur_piece__split_fields3)))))))
  (and (= result12 candidate__split_fields17)
  (and (= temp___2168 candidate__split_fields8)
  (and (= temp___21681 candidate__split_fields9)
  (and (= temp___21682 candidate__split_fields10)
  (= temp___21683 candidate__split_fields11))))))
  (and
  (and
  (and
  (= result5 (no_overlap cur_board (mk___rep candidate__split_fields16)))
  (no_overlap__function_guard result5 cur_board
  (mk___rep candidate__split_fields16)))
  (= (= result5 true)
  (ite (= (to_rep1 candidate__split_fields8) 2)
  (and
  (and
  (and
  (= (is_empty cur_board (to_rep3 candidate__split_fields11)
     (to_rep2 candidate__split_fields10)) true)
  (= (is_empty cur_board (to_rep3 candidate__split_fields11)
     (+ (to_rep2 candidate__split_fields10) 1)) true))
  (= (is_empty cur_board (+ (to_rep3 candidate__split_fields11) 1)
     (to_rep2 candidate__split_fields10)) true))
  (= (is_empty cur_board (+ (to_rep3 candidate__split_fields11) 1)
     (+ (to_rep2 candidate__split_fields10) 1)) true))
  (ite (= (to_rep1 candidate__split_fields8) 1)
  (forall ((y Int))
  (=> (and (<= 0 y) (<= y 3))
  (forall ((x Int))
  (=> (and (<= 0 x) (<= x 3))
  (=>
  (= (get (select possible_i_shapes (to_rep4 candidate__split_fields9)) y x) true)
  (= (is_empty cur_board (+ (to_rep3 candidate__split_fields11) y)
     (+ (to_rep2 candidate__split_fields10) x)) true))))))
  (forall ((y Int))
  (=> (and (<= 0 y) (<= y 2))
  (forall ((x Int))
  (=> (and (<= 0 x) (<= x 2))
  (=>
  (= (get
     (get1 possible_three_shapes (to_rep1 candidate__split_fields8)
     (to_rep4 candidate__split_fields9)) y x) true)
  (= (is_empty cur_board (+ (to_rep3 candidate__split_fields11) y)
     (+ (to_rep2 candidate__split_fields10) x)) true))))))))))
  (and (= result5 true)
  (and
  (and
  (and (= result6 cur_piece__split_fields)
  (and (= result7 cur_piece__split_fields1)
  (and (= result8 cur_piece__split_fields2)
  (= result9 cur_piece__split_fields3))))
  (= cur_piece__split_fields16 candidate__split_fields16))
  (and (= result10 (mk_bool__ref success)) (= success2 (of_int 1))))))))))
  (and
  (and
  (and
  (and
  ...
  (= success2 success))
  (and (= cur_piece__split_fields16 cur_piece__split_fields17)
  (= success2 success1))))))
  (and
  (and
  (and (= candidate__split_fields candidate__split_fields8)
  (and (= candidate__split_fields1 candidate__split_fields9)
  (and (= candidate__split_fields2 candidate__split_fields10)
  (= candidate__split_fields3 candidate__split_fields11))))
  (and
  (and (= cur_piece__split_fields cur_piece__split_fields8)
  (and (= cur_piece__split_fields1 cur_piece__split_fields9)
  (and (= cur_piece__split_fields2 cur_piece__split_fields10)
  ...
  (= success2 success)))
  (and
  (and (= candidate__split_fields4 candidate__split_fields8)
  (and (= candidate__split_fields5 candidate__split_fields9)
  (and (= candidate__split_fields6 candidate__split_fields10)
  (= candidate__split_fields7 candidate__split_fields11))))
  (and (= cur_piece__split_fields16 cur_piece__split_fields17)
  (= success2 success1))))))
  (and
  (and
  ...
  (= cur_piece__split_fields12 (mk___split_fields__ref
                               cur_piece__split_fields16))
  (= success4 (mk_bool__ref success3))))
  (and (= candidate__split_fields13 candidate__split_fields16)
  (and (= cur_piece__split_fields13 cur_piece__split_fields16)
  (= success5 success3))))
  (and (= result11 (mk_bool__ref success2)) (= success3 (of_int 0)))))))

;; H
  (assert (= candidate__split_fields14 candidate__split_fields12))

;; H
  (assert (= cur_piece__split_fields14 cur_piece__split_fields12))
...
;; H
  (assert (= cur_piece__split_fields15 cur_piece__split_fields13))
...
;; H
  (assert (valid_configuration__2__function_guard
  (valid_configuration__2 cur_state
  (us_split_fields__content cur_piece__split_fields14) cur_board
  (mk___split_fields next_piece__split_fields next_piece__split_fields1
  next_piece__split_fields2 next_piece__split_fields3) speed_up
  action_request_nbr) cur_state
  (us_split_fields__content cur_piece__split_fields14) cur_board
