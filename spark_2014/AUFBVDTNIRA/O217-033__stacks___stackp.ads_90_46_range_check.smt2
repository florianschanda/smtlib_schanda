...
(declare-fun temp___663 () (Array Int element))

(declare-fun temp___6631 () t3)

(declare-fun o1 () (Array Int element))

(declare-fun temp___662 () (Array Int element))

(declare-fun temp___6621 () t2)
...
(declare-fun temp___664 () (Array Int element))

(declare-fun temp___6641 () t)
...
;; H
  (assert
  (and
  (and (= stackp__get_model__3__R84s (last4 s)) (last__function_guard
  stackp__get_model__3__R84s s))
...
;; H
  (assert
  (=> (<= 1 stackp__get_model__3__R84s)
  (and (and (<= 1 1) (<= 1 100))
  (and (<= 1 stackp__get_model__3__R84s) (<= stackp__get_model__3__R84s 100)))))
...
;; H
  (assert (= (mk3 1 stackp__get_model__3__R84s) temp___6631))
...
;; H
  (assert (= o1 (rec__stackp__stack_root__content1 (us_split_fields3 s))))

;; H
  (assert (= o1 temp___662))

;; H
  (assert
  (= (mk2 (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) 100) 
  temp___6621))

;; H
  (assert
  (=> (= (length2 (mk___t2 temp___662 temp___6621)) 0)
  (= temp___663 temp___664)))

;; H
  (assert
  (=> (= (length2 (mk___t2 temp___662 temp___6621)) 0)
  (= (mk (to_rep1 (first7 temp___6631)) (to_rep1 (last9 temp___6631))) 
  temp___6641)))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___662 temp___6621)) 0))
  (=> (<= (to_rep1 (first7 temp___6631)) (to_rep1 (last9 temp___6631)))
  (= o2 (+ (- (to_rep1 (last9 temp___6631)) (to_rep1 (first7 temp___6631))) 1)))))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___662 temp___6621)) 0))
  (=> (not (<= (to_rep1 (first7 temp___6631)) (to_rep1 (last9 temp___6631))))
  (= o2 0))))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___662 temp___6621)) 0))
  (=> (<= (to_rep1 (first5 temp___6621)) (to_rep1 (last6 temp___6621)))
  (= o3 (+ (- (to_rep1 (last6 temp___6621)) (to_rep1 (first5 temp___6621))) 1)))))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___662 temp___6621)) 0))
  (=> (not (<= (to_rep1 (first5 temp___6621)) (to_rep1 (last6 temp___6621))))
  (= o3 0))))
...
;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___662 temp___6621)) 0)) (= o5 (+ 1 o4))))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___662 temp___6621)) 0)) (= o6 (- o5 1))))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___662 temp___6621)) 0))
  (and (= o7 o6) (in_range1 o6))))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___662 temp___6621)) 0))
  (= (slide
     (concat1 temp___662 (to_rep1 (first5 temp___6621))
     (to_rep1 (last6 temp___6621)) temp___663 (to_rep1 (first7 temp___6631))
     (to_rep1 (last9 temp___6631))) (to_rep1 (first5 temp___6621)) 1) 
  temp___664)))
...
;; WP_parameter_def
 ;; File "stackp.ads", line 9, characters 0-0
  (not (dynamic_property1 1 2147483647 (to_rep1 (first temp___6641))
  (to_rep1 (last temp___6641)))))
(check-sat)
