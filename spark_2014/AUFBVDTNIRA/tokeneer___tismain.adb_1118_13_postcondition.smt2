...
;; H
  (assert (enrolmentisinprogress__function_guard
  (enrolmentisinprogress (us_private__content state48))
  (us_private__content state48)))

;; H
  (assert
  (not (= (enrolmentisinprogress (us_private__content state48)) true)))

;; H
  (assert (privatekeypresent__function_guard
  (privatekeypresent (us_private__content state39))
  (us_private__content state39)))

(assert
;; WP_parameter_def
 ;; File "tismain.adb", line 670, characters 0-0
  (not (= (privatekeypresent (us_private__content state39)) true)))
(check-sat)
