...
(declare-fun temp___3415 () (Array Int us_rep1))
...
(declare-fun temp___3414 () (Array Int us_rep1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3415 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i1))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3415 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3415 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (model____function_guard temp___3415
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o))
  (and (dynamic_invariant8 temp___3415 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3415 o))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3415 o)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3415 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3415 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3415 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3415 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3415 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3415 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o1 (select temp___3415 ki1)))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3414 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i1))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3414 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3414 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= temp___3414 (model__
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7 t)) o3))
  (model____function_guard temp___3414
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o3))
  (and (dynamic_invariant8 temp___3414 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3414 o3))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3414 o3)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o3))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___3414 (parent
                              ...
                              (us_split_fields7 t)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3414 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3414 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3414 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3414 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3414 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3414 j)))) true))
  (= j i1))))))))))))))
