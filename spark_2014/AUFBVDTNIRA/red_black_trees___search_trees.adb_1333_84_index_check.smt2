...
(declare-fun temp___1909 () (Array Int us_rep1))
...
(declare-fun temp___1908 () (Array Int us_rep1))
...
;; H
  ...
  (and (dynamic_invariant8 temp___1909 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1909 o))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1909 o)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1909 (parent
                              (rec__search_trees__search_tree__struct
                              (us_split_fields7 t)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1909 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1909 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1909 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1909 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1909 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1909 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o1 (select temp___1909 ki1)))
...
;; H
  ...
  (and (dynamic_invariant8 temp___1908 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1908 o3))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1908 o3)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o3))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1908 (parent
                              (rec__search_trees__search_tree__struct
                              (us_split_fields7 t)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1908 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1908 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1908 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1908 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1908 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1908 j)))) true))
  (= j i1))))))))))))))
