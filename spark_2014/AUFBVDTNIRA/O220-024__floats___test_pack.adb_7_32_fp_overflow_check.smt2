...
;; H
  (assert
  (ite (lt fliteral2 measured) (le (add RNE2 (neg fliteral1) measured)
  (to_rep pid__split_fields)) (le (to_rep pid__split_fields)
  (add RNE2 fliteral1 measured))))

(assert
;; WP_parameter_def
 ;; File "test_pack.ads", line 9, characters 0-0
  (not (tqtisFinite (sub RNE2 (to_rep pid__split_fields) measured))))
(check-sat)
