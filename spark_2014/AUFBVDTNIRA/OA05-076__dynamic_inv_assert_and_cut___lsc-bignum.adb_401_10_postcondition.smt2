...
;; H
  ...
  (= o4 (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___1770)))))

;; H
  (assert (=> (not (< temp___1770 4294967296)) (= o4 ((_ int2bv 32) 0))))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt a))) temp___1769)
  (<= temp___1769 (to_rep1 (last (rt a))))))

;; H
  (assert (= o2 temp___1769))
...
;; WP_parameter_def
 ;; File "lsc-bignum.adb", line 391, characters 0-0
  ...
  (let ((temp___1773 (bv2nat (bvurem i ((_ int2bv 64) 32)))))
  (ite (< temp___1773 4294967296)
  (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___1773)) ((_ int2bv 32) 0)))) ((_ int2bv 32) 0)))))
(check-sat)
