...
;; H
  ...
  (model_is_well_formed o25 data first_available) o25 data first_available))

;; H
  (assert
  (and
  (and (= o25 (model__ data first_available)) (model____function_guard 
  o25 data first_available))
...
;; H
  (assert (model_is_well_formed__function_guard
  (model_is_well_formed o24 data1 first_available1) o24 data1
  first_available1))

;; H
  (assert
  (and
  (and (= o24 (model__ data1 first_available1)) (model____function_guard 
  o24 data1 first_available1))
...
;; H
  (assert (and (= temp___388 (get c98b i2)) (in_range6 temp___388)))
