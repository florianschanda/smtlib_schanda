...
(define-fun dynamic_invariant2 ((temp___expr_531 Int)
...
(define-fun dynamic_invariant3 ((temp___expr_542 us_rep)
...
;; H
  (assert (dynamic_invariant3 a true false true))

;; H
  (assert (in_range3 v))

;; H
  (assert (in_range2 low))
...
(assert
;; WP_parameter_def
 ;; File "simple_unc_arrays.ads", line 107, characters 0-0
  (not
  (<= (to_rep2
