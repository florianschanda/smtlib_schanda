...
;; H
  (assert
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields8)) 1) true)
  (ite (= (contains
          (model__
  ...
  (= (get (elements (mk___rep s__split_discrs s__split_fields8))
     (find (elements (mk___rep s__split_discrs s__split_fields8)) 1)) 1))
  (= (equal_except
     (elements
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (elements (mk___rep s__split_discrs s__split_fields8))
     (find (elements (mk___rep s__split_discrs s__split_fields8)) 1)) true))
  (and
  (and
  (and
  (and
  ...
  (= (range_equal
     ...
     (- (find (elements (mk___rep s__split_discrs s__split_fields8)) 1) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (elements (mk___rep s__split_discrs s__split_fields8))
     (find (elements (mk___rep s__split_discrs s__split_fields8)) 1)
     (length (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     1) true))
  (= (p_positions_shifted
     (positions
...
;; H
  (assert
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields7)) 2) true)
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields8)) 2) true)
  (and
  (and
  (and
  ...
  (= (get (elements (mk___rep s__split_discrs s__split_fields7))
     (find (elements (mk___rep s__split_discrs s__split_fields7)) 2)) 2))
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields8))
     (elements (mk___rep s__split_discrs s__split_fields7))
     (find (elements (mk___rep s__split_discrs s__split_fields7)) 2)) true))
  (and
  (and
  (and
  (and
  ...
  (= (included_except (model__ (mk___rep s__split_discrs s__split_fields7))
     (model__ (mk___rep s__split_discrs s__split_fields8)) 2) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields7))
     (find (elements (mk___rep s__split_discrs s__split_fields7)) 2)) 2))
  (= (range_equal (elements (mk___rep s__split_discrs s__split_fields8))
     (elements (mk___rep s__split_discrs s__split_fields7)) 1
     (- (find (elements (mk___rep s__split_discrs s__split_fields7)) 2) 1)) true))
  (= (range_shifted (elements (mk___rep s__split_discrs s__split_fields8))
     (elements (mk___rep s__split_discrs s__split_fields7))
     (find (elements (mk___rep s__split_discrs s__split_fields7)) 2)
     (length (mk___rep s__split_discrs s__split_fields8)) 1) true))
  (= (p_positions_shifted
     (positions (mk___rep s__split_discrs s__split_fields8))
...
;; H
  (assert
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields6)) 3) true)
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields7)) 3) true)
  (and
  (and
  (and
  ...
  (= (get (elements (mk___rep s__split_discrs s__split_fields6))
     (find (elements (mk___rep s__split_discrs s__split_fields6)) 3)) 3))
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields7))
     (elements (mk___rep s__split_discrs s__split_fields6))
     (find (elements (mk___rep s__split_discrs s__split_fields6)) 3)) true))
  (and
  (and
  (and
  (and
  ...
  (= (included_except (model__ (mk___rep s__split_discrs s__split_fields6))
     (model__ (mk___rep s__split_discrs s__split_fields7)) 3) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields6))
     (find (elements (mk___rep s__split_discrs s__split_fields6)) 3)) 3))
  (= (range_equal (elements (mk___rep s__split_discrs s__split_fields7))
     (elements (mk___rep s__split_discrs s__split_fields6)) 1
     (- (find (elements (mk___rep s__split_discrs s__split_fields6)) 3) 1)) true))
  (= (range_shifted (elements (mk___rep s__split_discrs s__split_fields7))
     (elements (mk___rep s__split_discrs s__split_fields6))
     (find (elements (mk___rep s__split_discrs s__split_fields6)) 3)
     (length (mk___rep s__split_discrs s__split_fields7)) 1) true))
  (= (p_positions_shifted
     (positions (mk___rep s__split_discrs s__split_fields7))
...
;; H
  (assert
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields5)) 4) true)
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields6)) 4) true)
  (and
  (and
  (and
  ...
  (= (get (elements (mk___rep s__split_discrs s__split_fields5))
     (find (elements (mk___rep s__split_discrs s__split_fields5)) 4)) 4))
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields6))
     (elements (mk___rep s__split_discrs s__split_fields5))
     (find (elements (mk___rep s__split_discrs s__split_fields5)) 4)) true))
  (and
  (and
  (and
  (and
...
;; WP_parameter_def
 ;; File "a-cofuve.ads", line 75, characters 0-0
  (not
  (or
  (< (length (mk___rep s__split_discrs s__split_fields5)) (to_rep
                                                          (rec__use_ordered_sets__my_sets__set__capacity
                                                          s__split_discrs)))
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields5)) 5) true))))
(check-sat)
