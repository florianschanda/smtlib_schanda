...
;; H
  (assert (is_perm__function_guard (is_perm o27 o28) o27 o28))
...
;; H
  (assert (is_perm__function_guard (is_perm o24 o25) o24 o25))
...
;; H
  (assert
  (=> (< ib ib2)
  (and (and (= o27 (remove bb o9)) (remove__function_guard o27 bb o9))
...
;; H
  (assert
  (=> (< ib ib2)
  (and (and (= o28 (remove aa ia21)) (remove__function_guard o28 aa ia21))
...
;; H
  (assert
  (=> (< ib ib2)
  (and (and (= o29 (remove bb2 ib)) (remove__function_guard o29 bb2 ib))
...
;; H
  ...
  (=> (< ib ib2)
  (and
  (and (= o12 (shift_perm_l o29 o28 o27)) (shift_perm_l__function_guard 
  o12 o29 o28 o27))
...
;; H
  (assert
  (=> (not (< ib ib2))
  (and (and (= o24 (remove bb ib2)) (remove__function_guard o24 bb ib2))
...
;; H
  (assert
  (=> (not (< ib ib2))
  (and (and (= o25 (remove aa ia22)) (remove__function_guard o25 aa ia22))
...
;; H
  (assert
  (=> (not (< ib ib2))
  (and (and (= o26 (remove bb2 o16)) (remove__function_guard o26 bb2 o16))
...
;; H
  ...
  (=> (not (< ib ib2))
  (and
  (and (= o23 (shift_perm_l o26 o25 o24)) (shift_perm_l__function_guard 
  o23 o26 o25 o24))
