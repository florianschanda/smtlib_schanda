...
(declare-fun log__2 (t t) t)

(declare-fun log__2__function_guard (t t t) Bool)
...
;; log__2__post_axiom
  ...
  (! (=>
     ...
     true true))
     (and (and (lt fliteral2 x) (lt fliteral2 base)) (neq base fliteral)))
     (let ((result (log__2 x base)))
     (and (=> (eq x fliteral) (eq result fliteral2)) (dynamic_invariant
     result true false true)))) :pattern ((log__2 x base)) )))
