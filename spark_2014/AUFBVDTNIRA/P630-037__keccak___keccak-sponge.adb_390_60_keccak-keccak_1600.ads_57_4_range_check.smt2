...
;; H
  (assert
  (and (= o50 (rate_of (mk___rep ctx__split_fields15)))
  (and (in_range3 o50)
  (and
  (= o50 (* (to_rep4
            (rec__keccak__keccak_1600__sponge__context__rate
...
;; H
  (assert (= o51 (ite (= o50 initial_rate1) true false)))

;; H
  (assert
  (and (= o48 (state_of (mk___rep ctx__split_fields15)))
  (and (in_range5 o48)
  (= o48 (to_rep5
         (rec__keccak__keccak_1600__sponge__context__curr_state
         ctx__split_fields15))))))
...
;; H
  (assert (= o49 (ite (= o48 1) true false)))
