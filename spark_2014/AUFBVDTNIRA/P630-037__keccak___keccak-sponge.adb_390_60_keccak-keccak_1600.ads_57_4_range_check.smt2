...
;; H
  (assert
  (and
  (and (= o49 (rate_of (mk___rep ctx__split_fields15)))
  (rate_of__function_guard o49 (mk___rep ctx__split_fields15)))
  (and (in_range3 o49)
  (and
  (= o49 (* (to_rep4
            (rec__keccak__keccak_1600__sponge__context__rate
...
;; H
  (assert (= o50 (ite (= o49 initial_rate1) true false)))

;; H
  (assert
  (and
  (and (= o47 (state_of (mk___rep ctx__split_fields15)))
  (state_of__function_guard o47 (mk___rep ctx__split_fields15)))
  (and (in_range7 o47)
  (= o47 (to_rep5
         (rec__keccak__keccak_1600__sponge__context__curr_state
         ctx__split_fields15))))))
...
;; H
  (assert (= o48 (ite (= o47 1) true false)))
