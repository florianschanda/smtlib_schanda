...
;; H
  (assert (= o4 (select temp___1987 i)))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root))
  (and (dynamic_invariant3 temp___1988 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1988 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1988 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1988 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (=> (= result2 true) (= o (select temp___1988 i))))
