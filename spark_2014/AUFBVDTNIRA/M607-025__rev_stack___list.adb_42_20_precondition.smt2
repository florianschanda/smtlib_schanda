...
;; H
  (assert
  (=> (= result6 true) (and (= o15 (- last6 i9)) (in_range1 (- last6 i9)))))
...
;; H
  ...
  (=> (= result6 true)
  (and
  (and (= o14 (to__ (mk___rep s__split_fields9))) (to____function_guard 
  o14 (mk___rep s__split_fields9)))
...
;; H
  (assert
  (=> (= result5 true) (and (= o10 (- last6 i9)) (in_range1 (- last6 i9)))))
...
;; H
  (assert (and (= o5 (- last6 j)) (in_range1 (- last6 j))))
