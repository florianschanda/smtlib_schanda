...
;; H
  (assert (= temp___1204 (mk___rep2 o35)))

;; H
  (assert (= result3 (mk___split_fields__ref2 f__split_fields2)))

;; H
  (assert (= f__split_fields4 (us_split_fields5 temp___1204)))
