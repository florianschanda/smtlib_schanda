...
;; H
  (assert
  (and (= o17 (num_of_big_int m m_first o16)) (num_of_big_int__function_guard
  o17 m m_first o16)))
...
;; H
  (assert
  (and (and (= o12 (base Tuple0)) (base__function_guard o12 Tuple0))
  (= o12 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o14 (oexpon o12 o13)) (oexpon__function_guard o14 o12 o13)))

;; H
  (assert (and (= o7 (* 2 n)) (in_range1 (* 2 n))))
...
;; H
  (assert
  (and (= o6 (num_of_big_int x x_first o5)) (num_of_big_int__function_guard
  o6 x x_first o5)))

;; H
  (assert (and (= o11 (oexpon o6 o10)) (oexpon__function_guard o11 o6 o10)))

;; H
  (assert
  (and (= o15 (omultiply o11 o14)) (omultiply__function_guard o15 o11 o14)))

;; H
  (assert (and (= o18 (omod o15 o17)) (omod__function_guard o18 o15 o17)))
