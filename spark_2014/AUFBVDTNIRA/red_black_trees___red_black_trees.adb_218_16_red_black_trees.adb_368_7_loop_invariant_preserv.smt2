...
;; H
  ...
  (rec__search_trees__search_tree__struct
  (us_split_fields7
  (rec__red_black_trees__rbt__struct (us_split_fields9 c66b)))))
  (rec__search_trees__search_tree__struct
  (us_split_fields7
  (rec__red_black_trees__rbt__struct (us_split_fields9 c66b))))))
...
;; H
  ...
  (and
  (and
  (= o4 (size (rec__red_black_trees__rbt__struct (us_split_fields9 c66b))))
  (size__function_guard o4
  (rec__red_black_trees__rbt__struct (us_split_fields9 c66b))))
  (and (in_range3 o4)
  (= o4 (size1
        (rec__search_trees__search_tree__struct
...
;; H
  (assert (model____function_guard
  (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c66b)))
  (rec__red_black_trees__rbt__struct (us_split_fields9 c66b))))

;; H
  (assert (nb_blacks__function_guard (nb_blacks c66b) c66b))

;; H
  (assert (root__function_guard
  (root (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)))
  (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))))

;; H
  (assert (nb_blacks__function_guard (nb_blacks c67b) c67b))
...
;; H
  ...
  (eq (select (nb_blacks c67b) i) (select (nb_blacks c66b) i))
  (select (nb_blacks c67b) i) (select (nb_blacks c66b) i))))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
             (rec__red_black_trees__rbt__struct (us_split_fields9 c66b))) i))) true)
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c66b) i)))) n6))
  (not
  (= i (root (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))))))
  (= (eq (select (nb_blacks c67b) i) (select (nb_blacks c66b) i)) true)))))
...
;; H
  (assert (= result5 (mk_int__ref n6)))

;; H
  (assert (= n7 (+ n6 1)))

;; H
  (assert (= n8 (mk_int__ref n7)))
...
;; H
  ...
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c66b) i)))) (int__content n8)))
