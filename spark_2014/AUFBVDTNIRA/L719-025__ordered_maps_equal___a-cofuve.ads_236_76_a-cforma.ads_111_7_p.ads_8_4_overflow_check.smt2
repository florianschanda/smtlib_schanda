...
(define-fun dynamic_invariant1 ((temp___expr_370 Int)
...
(define-fun default_initial_assumption ((temp___expr_377 us_rep)
  (temp___skip_top_level_378 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_378 true))
                                         (= (length temp___expr_377) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_364 Int)
