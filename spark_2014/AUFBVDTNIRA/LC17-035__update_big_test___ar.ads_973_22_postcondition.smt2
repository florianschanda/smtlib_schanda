...
;; inversion_axiom
  (assert
  (forall ((x et4)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)) )))

;; range_axiom
  (assert
  (forall ((x et4)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
(define-fun bool_eq7 ((a us_rep2)
  (b us_rep2)) Bool (ite (and
                         ...
                         (to_rep1 (rec__ar__rec3t__g3 (us_split_fields5 b)))))
                    true false))
...
(declare-fun temp___7003 () us_rep2)
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 966, characters 0-0
  (not
  (= (bool_eq6
     (rec__ar__rec3t__f3 (us_split_fields__content2 r__split_fields7))
     (mk___rep1
