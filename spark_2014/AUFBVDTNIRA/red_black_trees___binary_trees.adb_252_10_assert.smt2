...
;; H
  ...
  (and
  (forall ((i8 Int))
  (=> (and (<= 1 i8) (<= i8 100)) (= (contains o i8) true)))
  (= (length1 o) 100))))
...
;; H
  (assert
  (=> (not (= i1 0)) (=> (not (= j3 0)) (= temp___599 (to_rep o28)))))
...
;; H
  (assert
  (=> (not (= i1 0)) (=> (not (= j3 0)) (= o31 (us_split_fields1 o30)))))
...
;; H
  (assert
  (=> (not (= i1 0)) (=> (not (= j3 0)) (= temp___601 (mk___rep o34)))))
...
;; H
  (assert
  (=> (not (= i1 0)) (=> (not (= j4 0)) (= o50 (us_split_fields3 o49)))))
...
;; H
  (assert
  (=> (not (= i1 0)) (=> (not (= j4 0)) (= temp___606 (to_rep o51)))))
...
;; H
  (assert
  (=> (not (= i1 0)) (=> (not (= j4 0)) (= o54 (us_split_fields1 o53)))))
...
;; H
  (assert
  (=> (not (= i1 0)) (=> (not (= j4 0)) (= temp___608 (mk___rep o57)))))
