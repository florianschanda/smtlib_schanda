...
(declare-fun temp___2060 () (Array Int us_rep1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2060 (parent
                      (mk___rep2
                      (let ((subject f_5__split_fields)) f_5__split_fields2))
                      i2))))
  (position
  (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2060 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2060 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___2060 (model__
                 ...
                 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
                 o45))
  (model____function_guard temp___2060
  (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
  o45))
  (and (dynamic_invariant6 temp___2060 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2060 o45))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2060 o45)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o45))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2060 (parent
                              ...
                              f_5__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2060 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2060 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2060 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2060 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2060 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2060 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o46 (select temp___2060 i1)))
