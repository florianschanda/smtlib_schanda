...
;; H
  ...
  (and (le fliteral2
  (to_rep
  (select battery_level_at1 (let ((temp___284 (bvsub current_time1 counter1)))
                            (ite (bvult current_time1 counter1)
                            (bvadd temp___284 ((_ int2bv 8) 50)) temp___284)))))
  (ite (bvuge current_time1 (bvsub counter1 ((_ int2bv 8) 1)))
  (forall ((s (_ BitVec 8)))
  (=>
  (and
  (bvule (let ((temp___285 (bvsub current_time1 (bvsub counter1 ((_ int2bv 8) 1)))))
         (ite (bvult current_time1 (bvsub counter1 ((_ int2bv 8) 1)))
         (bvadd temp___285 ((_ int2bv 8) 50)) temp___285)) s)
  ...
  (=>
  (and
  (bvule (let ((temp___286 (bvsub current_time1 (bvsub counter1 ((_ int2bv 8) 1)))))
         (ite (bvult current_time1 (bvsub counter1 ((_ int2bv 8) 1)))
