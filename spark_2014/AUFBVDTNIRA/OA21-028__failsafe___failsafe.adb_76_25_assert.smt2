...
(declare-fun o2 () (Array (_ BitVec 8) battery_level_type))
...
(declare-fun result1 () (Array (_ BitVec 8) battery_level_type))
...
;; H
  (assert (tqtisFinite battery_level))
...
;; H
  ...
  (=>
  (forall ((s (_ BitVec 8)))
  (=> (and (bvule ((_ int2bv 8) 0) s) (bvule s ((_ int2bv 8) 49))) (lt
  (to_rep (select battery_level_at s)) fliteral2)))
...
;; H
  ...
  (lt (to_rep (select battery_level_at s)) fliteral2))))
...
;; H
  (assert (lt battery_level fliteral2))
...
;; H
  (assert
  (=> (le fliteral2 (to_rep (select battery_level_at1 current_time1)))
  (= counter1 ((_ int2bv 8) 0))))

;; H
  (assert (=> (= c ((_ int2bv 8) 50)) (= counter1 ((_ int2bv 8) 50))))
...
;; H
  ...
  (forall ((s (_ BitVec 8)))
  (=> (and (bvule ((_ int2bv 8) 0) s) (bvule s ((_ int2bv 8) 49))) (lt
  (to_rep (select battery_level_at1 s)) fliteral2))))
  (= c ((_ int2bv 8) 49))))
...
;; H
  (assert
  (=>
  (and (lt (to_rep (select battery_level_at1 current_time1)) fliteral2)
  (not
  (forall ((s (_ BitVec 8)))
  (=> (and (bvule ((_ int2bv 8) 0) s) (bvule s ((_ int2bv 8) 49))) (lt
  (to_rep (select battery_level_at1 s)) fliteral2)))))
  (and (le fliteral2
  (to_rep
  (select battery_level_at1 (let ((temp___295 (bvsub current_time1 counter1)))
                            (ite (bvult current_time1 counter1)
                            (bvadd temp___295 ((_ int2bv 8) 50)) temp___295)))))
  (ite (bvuge current_time1 (bvsub counter1 ((_ int2bv 8) 1)))
  (forall ((s (_ BitVec 8)))
  (=>
  (and
  (bvule (let ((temp___296 (bvsub current_time1 (bvsub counter1 ((_ int2bv 8) 1)))))
         (ite (bvult current_time1 (bvsub counter1 ((_ int2bv 8) 1)))
         (bvadd temp___296 ((_ int2bv 8) 50)) temp___296)) s)
  (bvule s current_time1)) (lt (to_rep (select battery_level_at1 s))
  fliteral2)))
  (and
  (forall ((s (_ BitVec 8)))
  (=> (and (bvule ((_ int2bv 8) 0) s) (bvule s current_time1)) (lt
  (to_rep (select battery_level_at1 s)) fliteral2)))
  (forall ((s (_ BitVec 8)))
  (=>
  (and
  (bvule (let ((temp___297 (bvsub current_time1 (bvsub counter1 ((_ int2bv 8) 1)))))
         (ite (bvult current_time1 (bvsub counter1 ((_ int2bv 8) 1)))
         (bvadd temp___297 ((_ int2bv 8) 50)) temp___297)) s)
  (bvule s ((_ int2bv 8) 49))) (lt (to_rep (select battery_level_at1 s))
  fliteral2))))))))
...
;; WP_parameter_def
 ;; File "failsafe.adb", line 31, characters 0-0
  (not (= counter1 (time_below_threshold battery_level_at1 current_time1))))
(check-sat)
