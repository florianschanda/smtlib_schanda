...
;; H
  ...
  (and (eq y (add RNE2 x fliteral))
  (and (eq (roundToIntegral RTN2 z) x) (eq (roundToIntegral RTP2 z) y))))))

;; H
  (assert (and (= o (add RNE2 x y)) (tqtisFinite (add RNE2 x y))))

;; H
  (assert (= o1 (div1 RNE2 o fliteral3)))
...
;; H
  (assert (eq (roundToIntegral RTN2 x) x))

;; H
  (assert (eq (roundToIntegral RTN2 y) y))

;; H
  (assert (eq (roundToIntegral RTN2 z) x))

;; H
  (assert (eq (roundToIntegral RTN2 t2) x))

;; H
  (assert (eq (roundToIntegral RTP2 x) x))

;; H
  (assert (eq (roundToIntegral RTP2 y) y))

;; H
  (assert (eq (roundToIntegral RTP2 z) y))

;; H
  (assert (eq (roundToIntegral RTP2 t2) y))
