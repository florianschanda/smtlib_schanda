...
;; H
  (assert (< 1 (to_rep3 usedlogfiles__split_fields3)))
...
;; H
  ...
  (= (to_rep5
     (select logfilesstatus1 (to_rep4
                             (select usedlogfiles__split_fields4 (to_rep4
                                                                 usedlogfiles__split_fields5))))) 1))
  (= numberlogentries1 (+ (* (- (to_rep3 usedlogfiles__split_fields7) 1) 1024) 
  (to_rep2 (select logfileentries1 currentlogfile))))))

;; H
  (assert
  (and (in_range9 numberlogentries1)
  (and (= usedlogfiles__split_fields4 usedlogfiles__split_fields)
  (= usedlogfiles__split_fields6 usedlogfiles__split_fields2))))

;; H
  (assert
  (and (= o (- (to_rep3 usedlogfiles__split_fields7) 1)) (in_range9
  (- (to_rep3 usedlogfiles__split_fields7) 1))))
...
;; H
  (assert (= o3 (+ o2 (to_rep2 (select logfileentries1 currentlogfile)))))
