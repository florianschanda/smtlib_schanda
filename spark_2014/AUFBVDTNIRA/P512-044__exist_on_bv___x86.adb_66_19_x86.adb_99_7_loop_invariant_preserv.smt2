...
(declare-fun n14 () t__ref)

(declare-fun n27 () t__ref)
...
;; H
  ...
  (exists ((n16 (_ BitVec 64)))
  (and
  (and (bvule ((_ int2bv 64) 0) n16)
  (bvule n16 (bvadd var1_range_size var2_range_size)))
  (= var1 (bvadd (bvsub var2 var1_range_size) n16)))))))
