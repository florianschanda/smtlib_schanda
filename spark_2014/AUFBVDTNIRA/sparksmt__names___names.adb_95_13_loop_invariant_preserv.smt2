...
(declare-fun names__data__char_tables__append__2__container__fields1 () us_split_fields)

(declare-fun result3 () us_split_fields__ref)

(declare-fun char_table__split_fields3 () us_split_fields)

(define-fun char_table__split_fields4 () us_split_fields (mk___split_fields
                                                         char_table__split_fields2))

(define-fun names__data__char_tables__append__2__container__fields2 () us_split_fields 
...
;; H
  ...
  (= (length1
     (mk___rep char_table__split_discrs
     names__data__char_tables__append__2__container__fields2)) (+ (length1
                                                                  (mk___rep
                                                                  char_table__split_discrs
                                                                  (mk___split_fields
  ...
  (= (olt
     ...
     (model__
     (mk___rep char_table__split_discrs
     names__data__char_tables__append__2__container__fields2))) true))
  (= (get
     (model__
     (mk___rep char_table__split_discrs
     names__data__char_tables__append__2__container__fields2))
     (+ (last2
        (model__
        (mk___rep char_table__split_discrs
...
;; H
  (assert
  (= (mk___split_fields char_table__split_fields1) names__data__char_tables__append__2__container__fields2))

;; H
  (assert (invariant____function_guard
  (invariant__ hash_table char_table__split_fields4
  (mk___split_fields1 entry_table__split_fields)) hash_table
  char_table__split_fields4 (mk___split_fields1 entry_table__split_fields)))
...
;; H
  ...
  (= (invariant__ hash_table char_table__split_fields4
     (mk___split_fields1 entry_table__split_fields)) true)
  (= (length1 (mk___rep char_table__split_discrs char_table__split_fields4)) (+ 
  (length1
  (mk___rep char_table__split_discrs
...
;; H
  (assert
  (and (= o5 (- (to_rep1 (first (rt s))) 1)) (in_range1
  (- (to_rep1 (first (rt s))) 1))))
...
;; H
  (assert (and (= temp___5311 o6) (in_range1 o6)))

;; H
  (assert
  (and (<= (to_rep1 (first (rt s))) temp___5311)
  (<= temp___5311 (to_rep1 (last (rt s))))))

;; H
  (assert (= o7 temp___5311))
...
;; H
  ...
  (= (length1
     ...
     names__data__char_tables__append__2__container__fields1)) (+ (length1
                                                                  (mk___rep
                                                                  char_table__split_discrs
                                                                  char_table__split_fields4)) 1))
  (= (olt
     (model__ (mk___rep char_table__split_discrs char_table__split_fields4))
     (model__
     (mk___rep char_table__split_discrs
  ...
  (= (get
     ...
     (+ (last2
        (model__
        (mk___rep char_table__split_discrs char_table__split_fields4))) 1)) 
  o9)))
...
;; H
  (assert
  (= char_table__split_fields3 names__data__char_tables__append__2__container__fields1))
