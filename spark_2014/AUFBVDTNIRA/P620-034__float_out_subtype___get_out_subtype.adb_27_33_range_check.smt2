...
(define-fun in_range1 ((x1 t)) Bool (and (tqtisFinite x1)
                                    (and (le (neg fliteral2) x1) (le x1
                                    fliteral2))))

(define-fun bool_eq2 ((x1 t) (y1 t)) Bool (ite (eq x1 y1) true false))
...
(declare-fun to_rep (t_rate) t)

(declare-fun of_rep (t) t_rate)
...
(declare-fun roll_rate_desired () t)

(declare-fun pitch_rate_desired () t)

(declare-fun yaw_rate_desired () t)

(declare-fun o () t)

(declare-fun get_out_subtype__controller_get_desired_rate__pitch_rate_desired () t)

(declare-fun result () t)

(declare-fun roll_rate_desired1 () t)

(declare-fun result1 () t)

(declare-fun pitch_rate_desired1 () t)

(declare-fun result2 () t)

(declare-fun yaw_rate_desired1 () t)

(declare-fun get_out_subtype__controller_get_desired_rate__yaw_rate_desired () t)

(declare-fun get_out_subtype__controller_get_desired_rate__pitch_rate_desired1 () t)

(declare-fun get_out_subtype__controller_get_desired_rate__roll_rate_desired () t)
...
;; H
  (assert (tqtisFinite z))

;; H
  (assert (= result roll_rate_desired))

;; H
  (assert (= roll_rate_desired1 fliteral3))
...
;; H
  (assert (= pitch_rate_desired1 fliteral3))
...
;; H
  (assert (= yaw_rate_desired1 fliteral3))

;; H
  (assert (in_range1 yaw_rate_desired1))

;; H
  (assert (and (= o pitch_rate_desired1) (tqtisFinite pitch_rate_desired1)))
