...
(declare-fun temp___251 () map1)

(declare-fun temp___250 () map1)

(declare-fun temp___245 () map1)

(declare-fun temp___244 () Int)

(declare-fun temp___243 () Int)

(declare-fun temp___249 () map1)

(declare-fun temp___248 () map1)
...
(declare-fun m15 () map__ref)

(declare-fun tmp14 () int__ref)

(declare-fun c12 () int__ref)

(declare-fun m16 () map1)

(declare-fun tmp15 () Int)

(declare-fun c13 () Int)

(declare-fun result10 () map__ref)

(declare-fun m17 () map1)

(declare-fun result11 () int__ref)

(declare-fun i1 () Int)

(declare-fun m18 () map1)
...
;; H
  ...
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 (- c3 1)))
  (and (= (to_rep (get m2 5 i3)) (to_rep (get temp___232 7 i3)))
  (= (to_rep (get m2 7 i3)) (to_rep (get temp___233 5 i3))))))))
...
;; H
  ...
  (=> (<= 1 10) (in_range7 c3))) (=> (<= 0 2147483647) (in_range2 tmp4)))
  (and (<= 1 c3) (<= c3 10)))))
...
;; H
  (assert (=> (and (<= 1 c2) (<= c2 10)) (= (to_rep o3) tmp5)))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j 10))
  (ite (= i3 5) (= (to_rep (get m7 i3 j)) 2)
  (ite (= i3 7) (= (to_rep (get m7 i3 j)) 1) (= (to_rep (get m7 i3 j)) 0))))))))
...
;; H
  ...
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 c9))
  (and (= (to_rep (get m10 5 i3)) (to_rep (get temp___248 7 i3)))
  (= (to_rep (get m10 7 i3)) (to_rep (get temp___249 5 i3))))))))
...
;; H
  ...
  (forall ((i3 Int))
  (=> (and (<= (+ c9 1) i3) (<= i3 10))
  (and (= (to_rep (get m10 5 i3)) (to_rep (get temp___250 5 i3)))
  (= (to_rep (get m10 7 i3)) (to_rep (get temp___251 7 i3))))))))
...
;; H
  ...
  (and
  (and
  (and (=> (<= 0 9) (in_range10 c9))
  (=> (<= 0 2147483647) (in_range2 tmp10)))
  ...
  (= (get m10 temp___246 temp___247) (get temp___245 temp___246 temp___247))))))
  (and (<= 0 c9) (<= c9 9)))))
...
;; H
  (assert
  (=> (and (<= 0 c8) (<= c8 9)) (= tmp11 (to_rep (get m10 5 (+ c9 1))))))

;; H
  (assert
  (=> (and (<= 0 c8) (<= c8 9))
  (= (to_rep o6) (to_rep (get m10 7 (+ c9 1))))))

;; H
  (assert (=> (and (<= 0 c8) (<= c8 9)) (= o7 (set m10 5 (+ c9 1) o6))))

;; H
  (assert (=> (and (<= 0 c8) (<= c8 9)) (= result8 (mk_map__ref m10))))

;; H
  (assert (=> (and (<= 0 c8) (<= c8 9)) (= m11 o7)))

;; H
  (assert (=> (and (<= 0 c8) (<= c8 9)) (= (to_rep o8) tmp11)))

;; H
  (assert (=> (and (<= 0 c8) (<= c8 9)) (= o9 (set m11 7 (+ c9 1) o8))))

;; H
  (assert (=> (and (<= 0 c8) (<= c8 9)) (= result9 (mk_map__ref m11))))

;; H
  (assert (=> (and (<= 0 c8) (<= c8 9)) (= m12 o9)))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j 10))
  (ite (= i3 5) (= (to_rep (get (map__content m15) i3 j)) 2)
  (ite (= i3 7) (= (to_rep (get (map__content m15) i3 j)) 1)
  (= (to_rep (get (map__content m15) i3 j)) 0))))))))

;; H
  (assert (= o10 (temp___254 0)))
...
;; H
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- i2 1)))
  (= (to_rep (get m18 k k)) (+ (to_rep (get m17 k k)) 1)))))
...
;; H
  ...
  (forall ((h Int))
  (=> (and (<= 1 h) (<= h (- i2 1)))
  (=> (not (= k h)) (= (to_rep (get m18 k h)) (to_rep (get m17 k h)))))))))

;; H
  (assert
  (and
  (and (=> (<= 1 10) (in_range13 i2))
  (forall ((temp___261 Int) (temp___262 Int))
  (=>
  (and (and (<= 1 temp___261) (<= temp___261 10))
  (and (<= 1 temp___262) (<= temp___262 10)))
  (=> (or (<= i2 temp___262) (<= i2 temp___261))
  (= (get m18 temp___261 temp___262) (get m17 temp___261 temp___262))))))
  (and (<= 1 i2) (<= i2 10))))

(assert
;; WP_parameter_def
 ;; File "test_swap_lines.adb", line 1, characters 0-0
  (not (in_range1 (+ (to_rep (get m18 i2 i2)) 1))))
(check-sat)
