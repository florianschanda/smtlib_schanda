...
;; H
  (assert (and (= o42 (oadd o40 o41)) (oadd__function_guard o42 o40 o41)))

;; H
  (assert
  (and (= o39 (from_integer j3)) (from_integer__function_guard o39 j3)))

;; H
  (assert (and (= o43 (ole o39 o42)) (ole__function_guard o43 o39 o42)))
...
;; H
  (assert (and (= o34 (oexpon o33 j3)) (oexpon__function_guard o34 o33 j3)))
...
;; H
  (assert
  (and (= o27 (from_integer j3)) (from_integer__function_guard o27 j3)))

;; H
  (assert
  (and (= o29 (osubtract o27 o28)) (osubtract__function_guard o29 o27 o28)))

;; H
  (assert
  (and (= o26 (from_word64 i2)) (from_word64__function_guard o26 i2)))

;; H
  (assert
  (and (= o30 (osubtract o26 o29)) (osubtract__function_guard o30 o26 o29)))

;; H
  (assert
  (and (= o25 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o25 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o31 (oexpon__2 o25 o30)) (oexpon__2__function_guard o31 o25 o30)))
...
;; H
  (assert
  (and (= o24 (num_of_big_int e e_first o23)) (num_of_big_int__function_guard
  o24 e e_first o23)))

;; H
  (assert
  (and (= o32 (odivide o24 o31)) (odivide__function_guard o32 o24 o31)))

;; H
  (assert (and (= o35 (omod o32 o34)) (omod__function_guard o35 o32 o34)))
...
;; H
  (assert
  (and (= o18 (oexpon o13 o17)) (oexpon__function_guard o18 o13 o17)))

;; H
  (assert
  (and (= o12 (from_word32 w2)) (from_word32__function_guard o12 w2)))

;; H
  (assert
  (and (= o19 (omultiply o12 o18)) (omultiply__function_guard o19 o12 o18)))

;; H
  (assert (and (= o36 (oeq o19 o35)) (oeq__function_guard o36 o19 o35)))
