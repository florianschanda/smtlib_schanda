...
(define-fun bool_eq ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (rec__mode_logic_props_types__changed_state__unit_delay_memory
                           (us_split_fields1 a)) (rec__mode_logic_props_types__changed_state__unit_delay_memory
                                                 (us_split_fields1 b)))
                        (= (rec__mode_logic_props_types__changed_state__in1_out1
...
(declare-fun mode_logic_props_types__changed_state__unit_delay_memory__first__bit () Int)

(declare-fun mode_logic_props_types__changed_state__unit_delay_memory__last__bit () Int)

(declare-fun mode_logic_props_types__changed_state__unit_delay_memory__position () Int)
...
(declare-fun mode_logic_props_types__changed_state__in1_out1__first__bit () Int)

(declare-fun mode_logic_props_types__changed_state__in1_out1__last__bit () Int)

(declare-fun mode_logic_props_types__changed_state__in1_out1__position () Int)
...
(declare-datatypes ()
((changed_state__ref (mk_changed_state__ref (changed_state__content us_rep)))))
(define-fun changed_state__ref___projection ((a changed_state__ref)) us_rep 
...
(declare-fun nav_capture_cond_met () Bool)

(declare-fun attr__ATTRIBUTE_ADDRESS6 () Int)

(declare-fun no_higher_event_than_nav_capture_cond_met () Bool)
...
(declare-fun unit_delay1_memory () Bool)

(declare-fun unit_delay_out1 () Bool)

(declare-fun unit_delay1_out1 () Bool)

(declare-fun modes_on_out1 () Bool)

(declare-fun nav_capture_cond_met_out1 () Bool)

(declare-fun no_higher_event_than_nav_capture_cond_met_out1 () Bool)

(declare-fun pilot_flying_side_out1 () Bool)

(declare-fun selected_nav_frequency_changed_out1 () Bool)

(declare-fun selected_nav_source_changed_out1 () Bool)

(declare-fun not4_out1 () Bool)

(declare-fun not3_out1 () Bool)

(declare-fun not2_out1 () Bool)
...
(declare-fun unit_delay1_out11 () Bool)
...
(declare-fun nav_capture_cond_met_out11 () Bool)

(declare-fun result5 () bool__ref)

(declare-fun no_higher_event_than_nav_capture_cond_met_out11 () Bool)

(declare-fun result6 () bool__ref)

(declare-fun pilot_flying_side_out11 () Bool)

(declare-fun changed_out1 () Bool)

(declare-fun result7 () bool__ref)

(declare-fun selected_nav_frequency_changed_out11 () Bool)

(declare-fun result8 () bool__ref)

(declare-fun selected_nav_source_changed_out11 () Bool)

(declare-fun result9 () bool__ref)

(declare-fun not4_out11 () Bool)

(declare-fun result10 () bool__ref)

(declare-fun not3_out11 () Bool)

(declare-fun result11 () bool__ref)

(declare-fun not2_out11 () Bool)
...
;; H
  (assert
  (= result5 (mk_bool__ref no_higher_event_than_nav_capture_cond_met_out1)))
...
;; H
  (assert
  (= not3_out11 (ite (not (= selected_nav_frequency_changed_out11 true)) true
                false)))
...
;; H
  (assert
  (= not2_out11 (ite (not (= selected_nav_source_changed_out11 true)) true
                false)))
...
;; H
  ...
  (= or_out11 (ite (and
                   ...
                   (and
                   (and
                   (and (and (= unit_delay_out11 true) (= not_out11 true))
                   (= nav_capture_cond_met_out11 true)) (= not2_out11 true))
                   (= not3_out11 true)) (= not4_out11 true))
                   (= modes_on_out11 true))
                   (= no_higher_event_than_nav_capture_cond_met_out11 true))
              true false)))
...
;; H
  (assert
  (= not5_out11 (ite (or (= not1_out11 true) (= nav_active_out11 true)) true
                false)))
