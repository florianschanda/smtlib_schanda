...
(declare-fun user_eq3 (t73b t73b) Bool)

(declare-fun dummy3 () t73b)
...
(declare-fun user_eq4 (t71b t71b) Bool)

(declare-fun dummy4 () t71b)
...
(declare-fun temp___517 ((Array Int unsigned_byte)) (Array Int (Array Int unsigned_byte)))

;; def_axiom
  (assert
  (forall ((temp___519 (Array Int unsigned_byte)))
  (forall ((temp___520 Int))
  (= (select (temp___517 temp___519) temp___520) temp___519))))

(declare-fun temp___521 (Int Int) (Array Int unsigned_byte))

;; def_axiom
  (assert
  (forall ((temp___523 Int) (temp___524 Int))
  (let ((temp___522 (temp___521 temp___523 temp___524)))
  (forall ((temp___525 Int))
  (ite (= temp___525 5)
  (= (select temp___522 temp___525) (of_rep temp___523))
  (= (select temp___522 temp___525) (of_rep temp___524)))))))
...
;; H
  (assert (= o (temp___521 10 12)))

;; H
  (assert (= o1 (temp___517 o)))
...
(assert
;; WP_parameter_def
 ;; File "array_aggregates.adb", line 215, characters 0-0
