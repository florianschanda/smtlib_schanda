...
(declare-fun regold () (_ BitVec 64))

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun regnew () (_ BitVec 64))
...
(declare-fun x86__writereghigh8post__result () Bool)
...
(declare-fun x86__writereghigh8post__result1 () Bool)

(declare-fun x86__writereghigh8post__result2 () Bool)

(declare-fun x86__writereghigh8post__result3 () Bool)

(declare-fun x86__writereghigh8post__result4 () Bool)

(declare-fun x86__writereghigh8post__result5 () Bool)
...
;; H
  (assert
  (and
  (and (= o (readreghigh8 regnew)) (readreghigh8__function_guard o regnew))
...
;; H
  (assert (readreghigh8__function_guard (readreghigh8 regnew) regnew))
