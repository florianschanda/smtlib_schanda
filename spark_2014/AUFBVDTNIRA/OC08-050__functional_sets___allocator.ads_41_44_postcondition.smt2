...
(declare-fun temp___368 () us_rep)

(declare-fun temp___367 () us_rep)
...
;; H
  (assert (=> (and (<= 1 r1) (<= r1 3)) (= temp___368 alloc)))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 3)) (= temp___367 avail)))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 3)) (= temp___366 r1)))
