...
;; H
  (assert (no_char_in_slice__function_guard
  (no_char_in_slice eof_ch cur_position (- o27 1) the_file) eof_ch
  cur_position (- o27 1) the_file))
...
;; H
  (assert
  (and
  (and (= o27 (find_char_in_slice eof_ch cur_position o26 the_file))
  (find_char_in_slice__function_guard o27 eof_ch cur_position o26 the_file))
  (and (in_range2 o27)
  (and (and (<= cur_position o27) (<= o27 o26))
  (and (= (no_char_in_slice eof_ch cur_position (- o27 1) the_file) true)
  (= (to_rep (select the_file o27)) eof_ch))))))
