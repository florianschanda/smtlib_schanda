...
;; H
  (assert
  (and (= o26 (find_char_in_slice eof_ch cur_position o25 the_file))
  (and (in_range2 o26)
  (and (and (<= cur_position o26) (<= o26 o25))
  (and (= (no_char_in_slice eof_ch cur_position (- o26 1) the_file) true)
  (= (to_rep (select the_file o26)) eof_ch))))))
