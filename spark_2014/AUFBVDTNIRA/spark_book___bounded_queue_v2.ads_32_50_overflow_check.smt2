...
(declare-fun temp___303 () positive)

(declare-fun temp___3031 () natural)

(declare-fun temp___3032 () positive)

(declare-fun temp___3033 () positive)

(declare-fun temp___3034 () (Array Int element_type))

(declare-fun temp___3035 () t)
...
(declare-fun temp___305 () positive)

(declare-fun temp___3051 () natural)

(declare-fun temp___3052 () positive)

(declare-fun temp___3053 () positive)

(declare-fun temp___3054 () (Array Int element_type))

(declare-fun temp___3055 () t)
...
;; H
  (assert (= queue__split_discrs (mk___split_discrs temp___303)))

;; H
  (assert (= temp___3031 o13))

;; H
  (assert (= temp___3032 o14))

;; H
  (assert (= temp___3033 o15))

;; H
  (assert (= temp___3034 o16))

;; H
  (assert (= temp___3035 o17))
...
;; H
  (assert
  (= queue__split_fields6 (mk___split_fields temp___3031 temp___3032
                          temp___3033 (mk___t temp___3034 temp___3035))))
...
;; H
  ...
  (and
  (= o18 (+ (to_rep
            (rec__bounded_queue_v2__queue_type__count queue__split_fields6)) 1))
  (in_range
...
;; H
  (assert
  (= (rec__bounded_queue_v2__queue_type__rear queue__split_fields6) o22))
...
;; H
  (assert (= queue__split_discrs (mk___split_discrs temp___305)))

;; H
  (assert (= temp___3051 o20))

;; H
  (assert (= temp___3052 o21))

;; H
  (assert (= temp___3053 o22))

;; H
  (assert (= temp___3054 o23))

;; H
  (assert (= temp___3055 o24))
...
;; H
  (assert
  (= queue__split_fields7 (mk___split_fields temp___3051 temp___3052
                          temp___3053 (mk___t temp___3054 temp___3055))))
