...
(declare-fun s__split_fields8 () (Array Int integer))

(declare-fun s__split_fields9 () pointer_range)
...
;; H
  (assert
  (and (<= 1 (to_rep1 s__split_fields3)) (<= (to_rep1 s__split_fields3) 100)))
...
;; H
  (assert (= temp___193 s__split_fields4))

;; H
  (assert (= temp___1931 s__split_fields5))
