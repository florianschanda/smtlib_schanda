...
;; lemmafunction__post_axiom
  ...
  (! (=>
     ...
     (=> (lemmafunction__function_guard result x len)
...
;; maxvalue__post_axiom
  ...
  (! (=> (dynamic_invariant1 len1 true true true)
     (let ((result (maxvalue len1)))
     (=> (maxvalue__function_guard result len1) (dynamic_invariant2 result
     true false true)))) :pattern ((maxvalue len1)) )))

;; maxvalue__def_axiom
  (assert
  (forall ((len1 Int))
  (! (=>
     (and (dynamic_invariant1 len1 true true true) (maxvalue__function_guard
     (maxvalue len1) len1))
...
;; H
  ...
  i1) (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i1)))
...
;; H
  (assert
  (forall ((i1 Int)) (nth8_stream__function_guard (nth8_stream addrold i1)
  addrold i1)))
...
;; H
  ...
  (= o (peek start len
       (mk___t addr (mk (to_rep addr__first) (to_rep addr__last)))))
  (peek__function_guard o start len
  (mk___t addr (mk (to_rep addr__first) (to_rep addr__last)))))
  ...
  (= (nth o i1) true))))
  (forall ((i1 Int))
  (=> (and (<= len i1) (<= i1 63)) (not (= (nth o i1) true)))))))))
...
;; H
  (assert
  (and
  (and (= o1 (lemmafunction value1 len)) (lemmafunction__function_guard 
  o1 value1 len))
...
;; H
  (assert
  (and
  (and (and (<= (- 2) result__1) (<= result__1 0))
  (and
  (= (= result__1 (- 1))
  (< (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last))
  ...
  (and
  (= (= result__1 (- 2))
  (and (bvule (maxvalue len) value1)
  (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last))
                         (+ (- (to_rep addr__last) (to_rep addr__first)) 1)
                         0)))))
  (and
  (= (= result__1 0)
  (and (bvugt (maxvalue len) value1)
  (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last))
                         (+ (- (to_rep addr__last) (to_rep addr__first)) 1)
                         0)))))
  (and
  ...
  (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last)))
     i1) true)
  (= (nth8_stream
     (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i1) true)))))
  (and
  (=> (= result__1 0)
  (forall ((i1 Int))
  (=> (and (<= start i1) (<= i1 (- (+ start len) 1)))
  (=
  (= (nth8_stream
     (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i1) true)
  (= (nth value1 (+ (- (- len i1) 1) start)) true)))))
  (=> (= result__1 0)
  (forall ((i1 Int))
  (=>
  (and (<= (+ start len) i1)
...
;; H
  ...
  (= o2 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
;; H
  (assert (= result2 (ite (<= 0 i) o6 false)))
...
;; H
  ...
  (nth8_stream__function_guard o7
  (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i))
  (= (= o7 true)
  (= (nth1 (to_rep1 (select addr (div1 i 8))) (- 7 (mod1 i 8))) true))))

;; H
  (assert (= o8 (to_int2 o7)))
