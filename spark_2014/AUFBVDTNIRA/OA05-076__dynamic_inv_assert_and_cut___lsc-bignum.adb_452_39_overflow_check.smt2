...
(declare-fun o5 () (Array Int word32))
...
;; H
  (assert
  (forall ((k1 Int))
  (=> (and (<= aux1_first k1) (<= k1 o2))
  (= (to_rep1 (select aux1 k1)) ((_ int2bv 32) 0)))))
...
;; H
  ...
  aux3_first (+ (- o6 aux3_first) 1))
  (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first
  (+ (- o6 aux3_first) 1)))

;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int r r_first (+ (- o6 aux3_first) 1)) r r_first
  (+ (- o6 aux3_first) 1)))
...
;; H
  (assert (omultiply__function_guard
  (omultiply (num_of_big_int r r_first (+ (- o6 aux3_first) 1))
  (num_of_big_int
  (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first
  (+ (- o6 aux3_first) 1)))
  (num_of_big_int r r_first (+ (- o6 aux3_first) 1))
  (num_of_big_int
  (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first
  (+ (- o6 aux3_first) 1))))
...
;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int m m_first (+ (- o6 aux3_first) 1)) m m_first
  (+ (- o6 aux3_first) 1)))
...
;; H
  ...
  (inverse (num_of_big_int m m_first (+ (- o6 aux3_first) 1)) (base Tuple0))
  (num_of_big_int m m_first (+ (- o6 aux3_first) 1)) (base Tuple0)))
...
;; H
  ...
  (inverse (num_of_big_int m m_first (+ (- o6 aux3_first) 1)) (base Tuple0))
  (+ (- o6 aux3_first) 1)))
  (num_of_big_int m m_first (+ (- o6 aux3_first) 1)))
  (omultiply
  (omultiply (num_of_big_int r r_first (+ (- o6 aux3_first) 1))
  (num_of_big_int
  (mk___t aux11 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first
...
;; H
  ...
  (= (oeq
     ...
     (+ (- o6 aux3_first) 1)))
     (oexpon
     (inverse (num_of_big_int m m_first (+ (- o6 aux3_first) 1))
     (base Tuple0)) (+ (- o6 aux3_first) 1)))
     (num_of_big_int m m_first (+ (- o6 aux3_first) 1)))) true))

(assert
;; WP_parameter_def
 ;; File "lsc-bignum.ads", line 141, characters 0-0
  (not (in_range1 (+ aux4_first l1))))
(check-sat)
