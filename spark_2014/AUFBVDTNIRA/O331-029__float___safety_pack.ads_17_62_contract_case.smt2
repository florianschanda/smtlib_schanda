...
;; H
  ...
  (=> (lt fliteral2 value)
  (and (= o (sub RNE2 res1 threshold)) (tqtisFinite
  (sub RNE2 res1 threshold))))))
...
;; H
  ...
  (=> (lt value fliteral2)
  (and (= o1 (add RNE2 res1 threshold)) (tqtisFinite
  (add RNE2 res1 threshold)))))))
...
;; H
  (assert (= (bool_gt value threshold) true))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (eq safety_pack__dead_band__result4 (sub RNE2 value threshold))))
(check-sat)
