...
(declare-fun numerics__Omultiply__result () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun numerics__Omultiply__result1 () t)

(declare-fun numerics__Omultiply__result2 () t)

(declare-fun numerics__Omultiply__result3 () t)

(declare-fun numerics__Omultiply__result4 () t)

(declare-fun numerics__Omultiply__result5 () t)
...
;; H
  (assert
  (and (= o (mul RNE2 left right)) (tqtisFinite (mul RNE2 left right))))

;; H
  (assert (= (mk_t__ref result) (mk_t__ref numerics__Omultiply__result)))
...
;; H
  (assert
  (= (mk_t__ref numerics__Omultiply__result4) (mk_t__ref
                                              numerics__Omultiply__result2)))
...
;; WP_parameter_def
 ;; File "numerics.ads", line 7, characters 0-0
  (not (eq numerics__Omultiply__result4 (mul RNE2 left right))))
(check-sat)
