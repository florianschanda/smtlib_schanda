...
;; range_axiom
  (assert
  (forall ((x item)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)) )))
...
(define-fun bool_eq3 ((a (Array Int item)) (a__first Int) (a__last Int)
...
(declare-fun user_eq3 (tTstack_vectorSP1 tTstack_vectorSP1) Bool)

(declare-fun dummy3 () tTstack_vectorSP1)

(declare-datatypes ()
((tTstack_vectorSP1__ref
 (mk_tTstack_vectorSP1__ref (tTstack_vectorSP1__content tTstack_vectorSP1)))))
(define-fun tTstack_vectorSP1__ref___projection ((a tTstack_vectorSP1__ref)) tTstack_vectorSP1 
