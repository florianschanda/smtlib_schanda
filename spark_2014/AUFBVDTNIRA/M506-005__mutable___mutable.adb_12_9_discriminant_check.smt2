...
(declare-fun mutable__t__k__first__bit1 () Int)

(declare-fun mutable__t__k__last__bit1 () Int)

(declare-fun mutable__t__k__position1 () Int)
...
(declare-fun mutable__t__som__first__bit1 () Int)

(declare-fun mutable__t__som__last__bit1 () Int)

(declare-fun mutable__t__som__position1 () Int)
...
(declare-fun mutable__t__arr__first__bit1 () Int)

(declare-fun mutable__t__arr__last__bit1 () Int)

(declare-fun mutable__t__arr__position1 () Int)
...
(declare-fun x__split_fields1 () (Array Int integer))

(declare-fun x__split_fields2 () t)

(declare-fun x__split_discrs () d)
...
(declare-fun temp___1941 () integer)

(declare-fun temp___1942 () (Array Int integer))

(declare-fun temp___1943 () t)

(declare-fun temp___1944 () Bool)
