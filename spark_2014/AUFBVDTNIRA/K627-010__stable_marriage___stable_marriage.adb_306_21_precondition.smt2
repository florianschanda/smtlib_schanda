...
(declare-fun o11 () group2_id)

(declare-fun o12 () Int)

(declare-fun o13 () group1_id)

(declare-fun o14 () Int)

(declare-fun o15 () Int)

(declare-fun o16 () group2_id)

(declare-fun o17 () Int)

(declare-fun o18 () (Array Int group1_id))
...
;; H
  (assert (is_permutation_1__function_guard (is_permutation_1 o18) o18))

(assert
;; WP_parameter_def
 ;; File "stable_marriage.adb", line 194, characters 0-0
  (not (= (is_permutation_1 o18) true)))
(check-sat)
