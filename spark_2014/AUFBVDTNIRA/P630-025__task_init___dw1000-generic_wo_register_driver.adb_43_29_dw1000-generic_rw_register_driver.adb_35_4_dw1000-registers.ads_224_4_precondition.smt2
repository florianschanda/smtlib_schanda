...
(define-fun dynamic_invariant ((temp___expr_2334 us_t1)
  ...
  (temp___do_toplevel_2333 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_2334))
                                       (and (= (first3 temp___expr_2334) 1)
                                       (= (last4 temp___expr_2334) 2)))))
...
(define-fun dynamic_invariant1 ((temp___expr_2350 us_t2)
  ...
  (temp___do_toplevel_2349 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_2350))
                                       (and (= (first5 temp___expr_2350) 1)
                                       (= (last6 temp___expr_2350) 2)))))
...
;; H
  (assert
  (and
  (and (= temp___75892 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___75892 reg)) (dynamic_invariant1
  temp___75892 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___75891)) (to_rep (last5 temp___75891)))
     (+ (- (to_rep (last5 temp___75891)) (to_rep (first4 temp___75891))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___75891)) (to_rep (last5 temp___75891))) 
  temp___75901))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___75901)) (to_rep (last3 temp___75901)))
     (+ (- (to_rep (last3 temp___75901)) (to_rep (first2 temp___75901))) 1)
