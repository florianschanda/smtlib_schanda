...
;; H
  (assert
  (forall ((g1_id Int) (rank3 Int)) (is_preferred_1__function_guard
  (is_preferred_1 g1_id
  (to_rep
  (select result__2 (to_rep1 (select (select ranking_1 g1_id) rank3))))
  (select ranking_2 (to_rep1 (select (select ranking_1 g1_id) rank3)))) g1_id
  (to_rep
  (select result__2 (to_rep1 (select (select ranking_1 g1_id) rank3))))
  (select ranking_2 (to_rep1 (select (select ranking_1 g1_id) rank3))))))
...
;; H
  ...
  (=> (and (<= 1 g1_id) (<= g1_id 64))
  (forall ((rank3 Int))
  (=> (and (<= 1 rank3) (<= rank3 (to_rep3 (select proposals_made1 g1_id))))
  (and
  (not
  ...
  (not
  (= (to_rep
     (select result__2 (to_rep1 (select (select ranking_1 g1_id) rank3)))) g1_id))
  (not
  (= (is_preferred_1 g1_id
     (to_rep
     (select result__2 (to_rep1 (select (select ranking_1 g1_id) rank3))))
     (select ranking_2 (to_rep1 (select (select ranking_1 g1_id) rank3)))) true)))))))))
