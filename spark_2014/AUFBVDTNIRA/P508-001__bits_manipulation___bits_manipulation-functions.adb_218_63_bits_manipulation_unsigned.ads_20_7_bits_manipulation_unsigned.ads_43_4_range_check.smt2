...
(define-fun dynamic_invariant1 ((temp___expr_429 Int)
  ...
  (temp___do_toplevel_428 Bool)) Bool (=>
                                      ...
                                      (<= 1 16)) (in_range1 temp___expr_429)))
...
;; lemma2__def_axiom
  ...
  (! (=> (lemma2__function_guard (lemma2 us_void_param) us_void_param)
     ...
     (= (make_mask size) (bvsub (ite (< size 65536)
                                (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) size))
                                ((_ int2bv 16) 0)) ((_ int2bv 16) 1)))))))) :pattern (
...
(declare-fun user_eq2 (t560s t560s) Bool)

(declare-fun dummy2 () t560s)

(declare-datatypes () ((t560s__ref (mk_t560s__ref (t560s__content t560s)))))
(define-fun t560s__ref___projection ((a t560s__ref)) t560s (t560s__content a))
...
;; lemma8__def_axiom
  ...
  (! (=> (lemma8__function_guard1 (lemma81 us_void_param) us_void_param)
     ...
     (shift_right val__ (- 16 n)) val__ (- 16 n)))
     ...
     (bvult (shift_right val__ (- 16 n)) (ite (< n 65536)
                                         (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) n))
                                         ((_ int2bv 16) 0)))))))))) :pattern (
...
;; H
  (assert
  (= (make_mask i1) (bvsub (ite (< i1 65536)
                           (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) i1))
                           ((_ int2bv 16) 0)) ((_ int2bv 16) 1))))

;; H
  (assert (forall ((j1 Int)) (make_mask__function_guard (make_mask j1) j1)))
...
;; H
  ...
  (= (make_mask j1) (bvsub (ite (< j1 65536)
                           (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) j1))
                           ((_ int2bv 16) 0)) ((_ int2bv 16) 1))))))

;; H
  (assert (and (=> (<= 2 15) (in_range2 i2)) (and (<= 2 i2) (<= i2 15))))
...
;; H
  (assert (=> (< j 65536) (= o (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) j)))))

;; H
  (assert (=> (not (< j 65536)) (= o ((_ int2bv 16) 0))))

;; H
  (assert (= o1 (bvsub o ((_ int2bv 16) 1))))
