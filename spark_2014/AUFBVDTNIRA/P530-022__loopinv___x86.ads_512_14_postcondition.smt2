...
(declare-fun r111 () (_ BitVec 64))

(declare-fun r112 () (_ BitVec 64))

(declare-fun r113 () (_ BitVec 64))
...
;; H
  (assert (writereglow8post__function_guard (writereglow8post r11 r112 val__)
  r11 r112 val__))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not (= (writereglow8post r11 r112 val__) true)))
(check-sat)
