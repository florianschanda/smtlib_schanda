...
;; H
  ...
  (convert_character_digit_to_integer__function_guard o49 o48))
  (and (in_range1 o49)
  (and (and (<= 0 o49) (<= o49 9))
...
;; H
  ...
  (convert_character_digit_to_integer__function_guard o41 o40))
  (and (in_range1 o41)
  (and (and (<= 0 o41) (<= o41 9))
...
;; H
  (assert
  (and (= temp___1963 (+ (to_rep1 (first (rt source))) 0)) (in_range1
  (+ (to_rep1 (first (rt source))) 0))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1963)
  (<= temp___1963 (to_rep1 (last (rt source))))))

;; H
  (assert (= o33 temp___1963))
