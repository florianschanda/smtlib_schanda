...
(declare-fun basic__r__x__first__bit2 () Int)

(declare-fun basic__r__x__last__bit2 () Int)

(declare-fun basic__r__x__position2 () Int)
...
(declare-fun basic__r__c_field1__first__bit2 () Int)

(declare-fun basic__r__c_field1__last__bit2 () Int)

(declare-fun basic__r__c_field1__position2 () Int)
...
(declare-fun basic__r__c_field2__first__bit2 () Int)

(declare-fun basic__r__c_field2__last__bit2 () Int)

(declare-fun basic__r__c_field2__position2 () Int)
...
(declare-fun basic__r__base__first__bit2 () Int)

(declare-fun basic__r__base__last__bit2 () Int)

(declare-fun basic__r__base__position2 () Int)
...
(declare-fun basic__r__a_field__first__bit2 () Int)

(declare-fun basic__r__a_field__last__bit2 () Int)

(declare-fun basic__r__a_field__position2 () Int)
...
(declare-fun z__split_fields2 () Bool)

(declare-fun z__split_fields3 () natural)
...
(declare-fun subty__p__z__assume () enum)

(declare-fun subty__p__z__assume1 () integer)

(declare-fun subty__p__z__assume2 () integer)

(declare-fun subty__p__z__assume3 () Bool)

(declare-fun subty__p__z__assume4 () natural)
...
;; WP_parameter_def
 ;; File "subty.ads", line 5, characters 0-0
  (not (= (to_rep (rec__basic__r__a_field z__split_fields4)) 1)))
(check-sat)
