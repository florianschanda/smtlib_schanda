...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o17) j3))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o17) (peek
                                                                   (mk___rep2
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o17) j3))) true))))
  (and
  (forall ((j3 Int))
  (=> (and (<= 1 j3) (<= j3 100))
  (=>
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__1 (mk___rep3 t_old__split_fields4)) j3))) true))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__1 (mk___rep3 t__split_fields10)) j3))) true)))
(check-sat)
