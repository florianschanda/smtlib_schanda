...
(define-fun eq__logic ((a (_ BitVec 64))
  (b (_ BitVec 64))) Bool (ite (eq_sub a b 0 64) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_215 Int)
...
;; peek__post_axiom
  ...
  (! (=>
     ...
     length1 true true true)) (dynamic_invariant4 addr true true true))
     (and (= (first1 addr) 0)
     (and (<= length1 64)
     ...
     (and
     (forall ((i Int)) (nth8_stream__function_guard
     (nth8_stream addr (- (- (+ start length1) i) 1)) addr
     (- (- (+ start length1) i) 1)))
     (=> (peek__function_guard result start length1 addr)
     (and
...
;; lemmafunction2__post_axiom
  (assert
  (forall ((x (_ BitVec 64)))
  (forall ((len Int))
  (! (and (maxvalue__function_guard (maxvalue len) len)
     (=>
     (and
     (and (dynamic_invariant2 x true true true) (dynamic_invariant len true
     true true)) (and (and (<= 0 len) (<= len 63)) (bvult x (maxvalue len))))
     (let ((result (lemmafunction2 x len)))
     (=> (lemmafunction2__function_guard result x len)
     (and
     (and (= result 0)
     (forall ((i Int))
     (=> (and (<= len i) (<= i 63)) (not (= (nth x i) true)))))
     (dynamic_invariant3 result true false true)))))) :pattern ((lemmafunction2
                                                                x len)) ))))
...
;; H
  ...
  (and
  (<= (+ start len) (ite (<= (to_rep addr__first) (to_rep addr__last))
                    (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))
  (bvult value (maxvalue len)))))))
...
;; H
  (assert
  (and
  (and (= o (lemmafunction2 value len)) (lemmafunction2__function_guard 
  o value len))
  (and (in_range4 o)
  (and (= o 0)
  (forall ((i Int))
  (=> (and (<= len i) (<= i 63)) (not (= (nth value i) true))))))))
...
;; H
  (assert
  (forall ((i Int)) (nth8_stream__function_guard
  (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i)
  (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i)))

;; H
  (assert
  (forall ((i Int)) (nth8_stream__function_guard
  (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last)))
  i) (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i)))
...
;; H
  (assert
  (and
  (and (and (<= (- 2) pokeresult1) (<= pokeresult1 0))
  (and
  (= (= pokeresult1 (- 1))
  (< (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last))
          (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) (+ start 
  len)))
  (and
  (= (= pokeresult1 (- 2))
  (and (bvule (maxvalue len) value)
  (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last))
                         (+ (- (to_rep addr__last) (to_rep addr__first)) 1)
                         0)))))
  (and
  (= (= pokeresult1 0)
  (and (bvugt (maxvalue len) value)
  (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last))
                         (+ (- (to_rep addr__last) (to_rep addr__first)) 1)
                         0)))))
  (and
  ...
  (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last)))
     i) true)
  (= (nth8_stream
     (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i) true)))))
  (and
  (=> (= pokeresult1 0)
  (forall ((i Int))
  (=> (and (<= start i) (<= i (- (+ start len) 1)))
  (=
  (= (nth8_stream
     (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i) true)
  (= (nth value (+ (- (- len i) 1) start)) true)))))
  (=> (= pokeresult1 0)
  (forall ((i Int))
  (=>
  (and (<= (+ start len) i)
  (<= i (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last))
...
;; H
  ...
  (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last)))
  (- (- (+ start len) i) 1))
  (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last)))
  (- (- (+ start len) i) 1))))
...
;; H
  ...
  (= o1 (peek start len
        (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last)))))
  (peek__function_guard o1 start len
  (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last)))))
  ...
  (= (nth o1 i) true))))
  (forall ((i Int))
  (=> (and (<= len i) (<= i 63)) (not (= (nth o1 i) true)))))))))

;; H
  (assert (= (mk_t__ref result1) (mk_t__ref result__)))
...
(assert
;; WP_parameter_def
 ;; File "bitwalker.ads", line 134, characters 0-0
  (not (= (eq__logic result__1 value) true)))
(check-sat)
