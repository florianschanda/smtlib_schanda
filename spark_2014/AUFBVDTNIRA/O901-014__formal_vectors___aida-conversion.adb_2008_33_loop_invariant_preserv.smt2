...
;; H
  ...
  (<= index4 (+ (to_rep1 (first (rt source))) 7)))
...
;; H
  (assert (<= temp___2619 index1))

;; H
  (assert (<= index1 temp___2620))
...
;; H
  ...
  (=> (< index2 temp___2617)
  (= (select n3 temp___2617) (select n1 temp___2617)))))
  (=>
