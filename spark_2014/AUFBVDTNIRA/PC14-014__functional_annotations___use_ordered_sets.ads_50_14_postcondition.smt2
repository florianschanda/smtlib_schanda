...
;; H
  ...
  (= (ole (model__ s2)
     (model__ (mk___rep s1__split_discrs s1__split_fields4))) true))
  (= (included_in_union
     (model__ (mk___rep s1__split_discrs s1__split_fields4)) (model__ s2)
     (model__
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) true))
  (= (e_elements_included__3
     (elements (mk___rep s1__split_discrs s1__split_fields4))
     (model__
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
     (elements
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
  ...
  (= (e_elements_included__2
     ...
     (model__
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
     (elements (mk___rep s1__split_discrs s1__split_fields4))) true))
  (= (e_elements_included__3 (elements s2)
     (model__
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
     (elements s2) (elements (mk___rep s1__split_discrs s1__split_fields4))) true))
  (= (mapping_preserved
     (elements
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
     (elements (mk___rep s1__split_discrs s1__split_fields4))
...
;; H
  (assert (= s1__split_fields2 s1__split_fields1))
