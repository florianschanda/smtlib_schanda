...
;; H
  (assert
  (forall ((i14 Int)) (nth8_stream__function_guard
  (nth8_stream (mk___t addr3 (mk (to_rep addr__first) (to_rep addr__last)))
  i14) (mk___t addr3 (mk (to_rep addr__first) (to_rep addr__last))) i14)))

;; H
  (assert
  (forall ((i14 Int)) (nth8_stream__function_guard
  (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last)))
  i14) (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) i14)))
...
;; H
  (assert (nth8_stream__function_guard
  (nth8_stream (mk___t addr3 (mk (to_rep addr__first) (to_rep addr__last)))
  (+ start i3)) (mk___t addr3 (mk (to_rep addr__first) (to_rep addr__last)))
  (+ start i3)))
...
;; H
  ...
  (= o27 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))

;; H
  (assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o27 0)))
...
;; H
  (assert (= o30 (ite (< o29 (+ start len)) true false)))

;; H
  (assert (= o31 (to_int2 o30)))
...
;; H
  (assert (= o24 (ite (bvule o19 value) true false)))
...
;; H
  (assert
  (and (and (= o11 (maxvalue len)) (maxvalue__function_guard o11 len))
  (= o11 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))))

;; H
  (assert (= o16 (ite (bvugt o11 value) true false)))
...
;; H
  ...
  i14) (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i14)))
...
;; H
  ...
  (mk (to_rep addr__first) (to_rep addr__last))) i14)
  (mk___t (map__content addr10)
  (mk (to_rep addr__first) (to_rep addr__last))) i14)))
...
;; H
  ...
  (= (= result10 true)
  (forall ((i14 Int))
  (=> (and (<= 0 i14) (<= i14 (- start 1)))
  (=
  (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last)))
     i14) true)
  (= (nth8_stream
     (mk___t (map__content addr10)
     (mk (to_rep addr__first) (to_rep addr__last))) i14) true)))))))
...
;; H
  ...
  (= (= result11 true)
  (forall ((i14 Int))
  (=> (and (<= start i14) (<= i14 (- (+ start len) 1)))
  (=
  (= (nth8_stream
     (mk___t (map__content addr10)
     (mk (to_rep addr__first) (to_rep addr__last))) i14) true)
  (= (nth value (+ (- (- len i14) 1) start)) true)))))))
