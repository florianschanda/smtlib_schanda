...
;; H
  (assert
  (= (oeq (mk___rep v__split_discrs v__split_fields9) (empty_vector Tuple0)) true))
...
;; H
  ...
  (= (length
     ...
     unbounded__vect__append__2__container__fields4)) (+ (length
                                                         ...
                                                         v__split_discrs
                                                         v__split_fields9)) 1))
  (= (olt (model__ (mk___rep v__split_discrs v__split_fields9))
     (model__
     (mk___rep v__split_discrs
  ...
  (= (get
     ...
     (+ (last (model__ (mk___rep v__split_discrs v__split_fields9))) 1)) 1)))
...
;; H
  (assert
  (= v__split_fields8 unbounded__vect__append__2__container__fields4))
...
;; H
  ...
  (= (length
     ...
     unbounded__vect__append__2__container__fields3)) (+ (length
                                                         ...
                                                         v__split_discrs
                                                         v__split_fields8)) 1))
  (= (olt (model__ (mk___rep v__split_discrs v__split_fields8))
     (model__
     (mk___rep v__split_discrs
  ...
  (= (get
     ...
     (+ (last (model__ (mk___rep v__split_discrs v__split_fields8))) 1)) 2)))
...
;; WP_parameter_def
 ;; File "a-cofove.ads", line 807, characters 0-0
  (not (< 0 (length (mk___rep v__split_discrs v__split_fields7)))))
(check-sat)
