...
;; H
  (assert
  (and
  (and (= o4 (to__ (mk___rep s__split_fields10))) (to____function_guard 
  o4 (mk___rep s__split_fields10))) (dynamic_invariant1 o4 true false true)))
...
;; H
  (assert (and (= temp___482 (- last3 i9)) (in_range1 (- last3 i9))))
...
;; H
  (assert (= temp___484 (mk___t2 o3 (mk2 first2 temp___482))))

;; H
  (assert (and (= temp___481 (- last3 i9)) (in_range1 (- last3 i9))))

;; H
  (assert (<= first2 temp___481))
