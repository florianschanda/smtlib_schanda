...
(declare-fun temp___318 () positive)

(declare-fun temp___3181 () natural)

(declare-fun temp___3182 () positive)

(declare-fun temp___3183 () positive)

(declare-fun temp___3184 () (Array Int element_type))

(declare-fun temp___3185 () t)
...
;; H
  (assert (= queue__split_discrs (mk___split_discrs temp___318)))

;; H
  (assert (= temp___3181 o20))

;; H
  (assert (= temp___3182 o21))

;; H
  (assert (= temp___3183 o22))

;; H
  (assert (= temp___3184 o23))

;; H
  (assert (= temp___3185 o24))
...
;; H
  (assert
  (= queue__split_fields7 (mk___split_fields temp___3181 temp___3182
                          temp___3183 (mk___t temp___3184 temp___3185))))
