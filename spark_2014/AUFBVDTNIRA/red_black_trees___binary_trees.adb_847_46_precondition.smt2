...
(declare-fun temp___2474 () (Array Int us_rep1))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2474 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2474 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___2474 (model__
                 (mk___rep2
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) o58))
  (model____function_guard temp___2474
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  o58))
  (and (dynamic_invariant3 temp___2474 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2474 o58))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2474 o58)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o58))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2474 (parent
                              ...
                              f_old__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2474 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2474 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2474 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2474 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2474 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2474 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o59 (select temp___2474 i)))

;; H
  (assert (= o60 (us_split_fields1 o59)))

;; H
  (assert (= result8 (rec__tree_model__path_type__k o60)))
