...
;; H
  ...
  (= result (valid_root
            (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
            root))
  (valid_root__function_guard result
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1294 (parent
                      (mk___rep2
                      (mk___split_fields2 f__split_fields f__split_fields1))
                      i1))))
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1294 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1294 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___1294 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 root))
  (model____function_guard temp___1294
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root))
  (and (dynamic_invariant3 temp___1294 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1294 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1294 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1294 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1294 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1294 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1294 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___1294 i)))
...
;; H
  ...
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  o) (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) 
  o))
