...
(declare-fun temp___12051 () (Array Int us_rep1))
...
(declare-fun result7 () us_rep2)

(declare-fun s4 () us_rep2)
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1205 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (= (contains s3
     (to_rep
     (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i))) true)))))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             ...
             (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) true)
  (= (to_rep
     (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i)) v))))))))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___12051 (parent
                       (rec__search_trees__search_tree__struct
                       (us_split_fields7 t)) i))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___12051 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___12051 (parent
                       (rec__search_trees__search_tree__struct
...
;; H
  (assert
  (and
  (= o9 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))
  (in_range2
  (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
...
;; H
  ...
  (and
  (and
  (= temp___12051 (model__
                  (rec__search_trees__search_tree__struct
                  (us_split_fields7 t)) o9))
  (model____function_guard temp___12051
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o9))
  (and (dynamic_invariant5 temp___12051 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___12051 o9))) true)
  (and
  (= (length1
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___12051 o9)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i o9))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___12051 (parent
                               ...
                               (us_split_fields7 t)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___12051 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___12051 i))) true))))))
  (and
  ...
  (= (length1
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___12051 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___12051 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___12051 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___12051 j4)))) true))
  (= j4 i))))))))))))))
...
;; H
  (assert
  (= (mk___rep (mk___split_fields o10 o11)) (select temp___12051 j3)))
...
;; H
  ...
  (=>
  (exists ((e Int))
  (and (and (in_range4 e) (= (contains s3 e) true))
  (= e (to_rep
       (select (rec__search_trees__search_tree__values (us_split_fields7 t)) 
       j3)))))
  (= o8 true))))))
...
;; H
  (assert
  (=> (= result6 true) (= result5 (ite (not (= o8 true)) true false))))
...
;; H
  ...
  (= o14 (add s3
         ...
         (select (rec__search_trees__search_tree__values
                 (us_split_fields7 t)) j3))))
  (and
  (and
  (and (= (length o14) (+ (length s3) 1))
  (= (contains o14
     (to_rep
     (select (rec__search_trees__search_tree__values (us_split_fields7 t)) 
     j3))) true))
  (= (ole s3 o14) true))
  (= (included_except o14 s3
     (to_rep
     (select (rec__search_trees__search_tree__values (us_split_fields7 t)) 
     j3))) true)))))
