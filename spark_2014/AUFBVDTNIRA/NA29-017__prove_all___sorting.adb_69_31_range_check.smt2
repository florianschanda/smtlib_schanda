...
;; H
  (assert (and (= o4 (+ a_first length1)) (in_range1 (+ a_first length1))))

;; H
  (assert
  (and
  (= o5 (sorted (mk___t a (mk (to_rep a__first) (to_rep a__last))) o4
        length2))
  (sorted__function_guard o5
  (mk___t a (mk (to_rep a__first) (to_rep a__last))) o4 length2)))

;; H
  (assert
  (and
  (= o3 (sorted (mk___t a (mk (to_rep a__first) (to_rep a__last))) a_first
        length1))
  (sorted__function_guard o3
...
;; H
  (assert (= o2 (ite (<= o1 2147483647) true false)))
