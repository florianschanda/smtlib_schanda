...
;; H
  (assert (is_perm__function_guard
  (is_perm (mk___t a12 (mk (to_rep a__first) (to_rep a__last)))
  (mk___t a13 (mk (to_rep a__first) (to_rep a__last))))
  (mk___t a12 (mk (to_rep a__first) (to_rep a__last)))
  (mk___t a13 (mk (to_rep a__first) (to_rep a__last)))))
...
;; H
  ...
  (and
  (= (is_perm (mk___t a12 (mk (to_rep a__first) (to_rep a__last)))
     (mk___t a13 (mk (to_rep a__first) (to_rep a__last)))) true)
  (and (= (to_rep (select a13 o41)) (to_rep (select a12 o42)))
  (and (= (to_rep (select a13 o42)) (to_rep (select a12 o41)))
  (forall ((z3 Int))
  (=> (and (<= (to_rep a__first) z3) (<= z3 (to_rep a__last)))
  (=> (and (not (= z3 o41)) (not (= z3 o42)))
  (= (to_rep (select a13 z3)) (to_rep (select a12 z3)))))))))
  (= (to_rep a__first) 0)))
...
;; H
  (assert (sorted__function_guard
  (sorted (mk___t (map__content a14) (mk (to_rep a__first) (to_rep a__last)))
  0 (- (int__content j10) 1))
  (mk___t (map__content a14) (mk (to_rep a__first) (to_rep a__last))) 0
  (- (int__content j10) 1)))
