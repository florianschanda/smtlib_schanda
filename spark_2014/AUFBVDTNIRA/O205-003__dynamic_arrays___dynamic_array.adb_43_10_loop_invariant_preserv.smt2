...
(declare-fun dynamic_array__rec__b__first__bit () Int)

(declare-fun dynamic_array__rec__b__last__bit () Int)

(declare-fun dynamic_array__rec__b__position () Int)
...
(declare-fun dynamic_array__rec__f1__first__bit () Int)

(declare-fun dynamic_array__rec__f1__last__bit () Int)

(declare-fun dynamic_array__rec__f1__position () Int)
...
(declare-fun dynamic_array__rec__f2__first__bit () Int)

(declare-fun dynamic_array__rec__f2__last__bit () Int)

(declare-fun dynamic_array__rec__f2__position () Int)
...
(declare-fun dynamic_array__holder__d__first__bit () Int)

(declare-fun dynamic_array__holder__d__last__bit () Int)

(declare-fun dynamic_array__holder__d__position () Int)
...
(declare-fun dynamic_array__holder__content__first__bit () Int)

(declare-fun dynamic_array__holder__content__last__bit () Int)

(declare-fun dynamic_array__holder__content__position () Int)
...
(declare-datatypes ()
((holder__ref (mk_holder__ref (holder__content us_rep1)))))
(define-fun holder__ref___projection ((a holder__ref)) us_rep1 (holder__content
                                                               a))

(define-fun dynamic_invariant2 ((temp___expr_167 us_rep1)
  (temp___is_init_164 Bool) (temp___skip_constant_165 Bool)
  (temp___do_toplevel_166 Bool)) Bool (let ((temp___168 (rec__dynamic_array__holder__d
                                                        (us_split_discrs3
                                                        temp___expr_167))))
                                      (and
                                      ...
                                      (first1
                                      (rec__dynamic_array__holder__content
                                      (us_split_fields3 temp___expr_167)))
                                      (last3
                                      (rec__dynamic_array__holder__content
                                      (us_split_fields3 temp___expr_167))))
                                      (and
                                      (= (first1
                                         (rec__dynamic_array__holder__content
                                         (us_split_fields3 temp___expr_167))) 1)
                                      (= (last3
                                         (rec__dynamic_array__holder__content
                                         (us_split_fields3 temp___expr_167))) 
                                      (to_rep temp___168))))
                                      ...
                                      (<= (first1
                                          (rec__dynamic_array__holder__content
                                          (us_split_fields3 temp___expr_167))) temp___169)
                                      (<= temp___169 (last3
                                                     (rec__dynamic_array__holder__content
                                                     (us_split_fields3
                                                     temp___expr_167)))))
                                      ...
                                      (= (attr__constrained
                                         (select (to_array
                                                 (rec__dynamic_array__holder__content
                                                 (us_split_fields3
                                                 temp___expr_167))) temp___169)) false)))))))
...
;; increment__post_axiom
  ...
  (! (=> (dynamic_invariant1 r true true true)
     ...
     false true)))) :pattern ((increment r)) )))

;; increment__def_axiom
  (assert
  (forall ((r us_rep))
  (! (=>
     (and (dynamic_invariant1 r true true true) (increment__function_guard
     (increment r) r))
...
(declare-datatypes ()
((tT18bP1__ref (mk_tT18bP1__ref (tT18bP1__content integer)))))
...
(define-fun last6 ((a us_t1)) Int (to_rep1 (last5 (rt1 a))))
...
(define-fun bool_eq10 ((x us_t1)
  (y us_t1)) Bool (bool_eq5 (elts1 x) (to_rep1 (first2 (rt1 x)))
                  (to_rep1 (last5 (rt1 x))) (elts1 y)
                  (to_rep1 (first2 (rt1 y))) (to_rep1 (last5 (rt1 y)))))
...
(define-fun us_split_fields_Content4__projection ((a us_split_fields4)) us_t1 
...
(define-fun us_rep_10__projection ((a us_rep2)) us_split_discrs2 (us_split_discrs4
                                                                 a))
...
(declare-fun dynamic_array__holder__d__first__bit1 () Int)

(declare-fun dynamic_array__holder__d__last__bit1 () Int)

(declare-fun dynamic_array__holder__d__position1 () Int)
...
(declare-fun dynamic_array__holder__content__first__bit1 () Int)

(declare-fun dynamic_array__holder__content__last__bit1 () Int)

(declare-fun dynamic_array__holder__content__position1 () Int)
...
(define-fun dynamic_invariant3 ((temp___expr_182 us_rep2)
  (temp___is_init_179 Bool) (temp___skip_constant_180 Bool)
  (temp___do_toplevel_181 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_180 true))
                                      (in_range4 c
                                      (to_base temp___expr_182)))
                                      (and
                                      (and (dynamic_property4 1 c
                                      (first3
                                      (rec__dynamic_array__holder__content1
                                      (us_split_fields5 temp___expr_182)))
                                      (last6
                                      (rec__dynamic_array__holder__content1
                                      (us_split_fields5 temp___expr_182))))
                                      (and
                                      (= (first3
                                         (rec__dynamic_array__holder__content1
                                         (us_split_fields5 temp___expr_182))) 1)
                                      (= (last6
                                         (rec__dynamic_array__holder__content1
                                         (us_split_fields5 temp___expr_182))) 
                                      c)))
                                      ...
                                      (<= (first3
                                          (rec__dynamic_array__holder__content1
                                          (us_split_fields5 temp___expr_182))) temp___184)
                                      (<= temp___184 (last6
                                                     (rec__dynamic_array__holder__content1
                                                     (us_split_fields5
                                                     temp___expr_182)))))
                                      ...
                                      (= (attr__constrained
                                         (select (to_array1
                                                 (rec__dynamic_array__holder__content1
                                                 (us_split_fields5
                                                 temp___expr_182))) temp___184)) false)))))))
  ...
  (temp___skip_top_level_187 Bool)) Bool (and
                                         ...
                                         (= (attr__constrained
                                            (select (to_array1
                                                    (rec__dynamic_array__holder__content1
                                                    (us_split_fields5
                                                    temp___expr_186))) temp___190)) false)
                                         (= (rec__dynamic_array__rec__b
                                            (us_split_discrs1
                                            (select (to_array1
                                                    (rec__dynamic_array__holder__content1
...
(declare-datatypes ()
((tT20bP1__ref (mk_tT20bP1__ref (tT20bP1__content integer)))))
...
;; mk_def
  ...
  (! (=> (in_range1 f)
     ...
     (= (to_rep1 (last8 (mk2 f l))) l)))) :pattern ((mk2 f l)) )))
...
(define-fun last9 ((a us_t2)) Int (to_rep1 (last8 (rt2 a))))
...
(define-fun bool_eq13 ((x us_t2)
  (y us_t2)) Bool (bool_eq5 (elts2 x) (to_rep1 (first4 (rt2 x)))
                  (to_rep1 (last8 (rt2 x))) (elts2 y)
                  (to_rep1 (first4 (rt2 y))) (to_rep1 (last8 (rt2 y)))))
...
(define-fun us_split_fields_Content5__projection ((a us_split_fields6)) us_t2 
...
(define-fun us_rep_12__projection ((a us_rep3)) us_split_discrs2 (us_split_discrs5
                                                                 a))

(define-fun us_rep_13__projection ((a us_rep3)) us_split_fields6 (us_split_fields7
                                                                 a))
...
(declare-fun dynamic_array__holder__d__first__bit2 () Int)

(declare-fun dynamic_array__holder__d__last__bit2 () Int)

(declare-fun dynamic_array__holder__d__position2 () Int)
...
(declare-fun dynamic_array__holder__content__first__bit2 () Int)

(declare-fun dynamic_array__holder__content__last__bit2 () Int)

(declare-fun dynamic_array__holder__content__position2 () Int)
...
;; mk_def
  ...
  (! (=> (in_range1 f)
     ...
     (= (to_rep1 (last11 (mk3 f l))) l)))) :pattern ((mk3 f l)) )))
...
(define-fun last12 ((a us_t3)) Int (to_rep1 (last11 (rt3 a))))

(define-fun length3 ((a us_t3)) Int (ite (<= (first7 a) (last12 a))
                                    (+ (- (last12 a) (first7 a)) 1) 0))
...
(define-fun bool_eq16 ((x us_t3)
  (y us_t3)) Bool (bool_eq5 (elts3 x) (to_rep1 (first6 (rt3 x)))
                  (to_rep1 (last11 (rt3 x))) (elts3 y)
                  (to_rep1 (first6 (rt3 y))) (to_rep1 (last11 (rt3 y)))))
...
(declare-fun dynamic_array__rec__b__first__bit1 () Int)

(declare-fun dynamic_array__rec__b__last__bit1 () Int)

(declare-fun dynamic_array__rec__b__position1 () Int)
...
(declare-fun dynamic_array__rec__f1__first__bit1 () Int)

(declare-fun dynamic_array__rec__f1__last__bit1 () Int)

(declare-fun dynamic_array__rec__f1__position1 () Int)
...
(declare-fun dynamic_array__rec__f2__first__bit1 () Int)

(declare-fun dynamic_array__rec__f2__last__bit1 () Int)

(declare-fun dynamic_array__rec__f2__position1 () Int)
...
(declare-fun h__split_discrs () us_split_discrs2)
...
(declare-fun dynamic_array__rec__b__first__bit2 () Int)

(declare-fun dynamic_array__rec__b__last__bit2 () Int)

(declare-fun dynamic_array__rec__b__position2 () Int)
...
(declare-fun dynamic_array__rec__f2__first__bit2 () Int)

(declare-fun dynamic_array__rec__f2__last__bit2 () Int)

(declare-fun dynamic_array__rec__f2__position2 () Int)
...
(declare-fun dynamic_array__rec__f1__first__bit2 () Int)

(declare-fun dynamic_array__rec__f1__last__bit2 () Int)

(declare-fun dynamic_array__rec__f1__position2 () Int)
...
;; mk_def
  ...
  (! (=> (in_range1 f)
     ...
     (= (to_rep1 (last14 (mk4 f l))) l)))) :pattern ((mk4 f l)) )))
...
(define-fun last15 ((a us_t4)) Int (to_rep1 (last14 (rt4 a))))

(define-fun length4 ((a us_t4)) Int (ite (<= (first9 a) (last15 a))
                                    (+ (- (last15 a) (first9 a)) 1) 0))
...
(define-fun bool_eq18 ((x us_t4)
  (y us_t4)) Bool (bool_eq5 (elts4 x) (to_rep1 (first8 (rt4 x)))
                  (to_rep1 (last14 (rt4 x))) (elts4 y)
                  (to_rep1 (first8 (rt4 y))) (to_rep1 (last14 (rt4 y)))))
...
(declare-datatypes ()
((rec_array__ref (mk_rec_array__ref (rec_array__content us_t4)))))
(define-fun rec_array__ref___projection ((a rec_array__ref)) us_t4 (rec_array__content
                                                                   a))

(declare-fun temp___197 (us_rep Int Int) us_t3)
...
;; def_axiom
  ...
  (and
  (=> (dynamic_property10 1 2147483647 temp___200 temp___201)
  (and (= (first7 temp___198) temp___200) (= (last12 temp___198) temp___201)))
  (forall ((temp___202 Int))
  (= (select (to_array3 temp___198) temp___202) temp___199)))))))
...
(define-fun dynamic_invariant6 ((temp___expr_145 Int)
...
(declare-fun h__split_fields () (Array Int us_rep))

(declare-fun h__split_fields1 () t1)

(declare-fun i () Int)

(declare-fun temp___d_196 () Int)
...
(declare-fun temp___203 () (Array Int us_rep))

(declare-fun temp___2031 () t3)

(declare-fun temp___204 () (Array Int us_rep))

(declare-fun temp___2041 () t3)

(declare-fun o9 () (Array Int us_rep))

(declare-fun o10 () t2)

(declare-fun o11 () (Array Int us_rep))
...
(declare-fun dynamic_array__h__assume () us_rep2)

(declare-fun dynamic_array__B_2__hh__assume () us_rep1)

(declare-fun o19 () Int)

(declare-fun dynamic_array__B_2__r__assume () us_rep)
...
(declare-fun o26 () us_t1)

(declare-fun o27 () us_split_fields4)

(declare-fun temp___213 () us_rep2)

(declare-fun result () us_split_fields__ref2)

(declare-fun h__split_fields2 () us_split_fields4)

(declare-fun result1 () int__ref)

(declare-fun i1 () Int)

(declare-fun h__split_fields3 () us_split_fields4)
...
(declare-fun h__split_fields4 () us_split_fields4)

(declare-fun result6 () int__ref)

(declare-fun i3 () Int)

(define-fun temp___2032 () us_t3 (mk___t3 temp___203 temp___2031))

;; H
  (assert (in_range2 c))

;; H
  (assert (in_range2 temp___d_196))
...
;; H
  (assert
  (= temp___2032 (temp___197
                 (mk___rep (mk___split_discrs o5) (mk___split_fields o6 o7)
                 o8) 1 c)))

;; H
  (assert (= (to_rep1 (first6 temp___2031)) 1))

;; H
  (assert (= (to_rep1 (last11 temp___2031)) c))

;; H
  (assert (= (mk___t3 temp___204 temp___2041) temp___2032))

;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___2041)) (to_rep1 (last11 temp___2041)))
     (+ (- (to_rep1 (last11 temp___2041)) (to_rep1 (first6 temp___2041))) 1)
     0) (ite (<= 1 c) (+ (- c 1) 1) 0)))

;; H
  (assert (= temp___204 o9))

;; H
  (assert
  (= (mk2 (to_rep1 (first6 temp___2041)) (to_rep1 (last11 temp___2041))) 
  o10))
...
;; H
  (assert (new_holder__function_guard (new_holder c) c))
...
;; H
  ...
  (and
  (<= (to_rep1
      (first2 (rt1 (rec__dynamic_array__holder__content1 h__split_fields3)))) temp___217)
  (<= temp___217 (to_rep1
                 (last5
                 (rt1
                 (rec__dynamic_array__holder__content1 h__split_fields3))))))
  (=> (<= i2 temp___217)
  (= (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) temp___217) (select 
  (elts1 (rec__dynamic_array__holder__content1 h__split_fields2)) temp___217))))))
  (and (<= 1 i2) (<= i2 c))))
...
;; H
  ...
  (new_holder__function_guard dynamic_array__B_2__hh__assume c))
...
;; H
  (assert
  (=> (= (rec__dynamic_array__rec__b (us_split_discrs1 r)) true)
  (= result2 (mk_int__ref f))))

;; H
  (assert
  (=> (= (rec__dynamic_array__rec__b (us_split_discrs1 r)) true)
  (= f1 (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 r))))))

;; H
  (assert
  (=> (not (= (rec__dynamic_array__rec__b (us_split_discrs1 r)) true))
  (= result3 (mk_int__ref f))))

;; H
  (assert
  (=> (not (= (rec__dynamic_array__rec__b (us_split_discrs1 r)) true))
  (= f2 (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 r))))))
...
;; H
  (assert (=> (< f1 c) (and (= o20 (+ f1 1)) (in_range1 (+ f1 1)))))

;; H
  (assert (=> (< f1 c) (= result4 (mk_int__ref f1))))

;; H
  (assert (=> (< f1 c) (= f3 o20)))

;; H
  (assert (=> (not (< f1 c)) (= f3 f1)))

;; H
  (assert (and (= us2 f3) (dynamic_property 0 last f3)))

;; H
  (assert (= o21 f3))

;; H
  (assert (= o22 (of_rep1 o21)))

;; H
  (assert (= o23 (mk___split_fields o22 dummy3)))

;; H
  (assert (= temp___207 (mk___rep (mk___split_discrs (of_int 1)) o23 true)))

;; H
  (assert
  (=>
  (= (attr__constrained
     (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) 
     i2)) true)
  (= (rec__dynamic_array__rec__b (us_split_discrs1 temp___207)) (rec__dynamic_array__rec__b
                                                                (us_split_discrs1
                                                                (select 
                                                                (elts1
                                                                (rec__dynamic_array__holder__content1
...
;; H
  (assert (= usq_4 temp___207))

;; H
  (assert
  (= o24 (mk___rep (us_split_discrs1 usq_4) (us_split_fields1 usq_4)
         (attr__constrained
         (select (elts1
                 (rec__dynamic_array__holder__content1 h__split_fields3)) 
         i2)))))
...
;; H
  (assert
  (= o26 (mk___t1 o25
         (rt1 (rec__dynamic_array__holder__content1 h__split_fields3)))))

;; H
  (assert (= o27 (mk___split_fields2 o26)))

;; H
  (assert (= temp___213 (mk___rep2 h__split_discrs o27)))

;; H
  (assert (= result5 (mk___split_fields__ref2 h__split_fields3)))

;; H
  (assert (= h__split_fields4 (us_split_fields5 temp___213)))

;; H
  (assert (= h__split_discrs (us_split_discrs4 temp___213)))
...
;; WP_parameter_def
 ;; File "dynamic_array.adb", line 31, characters 0-0
  ...
  (= (rec__dynamic_array__rec__b
     (us_split_discrs1
     (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields4)) 
     j))) true))))
(check-sat)
