...
;; H
  (assert
  (= (mk1 1 (to_rep (rec__stack__stack__top (us_split_fields1 s)))) temp___2171))

(assert
;; WP_parameter_def
 ;; File "stack.ads", line 5, characters 0-0
  (not (dynamic_property 1 2147483647 (to_rep1 (first2 temp___2171))
  (to_rep1 (last3 temp___2171)))))
(check-sat)
