...
;; H
  ...
  (ite (< k q2)
  (= (to_rep1 (select h2 k)) (to_rep1 (select temp___483 (+ k m1))))
  (ite (< (+ q2 m1) k)
  (= (to_rep1 (select h2 k)) (to_rep1 (select temp___485 (- k m1))))
  (= (to_rep1 (select h2 k)) (to_rep1 (select temp___487 k)))))))))
...
;; WP_parameter_def
 ;; File "infoflow.ads", line 114, characters 0-0
  (not
  (= (to_rep1 (select h9 k)) (to_rep1
                             (select h (+ k (div1 (to_rep h__last) 2)))))))
(check-sat)
