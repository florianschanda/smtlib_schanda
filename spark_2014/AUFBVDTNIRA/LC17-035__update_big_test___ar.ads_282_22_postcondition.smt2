...
(declare-fun temp___760 ((Array Int (Array Int et1)) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___762 (Array Int (Array Int et1))))
  (forall ((temp___763 Int))
  (forall ((temp___764 (Array Int et1)))
  (let ((temp___761 (temp___760 temp___762 temp___763 temp___764)))
  (forall ((temp___765 Int))
  (ite (= temp___765 temp___763)
  (= (select temp___761 temp___765) temp___764)
  (= (select temp___761 temp___765) (select temp___762 temp___765)))))))))

(declare-fun temp___766 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___768 (Array Int et1)))
  (forall ((temp___769 Int) (temp___770 Int))
  (let ((temp___767 (temp___766 temp___768 temp___769 temp___770)))
  (forall ((temp___771 Int))
  (ite (= temp___771 temp___769)
  (= (select temp___767 temp___771) (of_rep temp___770))
  (= (select temp___767 temp___771) (select temp___768 temp___771))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 275, characters 0-0
  (not
  (= (bool_eq4 a2 5 50 (temp___760 a i2 (temp___766 (select a i2) i1 e)) 5
     50) true)))
(check-sat)
