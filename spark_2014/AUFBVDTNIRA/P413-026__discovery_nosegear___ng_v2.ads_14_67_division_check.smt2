...
;; H
  ...
  (timesincelastclickbeforelastupdate__function_guard o6 prevtime currtime
  thistime))
...
;; H
  (assert (distancesincelastupdate__function_guard
  (distancesincelastupdate prevtime prevcount currtime thistime thiscount)
  prevtime prevcount currtime thistime thiscount))
...
;; H
  ...
  (= o4 (distancesincelastclickbeforelastupdate prevtime prevcount currtime
        thistime thiscount))
  (distancesincelastclickbeforelastupdate__function_guard o4 prevtime
  prevcount currtime thistime thiscount))
