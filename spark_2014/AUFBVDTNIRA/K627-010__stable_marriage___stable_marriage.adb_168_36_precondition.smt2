...
;; H
  (assert
  (forall ((g211 Int)) (is_permutation_1__function_guard
  (is_permutation_1 (select r2 g211)) (select r2 g211))))
...
;; H
  (assert (=> (and (<= 1 g22) (<= g22 64)) (= temp___596 result__1)))

;; H
  (assert (=> (and (<= 1 g22) (<= g22 64)) (= temp___595 g22)))
...
;; H
  ...
  (=> (and (<= 1 g22) (<= g22 64))
  (and
  (and (= o2 (invert_1 (select r2 g23))) (invert_1__function_guard o2
  (select r2 g23)))
  (and
  (forall ((rank Int))
  (=> (and (<= 1 rank) (<= rank 64))
  (= (to_rep1 (select o2 (to_rep (select (select r2 g23) rank)))) rank)))
  (forall ((g1 Int))
  (=> (and (<= 1 g1) (<= g1 64))
  (= (to_rep (select (select r2 g23) (to_rep1 (select o2 g1)))) g1)))))))

;; H
  (assert (=> (and (<= 1 g22) (<= g22 64)) (= o3 (store result__2 g23 o2))))

;; H
  (assert (=> (and (<= 1 g22) (<= g22 64)) (= result__2 result2)))

;; H
  (assert (=> (and (<= 1 g22) (<= g22 64)) (= result__3 o3)))
