...
;; H
  (assert (from_word32__function_guard (from_word32 a_msw1) a_msw1))
...
;; H
  ...
  (from_word32 a_msw1)) (oexpon (base Tuple0) (+ (- a_last a_first) 1))
  (from_word32 a_msw1)))
...
;; H
  ...
  a_first (+ (- a_last a_first) 1))
  (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1))
  (from_word32 a_msw1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))
  (oadd
  (num_of_big_int (mk___t a (mk (to_rep a__first) (to_rep a__last))) 
  a_first (+ (- a_last a_first) 1))
  (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1))
...
;; H
  ...
  (num_of_big_int c c_first (+ (- a_last a_first) 1)))
  (num_of_big_int b b_first (- i1 a_first))
  (num_of_big_int c c_first (+ (- a_last a_first) 1))))
...
;; H
  ...
  (oexpon
  (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0))
  (- i1 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))
  (omultiply
  (omultiply (num_of_big_int b b_first (- i1 a_first))
  (num_of_big_int c c_first (+ (- a_last a_first) 1)))
  (oexpon
