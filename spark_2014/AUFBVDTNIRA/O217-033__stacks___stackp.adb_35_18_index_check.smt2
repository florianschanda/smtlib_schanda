...
;; H
  ...
  (wraps_around (mk___rep1 s__split_fields8 s__attr__tag))
  (mk___rep1 s__split_fields8 s__attr__tag)))

;; H
  (assert
  (and
  (and (= temp___740 (last2 (mk___rep1 s__split_fields8 s__attr__tag)))
  (last__function_guard temp___740
  (mk___rep1 s__split_fields8 s__attr__tag)))
  (and (in_range temp___740)
  (= temp___740 (ite (not
                     (= (wraps_around
                        (mk___rep1 s__split_fields8 s__attr__tag)) true))
