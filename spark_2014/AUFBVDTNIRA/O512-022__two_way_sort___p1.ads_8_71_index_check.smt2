...
(declare-fun temp___168 () (Array Int Bool))
...
(declare-fun a5 () (Array Int Bool))

(declare-fun i7 () Int)

(declare-fun j8 () Int)

(declare-fun a6 () (Array Int Bool))

(declare-fun i8 () Int)

(declare-fun j9 () Int)

(declare-fun a7 () (Array Int Bool))
...
(declare-fun a11 () (Array Int Bool))
...
;; H
  ...
  (= (= result9 true)
  (forall ((j17 Int))
  (=> (and (<= (to_rep a__first) j17) (<= j17 k))
  (not (= (select (map__content a10) j17) true))))))

;; H
  (assert (= result9 true))

;; H
  (assert (and (= o9 (+ k 1)) (in_range1 (+ k 1))))
...
;; H
  (assert
  (= result10 (ite (= o10 true) (ite (<= j1 (to_rep a__last)) true false) false)))
