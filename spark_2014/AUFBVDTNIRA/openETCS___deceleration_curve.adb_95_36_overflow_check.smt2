...
;; H
  (assert (= o30 (div1 RNE2 o29 fliteral9)))
...
;; H
  (assert
  (=> (lt maximum_valid_speed speed3) (= result7 (mk_t__ref speed3))))

;; H
  (assert
  (=> (lt maximum_valid_speed speed3) (= speed4 maximum_valid_speed)))

;; H
  (assert (=> (not (lt maximum_valid_speed speed3)) (= speed4 speed3)))
