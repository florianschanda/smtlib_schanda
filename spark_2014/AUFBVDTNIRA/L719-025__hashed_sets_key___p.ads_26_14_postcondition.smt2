...
(define-fun dynamic_invariant ((temp___expr_320 Int)
  ...
  (temp___do_toplevel_319 Bool)) Bool (=>
                                      ...
                                      (<= 1 100)) (in_range temp___expr_320)))
...
;; contains__post_axiom
  ...
  (! (=> (dynamic_invariant2 key1 true true true)
     ...
     (and (forall ((e Int)) (key__function_guard (key e) e))
     (and
     (forall ((e Int)) (my_eq__function_guard (my_eq key1 (key e)) key1
     (key e)))
     (= (= (contains container key1) true)
     (exists ((e Int))
     (and (and (in_range3 e) (= (contains1 (model__ container) e) true))
...
(define-fun dynamic_invariant3 ((temp___expr_326 Int)
...
(define-fun key_type__ref___projection ((a key_type__ref2)) us_rep3 (key_type__content2
                                                                    a))
...
(define-fun element2 ((container us_rep)
...
;; key__post_axiom
  ...
  (! (=> (dynamic_invariant i true true true)
     (let ((result (key i)))
     (=> (key__function_guard result i) (dynamic_invariant1 result true false
     true)))) :pattern ((key i)) )))
...
;; key__def_axiom
  ...
  (forall ((i Int))
  (! (=>
     (and (dynamic_invariant i true true true) (key__function_guard (key i)
     i)) (= (key i) i)) :pattern ((key i)) )))

(define-fun dynamic_invariant4 ((temp___expr_168 (_ BitVec 32))
...
(define-fun default_initial_assumption2 ((temp___expr_362 us_rep2)
  (temp___skip_top_level_363 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_363 true))
                                         (= (is_empty1 temp___expr_362) true)))
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container)))
     ...
     (=>
     (and (in_range7 temp___440)
     (= (iter_has_element result temp___440) true))
     (= (contains1 (model__ container) (get result temp___440)) true))))
     (forall ((item Int))
     (=> (and (in_range3 item) (= (contains1 (model__ container) item) true))
...
;; element__post__dispatch_axiom
  ...
  (forall ((attr__tag Int))
  (forall ((container us_rep))
  (forall ((position us_rep3)) (! (dynamic_invariant3
...
(define-fun dynamic_invariant6 ((temp___expr_355 Int)
...
(define-fun dynamic_invariant7 ((temp___expr_392 Int)
...
;; has_key__post_axiom
  ...
  (! (=> (= (of_int 0) true)
     (=>
     (exists ((k1 us_rep3))
     (and (= (has_key container k1) true) (= (bool_eq10 k1 key1) true)))
...
(declare-fun dummy14 () element_type4)
...
;; witness__post_axiom
  ...
  (! (=> (= (has_key container key1) true)
     ...
     true false true)))) :pattern ((witness container key1)) ))))
...
;; m_included_except__post_axiom
  ...
  (! (=> (dynamic_invariant2 key1 true true true)
     ...
     (and (forall ((e Int)) (key__function_guard (key e) e))
     (and
     (forall ((e Int)) (my_eq__function_guard (my_eq (key e) key1) (key e)
     key1))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant2 key1 true true true)
     ...
     (forall ((e Int)) (my_eq__function_guard (my_eq key1 (key e)) key1
     (key e)))
     (and (my_eq__function_guard (my_eq (key__2 container result) key1)
     (key__2 container result) key1)
     (ite (forall ((e Int))
          (=> (and (in_range3 e) (= (contains1 (model__ container) e) true))
          (not (= (my_eq key1 (key e)) true))))
     (= (bool_eq10 result no_element) true)
     (and (= (has_key (positions container) result) true)
     (= (my_eq (key__2 container result) key1) true))))))))) :pattern (
...
;; H
  (assert
  (= (contains (mk___rep l__split_discrs (mk___split_fields l__split_fields))
     k) true))
...
;; H
  ...
  (= o (element
       (mk___rep l__split_discrs (mk___split_fields l__split_fields))
       (find1 (mk___rep l__split_discrs (mk___split_fields l__split_fields))
       k))))))
...
;; H
  ...
  (= (length (mk___rep l__split_discrs l__split_fields4)) (length
                                                          ...
                                                          (mk___split_fields
                                                          l__split_fields))))
  (= (element2 (mk___rep l__split_discrs l__split_fields4) k) e1))
  (= (contains1 (model__ (mk___rep l__split_discrs l__split_fields4)) e1) true))
  (= (m_included_except
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (model__ (mk___rep l__split_discrs l__split_fields4)) k) true))
  (= (included_except (model__ (mk___rep l__split_discrs l__split_fields4))
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     e1) true))
  (= (mapping_preserved_except
     (elements
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (elements (mk___rep l__split_discrs l__split_fields4))
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (positions (mk___rep l__split_discrs l__split_fields4))
     (find1 (mk___rep l__split_discrs l__split_fields4) k)) true))
  (= (oeq2 (positions (mk___rep l__split_discrs l__split_fields4))
     (positions
...
(assert
;; WP_parameter_def
 ;; File "a-cfhase.ads", line 1254, characters 0-0
  (not
  (= (oeq (mk___rep l__split_discrs (mk___split_fields l__split_fields2))
     (mk___rep l__split_discrs (mk___split_fields l__split_fields))) true)))
(check-sat)
