...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__otp_srdat_type__otp_srdat bits_32)))))
(define-fun us_split_fields_OTP_SRDAT__projection ((a us_split_fields)) bits_32 
  (rec__dw1000__register_types__otp_srdat_type__otp_srdat a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_78__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_78__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq6 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__otp_srdat_type__otp_srdat
...
(declare-fun dw1000__register_types__otp_srdat_type__otp_srdat__first__bit () Int)

(declare-fun dw1000__register_types__otp_srdat_type__otp_srdat__last__bit () Int)

(declare-fun dw1000__register_types__otp_srdat_type__otp_srdat__position () Int)

;; dw1000__register_types__otp_srdat_type__otp_srdat__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__otp_srdat_type__otp_srdat__first__bit))

;; dw1000__register_types__otp_srdat_type__otp_srdat__last__bit_axiom
  (assert
  (< dw1000__register_types__otp_srdat_type__otp_srdat__first__bit dw1000__register_types__otp_srdat_type__otp_srdat__last__bit))

;; dw1000__register_types__otp_srdat_type__otp_srdat__position_axiom
...
(declare-datatypes ()
((otp_srdat_type__ref
 (mk_otp_srdat_type__ref (otp_srdat_type__content us_rep)))))
(define-fun otp_srdat_type__ref___projection ((a otp_srdat_type__ref)) us_rep 
  (otp_srdat_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_191__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_134__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_134__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6446 us_t1)
  (temp___is_init_6443 Bool) (temp___skip_constant_6444 Bool)
  (temp___do_toplevel_6445 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6444 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_6446)
                                       (last4 temp___expr_6446))
                                       (and (= (first3 temp___expr_6446) 1)
                                       (= (last4 temp___expr_6446) 4)))))
...
(define-fun target__ref_58__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_58__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_6462 us_t2)
  (temp___is_init_6459 Bool) (temp___skip_constant_6460 Bool)
  (temp___do_toplevel_6461 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6460 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_6462)
                                       (last6 temp___expr_6462))
                                       (and (= (first5 temp___expr_6462) 1)
                                       (= (last6 temp___expr_6462) 4)))))
...
(declare-fun temp___7984 () (Array Int bits_8))

(declare-fun temp___79841 () t2)

(declare-fun temp___7985 () (Array Int bits_8))

(declare-fun temp___79851 () t1)
...
(define-fun temp___79842 () us_t2 (mk___t2 temp___7984 temp___79841))
...
;; H
  (assert
  (and
  (and (= temp___79842 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___79842 reg)) (dynamic_invariant1
  temp___79842 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___79841)) (to_rep (last5 temp___79841)))
     (+ (- (to_rep (last5 temp___79841)) (to_rep (first4 temp___79841))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___7984 temp___7985))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___79841)) (to_rep (last5 temp___79841))) 
  temp___79851))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___79851)) (to_rep (last3 temp___79851)))
     (+ (- (to_rep (last3 temp___79851)) (to_rep (first2 temp___79851))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7985 temp___79851)))
