...
;; H
  ...
  (model_is_well_formed o26 data first_available) o26 data first_available))

;; H
  (assert (model_is_well_formed__function_guard
  (model_is_well_formed o25 data2 first_available2) o25 data2
  first_available2))

;; H
  (assert
  (and
  (and (= o26 (model__ data first_available)) (model____function_guard 
  o26 data first_available))
...
;; H
  ...
  (=> (= result true)
  (and
  (and (= o25 (model__ data2 first_available2)) (model____function_guard 
  o25 data2 first_available2))
...
;; H
  ...
  (int__content first_available5)) o22 (map__content data5)
...
;; H
  ...
  (model____function_guard o22 (map__content data5)
  (int__content first_available5)))
  (= (model_is_well_formed o22 (map__content data5)
...
;; H
  ...
  (is_prepend__function_guard result4
  (rec__list_mod_allocator__m__t__available
  (us_split_fields3 (model__ data first_available))) res o24))
  (= (= result4 true)
  (and
