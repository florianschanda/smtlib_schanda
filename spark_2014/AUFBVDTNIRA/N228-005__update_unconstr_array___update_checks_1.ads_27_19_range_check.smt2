...
;; def_axiom
  ...
  (and (= (first5 temp___275) temp___277) (= (last7 temp___275) temp___278)))
...
;; def_axiom
  ...
  (and (= (first9 temp___461) temp___463) (= (last13 temp___461) temp___464)))
...
(declare-fun temp___467 () (Array Int integer))

(declare-fun temp___4671 () t4)

(declare-fun temp___468 () (Array Int integer))

(declare-fun temp___4681 () t3)

(declare-fun temp___471 () (Array Int integer))

(declare-fun temp___4711 () t3)

(declare-fun o () (Array Int integer))

(declare-fun temp___477 () (Array Int integer))

(declare-fun temp___4771 () t2)
...
;; H
  (assert (= (to_rep (last12 (rt4 (temp___460 new_val 2 i)))) i))
...
;; H
  (assert
  (= (ite (<= (to_rep (first8 temp___4671)) (to_rep (last12 temp___4671)))
     (+ (- (to_rep (last12 temp___4671)) (to_rep (first8 temp___4671))) 1) 0) 
  (ite (<= 2 i) (+ (- i 2) 1) 0)))
...
;; H
  (assert
  (= (mk3 (to_rep (first8 temp___4671)) (to_rep (last12 temp___4671))) 
  temp___4681))

;; H
  (assert
  (= (ite (<= (to_rep (first6 temp___4681)) (to_rep (last9 temp___4681)))
     (+ (- (to_rep (last9 temp___4681)) (to_rep (first6 temp___4681))) 1) 0) 
  (ite (<= (to_rep (first6 (mk3 2 i))) (to_rep (last9 (mk3 2 i))))
  (+ (- (to_rep (last9 (mk3 2 i))) (to_rep (first6 (mk3 2 i)))) 1) 0)))

;; H
  (assert
  (= (mk___t3 temp___471 temp___4711) (mk___t3 temp___468 temp___4681)))

;; H
  (assert
  (forall ((temp___472 Int))
  (ite (and (<= 2 temp___472) (<= temp___472 i))
  (= (select o temp___472) (select temp___471 temp___472))
  (= (select o temp___472) (select a temp___472)))))
...
;; H
  (assert (= (to_rep (first4 (rt2 (temp___274 new_val 1 i)))) 1))

;; H
  (assert (= (to_rep (last6 (rt2 (temp___274 new_val 1 i)))) i))

;; H
  (assert (= (mk___t2 temp___477 temp___4771) (temp___274 new_val 1 i)))
