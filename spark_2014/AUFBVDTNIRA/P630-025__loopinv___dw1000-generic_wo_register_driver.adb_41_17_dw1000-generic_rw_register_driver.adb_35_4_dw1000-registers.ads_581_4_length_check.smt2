...
(define-fun dynamic_invariant ((temp___expr_6734 us_t1)
  ...
  (temp___do_toplevel_6733 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_6734))
                                       (and (= (first3 temp___expr_6734) 1)
                                       (= (last4 temp___expr_6734) 2)))))
...
(define-fun dynamic_invariant1 ((temp___expr_6750 us_t2)
  ...
  (temp___do_toplevel_6749 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_6750))
                                       (and (= (first5 temp___expr_6750) 1)
                                       (= (last6 temp___expr_6750) 2)))))
...
;; H
  (assert
  (and
  (and (= temp___80182 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___80182 reg)) (dynamic_invariant1
  temp___80182 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80181)) (to_rep (last5 temp___80181)))
     (+ (- (to_rep (last5 temp___80181)) (to_rep (first4 temp___80181))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80181)) (to_rep (last5 temp___80181))) 
  temp___80191))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___80191)) (to_rep (last3 temp___80191)))
     (+ (- (to_rep (last3 temp___80191)) (to_rep (first2 temp___80191))) 1)
