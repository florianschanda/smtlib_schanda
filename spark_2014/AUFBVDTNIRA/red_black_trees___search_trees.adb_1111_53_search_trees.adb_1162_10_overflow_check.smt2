...
;; H
  ...
  (select temp___2094 (parent
                      ...
                      t__split_fields10) i2))))
  (position (rec__search_trees__search_tree__struct t__split_fields10) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2094 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2094 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2095 o55))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2095 o55)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o55))
...
;; H
  (assert (= o56 (select temp___2095 i1)))
...
;; H
  ...
  (rec__search_trees__search_tree__struct t__split_fields10) o51))
  (and (dynamic_invariant6 temp___2094 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2094 o51))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2094 o51)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o51))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2094 (parent
                              ...
                              t__split_fields10) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2094 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2094 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2094 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2094 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2094 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2094 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o52 (select temp___2094 x1)))
...
;; H
  (assert
  (forall ((i2 Int)) (parent__function_guard
  (parent (mk___rep2 f_1__split_fields3) i2) (mk___rep2 f_1__split_fields3)
  i2)))
...
;; H
  (assert
  (forall ((i2 Int)) (position__function_guard
  (position (mk___rep2 f_1__split_fields3) i2) (mk___rep2 f_1__split_fields3)
  i2)))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2093 (parent (mk___rep2 f_1__split_fields3) i2))))
  (position (mk___rep2 f_1__split_fields3) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2093 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2093 (parent (mk___rep2 f_1__split_fields3) i2))))
  (position (mk___rep2 f_1__split_fields3) i2)
...
;; H
  (assert
  (and
  (and (= temp___2093 (model__ (mk___rep2 f_1__split_fields3) o45))
  (model____function_guard temp___2093 (mk___rep2 f_1__split_fields3) 
  o45))
  (and (dynamic_invariant6 temp___2093 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2093 o45))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2093 o45)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o45))
  (ite (and (not (= (parent (mk___rep2 f_1__split_fields3) i2) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___2093 (parent (mk___rep2 f_1__split_fields3) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2093 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2093 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2093 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2093 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2093 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2093 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o46 (select temp___2093 i1)))
