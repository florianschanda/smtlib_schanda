...
;; H
  ...
  (us_split_fields__content usedlogfiles__split_fields18))
  (map__content1 logfileentries8) (int__content numberlogentries8)
  currentlogfile (us_split_fields__content usedlogfiles__split_fields18)))
