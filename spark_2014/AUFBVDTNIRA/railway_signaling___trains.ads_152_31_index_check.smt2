...
(define-fun bool_eq13 ((a (Array Int track_opt_id)) (a__first Int)
...
(define-fun bool_eq14 ((a (Array Int (Array Int track_opt_id)))
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq13 (select a temp___idx_144) 1 3
...
(define-fun o22 () us_rep (mk___rep (mk___split_fields o17 o18 o19)))

(define-fun o23 () us_rep (mk___rep (mk___split_fields o11 o12 o13)))

(define-fun o24 () us_rep (mk___rep (mk___split_fields o7 o8 o9)))

(define-fun o25 () us_rep (mk___rep (mk___split_fields o1 o2 o3)))
...
;; H
  (assert (= result1 (ite (not (= o15 true)) true false)))

;; H
  (assert (=> (= result1 true) (and (<= 1 train) (<= train 10))))

;; H
  (assert (=> (= result1 true) (= o16 train)))

;; H
  (assert (=> (= result1 true) (= o22 (select trains o16))))
