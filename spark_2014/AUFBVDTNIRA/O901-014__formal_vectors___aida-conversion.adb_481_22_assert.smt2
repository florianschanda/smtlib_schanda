...
(declare-fun temp___1571 () (Array Int integer))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1575))
  (= temp___1573 index1)))
...
;; H
  ...
  (=> (< index2 temp___1572)
  (= (select n3 temp___1572) (select temp___1571 temp___1572)))))
...
;; H
  (assert
  (and (= temp___1576 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))
