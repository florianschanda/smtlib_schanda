...
;; H
  (assert (= o26 (sub RNE2 o25 target_y)))

;; H
  (assert (and (= o28 o26) (tqtisFinite o26)))

;; H
  (assert (= o29 (ite (lt o28 o27) true false)))

;; H
  (assert
  (and
  (= o24 (add RNE2 position_x
         (to_rep
         (rec__flight_manager__engine_values__x_speed
         (us_split_fields1
         (engine_values__content flight_manager__set_engine_speed__result5))))))
...
;; H
  (assert (= o23 (sub RNE2 o22 target_x)))
