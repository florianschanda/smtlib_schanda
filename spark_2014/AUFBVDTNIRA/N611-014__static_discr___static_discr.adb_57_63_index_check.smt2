...
(define-fun tT17bP1__ref___projection ((a tT17bP1__ref)) integer (tT17bP1__content
                                                                 a))
...
(define-fun t16b__ref___projection ((a t16b__ref)) us_rep3 (t16b__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_224 us_rep4)
  ...
  (temp___do_toplevel_223 Bool)) Bool (and
                                      ...
                                      (in_range5 (last10 a) (last10 a)
                                      (to_base2 temp___expr_224)))
                                      (and (in_range4 (last10 a) (last10 a)
                                      (to_base1
                                      (rec__static_discr__holder__content1
                                      (us_split_fields9 temp___expr_224))))
                                      (and (dynamic_property5 1 (last10 a)
                                      (first5
                                      (rec__static_discr__i_holder__content2
                                      (us_split_fields7
                                      (rec__static_discr__holder__content1
...
;; H
  ...
  (= (bool_eq2
     ...
     (to_rep1 (last7 current__split_fields3))) true))
...
;; H
  ...
  (<= (to_rep
      (rec__static_discr__holder__length1
      (us_split_fields__content4 current__split_fields6))) (int__content
                                                           result__3)))
