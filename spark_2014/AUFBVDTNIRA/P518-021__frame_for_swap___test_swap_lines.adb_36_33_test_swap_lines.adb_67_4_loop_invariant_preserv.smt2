...
(declare-fun m19 () map1)

(declare-fun result13 () int__ref)

(declare-fun i3 () Int)

(declare-fun m20 () map__ref)

(declare-fun i4 () int__ref)

(declare-fun m21 () map1)
...
;; H
  ...
  (forall ((i6 Int))
  (=> (and (<= 1 i6) (<= i6 (- c3 1)))
  (and (= (to_rep (get m2 5 i6)) (to_rep (get temp___232 7 i6)))
  (= (to_rep (get m2 7 i6)) (to_rep (get temp___233 5 i6))))))))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j 10))
  (ite (= i6 5) (= (to_rep (get m7 i6 j)) 2)
  (ite (= i6 7) (= (to_rep (get m7 i6 j)) 1) (= (to_rep (get m7 i6 j)) 0))))))))
...
;; H
  ...
  (forall ((i6 Int))
  (=> (and (<= 1 i6) (<= i6 c9))
  (and (= (to_rep (get m10 5 i6)) (to_rep (get temp___248 7 i6)))
  (= (to_rep (get m10 7 i6)) (to_rep (get temp___249 5 i6))))))))
...
;; H
  ...
  (forall ((i6 Int))
  (=> (and (<= (+ c9 1) i6) (<= i6 10))
  (and (= (to_rep (get m10 5 i6)) (to_rep (get temp___250 5 i6)))
  (= (to_rep (get m10 7 i6)) (to_rep (get temp___251 7 i6))))))))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j 10))
  (ite (= i6 5) (= (to_rep (get (map__content m15) i6 j)) 2)
  (ite (= i6 7) (= (to_rep (get (map__content m15) i6 j)) 1)
  (= (to_rep (get (map__content m15) i6 j)) 0))))))))
...
;; H
  (assert
  (and (= o11 (+ (to_rep (get m18 i2 i2)) 1)) (in_range1
  (+ (to_rep (get m18 i2 i2)) 1))))

;; H
  (assert (= (to_rep o12) o11))

;; H
  (assert (= o13 (set m18 i2 i2 o12)))
...
;; WP_parameter_def
 ;; File "test_swap_lines.adb", line 1, characters 0-0
  (not
  (= (to_rep (get (map__content m20) k k)) (+ (to_rep (get m17 k k)) 1))))
(check-sat)
