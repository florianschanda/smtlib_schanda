...
(declare-fun amortized_queue__enqueue__result () capacity_range)

(declare-fun amortized_queue__enqueue__result1 () us_main_type)

(declare-fun amortized_queue__enqueue__result2 () capacity_range)

(declare-fun amortized_queue__enqueue__result3 () us_main_type)
...
(declare-fun amortized_queue__enqueue__R63b__result__assume () us_rep2)
...
(declare-fun amortized_queue__my_vectors__append__2__container__fields () us_split_fields)
...
(declare-fun amortized_queue__enqueue__result4 () us_rep2)

(declare-fun result____split_fields8 () us_split_fields__ref1)

(declare-fun amortized_queue__enqueue__result5 () queue__ref)

(declare-fun result____split_fields9 () us_split_fields2)

(declare-fun amortized_queue__enqueue__result6 () us_rep2)

(declare-fun result____split_fields10 () us_split_fields__ref1)

(declare-fun amortized_queue__enqueue__result7 () queue__ref)

(declare-fun result____split_fields11 () us_split_fields2)

(declare-fun amortized_queue__enqueue__result8 () us_rep2)

(declare-fun result6 () Bool)

(define-fun o19 () us_rep (mk___rep (mk___split_discrs o2)
                          (mk___split_fields o3)))

(define-fun o20 () us_rep (mk___rep (mk___split_discrs o)
...
;; H
  (assert
  (= amortized_queue__enqueue__result5 (mk_queue__ref
                                       amortized_queue__enqueue__result4)))
...
;; H
  (assert
  (= amortized_queue__enqueue__result6 amortized_queue__enqueue__result4))
...
;; H
  (assert
  (and
  (= o20 (copy (rec__amortized_queue__queue__front (us_split_fields3 q))
         1000))
  (and
  (= (oeq1 (model__ o20)
...
;; H
  ...
  (= result5 (mk_queue__ref
             (mk___rep1
             (mk___split_fields1
             (mk___rep (mk___split_discrs amortized_queue__enqueue__result)
             (mk___split_fields amortized_queue__enqueue__result1))
             (mk___rep (mk___split_discrs amortized_queue__enqueue__result2)
             (mk___split_fields amortized_queue__enqueue__result3)))))))

;; H
  (assert
  (= amortized_queue__enqueue__result4 (mk___rep1 result____split_fields7)))

;; H
  (assert
  (= amortized_queue__enqueue__result7 amortized_queue__enqueue__result5))
...
;; H
  (assert
  (= amortized_queue__enqueue__result8 amortized_queue__enqueue__result6))
...
;; H
  (assert
  (and
  (and (= result6 (inv (queue__content amortized_queue__enqueue__result7)))
  (inv__function_guard result6
  (queue__content amortized_queue__enqueue__result7)))
  (= (= result6 true)
  (and
  (and
  (<= (length
      (rec__amortized_queue__queue__rear
      (us_split_fields3 (queue__content amortized_queue__enqueue__result7)))) 
  (length
  (rec__amortized_queue__queue__front
  (us_split_fields3 (queue__content amortized_queue__enqueue__result7)))))
  (<= (length
...
;; H
  (assert (is_model__function_guard
  (is_model (queue__content amortized_queue__enqueue__result7) o18)
  (queue__content amortized_queue__enqueue__result7) o18))

;; H
  (assert
  (and
  (and (= o18 (model__1 (queue__content amortized_queue__enqueue__result7)))
  (model____function_guard1 o18
  (queue__content amortized_queue__enqueue__result7)))
  (= (is_model (queue__content amortized_queue__enqueue__result7) o18) true)))
