...
;; H
  (assert
  (and (and (= o4 (value Tuple0)) (value__function_guard o4 Tuple0))
  (in_range o4)))
...
;; H
  (assert
  (and (and (= o5 (value Tuple0)) (value__function_guard o5 Tuple0))
  (in_range o5)))
...
;; H
  (assert
  (and (and (= o6 (value Tuple0)) (value__function_guard o6 Tuple0))
  (in_range o6)))
...
;; H
  (assert
  (and (and (= o7 (value Tuple0)) (value__function_guard o7 Tuple0))
  (in_range o7)))
...
;; H
  (assert (g4__function_guard (g4 Tuple0) Tuple0))
