...
(declare-fun temperature () t)

(declare-fun pressure () t)

(declare-fun asl () t)

(declare-fun asl_raw () t)

(declare-fun asl_long () t)

(declare-fun asl_err_deadband () t)

(declare-fun asl_alpha () t)

(declare-fun asl_alpha_long () t)

(declare-fun asl_tmp () t)

(declare-fun asl_long_tmp () t)
...
;; H
  (assert (tqtisFinite temperature))

;; H
  (assert (tqtisFinite pressure))

;; H
  (assert (tqtisFinite asl))

;; H
  (assert (tqtisFinite asl_raw))

;; H
  (assert (tqtisFinite asl_long))

;; H
  (assert (tqtisFinite asl_err_deadband))

;; H
  (assert (tqtisFinite asl_alpha))

;; H
  (assert (tqtisFinite asl_alpha_long))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite asl_tmp)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite asl_long_tmp)))

;; H
  (assert
  (and (= o (sub RNE2 fliteral asl_alpha)) (tqtisFinite
  (sub RNE2 fliteral asl_alpha))))

;; H
  (assert (= o1 (mul RNE2 asl_raw o)))
...
;; H
  (assert
  (and (= o3 (mul RNE2 asl asl_alpha)) (tqtisFinite
  (mul RNE2 asl asl_alpha))))

;; H
  (assert (= o4 (add RNE2 o3 o2)))
