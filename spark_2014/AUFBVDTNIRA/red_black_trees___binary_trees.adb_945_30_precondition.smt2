...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2822 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= (mk___rep (mk___split_fields o5 o6)) (select temp___2822 v)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2818 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___2818 o)))
