...
;; H
  (assert
  (and (and (= o (pow21 iter2)) (pow2__function_guard o iter2))
  (= o (ite (< iter2 4294967296)
       (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) iter2)) ((_ int2bv 32) 0)))))

;; H
  (assert (= o1 (bvurem ((_ int2bv 32) exp) o)))
