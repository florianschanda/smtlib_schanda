...
(declare-fun float_example__minus_i__result () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun float_example__minus_i__result1 () t)

(declare-fun float_example__minus_i__result2 () t)

(declare-fun float_example__minus_i__result3 () t)

(declare-fun float_example__minus_i__result4 () t)

(declare-fun float_example__minus_i__result5 () t)
...
;; H
  (assert (and (= o (sub RNE2 a b)) (tqtisFinite (sub RNE2 a b))))

;; H
  (assert (= (mk_t__ref result) (mk_t__ref float_example__minus_i__result)))
...
;; H
  (assert
  (= (mk_t__ref float_example__minus_i__result4) (mk_t__ref
                                                 float_example__minus_i__result2)))
...
;; H
  (assert (= result1 float_example__minus_i__result4))

(assert
;; WP_parameter_def
 ;; File "float_example.adb", line 5, characters 0-0
  (not (eq float_example__minus_i__result4 (add RNE2 a b))))
(check-sat)
