...
;; H
  ...
  (= (bool_eq1 (select p__split_fields3 c) d) true)))))
...
;; H
  (assert
  (= (mk___split_fields1 p__split_fields6 p__split_fields7) (mk___split_fields1
                                                            p__split_fields2
                                                            p__split_fields3)))
...
;; WP_parameter_def
 ;; File "p.ads", line 26, characters 0-0
  (not (= (bool_eq1 (select p__split_fields5 c) d) true)))
(check-sat)
