...
;; H
  (assert (remove__function_guard (remove bb2 o3) bb2 o3))
...
;; H
  (assert (is_perm__function_guard (is_perm (remove bb2 o3) (remove aa o4))
  (remove bb2 o3) (remove aa o4)))
...
;; H
  (assert
  (and
  (and (= o4 (get_witness bb2 aa o3)) (get_witness__function_guard o4 
  bb2 aa o3))
  (and (in_range3 o4)
  (and
...
;; H
  (assert
  (and
  (and (= o5 (remove_swap b ib2 ib)) (remove_swap__function_guard o5 
  b ib2 ib))
  (and (in_range2 o5)
  (=> (= (of_int o5) true)
...
;; H
  (assert
  (and (and (= o11 (remove bb ib2)) (remove__function_guard o11 bb ib2))
  (and (dynamic_invariant2 o11 true false true)
  (and (= (invariant__ o11) true)
  (and (= (to_rep1 (last o10)) (- (to_rep1 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib2 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select o9 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib2 1) k) (<= k (to_rep1 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select o9 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib2 k) (<= k (- (to_rep1 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o9 k))))))))))))
...
;; H
  (assert
  (and (and (= o12 (remove aa ia21)) (remove__function_guard o12 aa ia21))
