...
;; H
  (assert
  (and (= o26 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o26 ((_ int2bv 32) 1))))
...
;; H
  (assert
  (and (= o24 (num_of_big_int m m_first o23)) (num_of_big_int__function_guard
  o24 m m_first o23)))
...
;; H
  (assert
  (and (= o25 (omultiply o19 o24)) (omultiply__function_guard o25 o19 o24)))

;; H
  (assert
  (and (= o27 (osubtract o25 o26)) (osubtract__function_guard o27 o25 o26)))

;; H
  (assert
  (and (= o16 (from_word32 a_msw2)) (from_word32__function_guard o16 a_msw2)))
...
;; H
  (assert
  (and (and (= o10 (base Tuple0)) (base__function_guard o10 Tuple0))
  (= o10 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o15 (oexpon o10 o14)) (oexpon__function_guard o15 o10 o14)))
...
;; H
  ...
  (= o9 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last)))
        a_first o8))
  (num_of_big_int__function_guard o9
  (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first o8)))

;; H
  (assert (and (= o18 (oadd o9 o17)) (oadd__function_guard o18 o9 o17)))

;; H
  (assert (and (= o28 (olt o18 o27)) (olt__function_guard o28 o18 o27)))
...
;; H
  (assert
  (and (= o4 (num_of_big_int m m_first o3)) (num_of_big_int__function_guard
  o4 m m_first o3)))
