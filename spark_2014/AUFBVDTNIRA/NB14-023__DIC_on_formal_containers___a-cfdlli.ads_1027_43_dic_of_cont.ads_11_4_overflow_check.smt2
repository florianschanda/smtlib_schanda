...
(declare-fun temp___1743 () count_type)
...
;; H
  (assert (= temp___1743 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___1743)) no_element))
...
;; H
  ...
  (and (in_range1 o2)
  (<= o2 (to_rep
         (rec__dic_of_cont__my_dlli__list__capacity target__split_discrs))))))
