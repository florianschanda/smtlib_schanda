...
(declare-fun o8 () us_split_fields20)

(declare-fun temp___1002 () us_rep10)
...
(declare-fun pbestvalley__split_discrs1 () us_split_discrs2)
...
;; H
  (assert
  (and
  (not (= (oeq (mk___rep1 disttogoal__split_fields) zero_position) true)) (lt
  (to_rep3
  (rec__robot_iface__proxy__robot_radius
  (us_split_fields9
  (rec__algorithm__controller__robot
...
;; H
  (assert
  (and
  (and (= o4 (norm (mk___rep1 disttogoal__split_fields)))
  (norm__function_guard o4 (mk___rep1 disttogoal__split_fields)))
  (and (tqtisFinite o4)
  (and (le fliteral2 o4)
  (=> (lt fliteral2 o4)
...
;; H
  (assert
  (and (= o3 (bearing (mk___rep1 disttogoal__split_fields)))
  (bearing__function_guard o3 (mk___rep1 disttogoal__split_fields))))

;; H
  (assert
  (and
  (= result2 (isfilterclear
             (rec__algorithm__controller__laserscan
             (let ((subject this__split_fields)) this__split_fields1)) 
             o3
             (to_rep3
             ...
             (let ((subject this__split_fields)) this__split_fields1))))) 
             o6 (of_int1 0)))
  (isfilterclear__function_guard result2
  (rec__algorithm__controller__laserscan
  (let ((subject this__split_fields)) this__split_fields1)) o3
  (to_rep3
  (rec__robot_iface__proxy__min_gap_width
  (us_split_fields9
  (rec__algorithm__controller__robot
  (let ((subject this__split_fields)) this__split_fields1))))) o6
  (of_int1 0))))
...
;; H
  ...
  (= (to_rep10
     (rec__algorithm__valley_option__opt
     (let ((subject pbestvalley__split_discrs)) pbestvalley__split_discrs1))) 0))

;; H
  (assert
  (and (= o7 (create__2 fliteral4)) (create__2__function_guard o7 fliteral4)))

;; H
  (assert
  (= o8 (mk___split_fields10
        (rec__algorithm__controller__robot
        (let ((subject this__split_fields)) this__split_fields1))
        (rec__algorithm__controller__laserscan
        (let ((subject this__split_fields)) this__split_fields1))
        ...
        (let ((subject this__split_fields)) this__split_fields1))
        (rec__algorithm__controller__obsavoiddelta
        (let ((subject this__split_fields)) this__split_fields1)) o7)))

;; H
  (assert (= temp___1002 (mk___rep10 o8)))
