...
;; H
  (assert (and (= us current2) (dynamic_property1 first1 last1 current2)))
...
;; H
  (assert (= use_vectors__my_find__result1 use_vectors__my_find__result))

;; H
  (assert (not (= current2 r27b)))

;; H
  (assert (= result3 current2))
