...
(define-fun dynamic_invariant4 ((temp___expr_820 us_rep1)
...
(define-fun dynamic_invariant5 ((temp___expr_832 us_rep2)
...
;; H
  (assert (= temp___1527 (- o5 2)))

;; H
  (assert
  (and (<= (to_rep2 (first2 u__split_fields1)) temp___1527)
  (<= temp___1527 (to_rep2 (last5 u__split_fields1)))))

;; H
  (assert (= o6 temp___1527))
...
;; H
  (assert (= temp___1525 (- o 1)))

;; H
  (assert
  (and (<= (to_rep2 (first2 u__split_fields1)) temp___1525)
  (<= temp___1525 (to_rep2 (last5 u__split_fields1)))))

;; H
  (assert (= o1 temp___1525))
...
;; H
  ...
  (<= (- n 1) (to_rep2 (last8 v__split_fields1)))))
...
;; H
  (assert (= temp___1535 (- o22 3)))

;; H
  (assert
  (and (<= (to_rep2 (first2 u__split_fields1)) temp___1535)
  (<= temp___1535 (to_rep2 (last5 u__split_fields1)))))

;; H
  (assert (= o23 temp___1535))
...
;; H
  (assert (= o27 (bvadd (bvmul ((_ int2bv 16) 256) r_hat1) o26)))

(assert
;; WP_parameter_def
 ;; File "aco-math-very_longs.adb", line 398, characters 0-0
  (not (<= (to_rep2 (first4 v__split_fields1)) (- n 2))))
(check-sat)
