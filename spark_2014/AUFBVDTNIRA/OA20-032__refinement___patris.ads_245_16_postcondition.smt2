...
(declare-fun o19 () (Array Int (Array Int cell)))

(declare-fun temp___2203 () (Array Int (Array Int cell)))

(declare-fun temp___2198 () (Array Int (Array Int cell)))

(declare-fun o20 () cell)

(declare-fun o21 () Int)

(declare-fun o22 () (Array Int cell))

(declare-fun o23 () Int)

(declare-fun o24 () (Array Int (Array Int cell)))

(declare-fun temp___2226 () (Array Int (Array Int cell)))

(declare-fun temp___2221 () (Array Int (Array Int cell)))

(declare-fun o25 () Int)

(declare-fun temp___2217 () map1)

(declare-fun o26 () cell)

(declare-fun o27 () Int)

(declare-fun o28 () (Array Int cell))

(declare-fun o29 () Int)

(declare-fun o30 () (Array Int (Array Int cell)))
...
(declare-fun result6 () (Array Int (Array Int cell)))

(declare-fun cur_board8 () (Array Int (Array Int cell)))

(declare-fun cur_board9 () map__ref1)
...
(declare-fun cur_board17 () (Array Int (Array Int cell)))
...
(declare-fun cur_board19 () (Array Int (Array Int cell)))

(declare-fun cur_board20 () map__ref1)

(declare-fun x18 () int__ref)

(declare-fun cur_board21 () (Array Int (Array Int cell)))

(declare-fun x19 () Int)

(declare-fun cur_board22 () map__ref1)

(declare-fun x20 () int__ref)

(declare-fun cur_board23 () (Array Int (Array Int cell)))

(declare-fun x21 () Int)

(declare-fun cur_board24 () map__ref1)

(declare-fun y12 () int__ref)

(declare-fun x22 () int__ref)

(declare-fun cur_board25 () (Array Int (Array Int cell)))

(declare-fun y13 () Int)

(declare-fun x23 () Int)

(declare-fun cur_board26 () map__ref1)

(declare-fun y14 () int__ref)

(declare-fun x24 () int__ref)

(declare-fun cur_board27 () (Array Int (Array Int cell)))

(declare-fun y15 () Int)

(declare-fun x25 () Int)

(declare-fun cur_board28 () map__ref1)

(declare-fun y16 () int__ref)

(declare-fun x26 () int__ref)

(declare-fun y17 () int__ref)

(declare-fun x27 () int__ref)

(declare-fun cur_board29 () (Array Int (Array Int cell)))
...
(declare-fun cur_board30 () map__ref1)

(declare-fun y20 () int__ref)

(declare-fun x30 () int__ref)

(declare-fun y21 () int__ref)

(declare-fun x31 () int__ref)

(declare-fun cur_board31 () (Array Int (Array Int cell)))
...
(declare-fun cur_board32 () map__ref1)

(declare-fun cur_state2 () int__ref)

(declare-fun y24 () int__ref)

(declare-fun x34 () int__ref)

(declare-fun y25 () int__ref)

(declare-fun x35 () int__ref)

(declare-fun cur_board33 () (Array Int (Array Int cell)))
...
(define-fun x38 () int__ref (mk_int__ref x1))

(define-fun y28 () int__ref (mk_int__ref y1))

(define-fun x39 () int__ref (mk_int__ref x))

(define-fun y29 () int__ref (mk_int__ref y))

(define-fun cur_board34 () map__ref1 (mk_map__ref1 cur_board))
...
;; H
  (assert
  (forall ((yy Int) (xx Int)) (is_empty__function_guard
...
;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= o1 (to_rep2 cur_piece__split_fields2))))
...
;; H
  ...
  (<= (to_rep3 cur_piece__split_fields3) 20))))

;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= o3 (to_rep3 cur_piece__split_fields3))))

;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2) (= o4 (store cur_board o3 o2))))

;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= (mk_map__ref1 result) cur_board34)))
...
;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= (to_rep o5) (to_rep1 cur_piece__split_fields))))
...
;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= o6 (to_rep2 cur_piece__split_fields2))))

;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= o7 (store (select cur_board2 (+ (to_rep3 cur_piece__split_fields3) 1)) 
  o6 o5))))
...
;; H
  ...
  (<= (+ (to_rep3 cur_piece__split_fields3) 1) 20))))

;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= o8 (+ (to_rep3 cur_piece__split_fields3) 1))))

;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= o9 (store cur_board2 o8 o7))))

;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2) (= cur_board2 result1)))
...
;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= (to_rep o10) (to_rep1 cur_piece__split_fields))))
...
;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= o11 (+ (to_rep2 cur_piece__split_fields2) 1))))

;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= o12 (store (select cur_board3 (to_rep3 cur_piece__split_fields3)) 
  o11 o10))))
...
;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= o13 (to_rep3 cur_piece__split_fields3))))

;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= o14 (store cur_board3 o13 o12))))

;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2) (= cur_board3 result2)))
...
;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= (to_rep o15) (to_rep1 cur_piece__split_fields))))
...
;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= o16 (+ (to_rep2 cur_piece__split_fields2) 1))))

;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= o17 (store (select cur_board4 (+ (to_rep3 cur_piece__split_fields3) 1)) 
  o16 o15))))
...
;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= o18 (+ (to_rep3 cur_piece__split_fields3) 1))))

;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= o19 (store cur_board4 o18 o17))))

;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2) (= result3 cur_board4)))

;; H
  (assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= cur_board5 o19)))

;; H
  (assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= x31 x38)))

;; H
  (assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= y21 y28)))

;; H
  (assert (=> (= (to_rep1 cur_piece__split_fields) 2) (= x30 x39)))
...
;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2)
  (= cur_board30 (mk_map__ref1 cur_board5))))
...
;; H
  (assert
  (=> (= (to_rep1 cur_piece__split_fields) 2) (= cur_board31 cur_board5)))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (forall ((yy Int))
  (=> (and (<= 0 yy) (<= yy 3))
  (forall ((xx Int))
  (=> (and (<= 0 xx) (<= xx 3))
...
;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1) (= (mk_int__ref result4) y29))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1) (= y4 0))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3)) (= temp___2203 cur_board)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3)) (and (<= 0 y5) (<= y5 3))))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3)) (= x4 result5)))))
...
;; H
  ...
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3))
  (=> (and (<= 0 x5) (<= x5 3)) (= temp___2198 cur_board6))))))
...
;; H
  ...
  (=> (and (<= 0 x5) (<= x5 3))
  (and
  (forall ((temp___2199 Int))
  (=> (and (<= 1 temp___2199) (<= temp___2199 20))
  (=> (not (= (+ (to_rep3 cur_piece__split_fields3) y5) temp___2199))
  (= (select cur_board7 temp___2199) (select temp___2198 temp___2199)))))
  (and (<= 0 x6) (<= x6 3))))))))
...
;; H
  ...
  (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) 
     y5 x6) true)
  (= (to_rep o20) (to_rep1 cur_piece__split_fields))))))))
...
;; H
  ...
  (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) 
     y5 x6) true)
  (and (<= 1 (+ (to_rep2 cur_piece__split_fields2) x6))
  (<= (+ (to_rep2 cur_piece__split_fields2) x6) 10))))))))
...
;; H
  ...
  (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) 
     y5 x6) true)
  (= o21 (+ (to_rep2 cur_piece__split_fields2) x6))))))))
...
;; H
  ...
  (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) 
     y5 x6) true)
  (= o22 (store (select cur_board7 (+ (to_rep3 cur_piece__split_fields3) 
  y5)) o21 o20))))))))
...
;; H
  ...
  (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) 
     y5 x6) true)
  (and (<= 1 (+ (to_rep3 cur_piece__split_fields3) y5))
  (<= (+ (to_rep3 cur_piece__split_fields3) y5) 20))))))))
...
;; H
  ...
  (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) 
     y5 x6) true)
  (= o23 (+ (to_rep3 cur_piece__split_fields3) y5))))))))
...
;; H
  ...
  (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) 
     y5 x6) true))
  (= cur_board8 cur_board7)))))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (= x6 3))))))
...
;; H
  ...
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3))
  (=> (and (<= 0 x5) (<= x5 3)) (= x7 (mk_int__ref x6)))))))
...
;; H
  ...
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3))
  (=> (and (<= 0 x5) (<= x5 3)) (= cur_board9 (mk_map__ref1 cur_board8)))))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (= x8 x6))))))
...
;; H
  ...
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3))
  (=> (and (<= 0 x5) (<= x5 3)) (= cur_board10 cur_board8))))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (= x9 x7))))))
...
;; H
  ...
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3))
  (=> (and (<= 0 x5) (<= x5 3)) (= cur_board11 cur_board9))))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3)) (=> (and (<= 0 x5) (<= x5 3)) (= x10 x8))))))
...
;; H
  ...
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3))
  (=> (and (<= 0 x5) (<= x5 3)) (= cur_board12 cur_board10))))))
...
;; H
  ...
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3))
  (=> (not (and (<= 0 x5) (<= x5 3))) (= x9 (mk_int__ref x5)))))))
...
;; H
  ...
  (=> (and (<= 0 y4) (<= y4 3))
  (=> (not (and (<= 0 x5) (<= x5 3)))
  (= cur_board11 (mk_map__ref1 cur_board6)))))))
...
;; H
  ...
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3))
  (=> (not (and (<= 0 x5) (<= x5 3))) (= cur_board12 cur_board6))))))
...
;; H
  ...
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3)) (= x11 x9)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3)) (= y6 (mk_int__ref y5))))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3)) (= cur_board13 cur_board11)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3)) (= x12 x10)))))
...
;; H
  ...
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3)) (= cur_board14 cur_board12)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3)) (= x13 x11)))))
...
;; H
  ...
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3)) (= cur_board15 cur_board13)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3)) (= x14 x12)))))
...
;; H
  ...
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (and (<= 0 y4) (<= y4 3)) (= cur_board16 cur_board14)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (not (and (<= 0 y4) (<= y4 3))) (= x13 x39)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (not (and (<= 0 y4) (<= y4 3))) (= y8 (mk_int__ref y4))))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (not (and (<= 0 y4) (<= y4 3))) (= cur_board15 cur_board34)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (not (and (<= 0 y4) (<= y4 3))) (= x14 x2)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (not (and (<= 0 y4) (<= y4 3))) (= y9 y4)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1)
  (=> (not (and (<= 0 y4) (<= y4 3))) (= cur_board16 cur_board1)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1) (= x27 x38))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1) (= y17 y28))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1) (= x26 x13))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1) (= y16 y8))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1) (= cur_board28 cur_board15))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1) (= x29 x3))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1) (= y19 y3))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1) (= x28 x14))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1) (= y18 y9))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (= (to_rep1 cur_piece__split_fields) 1) (= cur_board29 cur_board16))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (forall ((yy Int))
  (=> (and (<= 0 yy) (<= yy 2))
  (forall ((xx Int))
  (=> (and (<= 0 xx) (<= xx 2))
...
;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= result7 y28))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= y10 0))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (= temp___2226 cur_board)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (and (<= 0 y11) (<= y11 2))))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (= result8 (mk_int__ref x15))))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (= x16 0)))))
...
;; H
  ...
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (and (<= 0 x16) (<= x16 2)) (= temp___2221 cur_board17))))))
...
;; H
  ...
  (=> (and (<= 0 x16) (<= x16 2))
  (and
  (forall ((temp___2222 Int))
  (=> (and (<= 1 temp___2222) (<= temp___2222 20))
  (=> (not (= (+ (to_rep3 cur_piece__split_fields3) y11) temp___2222))
  (= (select cur_board18 temp___2222) (select temp___2221 temp___2222)))))
  (and (<= 0 x17) (<= x17 2))))))))
...
;; H
  ...
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (and (<= 0 x16) (<= x16 2)) (= o25 (to_rep1 cur_piece__split_fields)))))))
...
;; H
  ...
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (and (<= 0 x16) (<= x16 2))
  (= temp___2217 (get1 possible_three_shapes o25
...
;; H
  ...
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (and (<= 0 x16) (<= x16 2)) (= result9 (get temp___2217 y11 x17)))))))
...
;; H
  ...
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (and (<= 0 x16) (<= x16 2))
  (=> (= result9 true) (= (to_rep o26) (to_rep1 cur_piece__split_fields))))))))
...
;; H
  ...
  (=> (and (<= 0 x16) (<= x16 2))
  (=> (= result9 true)
  (and (<= 1 (+ (to_rep2 cur_piece__split_fields2) x17))
  (<= (+ (to_rep2 cur_piece__split_fields2) x17) 10))))))))
...
;; H
  ...
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (and (<= 0 x16) (<= x16 2))
  (=> (= result9 true) (= o27 (+ (to_rep2 cur_piece__split_fields2) x17))))))))
...
;; H
  ...
  (=> (and (<= 0 x16) (<= x16 2))
  (=> (= result9 true)
  (= o28 (store (select cur_board18 (+ (to_rep3 cur_piece__split_fields3) 
  y11)) o27 o26))))))))
...
;; H
  ...
  (=> (and (<= 0 x16) (<= x16 2))
  (=> (= result9 true)
  (and (<= 1 (+ (to_rep3 cur_piece__split_fields3) y11))
  (<= (+ (to_rep3 cur_piece__split_fields3) y11) 20))))))))
...
;; H
  ...
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (and (<= 0 x16) (<= x16 2))
  (=> (= result9 true) (= o29 (+ (to_rep3 cur_piece__split_fields3) y11))))))))
...
;; H
  ...
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (and (<= 0 x16) (<= x16 2))
  (=> (= result9 true) (= o30 (store cur_board18 o29 o28))))))))
...
;; H
  ...
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (and (<= 0 x16) (<= x16 2))
  (=> (= result9 true) (= result10 (mk_map__ref1 cur_board18))))))))
...
;; H
  ...
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (and (<= 0 x16) (<= x16 2)) (=> (= result9 true) (= cur_board19 o30)))))))
...
;; H
  ...
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (and (<= 0 x16) (<= x16 2))
  (=> (not (= result9 true)) (= cur_board19 cur_board18)))))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (=> (and (<= 0 x16) (<= x16 2)) (= x17 2))))))
...
;; H
  ...
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (and (<= 0 x16) (<= x16 2)) (= x18 (mk_int__ref x17)))))))
...
;; H
  ...
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (and (<= 0 x16) (<= x16 2)) (= cur_board20 (mk_map__ref1 cur_board19)))))))
...
;; H
  ...
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (and (<= 0 x16) (<= x16 2)) (= cur_board21 cur_board19))))))
...
;; H
  ...
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (and (<= 0 x16) (<= x16 2)) (= cur_board22 cur_board20))))))
...
;; H
  ...
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (and (<= 0 x16) (<= x16 2)) (= cur_board23 cur_board21))))))
...
;; H
  ...
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (not (and (<= 0 x16) (<= x16 2))) (= x20 (mk_int__ref x16)))))))
...
;; H
  ...
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (not (and (<= 0 x16) (<= x16 2)))
  (= cur_board22 (mk_map__ref1 cur_board17)))))))
...
;; H
  ...
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2))
  (=> (not (and (<= 0 x16) (<= x16 2))) (= cur_board23 cur_board17))))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (= y11 2)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (= x22 x20)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (= y12 (mk_int__ref y11))))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (= cur_board24 cur_board22)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (= x23 x21)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (= y13 y11)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (= cur_board25 cur_board23)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (= x24 x22)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (= y14 y12)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (= cur_board26 cur_board24)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (= x25 x23)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (= y15 y13)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (and (<= 0 y10) (<= y10 2)) (= cur_board27 cur_board25)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (not (and (<= 0 y10) (<= y10 2))) (= x24 x38)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (not (and (<= 0 y10) (<= y10 2))) (= y14 (mk_int__ref y10))))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (not (and (<= 0 y10) (<= y10 2))) (= cur_board26 cur_board34)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (not (and (<= 0 y10) (<= y10 2))) (= x25 x3)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (not (and (<= 0 y10) (<= y10 2))) (= y15 y10)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (=> (not (and (<= 0 y10) (<= y10 2))) (= cur_board27 cur_board1)))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= x27 x24))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= y17 y14))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= x26 x39))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= y16 y29))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (= cur_board28 cur_board26))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= x29 x25))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= y19 y15))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= x28 x2))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1)) (= y18 y2))))

;; H
  (assert
  (=> (not (= (to_rep1 cur_piece__split_fields) 2))
  (=> (not (= (to_rep1 cur_piece__split_fields) 1))
  (= cur_board29 cur_board27))))
...
;; H
  (assert (get_state__function_guard (get_state (int__content cur_state2))
  (int__content cur_state2)))

(assert
;; WP_parameter_def
 ;; File "patris.ads", line 196, characters 0-0
  (not (= (get_state (int__content cur_state2)) 2)))
(check-sat)
