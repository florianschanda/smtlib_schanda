...
;; H
  (assert (=> (<= 1 43) (= o2 (+ (- 43 1) 1))))

;; H
  (assert (=> (not (<= 1 43)) (= o2 0)))
...
;; H
  (assert (= (mk 1 o6) keystore__dofind__B74b__thestring__assume1))
...
;; H
  (assert (and (= o7 (length thestring)) (in_range1 (length thestring))))

;; H
  (assert (= result4 (ite (<= o7 150) true false)))
