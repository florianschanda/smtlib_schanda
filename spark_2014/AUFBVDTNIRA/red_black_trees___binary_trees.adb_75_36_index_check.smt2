...
(define-fun type_invariant ((temp___281 us_rep1)) Bool (= (tree_structure
                                                          temp___281) true))
...
;; size__post_axiom
  (assert
  (forall ((f1 us_rep1))
  (! (=> (type_invariant f1) (dynamic_invariant (size f1) true false true)) :pattern (
  (size f1)) )))
...
(define-fun default_initial_assumption1 ((temp___expr_259 us_rep)
...
(define-fun default_initial_assumption2 ((temp___expr_266 (Array Int us_rep))
...
;; H
  ...
  (=>
  (and
  (<= (+ (to_rep (rec__binary_trees__forest__s (us_split_fields3 f))) 1) i1)
  (<= i1 100))
  (= (bool_eq3
     (select (rec__binary_trees__forest__c (us_split_fields3 f)) i1)
     (mk___rep
     (mk___split_fields (of_rep 0) (of_rep 0) (of_rep 0) (of_rep1 2)))) true)))))
...
;; H
  ...
  (<= (to_rep
      ...
      (us_split_fields1
      (select (rec__binary_trees__forest__c (us_split_fields3 f)) i1)))) 
  (to_rep (rec__binary_trees__forest__s (us_split_fields3 f))))))))))
...
;; H
  ...
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields1
     (select (rec__binary_trees__forest__c (us_split_fields3 f)) i1)))) 2)
  (= (to_rep
     (rec__binary_trees__cell__parent
     (us_split_fields1
     (select (rec__binary_trees__forest__c (us_split_fields3 f)) i1)))) 0)))))))
...
;; H
  ...
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields1
     (select (rec__binary_trees__forest__c (us_split_fields3 f)) (to_rep
                                                                 (rec__binary_trees__cell__left
                                                                 (us_split_fields1
                                                                 (select 
                                                                 (rec__binary_trees__forest__c
...
(assert
;; WP_parameter_def
 ;; File "binary_trees.ads", line 426, characters 0-0
  (not
  (<= 1 (to_rep
        (rec__binary_trees__cell__parent
        (us_split_fields1
