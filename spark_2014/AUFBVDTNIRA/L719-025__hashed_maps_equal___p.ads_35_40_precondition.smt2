...
;; H
  ...
  (my_eq
  (key (mk___rep l__split_discrs (mk___split_fields l__split_fields)) o6) 
  k) (key (mk___rep l__split_discrs (mk___split_fields l__split_fields)) o6)
  k))

;; H
  (assert (my_eq__function_guard
  (my_eq
  (key (mk___rep l__split_discrs (mk___split_fields l__split_fields3)) o5) 
  k) (key (mk___rep l__split_discrs (mk___split_fields l__split_fields3)) o5)
  k))

;; H
  (assert
  (and
  (= o6 (find (mk___rep l__split_discrs (mk___split_fields l__split_fields))
        k))
  (ite (ite (= (has_key1
               (model__
               (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
...
;; H
  (assert
  (and
  (= o5 (find (mk___rep l__split_discrs (mk___split_fields l__split_fields3))
        k))
  (ite (ite (= (has_key1
               (model__
               (mk___rep l__split_discrs
               (mk___split_fields l__split_fields3))) k) false) true false)
  (= (bool_eq5 o5 no_element) true)
  (and
  (and
  (= (has_key
     (positions
