...
(declare-fun keccak__keccak_1600__sponge__absorb__R75s__assume () Int)
...
;; H
  (assert
  (and (= o10 (+ block_offset1 remaining_bytes1)) (in_range1
  (+ block_offset1 remaining_bytes1))))
...
;; H
  (assert
  (=> (<= (to_rep1 (first (rt data))) r78s)
  (and
  (and (<= (to_rep1 (first (rt data))) (to_rep1 (first (rt data))))
  (<= (to_rep1 (first (rt data))) (to_rep1 (last (rt data)))))
  (and (<= (to_rep1 (first (rt data))) r78s)
  (<= r78s (to_rep1 (last (rt data))))))))

;; H
  (assert (= o11 (elts data)))

;; H
  (assert (= o11 temp___918))

;; H
  (assert (= (mk2 (to_rep1 (first (rt data))) r78s) temp___9181))
