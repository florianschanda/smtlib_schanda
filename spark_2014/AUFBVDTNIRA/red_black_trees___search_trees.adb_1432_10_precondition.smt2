...
(declare-fun o14 () us_split_fields6)
...
(declare-fun result10 () us_split_fields__ref3)
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             (rec__search_trees__search_tree__struct t__split_fields5)
             (to_rep1
             (rec__search_trees__search_tree__root t__split_fields5))) i10))) true)
  (=>
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct t__split_fields5)
             (to_rep1
             (rec__search_trees__search_tree__root t__split_fields5))) i10)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct t__split_fields5)
  ...
  (ite (= (get
          ...
          (+ (length
             ...
             (select (model__
                     ...
                     t__split_fields5)
                     (to_rep1
                     (rec__search_trees__search_tree__root t__split_fields5))) i10)))) 1)) 0)
  (< v (to_rep
       (select (rec__search_trees__search_tree__values t__split_fields5) i10)))
  (< (to_rep
     (select (rec__search_trees__search_tree__values t__split_fields5) i10)) 
  v))))))))
...
;; H
  (assert
  (and (= o8 (int__content previous6)) (in_range3 (int__content previous6))))
...
;; H
  (assert (model____function_guard
  (model__ (mk___rep2 binary_trees__insert__f__fields) o9)
  (mk___rep2 binary_trees__insert__f__fields) o9))

;; H
  (assert (peek__function_guard
  (peek (mk___rep2 binary_trees__insert__f__fields) o10 (int__content d7))
  (mk___rep2 binary_trees__insert__f__fields) o10 (int__content d7)))

;; H
  (assert
  (forall ((i10 Int)) (valid_root__function_guard
  (valid_root
  (mk___rep2
  (us_split_fields5
  (rec__search_trees__search_tree__struct t__split_fields5))) i10)
  (mk___rep2
  (us_split_fields5
  (rec__search_trees__search_tree__struct t__split_fields5))) i10)))
...
;; H
  (assert
  (forall ((i10 Int)) (valid_root__function_guard
  (valid_root (mk___rep2 binary_trees__insert__f__fields) i10)
  (mk___rep2 binary_trees__insert__f__fields) i10)))
...
;; H
  ...
  (mk___rep2
  (us_split_fields5
  (rec__search_trees__search_tree__struct t__split_fields5))) o9)
  (mk___rep2
  (us_split_fields5
  (rec__search_trees__search_tree__struct t__split_fields5))) o9))
...
;; H
  ...
  (mk___rep2
  (us_split_fields5
  (rec__search_trees__search_tree__struct t__split_fields5))) j e)
  (mk___rep2
  (us_split_fields5
  (rec__search_trees__search_tree__struct t__split_fields5))) j e)))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__ (mk___rep2 binary_trees__insert__f__fields) o9) o10)))
  (int__content d7)
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__ (mk___rep2 binary_trees__insert__f__fields) o9) binary_trees__insert__v))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__ (mk___rep2 binary_trees__insert__f__fields) o9) o10)))
  (int__content d7)
...
;; H
  (assert
  (forall ((i10 Int)) (model____function_guard
  (model__ (mk___rep2 binary_trees__insert__f__fields) i10)
  (mk___rep2 binary_trees__insert__f__fields) i10)))
...
;; H
  (assert
  (forall ((i10 Int)) (oeq__function_guard2
  (oeq2 (model__ (mk___rep2 binary_trees__insert__f__fields) i10)
  (model__
  (mk___rep2
  (us_split_fields5
  (rec__search_trees__search_tree__struct t__split_fields5))) i10))
...
;; H
  (assert
  (and (= o10 (int__content previous6)) (in_range3 (int__content previous6))))

;; H
  (assert
  (and
  (= o9 (to_rep1 (rec__search_trees__search_tree__root t__split_fields5)))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root t__split_fields5)))))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__insert__f__fields) o9) 
     o10))) true)
  (and
  (= (peek (mk___rep2 binary_trees__insert__f__fields) o10 (int__content d7)) 
  ...
  (ite (= (valid_root
          (mk___rep2
          (us_split_fields5
          (rec__search_trees__search_tree__struct t__split_fields5))) i10) true)
  (= (valid_root (mk___rep2 binary_trees__insert__f__fields) i10) true)
  (not (= (valid_root (mk___rep2 binary_trees__insert__f__fields) i10) true)))))
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__insert__f__fields) o9) 
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             ...
             (us_split_fields5
             (rec__search_trees__search_tree__struct t__split_fields5))) 
             o9) binary_trees__insert__v))) true))
  (and
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j 100))
  ...
  (= (parent
     (mk___rep2
     (us_split_fields5
     (rec__search_trees__search_tree__struct t__split_fields5))) j) 0)))
  ...
  (forall ((e Int))
  (=> (and (<= 0 e) (<= e 1))
  (=> (or (not (= j o10)) (not (= e (int__content d7))))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__insert__f__fields) o9) j))) true)
  (or
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__insert__f__fields) o9) j)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (mk___rep2
...
;; H
  (assert
  (= o13 (store (rec__search_trees__search_tree__values t__split_fields6) 
  o12 o11)))

;; H
  (assert
  (= o14 (mk___split_fields3
         (rec__search_trees__search_tree__root t__split_fields6)
         (rec__search_trees__search_tree__struct t__split_fields6) o13)))

;; H
  (assert (= temp___1366 (mk___rep3 o14)))

;; H
  (assert (= result12 (mk___split_fields__ref3 t__split_fields6)))

;; H
  (assert (= t__split_fields7 (us_split_fields7 temp___1366)))

;; H
  (assert
  (and (= o15 (int__content previous6)) (in_range3 (int__content previous6))))
...
;; H
  (assert
  (and (= o16 (int__content previous6)) (in_range3 (int__content previous6))))

;; H
  (assert (size__function_guard
  (size (rec__search_trees__search_tree__struct t_old__split_fields4))
...
;; WP_parameter_def
 ;; File "search_trees.adb", line 1175, characters 0-0
  (not
  (< 0 (size (rec__search_trees__search_tree__struct t_old__split_fields4)))))
(check-sat)
