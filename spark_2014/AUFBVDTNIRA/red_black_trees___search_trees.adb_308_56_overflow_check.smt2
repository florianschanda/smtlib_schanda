...
(declare-fun temp___2625 () (Array Int us_rep1))
...
(declare-fun temp___2626 () (Array Int us_rep1))
...
(declare-fun temp___2624 () (Array Int us_rep1))

(declare-fun o26 () us_rep1)

(declare-fun o27 () us_split_fields)

(declare-fun temp___2623 () (Array Int us_rep1))

(declare-fun o28 () us_rep1)

(declare-fun o29 () us_split_fields)

(declare-fun temp___2622 () (Array Int us_rep1))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ f root) j27))) true))
  (= (olt
     (rec__tree_model__path_type__a
  ...
  (ite (= (get
          (rec__tree_model__path_type__a
          (us_split_fields1 (select (model__ f root) j27)))
          (+ (length
             (rec__tree_model__path_type__a
             (us_split_fields1 (select (model__ f root) k1)))) 1)) 0)
  (< (to_rep (select values j27)) (to_rep (select values k1)))
  (< (to_rep (select values k1)) (to_rep (select values j27)))))))))))
...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j6) (<= j6 100)) (= temp___2406 j6))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2390 j27))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j6) (<= j6 100)) (= o8 (select temp___2390 i3)))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j6) (<= j6 100)) (= o9 (us_split_fields1 o8)))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2391 j27))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j6) (<= j6 100))
  (=> (= result4 true) (= o6 (select temp___2391 j6))))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2393 j27))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j6) (<= j6 100))
  (=> (= result3 true) (= o3 (select temp___2393 j6))))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2392 j27))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (= (olt
     ...
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f_old root) j6)))) true)))))
...
;; H
  ...
  (ite (= (get
          (rec__tree_model__path_type__a
          (us_split_fields1 (select (model__ f root) j6)))
          (+ (length
             (rec__tree_model__path_type__a
             (us_split_fields1 (select (model__ f root) i3)))) 1)) 0)
  (< (to_rep (select values j6)) (to_rep (select values i3)))
  (< (to_rep (select values i3)) (to_rep (select values j6))))))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j6) (<= j6 100))
  (and (=> (<= 1 100) (in_range3 j7)) (and (<= 1 j7) (<= j7 100))))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j6) (<= j6 100)) (= j7 100))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j6) (<= j6 100)) (= j8 (mk_int__ref j7)))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100)) (=> (and (<= 1 j6) (<= j6 100)) (= j9 j7))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j6) (<= j6 100)) (= j10 j8))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (and (<= 1 j6) (<= j6 100)) (= j11 j9))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (and (<= 1 j6) (<= j6 100))) (= j10 (mk_int__ref j6)))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (and (<= 1 j6) (<= j6 100))) (= j11 j6))))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ f v) j27))) true))
  (= (olt
     (rec__tree_model__path_type__a
  ...
  (ite (= (get
          (rec__tree_model__path_type__a
          (us_split_fields1 (select (model__ f v) j27)))
          (+ (length
             (rec__tree_model__path_type__a
...
;; H
  (assert
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (and (<= 1 j17) (<= j17 100)) (= temp___2543 j17))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2527 j27))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (and (<= 1 j17) (<= j17 100)) (= o18 (select temp___2527 i9)))))

;; H
  (assert
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (and (<= 1 j17) (<= j17 100)) (= o19 (us_split_fields1 o18)))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2528 j27))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (and (<= 1 j17) (<= j17 100))
  (=> (= result9 true) (= o16 (select temp___2528 j17))))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2530 j27))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (and (<= 1 j17) (<= j17 100))
  (=> (= result8 true) (= o13 (select temp___2530 j17))))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2529 j27))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (= (olt
     ...
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f_old root) j17)))) true)))))
...
;; H
  ...
  (ite (= (get
          (rec__tree_model__path_type__a
          (us_split_fields1 (select (model__ f v) j17)))
          (+ (length
             (rec__tree_model__path_type__a
             (us_split_fields1 (select (model__ f v) i9)))) 1)) 0)
  (< (to_rep (select values j17)) (to_rep (select values i9)))
  (< (to_rep (select values i9)) (to_rep (select values j17))))))))
...
;; H
  ...
  (ite (= (get
          ...
          (+ (length
             (rec__tree_model__path_type__a
             (us_split_fields1 (select (model__ f v) i9)))) 1)) 0)
  (< (to_rep (select values k1)) (to_rep (select values i9)))
  (< (to_rep (select values i9)) (to_rep (select values k1))))))))))

;; H
  (assert
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (and (<= 1 j17) (<= j17 100))
  (and (=> (<= 1 100) (in_range3 j18)) (and (<= 1 j18) (<= j18 100))))))

;; H
  (assert
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (and (<= 1 j17) (<= j17 100)) (= j18 100))))

;; H
  (assert
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (and (<= 1 j17) (<= j17 100)) (= j19 (mk_int__ref j18)))))

;; H
  (assert
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (and (<= 1 j17) (<= j17 100)) (= j20 j18))))

;; H
  (assert
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (and (<= 1 j17) (<= j17 100)) (= j21 j19))))

;; H
  (assert
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (and (<= 1 j17) (<= j17 100)) (= j22 j20))))

;; H
  (assert
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (and (<= 1 j17) (<= j17 100))) (= j21 (mk_int__ref j17)))))

;; H
  (assert
  (=> (and (<= 1 i8) (<= i8 100))
  (=> (not (and (<= 1 j17) (<= j17 100))) (= j22 j17))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2623 (parent f i14)))) (position f i14)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2623 i14))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2623 (parent f i14)))) (position f i14)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2623 i14))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2624 (parent f i14)))) (position f i14)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2624 i14))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2624 (parent f i14)))) (position f i14)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2624 i14))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2626 (parent f i14)))) (position f i14)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2626 i14))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2626 (parent f i14)))) (position f i14)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2626 i14))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2625 (parent f i14)))) (position f i14)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2625 i14))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2625 (parent f i14)))) (position f i14)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2625 i14))))))
...
;; H
  (assert
  (and
  (and (= temp___2623 (model__ f v)) (model____function_guard temp___2623 
  f v))
  (and (dynamic_invariant5 temp___2623 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2623 v))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2623 v)))) 0)
  (and
  (forall ((i14 Int))
  (=> (and (<= 1 i14) (<= i14 100))
  (=> (not (= i14 v))
  (ite (and (not (= (parent f i14) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2623 (parent f i14)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2623 i14))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2623 i14))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2623 i14)))) 0))))
  (forall ((i14 Int))
  (=> (and (<= 1 i14) (<= i14 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2623 j27))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2623 i14)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2623 j27)))) true))
  (= j27 i14))))))))))))))

;; H
  (assert (= o28 (select temp___2623 k)))
...
;; H
  ...
  (=> (= result12 true)
  (and
  (and (= temp___2624 (model__ f v)) (model____function_guard temp___2624 
  f v))
  (and (dynamic_invariant5 temp___2624 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2624 v))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2624 v)))) 0)
  (and
  (forall ((i14 Int))
  (=> (and (<= 1 i14) (<= i14 100))
  (=> (not (= i14 v))
  (ite (and (not (= (parent f i14) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2624 (parent f i14)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2624 i14))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2624 i14))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2624 i14)))) 0))))
  (forall ((i14 Int))
  (=> (and (<= 1 i14) (<= i14 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2624 j27))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2624 i14)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2624 j27)))) true))
  (= j27 i14)))))))))))))))

;; H
  (assert (=> (= result12 true) (= o26 (select temp___2624 j2))))
...
;; H
  (assert
  (=> (= result12 true) (= result11 (rec__tree_model__path_type__k o27))))
...
;; H
  ...
  (=> (= result11 true)
  (and
  (and (= temp___2626 (model__ f v)) (model____function_guard temp___2626 
  f v))
  (and (dynamic_invariant5 temp___2626 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2626 v))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2626 v)))) 0)
  (and
  (forall ((i14 Int))
  (=> (and (<= 1 i14) (<= i14 100))
  (=> (not (= i14 v))
  (ite (and (not (= (parent f i14) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2626 (parent f i14)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2626 i14))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2626 i14))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2626 i14)))) 0))))
  (forall ((i14 Int))
  (=> (and (<= 1 i14) (<= i14 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2626 j27))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2626 i14)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2626 j27)))) true))
  (= j27 i14)))))))))))))))

;; H
  (assert (=> (= result11 true) (= o23 (select temp___2626 j2))))
...
;; H
  ...
  (=> (= result11 true)
  (and
  (and (= temp___2625 (model__ f v)) (model____function_guard temp___2625 
  f v))
  (and (dynamic_invariant5 temp___2625 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2625 v))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2625 v)))) 0)
  (and
  (forall ((i14 Int))
  (=> (and (<= 1 i14) (<= i14 100))
  (=> (not (= i14 v))
  (ite (and (not (= (parent f i14) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2625 (parent f i14)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2625 i14))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2625 i14))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2625 i14)))) 0))))
  (forall ((i14 Int))
  (=> (and (<= 1 i14) (<= i14 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2625 j27))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2625 i14)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2625 j27)))) true))
  (= j27 i14)))))))))))))))

;; H
  (assert (=> (= result11 true) (= o20 (select temp___2625 k))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2622 (parent f i14)))) (position f i14)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2622 i14))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2622 (parent f i14)))) (position f i14)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2622 i14))))))
...
;; H
  (assert
  (and
  (and (= temp___2622 (model__ f v)) (model____function_guard temp___2622 
  f v))
  (and (dynamic_invariant5 temp___2622 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2622 v))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2622 v)))) 0)
  (and
  (forall ((i14 Int))
  (=> (and (<= 1 i14) (<= i14 100))
  (=> (not (= i14 v))
  (ite (and (not (= (parent f i14) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2622 (parent f i14)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2622 i14))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2622 i14))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2622 i14)))) 0))))
  (forall ((i14 Int))
  (=> (and (<= 1 i14) (<= i14 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2622 j27))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2622 i14)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2622 j27)))) true))
  (= j27 i14))))))))))))))

;; H
  (assert (= o30 (select temp___2622 k)))
