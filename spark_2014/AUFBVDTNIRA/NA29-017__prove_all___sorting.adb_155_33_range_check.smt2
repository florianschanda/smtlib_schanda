...
;; H
  (assert
  (and
  (= o19 (perm (mk___t a (mk (to_rep a__first) (to_rep a__last)))
         (mk___t (map__content a8) (mk (to_rep a__first) (to_rep a__last)))
         a_first length1))
  (perm__function_guard o19
  (mk___t a (mk (to_rep a__first) (to_rep a__last)))
  (mk___t (map__content a8) (mk (to_rep a__first) (to_rep a__last))) 
  a_first length1)))
...
;; H
  (assert (and (= o11 (* j l2)) (in_range1 (* j l2))))
...
;; H
  (assert (= o17 (ite (< o16 o15) o16 o15)))
