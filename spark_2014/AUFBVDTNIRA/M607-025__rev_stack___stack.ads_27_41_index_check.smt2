...
(declare-fun temp___249 () (Array Int integer))

(declare-fun temp___2491 () t)
...
(define-fun temp___2492 () us_t (mk___t temp___249 temp___2491))
...
;; H
  (assert
  (and (and (= temp___2492 (to__ s)) (to____function_guard temp___2492 s))
  (and (dynamic_invariant temp___2492 true false true)
  (and
  (and (= (rec__stack__stack__content (us_split_fields1 s)) temp___249)
  (= (mk
     (to_rep
     (first2 (mk1 1 (to_rep1 (rec__stack__stack__top (us_split_fields1 s))))))
     (to_rep
     (last3 (mk1 1 (to_rep1 (rec__stack__stack__top (us_split_fields1 s))))))) 
  temp___2491))
  (and (= (to_rep (first temp___2491)) 1) (<= 0 (to_rep (last temp___2491))))))))

;; H
  (assert
  (and (and (= o5 (to__ s)) (to____function_guard o5 s))
  (and (dynamic_invariant o5 true false true)
  (and
  (and (= (rec__stack__stack__content (us_split_fields1 s)) o3)
  (= (mk
     (to_rep
     (first2 (mk1 1 (to_rep1 (rec__stack__stack__top (us_split_fields1 s))))))
     (to_rep
     (last3 (mk1 1 (to_rep1 (rec__stack__stack__top (us_split_fields1 s))))))) 
  o4)) (and (= (to_rep (first o4)) 1) (<= 0 (to_rep (last o4))))))))

;; H
  (assert (= temp___250 (to_rep (last o4))))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= (to_rep (first temp___2491)) temp___250)))
(check-sat)
