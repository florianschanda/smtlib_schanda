...
(declare-fun o14 () unsigned8)

(declare-fun o15 () (Array (_ BitVec 64) unsigned8))
...
(declare-fun result7 () (Array (_ BitVec 64) unsigned8))
...
;; H
  (assert
  (= (to_rep o14) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 64) 72057594037927936)) ((_ int2bv 64) 256)))))

;; H
  (assert (= o15 (store memory7 (bvadd addr ((_ int2bv 64) 7)) o14)))
...
;; WP_parameter_def
 ;; File "x86.ads", line 7, characters 0-0
  ...
  (to_rep (select memory9 addr))) (bvmul ((_ zero_extend 56) (to_rep
                                                             (select 
                                                             memory9 (bvadd 
                                                             addr ((_ int2bv 64) 1))))) ((_ int2bv 64) 256))) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory9 (bvadd addr ((_ int2bv 64) 2))))) ((_ int2bv 64) 65536))) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory9 (bvadd addr ((_ int2bv 64) 3))))) ((_ int2bv 64) 16777216))) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory9 (bvadd addr ((_ int2bv 64) 4))))) ((_ int2bv 64) 4294967296))) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory9 (bvadd addr ((_ int2bv 64) 5))))) ((_ int2bv 64) 1099511627776))) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory9 (bvadd addr ((_ int2bv 64) 6))))) ((_ int2bv 64) 281474976710656))) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory9 (bvadd addr ((_ int2bv 64) 7))))) ((_ int2bv 64) 72057594037927936))) 
  val__)))
(check-sat)
