...
(declare-fun s__split_fields () Bool)

(declare-fun s__split_fields1 () enum_t)

(declare-fun s__split_fields2 () integer)

(declare-fun temp___155 () Bool)

(declare-fun temp___1551 () enum_t)

(declare-fun temp___1552 () integer)
...
(declare-fun s__split_fields3 () Bool)

(declare-fun s__split_fields4 () enum_t)

(declare-fun s__split_fields5 () integer)
...
(define-fun temp___1553 () us_rep (mk___rep
                                  (mk___split_fields temp___155 temp___1551
                                  temp___1552)))
