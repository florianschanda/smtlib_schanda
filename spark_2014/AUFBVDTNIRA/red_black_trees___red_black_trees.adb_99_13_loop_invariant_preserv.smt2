...
;; H
  ...
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11
     (select (map__content4 res12) (peek
                                   (rec__red_black_trees__rbt__struct
                                   (us_split_fields9 t)) j 0))))) (int__content
                                                                  n4)))
...
;; H
  ...
  (< (to_rep
     ...
     (select (map__content4 res12) (peek
                                   (rec__red_black_trees__rbt__struct
                                   (us_split_fields9 t)) j 1))))) (int__content
                                                                  n4)))
...
;; WP_parameter_def
 ;; File "red_black_trees.adb", line 20, characters 0-0
  ...
  (<= (to_rep
      (rec__red_black_trees__black_count__depth
      (us_split_fields11 (select (map__content4 res12) j)))) (int__content
                                                             n4))))
(check-sat)
