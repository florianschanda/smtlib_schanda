...
(declare-fun temp___360 () (_ BitVec 64))

(declare-fun temp___359 () (_ BitVec 64))

(declare-fun temp___358 () (Array (_ BitVec 64) unsigned8))

(declare-fun temp___361 () (_ BitVec 64))
...
(declare-fun temp___362 () (Array (_ BitVec 64) unsigned8))

(declare-fun temp___354 () (_ BitVec 64))

(declare-fun temp___353 () (_ BitVec 64))

(declare-fun temp___352 () Bool)
...
;; H
  (assert (= temp___360 rbx))

;; H
  (assert (= temp___359 rsp))

;; H
  (assert (= temp___358 memory))

;; H
  (assert (= temp___361 rsp))

;; H
  (assert (= temp___357 xmm2))

;; H
  (assert (= temp___356 xmm1))

;; H
  (assert (= temp___355 rax))

;; H
  (assert (= temp___362 memory))

;; H
  (assert (= temp___354 xmm0))

;; H
  (assert (= temp___353 rdi))

;; H
  (assert (= temp___352 zeroflag))

;; H
  (assert (= rsp1 temp___361))
...
;; H
  ...
  (= (to_rep (select memory1 i)) (to_rep (select temp___362 i)))))))
