...
(declare-fun temp___476 () (Array (_ BitVec 64) unsigned8))

(declare-fun temp___479 () (_ BitVec 64))

(declare-fun temp___475 () (_ BitVec 64))

(declare-fun temp___474 () (_ BitVec 64))

(declare-fun temp___473 () (_ BitVec 64))

(declare-fun temp___480 () (Array (_ BitVec 64) unsigned8))

(declare-fun temp___472 () (_ BitVec 64))

(declare-fun temp___471 () (_ BitVec 64))

(declare-fun temp___470 () Bool)
...
;; H
  (assert (= temp___478 rbx))

;; H
  (assert (= temp___477 rsp))

;; H
  (assert (= temp___476 memory))

;; H
  (assert (= temp___479 rsp))

;; H
  (assert (= temp___475 xmm2))

;; H
  (assert (= temp___474 xmm1))

;; H
  (assert (= temp___473 rax))

;; H
  (assert (= temp___480 memory))

;; H
  (assert (= temp___472 xmm0))

;; H
  (assert (= temp___471 rdi))

;; H
  (assert (= temp___470 zeroflag))

;; H
  (assert (= rsp1 temp___479))
...
;; H
  ...
  (= (to_rep (select memory1 i)) (to_rep (select temp___480 i)))))))
