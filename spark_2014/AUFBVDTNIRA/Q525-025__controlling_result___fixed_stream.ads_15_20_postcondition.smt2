...
(declare-fun this__split_fields () natural)

(declare-fun this__split_fields1 () (Array Int character))

(declare-fun this__split_fields2 () us_private)

(declare-fun fixed_stream__create__result () natural)

(declare-fun fixed_stream__create__result1 () (Array Int character))

(declare-fun fixed_stream__create__result2 () us_private)

(declare-fun fixed_stream__create__result3 () Int)
...
(declare-fun temp___267 () natural)

(declare-fun temp___2671 () (Array Int character))

(declare-fun temp___2672 () us_private)

(declare-fun temp___2673 () Int)
...
(declare-fun this__split_fields3 () natural)

(declare-fun this__split_fields4 () (Array Int character))

(declare-fun this__split_fields5 () us_private)

(declare-fun fixed_stream__trim_string__change () (Array Int character))
...
(declare-fun this__split_fields7 () (Array Int character))

(declare-fun this__split_fields8 () us_private)

(declare-fun result6 () natural)

(declare-fun result7 () (Array Int character))

(declare-fun result8 () us_private)

(declare-fun result9 () Int)

(declare-fun fixed_stream__create__result4 () natural)

(declare-fun fixed_stream__create__result5 () (Array Int character))

(declare-fun fixed_stream__create__result6 () us_private)

(declare-fun fixed_stream__create__result7 () Int)

(declare-fun fixed_stream__create__result8 () object__ref)

(declare-fun fixed_stream__create__result9 () us_rep)

(declare-fun this__split_fields9 () us_split_fields__ref)

(declare-fun fixed_stream__create__result10 () object__ref)

(declare-fun this__split_fields10 () us_split_fields)

(declare-fun fixed_stream__create__result11 () us_rep)

(define-fun fixed_stream__create__result12 () us_rep (mk___rep
                                                     (mk___split_fields
...
(declare-fun result11 () (Array Int character))

(declare-fun result12 () us_private)
...
;; H
  (assert (= temp___2671 o2))

;; H
  (assert (= temp___2672 o3))

;; H
  (assert (= this__attr__tag temp___2673))
...
;; H
  (assert (= temp___267 this__split_fields3))

;; H
  (assert (= temp___2671 this__split_fields4))

;; H
  (assert (= temp___2672 this__split_fields5))
...
;; H
  (assert
  (= fixed_stream__create__result8 (mk_object__ref
                                   fixed_stream__create__result12)))

;; H
  (assert (= fixed_stream__create__result9 fixed_stream__create__result12))
...
;; H
  (assert (= fixed_stream__create__result10 fixed_stream__create__result8))
...
;; H
  (assert (= fixed_stream__create__result11 fixed_stream__create__result9))
...
;; H
  ...
  (object__content fixed_stream__create__result10)))

;; H
  (assert (elements__function_guard
  (elements (object__content fixed_stream__create__result10))
  (object__content fixed_stream__create__result10)))
...
;; WP_parameter_def
 ;; File "fixed_stream.ads", line 43, characters 0-0
  (not
  (= (elements (object__content fixed_stream__create__result10)) elem_width)))
(check-sat)
