...
(declare-fun temp___805 () Int)

(declare-fun temp___804 () us_rep3)

(declare-fun temp___803 () Int)

(declare-fun temp___802 () us_rep)

(declare-fun temp___801 () Int)

(declare-fun temp___800 () us_rep1)

(declare-fun temp___799 () us_rep2)

(declare-fun temp___798 () Int)

(declare-fun temp___797 () Int)

(declare-fun temp___796 () Int)

(declare-fun temp___795 () Int)

(declare-fun temp___794 () Int)

(declare-fun temp___793 () us_rep1)

(declare-fun temp___815 () Int)

(declare-fun temp___814 () us_rep)

(declare-fun temp___813 () us_rep1)

(declare-fun temp___812 () us_rep2)

(declare-fun temp___811 () Int)

(declare-fun temp___810 () Int)

(declare-fun temp___809 () Int)

(declare-fun temp___808 () Int)

(declare-fun temp___807 () us_rep1)
...
;; H
  (assert (= temp___805 (int__content first_col)))

;; H
  (assert
  (= temp___804 (mk___rep2 (mk___split_discrs2 t__split_discrs)
                (mk___split_fields2 t__split_fields t__split_fields1
                t__split_fields2 t__split_fields3) t__attr__constrained)))

;; H
  (assert (= temp___803 (int__content state)))

;; H
  (assert (= temp___802 the_file))

;; H
  (assert (= temp___801 first_line))

;; H
  (assert
  (= temp___800 (mk___rep (mk___split_discrs next_read__split_discrs)
                (mk___split_fields next_read__split_fields)
                next_read__attr__constrained)))

;; H
  (assert
  (= temp___799 (mk___rep1 s__split_discrs
                (mk___split_fields1 s__split_fields))))

;; H
  (assert (= temp___798 current_pos))

;; H
  (assert (= temp___797 current_col))

;; H
  (assert (= temp___796 current_line))

;; H
  (assert (= temp___795 (int__content first_pos)))

;; H
  (assert (= temp___794 (int__content c)))

;; H
  (assert
  (= temp___793 (mk___rep (mk___split_discrs current_read__split_discrs)
                (mk___split_fields current_read__split_fields)
...
;; H
  ...
  next_read__split_fields8 next_read__split_discrs8)
  current_read__split_fields8 current_read__split_discrs8
  next_read__split_fields8 next_read__split_discrs8))
...
;; H
  (assert (local_invariant__function_guard
  (local_invariant current_read__split_fields12 current_read__split_discrs12
  next_read__split_fields12 next_read__split_discrs12)
  current_read__split_fields12 current_read__split_discrs12
  next_read__split_fields12 next_read__split_discrs12))
...
;; H
  (assert (local_invariant__function_guard
  (local_invariant current_read__split_fields11 current_read__split_discrs11
  next_read__split_fields11 next_read__split_discrs11)
  current_read__split_fields11 current_read__split_discrs11
  next_read__split_fields11 next_read__split_discrs11))
...
;; H
  (assert (local_invariant__function_guard
  (local_invariant current_read__split_fields45 current_read__split_discrs45
  next_read__split_fields45 next_read__split_discrs45)
  current_read__split_fields45 current_read__split_discrs45
  next_read__split_fields45 next_read__split_discrs45))

;; H
  (assert (length__function_guard
  (length1 (mk___rep1 s__split_discrs s__split_fields44))
  (mk___rep1 s__split_discrs s__split_fields44)))

;; H
  (assert (length__function_guard
  (length1
  (mk___rep1 s__split_discrs (us_split_fields__content1 s__split_fields40)))
  (mk___rep1 s__split_discrs (us_split_fields__content1 s__split_fields40))))
...
;; H
  ...
  (= temp___815 (int__content state19))))
...
;; H
  ...
  (= (to_rep3
     (rec__file_io__read_result__status
     (us_split_discrs__content current_read__split_discrs5))) 0)
  (= temp___814 (file__content the_file4))))
...
;; H
  ...
  (= (to_rep3
     (rec__file_io__read_result__status
     (us_split_discrs__content current_read__split_discrs5))) 0)
  (= temp___813 (mk___rep (us_split_discrs__content next_read__split_discrs5)
...
;; H
  ...
  (= (to_rep3
     (rec__file_io__read_result__status
     (us_split_discrs__content current_read__split_discrs5))) 0)
  (= temp___812 (mk___rep1 s__split_discrs
...
;; H
  ...
  (= (to_rep3
     (rec__file_io__read_result__status
     (us_split_discrs__content current_read__split_discrs5))) 0)
  (= temp___811 (int__content current_pos6))))
...
;; H
  ...
  (= (to_rep3
     (rec__file_io__read_result__status
     (us_split_discrs__content current_read__split_discrs5))) 0)
  (= temp___810 (int__content current_col6))))
...
;; H
  ...
  (= (to_rep3
     (rec__file_io__read_result__status
     (us_split_discrs__content current_read__split_discrs5))) 0)
  (= temp___809 (int__content current_line6))))
...
;; H
  ...
  (not
  (let ((temp___817 (let ((subject state)) state21)))
  (or (and (<= 2 temp___817) (<= temp___817 2))
  (and (<= 9 temp___817) (<= temp___817 9)))))))
...
;; H
  (assert (length__function_guard
  (length1
  (mk___rep1 s__split_discrs (us_split_fields__content1 s__split_fields49)))
  (mk___rep1 s__split_discrs (us_split_fields__content1 s__split_fields49))))
...
;; WP_parameter_def
 ;; File "lexer.ads", line 65, characters 0-0
  (not (in_range1 (- (to_rep1 (last (rt tmp))) 1))))
(check-sat)
