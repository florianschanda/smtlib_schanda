...
;; H
  (assert (olt__function_guard (olt (abs1 o11) fliteral9) (abs1 o11)
  fliteral9))
...
;; H
  (assert (olt__function_guard (olt (abs1 o12) fliteral9) (abs1 o12)
  fliteral9))
...
;; H
  ...
  (= o12 (div1 RNE2
         ...
         (cos1
         (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source))))))
  (= (olt (abs1 o12) fliteral9) true)))))

;; H
  (assert (= o13 (mul RNE2 o12 o11)))

;; H
  (assert (and (= o14 o13) (tqtisFinite o13)))

;; H
  (assert (olt__function_guard (olt (abs1 o8) fliteral6) (abs1 o8)
  fliteral6))

;; H
  (assert (olt__function_guard (olt (abs1 o9) fliteral6) (abs1 o9)
  fliteral6))
