...
(declare-fun temp___250 () r1)

(declare-fun temp___2501 () (Array Int integer))
...
;; H
  (assert
  (and (= o (- (to_rep s__split_fields) 1)) (in_range1
...
;; H
  (assert
  (= (mk___split_fields s__split_fields6 s__split_fields7) (mk___split_fields
                                                           s__split_fields2
                                                           s__split_fields3)))
...
;; WP_parameter_def
 ;; File "stack.ads", line 31, characters 0-0
  ...
  (= (let ((temp___262 (to__
     ...
     (bool_eq2 (elts temp___262) (to_rep1 (first (rt temp___262)))
     (to_rep1 (last (rt temp___262)))
     (elts
     ...
     (- (to_rep1
        ...
        (rt
        (to__
        (mk___rep (mk___split_fields s__split_fields s__split_fields1)))))) 1))))
     (to_rep1
     (last4
     (mk2 1
     (- (to_rep1
        ...
        (rt
        (to__
        (mk___rep (mk___split_fields s__split_fields s__split_fields1)))))) 1)))))) true)))
(check-sat)
