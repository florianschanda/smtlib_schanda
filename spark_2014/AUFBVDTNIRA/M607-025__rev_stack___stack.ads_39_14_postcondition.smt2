...
(declare-fun temp___277 () r1)

(declare-fun temp___2771 () (Array Int integer))
...
;; H
  ...
  (to__ (mk___rep (mk___split_fields s__split_fields4 s__split_fields5)))
...
;; WP_parameter_def
 ;; File "stack.ads", line 31, characters 0-0
  ...
  (= (let ((temp___295 (to__
     ...
     (bool_eq2 (elts temp___295) (to_rep1 (first (rt temp___295)))
     (to_rep1 (last (rt temp___295)))
     (elts
     (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1))))
     (to_rep1
     (first4
