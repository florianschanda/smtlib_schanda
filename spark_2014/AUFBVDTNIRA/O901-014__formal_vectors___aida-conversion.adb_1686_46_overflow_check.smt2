...
;; H
  (assert
  (and (= temp___2373 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2373)
  (<= temp___2373 (to_rep1 n__last))))

;; H
  (assert (= o49 temp___2373))
