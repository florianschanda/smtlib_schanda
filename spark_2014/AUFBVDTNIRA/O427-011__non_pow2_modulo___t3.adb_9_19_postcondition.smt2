...
(define-fun dynamic_invariant ((temp___expr_177 (_ BitVec 64))
  ...
  (temp___do_toplevel_176 Bool)) Bool (=>
                                      ...
                                      (in_range temp___expr_177)))

(declare-fun x () (_ BitVec 64))

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun t3__mmin__result () (_ BitVec 64))

(declare-fun result () (_ BitVec 64))

(declare-fun t3__mmin__result1 () (_ BitVec 64))

(declare-fun t3__mmin__result2 () (_ BitVec 64))

(declare-fun t3__mmin__result3 () (_ BitVec 64))

(declare-fun t3__mmin__result4 () (_ BitVec 64))

(declare-fun t3__mmin__result5 () (_ BitVec 64))
...
;; H
  (assert (= t3__mmin__result1 t3__mmin__result2))

;; H
  (assert (= t3__mmin__result3 t3__mmin__result1))

;; H
  (assert (= result t3__mmin__result))

;; H
  (assert
  (= t3__mmin__result1 (bvurem (bvsub ((_ int2bv 64) 230) x) ((_ int2bv 64) 230))))

;; H
  (assert (= (mk_t__ref t3__mmin__result4) (mk_t__ref t3__mmin__result2)))

;; H
  (assert (= t3__mmin__result5 t3__mmin__result3))

;; H
  (assert (= result1 t3__mmin__result4))

(assert
;; WP_parameter_def
 ;; File "t3.adb", line 6, characters 0-0
  (not
  (= t3__mmin__result4 (let ((temp___187 (bvadd (let ((temp___186 (bvsub ((_ int2bv 64) 229) 
                                                x)))
                                                (ite (bvult ((_ int2bv 64) 229) 
                                                x)
                                                (bvadd temp___186 ((_ int2bv 64) 230))
                                                temp___186)) ((_ int2bv 64) 1))))
                       (ite (bvule (bvsub ((_ int2bv 64) 230) (let ((temp___186 (bvsub ((_ int2bv 64) 229) 
                                                              x)))
                                                              (ite (bvult ((_ int2bv 64) 229) 
                                                              x)
                                                              (bvadd temp___186 ((_ int2bv 64) 230))
                                                              temp___186))) ((_ int2bv 64) 1))
                       (bvsub temp___187 ((_ int2bv 64) 230)) temp___187)))))
(check-sat)
