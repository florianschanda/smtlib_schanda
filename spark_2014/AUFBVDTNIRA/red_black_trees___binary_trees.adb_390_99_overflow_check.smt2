...
;; H
  (assert (= (mk___rep (mk___split_fields o22 o23)) (select temp___1722 
  j)))
...
;; H
  (assert
  (=> (= result4 true)
  (= (mk___rep (mk___split_fields o17 o18)) (select temp___1724 j))))
...
;; H
  (assert
  (=> (= result4 true)
  (= (mk___rep (mk___split_fields o12 o13)) (select temp___1723 i))))
...
;; H
  (assert
  (=> (= result4 true)
  (and (= result3 (olt o16 o21))
  (= (= result3 true)
  (and (< (length o16) (length o21))
  (forall ((n3 Int))
  (=> (and (<= 1 n3) (<= n3 (last o16))) (= (get o16 n3) (get o21 n3)))))))))
...
;; H
  (assert (= (mk___rep (mk___split_fields o5 o6)) (select temp___1726 i)))
...
;; H
  (assert
  (and (= o10 (length o9)) (and (in_range3 o10) (<= (+ 0 o10) 2147483647))))
