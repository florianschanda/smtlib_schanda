...
(declare-fun temp___1081 () (Array Int us_rep1))
...
(declare-fun temp___1082 () (Array Int us_rep1))
...
;; H
  (assert
  (and (= temp___1082 (model__ f1 root))
  (and (dynamic_invariant2 temp___1082 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1082 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1082 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f1 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1082 (parent f1 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1082 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1082 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1082 (parent f1 i1)))) (position f1 i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1082 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1082 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1082 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1082 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1082 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o4 o5)) (select temp___1082 i)))
...
;; H
  (assert
  (and (= o9 (length o8)) (and (in_range5 o9) (<= (+ 0 o9) 2147483647))))
...
;; H
  (assert
  (and (= temp___1081 (model__ f1 root))
  (and (dynamic_invariant2 temp___1081 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1081 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1081 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f1 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1081 (parent f1 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1081 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1081 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1081 (parent f1 i1)))) (position f1 i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1081 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1081 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1081 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1081 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1081 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o o1)) (select temp___1081 i)))
