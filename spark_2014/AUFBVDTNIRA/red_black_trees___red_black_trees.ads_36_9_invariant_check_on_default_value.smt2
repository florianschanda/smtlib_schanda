...
(define-fun dynamic_invariant ((temp___expr_378 us_rep2)
...
(define-fun dynamic_invariant1 ((temp___expr_487 us_rep3)
...
(define-fun dynamic_invariant8 ((temp___expr_207 us_rep6)
...
(define-fun default_initial_assumption2 ((temp___expr_209 us_rep6)
...
(define-fun dynamic_predicate ((temp___213 us_rep6)) Bool (< (length
                                                             (rec__tree_model__path_type__a
                                                             (us_split_fields11
                                                             temp___213))) 100))

(define-fun dynamic_invariant9 ((temp___expr_218 (Array Int us_rep6))
...
(define-fun default_initial_assumption3 ((temp___expr_221 (Array Int us_rep6))
...
(define-fun default_initial_assumption4 ((temp___expr_201 us_rep5)
...
;; size__post_axiom
  (assert
  (forall ((t us_rep2))
  (! (=> (dynamic_invariant t true true true) (dynamic_invariant5 (size1 t)
     true false true)) :pattern ((size1 t)) )))
...
;; model____post_axiom
  ...
  (! (=> (and (dynamic_invariant t true true true) (not (= (size1 t) 0)))
     (dynamic_invariant9 (model__ t) true false true)) :pattern ((model__ t)) )))
...
;; peek__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant5 (peek t i d) true false true)) :pattern ((peek t i
                                                                  d)) ))))
...
;; size__post_axiom
  (assert
  (forall ((f us_rep1))
  (! (=> (dynamic_invariant11 f true true true) (dynamic_invariant5 (size f)
...
;; peek__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant5 result true false true)))) :pattern ((peek1 f i d)) ))))
...
(declare-fun temp___568 () extended_index_type)

(declare-fun temp___5681 () extended_index_type)

(declare-fun temp___5682 () (Array Int us_rep))

(declare-fun temp___5683 () (Array Int natural))

(declare-fun temp___5684 () (Array Int color_type))

(define-fun temp___5685 () us_rep3 (mk___rep3
                                   (mk___split_fields3
                                   (mk___rep2
                                   (mk___split_fields2 temp___568
                                   (mk___rep1
                                   (mk___split_fields1 temp___5681
                                   temp___5682)) temp___5683)) temp___5684)))

;; H
  (assert (dynamic_invariant1 temp___5685 true false true))
...
;; H
  ...
  (mk___rep2
  (mk___split_fields2 temp___568
  (mk___rep1 (mk___split_fields1 temp___5681 temp___5682)) temp___5683))
  false) (= temp___5684 (temp___502 0))))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= (invariant__ temp___5685) true)))
(check-sat)
