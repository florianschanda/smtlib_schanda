...
(declare-fun dummy1 () position_type)
...
;; range_axiom
  (assert
  (forall ((x position_type)) (! (in_range1
...
(define-fun dynamic_invariant ((temp___expr_567 us_rep2)
...
(define-fun dynamic_invariant1 ((temp___expr_905 us_rep3)
...
;; invariant____def_axiom
  ...
  (! (=> (invariant____function_guard (invariant__ t) t)
     ...
     (parent (rec__red_black_trees__rbt__struct (us_split_fields7 t)) i)
     ...
     (=>
     (or
     (= (parent (rec__red_black_trees__rbt__struct (us_split_fields7 t)) i) 0)
     (= (to_rep3
        (let ((temp___994 (rec__red_black_trees__rbt__color
                          (us_split_fields7 t))))
        (select temp___994 (parent
                           (rec__red_black_trees__rbt__struct
                           (us_split_fields7 t)) i)))) 1))
     (= (to_rep3
...
(declare-datatypes ()
((black_count__ref (mk_black_count__ref (black_count__content us_rep4)))))
(define-fun black_count__ref___projection ((a black_count__ref)) us_rep4 
...
(define-fun bool_eq13 ((a (Array Int us_rep4)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq12 (select a temp___idx_136)
...
(declare-fun bool_eq14 (us_rep5 us_rep5) Bool)
...
(define-fun us_split_fields_A__projection ((a us_split_fields10)) us_rep5 
...
(define-fun us_rep___projection ((a us_rep6)) us_split_fields10 (us_split_fields11
                                                                a))
...
(declare-datatypes ()
((path_type__ref (mk_path_type__ref (path_type__content us_rep6)))))
(define-fun path_type__ref___projection ((a path_type__ref)) us_rep6 
...
(declare-fun model__ (us_rep2) (Array Int us_rep6))

(declare-fun model____function_guard ((Array Int us_rep6) us_rep2) Bool)

(declare-fun peek (us_rep2 Int Int) Int)

(declare-fun peek__function_guard (Int us_rep2 Int Int) Bool)

(declare-fun nb_blacks (us_rep3) (Array Int us_rep4))

(declare-fun nb_blacks__function_guard ((Array Int us_rep4) us_rep3) Bool)
...
;; nb_blacks__post_axiom
  ...
  (! (and (size__function_guard1
     ...
     (=>
     (and (dynamic_invariant1 t true true true)
     (not
     ...
     (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t)) i 0)
     (rec__red_black_trees__rbt__struct (us_split_fields7 t)) i 0))
     (and
     (forall ((i Int)) (peek__function_guard
     (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t)) i 1)
     (rec__red_black_trees__rbt__struct (us_split_fields7 t)) i 1))
     (and
     (forall ((i Int)) (peek__function_guard
     (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t)) i 0)
     (rec__red_black_trees__rbt__struct (us_split_fields7 t)) i 0))
...
(define-fun dynamic_invariant5 ((temp___expr_163 Int)
  ...
  (temp___do_toplevel_162 Bool)) Bool (=>
                                      ...
                                      (<= 0 100)) (in_range temp___expr_163)))
...
(declare-fun length (us_rep5) Int)

(declare-fun length__function_guard (Int us_rep5) Bool)

(define-fun dynamic_invariant8 ((temp___expr_212 us_rep6)
  ...
  (temp___do_toplevel_211 Bool)) Bool (=> (= temp___do_toplevel_211 true)
                                      ...
                                      (< (length
                                         (rec__tree_model__path_type__a
                                         (us_split_fields11 temp___expr_212))) 100))))

(define-fun default_initial_assumption2 ((temp___expr_214 us_rep6)
...
(define-fun dynamic_predicate ((temp___218 us_rep6)) Bool (< (length
                                                             (rec__tree_model__path_type__a
                                                             (us_split_fields11
                                                             temp___218))) 100))

(define-fun dynamic_invariant9 ((temp___expr_223 (Array Int us_rep6))
...
(define-fun default_initial_assumption3 ((temp___expr_226 (Array Int us_rep6))
...
(define-fun last ((container us_rep5)) Int (+ 0 (length container)))

(declare-fun last__function_guard (Int us_rep5) Bool)

(declare-fun get (us_rep5 Int) Int)

(declare-fun get__function_guard (Int us_rep5 Int) Bool)

(define-fun oeq ((left us_rep5)
  (right us_rep5)) Bool (and (= (length left) (length right)) (ite (forall
                                                                   ((n Int))
                                                                   (=>
                                                                   (and
                                                                   (<= 1 n)
...
(define-fun default_initial_assumption4 ((temp___expr_206 us_rep5)
  (temp___skip_top_level_207 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_207 true))
                                         (= (length temp___expr_206) 0)))

(define-fun olt ((left us_rep5)
  (right us_rep5)) Bool (and (< (length left) (length right)) (ite (forall
                                                                   ((n Int))
                                                                   (=>
                                                                   (and
...
(declare-fun olt__function_guard (Bool us_rep5 us_rep5) Bool)

(declare-fun is_add (us_rep5 Int us_rep5) Bool)

(declare-fun is_add__function_guard (Bool us_rep5 Int us_rep5) Bool)
...
;; parent__post_axiom
  ...
  (forall ((i Int))
  (! (=>
     (and (dynamic_invariant t true true true) (dynamic_invariant4 i true
     true true))
     (let ((result (parent t i)))
     (and (size__function_guard1 (size1 t) t)
     (=> (parent__function_guard result t i)
     (and (=> (= (size1 t) 0) (= result 0)) (dynamic_invariant5 result true
...
(declare-fun model__1 (us_rep1 Int) (Array Int us_rep6))

(declare-fun model____function_guard1 ((Array Int us_rep6) us_rep1 Int) Bool)

;; model____post_axiom
  (assert
  (forall ((t us_rep2))
  (! (and (size__function_guard1 (size1 t) t)
     (=> (and (dynamic_invariant t true true true) (not (= (size1 t) 0)))
     (let ((result (model__ t)))
     (=> (model____function_guard result t) (dynamic_invariant9 result true
...
;; model____def_axiom
  ...
  (forall ((t us_rep2))
  (! (=>
     (and (dynamic_invariant t true true true) (model____function_guard
     (model__ t) t))
     (and (model____function_guard1
     (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 t))
     ...
     (= (model__ t) (model__1
                    ...
                    (to_rep
                    (rec__search_trees__search_tree__root
                    (us_split_fields5 t))))))) :pattern ((model__ t)) )))
...
;; peek__post_axiom
  ...
  (! (and (size__function_guard1 (size1 t) t)
     ...
     (=> (peek__function_guard result t i d) (dynamic_invariant5 result true
...
;; peek__def_axiom
  ...
  (! (=>
     ...
     (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 t)) i
     d) (rec__search_trees__search_tree__struct (us_split_fields5 t)) i d)
     (= (peek t i d) (peek1
                     (rec__search_trees__search_tree__struct
                     (us_split_fields5 t)) i d)))) :pattern ((peek t i d)) ))))
...
(declare-fun temp___1036 () extended_index_type)

(declare-fun temp___10361 () extended_index_type)

(declare-fun temp___10362 () (Array Int us_rep))

(declare-fun temp___10363 () (Array Int natural))

(declare-fun temp___10364 () (Array Int color_type))

(define-fun temp___10365 () us_rep3 (mk___rep3
                                    (mk___split_fields3
                                    (mk___rep2
                                    (mk___split_fields2 temp___1036
                                    (mk___rep1
                                    (mk___split_fields1 temp___10361
                                    temp___10362)) temp___10363))
                                    temp___10364)))

;; H
  (assert (dynamic_invariant1 temp___10365 true false true))
...
;; H
  ...
  (mk___rep2
  (mk___split_fields2 temp___1036
  (mk___rep1 (mk___split_fields1 temp___10361 temp___10362)) temp___10363))
  false) (= temp___10364 (temp___926 0))))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (type_invariant1 temp___10365)))
(check-sat)
