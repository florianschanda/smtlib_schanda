...
(declare-fun temp___446 () tcount_typeB)

(declare-fun temp___4461 () us_main_type)

(declare-fun temp___447 () Int)

(declare-fun temp___445 () Int)

(declare-fun temp___448 () us_rep1)
...
;; H
  ...
  (is_incr (get temp___448 n)
  (get (model__ (mk___rep v__split_discrs v__split_fields12)) n))
  (get temp___448 n)
  (get (model__ (mk___rep v__split_discrs v__split_fields12)) n))))
...
;; H
  (assert
  (=> (and (<= first i1) (<= i1 r7b))
  (and (= v__split_discrs (mk___split_discrs temp___446))
  (= v__split_fields temp___4461))))
...
;; H
  (assert (=> (and (<= first i1) (<= i1 r7b)) (= temp___445 i1)))
...
;; H
  (assert
  (=> (and (<= first i1) (<= i1 r7b))
  (= (length (mk___rep v__split_discrs v__split_fields12)) temp___447)))
...
;; H
  ...
  (=> (and (<= first n) (<= n (- i2 1)))
  (= (is_incr (get temp___448 n)
     (get (model__ (mk___rep v__split_discrs v__split_fields12)) n)) true)))))
...
;; H
  ...
  (=>
  (and (<= i2 n)
  (<= n (last5 (model__ (mk___rep v__split_discrs v__split_fields12)))))
  (= (get temp___451 n) (get
                        (model__
                        (mk___rep v__split_discrs v__split_fields12)) n))))))
