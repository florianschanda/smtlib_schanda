...
;; H
  (assert (=> (= result47 true) (= o21 (add RNE2 approx2 o20))))

;; H
  (assert (=> (= result47 true) (and (= o22 o21) (tqtisFinite o21))))

;; H
  (assert (=> (= result47 true) (= o23 (mul RNE2 fliteral7 o22))))
...
;; H
  (assert
  (=> (= result47 true)
  (and (= o24 (mul RNE2 approx3 approx3)) (tqtisFinite
  (mul RNE2 approx3 approx3)))))

;; H
  (assert (=> (= result47 true) (= o25 (sub RNE2 x1 o24))))

;; H
  (assert (=> (= result47 true) (and (= o26 o25) (tqtisFinite o25))))

;; H
  (assert (=> (= result47 true) (= o27 (abs1 o26))))

;; H
  (assert (=> (= result47 true) (= o28 (ite (lt fliteral4 o27) true false))))
