...
;; H
  (assert (=> (lt fliteral4 two_ki) (= o23 (mul RNE2 o22 c9b))))

;; H
  (assert (=> (lt fliteral4 two_ki) (and (= o24 o23) (tqtisFinite o23))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= o25 (add RNE2 integral_fbx o24))))
...
;; H
  (assert (=> (lt fliteral4 two_ki) (= o28 (mul RNE2 o27 c9b))))

;; H
  (assert (=> (lt fliteral4 two_ki) (and (= o29 o28) (tqtisFinite o28))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= o30 (add RNE2 integral_fby o29))))
...
;; H
  (assert (=> (lt fliteral4 two_ki) (= o33 (mul RNE2 o32 c9b))))

;; H
  (assert (=> (lt fliteral4 two_ki) (and (= o34 o33) (tqtisFinite o33))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= o35 (add RNE2 integral_fbz o34))))
...
;; H
  (assert
  (=> (lt fliteral4 two_ki)
  (and (= o38 (add RNE2 rad_gy1 integral_fby1)) (tqtisFinite
  (add RNE2 rad_gy1 integral_fby1)))))
...
;; H
  (assert
  (=> (lt fliteral4 two_ki)
  (and (= o39 (add RNE2 rad_gz1 integral_fbz1)) (tqtisFinite
  (add RNE2 rad_gz1 integral_fbz1)))))
...
;; H
  (assert
  (and (= o40 (mul RNE2 two_kp half_ex1)) (tqtisFinite
  (mul RNE2 two_kp half_ex1))))

;; H
  (assert (= o41 (add RNE2 rad_gx2 o40)))
...
;; H
  (assert
  (and (= o43 (mul RNE2 two_kp (let ((subject half_ey)) half_ey1)))
  (tqtisFinite (mul RNE2 two_kp (let ((subject half_ey)) half_ey1)))))

;; H
  (assert (= o44 (add RNE2 rad_gy2 o43)))
