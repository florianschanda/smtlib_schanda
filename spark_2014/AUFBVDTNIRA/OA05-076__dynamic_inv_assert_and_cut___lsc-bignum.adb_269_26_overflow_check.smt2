...
;; H
  (assert
  (and (= o2 (from_word32 (t__content carry28))) (from_word32__function_guard
  o2 (t__content carry28))))

;; H
  (assert
  (and (and (= o1 (base Tuple0)) (base__function_guard o1 Tuple0))
  (= o1 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o3 (omultiply o1 o2)) (omultiply__function_guard o3 o1 o2)))

;; H
  (assert
  (and (= o (from_word32 (t__content carry18))) (from_word32__function_guard
  o (t__content carry18))))

;; H
  (assert (and (= o4 (oadd o o3)) (oadd__function_guard o4 o o3)))
