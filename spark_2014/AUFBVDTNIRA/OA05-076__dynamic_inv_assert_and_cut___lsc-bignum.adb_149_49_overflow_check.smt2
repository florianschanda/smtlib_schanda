...
;; H
  (assert (= o41 (ite (<= o40 k) true false)))

;; H
  (assert
  (= result7 (ite (= o41 true) (ite (<= k a_last) true false) false)))
...
;; H
  (assert
  (and (= o38 (num_of_boolean carry3)) (num_of_boolean__function_guard 
  o38 carry3)))
...
;; H
  (assert
  (and (and (= o32 (base Tuple0)) (base__function_guard o32 Tuple0))
  (= o32 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o37 (oexpon o32 o36)) (oexpon__function_guard o37 o32 o36)))

;; H
  (assert
  (and (= o39 (omultiply o37 o38)) (omultiply__function_guard o39 o37 o38)))
