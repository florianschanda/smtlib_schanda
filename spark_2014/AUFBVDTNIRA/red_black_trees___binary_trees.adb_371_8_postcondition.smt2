...
;; H
  (assert
  (forall ((i Int) (d Int)) (peek__function_guard (peek f i d) f i d)))
...
;; H
  ...
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f root) i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f root) j)))) true))
  (<= (length
      (rec__tree_model__path_type__a
      (us_split_fields1 (select (model__ f root) j)))) (+ (length
                                                          (rec__tree_model__path_type__a
                                                          (us_split_fields1
                                                          (select (model__ 
                                                                  f root) i)))) 
  ...
  (= (get
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f root) j)))
     (+ (length
        (rec__tree_model__path_type__a
        (us_split_fields1 (select (model__ f root) i)))) 1)) d)))))))))))))
