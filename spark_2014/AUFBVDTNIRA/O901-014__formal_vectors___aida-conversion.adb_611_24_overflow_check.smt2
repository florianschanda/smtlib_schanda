...
;; H
  (assert
  (and (= temp___1670 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1670)
  (<= temp___1670 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1671 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1671)
  (<= temp___1671 (to_rep1 n__last))))

;; H
  (assert (= o54 temp___1671))
