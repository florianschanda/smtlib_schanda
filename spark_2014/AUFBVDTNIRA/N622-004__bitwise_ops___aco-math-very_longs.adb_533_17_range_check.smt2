...
;; H
  (assert (and (= temp___1316 o8) (in_range1 o8)))

;; H
  (assert (and (= us4 temp___1316) (dynamic_property2 1 last3 temp___1316)))

;; H
  (assert (= o9 temp___1316))
...
;; H
  (assert (and (= us5 (- 48 n1)) (dynamic_property3 first2 last4 (- 48 n1))))
...
;; H
  (assert
  (and
  (and (= o14 (get_shift_distance o13)) (get_shift_distance__function_guard
  o14 o13)) (in_range3 o14)))
