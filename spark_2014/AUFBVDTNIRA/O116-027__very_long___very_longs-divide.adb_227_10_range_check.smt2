...
;; H
  (assert
  (= (to_rep2 (first9 (rt4 (temp___1068 ((_ int2bv 8) 0) 1 r132b)))) 1))

;; H
  (assert
  (= (to_rep2 (last15 (rt4 (temp___1068 ((_ int2bv 8) 0) 1 r132b)))) 
  r132b))
...
;; H
  (assert
  (= (to_rep2 (first13 (rt6 (temp___1081 ((_ int2bv 8) 0) 1 r136b)))) 1))

;; H
  (assert
  (= (to_rep2 (last21 (rt6 (temp___1081 ((_ int2bv 8) 0) 1 r136b)))) 
  r136b))

;; H
  (assert (= temp___1088 (temp___1081 ((_ int2bv 8) 0) 1 r136b)))
