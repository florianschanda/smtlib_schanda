...
(declare-fun user_eq3 (t69b t69b) Bool)

(declare-fun dummy3 () t69b)

(declare-datatypes () ((t69b__ref (mk_t69b__ref (t69b__content t69b)))))
(define-fun t69b__ref___projection ((a t69b__ref)) t69b (t69b__content a))
...
(declare-fun user_eq4 (t65b t65b) Bool)

(declare-fun dummy4 () t65b)
...
(declare-fun user_eq5 (t67b t67b) Bool)

(declare-fun dummy5 () t67b)
...
(declare-fun temp___498 ((Array Int unsigned_byte)
  (Array Int unsigned_byte)) (Array Int (Array Int unsigned_byte)))

;; def_axiom
  (assert
  (forall ((temp___500 (Array Int unsigned_byte))
  (temp___501 (Array Int unsigned_byte)))
  (let ((temp___499 (temp___498 temp___500 temp___501)))
  (forall ((temp___502 Int))
  (ite (or (= temp___502 2) (and (<= 4 temp___502) (<= temp___502 6)))
  (= (select temp___499 temp___502) temp___500)
  (= (select temp___499 temp___502) temp___501))))))

(declare-fun temp___503 (Int Int Int Int) (Array Int unsigned_byte))

;; def_axiom
  (assert
  (forall ((temp___505 Int) (temp___506 Int) (temp___507 Int)
  (temp___508 Int))
  (let ((temp___504 (temp___503 temp___505 temp___506 temp___507 temp___508)))
  (forall ((temp___509 Int))
  (ite (= temp___509 3)
  (= (select temp___504 temp___509) (of_rep temp___507))
  (ite (= temp___509 2)
  (= (select temp___504 temp___509) (of_rep temp___506))
  (ite (= temp___509 1)
  (= (select temp___504 temp___509) (of_rep temp___505))
  (= (select temp___504 temp___509) (of_rep temp___508)))))))))

(declare-fun temp___510 (Int Int) (Array Int unsigned_byte))

;; def_axiom
  (assert
  (forall ((temp___512 Int) (temp___513 Int))
  (let ((temp___511 (temp___510 temp___512 temp___513)))
  (forall ((temp___514 Int))
  (ite (= temp___514 5)
  (= (select temp___511 temp___514) (of_rep temp___512))
  (= (select temp___511 temp___514) (of_rep temp___513)))))))
...
;; H
  (assert (= o (temp___510 10 12)))

;; H
  (assert (= o1 (temp___503 1 2 3 0)))

;; H
  (assert (= o2 (temp___498 o1 o)))
