...
;; H
  (assert
  (and (= o55 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o55 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o54 (from_word64 i2)) (from_word64__function_guard o54 i2)))

;; H
  (assert (and (= o56 (oadd o54 o55)) (oadd__function_guard o56 o54 o55)))

;; H
  (assert
  (and (= o53 (from_integer s10)) (from_integer__function_guard o53 s10)))

;; H
  (assert (and (= o57 (ole o53 o56)) (ole__function_guard o57 o53 o56)))
...
;; H
  (assert
  (and (= o47 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o47 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o48 (oexpon o47 s10)) (oexpon__function_guard o48 o47 s10)))

;; H
  (assert
  (and (= o42 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o42 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o41 (from_integer s10)) (from_integer__function_guard o41 s10)))

;; H
  (assert
  (and (= o43 (osubtract o41 o42)) (osubtract__function_guard o43 o41 o42)))

;; H
  (assert
  (and (= o40 (from_word64 i2)) (from_word64__function_guard o40 i2)))

;; H
  (assert
  (and (= o44 (osubtract o40 o43)) (osubtract__function_guard o44 o40 o43)))

;; H
  (assert
  (and (= o39 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o39 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o45 (oexpon__2 o39 o44)) (oexpon__2__function_guard o45 o39 o44)))
...
;; H
  (assert
  (and (= o38 (num_of_big_int e e_first o37)) (num_of_big_int__function_guard
  o38 e e_first o37)))

;; H
  (assert
  (and (= o46 (odivide o38 o45)) (odivide__function_guard o46 o38 o45)))

;; H
  (assert (and (= o49 (omod o46 o48)) (omod__function_guard o49 o46 o48)))

;; H
  (assert
  (and (= o33 (from_word32 (t__content w7))) (from_word32__function_guard 
  o33 (t__content w7))))

;; H
  (assert (and (= o50 (oeq o33 o49)) (oeq__function_guard o50 o33 o49)))
...
;; H
  (assert
  (and (= o31 (num_of_big_int m m_first o30)) (num_of_big_int__function_guard
  o31 m m_first o30)))
...
;; H
  (assert
  (and (and (= o26 (base Tuple0)) (base__function_guard o26 Tuple0))
  (= o26 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o28 (oexpon o26 o27)) (oexpon__function_guard o28 o26 o27)))
...
;; H
  (assert
  (and (= o20 (num_of_big_int x x_first o19)) (num_of_big_int__function_guard
  o20 x x_first o19)))

;; H
  (assert
  (and (= o25 (oexpon o20 o24)) (oexpon__function_guard o25 o20 o24)))

;; H
  (assert
  (and (= o29 (omultiply o25 o28)) (omultiply__function_guard o29 o25 o28)))

;; H
  (assert (and (= o32 (omod o29 o31)) (omod__function_guard o32 o29 o31)))
