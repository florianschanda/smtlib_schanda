...
;; H
  ...
  (=> (<= i32 temp___267) (= (select x2 temp___267) (select x1 temp___267)))))
  (and (<= 1 i32) (<= i32 3))))
...
;; WP_parameter_def
 ;; File "p.adb", line 1, characters 0-0
  (not
  (= (bool_eq4 (map__content2 x17) (to_rep (first1 (mk (+ i32 1) 3)))
     (to_rep (last (mk (+ i32 1) 3))) y (to_rep (first4 (mk1 (+ i32 1) 3)))
