...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral4) (= (tqtreal fliteral4) 7800.0)))
...
;; H
  (assert (and (le (neg fliteral4) x) (le x fliteral4)))

;; H
  (assert (and (le (neg fliteral4) y) (le y fliteral4)))

;; H
  (assert (lt (abs1 y) x))

;; H
  (assert (and (= o (mul RNE2 y y)) (tqtisFinite (mul RNE2 y y))))

;; H
  (assert (and (= o1 (mul RNE2 x x)) (tqtisFinite (mul RNE2 x x))))

;; H
  (assert (= o2 (sub RNE2 o1 o)))
...
;; H
  ...
  (and (tqtisFinite o4)
  (and (le fliteral2 o4)
  (and (=> (eq o3 fliteral2) (eq o4 fliteral2))
  (and (=> (eq o3 fliteral) (eq o4 fliteral))
  (=> (le fliteral3 o3) (lt fliteral2 o4))))))))

;; H
  (assert (= o5 (ite (le o4 x) true false)))
...
(assert
;; WP_parameter_def
 ;; File "floating_point.adb", line 320, characters 0-0
  (not (= res1 true)))
(check-sat)
