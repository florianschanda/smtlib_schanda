...
(declare-fun float_tested () t)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun float_ref () t)
...
;; H
  (assert (tqtisFinite float_tested))

;; H
  (assert (tqtisFinite float_ref))

;; H
  (assert (neq float_ref fliteral2))

;; H
  (assert
  (and (= o (sub RNE2 float_tested float_ref)) (tqtisFinite
  (sub RNE2 float_tested float_ref))))

;; H
  (assert (= o1 (abs1 o)))

;; H
  (assert (= o2 (div1 RNE2 o1 float_ref)))
