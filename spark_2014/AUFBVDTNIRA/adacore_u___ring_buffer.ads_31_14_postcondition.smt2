...
;; H
  (assert (=> (and (<= r13b j2) (<= j2 c)) (= j18 (mk_int__ref j4))))

;; H
  (assert (=> (and (<= r13b j2) (<= j2 c)) (= r16 (mk_model_type__ref r4))))
...
;; H
  (assert
  (=> (not (and (<= r13b j2) (<= j2 c))) (= r16 (mk_model_type__ref r))))
...
;; H
  (assert (=> (and (<= 1 j8) (<= j8 r19b)) (= temp___227 r6)))

;; H
  (assert (=> (and (<= 1 j8) (<= j8 r19b)) (= temp___226 j8)))

;; H
  (assert
  (=> (and (<= 1 j8) (<= j8 r19b)) (= (length r8) (+ (- c first) j9))))
...
;; H
  (assert (=> (and (<= 1 j8) (<= j8 r19b)) (= o3 o2)))

;; H
  (assert (=> (and (<= 1 j8) (<= j8 r19b)) (= r8 result3)))

;; H
  (assert (=> (and (<= 1 j8) (<= j8 r19b)) (= r9 o3)))

;; H
  (assert (=> (and (<= 1 j8) (<= j8 r19b)) (= j9 r19b)))

;; H
  (assert (=> (and (<= 1 j8) (<= j8 r19b)) (= j10 (mk_int__ref j9))))

;; H
  (assert (=> (and (<= 1 j8) (<= j8 r19b)) (= r10 (mk_model_type__ref r9))))

;; H
  (assert (=> (and (<= 1 j8) (<= j8 r19b)) (= j11 j9)))

;; H
  (assert (=> (and (<= 1 j8) (<= j8 r19b)) (= r11 r9)))

;; H
  (assert (=> (and (<= 1 j8) (<= j8 r19b)) (= j12 j10)))

;; H
  (assert (=> (and (<= 1 j8) (<= j8 r19b)) (= r12 r10)))

;; H
  (assert (=> (and (<= 1 j8) (<= j8 r19b)) (= j13 j11)))

;; H
  (assert (=> (and (<= 1 j8) (<= j8 r19b)) (= r13 r11)))

;; H
  (assert (=> (not (and (<= 1 j8) (<= j8 r19b))) (= j12 (mk_int__ref j8))))

;; H
  (assert (=> (not (and (<= 1 j8) (<= j8 r19b))) (= r12 r16)))

;; H
  (assert (=> (not (and (<= 1 j8) (<= j8 r19b))) (= j13 j8)))

;; H
  (assert (=> (not (and (<= 1 j8) (<= j8 r19b))) (= r13 r7)))
