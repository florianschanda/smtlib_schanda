...
(define-fun current__split_fields6 () us_split_fields2 (mk___split_fields1
...
;; H
  ...
  (= result2 (has_key
             ...
             (mk___rep container__split_discrs
             (mk___split_fields container__split_fields)))
             (mk___rep1 current__split_fields6)))
  (= (= result2 true)
  (= (has_key
     (positions
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))
     (mk___rep1 current__split_fields6)) true))))
...
;; H
  (assert
  (or
  (= (bool_eq4 (mk___rep1 current__split_fields5)
     (first
     (mk___rep container__split_discrs
  ...
  (< (element
     ...
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields))
     (mk___rep1 current__split_fields5))) new_item)))
...
;; H
  ...
  (= (has_key
     ...
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))
     (mk___rep1 current__split_fields5)) true)
  (< (element
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields))
     (mk___rep1 current__split_fields5)) new_item)))
...
;; H
  (assert
  (ite (= (ite (= (bool_eq4 (mk___rep1 current__split_fields5) no_element) false) (= 
          (get1
          (positions
          (mk___rep container__split_discrs
          (mk___split_fields container__split_fields)))
          (mk___rep1 current__split_fields5)) (length
                                              (mk___rep
                                              container__split_discrs
                                              (mk___split_fields
                                              container__split_fields)))) true) true)
  (= (bool_eq4 (mk___rep1 current__split_fields4) no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep container__split_discrs
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 1572, characters 0-0
  (not
  (or
  (= (bool_eq4 (mk___rep1 current__split_fields4)
     (first
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))) true)
  (< (element
     ...
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields))
     (mk___rep1 current__split_fields4))) new_item))))
(check-sat)
