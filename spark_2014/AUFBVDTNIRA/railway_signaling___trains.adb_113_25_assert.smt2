...
;; H
  (assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___428 track_signals1)))

;; H
  (assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___427 prev)))

;; H
  (assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___426 track_signals1)))

;; H
  (assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___429 track_signals1)))

;; H
  (assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___424 id1)))
...
;; H
  (assert
  (forall ((train1 Int) (id7 Int)) (get_previous_track__function_guard
  (get_previous_track (select trains1 train1) id7) (select trains1 train1)
  id7)))
...
;; H
  (assert
  (forall ((train1 Int) (id7 Int)) (get_other_previous_track__function_guard
  (get_other_previous_track (select trains1 train1) id7)
  (select trains1 train1) id7)))
...
;; H
  ...
  (=> (and (<= 1 id7) (<= id7 3))
  (and
  (=> (not (= (get_previous_track (select trains1 train1) id7) 0))
  (let ((temp___454 (to_rep5
                    (select (map__content4 track_signals6) (get_previous_track
                                                           (select trains1 train1)
                                                           id7)))))
  (or (= temp___454 1) (= temp___454 2))))
  (=> (not (= (get_other_previous_track (select trains1 train1) id7) 0))
  (let ((temp___457 (to_rep5
                    (select (map__content4 track_signals6) (get_other_previous_track
                                                           (select trains1 train1)
                                                           id7)))))
...
;; H
  (assert (safe_signaling__function_guard
  (safe_signaling cur_num_trains trains1 (map__content4 track_signals6))
  cur_num_trains trains1 (map__content4 track_signals6)))

(assert
;; WP_parameter_def
 ;; File "trains.ads", line 191, characters 0-0
  (not
  (= (safe_signaling cur_num_trains trains1 (map__content4 track_signals6)) true)))
(check-sat)
