...
(declare-fun c271b () (Array Int character))
...
(declare-fun temp___1508 () us_t6)

(declare-fun temp___1509 () us_t5)

(declare-fun temp___1513 () us_t5)

(declare-fun o16 () (Array Int character))

(declare-fun o17 () screenycoordt)

(declare-fun o18 () screenxcoordt)
...
(declare-fun c271b1 () (Array Int character))
...
;; H
  ...
  (= (select o2 temp___1488) (select result__4 temp___1488)))))
...
;; H
  ...
  (= (select o9 temp___1501) (select result__6 temp___1501)))))
...
;; H
  (assert (= temp___1508 (mk___t6 o15 (mk6 2 (to_rep1 data__last2)))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 (rt6 temp___1508))) (to_rep1
                                                    (last18
                                                    (rt6 temp___1508))))
     (+ (- (to_rep1 (last18 (rt6 temp___1508))) (to_rep1
                                                (first12 (rt6 temp___1508)))) 1)
...
;; H
  (assert
  (= temp___1509 (mk___t5
                 (slide (elts6 temp___1508)
                 (to_rep1 (first12 (rt6 temp___1508))) 1)
                 (mk5 1 (- (to_rep1 data__last2) 1)))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first10 (rt5 temp___1509))) (to_rep1
                                                    (last15
                                                    (rt5 temp___1509))))
     (+ (- (to_rep1 (last15 (rt5 temp___1509))) (to_rep1
                                                (first10 (rt5 temp___1509)))) 1)
     0) (ite (<= (to_rep1 (first10 (mk5 1 (- (to_rep1 data__last2) 1)))) 
        (to_rep1 (last15 (mk5 1 (- (to_rep1 data__last2) 1)))))
        (+ (- (to_rep1 (last15 (mk5 1 (- (to_rep1 data__last2) 1)))) 
        (to_rep1 (first10 (mk5 1 (- (to_rep1 data__last2) 1))))) 1) 0)))

;; H
  (assert (= temp___1513 temp___1509))

;; H
  (assert
  (forall ((temp___1514 Int))
  (ite (and (<= 1 temp___1514) (<= temp___1514 (- (to_rep1 data__last2) 1)))
  (= (select o16 temp___1514) (select (elts5 temp___1513) temp___1514))
  (= (select o16 temp___1514) (select result__8 temp___1514)))))
...
;; H
  (assert (= o21 (screen__writestatsdata__B284b__result__aggregate_def 32)))

;; H
  (assert (= result16 result__3))

;; H
  (assert (= (let ((subject result__3)) result__10) o21))
