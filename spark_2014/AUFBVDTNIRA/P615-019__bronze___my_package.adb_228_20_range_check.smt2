...
(declare-fun o15 () (Array Int natural))
...
;; H
  (assert
  (and (= o12 (to_rep1 (select a1 1))) (in_range (to_rep1 (select a1 1)))))

;; H
  (assert (= o12 my_package__swap__x))
...
;; H
  (assert
  (and (= o13 my_package__swap__x1) (in_range1 my_package__swap__x1)))

;; H
  (assert (= (to_rep1 o14) o13))

;; H
  (assert (= o15 (store a1 1 o14)))
...
;; WP_parameter_def
 ;; File "my_package.adb", line 195, characters 0-0
  (not (in_range1 my_package__swap__y1)))
(check-sat)
