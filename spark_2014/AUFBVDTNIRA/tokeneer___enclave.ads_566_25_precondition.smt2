...
;; H
  ...
  (= o24 (thecurrentop
         (mk___rep
         (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (thecurrentop__function_guard o24
  (mk___rep
  (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (in_range3 o24))))
...
;; H
  ...
  (= o19 (thecurrentop
         (mk___rep
         (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (thecurrentop__function_guard o19
  (mk___rep
  (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (in_range3 o19)))
...
;; H
  ...
  (statusiswaitingstartadminop__function_guard o22 status))
  (= (= o22 true) (= status 6)))))
...
;; H
  ...
  (statusisshutdown__function_guard result2 status))
...
;; H
  ...
  (= o15 (rolepresent
         (mk___rep
         (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (rolepresent__function_guard o15
  (mk___rep
  (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (in_range1 o15))))
...
;; H
  ...
  (statusisenclavequiescent__function_guard result3 status))
...
;; H
  ...
  (statusiswaitingfinishadminop__function_guard o7 status))
  (= (= o7 true) (= status 7))))
...
;; H
  ...
  (statusiswaitingstartadminop__function_guard o8 status))
  (= (= o8 true) (= status 6))))
...
;; H
  ...
  (statusiswaitingremoveadmintokenfail__function_guard o3 status))
  (= (= o3 true) (= status 4))))

;; H
  (assert
  (and
  (and (= o4 (statusisgotadmintoken status))
  (statusisgotadmintoken__function_guard o4 status))
  (= (= o4 true) (= status 5))))
