...
(declare-fun c3b () us_rep)

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun c4b () us_rep)
...
(declare-fun c10b () us_rep)

(declare-fun attr__ATTRIBUTE_ADDRESS7 () Int)

(declare-fun c11b () us_rep)
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral2) (/ 196000003814697265625.0 10000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral3) (/ 1239999961853027343750.0 100000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral4) (/ 218999996185302734375.0 10000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral5) (/ 4300000190734863281250.0 1000000000000000000000.0))))

(declare-fun p1__split_fields () float)

(declare-fun p1__split_fields1 () float)

(declare-fun p2__split_fields () float)

(declare-fun p2__split_fields1 () float)

(declare-fun left_squared () t)

(declare-fun right_squared () t)
...
(declare-fun temp___523 () float)

(declare-fun temp___5231 () float)
...
(declare-fun temp___524 () float)

(declare-fun temp___5241 () float)
...
(declare-fun p1__split_fields2 () float)

(declare-fun p1__split_fields3 () float)

(declare-fun result2 () float)

(declare-fun result3 () float)

(declare-fun p2__split_fields2 () float)

(declare-fun p2__split_fields3 () float)

(declare-fun result4 () t__ref)

(declare-fun left_squared1 () t)

;; H
  (assert (= (to_rep2 o) fliteral2))

;; H
  (assert (= (to_rep2 o1) fliteral3))
...
;; H
  (assert (= (to_rep2 o4) fliteral4))

;; H
  (assert (= (to_rep2 o5) fliteral5))
...
;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite left_squared)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite right_squared)))
...
;; H
  ...
  (= o8 (mul RNE2
        (to_rep2
        (rec__operator_overload__point__y_coord (us_split_fields1 c3b)))
        (to_rep2
        (rec__operator_overload__point__y_coord (us_split_fields1 c3b)))))
  (tqtisFinite
  (mul RNE2
...
;; H
  ...
  (= o9 (mul RNE2
        (to_rep2
        (rec__operator_overload__point__x_coord (us_split_fields1 c3b)))
        (to_rep2
        (rec__operator_overload__point__x_coord (us_split_fields1 c3b)))))
  (tqtisFinite
  (mul RNE2
...
;; H
  (assert (= o10 (add RNE2 o9 o8)))

;; H
  (assert (and (= o11 o10) (tqtisFinite o10)))
