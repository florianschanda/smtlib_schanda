...
;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= (to_rep o) 1))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3))
  (= o1 (store (get (select x4 i32) i212 i222) i12 o)))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= o2 (set (select x4 i32) i212 i222 o1)))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= o3 (store x4 i32 o2)))))
...
;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= x5 o3))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3))
  (= (bool_eq4 x6 (to_rep (first12 (mk6 (+ i32 1) 3)))
...
;; WP_parameter_def
 ;; File "p.adb", line 1, characters 0-0
  (not
  (= (bool_eq4 (map__content2 x15) (to_rep (first4 (mk2 (+ i32 1) 3)))
     (to_rep (last4 (mk2 (+ i32 1) 3))) x2
     (to_rep (first6 (mk3 (+ i32 1) 3))) (to_rep (last6 (mk3 (+ i32 1) 3)))) true)))
(check-sat)
