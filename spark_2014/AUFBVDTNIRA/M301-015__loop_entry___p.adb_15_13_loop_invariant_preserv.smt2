...
(declare-fun i214 () int__ref)

(declare-fun i227 () int__ref)

(declare-fun i112 () int__ref)
...
;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (= (bool_eq4 x4 (to_rep (first13 (mk4 (+ i32 1) 3)))
...
;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= temp___238 i12))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= temp___233 x4))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= temp___243 x4))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= (to_rep o3) 1))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3))
  (= o4 (store (get (select x4 i32) i212 i222) i12 o3)))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= o5 (set (select x4 i32) i212 i222 o4)))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= o6 (store x4 i32 o5)))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= x4 result5))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= x5 o6))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3))
  (= (bool_eq4 x6 (to_rep (first19 (mk6 (+ i32 1) 3)))
     (to_rep (last12 (mk6 (+ i32 1) 3))) temp___243
     (to_rep (first22 (mk7 (+ i32 1) 3)))
...
;; H
  ...
  (=> (<= 1 3) (in_range2 i13))) (and (<= 1 i13) (<= i13 3))))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= i13 3))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= i13 i14))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= x6 x7))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= i15 i13))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= x8 x6))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= i16 (mk_int__ref i14)))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= x9 (mk_map__ref2 x7)))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= i17 i15))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (and (<= 1 i12) (<= i12 3)) (= x10 x8))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (not (and (<= 1 i12) (<= i12 3))) (= i16 (mk_int__ref i12)))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (not (and (<= 1 i12) (<= i12 3))) (= x9 (mk_map__ref2 x4)))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (not (and (<= 1 i12) (<= i12 3))) (= i17 i12))))

;; H
  (assert
  (=> (and (<= 1 i221) (<= i221 3))
  (=> (not (and (<= 1 i12) (<= i12 3))) (= x10 x4))))
...
;; H
  (assert
  (=> (not (and (<= 1 i221) (<= i221 3))) (= i225 (mk_int__ref i221))))
...
;; WP_parameter_def
 ;; File "p.adb", line 1, characters 0-0
  (not
  (= (bool_eq4 (map__content2 x15) (to_rep (first7 (mk2 (+ i32 1) 3)))
     (to_rep (last4 (mk2 (+ i32 1) 3))) x2
     (to_rep (first10 (mk3 (+ i32 1) 3))) (to_rep (last6 (mk3 (+ i32 1) 3)))) true)))
(check-sat)
