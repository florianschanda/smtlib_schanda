...
;; H
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t))
             (to_rep1
             (rec__search_trees__search_tree__root (us_split_fields7 t)))) j))) true)
  (or
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
  ...
  (= (oeq
     ...
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t))
             (to_rep1
             (rec__search_trees__search_tree__root (us_split_fields7 t)))) j)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (mk___rep2
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             ...
             (rec__search_trees__search_tree__root (us_split_fields7 t)))) j))) true)
  (= (to_rep
     (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j)) 
  (to_rep (select t_old__split_fields3 j))))))
  (= (to_rep
...
;; H
  (assert (=> (and (<= 1 ki1) (<= ki1 100)) (= temp___3508 ki1)))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t))
             (to_rep1
             (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) true)
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t))
  ...
  (= (olt
     ...
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t))
             (to_rep1
             (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t))
  ...
  (ite (= (get
          ...
          (+ (length
             ...
             (select (model__
                     ...
                     (to_rep1
                     (rec__search_trees__search_tree__root
                     (us_split_fields7 t)))) i1)))) 1)) 0)
  (< (to_rep
     (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j)) 
  (to_rep
  (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1)))
  (< (to_rep
     (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1)) 
  (to_rep
  (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j)))))))))))
...
;; H
  (assert
  (=> (and (<= 1 ki1) (<= ki1 100))
  (and (=> (<= 1 100) (in_range3 ki2)) (and (<= 1 ki2) (<= ki2 100)))))
