...
(define-fun dynamic_invariant2 ((temp___expr_405 Int)
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant3 item true true true)
     ...
     (and
     (=> (< 0 result)
     (and (<= result (length1 container)) (= item (get container result))))
...
(declare-fun use_sets__are_disjoint__cu__assume () count_type)

(declare-fun o () Int)

(declare-fun temp___925 () count_type)
...
(declare-fun use_sets__are_disjoint__result () Bool)

(declare-fun result2 () Bool)

(declare-fun use_sets__are_disjoint__result1 () Bool)
...
(define-fun temp___9251 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___925)))

(define-fun use_sets__are_disjoint__cu__assume1 () us_rep1 (mk___rep1
                                                           (mk___split_fields1
                                                           use_sets__are_disjoint__cu__assume)))

;; H
  (assert
  (and (= use_sets__are_disjoint__cu__assume1 (first s1))
  (ite (= (= (length3 s1) 0) true)
  (= (bool_eq3 use_sets__are_disjoint__cu__assume1 no_element) true)
  (and (= (has_key (positions s1) use_sets__are_disjoint__cu__assume1) true)
  (= (get1 (positions s1) use_sets__are_disjoint__cu__assume1) 1)))))
...
;; H
  (assert
  (and (= result1 (has_key (positions s1) (mk___rep1 cu__split_fields6)))
  (= (= result1 true)
  (= (has_key (positions s1) (mk___rep1 cu__split_fields6)) true))))
...
;; H
  (assert (= (has_key (positions s1) (mk___rep1 cu__split_fields5)) true))

;; H
  (assert
  (and (= o (element s1 (mk___rep1 cu__split_fields5)))
  (and (in_range6 o)
  (= o (get (elements s1)
       (get1 (positions s1) (mk___rep1 cu__split_fields5)))))))
...
;; H
  (assert
  (and (= temp___9251 (next s1 (mk___rep1 cu__split_fields5)))
  ...
  (= (bool_eq3 temp___9251 no_element) true)
  (and (= (has_key (positions s1) temp___9251) true)
  (= (get1 (positions s1) temp___9251) (+ (get1 (positions s1)
...
;; H
  (assert (= temp___925 cu__split_fields3))

;; H
  (assert
  (and (= o1 (has_key (positions s1) (mk___rep1 cu__split_fields4)))
  (= (= o1 true)
...
(assert
;; WP_parameter_def
 ;; File "use_sets.ads", line 33, characters 0-0
