...
;; H
  ...
  (= (length (mk___rep l__split_discrs l__split_fields16)) (+ (length
                                                              ...
                                                              (mk___split_fields
                                                              l__split_fields))) 1))
  (ite (= (bool_eq3 cu no_element) true)
  (and
  (and
  (and
  (and
...
;; H
  ...
  (and (not (= (has_key o10 no_element) true))
  (forall ((i1 us_rep1))
  (=> (= (has_key o10 i1) true)
  (and
  (and (<= 1 (get1 o10 i1))
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o10 j) true)
  (=> (= (get1 o10 i1) (get1 o10 j)) (= (bool_eq3 i1 j) true))))))))))
...
;; H
  ...
  (and (in_range5 o14)
  (=> (= (of_int 0) true)
  (and (= o14 (w_get o10 (witness o10 cu)))
  (forall ((k us_rep1))
  (=> (= (has_key o10 k) true)
  (= (= (bool_eq3 k cu) true) (= (witness o10 cu) (witness o10 k))))))))))
...
;; H
  ...
  (= o8 (positions
        (mk___rep l__split_discrs (mk___split_fields l__split_fields8))))
  (and (not (= (has_key o8 no_element) true))
  (forall ((i1 us_rep1))
  (=> (= (has_key o8 i1) true)
  (and
  (and (<= 1 (get1 o8 i1))
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o8 j) true)
  (=> (= (get1 o8 i1) (get1 o8 j)) (= (bool_eq3 i1 j) true))))))))))

;; H
  (assert
  (and (= o9 (has_key o8 cu))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o8 k) true) (= (bool_eq3 k cu) true))) (= o9 true)))))
...
;; H
  ...
  (= o3 (length
        (mk___rep l__split_discrs (mk___split_fields l__split_fields8))))
  (and (in_range2 o3)
  (<= o3 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
