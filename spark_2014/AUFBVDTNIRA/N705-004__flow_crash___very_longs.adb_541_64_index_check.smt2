...
(declare-fun temp___1116 () (_ BitVec 16))

(declare-fun temp___1115 () Int)

(declare-fun temp___1114 () us_rep)

(declare-fun temp___1113 () us_rep1)

(declare-fun temp___1112 () (_ BitVec 16))
...
;; H
  (assert (= temp___1116 q_hat))

;; H
  (assert (= temp___1115 j1))

;; H
  (assert
  (= temp___1114 (mk___rep quotient__split_discrs quotient__split_fields2)))

;; H
  (assert (= temp___1113 (mk___rep1 u__split_discrs u__split_fields2)))

;; H
  (assert (= temp___1112 current_borrow))
...
;; H
  (assert (dynamic_property2 1 last3 r144b))
...
;; H
  ...
  true)
  (forall ((temp___1123 Int))
  (=>
  (and
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))) temp___1123)
  (<= temp___1123 (to_rep2
                  (last1
                  (rt
                  (rec__very_longs__very_long__long_digits
                  remainder__split_fields3))))))
  (=> (<= divisor_index2 temp___1123)
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             remainder__split_fields3)) temp___1123) (select (elts
                                                             (rec__very_longs__very_long__long_digits
                                                             remainder__split_fields2)) temp___1123))))))
