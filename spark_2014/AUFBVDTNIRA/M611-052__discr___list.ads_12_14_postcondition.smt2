...
;; H
  (assert (=> (and (<= r7b i8) (<= i8 r8b)) (= temp___493 i8)))
...
;; H
  (assert (=> (and (<= r7b i8) (<= i8 r8b)) (= result3 res__split_fields12)))
...
;; H
  (assert (=> (and (<= r7b i8) (<= i8 r8b)) (= result4 s__split_fields8)))
...
;; H
  (assert (=> (and (<= r7b i8) (<= i8 r8b)) (= i9 r8b)))

;; H
  (assert (=> (and (<= r7b i8) (<= i8 r8b)) (= i10 (mk_int__ref i9))))
...
;; H
  (assert (=> (and (<= r7b i8) (<= i8 r8b)) (= i11 i9)))
...
;; H
  (assert
  (=> (and (<= r7b i8) (<= i8 r8b)) (= s__split_fields13 s__split_fields11)))

;; H
  (assert (=> (and (<= r7b i8) (<= i8 r8b)) (= i12 i10)))
...
;; H
  (assert
  (=> (and (<= r7b i8) (<= i8 r8b)) (= s__split_fields14 s__split_fields12)))

;; H
  (assert (=> (and (<= r7b i8) (<= i8 r8b)) (= i13 i11)))
...
;; H
  (assert
  (=> (and (<= r7b i8) (<= i8 r8b)) (= s__split_fields15 s__split_fields13)))

;; H
  (assert (=> (not (and (<= r7b i8) (<= i8 r8b))) (= i12 (mk_int__ref i8))))

;; H
  (assert
  (=> (not (and (<= r7b i8) (<= i8 r8b)))
...
;; H
  (assert (=> (not (and (<= r7b i8) (<= i8 r8b))) (= i13 i8)))
...
;; H
  (assert
  (= (mk___rep1 (mk___split_discrs1 result6) (mk___split_fields1 result7)) 
