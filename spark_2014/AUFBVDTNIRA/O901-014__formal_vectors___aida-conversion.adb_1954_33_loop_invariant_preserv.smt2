...
(define-fun tint_arrayD1__ref_20__projection ((a tint_arrayD1__ref)) integer 
...
(define-fun tint_arrayT__ref_20__projection ((a tint_arrayT__ref)) us_t1 
...
(declare-datatypes ()
((t661b__ref (mk_t661b__ref (t661b__content integer)))))
(define-fun t661b__ref___projection ((a t661b__ref)) integer (t661b__content
                                                             a))
...
(define-fun tnumber_array_typeD1__ref_29__projection ((a tnumber_array_typeD1__ref)) integer 
...
(define-fun number_array_type__ref_29__projection ((a number_array_type__ref)) us_t3 
...
(declare-datatypes ()
((t665b__ref (mk_t665b__ref (t665b__content integer)))))
(define-fun t665b__ref___projection ((a t665b__ref)) integer (t665b__content
                                                             a))
...
(declare-datatypes ()
((t667b__ref (mk_t667b__ref (t667b__content integer)))))
(define-fun t667b__ref___projection ((a t667b__ref)) integer (t667b__content
                                                             a))
...
(define-fun tint_arrayB__ref_20__projection ((a tint_arrayB__ref)) us_t5 
  (tint_arrayB__content a))

(declare-fun aida__conversion__calculate_negative_target_length_9__int_array__aggregate_def (Int
  Int Int Int Int Int Int Int Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___2554 Int) (temp___2555 Int) (temp___2556 Int)
  (temp___2557 Int) (temp___2558 Int) (temp___2559 Int) (temp___2560 Int)
  (temp___2561 Int) (temp___2562 Int) (temp___2563 Int))
  (let ((temp___2553 (aida__conversion__calculate_negative_target_length_9__int_array__aggregate_def
                     temp___2554 temp___2555 temp___2556 temp___2557
                     temp___2558 temp___2559 temp___2560 temp___2561
                     temp___2562 temp___2563)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 8)
  temp___2562 temp___2563)
  (and (= (first7 temp___2553) temp___2562)
  (= (last7 temp___2553) temp___2563)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___2553) (+ (+ (first1 source) 1) 0)) (of_rep1
                                                                  temp___2554))
  (= (select (to_array2 temp___2553) (+ (+ (first1 source) 1) 1)) (of_rep1
                                                                  temp___2555)))
  (= (select (to_array2 temp___2553) (+ (+ (first1 source) 1) 2)) (of_rep1
                                                                  temp___2556)))
  (= (select (to_array2 temp___2553) (+ (+ (first1 source) 1) 3)) (of_rep1
                                                                  temp___2557)))
  (= (select (to_array2 temp___2553) (+ (+ (first1 source) 1) 4)) (of_rep1
                                                                  temp___2558)))
  (= (select (to_array2 temp___2553) (+ (+ (first1 source) 1) 5)) (of_rep1
                                                                  temp___2559)))
  (= (select (to_array2 temp___2553) (+ (+ (first1 source) 1) 6)) (of_rep1
                                                                  temp___2560)))
  (= (select (to_array2 temp___2553) (+ (+ (first1 source) 1) 7)) (of_rep1
                                                                  temp___2561)))))))
...
(define-fun tnumber_array_typeB__ref_29__projection ((a tnumber_array_typeB__ref)) us_t6 
  (tnumber_array_typeB__content a))

(declare-fun aida__conversion__calculate_negative_target_length_9__n__aggregate_def (Int
  Int Int) us_t4)

;; def_axiom
  (assert
  (forall ((temp___2569 Int) (temp___2570 Int) (temp___2571 Int))
  (let ((temp___2568 (aida__conversion__calculate_negative_target_length_9__n__aggregate_def
                     temp___2569 temp___2570 temp___2571)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 8)
  temp___2570 temp___2571)
  (and (= (first13 temp___2568) temp___2570)
  (= (last13 temp___2568) temp___2571)))
  (forall ((temp___2572 Int))
  (= (select (to_array4 temp___2568) temp___2572) (of_rep1 temp___2569)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_843 us_t3)
  ...
  (temp___do_toplevel_842 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 1)
                                      (+ (first1 source) 8)
                                      (first10 temp___expr_843)
                                      (last10 temp___expr_843))
                                      (and
                                      (= (first10 temp___expr_843) (+ 
                                      (first1 source) 1))
                                      (= (last10 temp___expr_843) (+ 
...
(declare-fun temp___2566 () (Array Int integer))

(declare-fun temp___25661 () t2)

(declare-fun aida__conversion__calculate_negative_target_length_9__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_length_9__int_array__assume1 () t1)

(declare-fun temp___2574 () (Array Int integer))

(declare-fun temp___25741 () t4)

(declare-fun aida__conversion__calculate_negative_target_length_9__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_length_9__n__assume1 () t3)

(declare-fun temp___2580 () Int)

(declare-fun temp___2581 () Int)
...
;; H
  ...
  (<= index4 (+ (to_rep1 (first (rt source))) 8)))
...
;; H
  ...
  (= (to_rep1
     (first6
     (rt2
     (aida__conversion__calculate_negative_target_length_9__int_array__aggregate_def
     9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1)
     (+ (+ (to_rep1 (first (rt source))) 1) 7))))) (+ (to_rep1
                                                      (first (rt source))) 1)))
...
;; H
  (assert
  (= (mk___t2 temp___2566 temp___25661) (aida__conversion__calculate_negative_target_length_9__int_array__aggregate_def
                                        9 9 9 9 9 9 9 9
                                        (+ (to_rep1 (first (rt source))) 1)
                                        (+ (+ (to_rep1 (first (rt source))) 1) 7))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___25661)) (to_rep1 (last6 temp___25661)))
     (+ (- (to_rep1 (last6 temp___25661)) (to_rep1 (first6 temp___25661))) 1)
...
;; H
  (assert
  (= (slide1 temp___2566 (to_rep1 (first6 temp___25661))
     (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_9__int_array__assume))

;; H
  (assert
  (= (mk1 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 8)) aida__conversion__calculate_negative_target_length_9__int_array__assume1))
...
;; H
  (assert
  (= int_array1 aida__conversion__calculate_negative_target_length_9__int_array__assume))

;; H
  (assert
  (= (to_rep1 int_array__first) (to_rep1
                                (first3
                                aida__conversion__calculate_negative_target_length_9__int_array__assume1))))
...
;; H
  ...
  (+ (to_rep1 (first (rt source))) 8) (to_rep1 int_array__first)
  (to_rep1 int_array__last))
  (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 1))
  (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 8)))))
...
;; H
  ...
  (= (to_rep1
     (first12
     (rt4
     (aida__conversion__calculate_negative_target_length_9__n__aggregate_def
     0 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 8))))) (+ (to_rep1 (first (rt source))) 1)))
...
;; H
  ...
  (= (to_rep1
     ...
     (aida__conversion__calculate_negative_target_length_9__n__aggregate_def
     0 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 8))))) (+ (to_rep1 (first (rt source))) 8)))

;; H
  (assert
  (= (mk___t4 temp___2574 temp___25741) (aida__conversion__calculate_negative_target_length_9__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 1)
                                        (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___25741)) (to_rep1
                                               (last12 temp___25741)))
     (+ (- (to_rep1 (last12 temp___25741)) (to_rep1 (first12 temp___25741))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1
                                                        (first (rt source))) 8))
        (+ (- (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1
                                                     (first (rt source))) 1)) 1)
...
;; H
  (assert
  (= (slide1 temp___2574 (to_rep1 (first12 temp___25741))
     (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_9__n__assume))

;; H
  (assert
  (= (mk3 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 8)) aida__conversion__calculate_negative_target_length_9__n__assume1))
...
;; H
  (assert
  (= n1 aida__conversion__calculate_negative_target_length_9__n__assume))

;; H
  (assert
  (= (to_rep1 n__first) (to_rep1
                        (first9
                        aida__conversion__calculate_negative_target_length_9__n__assume1))))
...
;; H
  (assert
  (and (= temp___2580 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (= temp___2581 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))
...
;; H
  (assert (= index1 temp___2580))

;; H
  (assert (<= temp___2580 index1))

;; H
  (assert (<= index1 temp___2581))
...
;; H
  ...
  (and
  (=>
  (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8))
  (dynamic_property9 (+ (to_rep1 (first (rt source))) 1)
  (+ (to_rep1 (first (rt source))) 8) index2))
  (forall ((temp___2579 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___2579)
  (<= temp___2579 (to_rep1 n__last)))
  (=> (< index2 temp___2579)
  (= (select n3 temp___2579) (select n1 temp___2579))))))
  (and (<= (+ (to_rep1 (first (rt source))) 1) index2)
  (<= index2 (+ (to_rep1 (first (rt source))) 8)))))

;; H
  (assert (not (= index2 temp___2581)))
...
(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 1880, characters 0-0
