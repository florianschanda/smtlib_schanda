...
;; H
  (assert (and (= o9 i) (in_range4 i)))

;; H
  (assert
  (and (= o8 (keys (mk___rep s__split_discrs s__split_fields2)))
  (and
  (and
  (and (= (length3 o8) (length (mk___rep s__split_discrs s__split_fields2)))
  (forall ((temp___396 Int))
  (=> (and (in_range4 temp___396) (= (iter_has_element o8 temp___396) true))
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2))
     (get1 o8 temp___396)) true))))
  (forall ((key2 Int))
  (=>
  (and (in_range2 key2)
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) key2) true))
  (and (< 0 (find o8 key2))
  (= (equivalent_keys (get1 o8 (find o8 key2)) key2) true)))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s__split_discrs s__split_fields2))))
  (and (= (find o8 (get1 o8 i1)) i1) (= (k_is_find o8 (get1 o8 i1) i1) true)))))))

;; H
  (assert (and (= o10 (get1 o8 o9)) (in_range5 o10)))

;; H
  (assert
  (and
  (= o11 (get (model__ (mk___rep s__split_discrs s__split_fields2)) o10))
  (and (in_range8 o11)
  (= o11 (get (model__ (mk___rep s__split_discrs s__split_fields2)) o10)))))
