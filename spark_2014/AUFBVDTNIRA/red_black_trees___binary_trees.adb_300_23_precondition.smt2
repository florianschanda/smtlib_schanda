...
;; H
  (assert
  (and
  (and (= result (tree_structure f1)) (tree_structure__function_guard 
  result f1))
  (= (= result true)
  (and
  (and
  ...
  (=>
  (and
  (<= (+ (to_rep (rec__binary_trees__forest__s (us_split_fields5 f1))) 1) i1)
  (<= i1 100))
  (= (bool_eq8
  ...
  (<= (to_rep
      ...
      (us_split_fields3
      (select (rec__binary_trees__forest__c (us_split_fields5 f1)) i1)))) 
  (to_rep (rec__binary_trees__forest__s (us_split_fields5 f1))))))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (and
  (<= 0 (to_rep
  ...
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3
     (select (rec__binary_trees__forest__c (us_split_fields5 f1)) i1)))) 2)
  (= (to_rep
     (rec__binary_trees__cell__parent
     (us_split_fields3
     (select (rec__binary_trees__forest__c (us_split_fields5 f1)) i1)))) 0)))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (not
  ...
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3
     (select (rec__binary_trees__forest__c (us_split_fields5 f1)) (to_rep
                                                                  (rec__binary_trees__cell__left
                                                                  (us_split_fields3
                                                                  (select 
                                                                  (rec__binary_trees__forest__c
  ...
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3
     (select (rec__binary_trees__forest__c (us_split_fields5 f1)) i1)))) 1))
  (= (to_rep
     (rec__binary_trees__cell__right
     (us_split_fields3
     (select (rec__binary_trees__forest__c (us_split_fields5 f1)) (to_rep
...
;; H
  (assert
  (and
  (and (= result1 (tree_structure f2)) (tree_structure__function_guard
  result1 f2))
  (= (= result1 true)
  (and
  (and
  ...
  (=>
  (and
  (<= (+ (to_rep (rec__binary_trees__forest__s (us_split_fields5 f2))) 1) i1)
  (<= i1 100))
  (= (bool_eq8
     (select (rec__binary_trees__forest__c (us_split_fields5 f2)) i1)
     (mk___rep1
     (mk___split_fields1 (of_rep 0) (of_rep 0) (of_rep 0) (of_rep1 2)))) true)))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  ...
  (<= (to_rep
      ...
      (us_split_fields3
      (select (rec__binary_trees__forest__c (us_split_fields5 f2)) i1)))) 
  (to_rep (rec__binary_trees__forest__s (us_split_fields5 f2))))))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (and
  (<= 0 (to_rep
  ...
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3
     (select (rec__binary_trees__forest__c (us_split_fields5 f2)) i1)))) 2)
  (= (to_rep
     (rec__binary_trees__cell__parent
     (us_split_fields3
     (select (rec__binary_trees__forest__c (us_split_fields5 f2)) i1)))) 0)))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (not
  ...
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3
     (select (rec__binary_trees__forest__c (us_split_fields5 f2)) (to_rep
                                                                  (rec__binary_trees__cell__left
                                                                  (us_split_fields3
                                                                  (select 
                                                                  (rec__binary_trees__forest__c
  ...
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3
     (select (rec__binary_trees__forest__c (us_split_fields5 f2)) i1)))) 1))
  (= (to_rep
     (rec__binary_trees__cell__right
     (us_split_fields3
     (select (rec__binary_trees__forest__c (us_split_fields5 f2)) (to_rep
