...
(declare-fun temp___1814 () (Array Int us_rep1))
...
(declare-fun o35 () us_rep6)

(declare-fun o36 () us_split_fields10)

(declare-fun o37 () extended_index_type)
...
;; H
  (assert
  (forall ((i16 Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i16 0)
  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i16 0)))

;; H
  (assert
  (forall ((i16 Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i16 1)
  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i16 1)))
...
;; H
  ...
  (<= (to_rep
      (rec__red_black_trees__black_count__count
      (us_split_fields11 (select res2 i16)))) (to_rep
                                              (rec__red_black_trees__black_count__depth
                                              (us_split_fields11
                                              (select res2 i16)))))))))
...
;; H
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res2 i16)))) 100)
  (<= (to_rep
      (rec__red_black_trees__black_count__depth
      (us_split_fields11 (select res2 i16)))) n2))))))
...
;; H
  ...
  (=> (and (<= 1 i16) (<= i16 100))
  (ite (and
       (= (rec__tree_model__path_type__k (us_split_fields1 (select m i16))) true)
       (< n2 (to_rep
             (rec__red_black_trees__black_count__depth
             (us_split_fields11 (select res2 i16))))))
  (< (length
     (rec__tree_model__path_type__a (us_split_fields1 (select m i16)))) (- 100 
  n2))
  (=>
  (= (rec__tree_model__path_type__k (us_split_fields1 (select m i16))) true)
  (and
  ...
  (=
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select res2 i16))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11
     (select res2 (peek
                  ...
                  i16 0))))) (to_rep
                             ...
                             (select res2 (peek
                                          (rec__red_black_trees__rbt__struct
                                          (us_split_fields9 t)) i16 1))))))))
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res2 i16)))) (+ 1 (ite (< (to_rep
                                                          (rec__red_black_trees__black_count__depth
                                                          (us_split_fields11
                                                          (select res2 
                                                          (peek
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select res2 i16)))) (+ (ite (= (to_rep3
...
;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (and (<= 1 i4) (<= i4 100)) (= temp___1767 i4))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (and (<= 1 i4) (<= i4 100)) (= temp___1765 res2))))
...
;; H
  ...
  (<= (to_rep
      (rec__red_black_trees__black_count__count
      (us_split_fields11 (select res3 i16)))) (to_rep
                                              (rec__red_black_trees__black_count__depth
                                              (us_split_fields11
                                              (select res3 i16))))))))))
...
;; H
  ...
  (=> (<= 1 100) (in_range2 i5))) (and (<= 1 i5) (<= i5 100))))))
...
;; H
  ...
  (=> (and (<= 1 i4) (<= i4 100))
  (=>
  (= (rec__tree_model__path_type__k (us_split_fields1 (select m i5))) true)
  (and
  (and
  (= o17 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i5 1))
...
;; H
  ...
  (and
  (and
  (= o18 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i5 0))
...
;; H
  ...
  (= o20 (mk___split_fields5
         (rec__red_black_trees__black_count__status
         (us_split_fields11 (select res3 i5))) o19
         (rec__red_black_trees__black_count__count
...
;; H
  ...
  (= res5 (store res4 i5 (mk___rep5
                         ...
                         true false)
                         (rec__red_black_trees__black_count__depth
                         (us_split_fields11 (select res4 i5)))
                         (rec__red_black_trees__black_count__count
                         (us_split_fields11 (select res4 i5))))))))))))
...
;; H
  ...
  (= o25 (mk___split_fields5
         (rec__red_black_trees__black_count__status
         (us_split_fields11 (select res5 i5)))
         (rec__red_black_trees__black_count__depth
         (us_split_fields11 (select res5 i5))) o24))))))))
...
;; H
  ...
  (= o29 (mk___split_fields5
         ...
         (us_split_fields11 (select res5 i5)))
         (rec__red_black_trees__black_count__depth
         (us_split_fields11 (select res5 i5))) o28))))))))
...
;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (= i5 100))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (and (<= 1 i4) (<= i4 100)) (= i6 (mk_int__ref i5)))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (and (<= 1 i4) (<= i4 100)) (= res8 (mk_map__ref4 res6)))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (= i7 i5))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (and (<= 1 i4) (<= i4 100)) (= res9 res6))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (= i8 i6))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (and (<= 1 i4) (<= i4 100)) (= res10 res8))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i4) (<= i4 100)) (= i9 i7))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (and (<= 1 i4) (<= i4 100)) (= res11 res9))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (not (and (<= 1 i4) (<= i4 100))) (= i8 (mk_int__ref i4)))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (not (and (<= 1 i4) (<= i4 100))) (= res10 (mk_map__ref4 res2)))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (not (and (<= 1 i4) (<= i4 100))) (= i9 i4))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (not (and (<= 1 i4) (<= i4 100))) (= res11 res2))))
...
;; H
  ...
  (= temp___1814 (model__
                 (rec__red_black_trees__rbt__struct (us_split_fields9 t))))
  (model____function_guard temp___1814
  (rec__red_black_trees__rbt__struct (us_split_fields9 t))))
  (and (dynamic_invariant1 temp___1814 true false true)
  (= temp___1814 (model__1
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7
                 (rec__red_black_trees__rbt__struct (us_split_fields9 t))))
                 (to_rep
...
;; H
  (assert (= o32 (select temp___1814 i1)))
...
;; H
  ...
  (and
  (and
  (= o34 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 0))
  (peek__function_guard o34
...
;; H
  (assert
  (= o35 (select (map__content4 red_black_trees__nb_blacks__result4) 
  o34)))
...
;; H
  (assert (= o37 (rec__red_black_trees__black_count__count o36)))
