...
;; H
  (assert
  (and (= o36 (from_word32 carry22)) (from_word32__function_guard o36
  carry22)))
...
;; H
  (assert
  (and (= o34 (from_word32 carry12)) (from_word32__function_guard o34
  carry12)))

;; H
  (assert (and (= o38 (oadd o34 o37)) (oadd__function_guard o38 o34 o37)))
...
;; H
  (assert
  (and (= o33 (oexpon o28 o32)) (oexpon__function_guard o33 o28 o32)))

;; H
  (assert
  (and (= o39 (omultiply o33 o38)) (omultiply__function_guard o39 o33 o38)))
...
;; H
  ...
  (= o27 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))
         a_first o26))
  (num_of_big_int__function_guard o27
  (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o26)))

;; H
  (assert (and (= o40 (oadd o27 o39)) (oadd__function_guard o40 o27 o39)))
...
;; H
  (assert
  (and (= o21 (from_word32 carry2)) (from_word32__function_guard o21 carry2)))

;; H
  (assert
  (and (and (= o20 (base Tuple0)) (base__function_guard o20 Tuple0))
  (= o20 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o22 (omultiply o20 o21)) (omultiply__function_guard o22 o20 o21)))

;; H
  (assert
  (and (= o19 (from_word32 carry1)) (from_word32__function_guard o19 carry1)))

;; H
  (assert (and (= o18 (from_word32 y)) (from_word32__function_guard o18 y)))
