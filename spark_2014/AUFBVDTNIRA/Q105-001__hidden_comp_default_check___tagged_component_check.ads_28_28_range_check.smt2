...
((us_split_fields
 (mk___split_fields
 (rec__tagged_component_check__q__p2__root__f natural)(rec__ext__ us_private)))))
...
((us_split_fields2
 (mk___split_fields1
 (rec__tagged_component_check__q__p2__c__g natural)(rec__tagged_component_check__q__p2__root__f1 natural)(rec__ext__1 us_private)))))
(define-fun us_split_fields_G2__projection ((a us_split_fields2)) natural 
  (rec__tagged_component_check__q__p2__c__g a))

(define-fun us_split_fields_F4__projection ((a us_split_fields2)) natural 
...
(define-fun us_rep_8__projection ((a us_rep1)) Int (attr__tag1 a))
...
(define-fun c__ref_2__projection ((a c__ref)) us_rep1 (c__content a))
...
;; H
  (assert
  (and (and (= o (hide 3)) (hide__function_guard o 3)) (in_range1 o)))
