...
(define-fun bool_eq2 ((a (Array Int cell)) (a__first Int) (a__last Int)
...
(declare-fun dummy2 () (Array Int cell))
...
(define-fun bool_eq3 ((a (Array Int (Array Int cell))) (a__first Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq2 (select a temp___idx_140) 1 10
...
(declare-fun new_board () (Array Int (Array Int cell)))

(declare-fun attr__ATTRIBUTE_ADDRESS6 () Int)

(declare-fun new_cur_state () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS7 () Int)

(declare-fun new_cur_piece () us_rep)

(declare-fun attr__ATTRIBUTE_ADDRESS8 () Int)

(declare-fun new_next_piece () us_rep)
...
(declare-fun user_eq10 (x_coord x_coord) Bool)

(declare-fun dummy10 () x_coord)
...
(declare-fun user_eq11 (y_coord y_coord) Bool)

(declare-fun dummy11 () y_coord)
...
(declare-fun result1 () shape)

(declare-fun result2 () direction)

(declare-fun result3 () px_coord)

(declare-fun result4 () py_coord)

(declare-fun cur_piece__split_fields4 () shape)

(declare-fun cur_piece__split_fields5 () direction)

(declare-fun cur_piece__split_fields6 () px_coord)

(declare-fun cur_piece__split_fields7 () py_coord)

(declare-fun result5 () shape)

(declare-fun result6 () direction)

(declare-fun result7 () px_coord)

(declare-fun result8 () py_coord)

(declare-fun next_piece__split_fields4 () shape)

(declare-fun next_piece__split_fields5 () direction)

(declare-fun next_piece__split_fields6 () px_coord)

(declare-fun next_piece__split_fields7 () py_coord)
...
(declare-fun cur_piece__split_fields8 () shape)

(declare-fun cur_piece__split_fields9 () direction)

(declare-fun cur_piece__split_fields10 () px_coord)

(declare-fun cur_piece__split_fields11 () py_coord)

(declare-fun next_piece__split_fields8 () us_split_fields__ref)

(declare-fun cur_state2 () int__ref)

(declare-fun action_request_nbr2 () int__ref)

(declare-fun speed_up2 () bool__ref)

(declare-fun cur_board3 () (Array Int (Array Int cell)))

(declare-fun cur_piece__split_fields12 () us_split_fields)

(declare-fun next_piece__split_fields9 () us_split_fields)

(declare-fun cur_state3 () Int)

(declare-fun action_request_nbr3 () Int)

(declare-fun speed_up3 () Bool)

(define-fun next_piece__split_fields10 () us_split_fields (mk___split_fields
                                                          next_piece__split_fields4
                                                          next_piece__split_fields5
                                                          next_piece__split_fields6
                                                          next_piece__split_fields7))

(define-fun cur_piece__split_fields13 () us_split_fields (mk___split_fields
                                                         cur_piece__split_fields4
                                                         cur_piece__split_fields5
                                                         cur_piece__split_fields6
...
;; H
  (assert (in_range7 new_cur_state))

;; H
  (assert
  (= (valid_configuration new_board new_cur_state new_cur_piece) true))

;; H
  (assert (= result cur_board))

;; H
  (assert (= cur_board1 new_board))

;; H
  (assert (= result1 cur_piece__split_fields))

;; H
  (assert (= result2 cur_piece__split_fields1))

;; H
  (assert (= result3 cur_piece__split_fields2))

;; H
  (assert (= result4 cur_piece__split_fields3))

;; H
  (assert (= cur_piece__split_fields13 (us_split_fields1 new_cur_piece)))

;; H
  (assert (= result5 next_piece__split_fields))

;; H
  (assert (= result6 next_piece__split_fields1))

;; H
  (assert (= result7 next_piece__split_fields2))

;; H
  (assert (= result8 next_piece__split_fields3))

;; H
  (assert (= next_piece__split_fields10 (us_split_fields1 new_next_piece)))

;; H
  (assert (= result9 cur_state))

;; H
  (assert (= cur_state1 new_cur_state))

;; H
  (assert (= result10 speed_up))

;; H
  (assert (= speed_up1 (of_int 0)))

;; H
  (assert (= result11 action_request_nbr))
...
;; H
  (assert
  (= next_piece__split_fields8 (mk___split_fields__ref
                               next_piece__split_fields10)))

;; H
  (assert (= cur_piece__split_fields8 cur_piece__split_fields4))

;; H
  (assert (= cur_piece__split_fields9 cur_piece__split_fields5))

;; H
  (assert (= cur_piece__split_fields10 cur_piece__split_fields6))

;; H
  (assert (= cur_piece__split_fields11 cur_piece__split_fields7))
...
;; H
  (assert (= next_piece__split_fields9 next_piece__split_fields10))

;; H
  (assert (= cur_piece__split_fields12 cur_piece__split_fields13))
...
;; WP_parameter_def
 ;; File "patris.ads", line 196, characters 0-0
  ...
  (= (valid_configuration__2 (int__content cur_state2)
     ...
     cur_piece__split_fields10 cur_piece__split_fields11) cur_board2
     (us_split_fields__content next_piece__split_fields8)
     (bool__content speed_up2) (int__content action_request_nbr2)) true)))
(check-sat)
