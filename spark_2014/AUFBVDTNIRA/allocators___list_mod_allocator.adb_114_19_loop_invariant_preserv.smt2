...
;; H
  (assert (contains__function_guard1 (contains1 (sequence__content avail4) e)
  (sequence__content avail4) e))
...
;; H
  (assert (not (= (contains1 (sequence__content avail4) e) true)))

(assert
;; WP_parameter_def
 ;; File "list_mod_allocator.ads", line 36, characters 0-0
  (not (= (contains (set__content unseen11) e) true)))
(check-sat)
