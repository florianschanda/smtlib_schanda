...
;; H
  (assert
  (and (= o4 (cos1 f23))
  (and (tqtisFinite o4) (lt (abs1 (sub RNE1 o4 (approx_cos f23))) fliteral2))))

;; H
  (assert
  (and (= o3 (sin1 f23))
  (and (tqtisFinite o3) (lt (abs1 (sub RNE1 o3 (approx_sin f23))) fliteral2))))

;; H
  (assert (= o5 (div1 RNE1 o3 o4)))
