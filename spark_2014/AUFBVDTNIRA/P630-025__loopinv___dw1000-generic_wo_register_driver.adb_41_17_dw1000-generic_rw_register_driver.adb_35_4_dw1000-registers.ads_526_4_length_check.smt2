...
(define-fun dynamic_invariant ((temp___expr_6224 us_t1)
  ...
  (temp___do_toplevel_6223 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_6224))
                                       (and (= (first3 temp___expr_6224) 1)
                                       (= (last4 temp___expr_6224) 2)))))
...
(define-fun dynamic_invariant1 ((temp___expr_6241 us_t2)
  ...
  (temp___do_toplevel_6240 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_6241))
                                       (and (= (first5 temp___expr_6241) 1)
                                       (= (last6 temp___expr_6241) 2)))))
...
;; H
  (assert
  (and
  (and (= temp___79612 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___79612 reg)) (dynamic_invariant1
  temp___79612 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___79611)) (to_rep (last5 temp___79611)))
     (+ (- (to_rep (last5 temp___79611)) (to_rep (first4 temp___79611))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___79611)) (to_rep (last5 temp___79611))) 
  temp___79621))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___79621)) (to_rep (last3 temp___79621)))
     (+ (- (to_rep (last3 temp___79621)) (to_rep (first2 temp___79621))) 1)
