...
;; H
  (assert
  (<= n (last4 (model__ (mk___rep v2__split_discrs v2__split_fields5)))))

;; H
  (assert (is_incr__function_guard
  (is_incr (get (model__ v1) n)
  (get (model__ (mk___rep v2__split_discrs v2__split_fields5)) n))
  (get (model__ v1) n)
  (get (model__ (mk___rep v2__split_discrs v2__split_fields5)) n)))
...
;; WP_parameter_def
 ;; File "use_vectors.ads", line 33, characters 0-0
  (not
  (= (is_incr (get (model__ v1) n)
     (get (model__ (mk___rep v2__split_discrs v2__split_fields5)) n)) true)))
(check-sat)
