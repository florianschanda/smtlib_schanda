...
;; H
  ...
  (=> (not (= (+ (to_rep3 cur_piece__split_fields3) y2) temp___2222))
  (= (select cur_board2 temp___2222) (select cur_board1 temp___2222)))))
  (and (<= 0 x2) (<= x2 2))))
...
;; H
  (assert
  (= temp___2217 (get1 possible_three_shapes o
                 (to_rep4 cur_piece__split_fields1))))

;; H
  (assert (= result2 (get temp___2217 y2 x2)))
