...
;; H
  ...
  (and (in_range1 o)
  (<= o (to_rep (rec__my_lists__m__list__capacity target__split_discrs))))))

;; H
  (assert
  (= o1 (- (to_rep (rec__my_lists__m__list__capacity target__split_discrs)) 
  o)))

(assert
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 1556, characters 0-0
  (not (in_range o1)))
(check-sat)
