...
(define-fun l2__split_fields1 () us_split_fields (mk___split_fields
                                                 l2__split_fields))
...
;; H
  (assert
  (and (= result1 (has_key (positions l1) (mk___rep1 cu__split_fields2)))
  (= (= result1 true)
  (= (has_key (positions l1) (mk___rep1 cu__split_fields2)) true))))
...
;; WP_parameter_def
 ;; File "use_lists.ads", line 23, characters 0-0
  (not
  (= (get1 (positions l1) (mk___rep1 cu__split_fields2)) (+ (length
                                                            (mk___rep
                                                            l2__split_discrs
                                                            l2__split_fields1)) 1))))
(check-sat)
