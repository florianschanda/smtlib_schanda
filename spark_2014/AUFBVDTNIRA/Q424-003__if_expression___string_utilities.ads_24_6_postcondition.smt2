...
(declare-fun temp___278 () (Array Int character))
...
;; H
  ...
  (=> (or (<= x26 temp___259) (not (= x14 temp___258)))
...
;; H
  ...
  (=>
  (not (= (to_rep (select (elts s1) x14)) (to_rep (select (elts s2) x26))))
  (and (= o12 (get_length x14 o11 lengths3))
...
;; H
  ...
  (and (dynamic_property9 1 last11 rx2)
  (and
  (and
  ...
  (=> (<= 1 last11) (dynamic_property9 1 last11 rx3)))
