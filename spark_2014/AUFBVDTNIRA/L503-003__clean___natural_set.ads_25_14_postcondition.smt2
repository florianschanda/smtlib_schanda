...
(declare-fun temp___224 () set_length)

(declare-fun temp___2241 () (Array Int element_t))
...
;; H
  (assert (=> (= result true) (= temp___220 o3)))

;; H
  (assert (=> (= result true) (= temp___2201 o4)))
...
;; H
  (assert (=> (= result true) (= temp___220 s__split_fields4)))

;; H
  (assert (=> (= result true) (= temp___2201 s__split_fields5)))
...
;; H
  (assert (=> (= result true) (= temp___224 o8)))

;; H
  (assert (=> (= result true) (= temp___2241 o9)))
...
;; H
  (assert (=> (= result true) (= temp___224 s__split_fields6)))

;; H
  (assert (=> (= result true) (= temp___2241 s__split_fields7)))
