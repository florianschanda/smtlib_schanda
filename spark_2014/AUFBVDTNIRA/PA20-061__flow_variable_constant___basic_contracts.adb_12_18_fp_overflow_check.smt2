...
;; H
  (assert (= (of_int RNE2 numerator) num))

;; H
  (assert (tqtisFinite num))

;; H
  (assert (tqtisFinite den))

;; H
  (assert (lt fliteral fliteral2))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (tqtisFinite (div1 RNE2 num fliteral2))))
(check-sat)
