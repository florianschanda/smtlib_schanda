...
;; H
  ...
  (= o66 (length
         (rec__list_allocator__m__t__available model____split_fields3)))
  (length__function_guard o66
  (rec__list_allocator__m__t__available model____split_fields3))) (in_range6
  o66))))

;; H
  (assert
  (=> (not (= first_available1 0)) (= result12 (ite (< 0 o66) true false))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result12 true)
  (= result11 (ite (= o65 first_available1) true false)))))
...
;; H
  (assert
  (=> (= result11 true)
  (=> (not (= first_allocated2 0)) (= result13 (ite (< 0 o63) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated2 0))
  (=> (= result13 true)
  (= result10 (ite (= o62 first_allocated2) true false))))))
