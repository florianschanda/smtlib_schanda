...
(declare-fun temp___153 () (Array Int integer))
...
;; H
  (assert
  (forall ((i11 Int))
  (=> (and (<= (to_rep a__first) i11) (<= i11 (to_rep a__last)))
  (< (to_rep (select a i11)) 2147483647))))
...
;; H
  ...
  (and
  (forall ((k Int))
  (=> (and (<= (to_rep a__first) k) (<= k (- i3 1)))
  (= (to_rep (select a2 k)) (+ (to_rep (select temp___155 k)) 1))))
  (forall ((k Int))
  (=> (and (<= i3 k) (<= k (to_rep a__last)))
  (= (to_rep (select a2 k)) (to_rep (select temp___156 k))))))))
...
;; H
  ...
  (to_rep a__first) (to_rep a__last) i3))
  (forall ((temp___154 Int))
  (=>
  (and (<= (to_rep a__first) temp___154) (<= temp___154 (to_rep a__last)))
  (=> (<= i3 temp___154)
  (= (select a2 temp___154) (select temp___153 temp___154))))))
  (and (<= (to_rep a__first) i3) (<= i3 (to_rep a__last))))))

;; H
  (assert
  (=> (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last)))
  (and (= o (+ (to_rep (select a2 i3)) 1)) (in_range1
  (+ (to_rep (select a2 i3)) 1)))))
...
;; H
  (assert
  (=> (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (= a3 o2)))
...
;; H
  (assert
  (=> (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (= i3 i4)))

;; H
  (assert
  (=> (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (= a3 a4)))

;; H
  (assert
  (=> (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (= i5 i3)))

;; H
  (assert
  (=> (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (= a5 a3)))
...
;; H
  (assert
  (=> (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (= i7 i5)))

;; H
  (assert
  (=> (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (= a7 a5)))

;; H
  (assert
  (=> (not (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))))
  (= i2 i6)))
