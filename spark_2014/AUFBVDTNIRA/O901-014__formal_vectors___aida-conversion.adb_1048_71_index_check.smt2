...
;; H
  (assert
  (forall ((j1 Int)) (convert_character_digit_to_integer__function_guard
  (convert_character_digit_to_integer (to_rep (select (elts source) j1)))
...
;; H
  ...
  (=> (< index2 temp___1984)
  (= (select n3 temp___1984) (select n1 temp___1984))))))
