...
(declare-fun static_discr__search_max__result () Int)

(declare-fun temp___320 () natural)

(declare-fun temp___3201 () natural)

(declare-fun temp___3202 () natural)

(declare-fun temp___3203 () natural)

(declare-fun temp___3204 () (Array Int natural))

(declare-fun temp___3205 () natural)
...
(declare-fun current__split_fields5 () natural)

(declare-fun current__split_fields6 () (Array Int natural))

(declare-fun current__split_fields7 () natural)

(declare-fun result4 () int__ref)

(declare-fun result__1 () Int)

(declare-fun current__split_fields8 () us_split_fields8)
...
(declare-fun static_discr__search_max__result1 () Int)

(declare-fun static_discr__search_max__result2 () int__ref)

(declare-fun static_discr__search_max__result3 () Int)

(declare-fun current__split_fields14 () us_split_fields__ref4)

(declare-fun result__8 () int__ref)

(declare-fun static_discr__search_max__result4 () int__ref)

(declare-fun current__split_fields15 () us_split_fields8)

(declare-fun result__9 () Int)

(declare-fun static_discr__search_max__result5 () Int)

(define-fun current__split_fields16 () us_split_fields8 (mk___split_fields4
                                                        (mk___rep3
                                                        (mk___split_discrs
                                                        current__split_fields4
                                                        current__split_fields5)
                                                        (mk___split_fields3
...
;; H
  ...
  (and
  (and
  (= 100 (to_rep (rec__static_discr__holder__unused (us_split_discrs6 a))))
  (= 100 (to_rep (rec__static_discr__holder__c (us_split_discrs6 a)))))
  (and
  (= 100 (to_rep
         (rec__static_discr__i_holder__unused
         (us_split_discrs5
         (rec__static_discr__holder__content1 (us_split_fields9 a))))))
  (= 100 (to_rep
         (rec__static_discr__i_holder__c
         (us_split_discrs5
         (rec__static_discr__holder__content1 (us_split_fields9 a)))))))))
...
;; H
  ...
  (= (mk___split_fields__ref4
     (mk___split_fields4
     (mk___rep3 (mk___split_discrs result result1)
     (mk___split_fields3 result2)) result3)) (mk___split_fields__ref4
                                             (mk___split_fields4
                                             (mk___rep3
                                             (mk___split_discrs
...
;; H
  ...
  (and (= 100 (to_rep current__split_fields4))
  (= 100 (to_rep current__split_fields5)))))
...
;; H
  (assert
  (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7)))
  (and (= current__split_discrs (mk___split_discrs1 temp___320 temp___3201))
  (and
  (and
  (and (= temp___3202 current__split_fields4)
  (= temp___3203 current__split_fields5))
  (= temp___3204 current__split_fields6))
  (= temp___3205 current__split_fields7)))))

;; H
  (assert
  (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7)))
  (= temp___319 result__1)))
...
;; H
  ...
  (and
  (and
  (<= 1 (to_rep (rec__static_discr__holder__length1 current__split_fields8)))
  (<= (to_rep (rec__static_discr__holder__length1 current__split_fields8)) 
  (to_rep (rec__static_discr__holder__length1 (us_split_fields9 a)))))
  (= (bool_eq2
     (rec__static_discr__i_holder__content2
     (us_split_fields7
     ...
     (rec__static_discr__i_holder__content2
     (us_split_fields7
     (rec__static_discr__holder__content1 current__split_fields8))) 1 100) true))
  (forall ((i Int))
  (=>
  (and
  (<= (+ (to_rep (rec__static_discr__holder__length1 current__split_fields8)) 1) i)
  (<= i (to_rep (rec__static_discr__holder__length1 (us_split_fields9 a)))))
  (not
  (= (to_rep
     (select (rec__static_discr__i_holder__content2
             (us_split_fields7
             (rec__static_discr__holder__content1 (us_split_fields9 a)))) i)) 
  e)))))))
...
;; H
  ...
  (= 100 (to_rep
         (rec__static_discr__i_holder__unused
         (us_split_discrs5
         (rec__static_discr__holder__content1 current__split_fields8)))))
  (= 100 (to_rep
         (rec__static_discr__i_holder__c
         (us_split_discrs5
         (rec__static_discr__holder__content1 current__split_fields8)))))))
  (and (= result__2 0)
  (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields8)))))))
...
;; H
  ...
  (= (bool_eq2
     (rec__static_discr__i_holder__content2
     (us_split_fields7
     (rec__static_discr__holder__content1 current__split_fields9))) 1 100
     (rec__static_discr__i_holder__content2
     (us_split_fields7
     (rec__static_discr__holder__content1 current__split_fields8))) 1 100) true)
  (and
  (< (to_rep (rec__static_discr__holder__length1 current__split_fields9)) 
  (to_rep (rec__static_discr__holder__length1 current__split_fields8)))
  (ite (= result__3 0)
  (forall ((i Int))
  (=>
  (and
  (<= (+ (to_rep (rec__static_discr__holder__length1 current__split_fields9)) 1) i)
  (<= i (to_rep (rec__static_discr__holder__length1 current__split_fields8))))
  (not
  (= (to_rep
     (select (rec__static_discr__i_holder__content2
             (us_split_fields7
             (rec__static_discr__holder__content1 current__split_fields9))) i)) 
  e))))
  (and
  (and
  (<= (to_rep (rec__static_discr__holder__length1 current__split_fields9)) 
  result__3)
  (<= result__3 (to_rep
                (rec__static_discr__holder__length1 current__split_fields8))))
  (= (to_rep
     (select (rec__static_discr__i_holder__content2
             (us_split_fields7
             (rec__static_discr__holder__content1 current__split_fields9))) 
     result__3)) e)))))
  (and
  (and
  (= 100 (to_rep
...
;; H
  ...
  (= (bool_eq2
     ...
     (rec__static_discr__i_holder__content2
     (us_split_fields7
     (rec__static_discr__holder__content1 current__split_fields9))) 1 100) true)))
...
;; H
  ...
  (not
  (and (= result__3 0)
  (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields9)))))))
...
;; H
  (assert
  (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7)))
  (= current__split_fields10 (mk___split_fields__ref4 current__split_fields9))))
...
;; H
  (assert
  (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7)))
  (= current__split_fields12 current__split_fields10)))
...
;; H
  (assert
  (=> (and (= result__1 0) (< 0 (to_rep current__split_fields7)))
  (= current__split_fields13 current__split_fields11)))

;; H
  (assert
  (=> (not (and (= result__1 0) (< 0 (to_rep current__split_fields7))))
  (= result__6 (mk_int__ref result__1))))

;; H
  (assert
  (=> (not (and (= result__1 0) (< 0 (to_rep current__split_fields7))))
  (= current__split_fields12 (mk___split_fields__ref4
                             current__split_fields16))))
...
;; H
  (assert
  (=> (not (and (= result__1 0) (< 0 (to_rep current__split_fields7))))
  (= current__split_fields13 current__split_fields16)))

;; H
  (assert
  (= static_discr__search_max__result2 (mk_int__ref
                                       static_discr__search_max__result1)))

;; H
  (assert
  (= static_discr__search_max__result3 static_discr__search_max__result1))
...
;; H
  (assert
  (= static_discr__search_max__result4 static_discr__search_max__result2))
...
;; H
  (assert
  (= static_discr__search_max__result5 static_discr__search_max__result3))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (<= (int__content static_discr__search_max__result4) (to_rep
                                                       (rec__static_discr__holder__length1
                                                       (us_split_fields9 a))))))
(check-sat)
