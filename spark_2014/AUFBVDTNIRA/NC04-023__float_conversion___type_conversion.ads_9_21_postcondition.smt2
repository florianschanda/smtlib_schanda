...
;; fliteral_axiom
  ...
  (= (tqtreal1 fliteral3) 340282346638528859811704183484516925440.0)))

(declare-fun type_conversion__float_to_long_float__result () t1)

(declare-fun result () t1)

(declare-fun type_conversion__float_to_long_float__result1 () t1)

(declare-fun type_conversion__float_to_long_float__result2 () t1)

(declare-fun type_conversion__float_to_long_float__result3 () t1)

(declare-fun type_conversion__float_to_long_float__result4 () t1)

(declare-fun type_conversion__float_to_long_float__result5 () t1)

(declare-fun result1 () t1)
...
;; H
  (assert
  (= type_conversion__float_to_long_float__result1 (to_float64 RNE1 x)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (le1 (neg1 fliteral3) type_conversion__float_to_long_float__result4)))
(check-sat)
