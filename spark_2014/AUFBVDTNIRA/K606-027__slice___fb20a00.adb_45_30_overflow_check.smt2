...
;; H
  (assert
  (=> (= result4 true)
  (= o12 (bool_eq3 temp___209 (to_rep1 (first9 temp___2091))
         (to_rep1 (last9 temp___2091)) new_sub1 (to_rep1 new_sub__first)
...
;; H
  ...
  (not
  (= (bool_eq3 new_str1
     (to_rep1 (first9 (mk3 pos2 fb20a00__find__L_2__R7b2)))
     (to_rep1 (last9 (mk3 pos2 fb20a00__find__L_2__R7b2))) new_sub1
...
;; H
  ...
  (=> (= result3 true)
  (=> (= result7 true)
  (= o26 (bool_eq3 temp___2092 (to_rep1 (first9 temp___2093))
         (to_rep1 (last9 temp___2093)) new_sub1 (to_rep1 new_sub__first)
         (to_rep1 new_sub__last))))))
