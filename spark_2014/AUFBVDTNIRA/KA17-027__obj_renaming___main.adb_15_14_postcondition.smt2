...
(declare-fun main__get_arr__result () (Array Int us_rep))
...
(declare-fun main__get_arr__result__assume () (Array Int us_rep))

(declare-fun result () (Array Int us_rep))

(declare-fun main__get_arr__result1 () (Array Int us_rep))

(declare-fun main__get_arr__result2 () (Array Int us_rep))

(declare-fun main__get_arr__result3 () (Array Int us_rep))

(declare-fun main__get_arr__result4 () (Array Int us_rep))

(declare-fun main__get_arr__result5 () (Array Int us_rep))
...
;; H
  (assert
  (= main__get_arr__result__assume (main__get_arr__result__aggregate_def
                                   (mk___rep (mk___split_fields o2)))))
...
;; H
  (assert
  (= (mk_map__ref main__get_arr__result4) (mk_map__ref
                                          main__get_arr__result2)))
