...
;; temp___String_Literal_143__def_axiom
  ...
  (! (and
     (and
     (and
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 1)) 97)
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 2)) 98))
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 3)) 99))
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 4)) 100)) :pattern (
...
;; WP_parameter_def
 ;; File "bug5.ads", line 4, characters 0-0
  (not (= (p (mk___t (temp___String_Literal_143 Tuple0) (mk 1 4))) true)))
(check-sat)
