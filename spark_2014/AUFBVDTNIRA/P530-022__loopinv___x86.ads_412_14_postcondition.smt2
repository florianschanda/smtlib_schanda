...
(declare-fun x86__esi__result () (_ BitVec 32))

(declare-fun result () (_ BitVec 32))

(declare-fun x86__esi__result1 () (_ BitVec 32))

(declare-fun x86__esi__result2 () (_ BitVec 32))

(declare-fun x86__esi__result3 () (_ BitVec 32))

(declare-fun x86__esi__result4 () (_ BitVec 32))

(declare-fun x86__esi__result5 () (_ BitVec 32))
...
;; H
  (assert
  (= x86__esi__result1 ((_ extract 31 0) (bvand rsi ((_ int2bv 64) 4294967295)))))

;; H
  (assert (= (mk_t__ref x86__esi__result4) (mk_t__ref x86__esi__result2)))
...
;; WP_parameter_def
 ;; File "x86.ads", line 8, characters 0-0
  (not (= x86__esi__result4 (readreg32 rsi))))
(check-sat)
