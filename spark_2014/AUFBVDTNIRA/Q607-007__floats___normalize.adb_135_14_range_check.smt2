...
;; r3__post_axiom
  ...
  (! (=> (and (dynamic_invariant x1 true true true) (le (neg fliteral1) x1))
     (let ((result (r3 x1)))
     (and (and (le result x1) (le (sub RNE1 x1 fliteral) result))
...
;; r3__def_axiom
  ...
  (! (=> (dynamic_invariant x1 true true true)
     (= (r3 x1) (roundToIntegral RTN1 x1))) :pattern ((r3 x1)) )))
...
;; H
  ...
  (and (= o (r3 v11))
  (and (in_range2 o)
  (and (= o (roundToIntegral RTN1 v11))
  (and (le o v11) (le (sub RNE1 v11 fliteral) o))))))
...
;; H
  (assert (le (sub RNE1 v11 fliteral) v21))
