...
;; def_axiom
  (assert
  (forall ((temp___966 (_ BitVec 8)))
  (forall ((temp___967 Int) (temp___968 Int))
  (let ((temp___965 (temp___964 temp___966 temp___967 temp___968)))
  (and
  (=> (dynamic_property6 1 65536 temp___967 temp___968)
  (and (= (first5 temp___965) temp___967) (= (last5 temp___965) temp___968)))
  (forall ((temp___969 Int))
  (= (select (to_array2 temp___965) temp___969) (of_rep1 temp___966))))))))
...
(declare-fun temp___971 () (Array Int octet))

(declare-fun temp___9711 () t2)

(declare-fun temp___972 () (Array Int octet))

(declare-fun temp___9721 () t1)
...
(declare-fun temp___975 () digit_index_type)

(declare-fun temp___9751 () (Array Int octet))

(declare-fun temp___9752 () t1)
...
;; H
  (assert
  (= (mk___t2 temp___971 temp___9711) (temp___964 ((_ int2bv 8) 0) 1
                                      (to_rep
                                      (rec__very_longs__very_long__length
                                      (us_split_discrs1 l))))))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___9711)) (to_rep2 (last4 temp___9711)))
     (+ (- (to_rep2 (last4 temp___9711)) (to_rep2 (first4 temp___9711))) 1)
     0) (ite (<= 1 (to_rep
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___9711)) (to_rep2 (last4 temp___9711))) 
  temp___9721))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___9721)) (to_rep2 (last2 temp___9721)))
     (+ (- (to_rep2 (last2 temp___9721)) (to_rep2 (first2 temp___9721))) 1)
...
;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___972 temp___9721)))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___975)))

;; H
  (assert (= temp___9751 o2))

;; H
  (assert (= temp___9752 o3))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___9751 temp___9752))))
