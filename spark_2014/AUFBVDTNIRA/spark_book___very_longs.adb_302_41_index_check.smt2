...
(declare-datatypes ()
((tT88bP1__ref (mk_tT88bP1__ref (tT88bP1__content tdigit_count_typeB)))))
(define-fun tT88bP1__ref___projection ((a tT88bP1__ref)) tdigit_count_typeB 
  (tT88bP1__content a))
...
(define-fun us_split_fields_Long_Digits24__projection ((a us_split_fields2)) us_t1 
  (rec__very_longs__very_long__long_digits1 a))

(declare-datatypes ()
((us_split_fields__ref1
 (mk___split_fields__ref1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref_24__projection ((a us_split_fields__ref1)) us_split_fields2 
...
(define-fun us_rep_47__projection ((a us_rep1)) us_split_discrs (us_split_discrs2
                                                                a))

(define-fun us_rep_48__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                 a))
...
(define-fun tresultS__ref_4__projection ((a tresultS__ref)) us_rep1 (tresultS__content
                                                                    a))

(define-fun dynamic_invariant4 ((temp___expr_619 us_rep1)
  (temp___is_init_616 Bool) (temp___skip_constant_617 Bool)
  (temp___do_toplevel_618 Bool)) Bool (and
                                      (=>
                                      ...
                                      (first3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_619)))
                                      (last5
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_619))))
                                      (and
                                      (= (first3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_619))) 1)
                                      (= (last5
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_619))) 
                                      (to_rep
...
(define-fun default_initial_assumption ((temp___expr_622 us_rep1)
  (temp___skip_top_level_623 Bool)) Bool (= (to_rep
                                            (rec__very_longs__very_long__length
                                            (us_split_discrs2
                                            temp___expr_622))) (to_rep
                                                               (rec__very_longs__very_long__length
                                                               (us_split_discrs1
                                                               l)))))
...
(declare-datatypes ()
((t89b__ref (mk_t89b__ref (t89b__content tdigit_count_typeB)))))
(define-fun t89b__ref___projection ((a t89b__ref)) tdigit_count_typeB 
  (t89b__content a))
...
(declare-fun temp___965 ((_ BitVec 8) Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___967 (_ BitVec 8)))
  (forall ((temp___968 Int) (temp___969 Int))
  (let ((temp___966 (temp___965 temp___967 temp___968 temp___969)))
  (and
  (=> (dynamic_property6 1 65536 temp___968 temp___969)
  (and (= (first5 temp___966) temp___968) (= (last8 temp___966) temp___969)))
  (forall ((temp___970 Int))
  (= (select (to_array2 temp___966) temp___970) (of_rep1 temp___967))))))))
...
(declare-fun temp___972 () (Array Int octet))

(declare-fun temp___9721 () t2)

(declare-fun temp___973 () (Array Int octet))

(declare-fun temp___9731 () t1)
...
(declare-fun temp___976 () digit_index_type)

(declare-fun temp___9761 () (Array Int octet))

(declare-fun temp___9762 () t1)
...
;; H
  (assert
  (= (mk___t2 temp___972 temp___9721) (temp___965 ((_ int2bv 8) 0) 1
                                      (to_rep
                                      (rec__very_longs__very_long__length
                                      (us_split_discrs1 l))))))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___9721)) (to_rep2 (last7 temp___9721)))
     (+ (- (to_rep2 (last7 temp___9721)) (to_rep2 (first4 temp___9721))) 1)
     0) (ite (<= 1 (to_rep
...
;; H
  (assert (= temp___972 temp___973))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___9721)) (to_rep2 (last7 temp___9721))) 
  temp___9731))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___9731)) (to_rep2 (last4 temp___9731)))
     (+ (- (to_rep2 (last4 temp___9731)) (to_rep2 (first2 temp___9731))) 1)
...
;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___973 temp___9731)))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___976)))

;; H
  (assert (= temp___9761 o2))

;; H
  (assert (= temp___9762 o3))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___9761 temp___9762))))
...
;; H
  ...
  (= (to_rep2
     (last4
     (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) 
  r93b))

;; H
  (assert (in_range1 r93b))

;; H
  (assert (and (= o14 (+ i2 j2)) (in_range1 (+ i2 j2))))

;; H
  (assert (= o15 (- o14 1)))

;; H
  (assert (= o16 (ite (<= o15 r93b) true false)))
...
;; H
  (assert (and (= o18 (+ i2 j2)) (in_range1 (+ i2 j2))))

;; H
  (assert (= temp___980 (- o18 1)))
...
;; H
  (assert (= result7 (mk_t__ref1 t_digit)))

;; H
  (assert (= t_digit1 o22))

;; H
  (assert (= result8 (mk_t__ref1 temp)))

;; H
  (assert
  (= temp1 (bvadd (bvadd (bvmul l_digit1 r_digit1) t_digit1) carry2)))

;; H
  (assert
  (and (= o24 (takelsb_from16 temp1)) (takelsb_from16__function_guard 
  o24 temp1)))
...
;; H
  (assert (and (= o23 (+ i2 j2)) (in_range1 (+ i2 j2))))

;; H
  (assert (= temp___982 (- o23 1)))
