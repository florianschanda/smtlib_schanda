...
;; H
  ...
  (= loopmax1 (+ (div1
                 (- (to_rep3
                    ...
                    (us_split_fields1 rawcertdata))) 1)
                 100) 1))
  (and (<= 1 j2) (<= j2 loopmax1)))
  (= bytesleft2 (- (to_rep3
                   (rec__certtypes__rawdatat__datalength
                   (us_split_fields1 rawcertdata))) (* (- j2 1) 100))))
  (and
  (<= 1 (to_rep3
...
;; H
  ...
  (and
  (and
  (and (=> (<= 1 2147483647) (in_range2 bytesleft2))
  (=> (<= 0 28) (in_range8 retvalupd2)))
  (=> (<= 0 4294967295) (in_range5 size2)))
  (=> (<= 1 r29b) (dynamic_property1 1 r29b j2)))
  (and (<= 1 j2) (<= j2 r29b))))

;; H
  (assert (and (= o7 (* (- j2 1) 100)) (in_range1 (* (- j2 1) 100))))

;; H
  (assert
  (= o8 (- (to_rep3
           (rec__certtypes__rawdatat__datalength
           (us_split_fields1 rawcertdata))) o7)))
