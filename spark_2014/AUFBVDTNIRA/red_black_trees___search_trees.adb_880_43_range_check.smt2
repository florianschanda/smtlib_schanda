...
;; H
  (assert (valid_root__function_guard
  (valid_root (mk___rep2 binary_trees__extract__f__fields) o3)
  (mk___rep2 binary_trees__extract__f__fields) o3))
...
;; H
  ...
  (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
  o3) (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) 
  o3))
...
;; H
  (assert (model____function_guard
  (model__ (mk___rep2 binary_trees__extract__f__fields) o3)
  (mk___rep2 binary_trees__extract__f__fields) o3))
...
;; H
  (assert
  (and (= o3 (to_rep1 t__split_fields)) (in_range3
...
;; H
  ...
  (= (size (mk___rep2 binary_trees__extract__f__fields)) (size
                                                         ...
                                                         t__split_fields1
                                                         t__split_fields2))))
  (and (= (valid_root (mk___rep2 binary_trees__extract__f__fields) o3) true)
  (and
  ...
  (= (valid_root
     (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t) true)
  (not (= o3 t))) (not (= binary_trees__extract__v t)))
  (= (oeq1 (model__ (mk___rep2 binary_trees__extract__f__fields) t)
     (model__
     (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t)) true))))
  (and
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__extract__f__fields) o3) i1))) true)))))
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__extract__f__fields) o3) i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (mk___rep2
