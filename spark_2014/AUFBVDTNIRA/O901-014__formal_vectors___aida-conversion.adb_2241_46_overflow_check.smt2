...
;; H
  (assert
  (and (= temp___2786 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2786)
  (<= temp___2786 (to_rep1 n__last))))

;; H
  (assert (= o9 temp___2786))
...
;; H
  (assert
  (and (= temp___2787 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2787)
  (<= temp___2787 (to_rep1 n__last))))

;; H
  (assert (= o14 temp___2787))
