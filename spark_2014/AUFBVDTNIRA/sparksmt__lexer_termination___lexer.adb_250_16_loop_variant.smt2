...
;; H
  (assert (= result1 (mk_int__ref temp___961)))

;; H
  (assert (= temp___9611 next_idx2))

;; H
  (assert (= result2 (mk_int__ref temp___960)))
...
;; WP_parameter_def
 ;; File "lexer.adb", line 48, characters 0-0
  (not
  (or (< temp___9611 next_idx3)
  (and (= next_idx3 temp___9611)
  (< (to_int1
     (= (to_rep1
