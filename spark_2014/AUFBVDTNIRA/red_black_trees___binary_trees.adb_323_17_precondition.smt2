...
(declare-fun temp___1664 () (Array Int us_rep1))
...
(declare-fun temp___1663 () (Array Int us_rep1))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1664 (parent f1 i1)))) (position f1 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1664 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1664 (parent f1 i1)))) (position f1 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1664 i1))))))
...
;; H
  (assert (= (mk___rep (mk___split_fields o4 o5)) (select temp___1665 i)))
...
;; H
  (assert
  (and
  (and (= temp___1664 (model__ f1 root)) (model____function_guard temp___1664
  f1 root))
  (and (dynamic_invariant2 temp___1664 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1664 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1664 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f1 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1664 (parent f1 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1664 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1664 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1664 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1664 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1664 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1664 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o o1)) (select temp___1664 i)))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1663 (parent f1 i1)))) (position f1 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1663 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1663 (parent f1 i1)))) (position f1 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1663 i1))))))
...
;; H
  (assert
  (and
  (and (= temp___1663 (model__ f1 root)) (model____function_guard temp___1663
  f1 root))
  (and (dynamic_invariant2 temp___1663 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1663 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1663 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f1 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1663 (parent f1 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1663 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1663 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1663 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1663 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1663 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1663 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o12 o13)) (select temp___1663 
  i)))
