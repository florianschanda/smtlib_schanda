...
(define-fun bool_eq2 ((a (Array (_ BitVec 64) byte)) (a__first (_ BitVec 64))
...
(define-fun bool_eq12 ((x (_ BitVec 8))
  (y (_ BitVec 8))) Bool (ite (= x y) true false))
...
(define-fun bool_eq13 ((x (_ BitVec 8))
  (y (_ BitVec 8))) Bool (ite (= x y) true false))
...
(define-fun bool_eq16 ((a (Array (_ BitVec 64) u64)) (a__first (_ BitVec 64))
...
(declare-fun temp___1394 () (_ BitVec 64))

(declare-fun temp___1393 () (_ BitVec 64))

(declare-fun temp___1391 () u64)

(declare-fun temp___13911 () u32)

(declare-fun temp___13912 () u16)

(declare-fun temp___13913 () u7)

(declare-fun temp___13914 () Bool)

(declare-fun temp___13915 () u6)

(declare-fun temp___13916 () Bool)

(declare-fun temp___13917 () Bool)

(declare-fun temp___13918 () hash_bit_length)

(declare-fun temp___13919 () u64)

(declare-fun temp___139110 () (Array (_ BitVec 64) u64))

(declare-fun temp___139111 () (Array (_ BitVec 64) byte))
...
(declare-fun temp___1388 () (Array (_ BitVec 64) byte))

(declare-fun o7 () (Array (_ BitVec 64) byte))

(declare-fun o8 () us_split_fields4)

(declare-fun temp___1390 () us_rep2)
...
(declare-fun temp___1397 () us_rep2)
...
(declare-fun src4 () t__ref1)

(declare-fun dst4 () t__ref1)

(declare-fun src5 () (_ BitVec 64))

(declare-fun dst5 () (_ BitVec 64))

(declare-fun ctx__split_fields15 () us_split_fields__ref2)

(declare-fun src6 () t__ref1)

(declare-fun dst6 () t__ref1)

(declare-fun ctx__split_fields16 () us_split_fields4)

(declare-fun src7 () (_ BitVec 64))

(declare-fun dst7 () (_ BitVec 64))

(declare-fun ctx__split_fields17 () us_split_fields__ref2)

(declare-fun src8 () t__ref1)

(declare-fun dst8 () t__ref1)

(declare-fun ctx__split_fields18 () us_split_fields4)

(declare-fun src9 () (_ BitVec 64))

(declare-fun dst9 () (_ BitVec 64))
...
(declare-fun src10 () t__ref1)

(declare-fun dst10 () t__ref1)

(declare-fun final_dst3 () t__ref1)

(declare-fun final_src3 () t__ref1)

(declare-fun ctx__split_fields21 () us_split_fields4)

(declare-fun src11 () (_ BitVec 64))

(declare-fun dst11 () (_ BitVec 64))

(declare-fun final_dst4 () (_ BitVec 64))
...
(define-fun ctx__split_fields22 () us_split_fields__ref2 (mk___split_fields__ref2
                                                         (mk___split_fields2
                                                         (mk___rep1
                                                         (mk___split_fields1
                                                         (mk___rep
...
;; H
  (assert
  (=> (bvugt c238b ((_ int2bv 64) 0))
  (and (= o2 (bvadd dst2 (bvsub c238b ((_ int2bv 64) 1)))) (in_range3
  (bvadd dst2 (bvsub c238b ((_ int2bv 64) 1)))))))
...
;; H
  (assert
  (=> (bvugt c238b ((_ int2bv 64) 0))
  (= final_src2 (bvadd src2 (bvsub c238b ((_ int2bv 64) 1))))))

;; H
  (assert (=> (bvugt c238b ((_ int2bv 64) 0)) (= temp___1394 dst2)))

;; H
  (assert (=> (bvugt c238b ((_ int2bv 64) 0)) (= temp___1393 src2)))
...
;; H
  ...
  (and
  (and
  (and (= ctx__split_fields temp___1391)
  (and (= ctx__split_fields1 temp___13911)
  (and (= ctx__split_fields2 temp___13912)
  (and (= ctx__split_fields3 temp___13913)
  (and (= ctx__split_fields4 temp___13914)
  (and (= ctx__split_fields5 temp___13915)
  (and (= ctx__split_fields6 temp___13916)
  (= ctx__split_fields7 temp___13917))))))))
  (and (= ctx__split_fields8 temp___13918)
  (= ctx__split_fields9 temp___13919)))
  (and (= ctx__split_fields10 temp___139110)
  (= ctx__split_fields11 temp___139111)))))

;; H
  (assert
  (=> (bvugt c238b ((_ int2bv 64) 0))
  (and (bvule (to_rep2 (first (rt msg))) src2)
  (bvule src2 (to_rep2 (last (rt msg)))))))
...
;; H
  (assert
  (=> (bvugt c238b ((_ int2bv 64) 0))
  (= temp___1388 (store ctx__split_fields11 dst2 o6))))

;; H
  (assert
  (=> (bvugt c238b ((_ int2bv 64) 0)) (dynamic_predicate1 temp___1388)))

;; H
  (assert (=> (bvugt c238b ((_ int2bv 64) 0)) (= o7 temp___1388)))
...
;; H
  (assert
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= temp___1390 (mk___rep2 o8))))

;; H
  (assert
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= result7 ctx__split_fields22)))

;; H
  (assert
  (=> (bvugt c238b ((_ int2bv 64) 0))
  (= ctx__split_fields13 (us_split_fields5 temp___1390))))
...
;; H
  ...
  (= (rec__skein__skein_512_context__h ctx__split_fields14) (mk___rep1
                                                            ...
                                                            temp___13918
                                                            temp___13919)))
  (= (rec__skein__skein_512_context__x ctx__split_fields14) temp___139110)))
  (=> (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 63)) (in_range3 dst3)))))
...
;; H
  (assert
  (=> (bvugt c238b ((_ int2bv 64) 0))
  (=> (not (bvuge dst3 final_dst2)) (bvuge src3 final_src2))))
...
;; H
  (assert
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= temp___1397 (mk___rep2 o12))))
...
;; H
  (assert
  (=> (bvugt c238b ((_ int2bv 64) 0))
  (= ctx__split_fields19 (us_split_fields5 temp___1397))))
...
;; H
  (assert
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= final_dst3 (mk_t__ref1 final_dst2))))
...
;; H
  (assert
  (=> (not (bvugt c238b ((_ int2bv 64) 0))) (= final_src3 final_src5)))

;; H
  (assert
  (=> (not (bvugt c238b ((_ int2bv 64) 0))) (= final_dst3 final_dst5)))
...
;; H
  ...
  (= ctx__split_fields20 ctx__split_fields22)))
...
;; H
  (assert
  (=> (not (bvugt c238b ((_ int2bv 64) 0))) (= final_dst4 final_dst1)))
