...
;; H
  (assert (= o10 temp___872))

;; H
  (assert (= (mk4 (to_rep1 (first (rt data))) r85s) temp___8721))
...
;; H
  (assert (= temp___880 (mk___rep o12)))
...
;; H
  (assert (= ctx__split_fields6 (us_split_fields1 temp___880)))

(assert
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not (in_range1 (+ offset1 free_bytes_in_block1))))
(check-sat)
