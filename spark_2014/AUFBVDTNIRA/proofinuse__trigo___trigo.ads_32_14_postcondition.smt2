...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral11) (/ 999999974737875163555145263671875.0 10000000000000000000000000000000000000.0))))
...
;; H
  (assert (approx_tan__function_guard (approx_tan x) x))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (lt (abs1 (sub RNE2 trigo__tan__result4 (approx_tan x))) fliteral11)))
(check-sat)
