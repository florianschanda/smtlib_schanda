...
(define-fun o29 () us_rep1 (mk___rep1 (mk___split_fields1 o24 o25 o26)))

(define-fun o30 () us_rep1 (mk___rep1 (mk___split_fields1 o18 o19 o20)))

(define-fun o31 () us_rep1 (mk___rep1 (mk___split_fields1 o14 o15 o16)))

(define-fun o32 () us_rep1 (mk___rep1 (mk___split_fields1 o8 o9 o10)))
...
;; H
  (assert (= o30 (select trains1 o17)))

;; H
  (assert
  (and
  (and (= o21 (get_previous_track o30 id1))
  (get_previous_track__function_guard o21 o30 id1))
  (and (in_range1 o21)
  (= o21 (to_rep3
         (select (select previous_tracks (to_rep1
                                         (rec__trains__track__from
                                         (us_split_fields1
                                         (select tracks (to_rep o20)))))) 
         id1))))))
...
;; H
  (assert (= result9 (ite (not (= o22 true)) true false)))

;; H
  (assert (=> (= result9 true) (and (<= 1 train1) (<= train1 10))))

;; H
  (assert (=> (= result9 true) (= o23 train1)))

;; H
  (assert (=> (= result9 true) (= o29 (select trains1 o23))))

;; H
  (assert
  (=> (= result9 true)
  (and
  (and (= temp___437 (get_previous_track o29 id1))
  (get_previous_track__function_guard temp___437 o29 id1))
  (and (in_range1 temp___437)
  (= temp___437 (to_rep3
                (select (select previous_tracks (to_rep1
                                                (rec__trains__track__from
                                                (us_split_fields1
                                                (select tracks (to_rep o26)))))) 
                id1)))))))

;; H
  (assert (=> (= result9 true) (and (<= 1 temp___437) (<= temp___437 8))))

;; H
  (assert (=> (= result9 true) (= o27 temp___437)))

;; H
  (assert
  (=> (= result9 true) (= o28 (select (map__content4 track_signals6) o27))))

;; H
  (assert (=> (= result9 true) (= temp___438 (to_rep5 o28))))

;; H
  (assert
  (=> (= result9 true)
  (= result8 (ite (or (= temp___438 1) (= temp___438 2)) true false))))
...
;; H
  (assert (= o32 (select trains1 o7)))

;; H
  (assert
  (and
  (and (= o11 (get_other_previous_track o32 id1))
  (get_other_previous_track__function_guard o11 o32 id1))
  (and (in_range1 o11)
  (= o11 (ite (= (to_rep3
                 (select (select previous_tracks (to_rep1
                                                 (rec__trains__track__from
                                                 (us_split_fields1
                                                 (select tracks (to_rep o8)))))) 
                 id1)) (to_rep o10))
         0
         (to_rep3
         (select (select previous_tracks (to_rep1
...
;; H
  (assert (= o31 (select trains1 o13)))

;; H
  (assert
  (and
  (and (= temp___439 (get_other_previous_track o31 id1))
  (get_other_previous_track__function_guard temp___439 o31 id1))
  (and (in_range1 temp___439)
  (= temp___439 (ite (= (to_rep3
                        (select (select previous_tracks (to_rep1
                                                        (rec__trains__track__from
                                                        (us_split_fields1
                                                        (select tracks 
