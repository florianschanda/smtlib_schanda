...
;; H
  (assert
  (=> (= result9 true)
  (and (= temp___375 (get_previous_track o29 id1))
  (and (in_range1 temp___375)
  (= temp___375 (to_rep3
                (select (select previous_tracks (to_rep1
                                                (rec__trains__track__from
                                                (us_split_fields1
...
;; H
  (assert (=> (= result9 true) (= o27 temp___375)))
...
;; H
  (assert (=> (= result9 true) (= temp___376 (to_rep5 o28))))

;; H
  (assert
  (=> (= result9 true)
  (= result8 (ite (or (= temp___376 1) (= temp___376 2)) true false))))
...
;; H
  (assert
  (and (= temp___377 (get_other_previous_track o31 id1))
  (and (in_range1 temp___377)
  (= temp___377 (ite (= (to_rep3
                        (select (select previous_tracks (to_rep1
                                                        (rec__trains__track__from
                                                        (us_split_fields1
                                                        (select tracks 
