...
;; H
  (assert (= o11 (store candidates3 current_candidate3 o10)))

;; H
  (assert (= candidates3 result6))

;; H
  (assert (= candidates4 o11))

;; H
  (assert (= o12 (end_of_file file)))

;; H
  (assert (= o13 (ite (not (= o12 true)) true false)))
...
;; H
  (assert (= result7 (ite (not (= o14 true)) true false)))
...
;; H
  (assert
  (and (= o15 (+ current_candidate3 1)) (in_range8 (+ current_candidate3 1))))

;; H
  (assert (= result8 current_candidate3))

;; H
  (assert (= current_candidate4 o15))
