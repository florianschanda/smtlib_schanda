...
(declare-fun dummy1 () t_int16)

(declare-datatypes ()
((t_int16__ref (mk_t_int16__ref (t_int16__content t_int16)))))
...
(define-fun dynamic_invariant1 ((temp___expr_1240 Int)
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral2) (= (tqtreal fliteral2) 32767.0)))

(declare-fun fliteral3 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 32768.0)))

;; H
  (assert (tqtisFinite value))

;; H
  (assert (not (lt fliteral2 value)))

;; H
  (assert (not (lt value (neg fliteral3))))

(assert
;; WP_parameter_def
 ;; File "types.ads", line 13, characters 0-0
  (not (in_range1 (to_int1 RNA2 value))))
(check-sat)
