...
;; H
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             (rec__search_trees__search_tree__struct t__split_fields5)
             (to_rep1
             (rec__search_trees__search_tree__root t__split_fields5))) i6))) true)
  (=>
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct t__split_fields5)
             (to_rep1
             (rec__search_trees__search_tree__root t__split_fields5))) i6)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct t__split_fields5)
  ...
  (ite (= (get
          ...
          (+ (length
             ...
             (select (model__
                     ...
                     t__split_fields5)
                     (to_rep1
                     (rec__search_trees__search_tree__root t__split_fields5))) i6)))) 1)) 0)
  (< v (to_rep
       (select (rec__search_trees__search_tree__values t__split_fields5) i6)))
  (< (to_rep
     (select (rec__search_trees__search_tree__values t__split_fields5) i6)) 
  v)))))))
...
;; H
  (assert (size__function_guard1 (size1 (mk___rep3 t__split_fields5))
  (mk___rep3 t__split_fields5)))

(assert
;; WP_parameter_def
 ;; File "search_trees.adb", line 1175, characters 0-0
  (not (not (= (size1 (mk___rep3 t__split_fields5)) 0))))
(check-sat)
