...
(declare-fun med4 () int__ref)

(declare-fun binary_search__search__result9 () int__ref)
...
(declare-fun binary_search__search__result10 () Int)
...
(declare-fun binary_search__search__result11 () int__ref)
...
(declare-fun binary_search__search__result12 () Int)
...
(declare-fun binary_search__search__result18 () int__ref)
...
(declare-fun binary_search__search__result19 () Int)
...
(declare-fun binary_search__search__result20 () int__ref)
...
(declare-fun binary_search__search__result21 () Int)

(declare-fun left15 () int__ref)

(declare-fun right15 () int__ref)

(declare-fun med14 () int__ref)

(declare-fun binary_search__search__result22 () int__ref)

(declare-fun left16 () Int)

(declare-fun right16 () Int)

(declare-fun med15 () Int)

(declare-fun binary_search__search__result23 () Int)
...
;; H
  (assert (= result16 (int__content binary_search__search__result22)))
...
;; WP_parameter_def
 ;; File "binary_search.ads", line 16, characters 0-0
  (not
  (= (to_rep
     (select (elts a) (int__content binary_search__search__result22))) 
  i)))
(check-sat)
