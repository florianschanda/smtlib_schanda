...
(define-fun us_split_fields_F31__projection ((a us_split_fields)) natural 
  (rec__tagged_component_check__s__p3__root__f a))

(define-fun us_split_fields_35__projection ((a us_split_fields)) us_private 
  (rec__ext__ a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_35__projection ((a us_split_fields__ref)) us_split_fields 
...
(define-fun us_rep_70__projection ((a us_rep)) Int (attr__tag a))
...
(define-fun root__ref_13__projection ((a root__ref)) us_rep (root__content a))
...
(define-fun us_split_fields_G15__projection ((a us_split_fields2)) natural 
  (rec__tagged_component_check__s__p3__c__g a))

(define-fun us_split_fields_F32__projection ((a us_split_fields2)) natural 
  (rec__tagged_component_check__s__p3__root__f1 a))

(define-fun us_split_fields_36__projection ((a us_split_fields2)) us_private 
  (rec__ext__1 a))
...
(define-fun us_rep_71__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                 a))

(define-fun us_rep_72__projection ((a us_rep1)) Int (attr__tag1 a))
...
(define-fun c__ref_13__projection ((a c__ref)) us_rep1 (c__content a))
...
(define-fun default_initial_assumption ((temp___expr_530 us_rep)
  (temp___skip_top_level_531 Bool)) Bool (and
                                         (= (attr__tag temp___expr_530) 
                                         us_tag)
                                         (= (to_rep
                                            (rec__tagged_component_check__s__p3__root__f
                                            (us_split_fields1
...
(define-fun default_initial_assumption1 ((temp___expr_541 us_rep1)
  (temp___skip_top_level_542 Bool)) Bool (and
                                         (= (attr__tag1 temp___expr_541) 
                                         us_tag1)
                                         (and
                                         (= (to_rep
                                            (rec__tagged_component_check__s__p3__c__g
...
;; H
  (assert
  (and (and (= o (hide 35)) (hide__function_guard o 35)) (in_range1 o)))
