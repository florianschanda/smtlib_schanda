...
;; H
  (assert (=> (lt target_x position_x) (= result result____split_fields7)))
...
;; H
  (assert
  (=> (not (lt target_x position_x))
  (=> (lt position_x target_x) (= result1 result____split_fields7))))
...
;; WP_parameter_def
 ;; File "flight_manager.ads", line 3, characters 0-0
  (not (tqtisFinite (sub RNE1 position_x target_x))))
(check-sat)
