...
;; H
  (assert
  (= result7 (ite (= o52 true) (ite (<= k a_last) true false) false)))
...
;; H
  (assert
  (and (= o48 (num_of_boolean carry3)) (num_of_boolean__function_guard 
  o48 carry3)))
...
;; H
  (assert
  (and (= o49 (omultiply o47 o48)) (omultiply__function_guard o49 o47 o48)))
...
;; H
  (assert
  (and (= o50 (osubtract o41 o49)) (osubtract__function_guard o50 o41 o49)))
...
;; H
  (assert
  (and (= o36 (num_of_big_int b b_first o35)) (num_of_big_int__function_guard
  o36 b b_first o35)))
