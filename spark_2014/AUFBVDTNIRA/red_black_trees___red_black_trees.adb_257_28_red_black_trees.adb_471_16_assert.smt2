...
(declare-fun temp___749 () (Array Int us_rep7))
...
;; H
  (assert
  (and
  (= temp___742 (parent (rec__red_black_trees__rbt__struct t__split_fields8)
                o24))
...
;; H
  (assert
  (and
  (= temp___746 (parent (rec__red_black_trees__rbt__struct t__split_fields9)
                o29))
...
;; H
  (assert
  (and (= temp___749 (nb_blacks c93b))
  (and
  (= (bool_eq17 (select temp___749 0)
     (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true)
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  ...
  (=
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select temp___749 i))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11
     (select temp___749 (peek
                        (rec__red_black_trees__rbt__struct
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select temp___749 i)))) (+ 1 (ite (< (to_rep
                                                              (rec__red_black_trees__black_count__depth
                                                              (us_split_fields11
                                                              (select 
                                                              temp___749 
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select temp___749 i)))) (+ (ite (= (to_rep3
...
;; H
  (assert (= o38 (select temp___749 c95b)))
