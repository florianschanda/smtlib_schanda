...
(declare-fun temp___1329 () (Array Int us_rep7))

(declare-fun o38 () us_rep7)

(declare-fun o39 () us_split_fields10)

(declare-fun o40 () extended_index_type)
...
;; H
  (assert (= temp___1319 (mk___rep4 o23)))

;; H
  (assert (= result9 (mk___split_fields__ref4 t__split_fields7)))

;; H
  (assert (= t__split_fields8 (us_split_fields9 temp___1319)))
...
;; H
  ...
  (and
  (and
  (= temp___1321 (parent (rec__red_black_trees__rbt__struct t__split_fields8)
                 o24))
...
;; H
  (assert (and (<= 1 temp___1321) (<= temp___1321 100)))

;; H
  (assert (= o26 temp___1321))
...
;; H
  (assert (= temp___1323 (mk___rep4 o28)))

;; H
  (assert (= result10 (mk___split_fields__ref4 t__split_fields8)))

;; H
  (assert (= t__split_fields9 (us_split_fields9 temp___1323)))
...
;; H
  ...
  (and
  (and
  (= temp___1325 (parent (rec__red_black_trees__rbt__struct t__split_fields9)
                 o29))
...
;; H
  (assert (and (<= 1 temp___1325) (<= temp___1325 100)))

;; H
  (assert (= o31 temp___1325))
...
;; H
  (assert (= temp___1327 (mk___rep4 o33)))

;; H
  (assert (= result11 (mk___split_fields__ref4 t__split_fields9)))

;; H
  (assert (= t__split_fields10 (us_split_fields9 temp___1327)))
...
;; H
  (assert (= (mk___rep4 t_old__split_fields7) c93b))

;; H
  (assert (dynamic_invariant6 c93b true false true))

;; H
  (assert (= (mk___rep4 t__split_fields10) c94b))
...
;; H
  (assert
  (and (= red_black_trees__insert__L_8__C95b__assume o37) (in_range2 o37)))

;; H
  (assert (= red_black_trees__insert__L_8__C95b__assume c95b))

;; H
  (assert (in_range2 c95b))

;; H
  (assert (same_nb_blacks__function_guard (same_nb_blacks c93b) c93b))

;; H
  (assert (= (same_nb_blacks c93b) true))
...
;; H
  (assert (model____function_guard
  (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c93b)))
  (rec__red_black_trees__rbt__struct (us_split_fields9 c93b))))

;; H
  (assert (nb_blacks__function_guard (nb_blacks c93b) c93b))

;; H
  (assert
  (forall ((i Int)) (parent__function_guard
  (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i)
  (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i)))

;; H
  (assert (nb_blacks__function_guard (nb_blacks c94b) c94b))
...
;; H
  ...
  (eq (select (nb_blacks c94b) i) (select (nb_blacks c93b) i))
  (select (nb_blacks c94b) i) (select (nb_blacks c93b) i))))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
             (rec__red_black_trees__rbt__struct (us_split_fields9 c93b))) i))) true)
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c93b) i)))) n6))
  (ite (= (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))
          i) c95b)
  (and
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select (nb_blacks c94b) i))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select (nb_blacks c94b) i)))) (+ (to_rep
                                                          (rec__red_black_trees__black_count__count
                                                          (us_split_fields11
                                                          (select (nb_blacks
                                                                  c93b) i)))) 1)))
  (= (eq (select (nb_blacks c94b) i) (select (nb_blacks c93b) i)) true))))))
...
;; H
  (assert
  (forall ((i Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c93b)) i 0)
  (rec__red_black_trees__rbt__struct (us_split_fields9 c93b)) i 0)))

;; H
  (assert
  (forall ((i Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c93b)) i 1)
  (rec__red_black_trees__rbt__struct (us_split_fields9 c93b)) i 1)))
...
;; H
  (assert
  (and
  (and (= temp___1329 (nb_blacks c93b)) (nb_blacks__function_guard
  temp___1329 c93b))
  (and
  (= (bool_eq17 (select temp___1329 0)
     (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true)
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  ...
  (=
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select temp___1329 i))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11
     (select temp___1329 (peek
                         (rec__red_black_trees__rbt__struct
                         (us_split_fields9 c93b)) i 0))))) (to_rep
                                                           (rec__red_black_trees__black_count__count
                                                           (us_split_fields11
                                                           (select temp___1329 
                                                           (peek
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select temp___1329 i)))) (+ 1 (ite (< (to_rep
                                                               (rec__red_black_trees__black_count__depth
                                                               (us_split_fields11
                                                               (select 
                                                               temp___1329 
  ...
  (select temp___1329 (peek
                      (rec__red_black_trees__rbt__struct
                      (us_split_fields9 c93b)) i 1)))))) (to_rep
                                                         (rec__red_black_trees__black_count__depth
                                                         (us_split_fields11
                                                         (select temp___1329 
                                                         (peek
  ...
  (select temp___1329 (peek
                      (rec__red_black_trees__rbt__struct
                      (us_split_fields9 c93b)) i 0)))))))))
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select temp___1329 i)))) (+ (ite (= (to_rep3
                                                             (select 
                                                             (rec__red_black_trees__rbt__color
                                                             (us_split_fields9
                                                             c93b)) i)) 0)
...
;; H
  (assert (= o38 (select temp___1329 c95b)))
...
;; WP_parameter_def
 ;; File "red_black_trees.ads", line 59, characters 0-0
  (not
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select (nb_blacks c94b) c95b))) true)))
(check-sat)
