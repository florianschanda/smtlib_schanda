...
;; H
  (assert
  (and (= o24 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o24 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o23 (from_word64 i2)) (from_word64__function_guard o23 i2)))

;; H
  (assert (and (= o25 (oadd o23 o24)) (oadd__function_guard o25 o23 o24)))
...
;; H
  (assert (and (= o26 (ole o22 o25)) (ole__function_guard o26 o22 o25)))
...
;; H
  (assert
  (and (= o18 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o18 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o19 (oexpon o18 s10)) (oexpon__function_guard o19 o18 s10)))

;; H
  (assert
  (and (= o14 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o14 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o13 (from_integer s10)) (from_integer__function_guard o13 s10)))

;; H
  (assert
  (and (= o15 (osubtract o13 o14)) (osubtract__function_guard o15 o13 o14)))

;; H
  (assert
  (and (= o12 (from_word64 i2)) (from_word64__function_guard o12 i2)))

;; H
  (assert
  (and (= o16 (osubtract o12 o15)) (osubtract__function_guard o16 o12 o15)))

;; H
  (assert
  (and (= o11 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o11 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o17 (oexpon__2 o11 o16)) (oexpon__2__function_guard o17 o11 o16)))
