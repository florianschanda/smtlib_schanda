...
(declare-fun temp___3655 () (Array Int us_rep1))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3680 o10))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3680 o10)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o10))
...
;; H
  (assert (= o11 (select temp___3680 l)))
...
;; H
  ...
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o5))
  (=>
  (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) 
  o5) (not (= result6 true)))))
...
;; H
  (assert (position__function_guard
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o4)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o4))

;; H
  (assert (parent__function_guard
  (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o4)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o4))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3655 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i1))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3655 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3655 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (model____function_guard temp___3655
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o))
  (and (dynamic_invariant8 temp___3655 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3655 o))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3655 o)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3655 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3655 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3655 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3655 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3655 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3655 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= o1 (select temp___3655 j)))
