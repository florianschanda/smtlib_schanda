...
;; r1__post_axiom
  ...
  (! (=> (dynamic_invariant1 x1 true true true)
     (let ((result (r1 x1)))
     (=> (r1__function_guard result x1) (dynamic_invariant1 result true false
     true)))) :pattern ((r1 x1)) )))
...
;; r1__def_axiom
  ...
  (forall ((x1 t))
  (! (=>
     (and (dynamic_invariant1 x1 true true true) (r1__function_guard 
     (r1 x1) x1)) (= (r1 x1) (roundToIntegral RTN2 x1))) :pattern ((r1 x1)) )))
...
;; H
  (assert
  (and
  (and (= o (r1 (div1 RNE2 x fliteral5))) (r1__function_guard o
