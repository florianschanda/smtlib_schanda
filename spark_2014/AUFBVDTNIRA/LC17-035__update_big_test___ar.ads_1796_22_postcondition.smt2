...
;; range_axiom
  (assert
  (forall ((x enum1t)) (! (in_range4 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
(declare-fun ar__rofaofr1__a1__first__bit () Int)

(declare-fun ar__rofaofr1__a1__last__bit () Int)

(declare-fun ar__rofaofr1__a1__position () Int)
...
(declare-fun ar__rofaofr1__b1__first__bit () Int)

(declare-fun ar__rofaofr1__b1__last__bit () Int)

(declare-fun ar__rofaofr1__b1__position () Int)
...
(declare-fun ar__rofaofr1__c1__first__bit () Int)

(declare-fun ar__rofaofr1__c1__last__bit () Int)

(declare-fun ar__rofaofr1__c1__position () Int)
...
(declare-fun temp___4017 ((Array Int us_rep) Int us_rep) (Array Int us_rep))

;; def_axiom
  (assert
  (forall ((temp___4019 (Array Int us_rep)))
  (forall ((temp___4020 Int))
  (forall ((temp___4021 us_rep))
  (let ((temp___4018 (temp___4017 temp___4019 temp___4020 temp___4021)))
  (forall ((temp___4022 Int))
  (ite (= temp___4022 temp___4020)
  (= (select temp___4018 temp___4022) temp___4021)
  (= (select temp___4018 temp___4022) (select temp___4019 temp___4022)))))))))
...
(declare-fun r__split_fields () (Array Int us_rep))

(declare-fun r__split_fields1 () Bool)

(declare-fun r__split_fields2 () enum1t)
...
(declare-fun o8 () enum1t)

(declare-fun temp___9392 () (Array Int us_rep))

(declare-fun temp___93921 () Bool)

(declare-fun temp___93922 () enum1t)
...
(declare-fun temp___9399 () (Array Int us_rep))

(declare-fun temp___93991 () Bool)

(declare-fun temp___93992 () enum1t)

(declare-fun result () (Array Int us_rep))

(declare-fun result1 () Bool)

(declare-fun result2 () enum1t)

(declare-fun r__split_fields3 () (Array Int us_rep))

(declare-fun r__split_fields4 () Bool)
...
(declare-fun result5 () enum1t)

(declare-fun r__split_fields6 () (Array Int us_rep))

(declare-fun r__split_fields7 () Bool)

(declare-fun r__split_fields8 () enum1t)

(declare-fun result6 () (Array Int us_rep))

(declare-fun result7 () Bool)

(declare-fun result8 () enum1t)

(declare-fun r__split_fields9 () us_split_fields2)

(declare-fun r__split_fields10 () us_split_fields__ref1)

(declare-fun r__split_fields11 () us_split_fields2)
...
;; H
  (assert (= temp___9392 o6))

;; H
  (assert (= temp___93921 o7))

;; H
  (assert (= temp___93922 o8))
...
;; H
  (assert (= temp___9392 r__split_fields3))

;; H
  (assert (= temp___93921 r__split_fields4))

;; H
  (assert (= temp___93922 r__split_fields5))
...
;; H
  (assert (= (of_int 1) r__split_fields7))
...
;; H
  (assert
  (= (rec__ar__rec1t__f1 (us_split_fields1 (select r__split_fields6 i))) 
  o10))
...
;; H
  (assert
  (= o14 (store r__split_fields6 i (mk___rep (mk___split_fields o12 o13)))))

;; H
  (assert (= o14 o15))

;; H
  (assert (= r__split_fields7 o16))

;; H
  (assert (= r__split_fields8 o17))

;; H
  (assert (= temp___9399 o15))

;; H
  (assert (= temp___93991 o16))

;; H
  (assert (= temp___93992 o17))
...
;; H
  (assert
  (= r__split_fields9 (mk___split_fields1 temp___9399 temp___93991
                      temp___93992)))

;; H
  (assert (= r__split_fields10 (mk___split_fields__ref1 r__split_fields9)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1789, characters 0-0
  (not
  (= (bool_eq6 (mk___rep1 (us_split_fields__content1 r__split_fields10))
     (mk___rep1
     (mk___split_fields1
     (temp___4017 r__split_fields i
     (mk___rep (mk___split_fields (of_rep e) (of_rep1 f)))) (of_int 1)
     r__split_fields2))) true)))
(check-sat)
