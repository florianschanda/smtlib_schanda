...
;; H
  (assert
  (and (= o5 (statusiswaitingfinishadminop (let ((subject state)) state12)))
  (statusiswaitingfinishadminop__function_guard o5
  (let ((subject state)) state12))))

;; H
  (assert
  (and (= o6 (statusiswaitingstartadminop (let ((subject state)) state12)))
  (statusiswaitingstartadminop__function_guard o6
  (let ((subject state)) state12))))
...
;; H
  (assert
  (and
  (= o1 (statusiswaitingremoveadmintokenfail (let ((subject state)) state12)))
  (statusiswaitingremoveadmintokenfail__function_guard o1
  (let ((subject state)) state12))))

;; H
  (assert
  (and (= o2 (statusisgotadmintoken (let ((subject state)) state12)))
  (statusisgotadmintoken__function_guard o2 (let ((subject state)) state12))))
