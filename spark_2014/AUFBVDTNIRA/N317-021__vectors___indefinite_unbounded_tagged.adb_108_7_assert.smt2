...
(declare-fun indefinite_unbounded_tagged__vect__replace_element__container__fields1 () us_split_fields2)
...
;; WP_parameter_def
 ;; File "a-cfinve.ads", line 813, characters 0-0
  ...
  (= (length
     (mk___rep1 v__split_discrs
     indefinite_unbounded_tagged__vect__replace_element__container__fields1)) 
  ...
  (= (equal_except (model__ (mk___rep1 v__split_discrs v__split_fields10))
     ...
     indefinite_unbounded_tagged__vect__replace_element__container__fields1))
     1) true)))
  (and (= result11 (mk___split_fields__ref1 v__split_fields10))
