...
(define-fun result____split_fields9 () us_split_fields (mk___split_fields
...
(define-fun result____split_fields10 () us_split_fields__ref (mk___split_fields__ref
                                                             (mk___split_fields
...
;; H
  (assert
  (=> (and (<= 1 idx2) (<= idx2 r4b))
  (= (mk___split_fields__ref (mk___split_fields result1)) result____split_fields10)))
...
;; H
  (assert
  (=> (and (<= 1 idx2) (<= idx2 r4b))
  (= result____split_fields4 (mk___split_fields__ref result____split_fields9))))
...
;; H
  (assert
  (=> (and (<= 1 idx2) (<= idx2 r4b))
  (= result____split_fields5 result____split_fields9)))
...
;; H
  ...
  (= result____split_fields6 result____split_fields10)))
