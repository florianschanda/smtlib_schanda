...
(declare-fun temp___217 () (Array Int character))
...
(declare-fun temp___219 () index_type)

(declare-fun temp___2191 () (Array Int character))

(declare-fun temp___2192 () t)

(declare-fun temp___2193 () length_type)
...
(declare-fun temp___221 () index_type)

(declare-fun temp___2211 () (Array Int character))

(declare-fun temp___2212 () t)

(declare-fun temp___2213 () length_type)
...
;; H
  (assert
  (= (mk___t1 temp___217 temp___2171) (mk___t1 temp___215 temp___2151)))
...
;; H
  (assert
  (= (mk (to_rep3 (first2 temp___2171)) (to_rep3 (last4 temp___2171))) 
  o1))
...
;; H
  (assert (= target__split_discrs (mk___split_discrs temp___219)))
...
;; H
  ...
  (= target__split_fields3 (mk___split_fields
                           (mk___t temp___2191 temp___2192) temp___2193)))
...
;; H
  (assert (= target__split_discrs (mk___split_discrs temp___221)))

;; H
  (assert (= temp___2211 o6))

;; H
  (assert (= temp___2212 o7))

;; H
  (assert (= temp___2213 o8))
...
;; H
  ...
  (= target__split_fields4 (mk___split_fields
                           (mk___t temp___2211 temp___2212) temp___2213)))
...
;; H
  ...
  (length1
  (mk___rep target__split_discrs
  (us_split_fields__content target__split_fields5)))
  (mk___rep target__split_discrs
  (us_split_fields__content target__split_fields5))))
