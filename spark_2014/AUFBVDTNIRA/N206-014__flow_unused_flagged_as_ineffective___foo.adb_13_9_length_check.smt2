...
(declare-fun temp___161 (Int Int Int) us_t1)
...
;; def_axiom
  ...
  (and
  (=> (dynamic_property 1 2147483647 temp___164 temp___165)
  (and (= (first4 temp___162) temp___164) (= (last4 temp___162) temp___165)))
  (forall ((temp___166 Int))
  (= (select (to_array1 temp___162) temp___166) (of_rep temp___163)))))))
...
(declare-fun temp___168 () (Array Int character))

(declare-fun temp___1681 () t1)

(declare-fun temp___169 () (Array Int character))

(declare-fun temp___1691 () t)
...
;; H
  (assert
  (= (to_rep1
     (first3 (rt1 (temp___161 120 (to_rep1 x__first) (to_rep1 x__last))))) 
  (to_rep1 x__first)))

;; H
  (assert
  (= (to_rep1
     (last3 (rt1 (temp___161 120 (to_rep1 x__first) (to_rep1 x__last))))) 
  (to_rep1 x__last)))

;; H
  (assert
  (= (mk___t1 temp___168 temp___1681) (temp___161 120 (to_rep1 x__first)
                                      (to_rep1 x__last))))

;; H
  (assert (= temp___168 temp___169))

;; H
  (assert
  (= (mk (to_rep1 (first3 temp___1681)) (to_rep1 (last3 temp___1681))) 
  temp___1691))

(assert
;; WP_parameter_def
 ;; File "foo.adb", line 4, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first temp___1691)) (to_rep1 (last temp___1691)))
     (+ (- (to_rep1 (last temp___1691)) (to_rep1 (first temp___1691))) 1) 0) 
  (ite (<= (to_rep1 x__first) (to_rep1 x__last))
  (+ (- (to_rep1 x__last) (to_rep1 x__first)) 1) 0))))
(check-sat)
