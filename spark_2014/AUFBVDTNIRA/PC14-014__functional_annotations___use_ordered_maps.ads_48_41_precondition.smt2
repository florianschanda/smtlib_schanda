...
(declare-fun temp___723 () count_type)

(declare-fun temp___722 () count_type)

(declare-fun temp___7221 () us_main_type)
...
(declare-fun temp___738 () us_rep3)

(declare-fun temp___737 () Int)
...
;; H
  (assert (=> (= result1 true) (= temp___723 cu__split_fields1)))

;; H
  (assert
  (=> (= result1 true)
  (and (= r__split_discrs (mk___split_discrs temp___722))
  (= temp___7221 r__split_fields))))
...
;; H
  (assert
  (=> (= result1 true)
  (let ((temp___731 (keys (mk___rep r__split_discrs r__split_fields10))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= temp___7211 (next s (mk___rep1 cu__split_fields10)))
...
;; H
  (assert
  (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___721))))
...
;; H
  (assert
  (and (= temp___738 (keys s))
  (and
  (and
  (and (= (length3 temp___738) (length s))
  (forall ((temp___396 Int))
  (=>
  (and (in_range3 temp___396)
  (= (iter_has_element temp___738 temp___396) true))
  (= (has_key (model__ s) (get temp___738 temp___396)) true))))
  (forall ((key2 Int))
  (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true))
  (and (< 0 (find temp___738 key2))
  (= (equivalent_keys (get temp___738 (find temp___738 key2)) key2) true)))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i (length s)))
  (and (= (find temp___738 (get temp___738 i)) i)
  (= (k_is_find temp___738 (get temp___738 i) i) true)))))))

;; H
  (assert
  (and (= o4 (iter_has_element temp___738 temp___737))
  (= (= o4 true) (and (<= 1 temp___737) (<= temp___737 (last temp___738))))))

;; H
  (assert (= (= o5 true) (in_range3 temp___737)))
...
;; H
  (assert (and (= k (get temp___738 temp___737)) (in_range4 k)))
...
;; H
  ...
  (=>
  (exists ((k1 Int))
  (and (and (in_range2 k1) (= (has_key o6 k1) true))
