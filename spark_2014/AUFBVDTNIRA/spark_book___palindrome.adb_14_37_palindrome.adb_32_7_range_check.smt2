...
;; H
  (assert
  (=> (not (<= right_index2 left_index2)) (= (mk4 1 r5b) temp___5371)))
...
;; H
  (assert
  (=> (not (<= right_index2 left_index2)) (= o13 (select temp___537 o12))))
...
;; H
  (assert
  (=> (not (<= right_index2 left_index2)) (= (mk3 1 r5b) temp___5351)))

;; H
  (assert
  (=> (not (<= right_index2 left_index2))
  (and (<= (to_rep1 (first6 temp___5351)) right_index2)
  (<= right_index2 (to_rep1 (last9 temp___5351))))))
...
;; H
  (assert
  (=> (not (<= right_index2 left_index2)) (= o10 (select temp___535 o9))))
...
;; H
  (assert
  (=> (not (<= right_index2 left_index2))
  (= result3 (ite (not (= o16 true)) true false))))
