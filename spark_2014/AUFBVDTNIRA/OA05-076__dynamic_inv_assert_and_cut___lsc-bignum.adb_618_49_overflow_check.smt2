...
;; H
  (assert (and (= o39 (- e_last e_first)) (in_range1 (- e_last e_first))))

;; H
  (assert (and (= o40 o39) (uint_in_range1 o39)))

;; H
  (assert (= o41 ((_ int2bv 64) o40)))

;; H
  (assert (= o42 (bvadd o41 ((_ int2bv 64) 1))))

;; H
  (assert (= o43 (bvmul o42 ((_ int2bv 64) 32))))

;; H
  (assert (= o44 (ite (bvult i2 o43) true false)))

;; H
  (assert
  (and (= o36 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o36 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o35 (from_word64 i2)) (from_word64__function_guard o35 i2)))

;; H
  (assert (and (= o37 (oadd o35 o36)) (oadd__function_guard o37 o35 o36)))

;; H
  (assert
  (and (= o34 (from_integer s10)) (from_integer__function_guard o34 s10)))

;; H
  (assert (and (= o38 (ole o34 o37)) (ole__function_guard o38 o34 o37)))

;; H
  (assert (and (= o32 (+ k 1)) (in_range1 (+ k 1))))

;; H
  (assert (= o33 (ite (<= s10 o32) true false)))

;; H
  (assert
  (and (= o28 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o28 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o29 (oexpon o28 s10)) (oexpon__function_guard o29 o28 s10)))

;; H
  (assert
  (and (= o23 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o23 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o22 (from_integer s10)) (from_integer__function_guard o22 s10)))

;; H
  (assert
  (and (= o24 (osubtract o22 o23)) (osubtract__function_guard o24 o22 o23)))

;; H
  (assert
  (and (= o21 (from_word64 i2)) (from_word64__function_guard o21 i2)))

;; H
  (assert
  (and (= o25 (osubtract o21 o24)) (osubtract__function_guard o25 o21 o24)))

;; H
  (assert
  (and (= o20 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o20 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o26 (oexpon__2 o20 o25)) (oexpon__2__function_guard o26 o20 o25)))
...
;; H
  (assert
  (and (= o19 (num_of_big_int e e_first o18)) (num_of_big_int__function_guard
  o19 e e_first o18)))

;; H
  (assert
  (and (= o27 (odivide o19 o26)) (odivide__function_guard o27 o19 o26)))

;; H
  (assert (and (= o30 (omod o27 o29)) (omod__function_guard o30 o27 o29)))

;; H
  (assert
  (and (= o14 (from_word32 (t__content w7))) (from_word32__function_guard 
  o14 (t__content w7))))

;; H
  (assert (and (= o31 (oeq o14 o30)) (oeq__function_guard o31 o14 o30)))
