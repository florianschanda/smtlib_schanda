...
(declare-fun bounded__vect__replace_element__container__fields1 () us_split_fields)
...
;; H
  ...
  (length (mk___rep v__split_discrs v__split_fields13)) 1))
...
;; H
  ...
  (= (length
     (mk___rep v__split_discrs
     bounded__vect__replace_element__container__fields1)) (length
                                                          (mk___rep
                                                          v__split_discrs
                                                          v__split_fields10)))
  (= (get
     (model__
     (mk___rep v__split_discrs
     bounded__vect__replace_element__container__fields1)) 1) o2))
  (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields10))
     (model__
     (mk___rep v__split_discrs
     bounded__vect__replace_element__container__fields1)) 1) true)))
...
;; H
  (assert
  (= v__split_fields11 bounded__vect__replace_element__container__fields1))
