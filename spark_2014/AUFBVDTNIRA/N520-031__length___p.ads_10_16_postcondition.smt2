...
;; WP_parameter_def
 ;; File "p.ads", line 7, characters 0-0
  (not
  (= (let ((temp___171 (temp___138
                       (mk___t v (mk (to_rep v__first) (to_rep v__last))) 
                       i (to_rep (select v j)) j (to_rep (select v i)))))
     (bool_eq2 v3 (to_rep v__first) (to_rep v__last) (elts temp___171)
     (to_rep (first (rt temp___171))) (to_rep (last (rt temp___171))))) true)))
(check-sat)
