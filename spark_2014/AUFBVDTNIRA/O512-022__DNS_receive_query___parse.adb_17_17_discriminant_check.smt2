...
(declare-fun o7 () return_code_t)

(declare-fun o8 () return_code_t)

(declare-fun temp___314 () return_code_t)

(declare-fun temp___3141 () unsigned_16)

(declare-fun temp___3142 () query_opcode)

(declare-fun temp___3143 () qdcount_range)

(declare-fun temp___3144 () Bool)
...
;; H
  (assert (= (to_rep2 result____split_discrs) r2b))
...
;; H
  (assert (= temp___314 o8))

;; H
  (assert
  (= dummy6 (mk___rep1
            (mk___split_fields1 temp___3141 temp___3142 temp___3143))))

;; H
  (assert (= true temp___3144))
...
;; WP_parameter_def
 ;; File "parse.ads", line 16, characters 0-0
  (not (= temp___314 result____split_discrs)))
(check-sat)
