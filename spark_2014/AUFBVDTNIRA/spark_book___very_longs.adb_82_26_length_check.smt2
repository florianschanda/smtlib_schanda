...
(declare-fun temp___1153 ((_ BitVec 8) Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___1155 (_ BitVec 8)))
  (forall ((temp___1156 Int) (temp___1157 Int))
  (let ((temp___1154 (temp___1153 temp___1155 temp___1156 temp___1157)))
  (and
  (=> (dynamic_property6 1 65536 temp___1156 temp___1157)
  (and (= (first5 temp___1154) temp___1156)
  (= (last8 temp___1154) temp___1157)))
  (forall ((temp___1158 Int))
  (= (select (to_array2 temp___1154) temp___1158) (of_rep1 temp___1155))))))))
...
(declare-fun temp___11601 () t2)

(declare-fun temp___1161 () (Array Int octet))

(declare-fun temp___11611 () t1)
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___1153 ((_ int2bv 8) 0) 1 r19b)))) 1))

;; H
  (assert
  (= (to_rep2 (last7 (rt2 (temp___1153 ((_ int2bv 8) 0) 1 r19b)))) r19b))

;; H
  (assert
  (= (mk___t2 temp___1160 temp___11601) (temp___1153 ((_ int2bv 8) 0) 1 r19b)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___11601)) (to_rep2 (last7 temp___11601)))
     (+ (- (to_rep2 (last7 temp___11601)) (to_rep2 (first4 temp___11601))) 1)
     0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0)))

;; H
  (assert (= temp___1160 temp___1161))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___11601)) (to_rep2 (last7 temp___11601))) 
  temp___11611))
...
;; WP_parameter_def
 ;; File "very_longs.adb", line 49, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first2 temp___11611)) (to_rep2 (last4 temp___11611)))
     (+ (- (to_rep2 (last4 temp___11611)) (to_rep2 (first2 temp___11611))) 1)
