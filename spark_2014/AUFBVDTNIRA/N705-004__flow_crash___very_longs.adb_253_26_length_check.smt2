...
(define-fun dynamic_invariant4 ((temp___expr_615 us_rep1)
  (temp___is_init_612 Bool) (temp___skip_constant_613 Bool)
  (temp___do_toplevel_614 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_613 true))
                                      (in_range4
                                      (to_rep
                                      (rec__very_longs__very_long__octet_length
                                      (us_split_discrs1 l)))
                                      (to_base temp___expr_615)))
                                      ...
                                      (first3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_615)))
                                      (last5
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_615))))
                                      (and
                                      (= (first3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_615))) 1)
                                      (= (last5
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_615))) 
                                      (to_rep
...
(define-fun default_initial_assumption ((temp___expr_618 us_rep1)
  (temp___skip_top_level_619 Bool)) Bool (= (to_rep
                                            (rec__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_618))) (to_rep
                                                               (rec__very_longs__very_long__octet_length
                                                               (us_split_discrs1
                                                               l)))))
...
(declare-fun temp___974 ((_ BitVec 8) Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___976 (_ BitVec 8)))
  (forall ((temp___977 Int) (temp___978 Int))
  (let ((temp___975 (temp___974 temp___976 temp___977 temp___978)))
  (and
  (=> (dynamic_property6 1 2147483647 temp___977 temp___978)
  (and (= (first5 temp___975) temp___977) (= (last8 temp___975) temp___978)))
  (forall ((temp___979 Int))
  (= (select (to_array2 temp___975) temp___979) (of_rep1 temp___976))))))))
...
(declare-fun temp___981 () (Array Int octet))

(declare-fun temp___9811 () t2)

(declare-fun temp___982 () (Array Int octet))

(declare-fun temp___9821 () t1)
...
;; H
  (assert
  (= (mk___t2 temp___981 temp___9811) (temp___974 ((_ int2bv 8) 0) 1
                                      (to_rep
                                      (rec__very_longs__very_long__octet_length
                                      (us_split_discrs1 l))))))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___9811)) (to_rep2 (last7 temp___9811)))
     (+ (- (to_rep2 (last7 temp___9811)) (to_rep2 (first4 temp___9811))) 1)
     0) (ite (<= 1 (to_rep
                   (rec__very_longs__very_long__octet_length
                   (us_split_discrs1 l))))
        (+ (- (to_rep
...
;; H
  (assert (= temp___981 temp___982))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___9811)) (to_rep2 (last7 temp___9811))) 
  temp___9821))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 85, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first2 temp___9821)) (to_rep2 (last4 temp___9821)))
     (+ (- (to_rep2 (last4 temp___9821)) (to_rep2 (first2 temp___9821))) 1)
