...
(declare-fun dummy2 () return_code_t)
...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__types__octet__data unsigned_8)))))
...
(declare-fun types__octet__data__first__bit () Int)

(declare-fun types__octet__data__last__bit () Int)

(declare-fun types__octet__data__position () Int)
...
(declare-fun dummy4 () query_opcode)
...
(declare-fun dummy5 () qdcount_range)
...
(declare-fun types__query_header__id__first__bit () Int)

(declare-fun types__query_header__id__last__bit () Int)

(declare-fun types__query_header__id__position () Int)
...
(declare-fun types__query_header__opcode__first__bit () Int)

(declare-fun types__query_header__opcode__last__bit () Int)

(declare-fun types__query_header__opcode__position () Int)
...
(declare-fun types__query_header__qdcount__first__bit () Int)

(declare-fun types__query_header__qdcount__last__bit () Int)

(declare-fun types__query_header__qdcount__position () Int)
...
(declare-datatypes ()
((query_header__ref (mk_query_header__ref (query_header__content us_rep1)))))
...
(declare-fun dummy7 () network_dns_query_range)
...
(declare-fun dummy8 () bit_range)

(declare-datatypes ()
((bit_range__ref (mk_bit_range__ref (bit_range__content bit_range)))))
...
(declare-fun parse__parse_result_t__return_code__first__bit () Int)

(declare-fun parse__parse_result_t__return_code__last__bit () Int)

(declare-fun parse__parse_result_t__return_code__position () Int)
...
(declare-fun parse__parse_result_t__header__first__bit () Int)

(declare-fun parse__parse_result_t__header__last__bit () Int)

(declare-fun parse__parse_result_t__header__position () Int)
...
(declare-fun query () (Array Int us_rep))
...
(declare-fun parse__parse_result_t__return_code__first__bit1 () Int)

(declare-fun parse__parse_result_t__return_code__last__bit1 () Int)

(declare-fun parse__parse_result_t__return_code__position1 () Int)
...
(declare-fun parse__parse_result_t__header__first__bit1 () Int)

(declare-fun parse__parse_result_t__header__last__bit1 () Int)

(declare-fun parse__parse_result_t__header__position1 () Int)
...
(declare-fun parse__parse_result_t__return_code__first__bit2 () Int)

(declare-fun parse__parse_result_t__return_code__last__bit2 () Int)

(declare-fun parse__parse_result_t__return_code__position2 () Int)
...
(declare-fun parse__parse_result_t__header__first__bit2 () Int)

(declare-fun parse__parse_result_t__header__last__bit2 () Int)

(declare-fun parse__parse_result_t__header__position2 () Int)
...
(declare-fun parse__parse_result_t__return_code__first__bit3 () Int)

(declare-fun parse__parse_result_t__return_code__last__bit3 () Int)

(declare-fun parse__parse_result_t__return_code__position3 () Int)
...
(declare-fun parse__parse_result_t__header__first__bit3 () Int)

(declare-fun parse__parse_result_t__header__last__bit3 () Int)

(declare-fun parse__parse_result_t__header__position3 () Int)
...
(declare-fun parse__parse_result_t__return_code__first__bit4 () Int)

(declare-fun parse__parse_result_t__return_code__last__bit4 () Int)

(declare-fun parse__parse_result_t__return_code__position4 () Int)
...
(declare-fun parse__parse_result_t__header__first__bit4 () Int)

(declare-fun parse__parse_result_t__header__last__bit4 () Int)

(declare-fun parse__parse_result_t__header__position4 () Int)
...
(declare-fun parse__parse_result_t__return_code__first__bit5 () Int)

(declare-fun parse__parse_result_t__return_code__last__bit5 () Int)

(declare-fun parse__parse_result_t__return_code__position5 () Int)
...
(declare-fun parse__parse_result_t__header__first__bit5 () Int)

(declare-fun parse__parse_result_t__header__last__bit5 () Int)

(declare-fun parse__parse_result_t__header__position5 () Int)
...
(declare-fun parse__parse_result_t__return_code__first__bit6 () Int)

(declare-fun parse__parse_result_t__return_code__last__bit6 () Int)

(declare-fun parse__parse_result_t__return_code__position6 () Int)
...
(declare-fun parse__parse_result_t__header__first__bit6 () Int)

(declare-fun parse__parse_result_t__header__last__bit6 () Int)

(declare-fun parse__parse_result_t__header__position6 () Int)
...
(declare-fun parse__parse_result_t__return_code__first__bit7 () Int)

(declare-fun parse__parse_result_t__return_code__last__bit7 () Int)

(declare-fun parse__parse_result_t__return_code__position7 () Int)
...
(declare-fun parse__parse_result_t__header__first__bit7 () Int)

(declare-fun parse__parse_result_t__header__last__bit7 () Int)

(declare-fun parse__parse_result_t__header__position7 () Int)
...
(declare-fun parse__parse_result_t__return_code__first__bit8 () Int)

(declare-fun parse__parse_result_t__return_code__last__bit8 () Int)

(declare-fun parse__parse_result_t__return_code__position8 () Int)
...
(declare-fun parse__parse_result_t__header__first__bit8 () Int)

(declare-fun parse__parse_result_t__header__last__bit8 () Int)

(declare-fun parse__parse_result_t__header__position8 () Int)
...
(declare-fun result____split_fields () unsigned_16)

(declare-fun result____split_fields1 () query_opcode)

(declare-fun result____split_fields2 () qdcount_range)

(declare-fun result____split_discrs () return_code_t)

(declare-fun opcode () (_ BitVec 8))

(declare-fun qdcount () (_ BitVec 16))

(declare-fun count () (_ BitVec 16))

(declare-fun header__split_fields () unsigned_16)

(declare-fun header__split_fields1 () query_opcode)

(declare-fun header__split_fields2 () qdcount_range)

(declare-fun o () (_ BitVec 16))

(declare-fun o1 () unsigned_16)

(declare-fun o2 () unsigned_16)

(declare-fun o3 () query_opcode)

(declare-fun o4 () qdcount_range)

(declare-fun temp___313 () unsigned_16)

(declare-fun temp___3131 () query_opcode)

(declare-fun temp___3132 () qdcount_range)
...
(declare-fun o8 () query_opcode)

(declare-fun o9 () unsigned_16)

(declare-fun o10 () query_opcode)

(declare-fun o11 () qdcount_range)

(declare-fun temp___318 () us_rep1)

(declare-fun o12 () query_opcode)

(declare-fun o13 () us_split_fields2)

(declare-fun temp___320 () us_rep1)
...
(declare-fun o22 () (_ BitVec 16))

(declare-fun o23 () return_code_t)

(declare-fun o24 () us_split_discrs)

(declare-fun temp___335 () us_rep2)

(declare-fun result____split_fields3 () us_split_fields4)

(declare-fun result____split_discrs1 () us_split_discrs)

(declare-fun result () us_split_fields__ref1)

(declare-fun header__split_fields3 () us_split_fields2)

(declare-fun result1 () Bool)

(declare-fun result____split_fields4 () us_split_fields4)

(declare-fun result____split_discrs2 () us_split_discrs)

(declare-fun result2 () t__ref)

(declare-fun opcode1 () (_ BitVec 8))

(declare-fun result3 () us_split_fields__ref1)

(declare-fun header__split_fields4 () us_split_fields2)

(declare-fun result4 () us_split_fields__ref1)

(declare-fun header__split_fields5 () us_split_fields2)

(declare-fun result____split_fields5 () us_split_fields4)

(declare-fun result____split_discrs3 () us_split_discrs)

(declare-fun result5 () Bool)

(declare-fun result____split_fields6 () us_split_fields4)

(declare-fun result____split_discrs4 () us_split_discrs)

(declare-fun result6 () t__ref1)

(declare-fun qdcount1 () (_ BitVec 16))

(declare-fun result7 () us_split_fields__ref1)

(declare-fun header__split_fields6 () us_split_fields2)

(declare-fun result____split_fields7 () us_split_fields4)

(declare-fun result____split_discrs5 () us_split_discrs)

(declare-fun result8 () t__ref1)

(declare-fun count1 () (_ BitVec 16))

(declare-fun result____split_fields8 () us_split_fields4)

(declare-fun result____split_discrs6 () us_split_discrs)
...
;; H
  (assert (bvuge qdcount1 ((_ int2bv 16) 1)))

;; H
  (assert (bvule qdcount1 ((_ int2bv 16) 16)))

;; H
  (assert (and (= o18 (bv2nat qdcount1)) (in_range3 (bv2nat qdcount1))))
...
;; H
  ...
  (= o20 (mk___split_fields1
         (rec__types__query_header__id header__split_fields4)
         (rec__types__query_header__opcode header__split_fields4) o19)))

;; H
  (assert (= temp___331 (mk___rep1 o20)))

;; H
  (assert (= result7 (mk___split_fields__ref1 header__split_fields4)))

;; H
  (assert (= header__split_fields6 (us_split_fields3 temp___331)))
...
;; H
  (assert (not (= count2 ((_ int2bv 16) 0))))

;; H
  (assert
  (= (to_rep2
     (rec__parse__parse_result_t__return_code result____split_discrs6)) 
  r22b))

;; H
  (assert (in_range1 r22b))

;; H
  (assert (= (to_rep2 o23) 1))

;; H
  (assert (= o24 (mk___split_discrs o23)))

;; H
  (assert (= temp___335 (mk___rep2 o24 (mk___split_fields2 dummy6) true)))
...
;; WP_parameter_def
 ;; File "parse.ads", line 16, characters 0-0
  (not
  (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___335)) 
  (rec__parse__parse_result_t__return_code result____split_discrs6))))
(check-sat)
