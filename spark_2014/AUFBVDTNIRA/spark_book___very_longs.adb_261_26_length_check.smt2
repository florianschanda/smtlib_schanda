...
(declare-fun temp___938 () (Array Int octet))

(declare-fun temp___9381 () t1)
...
;; H
  (assert (= temp___937 temp___938))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___9371)) (to_rep2 (last7 temp___9371))) 
  temp___9381))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 84, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first2 temp___9381)) (to_rep2 (last4 temp___9381)))
     (+ (- (to_rep2 (last4 temp___9381)) (to_rep2 (first2 temp___9381))) 1)
