...
(define-fun dynamic_invariant1 ((temp___expr_273 us_rep4)
...
(define-fun dynamic_invariant3 ((temp___expr_376 us_rep5)
...
;; size__post_axiom
  ...
  (forall ((t us_rep5))
  (! (=> (and (dynamic_invariant3 t true true true) (type_invariant1 t))
     (dynamic_invariant5 (size1 t) true false true)) :pattern ((size1 t)) )))
...
;; size__post_axiom
  (assert
  (forall ((f us_rep4))
  (! (=> (dynamic_invariant1 f true true true) (dynamic_invariant5 (size f)
...
;; H
  (assert
  (= (tree_structure
     (rec__search_trees__search_tree__struct (us_split_fields7 t1))) true))

;; H
  (assert
  (= (tree_structure
     (rec__search_trees__search_tree__struct (us_split_fields7 t2))) true))
...
;; H
  ...
  (= (valid_root
     ...
     (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))) true)
  (and
  (not
  (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2))) 0))
  (and
  (= (valid_root
     (rec__search_trees__search_tree__struct (us_split_fields7 t2))
     (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))) true)
  (and
  (= (ordered_leafs
     (rec__search_trees__search_tree__struct (us_split_fields7 t1))
     (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))
     (rec__search_trees__search_tree__values (us_split_fields7 t1))) true)
  (and
  (= (ordered_leafs
     (rec__search_trees__search_tree__struct (us_split_fields7 t2))
     (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))
     (rec__search_trees__search_tree__values (us_split_fields7 t2))) true)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t1))
             (to_rep
             (rec__search_trees__search_tree__root (us_split_fields7 t1)))) i))) true)
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t2))
             (to_rep
             (rec__search_trees__search_tree__root (us_split_fields7 t2)))) i))) true))))
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             ...
             (rec__search_trees__search_tree__root (us_split_fields7 t1)))) i))) true))))
  (= (bool_eq11
     (rec__search_trees__search_tree__values (us_split_fields7 t1)) 1 100
     (rec__search_trees__search_tree__values (us_split_fields7 t2)) 1 100) true))))))))))

;; H
  (assert (type_invariant1 t2))

;; H
  (assert
  (and (= o (values1 t2))
  (ite (= (size
          (rec__search_trees__search_tree__struct (us_split_fields7 t2))) 0)
  (= (is_empty o) true)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  ...
  (= (contains o
     (to_rep2
     (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) i))) true))))
  (forall ((v Int))
  (=> (and (<= 0 v) (<= v 2147483647))
  (=> (= (contains o v) true)
  (exists ((i Int))
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             ...
             (rec__search_trees__search_tree__root (us_split_fields7 t2)))) i))) true)
  (= (to_rep2
     (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) i)) v)))))))))))

(assert
;; WP_parameter_def
 ;; File "search_trees.adb", line 521, characters 0-0
  (not (type_invariant1 t1)))
(check-sat)
