...
;; H
  ...
  (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t1))
...
;; H
  (assert (valid_root__function_guard
  (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t2))
...
;; H
  ...
  (rec__search_trees__search_tree__struct (us_split_fields7 t1))
  (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))
  (rec__search_trees__search_tree__values (us_split_fields7 t1)))
  (rec__search_trees__search_tree__struct (us_split_fields7 t1))
  (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))
  (rec__search_trees__search_tree__values (us_split_fields7 t1))))
...
;; H
  ...
  (rec__search_trees__search_tree__struct (us_split_fields7 t2))
  (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))
  (rec__search_trees__search_tree__values (us_split_fields7 t2)))
  (rec__search_trees__search_tree__struct (us_split_fields7 t2))
  (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))
  (rec__search_trees__search_tree__values (us_split_fields7 t2))))
...
;; H
  ...
  (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1))
  (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1))))
  (rec__search_trees__search_tree__struct (us_split_fields7 t1))
  (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))))
...
;; H
  (assert (model____function_guard
  (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2))
  (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2))))
  (rec__search_trees__search_tree__struct (us_split_fields7 t2))
  (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))))
...
;; H
  ...
  (size (rec__search_trees__search_tree__struct (us_split_fields7 t2)))
  (rec__search_trees__search_tree__struct (us_split_fields7 t2))))
...
;; H
  (assert
  (and (and (= o (values1 t2)) (values__function_guard1 o t2))
  (ite (= (size
