...
;; def_axiom
  ...
  (and (= (first4 temp___252) temp___254) (= (last4 temp___252) temp___255)))
...
;; H
  (assert
  (= (mk (to_rep1 (first3 temp___2581)) (to_rep1 (last3 temp___2581))) 
  temp___2591))
...
;; WP_parameter_def
 ;; File "terminal.ads", line 9, characters 0-0
  (not
  (<= count1 (ite (<= (to_rep1 buffer__first) (to_rep1 buffer__last))
             (+ (- (to_rep1 buffer__last) (to_rep1 buffer__first)) 1) 0))))
(check-sat)
