...
;; H
  (assert (= o43 (select temp___2277 o42)))
...
;; H
  (assert (= o39 (select temp___2276 ki1)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2275 o35))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2275 o35)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i o35))
...
;; H
  (assert (= o36 (select temp___2275 ki1)))
