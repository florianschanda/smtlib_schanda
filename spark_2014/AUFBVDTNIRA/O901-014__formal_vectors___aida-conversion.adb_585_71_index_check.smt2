...
;; def_axiom
  (assert
  (forall ((temp___1634 Int) (temp___1635 Int) (temp___1636 Int)
  (temp___1637 Int) (temp___1638 Int) (temp___1639 Int) (temp___1640 Int)
  (temp___1641 Int) (temp___1642 Int) (temp___1643 Int) (temp___1644 Int)
  (temp___1645 Int))
  (let ((temp___1633 (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__aggregate_def
                     temp___1634 temp___1635 temp___1636 temp___1637
                     temp___1638 temp___1639 temp___1640 temp___1641
                     temp___1642 temp___1643 temp___1644 temp___1645)))
  (and
  (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1644
  temp___1645)
  (and (= (first7 temp___1633) temp___1644)
  (= (last7 temp___1633) temp___1645)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___1633) (+ (first1 source) 0)) (of_rep1
                                                            temp___1634))
  (= (select (to_array2 temp___1633) (+ (first1 source) 1)) (of_rep1
                                                            temp___1635)))
  (= (select (to_array2 temp___1633) (+ (first1 source) 2)) (of_rep1
                                                            temp___1636)))
  (= (select (to_array2 temp___1633) (+ (first1 source) 3)) (of_rep1
                                                            temp___1637)))
  (= (select (to_array2 temp___1633) (+ (first1 source) 4)) (of_rep1
                                                            temp___1638)))
  (= (select (to_array2 temp___1633) (+ (first1 source) 5)) (of_rep1
                                                            temp___1639)))
  (= (select (to_array2 temp___1633) (+ (first1 source) 6)) (of_rep1
                                                            temp___1640)))
  (= (select (to_array2 temp___1633) (+ (first1 source) 7)) (of_rep1
                                                            temp___1641)))
  (= (select (to_array2 temp___1633) (+ (first1 source) 8)) (of_rep1
                                                            temp___1642)))
  (= (select (to_array2 temp___1633) (+ (first1 source) 9)) (of_rep1
                                                            temp___1643)))))))
...
;; def_axiom
  (assert
  (forall ((temp___1651 Int) (temp___1652 Int) (temp___1653 Int))
  (let ((temp___1650 (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__aggregate_def
                     temp___1651 temp___1652 temp___1653)))
  (and
  (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1652
  temp___1653)
  (and (= (first13 temp___1650) temp___1652)
  (= (last13 temp___1650) temp___1653)))
  (forall ((temp___1654 Int))
  (= (select (to_array4 temp___1650) temp___1654) (of_rep1 temp___1651)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_315 us_t3)
  ...
  (temp___do_toplevel_314 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 9)
                                      (first10 temp___expr_315)
                                      (last10 temp___expr_315))
                                      (and
                                      (= (first10 temp___expr_315) (first1
                                                                   source))
                                      (= (last10 temp___expr_315) (+ 
                                      (first1 source) 9))))))
...
(declare-fun temp___1648 () (Array Int integer))

(declare-fun temp___16481 () t2)
...
(declare-fun temp___1656 () (Array Int integer))

(declare-fun temp___16561 () t4)
...
;; H
  (assert
  (= (mk___t2 temp___1648 temp___16481) (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__aggregate_def
                                        2 1 3 9 9 9 9 9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___16481)) (to_rep1 (last6 temp___16481)))
     (+ (- (to_rep1 (last6 temp___16481)) (to_rep1 (first6 temp___16481))) 1)
...
;; H
  (assert
  (= (slide1 temp___1648 (to_rep1 (first6 temp___16481))
...
;; H
  (assert
  (= (mk___t4 temp___1656 temp___16561) (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__aggregate_def
                                        0 (to_rep1 (first (rt source)))
                                        (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___16561)) (to_rep1
                                               (last12 temp___16561)))
     (+ (- (to_rep1 (last12 temp___16561)) (to_rep1 (first12 temp___16561))) 1)
     0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1
                                                  (first (rt source))) 9))
        (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1
                                                  (first (rt source)))) 1)
...
;; H
  (assert
  (= (slide1 temp___1656 (to_rep1 (first12 temp___16561))
...
;; H
  (assert
  (and (= temp___1663 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))
...
;; H
  (assert
  (forall ((j1 Int))
  (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index2))
...
;; H
  ...
  (and
  (and
  (forall ((temp___1660 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___1660)
  (<= temp___1660 (to_rep1 n__last)))
  (=> (< index2 temp___1660)
  (= (select n3 temp___1660) (select n1 temp___1660)))))
