...
(declare-fun temp___3689 ((Array Int us_rep) Int us_rep Int
  us_rep) (Array Int us_rep))

;; def_axiom
  (assert
  (forall ((temp___3691 (Array Int us_rep)))
  (forall ((temp___3692 Int) (temp___3694 Int))
  (forall ((temp___3693 us_rep) (temp___3695 us_rep))
  (let ((temp___3690 (temp___3689 temp___3691 temp___3692 temp___3693
                     temp___3694 temp___3695)))
  (forall ((temp___3696 Int))
  (ite (= temp___3696 temp___3694)
  (= (select temp___3690 temp___3696) temp___3695)
  (ite (= temp___3696 temp___3692)
  (= (select temp___3690 temp___3696) temp___3693)
  (= (select temp___3690 temp___3696) (select temp___3691 temp___3696))))))))))

(declare-fun temp___3697 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___3699 (Array Int et1)))
  (forall ((temp___3700 Int) (temp___3701 Int))
  (let ((temp___3698 (temp___3697 temp___3699 temp___3700 temp___3701)))
  (forall ((temp___3702 Int))
  (ite (= temp___3702 temp___3700)
  (= (select temp___3698 temp___3702) (of_rep temp___3701))
  (= (select temp___3698 temp___3702) (select temp___3699 temp___3702))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1685, characters 0-0
  (not
  (= (bool_eq6 a3 1 16
     (temp___3689 a x r i
     (mk___rep
     (mk___split_fields
     (temp___3697 (rec__ar__rofa1__s1 (us_split_fields1 (select a i))) j e)
     (rec__ar__rofa1__t1 (us_split_fields1 (select a i)))))) 1 16) true)))
(check-sat)
