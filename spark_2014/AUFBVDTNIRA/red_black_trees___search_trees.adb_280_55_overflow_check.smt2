...
(declare-fun temp___2538 () (Array Int us_rep1))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2538 (parent f i10)))) (position f i10)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2538 i10))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2538 (parent f i10)))) (position f i10)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2538 i10))))))
...
;; H
  (assert
  (and
  (and (= temp___2538 (model__ f v)) (model____function_guard temp___2538 
  f v))
  (and (dynamic_invariant5 temp___2538 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2538 v))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2538 v)))) 0)
  (and
  (forall ((i10 Int))
  (=> (and (<= 1 i10) (<= i10 100))
  (=> (not (= i10 v))
  (ite (and (not (= (parent f i10) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2538 (parent f i10)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2538 i10))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2538 i10))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2538 i10)))) 0))))
  (forall ((i10 Int))
  (=> (and (<= 1 i10) (<= i10 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2538 j15))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2538 i10)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2538 j15)))) true))
  (= j15 i10))))))))))))))

;; H
  (assert (= o20 (select temp___2538 i9)))
