...
(declare-fun temp___1386 () (Array Int us_rep1))
...
;; H
  (assert
  (and (= temp___1386 (model__ f v))
  (and (dynamic_invariant5 temp___1386 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1386 v))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1386 v)))) 0)
  (and
  (forall ((i10 Int))
  (=> (and (<= 1 i10) (<= i10 100))
  (=> (not (= i10 v))
  (ite (and (not (= (parent f i10) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1386 (parent f i10)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1386 i10))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1386 i10))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1386 (parent f i10)))) (position f i10)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1386 i10)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1386 i10)))) 0))))
  (forall ((i10 Int))
  (=> (and (<= 1 i10) (<= i10 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1386 j15))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1386 i10)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1386 j15)))) true))
  (= j15 i10))))))))))))))

;; H
  (assert (= o20 (select temp___1386 i9)))
