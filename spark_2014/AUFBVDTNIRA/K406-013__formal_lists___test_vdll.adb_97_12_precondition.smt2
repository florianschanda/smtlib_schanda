...
;; H
  (assert
  (and (= o9 (first (mk___rep l3__split_discrs l3__split_fields2)))
  (ite (= (= (length (mk___rep l3__split_discrs l3__split_fields2)) 0) true)
  (= (bool_eq3 o9 no_element) true)
  (and
  (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o9) true)
  (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o9) 1)))))

;; H
  (assert
  (and (= o10 (next (mk___rep l3__split_discrs l3__split_fields2) o9))
  (ite (= (ite (= (bool_eq3 o9 no_element) false) (= (get1
                                                     (positions
                                                     (mk___rep
                                                     l3__split_discrs
                                                     l3__split_fields2)) 
                                                     o9) (length
                                                         (mk___rep
                                                         l3__split_discrs
                                                         l3__split_fields2))) true) true)
  (= (bool_eq3 o10 no_element) true)
  (and
  (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o10) true)
  (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o10) (+ 
  (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o9) 1))))))

;; H
  (assert
  (and (= o11 (next (mk___rep l1__split_discrs l1__split_fields4) o10))
  (ite (= (ite (= (bool_eq3 o10 no_element) false) (= (get1
                                                      (positions
                                                      (mk___rep
                                                      l1__split_discrs
                                                      l1__split_fields4))
                                                      o10) (length
                                                           (mk___rep
                                                           l1__split_discrs
                                                           l1__split_fields4))) true) true)
  (= (bool_eq3 o11 no_element) true)
  (and
  (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o11) true)
  (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o11) (+ 
  (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o10) 1))))))
...
;; WP_parameter_def
 ;; File "test_vdll.adb", line 18, characters 0-0
  (not
  (or
  (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o11) true)
  (= (bool_eq3 o11 no_element) true))))
(check-sat)
