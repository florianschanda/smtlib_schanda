...
;; H
  (assert
  (and (= temp___2589 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2589)
  (<= temp___2589 (to_rep1 n__last))))

;; H
  (assert (= o56 temp___2589))
