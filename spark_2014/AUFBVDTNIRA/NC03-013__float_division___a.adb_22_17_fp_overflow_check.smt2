...
(define-fun in_range1 ((x (_ BitVec 16))) Bool (and
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral2) (= (tqtreal fliteral2) 0.0)))

(declare-fun fliteral3 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 13750.0)))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral4) (/ 899999976158142089843750.0 1000000000000000000000000.0))))

(declare-fun fliteral5 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral5) (= (tqtreal fliteral5) 7352600.0)))
...
;; H
  (assert (=> (le fliteral2 fliteral3) (in_range2 y)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite h)))

;; H
  (assert (not (= x ((_ int2bv 16) 0))))

;; H
  (assert (le fliteral4 (of_ubv16 RNA2 x)))

(assert
;; WP_parameter_def
 ;; File "a.ads", line 10, characters 0-0
  (not (tqtisFinite (div1 RNE2 fliteral5 (of_ubv16 RNA2 x)))))
(check-sat)
