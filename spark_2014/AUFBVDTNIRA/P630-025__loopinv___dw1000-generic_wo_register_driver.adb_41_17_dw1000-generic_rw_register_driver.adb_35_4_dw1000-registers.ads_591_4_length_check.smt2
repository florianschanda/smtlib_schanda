...
(define-fun us_split_fields_Reserved22__projection ((a us_split_fields)) bits_30 
  (rec__dw1000__register_types__evc_ctrl_type__reserved a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_87__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_87__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))
...
(declare-fun dw1000__register_types__evc_ctrl_type__evc_en__first__bit () Int)

(declare-fun dw1000__register_types__evc_ctrl_type__evc_en__last__bit () Int)

(declare-fun dw1000__register_types__evc_ctrl_type__evc_en__position () Int)
...
(declare-fun dw1000__register_types__evc_ctrl_type__evc_clr__first__bit () Int)

(declare-fun dw1000__register_types__evc_ctrl_type__evc_clr__last__bit () Int)

(declare-fun dw1000__register_types__evc_ctrl_type__evc_clr__position () Int)
...
(declare-fun dw1000__register_types__evc_ctrl_type__reserved__first__bit () Int)

(declare-fun dw1000__register_types__evc_ctrl_type__reserved__last__bit () Int)

(declare-fun dw1000__register_types__evc_ctrl_type__reserved__position () Int)
...
(define-fun register_type__ref_212__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_149__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_149__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6850 us_t1)
  (temp___is_init_6847 Bool) (temp___skip_constant_6848 Bool)
  (temp___do_toplevel_6849 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6848 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_6850)
                                       (last4 temp___expr_6850))
                                       (and (= (first3 temp___expr_6850) 1)
                                       (= (last4 temp___expr_6850) 4)))))
...
(define-fun target__ref_64__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_64__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_6868 us_t2)
  (temp___is_init_6865 Bool) (temp___skip_constant_6866 Bool)
  (temp___do_toplevel_6867 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6866 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_6868)
                                       (last6 temp___expr_6868))
                                       (and (= (first5 temp___expr_6868) 1)
                                       (= (last6 temp___expr_6868) 4)))))
...
(declare-fun temp___8032 () (Array Int bits_8))

(declare-fun temp___80321 () t2)

(declare-fun temp___8033 () (Array Int bits_8))

(declare-fun temp___80331 () t1)

(define-fun temp___80322 () us_t2 (mk___t2 temp___8032 temp___80321))
...
;; H
  (assert
  (and
  (and (= temp___80322 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___80322 reg)) (dynamic_invariant1
  temp___80322 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80321)) (to_rep (last5 temp___80321)))
     (+ (- (to_rep (last5 temp___80321)) (to_rep (first4 temp___80321))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___8032 temp___8033))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80321)) (to_rep (last5 temp___80321))) 
  temp___80331))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___80331)) (to_rep (last3 temp___80331)))
     (+ (- (to_rep (last3 temp___80331)) (to_rep (first2 temp___80331))) 1)
