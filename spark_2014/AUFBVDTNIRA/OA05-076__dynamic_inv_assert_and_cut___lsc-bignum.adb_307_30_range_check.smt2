...
;; H
  (assert
  (and (= o21 (from_word32 carry22)) (from_word32__function_guard o21
  carry22)))
...
;; H
  (assert
  (and (= o19 (from_word32 carry12)) (from_word32__function_guard o19
  carry12)))

;; H
  (assert (and (= o23 (oadd o19 o22)) (oadd__function_guard o23 o19 o22)))
