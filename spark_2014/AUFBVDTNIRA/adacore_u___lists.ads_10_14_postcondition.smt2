...
(declare-datatypes ()
((us_split_discrs (mk___split_discrs (rec__lists__cell__is_set Bool)))))
...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__lists__cell__next index)))))
...
(declare-fun lists__cell__is_set__first__bit () Int)

(declare-fun lists__cell__is_set__last__bit () Int)

(declare-fun lists__cell__is_set__position () Int)
...
(declare-fun lists__cell__next__first__bit () Int)

(declare-fun lists__cell__next__last__bit () Int)

(declare-fun lists__cell__next__position () Int)
...
(declare-fun goes_to2 (Int Int (Array Int us_rep)) Bool)

(declare-fun goes_to2__function_guard (Bool Int Int (Array Int us_rep)) Bool)
...
;; goes_to2__post_axiom
  (assert true)

;; goes_to2__def_axiom
  (assert
  (forall ((i Int) (j Int))
  (forall ((lists__memory1 (Array Int us_rep)))
  (! (= (= (goes_to2 i j lists__memory1) true)
     (and
     (= (rec__lists__cell__is_set
        (us_split_discrs1 (select lists__memory1 i))) true)
     (= (to_rep
        (rec__lists__cell__next (us_split_fields1 (select lists__memory1 i)))) j))) :pattern (
  (goes_to2 i j lists__memory1)) ))))
...
(declare-fun lists__cell__is_set__first__bit1 () Int)

(declare-fun lists__cell__is_set__last__bit1 () Int)

(declare-fun lists__cell__is_set__position1 () Int)

;; lists__cell__is_set__first__bit_axiom
  (assert (<= 0 lists__cell__is_set__first__bit1))

;; lists__cell__is_set__last__bit_axiom
  (assert
  (< lists__cell__is_set__first__bit1 lists__cell__is_set__last__bit1))

;; lists__cell__is_set__position_axiom
  (assert (<= 0 lists__cell__is_set__position1))

(declare-fun lists__cell__next__first__bit1 () Int)

(declare-fun lists__cell__next__last__bit1 () Int)

(declare-fun lists__cell__next__position1 () Int)

;; lists__cell__next__first__bit_axiom
  (assert (<= 0 lists__cell__next__first__bit1))

;; lists__cell__next__last__bit_axiom
  (assert (< lists__cell__next__first__bit1 lists__cell__next__last__bit1))

;; lists__cell__next__position_axiom
  (assert (<= 0 lists__cell__next__position1))
...
(declare-fun memory11 () (Array Int us_rep))

(declare-fun memory12 () (Array Int us_rep))

(declare-fun memory13 () (Array Int us_rep))
...
;; H
  (assert (= (of_int 1) temp___179))

;; H
  (assert (= temp___1791 o1))

;; H
  (assert (= true temp___1792))

;; H
  (assert
  (=> (= (attr__constrained (select memory1 i)) true)
  (= temp___179 (rec__lists__cell__is_set
...
;; H
  (assert (= (attr__constrained (select memory1 i)) o4))

;; H
  (assert
  (= o5 (store memory1 i (mk___rep (mk___split_discrs o2)
                         (mk___split_fields o3) o4))))
...
;; H
  (assert (= memory11 memory12))

;; H
  (assert (= memory13 memory11))

(assert
;; WP_parameter_def
 ;; File "lists.ads", line 25, characters 0-0
  (not (= (goes_to2 i j memory12) true)))
(check-sat)
