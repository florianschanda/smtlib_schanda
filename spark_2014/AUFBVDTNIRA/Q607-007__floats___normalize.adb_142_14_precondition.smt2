...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral1) (= (tqtreal fliteral1) 720.0)))
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral2) (= (tqtreal fliteral2) 3.0)))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral4) 340282001837565597733306976381245063168.0)))

(define-fun in_range3 ((x1 t)) Bool (and (tqtisFinite x1)
                                    (and (le (neg fliteral4) x1) (le x1
                                    fliteral4))))
...
(define-fun dynamic_invariant1 ((temp___expr_135 t) (temp___is_init_132 Bool)
  ...
  (temp___do_toplevel_134 Bool)) Bool (=>
                                      ...
                                      (neg fliteral4) fliteral4)) (in_range3
                                      temp___expr_135)))
...
;; r4__post_axiom
  (assert
  (forall ((x1 t))
  (! (=> (and (dynamic_invariant1 x1 true true true) (le (neg fliteral4) x1))
     (let ((result (r4 x1)))
     (=> (r4__function_guard result x1)
     (and (eq result (roundToIntegral RTN2 x1)) (dynamic_invariant1 result
...
;; r4__def_axiom
  ...
  (forall ((x1 t))
  (! (=>
     (and (dynamic_invariant1 x1 true true true) (r4__function_guard 
     (r4 x1) x1)) (= (r4 x1) (roundToIntegral RTN2 x1))) :pattern ((r4 x1)) )))
...
(define-fun dynamic_invariant2 ((temp___expr_147 t) (temp___is_init_144 Bool)
  ...
  (temp___do_toplevel_146 Bool)) Bool (=>
                                      ...
                                      (neg fliteral2) fliteral3)) (in_range2
                                      temp___expr_147)))
...
;; WP_parameter_def
 ;; File "normalize.ads", line 9, characters 0-0
  (not (le (neg fliteral4) (div1 RNE2 x fliteral5))))
(check-sat)
