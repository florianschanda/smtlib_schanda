...
;; def_axiom
  (assert
  (forall ((temp___2668 Int) (temp___2669 Int) (temp___2670 Int)
  (temp___2671 Int) (temp___2672 Int) (temp___2673 Int) (temp___2674 Int))
  (let ((temp___2667 (aida__conversion__calculate_negative_target_length_6__int_array__aggregate_def
                     temp___2668 temp___2669 temp___2670 temp___2671
                     temp___2672 temp___2673 temp___2674)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 5)
  temp___2673 temp___2674)
  (and (= (first7 temp___2667) temp___2673)
  (= (last7 temp___2667) temp___2674)))
  (and
  (and
  (and
  (and
  (= (select (to_array2 temp___2667) (+ (+ (first1 source) 1) 0)) (of_rep1
                                                                  temp___2668))
  (= (select (to_array2 temp___2667) (+ (+ (first1 source) 1) 1)) (of_rep1
                                                                  temp___2669)))
  (= (select (to_array2 temp___2667) (+ (+ (first1 source) 1) 2)) (of_rep1
                                                                  temp___2670)))
  (= (select (to_array2 temp___2667) (+ (+ (first1 source) 1) 3)) (of_rep1
                                                                  temp___2671)))
  (= (select (to_array2 temp___2667) (+ (+ (first1 source) 1) 4)) (of_rep1
                                                                  temp___2672)))))))
...
;; def_axiom
  (assert
  (forall ((temp___2680 Int) (temp___2681 Int) (temp___2682 Int))
  (let ((temp___2679 (aida__conversion__calculate_negative_target_length_6__n__aggregate_def
                     temp___2680 temp___2681 temp___2682)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 5)
  temp___2681 temp___2682)
  (and (= (first13 temp___2679) temp___2681)
  (= (last13 temp___2679) temp___2682)))
  (forall ((temp___2683 Int))
  (= (select (to_array4 temp___2679) temp___2683) (of_rep1 temp___2680)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_900 us_t3)
  ...
  (temp___do_toplevel_899 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 1)
                                      (+ (first1 source) 5)
                                      (first10 temp___expr_900)
                                      (last10 temp___expr_900))
                                      (and
                                      (= (first10 temp___expr_900) (+ 
                                      (first1 source) 1))
                                      (= (last10 temp___expr_900) (+ 
...
(declare-fun temp___2677 () (Array Int integer))

(declare-fun temp___26771 () t2)
...
(declare-fun temp___2685 () (Array Int integer))

(declare-fun temp___26851 () t4)
...
(declare-fun temp___2691 () Int)

(declare-fun temp___2692 () Int)

(declare-fun temp___2690 () Int)

(declare-fun temp___2688 () (Array Int integer))
...
;; H
  (assert
  (= (mk___t2 temp___2677 temp___26771) (aida__conversion__calculate_negative_target_length_6__int_array__aggregate_def
                                        9 9 9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___26771)) (to_rep1 (last6 temp___26771)))
     (+ (- (to_rep1 (last6 temp___26771)) (to_rep1 (first6 temp___26771))) 1)
...
;; H
  (assert
  (= (slide1 temp___2677 (to_rep1 (first6 temp___26771))
...
;; H
  (assert
  (= (mk___t4 temp___2685 temp___26851) (aida__conversion__calculate_negative_target_length_6__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 1)
                                        (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___26851)) (to_rep1
                                               (last12 temp___26851)))
     (+ (- (to_rep1 (last12 temp___26851)) (to_rep1 (first12 temp___26851))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1
                                                        (first (rt source))) 5))
        (+ (- (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1
                                                     (first (rt source))) 1)) 1)
...
;; H
  (assert
  (= (slide1 temp___2685 (to_rep1 (first12 temp___26851))
...
;; H
  (assert
  (and (= temp___2691 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (= temp___2692 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))
...
;; H
  (assert (= index1 temp___2691))

;; H
  (assert
  (=> (and (<= temp___2691 index1) (<= index1 temp___2692))
  (= temp___2690 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2691 index1) (<= index1 temp___2692)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___2691 index1) (<= index1 temp___2692)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2691 index1) (<= index1 temp___2692)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2691 index1) (<= index1 temp___2692)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___2691 index1) (<= index1 temp___2692)) (= n2 o8)))
...
;; H
  ...
  (and
  (and
  (forall ((temp___2689 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___2689)
  (<= temp___2689 (to_rep1 n__last)))
  (=> (< index2 temp___2689)
  (= (select n3 temp___2689) (select temp___2688 temp___2689)))))
  (=>
...
;; H
  (assert
  (=> (and (<= temp___2691 index1) (<= index1 temp___2692)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___2691 index1) (<= index1 temp___2692)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___2691 index1) (<= index1 temp___2692)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___2691 index1) (<= index1 temp___2692)))
...
;; H
  (assert
  (=> (not (and (<= temp___2691 index1) (<= index1 temp___2692))) (= n7 n1)))
...
;; H
  (assert
  (and (= temp___2693 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2693)
  (<= temp___2693 (to_rep1 n__last))))

;; H
  (assert (= o9 temp___2693))
...
;; H
  (assert
  (and (= temp___2694 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2694)
  (<= temp___2694 (to_rep1 n__last))))

;; H
  (assert (= o14 temp___2694))
...
;; H
  (assert
  (and (= temp___2695 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2695)
  (<= temp___2695 (to_rep1 n__last))))

;; H
  (assert (= o21 temp___2695))
...
;; H
  (assert
  (and (= temp___2696 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2696)
  (<= temp___2696 (to_rep1 n__last))))

;; H
  (assert (= o28 temp___2696))
