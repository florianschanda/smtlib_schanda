...
(declare-fun temp___902 () t)

(declare-fun temp___901 () t)

(declare-fun temp___900 () t)

(declare-fun temp___899 () t)

(declare-fun temp___898 () Int)

(declare-fun temp___897 () t)
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 1000))
  (=> (= result3 true) (= o4 (div1 RNE2 o3 safetydist)))))
...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 1000))
  (=> (= result3 true)
  (and (= o16 (create__2 fliteral4)) (create__2__function_guard o16
  fliteral4)))))
...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 1000))
  (=> (= result3 true)
  (and (= o11 (add RNE2 deltaareasum2 (mul RNE2 deltamag3 deltamag3)))
  (tqtisFinite (add RNE2 deltaareasum2 (mul RNE2 deltamag3 deltamag3)))))))
...
;; H
  ...
  (=> (= result3 true)
  (and
  (= o12 (mul RNE2 (mul RNE2 (mul RNE2 deltamag3 deltamag3) deltamag3)
         deltaangle3))
  (tqtisFinite
  (mul RNE2 (mul RNE2 (mul RNE2 deltamag3 deltamag3) deltamag3) deltaangle3))))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 1000))
  (=> (= result3 true) (= o13 (add RNE2 obstacleavoiddelta2 o12)))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (tqtisFinite
  (div1 RNE2 (t__content obstacleavoiddelta6) (t__content deltaareasum6)))))
(check-sat)
