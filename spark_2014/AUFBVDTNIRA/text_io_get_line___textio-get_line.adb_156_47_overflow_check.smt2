...
;; H
  (assert
  (=> (not (= success true))
  (and (= o4 (ferror (to_rep2 file__split_fields))) (in_range5 o4))))
...
;; H
  (assert
  (=> (not (= success true)) (= result3 (ite (not (= o5 true)) true false))))
...
;; H
  (assert
  (=> (not (= result7 true))
  (and (= temp___600 (+ k1 2)) (in_range1 (+ k1 2)))))

;; H
  (assert
  (=> (not (= result7 true)) (and (<= 1 temp___600) (<= temp___600 80))))
...
;; H
  (assert
  (=> (not (= result7 true)) (= result6 (ite (not (= o11 true)) true false))))
