...
(declare-fun o11 () word32)

(declare-fun o12 () (_ BitVec 32))

(declare-fun o13 () word32)

(declare-fun o14 () Int)

(declare-fun o15 () (Array Int word32))
...
(declare-fun result2 () (Array Int word32))
...
;; H
  (assert (and (= temp___1639 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert
  (and (<= (to_rep a__first) temp___1639) (<= temp___1639 (to_rep a__last))))

;; H
  (assert (= o temp___1639))
...
;; H
  (assert (from_word32__function_guard (from_word32 temp1) temp1))

;; H
  (assert (from_word32__function_guard (from_word32 o7) o7))
...
;; H
  (assert (omultiply__function_guard
  (omultiply (from_word32 o7) (from_word32 x)) (from_word32 o7)
  (from_word32 x)))
...
;; H
  (assert (oadd__function_guard
  (oadd (from_word32 temp1) (omultiply (from_word32 o7) (from_word32 x)))
  (from_word32 temp1) (omultiply (from_word32 o7) (from_word32 x))))

;; H
  (assert (from_word32__function_guard (from_word32 o12) o12))
...
;; H
  (assert (omultiply__function_guard
  (omultiply (from_word32 o12) (from_word32 y)) (from_word32 o12)
  (from_word32 y)))
...
;; H
  ...
  (oadd
  (oadd (from_word32 temp1) (omultiply (from_word32 o7) (from_word32 x)))
  (omultiply (from_word32 o12) (from_word32 y)))
  (oadd (from_word32 temp1) (omultiply (from_word32 o7) (from_word32 x)))
  (omultiply (from_word32 o12) (from_word32 y))))
...
;; H
  ...
  (oadd
  (oadd (from_word32 temp1) (omultiply (from_word32 o7) (from_word32 x)))
  (omultiply (from_word32 o12) (from_word32 y))) (from_word32 carry11))
  (oadd
  (oadd (from_word32 temp1) (omultiply (from_word32 o7) (from_word32 x)))
  (omultiply (from_word32 o12) (from_word32 y))) (from_word32 carry11)))
...
;; H
  (assert (from_word32__function_guard (from_word32 temp2) temp2))
...
;; H
  (assert (oadd__function_guard
  (oadd (from_word32 temp2)
  (omultiply (base Tuple0)
  (oadd (from_word32 carry12)
  (omultiply (base Tuple0) (from_word32 carry22))))) (from_word32 temp2)
  (omultiply (base Tuple0)
  (oadd (from_word32 carry12)
  (omultiply (base Tuple0) (from_word32 carry22))))))
...
;; H
  (assert (and (= temp___1641 o9) (in_range1 o9)))

;; H
  (assert
  (and (<= (to_rep (first (rt c))) temp___1641)
  (<= temp___1641 (to_rep (last (rt c))))))

;; H
  (assert (= o10 temp___1641))
...
;; H
  (assert (and (= temp___1640 o4) (in_range1 o4)))

;; H
  (assert
  (and (<= (to_rep (first (rt b))) temp___1640)
  (<= temp___1640 (to_rep (last (rt b))))))

;; H
  (assert (= o5 temp___1640))
...
;; H
  (assert (and (= o24 (+ a_last 1)) (in_range1 (+ a_last 1))))

;; H
  (assert (= o25 (ite (<= k o24) true false)))

;; H
  (assert (and (= o23 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert (= o26 (ite (<= o23 k) true false)))

;; H
  (assert (= result3 (ite (= o26 true) o25 false)))

;; H
  (assert
  (= (= o27 true)
  (forall ((k1 Int))
  (=> (and (<= (+ i2 1) k1) (<= k1 (+ a_last 1)))
...
;; H
  (assert
  (and (= o20 (from_word32 carry22)) (from_word32__function_guard o20
  carry22)))
...
;; H
  (assert
  (and (= o18 (from_word32 carry12)) (from_word32__function_guard o18
  carry12)))

;; H
  (assert (and (= o22 (oadd o18 o21)) (oadd__function_guard o22 o18 o21)))
