...
(declare-fun temp___2002 ((Array Int (Array Int (Array Int et1))) Int
  (Array Int (Array Int et1)) Int
  (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))

;; def_axiom
  (assert
  (forall ((temp___2004 (Array Int (Array Int (Array Int et1)))))
  (forall ((temp___2005 Int) (temp___2007 Int))
  (forall ((temp___2006 (Array Int (Array Int et1)))
  (temp___2008 (Array Int (Array Int et1))))
  (let ((temp___2003 (temp___2002 temp___2004 temp___2005 temp___2006
                     temp___2007 temp___2008)))
  (forall ((temp___2009 Int))
  (ite (= temp___2009 temp___2007)
  (= (select temp___2003 temp___2009) temp___2008)
  (ite (= temp___2009 temp___2005)
  (= (select temp___2003 temp___2009) temp___2006)
  (= (select temp___2003 temp___2009) (select temp___2004 temp___2009))))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 499, characters 0-0
  (not (= (bool_eq4 a3 1 16 (temp___2002 a i b j c) 1 16) true)))
(check-sat)
