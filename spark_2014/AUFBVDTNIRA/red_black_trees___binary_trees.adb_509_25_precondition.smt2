...
;; H
  (assert (= o13 (select temp___1276 i)))
...
;; H
  ...
  (= temp___1275 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___1275 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1275 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o10 (select temp___1275 o9)))
