...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 1024))
  (=> (not (= (to_rep (select buffer i3)) erase_character))
  (= (to_rep o1) (to_rep (select buffer i3))))))
...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 1024))
  (=> (not (= (to_rep (select buffer i3)) erase_character)) (= offset3 o4))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 1024))
  (=> (not (not (= (to_rep (select buffer i3)) erase_character)))
  (= offset3 offset2))))
...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 1024)) (= (mk_int__ref i6) (mk_int__ref i4))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 1024))
  (= (mk_int__ref offset6) (mk_int__ref offset4))))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 1024))
  (= (mk_map__ref workspace6) (mk_map__ref workspace4))))
...
;; H
  (assert (= (to_rep o5) fill_character))
