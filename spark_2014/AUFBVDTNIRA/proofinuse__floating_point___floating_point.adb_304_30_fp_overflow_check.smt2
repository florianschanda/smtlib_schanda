...
;; H
  (assert (tqtisFinite d0))

;; H
  (assert (tqtisFinite d1))

;; H
  (assert (tqtisFinite r))

;; H
  (assert (lt d0 d1))

;; H
  (assert (and (le fliteral2 r) (le r fliteral)))

;; H
  (assert (le fliteral2 d0))

;; H
  (assert (and (= o (sub RNE2 d1 d0)) (tqtisFinite (sub RNE2 d1 d0))))

;; H
  (assert (= o1 (mul RNE2 o r)))
