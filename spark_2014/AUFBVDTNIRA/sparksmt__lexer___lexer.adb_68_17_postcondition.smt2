...
;; H
  ...
  (=> (= (to_rep1 current_read__split_discrs) 0)
  (=> (= (to_rep current_read__split_fields) 10)
  (= (mk_int__ref result1) current_col6))))

;; H
  (assert
  (=> (= (to_rep1 current_read__split_discrs) 0)
  (=> (= (to_rep current_read__split_fields) 10) (= current_col2 0))))
...
;; H
  ...
  (=> (not (= (to_rep current_read__split_fields) 10))
  (=> (not (= (to_rep current_read__split_fields) 13))
  (= (mk_int__ref result2) current_col6)))))
...
;; H
  (assert
  (=> (= (to_rep1 current_read__split_discrs) 0)
  (and (= o2 (+ current_pos 1)) (in_range (+ current_pos 1)))))

;; H
  (assert
  (=> (= (to_rep1 current_read__split_discrs) 0) (= result3 current_pos)))

;; H
  (assert
  (=> (= (to_rep1 current_read__split_discrs) 0) (= current_pos2 o2)))
