...
;; WP_parameter_def
 ;; File "arr_aggregate.ads", line 41, characters 0-0
  (not
  (= (bool_eq3 a1 1 2 (temp___224 (temp___229 one 2) (temp___234 one 2)) 1 2) true)))
(check-sat)
