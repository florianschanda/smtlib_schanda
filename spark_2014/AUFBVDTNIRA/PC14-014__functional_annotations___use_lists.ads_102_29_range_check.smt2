...
;; H
  ...
  (and (not (= (has_key o16 no_element) true))
  (forall ((i2 us_rep1))
  (=> (= (has_key o16 i2) true)
  (and
  (and (<= 1 (get1 o16 i2))
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o16 j) true)
  (=> (= (get1 o16 i2) (get1 o16 j)) (= (bool_eq3 i2 j) true))))))))))
...
;; H
  ...
  (and (in_range5 o20)
  (=> (= (of_int 0) true)
  (and (= o20 (w_get o16 (witness o16 cu)))
  (forall ((k us_rep1))
  (=> (= (has_key o16 k) true)
  (= (= (bool_eq3 k cu) true) (= (witness o16 cu) (witness o16 k))))))))))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o14 j) true)
  (=> (= (get1 o14 i2) (get1 o14 j)) (= (bool_eq3 i2 j) true))))))))))

;; H
  (assert
  (and (= o15 (has_key o14 cu))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o14 k) true) (= (bool_eq3 k cu) true))) (= o15 true)))))
...
;; H
  ...
  (= o10 (length
         (mk___rep l__split_discrs (mk___split_fields l__split_fields8))))
  (and (in_range2 o10)
  (<= o10 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
...
;; H
  (assert (= o12 (ite (<= o9 i1) true false)))
