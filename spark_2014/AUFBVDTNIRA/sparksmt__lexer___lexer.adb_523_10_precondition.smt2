...
;; H
  (assert
  (=> (= (let ((subject state)) state21) 3)
  (= next_read__split_discrs32 next_read__split_discrs7)))

;; H
  (assert
  (=> (= (let ((subject state)) state21) 3)
  (= next_read__split_fields32 next_read__split_fields7)))
...
;; H
  (assert
  (=> (= (let ((subject state)) state21) 3)
  (= current_read__split_discrs32 current_read__split_discrs7)))

;; H
  (assert
  (=> (= (let ((subject state)) state21) 3)
  (= current_read__split_fields32 current_read__split_fields7)))
...
;; H
  ...
  (=> (not (= (let ((subject state)) state21) 0))
  (=> (= (let ((subject state)) state21) 1)
  (= next_read__split_discrs10 next_read__split_discrs7)))))))))
...
;; H
  ...
  (=> (not (= (let ((subject state)) state21) 0))
  (=> (= (let ((subject state)) state21) 1)
  (= next_read__split_fields10 next_read__split_fields7)))))))))
...
;; H
  ...
  (=> (not (= (let ((subject state)) state21) 0))
  (=> (= (let ((subject state)) state21) 1)
  (= current_read__split_discrs10 current_read__split_discrs7)))))))))
...
;; H
  ...
  (=> (not (= (let ((subject state)) state21) 0))
  (=> (= (let ((subject state)) state21) 1)
  (= current_read__split_fields10 current_read__split_fields7)))))))))
...
;; H
  ...
  (=> (not (= (let ((subject state)) state21) 0))
  (=> (= (let ((subject state)) state21) 1)
  (= next_read__split_discrs19 next_read__split_discrs9)))))))))
...
;; H
  ...
  (=> (not (= (let ((subject state)) state21) 0))
  (=> (= (let ((subject state)) state21) 1)
  (= next_read__split_fields19 next_read__split_fields9)))))))))
...
;; H
  ...
  (=> (not (= (let ((subject state)) state21) 0))
  (=> (= (let ((subject state)) state21) 1)
  (= current_read__split_discrs19 current_read__split_discrs9)))))))))
...
;; H
  ...
  (=> (not (= (let ((subject state)) state21) 0))
  (=> (= (let ((subject state)) state21) 1)
  (= current_read__split_fields19 current_read__split_fields9)))))))))
...
;; H
  ...
  (=> (not (= (let ((subject state)) state21) 1))
  (=> (= (let ((subject c)) c8) 34)
  (= next_read__split_discrs14 next_read__split_discrs11))))))))))
...
;; H
  ...
  (=> (not (= (let ((subject state)) state21) 1))
  (=> (= (let ((subject c)) c8) 34)
  (= next_read__split_fields14 next_read__split_fields11))))))))))
...
;; H
  ...
  (=> (not (= (let ((subject state)) state21) 1))
  (=> (= (let ((subject c)) c8) 34)
  (= current_read__split_discrs14 current_read__split_discrs11))))))))))
...
;; H
  ...
  (=> (not (= (let ((subject state)) state21) 1))
  (=> (= (let ((subject c)) c8) 34)
  (= current_read__split_fields14 current_read__split_fields11))))))))))
...
;; H
  ...
  (=> (not (= (let ((subject state)) state21) 1))
  (=> (not (= (let ((subject c)) c8) 34))
  (= next_read__split_discrs16 next_read__split_discrs7))))))))))
...
;; H
  ...
  (=> (not (= (let ((subject state)) state21) 1))
  (=> (not (= (let ((subject c)) c8) 34))
  (= next_read__split_fields16 next_read__split_fields7))))))))))
...
;; H
  ...
  (=> (not (= (let ((subject state)) state21) 1))
  (=> (not (= (let ((subject c)) c8) 34))
  (= current_read__split_discrs16 current_read__split_discrs7))))))))))
...
;; H
  ...
  (=> (not (= (let ((subject state)) state21) 1))
  (=> (not (= (let ((subject c)) c8) 34))
  (= current_read__split_fields16 current_read__split_fields7))))))))))
...
;; H
  (assert (local_invariant__function_guard
  (local_invariant (us_split_fields__content current_read__split_fields31)
  (us_split_discrs__content current_read__split_discrs31)
  (us_split_fields__content next_read__split_fields31)
  (us_split_discrs__content next_read__split_discrs31))
  (us_split_fields__content current_read__split_fields31)
  (us_split_discrs__content current_read__split_discrs31)
  (us_split_fields__content next_read__split_fields31)
  (us_split_discrs__content next_read__split_discrs31)))
...
;; WP_parameter_def
 ;; File "lexer.ads", line 65, characters 0-0
  ...
  (= (local_invariant (us_split_fields__content current_read__split_fields31)
     (us_split_discrs__content current_read__split_discrs31)
     (us_split_fields__content next_read__split_fields31)
     (us_split_discrs__content next_read__split_discrs31)) true)))
(check-sat)
