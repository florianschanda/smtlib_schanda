...
(declare-fun to_int3 (mode t) Int)
...
;; is_finite
  (assert (forall ((x t)) (=> (tqtisFinite x) (in_range3 (tqtreal x)))))

(define-fun no_overflow ((m mode) (x Real)) Bool (in_range3 (round m x)))

;; Bounded_real_no_overflow
  (assert (forall ((m mode) (x Real)) (=> (in_range3 x) (no_overflow m x))))
...
;; is_int_of_int
  ...
  (=> (is_int1 x) (eq x (of_int mqt (to_int3 m x))))))

;; is_int_to_int
  (assert
  (forall ((m mode) (x t)) (=> (is_int1 x) (in_int_range (to_int3 m x)))))
...
;; int_to_real
  (assert
  (forall ((m mode) (x t))
  (=> (is_int1 x) (= (tqtreal x) (to_real (to_int3 m x))))))
...
;; ceil_to_int
  ...
  (forall ((m mode) (x t))
  (=> (tqtisFinite x)
  (= (to_int3 m (roundToIntegral RTP1 x)) (- 1 (to_int (- 1.0 (tqtreal x))))))))
...
;; floor_to_int
  ...
  (forall ((m mode) (x t))
  (=> (tqtisFinite x)
  (= (to_int3 m (roundToIntegral RTN1 x)) (to_int (tqtreal x))))))
...
;; to_int_roundToIntegral
  (assert
  (forall ((m mode) (x t))
  (= (to_int3 m x) (to_int3 m (roundToIntegral m x)))))

;; to_int_monotonic
  (assert
  (forall ((m mode) (x t) (y t))
  (=> (tqtisFinite x)
  (=> (tqtisFinite y) (=> (le x y) (<= (to_int3 m x) (to_int3 m y)))))))

;; to_int_of_int
  (assert
  (forall ((m mode) (i Int))
  (=> (in_safe_int_range i) (= (to_int3 m (of_int m i)) i))))

;; eq_to_int
  (assert
  (forall ((m mode) (x t) (y t))
  (=> (tqtisFinite x) (=> (eq x y) (= (to_int3 m x) (to_int3 m y))))))

;; neg_to_int
  (assert
  (forall ((m mode) (x t))
  (=> (is_int1 x) (= (to_int3 m (neg x)) (- (to_int3 m x))))))
