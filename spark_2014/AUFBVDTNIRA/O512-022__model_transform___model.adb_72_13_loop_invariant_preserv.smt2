...
;; H
  (assert (= o6 (select temp___515 s9)))
...
;; H
  (assert (= o8 (select temp___516 s9)))
...
;; H
  (assert (from__2__function_guard (from__2 (select (map__content3 cfv5) t))
  (select (map__content3 cfv5) t)))
