...
(declare-fun ctx__split_fields6 () us_split_fields__ref)
...
(define-fun ctx__split_fields8 () us_split_fields (mk___split_fields
                                                  ctx__split_fields4
                                                  ctx__split_fields5))
...
;; H
  (assert (= ctx__split_fields6 (mk___split_fields__ref ctx__split_fields8)))
...
;; H
  (assert (= ctx__split_fields7 ctx__split_fields8))

;; H
  (assert (rate_of__function_guard
  (rate_of (mk___rep (us_split_fields__content ctx__split_fields6)))
  (mk___rep (us_split_fields__content ctx__split_fields6))))
