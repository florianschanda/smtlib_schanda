...
;; element__2__post__dispatch_axiom
  ...
  (forall ((container us_rep))
  (! (=> (dynamic_invariant5 key true true true) (dynamic_invariant6
...
;; first_key__post_axiom
  ...
  (! (=> (not (= (is_empty1 container) true))
     ...
     (dynamic_invariant5 result true false true)))) :pattern ((first_key
                                                              container)) )))
...
;; find__post_axiom
  ...
  (forall ((container us_rep2))
  (forall ((key Int))
  (! (=> (dynamic_invariant5 key true true true)
...
(define-fun key_type__ref_3__projection ((a key_type__ref2)) us_rep4 
...
(define-fun default_initial_assumption2 ((temp___expr_385 us_rep3)
  (temp___skip_top_level_386 Bool)) Bool (=>
                                         ...
                                         (and
                                         (= (is_empty3 temp___expr_385) true)
...
;; positions__post_axiom
  ...
  (! (let ((result (positions container)))
     ...
     (=> (= (get2 result i) (get2 result j)) (= (bool_eq12 i j) true))))))))) :pattern (
  (positions container)) )))
...
;; has_key__post_axiom
  ...
  (! (=> (= (of_int 0) true)
     (=>
     (exists ((k us_rep4))
     (and (= (has_key1 container k) true) (= (bool_eq12 k key) true)))
...
;; H
  ...
  (and (in_range2 o)
  (<= o (to_rep
        (rec__use_ordered_maps__my_maps__map__capacity m__split_discrs))))))
...
(assert
;; WP_parameter_def
 ;; File "use_ordered_maps.ads", line 76, characters 0-0
  (not
  (not
  (= (is_empty1
     (mk___rep m__split_discrs (mk___split_fields m__split_fields))) true))))
(check-sat)
