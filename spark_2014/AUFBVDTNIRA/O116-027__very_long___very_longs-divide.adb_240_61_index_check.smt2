...
(declare-fun temp___1100 () us_rep1)
...
;; H
  (assert (=> (and (<= 1 j1) (<= j1 r139b)) (= temp___1103 current_borrow)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r139b)) (= temp___1102 q_hat)))
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b))
  (= temp___1100 (mk___rep1 u__split_discrs u__split_fields2))))
...
;; H
  (assert (dynamic_property2 1 last3 r141b))
