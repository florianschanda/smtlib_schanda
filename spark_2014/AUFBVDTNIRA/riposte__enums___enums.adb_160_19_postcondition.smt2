...
(declare-fun enums__next_a__result () Int)
...
(declare-fun enums__next_a__result1 () Int)

(declare-fun enums__next_a__result2 () Int)

(declare-fun enums__next_a__result3 () Int)

(declare-fun r3 () Int)

(declare-fun enums__next_a__result4 () Int)

(declare-fun r4 () Int)

(declare-fun enums__next_a__result5 () Int)
...
;; H
  (assert (=> (< a 5) (and (= o a) (not (= a 8)))))

;; H
  (assert (=> (< a 5) (= o1 (+ o 1))))

;; H
  (assert (=> (< a 5) (and (= o2 o1) (in_range2 o1))))
...
;; H
  (assert (=> (not (< a 5)) (= result1 r)))

;; H
  (assert (=> (not (< a 5)) (= r2 3)))

;; H
  (assert (=> (not (< a 5)) (= r1 r2)))

;; H
  (assert (= enums__next_a__result1 enums__next_a__result2))

;; H
  (assert (= enums__next_a__result3 enums__next_a__result1))

;; H
  (assert (= result2 enums__next_a__result))

;; H
  (assert (= enums__next_a__result1 r1))

;; H
  (assert
  (= (mk_int__ref enums__next_a__result4) (mk_int__ref
                                          enums__next_a__result2)))

;; H
  (assert (= r3 r1))

;; H
  (assert (= enums__next_a__result5 enums__next_a__result3))

;; H
  (assert (= r4 r1))

;; H
  (assert (= result3 enums__next_a__result4))
