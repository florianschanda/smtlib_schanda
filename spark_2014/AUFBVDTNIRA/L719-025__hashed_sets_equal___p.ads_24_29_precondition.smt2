...
;; contains__post_axiom
  ...
  (! (=> (dynamic_invariant4 item true true true)
     (and (forall ((e1 Int)) (my_eq__function_guard (my_eq e1 item) e1 item))
     (=> (= (of_int 1) true)
     (=>
     (exists ((e1 Int))
...
;; H
  ...
  (= (my_eq
     (element (mk___rep l__split_discrs l__split_fields6)
     (mk___rep1 cu__split_fields5)) e) true))
  (ite (= (contains
          (model__
  ...
  (= (oeq3 (elements (mk___rep l__split_discrs l__split_fields6))
     (elements
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true))
  (= (oeq4 (positions (mk___rep l__split_discrs l__split_fields6))
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true))
  (and
  (and
  ...
  (= (included_except (model__ (mk___rep l__split_discrs l__split_fields6))
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     e) true))
  (= (mapping_preserved
     (elements
...
;; H
  ...
  (and
  (and
  (and (= (bool_eq4 (mk___rep1 cu__split_fields4) no_element) true)
  (= (length (mk___rep l__split_discrs l__split_fields5)) (- (length
                                                             (mk___rep
                                                             l__split_discrs
                                                             l__split_fields6)) 1)))
  (not
  (= (contains (model__ (mk___rep l__split_discrs l__split_fields5))
     (element (mk___rep l__split_discrs l__split_fields6)
     (mk___rep1 cu__split_fields5))) true)))
  (not
