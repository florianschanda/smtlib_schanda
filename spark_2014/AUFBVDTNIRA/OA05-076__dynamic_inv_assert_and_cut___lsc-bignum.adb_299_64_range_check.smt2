...
;; H
  (assert
  (and (= o50 (from_word32 carry22)) (from_word32__function_guard o50
  carry22)))

;; H
  (assert
  (and (and (= o49 (base Tuple0)) (base__function_guard o49 Tuple0))
  (= o49 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o51 (omultiply o49 o50)) (omultiply__function_guard o51 o49 o50)))

;; H
  (assert
  (and (= o48 (from_word32 carry12)) (from_word32__function_guard o48
  carry12)))

;; H
  (assert (and (= o52 (oadd o48 o51)) (oadd__function_guard o52 o48 o51)))
...
;; H
  (assert
  (and (and (= o42 (base Tuple0)) (base__function_guard o42 Tuple0))
  (= o42 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o47 (oexpon o42 o46)) (oexpon__function_guard o47 o42 o46)))

;; H
  (assert
  (and (= o53 (omultiply o47 o52)) (omultiply__function_guard o53 o47 o52)))
...
;; H
  ...
  (= o41 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))
         a_first o40))
  (num_of_big_int__function_guard o41
  (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o40)))

;; H
  (assert (and (= o54 (oadd o41 o53)) (oadd__function_guard o54 o41 o53)))
...
;; H
  (assert
  (and (= o35 (from_word32 carry2)) (from_word32__function_guard o35 carry2)))
...
;; H
  (assert
  (and (= o33 (from_word32 carry1)) (from_word32__function_guard o33 carry1)))

;; H
  (assert (and (= o31 (from_word32 y)) (from_word32__function_guard o31 y)))
...
;; H
  (assert
  (and (= o30 (num_of_big_int c c_first o29)) (num_of_big_int__function_guard
  o30 c c_first o29)))

;; H
  (assert
  (and (= o32 (omultiply o30 o31)) (omultiply__function_guard o32 o30 o31)))

;; H
  (assert (and (= o24 (from_word32 x)) (from_word32__function_guard o24 x)))
...
;; H
  (assert
  (and (= o23 (num_of_big_int b b_first o22)) (num_of_big_int__function_guard
  o23 b b_first o22)))

;; H
  (assert
  (and (= o25 (omultiply o23 o24)) (omultiply__function_guard o25 o23 o24)))
