...
;; H
  (assert
  (and (= o (sqrt2 (of_int RNE2 i)))
  (and (tqtisFinite o)
  (and (le fliteral2 o)
  (and (=> (eq (of_int RNE2 i) fliteral2) (eq o fliteral2))
  (and (=> (eq (of_int RNE2 i) fliteral) (eq o fliteral))
  (=> (le fliteral3 (of_int RNE2 i)) (lt fliteral2 o))))))))

;; H
  (assert (= o1 (to_int1 RNA2 o)))
