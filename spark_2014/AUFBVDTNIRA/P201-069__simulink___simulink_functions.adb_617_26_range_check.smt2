...
;; H
  (assert
  (and (= o (sqrt2 (of_int RNE1 i)))
  (and (tqtisFinite o)
  (and (le fliteral2 o)
  (and (=> (eq (of_int RNE1 i) fliteral2) (eq o fliteral2))
  (and (=> (eq (of_int RNE1 i) fliteral) (eq o fliteral))
  (=> (le fliteral3 (of_int RNE1 i)) (lt fliteral2 o))))))))
