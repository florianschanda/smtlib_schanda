...
(define-fun dynamic_invariant3 ((temp___expr_694 us_rep1)
  (temp___is_init_691 Bool) (temp___skip_constant_692 Bool)
  (temp___do_toplevel_693 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_692 true))
                                      (in_range3
                                      (to_rep1
                                      (rec__aco__math__very_longs__very_long__octet_length
                                      (us_split_discrs1 l)))
                                      (to_base temp___expr_694)))
                                      ...
                                      (first3
                                      (rec__aco__math__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_694)))
                                      (last5
                                      (rec__aco__math__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_694))))
                                      (and
                                      (= (first3
                                         (rec__aco__math__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_694))) 1)
                                      (= (last5
                                         (rec__aco__math__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_694))) 
                                      (to_rep1
...
(define-fun default_initial_assumption ((temp___expr_697 us_rep1)
  (temp___skip_top_level_698 Bool)) Bool (= (to_rep1
                                            (rec__aco__math__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_697))) (to_rep1
                                                               (rec__aco__math__very_longs__very_long__octet_length
                                                               (us_split_discrs1
                                                               l)))))
...
;; def_axiom
  ...
  (and
  (=> (dynamic_property6 1 2147483647 temp___1153 temp___1154)
  (and (= (first5 temp___1151) temp___1153)
  (= (last8 temp___1151) temp___1154)))
  (forall ((temp___1155 Int))
  (= (select (to_array2 temp___1151) temp___1155) (of_rep temp___1152))))))))
...
;; H
  (assert
  (= (mk___t2 temp___1157 temp___11571) (temp___1150 ((_ int2bv 8) 0) 1
                                        (to_rep1
                                        (rec__aco__math__very_longs__very_long__octet_length
                                        (us_split_discrs1 l))))))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___11571)) (to_rep2 (last7 temp___11571)))
     (+ (- (to_rep2 (last7 temp___11571)) (to_rep2 (first4 temp___11571))) 1)
     0) (ite (<= 1 (to_rep1
                   (rec__aco__math__very_longs__very_long__octet_length
                   (us_split_discrs1 l))))
        (+ (- (to_rep1
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___11571)) (to_rep2 (last7 temp___11571))) 
  temp___11581))
...
;; WP_parameter_def
 ;; File "aco-math-very_longs.ads", line 108, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first2 temp___11581)) (to_rep2 (last4 temp___11581)))
     (+ (- (to_rep2 (last4 temp___11581)) (to_rep2 (first2 temp___11581))) 1)
