...
;; H
  (assert (and (= o1 (length source)) (in_range1 (length source))))

;; H
  (assert (= result2 (ite (< o1 characters_to_copy1) true false)))

;; H
  (assert
  (=> (= result2 true)
  (and (= o2 (length source)) (in_range4 (length source)))))

;; H
  (assert (=> (= result2 true) (= result3 characters_to_copy1)))

;; H
  (assert (=> (= result2 true) (= characters_to_copy2 o2)))
