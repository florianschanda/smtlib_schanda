...
;; H
  (assert
  (and (= o2 (length s1)) (and (in_range2 o2) (<= (+ 0 o2) 2147483647))))

;; H
  (assert
  (and (= o1 (length s2)) (and (in_range2 o1) (<= (+ 0 o1) 2147483647))))
...
;; H
  (assert
  (and (= o (length s2)) (and (in_range2 o) (<= (+ 0 o) 2147483647))))
