...
;; def_axiom
  (assert
  (forall ((temp___1827 Int) (temp___1828 Int) (temp___1829 Int)
  (temp___1830 Int))
  (let ((temp___1826 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__aggregate_def
                     temp___1827 temp___1828 temp___1829 temp___1830)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 9) (+ (first1 source) 10)
  temp___1829 temp___1830)
  (and (= (first5 temp___1826) temp___1829)
  (= (last5 temp___1826) temp___1830)))
  (and
  (= (select (to_array2 temp___1826) (+ (+ (first1 source) 9) 0)) (of_rep1
                                                                  temp___1827))
  (= (select (to_array2 temp___1826) (+ (+ (first1 source) 9) 1)) (of_rep1
                                                                  temp___1828)))))))
...
;; def_axiom
  (assert
  (forall ((temp___1836 Int) (temp___1837 Int) (temp___1838 Int))
  (let ((temp___1835 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__aggregate_def
                     temp___1836 temp___1837 temp___1838)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 9) (+ (first1 source) 10)
  temp___1837 temp___1838)
  (and (= (first9 temp___1835) temp___1837)
  (= (last9 temp___1835) temp___1838)))
  (forall ((temp___1839 Int))
  (= (select (to_array4 temp___1835) temp___1839) (of_rep1 temp___1836)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_527 us_t3)
  ...
  (temp___do_toplevel_526 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 9)
                                      (+ (first1 source) 10)
                                      (first7 temp___expr_527)
                                      (last7 temp___expr_527))
                                      (and
                                      (= (first7 temp___expr_527) (+ 
                                      (first1 source) 9))
                                      (= (last7 temp___expr_527) (+ (first1
                                                                    source) 10))))))
...
(declare-fun temp___1833 () (Array Int integer))

(declare-fun temp___18331 () t2)
...
(declare-fun temp___1841 () (Array Int integer))

(declare-fun temp___18411 () t4)
...
(declare-fun temp___1847 () Int)

(declare-fun temp___1848 () Int)
...
;; H
  (assert
  (= (mk___t2 temp___1833 temp___18331) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__aggregate_def
                                        3 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___18331)) (to_rep1 (last4 temp___18331)))
     (+ (- (to_rep1 (last4 temp___18331)) (to_rep1 (first4 temp___18331))) 1)
...
;; H
  (assert
  (= (slide1 temp___1833 (to_rep1 (first4 temp___18331))
...
;; H
  (assert
  (= (mk___t4 temp___1841 temp___18411) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 9)
                                        (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first8 temp___18411)) (to_rep1 (last8 temp___18411)))
     (+ (- (to_rep1 (last8 temp___18411)) (to_rep1 (first8 temp___18411))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1
                                                        (first (rt source))) 10))
        (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1
                                                      (first (rt source))) 9)) 1)
...
;; H
  (assert
  (= (slide1 temp___1841 (to_rep1 (first8 temp___18411))
...
;; H
  (assert
  (and (= temp___1847 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (= temp___1848 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))
...
;; H
  ...
  (and
  (and
  (forall ((temp___1845 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___1845)
  (<= temp___1845 (to_rep1 n__last)))
  (=> (< index2 temp___1845)
  (= (select n3 temp___1845) (select n1 temp___1845)))))
  (=>
