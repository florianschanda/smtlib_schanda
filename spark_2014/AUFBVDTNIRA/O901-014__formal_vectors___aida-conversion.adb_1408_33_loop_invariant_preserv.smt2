...
(define-fun tint_arrayD1__ref_10__projection ((a tint_arrayD1__ref)) integer 
...
(define-fun tint_arrayT__ref_10__projection ((a tint_arrayT__ref)) us_t1 
...
(declare-datatypes ()
((t411b__ref (mk_t411b__ref (t411b__content integer)))))
(define-fun t411b__ref___projection ((a t411b__ref)) integer (t411b__content
                                                             a))
...
(define-fun tnumber_array_typeD1__ref_19__projection ((a tnumber_array_typeD1__ref)) integer 
...
(define-fun number_array_type__ref_19__projection ((a number_array_type__ref)) us_t3 
...
(declare-datatypes ()
((t415b__ref (mk_t415b__ref (t415b__content integer)))))
(define-fun t415b__ref___projection ((a t415b__ref)) integer (t415b__content
                                                             a))
...
(declare-datatypes ()
((t417b__ref (mk_t417b__ref (t417b__content integer)))))
(define-fun t417b__ref___projection ((a t417b__ref)) integer (t417b__content
                                                             a))
...
(define-fun tint_arrayB__ref_10__projection ((a tint_arrayB__ref)) us_t5 
  (tint_arrayB__content a))

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__aggregate_def (Int
  Int Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___2145 Int) (temp___2146 Int) (temp___2147 Int)
  (temp___2148 Int))
  (let ((temp___2144 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__aggregate_def
                     temp___2145 temp___2146 temp___2147 temp___2148)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 9) (+ (first1 source) 10)
  temp___2147 temp___2148)
  (and (= (first7 temp___2144) temp___2147)
  (= (last7 temp___2144) temp___2148)))
  (and
  (= (select (to_array2 temp___2144) (+ (+ (first1 source) 9) 0)) (of_rep1
                                                                  temp___2145))
  (= (select (to_array2 temp___2144) (+ (+ (first1 source) 9) 1)) (of_rep1
                                                                  temp___2146)))))))
...
(define-fun tnumber_array_typeB__ref_19__projection ((a tnumber_array_typeB__ref)) us_t6 
  (tnumber_array_typeB__content a))

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__aggregate_def (Int
  Int Int) us_t4)

;; def_axiom
  (assert
  (forall ((temp___2154 Int) (temp___2155 Int) (temp___2156 Int))
  (let ((temp___2153 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__aggregate_def
                     temp___2154 temp___2155 temp___2156)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 9) (+ (first1 source) 10)
  temp___2155 temp___2156)
  (and (= (first13 temp___2153) temp___2155)
  (= (last13 temp___2153) temp___2156)))
  (forall ((temp___2157 Int))
  (= (select (to_array4 temp___2153) temp___2157) (of_rep1 temp___2154)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_653 us_t3)
  ...
  (temp___do_toplevel_652 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 9)
                                      (+ (first1 source) 10)
                                      (first10 temp___expr_653)
                                      (last10 temp___expr_653))
                                      (and
                                      (= (first10 temp___expr_653) (+ 
                                      (first1 source) 9))
                                      (= (last10 temp___expr_653) (+ 
...
(declare-fun temp___2151 () (Array Int integer))

(declare-fun temp___21511 () t2)

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume1 () t1)

(declare-fun temp___2159 () (Array Int integer))

(declare-fun temp___21591 () t4)

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume1 () t3)

(declare-fun temp___2165 () Int)

(declare-fun temp___2166 () Int)
...
;; H
  ...
  (forall ((index4 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 9) index4)
...
;; H
  ...
  (= (to_rep1
     (first6
     (rt2
     (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__aggregate_def
     3 9 (+ (to_rep1 (first (rt source))) 9)
     (+ (+ (to_rep1 (first (rt source))) 9) 1))))) (+ (to_rep1
                                                      (first (rt source))) 9)))
...
;; H
  (assert
  (= (mk___t2 temp___2151 temp___21511) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__aggregate_def
                                        3 9
                                        (+ (to_rep1 (first (rt source))) 9)
                                        (+ (+ (to_rep1 (first (rt source))) 9) 1))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___21511)) (to_rep1 (last6 temp___21511)))
     (+ (- (to_rep1 (last6 temp___21511)) (to_rep1 (first6 temp___21511))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1
                                                        (first (rt source))) 10))
...
;; H
  (assert
  (= (slide1 temp___2151 (to_rep1 (first6 temp___21511))
     (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume))

;; H
  (assert
  (= (mk1 (+ (to_rep1 (first (rt source))) 9)
     (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume1))
...
;; H
  (assert
  (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume))

;; H
  (assert
  (= (to_rep1 int_array__first) (to_rep1
                                (first3
                                aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume1))))
...
;; H
  (assert
  (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 9)
  (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first)
  (to_rep1 int_array__last))
  (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 9))
...
;; H
  ...
  (= (to_rep1
     (first12
     (rt4
     (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__aggregate_def
     0 (+ (to_rep1 (first (rt source))) 9)
     (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1
                                                 (first (rt source))) 9)))
...
;; H
  (assert
  (= (mk___t4 temp___2159 temp___21591) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 9)
                                        (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___21591)) (to_rep1
                                               (last12 temp___21591)))
     (+ (- (to_rep1 (last12 temp___21591)) (to_rep1 (first12 temp___21591))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1
                                                        (first (rt source))) 10))
        (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1
                                                      (first (rt source))) 9)) 1)
...
;; H
  (assert
  (= (slide1 temp___2159 (to_rep1 (first12 temp___21591))
     (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume))

;; H
  (assert
  (= (mk3 (+ (to_rep1 (first (rt source))) 9)
     (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume1))
...
;; H
  (assert
  (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume))

;; H
  (assert
  (= (to_rep1 n__first) (to_rep1
                        (first9
                        aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume1))))
...
;; H
  (assert
  (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 9)
  (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last))
  (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 9))
  (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 10)))))

;; H
  (assert
  (and (= temp___2165 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (= temp___2166 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))
...
;; H
  (assert (= index1 temp___2165))

;; H
  (assert (<= temp___2165 index1))

;; H
  (assert (<= index1 temp___2166))
...
;; H
  (assert
  (forall ((i Int))
  (=> (and (<= (+ (to_rep1 (first (rt source))) 9) i) (<= i index2))
  (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9)))))

;; H
  (assert
  (forall ((j Int))
  (=> (and (<= (+ (to_rep1 (first (rt source))) 9) j) (<= j index2))
...
;; H
  ...
  (and
  (and
  (forall ((temp___2163 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___2163)
  (<= temp___2163 (to_rep1 n__last)))
  (=> (< index2 temp___2163)
  (= (select n3 temp___2163) (select n1 temp___2163)))))
  (=>
  (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10))
  (dynamic_property9 (+ (to_rep1 (first (rt source))) 9)
  (+ (to_rep1 (first (rt source))) 10) index2)))
  (and (<= (+ (to_rep1 (first (rt source))) 9) index2)
  (<= index2 (+ (to_rep1 (first (rt source))) 10)))))

;; H
  (assert (not (= index2 temp___2166)))
...
(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 1357, characters 0-0
