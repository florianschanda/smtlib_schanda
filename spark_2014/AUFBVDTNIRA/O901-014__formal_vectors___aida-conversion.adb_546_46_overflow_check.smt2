...
(define-fun tint_arrayD1__ref_7__projection ((a tint_arrayD1__ref)) integer 
...
(define-fun tint_arrayT__ref_7__projection ((a tint_arrayT__ref)) us_t1 
...
(define-fun tnumber_array_typeD1__ref_7__projection ((a tnumber_array_typeD1__ref)) integer 
...
(define-fun number_array_type__ref_7__projection ((a number_array_type__ref)) us_t3 
...
(define-fun tint_arrayB__ref_7__projection ((a tint_arrayB__ref)) us_t5 
...
;; def_axiom
  (assert
  (forall ((temp___1590 Int) (temp___1591 Int) (temp___1592 Int)
  (temp___1593 Int) (temp___1594 Int) (temp___1595 Int) (temp___1596 Int)
  (temp___1597 Int) (temp___1598 Int) (temp___1599 Int) (temp___1600 Int)
  (temp___1601 Int))
  (let ((temp___1589 (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__aggregate_def
                     temp___1590 temp___1591 temp___1592 temp___1593
                     temp___1594 temp___1595 temp___1596 temp___1597
                     temp___1598 temp___1599 temp___1600 temp___1601)))
  (and
  (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1600
  temp___1601)
  (and (= (first7 temp___1589) temp___1600)
  (= (last7 temp___1589) temp___1601)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___1589) (+ (first1 source) 0)) (of_rep1
                                                            temp___1590))
  (= (select (to_array2 temp___1589) (+ (first1 source) 1)) (of_rep1
                                                            temp___1591)))
  (= (select (to_array2 temp___1589) (+ (first1 source) 2)) (of_rep1
                                                            temp___1592)))
  (= (select (to_array2 temp___1589) (+ (first1 source) 3)) (of_rep1
                                                            temp___1593)))
  (= (select (to_array2 temp___1589) (+ (first1 source) 4)) (of_rep1
                                                            temp___1594)))
  (= (select (to_array2 temp___1589) (+ (first1 source) 5)) (of_rep1
                                                            temp___1595)))
  (= (select (to_array2 temp___1589) (+ (first1 source) 6)) (of_rep1
                                                            temp___1596)))
  (= (select (to_array2 temp___1589) (+ (first1 source) 7)) (of_rep1
                                                            temp___1597)))
  (= (select (to_array2 temp___1589) (+ (first1 source) 8)) (of_rep1
                                                            temp___1598)))
  (= (select (to_array2 temp___1589) (+ (first1 source) 9)) (of_rep1
                                                            temp___1599)))))))
...
(define-fun tnumber_array_typeB__ref_7__projection ((a tnumber_array_typeB__ref)) us_t6 
...
;; def_axiom
  (assert
  (forall ((temp___1607 Int) (temp___1608 Int) (temp___1609 Int))
  (let ((temp___1606 (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__aggregate_def
                     temp___1607 temp___1608 temp___1609)))
  (and
  (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1608
  temp___1609)
  (and (= (first13 temp___1606) temp___1608)
  (= (last13 temp___1606) temp___1609)))
  (forall ((temp___1610 Int))
  (= (select (to_array4 temp___1606) temp___1610) (of_rep1 temp___1607)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_296 us_t3)
  (temp___is_init_293 Bool) (temp___skip_constant_294 Bool)
  (temp___do_toplevel_295 Bool)) Bool (=>
                                      (not (= temp___skip_constant_294 true))
                                      (and (dynamic_property6 (first1 source)
                                      (+ (first1 source) 9)
                                      (first10 temp___expr_296)
                                      (last10 temp___expr_296))
                                      (and
                                      (= (first10 temp___expr_296) (first1
                                                                   source))
                                      (= (last10 temp___expr_296) (+ 
                                      (first1 source) 9))))))
...
(declare-fun temp___1604 () (Array Int integer))

(declare-fun temp___16041 () t2)

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__assume1 () t1)

(declare-fun temp___1612 () (Array Int integer))

(declare-fun temp___16121 () t4)

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__assume1 () t3)

(declare-fun temp___1619 () Int)

(declare-fun temp___1617 () Int)

(declare-fun temp___1615 () (Array Int integer))
...
;; H
  (assert
  (= (mk___t2 temp___1604 temp___16041) (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__aggregate_def
                                        2 1 4 6 9 9 9 9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___16041)) (to_rep1 (last6 temp___16041)))
     (+ (- (to_rep1 (last6 temp___16041)) (to_rep1 (first6 temp___16041))) 1)
...
;; H
  (assert
  (= (slide1 temp___1604 (to_rep1 (first6 temp___16041))
...
;; H
  (assert
  (= (mk___t4 temp___1612 temp___16121) (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__aggregate_def
                                        0 (to_rep1 (first (rt source)))
                                        (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___16121)) (to_rep1
                                               (last12 temp___16121)))
     (+ (- (to_rep1 (last12 temp___16121)) (to_rep1 (first12 temp___16121))) 1)
     0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1
                                                  (first (rt source))) 9))
        (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1
                                                  (first (rt source)))) 1)
...
;; H
  (assert
  (= (slide1 temp___1612 (to_rep1 (first12 temp___16121))
...
;; H
  (assert
  (and (= temp___1619 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1619))
  (= temp___1617 index1)))
...
;; H
  ...
  (and
  (and
  (forall ((temp___1616 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___1616)
  (<= temp___1616 (to_rep1 n__last)))
  (=> (< index2 temp___1616)
  (= (select n3 temp___1616) (select temp___1615 temp___1616)))))
...
;; H
  (assert
  (and (= temp___1620 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1620)
  (<= temp___1620 (to_rep1 n__last))))

;; H
  (assert (= o9 temp___1620))
...
;; H
  (assert
  (and (= temp___1621 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1621)
  (<= temp___1621 (to_rep1 n__last))))

;; H
  (assert (= o12 temp___1621))
...
;; H
  (assert
  (and (= temp___1622 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1622)
  (<= temp___1622 (to_rep1 n__last))))

;; H
  (assert (= o19 temp___1622))
...
;; H
  (assert
  (and (= temp___1623 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1623)
  (<= temp___1623 (to_rep1 n__last))))

;; H
  (assert (= o26 temp___1623))
...
;; H
  (assert
  (and (= temp___1624 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1624)
  (<= temp___1624 (to_rep1 n__last))))

;; H
  (assert (= o33 temp___1624))
