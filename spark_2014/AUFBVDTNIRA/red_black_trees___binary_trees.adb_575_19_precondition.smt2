...
;; H
  (assert (= o53 (select temp___1234 o52)))
...
;; H
  (assert (= o49 (select temp___1233 ki1)))
...
;; H
  (assert (= o46 (select temp___1232 ki1)))
...
;; H
  (assert (= o41 (select temp___1229 o40)))
...
;; H
  (assert (= o37 (select temp___1226 o36)))
