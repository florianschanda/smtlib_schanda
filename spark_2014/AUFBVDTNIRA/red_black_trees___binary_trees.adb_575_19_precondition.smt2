...
;; H
  (assert (= o53 (select temp___1893 o52)))
...
;; H
  (assert (= o49 (select temp___1892 ki1)))
...
;; H
  (assert (= o46 (select temp___1891 ki1)))
...
;; H
  (assert (= o41 (select temp___1888 o40)))
...
;; H
  (assert (= o37 (select temp___1885 o36)))
