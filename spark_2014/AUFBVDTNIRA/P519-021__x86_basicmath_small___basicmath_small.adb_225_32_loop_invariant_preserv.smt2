...
;; readmem32__post_axiom
  ...
  (! (=> (dynamic_invariant addr true true true)
     ...
     (dynamic_invariant1 result true false true))))) :pattern ((readmem32
                                                               addr
                                                               x86__memory)) ))))
...
;; H
  ...
  (writereg32post rbx ((_ int2bv 32) 0)) rbx ((_ int2bv 32) 0)))
...
;; H
  (assert (writereg32post__function_guard
  (writereg32post rdi2 ((_ int2bv 32) 4198688)) rdi2
  ((_ int2bv 32) 4198688)))

;; H
  (assert (writereg32post__function_guard (writereg32post rax1 o4) rax1 
  o4))

;; H
  (assert (writereg32post__function_guard
  (writereg32post rdi3 ((_ int2bv 32) 10)) rdi3 ((_ int2bv 32) 10)))
...
;; H
  (assert
  (= rsi1 (bvsub (bvadd rsp1 ((_ int2bv 64) 152)) ((_ int2bv 64) 88))))
...
;; H
  (assert
  (= rdi1 (bvsub (bvadd rsp1 ((_ int2bv 64) 152)) ((_ int2bv 64) 108))))

;; H
  (assert (= (writereg32post rbx ((_ int2bv 32) 0)) true))

;; H
  (assert
  (and
  (and (= o (readmem64 rsp1 memory1)) (readmem64__function_guard o rsp1
  memory1))
  (and
  (and
  (and
...
;; H
  (assert
  (= rbp1 (bvsub (bvadd rsp1 ((_ int2bv 64) 152)) ((_ int2bv 64) 88))))
...
;; H
  ...
  (= o1 (readmem64
        ...
        memory1))
  (readmem64__function_guard o1
  (bvsub (bvadd rsp1 ((_ int2bv 64) 152)) ((_ int2bv 64) 144)) memory1))
  (and
  (and
  (and
  (and
...
;; H
  (assert (= result4 (mk_t__ref2 xmm2)))
...
;; H
  ...
  (bvsub (bvadd rsp1 ((_ int2bv 64) 152)) ((_ int2bv 64) 136)) memory1))
  (and
  (and
  (and
  (and
...
;; H
  (assert (= result5 (mk_t__ref2 xmm1)))
...
;; H
  ...
  (= o3 (readmem64
        ...
        memory1))
  (readmem64__function_guard o3
  (bvsub (bvadd rsp1 ((_ int2bv 64) 152)) ((_ int2bv 64) 128)) memory1))
  (and
  (and
  (and
  (and
...
;; H
  (assert (= result6 (mk_t__ref2 xmm0)))
...
;; H
  (assert (= (writereg32post rdi2 ((_ int2bv 32) 4198688)) true))
...
;; H
  ...
  (= o4 (readmem32
        ...
        memory1))
  (readmem32__function_guard o4
  (bvsub (bvadd rsp5 ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) memory1))
  (and
  (and
  (and
...
;; H
  (assert (= (writereg32post rax1 o4) true))

;; H
  (assert
  (and (and (= o5 (eax rax1)) (eax__function_guard o5 rax1))
  (= o5 ((_ extract 31 0) (bvand rax1 ((_ int2bv 64) 4294967295))))))

;; H
  (assert (= o6 (ite (= o5 ((_ int2bv 32) 0)) true false)))

;; H
  (assert (= result9 (mk_bool__ref zeroflag)))
...
;; H
  (assert
  (and (and (= o7 (eax rax1)) (eax__function_guard o7 rax1))
  (= o7 ((_ extract 31 0) (bvand rax1 ((_ int2bv 64) 4294967295))))))

;; H
  (assert (= o8 (ite (bvugt o7 ((_ int2bv 32) 2147483647)) true false)))

;; H
  (assert (= result10 (mk_bool__ref signflag)))

;; H
  (assert (= signflag1 o8))

;; H
  (assert (= result11 (mk_bool__ref carryflag)))

;; H
  (assert (= carryflag1 (of_int 0)))

;; H
  (assert (= result12 (mk_bool__ref overflowflag)))
...
;; H
  (assert (= (writereg32post rdi3 ((_ int2bv 32) 10)) true))
...
;; H
  (assert
  (and
  (and (= o9 (readmem64 rsp8 memory1)) (readmem64__function_guard o9 
  rsp8 memory1))
  (and
  (and
  (and
...
;; H
  (assert (= result14 (mk_t__ref2 xmm4)))

;; H
  (assert (= xmm41 o9))

;; H
  (assert (= result15 (mk_t__ref2 r12)))

;; H
  (assert (= r121 (bvsub r12 ((_ int2bv 64) 1))))

;; H
  (assert (= result16 (mk_bool__ref zeroflag2)))

;; H
  (assert (= zeroflag3 (ite (= r121 ((_ int2bv 64) 0)) true false)))

;; H
  (assert
  (and
  (and (= o10 (readmem64 ((_ int2bv 64) 4198768) memory1))
  (readmem64__function_guard o10 ((_ int2bv 64) 4198768) memory1))
  (and
  (and
  (and
  (and
...
;; H
  (assert (= o11 (bvsub xmm41 o10)))

;; H
  (assert (= result17 (mk_t__ref2 xmm41)))
...
;; H
  ...
  (and
  (and
  (= (bvand xmm42 ((_ int2bv 64) 255)) ((_ zero_extend 56) (to_rep
                                                           (select memory2 
                                                           rsp8))))
  (= (bvand xmm42 ((_ int2bv 64) 65280)) (bvmul ((_ zero_extend 56) (to_rep
                                                                    (select 
                                                                    memory2 (bvadd 
                                                                    rsp8 ((_ int2bv 64) 1))))) ((_ int2bv 64) 256))))
  (= (bvand xmm42 ((_ int2bv 64) 16711680)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory2 (bvadd rsp8 ((_ int2bv 64) 2))))) ((_ int2bv 64) 65536))))
  (= (bvand xmm42 ((_ int2bv 64) 4278190080)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory2 (bvadd rsp8 ((_ int2bv 64) 3))))) ((_ int2bv 64) 16777216))))
  (= (bvand xmm42 ((_ int2bv 64) 1095216660480)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory2 (bvadd rsp8 ((_ int2bv 64) 4))))) ((_ int2bv 64) 4294967296))))
  (= (bvand xmm42 ((_ int2bv 64) 280375465082880)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory2 (bvadd rsp8 ((_ int2bv 64) 5))))) ((_ int2bv 64) 1099511627776))))
  (= (bvand xmm42 ((_ int2bv 64) 71776119061217280)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory2 (bvadd rsp8 ((_ int2bv 64) 6))))) ((_ int2bv 64) 281474976710656))))
  (= (bvand xmm42 ((_ int2bv 64) 18374686479671623680)) (bvmul ((_ zero_extend 56) 
...
;; H
  (assert (not (= i (bvadd rsp8 ((_ int2bv 64) 1)))))

;; H
  (assert (not (= i (bvadd rsp8 ((_ int2bv 64) 2)))))

;; H
  (assert (not (= i (bvadd rsp8 ((_ int2bv 64) 3)))))

;; H
  (assert (not (= i (bvadd rsp8 ((_ int2bv 64) 4)))))

;; H
  (assert (not (= i (bvadd rsp8 ((_ int2bv 64) 5)))))

;; H
  (assert (not (= i (bvadd rsp8 ((_ int2bv 64) 6)))))

;; H
  (assert (not (= i (bvadd rsp8 ((_ int2bv 64) 7)))))
