...
;; H
  ...
  (=> (= result3 true)
  (and
  (and (= o9 (get model____split_fields 1)) (get__function_guard o9
  model____split_fields 1)) (in_range7 o9)))))
...
;; H
  ...
  (and
  (and (= o11 (length model____split_fields)) (length__function_guard 
  o11 model____split_fields)) (in_range6 o11))))
...
;; H
  ...
  (and
  (and (= o7 (length model____split_fields1)) (length__function_guard 
  o7 model____split_fields1)) (in_range6 o7)))))
...
;; H
  ...
  (=> (= result4 true)
  (and
  (and (= o6 (get model____split_fields1 1)) (get__function_guard o6
  model____split_fields1 1)) (in_range7 o6))))))
...
;; H
  ...
  (and
  (and (= o8 (length model____split_fields1)) (length__function_guard 
  o8 model____split_fields1)) (in_range6 o8)))))
...
;; H
  ...
  (=> (= result1 true)
  (and
  (and (= o4 (length model____split_fields)) (length__function_guard 
  o4 model____split_fields)) (in_range6 o4))))
...
;; H
  (assert
  (and
  (and (= o3 (get model____split_fields1 j)) (get__function_guard o3
  model____split_fields1 j)) (in_range7 o3)))
...
;; H
  (assert
  (and
  (and (= o2 (length model____split_fields1)) (length__function_guard 
  o2 model____split_fields1)) (in_range6 o2)))
