...
;; H
  (assert
  (and
  (and (= o9 (to__ (mk___rep s__split_fields10))) (to____function_guard 
  o9 (mk___rep s__split_fields10))) (dynamic_invariant1 o9 true false true)))
...
;; H
  (assert
  (=> (= result4 true) (= temp___484 (mk___t2 o7 (mk2 first2 temp___482)))))
...
;; H
  (assert
  (=> (= result4 true) (= temp___483 (mk___t1 o8 (mk1 first2 temp___481)))))
