...
(declare-fun temp___440 () (Array Int integer))
...
(declare-fun a_v14 () map__ref)

(declare-fun i_v13 () int__ref)

(declare-fun a_v15 () (Array Int integer))

(declare-fun i_v14 () Int)

(declare-fun a_v16 () map__ref)

(declare-fun i_v15 () int__ref)
...
;; H
  (assert
  (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last)))
  (= temp___440 a_v1)))
...
;; H
  ...
  (forall ((m1 Int))
  (=> (and (<= (to_rep a_v1__first) m1) (<= m1 k_1))
  (= (to_rep (select a_v12 m1)) (to_rep (select (elts b_v1) m1)))))
  (forall ((m1 Int))
  (=> (and (<= (+ k_1 1) m1) (<= m1 (- i_v12 1)))
  (= (to_rep (select a_v12 m1)) (to_rep (select (elts c_v1) (- m1 k_1)))))))))
...
;; H
  ...
  (=> (<= i_v12 temp___441)
  (= (select a_v12 temp___441) (select temp___440 temp___441))))))
  (and (<= (+ k_1 1) i_v12) (<= i_v12 (to_rep a_v1__last))))))

;; H
  (assert
  (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last)))
  (and (= temp___437 (- i_v12 k_1)) (in_range1 (- i_v12 k_1)))))
...
;; H
  (assert
  (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last)))
  (= i_v12 (to_rep a_v1__last))))

;; H
  (assert
  (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last)))
  (= i_v13 (mk_int__ref i_v12))))

;; H
  (assert
  (=> (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last)))
  (= a_v14 (mk_map__ref a_v13))))
...
;; H
  (assert
  (=> (not (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))))
  (= i_v15 (mk_int__ref i_v11))))

;; H
  (assert
  (=> (not (and (<= temp___443 i_v11) (<= i_v11 (to_rep a_v1__last))))
  (= a_v16 (mk_map__ref a_v1))))
...
;; H
  ...
  (forall ((m1 Int))
  (=> (and (<= (to_rep a_v1__first) m1) (<= m1 k_1))
  (= (to_rep (select (map__content a_v16) m1)) (to_rep
                                               (select (elts b_v1) m1)))))))
