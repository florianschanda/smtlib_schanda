...
;; H
  (assert (= o29 (select temp___1474 ki1)))
...
;; H
  (assert (=> (= result6 true) (= o25 (select temp___1475 ki1))))
...
;; H
  (assert
  (=> (= result6 true)
  (and (= o28 (length o27)) (and (in_range5 o28) (<= (+ 0 o28) 2147483647)))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  ...
  (= (valid_root
     (mk___rep2
     (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o24) true)))
(check-sat)
