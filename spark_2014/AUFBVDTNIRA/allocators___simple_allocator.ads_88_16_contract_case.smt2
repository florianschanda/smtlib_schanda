...
;; H
  ...
  res
  (rec__simple_allocator__m__t__available (us_split_fields1 (model__ data3))))
  (rec__simple_allocator__m__t__available (us_split_fields1 (model__ data)))
  res
  (rec__simple_allocator__m__t__available (us_split_fields1 (model__ data3)))))
...
;; H
  (assert (is_add__function_guard
  (is_add
  (rec__simple_allocator__m__t__allocated (us_split_fields1 (model__ data3)))
  res
  (rec__simple_allocator__m__t__allocated (us_split_fields1 (model__ data))))
  (rec__simple_allocator__m__t__allocated (us_split_fields1 (model__ data3)))
  res
  (rec__simple_allocator__m__t__allocated (us_split_fields1 (model__ data)))))
...
;; H
  (assert (oeq__function_guard (oeq (model__ data3) (model__ data))
