...
;; H
  (assert (=> (and (<= 2 i1) (<= i1 15)) (= temp___1153 i1)))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (- i2 1)))
  (= (make_mask j) (bvsub (ite (< j 65536)
                          (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) j))
                          ((_ int2bv 16) 0)) ((_ int2bv 16) 1)))))))

;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 15))
  (and (=> (<= 2 15) (in_range2 i2)) (and (<= 2 i2) (<= i2 15)))))
...
;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 15)) (= (mk_int__ref i5) (mk_int__ref i3))))
...
;; H
  (assert (make_mask__function_guard (make_mask size) size))
...
;; WP_parameter_def
 ;; File "bits_manipulation-functions.ads", line 302, characters 0-0
  (not
  (= (make_mask size) (bvsub (ite (< size 65536)
                             (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) 
                             size)) ((_ int2bv 16) 0)) ((_ int2bv 16) 1)))))
(check-sat)
