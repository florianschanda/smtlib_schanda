...
(declare-fun total_pay1 () Int)

(declare-fun outstanding1 () Int)

(declare-fun result () Bool)

(declare-fun result1 () Int)

(declare-fun total_pay2 () Int)
...
(declare-fun outstanding2 () Int)

(declare-fun cur_state3 () Int)

(declare-fun total_pay3 () Int)

(declare-fun outstanding3 () Int)

(declare-fun cur_state4 () Int)

(declare-fun total_pay4 () Int)

(declare-fun outstanding4 () Int)
...
;; H
  (assert
  (=> (= result true)
  (and (= o (+ total_pay outstanding)) (in_range (+ total_pay outstanding)))))

;; H
  (assert
  (=> (= result true) (= (mk_int__ref result1) (mk_int__ref total_pay))))
...
;; H
  (assert
  (=> (= result true) (= (mk_int__ref result2) (mk_int__ref cur_state))))
...
;; H
  (assert
  (=> (= result true) (= (mk_int__ref result3) (mk_int__ref outstanding))))
...
;; H
  (assert (is_base__function_guard (is_base cur_state3) cur_state3))

(assert
;; WP_parameter_def
 ;; File "pumpunit.ads", line 36, characters 0-0
  (not (= (is_base cur_state3) true)))
(check-sat)
