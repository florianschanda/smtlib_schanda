...
(declare-datatypes ()
((tT46bP1__ref (mk_tT46bP1__ref (tT46bP1__content integer)))))
(define-fun tT46bP1__ref___projection ((a tT46bP1__ref)) integer (tT46bP1__content
                                                                 a))
...
(declare-datatypes () ((t46b__ref (mk_t46b__ref (t46b__content us_t2)))))
(define-fun t46b__ref___projection ((a t46b__ref)) us_t2 (t46b__content a))
...
(declare-datatypes () ((s43b__ref (mk_s43b__ref (s43b__content us_rep3)))))
(define-fun s43b__ref___projection ((a s43b__ref)) us_rep3 (s43b__content a))
...
;; H
  (assert
  (= (to_rep (rec__static_discr__holder__c current__split_discrs)) r45b))

;; H
  (assert (in_range2 r45b))

;; H
  (assert (and (= us r45b) (in_range2 r45b)))

;; H
  (assert (and (= us1 r44b) (in_range2 r44b)))
...
;; H
  ...
  (<= (to_rep
      (rec__static_discr__holder__length
      (us_split_fields__content2 current__split_fields6))) (int__content
                                                           result__3)))
