...
;; H
  (assert
  (and (= o49 (from_word32 carry22)) (from_word32__function_guard o49
  carry22)))
...
;; H
  (assert
  (and (= o47 (from_word32 carry12)) (from_word32__function_guard o47
  carry12)))

;; H
  (assert (and (= o51 (oadd o47 o50)) (oadd__function_guard o51 o47 o50)))
...
;; H
  (assert
  (and (and (= o41 (base Tuple0)) (base__function_guard o41 Tuple0))
  (= o41 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o46 (oexpon o41 o45)) (oexpon__function_guard o46 o41 o45)))

;; H
  (assert
  (and (= o52 (omultiply o46 o51)) (omultiply__function_guard o52 o46 o51)))
...
;; H
  ...
  (= o40 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))
         a_first o39))
  (num_of_big_int__function_guard o40
  (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o39)))

;; H
  (assert (and (= o53 (oadd o40 o52)) (oadd__function_guard o53 o40 o52)))
...
;; H
  (assert
  (and (= o34 (from_word32 carry2)) (from_word32__function_guard o34 carry2)))
...
;; H
  (assert
  (and (= o35 (omultiply o33 o34)) (omultiply__function_guard o35 o33 o34)))

;; H
  (assert
  (and (= o32 (from_word32 carry1)) (from_word32__function_guard o32 carry1)))

;; H
  (assert (and (= o30 (from_word32 y)) (from_word32__function_guard o30 y)))
...
;; H
  (assert
  (and (= o29 (num_of_big_int c c_first o28)) (num_of_big_int__function_guard
  o29 c c_first o28)))

;; H
  (assert
  (and (= o31 (omultiply o29 o30)) (omultiply__function_guard o31 o29 o30)))

;; H
  (assert (and (= o23 (from_word32 x)) (from_word32__function_guard o23 x)))
...
;; H
  (assert
  (and (= o22 (num_of_big_int b b_first o21)) (num_of_big_int__function_guard
  o22 b b_first o21)))

;; H
  (assert
  (and (= o24 (omultiply o22 o23)) (omultiply__function_guard o24 o22 o23)))
