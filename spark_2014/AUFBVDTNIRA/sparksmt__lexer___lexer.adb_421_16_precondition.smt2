...
;; H
  (assert (= o7 (concat1 (temp___String_Literal_754 Tuple0) 1 19 o1 1 1)))

;; H
  (assert (= temp___757 (mk___t o7 (mk 1 o6))))

;; H
  (assert
  (=> (= (length temp___757) 0)
  (= o14 (mk___t (temp___String_Literal_756 Tuple0) (mk 1 1)))))

;; H
  (assert
  (=> (not (= (length temp___757) 0)) (=> (<= 1 1) (= o8 (+ (- 1 1) 1)))))

;; H
  (assert (=> (not (= (length temp___757) 0)) (=> (not (<= 1 1)) (= o8 0))))

;; H
  (assert
  (=> (not (= (length temp___757) 0))
  (=> (<= (to_rep1 (first (rt temp___757))) (to_rep1 (last (rt temp___757))))
  (= o9 (+ (- (to_rep1 (last (rt temp___757))) (to_rep1
                                               (first (rt temp___757)))) 1)))))
...
;; H
  (assert (=> (not (= (length temp___757) 0)) (= o10 (+ o9 o8))))

;; H
  (assert
  (=> (not (= (length temp___757) 0))
  (= o11 (+ (to_rep1 (first (rt temp___757))) o10))))

;; H
  (assert (=> (not (= (length temp___757) 0)) (= o12 (- o11 1))))

;; H
  (assert
  (=> (not (= (length temp___757) 0)) (and (= o13 o12) (in_range2 o12))))

;; H
  (assert
  (=> (not (= (length temp___757) 0))
  (= o14 (mk___t
         (concat1 (elts temp___757) (to_rep1 (first (rt temp___757)))
         (to_rep1 (last (rt temp___757))) (temp___String_Literal_756 Tuple0)
         1 1) (mk (to_rep1 (first (rt temp___757))) o13)))))
