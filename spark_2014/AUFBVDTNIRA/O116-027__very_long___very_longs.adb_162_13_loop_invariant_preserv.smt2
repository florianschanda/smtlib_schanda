...
;; H
  (assert
  (and (= temp___831 (+ string_index2 1)) (in_range1 (+ string_index2 1))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt number))) temp___831)
  (<= temp___831 (to_rep1 (last (rt number))))))

;; H
  (assert (= o9 temp___831))
...
;; H
  (assert (= temp___834 (mk___rep result____split_discrs o17)))

;; H
  (assert (= result4 (mk___split_fields__ref result____split_fields3)))

;; H
  (assert (= result____split_fields4 (us_split_fields1 temp___834)))

;; H
  (assert (= result____split_discrs (us_split_discrs1 temp___834)))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 84, characters 0-0
  (not
  (= (div1 (+ (- (to_rep1 (last (rt number))) string_index3) 1) 2) (+ (- 
  index3 1) 1))))
(check-sat)
