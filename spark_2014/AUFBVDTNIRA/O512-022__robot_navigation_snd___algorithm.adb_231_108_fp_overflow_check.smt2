...
;; H
  (assert
  (and (and (= o5 (cos1 o4)) (cos__function_guard o5 o4))
  (and (tqtisFinite o5)
  (and (and (le (neg fliteral) o5) (le o5 fliteral))
  (=> (eq o4 fliteral2) (eq o5 fliteral))))))

;; H
  (assert
  (and
  (= o2 (mul RNE2 fliteral4
