...
;; H
  (assert (= (bool_eq2 a1 1 10 (temp___4365 t i e) 1 10) true))
...
;; WP_parameter_def
 ;; File "ar.ads", line 62, characters 0-0
  ...
  (or
  (and (< 0 e)
  (= (bool_eq2 a3 1 10 (temp___641 a i e (+ i 1) (- e 1)) 1 10) true))
  (and (= e 0)
  (= (bool_eq2 a3 1 10 (temp___650 a i e (+ i 1) 99) 1 10) true))))
  (and (= i 10)
  (or
  (and (< 0 e) (= (bool_eq2 a3 1 10 (temp___659 a i e 1 (- e 1)) 1 10) true))
  (and (= e 0) (= (bool_eq2 a3 1 10 (temp___668 a i e 1 99) 1 10) true)))))))
(check-sat)
