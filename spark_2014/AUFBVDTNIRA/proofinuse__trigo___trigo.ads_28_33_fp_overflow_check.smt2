...
;; H
  (assert (= o7 (mul RNE2 fliteral2 o6)))

;; H
  (assert (and (= o8 o7) (tqtisFinite o7)))

;; H
  (assert (= o9 (div1 RNE2 o8 fliteral3)))
...
;; H
  (assert (= o3 (mul RNE2 fliteral4 o2)))

;; H
  (assert (and (= o4 o3) (tqtisFinite o3)))

;; H
  (assert (= o5 (div1 RNE2 o4 fliteral5)))
...
;; H
  (assert (= o1 (mul RNE2 fliteral6 o)))
