...
;; H
  (assert (get_model__2__function_guard
  (get_model__2 (mk___rep s__split_fields6 s__attr__tag))
  (mk___rep s__split_fields6 s__attr__tag)))
...
;; H
  (assert
  (= (bool_eq2
     (let ((temp___613 (temp___239 e2)))
     (let ((temp___612 (get_model__2
                       (mk___rep s__split_fields6 s__attr__tag))))
     (ite (= (length temp___612) 0) temp___613
     (concat1 (elts temp___612) (to_rep1 (first (rt temp___612)))
     (to_rep1 (last (rt temp___612))) temp___613 1 1))))
     (to_rep1
     (first
     (let ((temp___612 (get_model__2
                       (mk___rep s__split_fields6 s__attr__tag))))
     (ite (= (length temp___612) 0) (mk 1 1)
     (mk (to_rep1 (first (rt temp___612)))
     (- (+ (to_rep1 (first (rt temp___612))) (+ (ite (<= (to_rep1
                                                         (first
                                                         (rt temp___612))) 
                                                (to_rep1
                                                (last (rt temp___612))))
...
;; WP_parameter_def
 ;; File "stackp.adb", line 8, characters 0-0
  (not
  (= (bool_eq2
     (let ((temp___608 (temp___603 e2)))
     (let ((temp___607 (get_model__2
                       (mk___rep s__split_fields6 s__attr__tag))))
     (ite (= (length temp___607) 0) temp___608
     (concat1 (elts temp___607) (to_rep1 (first (rt temp___607)))
     (to_rep1 (last (rt temp___607))) temp___608 1 1))))
     (to_rep1
     (first
     (let ((temp___607 (get_model__2
                       (mk___rep s__split_fields6 s__attr__tag))))
     (ite (= (length temp___607) 0) (mk 1 1)
     (mk (to_rep1 (first (rt temp___607)))
     (- (+ (to_rep1 (first (rt temp___607))) (+ (ite (<= (to_rep1
                                                         (first
                                                         (rt temp___607))) 
                                                (to_rep1
                                                (last (rt temp___607))))
