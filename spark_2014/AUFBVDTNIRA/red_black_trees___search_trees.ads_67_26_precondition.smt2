...
(declare-fun o29 () us_rep2)

(declare-fun o30 () us_rep2)
...
;; H
  ...
  (= (contains o30 (to_rep (select t__split_fields3 i16))) true))))
  (forall ((v1 Int))
  (=> (and (<= 0 v1) (<= v1 2147483647))
  (=> (= (contains o30 v1) true)
  (exists ((i16 Int))
  (and (and (<= 1 i16) (<= i16 100))
  (and
  (= (rec__tree_model__path_type__k
...
;; H
  ...
  (and
  (and
  (= o29 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (values__function_guard1 o29
  (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (ite (= (size
          (rec__search_trees__search_tree__struct
...
;; H
  (assert
  (=> (= (int__content i14) 0)
  (and (= result20 (oeq1 o29 o30))
  (= (= result20 true) (and (= (ole o29 o30) true) (= (ole o30 o29) true))))))
...
;; H
  (assert (size__function_guard1
  (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))
  (mk___rep3 (us_split_fields__content3 t__split_fields14))))
