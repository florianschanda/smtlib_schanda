...
(declare-fun temp___1760 () (Array Int us_rep1))
...
;; H
  (assert (= (mk___rep (mk___split_fields o6 o7)) (select temp___1759 i)))
...
;; H
  ...
  (= temp___1760 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___1760 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1760 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1760 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1760 (parent
                              (mk___rep2
                              (mk___split_fields2 f_old__split_fields
                              f_old__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1760 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1760 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1760 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1760 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1760 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1760 j)))) true))
  (= j i1)))))))))))))))
...
;; H
  (assert
  (=> (= result2 true)
  (= (mk___rep (mk___split_fields o o1)) (select temp___1760 i))))
