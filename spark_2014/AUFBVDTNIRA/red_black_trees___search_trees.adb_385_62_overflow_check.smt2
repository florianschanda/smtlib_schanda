...
(declare-fun temp___2919 () (Array Int us_rep1))
...
(declare-fun temp___2920 () (Array Int us_rep1))
...
(declare-fun temp___2918 () (Array Int us_rep1))

(declare-fun o7 () us_rep1)

(declare-fun o8 () us_split_fields)

(declare-fun temp___2917 () (Array Int us_rep1))
...
(declare-fun temp___2916 () (Array Int us_rep1))
...
;; H
  ...
  (< (to_rep (select values j1)) (to_rep (select values i3))))))
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 100))
  (=>
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ f_old v) j1))) true)
  (< (to_rep (select values i3)) (to_rep (select values j1))))))))))
  (and
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=>
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2917 (parent f i3)))) (position f i3)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2917 i3))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2917 (parent f i3)))) (position f i3)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2917 i3))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2918 (parent f i3)))) (position f i3)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2918 i3))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2918 (parent f i3)))) (position f i3)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2918 i3))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2920 (parent f i3)))) (position f i3)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2920 i3))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2920 (parent f i3)))) (position f i3)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2920 i3))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2919 (parent f i3)))) (position f i3)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2919 i3))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2919 (parent f i3)))) (position f i3)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2919 i3))))))
...
;; H
  (assert
  (and
  (and (= temp___2917 (model__ f root)) (model____function_guard temp___2917
  f root))
  (and (dynamic_invariant5 temp___2917 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2917 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2917 root)))) 0)
  (and
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=> (not (= i3 root))
  (ite (and (not (= (parent f i3) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2917 (parent f i3)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2917 i3))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2917 i3))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2917 i3)))) 0))))
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2917 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2917 i3)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2917 j1)))) true))
  (= j1 i3))))))))))))))
...
;; H
  (assert (= o10 (select temp___2917 o9)))
...
;; H
  ...
  (=> (= result3 true)
  (and
  (and (= temp___2918 (model__ f root)) (model____function_guard temp___2918
  f root))
  (and (dynamic_invariant5 temp___2918 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2918 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2918 root)))) 0)
  (and
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=> (not (= i3 root))
  (ite (and (not (= (parent f i3) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2918 (parent f i3)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2918 i3))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2918 i3))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2918 i3)))) 0))))
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2918 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2918 i3)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2918 j1)))) true))
  (= j1 i3)))))))))))))))

;; H
  (assert (=> (= result3 true) (= o7 (select temp___2918 j))))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (and (= temp___2920 (model__ f root)) (model____function_guard temp___2920
  f root))
  (and (dynamic_invariant5 temp___2920 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2920 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2920 root)))) 0)
  (and
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=> (not (= i3 root))
  (ite (and (not (= (parent f i3) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2920 (parent f i3)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2920 i3))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2920 i3))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2920 i3)))) 0))))
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2920 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2920 i3)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2920 j1)))) true))
  (= j1 i3)))))))))))))))

;; H
  (assert (=> (= result2 true) (= o4 (select temp___2920 j))))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (and (= temp___2919 (model__ f root)) (model____function_guard temp___2919
  f root))
  (and (dynamic_invariant5 temp___2919 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2919 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2919 root)))) 0)
  (and
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=> (not (= i3 root))
  (ite (and (not (= (parent f i3) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2919 (parent f i3)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2919 i3))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2919 i3))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2919 i3)))) 0))))
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2919 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2919 i3)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2919 j1)))) true))
  (= j1 i3)))))))))))))))
...
;; H
  (assert (=> (= result2 true) (= o1 (select temp___2919 o))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2916 (parent f i3)))) (position f i3)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2916 i3))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2916 (parent f i3)))) (position f i3)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2916 i3))))))
...
;; H
  (assert
  (and
  (and (= temp___2916 (model__ f root)) (model____function_guard temp___2916
  f root))
  (and (dynamic_invariant5 temp___2916 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2916 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2916 root)))) 0)
  (and
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=> (not (= i3 root))
  (ite (and (not (= (parent f i3) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2916 (parent f i3)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2916 i3))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2916 i3))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2916 i3)))) 0))))
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2916 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2916 i3)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2916 j1)))) true))
  (= j1 i3))))))))))))))
...
;; H
  (assert (= o13 (select temp___2916 o12)))
