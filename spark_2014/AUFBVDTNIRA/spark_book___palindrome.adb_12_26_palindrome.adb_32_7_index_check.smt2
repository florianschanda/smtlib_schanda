...
(declare-fun temp___535 () (Array Int character))

(declare-fun temp___5351 () t3)
...
;; H
  (assert (= o10 left_index2))

;; H
  (assert (= o11 (select temp___537 o10)))
...
;; H
  (assert (= o8 temp___535))

;; H
  (assert (= (mk3 1 r5b) temp___5351))

(assert
;; WP_parameter_def
 ;; File "palindrome.adb", line 2, characters 0-0
  (not (<= (to_rep1 (first6 temp___5351)) right_index2)))
(check-sat)
