...
;; H
  ...
  (and (dynamic_property2 first2 last2 o14)
  (= o14 (last6
         (model__
         (mk___rep v__split_discrs (mk___split_fields v__split_fields8))))))))

;; H
  (assert (= o15 (ite (<= j2 o14) true false)))

;; H
  (assert (and (= o13 (+ i 7)) (in_range1 (+ i 7))))

;; H
  (assert (= o16 (ite (<= o13 j2) true false)))
...
;; H
  (assert (and (= o9 (+ i 7)) (in_range1 (+ i 7))))

;; H
  (assert (= o10 (- o9 1)))

;; H
  (assert (= o11 (ite (<= j1 o10) true false)))

;; H
  (assert (= result1 (ite (<= i j1) o11 false)))
...
;; WP_parameter_def
 ;; File "a-cofuve.ads", line 75, characters 0-0
  (not (dynamic_property4 first3 last4 j)))
(check-sat)
