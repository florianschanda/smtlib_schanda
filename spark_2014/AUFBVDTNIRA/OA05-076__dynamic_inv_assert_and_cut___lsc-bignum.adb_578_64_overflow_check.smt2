...
;; H
  (assert
  (and (= o22 (from_word64 i2)) (from_word64__function_guard o22 i2)))

;; H
  (assert (and (= o24 (oadd o22 o23)) (oadd__function_guard o24 o22 o23)))

;; H
  (assert
  (and (= o21 (from_integer j3)) (from_integer__function_guard o21 j3)))

;; H
  (assert (and (= o25 (ole o21 o24)) (ole__function_guard o25 o21 o24)))
...
;; H
  (assert
  (and (= o17 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o17 ((_ int2bv 32) 2))))

;; H
  (assert (and (= o18 (oexpon o17 j3)) (oexpon__function_guard o18 o17 j3)))

;; H
  (assert
  (and (= o13 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o13 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o12 (from_integer j3)) (from_integer__function_guard o12 j3)))

;; H
  (assert
  (and (= o14 (osubtract o12 o13)) (osubtract__function_guard o14 o12 o13)))
...
;; H
  (assert
  (and (= o15 (osubtract o11 o14)) (osubtract__function_guard o15 o11 o14)))
...
;; H
  (assert
  (and (= o16 (oexpon__2 o10 o15)) (oexpon__2__function_guard o16 o10 o15)))
