...
(declare-fun temp___156 () (Array Int natural))
...
;; H
  (assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___156 a2)))

;; H
  (assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___155 i1)))
...
;; H
  ...
  (=> (and (<= 0 temp___157) (<= temp___157 30))
  (=> (< i2 temp___157)
  (= (select a4 temp___157) (select temp___156 temp___157))))))
  (and (<= 2 i2) (<= i2 30)))))
...
;; WP_parameter_def
 ;; File "array_applications.adb", line 10, characters 0-0
  (not (= (to_rep (select a9 30)) 832040)))
(check-sat)
