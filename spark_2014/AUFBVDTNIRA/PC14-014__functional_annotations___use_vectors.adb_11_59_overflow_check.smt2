...
(define-fun v2__split_fields2 () us_split_fields (mk___split_fields
                                                 v2__split_fields1))
...
;; H
  ...
  (get (model__ (mk___rep v2__split_discrs v2__split_fields2)) n))
  (get (model__ v1) n)
  (get (model__ (mk___rep v2__split_discrs v2__split_fields2)) n))))

;; H
  (assert
  (= (length (mk___rep v2__split_discrs v2__split_fields2)) (- i2 first)))
...
;; H
  ...
  (=>
  (and (<= first n)
  (<= n (last4 (model__ (mk___rep v2__split_discrs v2__split_fields2)))))
  (= (is_incr (get (model__ v1) n)
     (get (model__ (mk___rep v2__split_discrs v2__split_fields2)) n)) true))))
