...
(declare-fun students3__student_record__birth_date__first__bit () Int)

(declare-fun students3__student_record__birth_date__last__bit () Int)

(declare-fun students3__student_record__birth_date__position () Int)
...
(declare-fun students3__student_record__id__first__bit () Int)

(declare-fun students3__student_record__id__last__bit () Int)

(declare-fun students3__student_record__id__position () Int)
...
(declare-fun students3__student_record__gender__first__bit () Int)

(declare-fun students3__student_record__gender__last__bit () Int)

(declare-fun students3__student_record__gender__position () Int)
...
(declare-fun students3__student_record__gpa__first__bit () Int)

(declare-fun students3__student_record__gpa__last__bit () Int)

(declare-fun students3__student_record__gpa__position () Int)
...
(declare-fun students3__student_record__part_time__first__bit () Int)

(declare-fun students3__student_record__part_time__last__bit () Int)

(declare-fun students3__student_record__part_time__position () Int)
...
(declare-fun students3__student_record__in_state__first__bit () Int)

(declare-fun students3__student_record__in_state__last__bit () Int)

(declare-fun students3__student_record__in_state__position () Int)
...
(declare-fun students3__student_record__resident__first__bit () Int)

(declare-fun students3__student_record__resident__last__bit () Int)

(declare-fun students3__student_record__resident__position () Int)
...
(declare-fun students3__student_record__meal_plan__first__bit () Int)

(declare-fun students3__student_record__meal_plan__last__bit () Int)

(declare-fun students3__student_record__meal_plan__position () Int)
...
(declare-fun students3__student_record__self_insured__first__bit () Int)

(declare-fun students3__student_record__self_insured__last__bit () Int)

(declare-fun students3__student_record__self_insured__position () Int)
...
;; H
  (assert
  (=>
  (= (rec__students3__student_record__part_time (us_split_fields3 student)) true)
  (= (to_fixed2 o2) 10000)))
...
;; H
  ...
  (=>
  (= (rec__students3__student_record__part_time (us_split_fields3 student)) true)
  (= (mk_money_type__ref result2) fees3)))
...
;; H
  ...
  (not
  (= (rec__students3__student_record__part_time (us_split_fields3 student)) true))
  (= (mk_money_type__ref result3) fees3)))
...
;; H
  (assert
  (not
  (= (rec__students3__student_record__resident (us_split_fields3 student)) true)))

;; H
  (assert
  (not
  (= (to_rep1
     (rec__students3__student_record__meal_plan (us_split_fields3 student))) 0)))

;; H
  (assert
  (not
  (= (to_rep1
     (rec__students3__student_record__meal_plan (us_split_fields3 student))) 1)))

;; H
  (assert
  (not
  (= (to_rep1
     (rec__students3__student_record__meal_plan (us_split_fields3 student))) 2)))
