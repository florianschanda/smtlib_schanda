...
(define-fun dynamic_invariant ((temp___expr_7392 us_t1)
  ...
  (temp___do_toplevel_7391 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_7392))
                                       (and (= (first3 temp___expr_7392) 1)
                                       (= (last4 temp___expr_7392) 1)))))
...
(define-fun dynamic_invariant1 ((temp___expr_7408 us_t2)
  ...
  (temp___do_toplevel_7407 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_7408))
                                       (and (= (first5 temp___expr_7408) 1)
                                       (= (last6 temp___expr_7408) 1)))))
...
;; H
  (assert
  (and
  (and (= temp___80842 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___80842 reg)) (dynamic_invariant1
  temp___80842 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80841)) (to_rep (last5 temp___80841)))
     (+ (- (to_rep (last5 temp___80841)) (to_rep (first4 temp___80841))) 1)
     0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80841)) (to_rep (last5 temp___80841))) 
  temp___80851))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___80851)) (to_rep (last3 temp___80851)))
     (+ (- (to_rep (last3 temp___80851)) (to_rep (first2 temp___80851))) 1)
