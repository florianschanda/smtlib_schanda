...
(declare-fun temp___206 (Int) (Array Int element_t))

;; def_axiom
  (assert
  (forall ((temp___208 Int))
  (forall ((temp___209 Int))
  (= (select (temp___206 temp___208) temp___209) (of_rep1 temp___208)))))
...
(define-fun dynamic_invariant3 ((temp___expr_148 Int)
  ...
  (temp___do_toplevel_147 Bool)) Bool (=>
                                      ...
                                      (<= 1 10)) (in_range1 temp___expr_148)))
...
;; H
  (assert (= temp___210 s__split_fields2))

;; H
  (assert (= temp___2101 s__split_fields3))
