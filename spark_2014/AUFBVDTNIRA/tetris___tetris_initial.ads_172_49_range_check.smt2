...
;; WP_parameter_def
 ;; File "tetris_initial.ads", line 65, characters 0-0
  (not (in_range1
  (+ (to_rep1 (rec__tetris_initial__piece__y (us_split_fields1 p))) 1))))
(check-sat)
