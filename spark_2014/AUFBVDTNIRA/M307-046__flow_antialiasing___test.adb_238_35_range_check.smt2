...
(declare-datatypes () ((t62b__ref (mk_t62b__ref (t62b__content us_t1)))))
(define-fun t62b__ref___projection ((a t62b__ref)) us_t1 (t62b__content a))
...
(declare-datatypes () ((t64b__ref (mk_t64b__ref (t64b__content us_t2)))))
(define-fun t64b__ref___projection ((a t64b__ref)) us_t2 (t64b__content a))
...
;; H
  (assert
  (=> (<= n n) (and (<= (to_rep1 a__first) n) (<= n (to_rep1 a__last)))))
...
;; H
  (assert (= test__op_string_io_i__x__compl1 (mk1 n n)))
...
(assert
;; WP_parameter_def
 ;; File "test.adb", line 226, characters 0-0
  (not (<= (to_rep1 a__first) m)))
(check-sat)
