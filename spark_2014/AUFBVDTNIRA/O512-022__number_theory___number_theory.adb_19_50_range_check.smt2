...
;; Power_0
  (assert
  (forall ((x t)) (=> (tqtisFinite x) (eq (power x 0) (of_int1 RNE1 1)))))
...
;; Power_neg1
  ...
  (forall ((x t))
  (=> (tqtisFinite x)
  (=> (not (is_zero x)) (eq (power x (- 1)) (div1 RNE1 (of_int1 RNE1 1) x))))))
...
;; Power_neg2
  ...
  (div1 RNE1 (of_int1 RNE1 1) (power x 2)))))))
...
;; Power_neg3
  ...
  (=> (tqtisFinite x)
  (=> (not (is_zero x)) (eq (power x (- 2))
  (div1 RNE1 (of_int1 RNE1 1) (power x 3)))))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral1) (/ 161810004711151123046875.0 100000000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral2) (/ 22360000610351562500000.0 10000000000000000000000.0))))
...
;; H
  ...
  (lt (of_int1 RNE1 o1)
  (add RNE1 (div1 RNE1 (power fliteral1 o) fliteral2) fliteral))))))
