...
(declare-fun search_trees__contains__result2 () Bool)

(declare-fun temp___12931 () Int)

(declare-fun result3 () int__ref)

(declare-fun temp___12932 () Int)
...
(declare-fun search_trees__contains__result3 () Bool)
...
(declare-fun search_trees__contains__result4 () bool__ref)
...
(declare-fun search_trees__contains__result5 () Bool)
...
(declare-fun search_trees__contains__result6 () bool__ref)
...
(declare-fun search_trees__contains__result7 () Bool)
...
;; H
  (assert (=> (not (= current1 0)) (= temp___1258 d1)))

;; H
  (assert (=> (not (= current1 0)) (= temp___1257 previous1)))

;; H
  (assert (=> (not (= current1 0)) (= temp___1256 current1)))

;; H
  (assert (=> (not (= current1 0)) (= 0 temp___1293)))
...
;; H
  (assert (=> (not (= current1 0)) (= result3 (mk_int__ref temp___12931))))
...
;; H
  (assert
  (=> (not (= current1 0))
  (=> (= result6 true) (and (= o6 current2) (in_range3 current2)))))
...
;; H
  (assert
  (=> (not (= current1 0))
  (=> (= result6 true) (= result8 (mk_int__ref current2)))))
...
;; H
  (assert
  (=> (not (= current1 0))
  (=> (not (= result6 true)) (= result9 (mk_int__ref d2)))))
...
;; H
  (assert
  (=> (not (= current1 0))
  (=> (not (= result6 true)) (= result10 (mk_int__ref current2)))))

;; H
  (assert
  (=> (not (= current1 0)) (=> (not (= result6 true)) (= current4 o9))))
...
;; H
  (assert
  (=> (not (= current1 0)) (=> (not (= result6 true)) (= current3 current4))))

;; H
  (assert
  (=> (not (= current1 0))
  (= search_trees__contains__result3 search_trees__contains__result2)))
...
;; H
  (assert
  (=> (not (= current1 0))
  (= search_trees__contains__result4 (mk_bool__ref
                                     search_trees__contains__result3))))
...
;; H
  (assert
  (=> (not (= current1 0))
  (= search_trees__contains__result5 search_trees__contains__result3)))
...
;; H
  (assert
  (=> (not (= current1 0))
  (= search_trees__contains__result6 search_trees__contains__result4)))
...
;; H
  (assert
  (=> (not (= current1 0))
  (= search_trees__contains__result7 search_trees__contains__result5)))
...
;; H
  (assert
  (=> (not (not (= current1 0)))
  (= search_trees__contains__result6 (mk_bool__ref
                                     search_trees__contains__result))))
...
;; H
  (assert
  (=> (not (not (= current1 0))) (= current7 (mk_int__ref current1))))

;; H
  (assert
  (=> (not (not (= current1 0)))
  (= search_trees__contains__result7 search_trees__contains__result1)))
