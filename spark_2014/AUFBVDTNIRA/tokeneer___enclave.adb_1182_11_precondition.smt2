...
(define-fun dynamic_invariant2 ((temp___expr_1092 Int)
...
;; current_latch__post_axiom
  ...
  (! (let ((result (current_latch latch__state)))
     ...
     (dynamic_invariant2 result true false true))) :pattern ((current_latch
                                                             latch__state)) )))
...
(define-fun dynamic_invariant3 ((temp___expr_1107 Int)
...
;; thecurrentdoor__post_axiom
  ...
  (! (let ((result (thecurrentdoor door__state)))
     ...
     (dynamic_invariant3 result true false true))) :pattern ((thecurrentdoor
                                                             door__state)) )))
...
(define-fun dynamic_invariant4 ((temp___expr_336 Int)
  ...
  (temp___do_toplevel_335 Bool)) Bool (=>
                                      ...
                                      (<= 0 1)) (in_range15 temp___expr_336)))
...
(define-fun dynamic_invariant5 ((temp___expr_1903 Int)
...
(define-fun dynamic_invariant13 ((temp___expr_396 Int)
...
(define-fun dynamic_invariant14 ((temp___expr_402 Int)
  ...
  (temp___do_toplevel_401 Bool)) Bool (=>
                                      ...
                                      (<= 1 12)) (in_range9 temp___expr_402)))
...
(define-fun dynamic_invariant16 ((temp___expr_432 Int)
...
(declare-fun o4 () monthst)

(declare-fun o5 () dayst)

(declare-fun o6 () millisecst)

(declare-fun o7 () yearst)

(declare-fun o8 () monthst)

(declare-fun o9 () dayst)

(declare-fun o10 () millisecst)
...
(define-fun o34 () us_rep1 (mk___rep1 (mk___split_fields1 o7 o8 o9 o10)))

(define-fun o35 () us_rep1 (mk___rep1 (mk___split_fields1 o3 o4 o5 o6)))
...
;; H
  ...
  (rolepresent__function_guard o26
  (mk___rep
  (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (in_range4 o26)))

;; H
  (assert (= result (ite (= o26 1) true false)))
...
;; H
  (assert (=> (= result true) (= o31 (ite (not (= o30 true)) true false))))
...
;; H
  ...
  (= o27 (thecurrentop
         (mk___rep
         (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (thecurrentop__function_guard o27
  (mk___rep
  (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (in_range6 o27))))

;; H
  (assert (=> (= result true) (= o28 (ite (= o27 3) true false))))
...
;; H
  ...
  (= o29 (isdoingop
         (mk___rep
         (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (isdoingop__function_guard o29
  (mk___rep
  (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))

;; H
  (assert (=> (= result true) (= o32 (ite (= o29 true) o28 false))))

;; H
  (assert (=> (= result true) (= o33 (ite (= o32 false) o31 true))))

;; H
  (assert (=> (not (= result true)) (= o33 (of_int 1))))
...
;; H
  ...
  (= o19 (rolepresent
         (mk___rep
         (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (rolepresent__function_guard o19
  (mk___rep
  (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (in_range4 o19)))

;; H
  (assert (= result1 (ite (= o19 1) true false)))

;; H
  (assert
  (=> (= result1 true)
  (and
  (and (= o22 (theauthcertrole state)) (theauthcertrole__function_guard 
  o22 state)) (in_range4 o22))))

;; H
  (assert (=> (= result1 true) (= o23 (ite (= o22 1) true false))))

;; H
  (assert
  (=> (= result1 true)
  (and (= o20 (authcertvalid state)) (authcertvalid__function_guard o20
  state))))

;; H
  (assert
  (=> (= result1 true)
  (and (= o21 (isgood state)) (isgood__function_guard o21 state))))

;; H
  (assert (=> (= result1 true) (= o24 (ite (= o21 true) o20 false))))

;; H
  (assert (=> (= result1 true) (= o25 (ite (= o24 true) o23 false))))

;; H
  (assert (=> (not (= result1 true)) (= o25 (of_int 1))))

;; H
  (assert
  (and
  (and (= o14 (thedooralarm state2)) (thedooralarm__function_guard o14
  state2)) (in_range15 o14)))

;; H
  (assert (= o15 (ite (= o14 0) true false)))

;; H
  (assert (= o16 (to_int1 o15)))

;; H
  (assert
  (and (= o34 (alarm_timeout state2)) (alarm_timeout__function_guard 
  o34 state2)))

;; H
  (assert
  (and (= o35 (thecurrenttime currenttime)) (thecurrenttime__function_guard
  o35 currenttime)))

;; H
  (assert
  (and (= o11 (greaterthanorequal o35 o34))
  (greaterthanorequal__function_guard o11 o35 o34)))

;; H
  (assert
  (and
  (and (= o (thecurrentdoor state2)) (thecurrentdoor__function_guard 
  o state2)) (in_range14 o)))
...
;; H
  (assert
  (and (= o2 (islocked state1)) (islocked__function_guard o2 state1)))

;; H
  (assert (= o12 (ite (= o2 true) o1 false)))

;; H
  (assert (= o13 (ite (= o12 true) o11 false)))

;; H
  (assert (= o17 (to_int1 o13)))

;; H
  (assert (= o18 (ite (= o17 o16) true false)))
