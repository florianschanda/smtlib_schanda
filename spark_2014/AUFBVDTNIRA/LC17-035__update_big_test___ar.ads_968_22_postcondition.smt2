...
(declare-fun temp___6993 () us_rep2)
...
;; H
  ...
  (= (rec__ar__rec1t__g1
     (us_split_fields1
     (rec__ar__rec2t__g2
     (us_split_fields3 (rec__ar__rec3t__f3 r__split_fields5))))) o2))
...
;; H
  (assert
  (= (rec__ar__rec2t__f2
     (us_split_fields3 (rec__ar__rec3t__f3 r__split_fields5))) o5))
...
;; H
  (assert
  (= (rec__ar__rec2t__h2
     (us_split_fields3 (rec__ar__rec3t__f3 r__split_fields5))) o8))
...
;; H
  (assert (= r__split_fields6 (us_split_fields5 temp___6993)))
...
;; WP_parameter_def
 ;; File "ar.ads", line 961, characters 0-0
  (not
  (= (bool_eq7 (mk___rep2 (us_split_fields__content2 r__split_fields7))
     (mk___rep2
     (mk___split_fields2
     (mk___rep1
     (let ((usq_ (us_split_fields3 a)))
     (mk___split_fields1 (rec__ar__rec2t__f2 usq_)
     (mk___rep
     (mk___split_fields (of_rep e)
     (rec__ar__rec1t__g1
     (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 a))))))
     (rec__ar__rec2t__h2 usq_)))) r__split_fields4))) true)))
(check-sat)
