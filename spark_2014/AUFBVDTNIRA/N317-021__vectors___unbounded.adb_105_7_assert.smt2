...
(declare-fun unbounded__vect__replace_element__container__fields1 () us_split_fields)
...
;; H
  (assert
  (= v__split_fields12 unbounded__vect__append__2__container__fields4))
...
;; WP_parameter_def
 ;; File "a-cofove.ads", line 807, characters 0-0
  ...
  (= (length
     (mk___rep v__split_discrs
     unbounded__vect__replace_element__container__fields1)) (length
                                                            (mk___rep
                                                            v__split_discrs
                                                            v__split_fields10)))
  (= (get
     (model__
     (mk___rep v__split_discrs
     unbounded__vect__replace_element__container__fields1)) 1) o2))
  (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields10))
     (model__
     (mk___rep v__split_discrs
     unbounded__vect__replace_element__container__fields1)) 1) true)))
  (and (= result11 (mk___split_fields__ref v__split_fields10))
  (= v__split_fields11 unbounded__vect__replace_element__container__fields1))))))
(check-sat)
