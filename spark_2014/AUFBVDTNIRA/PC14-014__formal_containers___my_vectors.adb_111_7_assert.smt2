...
;; H
  (assert (= (is_sorted (mk___rep l__split_discrs l__split_fields7)) true))
...
;; WP_parameter_def
 ;; File "a-cofove.ads", line 855, characters 0-0
  ...
  (and (= result13 (mk___split_fields__ref l__split_fields7))
  (= l__split_fields8 my_vectors__v__clear__container__fields))))))
(check-sat)
