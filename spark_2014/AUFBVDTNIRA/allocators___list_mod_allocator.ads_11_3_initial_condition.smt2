...
;; H
  ...
  (model_is_well_formed o20 (map__content data6) first_available1) o20
...
;; H
  ...
  (is_well_formed (map__content data6) first_available1) (map__content data6)
  first_available1))
...
;; H
  ...
  (contains
  (rec__list_mod_allocator__m__t__available
  (us_split_fields3 (model__ (map__content data6) first_available1))) r7)
  (rec__list_mod_allocator__m__t__available
  (us_split_fields3 (model__ (map__content data6) first_available1))) r7)))
...
;; H
  ...
  (model____function_guard o20 (map__content data6) first_available1))
...
;; H
  ...
  (is_valid__function_guard o18 (map__content data6) first_available1))
  (= (= o18 true)
  (and
...
;; H
  ...
  (all_available__function_guard o19 (map__content data6)))
  (= (= o19 true)
  (forall ((r7 Int))
  (=> (and (<= 1 r7) (<= r7 10000))
  (= (to_rep1
