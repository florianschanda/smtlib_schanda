...
;; H
  ...
  (= o5 (+ (- (to_rep first_block__last) (to_rep first_block__first)) 1))))
...
;; H
  ...
  (= o6 (+ (- (to_rep next_block__last) (to_rep next_block__first)) 1))))
...
;; H
  (assert
  (=> (<= (to_rep first_block__first) (to_rep first_block__last))
  (= o3 (+ (- (to_rep first_block__last) (to_rep first_block__first)) 1))))
