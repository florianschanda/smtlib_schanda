...
;; H
  (assert
  (and (= o (sqrt2 fliteral4))
  (and (tqtisFinite o)
  (and (le fliteral2 o)
  (and (=> (eq fliteral4 fliteral2) (eq o fliteral2))
  (and (=> (eq fliteral4 fliteral) (eq o fliteral))
  (=> (le fliteral3 fliteral4) (lt fliteral2 o))))))))

;; H
  (assert (= o1 (to_int1 RNA1 o)))
...
;; H
  (assert
  (=> (= result4 true)
  (and (= o3 (* 2 index_12)) (in_range2 (* 2 index_12)))))

;; H
  (assert (=> (= result4 true) (= index_31 result6)))

;; H
  (assert (=> (= result4 true) (= index_32 o3)))

;; H
  (assert
  (=> (= result4 true) (=> (<= index_32 100000) (= temp___255 is_prime5))))

;; H
  (assert
  (=> (= result4 true) (=> (<= index_32 100000) (= temp___254 index_32))))
...
;; H
  (assert (=> (= result4 true) (=> (<= index_32 100000) (= o4 index_32))))

;; H
  (assert
  (=> (= result4 true)
  (=> (<= index_32 100000) (= o5 (store is_prime5 o4 (of_int1 0))))))
...
;; H
  (assert (=> (= result4 true) (=> (<= index_32 100000) (= is_prime6 o5))))
...
;; H
  (assert (=> (= result4 true) (=> (<= index_32 100000) (= index_34 o6))))
