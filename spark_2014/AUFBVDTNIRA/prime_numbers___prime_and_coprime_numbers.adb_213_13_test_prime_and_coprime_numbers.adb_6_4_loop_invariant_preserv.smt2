...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral4) (= (tqtreal fliteral4) 100000.0)))
...
(declare-fun is_prime14 () map__ref)

(declare-fun index_15 () int__ref)

(declare-fun index_311 () int__ref)

(declare-fun index_24 () int__ref)
...
;; H
  (assert
  (and (= o1 (sqrt2 fliteral4))
  (and (tqtisFinite o1)
  (and (le fliteral2 o1)
  (and (=> (eq fliteral4 fliteral2) (eq o1 fliteral2))
  (and (=> (eq fliteral4 fliteral) (eq o1 fliteral))
  (=> (le fliteral3 fliteral4) (lt fliteral2 o1))))))))

;; H
  (assert (= o2 (to_int1 RNA2 o1)))
...
;; H
  ...
  (forall ((div3 Int))
  (=> (and (<= 2 div3) (<= div3 (- index_22 1))) (not (= (mod2 v div3) 0))))))))
...
;; H
  (assert (= result4 (select is_prime5 o3)))
...
;; H
  (assert
  (=> (= result4 true)
  (and (= o4 (* 2 index_12)) (in_range2 (* 2 index_12)))))

;; H
  (assert (=> (= result4 true) (= index_31 result6)))

;; H
  (assert (=> (= result4 true) (= index_32 o4)))

;; H
  (assert
  (=> (= result4 true) (=> (<= index_32 100000) (= temp___311 is_prime5))))

;; H
  (assert
  (=> (= result4 true) (=> (<= index_32 100000) (= temp___310 index_32))))
...
;; H
  (assert (=> (= result4 true) (=> (<= index_32 100000) (= o5 index_32))))

;; H
  (assert
  (=> (= result4 true)
  (=> (<= index_32 100000) (= o6 (store is_prime5 o5 (of_int1 0))))))
...
;; H
  (assert (=> (= result4 true) (=> (<= index_32 100000) (= is_prime6 o6))))
...
;; H
  (assert
  (=> (= result4 true)
  (=> (<= index_32 100000) (= (mod2 index_33 index_22) 0))))

;; H
  (assert
  (=> (= result4 true)
  (=> (<= index_32 100000)
  (=> (<= (- 2147483648) 2147483647) (in_range2 index_33)))))

;; H
  (assert
  (=> (= result4 true)
  (=> (<= index_32 100000)
  (and (= o7 (+ index_33 index_12)) (in_range2 (+ index_33 index_12))))))
...
;; H
  (assert (=> (= result4 true) (=> (<= index_32 100000) (= index_34 o7))))
...
;; H
  (assert (<= v (int__content index_24)))

;; H
  (assert (= (select (map__content is_prime14) v) true))

;; H
  (assert (is_prime__function_guard (is_prime v) v))
