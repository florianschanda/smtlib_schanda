...
(declare-fun real_val () t)

(declare-fun kind () Int)

(declare-fun int_val1 () Int)

(declare-fun real_val1 () t)
...
;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite real_val)))
...
;; H
  (assert
  (and (and (in_range1 int_val1) (tqtisFinite real_val1)) (in_range4 kind1)))
