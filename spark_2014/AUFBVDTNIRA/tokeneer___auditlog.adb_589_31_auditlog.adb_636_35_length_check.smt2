...
(declare-fun dummy15 () elementtexti)
...
(declare-fun noelement () (Array Int character))
...
(declare-fun now__split_fields () yearst)

(declare-fun now__split_fields1 () monthst)

(declare-fun now__split_fields2 () dayst)

(declare-fun now__split_fields3 () millisecst)
...
(declare-fun now__split_fields4 () yearst)

(declare-fun now__split_fields5 () monthst)

(declare-fun now__split_fields6 () dayst)

(declare-fun now__split_fields7 () millisecst)

(declare-fun thefile () us_rep1)

(declare-fun ok () Bool)

(declare-fun thefile1 () us_rep1)
