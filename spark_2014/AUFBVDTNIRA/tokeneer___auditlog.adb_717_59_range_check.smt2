...
(define-fun bool_eq5 ((a (Array Int fileentrycountt)) (a__first Int)
...
(define-fun bool_eq8 ((a (Array Int logfileindext)) (a__first Int)
...
(declare-fun bool_eq10 (us_rep1 us_rep1) Bool)
...
(define-fun bool_eq11 ((a (Array Int us_rep1)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq10 (select a temp___idx_149)
...
;; WP_parameter_def
 ;; File "auditlog.adb", line 553, characters 0-0
  (not (in_range9 (- (to_rep2 usedlogfiles__split_fields) 1))))
(check-sat)
