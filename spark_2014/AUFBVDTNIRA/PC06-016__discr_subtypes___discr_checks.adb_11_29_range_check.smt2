...
(declare-fun discr_checks__check_derived_rec__R2b__assume () Int)

;; H
  (assert
  (and
  (and (= discr_checks__check_derived_rec__R2b__assume (bad Tuple0))
  (bad__function_guard discr_checks__check_derived_rec__R2b__assume Tuple0))
  (and (in_range discr_checks__check_derived_rec__R2b__assume)
  (= discr_checks__check_derived_rec__R2b__assume 6))))

;; H
  (assert (= discr_checks__check_derived_rec__R2b__assume r2b))
...
(assert
;; WP_parameter_def
 ;; File "discr_checks.adb", line 4, characters 0-0
  (not (in_range1 r2b)))
(check-sat)
