...
(declare-fun dummy1 () scrabble_letter)
...
;; inversion_axiom
  (assert
  (forall ((x scrabble_letter))
  (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)) )))

;; range_axiom
  (assert
  (forall ((x scrabble_letter)) (! (in_range2
...
(declare-fun dummy2 () scrabble_value)
...
;; range_axiom
  (assert
  (forall ((x scrabble_value)) (! (in_range3
...
(declare-datatypes ()
((map__ref (mk_map__ref (map__content (Array Int scrabble_letter))))))
(declare-fun slide ((Array Int scrabble_letter) Int
  Int) (Array Int scrabble_letter))

;; slide_eq
  (assert
  (forall ((a (Array Int scrabble_letter)))
  (forall ((first Int))
...
(declare-fun concat1 ((Array Int scrabble_letter) Int Int
  (Array Int scrabble_letter) Int Int) (Array Int scrabble_letter))

;; concat_def
  (assert
  (forall ((a (Array Int scrabble_letter)) (b (Array Int scrabble_letter)))
...
(define-fun bool_eq3 ((a (Array Int scrabble_letter)) (a__first Int)
  (a__last Int) (b (Array Int scrabble_letter)) (b__first Int)
...
(declare-fun compare ((Array Int scrabble_letter) Int Int
  (Array Int scrabble_letter) Int Int) Int)
...
(declare-datatypes ()
((us_t (mk___t (elts (Array Int scrabble_letter))(rt t)))))
(define-fun to_array ((a us_t)) (Array Int scrabble_letter) (elts a))

(define-fun of_array ((a (Array Int scrabble_letter)) (f Int)
...
;; object__alignment_axiom
  (assert
  (forall ((a (Array Int scrabble_letter))) (<= 0 (object__alignment a))))
...
(declare-fun dummy5 () scrabble_score)
...
(declare-fun word () us_t)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-datatypes ()
((map__ref1 (mk_map__ref1 (map__content1 (Array Int scrabble_value))))))
(declare-fun slide1 ((Array Int scrabble_value) Int
...
(define-fun bool_eq7 ((a (Array Int scrabble_value)) (a__first Int)
...
(declare-fun compare1 ((Array Int scrabble_value) Int Int
...
(define-fun dynamic_invariant2 ((temp___expr_193 (Array Int scrabble_value))
...
;; def_axiom
  ...
  (and
  (and
  (and (= (select temp___134 65) (of_rep1 temp___135))
  (= (select temp___134 66) (of_rep1 temp___136)))
  (= (select temp___134 67) (of_rep1 temp___137)))
  (= (select temp___134 68) (of_rep1 temp___138)))
  (= (select temp___134 69) (of_rep1 temp___139)))
  (= (select temp___134 70) (of_rep1 temp___140)))
  (= (select temp___134 71) (of_rep1 temp___141)))
  (= (select temp___134 72) (of_rep1 temp___142)))
  (= (select temp___134 73) (of_rep1 temp___143)))
  (= (select temp___134 74) (of_rep1 temp___144)))
  (= (select temp___134 75) (of_rep1 temp___145)))
  (= (select temp___134 76) (of_rep1 temp___146)))
  (= (select temp___134 77) (of_rep1 temp___147)))
  (= (select temp___134 78) (of_rep1 temp___148)))
  (= (select temp___134 79) (of_rep1 temp___149)))
  (= (select temp___134 80) (of_rep1 temp___150)))
  (= (select temp___134 81) (of_rep1 temp___151)))
  (= (select temp___134 82) (of_rep1 temp___152)))
  (= (select temp___134 83) (of_rep1 temp___153)))
  (= (select temp___134 84) (of_rep1 temp___154)))
  (= (select temp___134 85) (of_rep1 temp___155)))
  (= (select temp___134 86) (of_rep1 temp___156)))
  (= (select temp___134 87) (of_rep1 temp___157)))
  (= (select temp___134 88) (of_rep1 temp___158)))
  (= (select temp___134 89) (of_rep1 temp___159)))
  (= (select temp___134 90) (of_rep1 temp___160))))))
...
;; H
  (assert
  (= (scrabble__lookup_table__aggregate_def 1 3 3 2 1 4 2 4 1 8 5 1 3 1 1 3
     10 1 1 1 1 4 4 8 4 10) lookup_table))
...
;; H
  (assert
  (<= total_score2 (* 10 (- letter_index2 (to_rep2 (first (rt word)))))))

;; H
  (assert
  (and
  (and
  (=> (<= (to_rep2 (first (rt word))) (to_rep2 (last (rt word))))
  (dynamic_property1 (to_rep2 (first (rt word))) (to_rep2 (last (rt word)))
  letter_index2)) (=> (<= 0 100) (in_range5 total_score2)))
  (and (<= (to_rep2 (first (rt word))) letter_index2)
  (<= letter_index2 (to_rep2 (last (rt word)))))))

;; H
  (assert
  (and
  (= o (+ total_score2 (to_rep1
                       (select lookup_table (to_rep
                                            (select (elts word) letter_index2))))))
  (in_range1
  (+ total_score2 (to_rep1
                  (select lookup_table (to_rep
                                       (select (elts word) letter_index2))))))))
...
;; H
  (assert (= result2 total_score2))

;; H
  (assert (= total_score3 o1))

;; H
  (assert (not (= letter_index2 (to_rep2 (last (rt word))))))

;; H
  (assert (= result3 letter_index2))

;; H
  (assert (= letter_index3 (+ letter_index2 1)))

(assert
;; WP_parameter_def
 ;; File "scrabble.ads", line 11, characters 0-0
  (not
  (<= total_score3 (* 10 (- letter_index3 (to_rep2 (first (rt word))))))))
(check-sat)
