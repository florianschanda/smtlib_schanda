...
(define-fun r__split_fields1 () us_split_fields (mk___split_fields
                                                r__split_fields))
...
;; H
  (assert
  (and (= (length (mk___rep r__split_discrs r__split_fields1)) 0)
  (= (is_empty (model__ (mk___rep r__split_discrs r__split_fields1))) true)))

;; H
  (assert
  (and (= result1 (has_key (positions s) (mk___rep1 cu__split_fields2)))
  (= (= result1 true)
  (= (has_key (positions s) (mk___rep1 cu__split_fields2)) true))))
...
;; H
  (assert
  (= (contains (model__ (mk___rep r__split_discrs r__split_fields1)) g) true))
