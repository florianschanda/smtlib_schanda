...
;; H
  (assert (equal_subrange__function_guard
  (equal_subrange a
  (to_rep
  (rec__types__option__value
  (us_split_fields1 (option__content search_ter_p__search__result21)))) 
  b) a
  (to_rep
  (rec__types__option__value
  (us_split_fields1 (option__content search_ter_p__search__result21)))) 
...
;; H
  (assert (has_sub_range_in_prefix__function_guard
  (has_sub_range_in_prefix a
  (- (to_rep
     (rec__types__option__value
     (us_split_fields1 (option__content search_ter_p__search__result21)))) 1)
  b) a
  (- (to_rep
     (rec__types__option__value
     (us_split_fields1 (option__content search_ter_p__search__result21)))) 1)
...
;; H
  ...
  (= (equal_subrange a
     ...
     b) true))
  (=>
  (< (to_rep (first (rt a))) (to_rep
                             (rec__types__option__value
                             (us_split_fields1
                             (option__content search_ter_p__search__result21)))))
  (not
  (= (has_sub_range_in_prefix a
     (- (to_rep
        (rec__types__option__value
...
;; H
  (assert
  (not
  (= (ite (= (ite (= (= (length b) 0) false) (< (length a) (length b)) true) false) 
     (ite (= (>= (length a) (length b)) true) (has_sub_range a b) false) true) true)))
