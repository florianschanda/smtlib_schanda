...
(define-fun c__split_fields2 () us_split_fields2 (mk___split_fields1
                                                 c__split_fields1))
...
;; H
  ...
  (= (bool_eq2 lists__search__c__assume1 no_element) true)
...
;; H
  (assert
  (and (= result1 (has_key (positions l) (mk___rep1 c__split_fields2)))
  (= (= result1 true)
  (= (has_key (positions l) (mk___rep1 c__split_fields2)) true))))
