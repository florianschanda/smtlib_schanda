...
(declare-fun user_eq8 (enum1t enum1t) Bool)

(declare-fun dummy8 () enum1t)
...
;; range_axiom
  (assert
  (forall ((x enum1t)) (! (in_range5 (to_rep5 x)) :pattern ((to_rep5 x)) )))
...
(define-fun bool_eq9 ((a us_rep3)
  (b us_rep3)) Bool (ite (and
                         ...
                         (to_rep5 (rec__ar__rec4t__g4 (us_split_fields7 b)))))
                    true false))
...
(declare-fun temp___7335 () us_rep3)
...
(declare-fun r__split_fields8 () us_split_fields6)

(declare-fun result3 () us_split_fields__ref3)

(declare-fun r__split_fields9 () us_split_fields6)

(declare-fun r__split_fields10 () us_split_fields__ref3)

(declare-fun r__split_fields11 () us_split_fields6)
...
;; H
  (assert (= temp___7335 (mk___rep3 o19)))

;; H
  (assert (= result3 (mk___split_fields__ref3 r__split_fields8)))

;; H
  (assert (= r__split_fields9 (us_split_fields7 temp___7335)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1112, characters 0-0
  (not
  (= (bool_eq9 (mk___rep3 (us_split_fields__content3 r__split_fields10))
     (mk___rep3
     (mk___split_fields3
     (mk___rep2
     (mk___split_fields2
     (mk___rep1
     (let ((usq_ (us_split_fields3 b)))
     (mk___split_fields1 (rec__ar__rec2t__f2 usq_)
     (mk___rep
     (mk___split_fields (of_rep d) (rec__ar__rec1t__g1 (us_split_fields1 c))))
     (rec__ar__rec2t__h2 usq_)))) (rec__ar__rec3t__g3 (us_split_fields5 a))))
     r__split_fields5))) true)))
(check-sat)
