...
(declare-fun temp___514 () (Array Int integer))

(declare-fun temp___5141 () t)
...
;; H
  (assert
  (and (= us1 8) (dynamic_property1 (to_rep a__first) (to_rep a__last) 8)))
...
;; H
  (assert
  (and (= us 1) (dynamic_property1 (to_rep a__first) (to_rep a__last) 1)))
...
;; H
  (assert
  (= (mk___t temp___514 temp___5141) (temp___505
                                     (mk___t a
...
;; WP_parameter_def
 ;; File "update_checks_1.ads", line 33, characters 0-0
  (not
  (= (ite (<= (to_rep (first temp___5141)) (to_rep (last temp___5141)))
     (+ (- (to_rep (last temp___5141)) (to_rep (first temp___5141))) 1) 0) 
