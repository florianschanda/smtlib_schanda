...
(define-fun dynamic_invariant6 ((temp___expr_281 us_rep3)
...
;; size__post_axiom
  (assert
  (forall ((f us_rep3))
  (! (=> (dynamic_invariant6 f true true true)
     (let ((result (size f)))
...
;; valid_root__post_axiom
  ...
  (forall ((i Int))
  (! (=>
     (and (dynamic_invariant6 f true true true) (dynamic_invariant1 i true
     true true))
...
;; peek__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant5 result true false true))))))))))) :pattern (
  (peek f i d)) ))))
...
;; model____post_axiom
  ...
  (! (and (valid_root__function_guard (valid_root f root) f root)
     (=>
     (and
     (and (dynamic_invariant6 f true true true) (dynamic_invariant1 root true
...
;; find_root__post_axiom
  ...
  (! (and (valid_root__function_guard (valid_root f root) f root)
     ...
     (and
     (and (dynamic_invariant6 f true true true) (dynamic_invariant1 root true
     true true)) (dynamic_invariant1 i true true true)) (dynamic_invariant1 j
     true true true))
     (and (= (valid_root f root) true)
     (and
     (= (rec__tree_model__path_type__k
        (us_split_fields1
        (let ((temp___942 (model__ f root))) (select temp___942 i)))) true)
     (= (rec__tree_model__path_type__k
        (us_split_fields1
        (let ((temp___940 (model__ f root))) (select temp___940 j)))) true))))
     (let ((result (find_root f root i j)))
     (and (model____function_guard (model__ f root) f root)
     (and (model____function_guard (model__ f root) f root)
     (and (model____function_guard (model__ f root) f root)
     (and (model____function_guard (model__ f root) f root)
     ...
     (and (model____function_guard (model__ f root) f root)
     (and (model____function_guard (model__ f root) f root)
     (=> (find_root__function_guard result f root i j)
     (and
     (and
     (= (rec__tree_model__path_type__k
        (us_split_fields1
        (let ((temp___961 (model__ f root))) (select temp___961 result)))) true)
     (and
     (= (ole
        (rec__tree_model__path_type__a
        (us_split_fields1
        (let ((temp___957 (model__ f root))) (select temp___957 result))))
        (rec__tree_model__path_type__a
        (us_split_fields1
        (let ((temp___959 (model__ f root))) (select temp___959 i))))) true)
     (and
     (= (ole
        (rec__tree_model__path_type__a
        (us_split_fields1
        (let ((temp___953 (model__ f root))) (select temp___953 result))))
        (rec__tree_model__path_type__a
        (us_split_fields1
        (let ((temp___955 (model__ f root))) (select temp___955 j))))) true)
     (or (or (= i result) (= j result))
     (not
     (= (get
        (rec__tree_model__path_type__a
        (us_split_fields1
        (let ((temp___945 (model__ f root))) (select temp___945 i))))
        (+ (length
           (rec__tree_model__path_type__a
           (us_split_fields1
           (let ((temp___947 (model__ f root))) (select temp___947 result))))) 1)) 
     (get
     (rec__tree_model__path_type__a
     (us_split_fields1
     (let ((temp___949 (model__ f root))) (select temp___949 j))))
     (+ (length
        (rec__tree_model__path_type__a
        (us_split_fields1
        (let ((temp___951 (model__ f root))) (select temp___951 result))))) 1))))))))
     (dynamic_invariant1 result true false true))))))))))))))))) :pattern (
  (find_root f root i j)) ))))
...
;; size__post_axiom
  ...
  (! (=> (and (dynamic_invariant9 t1 true true true) (type_invariant1 t1))
     (let ((result (size1 t1)))
     (=> (size__function_guard1 result t1) (dynamic_invariant5 result true
...
;; H
  ...
  (rec__search_trees__search_tree__struct (us_split_fields7 t))
  (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))
  (rec__search_trees__search_tree__values (us_split_fields7 t)))
  (rec__search_trees__search_tree__struct (us_split_fields7 t))
  (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))
  (rec__search_trees__search_tree__values (us_split_fields7 t))))
...
;; H
  ...
  (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) l 0)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) l 0))

;; H
  (assert (peek__function_guard
  (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) l 1)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) l 1))
...
;; H
  (assert
  (and
  (< 0 (size (rec__search_trees__search_tree__struct (us_split_fields7 t))))
  (and
  (not
  ...
  (= (ordered_leafs
     (rec__search_trees__search_tree__struct (us_split_fields7 t))
     (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))
     (rec__search_trees__search_tree__values (us_split_fields7 t))) true)
  (and
  (not
  (= (to_rep
  ...
  (ite (< v (to_rep
            (select (rec__search_trees__search_tree__values
                    (us_split_fields7 t)) l)))
  (= (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) l 0) 0)
  (= (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) l 1) 0))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t))
             (to_rep1
             (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) true)
  (=>
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t))
             (to_rep1
             (rec__search_trees__search_tree__root (us_split_fields7 t)))) i)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t))
  ...
  (ite (= (get
          ...
          (+ (length
             ...
             (select (model__
                     ...
                     (to_rep1
                     (rec__search_trees__search_tree__root
                     (us_split_fields7 t)))) i)))) 1)) 0)
  (< v (to_rep
       (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i)))
  (< (to_rep
     (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i)) 
  v))))))))))))))
...
;; H
  (assert
  (forall ((i Int)) (find_root__function_guard
  (find_root (rec__search_trees__search_tree__struct (us_split_fields7 t))
  (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) i 
  l) (rec__search_trees__search_tree__struct (us_split_fields7 t))
  (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) i 
  l)))
...
;; H
  (assert (model____function_guard
  (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o)
...
;; H
  (assert (model____function_guard
  (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)
...
;; H
  (assert (find_root__function_guard
  (find_root (rec__search_trees__search_tree__struct (us_split_fields7 t))
  (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) 
  i l) (rec__search_trees__search_tree__struct (us_split_fields7 t))
  (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) 
  i l))
...
(assert
;; WP_parameter_def
 ;; File "search_trees.adb", line 571, characters 0-0
  (not
  (not
  (= (to_rep
     (select (rec__search_trees__search_tree__values (us_split_fields7 t)) 
