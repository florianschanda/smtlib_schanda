...
;; H
  (assert (= (is_empty (mk___rep r__split_fields18)) true))
...
;; H
  (assert (head__function_guard (head (mk___rep r__split_fields17))
...
;; H
  ...
  (= (head (mk___rep r__split_fields17)) h1)) (in_range h1)))
...
;; H
  ...
  (= (head (mk___rep r__split_fields16)) h2)) (in_range h2)))
...
;; H
  ...
  (= (head (mk___rep r__split_fields15)) h3)) (in_range h3)))
