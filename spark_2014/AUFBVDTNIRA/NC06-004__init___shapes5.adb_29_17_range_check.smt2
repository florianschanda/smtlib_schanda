...
;; H
  (assert
  (=> (le (sub RNE2 x (neg fliteral1)) r2)
  (and (= o1 (sub RNE2 x (neg fliteral1))) (tqtisFinite
  (sub RNE2 x (neg fliteral1))))))

;; H
  (assert (=> (le (sub RNE2 x (neg fliteral1)) r2) (= r2 result2)))

;; H
  (assert (=> (le (sub RNE2 x (neg fliteral1)) r2) (= r3 o1)))

;; H
  (assert (=> (not (le (sub RNE2 x (neg fliteral1)) r2)) (= r3 r2)))

;; H
  (assert
  (=> (le (sub RNE2 fliteral1 y) r3)
  (and (= o2 (sub RNE2 fliteral1 y)) (tqtisFinite (sub RNE2 fliteral1 y)))))

;; H
  (assert (=> (le (sub RNE2 fliteral1 y) r3) (= r3 result3)))

;; H
  (assert (=> (le (sub RNE2 fliteral1 y) r3) (= r4 o2)))

;; H
  (assert (=> (not (le (sub RNE2 fliteral1 y) r3)) (= r4 r3)))

;; H
  (assert (le (sub RNE2 y (neg fliteral1)) r4))

(assert
;; WP_parameter_def
 ;; File "shapes5.ads", line 27, characters 0-0
  (not (in_range4 (sub RNE2 y (neg fliteral1)))))
(check-sat)
