...
(declare-fun temp___4389 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___4391 (Array Int et1)))
  (forall ((temp___4392 Int) (temp___4393 Int))
  (let ((temp___4390 (temp___4389 temp___4391 temp___4392 temp___4393)))
  (forall ((temp___4394 Int))
  (ite (= temp___4394 temp___4392)
  (= (select temp___4390 temp___4394) (of_rep temp___4393))
  (= (select temp___4390 temp___4394) (select temp___4391 temp___4394))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 184, characters 0-0
  (not (= (bool_eq2 a1 1 10 (temp___4389 t1 i e) 1 10) true)))
(check-sat)
