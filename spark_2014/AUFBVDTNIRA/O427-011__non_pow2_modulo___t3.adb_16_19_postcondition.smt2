...
(declare-fun t3__madd__result () (_ BitVec 64))

(declare-fun o () (_ BitVec 64))

(declare-fun result () (_ BitVec 64))

(declare-fun t3__madd__result1 () (_ BitVec 64))

(declare-fun t3__madd__result2 () (_ BitVec 64))

(declare-fun t3__madd__result3 () (_ BitVec 64))

(declare-fun t3__madd__result4 () (_ BitVec 64))

(declare-fun t3__madd__result5 () (_ BitVec 64))
...
;; H
  (assert (= t3__madd__result1 t3__madd__result2))

;; H
  (assert (= t3__madd__result3 t3__madd__result1))

;; H
  (assert
  (=> (bvule (bvsub ((_ int2bv 64) 230) x) y)
  (= o (bvsub (bvadd x y) ((_ int2bv 64) 230)))))

;; H
  (assert
  (=> (not (bvule (bvsub ((_ int2bv 64) 230) x) y)) (= o (bvadd x y))))

;; H
  (assert (= (mk_t__ref1 result) (mk_t__ref1 t3__madd__result)))

;; H
  (assert (= t3__madd__result1 o))

;; H
  (assert (= (mk_t__ref1 t3__madd__result4) (mk_t__ref1 t3__madd__result2)))

;; H
  (assert (= t3__madd__result5 t3__madd__result3))

;; H
  (assert (= result1 t3__madd__result4))

(assert
;; WP_parameter_def
 ;; File "t3.adb", line 6, characters 0-0
  (not
  (= ((_ extract 15 0) t3__madd__result4) (bvurem (bvadd ((_ extract 15 0) 
  x) ((_ extract 15 0) y)) ((_ int2bv 16) 230)))))
(check-sat)
