...
;; H
  (assert (forall ((i11 Int)) (parent__function_guard (parent f i11) f i11)))
...
;; H
  ...
  (=> (and (<= 1 i11) (<= i11 100))
  (=> (not (= i11 root))
  (ite (and (not (= (parent f i11) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select (map__content binary_trees__model__result4) (parent f i11)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (map__content binary_trees__model__result4) i11))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (map__content binary_trees__model__result4) i11))) true))))))))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (map__content binary_trees__model__result4) i1))) true))
...
;; H
  (assert
  (and (and (= o67 (position f i1)) (position__function_guard o67 f i1))
  (and (in_range4 o67)
  (= o67 (to_rep1
         (rec__binary_trees__cell__position
         (us_split_fields3
...
;; H
  (assert
  (and
  (and (= temp___940 (parent f i1)) (parent__function_guard temp___940 f i1))
  (and (in_range2 temp___940)
  (and
  (= temp___940 (to_rep
                (rec__binary_trees__cell__parent
                (us_split_fields3
                (select (rec__binary_trees__forest__c (us_split_fields5 f)) 
                i1)))))
  (and (=> (= (valid_root f i1) true) (= temp___940 0))
  (=> (= (size f) 0) (= temp___940 0)))))))
