...
(declare-fun temp___901 () (Array Int us_rep7))
...
;; H
  (assert
  (and (= temp___901 (nb_blacks c74b))
  (and
  (= (bool_eq17 (select temp___901 0)
     (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true)
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  ...
  (=
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select temp___901 i))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11
     (select temp___901 (peek
                        (rec__red_black_trees__rbt__struct
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select temp___901 i)))) (+ 1 (ite (< (to_rep
                                                              (rec__red_black_trees__black_count__depth
                                                              (us_split_fields11
                                                              (select 
                                                              temp___901 
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select temp___901 i)))) (+ (ite (= (to_rep3
...
;; H
  (assert (= o38 (select temp___901 c76b)))
...
;; H
  ...
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c74b) i)))) (int__content n8)))
