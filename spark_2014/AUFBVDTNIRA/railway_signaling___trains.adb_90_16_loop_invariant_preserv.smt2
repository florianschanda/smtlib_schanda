...
(declare-fun result3 () (Array Int us_rep1))

(declare-fun trains1 () (Array Int us_rep1))

(declare-fun result4 () (Array Int signal))
...
(declare-fun track_signals4 () (Array Int signal))
...
;; H
  (assert (no_track_precedes_itself__function_guard
  (no_track_precedes_itself Tuple0) Tuple0))
...
;; H
  ...
  (occupied_tracks_on_red cur_num_trains trains1 track_signals1)
  cur_num_trains trains1 track_signals1))
...
;; H
  (assert (previous_tracks_on_orange_or_red__function_guard
  (previous_tracks_on_orange_or_red cur_num_trains trains1 track_signals1)
  cur_num_trains trains1 track_signals1))
...
;; H
  (assert
  (and
  (and (= o2 (get_previous_track cur_position id1))
  (get_previous_track__function_guard o2 cur_position id1))
  (and (in_range1 o2)
  (= o2 (to_rep3
...
;; H
  (assert
  (forall ((t Int)) (is_previous_track__function_guard
  (is_previous_track (select trains1 t) o6) (select trains1 t) o6)))
...
;; H
  (assert
  (forall ((j Int) (t Int)) (is_previous_track__function_guard
  (is_previous_track (select trains1 t) j) (select trains1 t) j)))
...
;; H
  ...
  (=>
  (and (= (to_rep5 (select track_signals1 j)) 1)
  (exists ((t Int))
  (and (and (<= 1 t) (<= t cur_num_trains))
...
;; H
  (assert
  (forall ((t Int)) (is_previous_track__function_guard
  (is_previous_track (select trains1 t) o11) (select trains1 t) o11)))

;; H
  (assert
  (and (and (=> (<= 1 3) (in_range3 id2)) (=> (<= 0 8) (in_range1 prev2)))
  (and (<= 1 id2) (<= id2 3))))
...
;; H
  (assert (= result8 (mk_int__ref id2)))
...
;; H
  (assert
  (and
  (and (= o7 (get_previous_track cur_position id3))
  (get_previous_track__function_guard o7 cur_position id3))
  (and (in_range1 o7)
  (= o7 (to_rep3
        (select (select previous_tracks (to_rep1
                                        (rec__trains__track__from
...
;; H
  (assert (= result9 (mk_int__ref prev2)))
...
;; H
  (assert (=> (not (= prev3 0)) (= o8 prev3)))

;; H
  (assert (=> (not (= prev3 0)) (= o9 (select track_signals3 o8))))

;; H
  (assert (=> (not (= prev3 0)) (= o10 (to_rep5 o9))))

;; H
  (assert (=> (not (= prev3 0)) (= result10 (ite (= o10 1) true false))))

;; H
  (assert (=> (not (not (= prev3 0))) (= result10 false)))

;; H
  (assert (=> (= result10 true) (and (= o11 prev3) (in_range2 prev3))))
...
;; H
  ...
  (ite (exists ((t Int))
       (and (and (<= 1 t) (<= t cur_num_trains))
       (= (is_previous_track (select trains1 t) o11) true)))
  (= (to_rep5 (select track_signals4 o11)) 1)
  (= (to_rep5 (select track_signals4 o11)) 0))
  (forall ((other_track Int))
  (=> (and (<= 1 other_track) (<= other_track 8))
  (=> (not (= other_track o11))
  (= (to_rep5 (select track_signals4 other_track)) (to_rep5
                                                   (select track_signals3 other_track)))))))))

;; H
  (assert (=> (not (= result10 true)) (= track_signals4 track_signals3)))
...
;; WP_parameter_def
 ;; File "trains.ads", line 191, characters 0-0
  (not (= (to_rep5 (select track_signals4 j)) 2)))
(check-sat)
