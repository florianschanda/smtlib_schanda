...
(declare-fun dummy3 () ttmp3S)

(declare-datatypes ()
((ttmp3S__ref (mk_ttmp3S__ref (ttmp3S__content ttmp3S)))))
(define-fun ttmp3S__ref___projection ((a ttmp3S__ref)) ttmp3S (ttmp3S__content
                                                              a))
...
(declare-fun dummy4 () ttmp4S)

(declare-datatypes ()
((ttmp4S__ref (mk_ttmp4S__ref (ttmp4S__content ttmp4S)))))
(define-fun ttmp4S__ref___projection ((a ttmp4S__ref)) ttmp4S (ttmp4S__content
                                                              a))
...
(define-fun dynamic_invariant4 ((temp___expr_153 Int)
  ...
  (temp___do_toplevel_152 Bool)) Bool (=>
                                      ...
                                      (<= 1 5)) (in_range5 temp___expr_153)))

(declare-fun attr__ATTRIBUTE_ADDRESS5 () Int)

(declare-sort ttmp5S 0)

(define-fun in_range6 ((x1 Int)) Bool (and (<= 1 x1) (<= x1 5)))
...
(declare-fun dummy5 () ttmp5S)

(declare-datatypes ()
((ttmp5S__ref (mk_ttmp5S__ref (ttmp5S__content ttmp5S)))))
(define-fun ttmp5S__ref___projection ((a ttmp5S__ref)) ttmp5S (ttmp5S__content
                                                              a))
...
;; H
  (assert (=> (<= 1 10) (in_range2 tmp1)))

;; H
  (assert (=> (<= 1 10) (in_range3 tmp2)))

;; H
  (assert (=> (<= 1 5) (in_range4 tmp3)))

;; H
  (assert (=> (<= 1 5) (in_range5 tmp4)))

;; H
  (assert (=> (<= 1 5) (in_range6 tmp5)))
