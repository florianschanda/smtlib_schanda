...
;; H
  (assert (top__function_guard (top (mk___rep s__split_fields4))
...
;; H
  (assert (to_but_top__function_guard
  (to_but_top (mk___rep s__split_fields4)) (mk___rep s__split_fields4)))
...
;; H
  (assert
  (and (= (top (mk___rep s__split_fields4)) o3)
  (= (let ((temp___187 (to__ (mk___rep s__split_fields3))))
     (let ((temp___186 (to_but_top (mk___rep s__split_fields4))))
     (bool_eq1 (elts temp___186) (to_rep (first (rt temp___186)))
     (to_rep (last (rt temp___186))) (elts temp___187)
     (to_rep (first (rt temp___187))) (to_rep (last (rt temp___187)))))) true)))
