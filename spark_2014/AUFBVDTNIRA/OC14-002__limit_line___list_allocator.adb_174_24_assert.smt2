...
;; H
  ...
  (= (to_rep
     (rec__list_allocator__cell__next
     (us_split_fields1 (select data3 (get ma1 (+ j 1)))))) (get ma1 (+ j 2))))))
...
;; H
  ...
  (= (to_rep
     (rec__list_allocator__cell__next
     (us_split_fields1 (select data3 (get ma1 (+ j 1)))))) (ite (< j 
                                                           (length
                                                           (rec__list_allocator__m__t__available
                                                           model____split_fields3)))
                                                           (get ma1 (+ j 2))
...
;; WP_parameter_def
 ;; File "list_allocator.adb", line 27, characters 0-0
  (not
  (< 0 (length (rec__list_allocator__m__t__available model____split_fields3)))))
(check-sat)
