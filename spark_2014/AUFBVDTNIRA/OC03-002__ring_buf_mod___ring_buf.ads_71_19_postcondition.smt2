...
;; WP_parameter_def
 ;; File "ring_buf.ads", line 67, characters 0-0
  (not
  (= (let ((temp___336 (func_pop
                       (to_model
                       (mk___rep
                       (mk___split_fields r__split_fields r__split_fields1
                       r__split_fields2))))))
     (let ((temp___335 (to_model
                       (mk___rep
                       (mk___split_fields r__split_fields9 r__split_fields10
                       r__split_fields11)))))
     (bool_eq3 (elts temp___335) (to_rep1 (first (rt temp___335)))
     (to_rep1 (last (rt temp___335))) (elts temp___336)
     (to_rep1 (first (rt temp___336))) (to_rep1 (last (rt temp___336)))))) true)))
(check-sat)
