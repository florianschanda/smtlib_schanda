...
(declare-fun temp___4083 ((Array Int us_rep2) Int
  us_rep2) (Array Int us_rep2))

;; def_axiom
  (assert
  (forall ((temp___4085 (Array Int us_rep2)))
  (forall ((temp___4086 Int))
  (forall ((temp___4087 us_rep2))
  (let ((temp___4084 (temp___4083 temp___4085 temp___4086 temp___4087)))
  (forall ((temp___4088 Int))
  (ite (= temp___4088 temp___4086)
  (= (select temp___4084 temp___4088) temp___4087)
  (= (select temp___4084 temp___4088) (select temp___4085 temp___4088)))))))))
...
(declare-fun temp___9563 () us_rep3)
...
;; H
  (assert (= temp___9563 (mk___rep3 o28)))
...
;; H
  (assert (= r__split_fields2 (us_split_fields7 temp___9563)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1817, characters 0-0
  (not
  (= (bool_eq9 (mk___rep3 (us_split_fields__content3 r__split_fields3))
     (mk___rep3
     (mk___split_fields3 r__split_fields
     (temp___4083 r__split_fields1 i
     (mk___rep2
     (mk___split_fields2
     (mk___rep1
     (mk___split_fields1
     ...
     (rec__ar__rec1t__g1
     (us_split_fields1
     (rec__ar__rec5t__h5 (us_split_fields5 (select r__split_fields1 i))))))))))))) true)))
(check-sat)
