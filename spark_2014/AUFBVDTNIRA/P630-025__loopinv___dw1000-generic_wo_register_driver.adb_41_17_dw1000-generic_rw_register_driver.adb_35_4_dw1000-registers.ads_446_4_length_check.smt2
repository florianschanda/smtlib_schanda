...
(define-fun dynamic_invariant ((temp___expr_5308 us_t1)
  ...
  (temp___do_toplevel_5307 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_5308))
                                       (and (= (first3 temp___expr_5308) 1)
                                       (= (last4 temp___expr_5308) 5)))))
...
(define-fun dynamic_invariant1 ((temp___expr_5324 us_t2)
  ...
  (temp___do_toplevel_5323 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_5324))
                                       (and (= (first5 temp___expr_5324) 1)
                                       (= (last6 temp___expr_5324) 5)))))
...
;; H
  (assert
  (and
  (and (= temp___78592 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___78592 reg)) (dynamic_invariant1
  temp___78592 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___78591)) (to_rep (last5 temp___78591)))
     (+ (- (to_rep (last5 temp___78591)) (to_rep (first4 temp___78591))) 1)
     0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78591)) (to_rep (last5 temp___78591))) 
  temp___78601))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___78601)) (to_rep (last3 temp___78601)))
     (+ (- (to_rep (last3 temp___78601)) (to_rep (first2 temp___78601))) 1)
