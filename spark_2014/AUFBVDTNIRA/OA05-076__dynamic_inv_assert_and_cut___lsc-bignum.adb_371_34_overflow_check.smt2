...
;; H
  (assert
  (and (= o66 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o66 ((_ int2bv 32) 1))))
...
;; H
  (assert
  (and (= o64 (num_of_big_int m m_first o63)) (num_of_big_int__function_guard
  o64 m m_first o63)))

;; H
  (assert
  (and (= o59 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o59 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o65 (omultiply o59 o64)) (omultiply__function_guard o65 o59 o64)))

;; H
  (assert
  (and (= o67 (osubtract o65 o66)) (osubtract__function_guard o67 o65 o66)))

;; H
  (assert
  (and (= o56 (from_word32 a_msw3)) (from_word32__function_guard o56 a_msw3)))
...
;; H
  (assert
  (and (= o55 (oexpon o50 o54)) (oexpon__function_guard o55 o50 o54)))

;; H
  (assert
  (and (= o57 (omultiply o55 o56)) (omultiply__function_guard o57 o55 o56)))
...
;; H
  ...
  (= o49 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))
         a_first o48))
  (num_of_big_int__function_guard o49
  (mk___t a4 (mk (to_rep a__first) (to_rep a__last))) a_first o48)))

;; H
  (assert (and (= o58 (oadd o49 o57)) (oadd__function_guard o58 o49 o57)))

;; H
  (assert (and (= o68 (olt o58 o67)) (olt__function_guard o68 o58 o67)))
...
;; H
  (assert
  (and (= o44 (num_of_big_int m m_first o43)) (num_of_big_int__function_guard
  o44 m m_first o43)))
