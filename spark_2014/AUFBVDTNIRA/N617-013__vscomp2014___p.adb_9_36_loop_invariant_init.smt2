...
(declare-fun saved () (Array Int index))
...
(declare-fun f1 () (Array Int index))
...
(declare-fun f2 () (Array Int index))
...
;; WP_parameter_def
 ;; File "p.ads", line 5, characters 0-0
  (not (= (bool_eq1 f1 1 10 saved 1 10) true)))
(check-sat)
