...
(declare-fun temp___832 () digit_index_type)

(declare-fun temp___8321 () (Array Int octet))

(declare-fun temp___8322 () t1)
...
;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___829 temp___8291)))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___832)))

;; H
  (assert (= temp___8321 o2))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___8321 temp___8322))))
...
;; H
  ...
  (forall ((temp___838 Int))
  (=>
  (and
  (<= (to_rep2
      (first2
      (rt1
      (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___838)
  (<= temp___838 (to_rep2
                 (last4
                 (rt1
                 (rec__very_longs__very_long__long_digits1
  ...
  (= (select (elts1
             (rec__very_longs__very_long__long_digits1
             result____split_fields3)) temp___838) (select (elts1
                                                           (rec__very_longs__very_long__long_digits1
                                                           result____split_fields2)) temp___838))))))
  (=> (<= 0 2147483647) (in_range1 temp2)))
  (and (<= 1 index2) (<= index2 r28b))))
