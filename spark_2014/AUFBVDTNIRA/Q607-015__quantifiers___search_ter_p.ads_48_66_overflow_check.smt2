...
;; H
  ...
  (and
  (and
  (= result16 (equal_subrange a
              (to_rep
              (rec__types__option__value
              (us_split_fields1
              (option__content search_ter_p__search__result21)))) b))
  (equal_subrange__function_guard result16 a
  (to_rep
  (rec__types__option__value
  ...
  (= (bool_eq2 (elts a)
     ...
     (+ (- (to_rep
           (rec__types__option__value
           (us_split_fields1
           (option__content search_ter_p__search__result21)))) 1) (length b)))))
     (to_rep
     (last3
     (mk1
     (to_rep
