...
;; H
  (assert (divides__function_guard (divides c3 a) c3 a))

;; H
  (assert (divides__function_guard (divides c3 b) c3 b))

;; H
  (assert (=> (<= 1 2147483647) (in_range1 c2)))

;; H
  (assert (and (= o1 (- c2 1)) (in_range1 (- c2 1))))
...
;; H
  (assert (not (and (= (mod2 a c3) 0) (= (mod2 b c3) 0))))

;; H
  (assert (=> (not (= (mod2 a c3) 0)) (not (= (divides c3 a) true))))

;; H
  (assert (=> (not (not (= (mod2 a c3) 0))) (not (= (divides c3 b) true))))
