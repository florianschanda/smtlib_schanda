...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__interrupt_priority__interrupt_needed_1__i integer)))))
...
((interrupt_needed_1__ref
 (mk_interrupt_needed_1__ref (interrupt_needed_1__content us_rep)))))
(define-fun interrupt_needed_1__ref___projection ((a interrupt_needed_1__ref)) us_rep 
