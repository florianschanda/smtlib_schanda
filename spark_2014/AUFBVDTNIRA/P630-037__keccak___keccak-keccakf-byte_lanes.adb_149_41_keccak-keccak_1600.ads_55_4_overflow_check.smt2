...
(define-fun dynamic_invariant1 ((temp___expr_282 (_ BitVec 64))
...
(declare-fun temp___789 ((_ BitVec 8) Int Int) us_t1)

;; def_axiom
  (assert
  (forall ((temp___791 (_ BitVec 8)))
  (forall ((temp___792 Int) (temp___793 Int))
  (let ((temp___790 (temp___789 temp___791 temp___792 temp___793)))
  (and
  (=> (dynamic_property 0 2147483647 temp___792 temp___793)
  (and (= (first4 temp___790) temp___792) (= (last4 temp___790) temp___793)))
  (forall ((temp___794 Int))
  (= (select (to_array1 temp___790) temp___794) (of_rep1 temp___791))))))))
...
(declare-fun temp___796 () (Array Int byte))

(declare-fun temp___7961 () t1)

(declare-fun temp___797 () (Array Int byte))

(declare-fun temp___7971 () t)

(declare-fun temp___798 () (Array Int byte))

(declare-fun temp___7981 () t)

(declare-fun o2 () (Array Int byte))

(declare-fun temp___814 () (_ BitVec 64))

(declare-fun temp___813 () Int)

(declare-fun temp___812 () Int)

(declare-fun temp___811 () (_ BitVec 8))

(declare-fun temp___809 () (Array Int byte))

(declare-fun temp___807 () (_ BitVec 8))

(declare-fun temp___816 () Int)

(declare-fun temp___815 () Int)

(declare-fun temp___801 () (Array Int byte))
...
(declare-fun temp___8161 () Int)

(declare-fun temp___8151 () Int)

(declare-fun result5 () Int)

(declare-fun temp___8162 () Int)

(declare-fun result6 () Int)

(declare-fun temp___8152 () Int)
...
(declare-fun data13 () (Array Int byte))
...
(declare-fun temp___8261 () Int)

(declare-fun result18 () int__ref)

(declare-fun temp___8251 () Int)

(declare-fun result19 () int__ref)

(declare-fun temp___8241 () Int)
...
;; H
  ...
  (= (to_rep
     (first3
     (rt1
     (temp___789 ((_ int2bv 8) 0) (to_rep data__first) (to_rep data__last))))) 
  (to_rep data__first)))
...
;; H
  (assert
  (= (mk___t1 temp___796 temp___7961) (temp___789 ((_ int2bv 8) 0)
                                      (to_rep data__first)
                                      (to_rep data__last))))

;; H
  (assert (= temp___796 temp___797))

;; H
  (assert
  (= (mk (to_rep (first3 temp___7961)) (to_rep (last3 temp___7961))) 
  temp___7971))

;; H
  (assert
  (= (ite (<= (to_rep (first temp___7971)) (to_rep (last temp___7971)))
     (+ (- (to_rep (last temp___7971)) (to_rep (first temp___7971))) 1) 0) 
  (ite (<= (to_rep data__first) (to_rep data__last))
  (+ (- (to_rep data__last) (to_rep data__first)) 1) 0)))

;; H
  (assert
  (= (mk___t temp___798 temp___7981) (mk___t temp___797 temp___7971)))

;; H
  (assert
  (= o2 (slide temp___798 (to_rep (first temp___7981)) (to_rep data__first))))
...
;; H
  (assert (=> (<= 8 remaining_bytes1) (= temp___814 lane)))

;; H
  (assert (=> (<= 8 remaining_bytes1) (= temp___813 offset1)))

;; H
  (assert (=> (<= 8 remaining_bytes1) (= temp___812 remaining_bytes1)))

;; H
  (assert (=> (<= 8 remaining_bytes1) (= temp___811 y1)))

;; H
  (assert (=> (<= 8 remaining_bytes1) (= temp___809 data1)))

;; H
  (assert (=> (<= 8 remaining_bytes1) (= temp___807 x1)))

;; H
  (assert (=> (<= 8 remaining_bytes1) (= 0 temp___816)))

;; H
  (assert (=> (<= 8 remaining_bytes1) (= 0 temp___815)))
...
;; H
  (assert (=> (<= 8 remaining_bytes1) (= temp___8161 result5)))

;; H
  (assert (=> (<= 8 remaining_bytes1) (= temp___8162 offset2)))

;; H
  (assert (=> (<= 8 remaining_bytes1) (= temp___8151 result6)))

;; H
  (assert (=> (<= 8 remaining_bytes1) (= temp___8152 remaining_bytes2)))
...
;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (and (<= 0 i3) (<= i3 7)) (= temp___801 data2))))
...
;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (and (<= 0 i3) (<= i3 7)) (and (= o5 (* i4 8)) (in_range1 (* i4 8))))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (and (<= 0 i3) (<= i3 7)) (and (= o6 o5) (in_range2 o5)))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (and (<= 0 i3) (<= i3 7)) (= o7 ((_ int2bv 64) o6)))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (and (<= 0 i3) (<= i3 7)) (= o8 (bvlshr lane3 o7)))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (and (<= 0 i3) (<= i3 7)) (= o9 (bvand o8 ((_ int2bv 64) 255))))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1) (=> (and (<= 0 i3) (<= i3 7)) (= o10 o9))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (and (<= 0 i3) (<= i3 7)) (= o11 ((_ extract 7 0) o10)))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (and (<= 0 i3) (<= i3 7)) (= (to_rep1 o12) o11))))
...
;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (and (<= 0 i3) (<= i3 7)) (and (= temp___799 o4) (in_range1 o4)))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (and (<= 0 i3) (<= i3 7))
  (and (<= (to_rep data__first) temp___799)
  (<= temp___799 (to_rep data__last))))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (and (<= 0 i3) (<= i3 7)) (= o13 temp___799))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (and (<= 0 i3) (<= i3 7)) (= o14 (store data3 o13 o12)))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (and (<= 0 i3) (<= i3 7)) (= result9 (mk_map__ref data3)))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1) (=> (and (<= 0 i3) (<= i3 7)) (= data4 o14))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1) (=> (and (<= 0 i3) (<= i3 7)) (= i4 7))))
...
;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (and (<= 0 i3) (<= i3 7)) (= data5 (mk_map__ref data4)))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1) (=> (and (<= 0 i3) (<= i3 7)) (= i6 i4))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1) (=> (and (<= 0 i3) (<= i3 7)) (= data6 data4))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1) (=> (and (<= 0 i3) (<= i3 7)) (= i7 i5))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1) (=> (and (<= 0 i3) (<= i3 7)) (= data7 data5))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1) (=> (and (<= 0 i3) (<= i3 7)) (= i8 i6))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1) (=> (and (<= 0 i3) (<= i3 7)) (= data8 data6))))
...
;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (not (and (<= 0 i3) (<= i3 7))) (= data7 (mk_map__ref data2)))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1) (=> (not (and (<= 0 i3) (<= i3 7))) (= i8 i3))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (not (and (<= 0 i3) (<= i3 7))) (= data8 data2))))
...
;; H
  (assert (=> (<= 8 remaining_bytes1) (= result10 (mk_t__ref x2))))

;; H
  (assert (=> (<= 8 remaining_bytes1) (= x3 o15)))
...
;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (= x3 ((_ int2bv 8) 0)) (= result11 (mk_t__ref y2)))))

;; H
  (assert
  (=> (<= 8 remaining_bytes1) (=> (= x3 ((_ int2bv 8) 0)) (= y3 o16))))
...
;; H
  (assert
  (=> (<= 8 remaining_bytes1) (=> (= x3 ((_ int2bv 8) 0)) (= y5 y3))))
...
;; H
  (assert
  (=> (<= 8 remaining_bytes1) (=> (not (= x3 ((_ int2bv 8) 0))) (= y5 y2))))
...
;; H
  (assert
  (=> (<= 8 remaining_bytes1) (= result12 (mk_int__ref remaining_bytes2))))

;; H
  (assert (=> (<= 8 remaining_bytes1) (= remaining_bytes3 o17)))
...
;; H
  (assert (=> (<= 8 remaining_bytes1) (= result13 (mk_int__ref offset2))))

;; H
  (assert (=> (<= 8 remaining_bytes1) (= offset3 o18)))

;; H
  (assert (=> (<= 8 remaining_bytes1) (not (<= 8 remaining_bytes3))))

;; H
  (assert (=> (<= 8 remaining_bytes1) (= i9 i7)))
...
;; H
  (assert (=> (<= 8 remaining_bytes1) (= data9 data7)))

;; H
  (assert (=> (<= 8 remaining_bytes1) (= i10 i8)))
...
;; H
  (assert (=> (<= 8 remaining_bytes1) (= data10 data8)))

;; H
  (assert (=> (<= 8 remaining_bytes1) (= i11 i9)))
...
;; H
  (assert (=> (<= 8 remaining_bytes1) (= data11 data9)))
...
;; H
  (assert (=> (not (<= 8 remaining_bytes1)) (= i11 (mk_int__ref i))))
...
;; H
  (assert (=> (not (<= 8 remaining_bytes1)) (= data11 (mk_map__ref data1))))

;; H
  (assert (=> (not (<= 8 remaining_bytes1)) (= i12 i1)))
...
;; H
  (assert (=> (not (<= 8 remaining_bytes1)) (= data12 data1)))

;; H
  (assert (< 0 (int__content remaining_bytes6)))

;; H
  (assert (= result14 lane6))

;; H
  (assert (= lane8 (to_rep2 (get a (t__content x6) (t__content y8)))))

;; H
  (assert (= result15 (mk_int__ref shift)))
...
;; H
  (assert (= result16 (mk_int__ref initial_offset)))
...
;; H
  (assert (= result17 (mk_int__ref temp___826)))

;; H
  (assert (= temp___8261 offset8))

;; H
  (assert (= result18 (mk_int__ref temp___825)))

;; H
  (assert (= temp___8251 shift2))

;; H
  (assert (= result19 (mk_int__ref temp___824)))

;; H
  (assert (= temp___8241 remaining_bytes8))

;; H
  (assert
  (= (to_rep1 o19) ((_ extract 7 0) (bvand (bvlshr lane8 ((_ int2bv 64) 
  shift2)) ((_ int2bv 64) 255)))))

;; H
  (assert
  (and (= temp___817 (+ (to_rep data__first) offset8)) (in_range1
  (+ (to_rep data__first) offset8))))

;; H
  (assert
  (and (<= (to_rep data__first) temp___817)
  (<= temp___817 (to_rep data__last))))

;; H
  (assert (= o20 temp___817))

;; H
  (assert (= o21 (store data13 o20 o19)))

;; H
  (assert (= result20 (mk_map__ref data13)))
