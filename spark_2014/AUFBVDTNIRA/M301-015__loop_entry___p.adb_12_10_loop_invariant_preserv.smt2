...
;; H
  ...
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3))
  (= o4 (store (get (select x4 i32) i212 i223) i13 o3))))))

;; H
  (assert
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3)) (= o5 (set (select x4 i32) i212 i223 o4))))))

;; H
  (assert
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3)) (= o6 (store x4 i32 o5))))))
...
;; WP_parameter_def
 ;; File "p.adb", line 1, characters 0-0
  (not
  (= (bool_eq4 (map__content2 x19)
     (to_rep (first1 (mk (+ (int__content i34) 1) 3)))
     (to_rep (last (mk (+ (int__content i34) 1) 3))) x1
     (to_rep (first4 (mk1 (+ (int__content i34) 1) 3)))
