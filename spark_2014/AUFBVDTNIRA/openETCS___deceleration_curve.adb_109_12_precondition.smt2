...
(declare-fun to_rep2 (speed_t) t)

(declare-fun of_rep2 (t) speed_t)
...
(define-fun dynamic_invariant1 ((temp___expr_161 t) (temp___is_init_158 Bool)
...
(declare-fun km_per_h_from_m_per_s (t) t)

(declare-fun km_per_h_from_m_per_s__function_guard (t t) Bool)
...
;; WP_parameter_def
 ;; File "deceleration_curve.adb", line 73, characters 0-0
  ...
  (= (is_valid_speed
     ...
     (us_split_fields1
     (select (rec__deceleration_curve__braking_curve_t__curve
             (us_split_fields3 braking_curve)) i2))))) true)))
(check-sat)
