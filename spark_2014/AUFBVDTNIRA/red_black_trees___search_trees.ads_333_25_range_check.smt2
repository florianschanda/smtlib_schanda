...
(define-fun dynamic_invariant1 ((temp___expr_216 (Array Int us_rep3))
...
(define-fun default_initial_assumption ((temp___expr_219 (Array Int us_rep3))
...
(define-fun dynamic_invariant3 ((temp___expr_376 us_rep4)
...
(define-fun default_initial_assumption2 ((temp___expr_380 us_rep4)
...
;; size__post_axiom
  ...
  (! (=> (and (dynamic_invariant3 t true true true) (type_invariant1 t))
     (dynamic_invariant4 (size1 t) true false true)) :pattern ((size1 t)) )))
...
(define-fun dynamic_invariant8 ((temp___expr_205 us_rep3)
...
(define-fun dynamic_predicate ((temp___211 us_rep3)) Bool (< (length
                                                             (rec__tree_model__path_type__a
                                                             (us_split_fields5
                                                             temp___211))) 100))
...
(define-fun default_initial_assumption4 ((temp___expr_199 us_rep2)
