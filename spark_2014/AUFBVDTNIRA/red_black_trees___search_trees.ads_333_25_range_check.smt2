...
(define-fun us_split_fields_A__projection ((a us_split_fields4)) us_rep2 
  (rec__tree_model__path_type__a a))

(define-fun us_split_fields_K__projection ((a us_split_fields4)) Bool 
...
(define-fun bool_eq7 ((a us_rep3)
  (b us_rep3)) Bool (ite (and
                         ...
                         (= (rec__tree_model__path_type__k
                            (us_split_fields5 a)) (rec__tree_model__path_type__k
                                                  (us_split_fields5 b))))
                    true false))
...
(declare-datatypes ()
((path_type__ref (mk_path_type__ref (path_type__content us_rep3)))))
(define-fun path_type__ref___projection ((a path_type__ref)) us_rep3 
...
(define-fun dynamic_invariant1 ((temp___expr_218 (Array Int us_rep3))
...
(define-fun default_initial_assumption ((temp___expr_221 (Array Int us_rep3))
...
;; model____post_axiom
  ...
  (! (and (valid_root__function_guard (valid_root f root) f root)
     ...
     (is_add
     (rec__tree_model__path_type__a
     (us_split_fields5 (select result (parent f i)))) (position f i)
     (rec__tree_model__path_type__a (us_split_fields5 (select result i))))
     (rec__tree_model__path_type__a
     (us_split_fields5 (select result (parent f i)))) (position f i)
     (rec__tree_model__path_type__a (us_split_fields5 (select result i)))))
     ...
     (and
     (= (rec__tree_model__path_type__k
        (us_split_fields5 (select result root))) true)
     (and
     (= (length
        (rec__tree_model__path_type__a
        (us_split_fields5 (select result root)))) 0)
     (and
     (forall ((i Int))
     (=> (and (<= 1 i) (<= i 100))
     (=> (not (= i root))
     (ite (and (not (= (parent f i) 0))
          (= (rec__tree_model__path_type__k
             (us_split_fields5 (select result (parent f i)))) true))
     (= (rec__tree_model__path_type__k (us_split_fields5 (select result i))) true)
     (not
     (= (rec__tree_model__path_type__k (us_split_fields5 (select result i))) true))))))
     (and
     (forall ((i Int))
     ...
     (= (is_add
        (rec__tree_model__path_type__a
        (us_split_fields5 (select result (parent f i)))) (position f i)
        (rec__tree_model__path_type__a (us_split_fields5 (select result i)))) true)
     (= (length
        (rec__tree_model__path_type__a (us_split_fields5 (select result i)))) 0))))
     (forall ((i Int))
     (=> (and (<= 1 i) (<= i 100))
     (=>
     (= (rec__tree_model__path_type__k (us_split_fields5 (select result i))) true)
     ...
     (=>
     (and
     (= (rec__tree_model__path_type__k (us_split_fields5 (select result j))) true)
     (= (oeq
        (rec__tree_model__path_type__a (us_split_fields5 (select result i)))
        (rec__tree_model__path_type__a (us_split_fields5 (select result j)))) true))
...
(define-fun bool_eq10 ((a (Array Int natural)) (a__first Int) (a__last Int)
...
(declare-fun dummy9 () (Array Int natural))
...
(define-fun us_split_fields_Struct__projection ((a us_split_fields6)) us_rep1 
...
(define-fun dynamic_invariant3 ((temp___expr_562 us_rep4)
...
(define-fun default_initial_assumption2 ((temp___expr_567 us_rep4)
...
;; size__post_axiom
  ...
  (! (=> (and (dynamic_invariant3 t true true true) (type_invariant1 t))
     (let ((result (size1 t)))
     (=> (size__function_guard1 result t) (dynamic_invariant4 result true
...
(define-fun dynamic_invariant8 ((temp___expr_207 us_rep3)
  (temp___is_init_204 Bool) (temp___skip_constant_205 Bool)
  (temp___do_toplevel_206 Bool)) Bool (=> (= temp___do_toplevel_206 true)
                                      (=> (= temp___is_init_204 true)
                                      (< (length
                                         (rec__tree_model__path_type__a
                                         (us_split_fields5 temp___expr_207))) 100))))

(define-fun default_initial_assumption3 ((temp___expr_209 us_rep3)
...
(define-fun dynamic_predicate ((temp___213 us_rep3)) Bool (< (length
                                                             (rec__tree_model__path_type__a
                                                             (us_split_fields5
                                                             temp___213))) 100))
...
(define-fun default_initial_assumption4 ((temp___expr_201 us_rep2)
