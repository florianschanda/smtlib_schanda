...
(declare-fun numerics__Odivide__result () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun numerics__Odivide__result1 () t)

(declare-fun numerics__Odivide__result2 () t)

(declare-fun numerics__Odivide__result3 () t)

(declare-fun numerics__Odivide__result4 () t)

(declare-fun numerics__Odivide__result5 () t)
...
;; WP_parameter_def
 ;; File "numerics.ads", line 7, characters 0-0
  (not (eq numerics__Odivide__result4 (div1 RNE1 left right))))
(check-sat)
