...
(define-fun dynamic_invariant4 ((temp___expr_203 t) (temp___is_init_200 Bool)
  (temp___skip_constant_201 Bool)
  (temp___do_toplevel_202 Bool)) Bool (=>
                                      (or (= temp___is_init_200 true) (le
                                      (neg fliteral1) fliteral1))
                                      (tqtisFinite temp___expr_203)))
...
(declare-fun zero_and_unchecked__zero_plus__assume () t)

(declare-fun zero_and_unchecked__zero_neg__assume () t)
...
;; H
  ...
  ((_ int2bv 32) 0))) (tqtisFinite zero_and_unchecked__zero_plus__assume)))
...
;; H
  ...
  ((_ int2bv 32) 2147483648))) (tqtisFinite
