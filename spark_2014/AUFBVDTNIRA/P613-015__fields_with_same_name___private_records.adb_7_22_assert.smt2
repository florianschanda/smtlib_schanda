...
((us_split_fields
 (mk___split_fields
 (rec__private_records__root__f integer)(rec__ext__ us_private)))))
(define-fun us_split_fields_F__projection ((a us_split_fields)) integer 
  (rec__private_records__root__f a))
...
(declare-fun private_records__root__f__first__bit () Int)

(declare-fun private_records__root__f__last__bit () Int)

(declare-fun private_records__root__f__position () Int)

;; private_records__root__f__first__bit_axiom
  (assert (<= 0 private_records__root__f__first__bit))

;; private_records__root__f__last__bit_axiom
  (assert
  (< private_records__root__f__first__bit private_records__root__f__last__bit))

;; private_records__root__f__position_axiom
...
((us_split_fields2
 (mk___split_fields1
 (rec__private_records__root__f1 integer)(rec__public_records__child__f integer)(rec__ext__1 us_private)))))
(define-fun us_split_fields_F2__projection ((a us_split_fields2)) integer 
  (rec__private_records__root__f1 a))

(define-fun us_split_fields_F3__projection ((a us_split_fields2)) integer 
  (rec__public_records__child__f a))
...
;; extract__f__conv
  ...
  (= (extract__f (hide_ext__ f rec__ext__2)) f))))
...
(declare-fun private_records__root__f__first__bit1 () Int)

(declare-fun private_records__root__f__last__bit1 () Int)

(declare-fun private_records__root__f__position1 () Int)
...
(declare-fun public_records__child__f__first__bit () Int)

(declare-fun public_records__child__f__last__bit () Int)

(declare-fun public_records__child__f__position () Int)

;; public_records__child__f__first__bit_axiom
  (assert (<= 0 public_records__child__f__first__bit))

;; public_records__child__f__last__bit_axiom
  (assert
  (< public_records__child__f__first__bit public_records__child__f__last__bit))

;; public_records__child__f__position_axiom
...
;; H
  (assert
  (and (= c__attr__tag us_tag1)
  (and (= (to_rep c__split_fields) 0) (= (to_rep c__split_fields1) 1))))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= (to_rep c__split_fields) 1)))
(check-sat)
