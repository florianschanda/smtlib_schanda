...
;; H
  (assert (writereg32post__function_guard
  (writereg32post (let ((subject rbx)) rbx31) ((_ int2bv 32) 0))
  (let ((subject rbx)) rbx31) ((_ int2bv 32) 0)))

;; H
  (assert (writereg32post__function_guard
  (writereg32post rax26 ((_ int2bv 32) 0)) rax26 ((_ int2bv 32) 0)))

;; H
  (assert (writereg32post__function_guard
  (writereg32post (let ((subject rdi)) rdi39) ((_ int2bv 32) 4198688))
  (let ((subject rdi)) rdi39) ((_ int2bv 32) 4198688)))

;; H
  (assert (writereg32post__function_guard (writereg32post rax27 o181) 
  rax27 o181))

;; H
  (assert (writereg32post__function_guard
  (writereg32post (let ((subject rdi)) rdi40) ((_ int2bv 32) 4198699))
  (let ((subject rdi)) rdi40) ((_ int2bv 32) 4198699)))

;; H
  (assert (writereg32post__function_guard
  (writereg32post rax28 ((_ int2bv 32) 1)) rax28 ((_ int2bv 32) 1)))

;; H
  (assert (readreg32__function_guard (readreg32 (let ((subject rbx)) rbx32))
  (let ((subject rbx)) rbx32)))

;; H
  (assert (writereg32post__function_guard
  (writereg32post (let ((subject rbx)) rbx33) o188)
  (let ((subject rbx)) rbx33) o188))
...
;; H
  (assert (writereg32post__function_guard
  (writereg32post (let ((subject rdi)) rdi45) ((_ int2bv 32) 10))
  (let ((subject rdi)) rdi45) ((_ int2bv 32) 10)))
...
;; H
  (assert (= temp___595 (let ((subject rbx)) rbx29)))

;; H
  (assert (= temp___594 xmm35))
...
;; H
  (assert (= temp___591 (let ((subject rsi)) rsi6)))

;; H
  (assert (= temp___592 (let ((subject memory)) memory11)))

;; H
  (assert (= temp___589 overflowflag29))

;; H
  (assert (= temp___590 xmm25))

;; H
  (assert (= temp___597 (let ((subject memory)) memory11)))

;; H
  (assert (= temp___587 (let ((subject r13)) r132)))

;; H
  (assert (= temp___588 xmm73))

;; H
  (assert (= temp___585 signflag29))

;; H
  (assert (= temp___586 xmm15))

;; H
  (assert (= temp___584 rax24))

;; H
  (assert (= temp___582 carryflag29))

;; H
  (assert (= temp___583 xmm029))

;; H
  (assert (= temp___581 (let ((subject rbp)) rbp29)))

;; H
  (assert (= temp___578 xmm5))

;; H
  (assert (= temp___579 (let ((subject rdi)) rdi35)))

;; H
  (assert (= temp___580 (let ((subject r12)) r121)))

;; H
  (assert (= temp___577 zeroflag29))

;; H
  (assert (= temp___576 xmm4))
...
;; H
  (assert (= temp___573 (let ((subject rbx)) rbx30)))

;; H
  (assert (= temp___572 xmm36))
...
;; H
  (assert (= temp___570 (let ((subject rsi)) rsi7)))

;; H
  (assert (= temp___567 overflowflag30))

;; H
  (assert (= temp___568 xmm26))

;; H
  (assert (= temp___565 signflag30))

;; H
  (assert (= temp___566 xmm16))

;; H
  (assert (= temp___574 (let ((subject rsp)) rsp64)))

;; H
  (assert (= temp___564 rax25))

;; H
  (assert (= temp___562 carryflag30))

;; H
  (assert (= temp___563 xmm030))

;; H
  (assert (= temp___561 (let ((subject rbp)) rbp30)))

;; H
  (assert (= temp___559 (let ((subject r12)) r123)))

;; H
  (assert (= temp___560 (let ((subject rdi)) rdi36)))

;; H
  (assert (= temp___558 zeroflag30))

;; H
  (assert (= temp___557 xmm41))
...
;; H
  (assert
  (and (and (= o182 (eax rax27)) (eax__function_guard o182 rax27))
...
;; H
  (assert
  (and (and (= o184 (eax rax27)) (eax__function_guard o184 rax27))
...
;; H
  ...
  (= temp___555 (let ((subject rbx)) rbx31))))
...
;; H
  ...
  (and (not (= zeroflag32 true))
  (= (to_int5 signflag32) (to_int5 overflowflag32)))
  (= temp___552 signflag32)))

;; H
  (assert
  (=>
  (and (not (= zeroflag32 true))
  (= (to_int5 signflag32) (to_int5 overflowflag32))) (= temp___551 rax27)))
...
;; H
  ...
  (and (not (= zeroflag32 true))
  (= (to_int5 signflag32) (to_int5 overflowflag32)))
  (= temp___549 carryflag32)))

;; H
  (assert
  (=>
  (and (not (= zeroflag32 true))
  (= (to_int5 signflag32) (to_int5 overflowflag32))) (= temp___550 xmm032)))
...
;; H
  ...
  (and (not (= zeroflag32 true))
  (= (to_int5 signflag32) (to_int5 overflowflag32)))
  (= temp___548 (let ((subject rbp)) rbp32))))
...
;; H
  ...
  (and (not (= zeroflag32 true))
  (= (to_int5 signflag32) (to_int5 overflowflag32)))
  (= temp___547 (let ((subject rdi)) rdi39))))
...
;; H
  ...
  (= o186 (readmem64 (let ((subject rbp)) rbp33)
          (let ((subject memory)) memory14)))
  (readmem64__function_guard o186 (let ((subject rbp)) rbp33)
  (let ((subject memory)) memory14)))
  (and
  (and
  (and
...
;; H
  ...
  (= (to_int5 signflag32) (to_int5 overflowflag32)))
  (and
  (and (= o187 (ebx (let ((subject rbx)) rbx32))) (ebx__function_guard 
  o187 (let ((subject rbx)) rbx32)))
...
;; H
  ...
  (= (to_int5 signflag32) (to_int5 overflowflag32)))
  (and
  (and (= o189 (ebx (let ((subject rbx)) rbx33))) (ebx__function_guard 
  o189 (let ((subject rbx)) rbx33)))
...
;; H
  ...
  (= (to_int5 signflag32) (to_int5 overflowflag32)))
  (and
  (and (= o193 (ebx (let ((subject rbx)) rbx33))) (ebx__function_guard 
  o193 (let ((subject rbx)) rbx33)))
...
;; H
  ...
  (= (to_int5 signflag32) (to_int5 overflowflag32)))
  (and
  (and (= o197 (ebx (let ((subject rbx)) rbx33))) (ebx__function_guard 
  o197 (let ((subject rbx)) rbx33)))
...
;; H
  ...
  (=> (= result142 true)
  (and
  (and (= o202 (ebx (let ((subject rbx)) rbx33))) (ebx__function_guard 
  o202 (let ((subject rbx)) rbx33)))
...
;; H
  ...
  (=> (= signflag34 true)
  (and
  (and (= o201 (ebx (let ((subject rbx)) rbx33))) (ebx__function_guard 
  o201 (let ((subject rbx)) rbx33)))
...
;; WP_parameter_def
 ;; File "x86.ads", line 334, characters 0-0
  (not (= (t__content3 rsp87) (let ((subject rsp)) rsp62))))
(check-sat)
