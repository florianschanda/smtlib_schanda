...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 16777216.0)))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral4) (/ 500000000000000000000000.0 1000000000000000000000000.0))))
...
;; H
  (assert (and (le fliteral2 x) (le x fliteral3)))

;; H
  (assert (= (mk_t__ref result) (mk_t__ref y)))

;; H
  (assert (= y1 (roundToIntegral RNA1 x)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (le (sub RNE1 x fliteral4) y2)))
(check-sat)
