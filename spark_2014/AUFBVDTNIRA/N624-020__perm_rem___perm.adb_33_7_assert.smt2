...
(declare-fun perm__get_witness__result4 () int__ref)
...
(declare-fun perm__get_witness__result6 () int__ref)

(declare-fun ib6 () Int)

(declare-fun perm__get_witness__result7 () Int)
...
;; H
  (assert (forall ((ib7 Int)) (remove__function_guard (remove b ib7) b ib7)))
...
;; H
  (assert
  (forall ((ib7 Int)) (is_perm__function_guard
  (is_perm (remove a ia) (remove b ib7)) (remove a ia) (remove b ib7))))
...
;; H
  ...
  (exists ((ib7 Int))
  (and
  (and (<= (to_rep1 (first (rt b))) ib7) (<= ib7 (to_rep1 (last (rt b)))))
  (and (= (to_rep (select (elts a) ia)) (to_rep (select (elts b) ib7)))
  (= (is_perm (remove a ia) (remove b ib7)) true))))))))
...
;; H
  (assert
  (forall ((ib7 Int)) (remove__function_guard (remove o8 ib7) o8 ib7)))
...
;; H
  (assert
  (forall ((ia1 Int) (ib7 Int)) (is_perm__function_guard
  (is_perm (remove o9 ia1) (remove o8 ib7)) (remove o9 ia1) (remove o8 ib7))))
...
;; WP_parameter_def
 ;; File "perm.ads", line 3, characters 0-0
  ...
  (not
  (and
  (and (= (mk_int__ref result) (mk_int__ref ib))
  (= ib1 (to_rep1 (first (rt b)))))
  (ite (and (<= (to_rep1 (first (rt b))) ib1)
       (<= ib1 (to_rep1 (last (rt b)))))
  (and
  (and
  (and (= temp___791 ib1)
  (and
  ...
  (exists ((ib7 Int))
  (and (and (<= (to_rep1 (first o4)) ib7) (<= ib7 (to_rep1 (last o4))))
  (and (= (to_rep (select o ia1)) (to_rep (select o3 ib7)))
  (= (is_perm (remove o9 ia1) (remove o8 ib7)) true)))))))))))
  (= result1 false)))
  ...
  (= ib2 (to_rep1 (last (rt b))))))))
  (and
  (and
  (= perm__get_witness__result4 (mk_int__ref perm__get_witness__result3))
  (= ib2 ib3))
  (and (= perm__get_witness__result5 perm__get_witness__result3) (= ib4 ib2))))
  (and
  (and (= perm__get_witness__result6 perm__get_witness__result4)
  (= ib5 (mk_int__ref ib3)))
  (and (= perm__get_witness__result7 perm__get_witness__result5) (= ib6 ib4))))
  (and
  (and (= perm__get_witness__result6 (mk_int__ref perm__get_witness__result))
  (= ib5 (mk_int__ref ib1)))
  (and (= perm__get_witness__result7 perm__get_witness__result1) (= ib6 ib1))))))))
(check-sat)
