...
;; H
  (assert (and (= o5 hi2) (in_range4 hi2)))

;; H
  (assert (= (to_rep1 o6) o5))

;; H
  (assert (and (= o4 lo2) (in_range3 lo2)))
...
;; H
  (assert (= temp___157 (mk_slice_bounds o8)))

;; H
  (assert (= result4 (mk___split_fields__ref current_slice__split_fields)))

;; H
  (assert (= current_slice__split_fields1 (us_split_fields1 temp___157)))
...
;; H
  ...
  (= current_sum3 (sum__logic x
                  (mk_slice_bounds current_slice__split_fields1))))
...
;; H
  (assert
  (=> (< max_sum3 current_sum3)
  (= result____split_fields5 current_slice__split_fields1)))
...
;; H
  (assert (=> (< max_sum3 current_sum3) (= max_sum4 o9)))
...
;; H
  (assert (not (= hi2 (to_rep3 (last (rt x))))))
...
;; WP_parameter_def
 ;; File "sums.ads", line 12, characters 0-0
  ...
  (<= (sum__logic x
      (mk_slice_bounds
      (mk___split_fields (of_rep lo_index) (of_rep1 hi_index)))) max_sum4)))
(check-sat)
