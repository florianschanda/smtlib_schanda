...
(declare-fun temp___3666 () (Array Int us_rep1))
...
(declare-fun temp___3664 () (Array Int us_rep1))
...
(declare-fun temp___3665 () (Array Int us_rep1))
...
(declare-fun temp___3663 () (Array Int us_rep1))
...
;; H
  ...
  (select temp___3680 (parent
                      ...
                      t_old__split_fields2)) i2))))
  (position
  (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
  i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3680 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3680 (parent
                      (mk___rep2
...
;; H
  (assert
  (and (= o18 (to_rep1 t_old__split_fields)) (in_range3
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3680 o18))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3680 o18)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o18))
  (ite (and
       ...
       (= (parent
          (mk___rep2
          (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i2) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___3680 (parent
                              (mk___rep2
                              (mk___split_fields2 t_old__split_fields1
                              t_old__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3680 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3680 i2))) true))))))
  (and
  ...
  (= (is_add
     ...
     (position
     (mk___rep2
     (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i2)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3680 i2)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3680 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3680 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3680 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o19 (select temp___3680 l)))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
  i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3666 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3666 (parent
                      (mk___rep2
...
;; H
  (assert
  (and (= o (to_rep1 t_old__split_fields)) (in_range3
  (to_rep1 t_old__split_fields))))
...
;; H
  ...
  (model____function_guard temp___3666
  (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
  o))
  (and (dynamic_invariant8 temp___3666 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3666 o))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3666 o)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___3666 (parent
                              ...
                              t_old__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3666 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3666 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3666 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3666 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3666 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3666 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o1 (select temp___3666 i1)))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
  i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3665 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3665 (parent
                      (mk___rep2
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
  i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3664 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3664 (parent
                      (mk___rep2
...
;; H
  (assert
  (and (= o7 (to_rep1 t_old__split_fields)) (in_range3
  (to_rep1 t_old__split_fields))))
...
;; H
  ...
  (= temp___3665 (model__
                 (mk___rep2
                 (mk___split_fields2 t_old__split_fields1
                 t_old__split_fields2)) o7))
  (model____function_guard temp___3665
  (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
  o7))
  (and (dynamic_invariant8 temp___3665 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3665 o7))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3665 o7)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o7))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___3665 (parent
                              ...
                              t_old__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3665 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3665 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3665 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3665 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3665 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3665 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o8 (select temp___3665 l)))
...
;; H
  (assert
  (and (= o3 (to_rep1 t_old__split_fields)) (in_range3
  (to_rep1 t_old__split_fields))))
...
;; H
  ...
  (= temp___3664 (model__
                 (mk___rep2
                 (mk___split_fields2 t_old__split_fields1
                 t_old__split_fields2)) o3))
  (model____function_guard temp___3664
  (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
  o3))
  (and (dynamic_invariant8 temp___3664 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3664 o3))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3664 o3)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o3))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___3664 (parent
                              ...
                              t_old__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3664 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3664 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3664 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3664 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3664 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3664 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o4 (select temp___3664 i1)))
...
;; H
  (assert
  (and (= result5 (olt o6 o10))
  (= (= result5 true)
  (and (< (length o6) (length o10))
  (forall ((n Int))
  (=> (and (<= 1 n) (<= n (last o6))) (= (get o6 n) (get o10 n))))))))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
  i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3663 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3663 (parent
                      (mk___rep2
...
;; H
  (assert
  (and (= o11 (to_rep1 t_old__split_fields)) (in_range3
  (to_rep1 t_old__split_fields))))
...
;; H
  ...
  (= temp___3663 (model__
                 (mk___rep2
                 (mk___split_fields2 t_old__split_fields1
                 t_old__split_fields2)) o11))
  (model____function_guard temp___3663
  (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
  o11))
  (and (dynamic_invariant8 temp___3663 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3663 o11))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3663 o11)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o11))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___3663 (parent
                              ...
                              t_old__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3663 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3663 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3663 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3663 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3663 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3663 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o12 (select temp___3663 i1)))
...
;; H
  (assert
  (and (= o15 (length o14)) (and (in_range6 o15) (<= (+ 0 o15) 2147483647))))
