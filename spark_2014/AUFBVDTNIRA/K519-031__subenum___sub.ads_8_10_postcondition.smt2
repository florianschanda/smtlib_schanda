...
(declare-fun sub__remove_absent__result () Int)

(declare-fun result () Int)

(declare-fun sub__remove_absent__result1 () Int)

(declare-fun result1 () Int)

(declare-fun sub__remove_absent__result2 () Int)

(declare-fun sub__remove_absent__result3 () Int)

(declare-fun sub__remove_absent__result4 () Int)

(declare-fun sub__remove_absent__result5 () Int)

(declare-fun sub__remove_absent__result6 () Int)

(declare-fun sub__remove_absent__result7 () Int)

(declare-fun sub__remove_absent__result8 () Int)
