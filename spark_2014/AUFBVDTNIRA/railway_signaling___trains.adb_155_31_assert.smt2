...
(declare-fun temp___364 () (Array Int signal))

(declare-fun temp___358 () Int)

(declare-fun temp___363 () (Array Int signal))

(declare-fun temp___356 () (Array Int signal))
...
;; H
  ...
  (=> (and (<= 1 j) (<= j 8))
  (and
  (=> (= (to_rep5 (select temp___363 j)) 2)
  (= (to_rep5 (select track_signals3 j)) 2))
  (=> (= (to_rep5 (select temp___364 j)) 1)
