...
(declare-fun temp___1116 () (Array Int us_rep1))
...
(declare-fun temp___1117 () (Array Int us_rep1))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1118 o39))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1118 o39)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o39))
...
;; H
  (assert (= o40 (select temp___1118 x1)))
...
;; H
  ...
  (= temp___1117 (model__
                 ...
                 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
                 o35))
  (and (dynamic_invariant6 temp___1117 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1117 o35))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1117 o35)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o35))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1117 (parent
                              (mk___rep2
                              (let ((subject f_5__split_fields))
                              f_5__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1117 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1117 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1117 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1117 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1117 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1117 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o36 (select temp___1117 i1)))
...
;; H
  ...
  (= temp___1116 (model__
                 ...
                 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
                 o32))
  (and (dynamic_invariant6 temp___1116 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1116 o32))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1116 o32)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o32))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1116 (parent
                              (mk___rep2
                              (let ((subject f_5__split_fields))
                              f_5__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1116 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1116 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1116 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1116 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1116 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1116 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o33 (select temp___1116 i1)))
