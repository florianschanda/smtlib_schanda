...
(declare-fun temp___2034 () (Array Int us_rep1))
...
(declare-fun temp___2035 () (Array Int us_rep1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2035 (parent
                      (mk___rep2
                      (let ((subject f_5__split_fields)) f_5__split_fields2))
                      i2))))
  (position
  (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2035 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2035 (parent
                      (mk___rep2
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2034 (parent
                      (mk___rep2
                      (let ((subject f_5__split_fields)) f_5__split_fields2))
                      i2))))
  (position
  (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2034 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2034 (parent
                      (mk___rep2
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2036 o39))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2036 o39)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o39))
...
;; H
  (assert (= o40 (select temp___2036 x1)))
...
;; H
  ...
  (= temp___2035 (model__
                 ...
                 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
                 o35))
  (model____function_guard temp___2035
  (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
  o35))
  (and (dynamic_invariant6 temp___2035 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2035 o35))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2035 o35)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o35))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2035 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2035 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2035 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2035 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2035 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2035 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o36 (select temp___2035 i1)))
...
;; H
  ...
  (= temp___2034 (model__
                 ...
                 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
                 o32))
  (model____function_guard temp___2034
  (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
  o32))
  (and (dynamic_invariant6 temp___2034 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2034 o32))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2034 o32)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o32))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2034 (parent
                              ...
                              f_5__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2034 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2034 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2034 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2034 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2034 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2034 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o33 (select temp___2034 i1)))
