...
(define-fun dynamic_invariant ((temp___expr_3269 us_t1)
  ...
  (temp___do_toplevel_3268 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_3269))
                                       (and (= (first3 temp___expr_3269) 1)
                                       (= (last4 temp___expr_3269) 4)))))
...
(define-fun dynamic_invariant1 ((temp___expr_3293 us_t2)
  ...
  (temp___do_toplevel_3292 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_3293))
                                       (and (= (first5 temp___expr_3293) 1)
                                       (= (last6 temp___expr_3293) 4)))))
...
;; H
  (assert
  (and
  (and (= temp___76602 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___76602 reg)) (dynamic_invariant1
  temp___76602 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___76601)) (to_rep (last5 temp___76601)))
     (+ (- (to_rep (last5 temp___76601)) (to_rep (first4 temp___76601))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76601)) (to_rep (last5 temp___76601))) 
  temp___76611))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___76611)) (to_rep (last3 temp___76611)))
     (+ (- (to_rep (last3 temp___76611)) (to_rep (first2 temp___76611))) 1)
