...
(declare-fun temp___1459 ((_ BitVec 8) Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___1461 (_ BitVec 8)))
  (forall ((temp___1462 Int) (temp___1463 Int))
  (let ((temp___1460 (temp___1459 temp___1461 temp___1462 temp___1463)))
  (and
  (=> (dynamic_property6 1 2147483647 temp___1462 temp___1463)
  (and (= (first5 temp___1460) temp___1462)
  (= (last8 temp___1460) temp___1463)))
  (forall ((temp___1464 Int))
  (= (select (to_array2 temp___1460) temp___1464) (of_rep temp___1461))))))))

(define-fun dynamic_invariant5 ((temp___expr_874 us_t1)
  (temp___is_init_871 Bool) (temp___skip_constant_872 Bool)
  (temp___do_toplevel_873 Bool)) Bool (=>
                                      (not (= temp___skip_constant_872 true))
                                      (and (dynamic_property3 1 r122b
                                      (first3 temp___expr_874)
                                      (last5 temp___expr_874))
                                      (and (= (first3 temp___expr_874) 1)
                                      (= (last5 temp___expr_874) r122b)))))
...
(declare-fun temp___1466 () (Array Int octet))
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___1459 ((_ int2bv 8) 0) 1 r122b)))) 1))

;; H
  (assert
  (= (to_rep2 (last7 (rt2 (temp___1459 ((_ int2bv 8) 0) 1 r122b)))) r122b))

;; H
  (assert
  (= (mk___t2 temp___1466 temp___14661) (temp___1459 ((_ int2bv 8) 0) 1
                                        r122b)))
...
;; WP_parameter_def
 ;; File "aco-math-very_longs.adb", line 310, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first4 temp___14661)) (to_rep2 (last7 temp___14661)))
     (+ (- (to_rep2 (last7 temp___14661)) (to_rep2 (first4 temp___14661))) 1)
