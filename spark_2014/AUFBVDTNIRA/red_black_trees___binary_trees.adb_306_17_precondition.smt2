...
;; H
  (assert (forall ((i Int)) (parent__function_guard (parent f2 i) f2 i)))
...
;; H
  (assert (forall ((i Int)) (position__function_guard (position f2 i) f2 i)))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1621 (parent f2 i)))) (position f2 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1621 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1621 (parent f2 i)))) (position f2 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1621 i))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1620 (parent f1 i)))) (position f1 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1620 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1620 (parent f1 i)))) (position f1 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1620 i))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1617 (parent f2 i)))) (position f2 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1617 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1617 (parent f2 i)))) (position f2 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1617 i))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1614 (parent f1 i)))) (position f1 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1614 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1614 (parent f1 i)))) (position f1 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1614 i))))))
...
;; H
  (assert (=> (and (<= 1 n1) (<= n1 100)) (= temp___1646 n1)))
...
;; H
  (assert
  (=> (and (<= 1 n1) (<= n1 100))
  (=> (and (<= 1 j3) (<= j3 100)) (= temp___1623 j3))))

;; H
  (assert
  (=> (and (<= 1 n1) (<= n1 100))
  (=> (and (<= 1 j3) (<= j3 100)) (type_invariant f1))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1613 j15))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert
  (=> (and (<= 1 n1) (<= n1 100))
  (=> (and (<= 1 j3) (<= j3 100)) (= o2 (select temp___1613 j3)))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1612 j15))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert
  (=> (and (<= 1 n1) (<= n1 100))
  (=> (and (<= 1 j3) (<= j3 100)) (= o (select temp___1612 j3)))))
...
;; H
  (assert
  (=> (and (<= 1 n1) (<= n1 100))
  (=> (and (<= 1 j3) (<= j3 100)) (=> (= result2 true) (type_invariant f2)))))
...
;; H
  ...
  (ite (and (not (= (parent f2 i) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1621 (parent f2 i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1621 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1621 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1621 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1621 j15))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1621 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1621 j15)))) true))
  (= j15 i)))))))))))))))))
...
;; H
  ...
  (=> (and (<= 1 n1) (<= n1 100))
  (=> (and (<= 1 j3) (<= j3 100))
  (=> (= result2 true) (= o19 (select temp___1621 j3))))))
...
;; H
  (assert
  (=> (and (<= 1 n1) (<= n1 100))
  (=> (and (<= 1 j3) (<= j3 100)) (=> (= result2 true) (type_invariant f1)))))
...
;; H
  ...
  (ite (and (not (= (parent f1 i) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1620 (parent f1 i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1620 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1620 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1620 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1620 j15))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1620 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1620 j15)))) true))
  (= j15 i)))))))))))))))))
...
;; H
  ...
  (=> (and (<= 1 n1) (<= n1 100))
  (=> (and (<= 1 j3) (<= j3 100))
  (=> (= result2 true) (= o16 (select temp___1620 j3))))))
...
;; H
  ...
  (ite (and (not (= (parent f2 i) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1617 (parent f2 i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1617 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1617 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1617 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1617 j15))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1617 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1617 j15)))) true))
  (= j15 i)))))))))))))))))
...
;; H
  ...
  (=> (and (<= 1 n1) (<= n1 100))
  (=> (and (<= 1 j3) (<= j3 100))
  (=> (= result2 true) (= o13 (select temp___1617 o12))))))
...
;; H
  ...
  (ite (and (not (= (parent f1 i) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1614 (parent f1 i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1614 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1614 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1614 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1614 j15))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1614 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1614 j15)))) true))
  (= j15 i)))))))))))))))))
...
;; H
  ...
  (=> (and (<= 1 n1) (<= n1 100))
  (=> (and (<= 1 j3) (<= j3 100))
  (=> (= result2 true) (= o9 (select temp___1614 o8))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select o23 (parent f2 i)))) (position f2 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select o23 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select o23 (parent f2 i)))) (position f2 i)
  (rec__tree_model__path_type__a (us_split_fields1 (select o23 i))))))
...
;; H
  (assert
  (and (and (= o23 (model__ f2 root)) (model____function_guard o23 f2 root))
  (and (dynamic_invariant2 o23 true false true)
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o23 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select o23 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and (not (= (parent f2 i) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select o23 (parent f2 i)))) true))
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o23 i))) true)
  (not
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o23 i))) true))))))
  (and
  (forall ((i Int))
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select o23 (parent f2 i)))) (position f2 i)
     (rec__tree_model__path_type__a (us_split_fields1 (select o23 i)))) true)
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select o23 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o23 i))) true)
  ...
  (=>
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o23 j15))) true)
  (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o23 i)))
     (rec__tree_model__path_type__a (us_split_fields1 (select o23 j15)))) true))
  (= j15 i))))))))))))))
