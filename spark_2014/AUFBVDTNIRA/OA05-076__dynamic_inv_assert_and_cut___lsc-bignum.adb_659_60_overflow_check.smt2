...
;; H
  ...
  (= (to_rep1 (select aux33 k1)) (to_rep1
                                 (select a7 (- (+ a_first k1) aux3_first)))))
  (=> (=> (<= aux3_first k1) (not (<= k1 (- (+ aux3_first a_last) a_first))))
  (= (to_rep1 (select aux33 k1)) (to_rep1 (select aux32 k1))))))))
...
;; H
  (assert (= o58 (bvadd o57 ((_ int2bv 64) 1))))

;; H
  (assert (= o59 (bvmul o58 ((_ int2bv 64) 32))))
...
;; H
  (assert
  (and (= o52 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o52 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o51 (from_word64 i2)) (from_word64__function_guard o51 i2)))

;; H
  (assert (and (= o53 (oadd o51 o52)) (oadd__function_guard o53 o51 o52)))

;; H
  (assert
  (and (= o50 (from_integer s10)) (from_integer__function_guard o50 s10)))

;; H
  (assert (and (= o54 (ole o50 o53)) (ole__function_guard o54 o50 o53)))
...
;; H
  (assert
  (and (= o44 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o44 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o45 (oexpon o44 s10)) (oexpon__function_guard o45 o44 s10)))

;; H
  (assert
  (and (= o39 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o39 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o38 (from_integer s10)) (from_integer__function_guard o38 s10)))

;; H
  (assert
  (and (= o40 (osubtract o38 o39)) (osubtract__function_guard o40 o38 o39)))

;; H
  (assert
  (and (= o37 (from_word64 i2)) (from_word64__function_guard o37 i2)))

;; H
  (assert
  (and (= o41 (osubtract o37 o40)) (osubtract__function_guard o41 o37 o40)))

;; H
  (assert
  (and (= o36 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o36 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o42 (oexpon__2 o36 o41)) (oexpon__2__function_guard o42 o36 o41)))
...
;; H
  (assert
  (and (= o35 (num_of_big_int e e_first o34)) (num_of_big_int__function_guard
  o35 e e_first o34)))

;; H
  (assert
  (and (= o43 (odivide o35 o42)) (odivide__function_guard o43 o35 o42)))

;; H
  (assert (and (= o46 (omod o43 o45)) (omod__function_guard o46 o43 o45)))

;; H
  (assert
  (and (= o30 (from_word32 (t__content w7))) (from_word32__function_guard 
  o30 (t__content w7))))

;; H
  (assert (and (= o47 (oeq o30 o46)) (oeq__function_guard o47 o30 o46)))
...
;; H
  (assert
  (and (= o28 (num_of_big_int m m_first o27)) (num_of_big_int__function_guard
  o28 m m_first o27)))
...
;; H
  (assert
  (and (and (= o23 (base Tuple0)) (base__function_guard o23 Tuple0))
  (= o23 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o25 (oexpon o23 o24)) (oexpon__function_guard o25 o23 o24)))
...
;; H
  (assert
  (and (= o17 (num_of_big_int x x_first o16)) (num_of_big_int__function_guard
  o17 x x_first o16)))

;; H
  (assert
  (and (= o22 (oexpon o17 o21)) (oexpon__function_guard o22 o17 o21)))

;; H
  (assert
  (and (= o26 (omultiply o22 o25)) (omultiply__function_guard o26 o22 o25)))

;; H
  (assert (and (= o29 (omod o26 o28)) (omod__function_guard o29 o26 o28)))
