...
;; H
  (assert (=> (and (<= 1 n5) (<= n5 100)) (= temp___1339 n5)))
...
;; H
  (assert (=> (and (<= 1 n5) (<= n5 100)) (= o38 (select temp___1329 c95b))))
...
;; H
  (assert
  (=> (and (<= 1 n5) (<= n5 100))
  (= o40 (rec__red_black_trees__black_count__depth o39))))
...
;; H
  (assert
  (=> (and (<= 1 n5) (<= n5 100)) (= result14 (ite (<= o41 n6) true false))))
