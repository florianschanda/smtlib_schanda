...
;; H
  (assert (model_is_well_formed__function_guard
  (model_is_well_formed o22 data1 first_available1) o22 data1
  first_available1))

;; H
  (assert
  (and
  (and (= o22 (model__ data1 first_available1)) (model____function_guard 
  o22 data1 first_available1))
  (= (model_is_well_formed o22 data1 first_available1) true)))
...
;; H
  (assert (= list_mod_allocator__free__C99b__assume c99b))
...
;; H
  (assert (= list_mod_allocator__free__B100b__L_4__R101b__assume r101b))

;; H
  (assert (in_range1 r101b))
...
;; H
  (assert (<= (+ i2 1) (length c99b)))

;; H
  (assert
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 i2)) (= (get c98b j1) (get c99b (+ j1 1))))))

;; H
  (assert
  (forall ((j1 Int))
  (=> (and (<= 2 j1) (<= j1 (+ i2 1))) (= (get c98b (- j1 1)) (get c99b j1)))))

;; H
  (assert
  (and (=> (<= 1 r101b) (dynamic_property 1 r101b i2))
  (and (<= 1 i2) (<= i2 r101b))))
