...
(define-fun dynamic_invariant5 ((temp___expr_1366 t)
  (temp___is_init_1363 Bool) (temp___skip_constant_1364 Bool)
  (temp___do_toplevel_1365 Bool)) Bool (=>
                                       (or (= temp___is_init_1363 true) (le
                                       (neg fliteral1) fliteral1))
                                       (tqtisFinite temp___expr_1366)))
...
;; H
  (assert
  (and (= o2 (mul RNE2 half_x1 y2)) (tqtisFinite (mul RNE2 half_x1 y2))))

;; H
  (assert (= o3 (mul RNE2 o2 y2)))

;; H
  (assert (and (= o4 o3) (tqtisFinite o3)))

;; H
  (assert (= o5 (sub RNE2 fliteral4 o4)))

;; H
  (assert (and (= o6 o5) (tqtisFinite o5)))

;; H
  (assert (= o7 (mul RNE2 y2 o6)))
