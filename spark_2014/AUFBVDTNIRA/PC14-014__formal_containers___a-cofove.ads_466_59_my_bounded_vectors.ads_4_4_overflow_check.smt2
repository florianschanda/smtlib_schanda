...
(define-fun dynamic_invariant1 ((temp___expr_688 Int)
  ...
  (temp___do_toplevel_687 Bool)) Bool (=>
                                      (or (= temp___is_init_685 true)
...
(declare-fun my_bounded_vectors__v__vector__capacity__first__bit () Int)

(declare-fun my_bounded_vectors__v__vector__capacity__last__bit () Int)

(declare-fun my_bounded_vectors__v__vector__capacity__position () Int)

;; my_bounded_vectors__v__vector__capacity__first__bit_axiom
  (assert (<= 0 my_bounded_vectors__v__vector__capacity__first__bit))

;; my_bounded_vectors__v__vector__capacity__last__bit_axiom
  (assert
  (< my_bounded_vectors__v__vector__capacity__first__bit my_bounded_vectors__v__vector__capacity__last__bit))

;; my_bounded_vectors__v__vector__capacity__position_axiom
...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 1) true)
                                              (to_rep
                                              (rec__my_bounded_vectors__v__vector__capacity
                                              (us_split_discrs1 container)))
                                              2147483647))

(declare-fun capacity__function_guard (Int us_rep) Bool)

(define-fun dynamic_invariant2 ((temp___expr_700 Int)
  (temp___is_init_697 Bool) (temp___skip_constant_698 Bool)
  (temp___do_toplevel_699 Bool)) Bool (=>
...
;; H
  ...
  (= o (ite (= (of_int 1) true)
       (to_rep
       (rec__my_bounded_vectors__v__vector__capacity container__split_discrs))
       2147483647)))))
