...
;; H
  (assert
  (and (= o (iter_has_element temp___988 temp___987))
  (= (= o true) (and (<= 1 temp___987) (<= temp___987 (last temp___988))))))

;; H
  (assert (= (= o1 true) (in_range5 temp___987)))
...
;; H
  (assert (and (= k (get1 temp___988 temp___987)) (in_range6 k)))
