...
(define-fun bool_eq5 ((a (Array Int (Array Int (Array Int et1))))
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq4 (select a temp___idx_134) 5 50
...
(declare-fun temp___2130 ((Array Int (Array Int (Array Int et1))) Int
  (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))

;; def_axiom
  (assert
  (forall ((temp___2132 (Array Int (Array Int (Array Int et1)))))
  (forall ((temp___2133 Int))
  (forall ((temp___2134 (Array Int (Array Int et1))))
  (let ((temp___2131 (temp___2130 temp___2132 temp___2133 temp___2134)))
  (forall ((temp___2135 Int))
  (ite (= temp___2135 temp___2133)
  (= (select temp___2131 temp___2135) temp___2134)
  (= (select temp___2131 temp___2135) (select temp___2132 temp___2135)))))))))

(declare-fun temp___2136 ((Array Int (Array Int et1)) Int (Array Int et1) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___2138 (Array Int (Array Int et1))))
  (forall ((temp___2139 Int) (temp___2141 Int))
  (forall ((temp___2140 (Array Int et1)) (temp___2142 (Array Int et1)))
  (let ((temp___2137 (temp___2136 temp___2138 temp___2139 temp___2140
                     temp___2141 temp___2142)))
  (forall ((temp___2143 Int))
  (ite (= temp___2143 temp___2141)
  (= (select temp___2137 temp___2143) temp___2142)
  (ite (= temp___2143 temp___2139)
  (= (select temp___2137 temp___2143) temp___2140)
  (= (select temp___2137 temp___2143) (select temp___2138 temp___2143))))))))))

(declare-fun temp___2146 ((Array Int (Array Int (Array Int et1))) Int
  (Array Int (Array Int et1)) Int
  (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))

;; def_axiom
  (assert
  (forall ((temp___2148 (Array Int (Array Int (Array Int et1)))))
  (forall ((temp___2149 Int) (temp___2151 Int))
  (forall ((temp___2150 (Array Int (Array Int et1)))
  (temp___2152 (Array Int (Array Int et1))))
  (let ((temp___2147 (temp___2146 temp___2148 temp___2149 temp___2150
                     temp___2151 temp___2152)))
  (forall ((temp___2153 Int))
  (ite (= temp___2153 temp___2151)
  (= (select temp___2147 temp___2153) temp___2152)
  (ite (= temp___2153 temp___2149)
  (= (select temp___2147 temp___2153) temp___2150)
  (= (select temp___2147 temp___2153) (select temp___2148 temp___2153))))))))))

(declare-fun temp___2154 ((Array Int (Array Int et1)) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___2156 (Array Int (Array Int et1))))
  (forall ((temp___2157 Int))
  (forall ((temp___2158 (Array Int et1)))
  (let ((temp___2155 (temp___2154 temp___2156 temp___2157 temp___2158)))
  (forall ((temp___2159 Int))
  (ite (= temp___2159 temp___2157)
  (= (select temp___2155 temp___2159) temp___2158)
  (= (select temp___2155 temp___2159) (select temp___2156 temp___2159)))))))))

(declare-fun temp___2161 ((Array Int (Array Int et1)) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___2163 (Array Int (Array Int et1))))
  (forall ((temp___2164 Int))
  (forall ((temp___2165 (Array Int et1)))
  (let ((temp___2162 (temp___2161 temp___2163 temp___2164 temp___2165)))
  (forall ((temp___2166 Int))
  (ite (= temp___2166 temp___2164)
  (= (select temp___2162 temp___2166) temp___2165)
  (= (select temp___2162 temp___2166) (select temp___2163 temp___2166)))))))))
...
;; H
  (assert (= a1 (store a i1 (store (select a i1) j1 b))))

;; H
  (assert (= result1 a1))

;; H
  (assert (= a2 (store a1 i2 (store (select a1 i2) j2 c))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 541, characters 0-0
  (not
  (= (bool_eq5 a3 1 16
     (temp___2146 a i1 (temp___2154 (select a i1) j1 b) i2
     (temp___2161 (select a i2) j2 c)) 1 16) true)))
(check-sat)
