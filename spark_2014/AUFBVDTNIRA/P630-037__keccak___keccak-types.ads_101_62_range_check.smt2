...
(declare-fun dummy1 () unsigned_1)

(declare-datatypes ()
((unsigned_1__ref (mk_unsigned_1__ref (unsigned_1__content unsigned_1)))))
(define-fun unsigned_1__ref___projection ((a unsigned_1__ref)) unsigned_1 
...
(assert
;; WP_parameter_def
 ;; File "keccak-types.ads", line 39, characters 0-0
  (not (in_range1 o1)))
(check-sat)
