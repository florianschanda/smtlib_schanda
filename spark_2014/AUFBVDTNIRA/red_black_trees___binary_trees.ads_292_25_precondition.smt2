...
;; H
  (assert (= o55 (select temp___1221 j)))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o51))
  (and (dynamic_invariant3 temp___1220 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1220 o51))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1220 o51)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o51))
...
;; H
  (assert (= o52 (select temp___1220 j)))
...
;; H
  ...
  (select temp___1217 (parent
                      ...
                      (us_split_fields__content2 f__split_fields7)) i1))))
  (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1217 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1217 (parent
                      (mk___rep2
...
;; H
  ...
  temp___1218) (mk___rep2 (us_split_fields__content2 f__split_fields7))
  temp___1218))
...
;; H
  ...
  (= temp___1217 (model__
                 (mk___rep2 (us_split_fields__content2 f__split_fields7))
                 root))
  (model____function_guard temp___1217
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) root))
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1217 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (= temp___1218 (peek
                 (mk___rep2 (us_split_fields__content2 f__split_fields7)) 
                 i d))
  (peek__function_guard temp___1218
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d))
  (and (in_range2 temp___1218)
  (and
  (= temp___1218 (ite (= d 0)
                 (to_rep
                 (rec__binary_trees__cell__left
...
;; H
  (assert (and (<= 1 temp___1218) (<= temp___1218 100)))

;; H
  (assert (= o46 temp___1218))

;; H
  (assert (= o47 (select temp___1217 o46)))
