...
(declare-fun temp___1417 () (Array Int octet))

(declare-fun temp___14171 () t2)

(declare-fun temp___1418 () (Array Int octet))

(declare-fun temp___14181 () t1)

(declare-fun temp___1420 () (Array Int octet))

(declare-fun temp___14201 () t1)
...
(declare-fun temp___1422 () digit_index_type)

(declare-fun temp___14221 () (Array Int octet))

(declare-fun temp___14222 () t)

(declare-fun temp___1434 () (_ BitVec 16))

(declare-fun temp___1431 () digit_index_type)

(declare-fun temp___14311 () (Array Int octet))

(declare-fun temp___14312 () t)

(declare-fun temp___1430 () (_ BitVec 16))

(declare-fun temp___1429 () (_ BitVec 16))

(declare-fun temp___1428 () (_ BitVec 16))
...
(declare-fun temp___1427 () us_rep)
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___1410 ((_ int2bv 8) 0) 1 r19b)))) 1))

;; H
  (assert
  (= (to_rep2 (last7 (rt2 (temp___1410 ((_ int2bv 8) 0) 1 r19b)))) r19b))

;; H
  (assert
  (= (mk___t2 temp___1417 temp___14171) (temp___1410 ((_ int2bv 8) 0) 1 r19b)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___14171)) (to_rep2 (last7 temp___14171)))
     (+ (- (to_rep2 (last7 temp___14171)) (to_rep2 (first4 temp___14171))) 1)
     0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0)))

;; H
  (assert (= temp___1417 temp___1418))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___14171)) (to_rep2 (last7 temp___14171))) 
  temp___14181))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___14181)) (to_rep2 (last4 temp___14181)))
     (+ (- (to_rep2 (last4 temp___14181)) (to_rep2 (first2 temp___14181))) 1)
...
;; H
  (assert
  (= (mk___t1 temp___1420 temp___14201) (mk___t1 temp___1418 temp___14181)))

;; H
  (assert (= temp___1420 o))

;; H
  (assert
  (= (mk (to_rep2 (first2 temp___14201)) (to_rep2 (last4 temp___14201))) 
  o1))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___1422)))

;; H
  (assert (= temp___14221 o2))

;; H
  (assert (= temp___14222 o3))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___14221 temp___14222))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (and (= result____split_discrs (mk___split_discrs temp___1431))
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___14311 temp___14312))))))
...
;; H
  ...
  (and
  (= (rec__aco__math__very_longs__very_long__octet_length
     result____split_discrs) temp___1431)
  ...
  (<= (to_rep2
      ...
      (rt
      (rec__aco__math__very_longs__very_long__long_digits
      result____split_fields3)))) temp___1433)
  (<= temp___1433 (to_rep2
                  (last1
                  (rt
                  (rec__aco__math__very_longs__very_long__long_digits
  ...
  (= (select (elts
             (rec__aco__math__very_longs__very_long__long_digits
             result____split_fields3)) temp___1433) (select temp___14311 temp___1433)))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last1
         (rt
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (and (= o12 (takelsb_from16 difference3)) (takelsb_from16__function_guard
  o12 difference3))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= temp___1427 (mk___rep result____split_discrs o17))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= result____split_fields4 (us_split_fields1 temp___1427))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= result____split_discrs (us_split_discrs1 temp___1427))))
