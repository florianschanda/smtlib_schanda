...
(define-fun bool_eq7 ((a (Array Int natural)) (a__first Int) (a__last Int)
...
(declare-fun dummy7 () (Array Int natural))
...
(define-fun us_split_fields_Root__projection ((a us_split_fields4)) extended_index_type 
  (rec__search_trees__search_tree__root a))

(define-fun us_split_fields_Struct__projection ((a us_split_fields4)) us_rep1 
  (rec__search_trees__search_tree__struct a))

(define-fun us_split_fields_Values__projection ((a us_split_fields4)) (Array Int natural) 
...
(declare-datatypes ()
((search_tree__ref (mk_search_tree__ref (search_tree__content us_rep2)))))
(define-fun search_tree__ref___projection ((a search_tree__ref)) us_rep2 
...
(define-fun dynamic_invariant ((temp___expr_157 Int)
...
(declare-fun ordered_leafs__function_guard (Bool us_rep1 Int
...
;; temp___result_571_def
  (assert
  (forall ((temp___568 us_rep2)) (size__function_guard
  (size
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___568)))
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___568)))))

;; temp___result_569_def
  (assert
  (forall ((temp___568 us_rep2)) (valid_root__function_guard
  (valid_root
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___568))
  (to_rep
  (rec__search_trees__search_tree__root (us_split_fields5 temp___568))))
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___568))
  (to_rep
  (rec__search_trees__search_tree__root (us_split_fields5 temp___568))))))
...
;; temp___result_570_def
  (assert
  (forall ((temp___568 us_rep2)) (ordered_leafs__function_guard
  (ordered_leafs
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___568))
  (to_rep
  (rec__search_trees__search_tree__root (us_split_fields5 temp___568)))
  (rec__search_trees__search_tree__values (us_split_fields5 temp___568)))
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___568))
  (to_rep
  (rec__search_trees__search_tree__root (us_split_fields5 temp___568)))
  (rec__search_trees__search_tree__values (us_split_fields5 temp___568)))))
...
;; temp___result_573_def
  (assert
  (forall ((temp___572 us_rep1)) (tree_structure__function_guard
  (tree_structure temp___572) temp___572)))

(define-fun dynamic_invariant2 ((temp___expr_567 us_rep2)
  ...
  (temp___do_toplevel_566 Bool)) Bool (and
                                      ...
                                      (= (to_rep
                                         (rec__search_trees__search_tree__root
                                         (us_split_fields5 temp___expr_567))) 0)
                                      (and
                                      (and
                                      (not
                                      (= (to_rep
                                      ...
                                      (= (valid_root
                                         (rec__search_trees__search_tree__struct
                                         (us_split_fields5 temp___expr_567))
                                         (to_rep
                                         (rec__search_trees__search_tree__root
                                         (us_split_fields5 temp___expr_567)))) true))
                                      (= (ordered_leafs
                                         (rec__search_trees__search_tree__struct
                                         (us_split_fields5 temp___expr_567))
                                         (to_rep
...
;; temp___result_583_def
  (assert
  (forall ((temp___582 us_rep1)) (size__function_guard (size temp___582)
  temp___582)))

;; temp___result_589_def
  (assert
  (forall ((temp___588 us_rep2)) (size__function_guard1 (size1 temp___588)
  temp___588)))

(define-fun default_initial_assumption ((temp___expr_576 us_rep2)
  (temp___skip_top_level_577 Bool)) Bool (and
                                         ...
                                         (= (size1 temp___expr_576) 0))))

;; temp___result_594_def
  (assert
  (forall ((temp___591 us_rep2)) (size__function_guard
  (size
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___591)))
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___591)))))

;; temp___result_592_def
  (assert
  (forall ((temp___591 us_rep2)) (valid_root__function_guard
  (valid_root
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___591))
  (to_rep
  (rec__search_trees__search_tree__root (us_split_fields5 temp___591))))
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___591))
  (to_rep
  (rec__search_trees__search_tree__root (us_split_fields5 temp___591))))))
...
;; temp___result_593_def
  (assert
  (forall ((temp___591 us_rep2)) (ordered_leafs__function_guard
  (ordered_leafs
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___591))
  (to_rep
  (rec__search_trees__search_tree__root (us_split_fields5 temp___591)))
  (rec__search_trees__search_tree__values (us_split_fields5 temp___591)))
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___591))
  (to_rep
  (rec__search_trees__search_tree__root (us_split_fields5 temp___591)))
  (rec__search_trees__search_tree__values (us_split_fields5 temp___591)))))

(define-fun type_invariant ((temp___590 us_rep2)) Bool (ite (= (size
                                                               (rec__search_trees__search_tree__struct
                                                               (us_split_fields5
                                                               temp___590))) 0)
                                                       (= (to_rep
...
;; parent__post_axiom
  ...
  (forall ((i Int))
  (! (=>
     (and (dynamic_invariant2 t true true true) (dynamic_invariant i true
     true true))
...
;; parent__def_axiom
  ...
  (! (=>
     ...
     (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 t))
     i) (rec__search_trees__search_tree__struct (us_split_fields5 t)) i)
     (= (parent t i) (parent1
                     (rec__search_trees__search_tree__struct
                     (us_split_fields5 t)) i)))) :pattern ((parent t i)) ))))
...
(declare-fun user_eq9 (color_type color_type) Bool)

(declare-fun dummy9 () color_type)
...
(declare-datatypes ()
((map__ref2 (mk_map__ref2 (map__content2 (Array Int color_type))))))
...
(declare-fun concat3 ((Array Int color_type) Int Int (Array Int color_type)
...
(define-fun bool_eq10 ((a (Array Int color_type)) (a__first Int)
...
(declare-fun dummy10 () (Array Int color_type))

(declare-fun value__size5 () Int)

(declare-fun object__size5 ((Array Int color_type)) Int)
...
(declare-fun object__alignment5 ((Array Int color_type)) Int)

;; value__size_axiom
  (assert (<= 0 value__size5))

;; object__size_axiom
  (assert (forall ((a (Array Int color_type))) (<= 0 (object__size5 a))))
...
;; object__alignment_axiom
  (assert
  (forall ((a (Array Int color_type))) (<= 0 (object__alignment5 a))))

(declare-fun user_eq10 ((Array Int color_type) (Array Int color_type)) Bool)

(declare-datatypes ()
((us_split_fields6
 (mk___split_fields3
 (rec__red_black_trees__rbt__struct us_rep2)(rec__red_black_trees__rbt__color (Array Int color_type))))))
(define-fun us_split_fields_Struct2__projection ((a us_split_fields6)) us_rep2 
  (rec__red_black_trees__rbt__struct a))

(define-fun us_split_fields_Color__projection ((a us_split_fields6)) (Array Int color_type) 
...
(define-fun us_split_fields__ref_5__projection ((a us_split_fields__ref3)) us_split_fields6 
...
(declare-datatypes () ((rbt__ref (mk_rbt__ref (rbt__content us_rep3)))))
(define-fun rbt__ref___projection ((a rbt__ref)) us_rep3 (rbt__content a))

(declare-fun invariant__ (us_rep3) Bool)

(declare-fun invariant____function_guard (Bool us_rep3) Bool)
...
;; temp___result_909_def
  (assert
  (forall ((temp___906 us_rep2)) (size__function_guard
  (size
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___906)))
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___906)))))

;; temp___result_907_def
  (assert
  (forall ((temp___906 us_rep2)) (valid_root__function_guard
  (valid_root
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___906))
  (to_rep
  (rec__search_trees__search_tree__root (us_split_fields5 temp___906))))
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___906))
  (to_rep
  (rec__search_trees__search_tree__root (us_split_fields5 temp___906))))))
...
;; temp___result_908_def
  (assert
  (forall ((temp___906 us_rep2)) (ordered_leafs__function_guard
  (ordered_leafs
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___906))
  (to_rep
  (rec__search_trees__search_tree__root (us_split_fields5 temp___906)))
  (rec__search_trees__search_tree__values (us_split_fields5 temp___906)))
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___906))
  (to_rep
  (rec__search_trees__search_tree__root (us_split_fields5 temp___906)))
  (rec__search_trees__search_tree__values (us_split_fields5 temp___906)))))
...
;; temp___result_911_def
  (assert
  (forall ((temp___910 us_rep1)) (tree_structure__function_guard
  (tree_structure temp___910) temp___910)))

(define-fun dynamic_invariant3 ((temp___expr_905 us_rep3)
  ...
  (temp___do_toplevel_904 Bool)) Bool (and
                                      ...
                                      (= (valid_root
                                         (rec__search_trees__search_tree__struct
                                         (us_split_fields5 temp___906))
                                         (to_rep
                                         (rec__search_trees__search_tree__root
                                         (us_split_fields5 temp___906)))) true))
                                      (= (ordered_leafs
                                         (rec__search_trees__search_tree__struct
                                         (us_split_fields5 temp___906))
                                         (to_rep
                                      ...
                                      (= (tree_structure
                                         ...
                                         (us_split_fields5
                                         (rec__red_black_trees__rbt__struct
                                         (us_split_fields7 temp___expr_905))))) true)))

;; temp___result_923_def
  (assert
  (forall ((temp___922 us_rep1)) (size__function_guard (size temp___922)
  temp___922)))

;; temp___result_925_def
  (assert
  (forall ((temp___924 us_rep2)) (size__function_guard1 (size1 temp___924)
  temp___924)))

(define-fun default_initial_assumption1 ((temp___expr_915 us_rep3)
...
;; temp___result_933_def
  (assert
  (forall ((temp___932 us_rep3)) (invariant____function_guard
  (invariant__ temp___932) temp___932)))

(define-fun type_invariant1 ((temp___931 us_rep3)) Bool (= (invariant__
                                                           temp___931) true))
...
(declare-fun bool_eq12 (us_rep4 us_rep4) Bool)
...
(define-fun us_split_fields_A__projection ((a us_split_fields8)) us_rep4 
  (rec__tree_model__path_type__a a))

(define-fun us_split_fields_K__projection ((a us_split_fields8)) Bool 
  (rec__tree_model__path_type__k a))

(declare-datatypes ()
((us_split_fields__ref4
 (mk___split_fields__ref4 (us_split_fields__content4 us_split_fields8)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref4)) us_split_fields8 
  (us_split_fields__content4 a))

(declare-datatypes ()
((us_rep5 (mk___rep4 (us_split_fields9 us_split_fields8)))))
(define-fun us_rep___projection ((a us_rep5)) us_split_fields8 (us_split_fields9
                                                               a))

(define-fun bool_eq13 ((a us_rep5)
  (b us_rep5)) Bool (ite (and
                         ...
                         (= (rec__tree_model__path_type__k
                            (us_split_fields9 a)) (rec__tree_model__path_type__k
                                                  (us_split_fields9 b))))
                    true false))
...
(declare-datatypes ()
((path_type__ref (mk_path_type__ref (path_type__content us_rep5)))))
(define-fun path_type__ref___projection ((a path_type__ref)) us_rep5 
  (path_type__content a))

(declare-datatypes ()
((map__ref3 (mk_map__ref3 (map__content3 (Array Int us_rep5))))))
(declare-fun slide3 ((Array Int us_rep5) Int Int) (Array Int us_rep5))

;; slide_eq
  (assert
  (forall ((a (Array Int us_rep5)))
  (forall ((first Int))
...
(declare-fun concat4 ((Array Int us_rep5) Int Int (Array Int us_rep5) Int
  Int) (Array Int us_rep5))

;; concat_def
  (assert
  (forall ((a (Array Int us_rep5)) (b (Array Int us_rep5)))
  (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int))
  (forall ((i Int))
  (! (and
     (=> (and (<= a_first i) (<= i a_last))
...
(define-fun bool_eq14 ((a (Array Int us_rep5)) (a__first Int) (a__last Int)
  (b (Array Int us_rep5)) (b__first Int)
  (b__last Int)) Bool (ite (and
                           (ite (<= a__first a__last)
                           (and (<= b__first b__last)
                           (= (- a__last a__first) (- b__last b__first)))
                           ...
                           (= (bool_eq13 (select a temp___idx_132)
...
(declare-fun model__ (us_rep2) (Array Int us_rep5))

(declare-fun model____function_guard ((Array Int us_rep5) us_rep2) Bool)

(declare-fun same_nb_blacks (us_rep3) Bool)

(declare-fun same_nb_blacks__function_guard (Bool us_rep3) Bool)
...
(define-fun bool_eq16 ((a (Array Int us_rep6)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq15 (select a temp___idx_136)
...
(declare-fun nb_blacks__function_guard ((Array Int us_rep6) us_rep3) Bool)
...
;; same_nb_blacks__def_axiom
  ...
  (! (=> (same_nb_blacks__function_guard (same_nb_blacks t) t)
     ...
     (size1 (rec__red_black_trees__rbt__struct (us_split_fields7 t)))
     (rec__red_black_trees__rbt__struct (us_split_fields7 t)))
     (and (model____function_guard
     (model__ (rec__red_black_trees__rbt__struct (us_split_fields7 t)))
     (rec__red_black_trees__rbt__struct (us_split_fields7 t)))
     (and (nb_blacks__function_guard (nb_blacks t) t)
     (= (= (same_nb_blacks t) true)
     (or
     (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields7 t))) 0)
     (forall ((i Int))
     (=> (and (<= 1 i) (<= i 100))
     (=>
     (= (rec__tree_model__path_type__k
...
;; nb_blacks__post_axiom
  ...
  (forall ((t1 us_rep3))
  (! (and (size__function_guard1
     (size1 (rec__red_black_trees__rbt__struct (us_split_fields7 t1)))
     (rec__red_black_trees__rbt__struct (us_split_fields7 t1)))
     (=>
     (and (dynamic_invariant3 t1 true true true)
     (not
     (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields7 t1))) 0)))
     (let ((result (nb_blacks t1)))
     (and (model____function_guard
     (model__ (rec__red_black_trees__rbt__struct (us_split_fields7 t1)))
     (rec__red_black_trees__rbt__struct (us_split_fields7 t1)))
     (and
     (forall ((i Int)) (peek__function_guard
     (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 0)
     (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 0))
     (and
     (forall ((i Int)) (peek__function_guard
     (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 1)
     (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 1))
     (and
     (forall ((i Int)) (peek__function_guard
     (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 0)
     (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 0))
     ...
     (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 0)
     (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i 0))
     (=> (nb_blacks__function_guard result t1)
     (and
     (= (bool_eq15 (select result 0)
     ...
     (= (to_rep
        ...
        (select result (peek
                       (rec__red_black_trees__rbt__struct
                       (us_split_fields7 t1)) i 0))))) (to_rep
                                                       (rec__red_black_trees__black_count__count
                                                       (us_split_fields11
                                                       (select result 
                                                       (peek
...
;; invariant____def_axiom
  (assert
  (forall ((t1 us_rep3))
  (! (=> (invariant____function_guard (invariant__ t1) t1)
     (and
     (forall ((i Int)) (parent__function_guard
     (parent (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i)
     (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i))
     (and
     (forall ((i Int)) (parent__function_guard
     (parent (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i)
     (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i))
     (and (same_nb_blacks__function_guard (same_nb_blacks t1) t1)
     (= (= (invariant__ t1) true)
     (and
     (forall ((i Int))
     (=> (and (<= 1 i) (<= i 100))
     (=>
     (or
     (= (parent (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i) 0)
     (= (to_rep3
...
(define-fun dynamic_invariant8 ((temp___expr_212 us_rep5)
  ...
  (temp___do_toplevel_211 Bool)) Bool (=> (= temp___do_toplevel_211 true)
                                      ...
                                      (< (length
                                         (rec__tree_model__path_type__a
                                         (us_split_fields9 temp___expr_212))) 100))))

(define-fun default_initial_assumption2 ((temp___expr_214 us_rep5)
...
(define-fun dynamic_predicate ((temp___218 us_rep5)) Bool (< (length
                                                             (rec__tree_model__path_type__a
                                                             (us_split_fields9
                                                             temp___218))) 100))

(define-fun dynamic_invariant9 ((temp___expr_223 (Array Int us_rep5))
...
(define-fun default_initial_assumption3 ((temp___expr_226 (Array Int us_rep5))
...
(define-fun oeq ((left us_rep4)
  (right us_rep4)) Bool (and (= (length left) (length right)) (ite (forall
                                                                   ((n Int))
                                                                   (=>
                                                                   (and
                                                                   (<= 1 n)
...
(define-fun default_initial_assumption4 ((temp___expr_206 us_rep4)
  (temp___skip_top_level_207 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_207 true))
                                         (= (length temp___expr_206) 0)))

(define-fun olt ((left us_rep4)
  (right us_rep4)) Bool (and (< (length left) (length right)) (ite (forall
                                                                   ((n Int))
                                                                   (=>
                                                                   (and
...
;; size__post_axiom
  (assert
  (forall ((t1 us_rep2))
  (! (=> (dynamic_invariant2 t1 true true true)
     (let ((result (size1 t1)))
     (=> (size__function_guard1 result t1) (dynamic_invariant1 result true
     false true)))) :pattern ((size1 t1)) )))

;; size__def_axiom
  (assert
  (forall ((t1 us_rep2))
  (! (=>
     (and (dynamic_invariant2 t1 true true true) (size__function_guard1
     (size1 t1) t1))
     (and (size__function_guard
     (size (rec__search_trees__search_tree__struct (us_split_fields5 t1)))
     (rec__search_trees__search_tree__struct (us_split_fields5 t1)))
     (= (size1 t1) (size
                   (rec__search_trees__search_tree__struct
                   (us_split_fields5 t1)))))) :pattern ((size1 t1)) )))

(declare-fun model__1 (us_rep1 Int) (Array Int us_rep5))

(declare-fun model____function_guard1 ((Array Int us_rep5) us_rep1 Int) Bool)

;; model____post_axiom
  (assert
  (forall ((t1 us_rep2))
  (! (and (size__function_guard1 (size1 t1) t1)
     (=> (and (dynamic_invariant2 t1 true true true) (not (= (size1 t1) 0)))
     (let ((result (model__ t1)))
     (=> (model____function_guard result t1) (dynamic_invariant9 result true
     false true))))) :pattern ((model__ t1)) )))

;; model____def_axiom
  (assert
  (forall ((t1 us_rep2))
  (! (=>
     (and (dynamic_invariant2 t1 true true true) (model____function_guard
     (model__ t1) t1))
     (and (model____function_guard1
     (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 t1))
     (to_rep (rec__search_trees__search_tree__root (us_split_fields5 t1))))
     (rec__search_trees__search_tree__struct (us_split_fields5 t1))
     (to_rep (rec__search_trees__search_tree__root (us_split_fields5 t1))))
     (= (model__ t1) (model__1
                     (rec__search_trees__search_tree__struct
                     ...
                     (to_rep
                     (rec__search_trees__search_tree__root
                     (us_split_fields5 t1))))))) :pattern ((model__ t1)) )))
...
;; peek__post_axiom
  ...
  (forall ((i Int) (d Int))
  (! (and (size__function_guard1 (size1 t1) t1)
     (and (model____function_guard (model__ t1) t1)
     (=>
     (and
     (and
     (and (dynamic_invariant2 t1 true true true) (dynamic_invariant i true
     true true)) (dynamic_invariant7 d true true true))
     (and (not (= (size1 t1) 0))
     (= (rec__tree_model__path_type__k
        (us_split_fields9
        (let ((temp___640 (model__ t1))) (select temp___640 i)))) true)))
     (let ((result (peek t1 i d)))
     (=> (peek__function_guard result t1 i d) (dynamic_invariant1 result true
     false true)))))) :pattern ((peek t1 i d)) ))))
...
;; peek__def_axiom
  ...
  (! (=>
     ...
     (and
     (and (dynamic_invariant2 t1 true true true) (dynamic_invariant i true
     true true)) (dynamic_invariant7 d true true true)) (peek__function_guard
     (peek t1 i d) t1 i d))
     (and (peek__function_guard1
     (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 t1)) i
     d) (rec__search_trees__search_tree__struct (us_split_fields5 t1)) i d)
     (= (peek t1 i d) (peek1
                      (rec__search_trees__search_tree__struct
                      (us_split_fields5 t1)) i d)))) :pattern ((peek t1 i d)) ))))

;; temp___result_288_def
  (assert
  (forall ((temp___287 us_rep1)) (tree_structure__function_guard
  (tree_structure temp___287) temp___287)))

(define-fun dynamic_invariant11 ((temp___expr_286 us_rep1)
...
;; temp___result_296_def
  (assert
  (forall ((temp___295 us_rep1)) (size__function_guard (size temp___295)
  temp___295)))

(define-fun default_initial_assumption5 ((temp___expr_290 us_rep1)
  (temp___skip_top_level_291 Bool)) Bool (and
                                         ...
                                         (= (size temp___expr_290) 0))))

;; temp___result_299_def
  (assert
  (forall ((temp___298 us_rep1)) (tree_structure__function_guard
  (tree_structure temp___298) temp___298)))

(define-fun type_invariant2 ((temp___297 us_rep1)) Bool (= (tree_structure
                                                           temp___297) true))
...
;; valid_root__post_axiom
  ...
  (forall ((i Int))
  (! (=>
     (and (dynamic_invariant11 f true true true) (dynamic_invariant i true
     true true))
...
;; position__post_axiom
  ...
  (! (and (parent__function_guard1 (parent1 f i) f i)
     ...
     (=> (position__function_guard result f i) (dynamic_invariant7 result
...
;; model____post_axiom
  ...
  (! (and (valid_root__function_guard (valid_root f root) f root)
     (=>
     (and
     (and (dynamic_invariant11 f true true true) (dynamic_invariant root true
     ...
     (is_add
     (rec__tree_model__path_type__a
     (us_split_fields9 (select result (parent1 f i)))) (position f i)
     (rec__tree_model__path_type__a (us_split_fields9 (select result i))))
     (rec__tree_model__path_type__a
     (us_split_fields9 (select result (parent1 f i)))) (position f i)
     (rec__tree_model__path_type__a (us_split_fields9 (select result i)))))
     (=> (model____function_guard1 result f root)
     (and
     (and
     (= (rec__tree_model__path_type__k
        (us_split_fields9 (select result root))) true)
     (and
     (= (length
        (rec__tree_model__path_type__a
        (us_split_fields9 (select result root)))) 0)
     (and
     (forall ((i Int))
     (=> (and (<= 1 i) (<= i 100))
     (=> (not (= i root))
     (ite (and (not (= (parent1 f i) 0))
          (= (rec__tree_model__path_type__k
             (us_split_fields9 (select result (parent1 f i)))) true))
     (= (rec__tree_model__path_type__k (us_split_fields9 (select result i))) true)
     (not
     (= (rec__tree_model__path_type__k (us_split_fields9 (select result i))) true))))))
     (and
     (forall ((i Int))
     ...
     (= (is_add
        (rec__tree_model__path_type__a
        (us_split_fields9 (select result (parent1 f i)))) (position f i)
        (rec__tree_model__path_type__a (us_split_fields9 (select result i)))) true)
     (= (length
        (rec__tree_model__path_type__a (us_split_fields9 (select result i)))) 0))))
     (forall ((i Int))
     (=> (and (<= 1 i) (<= i 100))
     (=>
     (= (rec__tree_model__path_type__k (us_split_fields9 (select result i))) true)
     ...
     (=>
     (and
     (= (rec__tree_model__path_type__k (us_split_fields9 (select result j))) true)
     (= (oeq
        (rec__tree_model__path_type__a (us_split_fields9 (select result i)))
        (rec__tree_model__path_type__a (us_split_fields9 (select result j)))) true))
     (= j i))))))))))) (dynamic_invariant9 result true false true))))))))))))) :pattern (
  (model__1 f root)) ))))

(define-fun default_initial_assumption6 ((temp___expr_272 us_rep)
...
(define-fun default_initial_assumption7 ((temp___expr_279 (Array Int us_rep))
...
(declare-fun dummy18 () element_type)
...
;; H
  (assert (dynamic_invariant3 t true false true))
...
;; H
  (assert (nb_blacks__function_guard (nb_blacks t) t))

;; H
  (assert
  (and (and (= o1 (same_nb_blacks t)) (same_nb_blacks__function_guard o1 t))
  (= (= o1 true)
  (or (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields7 t))) 0)
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
     (us_split_fields9
     (select (model__
             (rec__red_black_trees__rbt__struct (us_split_fields7 t))) i1))) true)
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select (nb_blacks t) i1))) true))))))))
...
;; H
  ...
  (parent1
  (rec__search_trees__search_tree__struct
  (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields7 t))))
  i)
  (rec__search_trees__search_tree__struct
  (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields7 t))))
  i))
...
;; H
  ...
  (and
  (and
  (= o (parent (rec__red_black_trees__rbt__struct (us_split_fields7 t)) i))
  (parent__function_guard o
  (rec__red_black_trees__rbt__struct (us_split_fields7 t)) i))
  (and (in_range2 o)
  (and
  (= o (parent1
       (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= temp___1751 (parent
                 (rec__red_black_trees__rbt__struct (us_split_fields7 t)) 
                 i))
  (parent__function_guard temp___1751
  (rec__red_black_trees__rbt__struct (us_split_fields7 t)) i))
  (and (in_range2 temp___1751)
  (and
  (= temp___1751 (parent1
                 (rec__search_trees__search_tree__struct
                 (us_split_fields5
...
(assert
;; WP_parameter_def
 ;; File "red_black_trees.ads", line 47, characters 0-0
  (not (<= 1 temp___1751)))
(check-sat)
