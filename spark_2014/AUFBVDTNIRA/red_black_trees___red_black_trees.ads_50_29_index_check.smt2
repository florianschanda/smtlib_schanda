...
(define-fun dynamic_invariant2 ((temp___expr_378 us_rep2)
  ...
  (temp___do_toplevel_377 Bool)) Bool (and
                                      ...
                                      (= (to_rep
                                         (rec__search_trees__search_tree__root
                                         (us_split_fields5 temp___expr_378))) 0)
                                      (and
                                      (and
                                      (not
                                      (= (to_rep
                                      ...
                                      (= (valid_root
                                         (rec__search_trees__search_tree__struct
                                         (us_split_fields5 temp___expr_378))
                                         (to_rep
                                         (rec__search_trees__search_tree__root
                                         (us_split_fields5 temp___expr_378)))) true))
                                      (= (ordered_leafs
                                         (rec__search_trees__search_tree__struct
                                         (us_split_fields5 temp___expr_378))
                                         (to_rep
...
(define-fun default_initial_assumption ((temp___expr_383 us_rep2)
  (temp___skip_top_level_384 Bool)) Bool (and
                                         ...
                                         (= (size1 temp___expr_383) 0))))

(define-fun type_invariant ((temp___395 us_rep2)) Bool (ite (= (size
                                                               (rec__search_trees__search_tree__struct
                                                               (us_split_fields5
                                                               temp___395))) 0)
                                                       (= (to_rep
...
(define-fun dynamic_invariant3 ((temp___expr_487 us_rep3)
  ...
  (temp___do_toplevel_486 Bool)) Bool (and
                                      ...
                                      (= (valid_root
                                         (rec__search_trees__search_tree__struct
                                         (us_split_fields5 temp___488))
                                         (to_rep
                                         (rec__search_trees__search_tree__root
                                         (us_split_fields5 temp___488)))) true))
                                      (= (ordered_leafs
                                         (rec__search_trees__search_tree__struct
                                         (us_split_fields5 temp___488))
                                         (to_rep
                                      ...
                                      (= (tree_structure
                                         ...
                                         (us_split_fields5
                                         (rec__red_black_trees__rbt__struct
                                         (us_split_fields7 temp___expr_487))))) true)))

(define-fun default_initial_assumption1 ((temp___expr_493 us_rep3)
...
(define-fun type_invariant1 ((temp___507 us_rep3)) Bool (= (invariant__
                                                           temp___507) true))
...
(define-fun dynamic_invariant6 ((temp___expr_164 Int)
  (temp___is_init_161 Bool) (temp___skip_constant_162 Bool)
  (temp___do_toplevel_163 Bool)) Bool (=>
                                      (or (= temp___is_init_161 true)
                                      (<= 0 2)) (in_range3 temp___expr_164)))
...
(define-fun dynamic_predicate ((temp___213 us_rep5)) Bool (< (length
                                                             (rec__tree_model__path_type__a
                                                             (us_split_fields9
                                                             temp___213))) 100))

(define-fun dynamic_invariant9 ((temp___expr_218 (Array Int us_rep5))
...
(define-fun default_initial_assumption3 ((temp___expr_221 (Array Int us_rep5))
...
(define-fun default_initial_assumption4 ((temp___expr_201 us_rep4)
...
;; size__post_axiom
  (assert
  (forall ((t1 us_rep2))
  (! (=> (dynamic_invariant2 t1 true true true) (dynamic_invariant1
     (size1 t1) true false true)) :pattern ((size1 t1)) )))
...
;; model____post_axiom
  ...
  (! (=> (and (dynamic_invariant2 t1 true true true) (not (= (size1 t1) 0)))
     (dynamic_invariant9 (model__ t1) true false true)) :pattern ((model__
                                                                  t1)) )))
...
;; peek__post_axiom
  ...
  (! (=>
     ...
     (= (rec__tree_model__path_type__k
        (us_split_fields9
        (let ((temp___422 (model__ t1))) (select temp___422 i)))) true)))
     (dynamic_invariant1 (peek t1 i d) true false true)) :pattern ((peek t1 i
                                                                   d)) ))))
...
(define-fun dynamic_invariant11 ((temp___expr_275 us_rep1)
...
(define-fun default_initial_assumption5 ((temp___expr_278 us_rep1)
  (temp___skip_top_level_279 Bool)) Bool (and
                                         ...
                                         (= (size temp___expr_278) 0))))

(define-fun type_invariant2 ((temp___284 us_rep1)) Bool (= (tree_structure
                                                           temp___284) true))
...
;; size__post_axiom
  (assert
  (forall ((f us_rep1))
  (! (=> (dynamic_invariant11 f true true true) (dynamic_invariant1 (size f)
...
;; position__post_axiom
  ...
  (! (=>
     (and
     (and (dynamic_invariant11 f true true true) (dynamic_invariant i true
     true true)) (not (= (parent1 f i) 0))) (dynamic_invariant7
...
;; peek__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant1 result true false true)))) :pattern ((peek1 f i d)) ))))
...
(define-fun default_initial_assumption6 ((temp___expr_261 us_rep)
...
(define-fun default_initial_assumption7 ((temp___expr_268 (Array Int us_rep))
