...
(declare-fun tmp__split_fields () Bool)

(declare-fun tmp__split_fields1 () unsigned_byte)

(declare-fun tmp__split_fields2 () unsigned_byte)

(declare-fun records__update_b__result () Bool)

(declare-fun records__update_b__result1 () unsigned_byte)

(declare-fun records__update_b__result2 () unsigned_byte)
...
(declare-fun tmp__split_fields3 () us_split_fields2)

(declare-fun result3 () us_split_fields__ref1)

(declare-fun tmp__split_fields4 () us_split_fields2)

(declare-fun result4 () optional_pair__ref)

(declare-fun records__update_b__result3 () us_rep1)

(declare-fun records__update_b__result4 () optional_pair__ref)

(declare-fun records__update_b__result5 () us_rep1)

(declare-fun tmp__split_fields5 () us_split_fields__ref1)

(declare-fun records__update_b__result6 () optional_pair__ref)

(declare-fun tmp__split_fields6 () us_split_fields2)

(declare-fun records__update_b__result7 () us_rep1)
...
;; H
  ...
  (= (rec__records_prooffuncs__pair__b
     (us_split_fields1
     (rec__records_prooffuncs__optional_pair__the_pair tmp__split_fields3))) 
  o3))
...
;; H
  (assert
  (= (rec__records_prooffuncs__optional_pair__exists tmp__split_fields3) 
  o6))
...
;; H
  (assert
  (= records__update_b__result4 (mk_optional_pair__ref
                                records__update_b__result3)))

;; H
  (assert (= records__update_b__result5 records__update_b__result3))

;; H
  (assert
  (= result4 (mk_optional_pair__ref
             (mk___rep1
             (mk___split_fields1 records__update_b__result
             (mk___rep
             (mk___split_fields records__update_b__result1
             records__update_b__result2)))))))

;; H
  (assert (= records__update_b__result3 (mk___rep1 tmp__split_fields4)))

;; H
  (assert (= records__update_b__result6 records__update_b__result4))

;; H
  (assert
  (= tmp__split_fields5 (mk___split_fields__ref1 tmp__split_fields4)))

;; H
  (assert (= records__update_b__result7 records__update_b__result5))
...
;; H
  ...
  (= (mk___rep1
     ...
     (mk___rep (mk___split_fields result6 result7)))) (optional_pair__content
                                                      records__update_b__result6)))

(assert
;; WP_parameter_def
 ;; File "records_prooffuncs.ads", line 19, characters 0-0
  (not
  (= (bool_eq2 (optional_pair__content records__update_b__result6)
     (mk___rep1
     (mk___split_fields1
