...
;; H
  (assert (and (= o9 (mul RNE1 a91 a91)) (tqtisFinite (mul RNE1 a91 a91))))

;; H
  (assert
  (and (= o10 (mul RNE1 a101 a81)) (tqtisFinite (mul RNE1 a101 a81))))

;; H
  (assert (= o11 (sub RNE1 o10 o9)))

;; H
  (assert (and (= o12 o11) (tqtisFinite o11)))

;; H
  (assert (= o13 (mul RNE1 fliteral11 o12)))
...
;; H
  (assert
  (and (= o15 (mul RNE1 fliteral12 a91)) (tqtisFinite
  (mul RNE1 fliteral12 a91))))

;; H
  (assert (= o16 (sub RNE1 a101 o15)))

;; H
  (assert (and (= o17 o16) (tqtisFinite o16)))

;; H
  (assert (= o18 (add RNE1 o17 a81)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (not (eq (let ((subject den)) den1) zeroF))))
(check-sat)
