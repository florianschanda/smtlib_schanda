...
(declare-datatypes ()
((tS6bP1__ref (mk_tS6bP1__ref (tS6bP1__content tindexB)))))
(define-fun tS6bP1__ref___projection ((a tS6bP1__ref)) tindexB (tS6bP1__content
                                                               a))
...
;; def_axiom
  (assert
  (forall ((temp___507 us_t))
  (forall ((temp___508 Int) (temp___509 Int) (temp___510 Int))
  (let ((temp___506 (temp___505 temp___507 temp___508 temp___509 temp___510)))
  (and
  (and (= (first1 temp___506) (first1 temp___507))
  (= (last1 temp___506) (last1 temp___507)))
  (forall ((temp___511 Int))
  (ite (and (<= temp___508 temp___511) (<= temp___511 temp___509))
  (= (select (to_array temp___506) temp___511) (of_rep1 temp___510))
  (= (select (to_array temp___506) temp___511) (select (to_array temp___507) temp___511)))))))))
...
;; H
  (assert
  (and (= us 8) (dynamic_property1 (to_rep a__first) (to_rep a__last) 8)))
...
(assert
;; WP_parameter_def
 ;; File "update_checks_1.ads", line 33, characters 0-0
  (not (dynamic_property1 (to_rep a__first) (to_rep a__last) 1)))
(check-sat)
