...
(declare-sort tsubject_listD1 0)
...
(declare-fun user_eq12 (tsubject_listD1 tsubject_listD1) Bool)

(declare-fun dummy12 () tsubject_listD1)

(declare-datatypes ()
((tsubject_listD1__ref
 (mk_tsubject_listD1__ref (tsubject_listD1__content tsubject_listD1)))))
(define-fun tsubject_listD1__ref___projection ((a tsubject_listD1__ref)) tsubject_listD1 
  (tsubject_listD1__content a))
...
(define-fun bool_eq13 ((a (Array Int subject)) (a__first Int) (a__last Int)
...
(define-fun in_range8 ((x Int)) Bool (and (<= 0 x) (<= x 9)))
...
(declare-fun user_eq14 (tsubject_score_pair_listD1
  tsubject_score_pair_listD1) Bool)

(declare-fun dummy14 () tsubject_score_pair_listD1)

(declare-datatypes ()
((tsubject_score_pair_listD1__ref
 (mk_tsubject_score_pair_listD1__ref
 (tsubject_score_pair_listD1__content tsubject_score_pair_listD1)))))
(define-fun tsubject_score_pair_listD1__ref___projection ((a tsubject_score_pair_listD1__ref)) tsubject_score_pair_listD1 
...
(define-fun bool_eq16 ((a (Array Int us_rep3)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq14 (select a temp___idx_145)
...
(define-fun in_range9 ((x Int)) Bool (and (<= 0 x) (<= x 9)))
...
(declare-fun user_eq15 (t23s t23s) Bool)

(declare-fun dummy15 () t23s)
...
(declare-fun user_eq16 (t25s t25s) Bool)

(declare-fun dummy16 () t25s)
...
(declare-fun user_eq17 (t27s t27s) Bool)

(declare-fun dummy17 () t27s)
...
(declare-fun user_eq18 (t1b t1b) Bool)

(declare-fun dummy18 () t1b)
...
(declare-fun o74 () (Array Int us_rep1))

(declare-fun o75 () us_split_fields4)

(declare-fun temp___430 () us_rep2)

(declare-fun o76 () Int)

(declare-fun o77 () (Array Int us_rep1))

(declare-fun o78 () us_split_fields4)

(declare-fun temp___436 () us_rep2)

(declare-fun o79 () formtype)

(declare-fun o80 () us_split_fields2)

(declare-fun o81 () us_rep1)

(declare-fun o82 () Int)

(declare-fun o83 () (Array Int us_rep1))
...
(declare-fun o85 () percentage)

(declare-fun o86 () us_split_fields)

(declare-fun o87 () percentage)

(declare-fun o88 () us_split_fields)

(declare-fun o89 () percentage)

(declare-fun o90 () us_split_fields)

(declare-fun o91 () percentage)
...
(declare-fun o95 () percentage)

(declare-fun o96 () us_split_fields)

(declare-fun o97 () percentage)

(declare-fun o98 () us_split_fields)

(declare-fun o99 () percentage)

(declare-fun o100 () us_split_fields)

(declare-fun o101 () percentage)

(declare-fun o102 () us_split_fields)

(declare-fun o103 () percentage)
...
(declare-fun o108 () us_rep)

(declare-fun o109 () us_rep)
...
(declare-fun o113 () us_rep)

(declare-fun o114 () us_rep)

(declare-fun o115 () (Array Int us_rep))

(declare-fun o116 () formtype)

(declare-fun o117 () us_split_fields2)

(declare-fun o118 () us_rep1)
...
(declare-fun p__split_fields13 () us_split_fields4)
...
(declare-fun success8 () bool__ref)
...
;; H
  (assert (=> (and (<= 0 i2) (<= i2 9)) (= temp___420 success)))
...
;; H
  (assert (=> (and (<= 0 i2) (<= i2 9)) (= o56 (us_split_fields3 o55))))
...
;; H
  (assert (=> (and (<= 0 i2) (<= i2 9)) (= o58 (us_split_fields1 o57))))
...
;; H
  (assert
  (=> (and (<= 0 i2) (<= i2 9)) (= o60 (ite (not (= o59 true)) true false))))

;; H
  (assert (=> (and (<= 0 i2) (<= i2 9)) (= result2 (mk_bool__ref success2))))

;; H
  (assert (=> (and (<= 0 i2) (<= i2 9)) (= success3 o60)))
...
;; H
  ...
  (to_rep1
  (rec__pupils__subject_score_pair__subj
  (us_split_fields7 (select subject_scores1 i3)))) o63)))
  ...
  (= p__split_fields4 (us_split_fields5 temp___416)))) (= i3 9)))))))

;; H
  (assert (=> (and (<= 0 i2) (<= i2 9)) (= i4 (mk_int__ref i3))))

;; H
  (assert
  (=> (and (<= 0 i2) (<= i2 9)) (= success4 (mk_bool__ref success3))))

;; H
  (assert
  (=> (and (<= 0 i2) (<= i2 9)) (= p__split_fields7 p__split_fields5)))

;; H
  (assert (=> (and (<= 0 i2) (<= i2 9)) (= i5 i3)))

;; H
  (assert (=> (and (<= 0 i2) (<= i2 9)) (= success5 success3)))

;; H
  (assert
  (=> (and (<= 0 i2) (<= i2 9)) (= p__split_fields8 p__split_fields6)))

;; H
  (assert (=> (and (<= 0 i2) (<= i2 9)) (= i6 i4)))

;; H
  (assert (=> (and (<= 0 i2) (<= i2 9)) (= success6 success4)))

;; H
  (assert
  (=> (and (<= 0 i2) (<= i2 9)) (= p__split_fields9 p__split_fields7)))

;; H
  (assert (=> (and (<= 0 i2) (<= i2 9)) (= i7 i5)))

;; H
  (assert (=> (and (<= 0 i2) (<= i2 9)) (= success7 success5)))

;; H
  (assert
  (=> (and (<= 0 i2) (<= i2 9)) (= p__split_fields10 p__split_fields8)))

;; H
  (assert (=> (not (and (<= 0 i2) (<= i2 9))) (= i6 (mk_int__ref i2))))

;; H
  (assert
  (=> (not (and (<= 0 i2) (<= i2 9))) (= success6 (mk_bool__ref success))))
...
;; H
  (assert (=> (not (and (<= 0 i2) (<= i2 9))) (= i7 i2)))

;; H
  (assert (=> (not (and (<= 0 i2) (<= i2 9))) (= success7 success1)))

;; H
  (assert
  (=> (not (and (<= 0 i2) (<= i2 9))) (= p__split_fields10 p__split_fields2)))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (and
  (= o70 (+ (to_rep4
            (rec__pupils__pupildata__numberofpupils
...
;; H
  (assert (=> (= (bool__content success6) true) (= (to_rep4 o71) o70)))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= o72 (mk___split_fields2 o71
         (rec__pupils__pupildata__pupilentries
         (us_split_fields__content2 p__split_fields9))))))

;; H
  (assert
  (=> (= (bool__content success6) true) (= temp___424 (mk___rep2 o72))))

;; H
  (assert
  (=> (= (bool__content success6) true) (= result4 p__split_fields9)))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= p__split_fields11 (us_split_fields5 temp___424))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (and
  (<= 1 (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields11)))
  (<= (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields11)) 250))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= o73 (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields11)))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= o74 (store (rec__pupils__pupildata__pupilentries p__split_fields11) 
  o73 (mk___rep1
      (mk___split_fields1 sname
      (rec__pupils__pupiltype__forename
      (us_split_fields3
      (select (rec__pupils__pupildata__pupilentries p__split_fields11) 
      (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields11)))))
      (rec__pupils__pupiltype__form
      (us_split_fields3
      (select (rec__pupils__pupildata__pupilentries p__split_fields11) 
      (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields11)))))
...
;; H
  (assert
  (=> (= (bool__content success6) true)
  (= o75 (mk___split_fields2
         (rec__pupils__pupildata__numberofpupils p__split_fields11) o74))))

;; H
  (assert
  (=> (= (bool__content success6) true) (= temp___430 (mk___rep2 o75))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= result5 (mk___split_fields__ref2 p__split_fields11))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= p__split_fields12 (us_split_fields5 temp___430))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (and
  (<= 1 (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields12)))
  (<= (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields12)) 250))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= o76 (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields12)))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= o77 (store (rec__pupils__pupildata__pupilentries p__split_fields12) 
  o76 (mk___rep1
      (mk___split_fields1
      (rec__pupils__pupiltype__surname
      (us_split_fields3
      (select (rec__pupils__pupildata__pupilentries p__split_fields12) 
      (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields12)))))
      fname
      (rec__pupils__pupiltype__form
      (us_split_fields3
      (select (rec__pupils__pupildata__pupilentries p__split_fields12) 
...
;; H
  (assert
  (=> (= (bool__content success6) true)
  (= o78 (mk___split_fields2
         (rec__pupils__pupildata__numberofpupils p__split_fields12) o77))))

;; H
  (assert
  (=> (= (bool__content success6) true) (= temp___436 (mk___rep2 o78))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= result6 (mk___split_fields__ref2 p__split_fields12))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= p__split_fields13 (us_split_fields5 temp___436))))

;; H
  (assert (=> (= (bool__content success6) true) (= (to_rep3 o79) fm)))
...
;; H
  ...
  (= o80 (mk___split_fields1
         (rec__pupils__pupiltype__surname
         (us_split_fields3
         (select (rec__pupils__pupildata__pupilentries p__split_fields13) 
         (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields13)))))
         (rec__pupils__pupiltype__forename
         (us_split_fields3
         (select (rec__pupils__pupildata__pupilentries p__split_fields13) 
         (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields13)))))
...
;; H
  (assert (=> (= (bool__content success6) true) (= o81 (mk___rep1 o80))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (and
  (<= 1 (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields13)))
  (<= (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields13)) 250))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= o82 (to_rep4 (rec__pupils__pupildata__numberofpupils p__split_fields13)))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= o83 (store (rec__pupils__pupildata__pupilentries p__split_fields13) 
  o82 o81))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= o84 (mk___split_fields2
         (rec__pupils__pupildata__numberofpupils p__split_fields13) o83))))

;; H
  (assert
  (=> (= (bool__content success6) true) (= temp___442 (mk___rep2 o84))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= result7 (mk___split_fields__ref2 p__split_fields13))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= p__split_fields14 (us_split_fields5 temp___442))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= p__split_fields15 (mk___split_fields__ref2 p__split_fields14))))

;; H
  (assert
  (=> (= (bool__content success6) true)
  (= p__split_fields16 p__split_fields14)))

;; H
  (assert
  (=> (not (= (bool__content success6) true))
  (= p__split_fields15 p__split_fields9)))

;; H
  (assert
  (=> (not (= (bool__content success6) true))
  (= p__split_fields16 p__split_fields10)))
...
;; H
  (assert (= success9 success7))

;; H
  (assert (= p__split_fields18 p__split_fields16))

;; H
  (assert (= (bool__content success8) true))
...
;; H
  (assert (= (to_rep o103) score9))

;; H
  (assert (= o104 (mk___split_fields (of_int 1) o103)))

;; H
  (assert (= o105 (mk___rep o104)))

;; H
  (assert (= (to_rep o101) score8))

;; H
  (assert (= o102 (mk___split_fields (of_int 1) o101)))

;; H
  (assert (= o106 (mk___rep o102)))

;; H
  (assert (= (to_rep o99) score7))

;; H
  (assert (= o100 (mk___split_fields (of_int 1) o99)))

;; H
  (assert (= o107 (mk___rep o100)))

;; H
  (assert (= (to_rep o97) score6))

;; H
  (assert (= o98 (mk___split_fields (of_int 1) o97)))

;; H
  (assert (= o108 (mk___rep o98)))

;; H
  (assert (= (to_rep o95) score5))

;; H
  (assert (= o96 (mk___split_fields (of_int 1) o95)))

;; H
  (assert (= o109 (mk___rep o96)))

;; H
  (assert (= (to_rep o93) score4))

;; H
  (assert (= o94 (mk___split_fields (of_int 1) o93)))

;; H
  (assert (= o110 (mk___rep o94)))

;; H
  (assert (= (to_rep o91) score3))

;; H
  (assert (= o92 (mk___split_fields (of_int 1) o91)))

;; H
  (assert (= o111 (mk___rep o92)))

;; H
  (assert (= (to_rep o89) score2))

;; H
  (assert (= o90 (mk___split_fields (of_int 1) o89)))

;; H
  (assert (= o112 (mk___rep o90)))

;; H
  (assert (= (to_rep o87) score1))

;; H
  (assert (= o88 (mk___split_fields (of_int 1) o87)))

;; H
  (assert (= o113 (mk___rep o88)))

;; H
  (assert (= (to_rep o85) score0))

;; H
  (assert (= o86 (mk___split_fields (of_int 1) o85)))

;; H
  (assert (= o114 (mk___rep o86)))
...
;; H
  ...
  (= o115 (temp___354
          ...
          subj0 o114 subj1 o113 subj2 o112 subj3 o111 subj4 o110 subj5 
          o109 subj6 o108 subj7 o107 subj8 o106 subj9 o105)))

;; H
  (assert (= (to_rep3 o116) fm))

;; H
  (assert (= o117 (mk___split_fields1 sname fname o116 o115)))

;; H
  (assert (= o118 (mk___rep1 o117)))
...
;; WP_parameter_def
 ;; File "pupils.ads", line 74, characters 0-0
  ...
  (<= 1 (to_rep4
        (rec__pupils__pupildata__numberofpupils
        (us_split_fields__content2 p__split_fields17))))))
(check-sat)
