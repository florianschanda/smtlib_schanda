...
(declare-fun dw1000__register_types__pmsc_txfseq_type__txfineseq__first__bit () Int)

(declare-fun dw1000__register_types__pmsc_txfseq_type__txfineseq__last__bit () Int)

(declare-fun dw1000__register_types__pmsc_txfseq_type__txfineseq__position () Int)
...
(define-fun dynamic_invariant ((temp___expr_7447 us_t1)
  ...
  (temp___do_toplevel_7446 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_7447))
                                       (and (= (first3 temp___expr_7447) 1)
                                       (= (last4 temp___expr_7447) 2)))))
...
(define-fun dynamic_invariant1 ((temp___expr_7463 us_t2)
  ...
  (temp___do_toplevel_7462 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_7463))
                                       (and (= (first5 temp___expr_7463) 1)
                                       (= (last6 temp___expr_7463) 2)))))
...
(declare-fun temp___8091 () (Array Int bits_8))

(declare-fun temp___80911 () t2)

(declare-fun temp___8092 () (Array Int bits_8))

(declare-fun temp___80921 () t1)
...
;; H
  (assert
  (and
  (and (= temp___80912 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___80912 reg)) (dynamic_invariant1
  temp___80912 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80911)) (to_rep (last5 temp___80911)))
     (+ (- (to_rep (last5 temp___80911)) (to_rep (first4 temp___80911))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80911)) (to_rep (last5 temp___80911))) 
  temp___80921))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___80921)) (to_rep (last3 temp___80921)))
     (+ (- (to_rep (last3 temp___80921)) (to_rep (first2 temp___80921))) 1)
