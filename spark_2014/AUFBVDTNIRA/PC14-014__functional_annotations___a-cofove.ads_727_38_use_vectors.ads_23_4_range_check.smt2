...
(define-fun dynamic_invariant2 ((temp___expr_233 us_rep)
  ...
  (temp___do_toplevel_232 Bool)) Bool (dynamic_property1 0 last1
  (to_rep1
...
(define-fun contains ((container us_rep1) (fst1 Int) (lst1 Int)
  (item Int)) Bool (ite (exists ((i Int))
                        (and (and (<= fst1 i) (<= i lst1))
...
(define-fun last4 ((container us_rep1)) Int (+ (- first1 1) (length
                                                            container)))
...
(define-fun dynamic_invariant5 ((temp___expr_143 Int)
...
;; length__post_axiom
  ...
  (! (=> (dynamic_invariant2 container1 true true true)
     (let ((result (length1 container1)))
     (and (<= result (capacity container1)) (dynamic_invariant6 result true
...
;; length__post_axiom
  ...
  (! (let ((result (length container1)))
     (and (<= (+ (- first1 1) result) last2) (dynamic_invariant5 result true
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (and (<= first1 position) (<= position (last4 container1))))
     (dynamic_invariant8 (get container1 position) true false true)) :pattern (
...
(define-fun dynamic_invariant9 ((temp___expr_242 Int)
  ...
  (temp___do_toplevel_241 Bool)) Bool (=>
                                      ...
                                      (<= first1 last2)) (dynamic_property2
                                      first1 last2 temp___expr_242)))
...
;; H
  (assert (dynamic_property1 0 last1
  (to_rep1
  (rec__use_vectors__my_vectors__vector__capacity
...
;; H
  (assert
  (and (= o (last4 (model__ container)))
  (and (dynamic_property4 first3 last5 o) (= o (last4 (model__ container))))))
...
;; H
  (assert
  (and (= temp___425 (last4 (model__ container)))
  (and (dynamic_property4 first3 last5 temp___425)
  (= temp___425 (last4 (model__ container))))))

(assert
;; WP_parameter_def
 ;; File "a-cofove.ads", line 704, characters 0-0
  (not (dynamic_property3 first2 last3 temp___425)))
(check-sat)
