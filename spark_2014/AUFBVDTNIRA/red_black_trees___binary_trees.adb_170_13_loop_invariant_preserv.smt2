...
;; H
  ...
  (and
  (forall ((i4 Int))
  (=> (and (<= 1 i4) (<= i4 100)) (= (contains o1 i4) true)))
  (= (length1 o1) 100))))
...
;; H
  (assert
  (forall ((j3 Int)) (is_add__function_guard
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select r2 (to_rep
...
;; H
  (assert (= result5 (mk_int__ref temp___927)))

;; H
  (assert (= temp___9271 (length1 unseen2)))

;; H
  (assert (and (= o6 i2) (in_range7 i2)))
...
;; H
  (assert (=> (not (= j1 0)) (= (of_int 1) o20)))

;; H
  (assert (=> (not (= j1 0)) (and (<= 1 j1) (<= j1 100))))

;; H
  (assert (=> (not (= j1 0)) (= o21 j1)))
...
;; H
  (assert (=> (not (= j1 0)) (= r3 o22)))

;; H
  (assert (=> (not (= j1 0)) (and (<= 1 j1) (<= j1 100))))

;; H
  (assert (=> (not (= j1 0)) (= o23 j1)))
...
;; H
  (assert (=> (not (= j1 0)) (= o28 (mk___split_fields1 o24 o25 o26 o27))))

;; H
  (assert (=> (not (= j1 0)) (= o29 (rec__binary_trees__cell__parent o28))))

;; H
  (assert (=> (not (= j1 0)) (= temp___880 (to_rep o29))))

;; H
  (assert (=> (not (= j1 0)) (and (<= 1 temp___880) (<= temp___880 100))))

;; H
  (assert (=> (not (= j1 0)) (= o30 temp___880)))

;; H
  (assert (=> (not (= j1 0)) (= o31 (select r3 o30))))

;; H
  (assert (=> (not (= j1 0)) (= o32 (us_split_fields1 o31))))

;; H
  (assert (=> (not (= j1 0)) (= o33 (rec__tree_model__path_type__a o32))))
...
;; H
  (assert (=> (not (= j1 0)) (= temp___882 (mk___rep o35))))
...
;; H
  (assert (=> (not (= j1 0)) (= o36 temp___882)))

;; H
  (assert (=> (not (= j1 0)) (and (<= 1 j1) (<= j1 100))))

;; H
  (assert (=> (not (= j1 0)) (= o37 j1)))

;; H
  (assert (=> (not (= j1 0)) (= o38 (store r3 o37 o36))))

;; H
  (assert (=> (not (= j1 0)) (= result9 (mk_map__ref r3))))

;; H
  (assert (=> (not (= j1 0)) (= r4 o38)))

;; H
  (assert (=> (not (= j1 0)) (and (<= 1 j1) (<= j1 100))))

;; H
  (assert (=> (not (= j1 0)) (= o39 j1)))

;; H
  (assert (=> (not (= j1 0)) (= o40 (store todo3 o39 (of_int 1)))))

;; H
  (assert (=> (not (= j1 0)) (= result10 (mk_map__ref2 todo3))))

;; H
  (assert (=> (not (= j1 0)) (= todo4 o40)))
...
;; H
  (assert (= o43 (us_split_fields3 o42)))

;; H
  (assert (= o44 (rec__binary_trees__cell__right o43)))
...
;; H
  (assert (=> (not (= j2 0)) (= o47 j2)))

;; H
  (assert (=> (not (= j2 0)) (= o48 (store r4 o47 o46))))

;; H
  (assert (=> (not (= j2 0)) (= result12 (mk_map__ref r4))))

;; H
  (assert (=> (not (= j2 0)) (= r5 o48)))

;; H
  (assert (=> (not (= j2 0)) (and (<= 1 j2) (<= j2 100))))

;; H
  (assert (=> (not (= j2 0)) (= o49 j2)))
...
;; H
  (assert (=> (not (= j2 0)) (= o51 (us_split_fields3 o50))))

;; H
  (assert (=> (not (= j2 0)) (= o52 (rec__binary_trees__cell__parent o51))))

;; H
  (assert (=> (not (= j2 0)) (= temp___887 (to_rep o52))))

;; H
  (assert (=> (not (= j2 0)) (and (<= 1 temp___887) (<= temp___887 100))))

;; H
  (assert (=> (not (= j2 0)) (= o53 temp___887)))

;; H
  (assert (=> (not (= j2 0)) (= o54 (select r5 o53))))

;; H
  (assert (=> (not (= j2 0)) (= o55 (us_split_fields1 o54))))

;; H
  (assert (=> (not (= j2 0)) (= o56 (rec__tree_model__path_type__a o55))))
...
;; H
  (assert (=> (not (= j2 0)) (= temp___889 (mk___rep o58))))
...
;; H
  (assert (=> (not (= j2 0)) (= o59 temp___889)))

;; H
  (assert (=> (not (= j2 0)) (and (<= 1 j2) (<= j2 100))))

;; H
  (assert (=> (not (= j2 0)) (= o60 j2)))

;; H
  (assert (=> (not (= j2 0)) (= o61 (store r5 o60 o59))))

;; H
  (assert (=> (not (= j2 0)) (= result13 (mk_map__ref r5))))

;; H
  (assert (=> (not (= j2 0)) (= r6 o61)))

;; H
  (assert (=> (not (= j2 0)) (and (<= 1 j2) (<= j2 100))))

;; H
  (assert (=> (not (= j2 0)) (= o62 j2)))

;; H
  (assert (=> (not (= j2 0)) (= o63 (store todo4 o62 (of_int 1)))))

;; H
  (assert (=> (not (= j2 0)) (= result14 (mk_map__ref2 todo4))))

;; H
  (assert (=> (not (= j2 0)) (= todo5 o63)))
...
;; H
  (assert (= o65 (store todo5 o64 (of_int 0))))
...
;; H
  ...
  (us_split_fields3
  (select (rec__binary_trees__forest__c (us_split_fields5 f)) j3))))
  (rec__tree_model__path_type__a (us_split_fields1 (select r6 j3))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select r6 (to_rep
             (rec__binary_trees__cell__parent
...
;; WP_parameter_def
 ;; File "tree_model.ads", line 49, characters 0-0
  ...
  (= (is_add
     ...
     (us_split_fields3
     (select (rec__binary_trees__forest__c (us_split_fields5 f)) j3))))
     (rec__tree_model__path_type__a (us_split_fields1 (select r6 j3)))) true)))
(check-sat)
