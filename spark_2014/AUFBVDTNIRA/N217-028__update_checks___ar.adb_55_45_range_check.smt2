...
;; def_axiom
  ...
  (let ((temp___234 (temp___233 temp___235 temp___236)))
  (forall ((temp___237 Int))
  (ite (and (<= 5 temp___237) (<= temp___237 10))
  (= (select temp___234 temp___237) (of_rep temp___236))
  (=> (and (<= 1 temp___237) (<= temp___237 4))
  (= (select temp___234 temp___237) (of_rep temp___235))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.adb", line 39, characters 0-0
  (not (in_range2 (- e 1))))
(check-sat)
