...
(declare-fun temp___288 () (Array Int natural))

(declare-fun temp___2881 () t)
...
(define-fun temp___2882 () us_t (mk___t temp___288 temp___2881))
...
;; H
  (assert (invariant____function_guard (invariant__ temp___2882)
  temp___2882))
...
;; H
  (assert
  (and
  (and (= temp___2882 (remove (mk___t values2 (mk 1 100)) o13))
  (remove__function_guard temp___2882 (mk___t values2 (mk 1 100)) o13))
  (and (dynamic_invariant4 temp___2882 true false true)
  (and (= (invariant__ temp___2882) true)
  (and (= (to_rep1 (last temp___2881)) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o13 1)))
  (= (to_rep (select values2 k)) (to_rep (select temp___288 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select values2 k)) (to_rep (select temp___288 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o13 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select values2 (+ k 1))) (to_rep (select temp___288 k))))))))))))
