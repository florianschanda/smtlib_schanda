...
(declare-fun temp___270 () integer)

(declare-fun temp___2701 () float)
...
;; H
  (assert (= temp___270 full_s__split_fields2))

;; H
  (assert (= temp___2701 full_s__split_fields3))

(assert
;; WP_parameter_def
 ;; File "p2.ads", line 18, characters 0-0
  (not (tqtisFinite (add RNE2 (to_rep1 full_s__split_fields3) y))))
(check-sat)
