...
;; H
  ...
  (inrange64 rdi1 rdi (bvmul rcx ((_ int2bv 64) 8))) rdi1 rdi
  (bvmul rcx ((_ int2bv 64) 8))))

;; H
  (assert (readmem64__function_guard (readmem64 rdi1 memory2) rdi1 memory2))

;; H
  (assert (readmem64__function_guard
  (readmem64 (bvadd rdi (bvmul (bvsub rcx rcx1) ((_ int2bv 64) 8))) memory2)
  (bvadd rdi (bvmul (bvsub rcx rcx1) ((_ int2bv 64) 8))) memory2))

;; H
  (assert
  (forall ((i (_ BitVec 64))) (readmem64__function_guard
  (readmem64 (bvadd rdi (bvmul i ((_ int2bv 64) 8))) memory2)
  (bvadd rdi (bvmul i ((_ int2bv 64) 8))) memory2)))
...
;; H
  (assert (hasmem64__function_guard (hasmem64 memory3 rdi2 rax) memory3 
  rdi2 rax))

;; H
  (assert (nooverlap8equal__function_guard
  (nooverlap8equal memory3 memory2 rdi2) memory3 memory2 rdi2))

;; H
  (assert
  (forall ((i (_ BitVec 64))) (hasmem64__function_guard
  (hasmem64 mem3 (bvadd rdi_start (bvmul i ((_ int2bv 64) 8))) rax) mem3
  (bvadd rdi_start (bvmul i ((_ int2bv 64) 8))) rax)))
...
;; H
  ...
  (bvadd rdi_start (bvmul i ((_ int2bv 64) 8))) memory3)))

;; H
  (assert (readmem64__function_guard
  (readmem64
  (bvadd rdi_start (bvmul (bvsub rcx_start rcx2) ((_ int2bv 64) 8))) 
  memory3) (bvadd rdi_start (bvmul (bvsub rcx_start rcx2) ((_ int2bv 64) 8)))
  memory3))
...
;; H
  (assert (inrange64__function_guard
  (inrange64 rdi2 rdi (bvmul rcx ((_ int2bv 64) 8))) rdi2 rdi
  (bvmul rcx ((_ int2bv 64) 8))))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 714, characters 0-0
  (not (= (inrange64 rdi2 rdi (bvmul rcx ((_ int2bv 64) 8))) true)))
(check-sat)
