...
(declare-fun temp___270 () (Array Int natural))

(declare-fun temp___271 () Int)

(declare-fun temp___275 () (Array Int natural))
...
(declare-fun previous3 () (Array Int natural))
...
(declare-fun previous4 () map__ref)
...
(declare-fun previous5 () (Array Int natural))
...
(declare-fun previous6 () map__ref)
...
(declare-fun previous7 () (Array Int natural))
...
(declare-fun previous8 () map__ref)

(declare-fun current8 () int__ref)

(declare-fun values9 () (Array Int natural))

(declare-fun smallest9 () Int)

(declare-fun previous9 () (Array Int natural))

(declare-fun current9 () Int)

(declare-fun values10 () map__ref)

(declare-fun smallest10 () int__ref)

(declare-fun previous10 () map__ref)

(declare-fun current10 () int__ref)

(declare-fun values11 () (Array Int natural))

(declare-fun smallest11 () Int)

(declare-fun previous11 () (Array Int natural))

(declare-fun current11 () Int)
...
(define-fun o12 () us_t (mk___t o2 o3))

(define-fun current12 () int__ref (mk_int__ref current))

(define-fun previous12 () map__ref (mk_map__ref previous))

(define-fun smallest12 () int__ref (mk_int__ref smallest))

(define-fun values12 () map__ref (mk_map__ref values))
...
;; H
  (assert (is_perm__function_guard
  (is_perm
  (mk___t temp___275 (mk (to_rep1 values__first) (to_rep1 values__last)))
...
;; H
  ...
  (and
  (and
  (and (= current8 current12)
  (and (= previous8 previous12)
  (and (= smallest8 smallest12) (= values8 values12))))
  (and (= current9 current1)
  (and (= previous9 previous1)
  (and (= smallest9 smallest1) (= values9 values1)))))
  (and
  (and
  (ite (<= (to_rep1 values__first) (to_rep1 values__last))
  (= o (+ (- (to_rep1 values__last) (to_rep1 values__first)) 1)) (= o 0))
  ...
  (and
  (and
  (and (= current8 current6)
  (and (= previous8 previous6)
  (and (= smallest8 smallest6) (= values8 values6))))
  (and (= current9 current7)
  (and (= previous9 previous7)
  (and (= smallest9 smallest7) (= values9 values7)))))
  (and
  (and (= temp___278 (- (to_rep1 values__last) 1)) (in_range1
  (- (to_rep1 values__last) 1)))
  (and
  (and (= (mk_int__ref result1) current12)
  (= current2 (to_rep1 values__first)))
  (ite (and (<= (to_rep1 values__first) current2) (<= current2 temp___278))
  (and
  (and
  (and (= temp___274 previous)
  (and (= temp___272 smallest)
  (and (= temp___270 values)
  (and (= temp___271 current2)
  (and (= temp___275 values)
  (and
  (and
  (and
  (and
  (and
  (and
  (=> (<= current2 (to_rep1 values__last))
  (and
  (and (<= (to_rep1 values__first) current2)
  (<= current2 (to_rep1 values__last)))
  (and (<= (to_rep1 values__first) (to_rep1 values__last))
  (<= (to_rep1 values__last) (to_rep1 values__last))))) (= o1 values))
  (and (= o1 temp___267)
  (= (mk2 current2 (to_rep1 values__last)) temp___2671)))
  (and (= temp___267 o2)
  (= (mk (to_rep1 (first7 temp___2671)) (to_rep1 (last7 temp___2671))) 
  o3)))
  (and
  (and (= o4 (index_of_minimum o12)) (index_of_minimum__function_guard 
  o4 o12))
  (and (in_range3 o4)
  ...
  (and (= (mk_int__ref result2) smallest12) (= smallest2 o4)))
  (and
  (ite (not (= smallest2 current2))
  (and
  (and
  (and
  (and
  ...
  (= (mk___t1 o5 o6) (mk___t1 temp___268 temp___2681)))) (= o7 o5))
  (and (= (mk_map__ref result3) previous12) (= previous2 o7)))
  (and (and (= o8 current2) (in_range3 current2))
  (and
  (and
  (and
  (= (is_perm
  ...
  (= (to_rep (select values2 o8)) (to_rep (select values smallest2))))
  (= (to_rep (select values2 smallest2)) (to_rep (select values o8))))
  (forall ((z Int))
  (=> (and (<= (to_rep1 values__first) z) (<= z (to_rep1 values__last)))
  (=> (and (not (= z o8)) (not (= z smallest2)))
  (= (to_rep (select values2 z)) (to_rep (select values z)))))))))
  (and (and (= previous2 previous) (= values2 values))
  (and (= previous2 previous1) (= values2 values1))))
  (and
  (and
  (forall ((i1 Int))
  (=> (and (<= (to_rep1 values__first) i1) (<= i1 current3))
  (forall ((j Int))
  ...
  current3)) (=> (<= 1 2147483647) (in_range3 smallest3)))
  (and (<= (to_rep1 values__first) current3)
  (<= current3 (- (to_rep1 values__last) 1)))) (= current3 temp___278))))))))))
  (and
  (and (= current4 (mk_int__ref current3))
  (and (= previous4 (mk_map__ref previous3))
  (and (= smallest4 (mk_int__ref smallest3))
  (= values4 (mk_map__ref values3)))))
  (and (= current5 current3)
  (and (= previous5 previous3)
  (and (= smallest5 smallest3) (= values5 values3))))))
  (and
  (and (= current6 current4)
  (and (= previous6 previous4)
  (and (= smallest6 smallest4) (= values6 values4))))
  (and (= current7 current5)
  (and (= previous7 previous5)
  (and (= smallest7 smallest5) (= values7 values5))))))
  (and
  (and (= current6 (mk_int__ref current2))
  (and (= previous6 previous12)
  (and (= smallest6 smallest12) (= values6 values12))))
  (and (= current7 current2)
  (and (= previous7 previous1)
  (and (= smallest7 smallest1) (= values7 values1))))))))))))

;; H
  (assert (= current10 current8))

;; H
  (assert (= previous10 previous8))
...
;; H
  (assert
  (forall ((e Int)) (occ__function_guard
  (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e)
  (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e)))

;; H
  (assert
  (forall ((e Int)) (occ__function_guard
  (occ
  (mk___t (map__content values10)
  (mk (to_rep1 values__first) (to_rep1 values__last))) e)
  (mk___t (map__content values10)
  (mk (to_rep1 values__first) (to_rep1 values__last))) e)))
...
;; H
  ...
  (= result4 (is_perm
             (mk___t values
             (mk (to_rep1 values__first) (to_rep1 values__last)))
             (mk___t (map__content values10)
             (mk (to_rep1 values__first) (to_rep1 values__last)))))
  (is_perm__function_guard result4
  (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last)))
  (mk___t (map__content values10)
  (mk (to_rep1 values__first) (to_rep1 values__last)))))
  (= (= result4 true)
...
;; H
  ...
  (= o9 (+ (- (to_rep1 values__last) (to_rep1 values__first)) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 values__first) (to_rep1 values__last))) (= o9 0)))

;; H
  (assert (= result5 (ite (< 0 o9) true false)))
...
;; H
  (assert
  (and (= o10 (- (to_rep1 values__last) 1)) (in_range1
  (- (to_rep1 values__last) 1))))
...
;; H
  (assert (= result6 (ite (<= (to_rep1 values__first) i) o11 false)))
