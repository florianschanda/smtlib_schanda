...
(declare-fun temp___1137 () us_rep10)

(declare-fun temp___1136 () us_rep5)

(declare-fun temp___1135 () (Array Int positive))

(declare-fun temp___1139 () Int)

(declare-fun temp___1134 () us_rep)
...
;; H
  (assert
  (=> (= result1 true)
  (= temp___1137 (mk___rep5 p__split_discrs
                 (mk___split_fields5 p__split_fields)))))

;; H
  (assert
  (=> (= result1 true)
  (= temp___1136 (mk___rep3 d__split_discrs
                 (mk___split_fields3 d__split_fields)))))

;; H
  (assert (=> (= result1 true) (= temp___1135 a)))
...
;; H
  (assert (=> (= result1 true) (= temp___1134 (mk___rep c__split_fields1))))

;; H
  (assert
  (=> (= result1 true)
  (= temp___1138 (capacity
                 (mk___rep5 p__split_discrs
                 (mk___split_fields5 p__split_fields))))))
...
;; H
  (assert
  (=> (= result1 true)
  (= (capacity (mk___rep5 p__split_discrs p__split_fields3)) temp___1138)))

;; H
  (assert
  (=> (= result1 true)
  (= (length1 (mk___rep5 p__split_discrs p__split_fields3)) temp___1139)))
...
;; H
  ...
  (and (<= 0 (to_rep4 (select f j)))
  (<= (to_rep4 (select f j)) (- (length1
                                (mk___rep5 p__split_discrs p__split_fields3)) 1)))))))
...
;; H
  ...
  (=>
  (and (<= 0 j)
  (<= j (- (length1 (mk___rep5 p__split_discrs p__split_fields3)) 1)))
  (forall ((k Int))
  (=>
  (and
  (<= (to_rep2
      (rec__partition_refinement__interval__first
      (us_split_fields9
      (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) j)))) k)
  (<= k (to_rep2
        (rec__partition_refinement__interval__last
        (us_split_fields9
        (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) j))))))
  (= (to_rep4 (select f k)) j)))))))
...
;; H
  (assert
  (=> (= result1 true) (= result2 (ite (not (= o1 true)) true false))))
