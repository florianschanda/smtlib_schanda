...
;; H
  (assert
  (= (to_rep4 (first6 (rt3 (temp___818 ((_ int2bv 8) 0) 1 r32b)))) 1))

;; H
  (assert
  (= (to_rep4 (last9 (rt3 (temp___818 ((_ int2bv 8) 0) 1 r32b)))) r32b))

;; H
  (assert
  (= (mk___t3 temp___825 temp___8251) (temp___818 ((_ int2bv 8) 0) 1 r32b)))
