...
;; H
  (assert
  (forall ((ib3 Int)) (remove__function_guard (remove bb ib3) bb ib3)))
...
;; H
  (assert
  (forall ((ia2 Int) (ib3 Int)) (is_perm__function_guard
  (is_perm (remove aa ia2) (remove bb ib3)) (remove aa ia2) (remove bb ib3))))
...
;; H
  (assert (is_perm__function_guard (is_perm o28 o30) o28 o30))
...
;; H
  (assert
  (and (and (= o29 (remove a o10)) (remove__function_guard o29 a o10))
...
;; H
  (assert
  (and (and (= o28 (remove o29 o13)) (remove__function_guard o28 o29 o13))
...
;; H
  (assert
  (and (and (= o30 (remove bb ib1)) (remove__function_guard o30 bb ib1))
...
;; H
  (assert
  (and (and (= o31 (remove aa o5)) (remove__function_guard o31 aa o5))
...
;; H
  (assert
  (and
  (and (= o16 (shift_perm_l o31 o30 o28)) (shift_perm_l__function_guard 
  o16 o31 o30 o28))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o28 o30) true)))))
...
;; H
  (assert (remove__function_guard
  (remove (remove b ib2)
  (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))) (remove b ib2)
  (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
...
;; H
  ...
  (remove_swap__function_guard o18 b
  (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) ib2))
  (and (in_range3 o18)
  (=> (= (of_int o18) true)
  (= (let ((temp___196 (remove (remove b ib2)
                       (to_rep1
...
;; H
  (assert (invariant____function_guard (invariant__ o22) o22))

;; H
  (assert (is_perm__function_guard (is_perm o22 o26) o22 o26))

;; H
  (assert
  (and (and (= o25 (remove b ib2)) (remove__function_guard o25 b ib2))
...
;; H
  ...
  (= o26 (remove o25
         (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
  (remove__function_guard o26 o25
  (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
...
;; H
  (assert
  (and (and (= o24 (remove bb o23)) (remove__function_guard o24 bb o23))
...
;; H
  (assert
  (and (and (= o20 (remove a o19)) (remove__function_guard o20 a o19))
...
;; H
  (assert
  (and (and (= o22 (remove o20 o21)) (remove__function_guard o22 o20 o21))
...
;; H
  (assert
  (and
  (and (= o27 (shift_perm_r o22 o24 o26)) (shift_perm_r__function_guard 
  o27 o22 o24 o26))
...
;; H
  (assert (is_perm__function_guard (is_perm (remove a ia1) (remove b ib2))
  (remove a ia1) (remove b ib2)))

(assert
;; WP_parameter_def
 ;; File "perm.ads", line 2, characters 0-0
  (not (= (is_perm (remove a ia1) (remove b ib2)) true)))
(check-sat)
