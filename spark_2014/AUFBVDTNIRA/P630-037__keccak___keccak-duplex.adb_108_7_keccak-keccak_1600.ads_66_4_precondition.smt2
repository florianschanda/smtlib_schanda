...
(declare-fun user_eq13 (t192s t192s) Bool)

(declare-fun dummy13 () t192s)

(declare-datatypes () ((t192s__ref (mk_t192s__ref (t192s__content t192s)))))
(define-fun t192s__ref___projection ((a t192s__ref)) t192s (t192s__content a))
...
(declare-fun temp___1237 () (Array Int byte))

(declare-fun temp___12371 () t1)

(declare-fun temp___1241 () (Array Int byte))

(declare-fun temp___12411 () t1)
...
;; H
  (assert
  (= o (keccak__keccak_1600__duplex__duplex_mute__block__aggregate_def
       ((_ int2bv 8) 0))))
...
;; H
  (assert
  (= (slide (elts in_data) (to_rep (first (rt in_data))) 0) temp___1237))

;; H
  (assert (= (mk1 0 (- (length in_data) 1)) temp___12371))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___12371)) (to_rep (last3 temp___12371)))
     (+ (- (to_rep (last3 temp___12371)) (to_rep (first2 temp___12371))) 1)
     0) (ite (<= (to_rep (first2 (mk1 0 (- (length in_data) 1)))) (to_rep
                                                                  ...
                                                                  (length
                                                                  in_data) 1)))))
        (+ (- (to_rep (last3 (mk1 0 (- (length in_data) 1)))) (to_rep
                                                              (first2
                                                              (mk1 0
                                                              (- (length
                                                                 in_data) 1))))) 1)
...
;; H
  (assert
  (= (mk___t1 temp___1241 temp___12411) (mk___t1 temp___1237 temp___12371)))

;; H
  (assert
  (forall ((temp___1242 Int))
  (ite (and (<= 0 temp___1242) (<= temp___1242 (- (length in_data) 1)))
  (= (select o1 temp___1242) (select temp___1241 temp___1242))
  (= (select o1 temp___1242) (select block1 temp___1242)))))
...
;; H
  ...
  (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))))
  (and (in_range5 o2) (= o2 (to_rep3 ctx__split_fields1)))))
...
;; H
  (assert
  (= keccak__keccak_1600__duplex__duplex_mute__R196s__assume (- o4 1)))
...
;; H
  (assert (= o5 keccak__padding__pad101_single_block__block__compl))
...
;; H
  ...
  (= o8 (rate_of
        (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))))
  (rate_of__function_guard o8
  (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))))
  (and (in_range5 o8) (= o8 (to_rep3 ctx__split_fields1)))))
...
;; WP_parameter_def
 ;; File "keccak-duplex.ads", line 137, characters 0-0
  (not
  (<= (ite (<= (to_rep o6) (to_rep o7)) (+ (- (to_rep o7) (to_rep o6)) 1) 0) 268435455)))
(check-sat)
