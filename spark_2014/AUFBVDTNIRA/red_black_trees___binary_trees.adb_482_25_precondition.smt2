...
(declare-fun temp___2093 () (Array Int us_rep1))
...
(declare-fun temp___2094 () (Array Int us_rep1))

(declare-fun o67 () us_rep1)
...
;; H
  (assert (= o70 (select temp___2095 i)))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2094 (parent
                      (mk___rep2
                      (mk___split_fields2 f__split_fields f__split_fields1))
                      i1))))
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2094 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2094 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___2094 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 o66))
  (model____function_guard temp___2094
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o66))
  (and (dynamic_invariant3 temp___2094 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2094 o66))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2094 o66)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o66))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2094 (parent
                              ...
                              f__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2094 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2094 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2094 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2094 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2094 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2094 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o67 (select temp___2094 i)))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2093 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2093 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___2093 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (model____function_guard temp___2093
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  root))
  (and (dynamic_invariant3 temp___2093 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2093 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2093 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2093 (parent
                              ...
                              f_old__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2093 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2093 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2093 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2093 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2093 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2093 j)))) true))
  (= j i1))))))))))))))
...
;; H
  (assert (= o62 (select temp___2093 o61)))
