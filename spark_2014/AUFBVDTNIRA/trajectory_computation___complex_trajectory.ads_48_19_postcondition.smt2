...
(declare-fun distance2 () t)

(declare-fun average2 () t)

(declare-fun speed3 () t)

(declare-fun distance3 () t)
...
;; H
  (assert (le
  (mul RNE2 (mul RNE2 (mul RNE2 fliteral8 (of_int RNE2 n)) (neg fliteral3))
  fliteral5) average1))

;; H
  (assert (le average1
  (mul RNE2 (mul RNE2 (mul RNE2 fliteral8 (of_int RNE2 n)) fliteral3)
  fliteral5)))

;; H
  (assert (le
  (mul RNE2 (mul RNE2 (mul RNE2 fliteral8 (of_int RNE2 n)) (neg fliteral3))
  fliteral5) (mul RNE2 average1 fliteral7)))

;; H
  (assert (le (mul RNE2 average1 fliteral7)
  (mul RNE2 (mul RNE2 (mul RNE2 fliteral8 (of_int RNE2 n)) fliteral3)
  fliteral5)))

;; H
  (assert
  (and (= o3 (add RNE2 distance (mul RNE2 average1 fliteral7))) (tqtisFinite
  (add RNE2 distance (mul RNE2 average1 fliteral7)))))
...
;; H
  ...
  (add RNE2
  (mul RNE2
  (mul RNE2 (mul RNE2 (of_int RNE2 n) (of_int RNE2 (+ n 1))) (neg fliteral3))
  fliteral5)
  (mul RNE2 (mul RNE2 (mul RNE2 fliteral8 (of_int RNE2 n)) (neg fliteral3))
  fliteral5))
  (mul RNE2
  (mul RNE2 (mul RNE2 (of_int RNE2 (+ n 1)) (of_int RNE2 (+ n 2)))
...
;; H
  ...
  fliteral5))
  (mul RNE2
  (mul RNE2 (mul RNE2 (of_int RNE2 (+ n 1)) (of_int RNE2 (+ n 2))) fliteral3)
  fliteral5)))
...
;; H
  ...
  (mul RNE2
  (mul RNE2 (mul RNE2 (of_int RNE2 (+ n 1)) (of_int RNE2 (+ n 2)))
  (neg fliteral3)) fliteral5) distance1))
...
;; WP_parameter_def
 ;; File "complex_trajectory.ads", line 29, characters 0-0
  (not (= (invariant__ (+ n 1) speed2 distance2) true)))
(check-sat)
