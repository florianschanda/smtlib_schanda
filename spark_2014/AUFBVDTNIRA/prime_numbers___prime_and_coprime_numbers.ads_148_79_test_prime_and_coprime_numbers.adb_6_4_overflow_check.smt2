...
(declare-fun dummy2 () nearest_mode)
...
;; H
  (assert
  (and
  (= o5 (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))
  (in_range1
  (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))))
...
;; H
  (assert (= o12 (ite (< 0 o11) o11 0)))

;; H
  (assert (= o13 (ite (<= o12 v) true false)))

;; H
  (assert (= result2 (ite (= o13 true) (ite (<= v value) true false) false)))
