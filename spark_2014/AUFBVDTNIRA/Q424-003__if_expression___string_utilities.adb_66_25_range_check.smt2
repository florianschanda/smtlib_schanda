...
;; H
  (assert
  (and (= us6 temp___309) (dynamic_property1 first2 last2 temp___309)))

;; H
  (assert (= o26 temp___309))
...
;; H
  (assert (and (= temp___310 (- x215 1)) (in_range1 (- x215 1))))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (dynamic_property2 first3 last3 temp___310)))
(check-sat)
