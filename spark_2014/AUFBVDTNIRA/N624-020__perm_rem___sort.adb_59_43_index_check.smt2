...
(declare-fun temp___383 () us_t)

(declare-fun o48 () Int)

(declare-fun temp___384 () us_t)
...
;; H
  (assert (invariant____function_guard (invariant__ temp___384) temp___384))
...
;; H
  (assert
  (and
  (and (= temp___384 (remove (mk___t values2 (mk 1 100)) o48))
  (remove__function_guard temp___384 (mk___t values2 (mk 1 100)) o48))
  (and (dynamic_invariant4 temp___384 true false true)
  (and (= (invariant__ temp___384) true)
  (and (= (to_rep1 (last (rt temp___384))) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o48 1)))
  (= (to_rep (select values2 k)) (to_rep (select (elts temp___384) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o48 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select values2 k)) (to_rep (select (elts temp___384) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o48 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts temp___384) k))))))))))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt temp___384))) (- x 1))
  (<= (- x 1) (to_rep1 (last (rt temp___384))))))

;; H
  (assert (= o49 (- x 1)))

;; H
  (assert (= o50 (select (elts temp___384) o49)))

;; H
  (assert (= o51 (to_rep o50)))

;; H
  (assert (invariant____function_guard (invariant__ temp___383) temp___383))
...
;; H
  (assert
  (and
  (and (= temp___383 (remove (mk___t init (mk 1 100)) o47))
  (remove__function_guard temp___383 (mk___t init (mk 1 100)) o47))
  (and (dynamic_invariant4 temp___383 true false true)
  (and (= (invariant__ temp___383) true)
  (and (= (to_rep1 (last (rt temp___383))) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o47 1)))
  (= (to_rep (select init k)) (to_rep (select (elts temp___383) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o47 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select init k)) (to_rep (select (elts temp___383) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o47 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select init (+ k 1))) (to_rep (select (elts temp___383) k))))))))))))

(assert
;; WP_parameter_def
 ;; File "sort.ads", line 4, characters 0-0
  (not (<= (to_rep1 (first (rt temp___383))) y)))
(check-sat)
