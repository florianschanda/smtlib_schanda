...
;; H
  ...
  (model_is_well_formed o24 data first_available) o24 data first_available))
...
;; H
  (assert
  (and
  (and (= o24 (model__ data first_available)) (model____function_guard 
  o24 data first_available))
...
;; H
  ...
  (int__content first_available5)) o21 (map__content data5)
  (int__content first_available5)))
...
;; H
  ...
  (model____function_guard o21 (map__content data5)
  (int__content first_available5)))
  (= (model_is_well_formed o21 (map__content data5)
...
;; H
  ...
  (is_prepend__function_guard result6 o23 (int__content res5)
  (rec__list_mod_allocator__m__t__available
  (us_split_fields3 (model__ data first_available)))))
  (= (= result6 true)
  (and
