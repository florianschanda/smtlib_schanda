...
(define-fun s__split_fields24 () us_split_fields (mk___split_fields
                                                 s__split_fields16
                                                 s__split_fields17
                                                 s__split_fields18
                                                 s__split_fields19
...
;; H
  (assert (inv__function_guard (inv (mk___rep s__split_fields24))
  (mk___rep s__split_fields24)))
...
;; WP_parameter_def
 ;; File "patience.ads", line 27, characters 0-0
  (not (in_range1 (- i2 (to_rep1 (first (rt cards)))))))
(check-sat)
