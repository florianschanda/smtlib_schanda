...
(define-fun dynamic_invariant1 ((temp___expr_515 us_rep1)
...
(assert
;; WP_parameter_def
 ;; File "do_checks.adb", line 437, characters 0-0
  (not
  (= 10 (to_rep
        (rec__do_checks__do_discriminant_check__r1__j x__split_discrs)))))
(check-sat)
