...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral2) (= (tqtreal fliteral2) 2.0)))

(declare-fun fliteral3 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 100000.0)))
...
;; H
  ...
  (and (= o (add RNE2 x x)) (tqtisFinite (add RNE2 x x)))))
...
;; H
  (assert (=> (and (le (neg fliteral) x) (le x fliteral)) (= x2 o)))

;; H
  (assert
  (=> (and (le (neg fliteral) x) (le x fliteral))
  (and (le (neg fliteral2) x2) (le x2 fliteral2))))

;; H
  (assert (=> (not (and (le (neg fliteral) x) (le x fliteral))) (= x2 x)))

;; H
  (assert (=> (not (and (le (neg fliteral) x) (le x fliteral))) (= x2 x1)))

;; H
  (assert
  (=> (and (le (neg fliteral) x2) (le x2 fliteral))
  (and (= o1 (mul RNE2 x2 fliteral2)) (tqtisFinite (mul RNE2 x2 fliteral2)))))

;; H
  (assert (=> (and (le (neg fliteral) x2) (le x2 fliteral)) (= x2 result1)))

;; H
  (assert (=> (and (le (neg fliteral) x2) (le x2 fliteral)) (= x3 o1)))

;; H
  (assert
  (=> (and (le (neg fliteral) x2) (le x2 fliteral))
  (and (le (neg fliteral2) x3) (le x3 fliteral2))))

;; H
  (assert (=> (not (and (le (neg fliteral) x2) (le x2 fliteral))) (= x3 x2)))

;; H
  (assert
  (=> (and (le (neg fliteral) x3) (le x3 fliteral))
  (and (= o2 (mul RNE2 x3 x3)) (tqtisFinite (mul RNE2 x3 x3)))))

;; H
  (assert (=> (and (le (neg fliteral) x3) (le x3 fliteral)) (= x3 result2)))

;; H
  (assert (=> (and (le (neg fliteral) x3) (le x3 fliteral)) (= x4 o2)))

;; H
  (assert
  (=> (and (le (neg fliteral) x3) (le x3 fliteral))
  (and (le (neg fliteral) x4) (le x4 fliteral))))

;; H
  (assert (=> (not (and (le (neg fliteral) x3) (le x3 fliteral))) (= x4 x3)))
