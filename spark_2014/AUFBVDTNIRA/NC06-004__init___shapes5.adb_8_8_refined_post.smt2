...
;; H
  (assert
  (=> (le (sub RNE2 y (neg fliteral1)) r4)
  (and (= o3 (sub RNE2 y (neg fliteral1))) (tqtisFinite
  (sub RNE2 y (neg fliteral1))))))

;; H
  (assert (=> (le (sub RNE2 y (neg fliteral1)) r4) (= result4 r4)))

;; H
  (assert (=> (le (sub RNE2 y (neg fliteral1)) r4) (= r5 o3)))

;; H
  (assert (=> (not (le (sub RNE2 y (neg fliteral1)) r4)) (= r5 r4)))
