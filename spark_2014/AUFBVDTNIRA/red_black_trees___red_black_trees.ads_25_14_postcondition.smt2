...
(define-fun dynamic_invariant2 ((temp___expr_567 us_rep3)
...
;; contains__post_axiom
  ...
  (! (=>
     ...
     (= (= result true) (= (contains (values t) v) true)))))) :pattern (
  (contains1 t v)) ))))
...
(define-fun dynamic_invariant3 ((temp___expr_905 us_rep4)
...
(define-fun default_initial_assumption2 ((temp___expr_915 us_rep4)
...
(define-fun default_initial_assumption3 ((temp___expr_265 us_rep)
...
;; values__def_axiom
  ...
  (forall ((t us_rep4))
  (! (=>
     (and (dynamic_invariant3 t true true true) (values__function_guard1
     (values1 t) t))
...
;; size__post_axiom
  ...
  (! (=> (and (dynamic_invariant3 t1 true true true) (type_invariant1 t1))
     (let ((result (size2 t1)))
     (=> (size__function_guard2 result t1) (dynamic_invariant4 result true
     false true)))) :pattern ((size2 t1)) )))

;; size__def_axiom
  (assert
  (forall ((t1 us_rep4))
  (! (=>
     (and (dynamic_invariant3 t1 true true true) (size__function_guard2
     (size2 t1) t1))
     (and (size__function_guard1
     (size1 (rec__red_black_trees__rbt__struct (us_split_fields7 t1)))
     (rec__red_black_trees__rbt__struct (us_split_fields7 t1)))
...
(define-fun dynamic_invariant6 ((temp___expr_157 Int)
...
(define-fun dynamic_invariant7 ((temp___expr_169 Int)
...
(define-fun dynamic_invariant9 ((temp___expr_212 us_rep7)
...
(define-fun dynamic_predicate ((temp___218 us_rep7)) Bool (< (length
                                                             (rec__tree_model__path_type__a
                                                             (us_split_fields11
                                                             temp___218))) 100))

(define-fun dynamic_invariant10 ((temp___expr_223 (Array Int us_rep7))
...
(define-fun dynamic_invariant11 ((temp___expr_151 Int)
...
;; model____post_axiom
  ...
  (! (and (size__function_guard1 (size1 t1) t1)
     ...
     (=> (model____function_guard result t1) (dynamic_invariant10 result true
...
;; peek__post_axiom
  ...
  (! (and (size__function_guard1 (size1 t1) t1)
     ...
     (=> (peek__function_guard result t1 i d) (dynamic_invariant4 result true
...
;; peek__def_axiom
  ...
  (! (=>
     ...
     (and
     (and (dynamic_invariant2 t1 true true true) (dynamic_invariant6 i true
     true true)) (dynamic_invariant8 d true true true)) (peek__function_guard
     (peek t1 i d) t1 i d))
...
;; values__post_axiom
  ...
  (forall ((t1 us_rep3))
  (! (=> (dynamic_invariant2 t1 true true true)
     (let ((result (values t1)))
     (and (size__function_guard1 (size1 t1) t1)
     (=> (values__function_guard result t1)
     (=> (= (size1 t1) 0) (= (is_empty result) true)))))) :pattern ((values
                                                                    t1)) )))
...
(define-fun dynamic_invariant12 ((temp___expr_286 us_rep2)
...
;; size__post_axiom
  (assert
  (forall ((f us_rep2))
  (! (=> (dynamic_invariant12 f true true true)
     (let ((result (size f)))
...
;; position__post_axiom
  ...
  (! (and (parent__function_guard1 (parent1 f i) f i)
     ...
     (=> (position__function_guard result f i) (dynamic_invariant8 result
...
(define-fun dynamic_invariant13 ((temp___expr_199 Int)
...
(define-fun dynamic_invariant14 ((temp___expr_193 Int)
...
;; H
  ...
  (contains__function_guard1 o
  (rec__red_black_trees__rbt__struct (us_split_fields7 t)) v))
  (= (= o true)
  (= (contains
     (values (rec__red_black_trees__rbt__struct (us_split_fields7 t))) 
     v) true))))
