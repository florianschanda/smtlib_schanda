...
;; H
  (assert
  (and
  (and (= o4 (parent (rec__red_black_trees__rbt__struct t__split_fields6) i))
  (parent__function_guard o4
...
;; H
  ...
  (and
  (and
  (= temp___1122 (parent (rec__red_black_trees__rbt__struct t__split_fields6)
                 i))
  (parent__function_guard temp___1122
  (rec__red_black_trees__rbt__struct t__split_fields6) i))
  (and (in_range3 temp___1122)
  (and
  (= temp___1122 (parent1
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7
