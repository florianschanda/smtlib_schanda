...
;; H
  (assert
  (and
  (and (= o29 (remove (mk___t interm1 (mk 1 100)) o28))
  (remove__function_guard o29 (mk___t interm1 (mk 1 100)) o28))
  (and (dynamic_invariant4 o29 true false true)
  (and (= (invariant__ o29) true)
  (and (= (to_rep1 (last (rt o29))) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o28 1)))
  (= (to_rep (select interm1 k)) (to_rep (select (elts o29) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o28 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select interm1 k)) (to_rep (select (elts o29) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o28 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o29) k))))))))))))

;; H
  (assert (and (= o27 x) (in_range5 x)))

;; H
  (assert (invariant____function_guard (invariant__ (mk___t init (mk 1 100)))
  (mk___t init (mk 1 100))))
