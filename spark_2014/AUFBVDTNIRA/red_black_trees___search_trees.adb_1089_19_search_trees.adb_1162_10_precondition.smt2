...
(declare-fun temp___2006 () (Array Int us_rep1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2006 (parent
                      (mk___rep2
                      (let ((subject f_5__split_fields)) f_5__split_fields2))
                      i2))))
  (position
  (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2006 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2006 (parent
                      (mk___rep2
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2007 o37))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2007 o37)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o37))
...
;; H
  (assert (= o38 (select temp___2007 x1)))
...
;; H
  ...
  (= temp___2006 (model__
                 ...
                 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
                 o33))
  (model____function_guard temp___2006
  (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
  o33))
  (and (dynamic_invariant6 temp___2006 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2006 o33))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2006 o33)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o33))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2006 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2006 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2006 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2006 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2006 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2006 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o34 (select temp___2006 i1)))
