...
;; H
  (assert
  (and (= o33 (+ 48 (div1 localvalue1 10))) (in_range3
...
;; H
  (assert (= o35 (store localtext1 1 o34)))

;; H
  (assert (= result3 (mk_map__ref localtext1)))

;; H
  (assert (= localtext2 o35))

;; H
  (assert (= (to_rep o36) (+ 48 (mod2 localvalue1 10))))

;; H
  (assert (= o37 (store localtext2 2 o36)))

;; H
  (assert (= result4 (mk_map__ref localtext2)))

;; H
  (assert (= localtext3 o37))
...
;; WP_parameter_def
 ;; File "configdata.adb", line 1359, characters 0-0
  (not (in_range3 (+ 48 (div1 localvalue2 10)))))
(check-sat)
