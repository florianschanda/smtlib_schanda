...
;; H
  (assert
  (and
  (and (= o2 (get_length x12 o1 lengths2)) (get_length__function_guard 
  o2 x12 o1 lengths2))
  (and (dynamic_property3 0 last4 o2)
  (= o2 (ite (and (dynamic_property1 first2 last2 x12) (dynamic_property2
             first3 last3 o1))
        (to_rep2 (get lengths2 x12 o1)) 0)))))
