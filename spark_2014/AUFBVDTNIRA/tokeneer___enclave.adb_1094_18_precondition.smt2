...
;; H
  (assert (thecurrentdoor__function_guard (thecurrentdoor state7) state7))
...
;; H
  (assert (alarm_timeout__function_guard (alarm_timeout state7) state7))
...
;; H
  ...
  (greaterthanorequal (thecurrenttime currenttime) (alarm_timeout state7))
  (thecurrenttime currenttime) (alarm_timeout state7)))

;; H
  (assert (thedooralarm__function_guard (thedooralarm state7) state7))
...
;; H
  (assert (latch_timeout__function_guard (latch_timeout state6) state6))
...
;; H
  (assert (greaterthanorequal__function_guard
  (greaterthanorequal (thecurrenttime currenttime) (latch_timeout state6))
  (thecurrenttime currenttime) (latch_timeout state6)))

;; H
  (assert (isdoingop__function_guard
  (isdoingop (mk___rep theadmin__split_fields7))
  (mk___rep theadmin__split_fields7)))

;; H
  (assert (rolepresent__function_guard
  (rolepresent (mk___rep theadmin__split_fields7))
  (mk___rep theadmin__split_fields7)))
...
;; H
  ...
  (ispresent (mk___rep theadmin__split_fields7))
  (mk___rep theadmin__split_fields7)))
...
;; H
  (assert
  (and (= o9 (islocked state9)) (islocked__function_guard o9 state9)))
