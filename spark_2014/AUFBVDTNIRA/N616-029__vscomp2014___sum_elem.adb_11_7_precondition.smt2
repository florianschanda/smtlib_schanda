...
(declare-fun sum_elem__partitions__vector__capacity__first__bit2 () Int)

(declare-fun sum_elem__partitions__vector__capacity__last__bit2 () Int)

(declare-fun sum_elem__partitions__vector__capacity__position2 () Int)
