...
(declare-fun o17 () (Array Int word32))
...
;; H
  ...
  (=> (< i2 temp___291)
  (= (select result__2 temp___291) (select result__ temp___291))))))
...
;; H
  (assert
  (and (<= (to_rep (first (rt right))) i3)
  (<= i3 (to_rep (last (rt right))))))
...
;; H
  (assert
  (and (<= (to_rep (first (rt left))) i3) (<= i3 (to_rep (last (rt left))))))
