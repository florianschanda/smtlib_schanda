...
(declare-datatypes ()
((tS7bP1__ref (mk_tS7bP1__ref (tS7bP1__content tindexB)))))
(define-fun tS7bP1__ref___projection ((a tS7bP1__ref)) tindexB (tS7bP1__content
                                                               a))
...
;; def_axiom
  (assert
  (forall ((temp___262 us_t))
  (forall ((temp___263 Int) (temp___264 Int))
  (let ((temp___261 (temp___260 temp___262 temp___263 temp___264)))
  (and
  (and (= (first1 temp___261) (first1 temp___262))
  (= (last1 temp___261) (last1 temp___262)))
  (forall ((temp___265 Int))
  (ite (= temp___265 temp___263)
  (= (select (to_array temp___261) temp___265) (of_rep1 temp___264))
  (= (select (to_array temp___261) temp___265) (select (to_array temp___262) temp___265)))))))))

(declare-fun temp___442 (us_t Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___444 us_t))
  (forall ((temp___445 Int) (temp___446 Int))
  (let ((temp___443 (temp___442 temp___444 temp___445 temp___446)))
  (and
  (and (= (first1 temp___443) (first1 temp___444))
  (= (last1 temp___443) (last1 temp___444)))
  (forall ((temp___447 Int))
  (ite (= temp___447 temp___445)
  (= (select (to_array temp___443) temp___447) (of_rep1 temp___446))
  (= (select (to_array temp___443) temp___447) (select (to_array temp___444) temp___447)))))))))
...
(declare-fun temp___448 () (Array Int integer))

(declare-fun temp___4481 () t)
...
;; H
  (assert
  (= (mk___t temp___448 temp___4481) (temp___442
                                     (mk___t a
                                     (mk (to_rep a__first) (to_rep a__last)))
                                     o new_val)))

(assert
;; WP_parameter_def
 ;; File "update_checks_1.ads", line 15, characters 0-0
  (not
  (= (ite (<= (to_rep (first temp___4481)) (to_rep (last temp___4481)))
     (+ (- (to_rep (last temp___4481)) (to_rep (first temp___4481))) 1) 0) 
