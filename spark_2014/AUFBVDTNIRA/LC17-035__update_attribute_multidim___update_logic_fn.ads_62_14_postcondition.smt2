...
(declare-fun user_eq4 (t18s t18s) Bool)

(declare-fun dummy4 () t18s)
...
(declare-fun user_eq5 (t19s t19s) Bool)

(declare-fun dummy5 () t19s)
...
(declare-fun user_eq6 (t20s t20s) Bool)

(declare-fun dummy6 () t20s)

(declare-datatypes () ((t20s__ref (mk_t20s__ref (t20s__content t20s)))))
(define-fun t20s__ref___projection ((a t20s__ref)) t20s (t20s__content a))

(declare-fun temp___230 (map1 Int (_ BitVec 8) Int Int Int (_ BitVec 8) Int
  Int) map1)

;; def_axiom
  (assert
  (forall ((temp___232 map1))
  (forall ((temp___233 Int) (temp___235 Int) (temp___236 Int)
  (temp___237 Int) (temp___239 Int) (temp___240 Int))
  (forall ((temp___234 (_ BitVec 8)) (temp___238 (_ BitVec 8)))
  (let ((temp___231 (temp___230 temp___232 temp___233 temp___234 temp___235
                    temp___236 temp___237 temp___238 temp___239 temp___240)))
  (forall ((temp___241 Int) (temp___243 Int))
  (forall ((temp___242 (_ BitVec 8)))
  (ite (and (and (= temp___241 temp___237) (= temp___242 temp___238))
       (= temp___243 temp___239))
  (= (get temp___231 temp___241 temp___242 temp___243) (of_rep temp___240))
  (ite (and (and (= temp___241 temp___233) (= temp___242 temp___234))
       (= temp___243 temp___235))
  (= (get temp___231 temp___241 temp___242 temp___243) (of_rep temp___236))
  (= (get temp___231 temp___241 temp___242 temp___243) (get temp___232
...
;; def_axiom
  ...
  (forall ((temp___247 Int) (temp___249 Int))
  (forall ((temp___248 (_ BitVec 8)))
  (= (get (temp___244 temp___246) temp___247 temp___248 temp___249) (of_rep
                                                                    temp___246))))))
...
;; WP_parameter_def
 ;; File "update_logic_fn.ads", line 49, characters 0-0
  ...
  (= (bool_eq4 a4 1 10 ((_ int2bv 8) 0) ((_ int2bv 8) 7) 0 2
     (temp___230 (temp___244 1000) 5 ((_ int2bv 8) 7) 1 v1 x y z v2) 1 10
