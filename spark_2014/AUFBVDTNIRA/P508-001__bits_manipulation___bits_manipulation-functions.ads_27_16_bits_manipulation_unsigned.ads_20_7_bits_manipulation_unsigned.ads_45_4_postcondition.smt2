...
;; msb_index_slow_inline_always__post_axiom
  ...
  (! (=>
     ...
     (and (= (shift_right value1 result) ((_ int2bv 64) 1))
...
(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index__result () Int)
...
(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index__result1 () Int)

(declare-fun result__3 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index__result2 () Int)

(declare-fun result__4 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index__result3 () Int)

(declare-fun result__5 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index__result4 () Int)

(declare-fun result__6 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index__result5 () Int)
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__msb_index__result1 
  bits_manipulation_unsigned__unsigned_64__functions__msb_index__result2))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__msb_index__result3 
  bits_manipulation_unsigned__unsigned_64__functions__msb_index__result1))
...
;; H
  ...
  (and (in_range o) (= (shift_right value o) ((_ int2bv 64) 1))))))

;; H
  (assert (=> (= 2 0) (= result result__)))
...
;; H
  ...
  (and (in_range o1) (= (shift_right value o1) ((_ int2bv 64) 1))))))

;; H
  (assert (=> (not (= 2 0)) (= result1 result__)))

;; H
  (assert (=> (not (= 2 0)) (= result__2 o1)))
...
;; H
  (assert
  (= result2 bits_manipulation_unsigned__unsigned_64__functions__msb_index__result))
...
;; H
  (assert
  (= (mk_int__ref
     bits_manipulation_unsigned__unsigned_64__functions__msb_index__result4) 
  (mk_int__ref
  bits_manipulation_unsigned__unsigned_64__functions__msb_index__result2)))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__msb_index__result5 
  bits_manipulation_unsigned__unsigned_64__functions__msb_index__result3))
...
;; H
  (assert
  (= result3 bits_manipulation_unsigned__unsigned_64__functions__msb_index__result4))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 10, characters 0-0
  (not
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_64__functions__msb_index__result4) ((_ int2bv 64) 1))))
(check-sat)
