...
;; H
  (assert (enrolmentisinprogress__function_guard
  (enrolmentisinprogress (int__content status1)) (int__content status1)))

;; H
  (assert (islocked__function_guard (islocked (us_private__content state4))
  (us_private__content state4)))

;; H
  (assert (thecurrentdoor__function_guard
  (thecurrentdoor (us_private__content state5))
  (us_private__content state5)))
...
;; H
  ...
  (alarm_timeout (us_private__content state5)) (us_private__content state5)))
...
;; H
  ...
  (alarm_timeout (us_private__content state5))) (thecurrenttime currenttime)
  (alarm_timeout (us_private__content state5))))

;; H
  (assert (thedooralarm__function_guard
  (thedooralarm (us_private__content state5)) (us_private__content state5)))

;; H
  (assert (rolepresent__function_guard
  (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields2)))
  (mk___rep (us_split_fields__content theadmin__split_fields2))))

;; H
  (assert (isgood__function_guard (isgood (us_private__content state3))
  (us_private__content state3)))

;; H
  (assert (authcertvalid__function_guard
  (authcertvalid (us_private__content state3)) (us_private__content state3)))

;; H
  (assert (theauthcertrole__function_guard
  (theauthcertrole (us_private__content state3))
  (us_private__content state3)))
...
;; H
  (assert (isdoingop__function_guard
  (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))
  (mk___rep (us_split_fields__content theadmin__split_fields2))))
...
;; H
  (assert (ispresent__function_guard
  (ispresent (mk___rep (us_split_fields__content theadmin__split_fields2)))
  (mk___rep (us_split_fields__content theadmin__split_fields2))))
...
;; H
  (assert
  (and (= o19 (islocked (us_private__content state4)))
  (islocked__function_guard o19 (us_private__content state4))))

;; H
  (assert (= o20 (ite (not (= o19 true)) true false)))

;; H
  (assert (= result (ite (= o20 true) (islocked state1) false)))
...
;; H
  ...
  (= o21 (thecurrentop
         (mk___rep
         (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (thecurrentop__function_guard o21
  (mk___rep
  (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (in_range3 o21))))

;; H
  (assert (=> (= result true) (= o22 (ite (= o21 3) true false))))
...
;; H
  (assert
  (and (= o11 (islocked (us_private__content state4)))
  (islocked__function_guard o11 (us_private__content state4))))

;; H
  (assert (= o12 (ite (not (= o11 true)) true false)))

;; H
  (assert (= result1 (ite (= o12 true) (islocked state1) false)))

;; H
  (assert
  (=> (= result1 true)
  (and
  (and (= o15 (theauthcertrole (us_private__content state3)))
  (theauthcertrole__function_guard o15 (us_private__content state3)))
  (in_range1 o15))))

;; H
  (assert (=> (= result1 true) (= o16 (ite (= o15 1) true false))))

;; H
  (assert
  (=> (= result1 true)
  (and (= o13 (authcertvalid (us_private__content state3)))
  (authcertvalid__function_guard o13 (us_private__content state3)))))

;; H
  (assert
  (=> (= result1 true)
  (and (= o14 (isgood (us_private__content state3))) (isgood__function_guard
  o14 (us_private__content state3)))))

;; H
  (assert (=> (= result1 true) (= o17 (ite (= o14 true) o13 false))))

;; H
  (assert (=> (= result1 true) (= o18 (ite (= o17 true) o16 false))))
...
;; H
  ...
  (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range1
  o)))
...
;; H
  ...
  (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range3
  o1))))
