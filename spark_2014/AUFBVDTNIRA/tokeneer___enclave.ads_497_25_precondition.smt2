...
;; H
  (assert (= o19 (islocked (us_private__content state4))))
...
;; H
  (assert (= o11 (islocked (us_private__content state4))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o15 (theauthcertrole (us_private__content state3))) (in_range1
  o15))))
...
;; H
  (assert
  (=> (= result1 true) (= o13 (authcertvalid (us_private__content state3)))))

;; H
  (assert
  (=> (= result1 true) (= o14 (isgood (us_private__content state3)))))
