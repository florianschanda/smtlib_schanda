...
;; H
  (assert
  (and (and (= o14 (base Tuple0)) (base__function_guard o14 Tuple0))
  (= o14 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o16 (oexpon o14 o15)) (oexpon__function_guard o16 o14 o15)))
...
;; H
  (assert
  (and (= o8 (num_of_big_int x x_first o7)) (num_of_big_int__function_guard
  o8 x x_first o7)))

;; H
  (assert (and (= o13 (oexpon o8 o12)) (oexpon__function_guard o13 o8 o12)))

;; H
  (assert
  (and (= o17 (omultiply o13 o16)) (omultiply__function_guard o17 o13 o16)))

;; H
  (assert (and (= o20 (omod o17 o19)) (omod__function_guard o20 o17 o19)))
