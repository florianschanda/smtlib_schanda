...
(declare-fun e__split_fields () integer)

(declare-fun e__split_fields1 () integer)

(declare-fun e__split_fields2 () us_private)

(declare-fun usq_ () integer)

(declare-fun usq_1 () integer)

(declare-fun usq_2 () us_private)
...
(declare-fun e__split_fields3 () us_split_fields2)
...
;; H
  (assert
  (= (mk___rep1 (mk___split_fields1 usq_ usq_1 usq_2) usq_3) (rec__tests__pair__a
                                                             (us_split_fields7
                                                             c))))
...
;; H
  ...
  (= result4 (mk___split_fields__ref1
             (mk___split_fields1 e__split_fields e__split_fields1
             e__split_fields2))))
