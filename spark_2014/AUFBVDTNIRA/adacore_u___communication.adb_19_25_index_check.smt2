...
(define-fun bool_eq4 ((a (Array Int data)) (a__first Int) (a__last Int)
...
(assert
;; WP_parameter_def
 ;; File "communication.ads", line 16, characters 0-0
  (not (<= (to_rep3 (first b__split_fields1)) (to_rep1 b__split_fields2))))
(check-sat)
