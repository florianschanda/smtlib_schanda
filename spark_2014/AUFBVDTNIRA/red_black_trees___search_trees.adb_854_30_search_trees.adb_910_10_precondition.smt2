...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1683 o45))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1683 o45)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o45))
...
;; H
  (assert (= o46 (select temp___1683 i1)))
...
;; H
  (assert (valid_root__function_guard
  (valid_root (rec__search_trees__search_tree__struct t__split_fields10) o44)
