...
;; H
  (assert
  (= rdx1 (bvor (bvand rdx ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) 
  val__))))
...
;; H
  (assert (writereglow8post__function_guard (writereglow8post rdx rdx2 val__)
  rdx rdx2 val__))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not (= (writereglow8post rdx rdx2 val__) true)))
(check-sat)
