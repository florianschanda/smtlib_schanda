...
;; H
  (assert
  (forall ((i2 Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i2 0)
  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i2 0)))

;; H
  (assert
  (forall ((i2 Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i2 1)
...
;; H
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res2 i2)))) 100)
  (<= (to_rep
      (rec__red_black_trees__black_count__depth
      (us_split_fields11 (select res2 i2)))) n2)))))
...
;; H
  ...
  (ite (and
       ...
       (< n2 (to_rep
             (rec__red_black_trees__black_count__depth
             (us_split_fields11 (select res2 i2))))))
  (< (length
     (rec__tree_model__path_type__a (us_split_fields1 (select m i2)))) (- 100 
  n2))
  (=>
  (= (rec__tree_model__path_type__k (us_split_fields1 (select m i2))) true)
  (and
  ...
  (=
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select res2 i2))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11
     (select res2 (peek
                  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i2
                  0))))) (to_rep
                         (rec__red_black_trees__black_count__count
                         (us_split_fields11
                         (select res2 (peek
                                      (rec__red_black_trees__rbt__struct
                                      (us_split_fields9 t)) i2 1))))))))
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res2 i2)))) (+ 1 (ite (< (to_rep
                                                         (rec__red_black_trees__black_count__depth
                                                         (us_split_fields11
                                                         (select res2 
                                                         (peek
  ...
  (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t))
               i2 1))))) (to_rep
                         ...
                         (select res2 (peek
                                      (rec__red_black_trees__rbt__struct
                                      (us_split_fields9 t)) i2 0)))))))))
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select res2 i2)))) (+ (ite (= (to_rep3
...
;; H
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res2 j)))) (+ n2 1)))))
