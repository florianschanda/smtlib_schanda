...
;; H
  ...
  (= o4 (max_input_length
        (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))))
  (max_input_length__function_guard o4
  (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))))
  (and (in_range6 o4)
  (= o4 (- (rate_of
           (mk___rep
...
;; H
  (assert (= result (ite (<= in_data_bit_length o4) true false)))
...
;; H
  (assert (and (= o3 (length in_data)) (in_range (length in_data))))

;; H
  (assert (= result1 (ite (<= o2 o3) true false)))
...
;; H
  ...
  (= o (rate_of
       (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))))
  (rate_of__function_guard o
  (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))))
  (and (in_range5 o) (= o (to_rep3 ctx__split_fields1)))))

;; H
  (assert (= result2 (ite (<= out_data_bit_length o) true false)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range (+ out_data_bit_length 7))))
(check-sat)
