...
;; H
  (assert (and (= o7 (+ a_first length1)) (in_range1 (+ a_first length1))))

;; H
  (assert
  (and
  (= o8 (sorted (mk___t a (mk (to_rep a__first) (to_rep a__last))) o7
        length2))
  (sorted__function_guard o8
  (mk___t a (mk (to_rep a__first) (to_rep a__last))) o7 length2)))

;; H
  (assert
  (and
  (= o6 (sorted (mk___t a (mk (to_rep a__first) (to_rep a__last))) a_first
        length1))
  (sorted__function_guard o6
  (mk___t a (mk (to_rep a__first) (to_rep a__last))) a_first length1)))

;; H
  (assert (and (= o4 (+ length1 length2)) (in_range1 (+ length1 length2))))

;; H
  (assert (= o5 (ite (<= o4 2147483647) true false)))

;; H
  (assert
  (=> (<= (to_rep b__first) (to_rep b__last))
  (= o (+ (- (to_rep b__last) (to_rep b__first)) 1))))

;; H
  (assert (=> (not (<= (to_rep b__first) (to_rep b__last))) (= o 0)))

;; H
  (assert (and (= o1 o) (in_range1 o)))

;; H
  (assert (and (= o2 (+ length1 length2)) (in_range1 (+ length1 length2))))

;; H
  (assert (= o3 (ite (<= o2 o1) true false)))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range1 (+ (to_rep a__last) 1))))
(check-sat)
