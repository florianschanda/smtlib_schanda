...
;; H
  (assert (= (to_rep o18) 10))

;; H
  (assert (= o19 (store x9 10 o18)))
...
(assert
;; WP_parameter_def
 ;; File "array_arith.adb", line 45, characters 0-0
  (not (= (to_rep (select x11 j)) j)))
(check-sat)
