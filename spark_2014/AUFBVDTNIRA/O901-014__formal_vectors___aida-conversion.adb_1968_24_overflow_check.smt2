...
(declare-fun temp___2578 () (Array Int integer))
...
;; H
  (assert
  (=> (and (<= temp___2580 index1) (<= index1 temp___2581))
  (= temp___2578 n1)))
...
;; H
  (assert
  (=> (and (<= temp___2580 index1) (<= index1 temp___2581)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___2580 index1) (<= index1 temp___2581)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2580 index1) (<= index1 temp___2581)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2580 index1) (<= index1 temp___2581)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___2580 index1) (<= index1 temp___2581)) (= n2 o8)))
...
;; H
  ...
  (=> (< index2 temp___2579)
  (= (select n3 temp___2579) (select temp___2578 temp___2579))))))
...
;; H
  (assert
  (=> (and (<= temp___2580 index1) (<= index1 temp___2581)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___2580 index1) (<= index1 temp___2581)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___2580 index1) (<= index1 temp___2581)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___2580 index1) (<= index1 temp___2581)))
...
;; H
  (assert
  (=> (not (and (<= temp___2580 index1) (<= index1 temp___2581))) (= n7 n1)))
...
;; H
  (assert
  (and (= temp___2582 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2582)
  (<= temp___2582 (to_rep1 n__last))))

;; H
  (assert (= o9 temp___2582))
...
;; H
  (assert
  (and (= temp___2583 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2583)
  (<= temp___2583 (to_rep1 n__last))))

;; H
  (assert (= o14 temp___2583))
...
;; H
  (assert
  (and (= temp___2584 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2584)
  (<= temp___2584 (to_rep1 n__last))))

;; H
  (assert (= o21 temp___2584))
...
;; H
  (assert
  (and (= temp___2585 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2585)
  (<= temp___2585 (to_rep1 n__last))))

;; H
  (assert (= o28 temp___2585))
