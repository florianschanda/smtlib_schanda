...
;; H
  (assert (sorted__function_guard
  (sorted (mk___t (map__content a25) (mk (to_rep a__first) (to_rep a__last)))
  0 (- (int__content j23) 1))
  (mk___t (map__content a25) (mk (to_rep a__first) (to_rep a__last))) 0
  (- (int__content j23) 1)))
