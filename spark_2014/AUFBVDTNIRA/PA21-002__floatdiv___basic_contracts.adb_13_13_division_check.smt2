...
;; num__def_axiom
  (assert (= num (of_int RNE1 numerator)))

;; den__def_axiom
  (assert (= den (of_int RNE1 denominator)))
...
;; H
  (assert
  (and (= basic_contracts__average__num__assume (of_int RNE1 numerator))
  (tqtisFinite (of_int RNE1 numerator))))
...
;; H
  (assert
  (and (= basic_contracts__average__den__assume (of_int RNE1 denominator))
  (tqtisFinite (of_int RNE1 denominator))))
