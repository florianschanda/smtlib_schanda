...
;; H
  (assert
  (and (= o (div1 RNE2 right left)) (tqtisFinite (div1 RNE2 right left))))
...
;; H
  (assert
  (and (and (= o2 (atan__2 o1)) (atan__2__function_guard o2 o1)) (tqtisFinite
  o2)))
...
;; H
  (assert (le left fliteral4))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (tqtisFinite (sub RNE2 result__1 fliteral3))))
(check-sat)
