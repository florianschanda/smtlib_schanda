...
;; H
  ...
  (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) i1) 0))))

;; H
  (assert
  (forall ((i1 Int))
  (=> (and (<= first i1) (<= i1 (- fst1 1)))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) i1) (get
                                                                    (model__
                                                                    (mk___rep
                                                                    v__split_discrs
                                                                    (mk___split_fields
...
;; H
  ...
  (=>
  (and (<= current2 i1)
  (<= i1 (last5 (model__ (mk___rep v__split_discrs v__split_fields2)))))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) i1) (get
                                                                    (model__
                                                                    (mk___rep
                                                                    v__split_discrs
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (dynamic_property1 first1 last1 i)))
(check-sat)
