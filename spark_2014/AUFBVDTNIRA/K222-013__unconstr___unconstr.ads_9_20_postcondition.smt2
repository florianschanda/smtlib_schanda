...
(define-fun bool_eq2 ((a (Array Int myint)) (a__first Int) (a__last Int)
...
(define-fun of_array1 ((a (Array Int myint)) (f Int)
...
;; object__component__size_axiom
  (assert
  (forall ((a (Array Int myint))) (<= 0 (object__component__size1 a))))
...
;; def_axiom
  ...
  (let ((temp___174 (temp___173 temp___175 temp___176 temp___177)))
  (and
  (=> (dynamic_property (- 2147483648) 2147483647 temp___176 temp___177)
  (and (= (first4 temp___174) temp___176) (= (last4 temp___174) temp___177)))
  (forall ((temp___178 Int))
  (= (select (to_array1 temp___174) temp___178) (of_rep1 temp___175)))))))
...
(declare-fun x () (Array Int myint))

(declare-fun temp___180 () (Array Int myint))

(declare-fun temp___1801 () t1)

(declare-fun temp___181 () (Array Int myint))

(declare-fun temp___1811 () t)

(declare-fun temp___182 () (Array Int myint))

(declare-fun temp___1821 () t)

(declare-fun o () (Array Int myint))

(declare-fun result () (Array Int myint))

(declare-fun x1 () (Array Int myint))

(declare-fun x2 () (Array Int myint))

(declare-fun x3 () (Array Int myint))
...
;; H
  (assert
  (= (to_rep
     (first3 (rt1 (temp___173 0 (to_rep x__first) (to_rep x__last))))) 
  (to_rep x__first)))

;; H
  (assert
  (= (to_rep (last3 (rt1 (temp___173 0 (to_rep x__first) (to_rep x__last))))) 
  (to_rep x__last)))

;; H
  (assert
  (= (mk___t1 temp___180 temp___1801) (temp___173 0 (to_rep x__first)
                                      (to_rep x__last))))
...
;; H
  (assert
  (= (mk (to_rep (first3 temp___1801)) (to_rep (last3 temp___1801))) 
  temp___1811))

;; H
  (assert
  (= (ite (<= (to_rep (first temp___1811)) (to_rep (last temp___1811)))
     (+ (- (to_rep (last temp___1811)) (to_rep (first temp___1811))) 1) 0) 
  (ite (<= (to_rep x__first) (to_rep x__last))
  (+ (- (to_rep x__last) (to_rep x__first)) 1) 0)))

;; H
  (assert
  (= (mk___t temp___182 temp___1821) (mk___t temp___181 temp___1811)))

;; H
  (assert
  (= o (slide temp___182 (to_rep (first temp___1821)) (to_rep x__first))))
...
;; WP_parameter_def
 ;; File "unconstr.ads", line 7, characters 0-0
  (not (= (to_rep1 (select x2 (to_rep x__first))) 0)))
(check-sat)
