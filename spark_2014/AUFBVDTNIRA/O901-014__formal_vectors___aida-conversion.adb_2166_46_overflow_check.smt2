...
(declare-fun temp___2364 () (Array Int integer))

(declare-fun temp___23641 () t2)
...
(declare-fun temp___2372 () (Array Int integer))

(declare-fun temp___23721 () t4)
...
(declare-fun temp___2378 () Int)

(declare-fun temp___2379 () Int)

(declare-fun temp___2377 () Int)

(declare-fun temp___2375 () (Array Int integer))
...
;; H
  (assert
  (=> (and (<= temp___2378 index1) (<= index1 temp___2379))
  (= temp___2377 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2378 index1) (<= index1 temp___2379)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___2378 index1) (<= index1 temp___2379)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2378 index1) (<= index1 temp___2379)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2378 index1) (<= index1 temp___2379)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___2378 index1) (<= index1 temp___2379)) (= n2 o8)))
...
;; H
  ...
  (=> (< index2 temp___2376)
  (= (select n3 temp___2376) (select temp___2375 temp___2376)))))
  (=>
...
;; H
  (assert
  (=> (and (<= temp___2378 index1) (<= index1 temp___2379)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___2378 index1) (<= index1 temp___2379)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___2378 index1) (<= index1 temp___2379)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___2378 index1) (<= index1 temp___2379)))
...
;; H
  (assert
  (=> (not (and (<= temp___2378 index1) (<= index1 temp___2379))) (= n7 n1)))
...
;; H
  (assert
  (and (= temp___2380 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2380)
  (<= temp___2380 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___2381 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2381)
  (<= temp___2381 (to_rep1 n__last))))

;; H
  (assert (= o14 temp___2381))
...
;; H
  (assert
  (and (= temp___2382 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2382)
  (<= temp___2382 (to_rep1 n__last))))

;; H
  (assert (= o21 temp___2382))
...
;; H
  (assert
  (and (= temp___2383 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2383)
  (<= temp___2383 (to_rep1 n__last))))

;; H
  (assert (= o28 temp___2383))
