...
(declare-fun temp___2723 () Int)

(declare-fun temp___2721 () (Array Int integer))
...
;; H
  ...
  (<= index7 (+ (to_rep1 (first (rt source))) 4)))
...
;; H
  (assert
  (=> (and (<= temp___2724 index1) (<= index1 temp___2725))
  (= temp___2723 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2724 index1) (<= index1 temp___2725)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___2724 index1) (<= index1 temp___2725)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2724 index1) (<= index1 temp___2725)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2724 index1) (<= index1 temp___2725)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___2724 index1) (<= index1 temp___2725)) (= n2 o8)))
...
;; H
  ...
  (=> (< index2 temp___2722)
  (= (select n3 temp___2722) (select temp___2721 temp___2722)))))
  (=>
...
;; H
  (assert
  (=> (and (<= temp___2724 index1) (<= index1 temp___2725)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___2724 index1) (<= index1 temp___2725)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___2724 index1) (<= index1 temp___2725)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___2724 index1) (<= index1 temp___2725)))
...
;; H
  (assert
  (=> (not (and (<= temp___2724 index1) (<= index1 temp___2725))) (= n7 n1)))
...
;; H
  (assert
  (and (= temp___2726 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2726)
  (<= temp___2726 (to_rep1 n__last))))

;; H
  (assert (= o9 temp___2726))
...
;; H
  (assert
  (and (= temp___2727 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2727)
  (<= temp___2727 (to_rep1 n__last))))

;; H
  (assert (= o14 temp___2727))
...
;; H
  (assert
  (and (= temp___2728 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2728)
  (<= temp___2728 (to_rep1 n__last))))

;; H
  (assert (= o21 temp___2728))
...
;; H
  (assert
  (and (= temp___2729 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2729)
  (<= temp___2729 (to_rep1 n__last))))

;; H
  (assert (= o28 temp___2729))
