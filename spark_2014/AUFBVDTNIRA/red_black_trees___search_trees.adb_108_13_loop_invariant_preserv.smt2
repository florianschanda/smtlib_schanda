...
(define-fun dynamic_invariant8 ((temp___expr_168 Int)
  (temp___is_init_165 Bool) (temp___skip_constant_166 Bool)
  (temp___do_toplevel_167 Bool)) Bool (=>
                                      (or (= temp___is_init_165 true)
                                      (<= 0 1)) (in_range8 temp___expr_168)))

(define-fun dynamic_invariant9 ((temp___expr_205 us_rep1)
...
;; size__post_axiom
  (assert
  (forall ((f1 us_rep3))
  (! (=> (dynamic_invariant5 f1 true true true) (dynamic_invariant6 (size f1)
...
;; position__post_axiom
  ...
  (! (=>
     ...
     true true)) (not (= (parent f1 i1) 0))) (dynamic_invariant8
     (position f1 i1) true false true)) :pattern ((position f1 i1)) ))))
...
(declare-fun temp___12701 () Int)

(declare-fun result3 () int__ref)

(declare-fun temp___12691 () Int)
...
;; H
  (assert (= result2 (mk_int__ref temp___1270)))
...
;; H
  (assert (= result3 (mk_int__ref temp___1269)))
...
;; H
  (assert (= result4 (ite (< o o1) true false)))
...
;; H
  (assert (=> (= result4 true) (and (= o3 o2) (in_range2 o2))))

;; H
  (assert (=> (= result4 true) (= result5 (mk_int__ref ki2))))

;; H
  (assert (=> (= result4 true) (= ki3 o3)))

;; H
  (assert (=> (= result4 true) (= kj3 kj2)))
...
;; H
  (assert (=> (not (= result4 true)) (= result6 (ite (< o4 o5) true false))))
...
;; H
  (assert (=> (not (= result4 true)) (=> (= result6 true) (= kj3 o7))))

;; H
  (assert (=> (not (= result4 true)) (=> (= result6 true) (= ki4 ki2))))
...
;; H
  (assert (=> (not (= result4 true)) (=> (not (= result6 true)) (= ki4 o9))))

;; H
  (assert
  (=> (not (= result4 true))
  (=> (not (= result6 true))
  (and (= o10 (parent f kj2))
  (and (in_range6 o10)
...
;; H
  (assert (=> (not (= result4 true)) (= ki3 ki4)))
...
;; H
  (assert
  (< (length
     (rec__tree_model__path_type__a (us_split_fields1 (select m ki3)))) 
  (length (rec__tree_model__path_type__a (us_split_fields1 (select m kj3))))))
