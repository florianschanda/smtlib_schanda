...
;; H
  (assert
  (and (le1 (neg1 fliteral1) (to_rep1 (select d4 3))) (le1
  (to_rep1 (select d4 3)) fliteral1)))

;; H
  (assert
  (and (le1 (neg1 fliteral1) (to_rep1 (select d4 4))) (le1
  (to_rep1 (select d4 4)) fliteral1)))
...
;; WP_parameter_def
 ;; File "floats.ads", line 5, characters 0-0
  (not (le1 (neg1 fliteral1) (to_rep1 (select d4 i)))))
(check-sat)
