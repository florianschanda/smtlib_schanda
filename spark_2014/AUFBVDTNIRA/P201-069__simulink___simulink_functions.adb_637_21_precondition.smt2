...
(declare-fun sqrt3 (t1) t1)

(declare-fun sqrt__function_guard (t1 t1) Bool)
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (le1 fliteral4 (to_float64 RNE1 f))))
(check-sat)
