...
;; H
  (assert
  (= o32 (select temp___2364 (int__content search_trees__find_root__result4))))
...
;; H
  (assert (= o29 (select temp___2363 i)))
...
;; H
  (assert
  (= o26 (select temp___2362 (int__content search_trees__find_root__result4))))
...
;; H
  (assert (= o23 (select temp___2361 j)))
...
;; H
  (assert
  (= (mk___rep (mk___split_fields o19 o20)) (select temp___2360 (int__content
...
;; H
  (assert
  (= (mk___rep (mk___split_fields o12 o13)) (select temp___2359 (int__content
                                                                search_trees__find_root__result4))))
