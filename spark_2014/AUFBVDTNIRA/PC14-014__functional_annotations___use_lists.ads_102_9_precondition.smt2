...
;; H
  ...
  (and (not (= (has_key o18 no_element) true))
  (forall ((i2 us_rep1))
  (=> (= (has_key o18 i2) true)
  (and
  (and (<= 1 (get1 o18 i2))
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o18 j) true)
  (=> (= (get1 o18 i2) (get1 o18 j)) (= (bool_eq3 i2 j) true))))))))))
...
;; H
  ...
  (and (in_range5 o22)
  (=> (= (of_int 0) true)
  (and (= o22 (w_get o18 (witness o18 cu)))
  (forall ((k us_rep1))
  (=> (= (has_key o18 k) true)
  (= (= (bool_eq3 k cu) true) (= (witness o18 cu) (witness o18 k))))))))))
...
;; H
  (assert
  (and (= o17 (has_key o16 cu))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o16 k) true) (= (bool_eq3 k cu) true))) (= o17 true)))))
...
;; H
  ...
  (= o12 (length
         (mk___rep l__split_discrs (mk___split_fields l__split_fields8))))
  (and (in_range2 o12)
  (<= o12 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
...
;; H
  (assert (= o14 (ite (<= o11 i1) true false)))
