...
;; to_int_def
  ...
  (forall ((x Int))
  (! (ite (= x 0) (= (to_int3 x) 0)
     (ite (< 0 x) (pos_div_relation1 (to_int3 x) x 1000000000)
     (pos_div_relation1 (- (to_int3 x)) (- x) 1000000000))) :pattern (
  (to_int3 x)) )))
...
;; range_axiom
  (assert (forall ((x my_duration)) (in_range2 (to_fixed1 x))))

;; coerce_axiom
  (assert
  (forall ((x Int))
  (! (=> (in_range2 x) (= (to_fixed1 (of_fixed1 x)) x)) :pattern ((to_fixed1
                                                                  (of_fixed1
                                                                  x))) )))
...
(define-fun in_range3 ((x Int)) Bool (and (<= (- 10000000000) x)
                                     (<= x 10000000000)))
...
;; to_int_def
  ...
  (forall ((x Int))
  (! (ite (= x 0) (= (to_int4 x) 0)
     (ite (< 0 x) (pos_div_relation2 (to_int4 x) x 1000000000)
     (pos_div_relation2 (- (to_int4 x)) (- x) 1000000000))) :pattern (
  (to_int4 x)) )))
...
;; range_axiom
  (assert (forall ((x my_subduration)) (in_range3 (to_fixed2 x))))

;; coerce_axiom
  (assert
  (forall ((x Int))
  (! (=> (in_range3 x) (= (to_fixed2 (of_fixed2 x)) x)) :pattern ((to_fixed2
                                                                  (of_fixed2
                                                                  x))) )))
...
(assert
;; WP_parameter_def
 ;; File "fxp_false_check_1b.adb", line 3, characters 0-0
  (not
  (or (< (to_fixed (of_fixed (to_fixed1 md1))) 0)
  (< (to_fixed (of_fixed (to_fixed2 ms1))) 0))))
(check-sat)
