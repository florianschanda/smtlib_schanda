...
(declare-fun keyeddatapresence2 () int__ref)

(declare-fun keyeddata__split_fields2 () us_split_fields__ref)

(declare-fun theop3 () int__ref)
...
(declare-fun theadmin__split_fields8 () us_split_fields2)

(declare-fun status4 () Int)

(declare-fun keyeddatapresence3 () Int)

(declare-fun keyeddata__split_fields3 () us_split_fields)

(declare-fun theop4 () Int)

(declare-fun result2 () Bool)

(declare-fun result3 () Bool)

(define-fun theadmin__split_fields9 () us_split_fields2 (mk___split_fields1
                                                        theadmin__split_fields4
                                                        theadmin__split_fields5))

(define-fun keyeddata__split_fields4 () us_split_fields (mk___split_fields
                                                        keyeddata__split_fields
                                                        keyeddata__split_fields1))

(define-fun theadmin__split_fields10 () us_split_fields2 (mk___split_fields1
...
;; H
  ...
  (ite (= (ite (exists ((op Int))
               ...
               (and
               (and
               (= (str_comp (mk___rep keyeddata__split_fields4) op) true)
               (= (allowedop
                  (mk___rep1
          ...
          true (= o 0)) true) (ite (= (ite (exists ((op Int))
                                           ...
                                           (= (str_comp
                                              (mk___rep
                                              keyeddata__split_fields4) op) true)
                                           (= (allowedop
                                              (mk___rep1
                                              (mk___split_fields1
...
;; H
  (assert
  (=> (= keyeddatapresence1 0) (= (mk_int__ref result) (mk_int__ref theop))))
...
;; H
  (assert
  (=> (= keyeddatapresence1 0)
  (=> (not (= theop2 0)) (= (mk_int__ref result1) (mk_int__ref status)))))

;; H
  (assert
  (=> (= keyeddatapresence1 0) (=> (not (= theop2 0)) (= status2 6))))

;; H
  (assert
  (=> (= keyeddatapresence1 0)
  (=> (not (= theop2 0)) (and (= o1 theop2) (in_range8 theop2)))))
...
;; H
  ...
  (and
  (and
  (= (rolepresent (mk___rep1 theadmin__split_fields9)) (rolepresent
                                                       (mk___rep1
                                                       (mk___split_fields1
                                                       theadmin__split_fields
                                                       theadmin__split_fields1))))
  (= (ispresent (mk___rep1 theadmin__split_fields9)) true))
  (= (isdoingop (mk___rep1 theadmin__split_fields9)) true))
  (= (thecurrentop (mk___rep1 theadmin__split_fields9)) o1)))))
...
;; H
  (assert
  (=> (= keyeddatapresence1 0)
  (=> (not (= theop2 0)) (= (valid_numberlogentries state6) true))))
...
;; H
  (assert
  (=> (= keyeddatapresence1 0)
  (=> (not (not (= theop2 0))) (= (valid_numberlogentries state8) true))))

;; H
  (assert
  (=> (= keyeddatapresence1 0)
  (=> (not (not (= theop2 0))) (= status2 status))))
...
;; H
  (assert
  (=> (= keyeddatapresence1 0)
  (=> (not (not (= theop2 0))) (= state5 state7))))

;; H
  (assert
  (=> (= keyeddatapresence1 0)
  (=> (not (not (= theop2 0))) (= state6 state8))))

;; H
  (assert
  (=> (= keyeddatapresence1 0)
  (=> (not (not (= theop2 0))) (= filestate2 filestate3))))

;; H
  (assert
  (=> (= keyeddatapresence1 0)
  (=> (not (not (= theop2 0))) (= status2 status1))))
...
;; H
  (assert (=> (not (= keyeddatapresence1 0)) (= state5 state2)))
...
;; H
  (assert
  (= keyeddata__split_fields2 (mk___split_fields__ref
                              keyeddata__split_fields4)))
...
;; H
  (assert (= state5 state10))

;; H
  (assert (= state6 state9))

;; H
  (assert (= filestate2 filestate4))

;; H
  (assert (= theop4 theop2))

;; H
  (assert (= keyeddata__split_fields3 keyeddata__split_fields4))
...
;; H
  ...
  (rolepresent__function_guard o30
  (mk___rep1
  (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7))))
  (in_range9 o30))))
...
;; H
  (assert
  (=> (= (int__content status3) 8) (= o31 (ite (= o30 0) true false))))
...
;; H
  (assert
  (=> (= (int__content status3) 8)
  (= o32 (ite (not (= o29 true)) true false))))

;; H
  (assert
  (=> (= (int__content status3) 8) (= o33 (ite (= o32 true) o31 false))))

;; H
  (assert (=> (not (= (int__content status3) 8)) (= o33 (of_int 1))))
...
;; H
  ...
  (= o25 (rolepresent
         (mk___rep1
         (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7))))
  (rolepresent__function_guard o25
  (mk___rep1
  (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7))))
  (in_range9 o25))))
...
;; H
  (assert
  (=> (= (int__content status3) 3) (= o26 (ite (= o25 o24) true false))))
...
;; H
  (assert
  (=> (= (int__content status3) 3)
  (= o27 (ite (not (= o23 true)) true false))))

;; H
  (assert
  (=> (= (int__content status3) 3) (= o28 (ite (= o27 true) o26 false))))

;; H
  (assert (=> (not (= (int__content status3) 3)) (= o28 (of_int 1))))
...
;; H
  (assert
  (=> (=> (not (= (int__content status3) 6)) (= (int__content status3) 7))
  (= o21 (ite (= o17 true) o16 false))))

;; H
  (assert
  (=> (=> (not (= (int__content status3) 6)) (= (int__content status3) 7))
  (= o22 (ite (= o21 true) o20 false))))
...
;; H
  (assert (= o13 (ite (= o12 4) true false)))
...
;; H
  (assert (= result2 (ite (= o14 true) o13 false)))

;; H
  (assert
  (=> (= result2 true) (= o15 (ite (= (int__content status3) 6) true false))))
...
;; H
  (assert (= result3 (ite (= o4 1) true false)))
...
;; H
  (assert (=> (= result3 true) (= o9 (ite (not (= o8 true)) true false))))
...
;; H
  ...
  (= o5 (thecurrentop
        (mk___rep1
        (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7))))
  (thecurrentop__function_guard o5
  (mk___rep1
  (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7))))
  (in_range8 o5))))

;; H
  (assert (=> (= result3 true) (= o6 (ite (= o5 3) true false))))
...
;; H
  (assert (=> (= result3 true) (= o10 (ite (= o7 true) o6 false))))

;; H
  (assert (=> (= result3 true) (= o11 (ite (= o10 false) o9 true))))
...
;; WP_parameter_def
 ;; File "enclave.adb", line 2122, characters 0-0
  ...
  (= (isdoingop
     (mk___rep1
     (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7))) true)))
(check-sat)
