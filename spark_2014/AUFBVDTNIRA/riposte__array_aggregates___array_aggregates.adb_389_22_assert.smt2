...
(declare-fun user_eq2 (t113b t113b) Bool)

(declare-fun dummy2 () t113b)

(declare-datatypes () ((t113b__ref (mk_t113b__ref (t113b__content t113b)))))
(define-fun t113b__ref___projection ((a t113b__ref)) t113b (t113b__content a))

(declare-fun temp___632 (Int Int) (Array Int unsigned_byte))

;; def_axiom
  (assert
  (forall ((temp___634 Int) (temp___635 Int))
  (let ((temp___633 (temp___632 temp___634 temp___635)))
  (forall ((temp___636 Int))
  (ite (and (<= 2 temp___636) (<= temp___636 5))
  (= (select temp___633 temp___636) (of_rep temp___634))
  (= (select temp___633 temp___636) (of_rep temp___635)))))))
...
(assert
;; WP_parameter_def
 ;; File "array_aggregates.adb", line 374, characters 0-0
