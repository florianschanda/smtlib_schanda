...
;; H
  (assert (=> (and (<= 0 s2) (<= s2 100)) (= o6 (select temp___500 s3))))

;; H
  (assert
  (=> (and (<= 0 s2) (<= s2 100))
  (and (and (= o1 (name o6)) (name__function_guard o1 o6))
...
;; H
  (assert
  (forall ((t1 Int)) (from__2__function_guard (from__2 (select cfv2 t1))
  (select cfv2 t1))))
...
;; H
  (assert
  (forall ((t1 Int)) (name__2__function_guard
  (name__2 (select (map__content2 av6) (from__2 (select cfv2 t1))))
  (select (map__content2 av6) (from__2 (select cfv2 t1))))))
...
;; H
  (assert
  (forall ((t1 Int)) (to____function_guard
  (to__ (select (owned_transition sm) t1))
  (select (owned_transition sm) t1))))
...
;; H
  (assert
  (forall ((t1 Int)) (name__function_guard
  (name (select (owned_state sm) (to__ (select (owned_transition sm) t1))))
  (select (owned_state sm) (to__ (select (owned_transition sm) t1))))))

;; H
  (assert
  (forall ((t1 Int)) (to__2__function_guard (to__2 (select cfv2 t1))
  (select cfv2 t1))))
...
;; H
  ...
  (select (map__content2 av6) (to__2 (select cfv2 t1))))))
