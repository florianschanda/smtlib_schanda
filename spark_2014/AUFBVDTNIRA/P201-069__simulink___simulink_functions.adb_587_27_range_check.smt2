...
;; H
  (assert
  (and (= o (sqrt2 (of_ubv16 RNA1 i)))
  (and (tqtisFinite o)
  (and (le fliteral2 o)
  (and (=> (eq (of_ubv16 RNA1 i) fliteral2) (eq o fliteral2))
  (and (=> (eq (of_ubv16 RNA1 i) fliteral) (eq o fliteral))
  (=> (le fliteral3 (of_ubv16 RNA1 i)) (lt fliteral2 o))))))))

;; H
  (assert (= o1 (roundToIntegral RNA1 o)))

(assert
;; WP_parameter_def
 ;; File "interfac.ads", line 66, characters 0-0
  (not (le (of_ubv16 RTP1 ((_ int2bv 16) 0)) o1)))
(check-sat)
