...
;; H
  (assert (is_perm__function_guard (is_perm o22 o24) o22 o24))
...
;; H
  (assert
  (and (and (= o23 (remove a o10)) (remove__function_guard o23 a o10))
...
;; H
  (assert
  (and (and (= o22 (remove o23 o13)) (remove__function_guard o22 o23 o13))
...
;; H
  (assert
  (and (and (= o24 (remove bb ib1)) (remove__function_guard o24 bb ib1))
...
;; H
  (assert
  (and (and (= o25 (remove aa o5)) (remove__function_guard o25 aa o5))
...
;; H
  (assert
  (and
  (and (= o16 (shift_perm_l o25 o24 o22)) (shift_perm_l__function_guard 
  o16 o25 o24 o22))
...
;; H
  (assert
  (and (and (= o20 (remove b ib2)) (remove__function_guard o20 b ib2))
  (and (dynamic_invariant2 o20 true false true)
  (and (= (invariant__ o20) true)
  (and (= (to_rep2 (last (rt o20))) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib2 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o20) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib2 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o20) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib2 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o20) k))))))))))))
...
;; H
  ...
  (= o21 (remove o20
         (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
  (remove__function_guard o21 o20
  (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
  (and (dynamic_invariant2 o21 true false true)
  (and (= (invariant__ o21) true)
  (and (= (to_rep2 (last (rt o21))) (- (to_rep2 (last (rt o20))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts o20) k)) (to_rep (select (elts o21) k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt o20)))))
  (= (to_rep (select (elts o20) k)) (to_rep (select (elts o21) (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt o20))) 1)))
  (= (to_rep (select (elts o20) (+ k 1))) (to_rep (select (elts o21) k))))))))))))
