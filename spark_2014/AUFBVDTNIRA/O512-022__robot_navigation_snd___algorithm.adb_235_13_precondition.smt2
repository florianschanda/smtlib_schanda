...
(declare-fun algorithm__buildgapvector__B_10__dist__assume () t)
...
;; H
  (assert
  (and (= algorithm__buildgapvector__B_10__dist__assume o13) (tqtisFinite
  o13)))
...
;; H
  (assert (tqtisFinite dist2))

;; H
  (assert (le mingapwidth dist2))
