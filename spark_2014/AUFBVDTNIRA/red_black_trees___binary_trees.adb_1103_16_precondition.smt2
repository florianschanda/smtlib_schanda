...
(declare-fun o15 () (Array Int us_rep1))
...
;; H
  (assert (=> (and (<= 1 r2) (<= r2 r313b)) (= temp___2879 r2)))
...
;; H
  (assert
  (=> (and (<= 1 r2) (<= r2 r313b))
  (and (=> (<= 1 r313b) (dynamic_property 1 r313b r3))
  (and (<= 1 r3) (<= r3 r313b)))))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 r313b)) (= r3 r313b)))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 r313b)) (= r4 (mk_int__ref r3))))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 r313b)) (= r5 r3)))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 r313b)) (= r6 r4)))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 r313b)) (= r7 r5)))

;; H
  (assert (=> (not (and (<= 1 r2) (<= r2 r313b))) (= r6 (mk_int__ref r2))))

;; H
  (assert (=> (not (and (<= 1 r2) (<= r2 r313b))) (= r7 r2)))
...
;; H
  ...
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i) (rec__tree_model__path_type__a (us_split_fields1 (select o15 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select o15 (parent
              (mk___rep2
...
;; H
  (assert (and (= o13 r1) (in_range1 r1)))
...
;; H
  (assert (and (= o14 r1) (in_range1 r1)))
...
;; H
  ...
  (= o15 (model__
         (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
         o14))
  (model____function_guard o15
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o14))
  (and (dynamic_invariant3 o15 true false true)
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o15 o14))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select o15 o14)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i o14))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select o15 (parent
                      ...
                      (mk___split_fields2 f__split_fields f__split_fields1))
                      i)))) true))
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o15 i))) true)
  (not
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o15 i))) true))))))
  (and
  (forall ((i Int))
  ...
  (= (is_add
     ...
     (rec__tree_model__path_type__a (us_split_fields1 (select o15 i)))) true)
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select o15 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o15 i))) true)
  ...
  (=>
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o15 j))) true)
  (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o15 i)))
     (rec__tree_model__path_type__a (us_split_fields1 (select o15 j)))) true))
  (= j i))))))))))))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  ...
  (= (valid_root
     (mk___rep2
     (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o12) true)))
(check-sat)
