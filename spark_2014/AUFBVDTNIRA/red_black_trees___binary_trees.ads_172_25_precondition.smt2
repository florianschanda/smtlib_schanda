...
(declare-fun o46 () (Array Int us_rep1))
...
;; H
  (assert
  (forall ((t1 Int)) (valid_root__function_guard
  (valid_root
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t1)
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t1)))

;; H
  (assert
  (forall ((t1 Int)) (valid_root__function_guard
  (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) t1)
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) t1)))
...
;; H
  ...
  (and
  (= (valid_root
     (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t1) true)
  (not (= i t1))) (not (= (int__content v2) t1)))
  (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) t1) true))))))
...
;; H
  ...
  (= o44 (valid_root
         (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) 
         t))
  (valid_root__function_guard o44
...
;; H
  (assert
  (= result13 (ite (and (= o45 true) (not (= (int__content v2) t))) true
              false)))
...
;; H
  ...
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1) (rec__tree_model__path_type__a (us_split_fields1 (select o46 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select o46 (parent
              (mk___rep2
...
;; H
  ...
  (= o46 (model__
         (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) 
         t))
  (model____function_guard o46
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t))
  (and (dynamic_invariant3 o46 true false true)
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o46 t))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select o46 t)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 t))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select o46 (parent
                      ...
                      (mk___split_fields2 f__split_fields f__split_fields1))
                      i1)))) true))
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o46 i1))) true)
  (not
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o46 i1))) true))))))
  (and
  (forall ((i1 Int))
  ...
  (= (is_add
     ...
     (rec__tree_model__path_type__a (us_split_fields1 (select o46 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select o46 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o46 i1))) true)
  ...
  (=>
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o46 j))) true)
  (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o46 i1)))
     (rec__tree_model__path_type__a (us_split_fields1 (select o46 j)))) true))
  (= j i1))))))))))))))
