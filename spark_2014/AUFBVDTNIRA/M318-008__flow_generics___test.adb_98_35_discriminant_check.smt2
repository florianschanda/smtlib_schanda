...
(declare-sort tarray_of_items_tD1 0)
...
(declare-fun user_eq2 (tarray_of_items_tD1 tarray_of_items_tD1) Bool)

(declare-fun dummy2 () tarray_of_items_tD1)

(declare-datatypes ()
((tarray_of_items_tD1__ref
 (mk_tarray_of_items_tD1__ref
 (tarray_of_items_tD1__content tarray_of_items_tD1)))))
(define-fun tarray_of_items_tD1__ref___projection ((a tarray_of_items_tD1__ref)) tarray_of_items_tD1 
  (tarray_of_items_tD1__content a))
...
(define-fun bool_eq3 ((a (Array Int item_t)) (a__first Int) (a__last Int)
...
(declare-fun dummy3 () (Array Int item_t))
...
(declare-fun user_eq3 ((Array Int item_t) (Array Int item_t)) Bool)
...
(declare-fun test__fruit_rec__record_t__d__first__bit1 () Int)

(declare-fun test__fruit_rec__record_t__d__last__bit1 () Int)

(declare-fun test__fruit_rec__record_t__d__position1 () Int)
...
(declare-fun test__fruit_rec__record_t__single_item__first__bit1 () Int)

(declare-fun test__fruit_rec__record_t__single_item__last__bit1 () Int)

(declare-fun test__fruit_rec__record_t__single_item__position1 () Int)
...
(declare-fun test__fruit_rec__record_t__a__first__bit1 () Int)

(declare-fun test__fruit_rec__record_t__a__last__bit1 () Int)

(declare-fun test__fruit_rec__record_t__a__position1 () Int)
...
(declare-fun test__fruit_rec__record_t__b__first__bit1 () Int)

(declare-fun test__fruit_rec__record_t__b__last__bit1 () Int)

(declare-fun test__fruit_rec__record_t__b__position1 () Int)
...
(declare-fun test__fruit_rec__record_t__arr__first__bit1 () Int)

(declare-fun test__fruit_rec__record_t__arr__last__bit1 () Int)

(declare-fun test__fruit_rec__record_t__arr__position1 () Int)
...
(declare-datatypes ()
((tapple_basketS__ref
 (mk_tapple_basketS__ref (tapple_basketS__content us_rep)))))
...
(define-fun in_range4 ((rec__test__fruit_rec__record_t__d1 Int)
  (a us_rep)) Bool (= rec__test__fruit_rec__record_t__d1 (to_rep
                                                         (rec__test__fruit_rec__record_t__d
                                                         (us_split_discrs1 a)))))
...
(declare-fun test__fruit_rec__record_t__d__first__bit2 () Int)

(declare-fun test__fruit_rec__record_t__d__last__bit2 () Int)

(declare-fun test__fruit_rec__record_t__d__position2 () Int)
...
(declare-fun test__fruit_rec__record_t__single_item__first__bit2 () Int)

(declare-fun test__fruit_rec__record_t__single_item__last__bit2 () Int)

(declare-fun test__fruit_rec__record_t__single_item__position2 () Int)
...
(declare-fun test__fruit_rec__record_t__a__first__bit2 () Int)

(declare-fun test__fruit_rec__record_t__a__last__bit2 () Int)

(declare-fun test__fruit_rec__record_t__a__position2 () Int)
...
(declare-fun test__fruit_rec__record_t__b__first__bit2 () Int)

(declare-fun test__fruit_rec__record_t__b__last__bit2 () Int)

(declare-fun test__fruit_rec__record_t__b__position2 () Int)
...
(declare-fun test__fruit_rec__record_t__arr__first__bit2 () Int)

(declare-fun test__fruit_rec__record_t__arr__last__bit2 () Int)

(declare-fun test__fruit_rec__record_t__arr__position2 () Int)
...
(declare-fun user_eq5 (t18b t18b) Bool)
...
(declare-fun apple_basket__split_discrs () us_split_discrs)

(declare-fun apple_basket__attr__constrained () Bool)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(define-fun in_range6 ((rec__test__fruit_rec__record_t__d1 Int)
  (a us_rep)) Bool (= rec__test__fruit_rec__record_t__d1 (to_rep
                                                         (rec__test__fruit_rec__record_t__d
                                                         (us_split_discrs1 a)))))
...
(declare-fun test__fruit_rec__record_t__d__first__bit3 () Int)

(declare-fun test__fruit_rec__record_t__d__last__bit3 () Int)

(declare-fun test__fruit_rec__record_t__d__position3 () Int)
...
(declare-fun test__fruit_rec__record_t__single_item__first__bit3 () Int)

(declare-fun test__fruit_rec__record_t__single_item__last__bit3 () Int)

(declare-fun test__fruit_rec__record_t__single_item__position3 () Int)
...
(declare-fun test__fruit_rec__record_t__a__first__bit3 () Int)

(declare-fun test__fruit_rec__record_t__a__last__bit3 () Int)

(declare-fun test__fruit_rec__record_t__a__position3 () Int)
...
(declare-fun test__fruit_rec__record_t__b__first__bit3 () Int)

(declare-fun test__fruit_rec__record_t__b__last__bit3 () Int)

(declare-fun test__fruit_rec__record_t__b__position3 () Int)
...
(declare-fun test__fruit_rec__record_t__arr__first__bit3 () Int)

(declare-fun test__fruit_rec__record_t__arr__last__bit3 () Int)

(declare-fun test__fruit_rec__record_t__arr__position3 () Int)
...
(declare-fun user_eq6 (t21b t21b) Bool)

(declare-fun dummy9 () t21b)
...
(declare-fun mixed_basket__attr__constrained () Bool)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun temp___380 (Int Int Int Int Int) (Array Int item_t))

;; def_axiom
  (assert
  (forall ((temp___382 Int) (temp___383 Int) (temp___384 Int)
  (temp___385 Int) (temp___386 Int))
  (let ((temp___381 (temp___380 temp___382 temp___383 temp___384 temp___385
                    temp___386)))
  (and
  (and
  (and
  (and (= (select temp___381 1) (of_rep1 temp___382))
  (= (select temp___381 2) (of_rep1 temp___383)))
  (= (select temp___381 3) (of_rep1 temp___384)))
  (= (select temp___381 4) (of_rep1 temp___385)))
  (= (select temp___381 5) (of_rep1 temp___386))))))

(declare-fun temp___388 (Int Int Int Int Int) (Array Int item_t))

;; def_axiom
  (assert
  (forall ((temp___390 Int) (temp___391 Int) (temp___392 Int)
  (temp___393 Int) (temp___394 Int))
  (let ((temp___389 (temp___388 temp___390 temp___391 temp___392 temp___393
                    temp___394)))
  (and
  (and
  (and
  (and (= (select temp___389 1) (of_rep1 temp___390))
  (= (select temp___389 2) (of_rep1 temp___391)))
  (= (select temp___389 3) (of_rep1 temp___392)))
  (= (select temp___389 4) (of_rep1 temp___393)))
  (= (select temp___389 5) (of_rep1 temp___394))))))
...
(declare-fun o1 () (Array Int item_t))

(declare-fun o2 () item_t)

(declare-fun o3 () item_t)

(declare-fun o4 () item_t)

(declare-fun o5 () (Array Int item_t))

(declare-fun o6 () natural)

(declare-fun o7 () natural)

(declare-fun o8 () item_t)

(declare-fun o9 () item_t)

(declare-fun o10 () item_t)

(declare-fun o11 () (Array Int item_t))

(declare-fun o12 () Bool)

(declare-fun o13 () natural)

(declare-fun o14 () item_t)

(declare-fun o15 () item_t)

(declare-fun o16 () item_t)

(declare-fun o17 () (Array Int item_t))
...
;; H
  (assert (= o1 (temp___388 1 1 1 1 1)))
...
;; H
  (assert
  (= (mk___rep (mk___split_discrs o13) (mk___split_fields o14 o15 o16 o17)
     o18) (mk___rep (mk___split_discrs o7) (mk___split_fields o8 o9 o10 o11)
          o12)))

(assert
;; WP_parameter_def
 ;; File "test.ads", line 73, characters 0-0
  (not (= 0 (to_rep o13))))
(check-sat)
