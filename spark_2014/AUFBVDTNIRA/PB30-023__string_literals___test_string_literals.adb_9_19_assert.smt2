...
(declare-fun t2 () (Array Int character))
...
;; WP_parameter_def
 ;; File "test_string_literals.adb", line 5, characters 0-0
  (not
  (= (let ((temp___188 (id (mk___t t2 (mk 5 8)))))
     (bool_eq3 s1 (to_rep1 s__first) (to_rep1 s__last) (elts temp___188)
     (to_rep1 (first (rt temp___188))) (to_rep1 (last (rt temp___188))))) true)))
(check-sat)
