...
(declare-fun total_area1 () Int)

(declare-fun total_area2 () Int)

(declare-fun rec____split_fields15 () integer)

(declare-fun rec____split_fields16 () integer)

(declare-fun rec____split_fields17 () integer)

(declare-fun rec____split_fields18 () natural)

(declare-fun rec____split_fields19 () natural)

(declare-fun rec____split_fields20 () us_private)

(declare-fun total_area3 () Int)

(declare-fun rec____split_fields21 () integer)

(declare-fun rec____split_fields22 () integer)

(declare-fun rec____split_fields23 () integer)

(declare-fun rec____split_fields24 () natural)

(declare-fun rec____split_fields25 () natural)

(declare-fun rec____split_fields26 () us_private)

(define-fun rec____split_fields27 () us_split_fields2 (mk___split_fields1
                                                      rec____split_fields9
                                                      rec____split_fields10
...
;; H
  ...
  (mk___rep window__prepare_to_draw__obj__fields4 rec____attr__tag))
  rec____attr__tag
  (mk___rep window__prepare_to_draw__obj__fields4 rec____attr__tag)))

;; H
  (assert (get_stored_area__function_guard1
  (get_stored_area1 rec____attr__tag
  (mk___rep
  (mk___split_fields rec____split_fields9 rec____split_fields10
  rec____split_fields11
  (hide_ext__ rec____split_fields12 rec____split_fields13
  rec____split_fields14)) rec____attr__tag)) rec____attr__tag
  (mk___rep
  (mk___split_fields rec____split_fields9 rec____split_fields10
  rec____split_fields11
  (hide_ext__ rec____split_fields12 rec____split_fields13
  rec____split_fields14)) rec____attr__tag)))
...
;; H
  (assert
  (= rec____split_fields27 (us_split_fields3
                           (of_base
...
;; H
  (assert
  (and
  (= total_area1 (- total_area (get_stored_area1 rec____attr__tag
                               (mk___rep
                               (mk___split_fields rec____split_fields9
                               rec____split_fields10 rec____split_fields11
                               (hide_ext__ rec____split_fields12
                               rec____split_fields13 rec____split_fields14))
                               rec____attr__tag))))
  (in_range total_area1)))
...
;; H
  (assert
  (= (mk___split_fields1 rec____split_fields21 rec____split_fields22
     rec____split_fields23 rec____split_fields24 rec____split_fields25
     rec____split_fields26) rec____split_fields27))
...
;; WP_parameter_def
 ;; File "window.ads", line 13, characters 0-0
  (not (= total_area2 (- total_area 100))))
(check-sat)
