...
;; H
  (assert (invariant____function_guard (invariant__ o36) o36))

;; H
  (assert (remove__function_guard (remove o35 o19) o35 o19))

;; H
  (assert (remove__function_guard (remove o36 o19) o36 o19))
...
;; H
  (assert
  (and
  (and (= o35 (remove (mk___t values2 (mk 1 100)) o16))
  (remove__function_guard o35 (mk___t values2 (mk 1 100)) o16))
...
;; H
  (assert
  (and
  (and (= o36 (remove (mk___t interm1 (mk 1 100)) o13))
  (remove__function_guard o36 (mk___t interm1 (mk 1 100)) o13))
  (and (dynamic_invariant4 o36 true false true)
...
;; H
  (assert
  (and
  (and (= o20 (remove_eq o36 o35 o19)) (remove_eq__function_guard o20 
  o36 o35 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___181 (remove o35 o19)))
     (let ((temp___180 (remove o36 o19)))
...
;; H
  (assert
  (= (let ((temp___366 (remove (remove (mk___t values2 (mk 1 100)) x) y)))
     (let ((temp___365 (remove (remove (mk___t interm1 (mk 1 100)) x) y)))
     (bool_eq5 (elts temp___365) (to_rep1 (first (rt temp___365)))
     (to_rep1 (last (rt temp___365))) (elts temp___366)
     (to_rep1 (first (rt temp___366))) (to_rep1 (last (rt temp___366)))))) true))
...
;; H
  (assert (remove__function_guard (remove o30 o31) o30 o31))

;; H
  (assert (remove__function_guard (remove o28 o31) o28 o31))
...
;; H
  ...
  (remove__function_guard o30 (mk___t interm1 (mk 1 100)) o29))
...
;; H
  (assert
  (and
  (and (= o28 (remove (mk___t init (mk 1 100)) o27)) (remove__function_guard
  o28 (mk___t init (mk 1 100)) o27))
...
;; H
  (assert
  (and
  (and (= o32 (remove_eq o28 o30 o31)) (remove_eq__function_guard o32 
  o28 o30 o31))
  (and (in_range4 o32)
  (=> (= (of_int o32) true)
  (= (let ((temp___181 (remove o30 o31)))
     (let ((temp___180 (remove o28 o31)))
     (bool_eq5 (elts temp___180) (to_rep1 (first (rt temp___180)))
     (to_rep1 (last (rt temp___180))) (elts temp___181)
     (to_rep1 (first (rt temp___181))) (to_rep1 (last (rt temp___181)))))) true)))))
