...
(define-fun default_initial_assumption ((temp___expr_327 us_rep1)
  (temp___skip_top_level_328 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_328 true))
                                         (= (length temp___expr_327) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_293 Int)
