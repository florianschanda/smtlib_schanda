...
;; H
  (assert
  (and
  (and (= o7 (to__ (mk___rep s__split_fields10))) (to____function_guard 
  o7 (mk___rep s__split_fields10))) (dynamic_invariant1 o7 true false true)))
...
;; H
  (assert
  (=> (= result4 true) (= temp___484 (mk___t2 o5 (mk2 first2 temp___482)))))
...
;; H
  (assert
  (=> (= result4 true) (= temp___483 (mk___t1 o6 (mk1 first2 temp___481)))))
