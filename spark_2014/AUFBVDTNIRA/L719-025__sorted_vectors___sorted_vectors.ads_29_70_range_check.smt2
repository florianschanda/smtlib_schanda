...
;; H
  (assert (=> (= result1 true) (= temp___407 position1)))
...
;; H
  (assert (= o15 (ite (<= position8 o14) true false)))

;; H
  (assert (and (= o13 1) (and (in_range4 o13) (= o13 1))))

;; H
  (assert (= o16 (ite (<= o13 position8) true false)))
...
;; H
  (assert (= result8 (ite (= o11 new_item) true false)))
...
;; H
  (assert
  (forall ((i2 Int) (j Int)) (my_lt__function_guard
  (my_lt
  (get
  (model__
  (mk___rep container__split_discrs
  ...
  (model__
  (mk___rep container__split_discrs
  (mk___split_fields container__split_fields))) j))
  (get
  (model__
  (mk___rep container__split_discrs
  (mk___split_fields container__split_fields))) i2)
...
;; H
  (assert (=> (not (= result9 true)) (= o10 (of_int 1))))
...
;; H
  (assert (= result10 (ite (<= (+ position8 1) i1) o8 false)))
