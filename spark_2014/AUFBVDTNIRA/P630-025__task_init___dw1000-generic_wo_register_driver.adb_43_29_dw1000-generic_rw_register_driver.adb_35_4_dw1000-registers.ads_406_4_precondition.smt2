...
(declare-fun dw1000__register_types__drx_sfdtoc_type__drx_sfdtoc__first__bit () Int)

(declare-fun dw1000__register_types__drx_sfdtoc_type__drx_sfdtoc__last__bit () Int)

(declare-fun dw1000__register_types__drx_sfdtoc_type__drx_sfdtoc__position () Int)
...
(define-fun dynamic_invariant ((temp___expr_4922 us_t1)
  ...
  (temp___do_toplevel_4921 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_4922))
                                       (and (= (first3 temp___expr_4922) 1)
                                       (= (last4 temp___expr_4922) 2)))))
...
(define-fun dynamic_invariant1 ((temp___expr_4938 us_t2)
  ...
  (temp___do_toplevel_4937 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_4938))
                                       (and (= (first5 temp___expr_4938) 1)
                                       (= (last6 temp___expr_4938) 2)))))
...
(declare-fun temp___7813 () (Array Int bits_8))

(declare-fun temp___78131 () t2)

(declare-fun temp___7814 () (Array Int bits_8))

(declare-fun temp___78141 () t1)
...
;; H
  (assert
  (and
  (and (= temp___78132 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___78132 reg)) (dynamic_invariant1
  temp___78132 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___78131)) (to_rep (last5 temp___78131)))
     (+ (- (to_rep (last5 temp___78131)) (to_rep (first4 temp___78131))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___7813 temp___7814))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78131)) (to_rep (last5 temp___78131))) 
  temp___78141))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___78141)) (to_rep (last3 temp___78141)))
     (+ (- (to_rep (last3 temp___78141)) (to_rep (first2 temp___78141))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7814 temp___78141)))
