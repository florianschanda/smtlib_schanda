...
(declare-fun amortized_queue__Oconcat__2__result () capacity_range)

(declare-fun amortized_queue__Oconcat__2__result1 () us_main_type)
...
;; H
  (assert
  (= amortized_queue__Oconcat__2__result3 (mk_vector__ref
                                          amortized_queue__Oconcat__2__result2)))
...
;; H
  (assert
  (= amortized_queue__Oconcat__2__result4 amortized_queue__Oconcat__2__result2))
...
;; H
  (assert
  (= result____split_fields13 amortized_queue__my_vectors__append__2__container__fields3))
...
;; H
  (assert
  (=> (and (<= r23b idx1) (<= idx1 r24b)) (and (= o1 idx1) (in_range4 idx1))))
...
;; H
  ...
  (length (mk___rep result____split_discrs result____split_fields13)) 1))
  (= (olt
     (model__ (mk___rep result____split_discrs result____split_fields13))
     (model__
     (mk___rep result____split_discrs
  ...
  (= (get
     ...
     amortized_queue__my_vectors__append__2__container__fields2))
     (+ (last
        (model__ (mk___rep result____split_discrs result____split_fields13))) 1)) 
  o2))))
...
;; H
  (assert
  (=> (and (<= r23b idx1) (<= idx1 r24b))
  (= (length (mk___rep result____split_discrs result____split_fields12)) (+ 1 
  idx2))))
...
;; H
  ...
  (=> (and (<= r23b idx1) (<= idx1 r24b))
  (= (get
     (model__ (mk___rep result____split_discrs result____split_fields12)) 1) 
  left)))
...
;; H
  ...
  (= (get
     ...
     (+ 1 i1)) (get (model__ right) i1))))))

;; H
  (assert
  (=> (and (<= r23b idx1) (<= idx1 r24b))
  (and (=> (<= r23b r24b) (dynamic_property r23b r24b idx2))
  (and (<= r23b idx2) (<= idx2 r24b)))))
...
;; H
  (assert
  (=> (and (<= r23b idx1) (<= idx1 r24b)) (= idx3 (mk_int__ref idx2))))
...
;; H
  (assert
  (=> (and (<= r23b idx1) (<= idx1 r24b))
  (= result____split_fields5 result____split_fields12)))
...
;; H
  (assert
  (=> (not (and (<= r23b idx1) (<= idx1 r24b))) (= idx5 (mk_int__ref idx1))))

;; H
  (assert
  (=> (not (and (<= r23b idx1) (<= idx1 r24b)))
...
;; H
  (assert
  (=> (not (and (<= r23b idx1) (<= idx1 r24b)))
  (= result____split_fields7 result____split_fields13)))

;; H
  (assert
  (= result3 (mk_vector__ref
             (mk___rep
             (mk___split_discrs amortized_queue__Oconcat__2__result)
             (mk___split_fields amortized_queue__Oconcat__2__result1)))))

;; H
  (assert
  (= amortized_queue__Oconcat__2__result2 (mk___rep result____split_discrs
                                          (us_split_fields__content
                                          result____split_fields6))))

;; H
  (assert
  (= amortized_queue__Oconcat__2__result5 amortized_queue__Oconcat__2__result3))
...
;; H
  (assert
  (= amortized_queue__Oconcat__2__result6 amortized_queue__Oconcat__2__result4))
...
;; H
  (assert
  (and (= o6 (length right)) (and (in_range6 o6) (<= o6 (capacity right)))))
...
;; H
  (assert
  (and (= o8 (length (vector__content amortized_queue__Oconcat__2__result5)))
  (and (in_range6 o8)
  (<= o8 (capacity (vector__content amortized_queue__Oconcat__2__result5))))))

;; H
  (assert (= result4 (ite (= o8 o7) true false)))
...
;; H
  (assert
  (and
  (= o5 (get (model__ (vector__content amortized_queue__Oconcat__2__result5))
        1))
  (and (in_range7 o5)
  (= o5 (get (model__ (vector__content amortized_queue__Oconcat__2__result5))
        1)))))
...
;; H
  (assert (= result5 (ite (= o5 left) true false)))
...
;; H
  (assert
  (and (= o3 (last (model__ right)))
  (and (in_range5 o3) (= o3 (last (model__ right))))))

;; H
  (assert (= o4 (ite (<= i o3) true false)))

;; H
  (assert (= result6 (ite (<= 1 i) o4 false)))
