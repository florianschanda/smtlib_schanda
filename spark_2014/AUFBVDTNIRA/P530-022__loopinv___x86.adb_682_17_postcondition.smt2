...
(define-fun dynamic_invariant ((temp___expr_184 (_ BitVec 64))
...
(define-fun dynamic_invariant1 ((temp___expr_202 (_ BitVec 64))
...
;; readmem64__post_axiom
  ...
  (! (=> (dynamic_invariant1 addr true true true)
     ...
     (and (= (hasmem64 x86__memory addr result) true) (dynamic_invariant1
...
(declare-datatypes ()
((t76b__ref (mk_t76b__ref (t76b__content unsigned_64)))))
(define-fun t76b__ref___projection ((a t76b__ref)) unsigned_64 (t76b__content
                                                               a))
...
(declare-fun temp___638 () (_ BitVec 64))
...
;; H
  (assert
  (forall ((i9 (_ BitVec 64))) (hasmem64__function_guard
  (hasmem64 mem (bvadd rdi_start (bvmul i9 ((_ int2bv 64) 8))) rax) mem
  (bvadd rdi_start (bvmul i9 ((_ int2bv 64) 8))) rax)))

;; H
  (assert (nooverlap8equal__function_guard (nooverlap8equal memory mem rdi)
  memory mem rdi))

;; H
  (assert
  (forall ((i9 (_ BitVec 64))) (nooverlap8__function_guard
  (nooverlap8 (bvadd rdi_start (bvmul i9 ((_ int2bv 64) 8))) rdi)
  (bvadd rdi_start (bvmul i9 ((_ int2bv 64) 8))) rdi)))

;; H
  (assert (hasmem64__function_guard
  (hasmem64 memory (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) rax) 
  memory (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) rax))

;; H
  (assert
  (forall ((j (_ BitVec 64))) (hasmem64__function_guard
  (hasmem64 memory (bvadd rdi_start (bvmul j ((_ int2bv 64) 8))) rax) 
  memory (bvadd rdi_start (bvmul j ((_ int2bv 64) 8))) rax)))
...
;; H
  (assert
  (and
  (forall ((i9 (_ BitVec 64)))
  (=> (and (bvule ((_ int2bv 64) 0) i9) (bvule i9 (bvsub rcx_start rcx)))
  (=> (not (= i9 (bvsub rcx_start rcx)))
  (= (hasmem64 mem (bvadd rdi_start (bvmul i9 ((_ int2bv 64) 8))) rax) true))))
  (and
  (= rdi (bvadd rdi_start (bvmul (bvsub rcx_start rcx) ((_ int2bv 64) 8))))
  (and (bvule rcx rcx_start)
  (and (bvult rcx_start ((_ int2bv 64) 2305843009213693951))
  (and (= (nooverlap8equal memory mem rdi) true)
  (forall ((i9 (_ BitVec 64)))
  (=> (and (bvule ((_ int2bv 64) 0) i9) (bvule i9 (bvsub rcx_start rcx)))
  (=> (not (= i9 (bvsub rcx_start rcx)))
  (= (nooverlap8 (bvadd rdi_start (bvmul i9 ((_ int2bv 64) 8))) rdi) true))))))))))
...
;; H
  (assert
  (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b)) (= temp___638 i1)))

;; H
  (assert
  (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b))
  (=> (not (= i1 (bvsub rcx_start rcx)))
  (forall ((j (_ BitVec 64)))
  (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j ((_ int2bv 64) 7)))
  (= (to_rep
     (select memory (bvadd (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) j))) 
  (to_rep
  (select mem (bvadd (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) j)))))))))

;; H
  (assert
  (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b))
  (=> (not (= i1 (bvsub rcx_start rcx)))
  (= (hasmem64 memory (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) rax) true))))

;; H
  (assert
  (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b))
  (forall ((j (_ BitVec 64)))
  (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j i2))
  (=> (not (= j (bvsub rcx_start rcx)))
  (= (hasmem64 memory (bvadd rdi_start (bvmul j ((_ int2bv 64) 8))) rax) true))))))

;; H
  (assert
  (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b))
  (and
  (=> (bvule ((_ int2bv 64) 0) r75b) (dynamic_property ((_ int2bv 64) 0) 
  r75b i2)) (and (bvule ((_ int2bv 64) 0) i2) (bvule i2 r75b)))))

;; H
  (assert
  (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b)) (= i2 r75b)))
...
;; H
  (assert
  (=> (not (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b))) (= i1 i5)))

;; H
  (assert
  (=> (not (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b))) (= i6 i1)))
...
;; H
  ...
  (readmem64 (bvadd rdi_start (bvmul i9 ((_ int2bv 64) 8))) memory)
  (bvadd rdi_start (bvmul i9 ((_ int2bv 64) 8))) memory))
