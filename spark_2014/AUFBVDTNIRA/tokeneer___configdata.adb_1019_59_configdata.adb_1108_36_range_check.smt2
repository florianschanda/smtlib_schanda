...
(declare-fun bool_eq8 (us_rep us_rep) Bool)
...
(declare-fun dummy11 () alarmsilenttexti)

(declare-datatypes ()
((alarmsilenttexti__ref
...
(declare-fun dummy12 () latchunlocktexti)

(declare-datatypes ()
((latchunlocktexti__ref
...
(declare-fun dummy13 () tokenremovaltexti)

(declare-datatypes ()
((tokenremovaltexti__ref
...
(declare-fun dummy14 () fingerwaittexti)

(declare-datatypes ()
((fingerwaittexti__ref
...
(declare-fun dummy15 () clearancetexti)
...
(declare-fun dummy16 () workingstarttexti)

(declare-datatypes ()
((workingstarttexti__ref
...
(declare-fun dummy17 () workingendtexti)

(declare-datatypes ()
((workingendtexti__ref
...
(declare-fun dummy18 () maxauthdurationtexti)

(declare-datatypes ()
((maxauthdurationtexti__ref
...
(declare-fun dummy19 () minentryclasstexti)

(declare-datatypes ()
((minentryclasstexti__ref
...
(declare-fun dummy20 () accesspolicytexti)
...
(declare-fun dummy21 () minpreservedlogsizetexti)

(declare-datatypes ()
((minpreservedlogsizetexti__ref
...
(declare-fun dummy22 () alarmthresholdtexti)

(declare-datatypes ()
((alarmthresholdtexti__ref
...
(declare-fun dummy23 () systemmaxfartexti)

(declare-datatypes ()
((systemmaxfartexti__ref
...
(declare-fun alarmsilenttitle () (Array Int character))
...
(declare-fun latchunlocktitle () (Array Int character))
...
(declare-fun tokenremovaltitle () (Array Int character))
...
(declare-fun fingerwaittitle () (Array Int character))
...
(declare-fun clearancetitle () (Array Int character))
...
(declare-fun workingstarttitle () (Array Int character))
...
(declare-fun workingendtitle () (Array Int character))
...
(declare-fun maxauthdurationtitle () (Array Int character))
...
(declare-fun minentryclasstitle () (Array Int character))
...
(declare-fun minpreservedlogsizetitle () (Array Int character))
...
(declare-fun alarmthresholdtitle () (Array Int character))
...
(declare-fun systemmaxfartitle () (Array Int character))
...
(declare-fun dummy24 () classtexti)
...
(declare-fun dummy25 () (Array Int character))
...
(define-fun bool_eq26 ((a us_rep1)
...
(define-fun bool_eq27 ((a (Array Int us_rep1)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq26 (select a temp___idx_162)
...
;; bool_eq_rev
  ...
  (forall ((a (Array Int us_rep1)) (b (Array Int us_rep1)))
  (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int))
  (=> (= (bool_eq27 b b__first b__last a a__first a__last) true)
  (and
  (ite (<= a__first a__last)
  (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first)))
  (< b__last b__first))
...
(declare-fun dummy27 () accesstexti)
...
(declare-fun dummy28 () (Array Int character))
...
(define-fun bool_eq29 ((a us_rep2)
...
(declare-datatypes ()
((map__ref2 (mk_map__ref2 (map__content2 (Array Int us_rep2))))))
...
(define-fun bool_eq30 ((a (Array Int us_rep2)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq29 (select a temp___idx_177)
...
(declare-fun accessstringlookup () (Array Int us_rep2))
...
(declare-fun dummy30 () string5i)

(declare-datatypes ()
((string5i__ref (mk_string5i__ref (string5i__content string5i)))))
...
(declare-fun configfile () us_rep)

(declare-fun c39b () (Array Int character))

(declare-fun localtext () (Array Int character))

(declare-fun localvalue () Int)

(declare-fun localtext1 () (Array Int character))

(declare-fun localvalue1 () Int)
...
(declare-fun temp___1163 () (Array Int us_rep1))

(declare-fun o26 () accesstexti)

(declare-fun o27 () us_split_fields2)

(declare-fun o28 () accesstexti)
...
(declare-fun temp___1164 () (Array Int us_rep2))
...
(declare-fun o35 () (Array Int character))

(declare-fun o36 () character)

(declare-fun o37 () (Array Int character))
...
(declare-fun configfile1 () us_rep)

(declare-fun success1 () Bool)

(declare-fun configfile2 () us_rep)

(declare-fun result1 () map__ref)

(declare-fun localtext2 () (Array Int character))

(declare-fun result2 () int__ref)

(declare-fun localvalue2 () Int)

(declare-fun result3 () map__ref)

(declare-fun localtext3 () (Array Int character))

(declare-fun result4 () map__ref)

(declare-fun localtext4 () (Array Int character))

(declare-fun result5 () int__ref)

(declare-fun localvalue3 () Int)

(declare-fun result6 () map__ref)

(declare-fun localtext5 () (Array Int character))

(declare-fun result7 () map__ref)

(declare-fun localtext6 () (Array Int character))

(declare-fun result8 () map__ref)

(declare-fun c39b1 () (Array Int character))

(declare-fun result9 () map__ref)

(declare-fun localtext7 () (Array Int character))

(declare-fun result10 () int__ref)

(declare-fun localvalue4 () Int)
...
;; H
  (assert
  (and (= result (exists__ configfile)) (exists____function_guard result
  configfile)))
...
;; H
  (assert (= o32 (temp___String_Literal_1147 Tuple0)))

;; H
  (assert (= result1 (mk_map__ref localtext)))

;; H
  (assert (= localtext2 o32))
...
;; H
  (assert (= localvalue2 (div1 c38b 36000)))

;; H
  (assert
  (and (= o33 (+ 48 (div1 localvalue2 10))) (in_range3
  (+ 48 (div1 localvalue2 10)))))

;; H
  (assert (= (to_rep o34) o33))

;; H
  (assert (= o35 (store localtext2 1 o34)))

;; H
  (assert (= result3 (mk_map__ref localtext2)))

;; H
  (assert (= localtext3 o35))

;; H
  (assert (= (to_rep o36) (+ 48 (mod2 localvalue2 10))))

;; H
  (assert (= o37 (store localtext3 2 o36)))

;; H
  (assert (= result4 (mk_map__ref localtext3)))

;; H
  (assert (= localtext4 o37))

;; H
  (assert (= result5 (mk_int__ref localvalue2)))

;; H
  (assert (= localvalue3 (div1 (mod2 c38b 36000) 600)))

;; H
  (assert
  (and (= o38 (+ 48 (div1 localvalue3 10))) (in_range3
  (+ 48 (div1 localvalue3 10)))))

;; H
  (assert (= (to_rep o39) o38))

;; H
  (assert (= o40 (store localtext4 4 o39)))

;; H
  (assert (= result6 (mk_map__ref localtext4)))

;; H
  (assert (= localtext5 o40))

;; H
  (assert (= (to_rep o41) (+ 48 (mod2 localvalue3 10))))

;; H
  (assert (= o42 (store localtext5 5 o41)))

;; H
  (assert (= result7 (mk_map__ref localtext5)))

;; H
  (assert (= localtext6 o42))

;; H
  (assert (= result8 (mk_map__ref c39b)))

;; H
  (assert (= c39b1 localtext6))
...
;; H
  (assert (= o43 (temp___String_Literal_1148 Tuple0)))

;; H
  (assert (= result9 (mk_map__ref localtext1)))

;; H
  (assert (= localtext7 o43))
...
;; H
  (assert (= localvalue4 (div1 c43b 36000)))

(assert
;; WP_parameter_def
 ;; File "configdata.adb", line 1359, characters 0-0
  (not (in_range3 (+ 48 (div1 localvalue4 10)))))
(check-sat)
