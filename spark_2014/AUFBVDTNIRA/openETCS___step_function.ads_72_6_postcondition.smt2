...
(declare-fun step_function__minimum_until_point__result () t)

(declare-fun temp___288 () t)
...
(declare-fun step_function__minimum_until_point__result1 () t)

(declare-fun step_function__minimum_until_point__result2 () t__ref)

(declare-fun step_function__minimum_until_point__result3 () t)

(declare-fun min9 () t__ref)
...
(declare-fun step_function__minimum_until_point__result5 () t)
...
;; H
  (assert (=> (and (<= 0 i1) (<= i1 r10b)) (= temp___288 min2)))
...
;; H
  (assert (=> (and (<= 0 i1) (<= i1 r10b)) (= min5 (mk_t__ref min4))))
...
;; H
  (assert (=> (and (<= 0 i1) (<= i1 r10b)) (= min8 min6)))

;; H
  (assert (=> (not (and (<= 0 i1) (<= i1 r10b))) (= i5 (mk_int__ref i1))))

;; H
  (assert (=> (not (and (<= 0 i1) (<= i1 r10b))) (= min7 (mk_t__ref min2))))

;; H
  (assert (=> (not (and (<= 0 i1) (<= i1 r10b))) (= i6 i1)))

;; H
  (assert (=> (not (and (<= 0 i1) (<= i1 r10b))) (= min8 min2)))
...
;; H
  (assert (= step_function__minimum_until_point__result1 (t__content min7)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (le (t__content step_function__minimum_until_point__result4)
  (to_rep
  (rec__step_function__delimiter_entry__value
  (us_split_fields1
  (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) 
