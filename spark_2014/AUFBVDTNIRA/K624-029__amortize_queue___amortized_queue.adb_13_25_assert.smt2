...
;; H
  (assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= temp___495 idx1)))
...
;; H
  (assert
  (=> (and (<= 1 idx1) (<= idx1 r4b)) (and (= o2 idx1) (in_range3 idx1))))
...
;; H
  (assert
  (=> (and (<= 1 idx1) (<= idx1 r4b))
  (and (=> (<= 1 r4b) (dynamic_property 1 r4b idx2))
  (and (<= 1 idx2) (<= idx2 r4b)))))

;; H
  (assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= idx2 r4b)))

;; H
  (assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= idx3 (mk_int__ref idx2))))
...
;; H
  (assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= idx4 idx2)))
...
;; H
  (assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= idx5 idx3)))
...
;; H
  (assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= idx6 idx4)))
...
;; H
  (assert
  (=> (not (and (<= 1 idx1) (<= idx1 r4b))) (= idx5 (mk_int__ref idx1))))

;; H
  (assert
  (=> (not (and (<= 1 idx1) (<= idx1 r4b)))
  (= result____split_fields6 result____split_fields9)))

;; H
  (assert (=> (not (and (<= 1 idx1) (<= idx1 r4b))) (= idx6 idx1)))
