...
(define-fun dynamic_invariant2 ((temp___expr_266 Int)
...
(define-fun dynamic_invariant3 ((temp___expr_254 Int)
...
(define-fun dynamic_invariant5 ((temp___expr_396 us_rep1)
  (temp___is_init_393 Bool) (temp___skip_constant_394 Bool)
  (temp___do_toplevel_395 Bool)) Bool (=>
                                      (not (= temp___skip_constant_394 true))
                                      (in_range8 100 temp___expr_396)))

(define-fun default_initial_assumption1 ((temp___expr_398 us_rep1)
  (temp___skip_top_level_399 Bool)) Bool (and
                                         ...
                                         (= (is_empty1 temp___expr_398) true))))
...
;; mk_def
  ...
  (! (=> (in_range1 f)
     (=> (in_range1 l1)
     (and (= (to_rep (first6 (mk1 f l1))) f)
     (= (to_rep (last7 (mk1 f l1))) l1)))) :pattern ((mk1 f l1)) )))
...
(define-fun first7 ((a us_t1)) Int (to_rep (first6 (rt1 a))))

(define-fun last8 ((a us_t1)) Int (to_rep (last7 (rt1 a))))

(define-fun length3 ((a us_t1)) Int (ite (<= (first7 a) (last8 a))
...
(define-fun bool_eq14 ((x us_t1)
  (y us_t1)) Bool (bool_eq1 (elts1 x) (to_rep (first6 (rt1 x)))
                  (to_rep (last7 (rt1 x))) (elts1 y)
                  (to_rep (first6 (rt1 y))) (to_rep (last7 (rt1 y)))))
...
(declare-fun first9 (t2) integer)

(declare-fun last10 (t2) integer)
...
;; mk_def
  ...
  (! (=> (in_range1 f)
     (=> (in_range1 l1)
     (and (= (to_rep (first9 (mk2 f l1))) f)
     (= (to_rep (last10 (mk2 f l1))) l1)))) :pattern ((mk2 f l1)) )))
...
(define-fun first10 ((a us_t2)) Int (to_rep (first9 (rt2 a))))

(define-fun last11 ((a us_t2)) Int (to_rep (last10 (rt2 a))))

(define-fun length4 ((a us_t2)) Int (ite (<= (first10 a) (last11 a))
...
(define-fun bool_eq16 ((x us_t2)
  (y us_t2)) Bool (bool_eq1 (elts2 x) (to_rep (first9 (rt2 x)))
                  (to_rep (last10 (rt2 x))) (elts2 y)
                  (to_rep (first9 (rt2 y))) (to_rep (last10 (rt2 y)))))
...
(define-fun dynamic_invariant7 ((temp___expr_206 Int)
...
(define-fun dynamic_invariant9 ((temp___expr_272 Int)
...
(define-fun default_initial_assumption2 ((temp___expr_306 us_rep2)
  (temp___skip_top_level_307 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_307 true))
                                         (= (length1 temp___expr_306) 0)))

;; model____post_axiom
  (assert
  (forall ((container us_rep1))
  (! (= (length1 (model__ container)) (length2 container)) :pattern (
  (model__ container)) )))
...
(define-fun dynamic_invariant10 ((temp___expr_299 Int)
...
;; length__post_axiom
  ...
  (! (let ((result (length1 container)))
     (and (<= (+ 0 result) 100) (dynamic_invariant7 result true false true))) :pattern (
  (length1 container)) )))
...
(declare-fun dummy21 () element_type1)
...
(declare-fun temp___468 () r1)

(declare-fun temp___4681 () (Array Int integer))

(declare-fun temp___467 () Int)

(declare-fun o () Int)

(declare-fun o1 () Int)

(declare-fun temp___480 () capacity_range)

(declare-fun temp___4801 () us_main_type)

(declare-fun temp___479 () Int)

(declare-fun temp___485 () r1)

(declare-fun temp___4851 () (Array Int integer))

(declare-fun temp___478 () r1)

(declare-fun temp___4781 () (Array Int integer))
...
(declare-fun s__split_fields7 () us_split_fields__ref)
...
(declare-fun s__split_fields16 () us_split_fields)
...
(declare-fun s__split_fields17 () us_split_fields__ref)
...
(declare-fun s__split_fields18 () us_split_fields)
...
(define-fun temp___4852 () us_rep (mk___rep
                                  (mk___split_fields temp___485 temp___4851)))
...
;; H
  (assert (top__function_guard (top (mk___rep s__split_fields3))
  (mk___rep s__split_fields3)))

;; H
  (assert (to____function_guard
...
;; H
  (assert (to_but_top__function_guard
  (to_but_top (mk___rep s__split_fields3)) (mk___rep s__split_fields3)))

;; H
  (assert (to____function_guard (to__ (mk___rep s__split_fields4))
  (mk___rep s__split_fields4)))
...
;; H
  (assert (to____function_guard (to__ (mk___rep s__split_fields9))
  (mk___rep s__split_fields9)))

;; H
  (assert (to_but_top__function_guard
  (to_but_top (mk___rep (us_split_fields__content s__split_fields7)))
  (mk___rep (us_split_fields__content s__split_fields7))))

;; H
  (assert (to____function_guard (to__ (mk___rep s__split_fields10))
  (mk___rep s__split_fields10)))
...
;; H
  (assert (to____function_guard
  (to__ (mk___rep (us_split_fields__content s__split_fields7)))
  (mk___rep (us_split_fields__content s__split_fields7))))
...
;; H
  (assert (to____function_guard (to__ temp___4852) temp___4852))

;; H
  (assert
  (and (= (to_rep1 s__split_fields) 0) (= s__split_fields1 (temp___157 0))))

;; H
  (assert
  (and (= list__reverse_list__first__assume 1)
  (and (in_range4 list__reverse_list__first__assume)
...
;; H
  (assert
  (and (= list__reverse_list__last__assume (last2 (model__ l)))
  (and (in_range6 list__reverse_list__last__assume)
  (= list__reverse_list__last__assume (last2 (model__ l))))))
...
;; H
  (assert
  (=> (and (<= first2 i3) (<= i3 last3))
  (and (= s__split_fields temp___468) (= s__split_fields1 temp___4681))))

;; H
  (assert (=> (and (<= first2 i3) (<= i3 last3)) (= temp___467 i3)))

;; H
  (assert
  (=> (and (<= first2 i3) (<= i3 last3)) (and (= o i3) (in_range4 i3))))
...
;; H
  (assert
  (=> (and (<= first2 i3) (<= i3 last3))
  (and (= (top (mk___rep s__split_fields3)) o1)
  (= (let ((temp___187 (to__
                       (mk___rep
                       (mk___split_fields s__split_fields s__split_fields1)))))
     (let ((temp___186 (to_but_top (mk___rep s__split_fields3))))
     (bool_eq1 (elts temp___186) (to_rep (first (rt temp___186)))
     (to_rep (last (rt temp___186))) (elts temp___187)
     (to_rep (first (rt temp___187))) (to_rep (last (rt temp___187)))))) true))))

;; H
  (assert
  (=> (and (<= first2 i3) (<= i3 last3))
  (and
  (= (to_rep (last (rt (to__ (mk___rep s__split_fields4))))) (+ (- i4 
  first2) 1))
  (forall ((j Int))
  (=> (and (<= first2 j) (<= j i4))
  (= (to_rep (select (elts (to__ (mk___rep s__split_fields4))) j)) (get
                                                                   (model__
                                                                   l) j)))))))
...
;; H
  (assert
  (=> (and (<= first2 i3) (<= i3 last3))
  (and (=> (<= first2 last3) (dynamic_property1 first2 last3 i4))
  (and (<= first2 i4) (<= i4 last3)))))
...
;; H
  (assert
  (=> (and (<= first2 i3) (<= i3 last3))
  (= s__split_fields5 (mk___split_fields__ref s__split_fields4))))
...
;; H
  (assert
  (=> (and (<= first2 i3) (<= i3 last3))
  (= s__split_fields6 s__split_fields4)))
...
;; H
  (assert
  (=> (and (<= first2 i3) (<= i3 last3))
  (= s__split_fields7 s__split_fields5)))
...
;; H
  (assert
  (=> (and (<= first2 i3) (<= i3 last3))
  (= s__split_fields8 s__split_fields6)))

;; H
  (assert
  (=> (not (and (<= first2 i3) (<= i3 last3))) (= i7 (mk_int__ref i3))))

;; H
  (assert
  (=> (not (and (<= first2 i3) (<= i3 last3)))
  (= s__split_fields7 (mk___split_fields__ref
                      (mk___split_fields s__split_fields s__split_fields1)))))
...
;; H
  (assert
  (=> (not (and (<= first2 i3) (<= i3 last3)))
  (= s__split_fields8 s__split_fields2)))
...
;; H
  (assert
  (=> (and (<= first2 i9) (<= i9 last3))
  (and (= res__split_discrs (mk___split_discrs temp___480))
  (= res__split_fields temp___4801))))

;; H
  (assert (=> (and (<= first2 i9) (<= i9 last3)) (= temp___479 i9)))

;; H
  (assert
  (=> (and (<= first2 i9) (<= i9 last3))
  (= (us_split_fields__content s__split_fields7) (mk___split_fields
                                                 temp___485 temp___4851))))

;; H
  (assert
  (=> (and (<= first2 i9) (<= i9 last3))
  (= (us_split_fields__content s__split_fields7) (mk___split_fields
                                                 temp___478 temp___4781))))

;; H
  (assert
  (=> (and (<= first2 i9) (<= i9 last3))
  (and
  (and (= o2 (top (mk___rep (us_split_fields__content s__split_fields7))))
  (top__function_guard o2
  (mk___rep (us_split_fields__content s__split_fields7))))
  (and (in_range1 o2)
  (= o2 (to_rep1
        (rec__stack__stack__top (us_split_fields__content s__split_fields7))))))))
...
;; H
  (assert
  (=> (and (<= first2 i9) (<= i9 last3)) (= result2 res__split_fields12)))
...
;; H
  (assert
  (=> (and (<= first2 i9) (<= i9 last3))
  (= (let ((temp___194 (to__ (mk___rep s__split_fields9))))
     (let ((temp___193 (to_but_top
                       (mk___rep (us_split_fields__content s__split_fields7)))))
     (bool_eq1 (elts temp___193) (to_rep (first (rt temp___193)))
     (to_rep (last (rt temp___193))) (elts temp___194)
     (to_rep (first (rt temp___194))) (to_rep (last (rt temp___194)))))) true)))
...
;; H
  ...
  (and
  (and
  (= (to_rep (last (rt (to__ (mk___rep s__split_fields10))))) (- last3 
  i10))
  (= (bool_eq1 (elts (to__ (mk___rep s__split_fields10)))
     (to_rep (first6 (mk1 first2 (- last3 i10))))
     (to_rep (last7 (mk1 first2 (- last3 i10)))) (elts (to__ temp___4852))
     (to_rep (first9 (mk2 first2 (- last3 i10))))
     (to_rep (last10 (mk2 first2 (- last3 i10))))) true))
  (forall ((j Int))
  (=> (and (<= first2 j) (<= j i10))
  (= (get (model__ (mk___rep1 res__split_discrs res__split_fields3)) j) 
  (get (model__ l) (+ (- (last2 (model__ l)) j) 1))))))))

;; H
  (assert
  (=> (and (<= first2 i9) (<= i9 last3))
  (and (=> (<= first2 last3) (dynamic_property2 first2 last3 i10))
  (and (<= first2 i10) (<= i10 last3)))))
...
;; H
  (assert
  (=> (and (<= first2 i9) (<= i9 last3))
  (= s__split_fields11 (mk___split_fields__ref s__split_fields10))))
...
;; H
  (assert
  (=> (and (<= first2 i9) (<= i9 last3))
  (= s__split_fields12 s__split_fields10)))
...
;; H
  (assert
  (=> (and (<= first2 i9) (<= i9 last3))
  (= s__split_fields13 s__split_fields11)))
...
;; H
  (assert
  (=> (not (and (<= first2 i9) (<= i9 last3))) (= i13 (mk_int__ref i9))))

;; H
  (assert
  (=> (not (and (<= first2 i9) (<= i9 last3)))
...
;; H
  (assert
  (= result3 (mk_list__ref
             (mk___rep1 (mk___split_discrs list__reverse_list__result)
...
;; H
  (assert
  (and (= o4 (last2 (model__ l)))
  (and (in_range6 o4) (= o4 (last2 (model__ l))))))
...
;; H
  (assert
  (and (= o7 (last2 (model__ l)))
  (and (in_range6 o7) (= o7 (last2 (model__ l))))))
...
(assert
;; WP_parameter_def
 ;; File "list.ads", line 10, characters 0-0
  (not (in_range4 o11)))
(check-sat)
