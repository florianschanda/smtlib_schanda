...
;; H
  (assert
  (and (= o19 (statusiswaitingfinishadminop (let ((subject state)) state15)))
  (statusiswaitingfinishadminop__function_guard o19
  (let ((subject state)) state15))))

;; H
  (assert
  (and (= o20 (statusiswaitingstartadminop (let ((subject state)) state15)))
...
;; H
  (assert
  (and (= o16 (statusisgotadmintoken (let ((subject state)) state15)))
  (statusisgotadmintoken__function_guard o16
  (let ((subject state)) state15))))
...
;; H
  (assert
  (=> (= result6 true)
  (and (= o14 (statusiswaitingstartadminop (let ((subject state)) state15)))
