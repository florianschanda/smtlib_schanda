...
(define-fun bool_eq4 ((a (Array Int unsigned_8)) (a__first Int) (a__last Int)
...
(define-fun dynamic_invariant1 ((temp___expr_208 us_t)
...
;; nth8_stream__def_axiom
  ...
  (! (=> (nth8_stream__function_guard (nth8_stream stream pos) stream pos)
     ...
     (= (nth (to_rep1 (select (to_array stream) (div1 pos 8)))
...
(declare-fun pokebit8 ((_ BitVec 8) Int Bool) (_ BitVec 8))

(declare-fun pokebit8__function_guard ((_ BitVec 8) (_ BitVec 8) Int
  Bool) Bool)

;; pokebit8__post_axiom
  (assert
  ...
  (! (=>
     ...
     (let ((result (pokebit8 byte left flag)))
     (=> (pokebit8__function_guard result byte left flag)
     (and
     (and
     (forall ((i Int))
     (=> (and (<= 0 i) (<= i 7))
     (=> (not (= i (- 7 left)))
     (= (= (nth result i) true) (= (nth byte i) true)))))
     (= (= (nth result (- 7 left)) true) (= flag true))) (dynamic_invariant2
     result true false true))))) :pattern ((pokebit8 byte left flag)) )))))
...
(define-fun dynamic_invariant4 ((temp___expr_202 Int)
...
(declare-fun o6 () (Array Int unsigned_8))
...
;; H
  ...
  (< left (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last))
               (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)))))

;; H
  (assert
  (and (<= (to_rep addr__first) (div1 left 8))
  (<= (div1 left 8) (to_rep addr__last))))

;; H
  (assert (= o (div1 left 8)))

;; H
  (assert (= o1 (select addr o)))
...
;; H
  (assert
  (and
  (and (= o3 (pokebit8 o2 (mod1 left 8) flag)) (pokebit8__function_guard 
  o3 o2 (mod1 left 8) flag))
  (and
  (forall ((i1 Int))
  (=> (and (<= 0 i1) (<= i1 7))
  (=> (not (= i1 (- 7 (mod1 left 8))))
  (= (= (nth o3 i1) true) (= (nth o2 i1) true)))))
  (= (= (nth o3 (- 7 (mod1 left 8))) true) (= flag true)))))
...
;; H
  (assert (= o5 (div1 left 8)))

;; H
  (assert (= o6 (store addr o5 o4)))

;; H
  (assert (= (mk_map__ref result) (mk_map__ref addr)))
...
;; H
  (assert
  (forall ((i1 Int)) (nth8_stream__function_guard
  (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last)))
  i1) (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) i1)))

;; H
  (assert
  (forall ((i1 Int)) (nth8_stream__function_guard
  (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last)))
  i1) (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i1)))

;; H
  (assert
  (=> (<= (to_rep addr__first) (to_rep addr__last))
  (= o7 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))

;; H
  (assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o7 0)))
...
;; H
  (assert (= result2 (ite (<= 0 i) o11 false)))
...
;; H
  ...
  (=>
  (and (<= 0 i1)
  (<= i1 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last))
                 (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1)))
  (=> (not (= i1 left))
  (=
  (= (nth8_stream
     (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) i1) true)
  (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last)))
     i1) true)))))))
