...
(declare-fun user_eq2 (t41b t41b) Bool)

(declare-fun dummy2 () t41b)
...
(declare-fun temp___432 (Int Int Int) (Array Int unsigned_byte))

;; def_axiom
  (assert
  (forall ((temp___434 Int) (temp___435 Int) (temp___436 Int))
  (let ((temp___433 (temp___432 temp___434 temp___435 temp___436)))
  (forall ((temp___437 Int))
  (ite (= temp___437 7)
  (= (select temp___433 temp___437) (of_rep temp___435))
  (ite (= temp___437 2)
  (= (select temp___433 temp___437) (of_rep temp___434))
  (= (select temp___433 temp___437) (of_rep temp___436))))))))
