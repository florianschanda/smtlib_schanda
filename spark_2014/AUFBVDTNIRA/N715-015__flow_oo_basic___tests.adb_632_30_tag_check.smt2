...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite true true false))
...
(define-fun default_initial_assumption1 ((temp___expr_138 us_rep)
  (temp___skip_top_level_139 Bool)) Bool (= (attr__tag temp___expr_138) 
  us_tag))

(assert
;; WP_parameter_def
 ;; File "tests.adb", line 618, characters 0-0
