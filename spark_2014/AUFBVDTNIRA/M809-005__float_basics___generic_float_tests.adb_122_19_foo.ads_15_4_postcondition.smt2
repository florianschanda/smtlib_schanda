...
(define-fun dynamic_invariant ((temp___expr_167 t) (temp___is_init_164 Bool)
...
(define-fun dynamic_invariant1 ((temp___expr_57 t) (temp___is_init_54 Bool)
...
(declare-fun foo__double_tests__bad_optimisation_1__result () t)
...
(declare-fun foo__double_tests__bad_optimisation_1__result1 () t)

(declare-fun foo__double_tests__bad_optimisation_1__result2 () t)

(declare-fun foo__double_tests__bad_optimisation_1__result3 () t)

(declare-fun foo__double_tests__bad_optimisation_1__result4 () t)

(declare-fun foo__double_tests__bad_optimisation_1__result5 () t)

(declare-fun result1 () t)

;; H
  (assert (tqtisFinite a))

;; H
  (assert (tqtisFinite b))

;; H
  (assert (neq b fliteral2))

;; H
  (assert
  (= foo__double_tests__bad_optimisation_1__result1 foo__double_tests__bad_optimisation_1__result2))

;; H
  (assert
  (= foo__double_tests__bad_optimisation_1__result3 foo__double_tests__bad_optimisation_1__result1))

;; H
  (assert
  (and (= o (div1 RNE2 fliteral b)) (tqtisFinite (div1 RNE2 fliteral b))))

;; H
  (assert (= o1 (mul RNE2 a o)))
...
;; H
  ...
  (= (mk_t__ref result) (mk_t__ref
                        foo__double_tests__bad_optimisation_1__result)))

;; H
  (assert (= foo__double_tests__bad_optimisation_1__result1 o2))

;; H
  (assert
  (= (mk_t__ref foo__double_tests__bad_optimisation_1__result4) (mk_t__ref
                                                                foo__double_tests__bad_optimisation_1__result2)))

;; H
  (assert
  (= foo__double_tests__bad_optimisation_1__result5 foo__double_tests__bad_optimisation_1__result3))

;; H
  (assert (= result1 foo__double_tests__bad_optimisation_1__result4))

(assert
;; WP_parameter_def
 ;; File "generic_float_tests.ads", line 2, characters 0-0
  (not (eq foo__double_tests__bad_optimisation_1__result4 (div1 RNE2 a b))))
(check-sat)
