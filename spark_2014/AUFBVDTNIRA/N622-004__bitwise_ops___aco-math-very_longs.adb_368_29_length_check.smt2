...
(declare-fun temp___1467 () (Array Int octet))

(declare-fun temp___14671 () t1)
...
;; H
  (assert (= temp___1466 temp___1467))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___14661)) (to_rep2 (last7 temp___14661))) 
  temp___14671))
...
;; WP_parameter_def
 ;; File "aco-math-very_longs.adb", line 310, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first2 temp___14671)) (to_rep2 (last4 temp___14671)))
     (+ (- (to_rep2 (last4 temp___14671)) (to_rep2 (first2 temp___14671))) 1)
