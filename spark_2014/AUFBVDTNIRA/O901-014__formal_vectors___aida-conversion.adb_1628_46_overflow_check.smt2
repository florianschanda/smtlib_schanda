...
(define-fun tint_arrayD1__ref_14__projection ((a tint_arrayD1__ref)) integer 
...
(define-fun tint_arrayT__ref_14__projection ((a tint_arrayT__ref)) us_t1 
...
(declare-datatypes ()
((t511b__ref (mk_t511b__ref (t511b__content integer)))))
(define-fun t511b__ref___projection ((a t511b__ref)) integer (t511b__content
                                                             a))
...
(define-fun tnumber_array_typeD1__ref_23__projection ((a tnumber_array_typeD1__ref)) integer 
...
(define-fun number_array_type__ref_23__projection ((a number_array_type__ref)) us_t3 
...
(declare-datatypes ()
((t515b__ref (mk_t515b__ref (t515b__content integer)))))
(define-fun t515b__ref___projection ((a t515b__ref)) integer (t515b__content
                                                             a))
...
(declare-datatypes ()
((t517b__ref (mk_t517b__ref (t517b__content integer)))))
(define-fun t517b__ref___projection ((a t517b__ref)) integer (t517b__content
                                                             a))
...
(define-fun tint_arrayB__ref_14__projection ((a tint_arrayB__ref)) us_t5 
  (tint_arrayB__content a))

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__aggregate_def (Int
  Int Int Int Int Int Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___2299 Int) (temp___2300 Int) (temp___2301 Int)
  (temp___2302 Int) (temp___2303 Int) (temp___2304 Int) (temp___2305 Int)
  (temp___2306 Int))
  (let ((temp___2298 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__aggregate_def
                     temp___2299 temp___2300 temp___2301 temp___2302
                     temp___2303 temp___2304 temp___2305 temp___2306)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 5) (+ (first1 source) 10)
  temp___2305 temp___2306)
  (and (= (first7 temp___2298) temp___2305)
  (= (last7 temp___2298) temp___2306)))
  (and
  (and
  (and
  (and
  (and
  (= (select (to_array2 temp___2298) (+ (+ (first1 source) 5) 0)) (of_rep1
                                                                  temp___2299))
  (= (select (to_array2 temp___2298) (+ (+ (first1 source) 5) 1)) (of_rep1
                                                                  temp___2300)))
  (= (select (to_array2 temp___2298) (+ (+ (first1 source) 5) 2)) (of_rep1
                                                                  temp___2301)))
  (= (select (to_array2 temp___2298) (+ (+ (first1 source) 5) 3)) (of_rep1
                                                                  temp___2302)))
  (= (select (to_array2 temp___2298) (+ (+ (first1 source) 5) 4)) (of_rep1
                                                                  temp___2303)))
  (= (select (to_array2 temp___2298) (+ (+ (first1 source) 5) 5)) (of_rep1
                                                                  temp___2304)))))))
...
(define-fun tnumber_array_typeB__ref_23__projection ((a tnumber_array_typeB__ref)) us_t6 
  (tnumber_array_typeB__content a))

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__aggregate_def (Int
  Int Int) us_t4)

;; def_axiom
  (assert
  (forall ((temp___2312 Int) (temp___2313 Int) (temp___2314 Int))
  (let ((temp___2311 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__aggregate_def
                     temp___2312 temp___2313 temp___2314)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 5) (+ (first1 source) 10)
  temp___2313 temp___2314)
  (and (= (first13 temp___2311) temp___2313)
  (= (last13 temp___2311) temp___2314)))
  (forall ((temp___2315 Int))
  (= (select (to_array4 temp___2311) temp___2315) (of_rep1 temp___2312)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_729 us_t3)
  ...
  (temp___do_toplevel_728 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 5)
                                      (+ (first1 source) 10)
                                      (first10 temp___expr_729)
                                      (last10 temp___expr_729))
                                      (and
                                      (= (first10 temp___expr_729) (+ 
                                      (first1 source) 5))
                                      (= (last10 temp___expr_729) (+ 
...
(declare-fun temp___2309 () (Array Int integer))

(declare-fun temp___23091 () t2)

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume1 () t1)

(declare-fun temp___2317 () (Array Int integer))

(declare-fun temp___23171 () t4)

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume1 () t3)

(declare-fun temp___2323 () Int)

(declare-fun temp___2324 () Int)

(declare-fun temp___2322 () Int)

(declare-fun temp___2320 () (Array Int integer))
...
;; H
  ...
  (forall ((index7 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 5) index7)
...
;; H
  ...
  (= (to_rep1
     (first6
     (rt2
     (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__aggregate_def
     3 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 5)
     (+ (+ (to_rep1 (first (rt source))) 5) 5))))) (+ (to_rep1
                                                      (first (rt source))) 5)))
...
;; H
  (assert
  (= (mk___t2 temp___2309 temp___23091) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__aggregate_def
                                        3 9 9 9 9 9
                                        (+ (to_rep1 (first (rt source))) 5)
                                        (+ (+ (to_rep1 (first (rt source))) 5) 5))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___23091)) (to_rep1 (last6 temp___23091)))
     (+ (- (to_rep1 (last6 temp___23091)) (to_rep1 (first6 temp___23091))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1
                                                        (first (rt source))) 10))
...
;; H
  (assert
  (= (slide1 temp___2309 (to_rep1 (first6 temp___23091))
     (+ (to_rep1 (first (rt source))) 5)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume))

;; H
  (assert
  (= (mk1 (+ (to_rep1 (first (rt source))) 5)
     (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume1))
...
;; H
  (assert
  (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume))

;; H
  (assert
  (= (to_rep1 int_array__first) (to_rep1
                                (first3
                                aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume1))))
...
;; H
  (assert
  (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 5)
  (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first)
  (to_rep1 int_array__last))
  (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 5))
...
;; H
  ...
  (= (to_rep1
     (first12
     (rt4
     (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__aggregate_def
     0 (+ (to_rep1 (first (rt source))) 5)
     (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1
                                                 (first (rt source))) 5)))
...
;; H
  (assert
  (= (mk___t4 temp___2317 temp___23171) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 5)
                                        (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___23171)) (to_rep1
                                               (last12 temp___23171)))
     (+ (- (to_rep1 (last12 temp___23171)) (to_rep1 (first12 temp___23171))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1
                                                        (first (rt source))) 10))
        (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1
                                                      (first (rt source))) 5)) 1)
...
;; H
  (assert
  (= (slide1 temp___2317 (to_rep1 (first12 temp___23171))
     (+ (to_rep1 (first (rt source))) 5)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume))

;; H
  (assert
  (= (mk3 (+ (to_rep1 (first (rt source))) 5)
     (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume1))
...
;; H
  (assert
  (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume))

;; H
  (assert
  (= (to_rep1 n__first) (to_rep1
                        (first9
                        aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume1))))
...
;; H
  (assert
  (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 5)
  (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last))
  (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 5))
...
;; H
  (assert
  (and (= temp___2323 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (= temp___2324 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))
...
;; H
  (assert (= index1 temp___2323))

;; H
  (assert
  (=> (and (<= temp___2323 index1) (<= index1 temp___2324))
  (= temp___2322 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2323 index1) (<= index1 temp___2324)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___2323 index1) (<= index1 temp___2324)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2323 index1) (<= index1 temp___2324)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2323 index1) (<= index1 temp___2324)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___2323 index1) (<= index1 temp___2324)) (= n2 o8)))

;; H
  (assert
  (=> (and (<= temp___2323 index1) (<= index1 temp___2324))
  (forall ((i Int))
  (=> (and (<= (+ (to_rep1 (first (rt source))) 5) i) (<= i index2))
...
;; H
  ...
  (=> (and (<= temp___2323 index1) (<= index1 temp___2324))
  (forall ((j Int))
  (=> (and (<= (+ (to_rep1 (first (rt source))) 5) j) (<= j index2))
...
;; H
  ...
  (and
  (and
  (forall ((temp___2321 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___2321)
  (<= temp___2321 (to_rep1 n__last)))
  (=> (< index2 temp___2321)
  (= (select n3 temp___2321) (select temp___2320 temp___2321)))))
  (=>
  (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10))
  (dynamic_property9 (+ (to_rep1 (first (rt source))) 5)
  (+ (to_rep1 (first (rt source))) 10) index2)))
  (and (<= (+ (to_rep1 (first (rt source))) 5) index2)
...
;; H
  (assert
  (=> (and (<= temp___2323 index1) (<= index1 temp___2324)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___2323 index1) (<= index1 temp___2324)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___2323 index1) (<= index1 temp___2324)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___2323 index1) (<= index1 temp___2324)))
...
;; H
  (assert
  (=> (not (and (<= temp___2323 index1) (<= index1 temp___2324))) (= n7 n1)))
...
;; H
  (assert
  (and (= temp___2325 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2325)
  (<= temp___2325 (to_rep1 n__last))))

;; H
  (assert (= o9 temp___2325))
...
;; H
  (assert
  (and (= temp___2326 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2326)
  (<= temp___2326 (to_rep1 n__last))))

;; H
  (assert (= o14 temp___2326))
...
;; H
  (assert
  (and (= temp___2327 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2327)
  (<= temp___2327 (to_rep1 n__last))))

;; H
  (assert (= o21 temp___2327))
...
;; H
  (assert
  (and (= temp___2328 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2328)
  (<= temp___2328 (to_rep1 n__last))))

;; H
  (assert (= o28 temp___2328))
...
;; H
  (assert
  (and (= temp___2329 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2329)
  (<= temp___2329 (to_rep1 n__last))))

;; H
  (assert (= o35 temp___2329))
...
;; H
  (assert
  (and (= temp___2330 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2330)
  (<= temp___2330 (to_rep1 n__last))))

;; H
  (assert (= o42 temp___2330))
...
(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 1538, characters 0-0
  (not (in_range1 o45)))
(check-sat)
