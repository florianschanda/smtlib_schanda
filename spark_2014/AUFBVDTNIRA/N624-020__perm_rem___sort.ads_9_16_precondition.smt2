...
;; H
  (assert (is_perm__function_guard
  (is_perm (mk___t temp___273 (mk 1 100)) (mk___t values3 (mk 1 100)))
  (mk___t temp___273 (mk 1 100)) (mk___t values3 (mk 1 100))))
...
;; H
  (assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___273 values)))

;; H
  (assert
  (=> (and (<= 1 current1) (<= current1 99)) (= temp___272 current1)))

;; H
  (assert
  (=> (and (<= 1 current1) (<= current1 99)) (= temp___271 smallest)))

;; H
  (assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___270 values)))

;; H
  (assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___269 hr1)))

;; H
  (assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___268 prec1)))
...
;; H
  (assert
  (=> (and (<= 1 current1) (<= current1 99))
  (= (is_perm (mk___t temp___273 (mk 1 100)) (mk___t values3 (mk 1 100))) true)))
...
;; H
  ...
  (invariant__ (mk___t values (mk 1 100))) (mk___t values (mk 1 100))))

(assert
;; WP_parameter_def
 ;; File "sort.adb", line 92, characters 0-0
  (not (= (invariant__ (mk___t values (mk 1 100))) true)))
(check-sat)
