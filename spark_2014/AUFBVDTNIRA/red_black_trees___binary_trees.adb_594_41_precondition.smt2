...
;; H
  (assert (= o77 (select temp___1923 o76)))
...
;; H
  ...
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1922 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1922 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___1922 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 o71))
  (model____function_guard temp___1922
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o71))
  (and (dynamic_invariant3 temp___1922 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1922 o71))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1922 o71)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o71))
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1922 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o73 (select temp___1922 o72)))
