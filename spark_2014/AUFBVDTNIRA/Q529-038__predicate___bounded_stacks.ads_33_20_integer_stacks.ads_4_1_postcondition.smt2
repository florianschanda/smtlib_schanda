...
(declare-fun temp___396 () positive)

(declare-fun temp___3961 () (Array Int element))

(declare-fun temp___3962 () t)

(declare-fun temp___3963 () natural)

(declare-fun temp___3964 () us_private)

(declare-fun temp___3965 () Int)
...
;; H
  (assert (<= (to_rep temp___3953) (to_rep3 temp___395)))

;; H
  (assert
  (= (mk___rep (mk___split_discrs temp___396)
     (mk___split_fields (mk___t temp___3961 temp___3962) temp___3963
     temp___3964) temp___3965) (mk___rep (mk___split_discrs temp___395)
                               (mk___split_fields
                               (mk___t temp___3951 temp___3952) temp___3953
                               temp___3954) temp___3955)))
...
;; H
  (assert (= temp___3961 this__split_fields4))

;; H
  (assert (= temp___3962 this__split_fields5))

;; H
  (assert (= temp___3963 this__split_fields6))

;; H
  (assert (= temp___3964 this__split_fields7))

;; H
  (assert (= this__split_discrs (mk___split_discrs temp___396)))
...
;; H
  ...
  this__split_fields10 this__split_fields11) this__attr__tag))
  (mk___rep this__split_discrs
  (mk___split_fields (mk___t this__split_fields8 this__split_fields9)
  this__split_fields10 this__split_fields11) this__attr__tag)))
