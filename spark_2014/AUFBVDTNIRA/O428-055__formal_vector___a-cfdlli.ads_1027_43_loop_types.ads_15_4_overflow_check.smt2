...
(define-fun dynamic_invariant1 ((temp___expr_408 Int)
...
(declare-fun temp___643 () count_type)
...
;; H
  (assert (= temp___643 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___643)) no_element))
...
;; H
  ...
  (and (in_range1 o2)
  (<= o2 (to_rep
         (rec__loop_types__lists__list__capacity target__split_discrs))))))
