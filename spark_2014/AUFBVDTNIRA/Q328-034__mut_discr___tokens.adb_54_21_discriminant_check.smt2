...
;; H
  ...
  (read__function_guard o52
  (mk___t word1 (mk (to_rep1 word__first) (to_rep1 word__last))))) (in_range4
  o52)))
...
;; H
  (assert (= temp___257 (mk___rep1 o55 o54 true)))
...
;; WP_parameter_def
 ;; File "tokens.ads", line 14, characters 0-0
  (not
  (= (rec__tokens__token__kind (us_split_discrs1 temp___257)) (rec__tokens__token__kind
                                                              v__split_discrs))))
(check-sat)
