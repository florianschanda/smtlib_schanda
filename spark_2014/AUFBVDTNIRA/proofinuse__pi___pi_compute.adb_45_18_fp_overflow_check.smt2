...
;; H
  (assert (and (= o (sub RNE2 t11 t21)) (tqtisFinite (sub RNE2 t11 t21))))

;; H
  (assert (= o1 (add RNE2 o t31)))

;; H
  (assert (and (= o2 o1) (tqtisFinite o1)))

;; H
  (assert (= o3 (sub RNE2 o2 t41)))

;; H
  (assert (and (= o4 o3) (tqtisFinite o3)))

;; H
  (assert (= o5 (add RNE2 o4 t51)))

;; H
  (assert (and (= o6 o5) (tqtisFinite o5)))

;; H
  (assert (= o7 (sub RNE2 o6 t61)))

;; H
  (assert (and (= o8 o7) (tqtisFinite o7)))

;; H
  (assert (= o9 (add RNE2 o8 t71)))

;; H
  (assert (and (= o10 o9) (tqtisFinite o9)))

;; H
  (assert (= o11 (sub RNE2 o10 t81)))

;; H
  (assert (and (= o12 o11) (tqtisFinite o11)))

;; H
  (assert (= o13 (add RNE2 o12 t91)))

;; H
  (assert (and (= o14 o13) (tqtisFinite o13)))

;; H
  (assert (= o15 (sub RNE2 o14 t101)))

;; H
  (assert (and (= o16 o15) (tqtisFinite o15)))

;; H
  (assert (= o17 (mul RNE2 fliteral11 o16)))
