...
(define-fun o4 () us_t (mk___t o1 o2))
...
;; H
  (assert
  (and
  (and (= o3 (index_of_minimum o4)) (index_of_minimum__function_guard o3 o4))
  (and (in_range2 o3)
...
;; WP_parameter_def
 ;; File "sorters.adb", line 22, characters 0-0
  (not (<= (to_rep (select values smallest2)) (to_rep (select values j)))))
(check-sat)
