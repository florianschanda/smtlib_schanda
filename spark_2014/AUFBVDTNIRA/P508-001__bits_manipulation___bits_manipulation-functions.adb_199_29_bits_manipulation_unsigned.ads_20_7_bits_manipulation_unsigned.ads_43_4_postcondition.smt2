...
(declare-fun bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result () (_ BitVec 16))

(declare-fun temp___1201 () Int)

(declare-fun temp___1200 () (_ BitVec 16))
...
(declare-fun result__4 () (_ BitVec 16))

(declare-fun i3 () Int)

(declare-fun result__5 () (_ BitVec 16))

(declare-fun i4 () Int)

(declare-fun result__6 () (_ BitVec 16))

(declare-fun i5 () Int)

(declare-fun result__7 () (_ BitVec 16))

(declare-fun i6 () Int)

(declare-fun result3 () (_ BitVec 16))

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result1 () (_ BitVec 16))

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result2 () (_ BitVec 16))

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result3 () (_ BitVec 16))

(declare-fun result__8 () (_ BitVec 16))

(declare-fun i7 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result4 () (_ BitVec 16))

(declare-fun result__9 () (_ BitVec 16))

(declare-fun i8 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result5 () (_ BitVec 16))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___1201 i1)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___1200 result__1)))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 amount))
  (=> (not (< (- i1 1) 65536)) (= o ((_ int2bv 16) 0)))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 amount))
  (= (bvand result__3 (let ((temp___1204 (- i2 1)))
                      (ite (< temp___1204 65536)
                      (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___1204))
                      ((_ int2bv 16) 0)))) (let ((temp___1205 (- i2 1)))
                                           (ite (< temp___1205 65536)
                                           (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___1205))
                                           ((_ int2bv 16) 0))))))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result1 
  bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result2))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result3 
  bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result1))

;; H
  (assert
  (= result3 bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result))
...
;; H
  (assert
  (= (mk_t__ref
     bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result4) 
  (mk_t__ref
  bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result2)))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result5 
  bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result3))
...
;; H
  (assert
  (= result4 bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result4))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 3, characters 0-0
  (not
  (= (bvand bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__ones__result4 
  (let ((temp___1212 (- i9 1)))
  (ite (< temp___1212 65536)
  (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___1212)) ((_ int2bv 16) 0)))) 
  (let ((temp___1213 (- i9 1)))
  (ite (< temp___1213 65536)
  (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___1213)) ((_ int2bv 16) 0))))))
(check-sat)
