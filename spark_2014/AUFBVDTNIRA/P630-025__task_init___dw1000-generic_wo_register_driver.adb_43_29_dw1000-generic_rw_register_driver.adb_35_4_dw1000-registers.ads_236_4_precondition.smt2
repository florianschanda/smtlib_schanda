...
(define-fun register_type__ref_30__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_21__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_21__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2768 us_t1)
  (temp___is_init_2765 Bool) (temp___skip_constant_2766 Bool)
  (temp___do_toplevel_2767 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2766 true))
                                       (and (dynamic_property2 1 5
                                       (first3 temp___expr_2768)
                                       (last4 temp___expr_2768))
                                       (and (= (first3 temp___expr_2768) 1)
                                       (= (last4 temp___expr_2768) 5)))))
...
(define-fun target__ref_10__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_10__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_2819 us_t2)
  (temp___is_init_2816 Bool) (temp___skip_constant_2817 Bool)
  (temp___do_toplevel_2818 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2817 true))
                                       (and (dynamic_property3 1 5
                                       (first5 temp___expr_2819)
                                       (last6 temp___expr_2819))
                                       (and (= (first5 temp___expr_2819) 1)
                                       (= (last6 temp___expr_2819) 5)))))
...
(declare-fun temp___7610 () (Array Int bits_8))

(declare-fun temp___76101 () t2)

(declare-fun temp___7611 () (Array Int bits_8))

(declare-fun temp___76111 () t1)
...
(define-fun temp___76102 () us_t2 (mk___t2 temp___7610 temp___76101))
...
;; H
  (assert
  (and
  (and (= temp___76102 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___76102 reg)) (dynamic_invariant1
  temp___76102 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___76101)) (to_rep (last5 temp___76101)))
     (+ (- (to_rep (last5 temp___76101)) (to_rep (first4 temp___76101))) 1)
     0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))

;; H
  (assert (= temp___7610 temp___7611))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76101)) (to_rep (last5 temp___76101))) 
  temp___76111))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___76111)) (to_rep (last3 temp___76111)))
     (+ (- (to_rep (last3 temp___76111)) (to_rep (first2 temp___76111))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7611 temp___76111)))
