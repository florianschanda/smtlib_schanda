...
(declare-fun temp___281 () (Array Int word32))
...
;; H
  (assert
  (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last)))
  (and (<= (to_rep (first (rt right))) i2)
  (<= i2 (to_rep (last (rt right)))))))
...
;; H
  (assert
  (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last)))
  (and (<= (to_rep (first (rt left))) i2) (<= i2 (to_rep (last (rt left)))))))
...
;; H
  ...
  (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last)))
  (forall ((pos Int))
  (=> (and (<= (to_rep result____first) pos) (<= pos i3))
...
;; H
  ...
  (=> (< i3 temp___282)
  (= (select result__3 temp___282) (select temp___281 temp___282)))))
