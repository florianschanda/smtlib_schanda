...
(declare-fun temp___552 () (_ BitVec 64))

(declare-fun temp___553 () (_ BitVec 64))

(declare-fun temp___551 () (_ BitVec 64))

(declare-fun temp___550 () (Array (_ BitVec 64) unsigned8))

(declare-fun temp___549 () (_ BitVec 64))

(declare-fun temp___554 () (Array (_ BitVec 64) unsigned8))

(declare-fun temp___548 () (_ BitVec 64))

(declare-fun temp___547 () (_ BitVec 64))

(declare-fun temp___546 () (_ BitVec 64))

(declare-fun temp___545 () (_ BitVec 64))

(declare-fun temp___544 () Bool)
...
;; H
  (assert (= temp___552 rbx))

;; H
  (assert (= temp___553 rsp))

;; H
  (assert (= temp___551 rsp))

;; H
  (assert (= temp___550 memory))

;; H
  (assert (= temp___549 xmm2))

;; H
  (assert (= temp___554 memory))

;; H
  (assert (= temp___548 xmm1))

;; H
  (assert (= temp___547 rax))

;; H
  (assert (= temp___546 xmm0))

;; H
  (assert (= temp___545 rdi))

;; H
  (assert (= temp___544 zeroflag))

;; H
  (assert (= rsp1 temp___553))
...
;; H
  ...
  (= (to_rep (select memory1 i)) (to_rep (select temp___554 i)))))))
