...
(declare-fun temp___670 () (_ BitVec 64))

(declare-fun temp___671 () (_ BitVec 64))

(declare-fun temp___669 () (_ BitVec 64))

(declare-fun temp___668 () (Array (_ BitVec 64) unsigned8))

(declare-fun temp___667 () (_ BitVec 64))

(declare-fun temp___672 () (Array (_ BitVec 64) unsigned8))

(declare-fun temp___666 () (_ BitVec 64))

(declare-fun temp___665 () (_ BitVec 64))

(declare-fun temp___664 () (_ BitVec 64))

(declare-fun temp___663 () (_ BitVec 64))

(declare-fun temp___662 () Bool)
...
;; H
  ...
  (writereg32post rdi1 ((_ int2bv 32) 4198624)) rdi1
  ((_ int2bv 32) 4198624)))

;; H
  (assert (writereg32post__function_guard
  (writereg32post rax1 ((_ int2bv 32) 2)) rax1 ((_ int2bv 32) 2)))

;; H
  (assert (readreg32__function_guard (readreg32 rbx1) rbx1))

;; H
  (assert (writereg32post__function_guard (writereg32post rbx2 o5) rbx2 
  o5))

;; H
  (assert (readreg32__function_guard (readreg32 rbx2) rbx2))

;; H
  (assert (= temp___670 rbx))

;; H
  (assert (= temp___671 rsp))

;; H
  (assert (= temp___669 rsp))

;; H
  (assert (= temp___668 memory))

;; H
  (assert (= temp___667 xmm2))

;; H
  (assert (= temp___672 memory))

;; H
  (assert (= temp___666 xmm1))

;; H
  (assert (= temp___665 rax))

;; H
  (assert (= temp___664 xmm0))

;; H
  (assert (= temp___663 rdi))

;; H
  (assert (= temp___662 zeroflag))

;; H
  (assert (= rsp1 temp___671))
...
;; H
  ...
  (= (to_rep (select memory1 i)) (to_rep (select temp___672 i)))))))

;; H
  (assert
  (and
  (and (= o (readmem64 ((_ int2bv 64) 4198864) memory1))
  (readmem64__function_guard o ((_ int2bv 64) 4198864) memory1))
  (and
  (and
  (and
  (and
  ...
  (= (bvand o ((_ int2bv 64) 255)) ((_ zero_extend 56) (to_rep
                                                       (select memory1 ((_ int2bv 64) 4198864)))))
  (= (bvand o ((_ int2bv 64) 65280)) (bvmul ((_ zero_extend 56) (to_rep
                                                                (select 
                                                                memory1 (bvadd ((_ int2bv 64) 4198864) ((_ int2bv 64) 1))))) ((_ int2bv 64) 256))))
  (= (bvand o ((_ int2bv 64) 16711680)) (bvmul ((_ zero_extend 56) (to_rep
                                                                   (select 
                                                                   memory1 (bvadd ((_ int2bv 64) 4198864) ((_ int2bv 64) 2))))) ((_ int2bv 64) 65536))))
  (= (bvand o ((_ int2bv 64) 4278190080)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory1 (bvadd ((_ int2bv 64) 4198864) ((_ int2bv 64) 3))))) ((_ int2bv 64) 16777216))))
  (= (bvand o ((_ int2bv 64) 1095216660480)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory1 (bvadd ((_ int2bv 64) 4198864) ((_ int2bv 64) 4))))) ((_ int2bv 64) 4294967296))))
  (= (bvand o ((_ int2bv 64) 280375465082880)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory1 (bvadd ((_ int2bv 64) 4198864) ((_ int2bv 64) 5))))) ((_ int2bv 64) 1099511627776))))
  (= (bvand o ((_ int2bv 64) 71776119061217280)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory1 (bvadd ((_ int2bv 64) 4198864) ((_ int2bv 64) 6))))) ((_ int2bv 64) 281474976710656))))
  (= (bvand o ((_ int2bv 64) 18374686479671623680)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory1 (bvadd ((_ int2bv 64) 4198864) ((_ int2bv 64) 7))))) ((_ int2bv 64) 72057594037927936))))))
...
;; H
  (assert (= (writereg32post rdi1 ((_ int2bv 32) 4198624)) true))
...
;; H
  (assert
  (and
  (and (= o1 (readmem64 ((_ int2bv 64) 4198872) memory2))
  (readmem64__function_guard o1 ((_ int2bv 64) 4198872) memory2))
  (and
  (and
  (and
  (and
  ...
  (= (bvand o1 ((_ int2bv 64) 255)) ((_ zero_extend 56) (to_rep
                                                        (select memory2 ((_ int2bv 64) 4198872)))))
  (= (bvand o1 ((_ int2bv 64) 65280)) (bvmul ((_ zero_extend 56) (to_rep
                                                                 (select 
                                                                 memory2 (bvadd ((_ int2bv 64) 4198872) ((_ int2bv 64) 1))))) ((_ int2bv 64) 256))))
  (= (bvand o1 ((_ int2bv 64) 16711680)) (bvmul ((_ zero_extend 56) (to_rep
                                                                    (select 
                                                                    memory2 (bvadd ((_ int2bv 64) 4198872) ((_ int2bv 64) 2))))) ((_ int2bv 64) 65536))))
  (= (bvand o1 ((_ int2bv 64) 4278190080)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory2 (bvadd ((_ int2bv 64) 4198872) ((_ int2bv 64) 3))))) ((_ int2bv 64) 16777216))))
  (= (bvand o1 ((_ int2bv 64) 1095216660480)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory2 (bvadd ((_ int2bv 64) 4198872) ((_ int2bv 64) 4))))) ((_ int2bv 64) 4294967296))))
  (= (bvand o1 ((_ int2bv 64) 280375465082880)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory2 (bvadd ((_ int2bv 64) 4198872) ((_ int2bv 64) 5))))) ((_ int2bv 64) 1099511627776))))
  (= (bvand o1 ((_ int2bv 64) 71776119061217280)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory2 (bvadd ((_ int2bv 64) 4198872) ((_ int2bv 64) 6))))) ((_ int2bv 64) 281474976710656))))
  (= (bvand o1 ((_ int2bv 64) 18374686479671623680)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory2 (bvadd ((_ int2bv 64) 4198872) ((_ int2bv 64) 7))))) ((_ int2bv 64) 72057594037927936))))))

;; H
  (assert
  (and
  (and (= o2 (safedivision64 xmm13 o1)) (safedivision64__function_guard 
  o2 xmm13 o1)) (= o2 (bvudiv xmm13 o1))))
...
;; H
  (assert
  (and (and (= o4 (ebx rbx1)) (ebx__function_guard o4 rbx1))
  (= o4 (readreg32 rbx1))))
...
;; H
  (assert
  (and (and (= o6 (ebx rbx2)) (ebx__function_guard o6 rbx2))
  (= o6 (readreg32 rbx2))))
...
;; H
  (assert
  (and
  (and (= o8 (readmem64 ((_ int2bv 64) 4198768) memory2))
  (readmem64__function_guard o8 ((_ int2bv 64) 4198768) memory2))
  (and
  (and
  (and
  (and
  ...
  (= (bvand o8 ((_ int2bv 64) 255)) ((_ zero_extend 56) (to_rep
                                                        (select memory2 ((_ int2bv 64) 4198768)))))
  (= (bvand o8 ((_ int2bv 64) 65280)) (bvmul ((_ zero_extend 56) (to_rep
                                                                 (select 
                                                                 memory2 (bvadd ((_ int2bv 64) 4198768) ((_ int2bv 64) 1))))) ((_ int2bv 64) 256))))
  (= (bvand o8 ((_ int2bv 64) 16711680)) (bvmul ((_ zero_extend 56) (to_rep
                                                                    (select 
                                                                    memory2 (bvadd ((_ int2bv 64) 4198768) ((_ int2bv 64) 2))))) ((_ int2bv 64) 65536))))
  (= (bvand o8 ((_ int2bv 64) 4278190080)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory2 (bvadd ((_ int2bv 64) 4198768) ((_ int2bv 64) 3))))) ((_ int2bv 64) 16777216))))
  (= (bvand o8 ((_ int2bv 64) 1095216660480)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory2 (bvadd ((_ int2bv 64) 4198768) ((_ int2bv 64) 4))))) ((_ int2bv 64) 4294967296))))
  (= (bvand o8 ((_ int2bv 64) 280375465082880)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory2 (bvadd ((_ int2bv 64) 4198768) ((_ int2bv 64) 5))))) ((_ int2bv 64) 1099511627776))))
  (= (bvand o8 ((_ int2bv 64) 71776119061217280)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory2 (bvadd ((_ int2bv 64) 4198768) ((_ int2bv 64) 6))))) ((_ int2bv 64) 281474976710656))))
  (= (bvand o8 ((_ int2bv 64) 18374686479671623680)) (bvmul ((_ zero_extend 56) 
  (to_rep (select memory2 (bvadd ((_ int2bv 64) 4198768) ((_ int2bv 64) 7))))) ((_ int2bv 64) 72057594037927936))))))
