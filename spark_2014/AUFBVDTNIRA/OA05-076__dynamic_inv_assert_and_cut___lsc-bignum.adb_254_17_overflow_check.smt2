...
;; H
  (assert (= o13 (+ c_first o12)))

;; H
  (assert (and (= o14 o13) (in_range1 o13)))

;; H
  (assert (= o15 (ite (<= o14 (to_rep (last (rt c)))) true false)))
...
;; H
  (assert (= o16 (ite (<= (to_rep (first (rt c))) o11) true false)))
...
;; H
  (assert (= o6 (ite (<= o5 (to_rep (last (rt b)))) true false)))
...
;; H
  (assert (= o7 (ite (<= (to_rep (first (rt b))) o2) true false)))
