...
;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int a (+ i3 1) (- a_last i3)) a (+ i3 1) (- a_last i3)))

;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int b (+ (+ b_first (- i3 a_first)) 1) (- a_last i3)) b
  (+ (+ b_first (- i3 a_first)) 1) (- a_last i3)))
...
;; H
  ...
  (num_of_big_int b (+ (+ b_first (- i3 a_first)) 1) (- a_last i3)))
  (num_of_big_int a (+ i3 1) (- a_last i3))
  (num_of_big_int b (+ (+ b_first (- i3 a_first)) 1) (- a_last i3))))
