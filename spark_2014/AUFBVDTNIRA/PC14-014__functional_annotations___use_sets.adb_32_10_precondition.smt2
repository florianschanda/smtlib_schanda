...
;; H
  ...
  (ite (= (= (length s) 0) true)
  (= (bool_eq3 use_sets__apply_f__cu__assume1 no_element) true)
...
;; H
  (assert
  (and (= (length (mk___rep r__split_discrs r__split_fields4)) 0)
  (= (is_empty1 (model__ (mk___rep r__split_discrs r__split_fields4))) true)))
...
;; H
  ...
  (= (contains (model__ (mk___rep r__split_discrs r__split_fields3))
...
;; WP_parameter_def
 ;; File "use_sets.ads", line 6, characters 0-0
  (not
  (or
  (< (length (mk___rep r__split_discrs r__split_fields3)) (to_rep1
                                                          (rec__use_sets__my_sets__set__capacity
                                                          r__split_discrs)))
