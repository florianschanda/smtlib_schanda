...
(declare-fun record_discr__search_upto__result () Bool)

(declare-fun record_discr__search_upto__result1 () us_main_type)
...
(declare-fun record_discr__search_upto__result__assume () Bool)

(declare-fun record_discr__search_upto__result__assume1 () us_main_type)
...
(declare-fun o19 () us_main_type)

(declare-fun result () Bool)

(declare-fun result2 () result_ty__ref)

(declare-fun record_discr__search_upto__result2 () us_rep)

(declare-fun result3 () result_ty__ref)

(declare-fun record_discr__search_upto__result3 () us_rep)

(declare-fun record_discr__search_upto__result4 () result_ty__ref)

(declare-fun record_discr__search_upto__result5 () us_rep)

(declare-fun record_discr__search_upto__result6 () result_ty__ref)

(declare-fun record_discr__search_upto__result7 () us_rep)

(declare-fun record_discr__search_upto__result8 () result_ty__ref)

(declare-fun record_discr__search_upto__result9 () us_rep)

(define-fun o20 () us_rep (mk___rep (mk___split_discrs o18)
                          (mk___split_fields o19)))

(define-fun o21 () us_rep1 (mk___rep1 (mk___split_discrs1 o15)
                           (mk___split_fields1 (mk___t o16 o17))))
...
(define-fun record_discr__search_upto__result10 () result_ty__ref (mk_result_ty__ref
                                                                  (mk___rep
                                                                  (mk___split_discrs
                                                                  record_discr__search_upto__result)
                                                                  (mk___split_fields
...
;; H
  ...
  (get_content record_discr__search_upto__result__assume2)
  record_discr__search_upto__result__assume2))

;; H
  (assert (get_content__function_guard (get_content o20) o20))
  ...
  (= record_discr__search_upto__result__assume2 (mk_result
                                                (ite (not
                                                     (= (to_rep
                                                        ...
                                                        (us_split_discrs3 r))) 0))
                                                true false) o))
  (mk_result__function_guard record_discr__search_upto__result__assume2
  (ite (not
       (= (to_rep
          (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0))
  true false) o))
...
;; H
  (assert
  (= record_discr__search_upto__result6 record_discr__search_upto__result4))

;; H
  (assert
  (= record_discr__search_upto__result7 record_discr__search_upto__result5))
...
;; H
  ...
  (not
  (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0))
  (= result (ite (= o3 e) true false))))

;; H
  (assert
  (=> (= result true)
  (= record_discr__search_upto__result4 (mk_result_ty__ref
                                        record_discr__search_upto__result2))))

;; H
  (assert
  (=> (= result true)
  (= record_discr__search_upto__result5 record_discr__search_upto__result2)))

;; H
  (assert
  (=> (= result true) (= result2 record_discr__search_upto__result10)))

;; H
  (assert
  (=> (= result true) (= record_discr__search_upto__result2 result1_base)))

;; H
  (assert
  (=> (not (= result true))
  (= record_discr__search_upto__result4 (mk_result_ty__ref
                                        record_discr__search_upto__result3))))

;; H
  (assert
  (=> (not (= result true))
  (= record_discr__search_upto__result5 record_discr__search_upto__result3)))
...
;; H
  ...
  (<= (to_rep1
      (first
      (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))) 1)
  (<= 1 (to_rep1
        (last1
        (rt
        (rec__record_discr__interm_result__to_search (us_split_fields3 r)))))))
  (and
  (<= (to_rep1
      (first
      (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))) (- 
  (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1))
  (<= (- (to_rep
         (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1) 
  (to_rep1
  (last1
...
;; H
  (assert (=> (not (= result true)) (= o6 temp___276)))
...
;; H
  (assert
  (=> (not (= result true))
  (= (ite (<= (to_rep1 (first4 temp___2761)) (to_rep1 (last7 temp___2761)))
     (+ (- (to_rep1 (last7 temp___2761)) (to_rep1 (first4 temp___2761))) 1)
     0) (ite (<= 1 (- (to_rep
                      (rec__record_discr__interm_result__upto
                      (us_split_discrs3 r))) 1))
        (+ (- (- (to_rep
                 (rec__record_discr__interm_result__upto
                 (us_split_discrs3 r))) 1) 1) 1)
        0))))

;; H
  (assert (=> (not (= result true)) (= temp___276 o7)))

;; H
  (assert
  (=> (not (= result true))
  (= (mk1 (to_rep1 (first4 temp___2761)) (to_rep1 (last7 temp___2761))) 
  o8)))
...
;; H
  ...
  (=> (not (= result true))
  (= o21 (to_base
         (mk___rep2 (mk___split_discrs1 o12)
         (mk___split_fields2 (mk___t1 o13 o14)))))))

;; H
  (assert
  (=> (not (= result true))
  (and
  (and (= o20 (search_upto o21 e)) (search_upto__function_guard o20 o21 e))
  (ite (= o18 true)
  (and (<= (get_content o20) (to_rep o15))
  (= (to_rep (select o16 (get_content o20))) e))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i (to_rep o15))) (not (= (to_rep (select o16 i)) e))))))))

;; H
  (assert
  (=> (not (= result true)) (= result3 record_discr__search_upto__result10)))

;; H
  (assert
  (=> (not (= result true)) (= record_discr__search_upto__result3 o20)))

;; H
  (assert
  (= record_discr__search_upto__result8 record_discr__search_upto__result6))

;; H
  (assert
  (= record_discr__search_upto__result9 record_discr__search_upto__result7))

;; H
  (assert
  (= (mk___rep (mk___split_discrs result4) (mk___split_fields result5)) 
  (result_ty__content record_discr__search_upto__result8)))

;; H
  (assert
  (= (rec__private_record__result_ty__found
     (us_split_discrs1
     (result_ty__content record_discr__search_upto__result8))) true))

;; H
  (assert (get_content__function_guard
  (get_content (result_ty__content record_discr__search_upto__result8))
  (result_ty__content record_discr__search_upto__result8)))
