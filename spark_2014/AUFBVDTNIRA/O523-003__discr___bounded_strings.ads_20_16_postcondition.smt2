...
(declare-fun bounded_strings__make__result () index_type)

(declare-fun bounded_strings__make__result1 () (Array Int character))

(declare-fun bounded_strings__make__result2 () t1)

(declare-fun bounded_strings__make__result3 () size_type)
...
(declare-fun o11 () size_type)

(declare-fun o12 () us_split_fields2)

(declare-fun temp___217 () us_rep1)
...
(declare-fun b__split_fields5 () us_split_fields2)

(declare-fun result3 () bounded_string__ref)

(declare-fun bounded_strings__make__result4 () us_rep)

(declare-fun bounded_strings__make__result5 () bounded_string__ref)

(declare-fun bounded_strings__make__result6 () us_rep)

(declare-fun b__split_fields6 () us_split_fields__ref1)

(declare-fun bounded_strings__make__result7 () bounded_string__ref)

(declare-fun b__split_fields7 () us_split_fields2)

(declare-fun bounded_strings__make__result8 () us_rep)

(declare-fun result4 () index_type)

(declare-fun result5 () (Array Int character))

(declare-fun result6 () t1)

(declare-fun result7 () size_type)
...
;; H
  (assert
  (and (= o10 (length initializer)) (in_range4 (length initializer))))
...
;; H
  ...
  (= o12 (mk___split_fields1
         (rec__bounded_strings__bounded_string__text1 b__split_fields4) 
         o11)))

;; H
  (assert (= temp___217 (mk___rep1 b__split_discrs o12)))

;; H
  (assert (= result2 (mk___split_fields__ref1 b__split_fields4)))

;; H
  (assert (= b__split_fields5 (us_split_fields3 temp___217)))

;; H
  (assert (= b__split_discrs (us_split_discrs2 temp___217)))

;; H
  (assert
  (= bounded_strings__make__result5 (mk_bounded_string__ref
                                    bounded_strings__make__result4)))
...
;; H
  (assert
  (= result3 (mk_bounded_string__ref
             (mk___rep (mk___split_discrs bounded_strings__make__result)
             (mk___split_fields
             (mk___t1 bounded_strings__make__result1
             bounded_strings__make__result2) bounded_strings__make__result3)))))

;; H
  (assert
  (= bounded_strings__make__result4 (to_base
                                    (mk___rep1 b__split_discrs
                                    b__split_fields5))))
...
;; H
  (assert
  (= (mk___rep (mk___split_discrs result4)
     (mk___split_fields (mk___t1 result5 result6) result7)) (bounded_string__content
                                                            bounded_strings__make__result7)))

;; H
  (assert (size__function_guard
  (size (bounded_string__content bounded_strings__make__result7))
  (bounded_string__content bounded_strings__make__result7)))
