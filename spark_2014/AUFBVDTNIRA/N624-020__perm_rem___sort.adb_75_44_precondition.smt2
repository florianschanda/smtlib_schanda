...
;; H
  (assert (remove__function_guard (remove o28 o29) o28 o29))

;; H
  (assert (remove__function_guard (remove o26 o29) o26 o29))
...
;; H
  ...
  (remove__function_guard o28 (mk___t interm1 (mk 1 100)) o27))
...
;; H
  (assert
  (and
  (and (= o26 (remove (mk___t init (mk 1 100)) o25)) (remove__function_guard
  o26 (mk___t init (mk 1 100)) o25))
...
;; H
  (assert
  (and
  (and (= o30 (remove_eq o26 o28 o29)) (remove_eq__function_guard o30 
  o26 o28 o29))
  (and (in_range4 o30)
  (=> (= (of_int o30) true)
  (= (let ((temp___181 (remove o28 o29)))
     (let ((temp___180 (remove o26 o29)))
     (bool_eq5 (elts temp___180) (to_rep1 (first (rt temp___180)))
     (to_rep1 (last (rt temp___180))) (elts temp___181)
     (to_rep1 (first (rt temp___181))) (to_rep1 (last (rt temp___181)))))) true)))))
...
;; H
  (assert (invariant____function_guard (invariant__ temp___326) temp___326))
...
;; H
  ...
  (remove__function_guard o32 (mk___t values2 (mk 1 100)) o31))
...
;; H
  (assert
  (and
  (and (= temp___326 (remove o32 o33)) (remove__function_guard temp___326 
  o32 o33))
  (and (dynamic_invariant4 temp___326 true false true)
  (and (= (invariant__ temp___326) true)
  (and (= (to_rep1 (last (rt temp___326))) (- (to_rep1 (last (rt o32))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o33 1)))
  (= (to_rep (select (elts o32) k)) (to_rep (select (elts temp___326) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o33 1) k) (<= k (to_rep1 (last (rt o32)))))
  (= (to_rep (select (elts o32) k)) (to_rep
                                    (select (elts temp___326) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o33 k) (<= k (- (to_rep1 (last (rt o32))) 1)))
  (= (to_rep (select (elts o32) (+ k 1))) (to_rep
                                          (select (elts temp___326) k))))))))))))
