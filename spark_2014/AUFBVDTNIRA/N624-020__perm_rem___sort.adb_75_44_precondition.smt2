...
;; H
  (assert
  (and (= temp___237 (remove o32 o33))
  (and (dynamic_invariant4 temp___237 true false true)
  (and (= (invariant__ temp___237) true)
  (and (= (to_rep1 (last (rt temp___237))) (- (to_rep1 (last (rt o32))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o33 1)))
  (= (to_rep (select (elts o32) k)) (to_rep (select (elts temp___237) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o33 1) k) (<= k (to_rep1 (last (rt o32)))))
  (= (to_rep (select (elts o32) k)) (to_rep
                                    (select (elts temp___237) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o33 k) (<= k (- (to_rep1 (last (rt o32))) 1)))
  (= (to_rep (select (elts o32) (+ k 1))) (to_rep
                                          (select (elts temp___237) k))))))))))))
