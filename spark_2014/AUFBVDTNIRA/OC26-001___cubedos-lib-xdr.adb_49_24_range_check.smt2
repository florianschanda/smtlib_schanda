...
(declare-fun temp___461 () (_ BitVec 32))

(declare-fun temp___460 () (_ BitVec 32))

(declare-fun temp___458 () (Array Int octet))
...
(declare-fun temporary_25 () (_ BitVec 32))

(declare-fun i4 () Int)

(declare-fun data6 () (Array Int octet))

(declare-fun temporary_16 () (_ BitVec 32))
...
(declare-fun temporary_27 () (_ BitVec 32))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= temp___461 temporary_2)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= temp___460 temporary_11)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= temp___458 data)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (and (<= 1 i2) (<= i2 4))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= temporary_22 result2)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 4))
  (= temporary_23 (bvurem temporary_12 ((_ int2bv 32) 256)))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= o1 (+ position (- 4 i2)))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= o2 (store data2 o1 o))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= data2 result3)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= data3 o2)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= temporary_12 result4)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 4))
  (= temporary_13 (bvudiv temporary_12 ((_ int2bv 32) 256)))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= i2 4)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= i2 i3)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= temporary_23 temporary_24)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= temporary_13 temporary_14)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= data3 data4)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= i4 i2)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= temporary_25 temporary_23)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= temporary_15 temporary_13)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= data5 data3)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= i5 (mk_int__ref i3))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 4)) (= temporary_28 (mk_t__ref1 temporary_24))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= data8 (mk_map__ref data4))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= i6 i4)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= temporary_27 temporary_25)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= temporary_17 temporary_15)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 4)) (= data7 data5)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 4))) (= i5 (mk_int__ref i1))))
...
;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 4))) (= temporary_11 temporary_16)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 4))) (= data8 (mk_map__ref data))))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 4))) (= i6 i1)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 4))) (= temporary_27 temporary_21)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 4))) (= temporary_17 temporary_11)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 4))) (= data7 data1)))

(assert
;; WP_parameter_def
 ;; File "cubedos-lib-xdr.ads", line 57, characters 0-0
  (not (in_range2 (+ position 3))))
(check-sat)
