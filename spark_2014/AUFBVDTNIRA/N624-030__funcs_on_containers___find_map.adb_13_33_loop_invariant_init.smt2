...
;; H
  (assert
  (= result____split_fields4 find_map__index_maps__clear__container__fields1))
...
;; H
  ...
  (= (ole (model__ (mk___rep result____split_discrs result____split_fields4))
     (model__
     (mk___rep result____split_discrs
  ...
  (= (keys_included_except
     ...
     (to_rep (select (elts a) k1))) true))
  (= (mapping_preserved
     (keys (mk___rep result____split_discrs result____split_fields4))
     (keys
     (mk___rep result____split_discrs
     find_map__index_maps__insert__2__container__fields1))
     (positions (mk___rep result____split_discrs result____split_fields4))
     (positions
     (mk___rep result____split_discrs
     find_map__index_maps__insert__2__container__fields1))) true))
...
;; H
  (assert
  (=> (= result2 true)
  (= result____split_fields3 find_map__index_maps__insert__2__container__fields1)))
...
;; WP_parameter_def
 ;; File "find_map.ads", line 23, characters 0-0
  (not
  (<= (length1 (mk___rep result____split_discrs result____split_fields3)) 
  k1)))
(check-sat)
