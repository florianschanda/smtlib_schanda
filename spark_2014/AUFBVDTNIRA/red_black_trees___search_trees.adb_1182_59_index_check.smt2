...
(declare-fun temp___1259 () (Array Int us_rep1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1259 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1259 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1259 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (model____function_guard temp___1259
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o))
  (and (dynamic_invariant9 temp___1259 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1259 o))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1259 o)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i o))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1259 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1259 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1259 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1259 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1259 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1259 j)))) true))
  (= j i))))))))))))))
