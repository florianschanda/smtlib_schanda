...
(define-fun bool_eq2 ((a (Array Int value_t)) (a__first Int) (a__last Int)
...
(declare-fun usergroup_examples__value_cache_t__cached__first__bit () Int)

(declare-fun usergroup_examples__value_cache_t__cached__last__bit () Int)

(declare-fun usergroup_examples__value_cache_t__cached__position () Int)
...
(declare-fun usergroup_examples__value_cache_t__cache__first__bit () Int)

(declare-fun usergroup_examples__value_cache_t__cache__last__bit () Int)

(declare-fun usergroup_examples__value_cache_t__cache__position () Int)
...
(define-fun bool_eq4 ((a (Array Int us_rep)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq3 (select a temp___idx_134)
...
(declare-fun va () (Array Int value_t))
...
(declare-fun vca () (Array Int us_rep))

(declare-fun v () Int)

(declare-fun o () value_t)

(declare-fun o1 () Bool)

(declare-fun o2 () value_t)

(declare-fun o3 () Bool)

(declare-fun o4 () value_t)

(declare-fun o5 () (Array Int us_rep))

(declare-fun vca1 () (Array Int us_rep))
...
(declare-fun vca2 () (Array Int us_rep))

(declare-fun result2 () (Array Int us_rep))

(declare-fun vca3 () (Array Int us_rep))

(declare-fun result3 () Int)

(declare-fun v2 () Int)

(declare-fun vca4 () (Array Int us_rep))

(declare-fun v3 () Int)

(declare-fun vca5 () (Array Int us_rep))
