...
;; range_axiom
  (assert
  (forall ((x et3)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
;; range_axiom
  (assert
  (forall ((x et4)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
;; range_axiom
  (assert
  (forall ((x et2)) (! (in_range1 (to_rep4 x)) :pattern ((to_rep4 x)) )))
...
(declare-fun temp___6891 () us_rep2)
...
(declare-fun temp___6894 () us_rep2)

(declare-fun o22 () et4)

(declare-fun o23 () us_split_fields4)

(declare-fun temp___6896 () us_rep2)
...
(declare-fun temp___6899 () us_rep2)
...
;; H
  (assert (= r__split_fields5 (us_split_fields5 temp___6891)))
...
;; H
  (assert (= temp___6894 (mk___rep2 o21)))

;; H
  (assert (= result1 (mk___split_fields__ref2 r__split_fields5)))

;; H
  (assert (= r__split_fields6 (us_split_fields5 temp___6894)))
...
;; H
  (assert (= temp___6896 (mk___rep2 o23)))

;; H
  (assert (= result2 (mk___split_fields__ref2 r__split_fields6)))

;; H
  (assert (= r__split_fields7 (us_split_fields5 temp___6896)))
...
;; H
  (assert (= temp___6899 (mk___rep2 o27)))

;; H
  (assert (= result3 (mk___split_fields__ref2 r__split_fields7)))

;; H
  (assert (= r__split_fields8 (us_split_fields5 temp___6899)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 912, characters 0-0
  (not
  (= (bool_eq7 (mk___rep2 (us_split_fields__content2 r__split_fields9))
     (mk___rep2
     (mk___split_fields2
     (mk___rep1
     (mk___split_fields1 (of_rep1 f)
     (mk___rep (mk___split_fields (of_rep e) r__split_fields2)) (of_rep3 2)))
     (of_rep2 g)))) true)))
(check-sat)
