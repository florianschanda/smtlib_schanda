...
;; H
  (assert
  (= result2 bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result4))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 3, characters 0-0
  (not
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result4 (bvand 
