...
(declare-fun tl3 () (Array Int us_rep1))

;; H
  (assert (= result (mk_int__ref t1)))
...
;; H
  ...
  (ite (<= t3 temp___252) (= (select tl1 temp___252) (select tl temp___252))
  (and
...
;; H
  ...
  (= o1 (add RNE2
        ...
        (us_split_fields1
        (select (rec__untangle_tests__triangle__vertices
                (us_split_fields3 (select tl2 t3))) v2))))
...
;; H
  ...
  (= (rec__untangle_tests__coordinate__y
     (us_split_fields1
     (select (rec__untangle_tests__triangle__vertices
             (us_split_fields3 (select tl2 t3))) v2))) o4))
...
;; H
  ...
  (= (rec__untangle_tests__coordinate__z
     (us_split_fields1
     (select (rec__untangle_tests__triangle__vertices
             (us_split_fields3 (select tl2 t3))) v2))) o5))
...
;; H
  ...
  (= (rec__untangle_tests__coordinate__w
     (us_split_fields1
     (select (rec__untangle_tests__triangle__vertices
             (us_split_fields3 (select tl2 t3))) v2))) o6))
...
;; H
  ...
  (= o11 (store (rec__untangle_tests__triangle__vertices
                (us_split_fields3 (select tl2 t3))) v2 (mk___rep
                                                       (mk___split_fields 
                                                       o7 o8 o9 o10)))))
...
;; H
  (assert
  (= (rec__untangle_tests__triangle__normal
     (us_split_fields3 (select tl2 t3))) (mk___rep
...
;; WP_parameter_def
 ;; File "untangle_tests.adb", line 44, characters 0-0
  ...
  (us_split_fields1
  (select (rec__untangle_tests__triangle__vertices
          (us_split_fields3 (select tl3 t3))) v2))))
