...
(declare-fun temp___395 () us_rep2)

(declare-fun o41 () us_rep1)

(declare-fun o42 () us_split_fields2)

(declare-fun temp___397 () us_rep2)
...
;; H
  (assert
  (=> (not (= first_available 0))
  (= temp___395 (mk___rep1 (mk___split_fields1 o39 o40)))))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (= model____split_fields3 (us_split_fields3 temp___395))))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (= model____split_fields4 (us_split_fields3 temp___397))))
