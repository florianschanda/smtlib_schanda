...
(declare-fun first_allocated2 () Int)
...
(declare-fun model____split_fields5 () us_split_fields__ref1)

(declare-fun res3 () int__ref)

(declare-fun data5 () map__ref)

(declare-fun first_available3 () int__ref)

(declare-fun first_allocated3 () int__ref)

(declare-fun next_avail3 () int__ref)

(declare-fun ma2 () sequence__ref)

(declare-fun model____split_fields6 () us_split_fields2)
...
(declare-fun first_allocated4 () Int)

(declare-fun next_avail4 () Int)

(declare-fun ma3 () us_rep1)
...
;; H
  ...
  (is_prepend (rec__list_allocator__m__t__allocated model____split_fields3)
  res1 o41) (rec__list_allocator__m__t__allocated model____split_fields3)
  res1 o41))

;; H
  (assert (length__function_guard
  (length (rec__list_allocator__m__t__available model____split_fields4))
  (rec__list_allocator__m__t__available model____split_fields4)))

;; H
  (assert
  (forall ((j Int)) (get__function_guard
  (get (rec__list_allocator__m__t__available model____split_fields4) j)
  (rec__list_allocator__m__t__available model____split_fields4) j)))
...
;; H
  (assert
  (forall ((j Int)) (get__function_guard
  (get (rec__list_allocator__m__t__available model____split_fields4) (+ j 1))
  (rec__list_allocator__m__t__available model____split_fields4) (+ j 1))))
...
;; H
  (assert
  (forall ((k Int)) (get__function_guard
  (get (rec__list_allocator__m__t__available model____split_fields4) k)
  (rec__list_allocator__m__t__available model____split_fields4) k)))

;; H
  (assert (length__function_guard
  (length (rec__list_allocator__m__t__allocated model____split_fields4))
  (rec__list_allocator__m__t__allocated model____split_fields4)))

;; H
  (assert
  (forall ((j Int)) (get__function_guard
  (get (rec__list_allocator__m__t__allocated model____split_fields4) j)
  (rec__list_allocator__m__t__allocated model____split_fields4) j)))
...
;; H
  (assert
  (forall ((j Int)) (get__function_guard
  (get (rec__list_allocator__m__t__allocated model____split_fields4) (+ j 1))
  (rec__list_allocator__m__t__allocated model____split_fields4) (+ j 1))))
...
;; H
  (assert
  (forall ((k Int)) (get__function_guard
  (get (rec__list_allocator__m__t__allocated model____split_fields4) k)
  (rec__list_allocator__m__t__allocated model____split_fields4) k)))
...
;; H
  (assert
  (forall ((j Int)) (get__function_guard (get ma1 (+ j 1)) ma1 (+ j 1))))

;; H
  (assert (length__function_guard (length ma1) ma1))
...
;; H
  (assert
  (forall ((j Int)) (get__function_guard (get ma1 (+ j 2)) ma1 (+ j 2))))
...
;; H
  (assert
  (forall ((r Int)) (mem__function_guard
  (mem (rec__list_allocator__m__t__available model____split_fields4) r)
  (rec__list_allocator__m__t__available model____split_fields4) r)))

;; H
  (assert
  (forall ((r Int)) (mem__function_guard
  (mem (rec__list_allocator__m__t__allocated model____split_fields4) r)
  (rec__list_allocator__m__t__allocated model____split_fields4) r)))
...
;; H
  ...
  (get (rec__list_allocator__m__t__available model____split_fields4) 1)
...
;; H
  (assert (get__function_guard
  (get (rec__list_allocator__m__t__allocated model____split_fields4) 1)
  (rec__list_allocator__m__t__allocated model____split_fields4) 1))
...
;; H
  ...
  (and (<= 1 first_available) (<= first_available 3))))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (= (mk___rep (mk___split_fields o1 o2 o3)) (select data o))))
...
;; H
  (assert
  (=> (not (= first_available 0)) (= result2 (mk_int__ref next_avail))))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (= next_avail2 0)) (= (to_rep o20) 0))))
...
;; H
  ...
  (=> (not (= next_avail2 0))
  (= (rec__list_allocator__cell__stat
     (us_split_fields1 (select data2 next_avail2))) o21))))

;; H
  (assert
  (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (= o20 o22))))
...
;; H
  ...
  (=> (not (= next_avail2 0))
  (= (rec__list_allocator__cell__next
     (us_split_fields1 (select data2 next_avail2))) o23))))

;; H
  (assert
  (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (= o24 o21))))

;; H
  (assert
  (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (= o25 o22))))

;; H
  (assert
  (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (= o26 o23))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (= next_avail2 0)) (and (<= 1 next_avail2) (<= next_avail2 3)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (= next_avail2 0)) (= o27 next_avail2))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (= next_avail2 0))
  (= o28 (store data2 o27 (mk___rep (mk___split_fields o24 o25 o26)))))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (= next_avail2 0)) (= result4 (mk_map__ref data2)))))

;; H
  (assert
  (=> (not (= first_available 0)) (=> (not (= next_avail2 0)) (= data3 o28))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (not (= next_avail2 0))) (= data3 data2))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (= first_allocated 0)) (= (to_rep o29) first_available))))
...
;; H
  ...
  (= (rec__list_allocator__cell__stat
     (us_split_fields1 (select data3 first_allocated))) o30))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (= first_allocated 0)) (= o29 o31))))
...
;; H
  ...
  (=> (not (= first_allocated 0))
  (= (rec__list_allocator__cell__next
     (us_split_fields1 (select data3 first_allocated))) o32))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (= first_allocated 0)) (= o33 o30))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (= first_allocated 0)) (= o34 o31))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (= first_allocated 0)) (= o35 o32))))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (= first_allocated 0)) (= o36 first_allocated))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (= first_allocated 0))
  (= o37 (store data3 o36 (mk___rep (mk___split_fields o33 o34 o35)))))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (= first_allocated 0)) (= result5 (mk_map__ref data3)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (= first_allocated 0)) (= data4 o37))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (not (= first_allocated 0))) (= data4 data3))))

;; H
  (assert
  (=> (not (= first_available 0)) (= result6 (mk_int__ref first_allocated))))

;; H
  (assert
  (=> (not (= first_available 0)) (= first_allocated2 first_available)))

;; H
  (assert
  (=> (not (= first_available 0)) (= result7 (mk_int__ref first_available))))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (= temp___616 (mk___rep1 (mk___split_fields1 o39 o40)))))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (= model____split_fields3 (us_split_fields3 temp___616))))
...
;; H
  ...
  (rec__list_allocator__m__t__allocated model____split_fields3) res1))
  (= (is_prepend
     (rec__list_allocator__m__t__allocated model____split_fields3) res1 
     o41) true))))
...
;; H
  (assert (=> (not (= first_available 0)) (= temp___618 (mk___rep1 o42))))

;; H
  (assert
  (=> (not (= first_available 0))
  (= result9 (mk___split_fields__ref1 model____split_fields3))))

;; H
  (assert
  (=> (not (= first_available 0))
  (= model____split_fields4 (us_split_fields3 temp___618))))
...
;; H
  ...
  (= (to_rep
     ...
     (select data4 (get
                   (rec__list_allocator__m__t__available
                   model____split_fields4) j))))) (ite (< j (length
                                                            (rec__list_allocator__m__t__available
  ...
  (= (to_rep
     ...
     (select data4 (get
                   (rec__list_allocator__m__t__available
                   model____split_fields4) j))))) (ite (< 1 j)
                                                  (get
                                                  (rec__list_allocator__m__t__available
                                                  model____split_fields4)
                                                  (- j 1)) 0)))
...
;; H
  ...
  (= (bool_eq5
     (select data4 (get
                   (rec__list_allocator__m__t__available
                   model____split_fields4) j))
     (select data4 (get ma1 (+ j 1)))) true)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (- (length ma1) 2)))
  (= (to_rep
     (rec__list_allocator__cell__next
     (us_split_fields1 (select data4 (get ma1 (+ j 1)))))) (get ma1 (+ j 2)))))))
...
;; H
  ...
  (= (to_rep
     (rec__list_allocator__cell__next
     (us_split_fields1 (select data4 (get ma1 (+ j 1)))))) (ite (< j 
                                                           (length
                                                           (rec__list_allocator__m__t__available
                                                           model____split_fields4)))
                                                           (get ma1 (+ j 2))
...
;; H
  ...
  (ite (= (to_rep1
          (rec__list_allocator__cell__stat
          (us_split_fields1 (select data4 r)))) 0)
  (and
  (= (mem (rec__list_allocator__m__t__available model____split_fields4) r) true)
  (not
  (= (mem (rec__list_allocator__m__t__allocated model____split_fields4) r) true)))
  (and
  (not
  (= (mem (rec__list_allocator__m__t__available model____split_fields4) r) true))
  (= (mem (rec__list_allocator__m__t__allocated model____split_fields4) r) true)))))))
...
;; H
  ...
  (and
  (and
  (ite (not (= first_available2 0))
  (and
  (< 0 (length (rec__list_allocator__m__t__available model____split_fields4)))
  (= (get (rec__list_allocator__m__t__available model____split_fields4) 1) 
  first_available2))
  (= (length (rec__list_allocator__m__t__available model____split_fields4)) 0))
  (ite (not (= first_allocated2 0))
  (and
  (< 0 (length (rec__list_allocator__m__t__allocated model____split_fields4)))
  (= (get (rec__list_allocator__m__t__allocated model____split_fields4) 1) 
  first_allocated2))
  (= (length (rec__list_allocator__m__t__allocated model____split_fields4)) 0)))
  (forall ((j Int))
  (=>
  (and (<= 1 j)
  (<= j (length
...
;; H
  (assert
  (=> (not (not (= first_available 0))) (= first_allocated2 first_allocated)))

;; H
  (assert
  (=> (not (not (= first_available 0))) (= first_available2 first_available)))
...
;; H
  ...
  (= model____split_fields4 (mk___split_fields1 model____split_fields
                            model____split_fields1))))
...
;; H
  (assert
  (=> (not (not (= first_available 0)))
  (= first_available2 first_available1)))
...
;; H
  (assert
  (=> (not (not (= first_available 0)))
  (= model____split_fields4 model____split_fields2)))
...
;; H
  (assert
  (= model____split_fields5 (mk___split_fields__ref1 model____split_fields4)))
