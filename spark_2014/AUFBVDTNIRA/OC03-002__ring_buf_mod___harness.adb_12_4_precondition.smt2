...
;; H
  (assert (to_model__function_guard (to_model (mk___rep r__split_fields11))
  (mk___rep r__split_fields11)))

;; H
  (assert
  (= (let ((temp___224 (to_model (mk___rep r__split_fields11))))
...
;; H
  ...
  (func_push (to_model (mk___rep r__split_fields11)) x)
  (to_model (mk___rep r__split_fields11)) x))

;; H
  (assert (to_model__function_guard (to_model (mk___rep r__split_fields10))
  (mk___rep r__split_fields10)))

;; H
  (assert
  (= (let ((temp___242 (func_push (to_model (mk___rep r__split_fields11)) x)))
     (let ((temp___241 (to_model (mk___rep r__split_fields10))))
...
;; H
  (assert (func_push__function_guard
  (func_push (to_model (mk___rep r__split_fields10)) y)
  (to_model (mk___rep r__split_fields10)) y))

;; H
  (assert (to_model__function_guard (to_model (mk___rep r__split_fields9))
  (mk___rep r__split_fields9)))

;; H
  (assert
  (= (let ((temp___242 (func_push (to_model (mk___rep r__split_fields10)) y)))
     (let ((temp___241 (to_model (mk___rep r__split_fields9))))
     (bool_eq3 (elts temp___241) (to_rep (first (rt temp___241)))
     (to_rep (last (rt temp___241))) (elts temp___242)
     (to_rep (first (rt temp___242))) (to_rep (last (rt temp___242)))))) true))
