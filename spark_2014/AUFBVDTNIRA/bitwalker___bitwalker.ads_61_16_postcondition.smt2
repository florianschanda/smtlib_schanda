...
(declare-fun bitwalker__peekbit64__result () Bool)
...
(declare-fun bitwalker__peekbit64__result1 () Bool)

(declare-fun bitwalker__peekbit64__result2 () Bool)

(declare-fun bitwalker__peekbit64__result3 () Bool)

(declare-fun bitwalker__peekbit64__result4 () Bool)

(declare-fun bitwalker__peekbit64__result5 () Bool)
...
;; H
  (assert
  (= (mk_bool__ref result) (mk_bool__ref bitwalker__peekbit64__result)))
...
;; H
  (assert
  (= (mk_bool__ref bitwalker__peekbit64__result4) (mk_bool__ref
                                                  bitwalker__peekbit64__result2)))

;; H
  (assert (= bitwalker__peekbit64__result5 bitwalker__peekbit64__result3))

;; H
  (assert (= result1 bitwalker__peekbit64__result4))

;; H
  (assert (= bitwalker__peekbit64__result4 true))

(assert
;; WP_parameter_def
 ;; File "bitwalker.ads", line 54, characters 0-0
  (not (= (nth value (- 63 left)) true)))
(check-sat)
