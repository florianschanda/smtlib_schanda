...
;; H
  (assert
  (and (= o31 (islocked (us_private__content state4)))
  (islocked__function_guard o31 (us_private__content state4))))
...
;; H
  ...
  (= o33 (thecurrentop
         (mk___rep
         (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (thecurrentop__function_guard o33
  (mk___rep
  (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (in_range3 o33))))
...
;; H
  (assert
  (and (= o23 (islocked (us_private__content state4)))
  (islocked__function_guard o23 (us_private__content state4))))
...
;; H
  ...
  (=> (= result1 true)
  (and
  (and (= o27 (theauthcertrole (us_private__content state3)))
  (theauthcertrole__function_guard o27 (us_private__content state3)))
  (in_range1 o27))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o25 (authcertvalid (us_private__content state3)))
  (authcertvalid__function_guard o25 (us_private__content state3)))))

;; H
  (assert
  (=> (= result1 true)
  (and (= o26 (isgood (us_private__content state3))) (isgood__function_guard
  o26 (us_private__content state3)))))
...
;; H
  ...
  (=> (= result5 true)
  (and
  (and (= o3 (theauthcertrole (us_private__content state3)))
  (theauthcertrole__function_guard o3 (us_private__content state3)))
  (in_range1 o3))))
...
;; H
  (assert
  (=> (= result5 true)
  (and (= o1 (authcertvalid (us_private__content state3)))
  (authcertvalid__function_guard o1 (us_private__content state3)))))

;; H
  (assert
  (=> (= result5 true)
  (and (= o2 (isgood (us_private__content state3))) (isgood__function_guard
  o2 (us_private__content state3)))))
