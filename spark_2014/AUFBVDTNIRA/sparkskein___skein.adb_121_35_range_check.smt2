...
(declare-fun dummy2 () word_count_t)
...
;; range_int_axiom
  (assert
  (forall ((x u64)) (! (uint_in_range (to_int3 x)) :pattern ((to_int3 x)) )))
...
(declare-datatypes ()
((us_t (mk___t (elts (Array (_ BitVec 64) u64))(rt t)))))
(define-fun to_array ((a us_t)) (Array (_ BitVec 64) u64) (elts a))

(define-fun of_array ((a (Array (_ BitVec 64) u64)) (f (_ BitVec 64))
...
;; object__alignment_axiom
  (assert
  (forall ((a (Array (_ BitVec 64) u64))) (<= 0 (object__alignment a))))
...
(declare-datatypes ()
((u64_seq__ref (mk_u64_seq__ref (u64_seq__content us_t)))))
(define-fun u64_seq__ref___projection ((a u64_seq__ref)) us_t (u64_seq__content
                                                              a))

(define-fun dynamic_invariant1 ((temp___expr_470 us_t)
  ...
  (temp___do_toplevel_469 Bool)) Bool (=>
                                      ...
                                      (first1 temp___expr_470)
                                      (last1 temp___expr_470))))
...
(define-fun dynamic_invariant2 ((temp___expr_458 (_ BitVec 64))
...
(assert
;; WP_parameter_def
 ;; File "skein.adb", line 111, characters 0-0
