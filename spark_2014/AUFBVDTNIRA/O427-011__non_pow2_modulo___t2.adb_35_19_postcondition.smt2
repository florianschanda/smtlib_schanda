...
(declare-fun t2__mmul__result () (_ BitVec 8))

(declare-fun result () (_ BitVec 8))

(declare-fun t2__mmul__result1 () (_ BitVec 8))

(declare-fun t2__mmul__result2 () (_ BitVec 8))

(declare-fun t2__mmul__result3 () (_ BitVec 8))

(declare-fun t2__mmul__result4 () (_ BitVec 8))

(declare-fun t2__mmul__result5 () (_ BitVec 8))
...
;; H
  (assert
  (= t2__mmul__result1 ((_ extract 7 0) (bvurem (bvmul ((_ zero_extend 8) 
...
;; WP_parameter_def
 ;; File "t2.adb", line 6, characters 0-0
  (not
  (= ((_ zero_extend 56) t2__mmul__result4) (bvurem (bvurem (bvmul ((_ zero_extend 56) 
