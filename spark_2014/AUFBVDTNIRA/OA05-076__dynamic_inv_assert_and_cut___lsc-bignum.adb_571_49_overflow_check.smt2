...
;; H
  (assert
  (and (= o41 (from_word64 i2)) (from_word64__function_guard o41 i2)))

;; H
  (assert (and (= o43 (oadd o41 o42)) (oadd__function_guard o43 o41 o42)))

;; H
  (assert
  (and (= o40 (from_integer j3)) (from_integer__function_guard o40 j3)))

;; H
  (assert (and (= o44 (ole o40 o43)) (ole__function_guard o44 o40 o43)))

;; H
  (assert (and (= o38 (+ k 1)) (in_range1 (+ k 1))))

;; H
  (assert (= o39 (ite (<= j3 o38) true false)))

;; H
  (assert
  (and (= o34 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o34 ((_ int2bv 32) 2))))

;; H
  (assert (and (= o35 (oexpon o34 j3)) (oexpon__function_guard o35 o34 j3)))

;; H
  (assert
  (and (= o29 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o29 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o28 (from_integer j3)) (from_integer__function_guard o28 j3)))

;; H
  (assert
  (and (= o30 (osubtract o28 o29)) (osubtract__function_guard o30 o28 o29)))
...
;; H
  (assert
  (and (= o31 (osubtract o27 o30)) (osubtract__function_guard o31 o27 o30)))

;; H
  (assert
  (and (= o26 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o26 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o32 (oexpon__2 o26 o31)) (oexpon__2__function_guard o32 o26 o31)))
...
;; H
  (assert
  (and (= o25 (num_of_big_int e e_first o24)) (num_of_big_int__function_guard
  o25 e e_first o24)))

;; H
  (assert
  (and (= o33 (odivide o25 o32)) (odivide__function_guard o33 o25 o32)))

;; H
  (assert (and (= o36 (omod o33 o35)) (omod__function_guard o36 o33 o35)))

;; H
  (assert (and (= o15 (- j3 s3)) (in_range1 (- j3 s3))))
...
;; H
  (assert
  (and (= o14 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o14 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o19 (oexpon o14 o18)) (oexpon__function_guard o19 o14 o18)))

;; H
  (assert
  (and (= o13 (from_word32 w2)) (from_word32__function_guard o13 w2)))

;; H
  (assert
  (and (= o20 (omultiply o13 o19)) (omultiply__function_guard o20 o13 o19)))

;; H
  (assert (and (= o37 (oeq o20 o36)) (oeq__function_guard o37 o20 o36)))
