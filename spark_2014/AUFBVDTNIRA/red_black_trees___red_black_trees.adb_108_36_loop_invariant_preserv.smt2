...
;; H
  (assert
  (forall ((i4 Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i4 0)
  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i4 0)))

;; H
  (assert
  (forall ((i4 Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i4 1)
