...
;; H
  (assert
  (and (= us2 l) (dynamic_property1 (to_rep a__first) (to_rep a__last) l)))
...
;; H
  (assert
  (and (= us1 k) (dynamic_property1 (to_rep a__first) (to_rep a__last) k)))
...
;; H
  (assert
  (and (= us j) (dynamic_property1 (to_rep a__first) (to_rep a__last) j)))
