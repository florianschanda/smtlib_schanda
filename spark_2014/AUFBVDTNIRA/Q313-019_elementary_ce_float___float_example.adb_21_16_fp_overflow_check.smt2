...
(declare-fun dummy1 () float_7)

(declare-datatypes ()
((float_7__ref (mk_float_7__ref (float_7__content float_7)))))
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral2) (= (tqtreal fliteral2) 4.0)))
...
;; H
  (assert (and (lt a fliteral2) (lt b fliteral2)))

(assert
;; WP_parameter_def
 ;; File "float_example.adb", line 5, characters 0-0
  (not (tqtisFinite (add RNE2 a b))))
(check-sat)
