...
(declare-fun for_loops_on_lists__count_for_of__result () Bool)
...
(declare-fun temp___5051 () count_type)
...
(declare-fun temp___5052 () us_rep1)
...
(declare-fun count_04 () int__ref)

(declare-fun count_14 () int__ref)

(declare-fun e4 () int__ref)

(declare-fun temp___5053 () cursor__ref)

(declare-fun count_05 () Int)

(declare-fun count_15 () Int)

(declare-fun e5 () Int)

(declare-fun temp___5054 () us_rep1)

(declare-fun count_06 () int__ref)

(declare-fun count_16 () int__ref)

(declare-fun e6 () int__ref)

(declare-fun temp___5055 () cursor__ref)

(declare-fun count_07 () Int)

(declare-fun count_17 () Int)

(declare-fun e7 () Int)

(declare-fun temp___5056 () us_rep1)

(declare-fun result8 () bool__ref)

(declare-fun for_loops_on_lists__count_for_of__result1 () Bool)

(declare-fun for_loops_on_lists__count_for_of__result2 () bool__ref)

(declare-fun for_loops_on_lists__count_for_of__result3 () Bool)

(declare-fun count_08 () int__ref)

(declare-fun count_18 () int__ref)

(declare-fun e8 () int__ref)

(declare-fun for_loops_on_lists__count_for_of__result4 () bool__ref)

(declare-fun count_09 () Int)

(declare-fun count_19 () Int)

(declare-fun e9 () Int)

(declare-fun for_loops_on_lists__count_for_of__result5 () Bool)
...
;; H
  (assert
  (and (= o7 (first l))
  (ite (= (= (length1 l) 0) true) (= (bool_eq5 o7 no_element) true)
  (and (= (has_key (positions l) o7) true) (= (get1 (positions l) o7) 1)))))
...
;; H
  (assert (=> (= result4 true) (= temp___502 e2)))
...
;; H
  (assert
  (=> (= result4 true) (=> (= e2 0) (= result5 (mk_int__ref count_01)))))
...
;; H
  ...
  (and (= (has_key (positions l) temp___5052) true)
  (= e3 (element l temp___5052))))))
...
;; H
  (assert
  (=> (= result4 true) (=> (= e3 1) (= result6 (mk_int__ref count_12)))))
...
;; H
  (assert
  (=> (= result4 true)
  (and (= o6 (next l temp___5052))
  (ite (= (ite (= (bool_eq5 temp___5052 no_element) false) (= (get1
                                                              (positions l)
                                                              temp___5052) 
          (length1 l)) true) true)
  (= (bool_eq5 o6 no_element) true)
  (and (= (has_key (positions l) o6) true)
  (= (get1 (positions l) o6) (+ (get1 (positions l) temp___5052) 1)))))))

;; H
  (assert
  (=> (= result4 true)
  (and (= o5 (has_key (positions l) o6))
  (= (= o5 true) (= (has_key (positions l) o6) true)))))

;; H
  (assert
  (=> (= result4 true) (= result7 (ite (not (= o5 true)) true false))))

;; H
  (assert (=> (= result4 true) (= result7 true)))

;; H
  (assert (=> (= result4 true) (= temp___5053 (mk_cursor__ref temp___5052))))
...
;; H
  (assert (=> (= result4 true) (= temp___5054 temp___5052)))
...
;; H
  (assert (=> (= result4 true) (= temp___5055 temp___5053)))
...
;; H
  (assert
  (=> (not (= result4 true))
  (= temp___5055 (mk_cursor__ref (mk___rep1 (mk___split_fields1 temp___505))))))
...
;; H
  (assert
  (=> (not (= result4 true))
  (= temp___5056 (mk___rep1 (mk___split_fields1 temp___5051)))))
...
;; H
  (assert
  (= for_loops_on_lists__count_for_of__result2 (mk_bool__ref
                                               for_loops_on_lists__count_for_of__result1)))

;; H
  (assert
  (= for_loops_on_lists__count_for_of__result3 for_loops_on_lists__count_for_of__result1))

;; H
  (assert
  (= result8 (mk_bool__ref for_loops_on_lists__count_for_of__result)))

;; H
  (assert
  (= for_loops_on_lists__count_for_of__result1 (ite (and
                                                    (< 0 (int__content
                                                         count_16))
                                                    (< 0 (int__content
                                                         count_06)))
...
;; H
  (assert
  (= for_loops_on_lists__count_for_of__result4 for_loops_on_lists__count_for_of__result2))
...
;; H
  (assert
  (= for_loops_on_lists__count_for_of__result5 for_loops_on_lists__count_for_of__result3))
...
;; H
  (assert
  (= result9 (bool__content for_loops_on_lists__count_for_of__result4)))

;; H
  (assert (= (bool__content for_loops_on_lists__count_for_of__result4) true))

(define-fun temp___516 () us_rep2 (model__ l))

(assert
;; WP_parameter_def
 ;; File "for_loops_on_lists.ads", line 25, characters 0-0
  (not
  (exists ((temp___515 Int))
  (and
  (and (in_range5 temp___515)
  (= (iter_has_element temp___516 temp___515) true))
  (= (get temp___516 temp___515) 0)))))
(check-sat)
