...
(define-fun dynamic_invariant ((temp___expr_1868 us_t1)
  ...
  (temp___do_toplevel_1867 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_1868))
                                       (and (= (first3 temp___expr_1868) 1)
                                       (= (last4 temp___expr_1868) 8)))))
...
(define-fun dynamic_invariant1 ((temp___expr_1884 us_t2)
  ...
  (temp___do_toplevel_1883 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_1884))
                                       (and (= (first5 temp___expr_1884) 1)
                                       (= (last6 temp___expr_1884) 8)))))
...
;; H
  (assert
  (and
  (and (= temp___75472 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___75472 reg)) (dynamic_invariant1
  temp___75472 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___75471)) (to_rep (last5 temp___75471)))
     (+ (- (to_rep (last5 temp___75471)) (to_rep (first4 temp___75471))) 1)
     0) (ite (<= 1 8) (+ (- 8 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___75471)) (to_rep (last5 temp___75471))) 
  temp___75481))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___75481)) (to_rep (last3 temp___75481)))
     (+ (- (to_rep (last3 temp___75481)) (to_rep (first2 temp___75481))) 1)
