...
(declare-fun use_sets__move__cu__assume () count_type)
...
;; H
  ...
  (= (bool_eq4 use_sets__move__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
...
;; WP_parameter_def
 ;; File "use_sets.ads", line 44, characters 0-0
  (not
  (= (capacity (mk___rep s1__split_discrs s1__split_fields2)) (capacity
                                                              (mk___rep
                                                              s1__split_discrs
                                                              (mk___split_fields
                                                              s1__split_fields))))))
