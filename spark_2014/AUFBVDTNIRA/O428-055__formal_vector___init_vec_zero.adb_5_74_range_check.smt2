...
(declare-fun temp___529 () Int)

(declare-fun temp___530 () Int)

(declare-fun temp___528 () capacity_range)
...
(declare-fun v__split_fields4 () us_split_fields__ref)
...
(define-fun v__split_fields11 () us_split_fields__ref (mk___split_fields__ref
                                                      (mk___split_fields
                                                      v__split_fields)))
...
;; H
  (assert
  (=> (and (<= r4b j2) (<= j2 r5b))
  (and (= v__split_discrs (mk___split_discrs temp___528))
  (= v__split_fields temp___5281))))
...
;; H
  (assert
  (=> (and (<= r4b j2) (<= j2 r5b))
  (= (mk___split_fields__ref (mk___split_fields result1)) v__split_fields11)))

;; H
  (assert
  (=> (and (<= r4b j2) (<= j2 r5b))
  (= (mk___split_fields v__split_fields2) loop_types__vectors__replace_element__container__fields1)))

;; H
  (assert
  (=> (and (<= r4b j2) (<= j2 r5b))
  (= (last (model__ (mk___rep v__split_discrs v__split_fields10))) temp___530)))
...
;; H
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k j3))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields10)) k) 0)))))

;; H
  (assert
  (=> (and (<= r4b j2) (<= j2 r5b))
  (and (=> (<= r4b r5b) (dynamic_property r4b r5b j3))
  (and (<= r4b j3) (<= j3 r5b)))))
...
;; H
  (assert
  (=> (and (<= r4b j2) (<= j2 r5b))
  (= v__split_fields4 (mk___split_fields__ref v__split_fields10))))
...
;; H
  (assert
  (=> (and (<= r4b j2) (<= j2 r5b)) (= v__split_fields5 v__split_fields10)))
...
;; H
  (assert
  (=> (and (<= r4b j2) (<= j2 r5b)) (= v__split_fields6 v__split_fields4)))
...
;; H
  (assert
  (=> (and (<= r4b j2) (<= j2 r5b)) (= v__split_fields7 v__split_fields5)))
...
;; H
  (assert
  (=> (not (and (<= r4b j2) (<= j2 r5b)))
  (= v__split_fields6 v__split_fields11)))
