...
(declare-fun temp___8338 () (Array Int (Array Int et1)))

(declare-fun temp___83381 () Bool)
...
;; WP_parameter_def
 ;; File "ar.ads", line 1558, characters 0-0
  ...
  (= (bool_eq4
     ...
     (mk___rep
     (mk___split_fields
     (temp___3258 r__split_fields i a (- 55 i)
     (temp___3266 (select r__split_fields (- 55 i)) 1 0)) r__split_fields1))) true)))
(check-sat)
