...
(declare-fun user_eq7 (bits_7 bits_7) Bool)

(declare-fun dummy7 () bits_7)
...
;; range_axiom
  (assert
  (forall ((x bits_7)) (! (in_range5 (to_rep5 x)) :pattern ((to_rep5 x)) )))
...
(define-fun to_int7 ((x bits_7)) Int (bv2nat (to_rep5 x)))

;; range_int_axiom
  (assert
  (forall ((x bits_7)) (! (in_range_int3
  (to_int7 x)) :pattern ((to_int7 x)) )))

(declare-sort bits_10 0)

(define-fun in_range6 ((x (_ BitVec 16))) Bool (and
...
(declare-fun to_rep6 (bits_10) (_ BitVec 16))

(declare-fun of_rep6 ((_ BitVec 16)) bits_10)
...
;; range_axiom
  (assert
  (forall ((x bits_10)) (! (in_range6 (to_rep6 x)) :pattern ((to_rep6 x)) )))
...
(define-fun to_int8 ((x bits_10)) Int (bv2nat (to_rep6 x)))

;; range_int_axiom
  (assert
  (forall ((x bits_10)) (! (in_range_int4
...
(define-fun register_type__ref_14__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_10__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_10__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2176 us_t1)
  (temp___is_init_2173 Bool) (temp___skip_constant_2174 Bool)
  (temp___do_toplevel_2175 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2174 true))
                                       (and (dynamic_property2 1 5
                                       (first3 temp___expr_2176)
                                       (last4 temp___expr_2176))
                                       (and (= (first3 temp___expr_2176) 1)
                                       (= (last4 temp___expr_2176) 5)))))
...
(define-fun target__ref_4__projection ((a target__ref)) us_t2 (target__content
                                                              a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_4__projection ((a source__ref)) us_rep (source__content
                                                               a))

(define-fun dynamic_invariant1 ((temp___expr_2201 us_t2)
  (temp___is_init_2198 Bool) (temp___skip_constant_2199 Bool)
  (temp___do_toplevel_2200 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2199 true))
                                       (and (dynamic_property3 1 5
                                       (first5 temp___expr_2201)
                                       (last6 temp___expr_2201))
                                       (and (= (first5 temp___expr_2201) 1)
                                       (= (last6 temp___expr_2201) 5)))))
...
(declare-fun temp___7570 () (Array Int bits_8))

(declare-fun temp___75701 () t2)

(declare-fun temp___7571 () (Array Int bits_8))

(declare-fun temp___75711 () t1)
...
(define-fun temp___75702 () us_t2 (mk___t2 temp___7570 temp___75701))
...
;; H
  (assert
  (and
  (and (= temp___75702 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___75702 reg)) (dynamic_invariant1
  temp___75702 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___75701)) (to_rep (last5 temp___75701)))
     (+ (- (to_rep (last5 temp___75701)) (to_rep (first4 temp___75701))) 1)
     0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))

;; H
  (assert (= temp___7570 temp___7571))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___75701)) (to_rep (last5 temp___75701))) 
  temp___75711))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___75711)) (to_rep (last3 temp___75711)))
     (+ (- (to_rep (last3 temp___75711)) (to_rep (first2 temp___75711))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7571 temp___75711)))
