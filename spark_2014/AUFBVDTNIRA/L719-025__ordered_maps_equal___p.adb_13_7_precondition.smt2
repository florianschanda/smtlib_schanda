...
(define-fun default_initial_assumption ((temp___expr_346 us_rep2)
  (temp___skip_top_level_347 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_347 true))
                                         (and
                                         (= (is_empty temp___expr_346) true)
                                         (= (length temp___expr_346) 0))))
...
(declare-datatypes ()
((key_type__ref2 (mk_key_type__ref2 (key_type__content2 us_rep1)))))
(define-fun key_type__ref_4__projection ((a key_type__ref2)) us_rep1 
...
(define-fun default_initial_assumption1 ((temp___expr_397 us_rep4)
  (temp___skip_top_level_398 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_398 true))
                                         (and
                                         (= (is_empty1 temp___expr_397) true)
                                         (= (length2 temp___expr_397) 0))))
...
(define-fun default_initial_assumption2 ((temp___expr_377 us_rep3)
...
;; positions__post_axiom
  ...
  (! (let ((result (positions container)))
     ...
     (and
     (and (<= 1 (get2 result i)) (<= (get2 result i) (length3 container)))
     (forall ((j us_rep1))
...
(declare-fun dummy10 () key_type2)

(declare-datatypes ()
((key_type__ref3 (mk_key_type__ref3 (key_type__content3 key_type2)))))
(define-fun key_type__ref_2__projection ((a key_type__ref3)) key_type2 
...
(define-fun dynamic_invariant3 ((temp___expr_307 Int)
...
;; element__2__post__dispatch_axiom
  ...
  (forall ((container us_rep))
  (! (=> (dynamic_invariant2 key true true true) (dynamic_invariant3
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant2 key2 true true true)
     ...
     (and (not (= (has_key1 (positions container) result) true))
...
;; p_positions_shifted__post_axiom
  ...
  (! (=>
     (and (dynamic_invariant5 cut true true true) (dynamic_invariant4 count
     true true true))
...
;; has_key__post_axiom
  ...
  (! (=> (= (of_int 0) true)
     (=>
     (exists ((k1 us_rep1))
     (and (= (has_key1 container k1) true) (= (bool_eq4 k1 key2) true)))
...
;; H
  ...
  (and
  (and
  (= (length3 (mk___rep l__split_discrs l__split_fields2)) (- (length3
                                                              (mk___rep
                                                              l__split_discrs
                                                              (mk___split_fields
                                                              l__split_fields))) 1))
  (not
  (= (has_key (model__ (mk___rep l__split_discrs l__split_fields2)) k) true)))
  ...
  (= (keys_included_except
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (model__ (mk___rep l__split_discrs l__split_fields2)) k) true))
  (= (range_equal
     (keys (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (keys (mk___rep l__split_discrs l__split_fields2)) 1
     (- (find
        (keys (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
        k) 1)) true))
  (= (range_shifted (keys (mk___rep l__split_discrs l__split_fields2))
     ...
     (find
     (keys (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 
     k) (length3 (mk___rep l__split_discrs l__split_fields2)) 1) true))
  (= (p_positions_shifted
...
;; WP_parameter_def
 ;; File "p.ads", line 16, characters 0-0
  (not
  (< (length3 (mk___rep l__split_discrs l__split_fields2)) (to_rep
                                                           (rec__p__my_maps__map__capacity
                                                           l__split_discrs)))))
(check-sat)
