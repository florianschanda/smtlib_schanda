...
(declare-fun has_more (Int) Bool)

(declare-fun has_more__function_guard (Bool Int) Bool)
...
(declare-fun user_eq3 (buffer_count_type buffer_count_type) Bool)

(declare-fun dummy3 () buffer_count_type)
...
(define-fun dynamic_invariant ((temp___expr_178 Int)
  ...
  (temp___do_toplevel_177 Bool)) Bool (=>
                                      ...
                                      (<= 0 8)) (in_range2 temp___expr_178)))

;; has_more__post_axiom
  (assert true)

;; has_more__def_axiom
  (assert
  (forall ((temperature_buffer14__count Int))
  (! (=> (has_more__function_guard (has_more temperature_buffer14__count)
     temperature_buffer14__count)
     (= (= (has_more temperature_buffer14__count) true)
     (< 0 temperature_buffer14__count))) :pattern ((has_more
                                                   temperature_buffer14__count)) )))
...
(declare-fun user_eq4 (buffer_index_type buffer_index_type) Bool)

(declare-fun dummy4 () buffer_index_type)
...
(declare-fun item__split_fields () time_type)

(declare-fun item__split_fields1 () temperature_type)
...
(declare-fun result () time_type)

(declare-fun result1 () temperature_type)

(declare-fun item__split_fields2 () time_type)

(declare-fun item__split_fields3 () temperature_type)

(declare-fun result2 () (_ BitVec 8))

(declare-fun next_out1 () (_ BitVec 8))

;; H
  (assert (in_range2 count))

;; H
  (assert (in_range3 next_out))

;; H
  (assert (has_more__function_guard (has_more count) count))

;; H
  (assert (= (has_more count) true))

;; H
  (assert (= result item__split_fields))

;; H
  (assert (= result1 item__split_fields1))
...
;; H
  (assert (= result2 next_out))

;; H
  (assert
  (= next_out1 (bvurem (bvadd next_out ((_ int2bv 8) 1)) ((_ int2bv 8) 8))))
