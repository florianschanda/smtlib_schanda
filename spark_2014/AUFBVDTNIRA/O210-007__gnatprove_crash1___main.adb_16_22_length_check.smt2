...
;; def_axiom
  ...
  (and
  (=> (dynamic_property7 0 2147483647 temp___212 temp___213)
  (and (= (first5 temp___210) temp___212) (= (last5 temp___210) temp___213)))
  (forall ((temp___214 Int))
  (= (select (to_array2 temp___210) temp___214) (of_rep temp___211)))))))
...
;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___2161)) (to_rep (last4 temp___2161)))
     (+ (- (to_rep (last4 temp___2161)) (to_rep (first4 temp___2161))) 1) 0) 
  (ite (<= 0 r6b) (+ (- r6b 0) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___2161)) (to_rep (last4 temp___2161))) 
  temp___2171))
...
;; WP_parameter_def
 ;; File "main.adb", line 1, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___2171)) (to_rep (last2 temp___2171)))
     (+ (- (to_rep (last2 temp___2171)) (to_rep (first2 temp___2171))) 1) 0) 
