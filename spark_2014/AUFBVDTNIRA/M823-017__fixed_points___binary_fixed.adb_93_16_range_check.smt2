...
;; ceil_to_int
  ...
  (forall ((m mode) (x t1))
  (=> (tqtisFinite1 x)
  (= (to_int3 m (roundToIntegral1 RTP2 x)) (- 1 (to_int (- 1.0 (tqtreal1 x))))))))
...
;; floor_to_int
  ...
  (forall ((m mode) (x t1))
  (=> (tqtisFinite1 x)
  (= (to_int3 m (roundToIntegral1 RTN2 x)) (to_int (tqtreal1 x))))))
...
;; one_of_int
  (assert (= fliteral1 (of_int2 RNA2 1)))
...
(define-fun bool_eq7 ((x1 t) (y t)) Bool (ite (eq x1 y) true false))
