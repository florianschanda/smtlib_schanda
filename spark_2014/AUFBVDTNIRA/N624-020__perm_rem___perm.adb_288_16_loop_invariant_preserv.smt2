...
;; H
  (assert
  (forall ((ia4 Int)) (remove__function_guard (remove aa ia4) aa ia4)))
...
;; H
  (assert
  (forall ((ia4 Int) (ib1 Int)) (is_perm__function_guard
  (is_perm (remove aa ia4) (remove bb ib1)) (remove aa ia4) (remove bb ib1))))
...
;; H
  (assert (forall ((ib1 Int)) (remove__function_guard (remove b ib1) b ib1)))
