...
;; H
  (assert
  (not (= (to_rep (rec__tetris_initial__piece__s (us_split_fields1 p))) 2)))

;; H
  (assert
  (not (= (to_rep (rec__tetris_initial__piece__s (us_split_fields1 p))) 1)))
...
;; WP_parameter_def
 ;; File "tetris_initial.ads", line 141, characters 0-0
  (not (<= 3 (to_rep (rec__tetris_initial__piece__s (us_split_fields1 p))))))
(check-sat)
