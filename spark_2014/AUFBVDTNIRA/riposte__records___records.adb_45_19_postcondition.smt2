...
(declare-fun records__init_e__result () Bool)

(declare-fun records__init_e__result1 () unsigned_byte)

(declare-fun records__init_e__result2 () unsigned_byte)
...
(declare-fun records__init_e__result3 () Bool)

(declare-fun records__init_e__result4 () unsigned_byte)

(declare-fun records__init_e__result5 () unsigned_byte)

(declare-fun records__init_e__result6 () optional_pair__ref)

(declare-fun records__init_e__result7 () us_rep1)

(declare-fun records__init_e__result8 () optional_pair__ref)

(declare-fun records__init_e__result9 () us_rep1)

(define-fun records__init_e__result10 () us_rep1 (mk___rep1
                                                 (mk___split_fields1
                                                 records__init_e__result3
                                                 (mk___rep
                                                 (mk___split_fields
                                                 records__init_e__result4
                                                 records__init_e__result5)))))
...
;; H
  (assert
  (= records__init_e__result6 (mk_optional_pair__ref
                              records__init_e__result10)))
...
;; H
  (assert
  (= records__init_e__result10 (mk___rep1
...
;; H
  (assert
  (= (mk___rep1
     (mk___split_fields1 result3
     (mk___rep (mk___split_fields result4 result5)))) (optional_pair__content
                                                      records__init_e__result8)))

(assert
;; WP_parameter_def
 ;; File "records_prooffuncs.ads", line 19, characters 0-0
  (not
  (= (bool_eq2 (optional_pair__content records__init_e__result8)
     null_optional_pair) true)))
(check-sat)
