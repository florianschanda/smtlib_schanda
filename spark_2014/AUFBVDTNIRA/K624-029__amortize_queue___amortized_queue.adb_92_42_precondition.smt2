...
;; H
  (assert
  (and
  (= o (copy (rec__amortized_queue__queue__rear (us_split_fields3 q)) 1000))
  (and
  (= (oeq1 (model__ o)
  ...
  (= (to_rep
     (rec__amortized_queue__my_vectors__vector__capacity
     (us_split_discrs1 o))) (length
                            (rec__amortized_queue__queue__rear
                            (us_split_fields3 q))))
  (= (to_rep
     (rec__amortized_queue__my_vectors__vector__capacity
     (us_split_discrs1 o))) 1000)))))
...
;; WP_parameter_def
 ;; File "amortized_queue.ads", line 41, characters 0-0
  (not
  (or (= 1000 0)
  (<= (length (rec__amortized_queue__queue__front (us_split_fields3 q))) 1000))))
(check-sat)
