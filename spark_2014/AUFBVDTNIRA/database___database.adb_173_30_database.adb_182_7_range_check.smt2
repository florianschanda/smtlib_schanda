...
(declare-fun dummy () ext_account_num)
...
(declare-fun dummy1 () account_num)
...
(define-fun bool_eq3 ((a (Array Int us_rep)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq2 (select a temp___idx_141)
...
(declare-fun no_account_link () us_rep)
...
(declare-fun tmp_prev () Int)

(declare-fun tmp_next () Int)

(declare-fun i () Int)

(declare-fun o () ext_account_num)

(declare-fun o1 () ext_account_num)

(declare-fun o2 () Bool)

(declare-fun o3 () ext_account_num)

(declare-fun o4 () ext_account_num)

(declare-fun database__availability__no_account_link__assume () Bool)

(declare-fun database__availability__no_account_link__assume1 () ext_account_num)

(declare-fun database__availability__no_account_link__assume2 () ext_account_num)
...
(declare-fun links1 () (Array Int us_rep))

(declare-fun tmp_prev1 () Int)

(declare-fun tmp_next1 () Int)

(declare-fun i2 () Int)

(declare-fun result2 () Int)

(declare-fun tmp_prev2 () Int)

(declare-fun result3 () Int)

(declare-fun tmp_prev3 () Int)
