...
(declare-fun float_example__bounded_add__result () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun float_example__bounded_add__result1 () t)

(declare-fun float_example__bounded_add__result2 () t)

(declare-fun float_example__bounded_add__result3 () t)

(declare-fun float_example__bounded_add__result4 () t)

(declare-fun float_example__bounded_add__result5 () t)
...
;; H
  (assert (and (= o (add RNE1 a b)) (tqtisFinite (add RNE1 a b))))
...
;; WP_parameter_def
 ;; File "float_example.adb", line 5, characters 0-0
  (not (lt float_example__bounded_add__result4 fliteral3)))
(check-sat)
