...
;; H
  ...
  (<= index2 (to_rep2
             ...
             (rec__very_longs__very_long__long_digits
             (us_split_fields1 number)))))))
  (=> (= result3 true) (and (= o5 index2) (in_range1 index2))))))
...
;; H
  ...
  (and (<= 1 digit_count3) (<= digit_count3 index3))))
  (=> (< digit_count3 index3)
  (forall ((j1 Int))
  (=> (and (<= (+ digit_count3 1) j1) (<= j1 index3))
  (= (to_rep1
     (select (elts
             (rec__very_longs__very_long__long_digits
             (us_split_fields1 number))) j1)) ((_ int2bv 8) 0)))))))))
...
;; H
  ...
  index3)) (=> (<= 0 65536) (in_range1 digit_count3)))
  (and (<= 1 index3)
  (<= index3 (to_rep2
             (last1
             (rt
