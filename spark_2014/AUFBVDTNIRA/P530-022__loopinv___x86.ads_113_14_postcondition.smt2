...
(declare-fun writereglow8post__function_guard (Bool (_ BitVec 64)
  (_ BitVec 64) (_ BitVec 8)) Bool)
...
;; writereglow8post__post_axiom
  ...
  (! (=>
     ...
     (let ((result (writereglow8post regold regnew val__1)))
     (and (readreglow8__function_guard (readreglow8 regnew) regnew)
     (=> (writereglow8post__function_guard result regold regnew val__1)
     (= (= result true)
     (and (= (readreglow8 regnew) val__1)
     (= (bvand regnew ((_ int2bv 64) 18446744073709551360)) (bvand regold ((_ int2bv 64) 18446744073709551360))))))))) :pattern (
  (writereglow8post regold regnew val__1)) ))))
...
;; writereglow8post__def_axiom
  ...
  (! (=> (writereglow8post__function_guard
     (writereglow8post regold regnew val__1) regold regnew val__1)
     (and (readreglow8__function_guard (readreglow8 regnew) regnew)
     (= (= (writereglow8post regold regnew val__1) true)
     (and (= (readreglow8 regnew) val__1)
     (= (bvand regnew ((_ int2bv 64) 18446744073709551360)) (bvand regold ((_ int2bv 64) 18446744073709551360))))))) :pattern (
  (writereglow8post regold regnew val__1)) ))))
...
(declare-fun reg1 () (_ BitVec 64))

(declare-fun reg2 () (_ BitVec 64))

(declare-fun reg3 () (_ BitVec 64))
...
;; H
  (assert
  (= reg1 (bvor (bvand reg ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) 
  val__))))
...
;; H
  (assert (writereglow8post__function_guard (writereglow8post reg reg2 val__)
  reg reg2 val__))

(assert
;; WP_parameter_def
 ;; File "x86.adb", line 63, characters 0-0
  (not (= (writereglow8post reg reg2 val__) true)))
(check-sat)
