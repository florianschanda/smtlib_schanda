...
(define-fun default_initial_assumption ((temp___expr_386 us_rep2)
...
(define-fun default_initial_assumption1 ((temp___expr_355 us_rep1)
  (temp___skip_top_level_356 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_356 true))
                                         (= (is_empty temp___expr_355) true)))
...
(define-fun dynamic_invariant3 ((temp___expr_348 Int)
...
(define-fun dynamic_invariant5 ((temp___expr_373 Int)
...
;; H
  ...
  (= o6 (length
        ...
        (mk___split_fields target__split_fields))))
  (and (in_range1 o6)
  (<= o6 (to_rep (rec__my_sets__m__set__capacity target__split_discrs))))))

;; H
  (assert
  (= o7 (- (to_rep (rec__my_sets__m__set__capacity target__split_discrs)) 
  o6)))
...
;; H
  ...
  (and (in_range1 o4)
  (<= o4 (to_rep (rec__my_sets__m__set__capacity (us_split_discrs1 source)))))))
