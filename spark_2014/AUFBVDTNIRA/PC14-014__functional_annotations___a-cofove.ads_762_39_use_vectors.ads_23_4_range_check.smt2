...
;; H
  (assert
  (=> (= result true)
  (and (= us index) (dynamic_property3 first2 last3 index))))

;; H
  (assert (=> (= result true) (= o1 index)))

;; H
  (assert
  (=> (not (= result true))
  (and (= temp___430 (last4 (model__ container)))
  (and (dynamic_property4 first3 last5 temp___430)
  (= temp___430 (last4 (model__ container)))))))

;; H
  (assert
  (=> (not (= result true))
  (and (= us1 temp___430) (dynamic_property3 first2 last3 temp___430))))

;; H
  (assert (=> (not (= result true)) (= o1 temp___430)))

(assert
;; WP_parameter_def
 ;; File "a-cofove.ads", line 714, characters 0-0
  (not (dynamic_property2 first1 last2 first)))
(check-sat)
