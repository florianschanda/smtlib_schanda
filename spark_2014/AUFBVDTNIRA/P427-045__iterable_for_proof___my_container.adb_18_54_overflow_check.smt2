...
;; H
  (assert
  (< (to_rep (rec__my_container__cursor__index (us_split_fields1 p))) 100))

(assert
;; WP_parameter_def
 ;; File "my_container.ads", line 28, characters 0-0
  (not (in_range
  (+ (to_rep (rec__my_container__cursor__index (us_split_fields1 p))) 1))))
(check-sat)
