...
(declare-fun dummy1 () acceleration_t)
...
(declare-fun dummy3 () speed_km_per_h_t)
...
(define-fun dynamic_invariant3 ((temp___expr_161 t) (temp___is_init_158 Bool)
...
(declare-fun minimum_valid_acceleration () t)
...
(declare-fun minimum_valid_speed () t)
...
;; minimum_valid_speed__def_axiom
  (assert (= minimum_valid_speed fliteral4))
...
;; minimum_valid_acceleration__def_axiom
  (assert (= minimum_valid_acceleration (neg fliteral6)))
...
;; is_valid_speed_km_per_h__def_axiom
  ...
  (! (=> (is_valid_speed_km_per_h__function_guard
     (is_valid_speed_km_per_h speed) speed)
     (= (= (is_valid_speed_km_per_h speed) true)
     (and (le fliteral7 speed) (le speed fliteral5)))) :pattern ((is_valid_speed_km_per_h
                                                                 speed)) )))
...
;; H
  ...
  (is_valid_speed_km_per_h fliteral5) fliteral5))

(assert
;; WP_parameter_def
 ;; File "deceleration_curve.ads", line 47, characters 0-0
  (not (= (is_valid_speed_km_per_h fliteral5) true)))
(check-sat)
