...
;; H
  ...
  (mk___t (elts1 init)
  (mk (to_rep1 (first3 (rt1 init))) (to_rep1 (last3 (rt1 init))))) o3 
  o6 (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last)))))
  (= (= result true)
  (and
  (and
  (and
