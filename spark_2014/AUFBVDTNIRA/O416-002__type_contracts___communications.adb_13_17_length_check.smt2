...
(define-fun bool_eq12 ((x us_t2)
  (y us_t2)) Bool (bool_eq6 (elts2 x) (to_rep1 (first4 (rt2 x)))
...
(define-fun us_split_fields_Msgs2__projection ((a1 us_split_fields4)) us_t2 
  (rec__communications__communication__msgs1 a1))

(declare-datatypes ()
((us_split_fields__ref2
 (mk___split_fields__ref2 (us_split_fields__content2 us_split_fields4)))))
(define-fun us_split_fields__ref_3__projection ((a1 us_split_fields__ref2)) us_split_fields4 
...
(define-fun us_rep_4__projection ((a1 us_rep2)) us_split_discrs (us_split_discrs2
                                                                a1))

(define-fun us_rep_5__projection ((a1 us_rep2)) us_split_fields4 (us_split_fields5
                                                                 a1))
...
(define-fun bool_eq13 ((a1 us_rep2)
...
(declare-fun coms__split_fields () (Array Int us_rep))

(declare-fun coms__split_fields1 () t2)

(declare-fun o () Int)

(declare-fun us () Int)

(declare-fun temp___313 () (Array Int us_rep))
...
;; WP_parameter_def
 ;; File "communications.ads", line 16, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first4 temp___3131)) (to_rep1 (last6 temp___3131)))
     (+ (- (to_rep1 (last6 temp___3131)) (to_rep1 (first4 temp___3131))) 1)
     0) (ite (<= (to_rep1 (first4 coms__split_fields1)) (to_rep1
                                                        (last6
                                                        coms__split_fields1)))
        (+ (- (to_rep1 (last6 coms__split_fields1)) (to_rep1
                                                    (first4
