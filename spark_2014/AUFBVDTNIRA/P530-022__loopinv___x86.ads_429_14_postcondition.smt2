...
(declare-fun x86__di__result () (_ BitVec 16))

(declare-fun result () (_ BitVec 16))

(declare-fun x86__di__result1 () (_ BitVec 16))

(declare-fun x86__di__result2 () (_ BitVec 16))

(declare-fun x86__di__result3 () (_ BitVec 16))

(declare-fun x86__di__result4 () (_ BitVec 16))

(declare-fun x86__di__result5 () (_ BitVec 16))
...
;; H
  (assert (= result x86__di__result))

;; H
  (assert
  (= x86__di__result1 ((_ extract 15 0) (bvand rdi ((_ int2bv 64) 65535)))))
...
;; H
  (assert (readreg16__function_guard (readreg16 rdi) rdi))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 9, characters 0-0
  (not (= x86__di__result4 (readreg16 rdi))))
(check-sat)
