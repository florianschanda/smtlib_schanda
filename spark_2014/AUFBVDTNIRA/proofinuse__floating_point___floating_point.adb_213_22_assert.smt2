...
;; H
  (assert (and (le fliteral2 x) (le x fliteral)))
...
;; H
  ...
  (and (tqtisFinite o)
  (and (le fliteral2 o)
  (and (=> (eq x fliteral2) (eq o fliteral2))
  (and (=> (eq x fliteral) (eq o fliteral))
  (=> (le fliteral3 x) (lt fliteral2 o))))))))

;; H
  (assert (= o1 (ite (le o fliteral) true false)))
...
(assert
;; WP_parameter_def
 ;; File "floating_point.adb", line 197, characters 0-0
  (not (= res1 true)))
(check-sat)
