...
;; def_axiom
  ...
  (and (= (first4 temp___151) temp___153) (= (last4 temp___151) temp___154)))
...
;; H
  (assert
  (= (to_rep1
     (first3 (rt1 (temp___150 120 (to_rep1 x__first) (to_rep1 x__last))))) 
  (to_rep1 x__first)))

;; H
  (assert
  (= (to_rep1
     (last3 (rt1 (temp___150 120 (to_rep1 x__first) (to_rep1 x__last))))) 
  (to_rep1 x__last)))
...
;; H
  (assert
  (= (mk (to_rep1 (first3 temp___1571)) (to_rep1 (last3 temp___1571))) 
  temp___1581))
