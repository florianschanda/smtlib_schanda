...
(declare-fun instr__display_value__4__s1__assume () (Array Int character))

(declare-fun instr__display_value__4__s1__assume1 () t1)
...
;; H
  (assert (= temp___349 instr__display_value__4__s1__assume))
...
;; H
  (assert
  (= (mk___t1 instr__display_value__4__s1__assume
     instr__display_value__4__s1__assume1) s1))
