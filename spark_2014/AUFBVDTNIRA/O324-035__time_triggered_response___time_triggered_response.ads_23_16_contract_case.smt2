...
(declare-fun idle_history () (Array Int Bool))

(declare-fun status () Bool)

(declare-fun time_idle () Int)

(declare-fun result () Bool)

(declare-fun status1 () Bool)

(declare-fun result1 () Bool)

(declare-fun status2 () Bool)

(declare-fun status3 () Bool)

(declare-fun status4 () Bool)
...
;; H
  (assert (=> (<= 10 time_idle) (= status1 (of_int 1))))

;; H
  (assert (=> (not (<= 10 time_idle)) (= result1 status)))

;; H
  (assert (=> (not (<= 10 time_idle)) (= status2 (of_int 0))))
...
(assert
;; WP_parameter_def
 ;; File "time_triggered_response.adb", line 9, characters 0-0
  (not (not (= status3 true))))
(check-sat)
