...
;; H
  ...
  (= (key (mk___rep m__split_discrs m__split_fields2)
     (find1 (mk___rep m__split_discrs m__split_fields2) 1)) 1))
  ...
  (= (keys_included_except1
     ...
     (positions
     (mk___rep m__split_discrs (mk___split_fields m__split_fields)))
     (find1 (mk___rep m__split_discrs m__split_fields2) 1)) true)))
