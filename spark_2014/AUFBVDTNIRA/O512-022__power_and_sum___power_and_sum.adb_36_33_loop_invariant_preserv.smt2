...
(define-fun innersum12 () int__ref (mk_int__ref innersum8))
...
;; H
  (assert (=> (<= j3 i2) (= innersum12 (mk_int__ref innersum6))))

;; H
  (assert (=> (<= j3 i2) (= j12 (mk_int__ref j6))))
...
;; H
  (assert (= innersum10 innersum12))

;; H
  (assert (= totalsum4 (mk_int__ref totalsum3)))
...
;; H
  (assert (= innersum11 innersum9))

;; H
  (assert (= totalsum5 totalsum3))
...
;; WP_parameter_def
 ;; File "power_and_sum.ads", line 5, characters 0-0
  (not
  (= (* 6 (int__content totalsum4)) (* (* (- (int__content i4) 1) (int__content
                                                                  i4)) (+ 
  (int__content i4) 1)))))
(check-sat)
