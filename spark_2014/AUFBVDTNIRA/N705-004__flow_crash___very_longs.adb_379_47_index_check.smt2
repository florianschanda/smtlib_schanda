...
(declare-fun temp___1230 () (Array Int octet))

(declare-fun temp___12301 () t1)

(declare-fun temp___1232 () (Array Int octet))
...
(declare-fun temp___1248 () (_ BitVec 8))

(declare-fun temp___1245 () digit_index_type)

(declare-fun temp___12451 () (Array Int octet))

(declare-fun temp___12452 () t)

(declare-fun temp___1244 () (_ BitVec 8))
...
;; H
  (assert (= temp___1229 temp___1230))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___12291)) (to_rep2 (last7 temp___12291))) 
  temp___12301))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___12301)) (to_rep2 (last4 temp___12301)))
     (+ (- (to_rep2 (last4 temp___12301)) (to_rep2 (first2 temp___12301))) 1)
...
;; H
  (assert
  (= (mk___t1 temp___1232 temp___12321) (mk___t1 temp___1230 temp___12301)))

;; H
  (assert (= temp___1232 o))

;; H
  (assert
  (= (mk (to_rep2 (first2 temp___12321)) (to_rep2 (last4 temp___12321))) 
  o1))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___1234)))

;; H
  (assert (= temp___12341 o2))

;; H
  (assert (= temp___12342 o3))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (and (= result____split_discrs (mk___split_discrs temp___1245))
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___12451 temp___12452))))))
...
;; H
  ...
  (= (rec__very_longs__very_long__octet_length result____split_discrs) 
  temp___1245)
  (forall ((temp___1247 Int))
  (=>
  (and
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1247)
  (<= temp___1247 (to_rep2
                  (last1
                  (rt
                  (rec__very_longs__very_long__long_digits
  ...
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             result____split_fields3)) temp___1247) (select temp___12451 temp___1247)))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last1
         (rt
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= temp___1239 (mk___rep result____split_discrs o18))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= result____split_fields4 (us_split_fields1 temp___1239))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= result____split_discrs (us_split_discrs1 temp___1239))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= temp___1243 (mk___rep result____split_discrs o27))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= result____split_fields5 (us_split_fields1 temp___1243))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= result____split_discrs (us_split_discrs1 temp___1243))))
