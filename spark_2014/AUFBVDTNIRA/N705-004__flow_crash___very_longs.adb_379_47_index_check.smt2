...
(declare-fun temp___1243 () (_ BitVec 8))

(declare-fun temp___1240 () digit_index_type)

(declare-fun temp___12401 () (Array Int octet))

(declare-fun temp___12402 () t)

(declare-fun temp___1239 () (_ BitVec 8))
...
(declare-fun temp___1238 () us_rep)
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (and (= result____split_discrs (mk___split_discrs temp___1240))
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___12401 temp___12402))))))
...
;; H
  ...
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             result____split_fields3)) temp___1242) (select temp___12401 temp___1242)))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= temp___1234 (mk___rep result____split_discrs o18))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= result____split_fields4 (us_split_fields1 temp___1234))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= result____split_discrs (us_split_discrs1 temp___1234))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= temp___1238 (mk___rep result____split_discrs o27))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= result____split_fields5 (us_split_fields1 temp___1238))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= result____split_discrs (us_split_discrs1 temp___1238))))
