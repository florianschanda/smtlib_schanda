...
(define-fun bool_eq3 ((a (Array Int group1_id)) (a__first Int) (a__last Int)
...
(define-fun bool_eq4 ((a (Array Int group2_id)) (a__first Int) (a__last Int)
...
(define-fun bool_eq5 ((a (Array Int (Array Int group2_id))) (a__first Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq4 (select a temp___idx_134) 1 64
...
(define-fun bool_eq6 ((a (Array Int (Array Int group1_id))) (a__first Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq3 (select a temp___idx_135) 1 64
...
(define-fun bool_eq7 ((a (Array Int ranking)) (a__first Int) (a__last Int)
...
(define-fun bool_eq9 ((a (Array Int (Array Int ranking))) (a__first Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq7 (select a temp___idx_138) 1 64
...
(define-fun bool_eq12 ((a (Array Int count)) (a__first Int) (a__last Int)
...
(define-fun dynamic_invariant4 ((temp___expr_335 Int)
...
(declare-fun temp___658 () (Array Int group1_id))

(declare-fun temp___6581 () count)
...
(declare-fun temp___676 () (Array Int group1_id))

(declare-fun temp___6761 () count)
...
(declare-fun temp___680 () (Array Int group1_id))

(declare-fun temp___6801 () count)
...
(declare-fun proposals_made2 () map__ref7)

(declare-fun unmatched_g1_set__split_fields7 () us_split_fields__ref)

(declare-fun unmatched_g2_set3 () map__ref5)

(declare-fun result__3 () map__ref)

(declare-fun g12 () int__ref)

(declare-fun g22 () int__ref)

(declare-fun accepted4 () bool__ref)

(declare-fun rank3 () int__ref)

(declare-fun already_asked2 () int__ref)

(declare-fun proposals_made3 () (Array Int count))

(declare-fun unmatched_g1_set__split_fields8 () us_split_fields)

(declare-fun unmatched_g2_set4 () (Array Int Bool))

(declare-fun result__4 () (Array Int group1_id))

(declare-fun g13 () Int)

(declare-fun g23 () Int)

(declare-fun accepted5 () Bool)

(declare-fun rank4 () Int)

(declare-fun already_asked3 () Int)
...
;; H
  ...
  (is_permutation_1 (select ranking_2 g24)) (select ranking_2 g24))))

;; H
  (assert (invert__function_guard (invert ranking_2) ranking_2))

;; H
  (assert (invariant_holds__function_guard
  (invariant_holds
  (mk___split_fields unmatched_g1_set__split_fields
  unmatched_g1_set__split_fields1) proposals_made result__ unmatched_g2_set)
  (mk___split_fields unmatched_g1_set__split_fields
  unmatched_g1_set__split_fields1) proposals_made result__ unmatched_g2_set))

;; H
  (assert (is_preferred_1__function_guard
  (is_preferred_1 g11
  (to_rep
  (select result__ (to_rep1 (select (select ranking_1 g11) (- rank2 1)))))
  (select ranking_2 (to_rep1 (select (select ranking_1 g11) (- rank2 1)))))
  g11
  (to_rep
  (select result__ (to_rep1 (select (select ranking_1 g11) (- rank2 1)))))
  (select ranking_2 (to_rep1 (select (select ranking_1 g11) (- rank2 1))))))
...
;; H
  (assert (is_preferred_1__function_guard
  (is_preferred_1 g11 (to_rep (select result__ g21)) (select ranking_2 g21))
  g11 (to_rep (select result__ g21)) (select ranking_2 g21)))
...
;; H
  (assert
  (forall ((g1_id Int) (rank5 Int)) (is_preferred_1__function_guard
  (is_preferred_1 g1_id
  (to_rep
  (select result__2 (to_rep1 (select (select ranking_1 g1_id) rank5))))
  (select ranking_2 (to_rep1 (select (select ranking_1 g1_id) rank5)))) g1_id
  (to_rep
  (select result__2 (to_rep1 (select (select ranking_1 g1_id) rank5))))
  (select ranking_2 (to_rep1 (select (select ranking_1 g1_id) rank5))))))
...
;; H
  ...
  (forall ((g24 Int))
  (=> (and (<= 1 g24) (<= g24 64))
  (= (is_permutation_1 (select ranking_2 g24)) true)))
  (and (= (bool_eq9 (invert ranking_2) 1 64 ranking_2_inverted 1 64) true)
  (and
  (= (invariant_holds
     (mk___split_fields unmatched_g1_set__split_fields
...
;; H
  (assert (= temp___658 o5))

;; H
  (assert (= temp___6581 o6))
...
;; H
  (assert
  (= unmatched_g1_set__split_fields2 (mk___split_fields temp___658
                                     temp___6581)))
...
;; H
  ...
  (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2
                                                            ...
                                                            g21) (to_rep
                                                                 ...
                                                                 result__ 
                                                                 g21)))))
  (= unmatched_g1_set__split_fields3 (mk___split_fields temp___676
                                     temp___6761)))))
...
;; H
  ...
  (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2
                                                            ...
                                                            g21) (to_rep
                                                                 ...
                                                                 result__ 
                                                                 g21)))))
  (= unmatched_g1_set__split_fields4 (mk___split_fields temp___680
                                     temp___6801)))))
...
;; H
  ...
  (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2
                                                            ...
                                                            g21) (to_rep
                                                                 ...
                                                                 result__ 
                                                                 g21))))))
  (= temp___668 (mk___rep (mk___split_fields o24 o25))))))
...
;; H
  ...
  (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2
                                                            ...
                                                            g21) (to_rep
                                                                 ...
                                                                 result__ 
                                                                 g21))))))
  (= unmatched_g1_set__split_fields5 (us_split_fields1 temp___668)))))
...
;; H
  ...
  (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2
                                                            ...
                                                            g21) (to_rep
                                                                 ...
                                                                 result__ 
                                                                 g21))))))
  (= unmatched_g1_set__split_fields6 (us_split_fields1 temp___672)))))
...
;; H
  ...
  (= (to_rep
     (select (rec__stable_marriage__matching__group1_set__elements
             unmatched_g1_set__split_fields4) idx)) (to_rep
...
;; H
  ...
  (=> (and (<= 1 g1_id) (<= g1_id 64))
  (forall ((rank5 Int))
  (=> (and (<= 1 rank5) (<= rank5 (to_rep3 (select proposals_made1 g1_id))))
  (and
  (not
  ...
  (not
  (= (to_rep
     (select result__2 (to_rep1 (select (select ranking_1 g1_id) rank5)))) g1_id))
  (not
  (= (is_preferred_1 g1_id
     (to_rep
     (select result__2 (to_rep1 (select (select ranking_1 g1_id) rank5))))
     (select ranking_2 (to_rep1 (select (select ranking_1 g1_id) rank5)))) true)))))))))

;; H
  (assert
  (forall ((g1_id Int))
  (=> (and (<= 1 g1_id) (<= g1_id 64))
  (=> (= (to_rep3 (select proposals_made1 g1_id)) 0)
  (exists ((idx Int))
  (and
  (and (<= 1 idx)
  (<= idx (to_rep3
  ...
  (= (to_rep
     (select (rec__stable_marriage__matching__group1_set__elements
             unmatched_g1_set__split_fields4) idx)) g1_id)))))))
...
;; H
  ...
  (= (to_rep
     (select (rec__stable_marriage__matching__group1_set__elements
             unmatched_g1_set__split_fields4) idx)) g1_id))))
  (and (< 0 (to_rep3 (select proposals_made1 g1_id)))
  (= (to_rep
     (select result__2 (to_rep1
                       (select (select ranking_1 g1_id) (to_rep3
                                                        (select proposals_made1 g1_id)))))) g1_id))))))
...
;; H
  (assert
  (= unmatched_g1_set__split_fields7 (mk___split_fields__ref
                                     unmatched_g1_set__split_fields4)))
...
;; H
  (assert
  (= unmatched_g1_set__split_fields8 unmatched_g1_set__split_fields4))
...
;; H
  (assert (invariant_holds__function_guard
  (invariant_holds (us_split_fields__content unmatched_g1_set__split_fields7)
  (map__content7 proposals_made2) (map__content result__3)
  (map__content5 unmatched_g2_set3))
  (us_split_fields__content unmatched_g1_set__split_fields7)
  (map__content7 proposals_made2) (map__content result__3)
  (map__content5 unmatched_g2_set3)))
...
;; WP_parameter_def
 ;; File "stable_marriage.adb", line 194, characters 0-0
  ...
  (= (invariant_holds
     (us_split_fields__content unmatched_g1_set__split_fields7)
     (map__content7 proposals_made2) (map__content result__3)
     (map__content5 unmatched_g2_set3)) true)))
(check-sat)
