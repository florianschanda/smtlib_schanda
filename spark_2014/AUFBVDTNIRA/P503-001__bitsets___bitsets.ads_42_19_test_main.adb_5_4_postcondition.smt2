...
;; H
  (assert (add__function_guard (add s e) s e))

;; H
  (assert (add__function_guard (add s e) s e))

;; H
  (assert (ext_equal__function_guard (ext_equal s2 (add s e)) s2 (add s e)))

(assert
;; WP_parameter_def
 ;; File "bitsets.ads", line 36, characters 0-0
  (not (= (ext_equal s2 (add s e)) true)))
(check-sat)
