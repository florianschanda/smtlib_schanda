...
(declare-fun temp___428 () (Array Int signal))

(declare-fun temp___427 () Int)

(declare-fun temp___426 () (Array Int signal))

(declare-fun temp___429 () (Array Int signal))

(declare-fun temp___424 () Int)
...
(define-fun o17 () us_rep1 (mk___rep1 (mk___split_fields1 o14 o15 o16)))

(define-fun o18 () us_rep1 (mk___rep1 (mk___split_fields1 o8 o9 o10)))
...
;; H
  (assert (=> (and (<= 1 id2) (<= id2 3)) (= temp___428 track_signals1)))

;; H
  (assert (=> (and (<= 1 id2) (<= id2 3)) (= temp___427 prev)))

;; H
  (assert (=> (and (<= 1 id2) (<= id2 3)) (= temp___426 track_signals1)))

;; H
  (assert (=> (and (<= 1 id2) (<= id2 3)) (= temp___429 track_signals1)))

;; H
  (assert (=> (and (<= 1 id2) (<= id2 3)) (= temp___424 id2)))
...
;; H
  ...
  (get_previous_track__function_guard o2 cur_position id2))
  (and (in_range1 o2)
  (= o2 (to_rep3
...
;; H
  ...
  (=> (and (<= 1 j) (<= j 8))
  (and
  (=> (= (to_rep5 (select temp___428 j)) 2)
  (= (to_rep5 (select track_signals3 j)) 2))
  (=>
  (and (= (to_rep5 (select temp___429 j)) 1)
  (exists ((t Int))
  (and (and (<= 1 t) (<= t cur_num_trains))
...
;; H
  (assert (= o18 (select trains1 o7)))

;; H
  (assert
  (and
  (and (= o11 (get_previous_track o18 id1))
  (get_previous_track__function_guard o11 o18 id1))
  (and (in_range1 o11)
  (= o11 (to_rep3
         (select (select previous_tracks (to_rep1
                                         (rec__trains__track__from
                                         (us_split_fields1
                                         (select tracks (to_rep o10)))))) 
         id1))))))
...
;; H
  (assert (= o17 (select trains1 o13)))

;; H
  (assert
  (and
  (and (= temp___437 (get_previous_track o17 id1))
  (get_previous_track__function_guard temp___437 o17 id1))
  (and (in_range1 temp___437)
  (= temp___437 (to_rep3
                (select (select previous_tracks (to_rep1
                                                (rec__trains__track__from
                                                (us_split_fields1
                                                (select tracks (to_rep o16)))))) 
                id1))))))
