...
;; H
  (assert
  (=> (le (sub RNE2 fliteral1 x) r1)
  (and (= o (sub RNE2 fliteral1 x)) (tqtisFinite (sub RNE2 fliteral1 x)))))

;; H
  (assert (=> (le (sub RNE2 fliteral1 x) r1) (= r1 result1)))

;; H
  (assert (=> (le (sub RNE2 fliteral1 x) r1) (= r2 o)))

;; H
  (assert (=> (not (le (sub RNE2 fliteral1 x) r1)) (= r2 r1)))

;; H
  (assert (le (sub RNE2 x (neg fliteral1)) r2))

(assert
;; WP_parameter_def
 ;; File "shapes5.ads", line 27, characters 0-0
  (not (in_range4 (sub RNE2 x (neg fliteral1)))))
(check-sat)
