...
(declare-fun keyeddatapresence () Int)
...
(declare-fun keyeddatapresence1 () Int)

(declare-fun keyeddata__split_fields () datalengtht)

(declare-fun keyeddata__split_fields1 () (Array Int character))
...
;; H
  ...
  (str_comp (mk___rep keyeddata__split_fields2) op)
  (mk___rep keyeddata__split_fields2) op)))
...
;; H
  (assert (rolepresent__function_guard
  (rolepresent (mk___rep1 theadmin__split_fields4))
  (mk___rep1 theadmin__split_fields4)))
...
;; H
  (assert (ispresent__function_guard
  (ispresent (mk___rep1 theadmin__split_fields4))
  (mk___rep1 theadmin__split_fields4)))

;; H
  (assert (isdoingop__function_guard
  (isdoingop (mk___rep1 theadmin__split_fields4))
  (mk___rep1 theadmin__split_fields4)))

;; H
  (assert (thecurrentop__function_guard
  (thecurrentop (mk___rep1 theadmin__split_fields4))
  (mk___rep1 theadmin__split_fields4)))
...
;; H
  (assert
  (and (= o2 (extractuser state)) (extractuser__function_guard o2 state)))
