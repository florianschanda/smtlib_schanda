...
(declare-fun x__split_fields () small)

(declare-fun x__split_fields1 () very_small)

(declare-fun temp___204 () Int)

(declare-fun o () Int)

(declare-fun o1 () small)

(declare-fun o2 () small)

(declare-fun o3 () very_small)

(declare-fun temp___207 () small)

(declare-fun temp___2071 () very_small)

(declare-fun temp___208 () Int)

(declare-fun result () small)

(declare-fun result1 () very_small)

(declare-fun x__split_fields2 () small)

(declare-fun x__split_fields3 () very_small)
...
;; H
  (assert (and (= temp___208 y) (in_range2 y)))

(assert
;; WP_parameter_def
 ;; File "dynamic_preds_rte.ads", line 17, characters 0-0
  (not (< (* temp___208 temp___208) 100000)))
(check-sat)
