...
;; H
  ...
  (has_element (mk___rep c1__split_fields2) temp___2821)
  (mk___rep c1__split_fields2) temp___2821))

;; H
  (assert (element__function_guard
  (element (mk___rep c1__split_fields2) temp___2821)
  (mk___rep c1__split_fields2) temp___2821))

;; H
  (assert
  (and (= (has_element (mk___rep c1__split_fields2) temp___2821) true)
  (= e3 (element (mk___rep c1__split_fields2) temp___2821))))
