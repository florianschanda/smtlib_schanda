...
(declare-fun temp___229 ((Array Int integer) Int Int Int Int Int
  Int) (Array Int integer))

;; def_axiom
  (assert
  (forall ((temp___231 (Array Int integer)))
  (forall ((temp___232 Int) (temp___233 Int) (temp___234 Int)
  (temp___235 Int) (temp___236 Int) (temp___237 Int))
  (let ((temp___230 (temp___229 temp___231 temp___232 temp___233 temp___234
                    temp___235 temp___236 temp___237)))
  (forall ((temp___238 Int))
  (ite (= temp___238 temp___236)
  (= (select temp___230 temp___238) (of_rep temp___237))
  (ite (= temp___238 temp___234)
  (= (select temp___230 temp___238) (of_rep temp___235))
  (ite (= temp___238 temp___232)
  (= (select temp___230 temp___238) (of_rep temp___233))
  (= (select temp___230 temp___238) (select temp___231 temp___238))))))))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (bool_eq1 a4 (- 2147483648) 2147483647 (temp___229 a i 1 j 2 k 3)
