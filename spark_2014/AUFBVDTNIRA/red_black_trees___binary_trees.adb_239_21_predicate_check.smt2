...
;; H
  (assert (= o51 (us_split_fields3 o50)))

;; H
  (assert (= o52 (rec__binary_trees__cell__parent o51)))

;; H
  (assert (= temp___887 (to_rep o52)))

;; H
  (assert (and (<= 1 temp___887) (<= temp___887 100)))

;; H
  (assert (= o53 temp___887))

;; H
  (assert (= o54 (select r5 o53)))
...
;; H
  (assert (= temp___889 (mk___rep o58)))
