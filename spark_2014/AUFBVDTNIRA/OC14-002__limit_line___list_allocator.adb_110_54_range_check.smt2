...
;; H
  ...
  (and
  (and
  (= o53 (get (rec__list_allocator__m__t__available model____split_fields3)
         j))
  (get__function_guard o53
  (rec__list_allocator__m__t__available model____split_fields3) j))
  (in_range7 o53)))

;; H
  (assert (= result12 (ite (in_range4 o53) true false)))
...
;; H
  (assert (=> (= result12 true) (= result13 (ite (< j o49) true false))))

;; H
  (assert
  (=> (= result12 true)
  (=> (= result13 true) (and (= o50 (+ j 1)) (in_range1 (+ j 1))))))
...
;; H
  ...
  (= o51 (get (rec__list_allocator__m__t__available model____split_fields3)
         o50))
  (get__function_guard o51
  (rec__list_allocator__m__t__available model____split_fields3) o50))
  (in_range7 o51)))))

;; H
  (assert (=> (= result12 true) (=> (not (= result13 true)) (= o51 0))))
...
;; H
  ...
  (= temp___619 (get
                (rec__list_allocator__m__t__available model____split_fields3)
                j))
  (get__function_guard temp___619
  (rec__list_allocator__m__t__available model____split_fields3) j))
  (in_range7 temp___619))))

;; H
  (assert (=> (= result12 true) (and (<= 1 temp___619) (<= temp___619 3))))

;; H
  (assert (=> (= result12 true) (= o45 temp___619)))

;; H
  (assert (=> (= result12 true) (= o46 (select data3 o45))))

;; H
  (assert (=> (= result12 true) (= o47 (us_split_fields1 o46))))

;; H
  (assert
  (=> (= result12 true) (= o48 (rec__list_allocator__cell__next o47))))

;; H
  (assert (=> (= result12 true) (= o52 (to_rep o48))))

;; H
  (assert (=> (= result12 true) (= result11 (ite (= o52 o51) true false))))
