...
;; H
  (assert
  (= (slide (concat1 temp___201 6 10 temp___202 1 5) 6 1) temp___203))
...
;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___2031)) (to_rep (last2 temp___2031)))
     (+ (- (to_rep (last2 temp___2031)) (to_rep (first2 temp___2031))) 1) 0) 
  (ite (<= 1 10) (+ (- 10 1) 1) 0)))
...
;; H
  (assert (= (to_rep (select d3 1)) (to_rep (select y 6))))

;; H
  (assert (= (to_rep (select d3 6)) (to_rep (select y 1))))

(assert
;; WP_parameter_def
 ;; File "concat.ads", line 8, characters 0-0
  (not (<= (to_rep (first (mk 1 10))) (to_rep (last (mk 1 10))))))
(check-sat)
