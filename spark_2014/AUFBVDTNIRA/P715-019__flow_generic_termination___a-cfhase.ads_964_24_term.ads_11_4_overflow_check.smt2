...
(declare-fun term__tset__set__capacity__first__bit () Int)

(declare-fun term__tset__set__capacity__last__bit () Int)

(declare-fun term__tset__set__capacity__position () Int)
...
(declare-fun term__tset__set__modulus__first__bit () Int)

(declare-fun term__tset__set__modulus__last__bit () Int)

(declare-fun term__tset__set__modulus__position () Int)
...
;; H
  ...
  (= o6 (length
        ...
        (mk___split_fields target__split_fields))))
  (and (in_range1 o6)
  (<= o6 (to_rep (rec__term__tset__set__capacity target__split_discrs))))))

;; H
  (assert
  (= o7 (- (to_rep (rec__term__tset__set__capacity target__split_discrs)) 
  o6)))
...
;; H
  ...
  (and (in_range1 o4)
  (<= o4 (to_rep (rec__term__tset__set__capacity (us_split_discrs1 source)))))))
