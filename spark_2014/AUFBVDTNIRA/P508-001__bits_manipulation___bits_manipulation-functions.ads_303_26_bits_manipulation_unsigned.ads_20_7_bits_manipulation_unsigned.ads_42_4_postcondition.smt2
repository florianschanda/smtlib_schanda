...
;; make_mask__def_axiom
  ...
  (! (=>
     ...
     (shift_right ((_ int2bv 8) 255) (- 8 num_bits)) ((_ int2bv 8) 255)
     (- 8 num_bits))
...
;; lemma2__def_axiom
  ...
  (! (=> (lemma2__function_guard (lemma2 us_void_param) us_void_param)
     ...
     (= (make_mask size) (bvsub (ite (< size 256)
                                (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) size))
                                ((_ int2bv 8) 0)) ((_ int2bv 8) 1)))))))) :pattern (
...
(declare-fun user_eq2 (t497s t497s) Bool)

(declare-fun dummy2 () t497s)

(declare-datatypes () ((t497s__ref (mk_t497s__ref (t497s__content t497s)))))
(define-fun t497s__ref___projection ((a t497s__ref)) t497s (t497s__content a))
...
;; lemma8__def_axiom
  ...
  (! (=> (lemma8__function_guard1 (lemma81 us_void_param) us_void_param)
     ...
     (shift_right val__ (- 8 n)) val__ (- 8 n)))
...
(declare-fun bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result () Bool)
...
(declare-fun bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result1 () Bool)

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result2 () Bool)

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result3 () Bool)

(declare-fun i7 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result4 () Bool)

(declare-fun i8 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result5 () Bool)
...
;; H
  (assert (= (make_mask 1) ((_ int2bv 8) 1)))
...
;; H
  (assert (=> (and (<= 2 i1) (<= i1 7)) (= temp___1032 i1)))

;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 7))
  (= (make_mask i1) (bvsub (ite (< i1 256)
                           (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) i1))
                           ((_ int2bv 8) 0)) ((_ int2bv 8) 1)))))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (- i2 1)))
  (= (make_mask j) (bvsub (ite (< j 256)
                          (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) j))
                          ((_ int2bv 8) 0)) ((_ int2bv 8) 1)))))))

;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 7))
  (and (=> (<= 2 7) (in_range2 i2)) (and (<= 2 i2) (<= i2 7)))))

;; H
  (assert (=> (and (<= 2 i1) (<= i1 7)) (= i2 7)))

;; H
  (assert (=> (and (<= 2 i1) (<= i1 7)) (= i2 i3)))

;; H
  (assert (=> (and (<= 2 i1) (<= i1 7)) (= i4 i2)))

;; H
  (assert (=> (and (<= 2 i1) (<= i1 7)) (= i9 (mk_int__ref i3))))

;; H
  (assert (=> (and (<= 2 i1) (<= i1 7)) (= i6 i4)))

;; H
  (assert (=> (not (and (<= 2 i1) (<= i1 7))) (= i1 i5)))

;; H
  (assert (=> (not (and (<= 2 i1) (<= i1 7))) (= i6 i1)))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result1 
  bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result2))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result3 
  bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result1))
...
;; H
  (assert
  (= result1 bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result))
...
;; H
  (assert
  (= (mk_bool__ref
     bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result4) 
  (mk_bool__ref
  bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result2)))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result5 
  bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result3))
...
;; H
  (assert
  (= result2 bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result4))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result4 true))
