...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 6.0)))

(declare-fun fliteral4 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral4) (= (tqtreal fliteral4) 120.0)))

(declare-fun fliteral5 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral5) (= (tqtreal fliteral5) 5040.0)))
...
;; approx_sin__def_axiom
  ...
  (! (=> (dynamic_invariant x true true true)
     (= (approx_sin x) (sub RNE1
                       (add RNE1 (sub RNE1 x (div1 RNE1 (pow3 x) fliteral3))
                       (div1 RNE1 (pow5 x) fliteral4))
                       (div1 RNE1 (pow7 x) fliteral5)))) :pattern ((approx_sin
                                                                   x)) )))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral6) (/ 3000000106112565845251083374023437500.0 1000000000000000000000000000000000000000000.0))))

(declare-fun trigo__sin__result () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun trigo__sin__result1 () t)

(declare-fun trigo__sin__result2 () t)

(declare-fun trigo__sin__result3 () t)

(declare-fun trigo__sin__result4 () t)

(declare-fun trigo__sin__result5 () t)
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (lt (abs1 (sub RNE1 trigo__sin__result4 (approx_sin x))) fliteral6)))
(check-sat)
