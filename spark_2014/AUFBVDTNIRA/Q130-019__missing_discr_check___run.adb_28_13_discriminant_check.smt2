...
(declare-fun y1__split_fields () integer)

(declare-fun y1__split_fields1 () integer)
...
(declare-fun temp___228 () us_rep)

(declare-fun usq_2 () us_rep)

(declare-fun temp___231 () us_rep)
...
(declare-fun y1__split_fields2 () us_split_fields)

(declare-fun result4 () us_split_discrs__ref)

(declare-fun y1__split_discrs1 () us_split_discrs)

(declare-fun result5 () us_split_fields__ref)

(declare-fun y1__split_fields3 () us_split_fields)

(declare-fun result6 () us_split_discrs__ref)

(declare-fun y1__split_discrs2 () us_split_discrs)

(define-fun temp___2384 () us_rep (mk___rep (mk___split_discrs temp___238)
                                  (mk___split_fields temp___2381 temp___2382)
                                  temp___2383))

(define-fun o16 () us_rep (mk___rep (mk___split_discrs o9)
...
;; H
  (assert
  (= o16 (mk___rep (mk___split_discrs o5) (mk___split_fields o6 o7) o8)))
...
;; H
  (assert
  (and (= temp___226 (init Tuple0)) (init__function_guard temp___226 Tuple0)))
...
;; H
  (assert
  (= temp___231 (mk___rep (us_split_discrs1 usq_2) (us_split_fields1 usq_2)
                y1__attr__constrained)))
...
;; H
  (assert (and (= o15 (init Tuple0)) (init__function_guard o15 Tuple0)))

(assert
;; WP_parameter_def
 ;; File "run.adb", line 15, characters 0-0
  (not (= 0 (to_rep2 (rec__p_init__t__e (us_split_discrs1 o15))))))
(check-sat)
