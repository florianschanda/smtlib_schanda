...
;; H
  ...
  (= (element (mk___rep s__split_discrs s__split_fields4)
     (find1 (mk___rep s__split_discrs s__split_fields4) 1)) 1))
  (ite (= (contains
          (model__
  ...
  (= (equal_except
     ...
     (find1 (mk___rep s__split_discrs s__split_fields4) 1))) true))
  (and
  (and
  (and
  (and
...
;; H
  ...
  (= (element (mk___rep s__split_discrs s__split_fields3)
     (find1 (mk___rep s__split_discrs s__split_fields3) 2)) 2))
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields4)) 2) true)
  (and
  (and
  (= (oeq3 (model__ (mk___rep s__split_discrs s__split_fields3))
     (model__ (mk___rep s__split_discrs s__split_fields4))) true)
  ...
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields4))
     ...
     (find1 (mk___rep s__split_discrs s__split_fields3) 2))) true))
  (and
  (and
  (and
  (and
...
;; WP_parameter_def
 ;; File "use_sets.ads", line 60, characters 0-0
  (not
  (or
  (< (length (mk___rep s__split_discrs s__split_fields3)) (to_rep1
                                                          (rec__use_sets__my_sets__set__capacity
                                                          s__split_discrs)))
