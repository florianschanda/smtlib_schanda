...
;; H
  (assert (= result2 (ite (not (= o16 true)) true false)))
...
;; H
  (assert (=> (= result2 true) (= o20 (select b o19))))

;; H
  (assert (=> (= result2 true) (= o21 (to_rep o20))))
...
;; H
  (assert (=> (= result2 true) (= o17 j)))

;; H
  (assert (=> (= result2 true) (= o18 (select b2 o17))))

;; H
  (assert (=> (= result2 true) (= o22 (to_rep o18))))

;; H
  (assert (=> (= result2 true) (= o23 (ite (= o22 o21) true false))))

;; H
  (assert (=> (not (= result2 true)) (= o23 (of_int 1))))
