...
(declare-fun temp___882 () count_type)

(declare-fun temp___881 () count_type)

(declare-fun temp___8811 () hash_type)

(declare-fun temp___8812 () us_main_type)

(declare-fun o () Int)

(declare-fun o1 () Int)

(declare-fun temp___880 () count_type)
...
(define-fun temp___8801 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___880)))
...
;; H
  (assert
  (and (= (length (mk___rep r__split_discrs r__split_fields12)) 0)
  (= (is_empty1 (model__ (mk___rep r__split_discrs r__split_fields12))) true)))
...
;; H
  (assert (=> (= result1 true) (= temp___882 cu__split_fields1)))

;; H
  (assert
  (=> (= result1 true)
  (and (= r__split_discrs (mk___split_discrs temp___881 temp___8811))
  (= temp___8812 r__split_fields1))))

;; H
  (assert
  (=> (= result1 true)
  (<= (length (mk___rep r__split_discrs r__split_fields11)) (- (get1
                                                               (positions s)
                                                               (mk___rep1
...
;; H
  ...
  (= (contains (model__ (mk___rep r__split_discrs r__split_fields11))
     (f (get (elements s) i))) true)))))

;; H
  (assert
  (=> (= result1 true)
  (let ((temp___892 (elements (mk___rep r__split_discrs r__split_fields11))))
...
;; H
  ...
  (and
  (and
  (= (contains (model__ (mk___rep r__split_discrs r__split_fields10)) o1) true)
  (= (element (mk___rep r__split_discrs r__split_fields10)
     (find1 (mk___rep r__split_discrs r__split_fields10) o1)) o1))
  (ite (= (contains (model__ (mk___rep r__split_discrs r__split_fields11))
          o1) true)
  (and
  (and
  (= (oeq3 (model__ (mk___rep r__split_discrs r__split_fields10))
     (model__ (mk___rep r__split_discrs r__split_fields11))) true)
  (= (oeq4 (positions (mk___rep r__split_discrs r__split_fields10))
     (positions (mk___rep r__split_discrs r__split_fields11))) true))
  (= (equal_except (elements (mk___rep r__split_discrs r__split_fields11))
     (elements (mk___rep r__split_discrs r__split_fields10))
     (get1 (positions (mk___rep r__split_discrs r__split_fields10))
     (find1 (mk___rep r__split_discrs r__split_fields10) o1))) true))
  (and
  (and
  (and
  (and
  (= (length (mk___rep r__split_discrs r__split_fields10)) (+ (length
                                                              (mk___rep
                                                              r__split_discrs
                                                              r__split_fields11)) 1))
  (= (ole (model__ (mk___rep r__split_discrs r__split_fields11))
     (model__ (mk___rep r__split_discrs r__split_fields10))) true))
  (= (included_except (model__ (mk___rep r__split_discrs r__split_fields10))
     (model__ (mk___rep r__split_discrs r__split_fields11)) o1) true))
  (= (mapping_preserved
     (elements (mk___rep r__split_discrs r__split_fields11))
     (elements (mk___rep r__split_discrs r__split_fields10))
     (positions (mk___rep r__split_discrs r__split_fields11))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= temp___8801 (next s (mk___rep1 cu__split_fields10)))
  ...
  (= (bool_eq3 temp___8801 no_element) true)
  (and (= (has_key (positions s) temp___8801) true)
  (= (get1 (positions s) temp___8801) (+ (get1 (positions s)
...
;; H
  (assert
  (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___880))))
...
;; H
  (assert
  (=> (= result1 true)
  (= r__split_fields4 (mk___split_fields__ref r__split_fields10))))
...
;; H
  (assert
  (=> (not (= result1 true))
  (= r__split_fields6 (mk___split_fields__ref r__split_fields12))))
...
(define-fun temp___918 () us_rep2 (elements s))

(declare-fun temp___917 () Int)

;; H
  (assert (in_range2 temp___917))

;; H
  (assert (= (iter_has_element temp___918 temp___917) true))

(define-fun e () Int (get temp___918 temp___917))

;; H
  (assert (f__function_guard (f e) e))
...
;; WP_parameter_def
 ;; File "use_sets.ads", line 6, characters 0-0
  ...
  (= (contains
     (model__
     (mk___rep r__split_discrs (us_split_fields__content r__split_fields8)))
     (f e)) true)))
(check-sat)
