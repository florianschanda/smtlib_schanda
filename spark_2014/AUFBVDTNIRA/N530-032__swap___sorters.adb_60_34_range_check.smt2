...
;; index_of_minimum__post_axiom
  ...
  (! (=>
     (and (dynamic_invariant2 unsorted true true true)
...
(declare-fun temp___160 () (Array Int integer))

(declare-fun temp___1601 () t1)
...
(declare-fun sorters__swap__y () Int)
...
(declare-fun sorters__swap__x () Int)
...
(declare-fun sorters__swap__y1 () Int)

(declare-fun sorters__swap__x1 () Int)
...
;; H
  (assert
  (and (= temp___166 (- (to_rep values__last) 1)) (in_range1
...
;; H
  (assert (<= current1 temp___166))

;; H
  (assert
  (and (=> (<= 1 2147483647) (in_range2 smallest1))
  (and (<= (to_rep values__first) current2)
  (<= current2 (- (to_rep values__last) 1)))))

;; H
  (assert
  (=> (<= current2 (to_rep values__last))
  (and
  (and (<= (to_rep values__first) current2)
  (<= current2 (to_rep values__last)))
...
;; H
  (assert (= (mk1 current2 (to_rep values__last)) temp___1601))

;; H
  (assert (= temp___160 o1))

;; H
  (assert
  (= (mk (to_rep (first3 temp___1601)) (to_rep (last3 temp___1601))) 
  o2))

;; H
  (assert
  (and
  (and (= o3 (index_of_minimum o16)) (index_of_minimum__function_guard 
  o3 o16))
  (and (in_range2 o3)
  (and (and (<= (to_rep (first o2)) o3) (<= o3 (to_rep (last o2))))
  (forall ((j Int))
  (=> (and (<= (to_rep (first o2)) j) (<= j (to_rep (last o2))))
  (<= (to_rep (select o1 o3)) (to_rep (select o1 j)))))))))

;; H
  (assert (= result1 smallest1))
...
;; H
  (assert
  (=> (not (= smallest2 current2))
  (and (<= (to_rep values__first) smallest2)
  (<= smallest2 (to_rep values__last)))))

;; H
  (assert (=> (not (= smallest2 current2)) (= o4 smallest2)))

;; H
  (assert (=> (not (= smallest2 current2)) (= o5 (select values o4))))

;; H
  (assert (=> (not (= smallest2 current2)) (= o6 (to_rep o5))))

;; H
  (assert (=> (not (= smallest2 current2)) (= o6 sorters__swap__y)))
...
;; H
  (assert (=> (not (= smallest2 current2)) (= o7 current2)))

;; H
  (assert (=> (not (= smallest2 current2)) (= o8 (select values o7))))

;; H
  (assert (=> (not (= smallest2 current2)) (= o9 (to_rep o8))))

;; H
  (assert (=> (not (= smallest2 current2)) (= o9 sorters__swap__x)))

;; H
  (assert
  (=> (not (= smallest2 current2))
  (and
  (and (= sorters__swap__x1 sorters__swap__y)
  (= sorters__swap__y1 sorters__swap__x))
  (and (in_range1 sorters__swap__x1) (in_range1 sorters__swap__y1)))))

;; H
  (assert
  (=> (not (= smallest2 current2)) (= (to_rep o10) sorters__swap__x1)))
...
;; H
  (assert (=> (not (= smallest2 current2)) (= o11 current2)))

;; H
  (assert (=> (not (= smallest2 current2)) (= o12 (store values o11 o10))))

;; H
  (assert (=> (not (= smallest2 current2)) (= values result2)))

;; H
  (assert (=> (not (= smallest2 current2)) (= values1 o12)))

;; H
  (assert
  (=> (not (= smallest2 current2)) (= (to_rep o13) sorters__swap__y1)))
...
;; H
  (assert (=> (not (= smallest2 current2)) (= o14 smallest2)))

;; H
  (assert (=> (not (= smallest2 current2)) (= o15 (store values1 o14 o13))))

;; H
  (assert (=> (not (= smallest2 current2)) (= result3 values1)))

;; H
  (assert (=> (not (= smallest2 current2)) (= values2 o15)))

;; H
  (assert (=> (not (not (= smallest2 current2))) (= values2 values)))

;; H
  (assert (=> (not (not (= smallest2 current2))) (= sorters__swap__x1 rho1)))

;; H
  (assert (=> (not (not (= smallest2 current2))) (= sorters__swap__y1 rho)))

;; H
  (assert (=> (not (not (= smallest2 current2))) (= values2 values)))

;; H
  (assert (<= current2 (to_rep values__last)))
