...
;; H
  (assert
  (and (and (= temp___180 (id 257)) (id__function_guard temp___180 257))
  (and (in_range temp___180) (= temp___180 257))))

;; H
  (assert
  (=> (< temp___180 256)
  (= o (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) temp___180)))))

;; H
  (assert (=> (not (< temp___180 256)) (= o ((_ int2bv 8) 0))))
...
;; H
  (assert
  (and (and (= temp___181 (id 3)) (id__function_guard temp___181 3))
  (and (in_range temp___181) (= temp___181 3))))

;; H
  (assert
  (=> (< temp___181 256)
  (= o1 (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) temp___181)))))

;; H
  (assert (=> (not (< temp___181 256)) (= o1 ((_ int2bv 8) 0))))

;; H
  (assert (= o2 (bvurem o1 ((_ int2bv 8) 8))))
...
(assert
;; WP_parameter_def
 ;; File "overflow_modulus.adb", line 3, characters 0-0
  (not (= y1 ((_ int2bv 8) 0))))
(check-sat)
