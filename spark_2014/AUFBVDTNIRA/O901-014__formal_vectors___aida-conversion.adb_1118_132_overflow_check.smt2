...
;; H
  (assert
  (and (= temp___1774 (+ (to_rep1 (first (rt source))) 2)) (in_range1
...
;; H
  (assert
  (and (= temp___1773 (+ (to_rep1 (first (rt source))) 1)) (in_range1
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1772)
  (<= temp___1772 (to_rep1 (last (rt source))))))

;; H
  (assert (= o temp___1772))
