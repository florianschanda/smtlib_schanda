...
;; H
  (assert (remove__function_guard (remove o33 o19) o33 o19))
...
;; H
  ...
  (remove__function_guard o33 (mk___t values2 (mk 1 100)) o16))
...
;; H
  ...
  (remove__function_guard o34 (mk___t interm1 (mk 1 100)) o13))
...
;; H
  (assert
  (and
  (and (= o20 (remove_eq o34 o33 o19)) (remove_eq__function_guard o20 
  o34 o33 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___181 (remove o33 o19)))
     (let ((temp___180 (remove o34 o19)))
