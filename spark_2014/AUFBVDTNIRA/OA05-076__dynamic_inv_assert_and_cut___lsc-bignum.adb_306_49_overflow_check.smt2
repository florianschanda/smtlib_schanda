...
;; H
  (assert
  (and (= o26 (from_word32 carry22)) (from_word32__function_guard o26
  carry22)))
...
;; H
  (assert
  (and (= o27 (omultiply o25 o26)) (omultiply__function_guard o27 o25 o26)))

;; H
  (assert
  (and (= o24 (from_word32 carry12)) (from_word32__function_guard o24
  carry12)))

;; H
  (assert (and (= o28 (oadd o24 o27)) (oadd__function_guard o28 o24 o27)))
...
;; H
  (assert
  (and (and (= o18 (base Tuple0)) (base__function_guard o18 Tuple0))
...
;; H
  (assert
  (and (= o29 (omultiply o23 o28)) (omultiply__function_guard o29 o23 o28)))
