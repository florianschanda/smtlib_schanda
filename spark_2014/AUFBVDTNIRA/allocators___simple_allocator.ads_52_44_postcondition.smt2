...
(declare-fun simple_allocator__m__model__result () us_rep)

(declare-fun simple_allocator__m__model__result1 () us_rep)

(declare-fun temp___261 () us_rep)

(declare-fun temp___260 () Int)

(declare-fun temp___259 () us_rep)
...
(declare-fun simple_allocator__m__model__result2 () us_rep1)

(declare-fun simple_allocator__m__model__result3 () t__ref)

(declare-fun simple_allocator__m__model__result4 () us_rep1)
...
(declare-fun simple_allocator__m__model__result5 () t__ref)
...
(declare-fun simple_allocator__m__model__result6 () us_rep1)
...
;; H
  (assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___261 avail)))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___260 r1)))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___259 alloc)))
...
;; H
  (assert (=> (and (<= 1 r1) (<= r1 10000)) (= r2 r3)))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 10000)) (= alloc3 alloc4)))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 10000)) (= avail3 avail4)))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 10000)) (= r4 r2)))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 10000)) (= alloc5 alloc3)))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 10000)) (= avail5 avail3)))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 10000)) (= r5 (mk_int__ref r3))))

;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000)) (= alloc10 (mk_set__ref alloc4))))

;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000)) (= avail10 (mk_set__ref avail4))))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 10000)) (= r6 r4)))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 10000)) (= alloc7 alloc5)))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 10000)) (= avail7 avail5)))

;; H
  (assert (=> (not (and (<= 1 r1) (<= r1 10000))) (= r5 (mk_int__ref r1))))

;; H
  (assert (=> (not (and (<= 1 r1) (<= r1 10000))) (= alloc10 alloc11)))

;; H
  (assert (=> (not (and (<= 1 r1) (<= r1 10000))) (= avail10 avail11)))

;; H
  (assert (=> (not (and (<= 1 r1) (<= r1 10000))) (= r6 r1)))

;; H
  (assert (=> (not (and (<= 1 r1) (<= r1 10000))) (= alloc7 alloc1)))

;; H
  (assert (=> (not (and (<= 1 r1) (<= r1 10000))) (= avail7 avail1)))

;; H
  (assert
  (= simple_allocator__m__model__result3 (mk_t__ref
                                         simple_allocator__m__model__result2)))

;; H
  (assert
  (= simple_allocator__m__model__result4 simple_allocator__m__model__result2))

;; H
  (assert
  (= result3 (mk_t__ref
             (mk___rep
             (mk___split_fields simple_allocator__m__model__result
             simple_allocator__m__model__result1)))))

;; H
  (assert
  (= simple_allocator__m__model__result2 (mk___rep
                                         (mk___split_fields avail6 alloc6))))

;; H
  (assert
  (= simple_allocator__m__model__result5 simple_allocator__m__model__result3))
...
;; H
  (assert
  (= simple_allocator__m__model__result6 simple_allocator__m__model__result4))
...
;; H
  ...
  (= (mk___rep (mk___split_fields result4 result5)) (t__content
                                                    simple_allocator__m__model__result5)))

;; H
  (assert (is_valid__function_guard
  (is_valid (t__content simple_allocator__m__model__result5) data)
  (t__content simple_allocator__m__model__result5) data))

(assert
;; WP_parameter_def
 ;; File "simple_allocator.ads", line 30, characters 0-0
  (not
  (= (is_valid (t__content simple_allocator__m__model__result5) data) true)))
(check-sat)
