...
(declare-fun temp___987 () us_rep2)
...
(declare-fun temp___989 () us_rep2)
...
(declare-fun my_ordered_maps__n__include__container__fields1 () us_split_fields2)

(declare-fun result11 () us_split_fields__ref1)

(declare-fun l__split_fields8 () us_split_fields2)

(declare-fun my_ordered_maps__n__delete__container__fields () us_split_fields2)
...
(declare-fun my_ordered_maps__n__delete__2__container__fields () us_split_fields2)
...
(declare-fun my_ordered_maps__n__exclude__container__fields () us_split_fields2)

(declare-fun result16 () us_split_fields__ref1)

(declare-fun l__split_fields11 () us_split_fields2)

(declare-fun my_ordered_maps__n__exclude__container__fields1 () us_split_fields2)
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o51) true))
  (= (bool_eq2
     (get
     (keys
     (mk___rep1 l__split_discrs
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o51)) o51) true))
  (= (get2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o51) 1))
  (= (ole
     (model__
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (model__
  ...
  (= (range_equal
     ...
     (- (find
        (keys
        (mk___rep1 l__split_discrs
        my_ordered_maps__n__insert__2__container__fields)) o51) 1)) true))
  (= (range_shifted
     (keys (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (keys
     (mk___rep1 l__split_discrs
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o51)
     (length
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1)) o50) true))
  (= (bool_eq2
     (get
     (keys
     (mk___rep1 l__split_discrs
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1)) o50)) o50) true))
  (= (get2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1)) o50) 2))
  ...
  (= (keys_included_except
     ...
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields1)) o50) true))
  (= (range_equal (keys (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (- (find
        (keys
        (mk___rep1 l__split_discrs
        my_ordered_maps__n__insert__2__container__fields1)) o50) 1)) true))
  (= (range_shifted (keys (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1)) o50)
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields1)) o29) true)
  (= (get2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields1)) o29) 3))
  ...
  (= (oeq4
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields1))
  ...
  (= (bool_eq2
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields1)) o29)) o29) true))
  ...
  (= (elements_equal_except
     ...
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields7)) o29) true))
  (and
  (and
  (and
  (and
  ...
  (= (length
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields1)) (+ (length
                                                          (mk___rep1
                                                          l__split_discrs
                                                          l__split_fields7)) 1))
  (= (ole (model__ (mk___rep1 l__split_discrs l__split_fields7))
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields1))) true))
  (= (keys_included_except
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields1))
  ...
  (= (bool_eq2
     ...
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields1)) o29)) o29) true))
  (= (range_equal (keys (mk___rep1 l__split_discrs l__split_fields7))
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields1)) 1
     (- (find
        (keys
        (mk___rep1 l__split_discrs
        my_ordered_maps__n__include__container__fields1)) o29) 1)) true))
  (= (range_shifted (keys (mk___rep1 l__split_discrs l__split_fields7))
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields1))
     (find
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__include__container__fields1)) o29)
...
;; H
  (assert
  (= l__split_fields8 my_ordered_maps__n__include__container__fields1))
...
;; H
  ...
  (= (length
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__delete__container__fields)) (- (length
                                                        (mk___rep1
                                                        l__split_discrs
                                                        l__split_fields8)) 1))
  (not
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__delete__container__fields)) o33) true)))
  (= (ole
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__delete__container__fields))
  ...
  (= (keys_included_except
     ...
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__delete__container__fields)) o33) true))
  (= (range_equal (keys (mk___rep1 l__split_discrs l__split_fields8))
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__delete__container__fields)) 1
     (- (find (keys (mk___rep1 l__split_discrs l__split_fields8)) o33) 1)) true))
  (= (range_shifted
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__delete__container__fields))
     (keys (mk___rep1 l__split_discrs l__split_fields8))
     (find (keys (mk___rep1 l__split_discrs l__split_fields8)) o33)
     (length
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__delete__container__fields)) 1) true))
  (= (p_positions_shifted
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__delete__container__fields))
...
;; H
  (assert
  (and
  (= temp___987 (find1 (mk___rep1 l__split_discrs l__split_fields9) o37))
  (ite (ite (= (has_key1
               (model__ (mk___rep1 l__split_discrs l__split_fields9)) 
               o37) false) true false)
  (and
  (not
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___987) true))
  (= (bool_eq4 temp___987 no_element) true))
  (and
  (and
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___987) true)
  (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___987) (find (keys (mk___rep1 l__split_discrs l__split_fields9))
                 o37)))
  (= (equivalent_keys
     (key (mk___rep1 l__split_discrs l__split_fields9) temp___987) o37) true)))))
...
;; H
  (assert (not (= (bool_eq4 (mk___rep2 c__split_fields4) no_element) true)))
...
;; H
  ...
  (and
  (and
  (and (= (bool_eq4 (mk___rep2 c__split_fields5) no_element) true)
  (= (length
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__delete__2__container__fields)) (- (length
                                                           (mk___rep1
                                                           l__split_discrs
                                                           l__split_fields9)) 1)))
  (not
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__delete__2__container__fields))
  ...
  (= (keys_included_except
     ...
     (key (mk___rep1 l__split_discrs l__split_fields9)
     (mk___rep2 c__split_fields4))) true))
  (= (range_equal (keys (mk___rep1 l__split_discrs l__split_fields9))
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__delete__2__container__fields)) 1
     (- (get1 (positions (mk___rep1 l__split_discrs l__split_fields9))
  ...
  (= (range_shifted
     ...
     (length
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__delete__2__container__fields)) 1) true))
  (= (p_positions_shifted
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__delete__2__container__fields))
...
;; H
  (assert
  (= l__split_fields10 my_ordered_maps__n__delete__2__container__fields))

;; H
  (assert
  (not
  (= (has_key1 (model__ (mk___rep1 l__split_discrs l__split_fields10))
     (mk___rep (mk___split_fields (of_rep 2) (of_rep 5)))) true)))
...
;; H
  (assert
  (and
  (= temp___989 (find1 (mk___rep1 l__split_discrs l__split_fields10) o41))
  (ite (ite (= (has_key1
               (model__ (mk___rep1 l__split_discrs l__split_fields10)) 
               o41) false) true false)
  (and
  (not
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___989) true))
  (= (bool_eq4 temp___989 no_element) true))
  (and
  (and
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___989) true)
  (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___989) (find (keys (mk___rep1 l__split_discrs l__split_fields10))
                 o41)))
  (= (equivalent_keys
     (key (mk___rep1 l__split_discrs l__split_fields10) temp___989) o41) true)))))
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields)) o45) true))
  (ite (ite (= (has_key1
               (model__ (mk___rep1 l__split_discrs l__split_fields10)) 
               o45) false) true false)
  (and
  (and
  (= (oeq2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields))
  ...
  (= (length
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields)) (- (length
                                                         (mk___rep1
                                                         l__split_discrs
                                                         l__split_fields10)) 1))
  (= (ole
  ...
  (= (keys_included_except
     ...
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields)) o45) true))
  (= (range_equal (keys (mk___rep1 l__split_discrs l__split_fields10))
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields)) 1
     (- (find (keys (mk___rep1 l__split_discrs l__split_fields10)) o45) 1)) true))
  (= (range_shifted
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields))
     (keys (mk___rep1 l__split_discrs l__split_fields10))
     (find (keys (mk___rep1 l__split_discrs l__split_fields10)) o45)
     (length
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields)) 1) true))
  (= (p_positions_shifted
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields))
...
;; H
  (assert
  (= l__split_fields11 my_ordered_maps__n__exclude__container__fields))

;; H
  (assert
  (= (has_key1 (model__ (mk___rep1 l__split_discrs l__split_fields11))
     (mk___rep (mk___split_fields (of_rep 1) (of_rep 8)))) true))
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields1)) o49) true))
  (ite (ite (= (has_key1
               (model__ (mk___rep1 l__split_discrs l__split_fields11)) 
               o49) false) true false)
  (and
  (and
  (= (oeq2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields1))
  ...
  (= (length
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields1)) (- (length
                                                          (mk___rep1
                                                          l__split_discrs
                                                          l__split_fields11)) 1))
  (= (ole
  ...
  (= (keys_included_except
     ...
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields1)) o49) true))
  (= (range_equal (keys (mk___rep1 l__split_discrs l__split_fields11))
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields1)) 1
     (- (find (keys (mk___rep1 l__split_discrs l__split_fields11)) o49) 1)) true))
  (= (range_shifted
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields1))
     (keys (mk___rep1 l__split_discrs l__split_fields11))
     (find (keys (mk___rep1 l__split_discrs l__split_fields11)) o49)
     (length
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields1)) 1) true))
  (= (p_positions_shifted
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields1))
...
;; H
  (assert
  (= l__split_fields12 my_ordered_maps__n__exclude__container__fields1))
