...
;; H
  ...
  (and (in_range2 o2)
  (<= o2 (to_rep
         (rec__use_maps__my_maps__map__capacity (us_split_discrs1 s2)))))))
...
;; H
  ...
  (and (in_range2 o)
  (<= o (to_rep (rec__use_maps__my_maps__map__capacity s1__split_discrs))))))

;; H
  (assert
  (= o1 (- (to_rep (rec__use_maps__my_maps__map__capacity s1__split_discrs)) 
  o)))
