...
(declare-fun arctanh (t) t)

(declare-fun arctanh__function_guard (t t) Bool)
...
;; arctanh__post_axiom
  (assert
  (forall ((x t))
  (! (=> (and (dynamic_invariant x true true true) (neq (abs1 x) fliteral))
     (let ((result (arctanh x)))
     (and (=> (eq x fliteral2) (eq result fliteral2)) (dynamic_invariant
     result true false true)))) :pattern ((arctanh x)) )))
