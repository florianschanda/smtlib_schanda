...
(define-fun o26 () us_rep (mk___rep (mk___split_fields o18 o19)))

(define-fun o27 () us_rep (mk___rep (mk___split_fields o16 o17)))

(define-fun o28 () us_rep (mk___rep (mk___split_fields o11 o12)))
...
;; H
  ...
  (stack_entry (state__2 (us_split_fields__content my_stack__split_fields5))
  i1) (state__2 (us_split_fields__content my_stack__split_fields5)) i1)))
...
;; H
  (assert (= o24 (ite (<= i o23) true false)))

;; H
  (assert (= result4 (ite (<= 1 i) o24 false)))
...
;; H
  ...
  (<= i1 (count
         ...
         (mk___split_fields my_stack__split_fields my_stack__split_fields1)))))
  (= (stack_entry
     (state__2 (us_split_fields__content my_stack__split_fields5)) i1) 
  (stack_entry
  (state__2
  (mk___split_fields my_stack__split_fields my_stack__split_fields1)) i1))))))
...
;; H
  (assert
  (and
  (and (= o26 (state__2 (us_split_fields__content my_stack__split_fields5)))
  (state__2__function_guard o26
  (us_split_fields__content my_stack__split_fields5)))
  (= (us_split_fields__content my_stack__split_fields5) (mk___split_fields
                                                        o18 o19))))

;; H
  (assert
  (and (and (= o20 (count o26)) (count__function_guard o20 o26))
  (and (in_range4 o20) (= o20 (to_rep1 o19)))))

;; H
  (assert
  (and
  (and (= o27 (state__2 (us_split_fields__content my_stack__split_fields5)))
...
;; H
  (assert
  (and
  (and (= o21 (stack_entry o27 o20)) (stack_entry__function_guard o21 
  o27 o20)) (and (in_range1 o21) (= o21 (to_rep (select o16 o20))))))

;; H
  (assert (= o22 (ite (= o21 x) true false)))

;; H
  (assert
  (and
  (and (= o13 (max_stack_size Tuple0)) (max_stack_size__function_guard 
  o13 Tuple0)) (and (in_range4 o13) (= o13 100))))

;; H
  (assert
  (and
  (and (= o28 (state__2 (us_split_fields__content my_stack__split_fields5)))
  (state__2__function_guard o28
  (us_split_fields__content my_stack__split_fields5)))
  (= (us_split_fields__content my_stack__split_fields5) (mk___split_fields
                                                        o11 o12))))
...
;; H
  (assert
  (and (and (= o14 (count o28)) (count__function_guard o14 o28))
  (and (in_range4 o14) (= o14 (to_rep1 o12)))))
