...
(declare-fun temp___843 () count_type)
...
(define-fun temp___8431 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___843)))
...
;; H
  ...
  (ite (= (= (length s) 0) true)
  (= (bool_eq3 use_maps__apply_f_2__cu__assume1 no_element) true)
...
;; H
  (assert
  (let ((temp___853 (keys (mk___rep r__split_discrs r__split_fields4))))
  ...
  (and (<= 1 i)
  (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1)))
  (= (get temp___853 temp___852) (get (keys s) i))))))))
...
;; H
  (assert
  (and (= temp___8431 (next s (mk___rep1 cu__split_fields4)))
  ...
  (= (bool_eq3 temp___8431 no_element) true)
  (and (= (has_key1 (positions s) temp___8431) true)
  (= (get1 (positions s) temp___8431) (+ (get1 (positions s)
...
;; H
  (assert (= cu__split_fields3 (mk___split_fields1 temp___843)))
