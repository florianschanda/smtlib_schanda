...
(declare-fun o29 () position_type)

(declare-fun o30 () us_rep2)

(declare-fun o31 () (Array Int us_rep2))
...
(declare-fun o36 () (Array Int us_rep2))
...
(declare-fun o39 () extended_index_type)
...
;; H
  (assert
  (and (= o (+ (to_rep f__split_fields) 1)) (in_range1
...
;; H
  (assert
  (= (rec__binary_trees__cell__left
     (us_split_fields3 (select f__split_fields1 v1))) o2))

;; H
  (assert
  (= (rec__binary_trees__cell__right
     (us_split_fields3 (select f__split_fields1 v1))) o3))

;; H
  (assert
  (= (rec__binary_trees__cell__parent
     (us_split_fields3 (select f__split_fields1 v1))) o4))
...
;; H
  (assert
  (= o10 (store f__split_fields1 v1 (mk___rep1
...
;; H
  ...
  (= (rec__binary_trees__cell__left
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields2) v1))) o14))

;; H
  (assert
  (= (rec__binary_trees__cell__right
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields2) v1))) o15))
...
;; H
  ...
  (= (rec__binary_trees__cell__position
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields2) v1))) o17))
...
;; H
  (assert
  (= o22 (store (rec__binary_trees__forest__c f__split_fields2) v1 (mk___rep1
                                                                   (mk___split_fields1
                                                                   o18 
                                                                   o19 
                                                                   o20 
...
;; H
  ...
  (= (rec__binary_trees__cell__right
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields3) i))) o27)))
...
;; H
  ...
  (= (rec__binary_trees__cell__parent
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields3) i))) o28)))
...
;; H
  ...
  (= (rec__binary_trees__cell__position
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields3) i))) o29)))

;; H
  (assert
  (=> (= d 0) (= o30 (mk___rep1 (mk___split_fields1 o26 o27 o28 o29)))))

;; H
  (assert
  (=> (= d 0)
  (= o31 (store (rec__binary_trees__forest__c f__split_fields3) i o30))))

;; H
  (assert
  (=> (= d 0)
  (= o32 (mk___split_fields2 (rec__binary_trees__forest__s f__split_fields3)
         o31))))
...
;; H
  ...
  (= o34 (mk___split_fields1
         (rec__binary_trees__cell__left
         (us_split_fields3
         (select (rec__binary_trees__forest__c f__split_fields3) i))) 
         o33
         (rec__binary_trees__cell__parent
         (us_split_fields3
         (select (rec__binary_trees__forest__c f__split_fields3) i)))
...
;; H
  (assert
  (=> (not (= d 0))
  (= o36 (store (rec__binary_trees__forest__c f__split_fields3) i o35))))

;; H
  (assert
  (=> (not (= d 0))
  (= o37 (mk___split_fields2 (rec__binary_trees__forest__s f__split_fields3)
         o36))))
...
;; H
  (assert
  (=> (not (= d 0)) (= result5 (mk___split_fields__ref2 f__split_fields3))))
...
;; H
  (assert
  (and (= o38 (+ (to_rep (rec__binary_trees__forest__s f__split_fields4)) 1))
  (in_range2 (+ (to_rep (rec__binary_trees__forest__s f__split_fields4)) 1))))
...
;; H
  ...
  (= (to_rep
     (rec__binary_trees__cell__parent
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields6) i1)))) 0))
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields6) i1)))) 0))
  (= (to_rep
     (rec__binary_trees__cell__left
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields6) (to_rep
                                                             (rec__binary_trees__cell__parent
                                                             (us_split_fields3
                                                             (select 
                                                             (rec__binary_trees__forest__c
                                                             f__split_fields6) i1)))))))) i1)))))
...
;; H
  ...
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields6) i1)))) 1))
  (= (to_rep
     (rec__binary_trees__cell__right
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields6) (to_rep
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 f__split_fields6) root) v1))) true)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  ...
  (=>
  (and (<= 1 r)
  (<= r (to_rep (rec__binary_trees__forest__s f_old__split_fields2))))
  (=>
  (and
  (and (not (= r root))
  (= (to_rep1
...
;; H
  ...
  (and
  (and
  (= o50 (size (mk___rep2 (us_split_fields__content2 f__split_fields7))))
  (size__function_guard o50
  (mk___rep2 (us_split_fields__content2 f__split_fields7))))
  (and (in_range2 o50)
  (= o50 (to_rep
         (rec__binary_trees__forest__s
...
;; H
  ...
  (ite (and
       (not
       (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7))
          i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1443 (parent
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1443 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o48 (select temp___1443 i)))

;; H
  (assert (= o49 (us_split_fields1 o48)))

;; H
  (assert (= result8 (rec__tree_model__path_type__k o49)))
...
;; H
  ...
  (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o47)
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) o47))

;; H
  (assert (parent__function_guard
  (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o47)
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) o47))
...
;; H
  ...
  (and
  (and
  (= o47 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d))
  (peek__function_guard o47
...
;; H
  (assert (= result9 (ite (= o47 (int__content v2)) true false)))
...
;; H
  ...
  (ite (= (valid_root
          (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
          i1) true)
  (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) i1) true)
  (not
  (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) i1) true)))))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1438 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o45 (select temp___1438 (int__content v2))))

;; H
  (assert (= o46 (us_split_fields1 o45)))

;; H
  (assert (= result11 (rec__tree_model__path_type__k o46)))
...
;; H
  (assert (valid_root__function_guard
  (valid_root
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j)
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j))
...
;; H
  ...
  (= o41 (to_rep
         (rec__binary_trees__cell__parent
         (us_split_fields3 (select f__split_fields1 j)))))
  (and
  (=>
  (= (valid_root
     (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) 
  ...
  (= o41 0))
  (=>
  (= (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 0)
  (= o41 0)))))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (not
  (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) 0))))
(check-sat)
