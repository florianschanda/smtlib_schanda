...
;; mk_def
  ...
  (! (=> (in_range3 f)
     ...
     (= (to_rep3 (last7 (mk2 f l))) l)))) :pattern ((mk2 f l)) )))
...
(define-fun last8 ((a us_t2)) Int (to_rep3 (last7 (rt2 a))))
...
(define-fun bool_eq12 ((x us_t2)
  (y us_t2)) Bool (bool_eq3 (elts2 x) (to_rep3 (first4 (rt2 x)))
                  (to_rep3 (last7 (rt2 x))) (elts2 y)
                  (to_rep3 (first4 (rt2 y))) (to_rep3 (last7 (rt2 y)))))
...
;; mk_def
  ...
  (! (=> (in_range3 f)
     ...
     (= (to_rep3 (last10 (mk3 f l))) l)))) :pattern ((mk3 f l)) )))
...
(define-fun last11 ((a us_t3)) Int (to_rep3 (last10 (rt3 a))))
...
(define-fun bool_eq15 ((x us_t3)
  (y us_t3)) Bool (bool_eq3 (elts3 x) (to_rep3 (first6 (rt3 x)))
                  (to_rep3 (last10 (rt3 x))) (elts3 y)
                  (to_rep3 (first6 (rt3 y))) (to_rep3 (last10 (rt3 y)))))
...
(declare-fun temp___330 () positive)

(declare-fun temp___3301 () natural)

(declare-fun temp___3302 () Int)

(declare-fun temp___337 () positive)

(declare-fun temp___3371 () (Array Int element))

(declare-fun temp___3372 () t)

(declare-fun temp___3373 () natural)

(declare-fun temp___3374 () us_private)

(declare-fun temp___3375 () Int)

(define-fun temp___3376 () us_rep (mk___rep (mk___split_discrs temp___337)
                                  (mk___split_fields
                                  (mk___t temp___3371 temp___3372)
                                  temp___3373 temp___3374) temp___3375))

;; H
  (assert (and (= temp___3302 us_tag) (= (to_rep temp___3301) 0)))

;; H
  (assert (<= (to_rep temp___3301) (to_rep1 temp___330)))

;; H
  (assert
  (and (dynamic_invariant2 temp___3376 true false true)
  (and (= temp___3375 us_tag) (= (to_rep temp___3373) 0))))

;; H
  (assert (empty__function_guard (empty temp___3376) temp___3376))

(assert
;; WP_parameter_def
 ;; File "bounded_stacks.ads", line 48, characters 0-0
  (not (= (empty temp___3376) true)))
(check-sat)
