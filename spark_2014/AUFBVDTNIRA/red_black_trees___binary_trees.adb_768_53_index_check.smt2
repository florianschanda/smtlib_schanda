...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2391 o11))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2391 o11)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o11))
...
;; H
  (assert (= o12 (select temp___2391 i)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2392 o5))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2392 o5)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o5))
...
;; H
  (assert (=> (= result2 true) (= o6 (select temp___2392 i))))
...
;; H
  (assert
  (=> (= result2 true) (= result1 (ite (<= o9 (- n2 1)) true false))))
