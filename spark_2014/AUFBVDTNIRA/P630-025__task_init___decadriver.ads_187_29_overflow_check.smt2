...
(define-fun us_split_fields__ref_139__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_140__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                a))
