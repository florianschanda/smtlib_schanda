...
(declare-fun temp___1162 () (Array Int octet))

(declare-fun temp___11621 () t1)
...
;; H
  (assert
  (= (mk___t1 temp___1162 temp___11621) (mk___t1 temp___1160 temp___11601)))

;; H
  (assert (= temp___1162 o))

;; H
  (assert
  (= (mk (to_rep2 (first2 temp___11621)) (to_rep2 (last4 temp___11621))) 
  o1))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___1164)))

;; H
  (assert (= temp___11641 o2))

;; H
  (assert (= temp___11642 o3))
...
;; WP_parameter_def
 ;; File "very_longs.adb", line 49, characters 0-0
  ...
  (= (to_rep2
     ...
     (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) 
  (to_rep2
  (last1 (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))))
(check-sat)
