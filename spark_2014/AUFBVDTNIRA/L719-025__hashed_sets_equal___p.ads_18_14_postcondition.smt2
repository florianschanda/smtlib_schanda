...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant2 item true true true)
     ...
     (and (my_eq__function_guard (my_eq (element container result) item)
     (element container result) item)
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container)))
     ...
     (my_eq (get result (find2 result item)) item)
...
;; WP_parameter_def
 ;; File "a-cfhase.ads", line 1134, characters 0-0
  ...
  (= (element (mk___rep l__split_discrs (mk___split_fields l__split_fields3))
     (find (mk___rep l__split_discrs (mk___split_fields l__split_fields3)) e)) 
  e)))
(check-sat)
