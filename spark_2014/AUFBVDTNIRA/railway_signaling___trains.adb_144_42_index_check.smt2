...
;; H
  (assert
  (forall ((k1 Int)) (get_other_previous_track__function_guard
  (get_other_previous_track new_position k1) new_position k1)))
...
;; H
  ...
  (get_other_previous_track__function_guard o10 new_position o9))
  (and (in_range1 o10)
  (= o10 (ite (= (to_rep3
                 (select (select previous_tracks (to_rep1
                                                 (rec__trains__track__from
...
;; H
  (assert
  (and
  (and (= temp___405 (get_other_previous_track new_position o12))
  (get_other_previous_track__function_guard temp___405 new_position o12))
  (and (in_range1 temp___405)
  (= temp___405 (ite (= (to_rep3
                        (select (select previous_tracks (to_rep1
                                                        (rec__trains__track__from
                                                        (us_split_fields1
                                                        (select tracks 
