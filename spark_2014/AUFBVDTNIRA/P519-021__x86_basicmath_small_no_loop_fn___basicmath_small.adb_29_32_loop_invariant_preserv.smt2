...
;; H
  ...
  (inrange64 i rsi1 ((_ int2bv 64) 8)) i rsi1 ((_ int2bv 64) 8))))

;; H
  (assert (writereg32post__function_guard (writereg32post rdx o) rdx o))

;; H
  (assert (readreg32__function_guard (readreg32 rbx) rbx))

;; H
  (assert (writereg32post__function_guard (writereg32post rsi2 o1) rsi2 
  o1))
...
;; H
  (assert (writereg32post__function_guard
  (writereg32post rdi2 ((_ int2bv 32) 4198703)) rdi2
  ((_ int2bv 32) 4198703)))
...
;; H
  (assert
  (and (and (= o1 (ebx rbx)) (ebx__function_guard o1 rbx))
  (= o1 (readreg32 rbx))))
