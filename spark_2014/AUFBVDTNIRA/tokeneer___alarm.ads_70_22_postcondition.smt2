...
;; H
  (assert (thedooralarm__function_guard (thedooralarm state) state))
...
;; H
  (assert
  (<= (to_int1 (= (thedooralarm state) 0)) (to_int1 (isalarming1 Tuple0))))
...
;; WP_parameter_def
 ;; File "alarm.adb", line 30, characters 0-0
  (not
  (<= (to_int1 (= (thedooralarm state) 0)) (to_int1 (isalarming Tuple0)))))
(check-sat)
