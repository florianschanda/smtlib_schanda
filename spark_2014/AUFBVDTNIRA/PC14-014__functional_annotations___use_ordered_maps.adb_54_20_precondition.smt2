...
;; H
  ...
  (ite (= (= (length s) 0) true)
  (= (bool_eq2 use_ordered_maps__apply_f_2__cu__assume1 no_element) true)
  (and
...
;; H
  (assert
  (let ((temp___731 (keys (mk___rep r__split_discrs r__split_fields2))))
  (forall ((temp___730 Int))
  (=>
  (and (in_range3 temp___730)
  (= (iter_has_element temp___731 temp___730) true))
  (exists ((i1 Int))
  (and
  (and (<= 1 i1)
  (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1)))
  (= (get temp___731 temp___730) (get (keys s) i1))))))))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key1 o j) true)
  (=> (= (get1 o i1) (get1 o j)) (= (bool_eq2 i1 j) true))))))))))
...
;; H
  ...
  (and
  (and
  (and (= (length3 o7) (length s))
  (forall ((temp___396 Int))
  (=> (and (in_range3 temp___396) (= (iter_has_element o7 temp___396) true))
  (= (has_key (model__ s) (get o7 temp___396)) true))))
  (forall ((key2 Int))
  (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true))
  (and (< 0 (find o7 key2))
  (= (equivalent_keys (get o7 (find o7 key2)) key2) true)))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length s)))
  (and (= (find o7 (get o7 i1)) i1) (= (k_is_find o7 (get o7 i1) i1) true)))))))
...
;; H
  (assert
  (and (= result3 (has_key o6 o8))
  (=> (= (of_int 1) true)
  (=>
  (exists ((k Int))
  (and (and (in_range2 k) (= (has_key o6 k) true))
  (= (equivalent_keys k o8) true))) (= result3 true)))))
