...
;; H
  (assert (=> (= d 0) (= temp___1199 o10)))

;; H
  (assert (=> (= d 0) (= temp___11991 o11)))

;; H
  (assert (=> (= d 0) (= result1 f__split_fields4)))

;; H
  (assert
  (=> (= d 0)
  (= f__split_fields2 (mk___split_fields2 temp___1199 temp___11991))))
...
;; H
  (assert (=> (not (= d 0)) (= temp___1194 o22)))

;; H
  (assert (=> (not (= d 0)) (= temp___11941 o23)))

;; H
  (assert (=> (not (= d 0)) (= result2 f__split_fields4)))

;; H
  (assert
  (=> (not (= d 0))
  (= f__split_fields3 (mk___split_fields2 temp___1194 temp___11941))))
...
;; H
  ...
  (= (rec__binary_trees__cell__left
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields2) v))) o25))

;; H
  (assert
  (= (rec__binary_trees__cell__right
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields2) v))) o26))

;; H
  (assert
  (= (rec__binary_trees__cell__parent
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields2) v))) o27))
