...
(define-fun k_smaller_than_range ((container us_rep2) (fst Int) (lst Int)
  (key us_rep)) Bool (ite (forall ((i Int))
                          (=> (and (<= fst i) (<= i lst))
                          (= (my_lt key (get container i)) true)))
                     true false))
...
;; first_key__post_axiom
  ...
  (! (=> (not (= (is_empty container) true))
     ...
     (and (= (bool_eq1 result (get (keys container) 1)) true)
     (= (k_smaller_than_range (keys container) 2 (length container) result) true)))) :pattern (
  (first_key container)) )))
...
(define-fun k_bigger_than_range ((container1 us_rep2) (fst Int) (lst Int)
  (key1 us_rep)) Bool (ite (forall ((i Int))
                           (=> (and (<= fst i) (<= i lst))
                           (= (my_lt (get container1 i) key1) true)))
                      true false))
