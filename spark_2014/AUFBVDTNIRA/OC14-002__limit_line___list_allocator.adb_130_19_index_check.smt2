...
;; H
  (assert
  (and
  (and (= temp___670 (get ma1 o45)) (get__function_guard temp___670 ma1 o45))
  (in_range7 temp___670)))

;; H
  (assert (and (<= 1 temp___670) (<= temp___670 3)))

;; H
  (assert (= o46 temp___670))
