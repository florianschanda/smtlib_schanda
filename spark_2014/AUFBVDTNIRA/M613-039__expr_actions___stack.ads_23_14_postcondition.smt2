...
;; to____post_axiom
  ...
  (forall ((s us_rep))
  (! (let ((result (to__ s)))
     (=> (to____function_guard result s) (dynamic_invariant result true false
     true))) :pattern ((to__ s)) )))
...
;; to_but_top__post_axiom
  ...
  (! (let ((result (to_but_top s)))
     (=> (to_but_top__function_guard result s) (dynamic_invariant result true
     false true))) :pattern ((to_but_top s)) )))

;; to_but_top__def_axiom
  (assert
  (forall ((s us_rep))
  (! (=> (to_but_top__function_guard (to_but_top s) s)
     (= (to_but_top s) (let ((temp___189 (let ((temp___187 (- (to_rep
                       ...
                       (last7 temp___189))))) :pattern ((to_but_top s)) )))
...
(declare-fun temp___248 () r1)

(declare-fun temp___2481 () (Array Int integer))
...
;; WP_parameter_def
 ;; File "stack.ads", line 19, characters 0-0
  ...
  (= (let ((temp___258 (to__
     ...
     (let ((temp___257 (to_but_top
                       (mk___rep
                       (mk___split_fields s__split_fields s__split_fields1)))))
     (bool_eq2 (elts temp___257) (to_rep1 (first (rt temp___257)))
     (to_rep1 (last (rt temp___257))) (elts temp___258)
     (to_rep1 (first (rt temp___258))) (to_rep1 (last (rt temp___258)))))) true)))
(check-sat)
