...
(declare-fun use_ordered_sets__move_4__cu__assume () count_type)

(declare-fun temp___815 () count_type)

(declare-fun temp___8151 () us_main_type)

(declare-fun temp___814 () count_type)

(declare-fun o () Int)

(declare-fun temp___813 () count_type)
...
(define-fun temp___8131 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___813)))

(define-fun use_ordered_sets__move_4__cu__assume1 () us_rep1 (mk___rep1
                                                             (mk___split_fields1
                                                             use_ordered_sets__move_4__cu__assume)))
...
;; H
  (assert
  (and
  (= use_ordered_sets__move_4__cu__assume1 (first
                                           (mk___rep s1__split_discrs
                                           (mk___split_fields
                                           s1__split_fields))))
  (ite (= (= (length
             (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) 0) true)
  (= (bool_eq3 use_ordered_sets__move_4__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
     use_ordered_sets__move_4__cu__assume1) true)
  (= (get1
     (positions
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
     use_ordered_sets__move_4__cu__assume1) 1)))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= (mk___split_discrs temp___815) s2__split_discrs)
  (= temp___8151 s2__split_fields))))

;; H
  (assert (=> (= result1 true) (= temp___814 cu__split_fields1)))
...
;; H
  ...
  (= (get (elements (mk___rep s2__split_discrs s2__split_fields9)) i) 
  (get
  (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
  i))))))
...
;; H
  ...
  (= (bool_eq3 temp___8131 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
...
;; H
  (assert
  (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___813))))
...
(assert
;; WP_parameter_def
 ;; File "use_ordered_sets.ads", line 66, characters 0-0
  (not
  (= (oeq2
     (model__
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
