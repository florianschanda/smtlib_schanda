...
(declare-fun v5__split_fields () integer)

(declare-fun v5__split_fields1 () us_private)

(declare-fun v6__split_fields () integer)

(declare-fun v6__split_fields1 () integer)

(declare-fun v6__split_fields2 () us_private)
...
;; H
  (assert
  (<= 0 (object__size5
        (mk___rep2 (mk___split_fields2 v5__split_fields v5__split_fields1)
        v5__attr__tag))))
...
;; WP_parameter_def
 ;; File "size_attr.adb", line 3, characters 0-0
  ...
  (<= 0 (object__size6
        (mk___rep3
        (mk___split_fields3 v6__split_fields v6__split_fields1
        v6__split_fields2) v6__attr__tag)))))
(check-sat)
