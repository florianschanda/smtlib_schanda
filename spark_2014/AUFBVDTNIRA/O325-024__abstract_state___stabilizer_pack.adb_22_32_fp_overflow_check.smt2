...
;; H
  (assert
  (and (= o (sub RNE1 fliteral asl_alpha)) (tqtisFinite
  (sub RNE1 fliteral asl_alpha))))

;; H
  (assert (= o1 (mul RNE1 asl_raw o)))
...
;; H
  (assert
  (and (= o3 (mul RNE1 asl asl_alpha)) (tqtisFinite
  (mul RNE1 asl asl_alpha))))

;; H
  (assert (= o4 (add RNE1 o3 o2)))
...
;; H
  (assert
  (and (= o6 (sub RNE1 fliteral asl_alpha_long)) (tqtisFinite
  (sub RNE1 fliteral asl_alpha_long))))

;; H
  (assert (= o7 (mul RNE1 asl_raw o6)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (tqtisFinite (mul RNE1 asl_long asl_alpha_long))))
(check-sat)
