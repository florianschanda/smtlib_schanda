...
;; H
  (assert
  (and (= o6 (sub RNE2 fliteral asl_alpha_long)) (tqtisFinite
  (sub RNE2 fliteral asl_alpha_long))))

;; H
  (assert (= o7 (mul RNE2 asl_raw o6)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (tqtisFinite (mul RNE2 asl_long asl_alpha_long))))
(check-sat)
