...
;; H
  ...
  (model_is_well_formed o30 (map__content data6) first_available1) o30
...
;; H
  ...
  (model____function_guard o30 (map__content data6) first_available1))
...
;; H
  (assert (model_is_well_formed__function_guard
  (model_is_well_formed o28 (map__content data6) first_available1) o28
  (map__content data6) first_available1))

;; H
  (assert (model_is_well_formed__function_guard
  (model_is_well_formed o29 (map__content data6) first_available1) o29
  (map__content data6) first_available1))
...
;; H
  ...
  (model____function_guard o28 (map__content data6) first_available1))
...
;; H
  ...
  (model____function_guard o29 (map__content data6) first_available1))
...
;; H
  (assert (and (= temp___312 (get o22 o27)) (in_range7 temp___312)))
