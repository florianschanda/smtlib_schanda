...
(declare-fun temp___496 () (Array (_ BitVec 64) unsigned8))

(declare-fun temp___493 () (_ BitVec 64))

(declare-fun temp___492 () (Array (_ BitVec 64) unsigned8))

(declare-fun temp___491 () (_ BitVec 64))
...
(declare-fun temp___495 () (_ BitVec 64))
...
;; H
  (assert (= temp___494 rbx))

;; H
  (assert (= temp___496 memory))

;; H
  (assert (= temp___493 rsp))

;; H
  (assert (= temp___492 memory))

;; H
  (assert (= temp___491 xmm2))

;; H
  (assert (= temp___490 xmm1))

;; H
  (assert (= temp___489 rax))

;; H
  (assert (= temp___488 xmm0))

;; H
  (assert (= temp___487 rdi))

;; H
  (assert (= temp___495 rsp))

;; H
  (assert (= temp___486 zeroflag))

;; H
  (assert (= rsp1 temp___495))
...
;; H
  ...
  (= (to_rep (select memory1 i)) (to_rep (select temp___496 i)))))))
