...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__init_concurrent__wrong_initT__v natural)))))
(define-fun us_split_fields_V__projection ((a us_split_fields)) natural 
...
(declare-fun init_concurrent__wrong_initT__v__first__bit () Int)

(declare-fun init_concurrent__wrong_initT__v__last__bit () Int)

(declare-fun init_concurrent__wrong_initT__v__position () Int)
