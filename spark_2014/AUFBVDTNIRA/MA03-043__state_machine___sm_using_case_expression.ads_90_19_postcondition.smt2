...
;; H
  (assert
  (forall ((state21 Int) (trigger1 Int)) (my_sm__function_guard
  (my_sm state21 trigger1) state21 trigger1)))
...
;; H
  (assert (get_state__function_guard (get_state state3) state3))

;; H
  (assert (get_state__function_guard (get_state state4) state4))

;; H
  (assert (get_state__function_guard (get_state state5) state5))

;; H
  (assert (get_state__function_guard (get_state state6) state6))

;; H
  (assert (get_state__function_guard (get_state state7) state7))
...
;; H
  (assert (get_state__function_guard (get_state (int__content state8))
  (int__content state8)))

;; H
  (assert (get_state__function_guard (get_state state) state))

;; H
  (assert (get_state__function_guard (get_state state) state))

;; H
  (assert (my_sm__function_guard (my_sm (get_state state) trigger)
  (get_state state) trigger))
