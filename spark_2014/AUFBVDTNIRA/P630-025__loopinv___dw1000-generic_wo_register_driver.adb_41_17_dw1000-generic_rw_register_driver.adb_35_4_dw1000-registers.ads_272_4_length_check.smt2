...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__ack_resp_t_type__w4d_tim bits_20)(rec__dw1000__register_types__ack_resp_t_type__ack_tim bits_8)(rec__dw1000__register_types__ack_resp_t_type__reserved bits_4)))))
(define-fun us_split_fields_W4D_TIM__projection ((a us_split_fields)) bits_20 
  (rec__dw1000__register_types__ack_resp_t_type__w4d_tim a))

(define-fun us_split_fields_ACK_TIM__projection ((a us_split_fields)) bits_8 
  (rec__dw1000__register_types__ack_resp_t_type__ack_tim a))

(define-fun us_split_fields_Reserved2__projection ((a us_split_fields)) bits_4 
  (rec__dw1000__register_types__ack_resp_t_type__reserved a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_21__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_21__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))
...
(define-fun bool_eq7 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (and
                        (= (to_rep3
                           (rec__dw1000__register_types__ack_resp_t_type__w4d_tim
                           (us_split_fields1 a))) (to_rep3
                                                  (rec__dw1000__register_types__ack_resp_t_type__w4d_tim
                                                  (us_split_fields1 b))))
                        (= (to_rep1
                           (rec__dw1000__register_types__ack_resp_t_type__ack_tim
                           (us_split_fields1 a))) (to_rep1
                                                  (rec__dw1000__register_types__ack_resp_t_type__ack_tim
                                                  (us_split_fields1 b)))))
                        (= (to_rep2
                           (rec__dw1000__register_types__ack_resp_t_type__reserved
...
(declare-fun dw1000__register_types__ack_resp_t_type__w4d_tim__first__bit () Int)

(declare-fun dw1000__register_types__ack_resp_t_type__w4d_tim__last__bit () Int)

(declare-fun dw1000__register_types__ack_resp_t_type__w4d_tim__position () Int)

;; dw1000__register_types__ack_resp_t_type__w4d_tim__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__ack_resp_t_type__w4d_tim__first__bit))

;; dw1000__register_types__ack_resp_t_type__w4d_tim__last__bit_axiom
  (assert
  (< dw1000__register_types__ack_resp_t_type__w4d_tim__first__bit dw1000__register_types__ack_resp_t_type__w4d_tim__last__bit))

;; dw1000__register_types__ack_resp_t_type__w4d_tim__position_axiom
  (assert (<= 0 dw1000__register_types__ack_resp_t_type__w4d_tim__position))

(declare-fun dw1000__register_types__ack_resp_t_type__ack_tim__first__bit () Int)

(declare-fun dw1000__register_types__ack_resp_t_type__ack_tim__last__bit () Int)

(declare-fun dw1000__register_types__ack_resp_t_type__ack_tim__position () Int)

;; dw1000__register_types__ack_resp_t_type__ack_tim__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__ack_resp_t_type__ack_tim__first__bit))

;; dw1000__register_types__ack_resp_t_type__ack_tim__last__bit_axiom
  (assert
  (< dw1000__register_types__ack_resp_t_type__ack_tim__first__bit dw1000__register_types__ack_resp_t_type__ack_tim__last__bit))

;; dw1000__register_types__ack_resp_t_type__ack_tim__position_axiom
  (assert (<= 0 dw1000__register_types__ack_resp_t_type__ack_tim__position))

(declare-fun dw1000__register_types__ack_resp_t_type__reserved__first__bit () Int)

(declare-fun dw1000__register_types__ack_resp_t_type__reserved__last__bit () Int)

(declare-fun dw1000__register_types__ack_resp_t_type__reserved__position () Int)

;; dw1000__register_types__ack_resp_t_type__reserved__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__ack_resp_t_type__reserved__first__bit))

;; dw1000__register_types__ack_resp_t_type__reserved__last__bit_axiom
  (assert
  (< dw1000__register_types__ack_resp_t_type__reserved__first__bit dw1000__register_types__ack_resp_t_type__reserved__last__bit))

;; dw1000__register_types__ack_resp_t_type__reserved__position_axiom
  (assert (<= 0 dw1000__register_types__ack_resp_t_type__reserved__position))

(declare-fun dummy6 () us_rep)

(declare-datatypes ()
((ack_resp_t_type__ref
 (mk_ack_resp_t_type__ref (ack_resp_t_type__content us_rep)))))
(define-fun ack_resp_t_type__ref___projection ((a ack_resp_t_type__ref)) us_rep 
  (ack_resp_t_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_43__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_32__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_32__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3054 us_t1)
  (temp___is_init_3051 Bool) (temp___skip_constant_3052 Bool)
  (temp___do_toplevel_3053 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3052 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_3054)
                                       (last4 temp___expr_3054))
                                       (and (= (first3 temp___expr_3054) 1)
                                       (= (last4 temp___expr_3054) 4)))))
...
(define-fun target__ref_12__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_12__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_3072 us_t2)
  (temp___is_init_3069 Bool) (temp___skip_constant_3070 Bool)
  (temp___do_toplevel_3071 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3070 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_3072)
                                       (last6 temp___expr_3072))
                                       (and (= (first5 temp___expr_3072) 1)
                                       (= (last6 temp___expr_3072) 4)))))
...
(declare-fun temp___7639 () (Array Int bits_8))

(declare-fun temp___76391 () t2)

(declare-fun temp___7640 () (Array Int bits_8))

(declare-fun temp___76401 () t1)

(define-fun temp___76392 () us_t2 (mk___t2 temp___7639 temp___76391))
...
;; H
  (assert
  (and
  (and (= temp___76392 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___76392 reg)) (dynamic_invariant1
  temp___76392 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___76391)) (to_rep (last5 temp___76391)))
     (+ (- (to_rep (last5 temp___76391)) (to_rep (first4 temp___76391))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___7639 temp___7640))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76391)) (to_rep (last5 temp___76391))) 
  temp___76401))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___76401)) (to_rep (last3 temp___76401)))
     (+ (- (to_rep (last3 temp___76401)) (to_rep (first2 temp___76401))) 1)
