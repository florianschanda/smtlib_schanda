...
(define-fun tint_arrayD1__ref_13__projection ((a tint_arrayD1__ref)) integer 
...
(define-fun tint_arrayT__ref_13__projection ((a tint_arrayT__ref)) us_t1 
...
(declare-datatypes ()
((t486b__ref (mk_t486b__ref (t486b__content integer)))))
(define-fun t486b__ref___projection ((a t486b__ref)) integer (t486b__content
                                                             a))
...
(define-fun tnumber_array_typeD1__ref_22__projection ((a tnumber_array_typeD1__ref)) integer 
...
(define-fun number_array_type__ref_22__projection ((a number_array_type__ref)) us_t3 
...
(declare-datatypes ()
((t490b__ref (mk_t490b__ref (t490b__content integer)))))
(define-fun t490b__ref___projection ((a t490b__ref)) integer (t490b__content
                                                             a))
...
(declare-datatypes ()
((t492b__ref (mk_t492b__ref (t492b__content integer)))))
(define-fun t492b__ref___projection ((a t492b__ref)) integer (t492b__content
                                                             a))
...
(define-fun tint_arrayB__ref_13__projection ((a tint_arrayB__ref)) us_t5 
  (tint_arrayB__content a))

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__aggregate_def (Int
  Int Int Int Int Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___2259 Int) (temp___2260 Int) (temp___2261 Int)
  (temp___2262 Int) (temp___2263 Int) (temp___2264 Int) (temp___2265 Int))
  (let ((temp___2258 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__aggregate_def
                     temp___2259 temp___2260 temp___2261 temp___2262
                     temp___2263 temp___2264 temp___2265)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 6) (+ (first1 source) 10)
  temp___2264 temp___2265)
  (and (= (first7 temp___2258) temp___2264)
  (= (last7 temp___2258) temp___2265)))
  (and
  (and
  (and
  (and
  (= (select (to_array2 temp___2258) (+ (+ (first1 source) 6) 0)) (of_rep1
                                                                  temp___2259))
  (= (select (to_array2 temp___2258) (+ (+ (first1 source) 6) 1)) (of_rep1
                                                                  temp___2260)))
  (= (select (to_array2 temp___2258) (+ (+ (first1 source) 6) 2)) (of_rep1
                                                                  temp___2261)))
  (= (select (to_array2 temp___2258) (+ (+ (first1 source) 6) 3)) (of_rep1
                                                                  temp___2262)))
  (= (select (to_array2 temp___2258) (+ (+ (first1 source) 6) 4)) (of_rep1
                                                                  temp___2263)))))))
...
(define-fun tnumber_array_typeB__ref_22__projection ((a tnumber_array_typeB__ref)) us_t6 
  (tnumber_array_typeB__content a))

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__aggregate_def (Int
  Int Int) us_t4)

;; def_axiom
  (assert
  (forall ((temp___2271 Int) (temp___2272 Int) (temp___2273 Int))
  (let ((temp___2270 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__aggregate_def
                     temp___2271 temp___2272 temp___2273)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 6) (+ (first1 source) 10)
  temp___2272 temp___2273)
  (and (= (first13 temp___2270) temp___2272)
  (= (last13 temp___2270) temp___2273)))
  (forall ((temp___2274 Int))
  (= (select (to_array4 temp___2270) temp___2274) (of_rep1 temp___2271)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_710 us_t3)
  (temp___is_init_707 Bool) (temp___skip_constant_708 Bool)
  (temp___do_toplevel_709 Bool)) Bool (=>
                                      (not (= temp___skip_constant_708 true))
                                      (and (dynamic_property6
                                      (+ (first1 source) 6)
                                      (+ (first1 source) 10)
                                      (first10 temp___expr_710)
                                      (last10 temp___expr_710))
                                      (and
                                      (= (first10 temp___expr_710) (+ 
                                      (first1 source) 6))
                                      (= (last10 temp___expr_710) (+ 
...
(declare-fun temp___2268 () (Array Int integer))

(declare-fun temp___22681 () t2)

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__assume1 () t1)

(declare-fun temp___2276 () (Array Int integer))

(declare-fun temp___22761 () t4)

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__assume1 () t3)

(declare-fun temp___2282 () Int)

(declare-fun temp___2283 () Int)

(declare-fun temp___2281 () Int)

(declare-fun temp___2279 () (Array Int integer))
...
;; H
  ...
  (forall ((index7 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 6) index7)
...
;; H
  ...
  (= (to_rep1
     (first6
     (rt2
     (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__aggregate_def
     7 9 9 9 9 (+ (to_rep1 (first (rt source))) 6)
     (+ (+ (to_rep1 (first (rt source))) 6) 4))))) (+ (to_rep1
                                                      (first (rt source))) 6)))
...
;; H
  (assert
  (= (mk___t2 temp___2268 temp___22681) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__aggregate_def
                                        7 9 9 9 9
                                        (+ (to_rep1 (first (rt source))) 6)
                                        (+ (+ (to_rep1 (first (rt source))) 6) 4))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___22681)) (to_rep1 (last6 temp___22681)))
     (+ (- (to_rep1 (last6 temp___22681)) (to_rep1 (first6 temp___22681))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1
                                                        (first (rt source))) 10))
...
;; H
  (assert
  (= (slide1 temp___2268 (to_rep1 (first6 temp___22681))
     (+ (to_rep1 (first (rt source))) 6)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__assume))

;; H
  (assert
  (= (mk1 (+ (to_rep1 (first (rt source))) 6)
     (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__assume1))
...
;; H
  (assert
  (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__assume))

;; H
  (assert
  (= (to_rep1 int_array__first) (to_rep1
                                (first3
                                aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__assume1))))
...
;; H
  (assert
  (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 6)
  (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first)
  (to_rep1 int_array__last))
  (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 6))
...
;; H
  ...
  (= (to_rep1
     (first12
     (rt4
     (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__aggregate_def
     0 (+ (to_rep1 (first (rt source))) 6)
     (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1
                                                 (first (rt source))) 6)))
...
;; H
  (assert
  (= (mk___t4 temp___2276 temp___22761) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 6)
                                        (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___22761)) (to_rep1
                                               (last12 temp___22761)))
     (+ (- (to_rep1 (last12 temp___22761)) (to_rep1 (first12 temp___22761))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1
                                                        (first (rt source))) 10))
        (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1
                                                      (first (rt source))) 6)) 1)
...
;; H
  (assert
  (= (slide1 temp___2276 (to_rep1 (first12 temp___22761))
     (+ (to_rep1 (first (rt source))) 6)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__assume))

;; H
  (assert
  (= (mk3 (+ (to_rep1 (first (rt source))) 6)
     (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__assume1))
...
;; H
  (assert
  (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__assume))

;; H
  (assert
  (= (to_rep1 n__first) (to_rep1
                        (first9
                        aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__assume1))))
...
;; H
  (assert
  (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 6)
  (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last))
  (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 6))
...
;; H
  (assert
  (and (= temp___2282 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (= temp___2283 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))
...
;; H
  (assert (= index1 temp___2282))

;; H
  (assert
  (=> (and (<= temp___2282 index1) (<= index1 temp___2283))
  (= temp___2281 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2282 index1) (<= index1 temp___2283)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___2282 index1) (<= index1 temp___2283)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2282 index1) (<= index1 temp___2283)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2282 index1) (<= index1 temp___2283)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___2282 index1) (<= index1 temp___2283)) (= n2 o8)))

;; H
  (assert
  (=> (and (<= temp___2282 index1) (<= index1 temp___2283))
  (forall ((i Int))
  (=> (and (<= (+ (to_rep1 (first (rt source))) 6) i) (<= i index2))
...
;; H
  ...
  (=> (and (<= temp___2282 index1) (<= index1 temp___2283))
  (forall ((j Int))
  (=> (and (<= (+ (to_rep1 (first (rt source))) 6) j) (<= j index2))
...
;; H
  ...
  (and
  (and
  (forall ((temp___2280 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___2280)
  (<= temp___2280 (to_rep1 n__last)))
  (=> (< index2 temp___2280)
  (= (select n3 temp___2280) (select temp___2279 temp___2280)))))
  (=>
  (<= (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10))
  (dynamic_property9 (+ (to_rep1 (first (rt source))) 6)
  (+ (to_rep1 (first (rt source))) 10) index2)))
  (and (<= (+ (to_rep1 (first (rt source))) 6) index2)
...
;; H
  (assert
  (=> (and (<= temp___2282 index1) (<= index1 temp___2283)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___2282 index1) (<= index1 temp___2283)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___2282 index1) (<= index1 temp___2283)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___2282 index1) (<= index1 temp___2283)))
...
;; H
  (assert
  (=> (not (and (<= temp___2282 index1) (<= index1 temp___2283))) (= n7 n1)))
...
;; H
  (assert
  (and (= temp___2284 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2284)
  (<= temp___2284 (to_rep1 n__last))))

;; H
  (assert (= o9 temp___2284))
...
;; H
  (assert
  (and (= temp___2285 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2285)
  (<= temp___2285 (to_rep1 n__last))))

;; H
  (assert (= o14 temp___2285))
...
;; H
  (assert
  (and (= temp___2286 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2286)
  (<= temp___2286 (to_rep1 n__last))))

;; H
  (assert (= o21 temp___2286))
...
;; H
  (assert
  (and (= temp___2287 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2287)
  (<= temp___2287 (to_rep1 n__last))))

;; H
  (assert (= o28 temp___2287))
...
;; H
  (assert
  (and (= temp___2288 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2288)
  (<= temp___2288 (to_rep1 n__last))))

;; H
  (assert (= o35 temp___2288))
...
(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 1487, characters 0-0
  (not (<= (- 79999) target5)))
(check-sat)
