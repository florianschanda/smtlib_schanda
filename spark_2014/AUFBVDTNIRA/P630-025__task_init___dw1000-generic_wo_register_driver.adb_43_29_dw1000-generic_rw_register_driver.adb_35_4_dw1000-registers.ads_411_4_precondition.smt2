...
(define-fun dynamic_invariant ((temp___expr_4977 us_t1)
  ...
  (temp___do_toplevel_4976 Bool)) Bool (=>
                                       ...
                                       (last3 temp___expr_4977))
                                       (and (= (first3 temp___expr_4977) 1)
                                       (= (last3 temp___expr_4977) 2)))))
...
(define-fun dynamic_invariant1 ((temp___expr_4993 us_t2)
  ...
  (temp___do_toplevel_4992 Bool)) Bool (=>
                                       ...
                                       (last5 temp___expr_4993))
                                       (and (= (first5 temp___expr_4993) 1)
                                       (= (last5 temp___expr_4993) 2)))))
...
;; H
  (assert
  (and (= temp___78202 (register_to_bytes reg)) (dynamic_invariant1
  temp___78202 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___78201)) (to_rep (last4 temp___78201)))
     (+ (- (to_rep (last4 temp___78201)) (to_rep (first4 temp___78201))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78201)) (to_rep (last4 temp___78201))) 
  temp___78211))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___78211)) (to_rep (last2 temp___78211)))
     (+ (- (to_rep (last2 temp___78211)) (to_rep (first2 temp___78211))) 1)
