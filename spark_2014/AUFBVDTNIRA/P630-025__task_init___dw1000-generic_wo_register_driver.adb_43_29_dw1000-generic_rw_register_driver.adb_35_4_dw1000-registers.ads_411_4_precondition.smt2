...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__drx_pretoc_type__drx_pretoc bits_16)))))
(define-fun us_split_fields_DRX_PRETOC__projection ((a us_split_fields)) bits_16 
  (rec__dw1000__register_types__drx_pretoc_type__drx_pretoc a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_51__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_51__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq6 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__drx_pretoc_type__drx_pretoc
...
(declare-fun dw1000__register_types__drx_pretoc_type__drx_pretoc__first__bit () Int)

(declare-fun dw1000__register_types__drx_pretoc_type__drx_pretoc__last__bit () Int)

(declare-fun dw1000__register_types__drx_pretoc_type__drx_pretoc__position () Int)

;; dw1000__register_types__drx_pretoc_type__drx_pretoc__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__drx_pretoc_type__drx_pretoc__first__bit))

;; dw1000__register_types__drx_pretoc_type__drx_pretoc__last__bit_axiom
  (assert
  (< dw1000__register_types__drx_pretoc_type__drx_pretoc__first__bit 
  dw1000__register_types__drx_pretoc_type__drx_pretoc__last__bit))

;; dw1000__register_types__drx_pretoc_type__drx_pretoc__position_axiom
  (assert
  (<= 0 dw1000__register_types__drx_pretoc_type__drx_pretoc__position))

(declare-fun dummy5 () us_rep)

(declare-datatypes ()
((drx_pretoc_type__ref
 (mk_drx_pretoc_type__ref (drx_pretoc_type__content us_rep)))))
(define-fun drx_pretoc_type__ref___projection ((a drx_pretoc_type__ref)) us_rep 
  (drx_pretoc_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_120__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_85__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_85__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_4977 us_t1)
  (temp___is_init_4974 Bool) (temp___skip_constant_4975 Bool)
  (temp___do_toplevel_4976 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_4975 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_4977)
                                       (last4 temp___expr_4977))
                                       (and (= (first3 temp___expr_4977) 1)
                                       (= (last4 temp___expr_4977) 2)))))
...
(define-fun target__ref_36__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_36__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_4993 us_t2)
  (temp___is_init_4990 Bool) (temp___skip_constant_4991 Bool)
  (temp___do_toplevel_4992 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_4991 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_4993)
                                       (last6 temp___expr_4993))
                                       (and (= (first5 temp___expr_4993) 1)
                                       (= (last6 temp___expr_4993) 2)))))
...
(declare-fun temp___7820 () (Array Int bits_8))

(declare-fun temp___78201 () t2)

(declare-fun temp___7821 () (Array Int bits_8))

(declare-fun temp___78211 () t1)
...
(define-fun temp___78202 () us_t2 (mk___t2 temp___7820 temp___78201))
...
;; H
  (assert
  (and
  (and (= temp___78202 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___78202 reg)) (dynamic_invariant1
  temp___78202 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___78201)) (to_rep (last5 temp___78201)))
     (+ (- (to_rep (last5 temp___78201)) (to_rep (first4 temp___78201))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___7820 temp___7821))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78201)) (to_rep (last5 temp___78201))) 
  temp___78211))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___78211)) (to_rep (last3 temp___78211)))
     (+ (- (to_rep (last3 temp___78211)) (to_rep (first2 temp___78211))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7821 temp___78211)))
