...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3680 o7))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3680 o7)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o7))
...
;; H
  (assert (= o8 (select temp___3680 l)))
...
;; H
  ...
  (and
  (and
  (= o5 (size (rec__search_trees__search_tree__struct (us_split_fields7 t))))
  (size__function_guard o5
...
;; H
  (assert
  (and
  (= o2 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
...
;; H
  ...
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o2))
  (=>
  (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) 
  o2) (not (= result6 true)))))
...
;; H
  (assert (position__function_guard
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1))

;; H
  (assert (parent__function_guard
  (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1))
...
;; H
  ...
  (and
  (and
  (= o1 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) 
        l d))
  (peek__function_guard o1
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3638 o))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3638 o)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o))
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3638 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
