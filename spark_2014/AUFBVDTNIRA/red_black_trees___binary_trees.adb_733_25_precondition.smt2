...
;; H
  (assert (=> (and (<= 1 r2) (<= r2 r246b)) (= temp___1627 r2)))
...
;; H
  ...
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___1667 (parent
                              ...
                              f__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1667 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1667 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1667 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1667 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1667 j)))) true))
  (= j i))))))))))))))
