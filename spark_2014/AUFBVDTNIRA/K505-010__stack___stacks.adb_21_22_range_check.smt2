...
(define-fun dynamic_invariant1 ((temp___expr_154 us_rep)
...
;; size__def_axiom
  ...
  (forall ((s us_rep))
  (! (=>
     (and (dynamic_invariant1 s true true true) (size__function_guard
     (size s) s))
...
(assert
;; WP_parameter_def
 ;; File "stacks.ads", line 21, characters 0-0
