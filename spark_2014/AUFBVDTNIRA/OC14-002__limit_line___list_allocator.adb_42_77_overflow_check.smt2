...
;; H
  ...
  (and
  (and (= o8 (length model____split_fields)) (length__function_guard 
  o8 model____split_fields)) (in_range6 o8))))

;; H
  (assert
  (=> (not (= first_available 0)) (= result2 (ite (< 0 o8) true false))))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (and (= o7 (get model____split_fields 1)) (get__function_guard o7
  model____split_fields 1)) (in_range7 o7)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result2 true) (= result1 (ite (= o7 first_available) true false)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (= result2 true)) (= result1 false))))

;; H
  (assert
  (=> (not (not (= first_available 0)))
  (and
  (and (= o9 (length model____split_fields)) (length__function_guard 
  o9 model____split_fields)) (in_range6 o9))))

;; H
  (assert
  (=> (not (not (= first_available 0)))
  (= result1 (ite (= o9 0) true false))))
...
;; H
  ...
  (and
  (and (= o5 (length model____split_fields1)) (length__function_guard 
  o5 model____split_fields1)) (in_range6 o5)))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o5) true false)))))
...
;; H
  ...
  (=> (= result3 true)
  (and
  (and (= o4 (get model____split_fields1 1)) (get__function_guard o4
  model____split_fields1 1)) (in_range7 o4))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_allocated 0))
  (=> (= result3 true) (= result (ite (= o4 first_allocated) true false))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_allocated 0))
  (=> (not (= result3 true)) (= result false)))))
...
;; H
  ...
  (and
  (and (= o6 (length model____split_fields1)) (length__function_guard 
  o6 model____split_fields1)) (in_range6 o6)))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (not (= first_allocated 0))) (= result (ite (= o6 0) true false)))))
...
;; H
  (assert
  (and
  (and (= o3 (get model____split_fields j)) (get__function_guard o3
  model____split_fields j)) (in_range7 o3)))

;; H
  (assert (= result5 (ite (in_range4 o3) true false)))
...
;; H
  (assert
  (and
  (and (= o2 (length model____split_fields)) (length__function_guard 
  o2 model____split_fields)) (in_range6 o2)))
