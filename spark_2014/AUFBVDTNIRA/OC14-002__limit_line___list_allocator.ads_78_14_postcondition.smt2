...
(declare-fun prev_alloc () Int)

(declare-fun next_alloc () Int)
...
(declare-fun o28 () resource)

(declare-fun o29 () status)
...
(declare-fun o39 () status)

(declare-fun o40 () resource)

(declare-fun o41 () resource)

(declare-fun o42 () status)

(declare-fun o43 () resource)

(declare-fun o44 () resource)

(declare-fun o45 () Int)

(declare-fun o46 () (Array Int us_rep))

(declare-fun o47 () resource)
...
(declare-fun prev_alloc1 () Int)

(declare-fun next_alloc1 () Int)

(declare-fun result () Bool)

(declare-fun result1 () int__ref)

(declare-fun prev_alloc2 () Int)

(declare-fun result2 () int__ref)

(declare-fun next_alloc2 () Int)
...
(declare-fun prev_alloc3 () int__ref)

(declare-fun next_alloc3 () int__ref)
...
(declare-fun prev_alloc4 () Int)

(declare-fun next_alloc4 () Int)
...
;; H
  ...
  (is_prepend (rec__list_allocator__m__t__available model____split_fields3)
  res o56) (rec__list_allocator__m__t__available model____split_fields3) 
  res o56))
...
;; H
  ...
  (rec__list_allocator__m__t__available
  (us_split_fields__content1 model____split_fields5))) model____split_fields
  res
  (rec__list_allocator__m__t__available
  (us_split_fields__content1 model____split_fields5))))
...
;; H
  (assert
  (forall ((j Int)) (get__function_guard (get model____split_fields1 j)
  model____split_fields1 j)))
...
;; H
  (assert
  (forall ((j Int)) (mem__function_guard
  (mem
  (rec__list_allocator__m__t__allocated
  (us_split_fields__content1 model____split_fields5))
  (get model____split_fields1 j))
  (rec__list_allocator__m__t__allocated
  (us_split_fields__content1 model____split_fields5))
  (get model____split_fields1 j))))
...
;; H
  (assert (oeq__function_guard2
  (oeq2 (mk___rep1 (us_split_fields__content1 model____split_fields5))
  (mk___rep1
  (mk___split_fields1 model____split_fields model____split_fields1)))
  (mk___rep1 (us_split_fields__content1 model____split_fields5))
  (mk___rep1
  (mk___split_fields1 model____split_fields model____split_fields1))))
...
;; H
  (assert
  (=> (= result true)
  (= (mk___rep (mk___split_fields o10 o11 o12)) (select data o9))))
...
;; H
  (assert
  (=> (= result true)
  (= (mk___rep (mk___split_fields o19 o20 o21)) (select data o18))))
...
;; H
  (assert (=> (= result true) (= (to_rep o28) 0)))

;; H
  (assert (=> (= result true) (= (to_rep1 o29) 0)))

;; H
  (assert (=> (= result true) (= o29 o30)))

;; H
  (assert (=> (= result true) (= o28 o31)))

;; H
  (assert (=> (= result true) (= o27 o32)))
...
;; H
  (assert (=> (= result true) (= o35 o32)))

;; H
  (assert (=> (= result true) (and (<= 1 res) (<= res 3))))

;; H
  (assert (=> (= result true) (= o36 res)))

;; H
  (assert
  (=> (= result true)
  (= o37 (store data o36 (mk___rep (mk___split_fields o33 o34 o35))))))

;; H
  (assert (=> (= result true) (= result3 (mk_map__ref data))))

;; H
  (assert (=> (= result true) (= data2 o37)))

;; H
  (assert
  (=> (= result true)
  (=> (not (= prev_alloc2 0)) (= (to_rep o38) next_alloc2))))
...
;; H
  ...
  (=> (not (= prev_alloc2 0))
  (= (rec__list_allocator__cell__stat
     (us_split_fields1 (select data2 prev_alloc2))) o39))))
...
;; H
  ...
  (=> (not (= prev_alloc2 0))
  (= (rec__list_allocator__cell__prev
     (us_split_fields1 (select data2 prev_alloc2))) o40))))

;; H
  (assert (=> (= result true) (=> (not (= prev_alloc2 0)) (= o38 o41))))
...
;; H
  (assert (=> (= result true) (=> (not (= prev_alloc2 0)) (= o44 o41))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= prev_alloc2 0)) (and (<= 1 prev_alloc2) (<= prev_alloc2 3)))))

;; H
  (assert
  (=> (= result true) (=> (not (= prev_alloc2 0)) (= o45 prev_alloc2))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= prev_alloc2 0))
  (= o46 (store data2 o45 (mk___rep (mk___split_fields o42 o43 o44)))))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= prev_alloc2 0)) (= result4 (mk_map__ref data2)))))

;; H
  (assert (=> (= result true) (=> (not (= prev_alloc2 0)) (= data3 o46))))

;; H
  (assert
  (=> (= result true) (=> (not (not (= prev_alloc2 0))) (= data3 data2))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= next_alloc2 0)) (= (to_rep o47) prev_alloc2))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= next_alloc2 0))
  (= o48 (mk___split_fields
         (rec__list_allocator__cell__stat
         (us_split_fields1 (select data3 next_alloc2))) o47
         (rec__list_allocator__cell__next
         (us_split_fields1 (select data3 next_alloc2))))))))

;; H
  (assert
  (=> (= result true) (=> (not (= next_alloc2 0)) (= o49 (mk___rep o48)))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= next_alloc2 0)) (and (<= 1 next_alloc2) (<= next_alloc2 3)))))

;; H
  (assert
  (=> (= result true) (=> (not (= next_alloc2 0)) (= o50 next_alloc2))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= next_alloc2 0)) (= o51 (store data3 o50 o49)))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= next_alloc2 0)) (= result5 (mk_map__ref data3)))))

;; H
  (assert (=> (= result true) (=> (not (= next_alloc2 0)) (= data4 o51))))

;; H
  (assert
  (=> (= result true) (=> (not (not (= next_alloc2 0))) (= data4 data3))))
...
;; H
  (assert
  (=> (= result true)
  (=> (= res first_allocated) (= result7 (mk_int__ref first_allocated)))))

;; H
  (assert
  (=> (= result true)
  (=> (= res first_allocated) (= first_allocated2 next_alloc2))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= res first_allocated)) (= first_allocated2 first_allocated))))
...
;; H
  ...
  (= (get model____split_fields1 o52) res)) (= o52 0))))))

;; H
  (assert (=> (= result true) (and (= o53 o52) (in_range2 o52))))
...
;; H
  (assert
  (=> (= result true) (= o55 (mk___split_fields1 model____split_fields o54))))

;; H
  (assert (=> (= result true) (= temp___795 (mk___rep1 o55))))
...
;; H
  (assert
  (=> (= result true)
  (= model____split_fields3 (us_split_fields3 temp___795))))
...
;; H
  ...
  (rec__list_allocator__m__t__available model____split_fields3) res))
  (= (is_prepend
     (rec__list_allocator__m__t__available model____split_fields3) res 
     o56) true))))
...
;; H
  (assert
  (=> (= result true)
  (= o57 (mk___split_fields1 o56
         (rec__list_allocator__m__t__allocated model____split_fields3)))))

;; H
  (assert (=> (= result true) (= temp___797 (mk___rep1 o57))))
...
;; H
  (assert
  (=> (= result true)
  (= model____split_fields4 (us_split_fields3 temp___797))))
...
;; H
  (assert
  (=> (= (mem model____split_fields1 res) true)
  (and
  (and
  (= (is_prepend model____split_fields res
     (rec__list_allocator__m__t__available
     (us_split_fields__content1 model____split_fields5))) true)
  (= (length
     (rec__list_allocator__m__t__allocated
     (us_split_fields__content1 model____split_fields5))) (- (length
                                                             model____split_fields1) 1)))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (length model____split_fields1)))
  (=> (not (= (get model____split_fields1 j) res))
  (= (mem
     (rec__list_allocator__m__t__allocated
     (us_split_fields__content1 model____split_fields5))
     (get model____split_fields1 j)) true)))))))

;; H
  (assert
  (=> (not (= (mem model____split_fields1 res) true))
  (= (oeq2 (mk___rep1 (us_split_fields__content1 model____split_fields5))
     (mk___rep1
...
;; H
  (assert (is_valid__function_guard
  (is_valid (us_split_fields__content1 model____split_fields5)
  (map__content data5) (int__content first_available3)
  (int__content first_allocated3))
  (us_split_fields__content1 model____split_fields5) (map__content data5)
  (int__content first_available3) (int__content first_allocated3)))
...
;; WP_parameter_def
 ;; File "list_allocator.ads", line 30, characters 0-0
  ...
  (= (is_valid (us_split_fields__content1 model____split_fields5)
     (map__content data5) (int__content first_available3)
     (int__content first_allocated3)) true)))
(check-sat)
