...
(declare-fun temp___676 () us_rep3)
...
;; H
  (assert
  (and (= temp___676 (keys (mk___rep r__split_discrs r__split_fields2)))
  (and
  (and
  (and
  (= (length3 temp___676) (length
                          (mk___rep r__split_discrs r__split_fields2)))
  (forall ((temp___396 Int))
  (=>
  (and (in_range3 temp___396)
  (= (iter_has_element temp___676 temp___396) true))
  (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2))
     (get temp___676 temp___396)) true))))
  (forall ((key2 Int))
  (=>
  (and (in_range2 key2)
  (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key2) true))
  (and (< 0 (find temp___676 key2))
  (= (equivalent_keys (get temp___676 (find temp___676 key2)) key2) true)))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep r__split_discrs r__split_fields2))))
  (and (= (find temp___676 (get temp___676 i1)) i1)
  (= (k_is_find temp___676 (get temp___676 i1) i1) true)))))))

;; H
  (assert
  (and (= o (iter_has_element temp___676 temp___675))
  (= (= o true) (and (<= 1 temp___675) (<= temp___675 (last temp___676))))))

;; H
  (assert (= (= o1 true) (in_range3 temp___675)))
...
;; H
  (assert (and (= k (get temp___676 temp___675)) (in_range4 k)))
