...
(declare-fun temp___1236 () (Array Int us_rep1))
...
;; H
  ...
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1238 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1238 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___1238 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 root))
  (model____function_guard temp___1238
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root))
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1238 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o42 (select temp___1238 j)))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1236 (parent
                      (mk___rep2
                      (mk___split_fields2 f__split_fields f__split_fields1))
                      i1))))
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1236 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1236 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___1236 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 root))
  (model____function_guard temp___1236
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root))
  (and (dynamic_invariant3 temp___1236 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1236 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1236 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___1236 (parent
                              ...
                              f__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1236 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1236 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1236 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1236 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1236 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1236 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= o44 (select temp___1236 j)))
