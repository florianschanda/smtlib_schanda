...
;; H
  ...
  (= o3 (rolepresent
        (mk___rep
        (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (rolepresent__function_guard o3
  (mk___rep
  (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (in_range1 o3)))
...
;; H
  ...
  (rolepresent__function_guard o4
...
;; H
  (assert
  (=> (= (int__content status4) 3) (= o2 (ite (not (= o1 true)) true false))))

;; H
  (assert (=> (not (= (int__content status4) 3)) (= o2 (of_int 1))))

;; H
  (assert
  (=> (not (= (int__content status4) 6)) (= (int__content status4) 7)))
