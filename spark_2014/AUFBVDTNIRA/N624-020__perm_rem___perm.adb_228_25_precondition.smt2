...
;; H
  (assert (is_perm__function_guard (is_perm o25 o27) o25 o27))
...
;; H
  (assert
  (and (and (= o26 (remove a o10)) (remove__function_guard o26 a o10))
...
;; H
  (assert
  (and (and (= o25 (remove o26 o13)) (remove__function_guard o25 o26 o13))
...
;; H
  (assert
  (and (and (= o27 (remove bb ib1)) (remove__function_guard o27 bb ib1))
...
;; H
  (assert
  (and (and (= o28 (remove aa o5)) (remove__function_guard o28 aa o5))
...
;; H
  (assert
  (and
  (and (= o16 (shift_perm_l o28 o27 o25)) (shift_perm_l__function_guard 
  o16 o28 o27 o25))
...
;; H
  (assert
  (and (and (= o24 (remove b ib1)) (remove__function_guard o24 b ib1))
...
;; H
  (assert
  (and (and (= o23 (remove o24 o20)) (remove__function_guard o23 o24 o20))
