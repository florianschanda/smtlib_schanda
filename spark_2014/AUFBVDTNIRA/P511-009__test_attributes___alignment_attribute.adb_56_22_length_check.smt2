...
(define-fun bool_eq3 ((x1 us_t)
  (y us_t)) Bool (bool_eq2 (elts x1) (to_rep (first (rt x1)))
                 (to_rep (last1 (rt x1))) (elts y) (to_rep (first (rt y)))
                 (to_rep (last1 (rt y)))))
...
(define-fun bool_eq5 ((a (Array Int us_t)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq3 (select a temp___idx_135)
                              (select b (+ (- b__first a__first) temp___idx_135))) true))))
                      true false))
...
(declare-fun dummy4 () (Array Int us_t))
...
(declare-fun user_eq4 ((Array Int us_t) (Array Int us_t)) Bool)

(define-fun dynamic_invariant1 ((temp___expr_233 (Array Int us_t))
  ...
  (temp___do_toplevel_232 Bool)) Bool (forall ((temp___234 Int))
                                      ...
                                      (first1
                                      (select temp___expr_233 temp___234))
                                      (last2
                                      (select temp___expr_233 temp___234)))
                                      (and
                                      (= (first1
                                         (select temp___expr_233 temp___234)) 1)
                                      (= (last2
                                         (select temp___expr_233 temp___234)) 
                                      x))))))
...
(define-fun bool_eq7 ((x1 us_t1)
  (y us_t1)) Bool (bool_eq2 (elts1 x1) (to_rep (first2 (rt1 x1)))
                  (to_rep (last4 (rt1 x1))) (elts1 y)
...
(define-fun in_range2 ((x1 Int)) Bool (and (<= 1 x1) (<= x1 1)))
...
(declare-fun user_eq7 (t24b t24b) Bool)

(declare-fun dummy7 () t24b)
...
(define-fun bool_eq9 ((x1 us_t2)
  (y us_t2)) Bool (bool_eq2 (elts2 x1) (to_rep (first4 (rt2 x1)))
                  (to_rep (last6 (rt2 x1))) (elts2 y)
...
;; def_axiom
  ...
  (let ((temp___266 (alignment_attribute__q__a1__aggregate_def temp___267
                    temp___268 temp___269)))
  (and
  (=> (dynamic_property4 1 x temp___268 temp___269)
  (and (= (first3 temp___266) temp___268) (= (last5 temp___266) temp___269)))
...
;; def_axiom
  (assert
  (forall ((temp___275 us_t))
  (forall ((temp___276 Int))
  (= (select (alignment_attribute__q__a2__aggregate_def temp___275) temp___276) temp___275))))

(define-fun dynamic_invariant2 ((temp___expr_224 us_t)
  ...
  (temp___do_toplevel_223 Bool)) Bool (=>
                                      ...
                                      (last2 temp___expr_224))
                                      (and (= (first1 temp___expr_224) 1)
                                      (= (last2 temp___expr_224) x)))))
...
;; H
  (assert
  (= (to_rep
     (first2 (rt1 (alignment_attribute__q__a1__aggregate_def 1 1 x)))) 1))

;; H
  (assert
  (= (to_rep (last4 (rt1 (alignment_attribute__q__a1__aggregate_def 1 1 x)))) 
  x))

;; H
  (assert
  (= (mk___t1 temp___272 temp___2721) (alignment_attribute__q__a1__aggregate_def
                                      1 1 x)))
...
;; WP_parameter_def
 ;; File "alignment_attribute.adb", line 47, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___2721)) (to_rep (last4 temp___2721)))
     (+ (- (to_rep (last4 temp___2721)) (to_rep (first2 temp___2721))) 1) 0) 
  (ite (<= 1 x) (+ (- x 1) 1) 0))))
(check-sat)
