...
;; H
  ...
  (= (bool_eq2 temp___4661 no_element) true)
  (and
...
;; H
  ...
  (= temp___4661 (previous (mk___rep l__split_discrs l__split_fields6)
                 (mk___rep1 (mk___split_fields1 cu__split_fields))))
  (ite (= (ite (= (bool_eq2 (mk___rep1 (mk___split_fields1 cu__split_fields))
...
;; H
  ...
  (= (length (mk___rep l__split_discrs l__split_fields5)) (- (length
                                                             ...
                                                             l__split_discrs
                                                             l__split_fields6)) 1))
  (= (bool_eq2 (mk___rep1 cu__split_fields5) no_element) true))
