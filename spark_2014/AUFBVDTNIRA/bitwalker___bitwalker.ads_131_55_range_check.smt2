...
(declare-fun bitwalker__lemmafunction2__result () Int)
...
(declare-fun bitwalker__lemmafunction2__result1 () Int)

(declare-fun bitwalker__lemmafunction2__result2 () Int)

(declare-fun bitwalker__lemmafunction2__result3 () Int)

(declare-fun bitwalker__lemmafunction2__result4 () Int)

(declare-fun bitwalker__lemmafunction2__result5 () Int)
...
;; H
  (assert
  (= bitwalker__lemmafunction2__result1 bitwalker__lemmafunction2__result2))

;; H
  (assert
  (= bitwalker__lemmafunction2__result3 bitwalker__lemmafunction2__result1))

;; H
  (assert
  (= (mk_int__ref result) (mk_int__ref bitwalker__lemmafunction2__result)))
...
;; H
  (assert
  (= (mk_int__ref bitwalker__lemmafunction2__result4) (mk_int__ref
                                                      bitwalker__lemmafunction2__result2)))

;; H
  (assert
  (= bitwalker__lemmafunction2__result5 bitwalker__lemmafunction2__result3))
