...
(declare-fun temp___4131 () unsigned_byte)

(declare-fun temp___4132 () unsigned_byte)
...
;; H
  (assert
  (= r__split_fields3 (mk___split_fields1 temp___413
                      (mk___rep (mk___split_fields temp___4131 temp___4132)))))
