...
(declare-fun records__make_optional_pair_a_2__result () Bool)

(declare-fun records__make_optional_pair_a_2__result1 () unsigned_byte)

(declare-fun records__make_optional_pair_a_2__result2 () unsigned_byte)
...
(declare-fun temp___430 () Bool)

(declare-fun temp___4301 () unsigned_byte)

(declare-fun temp___4302 () unsigned_byte)
...
(declare-fun records__make_optional_pair_a_2__result3 () us_rep1)

(declare-fun records__make_optional_pair_a_2__result4 () optional_pair__ref)

(declare-fun records__make_optional_pair_a_2__result5 () us_rep1)

(declare-fun r__split_fields5 () us_split_fields__ref1)

(declare-fun records__make_optional_pair_a_2__result6 () optional_pair__ref)

(declare-fun r__split_fields6 () us_split_fields2)

(declare-fun records__make_optional_pair_a_2__result7 () us_rep1)
...
;; H
  (assert (= temp___430 o6))

;; H
  (assert (= temp___4301 o7))

;; H
  (assert (= temp___4302 o8))
...
;; H
  (assert
  (= r__split_fields3 (mk___split_fields1 temp___430
                      (mk___rep (mk___split_fields temp___4301 temp___4302)))))
...
;; H
  (assert
  (= records__make_optional_pair_a_2__result4 (mk_optional_pair__ref
                                              records__make_optional_pair_a_2__result3)))

;; H
  (assert
  (= records__make_optional_pair_a_2__result5 records__make_optional_pair_a_2__result3))

;; H
  (assert
  (= result4 (mk_optional_pair__ref
             (mk___rep1
             (mk___split_fields1 records__make_optional_pair_a_2__result
             (mk___rep
             (mk___split_fields records__make_optional_pair_a_2__result1
             records__make_optional_pair_a_2__result2)))))))

;; H
  (assert
  (= records__make_optional_pair_a_2__result3 (mk___rep1 r__split_fields4)))

;; H
  (assert
  (= records__make_optional_pair_a_2__result6 records__make_optional_pair_a_2__result4))
...
;; H
  (assert
  (= records__make_optional_pair_a_2__result7 records__make_optional_pair_a_2__result5))
...
;; H
  ...
  (= (mk___rep1
     ...
     (mk___rep (mk___split_fields result6 result7)))) (optional_pair__content
                                                      records__make_optional_pair_a_2__result6)))
...
;; WP_parameter_def
 ;; File "records_prooffuncs.ads", line 19, characters 0-0
  (not
  (= (bool_eq2
     (optional_pair__content records__make_optional_pair_a_2__result6)
     (mk___rep1 (mk___split_fields1 (of_int 0) x))) true)))
(check-sat)
