...
;; H
  (assert (and (= o30 (+ a_last 1)) (in_range1 (+ a_last 1))))

;; H
  (assert (= o31 (ite (<= k o30) true false)))

;; H
  (assert (= result1 (ite (<= i2 k) o31 false)))
...
;; H
  (assert
  (and (= o25 (from_word32 carry21)) (from_word32__function_guard o25
  carry21)))

;; H
  (assert
  (and (and (= o24 (base Tuple0)) (base__function_guard o24 Tuple0))
  (= o24 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o26 (omultiply o24 o25)) (omultiply__function_guard o26 o24 o25)))

;; H
  (assert
  (and (= o23 (from_word32 carry11)) (from_word32__function_guard o23
  carry11)))

;; H
  (assert (and (= o27 (oadd o23 o26)) (oadd__function_guard o27 o23 o26)))

;; H
  (assert (and (= o20 (- i2 a_first)) (in_range1 (- i2 a_first))))
...
;; H
  (assert
  (and (= o22 (oexpon o19 o21)) (oexpon__function_guard o22 o19 o21)))

;; H
  (assert
  (and (= o28 (omultiply o22 o27)) (omultiply__function_guard o28 o22 o27)))

;; H
  (assert (and (= o16 (- i2 a_first)) (in_range1 (- i2 a_first))))
...
;; H
  (assert
  (and
  (= o18 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last)))
         a_first o17))
  (num_of_big_int__function_guard o18
  (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first o17)))

;; H
  (assert (and (= o29 (oadd o18 o28)) (oadd__function_guard o29 o18 o28)))
...
;; H
  (assert
  (and (= o14 (from_word32 carry2)) (from_word32__function_guard o14 carry2)))

;; H
  (assert
  (and (and (= o13 (base Tuple0)) (base__function_guard o13 Tuple0))
  (= o13 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o15 (omultiply o13 o14)) (omultiply__function_guard o15 o13 o14)))

;; H
  (assert
  (and (= o12 (from_word32 carry1)) (from_word32__function_guard o12 carry1)))

;; H
  (assert (and (= o10 (from_word32 y)) (from_word32__function_guard o10 y)))
...
;; H
  (assert
  (and (= o9 (num_of_big_int c c_first o8)) (num_of_big_int__function_guard
  o9 c c_first o8)))

;; H
  (assert
  (and (= o11 (omultiply o9 o10)) (omultiply__function_guard o11 o9 o10)))

;; H
  (assert (and (= o5 (from_word32 x)) (from_word32__function_guard o5 x)))

;; H
  (assert (and (= o2 (- i2 a_first)) (in_range1 (- i2 a_first))))
...
;; H
  (assert
  (and (= o4 (num_of_big_int b b_first o3)) (num_of_big_int__function_guard
  o4 b b_first o3)))

;; H
  (assert
  (and (= o6 (omultiply o4 o5)) (omultiply__function_guard o6 o4 o5)))
