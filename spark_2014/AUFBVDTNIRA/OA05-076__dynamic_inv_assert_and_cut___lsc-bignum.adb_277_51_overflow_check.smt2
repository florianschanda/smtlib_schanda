...
;; H
  (assert (= o25 (from_word32 carry21)))
...
;; H
  (assert (= o23 (from_word32 carry11)))

;; H
  (assert (= o27 (oadd o23 o26)))
...
;; H
  (assert (= o22 (oexpon o19 o21)))

;; H
  (assert (= o28 (omultiply o22 o27)))
...
;; H
  (assert (= o29 (oadd o18 o28)))

;; H
  (assert (= o14 (from_word32 carry2)))
...
;; H
  (assert (= o15 (omultiply o13 o14)))

;; H
  (assert (= o12 (from_word32 carry1)))

;; H
  (assert (= o10 (from_word32 y)))
...
;; H
  (assert (= o9 (num_of_big_int c c_first o8)))

;; H
  (assert (= o11 (omultiply o9 o10)))
