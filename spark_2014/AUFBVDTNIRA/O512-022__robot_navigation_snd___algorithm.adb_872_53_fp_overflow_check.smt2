...
(define-fun dynamic_invariant2 ((temp___expr_140 t) (temp___is_init_137 Bool)
...
(define-fun dynamic_invariant3 ((temp___expr_146 t) (temp___is_init_143 Bool)
...
(define-fun dynamic_invariant14 ((temp___expr_158 t)
...
(define-fun dynamic_invariant15 ((temp___expr_170 t)
...
(declare-fun temp___1014 () us_rep1)
...
;; H
  (assert
  (and (= o4 (mul RNE1 fliteral5 theta2)) (tqtisFinite
  (mul RNE1 fliteral5 theta2))))

;; H
  (assert (= o5 (div2 RNE1 o4 fliteral6)))
...
;; H
  (assert
  (and (= o10 (limit o9 fliteral7 fliteral))
  (and (tqtisFinite o10) (and (le fliteral7 o10) (le o10 fliteral)))))

;; H
  (assert (= o11 (mul RNE1 driveturnrate2 o10)))
...
;; H
  (assert (lt fliteral2
  (sub RNE1 (t__content disttoclosestobstacle1)
  (to_rep3
  (rec__robot_iface__proxy__robot_radius
  (us_split_fields9
  (rec__algorithm__controller__robot
...
;; H
  (assert
  (and
  (= o13 (sub RNE1 (t__content disttoclosestobstacle1)
         (to_rep3
         (rec__robot_iface__proxy__robot_radius
         (us_split_fields9
         (rec__algorithm__controller__robot
...
;; H
  (assert
  (and (= o17 (limit o16 fliteral8 fliteral))
  (and (tqtisFinite o17) (and (le fliteral8 o17) (le o17 fliteral)))))

;; H
  (assert (= o18 (mul RNE1 driveturnrate3 o17)))
...
;; H
  (assert
  (and (= o23 (limit o22 fliteral2 fliteral))
  (and (tqtisFinite o23) (and (le fliteral2 o23) (le o23 fliteral)))))

;; H
  (assert (= o24 (mul RNE1 drivespeed1 o23)))
...
;; H
  (assert
  (and
  (= o26 (sub RNE1 (t__content disttoclosestobstacle1)
         (to_rep3
         (rec__robot_iface__proxy__robot_radius
         (us_split_fields9
         (rec__algorithm__controller__robot
...
;; H
  (assert
  (and (= o30 (limit o29 fliteral2 fliteral))
  (and (tqtisFinite o30) (and (le fliteral2 o30) (le o30 fliteral)))))

;; H
  (assert (= o31 (mul RNE1 drivespeed2 o30)))
...
;; WP_parameter_def
 ;; File "algorithm.ads", line 107, characters 0-0
  (not (tqtisFinite (sub RNE1 fliteral10 (abs1 theta3)))))
(check-sat)
