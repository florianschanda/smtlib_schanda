...
(declare-fun amortized_queue__my_vectors__append__2__container__fields2 () us_split_fields)
...
(define-fun amortized_queue__my_vectors__append__2__container__fields4 () us_split_fields 
  (mk___split_fields
...
;; H
  ...
  (= (length
     (mk___rep result____split_discrs
     amortized_queue__my_vectors__append__2__container__fields4)) (+ 
  (length
  (mk___rep result____split_discrs
  ...
  (= (olt
     ...
     (model__
     (mk___rep result____split_discrs
     amortized_queue__my_vectors__append__2__container__fields4))) true))
  (= (get
     (model__
     (mk___rep result____split_discrs
     amortized_queue__my_vectors__append__2__container__fields4))
...
;; H
  (assert
  (= result____split_fields6 amortized_queue__my_vectors__append__2__container__fields4))
...
;; H
  ...
  (length (mk___rep result____split_discrs result____split_fields6)) 1))
  (= (olt (model__ (mk___rep result____split_discrs result____split_fields6))
     (model__
     (mk___rep result____split_discrs
  ...
  (= (get
     ...
     amortized_queue__my_vectors__append__2__container__fields3))
     (+ (last
        (model__ (mk___rep result____split_discrs result____split_fields6))) 1)) 
  o2)))
...
;; H
  (assert
  (= (mk___split_fields result____split_fields2) amortized_queue__my_vectors__append__2__container__fields3))
...
;; H
  (assert
  (= (get (model__ (mk___rep result____split_discrs result____split_fields5))
     1) left))
...
;; H
  (assert
  (= result____split_fields4 amortized_queue__my_vectors__append__2__container__fields2))
