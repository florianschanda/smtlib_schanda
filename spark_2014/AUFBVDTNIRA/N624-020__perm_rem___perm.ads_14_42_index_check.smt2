...
;; H
  (assert (and (= temp___718 (- k 1)) (in_range1 (- k 1))))

;; H
  (assert
  (and (<= (to_rep1 (first perm__remove__result9)) temp___718)
  (<= temp___718 (to_rep1 (last perm__remove__result9)))))

;; H
  (assert (= o8 temp___718))
