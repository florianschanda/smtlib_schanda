...
;; H
  ...
  (rec__list_allocator__m__t__allocated model____split_fields3) o50))
  (in_range7 o51)))))
...
;; H
  ...
  (= temp___644 (get
                (rec__list_allocator__m__t__allocated model____split_fields3)
                j))
  (get__function_guard temp___644
  (rec__list_allocator__m__t__allocated model____split_fields3) j))
  (in_range7 temp___644))))

;; H
  (assert (=> (= result12 true) (and (<= 1 temp___644) (<= temp___644 3))))

;; H
  (assert (=> (= result12 true) (= o45 temp___644)))
