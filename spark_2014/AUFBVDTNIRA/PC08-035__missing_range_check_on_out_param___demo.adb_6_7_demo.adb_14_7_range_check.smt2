...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral1) (= (tqtreal fliteral1) 20.0)))
...
(define-fun dynamic_invariant ((temp___expr_141 t) (temp___is_init_138 Bool)
  ...
  (temp___do_toplevel_140 Bool)) Bool (=>
                                      ...
                                      (neg fliteral1) (neg fliteral2)))
                                      (in_range1 temp___expr_141)))

(declare-fun to_rep (range_b) t)

(declare-fun of_rep (t) range_b)
...
;; range_axiom
  (assert
  (forall ((x range_b)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)) )))
...
;; H
  (assert (=> (le (neg fliteral1) (neg fliteral2)) (in_range1 b)))

(assert
;; WP_parameter_def
 ;; File "demo.ads", line 7, characters 0-0
  (not (in_range1 fliteral1)))
(check-sat)
