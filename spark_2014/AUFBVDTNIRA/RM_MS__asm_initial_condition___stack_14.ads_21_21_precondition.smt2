...
(declare-fun s2 () (Array Int integer))

(declare-fun pointer2 () Int)

(declare-fun s3 () (Array Int integer))
...
;; H
  (assert (and (<= 1 pointer1) (<= pointer1 1024)))

;; H
  (assert (= o2 pointer1))

;; H
  (assert (= o3 (store s o2 o1)))

;; H
  (assert (= (mk_map__ref result1) (mk_map__ref s)))
...
;; H
  (assert (= pointer3 pointer1))

;; H
  (assert (= s3 s1))

;; H
  (assert (is_empty__function_guard (is_empty pointer2) pointer2))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (not (= (is_empty pointer2) true))))
(check-sat)
