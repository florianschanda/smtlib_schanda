...
(define-fun dynamic_invariant ((temp___expr_4702 us_t1)
  ...
  (temp___do_toplevel_4701 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_4702))
                                       (and (= (first3 temp___expr_4702) 1)
                                       (= (last4 temp___expr_4702) 2)))))
...
(define-fun dynamic_invariant1 ((temp___expr_4718 us_t2)
  ...
  (temp___do_toplevel_4717 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_4718))
                                       (and (= (first5 temp___expr_4718) 1)
                                       (= (last6 temp___expr_4718) 2)))))
...
(declare-fun temp___7786 () (Array Int bits_8))

(declare-fun temp___77861 () t1)
...
;; H
  (assert
  (and
  (and (= temp___77852 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___77852 reg)) (dynamic_invariant1
  temp___77852 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___77851)) (to_rep (last5 temp___77851)))
     (+ (- (to_rep (last5 temp___77851)) (to_rep (first4 temp___77851))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___7785 temp___7786))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___77851)) (to_rep (last5 temp___77851))) 
  temp___77861))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___77861)) (to_rep (last3 temp___77861)))
     (+ (- (to_rep (last3 temp___77861)) (to_rep (first2 temp___77861))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7786 temp___77861)))
