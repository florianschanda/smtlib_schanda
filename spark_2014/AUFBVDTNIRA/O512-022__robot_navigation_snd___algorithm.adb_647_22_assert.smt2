...
(declare-fun disttogoal__split_fields () float)

(declare-fun disttogoal__split_fields1 () float)
...
(declare-fun temp___961 () us_rep1)

(declare-fun driveturnrate1 () t)
...
(declare-fun driveturnrate2 () t__ref)
...
(declare-fun disttogoal__split_fields2 () us_split_fields2)
...
;; H
  ...
  (and (tqtisFinite o4)
  (and (le fliteral2 o4)
  (=> (lt fliteral2 o4) (not (= (oeq o3 zero_position) true)))))))
...
;; H
  ...
  (= result2 (ite (le o4
             ...
             (us_split_fields9
             (rec__algorithm__controller__robot
             (us_split_fields__content10 this__split_fields1)))))) true
             false)))
...
;; H
  (assert (= driveturnrate2 (mk_t__ref driveturnrate)))

;; H
  (assert (= this__split_fields3 this__split_fields1))

;; H
  (assert (= driveturnrate3 driveturnrate1))

;; H
  (assert (= this__split_fields4 this__split_fields2))

;; H
  (assert (oeq__function_guard (oeq o5 zero_position) o5 zero_position))

;; H
  (assert (oeq__function_guard (oeq temp___961 zero_position) temp___961
  zero_position))

;; H
  (assert
  (and (= o9 (ori (mk___rep2 robotpose__split_fields))) (ori__function_guard
  o9 (mk___rep2 robotpose__split_fields))))

;; H
  (assert
  (and (= o7 (pos (mk___rep2 relgoal__split_fields))) (pos__function_guard 
  o7 (mk___rep2 relgoal__split_fields))))

;; H
  (assert (and (= o8 (bearing o7)) (bearing__function_guard o8 o7)))

;; H
  (assert
  (and (= o10 (osubtract o8 o9)) (osubtract__function_guard o10 o8 o9)))

;; H
  (assert
  (and (= o5 (pos (mk___rep2 relgoal__split_fields))) (pos__function_guard 
  o5 (mk___rep2 relgoal__split_fields))))

;; H
  (assert
  (and (and (= o6 (norm o5)) (norm__function_guard o6 o5))
  (and (tqtisFinite o6)
  (and (le fliteral2 o6)
  (=> (lt fliteral2 o6) (not (= (oeq o5 zero_position) true)))))))

;; H
  (assert
  (and
  (and (= temp___961 (create__4 o6 o10)) (create__4__function_guard
  temp___961 o6 o10))
  (=> (neq o6 fliteral2) (not (= (oeq temp___961 zero_position) true)))))

;; H
  (assert
  (= result3 (mk___split_fields__ref1
             (mk___split_fields1 disttogoal__split_fields
             disttogoal__split_fields1))))

;; H
  (assert (= disttogoal__split_fields2 (us_split_fields3 temp___961)))

;; H
  (assert (oeq__function_guard
  (oeq (mk___rep1 disttogoal__split_fields2) zero_position)
  (mk___rep1 disttogoal__split_fields2) zero_position))
