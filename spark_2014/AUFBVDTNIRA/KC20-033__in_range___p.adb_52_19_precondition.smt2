...
(declare-fun ident__5 (t) t)

(declare-fun ident__5__function_guard (t t) Bool)
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral2) (/ 999000012874603271484375.0 1000000000000000000000000.0))))
...
;; ident__5__post_axiom
  ...
  (! (=>
     ...
     (and (le (neg fliteral2) f) (le f fliteral2)))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral3) (/ 112000003457069396972656250.0 1000000000000000000000000000.0))))
...
;; WP_parameter_def
 ;; File "p.adb", line 40, characters 0-0
  (not (le (neg fliteral2) (neg fliteral3))))
(check-sat)
