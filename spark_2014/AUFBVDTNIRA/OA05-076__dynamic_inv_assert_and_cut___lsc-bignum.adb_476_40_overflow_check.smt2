...
;; H
  ...
  aux4_first (+ (- o7 aux4_first) 1))
  (mk___t aux4 (mk (to_rep aux4__first) (to_rep aux4__last))) aux4_first
  (+ (- o7 aux4_first) 1)))

;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int x x_first (+ (- o7 aux4_first) 1)) x x_first
  (+ (- o7 aux4_first) 1)))

;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int r r_first (+ (- o7 aux4_first) 1)) r r_first
  (+ (- o7 aux4_first) 1)))
...
;; H
  ...
  (num_of_big_int x x_first (+ (- o7 aux4_first) 1))
  (num_of_big_int r r_first (+ (- o7 aux4_first) 1))))

;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int m m_first (+ (- o7 aux4_first) 1)) m m_first
  (+ (- o7 aux4_first) 1)))
...
;; H
  (assert (inverse__function_guard
  (inverse (num_of_big_int m m_first (+ (- o7 aux4_first) 1)) (base Tuple0))
  (num_of_big_int m m_first (+ (- o7 aux4_first) 1)) (base Tuple0)))
...
;; H
  ...
  (inverse (num_of_big_int m m_first (+ (- o7 aux4_first) 1)) (base Tuple0))
  (+ (- o7 aux4_first) 1)))
  (num_of_big_int m m_first (+ (- o7 aux4_first) 1)))
  (omultiply
  (omultiply (num_of_big_int x x_first (+ (- o7 aux4_first) 1))
  (num_of_big_int r r_first (+ (- o7 aux4_first) 1)))
  (oexpon
...
;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int m m_first (+ (- o8 aux2_first) 1)) m m_first
  (+ (- o8 aux2_first) 1)))
...
;; H
  (assert (inverse__function_guard
  (inverse (num_of_big_int m m_first (+ (- o8 aux2_first) 1)) (base Tuple0))
  (num_of_big_int m m_first (+ (- o8 aux2_first) 1)) (base Tuple0)))
...
;; H
  ...
  (inverse (num_of_big_int m m_first (+ (- o8 aux2_first) 1)) (base Tuple0))
  (+ (- o8 aux2_first) 1)))
  (num_of_big_int m m_first (+ (- o8 aux2_first) 1)))
  (omultiply
  (omultiply
  (num_of_big_int (mk___t aux4 (mk (to_rep aux4__first) (to_rep aux4__last)))
  aux4_first (+ (- o8 aux2_first) 1))
...
;; H
  ...
  (= (oeq
     ...
     (+ (- o8 aux2_first) 1)))
     (oexpon
     (inverse (num_of_big_int m m_first (+ (- o8 aux2_first) 1))
     (base Tuple0)) (+ (- o8 aux2_first) 1)))
     (num_of_big_int m m_first (+ (- o8 aux2_first) 1)))) true))
