...
;; invariant____def_axiom
  ...
  (! (=> (invariant____function_guard (invariant__ us_void_param)
     us_void_param) (= (invariant__ us_void_param) true)) :pattern ((invariant__
                                                                    us_void_param)) )))
...
(define-fun dynamic_invariant3 ((temp___expr_398 us_rep)
  ...
  (temp___do_toplevel_397 Bool)) Bool (=>
                                      ...
                                      (in_range6 128 temp___expr_398)))

(define-fun default_initial_assumption ((temp___expr_400 us_rep)
...
(define-fun bool_eq8 ((a (Array (_ BitVec 32) name_id))
...
(define-fun dynamic_invariant4 ((temp___expr_320 us_rep1)
  (temp___is_init_317 Bool) (temp___skip_constant_318 Bool)
  (temp___do_toplevel_319 Bool)) Bool (=>
                                      (not (= temp___skip_constant_318 true))
                                      (in_range8 1024 temp___expr_320)))

(define-fun default_initial_assumption1 ((temp___expr_322 us_rep1)
  (temp___skip_top_level_323 Bool)) Bool (and
                                         (= (to_rep5
                                            (rec__names__char_tables__vector__capacity
                                            (us_split_discrs3
                                            temp___expr_322))) 1024)
                                         (=>
                                         (not
...
;; to_string__post_axiom
  ...
  (! (and (invariant____function_guard (invariant__ Tuple0) Tuple0)
     ...
     true)) (= (invariant__ Tuple0) true))
     (let ((result (to_string1 n names__entry_table__fields
                   names__char_table__fields)))
     (=> (to_string__function_guard result n names__entry_table__fields
     names__char_table__fields) (dynamic_invariant result true false true))))) :pattern (
  (to_string1 n names__entry_table__fields names__char_table__fields)) )))))
...
(declare-fun user_eq10 (valid_name_id valid_name_id) Bool)
...
(declare-fun user_eq11 (hash_table_index_t hash_table_index_t) Bool)
...
(define-fun dynamic_invariant5 ((temp___expr_245 (_ BitVec 32))
...
(define-fun dynamic_invariant6 ((temp___expr_284 Int)
...
(declare-fun bool_eq14 (us_rep2 us_rep2) Bool)
...
(define-fun dynamic_invariant7 ((temp___expr_278 Int)
...
(declare-fun bool_eq19 (us_rep4 us_rep4) Bool)
...
(define-fun dynamic_invariant12 ((temp___expr_239 Int)
...
(define-fun dynamic_invariant13 ((temp___expr_260 Int)
...
(define-fun default_initial_assumption2 ((temp___expr_314 us_rep2)
...
(define-fun dynamic_invariant16 ((temp___expr_301 Int)
...
(define-fun dynamic_invariant17 ((temp___expr_359 Int)
...
;; user_eq__def_axiom
  ...
  (! (= (user_eq19 a b) (oeq1 a b)) :pattern ((user_eq19 a b)) )))

(define-fun default_initial_assumption3 ((temp___expr_392 us_rep4)
...
(define-fun dynamic_invariant18 ((temp___expr_338 Int)
...
(define-fun dynamic_invariant19 ((temp___expr_385 Int)
...
(declare-fun temp___433 () Int)

(declare-fun temp___432 () (Array Int character))

(declare-fun temp___4321 () t)

(declare-fun o2 () Int)

(declare-fun o3 () char_table_index)

(declare-fun o4 () positive)

(declare-fun o5 () name_id)

(declare-fun o6 () char_table_index)

(declare-fun o7 () positive)

(declare-fun o8 () name_id)

(declare-fun o9 () name_id)

(declare-fun o10 () Int)

(declare-fun temp___436 () capacity_range1)

(declare-fun temp___4361 () us_main_type1)
...
(declare-fun o17 () positive)

(declare-fun n1 () Int)

(declare-fun char_table__split_fields1 () us_split_fields2)
...
(declare-fun ptr4 () int__ref)

(declare-fun ptr5 () Int)

(declare-fun n6 () int__ref)

(declare-fun ptr6 () int__ref)

(declare-fun n7 () Int)

(declare-fun ptr7 () Int)

(declare-fun n8 () int__ref)

(declare-fun ptr8 () int__ref)

(declare-fun n9 () Int)

(declare-fun ptr9 () Int)

(declare-fun n10 () int__ref)

(declare-fun ptr10 () int__ref)

(declare-fun n11 () Int)

(declare-fun ptr11 () Int)

(declare-fun result5 () int__ref)

(declare-fun c344b1 () Int)

(declare-fun char_table__split_fields2 () us_split_fields2)

(declare-fun c344b2 () Int)

(declare-fun names__char_tables__append__2__container__fields () us_split_fields2)

(declare-fun result6 () us_split_fields__ref1)

(declare-fun char_table__split_fields3 () us_split_fields2)

(declare-fun char_table__split_fields4 () us_split_fields__ref1)

(declare-fun c344b3 () int__ref)

(declare-fun char_table__split_fields5 () us_split_fields2)

(declare-fun c344b4 () Int)

(declare-fun char_table__split_fields6 () us_split_fields__ref1)

(declare-fun c344b5 () int__ref)

(declare-fun char_table__split_fields7 () us_split_fields2)

(declare-fun c344b6 () Int)

(define-fun o18 () us_rep3 (mk___rep2 (mk___split_fields2 o3 o4 o5)))

(define-fun temp___4322 () us_t (mk___t temp___432 temp___4321))
...
;; H
  (assert (=> (in_range9 n3) (= temp___434 n3)))

;; H
  (assert (=> (in_range9 n3) (= temp___433 ptr2)))
...
;; H
  ...
  (and
  (and
  (= temp___4322 (to_string1 ptr3
                 (mk___split_fields entry_table__split_fields)
                 (mk___split_fields1 char_table__split_fields)))
  (to_string__function_guard temp___4322 ptr3
  (mk___split_fields entry_table__split_fields)
  (mk___split_fields1 char_table__split_fields))) (dynamic_invariant
  temp___4322 true false true))))

;; H
  (assert
  (=> (in_range9 n3)
  (= result3 (bool_eq3 temp___432 (to_rep1 (first temp___4321))
             (to_rep1 (last temp___4321)) (elts s) (to_rep1 (first (rt s)))
             (to_rep1 (last (rt s)))))))
...
;; H
  ...
  (= o18 (get1
         (model__1
         (mk___rep entry_table__split_discrs
         (mk___split_fields entry_table__split_fields))) o2))
  (= (bool_eq17 o18
     (get1
     (model__1
     (mk___rep entry_table__split_discrs
...
;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt s))) c344b1)
  (<= c344b1 (to_rep1 (last (rt s)))))
  (and (= char_table__split_discrs (mk___split_discrs1 temp___436))
  (= char_table__split_fields temp___4361))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt s))) c344b1)
  (<= c344b1 (to_rep1 (last (rt s)))))
  (and (<= (to_rep1 (first (rt s))) c344b2)
  (<= c344b2 (to_rep1 (last (rt s)))))))
...
;; H
  ...
  (= (length1
     ...
     names__char_tables__append__2__container__fields)) (+ (length1
                                                           (mk___rep1
                                                           char_table__split_discrs
                                                           char_table__split_fields2)) 1))
  (= (olt
     (model__ (mk___rep1 char_table__split_discrs char_table__split_fields2))
     (model__
     (mk___rep1 char_table__split_discrs
     names__char_tables__append__2__container__fields))) true))
  (= (get
     (model__
     (mk___rep1 char_table__split_discrs
     names__char_tables__append__2__container__fields))
     (+ (last2
        (model__
        (mk___rep1 char_table__split_discrs char_table__split_fields2))) 1)) 
  (to_rep (select (elts s) c344b2))))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt s))) c344b1)
  (<= c344b1 (to_rep1 (last (rt s)))))
  (= result6 (mk___split_fields__ref1 char_table__split_fields2))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt s))) c344b1)
  (<= c344b1 (to_rep1 (last (rt s)))))
  (= char_table__split_fields3 names__char_tables__append__2__container__fields)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt s))) c344b1)
  (<= c344b1 (to_rep1 (last (rt s))))) (= c344b2 (to_rep1 (last (rt s))))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt s))) c344b1)
  (<= c344b1 (to_rep1 (last (rt s))))) (= c344b3 (mk_int__ref c344b2))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt s))) c344b1)
  (<= c344b1 (to_rep1 (last (rt s)))))
  (= char_table__split_fields4 (mk___split_fields__ref1
...
;; H
  ...
  (=>
  (and (<= (to_rep1 (first (rt s))) c344b1)
  (<= c344b1 (to_rep1 (last (rt s))))) (= c344b4 c344b2)))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt s))) c344b1)
  (<= c344b1 (to_rep1 (last (rt s)))))
  (= char_table__split_fields5 char_table__split_fields3)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt s))) c344b1)
  (<= c344b1 (to_rep1 (last (rt s))))) (= c344b5 c344b3)))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 (first (rt s))) c344b1)
  (<= c344b1 (to_rep1 (last (rt s))))) (= c344b6 c344b4)))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt s))) c344b1)
  (<= c344b1 (to_rep1 (last (rt s)))))) (= c344b5 (mk_int__ref c344b1))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt s))) c344b1)
  (<= c344b1 (to_rep1 (last (rt s))))))
  (= char_table__split_fields6 (mk___split_fields__ref1
                               (mk___split_fields1 char_table__split_fields)))))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt s))) c344b1)
  (<= c344b1 (to_rep1 (last (rt s)))))) (= c344b6 c344b1)))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt s))) c344b1)
  (<= c344b1 (to_rep1 (last (rt s))))))
  (= char_table__split_fields7 char_table__split_fields1)))
...
;; H
  ...
  (= (last2
     (model__
     (mk___rep1 char_table__split_discrs
     (us_split_fields__content1 char_table__split_fields6)))) (- (length1
                                                                 (mk___rep1
                                                                 char_table__split_discrs
                                                                 (us_split_fields__content1
                                                                 char_table__split_fields6))) 1)))

;; H
  (assert
  (<= (length1
      (mk___rep1 char_table__split_discrs
      (us_split_fields__content1 char_table__split_fields6))) 2147483647))
...
;; H
  ...
  (<= (last2
      (model__
      (mk___rep1 char_table__split_discrs
      (us_split_fields__content1 char_table__split_fields6)))) 2147483646))

;; H
  (assert (= (to_rep3 o16) 0))

;; H
  (assert (and (= o15 (length s)) (in_range2 (length s))))

;; H
  (assert (= (to_rep2 o17) o15))
...
;; H
  ...
  (= o13 (last2
         (model__
         (mk___rep1 char_table__split_discrs
         (us_split_fields__content1 char_table__split_fields6)))))
  (and (in_range13 o13)
  (= o13 (last2
         (model__
         (mk___rep1 char_table__split_discrs
