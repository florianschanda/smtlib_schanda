...
(declare-fun c58b () (Array Int character))
...
(declare-fun temp___1266 () us_t3)

(declare-fun temp___1270 () us_t3)

(declare-fun o34 () (Array Int character))

(declare-fun temp___1265 () us_t)
...
(declare-fun result__20 () (Array Int character))

(declare-fun result24 () map__ref)

(declare-fun result__21 () (Array Int character))

(declare-fun result__22 () map__ref)

(declare-fun result__23 () (Array Int character))

(declare-fun result25 () map__ref)

(declare-fun c58b1 () (Array Int character))
...
;; H
  (assert
  (=> (not (= (select issystem retvalini1) true)) (= result__10 result__25)))
...
;; H
  (assert (and (= o33 (length thestring2)) (in_range1 (length thestring2))))

;; H
  (assert (= result22 (ite (<= o33 150) true false)))
...
;; H
  (assert
  (=> (= result22 true)
  (= (ite (<= (to_rep1 (first6 (rt3 temp___1266))) (to_rep1
                                                   (last10 (rt3 temp___1266))))
     (+ (- (to_rep1 (last10 (rt3 temp___1266))) (to_rep1
                                                (first6 (rt3 temp___1266)))) 1)
     0) (ite (<= (to_rep1 (first6 (mk3 1 (length thestring2)))) (to_rep1
                                                                (last10
                                                                (mk3 1
                                                                (length
                                                                thestring2)))))
        (+ (- (to_rep1 (last10 (mk3 1 (length thestring2)))) (to_rep1
                                                             (first6
                                                             (mk3 1
                                                             (length
                                                             thestring2))))) 1)
...
;; H
  (assert (=> (= result22 true) (= temp___1270 temp___1266)))

;; H
  (assert
  (=> (= result22 true)
  (forall ((temp___1271 Int))
  (ite (and (<= 1 temp___1271) (<= temp___1271 (length thestring2)))
  (= (select o34 temp___1271) (select (elts3 temp___1270) temp___1271))
  (= (select o34 temp___1271) (select result__19 temp___1271))))))

;; H
  (assert (=> (= result22 true) (= result23 (mk_map__ref result__19))))

;; H
  (assert (=> (= result22 true) (= result__20 o34)))
...
;; H
  (assert (=> (not (= result22 true)) (= temp___1265 thestring2)))

;; H
  (assert (=> (not (= result22 true)) (= o35 (elts temp___1265))))

;; H
  (assert (=> (not (= result22 true)) (= result24 (mk_map__ref result__19))))

;; H
  (assert (=> (not (= result22 true)) (= result__21 o35)))

;; H
  (assert
  (=> (not (= result22 true)) (= result__22 (mk_map__ref result__21))))
...
;; H
  (assert (valid_numberlogentries__function_guard
  (valid_numberlogentries (us_private__content state6))
  (us_private__content state6)))

(assert
;; WP_parameter_def
 ;; File "keystore.ads", line 100, characters 0-0
  (not (= (valid_numberlogentries (us_private__content state6)) true)))
(check-sat)
