...
;; range_axiom
  (assert
  (forall ((x item_type)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)) )))
...
(define-fun bool_eq1 ((a (Array Int item_type)) (a__first Int) (a__last Int)
...
(declare-fun c910003_pack__buffer__saved_item__first__bit () Int)

(declare-fun c910003_pack__buffer__saved_item__last__bit () Int)

(declare-fun c910003_pack__buffer__saved_item__position () Int)
...
(declare-fun c910003_pack__buffer__empty__first__bit () Int)

(declare-fun c910003_pack__buffer__empty__last__bit () Int)

(declare-fun c910003_pack__buffer__empty__position () Int)
...
(declare-fun c910003_pack__buffer__tc_items__first__bit () Int)

(declare-fun c910003_pack__buffer__tc_items__last__bit () Int)

(declare-fun c910003_pack__buffer__tc_items__position () Int)
...
(declare-fun c910003_pack__buffer__tc_last__first__bit () Int)

(declare-fun c910003_pack__buffer__tc_last__last__bit () Int)

(declare-fun c910003_pack__buffer__tc_last__position () Int)
...
(declare-datatypes ()
((us_t2 (mk___t2 (elts2 (Array Int item_type))(rt2 t2)))))
(define-fun to_array2 ((a us_t2)) (Array Int item_type) (elts2 a))

(define-fun of_array2 ((a (Array Int item_type)) (f Int)
...
;; object__component__size_axiom
  (assert
  (forall ((a (Array Int item_type))) (<= 0 (object__component__size2 a))))
...
(declare-fun o () item_type)

(declare-fun o1 () Bool)

(declare-fun o2 () (Array Int item_type))
...
(declare-fun o5 () item_type)

(declare-fun c910003_pack__proc__item1__assume () Int)

(declare-fun o6 () item_type)

(declare-fun o7 () Bool)

(declare-fun o8 () (Array Int item_type))
