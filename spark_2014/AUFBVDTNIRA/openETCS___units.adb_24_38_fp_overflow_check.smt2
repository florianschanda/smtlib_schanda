...
;; is_valid_speed_km_per_h__def_axiom
  ...
  (! (=> (is_valid_speed_km_per_h__function_guard
     ...
     (and (le fliteral2 speed1) (le speed1 fliteral3)))) :pattern ((is_valid_speed_km_per_h
                                                                   speed1)) )))
...
;; m_per_s_from_km_per_h__def_axiom
  ...
  (! (=>
     ...
     speed1))
     (= (m_per_s_from_km_per_h speed1) (div1 RNE2 (mul RNE2 speed1 fliteral4)
...
;; WP_parameter_def
 ;; File "units.ads", line 24, characters 0-0
  (not (tqtisFinite (mul RNE2 speed fliteral5))))
(check-sat)
