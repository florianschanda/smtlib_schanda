...
(define-fun bool_eq18 ((a (Array Int us_rep3)) (a__first Int) (a__last Int)
...
;; H
  ...
  (=> (and (<= 1 temp___379) (<= temp___379 64))
  (ite (not
       (= (to_rep9
          (rec__datebooks__add_event__find_result_record__fresh_index
          (us_split_fields__content4 find_result__split_fields9))) temp___379))
  (= (select book2 temp___379) (select book1 temp___379))
  (and
  (and
  (= (rec__datebooks__event_record__description_size
     (us_split_fields7 (select book2 temp___379))) (rec__datebooks__event_record__description_size
                                                   (us_split_fields7
                                                   (select book1 temp___379))))
  (= (rec__datebooks__event_record__date
     (us_split_fields7 (select book2 temp___379))) (rec__datebooks__event_record__date
                                                   (us_split_fields7
                                                   (select book1 temp___379)))))
  (= (rec__datebooks__event_record__is_used
     (us_split_fields7 (select book2 temp___379))) (rec__datebooks__event_record__is_used
                                                   (us_split_fields7
                                                   (select book1 temp___379))))))))
  (=>
...
;; H
  (assert (= (to_rep o20) (to_rep (select (elts description) i9))))

;; H
  (assert
  (and (= o18 (- i9 (to_rep1 (first (rt description))))) (in_range1
