...
;; H
  (assert
  (= rdx1 (bvor (bvand rdx ((_ int2bv 64) 18446744073709486080)) ((_ zero_extend 48) 
  val__))))
...
;; H
  (assert (writereg16post__function_guard (writereg16post rdx rdx2 val__) 
  rdx rdx2 val__))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 9, characters 0-0
  (not (= (writereg16post rdx rdx2 val__) true)))
(check-sat)
