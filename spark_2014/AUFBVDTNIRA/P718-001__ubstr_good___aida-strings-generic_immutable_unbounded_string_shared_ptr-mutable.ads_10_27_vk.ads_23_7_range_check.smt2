...
;; temp___result_838_def
  (assert
  (forall ((temp___837 us_rep)) (length__function_guard (length1 temp___837)
  temp___837)))
...
(declare-fun this__split_fields () us_main_type)

(declare-fun this__split_fields1 () us_private)

(define-fun this__split_fields2 () us_split_fields (mk___split_fields
                                                   this__split_fields
                                                   this__split_fields1))
...
;; H
  (assert
  (and
  (and (= o (length1 (mk___rep this__split_fields2 this__attr__tag)))
  (length__function_guard o (mk___rep this__split_fields2 this__attr__tag)))
  (in_range4 o)))

(assert
;; WP_parameter_def
 ;; File "aida-strings-generic_immutable_unbounded_string_shared_ptr-mutable.ads", line 7, characters 0-0
  (not (in_range3 (length text))))
(check-sat)
