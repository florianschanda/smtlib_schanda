...
(declare-fun y () (Array Int integer))
...
;; H
  (assert (= o7 (concat1 temp___183 1 9 o1 1 1)))

;; H
  (assert (= o7 temp___185))

;; H
  (assert (= (mk 1 o6) temp___1851))

;; H
  (assert
  (= (ite (<= (to_rep (first temp___1851)) (to_rep (last temp___1851)))
     (+ (- (to_rep (last temp___1851)) (to_rep (first temp___1851))) 1) 0) 
  (ite (<= 1 10) (+ (- 10 1) 1) 0)))
...
;; H
  (assert (= (to_rep (select z1 1)) (to_rep (select x 1))))

;; H
  (assert (= (to_rep (select z1 10)) 1))
...
;; H
  (assert (=> (<= 1 9) (= o12 (+ (- 9 1) 1))))

;; H
  (assert (=> (not (<= 1 9)) (= o12 0)))
...
;; H
  (assert (= o11 (concat1 temp___188 1 9 o10 1 1)))

;; H
  (assert (= o17 (slide o11 1 1)))

;; H
  (assert (= o17 temp___190))

;; H
  (assert (= (mk1 1 o16) temp___1901))

(assert
;; WP_parameter_def
 ;; File "concat.ads", line 8, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___1901)) (to_rep (last2 temp___1901)))
     (+ (- (to_rep (last2 temp___1901)) (to_rep (first2 temp___1901))) 1) 0) 
  (ite (<= 1 10) (+ (- 10 1) 1) 0))))
(check-sat)
