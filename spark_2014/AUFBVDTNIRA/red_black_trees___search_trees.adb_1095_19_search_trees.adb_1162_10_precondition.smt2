...
;; H
  ...
  (rec__search_trees__search_tree__struct t__split_fields10) o37))
  (and (dynamic_invariant6 temp___2036 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2036 o37))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2036 o37)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o37))
...
;; H
  (assert (= o38 (select temp___2036 x1)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2035 o33))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2035 o33)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o33))
...
;; H
  (assert (= o34 (select temp___2035 i1)))
