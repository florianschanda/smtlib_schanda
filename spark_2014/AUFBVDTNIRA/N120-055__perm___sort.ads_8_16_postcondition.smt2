...
(declare-fun temp___168 () (Array Int natural))

(declare-fun temp___170 () (Array Int natural))
...
(declare-fun values6 () (Array Int natural))
...
(declare-fun values8 () (Array Int natural))
...
;; H
  ...
  (and
  (and
  (and (= current8 current13)
  (and (= smallest8 smallest13) (= values12 values14)))
  (and (= current9 current1)
  (and (= smallest9 smallest1) (= values9 values1))))
  (and
  (and
  (ite (<= (to_rep values__first) (to_rep values__last))
  (= o (+ (- (to_rep values__last) (to_rep values__first)) 1)) (= o 0))
  ...
  (and (= smallest8 smallest12) (= values12 values13)))
  ...
  (and
  (and (= (mk_int__ref result1) current13)
  (= current2 (to_rep values__first)))
  (ite (and (<= (to_rep values__first) current2) (<= current2 temp___172))
  (and
  (and
  (and (= temp___169 current2)
  (and (= temp___168 values)
  (and (= temp___170 values)
  (and (= temp___166 smallest)
  (and
  (and
  (and
  (and
  ...
  (<= (to_rep values__last) (to_rep values__last))))) (= o1 values))
  (and (= o1 temp___165)
  (= (mk1 current2 (to_rep values__last)) temp___1651)))
  (and (= temp___165 o2)
  (= (mk (to_rep (first4 temp___1651)) (to_rep (last4 temp___1651))) 
  o3)))
  (and
  (and (= o4 (index_of_minimum o7)) (index_of_minimum__function_guard o4 o7))
  (and (in_range4 o4)
  (and (<= (to_rep (first o3)) o4) (<= o4 (to_rep (last o3)))))))
  (and (= (mk_int__ref result2) smallest13) (= smallest2 o4)))
  (and
  (ite (not (= smallest2 current2))
  (and (and (= o6 smallest2) (in_range4 smallest2))
  (and (and (= o5 current2) (in_range4 current2))
  (= (is_perm__logic
     (mk___t values (mk (to_rep values__first) (to_rep values__last)))
     (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true)))
  (and (= values2 values) (= values2 values1)))
  (and
  (= (is_perm__logic
     (mk___t temp___170 (mk (to_rep values__first) (to_rep values__last)))
  ...
  (<= current3 (- (to_rep values__last) 1)))) (= current3 temp___172)))))))))
  (and
  (and (= current3 current4)
  (and (= smallest3 smallest4) (= values3 values4)))
  (and (= current5 current3)
  (and (= smallest5 smallest3) (= values5 values3)))))
  (and
  (and (= current12 (mk_int__ref current4))
  (and (= smallest12 (mk_int__ref smallest4))
  (= values13 (mk_map__ref values4))))
  (and (= current7 current5)
  (and (= smallest7 smallest5) (= values7 values5)))))
  (and
  (and (= current2 current6)
  (and (= smallest12 smallest13) (= values13 values14)))
...
;; WP_parameter_def
 ;; File "sort.adb", line 22, characters 0-0
  ...
  (= (is_perm__logic
     ...
     (mk (to_rep values__first) (to_rep values__last)))) true)))
(check-sat)
