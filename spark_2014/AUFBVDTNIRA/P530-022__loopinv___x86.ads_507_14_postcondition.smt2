...
(declare-fun r11 () (_ BitVec 64))

(declare-fun x86__r11l__result () (_ BitVec 8))

(declare-fun result () (_ BitVec 8))

(declare-fun x86__r11l__result1 () (_ BitVec 8))

(declare-fun x86__r11l__result2 () (_ BitVec 8))

(declare-fun x86__r11l__result3 () (_ BitVec 8))

(declare-fun x86__r11l__result4 () (_ BitVec 8))

(declare-fun x86__r11l__result5 () (_ BitVec 8))
...
;; H
  (assert
  (= x86__r11l__result1 ((_ extract 7 0) (bvand r11 ((_ int2bv 64) 255)))))
...
;; H
  (assert (readreglow8__function_guard (readreglow8 r11) r11))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not (= x86__r11l__result4 (readreglow8 r11))))
(check-sat)
