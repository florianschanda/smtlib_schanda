...
(declare-fun destination__first () integer)

(declare-fun destination__last () integer)
...
(declare-fun temp___275 (Int Int Int) us_t1)

;; def_axiom
  (assert
  (forall ((temp___277 Int) (temp___278 Int) (temp___279 Int))
  (let ((temp___276 (temp___275 temp___277 temp___278 temp___279)))
  (and
  (=> (dynamic_property 1 2147483647 temp___278 temp___279)
  (and (= (first4 temp___276) temp___278) (= (last4 temp___276) temp___279)))
  (forall ((temp___280 Int))
  (= (select (to_array1 temp___276) temp___280) (of_rep temp___277)))))))
...
(declare-fun destination () (Array Int character))

(declare-fun characters_to_copy () Int)

(declare-fun i () Int)

(declare-fun temp___282 () (Array Int character))

(declare-fun temp___2821 () t1)

(declare-fun temp___283 () (Array Int character))

(declare-fun temp___2831 () t)

(declare-fun temp___284 () (Array Int character))

(declare-fun temp___2841 () t)
...
(declare-fun destination1 () (Array Int character))
...
;; H
  (assert (dynamic_property 1 2147483647 (to_rep1 destination__first)
...
;; H
  (assert
  (= (mk___t1 temp___282 temp___2821) (temp___275 32
                                      (to_rep1 destination__first)
                                      (to_rep1 destination__last))))

;; H
  (assert (= temp___282 temp___283))

;; H
  (assert
  (= (mk (to_rep1 (first3 temp___2821)) (to_rep1 (last3 temp___2821))) 
  temp___2831))
...
;; H
  (assert
  (= (mk___t temp___284 temp___2841) (mk___t temp___283 temp___2831)))

;; H
  (assert
  (= o (slide temp___284 (to_rep1 (first temp___2841))
       (to_rep1 destination__first))))
...
;; H
  (assert
  (=> (< (- 1024 point) characters_to_copy1) (= result2 characters_to_copy1)))
...
;; H
  (assert
  (=> (<= (to_rep1 destination__first) (to_rep1 destination__last))
  (= o1 (+ (- (to_rep1 destination__last) (to_rep1 destination__first)) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 destination__first) (to_rep1 destination__last)))
  (= o1 0)))
...
;; H
  ...
  (=> (= result3 true)
  (=> (<= (to_rep1 destination__first) (to_rep1 destination__last))
  (= o3 (+ (- (to_rep1 destination__last) (to_rep1 destination__first)) 1)))))
...
;; H
  (assert
  (=> (not (= result3 true)) (= characters_to_copy3 characters_to_copy2)))
...
;; H
  (assert
  (and (= temp___285 (+ point (- i2 1))) (in_range1 (+ point (- i2 1)))))
