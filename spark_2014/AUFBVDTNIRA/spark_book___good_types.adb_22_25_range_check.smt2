...
(define-fun dynamic_invariant1 ((temp___expr_515 t) (temp___is_init_512 Bool)
  (temp___skip_constant_513 Bool)
  (temp___do_toplevel_514 Bool)) Bool (=>
                                      (or (= temp___is_init_512 true) (le
...
(define-fun dynamic_invariant2 ((temp___expr_521 t) (temp___is_init_518 Bool)
  (temp___skip_constant_519 Bool)
  (temp___do_toplevel_520 Bool)) Bool (=>
                                      (or (= temp___is_init_518 true) (le
                                      fliteral1 fliteral3)) (in_range3
                                      temp___expr_521)))
...
(define-fun dynamic_invariant3 ((temp___expr_527 t) (temp___is_init_524 Bool)
  (temp___skip_constant_525 Bool)
  (temp___do_toplevel_526 Bool)) Bool (=>
                                      (or (= temp___is_init_524 true) (le
...
(define-fun dynamic_invariant4 ((temp___expr_536 t) (temp___is_init_533 Bool)
  (temp___skip_constant_534 Bool)
  (temp___do_toplevel_535 Bool)) Bool (=>
                                      (or (= temp___is_init_533 true) (le
...
(declare-fun good_types__feet_io__get__2__item () t)

(declare-fun result () t)

(declare-fun room_length1 () t)

(declare-fun good_types__inch_io__get__2__item () t)
...
;; H
  (assert (=> (le fliteral1 fliteral2) (in_range2 room_length)))

;; H
  (assert (=> (le fliteral1 fliteral3) (in_range3 wall_thickness)))

;; H
  (assert (=> (le fliteral1 fliteral2) (in_range2 total)))
...
;; WP_parameter_def
 ;; File "a-tiflio.ads", line 80, characters 0-0
  (not (in_range2
  (add RNE2 room_length1 (mul RNE2 fliteral4 (div1 RNE2 c3b fliteral3))))))
(check-sat)
