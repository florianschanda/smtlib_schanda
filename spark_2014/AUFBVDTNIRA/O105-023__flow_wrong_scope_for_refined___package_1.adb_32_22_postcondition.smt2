...
;; H
  (assert (and (= o (+ state_var_1 1)) (in_range (+ state_var_1 1))))

;; H
  (assert (= result state_var_1))

;; H
  (assert (= state_var_11 o))
...
;; H
  (assert (invariant____function_guard (invariant__ state_var_12 state_var_2)
  state_var_12 state_var_2))

(assert
;; WP_parameter_def
 ;; File "package_1.ads", line 10, characters 0-0
  (not (= (invariant__ state_var_12 state_var_2) true)))
(check-sat)
