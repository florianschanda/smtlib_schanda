...
;; H
  ...
  (and (= temp___482 r27b)
  (and (and (= result8 current12) (= current1 temp___481))
  ...
  (and
  (and (and (= result8 current12) (= current1 first))
...
;; H
  ...
  (=>
  (forall ((i1 Int))
  (=> (and (<= first i1) (<= i1 (last4 (model__ v))))
  (not (= (get (model__ v) i1) e))))
...
;; H
  (assert
  (and (= o8 (last4 (model__ v)))
  (and (dynamic_property4 first3 last5 o8) (= o8 (last4 (model__ v))))))
...
;; H
  (assert
  (= result6 (ite (<= first use_vectors__my_find__result13) o9 false)))
...
;; H
  (assert
  (=> (= result6 true)
  (and (= o7 (get (model__ v) o6))
  (and (in_range4 o7) (= o7 (get (model__ v) o6))))))
...
;; H
  (assert
  (and (= o4 (- use_vectors__my_find__result13 1)) (in_range1
  (- use_vectors__my_find__result13 1))))
