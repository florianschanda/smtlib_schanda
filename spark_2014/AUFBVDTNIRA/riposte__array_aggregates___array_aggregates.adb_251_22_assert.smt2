...
(declare-fun user_eq3 (t81b t81b) Bool)

(declare-fun dummy3 () t81b)

(declare-datatypes () ((t81b__ref (mk_t81b__ref (t81b__content t81b)))))
(define-fun t81b__ref___projection ((a t81b__ref)) t81b (t81b__content a))
...
(declare-fun user_eq4 (t79b t79b) Bool)

(declare-fun dummy4 () t79b)
...
(declare-fun temp___539 ((Array Int unsigned_byte)) (Array Int (Array Int unsigned_byte)))

;; def_axiom
  (assert
  (forall ((temp___541 (Array Int unsigned_byte)))
  (forall ((temp___542 Int))
  (= (select (temp___539 temp___541) temp___542) temp___541))))

(declare-fun temp___543 (Int) (Array Int unsigned_byte))

;; def_axiom
  (assert
  (forall ((temp___545 Int))
  (forall ((temp___546 Int))
  (= (select (temp___543 temp___545) temp___546) (of_rep temp___545)))))
...
;; H
  (assert (= o (temp___543 12)))

;; H
  (assert (= o1 (temp___539 o)))
