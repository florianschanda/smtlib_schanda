...
(declare-fun o7 () (Array Int element_t))

(declare-fun o8 () set_length)
...
(declare-fun result1 () set_length)

(declare-fun result2 () (Array Int element_t))

(declare-fun s__split_fields4 () set_length)

(declare-fun s__split_fields5 () (Array Int element_t))

(declare-fun result3 () set_length)

(declare-fun result4 () (Array Int element_t))

(declare-fun s__split_fields6 () set_length)

(declare-fun s__split_fields7 () (Array Int element_t))

(declare-fun s__split_fields8 () set_length)

(declare-fun s__split_fields9 () (Array Int element_t))

(declare-fun s__split_fields10 () set_length)
...
;; H
  (assert
  (and
  (= (valid (mk___rep (mk___split_fields s__split_fields s__split_fields1))) true)
  (not
  (= (full (mk___rep (mk___split_fields s__split_fields s__split_fields1))) true))))
...
;; H
  ...
  (= (to_rep1 (select s__split_fields1 i)) value))))))
...
;; H
  (assert
  (=> (= result true)
  (and (= o1 (+ (to_rep s__split_fields) 1)) (in_range2
...
;; H
  (assert
  (=> (= result true)
  (and (<= 1 (to_rep s__split_fields4)) (<= (to_rep s__split_fields4) 10))))
...
;; WP_parameter_def
 ;; File "natural_set.ads", line 63, characters 0-0
  (not
  (= (contains
     (mk___rep (mk___split_fields s__split_fields8 s__split_fields9)) 
     value) true)))
(check-sat)
