...
(declare-fun user_eq1 (t105b t105b) Bool)

(declare-fun dummy1 () t105b)
...
(declare-fun temp___613 (Int) (Array Int unsigned_byte))

;; def_axiom
  (assert
  (forall ((temp___615 Int))
  (forall ((temp___616 Int))
  (= (select (temp___613 temp___615) temp___616) (of_rep temp___615)))))
...
(assert
;; WP_parameter_def
 ;; File "array_aggregates.adb", line 336, characters 0-0
  (not (= (to_rep (select x1 1)) 4)))
(check-sat)
