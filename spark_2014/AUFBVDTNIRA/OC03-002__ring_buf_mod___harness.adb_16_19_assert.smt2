...
(define-fun r__split_fields23 () us_split_fields (mk___split_fields
                                                 r__split_fields
                                                 r__split_fields1
                                                 r__split_fields2))
...
;; H
  (assert (to_model__function_guard (to_model (mk___rep r__split_fields23))
  (mk___rep r__split_fields23)))

;; H
  (assert
  (= (let ((temp___224 (to_model (mk___rep r__split_fields23))))
...
;; H
  ...
  (func_push (to_model (mk___rep r__split_fields23)) x)
  (to_model (mk___rep r__split_fields23)) x))

;; H
  (assert (to_model__function_guard (to_model (mk___rep r__split_fields22))
  (mk___rep r__split_fields22)))

;; H
  (assert
  (= (let ((temp___242 (func_push (to_model (mk___rep r__split_fields23)) x)))
     (let ((temp___241 (to_model (mk___rep r__split_fields22))))
...
;; H
  (assert (func_push__function_guard
  (func_push (to_model (mk___rep r__split_fields22)) y)
  (to_model (mk___rep r__split_fields22)) y))

;; H
  (assert (to_model__function_guard (to_model (mk___rep r__split_fields21))
  (mk___rep r__split_fields21)))

;; H
  (assert
  (= (let ((temp___242 (func_push (to_model (mk___rep r__split_fields22)) y)))
     (let ((temp___241 (to_model (mk___rep r__split_fields21))))
     (bool_eq3 (elts temp___241) (to_rep (first (rt temp___241)))
     (to_rep (last (rt temp___241))) (elts temp___242)
     (to_rep (first (rt temp___242))) (to_rep (last (rt temp___242)))))) true))
...
;; H
  ...
  (func_pop (to_model (mk___rep r__split_fields21)))
  (to_model (mk___rep r__split_fields21))))

;; H
  (assert (to_model__function_guard (to_model (mk___rep r__split_fields20))
  (mk___rep r__split_fields20)))
...
;; H
  ...
  (func_head (to_model (mk___rep r__split_fields21)))
  (to_model (mk___rep r__split_fields21))))
...
;; H
  ...
  (and
  (and
  (= (let ((temp___250 (func_pop (to_model (mk___rep r__split_fields21)))))
     (let ((temp___249 (to_model (mk___rep r__split_fields20))))
  ...
  (= h1 (func_head (to_model (mk___rep r__split_fields21))))) (in_range 
  h1)))
...
;; H
  (assert (func_push__function_guard
  (func_push (to_model (mk___rep r__split_fields20)) z)
  (to_model (mk___rep r__split_fields20)) z))

;; H
  (assert (to_model__function_guard (to_model (mk___rep r__split_fields19))
  (mk___rep r__split_fields19)))

;; H
  (assert
  (= (let ((temp___242 (func_push (to_model (mk___rep r__split_fields20)) z)))
     (let ((temp___241 (to_model (mk___rep r__split_fields19))))
     (bool_eq3 (elts temp___241) (to_rep (first (rt temp___241)))
     (to_rep (last (rt temp___241))) (elts temp___242)
     (to_rep (first (rt temp___242))) (to_rep (last (rt temp___242)))))) true))
...
;; H
  (assert (func_pop__function_guard
  (func_pop (to_model (mk___rep r__split_fields19)))
  (to_model (mk___rep r__split_fields19))))

;; H
  (assert (to_model__function_guard (to_model (mk___rep r__split_fields18))
  (mk___rep r__split_fields18)))
...
;; H
  (assert (func_head__function_guard
  (func_head (to_model (mk___rep r__split_fields19)))
  (to_model (mk___rep r__split_fields19))))
...
;; H
  ...
  (and
  (and
  (= (let ((temp___250 (func_pop (to_model (mk___rep r__split_fields19)))))
     (let ((temp___249 (to_model (mk___rep r__split_fields18))))
     (bool_eq3 (elts temp___249) (to_rep (first (rt temp___249)))
     (to_rep (last (rt temp___249))) (elts temp___250)
     (to_rep (first (rt temp___250))) (to_rep (last (rt temp___250)))))) true)
  (= h2 (func_head (to_model (mk___rep r__split_fields19))))) (in_range 
  h2)))
