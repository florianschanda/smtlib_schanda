...
(define-fun tint_arrayD1__ref_5__projection ((a tint_arrayD1__ref)) integer 
...
(define-fun tint_arrayT__ref_5__projection ((a tint_arrayT__ref)) us_t1 
...
(declare-datatypes ()
((t128b__ref (mk_t128b__ref (t128b__content integer)))))
(define-fun t128b__ref___projection ((a t128b__ref)) integer (t128b__content
                                                             a))
...
(define-fun tnumber_array_typeD1__ref_5__projection ((a tnumber_array_typeD1__ref)) integer 
...
(define-fun number_array_type__ref_5__projection ((a number_array_type__ref)) us_t3 
...
(declare-datatypes ()
((t132b__ref (mk_t132b__ref (t132b__content integer)))))
(define-fun t132b__ref___projection ((a t132b__ref)) integer (t132b__content
                                                             a))
...
(declare-datatypes ()
((t134b__ref (mk_t134b__ref (t134b__content integer)))))
(define-fun t134b__ref___projection ((a t134b__ref)) integer (t134b__content
                                                             a))
...
(define-fun tint_arrayB__ref_5__projection ((a tint_arrayB__ref)) us_t5 
  (tint_arrayB__content a))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__aggregate_def (Int
  Int Int Int Int Int Int Int Int Int Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___1502 Int) (temp___1503 Int) (temp___1504 Int)
  (temp___1505 Int) (temp___1506 Int) (temp___1507 Int) (temp___1508 Int)
  (temp___1509 Int) (temp___1510 Int) (temp___1511 Int) (temp___1512 Int)
  (temp___1513 Int))
  (let ((temp___1501 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__aggregate_def
                     temp___1502 temp___1503 temp___1504 temp___1505
                     temp___1506 temp___1507 temp___1508 temp___1509
                     temp___1510 temp___1511 temp___1512 temp___1513)))
  (and
  (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1512
  temp___1513)
  (and (= (first7 temp___1501) temp___1512)
  (= (last7 temp___1501) temp___1513)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___1501) (+ (first1 source) 0)) (of_rep1
                                                            temp___1502))
  (= (select (to_array2 temp___1501) (+ (first1 source) 1)) (of_rep1
                                                            temp___1503)))
  (= (select (to_array2 temp___1501) (+ (first1 source) 2)) (of_rep1
                                                            temp___1504)))
  (= (select (to_array2 temp___1501) (+ (first1 source) 3)) (of_rep1
                                                            temp___1505)))
  (= (select (to_array2 temp___1501) (+ (first1 source) 4)) (of_rep1
                                                            temp___1506)))
  (= (select (to_array2 temp___1501) (+ (first1 source) 5)) (of_rep1
                                                            temp___1507)))
  (= (select (to_array2 temp___1501) (+ (first1 source) 6)) (of_rep1
                                                            temp___1508)))
  (= (select (to_array2 temp___1501) (+ (first1 source) 7)) (of_rep1
                                                            temp___1509)))
  (= (select (to_array2 temp___1501) (+ (first1 source) 8)) (of_rep1
                                                            temp___1510)))
  (= (select (to_array2 temp___1501) (+ (first1 source) 9)) (of_rep1
                                                            temp___1511)))))))
...
(define-fun tnumber_array_typeB__ref_5__projection ((a tnumber_array_typeB__ref)) us_t6 
  (tnumber_array_typeB__content a))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__aggregate_def (Int
  Int Int) us_t4)

;; def_axiom
  (assert
  (forall ((temp___1519 Int) (temp___1520 Int) (temp___1521 Int))
  (let ((temp___1518 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__aggregate_def
                     temp___1519 temp___1520 temp___1521)))
  (and
  (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1520
  temp___1521)
  (and (= (first13 temp___1518) temp___1520)
  (= (last13 temp___1518) temp___1521)))
  (forall ((temp___1522 Int))
  (= (select (to_array4 temp___1518) temp___1522) (of_rep1 temp___1519)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_258 us_t3)
  ...
  (temp___do_toplevel_257 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 9)
                                      (first10 temp___expr_258)
                                      (last10 temp___expr_258))
                                      (and
                                      (= (first10 temp___expr_258) (first1
                                                                   source))
                                      (= (last10 temp___expr_258) (+ 
                                      (first1 source) 9))))))
...
(declare-fun temp___1516 () (Array Int integer))

(declare-fun temp___15161 () t2)

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume1 () t1)

(declare-fun temp___1524 () (Array Int integer))

(declare-fun temp___15241 () t4)

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume1 () t3)

(declare-fun temp___1531 () Int)
...
;; H
  ...
  (forall ((index4 Int))
  (=>
  (and (<= (to_rep1 (first (rt source))) index4)
  (<= index4 (to_rep1 (last (rt source)))))
...
;; H
  ...
  (= (to_rep1
     (first6
     (rt2
     (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__aggregate_def
     2 1 4 7 4 7 9 9 9 9 (to_rep1 (first (rt source)))
...
;; H
  (assert
  (= (mk___t2 temp___1516 temp___15161) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__aggregate_def
                                        2 1 4 7 4 7 9 9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___15161)) (to_rep1 (last6 temp___15161)))
     (+ (- (to_rep1 (last6 temp___15161)) (to_rep1 (first6 temp___15161))) 1)
...
;; H
  (assert
  (= (slide1 temp___1516 (to_rep1 (first6 temp___15161))
     (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume))

;; H
  (assert
  (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) 
  aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume1))
...
;; H
  (assert
  (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume))
...
;; H
  ...
  (= (to_rep1
     (first12
     (rt4
     (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__aggregate_def
...
;; H
  (assert
  (= (mk___t4 temp___1524 temp___15241) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__aggregate_def
                                        0 (to_rep1 (first (rt source)))
                                        (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___15241)) (to_rep1
                                               (last12 temp___15241)))
     (+ (- (to_rep1 (last12 temp___15241)) (to_rep1 (first12 temp___15241))) 1)
     0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1
                                                  (first (rt source))) 9))
        (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1
                                                  (first (rt source)))) 1)
...
;; H
  (assert
  (= (slide1 temp___1524 (to_rep1 (first12 temp___15241))
     (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume))

;; H
  (assert
  (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) 
  aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume1))
...
;; H
  (assert
  (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume))
...
;; H
  (assert
  (and (= temp___1531 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 n__first) temp___1529)
  (<= temp___1529 (to_rep1 n__last)))
  (=> (< index2 temp___1529)
  (= (select n3 temp___1529) (select n1 temp___1529))))))
  (and (<= (to_rep1 (first (rt source))) index2)
  (<= index2 (+ (to_rep1 (first (rt source))) 9)))))

;; H
  (assert (not (= index2 temp___1531)))
...
(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 356, characters 0-0
  (not (<= 0 (to_rep1 (select n4 i)))))
(check-sat)
