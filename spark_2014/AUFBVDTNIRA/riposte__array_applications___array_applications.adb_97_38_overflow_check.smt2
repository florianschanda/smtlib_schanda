...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= 0 j1) (<= j1 i2))
  (and (<= 0 (to_rep (select a4 j1)))
  (< (to_rep (select a4 j1)) (power 2 j1)))))))
...
;; H
  ...
  (=> (and (<= 0 temp___174) (<= temp___174 30))
  (=> (< i2 temp___174) (= (select a4 temp___174) (select a2 temp___174))))))
  (and (<= 2 i2) (<= i2 30))))
