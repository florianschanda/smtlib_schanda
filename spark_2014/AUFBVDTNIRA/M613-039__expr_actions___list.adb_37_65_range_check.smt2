...
;; H
  (assert (and (= o11 (- last3 i9)) (in_range1 (- last3 i9))))

;; H
  (assert
  (and
  (and (= o10 (to__ (mk___rep s__split_fields10))) (to____function_guard 
  o10 (mk___rep s__split_fields10))) (dynamic_invariant1 o10 true false
  true)))

;; H
  (assert (= o12 (to_rep (last (rt o10)))))

;; H
  (assert (= result4 (ite (= o12 o11) true false)))
...
;; H
  (assert (=> (= result4 true) (= o8 (elts list__reverse_list__L_2__R20b))))

;; H
  (assert
  (=> (= result4 true) (= temp___484 (mk___t2 o8 (mk2 first2 temp___482)))))
...
;; H
  (assert (=> (= result4 true) (= o9 (elts list__reverse_list__L_2__R16b))))

;; H
  (assert
  (=> (= result4 true) (= temp___483 (mk___t1 o9 (mk1 first2 temp___481)))))
