...
(declare-fun dw1000__register_types__dx_time_type__dx_time__first__bit () Int)

(declare-fun dw1000__register_types__dx_time_type__dx_time__last__bit () Int)

(declare-fun dw1000__register_types__dx_time_type__dx_time__position () Int)
...
(define-fun register_type__ref_18__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_13__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_13__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2279 us_t1)
  (temp___is_init_2276 Bool) (temp___skip_constant_2277 Bool)
  (temp___do_toplevel_2278 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2277 true))
                                       (and (dynamic_property2 1 5
                                       (first3 temp___expr_2279)
                                       (last4 temp___expr_2279))
                                       (and (= (first3 temp___expr_2279) 1)
                                       (= (last4 temp___expr_2279) 5)))))
...
(define-fun target__ref_6__projection ((a target__ref)) us_t2 (target__content
                                                              a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_6__projection ((a source__ref)) us_rep (source__content
                                                               a))

(define-fun dynamic_invariant1 ((temp___expr_2295 us_t2)
  (temp___is_init_2292 Bool) (temp___skip_constant_2293 Bool)
  (temp___do_toplevel_2294 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2293 true))
                                       (and (dynamic_property3 1 5
                                       (first5 temp___expr_2295)
                                       (last6 temp___expr_2295))
                                       (and (= (first5 temp___expr_2295) 1)
                                       (= (last6 temp___expr_2295) 5)))))
...
(declare-fun temp___7582 () (Array Int bits_8))

(declare-fun temp___75821 () t2)

(declare-fun temp___7583 () (Array Int bits_8))

(declare-fun temp___75831 () t1)

(define-fun temp___75822 () us_t2 (mk___t2 temp___7582 temp___75821))
...
;; H
  (assert
  (and
  (and (= temp___75822 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___75822 reg)) (dynamic_invariant1
  temp___75822 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___75821)) (to_rep (last5 temp___75821)))
     (+ (- (to_rep (last5 temp___75821)) (to_rep (first4 temp___75821))) 1)
     0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))

;; H
  (assert (= temp___7582 temp___7583))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___75821)) (to_rep (last5 temp___75821))) 
  temp___75831))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___75831)) (to_rep (last3 temp___75831)))
     (+ (- (to_rep (last3 temp___75831)) (to_rep (first2 temp___75831))) 1)
