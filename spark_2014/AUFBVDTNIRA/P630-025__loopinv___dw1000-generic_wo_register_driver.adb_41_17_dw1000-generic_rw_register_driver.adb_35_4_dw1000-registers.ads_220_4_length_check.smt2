...
(define-fun dynamic_invariant ((temp___expr_2279 us_t1)
  ...
  (temp___do_toplevel_2278 Bool)) Bool (=>
                                       ...
                                       (last3 temp___expr_2279))
                                       (and (= (first3 temp___expr_2279) 1)
                                       (= (last3 temp___expr_2279) 5)))))
...
(define-fun dynamic_invariant1 ((temp___expr_2295 us_t2)
  ...
  (temp___do_toplevel_2294 Bool)) Bool (=>
                                       ...
                                       (last5 temp___expr_2295))
                                       (and (= (first5 temp___expr_2295) 1)
                                       (= (last5 temp___expr_2295) 5)))))
...
;; H
  (assert
  (and (= temp___75822 (register_to_bytes reg)) (dynamic_invariant1
  temp___75822 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___75821)) (to_rep (last4 temp___75821)))
     (+ (- (to_rep (last4 temp___75821)) (to_rep (first4 temp___75821))) 1)
     0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___75821)) (to_rep (last4 temp___75821))) 
  temp___75831))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___75831)) (to_rep (last2 temp___75831)))
     (+ (- (to_rep (last2 temp___75831)) (to_rep (first2 temp___75831))) 1)
