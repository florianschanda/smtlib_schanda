...
;; WP_parameter_def
 ;; File "tree_model.ads", line 49, characters 0-0
  (not
  (not
  (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select r6 j3)))
     (rec__tree_model__path_type__a (us_split_fields1 (select r6 k)))) true))))
(check-sat)
