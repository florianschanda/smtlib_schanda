...
(define-fun o4 () us_rep1 (mk___rep1 (mk___split_fields1 o1)))
...
;; H
  (assert
  (or
  (= (bool_eq4 (mk___rep1 current__split_fields3)
     (first
     (mk___rep container__split_discrs
...
;; H
  ...
  (ite (= (= (length
             (mk___rep container__split_discrs
             (mk___split_fields container__split_fields))) 0) true)
  (= (bool_eq4 o3 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields))) o3) true)
  (= (get1
     (positions
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields))) o3) 1)))))

;; H
  (assert (= result3 (bool_eq4 (mk___rep1 current__split_fields3) o3)))
...
;; H
  ...
  (ite (= (ite (= (bool_eq4 (mk___rep1 current__split_fields3) no_element) false) (= 
          (get1
          (positions
          (mk___rep container__split_discrs
          (mk___split_fields container__split_fields)))
          (mk___rep1 current__split_fields3)) 1) true) true)
  (= (bool_eq4 o4 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields))) o4) true)
  (= (get1
     (positions
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields))) o4) (- (get1
                                                          (positions
                                                          (mk___rep
                                                          container__split_discrs
                                                          (mk___split_fields
