...
;; invariant____def_axiom
  ...
  (! (= (= (invariant__ n speed distance) true)
     (and
     (and (le (mul RNE1 (of_int RNE1 n) (neg fliteral2)) speed) (le speed
     (mul RNE1 (of_int RNE1 n) fliteral2)))
     (and (le
     (mul RNE1
     (mul RNE1 (mul RNE1 (of_int RNE1 n) (of_int RNE1 (+ n 1)))
     (neg fliteral2)) fliteral3) distance) (le distance
     (mul RNE1
     (mul RNE1 (mul RNE1 (of_int RNE1 n) (of_int RNE1 (+ n 1))) fliteral2)
...
;; H
  (assert
  (and
  (= o (add RNE1 speed (mul RNE1 (mul RNE1 factor fliteral4) fliteral5)))
  (tqtisFinite
  (add RNE1 speed (mul RNE1 (mul RNE1 factor fliteral4) fliteral5)))))
