...
;; def_axiom
  ...
  (and (= (first4 temp___288) temp___290) (= (last4 temp___288) temp___291)))
...
(declare-fun temp___294 () (Array Int character))

(declare-fun temp___2941 () t1)

(declare-fun temp___295 () (Array Int character))

(declare-fun temp___2951 () t)
...
;; H
  (assert
  (= (to_rep1
     (first3 (rt1 (temp___287 32 (to_rep1 a__first) (to_rep1 a__last))))) 
  (to_rep1 a__first)))

;; H
  (assert
  (= (to_rep1
     (last3 (rt1 (temp___287 32 (to_rep1 a__first) (to_rep1 a__last))))) 
  (to_rep1 a__last)))
...
;; H
  (assert
  (= (mk (to_rep1 (first3 temp___2941)) (to_rep1 (last3 temp___2941))) 
  temp___2951))
