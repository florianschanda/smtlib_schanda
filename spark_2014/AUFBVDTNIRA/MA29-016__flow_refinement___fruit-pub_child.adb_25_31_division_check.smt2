...
;; H
  ...
  (and
  (and
  (= o4 (number_of_oranges apples oranges price_of_apple price_of_orange
        extra_cost))
  (number_of_oranges__function_guard o4 apples oranges price_of_apple
  price_of_orange extra_cost)) (in_range1 o4)))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (not (= oranges_in_fruit_salad 0))))
(check-sat)
