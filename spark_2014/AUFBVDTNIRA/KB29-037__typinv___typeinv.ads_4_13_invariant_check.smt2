...
(declare-fun typeinv__new_t__result () Int)
...
(declare-fun typeinv__new_t__result1 () Int)

(declare-fun typeinv__new_t__result2 () Int)

(declare-fun typeinv__new_t__result3 () Int)

(declare-fun typeinv__new_t__result4 () Int)

(declare-fun typeinv__new_t__result5 () Int)

;; H
  (assert (in_range x))

;; H
  (assert (= typeinv__new_t__result1 typeinv__new_t__result2))

;; H
  (assert (= typeinv__new_t__result3 typeinv__new_t__result1))

;; H
  (assert (and (= temp___141 x) (in_range1 x)))

;; H
  (assert (type_invariant temp___141))

;; H
  (assert (= o temp___141))

;; H
  (assert (= result typeinv__new_t__result))

;; H
  (assert (= typeinv__new_t__result1 o))

;; H
  (assert
  (= (mk_int__ref typeinv__new_t__result4) (mk_int__ref
                                           typeinv__new_t__result2)))

;; H
  (assert (= typeinv__new_t__result5 typeinv__new_t__result3))

(assert
;; WP_parameter_def
 ;; File "typeinv.ads", line 9, characters 0-0
  (not (type_invariant typeinv__new_t__result4)))
(check-sat)
