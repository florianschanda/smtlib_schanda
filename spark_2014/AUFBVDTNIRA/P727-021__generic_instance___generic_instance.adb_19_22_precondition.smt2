...
(declare-fun generic_instance__root__f__first__bit () Int)

(declare-fun generic_instance__root__f__last__bit () Int)

(declare-fun generic_instance__root__f__position () Int)
...
;; H
  (assert (f__function_guard (f (mk___rep x__split_fields2 x__attr__tag))
  (mk___rep x__split_fields2 x__attr__tag)))

;; H
  (assert (= (f (mk___rep x__split_fields2 x__attr__tag)) true))
