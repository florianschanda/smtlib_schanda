...
;; ispresent__def_axiom
  ...
  (! (=> (ispresent__function_guard (ispresent theadmin1) theadmin1)
...
;; H
  (assert (ispresent__function_guard (ispresent theadmin) theadmin))
