...
;; H
  (assert
  (and (= o19 (statusiswaitingfinishadminop (let ((subject state)) state7)))
  (statusiswaitingfinishadminop__function_guard o19
  (let ((subject state)) state7))))

;; H
  (assert
  (and (= o20 (statusiswaitingstartadminop (let ((subject state)) state7)))
...
;; H
  (assert
  (and
  (= o15 (statusiswaitingremoveadmintokenfail (let ((subject state)) state7)))
  (statusiswaitingremoveadmintokenfail__function_guard o15
  (let ((subject state)) state7))))

;; H
  (assert
  (and (= o16 (statusisgotadmintoken (let ((subject state)) state7)))
  (statusisgotadmintoken__function_guard o16 (let ((subject state)) state7))))
...
;; H
  (assert
  (=> (= result5 true)
  (and (= o14 (statusiswaitingstartadminop (let ((subject state)) state7)))
