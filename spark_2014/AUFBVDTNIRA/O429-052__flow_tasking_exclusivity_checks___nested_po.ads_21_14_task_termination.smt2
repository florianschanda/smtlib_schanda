...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__nested_po__inner__po pt)))))
...
(declare-fun nested_po__inner__po__first__bit () Int)

(declare-fun nested_po__inner__po__last__bit () Int)

(declare-fun nested_po__inner__po__position () Int)
...
(declare-fun nested_po__outer__inner_rec__first__bit () Int)

(declare-fun nested_po__outer__inner_rec__last__bit () Int)

(declare-fun nested_po__outer__inner_rec__position () Int)
...
(declare-datatypes ()
((outer__ref (mk_outer__ref (outer__content us_rep1)))))
