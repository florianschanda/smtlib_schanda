...
(declare-fun temp___178 () (Array Int contents_type))

(declare-fun temp___182 () (Array Int contents_type))
...
(declare-fun key4 () Int)

(declare-fun low3 () Int)

(declare-fun table5 () (Array Int contents_type))

(declare-fun key5 () Int)

(declare-fun low4 () Int)

(declare-fun table6 () (Array Int contents_type))

(declare-fun key6 () Int)

(declare-fun low5 () Int)

(declare-fun table7 () (Array Int contents_type))

(declare-fun key7 () Int)

(declare-fun low6 () Int)

(declare-fun table8 () (Array Int contents_type))

(declare-fun key8 () Int)

(declare-fun low7 () Int)

(declare-fun table9 () (Array Int contents_type))

(declare-fun key9 () Int)

(declare-fun low8 () Int)
...
;; H
  (assert (perm__function_guard (perm table3 temp___182) table3 temp___182))
...
;; H
  (assert (=> (and (<= 1 low1) (<= low1 99)) (= temp___180 low1)))

;; H
  (assert (=> (and (<= 1 low1) (<= low1 99)) (= temp___179 key)))

;; H
  (assert (=> (and (<= 1 low1) (<= low1 99)) (= temp___178 table)))

;; H
  (assert (=> (and (<= 1 low1) (<= low1 99)) (= temp___182 table)))
...
;; H
  (assert
  (=> (and (<= 1 low1) (<= low1 99)) (= (mk_int__ref result1) key11)))
...
;; H
  ...
  (=> (and (<= 1 low1) (<= low1 99))
  (=> (not (= key2 low1))
  (and (= (to_rep (select table2 low1)) (to_rep (select table key2)))
  (and (= (to_rep (select table2 key2)) (to_rep (select table low1)))
  (and
  (forall ((x Int))
  (=> (and (<= 1 x) (<= x 100))
  (=> (and (not (= x low1)) (not (= x key2)))
...
;; H
  (assert
  (=> (and (<= 1 low1) (<= low1 99))
  (=> (not (not (= key2 low1))) (= table2 table))))

;; H
  (assert
  (=> (and (<= 1 low1) (<= low1 99))
  (=> (not (not (= key2 low1))) (= table2 table1))))
...
;; H
  ...
  (= (perm table3 temp___182) true))))

;; H
  (assert
  (=> (and (<= 1 low1) (<= low1 99))
  (and (and (=> (<= 1 100) (in_range2 key3)) (=> (<= 1 99) (in_range4 low2)))
  (and (<= 1 low2) (<= low2 99)))))
...
;; H
  (assert
  (=> (and (<= 1 low1) (<= low1 99))
  (= (mk_int__ref low5) (mk_int__ref low3))))
...
;; H
  (assert
  (=> (and (<= 1 low1) (<= low1 99)) (= table10 (mk_map__ref table4))))
...
;; H
  (assert
  (=> (not (and (<= 1 low1) (<= low1 99))) (= table10 (mk_map__ref table))))
...
;; H
  (assert (ordered__function_guard (ordered table8 1 100) table8 1 100))

(assert
;; WP_parameter_def
 ;; File "t3q5.ads", line 19, characters 0-0
  (not (= (ordered table8 1 100) true)))
(check-sat)
