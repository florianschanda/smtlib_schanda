...
(declare-fun stable_marriage__matching__invert__result () (Array Int (Array Int ranking)))

(declare-fun o () (Array Int ranking))

(declare-fun o1 () (Array Int (Array Int ranking)))

(declare-fun temp___596 () (Array Int (Array Int ranking)))
...
(declare-fun result2 () (Array Int (Array Int ranking)))

(declare-fun result__3 () (Array Int (Array Int ranking)))

(declare-fun result__4 () (Array Int (Array Int ranking)))

(declare-fun g23 () Int)

(declare-fun result__5 () (Array Int (Array Int ranking)))

(declare-fun g24 () Int)

(declare-fun result__6 () (Array Int (Array Int ranking)))

(declare-fun g25 () Int)

(declare-fun result__7 () (Array Int (Array Int ranking)))

(declare-fun g26 () Int)

(declare-fun result3 () (Array Int (Array Int ranking)))

(declare-fun stable_marriage__matching__invert__result1 () (Array Int (Array Int ranking)))

(declare-fun stable_marriage__matching__invert__result2 () (Array Int (Array Int ranking)))

(declare-fun stable_marriage__matching__invert__result3 () (Array Int (Array Int ranking)))

(declare-fun result__8 () (Array Int (Array Int ranking)))

(declare-fun g27 () Int)

(declare-fun stable_marriage__matching__invert__result4 () (Array Int (Array Int ranking)))

(declare-fun result__9 () (Array Int (Array Int ranking)))

(declare-fun g28 () Int)

(declare-fun stable_marriage__matching__invert__result5 () (Array Int (Array Int ranking)))

(define-fun g29 () int__ref (mk_int__ref g25))

(define-fun result__10 () map__ref3 (mk_map__ref3 result__6))

(declare-fun result4 () (Array Int (Array Int ranking)))

;; H
  (assert
  (forall ((g210 Int)) (is_permutation_1__function_guard
  (is_permutation_1 (select r2 g210)) (select r2 g210))))
...
;; H
  (assert (=> (and (<= 1 g21) (<= g21 64)) (= temp___596 result__1)))

;; H
  (assert (=> (and (<= 1 g21) (<= g21 64)) (= temp___595 g21)))
...
;; H
  ...
  (=> (<= g22 temp___597)
  (= (select result__2 temp___597) (select temp___596 temp___597))))))
  (and (<= 1 g22) (<= g22 64)))))
...
;; H
  (assert (=> (and (<= 1 g21) (<= g21 64)) (= o3 (store result__2 g22 o2))))

;; H
  (assert (=> (and (<= 1 g21) (<= g21 64)) (= result__2 result2)))

;; H
  (assert (=> (and (<= 1 g21) (<= g21 64)) (= result__3 o3)))
...
;; H
  (assert (invert_1__function_guard (invert_1 (select r2 g210))
  (select r2 g210)))
...
;; WP_parameter_def
 ;; File "stable_marriage.adb", line 127, characters 0-0
  (not
  (= (bool_eq5 (select stable_marriage__matching__invert__result4 g210) 1 64
