...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral2) (= (tqtreal fliteral2) 5040.0)))

(declare-fun fliteral3 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 120.0)))

(declare-fun fliteral4 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral4) (= (tqtreal fliteral4) 6.0)))
...
;; H
  (assert
  (and (and (= o3 (pow7 x)) (pow7__function_guard o3 x))
  (and (tqtisFinite o3)
  (= o3 (mul RNE2
        (mul RNE2 (mul RNE2 (mul RNE2 (mul RNE2 (mul RNE2 x x) x) x) x) x) 
        x)))))

;; H
  (assert (= o4 (div1 RNE2 o3 fliteral2)))

;; H
  (assert
  (and (and (= o1 (pow5 x)) (pow5__function_guard o1 x))
  (and (tqtisFinite o1)
  (= o1 (mul RNE2 (mul RNE2 (mul RNE2 (mul RNE2 x x) x) x) x)))))

;; H
  (assert (= o2 (div1 RNE2 o1 fliteral3)))

;; H
  (assert
  (and (and (= o (pow3 x)) (pow3__function_guard o x))
  (and (tqtisFinite o) (= o (mul RNE2 (mul RNE2 x x) x)))))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (not (eq fliteral4 zeroF))))
(check-sat)
