...
;; mk_def
  ...
  (! (=> (in_range f1)
     (=> (in_range l)
     (and (= (to_rep1 (first1 (mk f1 l))) f1)
     (= (to_rep1 (last1 (mk f1 l))) l)))) :pattern ((mk f1 l)) )))
...
;; mk_def
  ...
  (! (=> (in_range f1)
     (=> (in_range l)
     (and (= (to_rep1 (first4 (mk1 f1 l))) f1)
     (= (to_rep1 (last4 (mk1 f1 l))) l)))) :pattern ((mk1 f1 l)) )))
...
(define-fun bool_eq7 ((x us_t1)
  (y us_t1)) Bool (bool_eq3 (elts1 x) (to_rep1 (first4 (rt1 x)))
...
;; mk_def
  ...
  (! (=> (in_range f1)
     (=> (in_range l)
     (and (= (to_rep1 (first6 (mk2 f1 l))) f1)
     (= (to_rep1 (last6 (mk2 f1 l))) l)))) :pattern ((mk2 f1 l)) )))
...
;; def_axiom
  ...
  (and (= (first5 temp___177) temp___179) (= (last5 temp___177) temp___180)))
...
(define-fun dynamic_invariant3 ((temp___expr_171 us_t)
  ...
  (temp___do_toplevel_170 Bool)) Bool (=>
                                      ...
                                      (first2 temp___expr_171)
                                      (last2 temp___expr_171))
                                      (and (= (first2 temp___expr_171) 
                                      r1b) (= (last2 temp___expr_171) 
                                      r2b)))))
...
(declare-fun dyn__R3b__assume () Int)

(declare-fun temp___183 () (Array Int character))

(declare-fun temp___1831 () t1)

;; H
  (assert
  (and
  (and (= dyn__R1b__assume (f Tuple0)) (f__function_guard dyn__R1b__assume
  Tuple0)) (and (in_range dyn__R1b__assume) (= dyn__R1b__assume 1))))
...
;; H
  (assert
  (and
  (and (= dyn__R2b__assume (f Tuple0)) (f__function_guard dyn__R2b__assume
  Tuple0)) (and (in_range dyn__R2b__assume) (= dyn__R2b__assume 1))))
...
;; H
  (assert
  (and (and (= o (f Tuple0)) (f__function_guard o Tuple0))
  (and (in_range o) (= o 1))))
...
;; H
  (assert
  (= (to_rep1 (first4 (rt1 (dyn__x__aggregate_def 48 r3b r3b)))) r3b))

;; H
  (assert (= (to_rep1 (last4 (rt1 (dyn__x__aggregate_def 48 r3b r3b)))) 
  r3b))

;; H
  (assert
  (= (mk___t1 temp___183 temp___1831) (dyn__x__aggregate_def 48 r3b r3b)))

(assert
;; WP_parameter_def
 ;; File "dyn.adb", line 2, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first4 temp___1831)) (to_rep1 (last4 temp___1831)))
     (+ (- (to_rep1 (last4 temp___1831)) (to_rep1 (first4 temp___1831))) 1)
     0) (ite (<= r1b r2b) (+ (- r2b r1b) 1) 0))))
(check-sat)
