...
(declare-fun to_rep (long_float) t)

(declare-fun of_rep (t) long_float)
...
;; range_axiom
  (assert
  (forall ((x long_float)) (! (tqtisFinite
...
(declare-fun first (t1) log_index)

(declare-fun last (t1) log_index)

(declare-fun mk ((_ BitVec 16) (_ BitVec 16)) t1)
...
(declare-datatypes ()
((us_t (mk___t (elts (Array (_ BitVec 16) us_rep))(rt t1)))))
...
(define-fun dynamic_invariant2 ((temp___expr_57 t) (temp___is_init_54 Bool)
...
(declare-fun make_entry ((_ BitVec 16) (_ BitVec 16) (_ BitVec 16) t
  Bool) us_rep)

(declare-fun make_entry__function_guard (us_rep (_ BitVec 16) (_ BitVec 16)
  (_ BitVec 16) t Bool) Bool)
...
;; make_entry__def_axiom
  ...
  (forall ((estimatedgroundvelocity t))
...
(declare-fun first2 (t2) log_index)

(declare-fun last3 (t2) log_index)

(declare-fun mk1 ((_ BitVec 16) (_ BitVec 16)) t2)
...
(declare-datatypes ()
((us_t1 (mk___t1 (elts1 (Array (_ BitVec 16) us_rep))(rt1 t2)))))
...
(declare-fun first5 (t3) log_index)

(declare-fun last6 (t3) log_index)

(declare-fun mk2 ((_ BitVec 16) (_ BitVec 16)) t3)
...
(declare-datatypes ()
((us_t2 (mk___t2 (elts2 (Array (_ BitVec 16) us_rep))(rt2 t3)))))
...
(declare-fun mk3 ((_ BitVec 16) (_ BitVec 16)) t4)
...
(declare-datatypes ()
((us_t3 (mk___t3 (elts3 (Array (_ BitVec 16) us_rep))(rt3 t4)))))
...
(declare-fun first10 (t5) log_index)

(declare-fun last11 (t5) log_index)

(declare-fun mk4 ((_ BitVec 16) (_ BitVec 16)) t5)
...
(declare-datatypes ()
((us_t4 (mk___t4 (elts4 (Array (_ BitVec 16) us_rep))(rt4 t5)))))
...
;; H
  (assert (= (to_rep2 event_log__split_fields1) r4b))

;; H
  (assert (in_range2 r4b))

;; H
  (assert (= (to_rep2 event_log__split_fields2) r5b))
...
;; H
  (assert (= o3 temp___282))

;; H
  (assert (= (mk2 r4b r5b) temp___2821))
