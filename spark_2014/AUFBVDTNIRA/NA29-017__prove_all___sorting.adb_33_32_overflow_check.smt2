...
(declare-fun b6 () (Array Int integer))
...
(declare-fun b8 () (Array Int integer))

(declare-fun i7 () Int)

(declare-fun b9 () (Array Int integer))
...
;; H
  ...
  (<= (+ a_first length1) (+ (to_rep (last (rt a))) 1)))
  (<= (to_rep b__first) b_first))
...
;; H
  (assert
  (=> (and (<= 0 i1) (<= i1 (- length1 1)))
  (forall ((j1 Int))
  (=> (and (<= (to_rep b__first) j1) (<= j1 (to_rep b__last)))
  (and
  (=> (and (<= b_first j1) (<= j1 (- (+ b_first i2) 1)))
  (= (to_rep (select b2 j1)) (to_rep
                             (select (elts a) (- (+ a_first j1) b_first)))))
  (=> (=> (<= b_first j1) (not (<= j1 (- (+ b_first i2) 1))))
  (= (to_rep (select b2 j1)) (to_rep (select temp___248 j1)))))))))
...
;; H
  ...
  (=> (and (<= (to_rep b__first) j1) (<= j1 (to_rep b__last)))
  (and
  (=> (and (<= b_first j1) (<= j1 (- (+ b_first (+ i2 1)) 1)))
  (= (to_rep (select b3 j1)) (to_rep
                             (select (elts a) (- (+ a_first j1) b_first)))))
  (=> (=> (<= b_first j1) (not (<= j1 (- (+ b_first (+ i2 1)) 1))))
  (= (to_rep (select b3 j1)) (to_rep (select temp___240 j1)))))))))

;; H
  (assert
  (=> (and (<= 0 i1) (<= i1 (- length1 1)))
  (=> (<= 0 (- length1 1)) (dynamic_property1 0 (- length1 1) i2))))
...
;; H
  (assert
  (=> (and (<= 0 i1) (<= i1 (- length1 1))) (= b10 (mk_map__ref b4))))
...
;; H
  (assert
  (=> (not (and (<= 0 i1) (<= i1 (- length1 1)))) (= b10 (mk_map__ref b))))
...
;; H
  (assert (and (= o3 (+ b_first length1)) (in_range1 (+ b_first length1))))
...
;; H
  (assert (= o6 (ite (<= b_first j) o5 false)))
...
;; H
  (assert
  (=> (= result1 true)
  (and (<= (to_rep b__first) j) (<= j (to_rep b__last)))))

;; H
  (assert (=> (= result1 true) (= o9 j)))

;; H
  (assert (=> (= result1 true) (= o10 (select b o9))))

;; H
  (assert (=> (= result1 true) (= o11 (to_rep o10))))
...
;; H
  (assert (=> (= result1 true) (= o7 j)))

;; H
  (assert (=> (= result1 true) (= o8 (select b8 o7))))

;; H
  (assert (=> (= result1 true) (= o12 (to_rep o8))))

;; H
  (assert (=> (= result1 true) (= o13 (ite (= o12 o11) true false))))
