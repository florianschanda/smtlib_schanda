...
;; def_axiom
  ...
  (= (select (tetris_initial__delete_complete_lines__empty_line__aggregate_def
...
;; empty_line__def_axiom
  (assert
  (= empty_line (tetris_initial__delete_complete_lines__empty_line__aggregate_def
                0)))
...
(declare-fun tetris_initial__delete_complete_lines__empty_line__assume () (Array Int cell))

(declare-fun temp___771 () Int)

(declare-fun temp___769 () (Array Int (Array Int cell)))

(declare-fun temp___768 () Bool)
...
;; H
  (assert
  (= tetris_initial__delete_complete_lines__empty_line__assume (tetris_initial__delete_complete_lines__empty_line__aggregate_def
                                                               0)))

;; H
  (assert
  (= tetris_initial__delete_complete_lines__empty_line__assume empty_line))
...
;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___771 to_line1)))

;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___769 cur_board)))

;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50))
  (= temp___768 has_complete_lines1)))
...
;; H
  ...
  (=> (and (<= 1 temp___770) (<= temp___770 50))
  (=> (<= del_line2 temp___770)
  (= (select cur_board2 temp___770) (select temp___769 temp___770)))))
  (=> (<= 1 50) (in_range4 to_line2)))
...
(assert
;; WP_parameter_def
 ;; File "tetris_initial.adb", line 37, characters 0-0
