...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral2) (= (tqtreal fliteral2) 360.0)))
...
(define-fun dynamic_invariant2 ((temp___expr_1339 t)
...
(define-fun dynamic_invariant3 ((temp___expr_1345 t)
  (temp___is_init_1342 Bool) (temp___skip_constant_1343 Bool)
  (temp___do_toplevel_1344 Bool)) Bool (=>
                                       (or (= temp___is_init_1342 true) (le
                                       (neg fliteral3) fliteral3)) (in_range3
                                       temp___expr_1345)))

(declare-fun atan_2 (t t) t)

(declare-fun atan_2__function_guard (t t t) Bool)
...
(declare-fun asin (t) t)

(declare-fun asin__function_guard (t t) Bool)
...
(declare-fun euler_roll_actual () t)

(declare-fun euler_pitch_actual () t)

(declare-fun euler_yaw_actual () t)
...
(declare-fun grav_x () t)

(declare-fun grav_y () t)

(declare-fun grav_z () t)
...
(declare-fun grav_x1 () t)

(declare-fun result1 () t)

(declare-fun grav_y1 () t)

(declare-fun result2 () t)

(declare-fun grav_z1 () t)

(declare-fun result3 () t)

(declare-fun grav_x2 () t)

(declare-fun result4 () t)

(declare-fun euler_yaw_actual1 () t)

(declare-fun result5 () t)

(declare-fun euler_pitch_actual1 () t)

;; H
  (assert (=> (le (neg fliteral2) fliteral2) (in_range1 euler_roll_actual)))

;; H
  (assert (=> (le (neg fliteral2) fliteral2) (in_range1 euler_pitch_actual)))

;; H
  (assert (=> (le (neg fliteral2) fliteral2) (in_range1 euler_yaw_actual)))
...
;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite grav_x)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite grav_y)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite grav_z)))
...
;; H
  (assert
  (= grav_x1 (mul RNE2 fliteral4
             (sub RNE2 (mul RNE2 q1 q3) (mul RNE2 q0 q2)))))
...
;; H
  (assert
  (= grav_y1 (mul RNE2 fliteral4
             (add RNE2 (mul RNE2 q0 q1) (mul RNE2 q2 q3)))))
...
;; H
  (assert
  (= grav_z1 (add RNE2
             (sub RNE2 (sub RNE2 (mul RNE2 q0 q0) (mul RNE2 q1 q1))
             (mul RNE2 q2 q2)) (mul RNE2 q3 q3))))

;; H
  (assert
  (and
  (and (= o (saturate grav_x1 (neg fliteral) fliteral))
  (saturate__function_guard o grav_x1 (neg fliteral) fliteral))
  (and (tqtisFinite o)
  (ite (lt grav_x1 (neg fliteral)) (eq o (neg fliteral))
  (ite (lt fliteral grav_x1) (eq o fliteral) (eq o grav_x1))))))
...
;; H
  ...
  (and
  (= o1 (atan_2
        (mul RNE2 fliteral4 (add RNE2 (mul RNE2 q0 q3) (mul RNE2 q1 q2)))
        (sub RNE2
        (sub RNE2 (add RNE2 (mul RNE2 q0 q0) (mul RNE2 q1 q1))
        (mul RNE2 q2 q2)) (mul RNE2 q3 q3))))
  (atan_2__function_guard o1
  (mul RNE2 fliteral4 (add RNE2 (mul RNE2 q0 q3) (mul RNE2 q1 q2)))
  (sub RNE2
  (sub RNE2 (add RNE2 (mul RNE2 q0 q0) (mul RNE2 q1 q1)) (mul RNE2 q2 q2))
  (mul RNE2 q3 q3)))) (in_range3 o1)))

;; H
  (assert (= o2 (mul RNE2 o1 fliteral5)))

;; H
  (assert (= o3 (div1 RNE2 o2 fliteral6)))
...
;; H
  (assert (= o5 (mul RNE2 o4 fliteral5)))

;; H
  (assert (= o6 (div1 RNE2 o5 fliteral6)))
...
;; H
  (assert
  (and
  (and (= o7 (atan_2 grav_y1 grav_z1)) (atan_2__function_guard o7 grav_y1
  grav_z1)) (in_range3 o7)))

;; H
  (assert (= o8 (mul RNE2 o7 fliteral5)))

(assert
;; WP_parameter_def
 ;; File "sensfusion6_pack.adb", line 248, characters 0-0
  (not (not (eq fliteral6 zeroF))))
(check-sat)
