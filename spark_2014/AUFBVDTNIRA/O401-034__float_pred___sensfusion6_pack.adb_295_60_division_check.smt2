...
;; H
  (assert
  (= grav_x1 (mul RNE1 fliteral4
             (sub RNE1 (mul RNE1 q1 q3) (mul RNE1 q0 q2)))))
...
;; H
  (assert
  (= grav_y1 (mul RNE1 fliteral4
             (add RNE1 (mul RNE1 q0 q1) (mul RNE1 q2 q3)))))
...
;; H
  (assert
  (= grav_z1 (add RNE1
             (sub RNE1 (sub RNE1 (mul RNE1 q0 q0) (mul RNE1 q1 q1))
             (mul RNE1 q2 q2)) (mul RNE1 q3 q3))))
...
;; H
  ...
  (and
  (= o1 (atan_2
        (mul RNE1 fliteral4 (add RNE1 (mul RNE1 q0 q3) (mul RNE1 q1 q2)))
        (sub RNE1
        (sub RNE1 (add RNE1 (mul RNE1 q0 q0) (mul RNE1 q1 q1))
        (mul RNE1 q2 q2)) (mul RNE1 q3 q3))))
  (in_range3 o1)))

;; H
  (assert (= o2 (mul RNE1 o1 fliteral5)))

;; H
  (assert (= o3 (div1 RNE1 o2 fliteral6)))
...
;; H
  (assert (= o5 (mul RNE1 o4 fliteral5)))

;; H
  (assert (= o6 (div1 RNE1 o5 fliteral6)))
...
;; H
  (assert (and (= o7 (atan_2 grav_y1 grav_z1)) (in_range3 o7)))

;; H
  (assert (= o8 (mul RNE1 o7 fliteral5)))
