...
;; H
  ...
  (= o1 (add RNE2
        (sub RNE2
        (add RNE2 (sub RNE2 fliteral (div1 RNE2 (pow21 x) fliteral3))
        (div1 RNE2 (pow4 x) fliteral4)) (div1 RNE2 (pow6 x) fliteral5))
        (div1 RNE2 (pow8 x) fliteral6))))))

;; H
  (assert (= o2 (sub RNE2 trigo__cos__result4 o1)))
