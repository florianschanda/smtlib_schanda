...
;; has_valid_order__def_axiom
  ...
  (! (=> (has_valid_order__function_guard (has_valid_order int__) int__)
     (= (= (has_valid_order int__) true) (le
     (to_rep (rec__interval__interval__low (us_split_fields1 int__)))
...
;; H
  (assert
  (and (= (to_rep temp___141) fliteral1) (= (to_rep temp___1411) fliteral1)))
