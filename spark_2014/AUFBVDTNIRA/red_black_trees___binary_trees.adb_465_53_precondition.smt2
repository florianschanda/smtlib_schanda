...
(declare-fun temp___2122 () (Array Int us_rep1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2122 (parent
                      (mk___rep2
                      (mk___split_fields2 f__split_fields f__split_fields1))
                      i1))))
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2122 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2122 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___2122 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 root))
  (model____function_guard temp___2122
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root))
  (and (dynamic_invariant3 temp___2122 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2122 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2122 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2122 (parent
                              ...
                              f__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2122 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2122 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2122 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2122 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2122 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2122 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o57 (select temp___2122 i)))
