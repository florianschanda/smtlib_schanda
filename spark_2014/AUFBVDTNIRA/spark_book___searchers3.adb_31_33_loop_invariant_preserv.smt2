...
;; H
  (assert (and (<= low_index2 mid_index2) (<= mid_index2 (- high_index2 1))))
...
;; H
  (assert (= temp___155 result5))

;; H
  (assert (= temp___1551 (- high_index2 low_index2)))

;; H
  (assert
  (=> (< (to_rep (select items mid_index2)) search_item)
  (and (<= 1 (+ mid_index2 1)) (<= (+ mid_index2 1) 100))))
...
;; H
  (assert
  (=> (< (to_rep (select items mid_index2)) search_item)
  (= result6 (ite (< search_item o2) true false))))
...
;; H
  (assert
  (=> (< (to_rep (select items mid_index2)) search_item)
  (and (= o3 (+ mid_index2 1)) (in_range2 (+ mid_index2 1)))))
