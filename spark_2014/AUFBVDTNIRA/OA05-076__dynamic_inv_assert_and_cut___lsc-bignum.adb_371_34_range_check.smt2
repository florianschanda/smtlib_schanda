...
;; H
  (assert
  (and (= o67 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o67 ((_ int2bv 32) 1))))
...
;; H
  (assert
  (and (= o65 (num_of_big_int m m_first o64)) (num_of_big_int__function_guard
  o65 m m_first o64)))

;; H
  (assert
  (and (= o60 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o60 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o66 (omultiply o60 o65)) (omultiply__function_guard o66 o60 o65)))

;; H
  (assert
  (and (= o68 (osubtract o66 o67)) (osubtract__function_guard o68 o66 o67)))

;; H
  (assert
  (and (= o57 (from_word32 a_msw3)) (from_word32__function_guard o57 a_msw3)))
...
;; H
  (assert
  (and (= o58 (omultiply o56 o57)) (omultiply__function_guard o58 o56 o57)))
...
;; H
  ...
  (= o50 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))
         a_first o49))
  (num_of_big_int__function_guard o50
  (mk___t a4 (mk (to_rep a__first) (to_rep a__last))) a_first o49)))

;; H
  (assert (and (= o59 (oadd o50 o58)) (oadd__function_guard o59 o50 o58)))

;; H
  (assert (and (= o69 (olt o59 o68)) (olt__function_guard o69 o59 o68)))
...
;; H
  (assert
  (and (= o45 (num_of_big_int m m_first o44)) (num_of_big_int__function_guard
  o45 m m_first o44)))
