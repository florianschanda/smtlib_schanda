...
;; H
  ...
  (model_is_well_formed o4 data first_available) o4 data first_available))

;; H
  (assert
  (and
  (and (= o4 (model__ data first_available)) (model____function_guard 
  o4 data first_available))
