...
(declare-fun temp___951 () (Array Int byte))

(declare-fun temp___9511 () t2)
...
;; H
  (assert (in_queue_bit_length__function_guard
  (in_queue_bit_length (mk___rep ctx__split_fields12))
  (mk___rep ctx__split_fields12)))
...
;; H
  ...
  (and (= o15 (+ (- bit_length 8) (- 8 (mod2 bit_length 8)))) (in_range1
...
;; H
  (assert (=> (< 1 message_byte_length1) (= o12 temp___951)))

;; H
  (assert
  (=> (< 1 message_byte_length1)
  (= (mk2 (to_rep1 (first (rt message))) r108s) temp___9511)))

;; H
  (assert (=> (< 1 message_byte_length1) (= temp___951 o13)))

;; H
  (assert
  (=> (< 1 message_byte_length1)
  (= (mk (to_rep1 (first6 temp___9511)) (to_rep1 (last6 temp___9511))) 
  o14)))
...
;; H
  (assert
  (=> (< (mod2 bit_length 8) 8)
  (= o19 (bvshl suffix ((_ int2bv 8) (mod2 bit_length 8))))))

;; H
  (assert (=> (not (< (mod2 bit_length 8) 8)) (= o19 ((_ int2bv 8) 0))))

;; H
  (assert
  (=> (< (mod2 bit_length 8) 256)
  (= o17 (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (mod2 bit_length 8))))))

;; H
  (assert (=> (not (< (mod2 bit_length 8) 256)) (= o17 ((_ int2bv 8) 0))))

;; H
  (assert (= o18 (bvsub o17 ((_ int2bv 8) 1))))
