...
(declare-fun discr_checks__check_subtype_priv__R3b__assume () Int)

;; H
  (assert
  (and
  (and (= discr_checks__check_subtype_priv__R3b__assume (bad Tuple0))
  (bad__function_guard discr_checks__check_subtype_priv__R3b__assume 
  Tuple0))
  (and (in_range discr_checks__check_subtype_priv__R3b__assume)
  (= discr_checks__check_subtype_priv__R3b__assume 6))))
...
(assert
;; WP_parameter_def
 ;; File "discr_checks.adb", line 10, characters 0-0
  (not (in_range1 r3b)))
(check-sat)
