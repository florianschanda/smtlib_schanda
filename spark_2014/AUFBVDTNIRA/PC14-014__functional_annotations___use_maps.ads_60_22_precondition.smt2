...
;; H
  (assert
  (and (= o4 (iter_has_element temp___900 temp___899))
  (= (= o4 true) (and (<= 1 temp___899) (<= temp___899 (last temp___900))))))

;; H
  (assert (= (= o5 true) (in_range4 temp___899)))
...
;; H
  (assert (and (= l (get1 temp___900 temp___899)) (in_range5 l)))
...
;; H
  (assert (= (= o7 true) (in_range4 temp___902)))
