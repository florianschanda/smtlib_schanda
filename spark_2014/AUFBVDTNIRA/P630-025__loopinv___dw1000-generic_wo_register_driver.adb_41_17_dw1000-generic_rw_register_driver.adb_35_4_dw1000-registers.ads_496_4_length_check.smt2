...
(define-fun register_type__ref_163__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_115__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_115__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5850 us_t1)
  (temp___is_init_5847 Bool) (temp___skip_constant_5848 Bool)
  (temp___do_toplevel_5849 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5848 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5850)
                                       (last4 temp___expr_5850))
                                       (and (= (first3 temp___expr_5850) 1)
                                       (= (last4 temp___expr_5850) 1)))))
...
(define-fun target__ref_49__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_49__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_5871 us_t2)
  (temp___is_init_5868 Bool) (temp___skip_constant_5869 Bool)
  (temp___do_toplevel_5870 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5869 true))
                                       (and (dynamic_property3 1 1
                                       (first5 temp___expr_5871)
                                       (last6 temp___expr_5871))
                                       (and (= (first5 temp___expr_5871) 1)
                                       (= (last6 temp___expr_5871) 1)))))
...
(declare-fun temp___7919 () (Array Int bits_8))

(declare-fun temp___79191 () t2)

(declare-fun temp___7920 () (Array Int bits_8))

(declare-fun temp___79201 () t1)
...
;; H
  (assert
  (and
  (and (= temp___79192 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___79192 reg)) (dynamic_invariant1
  temp___79192 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___79191)) (to_rep (last5 temp___79191)))
     (+ (- (to_rep (last5 temp___79191)) (to_rep (first4 temp___79191))) 1)
     0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___79191)) (to_rep (last5 temp___79191))) 
  temp___79201))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___79201)) (to_rep (last3 temp___79201)))
     (+ (- (to_rep (last3 temp___79201)) (to_rep (first2 temp___79201))) 1)
