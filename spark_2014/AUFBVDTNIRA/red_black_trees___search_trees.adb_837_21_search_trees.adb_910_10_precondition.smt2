...
(declare-fun temp___1608 () (Array Int us_rep1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1608 (parent
                      (rec__search_trees__search_tree__struct
                      t__split_fields10) i2))))
  (position (rec__search_trees__search_tree__struct t__split_fields10) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1608 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1608 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= temp___1608 (model__
                 (rec__search_trees__search_tree__struct t__split_fields10)
                 o32))
  (model____function_guard temp___1608
  (rec__search_trees__search_tree__struct t__split_fields10) o32))
  (and (dynamic_invariant6 temp___1608 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1608 o32))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1608 o32)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o32))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___1608 (parent
                              ...
                              t__split_fields10) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1608 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1608 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1608 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1608 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1608 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1608 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o33 (select temp___1608 y1)))
...
;; H
  ...
  (valid_root
  (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
  o31) (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2))
  o31))
