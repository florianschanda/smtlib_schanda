...
;; H
  (assert
  (= (mk1 (to_rep1 (first4 temp___2161)) (to_rep1 (last7 temp___2161))) 
  temp___2171))
...
;; WP_parameter_def
 ;; File "main.adb", line 1, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 temp___2171)) (to_rep1 (last4 temp___2171)))
     (+ (- (to_rep1 (last4 temp___2171)) (to_rep1 (first2 temp___2171))) 1)
