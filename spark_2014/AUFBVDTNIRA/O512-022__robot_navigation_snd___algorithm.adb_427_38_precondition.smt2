...
;; H
  (assert
  (and (= o30 (bearing disttogoal)) (bearing__function_guard o30 disttogoal)))
...
;; H
  (assert
  (and (and (= o31 (aldiff o29 o30)) (aldiff__function_guard o31 o29 o30))
  (and (tqtisFinite o31) (and (lt (neg fliteral4) o31) (le o31 fliteral4)))))
