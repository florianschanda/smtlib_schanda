...
(define-fun dynamic_invariant3 ((temp___expr_932 Int)
...
(define-fun dynamic_invariant4 ((temp___expr_1056 Int)
...
(define-fun dynamic_invariant6 ((temp___expr_926 Int)
...
(define-fun dynamic_invariant7 ((temp___expr_938 Int)
  (temp___is_init_935 Bool) (temp___skip_constant_936 Bool)
  (temp___do_toplevel_937 Bool)) Bool (=>
                                      (or (= temp___is_init_935 true)
                                      (<= 0 2)) (in_range8 temp___expr_938)))

(define-fun dynamic_invariant8 ((temp___expr_1062 Int)
