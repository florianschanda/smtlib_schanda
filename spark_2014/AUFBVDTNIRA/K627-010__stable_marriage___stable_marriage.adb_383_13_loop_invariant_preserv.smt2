...
;; H
  (assert
  (forall ((g14 Int)) (is_permutation_2__function_guard
  (is_permutation_2 (select ranking_1 g14)) (select ranking_1 g14))))
...
;; H
  ...
  (forall ((g14 Int))
  (=> (and (<= 1 g14) (<= g14 64))
  (= (is_permutation_2 (select ranking_1 g14)) true)))
  (forall ((g2 Int))
  (=> (and (<= 1 g2) (<= g2 64))
  (= (is_permutation_1 (select ranking_2 g2)) true)))))
...
;; H
  (assert (= temp___542 o10))

;; H
  (assert (= temp___5421 o11))
...
;; H
  (assert (= temp___546 o15))

;; H
  (assert (= temp___5461 o16))
...
;; WP_parameter_def
 ;; File "stable_marriage.ads", line 18, characters 0-0
  ...
  (= (to_rep
     (select (rec__stable_marriage__matching__group1_set__elements
             unmatched_g1_set__split_fields5) prev)) prev)))
(check-sat)
