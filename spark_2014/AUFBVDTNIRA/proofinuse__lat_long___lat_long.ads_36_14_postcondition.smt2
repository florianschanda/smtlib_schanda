...
;; fliteral_axiom
  (assert
  (and (tqtisFinite fliteral6) (= (tqtreal fliteral6) (/ 63674445.0 10.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral7) (/ 1745329238474369049072265625.0 100000000000000000000000000000.0))))

(declare-fun fliteral8 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral8) (= (tqtreal fliteral8) 20003916.0)))

(declare-fun lat_long__delta_lat_in_meters__result () t)

(declare-fun result () t)

(declare-fun lat_long__delta_lat_in_meters__result1 () t)

(declare-fun lat_long__delta_lat_in_meters__result2 () t)

(declare-fun lat_long__delta_lat_in_meters__result3 () t)

(declare-fun lat_long__delta_lat_in_meters__result4 () t)

(declare-fun lat_long__delta_lat_in_meters__result5 () t)
...
;; H
  (assert
  (= lat_long__delta_lat_in_meters__result1 (mul RNE2
                                            (mul RNE2
                                            (sub RNE2
                                            (to_rep
                                            (rec__lat_long__coordinates__lat
...
;; H
  ...
  (olt (abs1 lat_long__delta_lat_in_meters__result4) fliteral8)
  (abs1 lat_long__delta_lat_in_meters__result4) fliteral8))

(assert
;; WP_parameter_def
 ;; File "lat_long.ads", line 6, characters 0-0
  (not
  (= (olt (abs1 lat_long__delta_lat_in_meters__result4) fliteral8) true)))
(check-sat)
