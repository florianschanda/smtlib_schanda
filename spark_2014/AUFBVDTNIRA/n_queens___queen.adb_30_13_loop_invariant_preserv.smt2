...
(declare-fun r10 () (Array Int index))
...
;; H
  (assert
  (=> (and (<= 1 j2) (<= j2 i)) (= (mk_int__ref j6) (mk_int__ref j4))))

;; H
  (assert
  (=> (and (<= 1 j2) (<= j2 i)) (= (mk_map__ref r6) (mk_map__ref r4))))
...
;; H
  ...
  (=> (<= j9 temp___194) (= (select r8 temp___194) (select r6 temp___194)))))
  (=> (<= (+ i 1) 8) (dynamic_property1 (+ i 1) 8 j9)))
  (and (<= (+ i 1) j9) (<= j9 8))))

;; H
  (assert (= (to_rep o3) (to_rep (select c j9))))

;; H
  (assert (= o4 (store r8 j9 o3)))
...
;; WP_parameter_def
 ;; File "queen.ads", line 19, characters 0-0
  (not (= (to_rep (select r10 k)) (to_rep (select b k)))))
(check-sat)
