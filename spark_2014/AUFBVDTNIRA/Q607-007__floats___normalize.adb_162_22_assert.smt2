...
;; r4__post_axiom
  ...
  (! (=> (and (dynamic_invariant x1 true true true) (le (neg fliteral1) x1))
     (let ((result (r4 x1)))
     (and (eq result (roundToIntegral RTN1 x1)) (dynamic_invariant result
...
;; r4__def_axiom
  ...
  (! (=> (dynamic_invariant x1 true true true)
     (= (r4 x1) (roundToIntegral RTN1 x1))) :pattern ((r4 x1)) )))
...
;; H
  (assert (= v11 (div1 RNE1 x fliteral5)))
...
;; H
  ...
  (and (= o (r4 v11))
  (and (in_range2 o)
  (and (= o (roundToIntegral RTN1 v11)) (eq o (roundToIntegral RTN1 v11))))))
