...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral2) (= (tqtreal fliteral2) 720.0)))
...
(define-fun dynamic_invariant1 ((temp___expr_141 t) (temp___is_init_138 Bool)
  (temp___skip_constant_139 Bool)
  (temp___do_toplevel_140 Bool)) Bool (=>
                                      (or (= temp___is_init_138 true) (le
                                      (neg fliteral2) fliteral2)) (in_range3
                                      temp___expr_141)))
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 3.0)))
...
(declare-fun r4__function_guard (t t) Bool)

;; r4__post_axiom
  (assert
  (forall ((x1 t))
  (! (=> (and (dynamic_invariant x1 true true true) (le (neg fliteral1) x1))
     (let ((result (r4 x1)))
     (=> (r4__function_guard result x1)
     (and (eq result (roundToIntegral RTN2 x1)) (dynamic_invariant result
     true false true))))) :pattern ((r4 x1)) )))
...
;; r4__def_axiom
  ...
  (! (=>
     ...
     x1)) (= (r4 x1) (roundToIntegral RTN2 x1))) :pattern ((r4 x1)) )))
...
(define-fun dynamic_invariant2 ((temp___expr_147 t) (temp___is_init_144 Bool)
  ...
  (temp___do_toplevel_146 Bool)) Bool (=>
                                      ...
                                      (neg fliteral3) fliteral4)) (in_range4
                                      temp___expr_147)))

(declare-fun fliteral5 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral5) (= (tqtreal fliteral5) 360.0)))
...
;; H
  (assert (=> (le (neg fliteral1) fliteral1) (in_range2 v1)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (in_range2 v2)))

;; H
  (assert (= result v1))

;; H
  (assert (= v11 (div1 RNE2 x fliteral5)))

;; H
  (assert (and (le (neg fliteral4) v11) (le v11 fliteral4)))

;; H
  (assert
  (and (and (= o (r4 v11)) (r4__function_guard o v11))
  (and (in_range2 o)
  (and (= o (roundToIntegral RTN2 v11)) (eq o (roundToIntegral RTN2 v11))))))
