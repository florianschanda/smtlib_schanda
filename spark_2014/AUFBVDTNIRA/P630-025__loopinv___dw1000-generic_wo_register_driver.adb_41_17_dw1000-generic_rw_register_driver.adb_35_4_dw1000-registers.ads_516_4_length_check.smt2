...
(define-fun dynamic_invariant ((temp___expr_6108 us_t1)
  ...
  (temp___do_toplevel_6107 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_6108))
                                       (and (= (first3 temp___expr_6108) 1)
                                       (= (last4 temp___expr_6108) 2)))))
...
(define-fun dynamic_invariant1 ((temp___expr_6127 us_t2)
  ...
  (temp___do_toplevel_6126 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_6127))
                                       (and (= (first5 temp___expr_6127) 1)
                                       (= (last6 temp___expr_6127) 2)))))
...
;; H
  (assert
  (and
  (and (= temp___79472 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___79472 reg)) (dynamic_invariant1
  temp___79472 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___79471)) (to_rep (last5 temp___79471)))
     (+ (- (to_rep (last5 temp___79471)) (to_rep (first4 temp___79471))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___79471)) (to_rep (last5 temp___79471))) 
  temp___79481))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___79481)) (to_rep (last3 temp___79481)))
     (+ (- (to_rep (last3 temp___79481)) (to_rep (first2 temp___79481))) 1)
