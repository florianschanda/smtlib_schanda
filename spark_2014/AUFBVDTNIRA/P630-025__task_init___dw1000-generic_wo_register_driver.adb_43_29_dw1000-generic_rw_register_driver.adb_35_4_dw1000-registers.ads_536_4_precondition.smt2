...
(define-fun dynamic_invariant ((temp___expr_6373 us_t1)
  ...
  (temp___do_toplevel_6372 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_6373))
                                       (and (= (first3 temp___expr_6373) 1)
                                       (= (last4 temp___expr_6373) 2)))))
...
(define-fun dynamic_invariant1 ((temp___expr_6391 us_t2)
  ...
  (temp___do_toplevel_6390 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_6391))
                                       (and (= (first5 temp___expr_6391) 1)
                                       (= (last6 temp___expr_6391) 2)))))
...
;; H
  (assert
  (and
  (and (= temp___79752 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___79752 reg)) (dynamic_invariant1
  temp___79752 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___79751)) (to_rep (last5 temp___79751)))
     (+ (- (to_rep (last5 temp___79751)) (to_rep (first4 temp___79751))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___79751)) (to_rep (last5 temp___79751))) 
  temp___79761))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___79761)) (to_rep (last3 temp___79761)))
     (+ (- (to_rep (last3 temp___79761)) (to_rep (first2 temp___79761))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7976 temp___79761)))
