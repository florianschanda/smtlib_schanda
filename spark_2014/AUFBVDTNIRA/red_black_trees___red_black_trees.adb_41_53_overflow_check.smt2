...
(declare-fun temp___1020 () (Array Int us_rep1))
...
(declare-fun o39 () us_rep6)

(declare-fun o40 () us_split_fields10)

(declare-fun o41 () extended_index_type)
...
(declare-fun o47 () us_rep6)

(declare-fun o48 () us_split_fields10)

(declare-fun o49 () extended_index_type)
...
;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (and (<= 1 i4) (<= i4 100)) (= temp___1005 i4))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (and (<= 1 i4) (<= i4 100)) (= temp___1003 res2))))
...
;; H
  ...
  (= temp___1020 (model__
                 (rec__red_black_trees__rbt__struct (us_split_fields9 t))))
  (and (dynamic_invariant1 temp___1020 true false true)
  (= temp___1020 (model__1
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7
                 (rec__red_black_trees__rbt__struct (us_split_fields9 t))))
                 (to_rep
...
;; H
  (assert (= o32 (select temp___1020 i1)))
...
;; H
  (assert
  (and
  (= o46 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 0))
  (and (in_range3 o46)
  (= o46 (peek1
         (rec__search_trees__search_tree__struct
         (us_split_fields7
...
;; H
  (assert
  (= o47 (select (map__content4 red_black_trees__nb_blacks__result4) 
  o46)))

;; H
  (assert (= o48 (us_split_fields11 o47)))

;; H
  (assert (= o49 (rec__red_black_trees__black_count__count o48)))
...
;; H
  ...
  (= o54 (ite (= (to_rep
                 (rec__red_black_trees__black_count__count
                 (us_split_fields11
                 (select (map__content4 red_black_trees__nb_blacks__result4) 
                 i1)))) o53)
         true false)))
...
;; H
  (assert
  (and
  (= o38 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 1))
  (and (in_range3 o38)
  (= o38 (peek1
         (rec__search_trees__search_tree__struct
         (us_split_fields7
...
;; H
  (assert
  (= o39 (select (map__content4 red_black_trees__nb_blacks__result4) 
  o38)))
