...
;; H
  (assert (islocked__function_guard (islocked state4) state4))

;; H
  (assert (thecurrentdoor__function_guard (thecurrentdoor state5) state5))
...
;; H
  (assert (alarm_timeout__function_guard (alarm_timeout state5) state5))
...
;; H
  (assert (greaterthanorequal__function_guard
  (greaterthanorequal (thecurrenttime currenttime) (alarm_timeout state5))
  (thecurrenttime currenttime) (alarm_timeout state5)))

;; H
  (assert (thedooralarm__function_guard (thedooralarm state5) state5))
...
;; H
  ...
  (and
  (=
  (and (and (= (islocked state4) true) (= (thecurrentdoor state5) 0))
  (= (greaterthanorequal (thecurrenttime currenttime) (alarm_timeout state5)) true))
  (= (thedooralarm state5) 0)) (= (islocked state4) true)))
...
;; H
  (assert
  (and (not (= (ispresent (mk___rep theadmin__split_fields2)) true))
