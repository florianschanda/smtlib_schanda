...
(declare-fun o22 () us_rep6)

(declare-fun o23 () us_split_fields10)
...
(declare-fun o31 () us_split_fields10)
...
;; H
  ...
  (and
  (and
  (= o29 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0))
  (peek__function_guard o29
...
;; H
  ...
  (= o37 (ite (= (to_rep
                 (rec__red_black_trees__black_count__count
                 (us_split_fields11 (select res3 j)))) o36)
         true false)))
...
;; H
  ...
  (and
  (and
  (= o21 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 1))
  (peek__function_guard o21
