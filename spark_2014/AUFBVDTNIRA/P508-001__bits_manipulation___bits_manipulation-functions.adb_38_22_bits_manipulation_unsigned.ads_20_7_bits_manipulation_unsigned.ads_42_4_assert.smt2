...
(declare-fun bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__len__assume () Int)

(declare-fun o () Int)

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__mask__assume () (_ BitVec 8))
...
;; H
  (assert
  (and
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__len__assume (+ (- 
...
;; H
  ...
  (shift_right ((_ int2bv 8) 255) (- 8 o)) ((_ int2bv 8) 255) (- 8 o)))
...
;; H
  ...
  o))
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__mask__assume 
  (shift_right ((_ int2bv 8) 255) (- 8 o)))))
