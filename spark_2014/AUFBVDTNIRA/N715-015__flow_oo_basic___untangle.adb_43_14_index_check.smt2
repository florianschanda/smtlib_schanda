...
(declare-fun x__split_fields () (Array Int us_rep))
...
;; H
  (assert (= (to_rep o) ((_ int2bv 8) 0)))

;; H
  (assert
  (= (rec__untangle__word_a__lo
     (us_split_fields1 (select x__split_fields (wibble n g)))) o1))
