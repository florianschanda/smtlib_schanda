...
(declare-fun temp___1745 () (Array Int us_rep1))
...
;; H
  ...
  (= temp___1745 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___1745 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1745 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1745 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1745 (parent
                              (mk___rep2
                              (mk___split_fields2 f_old__split_fields
                              f_old__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1745 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1745 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1745 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1745 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1745 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1745 j)))) true))
  (= j i1))))))))))))))
...
;; H
  (assert (= o27 (select temp___1745 o26)))
...
;; H
  ...
  (= temp___1746 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___1746 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1746 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (=> (= result5 true) (= o22 (select temp___1746 o21))))
...
;; H
  ...
  (= temp___1744 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___1744 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1744 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o30 (select temp___1744 o29)))
