...
;; H
  (assert (is_perm__function_guard
  (is_perm (mk___t values (mk 1 100)) (mk___t values1 (mk 1 100)))
  (mk___t values (mk 1 100)) (mk___t values1 (mk 1 100))))

;; H
  (assert
  (= (is_perm (mk___t values (mk 1 100)) (mk___t values1 (mk 1 100))) true))
