...
;; H
  (assert
  (and (= o (sub RNE2 time (div1 RNE2 d1 fliteral5))) (tqtisFinite
  (sub RNE2 time (div1 RNE2 d1 fliteral5)))))
...
;; H
  (assert
  (and (= o1 (add RNE2 t_fp1 (mul RNE2 (of_int RNE2 nb_of_fp) delta_time)))
  (tqtisFinite
  (add RNE2 t_fp1 (mul RNE2 (of_int RNE2 nb_of_fp) delta_time)))))
...
;; H
  ...
  (and
  (= o2 (add RNE2 t_pp1
        (mul RNE2 (mul RNE2 fliteral4 (of_int RNE2 nb_of_fp)) delta_time)))
  (tqtisFinite
  (add RNE2 t_pp1
  (mul RNE2 (mul RNE2 fliteral4 (of_int RNE2 nb_of_fp)) delta_time)))))
