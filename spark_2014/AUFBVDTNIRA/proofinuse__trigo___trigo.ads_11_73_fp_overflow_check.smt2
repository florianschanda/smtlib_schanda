...
;; H
  (assert (and (= o (mul RNE2 x x)) (tqtisFinite (mul RNE2 x x))))

;; H
  (assert (= o1 (mul RNE2 o x)))

;; H
  (assert (and (= o2 o1) (tqtisFinite o1)))

;; H
  (assert (= o3 (mul RNE2 o2 x)))

;; H
  (assert (and (= o4 o3) (tqtisFinite o3)))

;; H
  (assert (= o5 (mul RNE2 o4 x)))

;; H
  (assert (and (= o6 o5) (tqtisFinite o5)))

;; H
  (assert (= o7 (mul RNE2 o6 x)))

;; H
  (assert (and (= o8 o7) (tqtisFinite o7)))

;; H
  (assert (= o9 (mul RNE2 o8 x)))

;; H
  (assert (and (= o10 o9) (tqtisFinite o9)))

;; H
  (assert (= o11 (mul RNE2 o10 x)))
