...
(define-fun in_range12 ((x t)) Bool (and (tqtisFinite x)
                                    (and (le fliteral1 x) (le x fliteral3))))

(define-fun bool_eq22 ((x t) (y t)) Bool (ite (eq x y) true false))

(declare-fun user_eq20 (positive_float positive_float) Bool)

(declare-fun attr__ATTRIBUTE_IMAGE11 (t) us_image)

(declare-fun attr__ATTRIBUTE_VALUE__pre_check11 (us_image) Bool)

(declare-fun attr__ATTRIBUTE_VALUE11 (us_image) t)
...
(declare-fun to_rep8 (positive_float) t)

(declare-fun of_rep8 (t) positive_float)
...
(define-fun in_range13 ((x t)) Bool (and (tqtisFinite x)
                                    (and (le fliteral1 x) (le x fliteral3))))

(define-fun bool_eq23 ((x t) (y t)) Bool (ite (eq x y) true false))

(declare-fun user_eq21 (nonnegative_float nonnegative_float) Bool)

(declare-fun attr__ATTRIBUTE_IMAGE12 (t) us_image)

(declare-fun attr__ATTRIBUTE_VALUE__pre_check12 (us_image) Bool)

(declare-fun attr__ATTRIBUTE_VALUE12 (us_image) t)
...
(declare-fun to_rep9 (nonnegative_float) t)

(declare-fun of_rep9 (t) nonnegative_float)
...
(define-fun bool_eq24 ((x t) (y t)) Bool (ite (eq x y) true false))

(declare-fun user_eq22 (unbounded_float unbounded_float) Bool)

(declare-fun attr__ATTRIBUTE_IMAGE13 (t) us_image)

(declare-fun attr__ATTRIBUTE_VALUE__pre_check13 (us_image) Bool)

(declare-fun attr__ATTRIBUTE_VALUE13 (us_image) t)
...
(declare-fun to_rep10 (unbounded_float) t)

(declare-fun of_rep10 (t) unbounded_float)
...
;; coerce_axiom
  (assert
  (forall ((x t))
  (! (=> (tqtisFinite x) (= (to_rep10 (of_rep10 x)) x)) :pattern ((to_rep10
                                                                  (of_rep10
                                                                  x))) )))
...
;; zero_position__def_axiom
  ...
  (= zero_position (mk___rep1
                   (mk___split_fields1 (of_rep2 fliteral1)
                   (of_rep2 fliteral1)))))
...
;; H
  (assert (= (to_rep2 o) fliteral1))

;; H
  (assert (= (to_rep2 o1) fliteral1))
