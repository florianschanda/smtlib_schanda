...
;; H
  (assert (le fliteral2 y))

;; H
  (assert (le y x))

;; H
  (assert (and (= o (sub RNE2 y x)) (tqtisFinite (sub RNE2 y x))))

;; H
  (assert (= o1 (add RNE2 x o)))
...
(assert
;; WP_parameter_def
 ;; File "floating_point.adb", line 377, characters 0-0
  (not (le y res1)))
(check-sat)
