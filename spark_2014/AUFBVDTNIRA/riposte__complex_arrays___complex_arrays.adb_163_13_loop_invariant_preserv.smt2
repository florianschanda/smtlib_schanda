...
;; H
  (assert (=> (and (<= 0 j2) (<= j2 i)) (= (to_rep o1) (- 23))))

;; H
  (assert (=> (and (<= 0 j2) (<= j2 i)) (= o2 (store tmp1 j2 o1))))

;; H
  (assert (=> (and (<= 0 j2) (<= j2 i)) (= tmp1 result2)))

;; H
  (assert (=> (and (<= 0 j2) (<= j2 i)) (= tmp2 o2)))
