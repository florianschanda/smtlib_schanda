...
(define-fun bool_eq3 ((a (Array Int fruits)) (a__first Int) (a__last Int)
...
;; H
  ...
  (=>
  (and (<= (to_rep inventory__first) i1) (<= i1 (to_rep inventory__last)))
  (=> (= result1 true) (= o1 (store inventory2 i2 o)))))
...
;; WP_parameter_def
 ;; File "test.adb", line 84, characters 0-0
  (not (not (= (found_none (to_rep1 (select inventory8 i10))) true))))
(check-sat)
