...
;; range_axiom
  (assert
  (forall ((x nat_type)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)) )))
...
(declare-fun dummy5 () internal_state)
...
(declare-fun pump_one__split_fields () (Array Int character))

(declare-fun pump_one__split_fields1 () nat_type)

(declare-fun pump_one__split_fields2 () nat_type)

(declare-fun pump_one__split_fields3 () nat_type)

(declare-fun pump_two__split_fields () (Array Int character))

(declare-fun pump_two__split_fields1 () nat_type)

(declare-fun pump_two__split_fields2 () nat_type)

(declare-fun pump_two__split_fields3 () nat_type)

(declare-fun cur_state1 () Int)

(declare-fun result () (Array Int character))

(declare-fun result1 () nat_type)

(declare-fun result2 () nat_type)

(declare-fun result3 () nat_type)
...
;; H
  (assert (is_base__function_guard (is_base cur_state) cur_state))
...
;; H
  (assert
  (and (or (= (is_base cur_state) true) (= (is_waiting cur_state) true))
  (and (<= 1 pump_index) (<= pump_index 2))))
...
;; H
  (assert
  (=> (< pump_index 2) (= pump_one__split_fields cur_pump__split_fields4)))

;; H
  (assert
  (=> (< pump_index 2) (= pump_one__split_fields1 cur_pump__split_fields5)))

;; H
  (assert
  (=> (< pump_index 2) (= pump_one__split_fields2 cur_pump__split_fields6)))

;; H
  (assert
  (=> (< pump_index 2) (= pump_one__split_fields3 cur_pump__split_fields7)))
...
;; H
  (assert
  (=> (not (< pump_index 2))
  (= pump_two__split_fields cur_pump__split_fields8)))

;; H
  (assert
  (=> (not (< pump_index 2))
  (= pump_two__split_fields1 cur_pump__split_fields9)))

;; H
  (assert
  (=> (not (< pump_index 2))
  (= pump_two__split_fields2 cur_pump__split_fields10)))

;; H
  (assert
  (=> (not (< pump_index 2))
  (= pump_two__split_fields3 cur_pump__split_fields11)))

;; H
  (assert
  (=> (not (< pump_index 2))
  (= (mk___split_fields cur_pump__split_fields4 cur_pump__split_fields5
     cur_pump__split_fields6 cur_pump__split_fields7) (mk___split_fields
...
;; H
  (assert
  (=> (not (or (= cur_state 2) (= cur_state 3))) (= cur_state2 cur_state)))

;; H
  (assert
  (=> (not (or (= cur_state 2) (= cur_state 3))) (= cur_state2 cur_state1)))
