...
;; H
  ...
  (timefromlastclicktolastupdate__function_guard o3 prevtime thistime))
...
;; H
  ...
  (timesincelastupdate__function_guard o currtime thistime))
...
;; H
  ...
  (distancefromlastclicktolastupdate__function_guard o1 prevcount thiscount))
