...
;; H
  (assert
  (and (= o55 (+ 48 (div1 localvalue7 10))) (in_range3
...
;; H
  (assert (= o57 (store localtext13 1 o56)))

;; H
  (assert (= result19 (mk_map__ref localtext13)))

;; H
  (assert (= localtext14 o57))

;; H
  (assert (= (to_rep o58) (+ 48 (mod2 localvalue7 10))))

;; H
  (assert (= o59 (store localtext14 2 o58)))

;; H
  (assert (= result20 (mk_map__ref localtext14)))

;; H
  (assert (= localtext15 o59))
