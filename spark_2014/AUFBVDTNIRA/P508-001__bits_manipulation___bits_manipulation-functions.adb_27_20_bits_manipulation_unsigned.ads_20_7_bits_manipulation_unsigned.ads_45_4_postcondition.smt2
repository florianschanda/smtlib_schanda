...
(define-fun dynamic_invariant2 ((temp___expr_799 Int)
...
(define-fun dynamic_invariant3 ((temp___expr_805 Int)
  ...
  (temp___do_toplevel_804 Bool)) Bool (=>
                                      ...
                                      (<= 1 64)) (in_range2 temp___expr_805)))
...
;; H
  ...
  ((_ int2bv 64) 18446744073709551615) (- 64 o)))
...
;; H
  (assert
  (= result2 bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result4))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 3, characters 0-0
  (not
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result4 (bvand 
