...
(declare-datatypes ()
((tresultP1__ref (mk_tresultP1__ref (tresultP1__content integer)))))
(define-fun tresultP1__ref___projection ((a tresultP1__ref)) integer 
  (tresultP1__content a))
...
(declare-datatypes ()
((result____ref (mk_result____ref (result____content us_t1)))))
(define-fun result____ref___projection ((a result____ref)) us_t1 (result____content
                                                                 a))
...
(declare-fun dir__full_name__B_1__value__assume () (Array Int character))

(declare-fun dir__full_name__B_1__value__assume1 () t)

(declare-fun dir__full_name__B_1__test_value__assume () (Array Int character))

(declare-fun dir__full_name__B_1__test_value__assume1 () t)

(declare-fun result () Bool)

(define-fun dir__full_name__B_1__test_value__assume2 () us_t (mk___t
                                                             dir__full_name__B_1__test_value__assume
                                                             dir__full_name__B_1__test_value__assume1))

(define-fun dir__full_name__B_1__value__assume2 () us_t (mk___t
                                                        dir__full_name__B_1__value__assume
                                                        dir__full_name__B_1__value__assume1))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first (rt value))) (to_rep1 (last (rt value))))
     (+ (- (to_rep1 (last (rt value))) (to_rep1 (first (rt value)))) 1) 0) 
  (ite (<= 1 (length value)) (+ (- (length value) 1) 1) 0))))
(check-sat)
