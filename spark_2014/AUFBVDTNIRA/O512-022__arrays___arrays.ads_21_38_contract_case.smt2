...
(declare-fun arrays__count_even__result1 () Int)

(declare-fun arrays__count_even__result2 () Int)

(declare-fun arrays__count_even__result3 () Int)

(declare-fun c8 () Int)

(declare-fun j7 () Int)

(declare-fun arrays__count_even__result4 () Int)

(declare-fun c9 () Int)

(declare-fun j8 () Int)

(declare-fun arrays__count_even__result5 () Int)
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x)))))
  (=> (= (mod2 (to_rep (select (elts x) j2)) 2) 0)
  (and (= o (+ c2 1)) (in_range1 (+ c2 1))))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x)))))
  (=> (= (mod2 (to_rep (select (elts x) j2)) 2) 0) (= c2 result2))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x)))))
  (=> (= (mod2 (to_rep (select (elts x) j2)) 2) 0) (= c3 o))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x)))))
  (=> (not (= (mod2 (to_rep (select (elts x) j2)) 2) 0)) (= c3 c2))))
...
;; H
  (assert (= arrays__count_even__result1 arrays__count_even__result2))

;; H
  (assert (= arrays__count_even__result3 arrays__count_even__result1))

;; H
  (assert (= (mk_int__ref result3) (mk_int__ref arrays__count_even__result)))

;; H
  (assert (= arrays__count_even__result1 c6))

;; H
  (assert
  (= (mk_int__ref arrays__count_even__result4) (mk_int__ref
                                               arrays__count_even__result2)))

;; H
  (assert (= (mk_int__ref j7) j9))

;; H
  (assert (= (mk_int__ref c8) c10))

;; H
  (assert (= arrays__count_even__result5 arrays__count_even__result3))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= arrays__count_even__result4 0)))
(check-sat)
