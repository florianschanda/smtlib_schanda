...
;; H
  (assert
  (=> (not (le fliteral2 x1))
  (and (= o7 (mul RNE1 fliteral6 x1)) (tqtisFinite (mul RNE1 fliteral6 x1)))))
...
;; H
  (assert
  (=> (not (le fliteral2 x1))
  (and (= o10 (mul RNE1 fliteral6 x1)) (tqtisFinite (mul RNE1 fliteral6 x1)))))
...
;; H
  (assert (= approx1 (div2 RNE1 x1 fliteral6)))

;; H
  (assert
  (and (= o16 (mul RNE1 approx1 approx1)) (tqtisFinite
  (mul RNE1 approx1 approx1))))

;; H
  (assert (= o17 (sub RNE1 x1 o16)))
