...
;; H
  (assert (tqtisFinite kv))

;; H
  (assert (tqtisFinite ka))

;; H
  (assert (and (and (neq d fliteral2) (lt fliteral2 kv)) (lt fliteral2 ka)))

;; H
  (assert (and (= o (mul RNE2 kv kv)) (tqtisFinite (mul RNE2 kv kv))))

;; H
  (assert (= o1 (div1 RNE2 o ka)))

;; H
  (assert (and (= o2 o1) (tqtisFinite o1)))

;; H
  (assert (= result (ite (lt (abs1 d) o2) true false)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (tqtisFinite (mul RNE2 (abs1 d) ka))))
(check-sat)
