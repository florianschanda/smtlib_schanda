...
;; H
  ...
  (= (bool_eq3 use_lists__incr_all_2__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
...
;; H
  ...
  (= result1 (has_key
             (positions
             (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
             (mk___rep1 cu__split_fields6)))
  (= (= result1 true)
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (mk___rep1 cu__split_fields6)) true))))
...
;; H
  ...
  (=>
  (and (<= 1 n)
  (<= n (- (get1 (positions (mk___rep l__split_discrs l__split_fields4))
           (mk___rep1 cu__split_fields5)) 1)))
  (= (is_incr
     (get
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     n) (get (model__ (mk___rep l__split_discrs l__split_fields4)) n)) true))))
...
;; H
  ...
  (=>
  (and
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields4))
      (mk___rep1 cu__split_fields5)) n)
  (<= n (length (mk___rep l__split_discrs l__split_fields4))))
  (= (get
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     n) (get (model__ (mk___rep l__split_discrs l__split_fields4)) n)))))
...
;; H
  (assert
  (and
  (= o (element (mk___rep l__split_discrs l__split_fields4)
       (mk___rep1 cu__split_fields5)))
  (and (in_range6 o)
  (= o (get (model__ (mk___rep l__split_discrs l__split_fields4))
       (get1 (positions (mk___rep l__split_discrs l__split_fields4))
       (mk___rep1 cu__split_fields5)))))))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o1 (element (mk___rep l__split_discrs l__split_fields4)
        (mk___rep1 cu__split_fields5)))
  (and (in_range6 o1)
  (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields4))
        (get1 (positions (mk___rep l__split_discrs l__split_fields4))
        (mk___rep1 cu__split_fields5))))))))
...
;; H
  (assert (=> (= result2 true) (and (= o3 o2) (in_range1 o2))))
...
;; H
  ...
  (= (get (model__ (mk___rep l__split_discrs l__split_fields3))
     ...
     (mk___rep1 cu__split_fields5))) o3))
...
;; H
  (assert
  (and
  (= o4 (has_key (positions (mk___rep l__split_discrs l__split_fields3))
...
;; H
  (assert
  (<= n (- (get1 (positions (mk___rep l__split_discrs l__split_fields3))
           (mk___rep1 cu__split_fields4)) 1)))

;; H
  (assert (is_incr__function_guard
  (is_incr
  (get
  (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 
  n) (get (model__ (mk___rep l__split_discrs l__split_fields3)) n))
  (get
  (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 
  n) (get (model__ (mk___rep l__split_discrs l__split_fields3)) n)))
...
;; WP_parameter_def
 ;; File "use_lists.ads", line 26, characters 0-0
  ...
  (= (is_incr
     (get
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     n) (get (model__ (mk___rep l__split_discrs l__split_fields3)) n)) true)))
(check-sat)
