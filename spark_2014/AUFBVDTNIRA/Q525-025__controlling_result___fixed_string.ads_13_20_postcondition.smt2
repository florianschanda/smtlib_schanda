...
(declare-fun fixed_string__create__result () natural)

(declare-fun fixed_string__create__result1 () (Array Int character))

(declare-fun fixed_string__create__result2 () us_private)

(declare-fun fixed_string__create__result3 () Int)
...
(declare-fun fixed_string__trim_string__change () (Array Int character))
...
(declare-fun fixed_string__create__result4 () natural)

(declare-fun fixed_string__create__result5 () (Array Int character))

(declare-fun fixed_string__create__result6 () us_private)
...
;; H
  ...
  (<= (+ (- i (to_rep1 o4)) (to_rep1 (first (rt name)))) (to_rep1
                                                         (last (rt name)))))
  (= (to_rep (select fixed_string__trim_string__change i)) (to_rep
                                                           (select (elts
                                                                   name) (+ (- i 
                                                           (to_rep1 o4)) 
                                                           (to_rep1
                                                           (first (rt name))))))))
  (= (to_rep (select fixed_string__trim_string__change i)) 0)))))
...
;; H
  (assert
  (= (slide fixed_string__trim_string__change (to_rep1 (first (mk 1 20))) 1) 
  this__split_fields7))
