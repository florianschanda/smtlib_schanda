...
;; H
  ...
  (= (= result3 true)
  (exists ((y Int))
  (and (and (<= 0 y) (<= y 100000)) (eq x4
  (mul RNE2 (div1 RNE2 (of_int RNE2 y) fliteral3)
  (div1 RNE2 (of_int RNE2 y) fliteral3)))))))

;; H
  (assert (=> (= result3 true) (and (le fliteral4 x4) (le x4 fliteral))))

;; H
  (assert (= x4 copy))

;; H
  (assert (tqtisFinite copy))

;; H
  (assert (le fliteral4 x4))

;; H
  (assert (le x4 fliteral))

;; H
  (assert (and (= o3 (mul RNE2 x4 x4)) (tqtisFinite (mul RNE2 x4 x4))))

;; H
  (assert (= o4 (sub RNE2 x4 o3)))
