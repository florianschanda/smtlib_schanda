...
(declare-fun temp___1112 () us_t1)

(declare-fun o22 () (Array Int character))

(declare-fun temp___1107 () us_t)
...
;; H
  (assert (=> (= result2 true) (= temp___1112 temp___1108)))

;; H
  (assert
  (=> (= result2 true)
  (forall ((temp___1113 Int))
  (ite (and (<= 1 temp___1113) (<= temp___1113 (length thestring)))
  (= (select o22 temp___1113) (select (elts1 temp___1112) temp___1113))
  (= (select o22 temp___1113) (select result__1 temp___1113))))))
...
;; H
  (assert (=> (not (= result2 true)) (= temp___1107 thestring)))

;; H
  (assert (=> (not (= result2 true)) (= o23 (elts temp___1107))))
