...
;; H
  (assert (= o22 (ite (<= b_first k) o21 false)))

;; H
  (assert (= result2 (ite (not (= o22 true)) true false)))
...
;; H
  (assert (=> (= result2 true) (= o26 (select b o25))))

;; H
  (assert (=> (= result2 true) (= o27 (to_rep1 o26))))
...
;; H
  (assert (=> (= result2 true) (= o24 (select b2 o23))))

;; H
  (assert (=> (= result2 true) (= o28 (to_rep1 o24))))

;; H
  (assert (=> (= result2 true) (= o29 (ite (= o28 o27) true false))))
