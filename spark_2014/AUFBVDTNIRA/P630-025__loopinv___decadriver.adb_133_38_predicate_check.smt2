...
(define-fun bool_eq15 ((a (Array (_ BitVec 8) us_rep1))
  ...
  (b__last (_ BitVec 8))) Bool (ite (and
                                    ...
                                    (= (bool_eq13 (select a temp___idx_183)
...
(define-fun o49 () us_rep1 (mk___rep1 (mk___split_fields1 o28 o29 o30 o31)))
...
;; H
  (assert (= o49 temp___45674))

;; H
  (assert
  (= o32 (store (rec__decadriver__receiver_type__frame_queue
                (us_split_fields5 self__5)) next_idx1 o49)))
...
;; WP_parameter_def
 ;; File "decadriver.ads", line 77, characters 0-0
  ...
  (mk___rep1
  (mk___split_fields1 temp___4571 temp___45711 temp___45712 temp___45713)))))
(check-sat)
