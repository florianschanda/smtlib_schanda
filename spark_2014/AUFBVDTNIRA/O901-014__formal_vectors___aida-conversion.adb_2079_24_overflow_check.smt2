...
(define-fun tint_arrayD1__ref_22__projection ((a tint_arrayD1__ref)) integer 
...
(define-fun tint_arrayT__ref_22__projection ((a tint_arrayT__ref)) us_t1 
...
(declare-datatypes ()
((t711b__ref (mk_t711b__ref (t711b__content integer)))))
(define-fun t711b__ref___projection ((a t711b__ref)) integer (t711b__content
                                                             a))
...
(define-fun tnumber_array_typeD1__ref_31__projection ((a tnumber_array_typeD1__ref)) integer 
...
(define-fun number_array_type__ref_31__projection ((a number_array_type__ref)) us_t3 
...
(declare-datatypes ()
((t715b__ref (mk_t715b__ref (t715b__content integer)))))
(define-fun t715b__ref___projection ((a t715b__ref)) integer (t715b__content
                                                             a))
...
(declare-datatypes ()
((t717b__ref (mk_t717b__ref (t717b__content integer)))))
(define-fun t717b__ref___projection ((a t717b__ref)) integer (t717b__content
                                                             a))
...
(define-fun tint_arrayB__ref_22__projection ((a tint_arrayB__ref)) us_t5 
  (tint_arrayB__content a))

(declare-fun aida__conversion__calculate_negative_target_length_7__int_array__aggregate_def (Int
  Int Int Int Int Int Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___2632 Int) (temp___2633 Int) (temp___2634 Int)
  (temp___2635 Int) (temp___2636 Int) (temp___2637 Int) (temp___2638 Int)
  (temp___2639 Int))
  (let ((temp___2631 (aida__conversion__calculate_negative_target_length_7__int_array__aggregate_def
                     temp___2632 temp___2633 temp___2634 temp___2635
                     temp___2636 temp___2637 temp___2638 temp___2639)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 6)
  temp___2638 temp___2639)
  (and (= (first7 temp___2631) temp___2638)
  (= (last7 temp___2631) temp___2639)))
  (and
  (and
  (and
  (and
  (and
  (= (select (to_array2 temp___2631) (+ (+ (first1 source) 1) 0)) (of_rep1
                                                                  temp___2632))
  (= (select (to_array2 temp___2631) (+ (+ (first1 source) 1) 1)) (of_rep1
                                                                  temp___2633)))
  (= (select (to_array2 temp___2631) (+ (+ (first1 source) 1) 2)) (of_rep1
                                                                  temp___2634)))
  (= (select (to_array2 temp___2631) (+ (+ (first1 source) 1) 3)) (of_rep1
                                                                  temp___2635)))
  (= (select (to_array2 temp___2631) (+ (+ (first1 source) 1) 4)) (of_rep1
                                                                  temp___2636)))
  (= (select (to_array2 temp___2631) (+ (+ (first1 source) 1) 5)) (of_rep1
                                                                  temp___2637)))))))
...
(define-fun tnumber_array_typeB__ref_31__projection ((a tnumber_array_typeB__ref)) us_t6 
  (tnumber_array_typeB__content a))

(declare-fun aida__conversion__calculate_negative_target_length_7__n__aggregate_def (Int
  Int Int) us_t4)

;; def_axiom
  (assert
  (forall ((temp___2645 Int) (temp___2646 Int) (temp___2647 Int))
  (let ((temp___2644 (aida__conversion__calculate_negative_target_length_7__n__aggregate_def
                     temp___2645 temp___2646 temp___2647)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 6)
  temp___2646 temp___2647)
  (and (= (first13 temp___2644) temp___2646)
  (= (last13 temp___2644) temp___2647)))
  (forall ((temp___2648 Int))
  (= (select (to_array4 temp___2644) temp___2648) (of_rep1 temp___2645)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_881 us_t3)
  (temp___is_init_878 Bool) (temp___skip_constant_879 Bool)
  (temp___do_toplevel_880 Bool)) Bool (=>
                                      (not (= temp___skip_constant_879 true))
                                      (and (dynamic_property6
                                      (+ (first1 source) 1)
                                      (+ (first1 source) 6)
                                      (first10 temp___expr_881)
                                      (last10 temp___expr_881))
                                      (and
                                      (= (first10 temp___expr_881) (+ 
                                      (first1 source) 1))
                                      (= (last10 temp___expr_881) (+ 
...
(declare-fun temp___26421 () t2)

(declare-fun aida__conversion__calculate_negative_target_length_7__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_length_7__int_array__assume1 () t1)

(declare-fun temp___2650 () (Array Int integer))

(declare-fun temp___26501 () t4)

(declare-fun aida__conversion__calculate_negative_target_length_7__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_length_7__n__assume1 () t3)

(declare-fun temp___2656 () Int)

(declare-fun temp___2657 () Int)

(declare-fun temp___2655 () Int)

(declare-fun temp___2653 () (Array Int integer))
...
;; H
  ...
  (<= index7 (+ (to_rep1 (first (rt source))) 6)))
...
;; H
  ...
  (= (to_rep1
     (first6
     (rt2
     (aida__conversion__calculate_negative_target_length_7__int_array__aggregate_def
     9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1)
     (+ (+ (to_rep1 (first (rt source))) 1) 5))))) (+ (to_rep1
                                                      (first (rt source))) 1)))
...
;; H
  (assert
  (= (mk___t2 temp___2642 temp___26421) (aida__conversion__calculate_negative_target_length_7__int_array__aggregate_def
                                        9 9 9 9 9 9
                                        (+ (to_rep1 (first (rt source))) 1)
                                        (+ (+ (to_rep1 (first (rt source))) 1) 5))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___26421)) (to_rep1 (last6 temp___26421)))
     (+ (- (to_rep1 (last6 temp___26421)) (to_rep1 (first6 temp___26421))) 1)
...
;; H
  (assert
  (= (slide1 temp___2642 (to_rep1 (first6 temp___26421))
     (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_7__int_array__assume))

;; H
  (assert
  (= (mk1 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 6)) aida__conversion__calculate_negative_target_length_7__int_array__assume1))
...
;; H
  (assert
  (= int_array1 aida__conversion__calculate_negative_target_length_7__int_array__assume))

;; H
  (assert
  (= (to_rep1 int_array__first) (to_rep1
                                (first3
                                aida__conversion__calculate_negative_target_length_7__int_array__assume1))))
...
;; H
  ...
  (+ (to_rep1 (first (rt source))) 6) (to_rep1 int_array__first)
  (to_rep1 int_array__last))
  (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 1))
  (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 6)))))
...
;; H
  ...
  (= (to_rep1
     (first12
     (rt4
     (aida__conversion__calculate_negative_target_length_7__n__aggregate_def
     0 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 6))))) (+ (to_rep1 (first (rt source))) 1)))
...
;; H
  ...
  (= (to_rep1
     ...
     (aida__conversion__calculate_negative_target_length_7__n__aggregate_def
     0 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 6))))) (+ (to_rep1 (first (rt source))) 6)))

;; H
  (assert
  (= (mk___t4 temp___2650 temp___26501) (aida__conversion__calculate_negative_target_length_7__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 1)
                                        (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___26501)) (to_rep1
                                               (last12 temp___26501)))
     (+ (- (to_rep1 (last12 temp___26501)) (to_rep1 (first12 temp___26501))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1
                                                        (first (rt source))) 6))
        (+ (- (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1
                                                     (first (rt source))) 1)) 1)
...
;; H
  (assert
  (= (slide1 temp___2650 (to_rep1 (first12 temp___26501))
     (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_7__n__assume))

;; H
  (assert
  (= (mk3 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 6)) aida__conversion__calculate_negative_target_length_7__n__assume1))
...
;; H
  (assert
  (= n1 aida__conversion__calculate_negative_target_length_7__n__assume))

;; H
  (assert
  (= (to_rep1 n__first) (to_rep1
                        (first9
                        aida__conversion__calculate_negative_target_length_7__n__assume1))))
...
;; H
  (assert
  (and (= temp___2656 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (= temp___2657 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))
...
;; H
  (assert (= index1 temp___2656))

;; H
  (assert
  (=> (and (<= temp___2656 index1) (<= index1 temp___2657))
  (= temp___2655 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2656 index1) (<= index1 temp___2657)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___2656 index1) (<= index1 temp___2657)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2656 index1) (<= index1 temp___2657)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2656 index1) (<= index1 temp___2657)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___2656 index1) (<= index1 temp___2657)) (= n2 o8)))
...
;; H
  ...
  (and
  (and
  (forall ((temp___2654 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___2654)
  (<= temp___2654 (to_rep1 n__last)))
  (=> (< index2 temp___2654)
  (= (select n3 temp___2654) (select temp___2653 temp___2654)))))
  (=>
  (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6))
...
;; H
  (assert
  (=> (and (<= temp___2656 index1) (<= index1 temp___2657)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___2656 index1) (<= index1 temp___2657)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___2656 index1) (<= index1 temp___2657)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___2656 index1) (<= index1 temp___2657)))
...
;; H
  (assert
  (=> (not (and (<= temp___2656 index1) (<= index1 temp___2657))) (= n7 n1)))
...
;; H
  (assert
  (and (= temp___2658 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2658)
  (<= temp___2658 (to_rep1 n__last))))

;; H
  (assert (= o9 temp___2658))
...
;; H
  (assert
  (and (= temp___2659 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2659)
  (<= temp___2659 (to_rep1 n__last))))

;; H
  (assert (= o14 temp___2659))
...
;; H
  (assert
  (and (= temp___2660 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2660)
  (<= temp___2660 (to_rep1 n__last))))

;; H
  (assert (= o21 temp___2660))
...
;; H
  (assert
  (and (= temp___2661 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2661)
  (<= temp___2661 (to_rep1 n__last))))

;; H
  (assert (= o28 temp___2661))
...
;; H
  (assert
  (and (= temp___2662 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2662)
  (<= temp___2662 (to_rep1 n__last))))

;; H
  (assert (= o35 temp___2662))
...
;; H
  (assert
  (and (= temp___2663 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2663)
  (<= temp___2663 (to_rep1 n__last))))

;; H
  (assert (= o42 temp___2663))
...
(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 1991, characters 0-0
  (not (in_range1 o47)))
(check-sat)
