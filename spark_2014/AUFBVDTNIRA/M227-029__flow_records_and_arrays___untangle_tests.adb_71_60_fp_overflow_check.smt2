...
;; H
  ...
  (= (rec__untangle_tests__coordinate__x
     (us_split_fields1
     (select (rec__untangle_tests__triangle__vertices
             (us_split_fields3 (select tl3 t3))) v2))) o25))
...
;; H
  ...
  (= (rec__untangle_tests__coordinate__z
     (us_split_fields1
     (select (rec__untangle_tests__triangle__vertices
             (us_split_fields3 (select tl3 t3))) v2))) o27))
...
;; H
  ...
  (= (rec__untangle_tests__coordinate__w
     (us_split_fields1
     (select (rec__untangle_tests__triangle__vertices
             (us_split_fields3 (select tl3 t3))) v2))) o28))
...
;; H
  ...
  (= o33 (store (rec__untangle_tests__triangle__vertices
                (us_split_fields3 (select tl3 t3))) v2 (mk___rep
                                                       (mk___split_fields 
                                                       o29 o30 o31 o32)))))
...
;; H
  (assert
  (= (rec__untangle_tests__triangle__normal
     (us_split_fields3 (select tl3 t3))) (mk___rep
...
;; WP_parameter_def
 ;; File "untangle_tests.adb", line 44, characters 0-0
  ...
  (us_split_fields1
  (select (rec__untangle_tests__triangle__vertices
          (us_split_fields3 (select tl4 t3))) v2))))
