...
;; H
  (assert (= end_of_seq true))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range2
  (ite (< size_of_seq3 biggest_seq2) biggest_seq2 size_of_seq3))))
(check-sat)
