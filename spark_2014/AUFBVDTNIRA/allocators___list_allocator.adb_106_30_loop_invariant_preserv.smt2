...
;; user_eq__def_axiom
  ...
  (! (and (oeq__function_guard (oeq a b) a b) (= (user_eq7 a b) (oeq a b))) :pattern (
  (user_eq7 a b)) )))

(define-fun default_initial_assumption ((temp___expr_212 us_rep3)
...
;; def_axiom
  (assert
  (forall ((temp___275 us_rep))
  (forall ((temp___276 Int))
  (= (select (list_allocator__data__aggregate_def temp___275) temp___276) temp___275))))
...
;; oeq__def_axiom
  ...
  (! (=> (oeq__function_guard (oeq x y) x y)
     (= (= (oeq x y) true)
     (and
     (= (oeq1 (rec__list_allocator__m__t__available (us_split_fields3 x))
...
;; contains__post_axiom
  ...
  (! (=> (dynamic_invariant6 item true true true)
     ...
     (=>
     (exists ((e Int))
     (and (and (in_range5 e) (= (contains1 container e) true)) (= e item)))
...
;; ole__post_axiom
  ...
  (! (= (= (ole left right) true)
     (forall ((item Int))
     (=> (and (in_range5 item) (= (contains1 left item) true))
...
;; is_empty__post_axiom
  ...
  (! (let ((result (is_empty container)))
     ...
     (= (= result true)
     (forall ((item Int))
     (not (and (in_range5 item) (= (contains1 container item) true)))))
...
(declare-fun o16 () status)

(declare-fun o17 () resource)

(declare-fun o18 () status)
...
;; H
  (assert
  (= o6 (list_allocator__data__aggregate_def
...
;; H
  (assert
  (forall ((rr Int)) (contains__function_guard
  (contains model____split_fields rr) model____split_fields rr)))
...
;; H
  ...
  (and
  (and
  (and (= (is_empty model____split_fields1) true)
  (= (length1 model____split_fields1) 0))
  (= (length model____split_fields) 10000))
  (= (get model____split_fields 1) 1))
  (forall ((rr Int))
  (=> (and (<= 1 rr) (<= rr 10000)) (= (get model____split_fields rr) rr))))
  (forall ((rr Int))
  (=> (and (<= 1 rr) (<= rr 10000))
  (= (contains model____split_fields rr) true)))))
...
;; H
  ...
  (=> (and (<= 1 rr) (<= rr r2))
  (= (to_rep
     (rec__list_allocator__cell__next (us_split_fields1 (select data3 rr)))) 
  (ite (= rr 10000) 0 (+ rr 1))))))
...
;; H
  ...
  (=> (and (<= 1 rr) (<= rr 10000))
  (= (to_rep1
     (rec__list_allocator__cell__stat (us_split_fields1 (select data3 rr)))) 0))))
...
;; H
  ...
  (=> (and (<= 1 temp___269) (<= temp___269 10000))
  (ite (< r2 temp___269)
  (= (select data3 temp___269) (select data1 temp___269))
  (= (rec__list_allocator__cell__stat
     (us_split_fields1 (select data3 temp___269))) (rec__list_allocator__cell__stat
                                                   (us_split_fields1
                                                   (select data1 temp___269)))))))
  (=> (<= 1 10000) (in_range3 r2))) (and (<= 1 r2) (<= r2 10000))))
...
;; H
  (assert (=> (< r3 10000) (and (= o14 (+ r3 1)) (in_range2 (+ r3 1)))))

;; H
  (assert (=> (< r3 10000) (= (to_rep o15) o14)))

;; H
  (assert
  (=> (< r3 10000)
  (= (rec__list_allocator__cell__stat (us_split_fields1 (select data3 r3))) 
  o16)))

;; H
  (assert (=> (< r3 10000) (= o15 o17)))

;; H
  (assert (=> (< r3 10000) (= o18 o16)))

;; H
  (assert (=> (< r3 10000) (= o19 o17)))

;; H
  (assert
  (=> (< r3 10000)
  (= o20 (store data3 r3 (mk___rep (mk___split_fields o18 o19))))))

;; H
  (assert (=> (< r3 10000) (= result5 data3)))

;; H
  (assert (=> (< r3 10000) (= data4 o20)))
...
;; WP_parameter_def
 ;; File "list_allocator.ads", line 80, characters 0-0
  ...
  (= (to_rep
     (rec__list_allocator__cell__next
     (us_split_fields1 (select data4 10000)))) 0)))
(check-sat)
