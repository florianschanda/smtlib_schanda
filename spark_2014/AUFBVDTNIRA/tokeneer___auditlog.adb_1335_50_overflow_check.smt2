...
;; H
  (assert
  (and (= o (converttoauditdescription description))
  (converttoauditdescription__function_guard o description)))
...
;; H
  (assert
  (and (= o1 (- (to_rep3 usedlogfiles__split_fields15) 1)) (in_range10
  (- (to_rep3 usedlogfiles__split_fields15) 1))))
...
;; H
  (assert (= o4 (+ o3 (to_rep2 (select logfileentries3 currentlogfile3)))))
