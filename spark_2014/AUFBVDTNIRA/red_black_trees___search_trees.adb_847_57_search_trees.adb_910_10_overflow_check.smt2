...
(declare-fun temp___1634 () (Array Int us_rep1))
...
;; H
  ...
  (select temp___1635 (parent
                      ...
                      t__split_fields10) i2))))
  (position (rec__search_trees__search_tree__struct t__split_fields10) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1635 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1635 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1636 o54))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1636 o54)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o54))
...
;; H
  (assert (= o55 (select temp___1636 i1)))
...
;; H
  ...
  (= temp___1635 (model__
                 (rec__search_trees__search_tree__struct t__split_fields10)
                 o50))
  (model____function_guard temp___1635
  (rec__search_trees__search_tree__struct t__split_fields10) o50))
  (and (dynamic_invariant6 temp___1635 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1635 o50))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1635 o50)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o50))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___1635 (parent
                              ...
                              t__split_fields10) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1635 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1635 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1635 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1635 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1635 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1635 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o51 (select temp___1635 y1)))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1634 (parent (mk___rep2 f_1__split_fields3) i2))))
  (position (mk___rep2 f_1__split_fields3) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1634 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1634 (parent (mk___rep2 f_1__split_fields3) i2))))
  (position (mk___rep2 f_1__split_fields3) i2)
...
;; H
  (assert
  (and
  (and (= temp___1634 (model__ (mk___rep2 f_1__split_fields3) o44))
  (model____function_guard temp___1634 (mk___rep2 f_1__split_fields3) 
  o44))
  (and (dynamic_invariant6 temp___1634 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1634 o44))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1634 o44)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o44))
  (ite (and (not (= (parent (mk___rep2 f_1__split_fields3) i2) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1634 (parent (mk___rep2 f_1__split_fields3) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1634 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1634 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1634 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1634 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1634 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1634 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o45 (select temp___1634 i1)))
