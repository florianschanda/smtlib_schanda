...
;; H
  (assert
  (and (= temp___2019 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___2019)
  (<= temp___2019 (to_rep1 (last (rt source))))))

;; H
  (assert (= o24 temp___2019))
...
;; H
  ...
  (convert_character_digit_to_integer__function_guard o27 o26))
  (and (in_range1 o27)
  (and (and (<= 0 o27) (<= o27 9))
...
;; H
  (assert
  (and (= temp___2018 (+ (to_rep1 (first (rt source))) 0)) (in_range1
  (+ (to_rep1 (first (rt source))) 0))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___2018)
  (<= temp___2018 (to_rep1 (last (rt source))))))

;; H
  (assert (= o19 temp___2018))
