...
(define-fun bool_eq21 ((a us_rep3)
...
;; therole__post_axiom
  ...
  (! (let ((result (therole contents)))
     (=> (therole__function_guard result contents) (dynamic_invariant2 result
...
(define-fun bool_eq25 ((a us_rep5)
...
(define-fun bool_eq26 ((a us_rep6)
...
(define-fun bool_eq27 ((a us_rep7)
...
;; theauthcertrole__post_axiom
  ...
  (! (let ((result (theauthcertrole admintoken__authcert__fields)))
     ...
     admintoken__authcert__fields) (dynamic_invariant2 result true false
...
(define-fun bool_eq28 ((a us_rep8)
...
(declare-fun temp___String_Literal_1395 (tuple0) (Array Int character))

;; temp___String_Literal_1395__def_axiom
  (assert
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_1395 us_void_param) 1)) 84)
     (= (to_rep (select (temp___String_Literal_1395 us_void_param) 2)) 111))
     (= (to_rep (select (temp___String_Literal_1395 us_void_param) 3)) 107))
     (= (to_rep (select (temp___String_Literal_1395 us_void_param) 4)) 101))
     (= (to_rep (select (temp___String_Literal_1395 us_void_param) 5)) 110))
     (= (to_rep (select (temp___String_Literal_1395 us_void_param) 6)) 32))
     (= (to_rep (select (temp___String_Literal_1395 us_void_param) 7)) 66))
     (= (to_rep (select (temp___String_Literal_1395 us_void_param) 8)) 97))
     (= (to_rep (select (temp___String_Literal_1395 us_void_param) 9)) 100)) :pattern (
  (temp___String_Literal_1395 us_void_param)) )))

(declare-fun temp___String_Literal_1396 (tuple0) (Array Int character))

;; temp___String_Literal_1396__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (and
     (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 1)) 65)
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 2)) 117))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 3)) 116))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 4)) 104))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 5)) 111))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 6)) 114))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 7)) 105))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 8)) 115))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 9)) 97))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 10)) 116))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 11)) 105))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 12)) 111))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 13)) 110))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 14)) 32))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 15)) 67))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 16)) 101))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 17)) 114))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 18)) 116))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 19)) 105))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 20)) 102))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 21)) 105))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 22)) 99))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 23)) 97))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 24)) 116))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 25)) 101))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 26)) 32))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 27)) 110))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 28)) 111))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 29)) 116))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 30)) 32))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 31)) 102))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 32)) 111))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 33)) 114))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 34)) 32))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 35)) 65))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 36)) 100))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 37)) 109))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 38)) 105))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 39)) 110))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 40)) 105))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 41)) 115))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 42)) 116))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 43)) 114))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 44)) 97))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 45)) 116))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 46)) 111))
     (= (to_rep (select (temp___String_Literal_1396 us_void_param) 47)) 114)) :pattern (
  (temp___String_Literal_1396 us_void_param)) )))
...
;; H
  (assert
  (and (and (= o (thetokentry state)) (thetokentry__function_guard o state))
  (in_range5 o)))
...
;; H
  (assert
  (and (and (= o1 (thetokenid state)) (thetokenid__function_guard o1 state))
  (in_range4 o1)))
...
;; H
  ...
  (therole__function_guard o2
  (mk___rep4
  (let ((subject authcertcontents__split_fields))
  authcertcontents__split_fields1)))) (in_range15 o2)))
