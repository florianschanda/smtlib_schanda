...
(declare-fun temp___185 () index_type)

(declare-fun temp___1851 () (Array Int character))

(declare-fun temp___1852 () t)

(declare-fun temp___1853 () length_type)

(define-fun temp___1854 () us_rep (mk___rep (mk___split_discrs temp___185)
                                  (mk___split_fields
                                  (mk___t temp___1851 temp___1852)
                                  temp___1853)))
...
;; H
  (assert
  (and (dynamic_invariant1 temp___1854 true false true)
  (and
  (let ((temp___187 (temp___171 32 1 (to_rep temp___185))))
  (and (= temp___1851 (elts1 temp___187))
  (= temp___1852 (mk (to_rep3 (first2 (rt1 temp___187)))
                 (to_rep3 (last4 (rt1 temp___187)))))))
  (= (to_rep1 temp___1853) 0))))

;; H
  (assert (length__function_guard (length2 temp___1854) temp___1854))

(assert
;; WP_parameter_def
 ;; File "bounded_strings.ads", line 29, characters 0-0
  (not (= (length2 temp___1854) 0)))
(check-sat)
