...
(declare-fun temp___155 () (Array Int Bool))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___155 x)))
...
;; H
  ...
  (=> (and (<= 1 temp___156) (<= temp___156 10))
  (=> (<= i2 temp___156)
  (= (select x2 temp___156) (select temp___155 temp___156)))))
  (and (<= 1 i2) (<= i2 10)))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 10)) (= result1 x2)))
