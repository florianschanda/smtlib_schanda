...
(define-fun dynamic_invariant ((temp___expr_281 us_rep1)
...
;; size__post_axiom
  (assert
  (forall ((f us_rep1))
  (! (=> (dynamic_invariant f true true true)
     (let ((result (size f)))
...
(declare-fun temp___1170 () extended_index_type)

(declare-fun temp___11701 () extended_index_type)

(declare-fun temp___11702 () (Array Int us_rep))

(declare-fun temp___11703 () (Array Int natural))
...
;; H
  ...
  (mk___rep2
  (mk___split_fields2 temp___1170
  (mk___rep1 (mk___split_fields1 temp___11701 temp___11702)) temp___11703))
  true false true))
...
;; H
  ...
  (and
  (and
  (= o (size (mk___rep1 (mk___split_fields1 temp___11701 temp___11702))))
  (size__function_guard o
  (mk___rep1 (mk___split_fields1 temp___11701 temp___11702)))) (in_range1 
  o)))
...
;; H
  (assert (not (= (to_rep temp___1170) 0)))

(assert
;; WP_parameter_def
 ;; File "search_trees.ads", line 311, characters 0-0
  (not (in_range (to_rep temp___1170))))
(check-sat)
