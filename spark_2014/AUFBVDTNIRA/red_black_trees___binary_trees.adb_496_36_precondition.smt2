...
(declare-fun temp___1852 () (Array Int us_rep1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1852 (parent
                      (mk___rep2
                      (mk___split_fields2 f__split_fields f__split_fields1))
                      i1))))
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1852 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1852 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___1852 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 o1))
  (model____function_guard temp___1852
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o1))
  (and (dynamic_invariant3 temp___1852 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1852 o1))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1852 o1)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o1))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1852 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1852 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1852 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1852 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1852 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1852 j)))) true))
  (= j i1)))))))))))))))
...
;; H
  ...
  (<= (to_rep
      (rec__binary_trees__cell__parent
      (us_split_fields3 (select f__split_fields1 i)))) 100))))
...
;; H
  ...
  (< 0 (to_rep
       (rec__binary_trees__cell__parent
       (us_split_fields3 (select f__split_fields1 i)))))
  (= (mk___rep (mk___split_fields o3 o4)) (select temp___1852 o2))))
...
;; H
  (assert (and (= o8 v) (in_range1 v)))

;; H
  (assert (valid_root__function_guard
  (valid_root
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o8)
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o8))
