...
;; def_axiom
  ...
  (and (= (first4 temp___255) temp___257) (= (last4 temp___255) temp___258)))
...
(declare-fun temp___263 () (Array Int character))

(declare-fun temp___2631 () t)
...
;; H
  (assert
  (= (to_rep1
     (first3 (rt1 (temp___254 32 (to_rep1 a__first) (to_rep1 a__last))))) 
  (to_rep1 a__first)))

;; H
  (assert
  (= (to_rep1
     (last3 (rt1 (temp___254 32 (to_rep1 a__first) (to_rep1 a__last))))) 
  (to_rep1 a__last)))
...
;; H
  (assert
  (= (mk (to_rep1 (first3 temp___2611)) (to_rep1 (last3 temp___2611))) 
  temp___2621))
