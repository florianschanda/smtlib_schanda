...
;; H
  (assert (= o44 (select temp___1443 i)))
...
;; H
  ...
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) o43))
...
;; H
  (assert (= o41 (select temp___1438 (int__content v2))))
