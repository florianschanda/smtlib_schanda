...
(define-fun dynamic_predicate1 ((temp___291 us_rep1)) Bool (<= (to_rep
                                                               (rec__integer_stacks__stack__top
                                                               (us_split_fields1
                                                               (to_base
                                                               temp___291)))) 
...
(define-fun dynamic_predicate2 ((temp___325 us_rep3)) Bool (<= (to_rep
                                                               (rec__integer_stacks__stack__top
                                                               (us_split_fields1
                                                               (to_base2
                                                               temp___325)))) 
...
(define-fun dynamic_predicate3 ((temp___308 us_rep2)) Bool (<= (to_rep
                                                               (rec__integer_stacks__stack__top
                                                               (us_split_fields1
                                                               (to_base1
                                                               temp___308)))) 
...
(declare-fun o5 () (Array Int element))

(declare-fun o6 () t)

(declare-fun o7 () natural)

(declare-fun o8 () us_private)

(declare-fun temp___395 () positive)

(declare-fun temp___3951 () (Array Int element))

(declare-fun temp___3952 () t)

(declare-fun temp___3953 () natural)

(declare-fun temp___3954 () us_private)

(declare-fun temp___3955 () Int)
...
;; H
  ...
  (<= (to_rep this__split_fields2) (to_rep2 (last1 this__split_fields1)))))
...
;; H
  (assert (= this__split_discrs (mk___split_discrs temp___395)))

;; H
  (assert (= temp___3951 o5))

;; H
  (assert (= temp___3952 o6))

;; H
  (assert (= temp___3953 o7))

;; H
  (assert (= temp___3954 o8))

;; H
  (assert (= this__attr__tag temp___3955))

(assert
;; WP_parameter_def
 ;; File "bounded_stacks.ads", line 23, characters 0-0
  (not (<= (to_rep temp___3953) (to_rep3 temp___395))))
(check-sat)
