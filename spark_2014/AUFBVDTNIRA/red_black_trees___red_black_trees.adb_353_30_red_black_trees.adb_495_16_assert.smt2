...
;; H
  (assert (parent__function_guard
  (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) y3)
  (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) y3))
...
;; H
  ...
  (= temp___1253 (let ((subject n1)) n11))))
