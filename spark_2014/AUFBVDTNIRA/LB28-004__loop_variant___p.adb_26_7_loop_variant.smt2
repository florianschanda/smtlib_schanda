...
(declare-fun tab10 () (Array Int integer))
...
;; H
  (assert
  (and (<= (to_rep tab__first) temp___1491)
  (<= temp___1491 (to_rep tab__last))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (or (< temp___1561 (int__content j14))
  (and (= (int__content j14) temp___1561) (< temp___1551 (int__content k7))))))
(check-sat)
