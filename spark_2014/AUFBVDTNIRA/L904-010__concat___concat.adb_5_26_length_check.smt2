...
;; def_axiom
  (assert
  (forall ((temp___185 Bool))
  (forall ((temp___186 Int))
  (= (select (concat__x__aggregate_def temp___185) temp___186) temp___185))))
...
;; WP_parameter_def
 ;; File "concat.adb", line 1, characters 0-0
  (not
  (= (ite (<= (to_rep (first temp___1931)) (to_rep (last temp___1931)))
     (+ (- (to_rep (last temp___1931)) (to_rep (first temp___1931))) 1) 0) 
  (ite (<= 1 10) (+ (- 10 1) 1) 0))))
(check-sat)
