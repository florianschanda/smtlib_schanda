...
(declare-fun temp___769 () count_type)
...
(define-fun s2__split_fields3 () us_split_fields (mk___split_fields
                                                 s2__split_fields1))
...
(define-fun temp___7691 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___769)))
...
;; H
  (assert
  (and (= (length (mk___rep s2__split_discrs s2__split_fields4)) 0)
  (= (is_empty (model__ (mk___rep s2__split_discrs s2__split_fields4))) true)))
...
;; H
  ...
  (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields3))
     (get
     (elements
...
;; H
  ...
  (=>
  (and (in_range3 e)
  (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields3)) e) true))
  (exists ((i Int))
  (and
  (and (<= 1 i)
  (<= i (length (mk___rep s2__split_discrs s2__split_fields3))))
...
;; H
  ...
  (ite (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields3))
          o) true)
  (and
  (and
  (and
  ...
  o))
  (= (equal_except (elements (mk___rep s2__split_discrs s2__split_fields3))
  ...
  (= (length (mk___rep s2__split_discrs s2__split_fields2)) (+ (length
                                                               ...
                                                               s2__split_discrs
                                                               s2__split_fields3)) 1))
  (= (ole (model__ (mk___rep s2__split_discrs s2__split_fields3))
     (model__ (mk___rep s2__split_discrs s2__split_fields2))) true))
  (= (included_except (model__ (mk___rep s2__split_discrs s2__split_fields2))
     (model__ (mk___rep s2__split_discrs s2__split_fields3)) o) true))
  (= (get (elements (mk___rep s2__split_discrs s2__split_fields2))
     (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o)) 
  o))
  (= (range_equal (elements (mk___rep s2__split_discrs s2__split_fields3))
     (elements (mk___rep s2__split_discrs s2__split_fields2)) 1
     (- (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o) 1)) true))
  (= (range_shifted (elements (mk___rep s2__split_discrs s2__split_fields3))
     (elements (mk___rep s2__split_discrs s2__split_fields2))
     (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o)
     (length (mk___rep s2__split_discrs s2__split_fields3)) 1) true))
  (= (p_positions_shifted
...
;; H
  ...
  (= (bool_eq3 temp___7691 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
...
;; H
  (assert (= cu__split_fields3 (mk___split_fields1 temp___769)))
...
;; H
  (assert
  (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) e) true))
...
;; WP_parameter_def
 ;; File "use_ordered_sets.ads", line 59, characters 0-0
  ...
  (and
  (and (<= 1 i)
  (<= i (length (mk___rep s2__split_discrs s2__split_fields2))))
  (= (get
     (elements
