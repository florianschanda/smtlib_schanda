...
(declare-fun x86__edx__result () (_ BitVec 32))

(declare-fun result () (_ BitVec 32))

(declare-fun x86__edx__result1 () (_ BitVec 32))

(declare-fun x86__edx__result2 () (_ BitVec 32))

(declare-fun x86__edx__result3 () (_ BitVec 32))

(declare-fun x86__edx__result4 () (_ BitVec 32))

(declare-fun x86__edx__result5 () (_ BitVec 32))
...
;; H
  (assert
  (= x86__edx__result1 ((_ extract 31 0) (bvand rdx ((_ int2bv 64) 4294967295)))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 8, characters 0-0
  (not (= x86__edx__result4 (readreg32 rdx))))
(check-sat)
