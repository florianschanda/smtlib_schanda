...
(declare-fun temp___3142 () (Array Int us_rep1))
...
(declare-fun temp___3143 () (Array Int us_rep1))
...
(declare-fun temp___3141 () (Array Int us_rep1))
...
(declare-fun temp___3140 () (Array Int us_rep1))
...
(declare-fun temp___3137 () (Array Int us_rep1))
...
(declare-fun temp___3138 () (Array Int us_rep1))
...
(declare-fun temp___3139 () (Array Int us_rep1))
...
(declare-fun temp___3134 () (Array Int us_rep1))
...
(declare-fun temp___3135 () (Array Int us_rep1))
...
(declare-fun temp___3133 () (Array Int us_rep1))

(declare-fun o43 () us_rep1)

(declare-fun o44 () us_split_fields)

(declare-fun temp___3132 () (Array Int us_rep1))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3140 (parent f1 i1)))) (position f1 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3140 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3140 (parent f1 i1)))) (position f1 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3140 i1))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3141 (parent f1 i1)))) (position f1 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3141 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3141 (parent f1 i1)))) (position f1 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3141 i1))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3143 (parent f1 i1)))) (position f1 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3143 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3143 (parent f1 i1)))) (position f1 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3143 i1))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3142 (parent f1 i1)))) (position f1 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3142 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3142 (parent f1 i1)))) (position f1 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3142 i1))))))
...
;; H
  (assert
  (and
  (and (= temp___3140 (model__ f1 root)) (model____function_guard temp___3140
  f1 root))
  (and (dynamic_invariant4 temp___3140 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3140 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3140 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f1 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___3140 (parent f1 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3140 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3140 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3140 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3140 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3140 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3140 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o14 o15)) (select temp___3140 
  i)))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (and (= temp___3141 (model__ f1 root)) (model____function_guard temp___3141
  f1 root))
  (and (dynamic_invariant4 temp___3141 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3141 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3141 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f1 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___3141 (parent f1 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3141 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3141 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3141 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3141 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3141 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3141 j1)))) true))
  (= j1 i1)))))))))))))))
...
;; H
  (assert
  (=> (= result2 true)
  (= (mk___rep (mk___split_fields o10 o11)) (select temp___3141 j))))
...
;; H
  ...
  (=> (= result1 true)
  (and
  (and (= temp___3143 (model__ f1 root)) (model____function_guard temp___3143
  f1 root))
  (and (dynamic_invariant4 temp___3143 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3143 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3143 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f1 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___3143 (parent f1 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3143 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3143 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3143 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3143 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3143 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3143 j1)))) true))
  (= j1 i1)))))))))))))))
...
;; H
  (assert
  (=> (= result1 true)
  (= (mk___rep (mk___split_fields o5 o6)) (select temp___3143 j))))
...
;; H
  ...
  (=> (= result1 true)
  (and
  (and (= temp___3142 (model__ f1 root)) (model____function_guard temp___3142
  f1 root))
  (and (dynamic_invariant4 temp___3142 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3142 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3142 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f1 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___3142 (parent f1 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3142 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3142 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3142 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3142 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3142 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3142 j1)))) true))
  (= j1 i1)))))))))))))))
...
;; H
  (assert
  (=> (= result1 true)
  (= (mk___rep (mk___split_fields o o1)) (select temp___3142 i))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3132 (parent f2 i1)))) (position f2 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3132 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3132 (parent f2 i1)))) (position f2 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3132 i1))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3133 (parent f2 i1)))) (position f2 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3133 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3133 (parent f2 i1)))) (position f2 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3133 i1))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3135 (parent f2 i1)))) (position f2 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3135 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3135 (parent f2 i1)))) (position f2 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3135 i1))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3134 (parent f2 i1)))) (position f2 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3134 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3134 (parent f2 i1)))) (position f2 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3134 i1))))))
...
;; H
  (assert
  (and
  (and (= temp___3132 (model__ f2 root)) (model____function_guard temp___3132
  f2 root))
  (and (dynamic_invariant4 temp___3132 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3132 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3132 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f2 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___3132 (parent f2 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3132 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3132 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3132 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3132 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3132 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3132 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= o45 (select temp___3132 i)))
...
;; H
  ...
  (=> (= result5 true)
  (and
  (and (= temp___3133 (model__ f2 root)) (model____function_guard temp___3133
  f2 root))
  (and (dynamic_invariant4 temp___3133 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3133 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3133 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f2 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___3133 (parent f2 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3133 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3133 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3133 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3133 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3133 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3133 j1)))) true))
  (= j1 i1)))))))))))))))

;; H
  (assert (=> (= result5 true) (= o43 (select temp___3133 j))))
...
;; H
  ...
  (=> (= result4 true)
  (and
  (and (= temp___3135 (model__ f2 root)) (model____function_guard temp___3135
  f2 root))
  (and (dynamic_invariant4 temp___3135 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3135 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3135 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f2 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___3135 (parent f2 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3135 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3135 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3135 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3135 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3135 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3135 j1)))) true))
  (= j1 i1)))))))))))))))

;; H
  (assert (=> (= result4 true) (= o40 (select temp___3135 j))))
...
;; H
  ...
  (=> (= result4 true)
  (and
  (and (= temp___3134 (model__ f2 root)) (model____function_guard temp___3134
  f2 root))
  (and (dynamic_invariant4 temp___3134 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3134 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3134 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f2 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___3134 (parent f2 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3134 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3134 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3134 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3134 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3134 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3134 j1)))) true))
  (= j1 i1)))))))))))))))

;; H
  (assert (=> (= result4 true) (= o37 (select temp___3134 i))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3139 (parent f2 i1)))) (position f2 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3139 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3139 (parent f2 i1)))) (position f2 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3139 i1))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3138 (parent f2 i1)))) (position f2 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3138 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3138 (parent f2 i1)))) (position f2 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3138 i1))))))
...
;; H
  (assert
  (and
  (and (= temp___3139 (model__ f2 root)) (model____function_guard temp___3139
  f2 root))
  (and (dynamic_invariant4 temp___3139 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3139 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3139 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f2 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___3139 (parent f2 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3139 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3139 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3139 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3139 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3139 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3139 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= o30 (select temp___3139 i)))
...
;; H
  (assert
  (and
  (and (= temp___3138 (model__ f2 root)) (model____function_guard temp___3138
  f2 root))
  (and (dynamic_invariant4 temp___3138 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3138 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3138 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f2 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___3138 (parent f2 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3138 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3138 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3138 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3138 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3138 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3138 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o25 o26)) (select temp___3138 
  j)))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3137 (parent f1 i1)))) (position f1 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3137 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3137 (parent f1 i1)))) (position f1 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3137 i1))))))
...
;; H
  (assert
  (and
  (and (= temp___3137 (model__ f1 root)) (model____function_guard temp___3137
  f1 root))
  (and (dynamic_invariant4 temp___3137 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3137 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3137 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f1 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___3137 (parent f1 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3137 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3137 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3137 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3137 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3137 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3137 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o18 o19)) (select temp___3137 
  i)))
