...
(define-fun dynamic_invariant ((temp___expr_376 us_rep2)
...
(define-fun default_initial_assumption ((temp___expr_380 us_rep2)
...
(define-fun type_invariant ((temp___392 us_rep2)) Bool (ite (= (size
                                                               (rec__search_trees__search_tree__struct
                                                               (us_split_fields5
                                                               temp___392))) 0)
                                                       (= (to_rep
...
;; size__def_axiom
  (assert
  (forall ((t us_rep2))
  (! (=> (dynamic_invariant t true true true)
     (= (size1 t) (size
                  (rec__search_trees__search_tree__struct
...
(define-fun dynamic_invariant3 ((temp___expr_150 Int)
...
(define-fun dynamic_invariant4 ((temp___expr_273 us_rep1)
...
(define-fun default_initial_assumption1 ((temp___expr_276 us_rep1)
...
(define-fun type_invariant1 ((temp___282 us_rep1)) Bool (= (tree_structure
                                                           temp___282) true))
...
;; size__post_axiom
  (assert
  (forall ((f us_rep1))
  (! (=> (dynamic_invariant4 f true true true) (dynamic_invariant1 (size f)
...
;; position__post_axiom
  ...
  (! (=>
     (and
     (and (dynamic_invariant4 f true true true) (dynamic_invariant3 i true
     true true)) (not (= (parent f i) 0))) (dynamic_invariant6 (position f i)
