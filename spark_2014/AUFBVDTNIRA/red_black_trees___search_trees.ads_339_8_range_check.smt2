...
(define-fun dynamic_invariant ((temp___expr_562 us_rep2)
...
(define-fun default_initial_assumption ((temp___expr_567 us_rep2)
...
(define-fun type_invariant ((temp___581 us_rep2)) Bool (ite (= (size
                                                               (rec__search_trees__search_tree__struct
                                                               (us_split_fields5
                                                               temp___581))) 0)
                                                       (= (to_rep
...
;; size__post_axiom
  (assert
  (forall ((t us_rep2))
  (! (=> (and (dynamic_invariant t true true true) (type_invariant t))
     (let ((result (size1 t)))
...
;; size__def_axiom
  ...
  (forall ((t us_rep2))
  (! (=>
     (and (dynamic_invariant t true true true) (size__function_guard1
     (size1 t) t))
     (and (size__function_guard
     (size (rec__search_trees__search_tree__struct (us_split_fields5 t)))
     (rec__search_trees__search_tree__struct (us_split_fields5 t)))
     (= (size1 t) (size
                  (rec__search_trees__search_tree__struct
                  (us_split_fields5 t)))))) :pattern ((size1 t)) )))
...
(define-fun bool_eq11 ((a (Array Int us_rep4)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq10 (select a temp___idx_132)
...
(define-fun dynamic_invariant4 ((temp___expr_281 us_rep1)
...
(define-fun type_invariant1 ((temp___292 us_rep1)) Bool (= (tree_structure
                                                           temp___292) true))
...
;; ordered_leafs__def_axiom
  ...
  (! (=> (ordered_leafs__function_guard (ordered_leafs f root values) f root
     ...
     (< (to_rep2 (select values j)) (to_rep2 (select values i)))
     (< (to_rep2 (select values i)) (to_rep2 (select values j))))))))))))))))) :pattern (
...
;; size__post_axiom
  (assert
  (forall ((f us_rep1))
  (! (=> (dynamic_invariant4 f true true true)
     (let ((result (size f)))
...
;; valid_root__post_axiom
  ...
  (forall ((i Int))
  (! (=>
     (and (dynamic_invariant4 f true true true) (dynamic_invariant3 i true
     true true))
...
;; model____post_axiom
  ...
  (! (and (valid_root__function_guard (valid_root f root) f root)
     (=>
     (and
     (and (dynamic_invariant4 f true true true) (dynamic_invariant3 root true
     ...
     (is_add
     (rec__tree_model__path_type__a
     (us_split_fields7 (select result (parent f i)))) (position f i)
     (rec__tree_model__path_type__a (us_split_fields7 (select result i))))
     (rec__tree_model__path_type__a
     (us_split_fields7 (select result (parent f i)))) (position f i)
     (rec__tree_model__path_type__a (us_split_fields7 (select result i)))))
     ...
     (ite (and (not (= (parent f i) 0))
          (= (rec__tree_model__path_type__k
             (us_split_fields7 (select result (parent f i)))) true))
     (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true)
     (not
     (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true))))))
     (and
     (forall ((i Int))
     ...
     (= (is_add
        (rec__tree_model__path_type__a
        (us_split_fields7 (select result (parent f i)))) (position f i)
        (rec__tree_model__path_type__a (us_split_fields7 (select result i)))) true)
     (= (length
        (rec__tree_model__path_type__a (us_split_fields7 (select result i)))) 0))))
     (forall ((i Int))
     (=> (and (<= 1 i) (<= i 100))
     (=>
     (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true)
...
;; H
  (assert (dynamic_invariant t true false true))

;; H
  (assert (type_invariant t))

;; H
  (assert (size__function_guard1 (size1 t) t))
...
;; WP_parameter_def
 ;; File "tree_model.ads", line 12, characters 0-0
  (not (in_range
  (to_rep (rec__search_trees__search_tree__root (us_split_fields5 t))))))
(check-sat)
