...
;; H
  (assert
  (and (= o31 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o31 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o30 (from_word64 i2)) (from_word64__function_guard o30 i2)))

;; H
  (assert (and (= o32 (oadd o30 o31)) (oadd__function_guard o32 o30 o31)))

;; H
  (assert
  (and (= o29 (from_integer j3)) (from_integer__function_guard o29 j3)))

;; H
  (assert (and (= o33 (ole o29 o32)) (ole__function_guard o33 o29 o32)))

;; H
  (assert (and (= o27 (+ k 1)) (in_range1 (+ k 1))))

;; H
  (assert (= o28 (ite (<= j3 o27) true false)))

;; H
  (assert
  (and (= o24 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o24 ((_ int2bv 32) 2))))

;; H
  (assert (and (= o25 (oexpon o24 j3)) (oexpon__function_guard o25 o24 j3)))

;; H
  (assert
  (and (= o19 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o19 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o18 (from_integer j3)) (from_integer__function_guard o18 j3)))

;; H
  (assert
  (and (= o20 (osubtract o18 o19)) (osubtract__function_guard o20 o18 o19)))

;; H
  (assert
  (and (= o17 (from_word64 i2)) (from_word64__function_guard o17 i2)))

;; H
  (assert
  (and (= o21 (osubtract o17 o20)) (osubtract__function_guard o21 o17 o20)))

;; H
  (assert
  (and (= o16 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o16 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o22 (oexpon__2 o16 o21)) (oexpon__2__function_guard o22 o16 o21)))
...
;; H
  (assert
  (and (= o15 (num_of_big_int e e_first o14)) (num_of_big_int__function_guard
  o15 e e_first o14)))

;; H
  (assert
  (and (= o23 (odivide o15 o22)) (odivide__function_guard o23 o15 o22)))

;; H
  (assert (and (= o26 (omod o23 o25)) (omod__function_guard o26 o23 o25)))

;; H
  (assert (and (= o8 (- j3 s3)) (in_range1 (- j3 s3))))
