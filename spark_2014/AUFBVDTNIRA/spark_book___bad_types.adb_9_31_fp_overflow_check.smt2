...
(define-fun dynamic_invariant1 ((temp___expr_514 t) (temp___is_init_511 Bool)
  (temp___skip_constant_512 Bool)
  (temp___do_toplevel_513 Bool)) Bool (=>
                                      (or (= temp___is_init_511 true) (le
                                      (neg fliteral1) fliteral1))
                                      (tqtisFinite temp___expr_514)))
...
(declare-fun room_length () t)

(declare-fun wall_thickness () t)

(declare-fun total () t)

(declare-fun ada__float_text_io__get__2__item () t)

(declare-fun result () t)

(declare-fun room_length1 () t)

(declare-fun ada__float_text_io__get__2__item1 () t)

(declare-fun result1 () t)

(declare-fun wall_thickness1 () t)

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite room_length)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite wall_thickness)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite total)))

;; H
  (assert (tqtisFinite ada__float_text_io__get__2__item))
...
;; H
  (assert (tqtisFinite ada__float_text_io__get__2__item1))
...
;; WP_parameter_def
 ;; File "bad_types.adb", line 2, characters 0-0
  (not (tqtisFinite (mul RNE1 fliteral2 wall_thickness1))))
(check-sat)
