...
(declare-fun result10 () (Array Int value))

(declare-fun result11 () t1)
...
;; H
  ...
  (= (mk___rep (mk___split_discrs result9)
     (mk___split_fields (mk___t1 result10 result11))) (table__content
                                                      simple_unc_arrays__bubble_sort__result6)))
 ...
 ;; File "simple_unc_arrays.ads", line 10, characters 0-0
  ...
  (<= (to_rep2
      (select (elts1
              (rec__simple_unc_arrays__table__v
              (us_split_fields1
              (table__content simple_unc_arrays__bubble_sort__result6)))) 
      j)) (to_rep2
          (select (elts1
                  (rec__simple_unc_arrays__table__v
                  (us_split_fields1
