...
(define-fun bool_eq4 ((a (Array Int word32)) (a__first Int) (a__last Int)
...
(define-fun bool_eq9 ((x1 Int) (y Int)) Bool (ite (= x1 y) true false))
...
(declare-fun temp___1032 () (Array Int word32))

(declare-fun temp___1030 () (Array Int word32))
...
(declare-fun temp___1079 () (_ BitVec 32))
...
(declare-fun aux45 () map__ref)

(declare-fun h5 () int__ref)
...
;; H
  ...
  (num_of_big_int r r_first (+ (- a_last a_first) 1)) r r_first
  (+ (- a_last a_first) 1)))
...
;; H
  (assert (from_integer__function_guard (from_integer 2) 2))

;; H
  (assert (from_integer__function_guard
  (from_integer (+ (- a_last a_first) 1)) (+ (- a_last a_first) 1)))
...
;; H
  ...
  (from_integer 2) (from_integer (+ (- a_last a_first) 1))))
...
;; H
  (assert (oexpon__2__function_guard
...
;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int m m_first (+ (- a_last a_first) 1)) m m_first
  (+ (- a_last a_first) 1)))
...
;; H
  (assert (from_word32__function_guard (from_word32 ((_ int2bv 32) 1))
  ((_ int2bv 32) 1)))
...
;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last)))
  aux1_first (+ l1 1))
...
;; H
  ...
  (oeq
  (num_of_big_int (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last)))
  aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1)))
  (num_of_big_int (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last)))
  aux1_first (+ l1 1)) (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last)))
  aux2_first (+ l1 1))
  (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first
  (+ l1 1)))

;; H
  (assert (num_of_big_int__function_guard (num_of_big_int x x_first (+ l1 1))
  x x_first (+ l1 1)))
...
;; H
  ...
  (num_of_big_int x x_first (+ l1 1))) (num_of_big_int x x_first (+ l1 1))
  (num_of_big_int x x_first (+ l1 1))))
...
;; H
  (assert (oexpon__function_guard (oexpon (base Tuple0) (+ l1 1))
  (base Tuple0) (+ l1 1)))
...
;; H
  (assert (num_of_big_int__function_guard (num_of_big_int m m_first (+ l1 1))
  m m_first (+ l1 1)))
...
;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last)))
  aux3_first (+ l1 1))
...
;; H
  (assert (omod__function_guard
  (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))
  (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1))))
...
;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int (mk___t aux4 (mk (to_rep aux4__first) (to_rep aux4__last)))
  aux4_first (+ l1 1))
...
;; H
  (assert (omultiply__function_guard
  (omultiply (num_of_big_int x x_first (+ l1 1))
  (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int x x_first (+ l1 1))
  (oexpon (base Tuple0) (+ l1 1))))
...
;; H
  (assert
  (forall ((n1 Int)) (num_of_big_int__function_guard
  (num_of_big_int
...
;; H
  (assert
  (forall ((n1 Int)) (oexpon__function_guard
  (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1))
  (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1))))
...
;; H
  (assert
  (forall ((n1 Int)) (omultiply__function_guard
...
;; H
  (assert
  (forall ((n1 Int)) (omod__function_guard
  (omod
  (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1))
  (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))
  (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1))
...
;; H
  (assert
  (forall ((n1 Int)) (oeq__function_guard
  (oeq
  (num_of_big_int
  (mk___t aux41 (mk (to_rep aux4__first) (to_rep aux4__last)))
  (+ aux4_first (* n1 (+ l1 1))) (+ l1 1))
...
;; H
  (assert (and (= temp___1074 o1) (in_range1 o1)))
...
;; H
  (assert (=> (and (<= 1 h1) (<= h1 temp___1074)) (= temp___1035 h1)))

;; H
  (assert (=> (and (<= 1 h1) (<= h1 temp___1074)) (= temp___1032 a)))

;; H
  (assert (=> (and (<= 1 h1) (<= h1 temp___1074)) (= temp___1030 aux4)))

;; H
  (assert
  (=> (and (<= 1 h1) (<= h1 temp___1074))
  (and
  (and
  (and
  (and (= l1 (- a_last a_first))
...
;; H
  (assert (=> (and (<= 1 h1) (<= h1 temp___1074)) (= h2 temp___1074)))

;; H
  (assert (=> (and (<= 1 h1) (<= h1 temp___1074)) (= h3 (mk_int__ref h2))))

;; H
  (assert (=> (and (<= 1 h1) (<= h1 temp___1074)) (= aux42 aux43)))

;; H
  (assert (=> (and (<= 1 h1) (<= h1 temp___1074)) (= a2 a3)))

;; H
  (assert (=> (and (<= 1 h1) (<= h1 temp___1074)) (= h4 h2)))

;; H
  (assert (=> (and (<= 1 h1) (<= h1 temp___1074)) (= aux44 aux42)))

;; H
  (assert (=> (and (<= 1 h1) (<= h1 temp___1074)) (= a4 a2)))

;; H
  (assert (=> (and (<= 1 h1) (<= h1 temp___1074)) (= h5 h3)))

;; H
  (assert
  (=> (and (<= 1 h1) (<= h1 temp___1074)) (= aux45 (mk_map__ref aux43))))

;; H
  (assert (=> (and (<= 1 h1) (<= h1 temp___1074)) (= a5 (mk_map__ref a3))))

;; H
  (assert (=> (and (<= 1 h1) (<= h1 temp___1074)) (= h6 h4)))

;; H
  (assert (=> (and (<= 1 h1) (<= h1 temp___1074)) (= aux46 aux44)))

;; H
  (assert (=> (and (<= 1 h1) (<= h1 temp___1074)) (= a6 a4)))

;; H
  (assert
  (=> (not (and (<= 1 h1) (<= h1 temp___1074))) (= h5 (mk_int__ref h1))))

;; H
  (assert
  (=> (not (and (<= 1 h1) (<= h1 temp___1074))) (= aux45 (mk_map__ref aux4))))

;; H
  (assert
  (=> (not (and (<= 1 h1) (<= h1 temp___1074))) (= a5 (mk_map__ref a))))

;; H
  (assert (=> (not (and (<= 1 h1) (<= h1 temp___1074))) (= h6 h1)))

;; H
  (assert (=> (not (and (<= 1 h1) (<= h1 temp___1074))) (= aux46 aux4)))

;; H
  (assert (=> (not (and (<= 1 h1) (<= h1 temp___1074))) (= a6 a1)))
...
;; H
  ...
  (+ l1 1)) (mk___t aux31 (mk (to_rep aux3__first) (to_rep aux3__last)))
  aux3_first (+ l1 1)))
...
;; H
  (assert (num_of_big_int__function_guard
  (num_of_big_int e e_first (+ (- e_last e_first) 1)) e e_first
  (+ (- e_last e_first) 1)))
...
;; H
  (assert (from_word64__function_guard (from_word64 i2) i2))
...
;; H
  ...
  (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1))) (from_word64 i2)
  (from_word32 ((_ int2bv 32) 1))))
...
;; H
  (assert (odivide__function_guard
...
;; H
  ...
  (forall ((n1 Int)) (num_of_big_int__function_guard
  (num_of_big_int
  (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last)))
  (+ aux4_first (* n1 (+ l1 1))) (+ l1 1))
  (mk___t (map__content aux45) (mk (to_rep aux4__first) (to_rep aux4__last)))
  (+ aux4_first (* n1 (+ l1 1))) (+ l1 1))))
...
;; H
  (assert
  (and
  (and (= result2 (bit_set e e_first i2)) (bit_set__function_guard result2 
  e e_first i2))
  (= (= result2 true)
  (not
  (= (bvand (to_rep1
            (select (elts e) (+ e_first (bv2nat (bvudiv i2 ((_ int2bv 64) 32)))))) 
  (let ((temp___569 (bv2nat (bvurem i2 ((_ int2bv 64) 32)))))
  (ite (< temp___569 4294967296)
  (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___569)) ((_ int2bv 32) 0)))) ((_ int2bv 32) 0))))))
...
;; H
  (assert (from_word32__function_guard (from_word32 w2) w2))
...
;; H
  (assert (oexpon__function_guard
  (oexpon (from_word32 ((_ int2bv 32) 2)) (- (- j3 s3) 1))
  (from_word32 ((_ int2bv 32) 2)) (- (- j3 s3) 1)))
...
;; H
  ...
  (oexpon (from_word32 ((_ int2bv 32) 2)) (- (- j3 s3) 1))) (from_word32 w2)
  (oexpon (from_word32 ((_ int2bv 32) 2)) (- (- j3 s3) 1))))
...
;; H
  (assert (from_integer__function_guard (from_integer j3) j3))
...
;; H
  ...
  (from_integer j3) (from_word32 ((_ int2bv 32) 1))))
...
;; H
  (assert (oexpon__function_guard (oexpon (from_word32 ((_ int2bv 32) 2)) j3)
  (from_word32 ((_ int2bv 32) 2)) j3))
...
;; H
  ...
  (osubtract (from_word64 i2)
  (osubtract (from_integer j3) (from_word32 ((_ int2bv 32) 1))))))
  (oexpon (from_word32 ((_ int2bv 32) 2)) j3))
  (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1))
  (oexpon__2 (from_word32 ((_ int2bv 32) 2))
  (osubtract (from_word64 i2)
  (osubtract (from_integer j3) (from_word32 ((_ int2bv 32) 1))))))
...
;; H
  (assert (ole__function_guard
  (ole (from_integer j3)
  (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))) (from_integer j3)
  (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))))
...
;; H
  (assert (= temp___1081 s2))

;; H
  (assert (= temp___1080 j2))

;; H
  (assert (= temp___1079 w1))
...
;; H
  (assert
  (and (= o8 (+ (int__content s8) 1)) (in_range1 (+ (int__content s8) 1))))
...
;; H
  ...
  (+ l1 1)) (mk___t aux32 (mk (to_rep aux3__first) (to_rep aux3__last)))
  aux3_first (+ l1 1)))
...
;; H
  (assert (oexpon__function_guard
  (oexpon (from_word32 ((_ int2bv 32) 2)) (- h9 1))
  (from_word32 ((_ int2bv 32) 2)) (- h9 1)))
...
;; H
  (assert (from_word32__function_guard (from_word32 (t__content w7))
  (t__content w7)))
...
;; H
  (assert (from_integer__function_guard (from_integer s10) s10))
...
;; H
  (assert (osubtract__function_guard
  (osubtract (from_integer s10) (from_word32 ((_ int2bv 32) 1)))
  (from_integer s10) (from_word32 ((_ int2bv 32) 1))))
...
;; H
  (assert (oexpon__function_guard
  (oexpon (from_word32 ((_ int2bv 32) 2)) s10)
  (from_word32 ((_ int2bv 32) 2)) s10))
...
;; H
  (assert (ole__function_guard
  (ole (from_integer s10)
  (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))) (from_integer s10)
  (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))))
...
;; H
  ...
  (= (oeq (from_word32 (t__content w7))
     ...
     (osubtract (from_word64 i2)
     (osubtract (from_integer s10) (from_word32 ((_ int2bv 32) 1))))))
     (oexpon (from_word32 ((_ int2bv 32) 2)) s10))) true))
  (= (bvurem (t__content w7) ((_ int2bv 32) 2)) ((_ int2bv 32) 1)))
  (<= 0 s10)) (<= s10 (+ k 1)))
  (= (ole (from_integer s10)
     (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))) true))
  (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) ((_ int2bv 64) 1)) ((_ int2bv 64) 32)))))
...
;; H
  (assert
  (and (=> (<= 1 r94b) (dynamic_property2 1 r94b h9))
  (and (<= 1 h9) (<= h9 r94b))))
...
;; H
  (assert (= o60 (bvadd o59 ((_ int2bv 64) 1))))

;; H
  (assert (= o61 (bvmul o60 ((_ int2bv 64) 32))))
...
;; H
  (assert
  (and (= o54 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o54 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o53 (from_word64 i2)) (from_word64__function_guard o53 i2)))

;; H
  (assert (and (= o55 (oadd o53 o54)) (oadd__function_guard o55 o53 o54)))

;; H
  (assert
  (and (= o52 (from_integer s10)) (from_integer__function_guard o52 s10)))

;; H
  (assert (and (= o56 (ole o52 o55)) (ole__function_guard o56 o52 o55)))
...
;; H
  (assert
  (and (= o46 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o46 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o47 (oexpon o46 s10)) (oexpon__function_guard o47 o46 s10)))

;; H
  (assert
  (and (= o41 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o41 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o40 (from_integer s10)) (from_integer__function_guard o40 s10)))

;; H
  (assert
  (and (= o42 (osubtract o40 o41)) (osubtract__function_guard o42 o40 o41)))

;; H
  (assert
  (and (= o39 (from_word64 i2)) (from_word64__function_guard o39 i2)))

;; H
  (assert
  (and (= o43 (osubtract o39 o42)) (osubtract__function_guard o43 o39 o42)))

;; H
  (assert
  (and (= o38 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o38 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o44 (oexpon__2 o38 o43)) (oexpon__2__function_guard o44 o38 o43)))
...
;; H
  (assert
  (and (= o37 (num_of_big_int e e_first o36)) (num_of_big_int__function_guard
  o37 e e_first o36)))

;; H
  (assert
  (and (= o45 (odivide o37 o44)) (odivide__function_guard o45 o37 o44)))

;; H
  (assert (and (= o48 (omod o45 o47)) (omod__function_guard o48 o45 o47)))

;; H
  (assert
  (and (= o32 (from_word32 (t__content w7))) (from_word32__function_guard 
  o32 (t__content w7))))

;; H
  (assert (and (= o49 (oeq o32 o48)) (oeq__function_guard o49 o32 o48)))
...
;; H
  (assert
  (and (= o30 (num_of_big_int m m_first o29)) (num_of_big_int__function_guard
  o30 m m_first o29)))
...
;; H
  (assert
  (and (and (= o25 (base Tuple0)) (base__function_guard o25 Tuple0))
  (= o25 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o27 (oexpon o25 o26)) (oexpon__function_guard o27 o25 o26)))
...
;; H
  (assert
  (and (= o19 (num_of_big_int x x_first o18)) (num_of_big_int__function_guard
  o19 x x_first o18)))

;; H
  (assert
  (and (= o24 (oexpon o19 o23)) (oexpon__function_guard o24 o19 o23)))

;; H
  (assert
  (and (= o28 (omultiply o24 o27)) (omultiply__function_guard o28 o24 o27)))

;; H
  (assert (and (= o31 (omod o28 o30)) (omod__function_guard o31 o28 o30)))
