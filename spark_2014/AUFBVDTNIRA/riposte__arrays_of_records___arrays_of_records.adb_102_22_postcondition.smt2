...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__flag
     (us_split_fields1 (select a2 17))) o17))
...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__second_value
     (us_split_fields1 (select a2 17))) o19))
...
;; H
  (assert
  (= a4 (store a3 5 (mk___rep
                    (mk___split_fields (of_int 0)
                    (rec__arrays_of_records__basic_record__first_value
                    (us_split_fields1 (select a3 5)))
                    (rec__arrays_of_records__basic_record__second_value
                    (us_split_fields1 (select a3 5))))))))
...
(assert
;; WP_parameter_def
 ;; File "arrays_of_records.adb", line 88, characters 0-0
  (not
  (= (to_rep
     (rec__arrays_of_records__basic_record__first_value
     (us_split_fields1 (select a5 17)))) 42)))
(check-sat)
