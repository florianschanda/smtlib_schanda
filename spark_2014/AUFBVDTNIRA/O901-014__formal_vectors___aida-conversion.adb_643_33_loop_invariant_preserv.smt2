...
(define-fun tint_arrayD1__ref_9__projection ((a tint_arrayD1__ref)) integer 
...
(define-fun tint_arrayT__ref_9__projection ((a tint_arrayT__ref)) us_t1 
...
(declare-datatypes ()
((t224b__ref (mk_t224b__ref (t224b__content integer)))))
(define-fun t224b__ref___projection ((a t224b__ref)) integer (t224b__content
                                                             a))
...
(define-fun tnumber_array_typeD1__ref_9__projection ((a tnumber_array_typeD1__ref)) integer 
...
(define-fun number_array_type__ref_9__projection ((a number_array_type__ref)) us_t3 
...
(declare-datatypes ()
((t228b__ref (mk_t228b__ref (t228b__content integer)))))
(define-fun t228b__ref___projection ((a t228b__ref)) integer (t228b__content
                                                             a))
...
(declare-datatypes ()
((t230b__ref (mk_t230b__ref (t230b__content integer)))))
(define-fun t230b__ref___projection ((a t230b__ref)) integer (t230b__content
                                                             a))
...
(define-fun tint_arrayB__ref_9__projection ((a tint_arrayB__ref)) us_t5 
  (tint_arrayB__content a))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__aggregate_def (Int
  Int Int Int Int Int Int Int Int Int Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___1678 Int) (temp___1679 Int) (temp___1680 Int)
  (temp___1681 Int) (temp___1682 Int) (temp___1683 Int) (temp___1684 Int)
  (temp___1685 Int) (temp___1686 Int) (temp___1687 Int) (temp___1688 Int)
  (temp___1689 Int))
  (let ((temp___1677 (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__aggregate_def
                     temp___1678 temp___1679 temp___1680 temp___1681
                     temp___1682 temp___1683 temp___1684 temp___1685
                     temp___1686 temp___1687 temp___1688 temp___1689)))
  (and
  (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1688
  temp___1689)
  (and (= (first7 temp___1677) temp___1688)
  (= (last7 temp___1677) temp___1689)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___1677) (+ (first1 source) 0)) (of_rep1
                                                            temp___1678))
  (= (select (to_array2 temp___1677) (+ (first1 source) 1)) (of_rep1
                                                            temp___1679)))
  (= (select (to_array2 temp___1677) (+ (first1 source) 2)) (of_rep1
                                                            temp___1680)))
  (= (select (to_array2 temp___1677) (+ (first1 source) 3)) (of_rep1
                                                            temp___1681)))
  (= (select (to_array2 temp___1677) (+ (first1 source) 4)) (of_rep1
                                                            temp___1682)))
  (= (select (to_array2 temp___1677) (+ (first1 source) 5)) (of_rep1
                                                            temp___1683)))
  (= (select (to_array2 temp___1677) (+ (first1 source) 6)) (of_rep1
                                                            temp___1684)))
  (= (select (to_array2 temp___1677) (+ (first1 source) 7)) (of_rep1
                                                            temp___1685)))
  (= (select (to_array2 temp___1677) (+ (first1 source) 8)) (of_rep1
                                                            temp___1686)))
  (= (select (to_array2 temp___1677) (+ (first1 source) 9)) (of_rep1
                                                            temp___1687)))))))
...
(define-fun tnumber_array_typeB__ref_9__projection ((a tnumber_array_typeB__ref)) us_t6 
  (tnumber_array_typeB__content a))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__aggregate_def (Int
  Int Int) us_t4)

;; def_axiom
  (assert
  (forall ((temp___1695 Int) (temp___1696 Int) (temp___1697 Int))
  (let ((temp___1694 (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__aggregate_def
                     temp___1695 temp___1696 temp___1697)))
  (and
  (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1696
  temp___1697)
  (and (= (first13 temp___1694) temp___1696)
  (= (last13 temp___1694) temp___1697)))
  (forall ((temp___1698 Int))
  (= (select (to_array4 temp___1694) temp___1698) (of_rep1 temp___1695)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_334 us_t3)
  ...
  (temp___do_toplevel_333 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 9)
                                      (first10 temp___expr_334)
                                      (last10 temp___expr_334))
                                      (and
                                      (= (first10 temp___expr_334) (first1
                                                                   source))
                                      (= (last10 temp___expr_334) (+ 
                                      (first1 source) 9))))))
...
(declare-fun temp___1692 () (Array Int integer))

(declare-fun temp___16921 () t2)

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume1 () t1)

(declare-fun temp___1700 () (Array Int integer))

(declare-fun temp___17001 () t4)

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume1 () t3)

(declare-fun temp___1707 () Int)
...
;; H
  ...
  (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 48)))
  (forall ((index4 Int))
  (=>
...
;; H
  ...
  (= (to_rep1
     (first6
     (rt2
     (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__aggregate_def
     2 0 9 9 9 9 9 9 9 9 (to_rep1 (first (rt source)))
...
;; H
  (assert
  (= (mk___t2 temp___1692 temp___16921) (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__aggregate_def
                                        2 0 9 9 9 9 9 9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___16921)) (to_rep1 (last6 temp___16921)))
     (+ (- (to_rep1 (last6 temp___16921)) (to_rep1 (first6 temp___16921))) 1)
...
;; H
  (assert
  (= (slide1 temp___1692 (to_rep1 (first6 temp___16921))
     (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume))

;; H
  (assert
  (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) 
  aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume1))
...
;; H
  (assert
  (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume))
...
;; H
  ...
  (= (to_rep1
     (first12
     (rt4
     (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__aggregate_def
...
;; H
  (assert
  (= (mk___t4 temp___1700 temp___17001) (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__aggregate_def
                                        0 (to_rep1 (first (rt source)))
                                        (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___17001)) (to_rep1
                                               (last12 temp___17001)))
     (+ (- (to_rep1 (last12 temp___17001)) (to_rep1 (first12 temp___17001))) 1)
     0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1
                                                  (first (rt source))) 9))
        (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1
                                                  (first (rt source)))) 1)
...
;; H
  (assert
  (= (slide1 temp___1700 (to_rep1 (first12 temp___17001))
     (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume))

;; H
  (assert
  (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) 
  aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume1))
...
;; H
  (assert
  (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume))
...
;; H
  (assert
  (and (= temp___1707 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 n__first) temp___1705)
  (<= temp___1705 (to_rep1 n__last)))
  (=> (< index2 temp___1705)
  (= (select n3 temp___1705) (select n1 temp___1705))))))
  (and (<= (to_rep1 (first (rt source))) index2)
  (<= index2 (+ (to_rep1 (first (rt source))) 9)))))

;; H
  (assert (not (= index2 temp___1707)))
...
(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 568, characters 0-0
