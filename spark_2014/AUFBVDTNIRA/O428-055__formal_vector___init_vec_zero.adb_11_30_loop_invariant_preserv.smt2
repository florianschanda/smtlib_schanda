...
(declare-fun loop_types__vectors__replace_element__container__fields1 () us_main_type)
...
(define-fun loop_types__vectors__replace_element__container__fields2 () us_split_fields 
  (mk___split_fields
  loop_types__vectors__replace_element__container__fields1))

(define-fun v__split_fields5 () us_split_fields (mk___split_fields
                                                v__split_fields2))

(define-fun loop_types__vectors__replace_element__container__fields3 () us_split_fields 
...
;; H
  ...
  (= (length1
     (mk___rep v__split_discrs
     loop_types__vectors__replace_element__container__fields3)) (length1
                                                                (mk___rep
                                                                v__split_discrs
                                                                (mk___split_fields
                                                                v__split_fields))))
  (= (get
     (model__
     (mk___rep v__split_discrs
     loop_types__vectors__replace_element__container__fields3)) o) 0))
  (= (equal_except
     (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))
     (model__
     (mk___rep v__split_discrs
     loop_types__vectors__replace_element__container__fields3)) o) true)))
...
;; H
  (assert
  (= (mk___split_fields v__split_fields1) loop_types__vectors__replace_element__container__fields3))

;; H
  (assert
  (= (last (model__ (mk___rep v__split_discrs v__split_fields5))) (last
                                                                  (model__
                                                                  (mk___rep
                                                                  v__split_discrs
                                                                  (mk___split_fields
...
;; H
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k j2))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields5)) k) 0))))
...
;; H
  ...
  (= (length1
     (mk___rep v__split_discrs
     loop_types__vectors__replace_element__container__fields2)) (length1
                                                                (mk___rep
                                                                v__split_discrs
                                                                v__split_fields5)))
  (= (get
     (model__
     (mk___rep v__split_discrs
     loop_types__vectors__replace_element__container__fields2)) o1) 0))
  (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields5))
     (model__
     (mk___rep v__split_discrs
     loop_types__vectors__replace_element__container__fields2)) o1) true)))
...
;; H
  (assert
  (= v__split_fields4 loop_types__vectors__replace_element__container__fields2))
...
;; WP_parameter_def
 ;; File "init_vec_zero.adb", line 3, characters 0-0
  (not (= (get (model__ (mk___rep v__split_discrs v__split_fields4)) k) 0)))
(check-sat)
