...
(declare-fun temp___205 (Int) (Array Int integer))

;; def_axiom
  (assert
  (forall ((temp___207 Int))
  (= (select (temp___205 temp___207) 1) (of_rep temp___207))))
