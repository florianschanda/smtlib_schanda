...
(declare-fun thecurrentfloppy2 () us_rep)
...
(declare-fun thecurrentfloppy3 () t__ref)

(declare-fun dataok1 () bool__ref)
...
(declare-fun thecurrentfloppy4 () us_rep)
...
;; H
  (assert
  (=> (not (= dataok true)) (= (valid_numberlogentries state8) true)))
...
;; WP_parameter_def
 ;; File "enclave.ads", line 50, characters 0-0
  ...
  (or
  (and (= status3 3)
  (=> (privatekeypresent__function_guard (privatekeypresent state10) 
  state10) (= (privatekeypresent state10) true)))
  (and (= status3 2)
  (=> (privatekeypresent__function_guard (privatekeypresent state10) 
  state10) (not (= (privatekeypresent state10) true)))))))
(check-sat)
