...
;; H
  (assert
  (forall ((i3 Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i3 0)
  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i3 0)))

;; H
  (assert
  (forall ((i3 Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i3 1)
  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i3 1)))
...
;; H
  (assert
  (forall ((j1 Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j1 0)
  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j1 0)))

;; H
  (assert
  (forall ((j1 Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j1 1)
  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j1 1)))
...
;; H
  ...
  (<= (to_rep
      (rec__red_black_trees__black_count__count
      (us_split_fields11 (select res2 i3)))) (to_rep
                                             (rec__red_black_trees__black_count__depth
                                             (us_split_fields11
                                             (select res2 i3))))))))
...
;; H
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res2 i3)))) 100)
  (<= (to_rep
      (rec__red_black_trees__black_count__depth
      (us_split_fields11 (select res2 i3)))) n2)))))
...
;; H
  ...
  (=> (and (<= 1 i3) (<= i3 100))
  (ite (and
       (= (rec__tree_model__path_type__k (us_split_fields1 (select m i3))) true)
       (< n2 (to_rep
             (rec__red_black_trees__black_count__depth
             (us_split_fields11 (select res2 i3))))))
  (< (length
     (rec__tree_model__path_type__a (us_split_fields1 (select m i3)))) (- 100 
  n2))
  (=>
  (= (rec__tree_model__path_type__k (us_split_fields1 (select m i3))) true)
  (and
  ...
  (=
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select res2 i3))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11
     (select res2 (peek
                  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i3
                  0))))) (to_rep
                         (rec__red_black_trees__black_count__count
                         (us_split_fields11
                         (select res2 (peek
                                      (rec__red_black_trees__rbt__struct
                                      (us_split_fields9 t)) i3 1))))))))
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res2 i3)))) (+ 1 (ite (< (to_rep
                                                         (rec__red_black_trees__black_count__depth
                                                         (us_split_fields11
                                                         (select res2 
                                                         (peek
  ...
  (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t))
               i3 1))))) (to_rep
                         ...
                         (select res2 (peek
                                      (rec__red_black_trees__rbt__struct
                                      (us_split_fields9 t)) i3 0)))))))))
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select res2 i3)))) (+ (ite (= (to_rep3
...
;; H
  ...
  (and
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select m j1))) true)
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11
     (select res2 (peek
                  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j1
                  0))))) n2))
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11
  ...
  (<= (to_rep
      (rec__red_black_trees__black_count__depth
      (us_split_fields11 (select res2 j1)))) n2)))))
...
;; H
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res3 j1)))) 100)
  (<= (to_rep
      (rec__red_black_trees__black_count__depth
      (us_split_fields11 (select res3 j1)))) (+ n2 1))))))
...
;; H
  ...
  (<= (to_rep
      (rec__red_black_trees__black_count__depth
      (us_split_fields11 (select res3 j1)))) n2)))))
...
;; H
  ...
  (< n2 (to_rep
        (rec__red_black_trees__black_count__depth
        (us_split_fields11 (select res3 j1))))))
  (< (length
     (rec__tree_model__path_type__a (us_split_fields1 (select m j1)))) (- 100 
  n2))))))
...
;; H
  ...
  (=
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select res3 j1))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11
     (select res3 (peek
                  ...
                  0))))) (to_rep
                         ...
                         (select res3 (peek
                                      (rec__red_black_trees__rbt__struct
                                      (us_split_fields9 t)) j1 1)))))))
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res3 j1)))) (+ 1 (ite (< (to_rep
                                                         (rec__red_black_trees__black_count__depth
                                                         (us_split_fields11
                                                         (select res3 
                                                         (peek
  ...
  (select res3 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t))
               j1 1))))) (to_rep
                         ...
                         (select res3 (peek
                                      (rec__red_black_trees__rbt__struct
                                      (us_split_fields9 t)) j1 0)))))))))
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select res3 j1)))) (+ (ite (= (to_rep3
                                                       (select (rec__red_black_trees__rbt__color
                                                               (us_split_fields9
                                                               t)) j1)) 0)
                                               1 0) (to_rep
...
;; H
  ...
  (=> (<= i2 temp___1766)
  (= (select res3 temp___1766) (select res2 temp___1766)))))
...
;; H
  (assert
  (ite (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true) 
  (=>
  (not
  (<= (to_rep
      (rec__red_black_trees__black_count__depth
...
;; H
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res3 j)))) (+ n2 1))) true))

;; H
  (assert
  (ite (= (rec__tree_model__path_type__k (us_split_fields1 (select m j))) true) true false))
...
;; H
  ...
  (and
  (and
  (= o17 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0))
...
;; H
  (assert (= o20 (rec__red_black_trees__black_count__count o19)))
