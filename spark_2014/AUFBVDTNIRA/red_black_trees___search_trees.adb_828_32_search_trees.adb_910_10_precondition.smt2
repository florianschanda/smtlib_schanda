...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__ (mk___rep2 binary_trees__plug__f__fields) x1) j3))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__ (mk___rep2 binary_trees__plug__f__fields) x1) (peek
                                                                 (mk___rep2
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__plug__f__fields) x1) j3))) true))))
  (and
  (forall ((j3 Int))
  (=> (and (<= 1 j3) (<= j3 100))
  (=>
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__ (mk___rep2 binary_trees__plug__f__fields1) y1) j3))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__ (mk___rep2 binary_trees__plug__f__fields1) y1) (peek
                                                                  (mk___rep2
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__plug__f__fields1) y1) j3))) true))))
  (and
  (forall ((j3 Int))
  (=> (and (<= 1 j3) (<= j3 100))
  (=>
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 f_2__split_fields3) x1) j3))) true)
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1
  ...
  (= (get
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__ (mk___rep2 f_2__split_fields3) x1) j3)))
     (+ (length
        (rec__tree_model__path_type__a
        (us_split_fields1
...
;; H
  (assert (model____function_guard
  (model__ (mk___rep2 binary_trees__plug__f__fields2) o14)
  (mk___rep2 binary_trees__plug__f__fields2) o14))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o14) (peek
                                                                   (mk___rep2
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o14) j3))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o14) (peek
                                                                   (mk___rep2
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o14) j3))) true))))
  (and
  (forall ((j3 Int))
  (=> (and (<= 1 j3) (<= j3 100))
  (=>
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o14) i1))) true)
  (ite (and (not (= y1 0))
       (= (ole1
          (rec__tree_model__path_type__a
          (us_split_fields1
          (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o14) 
          y1)))
          (rec__tree_model__path_type__a
          (us_split_fields1
          (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o14) i1)))) true))
...
;; H
  (assert
  (and
  (and (= temp___1592 (model__ (mk___rep2 f_old__split_fields2) o16))
  (model____function_guard temp___1592 (mk___rep2 f_old__split_fields2) 
  o16))
  (and (dynamic_invariant6 temp___1592 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1592 o16))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1592 o16)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o16))
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1592 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o17 (select temp___1592 x1)))
...
;; H
  (assert
  (and
  (= o15 (to_rep1 (rec__search_trees__search_tree__root t__split_fields10)))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root t__split_fields10)))))

;; H
  (assert (valid_root__function_guard
  (valid_root (rec__search_trees__search_tree__struct t__split_fields10) o15)
  (rec__search_trees__search_tree__struct t__split_fields10) o15))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (valid_root (rec__search_trees__search_tree__struct t__split_fields10)
     o15) true)))
(check-sat)
