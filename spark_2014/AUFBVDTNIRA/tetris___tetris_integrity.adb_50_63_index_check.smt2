...
(define-fun bool_eq11 ((a map1) (a__first Int) (a__last Int) (a__first_2 Int)
...
(define-fun bool_eq12 ((a (Array Int map1)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq11 (select a temp___idx_136) 0 3 0 3
...
(define-fun bool_eq13 ((a map2) (a__first Int) (a__last Int) (a__first_2 Int)
...
;; bool_eq_rev
  ...
  (= (bool_eq11 (get1 a temp___idx_223 temp___idx_224) 0 2 0 2
...
;; H
  ...
  (=> (and (<= 1 temp___767) (<= temp___767 50))
  (=> (not (= (+ (to_rep3 cur_piece__split_fields3) y2) temp___767))
  (= (select cur_board1 temp___767) (select cur_board temp___767)))))
  (and (<= 0 x2) (<= x2 3))))
...
;; WP_parameter_def
 ;; File "tetris_integrity.adb", line 109, characters 0-0
  (not (<= 1 (+ (to_rep2 cur_piece__split_fields2) x2))))
(check-sat)
