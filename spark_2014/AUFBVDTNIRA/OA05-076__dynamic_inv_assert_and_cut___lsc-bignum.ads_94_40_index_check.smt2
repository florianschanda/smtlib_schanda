...
;; H
  (assert (and (= o6 (+ b_first a_last)) (in_range1 (+ b_first a_last))))
...
;; H
  (assert (= o10 (ite (<= b_first k) o9 false)))

;; H
  (assert (= result1 (ite (not (= o10 true)) true false)))
...
;; H
  (assert (=> (= result1 true) (= o14 (select b o13))))

;; H
  (assert (=> (= result1 true) (= o15 (to_rep1 o14))))
...
;; H
  (assert (=> (= result1 true) (= o12 (select b8 o11))))

;; H
  (assert (=> (= result1 true) (= o16 (to_rep1 o12))))

;; H
  (assert (=> (= result1 true) (= o17 (ite (= o16 o15) true false))))

;; H
  (assert (=> (not (= result1 true)) (= o17 (of_int 1))))
...
;; H
  (assert (and (= o4 (+ a_first k)) (in_range1 (+ a_first k))))

;; H
  (assert (= o5 (- o4 b_first)))

;; H
  (assert (and (= temp___684 o5) (in_range1 o5)))

(assert
;; WP_parameter_def
 ;; File "lsc-bignum.adb", line 40, characters 0-0
  (not (<= (to_rep (first (rt a))) temp___684)))
(check-sat)
