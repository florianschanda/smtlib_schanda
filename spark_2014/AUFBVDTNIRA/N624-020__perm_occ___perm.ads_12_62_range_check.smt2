...
;; H
  (assert (remove_last__function_guard (remove_last o7) o7))

;; H
  (assert (remove_last__function_guard (remove_last o7) o7))

;; H
  (assert (occ_def__function_guard (occ_def (remove_last o7) e)
  (remove_last o7) e))
...
;; H
  (assert
  (and (and (= o7 (remove_last a)) (remove_last__function_guard o7 a))
...
;; H
  (assert
  (and (and (= o5 (occ_def o7 e)) (occ_def__function_guard o5 o7 e))
  (and (in_range3 o5)
  (and
