...
;; H
  (assert
  (and (= o4 (to_rep1 t_old__split_fields)) (in_range3
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3680 o4))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3680 o4)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o4))
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3680 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o5 (select temp___3680 l)))

;; H
  (assert (= o6 (us_split_fields1 o5)))

;; H
  (assert (= result1 (rec__tree_model__path_type__k o6)))
...
;; H
  ...
  (= (parent
     (mk___rep2
     (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) j) 
  l)
  (not
  (= (position
     (mk___rep2
...
;; H
  (assert (= result3 (ite (= o3 0) true false)))
...
;; H
  ...
  (and
  (and
  (= o2 (size (rec__search_trees__search_tree__struct (us_split_fields7 t))))
  (size__function_guard o2
  (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range4
  o2)))

;; H
  (assert (= result5 (ite (= o2 o1) true false)))
