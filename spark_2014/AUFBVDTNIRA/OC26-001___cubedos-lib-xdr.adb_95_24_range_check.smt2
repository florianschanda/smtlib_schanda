...
(define-fun temporary_28 () t__ref1 (mk_t__ref1 temporary_26))

(define-fun data8 () map__ref (mk_map__ref data6))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= temp___478 temporary_11)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= temp___476 data)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= temp___474 temporary_2)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (and (<= 1 i2) (<= i2 8))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= temporary_22 result2)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 8))
  (= temporary_23 (bvurem temporary_12 ((_ int2bv 64) 256)))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 8))
  (= (to_rep1 o) ((_ extract 7 0) temporary_23))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= o1 (+ position (- 8 i2)))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= o2 (store data2 o1 o))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= data2 result3)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= data3 o2)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= temporary_12 result4)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 8))
  (= temporary_13 (bvudiv temporary_12 ((_ int2bv 64) 256)))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= i2 8)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= i2 i3)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= temporary_23 temporary_24)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= temporary_13 temporary_14)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= data3 data4)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= i4 i2)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= temporary_25 temporary_23)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= temporary_15 temporary_13)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= data5 data3)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= i5 (mk_int__ref i3))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 8)) (= temporary_28 (mk_t__ref1 temporary_24))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= data8 (mk_map__ref data4))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= i6 i4)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= temporary_27 temporary_25)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= temporary_17 temporary_15)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= data7 data5)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 8))) (= i5 (mk_int__ref i1))))

;; H
  (assert
  (=> (not (and (<= 1 i1) (<= i1 8)))
  (= temporary_28 (mk_t__ref1 temporary_2))))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 8))) (= temporary_11 temporary_16)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 8))) (= data8 (mk_map__ref data))))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 8))) (= i6 i1)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 8))) (= temporary_27 temporary_21)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 8))) (= temporary_17 temporary_11)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 8))) (= data7 data1)))

(assert
;; WP_parameter_def
 ;; File "cubedos-lib-xdr.ads", line 105, characters 0-0
  (not (in_range2 (+ position 7))))
(check-sat)
