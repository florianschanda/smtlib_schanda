...
(declare-datatypes ()
((us_split_discrs (mk___split_discrs (rec__p__pt__x integer)))))
...
(declare-fun p__pt__x__first__bit () Int)

(declare-fun p__pt__x__last__bit () Int)

(declare-fun p__pt__x__position () Int)
...
(declare-datatypes ()
((us_split_discrs2 (mk___split_discrs1 (rec__p__tt__x integer)))))
...
(declare-datatypes ()
((us_rep2 (mk___rep2 (us_split_discrs4 us_split_discrs)))))
...
(declare-fun p__pt__x__first__bit1 () Int)

(declare-fun p__pt__x__last__bit1 () Int)

(declare-fun p__pt__x__position1 () Int)
...
(define-fun dynamic_invariant1 ((temp___expr_185 us_rep2)
...
(declare-fun po_x () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun to_x () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS3 () Int)

(define-fun dynamic_invariant2 ((temp___expr_192 us_rep3)
  (temp___is_init_189 Bool) (temp___skip_constant_190 Bool)
  (temp___do_toplevel_191 Bool)) Bool (=>
                                      (not (= temp___skip_constant_190 true))
                                      (in_range2 0
                                      (to_base1 temp___expr_192))))

(declare-fun po () integer)

(declare-fun to__ () integer)
...
(declare-fun p__po_x__assume () Int)
...
;; H
  (assert
  (= (mk___rep2 (mk___split_discrs o)) (mk___rep2 (mk___split_discrs po1))))
...
;; H
  (assert (= p__po_x__assume (to_rep o2)))

;; H
  (assert (= p__po_x__assume po_x))

;; H
  (assert (in_range po_x))

;; H
  (assert (= (to_rep to__) to_x))

;; H
  (assert (in_range to_x))
