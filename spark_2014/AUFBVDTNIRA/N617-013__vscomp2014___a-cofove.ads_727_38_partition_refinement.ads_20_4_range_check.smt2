...
(declare-fun dummy5 () index_count)
...
(define-fun contains ((container us_rep1) (fst Int) (lst Int)
  (item us_rep2)) Bool (ite (exists ((i Int))
                            (and (and (<= fst i) (<= i lst))
                            (= (bool_eq6 (get container i) item) true)))
                       true false))
...
(define-fun dynamic_invariant6 ((temp___expr_329 Int)
...
;; H
  ...
  (and (in_range6 o) (= o (last (model__ container))))))
