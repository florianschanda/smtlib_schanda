...
(declare-fun bitwalker__peekbit8array__result () Bool)
...
(declare-fun bitwalker__peekbit8array__result1 () Bool)

(declare-fun bitwalker__peekbit8array__result2 () Bool)

(declare-fun bitwalker__peekbit8array__result3 () Bool)

(declare-fun bitwalker__peekbit8array__result4 () Bool)

(declare-fun bitwalker__peekbit8array__result5 () Bool)
...
;; H
  (assert
  (= bitwalker__peekbit8array__result1 bitwalker__peekbit8array__result2))

;; H
  (assert
  (= bitwalker__peekbit8array__result3 bitwalker__peekbit8array__result1))
...
;; H
  (assert
  (and
  (and (= o3 (peekbit8 o2 (mod1 left 8))) (peekbit8__function_guard o3 
  o2 (mod1 left 8))) (= (= o3 true) (= (nth o2 (- 7 (mod1 left 8))) true))))

;; H
  (assert
  (= (mk_bool__ref result) (mk_bool__ref bitwalker__peekbit8array__result)))
...
;; H
  (assert
  (= (mk_bool__ref bitwalker__peekbit8array__result4) (mk_bool__ref
                                                      bitwalker__peekbit8array__result2)))

;; H
  (assert
  (= bitwalker__peekbit8array__result5 bitwalker__peekbit8array__result3))

;; H
  (assert (= result1 bitwalker__peekbit8array__result4))

;; H
  (assert (= bitwalker__peekbit8array__result4 true))

;; H
  (assert (nth8_stream__function_guard (nth8_stream addr left) addr left))

(assert
;; WP_parameter_def
 ;; File "bitwalker.ads", line 14, characters 0-0
  (not (= (nth8_stream addr left) true)))
(check-sat)
