...
;; H
  ...
  (and (= o3 (pow6 x))
  (and (tqtisFinite o3)
  (= o3 (mul RNE1 (mul RNE1 (mul RNE1 (mul RNE1 (mul RNE1 x x) x) x) x) x)))))
...
;; H
  (assert
  (and (= o1 (pow4 x))
  (and (tqtisFinite o1) (= o1 (mul RNE1 (mul RNE1 (mul RNE1 x x) x) x)))))

;; H
  (assert (= o2 (div1 RNE1 o1 fliteral4)))

;; H
  (assert (and (= o (pow21 x)) (and (tqtisFinite o) (= o (mul RNE1 x x)))))
