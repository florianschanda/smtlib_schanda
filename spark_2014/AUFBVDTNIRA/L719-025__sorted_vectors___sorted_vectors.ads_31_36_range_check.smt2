...
;; H
  (assert (= o17 (ite (<= position8 o16) true false)))

;; H
  (assert (and (= o15 1) (and (in_range4 o15) (= o15 1))))

;; H
  (assert (= o18 (ite (<= o15 position8) true false)))

;; H
  (assert (= result6 (ite (= o18 true) o17 false)))
...
;; H
  (assert (= result8 (ite (= o13 new_item) true false)))
...
;; H
  (assert
  (forall ((i1 Int) (j Int)) (my_lt__function_guard
  (my_lt
  (get
  (model__
  (mk___rep container__split_discrs
...
;; H
  (assert (=> (not (= result9 true)) (= o12 (of_int 1))))
...
;; H
  (assert (and (= o10 o9) (in_range6 o9)))
...
;; H
  ...
  (= o11 (get
         (model__
         (mk___rep container__split_discrs
         (mk___split_fields container__split_fields))) o10))
  (in_range7 o11)))
