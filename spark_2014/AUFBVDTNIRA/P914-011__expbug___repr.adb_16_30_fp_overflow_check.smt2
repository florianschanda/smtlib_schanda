...
(declare-fun attr__ATTRIBUTE_IMAGE1 (t1) us_image)

(declare-fun attr__ATTRIBUTE_VALUE__pre_check1 (us_image) Bool)

(declare-fun attr__ATTRIBUTE_VALUE1 (us_image) t1)
...
(define-fun dynamic_invariant2 ((temp___expr_57 t1) (temp___is_init_54 Bool)
...
(declare-fun buf () (Array Int float))
...
;; H
  (assert (and (= temp___1371 (f Tuple0)) (in_range3 temp___1371)))

;; H
  (assert (and (<= 0 temp___1371) (<= temp___1371 3)))

;; H
  (assert (= o3 temp___1371))

;; H
  (assert (= o4 (select buf o3)))

;; H
  (assert (= o5 (to_rep o4)))

;; H
  (assert (= o6 (to_float64 RNE1 o5)))

;; H
  (assert (and (= temp___137 (f Tuple0)) (in_range3 temp___137)))

;; H
  (assert (and (<= 0 temp___137) (<= temp___137 3)))

;; H
  (assert (= o temp___137))

;; H
  (assert (= o1 (select buf o)))

;; H
  (assert (= o2 (to_rep o1)))

;; H
  (assert (= o7 (to_float64 RNE1 o2)))

;; H
  (assert (= o8 (mul1 RNE1 o7 o6)))
