...
;; H
  (assert
  (and
  (and (= temp___1371 (f Tuple0)) (f__function_guard temp___1371 Tuple0))
  (in_range3 temp___1371)))
...
;; H
  (assert (= o7 (to_float64 RNE2 o2)))

;; H
  (assert (= o8 (mul1 RNE2 o7 o6)))
