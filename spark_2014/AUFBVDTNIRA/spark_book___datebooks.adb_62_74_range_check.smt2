...
(declare-fun temp___378 () (Array Int us_rep3))
...
;; H
  ...
  (<= i8 (to_rep1 (last (rt description))))) (= temp___381 i8)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt description))) i8)
  (<= i8 (to_rep1 (last (rt description))))) (= temp___378 book1)))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt description))) i8)
  (<= i8 (to_rep1 (last (rt description)))))
  (= (to_rep o20) (to_rep (select (elts description) i9)))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 (first (rt description))) i8)
  (<= i8 (to_rep1 (last (rt description))))) (= o19 (+ 1 o18))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt description))) i8)
  (<= i8 (to_rep1 (last (rt description)))))
  (and (= temp___376 o19) (in_range1 o19))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt description))) i8)
  (<= i8 (to_rep1 (last (rt description)))))
  (and (<= 1 temp___376) (<= temp___376 128))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt description))) i8)
  (<= i8 (to_rep1 (last (rt description))))) (= o21 temp___376)))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt description))) i8)
  (<= i8 (to_rep1 (last (rt description)))))
  (= o22 (store (rec__datebooks__event_record__description_text
                (us_split_fields7
                (select book2 (to_rep9
                              (rec__datebooks__add_event__find_result_record__fresh_index
                              (us_split_fields__content4
                              find_result__split_fields9)))))) o21 o20))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 (first (rt description))) i8)
  (<= i8 (to_rep1 (last (rt description))))) (= o24 (mk___rep3 o23))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 (first (rt description))) i8)
  (<= i8 (to_rep1 (last (rt description))))) (= book3 o25)))
