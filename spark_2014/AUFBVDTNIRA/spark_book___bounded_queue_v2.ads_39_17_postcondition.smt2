...
(declare-fun temp___321 () positive)

(declare-fun temp___3211 () natural)

(declare-fun temp___3212 () positive)

(declare-fun temp___3213 () positive)

(declare-fun temp___3214 () (Array Int element_type))

(declare-fun temp___3215 () t)
...
;; H
  (assert (= queue__split_discrs (mk___split_discrs temp___321)))

;; H
  (assert (= temp___3211 o13))

;; H
  (assert (= temp___3212 o14))

;; H
  (assert (= temp___3213 o15))

;; H
  (assert (= temp___3214 o16))

;; H
  (assert (= temp___3215 o17))
...
;; H
  (assert
  (= queue__split_fields10 (mk___split_fields temp___3211 temp___3212
                           temp___3213 (mk___t temp___3214 temp___3215))))
