...
;; H
  (assert (=> (= result12 true) (= temp___1244 temp___1240)))
...
;; H
  ...
  (= (select o16 temp___1245) (select result__1 temp___1245))))))

;; H
  (assert (=> (= result12 true) (= result13 (mk_map__ref result__1))))

;; H
  (assert (=> (= result12 true) (= result__2 o16)))

;; H
  (assert (=> (= result12 true) (= result__4 (mk_map__ref result__2))))

;; H
  (assert (=> (= result12 true) (= result__5 result__2)))
...
;; H
  (assert (=> (not (= result12 true)) (= temp___1239 thestring)))

;; H
  (assert (=> (not (= result12 true)) (= o17 (elts temp___1239))))

;; H
  (assert (=> (not (= result12 true)) (= result14 (mk_map__ref result__1))))

;; H
  (assert (=> (not (= result12 true)) (= result__3 o17)))

;; H
  (assert (=> (not (= result12 true)) (= result__4 (mk_map__ref result__3))))

;; H
  (assert (=> (not (= result12 true)) (= result__5 result__3)))

;; H
  (assert (= result15 (mk_map__ref c34b)))

;; H
  (assert (= c34b1 (map__content result__4)))
