...
;; H
  (assert
  (forall ((i4 (_ BitVec 64))) (hasmem64__function_guard
  (hasmem64 mem (bvadd rdi_start (bvmul i4 ((_ int2bv 64) 8))) rax) mem
  (bvadd rdi_start (bvmul i4 ((_ int2bv 64) 8))) rax)))
...
;; H
  (assert
  (forall ((i4 (_ BitVec 64))) (nooverlap8__function_guard
  (nooverlap8 (bvadd rdi_start (bvmul i4 ((_ int2bv 64) 8))) rdi)
  (bvadd rdi_start (bvmul i4 ((_ int2bv 64) 8))) rdi)))

;; H
  (assert
  (and
  (forall ((i4 (_ BitVec 64)))
  (=> (and (bvule ((_ int2bv 64) 0) i4) (bvule i4 (bvsub rcx_start rcx)))
  (=> (not (= i4 (bvsub rcx_start rcx)))
  (= (hasmem64 mem (bvadd rdi_start (bvmul i4 ((_ int2bv 64) 8))) rax) true))))
  (and
  ...
  (=> (and (bvule ((_ int2bv 64) 0) i4) (bvule i4 (bvsub rcx_start rcx)))
  (=> (not (= i4 (bvsub rcx_start rcx)))
  (= (nooverlap8 (bvadd rdi_start (bvmul i4 ((_ int2bv 64) 8))) rdi) true))))))))))
...
;; H
  (assert (hasmem64__function_guard
  (hasmem64 memory (bvadd rdi_start (bvmul i3 ((_ int2bv 64) 8))) rax) 
  memory (bvadd rdi_start (bvmul i3 ((_ int2bv 64) 8))) rax))
...
;; H
  (assert
  (=> (not (= i3 (bvsub rcx_start rcx)))
  (forall ((j (_ BitVec 64)))
  (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j ((_ int2bv 64) 7)))
  (= (to_rep
     (select memory (bvadd (bvadd rdi_start (bvmul i3 ((_ int2bv 64) 8))) j))) 
  (to_rep
  (select mem (bvadd (bvadd rdi_start (bvmul i3 ((_ int2bv 64) 8))) j))))))))

;; H
  (assert
  (=> (not (= i3 (bvsub rcx_start rcx)))
  (= (hasmem64 memory (bvadd rdi_start (bvmul i3 ((_ int2bv 64) 8))) rax) true)))
