...
(define-fun indefinite_bounded__vect__append__2__container__fields2 () us_split_fields 
...
;; H
  (assert
  (= v__split_fields5 indefinite_bounded__vect__clear__container__fields1))
...
;; H
  (assert
  (= v__split_fields4 indefinite_bounded__vect__append__2__container__fields3))
...
;; H
  (assert
  (= v__split_fields3 indefinite_bounded__vect__append__2__container__fields2))
