...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__diag_tmc_type__tx_pstm bits_1)(rec__dw1000__register_types__diag_tmc_type__reserved_1 bits_4)(rec__dw1000__register_types__diag_tmc_type__reserved_2 bits_11)))))
(define-fun us_split_fields_TX_PSTM__projection ((a us_split_fields)) bits_1 
  (rec__dw1000__register_types__diag_tmc_type__tx_pstm a))

(define-fun us_split_fields_Reserved_115__projection ((a us_split_fields)) bits_4 
  (rec__dw1000__register_types__diag_tmc_type__reserved_1 a))

(define-fun us_split_fields_Reserved_215__projection ((a us_split_fields)) bits_11 
  (rec__dw1000__register_types__diag_tmc_type__reserved_2 a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_100__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_100__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                a))
...
(define-fun bool_eq8 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (and
                        (= (to_rep2
                           (rec__dw1000__register_types__diag_tmc_type__tx_pstm
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__diag_tmc_type__tx_pstm
                                                  (us_split_fields1 b))))
                        (= (to_rep3
                           (rec__dw1000__register_types__diag_tmc_type__reserved_1
                           (us_split_fields1 a))) (to_rep3
                                                  (rec__dw1000__register_types__diag_tmc_type__reserved_1
                                                  (us_split_fields1 b)))))
                        (= (to_rep4
                           (rec__dw1000__register_types__diag_tmc_type__reserved_2
...
(declare-fun dw1000__register_types__diag_tmc_type__tx_pstm__first__bit () Int)

(declare-fun dw1000__register_types__diag_tmc_type__tx_pstm__last__bit () Int)

(declare-fun dw1000__register_types__diag_tmc_type__tx_pstm__position () Int)

;; dw1000__register_types__diag_tmc_type__tx_pstm__first__bit_axiom
  (assert (<= 0 dw1000__register_types__diag_tmc_type__tx_pstm__first__bit))

;; dw1000__register_types__diag_tmc_type__tx_pstm__last__bit_axiom
  (assert
  (< dw1000__register_types__diag_tmc_type__tx_pstm__first__bit dw1000__register_types__diag_tmc_type__tx_pstm__last__bit))

;; dw1000__register_types__diag_tmc_type__tx_pstm__position_axiom
  (assert (<= 0 dw1000__register_types__diag_tmc_type__tx_pstm__position))

(declare-fun dw1000__register_types__diag_tmc_type__reserved_1__first__bit () Int)

(declare-fun dw1000__register_types__diag_tmc_type__reserved_1__last__bit () Int)

(declare-fun dw1000__register_types__diag_tmc_type__reserved_1__position () Int)

;; dw1000__register_types__diag_tmc_type__reserved_1__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__diag_tmc_type__reserved_1__first__bit))

;; dw1000__register_types__diag_tmc_type__reserved_1__last__bit_axiom
  (assert
  (< dw1000__register_types__diag_tmc_type__reserved_1__first__bit dw1000__register_types__diag_tmc_type__reserved_1__last__bit))

;; dw1000__register_types__diag_tmc_type__reserved_1__position_axiom
  (assert (<= 0 dw1000__register_types__diag_tmc_type__reserved_1__position))

(declare-fun dw1000__register_types__diag_tmc_type__reserved_2__first__bit () Int)

(declare-fun dw1000__register_types__diag_tmc_type__reserved_2__last__bit () Int)

(declare-fun dw1000__register_types__diag_tmc_type__reserved_2__position () Int)

;; dw1000__register_types__diag_tmc_type__reserved_2__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__diag_tmc_type__reserved_2__first__bit))

;; dw1000__register_types__diag_tmc_type__reserved_2__last__bit_axiom
  (assert
  (< dw1000__register_types__diag_tmc_type__reserved_2__first__bit dw1000__register_types__diag_tmc_type__reserved_2__last__bit))

;; dw1000__register_types__diag_tmc_type__reserved_2__position_axiom
  (assert (<= 0 dw1000__register_types__diag_tmc_type__reserved_2__position))

(declare-fun dummy7 () us_rep)

(declare-datatypes ()
((diag_tmc_type__ref (mk_diag_tmc_type__ref (diag_tmc_type__content us_rep)))))
(define-fun diag_tmc_type__ref___projection ((a diag_tmc_type__ref)) us_rep 
  (diag_tmc_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_227__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_163__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_163__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_7117 us_t1)
  (temp___is_init_7114 Bool) (temp___skip_constant_7115 Bool)
  (temp___do_toplevel_7116 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7115 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_7117)
                                       (last3 temp___expr_7117))
                                       (and (= (first3 temp___expr_7117) 1)
                                       (= (last3 temp___expr_7117) 2)))))
...
(define-fun target__ref_65__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_65__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_7135 us_t2)
  (temp___is_init_7132 Bool) (temp___skip_constant_7133 Bool)
  (temp___do_toplevel_7134 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7133 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_7135)
                                       (last5 temp___expr_7135))
                                       (and (= (first5 temp___expr_7135) 1)
                                       (= (last5 temp___expr_7135) 2)))))
...
(declare-fun temp___8063 () (Array Int bits_8))

(declare-fun temp___80631 () t2)

(declare-fun temp___8064 () (Array Int bits_8))

(declare-fun temp___80641 () t1)

(define-fun temp___80632 () us_t2 (mk___t2 temp___8063 temp___80631))
...
;; H
  (assert
  (and (= temp___80632 (register_to_bytes reg)) (dynamic_invariant1
  temp___80632 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80631)) (to_rep (last4 temp___80631)))
     (+ (- (to_rep (last4 temp___80631)) (to_rep (first4 temp___80631))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___8063 temp___8064))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80631)) (to_rep (last4 temp___80631))) 
  temp___80641))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___80641)) (to_rep (last2 temp___80641)))
     (+ (- (to_rep (last2 temp___80641)) (to_rep (first2 temp___80641))) 1)
