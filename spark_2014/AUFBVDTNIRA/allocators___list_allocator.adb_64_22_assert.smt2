...
(declare-fun model____split_fields4 () us_rep)

(declare-fun model____split_fields5 () us_rep1)

(declare-fun model____split_fields6 () us_rep)

(declare-fun model____split_fields7 () us_rep1)

(declare-fun r2 () Int)

(declare-fun model____split_fields8 () us_split_fields__ref)

(declare-fun r3 () int__ref)

(declare-fun model____split_fields9 () us_split_fields)

(declare-fun r4 () Int)

(declare-fun model____split_fields10 () us_split_fields__ref)

(declare-fun r5 () int__ref)

(declare-fun model____split_fields11 () us_split_fields)

(declare-fun r6 () Int)

(define-fun model____split_fields12 () us_split_fields (mk___split_fields
                                                       model____split_fields6
                                                       model____split_fields7))

(define-fun model____split_fields13 () us_split_fields__ref (mk___split_fields__ref
                                                            (mk___split_fields
...
;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000))
  (= (mk___split_fields__ref (mk___split_fields result1 result2)) model____split_fields13)))
...
;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000)) (= (length1 model____split_fields7) 0)))

;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000)) (= (length model____split_fields6) r2)))

;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000)) (= (get model____split_fields6 1) 1)))

;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000))
  (forall ((rr Int))
  (=> (and (<= 1 rr) (<= rr r2)) (= (get model____split_fields6 rr) rr)))))
...
;; H
  ...
  (forall ((rr Int))
  (=> (and (<= 1 rr) (<= rr r2))
  (= (contains1 model____split_fields6 rr) true)))))
...
;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000))
  (= model____split_fields8 (mk___split_fields__ref model____split_fields12))))
...
;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000))
  (= model____split_fields9 model____split_fields12)))
...
;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000))
  (= model____split_fields10 model____split_fields8)))
...
;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000))
  (= model____split_fields11 model____split_fields9)))
...
;; H
  (assert
  (=> (not (and (<= 1 r1) (<= r1 10000)))
  (= model____split_fields10 model____split_fields13)))
...
;; H
  (assert
  (=> (not (and (<= 1 r1) (<= r1 10000)))
  (= model____split_fields11 (mk___split_fields model____split_fields2
...
;; WP_parameter_def
 ;; File "list_allocator.adb", line 21, characters 0-0
  ...
  (= (length
     (rec__list_allocator__m__t__available
     (us_split_fields__content model____split_fields10))) 10000)))
(check-sat)
