...
;; H
  (assert
  (and (= o61 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o61 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o60 (from_word64 i2)) (from_word64__function_guard o60 i2)))

;; H
  (assert (and (= o62 (oadd o60 o61)) (oadd__function_guard o62 o60 o61)))

;; H
  (assert
  (and (= o59 (from_integer j3)) (from_integer__function_guard o59 j3)))

;; H
  (assert (and (= o63 (ole o59 o62)) (ole__function_guard o63 o59 o62)))
...
;; H
  (assert
  (and (= o53 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o53 ((_ int2bv 32) 2))))

;; H
  (assert (and (= o54 (oexpon o53 j3)) (oexpon__function_guard o54 o53 j3)))

;; H
  (assert
  (and (= o48 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o48 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o47 (from_integer j3)) (from_integer__function_guard o47 j3)))

;; H
  (assert
  (and (= o49 (osubtract o47 o48)) (osubtract__function_guard o49 o47 o48)))

;; H
  (assert
  (and (= o46 (from_word64 i2)) (from_word64__function_guard o46 i2)))

;; H
  (assert
  (and (= o50 (osubtract o46 o49)) (osubtract__function_guard o50 o46 o49)))

;; H
  (assert
  (and (= o45 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o45 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o51 (oexpon__2 o45 o50)) (oexpon__2__function_guard o51 o45 o50)))
...
;; H
  (assert
  (and (= o44 (num_of_big_int e e_first o43)) (num_of_big_int__function_guard
  o44 e e_first o43)))

;; H
  (assert
  (and (= o52 (odivide o44 o51)) (odivide__function_guard o52 o44 o51)))

;; H
  (assert (and (= o55 (omod o52 o54)) (omod__function_guard o55 o52 o54)))
...
;; H
  (assert
  (and (= o33 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o33 ((_ int2bv 32) 2))))
...
;; H
  (assert
  (and (= o32 (from_word32 w2)) (from_word32__function_guard o32 w2)))

;; H
  (assert
  (and (= o39 (omultiply o32 o38)) (omultiply__function_guard o39 o32 o38)))

;; H
  (assert (and (= o56 (oeq o39 o55)) (oeq__function_guard o56 o39 o55)))
