...
;; H
  (assert (parent__function_guard
  (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) y1)
  (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) y1))
...
;; H
  (assert (=> (and (<= 1 n10) (<= n10 100)) (= temp___1504 n10)))
