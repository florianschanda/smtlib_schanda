...
(declare-fun temp___209 () (_ BitVec 64))
...
(declare-fun n13 () t__ref)

(declare-fun n29 () t__ref)
...
;; H
  ...
  (exists ((n30 (_ BitVec 64)))
  (and
  (and (bvule ((_ int2bv 64) 0) n30)
  (bvule n30 (bvadd var1_range_size var2_range_size)))
  (= var1 (bvadd (bvsub var2 var1_range_size) n30)))))))
...
;; H
  (assert
  (=> (and (bvule ((_ int2bv 64) 0) n11) (bvule n11 var1_range_size))
  (= temp___209 n11)))
...
;; H
  (assert
  (=> (and (bvule ((_ int2bv 64) 0) n11) (bvule n11 var1_range_size))
  (=> (and (bvule ((_ int2bv 64) 0) n23) (bvule n23 var2_range_size))
  (= temp___206 n4))))
...
;; H
  ...
  (=> (and (bvule ((_ int2bv 64) 0) n11) (bvule n11 var1_range_size))
  (=> (and (bvule ((_ int2bv 64) 0) n23) (bvule n23 var2_range_size))
  (= o (bvadd n23 (bvsub var1_range_size n12))))))

;; H
  (assert
  (=> (and (bvule ((_ int2bv 64) 0) n11) (bvule n11 var1_range_size))
  (=> (and (bvule ((_ int2bv 64) 0) n23) (bvule n23 var2_range_size))
  (= result2 (mk_t__ref n4)))))
...
;; H
  ...
  (=> (and (bvule ((_ int2bv 64) 0) n11) (bvule n11 var1_range_size))
  (=> (and (bvule ((_ int2bv 64) 0) n23) (bvule n23 var2_range_size))
  (and (bvule ((_ int2bv 64) 0) n5)
  (bvule n5 (bvadd var1_range_size var2_range_size))))))

;; H
  (assert
  (=> (and (bvule ((_ int2bv 64) 0) n11) (bvule n11 var1_range_size))
  (=> (and (bvule ((_ int2bv 64) 0) n23) (bvule n23 var2_range_size))
  (not (= var1 (bvadd (bvsub var2 var1_range_size) n5))))))

;; H
  (assert
  (=> (and (bvule ((_ int2bv 64) 0) n11) (bvule n11 var1_range_size))
  (=> (and (bvule ((_ int2bv 64) 0) n23) (bvule n23 var2_range_size))
  (not (= (bvadd var1 n12) (bvadd var2 n23))))))
...
;; H
  ...
  (=> (and (bvule ((_ int2bv 64) 0) n23) (bvule n23 var2_range_size))
  (forall ((j (_ BitVec 64)))
  (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j n24))
...
;; H
  ...
  ((_ int2bv 64) 0) var2_range_size n24))
...
;; H
  (assert
  (=> (and (bvule ((_ int2bv 64) 0) n11) (bvule n11 var1_range_size))
  (=> (not (and (bvule ((_ int2bv 64) 0) n23) (bvule n23 var2_range_size)))
  (= n9 (mk_t__ref n4)))))
...
;; H
  (assert
  (=> (not (and (bvule ((_ int2bv 64) 0) n11) (bvule n11 var1_range_size)))
  (= n18 (mk_t__ref n))))
...
;; H
  (assert (bvule i var1_range_size))
