...
(declare-datatypes ()
((tT71bP1__ref (mk_tT71bP1__ref (tT71bP1__content tdigit_count_typeB)))))
(define-fun tT71bP1__ref___projection ((a tT71bP1__ref)) tdigit_count_typeB 
  (tT71bP1__content a))
...
(define-fun dynamic_invariant4 ((temp___expr_547 us_rep1)
  ...
  (temp___do_toplevel_546 Bool)) Bool (and
                                      ...
                                      (first3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_547)))
                                      (last5
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_547))))
                                      (and
                                      (= (first3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_547))) 1)
                                      (= (last5
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_547))) 
                                      (to_rep
...
(define-fun default_initial_assumption ((temp___expr_550 us_rep1)
  (temp___skip_top_level_551 Bool)) Bool (= (to_rep
                                            (rec__very_longs__very_long__length
                                            (us_split_discrs2
                                            temp___expr_550))) (to_rep
                                                               (rec__very_longs__very_long__length
                                                               (us_split_discrs1
                                                               l)))))
...
(declare-datatypes ()
((t72b__ref (mk_t72b__ref (t72b__content tdigit_count_typeB)))))
(define-fun t72b__ref___projection ((a t72b__ref)) tdigit_count_typeB 
  (t72b__content a))
...
(declare-fun temp___893 ((_ BitVec 8) Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___895 (_ BitVec 8)))
  (forall ((temp___896 Int) (temp___897 Int))
  (let ((temp___894 (temp___893 temp___895 temp___896 temp___897)))
  (and
  (=> (dynamic_property6 1 65536 temp___896 temp___897)
  (and (= (first5 temp___894) temp___896) (= (last8 temp___894) temp___897)))
  (forall ((temp___898 Int))
  (= (select (to_array2 temp___894) temp___898) (of_rep1 temp___895))))))))
...
(declare-fun temp___900 () (Array Int octet))

(declare-fun temp___9001 () t2)

(declare-fun temp___901 () (Array Int octet))

(declare-fun temp___9011 () t1)
...
;; H
  (assert
  (= (mk___t2 temp___900 temp___9001) (temp___893 ((_ int2bv 8) 0) 1
                                      (to_rep
                                      (rec__very_longs__very_long__length
                                      (us_split_discrs1 l))))))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___9001)) (to_rep2 (last7 temp___9001)))
     (+ (- (to_rep2 (last7 temp___9001)) (to_rep2 (first4 temp___9001))) 1)
     0) (ite (<= 1 (to_rep
...
;; H
  (assert (= temp___900 temp___901))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___9001)) (to_rep2 (last7 temp___9001))) 
  temp___9011))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 84, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first2 temp___9011)) (to_rep2 (last4 temp___9011)))
     (+ (- (to_rep2 (last4 temp___9011)) (to_rep2 (first2 temp___9011))) 1)
