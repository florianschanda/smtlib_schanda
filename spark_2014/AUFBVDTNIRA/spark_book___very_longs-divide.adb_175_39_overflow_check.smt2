...
(declare-fun temp___1280 () digit_index_type)

(declare-fun temp___12801 () (Array Int octet))

(declare-fun temp___12802 () t1)
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b))
  (and (= (mk___split_discrs temp___1280) u__split_discrs)
  (and (= temp___12801 u__split_fields) (= temp___12802 u__split_fields1)))))
