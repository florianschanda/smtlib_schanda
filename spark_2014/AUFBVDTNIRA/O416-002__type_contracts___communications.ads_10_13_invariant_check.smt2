...
(declare-fun communications__create__result () positive)

(declare-fun communications__create__result1 () (Array Int us_rep))

(declare-fun communications__create__result2 () t1)
...
(declare-fun o3 () (Array Int us_rep))

(declare-fun o4 () t2)

(declare-fun temp___316 () positive)

(declare-fun temp___3161 () (Array Int us_rep))

(declare-fun temp___3162 () t2)

(declare-fun result () (Array Int us_rep))

(declare-fun result1 () t2)

(declare-fun coms__split_fields2 () (Array Int us_rep))

(declare-fun coms__split_fields3 () t2)

(declare-fun result2 () communication__ref)

(declare-fun communications__create__result3 () us_rep1)

(declare-fun communications__create__result4 () communication__ref)

(declare-fun communications__create__result5 () us_rep1)

(declare-fun coms__split_fields4 () us_split_fields__ref2)

(declare-fun communications__create__result6 () communication__ref)

(declare-fun coms__split_fields5 () us_split_fields4)

(declare-fun communications__create__result7 () us_rep1)

(define-fun coms__split_fields6 () us_split_fields4 (mk___split_fields2
                                                    (mk___t2
                                                    coms__split_fields2
                                                    coms__split_fields3)))
...
;; H
  (assert (= (mk___t2 o1 o2) (mk___t2 temp___313 temp___3131)))
...
;; H
  (assert (= coms__split_discrs (mk___split_discrs temp___316)))
...
;; H
  (assert (= result coms__split_fields))

;; H
  (assert (= result1 coms__split_fields1))

;; H
  (assert (= temp___3161 coms__split_fields2))

;; H
  (assert (= temp___3162 coms__split_fields3))
...
;; H
  (assert
  (= communications__create__result4 (mk_communication__ref
                                     communications__create__result3)))

;; H
  (assert
  (= communications__create__result5 communications__create__result3))

;; H
  (assert
  (= result2 (mk_communication__ref
             (mk___rep1 (mk___split_discrs communications__create__result)
             (mk___split_fields1
             (mk___t1 communications__create__result1
             communications__create__result2))))))

;; H
  (assert
  (= communications__create__result3 (to_base
                                     (mk___rep2 coms__split_discrs
                                     coms__split_fields6))))

;; H
  (assert
  (= communications__create__result6 communications__create__result4))

;; H
  (assert
  (= coms__split_fields4 (mk___split_fields__ref2 coms__split_fields6)))

;; H
  (assert
  (= communications__create__result7 communications__create__result5))

;; H
  (assert (= coms__split_fields5 coms__split_fields6))

(assert
;; WP_parameter_def
 ;; File "communications.ads", line 16, characters 0-0
  (not (type_invariant
  (communication__content communications__create__result6))))
(check-sat)
