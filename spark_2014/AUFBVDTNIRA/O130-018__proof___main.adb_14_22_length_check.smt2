...
;; mk_def
  ...
  (! (=> (in_range1 f)
     (=> (in_range1 l)
     (and (= (to_rep (first7 (mk3 f l))) f)
     (= (to_rep (last10 (mk3 f l))) l)))) :pattern ((mk3 f l)) )))
...
(define-fun last11 ((a us_t3)) Int (to_rep (last10 (rt3 a))))
...
(define-fun bool_eq11 ((x us_t3)
  (y us_t3)) Bool (bool_eq2 (elts3 x) (to_rep (first7 (rt3 x)))
                  (to_rep (last10 (rt3 x))) (elts3 y)
                  (to_rep (first7 (rt3 y))) (to_rep (last10 (rt3 y)))))
...
;; def_axiom
  ...
  (and (= (first5 temp___193) temp___195) (= (last8 temp___193) temp___196)))
...
(define-fun dynamic_invariant3 ((temp___expr_185 us_t1)
  ...
  (temp___do_toplevel_184 Bool)) Bool (=>
                                      ...
                                      (last5 temp___expr_185))
                                      (and (= (first3 temp___expr_185) 0)
                                      (= (last5 temp___expr_185) r7b)))))
...
;; H
  (assert (= (to_rep (last7 (rt2 (temp___192 0 0 r7b)))) r7b))
...
;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___1991)) (to_rep (last7 temp___1991)))
     (+ (- (to_rep (last7 temp___1991)) (to_rep (first4 temp___1991))) 1) 0) 
  (ite (<= 0 r7b) (+ (- r7b 0) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___1991)) (to_rep (last7 temp___1991))) 
  temp___2001))
...
;; WP_parameter_def
 ;; File "main.adb", line 1, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___2001)) (to_rep (last4 temp___2001)))
     (+ (- (to_rep (last4 temp___2001)) (to_rep (first2 temp___2001))) 1) 0) 
  (ite (<= (to_rep (first branch__split_fields1)) (to_rep
                                                  (last1
                                                  branch__split_fields1)))
  (+ (- (to_rep (last1 branch__split_fields1)) (to_rep
