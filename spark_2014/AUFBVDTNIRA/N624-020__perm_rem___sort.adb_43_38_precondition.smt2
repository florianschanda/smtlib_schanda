...
;; H
  (assert (remove__function_guard (remove o26 o19) o26 o19))

;; H
  (assert (remove__function_guard (remove o27 o19) o27 o19))
...
;; H
  ...
  (remove__function_guard o26 (mk___t values2 (mk 1 100)) o16))
...
;; H
  ...
  (remove__function_guard o27 (mk___t interm1 (mk 1 100)) o13))
...
;; H
  (assert
  (and
  (and (= o20 (remove_eq o27 o26 o19)) (remove_eq__function_guard o20 
  o27 o26 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___181 (remove o26 o19)))
     (let ((temp___180 (remove o27 o19)))
