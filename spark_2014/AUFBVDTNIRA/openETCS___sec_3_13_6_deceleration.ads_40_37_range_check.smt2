...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 500.0)))

;; is_valid_speed__def_axiom
  (assert
  (forall ((speed t))
  (! (= (= (is_valid_speed speed) true)
     (and (le fliteral2 speed) (le speed (m_per_s_from_km_per_h fliteral3)))) :pattern (
...
(define-fun dynamic_invariant5 ((temp___expr_169 t) (temp___is_init_166 Bool)
...
;; is_valid_speed_km_per_h__def_axiom
  ...
  (! (= (= (is_valid_speed_km_per_h speed) true)
     (and (le fliteral2 speed) (le speed fliteral3))) :pattern ((is_valid_speed_km_per_h
                                                                speed)) )))
...
(declare-fun sec_3_13_6_deceleration__a_brake_emergency__result () t)
...
(declare-fun sec_3_13_6_deceleration__a_brake_emergency__result1 () t)

(declare-fun sec_3_13_6_deceleration__a_brake_emergency__result2 () t)

(declare-fun sec_3_13_6_deceleration__a_brake_emergency__result3 () t)

(declare-fun sec_3_13_6_deceleration__a_brake_emergency__result4 () t)

(declare-fun sec_3_13_6_deceleration__a_brake_emergency__result5 () t)
...
;; H
  (assert (and (= o16 (to_int1 RNA1 v)) (in_range5 (to_int1 RNA1 v))))
...
;; H
  (assert (and (= o19 (to_int1 RNA1 v)) (in_range5 (to_int1 RNA1 v))))

;; H
  (assert
  (and (= o20 (get_value a_brake_emergency_model o19))
  (and (tqtisFinite o20)
  (or
  (exists ((i Int))
  (and
  ...
  (<= (to_rep2
      ...
      (us_split_fields1
      (select (rec__step_function__step_function_t__step
              (us_split_fields3 a_brake_emergency_model)) i)))) o19)
  (< o19 (to_rep2
         (rec__step_function__delimiter_entry__delimiter
         (us_split_fields1
         (select (rec__step_function__step_function_t__step
