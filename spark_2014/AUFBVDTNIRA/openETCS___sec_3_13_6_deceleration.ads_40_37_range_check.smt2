...
;; is_valid_speed__def_axiom
  ...
  (! (=> (is_valid_speed__function_guard (is_valid_speed speed) speed)
     ...
     (m_per_s_from_km_per_h fliteral3) fliteral3)
...
;; H
  (assert (and (= o16 (to_int1 RNA2 v)) (in_range5 (to_int1 RNA2 v))))
...
;; H
  (assert (and (= o19 (to_int1 RNA2 v)) (in_range5 (to_int1 RNA2 v))))

;; H
  (assert
  (and
  (and (= o20 (get_value a_brake_emergency_model o19))
  (get_value__function_guard o20 a_brake_emergency_model o19))
  (and (tqtisFinite o20)
  (or
  (exists ((i Int))
  (and
