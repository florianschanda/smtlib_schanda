...
(define-fun dynamic_invariant ((temp___expr_6789 us_t1)
  ...
  (temp___do_toplevel_6788 Bool)) Bool (=>
                                       ...
                                       (last3 temp___expr_6789))
                                       (and (= (first3 temp___expr_6789) 1)
                                       (= (last3 temp___expr_6789) 2)))))
...
(define-fun dynamic_invariant1 ((temp___expr_6805 us_t2)
  ...
  (temp___do_toplevel_6804 Bool)) Bool (=>
                                       ...
                                       (last5 temp___expr_6805))
                                       (and (= (first5 temp___expr_6805) 1)
                                       (= (last5 temp___expr_6805) 2)))))
...
;; H
  (assert
  (and (= temp___80252 (register_to_bytes reg)) (dynamic_invariant1
  temp___80252 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80251)) (to_rep (last4 temp___80251)))
     (+ (- (to_rep (last4 temp___80251)) (to_rep (first4 temp___80251))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80251)) (to_rep (last4 temp___80251))) 
  temp___80261))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___80261)) (to_rep (last2 temp___80261)))
     (+ (- (to_rep (last2 temp___80261)) (to_rep (first2 temp___80261))) 1)
