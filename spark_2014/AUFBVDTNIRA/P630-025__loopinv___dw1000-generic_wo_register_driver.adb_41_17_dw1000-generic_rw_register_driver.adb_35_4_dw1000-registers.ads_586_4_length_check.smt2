...
(define-fun us_split_fields__ref_86__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_86__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))
...
(define-fun register_type__ref_209__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_147__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_147__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6789 us_t1)
  (temp___is_init_6786 Bool) (temp___skip_constant_6787 Bool)
  (temp___do_toplevel_6788 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6787 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6789)
                                       (last4 temp___expr_6789))
                                       (and (= (first3 temp___expr_6789) 1)
                                       (= (last4 temp___expr_6789) 2)))))
...
(define-fun target__ref_63__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_63__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_6805 us_t2)
  ...
  (temp___do_toplevel_6804 Bool)) Bool (=>
                                       ...
                                       (first5 temp___expr_6805)
                                       (last6 temp___expr_6805))
                                       (and (= (first5 temp___expr_6805) 1)
                                       (= (last6 temp___expr_6805) 2)))))
...
(declare-fun temp___8025 () (Array Int bits_8))

(declare-fun temp___80251 () t2)

(declare-fun temp___8026 () (Array Int bits_8))

(declare-fun temp___80261 () t1)

(define-fun temp___80252 () us_t2 (mk___t2 temp___8025 temp___80251))
...
;; H
  (assert
  (and
  (and (= temp___80252 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___80252 reg)) (dynamic_invariant1
  temp___80252 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80251)) (to_rep (last5 temp___80251)))
     (+ (- (to_rep (last5 temp___80251)) (to_rep (first4 temp___80251))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___8025 temp___8026))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80251)) (to_rep (last5 temp___80251))) 
  temp___80261))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___80261)) (to_rep (last3 temp___80261)))
     (+ (- (to_rep (last3 temp___80261)) (to_rep (first2 temp___80261))) 1)
