...
(declare-fun temp___1103 () us_rep1)

(declare-fun temp___1102 () (_ BitVec 16))

(declare-fun temp___1101 () us_rep)

(declare-fun temp___1100 () (_ BitVec 16))
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r137b))
  (= temp___1103 (mk___rep1 u__split_discrs u__split_fields2))))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (= temp___1102 current_borrow)))
...
;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (= temp___1100 q_hat)))
...
;; H
  (assert (dynamic_property2 1 last3 r139b))
...
;; H
  ...
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))) temp___1112)
  (<= temp___1112 (to_rep2
                  (last1
                  (rt
                  (rec__very_longs__very_long__long_digits
                  remainder__split_fields3))))))
  (=> (<= divisor_index2 temp___1112)
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             remainder__split_fields3)) temp___1112) (select (elts
                                                             (rec__very_longs__very_long__long_digits
                                                             remainder__split_fields2)) temp___1112))))))
