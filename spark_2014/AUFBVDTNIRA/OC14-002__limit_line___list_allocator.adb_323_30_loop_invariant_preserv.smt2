...
(declare-fun temp___5401 () us_rep2)
...
;; H
  (assert (= temp___540 (mk___rep1 o28)))

;; H
  (assert
  (= result7 (mk___split_fields__ref1
             (mk___split_fields1 model____split_fields
             model____split_fields1))))

;; H
  (assert (= model____split_fields2 (us_split_fields3 temp___540)))

;; H
  (assert
  (forall ((rr Int)) (mem__function_guard
  (mem (rec__list_allocator__m__t__available model____split_fields3) rr)
  (rec__list_allocator__m__t__available model____split_fields3) rr)))
...
;; H
  ...
  (forall ((rr Int))
  (=> (and (<= 1 rr) (<= rr r9))
  (= (mem (rec__list_allocator__m__t__available model____split_fields3) rr) true))))

;; H
  (assert
  (= (length (rec__list_allocator__m__t__allocated model____split_fields3)) 0))

;; H
  (assert (is_add__function_guard
  (is_add (rec__list_allocator__m__t__available model____split_fields3) 
  r10 o29) (rec__list_allocator__m__t__available model____split_fields3) 
  r10 o29))
...
;; H
  ...
  (and
  (and
  (= (rec__list_allocator__m__t__allocated model____split_fields3) model____split_fields1)
...
;; H
  ...
  (and
  (and
  (= o29 (add (rec__list_allocator__m__t__available model____split_fields3)
         r10))
  (add__function_guard o29
  (rec__list_allocator__m__t__available model____split_fields3) r10))
  (= (is_add (rec__list_allocator__m__t__available model____split_fields3)
     r10 o29) true)))
...
;; H
  (assert (= temp___5401 (mk___rep1 o30)))

;; H
  (assert (= result9 (mk___split_fields__ref1 model____split_fields3)))

;; H
  (assert (= model____split_fields4 (us_split_fields3 temp___5401)))
...
;; H
  (assert (<= rr (int__content r11)))

;; H
  (assert (mem__function_guard
  (mem
  (rec__list_allocator__m__t__available
  (us_split_fields__content1 model____split_fields5)) rr)
  (rec__list_allocator__m__t__available
  (us_split_fields__content1 model____split_fields5)) rr))
...
;; WP_parameter_def
 ;; File "list_allocator.adb", line 16, characters 0-0
  ...
  (= (mem
     (rec__list_allocator__m__t__available
     (us_split_fields__content1 model____split_fields5)) rr) true)))
(check-sat)
