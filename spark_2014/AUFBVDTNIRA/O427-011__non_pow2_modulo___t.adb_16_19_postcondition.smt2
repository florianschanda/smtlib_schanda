...
(declare-fun t__madd__result () (_ BitVec 8))

(declare-fun o () (_ BitVec 8))

(declare-fun result () (_ BitVec 8))

(declare-fun t__madd__result1 () (_ BitVec 8))

(declare-fun t__madd__result2 () (_ BitVec 8))

(declare-fun t__madd__result3 () (_ BitVec 8))

(declare-fun t__madd__result4 () (_ BitVec 8))

(declare-fun t__madd__result5 () (_ BitVec 8))
...
;; WP_parameter_def
 ;; File "t.adb", line 6, characters 0-0
  (not
  (= ((_ zero_extend 8) t__madd__result4) (bvurem (bvadd ((_ zero_extend 8) 
  x) ((_ zero_extend 8) y)) ((_ int2bv 16) 230)))))
(check-sat)
