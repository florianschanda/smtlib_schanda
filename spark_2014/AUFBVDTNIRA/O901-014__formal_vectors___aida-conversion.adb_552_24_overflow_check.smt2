...
;; H
  (assert
  (and (= temp___1625 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1625)
  (<= temp___1625 (to_rep1 n__last))))

;; H
  (assert (= o40 temp___1625))
...
;; H
  (assert
  (and (= temp___1626 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1626)
  (<= temp___1626 (to_rep1 n__last))))

;; H
  (assert (= o47 temp___1626))
