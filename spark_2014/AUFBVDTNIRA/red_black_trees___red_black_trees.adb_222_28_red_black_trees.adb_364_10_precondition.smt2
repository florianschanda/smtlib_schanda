...
(declare-fun temp___589 () (Array Int us_rep7))
...
;; H
  (assert
  (and (= temp___589 (nb_blacks c60b))
  (and
  (= (bool_eq17 (select temp___589 0)
     (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true)
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  ...
  (=
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select temp___589 i1))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11
     (select temp___589 (peek
                        (rec__red_black_trees__rbt__struct
                        (us_split_fields9 c60b)) i1 0))))) (to_rep
                                                           (rec__red_black_trees__black_count__count
                                                           (us_split_fields11
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select temp___589 i1)))) (+ 1 (ite (< (to_rep
                                                               (rec__red_black_trees__black_count__depth
                                                               (us_split_fields11
                                                               (select 
                                                               temp___589 
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select temp___589 i1)))) (+ (ite (= (to_rep3
                                                             (select 
                                                             (rec__red_black_trees__rbt__color
                                                             (us_split_fields9
                                                             c60b)) i1)) 0)
