...
(declare-fun o3 () us_rep7)

(declare-fun o4 () us_split_fields10)
...
(declare-fun temp___1059 () (Array Int us_rep7))

(declare-fun o9 () us_rep7)
...
;; H
  (assert (= o7 (select temp___1060 i)))
...
;; H
  (assert (=> (= result6 true) (= o3 (select temp___1061 i))))
...
;; H
  (assert
  (=> (= result6 true) (= o5 (rec__red_black_trees__black_count__depth o4))))
...
;; H
  ...
  (and
  (and
  (= o1 (root (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))))
  (root__function_guard o1
  (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))))
  (and (in_range2 o1)
  (= o1 (to_rep
        (rec__search_trees__search_tree__root
...
;; H
  (assert
  (=> (= result5 true) (= result4 (ite (not (= o2 true)) true false))))
...
;; H
  (assert
  (and
  (and (= temp___1059 (nb_blacks c60b)) (nb_blacks__function_guard
  temp___1059 c60b))
  (and
  (= (bool_eq17 (select temp___1059 0)
     (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true)
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  ...
  (=
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select temp___1059 i1))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11
     (select temp___1059 (peek
                         (rec__red_black_trees__rbt__struct
                         (us_split_fields9 c60b)) i1 0))))) (to_rep
                                                            (rec__red_black_trees__black_count__count
                                                            (us_split_fields11
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select temp___1059 i1)))) (+ 1 (ite (< (to_rep
                                                                (rec__red_black_trees__black_count__depth
                                                                (us_split_fields11
                                                                (select 
                                                                temp___1059 
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select temp___1059 i1)))) (+ (ite (= (to_rep3
                                                              (select 
                                                              (rec__red_black_trees__rbt__color
                                                              (us_split_fields9
                                                              c60b)) i1)) 0)
...
;; H
  (assert (= o9 (select temp___1059 i)))
