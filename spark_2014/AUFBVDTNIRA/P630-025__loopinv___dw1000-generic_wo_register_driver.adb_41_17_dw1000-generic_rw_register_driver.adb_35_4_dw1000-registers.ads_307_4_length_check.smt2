...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__agc_tune3_type__agc_tune3 bits_16)))))
(define-fun us_split_fields_AGC_TUNE3__projection ((a us_split_fields)) bits_16 
  (rec__dw1000__register_types__agc_tune3_type__agc_tune3 a))
...
(define-fun bool_eq6 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__agc_tune3_type__agc_tune3
...
(declare-fun dw1000__register_types__agc_tune3_type__agc_tune3__first__bit () Int)

(declare-fun dw1000__register_types__agc_tune3_type__agc_tune3__last__bit () Int)

(declare-fun dw1000__register_types__agc_tune3_type__agc_tune3__position () Int)

;; dw1000__register_types__agc_tune3_type__agc_tune3__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__agc_tune3_type__agc_tune3__first__bit))

;; dw1000__register_types__agc_tune3_type__agc_tune3__last__bit_axiom
  (assert
  (< dw1000__register_types__agc_tune3_type__agc_tune3__first__bit dw1000__register_types__agc_tune3_type__agc_tune3__last__bit))

;; dw1000__register_types__agc_tune3_type__agc_tune3__position_axiom
  (assert (<= 0 dw1000__register_types__agc_tune3_type__agc_tune3__position))

(declare-fun dummy5 () us_rep)

(declare-datatypes ()
((agc_tune3_type__ref
 (mk_agc_tune3_type__ref (agc_tune3_type__content us_rep)))))
(define-fun agc_tune3_type__ref___projection ((a agc_tune3_type__ref)) us_rep 
  (agc_tune3_type__content a))
...
(define-fun tregister_byte_arrayP1__ref_48__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_48__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3570 us_t1)
  (temp___is_init_3567 Bool) (temp___skip_constant_3568 Bool)
  (temp___do_toplevel_3569 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3568 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_3570)
                                       (last4 temp___expr_3570))
                                       (and (= (first3 temp___expr_3570) 1)
                                       (= (last4 temp___expr_3570) 2)))))
...
(define-fun target__ref_20__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_20__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_3586 us_t2)
  (temp___is_init_3583 Bool) (temp___skip_constant_3584 Bool)
  (temp___do_toplevel_3585 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3584 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_3586)
                                       (last6 temp___expr_3586))
                                       (and (= (first5 temp___expr_3586) 1)
                                       (= (last6 temp___expr_3586) 2)))))
...
(declare-fun temp___7697 () (Array Int bits_8))

(declare-fun temp___76971 () t2)

(declare-fun temp___7698 () (Array Int bits_8))

(declare-fun temp___76981 () t1)

(define-fun temp___76972 () us_t2 (mk___t2 temp___7697 temp___76971))
...
;; H
  (assert
  (and
  (and (= temp___76972 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___76972 reg)) (dynamic_invariant1
  temp___76972 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___76971)) (to_rep (last5 temp___76971)))
     (+ (- (to_rep (last5 temp___76971)) (to_rep (first4 temp___76971))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___7697 temp___7698))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76971)) (to_rep (last5 temp___76971))) 
  temp___76981))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___76981)) (to_rep (last3 temp___76981)))
     (+ (- (to_rep (last3 temp___76981)) (to_rep (first2 temp___76981))) 1)
