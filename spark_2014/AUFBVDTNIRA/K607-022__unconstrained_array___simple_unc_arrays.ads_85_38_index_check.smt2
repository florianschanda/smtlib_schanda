...
;; H
  (assert (and (= temp___958 (+ j 1)) (in_range1 (+ j 1))))
...
;; H
  ...
  (<= (to_rep1
      ...
      (rec__simple_unc_arrays__table__v
      (us_split_fields1
      (table__content simple_unc_arrays__bubble_sort__result6)))))) temp___958)
  (<= temp___958 (to_rep1
                 (last3
                 (rt1
                 (rec__simple_unc_arrays__table__v
...
;; WP_parameter_def
 ;; File "simple_unc_arrays.ads", line 10, characters 0-0
  ...
  (<= (to_rep1
      ...
      (rec__simple_unc_arrays__table__v
      (us_split_fields1
      (table__content simple_unc_arrays__bubble_sort__result6)))))) j)))
(check-sat)
