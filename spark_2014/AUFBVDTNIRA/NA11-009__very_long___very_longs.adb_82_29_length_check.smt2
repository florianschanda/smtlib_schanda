...
;; def_axiom
  (assert
  (forall ((temp___1153 (_ BitVec 8)))
  (forall ((temp___1154 Int) (temp___1155 Int))
  (let ((temp___1152 (temp___1151 temp___1153 temp___1154 temp___1155)))
  (and
  (=> (dynamic_property6 1 65536 temp___1154 temp___1155)
  (and (= (first5 temp___1152) temp___1154)
  (= (last8 temp___1152) temp___1155)))
  (forall ((temp___1156 Int))
  (= (select (to_array2 temp___1152) temp___1156) (of_rep1 temp___1153))))))))
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___1151 ((_ int2bv 8) 0) 1 r19b)))) 1))

;; H
  (assert
  (= (to_rep2 (last7 (rt2 (temp___1151 ((_ int2bv 8) 0) 1 r19b)))) r19b))

;; H
  (assert
  (= (mk___t2 temp___1158 temp___11581) (temp___1151 ((_ int2bv 8) 0) 1 r19b)))

(assert
;; WP_parameter_def
 ;; File "very_longs.adb", line 49, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first4 temp___11581)) (to_rep2 (last7 temp___11581)))
     (+ (- (to_rep2 (last7 temp___11581)) (to_rep2 (first4 temp___11581))) 1)
