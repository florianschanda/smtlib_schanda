...
(declare-fun temp___1793 () (Array Int us_rep1))
...
(declare-fun temp___1792 () (Array Int us_rep1))

(declare-fun o6 () us_rep1)

(declare-fun o7 () us_split_fields)

(declare-fun temp___1791 () (Array Int us_rep1))

(declare-fun o8 () us_rep1)

(declare-fun o9 () us_split_fields)

(declare-fun temp___1790 () (Array Int us_rep1))
...
;; H
  (assert
  (and (= temp___1791 (model__ f1 root))
  (and (dynamic_invariant4 temp___1791 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1791 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1791 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f1 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1791 (parent f1 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1791 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1791 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1791 (parent f1 i1)))) (position f1 i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1791 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1791 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1791 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1791 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1791 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= o8 (select temp___1791 i)))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= temp___1792 (model__ f1 root))
  (and (dynamic_invariant4 temp___1792 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1792 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1792 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f1 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1792 (parent f1 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1792 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1792 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1792 (parent f1 i1)))) (position f1 i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1792 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1792 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1792 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1792 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1792 j1)))) true))
  (= j1 i1)))))))))))))))

;; H
  (assert (=> (= result2 true) (= o6 (select temp___1792 j))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= temp___1794 (model__ f1 root))
  (and (dynamic_invariant4 temp___1794 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (ite (and (not (= (parent f1 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1794 (parent f1 i1)))) true))
  (= (rec__tree_model__path_type__k
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1794 (parent f1 i1)))) (position f1 i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1794 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
...
;; H
  (assert (=> (= result1 true) (= o3 (select temp___1794 j))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= temp___1793 (model__ f1 root))
  (and (dynamic_invariant4 temp___1793 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1793 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1793 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f1 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1793 (parent f1 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1793 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1793 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1793 (parent f1 i1)))) (position f1 i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1793 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1793 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1793 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1793 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1793 j1)))) true))
  (= j1 i1)))))))))))))))

;; H
  (assert (=> (= result1 true) (= o (select temp___1793 i))))
...
;; H
  (assert
  (and (= temp___1790 (model__ f1 root))
  (and (dynamic_invariant4 temp___1790 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1790 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1790 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f1 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1790 (parent f1 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1790 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1790 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1790 (parent f1 i1)))) (position f1 i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1790 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1790 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1790 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1790 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1790 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= o10 (select temp___1790 i)))
