...
(declare-datatypes ()
((us_split_discrs
 (mk___split_discrs (rec__fail__my_lists__vector__capacity capacity_range)))))
...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__fail__my_lists__vector us_main_type)))))
...
(declare-fun fail__my_lists__vector__capacity__first__bit () Int)

(declare-fun fail__my_lists__vector__capacity__last__bit () Int)

(declare-fun fail__my_lists__vector__capacity__position () Int)
...
;; length__post_axiom
  ...
  (! (let ((result (length container1)))
     (and (<= (+ 0 result) 3) (dynamic_invariant3 result true false true))) :pattern (
  (length container1)) )))
