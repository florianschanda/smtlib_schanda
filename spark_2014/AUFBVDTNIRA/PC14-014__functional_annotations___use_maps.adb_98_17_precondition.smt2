...
(declare-fun use_maps__apply_f_4__cu__assume () count_type)
...
;; H
  ...
  (= (bool_eq3 use_maps__apply_f_4__cu__assume1 no_element) true)
  (and
  (= (has_key1
     (positions
...
;; H
  ...
  (get1 (keys (mk___rep s__split_discrs s__split_fields2)) i1)))
  (get
  (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
  (get1 (keys (mk___rep s__split_discrs s__split_fields2)) i1)))))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key1 o j) true)
  (=> (= (get2 o i1) (get2 o j)) (= (bool_eq3 i1 j) true))))))))))
...
;; H
  ...
  (forall ((k us_rep1))
  (=> (= (has_key1 o k) true)
  (= (= (bool_eq3 k (mk___rep1 cu__split_fields3)) true)
