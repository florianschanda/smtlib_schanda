...
(define-fun us_split_fields_Reserved_16__projection ((a us_split_fields)) bits_4 
  (rec__dw1000__register_types__rx_sniff_type__reserved_1 a))

(define-fun us_split_fields_Reserved_26__projection ((a us_split_fields)) bits_16 
...
(declare-fun dw1000__register_types__rx_sniff_type__sniff_ont__first__bit () Int)

(declare-fun dw1000__register_types__rx_sniff_type__sniff_ont__last__bit () Int)

(declare-fun dw1000__register_types__rx_sniff_type__sniff_ont__position () Int)
...
(declare-fun dw1000__register_types__rx_sniff_type__sniff_offt__first__bit () Int)

(declare-fun dw1000__register_types__rx_sniff_type__sniff_offt__last__bit () Int)

(declare-fun dw1000__register_types__rx_sniff_type__sniff_offt__position () Int)
...
(declare-fun dw1000__register_types__rx_sniff_type__reserved_1__first__bit () Int)

(declare-fun dw1000__register_types__rx_sniff_type__reserved_1__last__bit () Int)

(declare-fun dw1000__register_types__rx_sniff_type__reserved_1__position () Int)
...
(declare-fun dw1000__register_types__rx_sniff_type__reserved_2__first__bit () Int)

(declare-fun dw1000__register_types__rx_sniff_type__reserved_2__last__bit () Int)

(declare-fun dw1000__register_types__rx_sniff_type__reserved_2__position () Int)
...
(define-fun register_type__ref_46__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_34__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_34__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3120 us_t1)
  (temp___is_init_3117 Bool) (temp___skip_constant_3118 Bool)
  (temp___do_toplevel_3119 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3118 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_3120)
                                       (last4 temp___expr_3120))
                                       (and (= (first3 temp___expr_3120) 1)
                                       (= (last4 temp___expr_3120) 4)))))
...
(define-fun target__ref_13__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_13__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_3139 us_t2)
  (temp___is_init_3136 Bool) (temp___skip_constant_3137 Bool)
  (temp___do_toplevel_3138 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3137 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_3139)
                                       (last6 temp___expr_3139))
                                       (and (= (first5 temp___expr_3139) 1)
                                       (= (last6 temp___expr_3139) 4)))))
...
(declare-fun temp___7646 () (Array Int bits_8))

(declare-fun temp___76461 () t2)

(declare-fun temp___7647 () (Array Int bits_8))

(declare-fun temp___76471 () t1)
...
(define-fun temp___76462 () us_t2 (mk___t2 temp___7646 temp___76461))
...
;; H
  (assert
  (and
  (and (= temp___76462 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___76462 reg)) (dynamic_invariant1
  temp___76462 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___76461)) (to_rep (last5 temp___76461)))
     (+ (- (to_rep (last5 temp___76461)) (to_rep (first4 temp___76461))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___7646 temp___7647))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76461)) (to_rep (last5 temp___76461))) 
  temp___76471))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___76471)) (to_rep (last3 temp___76471)))
     (+ (- (to_rep (last3 temp___76471)) (to_rep (first2 temp___76471))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7647 temp___76471)))
