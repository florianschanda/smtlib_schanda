...
;; copy__post_axiom
  ...
  (! (=>
     ...
     (=> (= (of_int 1) true)
     (or (= capacity 0) (<= (length source) capacity))))
...
(declare-fun oconcat (us_rep us_rep) us_rep)

(declare-fun oconcat__function_guard (us_rep us_rep us_rep) Bool)
...
(define-fun dynamic_invariant1 ((temp___expr_360 us_rep2)
  (temp___is_init_357 Bool) (temp___skip_constant_358 Bool)
  (temp___do_toplevel_359 Bool)) Bool (and (in_range2 1000
...
;; is_model__def_axiom
  ...
  (! (=> (is_model__function_guard (is_model q m) q m)
     ...
     (=>
     (and (<= 1 i)
     (<= i (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))))
     (= (element m i) (element
                      (rec__amortized_queue__queue__rear
                      (us_split_fields3 q))
                      (+ (- (length
     ...
     (=>
     (and (<= 1 i)
     (<= i (length (rec__amortized_queue__queue__front (us_split_fields3 q)))))
     (= (element m
        (+ i (length
...
(declare-fun revrear__split_discrs () us_split_discrs)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(define-fun dynamic_invariant2 ((temp___expr_351 us_rep)
  (temp___is_init_348 Bool) (temp___skip_constant_349 Bool)
  (temp___do_toplevel_350 Bool)) Bool (=>
                                      (not (= temp___skip_constant_349 true))
                                      (in_range2 1000 temp___expr_351)))
...
(declare-fun revrear__split_fields () us_main_type)

(declare-fun amortized_queue__model__result () capacity_range)

(declare-fun amortized_queue__model__result1 () us_main_type)

(declare-fun amortized_queue__model__revrear__assume () capacity_range)

(declare-fun amortized_queue__model__revrear__assume1 () us_main_type)
...
(declare-fun revrear__split_fields1 () us_main_type)

(declare-fun revrear__split_fields2 () us_main_type)

(declare-fun result1 () capacity_range)

(declare-fun result2 () us_main_type)

(declare-fun amortized_queue__model__result2 () capacity_range)

(declare-fun amortized_queue__model__result3 () us_main_type)

(declare-fun amortized_queue__model__result4 () vector__ref)

(declare-fun amortized_queue__model__result5 () us_rep)

(declare-fun revrear__split_fields3 () us_split_fields__ref)

(declare-fun amortized_queue__model__result6 () vector__ref)

(declare-fun revrear__split_fields4 () us_split_fields)

(declare-fun amortized_queue__model__result7 () us_rep)

(define-fun amortized_queue__model__result8 () us_rep (mk___rep
                                                      (mk___split_discrs
                                                      amortized_queue__model__result2)
                                                      (mk___split_fields
                                                      amortized_queue__model__result3)))

(define-fun revrear__split_fields5 () us_split_fields (mk___split_fields
                                                      revrear__split_fields2))

(define-fun o2 () us_rep (mk___rep (mk___split_discrs o)
                         (mk___split_fields o1)))

(define-fun amortized_queue__model__revrear__assume2 () us_rep (mk___rep
                                                               (mk___split_discrs
                                                               amortized_queue__model__revrear__assume)
                                                               (mk___split_fields
                                                               amortized_queue__model__revrear__assume1)))

(declare-fun result3 () capacity_range)

(declare-fun result4 () us_main_type)
...
;; H
  (assert
  (and
  (= amortized_queue__model__revrear__assume2 (copy
                                              (rec__amortized_queue__queue__rear
                                              (us_split_fields3 q)) 0))
  (and
  (= (oeq (model__ amortized_queue__model__revrear__assume2)
     (model__ (rec__amortized_queue__queue__rear (us_split_fields3 q)))) true)
  (= (to_rep amortized_queue__model__revrear__assume) (length
                                                      (rec__amortized_queue__queue__rear
                                                      (us_split_fields3 q)))))))
...
;; H
  ...
  (= (mk___split_fields__ref (mk___split_fields result)) (mk___split_fields__ref
                                                         (mk___split_fields
                                                         revrear__split_fields))))

;; H
  (assert
  (= amortized_queue__model__revrear__assume1 revrear__split_fields1))

;; H
  (assert
  (= revrear__split_discrs (mk___split_discrs
                           amortized_queue__model__revrear__assume)))
...
;; H
  ...
  (= (m_elements_reversed
     (model__
     (mk___rep revrear__split_discrs
     (mk___split_fields revrear__split_fields1)))
     (model__ (mk___rep revrear__split_discrs revrear__split_fields5))) true))

;; H
  (assert
  (= amortized_queue__model__result4 (mk_vector__ref
                                     amortized_queue__model__result8)))

;; H
  (assert
  (= amortized_queue__model__result5 amortized_queue__model__result8))

;; H
  (assert
  (and
  (and
  (= o2 (oconcat (mk___rep revrear__split_discrs revrear__split_fields5)
        (rec__amortized_queue__queue__front (us_split_fields3 q))))
  (oconcat__function_guard o2
  (mk___rep revrear__split_discrs revrear__split_fields5)
  (rec__amortized_queue__queue__front (us_split_fields3 q))))
  (and
  (= (length o2) (+ (length
                    (mk___rep revrear__split_discrs revrear__split_fields5)) 
  ...
  (and (<= 1 i)
  (<= i (last
        (model__ (mk___rep revrear__split_discrs revrear__split_fields5)))))
  (= (get (model__ o2) i) (get
                          (model__
                          (mk___rep revrear__split_discrs
                          revrear__split_fields5)) i))))
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (last
  ...
  (= (get (model__ o2)
     (+ (last
        (model__ (mk___rep revrear__split_discrs revrear__split_fields5))) i)) 
  (get (model__ (rec__amortized_queue__queue__front (us_split_fields3 q))) i))))))))

;; H
  (assert (= result1 amortized_queue__model__result))

;; H
  (assert (= result2 amortized_queue__model__result1))

;; H
  (assert (= amortized_queue__model__result8 o2))

;; H
  (assert
  (= amortized_queue__model__result6 amortized_queue__model__result4))

;; H
  (assert
  (= revrear__split_fields3 (mk___split_fields__ref revrear__split_fields5)))

;; H
  (assert
  (= amortized_queue__model__result7 amortized_queue__model__result5))

;; H
  (assert (= revrear__split_fields4 revrear__split_fields5))

;; H
  (assert
  (= (mk___rep (mk___split_discrs result3) (mk___split_fields result4)) 
  (vector__content amortized_queue__model__result6)))

;; H
  (assert (is_model__function_guard
  (is_model q (vector__content amortized_queue__model__result6)) q
  (vector__content amortized_queue__model__result6)))
...
;; WP_parameter_def
 ;; File "a-cofove.ads", line 76, characters 0-0
  (not
  (= (is_model q (vector__content amortized_queue__model__result6)) true)))
(check-sat)
