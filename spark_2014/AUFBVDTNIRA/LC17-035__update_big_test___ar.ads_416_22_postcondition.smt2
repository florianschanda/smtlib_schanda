...
(declare-fun temp___1291 ((Array Int (Array Int (Array Int et1))) Int
  (Array Int (Array Int et1)) Int
  (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))

;; def_axiom
  (assert
  (forall ((temp___1293 (Array Int (Array Int (Array Int et1)))))
  (forall ((temp___1294 Int) (temp___1296 Int))
  (forall ((temp___1295 (Array Int (Array Int et1)))
  (temp___1297 (Array Int (Array Int et1))))
  (let ((temp___1292 (temp___1291 temp___1293 temp___1294 temp___1295
                     temp___1296 temp___1297)))
  (forall ((temp___1298 Int))
  (ite (= temp___1298 temp___1296)
  (= (select temp___1292 temp___1298) temp___1297)
  (ite (= temp___1298 temp___1294)
  (= (select temp___1292 temp___1298) temp___1295)
  (= (select temp___1292 temp___1298) (select temp___1293 temp___1298))))))))))

(declare-fun temp___1299 ((Array Int (Array Int et1)) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___1301 (Array Int (Array Int et1))))
  (forall ((temp___1302 Int))
  (forall ((temp___1303 (Array Int et1)))
  (let ((temp___1300 (temp___1299 temp___1301 temp___1302 temp___1303)))
  (forall ((temp___1304 Int))
  (ite (= temp___1304 temp___1302)
  (= (select temp___1300 temp___1304) temp___1303)
  (= (select temp___1300 temp___1304) (select temp___1301 temp___1304)))))))))

(declare-fun temp___1306 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___1308 (Array Int et1)))
  (forall ((temp___1309 Int) (temp___1310 Int))
  (let ((temp___1307 (temp___1306 temp___1308 temp___1309 temp___1310)))
  (forall ((temp___1311 Int))
  (ite (= temp___1311 temp___1309)
  (= (select temp___1307 temp___1311) (of_rep temp___1310))
  (= (select temp___1307 temp___1311) (select temp___1308 temp___1311))))))))

(declare-fun temp___1314 ((Array Int (Array Int et1)) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___1316 (Array Int (Array Int et1))))
  (forall ((temp___1317 Int))
  (forall ((temp___1318 (Array Int et1)))
  (let ((temp___1315 (temp___1314 temp___1316 temp___1317 temp___1318)))
  (forall ((temp___1319 Int))
  (ite (= temp___1319 temp___1317)
  (= (select temp___1315 temp___1319) temp___1318)
  (= (select temp___1315 temp___1319) (select temp___1316 temp___1319)))))))))

(declare-fun temp___1321 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___1323 (Array Int et1)))
  (forall ((temp___1324 Int) (temp___1325 Int))
  (let ((temp___1322 (temp___1321 temp___1323 temp___1324 temp___1325)))
  (forall ((temp___1326 Int))
  (ite (= temp___1326 temp___1324)
  (= (select temp___1322 temp___1326) (of_rep temp___1325))
  (= (select temp___1322 temp___1326) (select temp___1323 temp___1326))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 407, characters 0-0
  (not
  (= (bool_eq6 a3 1 16
     (temp___1291 a k1
     (temp___1299 (select a k1) j1
     (temp___1306 (select (select a k1) j1) i1 e)) k2
     (temp___1314 (select a k2) j2
     (temp___1321 (select (select a k2) j2) i2 f))) 1 16) true)))
(check-sat)
