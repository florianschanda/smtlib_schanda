...
;; def_axiom
  (assert
  (forall ((temp___2425 Int) (temp___2426 Int) (temp___2427 Int)
  (temp___2428 Int) (temp___2429 Int) (temp___2430 Int) (temp___2431 Int)
  (temp___2432 Int) (temp___2433 Int) (temp___2434 Int) (temp___2435 Int))
  (let ((temp___2424 (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__aggregate_def
                     temp___2425 temp___2426 temp___2427 temp___2428
                     temp___2429 temp___2430 temp___2431 temp___2432
                     temp___2433 temp___2434 temp___2435)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 2) (+ (first1 source) 10)
  temp___2434 temp___2435)
  (and (= (first7 temp___2424) temp___2434)
  (= (last7 temp___2424) temp___2435)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___2424) (+ (+ (first1 source) 2) 0)) (of_rep1
                                                                  temp___2425))
  (= (select (to_array2 temp___2424) (+ (+ (first1 source) 2) 1)) (of_rep1
                                                                  temp___2426)))
  (= (select (to_array2 temp___2424) (+ (+ (first1 source) 2) 2)) (of_rep1
                                                                  temp___2427)))
  (= (select (to_array2 temp___2424) (+ (+ (first1 source) 2) 3)) (of_rep1
                                                                  temp___2428)))
  (= (select (to_array2 temp___2424) (+ (+ (first1 source) 2) 4)) (of_rep1
                                                                  temp___2429)))
  (= (select (to_array2 temp___2424) (+ (+ (first1 source) 2) 5)) (of_rep1
                                                                  temp___2430)))
  (= (select (to_array2 temp___2424) (+ (+ (first1 source) 2) 6)) (of_rep1
                                                                  temp___2431)))
  (= (select (to_array2 temp___2424) (+ (+ (first1 source) 2) 7)) (of_rep1
                                                                  temp___2432)))
  (= (select (to_array2 temp___2424) (+ (+ (first1 source) 2) 8)) (of_rep1
                                                                  temp___2433)))))))
...
;; def_axiom
  (assert
  (forall ((temp___2441 Int) (temp___2442 Int) (temp___2443 Int))
  (let ((temp___2440 (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__aggregate_def
                     temp___2441 temp___2442 temp___2443)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 2) (+ (first1 source) 10)
  temp___2442 temp___2443)
  (and (= (first13 temp___2440) temp___2442)
  (= (last13 temp___2440) temp___2443)))
  (forall ((temp___2444 Int))
  (= (select (to_array4 temp___2440) temp___2444) (of_rep1 temp___2441)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_786 us_t3)
  (temp___is_init_783 Bool) (temp___skip_constant_784 Bool)
  (temp___do_toplevel_785 Bool)) Bool (=>
                                      (not (= temp___skip_constant_784 true))
                                      (and (dynamic_property6
                                      (+ (first1 source) 2)
                                      (+ (first1 source) 10)
                                      (first10 temp___expr_786)
                                      (last10 temp___expr_786))
                                      (and
                                      (= (first10 temp___expr_786) (+ 
                                      (first1 source) 2))
                                      (= (last10 temp___expr_786) (+ 
...
(declare-fun temp___2438 () (Array Int integer))

(declare-fun temp___24381 () t2)
...
(declare-fun temp___2446 () (Array Int integer))

(declare-fun temp___24461 () t4)
...
(declare-fun temp___2452 () Int)

(declare-fun temp___2453 () Int)

(declare-fun temp___2450 () (Array Int integer))

(declare-fun temp___2448 () Int)
...
;; H
  ...
  (forall ((index7 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 2) index7)
...
;; H
  (assert
  (= (mk___t2 temp___2438 temp___24381) (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__aggregate_def
                                        0 9 9 9 9 9 9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___24381)) (to_rep1 (last6 temp___24381)))
     (+ (- (to_rep1 (last6 temp___24381)) (to_rep1 (first6 temp___24381))) 1)
...
;; H
  (assert
  (= (slide1 temp___2438 (to_rep1 (first6 temp___24381))
...
;; H
  (assert
  (= (mk___t4 temp___2446 temp___24461) (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 2)
                                        (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___24461)) (to_rep1
                                               (last12 temp___24461)))
     (+ (- (to_rep1 (last12 temp___24461)) (to_rep1 (first12 temp___24461))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1
                                                        (first (rt source))) 10))
        (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1
                                                      (first (rt source))) 2)) 1)
...
;; H
  (assert
  (= (slide1 temp___2446 (to_rep1 (first12 temp___24461))
...
;; H
  (assert
  (and (= temp___2452 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (= temp___2453 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))
...
;; H
  (assert (= index1 temp___2452))

;; H
  (assert
  (=> (and (<= temp___2452 index1) (<= index1 temp___2453))
  (= temp___2450 n1)))
...
;; H
  (assert
  (=> (and (<= temp___2452 index1) (<= index1 temp___2453)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___2452 index1) (<= index1 temp___2453)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2452 index1) (<= index1 temp___2453)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2452 index1) (<= index1 temp___2453)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___2452 index1) (<= index1 temp___2453)) (= n2 o8)))
...
;; H
  ...
  (forall ((temp___2451 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___2451)
  (<= temp___2451 (to_rep1 n__last)))
  (=> (< index2 temp___2451)
  (= (select n3 temp___2451) (select temp___2450 temp___2451))))))
...
;; H
  (assert
  (=> (and (<= temp___2452 index1) (<= index1 temp___2453)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___2452 index1) (<= index1 temp___2453)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___2452 index1) (<= index1 temp___2453)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___2452 index1) (<= index1 temp___2453)))
...
;; H
  (assert
  (=> (not (and (<= temp___2452 index1) (<= index1 temp___2453))) (= n7 n1)))
...
;; H
  (assert
  (and (= temp___2454 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2454)
  (<= temp___2454 (to_rep1 n__last))))

;; H
  (assert (= o9 temp___2454))
...
;; H
  (assert
  (and (= temp___2455 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2455)
  (<= temp___2455 (to_rep1 n__last))))

;; H
  (assert (= o14 temp___2455))
...
;; H
  (assert
  (and (= temp___2456 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2456)
  (<= temp___2456 (to_rep1 n__last))))

;; H
  (assert (= o21 temp___2456))
...
;; H
  (assert
  (and (= temp___2457 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2457)
  (<= temp___2457 (to_rep1 n__last))))

;; H
  (assert (= o28 temp___2457))
