...
;; H
  (assert (= (bool_eq2 (select b2 2) 1 2 (temp___211 0) 1 2) true))

;; H
  (assert (= (bool_eq5 b2 1 2 (temp___219 o_b 2 (temp___225 0)) 1 2) true))
...
;; WP_parameter_def
 ;; File "update_proof.adb", line 1, characters 0-0
  (not
  (= (bool_eq2 (select b2 i) 1 2 (ite (= i 2) (temp___231 0) (select o_b i))
     (to_rep (first (mk 1 2))) (to_rep (last (mk 1 2)))) true)))
(check-sat)
