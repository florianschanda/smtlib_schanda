...
;; H
  (assert (islocked__function_guard1 (islocked1 currentlatch) currentlatch))
...
;; H
  (assert
  (or (= (= (islocked1 currentlatch) true) (= (islocked Tuple0) true))
  (= systemfault true)))
...
;; WP_parameter_def
 ;; File "latch.ads", line 42, characters 0-0
  ...
  (=> (latchislocked__function_guard (latchislocked Tuple0) Tuple0)
  (= (= (islocked1 currentlatch) true) (= (latchislocked Tuple0) true))))
  (= systemfault true))))
(check-sat)
