...
;; H
  (assert
  (and (= use_maps__apply_f__cu__assume1 (first s))
  (ite (= (= (length s) 0) true)
  (= (bool_eq3 use_maps__apply_f__cu__assume1 no_element) true)
  (and (= (has_key1 (positions s) use_maps__apply_f__cu__assume1) true)
  (= (get1 (positions s) use_maps__apply_f__cu__assume1) 1)))))
...
;; H
  ...
  (let ((temp___792 (keys (mk___rep r__split_discrs r__split_fields4))))
...
;; H
  (assert
  (let ((temp___801 (keys (mk___rep r__split_discrs r__split_fields4))))
...
;; H
  (assert
  (and (= temp___7801 (next s (mk___rep1 cu__split_fields4)))
...
;; H
  (assert (<= (get1 (positions s) (mk___rep1 cu__split_fields3)) i))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (not
  (= (has_key (model__ (mk___rep r__split_discrs r__split_fields3))
     (get (keys s) i)) true))))
(check-sat)
