...
;; H
  (assert (= o1 (store cache_v1 i1 o)))

;; H
  (assert (= (mk_map__ref result1) (mk_map__ref cache_v1)))
...
;; H
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k 10))
  (=> (<= k i2) (= (to_rep (select cache_v12 k)) 0)))))
...
;; H
  ...
  (=> (< i2 temp___351)
  (= (select cache_v12 temp___351) (select cache_v1 temp___351))))))
  (and (<= 1 i2) (<= i2 10))))
...
;; H
  (assert (= o3 (store cache_v12 i3 o2)))

;; H
  (assert (= result3 cache_v12))
