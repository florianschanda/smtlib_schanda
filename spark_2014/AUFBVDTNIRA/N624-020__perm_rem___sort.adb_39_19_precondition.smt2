...
;; H
  (assert (remove__function_guard (remove o23 o19) o23 o19))
...
;; H
  ...
  (remove__function_guard o23 (mk___t values2 (mk 1 100)) o16))
...
;; H
  ...
  (remove__function_guard o24 (mk___t interm1 (mk 1 100)) o13))
...
;; H
  (assert
  (and
  (and (= o20 (remove_eq o24 o23 o19)) (remove_eq__function_guard o20 
  o24 o23 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___181 (remove o23 o19)))
     (let ((temp___180 (remove o24 o19)))
