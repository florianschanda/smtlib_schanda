...
;; H
  (assert
  (and
  (and (= o7 (minimum_date Tuple0)) (minimum_date__function_guard o7 Tuple0))
...
;; H
  (assert
  (not
  (= (bool_eq4 (mk___rep current_date__split_fields3) (minimum_date Tuple0)) true)))
...
;; H
  (assert
  (and
  (and (= o6 (minimum_date Tuple0)) (minimum_date__function_guard o6 Tuple0))
  (and (= (of_rep2 1) o3) (and (= (of_rep1 1) o4) (= (of_rep 2000) o5)))))

;; H
  (assert (= result5 (bool_eq4 (mk___rep current_date__split_fields4) o6)))
...
;; WP_parameter_def
 ;; File "dates.ads", line 89, characters 0-0
  (not
  (not
  (= (bool_eq4 (mk___rep current_date__split_fields4) (minimum_date Tuple0)) true))))
(check-sat)
