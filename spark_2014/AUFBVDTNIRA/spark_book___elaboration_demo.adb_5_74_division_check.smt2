...
(declare-fun temp___1531 () t2)

(declare-fun elaboration_demo__line__assume () (Array Int character))

(declare-fun elaboration_demo__line__assume1 () t1)
...
;; H
  (assert
  (= (mk (to_rep (first2 temp___1531)) (to_rep (last4 temp___1531))) 
...
;; H
  (assert
  (= (to_rep line__last) (to_rep (last1 elaboration_demo__line__assume1))))
