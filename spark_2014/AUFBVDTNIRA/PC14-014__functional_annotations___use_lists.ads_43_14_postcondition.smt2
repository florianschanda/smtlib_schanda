...
;; H
  ...
  (= (bool_eq3 use_lists__incr_all_3__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
...
;; H
  (assert
  (=> (= result1 true)
  (ite (= (ite (= (bool_eq3 (mk___rep1 cu__split_fields11) no_element) false) (= 
          (get1 (positions (mk___rep l__split_discrs l__split_fields10))
          (mk___rep1 cu__split_fields11)) (length
                                          (mk___rep l__split_discrs
                                          l__split_fields10))) true) true)
  (= (bool_eq3 (mk___rep1 cu__split_fields10) no_element) true)
  (and
...
;; WP_parameter_def
 ;; File "use_lists.ads", line 35, characters 0-0
  (not
  (= (length
     (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) 
