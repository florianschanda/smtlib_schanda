...
;; H
  (assert (=> (= result9 true) (= (mk2 1 (length thestring1)) temp___13091)))
...
;; H
  ...
  (= (select o17 temp___1314) (select result__6 temp___1314))))))

;; H
  (assert (=> (= result9 true) (= result10 (mk_map__ref result__6))))

;; H
  (assert (=> (= result9 true) (= result__7 o17)))
...
;; H
  (assert (=> (not (= result9 true)) (= o18 temp___1308)))

;; H
  (assert (=> (not (= result9 true)) (= result11 (mk_map__ref result__6))))

;; H
  (assert (=> (not (= result9 true)) (= result__8 o18)))
