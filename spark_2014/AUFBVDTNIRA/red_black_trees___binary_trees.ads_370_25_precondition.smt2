...
(declare-fun temp___941 () (Array Int us_rep1))
...
;; H
  ...
  (= temp___941 (model__
                (mk___rep2 (us_split_fields__content2 f__split_fields7))
                root))
  (and (dynamic_invariant2 temp___941 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___941 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___941 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___941 (parent
                             (mk___rep2
                             (us_split_fields__content2 f__split_fields7))
                             i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___941 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___941 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___941 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___941 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___941 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___941 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= o41 (select temp___941 j)))
