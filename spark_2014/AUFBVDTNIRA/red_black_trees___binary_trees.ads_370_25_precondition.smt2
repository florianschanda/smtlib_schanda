...
(declare-fun temp___1411 () (Array Int us_rep1))
...
;; H
  ...
  (=> (and (<= 1 j1) (<= j1 100))
  (=>
  (and (not (= j1 (int__content v2)))
  (not
  (= (parent
     (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j1) 0)))
  (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) 
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  j1)))))))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1411 (parent
                      (mk___rep2
                      (us_split_fields__content2 f__split_fields7)) i1))))
  (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1411 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1411 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___1411 (model__
                 (mk___rep2 (us_split_fields__content2 f__split_fields7))
                 root))
  (model____function_guard temp___1411
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) root))
  (and (dynamic_invariant2 temp___1411 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1411 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1411 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___1411 (parent
                              ...
                              i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1411 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1411 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1411 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1411 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1411 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1411 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= o41 (select temp___1411 j)))

;; H
  (assert (= o42 (us_split_fields1 o41)))

;; H
  (assert (= o43 (rec__tree_model__path_type__k o42)))

;; H
  (assert
  (= result17 (ite (= o43 true) (ite (not (= j (int__content v2))) true
                                false) false)))
