...
;; H
  (assert
  (and
  (= (to_rep (select memory6 (bvadd addr ((_ int2bv 64) 5)))) ((_ extract 7 0) (bvand (bvlshr 
  val__ ((_ int2bv 64) 40)) ((_ int2bv 64) 255))))
  (forall ((i (_ BitVec 64)))
  (=>
  (and (bvule ((_ int2bv 64) 0) i)
  (bvule i ((_ int2bv 64) 18446744073709551615)))
  (=> (not (= i (bvadd addr ((_ int2bv 64) 5))))
  (= (to_rep (select memory6 i)) (to_rep (select memory5 i))))))))

;; H
  (assert
  (and
  (= (to_rep (select memory7 (bvadd addr ((_ int2bv 64) 6)))) ((_ extract 7 0) (bvand (bvlshr 
  val__ ((_ int2bv 64) 48)) ((_ int2bv 64) 255))))
  (forall ((i (_ BitVec 64)))
  (=>
  (and (bvule ((_ int2bv 64) 0) i)
  (bvule i ((_ int2bv 64) 18446744073709551615)))
  (=> (not (= i (bvadd addr ((_ int2bv 64) 6))))
  (= (to_rep (select memory7 i)) (to_rep (select memory6 i))))))))

;; H
  (assert
  (and
  (= (to_rep (select memory8 (bvadd addr ((_ int2bv 64) 7)))) ((_ extract 7 0) (bvand (bvlshr 
  val__ ((_ int2bv 64) 56)) ((_ int2bv 64) 255))))
  (forall ((i (_ BitVec 64)))
  (=>
  (and (bvule ((_ int2bv 64) 0) i)
  (bvule i ((_ int2bv 64) 18446744073709551615)))
  (=> (not (= i (bvadd addr ((_ int2bv 64) 7))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 7, characters 0-0
  (not (= (hasmem64 memory9 addr val__) true)))
(check-sat)
