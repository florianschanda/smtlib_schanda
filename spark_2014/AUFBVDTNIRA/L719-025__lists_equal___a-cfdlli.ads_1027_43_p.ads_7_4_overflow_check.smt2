...
(declare-fun temp___427 () count_type)
...
;; H
  ...
  (and (in_range1 o2)
  (<= o2 (to_rep (rec__p__my_lists__list__capacity target__split_discrs))))))

;; H
  (assert
  (= o3 (- (to_rep (rec__p__my_lists__list__capacity target__split_discrs)) 
  o2)))
