...
(define-fun default_initial_assumption2 ((temp___expr_285 us_rep4)
...
;; size__def_axiom
  ...
  (forall ((t1 us_rep5))
  (! (=>
     (and (dynamic_invariant10 t1 true true true) (size__function_guard1
     (size1 t1) t1))
     (and (size__function_guard
...
;; H
  (assert (dynamic_invariant10 t true false true))
