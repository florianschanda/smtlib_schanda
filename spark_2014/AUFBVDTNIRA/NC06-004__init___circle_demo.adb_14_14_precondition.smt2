...
(declare-fun to_rep2 (coordinate_type) t)

(declare-fun of_rep2 (t) coordinate_type)
...
(declare-fun to_rep3 (radius_type) t)

(declare-fun of_rep3 (t) radius_type)
...
(define-fun dynamic_invariant1 ((temp___expr_514 t) (temp___is_init_511 Bool)
  ...
  (temp___do_toplevel_513 Bool)) Bool (=>
                                      ...
                                      (neg fliteral1) fliteral1)) (in_range4
                                      temp___expr_514)))

(define-fun dynamic_invariant2 ((temp___expr_520 t) (temp___is_init_517 Bool)
  (temp___skip_constant_518 Bool)
  (temp___do_toplevel_519 Bool)) Bool (=>
                                      (or (= temp___is_init_517 true) (le
                                      fliteral2 fliteral3)) (in_range5
                                      temp___expr_520)))
...
(declare-fun make_circle (t t t Int) us_rep)

(declare-fun make_circle__function_guard (us_rep t t t Int) Bool)

;; make_circle__post_axiom
  (assert
  (forall ((x t) (y t) (radius t))
...
(declare-fun inside_circle (t t us_rep Int) Bool)

(declare-fun inside_circle__function_guard (Bool t t us_rep Int) Bool)
...
;; H
  (assert
  (and
  (and (= temp___5383 (make_circle fliteral2 fliteral2 fliteral4 wild_man))
  (make_circle__function_guard temp___5383 fliteral2 fliteral2 fliteral4
