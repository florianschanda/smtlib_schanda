...
(declare-fun cu__split_fields4 () count_type)
...
;; H
  (assert (my_eq__function_guard
  (my_eq
  (element (mk___rep l__split_discrs l__split_fields5)
  (mk___rep1 cu__split_fields5)) e1)
  (element (mk___rep l__split_discrs l__split_fields5)
  (mk___rep1 cu__split_fields5)) e1))
...
;; H
  ...
  (= (length (mk___rep l__split_discrs l__split_fields6)) (- (length
                                                             ...
                                                             l__split_fields))) 1)))
  (not
  (= (contains (model__ (mk___rep l__split_discrs l__split_fields6))
...
;; H
  ...
  (and
  (and
  (= (contains (model__ (mk___rep l__split_discrs l__split_fields5)) e1) true)
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields5))
     (mk___rep1 cu__split_fields5)) true))
  (= (my_eq
     (element (mk___rep l__split_discrs l__split_fields5)
     (mk___rep1 cu__split_fields5)) e1) true))
  (ite (= (contains (model__ (mk___rep l__split_discrs l__split_fields6)) e1) true)
  (and
  (and
  (and (not (= i true))
  (= (oeq2 (model__ (mk___rep l__split_discrs l__split_fields5))
     (model__ (mk___rep l__split_discrs l__split_fields6))) true))
  (= (oeq3 (elements (mk___rep l__split_discrs l__split_fields5))
     (elements (mk___rep l__split_discrs l__split_fields6))) true))
  (= (oeq4 (positions (mk___rep l__split_discrs l__split_fields5))
  ...
  (= (included_except (model__ (mk___rep l__split_discrs l__split_fields5))
     (model__ (mk___rep l__split_discrs l__split_fields6)) e1) true))
  (= (mapping_preserved
     (elements (mk___rep l__split_discrs l__split_fields6))
