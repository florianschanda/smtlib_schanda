...
(declare-fun temp___796 () (Array Int character))

(declare-fun temp___7961 () t)
...
;; H
  ...
  (= (to_rep1
     (first2
     (rt (do_checks__do_range_check__B_17__a__aggregate_def 48 zero 1)))) 
  zero))
...
;; H
  ...
  (= (to_rep1
     (last1
     (rt (do_checks__do_range_check__B_17__a__aggregate_def 48 zero 1)))) 1))

;; H
  (assert
  (= (mk___t temp___796 temp___7961) (do_checks__do_range_check__B_17__a__aggregate_def
                                     48 zero 1)))
...
;; WP_parameter_def
 ;; File "do_checks.adb", line 1, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 temp___7961)) (to_rep1 (last1 temp___7961)))
     (+ (- (to_rep1 (last1 temp___7961)) (to_rep1 (first2 temp___7961))) 1)
     0) (ite (<= 1 10) (+ (- 10 1) 1) 0))))
(check-sat)
