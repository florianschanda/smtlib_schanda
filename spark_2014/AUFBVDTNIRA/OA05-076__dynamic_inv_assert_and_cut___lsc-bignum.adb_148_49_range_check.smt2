...
;; H
  (assert
  (and (= o44 (num_of_boolean carry3)) (num_of_boolean__function_guard 
  o44 carry3)))
...
;; H
  (assert
  (and (and (= o38 (base Tuple0)) (base__function_guard o38 Tuple0))
  (= o38 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o43 (oexpon o38 o42)) (oexpon__function_guard o43 o38 o42)))
...
;; H
  ...
  (= o37 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))
         a_first o36))
  (num_of_big_int__function_guard o37
  (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o36)))

;; H
  (assert
  (and (= o46 (osubtract o37 o45)) (osubtract__function_guard o46 o37 o45)))
