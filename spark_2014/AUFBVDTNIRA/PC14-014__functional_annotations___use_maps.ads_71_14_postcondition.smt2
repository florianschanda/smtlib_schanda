...
(declare-fun use_maps__are_disjoint__result () Bool)

(declare-fun use_maps__are_disjoint__cu__assume () count_type)
...
(declare-fun use_maps__are_disjoint__result1 () Bool)
...
(declare-fun use_maps__are_disjoint__result2 () Bool)

(declare-fun result2 () Bool)

(declare-fun result3 () Bool)

(declare-fun use_maps__are_disjoint__result3 () Bool)
...
(declare-fun use_maps__are_disjoint__result4 () bool__ref)

(declare-fun cu__split_fields5 () us_split_fields2)

(declare-fun use_maps__are_disjoint__result5 () Bool)

(declare-fun cu__split_fields6 () us_split_fields__ref1)

(declare-fun use_maps__are_disjoint__result6 () bool__ref)

(declare-fun cu__split_fields7 () us_split_fields2)

(declare-fun use_maps__are_disjoint__result7 () Bool)

(declare-fun result6 () bool__ref)

(declare-fun use_maps__are_disjoint__result8 () Bool)

(declare-fun use_maps__are_disjoint__result9 () bool__ref)

(declare-fun use_maps__are_disjoint__result10 () Bool)

(declare-fun cu__split_fields8 () us_split_fields__ref1)

(declare-fun use_maps__are_disjoint__result11 () bool__ref)

(declare-fun cu__split_fields9 () us_split_fields2)

(declare-fun use_maps__are_disjoint__result12 () Bool)

(declare-fun cu__split_fields10 () us_split_fields__ref1)

(declare-fun use_maps__are_disjoint__result13 () bool__ref)

(declare-fun cu__split_fields11 () us_split_fields2)

(declare-fun use_maps__are_disjoint__result14 () Bool)
...
;; H
  ...
  (= (bool_eq3 use_maps__are_disjoint__cu__assume1 no_element) true)
...
;; H
  ...
  (and (= result1 true)
  (and (= temp___948 cu__split_fields1)
  (and
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  ...
  (and
  (and
  (and (= temp___9471 (next s1 (mk___rep1 cu__split_fields13)))
  (ite (= (ite (= (bool_eq3 (mk___rep1 cu__split_fields13) no_element) false) (= 
  ...
  (and (= result4 cu__split_fields2) (= temp___947 cu__split_fields3)))
  (and
  (and
...
(define-fun temp___958 () us_rep3 (keys s2))

(declare-fun temp___957 () Int)

;; H
  (assert (in_range3 temp___957))

;; H
  (assert (= (iter_has_element temp___958 temp___957) true))

(assert
;; WP_parameter_def
 ;; File "use_maps.ads", line 70, characters 0-0
  (not (not (= (has_key (model__ s1) (get temp___958 temp___957)) true))))
(check-sat)
