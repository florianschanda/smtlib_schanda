...
(define-fun v2__split_fields1 () us_split_fields (mk___split_fields
                                                 v2__split_fields))
...
;; H
  (assert
  (and (= (length (mk___rep v2__split_discrs v2__split_fields1)) 0)
...
;; H
  (assert
  (<= n (last4 (model__ (mk___rep v2__split_discrs v2__split_fields1)))))

;; H
  (assert (is_incr__function_guard
  (is_incr (get (model__ v1) n)
  (get (model__ (mk___rep v2__split_discrs v2__split_fields1)) n))
  (get (model__ v1) n)
  (get (model__ (mk___rep v2__split_discrs v2__split_fields1)) n)))
...
;; WP_parameter_def
 ;; File "use_vectors.ads", line 33, characters 0-0
  (not
  (= (is_incr (get (model__ v1) n)
     (get (model__ (mk___rep v2__split_discrs v2__split_fields1)) n)) true)))
(check-sat)
