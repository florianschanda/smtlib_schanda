...
(define-fun dynamic_invariant ((temp___expr_152 Int)
  ...
  (temp___do_toplevel_151 Bool)) Bool (=>
                                      ...
                                      (<= 1 100)) (in_range temp___expr_152)))
...
;; temp___result_283_def
  (assert
  (forall ((temp___282 us_rep1)) (tree_structure__function_guard
  (tree_structure temp___282) temp___282)))

(define-fun dynamic_invariant2 ((temp___expr_281 us_rep1)
...
;; temp___result_291_def
  (assert
  (forall ((temp___290 us_rep1)) (size__function_guard (size temp___290)
  temp___290)))
...
;; temp___result_294_def
  (assert
  (forall ((temp___293 us_rep1)) (tree_structure__function_guard
  (tree_structure temp___293) temp___293)))

(define-fun type_invariant ((temp___292 us_rep1)) Bool (= (tree_structure
                                                          temp___292) true))
...
;; position__post_axiom
  ...
  (! (and (parent__function_guard (parent f i) f i)
     (=>
     (and
     (and (dynamic_invariant2 f true true true) (dynamic_invariant i true
...
;; temp___result_564_def
  (assert
  (forall ((temp___563 us_rep1)) (tree_structure__function_guard
  (tree_structure temp___563) temp___563)))

(define-fun dynamic_invariant3 ((temp___expr_562 us_rep2)
  (temp___is_init_559 Bool) (temp___skip_constant_560 Bool)
  (temp___do_toplevel_561 Bool)) Bool (= (tree_structure
                                         (rec__search_trees__search_tree__struct
                                         (us_split_fields5 temp___expr_562))) true))

;; temp___result_574_def
  (assert
  (forall ((temp___573 us_rep1)) (size__function_guard (size temp___573)
  temp___573)))

;; temp___result_580_def
  (assert
  (forall ((temp___579 us_rep2)) (size__function_guard1 (size1 temp___579)
  temp___579)))

(define-fun default_initial_assumption1 ((temp___expr_567 us_rep2)
...
;; temp___result_585_def
  (assert
  (forall ((temp___582 us_rep2)) (size__function_guard
  (size
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___582)))
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___582)))))

;; temp___result_583_def
  (assert
  (forall ((temp___582 us_rep2)) (valid_root__function_guard
  (valid_root
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___582))
  (to_rep
  (rec__search_trees__search_tree__root (us_split_fields5 temp___582))))
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___582))
  (to_rep
  (rec__search_trees__search_tree__root (us_split_fields5 temp___582))))))
...
;; temp___result_584_def
  (assert
  (forall ((temp___582 us_rep2)) (ordered_leafs__function_guard
  (ordered_leafs
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___582))
  (to_rep
  (rec__search_trees__search_tree__root (us_split_fields5 temp___582)))
  (rec__search_trees__search_tree__values (us_split_fields5 temp___582)))
  (rec__search_trees__search_tree__struct (us_split_fields5 temp___582))
  (to_rep
  (rec__search_trees__search_tree__root (us_split_fields5 temp___582)))
  (rec__search_trees__search_tree__values (us_split_fields5 temp___582)))))

(define-fun type_invariant1 ((temp___581 us_rep2)) Bool (ite (= (size
                                                                (rec__search_trees__search_tree__struct
                                                                (us_split_fields5
                                                                temp___581))) 0)
                                                        (= (to_rep
...
;; parent__def_axiom
  ...
  (! (=>
     ...
     (parent (rec__search_trees__search_tree__struct (us_split_fields5 t)) i)
     (rec__search_trees__search_tree__struct (us_split_fields5 t)) i)
     (= (parent1 t i) (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields5 t)) i)))) :pattern ((parent1 t i)) ))))

(declare-fun t () us_rep2)
...
;; size__post_axiom
  ...
  (! (=> (and (dynamic_invariant3 t1 true true true) (type_invariant1 t1))
     (let ((result (size1 t1)))
     (=> (size__function_guard1 result t1) (dynamic_invariant4 result true
...
;; size__def_axiom
  ...
  (forall ((t1 us_rep2))
  (! (=>
     (and (dynamic_invariant3 t1 true true true) (size__function_guard1
     (size1 t1) t1))
...
(define-fun of_int ((i1 Int)) Bool (ite (= i1 0) false true))
...
(define-fun us_split_fields_A__projection ((a us_split_fields6)) us_rep3 
  (rec__tree_model__path_type__a a))

(define-fun us_split_fields_K__projection ((a us_split_fields6)) Bool 
...
(define-fun us_rep___projection ((a us_rep4)) us_split_fields6 (us_split_fields7
                                                               a))
...
(define-fun bool_eq11 ((a us_rep4)
  (b us_rep4)) Bool (ite (and
                         ...
                         (= (rec__tree_model__path_type__k
                            (us_split_fields7 a)) (rec__tree_model__path_type__k
                                                  (us_split_fields7 b))))
                    true false))
...
(declare-datatypes ()
((path_type__ref (mk_path_type__ref (path_type__content us_rep4)))))
(define-fun path_type__ref___projection ((a path_type__ref)) us_rep4 
  (path_type__content a))

(declare-datatypes ()
((map__ref2 (mk_map__ref2 (map__content2 (Array Int us_rep4))))))
...
;; slide_def
  ...
  (forall ((new_first Int))
  (forall ((i1 Int))
  (! (= (select (slide2 a old_first new_first) i1) (select a (- i1 (- new_first old_first)))) :pattern ((select 
  (slide2 a old_first new_first) i1)) ))))))

(declare-fun concat3 ((Array Int us_rep4) Int Int (Array Int us_rep4) Int
...
;; concat_def
  ...
  (! (and
     ...
     (= (select (concat3 a a_first a_last b b_first b_last) i1) (select a i1)))
     (=> (< a_last i1)
     (= (select (concat3 a a_first a_last b b_first b_last) i1) (select b (+ (- i1 a_last) (- b_first 1)))))) :pattern ((select 
  (concat3 a a_first a_last b b_first b_last) i1)) )))))
...
;; singleton_def
  ...
  (forall ((v us_rep4))
  (forall ((i1 Int))
  (! (= (select (singleton3 v i1) i1) v) :pattern ((select (singleton3 v i1) i1)) ))))

(define-fun bool_eq12 ((a (Array Int us_rep4)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq11 (select a temp___idx_132)
...
;; ordered_leafs__def_axiom
  ...
  (! (=> (ordered_leafs__function_guard (ordered_leafs f root values) f root
     ...
     (= (rec__tree_model__path_type__k
        (us_split_fields7
        (let ((temp___909 (model__ f root))) (select temp___909 i1)))) true)
     (= (rec__tree_model__path_type__k
        (us_split_fields7
     ...
     (= (olt
        (rec__tree_model__path_type__a
        (us_split_fields7
        (let ((temp___913 (model__ f root))) (select temp___913 i1))))
        (rec__tree_model__path_type__a
        (us_split_fields7
     ...
     (ite (= (get
             ...
             (+ (length
                (rec__tree_model__path_type__a
                (us_split_fields7
                (let ((temp___907 (model__ f root))) (select temp___907 i1))))) 1)) 0)
     (< (to_rep2 (select values j)) (to_rep2 (select values i1)))
     (< (to_rep2 (select values i1)) (to_rep2 (select values j))))))))))))))))) :pattern (
...
(define-fun dynamic_invariant6 ((temp___expr_164 Int)
  ...
  (temp___do_toplevel_163 Bool)) Bool (=>
                                      ...
                                      (<= 0 2)) (in_range2 temp___expr_164)))

(define-fun dynamic_invariant7 ((temp___expr_207 us_rep4)
  (temp___is_init_204 Bool) (temp___skip_constant_205 Bool)
  (temp___do_toplevel_206 Bool)) Bool (=> (= temp___do_toplevel_206 true)
                                      (=> (= temp___is_init_204 true)
                                      (< (length
                                         (rec__tree_model__path_type__a
                                         (us_split_fields7 temp___expr_207))) 100))))

(define-fun default_initial_assumption2 ((temp___expr_209 us_rep4)
...
(define-fun dynamic_predicate ((temp___213 us_rep4)) Bool (< (length
                                                             (rec__tree_model__path_type__a
                                                             (us_split_fields7
                                                             temp___213))) 100))

(define-fun dynamic_invariant8 ((temp___expr_218 (Array Int us_rep4))
...
(define-fun default_initial_assumption3 ((temp___expr_221 (Array Int us_rep4))
...
(define-fun default_initial_assumption4 ((temp___expr_201 us_rep3)
...
;; size__post_axiom
  (assert
  (forall ((f us_rep1))
  (! (=> (dynamic_invariant2 f true true true)
     (let ((result (size f)))
     (=> (size__function_guard result f) (dynamic_invariant4 result true
...
;; valid_root__post_axiom
  ...
  (forall ((i1 Int))
  (! (=>
     (and (dynamic_invariant2 f true true true) (dynamic_invariant i1 true
     true true))
...
;; parent__post_axiom
  ...
  (! (=>
     (and (dynamic_invariant2 f true true true) (dynamic_invariant i1 true
     true true))
     (let ((result (parent f i1)))
     (and (valid_root__function_guard (valid_root f i1) f i1)
     (and (size__function_guard (size f) f)
     (=> (parent__function_guard result f i1)
     (and
     (and (=> (= (valid_root f i1) true) (= result 0))
     (=> (= (size f) 0) (= result 0))) (dynamic_invariant4 result true false
     true))))))) :pattern ((parent f i1)) ))))
...
;; model____post_axiom
  ...
  (! (and (valid_root__function_guard (valid_root f root) f root)
     (=>
     (and
     (and (dynamic_invariant2 f true true true) (dynamic_invariant root true
     true true)) (= (valid_root f root) true))
     (let ((result (model__ f root)))
     (and (forall ((i1 Int)) (parent__function_guard (parent f i1) f i1))
     (and (forall ((i1 Int)) (parent__function_guard (parent f i1) f i1))
     (and (forall ((i1 Int)) (parent__function_guard (parent f i1) f i1))
     (and (forall ((i1 Int)) (position__function_guard (position f i1) f i1))
     (and (forall ((i1 Int)) (parent__function_guard (parent f i1) f i1))
     (and (forall ((i1 Int)) (position__function_guard (position f i1) f i1))
     (and
     ...
     (is_add
     (rec__tree_model__path_type__a
     (us_split_fields7 (select result (parent f i1)))) (position f i1)
     (rec__tree_model__path_type__a (us_split_fields7 (select result i1))))
     (rec__tree_model__path_type__a
     (us_split_fields7 (select result (parent f i1)))) (position f i1)
     (rec__tree_model__path_type__a (us_split_fields7 (select result i1)))))
     ...
     (and
     (= (rec__tree_model__path_type__k
        (us_split_fields7 (select result root))) true)
     (and
     (= (length
        (rec__tree_model__path_type__a
        (us_split_fields7 (select result root)))) 0)
     (and
     (forall ((i1 Int))
     (=> (and (<= 1 i1) (<= i1 100))
     (=> (not (= i1 root))
     (ite (and (not (= (parent f i1) 0))
          (= (rec__tree_model__path_type__k
             (us_split_fields7 (select result (parent f i1)))) true))
     (= (rec__tree_model__path_type__k (us_split_fields7 (select result i1))) true)
     (not
     (= (rec__tree_model__path_type__k (us_split_fields7 (select result i1))) true))))))
     (and
     (forall ((i1 Int))
     ...
     (= (is_add
        (rec__tree_model__path_type__a
        (us_split_fields7 (select result (parent f i1)))) (position f i1)
        (rec__tree_model__path_type__a (us_split_fields7 (select result i1)))) true)
     (= (length
        (rec__tree_model__path_type__a (us_split_fields7 (select result i1)))) 0))))
     (forall ((i1 Int))
     (=> (and (<= 1 i1) (<= i1 100))
     (=>
     (= (rec__tree_model__path_type__k (us_split_fields7 (select result i1))) true)
     ...
     (=>
     (and
     (= (rec__tree_model__path_type__k (us_split_fields7 (select result j))) true)
     (= (oeq
        (rec__tree_model__path_type__a (us_split_fields7 (select result i1)))
        (rec__tree_model__path_type__a (us_split_fields7 (select result j)))) true))
     (= j i1))))))))))) (dynamic_invariant8 result true false true))))))))))))) :pattern (
  (model__ f root)) ))))

(define-fun default_initial_assumption5 ((temp___expr_267 us_rep)
...
(define-fun default_initial_assumption6 ((temp___expr_274 (Array Int us_rep))
...
;; H
  (assert (parent__function_guard1 (parent1 t i) t i))

;; H
  (assert (not (= (parent1 t i) 0)))
...
;; WP_parameter_def
 ;; File "tree_model.ads", line 19, characters 0-0
  (not
  (not
  (= (parent (rec__search_trees__search_tree__struct (us_split_fields5 t)) i) 0))))
(check-sat)
