...
;; H
  (assert (=> (and (<= 1 r2) (<= r2 r289b)) (= temp___2753 r2)))
...
;; H
  (assert
  (=> (and (<= 1 r2) (<= r2 r289b))
  (and (=> (<= 1 r289b) (dynamic_property 1 r289b r3))
  (and (<= 1 r3) (<= r3 r289b)))))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 r289b)) (= r3 r289b)))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 r289b)) (= r4 (mk_int__ref r3))))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 r289b)) (= r5 r3)))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 r289b)) (= r6 r4)))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 r289b)) (= r7 r5)))

;; H
  (assert (=> (not (and (<= 1 r2) (<= r2 r289b))) (= r6 (mk_int__ref r2))))

;; H
  (assert (=> (not (and (<= 1 r2) (<= r2 r289b))) (= r7 r2)))
...
;; H
  ...
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2785 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2785 (parent
                      (mk___rep2
...
;; H
  ...
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2785 (parent
                              ...
                              f__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2785 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2785 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2785 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2785 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2785 j)))) true))
  (= j i))))))))))))))

;; H
  (assert (= o30 (select temp___2785 v)))

;; H
  (assert (= o31 (us_split_fields1 o30)))

;; H
  (assert (= result6 (rec__tree_model__path_type__k o31)))
...
;; H
  (assert
  (= result9 (ite (= o27 true) (ite (not (= r1 v)) true false) false)))
...
;; H
  ...
  (valid_root
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o29)
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o29))
