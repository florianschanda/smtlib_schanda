...
;; H
  ...
  (rolepresent__function_guard o41
...
;; H
  ...
  (= o42 (thecurrentop
         (mk___rep (us_split_fields__content theadmin__split_fields5))))
  (thecurrentop__function_guard o42
  (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range6
  o42))))
...
;; H
  ...
  (= o36 (thecurrentop
         (mk___rep (us_split_fields__content theadmin__split_fields5))))
  (thecurrentop__function_guard o36
  (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range6
  o36)))
...
;; H
  ...
  (= o39 (rolepresent
         (mk___rep (us_split_fields__content theadmin__split_fields5))))
  (rolepresent__function_guard o39
  (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range4
  o39))))
...
;; H
  (assert
  (and (= o28 (islocked (us_private__content state21)))
  (islocked__function_guard o28 (us_private__content state21))))
...
;; H
  ...
  (=> (= result4 true)
  (and
  (and (= o32 (theauthcertrole (us_private__content state20)))
  (theauthcertrole__function_guard o32 (us_private__content state20)))
  (in_range4 o32))))
...
;; H
  (assert
  (=> (= result4 true)
  (and (= o30 (authcertvalid (us_private__content state20)))
  (authcertvalid__function_guard o30 (us_private__content state20)))))

;; H
  (assert
  (=> (= result4 true)
  (and (= o31 (isgood (us_private__content state20))) (isgood__function_guard
  o31 (us_private__content state20)))))
...
;; H
  ...
  (= o21 (rolepresent
         (mk___rep (us_split_fields__content theadmin__split_fields5))))
  (rolepresent__function_guard o21
  (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range4
  o21)))
...
;; H
  ...
  (=> (= result5 true)
  (and
  (and (= o24 (theauthcertrole (us_private__content state20)))
  (theauthcertrole__function_guard o24 (us_private__content state20)))
  (in_range4 o24))))
...
;; H
  (assert
  (=> (= result5 true)
  (and (= o22 (authcertvalid (us_private__content state20)))
  (authcertvalid__function_guard o22 (us_private__content state20)))))

;; H
  (assert
  (=> (= result5 true)
  (and (= o23 (isgood (us_private__content state20))) (isgood__function_guard
  o23 (us_private__content state20)))))
...
;; H
  (assert
  (and
  (and (= o16 (thedooralarm (us_private__content state22)))
  (thedooralarm__function_guard o16 (us_private__content state22)))
  (in_range15 o16)))
...
;; H
  (assert
  (and (= o49 (alarm_timeout (us_private__content state22)))
  (alarm_timeout__function_guard o49 (us_private__content state22))))

;; H
  (assert
  (and (= o50 (thecurrenttime currenttime)) (thecurrenttime__function_guard
  o50 currenttime)))

;; H
  (assert
  (and (= o13 (greaterthanorequal o50 o49))
  (greaterthanorequal__function_guard o13 o50 o49)))

;; H
  (assert
  (and
  (and (= o2 (thecurrentdoor (us_private__content state22)))
  (thecurrentdoor__function_guard o2 (us_private__content state22)))
  (in_range14 o2)))
...
;; H
  (assert
  (and (= o4 (islocked (us_private__content state21)))
  (islocked__function_guard o4 (us_private__content state21))))
