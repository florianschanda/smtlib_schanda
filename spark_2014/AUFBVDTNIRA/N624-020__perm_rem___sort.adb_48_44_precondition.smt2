...
(define-fun o38 () us_t (mk___t o17 o18))
...
;; H
  (assert (remove__function_guard (remove o38 o19) o38 o19))

;; H
  (assert (remove__function_guard (remove o39 o19) o39 o19))
...
;; H
  (assert
  (and
  (and (= o38 (remove (mk___t values2 (mk 1 100)) o16))
  (remove__function_guard o38 (mk___t values2 (mk 1 100)) o16))
...
;; H
  (assert
  (and
  (and (= o39 (remove (mk___t interm1 (mk 1 100)) o13))
  (remove__function_guard o39 (mk___t interm1 (mk 1 100)) o13))
...
;; H
  (assert
  (and
  (and (= o20 (remove_eq o39 o38 o19)) (remove_eq__function_guard o20 
  o39 o38 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___181 (remove o38 o19)))
     (let ((temp___180 (remove o39 o19)))
...
;; H
  (assert (invariant____function_guard (invariant__ temp___376) temp___376))
...
;; H
  ...
  (remove__function_guard o34 (mk___t values2 (mk 1 100)) o33))
...
;; H
  (assert
  (and
  (and (= temp___376 (remove o34 o35)) (remove__function_guard temp___376 
  o34 o35))
  (and (dynamic_invariant4 temp___376 true false true)
  (and (= (invariant__ temp___376) true)
  (and (= (to_rep1 (last (rt temp___376))) (- (to_rep1 (last (rt o34))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o35 1)))
  (= (to_rep (select (elts o34) k)) (to_rep (select (elts temp___376) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o35 1) k) (<= k (to_rep1 (last (rt o34)))))
  (= (to_rep (select (elts o34) k)) (to_rep
                                    (select (elts temp___376) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o35 k) (<= k (- (to_rep1 (last (rt o34))) 1)))
  (= (to_rep (select (elts o34) (+ k 1))) (to_rep
                                          (select (elts temp___376) k))))))))))))
