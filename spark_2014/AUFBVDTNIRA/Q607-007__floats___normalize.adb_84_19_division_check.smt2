...
;; r2__post_axiom
  ...
  (! (=> (and (dynamic_invariant1 x1 true true true) (le (neg fliteral4) x1))
     (let ((result (r2 x1)))
     (=> (r2__function_guard result x1) (dynamic_invariant1 result true false
     true)))) :pattern ((r2 x1)) )))
...
;; r2__def_axiom
  ...
  (forall ((x1 t))
  (! (=>
     (and (dynamic_invariant1 x1 true true true) (r2__function_guard 
     (r2 x1) x1)) (= (r2 x1) (roundToIntegral RTN2 x1))) :pattern ((r2 x1)) )))
