...
(define-fun dynamic_invariant ((temp___expr_5178 us_t1)
  ...
  (temp___do_toplevel_5177 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_5178))
                                       (and (= (first3 temp___expr_5178) 1)
                                       (= (last4 temp___expr_5178) 1)))))
...
(define-fun dynamic_invariant1 ((temp___expr_5194 us_t2)
  ...
  (temp___do_toplevel_5193 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_5194))
                                       (and (= (first5 temp___expr_5194) 1)
                                       (= (last6 temp___expr_5194) 1)))))
...
;; H
  (assert
  (and
  (and (= temp___78432 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___78432 reg)) (dynamic_invariant1
  temp___78432 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___78431)) (to_rep (last5 temp___78431)))
     (+ (- (to_rep (last5 temp___78431)) (to_rep (first4 temp___78431))) 1)
     0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78431)) (to_rep (last5 temp___78431))) 
  temp___78441))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___78441)) (to_rep (last3 temp___78441)))
     (+ (- (to_rep (last3 temp___78441)) (to_rep (first2 temp___78441))) 1)
