...
(define-fun dynamic_invariant3 ((temp___expr_293 us_t)
...
(declare-fun temp___663 () (Array Int word32))

(declare-fun o () word32)

(declare-fun o1 () Int)

(declare-fun o2 () (Array Int word32))
...
;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___665 i1)))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___663 a)))

;; H
  (assert
  (=> (and (<= a_first i1) (<= i1 a_last))
  (forall ((k1 Int))
  (=> (and (<= a_first k1) (<= k1 (- i2 1)))
  (= (to_rep1 (select a2 k1)) ((_ int2bv 32) 0))))))
...
;; H
  ...
  (and
  (and
  (forall ((temp___664 Int))
  (=>
  (and (<= (to_rep a__first) temp___664) (<= temp___664 (to_rep a__last)))
  (=> (<= i2 temp___664)
  (= (select a2 temp___664) (select temp___663 temp___664)))))
  (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)))
  (and (<= a_first i2) (<= i2 a_last)))))

;; H
  (assert
  (=> (and (<= a_first i1) (<= i1 a_last)) (= (to_rep1 o) ((_ int2bv 32) 0))))
...
;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o1 i2)))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o2 (store a2 o1 o))))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a2 result1)))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a3 o2)))
...
(assert
;; WP_parameter_def
 ;; File "lsc-bignum.ads", line 59, characters 0-0
