...
(declare-fun temp___549 () (Array Int word32))
...
;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___551 i1)))

;; H
  (assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___549 a)))
...
;; H
  ...
  (=>
  (and (<= (to_rep a__first) temp___550) (<= temp___550 (to_rep a__last)))
  (=> (<= i2 temp___550)
  (= (select a2 temp___550) (select temp___549 temp___550)))))
