...
(declare-fun number_of_oranges (Int) Int)

(declare-fun number_of_oranges__function_guard (Int Int) Bool)
...
;; H
  (assert (in_range1 oranges_to_consume))
...
(assert
;; WP_parameter_def
 ;; File "fruit.adb", line 16, characters 0-0
  (not (in_range (- oranges oranges_to_consume))))
(check-sat)
