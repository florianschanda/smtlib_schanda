...
;; H
  (assert
  (and (= o37 (from_word32 carry22)) (from_word32__function_guard o37
  carry22)))
...
;; H
  (assert
  (and (= o38 (omultiply o36 o37)) (omultiply__function_guard o38 o36 o37)))

;; H
  (assert
  (and (= o35 (from_word32 carry12)) (from_word32__function_guard o35
  carry12)))

;; H
  (assert (and (= o39 (oadd o35 o38)) (oadd__function_guard o39 o35 o38)))
...
;; H
  (assert
  (and (and (= o29 (base Tuple0)) (base__function_guard o29 Tuple0))
  (= o29 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o34 (oexpon o29 o33)) (oexpon__function_guard o34 o29 o33)))

;; H
  (assert
  (and (= o40 (omultiply o34 o39)) (omultiply__function_guard o40 o34 o39)))
...
;; H
  (assert
  (and
  (= o28 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))
         a_first o27))
  (num_of_big_int__function_guard o28
  (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o27)))

;; H
  (assert (and (= o41 (oadd o28 o40)) (oadd__function_guard o41 o28 o40)))
...
;; H
  (assert
  (and (= o22 (from_word32 carry2)) (from_word32__function_guard o22 carry2)))

;; H
  (assert
  (and (and (= o21 (base Tuple0)) (base__function_guard o21 Tuple0))
  (= o21 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o23 (omultiply o21 o22)) (omultiply__function_guard o23 o21 o22)))

;; H
  (assert
  (and (= o20 (from_word32 carry1)) (from_word32__function_guard o20 carry1)))

;; H
  (assert (and (= o19 (from_word32 y)) (from_word32__function_guard o19 y)))
