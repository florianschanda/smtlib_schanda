...
(declare-fun temp___1008 () natural)

(declare-fun temp___10081 () (Array Int value))

(declare-fun temp___10082 () t1)
...
;; H
  (assert (= temp___1011 left1))

;; H
  (assert (= temp___1010 right1))

;; H
  (assert
  (and (= a__split_discrs (mk___split_discrs temp___1008))
  (and (= a__split_fields temp___10081) (= a__split_fields1 temp___10082))))
...
;; H
  ...
  true true)
  (= (rec__simple_unc_arrays__table__last a__split_discrs) temp___1008))
...
;; WP_parameter_def
 ;; File "simple_unc_arrays.ads", line 126, characters 0-0
  (not (in_range2 (- (int__content right13) 1))))
(check-sat)
