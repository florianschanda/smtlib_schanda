...
(declare-fun temp___4671 () unsigned_byte)

(declare-fun temp___4672 () unsigned_byte)
...
;; H
  (assert (= temp___467 o5))

;; H
  (assert (= temp___4671 o6))

;; H
  (assert (= temp___4672 o7))
...
;; H
  (assert
  (= r__split_fields3 (mk___split_fields1 temp___467
                      (mk___rep (mk___split_fields temp___4671 temp___4672)))))
