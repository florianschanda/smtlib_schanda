...
(declare-fun temp___9411 () Int)

(declare-fun result2 () int__ref)

(declare-fun temp___9401 () Int)
...
;; H
  ...
  (let ((temp___943 (to_rep
                    (rec__file_io__read_result__c
                    current_read__split_fields1))))
  (or (= temp___943 10)
  (or (= temp___943 13) (or (= temp___943 32) (= temp___943 9))))))))

;; H
  (assert (= result1 (mk_int__ref temp___941)))

;; H
  (assert (= temp___9411 next_idx1))

;; H
  (assert (= result2 (mk_int__ref temp___940)))
...
;; H
  ...
  (= (bool_eq5
     (mk___rep current_read__split_discrs2 current_read__split_fields2
     current_read__attr__constrained)
     (mk___rep next_read__split_discrs1 next_read__split_fields1
     next_read__attr__constrained)) true))
  (= current_idx2 next_idx1)) (<= current_idx1 current_idx2))
  (and
...
;; H
  ...
  (= o (ite (or
            (= (to_rep
               (rec__file_io__read_result__c current_read__split_fields2)) 10)
            (or
            (= (to_rep
               (rec__file_io__read_result__c current_read__split_fields2)) 13)
            (or
            (= (to_rep
               (rec__file_io__read_result__c current_read__split_fields2)) 32)
            (= (to_rep
               (rec__file_io__read_result__c current_read__split_fields2)) 9))))
       true false))))
...
;; WP_parameter_def
 ;; File "lexer.adb", line 291, characters 0-0
  (not
  (or (< temp___9411 next_idx2)
  (and (= next_idx2 temp___9411)
  (< (to_int1
     (= (to_rep1
        (rec__file_io__read_result__status next_read__split_discrs2)) 0)) 
  temp___9401)))))
(check-sat)
