...
(declare-fun o29 () color_type)

(declare-fun o30 () Int)

(declare-fun o31 () (Array Int color_type))

(declare-fun o32 () us_split_fields8)
...
(declare-fun o36 () color_type)

(declare-fun o37 () Int)

(declare-fun o38 () (Array Int color_type))

(declare-fun o39 () us_split_fields8)
...
(declare-fun result13 () us_split_fields__ref4)

(declare-fun t__split_fields11 () us_split_fields8)

(declare-fun result14 () us_split_fields__ref4)

(declare-fun t__split_fields12 () us_split_fields8)
...
;; H
  (assert
  (and
  (and (= o19 (color (mk___rep4 t__split_fields7) y6)) (color__function_guard
  o19 (mk___rep4 t__split_fields7) y6))
  (and (in_range6 o19)
  (= o19 (ite (= y6 0) 0
         (to_rep3
...
;; H
  (assert (parent__function_guard
  (parent (mk___rep3 search_trees__right_rotate__t__fields) o26)
  (mk___rep3 search_trees__right_rotate__t__fields) o26))
...
;; H
  (assert (position__function_guard1
  (position1 (mk___rep3 search_trees__right_rotate__t__fields) o26)
  (mk___rep3 search_trees__right_rotate__t__fields) o26))
...
;; H
  ...
  (mk___rep3
  (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields7)))
  o26 0)) (mk___rep3 search_trees__right_rotate__t__fields)
  (peek
  (mk___rep3
  (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields7)))
  o26 0)))
...
;; H
  ...
  (mk___rep3
  (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields7)))
  o26 0) 1)) (mk___rep3 search_trees__right_rotate__t__fields)
  (peek
  (mk___rep3
  (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields7)))
  (peek
...
;; H
  (assert (peek__function_guard
  (peek (mk___rep3 search_trees__right_rotate__t__fields) o26 0)
  (mk___rep3 search_trees__right_rotate__t__fields) o26 0))
...
;; H
  ...
  (mk___rep3
  (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields7)))
  o26)) (mk___rep3 search_trees__right_rotate__t__fields)
  (parent
  (mk___rep3
  (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields7)))
  o26)
...
;; H
  ...
  (parent
  (rec__red_black_trees__rbt__struct
  (us_split_fields__content4 t__split_fields9)) (int__content x4))
  (rec__red_black_trees__rbt__struct
  (us_split_fields__content4 t__split_fields9)) (int__content x4)))
...
;; H
  ...
  (parent
  (rec__red_black_trees__rbt__struct
  (us_split_fields__content4 t__split_fields9)) (int__content x4))) 1)
  (rec__red_black_trees__rbt__struct
  (us_split_fields__content4 t__split_fields9))
  (parent
  (rec__red_black_trees__rbt__struct
...
;; H
  ...
  (= (peek
     ...
     (parent
     (rec__red_black_trees__rbt__struct
     (us_split_fields__content4 t__split_fields9)) (int__content x4))) 1) 0)))
...
;; H
  (assert (and (<= 1 temp___1201) (<= temp___1201 100)))

;; H
  (assert (= o30 temp___1201))

;; H
  (assert
  (= o31 (store (rec__red_black_trees__rbt__color
                (us_split_fields__content4 t__split_fields9)) o30 o29)))

;; H
  (assert
  (= o32 (mk___split_fields4
         (rec__red_black_trees__rbt__struct
         (us_split_fields__content4 t__split_fields9)) o31)))

;; H
  (assert (= temp___1203 (mk___rep4 o32)))

;; H
  (assert (= result13 t__split_fields9))

;; H
  (assert (= t__split_fields11 (us_split_fields9 temp___1203)))
...
;; H
  (assert (size__function_guard
  (size (rec__red_black_trees__rbt__struct t__split_fields11))
...
;; H
  ...
  (and
  (and
  (= o34 (parent (rec__red_black_trees__rbt__struct t__split_fields11) o33))
  (parent__function_guard o34
  (rec__red_black_trees__rbt__struct t__split_fields11) o33))
  (and (in_range3 o34)
  (and
  (= o34 (parent1
         (rec__search_trees__search_tree__struct
         (us_split_fields7
         (rec__red_black_trees__rbt__struct t__split_fields11))) o33))
  (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields11)) 0)
  (= o34 0))))))
...
;; H
  ...
  (rec__red_black_trees__rbt__struct t__split_fields11) o35))
...
;; H
  (assert (and (<= 1 temp___1205) (<= temp___1205 100)))

;; H
  (assert (= o37 temp___1205))

;; H
  (assert
  (= o38 (store (rec__red_black_trees__rbt__color t__split_fields11) 
  o37 o36)))

;; H
  (assert
  (= o39 (mk___split_fields4
         (rec__red_black_trees__rbt__struct t__split_fields11) o38)))

;; H
  (assert (= temp___1207 (mk___rep4 o39)))

;; H
  (assert (= result14 (mk___split_fields__ref4 t__split_fields11)))

;; H
  (assert (= t__split_fields12 (us_split_fields9 temp___1207)))

;; H
  (assert (parent__function_guard1
  (parent1
  (rec__search_trees__search_tree__struct
  (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields12)))
  o40)
  (rec__search_trees__search_tree__struct
  (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields12)))
  o40))
...
;; H
  (assert (size__function_guard
  (size (rec__red_black_trees__rbt__struct t__split_fields12))
  (rec__red_black_trees__rbt__struct t__split_fields12)))
...
;; H
  ...
  (peek
  (mk___rep3
  (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields12))) j
  d)
  (mk___rep3
  (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields12))) j
  d)))
...
;; H
  ...
  (and
  (and
  (= o41 (parent (rec__red_black_trees__rbt__struct t__split_fields12) o40))
  (parent__function_guard o41
  (rec__red_black_trees__rbt__struct t__split_fields12) o40))
  (and (in_range3 o41)
  (and
  (= o41 (parent1
         (rec__search_trees__search_tree__struct
         (us_split_fields7
         (rec__red_black_trees__rbt__struct t__split_fields12))) o40))
  (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields12)) 0)
  (= o41 0))))))
...
;; H
  ...
  (and
  (and
  (= o43 (parent (rec__red_black_trees__rbt__struct t__split_fields12) o42))
  (parent__function_guard o43
  (rec__red_black_trees__rbt__struct t__split_fields12) o42))
  (and (in_range3 o43)
  (and
  (= o43 (parent1
         (rec__search_trees__search_tree__struct
...
;; H
  ...
  (ite (not
       (= (root
          (mk___rep3
          (us_split_fields7
          (rec__red_black_trees__rbt__struct t__split_fields12)))) o44))
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             (mk___rep3
             (us_split_fields7
             (rec__red_black_trees__rbt__struct t__split_fields12)))) j))) true))))
  (and
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j 100))
  (=>
  ...
  (= (oeq (values (mk___rep3 search_trees__left_rotate__t__fields))
     (values
     (mk___rep3
     (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields12))))) true)
  (and
  ...
  (= (peek (mk___rep3 search_trees__left_rotate__t__fields)
     ...
     o44)) (peek
           (mk___rep3
           (us_split_fields7
           (rec__red_black_trees__rbt__struct t__split_fields12))) o44 1)))
  (and
  (= (peek (mk___rep3 search_trees__left_rotate__t__fields)
     (peek
     (mk___rep3
...
;; H
  (assert
  (= t__split_fields13 (mk___split_fields4
                       (mk___rep3 search_trees__left_rotate__t__fields)
                       (rec__red_black_trees__rbt__color t__split_fields12))))

;; H
  (assert
  (= (mk___rep4 (us_split_fields__content4 t_old__split_fields9)) c105b))

;; H
  (assert (dynamic_invariant6 c105b true false true))

;; H
  (assert (= (mk___rep4 t__split_fields13) c106b))
...
;; H
  ...
  (us_split_fields7
  (rec__red_black_trees__rbt__struct
  (us_split_fields__content4 t_old__split_fields9)))) o45)
  (rec__search_trees__search_tree__struct
  (us_split_fields7
  (rec__red_black_trees__rbt__struct
  (us_split_fields__content4 t_old__split_fields9)))) o45))
...
;; H
  ...
  (us_split_fields7
  (rec__red_black_trees__rbt__struct
  (us_split_fields__content4 t_old__split_fields9)))) o47)
  (rec__search_trees__search_tree__struct
  (us_split_fields7
  (rec__red_black_trees__rbt__struct
  (us_split_fields__content4 t_old__split_fields9)))) o47))
...
;; H
  (assert
  (and (= red_black_trees__insert__L_8__C107b__assume o48) (in_range2 o48)))

;; H
  (assert (= red_black_trees__insert__L_8__C107b__assume c107b))

;; H
  (assert (in_range2 c107b))
...
;; H
  ...
  (and
  (and
  (= o49 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))
         c107b))
  (parent__function_guard o49
  (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) c107b))
  (and (in_range3 o49)
  (and
  (= o49 (parent1
...
;; H
  (assert
  (and (= red_black_trees__insert__L_8__B108b__y__assume o49) (in_range2
  o49)))

;; H
  (assert (= red_black_trees__insert__L_8__B108b__y__assume y3))
...
;; H
  (assert (model____function_guard
  (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c105b)))
  (rec__red_black_trees__rbt__struct (us_split_fields9 c105b))))
...
;; H
  (assert (nb_blacks__function_guard (nb_blacks c105b) c105b))

;; H
  (assert (nb_blacks__function_guard (nb_blacks c106b) c106b))
...
;; H
  ...
  (eq (select (nb_blacks c106b) i) (select (nb_blacks c105b) i))
  (select (nb_blacks c106b) i) (select (nb_blacks c105b) i))))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
             (rec__red_black_trees__rbt__struct (us_split_fields9 c105b))) i))) true)
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c105b) i)))) (let ((subject 
                                                        n1)) n12)))
  (not (= i y3))) (not (= i c107b)))
  (= (eq (select (nb_blacks c106b) i) (select (nb_blacks c105b) i)) true)))))
...
;; H
  ...
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c105b) c107b)))) (let ((subject 
                                                            n1)) n12))
  (and
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select (nb_blacks c106b) c107b))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select (nb_blacks c106b) c107b)))) (to_rep
                                                            (rec__red_black_trees__black_count__count
                                                            (us_split_fields11
                                                            (select (nb_blacks
                                                                    c105b) 
...
;; H
  ...
  (and
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select (nb_blacks c106b) y3))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select (nb_blacks c106b) y3)))) (to_rep
                                                         (rec__red_black_trees__black_count__count
                                                         (us_split_fields11
                                                         (select (nb_blacks
                                                                 c105b) 
...
;; H
  (assert
  (and (=> (<= 1 100) (in_range2 (let ((subject n1)) n12)))
  (and (<= 1 (let ((subject n1)) n12)) (<= (let ((subject n1)) n12) 100))))
