...
;; H
  (assert (number_of_apples__function_guard
  (number_of_apples apples oranges price_of_apple price_of_orange extra_cost)
  apples oranges price_of_apple price_of_orange extra_cost))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (<= o10 (number_of_apples apples oranges price_of_apple price_of_orange
          extra_cost))))
(check-sat)
