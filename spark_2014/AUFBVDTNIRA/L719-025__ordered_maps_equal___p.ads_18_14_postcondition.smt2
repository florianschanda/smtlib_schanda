...
(define-fun key_type__ref_4__projection ((a key_type__ref2)) us_rep4 
...
(define-fun default_initial_assumption2 ((temp___expr_377 us_rep2)
  (temp___skip_top_level_378 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_378 true))
                                         (= (length3 temp___expr_377) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_333 Int)
...
(define-fun dynamic_invariant5 ((temp___expr_339 Int)
...
;; keys_included_except__post_axiom
  ...
  (forall ((left us_rep1) (right us_rep1))
  (forall ((new_key Int))
  (! (=> (dynamic_invariant4 new_key true true true)
...
;; has_key__post_axiom
  ...
  (! (=> (= (of_int 0) true)
     (=>
     (exists ((k1 us_rep4))
     (and (= (has_key1 container k1) true) (= (bool_eq7 k1 key) true)))
...
(define-fun dynamic_invariant8 ((temp___expr_390 Int)
...
;; length__post_axiom
  (assert
  (forall ((container us_rep3)) (! (dynamic_invariant1 (length4 container)
...
;; H
  ...
  (= (length (mk___rep l__split_discrs l__split_fields6)) (+ (length
                                                             ...
                                                             (mk___split_fields
                                                             l__split_fields))) 1))
  (= (has_key (model__ (mk___rep l__split_discrs l__split_fields6)) k) true))
  (= (get1 (keys (mk___rep l__split_discrs l__split_fields6))
     (find (keys (mk___rep l__split_discrs l__split_fields6)) k)) k))
  ...
  (= (range_equal
     ...
     (keys (mk___rep l__split_discrs l__split_fields6)) 1
     (- (find (keys (mk___rep l__split_discrs l__split_fields6)) k) 1)) true))
  (= (range_shifted
     (keys (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (keys (mk___rep l__split_discrs l__split_fields6))
     (find (keys (mk___rep l__split_discrs l__split_fields6)) k)
     (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     1) true))
  (= (p_positions_shifted
     (positions
...
;; H
  ...
  (= (range_equal (keys (mk___rep l__split_discrs l__split_fields6))
     (keys (mk___rep l__split_discrs l__split_fields5)) 1
     (- (find (keys (mk___rep l__split_discrs l__split_fields6)) k) 1)) true))
  (= (range_shifted (keys (mk___rep l__split_discrs l__split_fields5))
     (keys (mk___rep l__split_discrs l__split_fields6))
     (find (keys (mk___rep l__split_discrs l__split_fields6)) k)
