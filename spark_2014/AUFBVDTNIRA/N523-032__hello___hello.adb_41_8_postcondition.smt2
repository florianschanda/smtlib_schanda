...
(declare-fun temp___599 () Bool)

(declare-fun temp___597 () (Array Int character))
...
;; H
  ...
  (<= idx1 (to_rep1 (last (rt str))))) (= temp___600 idx1)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= temp___599 to_up1)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= temp___597 ret1)))
...
;; H
  ...
  (=> (< idx2 temp___598)
  (= (select ret4 temp___598) (select temp___597 temp___598)))))
