...
(declare-fun temp___1105 () us_rep1)

(declare-fun temp___1104 () (_ BitVec 16))

(declare-fun temp___1103 () (_ BitVec 16))

(declare-fun temp___1102 () us_rep)
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r138b))
  (= temp___1105 (mk___rep1 u__split_discrs u__split_fields2))))
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r138b))
  (= temp___1102 (mk___rep quotient__split_discrs quotient__split_fields2))))
...
;; H
  (assert (dynamic_property2 1 last3 r140b))
...
;; H
  ...
  true)
  (forall ((temp___1114 Int))
  (=>
  (and
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))) temp___1114)
  (<= temp___1114 (to_rep2
                  (last1
                  (rt
                  (rec__very_longs__very_long__long_digits
                  remainder__split_fields3))))))
  (=> (<= divisor_index2 temp___1114)
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             remainder__split_fields3)) temp___1114) (select (elts
                                                             (rec__very_longs__very_long__long_digits
                                                             remainder__split_fields2)) temp___1114))))))
