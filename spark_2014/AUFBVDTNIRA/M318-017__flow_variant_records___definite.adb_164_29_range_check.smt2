...
(declare-datatypes () ((t49b__ref (mk_t49b__ref (t49b__content us_rep)))))
(define-fun t49b__ref___projection ((a t49b__ref)) us_rep (t49b__content a))
...
;; H
  (assert (= (to_rep1 x__split_discrs) r48b))

;; H
  (assert (in_range2 r48b))

(assert
;; WP_parameter_def
 ;; File "definite.adb", line 149, characters 0-0
  (not (in_range1 i)))
(check-sat)
