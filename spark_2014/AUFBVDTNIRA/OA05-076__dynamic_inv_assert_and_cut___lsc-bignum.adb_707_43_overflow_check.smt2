...
;; H
  (assert (and (= o26 (- e_last e_first)) (in_range1 (- e_last e_first))))

;; H
  (assert (and (= o27 o26) (uint_in_range1 o26)))

;; H
  (assert (= o28 ((_ int2bv 64) o27)))

;; H
  (assert (= o29 (bvadd o28 ((_ int2bv 64) 1))))

;; H
  (assert (= o30 (bvmul o29 ((_ int2bv 64) 32))))

;; H
  (assert (= o31 (ite (bvult i2 o30) true false)))
