...
(define-fun bool_eq5 ((a (Array Int us_rep)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq4 (select a temp___idx_136)
...
(declare-fun user_eq5 (enum1t enum1t) Bool)

(declare-fun dummy5 () enum1t)
...
(define-fun bool_eq8 ((a (Array Int us_rep1)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq7 (select a temp___idx_142)
...
(declare-fun temp___4210 ((Array Int us_rep1) Int
  us_rep1) (Array Int us_rep1))

;; def_axiom
  (assert
  (forall ((temp___4212 (Array Int us_rep1)))
  (forall ((temp___4213 Int))
  (forall ((temp___4214 us_rep1))
  (let ((temp___4211 (temp___4210 temp___4212 temp___4213 temp___4214)))
  (forall ((temp___4215 Int))
  (ite (= temp___4215 temp___4213)
  (= (select temp___4211 temp___4215) temp___4214)
  (= (select temp___4211 temp___4215) (select temp___4212 temp___4215)))))))))

(declare-fun temp___4217 ((Array Int us_rep) Int us_rep) (Array Int us_rep))

;; def_axiom
  (assert
  (forall ((temp___4219 (Array Int us_rep)))
  (forall ((temp___4220 Int))
  (forall ((temp___4221 us_rep))
  (let ((temp___4218 (temp___4217 temp___4219 temp___4220 temp___4221)))
  (forall ((temp___4222 Int))
  (ite (= temp___4222 temp___4220)
  (= (select temp___4218 temp___4222) temp___4221)
  (= (select temp___4218 temp___4222) (select temp___4219 temp___4222)))))))))
...
(declare-fun o11 () enum1t)

(declare-fun o12 () (Array Int us_rep1))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1858, characters 0-0
  (not
  (= (bool_eq8 a2 5 50
     (temp___4210 a i
     (mk___rep1
     (let ((usq_ (us_split_fields3 (select a i))))
     (mk___split_fields1
     (temp___4217 (rec__ar__rofaofr1__a1 (us_split_fields3 (select a i))) 
     j
     (mk___rep
     ...
     (us_split_fields1
     (select (rec__ar__rofaofr1__a1 (us_split_fields3 (select a i))) 
     j)))))) (rec__ar__rofaofr1__b1 usq_) (rec__ar__rofaofr1__c1 usq_))))) 5
     50) true)))
(check-sat)
