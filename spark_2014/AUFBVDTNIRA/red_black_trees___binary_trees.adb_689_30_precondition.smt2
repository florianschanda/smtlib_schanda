...
(declare-fun temp___2600 () (Array Int us_rep1))
...
(declare-fun o19 () position_type)

(declare-fun o20 () extended_index_type)

(declare-fun o21 () extended_index_type)

(declare-fun o22 () extended_index_type)

(declare-fun o23 () position_type)
...
(declare-fun o34 () extended_index_type)

(declare-fun o35 () position_type)

(declare-fun o36 () position_type)
...
;; H
  (assert
  (= (mk___rep1 (mk___split_fields1 o28 o29 o30 o31)) (select f_old__split_fields1 
  o27)))
...
;; H
  (assert
  (= (mk___rep1 (mk___split_fields1 o16 o17 o18 o19)) (select f__split_fields1 
  o15)))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2600 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2600 (parent
                      (mk___rep2
...
;; H
  ...
  (model____function_guard temp___2600
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  root))
  (and (dynamic_invariant3 temp___2600 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2600 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2600 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2600 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2600 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2600 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2600 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2600 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2600 j1)))) true))
  (= j1 i))))))))))))))
...
;; H
  (assert (= temp___2602 (to_rep o9)))

;; H
  (assert (and (<= 1 temp___2602) (<= temp___2602 100)))

;; H
  (assert (= o10 temp___2602))

;; H
  (assert
  (= (mk___rep (mk___split_fields o11 o12)) (select temp___2600 o10)))
