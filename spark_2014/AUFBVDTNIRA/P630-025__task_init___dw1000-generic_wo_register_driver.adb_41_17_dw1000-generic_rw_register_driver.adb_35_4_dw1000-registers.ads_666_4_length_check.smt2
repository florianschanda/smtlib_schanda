...
(define-fun dynamic_invariant ((temp___expr_7325 us_t1)
  ...
  (temp___do_toplevel_7324 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_7325))
                                       (and (= (first3 temp___expr_7325) 1)
                                       (= (last4 temp___expr_7325) 4)))))
...
(define-fun dynamic_invariant1 ((temp___expr_7353 us_t2)
  ...
  (temp___do_toplevel_7352 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_7353))
                                       (and (= (first5 temp___expr_7353) 1)
                                       (= (last6 temp___expr_7353) 4)))))
...
;; H
  (assert
  (and
  (and (= temp___80772 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___80772 reg)) (dynamic_invariant1
  temp___80772 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80771)) (to_rep (last5 temp___80771)))
     (+ (- (to_rep (last5 temp___80771)) (to_rep (first4 temp___80771))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80771)) (to_rep (last5 temp___80771))) 
  temp___80781))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___80781)) (to_rep (last3 temp___80781)))
     (+ (- (to_rep (last3 temp___80781)) (to_rep (first2 temp___80781))) 1)
