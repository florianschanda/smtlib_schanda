...
;; H
  (assert (=> (= result1 true) (= o36 (ite (= o35 true) o34 false))))
...
;; H
  (assert (=> (= result2 true) (= o29 (ite (= o28 0) true false))))
...
;; H
  (assert (=> (= result2 true) (= o31 (ite (= o30 true) o29 false))))
...
;; H
  (assert (=> (not (= result3 true)) (= o26 (of_int 1))))
...
;; H
  (assert (=> (not (= result4 true)) (= o24 (of_int 1))))
...
;; H
  (assert (=> (not (= result7 true)) (= o11 (of_int 1))))
...
;; H
  (assert (=> (= result8 true) (= o3 (ite (= o2 3) true false))))
...
;; H
  (assert (=> (= result8 true) (= o8 (ite (= o7 false) o6 true))))
