...
;; H
  (assert (and (= o8 (- length2 j2)) (in_range1 (- length2 j2))))

;; H
  (assert (and (= o9 o8) (in_range2 o8)))

;; H
  (assert (and (= o7 (+ i2 j2)) (in_range1 (+ i2 j2))))
...
;; H
  (assert (and (= o3 (to_rep b__first)) (in_range2 (to_rep b__first))))

;; H
  (assert
  (and
  (= o10 (le_array (mk___t b (mk (to_rep b__first) (to_rep b__last)))
         (mk___t a (mk (to_rep a__first) (to_rep a__last))) o3 o6 o7 
         o9))
  (le_array__function_guard o10
  (mk___t b (mk (to_rep b__first) (to_rep b__last)))
  (mk___t a (mk (to_rep a__first) (to_rep a__last))) o3 o6 o7 o9)))

;; H
  (assert (and (= o1 (- length1 i2)) (in_range1 (- length1 i2))))
