...
;; H
  ...
  (us_split_fields5
  (rec__algorithm__controller__robot
  (let ((subject this__split_fields)) this__split_fields2))))) temp___1080))))
...
;; H
  (assert (= result14 (ite (lt o48 o47) true false)))
