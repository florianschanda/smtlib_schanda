...
;; size__post_axiom
  (assert
  (forall ((f us_rep3))
  (! (=> (type_invariant f) (dynamic_invariant2 (size f) true false true)) :pattern (
  (size f)) )))
...
;; position__post_axiom
  ...
  (! (=>
     ...
     (not (= (parent f i) 0))) (dynamic_invariant3 (position f i) true false
...
(define-fun default_initial_assumption2 ((temp___expr_259 us_rep2)
...
(define-fun default_initial_assumption3 ((temp___expr_266 (Array Int us_rep2))
...
(declare-fun temp___975 () extended_index_type)

(declare-fun temp___9751 () (Array Int us_rep2))
...
;; H
  (assert
  (and (= (tree_structure (mk___rep2 f__split_fields8)) true)
  (= (tree_structure (mk___rep2 f_old__split_fields7)) true)))
...
;; H
  (assert
  (= (tree_structure
     (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
