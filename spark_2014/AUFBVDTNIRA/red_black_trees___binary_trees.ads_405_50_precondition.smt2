...
(declare-fun oeq__function_guard (Bool (Array Int us_rep1)
...
(define-fun dynamic_invariant1 ((temp___expr_216 (Array Int us_rep1))
...
(define-fun default_initial_assumption ((temp___expr_219 (Array Int us_rep1))
...
;; oeq__def_axiom
  ...
  (! (=> (oeq__function_guard (oeq m1 m2) m1 m2)
     (= (= (oeq m1 m2) true)
     (forall ((i Int))
     (=> (and (<= 1 i) (<= i 100))
     (and
     (= (oeq1
        (rec__tree_model__path_type__a (us_split_fields1 (select m1 i)))
...
(declare-fun dummy4 () position_type)
...
(define-fun bool_eq7 ((a (Array Int us_rep2)) (a__first Int) (a__last Int)
...
(declare-fun dummy6 () (Array Int us_rep2))
...
(define-fun default_initial_assumption2 ((temp___expr_265 us_rep2)
...
(define-fun default_initial_assumption3 ((temp___expr_272 (Array Int us_rep2))
...
(define-fun default_initial_assumption4 ((temp___expr_207 us_rep1)
...
(define-fun default_initial_assumption5 ((temp___expr_199 us_rep)
...
(declare-fun o3 () (Array Int us_rep2))

(declare-fun temp___1500 () extended_index_type)

(declare-fun temp___15001 () (Array Int us_rep2))
...
(declare-fun result () extended_index_type)

(declare-fun result1 () (Array Int us_rep2))

(declare-fun f_old__split_fields2 () extended_index_type)

(declare-fun f_old__split_fields3 () (Array Int us_rep2))

(declare-fun result2 () extended_index_type)

(declare-fun result3 () (Array Int us_rep2))

(declare-fun f__split_fields2 () extended_index_type)

(declare-fun f__split_fields3 () (Array Int us_rep2))

(declare-fun result4 () Int)

(declare-fun root1 () Int)

(declare-fun f__split_fields4 () extended_index_type)

(declare-fun f__split_fields5 () (Array Int us_rep2))

(declare-fun root2 () Int)

(declare-fun f_old__split_fields4 () extended_index_type)

(declare-fun f_old__split_fields5 () (Array Int us_rep2))

(declare-fun f__split_fields6 () extended_index_type)

(declare-fun f__split_fields7 () (Array Int us_rep2))

(declare-fun root3 () Int)

(declare-fun f_old__split_fields6 () us_split_fields4)
...
(define-fun f__split_fields8 () us_split_fields4 (mk___split_fields2
                                                 f__split_fields2
                                                 f__split_fields3))

(define-fun f_old__split_fields7 () us_split_fields4 (mk___split_fields2
                                                     f_old__split_fields2
                                                     f_old__split_fields3))
...
;; H
  ...
  (model__ (mk___rep2 f_old__split_fields7) r)
  (mk___rep2 f_old__split_fields7) r)))

;; H
  (assert
  (forall ((r Int)) (model____function_guard
  (model__ (mk___rep2 f__split_fields8) r) (mk___rep2 f__split_fields8) r)))
...
;; H
  (assert
  (forall ((r Int)) (oeq__function_guard
  (oeq (model__ (mk___rep2 f_old__split_fields7) r)
  (model__ (mk___rep2 f__split_fields8) r))
  (model__ (mk___rep2 f_old__split_fields7) r)
  (model__ (mk___rep2 f__split_fields8) r))))

;; H
  (assert (model____function_guard
  (model__ (mk___rep2 f__split_fields8) root1) (mk___rep2 f__split_fields8)
  root1))

;; H
  (assert
  (= (mk___split_fields__ref2 (mk___split_fields2 result result1)) (mk___split_fields__ref2
                                                                   (mk___split_fields2
                                                                   f_old__split_fields
                                                                   f_old__split_fields1))))
...
;; H
  (assert
  (and (= o (+ (to_rep f__split_fields) 1)) (in_range2
  (+ (to_rep f__split_fields) 1))))
...
;; H
  (assert (= temp___1500 o2))

;; H
  (assert (= temp___15001 o3))

;; H
  (assert
  (= (mk___split_fields__ref2 (mk___split_fields2 result2 result3)) (mk___split_fields__ref2
                                                                    (mk___split_fields2
                                                                    f__split_fields
                                                                    f__split_fields1))))

;; H
  (assert (= temp___1500 f__split_fields2))

;; H
  (assert (= temp___15001 f__split_fields3))

;; H
  (assert
  (and (= o4 (to_rep f__split_fields2)) (in_range1
  (to_rep f__split_fields2))))
...
;; H
  (assert
  (and (type_invariant (mk___rep2 f__split_fields8)) (type_invariant
  (mk___rep2 f_old__split_fields7))))

;; H
  (assert
  (and
  (forall ((r Int))
  (=> (and (<= 1 r) (<= r (to_rep f_old__split_fields2)))
  (=>
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3 (select f_old__split_fields3 r)))) 2)
  (= (oeq (model__ (mk___rep2 f_old__split_fields7) r)
     (model__ (mk___rep2 f__split_fields8) r)) true))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root1))
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 f__split_fields8) root1) i1))) true)))))))
...
;; H
  (assert
  (= (mk___split_fields2 f__split_fields6 f__split_fields7) f__split_fields8))

;; H
  (assert (type_invariant
  (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))))
...
;; H
  ...
  (= o7 (size
        (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))))
  (size__function_guard o7
  (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))))
  (and (in_range2 o7) (= o7 (to_rep f__split_fields4)))))
...
;; H
  ...
  (= o6 (valid_root
        (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
        root2))
  (valid_root__function_guard o6
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root2))
  (and
  (= (= o6 true)
  (and (<= root2 (to_rep f__split_fields))
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3 (select f__split_fields1 root2)))) 2)))
  (=>
  (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 
  root2) (not (= o6 true))))))
...
;; H
  (assert (size__function_guard
  (size (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)))
  (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))))
...
;; H
  ...
  (= result7 (valid_root
             (mk___rep2
             (mk___split_fields2 f__split_fields4 f__split_fields5)) 
             root2))
  (valid_root__function_guard result7
  (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) 
  root2))
  (and
  (= (= result7 true)
  (and (<= root2 (to_rep f__split_fields4))
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3 (select f__split_fields5 root2)))) 2)))
  (=>
  (< (size
     (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) 
  root2) (not (= result7 true))))))
...
;; H
  ...
  (parent (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))
  i1) (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i1)))
...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 100))
  (= (parent
     (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i1) 
  (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1))))))
...
;; H
  ...
  (not
  (= (parent
     (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i1) 0))
  (= (position
     (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i1) 
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1)))))))
...
;; H
  ...
  (=>
  (= (valid_root
     (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) true)
  (= (valid_root
     (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i1) true))))))
...
;; H
  ...
  (= result12 (valid_root
              ...
              i))
  (valid_root__function_guard result12
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i))
  (and
  (= (= result12 true)
  (and (<= i (to_rep f__split_fields))
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3 (select f__split_fields1 i)))) 2)))
  (=>
  (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 
  i) (not (= result12 true))))))
...
;; H
  ...
  (select o5 (parent
             (mk___rep2
             (mk___split_fields2 f__split_fields f__split_fields1)) i1))))
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1) (rec__tree_model__path_type__a (us_split_fields1 (select o5 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select o5 (parent
             (mk___rep2
...
;; H
  ...
  (= o5 (model__
        (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) 
        i))
  (model____function_guard o5
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i))
  (and (dynamic_invariant1 o5 true false true)
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 i))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select o5 i)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 i))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select o5 (parent
                     ...
                     (mk___split_fields2 f__split_fields f__split_fields1))
                     i1)))) true))
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 i1))) true)
  (not
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 i1))) true))))))
  (and
  (forall ((i1 Int))
  ...
  (= (is_add
     ...
     (position
     (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)
     (rec__tree_model__path_type__a (us_split_fields1 (select o5 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select o5 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 i1))) true)
  ...
  (=>
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 j))) true)
  (= (oeq1 (rec__tree_model__path_type__a (us_split_fields1 (select o5 i1)))
     (rec__tree_model__path_type__a (us_split_fields1 (select o5 j)))) true))
  (= j i1))))))))))))))
...
;; H
  ...
  (valid_root
  (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) 
  i) (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) 
  i))
