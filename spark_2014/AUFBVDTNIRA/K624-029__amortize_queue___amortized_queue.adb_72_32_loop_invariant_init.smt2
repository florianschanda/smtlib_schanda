...
(define-fun front__split_fields2 () us_split_fields (mk___split_fields
                                                    front__split_fields1))
...
;; H
  (assert
  (= front__split_fields2 amortized_queue__my_vectors__append__2__container__fields1))

(assert
;; WP_parameter_def
 ;; File "amortized_queue.ads", line 41, characters 0-0
  (not
  (= (length (mk___rep front__split_discrs front__split_fields2)) (+ (- (+ 
  (length ofront) (last
                  (model__
                  (mk___rep rear__split_discrs
                  (mk___split_fields rear__split_fields))))) idx1) 1))))
(check-sat)
