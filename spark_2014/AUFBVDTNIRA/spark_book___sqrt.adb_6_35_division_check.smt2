...
;; H
  (assert (= approx1 (div1 RNE1 x fliteral2)))
...
;; H
  (assert (= result1 (ite (lt tolerance o3) true false)))
...
;; H
  ...
  tolerance (abs1 (sub RNE1 x (mul RNE1 approx2 approx2))))))
