...
;; H
  (assert (= approx1 (div1 RNE2 x fliteral2)))

;; H
  (assert
  (and (= o (mul RNE2 approx1 approx1)) (tqtisFinite
  (mul RNE2 approx1 approx1))))

;; H
  (assert (= o1 (sub RNE2 x o)))
...
;; H
  ...
  tolerance (abs1 (sub RNE2 x (mul RNE2 approx2 approx2))))))
