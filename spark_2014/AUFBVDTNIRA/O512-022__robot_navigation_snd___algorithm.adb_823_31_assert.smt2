...
(declare-fun temp___992 () us_rep10)
...
(declare-fun temp___994 () us_rep10)
...
(declare-fun temp___988 () us_rep10)
...
(declare-fun temp___990 () us_rep10)
...
(declare-fun temp___986 () us_rep10)
...
;; H
  (assert
  (=> (= result2 true) (=> (= result4 true) (= o8 (create__2 fliteral4)))))
...
;; H
  ...
  (=> (not (= result2 true))
  (=> (= result6 true)
  (=> (= result8 true) (= o15 (create__2 (neg fliteral4)))))))
