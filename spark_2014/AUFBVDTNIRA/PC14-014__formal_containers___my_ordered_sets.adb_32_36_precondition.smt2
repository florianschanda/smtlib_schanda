...
;; H
  (assert
  (and (= o3 (floor (mk___rep l__split_discrs l__split_fields8) 3))
  (ite (= (ite (= (= (length (mk___rep l__split_discrs l__split_fields8)) 0) false) (< 3 
  ...
  (not
  (< 3 (get1 (elements (mk___rep l__split_discrs l__split_fields8))
