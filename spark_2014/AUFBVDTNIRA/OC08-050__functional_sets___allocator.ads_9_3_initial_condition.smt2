...
;; all_available__def_axiom
  ...
  (! (=> (all_available__function_guard (all_available allocator__data)
     allocator__data)
...
;; def_axiom
  ...
  (= (select (allocator__data__aggregate_def temp___461) temp___462) 
  (of_rep temp___461)))))
...
;; H
  (assert (= o (allocator__data__aggregate_def 0)))
