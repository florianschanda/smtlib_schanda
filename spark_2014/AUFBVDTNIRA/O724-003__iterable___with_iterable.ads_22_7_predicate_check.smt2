...
(define-fun t14s__ref___projection ((a1 t14s__ref)) us_rep1 (t14s__content
                                                            a1))

(define-fun dynamic_predicate1 ((temp___186 us_rep1)) Bool (and
                                                           (<= 1 (to_rep
                                                                 (rec__with_iterable__cursor__i
                                                                 (us_split_fields3
                                                                 temp___186))))
...
(define-fun o11 () us_rep1 (mk___rep1 (mk___split_discrs o6)
