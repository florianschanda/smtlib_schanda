...
;; H
  (assert (lt x
  (add RNE2 (div1 RNE2 (power fliteral2 (- n 2)) fliteral3) fliteral)))

;; H
  (assert (lt y
  (add RNE2 (div1 RNE2 (power fliteral2 (- n 1)) fliteral3) fliteral)))
...
;; WP_parameter_def
 ;; File "floating_point.adb", line 55, characters 0-0
  (not (lt res1
  (add RNE2 (div1 RNE2 (power fliteral2 n) fliteral3) fliteral))))
(check-sat)
