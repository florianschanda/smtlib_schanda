...
;; H
  ...
  (=> (and (<= 1 h1) (<= h1 10))
  (or
  (and (and (= k9 (mk_int__ref k4)) (= k10 k4))
  (and (= temp___139 1)
  (and (= temp___140 10)
  (and (and (= k2 result1) (= k3 temp___139))
  (and (and (<= temp___139 k3) (<= k3 temp___140))
  (and (= temp___138 k3)
  (and (<= k4 x)
  (and (and (=> (<= 1 10) (in_range4 k4)) (and (<= 1 k4) (<= k4 10)))
  (and (< k4 y) (and (< k4 z) (< z y)))))))))))
  (and
  (and (and (= k2 result1) (= k3 1))
  (ite (and (<= 1 k3) (<= k3 10))
  (and
  (and
  (and (= temp___138 k3)
  (and (<= k4 x)
  (and (and (=> (<= 1 10) (in_range4 k4)) (and (<= 1 k4) (<= k4 10)))
  (and (=> (< k4 y) (=> (< k4 z) (not (< z y)))) (= k4 10)))))
  (and (= k4 k5) (= k6 k4))) (and (= k7 (mk_int__ref k5)) (= k8 k6)))
  (and (= k7 (mk_int__ref k3)) (= k8 k3))))
  (and (and (= k9 k7) (= k10 k8)) (= h2 10))))))
...
;; H
  (assert (=> (and (<= 1 h1) (<= h1 10)) (= k13 k11)))

;; H
  (assert (=> (and (<= 1 h1) (<= h1 10)) (= h5 h3)))

;; H
  (assert (=> (and (<= 1 h1) (<= h1 10)) (= k14 k12)))

;; H
  (assert (=> (and (<= 1 h1) (<= h1 10)) (= h6 h4)))

;; H
  (assert (=> (not (and (<= 1 h1) (<= h1 10))) (= k13 (mk_int__ref k))))

;; H
  (assert (=> (not (and (<= 1 h1) (<= h1 10))) (= h5 (mk_int__ref h1))))

;; H
  (assert (=> (not (and (<= 1 h1) (<= h1 10))) (= k14 k1)))
