...
(declare-fun o4 () nonnegative_float)

(declare-fun o5 () us_split_fields18)

(declare-fun o6 () us_rep9)

(declare-fun o7 () (Array Int us_rep9))

(declare-fun o8 () us_split_fields20)

(declare-fun temp___941 () us_rep10)
...
;; H
  ...
  (= (rec__algorithm__controller__robot
     (let ((subject this__split_fields)) this__split_fields2)) (rec__algorithm__controller__robot
                                                               ...
                                                               this__split_fields))
                                                               this__split_fields1)))
  (forall ((temp___949 Int))
  (=> (and (<= 1 temp___949) (<= temp___949 1000))
  (=> (<= (let ((subject i)) i2) temp___949)
  (= (select (rec__algorithm__controller__laserscan
             (let ((subject this__split_fields)) this__split_fields2)) temp___949) (select 
  (rec__algorithm__controller__laserscan
  (let ((subject this__split_fields)) this__split_fields1)) temp___949))))))
  (= (rec__algorithm__controller__gapvec
...
;; H
  ...
  (= o3 (getrange
        ...
        (let ((subject this__split_fields)) this__split_fields2))
        (let ((subject i)) i2)))
  (getrange__function_guard o3
  (rec__algorithm__controller__robot
  (let ((subject this__split_fields)) this__split_fields2))
  (let ((subject i)) i2))) (in_range7 o3)))

;; H
  (assert (= (to_rep4 o4) o3))

;; H
  (assert
  (= o5 (mk___split_fields9 o4
        (rec__algorithm__laser_scan_data__second
        (us_split_fields19
        (select (rec__algorithm__controller__laserscan
                (let ((subject this__split_fields)) this__split_fields2)) 
...
;; H
  (assert (= o6 (mk___rep9 o5)))

;; H
  (assert
  (= o7 (store (rec__algorithm__controller__laserscan
               (let ((subject this__split_fields)) this__split_fields2)) 
  (let ((subject i)) i2) o6)))
...
;; H
  ...
  (= o8 (mk___split_fields10
        (rec__algorithm__controller__robot
        (let ((subject this__split_fields)) this__split_fields2)) o7
        (rec__algorithm__controller__gapvec
        (let ((subject this__split_fields)) this__split_fields2))
        (rec__algorithm__controller__obsavoiddelta
        (let ((subject this__split_fields)) this__split_fields2))
...
;; H
  (assert (= temp___941 (mk___rep10 o8)))
...
;; WP_parameter_def
 ;; File "algorithm.ads", line 107, characters 0-0
  ...
  (of_int RNE2
  (- (- (let ((subject i)) i2) 1) (div1 (let ((subject inumlps)) inumlps1) 2)))))))
(check-sat)
