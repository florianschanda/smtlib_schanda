...
(declare-fun temp___900 () read_status)

(declare-fun temp___9001 () character)

(declare-fun temp___9002 () Bool)
...
(declare-fun temp___896 () read_status)

(declare-fun temp___8961 () character)

(declare-fun temp___8962 () Bool)

(declare-fun temp___905 () Int)

(declare-fun temp___9051 () Int)
...
(declare-fun temp___9052 () Int)

(declare-fun result () int__ref)

(declare-fun temp___9053 () Int)
...
(declare-fun temp___9054 () int__ref)
...
(declare-fun temp___9056 () int__ref)
...
(declare-fun temp___9058 () int__ref)
...
(define-fun temp___90510 () int__ref (mk_int__ref temp___905))
...
;; H
  ...
  next_read__split_discrs5 next_idx5) the_file5 current_read__split_fields5
  current_read__split_discrs5 current_idx5 next_read__split_fields5
  next_read__split_discrs5 next_idx5))
...
;; H
  (assert (= temp___902 next_idx))

;; H
  (assert (= temp___901 the_file))

;; H
  (assert (= temp___903 current_idx))

;; H
  (assert
  (and (= temp___900 next_read__split_discrs)
  (and (= temp___9001 next_read__split_fields)
  (= temp___9002 next_read__attr__constrained))))

;; H
  (assert (= temp___899 current_idx))

;; H
  (assert (= temp___898 current_col))

;; H
  (assert (= temp___897 current_line))

;; H
  (assert
  (and (= temp___896 current_read__split_discrs)
  (and (= temp___8961 current_read__split_fields)
  (= temp___8962 current_read__attr__constrained))))
...
;; H
  ...
  (and
  (and
  (and (= temp___9054 (mk_int__ref temp___9053))
...
;; H
  ...
  (int__content next_idx22)) (file__content the_file22)
  (us_split_fields__content current_read__split_fields22)
  (us_split_discrs__content current_read__split_discrs22)
  (int__content current_idx22)
  (us_split_fields__content next_read__split_fields22)
  (us_split_discrs__content next_read__split_discrs22)
  (int__content next_idx22)))
