...
(declare-datatypes ()
((t152b__ref (mk_t152b__ref (t152b__content integer)))))
...
(declare-datatypes ()
((t156b__ref (mk_t156b__ref (t156b__content integer)))))
...
(declare-datatypes ()
((t158b__ref (mk_t158b__ref (t158b__content integer)))))
...
;; def_axiom
  (assert
  (forall ((temp___1546 Int) (temp___1547 Int) (temp___1548 Int)
  (temp___1549 Int) (temp___1550 Int) (temp___1551 Int) (temp___1552 Int)
  (temp___1553 Int) (temp___1554 Int) (temp___1555 Int) (temp___1556 Int)
  (temp___1557 Int))
  (let ((temp___1545 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__aggregate_def
                     temp___1546 temp___1547 temp___1548 temp___1549
                     temp___1550 temp___1551 temp___1552 temp___1553
                     temp___1554 temp___1555 temp___1556 temp___1557)))
  (and
  (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1556
  temp___1557)
  (and (= (first7 temp___1545) temp___1556)
  (= (last7 temp___1545) temp___1557)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___1545) (+ (first1 source) 0)) (of_rep1
                                                            temp___1546))
  (= (select (to_array2 temp___1545) (+ (first1 source) 1)) (of_rep1
                                                            temp___1547)))
  (= (select (to_array2 temp___1545) (+ (first1 source) 2)) (of_rep1
                                                            temp___1548)))
  (= (select (to_array2 temp___1545) (+ (first1 source) 3)) (of_rep1
                                                            temp___1549)))
  (= (select (to_array2 temp___1545) (+ (first1 source) 4)) (of_rep1
                                                            temp___1550)))
  (= (select (to_array2 temp___1545) (+ (first1 source) 5)) (of_rep1
                                                            temp___1551)))
  (= (select (to_array2 temp___1545) (+ (first1 source) 6)) (of_rep1
                                                            temp___1552)))
  (= (select (to_array2 temp___1545) (+ (first1 source) 7)) (of_rep1
                                                            temp___1553)))
  (= (select (to_array2 temp___1545) (+ (first1 source) 8)) (of_rep1
                                                            temp___1554)))
  (= (select (to_array2 temp___1545) (+ (first1 source) 9)) (of_rep1
                                                            temp___1555)))))))
...
;; def_axiom
  (assert
  (forall ((temp___1563 Int) (temp___1564 Int) (temp___1565 Int))
  (let ((temp___1562 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__aggregate_def
                     temp___1563 temp___1564 temp___1565)))
  (and
  (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1564
  temp___1565)
  (and (= (first13 temp___1562) temp___1564)
  (= (last13 temp___1562) temp___1565)))
  (forall ((temp___1566 Int))
  (= (select (to_array4 temp___1562) temp___1566) (of_rep1 temp___1563)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_277 us_t3)
  ...
  (temp___do_toplevel_276 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 9)
                                      (first10 temp___expr_277)
                                      (last10 temp___expr_277))
                                      (and
                                      (= (first10 temp___expr_277) (first1
                                                                   source))
                                      (= (last10 temp___expr_277) (+ 
                                      (first1 source) 9))))))
...
(declare-fun temp___1560 () (Array Int integer))

(declare-fun temp___15601 () t2)

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume1 () t1)

(declare-fun temp___1568 () (Array Int integer))

(declare-fun temp___15681 () t4)

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume1 () t3)
...
;; H
  ...
  (= (to_rep1
     (first6
     (rt2
     (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__aggregate_def
     2 1 4 7 3 9 9 9 9 9 (to_rep1 (first (rt source)))
...
;; H
  (assert
  (= (mk___t2 temp___1560 temp___15601) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__aggregate_def
                                        2 1 4 7 3 9 9 9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___15601)) (to_rep1 (last6 temp___15601)))
     (+ (- (to_rep1 (last6 temp___15601)) (to_rep1 (first6 temp___15601))) 1)
...
;; H
  (assert
  (= (slide1 temp___1560 (to_rep1 (first6 temp___15601))
     (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume))

;; H
  (assert
  (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) 
  aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume1))
...
;; H
  (assert
  (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume))
...
;; H
  (assert
  (= (mk___t4 temp___1568 temp___15681) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__aggregate_def
                                        0 (to_rep1 (first (rt source)))
                                        (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___15681)) (to_rep1
                                               (last12 temp___15681)))
     (+ (- (to_rep1 (last12 temp___15681)) (to_rep1 (first12 temp___15681))) 1)
     0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1
                                                  (first (rt source))) 9))
        (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1
                                                  (first (rt source)))) 1)
...
;; H
  (assert
  (= (slide1 temp___1568 (to_rep1 (first12 temp___15681))
     (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume))

;; H
  (assert
  (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) 
  aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume1))
...
;; H
  (assert
  (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume))
...
;; H
  (assert
  (and (= temp___1575 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))
...
;; H
  ...
  (and
  (and
  (forall ((temp___1572 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___1572)
  (<= temp___1572 (to_rep1 n__last)))
  (=> (< index2 temp___1572)
  (= (select n3 temp___1572) (select n1 temp___1572)))))
