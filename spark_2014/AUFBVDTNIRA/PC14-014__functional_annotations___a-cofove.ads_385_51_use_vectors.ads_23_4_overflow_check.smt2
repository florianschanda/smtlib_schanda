...
(declare-fun dummy6 () tcount_typeB)
...
(define-fun dynamic_invariant3 ((temp___expr_233 us_rep)
...
(define-fun dynamic_invariant4 ((temp___expr_227 Int)
...
;; length__post_axiom
  ...
  (! (=> (dynamic_invariant3 container true true true)
...
;; H
  ...
  (and (dynamic_property1 first1 last1 o4)
  (= o4 (last4
        (model__
        (mk___rep container__split_discrs
        (mk___split_fields container__split_fields)))))))))
...
;; H
  (assert
  (=> (not (= before no_index))
  (and (= o5 (- before 1)) (in_range1 (- before 1)))))

;; H
  (assert (=> (not (= before no_index)) (= o6 (ite (= o5 o4) true false))))

;; H
  (assert (=> (not (not (= before no_index))) (= o6 false)))
...
;; H
  (assert (= o7 (ite (<= first before) o3 false)))
...
(assert
;; WP_parameter_def
 ;; File "a-cofove.ads", line 345, characters 0-0
  (not (in_range2 o1)))
(check-sat)
