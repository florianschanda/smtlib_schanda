...
;; H
  ...
  (=> (and (<= first4 j2) (<= j2 i3))
  (= (to_rep
     (select (elts (to__ (mk___rep s__split_fields4))) (+ (- j2 first4) 1))) 
  (get (model__ l) j2)))))))
...
;; H
  ...
  i9) 1)))
  (forall ((j2 Int))
  (=> (and (<= 1 j2) (<= j2 (+ (- last6 i9) 1)))
  (= (to_rep (select (elts (to__ (mk___rep s__split_fields9))) j2)) (to_rep
                                                                    (select 
                                                                    (elts
                                                                    (to__
                                                                    (mk___rep
                                                                    ...
                                                                    s__split_fields7)))) j2))))))
  (forall ((j2 Int))
  (=> (and (<= first4 j2) (<= j2 (- i9 1)))
  (= (get (model__ (mk___rep1 res__split_discrs res__split_fields2)) j2) 
  (get (model__ l) (+ (- last6 j2) first4)))))))
...
;; H
  (assert (and (= o13 (- i9 first4)) (in_range1 (- i9 first4))))

;; H
  (assert
  (and (= o14 (length2 (mk___rep1 res__split_discrs res__split_fields2)))
  (and (in_range6 o14)
  (<= o14 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))

;; H
  (assert (= result6 (ite (= o14 o13) true false)))

;; H
  (assert
  (=> (= result6 true) (and (= o9 (- last6 i9)) (in_range1 (- last6 i9)))))

;; H
  (assert (=> (= result6 true) (= o10 (+ o9 1))))

;; H
  (assert (=> (= result6 true) (and (= o11 o10) (in_range1 o10))))

;; H
  (assert
  (=> (= result6 true)
  (and
  (and (= o8 (to__ (mk___rep s__split_fields9))) (to____function_guard 
  o8 (mk___rep s__split_fields9)))
  (and (dynamic_invariant1 o8 true false true)
  (and (= (to_rep (first (rt o8))) 1) (<= 0 (to_rep (last (rt o8)))))))))

;; H
  (assert (=> (= result6 true) (= o12 (to_rep (last (rt o8))))))

;; H
  (assert (=> (= result6 true) (= result5 (ite (= o12 o11) true false))))
...
;; H
  (assert
  (=> (= result5 true) (and (= o4 (- last6 i9)) (in_range1 (- last6 i9)))))

;; H
  (assert (=> (= result5 true) (= o5 (+ o4 1))))

;; H
  (assert (=> (= result5 true) (and (= o6 o5) (in_range1 o5))))

;; H
  (assert (=> (= result5 true) (= o7 (ite (<= j1 o6) true false))))

;; H
  (assert (=> (= result5 true) (= result7 (ite (<= 1 j1) o7 false))))
