...
;; H
  (assert
  (=> (= result1 true) (and (= temp___154 (+ y l)) (in_range1 (+ y l)))))

;; H
  (assert (=> (= result1 true) (and (<= 1 temp___154) (<= temp___154 1000))))

;; H
  (assert (=> (= result1 true) (= o2 temp___154)))
...
;; H
  (assert
  (=> (= result1 true) (and (= temp___153 (+ x l)) (in_range1 (+ x l)))))

;; H
  (assert (=> (= result1 true) (and (<= 1 temp___153) (<= temp___153 1000))))

;; H
  (assert (=> (= result1 true) (= o temp___153)))
...
;; H
  ...
  (and (and (<= (+ x l1) 1000) (<= (+ y l1) 1000))
  (= (to_rep (select a (+ x l1))) (to_rep (select a (+ y l1)))))))
