...
;; H
  (assert
  (and (= o44 (+ 48 (div1 localvalue4 10))) (in_range3
...
;; H
  (assert (= o46 (store localtext7 1 o45)))

;; H
  (assert (= result11 (mk_map__ref localtext7)))

;; H
  (assert (= localtext8 o46))

;; H
  (assert (= (to_rep o47) (+ 48 (mod2 localvalue4 10))))

;; H
  (assert (= o48 (store localtext8 2 o47)))

;; H
  (assert (= result12 (mk_map__ref localtext8)))

;; H
  (assert (= localtext9 o48))
...
;; WP_parameter_def
 ;; File "configdata.adb", line 1359, characters 0-0
  (not (in_range3 (+ 48 (div1 localvalue5 10)))))
(check-sat)
