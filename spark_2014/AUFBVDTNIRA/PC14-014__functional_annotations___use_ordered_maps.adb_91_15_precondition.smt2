...
;; H
  (assert
  (and (= o6 (keys (mk___rep s__split_discrs s__split_fields2)))
  (and
  (and
  (and (= (length3 o6) (length (mk___rep s__split_discrs s__split_fields2)))
  (forall ((temp___396 Int))
  (=> (and (in_range4 temp___396) (= (iter_has_element o6 temp___396) true))
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2))
     (get1 o6 temp___396)) true))))
  (forall ((key2 Int))
  (=>
  (and (in_range2 key2)
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) key2) true))
  (and (< 0 (find o6 key2))
  (= (equivalent_keys (get1 o6 (find o6 key2)) key2) true)))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s__split_discrs s__split_fields2))))
  (and (= (find o6 (get1 o6 i1)) i1) (= (k_is_find o6 (get1 o6 i1) i1) true)))))))
...
;; H
  ...
  (= (has_key
     (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     k) true))
  (= (= (equivalent_keys k o7) true)
  (= (witness
     (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     o7) (witness
         (model__
         (mk___rep s__split_discrs (mk___split_fields s__split_fields))) k))))))))))
...
;; H
  ...
  (forall ((temp___396 Int))
  (=> (and (in_range4 temp___396) (= (iter_has_element o4 temp___396) true))
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2))
     (get1 o4 temp___396)) true))))
  (forall ((key2 Int))
  (=>
  (and (in_range2 key2)
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) key2) true))
  (and (< 0 (find o4 key2))
  (= (equivalent_keys (get1 o4 (find o4 key2)) key2) true)))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s__split_discrs s__split_fields2))))
  (and (= (find o4 (get1 o4 i1)) i1) (= (k_is_find o4 (get1 o4 i1) i1) true)))))))
...
;; WP_parameter_def
 ;; File "a-cofuma.ads", line 84, characters 0-0
  (not
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) o5) true)))
(check-sat)
