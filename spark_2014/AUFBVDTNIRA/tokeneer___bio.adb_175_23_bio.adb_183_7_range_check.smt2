...
;; H
  (assert
  (=> (= (length (mk___t temp___929 temp___9291)) 0)
  (= (temp___String_Literal_928 Tuple0) bio__makedescription__B33b__fullstring__assume)))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___929 temp___9291)) 0))
  (=> (<= 1 2) (= o25 (+ (- 2 1) 1)))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___929 temp___9291)) 0))
  (= o28 (+ (to_rep1 (first temp___9291)) o27))))

;; H
  (assert
  (=> (not (= (length (mk___t temp___929 temp___9291)) 0)) (= o29 (- o28 1))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___929 temp___9291)) 0))
  (= (concat1 temp___929 (to_rep1 (first temp___9291))
     (to_rep1 (last temp___9291)) (temp___String_Literal_928 Tuple0) 1 2) 
  bio__makedescription__B33b__fullstring__assume)))

;; H
  (assert
  (=> (not (= (length (mk___t temp___929 temp___9291)) 0))
  (= (mk (to_rep1 (first temp___9291)) o30) bio__makedescription__B33b__fullstring__assume1)))
