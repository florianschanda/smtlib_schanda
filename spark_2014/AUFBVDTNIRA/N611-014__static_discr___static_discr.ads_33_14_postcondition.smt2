...
(declare-datatypes ()
((tT17bP1__ref (mk_tT17bP1__ref (tT17bP1__content integer)))))
(define-fun tT17bP1__ref___projection ((a1 tT17bP1__ref)) integer (tT17bP1__content
                                                                  a1))
...
(define-fun length3 ((a1 us_t3)) Int (ite (<= (first7 a1) (last10 a1))
                                     (+ (- (last10 a1) (first7 a1)) 1) 0))
...
(define-fun t17b__ref___projection ((a1 t17b__ref)) us_t3 (t17b__content a1))
...
(define-fun bool_eq14 ((a1 us_rep3)
...
(declare-datatypes () ((t16b__ref (mk_t16b__ref (t16b__content us_rep3)))))
(define-fun t16b__ref___projection ((a1 t16b__ref)) us_rep3 (t16b__content
                                                            a1))
...
(define-fun tT26bP1__ref___projection ((a1 tT26bP1__ref)) integer (tT26bP1__content
                                                                  a1))
...
(define-fun last13 ((a1 us_t4)) Int (to_rep1 (last12 (rt4 a1))))

(define-fun length4 ((a1 us_t4)) Int (ite (<= (first9 a1) (last13 a1))
                                     (+ (- (last13 a1) (first9 a1)) 1) 0))
...
(define-fun t26b__ref___projection ((a1 t26b__ref)) us_t4 (t26b__content a1))
...
(define-fun bool_eq18 ((a1 us_rep5)
...
(declare-datatypes () ((t25b__ref (mk_t25b__ref (t25b__content us_rep5)))))
(define-fun t25b__ref___projection ((a1 t25b__ref)) us_rep5 (t25b__content
                                                            a1))
...
(define-fun bool_eq19 ((a1 us_rep6)
...
(declare-datatypes () ((t24b__ref (mk_t24b__ref (t24b__content us_rep6)))))
(define-fun t24b__ref___projection ((a1 t24b__ref)) us_rep6 (t24b__content
                                                            a1))
...
(define-fun tT28bP1__ref___projection ((a1 tT28bP1__ref)) integer (tT28bP1__content
                                                                  a1))
...
(define-fun last16 ((a1 us_t5)) Int (to_rep1 (last15 (rt5 a1))))

(define-fun length5 ((a1 us_t5)) Int (ite (<= (first11 a1) (last16 a1))
                                     (+ (- (last16 a1) (first11 a1)) 1) 0))
...
(declare-datatypes () ((t28b__ref (mk_t28b__ref (t28b__content us_t5)))))
(define-fun t28b__ref___projection ((a1 t28b__ref)) us_t5 (t28b__content a1))
...
(define-fun bool_eq22 ((a1 us_rep7)
...
(declare-datatypes () ((t27b__ref (mk_t27b__ref (t27b__content us_rep7)))))
(define-fun t27b__ref___projection ((a1 t27b__ref)) us_rep7 (t27b__content
                                                            a1))
...
;; H
  ...
  (= (let ((temp___368 (rec__static_discr__i_holder__content2
                       ...
                       (rec__static_discr__holder__content1
                       current__split_fields6)))))
     (bool_eq2 (elts a) (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))
     (elts3 temp___368) (to_rep1 (first6 (rt3 temp___368)))
     (to_rep1 (last9 (rt3 temp___368))))) true))
  (forall ((i Int))
  (=>
  (and
...
;; H
  ...
  (= (let ((temp___244 (rec__static_discr__i_holder__content2
     ...
     (bool_eq2 (elts3 temp___243) (to_rep1 (first6 (rt3 temp___243)))
     (to_rep1 (last9 (rt3 temp___243))) (elts3 temp___244)
     (to_rep1 (first6 (rt3 temp___244))) (to_rep1 (last9 (rt3 temp___244)))))) true)
  (and
...
;; H
  ...
  (= (let ((temp___364 (rec__static_discr__i_holder__content2
     ...
     (to_rep1 (last9 (rt3 temp___364))))) true)))
