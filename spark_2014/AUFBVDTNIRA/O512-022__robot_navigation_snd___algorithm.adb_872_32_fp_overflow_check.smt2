...
;; H
  (assert
  (and
  (and (= o36 (limit o35 fliteral2 fliteral)) (limit__function_guard 
  o36 o35 fliteral2 fliteral))
  (and (tqtisFinite o36) (and (le fliteral2 o36) (le o36 fliteral)))))

;; H
  (assert (= o37 (mul RNE2 drivespeed3 o36)))
