...
(define-fun dynamic_invariant2 ((temp___expr_233 us_rep)
...
(define-fun use_vectors__my_find__result8 () int__ref (mk_int__ref
...
;; H
  (assert (= current1 first))

;; H
  (assert
  (=> (and (<= first current1) (<= current1 r27b)) (= temp___480 current1)))

;; H
  (assert
  (=> (and (<= first current1) (<= current1 r27b))
  (forall ((i Int))
...
;; H
  (assert
  (=> (and (<= first current1) (<= current1 r27b))
  (and (= us current2) (dynamic_property1 first1 last1 current2))))

;; H
  (assert (=> (and (<= first current1) (<= current1 r27b)) (= o1 current2)))
...
;; H
  (assert
  (=> (and (<= first current1) (<= current1 r27b)) (not (= result2 true))))
...
;; H
  (assert
  (=> (and (<= first current1) (<= current1 r27b)) (= current2 r27b)))

;; H
  (assert
  (=> (and (<= first current1) (<= current1 r27b))
  (= use_vectors__my_find__result3 use_vectors__my_find__result4)))

;; H
  (assert
  (=> (and (<= first current1) (<= current1 r27b)) (= current2 current3)))

;; H
  (assert
  (=> (and (<= first current1) (<= current1 r27b))
  (= use_vectors__my_find__result5 use_vectors__my_find__result3)))

;; H
  (assert
  (=> (and (<= first current1) (<= current1 r27b)) (= current4 current2)))

;; H
  (assert
  (=> (and (<= first current1) (<= current1 r27b))
  (= use_vectors__my_find__result8 (mk_int__ref
                                   use_vectors__my_find__result4))))

;; H
  (assert
  (=> (and (<= first current1) (<= current1 r27b))
  (= (mk_int__ref current5) (mk_int__ref current3))))

;; H
  (assert
  (=> (and (<= first current1) (<= current1 r27b))
  (= use_vectors__my_find__result7 use_vectors__my_find__result5)))

;; H
  (assert
  (=> (and (<= first current1) (<= current1 r27b)) (= current6 current4)))

;; H
  (assert
  (=> (not (and (<= first current1) (<= current1 r27b)))
  (= use_vectors__my_find__result8 (mk_int__ref use_vectors__my_find__result))))
...
;; H
  (assert
  (=> (not (and (<= first current1) (<= current1 r27b)))
  (= use_vectors__my_find__result7 use_vectors__my_find__result1)))
