...
(declare-fun to_rep3 (bits_15) (_ BitVec 16))

(declare-fun of_rep3 ((_ BitVec 16)) bits_15)
...
;; range_axiom
  (assert
  (forall ((x bits_15)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)) )))

;; coerce_axiom
  (assert
  (forall ((x (_ BitVec 16)))
  (! (let ((y (bvurem x ((_ int2bv 16) 32768))))
     (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3
                                                               (of_rep3 x))) )))

(define-fun to_int5 ((x bits_15)) Int (bv2nat (to_rep3 x)))

;; range_int_axiom
  (assert
  (forall ((x bits_15)) (! (in_range_int1
  (to_int5 x)) :pattern ((to_int5 x)) )))

(declare-datatypes ()
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__agc_ctrl1_type__dis_am bits_1)(rec__dw1000__register_types__agc_ctrl1_type__reserved bits_15)))))
(define-fun us_split_fields_DIS_AM__projection ((a us_split_fields)) bits_1 
  (rec__dw1000__register_types__agc_ctrl1_type__dis_am a))

(define-fun us_split_fields_Reserved4__projection ((a us_split_fields)) bits_15 
  (rec__dw1000__register_types__agc_ctrl1_type__reserved a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_26__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_26__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq7 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (to_rep2
                           (rec__dw1000__register_types__agc_ctrl1_type__dis_am
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__agc_ctrl1_type__dis_am
                                                  (us_split_fields1 b))))
                        (= (to_rep3
                           (rec__dw1000__register_types__agc_ctrl1_type__reserved
...
(declare-fun dw1000__register_types__agc_ctrl1_type__dis_am__first__bit () Int)

(declare-fun dw1000__register_types__agc_ctrl1_type__dis_am__last__bit () Int)

(declare-fun dw1000__register_types__agc_ctrl1_type__dis_am__position () Int)

;; dw1000__register_types__agc_ctrl1_type__dis_am__first__bit_axiom
  (assert (<= 0 dw1000__register_types__agc_ctrl1_type__dis_am__first__bit))

;; dw1000__register_types__agc_ctrl1_type__dis_am__last__bit_axiom
  (assert
  (< dw1000__register_types__agc_ctrl1_type__dis_am__first__bit dw1000__register_types__agc_ctrl1_type__dis_am__last__bit))

;; dw1000__register_types__agc_ctrl1_type__dis_am__position_axiom
  (assert (<= 0 dw1000__register_types__agc_ctrl1_type__dis_am__position))

(declare-fun dw1000__register_types__agc_ctrl1_type__reserved__first__bit () Int)

(declare-fun dw1000__register_types__agc_ctrl1_type__reserved__last__bit () Int)

(declare-fun dw1000__register_types__agc_ctrl1_type__reserved__position () Int)

;; dw1000__register_types__agc_ctrl1_type__reserved__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__agc_ctrl1_type__reserved__first__bit))

;; dw1000__register_types__agc_ctrl1_type__reserved__last__bit_axiom
  (assert
  (< dw1000__register_types__agc_ctrl1_type__reserved__first__bit dw1000__register_types__agc_ctrl1_type__reserved__last__bit))

;; dw1000__register_types__agc_ctrl1_type__reserved__position_axiom
  (assert (<= 0 dw1000__register_types__agc_ctrl1_type__reserved__position))

(declare-fun dummy6 () us_rep)

(declare-datatypes ()
((agc_ctrl1_type__ref
 (mk_agc_ctrl1_type__ref (agc_ctrl1_type__content us_rep)))))
(define-fun agc_ctrl1_type__ref___projection ((a agc_ctrl1_type__ref)) us_rep 
  (agc_ctrl1_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_58__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_42__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_42__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3404 us_t1)
  (temp___is_init_3401 Bool) (temp___skip_constant_3402 Bool)
  (temp___do_toplevel_3403 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3402 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_3404)
                                       (last4 temp___expr_3404))
                                       (and (= (first3 temp___expr_3404) 1)
                                       (= (last4 temp___expr_3404) 2)))))
...
(define-fun target__ref_17__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_17__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_3421 us_t2)
  (temp___is_init_3418 Bool) (temp___skip_constant_3419 Bool)
  (temp___do_toplevel_3420 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3419 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_3421)
                                       (last6 temp___expr_3421))
                                       (and (= (first5 temp___expr_3421) 1)
                                       (= (last6 temp___expr_3421) 2)))))
...
(declare-fun temp___7676 () (Array Int bits_8))

(declare-fun temp___76761 () t2)

(declare-fun temp___7677 () (Array Int bits_8))

(declare-fun temp___76771 () t1)
...
(define-fun temp___76762 () us_t2 (mk___t2 temp___7676 temp___76761))
...
;; H
  (assert
  (and
  (and (= temp___76762 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___76762 reg)) (dynamic_invariant1
  temp___76762 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___76761)) (to_rep (last5 temp___76761)))
     (+ (- (to_rep (last5 temp___76761)) (to_rep (first4 temp___76761))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___7676 temp___7677))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76761)) (to_rep (last5 temp___76761))) 
  temp___76771))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___76771)) (to_rep (last3 temp___76771)))
     (+ (- (to_rep (last3 temp___76771)) (to_rep (first2 temp___76771))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7677 temp___76771)))
