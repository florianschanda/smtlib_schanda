...
;; H
  (assert (= (is_empty (mk___rep r__split_fields14)) true))
...
;; H
  (assert (head__function_guard (head (mk___rep r__split_fields13))
...
;; H
  ...
  (= (head (mk___rep r__split_fields13)) h1)) (in_range h1)))
...
;; H
  ...
  (= (head (mk___rep r__split_fields12)) h2)) (in_range h2)))
