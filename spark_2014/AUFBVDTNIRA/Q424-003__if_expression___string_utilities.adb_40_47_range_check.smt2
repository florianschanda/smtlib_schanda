...
;; H
  (assert
  (and
  (and (= o4 (get_length x12 o3 lengths2)) (get_length__function_guard 
  o4 x12 o3 lengths2))
  (and (dynamic_property3 0 last4 o4)
  (= o4 (ite (and (dynamic_property1 first2 last2 x12) (dynamic_property2
             first3 last3 o3))
        (to_rep2 (get lengths2 x12 o3)) 0)))))
...
;; H
  (assert
  (and
  (and (= o5 (get_length o o1 lengths2)) (get_length__function_guard 
  o5 o o1 lengths2))
  (and (dynamic_property3 0 last4 o5)
  (= o5 (ite (and (dynamic_property1 first2 last2 o) (dynamic_property2
             first3 last3 o1))
        (to_rep2 (get lengths2 o o1)) 0)))))

;; H
  (assert (= temp___289 (ite (< o5 o4) o4 o5)))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (dynamic_property3 0 last4 temp___289)))
(check-sat)
