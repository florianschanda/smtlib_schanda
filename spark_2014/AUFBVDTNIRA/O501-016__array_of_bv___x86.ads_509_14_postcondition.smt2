...
;; H
  ...
  (= rcx1 (bvor (bvand rcx ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) ((_ int2bv 8) 1))))))

;; H
  (assert
  (=> (not (and (not (= carryflag true)) (not (= zeroflag true))))
  (= rcx2 (bvor (bvand rcx ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) ((_ int2bv 8) 0))))))
