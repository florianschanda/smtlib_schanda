...
(declare-fun res () (Array Int Bool))

(declare-fun test_main__my_sets__remove__result () (Array Int Bool))

(declare-fun result () (Array Int Bool))

(declare-fun res1 () (Array Int Bool))

(declare-fun result1 () (Array Int Bool))

(declare-fun res2 () (Array Int Bool))

(declare-fun result2 () (Array Int Bool))

(declare-fun test_main__my_sets__remove__result1 () (Array Int Bool))

(declare-fun test_main__my_sets__remove__result2 () (Array Int Bool))

(declare-fun test_main__my_sets__remove__result3 () (Array Int Bool))

(declare-fun res3 () (Array Int Bool))

(declare-fun test_main__my_sets__remove__result4 () (Array Int Bool))

(declare-fun res4 () (Array Int Bool))

(declare-fun test_main__my_sets__remove__result5 () (Array Int Bool))
...
;; H
  (assert (= res2 (store res1 e (of_int 0))))

;; H
  (assert
  (= test_main__my_sets__remove__result1 test_main__my_sets__remove__result2))

;; H
  (assert
  (= test_main__my_sets__remove__result3 test_main__my_sets__remove__result1))

;; H
  (assert (= result2 test_main__my_sets__remove__result))

;; H
  (assert (= test_main__my_sets__remove__result1 res2))

;; H
  (assert
  (= (mk_map__ref test_main__my_sets__remove__result4) (mk_map__ref
                                                       test_main__my_sets__remove__result2)))
...
;; H
  (assert
  (= test_main__my_sets__remove__result5 test_main__my_sets__remove__result3))

;; H
  (assert (= res4 res2))

;; H
  (assert (= result3 test_main__my_sets__remove__result4))
