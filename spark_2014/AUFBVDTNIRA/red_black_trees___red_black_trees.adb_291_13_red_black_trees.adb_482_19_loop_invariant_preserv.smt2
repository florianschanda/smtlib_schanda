...
;; H
  (assert (eq__function_guard
  (eq (select (nb_blacks c100b) c101b) (select (nb_blacks c99b) c101b))
  (select (nb_blacks c100b) c101b) (select (nb_blacks c99b) c101b)))
...
;; H
  (assert (parent__function_guard
  (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) y2)
  (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) y2))
...
;; H
  ...
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c99b) c101b)))) (int__content n8)))
