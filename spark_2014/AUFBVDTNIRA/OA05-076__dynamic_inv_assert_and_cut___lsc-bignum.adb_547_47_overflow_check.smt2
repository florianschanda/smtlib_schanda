...
;; H
  (assert (and (= o13 o12) (uint_in_range1 o12)))

;; H
  (assert (= o14 ((_ int2bv 64) o13)))

;; H
  (assert (= o15 (bvadd o14 ((_ int2bv 64) 1))))

;; H
  (assert (= o16 (bvmul o15 ((_ int2bv 64) 32))))

;; H
  (assert (= o17 (ite (bvult i2 o16) true false)))
