...
(declare-fun use_ordered_maps__apply_f_4__cu__assume () count_type)
...
(declare-fun temp___794 () count_type)
...
(define-fun s__split_fields3 () us_split_fields (mk___split_fields
                                                s__split_fields2))

(define-fun cu__split_fields4 () us_split_fields2 (mk___split_fields1
                                                  cu__split_fields2))

(define-fun s__split_fields4 () us_split_fields (mk___split_fields
                                                s__split_fields1))

(define-fun cu__split_fields5 () us_split_fields2 (mk___split_fields1
                                                  cu__split_fields1))

(define-fun temp___7941 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___794)))

(define-fun use_ordered_maps__apply_f_4__cu__assume1 () us_rep1 (mk___rep1
                                                                (mk___split_fields1
                                                                use_ordered_maps__apply_f_4__cu__assume)))

;; H
  (assert
  (and
  (= use_ordered_maps__apply_f_4__cu__assume1 (first
                                              (mk___rep s__split_discrs
                                              (mk___split_fields
                                              s__split_fields))))
  (ite (= (= (length
             (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 0) true)
  (= (bool_eq2 use_ordered_maps__apply_f_4__cu__assume1 no_element) true)
  (and
  (= (has_key1
     (positions
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     use_ordered_maps__apply_f_4__cu__assume1) true)
  (= (get2
     (positions
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     use_ordered_maps__apply_f_4__cu__assume1) 1)))))
...
;; H
  ...
  (get1 (keys (mk___rep s__split_discrs s__split_fields4)) i)))
  (get
  (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
  (get1 (keys (mk___rep s__split_discrs s__split_fields4)) i)))))
...
;; H
  (assert
  (= (oeq3 (positions (mk___rep s__split_discrs s__split_fields4))
     (positions
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) true))

;; H
  (assert
  (= (oeq2 (keys (mk___rep s__split_discrs s__split_fields4))
...
;; H
  ...
  (=>
  (and (<= 1 i)
  (<= i (- (get2 (positions (mk___rep s__split_discrs s__split_fields4))
           (mk___rep1 cu__split_fields4)) 1)))
  (= (get (model__ (mk___rep s__split_discrs s__split_fields4))
     (get1 (keys (mk___rep s__split_discrs s__split_fields4)) i)) (f
                                                                  (get
                                                                  (model__
                                                                  (mk___rep
                                                                  s__split_discrs
...
;; H
  ...
  (=>
  (and
  (<= (get2 (positions (mk___rep s__split_discrs s__split_fields4))
      (mk___rep1 cu__split_fields4)) i)
  (<= i (length (mk___rep s__split_discrs s__split_fields4))))
  (= (get
     (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (get1 (keys (mk___rep s__split_discrs s__split_fields4)) i)) (get
                                                                  (model__
                                                                  (mk___rep
                                                                  s__split_discrs
                                                                  s__split_fields4))
...
;; H
  (assert
  (= (has_key1 (positions (mk___rep s__split_discrs s__split_fields4))
     (mk___rep1 cu__split_fields4)) true))

;; H
  (assert
  (and
  (= o1 (element (mk___rep s__split_discrs s__split_fields4)
        (mk___rep1 cu__split_fields4)))
  (and (in_range8 o1)
  (= o1 (get (model__ (mk___rep s__split_discrs s__split_fields4))
        (key (mk___rep s__split_discrs s__split_fields4)
        (mk___rep1 cu__split_fields4)))))))
...
;; H
  (assert
  (and
  (= o (key (mk___rep s__split_discrs s__split_fields4)
       (mk___rep1 cu__split_fields4)))
  (and (in_range7 o)
  (= o (get1 (keys (mk___rep s__split_discrs s__split_fields4))
       (get2 (positions (mk___rep s__split_discrs s__split_fields4))
       (mk___rep1 cu__split_fields4)))))))
...
;; H
  ...
  (and
  (and
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields3)) o) true)
  (= (get (model__ (mk___rep s__split_discrs s__split_fields3)) o) o2))
  (ite (= (has_key (model__ (mk___rep s__split_discrs s__split_fields4)) o) true)
  (and
  (and
  (and
  (and
  (= (oeq3 (positions (mk___rep s__split_discrs s__split_fields3))
     (positions (mk___rep s__split_discrs s__split_fields4))) true)
  (= (get1 (keys (mk___rep s__split_discrs s__split_fields3))
     (find (keys (mk___rep s__split_discrs s__split_fields3)) o)) o))
  (= (equal_except (keys (mk___rep s__split_discrs s__split_fields4))
     (keys (mk___rep s__split_discrs s__split_fields3))
     (find (keys (mk___rep s__split_discrs s__split_fields3)) o)) true))
  (= (same_keys (model__ (mk___rep s__split_discrs s__split_fields3))
     (model__ (mk___rep s__split_discrs s__split_fields4))) true))
  (= (elements_equal_except
     (model__ (mk___rep s__split_discrs s__split_fields3))
     (model__ (mk___rep s__split_discrs s__split_fields4)) o) true))
  (and
  (and
  (and
  (and
  (and
  (and
  (= (length (mk___rep s__split_discrs s__split_fields3)) (+ (length
                                                             (mk___rep
                                                             s__split_discrs
                                                             s__split_fields4)) 1))
  (= (ole (model__ (mk___rep s__split_discrs s__split_fields4))
     (model__ (mk___rep s__split_discrs s__split_fields3))) true))
  (= (keys_included_except
     (model__ (mk___rep s__split_discrs s__split_fields3))
     (model__ (mk___rep s__split_discrs s__split_fields4)) o) true))
  (= (get1 (keys (mk___rep s__split_discrs s__split_fields3))
     (find (keys (mk___rep s__split_discrs s__split_fields3)) o)) o))
  (= (range_equal (keys (mk___rep s__split_discrs s__split_fields4))
     (keys (mk___rep s__split_discrs s__split_fields3)) 1
     (- (find (keys (mk___rep s__split_discrs s__split_fields3)) o) 1)) true))
  (= (range_shifted (keys (mk___rep s__split_discrs s__split_fields4))
     (keys (mk___rep s__split_discrs s__split_fields3))
     (find (keys (mk___rep s__split_discrs s__split_fields3)) o)
     (length (mk___rep s__split_discrs s__split_fields4)) 1) true))
  (= (p_positions_shifted
     (positions (mk___rep s__split_discrs s__split_fields4))
     (positions (mk___rep s__split_discrs s__split_fields3))
     (find (keys (mk___rep s__split_discrs s__split_fields3)) o) 1) true)))))

;; H
  (assert
  (and
  (= temp___7941 (next (mk___rep s__split_discrs s__split_fields3)
                 (mk___rep1 cu__split_fields4)))
  (ite (= (ite (= (bool_eq2 (mk___rep1 cu__split_fields4) no_element) false) (= 
          (get2 (positions (mk___rep s__split_discrs s__split_fields3))
          (mk___rep1 cu__split_fields4)) (length
                                         (mk___rep s__split_discrs
                                         s__split_fields3))) true) true)
  (= (bool_eq2 temp___7941 no_element) true)
  (and
  (= (has_key1 (positions (mk___rep s__split_discrs s__split_fields3))
     temp___7941) true)
  (= (get2 (positions (mk___rep s__split_discrs s__split_fields3))
     temp___7941) (+ (get2
                     (positions (mk___rep s__split_discrs s__split_fields3))
...
;; H
  (assert (= cu__split_fields3 (mk___split_fields1 temp___794)))

;; H
  (assert
  (and
  (= o3 (has_key1 (positions (mk___rep s__split_discrs s__split_fields3))
...
;; H
  (assert
  (<= i (- (get2 (positions (mk___rep s__split_discrs s__split_fields3))
           (mk___rep1 cu__split_fields3)) 1)))

;; H
  (assert (f__function_guard
  (f
  (get
  (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
  (get1 (keys (mk___rep s__split_discrs s__split_fields3)) i)))
  (get
  (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
  (get1 (keys (mk___rep s__split_discrs s__split_fields3)) i))))
...
;; WP_parameter_def
 ;; File "a-cofuma.ads", line 84, characters 0-0
  (not
  (= (get (model__ (mk___rep s__split_discrs s__split_fields3))
     (get1 (keys (mk___rep s__split_discrs s__split_fields3)) i)) (f
                                                                  (get
                                                                  (model__
                                                                  (mk___rep
                                                                  s__split_discrs
