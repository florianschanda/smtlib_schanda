...
;; H
  (assert
  (= (to_rep1 o2) (to_float64 RNE2
                  (mul RNE2 (to_rep (select a 1)) fliteral4))))
...
;; H
  (assert
  (= (to_rep1 o4) (to_float64 RNE2
                  (mul RNE2 (to_rep (select a 2)) fliteral4))))
...
;; H
  (assert
  (= (to_rep1 o6) (to_float64 RNE2
                  (mul RNE2 (to_rep (select a 3)) fliteral4))))
...
;; WP_parameter_def
 ;; File "floats.ads", line 5, characters 0-0
  (not (le1 (neg1 fliteral1) (to_rep1 (select d4 1)))))
(check-sat)
