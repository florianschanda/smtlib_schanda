...
(declare-fun temp___1076 () (Array Int character))

(declare-fun temp___10761 () t)
...
;; H
  (assert
  (=> (= (length (mk___t temp___1074 temp___10741)) 0)
  (= (temp___String_Literal_155 Tuple0) temp___1076)))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1074 temp___10741)) 0))
  (=> (<= 1 3) (= o6 (+ (- 3 1) 1)))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1074 temp___10741)) 0))
  (= o9 (+ (to_rep1 (first temp___10741)) o8))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1074 temp___10741)) 0))
  (= (concat1 temp___1074 (to_rep1 (first temp___10741))
     (to_rep1 (last temp___10741)) (temp___String_Literal_155 Tuple0) 1 3) 
  temp___1076)))

;; H
  (assert
  (=> (not (= (length (mk___t temp___1074 temp___10741)) 0))
  (= (mk (to_rep1 (first temp___10741)) o11) temp___10761)))

;; H
  (assert (not (= (length (mk___t temp___1076 temp___10761)) 0)))
...
;; H
  (assert
  (=> (<= (to_rep1 (first temp___10761)) (to_rep1 (last temp___10761)))
  (= o13 (+ (- (to_rep1 (last temp___10761)) (to_rep1 (first temp___10761))) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 (first temp___10761)) (to_rep1 (last temp___10761))))
  (= o13 0)))
...
;; H
  (assert (= o15 (+ (to_rep1 (first temp___10761)) o14)))
