...
;; H
  (assert (= o44 (from_word32 carry22)))
...
;; H
  (assert (= o42 (from_word32 carry12)))

;; H
  (assert (= o46 (oadd o42 o45)))
...
;; H
  (assert (= o41 (oexpon o36 o40)))

;; H
  (assert (= o47 (omultiply o41 o46)))
...
;; H
  (assert (= o48 (oadd o35 o47)))

;; H
  (assert (= o29 (from_word32 carry2)))
...
;; H
  (assert (= o27 (from_word32 carry1)))

;; H
  (assert (= o25 (from_word32 y)))
...
;; H
  (assert (= o24 (num_of_big_int c c_first o23)))

;; H
  (assert (= o26 (omultiply o24 o25)))

;; H
  (assert (= o19 (from_word32 x)))
