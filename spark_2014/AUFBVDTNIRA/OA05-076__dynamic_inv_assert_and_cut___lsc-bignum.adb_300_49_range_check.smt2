...
;; H
  (assert (and (= o50 (+ a_last 1)) (in_range1 (+ a_last 1))))

;; H
  (assert (= o51 (ite (<= k o50) true false)))

;; H
  (assert (and (= o49 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert (= o52 (ite (<= o49 k) true false)))
...
;; H
  (assert
  (and (= o44 (from_word32 carry22)) (from_word32__function_guard o44
  carry22)))

;; H
  (assert
  (and (and (= o43 (base Tuple0)) (base__function_guard o43 Tuple0))
  (= o43 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o45 (omultiply o43 o44)) (omultiply__function_guard o45 o43 o44)))

;; H
  (assert
  (and (= o42 (from_word32 carry12)) (from_word32__function_guard o42
  carry12)))

;; H
  (assert (and (= o46 (oadd o42 o45)) (oadd__function_guard o46 o42 o45)))
...
;; H
  (assert
  (and (and (= o36 (base Tuple0)) (base__function_guard o36 Tuple0))
  (= o36 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o41 (oexpon o36 o40)) (oexpon__function_guard o41 o36 o40)))

;; H
  (assert
  (and (= o47 (omultiply o41 o46)) (omultiply__function_guard o47 o41 o46)))

;; H
  (assert (and (= o31 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert (= o32 (- o31 a_first)))
...
;; H
  (assert
  (and
  (= o35 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))
         a_first o34))
  (num_of_big_int__function_guard o35
  (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o34)))

;; H
  (assert (and (= o48 (oadd o35 o47)) (oadd__function_guard o48 o35 o47)))
...
;; H
  (assert
  (and (= o29 (from_word32 carry2)) (from_word32__function_guard o29 carry2)))

;; H
  (assert
  (and (and (= o28 (base Tuple0)) (base__function_guard o28 Tuple0))
  (= o28 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o30 (omultiply o28 o29)) (omultiply__function_guard o30 o28 o29)))

;; H
  (assert
  (and (= o27 (from_word32 carry1)) (from_word32__function_guard o27 carry1)))

;; H
  (assert (and (= o25 (from_word32 y)) (from_word32__function_guard o25 y)))
...
;; H
  (assert
  (and (= o24 (num_of_big_int c c_first o23)) (num_of_big_int__function_guard
  o24 c c_first o23)))
...
;; H
  (assert (and (= o19 (from_word32 x)) (from_word32__function_guard o19 x)))
