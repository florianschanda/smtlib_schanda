...
;; H
  (assert (= o31 (select temp___3132 i)))
...
;; H
  (assert (=> (= result5 true) (= o29 (select temp___3133 j))))
...
;; H
  (assert
  (=> (= result5 true) (= result4 (rec__tree_model__path_type__k o30))))
...
;; H
  (assert (=> (= result4 true) (= o26 (select temp___3135 j))))
...
;; H
  (assert (=> (= result4 true) (= o23 (select temp___3134 i))))
...
;; H
  (assert
  (=> (= result4 true)
  (and (= result3 (olt o25 o28))
  (= (= result3 true)
  (and (< (length o25) (length o28))
  (forall ((n Int))
  (=> (and (<= 1 n) (<= n (last o25))) (= (get o25 n) (get o28 n)))))))))
...
;; H
  (assert (= o18 (select temp___3139 i)))
...
;; H
  (assert
  (and (= o21 (length o20)) (and (in_range4 o21) (<= (+ 0 o21) 2147483647))))
