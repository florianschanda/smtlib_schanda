...
(declare-fun x86__writereg32post__result () Bool)
...
(declare-fun x86__writereg32post__result1 () Bool)

(declare-fun x86__writereg32post__result2 () Bool)

(declare-fun x86__writereg32post__result3 () Bool)

(declare-fun x86__writereg32post__result4 () Bool)

(declare-fun x86__writereg32post__result5 () Bool)
...
;; H
  (assert
  (and (and (= o (readreg32 regnew)) (readreg32__function_guard o regnew))
  (= o ((_ extract 31 0) (bvand regnew ((_ int2bv 64) 4294967295))))))
...
;; H
  (assert
  (= o2 (ite (= o1 true) (ite (= (bvand regnew ((_ int2bv 64) 18446744069414584320)) ((_ int2bv 64) 0))
                         true false) false)))
...
;; H
  (assert
  (= (mk_bool__ref x86__writereg32post__result4) (mk_bool__ref
                                                 x86__writereg32post__result2)))
...
;; H
  (assert (readreg32__function_guard (readreg32 regnew) regnew))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 148, characters 0-0
  (not (= (readreg32 regnew) val__)))
(check-sat)
