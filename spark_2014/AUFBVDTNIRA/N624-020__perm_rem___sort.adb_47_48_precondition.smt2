...
;; H
  (assert (remove__function_guard (remove o29 o19) o29 o19))

;; H
  (assert (remove__function_guard (remove o30 o19) o30 o19))
...
;; H
  ...
  (remove__function_guard o29 (mk___t values2 (mk 1 100)) o16))
...
;; H
  ...
  (remove__function_guard o30 (mk___t interm1 (mk 1 100)) o13))
...
;; H
  (assert
  (and
  (and (= o20 (remove_eq o30 o29 o19)) (remove_eq__function_guard o20 
  o30 o29 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___181 (remove o29 o19)))
     (let ((temp___180 (remove o30 o19)))
