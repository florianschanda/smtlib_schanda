...
(declare-fun variants__t__c__first__bit () Int)

(declare-fun variants__t__c__last__bit () Int)

(declare-fun variants__t__c__position () Int)
...
(declare-fun variants__t__d__first__bit () Int)

(declare-fun variants__t__d__last__bit () Int)

(declare-fun variants__t__d__position () Int)
...
(declare-fun variants__t__e__first__bit () Int)

(declare-fun variants__t__e__last__bit () Int)

(declare-fun variants__t__e__position () Int)
...
(declare-fun variants__t__c__first__bit1 () Int)

(declare-fun variants__t__c__last__bit1 () Int)

(declare-fun variants__t__c__position1 () Int)
...
(declare-fun variants__t__e__first__bit1 () Int)

(declare-fun variants__t__e__last__bit1 () Int)

(declare-fun variants__t__e__position1 () Int)
...
(declare-fun variants__t__d__first__bit1 () Int)

(declare-fun variants__t__d__last__bit1 () Int)

(declare-fun variants__t__d__position1 () Int)
...
(declare-fun variants__t__c__first__bit2 () Int)

(declare-fun variants__t__c__last__bit2 () Int)

(declare-fun variants__t__c__position2 () Int)
...
(declare-fun variants__t__d__first__bit2 () Int)

(declare-fun variants__t__d__last__bit2 () Int)

(declare-fun variants__t__d__position2 () Int)
...
(declare-fun variants__t__e__first__bit2 () Int)

(declare-fun variants__t__e__last__bit2 () Int)

(declare-fun variants__t__e__position2 () Int)
...
(declare-fun y__attr__constrained () Bool)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun z__split_discrs () us_split_discrs)

(declare-fun z__attr__constrained () Bool)
...
;; WP_parameter_def
 ;; File "variants.ads", line 14, characters 0-0
  (not (in_range (to_rep (rec__variants__t__c (us_split_discrs1 x))))))
(check-sat)
