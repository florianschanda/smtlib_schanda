...
(declare-fun temp___372 () (Array Int storage_element))

(declare-fun temp___3721 () t)
...
;; H
  ...
  (= (temp___354
     ...
     ((_ extract 7 0) (bvand c242b ((_ int2bv 32) 255)))) temp___370)))
...
;; H
  ...
  (= (concat1 temp___361 (to_rep1 (first temp___3611))
     (to_rep1 (last temp___3611))
     (temp___354
     ((_ extract 7 0) (bvand (bvlshr c242b ((_ int2bv 32) 24)) ((_ int2bv 32) 255)))
     ((_ extract 7 0) (bvand (bvlshr c242b ((_ int2bv 32) 16)) ((_ int2bv 32) 255)))
     ((_ extract 7 0) (bvand (bvlshr c242b ((_ int2bv 32) 8)) ((_ int2bv 32) 255)))
     ((_ extract 7 0) (bvand c242b ((_ int2bv 32) 255)))) 1 4) temp___370)))
...
;; H
  (assert
  (=> (= (length (mk___t temp___370 temp___3701)) 0)
  (= (temp___363
     ...
     ((_ extract 7 0) (bvand c248b ((_ int2bv 32) 255)))) temp___372)))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___370 temp___3701)) 0))
  (=> (<= 1 4) (= o72 (+ (- 4 1) 1)))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___370 temp___3701)) 0))
  (= o75 (+ (to_rep1 (first temp___3701)) o74))))

;; H
  (assert
  (=> (not (= (length (mk___t temp___370 temp___3701)) 0)) (= o76 (- o75 1))))

;; H
  (assert
  (=> (not (= (length (mk___t temp___370 temp___3701)) 0))
  (and (= o77 o76) (in_range o76))))

;; H
  (assert
  (=> (not (= (length (mk___t temp___370 temp___3701)) 0))
  (= (concat1 temp___370 (to_rep1 (first temp___3701))
     (to_rep1 (last temp___3701))
     (temp___363
     ((_ extract 7 0) (bvand (bvlshr c248b ((_ int2bv 32) 24)) ((_ int2bv 32) 255)))
     ((_ extract 7 0) (bvand (bvlshr c248b ((_ int2bv 32) 16)) ((_ int2bv 32) 255)))
     ((_ extract 7 0) (bvand (bvlshr c248b ((_ int2bv 32) 8)) ((_ int2bv 32) 255)))
     ((_ extract 7 0) (bvand c248b ((_ int2bv 32) 255)))) 1 4) temp___372)))

;; H
  (assert
  (=> (not (= (length (mk___t temp___370 temp___3701)) 0))
  (= (mk (to_rep1 (first temp___3701)) o77) temp___3721)))

(assert
;; WP_parameter_def
 ;; File "linted-update.ads", line 41, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first temp___3721)) (to_rep1 (last temp___3721)))
     (+ (- (to_rep1 (last temp___3721)) (to_rep1 (first temp___3721))) 1) 0) 
  (ite (<= 1 32) (+ (- 32 1) 1) 0))))
(check-sat)
