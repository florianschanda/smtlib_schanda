...
(declare-fun temp___855 () (Array Int us_rep1))
...
;; H
  ...
  (= temp___855 (model__
                ...
                o43))
  (and (dynamic_invariant3 temp___855 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___855 o43))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___855 o43)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o43))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___855 (parent
                             (mk___rep2
                             (mk___split_fields2 f__split_fields
                             f__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___855 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___855 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___855 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___855 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___855 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___855 j1)))) true))
  (= j1 i1)))))))))))))))

;; H
  (assert (=> (not (= v 0)) (= o44 (select temp___855 j))))
