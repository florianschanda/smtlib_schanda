...
(declare-fun dooralarm2 () int__ref)

(declare-fun localalarm3 () int__ref)

(declare-fun severity3 () int__ref)
...
(declare-fun localalarm4 () Int)

(declare-fun severity4 () Int)
...
;; H
  (assert
  (=> (not (not (= dooralarm localalarm1))) (= filestate2 filestate)))
...
;; H
  (assert
  (=> (not (not (= dooralarm localalarm1))) (= filestate2 filestate1)))
