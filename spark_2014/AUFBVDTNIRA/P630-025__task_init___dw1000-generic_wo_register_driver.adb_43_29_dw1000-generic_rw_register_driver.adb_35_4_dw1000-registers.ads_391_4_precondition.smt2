...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__drx_tune1a_type__drx_tune1a bits_16)))))
(define-fun us_split_fields_DRX_TUNE1a__projection ((a us_split_fields)) bits_16 
  (rec__dw1000__register_types__drx_tune1a_type__drx_tune1a a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_47__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_47__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq6 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__drx_tune1a_type__drx_tune1a
...
(declare-fun dw1000__register_types__drx_tune1a_type__drx_tune1a__first__bit () Int)

(declare-fun dw1000__register_types__drx_tune1a_type__drx_tune1a__last__bit () Int)

(declare-fun dw1000__register_types__drx_tune1a_type__drx_tune1a__position () Int)

;; dw1000__register_types__drx_tune1a_type__drx_tune1a__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__drx_tune1a_type__drx_tune1a__first__bit))

;; dw1000__register_types__drx_tune1a_type__drx_tune1a__last__bit_axiom
  (assert
  (< dw1000__register_types__drx_tune1a_type__drx_tune1a__first__bit 
  dw1000__register_types__drx_tune1a_type__drx_tune1a__last__bit))

;; dw1000__register_types__drx_tune1a_type__drx_tune1a__position_axiom
  (assert
  (<= 0 dw1000__register_types__drx_tune1a_type__drx_tune1a__position))

(declare-fun dummy5 () us_rep)

(declare-datatypes ()
((drx_tune1a_type__ref
 (mk_drx_tune1a_type__ref (drx_tune1a_type__content us_rep)))))
(define-fun drx_tune1a_type__ref___projection ((a drx_tune1a_type__ref)) us_rep 
  (drx_tune1a_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_108__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_77__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_77__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_4757 us_t1)
  (temp___is_init_4754 Bool) (temp___skip_constant_4755 Bool)
  (temp___do_toplevel_4756 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_4755 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_4757)
                                       (last4 temp___expr_4757))
                                       (and (= (first3 temp___expr_4757) 1)
                                       (= (last4 temp___expr_4757) 2)))))
...
(define-fun target__ref_32__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_32__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_4773 us_t2)
  (temp___is_init_4770 Bool) (temp___skip_constant_4771 Bool)
  (temp___do_toplevel_4772 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_4771 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_4773)
                                       (last6 temp___expr_4773))
                                       (and (= (first5 temp___expr_4773) 1)
                                       (= (last6 temp___expr_4773) 2)))))
...
(declare-fun temp___7792 () (Array Int bits_8))

(declare-fun temp___77921 () t2)

(declare-fun temp___7793 () (Array Int bits_8))

(declare-fun temp___77931 () t1)
...
(define-fun temp___77922 () us_t2 (mk___t2 temp___7792 temp___77921))
...
;; H
  (assert
  (and
  (and (= temp___77922 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___77922 reg)) (dynamic_invariant1
  temp___77922 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___77921)) (to_rep (last5 temp___77921)))
     (+ (- (to_rep (last5 temp___77921)) (to_rep (first4 temp___77921))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___7792 temp___7793))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___77921)) (to_rep (last5 temp___77921))) 
  temp___77931))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___77931)) (to_rep (last3 temp___77931)))
     (+ (- (to_rep (last3 temp___77931)) (to_rep (first2 temp___77931))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7793 temp___77931)))
