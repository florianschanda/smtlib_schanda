...
;; range_axiom
  (assert
  (forall ((x name_t)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)) )))
...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__model__uml_action__name_data name_t)))))
(define-fun us_split_fields_Name_Data2__projection ((a us_split_fields)) name_t 
...
(declare-datatypes ()
((uml_action__ref (mk_uml_action__ref (uml_action__content us_rep)))))
(define-fun uml_action__ref___projection ((a uml_action__ref)) us_rep 
...
(define-fun bool_eq3 ((a (Array Int us_rep)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq2 (select a temp___idx_134)
...
(declare-fun dummy3 () uml_control_flow_access)
...
(define-fun us_split_fields_From_Data2__projection ((a us_split_fields2)) uml_action_access 
  (rec__model__uml_control_flow__from_data a))

(define-fun us_split_fields_To_Data2__projection ((a us_split_fields2)) uml_action_access 
...
((uml_control_flow__ref
 (mk_uml_control_flow__ref (uml_control_flow__content us_rep1)))))
(define-fun uml_control_flow__ref___projection ((a uml_control_flow__ref)) us_rep1 
...
(define-fun us_split_fields_Owned_Action_Data__projection ((a us_split_fields4)) (Array Int us_rep) 
  (rec__model__uml_activity__owned_action_data a))

(define-fun us_split_fields_Owned_Flow_Data__projection ((a us_split_fields4)) (Array Int us_rep1) 
...
(declare-datatypes ()
((uml_activity__ref (mk_uml_activity__ref (uml_activity__content us_rep2)))))
(define-fun uml_activity__ref___projection ((a uml_activity__ref)) us_rep2 
...
(declare-fun val__ () (Array Int us_rep))
...
(declare-fun self__split_fields1 () (Array Int us_rep1))

(declare-fun result () (Array Int us_rep))

(declare-fun result1 () (Array Int us_rep1))

(declare-fun self__split_fields2 () (Array Int us_rep))

(declare-fun self__split_fields3 () (Array Int us_rep1))

(declare-fun self__split_fields4 () (Array Int us_rep))

(declare-fun self__split_fields5 () (Array Int us_rep1))

(declare-fun self__split_fields6 () (Array Int us_rep))

(declare-fun self__split_fields7 () (Array Int us_rep1))
...
;; H
  (assert (= val__ self__split_fields2))

;; H
  (assert (= self__split_fields1 self__split_fields3))
...
(assert
;; WP_parameter_def
 ;; File "model.ads", line 97, characters 0-0
  (not
  (= (bool_eq3
     (owned_action
