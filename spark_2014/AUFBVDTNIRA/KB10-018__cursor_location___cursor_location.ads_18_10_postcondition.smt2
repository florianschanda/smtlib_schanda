...
(declare-fun other_side () Int)

(declare-fun cursor_location__fulfill_condition__result () Bool)

(declare-fun o () Int)

(declare-fun result () Int)

(declare-fun other_side1 () Int)

(declare-fun result1 () Bool)

(declare-fun cursor_location__fulfill_condition__result1 () Bool)

(declare-fun cursor_location__fulfill_condition__result2 () Bool)

(declare-fun cursor_location__fulfill_condition__result3 () Bool)

(declare-fun other_side2 () Int)

(declare-fun cursor_location__fulfill_condition__result4 () Bool)

(declare-fun other_side3 () Int)

(declare-fun cursor_location__fulfill_condition__result5 () Bool)
...
;; H
  (assert
  (= cursor_location__fulfill_condition__result1 cursor_location__fulfill_condition__result2))

;; H
  (assert
  (= cursor_location__fulfill_condition__result3 cursor_location__fulfill_condition__result1))
...
;; H
  (assert
  (= cursor_location__fulfill_condition__result1 (ite (and
                                                      (= (select du_available 
                                                      side) true)
                                                      (or
                                                      (= (select request 
...
;; H
  (assert
  (= (mk_bool__ref cursor_location__fulfill_condition__result4) (mk_bool__ref
                                                                cursor_location__fulfill_condition__result2)))
...
;; H
  (assert
  (= cursor_location__fulfill_condition__result5 cursor_location__fulfill_condition__result3))
