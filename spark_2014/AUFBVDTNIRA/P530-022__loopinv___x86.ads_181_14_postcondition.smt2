...
(declare-fun x86__ax__result () (_ BitVec 16))

(declare-fun result () (_ BitVec 16))

(declare-fun x86__ax__result1 () (_ BitVec 16))

(declare-fun x86__ax__result2 () (_ BitVec 16))

(declare-fun x86__ax__result3 () (_ BitVec 16))

(declare-fun x86__ax__result4 () (_ BitVec 16))

(declare-fun x86__ax__result5 () (_ BitVec 16))
...
;; H
  (assert (= result x86__ax__result))

;; H
  (assert
  (= x86__ax__result1 ((_ extract 15 0) (bvand rax ((_ int2bv 64) 65535)))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 9, characters 0-0
  (not (= x86__ax__result4 (readreg16 rax))))
(check-sat)
