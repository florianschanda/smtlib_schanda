...
;; H
  ...
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100)) (= (contains o1 i2) true)))
  (= (length1 o1) 100))))
...
;; H
  (assert
  (= (rec__tree_model__path_type__k (us_split_fields1 (select r1 j))) true))
...
;; H
  ...
  (rec__tree_model__path_type__a (us_split_fields1 (select r1 j))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select r1 (to_rep
             (rec__binary_trees__cell__parent
...
;; WP_parameter_def
 ;; File "tree_model.ads", line 49, characters 0-0
  ...
  (= (is_add
     ...
     (us_split_fields3
     (select (rec__binary_trees__forest__c (us_split_fields5 f)) j))))
     (rec__tree_model__path_type__a (us_split_fields1 (select r1 j)))) true)))
(check-sat)
