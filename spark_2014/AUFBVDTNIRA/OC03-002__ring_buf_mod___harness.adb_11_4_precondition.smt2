...
;; H
  (assert (to_model__function_guard (to_model (mk___rep r__split_fields7))
  (mk___rep r__split_fields7)))

;; H
  (assert
  (= (let ((temp___224 (to_model (mk___rep r__split_fields7))))
...
;; H
  ...
  (func_push (to_model (mk___rep r__split_fields7)) x)
  (to_model (mk___rep r__split_fields7)) x))

;; H
  (assert (to_model__function_guard (to_model (mk___rep r__split_fields6))
  (mk___rep r__split_fields6)))

;; H
  (assert
  (= (let ((temp___242 (func_push (to_model (mk___rep r__split_fields7)) x)))
     (let ((temp___241 (to_model (mk___rep r__split_fields6))))
