...
;; H
  ...
  (bit_set__function_guard result6 e e_first (bvsub i2 ((_ int2bv 64) 
  j3))))
  (= (= result6 true)
  (not
  (= (bvand (to_rep1
            (select (elts e) (+ e_first (bv2nat (bvudiv (bvsub i2 ((_ int2bv 64) 
            j3)) ((_ int2bv 64) 32)))))) (let ((temp___569 (bv2nat (bvurem (bvsub 
                                         i2 ((_ int2bv 64) j3)) ((_ int2bv 64) 32)))))
                                         (ite (< temp___569 4294967296)
                                         (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___569))
