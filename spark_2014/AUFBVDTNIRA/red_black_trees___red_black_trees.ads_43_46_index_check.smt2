...
;; def_axiom
  ...
  (= (select (temp___390 temp___392) temp___393) (of_rep3 temp___392)))))
...
;; def_axiom
  ...
  (= (select (temp___502 temp___504) temp___505) (of_rep temp___504)))))
...
(define-fun default_initial_assumption ((temp___expr_493 us_rep3)
...
(define-fun type_invariant ((temp___507 us_rep3)) Bool (= (invariant__
                                                          temp___507) true))
  ...
  (! (= (= (same_nb_blacks t1) true)
     ...
     (= (rec__tree_model__path_type__k
        ...
        (let ((temp___538 (model__
                          (rec__red_black_trees__rbt__struct
                          (us_split_fields7 t1)))))
        (select temp___538 i1)))) true)
     (= (rec__red_black_trees__black_count__status
        (us_split_fields9
        (let ((temp___537 (nb_blacks t1))) (select temp___537 i1)))) true)))))) :pattern (
  (same_nb_blacks t1)) )))
...
(define-fun dynamic_invariant7 ((temp___expr_207 us_rep6)
...
(define-fun default_initial_assumption1 ((temp___expr_209 us_rep6)
...
(define-fun dynamic_invariant8 ((temp___expr_218 (Array Int us_rep6))
...
(define-fun default_initial_assumption2 ((temp___expr_221 (Array Int us_rep6))
...
(define-fun default_initial_assumption3 ((temp___expr_201 us_rep5)
...
(define-fun dynamic_invariant10 ((temp___expr_378 us_rep2)
...
(define-fun default_initial_assumption4 ((temp___expr_383 us_rep2)
...
(define-fun type_invariant1 ((temp___395 us_rep2)) Bool (ite (= (size
                                                                (rec__search_trees__search_tree__struct
                                                                (us_split_fields5
                                                                temp___395))) 0)
                                                        (= (to_rep1
...
;; size__post_axiom
  (assert
  (forall ((t1 us_rep2))
  (! (=> (dynamic_invariant10 t1 true true true) (dynamic_invariant
...
;; model____post_axiom
  ...
  (! (=> (and (dynamic_invariant10 t1 true true true) (not (= (size1 t1) 0)))
     (dynamic_invariant8 (model__ t1) true false true)) :pattern ((model__
                                                                  t1)) )))
...
;; peek__post_axiom
  ...
  (! (=>
     ...
     (= (rec__tree_model__path_type__k
        (us_split_fields11
        (let ((temp___422 (model__ t1))) (select temp___422 i1)))) true)))
     (dynamic_invariant (peek t1 i1 d) true false true)) :pattern ((peek t1
                                                                   i1 d)) ))))
...
;; size__post_axiom
  (assert
  (forall ((f us_rep1))
  (! (=> (dynamic_invariant11 f true true true) (dynamic_invariant (size f)
...
;; position__post_axiom
  ...
  (! (=>
     (and
     (and (dynamic_invariant11 f true true true) (dynamic_invariant4 i1 true
     true true)) (not (= (parent1 f i1) 0))) (dynamic_invariant6
...
;; peek__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant result true false true)))) :pattern ((peek1 f i1 d)) ))))
