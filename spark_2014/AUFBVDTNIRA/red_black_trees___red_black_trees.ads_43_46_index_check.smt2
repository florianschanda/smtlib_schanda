...
;; range_axiom
  (assert
  (forall ((x color_type)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)) )))
...
(declare-datatypes ()
((map__ref (mk_map__ref (map__content (Array Int color_type))))))
...
(declare-fun concat1 ((Array Int color_type) Int Int (Array Int color_type)
...
(define-fun bool_eq3 ((a (Array Int color_type)) (a__first Int) (a__last Int)
  (b (Array Int color_type)) (b__first Int)
...
(declare-fun compare ((Array Int color_type) Int Int (Array Int color_type)
  Int Int) Int)
...
(define-fun bool_eq9 ((a (Array Int natural)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (to_rep3 (select a temp___idx_134)) (to_rep3
...
;; def_axiom
  ...
  (= (select (temp___584 temp___586) temp___587) (of_rep3 temp___586)))))
...
;; def_axiom
  ...
  (= (select (temp___926 temp___928) temp___929) (of_rep temp___928)))))
...
(define-fun default_initial_assumption ((temp___expr_915 us_rep3)
...
(define-fun type_invariant ((temp___931 us_rep3)) Bool (= (invariant__
                                                          temp___931) true))
...
;; slide_def
  ...
  (forall ((new_first Int))
  (forall ((i1 Int))
  (! (= (select (slide3 a old_first new_first) i1) (select a (- i1 (- new_first old_first)))) :pattern ((select 
  (slide3 a old_first new_first) i1)) ))))))
...
;; concat_def
  ...
  (! (and
     ...
     (= (select (concat4 a a_first a_last b b_first b_last) i1) (select a i1)))
     (=> (< a_last i1)
     (= (select (concat4 a a_first a_last b b_first b_last) i1) (select b (+ (- i1 a_last) (- b_first 1)))))) :pattern ((select 
  (concat4 a a_first a_last b b_first b_last) i1)) )))))
...
;; singleton_def
  ...
  (forall ((v us_rep4))
  (forall ((i1 Int))
  (! (= (select (singleton4 v i1) i1) v) :pattern ((select (singleton4 v i1) i1)) ))))
...
;; slide_def
  ...
  (forall ((new_first Int))
  (forall ((i1 Int))
  (! (= (select (slide4 a old_first new_first) i1) (select a (- i1 (- new_first old_first)))) :pattern ((select 
  (slide4 a old_first new_first) i1)) ))))))
...
;; concat_def
  ...
  (! (and
     (=> (and (<= a_first i1) (<= i1 a_last))
     (= (select (concat5 a a_first a_last b b_first b_last) i1) (select a i1)))
     (=> (< a_last i1)
     (= (select (concat5 a a_first a_last b b_first b_last) i1) (select b (+ (- i1 a_last) (- b_first 1)))))) :pattern ((select 
  (concat5 a a_first a_last b b_first b_last) i1)) )))))
...
;; singleton_def
  ...
  (forall ((v us_rep6))
  (forall ((i1 Int))
  (! (= (select (singleton5 v i1) i1) v) :pattern ((select (singleton5 v i1) i1)) ))))
...
;; nb_blacks__post_axiom
  ...
  (! (and (size__function_guard1
     ...
     (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i1 0)
     (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i1 0))
     (and
     (forall ((i1 Int)) (peek__function_guard
     (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i1 1)
     (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i1 1))
     (and
     (forall ((i1 Int)) (peek__function_guard
     (peek (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i1 0)
     (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i1 0))
     ...
     (= (bool_eq12 (select result 0)
        (mk___rep4 (mk___split_fields4 (of_int 1) (of_rep1 0) (of_rep1 0)))) true)
     (forall ((i1 Int))
     (=> (and (<= 1 i1) (<= i1 100))
     (=>
     (= (rec__tree_model__path_type__k
        ...
        (let ((temp___1035 (model__
                           (rec__red_black_trees__rbt__struct
                           (us_split_fields7 t1)))))
        (select temp___1035 i1)))) true)
     (and
     (and
     (=
     (= (rec__red_black_trees__black_count__status
        (us_split_fields9 (select result i1))) true)
     (= (to_rep1
        (rec__red_black_trees__black_count__count
        (us_split_fields9
        (select result (peek
                       (rec__red_black_trees__rbt__struct
                       (us_split_fields7 t1)) i1 0))))) (to_rep1
                                                        (rec__red_black_trees__black_count__count
                                                        (us_split_fields9
                                                        (select result 
                                                        (peek
     ...
     (= (to_rep1
        (rec__red_black_trees__black_count__depth
        (us_split_fields9 (select result i1)))) (+ 1 (ite (< (to_rep1
                                                             (rec__red_black_trees__black_count__depth
                                                             (us_split_fields9
                                                             (select result 
                                                             (peek
     ...
     (= (to_rep1
        (rec__red_black_trees__black_count__count
        (us_split_fields9 (select result i1)))) (+ (ite (= (to_rep
                                                           (let ((temp___1032 
                                                           (rec__red_black_trees__rbt__color
                                                           (us_split_fields7
                                                           t1))))
                                                           (select temp___1032 i1))) 0)
                                                   1 0) (to_rep1
                                                        (rec__red_black_trees__black_count__count
                                                        (us_split_fields9
                                                        (select result 
  ...
  (! (=> (same_nb_blacks__function_guard (same_nb_blacks t1) t1)
     ...
     (= (rec__tree_model__path_type__k
        ...
        (let ((temp___986 (model__
                          (rec__red_black_trees__rbt__struct
                          (us_split_fields7 t1)))))
        (select temp___986 i1)))) true)
     (= (rec__red_black_trees__black_count__status
        (us_split_fields9
        (let ((temp___984 (nb_blacks t1))) (select temp___984 i1)))) true)))))))))) :pattern (
  (same_nb_blacks t1)) )))
...
;; invariant____def_axiom
  ...
  (! (=> (invariant____function_guard (invariant__ t1) t1)
     ...
     (parent (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i1)
     (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i1))
     (and
     (forall ((i1 Int)) (parent__function_guard
     (parent (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i1)
     (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i1))
     ...
     (=>
     (or
     (= (parent (rec__red_black_trees__rbt__struct (us_split_fields7 t1)) i1) 0)
     (= (to_rep
...
(define-fun dynamic_invariant4 ((temp___expr_157 Int)
  ...
  (temp___do_toplevel_156 Bool)) Bool (=>
                                      ...
                                      (<= 1 100)) (in_range temp___expr_157)))
...
(define-fun dynamic_invariant7 ((temp___expr_212 us_rep6)
...
(define-fun default_initial_assumption1 ((temp___expr_214 us_rep6)
...
(define-fun dynamic_invariant8 ((temp___expr_223 (Array Int us_rep6))
...
(define-fun default_initial_assumption2 ((temp___expr_226 (Array Int us_rep6))
...
(define-fun default_initial_assumption3 ((temp___expr_206 us_rep5)
...
(define-fun dynamic_invariant9 ((temp___expr_151 Int)
...
(define-fun dynamic_invariant10 ((temp___expr_567 us_rep2)
...
(define-fun default_initial_assumption4 ((temp___expr_576 us_rep2)
...
(define-fun type_invariant1 ((temp___590 us_rep2)) Bool (ite (= (size
                                                                (rec__search_trees__search_tree__struct
                                                                (us_split_fields5
                                                                temp___590))) 0)
                                                        (= (to_rep1
...
;; size__post_axiom
  ...
  (! (=> (dynamic_invariant10 t1 true true true)
     (let ((result (size1 t1)))
     (=> (size__function_guard1 result t1) (dynamic_invariant result true
...
;; parent__post_axiom
  ...
  (forall ((i1 Int))
  (! (=>
     (and (dynamic_invariant10 t1 true true true) (dynamic_invariant4 i1 true
     true true))
     (let ((result (parent t1 i1)))
     (and (size__function_guard1 (size1 t1) t1)
     (=> (parent__function_guard result t1 i1)
     (and (=> (= (size1 t1) 0) (= result 0)) (dynamic_invariant result true
     false true)))))) :pattern ((parent t1 i1)) ))))
...
;; parent__def_axiom
  ...
  (! (=>
     (and
     (and (dynamic_invariant10 t1 true true true) (dynamic_invariant4 i1 true
     true true)) (parent__function_guard (parent t1 i1) t1 i1))
     (and (parent__function_guard1
     (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 t1))
     i1) (rec__search_trees__search_tree__struct (us_split_fields5 t1)) i1)
     (= (parent t1 i1) (parent1
                       (rec__search_trees__search_tree__struct
                       (us_split_fields5 t1)) i1)))) :pattern ((parent t1 i1)) ))))
...
;; model____post_axiom
  ...
  (forall ((t1 us_rep2))
  (! (and (size__function_guard1 (size1 t1) t1)
     (=> (and (dynamic_invariant10 t1 true true true) (not (= (size1 t1) 0)))
     (let ((result (model__ t1)))
     (=> (model____function_guard result t1) (dynamic_invariant8 result true
...
;; model____def_axiom
  ...
  (forall ((t1 us_rep2))
  (! (=>
     (and (dynamic_invariant10 t1 true true true) (model____function_guard
     (model__ t1) t1))
     (and (model____function_guard1
     (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 t1))
     (to_rep1 (rec__search_trees__search_tree__root (us_split_fields5 t1))))
     (rec__search_trees__search_tree__struct (us_split_fields5 t1))
     (to_rep1 (rec__search_trees__search_tree__root (us_split_fields5 t1))))
     (= (model__ t1) (model__1
                     (rec__search_trees__search_tree__struct
...
;; peek__post_axiom
  ...
  (! (and (size__function_guard1 (size1 t1) t1)
     ...
     (and
     (and (dynamic_invariant10 t1 true true true) (dynamic_invariant4 i1 true
     true true)) (dynamic_invariant6 d true true true))
     (and (not (= (size1 t1) 0))
     (= (rec__tree_model__path_type__k
        (us_split_fields11
        (let ((temp___640 (model__ t1))) (select temp___640 i1)))) true)))
     (let ((result (peek t1 i1 d)))
     (=> (peek__function_guard result t1 i1 d) (dynamic_invariant result true
     false true)))))) :pattern ((peek t1 i1 d)) ))))
...
;; peek__def_axiom
  ...
  (! (=>
     ...
     (and
     (and (dynamic_invariant10 t1 true true true) (dynamic_invariant4 i1 true
     true true)) (dynamic_invariant6 d true true true)) (peek__function_guard
     (peek t1 i1 d) t1 i1 d))
     (and (peek__function_guard1
     (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 t1)) i1
     d) (rec__search_trees__search_tree__struct (us_split_fields5 t1)) i1 d)
     (= (peek t1 i1 d) (peek1
                       (rec__search_trees__search_tree__struct
                       (us_split_fields5 t1)) i1 d)))) :pattern ((peek t1 i1
                                                                 d)) ))))
...
;; valid_root__post_axiom
  ...
  (forall ((i1 Int))
  (! (=>
     (and (dynamic_invariant11 f true true true) (dynamic_invariant4 i1 true
     true true))
...
;; parent__post_axiom
  ...
  (! (=>
     (and (dynamic_invariant11 f true true true) (dynamic_invariant4 i1 true
     true true))
     (let ((result (parent1 f i1)))
     (and (valid_root__function_guard (valid_root f i1) f i1)
     (and (size__function_guard (size f) f)
     (=> (parent__function_guard1 result f i1)
     (and
     (and (=> (= (valid_root f i1) true) (= result 0))
     (=> (= (size f) 0) (= result 0))) (dynamic_invariant result true false
     true))))))) :pattern ((parent1 f i1)) ))))
...
;; position__post_axiom
  ...
  (forall ((f us_rep1))
  (forall ((i1 Int))
  (! (and (parent__function_guard1 (parent1 f i1) f i1)
     (=>
     (and
     (and (dynamic_invariant11 f true true true) (dynamic_invariant4 i1 true
     true true)) (not (= (parent1 f i1) 0)))
     (let ((result (position f i1)))
     (=> (position__function_guard result f i1) (dynamic_invariant6 result
     true false true))))) :pattern ((position f i1)) ))))
...
;; peek__post_axiom
  ...
  (! (=>
     ...
     (and (forall ((j Int)) (parent__function_guard1 (parent1 f j) f j))
     (and (forall ((j Int)) (position__function_guard (position f j) f j))
     (=> (peek__function_guard1 result f i1 d)
     (and
     (and
     (ite (not (= result 0))
     (and (= (position f result) d) (= (parent1 f result) i1))
     (forall ((j Int))
     (=> (and (<= 1 j) (<= j 100))
     (=> (= (parent1 f j) i1) (not (= (position f j) d))))))
     (forall ((j Int))
     (=> (and (<= 1 j) (<= j 100))
     (=> (and (= (parent1 f j) i1) (= (position f j) d)) (= result j)))))
     (dynamic_invariant result true false true))))))))))) :pattern ((peek1 f
                                                                    i1 d)) ))))
...
;; model____post_axiom
  ...
  (! (and (valid_root__function_guard (valid_root f root) f root)
     ...
     (and (forall ((i1 Int)) (parent__function_guard1 (parent1 f i1) f i1))
     (and (forall ((i1 Int)) (parent__function_guard1 (parent1 f i1) f i1))
     (and (forall ((i1 Int)) (parent__function_guard1 (parent1 f i1) f i1))
     ...
     (is_add
     (rec__tree_model__path_type__a
     (us_split_fields11 (select result (parent1 f i1)))) (position f i1)
     (rec__tree_model__path_type__a (us_split_fields11 (select result i1))))
     (rec__tree_model__path_type__a
     (us_split_fields11 (select result (parent1 f i1)))) (position f i1)
     (rec__tree_model__path_type__a (us_split_fields11 (select result i1)))))
     ...
     (=> (and (<= 1 i1) (<= i1 100))
     (=> (not (= i1 root))
     (ite (and (not (= (parent1 f i1) 0))
          (= (rec__tree_model__path_type__k
             (us_split_fields11 (select result (parent1 f i1)))) true))
     (= (rec__tree_model__path_type__k
        (us_split_fields11 (select result i1))) true)
     (not
     (= (rec__tree_model__path_type__k
        (us_split_fields11 (select result i1))) true))))))
     (and
     ...
     (= (length
        (rec__tree_model__path_type__a
        (us_split_fields11 (select result i1)))) 0))))
     (forall ((i1 Int))
     (=> (and (<= 1 i1) (<= i1 100))
     (=>
     (= (rec__tree_model__path_type__k
     ...
     (= (oeq
        (rec__tree_model__path_type__a
        (us_split_fields11 (select result i1)))
...
(assert
;; WP_parameter_def
 ;; File "red_black_trees.ads", line 33, characters 0-0
  (not (<= 1 i)))
(check-sat)
