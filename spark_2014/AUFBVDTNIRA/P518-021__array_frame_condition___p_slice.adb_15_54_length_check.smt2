...
(define-fun bool_eq9 ((x us_t2)
  (y1 us_t2)) Bool (bool_eq2 (elts2 x) (to_rep (first4 (rt2 x)))
...
;; H
  ...
  (= (select x3 temp___264) (select x2 temp___264))
  ...
  (get (select x2 temp___264) temp___265 temp___266) temp___267)))))))))))
  (and (<= 1 i212) (<= i212 3))))
...
;; H
  ...
  (get (select x3 temp___257) temp___258 temp___259) temp___260)))))))))))
  (and (<= 1 i222) (<= i222 3))))
...
;; H
  ...
  (get (select x4 temp___250) temp___251 temp___252) temp___253)))))))))))
  (and (<= 1 i12) (<= i12 3))))
...
;; H
  (assert (= (mk___t1 temp___237 temp___2371) (temp___230 1 i12 2)))
