...
;; H
  ...
  (<= (to_rep1
      ...
      (to_rep2 (select (map__content f8) k1)))))) k1)
  (<= k1 (to_rep1
         (rec__partition_refinement__interval__last
         (us_split_fields1
         (get
         ...
         (mk___rep1 p__split_discrs
         (us_split_fields__content1 p__split_fields4)))
         (to_rep2 (select (map__content f8) k1)))))))))))
...
;; H
  ...
  (= o23 (get
         (model__
         (mk___rep1 p__split_discrs
         (us_split_fields__content1 p__split_fields4))) o22))
  (= (bool_eq5 o23
     (get
     (model__
     (mk___rep1 p__split_discrs (us_split_fields__content1 p__split_fields4)))
...
;; H
  (assert (= o25 (rec__partition_refinement__interval__last o24)))

;; H
  (assert (= o26 (to_rep1 o25)))

;; H
  (assert (= o27 (ite (<= l o26) true false)))
...
;; H
  ...
  (= o18 (get
         (model__
         (mk___rep1 p__split_discrs
         (us_split_fields__content1 p__split_fields4))) o17))
  (= (bool_eq5 o18
     (get
     (model__
     (mk___rep1 p__split_discrs (us_split_fields__content1 p__split_fields4)))
...
;; H
  (assert (= o20 (rec__partition_refinement__interval__first o19)))

;; H
  (assert (= o21 (to_rep1 o20)))

;; H
  (assert (= o28 (ite (<= o21 l) true false)))

;; H
  (assert (= result11 (ite (= o28 true) o27 false)))
