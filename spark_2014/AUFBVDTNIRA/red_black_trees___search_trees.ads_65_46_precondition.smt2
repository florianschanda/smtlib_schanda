...
;; H
  (assert
  (=> (= (int__content i14) 0)
  (and (= result19 (oeq1 o31 o32))
  (= (= result19 true) (and (= (ole o31 o32) true) (= (ole o32 o31) true))))))
...
;; H
  ...
  (parent
  (rec__search_trees__search_tree__struct
  (us_split_fields__content3 t__split_fields14)) j)
  (rec__search_trees__search_tree__struct
  (us_split_fields__content3 t__split_fields14)) j))
...
;; H
  ...
  (and
  (and
  (= o29 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14))
         j))
  (parent__function_guard1 o29
