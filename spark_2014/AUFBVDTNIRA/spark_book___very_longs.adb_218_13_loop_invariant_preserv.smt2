...
(declare-datatypes ()
((t60b__ref (mk_t60b__ref (t60b__content tdigit_count_typeB)))))
(define-fun t60b__ref___projection ((a t60b__ref)) tdigit_count_typeB 
  (t60b__content a))
...
;; H
  ...
  (= (to_rep1
     (select (elts
             (rec__very_longs__very_long__long_digits
             (us_split_fields1 number))) digit_count3)) ((_ int2bv 8) 0)))
  (and (<= 1 digit_count3) (<= digit_count3 index2))))
  (=> (< digit_count3 index2)
  (forall ((j Int))
  (=> (and (<= (+ digit_count3 1) j) (<= j index2))
  (= (to_rep1
     (select (elts
             (rec__very_longs__very_long__long_digits
             (us_split_fields1 number))) j)) ((_ int2bv 8) 0)))))))
...
;; H
  ...
  index2)) (=> (<= 0 65536) (in_range1 digit_count3)))
  (and (<= 1 index2)
  (<= index2 (to_rep2
             (last1
             (rt
...
;; H
  ...
  (= o7 (select (elts
                (rec__very_longs__very_long__long_digits
                (us_split_fields1 number))) o6)))

;; H
  (assert (= o8 (to_rep1 o7)))

;; H
  (assert (= o9 (ite (= o8 ((_ int2bv 8) 0)) true false)))

;; H
  (assert (= result6 (ite (not (= o9 true)) true false)))

;; H
  (assert (=> (= result6 true) (and (= o10 index3) (in_range1 index3))))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 7, characters 0-0
  ...
  (= (to_rep1
     (select (elts
             (rec__very_longs__very_long__long_digits
             (us_split_fields1 number))) digit_count4)) ((_ int2bv 8) 0)))))
(check-sat)
