...
(declare-fun dummy1 () tarr_badD1)

(declare-datatypes ()
((tarr_badD1__ref (mk_tarr_badD1__ref (tarr_badD1__content tarr_badD1)))))
...
(declare-fun i25s () (Array Int integer))
...
(declare-fun preds__rec_bad__i__first__bit () Int)

(declare-fun preds__rec_bad__i__last__bit () Int)

(declare-fun preds__rec_bad__i__position () Int)
...
(declare-fun preds__rec_bad__x__first__bit () Int)

(declare-fun preds__rec_bad__x__last__bit () Int)

(declare-fun preds__rec_bad__x__position () Int)
...
(declare-fun preds__rec_bad__a__first__bit () Int)

(declare-fun preds__rec_bad__a__last__bit () Int)

(declare-fun preds__rec_bad__a__position () Int)
...
(declare-datatypes ()
((rec_bad__ref (mk_rec_bad__ref (rec_bad__content us_rep)))))
...
(declare-fun x__split_fields1 () int_bad)

(declare-fun x__split_fields2 () (Array Int integer))

(declare-fun temp___370 () int_bad)
...
;; WP_parameter_def
 ;; File "preds.adb", line 51, characters 0-0
  (not
  (or (and (<= (- 2147483648) temp___372) (<= temp___372 (- 1)))
  (and (<= 1 temp___372) (<= temp___372 2147483647)))))
(check-sat)
