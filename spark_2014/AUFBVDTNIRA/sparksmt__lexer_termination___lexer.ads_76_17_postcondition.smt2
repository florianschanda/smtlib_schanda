...
(define-fun dynamic_invariant3 ((temp___expr_579 Int)
...
(declare-fun temp___802 () read_status)

(declare-fun temp___8021 () character)

(declare-fun temp___8022 () Bool)
...
;; H
  (assert (size__function_guard (size the_file1) the_file1))

;; H
  (assert (size__function_guard (size the_file) the_file))

;; H
  (assert (index__function_guard (index the_file1) the_file1))
...
;; H
  (assert
  (and (and (= o (index the_file1)) (index__function_guard o the_file1))
  (and (in_range1 o) (<= o (size the_file1)))))
...
;; H
  ...
  (=>
  (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0)
  (and (and (= o1 (index the_file2)) (index__function_guard o1 the_file2))
...
;; H
  ...
  (not
  (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0))
  (= next_read__attr__constrained temp___8022)))
...
;; H
  ...
  (not
  (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0))
  (= next_read__split_fields2 (mk___split_fields temp___8021))))
...
;; H
  ...
  (not
  (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0))
  (= next_read__split_discrs2 (mk___split_discrs temp___802))))
...
;; H
  ...
  (int__content the_filename2) (file__content the_file3)
  ...
  (int__content next_idx3)) (us_private__content name_table2)
  (int__content the_filename2) (file__content the_file3)
  (us_split_fields__content current_read__split_fields1)
  (us_split_discrs__content current_read__split_discrs1)
  (int__content current_line3) (int__content current_col3)
