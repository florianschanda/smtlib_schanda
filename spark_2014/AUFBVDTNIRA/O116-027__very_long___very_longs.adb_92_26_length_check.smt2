...
(declare-fun last10 (t3) tdigit_count_typeB)
...
;; mk_def
  ...
  (! (=> (in_range1 f)
     (=> (in_range1 l1)
     (and (= (to_rep2 (first7 (mk3 f l1))) f)
     (= (to_rep2 (last10 (mk3 f l1))) l1)))) :pattern ((mk3 f l1)) )))
...
(define-fun length3 ((a us_t3)) Int (ite (<= (first8 a) (last11 a))
...
(define-fun bool_eq13 ((x us_t3)
  (y us_t3)) Bool (bool_eq3 (elts3 x) (to_rep2 (first7 (rt3 x)))
                  ...
                  (to_rep2 (first7 (rt3 y))) (to_rep2 (last10 (rt3 y)))))
...
(declare-fun temp___1152 ((_ BitVec 8) Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___1154 (_ BitVec 8)))
  (forall ((temp___1155 Int) (temp___1156 Int))
  (let ((temp___1153 (temp___1152 temp___1154 temp___1155 temp___1156)))
  (and
  (=> (dynamic_property7 1 65536 temp___1155 temp___1156)
  (and (= (first5 temp___1153) temp___1155)
  (= (last8 temp___1153) temp___1156)))
  (forall ((temp___1157 Int))
  (= (select (to_array2 temp___1153) temp___1157) (of_rep1 temp___1154))))))))

(define-fun dynamic_invariant4 ((temp___expr_376 us_t1)
  ...
  (temp___do_toplevel_375 Bool)) Bool (=>
                                      ...
                                      (first3 temp___expr_376)
                                      (last5 temp___expr_376))
                                      (and (= (first3 temp___expr_376) 1)
                                      (= (last5 temp___expr_376) r19b)))))
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___1152 ((_ int2bv 8) 0) 1 r19b)))) 1))

;; H
  (assert
  (= (to_rep2 (last7 (rt2 (temp___1152 ((_ int2bv 8) 0) 1 r19b)))) r19b))

;; H
  (assert
  (= (mk___t2 temp___1159 temp___11591) (temp___1152 ((_ int2bv 8) 0) 1 r19b)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___11591)) (to_rep2 (last7 temp___11591)))
     (+ (- (to_rep2 (last7 temp___11591)) (to_rep2 (first4 temp___11591))) 1)
     0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0)))

;; H
  (assert (= temp___1159 temp___1160))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___11591)) (to_rep2 (last7 temp___11591))) 
  temp___11601))
...
;; WP_parameter_def
 ;; File "very_longs.adb", line 49, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first2 temp___11601)) (to_rep2 (last4 temp___11601)))
     (+ (- (to_rep2 (last4 temp___11601)) (to_rep2 (first2 temp___11601))) 1)
     0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2
                                                           (last1
                                                           result____split_fields1)))
        (+ (- (to_rep2 (last1 result____split_fields1)) (to_rep2
                                                        (first
