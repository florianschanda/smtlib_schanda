...
;; H
  (assert
  (and (= o51 (from_word32 carry22)) (from_word32__function_guard o51
  carry22)))

;; H
  (assert
  (and (and (= o50 (base Tuple0)) (base__function_guard o50 Tuple0))
  (= o50 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o52 (omultiply o50 o51)) (omultiply__function_guard o52 o50 o51)))

;; H
  (assert
  (and (= o49 (from_word32 carry12)) (from_word32__function_guard o49
  carry12)))

;; H
  (assert (and (= o53 (oadd o49 o52)) (oadd__function_guard o53 o49 o52)))
...
;; H
  (assert
  (and (= o48 (oexpon o43 o47)) (oexpon__function_guard o48 o43 o47)))

;; H
  (assert
  (and (= o54 (omultiply o48 o53)) (omultiply__function_guard o54 o48 o53)))
...
;; H
  (assert
  (and
  (= o42 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))
         a_first o41))
  (num_of_big_int__function_guard o42
  (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o41)))

;; H
  (assert (and (= o55 (oadd o42 o54)) (oadd__function_guard o55 o42 o54)))
...
;; H
  (assert
  (and (= o36 (from_word32 carry2)) (from_word32__function_guard o36 carry2)))

;; H
  (assert
  (and (and (= o35 (base Tuple0)) (base__function_guard o35 Tuple0))
  (= o35 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o37 (omultiply o35 o36)) (omultiply__function_guard o37 o35 o36)))

;; H
  (assert
  (and (= o34 (from_word32 carry1)) (from_word32__function_guard o34 carry1)))

;; H
  (assert (and (= o32 (from_word32 y)) (from_word32__function_guard o32 y)))
...
;; H
  (assert
  (and (= o31 (num_of_big_int c c_first o30)) (num_of_big_int__function_guard
  o31 c c_first o30)))

;; H
  (assert
  (and (= o33 (omultiply o31 o32)) (omultiply__function_guard o33 o31 o32)))

;; H
  (assert (and (= o25 (from_word32 x)) (from_word32__function_guard o25 x)))
...
;; H
  (assert
  (and (= o24 (num_of_big_int b b_first o23)) (num_of_big_int__function_guard
  o24 b b_first o23)))
