...
(declare-fun temp___387 () index)

(declare-fun temp___3871 () (Array Int value))

(declare-fun temp___3872 () (Array Int value))
...
(declare-fun temp___390 () index)

(declare-fun temp___3901 () (Array Int value))

(declare-fun temp___3902 () (Array Int value))
...
;; H
  (assert (= temp___387 o2))

;; H
  (assert (= temp___3871 o3))

;; H
  (assert (= temp___3872 o4))
...
;; H
  (assert (= temp___387 a__split_fields3))

;; H
  (assert (= temp___3871 a__split_fields4))

;; H
  (assert (= temp___3872 a__split_fields5))
...
;; H
  (assert (= temp___390 o7))

;; H
  (assert (= temp___3901 o8))

;; H
  (assert (= temp___3902 o9))
...
;; H
  (assert (= temp___390 a__split_fields6))

;; H
  (assert (= temp___3901 a__split_fields7))

;; H
  (assert (= temp___3902 a__split_fields8))
