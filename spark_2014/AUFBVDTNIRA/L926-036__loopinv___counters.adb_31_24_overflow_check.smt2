...
;; H
  (assert
  (not (= (to_rep2 (rec__counters__counter__mode c__split_discrs)) 1)))

;; H
  (assert
  (not (= (to_rep2 (rec__counters__counter__mode c__split_discrs)) 3)))

;; H
  (assert (= (to_rep2 (rec__counters__counter__mode c__split_discrs)) 4))
