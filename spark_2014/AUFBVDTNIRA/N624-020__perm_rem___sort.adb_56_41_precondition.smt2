...
;; H
  ...
  (remove__function_guard o41 (mk___t values2 (mk 1 100)) o40))
...
;; H
  (assert
  (and (and (= o43 (remove o41 o42)) (remove__function_guard o43 o41 o42))
...
;; H
  ...
  (remove__function_guard o37 (mk___t values2 (mk 1 100)) o36))
...
;; H
  (assert
  (and (and (= o39 (remove o37 o38)) (remove__function_guard o39 o37 o38))
