...
(declare-fun c98b () us_rep1)

(declare-fun attr__ATTRIBUTE_ADDRESS4 () Int)

(declare-fun c99b () us_rep1)

(declare-fun attr__ATTRIBUTE_ADDRESS5 () Int)

(declare-fun r101b () Int)
...
(declare-datatypes ()
((t102b__ref (mk_t102b__ref (t102b__content integer)))))
(define-fun t102b__ref___projection ((a t102b__ref)) integer (t102b__content
                                                             a))
...
(declare-fun o3 () us_rep2)

(declare-fun list_mod_allocator__free__ma__assume () us_rep1)
...
(declare-fun o18 () (Array Int us_rep))
...
(declare-fun list_mod_allocator__free__C99b__assume () us_rep1)

(declare-fun list_mod_allocator__free__B100b__L_4__R101b__assume () Int)

(declare-fun temp___389 () Int)
...
(declare-fun first_available5 () int__ref)

(declare-fun i10 () int__ref)

(declare-fun data6 () (Array Int us_rep))

(declare-fun first_available6 () Int)

(declare-fun i11 () Int)

(define-fun o22 () us_rep3 (mk___rep1 (mk___split_fields1 o19 o20)))

(define-fun o23 () us_rep3 (mk___rep1 (mk___split_fields1 o o1)))
...
;; H
  ...
  (model_is_well_formed o23 data first_available) o23 data first_available))

;; H
  (assert (model_is_well_formed__function_guard
  (model_is_well_formed o22 data2 first_available2) o22 data2
  first_available2))

;; H
  (assert
  (and
  (and (= o23 (model__ data first_available)) (model____function_guard 
  o23 data first_available))
  (= (model_is_well_formed o23 data first_available) true)))
...
;; H
  (assert
  (=> (not (= res 0))
  (= (mk___rep (mk___split_fields o5 o6)) (select data o4))))
...
;; H
  (assert (=> (= result true) (= (to_rep o11) first_available)))

;; H
  (assert (=> (= result true) (= (to_rep1 o12) 0)))

;; H
  (assert (=> (= result true) (= o12 o13)))

;; H
  (assert (=> (= result true) (= o11 o14)))

;; H
  (assert (=> (= result true) (= o15 o13)))
...
;; H
  (assert (=> (= result true) (= o17 res)))

;; H
  (assert
  (=> (= result true)
  (= o18 (store data o17 (mk___rep (mk___split_fields o15 o16))))))

;; H
  (assert (=> (= result true) (= result1 data7)))

;; H
  (assert (=> (= result true) (= data2 o18)))

;; H
  (assert (=> (= result true) (= result2 first_available7)))

;; H
  (assert (=> (= result true) (= first_available2 res)))

;; H
  (assert (=> (= result true) (= ma c98b)))

;; H
  (assert
  (=> (= result true)
  (and
  (and (= o22 (model__ data2 first_available2)) (model____function_guard 
  o22 data2 first_available2))
  (= (model_is_well_formed o22 data2 first_available2) true))))

;; H
  (assert (=> (= result true) (= o21 (mk___split_fields1 o19 o20))))

;; H
  (assert
  (=> (= result true)
  (= list_mod_allocator__free__C99b__assume (rec__list_mod_allocator__m__t__available
                                            o21))))

;; H
  (assert
  (=> (= result true) (= list_mod_allocator__free__C99b__assume c99b)))

;; H
  (assert
  (=> (= result true)
  (and (= list_mod_allocator__free__B100b__L_4__R101b__assume (length c98b))
  (and (in_range5 list_mod_allocator__free__B100b__L_4__R101b__assume)
  (<= (+ 0 list_mod_allocator__free__B100b__L_4__R101b__assume) 2147483647)))))

;; H
  (assert
  (=> (= result true)
  (= list_mod_allocator__free__B100b__L_4__R101b__assume r101b)))

;; H
  (assert (=> (= result true) (in_range1 r101b)))

;; H
  (assert (=> (= result true) (= result3 i12)))

;; H
  (assert (=> (= result true) (= i2 1)))

;; H
  (assert
  (=> (= result true) (=> (and (<= 1 i2) (<= i2 r101b)) (= temp___389 i2))))

;; H
  (assert
  (=> (= result true)
  (=> (and (<= 1 i2) (<= i2 r101b)) (<= (+ i3 1) (length c99b)))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 r101b))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j i3)) (= (get c98b j) (get c99b (+ j 1))))))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 r101b))
  (forall ((j Int))
  (=> (and (<= 2 j) (<= j (+ i3 1))) (= (get c98b (- j 1)) (get c99b j)))))))

;; H
  (assert
  (=> (= result true)
  (=> (and (<= 1 i2) (<= i2 r101b))
  (and (=> (<= 1 r101b) (dynamic_property 1 r101b i3))
  (and (<= 1 i3) (<= i3 r101b))))))
...
;; H
  ...
  (= (get c99b j) (to_rep
                  (rec__list_mod_allocator__cell__next
                  (us_split_fields1 (select data2 (get c98b i3))))))))))))

;; H
  (assert
  (=> (= result true) (=> (and (<= 1 i2) (<= i2 r101b)) (= i3 r101b))))

;; H
  (assert
  (=> (= result true)
  (=> (and (<= 1 i2) (<= i2 r101b)) (= i4 (mk_int__ref i3)))))

;; H
  (assert (=> (= result true) (=> (and (<= 1 i2) (<= i2 r101b)) (= i5 i3))))

;; H
  (assert (=> (= result true) (=> (and (<= 1 i2) (<= i2 r101b)) (= i6 i4))))

;; H
  (assert (=> (= result true) (=> (and (<= 1 i2) (<= i2 r101b)) (= i7 i5))))

;; H
  (assert
  (=> (= result true)
  (=> (not (and (<= 1 i2) (<= i2 r101b))) (= i6 (mk_int__ref i2)))))

;; H
  (assert
  (=> (= result true) (=> (not (and (<= 1 i2) (<= i2 r101b))) (= i7 i2))))

;; H
  (assert (=> (= result true) (= i8 i6)))

;; H
  (assert
  (=> (= result true) (= first_available3 (mk_int__ref first_available2))))

;; H
  (assert (=> (= result true) (= data3 (mk_map__ref data2))))

;; H
  (assert (=> (= result true) (= i9 i7)))

;; H
  (assert (=> (= result true) (= first_available4 first_available2)))

;; H
  (assert (=> (= result true) (= data4 data2)))

;; H
  (assert (=> (not (= result true)) (= i8 i12)))

;; H
  (assert (=> (not (= result true)) (= first_available3 first_available7)))

;; H
  (assert (=> (not (= result true)) (= data3 data7)))

;; H
  (assert (=> (not (= result true)) (= i9 i1)))

;; H
  (assert (=> (not (= result true)) (= first_available4 first_available1)))
...
;; H
  ...
  (= (contains
     (rec__list_mod_allocator__m__t__allocated
     (us_split_fields3 (model__ data first_available))) res) true))

;; H
  (assert (is_well_formed__function_guard
  (is_well_formed (map__content data5) (int__content first_available5))
  (map__content data5) (int__content first_available5)))

(assert
;; WP_parameter_def
 ;; File "list_mod_allocator.ads", line 17, characters 0-0
  (not
  (= (is_well_formed (map__content data5) (int__content first_available5)) true)))
(check-sat)
