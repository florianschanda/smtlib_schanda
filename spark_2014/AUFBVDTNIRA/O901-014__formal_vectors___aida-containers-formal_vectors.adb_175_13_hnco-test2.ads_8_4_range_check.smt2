...
(define-fun dynamic_invariant4 ((temp___expr_732 Int)
...
(declare-fun user_eq8 (extended_index2 extended_index2) Bool)
...
(define-fun dynamic_invariant6 ((temp___expr_750 Int)
