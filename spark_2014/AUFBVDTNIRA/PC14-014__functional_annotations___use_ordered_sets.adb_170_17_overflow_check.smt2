...
;; H
  (assert
  (and
  (= o4 (next (mk___rep s__split_discrs s__split_fields2)
        (mk___rep1 cu__split_fields2)))
  ...
  (= (bool_eq4 o4 no_element) true)
  (and
  (= (has_key (positions (mk___rep s__split_discrs s__split_fields2)) o4) true)
  (= (get1 (positions (mk___rep s__split_discrs s__split_fields2)) o4) (+ 
  (get1 (positions (mk___rep s__split_discrs s__split_fields2))
