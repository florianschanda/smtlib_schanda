...
;; H
  ...
  (all_left_elements_in__function_guard result5 a2 left3 o1))
  (= (= result5 true)
  (forall ((k1 Int))
  (=> (and (<= 0 k1) (<= k1 7))
  (=> (< k1 left3)
...
;; H
  ...
  (all_right_elements_in__function_guard result4 a2 (- left3 1) o))
  (= (= result4 true)
  (forall ((k1 Int))
  (=> (and (<= 0 k1) (<= k1 7))
  (=> (< (- left3 1) k1)
...
;; H
  (assert
  (=> (and (<= 0 k) (<= k (- left3 space2)))
  (= result6 (ite (= (mod2 (+ k 1) (* 2 space2)) 0) true false))))

;; H
  (assert
  (=> (not (and (<= 0 k) (<= k (- left3 space2)))) (= result6 false)))
