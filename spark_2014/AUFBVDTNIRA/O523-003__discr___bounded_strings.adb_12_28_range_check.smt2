...
(declare-fun dummy5 () size_type)

(declare-datatypes ()
((size_type__ref (mk_size_type__ref (size_type__content size_type)))))
(define-fun size_type__ref___projection ((a size_type__ref)) size_type 
...
((us_split_fields
 (mk___split_fields
 (rec__bounded_strings__bounded_string__text us_t1)(rec__bounded_strings__bounded_string__size size_type)))))
(define-fun us_split_fields_Text__projection ((a us_split_fields)) us_t1 
  (rec__bounded_strings__bounded_string__text a))

(define-fun us_split_fields_Size__projection ((a us_split_fields)) size_type 
...
(declare-fun bounded_strings__bounded_string__size__first__bit () Int)

(declare-fun bounded_strings__bounded_string__size__last__bit () Int)

(declare-fun bounded_strings__bounded_string__size__position () Int)
...
(define-fun dynamic_invariant3 ((temp___expr_149 us_rep)
...
;; size__post_axiom
  (assert
  (forall ((b us_rep))
  (! (=> (dynamic_invariant3 b true true true)
     (let ((result (size b)))
     (=> (size__function_guard result b) (dynamic_invariant2 result true
     false true)))) :pattern ((size b)) )))

;; size__def_axiom
  (assert
  (forall ((b us_rep))
  (! (=>
     (and (dynamic_invariant3 b true true true) (size__function_guard
     (size b) b))
     (= (size b) (to_rep2
                 (rec__bounded_strings__bounded_string__size
...
((us_split_fields2
 (mk___split_fields1
 (rec__bounded_strings__bounded_string__text1 us_t2)(rec__bounded_strings__bounded_string__size1 size_type)))))
(define-fun us_split_fields_Text2__projection ((a us_split_fields2)) us_t2 
  (rec__bounded_strings__bounded_string__text1 a))

(define-fun us_split_fields_Size2__projection ((a us_split_fields2)) size_type 
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a)
                                         (mk___split_fields
                                         (let ((temp___133 (rec__bounded_strings__bounded_string__text1
                                                           (us_split_fields3
                                                           a))))
                                         (of_array1 (to_array2 temp___133)
                                         (first5 temp___133)
                                         (last7 temp___133)))
...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r)
                                         (mk___split_fields1
                                         (let ((temp___132 (rec__bounded_strings__bounded_string__text
                                                           (us_split_fields1
                                                           r))))
                                         (of_array2 (to_array1 temp___132)
                                         (first3 temp___132)
                                         (last4 temp___132)))
                                         (rec__bounded_strings__bounded_string__size
                                         (us_split_fields1 r)))))
...
(define-fun in_range5 ((rec__bounded_strings__bounded_string__bound1 Int)
  (a us_rep)) Bool (= rec__bounded_strings__bounded_string__bound1 (to_rep3
                                                                   (rec__bounded_strings__bounded_string__bound
                                                                   (us_split_discrs1
                                                                   a)))))
...
(declare-fun bounded_strings__bounded_string__bound__first__bit1 () Int)

(declare-fun bounded_strings__bounded_string__bound__last__bit1 () Int)

(declare-fun bounded_strings__bounded_string__bound__position1 () Int)
...
(declare-fun bounded_strings__bounded_string__text__first__bit1 () Int)

(declare-fun bounded_strings__bounded_string__text__last__bit1 () Int)

(declare-fun bounded_strings__bounded_string__text__position1 () Int)
...
(declare-fun bounded_strings__bounded_string__size__first__bit1 () Int)

(declare-fun bounded_strings__bounded_string__size__last__bit1 () Int)

(declare-fun bounded_strings__bounded_string__size__position1 () Int)
...
(define-fun dynamic_invariant4 ((temp___expr_176 us_rep1)
  (temp___is_init_173 Bool) (temp___skip_constant_174 Bool)
  (temp___do_toplevel_175 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_174 true))
                                      (in_range5 upper_bound
                                      (to_base temp___expr_176)))
                                      (and (dynamic_property4 1 upper_bound
                                      (first5
                                      (rec__bounded_strings__bounded_string__text1
                                      ...
                                      (= (first5
                                         (rec__bounded_strings__bounded_string__text1
                                         (us_split_fields3 temp___expr_176))) 1)
                                      (= (last7
                                         (rec__bounded_strings__bounded_string__text1
                                         (us_split_fields3 temp___expr_176))) 
                                      upper_bound)))))

(define-fun default_initial_assumption ((temp___expr_179 us_rep1)
  (temp___skip_top_level_180 Bool)) Bool (= (to_rep3
                                            (rec__bounded_strings__bounded_string__bound
                                            (us_split_discrs2
                                            temp___expr_179))) upper_bound))
...
(declare-fun temp___194 (Int Int Int) us_t3)

;; def_axiom
  (assert
  (forall ((temp___196 Int) (temp___197 Int) (temp___198 Int))
  (let ((temp___195 (temp___194 temp___196 temp___197 temp___198)))
  (and
  (=> (dynamic_property 1 2147483647 temp___197 temp___198)
  (and (= (first7 temp___195) temp___197) (= (last10 temp___195) temp___198)))
  (forall ((temp___199 Int))
  (= (select (to_array3 temp___195) temp___199) (of_rep temp___196)))))))
...
(declare-fun b__split_fields () (Array Int character))

(declare-fun b__split_fields1 () t2)

(declare-fun b__split_fields2 () size_type)

(declare-fun us () Int)

(declare-fun temp___201 () (Array Int character))

(declare-fun temp___2011 () t3)

(declare-fun temp___202 () (Array Int character))

(declare-fun temp___2021 () t2)
...
(declare-fun o4 () size_type)

(declare-fun temp___205 () index_type)

(declare-fun temp___2051 () (Array Int character))

(declare-fun temp___2052 () t2)

(declare-fun temp___2053 () size_type)

(declare-fun temp___206 () (Array Int character))

(declare-fun temp___2061 () t4)

(declare-fun temp___212 () (Array Int character))

(declare-fun temp___2121 () t4)
...
(declare-fun o9 () size_type)

(declare-fun temp___215 () us_rep1)

(declare-fun result () us_split_fields__ref1)

(declare-fun b__split_fields3 () us_split_fields2)

(declare-fun result1 () us_split_fields__ref1)

(declare-fun b__split_fields4 () us_split_fields2)
...
;; H
  (assert
  (= (to_rep3 (rec__bounded_strings__bounded_string__bound b__split_discrs)) 
  upper_bound))

;; H
  (assert (dynamic_invariant4
  (mk___rep1 b__split_discrs
  (mk___split_fields1 (mk___t2 b__split_fields b__split_fields1)
  b__split_fields2)) false false true))

;; H
  (assert (= (to_rep1 (first6 (rt3 (temp___194 0 1 upper_bound)))) 1))

;; H
  (assert
  (= (to_rep1 (last9 (rt3 (temp___194 0 1 upper_bound)))) upper_bound))

;; H
  (assert (= (mk___t3 temp___201 temp___2011) (temp___194 0 1 upper_bound)))

;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___2011)) (to_rep1 (last9 temp___2011)))
     (+ (- (to_rep1 (last9 temp___2011)) (to_rep1 (first6 temp___2011))) 1)
     0) (ite (<= 1 upper_bound) (+ (- upper_bound 1) 1) 0)))

;; H
  (assert (= temp___201 temp___202))

;; H
  (assert
  (= (mk2 (to_rep1 (first6 temp___2011)) (to_rep1 (last9 temp___2011))) 
  temp___2021))

;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___2021)) (to_rep1 (last6 temp___2021)))
     (+ (- (to_rep1 (last6 temp___2021)) (to_rep1 (first4 temp___2021))) 1)
     0) (ite (<= (to_rep1 (first4 b__split_fields1)) (to_rep1
                                                     (last6 b__split_fields1)))
        (+ (- (to_rep1 (last6 b__split_fields1)) (to_rep1
                                                 (first4 b__split_fields1))) 1)
        0)))

;; H
  (assert (= (mk___t2 o o1) (mk___t2 temp___202 temp___2021)))
...
;; H
  (assert (= b__split_discrs (mk___split_discrs temp___205)))
...
;; H
  (assert
  (= b__split_fields3 (mk___split_fields1 (mk___t2 temp___2051 temp___2052)
                      temp___2053)))
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first (rt initializer))) (to_rep1
                                                 (last (rt initializer))))
     (+ (- (to_rep1 (last (rt initializer))) (to_rep1
                                             (first (rt initializer)))) 1)
     0) (ite (<= 1 (length initializer)) (+ (- (length initializer) 1) 1) 0)))

;; H
  (assert
  (= (slide (elts initializer) (to_rep1 (first (rt initializer))) 1) 
  temp___206))

;; H
  (assert (= (mk4 1 (length initializer)) temp___2061))

;; H
  (assert
  (= (ite (<= (to_rep1 (first8 temp___2061)) (to_rep1 (last12 temp___2061)))
     (+ (- (to_rep1 (last12 temp___2061)) (to_rep1 (first8 temp___2061))) 1)
     0) (ite (<= (to_rep1 (first8 (mk4 1 (length initializer)))) (to_rep1
                                                                 (last12
                                                                 (mk4 1
                                                                 (length
                                                                 initializer)))))
        (+ (- (to_rep1 (last12 (mk4 1 (length initializer)))) (to_rep1
                                                              (first8
                                                              (mk4 1
                                                              (length
                                                              initializer))))) 1)
...
;; H
  (assert
  (= (mk___t4 temp___212 temp___2121) (mk___t4 temp___206 temp___2061)))
...
;; H
  ...
  (= (to_rep1
     (first4
     (rt2 (rec__bounded_strings__bounded_string__text1 b__split_fields3)))) 
  (to_rep1 (first4 o6)))
  (= (to_rep1
     (last6
     (rt2 (rec__bounded_strings__bounded_string__text1 b__split_fields3)))) 
  ...
  (ite (and (<= 1 temp___213) (<= temp___213 (length initializer)))
  (= (select o5 temp___213) (select temp___212 temp___213))
  (= (select o5 temp___213) (select (elts2
                                    (rec__bounded_strings__bounded_string__text1
                                    b__split_fields3)) temp___213))))))
...
;; H
  (assert
  (= (rec__bounded_strings__bounded_string__size1 b__split_fields3) o9))

;; H
  (assert
  (= temp___215 (mk___rep1 b__split_discrs
                (mk___split_fields1 (mk___t2 o7 o8) o9))))

;; H
  (assert (= result1 (mk___split_fields__ref1 b__split_fields3)))

;; H
  (assert (= b__split_fields4 (us_split_fields3 temp___215)))
...
;; WP_parameter_def
 ;; File "bounded_strings.ads", line 24, characters 0-0
  (not (in_range4 (length initializer))))
(check-sat)
