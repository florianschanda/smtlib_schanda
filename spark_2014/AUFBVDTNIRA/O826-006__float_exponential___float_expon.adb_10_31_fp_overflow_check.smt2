...
;; Power_0
  (assert
  (forall ((x t)) (=> (tqtisFinite x) (eq (power x 0) (of_int RNE2 1)))))
...
;; Power_neg1
  ...
  (forall ((x t))
  (=> (tqtisFinite x)
  (=> (not (is_zero x)) (eq (power x (- 1)) (div1 RNE2 (of_int RNE2 1) x))))))
...
;; Power_neg2
  ...
  (div1 RNE2 (of_int RNE2 1) (power x 2)))))))
...
;; Power_neg3
  ...
  (=> (tqtisFinite x)
  (=> (not (is_zero x)) (eq (power x (- 2))
  (div1 RNE2 (of_int RNE2 1) (power x 3)))))))
...
(define-fun t__ref___projection ((a t__ref1)) t1 (t__content1 a))

(define-fun dynamic_invariant1 ((temp___expr_171 t) (temp___is_init_168 Bool)
  (temp___skip_constant_169 Bool)
  (temp___do_toplevel_170 Bool)) Bool (=>
                                      (or (= temp___is_init_168 true) (le
                                      fliteral fliteral2)) (in_range1
                                      temp___expr_171)))
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 7.0)))

(declare-fun fliteral4 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral4) (= (tqtreal fliteral4) 4.0)))
...
;; H
  (assert (and (= o8 (mul RNE2 x x)) (tqtisFinite (mul RNE2 x x))))

;; H
  (assert
  (and (= o3 (mul RNE2 x (mul RNE2 x x))) (tqtisFinite
  (mul RNE2 x (mul RNE2 x x)))))

;; H
  (assert (= o4 (mul RNE2 fliteral3 o3)))

;; H
  (assert (and (= o5 o4) (tqtisFinite o4)))

;; H
  (assert (=> (< 4 0) (not (= x zeroF))))

;; H
  (assert (= o (power x 4)))

;; H
  (assert (and (= o1 o) (tqtisFinite o)))

;; H
  (assert (= o2 (mul RNE2 fliteral4 o1)))

;; H
  (assert (and (= o6 o2) (tqtisFinite o2)))

;; H
  (assert (= o7 (add RNE2 o6 o5)))

;; H
  (assert (and (= o9 o7) (tqtisFinite o7)))

;; H
  (assert (= o10 (sub RNE2 o9 o8)))
