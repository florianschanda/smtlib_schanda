...
(declare-fun state10 () us_private__ref)
...
(declare-fun state37 () us_private)
...
(declare-fun status5 () us_private)
...
(declare-fun output5 () us_private)
...
(declare-fun filestate12 () us_private__ref)

(declare-fun state57 () us_private__ref)

(declare-fun filestate13 () us_private__ref)

(declare-fun state58 () us_private__ref)

(declare-fun state59 () us_private__ref)

(declare-fun store4 () us_private__ref)

(declare-fun state60 () us_private__ref)

(declare-fun status6 () us_private__ref)

(declare-fun state61 () us_private__ref)

(declare-fun state62 () us_private__ref)

(declare-fun filestate14 () us_private__ref)

(declare-fun state63 () us_private__ref)

(declare-fun state64 () us_private__ref)

(declare-fun state65 () us_private__ref)

(declare-fun writtenstate3 () us_private__ref)

(declare-fun output6 () us_private__ref)

(declare-fun state66 () us_private__ref)

(declare-fun state67 () us_private__ref)

(declare-fun status7 () us_private__ref)

(declare-fun output7 () us_private__ref)

(declare-fun state68 () us_private__ref)

(declare-fun state69 () us_private__ref)

(declare-fun thestats__split_fields3 () us_split_fields__ref2)

(declare-fun theadmin__split_fields5 () us_split_fields__ref)

(declare-fun filestate15 () us_private)

(declare-fun state70 () us_private)

(declare-fun filestate16 () us_private)

(declare-fun state71 () us_private)

(declare-fun state72 () us_private)

(declare-fun store5 () us_private)

(declare-fun state73 () us_private)

(declare-fun status8 () us_private)

(declare-fun state74 () us_private)

(declare-fun state75 () us_private)

(declare-fun filestate17 () us_private)

(declare-fun state76 () us_private)

(declare-fun state77 () us_private)

(declare-fun state78 () us_private)

(declare-fun writtenstate4 () us_private)

(declare-fun output8 () us_private)

(declare-fun state79 () us_private)

(declare-fun state80 () us_private)

(declare-fun status9 () us_private)

(declare-fun output9 () us_private)

(declare-fun state81 () us_private)

(declare-fun state82 () us_private)

(declare-fun thestats__split_fields4 () us_split_fields4)

(declare-fun theadmin__split_fields6 () us_split_fields)
...
;; H
  ...
  (enrolmentisinprogress (us_private__content state9))
  (us_private__content state9)))
...
;; H
  ...
  (statusiswaitingstartadminop (us_private__content state9))
  (us_private__content state9)))

;; H
  (assert (statusisgotadmintoken__function_guard
  (statusisgotadmintoken (us_private__content state9))
  (us_private__content state9)))

;; H
  (assert (statusiswaitingremoveadmintokenfail__function_guard
  (statusiswaitingremoveadmintokenfail (us_private__content state9))
  (us_private__content state9)))
...
;; H
  ...
  (statusiswaitingfinishadminop (us_private__content state9))
  (us_private__content state9)))
...
;; H
  ...
  (statusisenclavequiescent (us_private__content state9))
  (us_private__content state9)))
...
;; H
  ...
  (statusisshutdown (us_private__content state9))
  (us_private__content state9)))
...
;; H
  ...
  (and
  (and
  (= (not (= (enrolmentisinprogress (us_private__content state9)) true))
  ...
  (= (statusiswaitingstartadminop (us_private__content state9)) true)))
  (=>
  (or (= (statusisgotadmintoken (us_private__content state9)) true)
  (= (statusiswaitingremoveadmintokenfail (us_private__content state9)) true))
  (not
  (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields))) true))))
  (=>
  (or (= (statusiswaitingstartadminop (us_private__content state9)) true)
  (= (statusiswaitingfinishadminop (us_private__content state9)) true))
  (and
  (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields))) true)
  (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true))))
  (=> (= (statusisenclavequiescent (us_private__content state9)) true)
  (not
  (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true))))
  (=> (= (statusisshutdown (us_private__content state9)) true)
  (and
  (not
  (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true))
  (= (rolepresent
     (mk___rep (us_split_fields__content theadmin__split_fields))) 0))))
  (=> (= (enrolmentisinprogress (us_private__content state9)) true)
  (and
  (not
  (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields))) true))
  (not
...
;; H
  (assert (privatekeypresent__function_guard (privatekeypresent state23)
  state23))

;; H
  (assert (enrolmentisinprogress__function_guard
  (enrolmentisinprogress (let ((subject state9)) state27))
  (let ((subject state9)) state27)))
...
;; H
  (assert (statusisenclavequiescent__function_guard
  (statusisenclavequiescent (let ((subject state9)) state27))
  (let ((subject state9)) state27)))

;; H
  (assert (enrolmentisinprogress__function_guard
  (enrolmentisinprogress (let ((subject state9)) state29))
  (let ((subject state9)) state29)))
...
;; H
  (assert (statusisenclavequiescent__function_guard
  (statusisenclavequiescent (let ((subject state9)) state29))
  (let ((subject state9)) state29)))

;; H
  (assert (statusiswaitingremoveadmintokenfail__function_guard
  (statusiswaitingremoveadmintokenfail (let ((subject state9)) state29))
  (let ((subject state9)) state29)))

;; H
  (assert (getstatus__function_guard
  (getstatus (let ((subject state9)) state29))
  (let ((subject state9)) state29)))

;; H
  (assert (getstatus__function_guard (getstatus (us_private__content state9))
  (us_private__content state9)))

;; H
  (assert (statusiswaitingstartadminop__function_guard
  (statusiswaitingstartadminop (let ((subject state9)) state29))
  (let ((subject state9)) state29)))

;; H
  (assert (statusiswaitingfinishadminop__function_guard
  (statusiswaitingfinishadminop (let ((subject state9)) state29))
  (let ((subject state9)) state29)))

;; H
  (assert (islocked__function_guard (islocked state32) state32))

;; H
  (assert (thecurrentdoor__function_guard (thecurrentdoor state33) state33))
...
;; H
  (assert (alarm_timeout__function_guard (alarm_timeout state33) state33))
...
;; H
  (assert (greaterthanorequal__function_guard
  (greaterthanorequal (thecurrenttime currenttime) (alarm_timeout state33))
  (thecurrenttime currenttime) (alarm_timeout state33)))

;; H
  (assert (thedooralarm__function_guard (thedooralarm state33) state33))

;; H
  (assert (enrolmentisinprogress__function_guard
  (enrolmentisinprogress (let ((subject state9)) state49))
  (let ((subject state9)) state49)))

;; H
  (assert (islocked__function_guard (islocked state43) state43))

;; H
  (assert (thecurrentdoor__function_guard (thecurrentdoor state44) state44))
...
;; H
  (assert (alarm_timeout__function_guard (alarm_timeout state44) state44))
...
;; H
  (assert (greaterthanorequal__function_guard
  (greaterthanorequal (thecurrenttime currenttime) (alarm_timeout state44))
  (thecurrenttime currenttime) (alarm_timeout state44)))

;; H
  (assert (thedooralarm__function_guard (thedooralarm state44) state44))

;; H
  (assert (statusisgotadmintoken__function_guard
  (statusisgotadmintoken (let ((subject state9)) state49))
  (let ((subject state9)) state49)))

;; H
  (assert (statusiswaitingremoveadmintokenfail__function_guard
  (statusiswaitingremoveadmintokenfail (let ((subject state9)) state49))
  (let ((subject state9)) state49)))
...
;; H
  (assert (statusiswaitingstartadminop__function_guard
  (statusiswaitingstartadminop (let ((subject state9)) state49))
  (let ((subject state9)) state49)))

;; H
  (assert (statusiswaitingfinishadminop__function_guard
  (statusiswaitingfinishadminop (let ((subject state9)) state49))
  (let ((subject state9)) state49)))
...
;; H
  (assert (statusisenclavequiescent__function_guard
  (statusisenclavequiescent (let ((subject state9)) state49))
  (let ((subject state9)) state49)))
...
;; H
  (assert (statusisshutdown__function_guard
  (statusisshutdown (let ((subject state9)) state49))
  (let ((subject state9)) state49)))
...
;; H
  (assert (isgood__function_guard (isgood state42) state42))

;; H
  (assert (authcertvalid__function_guard (authcertvalid state42) state42))

;; H
  (assert (theauthcertrole__function_guard (theauthcertrole state42)
  state42))
...
;; H
  (assert (enrolmentisinprogress__function_guard
  (enrolmentisinprogress (let ((subject state9)) state56))
  (let ((subject state9)) state56)))

;; H
  (assert (ispresent__function_guard
  (ispresent
  (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields4)))
  (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields4))))
...
;; H
  (assert (statusisgotadmintoken__function_guard
  (statusisgotadmintoken (let ((subject state9)) state56))
  (let ((subject state9)) state56)))

;; H
  (assert (statusiswaitingremoveadmintokenfail__function_guard
  (statusiswaitingremoveadmintokenfail (let ((subject state9)) state56))
  (let ((subject state9)) state56)))
...
;; H
  (assert (statusiswaitingstartadminop__function_guard
  (statusiswaitingstartadminop (let ((subject state9)) state56))
  (let ((subject state9)) state56)))

;; H
  (assert (statusiswaitingfinishadminop__function_guard
  (statusiswaitingfinishadminop (let ((subject state9)) state56))
  (let ((subject state9)) state56)))
...
;; H
  (assert (statusisenclavequiescent__function_guard
  (statusisenclavequiescent (let ((subject state9)) state56))
  (let ((subject state9)) state56)))
...
;; H
  (assert (statusisshutdown__function_guard
  (statusisshutdown (let ((subject state9)) state56))
  (let ((subject state9)) state56)))
...
;; H
  (assert
  (and (= result (enrolmentisinprogress (us_private__content state9)))
...
;; H
  ...
  (=> (= result true)
  (and
  (= (= (privatekeypresent state23) true)
  (not (= (enrolmentisinprogress (let ((subject state9)) state27)) true)))
  (or (= (enrolmentisinprogress (let ((subject state9)) state27)) true)
  (= (statusisenclavequiescent (let ((subject state9)) state27)) true)))))
...
;; H
  (assert
  (=> (= result true)
  (= (let ((subject state10)) (mk___private__ref state37)) state10)))

;; H
  (assert (=> (= result true) (= output4 output1)))

;; H
  (assert (=> (= result true) (= status4 status1)))

;; H
  (assert (=> (= result true) (= state36 state8)))
...
;; H
  (assert (=> (= result true) (= state34 state5)))

;; H
  (assert (=> (= result true) (= filestate6 filestate1)))

;; H
  (assert (=> (= result true) (= state33 state4)))

;; H
  (assert (=> (= result true) (= state32 state3)))

;; H
  (assert (=> (= result true) (= status5 status)))

;; H
  (assert (=> (= result true) (= state28 state2)))

;; H
  (assert (=> (= result true) (= state40 state)))
...
;; H
  (assert
  (=> (= result true) (= theadmin__split_fields2 theadmin__split_fields1)))

;; H
  (assert
  (=> (= result true) (= thestats__split_fields2 thestats__split_fields1)))

;; H
  (assert (=> (= result true) (= state37 state21)))
...
;; H
  (assert (=> (= result true) (= state36 state19)))
...
;; H
  (assert (=> (= result true) (= state32 state14)))

;; H
  (assert (=> (= result true) (= status5 status2)))

;; H
  (assert (=> (= result true) (= state28 state13)))

;; H
  (assert (=> (= result true) (= state40 state11)))
...
;; H
  ...
  (=> (not (= result true))
  (and
  (= result1 (adminmustlogout
             (mk___rep (us_split_fields__content theadmin__split_fields))
             state2 currenttime (us_private__content state9)))
  (adminmustlogout__function_guard result1
  (mk___rep (us_split_fields__content theadmin__split_fields)) state2
  currenttime (us_private__content state9)))))
...
;; H
  ...
  (and
  (and
  (not (= (enrolmentisinprogress (let ((subject state9)) state29)) true))
  (= (rolepresent
     (mk___rep
  ...
  (or
  (or (= (statusisenclavequiescent (let ((subject state9)) state29)) true)
  (= (statusiswaitingremoveadmintokenfail (let ((subject state9)) state29)) true))
  (= (getstatus (let ((subject state9)) state29)) (getstatus
                                                  (us_private__content
                                                  state9)))))
  (not
  (or (= (statusiswaitingstartadminop (let ((subject state9)) state29)) true)
  (= (statusiswaitingfinishadminop (let ((subject state9)) state29)) true)))))))
...
;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= output4 output1))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= status4 status1))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= state36 state8))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= output5 output))))

;; H
  (assert
  (=> (not (= result true))
  (=> (= result1 true) (= writtenstate2 writtenstate))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= state46 state7))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= state35 state6))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= state34 state5))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= filestate6 filestate1))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= state33 state4))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= state32 state3))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= status5 status))))

;; H
  (assert (=> (not (= result true)) (=> (= result1 true) (= state40 state))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= filestate8 filestate))))

;; H
  (assert
  (=> (not (= result true))
  (=> (= result1 true) (= thestats__split_fields2 thestats__split_fields1))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= state37 state21))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= output4 output3))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= status4 status3))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= state36 state19))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= output5 output2))))

;; H
  (assert
  (=> (not (= result true))
  (=> (= result1 true) (= writtenstate2 writtenstate1))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= state46 state18))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= state35 state17))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= state34 state16))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= filestate6 filestate3))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= state33 state15))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= state32 state14))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= status5 status2))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= state40 state11))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result1 true) (= filestate8 filestate2))))
...
;; H
  ...
  (=> (not (= result1 true))
  (and
  (= result2 (currentactivitypossible state8 (us_private__content state10)))
  (currentactivitypossible__function_guard result2 state8
...
;; H
  ...
  (=> (= result2 true)
  (=
  (and (and (= (islocked state32) true) (= (thecurrentdoor state33) 0))
  (= (greaterthanorequal (thecurrenttime currenttime)
     (alarm_timeout state33)) true))
  (= (thedooralarm state33) 0))))))
...
;; H
  ...
  (=> (= result2 true)
  (= (let ((subject theadmin__split_fields))
     (mk___split_fields__ref theadmin__split_fields3)) theadmin__split_fields)))))
...
;; H
  ...
  (=> (not (= result1 true))
  (=> (= result2 true)
  (= (let ((subject state9)) (mk___private__ref state49)) state9)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (= result2 true) (= output5 output)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (= result2 true) (= writtenstate2 writtenstate)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (= result2 true) (= state46 state7)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (= result2 true) (= status5 status)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (= result2 true) (= state42 state2)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (= result2 true) (= state40 state)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (= result2 true) (= filestate8 filestate)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (= result2 true) (= theadmin__split_fields3 theadmin__split_fields1)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (= result2 true) (= state49 state20)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (= result2 true) (= output5 output2)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (= result2 true) (= writtenstate2 writtenstate1)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (= result2 true) (= state46 state18)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (= result2 true) (= status5 status2)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (= result2 true) (= state42 state13)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (= result2 true) (= state40 state11)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (= result2 true) (= filestate8 filestate2)))))
...
;; H
  ...
  (=> (not (= result2 true))
  (and
  (= result3 (currentadminactivitypossible state2
             (us_private__content state9)))
  (currentadminactivitypossible__function_guard result3 state2
  (us_private__content state9)))))))
...
;; H
  ...
  (and
  (and
  (not (= (enrolmentisinprogress (let ((subject state9)) state49)) true))
  (=
  (and (and (= (islocked state43) true) (= (thecurrentdoor state44) 0))
  (= (greaterthanorequal (thecurrenttime currenttime)
     (alarm_timeout state44)) true))
  (= (thedooralarm state44) 0)))
  (=>
  (or (= (statusisgotadmintoken (let ((subject state9)) state49)) true)
  (= (statusiswaitingremoveadmintokenfail (let ((subject state9)) state49)) true))
  (not
  (= (ispresent
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true))))
  (=>
  (or (= (statusiswaitingstartadminop (let ((subject state9)) state49)) true)
  (= (statusiswaitingfinishadminop (let ((subject state9)) state49)) true))
  (and
  (and
  (= (isdoingop
     (mk___rep
  ...
  (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields)))))))
  (=> (= (statusisenclavequiescent (let ((subject state9)) state49)) true)
  (not
  (= (isdoingop
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true))))
  (=> (= (statusisshutdown (let ((subject state9)) state49)) true)
  (and
  (not
  (= (isdoingop
     (mk___rep
  ...
  (= (statusiswaitingstartadminop (let ((subject state9)) state49)) true)))
  (=>
  (= (rolepresent
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 1)
  (and (and (= (isgood state42) true) (= (authcertvalid state42) true))
  (= (theauthcertrole state42) 1))))
  (=>
  (and
  (= (isdoingop
     (mk___rep
  ...
  (= (isdoingop
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true))))
  (=> (and (not (= (islocked state43) true)) (= (islocked state3) true))
  (and (and (= (isgood state42) true) (= (authcertvalid state42) true))
  (= (theauthcertrole state42) 1))))
  (=> (and (not (= (islocked state43) true)) (= (islocked state3) true))
  (and
...
;; H
  ...
  (=> (not (= result2 true))
  (=> (= result3 true)
  (= (let ((subject state10)) (mk___private__ref state51)) state10))))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (= result3 true) (= state51 state21))))))
...
;; H
  ...
  (=> (not (= result2 true))
  (=> (not (= result3 true))
  (and (= result4 (canstart state8 (us_private__content state10)))
  (canstart__function_guard result4 state8 (us_private__content state10))))))))
...
;; H
  ...
  (=> (= result4 true)
  (= (let ((subject theadmin__split_fields))
     (mk___split_fields__ref theadmin__split_fields4)) theadmin__split_fields)))))))
...
;; H
  ...
  (=> (not (= result3 true))
  (=> (= result4 true)
  (= (let ((subject state9)) (mk___private__ref state56)) state9)))))))
...
;; H
  ...
  (=> (not (= result2 true))
  (=> (not (= result3 true))
  (=> (= result4 true) (= theadmin__split_fields4 theadmin__split_fields1)))))))
...
;; H
  ...
  (=> (not (= result1 true))
  (=> (not (= result2 true))
  (=> (not (= result3 true)) (=> (= result4 true) (= state56 state20)))))))
...
;; H
  ...
  (and
  (and
  (not (= (enrolmentisinprogress (let ((subject state9)) state56)) true))
  (=>
  (not
  (= (ispresent
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields4))) true))
  (not
  (= (isdoingop
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields4))) true))))
  (=>
  (or (= (statusisgotadmintoken (let ((subject state9)) state56)) true)
  (= (statusiswaitingremoveadmintokenfail (let ((subject state9)) state56)) true))
  (not
  (= (ispresent
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields4))) true))))
  (=>
  (or (= (statusiswaitingstartadminop (let ((subject state9)) state56)) true)
  (= (statusiswaitingfinishadminop (let ((subject state9)) state56)) true))
  (and
  (and
  (= (isdoingop
     (mk___rep
  ...
  (= (rolepresent
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields4))) 
  (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields)))))))
  (=> (= (statusisenclavequiescent (let ((subject state9)) state56)) true)
  (and
  (not
  (= (isdoingop
     (mk___rep
  ...
  (= (rolepresent
     ...
     (let ((subject theadmin__split_fields)) theadmin__split_fields4))) 
  (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields)))))))
  (=> (= (statusisshutdown (let ((subject state9)) state56)) true)
  (and
  (not
  (= (isdoingop
     (mk___rep
  ...
  (= (rolepresent
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields4))) 0))))
  (=>
  (and
  (= (isdoingop
     (mk___rep
  ...
  (= (thecurrentop
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields4))) 4))
  (= (statusiswaitingstartadminop (let ((subject state9)) state56)) true)))
  (=>
  (= (rolepresent
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields4))) 1)
  (and (and (= (isgood state2) true) (= (authcertvalid state2) true))
  (= (theauthcertrole state2) 1))))
  (=>
  (and
  ...
  (= (thecurrentop
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields4))) 3))
  (= (rolepresent
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields4))) 1)))
  (=>
...
;; H
  ...
  (=> (not (= result1 true))
  (=> (not (= result2 true))
  (=> (not (= result3 true)) (=> (not (= result4 true)) (= state53 state55)))))))
...
;; H
  ...
  (=> (not (= result1 true))
  (=> (not (= result2 true))
  (=> (not (= result3 true)) (=> (not (= result4 true)) (= state50 state6)))))))
...
;; H
  ...
  (=> (not (= result1 true))
  (=> (not (= result2 true))
  (=> (not (= result3 true)) (=> (not (= result4 true)) (= state52 state54)))))))
...
;; H
  ...
  (=> (not (= result2 true))
  (=> (not (= result3 true))
  (=> (not (= result4 true)) (= filestate10 filestate11)))))))
...
;; H
  ...
  (=> (not (= result1 true))
  (=> (not (= result2 true))
  (=> (not (= result3 true)) (=> (not (= result4 true)) (= state51 state21)))))))
...
;; H
  ...
  (=> (not (= result1 true))
  (=> (not (= result2 true))
  (=> (not (= result3 true)) (=> (not (= result4 true)) (= state50 state17)))))))
...
;; H
  ...
  (=> (not (= result3 true))
  (= (let ((subject theadmin__split_fields))
     (mk___split_fields__ref theadmin__split_fields3)) (let ((subject 
...
;; H
  ...
  (=> (not (= result2 true))
  (=> (not (= result3 true))
  (= (let ((subject state9)) (mk___private__ref state49)) (let ((subject 
                                                          state9))
                                                          (mk___private__ref
                                                          state56))))))))
...
;; H
  ...
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= state48 state8))))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= state47 state53))))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= output5 output))))))
...
;; H
  ...
  (=> (not (= result1 true))
  (=> (not (= result2 true))
  (=> (not (= result3 true)) (= writtenstate2 writtenstate))))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= state46 state7))))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= state45 state50))))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= state44 state4))))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= state43 state3))))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= status5 status))))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= state42 state2))))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= state41 state52))))))
...
;; H
  ...
  (=> (not (= result1 true))
  (=> (not (= result2 true))
  (=> (not (= result3 true)) (= filestate9 filestate10))))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= state40 state))))))
...
;; H
  ...
  (=> (not (= result1 true))
  (=> (not (= result2 true))
  (=> (not (= result3 true)) (= filestate8 filestate))))))
...
;; H
  ...
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= state49 state56))))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= state48 state19))))))
...
;; H
  ...
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= output5 output2))))))
...
;; H
  ...
  (=> (not (= result1 true))
  (=> (not (= result2 true))
  (=> (not (= result3 true)) (= writtenstate2 writtenstate1))))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= state46 state18))))))
...
;; H
  ...
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= state44 state15))))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= state43 state14))))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= status5 status2))))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= state42 state13))))))
...
;; H
  ...
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (=> (not (= result3 true)) (= state40 state11))))))
...
;; H
  ...
  (=> (not (= result1 true))
  (=> (not (= result2 true))
  (=> (not (= result3 true)) (= filestate8 filestate2))))))
...
;; H
  ...
  (=> (not (= result1 true))
  (=> (not (= result2 true))
  (= (let ((subject state10)) (mk___private__ref state37)) (let ((subject 
                                                           state10))
                                                           (mk___private__ref
                                                           state51)))))))
...
;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (not (= result2 true)) (= output4 output1)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (not (= result2 true)) (= status4 status1)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (not (= result2 true)) (= state36 state48)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (not (= result2 true)) (= state39 state47)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (not (= result2 true)) (= state35 state45)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (not (= result2 true)) (= state34 state5)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (= filestate6 filestate1)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (not (= result2 true)) (= state33 state44)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (not (= result2 true)) (= state32 state43)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (not (= result2 true)) (= state38 state41)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (= filestate7 filestate9)))))
...
;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (not (= result2 true)) (= state37 state51)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (not (= result2 true)) (= output4 output3)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (not (= result2 true)) (= status4 status3)))))
...
;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (=> (not (= result2 true)) (= state34 state16)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true))
  (=> (not (= result2 true)) (= filestate6 filestate3)))))
...
;; H
  ...
  (=> (not (= result1 true))
  (= (let ((subject theadmin__split_fields))
     (mk___split_fields__ref theadmin__split_fields2)) (let ((subject 
                                                       theadmin__split_fields))
                                                       (mk___split_fields__ref
...
;; H
  ...
  (=> (not (= result true))
  (=> (not (= result1 true))
  (= (let ((subject state9)) (mk___private__ref state29)) (let ((subject 
                                                          state9))
                                                          (mk___private__ref
                                                          state49))))))
...
;; H
  (assert
  (=> (not (= result true)) (=> (not (= result1 true)) (= state31 state39))))

;; H
  (assert
  (=> (not (= result true)) (=> (not (= result1 true)) (= state28 state42))))

;; H
  (assert
  (=> (not (= result true)) (=> (not (= result1 true)) (= state30 state38))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result1 true)) (= filestate5 filestate7))))
...
;; H
  (assert
  (=> (not (= result true)) (=> (not (= result1 true)) (= state29 state49))))
...
;; H
  (assert
  (=> (not (= result true))
  (= (let ((subject state9)) (mk___private__ref state27)) (let ((subject 
                                                          state9))
                                                          (mk___private__ref
                                                          state29)))))

;; H
  (assert (=> (not (= result true)) (= state26 state31)))

;; H
  (assert (=> (not (= result true)) (= state25 state46)))

;; H
  (assert (=> (not (= result true)) (= state24 state35)))

;; H
  (assert (=> (not (= result true)) (= store3 store1)))

;; H
  (assert (=> (not (= result true)) (= state23 state1)))

;; H
  (assert (=> (not (= result true)) (= state22 state30)))

;; H
  (assert (=> (not (= result true)) (= filestate4 filestate5)))

;; H
  (assert (=> (not (= result true)) (= state27 state29)))
...
;; H
  (assert (=> (not (= result true)) (= state23 state12)))
...
;; H
  (assert
  (= theadmin__split_fields5 (let ((subject theadmin__split_fields))
...
;; H
  (assert (= state69 (let ((subject state10)) (mk___private__ref state37))))

;; H
  (assert (= state68 (let ((subject state9)) (mk___private__ref state27))))

;; H
  (assert (= output7 (mk___private__ref output4)))

;; H
  (assert (= status7 (mk___private__ref status4)))

;; H
  (assert (= state67 (mk___private__ref state36)))
...
;; H
  (assert (= state64 (mk___private__ref state24)))
...
;; H
  (assert (= state61 (mk___private__ref state32)))

;; H
  (assert (= status6 (mk___private__ref status5)))

;; H
  (assert (= state60 (mk___private__ref state28)))
...
;; H
  (assert (= state58 (mk___private__ref state22)))

;; H
  (assert (= filestate13 (mk___private__ref filestate4)))

;; H
  (assert (= state57 (mk___private__ref state40)))
...
;; H
  (assert (= state82 state37))

;; H
  (assert (= state81 state27))
...
;; H
  (assert (= state74 state32))

;; H
  (assert (= status8 status5))

;; H
  (assert (= state73 state28))
...
;; H
  (assert (= state71 state22))

;; H
  (assert (= filestate16 filestate4))

;; H
  (assert (= state70 state40))
...
;; H
  (assert
  (and (= result5 (enrolmentisinprogress (us_private__content state68)))
  (enrolmentisinprogress__function_guard result5
  (us_private__content state68))))
...
;; H
  ...
  (and
  (= o36 (isdoingop
         (mk___rep (us_split_fields__content theadmin__split_fields5))))
  (isdoingop__function_guard o36
  (mk___rep (us_split_fields__content theadmin__split_fields5))))))

;; H
  (assert (=> (= result5 true) (= o37 (ite (not (= o36 true)) true false))))
...
;; H
  ...
  (= o35 (ispresent
         (mk___rep (us_split_fields__content theadmin__split_fields5))))
  (ispresent__function_guard o35
  (mk___rep (us_split_fields__content theadmin__split_fields5))))))

;; H
  (assert (=> (= result5 true) (= o38 (ite (not (= o35 true)) true false))))

;; H
  (assert (=> (= result5 true) (= o39 (ite (= o38 true) o37 false))))

;; H
  (assert (=> (not (= result5 true)) (= o39 (of_int 1))))

;; H
  (assert
  (and (= result6 (statusisshutdown (us_private__content state68)))
  (statusisshutdown__function_guard result6 (us_private__content state68))))
...
;; H
  ...
  (= o31 (rolepresent
         (mk___rep (us_split_fields__content theadmin__split_fields5))))
  (rolepresent__function_guard o31
  (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range1
  o31))))

;; H
  (assert (=> (= result6 true) (= o32 (ite (= o31 0) true false))))
...
;; H
  ...
  (= o30 (isdoingop
         (mk___rep (us_split_fields__content theadmin__split_fields5))))
  (isdoingop__function_guard o30
  (mk___rep (us_split_fields__content theadmin__split_fields5))))))

;; H
  (assert (=> (= result6 true) (= o33 (ite (not (= o30 true)) true false))))

;; H
  (assert (=> (= result6 true) (= o34 (ite (= o33 true) o32 false))))

;; H
  (assert (=> (not (= result6 true)) (= o34 (of_int 1))))

;; H
  (assert
  (and (= result7 (statusisenclavequiescent (us_private__content state68)))
  (statusisenclavequiescent__function_guard result7
  (us_private__content state68))))
...
;; H
  ...
  (= o28 (isdoingop
         (mk___rep (us_split_fields__content theadmin__split_fields5))))
  (isdoingop__function_guard o28
  (mk___rep (us_split_fields__content theadmin__split_fields5))))))

;; H
  (assert (=> (= result7 true) (= o29 (ite (not (= o28 true)) true false))))

;; H
  (assert (=> (not (= result7 true)) (= o29 (of_int 1))))

;; H
  (assert
  (and (= o19 (statusiswaitingfinishadminop (us_private__content state68)))
  (statusiswaitingfinishadminop__function_guard o19
  (us_private__content state68))))

;; H
  (assert
  (and (= o20 (statusiswaitingstartadminop (us_private__content state68)))
  (statusiswaitingstartadminop__function_guard o20
  (us_private__content state68))))

;; H
  (assert (= result8 (ite (= o20 false) o19 true)))
...
;; H
  ...
  (= o24 (rolepresent
         (mk___rep (us_split_fields__content theadmin__split_fields5))))
  (rolepresent__function_guard o24
  (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range1
  o24))))

;; H
  (assert (=> (= result8 true) (= o25 (ite (= o24 o23) true false))))
...
;; H
  ...
  (= o22 (isdoingop
         (mk___rep (us_split_fields__content theadmin__split_fields5))))
  (isdoingop__function_guard o22
  (mk___rep (us_split_fields__content theadmin__split_fields5))))))

;; H
  (assert (=> (= result8 true) (= o26 (ite (= o22 true) o21 false))))

;; H
  (assert (=> (= result8 true) (= o27 (ite (= o26 true) o25 false))))

;; H
  (assert (=> (not (= result8 true)) (= o27 (of_int 1))))

;; H
  (assert
  (and
  (= o15 (statusiswaitingremoveadmintokenfail (us_private__content state68)))
  (statusiswaitingremoveadmintokenfail__function_guard o15
  (us_private__content state68))))

;; H
  (assert
  (and (= o16 (statusisgotadmintoken (us_private__content state68)))
  (statusisgotadmintoken__function_guard o16 (us_private__content state68))))

;; H
  (assert (= result9 (ite (= o16 false) o15 true)))
...
;; H
  (assert (=> (= result9 true) (= o18 (ite (not (= o17 true)) true false))))

;; H
  (assert (=> (not (= result9 true)) (= o18 (of_int 1))))
...
;; H
  ...
  (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range3
  o11)))
...
;; H
  (assert (= result10 (ite (= o13 true) o12 false)))

;; H
  (assert
  (=> (= result10 true)
  (and (= o14 (statusiswaitingstartadminop (us_private__content state68)))
  (statusiswaitingstartadminop__function_guard o14
  (us_private__content state68)))))

;; H
  (assert (=> (not (= result10 true)) (= o14 (of_int 1))))
...
;; H
  (assert (= result11 (ite (not (= o8 true)) true false)))
...
;; H
  (assert (=> (= result11 true) (= o10 (ite (not (= o9 true)) true false))))

;; H
  (assert (=> (not (= result11 true)) (= o10 (of_int 1))))
...
;; H
  (assert (=> (= result12 true) (= o5 (ite (not (= o4 true)) true false))))
...
;; H
  (assert (=> (= result12 true) (= o2 (ite (= o1 3) true false))))
...
;; H
  (assert (=> (= result12 true) (= o6 (ite (= o3 true) o2 false))))

;; H
  (assert (=> (= result12 true) (= o7 (ite (= o6 false) o5 true))))

;; H
  (assert (=> (not (= result12 true)) (= o7 (of_int 1))))

;; H
  (assert (isdoingop__function_guard
  (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5)))
  (mk___rep (us_split_fields__content theadmin__split_fields5))))
...
;; WP_parameter_def
 ;; File "admintoken.ads", line 40, characters 0-0
  (not
  (= (isdoingop
     (mk___rep (us_split_fields__content theadmin__split_fields5))) true)))
(check-sat)
