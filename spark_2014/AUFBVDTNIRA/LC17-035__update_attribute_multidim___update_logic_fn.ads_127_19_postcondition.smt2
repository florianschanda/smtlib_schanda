...
(define-fun bool_eq4 ((a map1) (a__first Int) (a__last Int)
...
(declare-fun temp___303 (map1 Int (_ BitVec 8) Int Int (_ BitVec 8) Int Int
  Int (_ BitVec 8) Int Int) map1)

;; def_axiom
  (assert
  (forall ((temp___305 map1))
  (forall ((temp___306 Int) (temp___308 Int) (temp___309 Int)
  (temp___311 Int) (temp___312 Int) (temp___313 Int) (temp___315 Int)
  (temp___316 Int))
  (forall ((temp___307 (_ BitVec 8)) (temp___310 (_ BitVec 8))
  (temp___314 (_ BitVec 8)))
  (let ((temp___304 (temp___303 temp___305 temp___306 temp___307 temp___308
                    temp___309 temp___310 temp___311 temp___312 temp___313
                    temp___314 temp___315 temp___316)))
  (forall ((temp___317 Int) (temp___319 Int))
  (forall ((temp___318 (_ BitVec 8)))
  (ite (and (and (= temp___317 temp___313) (= temp___318 temp___314))
       (= temp___319 temp___315))
  (= (get temp___304 temp___317 temp___318 temp___319) (of_rep temp___316))
  (ite (or
       (and (and (= temp___317 temp___306) (= temp___318 temp___307))
       (= temp___319 temp___308))
       (and (and (= temp___317 temp___309) (= temp___318 temp___310))
       (= temp___319 temp___311)))
  (= (get temp___304 temp___317 temp___318 temp___319) (of_rep temp___312))
  (= (get temp___304 temp___317 temp___318 temp___319) (get temp___305
...
(assert
;; WP_parameter_def
 ;; File "update_logic_fn.ads", line 116, characters 0-0
  (not
  (= (bool_eq4 a4 1 10 ((_ int2bv 8) 0) ((_ int2bv 8) 7) 0 2
     (temp___303 a_3d_arr 1 ((_ int2bv 8) 2) 2 x1 y1 z1 v1 x2 y2 z2 v2) 1 10
