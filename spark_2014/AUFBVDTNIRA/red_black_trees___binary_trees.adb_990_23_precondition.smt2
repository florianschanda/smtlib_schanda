...
(declare-fun temp___2718 () (Array Int us_rep1))
...
(declare-fun temp___2717 () (Array Int us_rep1))

(declare-fun o5 () us_rep1)

(declare-fun o6 () us_split_fields)

(declare-fun temp___2716 () (Array Int us_rep1))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2717 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2717 (parent
                      (mk___rep2
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2718 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2718 (parent
                      (mk___rep2
...
;; H
  ...
  (model____function_guard temp___2717
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  root))
  (and (dynamic_invariant3 temp___2717 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2717 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2717 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2717 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2717 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2717 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2717 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2717 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2717 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o5 (select temp___2717 i)))

;; H
  (assert (= o6 (us_split_fields1 o5)))

;; H
  (assert (= result2 (rec__tree_model__path_type__k o6)))
...
;; H
  ...
  (= temp___2718 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (model____function_guard temp___2718
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  root))
  (and (dynamic_invariant3 temp___2718 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2718 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2718 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2718 (parent
                              ...
                              f_old__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2718 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2718 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2718 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2718 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2718 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2718 j)))) true))
  (= j i1)))))))))))))))
...
;; H
  (assert
  (=> (= result2 true)
  (= (mk___rep (mk___split_fields o o1)) (select temp___2718 i))))

;; H
  (assert (=> (= result2 true) (= o2 (mk___split_fields o o1))))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= o4 (length o3)) (and (in_range5 o4) (<= (+ 0 o4) 2147483647)))))

;; H
  (assert (=> (= result2 true) (= result1 (ite (< o4 n2) true false))))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2716 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2716 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___2716 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (model____function_guard temp___2716
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  root))
  (and (dynamic_invariant3 temp___2716 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2716 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2716 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2716 (parent
                              ...
                              f_old__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2716 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2716 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2716 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2716 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2716 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2716 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o7 (select temp___2716 i)))
