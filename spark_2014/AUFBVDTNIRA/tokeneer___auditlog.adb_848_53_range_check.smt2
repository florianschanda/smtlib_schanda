...
(define-fun bool_eq6 ((a (Array Int fileentrycountt)) (a__first Int)
...
(define-fun bool_eq9 ((a (Array Int logfileindext)) (a__first Int)
...
(define-fun bool_eq13 ((a (Array Int filestatust)) (a__first Int)
...
;; nextlistindex__post_axiom
  ...
  (! (=> (dynamic_invariant2 value true true true)
     ...
     (=> (nextlistindex__function_guard result value) (dynamic_invariant2
...
;; nextlistindex__def_axiom
  ...
  (forall ((value Int))
  (! (=>
     (and (dynamic_invariant2 value true true true)
...
(define-fun dynamic_invariant4 ((temp___expr_926 Int)
...
(define-fun dynamic_invariant5 ((temp___expr_938 Int)
...
(define-fun dynamic_invariant6 ((temp___expr_1062 Int)
...
(declare-fun o () filestatust)

(declare-fun o1 () (Array Int filestatust))

(declare-fun currentlogfile1 () Int)

(declare-fun result () (Array Int filestatust))
...
;; H
  (assert (< (to_rep2 usedlogfiles__split_fields) 17))
...
;; WP_parameter_def
 ;; File "auditlog.adb", line 43, characters 0-0
  (not (in_range5 (+ (to_rep2 usedlogfiles__split_fields) 1))))
(check-sat)
