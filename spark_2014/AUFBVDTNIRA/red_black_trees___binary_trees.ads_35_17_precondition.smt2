...
(declare-fun dummy3 () position_type)
...
;; size__post_axiom
  ...
  (! (=> (type_invariant f1)
     (let ((result (size f1)))
     (=> (size__function_guard result f1) (dynamic_invariant2 result true
...
;; valid_root__post_axiom
  ...
  (forall ((f1 us_rep1))
  (forall ((i1 Int))
  (! (=> (and (dynamic_invariant i1 true true true) (type_invariant f1))
     (let ((result (valid_root f1 i1)))
     (and (size__function_guard (size f1) f1)
     (=> (valid_root__function_guard result f1 i1)
     (=> (< (size f1) i1) (not (= result true))))))) :pattern ((valid_root f1
                                                               i1)) ))))
...
;; valid_root__def_axiom
  ...
  (forall ((f1 us_rep1))
  (forall ((i1 Int))
  (! (=> (valid_root__function_guard (valid_root f1 i1) f1 i1)
     (= (= (valid_root f1 i1) true)
     (and
     (<= i1 (to_rep (rec__binary_trees__forest__s (us_split_fields3 f1))))
     (= (to_rep1
        (rec__binary_trees__cell__position
        (us_split_fields1
        (let ((temp___298 (rec__binary_trees__forest__c
                          (us_split_fields3 f1))))
        (select temp___298 i1))))) 2)))) :pattern ((valid_root f1 i1)) ))))
...
(define-fun dynamic_invariant3 ((temp___expr_162 Int)
  ...
  (temp___do_toplevel_161 Bool)) Bool (=>
                                      ...
                                      (<= 0 2)) (in_range4 temp___expr_162)))

(declare-fun binary_trees__peek__result () Int)
...
(declare-fun binary_trees__peek__result1 () Int)

(declare-fun binary_trees__peek__result2 () Int)

(declare-fun binary_trees__peek__result3 () Int)

(declare-fun binary_trees__peek__result4 () Int)

(declare-fun binary_trees__peek__result5 () Int)
...
;; H
  (assert
  (= (mk_int__ref binary_trees__peek__result4) (mk_int__ref
                                               binary_trees__peek__result2)))
...
;; H
  (assert
  (and (= o1 binary_trees__peek__result4) (in_range1
  binary_trees__peek__result4)))
...
;; H
  (assert
  (and (= o2 binary_trees__peek__result4) (in_range1
  binary_trees__peek__result4)))
