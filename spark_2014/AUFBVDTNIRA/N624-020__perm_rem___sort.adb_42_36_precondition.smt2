...
(declare-fun temp___352 () (Array Int natural))

(declare-fun temp___3521 () t)
...
(define-fun temp___3522 () us_t (mk___t temp___352 temp___3521))
...
;; H
  (assert (invariant____function_guard (invariant__ o31) o31))

;; H
  (assert (invariant____function_guard (invariant__ o32) o32))

;; H
  (assert (remove__function_guard (remove o31 o19) o31 o19))

;; H
  (assert (remove__function_guard (remove o32 o19) o32 o19))
...
;; H
  (assert
  (and
  (and (= o31 (remove (mk___t values2 (mk 1 100)) o16))
  (remove__function_guard o31 (mk___t values2 (mk 1 100)) o16))
  (and (dynamic_invariant4 o31 true false true)
...
;; H
  (assert
  (and
  (and (= o32 (remove (mk___t interm1 (mk 1 100)) o13))
  (remove__function_guard o32 (mk___t interm1 (mk 1 100)) o13))
...
;; H
  (assert
  (and
  (and (= o20 (remove_eq o32 o31 o19)) (remove_eq__function_guard o20 
  o32 o31 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___181 (remove o31 o19)))
     (let ((temp___180 (remove o32 o19)))
...
;; H
  (assert (invariant____function_guard (invariant__ temp___3522)
  temp___3522))
...
;; H
  (assert
  (and
  (and (= o30 (remove (mk___t values2 (mk 1 100)) o24))
  (remove__function_guard o30 (mk___t values2 (mk 1 100)) o24))
  (and (dynamic_invariant4 o30 true false true)
  (and (= (invariant__ o30) true)
  (and (= (to_rep1 (last o26)) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o24 1)))
  (= (to_rep (select values2 k)) (to_rep (select o25 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o24 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select values2 k)) (to_rep (select o25 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o24 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select values2 (+ k 1))) (to_rep (select o25 k))))))))))))

;; H
  (assert
  (and
  (and (= temp___3522 (remove o30 o27)) (remove__function_guard temp___3522
  o30 o27))
  (and (dynamic_invariant4 temp___3522 true false true)
  (and (= (invariant__ temp___3522) true)
  (and (= (to_rep1 (last temp___3521)) (- (to_rep1 (last o26)) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o27 1)))
  (= (to_rep (select o25 k)) (to_rep (select temp___352 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last o26))))
  (= (to_rep (select o25 k)) (to_rep (select temp___352 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o27 k) (<= k (- (to_rep1 (last o26)) 1)))
  (= (to_rep (select o25 (+ k 1))) (to_rep (select temp___352 k))))))))))))

;; H
  (assert (and (= o29 y) (in_range5 y)))

;; H
  (assert (and (= o28 x) (in_range5 x)))
