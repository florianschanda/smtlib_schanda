...
;; H
  (assert
  (and (= o3 (sub RNE2 fliteral4 diff_out11)) (tqtisFinite
  (sub RNE2 fliteral4 diff_out11))))
...
;; H
  ...
  (ite (lt difference_out11 fliteral3) true false))) (tqtisFinite o4)))
...
;; H
  ...
  (ite (lt fliteral3 difference_out11) true false))) (tqtisFinite o5)))

;; H
  (assert (= o6 (sub RNE2 o5 o4)))
