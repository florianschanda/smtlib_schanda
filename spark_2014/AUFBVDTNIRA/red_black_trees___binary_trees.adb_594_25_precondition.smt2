...
;; H
  (assert (= o81 (select temp___1254 o80)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1253 o75))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1253 o75)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o75))
...
;; H
  (assert (= o77 (select temp___1253 o76)))
...
;; H
  ...
  (= temp___1252 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___1252 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1252 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o71 (select temp___1252 o70)))
