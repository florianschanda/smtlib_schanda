...
(declare-fun o82 () us_split_fields)
...
;; H
  (assert (= o81 (select temp___1923 o80)))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o75))
  (and (dynamic_invariant3 temp___1922 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1922 o75))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1922 o75)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o75))
...
;; H
  (assert (= o77 (select temp___1922 o76)))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1921 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1921 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___1921 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (model____function_guard temp___1921
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  root))
  (and (dynamic_invariant3 temp___1921 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1921 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1921 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1921 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o71 (select temp___1921 o70)))
