...
(declare-fun user_eq7 (bits_14 bits_14) Bool)

(declare-fun dummy7 () bits_14)
...
(declare-fun to_rep5 (bits_14) (_ BitVec 16))

(declare-fun of_rep5 ((_ BitVec 16)) bits_14)
...
;; range_axiom
  (assert
  (forall ((x bits_14)) (! (in_range5 (to_rep5 x)) :pattern ((to_rep5 x)) )))
...
(define-fun to_int7 ((x bits_14)) Int (bv2nat (to_rep5 x)))
...
(declare-fun dw1000__register_types__sys_ctrl_type__sfcst__first__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__sfcst__last__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__sfcst__position () Int)
...
(declare-fun dw1000__register_types__sys_ctrl_type__txstrt__first__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__txstrt__last__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__txstrt__position () Int)
...
(declare-fun dw1000__register_types__sys_ctrl_type__txdlys__first__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__txdlys__last__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__txdlys__position () Int)
...
(declare-fun dw1000__register_types__sys_ctrl_type__cansfcs__first__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__cansfcs__last__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__cansfcs__position () Int)
...
(declare-fun dw1000__register_types__sys_ctrl_type__trxoff__first__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__trxoff__last__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__trxoff__position () Int)
...
(declare-fun dw1000__register_types__sys_ctrl_type__wait4resp__first__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__wait4resp__last__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__wait4resp__position () Int)
...
(declare-fun dw1000__register_types__sys_ctrl_type__rxenab__first__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__rxenab__last__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__rxenab__position () Int)
...
(declare-fun dw1000__register_types__sys_ctrl_type__rxdlye__first__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__rxdlye__last__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__rxdlye__position () Int)
...
(declare-fun dw1000__register_types__sys_ctrl_type__hrbpt__first__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__hrbpt__last__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__hrbpt__position () Int)
...
(declare-fun dw1000__register_types__sys_ctrl_type__reserved_1__first__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__reserved_1__last__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__reserved_1__position () Int)
...
(declare-fun dw1000__register_types__sys_ctrl_type__reserved_2__first__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__reserved_2__last__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__reserved_2__position () Int)
...
(declare-fun dw1000__register_types__sys_ctrl_type__reserved_3__first__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__reserved_3__last__bit () Int)

(declare-fun dw1000__register_types__sys_ctrl_type__reserved_3__position () Int)
...
(declare-datatypes ()
((sys_ctrl_type__ref (mk_sys_ctrl_type__ref (sys_ctrl_type__content us_rep)))))
...
(define-fun register_type__ref_24__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_17__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_17__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2422 us_t1)
  (temp___is_init_2419 Bool) (temp___skip_constant_2420 Bool)
  (temp___do_toplevel_2421 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2420 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_2422)
                                       (last3 temp___expr_2422))
                                       (and (= (first3 temp___expr_2422) 1)
                                       (= (last3 temp___expr_2422) 4)))))
...
(define-fun target__ref_8__projection ((a target__ref)) us_t2 (target__content
                                                              a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_8__projection ((a source__ref)) us_rep (source__content
                                                               a))

(define-fun dynamic_invariant1 ((temp___expr_2449 us_t2)
  (temp___is_init_2446 Bool) (temp___skip_constant_2447 Bool)
  (temp___do_toplevel_2448 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2447 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_2449)
                                       (last5 temp___expr_2449))
                                       (and (= (first5 temp___expr_2449) 1)
                                       (= (last5 temp___expr_2449) 4)))))
...
(declare-fun temp___7596 () (Array Int bits_8))

(declare-fun temp___75961 () t2)

(declare-fun temp___7597 () (Array Int bits_8))

(declare-fun temp___75971 () t1)
...
(define-fun temp___75962 () us_t2 (mk___t2 temp___7596 temp___75961))
...
;; H
  (assert
  (and (= temp___75962 (register_to_bytes reg)) (dynamic_invariant1
  temp___75962 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___75961)) (to_rep (last4 temp___75961)))
     (+ (- (to_rep (last4 temp___75961)) (to_rep (first4 temp___75961))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___7596 temp___7597))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___75961)) (to_rep (last4 temp___75961))) 
  temp___75971))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___75971)) (to_rep (last2 temp___75971)))
     (+ (- (to_rep (last2 temp___75971)) (to_rep (first2 temp___75971))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7597 temp___75971)))
