...
(declare-fun o28 () (Array Int integer))

(declare-fun o29 () pointer_range)
...
;; H
  ...
  (us_split_fields__content my_stack__split_fields4)))
  (= o34 (mk___rep (us_split_fields__content my_stack__split_fields4)))))

;; H
  (assert
  (and (and (= o35 (count o34)) (count__function_guard o35 o34))
  (and (in_range2 o35)
  (= o35 (to_rep1
         (rec__stack_functional_spec__stack_type__pointer
...
;; H
  (assert
  (and
  (and (= o39 (state__2 (us_split_fields__content my_stack__split_fields4)))
  (state__2__function_guard o39
  (us_split_fields__content my_stack__split_fields4)))
...
;; H
  (assert
  (and (and (= o30 (count o39)) (count__function_guard o30 o39))
  (and (in_range2 o30) (= o30 (to_rep1 o29)))))
...
;; H
  ...
  (= o31 (stack_entry
         ...
         (mk___split_fields my_stack__split_fields my_stack__split_fields1))
         o30))
  (stack_entry__function_guard o31
  (state__2
  (mk___split_fields my_stack__split_fields my_stack__split_fields1)) 
  o30))
  (and (in_range1 o31)
...
;; H
  (assert
  (and (and (= o25 (count o40)) (count__function_guard o25 o40))
...
;; H
  (assert
  (and
  (and (= o41 (state__2 (us_split_fields__content my_stack__split_fields4)))
  (state__2__function_guard o41
  (us_split_fields__content my_stack__split_fields4)))
  (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields
                                                        o21 o22))))
...
;; H
  (assert
  (and
  (and (= o32 (stack_entry o41 o27)) (stack_entry__function_guard o32 
  o41 o27)) (and (in_range1 o32) (= o32 (to_rep (select o21 o27))))))
...
;; H
  (assert
  (and
  (and (= o42 (state__2 (us_split_fields__content my_stack__split_fields4)))
  (state__2__function_guard o42
  (us_split_fields__content my_stack__split_fields4)))
  (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields
                                                        o16 o17))))
...
;; H
  (assert
  (and (and (= o18 (count o42)) (count__function_guard o18 o42))
  (and (in_range2 o18) (= o18 (to_rep1 o17)))))
