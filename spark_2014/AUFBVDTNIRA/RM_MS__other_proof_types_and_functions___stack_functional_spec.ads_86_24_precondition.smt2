...
;; H
  (assert
  (and (= o30 (count o39)) (and (in_range2 o30) (= o30 (to_rep1 o29)))))
...
;; H
  (assert
  (and (= o25 (count o40)) (and (in_range2 o25) (= o25 (to_rep1 o24)))))
...
;; H
  (assert
  (and (= o32 (stack_entry o41 o27))
  (and (in_range1 o32) (= o32 (to_rep (select o21 o27))))))
...
;; H
  (assert
  (and (= o18 (count o42)) (and (in_range2 o18) (= o18 (to_rep1 o17)))))
