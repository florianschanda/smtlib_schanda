...
(declare-fun temp___2868 () (Array Int us_rep1))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2868 (parent f i3)))) (position f i3)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2868 i3))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2868 (parent f i3)))) (position f i3)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2868 i3))))))
...
;; H
  (assert
  (and
  (and (= temp___2868 (model__ f root)) (model____function_guard temp___2868
  f root))
  (and (dynamic_invariant5 temp___2868 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2868 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2868 root)))) 0)
  (and
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=> (not (= i3 root))
  (ite (and (not (= (parent f i3) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2868 (parent f i3)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2868 i3))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2868 i3))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2868 i3)))) 0))))
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2868 j2))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2868 i3)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2868 j2)))) true))
  (= j2 i3))))))))))))))

;; H
  (assert (= o30 (select temp___2868 i2)))
