...
(declare-fun result5 () capacity_range)
...
;; H
  ...
  (=> (and (<= 1 i) (<= i idx3))
  (= (get
     (model__ (mk___rep result____split_discrs result____split_fields18)) i) 
  (get (model__ left) i))))))
...
;; H
  (assert
  (= (mk___rep (mk___split_discrs result5) (mk___split_fields result6)) 
  (vector__content amortized_queue__Oconcat__result5)))

(assert
;; WP_parameter_def
 ;; File "a-cofove.ads", line 76, characters 0-0
  (not
  (= (length (vector__content amortized_queue__Oconcat__result5)) (+ 
