...
(declare-fun temp___295 () positive)

(declare-fun temp___2951 () natural)

(declare-fun temp___2952 () positive)

(declare-fun temp___2953 () positive)

(declare-fun temp___2954 () (Array Int element_type))

(declare-fun temp___2955 () t)
...
;; H
  (assert (= queue__split_discrs (mk___split_discrs temp___295)))

;; H
  (assert (= temp___2951 o6))

;; H
  (assert (= temp___2952 o7))

;; H
  (assert (= temp___2953 o8))

;; H
  (assert (= temp___2954 o9))

;; H
  (assert (= temp___2955 o10))
...
;; H
  (assert (= temp___2951 queue__split_fields5))

;; H
  (assert (= temp___2952 queue__split_fields6))

;; H
  (assert (= temp___2953 queue__split_fields7))

;; H
  (assert (= temp___2954 queue__split_fields8))

;; H
  (assert (= temp___2955 queue__split_fields9))
...
;; WP_parameter_def
 ;; File "bounded_queue_v2.ads", line 28, characters 0-0
  (not (in_range1 (- (to_rep queue__split_fields5) 1))))
(check-sat)
