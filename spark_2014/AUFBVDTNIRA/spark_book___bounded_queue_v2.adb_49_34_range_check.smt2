...
(declare-fun temp___319 () positive)

(declare-fun temp___3191 () natural)

(declare-fun temp___3192 () positive)

(declare-fun temp___3193 () positive)

(declare-fun temp___3194 () (Array Int element_type))

(declare-fun temp___3195 () t)
...
;; H
  (assert (= queue__split_discrs (mk___split_discrs temp___319)))

;; H
  (assert (= temp___3191 o6))

;; H
  (assert (= temp___3192 o7))

;; H
  (assert (= temp___3193 o8))

;; H
  (assert (= temp___3194 o9))

;; H
  (assert (= temp___3195 o10))
...
;; H
  (assert (= temp___3191 queue__split_fields5))

;; H
  (assert (= temp___3192 queue__split_fields6))

;; H
  (assert (= temp___3193 queue__split_fields7))

;; H
  (assert (= temp___3194 queue__split_fields8))

;; H
  (assert (= temp___3195 queue__split_fields9))
