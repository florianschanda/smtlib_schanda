...
(declare-fun temp___882 () us_rep)

(declare-fun temp___881 () read_status)

(declare-fun temp___8811 () character)

(declare-fun temp___8812 () Bool)

(declare-fun temp___880 () Int)

(declare-fun temp___879 () Int)

(declare-fun temp___878 () Int)

(declare-fun temp___877 () read_status)

(declare-fun temp___8771 () character)

(declare-fun temp___8772 () Bool)
...
(declare-fun current_pos8 () int__ref)
...
(declare-fun the_file13 () file__ref)
...
;; H
  (assert (= temp___882 the_file))

;; H
  (assert
  (and (= temp___881 next_read__split_discrs)
  (and (= temp___8811 next_read__split_fields)
  (= temp___8812 next_read__attr__constrained))))

;; H
  (assert (= temp___880 current_pos))

;; H
  (assert (= temp___879 current_col))

;; H
  (assert (= temp___878 current_line))

;; H
  (assert
  (and (= temp___877 current_read__split_discrs)
  (and (= temp___8771 current_read__split_fields)
  (= temp___8772 current_read__attr__constrained))))
...
;; H
  (assert (=> (= result true) (= temp___868 the_file1)))
...
;; H
  (assert (= next_read__split_discrs10 next_read__split_discrs8))

;; H
  (assert (= next_read__split_fields10 next_read__split_fields8))

;; H
  (assert (= current_pos10 current_pos8))

;; H
  (assert (= current_col10 current_col8))

;; H
  (assert (= current_line10 current_line8))

;; H
  (assert (= current_read__split_discrs10 current_read__split_discrs8))

;; H
  (assert (= current_read__split_fields10 current_read__split_fields8))

;; H
  (assert (= the_file9 the_file7))

;; H
  (assert (= next_read__split_discrs11 next_read__split_discrs9))

;; H
  (assert (= next_read__split_fields11 next_read__split_fields9))

;; H
  (assert (= current_pos11 current_pos9))

;; H
  (assert (= current_col11 current_col9))

;; H
  (assert (= current_line11 current_line9))

;; H
  (assert (= current_read__split_discrs11 current_read__split_discrs9))

;; H
  (assert (= current_read__split_fields11 current_read__split_fields9))

;; H
  (assert (= the_file10 the_file8))

;; H
  (assert (= next_read__split_discrs12 next_read__split_discrs10))

;; H
  (assert (= next_read__split_fields12 next_read__split_fields10))

;; H
  (assert (= current_pos12 current_pos10))

;; H
  (assert (= current_col12 current_col10))

;; H
  (assert (= current_line12 current_line10))

;; H
  (assert (= current_read__split_discrs12 current_read__split_discrs10))

;; H
  (assert (= current_read__split_fields12 current_read__split_fields10))

;; H
  (assert (= the_file11 the_file9))
...
;; H
  (assert (= current_pos13 current_pos11))
...
;; H
  (assert (= current_pos14 current_pos12))
...
;; H
  (assert (= next_read__split_discrs15 next_read__split_discrs13))

;; H
  (assert (= next_read__split_fields15 next_read__split_fields13))

;; H
  (assert (= current_pos15 current_pos13))

;; H
  (assert (= current_col15 current_col13))

;; H
  (assert (= current_line15 current_line13))

;; H
  (assert (= current_read__split_discrs15 current_read__split_discrs13))

;; H
  (assert (= current_read__split_fields15 current_read__split_fields13))
...
;; H
  (assert (local_invariant__function_guard
  (local_invariant (us_split_fields__content current_read__split_fields14)
  (us_split_discrs__content current_read__split_discrs14)
  (us_split_fields__content next_read__split_fields14)
  (us_split_discrs__content next_read__split_discrs14))
  (us_split_fields__content current_read__split_fields14)
  (us_split_discrs__content current_read__split_discrs14)
  (us_split_fields__content next_read__split_fields14)
  (us_split_discrs__content next_read__split_discrs14)))
...
;; WP_parameter_def
 ;; File "lexer.adb", line 47, characters 0-0
  ...
  (= (local_invariant (us_split_fields__content current_read__split_fields14)
     (us_split_discrs__content current_read__split_discrs14)
     (us_split_fields__content next_read__split_fields14)
     (us_split_discrs__content next_read__split_discrs14)) true)))
(check-sat)
