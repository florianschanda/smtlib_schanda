...
(declare-fun temp___3641 () (Array Int us_rep1))
...
(declare-fun temp___3680 () (Array Int us_rep1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3680 (parent
                      (mk___rep2
                      (mk___split_fields2 t_old__split_fields1
                      t_old__split_fields2)) i1))))
  (position
  (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3680 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3680 (parent
                      (mk___rep2
...
;; H
  (assert
  (and (= o12 (to_rep1 t_old__split_fields)) (in_range3
...
;; H
  ...
  (= temp___3680 (model__
                 (mk___rep2
                 (mk___split_fields2 t_old__split_fields1
                 t_old__split_fields2)) o12))
  (model____function_guard temp___3680
  (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
  o12))
  (and (dynamic_invariant8 temp___3680 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3680 o12))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3680 o12)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o12))
  (ite (and
       ...
       (= (parent
          (mk___rep2
          (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___3680 (parent
                              (mk___rep2
                              (mk___split_fields2 t_old__split_fields1
                              t_old__split_fields2)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3680 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3680 i1))) true))))))
  (and
  ...
  (= (is_add
     ...
     (position
     (mk___rep2
     (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3680 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3680 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3680 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3680 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3680 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= o13 (select temp___3680 l)))
...
;; H
  (assert
  (=> (< v (to_rep (select t_old__split_fields3 l)))
  (= result2 (ite (= d 0) true false))))

;; H
  (assert
  (=> (not (< v (to_rep (select t_old__split_fields3 l))))
  (= result2 (ite (= d 1) true false))))
...
;; H
  ...
  (= (parent
     (mk___rep2
     (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) j1) 
  l)
  (not
  (= (position
     (mk___rep2
...
;; H
  ...
  (and
  (and
  (= o10 (size (rec__search_trees__search_tree__struct (us_split_fields7 t))))
  (size__function_guard o10
  (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range4
  o10)))
...
;; H
  (assert
  (and
  (= o7 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
...
;; H
  ...
  (= result6 (valid_root
             (rec__search_trees__search_tree__struct (us_split_fields7 t))
             o7))
  (valid_root__function_guard result6
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o7))
  (=>
  (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) 
  o7) (not (= result6 true)))))
...
;; H
  (assert (position__function_guard
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o6)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o6))

;; H
  (assert (parent__function_guard
  (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o6)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o6))

;; H
  (assert
  (forall ((j1 Int)) (parent__function_guard
  (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1)))

;; H
  (assert
  (forall ((j1 Int)) (position__function_guard
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1)))
...
;; H
  ...
  (and
  (and
  (= o6 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) 
        l d))
  (peek__function_guard o6
  ...
  (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t))
     o6) d)
  (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t))
     o6) l))
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 100))
  (=>
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3641 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___3641 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___3641 (model__
                 (mk___rep2
                 (mk___split_fields2 t_old__split_fields1
                 t_old__split_fields2)) o))
  (model____function_guard temp___3641
  (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
  o))
  (and (dynamic_invariant8 temp___3641 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3641 o))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3641 o)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___3641 (parent
                              ...
                              t_old__split_fields2)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3641 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3641 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3641 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3641 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3641 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3641 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___3641 j)))
...
;; H
  (assert
  (and
  (= o5 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
