...
(define-fun dynamic_invariant7 ((temp___expr_273 us_rep3)
...
;; size__post_axiom
  (assert
  (forall ((f us_rep3))
  (! (=> (dynamic_invariant7 f true true true) (dynamic_invariant2 (size f)
...
;; peek__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant2 result true false true)))) :pattern ((peek f i d)) ))))

(declare-fun model__ (us_rep3 Int) (Array Int us_rep1))

(declare-fun model____function_guard ((Array Int us_rep1) us_rep3 Int) Bool)

(define-fun dynamic_invariant8 ((temp___expr_216 (Array Int us_rep1))
...
(define-fun dynamic_invariant9 ((temp___expr_376 us_rep4)
...
(define-fun type_invariant1 ((temp___392 us_rep4)) Bool (ite (= (size
                                                                (rec__search_trees__search_tree__struct
                                                                (us_split_fields7
                                                                temp___392))) 0)
                                                        (= (to_rep1
...
;; size__post_axiom
  ...
  (! (=> (and (dynamic_invariant9 t1 true true true) (type_invariant1 t1))
     (dynamic_invariant2 (size1 t1) true false true)) :pattern ((size1 t1)) )))

;; size__def_axiom
  (assert
  (forall ((t1 us_rep4))
  (! (=> (dynamic_invariant9 t1 true true true)
     (= (size1 t1) (size
                   (rec__search_trees__search_tree__struct
...
;; position__post_axiom
  ...
  (! (=>
     (and
     (and (dynamic_invariant7 f true true true) (dynamic_invariant1 i true
     true true)) (not (= (parent f i) 0))) (dynamic_invariant3 (position f i)
...
(declare-fun temp___2065 () (Array Int us_rep1))
...
(declare-fun temp___2092 () (Array Int us_rep1))
...
;; H
  ...
  (= (tree_structure
     (mk___rep2
     (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))) true))

;; H
  (assert
  (= (tree_structure
     (rec__search_trees__search_tree__struct (us_split_fields7 t))) true))
...
;; H
  ...
  (and (dynamic_invariant8 temp___2092 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2092 o12))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2092 o12)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o12))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___2092 (parent
                              (mk___rep2
                              (mk___split_fields2 t_old__split_fields1
                              t_old__split_fields2)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2092 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2092 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2092 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2092 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2092 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2092 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= o13 (select temp___2092 l)))
...
;; H
  ...
  (and (dynamic_invariant8 temp___2065 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2065 o))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2065 o)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___2065 (parent
                              (mk___rep2
                              (mk___split_fields2 t_old__split_fields1
                              t_old__split_fields2)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2065 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2065 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2065 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2065 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2065 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2065 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___2065 j)))
