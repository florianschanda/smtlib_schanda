...
;; H
  ...
  (= (bool_eq2 use_ordered_sets__are_disjoint_2__cu__assume1 no_element) true)
  (and
...
;; H
  (assert
  (and (= temp___7421 (next s1 (mk___rep1 cu__split_fields5)))
...
;; H
  (assert (= temp___742 cu__split_fields3))
