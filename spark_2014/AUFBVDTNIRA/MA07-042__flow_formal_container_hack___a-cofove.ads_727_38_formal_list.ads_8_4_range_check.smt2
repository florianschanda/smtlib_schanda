...
(declare-datatypes ()
((us_split_discrs
 (mk___split_discrs (rec__formal_list__vec__vector__capacity capacity_range)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) capacity_range 
  (rec__formal_list__vec__vector__capacity a))
...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__formal_list__vec__vector us_main_type)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields)) us_main_type 
  (rec__formal_list__vec__vector a))
...
(declare-fun formal_list__vec__vector__capacity__first__bit () Int)

(declare-fun formal_list__vec__vector__capacity__last__bit () Int)

(declare-fun formal_list__vec__vector__capacity__position () Int)

;; formal_list__vec__vector__capacity__first__bit_axiom
  (assert (<= 0 formal_list__vec__vector__capacity__first__bit))

;; formal_list__vec__vector__capacity__last__bit_axiom
  (assert
  (< formal_list__vec__vector__capacity__first__bit formal_list__vec__vector__capacity__last__bit))

;; formal_list__vec__vector__capacity__position_axiom
...
(define-fun default_initial_assumption ((temp___expr_241 us_rep1)
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (of_int 1) true)
                                               (to_rep
                                               (rec__formal_list__vec__vector__capacity
