...
(declare-fun p__good__x__assume () enum)

(declare-fun p__good__x__assume1 () integer)

(declare-fun p__good__x__assume2 () float)
...
(declare-fun temp___146 () enum)

(declare-fun temp___1461 () integer)

(declare-fun temp___1462 () float)
