...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= starting_at j1) (<= j1 (- index2 1)))
  (<= (to_rep (select values min2)) (to_rep (select values j1)))))))
...
;; H
  (assert (and (= o (- index2 1)) (in_range1 (- index2 1))))

;; H
  (assert (= o1 (ite (<= j o) true false)))

;; H
  (assert (= result2 (ite (<= starting_at j) o1 false)))
