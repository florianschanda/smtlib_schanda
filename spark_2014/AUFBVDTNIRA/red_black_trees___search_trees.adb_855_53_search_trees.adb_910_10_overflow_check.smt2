...
(declare-fun temp___924 () (Array Int us_rep1))
...
(declare-fun temp___925 () (Array Int us_rep1))
...
(declare-fun temp___926 () (Array Int us_rep1))
...
(declare-fun temp___923 () (Array Int us_rep1))
...
;; H
  ...
  (= temp___926 (model__
                (rec__search_trees__search_tree__struct t__split_fields10)
                o38))
  (and (dynamic_invariant6 temp___926 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___926 o38))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___926 o38)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o38))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___926 (parent
                             (rec__search_trees__search_tree__struct
                             t__split_fields10) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___926 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___926 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___926 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___926 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___926 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___926 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o39 (select temp___926 y1)))
...
;; H
  ...
  (= temp___925 (model__
                ...
                (let ((subject f_5__split_fields)) f_5__split_fields2)) 
                o34))
  (and (dynamic_invariant6 temp___925 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___925 o34))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___925 o34)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o34))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___925 (parent
                             (mk___rep2
                             (let ((subject f_5__split_fields))
                             f_5__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___925 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___925 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___925 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___925 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___925 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___925 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o35 (select temp___925 i1)))
...
;; H
  ...
  (= temp___924 (model__
                ...
                (let ((subject f_5__split_fields)) f_5__split_fields2)) 
                o31))
  (and (dynamic_invariant6 temp___924 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___924 o31))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___924 o31)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o31))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___924 (parent
                             (mk___rep2
                             (let ((subject f_5__split_fields))
                             f_5__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___924 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___924 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___924 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___924 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___924 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___924 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o32 (select temp___924 i1)))
...
;; H
  ...
  (= temp___923 (model__
                ...
                (let ((subject f_5__split_fields)) f_5__split_fields2)) 
                o44))
  (and (dynamic_invariant6 temp___923 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___923 o44))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___923 o44)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o44))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___923 (parent
                             (mk___rep2
                             (let ((subject f_5__split_fields))
                             f_5__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___923 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___923 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___923 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___923 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___923 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___923 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o45 (select temp___923 i1)))
