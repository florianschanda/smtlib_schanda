...
;; H
  (assert
  (and (= o13 (length q)) (and (in_range3 o13) (<= (+ 0 o13) 2147483647))))

;; H
  (assert
  (and (= o10 (length v)) (and (in_range3 o10) (<= (+ 0 o10) 2147483647))))

;; H
  (assert
  (and (= o11 (length p)) (and (in_range3 o11) (<= (+ 0 o11) 2147483647))))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= o8 (length q)) (and (in_range3 o8) (<= (+ 0 o8) 2147483647)))))

;; H
  (assert (=> (= result2 true) (= o9 (ite (<= i2 o8) true false))))

;; H
  (assert (=> (= result2 true) (= result3 (ite (<= 1 i2) o9 false))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o6 (length v)) (and (in_range3 o6) (<= (+ 0 o6) 2147483647)))))

;; H
  (assert (=> (= result1 true) (= o7 (ite (<= i1 o6) true false))))

;; H
  (assert (=> (= result1 true) (= result4 (ite (<= 1 i1) o7 false))))
