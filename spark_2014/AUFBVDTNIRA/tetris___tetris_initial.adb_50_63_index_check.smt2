...
(declare-fun tetris_initial__piece__s__first__bit () Int)

(declare-fun tetris_initial__piece__s__last__bit () Int)

(declare-fun tetris_initial__piece__s__position () Int)
...
(declare-fun tetris_initial__piece__d__first__bit () Int)

(declare-fun tetris_initial__piece__d__last__bit () Int)

(declare-fun tetris_initial__piece__d__position () Int)
...
(declare-fun tetris_initial__piece__x__first__bit () Int)

(declare-fun tetris_initial__piece__x__last__bit () Int)

(declare-fun tetris_initial__piece__x__position () Int)
...
(declare-fun tetris_initial__piece__y__first__bit () Int)

(declare-fun tetris_initial__piece__y__last__bit () Int)

(declare-fun tetris_initial__piece__y__position () Int)
...
(declare-fun tetris_initial__possible_i_shapes__aggregate_def (map1 map1 map1
  map1) (Array Int map1))
...
;; def_axiom
  ...
  (temp___141 map1))
  (let ((temp___137 (tetris_initial__possible_i_shapes__aggregate_def
...
(declare-fun tetris_initial__possible_three_shapes__aggregate_def (map1 map1
...
;; def_axiom
  ...
  (temp___245 map1))
  (let ((temp___225 (tetris_initial__possible_three_shapes__aggregate_def
...
;; possible_i_shapes__def_axiom
  (assert
  (= possible_i_shapes (tetris_initial__possible_i_shapes__aggregate_def
...
;; possible_three_shapes__def_axiom
  (assert
  (= possible_three_shapes (tetris_initial__possible_three_shapes__aggregate_def
...
;; H
  (assert
  (= (tetris_initial__possible_i_shapes__aggregate_def
...
;; H
  (assert
  (= (tetris_initial__possible_three_shapes__aggregate_def
...
;; H
  (assert
  (and
  (forall ((temp___735 Int))
  (=> (and (<= 1 temp___735) (<= temp___735 50))
  (=> (not (= (+ (to_rep3 cur_piece__split_fields3) y2) temp___735))
  (= (select cur_board1 temp___735) (select cur_board temp___735)))))
  (and (<= 0 x2) (<= x2 3))))
...
(assert
;; WP_parameter_def
 ;; File "tetris_initial.adb", line 107, characters 0-0
