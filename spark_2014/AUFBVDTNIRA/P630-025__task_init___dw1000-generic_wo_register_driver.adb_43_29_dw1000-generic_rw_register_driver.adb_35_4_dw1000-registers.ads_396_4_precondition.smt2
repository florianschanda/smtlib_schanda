...
(define-fun dynamic_invariant ((temp___expr_4812 us_t1)
  ...
  (temp___do_toplevel_4811 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_4812))
                                       (and (= (first3 temp___expr_4812) 1)
                                       (= (last4 temp___expr_4812) 2)))))
...
(define-fun dynamic_invariant1 ((temp___expr_4828 us_t2)
  ...
  (temp___do_toplevel_4827 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_4828))
                                       (and (= (first5 temp___expr_4828) 1)
                                       (= (last6 temp___expr_4828) 2)))))
...
;; H
  (assert
  (and
  (and (= temp___77992 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___77992 reg)) (dynamic_invariant1
  temp___77992 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___77991)) (to_rep (last5 temp___77991)))
     (+ (- (to_rep (last5 temp___77991)) (to_rep (first4 temp___77991))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___77991)) (to_rep (last5 temp___77991))) 
  temp___78001))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___78001)) (to_rep (last3 temp___78001)))
     (+ (- (to_rep (last3 temp___78001)) (to_rep (first2 temp___78001))) 1)
