...
(declare-fun temp___634 () count_type)
...
;; H
  ...
  (let ((temp___644 (keys (mk___rep r__split_discrs r__split_fields4))))
...
;; H
  (assert
  (let ((temp___650 (keys (mk___rep r__split_discrs r__split_fields4))))
...
;; H
  (assert
  (and (= temp___6341 (next s (mk___rep1 cu__split_fields4)))
  ...
  (= (bool_eq2 temp___6341 no_element) true)
...
;; H
  (assert (= cu__split_fields3 (mk___split_fields1 temp___634)))
...
(define-fun temp___644 () us_rep3 (keys
