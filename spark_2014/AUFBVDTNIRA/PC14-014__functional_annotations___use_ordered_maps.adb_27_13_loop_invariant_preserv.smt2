...
(declare-fun use_ordered_maps__apply_f__cu__assume () count_type)
...
(declare-fun temp___661 () count_type)
...
(define-fun temp___6611 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___661)))
...
;; H
  ...
  (ite (= (= (length s) 0) true)
  (= (bool_eq2 use_ordered_maps__apply_f__cu__assume1 no_element) true)
  (and
...
;; H
  ...
  (let ((temp___673 (keys (mk___rep r__split_discrs r__split_fields4))))
  (exists ((temp___672 Int))
  (and
  (and (in_range3 temp___672)
  (= (iter_has_element temp___673 temp___672) true))
  (= (get2 (model__ (mk___rep r__split_discrs r__split_fields4))
     (get temp___673 temp___672)) (f (get2 (model__ s) (get (keys s) i))))))))))

;; H
  (assert
  (let ((temp___682 (keys (mk___rep r__split_discrs r__split_fields4))))
  (forall ((temp___681 Int))
  (=>
  (and (in_range3 temp___681)
  (= (iter_has_element temp___682 temp___681) true))
  (exists ((i Int))
  (and
  (and (<= 1 i)
  (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1)))
...
;; H
  ...
  (forall ((i Int))
  (=>
  (and (<= (get1 (positions s) (mk___rep1 cu__split_fields4)) i)
  (<= i (length s)))
  (not
...
;; H
  ...
  (= (get (keys (mk___rep r__split_discrs r__split_fields3))
     (find (keys (mk___rep r__split_discrs r__split_fields3)) o)) o))
  (= (equal_except (keys (mk___rep r__split_discrs r__split_fields4))
     (keys (mk___rep r__split_discrs r__split_fields3))
     (find (keys (mk___rep r__split_discrs r__split_fields3)) o)) true))
  ...
  (= (get (keys (mk___rep r__split_discrs r__split_fields3))
     (find (keys (mk___rep r__split_discrs r__split_fields3)) o)) o))
  (= (range_equal (keys (mk___rep r__split_discrs r__split_fields4))
     (keys (mk___rep r__split_discrs r__split_fields3)) 1
     (- (find (keys (mk___rep r__split_discrs r__split_fields3)) o) 1)) true))
  (= (range_shifted (keys (mk___rep r__split_discrs r__split_fields4))
     (keys (mk___rep r__split_discrs r__split_fields3))
     (find (keys (mk___rep r__split_discrs r__split_fields3)) o)
...
;; H
  (assert
  (and (= temp___6611 (next s (mk___rep1 cu__split_fields4)))
  ...
  (= (bool_eq2 temp___6611 no_element) true)
  (and (= (has_key1 (positions s) temp___6611) true)
  (= (get1 (positions s) temp___6611) (+ (get1 (positions s)
...
;; H
  (assert (= cu__split_fields3 (mk___split_fields1 temp___661)))
...
(define-fun temp___673 () us_rep3 (keys
                                  (mk___rep r__split_discrs r__split_fields3)))

;; H
  (assert (f__function_guard (f (get2 (model__ s) (get (keys s) i)))
  (get2 (model__ s) (get (keys s) i))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  ...
  (and (in_range3 temp___672)
  (= (iter_has_element temp___673 temp___672) true))
  (= (get2 (model__ (mk___rep r__split_discrs r__split_fields3))
     (get temp___673 temp___672)) (f (get2 (model__ s) (get (keys s) i))))))))
(check-sat)
