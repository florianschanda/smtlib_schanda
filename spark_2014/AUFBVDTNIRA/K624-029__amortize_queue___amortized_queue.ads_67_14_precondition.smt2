...
(declare-fun amortized_queue__front__result () Int)

(declare-fun o () Int)

(declare-fun o1 () capacity_range)

(declare-fun o2 () us_main_type)

(declare-fun result () Int)

(declare-fun amortized_queue__front__result1 () Int)

(declare-fun amortized_queue__front__result2 () Int)

(declare-fun amortized_queue__front__result3 () Int)

(declare-fun amortized_queue__front__result4 () Int)

(declare-fun amortized_queue__front__result5 () Int)

(define-fun o3 () us_rep (mk___rep (mk___split_discrs o1)
...
;; H
  (assert
  (= (mk_int__ref result) (mk_int__ref amortized_queue__front__result)))
...
;; H
  (assert
  (= (mk_int__ref amortized_queue__front__result4) (mk_int__ref
                                                   amortized_queue__front__result2)))
