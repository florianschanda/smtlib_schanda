...
(declare-fun step_function__min__result () t)

(declare-fun result () t)

(declare-fun step_function__min__result1 () t)

(declare-fun result1 () t)

(declare-fun step_function__min__result2 () t)

(declare-fun step_function__min__result3 () t)

(declare-fun step_function__min__result4 () t)

(declare-fun step_function__min__result5 () t)

(declare-fun step_function__min__result6 () t)

(declare-fun step_function__min__result7 () t)

(declare-fun step_function__min__result8 () t)
...
;; H
  (assert
  (=> (le x1 x2) (= step_function__min__result1 step_function__min__result3)))

;; H
  (assert
  (=> (le x1 x2) (= step_function__min__result4 step_function__min__result1)))

;; H
  (assert (=> (le x1 x2) (= result step_function__min__result)))

;; H
  (assert (=> (le x1 x2) (= step_function__min__result1 x1)))
...
;; H
  (assert (=> (not (le x1 x2)) (= result1 step_function__min__result)))

;; H
  (assert (=> (not (le x1 x2)) (= step_function__min__result2 x2)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (eq step_function__min__result7 x1)))
(check-sat)
