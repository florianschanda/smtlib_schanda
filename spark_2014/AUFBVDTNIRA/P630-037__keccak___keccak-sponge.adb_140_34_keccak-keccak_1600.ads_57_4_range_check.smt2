...
;; H
  (assert (state_of__function_guard
  (state_of (mk___rep (us_split_fields__content ctx__split_fields18)))
  (mk___rep (us_split_fields__content ctx__split_fields18))))
...
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not (in_range9 (int__content remaining_bits7))))
(check-sat)
