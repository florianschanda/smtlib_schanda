...
;; H
  (assert
  (and
  (and (= p__t_FIRST__assume (id fliteral2)) (id__function_guard
  p__t_FIRST__assume fliteral2))
...
;; H
  (assert
  (and
  (and (= p__t_LAST__assume (id fliteral)) (id__function_guard
  p__t_LAST__assume fliteral))
