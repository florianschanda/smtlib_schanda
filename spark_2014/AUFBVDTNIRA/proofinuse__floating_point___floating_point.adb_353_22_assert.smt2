...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 60.0)))
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral6) (= (tqtreal fliteral6) 4.0)))

(declare-fun fliteral7 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral7) (= (tqtreal fliteral7) 5.0)))
...
;; WP_parameter_def
 ;; File "a-unccon.ads", line 20, characters 0-0
  (not (le (neg fliteral1)
  (add RNE2
  (mul RNE2
  (add RNE2 (add RNE2 (mul RNE2 (add RNE2 x fliteral4) x) fliteral5)
  fliteral6) x) fliteral7))))
(check-sat)
