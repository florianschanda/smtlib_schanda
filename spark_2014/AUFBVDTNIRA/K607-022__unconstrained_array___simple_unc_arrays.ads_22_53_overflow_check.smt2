...
;; H
  ...
  (=> (and (<= 1 j1) (<= j1 (- i2 1)))
  (= (to_rep1
     (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields4)) j1)) (+ 
  (to_rep1
  (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j1)) 
  (to_rep1
  (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 b))) j1))))))))
...
;; H
  ...
  (and
  (and
  (= result3 (same_range (table__content simple_unc_arrays__add__result6) a))
  (same_range__function_guard result3
  (table__content simple_unc_arrays__add__result6) a))
  (= (= result3 true)
  (= (to_rep
     (rec__simple_unc_arrays__table__last
     (us_split_discrs1 (table__content simple_unc_arrays__add__result6)))) 
  (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a)))))))
