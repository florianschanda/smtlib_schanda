...
;; H
  ...
  (and (tqtisFinite o6)
  (and (le fliteral2 o6)
  (and (=> (eq x1 fliteral2) (eq o6 fliteral2))
  (and (=> (eq x1 fliteral) (eq o6 fliteral))
  (=> (le fliteral3 x1) (lt fliteral2 o6)))))))))

;; H
  (assert (=> (le fliteral2 x1) (= result35 y4)))

;; H
  (assert (=> (le fliteral2 x1) (= y1 o6)))

;; H
  (assert
  (=> (not (le fliteral2 x1))
  (and (= o7 (mul RNE2 fliteral6 x1)) (tqtisFinite (mul RNE2 fliteral6 x1)))))

;; H
  (assert (=> (not (le fliteral2 x1)) (= o8 (neg o7))))
...
;; H
  ...
  (and (=> (eq o8 fliteral) (eq o9 fliteral))
  (=> (le fliteral3 o8) (lt fliteral2 o9)))))))))

;; H
  (assert (=> (not (le fliteral2 x1)) (= result36 y4)))

;; H
  (assert (=> (not (le fliteral2 x1)) (= y2 o9)))

;; H
  (assert (=> (not (le fliteral2 x1)) (= y1 y2)))

;; H
  (assert (=> (le fliteral2 x1) (= o11 x1)))

;; H
  (assert
  (=> (not (le fliteral2 x1))
  (and (= o10 (mul RNE2 fliteral6 x1)) (tqtisFinite (mul RNE2 fliteral6 x1)))))

;; H
  (assert (=> (not (le fliteral2 x1)) (= o11 (neg o10))))

;; H
  (assert
  (and (= o12 (sqrt2 o11))
  (and (tqtisFinite o12)
  (and (le fliteral2 o12)
  (and (=> (eq o11 fliteral2) (eq o12 fliteral2))
  (and (=> (eq o11 fliteral) (eq o12 fliteral))
  (=> (le fliteral3 o11) (lt fliteral2 o12))))))))
...
;; H
  (assert (= approx1 (div2 RNE2 x1 fliteral6)))

;; H
  (assert
  (and (= o16 (mul RNE2 approx1 approx1)) (tqtisFinite
  (mul RNE2 approx1 approx1))))

;; H
  (assert (= o17 (sub RNE2 x1 o16)))

;; H
  (assert (and (= o18 o17) (tqtisFinite o17)))

;; H
  (assert (= o19 (abs1 o18)))

;; H
  (assert (= result47 (ite (lt fliteral4 o19) true false)))
...
;; H
  ...
  fliteral4 (abs1 (sub RNE2 x1 (mul RNE2 approx2 approx2))))))

(assert
;; WP_parameter_def
 ;; File "control_structures.adb", line 29, characters 0-0
  (not (not (eq approx2 zeroF))))
(check-sat)
