...
;; WP_parameter_def
 ;; File "ar.ads", line 466, characters 0-0
  ...
  (= (bool_eq6 a3 1 16
     (temp___1475 a k
     (temp___1483 (select a k) j (temp___1490 (select (select a k) j) i e))
     (+ k 1)
     (temp___1498 (select a (+ k 1)) j
     (temp___1505 (select (select a (+ k 1)) j) i (- e 1)))) 1 16) true))
  (and (= e 0)
  (= (bool_eq6 a3 1 16
     (temp___1514 a k
     (temp___1522 (select a k) j (temp___1529 (select (select a k) j) i e))
     (+ k 1)
     (temp___1537 (select a (+ k 1)) j
     (temp___1544 (select (select a (+ k 1)) j) i 99))) 1 16) true))))
  (and (= k 16)
  (or
  (and (< 0 e)
  (= (bool_eq6 a3 1 16
     (temp___1553 a k
     (temp___1561 (select a k) j (temp___1568 (select (select a k) j) i e)) 1
     (temp___1576 (select a 1) j
     (temp___1583 (select (select a 1) j) i (- e 1)))) 1 16) true))
  (and (= e 0)
  (= (bool_eq6 a3 1 16
     (temp___1592 a k
     (temp___1600 (select a k) j (temp___1607 (select (select a k) j) i e)) 1
     (temp___1615 (select a 1) j (temp___1622 (select (select a 1) j) i 99)))
     1 16) true)))))))
(check-sat)
