...
(define-fun dynamic_invariant1 ((temp___expr_181 Int)
  ...
  (temp___do_toplevel_180 Bool)) Bool (=>
                                      ...
                                      (<= 1 10)) (in_range4 temp___expr_181)))
...
(declare-fun dummy5 () r)

(declare-datatypes () ((r__ref (mk_r__ref (r__content r)))))
(define-fun r__ref___projection ((a r__ref)) r (r__content a))

(declare-datatypes ()
((us_split_discrs (mk___split_discrs (rec__size_attr__r1__a Bool)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) Bool (rec__size_attr__r1__a
                                                                    a))
...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__size_attr__r1__x character)))))
(define-fun us_split_fields_X__projection ((a us_split_fields)) character 
...
(define-fun size_attr__r1__x__pred ((a us_rep)) Bool (= (to_int1
                                                        (rec__size_attr__r1__a
                                                        (us_split_discrs1 a))) 1))

(define-fun bool_eq6 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (rec__size_attr__r1__a (us_split_discrs1 a)) 
                        (rec__size_attr__r1__a (us_split_discrs1 b)))
...
(declare-fun size_attr__r1__a__first__bit () Int)

(declare-fun size_attr__r1__a__last__bit () Int)

(declare-fun size_attr__r1__a__position () Int)
...
(declare-fun size_attr__r1__x__first__bit () Int)

(declare-fun size_attr__r1__x__last__bit () Int)

(declare-fun size_attr__r1__x__position () Int)
...
(define-fun default_initial_assumption ((temp___expr_195 us_rep)
  (temp___skip_top_level_196 Bool)) Bool (and
                                         (= (attr__constrained
                                            temp___expr_195) false)
                                         (= (rec__size_attr__r1__a
                                            (us_split_discrs1
                                            temp___expr_195)) (of_int 0))))
...
(declare-fun size_attr__r1__a__first__bit1 () Int)

(declare-fun size_attr__r1__a__last__bit1 () Int)

(declare-fun size_attr__r1__a__position1 () Int)
...
(declare-fun size_attr__r1__x__first__bit1 () Int)

(declare-fun size_attr__r1__x__last__bit1 () Int)

(declare-fun size_attr__r1__x__position1 () Int)
...
(define-fun dynamic_invariant2 ((temp___expr_202 us_rep)
  ...
  (temp___do_toplevel_201 Bool)) Bool (and
                                      ...
                                      (in_range5 (of_int 0) temp___expr_202))
...
(define-fun default_initial_assumption1 ((temp___expr_204 us_rep)
  (temp___skip_top_level_205 Bool)) Bool (and
                                         ...
                                         (= (rec__size_attr__r1__a
                                            (us_split_discrs1
                                            temp___expr_204)) (of_int 0))))

(declare-datatypes ()
((us_split_fields2 (mk___split_fields1 (rec__size_attr__r2__x integer)))))
...
(declare-fun size_attr__r2__x__first__bit () Int)

(declare-fun size_attr__r2__x__last__bit () Int)

(declare-fun size_attr__r2__x__position () Int)
...
(declare-datatypes ()
((us_split_fields4
 (mk___split_fields2 (rec__size_attr__r3__x integer)(rec__ext__ us_private)))))
(define-fun us_split_fields_X3__projection ((a us_split_fields4)) integer 
  (rec__size_attr__r3__x a))

(define-fun us_split_fields___projection ((a us_split_fields4)) us_private 
  (rec__ext__ a))
...
(declare-datatypes ()
((us_rep2 (mk___rep2 (us_split_fields5 us_split_fields4)(attr__tag Int)))))
(define-fun us_rep_5__projection ((a us_rep2)) us_split_fields4 (us_split_fields5
                                                                a))

(define-fun us_rep_6__projection ((a us_rep2)) Int (attr__tag a))
...
(declare-fun size_attr__r3__x__first__bit () Int)

(declare-fun size_attr__r3__x__last__bit () Int)

(declare-fun size_attr__r3__x__position () Int)
...
(define-fun default_initial_assumption2 ((temp___expr_219 us_rep2)
...
(define-fun us_split_fields_Y__projection ((a us_split_fields6)) integer 
  (rec__size_attr__r4__y a))

(define-fun us_split_fields_X4__projection ((a us_split_fields6)) integer 
...
(declare-datatypes ()
((us_rep3 (mk___rep3 (us_split_fields7 us_split_fields6)(attr__tag1 Int)))))
...
(define-fun to_base ((a us_rep3)) us_rep2 (mk___rep2
                                          (mk___split_fields2
...
(define-fun of_base ((r1 us_rep2)) us_rep3 (mk___rep3
                                           (mk___split_fields3
                                           (extract__y
...
(declare-fun size_attr__r4__y__first__bit () Int)

(declare-fun size_attr__r4__y__last__bit () Int)

(declare-fun size_attr__r4__y__position () Int)
...
(declare-fun size_attr__r3__x__first__bit1 () Int)

(declare-fun size_attr__r3__x__last__bit1 () Int)

(declare-fun size_attr__r3__x__position1 () Int)
...
(define-fun default_initial_assumption3 ((temp___expr_230 us_rep3)
  (temp___skip_top_level_231 Bool)) Bool (= (attr__tag1 temp___expr_230) 
  us_tag1))
...
(declare-fun dummy12 () (Array Int natural))
...
(define-fun bool_eq12 ((x us_t1)
  (y us_t1)) Bool (bool_eq11 (elts1 x) (to_rep1 (first2 (rt1 x)))
...
((unconstrained_array__ref
 (mk_unconstrained_array__ref (unconstrained_array__content us_t1)))))
(define-fun unconstrained_array__ref___projection ((a unconstrained_array__ref)) us_t1 
...
(define-fun bool_eq13 ((a map1) (a__first Int) (a__last Int) (a__first_2 Int)
...
;; bool_eq_rev
  ...
  (=>
  (= (bool_eq13 b b__first b__last b__first_2 b__last_2 a a__first a__last
...
(define-fun of_array2 ((a map1) (f Int) (l Int) (f2 Int)
  (l2 Int)) us_t2 (mk___t2 a (mk2 f l) (mk3 f2 l2)))
...
(define-fun bool_eq14 ((x us_t2)
  (y us_t2)) Bool (bool_eq13 (elts2 x) (to_rep1 (first4 (rt2 x)))
...
((unconstrained_array_2__ref
 (mk_unconstrained_array_2__ref (unconstrained_array_2__content us_t2)))))
(define-fun unconstrained_array_2__ref___projection ((a unconstrained_array_2__ref)) us_t2 
...
(define-fun bool_eq15 ((a map2) (a__first Int) (a__last Int) (a__first_2 Int)
  ...
  (b__last_3 Int)) Bool (ite (and
                             ...
                             (temp___idx_136 Int) (temp___idx_137 Int))
                             (=>
                             (and
                             (and
                             (and (<= a__first temp___idx_135)
                             (<= temp___idx_135 a__last))
                             (and (<= a__first_2 temp___idx_136)
                             (<= temp___idx_136 a__last_2)))
                             (and (<= a__first_3 temp___idx_137)
                             (<= temp___idx_137 a__last_3)))
                             (= (to_rep2
                                (get1 a temp___idx_135 temp___idx_136
                                temp___idx_137)) (to_rep2
                                                 (get1 b
                                                 (+ (- b__first a__first) temp___idx_135)
                                                 (+ (- b__first_2 a__first_2) temp___idx_136)
                                                 (+ (- b__first_3 a__first_3) temp___idx_137)))))))
                        true false))
...
;; bool_eq_rev
  ...
  (=>
  (= (bool_eq15 b b__first b__last b__first_2 b__last_2 b__first_3 b__last_3
     a a__first a__last a__first_2 a__last_2 a__first_3 a__last_3) true)
  (and
  (and
  (and
  (ite (<= a__first a__last)
  ...
  (= (- a__last_3 a__first_3) (- b__last_3 b__first_3)))
  (< b__last_3 b__first_3)))
  (forall ((temp___idx_135 Int) (temp___idx_136 Int) (temp___idx_137 Int))
  (=>
  (and
  (and (and (<= a__first temp___idx_135) (<= temp___idx_135 a__last))
  (and (<= a__first_2 temp___idx_136) (<= temp___idx_136 a__last_2)))
  (and (<= a__first_3 temp___idx_137) (<= temp___idx_137 a__last_3)))
  (= (to_rep2 (get1 a temp___idx_135 temp___idx_136 temp___idx_137)) 
  (to_rep2
  (get1 b (+ (- b__first a__first) temp___idx_135)
  (+ (- b__first_2 a__first_2) temp___idx_136)
  (+ (- b__first_3 a__first_3) temp___idx_137)))))))))))

(declare-fun dummy16 () map2)
...
(declare-fun user_eq15 (map2 map2) Bool)
...
(define-fun bool_eq16 ((x us_t3)
  (y us_t3)) Bool (bool_eq15 (elts3 x) (to_rep1 (first7 (rt3 x)))
...
((unconstrained_array_3__ref
 (mk_unconstrained_array_3__ref (unconstrained_array_3__content us_t3)))))
(define-fun unconstrained_array_3__ref___projection ((a unconstrained_array_3__ref)) us_t3 
...
(define-fun bool_eq17 ((a map3) (a__first Int) (a__last Int) (a__first_2 Int)
  ...
  (b__last_4 Int)) Bool (ite (and
                             ...
                             (temp___idx_139 Int) (temp___idx_140 Int)
                             (temp___idx_141 Int))
                             (=>
                             (and
                             (and
                             ...
                             (and (<= a__first_2 temp___idx_139)
                             (<= temp___idx_139 a__last_2)))
                             (and (<= a__first_3 temp___idx_140)
                             (<= temp___idx_140 a__last_3)))
                             (and (<= a__first_4 temp___idx_141)
                             (<= temp___idx_141 a__last_4)))
                             (= (to_rep2
                                (get2 a temp___idx_138 temp___idx_139
                                temp___idx_140 temp___idx_141)) (to_rep2
                                                                (get2 b
                                                                (+ (- b__first a__first) temp___idx_138)
                                                                (+ (- b__first_2 a__first_2) temp___idx_139)
                                                                (+ (- b__first_3 a__first_3) temp___idx_140)
                                                                (+ (- b__first_4 a__first_4) temp___idx_141)))))))
                        true false))
...
;; bool_eq_rev
  ...
  (=>
  (= (bool_eq17 b b__first b__last b__first_2 b__last_2 b__first_3 b__last_3
  ...
  (= (- a__last_4 a__first_4) (- b__last_4 b__first_4)))
  (< b__last_4 b__first_4)))
  (forall ((temp___idx_138 Int) (temp___idx_139 Int) (temp___idx_140 Int)
  (temp___idx_141 Int))
  (=>
  (and
  (and
  (and (and (<= a__first temp___idx_138) (<= temp___idx_138 a__last))
  (and (<= a__first_2 temp___idx_139) (<= temp___idx_139 a__last_2)))
  (and (<= a__first_3 temp___idx_140) (<= temp___idx_140 a__last_3)))
  (and (<= a__first_4 temp___idx_141) (<= temp___idx_141 a__last_4)))
  (= (to_rep2
     (get2 a temp___idx_138 temp___idx_139 temp___idx_140 temp___idx_141)) 
  (to_rep2
  (get2 b (+ (- b__first a__first) temp___idx_138)
  (+ (- b__first_2 a__first_2) temp___idx_139)
  (+ (- b__first_3 a__first_3) temp___idx_140)
  (+ (- b__first_4 a__first_4) temp___idx_141)))))))))))

(declare-fun dummy18 () map3)
...
(declare-fun user_eq17 (map3 map3) Bool)
...
(declare-datatypes ()
((us_t4 (mk___t4 (elts4 map3)(rt4 t7)(rt_22 t8)(rt_31 t9)(rt_4 t10)))))
(define-fun to_array4 ((a us_t4)) map3 (elts4 a))

(define-fun of_array4 ((a map3) (f Int) (l Int) (f2 Int) (l2 Int) (f3 Int)
  (l3 Int) (f4 Int)
  (l4 Int)) us_t4 (mk___t4 a (mk7 f l) (mk8 f2 l2) (mk9 f3 l3) (mk10 f4 l4)))
...
(define-fun bool_eq18 ((x us_t4)
  (y us_t4)) Bool (bool_eq17 (elts4 x) (to_rep1 (first11 (rt4 x)))
...
((unconstrained_array_4__ref
 (mk_unconstrained_array_4__ref (unconstrained_array_4__content us_t4)))))
(define-fun unconstrained_array_4__ref___projection ((a unconstrained_array_4__ref)) us_t4 
...
(define-fun in_range7 ((rec__size_attr__r1__a1 Bool)
  (a us_rep)) Bool (= rec__size_attr__r1__a1 (rec__size_attr__r1__a
                                             (us_split_discrs1 a))))
...
(declare-fun size_attr__r1__a__first__bit2 () Int)

(declare-fun size_attr__r1__a__last__bit2 () Int)

(declare-fun size_attr__r1__a__position2 () Int)
...
(declare-fun size_attr__r1__x__first__bit2 () Int)

(declare-fun size_attr__r1__x__last__bit2 () Int)

(declare-fun size_attr__r1__x__position2 () Int)
...
(define-fun dynamic_invariant3 ((temp___expr_315 us_rep)
  (temp___is_init_312 Bool) (temp___skip_constant_313 Bool)
  (temp___do_toplevel_314 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_313 true))
                                      (in_range7 (of_int 0) temp___expr_315))
                                      (= (attr__constrained temp___expr_315) true)))

(define-fun default_initial_assumption4 ((temp___expr_317 us_rep)
  (temp___skip_top_level_318 Bool)) Bool (and
                                         (= (attr__constrained
                                            temp___expr_317) true)
                                         (= (rec__size_attr__r1__a
                                            (us_split_discrs1
                                            temp___expr_317)) (of_int 0))))

(declare-fun v1__split_discrs () us_split_discrs)

(declare-fun v1__attr__constrained () Bool)

(declare-fun attr__ATTRIBUTE_ADDRESS5 () Int)

(declare-fun v2__attr__constrained () Bool)

(declare-fun attr__ATTRIBUTE_ADDRESS6 () Int)

(declare-fun v3__split_discrs () us_split_discrs)

(declare-fun v3__attr__constrained () Bool)

(declare-fun attr__ATTRIBUTE_ADDRESS7 () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS8 () Int)

(declare-fun v5__attr__tag () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS9 () Int)

(declare-fun v6__attr__tag () Int)
...
(declare-fun user_eq19 (t6b t6b) Bool)

(declare-fun dummy21 () t6b)
...
(define-fun in_range9 ((x Int)) Bool (and (<= 1 x) (<= x 5)))
...
(declare-fun user_eq20 (tTuaSP1 tTuaSP1) Bool)

(declare-fun dummy22 () tTuaSP1)
...
(declare-fun dummy23 () (Array Int natural))
...
;; object__component__size_axiom
  (assert
  (forall ((a (Array Int natural))) (<= 0 (object__component__size9 a))))
...
(declare-fun user_eq22 (t8b t8b) Bool)

(declare-fun dummy24 () t8b)
...
(declare-fun user_eq23 (t10b t10b) Bool)

(declare-fun dummy25 () t10b)
...
(declare-fun user_eq24 (t12b t12b) Bool)

(declare-fun dummy26 () t12b)
...
(declare-fun user_eq25 (t14b t14b) Bool)

(declare-fun dummy27 () t14b)
...
(declare-fun user_eq26 (tTua2SP1 tTua2SP1) Bool)

(declare-fun dummy28 () tTua2SP1)

(declare-datatypes ()
((tTua2SP1__ref (mk_tTua2SP1__ref (tTua2SP1__content tTua2SP1)))))
(define-fun tTua2SP1__ref___projection ((a tTua2SP1__ref)) tTua2SP1 (tTua2SP1__content
                                                                    a))

(declare-sort tTua2SP2 0)

(define-fun in_range15 ((x Int)) Bool (and (<= 1 x) (<= x 5)))
...
(declare-fun user_eq27 (tTua2SP2 tTua2SP2) Bool)

(declare-fun dummy29 () tTua2SP2)

(declare-datatypes ()
((tTua2SP2__ref (mk_tTua2SP2__ref (tTua2SP2__content tTua2SP2)))))
(define-fun tTua2SP2__ref___projection ((a tTua2SP2__ref)) tTua2SP2 (tTua2SP2__content
                                                                    a))

(declare-fun dummy30 () map1)
...
(declare-fun user_eq28 (map1 map1) Bool)

(declare-sort t16b 0)

(define-fun in_range16 ((x Int)) Bool (and (<= 1 x) (<= x 5)))
...
(declare-fun user_eq29 (t16b t16b) Bool)

(declare-fun dummy31 () t16b)
...
(declare-fun user_eq30 (t17b t17b) Bool)

(declare-fun dummy32 () t17b)
...
(declare-fun user_eq31 (tTua3SP1 tTua3SP1) Bool)

(declare-fun dummy33 () tTua3SP1)

(declare-datatypes ()
((tTua3SP1__ref (mk_tTua3SP1__ref (tTua3SP1__content tTua3SP1)))))
(define-fun tTua3SP1__ref___projection ((a tTua3SP1__ref)) tTua3SP1 (tTua3SP1__content
                                                                    a))

(declare-sort tTua3SP2 0)
...
(declare-fun user_eq32 (tTua3SP2 tTua3SP2) Bool)

(declare-fun dummy34 () tTua3SP2)

(declare-datatypes ()
((tTua3SP2__ref (mk_tTua3SP2__ref (tTua3SP2__content tTua3SP2)))))
(define-fun tTua3SP2__ref___projection ((a tTua3SP2__ref)) tTua3SP2 (tTua3SP2__content
                                                                    a))

(declare-sort tTua3SP3 0)
...
(declare-fun user_eq33 (tTua3SP3 tTua3SP3) Bool)

(declare-fun dummy35 () tTua3SP3)

(declare-datatypes ()
((tTua3SP3__ref (mk_tTua3SP3__ref (tTua3SP3__content tTua3SP3)))))
(define-fun tTua3SP3__ref___projection ((a tTua3SP3__ref)) tTua3SP3 (tTua3SP3__content
                                                                    a))

(declare-fun dummy36 () map2)
...
(declare-fun user_eq34 (map2 map2) Bool)

(declare-sort t19b 0)

(define-fun in_range21 ((x Int)) Bool (and (<= 1 x) (<= x 5)))
...
(declare-fun user_eq35 (t19b t19b) Bool)

(declare-fun dummy37 () t19b)
...
(define-fun in_range22 ((x Int)) Bool (and (<= 1 x) (<= x 5)))
...
(declare-fun user_eq36 (t20b t20b) Bool)

(declare-fun dummy38 () t20b)
...
(define-fun in_range23 ((x Int)) Bool (and (<= 1 x) (<= x 5)))
...
(declare-fun user_eq37 (t21b t21b) Bool)

(declare-fun dummy39 () t21b)
...
(declare-sort tTua4SP1 0)

(define-fun in_range24 ((x Int)) Bool (and (<= 1 x) (<= x 5)))
...
(declare-fun user_eq38 (tTua4SP1 tTua4SP1) Bool)

(declare-fun dummy40 () tTua4SP1)

(declare-datatypes ()
((tTua4SP1__ref (mk_tTua4SP1__ref (tTua4SP1__content tTua4SP1)))))
(define-fun tTua4SP1__ref___projection ((a tTua4SP1__ref)) tTua4SP1 (tTua4SP1__content
                                                                    a))

(declare-sort tTua4SP2 0)
...
(declare-fun user_eq39 (tTua4SP2 tTua4SP2) Bool)

(declare-fun dummy41 () tTua4SP2)

(declare-datatypes ()
((tTua4SP2__ref (mk_tTua4SP2__ref (tTua4SP2__content tTua4SP2)))))
(define-fun tTua4SP2__ref___projection ((a tTua4SP2__ref)) tTua4SP2 (tTua4SP2__content
                                                                    a))

(declare-sort tTua4SP3 0)

(define-fun in_range26 ((x Int)) Bool (and (<= 1 x) (<= x 5)))
...
(declare-fun user_eq40 (tTua4SP3 tTua4SP3) Bool)

(declare-fun dummy42 () tTua4SP3)

(declare-datatypes ()
((tTua4SP3__ref (mk_tTua4SP3__ref (tTua4SP3__content tTua4SP3)))))
(define-fun tTua4SP3__ref___projection ((a tTua4SP3__ref)) tTua4SP3 (tTua4SP3__content
                                                                    a))

(declare-sort tTua4SP4 0)

(define-fun in_range27 ((x Int)) Bool (and (<= 1 x) (<= x 5)))
...
(declare-fun user_eq41 (tTua4SP4 tTua4SP4) Bool)

(declare-fun dummy43 () tTua4SP4)

(declare-datatypes ()
((tTua4SP4__ref (mk_tTua4SP4__ref (tTua4SP4__content tTua4SP4)))))
(define-fun tTua4SP4__ref___projection ((a tTua4SP4__ref)) tTua4SP4 (tTua4SP4__content
                                                                    a))

(declare-fun dummy44 () map3)
...
(declare-fun user_eq42 (map3 map3) Bool)

(declare-sort t23b 0)

(define-fun in_range28 ((x Int)) Bool (and (<= 1 x) (<= x 5)))
...
(declare-fun user_eq43 (t23b t23b) Bool)

(declare-fun dummy45 () t23b)
...
(define-fun in_range29 ((x Int)) Bool (and (<= 1 x) (<= x 5)))
...
(declare-fun user_eq44 (t24b t24b) Bool)

(declare-fun dummy46 () t24b)
...
(define-fun in_range30 ((x Int)) Bool (and (<= 1 x) (<= x 5)))
...
(declare-fun user_eq45 (t25b t25b) Bool)

(declare-fun dummy47 () t25b)
...
(define-fun in_range31 ((x Int)) Bool (and (<= 1 x) (<= x 5)))
...
(declare-fun user_eq46 (t26b t26b) Bool)

(declare-fun dummy48 () t26b)
...
(declare-fun temp___String_Literal_370 (tuple0) (Array Int character))

;; temp___String_Literal_370__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (and
     (and
     (= (to_rep (select (temp___String_Literal_370 us_void_param) 1)) 97)
     (= (to_rep (select (temp___String_Literal_370 us_void_param) 2)) 98))
     (= (to_rep (select (temp___String_Literal_370 us_void_param) 3)) 99)) :pattern (
  (temp___String_Literal_370 us_void_param)) )))
...
;; def_axiom
  ...
  (= (select (size_attr__ca__aggregate_def temp___387) temp___388) (of_rep2
                                                                   temp___387)))))
...
;; def_axiom
  ...
  (= (select (size_attr__ua__aggregate_def temp___390) temp___391) (of_rep2
                                                                   temp___390)))))
...
;; def_axiom
  ...
  (= (select (size_attr__ca2__aggregate_def temp___393) temp___394) (of_rep2
                                                                    temp___393)))))
...
;; def_axiom
  ...
  (= (select (size_attr__ca3__aggregate_def temp___396) temp___397) (of_rep2
                                                                    temp___396)))))
...
;; def_axiom
  ...
  (= (select (size_attr__ca4__aggregate_def temp___399) temp___400) (of_rep2
                                                                    temp___399)))))
...
;; def_axiom
  ...
  (= (get (size_attr__ua2__aggregate_def temp___402) temp___403 temp___404) 
  (of_rep2 temp___402)))))
...
;; def_axiom
  ...
  (= (get1 (size_attr__ua3__aggregate_def temp___406) temp___407 temp___408
     temp___409) (of_rep2 temp___406)))))
...
;; def_axiom
  ...
  (temp___415 Int))
  (= (get2 (size_attr__ua4__aggregate_def temp___411) temp___412 temp___413
     temp___414 temp___415) (of_rep2 temp___411)))))
...
(define-fun dynamic_invariant8 ((temp___expr_250 us_t1)
...
(define-fun dynamic_invariant9 ((temp___expr_266 us_t2)
  (temp___is_init_263 Bool) (temp___skip_constant_264 Bool)
  (temp___do_toplevel_265 Bool)) Bool (=>
                                      (not (= temp___skip_constant_264 true))
                                      (dynamic_property4 1 2147483647
                                      (first6 temp___expr_266)
                                      (last6 temp___expr_266) 1 2147483647
                                      (first_2 temp___expr_266)
                                      (last_2 temp___expr_266))))

(define-fun dynamic_invariant10 ((temp___expr_285 us_t3)
  ...
  (temp___do_toplevel_284 Bool)) Bool (=>
                                      ...
                                      (first10 temp___expr_285)
                                      (last10 temp___expr_285) 1 2147483647
                                      (first_21 temp___expr_285)
                                      (last_21 temp___expr_285) 1 2147483647
                                      (first_3 temp___expr_285)
                                      (last_3 temp___expr_285))))

(define-fun dynamic_invariant11 ((temp___expr_307 us_t4)
  ...
  (temp___do_toplevel_306 Bool)) Bool (=>
                                      ...
                                      (first15 temp___expr_307)
                                      (last15 temp___expr_307) 1 2147483647
                                      (first_22 temp___expr_307)
                                      (last_22 temp___expr_307) 1 2147483647
                                      (first_31 temp___expr_307)
                                      (last_31 temp___expr_307) 1 2147483647
                                      (first_4 temp___expr_307)
                                      (last_4 temp___expr_307))))
...
(declare-fun v2__split_discrs () Bool)

(declare-fun v4__split_fields () integer)

(declare-fun ca () (Array Int natural))

(declare-fun ua () (Array Int natural))

(declare-fun ca2 () map__ref1)

(declare-fun ca3 () map__ref1)

(declare-fun ca4 () map__ref1)

(declare-fun ua2 () map__ref2)

(declare-fun ua3 () map__ref3)

(declare-fun ua4 () map__ref4)

(declare-fun o () integer)

(declare-fun o1 () us_split_fields2)

(declare-fun size_attr__v4__assume () us_rep1)
...
(declare-fun v4__split_fields1 () us_split_fields2)

(declare-fun result5 () map__ref1)

(declare-fun ca1 () (Array Int natural))

(declare-fun result6 () map__ref1)

(declare-fun ua1 () (Array Int natural))

(declare-fun result7 () map__ref1)

(declare-fun ca21 () (Array Int natural))

(declare-fun result8 () map__ref1)

(declare-fun ca31 () (Array Int natural))

(declare-fun result9 () map__ref1)

(declare-fun ca41 () (Array Int natural))

(declare-fun result10 () map__ref2)

(declare-fun ua21 () map1)

(declare-fun result11 () map__ref3)

(declare-fun ua31 () map2)

(declare-fun result12 () map__ref4)

(declare-fun ua41 () map3)
...
;; H
  (assert (= s1 (temp___String_Literal_370 Tuple0)))
...
;; H
  (assert
  (and (= v1__attr__constrained true)
  (= (rec__size_attr__r1__a v1__split_discrs) (of_int 0))))

;; H
  (assert
  (and (= (of_int 0) (rec__size_attr__r1__a v1__split_discrs))
  (= v1__attr__constrained true)))

;; H
  (assert
  (and (= v2__attr__constrained false) (= v2__split_discrs (of_int 0))))

;; H
  (assert
  (and (= v3__attr__constrained true)
  (= (rec__size_attr__r1__a v3__split_discrs) (of_int 0))))

;; H
  (assert
  (and (= (of_int 0) (rec__size_attr__r1__a v3__split_discrs))
  (= v3__attr__constrained true)))
...
;; H
  (assert
  (= result4 (mk___split_fields__ref1 (mk___split_fields1 v4__split_fields))))
...
;; H
  (assert (= o2 (size_attr__ca__aggregate_def 1)))
...
;; H
  (assert (= o3 (size_attr__ua__aggregate_def 1)))
...
;; H
  (assert (= o4 (size_attr__ca2__aggregate_def 1)))

;; H
  (assert (= result7 ca2))

;; H
  (assert (= (let ((subject ca2)) ca21) o4))

;; H
  (assert (= o5 (size_attr__ca3__aggregate_def 1)))

;; H
  (assert (= result8 ca3))

;; H
  (assert (= (let ((subject ca3)) ca31) o5))

;; H
  (assert (= o6 (size_attr__ca4__aggregate_def 1)))

;; H
  (assert (= result9 ca4))

;; H
  (assert (= (let ((subject ca4)) ca41) o6))

;; H
  (assert (= o7 (size_attr__ua2__aggregate_def 1)))

;; H
  (assert (= result10 ua2))

;; H
  (assert (= (let ((subject ua2)) ua21) o7))

;; H
  (assert (= o8 (size_attr__ua3__aggregate_def 1)))

;; H
  (assert (= result11 ua3))

;; H
  (assert (= (let ((subject ua3)) ua31) o8))

;; H
  (assert (= o9 (size_attr__ua4__aggregate_def 1)))

;; H
  (assert (= result12 ua4))

;; H
  (assert (= (let ((subject ua4)) ua41) o9))
...
;; H
  (assert (<= 0 (object__size16 ua1)))

;; H
  (assert (<= 0 (object__size7 (let ((subject ca2)) ca21))))

;; H
  (assert (<= 0 (object__size17 (let ((subject ua2)) ua21))))

;; H
  (assert (<= 0 (object__size7 (let ((subject ca3)) ca31))))

;; H
  (assert (<= 0 (object__size18 (let ((subject ua3)) ua31))))

;; H
  (assert (<= 0 (object__size7 (let ((subject ca4)) ca41))))

(assert
;; WP_parameter_def
 ;; File "size_attr.adb", line 3, characters 0-0
  (not (<= 0 (object__size19 (let ((subject ua4)) ua41)))))
(check-sat)
