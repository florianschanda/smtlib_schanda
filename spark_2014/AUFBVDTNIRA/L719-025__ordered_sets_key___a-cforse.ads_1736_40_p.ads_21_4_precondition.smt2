...
(define-fun dynamic_invariant3 ((temp___expr_547 Int)
...
(define-fun dynamic_invariant4 ((temp___expr_553 Int)
...
;; temp___result_136_def
  (assert
  (forall ((container1 us_rep1) (item Int) (i Int)) (my_inf__function_guard
  (my_inf item (get container1 i)) item (get container1 i))))

(define-fun e_smaller_than_range ((container1 us_rep1) (fst Int) (lst Int)
  (item Int)) Bool (ite (forall ((i Int))
                        (=> (and (<= fst i) (<= i lst))
                        (= (my_inf item (get container1 i)) true)))
                   true false))
...
(define-fun dynamic_invariant6 ((temp___expr_367 Int)
...
(define-fun dynamic_invariant7 ((temp___expr_361 Int)
