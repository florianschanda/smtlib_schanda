...
;; H
  (assert (ispresent__function_guard1 (ispresent1 state1) state1))
...
;; H
  (assert (rolepresent__function_guard
  (rolepresent (mk___rep theadmin__split_fields10))
  (mk___rep theadmin__split_fields10)))
...
;; H
  (assert (isdoingop__function_guard
  (isdoingop (mk___rep theadmin__split_fields10))
  (mk___rep theadmin__split_fields10)))

;; H
  (assert (thecurrentop__function_guard
  (thecurrentop (mk___rep theadmin__split_fields10))
  (mk___rep theadmin__split_fields10)))
...
;; H
  (assert (ispresent__function_guard
  (ispresent (mk___rep theadmin__split_fields10))
  (mk___rep theadmin__split_fields10)))
...
;; H
  ...
  (adminlogoncanstart__function_guard result state1
  (mk___split_fields theadmin__split_fields theadmin__split_fields1) 
  status))
  (= (= result true)
  (and
...
;; H
  ...
  (= result2 (adminopcanstart state1
             (mk___split_fields theadmin__split_fields
             theadmin__split_fields1) status))
  (adminopcanstart__function_guard result2 state1
  (mk___split_fields theadmin__split_fields theadmin__split_fields1) 
  status))
  (= (= result2 true)
  (and
