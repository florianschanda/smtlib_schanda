...
(declare-fun temp___3058 () (Array Int us_rep1))

(declare-fun o () us_rep1)

(declare-fun o1 () us_split_fields)

(declare-fun temp___3059 () (Array Int us_rep1))
...
(declare-fun temp___3060 () (Array Int us_rep1))
...
(declare-fun temp___3057 () (Array Int us_rep1))
...
(declare-fun temp___3075 () (Array Int us_rep1))
...
;; H
  (assert (size__function_guard (size f_old) f_old))

;; H
  (assert
  (and
  (and (= result (valid_root f_old root)) (valid_root__function_guard 
  result f_old root)) (=> (< (size f_old) root) (not (= result true)))))
...
;; H
  (assert
  (and
  (and (= result1 (valid_root f root)) (valid_root__function_guard result1 
  f root)) (=> (< (size f) root) (not (= result1 true)))))
...
;; H
  (assert
  (and
  (and (= result2 (valid_root f_old v)) (valid_root__function_guard result2
  f_old v)) (=> (< (size f_old) v) (not (= result2 true)))))
...
;; H
  (assert
  (and (and (= o17 (valid_root f v)) (valid_root__function_guard o17 f v))
  (=> (< (size f) v) (not (= o17 true)))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3075 (parent f i1)))) (position f i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3075 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3075 (parent f i1)))) (position f i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3075 i1))))))
...
;; H
  (assert
  (and
  (and (= temp___3075 (model__ f root)) (model____function_guard temp___3075
  f root))
  (and (dynamic_invariant5 temp___3075 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3075 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3075 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___3075 (parent f i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3075 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3075 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3075 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3075 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3075 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3075 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o15 (select temp___3075 v)))
...
;; H
  ...
  (ordered_leafs__function_guard result5 f_old root values))
  (= (= result5 true)
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (forall ((j Int))
...
;; H
  ...
  (ordered_leafs__function_guard result6 f_old v values))
  (= (= result6 true)
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (forall ((j Int))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3060 (parent f i1)))) (position f i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3060 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3060 (parent f i1)))) (position f i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3060 i1))))))
...
;; H
  (assert
  (forall ((i1 Int)) (parent__function_guard (parent f_old i1) f_old i1)))
...
;; H
  (assert
  (forall ((i1 Int)) (position__function_guard (position f_old i1) f_old i1)))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3059 (parent f_old i1))))
  (position f_old i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3059 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3059 (parent f_old i1))))
  (position f_old i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3059 i1))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3058 (parent f_old i1))))
  (position f_old i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3058 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3058 (parent f_old i1))))
  (position f_old i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3058 i1))))))
...
;; H
  (assert
  (and
  (and (= temp___3060 (model__ f root)) (model____function_guard temp___3060
  f root))
  (and (dynamic_invariant5 temp___3060 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3060 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3060 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___3060 (parent f i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3060 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3060 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3060 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3060 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3060 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3060 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o5 (select temp___3060 v)))
...
;; H
  (assert
  (and
  (and (= temp___3059 (model__ f_old root)) (model____function_guard
  temp___3059 f_old root))
  (and (dynamic_invariant5 temp___3059 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3059 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3059 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f_old i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___3059 (parent f_old i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3059 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3059 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3059 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3059 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3059 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3059 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o2 (select temp___3059 i)))
...
;; H
  (assert
  (and
  (and (= temp___3058 (model__ f_old root)) (model____function_guard
  temp___3058 f_old root))
  (and (dynamic_invariant5 temp___3058 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3058 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3058 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f_old i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___3058 (parent f_old i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3058 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3058 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3058 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3058 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3058 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3058 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o (select temp___3058 i)))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3057 (parent f_old i1))))
  (position f_old i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3057 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___3057 (parent f_old i1))))
  (position f_old i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___3057 i1))))))
...
;; H
  (assert
  (and
  (and (= temp___3057 (model__ f_old root)) (model____function_guard
  temp___3057 f_old root))
  (and (dynamic_invariant5 temp___3057 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3057 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3057 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f_old i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___3057 (parent f_old i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3057 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3057 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3057 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___3057 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3057 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___3057 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o10 (select temp___3057 i)))
