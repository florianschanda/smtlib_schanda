...
;; func_head__def_axiom
  ...
  (forall ((m us_t))
  (! (=>
     (and (dynamic_invariant m true true true) (func_head__function_guard
     (func_head m) m))
...
;; H
  (assert (is_empty__function_guard (is_empty r) r))
...
;; H
  (assert (to_model__function_guard (to_model r) r))

;; H
  (assert (to_model__function_guard (to_model r) r))

;; H
  (assert (func_head__function_guard (func_head (to_model r)) (to_model r)))
