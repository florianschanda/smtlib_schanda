...
(define-fun us_split_fields_Year2__projection ((a us_split_fields4)) yearst 
  (rec__clock__timet__year a))

(define-fun us_split_fields_Month2__projection ((a us_split_fields4)) monthst 
  (rec__clock__timet__month a))

(define-fun us_split_fields_Day2__projection ((a us_split_fields4)) dayst 
...
(define-fun us_split_fields__ref_16__projection ((a us_split_fields__ref2)) us_split_fields4 
  (us_split_fields__content2 a))

(declare-datatypes ()
((us_rep2 (mk___rep2 (us_split_fields5 us_split_fields4)))))
(define-fun us_rep_16__projection ((a us_rep2)) us_split_fields4 (us_split_fields5
                                                                 a))
...
(define-fun timet__ref_2__projection ((a timet__ref)) us_rep2 (timet__content
                                                              a))
...
(define-fun us_split_fields__ref_18__projection ((a us_split_fields__ref3)) us_split_fields6 
  (us_split_fields__content3 a))

(declare-datatypes ()
((us_rep3 (mk___rep3 (us_split_fields7 us_split_fields6)))))
(define-fun us_rep_19__projection ((a us_rep3)) us_split_fields6 (us_split_fields7
                                                                 a))
...
(declare-fun temp___1224 () (Array Int character))

(declare-fun temp___12241 () t)
...
(declare-fun temp___1226 () (Array Int character))

(declare-fun temp___12261 () t)
...
(declare-fun cert__extractuser__fullstring__assume () (Array Int character))

(declare-fun cert__extractuser__fullstring__assume1 () t)
...
;; H
  (assert
  (=> (= (length (mk___t temp___1224 temp___12241)) 0)
  (= (temp___String_Literal_1223 Tuple0) temp___1226)))

;; H
  (assert
  (=> (= (length (mk___t temp___1224 temp___12241)) 0)
  (= (mk 1 12) temp___12261)))

;; H
  (assert
  (=> (not (= (length (mk___t temp___1224 temp___12241)) 0))
  (=> (<= 1 12) (= o6 (+ (- 12 1) 1)))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1224 temp___12241)) 0))
  (= o9 (+ (to_rep1 (first temp___12241)) o8))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1224 temp___12241)) 0))
  (= (concat1 temp___1224 (to_rep1 (first temp___12241))
     (to_rep1 (last temp___12241)) (temp___String_Literal_1223 Tuple0) 1 12) 
  temp___1226)))

;; H
  (assert
  (=> (not (= (length (mk___t temp___1224 temp___12241)) 0))
  (= (mk (to_rep1 (first temp___12241)) o11) temp___12261)))

;; H
  (assert
  (=> (= (length (mk___t temp___1226 temp___12261)) 0)
  (= (elts
     (to_string
     ...
     (rec__certtypes__idt__serialnumber
     (us_split_fields3
     (rec__cert__contentst__id (us_split_fields7 contents)))))))) cert__extractuser__fullstring__assume)))
...
;; H
  ...
  (= (mk
     ...
     (us_split_fields3
     (rec__cert__contentst__id (us_split_fields7 contents))))))))))) 
  cert__extractuser__fullstring__assume1)))

;; H
  (assert
  (=> (not (= (length (mk___t temp___1226 temp___12261)) 0))
  (=>
  (<= (to_rep1
      (first
      (rt
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1226 temp___12261)) 0))
  (=> (<= (to_rep1 (first temp___12261)) (to_rep1 (last temp___12261)))
  (= o13 (+ (- (to_rep1 (last temp___12261)) (to_rep1 (first temp___12261))) 1)))))

;; H
  (assert
  (=> (not (= (length (mk___t temp___1226 temp___12261)) 0))
  (=> (not (<= (to_rep1 (first temp___12261)) (to_rep1 (last temp___12261))))
  (= o13 0))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1226 temp___12261)) 0))
  (= o15 (+ (to_rep1 (first temp___12261)) o14))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1226 temp___12261)) 0))
  (= (concat1 temp___1226 (to_rep1 (first temp___12261))
     (to_rep1 (last temp___12261))
     (elts
     (to_string
     (attr__ATTRIBUTE_IMAGE5
     (to_rep4
     ...
     (us_split_fields3
     (rec__cert__contentst__id (us_split_fields7 contents))))))))))) 
  cert__extractuser__fullstring__assume)))

;; H
  (assert
  (=> (not (= (length (mk___t temp___1226 temp___12261)) 0))
  (= (mk (to_rep1 (first temp___12261)) o17) cert__extractuser__fullstring__assume1)))
...
;; H
  ...
  (= (to_rep1 fullstring__last) (to_rep1
                                (last cert__extractuser__fullstring__assume1))))
