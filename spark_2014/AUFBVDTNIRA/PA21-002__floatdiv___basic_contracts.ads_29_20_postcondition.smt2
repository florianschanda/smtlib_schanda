...
(declare-fun numerator () t)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun denominator () t)
...
(declare-fun basic_contracts__average_float__result () t)
...
(declare-fun basic_contracts__average_float__result1 () t)

(declare-fun basic_contracts__average_float__result2 () t)

(declare-fun basic_contracts__average_float__result3 () t)

(declare-fun res2 () t)

(declare-fun basic_contracts__average_float__result4 () t)

(declare-fun res3 () t)

(declare-fun basic_contracts__average_float__result5 () t)

(declare-fun result2 () t)

;; H
  (assert (tqtisFinite numerator))

;; H
  (assert (tqtisFinite denominator))

;; H
  (assert (and (le fliteral2 numerator) (le fliteral denominator)))
...
;; H
  (assert
  (and (= o (div1 RNE1 numerator denominator)) (tqtisFinite
  (div1 RNE1 numerator denominator))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (le fliteral2 basic_contracts__average_float__result4)))
(check-sat)
