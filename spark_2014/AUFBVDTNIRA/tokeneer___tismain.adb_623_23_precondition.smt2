...
;; H
  (assert
  (and (= o14 (statusiswaitingfinishadminop (us_private__content state68)))
  (statusiswaitingfinishadminop__function_guard o14
  (us_private__content state68))))

;; H
  (assert
  (and (= o15 (statusiswaitingstartadminop (us_private__content state68)))
...
;; H
  (assert
  (and (= o11 (statusisgotadmintoken (us_private__content state68)))
  (statusisgotadmintoken__function_guard o11 (us_private__content state68))))
...
;; H
  (assert
  (=> (= result10 true)
  (and (= o9 (statusiswaitingstartadminop (us_private__content state68)))
