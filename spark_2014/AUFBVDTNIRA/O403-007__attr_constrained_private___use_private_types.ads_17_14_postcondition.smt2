...
(declare-fun private_types__private_reinit__s__discrs () natural)

(declare-fun private_types__private_reinit__s__fields () us_main_type)
...
(declare-fun s__split_discrs1 () natural)

(declare-fun s__split_fields2 () us_main_type)

(declare-fun s__split_discrs2 () natural)

(declare-fun s__split_fields3 () us_main_type)

(declare-fun s__split_discrs3 () natural)
...
;; H
  (assert
  (= (mk___split_fields s__split_fields1) (mk___split_fields
...
;; H
  (assert
  (= (mk___split_discrs s__split_discrs1) (mk___split_discrs
                                          private_types__private_reinit__s__discrs)))

;; H
  (assert
  (=> (= s__attr__constrained true)
  (= s__split_discrs private_types__private_reinit__s__discrs)))
...
;; WP_parameter_def
 ;; File "use_private_types.ads", line 36, characters 0-0
  ...
  (= (d_zero
     (mk___rep (mk___split_discrs s__split_discrs2)
     (mk___split_fields s__split_fields2) s__attr__constrained)) true)))
(check-sat)
