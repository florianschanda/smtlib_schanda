...
(declare-datatypes () ((t30b__ref (mk_t30b__ref (t30b__content us_t1)))))
(define-fun t30b__ref___projection ((a t30b__ref)) us_t1 (t30b__content a))

(declare-fun temp___265 (Int Int Int) us_t1)

;; def_axiom
  (assert
  (forall ((temp___267 Int) (temp___268 Int) (temp___269 Int))
  (let ((temp___266 (temp___265 temp___267 temp___268 temp___269)))
  (and
  (=> (dynamic_property 1 2147483647 temp___268 temp___269)
  (and (= (first4 temp___266) temp___268) (= (last4 temp___266) temp___269)))
  (forall ((temp___270 Int))
  (= (select (to_array1 temp___266) temp___270) (of_rep temp___267)))))))
...
(declare-fun temp___272 () (Array Int character))

(declare-fun temp___2721 () t1)

(declare-fun temp___273 () (Array Int character))

(declare-fun temp___2731 () t)
...
;; H
  (assert (= b1 (to_rep1 a__last)))

;; H
  (assert
  (= (to_rep1
     (first3 (rt1 (temp___265 32 (to_rep1 a__first) (to_rep1 a__last))))) 
  (to_rep1 a__first)))

;; H
  (assert
  (= (to_rep1
     (last3 (rt1 (temp___265 32 (to_rep1 a__first) (to_rep1 a__last))))) 
  (to_rep1 a__last)))

;; H
  (assert
  (= (mk___t1 temp___272 temp___2721) (temp___265 32 (to_rep1 a__first)
                                      (to_rep1 a__last))))
...
;; H
  (assert
  (= (mk (to_rep1 (first3 temp___2721)) (to_rep1 (last3 temp___2721))) 
  temp___2731))
...
;; WP_parameter_def
 ;; File "test.adb", line 96, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first temp___2731)) (to_rep1 (last temp___2731)))
     (+ (- (to_rep1 (last temp___2731)) (to_rep1 (first temp___2731))) 1) 0) 
