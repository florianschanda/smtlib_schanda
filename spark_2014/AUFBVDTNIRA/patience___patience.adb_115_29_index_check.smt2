...
(declare-fun temp___719 () (Array Int cardindex))

(declare-fun o118 () Int)

(declare-fun o119 () cardindex)

(declare-fun temp___720 () Int)

(declare-fun o120 () Int)

(declare-fun temp___723 () (Array Int cardindex))

(declare-fun o121 () Int)

(declare-fun o122 () cardindex)

(declare-fun temp___724 () Int)

(declare-fun o123 () Int)

(declare-fun o124 () card)
...
;; H
  (assert
  (= temp___723 (select (rec__patience__state__stacks
                        (us_split_fields__content s__split_fields20)) 
  o120)))
...
;; H
  (assert (= o122 (select temp___723 o121)))

;; H
  (assert (= temp___724 (to_rep1 o122)))

;; H
  (assert (and (<= 0 temp___724) (<= temp___724 99)))

;; H
  (assert (= o123 temp___724))

;; H
  (assert
  (= o124 (select (rec__patience__state__values
                  (us_split_fields__content s__split_fields20)) o123)))
...
;; H
  (assert
  (= temp___719 (select (rec__patience__state__stacks
                        (us_split_fields__content s__split_fields20)) 
  o117)))
...
;; H
  (assert (= o119 (select temp___719 o118)))

;; H
  (assert (= temp___720 (to_rep1 o119)))
