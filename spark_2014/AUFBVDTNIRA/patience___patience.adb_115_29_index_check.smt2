...
(declare-fun temp___716 () (Array Int cardindex))
...
(declare-fun temp___720 () (Array Int cardindex))

(declare-fun o121 () Int)

(declare-fun o122 () cardindex)

(declare-fun temp___721 () Int)
...
;; H
  (assert
  (= temp___720 (select (rec__patience__state__stacks
                        (us_split_fields__content s__split_fields20)) 
  o120)))
...
;; H
  (assert (= o122 (select temp___720 o121)))

;; H
  (assert (= temp___721 (to_rep1 o122)))

;; H
  (assert (and (<= 0 temp___721) (<= temp___721 99)))

;; H
  (assert (= o123 temp___721))
...
;; H
  (assert
  (= temp___716 (select (rec__patience__state__stacks
                        (us_split_fields__content s__split_fields20)) 
  o117)))
...
;; H
  (assert (= o119 (select temp___716 o118)))

;; H
  (assert (= temp___717 (to_rep1 o119)))
