...
;; H
  (assert (= o53 (temp___1075 32)))

;; H
  (assert (= o54 (mk___split_fields2 o53 o52)))

;; H
  (assert (= display__updatedevice__B38b__result__assume (mk___rep2 o54)))
...
;; H
  ...
  (= temp___1040 (mk___rep2 result____split_fields2))))
...
;; H
  ...
  (=> (<= i3 temp___1041)
  (= (select (rec__display__scrollstrt__text result____split_fields3) temp___1041) (select 
...
;; H
  ...
  (<= i2 (to_rep3
         ...
         (us_split_fields1
         (rec__display__msgstrt__top (us_split_fields3 c35b)))))))
  (= o56 (store (rec__display__scrollstrt__text result____split_fields3) 
  i3 o55))))
...
;; H
  ...
  (<= i2 (to_rep3
         ...
         (us_split_fields1
         (rec__display__msgstrt__top (us_split_fields3 c35b)))))))
  (= result____split_fields4 (us_split_fields5 temp___1038))))
...
;; H
  ...
  (= o59 (mk___split_fields2
         (rec__display__scrollstrt__text
         (us_split_fields__content2 result____split_fields7)) o58)))

;; H
  (assert (= temp___1046 (mk___rep2 o59)))

;; H
  (assert (= result5 result____split_fields7))

;; H
  (assert (= result____split_fields9 (us_split_fields5 temp___1046)))

;; H
  (assert (= (to_rep o60) 32))
...
;; H
  (assert
  (= o61 (+ (to_rep4 (rec__display__scrollstrt__len result____split_fields9)) 1)))

;; H
  (assert
  (= o62 (store (rec__display__scrollstrt__text result____split_fields9) 
  o61 o60)))
...
;; H
  (assert (= temp___1050 (mk___rep2 o63)))

;; H
  (assert (= result6 (mk___split_fields__ref2 result____split_fields9)))

;; H
  (assert (= result____split_fields10 (us_split_fields5 temp___1050)))

;; H
  (assert (= (to_rep o64) 47))
...
;; H
  (assert
  (= o66 (store (rec__display__scrollstrt__text result____split_fields10) 
  o65 o64)))
...
;; H
  (assert (= temp___1054 (mk___rep2 o67)))

;; H
  (assert (= result7 (mk___split_fields__ref2 result____split_fields10)))

;; H
  (assert (= result____split_fields11 (us_split_fields5 temp___1054)))
...
;; H
  (assert
  (= o70 (store (rec__display__scrollstrt__text result____split_fields11) 
  o69 o68)))
...
;; H
  (assert (= temp___1058 (mk___rep2 o71)))

;; H
  (assert (= result8 (mk___split_fields__ref2 result____split_fields11)))

;; H
  (assert (= result____split_fields12 (us_split_fields5 temp___1058)))
...
;; H
  (assert (= (to_rep4 o73) o72))

;; H
  (assert
  (= o74 (mk___split_fields2
         (rec__display__scrollstrt__text result____split_fields12) o73)))

;; H
  (assert (= temp___1060 (mk___rep2 o74)))

;; H
  (assert (= result9 (mk___split_fields__ref2 result____split_fields12)))

;; H
  (assert (= result____split_fields13 (us_split_fields5 temp___1060)))
