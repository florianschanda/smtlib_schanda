...
;; H
  (assert
  (forall ((i3 Int)) (nth8_stream__function_guard
  (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last)))
  i3) (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) i3)))

;; H
  (assert
  (forall ((i3 Int)) (nth8_stream__function_guard
  (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last)))
  i3) (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i3)))
...
;; H
  (assert (and (= o10 (- (- len i2) 1)) (in_range2 (- (- len i2) 1))))

;; H
  (assert (= o11 (nth value o10)))

;; H
  (assert (= o12 (to_int2 o11)))
