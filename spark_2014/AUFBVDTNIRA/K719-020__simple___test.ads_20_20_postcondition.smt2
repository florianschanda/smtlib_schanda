...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        ...
                        (= (rec__test__t__b (us_split_fields1 a)) (rec__test__t__b
                                                                  (us_split_fields1
                                                                  b))))
                        (= (bool_eq1 (rec__test__t__c (us_split_fields1 a)) 1
...
(declare-fun test__t__a__first__bit () Int)

(declare-fun test__t__a__last__bit () Int)

(declare-fun test__t__a__position () Int)
...
(declare-fun test__t__b__first__bit () Int)

(declare-fun test__t__b__last__bit () Int)

(declare-fun test__t__b__position () Int)
...
(declare-fun test__t__c__first__bit () Int)

(declare-fun test__t__c__last__bit () Int)

(declare-fun test__t__c__position () Int)
...
(declare-fun test__f2__result () Int)

(declare-fun result () Int)

(declare-fun test__f2__result1 () Int)

(declare-fun test__f2__result2 () Int)

(declare-fun test__f2__result3 () Int)

(declare-fun test__f2__result4 () Int)

(declare-fun test__f2__result5 () Int)

(declare-fun result1 () Int)

;; H
  (assert (< 11 (to_rep (select (rec__test__t__c (us_split_fields1 x)) 1))))

;; H
  (assert (= test__f2__result1 test__f2__result2))

;; H
  (assert (= test__f2__result3 test__f2__result1))

;; H
  (assert (= result test__f2__result))

;; H
  (assert
  (= test__f2__result1 (to_rep
                       (select (rec__test__t__c (us_split_fields1 x)) 1))))

;; H
  (assert
  (= (mk_int__ref test__f2__result4) (mk_int__ref test__f2__result2)))

;; H
  (assert (= test__f2__result5 test__f2__result3))

;; H
  (assert (= result1 test__f2__result4))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (< 11 test__f2__result4)))
(check-sat)
