...
(define-fun current_date__split_fields9 () us_split_fields (mk___split_fields
                                                           current_date__split_fields6
                                                           current_date__split_fields7
                                                           current_date__split_fields8))
...
;; H
  (assert
  (and
  (and (= o7 (maximum_date Tuple0)) (maximum_date__function_guard o7 Tuple0))
...
;; H
  ...
  (= (bool_eq4
     (mk___rep
     (mk___split_fields current_date__split_fields3
     current_date__split_fields4 current_date__split_fields5))
...
;; H
  (assert
  (and
  (and (= o6 (maximum_date Tuple0)) (maximum_date__function_guard o6 Tuple0))
  (and (= (of_rep2 31) o3) (and (= (of_rep1 12) o4) (= (of_rep 2099) o5)))))

;; H
  (assert (= result5 (bool_eq4 (mk___rep current_date__split_fields9) o6)))
...
;; WP_parameter_def
 ;; File "dates.ads", line 89, characters 0-0
  (not
  (not
  (= (bool_eq4 (mk___rep current_date__split_fields9) (maximum_date Tuple0)) true))))
(check-sat)
