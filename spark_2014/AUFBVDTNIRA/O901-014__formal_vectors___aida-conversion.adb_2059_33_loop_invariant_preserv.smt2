...
;; H
  ...
  (<= index4 (+ (to_rep1 (first (rt source))) 6)))
...
;; H
  (assert (<= temp___2656 index1))

;; H
  (assert (<= index1 temp___2657))
...
;; H
  ...
  (=> (< index2 temp___2654)
  (= (select n3 temp___2654) (select n1 temp___2654)))))
  (=>
