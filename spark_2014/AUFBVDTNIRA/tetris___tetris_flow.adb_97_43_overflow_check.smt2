...
(declare-fun tetris_flow__delete_complete_lines__empty_line__assume () (Array Int cell))

(declare-fun temp___780 () Int)

(declare-fun temp___778 () (Array Int (Array Int cell)))

(declare-fun temp___777 () Bool)
...
;; H
  (assert
  (= tetris_flow__delete_complete_lines__empty_line__assume (tetris_flow__delete_complete_lines__empty_line__aggregate_def
                                                            0)))

;; H
  (assert
  (= tetris_flow__delete_complete_lines__empty_line__assume empty_line))
...
;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___780 to_line1)))

;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___778 cur_board)))

;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50))
  (= temp___777 has_complete_lines1)))
...
;; H
  ...
  (=> (and (<= 1 temp___779) (<= temp___779 50))
  (=> (<= del_line2 temp___779)
  (= (select cur_board2 temp___779) (select temp___778 temp___779)))))
