...
(declare-fun temp___575 () (Array Int character))

(declare-fun temp___5751 () nat_type)

(declare-fun temp___5752 () nat_type)

(declare-fun temp___5753 () nat_type)
...
;; H
  (assert
  (and (= result7 (is_pumping cur_state3))
  (= (= result7 true) (= cur_state3 0))))
