...
(declare-fun o2 () nat_type)

(declare-fun o3 () (Array Int character))

(declare-fun o4 () nat_type)

(declare-fun o5 () nat_type)

(declare-fun o6 () nat_type)

(declare-fun temp___602 () (Array Int character))

(declare-fun temp___6021 () nat_type)

(declare-fun temp___6022 () nat_type)

(declare-fun temp___6023 () nat_type)
...
(declare-fun cur_pump__split_fields4 () (Array Int character))

(declare-fun cur_pump__split_fields5 () nat_type)

(declare-fun cur_pump__split_fields6 () nat_type)

(declare-fun cur_pump__split_fields7 () nat_type)
...
(declare-fun result4 () nat_type)

(declare-fun result5 () nat_type)

(declare-fun result6 () nat_type)

(declare-fun cur_pump__split_fields8 () (Array Int character))

(declare-fun cur_pump__split_fields9 () nat_type)

(declare-fun cur_pump__split_fields10 () nat_type)

(declare-fun cur_pump__split_fields11 () nat_type)

(declare-fun cur_state3 () Int)

(declare-fun cur_pump__split_fields12 () (Array Int character))

(declare-fun cur_pump__split_fields13 () nat_type)

(declare-fun cur_pump__split_fields14 () nat_type)

(declare-fun cur_pump__split_fields15 () nat_type)

(declare-fun outstanding3 () Int)

(declare-fun cur_state4 () Int)

(declare-fun cur_pump__split_fields16 () (Array Int character))

(declare-fun cur_pump__split_fields17 () nat_type)

(declare-fun cur_pump__split_fields18 () nat_type)

(declare-fun cur_pump__split_fields19 () nat_type)

(declare-fun outstanding4 () Int)

(declare-fun result7 () Bool)

(define-fun cur_pump__split_fields20 () us_split_fields (mk___split_fields
                                                        cur_pump__split_fields8
                                                        cur_pump__split_fields9
                                                        cur_pump__split_fields10
                                                        cur_pump__split_fields11))
...
;; H
  (assert
  (=> (= result true) (= (mk_int__ref result1) (mk_int__ref cur_state))))
...
;; H
  (assert
  (=> (= result true)
  (and (= o (+ outstanding (to_rep2 cur_pump__split_fields2))) (in_range
  (+ outstanding (to_rep2 cur_pump__split_fields2))))))

;; H
  (assert
  (=> (= result true) (= (mk_int__ref result2) (mk_int__ref outstanding))))
...
;; H
  (assert
  (=> (= result true)
  (and (= o1 (- (to_rep2 cur_pump__split_fields1) 1)) (in_range4
  (- (to_rep2 cur_pump__split_fields1) 1)))))
...
;; H
  (assert (=> (= result true) (= temp___602 o3)))

;; H
  (assert (=> (= result true) (= temp___6021 o4)))

;; H
  (assert (=> (= result true) (= temp___6022 o5)))

;; H
  (assert (=> (= result true) (= temp___6023 o6)))

;; H
  (assert
  (=> (= result true)
  (= (mk___split_fields__ref
     (mk___split_fields result3 result4 result5 result6)) (mk___split_fields__ref
                                                          (mk___split_fields
                                                          cur_pump__split_fields
                                                          cur_pump__split_fields1
                                                          cur_pump__split_fields2
...
;; H
  (assert (=> (= result true) (= temp___602 cur_pump__split_fields8)))

;; H
  (assert (=> (= result true) (= temp___6021 cur_pump__split_fields9)))

;; H
  (assert (=> (= result true) (= temp___6022 cur_pump__split_fields10)))

;; H
  (assert (=> (= result true) (= temp___6023 cur_pump__split_fields11)))
...
;; H
  (assert
  (=> (not (= result true))
  (= cur_pump__split_fields cur_pump__split_fields8)))

;; H
  (assert
  (=> (not (= result true))
  (= cur_pump__split_fields1 cur_pump__split_fields9)))

;; H
  (assert
  (=> (not (= result true))
  (= cur_pump__split_fields2 cur_pump__split_fields10)))

;; H
  (assert
  (=> (not (= result true))
  (= cur_pump__split_fields3 cur_pump__split_fields11)))
...
;; H
  (assert
  (=> (not (= result true))
  (= cur_pump__split_fields20 (mk___split_fields cur_pump__split_fields4
                              cur_pump__split_fields5 cur_pump__split_fields6
                              cur_pump__split_fields7))))
...
;; H
  (assert
  (= (mk___split_fields cur_pump__split_fields16 cur_pump__split_fields17
     cur_pump__split_fields18 cur_pump__split_fields19) cur_pump__split_fields20))
...
;; H
  (assert
  (and
  (and (= result7 (is_pumping cur_state3)) (is_pumping__function_guard
  result7 cur_state3)) (= (= result7 true) (= cur_state3 0))))
...
;; H
  ...
  (and
  (= o7 (get_cur_price
        (mk___split_fields cur_pump__split_fields12 cur_pump__split_fields13
        cur_pump__split_fields14 cur_pump__split_fields15)))
  (get_cur_price__function_guard o7
  (mk___split_fields cur_pump__split_fields12 cur_pump__split_fields13
  cur_pump__split_fields14 cur_pump__split_fields15)))
  (and (in_range4 o7) (= o7 (to_rep2 cur_pump__split_fields14)))))
