...
;; length__post_axiom
  (assert
  (forall ((container us_rep2)) (! (dynamic_invariant1 (length4 container)
...
;; has_key__post_axiom
  ...
  (! (=> (= (of_int 0) true)
     (=>
     (exists ((k1 us_rep1))
     (and (= (has_key container k1) true) (= (bool_eq4 k1 key2) true)))
...
;; H
  ...
  (= (key (mk___rep l__split_discrs l__split_fields6)
     (find (mk___rep l__split_discrs l__split_fields6) k)) k))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields6)) k) 1))
  (= (ole
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
...
;; H
  ...
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields5))
     (model__ (mk___rep l__split_discrs l__split_fields6))) true))
  (= (keys_included_except
     (model__ (mk___rep l__split_discrs l__split_fields6))
     (model__ (mk___rep l__split_discrs l__split_fields5)) k) true))
  (= (mapping_preserved (keys (mk___rep l__split_discrs l__split_fields5))
     (keys (mk___rep l__split_discrs l__split_fields6))
