...
;; H
  (assert (= i1 temp___1034))

;; H
  (assert (<= temp___1034 i1))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) i3)
  (<= i3 (to_rep1 (last (rt source))))))

;; H
  (assert (= o7 i3))

;; H
  (assert (= o8 (select (elts source) o7)))
...
;; H
  (assert (= result4 (ite (not (= o10 true)) true false)))
