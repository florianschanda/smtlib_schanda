...
(declare-fun temp___1982 () (Array Int integer))

(declare-fun temp___1983 () t1)
...
(declare-fun temp___2002 () (Array Int integer))

(declare-fun temp___2003 () t2)
...
(declare-fun values_last2 () (Array Int integer))
...
(declare-fun values_last3 () (Array Int integer))
...
(define-fun o16 () us_t (mk___t o12 o13))

(define-fun o17 () us_t (mk___t o4 o5))
...
;; H
  (assert
  (and
  (and (= o6 (index_of_minimum o17)) (index_of_minimum__function_guard 
  o6 o17))
  (and (in_range2 o6)
  (and (and (<= (to_rep (first o5)) o6) (<= o6 (to_rep (last o5))))
  (forall ((j Int))
  (=> (and (<= (to_rep (first o5)) j) (<= j (to_rep (last o5))))
  (<= (to_rep (select o4 o6)) (to_rep (select o4 j)))))))))
...
;; H
  (assert (perm__function_guard
  (perm (mk___t values3 (mk (to_rep values__first) (to_rep values__last)))
...
;; H
  (assert (not (= current2 temp___213)))
...
;; H
  (assert
  (= (slide values3 (to_rep values__first) (to_rep values__first)) temp___1982))

;; H
  (assert (= (mk1 (to_rep values__first) (to_rep values__last)) temp___1983))

;; H
  (assert
  (= (ite (<= (to_rep (first3 temp___1983)) (to_rep (last3 temp___1983)))
     (+ (- (to_rep (last3 temp___1983)) (to_rep (first3 temp___1983))) 1) 0) 
  (ite (<= (to_rep values_last__first) (to_rep values_last__last))
  (+ (- (to_rep values_last__last) (to_rep values_last__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o8 o9) (mk___t1 temp___1982 temp___1983)))
...
;; H
  (assert (= o11 temp___2002))

;; H
  (assert (= (mk2 current3 (to_rep values__last)) temp___2003))

;; H
  (assert (= temp___2002 o12))

;; H
  (assert
  (= (mk (to_rep (first7 temp___2003)) (to_rep (last7 temp___2003))) 
  o13))

;; H
  (assert
  (and
  (and (= o14 (index_of_minimum o16)) (index_of_minimum__function_guard 
  o14 o16))
  (and (in_range2 o14)
  (and (and (<= (to_rep (first o13)) o14) (<= o14 (to_rep (last o13))))
  (forall ((j Int))
  (=> (and (<= (to_rep (first o13)) j) (<= j (to_rep (last o13))))
  (<= (to_rep (select o12 o14)) (to_rep (select o12 j)))))))))
...
;; H
  ...
  (and (= o15 current3) (in_range2 current3))))
...
;; H
  ...
  (and (= (to_rep (select values4 o15)) (to_rep (select values3 smallest3)))
  (and (= (to_rep (select values4 smallest3)) (to_rep (select values3 o15)))
  (forall ((j Int))
  (=> (and (<= (to_rep values__first) j) (<= j (to_rep values__last)))
  (=> (and (not (= j o15)) (not (= j smallest3)))
  (= (to_rep (select values4 j)) (to_rep (select values3 j)))))))))))
...
;; WP_parameter_def
 ;; File "sorters.ads", line 7, characters 0-0
  (not (<= (to_rep (select values4 current3)) (to_rep (select values4 j)))))
(check-sat)
