...
(declare-fun temp___2858 () (Array Int us_rep1))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2858 (parent f i3)))) (position f i3)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2858 i3))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___2858 (parent f i3)))) (position f i3)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2858 i3))))))
...
;; H
  (assert
  (and
  (and (= temp___2858 (model__ f root)) (model____function_guard temp___2858
  f root))
  (and (dynamic_invariant5 temp___2858 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2858 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2858 root)))) 0)
  (and
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=> (not (= i3 root))
  (ite (and (not (= (parent f i3) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___2858 (parent f i3)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2858 i3))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2858 i3))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2858 i3)))) 0))))
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2858 j2))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2858 i3)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2858 j2)))) true))
  (= j2 i3))))))))))))))

;; H
  (assert (= o30 (select temp___2858 i2)))
