...
(declare-fun dummy1 () float_64)

(declare-datatypes ()
((float_64__ref (mk_float_64__ref (float_64__content float_64)))))
(define-fun float_64__ref___projection ((a float_64__ref)) float_64 (float_64__content
                                                                    a))
...
(define-fun dynamic_invariant1 ((temp___expr_184 t1)
  (temp___is_init_181 Bool) (temp___skip_constant_182 Bool)
  (temp___do_toplevel_183 Bool)) Bool (=>
                                      (or (= temp___is_init_181 true) (le1
                                      (neg1 fliteral3) fliteral3))
                                      (tqtisFinite1 temp___expr_184)))
...
;; H
  (assert (=> (le1 (neg1 fliteral3) fliteral3) (tqtisFinite1 res)))
...
;; H
  (assert (= res1 (to_float64 RNE2 (mul RNE2 x fliteral4))))

(assert
;; WP_parameter_def
 ;; File "floating_point.adb", line 387, characters 0-0
  (not (le1 (neg1 fliteral1) res1)))
(check-sat)
