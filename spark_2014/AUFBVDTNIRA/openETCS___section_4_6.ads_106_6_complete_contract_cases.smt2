...
;; WP_parameter_def
 ;; File "section_4_3_2.ads", line 25, characters 0-0
  (not
  (<= 1 (+ (+ (+ 0 (ite (= (condition_transition_sb_to_sh ertms_etcs_level
                           an_acknowledge_request_for_shunting_is_displayed_to_the_driver
                           driver_acknowledges driver_selects_shunting_mode
                           note_5_conditions_for_shunting_mode
                           reception_of_information_shunting_granted_by_rbc
                           train_is_at_standstill priority) true)
                   1 0)) (ite (= (condition_transition_sb_to_fs
                                 ma_ssp_gardient_on_board
                                 no_specific_mode_is_required_by_a_mode_profile
                                 valid_train_data_is_stored_on_board
                                 priority) true)
                         1 0)) (ite (= (condition_transition_sb_to_is
