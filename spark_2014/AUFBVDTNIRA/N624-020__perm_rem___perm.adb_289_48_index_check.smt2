...
;; H
  ...
  (=>
  (and (<= 1 k1)
  (<= k1 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts a) k1)) (to_rep
                                   (select perm__extended_perm__B_6__aa__assume k1)))))
  (and
  (forall ((k1 Int))
  (=>
  (and
  (<= (+ (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k1)
  (<= k1 (to_rep2 (last (rt a)))))
  (= (to_rep (select (elts a) k1)) (to_rep
                                   (select perm__extended_perm__B_6__aa__assume (- k1 1))))))
  (forall ((k1 Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) k1)
  (<= k1 (- (to_rep2 (last (rt a))) 1)))
  (= (to_rep (select (elts a) (+ k1 1))) (to_rep
                                         (select perm__extended_perm__B_6__aa__assume k1))))))))))))
...
;; H
  ...
  (=>
  (and (<= 1 k1)
  (<= k1 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts b) k1)) (to_rep
                                   (select perm__extended_perm__B_6__bb__assume k1)))))
  (and
  (forall ((k1 Int))
  (=>
  (and
  (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k1)
  (<= k1 (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k1)) (to_rep
                                   (select perm__extended_perm__B_6__bb__assume (- k1 1))))))
  (forall ((k1 Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k1)
  (<= k1 (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k1 1))) (to_rep
                                         (select perm__extended_perm__B_6__bb__assume k1))))))))))))
...
;; H
  (assert
  (forall ((ia3 Int)) (remove__function_guard (remove aa ia3) aa ia3)))
...
;; H
  (assert
  (forall ((ia3 Int) (ib2 Int)) (is_perm__function_guard
  (is_perm (remove aa ia3) (remove bb ib2)) (remove aa ia3) (remove bb ib2))))
...
;; H
  ...
  (forall ((ia3 Int))
  (=>
  (and (<= (to_rep2 (first (rt aa))) ia3) (<= ia3 (to_rep2 (last (rt aa)))))
  (exists ((ib2 Int))
  (and
  (and (<= (to_rep2 (first (rt bb))) ib2) (<= ib2 (to_rep2 (last (rt bb)))))
  (and (= (to_rep (select (elts aa) ia3)) (to_rep (select (elts bb) ib2)))
  (= (is_perm (remove aa ia3) (remove bb ib2)) true))))))))))
...
;; H
  (assert (forall ((ib2 Int)) (remove__function_guard (remove b ib2) b ib2)))
...
;; H
  (assert
  (forall ((ib2 Int)) (is_perm__function_guard
  (is_perm (remove a ia1) (remove b ib2)) (remove a ia1) (remove b ib2))))

;; H
  (assert
  (exists ((ib2 Int))
  (and
  (and (<= (to_rep2 (first (rt b))) ib2) (<= ib2 (to_rep2 (last (rt b)))))
  (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib2)))
  (= (is_perm (remove a ia1) (remove b ib2)) true)))))
...
;; H
  (assert (forall ((k1 Int)) (remove__function_guard (remove a k1) a k1)))
...
;; H
  (assert
  (forall ((k1 Int) (ib2 Int)) (is_perm__function_guard
  (is_perm (remove a k1) (remove b ib2)) (remove a k1) (remove b ib2))))
...
;; H
  ...
  (and
  (and (<= (to_rep2 (first (rt b))) ib2) (<= ib2 (to_rep2 (last (rt b)))))
  (and (= (to_rep (select (elts a) k1)) (to_rep (select (elts b) ib2)))
  (= (is_perm (remove a k1) (remove b ib2)) true)))))))

;; H
  (assert
  (and
  (and
  (and (=> (<= 1 1) (in_range3 ih2))
  (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a))))
  (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) 
  ia2))) (=> (<= 1 100) (in_range4 ib1)))
...
;; H
  (assert
  (and (<= (to_rep2 (first (rt b))) ib) (<= ib (to_rep2 (last (rt b))))))
