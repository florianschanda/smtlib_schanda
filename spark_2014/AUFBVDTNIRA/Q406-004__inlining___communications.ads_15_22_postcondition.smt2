...
;; H
  (assert
  (=> (< (to_rep2 self__3) 16)
  (= (mk___rep (mk___split_fields self__8 self__9 self__10 self__11)) 
...
;; H
  (assert
  (=> (< (to_rep2 self__3) 16)
  (= self__12 (mk___rep (mk___split_fields o15 o16 o17 o18)))))
...
;; H
  (assert (item_count__function_guard
  (item_count (mailboxT__content self__14)) (mailboxT__content self__14)))
