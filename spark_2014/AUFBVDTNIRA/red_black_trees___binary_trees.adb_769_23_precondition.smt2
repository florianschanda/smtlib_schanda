...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2393 (parent
                      (mk___rep2
                      (mk___split_fields2 f__split_fields f__split_fields1))
                      i1))))
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2393 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2393 (parent
                      (mk___rep2
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2391 o14))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2391 o14)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o14))
...
;; H
  (assert (= o15 (select temp___2391 i)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2392 o8))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2392 o8)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o8))
...
;; H
  (assert (=> (= result3 true) (= o9 (select temp___2392 i))))
...
;; H
  (assert
  (=> (= result3 true)
  (and (= o12 (length o11)) (and (in_range5 o12) (<= (+ 0 o12) 2147483647)))))

;; H
  (assert
  (=> (= result3 true) (= result2 (ite (<= o12 (- n2 1)) true false))))
...
;; H
  ...
  (= temp___2393 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 root))
  (model____function_guard temp___2393
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root))
  (and (dynamic_invariant3 temp___2393 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2393 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2393 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2393 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2393 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2393 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2393 j)))) true))
  (= j i1)))))))))))))))
...
;; H
  (assert (=> (= result2 true) (= temp___2395 (to_rep o3))))

;; H
  (assert
  (=> (= result2 true) (and (<= 1 temp___2395) (<= temp___2395 100))))

;; H
  (assert (=> (= result2 true) (= o4 temp___2395)))

;; H
  (assert (=> (= result2 true) (= o5 (select temp___2393 o4))))
...
;; H
  (assert
  (=> (= result2 true) (= result1 (rec__tree_model__path_type__k o6))))
