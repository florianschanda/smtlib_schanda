...
;; H
  (assert (= o10 (mul RNE2 fliteral2 o9)))

;; H
  (assert (and (= o11 o10) (tqtisFinite o10)))

;; H
  (assert (= o12 (div1 RNE2 o11 fliteral3)))
...
;; H
  (assert (= o6 (mul RNE2 fliteral4 o5)))

;; H
  (assert (and (= o7 o6) (tqtisFinite o6)))

;; H
  (assert (= o8 (div1 RNE2 o7 fliteral5)))
...
;; H
  (assert (= o2 (mul RNE2 fliteral6 o1)))

;; H
  (assert (and (= o3 o2) (tqtisFinite o2)))

;; H
  (assert (= o4 (div1 RNE2 o3 fliteral7)))
