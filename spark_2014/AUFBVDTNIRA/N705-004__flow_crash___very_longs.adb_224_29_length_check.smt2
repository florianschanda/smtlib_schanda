...
(define-fun dynamic_invariant3 ((temp___expr_579 us_rep1)
  (temp___is_init_576 Bool) (temp___skip_constant_577 Bool)
  (temp___do_toplevel_578 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_577 true))
                                      (in_range3
                                      (to_rep
                                      (rec__very_longs__very_long__octet_length
                                      (us_split_discrs1 l)))
                                      (to_base temp___expr_579)))
                                      ...
                                      (first3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_579)))
                                      (last5
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_579))))
                                      (and
                                      (= (first3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_579))) 1)
                                      (= (last5
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_579))) 
                                      (to_rep
...
(define-fun default_initial_assumption ((temp___expr_582 us_rep1)
  (temp___skip_top_level_583 Bool)) Bool (= (to_rep
                                            (rec__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_582))) (to_rep
                                                               (rec__very_longs__very_long__octet_length
                                                               (us_split_discrs1
                                                               l)))))
...
(declare-fun temp___939 ((_ BitVec 8) Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___941 (_ BitVec 8)))
  (forall ((temp___942 Int) (temp___943 Int))
  (let ((temp___940 (temp___939 temp___941 temp___942 temp___943)))
  (and
  (=> (dynamic_property6 1 2147483647 temp___942 temp___943)
  (and (= (first5 temp___940) temp___942) (= (last8 temp___940) temp___943)))
  (forall ((temp___944 Int))
  (= (select (to_array2 temp___940) temp___944) (of_rep1 temp___941))))))))
...
(declare-fun temp___946 () (Array Int octet))

(declare-fun temp___9461 () t2)
...
;; H
  (assert
  (= (mk___t2 temp___946 temp___9461) (temp___939 ((_ int2bv 8) 0) 1
                                      (to_rep
                                      (rec__very_longs__very_long__octet_length
                                      (us_split_discrs1 l))))))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 85, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first4 temp___9461)) (to_rep2 (last7 temp___9461)))
     (+ (- (to_rep2 (last7 temp___9461)) (to_rep2 (first4 temp___9461))) 1)
     0) (ite (<= 1 (to_rep
                   (rec__very_longs__very_long__octet_length
                   (us_split_discrs1 l))))
        (+ (- (to_rep
