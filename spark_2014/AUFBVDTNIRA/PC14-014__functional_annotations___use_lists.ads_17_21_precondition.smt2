...
;; H
  (assert (= result6 (bool_eq3 o12 no_element)))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o7 j) true)
  (=> (= (get1 o7 i) (get1 o7 j)) (= (bool_eq3 i j) true))))))))))
...
;; H
  ...
  (forall ((k us_rep1))
  (=> (= (has_key o7 k) true)
  (= (= (bool_eq3 k (cursor__content use_lists__my_find__result13)) true)
...
;; H
  ...
  (forall ((k us_rep1))
  (=> (= (has_key o5 k) true)
  (= (= (bool_eq3 k o11) true) (= (witness o5 o11) (witness o5 k))))))))))
