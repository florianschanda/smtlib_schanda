...
(declare-fun temp___840 () us_rep3)
...
;; H
  ...
  (= (has_key
     ...
     (mk___rep s1__split_discrs (us_split_fields__content s1__split_fields8)))
     key2) true))
  (and (< 0 (find temp___840 key2))
  (= (equivalent_keys (get1 temp___840 (find temp___840 key2)) key2) true)))))
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (length
        (mk___rep s1__split_discrs
        (us_split_fields__content s1__split_fields8)))))
  (and (= (find temp___840 (get1 temp___840 i)) i)
  (= (k_is_find temp___840 (get1 temp___840 i) i) true)))))))

;; H
  (assert
  (and (= o3 (iter_has_element temp___840 temp___839))
  (= (= o3 true) (and (<= 1 temp___839) (<= temp___839 (last temp___840))))))

;; H
  (assert (= (= o4 true) (in_range5 temp___839)))
...
;; H
  (assert (and (= k (get1 temp___840 temp___839)) (in_range6 k)))
