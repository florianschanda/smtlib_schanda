...
(declare-fun result9 () (Array Int group1_id))

;; H
  (assert
  (forall ((g19 Int)) (is_permutation_2__function_guard
  (is_permutation_2 (select ranking_1 g19)) (select ranking_1 g19))))
...
;; H
  ...
  (forall ((g19 Int))
  (=> (and (<= 1 g19) (<= g19 64))
  (= (is_permutation_2 (select ranking_1 g19)) true)))
  (forall ((g2 Int))
  (=> (and (<= 1 g2) (<= g2 64))
  (= (is_permutation_1 (select ranking_2 g2)) true)))))
...
;; H
  (assert (= result9 (map__content stable_marriage__matching__result4)))
