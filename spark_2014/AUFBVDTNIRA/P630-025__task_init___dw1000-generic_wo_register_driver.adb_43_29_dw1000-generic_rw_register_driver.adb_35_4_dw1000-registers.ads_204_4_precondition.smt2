...
(define-fun tregister_byte_arrayP1__ref_7__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_7__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2054 us_t1)
  (temp___is_init_2051 Bool) (temp___skip_constant_2052 Bool)
  (temp___do_toplevel_2053 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2052 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_2054)
                                       (last4 temp___expr_2054))
                                       (and (= (first3 temp___expr_2054) 1)
                                       (= (last4 temp___expr_2054) 4)))))
...
(define-fun target__ref_3__projection ((a target__ref)) us_t2 (target__content
                                                              a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_3__projection ((a source__ref)) us_rep (source__content
                                                               a))

(define-fun dynamic_invariant1 ((temp___expr_2094 us_t2)
  (temp___is_init_2091 Bool) (temp___skip_constant_2092 Bool)
  (temp___do_toplevel_2093 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2092 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_2094)
                                       (last6 temp___expr_2094))
                                       (and (= (first5 temp___expr_2094) 1)
                                       (= (last6 temp___expr_2094) 4)))))
...
(declare-fun temp___7561 () (Array Int bits_8))

(declare-fun temp___75611 () t2)

(declare-fun temp___7562 () (Array Int bits_8))

(declare-fun temp___75621 () t1)
...
(define-fun temp___75612 () us_t2 (mk___t2 temp___7561 temp___75611))
...
;; H
  (assert
  (and
  (and (= temp___75612 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___75612 reg)) (dynamic_invariant1
  temp___75612 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___75611)) (to_rep (last5 temp___75611)))
     (+ (- (to_rep (last5 temp___75611)) (to_rep (first4 temp___75611))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___7561 temp___7562))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___75611)) (to_rep (last5 temp___75611))) 
  temp___75621))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___75621)) (to_rep (last3 temp___75621)))
     (+ (- (to_rep (last3 temp___75621)) (to_rep (first2 temp___75621))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7562 temp___75621)))
