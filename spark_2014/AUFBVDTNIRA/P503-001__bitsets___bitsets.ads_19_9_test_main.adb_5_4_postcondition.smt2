...
(declare-fun test_main__my_sets__add__result () (Array Int Bool))
...
(declare-fun test_main__my_sets__add__result1 () (Array Int Bool))

(declare-fun test_main__my_sets__add__result2 () (Array Int Bool))

(declare-fun test_main__my_sets__add__result3 () (Array Int Bool))

(declare-fun res3 () (Array Int Bool))

(declare-fun test_main__my_sets__add__result4 () (Array Int Bool))

(declare-fun res4 () (Array Int Bool))

(declare-fun test_main__my_sets__add__result5 () (Array Int Bool))
...
;; H
  (assert (= res2 (store res1 e (of_int 1))))

;; H
  (assert
  (= test_main__my_sets__add__result1 test_main__my_sets__add__result2))

;; H
  (assert
  (= test_main__my_sets__add__result3 test_main__my_sets__add__result1))
...
;; H
  (assert
  (= (mk_map__ref test_main__my_sets__add__result4) (mk_map__ref
                                                    test_main__my_sets__add__result2)))
...
;; H
  (assert
  (= test_main__my_sets__add__result5 test_main__my_sets__add__result3))
...
;; H
  (assert (mem__function_guard (mem test_main__my_sets__add__result4 elt)
  test_main__my_sets__add__result4 elt))
...
;; H
  (assert (mem__function_guard (mem s elt) s elt))
