...
;; H
  ...
  (and (< x 1000000)
  (or (= state fliteral2)
  (and (le fliteral3 state) (le state (mul RNE2 (of_int RNE2 x) fliteral3))))))

;; H
  (assert
  (and (= o (add RNE2 state fliteral3)) (tqtisFinite
  (add RNE2 state fliteral3))))
