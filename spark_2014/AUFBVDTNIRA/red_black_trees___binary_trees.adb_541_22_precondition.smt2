...
(declare-fun temp___2041 () (Array Int us_rep1))
...
;; H
  (assert (= o19 (select temp___2043 i)))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o15))
  (and (dynamic_invariant3 temp___2042 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2042 o15))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2042 o15)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o15))
...
;; H
  (assert (= o16 (select temp___2042 i)))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2041 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2041 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___2041 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (model____function_guard temp___2041
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  root))
  (and (dynamic_invariant3 temp___2041 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2041 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2041 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2041 (parent
                              ...
                              f_old__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2041 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2041 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2041 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2041 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2041 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2041 j)))) true))
  (= j i1))))))))))))))
...
;; H
  (assert (= o11 (select temp___2041 o10)))
