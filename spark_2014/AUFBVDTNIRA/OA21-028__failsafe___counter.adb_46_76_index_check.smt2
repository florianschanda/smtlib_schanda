...
;; H
  ...
  (=>
  (and
  (bvule (bvadd (bvsub ((_ int2bv 8) 10) counter__p__B_3__a__assume) ((_ int2bv 8) 1)) i1)
  (bvule i1 ((_ int2bv 8) 10))) (= (select inputs1 i1) true)))
...
;; H
  (assert (bvule (bvadd (bvsub ((_ int2bv 8) 10) a) ((_ int2bv 8) 1)) i))
