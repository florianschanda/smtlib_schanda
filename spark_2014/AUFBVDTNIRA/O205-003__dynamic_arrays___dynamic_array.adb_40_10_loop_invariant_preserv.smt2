...
(declare-fun temp___211 () us_rep2)
...
;; H
  ...
  (= (attr__constrained
     ...
     i2)) true)
  (= (rec__dynamic_array__rec__b (us_split_discrs1 temp___205)) (rec__dynamic_array__rec__b
                                                                (us_split_discrs1
                                                                (select 
                                                                (elts1
                                                                (rec__dynamic_array__holder__content1
...
;; H
  (assert (= temp___211 (mk___rep2 h__split_discrs o27)))

;; H
  (assert (= result5 (mk___split_fields__ref2 h__split_fields3)))

;; H
  (assert (= h__split_fields4 (us_split_fields5 temp___211)))

;; H
  (assert (= h__split_discrs (us_split_discrs4 temp___211)))
