...
;; H
  (assert
  (and (= o14 (statusiswaitingfinishadminop (let ((subject state)) state7)))
  (statusiswaitingfinishadminop__function_guard o14
  (let ((subject state)) state7))))

;; H
  (assert
  (and (= o15 (statusiswaitingstartadminop (let ((subject state)) state7)))
...
;; H
  (assert
  (and (= o11 (statusisgotadmintoken (let ((subject state)) state7)))
  (statusisgotadmintoken__function_guard o11 (let ((subject state)) state7))))
...
;; H
  (assert
  (=> (= result5 true)
  (and (= o9 (statusiswaitingstartadminop (let ((subject state)) state7)))
