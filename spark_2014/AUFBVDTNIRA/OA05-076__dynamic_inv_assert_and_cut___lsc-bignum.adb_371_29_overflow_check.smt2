...
;; H
  (assert
  (and (= o64 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o64 ((_ int2bv 32) 1))))
...
;; H
  (assert
  (and (= o57 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o57 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o63 (omultiply o57 o62)) (omultiply__function_guard o63 o57 o62)))

;; H
  (assert
  (and (= o65 (osubtract o63 o64)) (osubtract__function_guard o65 o63 o64)))

;; H
  (assert
  (and (= o54 (from_word32 a_msw3)) (from_word32__function_guard o54 a_msw3)))
...
;; H
  (assert
  (and (and (= o48 (base Tuple0)) (base__function_guard o48 Tuple0))
  (= o48 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o53 (oexpon o48 o52)) (oexpon__function_guard o53 o48 o52)))

;; H
  (assert
  (and (= o55 (omultiply o53 o54)) (omultiply__function_guard o55 o53 o54)))
...
;; H
  (assert
  (and
  (= o47 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))
         a_first o46))
  (num_of_big_int__function_guard o47
  (mk___t a4 (mk (to_rep a__first) (to_rep a__last))) a_first o46)))

;; H
  (assert (and (= o56 (oadd o47 o55)) (oadd__function_guard o56 o47 o55)))

;; H
  (assert (and (= o66 (olt o56 o65)) (olt__function_guard o66 o56 o65)))
...
;; H
  (assert
  (and (= o42 (num_of_big_int m m_first o41)) (num_of_big_int__function_guard
  o42 m m_first o41)))
