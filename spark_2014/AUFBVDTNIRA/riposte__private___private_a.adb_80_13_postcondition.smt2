...
;; null_stack__def_axiom
  (assert
  (= null_stack (mk___rep
                (mk___split_fields (of_rep 0) (temp___133 (- 2147483648))))))

(declare-fun dst__split_fields () Bool)

(declare-fun dst__split_fields1 () length_t)

(declare-fun dst__split_fields2 () (Array Int integer))
...
(declare-fun dst__split_fields4 () length_t)

(declare-fun dst__split_fields5 () (Array Int integer))

(declare-fun result3 () Bool)

(declare-fun result4 () length_t)

(declare-fun result5 () (Array Int integer))

(declare-fun dst__split_fields6 () Bool)

(declare-fun dst__split_fields7 () length_t)

(declare-fun dst__split_fields8 () (Array Int integer))

(declare-fun dst__split_fields9 () us_split_fields__ref1)

(declare-fun dst__split_fields10 () us_split_fields2)

(define-fun dst__split_fields11 () us_split_fields2 (mk___split_fields1
                                                    dst__split_fields6
                                                    (mk___rep
                                                    (mk___split_fields
                                                    dst__split_fields7
...
;; H
  (assert
  (= src (mk___rep (mk___split_fields dst__split_fields4 dst__split_fields5))))
...
;; H
  (assert
  (= dst__split_fields9 (mk___split_fields__ref1 dst__split_fields11)))
...
;; WP_parameter_def
 ;; File "private_a.adb", line 62, characters 0-0
  (not
  (= (bool_eq4 (mk___rep1 (us_split_fields__content1 dst__split_fields9))
     (mk___rep1 (mk___split_fields1 (bool_eq3 src null_stack) src))) true)))
(check-sat)
