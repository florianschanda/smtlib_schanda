...
(declare-fun temp___1379 () (Array Int us_rep1))
...
;; H
  ...
  (mk___rep2 binary_trees__insert__f__fields) o22 (int__content d8)))
...
;; H
  ...
  (rec__search_trees__search_tree__struct t__split_fields7) o18 d4))
  (and (in_range4 o19)
  (and
  (ite (not (= o19 0))
  (and
  ...
  (forall ((e Int))
  (=> (and (<= 0 e) (<= e 1))
  (=> (or (not (= j1 o22)) (not (= e (int__content d8))))
...
;; H
  ...
  (= (contains o32 (to_rep (select t__split_fields3 i16))) true))))
  (forall ((v1 Int))
...
;; H
  ...
  (and
  (and
  (= o31 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (values__function_guard1 o31
  (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (ite (= (size
          (rec__search_trees__search_tree__struct
...
;; H
  (assert
  (=> (= (int__content i14) 0)
  (and (= result20 (oeq1 o31 o32))
  (= (= result20 true) (and (= (ole o31 o32) true) (= (ole o32 o31) true))))))
...
;; H
  ...
  (and
  (and
  (= temp___1379 (model__1
                 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (model____function_guard1 temp___1379
  (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (and (dynamic_invariant9 temp___1379 true false true)
  (= temp___1379 (model__
                 (rec__search_trees__search_tree__struct
                 (us_split_fields__content3 t__split_fields14))
                 (to_rep1
...
;; H
  (assert (= o29 (select temp___1379 j)))
