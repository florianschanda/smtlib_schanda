...
;; H
  (assert
  (and
  (and (= o1 (add1 fliteral2 fliteral3)) (add__function_guard o1 fliteral2
  fliteral3)) (and (tqtisFinite o1) (eq o1 (add RNE2 fliteral2 fliteral3)))))

;; H
  (assert
  (and (and (= o2 (add1 fliteral4 o1)) (add__function_guard o2 fliteral4 o1))
  (and (tqtisFinite o2) (eq o2 (add RNE2 fliteral4 o1)))))

;; H
  (assert
  (and
  (and (= o (add1 fliteral4 fliteral2)) (add__function_guard o fliteral4
  fliteral2)) (and (tqtisFinite o) (eq o (add RNE2 fliteral4 fliteral2)))))
