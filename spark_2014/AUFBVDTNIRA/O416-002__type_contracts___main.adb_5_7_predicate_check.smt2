...
(declare-fun temp___268 () (Array Int character))

(declare-fun temp___2681 () (Array Int character))
...
;; H
  (assert (= o4 (temp___String_Literal_270 Tuple0)))

;; H
  (assert (= o5 (temp___String_Literal_269 Tuple0)))
...
;; H
  (assert (<= (compare temp___271 1 10 temp___2711 1 10) 0))

;; H
  (assert
  (= (mk___rep (mk___split_fields o8 o9)) (mk___rep
                                          (mk___split_fields temp___271
                                          temp___2711))))

;; H
  (assert (= o (temp___String_Literal_267 Tuple0)))

;; H
  (assert (= o1 (temp___String_Literal_266 Tuple0)))
...
;; WP_parameter_def
 ;; File "main.adb", line 3, characters 0-0
  (not (<= (compare temp___268 1 10 temp___2681 1 10) 0)))
(check-sat)
