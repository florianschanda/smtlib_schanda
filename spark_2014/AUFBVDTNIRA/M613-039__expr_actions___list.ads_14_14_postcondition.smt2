...
;; H
  (assert
  (=> (and (<= first2 i8) (<= i8 last3)) (= result2 res__split_fields12)))
...
;; H
  ...
  (= (bool_eq1 (elts (to__ (mk___rep s__split_fields10)))
     ...
     (to_rep (last7 (mk1 first2 (- last3 i9)))) (elts (to__ temp___4852))
...
;; H
  (assert
  (=> (not (and (<= first2 i8) (<= i8 last3))) (= i12 (mk_int__ref i8))))

;; H
  (assert
  (=> (not (and (<= first2 i8) (<= i8 last3)))
...
;; H
  (assert
  (= (mk___rep1 (mk___split_discrs result4) (mk___split_fields1 result5)) 
