...
(declare-fun temp___591 () (Array Int us_rep7))
...
(declare-fun temp___590 () (Array Int us_rep1))
...
;; H
  ...
  (= temp___590 (model__
                (rec__red_black_trees__rbt__struct (us_split_fields9 c60b))))
  (and (dynamic_invariant5 temp___590 true false true)
  (= temp___590 (model__1
                (rec__search_trees__search_tree__struct
                (us_split_fields7
                (rec__red_black_trees__rbt__struct (us_split_fields9 c60b))))
...
;; H
  (assert
  (=> (= result5 true)
  (and (= temp___591 (nb_blacks c60b))
  (and
  (= (bool_eq17 (select temp___591 0)
     (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true)
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  ...
  (=
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select temp___591 i1))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11
     (select temp___591 (peek
                        (rec__red_black_trees__rbt__struct
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select temp___591 i1)))) (+ 1 (ite (< (to_rep
                                                               (rec__red_black_trees__black_count__depth
                                                               (us_split_fields11
                                                               (select 
                                                               temp___591 
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select temp___591 i1)))) (+ (ite (= (to_rep3
                                                             (select 
                                                             (rec__red_black_trees__rbt__color
                                                             (us_split_fields9
                                                             c60b)) i1)) 0)
...
;; H
  (assert (=> (= result5 true) (= o1 (select temp___591 i))))
