...
(declare-fun temp___1061 () (Array Int us_rep7))

(declare-fun o1 () us_rep7)

(declare-fun o2 () us_split_fields10)

(declare-fun o3 () extended_index_type)

(declare-fun o4 () Int)

(declare-fun temp___1060 () (Array Int us_rep1))
...
;; H
  ...
  (parent (mk___rep3 search_trees__insert__t__fields) i1)
  (mk___rep3 search_trees__insert__t__fields) i1)))
...
;; H
  (assert
  (forall ((i1 Int)) (eq__function_guard
  (eq (select (nb_blacks c61b) i1) (select (nb_blacks c60b) i1))
  (select (nb_blacks c61b) i1) (select (nb_blacks c60b) i1))))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
             (rec__red_black_trees__rbt__struct (us_split_fields9 c60b))) i1))) true)
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c60b) i1)))) n2))
  (not
  (= i1 (root (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))))))
  (= (eq (select (nb_blacks c61b) i1) (select (nb_blacks c60b) i1)) true)))))
...
;; H
  (assert
  (forall ((i1 Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c60b)) i1 0)
  (rec__red_black_trees__rbt__struct (us_split_fields9 c60b)) i1 0)))

;; H
  (assert
  (forall ((i1 Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c60b)) i1 1)
  (rec__red_black_trees__rbt__struct (us_split_fields9 c60b)) i1 1)))
...
;; H
  ...
  (= temp___1060 (model__
                 (rec__red_black_trees__rbt__struct (us_split_fields9 c60b))))
  (model____function_guard temp___1060
  (rec__red_black_trees__rbt__struct (us_split_fields9 c60b))))
  (and (dynamic_invariant5 temp___1060 true false true)
  (= temp___1060 (model__1
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7
                 (rec__red_black_trees__rbt__struct (us_split_fields9 c60b))))
                 (to_rep
...
;; H
  (assert (= o5 (select temp___1060 i)))

;; H
  (assert (= o6 (us_split_fields1 o5)))

;; H
  (assert (= result5 (rec__tree_model__path_type__k o6)))

;; H
  (assert
  (=> (= result5 true)
  (and
  (and (= temp___1061 (nb_blacks c60b)) (nb_blacks__function_guard
  temp___1061 c60b))
  (and
  (= (bool_eq17 (select temp___1061 0)
     (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true)
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  ...
  (=
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select temp___1061 i1))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11
     (select temp___1061 (peek
                         (rec__red_black_trees__rbt__struct
                         (us_split_fields9 c60b)) i1 0))))) (to_rep
                                                            (rec__red_black_trees__black_count__count
                                                            (us_split_fields11
                                                            (select temp___1061 
                                                            (peek
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select temp___1061 i1)))) (+ 1 (ite (< (to_rep
                                                                (rec__red_black_trees__black_count__depth
                                                                (us_split_fields11
                                                                (select 
                                                                temp___1061 
  ...
  (select temp___1061 (peek
                      (rec__red_black_trees__rbt__struct
                      (us_split_fields9 c60b)) i1 1)))))) (to_rep
                                                          (rec__red_black_trees__black_count__depth
                                                          (us_split_fields11
                                                          (select temp___1061 
                                                          (peek
  ...
  (select temp___1061 (peek
                      (rec__red_black_trees__rbt__struct
                      (us_split_fields9 c60b)) i1 0)))))))))
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select temp___1061 i1)))) (+ (ite (= (to_rep3
                                                              (select 
                                                              (rec__red_black_trees__rbt__color
                                                              (us_split_fields9
                                                              c60b)) i1)) 0)
...
;; H
  (assert (=> (= result5 true) (= o1 (select temp___1061 i))))

;; H
  (assert (=> (= result5 true) (= o2 (us_split_fields11 o1))))

;; H
  (assert
  (=> (= result5 true) (= o3 (rec__red_black_trees__black_count__depth o2))))

;; H
  (assert (=> (= result5 true) (= o4 (to_rep o3))))

;; H
  (assert (=> (= result5 true) (= result4 (ite (< o4 n2) true false))))
...
;; H
  (assert (size__function_guard
  (size (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)))
  (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))))
...
;; WP_parameter_def
 ;; File "red_black_trees.ads", line 59, characters 0-0
  (not
  (not
  (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))) 0))))
(check-sat)
