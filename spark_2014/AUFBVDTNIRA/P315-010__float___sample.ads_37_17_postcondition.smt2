...
;; H
  (assert
  (and (= o (sub RNE2 time (div1 RNE2 d1 fliteral8))) (tqtisFinite
  (sub RNE2 time (div1 RNE2 d1 fliteral8)))))
...
;; H
  (assert (= tmp11 (mul RNE2 (of_int RNE2 nb_of_fp) delta_time)))

;; H
  (assert
  (and (= o2 (add RNE2 t_fp1 tmp11)) (tqtisFinite (add RNE2 t_fp1 tmp11))))
...
;; H
  (assert
  (= tmp21 (mul RNE2 (mul RNE2 fliteral7 (of_int RNE2 nb_of_fp)) delta_time)))

;; H
  (assert
  (and (= o3 (add RNE2 t_pp1 tmp21)) (tqtisFinite (add RNE2 t_pp1 tmp21))))
