...
(declare-fun temp___1327 () us_rep1)

(declare-fun temp___1326 () (_ BitVec 16))

(declare-fun temp___1325 () us_rep)
...
;; H
  (assert (= temp___1327 (mk___rep1 u__split_discrs u__split_fields2)))

;; H
  (assert (= temp___1326 current_borrow))

;; H
  (assert
  (= temp___1325 (mk___rep quotient__split_discrs quotient__split_fields2)))

;; H
  (assert (= temp___1324 q_hat))

;; H
  (assert (= temp___1323 j1))
...
;; H
  (assert (dynamic_property2 1 last3 r142b))
...
;; H
  ...
  (<= (to_rep2
      ...
      (rt
      (rec__aco__math__very_longs__very_long__long_digits
      remainder__split_fields3)))) temp___1334)
  (<= temp___1334 (to_rep2
                  (last1
                  (rt
                  (rec__aco__math__very_longs__very_long__long_digits
                  remainder__split_fields3))))))
  (=> (<= divisor_index2 temp___1334)
  (= (select (elts
             (rec__aco__math__very_longs__very_long__long_digits
             remainder__split_fields3)) temp___1334) (select (elts
                                                             (rec__aco__math__very_longs__very_long__long_digits
                                                             remainder__split_fields2)) temp___1334))))))
