...
(define-fun map__ref_2__projection ((a map__ref1)) us_rep3 (map__content1 a))
...
;; length__post_axiom
  ...
  (! (let ((result (length1 container)))
     ...
     (dynamic_invariant6 result true false true))) :pattern ((length1
                                                             container)) )))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant3 key2 true true true)
     ...
     (and
     (=> (< 0 result)
     (and (<= result (length container)) (= key2 (get container result))))
...
;; has_key__post_axiom
  ...
  (! (=> (dynamic_invariant7 key2 true true true)
     ...
     (=>
     (exists ((k Int))
     (and (and (in_range4 k) (= (has_key container k) true)) (= k key2)))
...
;; length__post_axiom
  (assert
  (forall ((container us_rep3)) (! (dynamic_invariant6 (length3 container)
...
(define-fun dynamic_invariant9 ((temp___expr_411 Int)
...
;; H
  ...
  (= (get (keys s) (get1 (positions s) i)) (get temp___444 temp___443))))))))
...
(assert
;; WP_parameter_def
 ;; File "use_maps.ads", line 143, characters 0-0
