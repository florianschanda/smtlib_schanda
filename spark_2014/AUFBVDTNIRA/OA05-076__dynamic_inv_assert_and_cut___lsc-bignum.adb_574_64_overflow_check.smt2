...
;; H
  (assert
  (and (= o46 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o46 ((_ int2bv 32) 1))))
...
;; H
  (assert (and (= o47 (oadd o45 o46)) (oadd__function_guard o47 o45 o46)))
...
;; H
  (assert (and (= o48 (ole o44 o47)) (ole__function_guard o48 o44 o47)))
...
;; H
  (assert (and (= o39 (oexpon o38 j3)) (oexpon__function_guard o39 o38 j3)))

;; H
  (assert
  (and (= o33 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o33 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o32 (from_integer j3)) (from_integer__function_guard o32 j3)))

;; H
  (assert
  (and (= o34 (osubtract o32 o33)) (osubtract__function_guard o34 o32 o33)))

;; H
  (assert
  (and (= o31 (from_word64 i2)) (from_word64__function_guard o31 i2)))

;; H
  (assert
  (and (= o35 (osubtract o31 o34)) (osubtract__function_guard o35 o31 o34)))
...
;; H
  (assert
  (and (= o36 (oexpon__2 o30 o35)) (oexpon__2__function_guard o36 o30 o35)))
...
;; H
  (assert
  (and (= o29 (num_of_big_int e e_first o28)) (num_of_big_int__function_guard
  o29 e e_first o28)))

;; H
  (assert
  (and (= o37 (odivide o29 o36)) (odivide__function_guard o37 o29 o36)))

;; H
  (assert (and (= o40 (omod o37 o39)) (omod__function_guard o40 o37 o39)))
...
;; H
  (assert
  (and (= o17 (from_word32 w2)) (from_word32__function_guard o17 w2)))

;; H
  (assert
  (and (= o24 (omultiply o17 o23)) (omultiply__function_guard o24 o17 o23)))

;; H
  (assert (and (= o41 (oeq o24 o40)) (oeq__function_guard o41 o24 o40)))
...
;; H
  (assert
  (and (= o16 (num_of_big_int m m_first o15)) (num_of_big_int__function_guard
  o16 m m_first o15)))
