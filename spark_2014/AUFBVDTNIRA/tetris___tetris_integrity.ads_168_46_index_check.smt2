...
(declare-fun to_rep1 (px_coord) Int)
...
;; range_axiom
  (assert
  (forall ((x px_coord)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
(declare-fun to_rep2 (py_coord) Int)
...
;; range_axiom
  (assert
  (forall ((x py_coord)) (! (in_range4 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
(define-fun bool_eq6 ((a map1) (a__first Int) (a__last Int) (a__first_2 Int)
...
(declare-datatypes ()
((map__ref1 (mk_map__ref1 (map__content1 (Array Int map1))))))
...
(declare-fun concat1 ((Array Int map1) Int Int (Array Int map1) Int
  Int) (Array Int map1))
...
(declare-fun singleton1 (map1 Int) (Array Int map1))
...
(define-fun bool_eq7 ((a (Array Int map1)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq6 (select a temp___idx_136) 0 3 0 3
...
;; bool_eq_rev
  ...
  (= (bool_eq6 (get1 a temp___idx_223 temp___idx_224) 0 2 0 2
...
(define-fun dynamic_invariant3 ((temp___expr_532 Int)
  ...
  (temp___do_toplevel_531 Bool)) Bool (=>
                                      ...
                                      (<= 1 10)) (in_range7 temp___expr_532)))
...
(define-fun dynamic_invariant4 ((temp___expr_538 Int)
  ...
  (temp___do_toplevel_537 Bool)) Bool (=>
                                      ...
                                      (<= 1 50)) (in_range8 temp___expr_538)))
...
;; H
  (assert
  (not (= (to_rep (rec__tetris_integrity__piece__s (us_split_fields1 p))) 2)))

;; H
  (assert
  (not (= (to_rep (rec__tetris_integrity__piece__s (us_split_fields1 p))) 1)))
...
;; WP_parameter_def
 ;; File "tetris_integrity.ads", line 157, characters 0-0
  (not
  (<= 3 (to_rep (rec__tetris_integrity__piece__s (us_split_fields1 p))))))
(check-sat)
