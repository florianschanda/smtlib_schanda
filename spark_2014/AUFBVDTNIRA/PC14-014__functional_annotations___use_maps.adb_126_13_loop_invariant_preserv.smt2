...
;; H
  (assert
  (let ((temp___913 (keys (mk___rep s1__split_discrs s1__split_fields4))))
...
;; H
  (assert
  (and (= temp___9041 (next s2 (mk___rep1 cu__split_fields4)))
  ...
  (= (bool_eq4 temp___9041 no_element) true)
...
;; H
  (assert (= cu__split_fields3 (mk___split_fields1 temp___904)))
...
(define-fun temp___913 () us_rep3 (keys
                                  (mk___rep s1__split_discrs
                                  s1__split_fields3)))
...
;; H
  (assert (in_range5 temp___912))

;; H
  (assert (= (iter_has_element temp___913 temp___912) true))
...
;; WP_parameter_def
 ;; File "use_maps.ads", line 75, characters 0-0
  (not
  (= (prop__
     (get (model__ (mk___rep s1__split_discrs s1__split_fields3))
     (get1 temp___913 temp___912))) true)))
(check-sat)
