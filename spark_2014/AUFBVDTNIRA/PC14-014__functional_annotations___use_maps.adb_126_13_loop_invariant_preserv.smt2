...
(declare-fun temp___959 () count_type)
...
(define-fun s1__split_fields3 () us_split_fields (mk___split_fields
                                                 s1__split_fields2))

(define-fun cu__split_fields4 () us_split_fields2 (mk___split_fields1
                                                  cu__split_fields2))

(define-fun s1__split_fields4 () us_split_fields (mk___split_fields
                                                 s1__split_fields1))

(define-fun cu__split_fields5 () us_split_fields2 (mk___split_fields1
                                                  cu__split_fields1))

(define-fun temp___9591 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___959)))
...
;; H
  ...
  (=>
  (and (in_range5 temp___992)
  (= (iter_has_element temp___993 temp___992) true))
  (= (prop__
     (get
     (model__
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
     (get1 temp___993 temp___992))) true))))
  (let ((temp___996 (keys s2)))
  (forall ((temp___995 Int))
  (=>
  (and (in_range5 temp___995)
  (= (iter_has_element temp___996 temp___995) true))
  (= (prop__ (get (model__ s2) (get1 temp___996 temp___995))) true)))))
  (< (length s2) (- (to_rep
...
;; H
  ...
  (= (bool_eq4 use_maps__union_prop__cu__assume1 no_element) true)
...
;; H
  (assert
  (and (= result1 (has_key1 (positions s2) (mk___rep1 cu__split_fields5)))
  (= (= result1 true)
  (= (has_key1 (positions s2) (mk___rep1 cu__split_fields5)) true))))
...
;; H
  (assert
  (forall ((k Int)) (prop____function_guard
  (prop__ (get (model__ (mk___rep s1__split_discrs s1__split_fields4)) k))
  (get (model__ (mk___rep s1__split_discrs s1__split_fields4)) k))))

;; H
  (assert
  (< (length (mk___rep s1__split_discrs s1__split_fields4)) (+ (length
                                                               (mk___rep
                                                               s1__split_discrs
                                                               (mk___split_fields
                                                               s1__split_fields))) 
  (get2 (positions s2) (mk___rep1 cu__split_fields4)))))

;; H
  (assert
  (let ((temp___969 (keys (mk___rep s1__split_discrs s1__split_fields4))))
  (forall ((temp___968 Int))
  (=>
  (and (in_range5 temp___968)
  (= (iter_has_element temp___969 temp___968) true))
  (= (prop__
     (get (model__ (mk___rep s1__split_discrs s1__split_fields4))
     (get1 temp___969 temp___968))) true)))))

;; H
  (assert (= (has_key1 (positions s2) (mk___rep1 cu__split_fields4)) true))

;; H
  (assert
  (and (= o1 (element s2 (mk___rep1 cu__split_fields4)))
  (and (in_range9 o1)
  (= o1 (get (model__ s2) (key s2 (mk___rep1 cu__split_fields4)))))))

;; H
  (assert
  (and (= o (key s2 (mk___rep1 cu__split_fields4)))
  (and (in_range8 o)
  (= o (get1 (keys s2) (get2 (positions s2) (mk___rep1 cu__split_fields4)))))))

;; H
  (assert
  (and
  (and
  (= (has_key (model__ (mk___rep s1__split_discrs s1__split_fields3)) o) true)
  (= (get (model__ (mk___rep s1__split_discrs s1__split_fields3)) o) 
  o1))
  (ite (= (has_key (model__ (mk___rep s1__split_discrs s1__split_fields4)) o) true)
  (and
  (and
  (and
  (and
  (= (oeq3 (positions (mk___rep s1__split_discrs s1__split_fields3))
     (positions (mk___rep s1__split_discrs s1__split_fields4))) true)
  (= (get1 (keys (mk___rep s1__split_discrs s1__split_fields3))
     (get2 (positions (mk___rep s1__split_discrs s1__split_fields3))
     (find1 (mk___rep s1__split_discrs s1__split_fields3) o))) o))
  (= (equal_except (keys (mk___rep s1__split_discrs s1__split_fields4))
     (keys (mk___rep s1__split_discrs s1__split_fields3))
     (get2 (positions (mk___rep s1__split_discrs s1__split_fields3))
     (find1 (mk___rep s1__split_discrs s1__split_fields3) o))) true))
  (= (same_keys (model__ (mk___rep s1__split_discrs s1__split_fields3))
     (model__ (mk___rep s1__split_discrs s1__split_fields4))) true))
  (= (elements_equal_except
     (model__ (mk___rep s1__split_discrs s1__split_fields3))
     (model__ (mk___rep s1__split_discrs s1__split_fields4)) o) true))
  (and
  (and
  (and
  (and
  ...
  (= (length (mk___rep s1__split_discrs s1__split_fields3)) (+ (length
                                                               ...
                                                               s1__split_discrs
                                                               s1__split_fields4)) 1))
  (= (ole (model__ (mk___rep s1__split_discrs s1__split_fields4))
     (model__ (mk___rep s1__split_discrs s1__split_fields3))) true))
  ...
  (= (get1 (keys (mk___rep s1__split_discrs s1__split_fields3))
     (get2 (positions (mk___rep s1__split_discrs s1__split_fields3))
     (find1 (mk___rep s1__split_discrs s1__split_fields3) o))) o))
  (= (mapping_preserved (keys (mk___rep s1__split_discrs s1__split_fields4))
     (keys (mk___rep s1__split_discrs s1__split_fields3))
     (positions (mk___rep s1__split_discrs s1__split_fields4))
     (positions (mk___rep s1__split_discrs s1__split_fields3))) true))
...
;; H
  (assert
  (and (= temp___9591 (next s2 (mk___rep1 cu__split_fields4)))
  (ite (= (ite (= (bool_eq4 (mk___rep1 cu__split_fields4) no_element) false) (= 
          (get2 (positions s2) (mk___rep1 cu__split_fields4)) (length s2)) true) true)
  (= (bool_eq4 temp___9591 no_element) true)
  (and (= (has_key1 (positions s2) temp___9591) true)
  (= (get2 (positions s2) temp___9591) (+ (get2 (positions s2)
...
;; H
  (assert (= cu__split_fields3 (mk___split_fields1 temp___959)))

;; H
  (assert
  (and (= o2 (has_key1 (positions s2) (mk___rep1 cu__split_fields3)))
  (= (= o2 true)
...
(define-fun temp___969 () us_rep3 (keys
                                  (mk___rep s1__split_discrs
                                  s1__split_fields3)))
...
;; H
  (assert (in_range5 temp___968))

;; H
  (assert (= (iter_has_element temp___969 temp___968) true))

(define-fun k () Int (get1 temp___969 temp___968))

;; H
  (assert (prop____function_guard
  (prop__ (get (model__ (mk___rep s1__split_discrs s1__split_fields3)) k))
  (get (model__ (mk___rep s1__split_discrs s1__split_fields3)) k)))

(assert
;; WP_parameter_def
 ;; File "use_maps.ads", line 75, characters 0-0
  (not
  (= (prop__ (get (model__ (mk___rep s1__split_discrs s1__split_fields3)) k)) true)))
(check-sat)
