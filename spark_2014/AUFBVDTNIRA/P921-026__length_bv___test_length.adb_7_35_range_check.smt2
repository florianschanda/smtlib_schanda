...
(declare-fun dummy () short_short_integer)

(declare-datatypes ()
((short_short_integer__ref
 (mk_short_short_integer__ref
 (short_short_integer__content short_short_integer)))))
(define-fun short_short_integer__ref___projection ((a short_short_integer__ref)) short_short_integer 
  (short_short_integer__content a))

(define-fun dynamic_invariant ((temp___expr_3 Int) (temp___is_init_0 Bool)
  (temp___skip_constant_1 Bool)
  (temp___do_toplevel_2 Bool)) Bool (=>
                                    (or (= temp___is_init_0 true)
                                    (<= (- 128) 127)) (in_range1
                                    temp___expr_3)))
...
(define-fun bool_eq3 ((a (Array (_ BitVec 16) natural))
...
(declare-fun test_length__p1__a__assume () (Array (_ BitVec 16) natural))

(declare-fun test_length__p1__a__assume1 () t)
...
(define-fun test_length__p1__a__assume2 () us_t (mk___t
                                                test_length__p1__a__assume
                                                test_length__p1__a__assume1))

;; H
  (assert
  (and
  (and (= test_length__p1__a__assume2 (create ((_ int2bv 16) 65535)))
  (create__function_guard test_length__p1__a__assume2 ((_ int2bv 16) 65535)))
  (and (dynamic_invariant2 test_length__p1__a__assume2 true false true)
  (and (= (to_rep (first test_length__p1__a__assume1)) ((_ int2bv 16) 0))
  (= (to_rep (last test_length__p1__a__assume1)) ((_ int2bv 16) 65535))))))
...
;; H
  (assert
  (=> (<= (bv2nat (to_rep a__first)) (bv2nat (to_rep a__last)))
  (= o (+ (- (bv2nat (to_rep a__last)) (bv2nat (to_rep a__first))) 1))))

;; H
  (assert
  (=> (not (<= (bv2nat (to_rep a__first)) (bv2nat (to_rep a__last))))
  (= o 0)))

(assert
;; WP_parameter_def
 ;; File "test_length.adb", line 2, characters 0-0
  (not (in_range1 o)))
(check-sat)
