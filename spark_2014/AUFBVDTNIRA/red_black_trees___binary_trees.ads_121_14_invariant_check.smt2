...
(declare-fun temp___1034 () us_rep3)
...
(declare-fun temp___1039 () us_rep3)
...
;; H
  (assert (model____function_guard (model__ (mk___rep2 f__split_fields6) v1)
  (mk___rep2 f__split_fields6) v1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__ (mk___rep2 f_old__split_fields2) root) i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__ (mk___rep2 f_old__split_fields2) root) v1)))
  (rec__tree_model__path_type__a
...
;; H
  (assert (=> (not (= v1 0)) (=> (= d 0) (= temp___1027 o11))))

;; H
  (assert (=> (not (= v1 0)) (=> (= d 0) (= temp___10271 o12))))
...
;; H
  ...
  (=> (not (= v1 0))
  (=> (= d 0)
  (= f__split_fields3 (mk___split_fields2 temp___1027 temp___10271)))))
...
;; H
  (assert (=> (not (= v1 0)) (=> (not (= d 0)) (= temp___1022 o23))))

;; H
  (assert (=> (not (= v1 0)) (=> (not (= d 0)) (= temp___10221 o24))))
...
;; H
  ...
  (=> (not (= v1 0))
  (=> (not (= d 0))
  (= f__split_fields4 (mk___split_fields2 temp___1022 temp___10221)))))
...
;; H
  (assert
  (=> (not (= v1 0))
  (= temp___1034 (mk___rep2 (mk___split_fields2 o36 o37)))))
...
;; H
  (assert
  (=> (not (= v1 0)) (= f__split_fields5 (us_split_fields5 temp___1034))))
...
;; H
  (assert (=> (not (= v1 0)) (= temp___1039 (mk___rep2 o43))))
...
;; H
  (assert
  (=> (not (= v1 0)) (= f__split_fields6 (us_split_fields5 temp___1039))))
...
;; H
  (assert
  (=> (not (= v1 0))
  (and (type_invariant (mk___rep2 f__split_fields6)) (type_invariant
