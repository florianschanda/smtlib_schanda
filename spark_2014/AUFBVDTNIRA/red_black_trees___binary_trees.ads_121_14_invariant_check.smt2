...
(declare-fun temp___708 () extended_index_type)

(declare-fun temp___7081 () (Array Int us_rep2))
...
(declare-fun temp___703 () extended_index_type)

(declare-fun temp___7031 () (Array Int us_rep2))

(declare-fun o25 () position_type)
...
(declare-fun o32 () extended_index_type)

(declare-fun o33 () position_type)

(declare-fun o34 () Int)

(declare-fun o35 () (Array Int us_rep2))

(declare-fun o36 () extended_index_type)

(declare-fun o37 () (Array Int us_rep2))

(declare-fun temp___715 () us_rep3)

(declare-fun o38 () extended_index_type)

(declare-fun o39 () us_split_fields2)

(declare-fun o40 () us_rep2)

(declare-fun o41 () Int)

(declare-fun o42 () (Array Int us_rep2))

(declare-fun o43 () us_split_fields4)

(declare-fun temp___720 () us_rep3)
...
;; H
  ...
  (=> (not (= v1 0))
  (=> (= d 0)
  (= f__split_fields3 (mk___split_fields2 temp___708 temp___7081)))))
...
;; H
  (assert
  (=> (not (= v1 0)) (=> (not (= d 0)) (= result3 f__split_fields9))))

;; H
  (assert
  (=> (not (= v1 0))
  (=> (not (= d 0))
  (= f__split_fields4 (mk___split_fields2 temp___703 temp___7031)))))

;; H
  (assert
  (=> (not (= v1 0))
  (=> (not (= d 0)) (= f__split_fields3 f__split_fields4))))
...
;; H
  ...
  (= (to_rep
     (rec__binary_trees__cell__parent
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields3) v1)))) i)))
...
;; H
  ...
  (= (rec__binary_trees__cell__left
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields3) v1))) o26)))
...
;; H
  ...
  (= (rec__binary_trees__cell__right
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields3) v1))) o27)))
...
;; H
  ...
  (= (rec__binary_trees__cell__parent
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields3) v1))) o28)))
...
;; H
  (assert
  (=> (not (= v1 0))
  (= o35 (store (rec__binary_trees__forest__c f__split_fields3) o34 (mk___rep1
                                                                    (mk___split_fields1
                                                                    o30 
                                                                    o31 
                                                                    o32 
...
;; H
  (assert
  (=> (not (= v1 0)) (= (rec__binary_trees__forest__s f__split_fields3) o36)))
...
;; H
  (assert
  (=> (not (= v1 0)) (= temp___715 (mk___rep2 (mk___split_fields2 o36 o37)))))

;; H
  (assert
  (=> (not (= v1 0)) (= result4 (mk___split_fields__ref2 f__split_fields3))))

;; H
  (assert
  (=> (not (= v1 0)) (= f__split_fields5 (us_split_fields5 temp___715))))
...
;; H
  ...
  (= o39 (mk___split_fields1
         (rec__binary_trees__cell__left
         (us_split_fields3
         (select (rec__binary_trees__forest__c f__split_fields5) v1)))
         (rec__binary_trees__cell__right
         (us_split_fields3
         (select (rec__binary_trees__forest__c f__split_fields5) v1))) 
         o38
...
;; H
  (assert
  (=> (not (= v1 0))
  (= o42 (store (rec__binary_trees__forest__c f__split_fields5) o41 o40))))

;; H
  (assert
  (=> (not (= v1 0))
  (= o43 (mk___split_fields2 (rec__binary_trees__forest__s f__split_fields5)
         o42))))
...
;; H
  (assert
  (=> (not (= v1 0)) (= result5 (mk___split_fields__ref2 f__split_fields5))))

;; H
  (assert
  (=> (not (= v1 0)) (= f__split_fields6 (us_split_fields5 temp___720))))
...
;; H
  (assert
  (=> (not (= v1 0))
  (and (= (tree_structure (mk___rep2 f__split_fields6)) true)
  (= (tree_structure (mk___rep2 f_old__split_fields2)) true))))
...
;; H
  ...
  (ite (= (ole
          (rec__tree_model__path_type__a
          (us_split_fields1
          (select (model__ (mk___rep2 f_old__split_fields2) root) v1)))
          (rec__tree_model__path_type__a
          (us_split_fields1
          (select (model__ (mk___rep2 f_old__split_fields2) root) i1)))) true)
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) v1) i1))) true)
  (= (rec__tree_model__path_type__k
     (us_split_fields1
  ...
  (= (is_concat
     ...
     (select (model__ (mk___rep2 f_old__split_fields2) root) v1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) v1) i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__ (mk___rep2 f_old__split_fields2) root) i1)))) true))))
  (forall ((r Int))
