...
(declare-fun r7b () (Array Int natural))
...
;; def_axiom
  ...
  (= (select (rename_aggregate__a__aggregate_def temp___191) temp___192) 
  (of_rep temp___191)))))
...
;; def_axiom
  ...
  (= (select (rename_aggregate__R7b__aggregate_def temp___194) temp___195) 
  (of_rep temp___194)))))
...
(declare-fun c10b1 () Int)

(declare-fun c10b2 () Int)

;; H
  (assert (= o (rename_aggregate__a__aggregate_def 0)))
...
;; H
  (assert
  (= (rename_aggregate__R7b__aggregate_def (to_rep (select a1 1))) r7b))

;; H
  (assert (= (to_rep o1) 1))

;; H
  (assert (= o2 (store a1 1 o1)))
...
;; H
  (assert (and (<= 1 c10b2) (<= c10b2 100)))

(assert
;; WP_parameter_def
 ;; File "rename_aggregate.adb", line 1, characters 0-0
  (not (= (to_rep (select r7b c10b2)) 1)))
(check-sat)
