...
;; H
  (assert (num_of_boolean__function_guard
  (num_of_boolean (bool__content carry8)) (bool__content carry8)))
...
;; H
  ...
  (num_of_boolean (bool__content carry8)))
  (oexpon (base Tuple0) (+ (- a_last a_first) 1))
  (num_of_boolean (bool__content carry8))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  ...
  (= (oeq
     ...
     a_first (+ (- a_last a_first) 1))
     (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1))
     (num_of_boolean (bool__content carry8))))) true)))
(check-sat)
