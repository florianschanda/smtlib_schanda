...
(define-fun o12 () us_t (mk___t o6 o7))
...
;; H
  (assert
  (and (= o8 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))))
...
;; H
  (assert
  (and (and (= o12 (remove a o5)) (remove__function_guard o12 a o5))
  (and (dynamic_invariant2 o12 true false true)
  (and (= (invariant__ o12) true)
  (and (= (to_rep2 (last o7)) (- (to_rep2 (last (rt a))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o5 1)))
  (= (to_rep (select (elts a) k)) (to_rep (select o6 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o5 1) k) (<= k (to_rep2 (last (rt a)))))
  (= (to_rep (select (elts a) k)) (to_rep (select o6 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o5 k) (<= k (- (to_rep2 (last (rt a))) 1)))
  (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o6 k))))))))))))

;; H
  (assert
  (and (and (= o11 (remove o12 o8)) (remove__function_guard o11 o12 o8))
  (and (dynamic_invariant2 o11 true false true)
  (and (= (invariant__ o11) true)
  (and (= (to_rep2 (last o10)) (- (to_rep2 (last o7)) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o8 1)))
  (= (to_rep (select o6 k)) (to_rep (select o9 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o8 1) k) (<= k (to_rep2 (last o7))))
  (= (to_rep (select o6 k)) (to_rep (select o9 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o8 k) (<= k (- (to_rep2 (last o7)) 1)))
  (= (to_rep (select o6 (+ k 1))) (to_rep (select o9 k))))))))))))
