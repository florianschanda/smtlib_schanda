...
(declare-fun arr () (Array Int natural))
...
(declare-fun arr1 () (Array Int natural))
...
(declare-fun arr2 () (Array Int natural))
...
;; H
  (assert
  (=> (< (to_rep (select arr n1)) 2147483647)
  (and (= o (+ (to_rep (select arr n1)) 1)) (in_range1
  (+ (to_rep (select arr n1)) 1)))))
...
;; H
  (assert
  (=> (< (to_rep (select arr n1)) 2147483647) (= o2 (store arr n1 o1))))
...
;; WP_parameter_def
 ;; File "loop_related_legal.adb", line 17, characters 0-0
  (not (<= (to_rep (select arr i)) (to_rep (select arr2 i)))))
(check-sat)
