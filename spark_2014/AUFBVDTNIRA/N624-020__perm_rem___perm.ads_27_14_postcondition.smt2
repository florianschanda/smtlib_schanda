...
;; WP_parameter_def
 ;; File "perm.ads", line 2, characters 0-0
  (not
  (= (let ((temp___569 (remove b i)))
     (let ((temp___568 (remove a i)))
     (bool_eq3 (elts temp___568) (to_rep1 (first (rt temp___568)))
     (to_rep1 (last (rt temp___568))) (elts temp___569)
     (to_rep1 (first (rt temp___569))) (to_rep1 (last (rt temp___569)))))) true)))
(check-sat)
