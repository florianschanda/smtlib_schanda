...
(declare-fun temp___193 () index)

(declare-fun temp___1931 () (Array Int value))

(declare-fun temp___1932 () (Array Int value))
...
(assert
;; WP_parameter_def
 ;; File "arrays_in_records.adb", line 26, characters 0-0
  (not (= (to_rep (select a__split_fields7 17)) 23)))
(check-sat)
