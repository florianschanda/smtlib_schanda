...
;; H
  (assert (= o49 (select temp___2277 o48)))
...
;; H
  (assert (= o45 (select temp___2276 ki1)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2275 o41))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2275 o41)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i o41))
...
;; H
  (assert (= o42 (select temp___2275 ki1)))
...
;; H
  (assert (= o37 (select temp___2272 o36)))
