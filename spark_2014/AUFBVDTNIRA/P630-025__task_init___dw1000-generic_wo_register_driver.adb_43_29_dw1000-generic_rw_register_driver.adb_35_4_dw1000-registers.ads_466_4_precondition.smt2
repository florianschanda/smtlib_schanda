...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__tc_pgdelay_type__tc_pgdelay bits_8)))))
(define-fun us_split_fields_TC_PGDELAY__projection ((a us_split_fields)) bits_8 
  (rec__dw1000__register_types__tc_pgdelay_type__tc_pgdelay a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_62__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_62__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq5 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep1
                           (rec__dw1000__register_types__tc_pgdelay_type__tc_pgdelay
...
(declare-fun dw1000__register_types__tc_pgdelay_type__tc_pgdelay__first__bit () Int)

(declare-fun dw1000__register_types__tc_pgdelay_type__tc_pgdelay__last__bit () Int)

(declare-fun dw1000__register_types__tc_pgdelay_type__tc_pgdelay__position () Int)

;; dw1000__register_types__tc_pgdelay_type__tc_pgdelay__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__tc_pgdelay_type__tc_pgdelay__first__bit))

;; dw1000__register_types__tc_pgdelay_type__tc_pgdelay__last__bit_axiom
  (assert
  (< dw1000__register_types__tc_pgdelay_type__tc_pgdelay__first__bit 
  dw1000__register_types__tc_pgdelay_type__tc_pgdelay__last__bit))

;; dw1000__register_types__tc_pgdelay_type__tc_pgdelay__position_axiom
  (assert
  (<= 0 dw1000__register_types__tc_pgdelay_type__tc_pgdelay__position))

(declare-fun dummy4 () us_rep)

(declare-datatypes ()
((tc_pgdelay_type__ref
 (mk_tc_pgdelay_type__ref (tc_pgdelay_type__content us_rep)))))
(define-fun tc_pgdelay_type__ref___projection ((a tc_pgdelay_type__ref)) us_rep 
  (tc_pgdelay_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_145__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_103__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_103__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5457 us_t1)
  (temp___is_init_5454 Bool) (temp___skip_constant_5455 Bool)
  (temp___do_toplevel_5456 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5455 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5457)
                                       (last4 temp___expr_5457))
                                       (and (= (first3 temp___expr_5457) 1)
                                       (= (last4 temp___expr_5457) 1)))))
...
(define-fun target__ref_43__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_43__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_5473 us_t2)
  (temp___is_init_5470 Bool) (temp___skip_constant_5471 Bool)
  (temp___do_toplevel_5472 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5471 true))
                                       (and (dynamic_property3 1 1
                                       (first5 temp___expr_5473)
                                       (last6 temp___expr_5473))
                                       (and (= (first5 temp___expr_5473) 1)
                                       (= (last6 temp___expr_5473) 1)))))
...
(declare-fun temp___7877 () (Array Int bits_8))

(declare-fun temp___78771 () t2)

(declare-fun temp___7878 () (Array Int bits_8))

(declare-fun temp___78781 () t1)
...
;; H
  (assert
  (and
  (and (= temp___78772 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___78772 reg)) (dynamic_invariant1
  temp___78772 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___78771)) (to_rep (last5 temp___78771)))
     (+ (- (to_rep (last5 temp___78771)) (to_rep (first4 temp___78771))) 1)
     0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78771)) (to_rep (last5 temp___78771))) 
  temp___78781))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___78781)) (to_rep (last3 temp___78781)))
     (+ (- (to_rep (last3 temp___78781)) (to_rep (first2 temp___78781))) 1)
