...
;; H
  (assert (=> (and (<= 0 j1) (<= j1 7)) (and (<= 0 j2) (<= j2 7))))

;; H
  (assert (=> (and (<= 0 j1) (<= j1 7)) (= j2 7)))

;; H
  (assert (=> (and (<= 0 j1) (<= j1 7)) (= j2 j3)))

;; H
  (assert (=> (and (<= 0 j1) (<= j1 7)) (= j4 j2)))

;; H
  (assert
  (=> (and (<= 0 j1) (<= j1 7)) (= (mk_int__ref j5) (mk_int__ref j3))))

;; H
  (assert (=> (and (<= 0 j1) (<= j1 7)) (= j6 j4)))

;; H
  (assert (=> (not (and (<= 0 j1) (<= j1 7))) (= j1 j5)))

;; H
  (assert (=> (not (and (<= 0 j1) (<= j1 7))) (= j6 j1)))
