...
(declare-fun temp___1133 () (Array Int octet))

(declare-fun temp___11331 () t2)
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___1126 ((_ int2bv 8) 0) 1 r9b)))) 1))

;; H
  (assert
  (= (to_rep2 (last7 (rt2 (temp___1126 ((_ int2bv 8) 0) 1 r9b)))) r9b))

;; H
  (assert
  (= (mk___t2 temp___1133 temp___11331) (temp___1126 ((_ int2bv 8) 0) 1 r9b)))

(assert
;; WP_parameter_def
 ;; File "very_longs.adb", line 33, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first4 temp___11331)) (to_rep2 (last7 temp___11331)))
     (+ (- (to_rep2 (last7 temp___11331)) (to_rep2 (first4 temp___11331))) 1)
