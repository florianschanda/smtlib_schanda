...
(declare-fun tokenreader__makedescription__setresultstring__fullstring__assume () (Array Int character))

(declare-fun tokenreader__makedescription__setresultstring__fullstring__assume1 () t)
...
;; WP_parameter_def
 ;; File "audittypes.ads", line 92, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first (rt fullstring))) (to_rep1
                                                (last (rt fullstring))))
     (+ (- (to_rep1 (last (rt fullstring))) (to_rep1 (first (rt fullstring)))) 1)
     0) (ite (<= 1 (to_rep1 (last (rt fullstring))))
        (+ (- (to_rep1 (last (rt fullstring))) 1) 1) 0))))
(check-sat)
