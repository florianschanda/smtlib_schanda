...
(declare-fun safety_pack__saturate__result () t)
...
(declare-fun safety_pack__saturate__result1 () t)

(declare-fun safety_pack__saturate__result2 () t)

(declare-fun safety_pack__saturate__result3 () t)

(declare-fun res4 () t)

(declare-fun safety_pack__saturate__result4 () t)

(declare-fun res5 () t)

(declare-fun safety_pack__saturate__result5 () t)
...
;; H
  (assert (tqtisFinite min_value))

;; H
  (assert (tqtisFinite max_value))
...
;; H
  (assert (=> (lt value min_value) (= result1 res1)))

;; H
  (assert (=> (lt value min_value) (= res2 min_value)))

;; H
  (assert
  (=> (not (lt value min_value)) (=> (lt max_value value) (= result2 res1))))

;; H
  (assert
  (=> (not (lt value min_value))
  (=> (lt max_value value) (= res3 max_value))))

;; H
  (assert
  (=> (not (lt value min_value))
  (=> (not (lt max_value value)) (= res3 res1))))

;; H
  (assert (=> (not (lt value min_value)) (= res2 res3)))
...
;; H
  (assert (lt value min_value))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (eq safety_pack__saturate__result4 min_value)))
(check-sat)
