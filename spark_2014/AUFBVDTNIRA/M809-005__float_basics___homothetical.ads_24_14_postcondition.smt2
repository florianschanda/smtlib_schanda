...
;; H
  ...
  (=> (and (<= 1 j15) (<= j15 2))
  (and
  (and (neq (to_rep (select d j15)) fliteral2) (lt fliteral2
  (to_rep (select kv j15)))) (lt fliteral2 (to_rep (select ka j15)))))))
...
;; H
  ...
  (=> (and (<= 1 i13) (<= i13 2))
  (and
  (and (lt fliteral2 (to_rep (select ka i13))) (neq
  (to_rep (select kvp2 i13)) fliteral2)) (neq (to_rep (select d i13))
  fliteral2)))))
...
;; H
  ...
  (=> (not (= i4 j4))
  (and
  (= o4 (mul RNE2 (to_rep (select kvp2 i4)) (abs1 (to_rep (select d j4)))))
  (tqtisFinite
  (mul RNE2 (to_rep (select kvp2 i4)) (abs1 (to_rep (select d j4))))))))))
...
;; H
  ...
  (=> (not (= i4 j4))
  (and
  (= o3 (mul RNE2 (to_rep (select kvp2 j4)) (abs1 (to_rep (select d i4)))))
  (tqtisFinite
  (mul RNE2 (to_rep (select kvp2 j4)) (abs1 (to_rep (select d i4))))))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (= o5 (div1 RNE2 o3 o4))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (and (= o6 o5) (tqtisFinite o5))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (= o7 (min (to_rep (select lambda3 i4)) o6))))))
...
;; H
  ...
  (=> (not (= i4 j4))
  (and
  (= o11 (mul RNE2 (to_rep (select ka i4)) (abs1 (to_rep (select d j4)))))
  (tqtisFinite
  (mul RNE2 (to_rep (select ka i4)) (abs1 (to_rep (select d j4))))))))))
...
;; H
  ...
  (=> (not (= i4 j4))
  (and
  (= o10 (mul RNE2 (to_rep (select ka j4)) (abs1 (to_rep (select d i4)))))
  (tqtisFinite
  (mul RNE2 (to_rep (select ka j4)) (abs1 (to_rep (select d i4))))))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (= o12 (div1 RNE2 o10 o11))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (and (= o13 o12) (tqtisFinite o12))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (= o14 (min (to_rep (select upsilon3 i4)) o13))))))
...
;; H
  ...
  (=> (and (<= 1 i3) (<= i3 2))
  (and
  (= o17 (mul RNE2 (to_rep (select (map__content lambda9) i4))
         (to_rep (select kvp2 i4))))
  (tqtisFinite
  (mul RNE2 (to_rep (select (map__content lambda9) i4))
  (to_rep (select kvp2 i4)))))))
...
;; H
  ...
  (=> (and (<= 1 i3) (<= i3 2))
  (and
  (= o20 (mul RNE2 (to_rep (select (map__content upsilon9) i4))
         (to_rep (select ka i4))))
  (tqtisFinite
  (mul RNE2 (to_rep (select (map__content upsilon9) i4))
  (to_rep (select ka i4)))))))
...
;; WP_parameter_def
 ;; File "homothetical.ads", line 5, characters 0-0
  (not (lt fliteral2 (to_rep (select (map__content kvmax7) j15)))))
(check-sat)
