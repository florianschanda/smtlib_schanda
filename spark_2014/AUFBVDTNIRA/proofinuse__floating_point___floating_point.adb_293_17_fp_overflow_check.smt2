...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral2) 18446742974197923840.0)))
...
(define-fun dynamic_invariant1 ((temp___expr_217 t) (temp___is_init_214 Bool)
...
;; H
  (assert (le fliteral3 a))

;; H
  (assert (le fliteral3 b))
