...
(declare-fun temp___578 () (Array Int element))

(declare-fun temp___5781 () t1)
...
;; WP_parameter_def
 ;; File "stackp.ads", line 9, characters 0-0
  (not (dynamic_property 1 2147483647 (to_rep1 (first2 temp___5781))
  (to_rep1 (last3 temp___5781)))))
(check-sat)
