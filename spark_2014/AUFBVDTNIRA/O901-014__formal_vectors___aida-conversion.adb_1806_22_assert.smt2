...
;; H
  (assert
  (and (= temp___2461 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2461)
  (<= temp___2461 (to_rep1 n__last))))

;; H
  (assert (= o56 temp___2461))
