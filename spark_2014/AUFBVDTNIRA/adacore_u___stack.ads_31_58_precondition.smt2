...
(declare-fun get_stack (Int (Array Int element)) us_rep)

(declare-fun get_stack__function_guard (us_rep Int (Array Int element)) Bool)
...
;; get_stack__def_axiom
  ...
  (! (=> (dynamic_invariant1 stack__b_top true true true)
     (= (get_stack stack__b_top stack__b_content) (mk___rep
                                                  (mk___split_fields
                                                  (of_rep1 stack__b_top)
                                                  stack__b_content)))) :pattern (
  (get_stack stack__b_top stack__b_content)) ))))

(declare-fun peek (Int (Array Int element)) Int)

(declare-fun peek__function_guard (Int Int (Array Int element)) Bool)
...
;; peek__post_axiom
  ...
  (forall ((stack__b_content (Array Int element)))
  (! (=>
     (and (dynamic_invariant1 stack__b_top true true true)
     (not (= (is_empty stack__b_top) true))) (dynamic_invariant
     (peek stack__b_top stack__b_content) true false true)) :pattern (
  (peek stack__b_top stack__b_content)) ))))
...
;; peek__def_axiom
  ...
  (forall ((stack__b_content (Array Int element)))
  (! (=> (dynamic_invariant1 stack__b_top true true true)
     (= (peek stack__b_top stack__b_content) (to_rep
...
(declare-fun dummy4 () tTb_contentSP1)
...
(declare-fun b_content () (Array Int element))
...
(declare-fun b_top1 () Int)

(declare-fun b_content1 () (Array Int element))

(declare-fun result () Int)

(declare-fun b_top2 () Int)

(declare-fun result1 () (Array Int element))

(declare-fun b_content2 () (Array Int element))

(declare-fun b_top3 () Int)

(declare-fun b_content3 () (Array Int element))

(declare-fun b_top4 () Int)

(declare-fun b_content4 () (Array Int element))

(declare-fun b_top5 () Int)

(declare-fun b_content5 () (Array Int element))

(declare-fun b_top6 () Int)

(declare-fun b_content6 () (Array Int element))

(define-fun b_content7 () map__ref (mk_map__ref b_content3))

(define-fun b_top7 () int__ref (mk_int__ref b_top3))

(define-fun b_content8 () map__ref (mk_map__ref b_content))

(define-fun b_top8 () int__ref (mk_int__ref b_top))

;; H
  (assert (in_range2 b_top))
...
;; H
  ...
  (or
  (and
  (and (and (= b_content7 b_content8) (= b_top7 b_top8))
  (and (= b_content4 b_content1) (= b_top4 b_top1))) (<= 100 b_top))
  (and (not (<= 100 b_top))
  (and
  (and (and (= b_content2 b_content3) (= b_top2 b_top3))
  (and (= b_content4 b_content2) (= b_top4 b_top2)))
  (and
  (and (and (= o (+ b_top 1)) (in_range2 (+ b_top 1)))
  (and (= (mk_int__ref result) b_top8) (= b_top2 o)))
  (and
  (and (= (to_rep o1) e)
  (and (and (and (<= 1 b_top2) (<= b_top2 100)) (= o2 b_top2))
  (= o3 (store b_content o2 o1))))
  (and (= (mk_map__ref result1) b_content8) (= b_content2 o3))))))))

;; H
  (assert (= (mk_map__ref b_content5) b_content7))

;; H
  (assert (= (mk_int__ref b_top5) b_top7))

;; H
  (assert (= b_content6 b_content4))

;; H
  (assert (= b_top6 b_top4))

;; H
  (assert (not (= (is_full b_top) true)))

(assert
;; WP_parameter_def
 ;; File "stack.ads", line 2, characters 0-0
  (not (not (= (is_empty b_top5) true))))
(check-sat)
