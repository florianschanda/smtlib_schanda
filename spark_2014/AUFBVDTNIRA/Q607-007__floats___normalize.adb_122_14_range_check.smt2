...
(define-fun dynamic_invariant ((temp___expr_135 t) (temp___is_init_132 Bool)
  ...
  (temp___do_toplevel_134 Bool)) Bool (=>
                                      ...
                                      (neg fliteral1) fliteral1)) (in_range1
                                      temp___expr_135)))
...
(declare-fun r3__function_guard (t t) Bool)
...
;; r3__post_axiom
  ...
  (! (=> (and (dynamic_invariant x1 true true true) (le (neg fliteral1) x1))
     ...
     (and (and (le result x1) (le (sub RNE2 x1 fliteral) result))
...
;; r3__def_axiom
  ...
  (! (=>
     ...
     x1)) (= (r3 x1) (roundToIntegral RTN2 x1))) :pattern ((r3 x1)) )))
...
(define-fun dynamic_invariant2 ((temp___expr_147 t) (temp___is_init_144 Bool)
  ...
  (temp___do_toplevel_146 Bool)) Bool (=>
                                      ...
                                      (neg fliteral3) fliteral4)) (in_range3
                                      temp___expr_147)))
...
;; H
  (assert (=> (le (neg fliteral1) fliteral1) (in_range1 v1)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (in_range1 v2)))
...
;; H
  (assert
  (and (and (= o (r3 v11)) (r3__function_guard o v11))
  (and (in_range1 o)
  (and (= o (roundToIntegral RTN2 v11))
  (and (le o v11) (le (sub RNE2 v11 fliteral) o))))))
