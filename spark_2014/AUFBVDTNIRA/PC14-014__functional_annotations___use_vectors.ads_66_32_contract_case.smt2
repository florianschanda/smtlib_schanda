...
;; H
  ...
  (= current8 current2)))
  (and (= temp___481 first)
  (and (= temp___482 r27b)
  (and (and (= result5 current12) (= current1 temp___481))
  (and (and (<= temp___481 current1) (<= current1 temp___482))
  (and (= temp___480 current1)
  (and
  (forall ((i Int))
  ...
  (and
  (and (and (= result5 current12) (= current1 first))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= use_vectors__my_find__result13 (- first 1))))
(check-sat)
