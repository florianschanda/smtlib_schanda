...
;; vec_ba_x__def_axiom
  (assert (= vec_ba_x (sub RNE2 a_x b_x)))

;; vec_ba_y__def_axiom
  (assert (= vec_ba_y (sub RNE2 a_y b_y)))

;; vec_bc_x__def_axiom
  (assert (= vec_bc_x (sub RNE2 c_x b_x)))

;; vec_bc_y__def_axiom
  (assert (= vec_bc_y (sub RNE2 c_y b_y)))

;; ba_dot_bc__def_axiom
  (assert
  (= ba_dot_bc (add RNE2 (mul RNE2 vec_ba_x vec_bc_x)
               (mul RNE2 vec_ba_y vec_bc_y))))

;; length_ba__def_axiom
  (assert
  (= length_ba (sqrt2
               (add RNE2 (mul RNE2 (sub RNE2 b_x a_x) (sub RNE2 b_x a_x))
               (mul RNE2 (sub RNE2 b_y a_y) (sub RNE2 b_y a_y))))))

;; length_bc__def_axiom
  (assert
  (= length_bc (sqrt2
               (add RNE2 (mul RNE2 (sub RNE2 b_x c_x) (sub RNE2 b_x c_x))
               (mul RNE2 (sub RNE2 b_y c_y) (sub RNE2 b_y c_y))))))
...
;; H
  (assert (= (sub RNE2 a_x b_x) vec_ba_x))

;; H
  (assert (tqtisFinite vec_ba_x))

;; H
  (assert (= (sub RNE2 a_y b_y) vec_ba_y))

;; H
  (assert (tqtisFinite vec_ba_y))

;; H
  (assert (= (sub RNE2 c_x b_x) vec_bc_x))

;; H
  (assert (tqtisFinite vec_bc_x))

;; H
  (assert (= (sub RNE2 c_y b_y) vec_bc_y))
...
;; H
  (assert
  (and (= o (mul RNE2 vec_ba_y vec_bc_y)) (tqtisFinite
  (mul RNE2 vec_ba_y vec_bc_y))))

;; H
  (assert
  (and (= o1 (mul RNE2 vec_ba_x vec_bc_x)) (tqtisFinite
  (mul RNE2 vec_ba_x vec_bc_x))))

;; H
  (assert (= o2 (add RNE2 o1 o)))
...
;; H
  (assert
  (and (= o3 (mul RNE2 (sub RNE2 b_y a_y) (sub RNE2 b_y a_y))) (tqtisFinite
  (mul RNE2 (sub RNE2 b_y a_y) (sub RNE2 b_y a_y)))))

;; H
  (assert
  (and (= o4 (mul RNE2 (sub RNE2 b_x a_x) (sub RNE2 b_x a_x))) (tqtisFinite
  (mul RNE2 (sub RNE2 b_x a_x) (sub RNE2 b_x a_x)))))

;; H
  (assert (= o5 (add RNE2 o4 o3)))
...
;; H
  (assert
  (and (= o7 (mul RNE2 (sub RNE2 b_y c_y) (sub RNE2 b_y c_y))) (tqtisFinite
  (mul RNE2 (sub RNE2 b_y c_y) (sub RNE2 b_y c_y)))))

;; H
  (assert
  (and (= o8 (mul RNE2 (sub RNE2 b_x c_x) (sub RNE2 b_x c_x))) (tqtisFinite
  (mul RNE2 (sub RNE2 b_x c_x) (sub RNE2 b_x c_x)))))

;; H
  (assert (= o9 (add RNE2 o8 o7)))
