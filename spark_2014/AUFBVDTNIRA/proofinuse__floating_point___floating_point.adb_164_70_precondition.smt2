...
;; sqrt__post_axiom
  (assert
  (forall ((x t))
  (! (=> (and (dynamic_invariant x true true true) (le fliteral2 x))
     (let ((result (sqrt2 x)))
     (and
     (and (le fliteral2 result)
     (and (=> (eq x fliteral2) (eq result fliteral2))
     (and (=> (eq x fliteral) (eq result fliteral))
     (=> (le fliteral3 x) (lt fliteral2 result))))) (dynamic_invariant result
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral4) (= (tqtreal fliteral4) 4096.0)))
...
(define-fun dynamic_invariant1 ((temp___expr_211 t) (temp___is_init_208 Bool)
  (temp___skip_constant_209 Bool)
  (temp___do_toplevel_210 Bool)) Bool (=>
                                      (or (= temp___is_init_208 true) (le
                                      (neg fliteral4) fliteral4)) (in_range2
                                      temp___expr_211)))
...
(declare-fun vec_ba_x () t)

(declare-fun attr__ATTRIBUTE_ADDRESS7 () Int)

(declare-fun vec_ba_y () t)

(declare-fun attr__ATTRIBUTE_ADDRESS8 () Int)

(declare-fun vec_bc_x () t)

(declare-fun attr__ATTRIBUTE_ADDRESS9 () Int)

(declare-fun vec_bc_y () t)

(declare-fun attr__ATTRIBUTE_ADDRESS10 () Int)

(declare-fun ba_dot_bc () t)

(declare-fun attr__ATTRIBUTE_ADDRESS11 () Int)

(declare-fun length_ba () t)

(declare-fun attr__ATTRIBUTE_ADDRESS12 () Int)

(declare-fun length_bc () t)

(declare-fun attr__ATTRIBUTE_ADDRESS13 () Int)

;; vec_ba_x__def_axiom
  (assert (= vec_ba_x (sub RNE1 a_x b_x)))

;; vec_ba_y__def_axiom
  (assert (= vec_ba_y (sub RNE1 a_y b_y)))

;; vec_bc_x__def_axiom
  (assert (= vec_bc_x (sub RNE1 c_x b_x)))

;; vec_bc_y__def_axiom
  (assert (= vec_bc_y (sub RNE1 c_y b_y)))

;; ba_dot_bc__def_axiom
  (assert
  (= ba_dot_bc (add RNE1 (mul RNE1 vec_ba_x vec_bc_x)
               (mul RNE1 vec_ba_y vec_bc_y))))

;; length_ba__def_axiom
  (assert
  (= length_ba (sqrt2
               (add RNE1 (mul RNE1 (sub RNE1 b_x a_x) (sub RNE1 b_x a_x))
               (mul RNE1 (sub RNE1 b_y a_y) (sub RNE1 b_y a_y))))))

;; length_bc__def_axiom
  (assert
  (= length_bc (sqrt2
               (add RNE1 (mul RNE1 (sub RNE1 b_x c_x) (sub RNE1 b_x c_x))
               (mul RNE1 (sub RNE1 b_y c_y) (sub RNE1 b_y c_y))))))
...
(declare-fun floating_point__angle_between__ba_dot_bc__assume () t)
...
(declare-fun floating_point__angle_between__length_ba__assume () t)
...
;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite res)))

;; H
  (assert (= (sub RNE1 a_x b_x) vec_ba_x))

;; H
  (assert (tqtisFinite vec_ba_x))

;; H
  (assert (= (sub RNE1 a_y b_y) vec_ba_y))

;; H
  (assert (tqtisFinite vec_ba_y))

;; H
  (assert (= (sub RNE1 c_x b_x) vec_bc_x))

;; H
  (assert (tqtisFinite vec_bc_x))

;; H
  (assert (= (sub RNE1 c_y b_y) vec_bc_y))

;; H
  (assert (tqtisFinite vec_bc_y))

;; H
  (assert
  (and (= o (mul RNE1 vec_ba_y vec_bc_y)) (tqtisFinite
  (mul RNE1 vec_ba_y vec_bc_y))))

;; H
  (assert
  (and (= o1 (mul RNE1 vec_ba_x vec_bc_x)) (tqtisFinite
  (mul RNE1 vec_ba_x vec_bc_x))))

;; H
  (assert (= o2 (add RNE1 o1 o)))

;; H
  (assert
  (and (= floating_point__angle_between__ba_dot_bc__assume o2) (tqtisFinite
  o2)))
...
;; H
  (assert (tqtisFinite ba_dot_bc))

;; H
  (assert
  (and (= o3 (mul RNE1 (sub RNE1 b_y a_y) (sub RNE1 b_y a_y))) (tqtisFinite
  (mul RNE1 (sub RNE1 b_y a_y) (sub RNE1 b_y a_y)))))

;; H
  (assert
  (and (= o4 (mul RNE1 (sub RNE1 b_x a_x) (sub RNE1 b_x a_x))) (tqtisFinite
  (mul RNE1 (sub RNE1 b_x a_x) (sub RNE1 b_x a_x)))))

;; H
  (assert (= o5 (add RNE1 o4 o3)))
...
;; H
  (assert
  (and (= floating_point__angle_between__length_ba__assume (sqrt2 o6))
  (and (tqtisFinite floating_point__angle_between__length_ba__assume)
  (and (le fliteral2 floating_point__angle_between__length_ba__assume)
  (and
  (=> (eq o6 fliteral2) (eq floating_point__angle_between__length_ba__assume
  fliteral2))
  (and
  (=> (eq o6 fliteral) (eq floating_point__angle_between__length_ba__assume
  fliteral))
  (=> (le fliteral3 o6) (lt fliteral2
...
;; H
  (assert (tqtisFinite length_ba))

;; H
  (assert
  (and (= o7 (mul RNE1 (sub RNE1 b_y c_y) (sub RNE1 b_y c_y))) (tqtisFinite
  (mul RNE1 (sub RNE1 b_y c_y) (sub RNE1 b_y c_y)))))

;; H
  (assert
  (and (= o8 (mul RNE1 (sub RNE1 b_x c_x) (sub RNE1 b_x c_x))) (tqtisFinite
  (mul RNE1 (sub RNE1 b_x c_x) (sub RNE1 b_x c_x)))))

;; H
  (assert (= o9 (add RNE1 o8 o7)))

;; H
  (assert (and (= o10 o9) (tqtisFinite o9)))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (le fliteral2 o10)))
(check-sat)
