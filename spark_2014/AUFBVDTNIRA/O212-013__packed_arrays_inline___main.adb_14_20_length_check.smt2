...
;; def_axiom
  ...
  (and (= (first5 temp___305) temp___307) (= (last8 temp___305) temp___308)))
...
(define-fun dynamic_invariant3 ((temp___expr_281 us_t1)
  ...
  (temp___do_toplevel_280 Bool)) Bool (=>
                                      ...
                                      (last5 temp___expr_281))
                                      (and (= (first3 temp___expr_281) 0)
                                      (= (last5 temp___expr_281) r6b)))))
...
;; H
  (assert (= (to_rep1 (last7 (rt2 (temp___304 (of_int 0) 0 r6b)))) r6b))
...
;; WP_parameter_def
 ;; File "main.adb", line 1, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first4 temp___3111)) (to_rep1 (last7 temp___3111)))
     (+ (- (to_rep1 (last7 temp___3111)) (to_rep1 (first4 temp___3111))) 1)
