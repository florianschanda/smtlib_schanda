...
;; H
  (assert (= o53 (select temp___2277 o52)))
...
;; H
  (assert (= o49 (select temp___2276 ki1)))
...
;; H
  (assert (= o46 (select temp___2275 ki1)))
...
;; H
  (assert (= o41 (select temp___2272 o40)))
...
;; H
  (assert (= o37 (select temp___2269 o36)))
