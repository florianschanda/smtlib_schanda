...
(declare-fun r__split_fields11 () (Array Int integer))

(declare-fun r__split_fields12 () ar_index)

(declare-fun r__split_fields13 () length_type)
...
;; H
  (assert
  (and
  (and (= (to_rep1 r__split_fields14) (- (to_rep1 r__split_fields13) 1))
  (= (head
     (mk___rep
     (mk___split_fields r__split_fields11 r__split_fields12
     r__split_fields13))) h3))
  (in_range h3)))
