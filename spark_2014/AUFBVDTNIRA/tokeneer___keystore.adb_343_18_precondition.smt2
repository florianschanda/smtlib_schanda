...
;; H
  ...
  (= (select o7 temp___1283) (select result__1 temp___1283))))))

;; H
  (assert (=> (= result4 true) (= result5 (mk_map__ref result__1))))

;; H
  (assert (=> (= result4 true) (= result__2 o7)))
...
;; H
  (assert (=> (not (= result4 true)) (= o8 temp___1277)))

;; H
  (assert (=> (not (= result4 true)) (= result6 (mk_map__ref result__1))))

;; H
  (assert (=> (not (= result4 true)) (= result__3 o8)))
