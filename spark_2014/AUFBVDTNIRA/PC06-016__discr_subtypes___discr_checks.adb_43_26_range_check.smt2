...
(declare-fun discr_checks__check_subtype_task__R11b__assume () Int)
...
;; H
  (assert (= discr_checks__check_subtype_task__R11b__assume r11b))

;; H
  (assert (in_range r11b))

(assert
;; WP_parameter_def
 ;; File "discr_checks.adb", line 28, characters 0-0
  (not (in_range1 r11b)))
(check-sat)
