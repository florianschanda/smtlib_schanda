...
(define-fun m__split_fields5 () us_split_fields (mk___split_fields
                                                m__split_fields4))

(define-fun m__split_fields6 () us_split_fields (mk___split_fields
                                                m__split_fields3))

(define-fun m__split_fields7 () us_split_fields (mk___split_fields
                                                m__split_fields2))
...
;; H
  ...
  (= (length (mk___rep m__split_discrs m__split_fields8)) (+ (length
                                                             ...
                                                             (mk___split_fields
                                                             m__split_fields))) 1))
  (= (has_key (model__ (mk___rep m__split_discrs m__split_fields8)) 1) true))
  (= (key (mk___rep m__split_discrs m__split_fields8)
     (find1 (mk___rep m__split_discrs m__split_fields8) 1)) 1))
  (= (get (model__ (mk___rep m__split_discrs m__split_fields8)) 1) 0))
  (= (ole
  ...
  (= (keys_included_except1
     ...
     (positions
     (mk___rep m__split_discrs (mk___split_fields m__split_fields)))
     (find1 (mk___rep m__split_discrs m__split_fields8) 1)) true)))
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep m__split_discrs m__split_fields7)) (+ (length
                                                             (mk___rep
                                                             m__split_discrs
                                                             m__split_fields8)) 1))
  (= (has_key (model__ (mk___rep m__split_discrs m__split_fields7)) 2) true))
  (= (key (mk___rep m__split_discrs m__split_fields7)
     (find1 (mk___rep m__split_discrs m__split_fields7) 2)) 2))
  (= (get (model__ (mk___rep m__split_discrs m__split_fields7)) 2) 0))
  (= (ole (model__ (mk___rep m__split_discrs m__split_fields8))
     (model__ (mk___rep m__split_discrs m__split_fields7))) true))
  (= (keys_included_except
     (model__ (mk___rep m__split_discrs m__split_fields7))
     (model__ (mk___rep m__split_discrs m__split_fields8)) 2) true))
  (= (mapping_preserved (keys (mk___rep m__split_discrs m__split_fields8))
     (keys (mk___rep m__split_discrs m__split_fields7))
     (positions (mk___rep m__split_discrs m__split_fields8))
     (positions (mk___rep m__split_discrs m__split_fields7))) true))
  (= (keys_included_except1
     (positions (mk___rep m__split_discrs m__split_fields7))
     (positions (mk___rep m__split_discrs m__split_fields8))
     (find1 (mk___rep m__split_discrs m__split_fields7) 2)) true)))
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep m__split_discrs m__split_fields6)) (+ (length
                                                             (mk___rep
                                                             m__split_discrs
                                                             m__split_fields7)) 1))
  (= (has_key (model__ (mk___rep m__split_discrs m__split_fields6)) 3) true))
  (= (key (mk___rep m__split_discrs m__split_fields6)
     (find1 (mk___rep m__split_discrs m__split_fields6) 3)) 3))
  (= (get (model__ (mk___rep m__split_discrs m__split_fields6)) 3) 0))
  (= (ole (model__ (mk___rep m__split_discrs m__split_fields7))
     (model__ (mk___rep m__split_discrs m__split_fields6))) true))
  (= (keys_included_except
     (model__ (mk___rep m__split_discrs m__split_fields6))
     (model__ (mk___rep m__split_discrs m__split_fields7)) 3) true))
  (= (mapping_preserved (keys (mk___rep m__split_discrs m__split_fields7))
     (keys (mk___rep m__split_discrs m__split_fields6))
     (positions (mk___rep m__split_discrs m__split_fields7))
     (positions (mk___rep m__split_discrs m__split_fields6))) true))
  (= (keys_included_except1
     (positions (mk___rep m__split_discrs m__split_fields6))
     (positions (mk___rep m__split_discrs m__split_fields7))
     (find1 (mk___rep m__split_discrs m__split_fields6) 3)) true)))
...
;; H
  ...
  (= (length (mk___rep m__split_discrs m__split_fields5)) (+ (length
                                                             ...
                                                             m__split_discrs
                                                             m__split_fields6)) 1))
  (= (has_key (model__ (mk___rep m__split_discrs m__split_fields5)) 4) true))
  (= (key (mk___rep m__split_discrs m__split_fields5)
     (find1 (mk___rep m__split_discrs m__split_fields5) 4)) 4))
  (= (get (model__ (mk___rep m__split_discrs m__split_fields5)) 4) 0))
  (= (ole (model__ (mk___rep m__split_discrs m__split_fields6))
     (model__ (mk___rep m__split_discrs m__split_fields5))) true))
  (= (keys_included_except
     (model__ (mk___rep m__split_discrs m__split_fields5))
     (model__ (mk___rep m__split_discrs m__split_fields6)) 4) true))
  (= (mapping_preserved (keys (mk___rep m__split_discrs m__split_fields6))
     (keys (mk___rep m__split_discrs m__split_fields5))
     (positions (mk___rep m__split_discrs m__split_fields6))
     (positions (mk___rep m__split_discrs m__split_fields5))) true))
  (= (keys_included_except1
     (positions (mk___rep m__split_discrs m__split_fields5))
     (positions (mk___rep m__split_discrs m__split_fields6))
     (find1 (mk___rep m__split_discrs m__split_fields5) 4)) true)))

(assert
;; WP_parameter_def
 ;; File "use_maps.ads", line 78, characters 0-0
  (not
  (< (length (mk___rep m__split_discrs m__split_fields5)) (to_rep
                                                          (rec__use_maps__my_maps__map__capacity
                                                          m__split_discrs)))))
(check-sat)
