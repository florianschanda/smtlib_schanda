...
;; def_axiom
  ...
  (= (select (purecat__x__aggregate_def temp___190) temp___191) (of_rep
                                                                temp___190)))))
...
(assert
;; WP_parameter_def
 ;; File "purecat.adb", line 2, characters 0-0
  (not
  (= (bool_eq3 x1 1 1000 x1 (to_rep1 (first (mk 1 1000)))
     (to_rep1 (last (mk 1 1000)))) true)))
(check-sat)
