...
(define-fun model____split_fields10 () us_split_fields (mk___split_fields
                                                       model____split_fields8
                                                       model____split_fields9))

(define-fun model____split_fields11 () us_split_fields (mk___split_fields
...
;; H
  (assert (is_valid__function_guard (is_valid state1 model____split_fields13)
  state1 model____split_fields13))
...
;; H
  ...
  (mk___rep model____split_fields13)
  (mk___rep (mk___split_fields model____split_fields model____split_fields1))))
...
;; H
  (assert
  (and
  (and (= (is_valid state1 model____split_fields13) true)
...
;; H
  (assert (is_valid__function_guard (is_valid state2 model____split_fields12)
  state2 model____split_fields12))
...
;; H
  (assert
  (and
  (and (= (is_valid state2 model____split_fields12) true)
...
;; H
  (assert (is_valid__function_guard (is_valid state3 model____split_fields11)
  state3 model____split_fields11))

;; H
  (assert (oeq__function_guard
  (oeq (mk___rep model____split_fields11) (mk___rep model____split_fields12))
  (mk___rep model____split_fields11) (mk___rep model____split_fields12)))
...
;; H
  (assert
  (and
  (and (= (is_valid state3 model____split_fields11) true)
  (ite (= (= (length model____split_fields4) 0) true)
  (and (= res31 0)
  (= (oeq (mk___rep model____split_fields11)
     (mk___rep model____split_fields12)) true))
  (and
...
;; H
  (assert (is_valid__function_guard (is_valid state4 model____split_fields10)
  state4 model____split_fields10))

;; H
  (assert (oeq__function_guard
  (oeq (mk___rep model____split_fields10) (mk___rep model____split_fields11))
  (mk___rep model____split_fields10) (mk___rep model____split_fields11)))
...
;; H
  (assert
  (and
  (and (= (is_valid state4 model____split_fields10) true)
  (ite (= (= (length model____split_fields6) 0) true)
  (and (= res41 0)
  (= (oeq (mk___rep model____split_fields10)
     (mk___rep model____split_fields11)) true))
  (and
