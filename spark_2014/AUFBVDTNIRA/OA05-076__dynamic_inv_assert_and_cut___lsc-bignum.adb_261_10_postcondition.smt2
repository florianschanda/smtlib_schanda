...
;; H
  ...
  (from_word32 x)) (num_of_big_int b b_first (+ (- a_last a_first) 1))
  (from_word32 x)))
...
;; H
  ...
  (from_word32 y)) (num_of_big_int c c_first (+ (- a_last a_first) 1))
  (from_word32 y)))
...
;; H
  (assert (from_word32__function_guard (from_word32 (t__content carry18))
  (t__content carry18)))
...
;; H
  (assert (from_word32__function_guard (from_word32 (t__content carry28))
  (t__content carry28)))
...
;; H
  (assert (omultiply__function_guard
  (omultiply (base Tuple0) (from_word32 (t__content carry28))) (base Tuple0)
  (from_word32 (t__content carry28))))
...
;; H
  ...
  (omultiply (base Tuple0) (from_word32 (t__content carry28))))
  (from_word32 (t__content carry18))
  (omultiply (base Tuple0) (from_word32 (t__content carry28)))))
