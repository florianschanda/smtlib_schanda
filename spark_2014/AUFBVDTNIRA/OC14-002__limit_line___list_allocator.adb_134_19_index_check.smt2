...
;; H
  (assert
  (and (and (= o43 (length ma1)) (length__function_guard o43 ma1)) (in_range6
  o43)))
...
;; H
  (assert
  (and
  (and (= temp___677 (get ma1 o46)) (get__function_guard temp___677 ma1 o46))
  (in_range7 temp___677)))
