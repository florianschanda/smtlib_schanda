...
;; H
  ...
  (not
  (= (inrange64 i
     (readmem64 (bvsub rbp ((_ int2bv 64) 32)) (map__content memory11))
     (readmem64 (bvsub rbp ((_ int2bv 64) 72)) (map__content memory11))) true)))
...
;; WP_parameter_def
 ;; File "x86.ads", line 334, characters 0-0
  (not
  (= (to_rep (select (map__content memory11) i)) (to_rep (select memory i)))))
(check-sat)
