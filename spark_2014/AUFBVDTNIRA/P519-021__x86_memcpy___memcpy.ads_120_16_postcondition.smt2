...
;; H
  ...
  (bvsub rbp ((_ int2bv 64) 32)) (map__content memory11)))

;; H
  (assert (readmem64__function_guard
  (readmem64 (bvsub rbp ((_ int2bv 64) 72)) (map__content memory11))
  (bvsub rbp ((_ int2bv 64) 72)) (map__content memory11)))
...
;; H
  ...
  (readmem64 (bvsub rbp ((_ int2bv 64) 32)) (map__content memory11))
  (readmem64 (bvsub rbp ((_ int2bv 64) 72)) (map__content memory11))) 
  i (readmem64 (bvsub rbp ((_ int2bv 64) 32)) (map__content memory11))
  (readmem64 (bvsub rbp ((_ int2bv 64) 72)) (map__content memory11))))
