...
(declare-datatypes ()
((us_split_discrs
 (mk___split_discrs (rec__p__my_lists__list__capacity count_type)))))
...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__p__my_lists__list us_main_type)))))
  ...
  (b us_rep)) Bool (ite (and
                        (= (to_rep
                           ...
                           (us_split_discrs1 a))) (to_rep
                                                  ...
                                                  (us_split_discrs1 b))))
                        (= (us_main_eq
                           (rec__p__my_lists__list (us_split_fields1 a))
                           (rec__p__my_lists__list (us_split_fields1 b))) true))
                   true false))
...
(declare-fun p__my_lists__list__capacity__first__bit () Int)

(declare-fun p__my_lists__list__capacity__last__bit () Int)

(declare-fun p__my_lists__list__capacity__position () Int)
...
(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1 (rec__p__my_lists__cursor__node count_type)))))
...
(declare-fun p__my_lists__cursor__node__first__bit () Int)

(declare-fun p__my_lists__cursor__node__last__bit () Int)

(declare-fun p__my_lists__cursor__node__position () Int)
...
;; get__post_axiom
  ...
  (! (=> (= (has_key container key) true)
     ...
     (dynamic_invariant5 result true false true)))) :pattern ((get1 container
                                                              key)) ))))
...
(declare-fun temp___468 () count_type)

(declare-fun temp___464 () count_type)
...
(define-fun temp___4641 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___464)))
...
;; H
  (assert
  (and (= temp___4641 (first x))
  (ite (= (= (length x) 0) true) (= (bool_eq3 temp___4641 no_element) true)
  (and (= (has_key (positions x) temp___4641) true)
  (= (get1 (positions x) temp___4641) 1)))))
...
;; H
  (assert
  (not
  (= (bool_eq3 (mk___rep1 (mk___split_fields1 c__split_fields1)) no_element) true)))

;; H
  (assert
  (and (=> (<= (- 2147483648) 2147483647) (in_range1 sum2))
  (not (= (bool_eq3 (mk___rep1 c__split_fields3) no_element) true))))

;; H
  (assert
  (and (= o2 (element x (mk___rep1 c__split_fields3)))
  (and (in_range3 o2)
  (= o2 (get (model__ x) (get1 (positions x) (mk___rep1 c__split_fields3)))))))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 1514, characters 0-0
  (not
  (or (= (has_key (positions x) (mk___rep1 c__split_fields3)) true)
