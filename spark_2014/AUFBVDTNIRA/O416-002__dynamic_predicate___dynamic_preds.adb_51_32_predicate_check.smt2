...
(declare-fun temp___224 () even)

(declare-fun temp___2241 () even)

(define-fun o2 () us_rep (mk___rep (mk___split_fields o o1)))
...
;; H
  (assert
  (and
  (and (= o2 (get_constant_even_pair Tuple0))
  (get_constant_even_pair__function_guard o2 Tuple0))
  (and (dynamic_invariant2 o2 true false true)
  (and (= (to_rep o) 0) (= (to_rep o1) 0)))))

;; H
  (assert (= (mk___rep (mk___split_fields temp___224 temp___2241)) o2))

(assert
;; WP_parameter_def
 ;; File "dynamic_preds.adb", line 44, characters 0-0
  (not (= (to_rep temp___2241) (+ (to_rep temp___224) 2))))
(check-sat)
