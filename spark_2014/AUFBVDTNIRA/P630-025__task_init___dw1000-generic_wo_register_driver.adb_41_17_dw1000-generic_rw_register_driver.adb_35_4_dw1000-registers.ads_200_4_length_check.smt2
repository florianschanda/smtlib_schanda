...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__panadr_type__short_addr bits_16)(rec__dw1000__register_types__panadr_type__pan_id bits_16)))))
(define-fun us_split_fields_SHORT_ADDR__projection ((a us_split_fields)) bits_16 
  (rec__dw1000__register_types__panadr_type__short_addr a))

(define-fun us_split_fields_PAN_ID__projection ((a us_split_fields)) bits_16 
  (rec__dw1000__register_types__panadr_type__pan_id a))
...
(define-fun bool_eq6 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (to_rep2
                           (rec__dw1000__register_types__panadr_type__short_addr
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__panadr_type__short_addr
                                                  (us_split_fields1 b))))
                        (= (to_rep2
                           (rec__dw1000__register_types__panadr_type__pan_id
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__panadr_type__pan_id
                                                  (us_split_fields1 b)))))
                   true false))
...
(declare-fun dw1000__register_types__panadr_type__short_addr__first__bit () Int)

(declare-fun dw1000__register_types__panadr_type__short_addr__last__bit () Int)

(declare-fun dw1000__register_types__panadr_type__short_addr__position () Int)

;; dw1000__register_types__panadr_type__short_addr__first__bit_axiom
  (assert (<= 0 dw1000__register_types__panadr_type__short_addr__first__bit))

;; dw1000__register_types__panadr_type__short_addr__last__bit_axiom
  (assert
  (< dw1000__register_types__panadr_type__short_addr__first__bit dw1000__register_types__panadr_type__short_addr__last__bit))

;; dw1000__register_types__panadr_type__short_addr__position_axiom
  (assert (<= 0 dw1000__register_types__panadr_type__short_addr__position))

(declare-fun dw1000__register_types__panadr_type__pan_id__first__bit () Int)

(declare-fun dw1000__register_types__panadr_type__pan_id__last__bit () Int)

(declare-fun dw1000__register_types__panadr_type__pan_id__position () Int)

;; dw1000__register_types__panadr_type__pan_id__first__bit_axiom
  (assert (<= 0 dw1000__register_types__panadr_type__pan_id__first__bit))

;; dw1000__register_types__panadr_type__pan_id__last__bit_axiom
  (assert
  (< dw1000__register_types__panadr_type__pan_id__first__bit dw1000__register_types__panadr_type__pan_id__last__bit))

;; dw1000__register_types__panadr_type__pan_id__position_axiom
  (assert (<= 0 dw1000__register_types__panadr_type__pan_id__position))

(declare-fun dummy5 () us_rep)

(declare-datatypes ()
((panadr_type__ref (mk_panadr_type__ref (panadr_type__content us_rep)))))
(define-fun panadr_type__ref___projection ((a panadr_type__ref)) us_rep 
  (panadr_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_7__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_5__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_5__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_1926 us_t1)
  (temp___is_init_1923 Bool) (temp___skip_constant_1924 Bool)
  (temp___do_toplevel_1925 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_1924 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_1926)
                                       (last4 temp___expr_1926))
                                       (and (= (first3 temp___expr_1926) 1)
                                       (= (last4 temp___expr_1926) 4)))))
...
(define-fun target__ref_2__projection ((a target__ref)) us_t2 (target__content
                                                              a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_2__projection ((a source__ref)) us_rep (source__content
                                                               a))

(define-fun dynamic_invariant1 ((temp___expr_1943 us_t2)
  (temp___is_init_1940 Bool) (temp___skip_constant_1941 Bool)
  (temp___do_toplevel_1942 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_1941 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_1943)
                                       (last6 temp___expr_1943))
                                       (and (= (first5 temp___expr_1943) 1)
                                       (= (last6 temp___expr_1943) 4)))))
...
(declare-fun temp___7554 () (Array Int bits_8))

(declare-fun temp___75541 () t2)

(declare-fun temp___7555 () (Array Int bits_8))

(declare-fun temp___75551 () t1)

(define-fun temp___75542 () us_t2 (mk___t2 temp___7554 temp___75541))
...
;; H
  (assert
  (and
  (and (= temp___75542 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___75542 reg)) (dynamic_invariant1
  temp___75542 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___75541)) (to_rep (last5 temp___75541)))
     (+ (- (to_rep (last5 temp___75541)) (to_rep (first4 temp___75541))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___7554 temp___7555))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___75541)) (to_rep (last5 temp___75541))) 
  temp___75551))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___75551)) (to_rep (last3 temp___75551)))
     (+ (- (to_rep (last3 temp___75551)) (to_rep (first2 temp___75551))) 1)
