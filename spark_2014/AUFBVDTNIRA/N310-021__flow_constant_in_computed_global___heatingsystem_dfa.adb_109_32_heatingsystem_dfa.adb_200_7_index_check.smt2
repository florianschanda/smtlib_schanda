...
(declare-fun minutesinhour () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun secondsinminute () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun secondsinhour () Int)
...
(declare-fun heatingison1 () Bool)

(declare-fun result1 () Int)

(declare-fun clockoffset1 () Int)

(declare-fun result2 () map__ref1)

(declare-fun onofftime1 () (Array Int times))

(declare-fun clockoffset2 () Int)
