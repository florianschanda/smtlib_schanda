...
(declare-fun temp___2059 () (Array Int us_rep1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2059 (parent
                      (rec__search_trees__search_tree__struct
                      t__split_fields10) i2))))
  (position (rec__search_trees__search_tree__struct t__split_fields10) i2)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2059 i2))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2059 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2060 o50))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2060 o50)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o50))
...
;; H
  (assert (= o51 (select temp___2060 i1)))
...
;; H
  ...
  (= temp___2059 (model__
                 (rec__search_trees__search_tree__struct t__split_fields10)
                 o46))
  (model____function_guard temp___2059
  (rec__search_trees__search_tree__struct t__split_fields10) o46))
  (and (dynamic_invariant6 temp___2059 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2059 o46))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2059 o46)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o46))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2059 (parent
                              ...
                              t__split_fields10) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2059 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2059 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2059 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2059 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2059 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2059 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o47 (select temp___2059 x1)))
