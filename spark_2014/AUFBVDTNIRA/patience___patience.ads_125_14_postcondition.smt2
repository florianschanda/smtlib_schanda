...
(declare-fun s__split_fields22 () us_split_fields__ref)

(declare-fun idx2 () int__ref)

(declare-fun pred10 () int__ref)

(declare-fun i13 () int__ref)

(declare-fun stackisize11 () int__ref)

(declare-fun topstacki8 () int__ref)

(declare-fun s__split_fields23 () us_split_fields)

(declare-fun idx3 () Int)

(declare-fun pred11 () Int)

(declare-fun i14 () Int)

(declare-fun stackisize12 () Int)

(declare-fun topstacki9 () Int)
...
;; H
  ...
  (<= 1 (to_rep1
        (select (rec__patience__state__stacksizes
                (us_split_fields__content s__split_fields20)) i15))))))
...
;; H
  ...
  (<= (to_rep1
      (select (rec__patience__state__stacksizes
              (us_split_fields__content s__split_fields20)) i15)) (to_rep1
                                                                  (rec__patience__state__numelts
                                                                  (us_split_fields__content
                                                                  s__split_fields20))))
  (forall ((j Int))
  ...
  (<= j (- (to_rep1
           (select (rec__patience__state__stacksizes
                   (us_split_fields__content s__split_fields20)) i15)) 1)))
  (and
  (<= 0 (to_rep1
        (select (select (rec__patience__state__stacks
                        (us_split_fields__content s__split_fields20)) i15) j)))
  (< (to_rep1
     (select (select (rec__patience__state__stacks
                     (us_split_fields__content s__split_fields20)) i15) j)) 
  (to_rep1
...
;; H
  ...
  (= (to_rep1
     (select (select (rec__patience__state__stacks
                     (us_split_fields__content s__split_fields20)) (to_rep1
                                                                   ...
                                                                   (rec__patience__state__posstack
                                                                   (us_split_fields__content
                                                                   s__split_fields20)) i15))) 
     (to_rep1
     (select (rec__patience__state__posheight
             (us_split_fields__content s__split_fields20)) i15)))) i15))))
  (forall ((ist Int))
  (=>
  (and (<= 0 ist)
  (<= ist (- (to_rep1
  ...
  (<= j (- (to_rep1
           (select (rec__patience__state__stacksizes
                   (us_split_fields__content s__split_fields20)) i15)) 2)))
  (forall ((k Int))
  (=>
  (and (<= (+ j 1) k)
  (<= k (- (to_rep1
  ...
  (to_rep1
  (select (select (rec__patience__state__stacks
                  (us_split_fields__content s__split_fields20)) i15) k))))))))))
  (forall ((i15 Int))
  (=>
  (and (<= 0 i15)
  (<= i15 (- (to_rep1
  ...
  (and
  (<= (- 1) (to_rep1
            (select (rec__patience__state__preds
                    (us_split_fields__content s__split_fields20)) i15)))
  (<= (to_rep1
      (select (rec__patience__state__preds
              (us_split_fields__content s__split_fields20)) i15)) (- 
  ...
  (ite (< (to_rep1
          (select (rec__patience__state__preds
                  (us_split_fields__content s__split_fields20)) i15)) 0)
  (= (to_rep1
     (select (rec__patience__state__posstack
             (us_split_fields__content s__split_fields20)) i15)) 0)
  (and
...
;; H
  (assert (inv__function_guard
  (inv (mk___rep (us_split_fields__content s__split_fields22)))
  (mk___rep (us_split_fields__content s__split_fields22))))

(assert
;; WP_parameter_def
 ;; File "patience.ads", line 53, characters 0-0
  (not
  (= (inv (mk___rep (us_split_fields__content s__split_fields22))) true)))
(check-sat)
