...
(declare-fun user_eq6 (t93b t93b) Bool)

(declare-fun dummy6 () t93b)
...
(declare-fun user_eq7 (t91b t91b) Bool)

(declare-fun dummy7 () t91b)
...
(declare-fun temp___571 (us_rep) (Array Int us_rep))

;; def_axiom
  (assert
  (forall ((temp___573 us_rep))
  (forall ((temp___574 Int))
  (= (select (temp___571 temp___573) temp___574) temp___573))))

(declare-fun temp___575 (Int Int Int Int Int) (Array Int character))

;; def_axiom
  (assert
  (forall ((temp___577 Int) (temp___578 Int) (temp___579 Int)
  (temp___580 Int) (temp___581 Int))
  (let ((temp___576 (temp___575 temp___577 temp___578 temp___579 temp___580
                    temp___581)))
  (and
  (and
  (and
  (and (= (select temp___576 1) (of_rep1 temp___577))
  (= (select temp___576 2) (of_rep1 temp___578)))
  (= (select temp___576 3) (of_rep1 temp___579)))
  (= (select temp___576 4) (of_rep1 temp___580)))
  (= (select temp___576 5) (of_rep1 temp___581))))))
...
;; H
  (assert (= o (temp___575 87 111 114 108 100)))
...
;; H
  (assert (= o6 (temp___571 (mk___rep (mk___split_fields o4 o5)))))
...
;; WP_parameter_def
 ;; File "array_aggregates.adb", line 262, characters 0-0
  (not
  (= (to_rep
     (rec__array_aggregates__string_t__len (us_split_fields1 (select x1 3)))) 5)))
(check-sat)
