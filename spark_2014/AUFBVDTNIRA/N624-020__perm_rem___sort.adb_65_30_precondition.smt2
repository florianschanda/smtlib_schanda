...
;; H
  (assert
  (and
  (and (= o15 (remove (mk___t values2 (mk 1 100)) o14))
  (remove__function_guard o15 (mk___t values2 (mk 1 100)) o14))
  (and (dynamic_invariant4 o15 true false true)
  (and (= (invariant__ o15) true)
  (and (= (to_rep1 (last (rt o15))) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o14 1)))
  (= (to_rep (select values2 k)) (to_rep (select (elts o15) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o14 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select values2 k)) (to_rep (select (elts o15) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o14 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o15) k))))))))))))
