...
;; H
  (assert (=> (not (= (int__content i14) 0)) (= o40 (int__content i14))))

;; H
  (assert
  (=> (not (= (int__content i14) 0)) (= o41 (select temp___1438 o40))))

;; H
  (assert (=> (not (= (int__content i14) 0)) (= o42 (us_split_fields1 o41))))

;; H
  (assert
  (=> (not (= (int__content i14) 0))
  (= result26 (rec__tree_model__path_type__k o42))))
...
;; H
  ...
  (= o38 (root
         ...
         (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
         t__split_fields3))))
  (root__function_guard o38
  (mk___rep3
  (mk___split_fields3 t__split_fields
  (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
  t__split_fields3))))
  (and (in_range3 o38) (= o38 (to_rep1 t__split_fields))))))
...
;; H
  ...
  (and
  (and
  (= o39 (root (mk___rep3 (us_split_fields__content3 t__split_fields14))))
...
;; H
  (assert (=> (= result26 true) (= result25 (ite (= o39 o38) true false))))
...
;; H
  ...
  (and
  (and
  (= o37 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (size__function_guard1 o37
  (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (and (in_range4 o37)
  (= o37 (size
         (rec__search_trees__search_tree__struct
...
;; H
  ...
  (and
  (and
  (= o36 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (values__function_guard1 o36
  (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (ite (= (size
          (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= (contains o35 (to_rep (select t__split_fields3 i16))) true))))
  (forall ((v1 Int))
  (=> (and (<= 0 v1) (<= v1 2147483647))
  (=> (= (contains o35 v1) true)
  (exists ((i16 Int))
  (and (and (<= 1 i16) (<= i16 100))
  (and
  (= (rec__tree_model__path_type__k
...
;; H
  ...
  (=> (= result24 true)
  (and
  (and (= result23 (is_add__2 o35 v o36)) (is_add__2__function_guard 
  result23 o35 v o36))
  (= (= result23 true)
  (and
  (and (and (not (= (contains o35 v) true)) (= (contains o36 v) true))
  (= (ole o35 o36) true)) (= (included_except o36 o35 v) true))))))
...
;; H
  ...
  (position
  (rec__search_trees__search_tree__struct
  (us_split_fields__content3 t__split_fields14)) o33)
  (rec__search_trees__search_tree__struct
  (us_split_fields__content3 t__split_fields14)) o33))
...
;; H
  ...
  (and
  (and
  (= o34 (position1 (mk___rep3 (us_split_fields__content3 t__split_fields14))
         o33))
  (position__function_guard1 o34
  (mk___rep3 (us_split_fields__content3 t__split_fields14)) o33))
  (and (in_range5 o34)
  (= o34 (position
         (rec__search_trees__search_tree__struct
         (us_split_fields__content3 t__split_fields14)) o33)))))
...
;; H
  ...
  (parent
  (rec__search_trees__search_tree__struct
  (us_split_fields__content3 t__split_fields14)) o30)
  (rec__search_trees__search_tree__struct
  (us_split_fields__content3 t__split_fields14)) o30))
...
;; H
  ...
  (and
  (and
  (= o31 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14))
         o30))
  (parent__function_guard1 o31
