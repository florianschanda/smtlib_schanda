...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2095 o46))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2095 o46)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o46))
...
;; H
  (assert (= o47 (select temp___2095 i1)))
...
;; H
  (assert (valid_root__function_guard
  (valid_root (rec__search_trees__search_tree__struct t__split_fields10) o45)
  (rec__search_trees__search_tree__struct t__split_fields10) o45))
