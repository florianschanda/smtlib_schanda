...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1153 o46))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1153 o46)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o46))
...
;; H
  (assert (= o47 (select temp___1153 i1)))
...
;; H
  (assert
  (and (= o50 (length o49)) (and (in_range6 o50) (<= (+ 0 o50) 2147483647))))
