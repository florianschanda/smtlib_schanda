...
;; H
  (assert (= temp___1695 (mk___rep4 o132)))

;; H
  (assert (= result36 t__split_fields34))

;; H
  (assert (= t__split_fields36 (us_split_fields9 temp___1695)))
...
;; H
  (assert (model____function_guard
  (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c113b)))
  (rec__red_black_trees__rbt__struct (us_split_fields9 c113b))))

;; H
  (assert (nb_blacks__function_guard (nb_blacks c113b) c113b))

;; H
  (assert (root__function_guard
  (root (rec__red_black_trees__rbt__struct (us_split_fields9 c114b)))
  (rec__red_black_trees__rbt__struct (us_split_fields9 c114b))))
...
;; H
  (assert (nb_blacks__function_guard (nb_blacks c114b) c114b))
...
;; H
  ...
  (eq (select (nb_blacks c114b) i) (select (nb_blacks c113b) i))
  (select (nb_blacks c114b) i) (select (nb_blacks c113b) i)))
