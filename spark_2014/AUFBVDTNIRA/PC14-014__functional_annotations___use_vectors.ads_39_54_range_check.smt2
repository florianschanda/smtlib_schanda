...
(declare-fun temp___435 () tcount_typeB)

(declare-fun temp___4351 () us_main_type)
...
;; H
  ...
  (get (model__ (mk___rep v2__split_discrs v2__split_fields12)) n1))
  (get (model__ v1) n1)
  (get (model__ (mk___rep v2__split_discrs v2__split_fields12)) n1))))
...
;; H
  (assert
  (=> (and (<= first i1) (<= i1 r1b))
  (and (= v2__split_discrs (mk___split_discrs temp___435))
  (= temp___4351 v2__split_fields))))

;; H
  (assert (=> (and (<= first i1) (<= i1 r1b)) (= temp___434 i1)))
