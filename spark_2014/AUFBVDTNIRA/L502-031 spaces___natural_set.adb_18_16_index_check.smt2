...
(declare-fun temp___220 () set_length)

(declare-fun temp___2201 () (Array Int element_t))
...
;; H
  (assert (= temp___220 o3))

;; H
  (assert (= temp___2201 o4))
...
;; H
  (assert (= temp___220 s__split_fields2))

;; H
  (assert (= temp___2201 s__split_fields3))
