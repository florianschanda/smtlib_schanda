...
;; add__post_axiom
  ...
  (! (=>
     ...
     (and (eq result (add RNE2 r1 r2)) (dynamic_invariant result true false
...
;; H
  (assert
  (and
  (and (= o (add1 fliteral2 fliteral3)) (add__function_guard o fliteral2
  fliteral3)) (and (tqtisFinite o) (eq o (add RNE2 fliteral2 fliteral3)))))

;; H
  (assert
  (and (and (= o1 (add1 fliteral4 o)) (add__function_guard o1 fliteral4 o))
  (and (tqtisFinite o1) (eq o1 (add RNE2 fliteral4 o)))))
