...
(define-fun dynamic_invariant ((temp___expr_3460 us_t1)
  ...
  (temp___do_toplevel_3459 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_3460))
                                       (and (= (first3 temp___expr_3460) 1)
                                       (= (last4 temp___expr_3460) 2)))))
...
(define-fun dynamic_invariant1 ((temp___expr_3476 us_t2)
  ...
  (temp___do_toplevel_3475 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_3476))
                                       (and (= (first5 temp___expr_3476) 1)
                                       (= (last6 temp___expr_3476) 2)))))
...
;; H
  (assert
  (and
  (and (= temp___76832 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___76832 reg)) (dynamic_invariant1
  temp___76832 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___76831)) (to_rep (last5 temp___76831)))
     (+ (- (to_rep (last5 temp___76831)) (to_rep (first4 temp___76831))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76831)) (to_rep (last5 temp___76831))) 
  temp___76841))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___76841)) (to_rep (last3 temp___76841)))
     (+ (- (to_rep (last3 temp___76841)) (to_rep (first2 temp___76841))) 1)
