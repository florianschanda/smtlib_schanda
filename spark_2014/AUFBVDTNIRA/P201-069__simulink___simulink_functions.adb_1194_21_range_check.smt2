...
;; H
  (assert
  (and
  (and (= o (atan2__2 (to_float64 RNE2 left) (to_float64 RNE2 right)))
  (atan2__2__function_guard o (to_float64 RNE2 left)
  (to_float64 RNE2 right))) (tqtisFinite1 o)))

;; H
  (assert (= o1 (to_float32 RNE2 o)))
