...
(define-fun bit_position__ref_7__projection ((a bit_position__ref)) bit_position 
  (bit_position__content a))

(define-fun dynamic_invariant1 ((temp___expr_799 Int)
  (temp___is_init_796 Bool) (temp___skip_constant_797 Bool)
  (temp___do_toplevel_798 Bool)) Bool (=>
                                      (or (= temp___is_init_796 true)
                                      (<= 0 63)) (in_range1 temp___expr_799)))
...
;; lemma6__def_axiom
  ...
  (! (=> (lemma6__function_guard1 (lemma61 us_void_param) us_void_param)
     ...
     (=> (not (= val__ ((_ int2bv 64) 0)))
     (and (= (shift_right val__ 0) val__)
     (exists ((n Int))
     (and (and (<= 0 n) (<= n 63))
     (and
     (and (= (shift_right val__ n) ((_ int2bv 64) 1))
     (forall ((j Int))
     (=> (and (<= 0 j) (<= j n))
     (bvuge (shift_right val__ j) ((_ int2bv 64) 1)))))
     (forall ((j Int))
     (=> (and (<= n j) (<= j 63))
     (bvule (shift_right val__ j) ((_ int2bv 64) 1))))))))))))))))) :pattern (
...
(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result () Int)

(declare-fun temp___1430 () Int)

(declare-fun temp___1429 () Int)
...
(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result1 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result2 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result3 () Int)

(declare-fun result__13 () Int)

(declare-fun i12 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result4 () int__ref)

(declare-fun result__14 () Int)

(declare-fun i13 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result5 () Int)
...
;; H
  (assert (=> (and (<= 0 i1) (<= i1 63)) (= temp___1430 i1)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 63)) (= temp___1429 result__)))

;; H
  (assert
  (=> (and (<= 0 i1) (<= i1 63)) (= (mk_int__ref result1) result__18)))
...
;; H
  ...
  (or
  (and
  (and (and (= i1 i6) (= result__2 result__7))
  ...
  (= o (ite (and (<= 1 64) (<= 64 8))
       ((_ zero_extend 56) (ite (< i1 8)
                           (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) 
                           i1)) ((_ int2bv 8) 0)))
       (ite (and (<= 9 64) (<= 64 16))
       ((_ zero_extend 48) (ite (< i1 16)
                           (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) 
                           i1)) ((_ int2bv 16) 0)))
       (ite (and (<= 17 64) (<= 64 32))
       ((_ zero_extend 32) (bvlshr ((_ extract 31 0) value) ((_ int2bv 32) 
       i1))) (bvlshr value ((_ int2bv 64) i1)))))))
  (= result2 (ite (= o ((_ int2bv 64) 1)) true false))) (= result2 true)))
  (and
  (and
  (and
  (and
  ...
  (= o (ite (and (<= 1 64) (<= 64 8))
       ...
       ((_ zero_extend 32) (bvlshr ((_ extract 31 0) value) ((_ int2bv 32) 
       i1))) (bvlshr value ((_ int2bv 64) i1)))))))
  (= result2 (ite (= o ((_ int2bv 64) 1)) true false)))
  (not (= result2 true)))
  (and
  (and (and (= i15 (mk_int__ref i4)) (= result__17 (mk_int__ref result__5)))
  (and (= i7 i5) (= result__8 result__6)))
  (and
  (forall ((j Int))
  (=> (and (<= 0 j) (<= j i2))
  (bvugt (shift_right value j) ((_ int2bv 64) 1))))
  (and
  (and
  (and (=> (<= 0 63) (in_range1 result__3)) (=> (<= 0 63) (in_range1 i2)))
  (and (<= 0 i2) (<= i2 63)))
  (or
  (and
  (and (and (= i2 i4) (= result__3 result__5))
  (and (= i5 i2) (= result__6 result__3))) (= i2 63))
  (and (not (= i2 63))
  (and
  (and (and (= i3 i4) (= result__4 result__5))
  (and (= i5 i3) (= result__6 result__4)))
  ...
  (= o1 (ite (and (<= 1 64) (<= 64 8))
        ((_ zero_extend 56) (ite (< i3 8)
                            (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) 
                            i3)) ((_ int2bv 8) 0)))
        (ite (and (<= 9 64) (<= 64 16))
        ((_ zero_extend 48) (ite (< i3 16)
                            (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) 
                            i3)) ((_ int2bv 16) 0)))
        (ite (and (<= 17 64) (<= 64 32))
        ((_ zero_extend 32) (bvlshr ((_ extract 31 0) value) ((_ int2bv 32) 
        i3))) (bvlshr value ((_ int2bv 64) i3)))))))
  (= result5 (ite (= o1 ((_ int2bv 64) 1)) true false))) (= result5 true))))))))))))))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result1 
  bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result2))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result3 
  bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result1))

;; H
  (assert
  (= result6 bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result4 
  (mk_int__ref
  bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result2)))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result5 
  bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result3))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 10, characters 0-0
  ...
  (= (shift_right value
     (int__content
     bits_manipulation_unsigned__unsigned_64__functions__msb_index_slow_inline_always__result4)) ((_ int2bv 64) 1))))
(check-sat)
