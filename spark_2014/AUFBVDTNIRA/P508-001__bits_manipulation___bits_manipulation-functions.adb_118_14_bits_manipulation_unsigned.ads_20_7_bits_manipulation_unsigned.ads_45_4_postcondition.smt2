...
(define-fun dynamic_invariant1 ((temp___expr_351 Int)
  ...
  (temp___do_toplevel_350 Bool)) Bool (=>
                                      ...
                                      (<= 0 63)) (in_range1 temp___expr_351)))
...
(declare-fun temp___462 () Int)

(declare-fun temp___461 () Int)
...
;; H
  (assert (=> (and (<= 0 i1) (<= i1 63)) (= temp___462 i1)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 63)) (= temp___461 result__)))
