...
(declare-fun r__split_fields7 () length_type)
...
;; H
  (assert (is_empty__function_guard (is_empty (mk___rep r__split_fields9))
  (mk___rep r__split_fields9)))

;; H
  (assert (= (is_empty (mk___rep r__split_fields9)) true))
...
;; H
  (assert (head__function_guard (head (mk___rep r__split_fields8))
...
;; H
  ...
  (= (head (mk___rep r__split_fields8)) h1)) (in_range h1)))
