...
(define-fun dynamic_invariant5 ((temp___expr_458 us_rep)
  (temp___is_init_455 Bool) (temp___skip_constant_456 Bool)
  (temp___do_toplevel_457 Bool)) Bool (=>
                                      (not (= temp___skip_constant_456 true))
                                      (in_range7 r31b temp___expr_458)))

(define-fun default_initial_assumption ((temp___expr_460 us_rep)
  (temp___skip_top_level_461 Bool)) Bool (and
                                         (= (to_rep
                                            (rec__amortized_queue__my_vectors__vector__capacity
                                            (us_split_discrs1
                                            temp___expr_460))) r31b)
                                         (=>
                                         (not
...
(declare-fun amortized_queue__Oconcat__3__result () capacity_range)

(declare-fun amortized_queue__Oconcat__3__result1 () us_main_type)

(declare-fun o () Int)

(declare-fun amortized_queue__Oconcat__3__R30b__R31b__assume () Int)

(declare-fun us () Int)

(declare-fun amortized_queue__Oconcat__3__L_4__R33b__assume () Int)

(declare-fun amortized_queue__Oconcat__3__L_4__R34b__assume () Int)

(declare-fun temp___552 () capacity_range)

(declare-fun temp___5521 () us_main_type)

(declare-fun temp___551 () Int)
...
(declare-fun result3 () vector__ref)

(declare-fun amortized_queue__Oconcat__3__result2 () us_rep)

(declare-fun result____split_fields9 () us_split_fields__ref)

(declare-fun idx7 () int__ref)

(declare-fun amortized_queue__Oconcat__3__result3 () vector__ref)

(declare-fun result____split_fields10 () us_split_fields)

(declare-fun idx8 () Int)

(declare-fun amortized_queue__Oconcat__3__result4 () us_rep)

(declare-fun result____split_fields11 () us_split_fields__ref)

(declare-fun idx9 () int__ref)

(declare-fun amortized_queue__Oconcat__3__result5 () vector__ref)

(declare-fun result____split_fields12 () us_split_fields)

(declare-fun idx10 () Int)

(declare-fun amortized_queue__Oconcat__3__result6 () us_rep)
...
(define-fun result____split_fields13 () us_split_fields (mk___split_fields
...
(define-fun result____split_fields14 () us_split_fields__ref (mk___split_fields__ref
                                                             (mk___split_fields
...
;; H
  (assert
  (= amortized_queue__Oconcat__3__result3 (mk_vector__ref
                                          amortized_queue__Oconcat__3__result2)))
...
;; H
  (assert
  (= amortized_queue__Oconcat__3__result4 amortized_queue__Oconcat__3__result2))
...
;; H
  (assert
  (=> (and (<= r33b idx1) (<= idx1 r34b))
  (and (= result____split_discrs (mk___split_discrs temp___552))
  (= result____split_fields temp___5521))))

;; H
  (assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= temp___551 idx1)))

;; H
  (assert
  (=> (and (<= r33b idx1) (<= idx1 r34b)) (and (= o1 idx1) (in_range3 idx1))))
...
;; H
  (assert
  (=> (and (<= r33b idx1) (<= idx1 r34b))
  (= (mk___split_fields__ref (mk___split_fields result1)) result____split_fields14)))
...
;; H
  (assert
  (=> (and (<= r33b idx1) (<= idx1 r34b))
  (= (length (mk___rep result____split_discrs result____split_fields13)) 
  idx2)))
...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 idx2))
  (= (get
     (model__ (mk___rep result____split_discrs result____split_fields13)) i1) 
  (get (model__ left) i1))))))

;; H
  (assert
  (=> (and (<= r33b idx1) (<= idx1 r34b))
  (and (=> (<= r33b r34b) (dynamic_property r33b r34b idx2))
  (and (<= r33b idx2) (<= idx2 r34b)))))
...
;; H
  (assert
  (=> (and (<= r33b idx1) (<= idx1 r34b)) (= idx3 (mk_int__ref idx2))))
...
;; H
  (assert
  (=> (and (<= r33b idx1) (<= idx1 r34b))
  (= result____split_fields5 result____split_fields13)))
...
;; H
  (assert
  (=> (not (and (<= r33b idx1) (<= idx1 r34b))) (= idx5 (mk_int__ref idx1))))

;; H
  (assert
  (=> (not (and (<= r33b idx1) (<= idx1 r34b)))
  (= result____split_fields6 result____split_fields14)))
...
;; H
  ...
  (= (get
     ...
     (+ (last
        (model__
        (mk___rep result____split_discrs
        (us_split_fields__content result____split_fields6)))) 1)) right)))
...
;; H
  (assert
  (= result3 (mk_vector__ref
             (mk___rep
             (mk___split_discrs amortized_queue__Oconcat__3__result)
             (mk___split_fields amortized_queue__Oconcat__3__result1)))))

;; H
  (assert
  (= amortized_queue__Oconcat__3__result2 (mk___rep result____split_discrs
                                          result____split_fields8)))

;; H
  (assert
  (= amortized_queue__Oconcat__3__result5 amortized_queue__Oconcat__3__result3))
...
;; H
  (assert
  (= amortized_queue__Oconcat__3__result6 amortized_queue__Oconcat__3__result4))
...
;; H
  (assert
  (and (= o7 (length left)) (and (in_range5 o7) (<= o7 (capacity left)))))
...
;; H
  (assert
  (and (= o9 (length (vector__content amortized_queue__Oconcat__3__result5)))
  (and (in_range5 o9)
  (<= o9 (capacity (vector__content amortized_queue__Oconcat__3__result5))))))
...
;; H
  (assert
  (and (= o5 (last (model__ left)))
  (and (in_range4 o5) (= o5 (last (model__ left))))))

;; H
  (assert (= o6 (ite (<= i o5) true false)))

;; H
  (assert (= result6 (ite (<= 1 i) o6 false)))

;; H
  (assert
  (= (= result5 true)
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (last (model__ left))))
  (= (get (model__ (vector__content amortized_queue__Oconcat__3__result5))
     i1) (get (model__ left) i1))))))
...
;; H
  (assert
  (and (= o3 (last (model__ left)))
  (and (in_range4 o3) (= o3 (last (model__ left))))))
