...
(declare-fun temp___1400 () us_rep2)
...
(declare-fun src12 () t__ref1)

(declare-fun dst12 () t__ref1)

(declare-fun final_dst5 () t__ref1)
...
(declare-fun src13 () (_ BitVec 64))

(declare-fun dst13 () (_ BitVec 64))

(declare-fun final_dst6 () (_ BitVec 64))
...
(define-fun final_src7 () t__ref1 (mk_t__ref1 final_src))

(define-fun final_dst7 () t__ref1 (mk_t__ref1 final_dst))

(define-fun dst14 () t__ref1 (mk_t__ref1 dst))

(define-fun src14 () t__ref1 (mk_t__ref1 src))

(define-fun tmp_b5 () map__ref (mk_map__ref tmp_b))

(define-fun n5 () t__ref1 (mk_t__ref1 n))

(define-fun ctx__split_fields26 () us_split_fields__ref2 (mk___split_fields__ref2
                                                         (mk___split_fields2
                                                         (mk___rep1
                                                         (mk___split_fields1
                                                         (mk___rep
...
;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0)) (= result2 n5)))
...
;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= result3 src14))))

;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= src2 c237b))))
...
;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= result4 dst14))))

;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= dst2 o1))))
...
;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= result5 final_dst7))))

;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= final_dst2 o2))))

;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= result6 final_src7))))
...
;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= temp___1394 dst2))))

;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= temp___1393 src2))))
...
;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= o3 src2))))
...
;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= o7 temp___1388))))
...
;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= result7 ctx__split_fields26))))
...
;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= dst4 (mk_t__ref1 dst3)))))

;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= src4 (mk_t__ref1 src3)))))

;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= dst5 dst3))))

;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= src5 src3))))
...
;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= final_dst4 final_dst2))))
...
;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (not (bvugt c238b ((_ int2bv 64) 0))) (= final_src3 final_src7))))

;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (not (bvugt c238b ((_ int2bv 64) 0))) (= final_dst3 final_dst7))))

;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (not (bvugt c238b ((_ int2bv 64) 0))) (= dst10 dst14))))

;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (not (bvugt c238b ((_ int2bv 64) 0))) (= src10 src14))))

;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (not (bvugt c238b ((_ int2bv 64) 0)))
  (= ctx__split_fields20 ctx__split_fields26))))
...
;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (not (bvugt c238b ((_ int2bv 64) 0))) (= dst11 dst1))))

;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (not (bvugt c238b ((_ int2bv 64) 0))) (= src11 src1))))
...
;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (= ctx__split_fields23 (us_split_fields5 temp___1400))))
...
;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (= final_dst5 final_dst3)))

;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0)) (= dst12 dst10)))

;; H
  (assert
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0)) (= src12 src10)))
...
;; H
  ...
  (= final_src5 final_src7)))

;; H
  (assert
  (=> (not (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0)))
  (= final_dst5 final_dst7)))
...
;; H
  (assert
  (=> (not (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))) (= n3 n5)))
...
;; H
  (assert
  (=> (not (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0)))
  (= ctx__split_fields24 ctx__split_fields26)))
...
;; H
  (assert (= result13 (mk_t__ref1 block_count)))

;; H
  (assert (= block_count1 o17))
...
;; WP_parameter_def
 ;; File "skein.ads", line 361, characters 0-0
  ...
  (us_split_fields3
  (rec__skein__skein_512_context__h
  (us_split_fields__content2 ctx__split_fields24))))))))
(check-sat)
