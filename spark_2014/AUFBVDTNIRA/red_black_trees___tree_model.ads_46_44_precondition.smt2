...
;; H
  (assert
  (and (= o14 (length q)) (and (in_range3 o14) (<= (+ 0 o14) 2147483647))))

;; H
  (assert
  (and (= o11 (length v)) (and (in_range3 o11) (<= (+ 0 o11) 2147483647))))

;; H
  (assert
  (and (= o12 (length p)) (and (in_range3 o12) (<= (+ 0 o12) 2147483647))))
...
;; H
  (assert (= result2 (ite (= o15 o14) true false)))

;; H
  (assert
  (=> (= result2 true)
  (and (= o9 (length q)) (and (in_range3 o9) (<= (+ 0 o9) 2147483647)))))

;; H
  (assert (=> (= result2 true) (= o10 (ite (<= i2 o9) true false))))

;; H
  (assert (=> (= result2 true) (= result3 (ite (<= 1 i2) o10 false))))
...
;; H
  ...
  (= (= result1 true)
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 (length q))) (= (get p i3) (get q i3)))))))
...
;; H
  (assert (=> (= result1 true) (= result4 (ite (<= 1 i1) o8 false))))
...
;; H
  ...
  (= (= result true)
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 (length v)))
  (= (get p (+ i3 (length q))) (get v i3)))))))
...
;; H
  (assert
  (and (= o3 (length p)) (and (in_range3 o3) (<= (+ 0 o3) 2147483647))))
