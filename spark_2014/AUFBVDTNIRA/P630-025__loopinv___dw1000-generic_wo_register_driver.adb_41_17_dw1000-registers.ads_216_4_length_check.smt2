...
(define-fun dynamic_invariant ((temp___expr_2221 us_t1)
  ...
  (temp___do_toplevel_2220 Bool)) Bool (=>
                                       ...
                                       (last4 temp___expr_2221))
                                       (and (= (first3 temp___expr_2221) 1)
                                       (= (last4 temp___expr_2221) 1024)))))
...
(define-fun dynamic_invariant1 ((temp___expr_2240 us_t2)
  ...
  (temp___do_toplevel_2239 Bool)) Bool (=>
                                       ...
                                       (last6 temp___expr_2240))
                                       (and (= (first5 temp___expr_2240) 1)
                                       (= (last6 temp___expr_2240) 1024)))))
...
;; H
  (assert
  (and
  (and (= temp___75742 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___75742 reg)) (dynamic_invariant1
  temp___75742 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___75741)) (to_rep (last5 temp___75741)))
     (+ (- (to_rep (last5 temp___75741)) (to_rep (first4 temp___75741))) 1)
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___75741)) (to_rep (last5 temp___75741))) 
  temp___75751))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___75751)) (to_rep (last3 temp___75751)))
     (+ (- (to_rep (last3 temp___75751)) (to_rep (first2 temp___75751))) 1)
