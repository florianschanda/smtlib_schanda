...
;; H
  (assert
  (and (= o (sub RNE2 new_value prior_value)) (tqtisFinite
  (sub RNE2 new_value prior_value))))
...
;; H
  (assert
  (and (= o2 (sub RNE2 new_value prior_value)) (tqtisFinite
  (sub RNE2 new_value prior_value))))

;; H
  (assert (= o3 (div1 RNE2 o2 smoothing_factor)))

;; H
  (assert (and (= o4 o3) (tqtisFinite o3)))

;; H
  (assert (= o5 (add RNE2 prior_value o4)))
