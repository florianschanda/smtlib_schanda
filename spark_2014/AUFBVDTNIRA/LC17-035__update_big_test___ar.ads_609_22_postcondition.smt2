...
(define-fun bool_eq5 ((a (Array Int (Array Int (Array Int (Array Int et1)))))
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq4 (select a temp___idx_135) 1 16
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 604, characters 0-0
  (not (in_range2 (to_rep (select (select (select (select a2 m) n) o) p)))))
(check-sat)
