...
;; H
  ...
  (= o13 (stack_entry o12
         (mk___split_fields my_stack__split_fields6 my_stack__split_fields7)))
  (stack_entry__function_guard o13 o12
  (mk___split_fields my_stack__split_fields6 my_stack__split_fields7)))
...
;; H
  (assert
  (and
  (and (= o9 (max_stack_size Tuple0)) (max_stack_size__function_guard 
  o9 Tuple0)) (and (in_range2 o9) (= o9 100))))
