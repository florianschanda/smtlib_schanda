...
(define-fun a__split_discrs2 () us_split_discrs (mk___split_discrs
                                                a__split_discrs1))

(define-fun a__split_fields2 () us_split_fields (mk___split_fields
                                                a__split_fields1))
...
;; H
  (assert (= b__split_fields2 a__split_fields2))

;; H
  (assert (= b__split_discrs a__split_discrs2))
...
;; WP_parameter_def
 ;; File "constrained_attribute.ads", line 6, characters 0-0
  ...
  (not
  (= (is_constrained
     (mk___rep a__split_discrs2 a__split_fields2 a__attr__constrained)) true))))
(check-sat)
