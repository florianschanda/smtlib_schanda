...
;; H
  (assert
  (=> (and (<= 0 i1) (<= i1 7)) (and (= o8 (* i2 8)) (in_range1 (* i2 8)))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (and (= o9 o8) (in_range2 o8))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= o10 ((_ int2bv 64) o9))))
...
;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= o7 (to_rep o6))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= o11 ((_ zero_extend 56) o7))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= o12 (bvshl o11 o10))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= o13 (bvor lane2 o12))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= result9 (mk_t__ref1 lane2))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= lane3 o13)))
...
;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= lane4 (mk_t__ref1 lane3))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= i4 i2)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= lane5 lane3)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= i5 i3)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= lane6 lane4)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= i6 i4)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= lane7 lane5)))

;; H
  (assert (=> (not (and (<= 0 i1) (<= i1 7))) (= i5 (mk_int__ref i1))))

;; H
  (assert (=> (not (and (<= 0 i1) (<= i1 7))) (= lane6 (mk_t__ref1 lane1))))

;; H
  (assert (=> (not (and (<= 0 i1) (<= i1 7))) (= i6 i1)))

;; H
  (assert (=> (not (and (<= 0 i1) (<= i1 7))) (= lane7 lane1)))

;; H
  (assert
  (= (to_rep2 o14) (bvxor (to_rep2 (get a x2 y2)) (t__content1 lane6))))

;; H
  (assert (= o15 (set a x2 y2 o14)))

;; H
  (assert (= result10 (mk_map__ref1 a)))
...
;; H
  (assert (=> (= x3 ((_ int2bv 8) 0)) (= result12 (mk_t__ref y2))))

;; H
  (assert (=> (= x3 ((_ int2bv 8) 0)) (= y3 o17)))
