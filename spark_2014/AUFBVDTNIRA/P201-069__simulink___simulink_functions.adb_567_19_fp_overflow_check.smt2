...
;; H
  (assert (tqtisFinite left))

;; H
  (assert (tqtisFinite right))

;; H
  (assert
  (and (= o (div1 RNE2 left right)) (tqtisFinite (div1 RNE2 left right))))

;; H
  (assert (= o1 (roundToIntegral RTZ2 o)))

;; H
  (assert (= o2 (mul RNE2 o1 right)))

;; H
  (assert (and (= o3 o2) (tqtisFinite o2)))

;; H
  (assert (= o4 (sub RNE2 left o3)))
