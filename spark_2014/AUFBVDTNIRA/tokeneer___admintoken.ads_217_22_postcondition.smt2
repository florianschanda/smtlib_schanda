...
;; theauthcertrole__post_axiom
  ...
  (! (let ((result (theauthcertrole admintoken__authcert__fields)))
     ...
     admintoken__authcert__fields) (dynamic_invariant3 result true false
...
;; theauthcertrole__def_axiom
  ...
  (! (=> (theauthcertrole__function_guard
     ...
     (therole
     (rec__admintoken__validauthcertt__contents
     (us_split_fields15 (mk___rep7 admintoken__authcert__fields))))
     (rec__admintoken__validauthcertt__contents
     (us_split_fields15 (mk___rep7 admintoken__authcert__fields))))
...
;; therole__post_axiom
  ...
  (! (let ((result (therole contents)))
     (=> (therole__function_guard result contents) (dynamic_invariant3 result
...
;; H
  ...
  (isgood (us_split_fields__content8 idcert__split_fields2))
  (us_split_fields__content8 idcert__split_fields2)))
