...
;; H
  (assert (to____function_guard (to__ (mk___rep s__split_fields5))
  (mk___rep s__split_fields5)))
...
;; H
  (assert
  (= (let ((temp___203 (to__ (mk___rep s__split_fields5))))
     (bool_eq1 (elts temp___203) (to_rep (first (rt temp___203)))
     (to_rep (last (rt temp___203)))
     (let ((temp___202 (temp___197 o3)))
     (let ((temp___201 (to__ (mk___rep s__split_fields4))))
     (ite (= (length temp___201) 0) temp___202
     (concat1 (elts temp___201) (to_rep (first (rt temp___201)))
     (to_rep (last (rt temp___201))) temp___202 1 1))))
     (to_rep
