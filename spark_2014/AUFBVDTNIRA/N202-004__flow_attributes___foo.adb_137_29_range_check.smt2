...
(define-fun bool_eq10 ((x us_t2)
  (y us_t2)) Bool (bool_eq7 (elts2 x) (to_rep1 (first5 (rt2 x)))
...
;; def_axiom
  ...
  (and (= (first6 temp___303) temp___305) (= (last6 temp___303) temp___306)))
...
;; H
  (assert
  (= (mk1 (to_rep1 (first5 temp___3091)) (to_rep1 (last5 temp___3091))) 
  temp___3101))
