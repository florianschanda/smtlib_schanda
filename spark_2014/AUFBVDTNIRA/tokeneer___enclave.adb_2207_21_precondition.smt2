...
;; H
  (assert
  (=> (= (int__content status3) 8) (= o19 (ite (= o18 0) true false))))
...
;; H
  (assert
  (=> (= (int__content status3) 8)
  (= o20 (ite (not (= o17 true)) true false))))

;; H
  (assert
  (=> (= (int__content status3) 8) (= o21 (ite (= o20 true) o19 false))))

;; H
  (assert (=> (not (= (int__content status3) 8)) (= o21 (of_int 1))))
...
;; H
  (assert
  (=> (= (int__content status3) 3) (= o14 (ite (= o13 o12) true false))))
...
;; H
  (assert
  (=> (= (int__content status3) 3)
  (= o15 (ite (not (= o11 true)) true false))))

;; H
  (assert
  (=> (= (int__content status3) 3) (= o16 (ite (= o15 true) o14 false))))

;; H
  (assert (=> (not (= (int__content status3) 3)) (= o16 (of_int 1))))
...
;; H
  (assert
  (=> (=> (not (= (int__content status3) 6)) (= (int__content status3) 7))
  (= o9 (ite (= o5 true) o4 false))))

;; H
  (assert
  (=> (=> (not (= (int__content status3) 6)) (= (int__content status3) 7))
  (= o10 (ite (= o9 true) o8 false))))
