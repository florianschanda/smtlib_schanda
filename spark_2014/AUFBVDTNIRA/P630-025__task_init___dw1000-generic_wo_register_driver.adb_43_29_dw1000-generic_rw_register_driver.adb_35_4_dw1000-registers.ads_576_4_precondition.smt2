...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__lde_rxantd_type__lde_rxantd bits_16)))))
(define-fun us_split_fields_LDE_RXANTD__projection ((a us_split_fields)) bits_16 
  (rec__dw1000__register_types__lde_rxantd_type__lde_rxantd a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_84__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_84__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq6 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__lde_rxantd_type__lde_rxantd
...
(declare-fun dw1000__register_types__lde_rxantd_type__lde_rxantd__first__bit () Int)

(declare-fun dw1000__register_types__lde_rxantd_type__lde_rxantd__last__bit () Int)

(declare-fun dw1000__register_types__lde_rxantd_type__lde_rxantd__position () Int)

;; dw1000__register_types__lde_rxantd_type__lde_rxantd__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__lde_rxantd_type__lde_rxantd__first__bit))

;; dw1000__register_types__lde_rxantd_type__lde_rxantd__last__bit_axiom
  (assert
  (< dw1000__register_types__lde_rxantd_type__lde_rxantd__first__bit 
  dw1000__register_types__lde_rxantd_type__lde_rxantd__last__bit))

;; dw1000__register_types__lde_rxantd_type__lde_rxantd__position_axiom
  (assert
  (<= 0 dw1000__register_types__lde_rxantd_type__lde_rxantd__position))

(declare-fun dummy5 () us_rep)

(declare-datatypes ()
((lde_rxantd_type__ref
 (mk_lde_rxantd_type__ref (lde_rxantd_type__content us_rep)))))
(define-fun lde_rxantd_type__ref___projection ((a lde_rxantd_type__ref)) us_rep 
  (lde_rxantd_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_203__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_143__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_143__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6679 us_t1)
  (temp___is_init_6676 Bool) (temp___skip_constant_6677 Bool)
  (temp___do_toplevel_6678 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6677 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6679)
                                       (last4 temp___expr_6679))
                                       (and (= (first3 temp___expr_6679) 1)
                                       (= (last4 temp___expr_6679) 2)))))
...
(define-fun target__ref_61__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_61__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_6695 us_t2)
  (temp___is_init_6692 Bool) (temp___skip_constant_6693 Bool)
  (temp___do_toplevel_6694 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6693 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_6695)
                                       (last6 temp___expr_6695))
                                       (and (= (first5 temp___expr_6695) 1)
                                       (= (last6 temp___expr_6695) 2)))))
...
(declare-fun temp___8011 () (Array Int bits_8))

(declare-fun temp___80111 () t2)

(declare-fun temp___8012 () (Array Int bits_8))

(declare-fun temp___80121 () t1)
...
(define-fun temp___80112 () us_t2 (mk___t2 temp___8011 temp___80111))
...
;; H
  (assert
  (and
  (and (= temp___80112 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___80112 reg)) (dynamic_invariant1
  temp___80112 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80111)) (to_rep (last5 temp___80111)))
     (+ (- (to_rep (last5 temp___80111)) (to_rep (first4 temp___80111))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___8011 temp___8012))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80111)) (to_rep (last5 temp___80111))) 
  temp___80121))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___80121)) (to_rep (last3 temp___80121)))
     (+ (- (to_rep (last3 temp___80121)) (to_rep (first2 temp___80121))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___8012 temp___80121)))
