...
;; H
  (assert
  (and (= o28 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o28 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o27 (from_word64 i2)) (from_word64__function_guard o27 i2)))

;; H
  (assert (and (= o29 (oadd o27 o28)) (oadd__function_guard o29 o27 o28)))

;; H
  (assert
  (and (= o26 (from_integer j3)) (from_integer__function_guard o26 j3)))

;; H
  (assert (and (= o30 (ole o26 o29)) (ole__function_guard o30 o26 o29)))

;; H
  (assert (and (= o24 (+ k 1)) (in_range1 (+ k 1))))

;; H
  (assert (= o25 (ite (<= j3 o24) true false)))

;; H
  (assert
  (and (= o21 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o21 ((_ int2bv 32) 2))))

;; H
  (assert (and (= o22 (oexpon o21 j3)) (oexpon__function_guard o22 o21 j3)))

;; H
  (assert
  (and (= o16 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o16 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o15 (from_integer j3)) (from_integer__function_guard o15 j3)))

;; H
  (assert
  (and (= o17 (osubtract o15 o16)) (osubtract__function_guard o17 o15 o16)))

;; H
  (assert
  (and (= o14 (from_word64 i2)) (from_word64__function_guard o14 i2)))

;; H
  (assert
  (and (= o18 (osubtract o14 o17)) (osubtract__function_guard o18 o14 o17)))

;; H
  (assert
  (and (= o13 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o13 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o19 (oexpon__2 o13 o18)) (oexpon__2__function_guard o19 o13 o18)))
...
;; H
  (assert
  (and (= o12 (num_of_big_int e e_first o11)) (num_of_big_int__function_guard
  o12 e e_first o11)))

;; H
  (assert
  (and (= o20 (odivide o12 o19)) (odivide__function_guard o20 o12 o19)))

;; H
  (assert (and (= o23 (omod o20 o22)) (omod__function_guard o23 o20 o22)))
