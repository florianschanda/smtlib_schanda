...
;; H
  (assert (number_of_oranges__function_guard
  (number_of_oranges apples1 oranges1 price_of_apple1 price_of_orange1
  extra_cost1) apples1 oranges1 price_of_apple1 price_of_orange1
  extra_cost1))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (<= o12 (number_of_oranges apples1 oranges1 price_of_apple1
          price_of_orange1 extra_cost1))))
(check-sat)
