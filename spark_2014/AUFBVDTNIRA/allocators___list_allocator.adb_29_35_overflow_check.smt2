...
;; H
  (assert
  (and (= o4 (length model____split_fields))
  (and (in_range6 o4) (<= (+ 0 o4) 2147483647))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o3 (length1 model____split_fields1)) (in_range6 o3))))
...
;; H
  (assert
  (and (= o1 (length model____split_fields))
  (and (in_range6 o1) (<= (+ 0 o1) 2147483647))))
