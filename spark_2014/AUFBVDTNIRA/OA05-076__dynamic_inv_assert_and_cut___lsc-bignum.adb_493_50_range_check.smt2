...
;; H
  (assert
  (and (= o20 (num_of_big_int m m_first o19)) (num_of_big_int__function_guard
  o20 m m_first o19)))
...
;; H
  (assert
  (and (and (= o15 (base Tuple0)) (base__function_guard o15 Tuple0))
  (= o15 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert
  (and (= o17 (oexpon o15 o16)) (oexpon__function_guard o17 o15 o16)))

;; H
  (assert (and (= o10 (* 2 n)) (in_range1 (* 2 n))))
...
;; H
  (assert
  (and (= o9 (num_of_big_int x x_first o8)) (num_of_big_int__function_guard
  o9 x x_first o8)))

;; H
  (assert (and (= o14 (oexpon o9 o13)) (oexpon__function_guard o14 o9 o13)))

;; H
  (assert
  (and (= o18 (omultiply o14 o17)) (omultiply__function_guard o18 o14 o17)))

;; H
  (assert (and (= o21 (omod o18 o20)) (omod__function_guard o21 o18 o20)))
