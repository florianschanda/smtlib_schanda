...
;; H
  (assert
  (=> (= result2 true) (and (= temp___163 (+ y l1)) (in_range1 (+ y l1)))))
...
;; H
  (assert (=> (= result2 true) (= o2 temp___163)))
...
;; H
  (assert
  (=> (= result2 true) (and (= temp___162 (+ x l1)) (in_range1 (+ x l1)))))

;; H
  (assert
  (=> (= result2 true)
  (and (<= (to_rep (first (rt a))) temp___162)
  (<= temp___162 (to_rep (last (rt a)))))))

;; H
  (assert (=> (= result2 true) (= o temp___162)))
...
;; H
  (assert (=> (= result1 true) (= temp___158 l1)))

;; H
  (assert (=> (= result1 true) (= 0 temp___161)))
...
;; H
  ...
  (and
  (and (<= (+ x l2) (to_rep (last (rt a))))
  (<= (+ y l2) (to_rep (last (rt a)))))
  (= (to_rep (select (elts a) (+ x l2))) (to_rep (select (elts a) (+ y l2))))))))

;; H
  (assert (=> (= result1 true) (= temp___1611 result4)))

;; H
  (assert (=> (= result1 true) (= temp___1612 l2)))
...
;; H
  ...
  (=> (= result1 true)
  (=> (= result8 true)
  (= result7 (ite (<= o15 (to_rep (last (rt a)))) true false)))))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (= result7 true) (and (= temp___1631 (+ y l3)) (in_range1 (+ y l3))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (= result7 true)
  (and (<= (to_rep (first (rt a))) temp___1631)
  (<= temp___1631 (to_rep (last (rt a))))))))

;; H
  (assert (=> (= result1 true) (=> (= result7 true) (= o11 temp___1631))))

;; H
  (assert
  (=> (= result1 true) (=> (= result7 true) (= o12 (select (elts a) o11)))))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (= result7 true) (and (= temp___1621 (+ x l3)) (in_range1 (+ x l3))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (= result7 true)
  (and (<= (to_rep (first (rt a))) temp___1621)
  (<= temp___1621 (to_rep (last (rt a))))))))

;; H
  (assert (=> (= result1 true) (=> (= result7 true) (= o9 temp___1621))))

;; H
  (assert
  (=> (= result1 true) (=> (= result7 true) (= o10 (select (elts a) o9)))))
...
;; H
  (assert
  (=> (= (+ x lcp__result4) (+ (to_rep (last (rt a))) 1)) (= result11 true)))

;; H
  (assert
  (=> (not (= (+ x lcp__result4) (+ (to_rep (last (rt a))) 1)))
  (= result11 (ite (= (+ y lcp__result4) (+ (to_rep (last (rt a))) 1)) true
              false))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= (to_rep (first (rt a))) (+ y lcp__result4))))
(check-sat)
