...
(define-fun default_initial_assumption ((temp___expr_247 us_rep2)
...
;; range_axiom
  (assert
  (forall ((x position_type)) (! (in_range6
...
(define-fun bool_eq11 ((a (Array Int us_rep3)) (a__first Int) (a__last Int)
...
(declare-fun dummy10 () (Array Int us_rep3))
...
(define-fun dynamic_invariant3 ((temp___expr_281 us_rep4)
...
(define-fun default_initial_assumption1 ((temp___expr_285 us_rep4)
...
;; size__post_axiom
  (assert
  (forall ((f us_rep4))
  (! (=> (dynamic_invariant3 f true true true)
     (let ((result (size f)))
...
;; model____post_axiom
  ...
  (! (and (valid_root__function_guard (valid_root f root) f root)
     (=>
     (and
     (and (dynamic_invariant3 f true true true) (dynamic_invariant4 root true
...
(define-fun bool_eq13 ((a (Array Int natural)) (a__first Int) (a__last Int)
...
(define-fun dynamic_invariant6 ((temp___expr_562 us_rep5)
...
(define-fun default_initial_assumption3 ((temp___expr_567 us_rep5)
...
;; size__post_axiom
  ...
  (! (=> (and (dynamic_invariant6 t true true true) (type_invariant1 t))
     (let ((result (size1 t)))
     (=> (size__function_guard1 result t) (dynamic_invariant2 result true
...
;; size__def_axiom
  ...
  (forall ((t us_rep5))
  (! (=>
     (and (dynamic_invariant6 t true true true) (size__function_guard1
     (size1 t) t))
...
(define-fun default_initial_assumption4 ((temp___expr_260 us_rep2)
...
(define-fun dynamic_predicate ((temp___213 us_rep1)) Bool (< (length1
                                                             (rec__tree_model__path_type__a
                                                             (us_split_fields1
                                                             temp___213))) 100))
...
;; is_add__def_axiom
  ...
  (! (=> (is_add__function_guard (is_add s1 d s2) s1 d s2)
     (= (= (is_add s1 d s2) true)
     (and (and (= (- (length1 s2) 1) (length1 s1)) (= (olt s1 s2) true))
     (= (get s2 (length1 s2)) d)))) :pattern ((is_add s1 d s2)) ))))
...
;; valid_root__post_axiom
  ...
  (forall ((i Int))
  (! (=>
     (and (dynamic_invariant3 f true true true) (dynamic_invariant4 i true
     true true))
...
;; position__post_axiom
  ...
  (! (and (parent__function_guard (parent f i) f i)
     ...
     (=> (position__function_guard result f i) (dynamic_invariant9 result
...
(define-fun dynamic_invariant11 ((temp___expr_194 Int)
...
(declare-fun dummy16 () element_type1)
...
(define-fun dynamic_invariant12 ((temp___expr_188 Int)
...
;; get__post_axiom
  ...
  (! (=>
     (and (dynamic_invariant11 position1 true true true)
     (and (<= 1 position1) (<= position1 (last container))))
     (dynamic_invariant12 (get container position1) true false true)) :pattern (
...
(declare-fun s () us_rep2)

(declare-fun j () Int)

(declare-fun search_trees__values__result () us_rep2)

(declare-fun o () Bool)

(declare-fun o1 () Int)

(declare-fun temp___1205 () (Array Int us_rep1))
...
(declare-fun o6 () us_rep2)

(declare-fun o7 () us_rep2)

(declare-fun s1 () us_rep2)

(declare-fun search_trees__values__result1 () us_rep2)

(declare-fun search_trees__values__result2 () us_rep2)
...
(declare-fun result3 () us_rep2)

(declare-fun s2 () us_rep2)
...
;; H
  (assert
  (not
  (= (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) 0)))
...
;; H
  ...
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1205 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1205 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1205 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= temp___1205 (model__
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7 t)) o1))
  (model____function_guard temp___1205
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1))
  (and (dynamic_invariant5 temp___1205 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1205 o1))) true)
  (and
  (= (length1
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1205 o1)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i o1))
  (ite (and
       (not
       (= (parent
          (rec__search_trees__search_tree__struct (us_split_fields7 t)) i) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1205 (parent
                              (rec__search_trees__search_tree__struct
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1205 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1205 i))) true))))))
  (and
  ...
  (= (length1
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1205 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1205 j2))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1205 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1205 j2)))) true))
  (= j2 i))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o2 o3)) (select temp___1205 j1)))
...
;; H
  ...
  (=>
  (exists ((e Int))
  (and (and (in_range4 e) (= (contains s e) true))
  (= e (to_rep
       (select (rec__search_trees__search_tree__values (us_split_fields7 t)) 
       j1)))))
  (= o true))))))
...
;; H
  (assert
  (=> (= result2 true) (= result1 (ite (not (= o true)) true false))))
...
;; H
  ...
  (and
  (and
  (and (= (length o6) (+ (length s) 1))
  (= (contains o6
     (to_rep
     (select (rec__search_trees__search_tree__values (us_split_fields7 t)) 
     j1))) true))
  (= (ole s o6) true))
  (= (included_except o6 s
     (to_rep
     (select (rec__search_trees__search_tree__values (us_split_fields7 t)) 
     j1))) true)))))
...
;; H
  (assert
  (=> (= result1 true) (= (mk_value_set__ref result3) (mk_value_set__ref s))))
...
(assert
;; WP_parameter_def
 ;; File "tree_model.ads", line 79, characters 0-0
  (not (<= (length s2) j1)))
(check-sat)
