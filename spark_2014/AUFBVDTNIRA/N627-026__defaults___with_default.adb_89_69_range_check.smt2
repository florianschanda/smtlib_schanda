...
(declare-datatypes ()
((us_split_discrs
 (mk___split_discrs (rec__with_default__bad_record2__rec_with_discr__b Bool)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) Bool (rec__with_default__bad_record2__rec_with_discr__b
                                                                    a))
...
(define-fun with_default__bad_record2__rec_with_discr__f1__pred ((a us_rep)) Bool (= 
  (to_int1
  (rec__with_default__bad_record2__rec_with_discr__b (us_split_discrs1 a))) 1))

(define-fun with_default__bad_record2__rec_with_discr__f2__pred ((a us_rep)) Bool (= 
  (to_int1
  (rec__with_default__bad_record2__rec_with_discr__b (us_split_discrs1 a))) 0))

(define-fun bool_eq4 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (and
                        (= (rec__with_default__bad_record2__rec_with_discr__b
                           (us_split_discrs1 a)) (rec__with_default__bad_record2__rec_with_discr__b
                                                 (us_split_discrs1 b)))
                        (=>
...
(declare-fun with_default__bad_record2__rec_with_discr__b__first__bit () Int)

(declare-fun with_default__bad_record2__rec_with_discr__b__last__bit () Int)

(declare-fun with_default__bad_record2__rec_with_discr__b__position () Int)
...
(declare-fun with_default__bad_record2__rec_with_discr__f1__first__bit () Int)

(declare-fun with_default__bad_record2__rec_with_discr__f1__last__bit () Int)

(declare-fun with_default__bad_record2__rec_with_discr__f1__position () Int)
...
(declare-fun with_default__bad_record2__rec_with_discr__f2__first__bit () Int)

(declare-fun with_default__bad_record2__rec_with_discr__f2__last__bit () Int)

(declare-fun with_default__bad_record2__rec_with_discr__f2__position () Int)
...
(declare-datatypes ()
((rec_with_discr__ref
 (mk_rec_with_discr__ref (rec_with_discr__content us_rep)))))
(define-fun rec_with_discr__ref___projection ((a rec_with_discr__ref)) us_rep 
...
(declare-fun with_default__bad_record2__rec_with_discr__b__first__bit1 () Int)

(declare-fun with_default__bad_record2__rec_with_discr__b__last__bit1 () Int)

(declare-fun with_default__bad_record2__rec_with_discr__b__position1 () Int)
...
(declare-fun with_default__bad_record2__rec_with_discr__f1__first__bit1 () Int)

(declare-fun with_default__bad_record2__rec_with_discr__f1__last__bit1 () Int)

(declare-fun with_default__bad_record2__rec_with_discr__f1__position1 () Int)
...
(declare-fun with_default__bad_record2__rec_with_discr__f2__first__bit1 () Int)

(declare-fun with_default__bad_record2__rec_with_discr__f2__last__bit1 () Int)

(declare-fun with_default__bad_record2__rec_with_discr__f2__position1 () Int)
...
(define-fun tbadS__ref___projection ((a tbadS__ref)) us_rep (tbadS__content
                                                            a))

(define-fun dynamic_invariant1 ((temp___expr_355 us_rep)
  (temp___is_init_352 Bool) (temp___skip_constant_353 Bool)
  (temp___do_toplevel_354 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_353 true))
                                      (in_range4 (of_int 0) temp___expr_355))
                                      (=>
                                      (with_default__bad_record2__rec_with_discr__f2__pred
                                      temp___expr_355)
                                      (=>
...
(declare-fun bad__split_discrs () us_split_discrs)
...
(define-fun dynamic_invariant4 ((temp___expr_350 us_rep)
...
(declare-fun temp___646 () Bool)

;; H
  (assert (in_range1 c))

;; H
  (assert (= (of_int 0) temp___646))

;; H
  (assert (= (to_int1 temp___646) 0))

(assert
;; WP_parameter_def
 ;; File "with_default.adb", line 74, characters 0-0
