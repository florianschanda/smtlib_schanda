...
(define-fun tint_arrayD1__ref_3__projection ((a tint_arrayD1__ref)) integer 
...
(define-fun tint_arrayT__ref_3__projection ((a tint_arrayT__ref)) us_t1 
...
(define-fun tnumber_array_typeD1__ref_3__projection ((a tnumber_array_typeD1__ref)) integer 
...
(define-fun number_array_type__ref_3__projection ((a number_array_type__ref)) us_t3 
...
(define-fun tint_arrayB__ref_3__projection ((a tint_arrayB__ref)) us_t5 
  (tint_arrayB__content a))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__aggregate_def (Int
  Int Int Int Int Int Int Int Int Int Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___1414 Int) (temp___1415 Int) (temp___1416 Int)
  (temp___1417 Int) (temp___1418 Int) (temp___1419 Int) (temp___1420 Int)
  (temp___1421 Int) (temp___1422 Int) (temp___1423 Int) (temp___1424 Int)
  (temp___1425 Int))
  (let ((temp___1413 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__aggregate_def
                     temp___1414 temp___1415 temp___1416 temp___1417
                     temp___1418 temp___1419 temp___1420 temp___1421
                     temp___1422 temp___1423 temp___1424 temp___1425)))
  (and
  (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1424
  temp___1425)
  (and (= (first7 temp___1413) temp___1424)
  (= (last7 temp___1413) temp___1425)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___1413) (+ (first1 source) 0)) (of_rep1
                                                            temp___1414))
  (= (select (to_array2 temp___1413) (+ (first1 source) 1)) (of_rep1
                                                            temp___1415)))
  (= (select (to_array2 temp___1413) (+ (first1 source) 2)) (of_rep1
                                                            temp___1416)))
  (= (select (to_array2 temp___1413) (+ (first1 source) 3)) (of_rep1
                                                            temp___1417)))
  (= (select (to_array2 temp___1413) (+ (first1 source) 4)) (of_rep1
                                                            temp___1418)))
  (= (select (to_array2 temp___1413) (+ (first1 source) 5)) (of_rep1
                                                            temp___1419)))
  (= (select (to_array2 temp___1413) (+ (first1 source) 6)) (of_rep1
                                                            temp___1420)))
  (= (select (to_array2 temp___1413) (+ (first1 source) 7)) (of_rep1
                                                            temp___1421)))
  (= (select (to_array2 temp___1413) (+ (first1 source) 8)) (of_rep1
                                                            temp___1422)))
  (= (select (to_array2 temp___1413) (+ (first1 source) 9)) (of_rep1
                                                            temp___1423)))))))
...
(define-fun tnumber_array_typeB__ref_3__projection ((a tnumber_array_typeB__ref)) us_t6 
  (tnumber_array_typeB__content a))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__aggregate_def (Int
  Int Int) us_t4)

;; def_axiom
  (assert
  (forall ((temp___1431 Int) (temp___1432 Int) (temp___1433 Int))
  (let ((temp___1430 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__aggregate_def
                     temp___1431 temp___1432 temp___1433)))
  (and
  (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1432
  temp___1433)
  (and (= (first13 temp___1430) temp___1432)
  (= (last13 temp___1430) temp___1433)))
  (forall ((temp___1434 Int))
  (= (select (to_array4 temp___1430) temp___1434) (of_rep1 temp___1431)))))))
...
(declare-fun temp___1428 () (Array Int integer))

(declare-fun temp___14281 () t2)

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume1 () t1)

(declare-fun temp___1436 () (Array Int integer))

(declare-fun temp___14361 () t4)

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume1 () t3)

(declare-fun temp___1443 () Int)

(declare-fun temp___1441 () Int)

(declare-fun temp___1439 () (Array Int integer))
...
;; H
  ...
  (= (to_rep1
     (first6
     (rt2
     (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__aggregate_def
     2 1 4 7 4 8 3 5 9 9 (to_rep1 (first (rt source)))
...
;; H
  (assert
  (= (mk___t2 temp___1428 temp___14281) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__aggregate_def
                                        2 1 4 7 4 8 3 5 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___14281)) (to_rep1 (last6 temp___14281)))
     (+ (- (to_rep1 (last6 temp___14281)) (to_rep1 (first6 temp___14281))) 1)
...
;; H
  (assert
  (= (slide1 temp___1428 (to_rep1 (first6 temp___14281))
     (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume))

;; H
  (assert
  (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) 
  aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume1))
...
;; H
  (assert
  (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume))
...
;; H
  ...
  (= (to_rep1
     (first12
     (rt4
     (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__aggregate_def
...
;; H
  (assert
  (= (mk___t4 temp___1436 temp___14361) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__aggregate_def
                                        0 (to_rep1 (first (rt source)))
                                        (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first12 temp___14361)) (to_rep1
                                               (last12 temp___14361)))
     (+ (- (to_rep1 (last12 temp___14361)) (to_rep1 (first12 temp___14361))) 1)
     0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1
                                                  (first (rt source))) 9))
        (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1
                                                  (first (rt source)))) 1)
...
;; H
  (assert
  (= (slide1 temp___1436 (to_rep1 (first12 temp___14361))
     (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume))

;; H
  (assert
  (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) 
  aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume1))
...
;; H
  (assert
  (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume))
...
;; H
  (assert
  (and (= temp___1443 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1443))
  (= temp___1441 index1)))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 n__first) temp___1440)
  (<= temp___1440 (to_rep1 n__last)))
  (=> (< index2 temp___1440)
  (= (select n3 temp___1440) (select temp___1439 temp___1440)))))
...
;; H
  (assert
  (and (= temp___1444 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1444)
  (<= temp___1444 (to_rep1 n__last))))

;; H
  (assert (= o9 temp___1444))
...
;; H
  (assert
  (and (= temp___1445 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1445)
  (<= temp___1445 (to_rep1 n__last))))

;; H
  (assert (= o12 temp___1445))
...
;; H
  (assert
  (and (= temp___1446 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1446)
  (<= temp___1446 (to_rep1 n__last))))

;; H
  (assert (= o19 temp___1446))
...
(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 262, characters 0-0
  (not (in_range1 o24)))
(check-sat)
