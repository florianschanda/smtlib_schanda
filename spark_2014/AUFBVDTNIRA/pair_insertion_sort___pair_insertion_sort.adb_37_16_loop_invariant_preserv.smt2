...
;; H
  (assert (occ__function_guard
  (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e3)
  (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))) e3))

;; H
  (assert (occ__function_guard
  (occ
  (mk___t (elts1 init)
  (mk (to_rep (first3 (rt1 init))) (to_rep (last3 (rt1 init))))) e3)
  (mk___t (elts1 init)
  (mk (to_rep (first3 (rt1 init))) (to_rep (last3 (rt1 init))))) e3))
...
;; H
  (assert (occ__function_guard
  (occ (mk___t values (mk (to_rep values__first) (to_rep values__last))) e3)
  (mk___t values (mk (to_rep values__first) (to_rep values__last))) e3))
...
;; H
  (assert
  (ite (= o8 (to_rep (select (elts1 init) x)))
  (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last)))
     e3) (occ
         (mk___t (elts1 init)
         (mk (to_rep (first3 (rt1 init))) (to_rep (last3 (rt1 init))))) 
  ...
  (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last)))
     e3) (+ (occ
            ...
            (mk (to_rep (first3 (rt1 init))) (to_rep (last3 (rt1 init)))))
            e3) 1))
  (ite (= (to_rep (select (elts1 init) x)) e3)
  (= (occ (mk___t interm (mk (to_rep interm__first) (to_rep interm__last)))
     e3) (- (occ
            (mk___t (elts1 init)
            (mk (to_rep (first3 (rt1 init))) (to_rep (last3 (rt1 init)))))
...
;; H
  (assert
  (ite (= o11 (to_rep (select interm y)))
  (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last)))
     e3) (occ
         (mk___t interm (mk (to_rep interm__first) (to_rep interm__last)))
         e3))
