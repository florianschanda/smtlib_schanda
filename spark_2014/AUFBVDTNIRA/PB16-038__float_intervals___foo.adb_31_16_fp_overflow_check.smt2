...
(define-fun dynamic_invariant ((temp___expr_147 t) (temp___is_init_144 Bool)
  (temp___skip_constant_145 Bool)
  (temp___do_toplevel_146 Bool)) Bool (=>
                                      (or (= temp___is_init_144 true) (le
                                      (neg fliteral1) fliteral1)) (in_range2
                                      temp___expr_147)))
...
(define-fun dynamic_predicate ((temp___157 t)) Bool (= (not (and (ite (le
                                                                 (neg
                                                                 fliteral2)
                                                                 temp___157)
                                                                 true false) 
  (ite (le temp___157 fliteral2) true false))) true))
...
;; H
  (assert (=> (le (neg fliteral1) fliteral1) (in_range2 y)))

;; H
  (assert (=> (le (neg fliteral2) x) (not (le x fliteral2))))

(assert
;; WP_parameter_def
 ;; File "foo.adb", line 13, characters 0-0
  (not (tqtisFinite (div1 RNE2 fliteral x))))
(check-sat)
