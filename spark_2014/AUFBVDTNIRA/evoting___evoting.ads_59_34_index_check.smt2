...
(declare-fun o11 () (Array Int (Array Int character)))
...
;; H
  (assert (=> (= result3 true) (= temp___644 last8)))
...
;; H
  (assert (=> (= result3 true) (= current_candidate2 o6)))
...
;; H
  ...
  (=> (= result3 true)
  (and
  (and (=> (<= 0 2147483647) (in_range4 last10))
...
;; H
  (assert (=> (= result3 true) (= (to_rep1 o8) 70)))

;; H
  (assert (=> (= result3 true) (= (to_rep1 o7) 1)))

;; H
  (assert (=> (= result3 true) (in_range4 last11)))
...
;; H
  (assert (=> (= result3 true) (= last11 r17b)))

;; H
  (assert (=> (= result3 true) (in_range4 r17b)))

;; H
  (assert (=> (= result3 true) (= last11 r20b)))
...
;; H
  (assert (=> (= result3 true) (= o9 item3)))

;; H
  (assert (=> (= result3 true) (= o9 temp___636)))
...
;; H
  (assert
  (=> (= result3 true)
  (= (mk1 (to_rep1 (first4 temp___6361)) (to_rep1 (last6 temp___6361))) 
  temp___6371)))

;; H
  (assert
  (=> (= result3 true)
  (= (ite (<= (to_rep1 (first2 temp___6371)) (to_rep1 (last3 temp___6371)))
     (+ (- (to_rep1 (last3 temp___6371)) (to_rep1 (first2 temp___6371))) 1)
     0) (ite (<= (to_rep1 (first2 (mk1 1 r17b))) (to_rep1
                                                 (last3 (mk1 1 r17b))))
        (+ (- (to_rep1 (last3 (mk1 1 r17b))) (to_rep1 (first2 (mk1 1 r17b)))) 1)
        0))))
...
;; H
  ...
  (= (select o10 temp___643) (select temp___642 temp___643))
  (= (select o10 temp___643) (select (select candidates3 current_candidate3) temp___643))))))

;; H
  (assert
  (=> (= result3 true) (= o11 (store candidates3 current_candidate3 o10))))

;; H
  (assert (=> (= result3 true) (= candidates3 result6)))

;; H
  (assert (=> (= result3 true) (= candidates4 o11)))

;; H
  (assert (=> (= result3 true) (= o12 (end_of_file file))))
...
;; H
  (assert
  (=> (= result3 true)
  (= o14 (ite (= o13 true) (ite (< current_candidate3 20) true false) false))))

;; H
  (assert
  (=> (= result3 true) (= result7 (ite (not (= o14 true)) true false))))
...
;; H
  (assert (=> (= result3 true) (= last12 (mk_int__ref last11))))
...
;; H
  (assert (=> (= result3 true) (= last14 last12)))
...
;; H
  (assert (=> (= result3 true) (= last15 last13)))
...
;; H
  (assert (=> (not (= result3 true)) (= last14 (mk_int__ref last8))))
...
;; H
  (assert (=> (not (= result3 true)) (= last15 last9)))
