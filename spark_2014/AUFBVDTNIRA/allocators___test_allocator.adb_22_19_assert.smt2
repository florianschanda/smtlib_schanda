...
(declare-fun model____split_fields14 () us_rep)

(declare-fun model____split_fields15 () us_rep1)

(define-fun model____split_fields16 () us_split_fields (mk___split_fields
                                                       model____split_fields14
                                                       model____split_fields15))
...
(define-fun model____split_fields20 () us_split_fields (mk___split_fields
                                                       model____split_fields6
                                                       model____split_fields7))

(define-fun model____split_fields21 () us_split_fields (mk___split_fields
                                                       model____split_fields4
                                                       model____split_fields5))

(define-fun model____split_fields22 () us_split_fields (mk___split_fields
...
;; H
  (assert (is_valid__function_guard (is_valid state1 model____split_fields22)
  state1 model____split_fields22))

;; H
  (assert (oeq__function_guard
  (oeq (mk___rep model____split_fields22)
  (mk___rep (mk___split_fields model____split_fields model____split_fields1)))
  (mk___rep model____split_fields22)
  (mk___rep (mk___split_fields model____split_fields model____split_fields1))))
...
;; H
  (assert
  (and
  (and (= (is_valid state1 model____split_fields22) true)
...
;; H
  (assert (is_valid__function_guard (is_valid state2 model____split_fields21)
  state2 model____split_fields21))

;; H
  (assert (oeq__function_guard
  (oeq (mk___rep model____split_fields21) (mk___rep model____split_fields22))
  (mk___rep model____split_fields21) (mk___rep model____split_fields22)))
...
;; H
  (assert
  (and
  (and (= (is_valid state2 model____split_fields21) true)
  (ite (= (= (length model____split_fields2) 0) true)
  (and (= res21 0)
  (= (oeq (mk___rep model____split_fields21)
     (mk___rep model____split_fields22)) true))
  (and
...
;; H
  (assert (is_valid__function_guard (is_valid state3 model____split_fields20)
  state3 model____split_fields20))

;; H
  (assert (oeq__function_guard
  (oeq (mk___rep model____split_fields20) (mk___rep model____split_fields21))
  (mk___rep model____split_fields20) (mk___rep model____split_fields21)))
...
;; H
  (assert
  (and
  (and (= (is_valid state3 model____split_fields20) true)
  (ite (= (= (length model____split_fields4) 0) true)
  (and (= res31 0)
  (= (oeq (mk___rep model____split_fields20)
     (mk___rep model____split_fields21)) true))
  (and
...
;; H
  (assert (is_valid__function_guard (is_valid state4 model____split_fields19)
  state4 model____split_fields19))

;; H
  (assert (oeq__function_guard
  (oeq (mk___rep model____split_fields19) (mk___rep model____split_fields20))
  (mk___rep model____split_fields19) (mk___rep model____split_fields20)))
...
;; H
  (assert
  (and
  (and (= (is_valid state4 model____split_fields19) true)
  (ite (= (= (length model____split_fields6) 0) true)
  (and (= res41 0)
  (= (oeq (mk___rep model____split_fields19)
     (mk___rep model____split_fields20)) true))
  (and
...
;; H
  (assert (is_valid__function_guard (is_valid state5 model____split_fields18)
  state5 model____split_fields18))
...
;; H
  (assert
  (and (= (is_valid state5 model____split_fields18) true)
...
;; H
  (assert (is_valid__function_guard (is_valid state6 model____split_fields17)
  state6 model____split_fields17))
...
;; H
  (assert
  (and (= (is_valid state6 model____split_fields17) true)
...
;; H
  (assert (is_valid__function_guard (is_valid state7 model____split_fields16)
  state7 model____split_fields16))

;; H
  (assert (is_prepend__function_guard
  (is_prepend model____split_fields12 res31 model____split_fields14)
  model____split_fields12 res31 model____split_fields14))

;; H
  (assert (is_add__function_guard
  (is_add model____split_fields15 res31 model____split_fields13)
  model____split_fields15 res31 model____split_fields13))
...
;; H
  (assert
  (and (= (is_valid state7 model____split_fields16) true)
  (ite (= (contains model____split_fields13 res31) true)
  (and
  (= (is_prepend model____split_fields12 res31 model____split_fields14) true)
  (= (is_add model____split_fields15 res31 model____split_fields13) true))
  (= (oeq (mk___rep model____split_fields16)
     (mk___rep model____split_fields17)) true))))

;; H
  (assert (is_available__function_guard (is_available res31 state7) res31
  state7))

(assert
;; WP_parameter_def
 ;; File "list_allocator.ads", line 80, characters 0-0
  (not (= (is_available res31 state7) true)))
(check-sat)
