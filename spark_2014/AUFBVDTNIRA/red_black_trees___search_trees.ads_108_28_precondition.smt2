...
(declare-fun temp___1458 () (Array Int us_rep1))
...
;; H
  (assert
  (forall ((j1 Int) (d17 Int)) (peek__function_guard1
  (peek1
  (mk___rep3
  (mk___split_fields3 t__split_fields
  (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
  t__split_fields3)) j1 d17)
  (mk___rep3
  (mk___split_fields3 t__split_fields
  (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
  t__split_fields3)) j1 d17)))
...
;; H
  (assert
  (forall ((j1 Int) (d17 Int)) (peek__function_guard1
  (peek1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j1 d17)
  (mk___rep3 (us_split_fields__content3 t__split_fields14)) j1 d17)))
...
;; H
  (assert
  (=> (not (= (int__content i14) 0)) (type_invariant1
  (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
...
;; H
  (assert
  (=> (not (= (int__content i14) 0))
  (and (<= 1 (int__content i14)) (<= (int__content i14) 100))))
...
;; H
  (assert
  (=> (not (= (int__content i14) 0)) (= o37 (select temp___1438 o36))))

;; H
  (assert (=> (not (= (int__content i14) 0)) (= o38 (us_split_fields1 o37))))

;; H
  (assert
  (=> (not (= (int__content i14) 0))
  (= result24 (rec__tree_model__path_type__k o38))))
...
;; H
  ...
  (= o34 (root
         ...
         (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
         t__split_fields3))))
  (root__function_guard o34
  (mk___rep3
  (mk___split_fields3 t__split_fields
  (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
  t__split_fields3))))
  (and (in_range3 o34) (= o34 (to_rep1 t__split_fields))))))
...
;; H
  ...
  (and
  (and
  (= o35 (root (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (root__function_guard o35
  (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (and (in_range3 o35)
  (= o35 (to_rep1
         (rec__search_trees__search_tree__root
...
;; H
  (assert (=> (= result24 true) (= result23 (ite (= o35 o34) true false))))
...
;; H
  ...
  (and
  (and
  (= o33 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (size__function_guard1 o33
  (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (and (in_range4 o33)
  (= o33 (size
         (rec__search_trees__search_tree__struct
...
;; H
  (assert
  (=> (= result23 true)
  (= result22 (ite (= o33 (+ (size1
                             (mk___rep3
                             (mk___split_fields3 t__split_fields
                             (mk___rep2
                             (mk___split_fields2 t__split_fields1
                             t__split_fields2)) t__split_fields3))) 1))
              true false))))
...
;; H
  ...
  (= (contains o31 (to_rep (select t__split_fields3 i16))) true))))
  (forall ((v1 Int))
  (=> (and (<= 0 v1) (<= v1 2147483647))
...
;; H
  ...
  (=> (= result22 true)
  (and
  (and (= result21 (is_add__2 o31 v o32)) (is_add__2__function_guard 
  result21 o31 v o32))
  (= (= result21 true)
  (and
  (and (and (not (= (contains o31 v) true)) (= (contains o32 v) true))
  (= (ole o31 o32) true)) (= (included_except o32 o31 v) true))))))
...
;; H
  ...
  (and
  (and
  (= temp___1458 (model__1
                 (mk___rep3
                 (mk___split_fields3 t__split_fields
                 (mk___rep2
                 (mk___split_fields2 t__split_fields1 t__split_fields2))
                 t__split_fields3))))
  (model____function_guard1 temp___1458
  (mk___rep3
  (mk___split_fields3 t__split_fields
  (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
  t__split_fields3))))
  (and (dynamic_invariant9 temp___1458 true false true)
  (= temp___1458 (model__
                 (mk___rep2
                 (mk___split_fields2 t__split_fields1 t__split_fields2))
                 (to_rep1 t__split_fields))))))
...
;; H
  (assert (= o29 (select temp___1458 j)))

;; H
  (assert (= o30 (us_split_fields1 o29)))

;; H
  (assert (= result25 (rec__tree_model__path_type__k o30)))
