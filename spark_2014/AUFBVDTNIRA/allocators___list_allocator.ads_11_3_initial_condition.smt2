...
(declare-fun temp___268 () (Array Int us_rep))
...
;; H
  (assert
  (forall ((r7 Int)) (contains__function_guard
  (contains model____split_fields r7) model____split_fields r7)))
...
;; H
  (assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___270 r1)))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___268 data1)))

;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000))
  (=> (< r1 10000) (and (= o7 (+ r1 1)) (in_range2 (+ r1 1))))))
...
;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (= data1 result3))))
...
;; H
  ...
  (ite (< r2 temp___269)
  (= (select data3 temp___269) (select temp___268 temp___269))
  (= (rec__list_allocator__cell__stat
     (us_split_fields1 (select data3 temp___269))) (rec__list_allocator__cell__stat
                                                   (us_split_fields1
                                                   (select temp___268 temp___269)))))))
...
;; H
  ...
  (and
  (and
  (= o14 (is_valid (map__content data6) first_available1
         (mk___split_fields1 model____split_fields model____split_fields1)))
  (is_valid__function_guard o14 (map__content data6) first_available1
  (mk___split_fields1 model____split_fields model____split_fields1)))
  (= (= o14 true)
  (and
  (and
  ...
  (and
  (and
  (and (<= (length model____split_fields) 10000)
  (<= (length1 model____split_fields1) 10000))
  (= (+ (length model____split_fields) (length1 model____split_fields1)) 10000))
  (ite (not (= first_available1 0))
  (and (< 0 (length model____split_fields))
  (= (get model____split_fields 1) first_available1))
  (= (length model____split_fields) 0)))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (length model____split_fields)))
  (and
  (and (in_range3 (get model____split_fields j))
  (= (to_rep
     (rec__list_allocator__cell__next
     (us_split_fields1
     (select (map__content data6) (get model____split_fields j))))) (ite (< j 
                                                                    (length
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- j 1)))
  (not (= (get model____split_fields j) (get model____split_fields k)))))))))
  (forall ((e Int))
  (=> (and (in_range5 e) (= (contains1 model____split_fields1 e) true))
  (in_range3 e))))
  (forall ((r7 Int))
  (=> (and (<= 1 r7) (<= r7 10000))
  (ite (= (to_rep1
  ...
  (and (= (contains model____split_fields r7) true)
  (not (= (contains1 model____split_fields1 r7) true)))
  (and (not (= (contains model____split_fields r7) true))
  (= (contains1 model____split_fields1 r7) true)))))))))

;; H
  (assert
  (and
  (and (= o15 (all_available (map__content data6)))
  (all_available__function_guard o15 (map__content data6)))
  (= (= o15 true)
  (forall ((r7 Int))
  (=> (and (<= 1 r7) (<= r7 10000))
  (= (to_rep1
...
;; H
  (assert (all_available__function_guard (all_available (map__content data6))
  (map__content data6)))
