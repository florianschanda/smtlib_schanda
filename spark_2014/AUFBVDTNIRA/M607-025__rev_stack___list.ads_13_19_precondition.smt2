...
;; empty_stack__post_axiom
  ...
  (! (let ((result (empty_stack us_void_param)))
     (and (is_empty__function_guard (is_empty result) result)
...
;; top__post_axiom
  ...
  (! (and (is_empty__function_guard (is_empty s) s)
     ...
     (and
     (= result (to_rep
               (let ((temp___190 (to__ s)))
               (select (to_array temp___190) (last1 (to__ s))))))
...
;; top__def_axiom
  ...
  (! (=> (top__function_guard (top s) s)
     (= (top s) (to_rep
                (let ((temp___193 (rec__stack__stack__content
                                  (us_split_fields1 s))))
                (select temp___193 (to_rep1
...
(declare-fun temp___197 (Int) (Array Int integer))

;; def_axiom
  (assert
  (forall ((temp___199 Int))
  (= (select (temp___197 temp___199) 1) (of_rep temp___199))))
...
(define-fun last5 ((container us_rep2)) Int (+ 0 (length3 container)))
...
(define-fun last_index ((container us_rep1)) Int (last5 (model__ container)))
...
(define-fun dynamic_invariant4 ((temp___expr_275 Int)
...
(define-fun dynamic_invariant6 ((temp___expr_417 us_rep1)
  (temp___is_init_414 Bool) (temp___skip_constant_415 Bool)
  (temp___do_toplevel_416 Bool)) Bool (=>
                                      (not (= temp___skip_constant_415 true))
                                      (in_range9 100 temp___expr_417)))

(define-fun default_initial_assumption ((temp___expr_419 us_rep1)
  (temp___skip_top_level_420 Bool)) Bool (and
                                         ...
                                         (=>
                                         (not
                                         (= temp___skip_top_level_420 true))
                                         (= (is_empty1 temp___expr_419) true))))
...
(define-fun default_initial_assumption1 ((temp___expr_327 us_rep2)
  (temp___skip_top_level_328 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_328 true))
                                         (= (length3 temp___expr_327) 0)))
...
(define-fun dynamic_invariant10 ((temp___expr_320 Int)
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (and (<= 1 position) (<= position (last5 container))))
...
(declare-fun temp___490 () Int)

(declare-fun temp___489 () r1)

(declare-fun temp___4891 () (Array Int integer))

(declare-fun o () Int)

(declare-fun o1 () Int)

(declare-fun temp___503 () Int)

(declare-fun temp___502 () r1)

(declare-fun temp___5021 () (Array Int integer))

(declare-fun temp___501 () capacity_range)

(declare-fun temp___5011 () us_main_type)

(declare-fun temp___505 () us_rep)
...
;; H
  (assert (is_empty__function_guard (is_empty list__reverse_list__s__assume2)
  list__reverse_list__s__assume2))

;; H
  (assert (to____function_guard (to__ (mk___rep s__split_fields3))
  (mk___rep s__split_fields3)))

;; H
  (assert (to____function_guard (to__ (mk___rep s__split_fields2))
  (mk___rep s__split_fields2)))
...
;; H
  (assert (to____function_guard (to__ temp___505) temp___505))
...
;; H
  ...
  (empty_stack__function_guard list__reverse_list__s__assume2 Tuple0))
...
;; H
  (assert
  (and (= list__reverse_list__last__assume (last5 (model__ l)))
  (and (in_range7 list__reverse_list__last__assume)
  (= list__reverse_list__last__assume (last5 (model__ l))))))

;; H
  (assert (= list__reverse_list__last__assume last6))
...
;; H
  (assert (=> (and (<= first4 i3) (<= i3 last6)) (= temp___490 i3)))

;; H
  (assert
  (=> (and (<= first4 i3) (<= i3 last6))
  (= s__split_fields2 (mk___split_fields temp___489 temp___4891))))

;; H
  (assert
  (=> (and (<= first4 i3) (<= i3 last6)) (and (= o i3) (in_range5 i3))))

;; H
  (assert
  (=> (and (<= first4 i3) (<= i3 last6))
  (and (= o1 (get (model__ l) o))
  (and (in_range8 o1) (= o1 (get (model__ l) o))))))

;; H
  (assert
  (=> (and (<= first4 i3) (<= i3 last6))
  (= (let ((temp___203 (to__ (mk___rep s__split_fields3))))
     (bool_eq1 (elts temp___203) (to_rep (first (rt temp___203)))
     (to_rep (last (rt temp___203)))
     (let ((temp___202 (temp___197 o1)))
     (let ((temp___201 (to__ (mk___rep s__split_fields2))))
     (ite (= (length temp___201) 0) temp___202
     (concat1 (elts temp___201) (to_rep (first (rt temp___201)))
     (to_rep (last (rt temp___201))) temp___202 1 1))))
     (to_rep
     (first
     (let ((temp___201 (to__ (mk___rep s__split_fields2))))
     (ite (= (length temp___201) 0) (mk 1 1)
     (mk (to_rep (first (rt temp___201)))
     (- (+ (to_rep (first (rt temp___201))) (+ (ite (<= (to_rep
                                                        (first
                                                        (rt temp___201))) 
                                               (to_rep
                                               (last (rt temp___201))))
...
;; H
  ...
  (=> (and (<= first4 j) (<= j i4))
  (= (to_rep
     (select (elts (to__ (mk___rep s__split_fields4))) (+ (- j first4) 1))) 
  (get (model__ l) j)))))))

;; H
  (assert
  (=> (and (<= first4 i3) (<= i3 last6))
  (and (=> (<= first4 last6) (dynamic_property3 first4 last6 i4))
  (and (<= first4 i4) (<= i4 last6)))))

;; H
  (assert (=> (and (<= first4 i3) (<= i3 last6)) (= i4 last6)))

;; H
  (assert (=> (and (<= first4 i3) (<= i3 last6)) (= i5 (mk_int__ref i4))))
...
;; H
  (assert (=> (and (<= first4 i3) (<= i3 last6)) (= i6 i4)))
...
;; H
  (assert (=> (and (<= first4 i3) (<= i3 last6)) (= i7 i5)))
...
;; H
  (assert (=> (and (<= first4 i3) (<= i3 last6)) (= i8 i6)))
...
;; H
  (assert
  (=> (not (and (<= first4 i3) (<= i3 last6))) (= i7 (mk_int__ref i3))))

;; H
  (assert
  (=> (not (and (<= first4 i3) (<= i3 last6)))
  (= s__split_fields7 (mk___split_fields__ref s__split_fields2))))

;; H
  (assert (=> (not (and (<= first4 i3) (<= i3 last6))) (= i8 i3)))
...
;; H
  (assert (=> (and (<= first4 i9) (<= i9 last6)) (= temp___503 i9)))

;; H
  (assert
  (=> (and (<= first4 i9) (<= i9 last6))
  (= (us_split_fields__content s__split_fields7) (mk___split_fields
                                                 temp___502 temp___5021))))

;; H
  (assert
  (=> (and (<= first4 i9) (<= i9 last6))
  (and (= res__split_discrs (mk___split_discrs temp___501))
  (= res__split_fields1 (mk___split_fields1 temp___5011)))))

;; H
  (assert
  (=> (and (<= first4 i9) (<= i9 last6))
  (= temp___505 (mk___rep (us_split_fields__content s__split_fields7)))))
...
;; H
  ...
  (and
  (and
  (= (length2 (mk___rep1 res__split_discrs res__split_fields2)) (- i10 
  first4))
  (= (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) (+ (- last6 
  i10) 1)))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (+ (- last6 i10) 1)))
  (= (to_rep (select (elts (to__ (mk___rep s__split_fields9))) j)) (to_rep
                                                                   (select 
                                                                   (elts
                                                                   (to__
                                                                   temp___505)) j))))))
  (forall ((j Int))
  (=> (and (<= first4 j) (<= j (- i10 1)))
  (= (get (model__ (mk___rep1 res__split_discrs res__split_fields2)) j) 
  (get (model__ l) (+ (- last6 j) first4))))))))

;; H
  (assert
  (=> (and (<= first4 i9) (<= i9 last6))
  (and (=> (<= first4 last6) (dynamic_property4 first4 last6 i10))
  (and (<= first4 i10) (<= i10 last6)))))

;; H
  (assert
  (=> (and (<= first4 i9) (<= i9 last6))
  (and
  (and (= o2 (top (mk___rep s__split_fields9))) (top__function_guard 
  o2 (mk___rep s__split_fields9)))
  (and (in_range1 o2)
  (and
  (= o2 (to_rep
        (select (rec__stack__stack__content s__split_fields9) (to_rep1
                                                              (rec__stack__stack__top
                                                              s__split_fields9)))))
  (= o2 (to_rep
        (select (elts (to__ (mk___rep s__split_fields9))) (to_rep
                                                          (last
                                                          (rt
                                                          (to__
                                                          (mk___rep
...
;; H
  ...
  (= (get
     ...
     (+ (last5 (model__ (mk___rep1 res__split_discrs res__split_fields2))) 1)) 
  o2))))

;; H
  (assert
  (=> (and (<= first4 i9) (<= i9 last6))
  (= result4 (mk___split_fields__ref1 res__split_fields2))))

;; H
  (assert
  (=> (and (<= first4 i9) (<= i9 last6))
  (= res__split_fields3 list__my_lists__append__2__container__fields)))

;; H
  (assert
  (=> (and (<= first4 i9) (<= i9 last6))
  (= (let ((temp___214 (to__ (mk___rep s__split_fields10))))
     (bool_eq1 (elts temp___214) (to_rep (first (rt temp___214)))
     (to_rep (last (rt temp___214)))
     (elts (to__ (mk___rep s__split_fields9)))
     (to_rep
     (first2
     (mk1 1 (- (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) 1))))
     (to_rep
     (last3
     (mk1 1 (- (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) 1)))))) true)))

;; H
  (assert (=> (and (<= first4 i9) (<= i9 last6)) (= i10 last6)))

;; H
  (assert (=> (and (<= first4 i9) (<= i9 last6)) (= i11 (mk_int__ref i10))))
...
;; H
  (assert (=> (and (<= first4 i9) (<= i9 last6)) (= i12 i10)))
...
;; H
  (assert (=> (and (<= first4 i9) (<= i9 last6)) (= i13 i11)))
...
;; H
  (assert (=> (and (<= first4 i9) (<= i9 last6)) (= i14 i12)))
...
;; H
  (assert
  (=> (not (and (<= first4 i9) (<= i9 last6))) (= i13 (mk_int__ref i9))))

;; H
  (assert
  (=> (not (and (<= first4 i9) (<= i9 last6)))
  (= res__split_fields6 (mk___split_fields__ref1 res__split_fields1))))
...
;; H
  (assert (=> (not (and (<= first4 i9) (<= i9 last6))) (= i14 i9)))
...
;; H
  (assert
  (and (= o4 (last5 (model__ l)))
  (and (in_range7 o4) (= o4 (last5 (model__ l))))))
...
;; H
  (assert
  (and (= o8 (last5 (model__ l)))
  (and (in_range7 o8) (= o8 (last5 (model__ l))))))
...
;; H
  (assert
  (and
  (= o15 (get (model__ (list__content list__reverse_list__result5)) o14))
  (and (in_range8 o15)
  (= o15 (get (model__ (list__content list__reverse_list__result5)) o14)))))
