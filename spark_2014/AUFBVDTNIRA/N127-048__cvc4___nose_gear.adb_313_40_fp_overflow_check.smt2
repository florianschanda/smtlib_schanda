...
(declare-fun distance_km_out11 () t)

(declare-fun result44 () t__ref1)

(declare-fun elapsed_time_h_out11 () t)
...
(declare-fun avoid_div_by_zero_out11 () t)

(declare-fun result47 () t__ref1)

(declare-fun avoid_div_by_zero_out12 () t)
...
;; H
  ...
  (= o16 (mul RNE2
         (of_ubv16 RNA2
         (let ((subject to_uint16_result_out1)) to_uint16_result_out11))
...
;; WP_parameter_def
 ;; File "nose_gear.adb", line 24, characters 0-0
  (not (tqtisFinite
  (div1 RNE2 (let ((subject distance_km_out1)) distance_km_out11)
  (let ((subject avoid_div_by_zero_out1)) avoid_div_by_zero_out11)))))
(check-sat)
