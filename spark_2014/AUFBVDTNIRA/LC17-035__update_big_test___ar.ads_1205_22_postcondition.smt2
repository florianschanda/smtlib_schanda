...
(declare-fun temp___2788 ((Array Int us_rep) Int us_rep) (Array Int us_rep))

;; def_axiom
  (assert
  (forall ((temp___2790 (Array Int us_rep)))
  (forall ((temp___2791 Int))
  (forall ((temp___2792 us_rep))
  (let ((temp___2789 (temp___2788 temp___2790 temp___2791 temp___2792)))
  (forall ((temp___2793 Int))
  (ite (= temp___2793 temp___2791)
  (= (select temp___2789 temp___2793) temp___2792)
  (= (select temp___2789 temp___2793) (select temp___2790 temp___2793)))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1198, characters 0-0
  (not
  (= (bool_eq4 a2 1 10
     (temp___2788 a i
     (mk___rep
