...
;; H
  ...
  (bvugt (bvadd msg_byte_count1 (to_rep1 ctx__split_fields9)) ((_ int2bv 64) 64))
  (=> (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0))
  (=> (bvugt c238b ((_ int2bv 64) 0)) (= temp___1373 src3)))))
...
;; H
  (assert (dynamic_predicate1 temp___1382))

;; H
  (assert (= o24 temp___1382))
...
;; H
  (assert (= temp___1384 (mk___rep2 o25)))

;; H
  (assert (= result21 ctx__split_fields29))

;; H
  (assert (= ctx__split_fields31 (us_split_fields5 temp___1384)))
