...
(define-fun dynamic_invariant3 ((temp___expr_583 us_rep1)
  (temp___is_init_580 Bool) (temp___skip_constant_581 Bool)
  (temp___do_toplevel_582 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_581 true))
                                      (in_range3
                                      (to_rep
                                      (rec__very_longs__very_long__length
                                      (us_split_discrs1 l)))
                                      (to_base temp___expr_583)))
                                      ...
                                      (first3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_583)))
                                      (last5
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_583))))
                                      (and
                                      (= (first3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_583))) 1)
                                      (= (last5
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_583))) 
                                      (to_rep
...
(define-fun default_initial_assumption ((temp___expr_586 us_rep1)
  (temp___skip_top_level_587 Bool)) Bool (= (to_rep
                                            (rec__very_longs__very_long__length
                                            (us_split_discrs2
                                            temp___expr_586))) (to_rep
                                                               (rec__very_longs__very_long__length
                                                               (us_split_discrs1
                                                               l)))))
...
(declare-fun temp___930 ((_ BitVec 8) Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___932 (_ BitVec 8)))
  (forall ((temp___933 Int) (temp___934 Int))
  (let ((temp___931 (temp___930 temp___932 temp___933 temp___934)))
  (and
  (=> (dynamic_property6 1 65536 temp___933 temp___934)
  (and (= (first5 temp___931) temp___933) (= (last8 temp___931) temp___934)))
  (forall ((temp___935 Int))
  (= (select (to_array2 temp___931) temp___935) (of_rep1 temp___932))))))))
...
;; H
  (assert
  (= (mk___t2 temp___937 temp___9371) (temp___930 ((_ int2bv 8) 0) 1
                                      (to_rep
                                      (rec__very_longs__very_long__length
                                      (us_split_discrs1 l))))))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 84, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first4 temp___9371)) (to_rep2 (last7 temp___9371)))
     (+ (- (to_rep2 (last7 temp___9371)) (to_rep2 (first4 temp___9371))) 1)
     0) (ite (<= 1 (to_rep
