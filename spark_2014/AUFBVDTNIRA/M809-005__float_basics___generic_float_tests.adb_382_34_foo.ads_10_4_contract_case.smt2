...
(define-fun dynamic_invariant1 ((temp___expr_137 t) (temp___is_init_134 Bool)
...
;; H
  (assert (and (= o (to_int1 RNA1 x)) (in_range2 (to_int1 RNA1 x))))
...
;; H
  (assert (=> (= (bool_eq x (neg fliteral3)) true) (= i2 (- 2))))

;; H
  (assert (= (bool_eq x (neg fliteral4)) true))
