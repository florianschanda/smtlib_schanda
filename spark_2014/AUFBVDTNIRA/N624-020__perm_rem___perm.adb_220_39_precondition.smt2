...
(define-fun o14 () us_t (mk___t o12 o13))

(define-fun o15 () us_t (mk___t o9 o10))

(define-fun o16 () us_t (mk___t o6 o7))
...
;; H
  (assert
  (and
  (= o11 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))))

;; H
  (assert (and (= o8 ia1) (in_range4 ia1)))

;; H
  (assert
  (and (and (= o15 (remove a o8)) (remove__function_guard o15 a o8))
  (and (dynamic_invariant2 o15 true false true)
  (and (= (invariant__ o15) true)
  (and (= (to_rep2 (last o10)) (- (to_rep2 (last (rt a))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o8 1)))
  ...
  (and
  (forall ((k Int))
  (=> (and (<= (+ o8 1) k) (<= k (to_rep2 (last (rt a)))))
  (= (to_rep (select (elts a) k)) (to_rep (select o9 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o8 k) (<= k (- (to_rep2 (last (rt a))) 1)))
  (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o9 k))))))))))))

;; H
  (assert
  (and (and (= o14 (remove o15 o11)) (remove__function_guard o14 o15 o11))
  (and (dynamic_invariant2 o14 true false true)
  (and (= (invariant__ o14) true)
  (and (= (to_rep2 (last o13)) (- (to_rep2 (last o10)) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o11 1)))
  (= (to_rep (select o9 k)) (to_rep (select o12 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o11 1) k) (<= k (to_rep2 (last o10))))
  (= (to_rep (select o9 k)) (to_rep (select o12 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o11 k) (<= k (- (to_rep2 (last o10)) 1)))
  (= (to_rep (select o9 (+ k 1))) (to_rep (select o12 k))))))))))))
...
;; H
  (assert
  (and (and (= o16 (remove bb ib1)) (remove__function_guard o16 bb ib1))
  (and (dynamic_invariant2 o16 true false true)
  (and (= (invariant__ o16) true)
  (and (= (to_rep2 (last o7)) (- (to_rep2 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select o6 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select o6 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o6 k))))))))))))
