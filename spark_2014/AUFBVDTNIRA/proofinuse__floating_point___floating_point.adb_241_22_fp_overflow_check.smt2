...
;; H
  (assert (le fliteral a))

;; H
  (assert (and (= o1 (sub RNE2 x z)) (tqtisFinite (sub RNE2 x z))))

;; H
  (assert (and (= o (sub RNE2 x y)) (tqtisFinite (sub RNE2 x y))))

;; H
  (assert (= o2 (div1 RNE2 o o1)))
