...
(declare-fun temp___176 (Int Int Int) us_t1)
...
;; def_axiom
  ...
  (and (= (first3 temp___177) temp___179) (= (last5 temp___177) temp___180)))
  (forall ((temp___181 Int))
  (= (select (to_array1 temp___177) temp___181) (of_rep2 temp___178)))))))
...
(declare-fun temp___174 () index_type)

(declare-fun temp___184 () index_type)

(declare-fun temp___1841 () (Array Int character))

(declare-fun temp___1842 () t)

(declare-fun temp___1843 () length_type)

(define-fun temp___1844 () us_rep (mk___rep (mk___split_discrs temp___184)
                                  (mk___split_fields
                                  (mk___t temp___1841 temp___1842)
                                  temp___1843)))
...
;; H
  (assert (= temp___175 (to_rep temp___174)))

;; H
  (assert
  (and (dynamic_invariant1 temp___1844 true false true)
  (and
  (let ((temp___186 (temp___176 32 1 (to_rep temp___184))))
  (and (= temp___1841 (elts1 temp___186))
  (= temp___1842 (mk (to_rep3 (first2 (rt1 temp___186)))
                 (to_rep3 (last4 (rt1 temp___186)))))))
  (= (to_rep1 temp___1843) 0))))

;; H
  (assert (length__function_guard (length2 temp___1844) temp___1844))

(assert
;; WP_parameter_def
 ;; File "bounded_strings.ads", line 38, characters 0-0
  (not (= (length2 temp___1844) 0)))
(check-sat)
