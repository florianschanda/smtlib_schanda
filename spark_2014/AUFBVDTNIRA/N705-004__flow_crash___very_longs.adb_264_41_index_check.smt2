...
(declare-fun temp___985 () digit_index_type)

(declare-fun temp___9851 () (Array Int octet))

(declare-fun temp___9852 () t1)
...
;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___982 temp___9821)))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___985)))

;; H
  (assert (= temp___9851 o2))

;; H
  (assert (= temp___9852 o3))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___9851 temp___9852))))
