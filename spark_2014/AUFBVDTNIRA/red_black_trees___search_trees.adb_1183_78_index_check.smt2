...
(declare-fun temp___1298 () (Array Int us_rep1))
...
(declare-fun search_trees__contains__result () Bool)

(declare-fun temp___1293 () Int)

(declare-fun result3 () int__ref)

(declare-fun temp___12931 () Int)
...
(declare-fun search_trees__contains__result1 () Bool)
...
;; H
  (assert (= result3 (mk_int__ref temp___1293)))
...
;; H
  ...
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o7)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o7))

;; H
  (assert (parent__function_guard
  (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o7)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o7))

;; H
  (assert
  (forall ((j Int)) (parent__function_guard
  (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) j)))

;; H
  (assert
  (forall ((j Int)) (position__function_guard
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) j)))
...
;; H
  (assert (position__function_guard
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o9)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o9))

;; H
  (assert (parent__function_guard
  (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o9)
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o9))
...
;; H
  (assert
  (= o1 (select (rec__search_trees__search_tree__values (us_split_fields7 t)) 
  o)))
...
;; H
  (assert
  (= o4 (select (rec__search_trees__search_tree__values (us_split_fields7 t)) 
  o3)))
...
;; H
  ...
  (and
  (and
  (= o7 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t))
        o6 0))
  (peek__function_guard o7
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o6 0))
  (and (in_range4 o7)
  (and
  (ite (not (= o7 0))
  (and
...
;; H
  (assert
  (=> (not (= result6 true)) (and (= o8 current2) (in_range3 current2))))
...
;; H
  ...
  (and
  (and
  (= o9 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t))
        o8 1))
  (peek__function_guard o9
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o8 1))
  (and (in_range4 o9)
  (and
  (ite (not (= o9 0))
  (and
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1298 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1298 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1298 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (model____function_guard temp___1298
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o10))
  (and (dynamic_invariant9 temp___1298 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1298 o10))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1298 o10)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i o10))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1298 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1298 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1298 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1298 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1298 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1298 j)))) true))
  (= j i))))))))))))))
