...
(declare-fun temp___197 () index_type)

(declare-fun temp___1971 () (Array Int character))

(declare-fun temp___1972 () t)

(declare-fun temp___1973 () length_type)
...
;; H
  (assert (= target__split_discrs (mk___split_discrs temp___197)))

;; H
  (assert (= temp___1971 o10))

;; H
  (assert (= temp___1972 o11))

;; H
  (assert (= temp___1973 o12))
...
;; H
  ...
  (= target__split_fields6 (mk___split_fields
                           (mk___t temp___1971 temp___1972) temp___1973)))
...
;; H
  ...
  (length1
  (mk___rep target__split_discrs
  (us_split_fields__content target__split_fields7)))
  (mk___rep target__split_discrs
  (us_split_fields__content target__split_fields7))))
