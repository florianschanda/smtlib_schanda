...
;; H
  (assert
  (and
  (ite (= (to_rep (select the_file cur_position)) eof_ch)
  (and (= cur_position1 cur_position) (= ch1 eof))
  (ite (= (to_rep (select the_file cur_position)) 10)
  (and (= cur_position1 cur_position) (= ch1 10))
  (and (= cur_position1 (+ cur_position 1))
  (= ch1 (to_rep (select the_file cur_position))))))
  (and (in_range2 ch1) (in_range cur_position1))))
