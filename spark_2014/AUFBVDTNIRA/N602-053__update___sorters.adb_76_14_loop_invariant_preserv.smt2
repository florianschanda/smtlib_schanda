...
(define-fun o10 () us_t (mk___t o6 o7))

(define-fun o11 () us_t (mk___t o1 o2))
...
;; H
  (assert
  (and
  (and (= o3 (index_of_minimum o11)) (index_of_minimum__function_guard 
  o3 o11))
  (and (in_range2 o3)
...
;; H
  (assert
  (= (mk (to_rep (first4 temp___1813)) (to_rep (last4 temp___1813))) 
  o7))

;; H
  (assert
  (and
  (and (= o8 (index_of_minimum o10)) (index_of_minimum__function_guard 
  o8 o10))
  (and (in_range2 o8)
...
;; H
  ...
  (= (let ((temp___151 (temp___141
     ...
     (bool_eq2 values4 (to_rep values__first) (to_rep values__last)
     (elts temp___151) (to_rep (first (rt temp___151)))
     (to_rep (last (rt temp___151))))) true)))
