...
(define-fun dynamic_invariant1 ((temp___expr_138 Int)
  ...
  (temp___do_toplevel_137 Bool)) Bool (=>
                                      ...
                                      (<= 1 10)) (in_range2 temp___expr_138)))
...
;; H
  (assert
  (forall ((n Int))
  (=> (and (<= 1 n) (<= n i2)) (< 0 (to_rep (select a2 n))))))
...
;; H
  ...
  (=> (and (<= 1 temp___224) (<= temp___224 10))
  (=> (< i2 temp___224) (= (select a2 temp___224) (select a temp___224))))))
  (and (<= 1 i2) (<= i2 10))))
