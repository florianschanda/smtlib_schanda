...
(declare-fun c__split_fields () us_private)

(declare-fun cc__split_fields () us_private)
...
(declare-fun c__split_fields1 () us_private)
...
(define-fun c__split_fields2 () us_split_fields (mk___split_fields
                                                c__split_fields1))
...
;; H
  (assert (= us_null_ext__ c__split_fields1))

;; H
  (assert (= c__attr__tag us_tag1))

;; H
  (assert (= result1 cc__split_fields))

;; H
  (assert (= (mk___split_fields cc__split_fields1) c__split_fields2))

;; H
  (assert (= cc__attr__tag c__attr__tag))

;; H
  (assert (= result2 r2__split_fields))

;; H
  (assert (= r2__split_fields2 c__split_fields2))

;; H
  (assert (= r2__attr__tag us_tag))

;; H
  (assert (= result3 rc2__split_fields))
...
(assert
;; WP_parameter_def
 ;; File "tagged_conv.adb", line 9, characters 0-0
  (not (us_compatible_tags cc__attr__tag us_tag1)))
(check-sat)
