...
(define-fun dynamic_invariant3 ((temp___expr_229 t) (temp___is_init_226 Bool)
  (temp___skip_constant_227 Bool)
  (temp___do_toplevel_228 Bool)) Bool (=>
                                      (or (= temp___is_init_226 true) (le
                                      (neg fliteral1) fliteral1))
                                      (tqtisFinite temp___expr_229)))

(declare-fun to_float (Int) t)

(declare-fun to_float__function_guard (t Int) Bool)
...
(define-fun bool_eq5 ((x1 t) (y t)) Bool (ite (eq x1 y) true false))
...
(define-fun dynamic_invariant4 ((temp___expr_235 t) (temp___is_init_232 Bool)
  (temp___skip_constant_233 Bool)
  (temp___do_toplevel_234 Bool)) Bool (=>
                                      (or (= temp___is_init_232 true) (le
                                      (neg fliteral1) fliteral1))
                                      (tqtisFinite temp___expr_235)))
...
(declare-fun to_int3 (t) Int)

(declare-fun to_int__function_guard (Int t) Bool)
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral2) (/ 500000000000000000000000.0 1000000000000000000000000.0))))

;; x2__def_axiom
  (assert (= x2 (mul RNE2 x fliteral2)))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral3) (/ 150000000000000000000000.0 100000000000000000000000.0))))

;; threehalfs__def_axiom
  (assert (= threehalfs fliteral3))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral4) (/ 99999997473787516355514526367187500.0 10000000000000000000000000000000000000000.0))))
...
;; H
  (assert (= (mul RNE2 x fliteral2) x2))

;; H
  (assert (tqtisFinite x2))

;; H
  (assert (tqtisFinite threehalfs))

;; H
  (assert (le fliteral4 x))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (tqtisFinite (mul RNE2 y1 y1))))
(check-sat)
