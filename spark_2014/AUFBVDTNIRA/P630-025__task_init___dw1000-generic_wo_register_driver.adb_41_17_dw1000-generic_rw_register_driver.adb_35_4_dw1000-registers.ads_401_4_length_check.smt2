...
(define-fun us_split_fields__ref_49__projection ((a us_split_fields__ref)) us_split_fields 
...
(declare-fun dw1000__register_types__drx_tune2_type__drx_tune2__first__bit () Int)

(declare-fun dw1000__register_types__drx_tune2_type__drx_tune2__last__bit () Int)

(declare-fun dw1000__register_types__drx_tune2_type__drx_tune2__position () Int)
...
(define-fun register_type__ref_114__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_81__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_81__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_4867 us_t1)
  (temp___is_init_4864 Bool) (temp___skip_constant_4865 Bool)
  (temp___do_toplevel_4866 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_4865 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_4867)
                                       (last4 temp___expr_4867))
                                       (and (= (first3 temp___expr_4867) 1)
                                       (= (last4 temp___expr_4867) 4)))))
...
(define-fun target__ref_34__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_34__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_4883 us_t2)
  (temp___is_init_4880 Bool) (temp___skip_constant_4881 Bool)
  (temp___do_toplevel_4882 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_4881 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_4883)
                                       (last6 temp___expr_4883))
                                       (and (= (first5 temp___expr_4883) 1)
                                       (= (last6 temp___expr_4883) 4)))))
...
(declare-fun temp___7806 () (Array Int bits_8))

(declare-fun temp___78061 () t2)

(declare-fun temp___7807 () (Array Int bits_8))

(declare-fun temp___78071 () t1)

(define-fun temp___78062 () us_t2 (mk___t2 temp___7806 temp___78061))
...
;; H
  (assert
  (and
  (and (= temp___78062 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___78062 reg)) (dynamic_invariant1
  temp___78062 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___78061)) (to_rep (last5 temp___78061)))
     (+ (- (to_rep (last5 temp___78061)) (to_rep (first4 temp___78061))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___7806 temp___7807))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78061)) (to_rep (last5 temp___78061))) 
  temp___78071))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___78071)) (to_rep (last3 temp___78071)))
     (+ (- (to_rep (last3 temp___78071)) (to_rep (first2 temp___78071))) 1)
