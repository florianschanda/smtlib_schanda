...
;; H
  (assert
  (=> (and (bvult i1 range_size) (not (= matched1 true)))
  (= matched13 (mk_bool__ref matched4))))
...
;; H
  (assert
  (= (mk_bool__ref result5) (mk_bool__ref inrange1__inrange64__result)))
...
;; H
  (assert
  (= inrange1__inrange64__result4 (mk_bool__ref inrange1__inrange64__result2)))
...
;; H
  (assert (= result6 (bool__content inrange1__inrange64__result4)))

;; H
  (assert (= (bool__content inrange1__inrange64__result4) true))
...
;; WP_parameter_def
 ;; File "inrange1.ads", line 15, characters 0-0
  ...
  (bvule n (bvsub range_size ((_ int2bv 64) 1)))) (= var (bvadd bottom n))))))
(check-sat)
