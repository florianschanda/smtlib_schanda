...
(declare-fun temp___1092 () (Array Int us_rep1))
...
;; H
  (assert
  (and (= temp___1092 (model__ f1 root))
  (and (dynamic_invariant2 temp___1092 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1092 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1092 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f1 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1092 (parent f1 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1092 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1092 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1092 (parent f1 i1)))) (position f1 i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1092 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1092 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1092 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1092 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1092 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o o1)) (select temp___1092 i)))
