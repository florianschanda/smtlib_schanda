...
(declare-fun temp___1665 () (Array Int us_rep1))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1665 (parent f1 i1)))) (position f1 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1665 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1665 (parent f1 i1)))) (position f1 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1665 i1))))))
...
;; H
  (assert
  (and
  (and (= temp___1665 (model__ f1 root)) (model____function_guard temp___1665
  f1 root))
  (and (dynamic_invariant2 temp___1665 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1665 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1665 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f1 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1665 (parent f1 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1665 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1665 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1665 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1665 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1665 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1665 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o o1)) (select temp___1665 i)))
