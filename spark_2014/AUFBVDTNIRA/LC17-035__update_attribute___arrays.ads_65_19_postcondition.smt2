...
(declare-fun temp___326 ((Array Int integer) Int Int Int
  Int) (Array Int integer))

;; def_axiom
  (assert
  (forall ((temp___328 (Array Int integer)))
  ...
  (ite (= temp___333 temp___331)
  (= (select temp___327 temp___333) (of_rep temp___332))
  (ite (= temp___333 temp___329)
  (= (select temp___327 temp___333) (of_rep temp___330))
  (= (select temp___327 temp___333) (select temp___328 temp___333)))))))))
...
(assert
;; WP_parameter_def
 ;; File "arrays.ads", line 61, characters 0-0
  (not
  (= (bool_eq2 a3 1 8
     (temp___326 a i (to_rep (select a j)) j (to_rep (select a i))) 1 8) true)))
(check-sat)
