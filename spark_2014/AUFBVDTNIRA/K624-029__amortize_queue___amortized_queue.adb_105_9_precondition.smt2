...
(define-fun o9 () us_rep (mk___rep (mk___split_discrs o2)
...
;; H
  (assert
  (and
  (= o10 (copy (rec__amortized_queue__queue__front (us_split_fields3 q))
         1000))
  (and
  (= (oeq1 (model__ o10)
...
;; WP_parameter_def
 ;; File "amortized_queue.ads", line 41, characters 0-0
  ...
  (< (length
     ...
     (rec__amortized_queue__queue__rear result____split_fields4))
     (us_split_fields1
     (rec__amortized_queue__queue__rear result____split_fields4)))) (capacity
                                                                    (mk___rep
                                                                    (us_split_discrs1
                                                                    (rec__amortized_queue__queue__rear
