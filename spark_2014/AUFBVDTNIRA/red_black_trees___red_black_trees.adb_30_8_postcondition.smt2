...
(declare-fun red_black_trees__nb_blacks__result () (Array Int us_rep6))
...
(declare-fun temp___1792 () (Array Int us_rep6))
...
(declare-fun res14 () map__ref4)

(declare-fun n5 () int__ref)

(declare-fun i11 () int__ref)

(declare-fun res15 () (Array Int us_rep6))

(declare-fun n6 () Int)

(declare-fun i12 () Int)

(declare-fun result7 () map__ref4)

(declare-fun red_black_trees__nb_blacks__result1 () (Array Int us_rep6))

(declare-fun red_black_trees__nb_blacks__result2 () map__ref4)

(declare-fun red_black_trees__nb_blacks__result3 () (Array Int us_rep6))

(declare-fun res16 () map__ref4)

(declare-fun n7 () int__ref)

(declare-fun i13 () int__ref)

(declare-fun red_black_trees__nb_blacks__result4 () map__ref4)

(declare-fun res17 () (Array Int us_rep6))

(declare-fun n8 () Int)

(declare-fun i14 () Int)

(declare-fun red_black_trees__nb_blacks__result5 () (Array Int us_rep6))

(declare-fun result8 () (Array Int us_rep6))
...
;; H
  (assert
  (forall ((i15 Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i15 0)
  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i15 0)))

;; H
  (assert
  (forall ((i15 Int)) (peek__function_guard
  (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i15 1)
  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i15 1)))
...
;; H
  (assert (=> (and (<= 0 n1) (<= n1 99)) (= temp___1792 res1)))

;; H
  (assert (=> (and (<= 0 n1) (<= n1 99)) (= temp___1791 n1)))
...
;; H
  ...
  (<= (to_rep
      (rec__red_black_trees__black_count__count
      (us_split_fields11 (select res2 i15)))) (to_rep
                                              (rec__red_black_trees__black_count__depth
                                              (us_split_fields11
                                              (select res2 i15)))))))))
...
;; H
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res2 i15)))) 100)
  (<= (to_rep
      (rec__red_black_trees__black_count__depth
      (us_split_fields11 (select res2 i15)))) n2))))))
...
;; H
  ...
  (=> (and (<= 1 i15) (<= i15 100))
  (ite (and
       (= (rec__tree_model__path_type__k (us_split_fields1 (select m i15))) true)
       (< n2 (to_rep
             (rec__red_black_trees__black_count__depth
             (us_split_fields11 (select res2 i15))))))
  (< (length
     (rec__tree_model__path_type__a (us_split_fields1 (select m i15)))) (- 100 
  n2))
  (=>
  (= (rec__tree_model__path_type__k (us_split_fields1 (select m i15))) true)
  (and
  ...
  (=
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select res2 i15))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11
     (select res2 (peek
                  ...
                  i15 0))))) (to_rep
                             ...
                             (select res2 (peek
                                          (rec__red_black_trees__rbt__struct
                                          (us_split_fields9 t)) i15 1))))))))
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res2 i15)))) (+ 1 (ite (< (to_rep
                                                          (rec__red_black_trees__black_count__depth
                                                          (us_split_fields11
                                                          (select res2 
                                                          (peek
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select res2 i15)))) (+ (ite (= (to_rep3
...
;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (and (=> (<= 0 99) (in_range10 n2)) (and (<= 0 n2) (<= n2 99)))))
...
;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (and (<= 1 i3) (<= i3 100)) (= temp___1767 i3))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (and (<= 1 i3) (<= i3 100)) (= temp___1765 res2))))
...
;; H
  ...
  (<= (to_rep
      (rec__red_black_trees__black_count__count
      (us_split_fields11 (select res3 i15)))) (to_rep
                                              (rec__red_black_trees__black_count__depth
                                              (us_split_fields11
                                              (select res3 i15))))))))))
...
;; H
  ...
  (=> (<= 1 100) (in_range2 i4))) (and (<= 1 i4) (<= i4 100))))))
...
;; H
  ...
  (and
  (and
  (= o17 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i4 1))
...
;; H
  ...
  (and
  (and
  (= o18 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i4 0))
...
;; H
  ...
  (= o20 (mk___split_fields5
         (rec__red_black_trees__black_count__status
         (us_split_fields11 (select res3 i4))) o19
         (rec__red_black_trees__black_count__count
...
;; H
  ...
  (= res5 (store res4 i4 (mk___rep5
                         ...
                         true false)
                         (rec__red_black_trees__black_count__depth
                         (us_split_fields11 (select res4 i4)))
                         (rec__red_black_trees__black_count__count
                         (us_split_fields11 (select res4 i4))))))))))))
...
;; H
  ...
  (= o25 (mk___split_fields5
         (rec__red_black_trees__black_count__status
         (us_split_fields11 (select res5 i4)))
         (rec__red_black_trees__black_count__depth
         (us_split_fields11 (select res5 i4))) o24))))))))
...
;; H
  ...
  (= o29 (mk___split_fields5
         ...
         (us_split_fields11 (select res5 i4)))
         (rec__red_black_trees__black_count__depth
         (us_split_fields11 (select res5 i4))) o28))))))))
...
;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i3) (<= i3 100)) (= i4 100))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (and (<= 1 i3) (<= i3 100)) (= i5 (mk_int__ref i4)))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (and (<= 1 i3) (<= i3 100)) (= res8 (mk_map__ref4 res6)))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i3) (<= i3 100)) (= i6 i4))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (and (<= 1 i3) (<= i3 100)) (= res9 res6))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i3) (<= i3 100)) (= i7 i5))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (and (<= 1 i3) (<= i3 100)) (= res10 res8))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99)) (=> (and (<= 1 i3) (<= i3 100)) (= i8 i6))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (and (<= 1 i3) (<= i3 100)) (= res11 res9))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (not (and (<= 1 i3) (<= i3 100))) (= i7 (mk_int__ref i3)))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (not (and (<= 1 i3) (<= i3 100))) (= res10 (mk_map__ref4 res2)))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (not (and (<= 1 i3) (<= i3 100))) (= i8 i3))))

;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 99))
  (=> (not (and (<= 1 i3) (<= i3 100))) (= res11 res2))))
...
;; H
  (assert
  (=> (not (and (<= 0 n1) (<= n1 99))) (= res14 (mk_map__ref4 res1))))
...
;; H
  (assert
  (= red_black_trees__nb_blacks__result2 (mk_map__ref4
                                         red_black_trees__nb_blacks__result1)))

;; H
  (assert
  (= red_black_trees__nb_blacks__result3 red_black_trees__nb_blacks__result1))
...
;; H
  (assert
  (= red_black_trees__nb_blacks__result4 red_black_trees__nb_blacks__result2))
...
;; H
  (assert
  (= red_black_trees__nb_blacks__result5 red_black_trees__nb_blacks__result3))
...
;; WP_parameter_def
 ;; File "red_black_trees.adb", line 20, characters 0-0
  (not
  (= (bool_eq18
     (select (map__content4 red_black_trees__nb_blacks__result4) 0)
     (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true)))
(check-sat)
