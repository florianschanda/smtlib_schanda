...
(define-fun ib13 () int__ref (mk_int__ref ib))

(define-fun ia14 () int__ref (mk_int__ref ia))
...
;; H
  (assert
  (forall ((ia15 Int)) (remove__function_guard (remove aa ia15) aa ia15)))

;; H
  (assert
  (forall ((ib14 Int)) (remove__function_guard (remove bb ib14) bb ib14)))
...
;; H
  (assert
  (forall ((ia15 Int) (ib14 Int)) (is_perm__function_guard
  (is_perm (remove aa ia15) (remove bb ib14)) (remove aa ia15)
  (remove bb ib14))))

;; H
  (assert (remove__function_guard (remove a ia2) a ia2))

;; H
  (assert
  (forall ((ib14 Int)) (remove__function_guard (remove b ib14) b ib14)))
...
;; H
  (assert
  (forall ((ib14 Int)) (is_perm__function_guard
  (is_perm (remove a ia2) (remove b ib14)) (remove a ia2) (remove b ib14))))
...
;; H
  (assert
  (forall ((k Int) (ib14 Int)) (is_perm__function_guard
  (is_perm (remove a k) (remove b ib14)) (remove a k) (remove b ib14))))
...
;; H
  ...
  (and (= ib9 ib13) (and (= ia10 ia14) (= ih10 ih14))))
  (and (= perm__extended_perm__result7 perm__extended_perm__result2)
  (and (= ib10 ib1) (and (= ia11 ia1) (= ih11 ih1)))))
  (and (= (length a) 0)
  ...
  (forall ((ia15 Int))
  (=>
  (and (<= (to_rep2 (first (rt aa))) ia15)
  (<= ia15 (to_rep2 (last (rt aa)))))
  (exists ((ib14 Int))
  (and
  (and (<= (to_rep2 (first (rt bb))) ib14)
  (<= ib14 (to_rep2 (last (rt bb)))))
  (and (= (to_rep (select (elts aa) ia15)) (to_rep (select (elts bb) ib14)))
  (= (is_perm (remove aa ia15) (remove bb ib14)) true)))))))))
  (and (= result1 ih14) (= ih2 o)))
  (and (in_range3 ih2)
  (and (= (of_int ih2) true)
  (and
  (and (and (= result2 ia14) (= ia2 (to_rep2 (first (rt a)))))
  (ite (and (<= (to_rep2 (first (rt a))) ia2)
  ...
  (exists ((ib14 Int))
  (and
  (and (<= (to_rep2 (first (rt b))) ib14) (<= ib14 (to_rep2 (last (rt b)))))
  (and (= (to_rep (select (elts a) ia2)) (to_rep (select (elts b) ib14)))
  (= (is_perm (remove a ia2) (remove b ib14)) true))))
  (and
  ...
  (and
  (and (<= (to_rep2 (first (rt b))) ib14) (<= ib14 (to_rep2 (last (rt b)))))
  (and (= (to_rep (select (elts a) k)) (to_rep (select (elts b) ib14)))
  (= (is_perm (remove a k) (remove b ib14)) true))))))
  (and
  (and
  (and
  ...
  (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a))))
  (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) 
  ia3))) (=> (<= 1 100) (in_range4 ib2)))
  (and (<= (to_rep2 (first (rt a))) ia3) (<= ia3 (to_rep2 (last (rt a))))))
  (= ia3 (to_rep2 (last (rt a)))))))))))
  (and
  (and (= ib3 (mk_int__ref ib2))
  (and (= ia4 (mk_int__ref ia3)) (= ih4 (mk_int__ref ih3))))
  (and (= ib4 ib2) (and (= ia5 ia3) (= ih5 ih3)))))
  (and (and (= ib5 ib3) (and (= ia6 ia4) (= ih6 ih4)))
  (and (= ib6 ib4) (and (= ia7 ia5) (= ih7 ih5)))))
  (and
  (and (= ib5 ib13)
  (and (= ia6 (mk_int__ref ia2)) (= ih6 (mk_int__ref ih2))))
  (and (= ib6 ib1) (and (= ia7 ia2) (= ih7 ih2))))))
...
;; H
  (assert (= result4 (int__content perm__extended_perm__result8)))

;; H
  (assert (= (of_int (int__content perm__extended_perm__result8)) true))

(declare-fun ia15 () Int)

;; H
  (assert (<= (to_rep2 (first (rt a))) ia15))

;; H
  (assert (<= ia15 (to_rep2 (last (rt a)))))

;; H
  (assert (remove__function_guard (remove a ia15) a ia15))
...
;; H
  (assert
  (forall ((ib14 Int)) (is_perm__function_guard
  (is_perm (remove a ia15) (remove b ib14)) (remove a ia15) (remove b ib14))))
...
;; WP_parameter_def
 ;; File "perm.ads", line 2, characters 0-0
  ...
  (and
  (and (<= (to_rep2 (first (rt b))) ib14) (<= ib14 (to_rep2 (last (rt b)))))
  (and (= (to_rep (select (elts a) ia15)) (to_rep (select (elts b) ib14)))
  (= (is_perm (remove a ia15) (remove b ib14)) true))))))
(check-sat)
