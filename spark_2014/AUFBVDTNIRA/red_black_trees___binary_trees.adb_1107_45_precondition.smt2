...
;; H
  (assert (=> (and (<= 1 r1) (<= r1 r313b)) (= temp___2879 r1)))
...
;; H
  (assert (=> (and (<= 1 r1) (<= r1 r313b)) (= r2 r313b)))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 r313b)) (= r3 (mk_int__ref r2))))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 r313b)) (= r4 r2)))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 r313b)) (= r5 r3)))

;; H
  (assert (=> (and (<= 1 r1) (<= r1 r313b)) (= r6 r4)))

;; H
  (assert (=> (not (and (<= 1 r1) (<= r1 r313b))) (= r5 (mk_int__ref r1))))

;; H
  (assert (=> (not (and (<= 1 r1) (<= r1 r313b))) (= r6 r1)))
...
;; H
  (assert
  (forall ((r9 Int)) (model____function_guard
  (model__
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  r9)
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
...
;; H
  ...
  (forall ((r9 Int)) (model____function_guard
  (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  r9) (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) r9)))
...
;; H
  (assert
  (forall ((r9 Int)) (oeq__function_guard1
  (oeq1
  (model__
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  r9)
...
;; H
  ...
  (= (= result2 true)
  (forall ((r9 Int))
  (=> (and (<= 1 r9) (<= r9 (to_rep f_old__split_fields)))
  (=>
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3 (select f_old__split_fields1 r9)))) 2)
  (= (oeq1
     (model__
     (mk___rep2
     (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r9)
     (model__
     (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) r9)) true))))))
