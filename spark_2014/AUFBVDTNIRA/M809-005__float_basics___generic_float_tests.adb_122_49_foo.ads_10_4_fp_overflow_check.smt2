...
(define-fun dynamic_invariant ((temp___expr_137 t) (temp___is_init_134 Bool)
  (temp___skip_constant_135 Bool)
  (temp___do_toplevel_136 Bool)) Bool (=>
                                      (or (= temp___is_init_134 true) (le
                                      (neg fliteral1) fliteral1))
                                      (tqtisFinite temp___expr_137)))
...
(declare-fun foo__float_tests__bad_optimisation_1__result () t)
...
(declare-fun foo__float_tests__bad_optimisation_1__result1 () t)

(declare-fun foo__float_tests__bad_optimisation_1__result2 () t)

(declare-fun foo__float_tests__bad_optimisation_1__result3 () t)

(declare-fun foo__float_tests__bad_optimisation_1__result4 () t)

(declare-fun foo__float_tests__bad_optimisation_1__result5 () t)
...
;; H
  (assert
  (= foo__float_tests__bad_optimisation_1__result1 foo__float_tests__bad_optimisation_1__result2))

;; H
  (assert
  (= foo__float_tests__bad_optimisation_1__result3 foo__float_tests__bad_optimisation_1__result1))
...
;; H
  ...
  (= (mk_t__ref result) (mk_t__ref
                        foo__float_tests__bad_optimisation_1__result)))

;; H
  (assert (= foo__float_tests__bad_optimisation_1__result1 o2))

;; H
  (assert
  (= (mk_t__ref foo__float_tests__bad_optimisation_1__result4) (mk_t__ref
                                                               foo__float_tests__bad_optimisation_1__result2)))

;; H
  (assert
  (= foo__float_tests__bad_optimisation_1__result5 foo__float_tests__bad_optimisation_1__result3))

(assert
;; WP_parameter_def
 ;; File "generic_float_tests.ads", line 2, characters 0-0
  (not (tqtisFinite (div1 RNE2 a b))))
(check-sat)
