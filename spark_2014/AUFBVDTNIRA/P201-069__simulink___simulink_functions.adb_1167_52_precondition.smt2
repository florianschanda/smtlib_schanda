...
(declare-fun arccosh (t) t)

(declare-fun arccosh__function_guard (t t) Bool)
...
;; arccosh__post_axiom
  (assert
  (forall ((x t))
  (! (=> (and (dynamic_invariant x true true true) (le fliteral x))
     (let ((result (arccosh x)))
     (and
     (and (le fliteral2 result) (=> (eq x fliteral) (eq result fliteral2)))
