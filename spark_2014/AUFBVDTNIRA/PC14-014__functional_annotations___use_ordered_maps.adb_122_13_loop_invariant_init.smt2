...
;; H
  (assert
  (and (= result1 (has_key1 (positions s2) (mk___rep1 cu__split_fields2)))
  (= (= result1 true)
  (= (has_key1 (positions s2) (mk___rep1 cu__split_fields2)) true))))
...
;; WP_parameter_def
 ;; File "use_ordered_maps.ads", line 73, characters 0-0
  ...
  (get2 (positions s2) (mk___rep1 cu__split_fields2))))))
(check-sat)
