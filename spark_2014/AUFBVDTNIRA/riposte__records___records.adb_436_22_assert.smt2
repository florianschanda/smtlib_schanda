...
;; H
  (assert (= temp___442 o6))

;; H
  (assert (= temp___4421 o7))

;; H
  (assert (= temp___4422 o8))
...
;; H
  (assert (= temp___442 x__split_fields3))

;; H
  (assert (= temp___4421 x__split_fields4))

;; H
  (assert (= temp___4422 x__split_fields5))
