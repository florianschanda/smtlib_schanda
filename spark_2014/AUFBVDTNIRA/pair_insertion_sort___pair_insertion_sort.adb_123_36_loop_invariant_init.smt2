...
;; H
  (assert (sorted__function_guard
  (sorted (mk___t a22 (mk (to_rep a__first) (to_rep a__last))) 0 (- j20 1))
  (mk___t a22 (mk (to_rep a__first) (to_rep a__last))) 0 (- j20 1)))

(assert
;; WP_parameter_def
 ;; File "pair_insertion_sort.ads", line 7, characters 0-0
  (not
  (= (sorted (mk___t a22 (mk (to_rep a__first) (to_rep a__last))) 0
     (- j20 1)) true)))
(check-sat)
