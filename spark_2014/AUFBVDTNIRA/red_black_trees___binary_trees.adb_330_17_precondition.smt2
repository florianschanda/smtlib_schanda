...
(declare-fun temp___1102 () (Array Int us_rep1))
...
(declare-fun temp___1103 () (Array Int us_rep1))
...
;; H
  (assert
  (and (= temp___1103 (model__ f2 root))
  (and (dynamic_invariant2 temp___1103 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1103 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1103 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f2 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1103 (parent f2 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1103 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1103 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1103 (parent f2 i1)))) (position f2 i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1103 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1103 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1103 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1103 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1103 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o4 o5)) (select temp___1103 i)))
...
;; H
  (assert
  (and (= temp___1102 (model__ f2 root))
  (and (dynamic_invariant2 temp___1102 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1102 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1102 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f2 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1102 (parent f2 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1102 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1102 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1102 (parent f2 i1)))) (position f2 i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1102 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1102 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1102 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1102 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1102 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o o1)) (select temp___1102 i)))
