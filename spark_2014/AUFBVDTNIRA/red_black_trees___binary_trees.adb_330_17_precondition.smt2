...
(declare-fun temp___1683 () (Array Int us_rep1))
...
(declare-fun temp___1684 () (Array Int us_rep1))
...
;; H
  (assert (forall ((i1 Int)) (parent__function_guard (parent f2 i1) f2 i1)))
...
;; H
  (assert
  (forall ((i1 Int)) (position__function_guard (position f2 i1) f2 i1)))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1684 (parent f2 i1)))) (position f2 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1684 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1684 (parent f2 i1)))) (position f2 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1684 i1))))))
...
;; H
  ...
  (is_add
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1683 (parent f2 i1)))) (position f2 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1683 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1 (select temp___1683 (parent f2 i1)))) (position f2 i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1683 i1))))))
...
;; H
  (assert
  (and
  (and (= temp___1684 (model__ f2 root)) (model____function_guard temp___1684
  f2 root))
  (and (dynamic_invariant2 temp___1684 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1684 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1684 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f2 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1684 (parent f2 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1684 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1684 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1684 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1684 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1684 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1684 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o4 o5)) (select temp___1684 i)))
...
;; H
  (assert
  (and (= o8 (length o7)) (and (in_range5 o8) (<= (+ 0 o8) 2147483647))))

;; H
  (assert (= o9 (ite (< o8 n2) true false)))
...
;; H
  (assert
  (and
  (and (= temp___1683 (model__ f2 root)) (model____function_guard temp___1683
  f2 root))
  (and (dynamic_invariant2 temp___1683 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1683 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1683 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f2 i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1683 (parent f2 i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1683 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1683 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1683 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1683 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1683 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1683 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o o1)) (select temp___1683 i)))
...
;; H
  (assert (valid_root__function_guard (valid_root f1 root) f1 root))
