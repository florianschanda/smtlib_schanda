...
(define-fun temp___968 () us_rep1 (elements
                                  (mk___rep s1__split_discrs
...
;; H
  (assert (in_range3 temp___967))

;; H
  (assert (= (iter_has_element temp___968 temp___967) true))

(define-fun e () Int (get temp___968 temp___967))
