...
;; slow_lcs_length__def_axiom
  ...
  (! (=>
     ...
     (= (slow_lcs_length s11 s21) (ite (or
                                  ...
                                  (+ 1 (slow_lcs_length (tail s11)
                                       (tail s21)))
                                  (ite (< (slow_lcs_length s11 (tail s21)) 
...
;; H
  (assert (head__function_guard (head o8) o8))

;; H
  (assert (tail__function_guard (tail o9) o9))

;; H
  (assert (tail__function_guard (tail o8) o8))
...
;; H
  (assert (slow_lcs_length__function_guard (slow_lcs_length o9 (tail o8)) 
  o9 (tail o8)))
...
;; H
  (assert (slow_lcs_length__function_guard (slow_lcs_length (tail o9) o8)
  (tail o9) o8))

;; H
  (assert
  (and (and (= o8 (tail s2)) (tail__function_guard o8 s2))
...
;; H
  (assert
  (and
  (and (= o6 (slow_lcs_length o9 o8)) (slow_lcs_length__function_guard 
  o6 o9 o8))
  (and (in_range4 o6)
  (= o6 (ite (or
