...
(declare-fun temp___2867 () (Array Int us_rep1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2867 (parent
                      (mk___rep2
                      (mk___split_fields2 f__split_fields f__split_fields1))
                      i))))
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2867 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2867 (parent
                      (mk___rep2
...
;; H
  ...
  (= temp___2867 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 root))
  (model____function_guard temp___2867
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root))
  (and (dynamic_invariant3 temp___2867 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2867 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2867 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2867 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2867 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2867 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2867 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2867 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2867 j1)))) true))
  (= j1 i))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o o1)) (select temp___2867 j)))
