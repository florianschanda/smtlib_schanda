...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__lde_cfg1_type__ntm bits_5)(rec__dw1000__register_types__lde_cfg1_type__pmult bits_3)))))
(define-fun us_split_fields_NTM__projection ((a us_split_fields)) bits_5 
  (rec__dw1000__register_types__lde_cfg1_type__ntm a))

(define-fun us_split_fields_PMULT__projection ((a us_split_fields)) bits_3 
  (rec__dw1000__register_types__lde_cfg1_type__pmult a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_81__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_81__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq7 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (to_rep3
                           (rec__dw1000__register_types__lde_cfg1_type__ntm
                           (us_split_fields1 a))) (to_rep3
                                                  (rec__dw1000__register_types__lde_cfg1_type__ntm
                                                  (us_split_fields1 b))))
                        (= (to_rep2
                           (rec__dw1000__register_types__lde_cfg1_type__pmult
...
(declare-fun dw1000__register_types__lde_cfg1_type__ntm__first__bit () Int)

(declare-fun dw1000__register_types__lde_cfg1_type__ntm__last__bit () Int)

(declare-fun dw1000__register_types__lde_cfg1_type__ntm__position () Int)

;; dw1000__register_types__lde_cfg1_type__ntm__first__bit_axiom
  (assert (<= 0 dw1000__register_types__lde_cfg1_type__ntm__first__bit))

;; dw1000__register_types__lde_cfg1_type__ntm__last__bit_axiom
  (assert
  (< dw1000__register_types__lde_cfg1_type__ntm__first__bit dw1000__register_types__lde_cfg1_type__ntm__last__bit))

;; dw1000__register_types__lde_cfg1_type__ntm__position_axiom
  (assert (<= 0 dw1000__register_types__lde_cfg1_type__ntm__position))

(declare-fun dw1000__register_types__lde_cfg1_type__pmult__first__bit () Int)

(declare-fun dw1000__register_types__lde_cfg1_type__pmult__last__bit () Int)

(declare-fun dw1000__register_types__lde_cfg1_type__pmult__position () Int)

;; dw1000__register_types__lde_cfg1_type__pmult__first__bit_axiom
  (assert (<= 0 dw1000__register_types__lde_cfg1_type__pmult__first__bit))

;; dw1000__register_types__lde_cfg1_type__pmult__last__bit_axiom
  (assert
  (< dw1000__register_types__lde_cfg1_type__pmult__first__bit dw1000__register_types__lde_cfg1_type__pmult__last__bit))

;; dw1000__register_types__lde_cfg1_type__pmult__position_axiom
  (assert (<= 0 dw1000__register_types__lde_cfg1_type__pmult__position))

(declare-fun dummy6 () us_rep)

(declare-datatypes ()
((lde_cfg1_type__ref (mk_lde_cfg1_type__ref (lde_cfg1_type__content us_rep)))))
(define-fun lde_cfg1_type__ref___projection ((a lde_cfg1_type__ref)) us_rep 
  (lde_cfg1_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_198__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_139__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_139__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6591 us_t1)
  (temp___is_init_6588 Bool) (temp___skip_constant_6589 Bool)
  (temp___do_toplevel_6590 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6589 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_6591)
                                       (last4 temp___expr_6591))
                                       (and (= (first3 temp___expr_6591) 1)
                                       (= (last4 temp___expr_6591) 1)))))
...
(define-fun target__ref_60__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_60__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_6608 us_t2)
  (temp___is_init_6605 Bool) (temp___skip_constant_6606 Bool)
  (temp___do_toplevel_6607 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6606 true))
                                       (and (dynamic_property3 1 1
                                       (first5 temp___expr_6608)
                                       (last6 temp___expr_6608))
                                       (and (= (first5 temp___expr_6608) 1)
                                       (= (last6 temp___expr_6608) 1)))))
...
(declare-fun temp___8000 () (Array Int bits_8))

(declare-fun temp___80001 () t2)

(declare-fun temp___8001 () (Array Int bits_8))

(declare-fun temp___80011 () t1)

(define-fun temp___80002 () us_t2 (mk___t2 temp___8000 temp___80001))
...
;; H
  (assert
  (and
  (and (= temp___80002 (register_to_bytes reg))
  (register_to_bytes__function_guard temp___80002 reg)) (dynamic_invariant1
  temp___80002 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80001)) (to_rep (last5 temp___80001)))
     (+ (- (to_rep (last5 temp___80001)) (to_rep (first4 temp___80001))) 1)
     0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))

;; H
  (assert (= temp___8000 temp___8001))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80001)) (to_rep (last5 temp___80001))) 
  temp___80011))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___80011)) (to_rep (last3 temp___80011)))
     (+ (- (to_rep (last3 temp___80011)) (to_rep (first2 temp___80011))) 1)
