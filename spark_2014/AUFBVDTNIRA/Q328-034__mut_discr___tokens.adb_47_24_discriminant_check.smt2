...
(declare-fun temp___251 () us_rep1)
...
;; H
  (assert (= temp___251 (mk___rep1 o38 o37 true)))
...
;; WP_parameter_def
 ;; File "tokens.ads", line 14, characters 0-0
  (not
  (= (rec__tokens__token__kind (us_split_discrs1 temp___251)) (rec__tokens__token__kind
                                                              v__split_discrs))))
(check-sat)
