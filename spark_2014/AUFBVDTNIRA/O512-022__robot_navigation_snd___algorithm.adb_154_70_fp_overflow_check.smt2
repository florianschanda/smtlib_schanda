...
(declare-fun dist (us_rep1 us_rep1) t)

(declare-fun dist__function_guard (t us_rep1 us_rep1) Bool)
...
(define-fun bool_eq13 ((x t) (y t)) Bool (ite (eq x y) true false))
...
(define-fun dynamic_invariant10 ((temp___expr_149 t)
...
(define-fun dynamic_invariant11 ((temp___expr_155 t)
...
(define-fun dynamic_invariant12 ((temp___expr_167 t)
...
(define-fun dynamic_invariant13 ((temp___expr_179 t)
  (temp___is_init_176 Bool) (temp___skip_constant_177 Bool)
  (temp___do_toplevel_178 Bool)) Bool (=>
                                      (or (= temp___is_init_176 true) (le
                                      fliteral2 fliteral3)) (in_range7
                                      temp___expr_179)))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral6) (/ 9999999776482582092285156250.0 1000000000000000000000000000000.0))))
...
(declare-fun algorithm__isrisinggapsafe__B_4__B_6__deltaangle__assume () t)
...
;; H
  ...
  (and (tqtisFinite o) (and (lt (neg fliteral4) o) (le o fliteral4)))))

;; H
  (assert
  (= o1 (mul RNE2
        (of_int RNE2
        (to_rep9 (rec__gaps__gap__idir (us_split_fields9 risinggap)))) 
        o)))
...
;; H
  (assert (lt fliteral2 deltaangle))

;; H
  (assert (lt deltaangle fliteral5))
...
;; WP_parameter_def
 ;; File "algorithm.ads", line 76, characters 0-0
  ...
  (rec__robot_iface__proxy__max_range
  (us_split_fields7
  (rec__algorithm__controller__robot (us_split_fields15 this))))) fliteral6))))
(check-sat)
