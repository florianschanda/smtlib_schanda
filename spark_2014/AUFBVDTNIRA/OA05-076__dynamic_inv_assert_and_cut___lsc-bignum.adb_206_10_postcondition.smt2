...
(declare-fun mult1 () (_ BitVec 64))

(declare-fun mult2 () (_ BitVec 64))

(declare-fun temp () (_ BitVec 64))

(declare-fun result () (_ BitVec 64))

(declare-fun mult11 () (_ BitVec 64))

(declare-fun result1 () (_ BitVec 64))

(declare-fun mult21 () (_ BitVec 64))

(declare-fun result2 () (_ BitVec 64))

(declare-fun temp1 () (_ BitVec 64))
...
(declare-fun mult12 () (_ BitVec 64))

(declare-fun mult22 () (_ BitVec 64))

(declare-fun temp3 () (_ BitVec 64))
...
(declare-fun mult13 () (_ BitVec 64))

(declare-fun mult23 () (_ BitVec 64))

(declare-fun temp4 () (_ BitVec 64))
...
;; H
  (assert (from_word32__function_guard (from_word32 a) a))

;; H
  (assert (from_word32__function_guard (from_word32 v) v))

;; H
  (assert (from_word32__function_guard (from_word32 w) w))
...
;; H
  ...
  (omultiply (from_word32 v) (from_word32 w)) (from_word32 v)
  (from_word32 w)))
...
;; H
  ...
  (oadd (from_word32 a) (omultiply (from_word32 v) (from_word32 w)))
  (from_word32 a) (omultiply (from_word32 v) (from_word32 w))))
...
;; H
  (assert (omultiply__function_guard
  (omultiply (from_word32 x) (from_word32 y)) (from_word32 x)
  (from_word32 y)))
...
;; H
  ...
  (omultiply (from_word32 x) (from_word32 y)))
  (oadd (from_word32 a) (omultiply (from_word32 v) (from_word32 w)))
  (omultiply (from_word32 x) (from_word32 y))))
...
;; H
  (assert (from_word32__function_guard (from_word32 a2) a2))
...
;; H
  ...
  (omultiply (base Tuple0)
  (oadd (from_word32 carry12)
  (omultiply (base Tuple0) (from_word32 carry22))))) (from_word32 a2)
  (omultiply (base Tuple0)
  (oadd (from_word32 carry12)
  (omultiply (base Tuple0) (from_word32 carry22))))))
