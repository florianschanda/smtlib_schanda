...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral2) (/ 99999997473787516355514526367187500.0 10000000000000000000000000000000000000000.0))))

;; olt__def_axiom
  (assert
  (forall ((left t) (right t))
  (! (=> (olt__function_guard (olt left right) left right)
     (= (= (olt left right) true) (lt left (add RNE2 right fliteral2)))) :pattern (
  (olt left right)) )))
...
;; cos__post_axiom
  ...
  (! (=> (dynamic_invariant x true true true)
     ...
     (and
     (=> (and (le (neg fliteral3) x) (le x fliteral3)) (le fliteral4 result))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral5) (/ 1799999847412109375.0 10000000000000000.0))))

(declare-fun fliteral6 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral6) (= (tqtreal fliteral6) 180.0)))

(define-fun in_range2 ((x t)) Bool (and (tqtisFinite x)
                                   (and (le (neg fliteral5) x) (le x
                                   fliteral6))))
...
(define-fun dynamic_invariant2 ((temp___expr_147 t) (temp___is_init_144 Bool)
  ...
  (temp___do_toplevel_146 Bool)) Bool (=>
                                      ...
                                      (neg fliteral3) fliteral3)) (in_range1
                                      temp___expr_147)))
...
(define-fun dynamic_invariant3 ((temp___expr_153 t) (temp___is_init_150 Bool)
  ...
  (temp___do_toplevel_152 Bool)) Bool (=>
                                      ...
                                      (neg fliteral5) fliteral6)) (in_range2
                                      temp___expr_153)))

(declare-fun fliteral7 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral7) (= (tqtreal fliteral7) (/ 0.0 10.0))))
...
;; sin__post_axiom
  ...
  (! (=> (dynamic_invariant1 x true true true)
     ...
     (=> (eq x fliteral7) (eq result fliteral7))) (dynamic_invariant1 result
...
;; fliteral_axiom
  (assert
  (and (tqtisFinite fliteral8) (= (tqtreal fliteral8) (/ 63674445.0 10.0))))
