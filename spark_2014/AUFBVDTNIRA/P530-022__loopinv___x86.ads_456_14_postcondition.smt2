...
(declare-fun x86__r8l__result () (_ BitVec 8))

(declare-fun result () (_ BitVec 8))

(declare-fun x86__r8l__result1 () (_ BitVec 8))

(declare-fun x86__r8l__result2 () (_ BitVec 8))

(declare-fun x86__r8l__result3 () (_ BitVec 8))

(declare-fun x86__r8l__result4 () (_ BitVec 8))

(declare-fun x86__r8l__result5 () (_ BitVec 8))
...
;; H
  (assert (= result x86__r8l__result))
...
;; H
  (assert (= result1 x86__r8l__result4))

;; H
  (assert (readreglow8__function_guard (readreglow8 r8) r8))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not (= x86__r8l__result4 (readreglow8 r8))))
(check-sat)
