...
(declare-fun temp___308 () Bool)

(declare-fun temp___307 () (_ BitVec 64))
...
(declare-fun retval5 () (_ BitVec 64))

(declare-fun flag4 () Bool)

(declare-fun i4 () Int)

(declare-fun retval6 () (_ BitVec 64))

(declare-fun flag5 () Bool)

(declare-fun i5 () Int)

(declare-fun retval7 () (_ BitVec 64))

(declare-fun flag6 () Bool)

(declare-fun i6 () Int)

(declare-fun retval8 () (_ BitVec 64))
...
(declare-fun bitwalker__peek__result3 () (_ BitVec 64))

(declare-fun retval9 () (_ BitVec 64))

(declare-fun flag8 () bool__ref)

(declare-fun i8 () int__ref)

(declare-fun bitwalker__peek__result4 () t__ref)

(declare-fun retval10 () (_ BitVec 64))

(declare-fun flag9 () Bool)

(declare-fun i9 () Int)

(declare-fun bitwalker__peek__result5 () (_ BitVec 64))

(declare-fun retval11 () t__ref)

(declare-fun flag10 () bool__ref)

(declare-fun i10 () int__ref)

(declare-fun bitwalker__peek__result6 () t__ref)

(declare-fun retval12 () (_ BitVec 64))

(declare-fun flag11 () Bool)

(declare-fun i11 () Int)

(declare-fun bitwalker__peek__result7 () (_ BitVec 64))

(declare-fun retval13 () t__ref)

(declare-fun flag12 () bool__ref)

(declare-fun i12 () int__ref)

(declare-fun bitwalker__peek__result8 () t__ref)

(declare-fun retval14 () (_ BitVec 64))

(declare-fun flag13 () Bool)

(declare-fun i13 () Int)

(declare-fun bitwalker__peek__result9 () (_ BitVec 64))
...
;; H
  ...
  (and
  (and
  (and (= bitwalker__peek__result6 (mk_t__ref bitwalker__peek__result2))
  (and (= i10 i15) (and (= flag10 flag15) (= retval11 retval17))))
  (and (= bitwalker__peek__result7 bitwalker__peek__result2)
  (and (= i11 i1) (and (= flag11 flag1) (= retval12 retval1)))))
  (and
  (and
  (and
  (and (and (= o (length addr)) (in_range1 (length addr))) (= o1 (* 8 o)))
  (and (= o2 o1) (in_range1 o1)))
  (and (and (= o3 (+ start length1)) (in_range1 (+ start length1)))
  (= result (ite (< o2 o3) true false))))
  (and (= result true)
  (and (= result1 bitwalker__peek__result)
  (= bitwalker__peek__result2 ((_ int2bv 64) 0))))))
  (and
  (and
  (and
  (and
  ...
  (= result (ite (< o2 o3) true false))))
  (and (not (= result true))
  (and (= bitwalker__peek__result2 bitwalker__peek__result)
  (= bitwalker__peek__result2 bitwalker__peek__result1))))
  (and
  (and
  (and (= bitwalker__peek__result6 bitwalker__peek__result4)
  (and (= i10 i8) (and (= flag10 flag8) (= retval11 retval15))))
  (and (= bitwalker__peek__result7 bitwalker__peek__result5)
  (and (= i11 i9) (and (= flag11 flag9) (= retval12 retval10)))))
  (and
  (and
  (and (= bitwalker__peek__result4 (mk_t__ref bitwalker__peek__result3))
  (and (= i8 i14) (and (= flag8 flag14) (= retval15 retval16))))
  (and (= bitwalker__peek__result5 bitwalker__peek__result3)
  (and (= i9 i7) (and (= flag9 flag7) (= retval10 retval8)))))
  (and (and (= (mk_t__ref result2) retval17) (= retval2 ((_ int2bv 64) 0)))
  (and
  (and (and (= (mk_int__ref result3) i15) (= i2 0))
  (ite (and (<= 0 i2) (<= i2 (- length1 1)))
  (and
  (and
  (and (= temp___309 i2)
  (and (= temp___308 flag)
  (and (= temp___307 retval2)
  (and
  (and
  (forall ((j Int))
  (=> (and (<= (- length1 i3) j) (<= j (- length1 1)))
  (= (= (nth8_stream addr (- (- (+ start length1) j) 1)) true)
  (= (nth retval3 j) true))))
  (forall ((j Int))
  (=> (and (<= length1 j) (<= j 63)) (not (= (nth retval3 j) true)))))
  (and
  (and (=> (<= 0 (- length1 1)) (dynamic_property1 0 (- length1 1) i3))
  (and (<= 0 i3) (<= i3 (- length1 1))))
  (and
  (and
  (and (and (= o4 (+ start i3)) (in_range1 (+ start i3)))
  (and
  ...
  (and (= flag2 result4) (= flag3 o5)))
  (and
  (and
  (and
  (and (and (= o6 (+ (- 64 length1) i3)) (in_range1 (+ (- 64 length1) i3)))
  (and (= o7 o6) (in_range2 o6)))
  (and
  (and (= o8 (pokebit64 retval3 o7 flag3)) (pokebit64__function_guard 
  o8 retval3 o7 flag3))
  (and
  (forall ((i16 Int))
  (=> (and (<= 0 i16) (<= i16 63))
  (=> (not (= i16 (- 63 o7)))
  (= (= (nth o8 i16) true) (= (nth retval3 i16) true)))))
  (= (= flag3 true) (= (nth o8 (- 63 o7)) true)))))
  (and (= retval3 result5) (= retval4 o8))) (= i3 (- length1 1)))))))))
  (and (and (= i3 i4) (and (= flag3 flag4) (= retval4 retval5)))
  (and (= i5 i3) (and (= flag5 flag3) (= retval6 retval4)))))
  (and
  (and (= i14 (mk_int__ref i4))
  (and (= flag14 (mk_bool__ref flag4)) (= retval16 (mk_t__ref retval5))))
  (and (= i7 i5) (and (= flag7 flag5) (= retval8 retval6)))))
  (and (and (= i2 i6) (and (= flag14 flag15) (= retval2 retval7)))
  (and (= i7 i2) (and (= flag7 flag1) (= retval8 retval2))))))
  (and (= result6 bitwalker__peek__result2)
  (= bitwalker__peek__result3 retval7)))))))))
...
;; H
  (assert
  (=> (= (> (+ start length1) (* 8 (length addr))) true)
  (= (t__content bitwalker__peek__result8) ((_ int2bv 64) 0))))
...
;; H
  (assert (<= i16 (- length1 1)))

;; H
  (assert (nth8_stream__function_guard
  (nth8_stream addr (- (- (+ start length1) i16) 1)) addr
  (- (- (+ start length1) i16) 1)))

;; H
  (assert (= (nth8_stream addr (- (- (+ start length1) i16) 1)) true))

(assert
;; WP_parameter_def
 ;; File "interfac.ads", line 77, characters 0-0
  (not (= (nth (t__content bitwalker__peek__result8) i16) true)))
(check-sat)
