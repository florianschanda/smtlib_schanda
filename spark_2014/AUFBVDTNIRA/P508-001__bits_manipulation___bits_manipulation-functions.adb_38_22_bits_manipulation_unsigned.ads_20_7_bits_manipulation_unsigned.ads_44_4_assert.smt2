...
(define-fun dynamic_invariant1 ((temp___expr_605 (_ BitVec 32))
...
(define-fun dynamic_invariant3 ((temp___expr_617 Int)
  ...
  (temp___do_toplevel_616 Bool)) Bool (=>
                                      ...
                                      (<= 1 32)) (in_range2 temp___expr_617)))
...
(declare-fun bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__len__assume () Int)

(declare-fun o () Int)

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__mask__assume () (_ BitVec 32))
...
;; H
  (assert
  (and
  (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__len__assume (+ (- 
...
;; H
  ...
  (shift_right ((_ int2bv 32) 4294967295) (- 32 o))
  ((_ int2bv 32) 4294967295) (- 32 o)))
