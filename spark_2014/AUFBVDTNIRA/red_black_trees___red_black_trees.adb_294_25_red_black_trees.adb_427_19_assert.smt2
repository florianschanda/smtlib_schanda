...
;; H
  (assert (model____function_guard
  (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c80b)))
  (rec__red_black_trees__rbt__struct (us_split_fields9 c80b))))

;; H
  (assert (nb_blacks__function_guard (nb_blacks c80b) c80b))

;; H
  (assert (nb_blacks__function_guard (nb_blacks c81b) c81b))
...
;; H
  ...
  (eq (select (nb_blacks c81b) i) (select (nb_blacks c80b) i))
  (select (nb_blacks c81b) i) (select (nb_blacks c80b) i))))
...
;; H
  ...
  (eq (select (nb_blacks c81b) y) (select (nb_blacks c80b) y))
  (select (nb_blacks c81b) y) (select (nb_blacks c80b) y)))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
             (rec__red_black_trees__rbt__struct (us_split_fields9 c80b))) i))) true)
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c80b) i)))) n6))
  (not (= i y)))
  (= (eq (select (nb_blacks c81b) i) (select (nb_blacks c80b) i)) true)))))
...
;; H
  ...
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c80b) c82b)))) n6)
...
;; H
  (assert (eq__function_guard
  (eq (select (nb_blacks c81b) c82b) (select (nb_blacks c80b) c82b))
  (select (nb_blacks c81b) c82b) (select (nb_blacks c80b) c82b)))

(assert
;; WP_parameter_def
 ;; File "red_black_trees.ads", line 59, characters 0-0
  (not
  (= (eq (select (nb_blacks c81b) c82b) (select (nb_blacks c80b) c82b)) true)))
(check-sat)
