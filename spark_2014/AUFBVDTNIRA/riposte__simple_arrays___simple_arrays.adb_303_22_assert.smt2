...
(declare-fun temp___532 ((Array Int integer) Int Int) (Array Int integer))

;; def_axiom
  (assert
  (forall ((temp___534 (Array Int integer)))
  (forall ((temp___535 Int) (temp___536 Int))
  (let ((temp___533 (temp___532 temp___534 temp___535 temp___536)))
  (forall ((temp___537 Int))
  (ite (= temp___537 temp___535)
  (= (select temp___533 temp___537) (of_rep temp___536))
  (= (select temp___533 temp___537) (select temp___534 temp___537))))))))

(declare-fun temp___539 ((Array Int integer) Int Int) (Array Int integer))

;; def_axiom
  (assert
  (forall ((temp___541 (Array Int integer)))
  (forall ((temp___542 Int) (temp___543 Int))
  (let ((temp___540 (temp___539 temp___541 temp___542 temp___543)))
  (forall ((temp___544 Int))
  (ite (= temp___544 temp___542)
  (= (select temp___540 temp___544) (of_rep temp___543))
  (= (select temp___540 temp___544) (select temp___541 temp___544))))))))
...
;; H
  (assert
  (= (bool_eq1 d (- 2147483648) 2147483647 (temp___532 c i 42) (- 2147483648)
     2147483647) true))
...
;; H
  (assert
  (= (bool_eq1 g (- 2147483648) 2147483647 (temp___539 f i 42) (- 2147483648)
     2147483647) true))
