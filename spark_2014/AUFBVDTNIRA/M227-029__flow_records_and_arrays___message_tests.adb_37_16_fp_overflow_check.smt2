...
;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite w)))

(assert
;; WP_parameter_def
 ;; File "message_tests.adb", line 23, characters 0-0
  (not (tqtisFinite
  (add RNE2 (to_rep (rec__message_tests__coordinate__x (us_split_fields3 c)))
  (to_rep (rec__message_tests__coordinate__y (us_split_fields3 c)))))))
(check-sat)
