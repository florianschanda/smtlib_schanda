...
;; H
  (assert
  (=> (= (length temp___818) 0)
  (= o14 (mk___t (temp___String_Literal_817 Tuple0) (mk 1 1)))))

;; H
  (assert
  (=> (not (= (length temp___818) 0)) (=> (<= 1 1) (= o8 (+ (- 1 1) 1)))))

;; H
  (assert (=> (not (= (length temp___818) 0)) (=> (not (<= 1 1)) (= o8 0))))

;; H
  (assert
  (=> (not (= (length temp___818) 0))
...
;; H
  (assert (=> (not (= (length temp___818) 0)) (= o10 (+ o9 o8))))

;; H
  (assert
  (=> (not (= (length temp___818) 0))
  (= o11 (+ (to_rep1 (first (rt temp___818))) o10))))

;; H
  (assert (=> (not (= (length temp___818) 0)) (= o12 (- o11 1))))

;; H
  (assert
  (=> (not (= (length temp___818) 0)) (and (= o13 o12) (in_range2 o12))))
...
;; H
  ...
  (= o14 (mk___t
         ...
         1 1) (mk (to_rep1 (first (rt temp___818))) o13)))))
