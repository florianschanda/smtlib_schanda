...
(declare-fun r__split_fields () us_private)

(declare-fun rc__split_fields () us_private)
...
;; H
  (assert (= us_null_ext__ r__split_fields1))

;; H
  (assert (= r__attr__tag us_tag))

;; H
  (assert (= result1 rc__split_fields))

;; H
  (assert
  (= (mk___split_fields rc__split_fields1) (mk___split_fields
                                           r__split_fields1)))
...
(assert
;; WP_parameter_def
 ;; File "tagged_conv.adb", line 35, characters 0-0
  (not (us_compatible_tags rc__attr__tag us_tag1)))
(check-sat)
