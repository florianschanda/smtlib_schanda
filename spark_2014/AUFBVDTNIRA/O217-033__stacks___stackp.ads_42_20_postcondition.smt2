...
;; def_axiom
  ...
  (= (select (temp___293 temp___295) 1) (of_rep1 temp___295))))
...
(declare-fun temp___622 () (Array Int element))

(declare-fun temp___6221 () less_than_max)

(declare-fun temp___6222 () us_private)

(declare-fun temp___6223 () Int)
...
(declare-fun temp___626 () (Array Int element))

(declare-fun temp___6261 () less_than_max)

(declare-fun temp___6262 () us_private)

(declare-fun temp___6263 () Int)
...
;; H
  (assert (= temp___622 o2))

;; H
  (assert (= temp___6221 o3))

;; H
  (assert (= temp___6222 o4))

;; H
  (assert (= s__attr__tag temp___6223))
...
;; H
  (assert (= temp___622 s__split_fields3))

;; H
  (assert (= temp___6221 s__split_fields4))

;; H
  (assert (= temp___6222 s__split_fields5))
...
;; H
  (assert (= temp___626 o8))

;; H
  (assert (= temp___6261 o9))

;; H
  (assert (= temp___6262 o10))

;; H
  (assert (= s__attr__tag temp___6263))
...
;; H
  (assert (= temp___626 s__split_fields6))

;; H
  (assert (= temp___6261 s__split_fields7))

;; H
  (assert (= temp___6262 s__split_fields8))
...
;; WP_parameter_def
 ;; File "stackp.ads", line 22, characters 0-0
  (not
  (= (let ((temp___634 (get_model__2
                       (mk___rep
                       (mk___split_fields s__split_fields9 s__split_fields10
                       s__split_fields11) s__attr__tag))))
     (bool_eq3 (elts temp___634) (to_rep2 (first (rt temp___634)))
     (to_rep2 (last (rt temp___634)))
     (let ((temp___633 (temp___293 e)))
     (let ((temp___632 (get_model__2
                       (mk___rep
                       (mk___split_fields s__split_fields s__split_fields1
                       s__split_fields2) s__attr__tag))))
     (ite (= (length temp___632) 0) temp___633
     (concat1 (elts temp___632) (to_rep2 (first (rt temp___632)))
     (to_rep2 (last (rt temp___632))) temp___633 1 1))))
     (to_rep2
     (first
     (let ((temp___632 (get_model__2
                       (mk___rep
                       (mk___split_fields s__split_fields s__split_fields1
                       s__split_fields2) s__attr__tag))))
     (ite (= (length temp___632) 0) (mk 1 1)
     (mk (to_rep2 (first (rt temp___632)))
     (- (+ (to_rep2 (first (rt temp___632))) (+ (ite (<= (to_rep2
                                                         (first
                                                         (rt temp___632))) 
                                                (to_rep2
                                                (last (rt temp___632))))
