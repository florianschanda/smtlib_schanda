...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral1) (= (tqtreal fliteral1) 0.0)))
...
(declare-fun user_eq (rt rt) Bool)
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral3) (/ 99959997558593750.0 100000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral4) (/ 4000000059604644775390625.0 10000000000000000000000000.0))))
...
;; WP_parameter_def
 ;; File "test_float.adb", line 3, characters 0-0
  (not (in_range1 (add RNE2 x fliteral4))))
(check-sat)
