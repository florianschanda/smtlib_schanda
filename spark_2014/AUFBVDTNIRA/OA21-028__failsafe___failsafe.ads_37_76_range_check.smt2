...
;; H
  ...
  (=>
  (forall ((s17 (_ BitVec 8)))
  (=> (and (bvule ((_ int2bv 8) 0) s17) (bvule s17 ((_ int2bv 8) 49))) (lt
  (to_rep (select battery_level_at s17)) fliteral2)))
...
;; H
  (assert
  (not
  (ite (= (bool_ge (to_rep (select battery_level_at current_time)) fliteral2) false) 
  (forall ((s17 (_ BitVec 8)))
  (=> (and (bvule ((_ int2bv 8) 0) s17) (bvule s17 ((_ int2bv 8) 49))) (lt
  (to_rep (select battery_level_at s17)) fliteral2))) false)))

;; H
  (assert
  (not
  (ite (= (bool_ge (to_rep (select battery_level_at current_time)) fliteral2) false) false true)))
