...
(declare-fun o33 () (Array Int byte))
...
(declare-fun o34 () (Array Int byte))
...
;; H
  ...
  (=> (< 0 (int__content remaining_bits7))
  (and
  (= o31 (+ (int__content offset7) (- (int__content remaining_bytes7) 1)))
  (in_range1
...
;; H
  (assert
  (=> (< 0 (int__content remaining_bits7))
  (= o32 (+ (to_rep1 (first (rt data))) o31))))

;; H
  (assert
  (=> (< 0 (int__content remaining_bits7))
  (and (= keccak__keccak_1600__sponge__absorb__R99s__assume o32) (in_range1
  o32))))
...
;; H
  (assert (=> (< 0 (int__content remaining_bits7)) (= o33 (elts data))))

;; H
  (assert
  (=> (< 0 (int__content remaining_bits7))
  (= temp___902 (mk___t8 o33 (mk8 r98s r99s)))))
...
;; H
  ...
  (= (select o34 temp___909) (select (elts7 temp___908) temp___909))
  (= (select o34 temp___909) (select (rec__keccak__keccak_1600__sponge__context__block
                                     (us_split_fields__content
                                     ctx__split_fields15)) temp___909))))))

;; H
  (assert
  (=> (< 0 (int__content remaining_bits7))
  (= o35 (mk___split_fields
         (rec__keccak__keccak_1600__sponge__context__state
         (us_split_fields__content ctx__split_fields15)) o34
         (rec__keccak__keccak_1600__sponge__context__bits_absorbed
...
;; H
  (assert
  (=> (< 0 (int__content remaining_bits7)) (= temp___911 (mk___rep o35))))
...
;; H
  (assert
  (=> (< 0 (int__content remaining_bits7))
  (= ctx__split_fields17 (us_split_fields1 temp___911))))
...
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not (= (mod2 (int__content remaining_bits7) 8) (mod2 bit_length 8))))
(check-sat)
