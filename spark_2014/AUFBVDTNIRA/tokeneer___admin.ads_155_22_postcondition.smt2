...
;; isdoingop__def_axiom
  ...
  (! (=> (isdoingop__function_guard (isdoingop theadmin) theadmin)
     (= (= (isdoingop theadmin) true) (in_range4
...
(declare-fun o () privileget)

(declare-fun o1 () privileget)

(declare-fun o2 () opandnullt)

(declare-fun temp___406 () privileget)

(declare-fun temp___4061 () opandnullt)

(declare-fun o3 () opandnullt)

(declare-fun o4 () privileget)

(declare-fun o5 () opandnullt)

(declare-fun temp___408 () privileget)

(declare-fun temp___4081 () opandnullt)
...
(declare-fun result2 () privileget)

(declare-fun result3 () opandnullt)
...
;; H
  (assert (= temp___406 theadmin__split_fields2))

;; H
  (assert (= temp___4061 theadmin__split_fields3))
...
;; H
  (assert (= temp___408 o4))

;; H
  (assert (= temp___4081 o5))
...
;; H
  (assert (= temp___408 theadmin__split_fields4))

;; H
  (assert (= temp___4081 theadmin__split_fields5))
