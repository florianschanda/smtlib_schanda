...
(declare-fun exponentiate ((_ BitVec 32) Int) (_ BitVec 32))

(declare-fun exponentiate__function_guard ((_ BitVec 32) (_ BitVec 32)
  Int) Bool)
...
(declare-fun val__1 () (_ BitVec 32))

(declare-fun result1 () Int)

(declare-fun exp1 () Int)

(declare-fun exp2 () Int)
...
;; WP_parameter_def
 ;; File "test_exponentiate.adb", line 4, characters 0-0
  (not (= (exponentiate val__1 exp2) (power val__1 exp2))))
(check-sat)
