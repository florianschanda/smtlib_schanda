...
(declare-fun temp___751 () (Array Int us_rep1))
...
(declare-fun temp___749 () (Array Int us_rep1))
...
;; H
  ...
  (= temp___751 (model__
                (mk___rep2 (us_split_fields__content2 f__split_fields7)) 
                o45))
  (and (dynamic_invariant3 temp___751 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___751 o45))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___751 o45)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o45))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___751 (parent
                             (mk___rep2
                             (us_split_fields__content2 f__split_fields7))
                             i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___751 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___751 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___751 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (=>
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___751 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___751 i2)))
     (rec__tree_model__path_type__a (us_split_fields1 (select temp___751 j)))) true))
  (= j i2)))))))))))))))

;; H
  (assert (=> (not (= (int__content v2) 0)) (= o46 (select temp___751 i1))))
...
;; H
  ...
  (= temp___749 (model__
                (mk___rep2 (us_split_fields__content2 f__split_fields7)) 
                o53))
  (and (dynamic_invariant3 temp___749 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___749 o53))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___749 o53)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o53))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___749 (parent
                             (mk___rep2
                             (us_split_fields__content2 f__split_fields7))
                             i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___749 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___749 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___749 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (=>
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___749 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___749 i2)))
     (rec__tree_model__path_type__a (us_split_fields1 (select temp___749 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o54 (select temp___749 i1)))
