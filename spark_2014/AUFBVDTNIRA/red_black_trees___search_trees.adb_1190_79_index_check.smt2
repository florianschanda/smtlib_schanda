...
(declare-fun temp___1268 () (Array Int us_rep1))
...
(declare-fun temp___1267 () (Array Int us_rep1))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1268 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i1))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1268 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1268 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (model____function_guard temp___1268
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o))
  (and (dynamic_invariant9 temp___1268 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1268 o))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1268 o)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1268 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1268 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1268 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1268 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1268 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1268 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___1268 i)))
...
;; H
  ...
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1267 (parent
                      (rec__search_trees__search_tree__struct
                      (us_split_fields7 t)) i1))))
  (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___1267 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___1267 (parent
                      (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= temp___1267 (model__
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7 t)) o5))
  (model____function_guard temp___1267
  (rec__search_trees__search_tree__struct (us_split_fields7 t)) o5))
  (and (dynamic_invariant9 temp___1267 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1267 o5))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1267 o5)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o5))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___1267 (parent
                              ...
                              (us_split_fields7 t)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1267 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1267 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1267 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1267 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1267 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1267 j)))) true))
  (= j i1))))))))))))))
