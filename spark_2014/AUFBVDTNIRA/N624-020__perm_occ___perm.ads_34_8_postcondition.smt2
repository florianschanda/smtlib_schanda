...
;; H
  ...
  (occ (mk___t b1 (mk (to_rep1 b__first) (to_rep1 b__last))) e)
  (mk___t b1 (mk (to_rep1 b__first) (to_rep1 b__last))) e))

;; H
  (assert (occ__function_guard (occ o11 e) o11 e))

;; H
  (assert (occ__function_guard (occ o10 e) o10 e))

;; H
  (assert (occ__function_guard
  (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e)
  (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e))
...
;; H
  (assert (occ__function_guard (occ o9 e) o9 e))
...
;; H
  ...
  (and
  (and
  (and (and (= o11 (remove_last r)) (remove_last__function_guard o11 r))
  (and (dynamic_invariant2 o11 true false true)
  (and (= (elts r) o)
  (= (mk
     (to_rep1
     (first3 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1))))
     (to_rep1
     (last3 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1))))) 
  o1))))
  ...
  (and
  (and
  (and (and (= o10 (remove_last r)) (remove_last__function_guard o10 r))
  ...
  (= (occ o10 e) (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last)))
                 e)))
  (and
  (and (and (= o9 (remove_last a)) (remove_last__function_guard o9 a))
