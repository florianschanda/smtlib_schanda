...
(declare-fun records__init_a__result () unsigned_byte)

(declare-fun records__init_a__result1 () unsigned_byte)
...
(declare-fun records__init_a__result2 () unsigned_byte)

(declare-fun records__init_a__result3 () unsigned_byte)

(declare-fun records__init_a__result4 () unsigned_byte)

(declare-fun records__init_a__result5 () unsigned_byte)

(declare-fun records__init_a__result6 () unsigned_byte)

(declare-fun records__init_a__result7 () unsigned_byte)

(declare-fun r__split_fields4 () us_split_fields__ref)

(declare-fun records__init_a__result8 () pair__ref)

(declare-fun r__split_fields5 () us_split_fields)

(declare-fun records__init_a__result9 () us_rep)

(define-fun records__init_a__result10 () us_rep (mk___rep
                                                (mk___split_fields
                                                records__init_a__result6
                                                records__init_a__result7)))
...
;; H
  (assert (= records__init_a__result5 records__init_a__result3))

;; H
  (assert
  (= records__init_a__result10 (mk___rep
                               (mk___split_fields records__init_a__result2
                               records__init_a__result3))))

;; H
  (assert (= result2 records__init_a__result))

;; H
  (assert (= result3 records__init_a__result1))

;; H
  (assert (= records__init_a__result2 r__split_fields2))

;; H
  (assert (= records__init_a__result3 r__split_fields3))

;; H
  (assert
  (= records__init_a__result8 (mk_pair__ref
                              (mk___rep
                              (mk___split_fields records__init_a__result4
                              records__init_a__result5)))))

;; H
  (assert (= r__split_fields4 (mk___split_fields__ref r__split_fields6)))

;; H
  (assert (= records__init_a__result9 records__init_a__result10))

;; H
  (assert (= r__split_fields5 r__split_fields6))

;; H
  (assert
  (= (mk___rep (mk___split_fields result4 result5)) (pair__content
                                                    records__init_a__result8)))

(assert
;; WP_parameter_def
 ;; File "records_prooffuncs.ads", line 11, characters 0-0
  (not
  (= (bool_eq1 (pair__content records__init_a__result8)
     (mk___rep (mk___split_fields (of_rep 0) (of_rep 0)))) true)))
(check-sat)
