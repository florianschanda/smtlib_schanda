...
;; H
  (assert (= temp___833 (to_string o81)))
...
;; H
  (assert
  (= temp___829 (mk___t
                (concat1 (temp___String_Literal_825 Tuple0) 1 1
...
;; H
  (assert
  (=> (= (length temp___829) 0)
  (= temp___832 (mk___t (temp___String_Literal_828 Tuple0) (mk 1 3)))))

;; H
  (assert
  (=> (not (= (length temp___829) 0)) (=> (<= 1 3) (= o88 (+ (- 3 1) 1)))))

;; H
  (assert (=> (not (= (length temp___829) 0)) (=> (not (<= 1 3)) (= o88 0))))

;; H
  (assert
  (=> (not (= (length temp___829) 0))
  (=> (<= (to_rep1 (first (rt temp___829))) (to_rep1 (last (rt temp___829))))
  (= o89 (+ (- (to_rep1 (last (rt temp___829))) (to_rep1
...
;; H
  (assert (=> (not (= (length temp___829) 0)) (= o90 (+ o89 o88))))

;; H
  (assert
  (=> (not (= (length temp___829) 0))
  (= o91 (+ (to_rep1 (first (rt temp___829))) o90))))

;; H
  (assert (=> (not (= (length temp___829) 0)) (= o92 (- o91 1))))

;; H
  (assert
  (=> (not (= (length temp___829) 0)) (and (= o93 o92) (in_range2 o92))))

;; H
  (assert
  (=> (not (= (length temp___829) 0))
  (= temp___832 (mk___t
                (concat1 (elts temp___829) (to_rep1 (first (rt temp___829)))
                (to_rep1 (last (rt temp___829)))
                (temp___String_Literal_828 Tuple0) 1 3)
                (mk (to_rep1 (first (rt temp___829))) o93)))))

;; H
  (assert (not (= (length temp___832) 0)))

;; H
  (assert
  (=> (<= (to_rep1 (first (rt temp___833))) (to_rep1 (last (rt temp___833))))
  (= o94 (+ (- (to_rep1 (last (rt temp___833))) (to_rep1
                                                (first (rt temp___833)))) 1))))
...
;; H
  (assert
  (=> (<= (to_rep1 (first (rt temp___832))) (to_rep1 (last (rt temp___832))))
  (= o95 (+ (- (to_rep1 (last (rt temp___832))) (to_rep1
                                                (first (rt temp___832)))) 1))))
...
;; H
  (assert (= o97 (+ (to_rep1 (first (rt temp___832))) o96)))
