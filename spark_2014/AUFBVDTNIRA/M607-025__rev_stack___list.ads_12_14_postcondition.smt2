...
(declare-fun result6 () capacity_range)

(declare-fun result7 () us_main_type)
...
;; H
  (assert (=> (and (<= first4 i2) (<= i2 last6)) (= temp___490 i2)))

;; H
  (assert
  (=> (and (<= first4 i2) (<= i2 last6))
  (= s__split_fields2 (mk___split_fields temp___489 temp___4891))))

;; H
  (assert
  (=> (and (<= first4 i2) (<= i2 last6)) (and (= o i2) (in_range5 i2))))
...
;; H
  ...
  (=> (and (<= first4 i2) (<= i2 last6))
  (and
  (= (to_rep (last (rt (to__ (mk___rep s__split_fields4))))) (+ (- i3 
  first4) 1))
  (forall ((j Int))
  (=> (and (<= first4 j) (<= j i3))
  (= (to_rep
...
;; H
  (assert
  (=> (and (<= first4 i2) (<= i2 last6))
  (and (=> (<= first4 last6) (dynamic_property3 first4 last6 i3))
  (and (<= first4 i3) (<= i3 last6)))))

;; H
  (assert (=> (and (<= first4 i2) (<= i2 last6)) (= i3 last6)))

;; H
  (assert (=> (and (<= first4 i2) (<= i2 last6)) (= i4 (mk_int__ref i3))))
...
;; H
  (assert (=> (and (<= first4 i2) (<= i2 last6)) (= i5 i3)))
...
;; H
  (assert (=> (and (<= first4 i2) (<= i2 last6)) (= i6 i4)))
...
;; H
  (assert (=> (and (<= first4 i2) (<= i2 last6)) (= i7 i5)))
...
;; H
  (assert
  (=> (not (and (<= first4 i2) (<= i2 last6))) (= i6 (mk_int__ref i2))))

;; H
  (assert
  (=> (not (and (<= first4 i2) (<= i2 last6)))
  (= s__split_fields7 (mk___split_fields__ref s__split_fields2))))

;; H
  (assert (=> (not (and (<= first4 i2) (<= i2 last6))) (= i7 i2)))
...
;; H
  (assert (=> (and (<= first4 i8) (<= i8 last6)) (= temp___503 i8)))

;; H
  (assert
  (=> (and (<= first4 i8) (<= i8 last6))
...
;; H
  ...
  (and
  (and
  (= (length2 (mk___rep1 res__split_discrs res__split_fields2)) (- i9 
  first4))
  (= (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) (+ (- last6 
  i9) 1)))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (+ (- last6 i9) 1)))
...
;; H
  (assert
  (=> (and (<= first4 i8) (<= i8 last6))
  (and (=> (<= first4 last6) (dynamic_property4 first4 last6 i9))
...
;; H
  (assert (=> (and (<= first4 i8) (<= i8 last6)) (= i9 last6)))

;; H
  (assert (=> (and (<= first4 i8) (<= i8 last6)) (= i10 (mk_int__ref i9))))
...
;; H
  (assert (=> (and (<= first4 i8) (<= i8 last6)) (= i11 i9)))
...
;; H
  (assert (=> (and (<= first4 i8) (<= i8 last6)) (= i12 i10)))
...
;; H
  (assert (=> (and (<= first4 i8) (<= i8 last6)) (= i13 i11)))
...
;; H
  (assert
  (=> (not (and (<= first4 i8) (<= i8 last6))) (= i12 (mk_int__ref i8))))

;; H
  (assert
  (=> (not (and (<= first4 i8) (<= i8 last6)))
...
;; H
  (assert (=> (not (and (<= first4 i8) (<= i8 last6))) (= i13 i8)))
...
;; H
  (assert
  (= (mk___rep1 (mk___split_discrs result6) (mk___split_fields1 result7)) 
  (list__content list__reverse_list__result5)))
...
;; H
  (assert (<= i22 (last5 (model__ l))))

(assert
;; WP_parameter_def
 ;; File "list.ads", line 9, characters 0-0
  (not
  (= (get (model__ l) i22) (get
                           (model__
                           (list__content list__reverse_list__result5))
                           (+ (- (last5 (model__ l)) i22) 1)))))
(check-sat)
