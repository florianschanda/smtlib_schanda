...
;; H
  (assert
  (=> (and (<= first4 i2) (<= i2 last5))
  (= s__split_fields2 (mk___split_fields temp___470 temp___4701))))

;; H
  (assert
  (=> (and (<= first4 i2) (<= i2 last5)) (and (= o i2) (in_range5 i2))))
...
;; H
  ...
  (= (let ((temp___188 (to__ (mk___rep s__split_fields3))))
     (bool_eq1 (elts temp___188) (to_rep (first (rt temp___188)))
...
;; H
  (assert
  (=> (and (<= first4 i2) (<= i2 last5))
  (and (=> (<= first4 last5) (dynamic_property3 first4 last5 i3))
...
;; H
  (assert
  (=> (not (and (<= first4 i2) (<= i2 last5))) (= i6 (mk_int__ref i2))))

;; H
  (assert
  (=> (not (and (<= first4 i2) (<= i2 last5)))
...
;; H
  (assert
  (=> (and (<= first4 i8) (<= i8 last5))
  (and (=> (<= first4 last5) (dynamic_property4 first4 last5 i9))
...
;; H
  ...
  (= (let ((temp___195 (to__ (mk___rep s__split_fields10))))
     (bool_eq1 (elts temp___195) (to_rep (first (rt temp___195)))
...
;; H
  (assert
  (=> (not (and (<= first4 i8) (<= i8 last5))) (= i12 (mk_int__ref i8))))

;; H
  (assert
  (=> (not (and (<= first4 i8) (<= i8 last5)))
