...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2391 o3))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2391 o3)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o3))
...
;; H
  (assert (= o4 (select temp___2391 i)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  ...
  (= (valid_root
     (mk___rep2
     (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o1) true)))
(check-sat)
