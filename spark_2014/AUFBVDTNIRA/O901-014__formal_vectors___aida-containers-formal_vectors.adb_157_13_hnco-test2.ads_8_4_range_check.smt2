...
(define-fun dynamic_invariant3 ((temp___expr_720 Int)
...
(define-fun dynamic_invariant5 ((temp___expr_732 Int)
...
;; reverse_find_index__post_axiom
  ...
  (! (=>
     ...
     (not
     (= (contains (model__ container1) (+ result 1)
        (ite (<= index1 (last_index container1)) index1
        (last_index container1)) item1) true))))
     (dynamic_invariant5 result true false true)))) :pattern ((reverse_find_index
                                                              container1
                                                              item1 index1)) ))))
...
(define-fun dynamic_invariant9 ((temp___expr_750 Int)
...
(define-fun dynamic_invariant10 ((temp___expr_744 Int)
