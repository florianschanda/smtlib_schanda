...
(declare-fun num5 () Int)

(declare-fun flag4 () Bool)

(declare-fun num6 () Int)
...
;; WP_parameter_def
 ;; File "state_machine.adb", line 22, characters 0-0
  (not
  (or
  (=> (state_a__function_guard (state_a flag3 num5) flag3 num5)
  (= (state_a flag3 num5) true))
  (=> (state_b__function_guard (state_b flag3 num5) flag3 num5)
  (= (state_b flag3 num5) true)))))
(check-sat)
