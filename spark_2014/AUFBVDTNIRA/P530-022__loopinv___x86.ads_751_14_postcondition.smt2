...
;; H
  (assert
  (=> (and (not (= carryflag true)) (not (= zeroflag true)))
  (= (writereglow8post rcx rcx1 ((_ int2bv 8) 1)) true)))

;; H
  (assert
  (=> (not (and (not (= carryflag true)) (not (= zeroflag true))))
  (= (writereglow8post rcx rcx2 ((_ int2bv 8) 0)) true)))
...
(assert
;; WP_parameter_def
 ;; File "x86.ads", line 251, characters 0-0
  (not (= (cl rcx3) ((_ int2bv 8) 1))))
(check-sat)
