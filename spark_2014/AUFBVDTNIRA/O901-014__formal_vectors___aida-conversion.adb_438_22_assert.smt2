...
(declare-fun temp___1528 () (Array Int integer))

(declare-fun temp___1526 () Int)
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1531))
  (= temp___1528 n1)))
...
;; H
  ...
  (=> (< index2 temp___1529)
  (= (select n3 temp___1529) (select temp___1528 temp___1529))))))
...
;; H
  (assert
  (and (= temp___1532 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1532)
  (<= temp___1532 (to_rep1 n__last))))

;; H
  (assert (= o9 temp___1532))
...
;; H
  (assert
  (and (= temp___1533 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1533)
  (<= temp___1533 (to_rep1 n__last))))

;; H
  (assert (= o12 temp___1533))
...
;; H
  (assert
  (and (= temp___1534 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1534)
  (<= temp___1534 (to_rep1 n__last))))

;; H
  (assert (= o19 temp___1534))
...
;; H
  (assert
  (and (= temp___1535 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1535)
  (<= temp___1535 (to_rep1 n__last))))

;; H
  (assert (= o26 temp___1535))
