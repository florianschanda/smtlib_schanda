...
(declare-fun dispatching_result__root__f1__first__bit () Int)

(declare-fun dispatching_result__root__f1__last__bit () Int)

(declare-fun dispatching_result__root__f1__position () Int)
...
(declare-fun dispatching_result__child__f2__first__bit () Int)

(declare-fun dispatching_result__child__f2__last__bit () Int)

(declare-fun dispatching_result__child__f2__position () Int)
...
(declare-fun dispatching_result__root__f1__first__bit1 () Int)

(declare-fun dispatching_result__root__f1__last__bit1 () Int)

(declare-fun dispatching_result__root__f1__position1 () Int)
...
(declare-fun dispatching_result__init__2__result1 () natural)

(declare-fun dispatching_result__init__2__result2 () us_private)

(declare-fun dispatching_result__init__2__result3 () Int)
...
(declare-fun dispatching_result__init__2__result4 () natural)

(declare-fun dispatching_result__init__2__result5 () natural)

(declare-fun dispatching_result__init__2__result6 () us_private)

(declare-fun dispatching_result__init__2__result7 () Int)

(declare-fun dispatching_result__init__2__result8 () natural)

(declare-fun dispatching_result__init__2__result9 () natural)

(declare-fun dispatching_result__init__2__result10 () us_private)

(declare-fun dispatching_result__init__2__result11 () Int)

(declare-fun dispatching_result__init__2__result12 () natural)

(declare-fun dispatching_result__init__2__result13 () natural)

(declare-fun dispatching_result__init__2__result14 () us_private)

(declare-fun dispatching_result__init__2__result15 () Int)

(declare-fun dispatching_result__init__2__result16 () natural)

(declare-fun dispatching_result__init__2__result17 () natural)

(declare-fun dispatching_result__init__2__result18 () us_private)

(declare-fun dispatching_result__init__2__result19 () Int)

(declare-fun dispatching_result__init__2__result20 () natural)

(declare-fun dispatching_result__init__2__result21 () natural)

(declare-fun dispatching_result__init__2__result22 () us_private)

(declare-fun dispatching_result__init__2__result23 () Int)

(define-fun dispatching_result__init__2__result24 () us_rep1 (mk___rep1
                                                             (mk___split_fields1
                                                             dispatching_result__init__2__result4
                                                             dispatching_result__init__2__result5
                                                             dispatching_result__init__2__result6)
                                                             dispatching_result__init__2__result7))
...
;; H
  (assert
  (= dispatching_result__init__2__result8 dispatching_result__init__2__result4))

;; H
  (assert
  (= dispatching_result__init__2__result9 dispatching_result__init__2__result5))

;; H
  (assert
  (= dispatching_result__init__2__result10 dispatching_result__init__2__result6))

;; H
  (assert
  (= dispatching_result__init__2__result11 dispatching_result__init__2__result7))

;; H
  (assert
  (= (mk___rep1
     (mk___split_fields1 dispatching_result__init__2__result12
     dispatching_result__init__2__result13
     dispatching_result__init__2__result14)
     dispatching_result__init__2__result15) dispatching_result__init__2__result24))
...
;; H
  (assert
  (= dispatching_result__init__2__result24 (mk___rep1
                                           (mk___split_fields1 o5 o6 o7) 
                                           o8)))
...
;; H
  ...
  (= (mk_child__ref
     (mk___rep1
     (mk___split_fields1 dispatching_result__init__2__result16
     dispatching_result__init__2__result17
     dispatching_result__init__2__result18)
     dispatching_result__init__2__result19)) (mk_child__ref
                                             (mk___rep1
                                             (mk___split_fields1
                                             dispatching_result__init__2__result8
                                             dispatching_result__init__2__result9
                                             dispatching_result__init__2__result10)
                                             dispatching_result__init__2__result11))))

;; H
  (assert
  (= dispatching_result__init__2__result20 dispatching_result__init__2__result12))

;; H
  (assert
  (= dispatching_result__init__2__result21 dispatching_result__init__2__result13))

;; H
  (assert
  (= dispatching_result__init__2__result22 dispatching_result__init__2__result14))

;; H
  (assert
  (= dispatching_result__init__2__result23 dispatching_result__init__2__result15))
...
(assert
;; WP_parameter_def
 ;; File "dispatching_result.ads", line 10, characters 0-0
  (not (= (to_rep dispatching_result__init__2__result17) v)))
(check-sat)
