...
;; H
  (assert (and (<= 1 i2) (<= i2 17)))

;; H
  (assert (= (to_rep5 (select logfilesstatus i2)) 2))
...
;; H
  (assert (in_range7 r95b))

;; H
  (assert (= result3 (mk_int__ref j)))
...
;; H
  ...
  (and
  (= o7 (+ (to_rep4
           (rec__auditlog__logfilelistt__lasti usedlogfiles__split_fields6)) 1))
  (in_range7
  (+ (to_rep4
     (rec__auditlog__logfilelistt__lasti usedlogfiles__split_fields6)) 1))))
...
;; H
  ...
  (= o9 (mk___split_fields
        ...
        (rec__auditlog__logfilelistt__head usedlogfiles__split_fields6) 
        o8 (rec__auditlog__logfilelistt__length usedlogfiles__split_fields6))))

;; H
  (assert (= temp___1198 (mk___rep o9)))

;; H
  (assert (= result5 (mk___split_fields__ref usedlogfiles__split_fields6)))

;; H
  (assert (= usedlogfiles__split_fields7 (us_split_fields1 temp___1198)))

;; H
  (assert
  (and
  (= o10 (+ (to_rep3
            (rec__auditlog__logfilelistt__length usedlogfiles__split_fields7)) 1))
  (in_range6
  (+ (to_rep3
     (rec__auditlog__logfilelistt__length usedlogfiles__split_fields7)) 1))))
...
;; H
  (assert (= temp___1200 (mk___rep o12)))

;; H
  (assert (= result6 (mk___split_fields__ref usedlogfiles__split_fields7)))

;; H
  (assert (= usedlogfiles__split_fields8 (us_split_fields1 temp___1200)))
...
;; H
  (assert (in_range7 r97b))

;; H
  (assert (and (= temp___1208 (+ j2 1)) (in_range10 (+ j2 1))))
...
;; H
  ...
  (=> (<= temp___1207 k2)
  (= (select (rec__auditlog__logfilelistt__list usedlogfiles__split_fields9) temp___1207) (select 
  (rec__auditlog__logfilelistt__list usedlogfiles__split_fields8) temp___1207)))))
  ...
  (= (rec__auditlog__logfilelistt__lasti usedlogfiles__split_fields9) 
  (rec__auditlog__logfilelistt__lasti usedlogfiles__split_fields8)))
