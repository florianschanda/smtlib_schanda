...
(declare-fun temp___590 () positive)

(declare-fun temp___5901 () natural)

(declare-fun temp___5902 () positive)

(declare-fun temp___5903 () positive)

(declare-fun temp___5904 () (Array Int element_type))
...
;; H
  ...
  (and (= (mk___split_discrs temp___590) my_queue__split_discrs)
  (and (= temp___5901 my_queue__split_fields4)
  (and (= temp___5902 my_queue__split_fields5)
  (and (= temp___5903 my_queue__split_fields6)
  (= temp___5904 my_queue__split_fields7)))))))
...
;; H
  ...
  (mk___rep my_queue__split_discrs
  (mk___split_fields
  (rec__bounded_queue_v2__queue_type__count1 my_queue__split_fields17)
  (rec__bounded_queue_v2__queue_type__front1 my_queue__split_fields17)
  (rec__bounded_queue_v2__queue_type__rear1 my_queue__split_fields17)
  (mk___t1
  (rec__bounded_queue_v2__queue_type__items1 my_queue__split_fields17)
  (mk1 1 100)))))
  (mk___rep my_queue__split_discrs
  (mk___split_fields
  (rec__bounded_queue_v2__queue_type__count1 my_queue__split_fields17)
...
;; H
  ...
  (= (mk___split_fields1 temp___5971 temp___5972 temp___5973 temp___5974) 
  (us_split_fields__content1 my_queue__split_fields15)))))

;; H
  (assert (=> (and (<= 1 count8) (<= count8 5)) (= temp___594 value)))
