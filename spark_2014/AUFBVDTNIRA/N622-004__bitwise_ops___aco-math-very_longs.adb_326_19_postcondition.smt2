...
;; H
  (assert (= result5 aco__math__very_longs__divide__get_msd__result4))
...
;; WP_parameter_def
 ;; File "aco-math-very_longs.ads", line 16, characters 0-0
  ...
  (= (to_rep
     (select (elts
             (rec__aco__math__very_longs__very_long__long_digits
             (us_split_fields1 number))) aco__math__very_longs__divide__get_msd__result4)) ((_ int2bv 8) 0)))))
(check-sat)
