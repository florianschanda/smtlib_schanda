...
;; H
  (assert
  (and (= o14 (islocked (us_private__content state4)))
  (islocked__function_guard o14 (us_private__content state4))))
...
;; H
  ...
  (= o16 (thecurrentop
         (mk___rep
         (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (thecurrentop__function_guard o16
  (mk___rep
  (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
  (in_range3 o16))))
...
;; H
  (assert
  (and (= o6 (islocked (us_private__content state4)))
  (islocked__function_guard o6 (us_private__content state4))))
...
;; H
  ...
  (=> (= result1 true)
  (and
  (and (= o10 (theauthcertrole (us_private__content state3)))
  (theauthcertrole__function_guard o10 (us_private__content state3)))
  (in_range1 o10))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o8 (authcertvalid (us_private__content state3)))
  (authcertvalid__function_guard o8 (us_private__content state3)))))

;; H
  (assert
  (=> (= result1 true)
  (and (= o9 (isgood (us_private__content state3))) (isgood__function_guard
  o9 (us_private__content state3)))))
