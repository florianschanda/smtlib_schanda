...
;; H
  (assert
  (and (= o11 (length m)) (and (in_range4 o11) (<= o11 (capacity m)))))

;; H
  (assert
  (and
  (= o9 (length (rec__amortized_queue__queue__rear (us_split_fields3 q))))
  (and (in_range4 o9)
  (<= o9 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))

;; H
  (assert
  (and
  (= o10 (length (rec__amortized_queue__queue__front (us_split_fields3 q))))
  (and (in_range4 o10)
  (<= o10 (capacity
          (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
...
;; H
  (assert (= result2 (ite (= o12 o11) true false)))

;; H
  (assert
  (=> (= result2 true)
  (and (= o8 (length m)) (and (in_range4 o8) (<= o8 (capacity m))))))

;; H
  (assert (=> (= result2 true) (= result1 (ite (<= o8 1000) true false))))
...
;; H
  ...
  (=> (= result1 true)
  (and
  (= o6 (length (rec__amortized_queue__queue__rear (us_split_fields3 q))))
  (and (in_range4 o6)
  (<= o6 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q))))))))

;; H
  (assert (=> (= result1 true) (= o7 (ite (<= i1 o6) true false))))

;; H
  (assert (=> (= result1 true) (= result3 (ite (<= 1 i1) o7 false))))
