...
(declare-fun temp___2006 () (Array Int integer))

(declare-fun temp___20061 () t2)
...
(declare-fun temp___2015 () Int)

(declare-fun temp___2011 () Int)

(declare-fun temp___2009 () (Array Int integer))
...
;; H
  (assert
  (= (mk___t2 temp___2006 temp___20061) (aida__conversion__calculate_positive_target_length_2__n__aggregate_def
                                        0 (to_rep1 (first (rt source)))
                                        (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___20061)) (to_rep1 (last6 temp___20061)))
     (+ (- (to_rep1 (last6 temp___20061)) (to_rep1 (first6 temp___20061))) 1)
...
;; H
  (assert
  (= (slide1 temp___2006 (to_rep1 (first6 temp___20061))
...
;; H
  (assert
  (and (= temp___2015 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___2015))
  (= temp___2011 index1)))
...
;; H
  ...
  (and
  (and
  (forall ((temp___2010 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___2010)
  (<= temp___2010 (to_rep1 n__last)))
  (=> (< index2 temp___2010)
  (= (select n3 temp___2010) (select temp___2009 temp___2010)))))
...
;; H
  (assert
  (and (= temp___2016 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2016)
  (<= temp___2016 (to_rep1 n__last))))

;; H
  (assert (= o9 temp___2016))
...
;; H
  (assert
  (and (= temp___2017 (+ (to_rep1 (first (rt source))) 0)) (in_range1
  (+ (to_rep1 (first (rt source))) 0))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2017)
  (<= temp___2017 (to_rep1 n__last))))

;; H
  (assert (= o12 temp___2017))
