...
;; H
  (assert
  (and (= o35 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o35 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o34 (from_word64 i2)) (from_word64__function_guard o34 i2)))

;; H
  (assert (and (= o36 (oadd o34 o35)) (oadd__function_guard o36 o34 o35)))

;; H
  (assert
  (and (= o33 (from_integer s10)) (from_integer__function_guard o33 s10)))

;; H
  (assert (and (= o37 (ole o33 o36)) (ole__function_guard o37 o33 o36)))
...
;; H
  (assert
  (and (= o27 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o27 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o28 (oexpon o27 s10)) (oexpon__function_guard o28 o27 s10)))

;; H
  (assert
  (and (= o22 (from_word32 ((_ int2bv 32) 1))) (from_word32__function_guard
  o22 ((_ int2bv 32) 1))))

;; H
  (assert
  (and (= o21 (from_integer s10)) (from_integer__function_guard o21 s10)))

;; H
  (assert
  (and (= o23 (osubtract o21 o22)) (osubtract__function_guard o23 o21 o22)))

;; H
  (assert
  (and (= o20 (from_word64 i2)) (from_word64__function_guard o20 i2)))

;; H
  (assert
  (and (= o24 (osubtract o20 o23)) (osubtract__function_guard o24 o20 o23)))

;; H
  (assert
  (and (= o19 (from_word32 ((_ int2bv 32) 2))) (from_word32__function_guard
  o19 ((_ int2bv 32) 2))))

;; H
  (assert
  (and (= o25 (oexpon__2 o19 o24)) (oexpon__2__function_guard o25 o19 o24)))
...
;; H
  (assert
  (and (= o18 (num_of_big_int e e_first o17)) (num_of_big_int__function_guard
  o18 e e_first o17)))

;; H
  (assert
  (and (= o26 (odivide o18 o25)) (odivide__function_guard o26 o18 o25)))
...
;; H
  (assert
  (and (= o13 (from_word32 (t__content w7))) (from_word32__function_guard 
  o13 (t__content w7))))

;; H
  (assert (and (= o30 (oeq o13 o29)) (oeq__function_guard o30 o13 o29)))
