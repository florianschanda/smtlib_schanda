...
(declare-fun bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result () (_ BitVec 8))
...
(declare-fun bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result1 () (_ BitVec 8))

(declare-fun result__4 () (_ BitVec 8))

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result2 () (_ BitVec 8))

(declare-fun result__5 () (_ BitVec 8))

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result3 () (_ BitVec 8))

(declare-fun result__6 () (_ BitVec 8))

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result4 () (_ BitVec 8))

(declare-fun result__7 () (_ BitVec 8))

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result5 () (_ BitVec 8))
...
;; H
  (assert
  (= result4 bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result4))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 3, characters 0-0
  (not
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits__result4 (bvand 
