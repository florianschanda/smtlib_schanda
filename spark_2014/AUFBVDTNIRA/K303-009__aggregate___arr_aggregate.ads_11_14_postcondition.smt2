...
;; def_axiom
  ...
  (= (select (temp___308 temp___310) 1) (of_rep temp___310))))
...
;; def_axiom
  ...
  (= (select (temp___312 temp___314) temp___315) (of_rep temp___314)))))
...
;; H
  (assert (=> (not (= b 1)) (= o1 (temp___312 one))))

;; H
  (assert (=> (not (= b 1)) (= (mk_map__ref result1) a5)))

;; H
  (assert (=> (not (= b 1)) (= a2 o1)))
