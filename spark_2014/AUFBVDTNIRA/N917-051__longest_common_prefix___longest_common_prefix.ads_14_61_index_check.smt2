...
(declare-fun longest_common_prefix__lcp2__result () Int)
...
(declare-fun longest_common_prefix__lcp2__result1 () Int)

(declare-fun longest_common_prefix__lcp2__result2 () Int)

(declare-fun longest_common_prefix__lcp2__result3 () Int)

(declare-fun l8 () Int)

(declare-fun longest_common_prefix__lcp2__result4 () Int)

(declare-fun l9 () Int)

(declare-fun longest_common_prefix__lcp2__result5 () Int)
...
;; H
  (assert (=> (= result1 true) (= temp___164 l1)))

;; H
  (assert (=> (= result1 true) (= 0 temp___167)))
...
;; H
  (assert (=> (= result1 true) (= temp___1671 result4)))

;; H
  (assert (=> (= result1 true) (= temp___1672 l2)))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (= result7 true) (and (= temp___1691 (+ y l3)) (in_range1 (+ y l3))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (= result7 true) (and (<= 1 temp___1691) (<= temp___1691 1000)))))

;; H
  (assert (=> (= result1 true) (=> (= result7 true) (= o11 temp___1691))))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (= result7 true) (and (= temp___1681 (+ x l3)) (in_range1 (+ x l3))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (= result7 true) (and (<= 1 temp___1681) (<= temp___1681 1000)))))

;; H
  (assert (=> (= result1 true) (=> (= result7 true) (= o9 temp___1681))))
...
;; H
  (assert
  (= longest_common_prefix__lcp2__result1 longest_common_prefix__lcp2__result2))

;; H
  (assert
  (= longest_common_prefix__lcp2__result3 longest_common_prefix__lcp2__result1))

;; H
  (assert
  (= (mk_int__ref result9) (mk_int__ref longest_common_prefix__lcp2__result)))

;; H
  (assert (= longest_common_prefix__lcp2__result1 l6))

;; H
  (assert
  (= (mk_int__ref longest_common_prefix__lcp2__result4) (mk_int__ref
                                                        longest_common_prefix__lcp2__result2)))
...
;; H
  (assert
  (= longest_common_prefix__lcp2__result5 longest_common_prefix__lcp2__result3))
...
;; H
  (assert (and (= temp___170 (+ i x)) (in_range1 (+ i x))))
