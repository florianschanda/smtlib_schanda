...
(define-fun dynamic_invariant8 ((temp___expr_197 Int)
...
(define-fun dynamic_invariant9 ((temp___expr_143 Int)
...
(define-fun dynamic_invariant10 ((temp___expr_209 Int)
...
;; H
  ...
  (is_incr
  (get
  (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n)
  (get (model__ (mk___rep v__split_discrs v__split_fields4)) n))
  (get
  (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n)
  (get (model__ (mk___rep v__split_discrs v__split_fields4)) n))))
...
;; H
  ...
  (= (is_incr
     ...
     n) (get (model__ (mk___rep v__split_discrs v__split_fields4)) n)) true))))
...
;; H
  ...
  (=>
  (and (<= i2 n)
  (<= n (last5 (model__ (mk___rep v__split_discrs v__split_fields4)))))
  (= (get
     (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))
     n) (get (model__ (mk___rep v__split_discrs v__split_fields4)) n)))))
...
;; H
  (assert
  (and (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields4)) o1))
  (and (in_range5 o2)
  (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields4)) o1)))))
...
;; H
  (assert (=> (= result2 true) (= o4 i2)))

;; H
  (assert
  (=> (= result2 true)
  (and (= o5 (get (model__ (mk___rep v__split_discrs v__split_fields4)) o4))
  (and (in_range5 o5)
  (= o5 (get (model__ (mk___rep v__split_discrs v__split_fields4)) o4))))))

;; H
  (assert (=> (= result2 true) (= o6 (+ o5 1))))

;; H
  (assert (=> (= result2 true) (and (= o7 o6) (in_range2 o6))))
...
;; H
  ...
  (= (length (mk___rep v__split_discrs v__split_fields3)) (length
                                                          ...
                                                          v__split_discrs
                                                          v__split_fields4)))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields3)) o3) o7))
  (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields4))
     (model__ (mk___rep v__split_discrs v__split_fields3)) o3) true))
  (dynamic_property2 0 last2
  (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))))))

;; H
  (assert (=> (not (= result2 true)) (= v__split_fields3 v__split_fields4)))
...
;; H
  ...
  (get
  (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) 
  n) (get (model__ (mk___rep v__split_discrs v__split_fields3)) n))
  (get
  (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) 
  n) (get (model__ (mk___rep v__split_discrs v__split_fields3)) n)))
...
;; WP_parameter_def
 ;; File "use_vectors.ads", line 36, characters 0-0
  ...
  (= (is_incr
     (get
     (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))
     n) (get (model__ (mk___rep v__split_discrs v__split_fields3)) n)) true)))
(check-sat)
