...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= 2 j1) (<= j1 i2))
  (= (to_rep (select a4 j1)) (+ (to_rep (select a4 (- j1 1))) (to_rep
                                                              (select 
                                                              a4 (- j1 2)))))))
  (= (to_rep (select a4 0)) 0)) (= (to_rep (select a4 1)) 1)))
...
;; H
  ...
  (=> (and (<= 0 temp___150) (<= temp___150 30))
  (=> (< i2 temp___150) (= (select a4 temp___150) (select a2 temp___150))))))
  (and (<= 2 i2) (<= i2 30))))
