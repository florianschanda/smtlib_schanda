...
;; WP_parameter_def
 ;; File "types.ads", line 5, characters 0-0
  (not
  (= (let ((temp___481 (temp___353
                       (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) 
                       i new_val)))
     (bool_eq3 a2 (to_rep1 a__first) (to_rep1 a__last) (elts temp___481)
     (to_rep1 (first (rt temp___481))) (to_rep1 (last (rt temp___481))))) true)))
(check-sat)
