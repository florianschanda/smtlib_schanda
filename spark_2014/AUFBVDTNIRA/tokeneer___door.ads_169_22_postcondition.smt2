...
;; thelatchunlockduration__post_axiom
  (assert
  (forall ((configdata__state us_private))
  (! (let ((result (thelatchunlockduration configdata__state)))
     (=> (thelatchunlockduration__function_guard result configdata__state)
     (dynamic_invariant1 result true false true))) :pattern ((thelatchunlockduration
                                                             configdata__state)) )))
...
;; thealarmsilentduration__post_axiom
  (assert
  (forall ((configdata__state us_private))
  (! (let ((result (thealarmsilentduration configdata__state)))
     (=> (thealarmsilentduration__function_guard result configdata__state)
     (dynamic_invariant1 result true false true))) :pattern ((thealarmsilentduration
                                                             configdata__state)) )))
...
;; thecurrentdoor__post_axiom
  ...
  (! (=> (dynamic_invariant2 door__currentdoor true true true)
...
;; thecurrentdoor__def_axiom
  ...
  (forall ((door__currentdoor Int))
  (! (=>
     (and (dynamic_invariant2 door__currentdoor true true true)
...
(define-fun dynamic_invariant6 ((temp___expr_272 Int)
...
(declare-fun dooralarm1 () int__ref)

(declare-fun alarmtimeout__split_fields () us_split_fields__ref)

;; H
  (assert (islocked__function_guard (islocked (us_private__content state))
...
;; H
  ...
  (mk___rep (us_split_fields__content alarmtimeout__split_fields)))
...
;; H
  ...
  (latch_timeout (us_private__content state)) (us_private__content state)))
...
;; H
  (assert (greaterthanorequal__function_guard
  (greaterthanorequal (thecurrenttime currenttime)
  (latch_timeout (us_private__content state))) (thecurrenttime currenttime)
  (latch_timeout (us_private__content state))))
...
;; H
  ...
  (=
  (and
  (and (= currentdoor 0) (= (islocked (us_private__content state)) true))
  (= (greaterthanorequal (thecurrenttime currenttime)
     (mk___rep (us_split_fields__content alarmtimeout__split_fields))) true))
  (= (int__content dooralarm1) 0))
  (= (= (islocked (us_private__content state)) true)
  (= (greaterthanorequal (thecurrenttime currenttime)
     (latch_timeout (us_private__content state))) true))))
...
;; H
  ...
  (alarm_timeout (us_split_fields__content alarmtimeout__split_fields))
  (us_split_fields__content alarmtimeout__split_fields)))
...
;; H
  (assert
  (= (greaterthanorequal (thecurrenttime currenttime)
     (alarm_timeout (us_split_fields__content alarmtimeout__split_fields))) true))

;; H
  (assert (thedooralarm__function_guard
  (thedooralarm (int__content dooralarm1)) (int__content dooralarm1)))

(assert
;; WP_parameter_def
 ;; File "latch.ads", line 42, characters 0-0
  (not (= (thedooralarm (int__content dooralarm1)) 0)))
(check-sat)
