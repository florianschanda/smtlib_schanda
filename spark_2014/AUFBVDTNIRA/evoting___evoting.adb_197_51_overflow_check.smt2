...
;; H
  (assert
  (and (= o3 (+ (to_rep2 (select counters1 chosen_vote2)) 1)) (in_range6
  (+ (to_rep2 (select counters1 chosen_vote2)) 1))))

;; H
  (assert (= (to_rep2 o4) o3))

;; H
  (assert (= o5 (store counters1 chosen_vote2 o4)))

;; H
  (assert (= counters1 result2))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range1 (+ number_of_votes1 1))))
(check-sat)
