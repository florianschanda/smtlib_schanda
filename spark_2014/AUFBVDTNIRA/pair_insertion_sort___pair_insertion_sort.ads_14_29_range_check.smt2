...
(declare-fun temp___320 () (Array Int integer))
...
(declare-fun a28 () map__ref)

(declare-fun j27 () int__ref)

(declare-fun y10 () int__ref)

(declare-fun a29 () (Array Int integer))

(declare-fun j28 () Int)

(declare-fun y11 () Int)

(declare-fun a30 () map__ref)

(declare-fun i8 () int__ref)

(declare-fun j29 () int__ref)

(declare-fun x9 () int__ref)

(declare-fun y12 () int__ref)

(declare-fun z8 () int__ref)

(declare-fun a31 () (Array Int integer))
...
;; H
  ...
  (forall ((z11 Int))
  (=> (and (<= (to_rep a__first) z11) (<= z11 (to_rep a__last)))
  (=> (and (not (= z11 o14)) (not (= z11 o15)))
  (= (to_rep (select a2 z11)) (to_rep (select a z11)))))))))
  (= (to_rep a__first) 0)))))
...
;; H
  (assert
  (=> (= result1 true) (=> (= result8 true) (= a32 (mk_map__ref a4)))))
...
;; H
  ...
  (forall ((z11 Int))
  (=> (and (<= (to_rep a__first) z11) (<= z11 (to_rep a__last)))
  (=> (and (not (= z11 o26)) (not (= z11 o28)))
  (= (to_rep (select a8 z11)) (to_rep (select a6 z11)))))))))
  (= (to_rep a__first) 0)))))
...
;; H
  ...
  (forall ((z11 Int))
  (=> (and (<= (to_rep a__first) z11) (<= z11 (to_rep a__last)))
  (=> (and (not (= z11 o33)) (not (= z11 o34)))
  (= (to_rep (select a11 z11)) (to_rep (select (map__content a9) z11)))))))))
  (= (to_rep a__first) 0)))))
...
;; H
  (assert
  (=> (= result17 true)
  (=> (<= 0 j20) (= o53 (select (map__content a20) o52)))))
...
;; H
  (assert
  (=> (= result17 true)
  (=> (<= 0 j20) (= result20 (ite (< y9 o54) true false)))))
...
;; H
  (assert
  (=> (= result17 true)
  (=> (= result20 true) (= temp___320 (map__content a20)))))

;; H
  (assert (=> (= result17 true) (=> (= result20 true) (= temp___317 j20))))

;; H
  (assert
  (=> (= result17 true)
  (=> (= result20 true) (and (= o57 j20) (in_range2 j20)))))

;; H
  (assert
  (=> (= result17 true)
  (=> (= result20 true) (and (= o55 (+ j20 1)) (in_range1 (+ j20 1))))))

;; H
  (assert
  (=> (= result17 true)
  (=> (= result20 true) (and (= o56 o55) (in_range2 o55)))))
...
;; H
  ...
  (forall ((z11 Int))
  (=> (and (<= (to_rep a__first) z11) (<= z11 (to_rep a__last)))
  (=> (and (not (= z11 o56)) (not (= z11 o57)))
  (= (to_rep (select a22 z11)) (to_rep (select (map__content a20) z11)))))))))
  (= (to_rep a__first) 0)))))
...
;; H
  (assert
  (=> (= result17 true)
  (=> (= result20 true) (< y9 (to_rep (select a23 (+ j21 1)))))))
...
;; H
  (assert
  (=> (= result17 true)
  (=> (= result20 true) (= (to_rep (select a23 j21)) y9))))
...
;; H
  (assert
  (=> (= result17 true)
  (=> (= result20 true) (and (= o58 (- j21 1)) (in_range1 (- j21 1))))))

;; H
  (assert
  (=> (= result17 true)
  (=> (= result20 true) (= result21 (mk_int__ref j21)))))
...
;; H
  (assert
  (=> (= result17 true) (=> (= result20 true) (=> (<= 0 j22) (= o59 j22)))))

;; H
  (assert
  (=> (= result17 true)
  (=> (= result20 true) (=> (<= 0 j22) (= o60 (select a23 o59))))))

;; H
  (assert
  (=> (= result17 true)
  (=> (= result20 true) (=> (<= 0 j22) (= o61 (to_rep o60))))))

;; H
  (assert
  (=> (= result17 true)
  (=> (= result20 true) (=> (<= 0 j22) (= o62 (ite (< y9 o61) true false))))))

;; H
  (assert
  (=> (= result17 true)
  (=> (= result20 true) (=> (not (<= 0 j22)) (= o62 false)))))

;; H
  (assert
  (=> (= result17 true)
  (=> (= result20 true) (= result22 (ite (not (= o62 true)) true false)))))
...
;; H
  (assert
  (=> (= result17 true) (=> (= result20 true) (= j23 (mk_int__ref j22)))))

;; H
  (assert
  (=> (= result17 true) (=> (= result20 true) (= a24 (mk_map__ref a23)))))
...
;; H
  (assert
  (=> (= result17 true)
  (=> (not (= result20 true)) (= j25 (mk_int__ref j20)))))
...
;; H
  (assert
  (=> (<= (to_rep a__first) (to_rep a__last))
  (= o63 (+ (- (to_rep a__last) (to_rep a__first)) 1))))
