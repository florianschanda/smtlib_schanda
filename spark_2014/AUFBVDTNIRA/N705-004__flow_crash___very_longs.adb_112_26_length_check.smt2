...
(define-fun dynamic_invariant2 ((temp___expr_393 us_rep1)
  (temp___is_init_390 Bool) (temp___skip_constant_391 Bool)
  (temp___do_toplevel_392 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_391 true))
                                      (in_range4 octet_length
                                      (to_base temp___expr_393)))
                                      (and (dynamic_property3 1 octet_length
                                      (first3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_393)))
                                      (last5
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_393))))
                                      (and
                                      (= (first3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_393))) 1)
                                      (= (last5
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_393))) 
                                      octet_length)))))

(define-fun default_initial_assumption ((temp___expr_396 us_rep1)
  (temp___skip_top_level_397 Bool)) Bool (= (to_rep
                                            (rec__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_396))) octet_length))
...
(declare-fun temp___821 ((_ BitVec 8) Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___823 (_ BitVec 8)))
  (forall ((temp___824 Int) (temp___825 Int))
  (let ((temp___822 (temp___821 temp___823 temp___824 temp___825)))
  (and
  (=> (dynamic_property6 1 2147483647 temp___824 temp___825)
  (and (= (first5 temp___822) temp___824) (= (last8 temp___822) temp___825)))
  (forall ((temp___826 Int))
  (= (select (to_array2 temp___822) temp___826) (of_rep1 temp___823))))))))
...
(declare-fun temp___829 () (Array Int octet))
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___821 ((_ int2bv 8) 0) 1 octet_length)))) 1))

;; H
  (assert
  (= (to_rep2 (last7 (rt2 (temp___821 ((_ int2bv 8) 0) 1 octet_length)))) 
  octet_length))

;; H
  (assert
  (= (mk___t2 temp___828 temp___8281) (temp___821 ((_ int2bv 8) 0) 1
                                      octet_length)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___8281)) (to_rep2 (last7 temp___8281)))
     (+ (- (to_rep2 (last7 temp___8281)) (to_rep2 (first4 temp___8281))) 1)
     0) (ite (<= 1 octet_length) (+ (- octet_length 1) 1) 0)))

;; H
  (assert (= temp___828 temp___829))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___8281)) (to_rep2 (last7 temp___8281))) 
  temp___8291))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 85, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first2 temp___8291)) (to_rep2 (last4 temp___8291)))
     (+ (- (to_rep2 (last4 temp___8291)) (to_rep2 (first2 temp___8291))) 1)
