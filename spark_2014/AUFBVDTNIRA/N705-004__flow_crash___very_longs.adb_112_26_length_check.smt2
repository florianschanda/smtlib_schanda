...
(define-fun bool_eq4 ((a (Array Int octet)) (a__first Int) (a__last Int)
...
(declare-datatypes ()
((tT25bP1__ref (mk_tT25bP1__ref (tT25bP1__content tdigit_index_typeB)))))
(define-fun tT25bP1__ref___projection ((a tT25bP1__ref)) tdigit_index_typeB 
  (tT25bP1__content a))
...
(define-fun dynamic_invariant2 ((temp___expr_392 us_rep1)
  (temp___is_init_389 Bool) (temp___skip_constant_390 Bool)
  (temp___do_toplevel_391 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_390 true))
                                      (in_range4 octet_length
                                      (to_base temp___expr_392)))
                                      (and (dynamic_property3 1 octet_length
                                      (first3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_392)))
                                      (last3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_392))))
                                      (and
                                      (= (first3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_392))) 1)
                                      (= (last3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_392))) 
                                      octet_length)))))

(define-fun default_initial_assumption ((temp___expr_395 us_rep1)
  (temp___skip_top_level_396 Bool)) Bool (= (to_rep
                                            (rec__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_395))) octet_length))
...
(declare-datatypes ()
((t26b__ref (mk_t26b__ref (t26b__content tdigit_index_typeB)))))
(define-fun t26b__ref___projection ((a t26b__ref)) tdigit_index_typeB 
  (t26b__content a))
...
;; def_axiom
  ...
  (and
  (=> (dynamic_property6 1 2147483647 temp___821 temp___822)
  (and (= (first5 temp___819) temp___821) (= (last5 temp___819) temp___822)))
  (forall ((temp___823 Int))
  (= (select (to_array2 temp___819) temp___823) (of_rep1 temp___820))))))))
...
(declare-fun temp___8251 () t2)

(declare-fun temp___826 () (Array Int octet))

(declare-fun temp___8261 () t1)
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___818 ((_ int2bv 8) 0) 1 octet_length)))) 1))

;; H
  (assert
  (= (to_rep2 (last4 (rt2 (temp___818 ((_ int2bv 8) 0) 1 octet_length)))) 
  octet_length))

;; H
  (assert
  (= (mk___t2 temp___825 temp___8251) (temp___818 ((_ int2bv 8) 0) 1
                                      octet_length)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___8251)) (to_rep2 (last4 temp___8251)))
     (+ (- (to_rep2 (last4 temp___8251)) (to_rep2 (first4 temp___8251))) 1)
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___8251)) (to_rep2 (last4 temp___8251))) 
  temp___8261))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 85, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first2 temp___8261)) (to_rep2 (last2 temp___8261)))
     (+ (- (to_rep2 (last2 temp___8261)) (to_rep2 (first2 temp___8261))) 1)
