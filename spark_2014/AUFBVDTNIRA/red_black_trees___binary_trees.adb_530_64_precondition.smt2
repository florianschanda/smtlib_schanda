...
(declare-fun temp___2019 () (Array Int us_rep1))
...
;; H
  ...
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  i1)
  (rec__tree_model__path_type__a (us_split_fields1 (select temp___2019 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select temp___2019 (parent
                      (mk___rep2
...
;; H
  ...
  (model____function_guard temp___2019
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))
  root))
  (and (dynamic_invariant3 temp___2019 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2019 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2019 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2019 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2019 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2019 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2019 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2019 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2019 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o (select temp___2019 i)))
