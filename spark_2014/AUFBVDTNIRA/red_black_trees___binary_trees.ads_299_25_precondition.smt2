...
(declare-fun o44 () (Array Int us_rep1))
...
;; H
  ...
  (= o46 (size
         (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))))
  (size__function_guard o46
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))))
  (and (in_range2 o46) (= o46 (to_rep f__split_fields)))))
...
;; H
  ...
  (and
  (and
  (= o47 (size (mk___rep2 (us_split_fields__content2 f__split_fields7))))
...
;; H
  ...
  (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o45)
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) o45))

;; H
  (assert (parent__function_guard
  (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o45)
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) o45))
...
;; H
  ...
  (and
  (and
  (= o45 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d))
  (peek__function_guard o45
...
;; H
  (assert
  (forall ((j Int)) (valid_root__function_guard
  (valid_root
...
;; H
  (assert
  (forall ((j Int)) (valid_root__function_guard
  (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) j)
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) j)))
...
;; H
  (assert (peek__function_guard
  (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d))
...
;; H
  (assert
  (forall ((j Int)) (is_concat__function_guard
  (is_concat
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7))
          root) (peek
                (mk___rep2 (us_split_fields__content2 f__split_fields7)) 
                i d))))
  (rec__tree_model__path_type__a
...
;; H
  ...
  (= (is_concat
     ...
     (select (model__
             (mk___rep2
             (mk___split_fields2 f__split_fields f__split_fields1)) v) j)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (mk___rep2 (us_split_fields__content2 f__split_fields7)) 
...
;; H
  ...
  (= o42 (valid_root
         (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) 
         t))
  (valid_root__function_guard o42
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t))
  (and
  (= (= o42 true)
  (and (<= t (to_rep f__split_fields))
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3 (select f__split_fields1 t)))) 2)))
  (=>
  (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 
  t) (not (= o42 true))))))
...
;; H
  ...
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i1) (rec__tree_model__path_type__a (us_split_fields1 (select o44 i1))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select o44 (parent
              (mk___rep2
...
;; H
  ...
  (= o44 (model__
         (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) 
         t))
  (model____function_guard o44
  (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t))
  (and (dynamic_invariant3 o44 true false true)
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o44 t))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select o44 t)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 t))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select o44 (parent
                      ...
                      i1)))) true))
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o44 i1))) true)
  (not
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o44 i1))) true))))))
  (and
  (forall ((i1 Int))
  ...
  (= (is_add
     ...
     (rec__tree_model__path_type__a (us_split_fields1 (select o44 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select o44 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o44 i1))) true)
  ...
  (=>
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o44 j))) true)
  (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o44 i1)))
     (rec__tree_model__path_type__a (us_split_fields1 (select o44 j)))) true))
  (= j i1))))))))))))))
...
;; H
  (assert (valid_root__function_guard
  (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) t)
  (mk___rep2 (us_split_fields__content2 f__split_fields7)) t))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) t) true)))
(check-sat)
