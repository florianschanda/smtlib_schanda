...
(declare-fun temp___307 () us_rep1)

(declare-fun temp___3071 () us_rep2)
...
(declare-fun temp___309 () us_rep1)

(declare-fun temp___3091 () us_rep2)
...
;; H
  ...
  (oeq1 (mk___rep1 (us_split_fields__content1 model____split_fields6))
  (mk___rep1
  (mk___split_fields1 model____split_fields model____split_fields1)))
  (mk___rep1 (us_split_fields__content1 model____split_fields6))
  (mk___rep1
  (mk___split_fields1 model____split_fields model____split_fields1))))
...
;; H
  ...
  (is_prepend
  (rec__list_allocator__m__t__available
  (us_split_fields__content1 model____split_fields6)) (int__content res3)
...
;; H
  ...
  (is_add model____split_fields1 (int__content res3)
  (rec__list_allocator__m__t__allocated
  (us_split_fields__content1 model____split_fields6))) model____split_fields1
  (int__content res3)
  (rec__list_allocator__m__t__allocated
...
;; H
  (assert (=> (not (= first_available 0)) (= o5 o4)))

;; H
  (assert (=> (not (= first_available 0)) (= o6 (to_rep o5))))
...
;; H
  (assert (=> (not (= first_available 0)) (= next_avail2 o6)))

;; H
  (assert (=> (not (= first_available 0)) (= (to_rep o7) 0)))

;; H
  (assert (=> (not (= first_available 0)) (= (to_rep1 o8) 1)))

;; H
  (assert (=> (not (= first_available 0)) (= o8 o9)))

;; H
  (assert (=> (not (= first_available 0)) (= o7 o10)))

;; H
  (assert (=> (not (= first_available 0)) (= o11 o9)))

;; H
  (assert (=> (not (= first_available 0)) (= o12 o10)))

;; H
  (assert (=> (not (= first_available 0)) (and (<= 1 res1) (<= res1 10000))))

;; H
  (assert (=> (not (= first_available 0)) (= o13 res1)))
...
;; H
  (assert (=> (not (= first_available 0)) (= data2 o14)))

;; H
  (assert
  (=> (not (= first_available 0)) (= result4 (mk_int__ref first_available))))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (and (= o15 (remove model____split_fields 1))
  (and (= (length o15) (- (length model____split_fields) 1))
  (and (= (range_equal model____split_fields o15 1 (- 1 1)) true)
  (= (range_shifted o15 model____split_fields 1 (last o15) 1) true))))))

;; H
  (assert (=> (not (= first_available 0)) (= o15 o16)))

;; H
  (assert (=> (not (= first_available 0)) (= model____split_fields1 o17)))

;; H
  (assert (=> (not (= first_available 0)) (= temp___307 o16)))

;; H
  (assert (=> (not (= first_available 0)) (= temp___3071 o17)))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (= model____split_fields4 (mk___split_fields1 temp___307 temp___3071))))

;; H
  (assert
  (=> (not (= first_available 0))
  (and
  (= o18 (add (rec__list_allocator__m__t__allocated model____split_fields4)
         res1))
  (and
  (and
  (and
  ...
  (= (contains o18 res1) true))
  (= (ole (rec__list_allocator__m__t__allocated model____split_fields4) o18) true))
  (= (included_except o18
     (rec__list_allocator__m__t__allocated model____split_fields4) res1) true)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (= (rec__list_allocator__m__t__available model____split_fields4) o19)))

;; H
  (assert (=> (not (= first_available 0)) (= o18 o20)))

;; H
  (assert (=> (not (= first_available 0)) (= temp___309 o19)))

;; H
  (assert (=> (not (= first_available 0)) (= temp___3091 o20)))

;; H
  (assert
  (=> (not (= first_available 0))
  (= result6 (mk___split_fields__ref1 model____split_fields4))))

;; H
  (assert
  (=> (not (= first_available 0))
  (= model____split_fields5 (mk___split_fields1 temp___309 temp___3091))))
...
;; H
  ...
  (and (<= 1 j)
  (<= j (length
        (rec__list_allocator__m__t__available model____split_fields5))))
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- j 1)))
  (not
  (= (get (rec__list_allocator__m__t__available model____split_fields5) j) 
  (get (rec__list_allocator__m__t__available model____split_fields5) k)))))))))

;; H
  (assert (=> (not (not (= first_available 0))) (= result7 res5)))
...
;; H
  (assert (=> (not (not (= first_available 0))) (= data2 data)))
...
;; H
  (assert (=> (not (not (= first_available 0))) (= data2 data1)))
...
;; H
  (assert
  (=> (= (= (length model____split_fields) 0) true)
  (and (= (int__content res3) 0)
  (= (oeq1 (mk___rep1 (us_split_fields__content1 model____split_fields6))
     (mk___rep1
     (mk___split_fields1 model____split_fields model____split_fields1))) true))))
...
;; H
  (assert
  (=> (not (= (= (length model____split_fields) 0) true))
  (and
  (= (is_prepend
     (rec__list_allocator__m__t__available
     (us_split_fields__content1 model____split_fields6)) (int__content res3)
     model____split_fields) true)
  (= (is_add model____split_fields1 (int__content res3)
     (rec__list_allocator__m__t__allocated
...
;; H
  (assert (is_valid__function_guard
  (is_valid (map__content data3) (int__content first_available3)
  (us_split_fields__content1 model____split_fields6)) (map__content data3)
  (int__content first_available3)
  (us_split_fields__content1 model____split_fields6)))
