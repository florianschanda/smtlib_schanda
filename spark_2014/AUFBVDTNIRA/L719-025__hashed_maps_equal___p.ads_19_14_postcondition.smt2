...
(define-fun key_type__ref_4__projection ((a key_type__ref2)) us_rep2 
...
(define-fun default_initial_assumption ((temp___expr_426 us_rep3)
...
(define-fun default_initial_assumption1 ((temp___expr_448 us_rep4)
...
;; keys__post_axiom
  ...
  (! (let ((result (keys container)))
     ...
     (= (has_key (model__ container) (get1 result temp___467)) true))))
     (forall ((key2 Int))
...
;; positions__post_axiom
  ...
  (! (let ((result (positions container)))
     ...
     (=> (= (get2 result i) (get2 result j)) (= (bool_eq7 i j) true))))))))) :pattern (
  (positions container)) )))
...
;; has_key__post_axiom
  ...
  (! (=> (= (of_int 0) true)
     (=>
     (exists ((k1 us_rep2))
     (and (= (has_key1 container k1) true) (= (bool_eq7 k1 key2) true)))
...
;; keys_included_except__post_axiom
  ...
  (! (= (= (keys_included_except1 left right new_key) true)
     (forall ((key2 us_rep2))
     (=> (= (has_key1 left key2) true)
     (=> (not (= (bool_eq7 key2 new_key) true))
...
;; H
  ...
  (and
  (and
  (= (oeq2 (positions (mk___rep l__split_discrs l__split_fields6))
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)
  (= (get1 (keys (mk___rep l__split_discrs l__split_fields6))
     (get2 (positions (mk___rep l__split_discrs l__split_fields6))
     (find (mk___rep l__split_discrs l__split_fields6) k))) k))
  (= (equal_except
     (keys (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (keys (mk___rep l__split_discrs l__split_fields6))
     (get2 (positions (mk___rep l__split_discrs l__split_fields6))
     (find (mk___rep l__split_discrs l__split_fields6) k))) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields6)) k) e))
  (= (same_keys (model__ (mk___rep l__split_discrs l__split_fields6))
...
;; H
  ...
  (= (length (mk___rep l__split_discrs l__split_fields5)) (+ (length
                                                             ...
                                                             (mk___split_fields
                                                             l__split_fields))) 1))
  (= (has_key (model__ (mk___rep l__split_discrs l__split_fields5)) k) true))
  (= (key (mk___rep l__split_discrs l__split_fields5)
     (find (mk___rep l__split_discrs l__split_fields5) k)) k))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields5)) k) e))
  (= (ole
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
