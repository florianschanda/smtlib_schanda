...
;; def_axiom
  ...
  (= (select (temp___222 temp___224) 1) (of_rep1 temp___224))))
...
(declare-fun temp___560 () positive_less_than_max)

(declare-fun temp___5601 () (Array Int element))

(declare-fun temp___5602 () less_than_max)

(declare-fun temp___5603 () us_private)

(declare-fun temp___5604 () Int)
...
;; H
  (assert (and (<= 1 temp___558) (<= temp___558 100)))
...
;; H
  (assert (= temp___560 o5))

;; H
  (assert (= temp___5601 o6))

;; H
  (assert (= temp___5602 o7))

;; H
  (assert (= temp___5603 o8))

;; H
  (assert (= s__attr__tag temp___5604))
...
;; H
  (assert (= temp___560 s__split_fields4))

;; H
  (assert (= temp___5601 s__split_fields5))

;; H
  (assert (= temp___5602 s__split_fields6))

;; H
  (assert (= temp___5603 s__split_fields7))
...
;; WP_parameter_def
 ;; File "stackp.ads", line 55, characters 0-0
  (not
  (= (let ((temp___566 (get_model__3
                       (mk___rep1
                       (mk___split_fields1 s__split_fields s__split_fields1
                       s__split_fields2 s__split_fields3) s__attr__tag))))
     (bool_eq3
     (let ((temp___564 (temp___222 e2)))
     (let ((temp___563 (get_model__3
                       (mk___rep1
                       (mk___split_fields1 s__split_fields8 s__split_fields9
                       s__split_fields10 s__split_fields11) s__attr__tag))))
     (ite (= (length temp___563) 0) temp___564
     (concat1 (elts temp___563) (to_rep2 (first (rt temp___563)))
     (to_rep2 (last (rt temp___563))) temp___564 1 1))))
     (to_rep2
     (first
     (let ((temp___563 (get_model__3
                       (mk___rep1
                       (mk___split_fields1 s__split_fields8 s__split_fields9
                       s__split_fields10 s__split_fields11) s__attr__tag))))
     (ite (= (length temp___563) 0) (mk 1 1)
     (mk (to_rep2 (first (rt temp___563)))
     (- (+ (to_rep2 (first (rt temp___563))) (+ (ite (<= (to_rep2
                                                         (first
                                                         (rt temp___563))) 
                                                (to_rep2
                                                (last (rt temp___563))))
     ...
     (- (+ (to_rep2 (first (rt temp___563))) (+ (ite (<= (to_rep2
                                                ...
                                                0) (ite (<= 1 1)
                                                   (+ (- 1 1) 1) 0))) 1))))))
     (elts temp___566) (to_rep2 (first (rt temp___566)))
     (to_rep2 (last (rt temp___566))))) true)))
(check-sat)
