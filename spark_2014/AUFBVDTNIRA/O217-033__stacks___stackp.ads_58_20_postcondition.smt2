...
(declare-fun temp___250 (Int) (Array Int element))

;; def_axiom
  (assert
  (forall ((temp___252 Int))
  (= (select (temp___250 temp___252) 1) (of_rep1 temp___252))))
...
(declare-fun o5 () positive_less_than_max)

(declare-fun o6 () (Array Int element))

(declare-fun o7 () less_than_max)

(declare-fun o8 () us_private)

(declare-fun temp___707 () positive_less_than_max)

(declare-fun temp___7071 () (Array Int element))

(declare-fun temp___7072 () less_than_max)

(declare-fun temp___7073 () us_private)

(declare-fun temp___7074 () Int)

(declare-fun result () Int)

(declare-fun e1 () Int)

(declare-fun result1 () positive_less_than_max)

(declare-fun result2 () (Array Int element))

(declare-fun result3 () less_than_max)
...
;; H
  ...
  (last__function_guard temp___705
  (mk___rep1
  (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2
  s__split_fields3) s__attr__tag)))
  (and (in_range temp___705)
  (= temp___705 (ite (not
                     (= (wraps_around
                        (mk___rep1
                        (mk___split_fields1 s__split_fields s__split_fields1
                        s__split_fields2 s__split_fields3) s__attr__tag)) true))
                (- (+ (to_rep3 s__split_fields) (to_rep s__split_fields2)) 1)
                (- (- (+ (to_rep3 s__split_fields) (to_rep s__split_fields2)) 1) 100))))))

;; H
  (assert (and (<= 1 temp___705) (<= temp___705 100)))

;; H
  (assert (= o temp___705))

;; H
  (assert (= o1 (select s__split_fields1 o)))
...
;; H
  (assert
  (and (= o3 (- (to_rep s__split_fields2) 1)) (in_range
...
;; H
  (assert (= temp___707 o5))

;; H
  (assert (= temp___7071 o6))

;; H
  (assert (= temp___7072 o7))

;; H
  (assert (= temp___7073 o8))

;; H
  (assert (= s__attr__tag temp___7074))
...
;; H
  (assert (= temp___707 s__split_fields4))

;; H
  (assert (= temp___7071 s__split_fields5))

;; H
  (assert (= temp___7072 s__split_fields6))

;; H
  (assert (= temp___7073 s__split_fields7))
...
;; H
  (assert (= s__split_fields12 s__split_fields4))

;; H
  (assert (= s__split_fields13 s__split_fields5))

;; H
  (assert (= s__split_fields14 s__split_fields6))

;; H
  (assert (= s__split_fields15 s__split_fields7))
...
;; H
  ...
  (get_model__3
  (mk___rep1
  (mk___split_fields1 s__split_fields8 s__split_fields9 s__split_fields10
  s__split_fields11) s__attr__tag))
  (mk___rep1
  (mk___split_fields1 s__split_fields8 s__split_fields9 s__split_fields10
  s__split_fields11) s__attr__tag)))
...
(assert
;; WP_parameter_def
 ;; File "stackp.ads", line 55, characters 0-0
  (not
  (= (let ((temp___716 (get_model__3
                       (mk___rep1
                       (mk___split_fields1 s__split_fields s__split_fields1
                       s__split_fields2 s__split_fields3) s__attr__tag))))
     (bool_eq3
     (let ((temp___713 (temp___250 e2)))
     (let ((temp___712 (get_model__3
                       (mk___rep1
                       (mk___split_fields1 s__split_fields8 s__split_fields9
                       s__split_fields10 s__split_fields11) s__attr__tag))))
     (ite (= (length temp___712) 0) temp___713
     (concat1 (elts temp___712) (to_rep2 (first (rt temp___712)))
     (to_rep2 (last (rt temp___712))) temp___713 1 1))))
     (to_rep2
     (first
     (let ((temp___712 (get_model__3
                       (mk___rep1
                       (mk___split_fields1 s__split_fields8 s__split_fields9
                       s__split_fields10 s__split_fields11) s__attr__tag))))
     (ite (= (length temp___712) 0) (mk 1 1)
     (mk (to_rep2 (first (rt temp___712)))
     (- (+ (to_rep2 (first (rt temp___712))) (+ (ite (<= (to_rep2
                                                         (first
                                                         (rt temp___712))) 
                                                (to_rep2
                                                (last (rt temp___712))))
     ...
     (- (+ (to_rep2 (first (rt temp___712))) (+ (ite (<= (to_rep2
                                                ...
                                                0) (ite (<= 1 1)
                                                   (+ (- 1 1) 1) 0))) 1))))))
     (elts temp___716) (to_rep2 (first (rt temp___716)))
     (to_rep2 (last (rt temp___716))))) true)))
(check-sat)
