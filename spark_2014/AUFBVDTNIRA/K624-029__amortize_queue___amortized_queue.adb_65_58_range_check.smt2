...
;; H
  ...
  (= (get (model__ (mk___rep front__split_discrs front__split_fields10)) i1) 
...
;; H
  (assert
  (and (= o5 (length orear)) (and (in_range4 o5) (<= o5 (capacity orear)))))

;; H
  (assert
  (and (= o6 (length ofront)) (and (in_range4 o6) (<= o6 (capacity ofront)))))
