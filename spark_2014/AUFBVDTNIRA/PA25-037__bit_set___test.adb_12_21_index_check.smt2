...
(define-fun bool_eq4 ((a (Array Int unsigned_32)) (a__first Int)
...
;; H
  ...
  (= o2 (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___224)))))

;; H
  (assert (=> (not (< temp___224 4294967296)) (= o2 ((_ int2bv 32) 0))))
...
;; WP_parameter_def
 ;; File "test.ads", line 13, characters 0-0
  (not (<= (to_rep1 (first (rt a))) temp___223)))
(check-sat)
