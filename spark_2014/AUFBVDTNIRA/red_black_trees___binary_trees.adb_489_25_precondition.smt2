...
;; H
  (assert (model____function_guard
  (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  r2) (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) 
  r2))
...
;; H
  (assert (=> (and (<= 1 r2) (<= r2 r186b)) (= temp___2076 r2)))
...
;; H
  ...
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3 (select f_old__split_fields1 r2)))) 2)))
  (type_invariant
  (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))))))
...
;; H
  ...
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3 (select f__split_fields1 r2)))) 2)
  (= (oeq1
     (model__
     (mk___rep2
     (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r2)
     (model__
     (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) 
     r2)) true)))))
...
;; H
  (assert
  (=> (and (<= 1 r2) (<= r2 r186b))
  (and (=> (<= 1 r186b) (dynamic_property 1 r186b r3))
  (and (<= 1 r3) (<= r3 r186b)))))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 r186b)) (= r3 r186b)))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 r186b)) (= r4 (mk_int__ref r3))))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 r186b)) (= r5 r3)))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 r186b)) (= r6 r4)))

;; H
  (assert (=> (and (<= 1 r2) (<= r2 r186b)) (= r7 r5)))

;; H
  (assert (=> (not (and (<= 1 r2) (<= r2 r186b))) (= r6 (mk_int__ref r2))))

;; H
  (assert (=> (not (and (<= 1 r2) (<= r2 r186b))) (= r7 r2)))
...
;; H
  (assert
  (= result14 (ite (not (= r1 root)) (ite (not (= r1 v)) o62 false) false)))
...
;; H
  ...
  (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))
  i) (rec__tree_model__path_type__a (us_split_fields1 (select o67 i))))
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select o67 (parent
              (mk___rep2
