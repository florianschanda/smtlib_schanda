...
;; H
  (assert
  (and (= o37 (+ offset1 bytes_to_squeeze2)) (in_range1
  (+ offset1 bytes_to_squeeze2))))
...
;; H
  (assert
  (and (= o38 (- remaining1 bytes_to_squeeze2)) (in_range1
...
;; H
  (assert (= result13 (mk_int__ref remaining1)))

;; H
  (assert (= remaining2 o39))
...
;; H
  (assert (= result14 (mk___split_fields__ref ctx__split_fields11)))
...
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not
  (<= (ite (<= (to_rep o41) (to_rep o42)) (+ (- (to_rep o42) (to_rep o41)) 1)
      0) 200)))
(check-sat)
