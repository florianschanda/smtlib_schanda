...
;; H
  (assert
  (= (mk (to_rep (first2 temp___2721)) (to_rep (last4 temp___2721))) 
...
;; H
  (assert
  (= (to_rep a1__last) (to_rep (last1 alignment_attribute__q__a1__assume1))))
...
;; H
  (assert
  (= o (alignment_attribute__q__a2__aggregate_def
