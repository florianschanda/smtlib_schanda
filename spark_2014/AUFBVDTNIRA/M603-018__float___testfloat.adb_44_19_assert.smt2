...
(declare-fun max_float () t)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun max_double () t1)
...
;; max_float__def_axiom
  (assert (= max_float fliteral2))

;; max_double__def_axiom
  (assert (= max_double fliteral3))
...
;; H
  (assert (tqtisFinite max_float))

;; H
  (assert (tqtisFinite1 max_double))
...
;; H
  (assert (tqtisFinite z1))

;; H
  (assert (and (= o (add RNE1 x1 y1)) (tqtisFinite (add RNE1 x1 y1))))

;; H
  (assert (= o1 (div1 RNE1 o fliteral6)))
...
;; H
  (assert (tqtisFinite t3))

;; H
  (assert (eq (roundToIntegral RTN1 x1) x1))

;; H
  (assert (eq (roundToIntegral RTN1 y1) y1))

;; H
  (assert (eq (roundToIntegral RTN1 z1) x1))

;; H
  (assert (eq (roundToIntegral RTN1 t3) x1))

;; H
  (assert (eq (roundToIntegral RTP1 x1) x1))

;; H
  (assert (eq (roundToIntegral RTP1 y1) y1))

;; H
  (assert (eq (roundToIntegral RTP1 z1) y1))

(assert
;; WP_parameter_def
 ;; File "testfloat.adb", line 11, characters 0-0
  (not (eq (roundToIntegral RTP1 t3) y1)))
(check-sat)
