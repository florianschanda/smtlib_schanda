...
;; H
  (assert (and (= o (add RNE2 x1 y1)) (tqtisFinite (add RNE2 x1 y1))))

;; H
  (assert (= o1 (div1 RNE2 o fliteral6)))
...
;; H
  (assert (eq (roundToIntegral RTN2 x1) x1))

;; H
  (assert (eq (roundToIntegral RTN2 y1) y1))

;; H
  (assert (eq (roundToIntegral RTN2 z1) x1))

;; H
  (assert (eq (roundToIntegral RTN2 t3) x1))

;; H
  (assert (eq (roundToIntegral RTP2 x1) x1))

;; H
  (assert (eq (roundToIntegral RTP2 y1) y1))

;; H
  (assert (eq (roundToIntegral RTP2 z1) y1))

(assert
;; WP_parameter_def
 ;; File "testfloat.adb", line 11, characters 0-0
  (not (eq (roundToIntegral RTP2 t3) y1)))
(check-sat)
