...
(declare-fun o9 () (Array Int even))

(declare-fun temp___299 () (Array Int even))
...
;; H
  (assert (= (mod2 temp___297 2) 0))

;; H
  (assert (= o7 temp___297))

;; H
  (assert (= (to_rep o8) o7))

;; H
  (assert (= o9 (store result__2 2 o8)))
