...
(declare-fun user_eq2 (t45b t45b) Bool)

(declare-fun dummy2 () t45b)
...
(declare-fun temp___444 (Int Int) (Array Int unsigned_byte))

;; def_axiom
  (assert
  (forall ((temp___446 Int) (temp___447 Int))
  (let ((temp___445 (temp___444 temp___446 temp___447)))
  (forall ((temp___448 Int))
  (ite (and (<= 2 temp___448) (<= temp___448 5))
  (= (select temp___445 temp___448) (of_rep temp___446))
  (= (select temp___445 temp___448) (of_rep temp___447)))))))
