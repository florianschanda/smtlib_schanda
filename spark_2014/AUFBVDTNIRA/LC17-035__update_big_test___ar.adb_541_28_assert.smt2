...
(declare-fun temp___4691 ((Array Int (Array Int et1)) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___4693 (Array Int (Array Int et1))))
  (forall ((temp___4694 Int))
  (forall ((temp___4695 (Array Int et1)))
  (let ((temp___4692 (temp___4691 temp___4693 temp___4694 temp___4695)))
  (forall ((temp___4696 Int))
  (ite (= temp___4696 temp___4694)
  (= (select temp___4692 temp___4696) temp___4695)
  (= (select temp___4692 temp___4696) (select temp___4693 temp___4696)))))))))

(declare-fun temp___4697 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___4699 (Array Int et1)))
  (forall ((temp___4700 Int) (temp___4701 Int))
  (let ((temp___4698 (temp___4697 temp___4699 temp___4700 temp___4701)))
  (forall ((temp___4702 Int))
  (ite (= temp___4702 temp___4700)
  (= (select temp___4698 temp___4702) (of_rep temp___4701))
  (= (select temp___4698 temp___4702) (select temp___4699 temp___4702))))))))
...
;; H
  (assert (= (mk_map__ref1 result) (mk_map__ref1 t)))
...
;; H
  (assert (= (mk_map__ref1 result1) (mk_map__ref1 a)))

;; H
  (assert (= a1 o2))

;; H
  (assert (=> (= j 50) (= result2 j_next)))
...
;; H
  (assert (=> (not (= j 50)) (= result3 j_next)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 334, characters 0-0
  (not
  (= (bool_eq4 a1 5 50 (temp___4691 t1 j (temp___4697 (select t1 j) i e)) 5
     50) true)))
(check-sat)
