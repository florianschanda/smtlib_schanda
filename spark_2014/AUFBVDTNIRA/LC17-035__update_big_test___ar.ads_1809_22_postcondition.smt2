...
;; range_axiom
  (assert
  (forall ((x it4)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)) )))
...
;; range_axiom
  (assert
  (forall ((x et1)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
;; range_axiom
  (assert
  (forall ((x et2)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
;; range_axiom
  (assert
  (forall ((x et3)) (! (in_range4 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
;; range_axiom
  (assert
  (forall ((x enum1ta)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)) )))
...
;; H
  (assert
  (= (rec__ar__rec5t__g5 (us_split_fields5 (select r__split_fields1 i))) 
  o17))

;; H
  (assert
  (= (rec__ar__rec5t__h5 (us_split_fields5 (select r__split_fields1 i))) 
...
;; H
  (assert
  (= o27 (store r__split_fields1 i (mk___rep2
                                   (mk___split_fields2
                                   (mk___rep1
                                   (mk___split_fields1 o20
                                   (mk___rep (mk___split_fields o21 o22))
                                   o23)) o24
                                   (mk___rep (mk___split_fields o25 o26)))))))

;; H
  (assert (= o28 (mk___split_fields3 r__split_fields o27)))

;; H
  (assert (= temp___9434 (mk___rep3 o28)))
...
;; H
  (assert (= r__split_fields2 (us_split_fields7 temp___9434)))

;; H
  (assert (= r__split_fields3 (mk___split_fields__ref3 r__split_fields2)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1799, characters 0-0
  (not (in_range4
  (to_rep3
  (rec__ar__rec2t__f2
  (us_split_fields3
  (rec__ar__rec5t__f5
  (us_split_fields5
  (select (rec__ar__rofaofr2__b2
          (us_split_fields__content3 r__split_fields3)) n)))))))))
(check-sat)
