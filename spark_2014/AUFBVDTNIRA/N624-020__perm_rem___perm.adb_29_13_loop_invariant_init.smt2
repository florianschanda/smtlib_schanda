...
;; H
  ...
  (is_perm (remove a ia) (remove b ib2)) (remove a ia) (remove b ib2))))
...
;; H
  (assert
  (forall ((ib2 Int)) (remove__function_guard (remove o8 ib2) o8 ib2)))
...
;; H
  ...
  (is_perm (remove o9 ia1) (remove o8 ib2)) (remove o9 ia1) (remove o8 ib2))))
...
;; H
  (assert (remove__function_guard (remove b kb) b kb))
...
;; H
  (assert (is_perm__function_guard (is_perm (remove a ia) (remove b kb))
  (remove a ia) (remove b kb)))
