...
(declare-fun temp___180 () (Array Int t))

(declare-fun temp___1801 () t2)
...
;; H
  (assert
  (and (= temp___178 (+ (to_rep (first (rt a))) i)) (in_range1
  (+ (to_rep (first (rt a))) i))))
...
;; H
  (assert (= o2 temp___180))

;; H
  (assert (= (mk1 temp___178 (to_rep (last (rt a)))) temp___1801))
