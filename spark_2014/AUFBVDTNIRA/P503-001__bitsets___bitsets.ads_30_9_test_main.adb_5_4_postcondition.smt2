...
(declare-fun test_main__my_sets__union__result () (Array Int Bool))

(declare-fun result () (Array Int Bool))

(declare-fun test_main__my_sets__union__result1 () (Array Int Bool))

(declare-fun test_main__my_sets__union__result2 () (Array Int Bool))

(declare-fun test_main__my_sets__union__result3 () (Array Int Bool))

(declare-fun test_main__my_sets__union__result4 () (Array Int Bool))

(declare-fun test_main__my_sets__union__result5 () (Array Int Bool))

(declare-fun result1 () (Array Int Bool))

;; H
  (assert
  (= test_main__my_sets__union__result1 test_main__my_sets__union__result2))

;; H
  (assert
  (= test_main__my_sets__union__result3 test_main__my_sets__union__result1))
...
;; H
  (assert
  (= (mk_map__ref test_main__my_sets__union__result4) (mk_map__ref
                                                      test_main__my_sets__union__result2)))

;; H
  (assert
  (= test_main__my_sets__union__result5 test_main__my_sets__union__result3))
