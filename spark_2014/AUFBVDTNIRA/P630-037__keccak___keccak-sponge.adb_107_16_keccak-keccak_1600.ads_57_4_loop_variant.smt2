...
(declare-fun o18 () (Array Int byte))
...
(declare-fun temp___843 () Int)

(declare-fun temp___842 () Int)
...
;; H
  (assert (= result18 (mk___split_fields__ref ctx__split_fields10)))
...
;; H
  (assert (= result19 (mk___split_fields__ref ctx__split_fields11)))
...
;; H
  (assert (= result20 (mk_int__ref offset3)))
...
;; H
  (assert (= result21 (mk_int__ref remaining_bytes3)))

;; H
  (assert (= remaining_bytes4 o25))

;; H
  (assert
  (and (= o26 (- remaining_bits3 initial_bit_rate1)) (in_range2
  (- remaining_bits3 initial_bit_rate1))))

;; H
  (assert (= result22 (mk_int__ref remaining_bits3)))

;; H
  (assert (= remaining_bits4 o26))

;; H
  (assert (<= initial_bit_rate1 remaining_bits4))

(assert
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not
  (or (< remaining_bytes4 temp___8441)
  (and (= remaining_bytes4 temp___8441)
  (or (< remaining_bits4 temp___8431)
  (and (= remaining_bits4 temp___8431) (< temp___8421 offset4)))))))
(check-sat)
