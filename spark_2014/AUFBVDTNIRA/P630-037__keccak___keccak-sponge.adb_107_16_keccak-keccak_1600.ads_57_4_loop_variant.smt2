...
;; H
  (assert (= result15 (mk_int__ref temp___901)))

;; H
  (assert (= temp___9011 remaining_bytes3))

;; H
  (assert (= result16 (mk_int__ref temp___900)))

;; H
  (assert (= temp___9001 remaining_bits3))

;; H
  (assert (= result17 (mk_int__ref temp___899)))

;; H
  (assert (= temp___8991 offset3))
...
;; H
  (assert (= o23 (+ (to_rep1 (first (rt data))) o22)))
...
;; H
  (assert (= o25 (elts data)))

;; H
  (assert (= temp___888 (mk___t6 o25 (mk6 r91s r92s))))
...
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not
  (or (< remaining_bytes4 temp___9011)
  (and (= remaining_bytes4 temp___9011)
  (or (< remaining_bits4 temp___9001)
  (and (= remaining_bits4 temp___9001) (< temp___8991 offset4)))))))
(check-sat)
