...
;; H
  (assert (readmem64__function_guard
  (readmem64 (bvsub rbp ((_ int2bv 64) 32)) memory1)
  (bvsub rbp ((_ int2bv 64) 32)) memory1))
...
;; H
  ...
  (readmem64__function_guard o24 (bvsub rbp ((_ int2bv 64) 32)) memory1))
  (and
  (and
  (and
  (and
...
;; H
  ...
  (readmem64__function_guard o25 (bvsub rbp ((_ int2bv 64) 40)) memory1))
  (and
  (and
  (and
  (and
...
;; H
  (assert
  (and
  (and (= o26 (readmem8 rax5 memory1)) (readmem8__function_guard o26 
  rax5 memory1)) (= o26 (to_rep (select memory1 rax5)))))
