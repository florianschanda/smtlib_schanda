...
;; H
  ...
  (forall ((e Int))
  (=> (and (<= 0 e) (<= e 1))
  (=> (or (not (= j o22)) (not (= e (int__content d9))))
...
;; H
  (assert
  (forall ((j Int) (d18 Int)) (peek__function_guard1
  (peek1
  (mk___rep3
  (mk___split_fields3 t__split_fields
  (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
  t__split_fields3)) j d18)
  (mk___rep3
  (mk___split_fields3 t__split_fields
  (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
  t__split_fields3)) j d18)))
...
;; H
  (assert
  (forall ((j Int) (d18 Int)) (peek__function_guard1
  (peek1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j d18)
  (mk___rep3 (us_split_fields__content3 t__split_fields14)) j d18)))
...
;; H
  (assert
  (=> (not (= (int__content i14) 0))
  (= result25 (rec__tree_model__path_type__k o38))))
...
;; H
  (assert (=> (= result25 true) (= result24 (ite (= o35 o34) true false))))
...
;; H
  ...
  (=> (= result23 true)
  (and
  (and (= result22 (is_add__2 o31 v o32)) (is_add__2__function_guard 
  result22 o31 v o32))
  (= (= result22 true)
  (and
