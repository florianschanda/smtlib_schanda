...
(declare-fun temp___1704 () (Array Int integer))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1707))
  (= temp___1704 n1)))
...
;; H
  ...
  (=> (< index2 temp___1705)
  (= (select n3 temp___1705) (select temp___1704 temp___1705))))))
...
;; H
  (assert
  (and (= temp___1708 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1708)
  (<= temp___1708 (to_rep1 n__last))))

;; H
  (assert (= o9 temp___1708))
...
;; H
  (assert
  (and (= temp___1709 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1709)
  (<= temp___1709 (to_rep1 n__last))))

;; H
  (assert (= o12 temp___1709))
...
;; H
  (assert
  (and (= temp___1710 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1710)
  (<= temp___1710 (to_rep1 n__last))))

;; H
  (assert (= o19 temp___1710))
...
;; H
  (assert
  (and (= temp___1711 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1711)
  (<= temp___1711 (to_rep1 n__last))))

;; H
  (assert (= o26 temp___1711))
...
;; H
  (assert
  (and (= temp___1712 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1712)
  (<= temp___1712 (to_rep1 n__last))))

;; H
  (assert (= o33 temp___1712))
...
;; H
  (assert
  (and (= temp___1713 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1713)
  (<= temp___1713 (to_rep1 n__last))))

;; H
  (assert (= o40 temp___1713))
