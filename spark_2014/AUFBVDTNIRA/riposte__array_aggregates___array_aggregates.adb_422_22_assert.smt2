...
(declare-fun temp___645 (us_rep) (Array Int us_rep))

;; def_axiom
  (assert
  (forall ((temp___647 us_rep))
  (forall ((temp___648 Int))
  (= (select (temp___645 temp___647) temp___648) temp___647))))

(declare-fun temp___649 (Int) (Array Int character))

;; def_axiom
  (assert
  (forall ((temp___651 Int))
  (forall ((temp___652 Int))
  (= (select (temp___649 temp___651) temp___652) (of_rep1 temp___651)))))

(declare-fun temp___653 (Int Int) (Array Int character))

;; def_axiom
  (assert
  (forall ((temp___655 Int) (temp___656 Int))
  (let ((temp___654 (temp___653 temp___655 temp___656)))
  (forall ((temp___657 Int))
  (ite (= temp___657 1)
  (= (select temp___654 temp___657) (of_rep1 temp___655))
  (= (select temp___654 temp___657) (of_rep1 temp___656)))))))
...
;; H
  (assert (= o5 (temp___645 (mk___rep (mk___split_fields o3 o4)))))
...
;; WP_parameter_def
 ;; File "array_aggregates.adb", line 400, characters 0-0
  ...
  (= (bool_eq3 (select x1 n)
     (mk___rep (mk___split_fields (of_rep 0) (temp___653 32 32)))) true)))
(check-sat)
