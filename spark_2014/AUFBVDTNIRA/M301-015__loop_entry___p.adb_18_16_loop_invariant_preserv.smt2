...
;; H
  (assert (=> (and (<= 1 i11) (<= i11 3)) (= (to_rep o3) 1)))

;; H
  (assert
  (=> (and (<= 1 i11) (<= i11 3))
  (= o4 (store (get (select x4 i32) i212 i222) i11 o3))))

;; H
  (assert
  (=> (and (<= 1 i11) (<= i11 3)) (= o5 (set (select x4 i32) i212 i222 o4))))

;; H
  (assert (=> (and (<= 1 i11) (<= i11 3)) (= o6 (store x4 i32 o5))))

;; H
  (assert (=> (and (<= 1 i11) (<= i11 3)) (= x4 result5)))

;; H
  (assert (=> (and (<= 1 i11) (<= i11 3)) (= x5 o6)))
...
;; WP_parameter_def
 ;; File "p.adb", line 1, characters 0-0
  (not
  (= (bool_eq4 (map__content2 x11) (to_rep (first13 (mk4 (+ i32 1) 3)))
     (to_rep (last8 (mk4 (+ i32 1) 3))) x3
     (to_rep (first16 (mk5 (+ i32 1) 3)))
     (to_rep (last10 (mk5 (+ i32 1) 3)))) true)))
(check-sat)
