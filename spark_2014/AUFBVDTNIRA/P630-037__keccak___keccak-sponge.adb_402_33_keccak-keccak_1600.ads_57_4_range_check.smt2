...
;; H
  (assert (= o48 (+ (to_rep digest__first) o47)))
...
;; H
  (assert (= temp___1056 (mk___t7 o49 (mk7 0 r155s))))
...
;; H
  (assert (= temp___1059 temp___1057))
...
;; H
  (assert (= temp___1070 (mk___rep o57)))

;; H
  (assert (= result21 (mk___split_fields__ref ctx__split_fields16)))

;; H
  (assert (= ctx__split_fields17 (us_split_fields1 temp___1070)))
