...
;; H
  ...
  res) (rec__allocator__m__t__allocated (us_split_fields1 (model__ data)))
  res))
...
;; H
  (assert (model____function_guard (model__ data3) data3))
...
;; H
  ...
  (is_add (rec__allocator__m__t__available (us_split_fields1 (model__ data)))
  res (rec__allocator__m__t__available (us_split_fields1 (model__ data3))))
...
;; H
  (assert (is_add__function_guard
  (is_add
  (rec__allocator__m__t__allocated (us_split_fields1 (model__ data3))) 
  res (rec__allocator__m__t__allocated (us_split_fields1 (model__ data))))
  (rec__allocator__m__t__allocated (us_split_fields1 (model__ data3))) 
  res (rec__allocator__m__t__allocated (us_split_fields1 (model__ data)))))
...
;; H
  ...
  (= (is_add
     (rec__allocator__m__t__allocated (us_split_fields1 (model__ data3))) 
     res (rec__allocator__m__t__allocated (us_split_fields1 (model__ data)))) true))))
...
;; H
  (assert (oeq__function_guard2 (oeq2 (model__ data3) (model__ data))
  (model__ data3) (model__ data)))

(assert
;; WP_parameter_def
 ;; File "allocator.adb", line 7, characters 0-0
  (not (= (oeq2 (model__ data3) (model__ data)) true)))
(check-sat)
