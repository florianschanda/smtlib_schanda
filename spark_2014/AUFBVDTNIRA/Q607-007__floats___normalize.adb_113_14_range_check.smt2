...
;; H
  (assert
  (and
  (and (= o (r3 (div1 RNE2 x fliteral5))) (r3__function_guard o
  (div1 RNE2 x fliteral5)))
  (and (in_range3 o)
  (and (= o (roundToIntegral RTN2 (div1 RNE2 x fliteral5)))
  (and (le o (div1 RNE2 x fliteral5)) (le
  (sub RNE2 (div1 RNE2 x fliteral5) fliteral) o))))))
