...
;; H
  (assert (model_is_well_formed__function_guard
  (model_is_well_formed o19 data2 first_available2) o19 data2
  first_available2))
...
;; H
  ...
  (=> (not (= first_available 0))
  (and
  (and (= o19 (model__ data2 first_available2)) (model____function_guard 
  o19 data2 first_available2))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r86b)) (= temp___366 i2))))
