...
(declare-fun temp___566 () (Array Int group2_id))

(declare-fun o17 () group2_id)
...
(declare-fun g16 () int__ref)

(declare-fun unmatched_g1_set__split_fields9 () us_split_fields)

(declare-fun g17 () Int)

(declare-fun proposals_made2 () (Array Int count))

(declare-fun unmatched_g1_set__split_fields10 () us_split_fields)
...
(declare-fun unmatched_g1_set__split_fields11 () us_split_fields)

(declare-fun unmatched_g2_set3 () (Array Int Bool))

(declare-fun result__3 () (Array Int group1_id))

(declare-fun proposals_made4 () map__ref6)

(declare-fun unmatched_g1_set__split_fields12 () us_split_fields__ref)

(declare-fun unmatched_g2_set4 () map__ref7)

(declare-fun result__4 () map__ref)

(declare-fun proposals_made5 () (Array Int count))

(declare-fun unmatched_g1_set__split_fields13 () us_split_fields)

(declare-fun unmatched_g2_set5 () (Array Int Bool))

(declare-fun result__5 () (Array Int group1_id))

(declare-fun proposals_made6 () map__ref6)

(declare-fun unmatched_g1_set__split_fields14 () us_split_fields__ref)

(declare-fun unmatched_g2_set6 () map__ref7)

(declare-fun result__6 () map__ref)

(declare-fun proposals_made7 () (Array Int count))

(declare-fun unmatched_g1_set__split_fields15 () us_split_fields)

(declare-fun unmatched_g2_set7 () (Array Int Bool))

(declare-fun result__7 () (Array Int group1_id))

(declare-fun result8 () map__ref)

(declare-fun stable_marriage__matching__result1 () (Array Int group1_id))

(declare-fun stable_marriage__matching__result2 () map__ref)

(declare-fun stable_marriage__matching__result3 () (Array Int group1_id))

(declare-fun ranking_2_inverted2 () map__ref5)

(declare-fun proposals_made8 () map__ref6)

(declare-fun unmatched_g1_set__split_fields16 () us_split_fields__ref)

(declare-fun unmatched_g2_set8 () map__ref7)

(declare-fun result__8 () map__ref)

(declare-fun g18 () int__ref)

(declare-fun stable_marriage__matching__result4 () map__ref)

(declare-fun ranking_2_inverted3 () (Array Int (Array Int ranking)))

(declare-fun proposals_made9 () (Array Int count))

(declare-fun unmatched_g1_set__split_fields17 () us_split_fields)

(declare-fun unmatched_g2_set9 () (Array Int Bool))

(declare-fun result__9 () (Array Int group1_id))

(declare-fun g19 () Int)

(declare-fun stable_marriage__matching__result5 () (Array Int group1_id))
...
;; H
  ...
  (forall ((g110 Int))
  (=> (and (<= 1 g110) (<= g110 64))
  (= (is_permutation_2 (select ranking_1 g110)) true)))
  (forall ((g21 Int))
  (=> (and (<= 1 g21) (<= g21 64))
...
;; H
  ...
  (= (to_rep3
     (rec__stable_marriage__matching__group1_set__cardinality
     unmatched_g1_set__split_fields3)) (- g13 1))))
...
;; H
  (assert
  (=> (and (<= 1 g12) (<= g12 64))
  (and (=> (<= 1 64) (in_range1 g13)) (and (<= 1 g13) (<= g13 64)))))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8))))
  (= (invariant_holds unmatched_g1_set__split_fields10 proposals_made2
     result__2 unmatched_g2_set2) true)))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       unmatched_g1_set__split_fields10)))))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8))))
  (= (invariant_holds unmatched_g1_set__split_fields11 proposals_made3
     result__3 unmatched_g2_set3) true)))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       unmatched_g1_set__split_fields11))))))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8))))
  (= result__4 (mk_map__ref result__3))))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8))))
  (= unmatched_g2_set4 (mk_map__ref7 unmatched_g2_set3))))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8))))
  (= unmatched_g1_set__split_fields12 (mk___split_fields__ref
                                      unmatched_g1_set__split_fields11))))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8))))
  (= proposals_made4 (mk_map__ref6 proposals_made3))))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8))))
  (= unmatched_g2_set5 unmatched_g2_set3)))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8))))
  (= unmatched_g1_set__split_fields13 unmatched_g1_set__split_fields11)))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8))))
  (= proposals_made5 proposals_made3)))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8))))
  (= unmatched_g2_set6 unmatched_g2_set4)))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8))))
  (= unmatched_g1_set__split_fields14 unmatched_g1_set__split_fields12)))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8))))
  (= proposals_made6 proposals_made4)))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8))))
  (= unmatched_g2_set7 unmatched_g2_set5)))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8))))
  (= unmatched_g1_set__split_fields15 unmatched_g1_set__split_fields13)))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8))))
  (= proposals_made7 proposals_made5)))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8)))))
  (= result__6 (mk_map__ref result__1))))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8)))))
  (= unmatched_g2_set6 (mk_map__ref7 unmatched_g2_set1))))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8)))))
  (= unmatched_g1_set__split_fields14 unmatched_g1_set__split_fields8)))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8)))))
  (= proposals_made6 (mk_map__ref6 proposals_made1))))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8)))))
  (= unmatched_g2_set7 unmatched_g2_set1)))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8)))))
  (= unmatched_g1_set__split_fields15 unmatched_g1_set__split_fields9)))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__stable_marriage__matching__group1_set__cardinality
       (us_split_fields__content unmatched_g1_set__split_fields8)))))
  (= proposals_made7 proposals_made1)))

;; H
  (assert
  (= stable_marriage__matching__result2 (mk_map__ref
                                        stable_marriage__matching__result1)))

;; H
  (assert
  (= stable_marriage__matching__result3 stable_marriage__matching__result1))
...
;; H
  (assert
  (= stable_marriage__matching__result4 stable_marriage__matching__result2))
...
;; H
  (assert
  (= unmatched_g1_set__split_fields16 unmatched_g1_set__split_fields14))
...
;; H
  (assert
  (= stable_marriage__matching__result5 stable_marriage__matching__result3))
...
;; H
  (assert
  (= unmatched_g1_set__split_fields17 unmatched_g1_set__split_fields15))
...
;; H
  ...
  (=> (and (<= 1 g110) (<= g110 64))
  (exists ((g21 Int))
  (and (and (<= 1 g21) (<= g21 64))
  (= (to_rep (select (map__content stable_marriage__matching__result4) g21)) g110)))))))
...
;; H
  ...
  (is_preferred_1__function_guard o19
  ...
  (<= (to_rep2
      (select (invert_1 (select ranking_2 g2)) (to_rep
                                               (select (map__content
                                                       stable_marriage__matching__result4) 
                                               g2)))) (to_rep2
                                                      (select (invert_1
                                                              (select 
                                                              ranking_2 
...
;; H
  ...
  (and
  (and
  (= temp___566 (invert_map
                (map__content stable_marriage__matching__result4)))
  (invert_map__function_guard temp___566
  (map__content stable_marriage__matching__result4)))
  (and
  (forall ((g110 Int))
  (=> (and (<= 1 g110) (<= g110 64))
  (= (to_rep
     (select (map__content stable_marriage__matching__result4) (to_rep1
                                                               (select 
                                                               temp___566 g110)))) g110)))
  (forall ((g21 Int))
  (=> (and (<= 1 g21) (<= g21 64))
  (= (to_rep1
     (select temp___566 (to_rep
                        (select (map__content
                                stable_marriage__matching__result4) g21)))) g21))))))

;; H
  (assert (= o17 (select temp___566 g11)))

;; H
  (assert (= o18 (to_rep1 o17)))

;; H
  (assert (is_permutation_2__function_guard
  (is_permutation_2 (select ranking_1 g11)) (select ranking_1 g11)))

(assert
;; WP_parameter_def
 ;; File "stable_marriage.ads", line 18, characters 0-0
  (not (= (is_permutation_2 (select ranking_1 g11)) true)))
(check-sat)
