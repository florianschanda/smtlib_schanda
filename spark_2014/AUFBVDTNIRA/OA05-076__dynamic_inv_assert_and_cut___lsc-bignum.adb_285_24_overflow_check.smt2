...
;; H
  (assert (and (= o5 (+ a_last 1)) (in_range1 (+ a_last 1))))

;; H
  (assert (= o6 (ite (<= k o5) true false)))

;; H
  (assert (= result1 (ite (<= i2 k) o6 false)))
...
;; H
  (assert
  (and (= o2 (from_word32 carry21)) (from_word32__function_guard o2 carry21)))
...
;; H
  (assert
  (and (= o (from_word32 carry11)) (from_word32__function_guard o carry11)))
