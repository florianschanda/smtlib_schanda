...
(define-fun _t_11 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b10011001100110011001100))
(define-fun _t_12 () Bool (fp.lt _t_9 _t_11))
(define-fun _t_14 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b10011001100110011001100))
