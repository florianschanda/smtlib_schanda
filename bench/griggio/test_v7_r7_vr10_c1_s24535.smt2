...
(define-fun _t_45 () (_ FloatingPoint 8 24) (fp #b1 #b01111011 #b00001110010101100000010))
(define-fun _t_48 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b00111100011010100111111))
...
(define-fun _t_53 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b10010011011101001011110))
...
(define-fun _t_58 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b10101001111110111110011))
...
(define-fun _t_63 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b10111110011101101100011))
(define-fun _t_64 () (_ FloatingPoint 8 24) (fp.mul _t_3 _t_25 _t_63))
(define-fun _t_65 () (_ FloatingPoint 8 24) (fp.add _t_3 _t_60 _t_64))
(define-fun _t_67 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b11011111101111100111011))
...
(define-fun _t_72 () (_ FloatingPoint 8 24) (fp #b1 #b01111100 #b00011110101110000101001))
...
(define-fun _t_76 () (_ FloatingPoint 8 24) (fp #b0 #b01111101 #b01111110111110011101101))
...
(assert _t_79)
(define-fun _t_81 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b01101110100101111000110))
(define-fun _t_83 () (_ FloatingPoint 8 24) (fp #b0 #b01111100 #b00100100110111010011000))
...
(define-fun _t_87 () (_ FloatingPoint 8 24) (fp #b0 #b01111100 #b01101100100010110100001))
...
(define-fun _t_92 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b11011100001010001111010))
...
(define-fun _t_96 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b10011101001011110001100))
...
(define-fun _t_100 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b01011000000100000110001))
...
(define-fun _t_104 () (_ FloatingPoint 8 24) (fp #b0 #b01111100 #b00000100000110001001010))
...
(define-fun _t_109 () (_ FloatingPoint 8 24) (fp #b1 #b01111100 #b01100100010110100001101))
...
(define-fun _t_112 () Bool (fp.leq _t_111 _t_81))
(assert _t_112)
(define-fun _t_115 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b00100001110010101100000))
(define-fun _t_118 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b10011011001000101101000))
...
(define-fun _t_122 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b10100000110001001001110))
...
(define-fun _t_127 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b11011101101100100010110))
...
(define-fun _t_132 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b11010011111101111100110))
...
(define-fun _t_136 () (_ FloatingPoint 8 24) (fp #b0 #b01111101 #b00110100001110010101100))
...
(define-fun _t_140 () (_ FloatingPoint 8 24) (fp #b0 #b01111100 #b10100001110010101100000))
...
(define-fun _t_144 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b01000001100010010011100))
...
(assert _t_147)
(define-fun _t_150 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b10101110000101000111100))
(define-fun _t_152 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b11011001000101101000100))
...
(define-fun _t_157 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b00101001111110111110100))
...
(define-fun _t_162 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b01001000101101000011100))
...
(define-fun _t_166 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b10001001101110100101110))
...
(define-fun _t_171 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b00111101011100001010010))
...
(define-fun _t_175 () (_ FloatingPoint 8 24) (fp #b0 #b01111101 #b10110111010010111100011))
...
(define-fun _t_179 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b10101011000000100000110))
...
(define-fun _t_182 () Bool (fp.leq _t_150 _t_181))
(assert _t_182)
(define-fun _t_185 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b10100010010011011101001))
(define-fun _t_188 () (_ FloatingPoint 8 24) (fp #b1 #b01111010 #b01100000010000011000101))
...
(define-fun _t_193 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b00000000100000110001001))
...
(define-fun _t_198 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b10110010101100000010000))
...
(define-fun _t_201 () (_ FloatingPoint 8 24) (fp.add _t_3 _t_133 _t_200))
(define-fun _t_203 () (_ FloatingPoint 8 24) (fp #b0 #b01111101 #b11011000000100000110000))
...
(define-fun _t_208 () (_ FloatingPoint 8 24) (fp #b1 #b01110111 #b10001001001101110100110))
...
(define-fun _t_212 () (_ FloatingPoint 8 24) (fp #b0 #b01111101 #b01101110100101111000110))
...
(define-fun _t_215 () Bool (fp.leq _t_185 _t_214))
(assert _t_215)
(define-fun _t_218 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b00011001100110011001100))
(define-fun _t_221 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b01001001101110100101110))
...
(define-fun _t_224 () (_ FloatingPoint 8 24) (fp.mul _t_3 _t_17 _t_144))
(define-fun _t_225 () (_ FloatingPoint 8 24) (fp.add _t_3 _t_223 _t_224))
(define-fun _t_226 () (_ FloatingPoint 8 24) (fp.mul _t_3 _t_21 _t_118))
(define-fun _t_227 () (_ FloatingPoint 8 24) (fp.add _t_3 _t_225 _t_226))
(define-fun _t_230 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b11110101110000101001000))
(define-fun _t_231 () (_ FloatingPoint 8 24) (fp.mul _t_3 _t_25 _t_230))
(define-fun _t_232 () (_ FloatingPoint 8 24) (fp.add _t_3 _t_227 _t_231))
(define-fun _t_235 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b10010011011101001011101))
...
(define-fun _t_240 () (_ FloatingPoint 8 24) (fp #b1 #b01111100 #b00101000111101011100001))
...
(define-fun _t_245 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b10010110100001110010110))
(define-fun _t_246 () (_ FloatingPoint 8 24) (fp.mul _t_3 _t_37 _t_245))
(define-fun _t_247 () (_ FloatingPoint 8 24) (fp.add _t_3 _t_242 _t_246))
(define-fun _t_248 () Bool (fp.leq _t_218 _t_247))
(assert _t_248)
(define-fun _t_251 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b00010011011101001011101))
(define-fun _t_254 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b00110110010001011010001))
...
(define-fun _t_258 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b01101100100010110100001))
...
(define-fun _t_263 () (_ FloatingPoint 8 24) (fp #b1 #b01111100 #b11011001000101101000100))
...
(define-fun _t_268 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b11000010100011110101101))
...
(define-fun _t_272 () (_ FloatingPoint 8 24) (fp #b0 #b01111101 #b00101101000011100101010))
...
(define-fun _t_276 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b10010000111001010110000))
...
(define-fun _t_281 () (_ FloatingPoint 8 24) (fp #b1 #b01111011 #b11001110110110010001010))
...
(define-fun _t_284 () Bool (fp.leq _t_283 _t_251))
(assert _t_284)
(check-sat)
(exit)
