...
(define-fun _t_11 () (_ FloatingPoint 8 24) (fp #b0 #b01111111 #b00110011001100110011001))
(define-fun _t_12 () Bool (fp.lt _t_9 _t_11))
(define-fun _t_14 () (_ FloatingPoint 8 24) (fp #b1 #b01111111 #b00110011001100110011001))
...
(define-fun _t_79 () (_ FloatingPoint 11 53) (fp #b0 #b01111111011 #b1001100110011001100110011001100110011001100110011001))
(define-fun _t_80 () Bool (fp.lt _t_77 _t_79))
