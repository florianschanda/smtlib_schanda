...
(define-fun oeq2 ((left us_rep2) (right us_rep2)) Bool (and (= (length1 left) (length1 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
...
(declare-const use_ordered_sets__move_3__cu__assume count_type)
(declare-const temp___813 count_type)
(declare-const temp___8131 us_main_type)
(declare-const temp___812 count_type)
(declare-const o Int)
(declare-const temp___811 count_type)
...
(declare-const s1__split_fields2 us_split_fields__ref)
...
(define-fun s2__split_fields9 () us_split_fields (mk___split_fields s2__split_fields1))
(define-fun s2__split_fields10 () us_split_fields (mk___split_fields s2__split_fields))
(define-fun cu__split_fields11 () us_split_fields2 (mk___split_fields1 cu__split_fields1))
(define-fun temp___8111 () us_rep3 (mk___rep1 (mk___split_fields1 temp___811)))
(define-fun use_ordered_sets__move_3__cu__assume1 () us_rep3 (mk___rep1 (mk___split_fields1 use_ordered_sets__move_3__cu__assume)))
...
(assert (and (= use_ordered_sets__move_3__cu__assume1 (first (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (ite (= (= (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) 0) true) (= (bool_eq3 use_ordered_sets__move_3__cu__assume1 no_element) true) (and (= (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) use_ordered_sets__move_3__cu__assume1) true) (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) use_ordered_sets__move_3__cu__assume1) 1)))))
(assert (= (mk___split_fields__ref1 (mk___split_fields1 result)) (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields))))
(assert (= use_ordered_sets__move_3__cu__assume cu__split_fields1))
(assert (and (= (length (mk___rep s2__split_discrs s2__split_fields10)) 0) (= (is_empty (model__ (mk___rep s2__split_discrs s2__split_fields10))) true)))
(assert (and (= result1 (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields11))) (= (= result1 true) (= (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields11)) true))))
(assert (=> (= result1 true) (and (= (mk___split_discrs temp___813) s2__split_discrs) (= temp___8131 s2__split_fields))))
(assert (=> (= result1 true) (= temp___812 cu__split_fields1)))
(assert (=> (= result1 true) (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields10)) (+ (length (mk___rep s2__split_discrs s2__split_fields9)) 1))))
(assert (=> (= result1 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s2__split_discrs s2__split_fields9)))) (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields9)) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i)) true)))))
(assert (=> (= result1 true) (forall ((e Int)) (=> (and (in_range2 e) (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields9)) e) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (length (mk___rep s2__split_discrs s2__split_fields9)))) (= (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i) e)))))))
(assert (=> (= result1 true) (and (= o (element (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)) (mk___rep1 cu__split_fields10))) (and (in_range6 o) (= o (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields10))))))))
(assert (=> (= result1 true) (and (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) o) true) (ite (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields9)) o) true) (and (and (and (= (oeq1 (model__ (mk___rep s2__split_discrs s2__split_fields9)) (model__ (mk___rep s2__split_discrs s2__split_fields2))) true) (= (oeq3 (positions (mk___rep s2__split_discrs s2__split_fields2)) (positions (mk___rep s2__split_discrs s2__split_fields9))) true)) (= (get (elements (mk___rep s2__split_discrs s2__split_fields2)) (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o)) o)) (= (equal_except (elements (mk___rep s2__split_discrs s2__split_fields9)) (elements (mk___rep s2__split_discrs s2__split_fields2)) (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o)) true)) (and (and (and (and (and (and (= (length (mk___rep s2__split_discrs s2__split_fields2)) (+ (length (mk___rep s2__split_discrs s2__split_fields9)) 1)) (= (ole (model__ (mk___rep s2__split_discrs s2__split_fields9)) (model__ (mk___rep s2__split_discrs s2__split_fields2))) true)) (= (included_except (model__ (mk___rep s2__split_discrs s2__split_fields2)) (model__ (mk___rep s2__split_discrs s2__split_fields9)) o) true)) (= (get (elements (mk___rep s2__split_discrs s2__split_fields2)) (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o)) o)) (= (range_equal (elements (mk___rep s2__split_discrs s2__split_fields9)) (elements (mk___rep s2__split_discrs s2__split_fields2)) 1 (- (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o) 1)) true)) (= (range_shifted (elements (mk___rep s2__split_discrs s2__split_fields9)) (elements (mk___rep s2__split_discrs s2__split_fields2)) (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o) (length (mk___rep s2__split_discrs s2__split_fields9)) 1) true)) (= (p_positions_shifted (positions (mk___rep s2__split_discrs s2__split_fields9)) (positions (mk___rep s2__split_discrs s2__split_fields2)) (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o) 1) true))))))
(assert (=> (= result1 true) (and (= temp___8111 (next (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)) (mk___rep1 cu__split_fields10))) (ite (= (ite (= (bool_eq3 (mk___rep1 cu__split_fields10) no_element) false) (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields10)) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) true) true) (= (bool_eq3 temp___8111 no_element) true) (and (= (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) temp___8111) true) (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) temp___8111) (+ (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields10)) 1)))))))
(assert (=> (= result1 true) (= result2 (mk___split_fields__ref1 cu__split_fields10))))
(assert (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___811))))
(assert (=> (= result1 true) (and (= o1 (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields3))) (= (= o1 true) (= (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields3)) true)))))
(assert (=> (= result1 true) (= result3 (ite (not (= o1 true)) true false))))
(assert (=> (= result1 true) (= result3 true)))
(assert (=> (= result1 true) (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields3))))
(assert (=> (= result1 true) (= s2__split_fields3 (mk___split_fields__ref s2__split_fields2))))
(assert (=> (= result1 true) (= cu__split_fields5 cu__split_fields3)))
(assert (=> (= result1 true) (= s2__split_fields4 s2__split_fields2)))
...
(assert (=> (not (= result1 true)) (= s2__split_fields5 (mk___split_fields__ref s2__split_fields10))))
(assert (=> (not (= result1 true)) (= cu__split_fields7 cu__split_fields11)))
(assert (=> (not (= result1 true)) (= s2__split_fields6 s2__split_fields10)))
(assert (and (= (length (mk___rep s1__split_discrs s1__split_fields1)) 0) (= (is_empty (model__ (mk___rep s1__split_discrs s1__split_fields1))) true)))
(assert (= cu__split_fields8 cu__split_fields6))
(assert (= s2__split_fields7 s2__split_fields5))
(assert (= s1__split_fields2 (mk___split_fields__ref s1__split_fields1)))
(assert (= cu__split_fields9 cu__split_fields7))
(assert (= s2__split_fields8 s2__split_fields6))
(assert (= s1__split_fields3 s1__split_fields1))
(assert (not (= (length (mk___rep s1__split_discrs (us_split_fields__content s1__split_fields2))) 0)))
(check-sat)
(exit)
