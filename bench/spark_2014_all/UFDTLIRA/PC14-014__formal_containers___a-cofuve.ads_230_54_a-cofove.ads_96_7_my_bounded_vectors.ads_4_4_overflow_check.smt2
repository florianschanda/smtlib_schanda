...
(define-fun dynamic_invariant ((temp___expr_184 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool) (temp___do_typ_inv_183 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 2147483647)) (in_range1 temp___expr_184)))
...
(define-fun dynamic_invariant1 ((temp___expr_804 Int) (temp___is_init_800 Bool) (temp___skip_constant_801 Bool) (temp___do_toplevel_802 Bool) (temp___do_typ_inv_803 Bool)) Bool (=> (or (= temp___is_init_800 true) (<= 0 2147483647)) (in_range2 temp___expr_804)))
...
(define-fun dynamic_invariant2 ((temp___expr_790 Int) (temp___is_init_786 Bool) (temp___skip_constant_787 Bool) (temp___do_toplevel_788 Bool) (temp___do_typ_inv_789 Bool)) Bool (=> (or (= temp___is_init_786 true) (<= 1 2147483647)) (in_range4 temp___expr_790)))
...
(define-fun dynamic_invariant3 ((temp___expr_797 Int) (temp___is_init_793 Bool) (temp___skip_constant_794 Bool) (temp___do_toplevel_795 Bool) (temp___do_typ_inv_796 Bool)) Bool (=> (or (= temp___is_init_793 true) (<= 1 2147483647)) (in_range5 temp___expr_797)))
