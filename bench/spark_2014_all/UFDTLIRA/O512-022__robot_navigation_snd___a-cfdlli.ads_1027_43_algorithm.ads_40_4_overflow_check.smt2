...
(define-fun dynamic_invariant ((temp___expr_365 Int) (temp___is_init_361 Bool) (temp___skip_constant_362 Bool) (temp___do_toplevel_363 Bool) (temp___do_typ_inv_364 Bool)) Bool (=> (or (= temp___is_init_361 true) (<= 0 2147483647)) (in_range temp___expr_365)))
...
(define-fun default_initial_assumption ((temp___expr_466 us_rep1) (temp___skip_top_level_467 Bool)) Bool (= (to_rep (rec__algorithm__gap_vectors__cursor__node (us_split_fields3 temp___expr_466))) 0))
...
(define-fun default_initial_assumption1 ((temp___expr_529 us_rep2) (temp___skip_top_level_530 Bool)) Bool (=> (not (= temp___skip_top_level_530 true)) (and (= (is_empty temp___expr_529) true) (= (length1 temp___expr_529) 0))))
(define-fun default_initial_assumption2 ((temp___expr_515 us_rep1) (temp___skip_top_level_516 Bool)) Bool (= (to_rep (rec__algorithm__gap_vectors__cursor__node (us_split_fields3 temp___expr_515))) 0))
...
(define-fun dynamic_invariant1 ((temp___expr_521 Int) (temp___is_init_517 Bool) (temp___skip_constant_518 Bool) (temp___do_toplevel_519 Bool) (temp___do_typ_inv_520 Bool)) Bool (=> (or (= temp___is_init_517 true) (<= 1 2147483647)) (in_range3 temp___expr_521)))
...
(assert (and (= o (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range o) (<= o (to_rep (rec__algorithm__gap_vectors__list__capacity target__split_discrs))))))
(assert (= o1 (- (to_rep (rec__algorithm__gap_vectors__list__capacity target__split_discrs)) o)))
