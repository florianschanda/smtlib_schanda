...
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (forall ((n Int)) (=> (and (<= first3 n) (<= n (last2 (model__ (mk___rep v2__split_discrs v2__split_fields12))))) (= (is_incr (get (model__ v1) n) (get (model__ (mk___rep v2__split_discrs v2__split_fields12)) n)) true)))))
...
(declare-const n Int)
(assert (<= first3 n))
(assert (<= n (last2 (model__ v1))))
(assert (not (= (is_incr (get (model__ v1) n) (get (model__ (mk___rep v2__split_discrs (us_split_fields__content v2__split_fields8))) n)) true)))
(check-sat)
(exit)
