...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (= (to_rep (rec__instances__lists__cursor__node (us_split_fields3 a))) (to_rep (rec__instances__lists__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun default_initial_assumption ((temp___expr_667 us_rep3) (temp___skip_top_level_668 Bool)) Bool (=> (not (= temp___skip_top_level_668 true)) (and (= (is_empty temp___expr_667) true) (= (length2 temp___expr_667) 0))))
(define-fun default_initial_assumption1 ((temp___expr_653 us_rep2) (temp___skip_top_level_654 Bool)) Bool (= (to_rep (rec__instances__lists__cursor__node (us_split_fields3 temp___expr_653))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_645 us_rep1) (temp___skip_top_level_646 Bool)) Bool (=> (not (= temp___skip_top_level_646 true)) (= (length1 temp___expr_645) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_594 Int) (temp___is_init_590 Bool) (temp___skip_constant_591 Bool) (temp___do_toplevel_592 Bool) (temp___do_typ_inv_593 Bool)) Bool (=> (or (= temp___is_init_590 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_594)))
(define-fun default_initial_assumption3 ((temp___expr_608 us_rep2) (temp___skip_top_level_609 Bool)) Bool (= (to_rep (rec__instances__lists__cursor__node (us_split_fields3 temp___expr_608))) 0))
...
(define-fun dynamic_invariant4 ((temp___expr_630 Int) (temp___is_init_626 Bool) (temp___skip_constant_627 Bool) (temp___do_toplevel_628 Bool) (temp___do_typ_inv_629 Bool)) Bool (=> (or (= temp___is_init_626 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_630)))
