...
(assert (<= x3 c))
(assert (=> (< 0 y) (and (= us1 y) (dynamic_property1 1 last1 y))))
(assert (=> (< 0 y) (= o2 y)))
(assert (=> (< 0 y) (= o2 test_dynamic_property__dyn_param__x)))
(assert (=> (< 0 y) (dynamic_property1 1 last1 test_dynamic_property__dyn_param__x1)))
(assert (=> (< 0 y) (and (= us2 test_dynamic_property__dyn_param__x1) (dynamic_property 0 last test_dynamic_property__dyn_param__x1))))
(assert (=> (< 0 y) (= o3 test_dynamic_property__dyn_param__x1)))
(assert (=> (< 0 y) (= (mk_int__ref result2) (mk_int__ref y))))
(assert (=> (< 0 y) (= y2 o3)))
(assert (=> (< 0 y) (<= y2 c)))
(assert (=> (not (< 0 y)) (= y2 y)))
(assert (=> (not (< 0 y)) (= y2 y1)))
(assert (and (= us3 x3) (dynamic_property 0 last x3)))
(assert (= o4 x3))
(assert (= o4 test_dynamic_property__nested__dyn_param__x))
(assert (and (< 0 test_dynamic_property__nested__dyn_param__x1) (dynamic_property 0 last test_dynamic_property__nested__dyn_param__x1)))
(assert (not (dynamic_property1 1 last1 test_dynamic_property__nested__dyn_param__x1)))
(check-sat)
(exit)
