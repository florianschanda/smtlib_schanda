...
(assert (and (= temp___465 (last1 (model__ container))) (and (dynamic_property3 first2 last4 temp___465) (= temp___465 (last1 (model__ container))))))
(assert (not (dynamic_property4 first3 last5 temp___465)))
(check-sat)
(exit)
