...
(define-fun result____split_fields5 () us_split_fields (mk___split_fields result____split_fields1))
...
(assert (= result____split_fields5 amortized_queue__my_vectors__append__2__container__fields3))
...
(assert (and (and (= (length (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2)) (+ (length (mk___rep result____split_discrs result____split_fields5)) 1)) (= (olt (model__ (mk___rep result____split_discrs result____split_fields5)) (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2))) true)) (= (get (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2)) (+ (last (model__ (mk___rep result____split_discrs result____split_fields5))) 1)) o2)))
(assert (= result2 result____split_fields1))
(assert (= (mk___split_fields result____split_fields2) amortized_queue__my_vectors__append__2__container__fields2))
(assert (= (length (mk___rep result____split_discrs result____split_fields4)) (+ 1 idx2)))
(assert (= (get (model__ (mk___rep result____split_discrs result____split_fields4)) 1) left))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i idx2)) (= (get (model__ (mk___rep result____split_discrs result____split_fields4)) (+ 1 i)) (get (model__ right) i)))))
(assert (and (=> (<= r23b r24b) (dynamic_property r23b r24b idx2)) (and (<= r23b idx2) (<= idx2 r24b))))
(assert (not (= idx2 r24b)))
(assert (= idx2 result3))
(assert (= idx3 (+ idx2 1)))
(assert (and (= o3 idx3) (in_range4 idx3)))
(assert (and (= o4 (get (model__ right) o3)) (and (in_range5 o4) (= o4 (get (model__ right) o3)))))
(assert (not (< (length (mk___rep result____split_discrs result____split_fields4)) (capacity (mk___rep result____split_discrs result____split_fields4)))))
(check-sat)
(exit)
