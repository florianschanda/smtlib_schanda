...
(assert (and (= o (positions (mk___rep l__split_discrs l__split_fields2))) (and (not (= (has_key o no_element) true)) (forall ((i us_rep2)) (=> (= (has_key o i) true) (and (and (<= 1 (get1 o i)) (<= (get1 o i) (length (mk___rep l__split_discrs l__split_fields2)))) (forall ((j us_rep2)) (=> (= (has_key o j) true) (=> (= (get1 o i) (get1 o j)) (= (bool_eq2 i j) true))))))))))
...
(assert (and (= o8 (get o6 o7)) (in_range2 o8)))
(assert (and (= o5 n) (in_range3 n)))
(assert (not (<= o5 (last (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
(check-sat)
(exit)
