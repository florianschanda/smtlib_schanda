...
(declare-const use_ordered_maps__my_find__result2 count_type)
(declare-const temp___6721 Int)
(declare-const result2 Int)
(declare-const temp___6722 Int)
(declare-const result3 Bool)
(declare-const result4 cursor__ref)
(declare-const use_ordered_maps__my_find__result3 us_rep2)
...
(declare-const use_ordered_maps__my_find__result5 us_rep2)
...
(declare-const use_ordered_maps__my_find__result7 us_rep2)
(declare-const result7 cursor__ref)
(declare-const use_ordered_maps__my_find__result8 us_rep2)
(declare-const use_ordered_maps__my_find__result9 cursor__ref)
(declare-const use_ordered_maps__my_find__result10 us_rep2)
...
(declare-const use_ordered_maps__my_find__result12 us_rep2)
...
(declare-const use_ordered_maps__my_find__result14 us_rep2)
(declare-const result8 Bool)
(define-fun use_ordered_maps__my_find__result15 () us_rep2 (mk___rep (mk___split_fields use_ordered_maps__my_find__result2)))
...
(define-fun temp___6701 () us_rep2 (mk___rep (mk___split_fields temp___670)))
(define-fun use_ordered_maps__my_find__cu__assume1 () us_rep2 (mk___rep (mk___split_fields use_ordered_maps__my_find__cu__assume)))
(assert (= (mk___rep (mk___split_fields rliteral)) no_element))
(assert (in_range1 k))
(assert (and (= use_ordered_maps__my_find__cu__assume1 (first s)) (ite (= (= (length3 s) 0) true) (= (bool_eq2 use_ordered_maps__my_find__cu__assume1 no_element) true) (and (= (has_key1 (positions s) use_ordered_maps__my_find__cu__assume1) true) (= (get1 (positions s) use_ordered_maps__my_find__cu__assume1) 1)))))
...
(assert (or (and (and (and (= use_ordered_maps__my_find__result11 (mk_cursor__ref use_ordered_maps__my_find__result3)) (= cu__split_fields8 (mk___split_fields__ref cu__split_fields12))) (and (= use_ordered_maps__my_find__result12 use_ordered_maps__my_find__result3) (= cu__split_fields9 cu__split_fields12))) (and (and (= result1 (has_key1 (positions s) (mk___rep cu__split_fields13))) (= (= result1 true) (= (has_key1 (positions s) (mk___rep cu__split_fields13)) true))) (and (= result1 true) (and (= temp___671 cu__split_fields1) (and (= 0 temp___672) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep cu__split_fields12)) 1))) (not (= (get (keys s) i) k)))) (and (= (has_key1 (positions s) (mk___rep cu__split_fields12)) true) (and (and (= temp___6721 result2) (= temp___6722 (get1 (positions s) (mk___rep cu__split_fields12)))) (and (and (and (= o (key s (mk___rep cu__split_fields12))) (and (in_range7 o) (= o (get (keys s) (get1 (positions s) (mk___rep cu__split_fields12)))))) (= result3 (ite (= o k) true false))) (and (= result3 true) (and (= result4 (mk_cursor__ref use_ordered_maps__my_find__result15)) (= use_ordered_maps__my_find__result3 (mk___rep cu__split_fields12))))))))))))) (and (and (and (= result1 (has_key1 (positions s) (mk___rep cu__split_fields13))) (= (= result1 true) (= (has_key1 (positions s) (mk___rep cu__split_fields13)) true))) (ite (= result1 true) (and (and (and (= temp___671 cu__split_fields1) (and (= 0 temp___672) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep cu__split_fields12)) 1))) (not (= (get (keys s) i) k)))) (and (= (has_key1 (positions s) (mk___rep cu__split_fields12)) true) (and (and (= temp___6721 result2) (= temp___6722 (get1 (positions s) (mk___rep cu__split_fields12)))) (and (and (and (and (= o (key s (mk___rep cu__split_fields12))) (and (in_range7 o) (= o (get (keys s) (get1 (positions s) (mk___rep cu__split_fields12)))))) (= result3 (ite (= o k) true false))) (and (not (= result3 true)) (= use_ordered_maps__my_find__result3 use_ordered_maps__my_find__result15))) (and (and (and (= temp___6701 (next s (mk___rep cu__split_fields12))) (ite (= (ite (= (bool_eq2 (mk___rep cu__split_fields12) no_element) false) (= (get1 (positions s) (mk___rep cu__split_fields12)) (length3 s)) true) true) (= (bool_eq2 temp___6701 no_element) true) (and (= (has_key1 (positions s) temp___6701) true) (= (get1 (positions s) temp___6701) (+ (get1 (positions s) (mk___rep cu__split_fields12)) 1))))) (and (= result5 (mk___split_fields__ref cu__split_fields12)) (= cu__split_fields3 (mk___split_fields temp___670)))) (and (and (and (= o1 (has_key1 (positions s) (mk___rep cu__split_fields3))) (= (= o1 true) (= (has_key1 (positions s) (mk___rep cu__split_fields3)) true))) (= result6 (ite (not (= o1 true)) true false))) (= result6 true))))))))) (and (and (= use_ordered_maps__my_find__result4 (mk_cursor__ref use_ordered_maps__my_find__result3)) (= cu__split_fields4 (mk___split_fields__ref cu__split_fields3))) (and (= use_ordered_maps__my_find__result5 use_ordered_maps__my_find__result3) (= cu__split_fields5 cu__split_fields3)))) (and (and (= use_ordered_maps__my_find__result6 use_ordered_maps__my_find__result4) (= cu__split_fields6 cu__split_fields4)) (and (= use_ordered_maps__my_find__result7 use_ordered_maps__my_find__result5) (= cu__split_fields7 cu__split_fields5)))) (and (and (= use_ordered_maps__my_find__result6 (mk_cursor__ref (mk___rep (mk___split_fields use_ordered_maps__my_find__result)))) (= cu__split_fields6 (mk___split_fields__ref cu__split_fields13))) (and (= use_ordered_maps__my_find__result7 (mk___rep (mk___split_fields use_ordered_maps__my_find__result1))) (= cu__split_fields7 cu__split_fields13))))) (and (and (and (= use_ordered_maps__my_find__result11 use_ordered_maps__my_find__result9) (= cu__split_fields8 cu__split_fields6)) (and (= use_ordered_maps__my_find__result12 use_ordered_maps__my_find__result10) (= cu__split_fields9 cu__split_fields7))) (and (and (= use_ordered_maps__my_find__result9 (mk_cursor__ref use_ordered_maps__my_find__result8)) (= use_ordered_maps__my_find__result10 use_ordered_maps__my_find__result8)) (and (= result7 use_ordered_maps__my_find__result6) (= use_ordered_maps__my_find__result8 no_element)))))))
...
(assert (not (= (bool_eq2 (cursor__content use_ordered_maps__my_find__result13) no_element) true)))
