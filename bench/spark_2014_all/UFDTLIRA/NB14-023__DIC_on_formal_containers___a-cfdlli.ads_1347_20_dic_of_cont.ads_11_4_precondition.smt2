...
(define-fun default_initial_assumption ((temp___expr_426 us_rep2) (temp___skip_top_level_427 Bool)) Bool (=> (not (= temp___skip_top_level_427 true)) (and (= (is_empty temp___expr_426) true) (= (length1 temp___expr_426) 0))))
(define-fun default_initial_assumption1 ((temp___expr_412 us_rep1) (temp___skip_top_level_413 Bool)) Bool (= (to_rep (rec__dic_of_cont__my_dlli__cursor__node (us_split_fields3 temp___expr_412))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_367 us_rep1) (temp___skip_top_level_368 Bool)) Bool (= (to_rep (rec__dic_of_cont__my_dlli__cursor__node (us_split_fields3 temp___expr_367))) 0))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep (rec__dic_of_cont__my_dlli__list__capacity (us_split_discrs1 container)))))))
