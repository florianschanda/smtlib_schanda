...
(define-fun use_ordered_sets__move_2__cu__assume1 () us_rep3 (mk___rep1 (mk___split_fields1 use_ordered_sets__move_2__cu__assume)))
...
(assert (and (= use_ordered_sets__move_2__cu__assume1 (first (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (ite (= (= (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) 0) true) (= (bool_eq3 use_ordered_sets__move_2__cu__assume1 no_element) true) (and (= (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) use_ordered_sets__move_2__cu__assume1) true) (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) use_ordered_sets__move_2__cu__assume1) 1)))))
...
(assert (= result1 true))
(assert (= (get1 (positions (mk___rep s1__split_discrs s1__split_fields1)) (mk___rep1 cu__split_fields2)) 1))
...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s2__split_discrs s2__split_fields1)))) (= (get (elements (mk___rep s2__split_discrs s2__split_fields1)) i1) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i1)))))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s1__split_discrs s1__split_fields1)))) (= (get (elements (mk___rep s1__split_discrs s1__split_fields1)) i1) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (+ (length (mk___rep s2__split_discrs s2__split_fields1)) i1))))))
(assert (and (= o (length (mk___rep s2__split_discrs s2__split_fields1))) (and (in_range1 o) (<= o (to_rep (rec__use_ordered_sets__my_sets__set__capacity s2__split_discrs))))))
(assert (= o1 (ite (<= i o) true false)))
(assert (= result2 (ite (<= 1 i) o1 false)))
(assert (= result2 true))
(assert (and (= o3 (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i)) (in_range2 o3)))
(assert (and (= o2 (elements (mk___rep s2__split_discrs s2__split_fields1))) (and (and (and (= (length1 o2) (length (mk___rep s2__split_discrs s2__split_fields1))) (forall ((temp___432 Int)) (=> (and (in_range3 temp___432) (= (iter_has_element o2 temp___432) true)) (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields1)) (get o2 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields1)) item) true)) (and (< 0 (find o2 item)) (= (equivalent_elements (get o2 (find o2 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s2__split_discrs s2__split_fields1)))) (and (= (find o2 (get o2 i1)) i1) (= (e_is_find o2 (get o2 i1) i1) true)))))))
(assert (not (<= i (last o2))))
(check-sat)
(exit)
