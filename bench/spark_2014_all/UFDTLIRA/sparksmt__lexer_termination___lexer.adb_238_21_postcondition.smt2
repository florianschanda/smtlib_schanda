...
(declare-const temp___1047 us_rep1)
(declare-const temp___1049 Int)
(declare-const temp___1046 read_status)
(declare-const temp___10461 character)
(declare-const temp___10462 Bool)
(declare-const temp___1045 Int)
(declare-const temp___1044 Int)
(declare-const temp___1043 Int)
(declare-const temp___1042 read_status)
(declare-const temp___10421 character)
(declare-const temp___10422 Bool)
...
(declare-const temp___10512 Int)
(declare-const result2 int__ref)
(declare-const temp___10502 Int)
...
(assert (=> (= result true) (= temp___1048 next_idx1)))
(assert (=> (= result true) (= temp___1047 the_file1)))
(assert (=> (= result true) (= temp___1049 current_idx1)))
(assert (=> (= result true) (and (= (mk___split_discrs temp___1046) next_read__split_discrs1) (and (= (mk___split_fields temp___10461) next_read__split_fields1) (= temp___10462 next_read__attr__constrained)))))
(assert (=> (= result true) (= temp___1045 current_idx1)))
(assert (=> (= result true) (= temp___1044 current_col1)))
(assert (=> (= result true) (= temp___1043 current_line1)))
(assert (=> (= result true) (and (= (mk___split_discrs temp___1042) current_read__split_discrs1) (and (= (mk___split_fields temp___10421) current_read__split_fields1) (= temp___10422 current_read__attr__constrained)))))
(assert (=> (= result true) (= 0 temp___1051)))
(assert (=> (= result true) (= 0 temp___1050)))
(assert (=> (= result true) (and (= (local_invariant the_file2 current_read__split_fields2 current_read__split_discrs2 current_idx2 next_read__split_fields2 next_read__split_discrs2 next_idx2) true) (<= temp___1049 current_idx2))))
(assert (=> (= result true) (and (and (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1 current_idx2)) (in_range1 next_idx2)) (and (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs2)) 0) (not (= (to_rep (rec__file_io__read_result__c current_read__split_fields2)) 10))))))
(assert (=> (= result true) (= result1 (mk_int__ref temp___10511))))
(assert (=> (= result true) (= temp___10512 next_idx2)))
(assert (=> (= result true) (= result2 (mk_int__ref temp___10501))))
(assert (=> (= result true) (= temp___10502 (ite (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs2)) 0) true false) 1 0))))
(assert (=> (= result true) (and (and (and (and (= (local_invariant the_file3 current_read__split_fields3 current_read__split_discrs3 current_idx3 next_read__split_fields3 next_read__split_discrs3 next_idx3) true) (= (bool_eq (mk___rep current_read__split_discrs3 current_read__split_fields3 current_read__attr__constrained) (mk___rep next_read__split_discrs2 next_read__split_fields2 next_read__attr__constrained)) true)) (= current_idx3 next_idx2)) (<= current_idx2 current_idx3)) (and (and (and (in_range2 current_line3) (in_range1 current_col3)) (in_range1 current_idx3)) (in_range1 next_idx3)))))
(assert (=> (= result true) (=> (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs3)) 0) (= o (ite (not (= (to_rep (rec__file_io__read_result__c current_read__split_fields3)) 10)) true false)))))
...
(assert (=> (not (= result true)) (= current_idx6 (mk_int__ref current_idx1))))
...
(assert (= (to_rep1 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs8))) 0))
(assert (not (< current_idx (int__content current_idx8))))
(check-sat)
(exit)
