...
(assert (and (= o (last2 (model__ (mk___rep v__split_discrs v__split_fields2)))) (and (dynamic_property4 first3 last5 o) (= o (last2 (model__ (mk___rep v__split_discrs v__split_fields2)))))))
(assert (= o1 (ite (<= i o) true false)))
(assert (= result1 (ite (<= current2 i) o1 false)))
(assert (= result1 true))
(assert (not (dynamic_property2 first1 last3 i)))
(check-sat)
(exit)
