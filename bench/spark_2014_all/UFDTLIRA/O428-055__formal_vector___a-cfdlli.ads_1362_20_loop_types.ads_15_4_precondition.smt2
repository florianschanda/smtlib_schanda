...
(define-fun default_initial_assumption ((temp___expr_469 us_rep2) (temp___skip_top_level_470 Bool)) Bool (=> (not (= temp___skip_top_level_470 true)) (and (= (is_empty temp___expr_469) true) (= (length1 temp___expr_469) 0))))
(define-fun default_initial_assumption1 ((temp___expr_455 us_rep1) (temp___skip_top_level_456 Bool)) Bool (= (to_rep (rec__loop_types__lists__cursor__node (us_split_fields3 temp___expr_455))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_410 us_rep1) (temp___skip_top_level_411 Bool)) Bool (= (to_rep (rec__loop_types__lists__cursor__node (us_split_fields3 temp___expr_410))) 0))
