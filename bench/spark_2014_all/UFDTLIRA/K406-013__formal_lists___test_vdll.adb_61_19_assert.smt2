...
(assert (not (= (bool_eq3 (find (mk___rep l1__split_discrs l1__split_fields4) 3 no_element) (next (mk___rep l1__split_discrs l1__split_fields4) (first (mk___rep l1__split_discrs l1__split_fields4)))) true)))
(check-sat)
(exit)
