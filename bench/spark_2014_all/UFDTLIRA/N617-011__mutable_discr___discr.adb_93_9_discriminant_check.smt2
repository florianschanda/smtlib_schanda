...
(declare-const temp___3481 us_main_type)
(declare-const temp___349 natural)
(declare-const temp___3491 us_main_type)
...
(define-fun temp___3462 () us_rep (mk___rep (mk___split_discrs temp___346) (mk___split_fields temp___3461)))
(assert (in_range c))
...
(assert (and (= temp___3462 (new_no_default c)) (= (to_rep temp___346) c)))
(assert (= temp___346 (rec__private_discr__p_no_default__c d__split_discrs)))
(assert (= (mk___rep (mk___split_discrs temp___348) (mk___split_fields temp___3481)) temp___3462))
(assert (= result1 d__split_fields1))
(assert (= temp___3481 d__split_fields2))
(assert (= d__split_discrs (mk___split_discrs temp___348)))
(assert (and (= (mk___rep (mk___split_discrs temp___349) (mk___split_fields temp___3491)) (new_no_default 0)) (= (to_rep temp___349) 0)))
(assert (not (= temp___349 (rec__private_discr__p_no_default__c d__split_discrs))))
(check-sat)
(exit)
