...
(assert (forall ((a us_rep1)) (! (= (= (is_valid a) true) (=> (not (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 a)) true)) (= (bool_eq (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 a)) null_pair) true))) :pattern ((is_valid a)))))
...
(assert (= null_pair (mk___rep (mk___split_fields rliteral rliteral))))
...
(assert (= (mk___split_fields1 dst__split_fields3 (mk___rep (mk___split_fields dst__split_fields4 dst__split_fields5))) (us_split_fields3 src)))
(assert (= dst__split_fields6 dst__split_fields3))
(assert (= dst__split_fields7 dst__split_fields4))
(assert (= dst__split_fields8 dst__split_fields5))
(assert (= dst__split_fields9 dst__split_fields3))
(assert (= dst__split_fields10 dst__split_fields4))
(assert (= dst__split_fields11 dst__split_fields5))
(assert (not (= (bool_eq1 (mk___rep1 (mk___split_fields1 dst__split_fields6 (mk___rep (mk___split_fields dst__split_fields7 dst__split_fields8)))) src) true)))
(check-sat)
(exit)
