...
(define-fun dynamic_invariant1 ((temp___expr_325 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool) (temp___do_typ_inv_324 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= (- 1) 10001)) (in_range2 temp___expr_325)))
...
(define-fun dynamic_invariant2 ((temp___expr_308 Int) (temp___is_init_304 Bool) (temp___skip_constant_305 Bool) (temp___do_toplevel_306 Bool) (temp___do_typ_inv_307 Bool)) Bool (=> (or (= temp___is_init_304 true) (<= 0 10000)) (in_range3 temp___expr_308)))
...
(define-fun dynamic_invariant4 ((temp___expr_277 Int) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool) (temp___do_typ_inv_276 Bool)) Bool (=> (or (= temp___is_init_273 true) (<= 0 6)) (in_range5 temp___expr_277)))
...
(define-fun dynamic_invariant5 ((temp___expr_284 Int) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool) (temp___do_typ_inv_283 Bool)) Bool (=> (or (= temp___is_init_280 true) (<= 0 5)) (in_range6 temp___expr_284)))
...
(define-fun default_initial_assumption ((temp___expr_374 us_rep1) (temp___skip_top_level_375 Bool)) Bool (=> (not (= temp___skip_top_level_375 true)) (= (length1 temp___expr_374) 0)))
...
(define-fun dynamic_invariant6 ((temp___expr_366 Int) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool) (temp___do_typ_inv_365 Bool)) Bool (=> (or (= temp___is_init_362 true) (<= (- 1) 10000)) (in_range7 temp___expr_366)))
