...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= temp___159 i1)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= temp___158 formal)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= 0 temp___160)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (and (= o (+ formal 1)) (in_range1 (+ formal 1)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= (mk_int__ref result1) formal11)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= formal2 o)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (< 0 (+ formal3 (ghost_func Tuple0)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (and (and (in_range1 formal3) (=> (<= 1 2) (in_range2 i2))) (and (<= 1 i2) (<= i2 2)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= temp___1601 result2)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= temp___1602 (+ formal3 (ghost_func Tuple0)))))
...
(assert (=> (not (= (= formal 0) true)) (= formal8 (+ (ghost_func Tuple0) 1))))
(assert (not (= formal8 (+ (ghost_func Tuple0) 1))))
(check-sat)
(exit)
