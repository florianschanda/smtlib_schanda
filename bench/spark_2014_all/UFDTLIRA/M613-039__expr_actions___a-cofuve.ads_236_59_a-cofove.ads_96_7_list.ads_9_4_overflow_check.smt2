...
(define-fun dynamic_invariant ((temp___expr_226 Int) (temp___is_init_222 Bool) (temp___skip_constant_223 Bool) (temp___do_toplevel_224 Bool) (temp___do_typ_inv_225 Bool)) Bool (=> (or (= temp___is_init_222 true) (<= 0 2147483647)) (in_range1 temp___expr_226)))
...
(define-fun dynamic_invariant1 ((temp___expr_334 Int) (temp___is_init_330 Bool) (temp___skip_constant_331 Bool) (temp___do_toplevel_332 Bool) (temp___do_typ_inv_333 Bool)) Bool (=> (or (= temp___is_init_330 true) (<= 0 100)) (in_range2 temp___expr_334)))
...
(define-fun dynamic_invariant2 ((temp___expr_320 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool) (temp___do_typ_inv_319 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 1 100)) (in_range4 temp___expr_320)))
...
(assert (and (= o (length right)) (and (in_range1 o) (<= (+ 0 o) 100))))
(assert (= o1 (+ 0 o)))
