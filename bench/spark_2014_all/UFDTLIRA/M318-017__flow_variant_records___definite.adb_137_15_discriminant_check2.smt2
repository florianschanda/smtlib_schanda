...
(declare-const temp___237 status)
(declare-const temp___2371 natural)
(declare-const temp___2372 natural)
(declare-const temp___2373 Bool)
...
(assert (not (= y1 0)))
(assert (not (= y1 1)))
(assert (= (to_rep x__split_discrs) r38b))
(assert (in_range2 r38b))
(assert (= (to_rep o) 2))
(assert (= o o1))
(assert (= temp___237 o1))
(assert (= rliteral temp___2371))
(assert (= dummy temp___2372))
(assert (= true temp___2373))
(assert (= true temp___2374))
(assert (= x__attr__constrained true))
(assert (not (= temp___237 x__split_discrs)))
(check-sat)
(exit)
