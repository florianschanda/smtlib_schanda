...
(assert (forall ((i barrier_limit)) (and (<= 1 (barrier_limitqtint i)) (<= (barrier_limitqtint i) 2147483647))))
...
(define-fun dynamic_invariant ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= 1 2147483647)) (in_range temp___expr_200)))
