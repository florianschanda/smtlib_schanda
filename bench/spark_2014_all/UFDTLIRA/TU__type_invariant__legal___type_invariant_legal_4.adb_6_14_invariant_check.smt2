...
(assert (and (= o (pub x1)) (in_range1 o)))
(assert (= (mk_int__ref result1) (mk_int__ref tmp)))
(assert (= tmp1 o))
(assert (type_invariant x1))
(assert (and (= o1 (priv x1)) (in_range1 o1)))
(assert (= tmp1 result2))
(assert (= tmp2 o1))
(assert (type_invariant x1))
(assert (and (= o2 (e_pub x1)) (and (in_range1 o2) (= o2 x1))))
(assert (= tmp2 result3))
(assert (= tmp3 o2))
(assert (type_invariant x1))
(assert (and (= o3 (e_priv x1)) (and (in_range1 o3) (= o3 x1))))
(assert (= result4 tmp3))
(assert (= tmp4 o3))
(assert (= tmp5 tmp4))
(assert (= x1 x2))
