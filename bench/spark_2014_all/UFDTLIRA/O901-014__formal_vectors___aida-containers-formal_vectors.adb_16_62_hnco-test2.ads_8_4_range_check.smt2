...
(assert (and (= us (to_rep1 (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 left)))) (in_range1 (to_rep1 (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 left))))))
(assert (not (in_range1 (to_rep1 (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 right))))))
(check-sat)
(exit)
