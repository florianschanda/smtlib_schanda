...
(define-fun default_initial_assumption ((temp___expr_1387 us_rep) (temp___skip_top_level_1388 Bool)) Bool (=> (not (= temp___skip_top_level_1388 true)) (= (is_empty temp___expr_1387) true)))
...
(define-fun element_type__ref___17__projection ((a element_type__ref)) element_type (element_type__content a))
(define-fun dynamic_invariant1 ((temp___expr_1379 Int) (temp___is_init_1375 Bool) (temp___skip_constant_1376 Bool) (temp___do_toplevel_1377 Bool) (temp___do_typ_inv_1378 Bool)) Bool (=> (or (= temp___is_init_1375 true) (<= 0 2147483647)) (in_range3 temp___expr_1379)))
