...
(assert (and (= o1 (positions (mk___rep l__split_discrs l__split_fields2))) (and (not (= (has_key o1 no_element) true)) (forall ((i1 us_rep2)) (=> (= (has_key o1 i1) true) (and (and (<= 1 (get1 o1 i1)) (<= (get1 o1 i1) (length (mk___rep l__split_discrs l__split_fields2)))) (forall ((j us_rep2)) (=> (= (has_key o1 j) true) (=> (= (get1 o1 i1) (get1 o1 j)) (= (bool_eq2 i1 j) true))))))))))
(assert (and (= o2 (get1 o1 (mk___rep1 current__split_fields3))) (and (in_range4 o2) (=> (= (distinct 0 0) true) (and (= o2 (w_get o1 (witness o1 (mk___rep1 current__split_fields3)))) (forall ((k us_rep2)) (=> (= (has_key o1 k) true) (= (= (bool_eq2 k (mk___rep1 current__split_fields3)) true) (= (witness o1 (mk___rep1 current__split_fields3)) (witness o1 k))))))))))
(assert (= o3 (- o2 1)))
