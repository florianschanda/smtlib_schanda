...
(define-fun dynamic_invariant ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 1 2147483647)) (in_range1 temp___expr_353)))
...
(assert (forall ((container us_rep)) (forall ((key Int)) (! (=> (dynamic_invariant key true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range1 k) (= (has_key container k) true)) (= (equivalent_keys k key) true))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(assert (forall ((a us_rep4) (b us_rep4)) (! (= (user_eq9 a b) (oeq1 a b)) :pattern ((user_eq9 a b)))))
(assert true)
...
(assert (forall ((container us_rep4)) (! (let ((result (keys container))) (and (and (and (= (length1 result) (length3 container)) (forall ((temp___442 Int)) (=> (and (in_range3 temp___442) (= (iter_has_element result temp___442) true)) (= (has_key (model__ container) (get result temp___442)) true)))) (forall ((key Int)) (=> (and (in_range1 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (equivalent_keys (get result (find result key)) key) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (and (= (find result (get result i)) i) (= (k_is_find result (get result i) i) true)))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 2147483647)) (in_range4 temp___expr_166)))
(declare-const rliteral count_type)
(assert (= (count_typeqtint rliteral) 0))
(assert (= no_element (mk___rep (mk___split_fields rliteral))))
(assert (forall ((container us_rep4)) (! (let ((result (length3 container))) (and (<= result (to_rep (rec__use_ordered_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant5 result true false true true))) :pattern ((length3 container)))))
(assert (forall ((container us_rep1)) (forall ((key1 Int)) (! (=> (dynamic_invariant4 key1 true true true true) (let ((result (find container key1))) (and (=> (< 0 result) (and (<= result (length1 container)) (= (equivalent_keys key1 (get container result)) true))) (dynamic_invariant5 result true false true true)))) :pattern ((find container key1))))))
...
(assert true)
(assert (forall ((container us_rep)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant key1 true true true true) (= (has_key container key1) true)) (let ((result (witness1 container key1))) (and (= (has_witness container result) true) (dynamic_invariant5 result true false true true)))) :pattern ((witness1 container key1))))))
(assert (forall ((container us_rep)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant5 witness2 true true true true) (= (has_witness container witness2) true)) (dynamic_invariant6 (w_get1 container witness2) true false true true)) :pattern ((w_get1 container witness2))))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key1 us_rep2)) (! (=> (= (has_key1 container key1) true) (let ((result (witness container key1))) (and (= (has_witness1 container result) true) (dynamic_invariant5 result true false true true)))) :pattern ((witness container key1))))))
(assert (forall ((container us_rep3)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant5 witness2 true true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant3 (w_get container witness2) true false true true)) :pattern ((w_get container witness2))))))
...
(define-fun use_ordered_maps__are_disjoint__cu__assume1 () us_rep2 (mk___rep (mk___split_fields use_ordered_maps__are_disjoint__cu__assume)))
(assert (and (= use_ordered_maps__are_disjoint__cu__assume1 (first s1)) (ite (= (= (length3 s1) 0) true) (= (bool_eq2 use_ordered_maps__are_disjoint__cu__assume1 no_element) true) (and (= (has_key1 (positions s1) use_ordered_maps__are_disjoint__cu__assume1) true) (= (get1 (positions s1) use_ordered_maps__are_disjoint__cu__assume1) 1)))))
...
(assert (= result1 true))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s1) (mk___rep cu__split_fields3)) 1))) (not (= (has_key (model__ s2) (get (keys s1) i1)) true)))))
(assert (= (has_key1 (positions s1) (mk___rep cu__split_fields3)) true))
(assert (and (= o (positions s1)) (and (not (= (has_key1 o no_element) true)) (forall ((i1 us_rep2)) (=> (= (has_key1 o i1) true) (and (and (<= 1 (get1 o i1)) (<= (get1 o i1) (length3 s1))) (forall ((j us_rep2)) (=> (= (has_key1 o j) true) (=> (= (get1 o i1) (get1 o j)) (= (bool_eq2 i1 j) true))))))))))
(assert (and (= o1 (get1 o (mk___rep cu__split_fields3))) (and (in_range5 o1) (=> (= (distinct 0 0) true) (and (= o1 (w_get o (witness o (mk___rep cu__split_fields3)))) (forall ((k us_rep2)) (=> (= (has_key1 o k) true) (= (= (bool_eq2 k (mk___rep cu__split_fields3)) true) (= (witness o (mk___rep cu__split_fields3)) (witness o k))))))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result2 (ite (<= 1 i) o3 false)))
(assert (= result2 true))
(assert (and (= o4 (keys s1)) (and (and (and (= (length1 o4) (length3 s1)) (forall ((temp___439 Int)) (=> (and (in_range3 temp___439) (= (iter_has_element o4 temp___439) true)) (= (has_key (model__ s1) (get o4 temp___439)) true)))) (forall ((key1 Int)) (=> (and (in_range1 key1) (= (has_key (model__ s1) key1) true)) (and (< 0 (find o4 key1)) (= (equivalent_keys (get o4 (find o4 key1)) key1) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length3 s1))) (and (= (find o4 (get o4 i1)) i1) (= (k_is_find o4 (get o4 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
