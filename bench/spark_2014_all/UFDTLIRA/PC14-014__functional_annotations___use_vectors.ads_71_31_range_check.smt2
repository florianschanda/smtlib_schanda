...
(assert (= lst4 lst2))
(assert (=> (forall ((i1 Int)) (=> (and (<= first3 i1) (<= i1 (last1 (model__ v)))) (not (= (get (model__ v) i1) e)))) (= use_vectors__my_find__result13 (- first3 1))))
(assert (not (forall ((i1 Int)) (=> (and (<= first3 i1) (<= i1 (last1 (model__ v)))) (not (= (get (model__ v) i1) e))))))
(assert (and (= o8 (last1 (model__ v))) (and (dynamic_property3 first2 last4 o8) (= o8 (last1 (model__ v))))))
(assert (= o9 (ite (<= use_vectors__my_find__result13 o8) true false)))
(assert (= result6 (ite (<= first3 use_vectors__my_find__result13) o9 false)))
(assert (=> (= result6 true) (and (= us1 use_vectors__my_find__result13) (dynamic_property2 first1 last3 use_vectors__my_find__result13))))
(assert (=> (= result6 true) (= o6 use_vectors__my_find__result13)))
(assert (=> (= result6 true) (and (= o7 (get (model__ v) o6)) (and (in_range3 o7) (= o7 (get (model__ v) o6))))))
(assert (=> (= result6 true) (= result5 (ite (= o7 e) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (= result5 true))
(assert (and (= o4 (- use_vectors__my_find__result13 1)) (in_range1 (- use_vectors__my_find__result13 1))))
(assert (= o5 (ite (<= i o4) true false)))
(assert (= result7 (ite (<= first3 i) o5 false)))
(assert (= result7 true))
