...
(declare-const temp___230 node_enum)
(declare-const temp___2301 Bool)
...
(assert (= o4 o2))
(assert (= o5 o3))
(assert (= temp___230 o4))
(assert (= temp___2301 o5))
(assert (= (mk___rep1 (mk___split_fields (mk___rep (mk___split_discrs temp___230) temp___2301))) null_node))
