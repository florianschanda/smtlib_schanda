...
(define-fun dynamic_invariant ((temp___expr_413 Int) (temp___is_init_409 Bool) (temp___skip_constant_410 Bool) (temp___do_toplevel_411 Bool) (temp___do_typ_inv_412 Bool)) Bool (=> (or (= temp___is_init_409 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_413)))
...
(define-fun dynamic_invariant3 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 2147483647)) (in_range temp___expr_249)))
(assert true)
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (distinct 1 0) true) (to_rep (rec__hnco__test2__v_type_owner__vector_type_owner__vector__capacity (us_split_discrs1 container1))) 2147483647))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(declare-fun length (us_rep) Int)
(declare-fun length__function_guard (Int us_rep) Bool)
(assert (forall ((container1 us_rep)) (! (let ((result (length container1))) (and (<= result (capacity container1)) (dynamic_invariant4 result true false true true))) :pattern ((length container1)))))
...
(assert (forall ((container1 us_rep)) (! (= (= (is_empty1 container1) true) (= (length container1) 0)) :pattern ((is_empty1 container1)))))
...
(define-fun dynamic_invariant5 ((temp___expr_445 Int) (temp___is_init_441 Bool) (temp___skip_constant_442 Bool) (temp___do_toplevel_443 Bool) (temp___do_typ_inv_444 Bool)) Bool (=> (or (= temp___is_init_441 true) (<= 0 2147483647)) (in_range6 temp___expr_445)))
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant2 result true false true true))) :pattern ((length1 container1)))))
...
(define-fun dynamic_invariant6 ((temp___expr_438 Int) (temp___is_init_434 Bool) (temp___skip_constant_435 Bool) (temp___do_toplevel_436 Bool) (temp___do_typ_inv_437 Bool)) Bool (=> (or (= temp___is_init_434 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_438)))
(assert (forall ((container1 us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant5 position true true true true) (and (<= 1 position) (<= position (last container1)))) (dynamic_invariant6 (get container1 position) true false true true)) :pattern ((get container1 position))))))
(assert (= (to_rep1 (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 container))) (to_rep (rec__hnco__test2__v_type_owner__vector_type_owner__vector__capacity (us_split_discrs1 (rec__hnco__test2__v_type_owner__vector_type__hidden_vector (us_split_fields3 container)))))))
(assert (not (= (is_empty container) true)))
(assert (not (in_range1 (to_rep1 (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 container))))))
(check-sat)
(exit)
