...
(define-fun indefinite_unbounded__vect__append__2__container__fields2 () us_split_fields (mk___split_fields indefinite_unbounded__vect__append__2__container__fields1))
(define-fun v__split_fields4 () us_split_fields (mk___split_fields v__split_fields2))
(define-fun indefinite_unbounded__vect__append__2__container__fields3 () us_split_fields (mk___split_fields indefinite_unbounded__vect__append__2__container__fields))
...
(assert (= v__split_fields5 indefinite_unbounded__vect__clear__container__fields1))
...
(assert (= v__split_fields4 indefinite_unbounded__vect__append__2__container__fields3))
(assert (and (and (= (length (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields2)) (+ (length (mk___rep v__split_discrs v__split_fields4)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields4)) (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields2))) true)) (= (get (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields2)) (+ (last (model__ (mk___rep v__split_discrs v__split_fields4))) 1)) 2)))
(assert (= result2 v__split_fields2))
(assert (= v__split_fields3 indefinite_unbounded__vect__append__2__container__fields2))
