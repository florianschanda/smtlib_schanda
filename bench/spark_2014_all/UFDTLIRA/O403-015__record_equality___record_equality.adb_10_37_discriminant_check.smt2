...
(assert (not (= 0 (to_rep (rec__record_equality__root__c (us_split_discrs2 (of_base (mk___rep g_pu2__split_discrs (mk___split_fields g_pu2__split_fields5 (hide_ext__1 g_pu2__split_fields4 g_pu2__split_fields6 g_pu2__split_fields7)) g_pu2__attr__tag))))))))
(check-sat)
(exit)
