...
(declare-const temp___1027 count_type)
...
(define-fun temp___10271 () us_rep3 (mk___rep2 (mk___split_fields2 temp___1027)))
...
(assert (and (= temp___10151 (next (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep2 c__split_fields5))) (ite (= (ite (= (bool_eq3 (mk___rep2 c__split_fields5) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields5)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq3 temp___10151 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___10151) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___10151) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields5)) 1))))))
...
(assert (and (= temp___10271 (find1 (mk___rep l__split_discrs l__split_fields9) (mk___rep1 (mk___split_fields1 rliteral2 rliteral2)))) (ite (ite (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields9)) (mk___rep1 (mk___split_fields1 rliteral2 rliteral2))) false) true false) (and (not (= (has_key (positions (mk___rep l__split_discrs l__split_fields9)) temp___10271) true)) (= (bool_eq3 temp___10271 no_element) true)) (and (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields9)) temp___10271) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields9)) temp___10271) (find (keys (mk___rep l__split_discrs l__split_fields9)) (mk___rep1 (mk___split_fields1 rliteral2 rliteral2))))) (= (equivalent_keys (key (mk___rep l__split_discrs l__split_fields9) temp___10271) (mk___rep1 (mk___split_fields1 rliteral2 rliteral2))) true)))))
(assert (= result13 (mk___split_fields__ref2 c__split_fields3)))
(assert (= c__split_fields4 (mk___split_fields2 temp___1027)))
