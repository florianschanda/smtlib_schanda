...
(assert (<= 1 j8))
(assert (<= j8 10))
(assert (= prop__10 true))
(assert (and (=> (<= 1 10) (in_range2 j9)) (and (<= 1 j9) (<= j9 10))))
(assert (= result7 (mk_bool__ref prop__10)))
(assert (= prop__11 (distinct 1 0)))
(assert (not (= j9 10)))
(assert (= result8 (mk_int__ref j9)))
(assert (= j10 (+ j9 1)))
(assert (= j11 (mk_int__ref j10)))
(assert (= prop__12 (mk_bool__ref prop__11)))
(assert (= j12 j10))
(assert (= prop__13 prop__11))
(assert (not (= (bool__content prop__12) true)))
(check-sat)
(exit)
