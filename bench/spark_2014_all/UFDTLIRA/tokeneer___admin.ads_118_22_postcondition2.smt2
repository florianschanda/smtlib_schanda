...
(declare-const o2 privileget)
(declare-const o3 opandnullt)
(declare-const temp___587 privileget)
(declare-const temp___5871 opandnullt)
...
(assert (= o1 o2))
(assert (= o o3))
(assert (= temp___587 o2))
(assert (= temp___5871 o3))
(assert (= result theadmin__split_fields))
(assert (= result1 theadmin__split_fields1))
(assert (= temp___587 theadmin__split_fields2))
(assert (= temp___5871 theadmin__split_fields3))
...
(assert (not (not (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields4 theadmin__split_fields5))) true))))
(check-sat)
(exit)
