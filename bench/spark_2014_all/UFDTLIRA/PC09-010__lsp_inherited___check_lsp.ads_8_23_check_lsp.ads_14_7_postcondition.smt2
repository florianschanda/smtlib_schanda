...
(define-fun default_initial_assumption ((temp___expr_172 us_rep1) (temp___skip_top_level_173 Bool)) Bool (= (attr__tag1 temp___expr_172) us_tag1))
...
(assert (= check_lsp__p_overridden__get_f__2__result1 check_lsp__p_overridden__get_f__2__result2))
(assert (= check_lsp__p_overridden__get_f__2__result3 check_lsp__p_overridden__get_f__2__result1))
(assert (= result check_lsp__p_overridden__get_f__2__result))
(assert (= check_lsp__p_overridden__get_f__2__result1 (to_rep (rec__check_lsp__p_overridden__child__g (us_split_fields3 x)))))
(assert (= (mk_int__ref check_lsp__p_overridden__get_f__2__result4) (mk_int__ref check_lsp__p_overridden__get_f__2__result2)))
(assert (= check_lsp__p_overridden__get_f__2__result5 check_lsp__p_overridden__get_f__2__result3))
(assert (= result1 check_lsp__p_overridden__get_f__2__result4))
(assert (not (= check_lsp__p_overridden__get_f__2__result4 (to_rep (rec__check_lsp__p_overridden__root__f1 (us_split_fields3 x))))))
(check-sat)
(exit)
