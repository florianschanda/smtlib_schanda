...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant result true false true true))) :pattern ((length container)))))
(declare-sort extended_index 0)
(declare-fun extended_indexqtint (extended_index) Int)
(assert (forall ((i extended_index)) (and (<= (- 1) (extended_indexqtint i)) (<= (extended_indexqtint i) 2147483646))))
(define-fun in_range2 ((x Int)) Bool (and (<= (- 1) x) (<= x 2147483646)))
...
(define-fun dynamic_invariant1 ((temp___expr_355 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool) (temp___do_typ_inv_354 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= (- 1) 2147483646)) (in_range2 temp___expr_355)))
...
(declare-fun user_eq3 (tchar_table_indexB tchar_table_indexB) Bool)
(declare-const dummy3 tchar_table_indexB)
...
(define-fun dynamic_invariant2 ((temp___expr_341 Int) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool) (temp___do_typ_inv_340 Bool)) Bool (=> (or (= temp___is_init_337 true) (<= 0 2147483646)) (in_range4 temp___expr_341)))
...
(define-fun dynamic_invariant3 ((temp___expr_348 Int) (temp___is_init_344 Bool) (temp___skip_constant_345 Bool) (temp___do_toplevel_346 Bool) (temp___do_typ_inv_347 Bool)) Bool (=> (or (= temp___is_init_344 true) (<= 0 255)) (in_range5 temp___expr_348)))
...
(assert (forall ((container1 us_rep)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant1 position1 true true true true) (and (<= 0 position1) (<= position1 (last container1)))) (dynamic_invariant3 (get container1 position1) true false true true)) :pattern ((get container1 position1))))))
(declare-const o Int)
...
(assert (and (= o2 (length container)) (and (in_range o2) (<= (+ (- 1) o2) 2147483646))))
(assert (= result (ite (< o2 2147483647) true false)))
(assert (= result true))
(assert (and (= o1 (last container)) (and (in_range2 o1) (= o1 (+ (- 1) (length container))))))
(assert (= result1 (ite (< o1 2147483646) true false)))
(assert (= result1 true))
(assert (and (= o (last container)) (and (in_range2 o) (= o (+ (- 1) (length container))))))
