...
(define-fun dynamic_invariant5 ((temp___expr_466 Int) (temp___is_init_462 Bool) (temp___skip_constant_463 Bool) (temp___do_toplevel_464 Bool) (temp___do_typ_inv_465 Bool)) Bool (=> (or (= temp___is_init_462 true) (<= 0 86399999)) (in_range3 temp___expr_466)))
...
(assert (in_range4 workinghoursstart))
(assert (in_range4 workinghoursend))
(assert (in_range4 maxauthduration))
...
(assert (not (in_range4 (- maxauthduration 1))))
(check-sat)
(exit)
