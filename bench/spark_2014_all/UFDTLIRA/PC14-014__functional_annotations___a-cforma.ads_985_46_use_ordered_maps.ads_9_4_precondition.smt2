...
(define-fun dynamic_invariant1 ((temp___expr_316 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool) (temp___do_typ_inv_315 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= 1 2147483647)) (in_range2 temp___expr_316)))
...
(define-fun dynamic_invariant5 ((temp___expr_389 Int) (temp___is_init_385 Bool) (temp___skip_constant_386 Bool) (temp___do_toplevel_387 Bool) (temp___do_typ_inv_388 Bool)) Bool (=> (or (= temp___is_init_385 true) (<= 1 2147483647)) (in_range6 temp___expr_389)))
...
(assert (and (= o (length container)) (and (in_range1 o) (<= o (to_rep (rec__use_ordered_maps__my_maps__map__capacity (us_split_discrs1 container)))))))
