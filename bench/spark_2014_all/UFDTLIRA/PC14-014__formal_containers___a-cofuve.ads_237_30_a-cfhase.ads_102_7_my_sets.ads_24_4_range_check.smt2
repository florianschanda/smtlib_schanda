...
(define-fun default_initial_assumption ((temp___expr_777 us_rep) (temp___skip_top_level_778 Bool)) Bool (=> (not (= temp___skip_top_level_778 true)) (= (length temp___expr_777) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_769 Int) (temp___is_init_765 Bool) (temp___skip_constant_766 Bool) (temp___do_toplevel_767 Bool) (temp___do_typ_inv_768 Bool)) Bool (=> (or (= temp___is_init_765 true) (<= 0 2147483647)) (in_range4 temp___expr_769)))
...
(define-fun dynamic_invariant2 ((temp___expr_753 Int) (temp___is_init_749 Bool) (temp___skip_constant_750 Bool) (temp___do_toplevel_751 Bool) (temp___do_typ_inv_752 Bool)) Bool (=> (or (= temp___is_init_749 true) (<= 1 2147483647)) (in_range6 temp___expr_753)))
...
(assert (and (= o1 (last left)) (and (in_range4 o1) (= o1 (+ 0 (length left))))))
(assert (= result (ite (<= lst o1) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o (- (- 2147483648) offset)) (in_range5 (- (- 2147483648) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o 1) true false))))
(assert (=> (not (< offset 0)) (= result1 (distinct 1 0))))
(assert (= result1 true))
(assert (<= fst lst))
(assert (not (in_range5 lst)))
(check-sat)
(exit)
