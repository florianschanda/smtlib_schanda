...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (= (to_rep (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields3 a))) (to_rep (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun default_initial_assumption ((temp___expr_423 us_rep3) (temp___skip_top_level_424 Bool)) Bool (=> (not (= temp___skip_top_level_424 true)) (and (= (is_empty temp___expr_423) true) (= (length2 temp___expr_423) 0))))
(define-fun default_initial_assumption1 ((temp___expr_409 us_rep2) (temp___skip_top_level_410 Bool)) Bool (= (to_rep (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields3 temp___expr_409))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_401 us_rep1) (temp___skip_top_level_402 Bool)) Bool (=> (not (= temp___skip_top_level_402 true)) (= (length1 temp___expr_401) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_350 Int) (temp___is_init_346 Bool) (temp___skip_constant_347 Bool) (temp___do_toplevel_348 Bool) (temp___do_typ_inv_349 Bool)) Bool (=> (or (= temp___is_init_346 true) (<= 1 2147483647)) (in_range3 temp___expr_350)))
(define-fun default_initial_assumption3 ((temp___expr_364 us_rep2) (temp___skip_top_level_365 Bool)) Bool (= (to_rep (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields3 temp___expr_364))) 0))
