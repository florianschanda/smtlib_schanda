...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 idx2)) (= (get (model__ (mk___rep result____split_discrs result____split_fields4)) (+ 1 i1)) (get (model__ right) i1)))))
(assert (and (=> (<= r23b r24b) (dynamic_property r23b r24b idx2)) (and (<= r23b idx2) (<= idx2 r24b))))
(assert (<= 1 i))
(assert (<= i idx2))
(assert (and (= o5 i) (in_range4 i)))
(assert (and (= o6 (get (model__ right) o5)) (and (in_range5 o6) (= o6 (get (model__ right) o5)))))
(assert (and (= o3 (+ 1 i)) (in_range1 (+ 1 i))))
