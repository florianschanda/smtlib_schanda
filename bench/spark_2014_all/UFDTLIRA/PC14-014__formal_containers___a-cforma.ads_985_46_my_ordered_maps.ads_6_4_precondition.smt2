...
(assert (forall ((container us_rep)) (! (=> (not (= (is_empty container) true)) (let ((result (first_key container))) (and (and (= result (get (keys container) 1)) (= (k_smaller_than_range (keys container) 2 (length container) result) true)) (dynamic_invariant1 result true false true true)))) :pattern ((first_key container)))))
...
(define-fun k_bigger_than_range ((container1 us_rep1) (fst Int) (lst Int) (key1 Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (< (get container1 i) key1))) true false))
...
(define-fun default_initial_assumption1 ((temp___expr_368 us_rep2) (temp___skip_top_level_369 Bool)) Bool (=> (not (= temp___skip_top_level_369 true)) (and (= (is_empty1 temp___expr_368) true) (= (length2 temp___expr_368) 0))))
(assert true)
...
(assert (forall ((container1 us_rep)) (! (let ((result (keys container1))) (and (and (and (= (length1 result) (length container1)) (forall ((temp___442 Int)) (=> (and (in_range4 temp___442) (= (iter_has_element result temp___442) true)) (= (has_key (model__ container1) (get result temp___442)) true)))) (forall ((key1 Int)) (=> (and (in_range3 key1) (= (has_key (model__ container1) key1) true)) (and (< 0 (find result key1)) (= (equivalent_keys (get result (find result key1)) key1) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get result i)) i) (= (k_is_find result (get result i) i) true)))))) :pattern ((keys container1)))))
...
(define-fun dynamic_invariant2 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 0 2147483647)) (in_range3 temp___expr_353)))
...
(define-fun dynamic_invariant3 ((temp___expr_360 Int) (temp___is_init_356 Bool) (temp___skip_constant_357 Bool) (temp___do_toplevel_358 Bool) (temp___do_typ_inv_359 Bool)) Bool (=> (or (= temp___is_init_356 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_360)))
...
(assert (and (= o (length container)) (and (in_range1 o) (<= o (to_rep (rec__my_ordered_maps__m__map__capacity (us_split_discrs1 container)))))))
