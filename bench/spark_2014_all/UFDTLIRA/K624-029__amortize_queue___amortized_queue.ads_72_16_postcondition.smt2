...
(assert (= (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_discrs result6) (mk___split_fields result7)) (mk___rep (mk___split_discrs result8) (mk___split_fields result9)))) (queue__content amortized_queue__tail__result7)))
(assert (not (= (oeq (model__1 q) (oconcat__3 (model__1 (queue__content amortized_queue__tail__result7)) (last_element (model__1 q)))) true)))
(check-sat)
(exit)
