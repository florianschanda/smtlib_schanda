...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (dynamic_invariant (id_public x) true false true true)) :pattern ((id_public x)))))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (dynamic_invariant (id_private x) true false true true)) :pattern ((id_private x)))))
...
(declare-const ident__test__C8b__assume Int)
...
(assert (= y2 9))
(assert (and (= ident__test__C8b__assume x1) (in_range1 x1)))
(assert (= ident__test__C8b__assume c8b))
(assert (in_range1 c8b))
(assert (= (to_rep o4) (- c8b 1)))
(assert (= o5 (to_rep o4)))
(assert (= result6 y2))
(assert (= y3 o5))
(assert (not (= y3 9)))
