...
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 idx2)) (= (get (model__ (mk___rep result____split_discrs result____split_fields12)) (+ 1 i1)) (get (model__ right) i1))))))
...
(assert (and (= o6 (length right)) (and (in_range2 o6) (<= o6 (capacity right)))))
(assert (= o7 (+ 1 o6)))
(assert (and (= o8 (length (vector__content amortized_queue__Oconcat__2__result5))) (and (in_range2 o8) (<= o8 (capacity (vector__content amortized_queue__Oconcat__2__result5))))))
(assert (= result4 (ite (= o8 o7) true false)))
(assert (= result4 true))
(assert (and (= o5 (get (model__ (vector__content amortized_queue__Oconcat__2__result5)) 1)) (and (in_range5 o5) (= o5 (get (model__ (vector__content amortized_queue__Oconcat__2__result5)) 1)))))
(assert (= result5 (ite (= o5 left) true false)))
(assert (= result5 true))
(assert (and (= o3 (last (model__ right))) (and (in_range3 o3) (= o3 (last (model__ right))))))
(assert (= o4 (ite (<= i o3) true false)))
(assert (= result6 (ite (<= 1 i) o4 false)))
(assert (= result6 true))
(assert (not (in_range4 i)))
(check-sat)
(exit)
