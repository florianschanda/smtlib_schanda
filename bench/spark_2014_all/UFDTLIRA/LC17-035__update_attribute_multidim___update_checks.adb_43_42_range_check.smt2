...
(declare-fun temp_____aggregate_def_276 (map1 Int Int Int Int) map1)
(assert (forall ((temp___278 map1)) (forall ((temp___279 Int) (temp___280 Int) (temp___281 Int) (temp___282 Int)) (let ((temp___277 (temp_____aggregate_def_276 temp___278 temp___279 temp___280 temp___281 temp___282))) (=> (and (and (and (dynamic_invariant temp___279 true true true true) (dynamic_invariant1 temp___280 true true true true)) (dynamic_invariant2 temp___281 true true true true)) (dynamic_invariant3 temp___282 true true true true)) (forall ((temp___283 Int) (temp___284 Int) (temp___285 Int)) (ite (and (and (= temp___283 temp___279) (= temp___284 temp___280)) (= temp___285 temp___281)) (= (to_rep (get temp___277 temp___283 temp___284 temp___285)) temp___282) (= (get temp___277 temp___283 temp___284 temp___285) (get temp___278 temp___283 temp___284 temp___285)))))))))
(declare-const o Int)
(assert (in_range x))
(assert (in_range1 y))
(assert (in_range2 z))
