...
(assert (and (= result6 (is_empty (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields10)))) (and (= (= result6 true) (forall ((item Int)) (not (and (in_range4 item) (= (contains (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields10)) item) true))))) (= (= result6 true) (= (length1 (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields10))) 0)))))
(assert (=> (= result6 true) (and (= o5 (length1 (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields10)))) (in_range1 o5))))
(assert (=> (= result6 true) (= result5 (ite (= o5 0) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (=> (= result5 true) (and (= o4 (length (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields10)))) (and (in_range1 o4) (<= (+ 0 o4) 2147483647)))))
(assert (=> (= result5 true) (= result4 (ite (= o4 10000) true false))))
(assert (=> (not (= result5 true)) (= result4 false)))
(assert (=> (= result4 true) (and (= o3 (get (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields10)) 1)) (in_range2 o3))))
(assert (=> (= result4 true) (= result3 (ite (= o3 1) true false))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (= result3 true))
(assert (<= 1 rr))
(assert (<= rr 10000))
(assert (not (<= rr (last (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields10))))))
(check-sat)
(exit)
