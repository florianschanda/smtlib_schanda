...
(define-fun dynamic_invariant ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 0 100)) (in_range1 temp___expr_158)))
...
(assert (and (= o (get_content r)) (in_range1 o)))
(assert (= o1 (+ o x)))
(assert (= (mk_int__ref result) (mk_int__ref alias__add__result)))
(assert (= alias__add__result1 o1))
(assert (= (mk_int__ref alias__add__result4) (mk_int__ref alias__add__result2)))
