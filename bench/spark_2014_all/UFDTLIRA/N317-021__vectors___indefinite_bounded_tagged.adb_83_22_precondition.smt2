...
(declare-const temp___668 us_rep1)
...
(assert (and (= temp___668 (f 3)) (= temp___668 (mk___rep1 (mk___split_fields1 (of_rep1 3) us_null_ext__) us_tag))))
(assert (not (<= 2 (last (model__ (mk___rep v__split_discrs v__split_fields9))))))
(check-sat)
(exit)
