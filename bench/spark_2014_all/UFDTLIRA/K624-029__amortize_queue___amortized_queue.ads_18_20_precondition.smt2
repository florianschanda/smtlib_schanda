...
(assert (= result6 true))
(assert (and (= o9 i) (in_range6 i)))
(assert (and (= o10 (get (model__ left) o9)) (and (in_range4 o10) (= o10 (get (model__ left) o9)))))
(assert (and (= o8 i) (in_range6 i)))
(assert (not (<= o8 (last (model__ (vector__content amortized_queue__Oconcat__result5))))))
(check-sat)
(exit)
