...
(assert (= o i))
(assert (and (and (and (and (= (length (mk___rep v__split_discrs v__split_fields4)) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))) 1)) (= (range_equal (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (model__ (mk___rep v__split_discrs v__split_fields4)) first2 (- o 1)) true)) (= (get (model__ (mk___rep v__split_discrs v__split_fields4)) o) 0)) (= (range_shifted (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (model__ (mk___rep v__split_discrs v__split_fields4)) o (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))) 1) true)) (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)))))
(assert (and (= us1 i) (dynamic_property4 first3 last5 i)))
(assert (= o1 i))
(assert (and (and (and (and (= (length (mk___rep v__split_discrs v__split_fields3)) (+ (length (mk___rep v__split_discrs v__split_fields4)) 1)) (= (range_equal (model__ (mk___rep v__split_discrs v__split_fields4)) (model__ (mk___rep v__split_discrs v__split_fields3)) first2 (- o1 1)) true)) (= (get (model__ (mk___rep v__split_discrs v__split_fields3)) o1) 0)) (= (range_shifted (model__ (mk___rep v__split_discrs v__split_fields4)) (model__ (mk___rep v__split_discrs v__split_fields3)) o1 (last2 (model__ (mk___rep v__split_discrs v__split_fields4))) 1) true)) (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)))))
