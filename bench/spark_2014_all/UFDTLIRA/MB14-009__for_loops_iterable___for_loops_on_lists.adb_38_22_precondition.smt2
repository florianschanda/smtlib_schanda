...
(assert (= result3 true))
(assert (and (= o10 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (= (length1 o10) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (and (= o11 (get o10 i)) (in_range2 o11)))
(assert (= result4 (ite (< 0 o11) true false)))
(assert (= result4 true))
...
(assert (= o9 (- o8 1)))
(assert (and (= o6 (model__ (mk___rep l__split_discrs l__split_fields1))) (= (length1 o6) (length (mk___rep l__split_discrs l__split_fields1)))))
