...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__p__poT__x Bool)))))
(define-fun us_split_fields_X__projection ((a us_split_fields)) Bool (rec__p__poT__x a))
...
(define-fun dynamic_invariant ((temp___expr_179 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 0 98)) (in_range1 temp___expr_179)))
(define-fun default_initial_assumption ((temp___expr_201 us_rep) (temp___skip_top_level_202 Bool)) Bool (= (rec__p__poT__x (us_split_fields1 temp___expr_201)) (distinct 0 0)))
