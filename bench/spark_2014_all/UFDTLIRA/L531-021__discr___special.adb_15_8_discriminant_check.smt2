...
(assert (forall ((x enum)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= special__t__v__assume o1))
(assert (= rliteral special__t__v__assume1))
(assert (= rliteral1 special__t__v__assume2))
(assert (= true special__t__v__assume3))
(assert (= dummy1 special__t__v__assume4))
...
(assert (= (to_rep (rec__basic__r__x v__split_discrs)) 0))
