...
(define-fun dynamic_invariant1 ((temp___expr_164 us_rep) (temp___is_init_160 Bool) (temp___skip_constant_161 Bool) (temp___do_toplevel_162 Bool) (temp___do_typ_inv_163 Bool)) Bool (=> (not (= temp___skip_constant_161 true)) (in_range1 tmp temp___expr_164)))
(define-fun default_initial_assumption ((temp___expr_166 us_rep) (temp___skip_top_level_167 Bool)) Bool (= (to_rep (rec__p__typ__int (us_split_discrs1 temp___expr_166))) tmp))
