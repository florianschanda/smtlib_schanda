...
(assert (forall ((us_void_param tuple0)) (! (= (query_x1 us_void_param) true) :pattern ((query_x1 us_void_param)))))
(assert (forall ((us_void_param tuple0)) (! (= (= (query_x1 us_void_param) true) (= (rec__pack__t1__x (us_split_fields1 x1)) true)) :pattern ((query_x1 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (let ((result (query_x2 us_void_param))) (and (= result 3) (dynamic_invariant result true false true true))) :pattern ((query_x2 us_void_param)))))
