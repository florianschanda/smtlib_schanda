...
(declare-const temp___6784 et3)
(declare-const temp___67841 et1)
(declare-const temp___67842 et2)
(declare-const temp___67843 enum1ta)
...
(declare-const temp___6787 us_rep1)
...
(assert (= temp___6784 o6))
(assert (= temp___67841 o7))
(assert (= temp___67842 o8))
(assert (= temp___67843 o9))
...
(assert (= r__split_fields4 (mk___split_fields1 temp___6784 (mk___rep (mk___split_fields temp___67841 temp___67842)) temp___67843)))
...
(assert (= temp___6787 (mk___rep1 (mk___split_fields1 o15 (mk___rep (mk___split_fields o16 o17)) o18))))
(assert (= result2 (mk___split_fields__ref1 r__split_fields4)))
(assert (= r__split_fields5 (us_split_fields3 temp___6787)))
