...
(declare-const temp___346 natural)
(declare-const temp___3461 us_main_type)
...
(assert (and (= (mk___rep (mk___split_discrs temp___346) (mk___split_fields temp___3461)) (new_no_default c)) (= (to_rep temp___346) c)))
(assert (not (= temp___346 (rec__private_discr__p_no_default__c d__split_discrs))))
(check-sat)
(exit)
