...
(declare-const temp___365 Bool)
(declare-const temp___3651 unsigned_byte)
(declare-const temp___3652 unsigned_byte)
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___365 o5))
(assert (= temp___3651 o6))
(assert (= temp___3652 o7))
...
(assert (= x__split_fields3 (mk___split_fields1 temp___365 (mk___rep (mk___split_fields temp___3651 temp___3652)))))
...
(assert (= o14 o11))
(assert (= o15 o12))
(assert (= temp___368 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15))))))
(assert (= result2 (mk___split_fields__ref1 x__split_fields3)))
(assert (= x__split_fields4 (us_split_fields3 temp___368)))
