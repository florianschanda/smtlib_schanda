...
(declare-const temp___632 integer)
(declare-const temp___6321 integer)
(declare-const temp___6322 integer)
(declare-const temp___6323 us_private)
(declare-const temp___6324 Int)
...
(assert (= temp___632 o2))
(assert (= temp___6321 o3))
(assert (= temp___6322 o4))
(assert (= temp___6323 o5))
(assert (= arg__attr__tag temp___6324))
...
(assert (= temp___632 arg__split_fields4))
(assert (= temp___6321 arg__split_fields5))
(assert (= temp___6322 arg__split_fields6))
(assert (= temp___6323 arg__split_fields7))
