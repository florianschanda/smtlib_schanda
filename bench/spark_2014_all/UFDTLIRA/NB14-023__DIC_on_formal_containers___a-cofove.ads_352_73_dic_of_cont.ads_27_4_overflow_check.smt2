...
(define-fun dynamic_invariant ((temp___expr_1610 Int) (temp___is_init_1606 Bool) (temp___skip_constant_1607 Bool) (temp___do_toplevel_1608 Bool) (temp___do_typ_inv_1609 Bool)) Bool (=> (or (= temp___is_init_1606 true) (<= 0 2147483647)) (in_range2 temp___expr_1610)))
...
(assert (and (= o2 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range2 o2) (= o2 (ite (= (distinct 1 0) true) (to_rep (rec__dic_of_cont__my_fove__vector__capacity container__split_discrs)) 2147483647)))))
