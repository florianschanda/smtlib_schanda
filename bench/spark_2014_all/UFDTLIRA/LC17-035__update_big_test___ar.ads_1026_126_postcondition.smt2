...
(declare-fun to_rep1 (enum1t) Int)
(declare-fun of_rep1 (Int) enum1t)
(assert (forall ((x enum1t)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x enum1t)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq3 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (bool_eq2 (rec__ar__rec4t__f4 (us_split_fields7 a)) (rec__ar__rec4t__f4 (us_split_fields7 b))) true) (= (to_rep1 (rec__ar__rec4t__g4 (us_split_fields7 a))) (to_rep1 (rec__ar__rec4t__g4 (us_split_fields7 b))))) true false))
...
(define-fun dynamic_invariant4 ((temp___expr_232 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool) (temp___do_typ_inv_231 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 0 6)) (in_range1 temp___expr_232)))
...
(declare-const temp___7140 us_rep3)
...
(assert (= temp___7140 (mk___rep3 o19)))
...
(assert (= r__split_fields6 (us_split_fields7 temp___7140)))
(assert (= r__split_fields7 (mk___split_fields__ref3 r__split_fields6)))
(assert (= r__split_fields8 r__split_fields6))
(assert (not (= (to_rep1 (rec__ar__rec4t__g4 (us_split_fields__content3 r__split_fields7))) (to_rep1 r__split_fields5))))
(check-sat)
(exit)
