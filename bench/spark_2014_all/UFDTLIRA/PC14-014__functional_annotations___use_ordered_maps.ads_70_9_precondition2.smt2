...
(declare-const temp___807 us_rep1)
...
(define-fun temp___8041 () us_rep2 (mk___rep (mk___split_fields temp___804)))
...
(assert (or (and (and (and (= use_ordered_maps__are_disjoint__result11 (mk_bool__ref use_ordered_maps__are_disjoint__result3)) (= cu__split_fields8 (mk___split_fields__ref cu__split_fields13))) (and (= use_ordered_maps__are_disjoint__result12 use_ordered_maps__are_disjoint__result3) (= cu__split_fields9 cu__split_fields13))) (and (and (= result1 (has_key1 (positions s1) (mk___rep cu__split_fields14))) (= (= result1 true) (= (has_key1 (positions s1) (mk___rep cu__split_fields14)) true))) (and (= result1 true) (and (= temp___805 cu__split_fields1) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s1) (mk___rep cu__split_fields13)) 1))) (not (= (has_key (model__ s2) (get (keys s1) i)) true)))) (and (= (has_key1 (positions s1) (mk___rep cu__split_fields13)) true) (and (and (and (= o (key s1 (mk___rep cu__split_fields13))) (and (in_range6 o) (= o (get (keys s1) (get1 (positions s1) (mk___rep cu__split_fields13)))))) (and (= result2 (has_key (model__ s2) o)) (= (= result2 true) (= (has_key (model__ s2) o) true)))) (and (= result2 true) (and (= use_ordered_maps__are_disjoint__result2 result3) (= use_ordered_maps__are_disjoint__result3 (distinct 0 0))))))))))) (and (and (and (= result1 (has_key1 (positions s1) (mk___rep cu__split_fields14))) (= (= result1 true) (= (has_key1 (positions s1) (mk___rep cu__split_fields14)) true))) (ite (= result1 true) (and (and (and (= temp___805 cu__split_fields1) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s1) (mk___rep cu__split_fields13)) 1))) (not (= (has_key (model__ s2) (get (keys s1) i)) true)))) (and (= (has_key1 (positions s1) (mk___rep cu__split_fields13)) true) (and (and (and (and (= o (key s1 (mk___rep cu__split_fields13))) (and (in_range6 o) (= o (get (keys s1) (get1 (positions s1) (mk___rep cu__split_fields13)))))) (and (= result2 (has_key (model__ s2) o)) (= (= result2 true) (= (has_key (model__ s2) o) true)))) (and (not (= result2 true)) (= use_ordered_maps__are_disjoint__result3 use_ordered_maps__are_disjoint__result2))) (and (and (and (= temp___8041 (next s1 (mk___rep cu__split_fields13))) (ite (= (ite (= (bool_eq2 (mk___rep cu__split_fields13) no_element) false) (= (get1 (positions s1) (mk___rep cu__split_fields13)) (length3 s1)) true) true) (= (bool_eq2 temp___8041 no_element) true) (and (= (has_key1 (positions s1) temp___8041) true) (= (get1 (positions s1) temp___8041) (+ (get1 (positions s1) (mk___rep cu__split_fields13)) 1))))) (and (= result4 cu__split_fields2) (= temp___804 cu__split_fields3))) (and (and (and (= o1 (has_key1 (positions s1) (mk___rep cu__split_fields12))) (= (= o1 true) (= (has_key1 (positions s1) (mk___rep cu__split_fields12)) true))) (= result5 (ite (not (= o1 true)) true false))) (= result5 true))))))) (and (and (= use_ordered_maps__are_disjoint__result4 (mk_bool__ref use_ordered_maps__are_disjoint__result3)) (= cu__split_fields4 (mk___split_fields__ref cu__split_fields12))) (and (= use_ordered_maps__are_disjoint__result5 use_ordered_maps__are_disjoint__result3) (= cu__split_fields5 cu__split_fields12)))) (and (and (= use_ordered_maps__are_disjoint__result6 use_ordered_maps__are_disjoint__result4) (= cu__split_fields6 cu__split_fields4)) (and (= use_ordered_maps__are_disjoint__result7 use_ordered_maps__are_disjoint__result5) (= cu__split_fields7 cu__split_fields5)))) (and (and (= use_ordered_maps__are_disjoint__result6 (mk_bool__ref use_ordered_maps__are_disjoint__result)) (= cu__split_fields6 (mk___split_fields__ref cu__split_fields14))) (and (= use_ordered_maps__are_disjoint__result7 use_ordered_maps__are_disjoint__result1) (= cu__split_fields7 cu__split_fields14))))) (and (and (and (= use_ordered_maps__are_disjoint__result11 use_ordered_maps__are_disjoint__result9) (= cu__split_fields8 cu__split_fields6)) (and (= use_ordered_maps__are_disjoint__result12 use_ordered_maps__are_disjoint__result10) (= cu__split_fields9 cu__split_fields7))) (and (and (= use_ordered_maps__are_disjoint__result9 (mk_bool__ref use_ordered_maps__are_disjoint__result8)) (= use_ordered_maps__are_disjoint__result10 use_ordered_maps__are_disjoint__result8)) (and (= result6 use_ordered_maps__are_disjoint__result6) (= use_ordered_maps__are_disjoint__result8 (distinct 1 0))))))))
(assert (= use_ordered_maps__are_disjoint__result13 use_ordered_maps__are_disjoint__result11))
(assert (= cu__split_fields10 cu__split_fields8))
(assert (= use_ordered_maps__are_disjoint__result14 use_ordered_maps__are_disjoint__result12))
(assert (= cu__split_fields11 cu__split_fields9))
(assert (and (= temp___807 (keys s2)) (and (and (and (= (length1 temp___807) (length3 s2)) (forall ((temp___439 Int)) (=> (and (in_range3 temp___439) (= (iter_has_element temp___807 temp___439) true)) (= (has_key (model__ s2) (get temp___807 temp___439)) true)))) (forall ((key1 Int)) (=> (and (in_range1 key1) (= (has_key (model__ s2) key1) true)) (and (< 0 (find temp___807 key1)) (= (equivalent_keys (get temp___807 (find temp___807 key1)) key1) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 s2))) (and (= (find temp___807 (get temp___807 i)) i) (= (k_is_find temp___807 (get temp___807 i) i) true)))))))
(assert (and (= o2 (iter_has_element temp___807 temp___806)) (= (= o2 true) (and (<= 1 temp___806) (<= temp___806 (last temp___807))))))
(assert (= (= o3 true) (in_range3 temp___806)))
(assert (= result7 (ite (= o3 true) o2 false)))
(assert (= result7 true))
(assert (not (<= 1 temp___806)))
(check-sat)
(exit)
