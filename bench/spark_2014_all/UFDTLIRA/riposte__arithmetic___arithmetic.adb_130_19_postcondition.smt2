...
(declare-sort t31b 0)
(declare-fun t31bqtint (t31b) Int)
(assert (forall ((i t31b)) (and (<= 0 (t31bqtint i)) (<= (t31bqtint i) 127))))
(define-fun in_range2 ((x Int)) Bool (and (<= 0 x) (<= x 127)))
(declare-fun attr__ATTRIBUTE_IMAGE2 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Int)
(declare-fun user_eq1 (t31b t31b) Bool)
(declare-const dummy1 t31b)
...
(declare-const r Int)
(declare-const i Int)
(declare-const arithmetic__halve_c__result Int)
...
(declare-const arithmetic__halve_c__result1 Int)
(declare-const arithmetic__halve_c__result2 Int)
(declare-const arithmetic__halve_c__result3 Int)
(declare-const r13 Int)
(declare-const i12 Int)
(declare-const arithmetic__halve_c__result4 int__ref)
(declare-const r14 Int)
(declare-const i13 Int)
(declare-const arithmetic__halve_c__result5 Int)
...
(assert (= i1 0))
(assert (=> (and (<= 0 i1) (<= i1 127)) (= temp___208 r)))
(assert (=> (and (<= 0 i1) (<= i1 127)) (= temp___207 i1)))
(assert (=> (and (<= 0 i1) (<= i1 127)) (= (mk_int__ref result1) r18)))
(assert (=> (and (<= 0 i1) (<= i1 127)) (= r2 i1)))
(assert (=> (and (<= 0 i1) (<= i1 127)) (or (and (and (and (= i1 i6) (= r2 r7)) (and (= i7 i1) (= r8 r2))) (=> (not (= (+ r2 r2) n)) (= (+ (+ r2 r2) 1) n))) (and (not (=> (not (= (+ r2 r2) n)) (= (+ (+ r2 r2) 1) n))) (and (and (and (= i15 (mk_int__ref i4)) (= r17 (mk_int__ref r5))) (and (= i7 i5) (= r8 r6))) (and (and (and (= r3 i2) (< (+ (+ r3 r3) 1) n)) (in_range1 r3)) (and (and (and (=> (<= 0 127) (in_range2 i2)) (=> (<= 0 255) (in_range1 r3))) (and (<= 0 i2) (<= i2 127))) (or (and (and (and (= i2 i4) (= r3 r5)) (and (= i5 i2) (= r6 r3))) (= i2 127)) (and (not (= i2 127)) (and (and (and (= i3 i4) (= r4 r5)) (and (= i5 i3) (= r6 r4))) (and (and (= i2 result2) (= i3 (+ i2 1))) (and (and (= r3 result3) (= r4 i3)) (=> (not (= (+ r4 r4) n)) (= (+ (+ r4 r4) 1) n))))))))))))))
...
(assert (= arithmetic__halve_c__result1 arithmetic__halve_c__result2))
(assert (= arithmetic__halve_c__result3 arithmetic__halve_c__result1))
(assert (= result4 arithmetic__halve_c__result))
(assert (= arithmetic__halve_c__result1 r11))
(assert (= arithmetic__halve_c__result4 (mk_int__ref arithmetic__halve_c__result2)))
(assert (= i12 i10))
(assert (= r13 r11))
(assert (= arithmetic__halve_c__result5 arithmetic__halve_c__result3))
(assert (= i13 i11))
(assert (= r14 r12))
(assert (= result5 (int__content arithmetic__halve_c__result4)))
(assert (not (or (= (+ (int__content arithmetic__halve_c__result4) (int__content arithmetic__halve_c__result4)) n) (= (+ (+ (int__content arithmetic__halve_c__result4) (int__content arithmetic__halve_c__result4)) 1) n))))
(check-sat)
(exit)
