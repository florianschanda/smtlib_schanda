...
(assert (and (= o5 (first l)) (ite (= (= (length2 l) 0) true) (= (bool_eq1 o5 no_element) true) (and (= (has_key (positions l) o5) true) (= (get1 (positions l) o5) 1)))))
...
(assert (and (= o4 (next l cu2)) (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions l) cu2) (length2 l)) true) true) (= (bool_eq1 o4 no_element) true) (and (= (has_key (positions l) o4) true) (= (get1 (positions l) o4) (+ (get1 (positions l) cu2) 1))))))
