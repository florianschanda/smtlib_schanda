...
(assert (= null_optional_pair (mk___rep1 (mk___split_fields1 (distinct 0 0) null_pair))))
...
(assert (= (mk___rep (mk___split_fields rliteral rliteral)) null_pair))
(assert (= (mk___rep1 (mk___split_fields1 (distinct 0 0) null_pair)) null_optional_pair))
...
(assert (= records__is_null_b__result1 (ite (not (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 x)) true)) (bool_eq (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 x)) null_pair) false)))
(assert (= (mk_bool__ref records__is_null_b__result4) (mk_bool__ref records__is_null_b__result2)))
(assert (= records__is_null_b__result5 records__is_null_b__result3))
(assert (= result1 records__is_null_b__result4))
(assert (= (bool_eq1 x null_optional_pair) true))
(assert (not (= records__is_null_b__result4 true)))
(check-sat)
(exit)
