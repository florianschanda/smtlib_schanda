...
(assert (and (= o (- 2147483647 extra_cost)) (in_range (- 2147483647 extra_cost))))
(assert (= result (ite (<= price_of_orange o) true false)))
(assert (= result true))
(assert (not (in_range (+ price_of_orange extra_cost))))
(check-sat)
(exit)
