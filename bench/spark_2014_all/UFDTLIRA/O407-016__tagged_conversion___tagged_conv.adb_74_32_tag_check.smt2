...
(declare-const cc3__attr__tag Int)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const cc4__attr__tag Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(assert (= c (mk___rep (mk___split_fields us_null_ext__) us_tag1)))
(assert (= cc c))
(declare-const cc2__split_fields us_private)
(declare-const cc3__split_fields us_private)
(declare-const result us_private)
(declare-const cc2__split_fields1 us_private)
(declare-const result1 us_private)
(declare-const cc3__split_fields1 us_private)
(define-fun cc2__split_fields2 () us_split_fields (mk___split_fields cc2__split_fields1))
(assert (= c cc))
...
(assert (not (us_compatible_tags cc3__attr__tag us_tag1)))
(check-sat)
(exit)
