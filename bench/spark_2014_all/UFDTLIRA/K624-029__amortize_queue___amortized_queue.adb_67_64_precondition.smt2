...
(assert (and (= o8 (length orear)) (and (in_range2 o8) (<= o8 (capacity orear)))))
(assert (and (= o9 (length ofront)) (and (in_range2 o9) (<= o9 (capacity ofront)))))
(assert (= o10 (+ o9 o8)))
(assert (and (= o11 (length (mk___rep front__split_discrs (us_split_fields__content front__split_fields8)))) (and (in_range2 o11) (<= o11 (capacity (mk___rep front__split_discrs (us_split_fields__content front__split_fields8)))))))
(assert (= result3 (ite (= o11 o10) true false)))
(assert (= result3 true))
(assert (and (= o7 (length (mk___rep rear__split_discrs (us_split_fields__content rear__split_fields2)))) (and (in_range2 o7) (<= o7 (capacity (mk___rep rear__split_discrs (us_split_fields__content rear__split_fields2)))))))
(assert (= result4 (ite (= o7 0) true false)))
(assert (= result4 true))
(assert (and (= o5 (last (model__ ofront))) (and (in_range3 o5) (= o5 (last (model__ ofront))))))
(assert (= o6 (ite (<= i1 o5) true false)))
(assert (= result6 (ite (<= 1 i1) o6 false)))
...
(assert (not (<= o4 (last (model__ orear)))))
(check-sat)
(exit)
