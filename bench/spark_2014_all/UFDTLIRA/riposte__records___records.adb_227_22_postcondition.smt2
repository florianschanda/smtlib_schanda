...
(declare-const temp___356 Bool)
(declare-const temp___3561 unsigned_byte)
(declare-const temp___3562 unsigned_byte)
...
(assert (=> (= x__split_fields true) (= (to_rep o) (to_rep x__split_fields2))))
...
(assert (=> (= x__split_fields true) (= temp___356 o5)))
(assert (=> (= x__split_fields true) (= temp___3561 o6)))
(assert (=> (= x__split_fields true) (= temp___3562 o7)))
(assert (=> (= x__split_fields true) (= result1 (mk___split_fields__ref1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields x__split_fields1 x__split_fields2)))))))
(assert (=> (= x__split_fields true) (= x__split_fields4 (mk___split_fields1 temp___356 (mk___rep (mk___split_fields temp___3561 temp___3562))))))
(assert (=> (= x__split_fields true) (= (to_rep o8) tmp2)))
(assert (=> (= x__split_fields true) (= (rec__records_prooffuncs__pair__a (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair x__split_fields4))) o9)))
(assert (=> (= x__split_fields true) (= o8 o10)))
(assert (=> (= x__split_fields true) (= o11 o9)))
(assert (=> (= x__split_fields true) (= o12 o10)))
(assert (=> (= x__split_fields true) (= (rec__records_prooffuncs__optional_pair__exists x__split_fields4) o13)))
(assert (=> (= x__split_fields true) (= o14 o11)))
(assert (=> (= x__split_fields true) (= o15 o12)))
(assert (=> (= x__split_fields true) (= temp___359 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)))))))
(assert (=> (= x__split_fields true) (= result2 (mk___split_fields__ref1 x__split_fields4))))
(assert (=> (= x__split_fields true) (= x__split_fields5 (us_split_fields3 temp___359))))
(assert (=> (not (= x__split_fields true)) (= tmp2 tmp)))
(assert (=> (not (= x__split_fields true)) (= x__split_fields5 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields x__split_fields1 x__split_fields2))))))
(assert (=> (not (= x__split_fields true)) (= tmp2 tmp1)))
(assert (=> (not (= x__split_fields true)) (= x__split_fields5 x__split_fields3)))
...
(assert (not (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields__content1 x__split_fields6)) true)))
(check-sat)
(exit)
