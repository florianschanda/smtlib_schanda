...
(assert true)
(define-fun default_initial_assumption1 ((temp___expr_235 us_rep2) (temp___skip_top_level_236 Bool)) Bool (= (to_rep (rec__use_lists__my_lists__cursor__node (us_split_fields3 temp___expr_235))) 0))
...
(define-fun default_initial_assumption3 ((temp___expr_280 us_rep2) (temp___skip_top_level_281 Bool)) Bool (= (to_rep (rec__use_lists__my_lists__cursor__node (us_split_fields3 temp___expr_280))) 0))
...
(assert (and (= temp___604 (model__ l)) (= (length temp___604) (length1 l))))
(assert (and (= o (iter_has_element temp___604 temp___603)) (= (= o true) (and (<= 1 temp___603) (<= temp___603 (last temp___604))))))
(assert (= (= o1 true) (in_range2 temp___603)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (<= 1 temp___603)))
(check-sat)
(exit)
