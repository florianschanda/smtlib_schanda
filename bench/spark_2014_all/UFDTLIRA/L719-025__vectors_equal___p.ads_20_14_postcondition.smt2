...
(define-fun dynamic_invariant3 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 1 100)) (in_range5 temp___expr_214)))
...
(define-fun dynamic_invariant4 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 1 100)) (in_range6 temp___expr_221)))
...
(define-fun dynamic_invariant6 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 100)) (in_range1 temp___expr_249)))
...
(assert (forall ((i1 element_type2)) (and (<= 1 (element_typeqtint2 i1)) (<= (element_typeqtint2 i1) 100))))
...
(assert (forall ((container us_rep)) (forall ((position Int)) (! (=> (and (dynamic_invariant7 position true true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant8 (get container position) true false true true)) :pattern ((get container position))))))
...
(assert (and (= o (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (and (in_range4 o) (= o (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)))))
(assert (= (mk_int__ref result) (mk_int__ref e)))
(assert (= e1 o))
(assert (in_range5 e1))
(assert (and (= (length1 (mk___rep l__split_discrs l__split_fields6)) (- (length1 (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1)) (= (olt (model__ (mk___rep l__split_discrs l__split_fields6)) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)))
(assert (and (and (= (length1 (mk___rep l__split_discrs l__split_fields5)) (+ (length1 (mk___rep l__split_discrs l__split_fields6)) 1)) (= (olt (model__ (mk___rep l__split_discrs l__split_fields6)) (model__ (mk___rep l__split_discrs l__split_fields5))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields5)) (+ (last (model__ (mk___rep l__split_discrs l__split_fields6))) 1)) e1)))
(assert (= e1 e2))
