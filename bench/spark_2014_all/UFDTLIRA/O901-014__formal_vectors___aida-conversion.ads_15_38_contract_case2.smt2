...
(assert (=> (= (= source 50) true) (= aida__conversion__convert_character_digit_to_integer__result4 2)))
(assert (=> (= (= source 51) true) (= aida__conversion__convert_character_digit_to_integer__result4 3)))
(assert (=> (= (= source 52) true) (= aida__conversion__convert_character_digit_to_integer__result4 4)))
(assert (=> (= (= source 53) true) (= aida__conversion__convert_character_digit_to_integer__result4 5)))
(assert (= (= source 54) true))
(assert (not (= aida__conversion__convert_character_digit_to_integer__result4 6)))
(check-sat)
(exit)
