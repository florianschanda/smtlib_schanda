...
(assert (forall ((n Int)) (=> (and (<= first3 n) (<= n (last2 (model__ (mk___rep v2__split_discrs v2__split_fields2))))) (= (is_incr (get (model__ v1) n) (get (model__ (mk___rep v2__split_discrs v2__split_fields2)) n)) true))))
...
(assert (and (= us i2) (dynamic_property2 first1 last3 i2)))
(assert (= o1 i2))
(assert (and (= o2 (get (model__ v1) o1)) (and (in_range3 o2) (= o2 (get (model__ v1) o1)))))
(assert (= result2 (ite (< o2 2147483647) true false)))
(assert (= result2 true))
(assert (not (dynamic_property2 first1 last3 i2)))
(check-sat)
(exit)
