...
(define-fun to_rep4 ((x et3)) Int (et3qtint x))
...
(declare-const temp___7284 et3)
(declare-const temp___72841 et1)
(declare-const temp___72842 et2)
(declare-const temp___72843 enum1ta)
(declare-const temp___72844 et4)
(declare-const temp___72845 enum1t)
...
(declare-const temp___7288 us_rep3)
...
(assert (and (= o (to_rep r__split_fields5)) (in_range5 (to_rep r__split_fields5))))
...
(assert (= o1 o7))
(assert (= temp___7284 o2))
(assert (= temp___72841 o3))
(assert (= temp___72842 o4))
(assert (= temp___72843 o5))
(assert (= temp___72844 o6))
(assert (= temp___72845 o7))
...
(assert (= r__split_fields6 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 temp___7284 (mk___rep (mk___split_fields temp___72841 temp___72842)) temp___72843)) temp___72844)) temp___72845)))
...
(assert (= temp___7288 (mk___rep3 o13)))
(assert (= result2 (mk___split_fields__ref3 r__split_fields6)))
(assert (= r__split_fields7 (us_split_fields7 temp___7288)))
