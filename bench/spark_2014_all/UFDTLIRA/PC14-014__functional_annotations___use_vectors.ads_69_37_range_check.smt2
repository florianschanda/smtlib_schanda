...
(assert (and (= o4 (last1 (model__ v))) (and (dynamic_property3 first2 last4 o4) (= o4 (last1 (model__ v))))))
(assert (= o5 (ite (<= use_vectors__my_find__result13 o4) true false)))
(assert (= result5 (ite (<= first3 use_vectors__my_find__result13) o5 false)))
(assert (= result5 true))
(assert (not (dynamic_property2 first1 last3 use_vectors__my_find__result13)))
(check-sat)
(exit)
