...
(declare-const records__init_c__result unsigned_byte)
(declare-const records__init_c__result1 unsigned_byte)
...
(declare-const records__init_c__result2 unsigned_byte)
(declare-const records__init_c__result3 unsigned_byte)
(declare-const records__init_c__result4 unsigned_byte)
(declare-const records__init_c__result5 unsigned_byte)
(declare-const records__init_c__result6 unsigned_byte)
(declare-const records__init_c__result7 unsigned_byte)
(declare-const r__split_fields4 unsigned_byte)
(declare-const r__split_fields5 unsigned_byte)
(declare-const records__init_c__result8 unsigned_byte)
(declare-const records__init_c__result9 unsigned_byte)
(declare-const r__split_fields6 us_split_fields)
(declare-const records__init_c__result10 us_rep)
(define-fun records__init_c__result11 () us_rep (mk___rep (mk___split_fields records__init_c__result6 records__init_c__result7)))
...
(assert (= records__init_c__result5 records__init_c__result3))
(assert (= records__init_c__result11 (mk___rep (mk___split_fields records__init_c__result2 records__init_c__result3))))
(assert (= result2 records__init_c__result))
(assert (= result3 records__init_c__result1))
(assert (= records__init_c__result2 r__split_fields2))
(assert (= records__init_c__result3 r__split_fields3))
(assert (= (mk_pair__ref (mk___rep (mk___split_fields records__init_c__result8 records__init_c__result9))) (mk_pair__ref (mk___rep (mk___split_fields records__init_c__result4 records__init_c__result5)))))
(assert (= r__split_fields4 r__split_fields2))
(assert (= r__split_fields5 r__split_fields3))
(assert (= records__init_c__result10 records__init_c__result11))
(assert (= r__split_fields6 (mk___split_fields r__split_fields2 r__split_fields3)))
(assert (= result4 records__init_c__result8))
(assert (= result5 records__init_c__result9))
(assert (not (= (bool_eq (mk___rep (mk___split_fields records__init_c__result8 records__init_c__result9)) null_pair) true)))
(check-sat)
(exit)
