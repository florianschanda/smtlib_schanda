...
(assert (not (or (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 current__split_fields3)) true) (= (bool_eq2 (mk___rep1 current__split_fields3) no_element) true))))
(check-sat)
(exit)
