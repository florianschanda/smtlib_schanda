...
(define-fun dynamic_invariant1 ((temp___expr_491 Int) (temp___is_init_487 Bool) (temp___skip_constant_488 Bool) (temp___do_toplevel_489 Bool) (temp___do_typ_inv_490 Bool)) Bool (=> (or (= temp___is_init_487 true) (<= 0 2147483647)) (in_range2 temp___expr_491)))
...
(define-fun dynamic_invariant2 ((temp___expr_474 Int) (temp___is_init_470 Bool) (temp___skip_constant_471 Bool) (temp___do_toplevel_472 Bool) (temp___do_typ_inv_473 Bool)) Bool (=> (or (= temp___is_init_470 true) (<= 1 2147483647)) (in_range3 temp___expr_474)))
