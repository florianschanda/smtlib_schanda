...
(declare-const records__is_null_a__result Bool)
(declare-const result Bool)
(declare-const records__is_null_a__result1 Bool)
(declare-const records__is_null_a__result2 Bool)
(declare-const records__is_null_a__result3 Bool)
(declare-const records__is_null_a__result4 Bool)
(declare-const records__is_null_a__result5 Bool)
(declare-const result1 Bool)
(assert (= (mk___rep1 (mk___split_fields1 (distinct 0 0) null_pair)) null_optional_pair))
(assert (= records__is_null_a__result1 records__is_null_a__result2))
(assert (= records__is_null_a__result3 records__is_null_a__result1))
(assert (= result records__is_null_a__result))
(assert (= records__is_null_a__result1 (bool_eq1 x null_optional_pair)))
(assert (= (mk_bool__ref records__is_null_a__result4) (mk_bool__ref records__is_null_a__result2)))
(assert (= records__is_null_a__result5 records__is_null_a__result3))
(assert (= result1 records__is_null_a__result4))
(assert (= records__is_null_a__result4 true))
(assert (not (= (bool_eq1 x null_optional_pair) true)))
(check-sat)
(exit)
