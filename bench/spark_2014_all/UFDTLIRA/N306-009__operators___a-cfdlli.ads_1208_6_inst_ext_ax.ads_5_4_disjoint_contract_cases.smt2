...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__inst_ext_ax__ok_lists1__list__capacity count_type)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) count_type (rec__inst_ext_ax__ok_lists1__list__capacity a))
(declare-datatypes () ((us_split_discrs__ref (mk___split_discrs__ref (us_split_discrs__content us_split_discrs)))))
(define-fun us_split_discrs__ref___projection ((a us_split_discrs__ref)) us_split_discrs (us_split_discrs__content a))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__inst_ext_ax__ok_lists1__list us_main_type)))))
(define-fun us_split_fields_List__projection ((a us_split_fields)) us_main_type (rec__inst_ext_ax__ok_lists1__list a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_discrs1 us_split_discrs) (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_discrs (us_split_discrs1 a))
(define-fun us_rep___2__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__inst_ext_ax__ok_lists1__list__capacity (us_split_discrs1 a))) (to_rep (rec__inst_ext_ax__ok_lists1__list__capacity (us_split_discrs1 b)))) (= (us_main_eq (rec__inst_ext_ax__ok_lists1__list (us_split_fields1 a)) (rec__inst_ext_ax__ok_lists1__list (us_split_fields1 b))) true)) true false))
...
(declare-const inst_ext_ax__ok_lists1__list__capacity__first__bit Int)
(declare-const inst_ext_ax__ok_lists1__list__capacity__last__bit Int)
(declare-const inst_ext_ax__ok_lists1__list__capacity__position Int)
(assert (<= 0 inst_ext_ax__ok_lists1__list__capacity__first__bit))
(assert (< inst_ext_ax__ok_lists1__list__capacity__first__bit inst_ext_ax__ok_lists1__list__capacity__last__bit))
(assert (<= 0 inst_ext_ax__ok_lists1__list__capacity__position))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__inst_ext_ax__ok_lists1__cursor__node count_type)))))
(define-fun us_split_fields_Node__projection ((a us_split_fields2)) count_type (rec__inst_ext_ax__ok_lists1__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__inst_ext_ax__ok_lists1__cursor__node (us_split_fields3 a))) (to_rep (rec__inst_ext_ax__ok_lists1__cursor__node (us_split_fields3 b)))) true false))
...
(declare-const inst_ext_ax__ok_lists1__cursor__node__first__bit Int)
(declare-const inst_ext_ax__ok_lists1__cursor__node__last__bit Int)
(declare-const inst_ext_ax__ok_lists1__cursor__node__position Int)
(assert (<= 0 inst_ext_ax__ok_lists1__cursor__node__first__bit))
(assert (< inst_ext_ax__ok_lists1__cursor__node__first__bit inst_ext_ax__ok_lists1__cursor__node__last__bit))
(assert (<= 0 inst_ext_ax__ok_lists1__cursor__node__position))
...
(define-fun default_initial_assumption ((temp___expr_228 us_rep1) (temp___skip_top_level_229 Bool)) Bool (= (to_rep (rec__inst_ext_ax__ok_lists1__cursor__node (us_split_fields3 temp___expr_228))) 0))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__inst_ext_ax__ok_lists1__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_273 us_rep1) (temp___skip_top_level_274 Bool)) Bool (= (to_rep (rec__inst_ext_ax__ok_lists1__cursor__node (us_split_fields3 temp___expr_273))) 0))
...
(assert (and (or (= (has_key (positions (mk___rep container__split_discrs (mk___split_fields container__split_fields))) before) true) (= (bool_eq1 before no_element) true)) (= (has_key (positions (mk___rep container__split_discrs (mk___split_fields container__split_fields))) position) true)))
(assert (not (<= (+ (+ 0 (ite (= (bool_eq1 before position) true) 1 0)) (ite (= (bool_eq1 before no_element) true) 1 0)) 1)))
(check-sat)
(exit)
