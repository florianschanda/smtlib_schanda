...
(define-fun dynamic_invariant ((temp___expr_208 us_rep) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool) (temp___do_typ_inv_207 Bool)) Bool (=> (= temp___do_toplevel_206 true) (=> (= temp___is_init_204 true) (<= 0 (to_rep (rec__prot__int__v (us_split_fields1 temp___expr_208)))))))
(define-fun dynamic_predicate ((temp___213 us_rep)) Bool (<= 0 (to_rep (rec__prot__int__v (us_split_fields1 temp___213)))))
...
(define-fun dynamic_invariant2 ((temp___expr_219 us_rep1) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool) (temp___do_typ_inv_218 Bool)) Bool (<= 0 (to_rep (rec__prot__int__v (us_split_fields1 (rec__prot__t__data (us_split_fields3 temp___expr_219)))))))
(declare-const rliteral integer)
(assert (= (integerqtint rliteral) 0))
(define-fun default_initial_assumption ((temp___expr_221 us_rep1) (temp___skip_top_level_222 Bool)) Bool (= (rec__prot__t__data (us_split_fields3 temp___expr_221)) (mk___rep (mk___split_fields rliteral))))
(declare-const self__ us_rep1)
(assert (not (<= 0 (to_rep rliteral))))
(check-sat)
(exit)
