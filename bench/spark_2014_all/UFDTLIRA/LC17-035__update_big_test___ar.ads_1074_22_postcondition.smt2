...
(declare-const temp___7269 et3)
(declare-const temp___72691 et1)
(declare-const temp___72692 et2)
(declare-const temp___72693 enum1ta)
(declare-const temp___72694 et4)
(declare-const temp___72695 enum1t)
...
(declare-const temp___7273 us_rep3)
...
(assert (= o1 o7))
(assert (= temp___7269 o2))
(assert (= temp___72691 o3))
(assert (= temp___72692 o4))
(assert (= temp___72693 o5))
(assert (= temp___72694 o6))
(assert (= temp___72695 o7))
...
(assert (= r__split_fields6 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 temp___7269 (mk___rep (mk___split_fields temp___72691 temp___72692)) temp___72693)) temp___72694)) temp___72695)))
...
(assert (= temp___7273 (mk___rep3 o13)))
(assert (= result2 (mk___split_fields__ref3 r__split_fields6)))
(assert (= r__split_fields7 (us_split_fields7 temp___7273)))
