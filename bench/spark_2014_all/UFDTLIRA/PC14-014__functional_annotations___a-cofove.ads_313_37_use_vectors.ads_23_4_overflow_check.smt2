...
(define-fun dynamic_invariant5 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= first1 last3)) (dynamic_property2 first1 last3 temp___expr_242)))
(assert (= first1 fst))
(assert (= last3 lst))
...
(declare-const o Int)
(assert (dynamic_property3 first2 last4 no_index))
