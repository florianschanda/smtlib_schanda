...
(assert (and (= o16 (length right)) (and (in_range2 o16) (<= o16 (capacity right)))))
(assert (and (= o17 (length left)) (and (in_range2 o17) (<= o17 (capacity left)))))
(assert (= o18 (+ o17 o16)))
(assert (and (= o19 (length (vector__content amortized_queue__Oconcat__result5))) (and (in_range2 o19) (<= o19 (capacity (vector__content amortized_queue__Oconcat__result5))))))
(assert (= result5 (ite (= o19 o18) true false)))
(assert (= result5 true))
(assert (and (= o14 (last (model__ left))) (and (in_range3 o14) (= o14 (last (model__ left))))))
...
(assert (= result8 true))
(assert (and (= o12 i) (in_range6 i)))
(assert (and (= o13 (get (model__ right) o12)) (and (in_range4 o13) (= o13 (get (model__ right) o12)))))
(assert (and (= o8 (last (model__ left))) (and (in_range3 o8) (= o8 (last (model__ left))))))
(assert (= o9 (+ o8 i)))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (and (= o11 o10) (in_range6 o10)))
(assert (not (<= o11 (last (model__ (vector__content amortized_queue__Oconcat__result5))))))
(check-sat)
(exit)
