...
(define-fun dynamic_invariant ((temp___expr_169 us_rep) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool) (temp___do_typ_inv_168 Bool)) Bool (and (=> (not (= temp___skip_constant_166 true)) (in_range2 0 temp___expr_169)) (= (attr__constrained temp___expr_169) true)))
(define-fun default_initial_assumption1 ((temp___expr_171 us_rep) (temp___skip_top_level_172 Bool)) Bool (and (= (attr__constrained temp___expr_171) true) (and (= (to_rep (rec__constrained_attribute__mut_rec__d (us_split_discrs1 temp___expr_171))) 0) (= (to_rep (rec__constrained_attribute__mut_rec__f (us_split_fields1 temp___expr_171))) 0))))
...
(define-fun b__split_fields2 () us_split_fields (mk___split_fields b__split_fields1))
(assert (= result a__split_fields))
(assert (= rliteral a__split_fields1))
(assert (= result1 a__split_discrs))
(assert (= rliteral a__split_discrs1))
(assert (= a__attr__constrained false))
(assert (and (= us 0) (in_range 0)))
(assert (= result2 b__split_fields))
(assert (= b__split_fields2 (mk___split_fields a__split_fields1)))
(assert (= b__split_discrs (mk___split_discrs a__split_discrs1)))
(assert (= b__attr__constrained true))
(assert (and (= 0 (to_rep (rec__constrained_attribute__mut_rec__d b__split_discrs))) (= b__attr__constrained true)))
(assert (= b__attr__constrained true))
(assert (= (is_constrained (mk___rep b__split_discrs b__split_fields2 b__attr__constrained)) true))
(assert (not (not (= a__attr__constrained true))))
(check-sat)
(exit)
