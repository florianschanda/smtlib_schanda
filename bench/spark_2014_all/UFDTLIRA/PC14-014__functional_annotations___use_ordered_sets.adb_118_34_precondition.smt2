...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s2__split_discrs s2__split_fields2)))) (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i)) true))))
(assert (forall ((e Int)) (=> (and (in_range2 e) (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) e) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (length (mk___rep s2__split_discrs s2__split_fields2)))) (= (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i) e))))))
(assert (and (= o1 (length (mk___rep s2__split_discrs s2__split_fields2))) (and (in_range1 o1) (<= o1 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s2__split_discrs))))))
(assert (= o2 (+ o1 1)))
(assert (and (= o3 o2) (in_range7 o2)))
(assert (and (= o (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (not (= (has_key o no_element) true)) (forall ((i us_rep3)) (=> (= (has_key o i) true) (and (and (<= 1 (get1 o i)) (<= (get1 o i) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (forall ((j us_rep3)) (=> (= (has_key o j) true) (=> (= (get1 o i) (get1 o j)) (= (bool_eq3 i j) true))))))))))
