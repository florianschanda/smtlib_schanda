...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__dic_of_cont__my_dlli__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (= (to_rep (rec__dic_of_cont__my_dlli__cursor__node (us_split_fields3 a))) (to_rep (rec__dic_of_cont__my_dlli__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_418 Int) (temp___is_init_414 Bool) (temp___skip_constant_415 Bool) (temp___do_toplevel_416 Bool) (temp___do_typ_inv_417 Bool)) Bool (=> (or (= temp___is_init_414 true) (<= 1 2147483647)) (in_range2 temp___expr_418)))
...
(define-fun default_initial_assumption ((temp___expr_426 us_rep3) (temp___skip_top_level_427 Bool)) Bool (=> (not (= temp___skip_top_level_427 true)) (and (= (is_empty temp___expr_426) true) (= (length2 temp___expr_426) 0))))
(define-fun default_initial_assumption1 ((temp___expr_412 us_rep2) (temp___skip_top_level_413 Bool)) Bool (= (to_rep (rec__dic_of_cont__my_dlli__cursor__node (us_split_fields3 temp___expr_412))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_404 us_rep1) (temp___skip_top_level_405 Bool)) Bool (=> (not (= temp___skip_top_level_405 true)) (= (length1 temp___expr_404) 0)))
...
(define-fun default_initial_assumption3 ((temp___expr_367 us_rep2) (temp___skip_top_level_368 Bool)) Bool (= (to_rep (rec__dic_of_cont__my_dlli__cursor__node (us_split_fields3 temp___expr_367))) 0))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__dic_of_cont__my_dlli__list__capacity (us_split_discrs1 container)))))))
