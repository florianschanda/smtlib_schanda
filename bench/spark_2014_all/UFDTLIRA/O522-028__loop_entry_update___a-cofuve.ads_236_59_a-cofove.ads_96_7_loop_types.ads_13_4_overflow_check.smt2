...
(define-fun dynamic_invariant1 ((temp___expr_298 Int) (temp___is_init_294 Bool) (temp___skip_constant_295 Bool) (temp___do_toplevel_296 Bool) (temp___do_typ_inv_297 Bool)) Bool (=> (or (= temp___is_init_294 true) (<= 0 1000)) (in_range2 temp___expr_298)))
...
(define-fun dynamic_invariant2 ((temp___expr_284 Int) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool) (temp___do_typ_inv_283 Bool)) Bool (=> (or (= temp___is_init_280 true) (<= 1 1000)) (in_range4 temp___expr_284)))
...
(define-fun dynamic_invariant3 ((temp___expr_291 Int) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool) (temp___do_typ_inv_290 Bool)) Bool (=> (or (= temp___is_init_287 true) (<= 0 2147483647)) (in_range5 temp___expr_291)))
...
(assert (and (= o4 (last left)) (and (in_range2 o4) (= o4 (+ 0 (length left))))))
(assert (= result (ite (<= lst o4) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o3 (- (- 2147483648) offset)) (in_range3 (- (- 2147483648) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o3 1) true false))))
(assert (=> (not (< offset 0)) (= result1 (distinct 1 0))))
(assert (= result1 true))
(assert (<= fst lst))
(assert (and (= o2 lst) (in_range3 lst)))
(assert (and (= o (length right)) (and (in_range1 o) (<= (+ 0 o) 1000))))
(assert (= o1 (+ 0 o)))
