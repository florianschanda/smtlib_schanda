...
(define-fun default_initial_assumption ((temp___expr_838 us_rep) (temp___skip_top_level_839 Bool)) Bool (=> (not (= temp___skip_top_level_839 true)) (= (length temp___expr_838) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_830 Int) (temp___is_init_826 Bool) (temp___skip_constant_827 Bool) (temp___do_toplevel_828 Bool) (temp___do_typ_inv_829 Bool)) Bool (=> (or (= temp___is_init_826 true) (<= 0 1000)) (in_range2 temp___expr_830)))
...
(define-fun dynamic_invariant2 ((temp___expr_816 Int) (temp___is_init_812 Bool) (temp___skip_constant_813 Bool) (temp___do_toplevel_814 Bool) (temp___do_typ_inv_815 Bool)) Bool (=> (or (= temp___is_init_812 true) (<= 1 1000)) (in_range4 temp___expr_816)))
...
(define-fun dynamic_invariant3 ((temp___expr_823 Int) (temp___is_init_819 Bool) (temp___skip_constant_820 Bool) (temp___do_toplevel_821 Bool) (temp___do_typ_inv_822 Bool)) Bool (=> (or (= temp___is_init_819 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_823)))
...
(assert (and (= o2 (length container)) (and (in_range o2) (<= (+ 0 o2) 1000))))
