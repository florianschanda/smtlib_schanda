...
(assert (forall ((x et2)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x et1)) (! (in_range (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(declare-const temp___6712 et3)
(declare-const temp___67121 et1)
(declare-const temp___67122 et2)
(declare-const temp___67123 enum1ta)
...
(assert (= temp___6712 o5))
(assert (= temp___67121 o6))
(assert (= temp___67122 o7))
(assert (= temp___67123 o8))
...
(assert (= temp___6712 r__split_fields4))
(assert (= temp___67121 r__split_fields5))
(assert (= temp___67122 r__split_fields6))
(assert (= temp___67123 r__split_fields7))
(assert (= r__split_fields8 (mk___split_fields__ref1 r__split_fields10)))
(assert (= r__split_fields9 r__split_fields10))
(assert (not (= (bool_eq1 (mk___rep1 (us_split_fields__content1 r__split_fields8)) (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields r__split_fields1 (of_rep e))) r__split_fields3))) true)))
(check-sat)
(exit)
