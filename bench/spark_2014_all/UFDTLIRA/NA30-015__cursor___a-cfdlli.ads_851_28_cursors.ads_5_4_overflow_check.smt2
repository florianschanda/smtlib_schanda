...
(define-fun default_initial_assumption1 ((temp___expr_273 us_rep1) (temp___skip_top_level_274 Bool)) Bool (= (to_rep (rec__cursors__l__cursor__node (us_split_fields3 temp___expr_273))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_228 us_rep1) (temp___skip_top_level_229 Bool)) Bool (= (to_rep (rec__cursors__l__cursor__node (us_split_fields3 temp___expr_228))) 0))
...
(assert (and (= o (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range o) (<= o (to_rep (rec__cursors__l__list__capacity container__split_discrs))))))
(assert (= o1 (- o count)))
