...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__r__pt__x integer) (rec__r__pt__y integer) (rec__r__pt__z integer)))))
(define-fun us_split_discrs___2__projection ((a us_split_discrs)) integer (rec__r__pt__x a))
(define-fun us_split_discrs___3__projection ((a us_split_discrs)) integer (rec__r__pt__y a))
(define-fun us_split_discrs___4__projection ((a us_split_discrs)) integer (rec__r__pt__z a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__r__pt us_main_type)))))
(define-fun us_split_fields_PT__projection ((a us_split_fields)) us_main_type (rec__r__pt a))
...
(declare-const temp___1794 Bool)
(assert (not (= temp___1794 false)))
(check-sat)
(exit)
