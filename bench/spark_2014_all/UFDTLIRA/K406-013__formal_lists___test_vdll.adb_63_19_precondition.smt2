...
(assert (and (= o7 (last1 (mk___rep l1__split_discrs l1__split_fields4))) (ite (= (= (length (mk___rep l1__split_discrs l1__split_fields4)) 0) true) (= (bool_eq3 o7 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o7) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o7) (length (mk___rep l1__split_discrs l1__split_fields4)))))))
(assert (and (= o8 (previous (mk___rep l1__split_discrs l1__split_fields4) o7)) (ite (= (ite (= (bool_eq3 o7 no_element) false) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o7) 1) true) true) (= (bool_eq3 o8 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o8) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o8) (- (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o7) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) no_element) true) (= (bool_eq3 no_element no_element) true))))
(check-sat)
(exit)
