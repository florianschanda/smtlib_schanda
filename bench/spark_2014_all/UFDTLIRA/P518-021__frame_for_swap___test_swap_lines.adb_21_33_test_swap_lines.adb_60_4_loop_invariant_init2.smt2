...
(define-fun tmp9 () int__ref (mk_int__ref tmp7))
(define-fun m10 () map__ref (mk_map__ref m7))
(assert (= result m))
...
(assert (=> (and (<= 1 c2) (<= c2 10)) (= tmp9 (mk_int__ref tmp5))))
(assert (=> (and (<= 1 c2) (<= c2 10)) (= m10 (mk_map__ref m5))))
(assert (=> (and (<= 1 c2) (<= c2 10)) (= c7 c5)))
(assert (=> (and (<= 1 c2) (<= c2 10)) (= tmp8 tmp6)))
(assert (=> (and (<= 1 c2) (<= c2 10)) (= m8 m6)))
(assert (=> (not (and (<= 1 c2) (<= c2 10))) (= c2 c6)))
(assert (=> (not (and (<= 1 c2) (<= c2 10))) (= tmp9 (mk_int__ref tmp))))
...
(assert (<= 1 i))
(assert (<= i c8))
(assert (not (= (to_rep (get m9 5 i)) (to_rep (get m9 7 i)))))
(check-sat)
(exit)
