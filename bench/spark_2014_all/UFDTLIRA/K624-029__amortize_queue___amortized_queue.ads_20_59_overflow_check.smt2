...
(assert (and (= o14 (length right)) (and (in_range2 o14) (<= o14 (capacity right)))))
(assert (and (= o15 (length left)) (and (in_range2 o15) (<= o15 (capacity left)))))
(assert (= o16 (+ o15 o14)))
(assert (and (= o17 (length (vector__content amortized_queue__Oconcat__result5))) (and (in_range2 o17) (<= o17 (capacity (vector__content amortized_queue__Oconcat__result5))))))
(assert (= result5 (ite (= o17 o16) true false)))
(assert (= result5 true))
(assert (and (= o12 (last (model__ left))) (and (in_range3 o12) (= o12 (last (model__ left))))))
