...
(declare-const temp___5271 us_main_type)
...
(define-fun l2__split_fields10 () us_split_fields (mk___split_fields l2__split_fields3))
(define-fun l2__split_fields11 () us_split_fields (mk___split_fields l2__split_fields2))
(define-fun cu__split_fields11 () us_split_fields2 (mk___split_fields1 cu__split_fields2))
(define-fun l2__split_fields12 () us_split_fields (mk___split_fields l2__split_fields1))
(define-fun l2__split_fields13 () us_split_fields (mk___split_fields l2__split_fields))
(define-fun cu__split_fields12 () us_split_fields2 (mk___split_fields1 cu__split_fields1))
(define-fun use_lists__incr_all__cu__assume1 () us_rep2 (mk___rep1 (mk___split_fields1 use_lists__incr_all__cu__assume)))
(assert (<= (length l1) (to_rep (rec__use_lists__my_lists__list__capacity l2__split_discrs))))
(assert (and (= use_lists__incr_all__cu__assume1 (first l1)) (ite (= (= (length l1) 0) true) (= (bool_eq2 use_lists__incr_all__cu__assume1 no_element) true) (and (= (has_key (positions l1) use_lists__incr_all__cu__assume1) true) (= (get1 (positions l1) use_lists__incr_all__cu__assume1) 1)))))
...
(assert (and (= result1 (has_key (positions l1) (mk___rep1 cu__split_fields12))) (= (= result1 true) (= (has_key (positions l1) (mk___rep1 cu__split_fields12)) true))))
(assert (=> (= result1 true) (and (= l2__split_discrs (mk___split_discrs temp___527)) (= temp___5271 l2__split_fields))))
(assert (=> (= result1 true) (= temp___526 cu__split_fields1)))
(assert (=> (= result1 true) (forall ((n Int)) (=> (and (<= 1 n) (<= n (length (mk___rep l2__split_discrs l2__split_fields12)))) (= (is_incr (get (model__ l1) n) (get (model__ (mk___rep l2__split_discrs l2__split_fields12)) n)) true)))))
(assert (=> (= result1 true) (= (get1 (positions l1) (mk___rep1 cu__split_fields11)) (+ (length (mk___rep l2__split_discrs l2__split_fields12)) 1))))
(assert (=> (= result1 true) (and (= o (element l1 (mk___rep1 cu__split_fields11))) (and (in_range5 o) (= o (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields11))))))))
(assert (=> (= result1 true) (= result2 (ite (< o 2147483647) true false))))
(assert (=> (= result1 true) (=> (= result2 true) (and (= o1 (element l1 (mk___rep1 cu__split_fields11))) (and (in_range5 o1) (= o1 (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields11)))))))))
(assert (=> (= result1 true) (=> (= result2 true) (= o2 (+ o1 1)))))
(assert (=> (= result1 true) (=> (= result2 true) (and (= o3 o2) (in_range8 o2)))))
(assert (=> (= result1 true) (=> (= result2 true) (and (and (and (and (and (= (length (mk___rep l2__split_discrs l2__split_fields11)) (+ (length (mk___rep l2__split_discrs l2__split_fields12)) 1)) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields11)) (last1 (mk___rep l2__split_discrs l2__split_fields11))) (length (mk___rep l2__split_discrs l2__split_fields11)))) (= (keys_included_except (positions (mk___rep l2__split_discrs l2__split_fields11)) (positions (mk___rep l2__split_discrs l2__split_fields12)) (last1 (mk___rep l2__split_discrs l2__split_fields11))) true)) (= (ole1 (positions (mk___rep l2__split_discrs l2__split_fields12)) (positions (mk___rep l2__split_discrs l2__split_fields11))) true)) (= (get (model__ (mk___rep l2__split_discrs l2__split_fields11)) (length (mk___rep l2__split_discrs l2__split_fields11))) o3)) (= (ole (model__ (mk___rep l2__split_discrs l2__split_fields12)) (model__ (mk___rep l2__split_discrs l2__split_fields11))) true)))))
(assert (=> (= result1 true) (=> (not (= result2 true)) (and (= o4 (element l1 (mk___rep1 cu__split_fields11))) (and (in_range5 o4) (= o4 (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields11)))))))))
(assert (=> (= result1 true) (=> (not (= result2 true)) (and (and (and (and (and (= (length (mk___rep l2__split_discrs l2__split_fields10)) (+ (length (mk___rep l2__split_discrs l2__split_fields12)) 1)) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields10)) (last1 (mk___rep l2__split_discrs l2__split_fields10))) (length (mk___rep l2__split_discrs l2__split_fields10)))) (= (keys_included_except (positions (mk___rep l2__split_discrs l2__split_fields10)) (positions (mk___rep l2__split_discrs l2__split_fields12)) (last1 (mk___rep l2__split_discrs l2__split_fields10))) true)) (= (ole1 (positions (mk___rep l2__split_discrs l2__split_fields12)) (positions (mk___rep l2__split_discrs l2__split_fields10))) true)) (= (get (model__ (mk___rep l2__split_discrs l2__split_fields10)) (length (mk___rep l2__split_discrs l2__split_fields10))) o4)) (= (ole (model__ (mk___rep l2__split_discrs l2__split_fields12)) (model__ (mk___rep l2__split_discrs l2__split_fields10))) true)))))
(assert (=> (= result1 true) (=> (not (= result2 true)) (= l2__split_fields11 l2__split_fields10))))
(assert (=> (= result1 true) (ite (= (ite (= (bool_eq2 (mk___rep1 cu__split_fields11) no_element) false) (= (get1 (positions l1) (mk___rep1 cu__split_fields11)) (length l1)) true) true) (= (bool_eq2 (mk___rep1 cu__split_fields10) no_element) true) (and (= (has_key (positions l1) (mk___rep1 cu__split_fields10)) true) (= (get1 (positions l1) (mk___rep1 cu__split_fields10)) (+ (get1 (positions l1) (mk___rep1 cu__split_fields11)) 1))))))
(assert (=> (= result1 true) (and (= o5 (has_key (positions l1) (mk___rep1 cu__split_fields10))) (= (= o5 true) (= (has_key (positions l1) (mk___rep1 cu__split_fields10)) true)))))
...
(assert (=> (= result1 true) (= l2__split_fields4 (mk___split_fields__ref l2__split_fields11))))
...
(assert (=> (not (= result1 true)) (= l2__split_fields6 (mk___split_fields__ref l2__split_fields13))))
(assert (=> (not (= result1 true)) (= cu__split_fields7 cu__split_fields12)))
(assert (=> (not (= result1 true)) (= l2__split_fields7 l2__split_fields13)))
...
(assert (not (= (length (mk___rep l2__split_discrs (us_split_fields__content l2__split_fields8))) (length l1))))
(check-sat)
(exit)
