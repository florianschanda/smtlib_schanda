...
(define-fun dynamic_invariant1 ((temp___expr_766 Int) (temp___is_init_762 Bool) (temp___skip_constant_763 Bool) (temp___do_toplevel_764 Bool) (temp___do_typ_inv_765 Bool)) Bool (=> (or (= temp___is_init_762 true) (<= 0 2147483647)) (in_range2 temp___expr_766)))
...
(define-fun dynamic_invariant2 ((temp___expr_184 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool) (temp___do_typ_inv_183 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 2147483647)) (in_range4 temp___expr_184)))
...
(define-fun default_initial_assumption ((temp___expr_812 us_rep1) (temp___skip_top_level_813 Bool)) Bool (=> (not (= temp___skip_top_level_813 true)) (= (length1 temp___expr_812) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_804 Int) (temp___is_init_800 Bool) (temp___skip_constant_801 Bool) (temp___do_toplevel_802 Bool) (temp___do_typ_inv_803 Bool)) Bool (=> (or (= temp___is_init_800 true) (<= 0 2147483647)) (in_range5 temp___expr_804)))
...
(define-fun dynamic_invariant4 ((temp___expr_797 Int) (temp___is_init_793 Bool) (temp___skip_constant_794 Bool) (temp___do_toplevel_795 Bool) (temp___do_typ_inv_796 Bool)) Bool (=> (or (= temp___is_init_793 true) (<= 1 2147483647)) (in_range6 temp___expr_797)))
...
(assert (and (= o1 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o1) (= o1 (ite (= (distinct 1 0) true) (to_rep (rec__my_bounded_vectors__v__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o2 (- o1 o)))
