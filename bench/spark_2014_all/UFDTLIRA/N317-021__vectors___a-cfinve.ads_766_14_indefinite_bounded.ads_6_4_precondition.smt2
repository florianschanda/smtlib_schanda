...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__indefinite_bounded__vect__vector us_main_type1)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields)) us_main_type1 (rec__indefinite_bounded__vect__vector a))
...
(define-fun capacity ((container1 us_rep1)) Int (ite (= (distinct 1 0) true) (to_rep (rec__indefinite_bounded__vect__vector__capacity (us_split_discrs1 container1))) 2147483647))
