...
(assert (=> (not (= y (- 2147483648))) (and (= o (abs y)) (in_range (abs y)))))
(assert (=> (not (= y (- 2147483648))) (= result y)))
(assert (=> (not (= y (- 2147483648))) (= y2 o)))
(assert (=> (not (not (= y (- 2147483648)))) (= y2 y)))
(assert (=> (not (not (= y (- 2147483648)))) (= y2 y1)))
(assert (= y2 y3))
(assert (= y4 y2))
(assert (not (type_invariant y3)))
(check-sat)
(exit)
