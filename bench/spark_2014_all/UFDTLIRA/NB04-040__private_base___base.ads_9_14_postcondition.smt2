...
(assert (forall ((attr__tag1 Int)) (forall ((x us_rep)) (! (dynamic_invariant (sum1 attr__tag1 x) true false true true) :pattern ((sum1 attr__tag1 x))))))
(assert (forall ((x us_rep)) (! (= (sum x) (sum1 us_tag x)) :pattern ((sum1 us_tag x)))))
(assert (forall ((x us_rep)) (! (= (sum x) (to_rep (rec__base__t__c (us_split_fields1 x)))) :pattern ((sum x)))))
(declare-const c Int)
...
(define-fun base__create__result18 () us_rep (mk___rep (mk___split_fields base__create__result3 base__create__result4) base__create__result5))
...
(assert (= (mk___rep (mk___split_fields base__create__result9 base__create__result10) base__create__result11) base__create__result18))
(assert (= (to_rep o) c))
(assert (= o o1))
...
(assert (= (mk_t__ref (mk___rep (mk___split_fields base__create__result12 base__create__result13) base__create__result14)) (mk_t__ref (mk___rep (mk___split_fields base__create__result6 base__create__result7) base__create__result8))))
...
(assert (not (= (sum (mk___rep (mk___split_fields base__create__result12 base__create__result13) base__create__result14)) c)))
(check-sat)
(exit)
