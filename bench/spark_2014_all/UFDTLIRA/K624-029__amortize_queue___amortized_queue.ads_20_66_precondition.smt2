...
(assert (and (= o11 (length right)) (and (in_range2 o11) (<= o11 (capacity right)))))
(assert (and (= o12 (length left)) (and (in_range2 o12) (<= o12 (capacity left)))))
(assert (= o13 (+ o12 o11)))
(assert (and (= o14 (length (vector__content amortized_queue__Oconcat__result5))) (and (in_range2 o14) (<= o14 (capacity (vector__content amortized_queue__Oconcat__result5))))))
(assert (= result5 (ite (= o14 o13) true false)))
(assert (= result5 true))
(assert (and (= o9 (last (model__ left))) (and (in_range3 o9) (= o9 (last (model__ left))))))
(assert (= o10 (ite (<= i1 o9) true false)))
(assert (= result7 (ite (<= 1 i1) o10 false)))
...
(assert (= result6 true))
(assert (and (= o6 (last (model__ right))) (and (in_range3 o6) (= o6 (last (model__ right))))))
(assert (= o7 (ite (<= i o6) true false)))
(assert (= result8 (ite (<= 1 i) o7 false)))
(assert (= result8 true))
(assert (and (= o8 i) (in_range6 i)))
(assert (not (<= o8 (last (model__ right)))))
(check-sat)
(exit)
