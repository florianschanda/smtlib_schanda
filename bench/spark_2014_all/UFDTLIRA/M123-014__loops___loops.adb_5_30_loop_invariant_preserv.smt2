...
(assert (= k result3))
(assert (= k1 1))
(assert (=> (and (<= 1 k1) (<= k1 i2)) (= temp___201 count3)))
(assert (=> (and (<= 1 k1) (<= k1 i2)) (= temp___200 k1)))
(assert (=> (and (<= 1 k1) (<= k1 i2)) (and (= o (+ count3 1)) (in_range1 (+ count3 1)))))
(assert (=> (and (<= 1 k1) (<= k1 i2)) (= count3 result4)))
(assert (=> (and (<= 1 k1) (<= k1 i2)) (= count4 o)))
(assert (=> (and (<= 1 k1) (<= k1 i2)) (= count5 k2)))
(assert (=> (and (<= 1 k1) (<= k1 i2)) (and (and (=> (<= 1 i2) (dynamic_property 1 i2 k2)) (=> (<= (- 2147483648) 2147483647) (in_range1 count5))) (and (<= 1 k2) (<= k2 i2)))))
...
(assert (=> (and (<= 1 k1) (<= k1 i2)) (= (mk_int__ref k5) (mk_int__ref k3))))
