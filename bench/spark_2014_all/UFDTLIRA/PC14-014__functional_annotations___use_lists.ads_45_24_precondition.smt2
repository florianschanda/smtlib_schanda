...
(assert (and (= o9 (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (and (not (= (has_key o9 no_element) true)) (forall ((i us_rep2)) (=> (= (has_key o9 i) true) (and (and (<= 1 (get1 o9 i)) (<= (get1 o9 i) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))) (forall ((j us_rep2)) (=> (= (has_key o9 j) true) (=> (= (get1 o9 i) (get1 o9 j)) (= (bool_eq2 i j) true))))))))))
(assert (and (= o10 (oeq1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o9)) (= (= o10 true) (and (forall ((key us_rep2)) (=> (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) key) true) (and (= (has_key o9 key) true) (= (get1 o9 key) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) key))))) (forall ((key us_rep2)) (=> (= (has_key o9 key) true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) key) true)))))))
