...
(assert (and (= o (element (mk___rep s1__split_discrs s1__split_fields1) (mk___rep1 cu__split_fields2))) (and (in_range6 o) (= o (get (elements (mk___rep s1__split_discrs s1__split_fields1)) (get1 (positions (mk___rep s1__split_discrs s1__split_fields1)) (mk___rep1 cu__split_fields2)))))))
...
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i (length (mk___rep s1__split_discrs s1__split_fields2))))
(assert (not (= (get (elements (mk___rep s1__split_discrs s1__split_fields2)) i) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (+ (length (mk___rep s2__split_discrs s2__split_fields2)) i)))))
(check-sat)
(exit)
