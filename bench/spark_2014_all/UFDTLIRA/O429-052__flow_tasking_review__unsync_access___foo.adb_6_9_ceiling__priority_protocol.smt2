...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__foo__g Bool)))))
(define-fun us_split_fields_G__projection ((a us_split_fields)) Bool (rec__foo__g a))
...
(define-fun default_initial_assumption ((temp___expr_215 us_rep) (temp___skip_top_level_216 Bool)) Bool (= (rec__foo__g (us_split_fields1 temp___expr_215)) (distinct 0 0)))
