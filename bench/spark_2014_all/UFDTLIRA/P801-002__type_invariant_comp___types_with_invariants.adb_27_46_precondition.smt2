...
(assert (in_range i))
(assert (let ((temp___164 e)) (=> (= (to_rep (rec__types_with_invariants__my_integer__val (us_split_fields1 temp___164))) 0) (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 temp___164)) true))))
(assert (= (bool_eq (from_integer (to_integer e)) e) true))
(assert (not (< (- 2147483648) i)))
(check-sat)
(exit)
