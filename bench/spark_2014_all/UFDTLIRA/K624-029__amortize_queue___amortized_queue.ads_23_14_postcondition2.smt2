...
(assert (= (mk___rep (mk___split_discrs result4) (mk___split_fields result5)) (vector__content amortized_queue__Oconcat__2__result5)))
(assert (not (= (length (vector__content amortized_queue__Oconcat__2__result5)) (+ 1 (length right)))))
(check-sat)
(exit)
