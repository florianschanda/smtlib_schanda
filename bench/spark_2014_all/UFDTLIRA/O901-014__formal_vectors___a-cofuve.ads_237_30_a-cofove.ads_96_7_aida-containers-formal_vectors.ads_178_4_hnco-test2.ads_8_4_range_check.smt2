...
(define-fun default_initial_assumption ((temp___expr_453 us_rep) (temp___skip_top_level_454 Bool)) Bool (=> (not (= temp___skip_top_level_454 true)) (= (length temp___expr_453) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_445 Int) (temp___is_init_441 Bool) (temp___skip_constant_442 Bool) (temp___do_toplevel_443 Bool) (temp___do_typ_inv_444 Bool)) Bool (=> (or (= temp___is_init_441 true) (<= 0 2147483647)) (in_range2 temp___expr_445)))
...
(define-fun dynamic_invariant2 ((temp___expr_431 Int) (temp___is_init_427 Bool) (temp___skip_constant_428 Bool) (temp___do_toplevel_429 Bool) (temp___do_typ_inv_430 Bool)) Bool (=> (or (= temp___is_init_427 true) (<= 1 2147483647)) (in_range4 temp___expr_431)))
...
(define-fun dynamic_invariant3 ((temp___expr_438 Int) (temp___is_init_434 Bool) (temp___skip_constant_435 Bool) (temp___do_toplevel_436 Bool) (temp___do_typ_inv_437 Bool)) Bool (=> (or (= temp___is_init_434 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_438)))
