...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__p__tt__x integer)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) integer (rec__p__tt__x a))
...
(define-fun in_range1 ((rec__p__tt__x1 Int) (a us_rep)) Bool (= rec__p__tt__x1 (to_rep (rec__p__tt__x (us_split_discrs1 a)))))
...
(declare-datatypes () ((tt1__ref (mk_tt1__ref (tt1__content us_rep1)))))
(define-fun tt1__ref___projection ((a tt1__ref)) us_rep1 (tt1__content a))
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__p__tt2 us_main_type)))))
(define-fun us_split_fields_TT__3__projection ((a us_split_fields4)) us_main_type (rec__p__tt2 a))
...
(define-fun to_base1 ((a us_rep2)) us_rep (mk___rep (us_split_discrs3 a) (mk___split_fields (rec__p__tt2 (us_split_fields5 a)))))
(define-fun of_base1 ((r us_rep)) us_rep2 (mk___rep2 (us_split_discrs1 r) (mk___split_fields2 (rec__p__tt (us_split_fields1 r)))))
...
(declare-datatypes () ((tto1S__ref (mk_tto1S__ref (tto1S__content us_rep2)))))
(define-fun tto1S__ref___projection ((a tto1S__ref)) us_rep2 (tto1S__content a))
(define-fun dynamic_invariant ((temp___expr_215 us_rep2) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool (=> (not (= temp___skip_constant_212 true)) (in_range2 1 (to_base1 temp___expr_215))))
(define-fun default_initial_assumption ((temp___expr_217 us_rep2) (temp___skip_top_level_218 Bool)) Bool (= (to_rep (rec__p__tt__x (us_split_discrs3 temp___expr_217))) 1))
...
(define-fun dynamic_invariant2 ((temp___expr_206 us_rep1) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool (=> (not (= temp___skip_constant_203 true)) (in_range1 1 (to_base temp___expr_206))))
(define-fun default_initial_assumption1 ((temp___expr_208 us_rep1) (temp___skip_top_level_209 Bool)) Bool (= (to_rep (rec__p__tt__x (us_split_discrs2 temp___expr_208))) 1))
