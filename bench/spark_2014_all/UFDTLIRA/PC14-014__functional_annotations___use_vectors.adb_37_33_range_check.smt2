...
(assert (forall ((n Int)) (=> (and (<= first4 n) (<= n (- i2 1))) (= (is_incr (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n) (get (model__ (mk___rep v__split_discrs v__split_fields2)) n)) true))))
(assert (forall ((n Int)) (=> (and (<= i2 n) (<= n (last2 (model__ (mk___rep v__split_discrs v__split_fields2))))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n) (get (model__ (mk___rep v__split_discrs v__split_fields2)) n)))))
...
(assert (= o1 i2))
(assert (and (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields2)) o1)) (and (in_range4 o2) (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields2)) o1)))))
(assert (= result2 (ite (< o2 2147483647) true false)))
(assert (= result2 true))
(assert (and (= us1 i2) (dynamic_property3 first2 last4 i2)))
(assert (= o3 i2))
(assert (and (= o4 (get (model__ (mk___rep v__split_discrs v__split_fields2)) o3)) (and (in_range4 o4) (= o4 (get (model__ (mk___rep v__split_discrs v__split_fields2)) o3)))))
(assert (= o5 (+ o4 1)))
(assert (and (= o6 o5) (in_range6 o5)))
(assert (not (dynamic_property3 first2 last4 i2)))
(check-sat)
(exit)
