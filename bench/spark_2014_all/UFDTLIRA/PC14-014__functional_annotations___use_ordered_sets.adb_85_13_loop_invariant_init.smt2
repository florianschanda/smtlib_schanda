...
(assert (= result1 true))
(assert (not (= (is_empty (intersection1 (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (model__ (mk___rep s2__split_discrs s2__split_fields)))) true)))
(check-sat)
(exit)
