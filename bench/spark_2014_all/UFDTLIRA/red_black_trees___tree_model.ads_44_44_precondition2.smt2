...
(assert (<= (length q) 100))
(assert (and (= o7 (length q)) (and (in_range1 o7) (<= (+ 0 o7) 2147483647))))
(assert (and (= o4 (length v)) (and (in_range1 o4) (<= (+ 0 o4) 2147483647))))
(assert (and (= o5 (length p)) (and (in_range1 o5) (<= (+ 0 o5) 2147483647))))
(assert (= o6 (- o5 o4)))
(assert (and (= o8 o6) (in_range4 o6)))
(assert (= result1 (ite (= o8 o7) true false)))
(assert (=> (= result1 true) (and (= o2 (length q)) (and (in_range1 o2) (<= (+ 0 o2) 2147483647)))))
