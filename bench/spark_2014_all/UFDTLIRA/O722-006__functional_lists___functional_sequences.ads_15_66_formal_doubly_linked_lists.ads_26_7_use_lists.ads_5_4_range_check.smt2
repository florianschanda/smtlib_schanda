...
(declare-fun get (us_rep Int us_type_of_heap) Int)
(declare-fun get__function_guard (Int us_rep Int us_type_of_heap) Bool)
...
(define-fun dynamic_invariant ((temp___expr_682 Int) (temp___is_init_678 Bool) (temp___skip_constant_679 Bool) (temp___do_toplevel_680 Bool) (temp___do_typ_inv_681 Bool)) Bool (=> (or (= temp___is_init_678 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_682)))
