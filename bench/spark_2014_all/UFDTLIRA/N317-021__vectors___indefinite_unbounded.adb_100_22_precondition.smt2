...
(define-fun dynamic_invariant ((temp___expr_235 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 0 2147483647)) (in_range temp___expr_235)))
...
(define-fun dynamic_invariant4 ((temp___expr_373 us_rep) (temp___is_init_369 Bool) (temp___skip_constant_370 Bool) (temp___do_toplevel_371 Bool) (temp___do_typ_inv_372 Bool)) Bool (=> (not (= temp___skip_constant_370 true)) (in_range5 2 temp___expr_373)))
(define-fun default_initial_assumption ((temp___expr_375 us_rep) (temp___skip_top_level_376 Bool)) Bool (and (= (to_rep (rec__indefinite_unbounded__vect__vector__capacity (us_split_discrs1 temp___expr_375))) 2) (=> (not (= temp___skip_top_level_376 true)) (= (is_empty temp___expr_375) true))))
...
(assert (= v__split_fields12 indefinite_unbounded__vect__clear__container__fields1))
...
(assert (= v__split_fields11 indefinite_unbounded__vect__append__2__container__fields4))
