...
(define-fun default_initial_assumption ((temp___expr_274 us_rep) (temp___skip_top_level_275 Bool)) Bool (=> (not (= temp___skip_top_level_275 true)) (= (length temp___expr_274) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 1 2147483647)) (in_range3 temp___expr_214)))
...
(define-fun dynamic_invariant4 ((temp___expr_235 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 0 2147483647)) (in_range1 temp___expr_235)))
...
(define-fun capacity ((container1 us_rep1)) Int (ite (= (distinct 1 0) true) (to_rep (rec__p__my_vectors__vector__capacity (us_split_discrs1 container1))) 2147483647))
