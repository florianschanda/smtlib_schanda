...
(declare-const use_ordered_maps__my_find__result1 us_rep2)
...
(assert (= temp___672 result2))
(assert (= temp___6721 (get1 (positions s) (mk___rep cu__split_fields4))))
...
(assert (= use_ordered_maps__my_find__result1 (mk___rep (mk___split_fields use_ordered_maps__my_find__result))))
(assert (and (= temp___6701 (next s (mk___rep cu__split_fields4))) (ite (= (ite (= (bool_eq2 (mk___rep cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep cu__split_fields4)) (length3 s)) true) true) (= (bool_eq2 temp___6701 no_element) true) (and (= (has_key1 (positions s) temp___6701) true) (= (get1 (positions s) temp___6701) (+ (get1 (positions s) (mk___rep cu__split_fields4)) 1))))))
(assert (= result4 (mk___split_fields__ref cu__split_fields4)))
(assert (= cu__split_fields3 (mk___split_fields temp___670)))
...
(assert (and (= o2 (positions s)) (and (not (= (has_key1 o2 no_element) true)) (forall ((i us_rep2)) (=> (= (has_key1 o2 i) true) (and (and (<= 1 (get1 o2 i)) (<= (get1 o2 i) (length3 s))) (forall ((j us_rep2)) (=> (= (has_key1 o2 j) true) (=> (= (get1 o2 i) (get1 o2 j)) (= (bool_eq2 i j) true))))))))))
(assert (not (= (has_key1 o2 (mk___rep cu__split_fields3)) true)))
(check-sat)
(exit)
