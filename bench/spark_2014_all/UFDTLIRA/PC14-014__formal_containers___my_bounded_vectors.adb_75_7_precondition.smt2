...
(assert (not (or (and (<= 1 o19) (<= o19 (last (model__ (mk___rep l__split_discrs l__split_fields26))))) (and (not (= o19 0)) (= (- o19 1) (last (model__ (mk___rep l__split_discrs l__split_fields26))))))))
(check-sat)
(exit)
