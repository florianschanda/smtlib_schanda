...
(define-fun default_initial_assumption ((temp___expr_587 us_rep) (temp___skip_top_level_588 Bool)) Bool (= (attr__tag temp___expr_587) us_tag))
...
(assert (not (in_range (+ (to_rep this__split_fields) step1))))
(check-sat)
(exit)
