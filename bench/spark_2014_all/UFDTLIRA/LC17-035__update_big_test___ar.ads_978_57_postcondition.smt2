...
(declare-const temp___7071 us_rep2)
...
(assert (= temp___7071 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)) o16)) o17))))
(assert (= result1 (mk___split_fields__ref2 r__split_fields5)))
(assert (= r__split_fields6 (us_split_fields5 temp___7071)))
(assert (= r__split_fields7 (mk___split_fields__ref2 r__split_fields6)))
(assert (= r__split_fields8 r__split_fields6))
(assert (not (= (to_rep (rec__ar__rec1t__f1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields__content2 r__split_fields7))))))) e)))
(check-sat)
(exit)
