...
(assert (and (= o2 (- index first1)) (in_range1 (- index first1))))
(assert (and (= o3 o2) (in_range3 o2)))
(assert (and (= o (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (dynamic_property 0 last o) (<= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))
(assert (= o1 (- o count)))
