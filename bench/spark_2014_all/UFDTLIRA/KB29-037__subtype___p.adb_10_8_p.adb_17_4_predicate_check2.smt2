...
(define-fun dynamic_invariant ((temp___expr_200 us_rep) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (= temp___do_toplevel_198 true) (=> (= temp___is_init_196 true) (= (= (rec__p__t__locked (us_split_fields1 temp___expr_200)) true) (< 3 (to_rep (rec__p__t__access_count (us_split_fields1 temp___expr_200))))))))
(define-fun default_initial_assumption ((temp___expr_202 us_rep) (temp___skip_top_level_203 Bool)) Bool (and (= (to_rep (rec__p__t__access_count (us_split_fields1 temp___expr_202))) 0) (= (rec__p__t__locked (us_split_fields1 temp___expr_202)) (distinct 0 0))))
(define-fun dynamic_predicate ((temp___204 us_rep)) Bool (= (= (rec__p__t__locked (us_split_fields1 temp___204)) true) (< 3 (to_rep (rec__p__t__access_count (us_split_fields1 temp___204))))))
...
(declare-const temp___2101 Bool)
(assert (and (= (to_rep var__split_fields) 0) (= var__split_fields1 (distinct 0 0))))
(assert (and (= o (+ (to_rep var__split_fields) 1)) (in_range1 (+ (to_rep var__split_fields) 1))))
(assert (= (to_rep o1) o))
(assert (= o1 o2))
(assert (= var__split_fields1 o3))
(assert (= temp___210 o2))
(assert (= temp___2101 o3))
(assert (= temp___2101 true))
(assert (not (< 3 (to_rep temp___210))))
(check-sat)
(exit)
