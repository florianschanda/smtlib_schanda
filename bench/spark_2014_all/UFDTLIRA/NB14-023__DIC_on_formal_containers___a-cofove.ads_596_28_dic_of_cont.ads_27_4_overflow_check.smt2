...
(define-fun dynamic_invariant2 ((temp___expr_1589 Int) (temp___is_init_1585 Bool) (temp___skip_constant_1586 Bool) (temp___do_toplevel_1587 Bool) (temp___do_typ_inv_1588 Bool)) Bool (=> (or (= temp___is_init_1585 true) (<= 1 2147483647)) (in_range3 temp___expr_1589)))
...
(define-fun dynamic_invariant4 ((temp___expr_1641 Int) (temp___is_init_1637 Bool) (temp___skip_constant_1638 Bool) (temp___do_toplevel_1639 Bool) (temp___do_typ_inv_1640 Bool)) Bool (=> (or (= temp___is_init_1637 true) (<= 0 2147483647)) (in_range6 temp___expr_1641)))
...
(define-fun dynamic_invariant5 ((temp___expr_1634 Int) (temp___is_init_1630 Bool) (temp___skip_constant_1631 Bool) (temp___do_toplevel_1632 Bool) (temp___do_typ_inv_1633 Bool)) Bool (=> (or (= temp___is_init_1630 true) (<= 0 2147483647)) (in_range7 temp___expr_1634)))
...
(assert (and (= o2 (- index 1)) (in_range5 (- index 1))))
(assert (and (= o (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o) (<= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))
(assert (= o1 (- o count)))
