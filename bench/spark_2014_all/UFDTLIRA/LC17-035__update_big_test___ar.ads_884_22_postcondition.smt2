...
(assert (= temp___6860 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)) o16)) o17))))
...
(assert (not (= (bool_eq2 (mk___rep2 (us_split_fields__content2 r__split_fields6)) (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields (of_rep e) r__split_fields2)) r__split_fields3)) r__split_fields4))) true)))
(check-sat)
(exit)
