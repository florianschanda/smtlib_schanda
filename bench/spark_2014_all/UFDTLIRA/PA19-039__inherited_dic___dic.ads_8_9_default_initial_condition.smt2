...
(define-fun default_initial_assumption ((temp___expr_167 us_rep) (temp___skip_top_level_168 Bool)) Bool (and (and (= (attr__tag temp___expr_167) us_tag) (= (rec__dic__parent__b (us_split_fields1 temp___expr_167)) (distinct 1 0))) (=> (not (= temp___skip_top_level_168 true)) (= (is_ok__2 temp___expr_167) true))))
(assert true)
(assert true)
(assert (forall ((obj us_rep)) (! (= (ite (is_ok__2 obj) 1 0) (ite (is_ok__21 us_tag obj) 1 0)) :pattern ((is_ok__21 us_tag obj)))))
(assert (forall ((obj us_rep)) (! (= (= (is_ok__2 obj) true) (not (= (rec__dic__parent__b (us_split_fields1 obj)) true))) :pattern ((is_ok__2 obj)))))
(declare-const temp___178 Bool)
(declare-const temp___1781 us_private)
(declare-const temp___1782 Int)
(assert (and (= temp___1782 us_tag) (= temp___178 (distinct 1 0))))
(assert (not (= (is_ok__2 (mk___rep (mk___split_fields temp___178 temp___1781) temp___1782)) true)))
(check-sat)
(exit)
