...
(assert (= result2 true))
(assert (and (= o2 (length (mk___rep s2__split_discrs s2__split_fields1))) (and (in_range1 o2) (<= o2 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s2__split_discrs))))))
(assert (= o3 (+ o2 i)))
