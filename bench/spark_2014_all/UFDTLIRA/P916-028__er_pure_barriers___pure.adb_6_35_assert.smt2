...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__pure__pt__n natural) (rec__pure__pt__b Bool)))))
(define-fun us_split_fields_N__projection ((a us_split_fields)) natural (rec__pure__pt__n a))
(define-fun us_split_fields_B__projection ((a us_split_fields)) Bool (rec__pure__pt__b a))
...
(define-fun default_initial_assumption ((temp___expr_201 us_rep) (temp___skip_top_level_202 Bool)) Bool (and (= (to_rep (rec__pure__pt__n (us_split_fields1 temp___expr_201))) 0) (= (rec__pure__pt__b (us_split_fields1 temp___expr_201)) (distinct 0 0))))
