...
(define-fun dynamic_invariant1 ((temp___expr_282 us_rep) (temp___is_init_278 Bool) (temp___skip_constant_279 Bool) (temp___do_toplevel_280 Bool) (temp___do_typ_inv_281 Bool)) Bool (and (=> (not (= temp___skip_constant_279 true)) (in_range1 c temp___expr_282)) (= (attr__constrained temp___expr_282) true)))
(define-fun default_initial_assumption1 ((temp___expr_284 us_rep) (temp___skip_top_level_285 Bool)) Bool (and (= (attr__constrained temp___expr_284) true) (= (to_rep (rec__private_discr__p_with_default__c (us_split_discrs1 temp___expr_284))) c)))
