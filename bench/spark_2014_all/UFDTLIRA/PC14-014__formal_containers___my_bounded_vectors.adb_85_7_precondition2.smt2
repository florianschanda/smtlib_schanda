...
(define-fun dynamic_invariant1 ((temp___expr_261 Int) (temp___is_init_257 Bool) (temp___skip_constant_258 Bool) (temp___do_toplevel_259 Bool) (temp___do_typ_inv_260 Bool)) Bool (=> (or (= temp___is_init_257 true) (<= 0 10)) (in_range3 temp___expr_261)))
...
(define-fun dynamic_invariant3 ((temp___expr_240 Int) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool) (temp___do_typ_inv_239 Bool)) Bool (=> (or (= temp___is_init_236 true) (<= 1 10)) (in_range5 temp___expr_240)))
...
(define-fun dynamic_invariant5 ((temp___expr_911 us_rep) (temp___is_init_907 Bool) (temp___skip_constant_908 Bool) (temp___do_toplevel_909 Bool) (temp___do_typ_inv_910 Bool)) Bool (=> (not (= temp___skip_constant_908 true)) (in_range7 10 temp___expr_911)))
(define-fun default_initial_assumption ((temp___expr_913 us_rep) (temp___skip_top_level_914 Bool)) Bool (and (= (to_rep (rec__my_vectors__v__vector__capacity (us_split_discrs1 temp___expr_913))) 10) (=> (not (= temp___skip_top_level_914 true)) (= (is_empty temp___expr_913) true))))
...
(define-fun dynamic_invariant6 ((temp___expr_921 us_rep) (temp___is_init_917 Bool) (temp___skip_constant_918 Bool) (temp___do_toplevel_919 Bool) (temp___do_typ_inv_920 Bool)) Bool (=> (not (= temp___skip_constant_918 true)) (in_range8 10 temp___expr_921)))
(define-fun default_initial_assumption1 ((temp___expr_923 us_rep) (temp___skip_top_level_924 Bool)) Bool (and (= (to_rep (rec__my_vectors__v__vector__capacity (us_split_discrs1 temp___expr_923))) 10) (=> (not (= temp___skip_top_level_924 true)) (= (is_empty temp___expr_923) true))))
...
(define-fun l__split_fields32 () us_split_fields (mk___split_fields l__split_fields2))
...
(define-fun l__split_fields33 () us_split_fields (mk___split_fields l__split_fields1))
...
(assert (= l__split_fields33 my_vectors__v__append__2__container__fields1))
(assert (and (and (= (length (mk___rep l__split_discrs my_vectors__v__append__3__container__fields1)) (+ (length (mk___rep l__split_discrs l__split_fields33)) 4)) (= (ole (model__ (mk___rep l__split_discrs l__split_fields33)) (model__ (mk___rep l__split_discrs my_vectors__v__append__3__container__fields1))) true)) (=> (< 0 4) (= (constant_range (model__ (mk___rep l__split_discrs my_vectors__v__append__3__container__fields1)) (+ (last (model__ (mk___rep l__split_discrs l__split_fields33))) 1) (+ (last (model__ (mk___rep l__split_discrs l__split_fields33))) 4) 9) true))))
(assert (= result2 l__split_fields1))
(assert (= l__split_fields32 my_vectors__v__append__3__container__fields1))
(assert (and (= (length (mk___rep l__split_discrs my_vectors__v__delete_last__container__fields1)) (- (length (mk___rep l__split_discrs l__split_fields32)) 1)) (= (olt (model__ (mk___rep l__split_discrs my_vectors__v__delete_last__container__fields1)) (model__ (mk___rep l__split_discrs l__split_fields32))) true)))
