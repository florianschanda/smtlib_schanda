...
(define-fun dynamic_invariant1 ((temp___expr_1217 Int) (temp___is_init_1213 Bool) (temp___skip_constant_1214 Bool) (temp___do_toplevel_1215 Bool) (temp___do_typ_inv_1216 Bool)) Bool (=> (or (= temp___is_init_1213 true) (<= 0 2147483647)) (in_range2 temp___expr_1217)))
...
(define-fun dynamic_invariant2 ((temp___expr_1203 Int) (temp___is_init_1199 Bool) (temp___skip_constant_1200 Bool) (temp___do_toplevel_1201 Bool) (temp___do_typ_inv_1202 Bool)) Bool (=> (or (= temp___is_init_1199 true) (<= 1 2147483647)) (in_range4 temp___expr_1203)))
