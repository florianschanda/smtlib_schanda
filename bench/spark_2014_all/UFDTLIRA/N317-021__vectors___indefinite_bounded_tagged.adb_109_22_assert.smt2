...
(assert (not (= (let ((temp___683 (f 3))) (let ((temp___682 (get (model__ (mk___rep v__split_discrs v__split_fields10)) 1))) (ite (= (attr__tag temp___682) (attr__tag temp___683)) (us_dispatch_eq temp___682 temp___683) false))) true)))
(check-sat)
(exit)
