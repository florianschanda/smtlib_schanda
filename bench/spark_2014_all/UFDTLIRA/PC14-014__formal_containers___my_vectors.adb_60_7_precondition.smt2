...
(assert (not (or (and (<= 1 o12) (<= o12 (last (model__ (mk___rep l__split_discrs l__split_fields21))))) (and (not (= o12 0)) (= (- o12 1) (last (model__ (mk___rep l__split_discrs l__split_fields21))))))))
(check-sat)
(exit)
