...
(define-fun default_initial_assumption ((temp___expr_1446 us_rep2) (temp___skip_top_level_1447 Bool)) Bool (=> (not (= temp___skip_top_level_1447 true)) (and (= (is_empty temp___expr_1446) true) (= (length1 temp___expr_1446) 0))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length2 result) (length container1)) (forall ((temp___1461 Int)) (=> (and (in_range5 temp___1461) (= (iter_has_element result temp___1461) true)) (= (contains (model__ container1) (get1 result temp___1461)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container1)))))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep (rec__dic_of_cont__my_orse__set__capacity (us_split_discrs1 container)))))))
