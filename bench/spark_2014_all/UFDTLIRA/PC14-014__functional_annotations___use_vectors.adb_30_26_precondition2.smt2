...
(assert (= result2 true))
(assert (and (= us1 n) (dynamic_property3 first2 last4 n)))
(assert (= o4 n))
(assert (and (= o5 (get (model__ (mk___rep v__split_discrs v__split_fields2)) o4)) (and (in_range4 o5) (= o5 (get (model__ (mk___rep v__split_discrs v__split_fields2)) o4)))))
