...
(assert (<= 1 c1))
(assert (<= c1 10))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- c2 1))) (and (= (to_rep (get m2 5 i)) (to_rep (get m1 7 i))) (= (to_rep (get m2 7 i)) (to_rep (get m1 5 i)))))))
...
(assert (<= 1 i))
(assert (<= i (- c3 1)))
(assert (not (= (to_rep (get m4 7 i)) (to_rep (get m1 5 i)))))
(check-sat)
(exit)
