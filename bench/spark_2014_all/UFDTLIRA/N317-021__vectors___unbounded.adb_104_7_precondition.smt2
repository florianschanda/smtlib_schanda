...
(define-fun default_initial_assumption ((temp___expr_375 us_rep) (temp___skip_top_level_376 Bool)) Bool (and (= (to_rep (rec__unbounded__vect__vector__capacity (us_split_discrs1 temp___expr_375))) 2) (=> (not (= temp___skip_top_level_376 true)) (= (is_empty temp___expr_375) true))))
...
(define-fun o3 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1)))
...
(assert (and (= o3 (empty_vector Tuple0)) (= (length o3) 0)))
(assert (= (oeq1 (model__ (mk___rep w__split_discrs w__split_fields3)) (model__ o3)) true))
...
(assert (and (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields10)) 2)) (and (in_range4 o2) (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields10)) 2)))))
