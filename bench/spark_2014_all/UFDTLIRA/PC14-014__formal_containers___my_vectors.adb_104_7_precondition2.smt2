...
(assert (= c1 0))
(assert (in_range2 c1))
(assert (and (= (length (mk___rep l__split_discrs l__split_fields1)) 10) (not (= (is_sorted (mk___rep l__split_discrs l__split_fields1)) true))))
(assert (= (oeq (model__ (mk___rep k__split_discrs my_vectors__v__assign__target__fields)) (model__ (mk___rep l__split_discrs l__split_fields1))) true))
(assert (= result1 (mk___split_fields__ref k__split_fields1)))
(assert (= k__split_fields2 my_vectors__v__assign__target__fields))
(assert (and (and (and (= (length (mk___rep l__split_discrs my_vectors__s__sort__container__fields)) (length (mk___rep l__split_discrs l__split_fields1))) (= (m_elements_sorted (model__ (mk___rep l__split_discrs my_vectors__s__sort__container__fields))) true)) (= (m_elements_included (model__ (mk___rep l__split_discrs l__split_fields1)) 1 (last (model__ (mk___rep l__split_discrs my_vectors__s__sort__container__fields))) (model__ (mk___rep l__split_discrs my_vectors__s__sort__container__fields)) 1 (last (model__ (mk___rep l__split_discrs my_vectors__s__sort__container__fields)))) true)) (= (m_elements_included (model__ (mk___rep l__split_discrs my_vectors__s__sort__container__fields)) 1 (last (model__ (mk___rep l__split_discrs my_vectors__s__sort__container__fields))) (model__ (mk___rep l__split_discrs l__split_fields1)) 1 (last (model__ (mk___rep l__split_discrs my_vectors__s__sort__container__fields)))) true)))
(assert (= result2 (mk___split_fields__ref l__split_fields1)))
(assert (= l__split_fields2 my_vectors__s__sort__container__fields))
(assert (ite (= (<= (length (mk___rep l__split_discrs l__split_fields2)) 5) true) (= (length (mk___rep l__split_discrs my_vectors__v__delete_last__2__container__fields)) 0) (and (= (length (mk___rep l__split_discrs my_vectors__v__delete_last__2__container__fields)) (- (length (mk___rep l__split_discrs l__split_fields2)) 5)) (= (ole (model__ (mk___rep l__split_discrs my_vectors__v__delete_last__2__container__fields)) (model__ (mk___rep l__split_discrs l__split_fields2))) true))))
(assert (= result3 (mk___split_fields__ref l__split_fields2)))
(assert (= l__split_fields3 my_vectors__v__delete_last__2__container__fields))
(assert (ite (= (<= (length (mk___rep k__split_discrs k__split_fields2)) 5) true) (= (length (mk___rep k__split_discrs my_vectors__v__delete_first__2__container__fields)) 0) (and (= (length (mk___rep k__split_discrs my_vectors__v__delete_first__2__container__fields)) (- (length (mk___rep k__split_discrs k__split_fields2)) 5)) (= (range_shifted (model__ (mk___rep k__split_discrs my_vectors__v__delete_first__2__container__fields)) (model__ (mk___rep k__split_discrs k__split_fields2)) 1 (last (model__ (mk___rep k__split_discrs my_vectors__v__delete_first__2__container__fields))) 5) true))))
(assert (= result4 (mk___split_fields__ref k__split_fields2)))
(assert (= k__split_fields3 my_vectors__v__delete_first__2__container__fields))
(assert (and (and (and (and (and (= (length (mk___rep l__split_discrs my_vectors__s__merge__target__fields)) (+ (length (mk___rep l__split_discrs l__split_fields3)) (length (mk___rep k__split_discrs k__split_fields3)))) (= (length (mk___rep k__split_discrs my_vectors__s__merge__source__fields)) 0)) (=> (and (= (m_elements_sorted (model__ (mk___rep l__split_discrs l__split_fields3))) true) (= (m_elements_sorted (model__ (mk___rep k__split_discrs k__split_fields3))) true)) (= (m_elements_sorted (model__ (mk___rep l__split_discrs my_vectors__s__merge__target__fields))) true))) (= (m_elements_included (model__ (mk___rep l__split_discrs l__split_fields3)) 1 (last (model__ (mk___rep l__split_discrs l__split_fields3))) (model__ (mk___rep l__split_discrs my_vectors__s__merge__target__fields)) 1 (last (model__ (mk___rep l__split_discrs my_vectors__s__merge__target__fields)))) true)) (= (m_elements_included (model__ (mk___rep k__split_discrs k__split_fields3)) 1 (last (model__ (mk___rep k__split_discrs k__split_fields3))) (model__ (mk___rep l__split_discrs my_vectors__s__merge__target__fields)) 1 (last (model__ (mk___rep l__split_discrs my_vectors__s__merge__target__fields)))) true)) (= (m_elements_in_union (model__ (mk___rep l__split_discrs my_vectors__s__merge__target__fields)) (model__ (mk___rep k__split_discrs k__split_fields3)) (model__ (mk___rep l__split_discrs l__split_fields3))) true)))
(assert (= result5 (mk___split_fields__ref l__split_fields3)))
(assert (= l__split_fields4 my_vectors__s__merge__target__fields))
(assert (= result6 (mk___split_fields__ref k__split_fields3)))
(assert (= k__split_fields4 my_vectors__s__merge__source__fields))
(assert (= (length (mk___rep l__split_discrs l__split_fields4)) 10))
(assert (and (and (and (= (length (mk___rep l__split_discrs my_vectors__s__sort__container__fields1)) (length (mk___rep l__split_discrs l__split_fields4))) (= (m_elements_sorted (model__ (mk___rep l__split_discrs my_vectors__s__sort__container__fields1))) true)) (= (m_elements_included (model__ (mk___rep l__split_discrs l__split_fields4)) 1 (last (model__ (mk___rep l__split_discrs my_vectors__s__sort__container__fields1))) (model__ (mk___rep l__split_discrs my_vectors__s__sort__container__fields1)) 1 (last (model__ (mk___rep l__split_discrs my_vectors__s__sort__container__fields1)))) true)) (= (m_elements_included (model__ (mk___rep l__split_discrs my_vectors__s__sort__container__fields1)) 1 (last (model__ (mk___rep l__split_discrs my_vectors__s__sort__container__fields1))) (model__ (mk___rep l__split_discrs l__split_fields4)) 1 (last (model__ (mk___rep l__split_discrs my_vectors__s__sort__container__fields1)))) true)))
(assert (= result7 (mk___split_fields__ref l__split_fields4)))
(assert (= l__split_fields5 my_vectors__s__sort__container__fields1))
(assert (= (distinct 0 0) true))
(assert (not (<= (length (mk___rep l__split_discrs l__split_fields5)) (to_rep (rec__my_vectors__v__vector__capacity k__split_discrs)))))
(check-sat)
(exit)
