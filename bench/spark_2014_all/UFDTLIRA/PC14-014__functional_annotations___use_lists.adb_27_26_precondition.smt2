...
(assert (and (= result1 (has_key (positions l1) (mk___rep1 cu__split_fields3))) (= (= result1 true) (= (has_key (positions l1) (mk___rep1 cu__split_fields3)) true))))
(assert (= result1 true))
(assert (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 (length (mk___rep l2__split_discrs l2__split_fields2)))) (= (is_incr (get (model__ l1) n1) (get (model__ (mk___rep l2__split_discrs l2__split_fields2)) n1)) true))))
(assert (= (get1 (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (+ (length (mk___rep l2__split_discrs l2__split_fields2)) 1)))
(assert (and (= o (length (mk___rep l2__split_discrs l2__split_fields2))) (and (in_range1 o) (<= o (to_rep (rec__use_lists__my_lists__list__capacity l2__split_discrs))))))
(assert (= o1 (ite (<= n o) true false)))
(assert (= result2 (ite (<= 1 n) o1 false)))
(assert (= result2 true))
(assert (and (= o3 (model__ (mk___rep l2__split_discrs l2__split_fields2))) (= (length1 o3) (length (mk___rep l2__split_discrs l2__split_fields2)))))
(assert (and (= o4 (get o3 n)) (in_range2 o4)))
(assert (and (= o2 (model__ l1)) (= (length1 o2) (length l1))))
(assert (not (<= n (last o2))))
(check-sat)
(exit)
