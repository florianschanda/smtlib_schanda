...
(define-fun dynamic_invariant ((temp___expr_732 Int) (temp___is_init_728 Bool) (temp___skip_constant_729 Bool) (temp___do_toplevel_730 Bool) (temp___do_typ_inv_731 Bool)) Bool (=> (or (= temp___is_init_728 true) (<= 0 2147483647)) (in_range1 temp___expr_732)))
...
(assert (forall ((i positive_count)) (and (<= 1 (positive_countqtint i)) (<= (positive_countqtint i) 2147483647))))
(define-fun in_range2 ((x Int)) Bool (and (<= 1 x) (<= x 2147483647)))
(declare-fun attr__ATTRIBUTE_IMAGE2 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Int)
(declare-fun user_eq2 (positive_count positive_count) Bool)
(declare-const dummy2 positive_count)
...
(define-fun dynamic_invariant1 ((temp___expr_739 Int) (temp___is_init_735 Bool) (temp___skip_constant_736 Bool) (temp___do_toplevel_737 Bool) (temp___do_typ_inv_738 Bool)) Bool (=> (or (= temp___is_init_735 true) (<= 1 2147483647)) (in_range2 temp___expr_739)))
...
(assert (and (= result1 (is_writable file)) (= (= result1 true) (and (= (is_open file) true) (or (= (mode__2 file) 1) (= (mode__2 file) 2))))))
(assert (=> (= result1 true) (and (= o (line_length__2 file)) (in_range1 o))))
(assert (=> (= result1 true) (= result (ite (< 0 o) true false))))
