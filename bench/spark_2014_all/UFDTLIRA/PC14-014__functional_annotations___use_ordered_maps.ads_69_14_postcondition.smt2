...
(assert (let ((temp___813 (keys s2))) (forall ((temp___812 Int)) (=> (and (in_range3 temp___812) (= (iter_has_element temp___813 temp___812) true)) (not (= (has_key (model__ s1) (get temp___813 temp___812)) true))))))
(assert (not (= (bool__content use_ordered_maps__are_disjoint__result13) true)))
(check-sat)
(exit)
