...
(declare-fun down (Int) Int)
(declare-fun down__function_guard (Int Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (= (down x) (ite (= x 1) x (+ (down (- x 1)) 1)))) :pattern ((down x)))))
(declare-const x Int)
