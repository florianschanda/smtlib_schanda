...
(assert (=> (= result2 true) (and (= o6 (length q)) (and (in_range1 o6) (<= (+ 0 o6) 2147483647)))))
(assert (=> (= result2 true) (= o7 (ite (<= i2 o6) true false))))
(assert (=> (= result2 true) (= result3 (ite (<= 1 i2) o7 false))))
...
(assert (=> (= result1 true) (and (= o4 (length v)) (and (in_range1 o4) (<= (+ 0 o4) 2147483647)))))
(assert (=> (= result1 true) (= o5 (ite (<= i1 o4) true false))))
(assert (=> (= result1 true) (= result4 (ite (<= 1 i1) o5 false))))
...
(assert (= result true))
(assert (and (= o2 (length p)) (and (in_range1 o2) (<= (+ 0 o2) 2147483647))))
