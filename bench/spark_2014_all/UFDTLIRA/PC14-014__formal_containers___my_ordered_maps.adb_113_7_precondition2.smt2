...
(assert (and (= temp___10421 (next (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep2 c__split_fields3))) (ite (= (ite (= (bool_eq3 (mk___rep2 c__split_fields3) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields3)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq3 temp___10421 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___10421) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___10421) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields3)) 1))))))
...
(assert (not (< (length (mk___rep l__split_discrs l__split_fields1)) (to_rep (rec__my_ordered_maps__n__map__capacity l__split_discrs)))))
(check-sat)
(exit)
