...
(assert (=> (= i 2) (=> (< speed 100) (and (= o (+ speed 1)) (in_range1 (+ speed 1))))))
...
(assert (=> (not (= i 2)) (=> (= i 3) (=> (< (- 100) speed) (and (= o1 (- speed 1)) (in_range1 (- speed 1)))))))
...
(assert (=> (not (= i 2)) (=> (not (= i 3)) (= speed3 speed))))
(assert (=> (not (= i 2)) (=> (not (= i 3)) (= speed3 speed1))))
