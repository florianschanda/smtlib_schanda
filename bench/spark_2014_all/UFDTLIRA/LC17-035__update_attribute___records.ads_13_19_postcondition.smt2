...
(declare-const result13 natural)
(declare-const result14 my_range)
...
(declare-const r__split_fields24 us_split_fields)
...
(assert (= rliteral r__split_fields8))
(assert (= r__split_fields5 r__split_fields9))
(assert (= r__split_fields6 r__split_fields10))
(assert (= r__split_fields7 r__split_fields11))
(assert (= (to_rep1 o5) new_data))
(assert (= r__split_fields8 o6))
(assert (= o5 o7))
(assert (= r__split_fields10 o8))
(assert (= r__split_fields11 o9))
(assert (= temp___238 o6))
(assert (= temp___2381 o7))
(assert (= temp___2382 o8))
(assert (= temp___2383 o9))
...
(assert (= temp___238 r__split_fields12))
(assert (= temp___2381 r__split_fields13))
(assert (= temp___2382 r__split_fields14))
(assert (= temp___2383 r__split_fields15))
(assert (= result12 r__split_fields12))
(assert (= result13 r__split_fields13))
(assert (= result14 r__split_fields14))
(assert (= result15 r__split_fields15))
(assert (= r__split_fields12 r__split_fields16))
(assert (= r__split_fields13 r__split_fields17))
(assert (= rliteral1 r__split_fields18))
(assert (= r__split_fields15 r__split_fields19))
(assert (= r__split_fields20 r__split_fields16))
(assert (= r__split_fields21 r__split_fields17))
(assert (= r__split_fields22 r__split_fields18))
(assert (= r__split_fields23 r__split_fields19))
(assert (= r__split_fields24 (mk___split_fields r__split_fields16 r__split_fields17 r__split_fields18 r__split_fields19)))
(assert (not (= (bool_eq (mk___rep (mk___split_fields r__split_fields20 r__split_fields21 r__split_fields22 r__split_fields23)) (mk___rep (mk___split_fields rliteral (of_rep1 new_data) rliteral1 r__split_fields))) true)))
(check-sat)
(exit)
