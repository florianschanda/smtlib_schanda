...
(define-fun dynamic_invariant ((temp___expr_441 Int) (temp___is_init_437 Bool) (temp___skip_constant_438 Bool) (temp___do_toplevel_439 Bool) (temp___do_typ_inv_440 Bool)) Bool (=> (or (= temp___is_init_437 true) (<= 0 2147483647)) (in_range1 temp___expr_441)))
...
(assert (forall ((x name_id)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x char_table_index)) (! (in_range6 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun element_type__ref___3__projection ((a element_type__ref)) us_rep1 (element_type__content a))
...
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o) (= o (ite (= (distinct 0 0) true) (to_rep (rec__names__data__entry_tables__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
