...
(declare-const temp___2432 my_range)
...
(assert (= temp___243 r__split_fields4))
(assert (= temp___2431 r__split_fields5))
(assert (= temp___2432 r__split_fields6))
(assert (= temp___2433 r__split_fields7))
