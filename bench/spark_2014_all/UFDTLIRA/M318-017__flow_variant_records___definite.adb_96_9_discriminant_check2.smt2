...
(declare-const temp___214 status)
(declare-const temp___2141 natural)
(declare-const temp___2142 natural)
(declare-const temp___2143 Bool)
(declare-const temp___2144 Bool)
...
(declare-const temp___217 status)
(declare-const temp___2171 natural)
(declare-const temp___2172 natural)
(declare-const temp___2173 Bool)
(declare-const temp___2174 Bool)
...
(assert (= (to_rep x__split_discrs) r19b))
(assert (in_range1 r19b))
(assert (= (to_rep o) 2))
(assert (= o o1))
(assert (= temp___214 o1))
(assert (= rliteral temp___2141))
(assert (= dummy temp___2142))
(assert (= true temp___2143))
(assert (= true temp___2144))
(assert (=> (= x__attr__constrained true) (= temp___214 x__split_discrs)))
(assert (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1 usq_2 usq_3) usq_4) (mk___rep (mk___split_discrs temp___214) (mk___split_fields temp___2141 temp___2142 temp___2143) temp___2144)))
(assert (= usq_ temp___216))
(assert (= usq_1 temp___2161))
(assert (= usq_2 temp___2162))
(assert (= usq_3 temp___2163))
(assert (= x__attr__constrained temp___2164))
(assert (= result1 (mk___split_fields__ref (mk___split_fields x__split_fields x__split_fields1 x__split_fields2))))
(assert (= x__split_fields3 (mk___split_fields temp___2161 temp___2162 temp___2163)))
(assert (= result2 (mk___split_discrs__ref (mk___split_discrs x__split_discrs))))
(assert (= x__split_discrs1 (mk___split_discrs temp___216)))
(assert (= (to_rep o2) 2))
(assert (= o2 o3))
(assert (= temp___217 o3))
(assert (= rliteral temp___2171))
(assert (= dummy temp___2172))
(assert (= true temp___2173))
(assert (= true temp___2174))
(assert (= g__attr__constrained true))
(assert (not (= temp___217 g__split_discrs)))
(check-sat)
(exit)
