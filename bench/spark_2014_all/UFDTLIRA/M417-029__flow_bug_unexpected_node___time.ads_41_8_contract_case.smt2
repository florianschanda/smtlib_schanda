...
(assert (=> (= (< (to_rep2 (rec__time__t__seconds (us_split_fields1 x))) 59) true) (and (and (= (to_rep2 (rec__time__t__seconds (us_split_fields1 (t__content time__t_increment__result12)))) (+ (to_rep2 (rec__time__t__seconds (us_split_fields1 x))) 1)) (= (to_rep1 (rec__time__t__minutes (us_split_fields1 (t__content time__t_increment__result12)))) (to_rep1 (rec__time__t__minutes (us_split_fields1 x))))) (= (to_rep (rec__time__t__hours (us_split_fields1 (t__content time__t_increment__result12)))) (to_rep (rec__time__t__hours (us_split_fields1 x)))))))
(assert (=> (= (ite (= (= (to_rep2 (rec__time__t__seconds (us_split_fields1 x))) 59) true) (< (to_rep1 (rec__time__t__minutes (us_split_fields1 x))) 59) false) true) (and (and (= (to_rep2 (rec__time__t__seconds (us_split_fields1 (t__content time__t_increment__result12)))) 0) (= (to_rep1 (rec__time__t__minutes (us_split_fields1 (t__content time__t_increment__result12)))) (+ (to_rep1 (rec__time__t__minutes (us_split_fields1 x))) 1))) (= (to_rep (rec__time__t__hours (us_split_fields1 (t__content time__t_increment__result12)))) (to_rep (rec__time__t__hours (us_split_fields1 x)))))))
(assert (= (ite (= (= (to_rep2 (rec__time__t__seconds (us_split_fields1 x))) 59) true) (= (to_rep1 (rec__time__t__minutes (us_split_fields1 x))) 59) false) true))
(assert (not (= (to_rep1 (rec__time__t__minutes (us_split_fields1 (t__content time__t_increment__result12)))) 0)))
(check-sat)
(exit)
