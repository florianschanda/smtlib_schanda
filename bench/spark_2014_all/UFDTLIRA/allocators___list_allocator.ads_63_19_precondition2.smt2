...
(assert (in_range5 e))
(assert (and (= o6 (length s)) (and (in_range o6) (<= (+ 0 o6) 2147483647))))
(assert (= result2 (ite (< o6 2147483647) true false)))
(assert (=> (= result2 true) (and (= o2 (length s)) (and (in_range o2) (<= (+ 0 o2) 2147483647)))))
(assert (=> (= result2 true) (= o3 (+ o2 1))))
(assert (=> (= result2 true) (and (= o4 o3) (in_range4 o3))))
(assert (=> (= result2 true) (and (= o5 (length result__)) (and (in_range o5) (<= (+ 0 o5) 2147483647)))))
(assert (=> (= result2 true) (= result1 (ite (= o5 o4) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o1 (get result__ 1)) (in_range3 o1))))
(assert (=> (= result1 true) (= result (ite (= o1 e) true false))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (and (= o (last s)) (and (in_range2 o) (= o (+ 0 (length s))))))
(assert (not (<= o (last s))))
(check-sat)
(exit)
