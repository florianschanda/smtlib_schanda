...
(assert (= o12 o11))
(assert (= o13 o12))
(assert (not (= (oeq (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__front result____split_fields5)) (us_split_fields1 (rec__amortized_queue__queue__front result____split_fields5))) o13) true)))
(check-sat)
(exit)
