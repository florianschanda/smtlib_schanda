...
(assert (not (or (= (has_key (positions (mk___rep l__split_discrs l__split_fields5)) (mk___rep1 d__split_fields1)) true) (= (bool_eq1 (mk___rep1 d__split_fields1) no_element) true))))
(check-sat)
(exit)
