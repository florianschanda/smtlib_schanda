...
(assert (and (= o4 (positions (mk___rep l__split_discrs l__split_fields2))) (and (not (= (has_key o4 no_element) true)) (forall ((i us_rep2)) (=> (= (has_key o4 i) true) (and (and (<= 1 (get1 o4 i)) (<= (get1 o4 i) (length (mk___rep l__split_discrs l__split_fields2)))) (forall ((j us_rep2)) (=> (= (has_key o4 j) true) (=> (= (get1 o4 i) (get1 o4 j)) (= (bool_eq2 i j) true))))))))))
...
(assert (and (= o3 (positions (mk___rep l__split_discrs l__split_fields2))) (and (not (= (has_key o3 no_element) true)) (forall ((i us_rep2)) (=> (= (has_key o3 i) true) (and (and (<= 1 (get1 o3 i)) (<= (get1 o3 i) (length (mk___rep l__split_discrs l__split_fields2)))) (forall ((j us_rep2)) (=> (= (has_key o3 j) true) (=> (= (get1 o3 i) (get1 o3 j)) (= (bool_eq2 i j) true))))))))))
(assert (and (= o6 (get1 o3 (mk___rep1 current__split_fields3))) (and (in_range4 o6) (=> (= (distinct 0 0) true) (and (= o6 (w_get o3 (witness o3 (mk___rep1 current__split_fields3)))) (forall ((k us_rep2)) (=> (= (has_key o3 k) true) (= (= (bool_eq2 k (mk___rep1 current__split_fields3)) true) (= (witness o3 (mk___rep1 current__split_fields3)) (witness o3 k))))))))))
