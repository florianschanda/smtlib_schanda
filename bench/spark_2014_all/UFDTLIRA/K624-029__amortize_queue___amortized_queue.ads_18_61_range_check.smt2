...
(declare-const temp___547 capacity_range)
(declare-const temp___5471 us_main_type)
...
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 idx3)) (= (get (model__ (mk___rep result____split_discrs result____split_fields18)) i1) (get (model__ left) i1))))))
...
(assert (= idx8 1))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (= temp___548 idx8)))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (and (= result____split_discrs (mk___split_discrs temp___547)) (= (us_split_fields__content result____split_fields6) (mk___split_fields temp___5471)))))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (and (= o4 idx8) (in_range6 idx8))))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (and (= o5 (get (model__ right) o4)) (and (in_range4 o5) (= o5 (get (model__ right) o4))))))
...
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (last (model__ left)))) (= (get (model__ (mk___rep result____split_discrs result____split_fields9)) i1) (get (model__ left) i1))))))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 idx9)) (= (get (model__ (mk___rep result____split_discrs result____split_fields9)) (+ (last (model__ left)) i1)) (get (model__ right) i1))))))
...
(assert (and (= o8 (length right)) (and (in_range2 o8) (<= o8 (capacity right)))))
(assert (and (= o9 (length left)) (and (in_range2 o9) (<= o9 (capacity left)))))
(assert (= o10 (+ o9 o8)))
(assert (and (= o11 (length (vector__content amortized_queue__Oconcat__result5))) (and (in_range2 o11) (<= o11 (capacity (vector__content amortized_queue__Oconcat__result5))))))
(assert (= result5 (ite (= o11 o10) true false)))
(assert (= result5 true))
