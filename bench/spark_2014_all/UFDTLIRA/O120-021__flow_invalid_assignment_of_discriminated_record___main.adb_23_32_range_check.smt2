...
(define-fun o14 () us_rep (mk___rep (mk___split_discrs o10) (mk___split_fields o11 o12) o13))
(define-fun o15 () us_rep (mk___rep (mk___split_discrs o6) (mk___split_fields o7 o8) o9))
...
(assert (= dummy o4))
(assert (= true o5))
(assert (= o15 (mk___rep (mk___split_discrs o2) (mk___split_fields o3 o4) o5)))
(assert (= o14 o15))
(assert (= (mk___rep (mk___split_discrs main__u1__assume) (mk___split_fields main__u1__assume1 main__u1__assume2) main__u1__assume3) o14))
