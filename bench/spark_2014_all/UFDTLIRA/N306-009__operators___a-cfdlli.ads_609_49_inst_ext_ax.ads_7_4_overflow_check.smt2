...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__inst_ext_ax__ok_lists2__list__capacity count_type)))))
(define-fun us_split_discrs___2__projection ((a us_split_discrs)) count_type (rec__inst_ext_ax__ok_lists2__list__capacity a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__inst_ext_ax__ok_lists2__list us_main_type)))))
(define-fun us_split_fields_List__2__projection ((a us_split_fields)) us_main_type (rec__inst_ext_ax__ok_lists2__list a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__inst_ext_ax__ok_lists2__list__capacity (us_split_discrs1 a))) (to_rep (rec__inst_ext_ax__ok_lists2__list__capacity (us_split_discrs1 b)))) (= (us_main_eq (rec__inst_ext_ax__ok_lists2__list (us_split_fields1 a)) (rec__inst_ext_ax__ok_lists2__list (us_split_fields1 b))) true)) true false))
...
(declare-const inst_ext_ax__ok_lists2__list__capacity__first__bit Int)
(declare-const inst_ext_ax__ok_lists2__list__capacity__last__bit Int)
(declare-const inst_ext_ax__ok_lists2__list__capacity__position Int)
(assert (<= 0 inst_ext_ax__ok_lists2__list__capacity__first__bit))
(assert (< inst_ext_ax__ok_lists2__list__capacity__first__bit inst_ext_ax__ok_lists2__list__capacity__last__bit))
(assert (<= 0 inst_ext_ax__ok_lists2__list__capacity__position))
(declare-fun user_eq1 (us_rep us_rep) Bool)
(declare-const dummy1 us_rep)
(declare-datatypes () ((list__ref (mk_list__ref (list__content us_rep)))))
(define-fun list__ref___2__projection ((a list__ref)) us_rep (list__content a))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__inst_ext_ax__ok_lists2__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__inst_ext_ax__ok_lists2__cursor__node count_type)))))
(define-fun us_split_fields_Node__2__projection ((a us_split_fields2)) count_type (rec__inst_ext_ax__ok_lists2__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__inst_ext_ax__ok_lists2__cursor__node (us_split_fields3 a))) (to_rep (rec__inst_ext_ax__ok_lists2__cursor__node (us_split_fields3 b)))) true false))
...
(declare-const inst_ext_ax__ok_lists2__cursor__node__first__bit Int)
(declare-const inst_ext_ax__ok_lists2__cursor__node__last__bit Int)
(declare-const inst_ext_ax__ok_lists2__cursor__node__position Int)
(assert (<= 0 inst_ext_ax__ok_lists2__cursor__node__first__bit))
(assert (< inst_ext_ax__ok_lists2__cursor__node__first__bit inst_ext_ax__ok_lists2__cursor__node__last__bit))
(assert (<= 0 inst_ext_ax__ok_lists2__cursor__node__position))
...
(define-fun dynamic_invariant1 ((temp___expr_398 Int) (temp___is_init_394 Bool) (temp___skip_constant_395 Bool) (temp___do_toplevel_396 Bool) (temp___do_typ_inv_397 Bool)) Bool (=> (or (= temp___is_init_394 true) (<= 0 2147483647)) (in_range2 temp___expr_398)))
(define-fun default_initial_assumption ((temp___expr_412 us_rep1) (temp___skip_top_level_413 Bool)) Bool (= (to_rep (rec__inst_ext_ax__ok_lists2__cursor__node (us_split_fields3 temp___expr_412))) 0))
...
(define-fun default_initial_assumption1 ((temp___expr_471 us_rep2) (temp___skip_top_level_472 Bool)) Bool (=> (not (= temp___skip_top_level_472 true)) (and (= (is_empty temp___expr_471) true) (= (length1 temp___expr_471) 0))))
(define-fun default_initial_assumption2 ((temp___expr_457 us_rep1) (temp___skip_top_level_458 Bool)) Bool (= (to_rep (rec__inst_ext_ax__ok_lists2__cursor__node (us_split_fields3 temp___expr_457))) 0))
...
(define-fun dynamic_invariant2 ((temp___expr_463 Int) (temp___is_init_459 Bool) (temp___skip_constant_460 Bool) (temp___do_toplevel_461 Bool) (temp___do_typ_inv_462 Bool)) Bool (=> (or (= temp___is_init_459 true) (<= 1 2147483647)) (in_range4 temp___expr_463)))
(assert (forall ((container us_rep2)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (get container key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep1)) (=> (= (has_key container k) true) (= (= (bool_eq1 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant2 result true false true true)))) :pattern ((get container key))))))
...
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant2 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
(assert (= (mk___rep1 (mk___split_fields1 rliteral)) no_element))
(assert (in_range2 new_item))
(assert (in_range count))
(assert (not (in_range1 (- (to_rep (rec__inst_ext_ax__ok_lists2__list__capacity container__split_discrs)) count))))
(check-sat)
(exit)
