...
(assert (not (or (and (<= 1 o11) (<= o11 (last (model__ (mk___rep k__split_discrs k__split_fields2))))) (and (not (= o11 0)) (= (- o11 1) (last (model__ (mk___rep k__split_discrs k__split_fields2))))))))
(check-sat)
(exit)
