...
(assert (and (= o8 (length left)) (and (in_range1 o8) (<= o8 (capacity left)))))
(assert (= o9 (+ o8 1)))
(assert (and (= o10 (length (vector__content amortized_queue__Oconcat__3__result5))) (and (in_range1 o10) (<= o10 (capacity (vector__content amortized_queue__Oconcat__3__result5))))))
(assert (= result4 (ite (= o10 o9) true false)))
(assert (= result4 true))
(assert (and (= o6 (last (model__ left))) (and (in_range2 o6) (= o6 (last (model__ left))))))
(assert (= o7 (ite (<= i o6) true false)))
(assert (= result6 (ite (<= 1 i) o7 false)))
(assert (= (= result5 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (last (model__ left)))) (= (get (model__ (vector__content amortized_queue__Oconcat__3__result5)) i1) (get (model__ left) i1))))))
(assert (= result5 true))
(assert (and (= o3 (last (model__ left))) (and (in_range2 o3) (= o3 (last (model__ left))))))
(assert (= o4 (+ o3 1)))
