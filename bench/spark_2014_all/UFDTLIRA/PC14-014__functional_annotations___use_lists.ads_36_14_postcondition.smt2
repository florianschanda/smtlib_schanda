...
(assert (=> (= result1 true) (forall ((n Int)) (=> (and (<= 1 n) (<= n (- (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) 1))) (= (is_incr (get temp___534 n) (get (model__ (mk___rep l__split_discrs l__split_fields11)) n)) true)))))
(assert (=> (= result1 true) (forall ((n Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) n) (<= n (length (mk___rep l__split_discrs l__split_fields11)))) (= (get temp___535 n) (get (model__ (mk___rep l__split_discrs l__split_fields11)) n))))))
