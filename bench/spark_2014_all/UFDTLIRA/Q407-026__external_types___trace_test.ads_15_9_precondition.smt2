...
(declare-datatypes () ((trace__ref (mk_trace__ref (trace__content us_rep)))))
(define-fun trace__ref___projection ((a trace__ref)) us_rep (trace__content a))
...
(assert (forall ((t us_rep)) (forall ((c us_rep1)) (! (dynamic_invariant (element t c) true false true true) :pattern ((element t c))))))
