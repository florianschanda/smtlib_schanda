...
(assert (forall ((i small)) (and (<= 1 (smallqtint i)) (<= (smallqtint i) 10))))
...
(define-fun dynamic_invariant1 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 1 21)) (in_range1 temp___expr_165)))
(declare-const a Int)
