...
(assert (and (= o2 (get1 o1 lst)) (and (in_range4 o2) (=> (= (distinct 0 0) true) (and (= o2 (w_get o1 (witness o1 lst))) (forall ((k us_rep2)) (=> (= (has_key o1 k) true) (= (= (bool_eq2 k lst) true) (= (witness o1 lst) (witness o1 k))))))))))
