...
(assert (and (= o8 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))))) (and (dynamic_property4 first3 last5 o8) (= o8 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))))))))
(assert (= o9 (ite (<= j o8) true false)))
(assert (and (= o7 (+ i 7)) (in_range1 (+ i 7))))
(assert (= o10 (ite (<= o7 j) true false)))
(assert (= result (ite (= o10 true) o9 false)))
(assert (= result true))
(assert (and (= temp___525 (- j 7)) (in_range1 (- j 7))))
(assert (not (dynamic_property2 first1 last3 temp___525)))
(check-sat)
(exit)
