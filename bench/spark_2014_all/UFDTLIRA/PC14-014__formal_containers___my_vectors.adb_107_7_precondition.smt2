...
(assert (not (<= (length (mk___rep k__split_discrs k__split_fields6)) (- (capacity (mk___rep l__split_discrs l__split_fields6)) (length (mk___rep l__split_discrs l__split_fields6))))))
(check-sat)
(exit)
