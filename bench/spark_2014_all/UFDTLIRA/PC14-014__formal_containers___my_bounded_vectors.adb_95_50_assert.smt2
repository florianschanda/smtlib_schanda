...
(define-fun l__split_fields35 () us_split_fields (mk___split_fields l__split_fields2))
...
(define-fun l__split_fields36 () us_split_fields (mk___split_fields l__split_fields1))
...
(assert (and (= o30 o29) (in_range5 o29)))
(assert (= (m_elements_swapped (model__ (mk___rep l__split_discrs l__split_fields33)) (model__ (mk___rep l__split_discrs my_vectors__v__swap__container__fields)) 1 o30) true))
(assert (= result45 (mk___split_fields__ref l__split_fields33)))
(assert (= l__split_fields34 my_vectors__v__swap__container__fields))
(assert (not (not (= (is_sorted (mk___rep l__split_discrs l__split_fields34)) true))))
(check-sat)
(exit)
