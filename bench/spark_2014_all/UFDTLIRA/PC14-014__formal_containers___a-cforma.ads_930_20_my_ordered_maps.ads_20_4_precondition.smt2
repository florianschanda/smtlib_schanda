...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__my_ordered_maps__n__cursor__node count_type)))))
(define-fun us_split_fields_Node__2__projection ((a us_split_fields)) count_type (rec__my_ordered_maps__n__cursor__node a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__my_ordered_maps__n__cursor__node (us_split_fields1 a))) (to_rep (rec__my_ordered_maps__n__cursor__node (us_split_fields1 b)))) true false))
...
(define-fun key_type__ref___6__projection ((a key_type__ref)) us_rep (key_type__content a))
...
(define-fun map__ref___6__projection ((a map__ref)) us_rep1 (map__content a))
...
(define-fun dynamic_invariant ((temp___expr_646 Int) (temp___is_init_642 Bool) (temp___skip_constant_643 Bool) (temp___do_toplevel_644 Bool) (temp___do_typ_inv_645 Bool)) Bool (=> (or (= temp___is_init_642 true) (<= 1 2147483647)) (in_range2 temp___expr_646)))
...
(define-fun default_initial_assumption ((temp___expr_654 us_rep1) (temp___skip_top_level_655 Bool)) Bool (=> (not (= temp___skip_top_level_655 true)) (and (= (is_empty temp___expr_654) true) (= (length temp___expr_654) 0))))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__my_ordered_maps__n__map us_main_type1)))))
(define-fun us_split_fields_Map__2__projection ((a us_split_fields2)) us_main_type1 (rec__my_ordered_maps__n__map a))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__my_ordered_maps__n__map__capacity (us_split_discrs1 a))) (to_rep (rec__my_ordered_maps__n__map__capacity (us_split_discrs1 b)))) (= (us_main_eq1 (rec__my_ordered_maps__n__map (us_split_fields3 a)) (rec__my_ordered_maps__n__map (us_split_fields3 b))) true)) true false))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__my_ordered_maps__n__map__capacity (us_split_discrs1 container1)))) (dynamic_invariant2 result true false true true))) :pattern ((length1 container1)))))
...
(define-fun default_initial_assumption1 ((temp___expr_593 us_rep4) (temp___skip_top_level_594 Bool)) Bool (=> (not (= temp___skip_top_level_594 true)) (and (= (is_empty1 temp___expr_593) true) (= (length2 temp___expr_593) 0))))
(assert true)
...
(assert (forall ((container1 us_rep4)) (! (dynamic_invariant2 (length2 container1) true false true true) :pattern ((length2 container1)))))
(assert (forall ((left us_rep4) (right us_rep4)) (! (= (= (oeq1 left right) true) (and (forall ((key us_rep3)) (=> (= (has_key1 left key) true) (and (= (has_key1 right key) true) (= (get1 right key) (get1 left key))))) (forall ((key us_rep3)) (=> (= (has_key1 right key) true) (= (has_key1 left key) true))))) :pattern ((oeq1 left right)))))
...
(assert true)
(assert (forall ((container1 us_rep4)) (forall ((key us_rep3)) (! (=> (= (has_key1 container1 key) true) (let ((result (witness1 container1 key))) (and (= (has_witness container1 result) true) (dynamic_invariant2 result true false true true)))) :pattern ((witness1 container1 key))))))
(assert (forall ((container1 us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant2 witness2 true true true true) (= (has_witness container1 witness2) true)) (dynamic_invariant3 (w_get1 container1 witness2) true false true true)) :pattern ((w_get1 container1 witness2))))))
...
(assert (forall ((container1 us_rep1)) (! (dynamic_invariant2 (length container1) true false true true) :pattern ((length container1)))))
...
(assert true)
(assert (forall ((container1 us_rep1)) (forall ((key us_rep)) (! (=> (= (has_key container1 key) true) (let ((result (witness container1 key))) (and (= (has_witness1 container1 result) true) (dynamic_invariant2 result true false true true)))) :pattern ((witness container1 key))))))
(assert (forall ((container1 us_rep1)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant2 witness2 true true true true) (= (has_witness1 container1 witness2) true)) (dynamic_invariant (w_get container1 witness2) true false true true)) :pattern ((w_get container1 witness2))))))
