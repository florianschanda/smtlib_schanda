...
(assert (= e2 1))
(assert (=> (and (<= 1 e2) (<= e2 3)) (= temp___486 e2)))
(assert (=> (and (<= 1 e2) (<= e2 3)) (= temp___485 (mk___rep l1__split_discrs l1__split_fields5))))
(assert (=> (and (<= 1 e2) (<= e2 3)) (= (length (mk___rep l1__split_discrs l1__split_fields6)) (- e3 1))))
(assert (=> (and (<= 1 e2) (<= e2 3)) (and (=> (<= 1 3) (in_range8 e3)) (and (<= 1 e3) (<= e3 3)))))
(assert (=> (and (<= 1 e2) (<= e2 3)) (and (and (and (and (and (= (length (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3)) (+ (length (mk___rep l1__split_discrs l1__split_fields6)) 1)) (= (get1 (positions (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3)) (last1 (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3))) (length (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3)))) (= (keys_included_except (positions (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3)) (positions (mk___rep l1__split_discrs l1__split_fields6)) (last1 (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3))) true)) (= (ole1 (positions (mk___rep l1__split_discrs l1__split_fields6)) (positions (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3))) true)) (= (get (model__ (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3)) (length (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3))) e3)) (= (ole (model__ (mk___rep l1__split_discrs l1__split_fields6)) (model__ (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3))) true))))
(assert (=> (and (<= 1 e2) (<= e2 3)) (= result21 (mk___split_fields__ref l1__split_fields6))))
(assert (=> (and (<= 1 e2) (<= e2 3)) (= l1__split_fields7 formal_container__vdll__append__container__fields3)))
(assert (=> (and (<= 1 e2) (<= e2 3)) (= e3 3)))
(assert (=> (and (<= 1 e2) (<= e2 3)) (= e4 (mk_int__ref e3))))
(assert (=> (and (<= 1 e2) (<= e2 3)) (= l1__split_fields8 (mk___split_fields__ref l1__split_fields7))))
(assert (=> (and (<= 1 e2) (<= e2 3)) (= e5 e3)))
(assert (=> (and (<= 1 e2) (<= e2 3)) (= l1__split_fields9 l1__split_fields7)))
(assert (=> (and (<= 1 e2) (<= e2 3)) (= e6 e4)))
(assert (=> (and (<= 1 e2) (<= e2 3)) (= l1__split_fields10 l1__split_fields8)))
(assert (=> (and (<= 1 e2) (<= e2 3)) (= e7 e5)))
(assert (=> (and (<= 1 e2) (<= e2 3)) (= l1__split_fields11 l1__split_fields9)))
(assert (=> (not (and (<= 1 e2) (<= e2 3))) (= e6 (mk_int__ref e2))))
(assert (=> (not (and (<= 1 e2) (<= e2 3))) (= l1__split_fields10 (mk___split_fields__ref l1__split_fields5))))
(assert (=> (not (and (<= 1 e2) (<= e2 3))) (= e7 e2)))
(assert (=> (not (and (<= 1 e2) (<= e2 3))) (= l1__split_fields11 l1__split_fields5)))
