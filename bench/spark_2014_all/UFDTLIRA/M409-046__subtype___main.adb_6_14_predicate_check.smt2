...
(define-fun dynamic_invariant1 ((temp___expr_185 Int) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool) (temp___do_typ_inv_184 Bool)) Bool (and (=> (or (= temp___is_init_181 true) (<= 1 2147483647)) (in_range1 temp___expr_185)) (=> (= temp___do_toplevel_183 true) (=> (= temp___is_init_181 true) (or (and (<= 1 temp___expr_185) (<= temp___expr_185 9)) (and (<= 21 temp___expr_185) (<= temp___expr_185 2147483647)))))))
...
(assert (= v1 12))
(assert (in_range v1))
(assert (not (or (and (<= 1 v1) (<= v1 9)) (and (<= 21 v1) (<= v1 2147483647)))))
(check-sat)
(exit)
