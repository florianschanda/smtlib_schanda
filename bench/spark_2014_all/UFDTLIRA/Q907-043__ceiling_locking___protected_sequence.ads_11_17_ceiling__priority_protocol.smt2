...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__protected_sequence__data integer)))))
(define-fun us_split_fields_Data__projection ((a us_split_fields)) integer (rec__protected_sequence__data a))
...
(define-fun default_initial_assumption ((temp___expr_201 us_rep) (temp___skip_top_level_202 Bool)) Bool (= (to_rep (rec__protected_sequence__data (us_split_fields1 temp___expr_201))) 0))
