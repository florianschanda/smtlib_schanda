...
(assert (and (and (and (= (local_invariant current_read__split_fields3 current_read__split_discrs3 next_read__split_fields2 next_read__split_discrs2) true) (= (bool_eq (mk___rep current_read__split_discrs3 current_read__split_fields3 current_read__attr__constrained) (mk___rep next_read__split_discrs1 next_read__split_fields1 next_read__attr__constrained)) true)) (<= current_pos2 current_pos3)) (and (and (in_range2 current_line3) (in_range1 current_col3)) (in_range1 current_pos3))))
(assert (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs3)) 0))
(assert (not (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs3)) 0)))
(check-sat)
(exit)
