...
(define-fun o9 () us_rep2 (mk___rep1 (mk___split_fields1 o6)))
(define-fun o10 () us_rep2 (mk___rep1 (mk___split_fields1 o4)))
...
(assert (and (= o11 (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq2 o11 no_element) true) (and (= (has_key (positions l) o11) true) (= (get1 (positions l) o11) 1)))))
(assert (= temp___547 o))
...
(assert (and (= o10 (next l temp___5471)) (ite (= (ite (= (bool_eq2 temp___5471 no_element) false) (= (get1 (positions l) temp___5471) (length1 l)) true) true) (= (bool_eq2 o10 no_element) true) (and (= (has_key (positions l) o10) true) (= (get1 (positions l) o10) (+ (get1 (positions l) temp___5471) 1))))))
...
(assert (< 0 count_04))
(assert (not (exists ((cu us_rep2)) (and (= (has_key (positions l) cu) true) (= (element l cu) 0)))))
(check-sat)
(exit)
