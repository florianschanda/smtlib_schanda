...
(declare-const r__split_fields7 us_split_fields__ref1)
(declare-const r__split_fields8 us_split_fields2)
(define-fun r__split_fields9 () us_split_fields2 (mk___split_fields1 r__split_fields3 (mk___rep (mk___split_fields r__split_fields4 r__split_fields5))))
(assert (in_range x))
(assert (= (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields r__split_fields1 r__split_fields2)))) r_old))
(assert (= (bool_eq1 (mk___rep1 r__split_fields9) (mk___rep1 (mk___split_fields1 (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 r_old)) (mk___rep (mk___split_fields (of_rep x) (rec__records_prooffuncs__pair__b (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 r_old))))))))) true))
(assert (= result (mk___split_fields__ref1 r__split_fields9)))
(assert (= r__split_fields6 (mk___split_fields1 r__split_fields3 (mk___rep (mk___split_fields r__split_fields4 rliteral)))))
(assert (= r__split_fields7 (mk___split_fields__ref1 r__split_fields6)))
(assert (= r__split_fields8 r__split_fields6))
(assert (not (= (bool_eq1 (mk___rep1 (us_split_fields__content1 r__split_fields7)) (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields (of_rep x) (of_rep x)))))) true)))
(check-sat)
(exit)
