...
(assert (and (= o10 (last (model__ (mk___rep l__split_discrs l__split_fields19)))) (and (in_range4 o10) (= o10 (last (model__ (mk___rep l__split_discrs l__split_fields19)))))))
(assert (not (in_range1 (+ c3 3))))
(check-sat)
(exit)
