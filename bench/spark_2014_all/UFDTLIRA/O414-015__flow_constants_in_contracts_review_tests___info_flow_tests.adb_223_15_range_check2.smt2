...
(assert (forall ((i tt4B)) (and (<= (- 2147483648) (tt4Bqtint i)) (<= (tt4Bqtint i) 2147483647))))
...
(assert (= last1 last))
(define-fun dynamic_invariant3 ((temp___expr_256 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= 0 last2)) (dynamic_property2 0 last2 temp___expr_256)))
(assert (= last2 last1))
(declare-const c Int)
(declare-const d Int)
(declare-const e Int)
