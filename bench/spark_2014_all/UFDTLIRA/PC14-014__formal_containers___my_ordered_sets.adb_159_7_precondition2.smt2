...
(assert (and (= temp___11891 (next (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep2 c__split_fields3))) (ite (= (ite (= (bool_eq3 (mk___rep2 c__split_fields3) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields3)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq3 temp___11891 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___11891) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___11891) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields3)) 1))))))
(assert (= result1 c__split_fields1))
(assert (= c__split_fields2 temp___1189))
(assert (not (< (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (to_rep (rec__my_ordered_sets__n__set__capacity l__split_discrs)))))
(check-sat)
(exit)
