...
(define-fun tt1B__ref___2__projection ((a tt1B__ref)) tt1B (tt1B__content a))
...
(define-fun t1__ref___2__projection ((a t1__ref)) tt1B (t1__content a))
(declare-sort tt2B 0)
...
(define-fun tt2B__ref___2__projection ((a tt2B__ref)) tt2B (tt2B__content a))
...
(define-fun t2__ref___2__projection ((a t2__ref)) tt2B (t2__content a))
(declare-const c1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(define-fun dynamic_invariant1 ((temp___expr_172 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 0 last)) (dynamic_property 0 last temp___expr_172)))
(assert (= last c1))
(declare-const c2 Int)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(define-fun dynamic_invariant2 ((temp___expr_179 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 0 last1)) (dynamic_property1 0 last1 temp___expr_179)))
(assert (= last1 c2))
(declare-const a Int)
(declare-const b Int)
(declare-const o Int)
