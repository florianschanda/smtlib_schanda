...
(define-fun dynamic_invariant3 ((temp___expr_1596 Int) (temp___is_init_1592 Bool) (temp___skip_constant_1593 Bool) (temp___do_toplevel_1594 Bool) (temp___do_typ_inv_1595 Bool)) Bool (=> (or (= temp___is_init_1592 true) (<= 0 2147483647)) (in_range5 temp___expr_1596)))
...
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o) (= o (ite (= (distinct 1 0) true) (to_rep (rec__dic_of_cont__my_fove__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
