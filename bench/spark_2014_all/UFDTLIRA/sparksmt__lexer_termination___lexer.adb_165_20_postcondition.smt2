...
(declare-const temp___991 read_status)
(declare-const temp___9911 character)
(declare-const temp___9912 Bool)
(declare-const o Int)
...
(assert (= usq_ temp___991))
(assert (= usq_1 temp___9911))
(assert (= current_read__attr__constrained temp___9912))
(assert (= result (mk___split_fields__ref (mk___split_fields current_read__split_fields))))
(assert (= current_read__split_fields1 (mk___split_fields temp___9911)))
(assert (= result1 (mk___split_discrs__ref (mk___split_discrs current_read__split_discrs))))
(assert (= current_read__split_discrs1 (mk___split_discrs temp___991)))
