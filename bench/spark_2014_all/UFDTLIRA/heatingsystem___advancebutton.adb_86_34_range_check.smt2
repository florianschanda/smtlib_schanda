...
(define-fun dynamic_invariant ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 0 86399)) (in_range1 temp___expr_158)))
...
(declare-const advpressed1 Bool)
(assert (in_range1 advtimer))
(assert (in_range1 period))
(assert (=> (<= 0 86399) (in_range1 timenow)))
(assert (in_range1 timenow1))
(assert (= result advpressed))
(assert (= advpressed1 stillpressed))
(assert (= stillpressed true))
(assert (<= period (- timenow1 advtimer)))
(assert (not (in_range1 (+ advtimer period))))
(check-sat)
(exit)
