...
(declare-const temp___7326 us_rep3)
(declare-const o17 enum1t)
(declare-const o18 us_split_fields6)
(declare-const temp___7328 us_rep3)
...
(assert (and (= o (to_rep r__split_fields5)) (in_range2 (to_rep r__split_fields5))))
(assert (= (to_rep1 o1) o))
...
(assert (= temp___7326 (mk___rep3 o16)))
