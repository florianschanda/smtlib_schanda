...
(define-fun default_initial_assumption ((temp___expr_160 us_rep) (temp___skip_top_level_161 Bool)) Bool (and (= (attr__constrained temp___expr_160) false) (and (= (to_rep (rec__constrained_attribute__mut_rec__d (us_split_discrs1 temp___expr_160))) 0) (= (to_rep (rec__constrained_attribute__mut_rec__f (us_split_fields1 temp___expr_160))) 0))))
(declare-const r us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_18)))
(declare-const constrained_attribute__is_constrained__result Bool)
(declare-const result Bool)
(declare-const constrained_attribute__is_constrained__result1 Bool)
(declare-const constrained_attribute__is_constrained__result2 Bool)
(declare-const constrained_attribute__is_constrained__result3 Bool)
(declare-const constrained_attribute__is_constrained__result4 Bool)
(declare-const constrained_attribute__is_constrained__result5 Bool)
(declare-const result1 Bool)
(assert (= constrained_attribute__is_constrained__result1 constrained_attribute__is_constrained__result2))
(assert (= constrained_attribute__is_constrained__result3 constrained_attribute__is_constrained__result1))
(assert (= result constrained_attribute__is_constrained__result))
(assert (= constrained_attribute__is_constrained__result1 true))
(assert (= (mk_bool__ref constrained_attribute__is_constrained__result4) (mk_bool__ref constrained_attribute__is_constrained__result2)))
(assert (= constrained_attribute__is_constrained__result5 constrained_attribute__is_constrained__result3))
(assert (= result1 constrained_attribute__is_constrained__result4))
(assert (not (= constrained_attribute__is_constrained__result4 true)))
(check-sat)
(exit)
