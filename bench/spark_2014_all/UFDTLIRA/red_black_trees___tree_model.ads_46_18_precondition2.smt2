...
(assert (<= (length q) 100))
(assert (and (= o19 (length q)) (and (in_range1 o19) (<= (+ 0 o19) 2147483647))))
(assert (and (= o16 (length v)) (and (in_range1 o16) (<= (+ 0 o16) 2147483647))))
(assert (and (= o17 (length p)) (and (in_range1 o17) (<= (+ 0 o17) 2147483647))))
(assert (= o18 (- o17 o16)))
(assert (and (= o20 o18) (in_range4 o18)))
(assert (= result2 (ite (= o20 o19) true false)))
(assert (=> (= result2 true) (and (= o14 (length q)) (and (in_range1 o14) (<= (+ 0 o14) 2147483647)))))
(assert (=> (= result2 true) (= o15 (ite (<= i2 o14) true false))))
(assert (=> (= result2 true) (= result3 (ite (<= 1 i2) o15 false))))
...
(assert (=> (= result1 true) (and (= o12 (length v)) (and (in_range1 o12) (<= (+ 0 o12) 2147483647)))))
(assert (=> (= result1 true) (= o13 (ite (<= i1 o12) true false))))
(assert (=> (= result1 true) (= result4 (ite (<= 1 i1) o13 false))))
...
(assert (and (= o11 (get p o10)) (in_range2 o11)))
