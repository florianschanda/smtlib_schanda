...
(assert (= o i))
(assert (and (and (and (and (= (length (mk___rep v__split_discrs v__split_fields6)) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))) 1)) (= (range_equal (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (model__ (mk___rep v__split_discrs v__split_fields6)) first2 (- o 1)) true)) (= (get (model__ (mk___rep v__split_discrs v__split_fields6)) o) 0)) (= (range_shifted (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (model__ (mk___rep v__split_discrs v__split_fields6)) o (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))) 1) true)) (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)))))
(assert (and (= us1 i) (dynamic_property4 first3 last5 i)))
(assert (= o1 i))
(assert (and (and (and (and (= (length (mk___rep v__split_discrs v__split_fields5)) (+ (length (mk___rep v__split_discrs v__split_fields6)) 1)) (= (range_equal (model__ (mk___rep v__split_discrs v__split_fields6)) (model__ (mk___rep v__split_discrs v__split_fields5)) first2 (- o1 1)) true)) (= (get (model__ (mk___rep v__split_discrs v__split_fields5)) o1) 0)) (= (range_shifted (model__ (mk___rep v__split_discrs v__split_fields6)) (model__ (mk___rep v__split_discrs v__split_fields5)) o1 (last2 (model__ (mk___rep v__split_discrs v__split_fields6))) 1) true)) (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)))))
(assert (and (= us2 i) (dynamic_property4 first3 last5 i)))
(assert (= o2 i))
(assert (and (and (and (and (= (length (mk___rep v__split_discrs v__split_fields4)) (+ (length (mk___rep v__split_discrs v__split_fields5)) 1)) (= (range_equal (model__ (mk___rep v__split_discrs v__split_fields5)) (model__ (mk___rep v__split_discrs v__split_fields4)) first2 (- o2 1)) true)) (= (get (model__ (mk___rep v__split_discrs v__split_fields4)) o2) 0)) (= (range_shifted (model__ (mk___rep v__split_discrs v__split_fields5)) (model__ (mk___rep v__split_discrs v__split_fields4)) o2 (last2 (model__ (mk___rep v__split_discrs v__split_fields5))) 1) true)) (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)))))
(assert (and (= us3 i) (dynamic_property4 first3 last5 i)))
(assert (= o3 i))
(assert (not (< (length (mk___rep v__split_discrs v__split_fields4)) (capacity (mk___rep v__split_discrs v__split_fields4)))))
(check-sat)
(exit)
