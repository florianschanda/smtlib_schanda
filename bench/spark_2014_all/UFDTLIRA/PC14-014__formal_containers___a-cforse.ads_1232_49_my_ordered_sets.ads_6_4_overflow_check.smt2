...
(define-fun equivalent_elements ((left1 Int) (right1 Int)) Bool (and (not (< left1 right1)) (not (< right1 left1))))
...
(define-fun dynamic_invariant1 ((temp___expr_316 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool) (temp___do_typ_inv_315 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= 0 2147483647)) (in_range3 temp___expr_316)))
(define-fun last ((container us_rep1)) Int (+ 0 (length1 container)))
(declare-fun last__function_guard (Int us_rep1) Bool)
(define-fun oeq1 ((left1 us_rep1) (right1 us_rep1)) Bool (and (= (length1 left1) (length1 right1)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left1))) (= (get left1 n) (get right1 n)))) true false)))
...
(define-fun e_elements_included ((left1 us_rep1) (right1 us_rep1)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 left1))) (and (< 0 (find right1 (get left1 i))) (= (get right1 (find right1 (get left1 i))) (get left1 i))))) true false))
...
(define-fun default_initial_assumption1 ((temp___expr_354 us_rep2) (temp___skip_top_level_355 Bool)) Bool (=> (not (= temp___skip_top_level_355 true)) (= (is_empty temp___expr_354) true)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length1 result) (length container)) (forall ((temp___428 Int)) (=> (and (in_range5 temp___428) (= (iter_has_element result temp___428) true)) (= (contains (model__ container) (get result temp___428)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container)))))
(assert (forall ((left1 us_rep) (right1 us_rep)) (! (ite (= (oeq left1 right1) true) (= (oeq1 (elements left1) (elements right1)) true) (or (not (= (e_elements_included (elements left1) (elements right1)) true)) (not (= (e_elements_included (elements right1) (elements left1)) true)))) :pattern ((oeq left1 right1)))))
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant3 ((temp___expr_382 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool) (temp___do_typ_inv_381 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= 0 2147483647)) (in_range5 temp___expr_382)))
...
(define-fun dynamic_invariant4 ((temp___expr_375 Int) (temp___is_init_371 Bool) (temp___skip_constant_372 Bool) (temp___do_toplevel_373 Bool) (temp___do_typ_inv_374 Bool)) Bool (=> (or (= temp___is_init_371 true) (<= 0 2147483647)) (in_range6 temp___expr_375)))
...
(assert (and (= o (length right)) (and (in_range o) (<= o (to_rep (rec__my_ordered_sets__m__set__capacity (us_split_discrs1 right)))))))
