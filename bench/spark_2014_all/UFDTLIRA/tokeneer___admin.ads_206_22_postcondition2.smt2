...
(define-fun dynamic_invariant2 ((temp___expr_479 Int) (temp___is_init_475 Bool) (temp___skip_constant_476 Bool) (temp___do_toplevel_477 Bool) (temp___do_typ_inv_478 Bool)) Bool (=> (or (= temp___is_init_475 true) (<= 1 4)) (in_range3 temp___expr_479)))
...
(declare-const o opandnullt)
(declare-const o1 privileget)
(declare-const o2 opandnullt)
(declare-const temp___604 privileget)
(declare-const temp___6041 opandnullt)
...
(assert (= o o2))
(assert (= temp___604 o1))
(assert (= temp___6041 o2))
(assert (= result theadmin__split_fields))
(assert (= result1 theadmin__split_fields1))
(assert (= temp___604 theadmin__split_fields2))
(assert (= temp___6041 theadmin__split_fields3))
...
(assert (not (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields4 theadmin__split_fields5))) true))))
(check-sat)
(exit)
