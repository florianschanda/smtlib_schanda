...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__hnco__test2__v_type_owner__vector_type_owner__vector us_main_type1)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields)) us_main_type1 (rec__hnco__test2__v_type_owner__vector_type_owner__vector a))
...
(define-fun dynamic_invariant ((temp___expr_420 Int) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool (=> (or (= temp___is_init_416 true) (<= 0 2147483647)) (in_range2 temp___expr_420)))
...
(define-fun dynamic_invariant1 ((temp___expr_406 Int) (temp___is_init_402 Bool) (temp___skip_constant_403 Bool) (temp___do_toplevel_404 Bool) (temp___do_typ_inv_405 Bool)) Bool (=> (or (= temp___is_init_402 true) (<= 1 2147483647)) (in_range3 temp___expr_406)))
...
(define-fun capacity ((container1 us_rep1)) Int (ite (= (distinct 1 0) true) (to_rep (rec__hnco__test2__v_type_owner__vector_type_owner__vector__capacity (us_split_discrs1 container1))) 2147483647))
