...
(assert (forall ((container us_rep)) (! (=> (not (= (is_empty container) true)) (let ((result (first_element container))) (and (and (= result (get (elements container) 1)) (= (e_smaller_than_range (elements container) 2 (length container) result) true)) (dynamic_invariant2 result true false true true)))) :pattern ((first_element container)))))
...
(define-fun e_bigger_than_range ((container1 us_rep1) (fst Int) (lst Int) (item1 Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt (get container1 i) item1) true))) true false))
