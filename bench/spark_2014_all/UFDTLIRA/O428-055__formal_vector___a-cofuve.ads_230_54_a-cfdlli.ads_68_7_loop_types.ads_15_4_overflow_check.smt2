...
(define-fun dynamic_invariant2 ((temp___expr_425 Int) (temp___is_init_421 Bool) (temp___skip_constant_422 Bool) (temp___do_toplevel_423 Bool) (temp___do_typ_inv_424 Bool)) Bool (=> (or (= temp___is_init_421 true) (<= 1 2147483647)) (in_range4 temp___expr_425)))
...
(define-fun dynamic_invariant3 ((temp___expr_432 Int) (temp___is_init_428 Bool) (temp___skip_constant_429 Bool) (temp___do_toplevel_430 Bool) (temp___do_typ_inv_431 Bool)) Bool (=> (or (= temp___is_init_428 true) (<= 0 2147483647)) (in_range5 temp___expr_432)))
