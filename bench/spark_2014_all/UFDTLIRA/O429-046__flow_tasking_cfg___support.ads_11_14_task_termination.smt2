...
(declare-const us_self__compl1 natural)
(declare-const result natural)
(declare-const prot__split_fields1 natural)
(assert (not (not (and (and (= o prot__split_fields) (= us_self__compl o)) (and (= result prot__split_fields) (= prot__split_fields1 us_self__compl1))))))
(check-sat)
(exit)
