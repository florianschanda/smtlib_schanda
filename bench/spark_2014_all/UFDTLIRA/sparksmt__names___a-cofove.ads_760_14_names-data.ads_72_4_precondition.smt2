...
(declare-fun user_eq2 (char_table_index char_table_index) Bool)
(declare-const dummy2 char_table_index)
...
(assert (forall ((x char_table_index)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(declare-datatypes () ((name_entry__ref (mk_name_entry__ref (name_entry__content us_rep)))))
(define-fun name_entry__ref___projection ((a name_entry__ref)) us_rep (name_entry__content a))
(declare-datatypes () ((element_type__ref (mk_element_type__ref (element_type__content us_rep)))))
(define-fun element_type__ref___4__projection ((a element_type__ref)) us_rep (element_type__content a))
...
(define-fun vector__ref___2__projection ((a vector__ref)) us_rep2 (vector__content a))
(declare-fun model__ (us_rep2) us_rep1)
(declare-fun model____function_guard (us_rep1 us_rep2) Bool)
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(define-fun oeq ((left us_rep1) (right us_rep1)) Bool (and (= (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (bool_eq (get left n) (get right n)) true))) true false)))
(declare-fun oeq__function_guard (Bool us_rep1 us_rep1) Bool)
(assert (forall ((a us_rep1) (b us_rep1)) (! (= (user_eq4 a b) (oeq a b)) :pattern ((user_eq4 a b)))))
(define-fun default_initial_assumption ((temp___expr_483 us_rep1) (temp___skip_top_level_484 Bool)) Bool (=> (not (= temp___skip_top_level_484 true)) (= (length temp___expr_483) 0)))
...
(define-fun dynamic_invariant ((temp___expr_434 Int) (temp___is_init_430 Bool) (temp___skip_constant_431 Bool) (temp___do_toplevel_432 Bool) (temp___do_typ_inv_433 Bool)) Bool (=> (or (= temp___is_init_430 true) (<= 0 2147483647)) (in_range5 temp___expr_434)))
...
(define-fun dynamic_invariant1 ((temp___expr_417 Int) (temp___is_init_413 Bool) (temp___skip_constant_414 Bool) (temp___do_toplevel_415 Bool) (temp___do_typ_inv_416 Bool)) Bool (=> (or (= temp___is_init_413 true) (<= 1 2147483647)) (in_range6 temp___expr_417)))
...
(define-fun element_type__ref___3__projection ((a element_type__ref1)) us_rep (element_type__content1 a))
...
(define-fun dynamic_invariant3 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 2147483646)) (in_range3 temp___expr_249)))
(define-fun dynamic_invariant4 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 2147483647)) (in_range2 temp___expr_173)))
...
(define-fun dynamic_invariant5 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 2147483647)) (in_range7 temp___expr_166)))
(define-fun dynamic_invariant6 ((temp___expr_441 Int) (temp___is_init_437 Bool) (temp___skip_constant_438 Bool) (temp___do_toplevel_439 Bool) (temp___do_typ_inv_440 Bool)) Bool (=> (or (= temp___is_init_437 true) (<= 0 2147483647)) (in_range4 temp___expr_441)))
...
(define-fun capacity ((container1 us_rep2)) Int (ite (= (distinct 0 0) true) (to_rep3 (rec__names__data__entry_tables__vector__capacity (us_split_discrs1 container1))) 2147483647))
(declare-fun capacity__function_guard (Int us_rep2) Bool)
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (capacity container1)) (dynamic_invariant6 result true false true true))) :pattern ((length1 container1)))))
...
(define-fun dynamic_invariant7 ((temp___expr_475 Int) (temp___is_init_471 Bool) (temp___skip_constant_472 Bool) (temp___do_toplevel_473 Bool) (temp___do_typ_inv_474 Bool)) Bool (=> (or (= temp___is_init_471 true) (<= 0 2147483647)) (in_range8 temp___expr_475)))
(assert (forall ((container1 us_rep1)) (! (let ((result (length container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant5 result true false true true))) :pattern ((length container1)))))
(assert true)
(declare-const o us_rep1)
(declare-const o1 Int)
(declare-const o2 Int)
(declare-const result Bool)
(assert (in_range6 index))
