...
(declare-const tests__test_15__R17b__assume Bool)
(declare-const tests__test_15__R17b__assume1 Bool)
(declare-const tests__test_15__R17b__assume2 natural)
(declare-const tests__test_15__R17b__assume3 Bool)
(define-fun tests__test_15__R17b__assume4 () us_rep1 (mk___rep1 (mk___split_discrs1 tests__test_15__R17b__assume) (mk___split_fields1 (mk___rep (mk___split_discrs tests__test_15__R17b__assume1) (mk___split_fields tests__test_15__R17b__assume2) tests__test_15__R17b__assume3))))
(assert (and (= (rec__tests__test_15__holder__present h1__split_discrs) (distinct 0 0)) (and (= h1__split_fields2 true) (= h1__split_fields (distinct 0 0)))))
(assert (dynamic_invariant1 (mk___rep2 h1__split_discrs (mk___split_fields2 (mk___rep (mk___split_discrs h1__split_fields) (mk___split_fields h1__split_fields1) h1__split_fields2))) false false true true))
(assert (and (= tests__test_15__R17b__assume4 (id (mk___rep1 h1__split_discrs (mk___split_fields1 (mk___rep (mk___split_discrs h1__split_fields) (mk___split_fields h1__split_fields1) h1__split_fields2))))) (and (dynamic_invariant tests__test_15__R17b__assume4 true false true true) (and (= h1__split_discrs (mk___split_discrs1 tests__test_15__R17b__assume)) (and (= h1__split_fields tests__test_15__R17b__assume1) (and (= h1__split_fields1 tests__test_15__R17b__assume2) (= h1__split_fields2 tests__test_15__R17b__assume3)))))))
(assert (= tests__test_15__R17b__assume4 r17b))
(assert (dynamic_invariant r17b true false true true))
(assert (not (in_range (ite (rec__tests__test_15__holder__present (us_split_discrs3 r17b)) 1 0))))
(check-sat)
(exit)
