...
(assert (and (= o15 (last1 left)) (and (dynamic_property1 first1 last2 o15) (= o15 (+ (- first 1) (length left))))))
(assert (= result (ite (<= lst1 o15) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o13 first) (in_range3 first))))
(assert (=> (< offset 0) (and (= o14 (- (- 2147483648) offset)) (in_range3 (- (- 2147483648) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o14 o13) true false))))
(assert (=> (not (< offset 0)) (= result1 (distinct 1 0))))
(assert (= result1 true))
(assert (<= fst1 lst1))
(assert (and (= o8 lst1) (in_range3 lst1)))
(assert (and (= o5 (length right)) (and (in_range1 o5) (<= (+ (- first 1) o5) last))))
(assert (and (= o3 first) (in_range3 first)))
(assert (= o4 (- o3 1)))
(assert (and (= o6 o4) (in_range3 o4)))
(assert (= o7 (+ o6 o5)))
(assert (and (= o9 o7) (in_range3 o7)))
(assert (= o10 (- o9 o8)))
(assert (and (= o11 o10) (in_range3 o10)))
(assert (= o12 (ite (<= offset o11) true false)))
(assert (and (= o fst1) (in_range3 fst1)))
(assert (and (= o1 first) (in_range3 first)))
(assert (= o2 (- o1 o)))
