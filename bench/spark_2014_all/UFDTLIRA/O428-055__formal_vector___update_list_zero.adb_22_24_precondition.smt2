...
(assert (and (= o1 (length (mk___rep l__split_discrs l__split_fields1))) (and (in_range1 o1) (<= o1 (to_rep (rec__loop_types__lists__list__capacity l__split_discrs))))))
...
(assert (not (= (has_key o (mk___rep1 cu__split_fields2)) true)))
(check-sat)
(exit)
