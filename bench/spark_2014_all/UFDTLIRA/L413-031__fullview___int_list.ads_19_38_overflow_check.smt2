...
(assert (and (= o3 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields2)) o4)) (and (in_range2 o3) (= o3 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) o4))))))
(assert (= result (ite (= o3 i) true false)))
(assert (= result true))
(assert (and (= o (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (in_range1 o) (<= o (to_rep (rec__int_list__my_lists__list__capacity l__split_discrs))))))
(assert (= o1 (+ o 1)))
