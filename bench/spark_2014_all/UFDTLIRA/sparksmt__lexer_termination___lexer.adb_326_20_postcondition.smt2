...
(declare-const o6 name_id)
(declare-const o7 token_kind)
(declare-const temp___1058 token_kind)
(declare-const temp___10581 natural)
(declare-const temp___10582 natural)
(declare-const temp___10583 natural)
(declare-const temp___10584 name_id)
(declare-const temp___10585 Bool)
...
(declare-const temp___1060 token_kind)
(declare-const temp___10601 natural)
(declare-const temp___10602 natural)
(declare-const temp___10603 natural)
(declare-const temp___10604 name_id)
(declare-const temp___10605 Bool)
...
(declare-const o15 token_kind)
(declare-const temp___1061 token_kind)
(declare-const temp___10611 natural)
(declare-const temp___10612 natural)
(declare-const temp___10613 natural)
(declare-const temp___10614 name_id)
(declare-const temp___10615 Bool)
(declare-const usq_6 us_rep)
(declare-const temp___1063 us_rep)
...
(define-fun t__split_discrs5 () us_split_discrs__ref (mk___split_discrs__ref (mk___split_discrs t__split_discrs)))
(define-fun t__split_fields8 () us_split_fields__ref (mk___split_fields__ref (mk___split_fields t__split_fields t__split_fields1 t__split_fields2 t__split_fields3)))
...
(assert (=> (= kind 1) (= (to_rep1 t__split_discrs) r22b)))
(assert (=> (= kind 1) (in_range3 r22b)))
(assert (=> (= kind 1) (= (to_rep o1) first_col)))
(assert (=> (= kind 1) (= (to_rep o2) first_line)))
(assert (=> (= kind 1) (= o2 o3)))
(assert (=> (= kind 1) (= o1 o4)))
(assert (=> (= kind 1) (= rliteral o5)))
(assert (=> (= kind 1) (= dummy1 o6)))
(assert (=> (= kind 1) (= (to_rep1 o) 1)))
(assert (=> (= kind 1) (= o o7)))
(assert (=> (= kind 1) (= temp___1058 o7)))
(assert (=> (= kind 1) (= temp___10581 o3)))
(assert (=> (= kind 1) (= temp___10582 o4)))
(assert (=> (= kind 1) (= temp___10583 o5)))
(assert (=> (= kind 1) (= temp___10584 o6)))
(assert (=> (= kind 1) (= true temp___10585)))
(assert (=> (= kind 1) (=> (= t__attr__constrained true) (= temp___1058 t__split_discrs))))
(assert (=> (= kind 1) (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1 usq_2 usq_3 usq_4) usq_5) (mk___rep (mk___split_discrs temp___1058) (mk___split_fields temp___10581 temp___10582 temp___10583 temp___10584) temp___10585))))
(assert (=> (= kind 1) (= usq_ temp___1060)))
(assert (=> (= kind 1) (= usq_1 temp___10601)))
(assert (=> (= kind 1) (= usq_2 temp___10602)))
(assert (=> (= kind 1) (= usq_3 temp___10603)))
(assert (=> (= kind 1) (= usq_4 temp___10604)))
(assert (=> (= kind 1) (= t__attr__constrained temp___10605)))
(assert (=> (= kind 1) (= result t__split_fields8)))
(assert (=> (= kind 1) (= t__split_fields4 (mk___split_fields temp___10601 temp___10602 temp___10603 temp___10604))))
(assert (=> (= kind 1) (= result1 t__split_discrs5)))
(assert (=> (= kind 1) (= t__split_discrs1 (mk___split_discrs temp___1060))))
(assert (=> (not (= kind 1)) (= kind 2)))
(assert (=> (not (= kind 1)) (= (to_rep1 t__split_discrs) r25b)))
(assert (=> (not (= kind 1)) (in_range3 r25b)))
(assert (=> (not (= kind 1)) (= (to_rep o9) first_col)))
(assert (=> (not (= kind 1)) (= (to_rep o10) first_line)))
(assert (=> (not (= kind 1)) (= o10 o11)))
(assert (=> (not (= kind 1)) (= o9 o12)))
(assert (=> (not (= kind 1)) (= rliteral o13)))
(assert (=> (not (= kind 1)) (= dummy1 o14)))
(assert (=> (not (= kind 1)) (= (to_rep1 o8) 2)))
(assert (=> (not (= kind 1)) (= o8 o15)))
(assert (=> (not (= kind 1)) (= temp___1061 o15)))
(assert (=> (not (= kind 1)) (= temp___10611 o11)))
(assert (=> (not (= kind 1)) (= temp___10612 o12)))
(assert (=> (not (= kind 1)) (= temp___10613 o13)))
(assert (=> (not (= kind 1)) (= temp___10614 o14)))
(assert (=> (not (= kind 1)) (= true temp___10615)))
(assert (=> (not (= kind 1)) (=> (= t__attr__constrained true) (= temp___1061 t__split_discrs))))
(assert (=> (not (= kind 1)) (= usq_6 (mk___rep (mk___split_discrs temp___1061) (mk___split_fields temp___10611 temp___10612 temp___10613 temp___10614) temp___10615))))
(assert (=> (not (= kind 1)) (= temp___1063 (mk___rep (us_split_discrs1 usq_6) (us_split_fields1 usq_6) t__attr__constrained))))
(assert (=> (not (= kind 1)) (= result2 t__split_fields8)))
(assert (=> (not (= kind 1)) (= t__split_fields5 (us_split_fields1 temp___1063))))
(assert (=> (not (= kind 1)) (= result3 t__split_discrs5)))
(assert (=> (not (= kind 1)) (= t__split_discrs2 (us_split_discrs1 temp___1063))))
...
(assert (not (= (to_rep (rec__lexer__token__line (us_split_fields__content t__split_fields6))) first_line)))
(check-sat)
(exit)
