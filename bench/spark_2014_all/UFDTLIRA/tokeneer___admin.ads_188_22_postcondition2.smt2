...
(assert (forall ((theadmin us_rep)) (! (= (thecurrentop theadmin) (to_rep1 (rec__admin__t__currentop (us_split_fields1 theadmin)))) :pattern ((thecurrentop theadmin)))))
...
(assert (not (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields4 theadmin__split_fields5))) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(check-sat)
(exit)
