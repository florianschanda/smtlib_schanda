...
(assert (<= (length q) 100))
(assert (and (= o17 (length q)) (and (in_range1 o17) (<= (+ 0 o17) 2147483647))))
(assert (and (= o14 (length v)) (and (in_range1 o14) (<= (+ 0 o14) 2147483647))))
(assert (and (= o15 (length p)) (and (in_range1 o15) (<= (+ 0 o15) 2147483647))))
(assert (= o16 (- o15 o14)))
(assert (and (= o18 o16) (in_range4 o16)))
(assert (= result2 (ite (= o18 o17) true false)))
(assert (=> (= result2 true) (and (= o12 (length q)) (and (in_range1 o12) (<= (+ 0 o12) 2147483647)))))
(assert (=> (= result2 true) (= o13 (ite (<= i2 o12) true false))))
(assert (=> (= result2 true) (= result3 (ite (<= 1 i2) o13 false))))
...
(assert (=> (= result1 true) (and (= o10 (length v)) (and (in_range1 o10) (<= (+ 0 o10) 2147483647)))))
(assert (=> (= result1 true) (= o11 (ite (<= i1 o10) true false))))
(assert (=> (= result1 true) (= result4 (ite (<= 1 i1) o11 false))))
...
(assert (and (= o9 (get p o8)) (in_range2 o9)))
