...
(define-fun default_initial_assumption ((temp___expr_375 us_rep) (temp___skip_top_level_376 Bool)) Bool (= (attr__tag temp___expr_375) us_tag))
...
(define-fun default_initial_assumption1 ((temp___expr_382 us_rep) (temp___skip_top_level_383 Bool)) Bool (= (attr__tag temp___expr_382) us_tag1))
