...
(assert (and (= o5 (length (mk___rep l__split_discrs l__split_fields7))) (and (in_range1 o5) (<= o5 (to_rep (rec__my_lists__m__list__capacity l__split_discrs))))))
(assert (and (= o2 (positions (mk___rep l__split_discrs l__split_fields7))) (and (not (= (has_key o2 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o2 i) true) (and (and (<= 1 (get o2 i)) (<= (get o2 i) (length (mk___rep l__split_discrs l__split_fields7)))) (forall ((j us_rep1)) (=> (= (has_key o2 j) true) (=> (= (get o2 i) (get o2 j)) (= (bool_eq1 i j) true))))))))))
(assert (and (= o3 (get o2 (mk___rep1 d__split_fields5))) (and (in_range2 o3) (=> (= (distinct 0 0) true) (and (= o3 (w_get o2 (witness o2 (mk___rep1 d__split_fields5)))) (forall ((k us_rep1)) (=> (= (has_key o2 k) true) (= (= (bool_eq1 k (mk___rep1 d__split_fields5)) true) (= (witness o2 (mk___rep1 d__split_fields5)) (witness o2 k))))))))))
(assert (= o4 (+ o3 3)))
