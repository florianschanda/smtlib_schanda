...
(declare-fun indexqtint (index1) Int)
(assert (forall ((i index1)) (and (<= 0 (indexqtint i)) (<= (indexqtint i) 5))))
(define-fun in_range5 ((x Int)) Bool (and (<= 0 x) (<= x 5)))
(declare-fun attr__ATTRIBUTE_IMAGE5 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check5 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE5 (us_image) Int)
(declare-fun user_eq6 (index1 index1) Bool)
(declare-const dummy6 index1)
...
(define-fun dynamic_invariant4 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 5)) (in_range5 temp___expr_221)))
(define-fun to_rep1 ((x index1)) Int (indexqtint x))
(declare-fun of_rep1 (Int) index1)
(assert (forall ((x index1)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x index1)) (! (in_range5 (to_rep1 x)) :pattern ((to_rep1 x)))))
(assert (forall ((x Int)) (! (=> (in_range5 x) (= (to_rep1 (of_rep1 x)) x)) :pattern ((to_rep1 (of_rep1 x))))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__sum_elem__interval__first index1) (rec__sum_elem__interval__last index1)))))
(define-fun us_split_fields_First__projection ((a us_split_fields2)) index1 (rec__sum_elem__interval__first a))
(define-fun us_split_fields_Last__projection ((a us_split_fields2)) index1 (rec__sum_elem__interval__last a))
...
(define-fun dynamic_invariant5 ((temp___expr_300 Int) (temp___is_init_296 Bool) (temp___skip_constant_297 Bool) (temp___do_toplevel_298 Bool) (temp___do_typ_inv_299 Bool)) Bool (=> (or (= temp___is_init_296 true) (<= (- 1) 10000)) (in_range6 temp___expr_300)))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant3 result true false true true))) :pattern ((length1 container)))))
(assert true)
