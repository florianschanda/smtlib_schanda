...
(define-fun bool_eq ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep1 (rec__sum_elem__interval__first (us_split_fields3 a))) (to_rep1 (rec__sum_elem__interval__first (us_split_fields3 b)))) (= (to_rep1 (rec__sum_elem__interval__last (us_split_fields3 a))) (to_rep1 (rec__sum_elem__interval__last (us_split_fields3 b))))) true false))
...
(define-fun in_range3 ((rec__sum_elem__partitions__vector__capacity1 Int) (a us_rep)) Bool (= rec__sum_elem__partitions__vector__capacity1 (to_rep (rec__sum_elem__partitions__vector__capacity (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant ((temp___expr_406 us_rep) (temp___is_init_402 Bool) (temp___skip_constant_403 Bool) (temp___do_toplevel_404 Bool) (temp___do_typ_inv_405 Bool)) Bool (=> (not (= temp___skip_constant_403 true)) (in_range3 10 temp___expr_406)))
...
(define-fun dynamic_invariant1 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 5)) (in_range2 temp___expr_221)))
...
(define-fun dynamic_invariant4 ((temp___expr_267 Int) (temp___is_init_263 Bool) (temp___skip_constant_264 Bool) (temp___do_toplevel_265 Bool) (temp___do_typ_inv_266 Bool)) Bool (=> (or (= temp___is_init_263 true) (<= 0 10001)) (in_range temp___expr_267)))
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (capacity container)) (dynamic_invariant4 result true false true true))) :pattern ((length container)))))
...
(define-fun sum_elem__partitions__append__2__container__fields1 () us_split_fields (mk___split_fields sum_elem__partitions__append__2__container__fields))
(assert (= 10 (to_rep (rec__sum_elem__partitions__vector__capacity p__split_discrs))))
(assert (and (and (= (length (mk___rep p__split_discrs sum_elem__partitions__append__2__container__fields1)) (+ (length (mk___rep p__split_discrs (mk___split_fields p__split_fields))) 1)) (= (olt (model__ (mk___rep p__split_discrs (mk___split_fields p__split_fields))) (model__ (mk___rep p__split_discrs sum_elem__partitions__append__2__container__fields1))) true)) (= (bool_eq (get (model__ (mk___rep p__split_discrs sum_elem__partitions__append__2__container__fields1)) (+ (last (model__ (mk___rep p__split_discrs (mk___split_fields p__split_fields)))) 1)) (mk___rep1 (mk___split_fields1 rliteral rliteral))) true)))
(assert (= result p__split_fields))
(assert (= (mk___split_fields p__split_fields1) sum_elem__partitions__append__2__container__fields1))
(assert (not (<= 0 0)))
(check-sat)
(exit)
