...
(define-fun dynamic_invariant1 ((temp___expr_218 Int) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool) (temp___do_typ_inv_217 Bool)) Bool (=> (or (= temp___is_init_214 true) (<= 10 90)) (in_range2 temp___expr_218)))
...
(define-fun dynamic_invariant2 ((temp___expr_225 Int) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool) (temp___do_typ_inv_224 Bool)) Bool (=> (or (= temp___is_init_221 true) (<= 50 59)) (in_range3 temp___expr_225)))
...
(define-fun dynamic_invariant3 ((temp___expr_211 Int) (temp___is_init_207 Bool) (temp___skip_constant_208 Bool) (temp___do_toplevel_209 Bool) (temp___do_typ_inv_210 Bool)) Bool (=> (or (= temp___is_init_207 true) (<= 1 25)) (in_range1 temp___expr_211)))
...
(assert (= temp___6937 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)) o16)) o17))))
...
(assert (= r__split_fields5 (us_split_fields5 temp___6937)))
...
(assert (= temp___6945 (mk___rep2 o27)))
(assert (= result3 (mk___split_fields__ref2 r__split_fields7)))
(assert (= r__split_fields8 (us_split_fields5 temp___6945)))
(assert (= r__split_fields9 (mk___split_fields__ref2 r__split_fields8)))
(assert (= r__split_fields10 r__split_fields8))
(assert (not (= (to_rep3 (rec__ar__rec3t__g3 (us_split_fields__content2 r__split_fields9))) g)))
(check-sat)
(exit)
