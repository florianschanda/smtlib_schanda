...
(define-fun v__split_fields4 () us_split_fields (mk___split_fields v__split_fields3))
(define-fun loop_types__vectors__replace_element__container__fields2 () us_split_fields (mk___split_fields loop_types__vectors__replace_element__container__fields1))
(define-fun v__split_fields5 () us_split_fields (mk___split_fields v__split_fields2))
(define-fun loop_types__vectors__replace_element__container__fields3 () us_split_fields (mk___split_fields loop_types__vectors__replace_element__container__fields))
...
(assert (<= r4b j1))
(assert (<= j1 r5b))
(assert (and (= o j1) (in_range3 j1)))
(assert (and (and (= (length1 (mk___rep v__split_discrs loop_types__vectors__replace_element__container__fields3)) (length1 (mk___rep v__split_discrs (mk___split_fields v__split_fields)))) (= (get (model__ (mk___rep v__split_discrs loop_types__vectors__replace_element__container__fields3)) o) 0)) (= (equal_except (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (model__ (mk___rep v__split_discrs loop_types__vectors__replace_element__container__fields3)) o) true)))
(assert (= (mk___split_fields__ref (mk___split_fields result1)) (mk___split_fields__ref (mk___split_fields v__split_fields))))
(assert (= (mk___split_fields v__split_fields1) loop_types__vectors__replace_element__container__fields3))
(assert (= (last (model__ (mk___rep v__split_discrs v__split_fields5))) (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k j2)) (= (get (model__ (mk___rep v__split_discrs v__split_fields5)) k) 0))))
(assert (and (=> (<= r4b r5b) (dynamic_property r4b r5b j2)) (and (<= r4b j2) (<= j2 r5b))))
(assert (not (= j2 r5b)))
(assert (= j2 result2))
(assert (= j3 (+ j2 1)))
(assert (and (= o1 j3) (in_range3 j3)))
(assert (and (and (= (length1 (mk___rep v__split_discrs loop_types__vectors__replace_element__container__fields2)) (length1 (mk___rep v__split_discrs v__split_fields5))) (= (get (model__ (mk___rep v__split_discrs loop_types__vectors__replace_element__container__fields2)) o1) 0)) (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields5)) (model__ (mk___rep v__split_discrs loop_types__vectors__replace_element__container__fields2)) o1) true)))
(assert (= result3 v__split_fields2))
(assert (= v__split_fields4 loop_types__vectors__replace_element__container__fields2))
(assert (not (= (last (model__ (mk___rep v__split_discrs v__split_fields4))) (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(check-sat)
(exit)
