...
(define-fun tc_pu1S__ref___5__projection ((a tc_pu1S__ref)) us_rep1 (tc_pu1S__content a))
(define-fun dynamic_invariant1 ((temp___expr_263 us_rep1) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool) (temp___do_typ_inv_262 Bool)) Bool (=> (not (= temp___skip_constant_260 true)) (in_range2 0 (to_base temp___expr_263))))
(define-fun default_initial_assumption ((temp___expr_265 us_rep1) (temp___skip_top_level_266 Bool)) Bool (and (= (attr__tag1 temp___expr_265) us_tag3) (and (and (= (to_rep (rec__record_equality__root__c (us_split_discrs2 temp___expr_265))) 0) (= (to_rep (rec__record_equality__root__f11 (us_split_fields3 temp___expr_265))) 0)) (= (to_rep (rec__record_equality__child__f2 (us_split_fields3 temp___expr_265))) 0))))
