...
(assert (<= (length q) 100))
(assert (and (= o10 (length q)) (and (in_range1 o10) (<= (+ 0 o10) 2147483647))))
(assert (and (= o7 (length v)) (and (in_range1 o7) (<= (+ 0 o7) 2147483647))))
(assert (and (= o8 (length p)) (and (in_range1 o8) (<= (+ 0 o8) 2147483647))))
(assert (= o9 (- o8 o7)))
(assert (and (= o11 o9) (in_range4 o9)))
(assert (= result1 (ite (= o11 o10) true false)))
(assert (=> (= result1 true) (and (= o5 (length q)) (and (in_range1 o5) (<= (+ 0 o5) 2147483647)))))
...
(assert (= result3 true))
(assert (and (= o4 (get v i)) (in_range2 o4)))
