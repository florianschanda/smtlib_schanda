...
(assert (and (= o5 (length m)) (and (in_range2 o5) (<= o5 (capacity m)))))
...
(assert (and (= o4 (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range2 o4) (<= o4 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= o6 (+ o4 o3)))
(assert (= result2 (ite (= o6 o5) true false)))
(assert (=> (= result2 true) (and (= o2 (length m)) (and (in_range2 o2) (<= o2 (capacity m))))))
(assert (=> (= result2 true) (= result1 (ite (<= o2 1000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range2 o) (<= o (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q))))))))
(assert (=> (= result1 true) (= o1 (ite (<= i o) true false))))
(assert (=> (= result1 true) (= result3 (ite (<= 1 i) o1 false))))
(assert (=> (= result1 true) (= (= result true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (rec__amortized_queue__queue__rear (us_split_fields3 q))))) (= (get (model__ m) i1) (get (model__ (rec__amortized_queue__queue__rear (us_split_fields3 q))) (+ (- (length (rec__amortized_queue__queue__rear (us_split_fields3 q))) i1) 1))))))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (<= 1 (length (rec__amortized_queue__queue__front (us_split_fields3 q)))))
(assert (not (<= (length (rec__amortized_queue__queue__front (us_split_fields3 q))) 1000)))
(check-sat)
(exit)
