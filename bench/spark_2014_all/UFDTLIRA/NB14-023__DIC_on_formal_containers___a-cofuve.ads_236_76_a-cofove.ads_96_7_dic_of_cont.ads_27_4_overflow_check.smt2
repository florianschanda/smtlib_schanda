...
(define-fun extended_index__ref___7__projection ((a extended_index__ref)) extended_index (extended_index__content a))
(define-fun dynamic_invariant1 ((temp___expr_1641 Int) (temp___is_init_1637 Bool) (temp___skip_constant_1638 Bool) (temp___do_toplevel_1639 Bool) (temp___do_typ_inv_1640 Bool)) Bool (=> (or (= temp___is_init_1637 true) (<= 0 2147483647)) (in_range2 temp___expr_1641)))
...
(define-fun index_type__ref___7__projection ((a index_type__ref)) index_type (index_type__content a))
(define-fun dynamic_invariant2 ((temp___expr_1627 Int) (temp___is_init_1623 Bool) (temp___skip_constant_1624 Bool) (temp___do_toplevel_1625 Bool) (temp___do_typ_inv_1626 Bool)) Bool (=> (or (= temp___is_init_1623 true) (<= 1 2147483647)) (in_range4 temp___expr_1627)))
...
(define-fun dynamic_invariant3 ((temp___expr_1634 Int) (temp___is_init_1630 Bool) (temp___skip_constant_1631 Bool) (temp___do_toplevel_1632 Bool) (temp___do_typ_inv_1633 Bool)) Bool (=> (or (= temp___is_init_1630 true) (<= 0 2147483647)) (in_range5 temp___expr_1634)))
...
(assert (and (= o6 (last left)) (and (in_range2 o6) (= o6 (+ 0 (length left))))))
(assert (= result (ite (<= lst o6) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o5 (- (- 2147483648) offset)) (in_range3 (- (- 2147483648) offset)))))
