...
(define-fun default_initial_assumption ((temp___expr_401 us_rep) (temp___skip_top_level_402 Bool)) Bool (=> (not (= temp___skip_top_level_402 true)) (= (length temp___expr_401) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_393 Int) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool) (temp___do_typ_inv_392 Bool)) Bool (=> (or (= temp___is_init_389 true) (<= 0 2147483647)) (in_range2 temp___expr_393)))
...
(define-fun dynamic_invariant2 ((temp___expr_379 Int) (temp___is_init_375 Bool) (temp___skip_constant_376 Bool) (temp___do_toplevel_377 Bool) (temp___do_typ_inv_378 Bool)) Bool (=> (or (= temp___is_init_375 true) (<= 1 2147483647)) (in_range4 temp___expr_379)))
...
(define-fun dynamic_invariant3 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 2147483647)) (in_range5 temp___expr_386)))
