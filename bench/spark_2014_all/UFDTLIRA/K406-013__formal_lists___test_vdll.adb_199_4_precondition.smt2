...
(declare-const temp___485 us_rep)
...
(assert (= e1 1))
(assert (=> (and (<= 1 e1) (<= e1 3)) (= temp___486 e1)))
(assert (=> (and (<= 1 e1) (<= e1 3)) (= temp___485 (mk___rep l1__split_discrs l1__split_fields5))))
(assert (=> (and (<= 1 e1) (<= e1 3)) (= (length (mk___rep l1__split_discrs l1__split_fields6)) (- e2 1))))
(assert (=> (and (<= 1 e1) (<= e1 3)) (and (=> (<= 1 3) (in_range8 e2)) (and (<= 1 e2) (<= e2 3)))))
(assert (=> (and (<= 1 e1) (<= e1 3)) (and (and (and (and (and (= (length (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3)) (+ (length (mk___rep l1__split_discrs l1__split_fields6)) 1)) (= (get1 (positions (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3)) (last1 (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3))) (length (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3)))) (= (keys_included_except (positions (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3)) (positions (mk___rep l1__split_discrs l1__split_fields6)) (last1 (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3))) true)) (= (ole1 (positions (mk___rep l1__split_discrs l1__split_fields6)) (positions (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3))) true)) (= (get (model__ (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3)) (length (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3))) e2)) (= (ole (model__ (mk___rep l1__split_discrs l1__split_fields6)) (model__ (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3))) true))))
(assert (=> (and (<= 1 e1) (<= e1 3)) (= result21 (mk___split_fields__ref l1__split_fields6))))
(assert (=> (and (<= 1 e1) (<= e1 3)) (= l1__split_fields7 formal_container__vdll__append__container__fields3)))
(assert (=> (and (<= 1 e1) (<= e1 3)) (= e2 3)))
(assert (=> (and (<= 1 e1) (<= e1 3)) (= e3 (mk_int__ref e2))))
(assert (=> (and (<= 1 e1) (<= e1 3)) (= l1__split_fields8 (mk___split_fields__ref l1__split_fields7))))
(assert (=> (and (<= 1 e1) (<= e1 3)) (= e4 e2)))
(assert (=> (and (<= 1 e1) (<= e1 3)) (= l1__split_fields9 l1__split_fields7)))
(assert (=> (and (<= 1 e1) (<= e1 3)) (= e5 e3)))
(assert (=> (and (<= 1 e1) (<= e1 3)) (= l1__split_fields10 l1__split_fields8)))
(assert (=> (and (<= 1 e1) (<= e1 3)) (= e6 e4)))
(assert (=> (and (<= 1 e1) (<= e1 3)) (= l1__split_fields11 l1__split_fields9)))
(assert (=> (not (and (<= 1 e1) (<= e1 3))) (= e5 (mk_int__ref e1))))
(assert (=> (not (and (<= 1 e1) (<= e1 3))) (= l1__split_fields10 (mk___split_fields__ref l1__split_fields5))))
(assert (=> (not (and (<= 1 e1) (<= e1 3))) (= e6 e1)))
(assert (=> (not (and (<= 1 e1) (<= e1 3))) (= l1__split_fields11 l1__split_fields5)))
(assert (not (<= (length (mk___rep l1__split_discrs (us_split_fields__content l1__split_fields10))) (to_rep (rec__formal_container__vdll__list__capacity l2__split_discrs)))))
(check-sat)
(exit)
