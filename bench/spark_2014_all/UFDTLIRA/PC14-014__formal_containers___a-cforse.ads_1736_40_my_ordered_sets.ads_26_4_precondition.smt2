...
(declare-fun last_element (us_rep) us_rep1)
...
(assert (forall ((container us_rep)) (! (=> (not (= (is_empty container) true)) (let ((result (last_element container))) (and (= (bool_eq1 result (get (elements container) (length container))) true) (= (e_bigger_than_range (elements container) 1 (- (length container) 1) result) true)))) :pattern ((last_element container)))))
...
(define-fun e_smaller_than_range ((container1 us_rep2) (fst Int) (lst Int) (item us_rep1)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt item (get container1 i)) true))) true false))
(declare-fun e_smaller_than_range__function_guard (Bool us_rep2 Int Int us_rep1) Bool)
(define-fun e_is_find ((container1 us_rep2) (item us_rep1) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item) (distinct 1 0)) (ite (< position (length1 container1)) (e_smaller_than_range container1 (+ position 1) (length1 container1) item) (distinct 1 0))))
...
(define-fun oeq1 ((left us_rep2) (right us_rep2)) Bool (and (= (length1 left) (length1 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (bool_eq1 (get left n) (get right n)) true))) true false)))
...
(assert (forall ((container1 us_rep2)) (forall ((item us_rep1)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length1 container1)) (= (equivalent_elements item (get container1 result)) true))) (dynamic_invariant result true false true true))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep3)) (forall ((item us_rep1)) (! (=> (= (distinct 1 0) true) (=> (exists ((e us_rep1)) (and (= (contains container1 e) true) (= (equivalent_elements e item) true))) (= (contains container1 item) true))) :pattern ((contains container1 item))))))
(assert (forall ((container1 us_rep3)) (! (dynamic_invariant (length2 container1) true false true true) :pattern ((length2 container1)))))
(assert (forall ((container1 us_rep3)) (! (let ((result (is_empty1 container1))) (and (= (= result true) (forall ((item us_rep1)) (not (= (contains container1 item) true)))) (= (= result true) (= (length2 container1) 0)))) :pattern ((is_empty1 container1)))))
...
(assert (and (= o (length container)) (and (in_range1 o) (<= o (to_rep (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 container)))))))
