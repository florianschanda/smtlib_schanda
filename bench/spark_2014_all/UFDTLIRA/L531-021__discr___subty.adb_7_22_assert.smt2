...
(define-fun o17 () us_rep (mk___rep (mk___split_discrs o12) (mk___split_fields o13 o14 o15 o16)))
(define-fun o18 () us_rep (mk___rep (mk___split_discrs o7) (mk___split_fields o8 o9 o10 o11)))
...
(assert (= true o5))
(assert (= dummy1 o6))
(assert (= o18 (mk___rep (mk___split_discrs o2) (mk___split_fields o3 o4 o5 o6))))
(assert (= o17 o18))
(assert (= (mk___rep (mk___split_discrs subty__p__z__assume) (mk___split_fields subty__p__z__assume1 subty__p__z__assume2 subty__p__z__assume3 subty__p__z__assume4)) o17))
...
(assert (not (= (to_rep (rec__basic__r__base z__split_fields4)) 1)))
(check-sat)
(exit)
