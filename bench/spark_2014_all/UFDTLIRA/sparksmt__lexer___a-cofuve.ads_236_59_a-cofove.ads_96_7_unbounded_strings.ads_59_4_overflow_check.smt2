...
(define-fun default_initial_assumption ((temp___expr_293 us_rep) (temp___skip_top_level_294 Bool)) Bool (=> (not (= temp___skip_top_level_294 true)) (= (length temp___expr_293) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_285 Int) (temp___is_init_281 Bool) (temp___skip_constant_282 Bool) (temp___do_toplevel_283 Bool) (temp___do_typ_inv_284 Bool)) Bool (=> (or (= temp___is_init_281 true) (<= 0 2147483647)) (in_range2 temp___expr_285)))
...
(define-fun dynamic_invariant2 ((temp___expr_271 Int) (temp___is_init_267 Bool) (temp___skip_constant_268 Bool) (temp___do_toplevel_269 Bool) (temp___do_typ_inv_270 Bool)) Bool (=> (or (= temp___is_init_267 true) (<= 1 2147483647)) (in_range4 temp___expr_271)))
...
(define-fun dynamic_invariant3 ((temp___expr_278 Int) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool (=> (or (= temp___is_init_274 true) (<= 0 255)) (in_range5 temp___expr_278)))
