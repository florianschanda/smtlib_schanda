...
(define-fun unbounded__vect__append__2__container__fields2 () us_split_fields (mk___split_fields unbounded__vect__append__2__container__fields1))
(define-fun v__split_fields4 () us_split_fields (mk___split_fields v__split_fields2))
(define-fun unbounded__vect__append__2__container__fields3 () us_split_fields (mk___split_fields unbounded__vect__append__2__container__fields))
...
(assert (= v__split_fields4 unbounded__vect__append__2__container__fields3))
...
(assert (= v__split_fields3 unbounded__vect__append__2__container__fields2))
