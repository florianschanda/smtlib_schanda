...
(define-fun dynamic_invariant2 ((temp___expr_266 Int) (temp___is_init_262 Bool) (temp___skip_constant_263 Bool) (temp___do_toplevel_264 Bool) (temp___do_typ_inv_265 Bool)) Bool (=> (or (= temp___is_init_262 true) (<= 1 2147483647)) (in_range3 temp___expr_266)))
...
(assert (forall ((x integer)) (! (in_range6 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant5 ((temp___expr_314 Int) (temp___is_init_310 Bool) (temp___skip_constant_311 Bool) (temp___do_toplevel_312 Bool) (temp___do_typ_inv_313 Bool)) Bool (=> (or (= temp___is_init_310 true) (<= 0 2147483647)) (in_range7 temp___expr_314)))
