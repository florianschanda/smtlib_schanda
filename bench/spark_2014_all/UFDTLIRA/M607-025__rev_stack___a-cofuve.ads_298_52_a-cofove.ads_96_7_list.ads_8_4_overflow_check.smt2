...
(define-fun dynamic_invariant ((temp___expr_237 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool) (temp___do_typ_inv_236 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= 0 2147483647)) (in_range1 temp___expr_237)))
...
(define-fun dynamic_invariant2 ((temp___expr_331 Int) (temp___is_init_327 Bool) (temp___skip_constant_328 Bool) (temp___do_toplevel_329 Bool) (temp___do_typ_inv_330 Bool)) Bool (=> (or (= temp___is_init_327 true) (<= 1 100)) (in_range4 temp___expr_331)))
...
(assert (and (= o2 (length container)) (and (in_range1 o2) (<= (+ 0 o2) 100))))
