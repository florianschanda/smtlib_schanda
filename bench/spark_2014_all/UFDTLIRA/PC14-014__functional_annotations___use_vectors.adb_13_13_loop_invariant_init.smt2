...
(assert (and (= (length (mk___rep v2__split_discrs v2__split_fields1)) 0) (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v2__split_discrs)))))
(assert (= lst2 r1b))
...
(declare-const n Int)
(assert (<= first3 n))
(assert (<= n (last2 (model__ (mk___rep v2__split_discrs v2__split_fields1)))))
(assert (not (= (is_incr (get (model__ v1) n) (get (model__ (mk___rep v2__split_discrs v2__split_fields1)) n)) true)))
(check-sat)
(exit)
