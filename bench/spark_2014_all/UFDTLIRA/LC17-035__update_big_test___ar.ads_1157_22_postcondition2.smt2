...
(define-fun dynamic_invariant3 ((temp___expr_246 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool) (temp___do_typ_inv_245 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 4)) (in_range4 temp___expr_246)))
...
(define-fun temp__split_fields6 () us_split_fields (mk___split_fields temp__split_fields2 temp__split_fields3))
(assert (= result temp__split_fields))
(assert (= result1 temp__split_fields1))
(assert (= r__split_fields5 temp__split_fields2))
(assert (= r__split_fields6 temp__split_fields3))
...
(assert (= r__split_fields7 (mk___split_fields2 (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields r__split_fields1 r__split_fields2)) r__split_fields3)) r__split_fields4 (mk___rep (mk___split_fields r__split_fields1 r__split_fields2)))))
(assert (= result9 (mk___split_fields__ref2 r__split_fields7)))
(assert (= r__split_fields8 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec5t__f5 r__split_fields7))) (mk___rep temp__split_fields6) (rec__ar__rec2t__h2 (us_split_fields3 (rec__ar__rec5t__f5 r__split_fields7))))) (rec__ar__rec5t__g5 r__split_fields7) (rec__ar__rec5t__h5 r__split_fields7))))
(assert (= temp__split_fields4 (mk___split_fields__ref temp__split_fields6)))
...
(assert (not (= (to_rep2 (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields__content2 r__split_fields9))))) (to_rep2 r__split_fields))))
(check-sat)
(exit)
