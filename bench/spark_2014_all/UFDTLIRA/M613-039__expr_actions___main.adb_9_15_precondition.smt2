...
(define-fun list__my_lists__append__2__container__fields1 () us_split_fields (mk___split_fields list__my_lists__append__2__container__fields))
...
(assert (= i1 1))
(assert (and (and (= (length1 (mk___rep l__split_discrs list__my_lists__append__2__container__fields1)) (+ (length1 (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1)) (= (olt (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs list__my_lists__append__2__container__fields1))) true)) (= (get (model__ (mk___rep l__split_discrs list__my_lists__append__2__container__fields1)) (+ (last (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) 1)) i1)))
(assert (= (mk___split_fields__ref (mk___split_fields result1)) (mk___split_fields__ref (mk___split_fields l__split_fields))))
(assert (= l__split_fields2 list__my_lists__append__2__container__fields1))
(assert (= i1 result2))
(assert (= i2 2))
