...
(assert (and (= o2 (positions (mk___rep l__split_discrs l__split_fields2))) (and (not (= (has_key o2 no_element) true)) (forall ((i us_rep2)) (=> (= (has_key o2 i) true) (and (and (<= 1 (get1 o2 i)) (<= (get1 o2 i) (length (mk___rep l__split_discrs l__split_fields2)))) (forall ((j us_rep2)) (=> (= (has_key o2 j) true) (=> (= (get1 o2 i) (get1 o2 j)) (= (bool_eq2 i j) true))))))))))
(assert (and (= o3 (get1 o2 lst)) (and (in_range4 o3) (=> (= (distinct 0 0) true) (and (= o3 (w_get o2 (witness o2 lst))) (forall ((k us_rep2)) (=> (= (has_key o2 k) true) (= (= (bool_eq2 k lst) true) (= (witness o2 lst) (witness o2 k))))))))))
(assert (and (= o1 (positions (mk___rep l__split_discrs l__split_fields2))) (and (not (= (has_key o1 no_element) true)) (forall ((i us_rep2)) (=> (= (has_key o1 i) true) (and (and (<= 1 (get1 o1 i)) (<= (get1 o1 i) (length (mk___rep l__split_discrs l__split_fields2)))) (forall ((j us_rep2)) (=> (= (has_key o1 j) true) (=> (= (get1 o1 i) (get1 o1 j)) (= (bool_eq2 i j) true))))))))))
(assert (and (= o4 (get1 o1 (mk___rep1 current__split_fields3))) (and (in_range4 o4) (=> (= (distinct 0 0) true) (and (= o4 (w_get o1 (witness o1 (mk___rep1 current__split_fields3)))) (forall ((k us_rep2)) (=> (= (has_key o1 k) true) (= (= (bool_eq2 k (mk___rep1 current__split_fields3)) true) (= (witness o1 (mk___rep1 current__split_fields3)) (witness o1 k))))))))))
