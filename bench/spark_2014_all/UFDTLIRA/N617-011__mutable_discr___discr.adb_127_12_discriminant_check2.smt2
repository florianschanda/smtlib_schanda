...
(declare-const temp___392 natural)
(declare-const temp___3921 us_main_type)
(declare-const temp___3922 Bool)
(assert (= (to_rep d__split_discrs) r26b))
(assert (in_range1 r26b))
(assert (and (= (mk___rep (mk___split_discrs temp___392) (mk___split_fields temp___3921) temp___3922) (new_with_default 0)) (= (to_rep temp___392) 0)))
(assert (= d__attr__constrained true))
(assert (not (= temp___392 d__split_discrs)))
(check-sat)
(exit)
