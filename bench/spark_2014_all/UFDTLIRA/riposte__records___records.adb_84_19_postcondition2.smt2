...
(declare-const temp___309 unsigned_byte)
(declare-const temp___3091 unsigned_byte)
...
(declare-const records__safe_add_pair_b__result4 unsigned_byte)
(declare-const records__safe_add_pair_b__result5 unsigned_byte)
(declare-const records__safe_add_pair_b__result6 us_rep)
(declare-const r__split_fields6 us_split_fields__ref)
(declare-const records__safe_add_pair_b__result7 pair__ref)
(declare-const r__split_fields7 us_split_fields)
(declare-const records__safe_add_pair_b__result8 us_rep)
(define-fun r__split_fields8 () us_split_fields (mk___split_fields r__split_fields2 r__split_fields3))
(define-fun temp___3092 () us_rep (mk___rep (mk___split_fields temp___309 temp___3091)))
(declare-const result6 unsigned_byte)
(declare-const result7 unsigned_byte)
(assert (=> (and (<= (+ (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) 1) (- 255 (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b)))))) (and (= temp___3092 (add_pair_a a b)) (= (bool_eq temp___3092 (mk___rep (mk___split_fields (of_rep (+ (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (of_rep (+ (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b)))))))) true))))
(assert (=> (and (<= (+ (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) 1) (- 255 (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b)))))) (= result r__split_fields)))
(assert (=> (and (<= (+ (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) 1) (- 255 (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b)))))) (= result1 r__split_fields1)))
(assert (=> (and (<= (+ (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) 1) (- 255 (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b)))))) (= temp___309 r__split_fields2)))
(assert (=> (and (<= (+ (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) 1) (- 255 (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b)))))) (= temp___3091 r__split_fields3)))
(assert (=> (not (and (<= (+ (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) 1) (- 255 (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b))))))) (= result2 r__split_fields)))
(assert (=> (not (and (<= (+ (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) 1) (- 255 (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b))))))) (= result3 r__split_fields1)))
(assert (=> (not (and (<= (+ (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) 1) (- 255 (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b))))))) (= rliteral r__split_fields4)))
(assert (=> (not (and (<= (+ (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) 1) (- 255 (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b))))))) (= rliteral r__split_fields5)))
(assert (=> (not (and (<= (+ (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) 1) (- 255 (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b))))))) (= r__split_fields8 (mk___split_fields r__split_fields4 r__split_fields5))))
(assert (= records__safe_add_pair_b__result4 records__safe_add_pair_b__result2))
(assert (= records__safe_add_pair_b__result5 records__safe_add_pair_b__result3))
(assert (= records__safe_add_pair_b__result6 (mk___rep (mk___split_fields records__safe_add_pair_b__result2 records__safe_add_pair_b__result3))))
...
(assert (= records__safe_add_pair_b__result7 (mk_pair__ref (mk___rep (mk___split_fields records__safe_add_pair_b__result4 records__safe_add_pair_b__result5)))))
(assert (= r__split_fields6 (mk___split_fields__ref r__split_fields8)))
(assert (= records__safe_add_pair_b__result8 records__safe_add_pair_b__result6))
(assert (= r__split_fields7 r__split_fields8))
(assert (= (mk___rep (mk___split_fields result6 result7)) (pair__content records__safe_add_pair_b__result7)))
...
(assert (not (= (bool_eq (pair__content records__safe_add_pair_b__result7) (mk___rep (mk___split_fields (of_rep (+ (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (of_rep (+ (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b)))))))) true)))
(check-sat)
(exit)
