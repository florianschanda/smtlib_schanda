...
(define-fun o10 () us_rep2 (mk___rep1 (mk___split_fields1 o)))
(assert (= (mk___rep1 (mk___split_fields1 rliteral)) no_element))
(assert (and (= o10 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq2 o10 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o10) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o10) 1)))))
...
(assert (and (= o4 (length (mk___rep l__split_discrs l__split_fields1))) (and (in_range1 o4) (<= o4 (to_rep (rec__for_loops_on_lists__my_lists__list__capacity l__split_discrs))))))
