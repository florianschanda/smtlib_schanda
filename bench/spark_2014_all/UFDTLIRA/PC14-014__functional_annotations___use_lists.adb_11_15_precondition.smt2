...
(assert (and (= result1 (has_key (positions l) (mk___rep cu__split_fields4))) (= (= result1 true) (= (has_key (positions l) (mk___rep cu__split_fields4)) true))))
(assert (= result1 true))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions l) (mk___rep cu__split_fields3)) 1))) (not (= (get (model__ l) i1) e)))))
(assert (= (has_key (positions l) (mk___rep cu__split_fields3)) true))
