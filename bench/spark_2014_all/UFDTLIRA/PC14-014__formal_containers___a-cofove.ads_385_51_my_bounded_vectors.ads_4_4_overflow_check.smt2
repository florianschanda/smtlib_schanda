...
(define-fun dynamic_invariant3 ((temp___expr_759 Int) (temp___is_init_755 Bool) (temp___skip_constant_756 Bool) (temp___do_toplevel_757 Bool) (temp___do_typ_inv_758 Bool)) Bool (=> (or (= temp___is_init_755 true) (<= 1 2147483647)) (in_range5 temp___expr_759)))
...
(define-fun dynamic_invariant4 ((temp___expr_804 Int) (temp___is_init_800 Bool) (temp___skip_constant_801 Bool) (temp___do_toplevel_802 Bool) (temp___do_typ_inv_803 Bool)) Bool (=> (or (= temp___is_init_800 true) (<= 0 2147483647)) (in_range6 temp___expr_804)))
...
(define-fun dynamic_invariant5 ((temp___expr_797 Int) (temp___is_init_793 Bool) (temp___skip_constant_794 Bool) (temp___do_toplevel_795 Bool) (temp___do_typ_inv_796 Bool)) Bool (=> (or (= temp___is_init_793 true) (<= 1 2147483647)) (in_range7 temp___expr_797)))
