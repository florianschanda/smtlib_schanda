...
(define-fun o6 () us_rep (mk___rep (mk___split_discrs o3) (mk___split_fields o4) o5))
(define-fun o7 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1) o2))
(assert (in_range c))
(assert (and (= us c) (in_range c)))
(assert (and (= o7 (new_with_default c)) (= (to_rep o) c)))
(assert (= o6 o7))
(assert (= (mk___rep (mk___split_discrs discr__p5__d1__assume) (mk___split_fields discr__p5__d1__assume1) discr__p5__d1__assume2) o6))
...
(assert (= h__split_fields1 true))
(assert (not (= (rec__private_discr__p_with_default__c d1__split_discrs) h__split_fields)))
(check-sat)
(exit)
