...
(define-fun dynamic_invariant1 ((temp___expr_403 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool) (temp___do_typ_inv_402 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 2147483647)) (in_range2 temp___expr_403)))
(define-fun default_initial_assumption ((temp___expr_417 us_rep1) (temp___skip_top_level_418 Bool)) Bool (= (to_rep (rec__loop_types__lists__cursor__node (us_split_fields3 temp___expr_417))) 0))
...
(define-fun default_initial_assumption1 ((temp___expr_476 us_rep2) (temp___skip_top_level_477 Bool)) Bool (=> (not (= temp___skip_top_level_477 true)) (and (= (is_empty temp___expr_476) true) (= (length1 temp___expr_476) 0))))
(define-fun default_initial_assumption2 ((temp___expr_462 us_rep1) (temp___skip_top_level_463 Bool)) Bool (= (to_rep (rec__loop_types__lists__cursor__node (us_split_fields3 temp___expr_462))) 0))
...
(define-fun dynamic_invariant2 ((temp___expr_468 Int) (temp___is_init_464 Bool) (temp___skip_constant_465 Bool) (temp___do_toplevel_466 Bool) (temp___do_typ_inv_467 Bool)) Bool (=> (or (= temp___is_init_464 true) (<= 1 2147483647)) (in_range4 temp___expr_468)))
...
(assert (not (in_range1 (- (to_rep (rec__loop_types__lists__list__capacity container__split_discrs)) count))))
(check-sat)
(exit)
