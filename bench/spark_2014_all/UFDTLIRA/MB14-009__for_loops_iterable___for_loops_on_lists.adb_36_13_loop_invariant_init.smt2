...
(define-fun o2 () us_rep2 (mk___rep1 (mk___split_fields1 o)))
(assert (= (mk___rep1 (mk___split_fields1 rliteral)) no_element))
(assert (and (= o2 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq2 o2 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o2) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o2) 1)))))
...
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1) 1)))
(assert (not (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i) (- (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i) 1))))
(check-sat)
(exit)
