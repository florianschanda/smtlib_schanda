...
(assert (forall ((i t_rate)) (and (<= (- 3000) (t_rateqtint i)) (<= (t_rateqtint i) 3000))))
...
(declare-const roll_rate_desired2 Int)
(assert (in_range x))
(assert (in_range y))
(assert (in_range z))
...
(assert (and (= o2 get_out_subtype_int__controller_get_desired_rate__roll_rate_desired) (in_range1 get_out_subtype_int__controller_get_desired_rate__roll_rate_desired)))
(assert (= result3 roll_rate_desired1))
(assert (= roll_rate_desired2 o2))
(assert (not (in_range1 get_out_subtype_int__controller_get_desired_rate__pitch_rate_desired1)))
(check-sat)
(exit)
