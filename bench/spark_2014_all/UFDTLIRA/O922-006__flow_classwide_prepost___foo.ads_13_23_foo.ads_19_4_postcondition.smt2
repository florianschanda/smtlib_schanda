...
(declare-const temp___189 positive)
(declare-const temp___1891 integer)
(declare-const temp___1892 integer)
(declare-const temp___1893 us_private)
...
(assert (or (<= (to_rep p__split_fields1) limit) (<= (to_rep p__split_fields2) limit)))
(assert (= (to_rep o) (to_rep p__split_fields2)))
(assert (= p__split_fields o1))
(assert (= o o2))
(assert (= p__split_fields2 o3))
(assert (= p__split_fields3 o4))
(assert (= temp___189 o1))
(assert (= temp___1891 o2))
(assert (= temp___1892 o3))
(assert (= temp___1893 o4))
(assert (= p__attr__tag temp___1894))
...
(assert (= temp___189 p__split_fields4))
(assert (= temp___1891 p__split_fields5))
(assert (= temp___1892 p__split_fields6))
(assert (= temp___1893 p__split_fields7))
...
(assert (= rliteral p__split_fields8))
(assert (= p__split_fields5 p__split_fields9))
(assert (= p__split_fields6 p__split_fields10))
(assert (= p__split_fields7 p__split_fields11))
...
(assert (= (mk___split_fields1 p__split_fields16 p__split_fields17 p__split_fields18 p__split_fields19) (mk___split_fields1 p__split_fields8 p__split_fields9 p__split_fields10 p__split_fields11)))
(assert (not (= (to_rep p__split_fields13) (to_rep p__split_fields14))))
(check-sat)
(exit)
