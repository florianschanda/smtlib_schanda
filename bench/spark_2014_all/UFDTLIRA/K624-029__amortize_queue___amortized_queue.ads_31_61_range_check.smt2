...
(assert (and (= o5 (length left)) (and (in_range1 o5) (<= o5 (capacity left)))))
(assert (= o6 (+ o5 1)))
(assert (and (= o7 (length (vector__content amortized_queue__Oconcat__3__result5))) (and (in_range1 o7) (<= o7 (capacity (vector__content amortized_queue__Oconcat__3__result5))))))
