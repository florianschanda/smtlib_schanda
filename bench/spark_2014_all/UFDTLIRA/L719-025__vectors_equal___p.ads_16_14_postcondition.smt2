...
(assert (and (and (= (length (mk___rep l__split_discrs l__split_fields6)) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1)) (= (olt (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields6))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields6)) (+ (last (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) 1)) 1)))
(assert (and (= (length (mk___rep l__split_discrs l__split_fields5)) (- (length (mk___rep l__split_discrs l__split_fields6)) 1)) (= (olt (model__ (mk___rep l__split_discrs l__split_fields5)) (model__ (mk___rep l__split_discrs l__split_fields6))) true)))
