...
(assert (=> (= result2 true) (and (= o1 (element l1 (mk___rep1 cu__split_fields3))) (and (in_range5 o1) (= o1 (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields3))))))))
(assert (=> (= result2 true) (= o2 (+ o1 1))))
(assert (=> (= result2 true) (and (= o3 o2) (in_range8 o2))))
...
(assert (=> (not (= result2 true)) (and (= o4 (element l1 (mk___rep1 cu__split_fields3))) (and (in_range5 o4) (= o4 (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields3))))))))
...
(assert (not (or (= (has_key (positions l1) (mk___rep1 cu__split_fields3)) true) (= (bool_eq2 (mk___rep1 cu__split_fields3) no_element) true))))
(check-sat)
(exit)
