...
(define-fun result____split_fields9 () us_split_fields (mk___split_fields result____split_fields3))
...
(define-fun result____split_fields10 () us_split_fields__ref (mk___split_fields__ref (mk___split_fields result____split_fields)))
...
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= (mk___split_fields__ref (mk___split_fields result1)) result____split_fields10)))
...
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= (length (mk___rep result____split_discrs result____split_fields9)) idx3)))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (forall ((i Int)) (=> (and (<= 1 i) (<= i idx3)) (= (get (model__ (mk___rep result____split_discrs result____split_fields9)) i) (get (model__ left) i))))))
...
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= result____split_fields4 (mk___split_fields__ref result____split_fields9))))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= idx5 idx3)))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= result____split_fields5 result____split_fields9)))
...
(assert (=> (not (and (<= 1 idx2) (<= idx2 r4b))) (= result____split_fields6 result____split_fields10)))
...
(assert (<= 1 i))
(assert (<= i idx8))
(assert (not (= (get (model__ (mk___rep result____split_discrs result____split_fields8)) (+ (last (model__ left)) i)) (get (model__ right) i))))
(check-sat)
(exit)
