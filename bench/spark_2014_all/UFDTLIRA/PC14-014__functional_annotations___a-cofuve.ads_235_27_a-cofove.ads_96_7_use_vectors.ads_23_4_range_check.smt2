...
(assert (and (= o13 (last1 left)) (and (dynamic_property1 first1 last2 o13) (= o13 (+ (- first 1) (length left))))))
(assert (= result (ite (<= lst1 o13) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o11 first) (in_range3 first))))
(assert (=> (< offset 0) (and (= o12 (- (- 2147483648) offset)) (in_range3 (- (- 2147483648) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o12 o11) true false))))
(assert (=> (not (< offset 0)) (= result1 (distinct 1 0))))
(assert (= result1 true))
(assert (<= fst1 lst1))
(assert (and (= o6 lst1) (in_range3 lst1)))
(assert (and (= o3 (length right)) (and (in_range1 o3) (<= (+ (- first 1) o3) last))))
(assert (and (= o1 first) (in_range3 first)))
(assert (= o2 (- o1 1)))
(assert (and (= o4 o2) (in_range3 o2)))
(assert (= o5 (+ o4 o3)))
(assert (and (= o7 o5) (in_range3 o5)))
(assert (= o8 (- o7 o6)))
