...
(define-fun o1 () us_rep1 (mk___rep (mk___split_fields o)))
(assert (= (mk___rep (mk___split_fields rliteral)) no_element))
(assert (and (= o1 (first l)) (ite (= (= (length2 l) 0) true) (= (bool_eq1 o1 no_element) true) (and (= (has_key (positions l) o1) true) (= (get1 (positions l) o1) 1)))))
...
(assert (= result1 true))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions l) cu2) 1))) (not (= (get (model__ l) i) 0)))))
(assert (= (has_key (positions l) cu2) true))
(assert (not (= (has_key (positions l) cu2) true)))
(check-sat)
(exit)
