...
(assert (and (= o10 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o9)) (and (in_range4 o10) (= o10 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o9)))))
