...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__indefinite_bounded_tagged__vect__vector us_main_type)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields)) us_main_type (rec__indefinite_bounded_tagged__vect__vector a))
...
(define-fun capacity ((container us_rep)) Int (ite (= (distinct 1 0) true) (to_rep (rec__indefinite_bounded_tagged__vect__vector__capacity (us_split_discrs1 container))) 2147483647))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_285 Int) (temp___is_init_281 Bool) (temp___skip_constant_282 Bool) (temp___do_toplevel_283 Bool) (temp___do_typ_inv_284 Bool)) Bool (=> (or (= temp___is_init_281 true) (<= 0 2147483647)) (in_range1 temp___expr_285)))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__indefinite_bounded_tagged__t__c integer) (rec__ext__ us_private)))))
(define-fun us_split_fields_C__projection ((a us_split_fields2)) integer (rec__indefinite_bounded_tagged__t__c a))
...
(define-fun bool_eq ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep1 (rec__indefinite_bounded_tagged__t__c (us_split_fields3 a))) (to_rep1 (rec__indefinite_bounded_tagged__t__c (us_split_fields3 b)))) true false))
...
(assert (forall ((source us_rep)) (forall ((capacity1 Int)) (! (=> (and (dynamic_invariant capacity1 true true true true) (=> (= (distinct 1 0) true) (or (= capacity1 0) (<= (length source) capacity1)))) (let ((result (copy source capacity1))) (and (= (oeq1 (model__ result) (model__ source)) true) (ite (= capacity1 0) (= (to_rep (rec__indefinite_bounded_tagged__vect__vector__capacity (us_split_discrs1 result))) (length source)) (= (to_rep (rec__indefinite_bounded_tagged__vect__vector__capacity (us_split_discrs1 result))) capacity1))))) :pattern ((copy source capacity1))))))
...
(define-fun element ((container us_rep) (index Int)) us_rep1 (get (model__ container) index))
(declare-fun element__function_guard (us_rep1 us_rep Int) Bool)
(define-fun default_initial_assumption ((temp___expr_249 us_rep1) (temp___skip_top_level_250 Bool)) Bool (= (attr__tag temp___expr_249) us_tag))
...
(define-fun first_element ((container us_rep)) us_rep1 (get (model__ container) 1))
(declare-fun first_element__function_guard (us_rep1 us_rep) Bool)
(define-fun last_element ((container us_rep)) us_rep1 (get (model__ container) (last_index container)))
(declare-fun last_element__function_guard (us_rep1 us_rep) Bool)
(declare-fun find_index (us_rep us_rep1 Int) Int)
(declare-fun find_index__function_guard (Int us_rep us_rep1 Int) Bool)
(define-fun contains ((container us_rep2) (fst Int) (lst Int) (item us_rep1)) Bool (ite (exists ((i Int)) (and (and (<= fst i) (<= i lst)) (= (let ((temp___160 (get container i))) (and (ite (= (attr__tag temp___160) (attr__tag item)) true false) (us_dispatch_eq temp___160 item))) true))) true false))
(declare-fun contains__function_guard (Bool us_rep2 Int Int us_rep1) Bool)
(assert (forall ((container us_rep)) (forall ((item us_rep1)) (forall ((index Int)) (! (=> (dynamic_invariant2 index true true true true) (let ((result (find_index container item index))) (and (ite (or (< (last_index container) index) (not (= (contains (model__ container) index (last_index container) item) true))) (= result 0) (and (and (and (<= index result) (<= result (last_index container))) (= (let ((temp___483 (get (model__ container) result))) (and (ite (= (attr__tag temp___483) (attr__tag item)) true false) (us_dispatch_eq temp___483 item))) true)) (not (= (contains (model__ container) index (- result 1) item) true)))) (dynamic_invariant1 result true false true true)))) :pattern ((find_index container item index)))))))
(declare-fun reverse_find_index (us_rep us_rep1 Int) Int)
(declare-fun reverse_find_index__function_guard (Int us_rep us_rep1 Int) Bool)
...
(declare-fun contains1 (us_rep us_rep1) Bool)
(declare-fun contains__function_guard1 (Bool us_rep us_rep1) Bool)
(assert (forall ((container us_rep)) (forall ((item us_rep1)) (! (= (= (contains1 container item) true) (= (contains (model__ container) 1 (last_index container) item) true)) :pattern ((contains1 container item))))))
...
(declare-fun f (Int) us_rep1)
(declare-fun f__function_guard (us_rep1 Int) Bool)
...
(assert true)
(assert (forall ((x Int)) (! (=> (dynamic_invariant3 x true true true true) (= (f x) (mk___rep1 (mk___split_fields1 (of_rep1 x) us_null_ext__) us_tag))) :pattern ((f x)))))
(declare-fun is_sorted (us_rep) Bool)
(declare-fun is_sorted__function_guard (Bool us_rep) Bool)
(declare-fun lt (us_rep1 us_rep1) Bool)
(declare-fun lt__function_guard (Bool us_rep1 us_rep1) Bool)
...
(define-fun in_range5 ((rec__indefinite_bounded_tagged__vect__vector__capacity1 Int) (a us_rep)) Bool (= rec__indefinite_bounded_tagged__vect__vector__capacity1 (to_rep (rec__indefinite_bounded_tagged__vect__vector__capacity (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant4 ((temp___expr_509 us_rep) (temp___is_init_505 Bool) (temp___skip_constant_506 Bool) (temp___do_toplevel_507 Bool) (temp___do_typ_inv_508 Bool)) Bool (=> (not (= temp___skip_constant_506 true)) (in_range5 5 temp___expr_509)))
(define-fun default_initial_assumption1 ((temp___expr_511 us_rep) (temp___skip_top_level_512 Bool)) Bool (and (= (to_rep (rec__indefinite_bounded_tagged__vect__vector__capacity (us_split_discrs1 temp___expr_511))) 5) (=> (not (= temp___skip_top_level_512 true)) (= (is_empty temp___expr_511) true))))
(declare-const v__split_discrs us_split_discrs)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const w__split_discrs us_split_discrs)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(assert true)
(assert (forall ((left us_rep1) (right us_rep1)) (! (= (= (lt left right) true) (< (to_rep1 (rec__indefinite_bounded_tagged__t__c (us_split_fields3 left))) (to_rep1 (rec__indefinite_bounded_tagged__t__c (us_split_fields3 right))))) :pattern ((lt left right)))))
...
(declare-const indefinite_bounded_tagged__test__B_1__w__assume us_rep)
(declare-const o9 us_rep)
(declare-const o10 us_rep1)
(declare-const o11 us_rep1)
(declare-const indefinite_bounded_tagged__vect__clear__container__fields us_split_fields)
(declare-const result us_split_fields__ref)
(declare-const v__split_fields1 us_split_fields)
(declare-const indefinite_bounded_tagged__vect__append__2__container__fields us_split_fields)
(declare-const result1 us_split_fields__ref)
(declare-const v__split_fields2 us_split_fields)
(declare-const indefinite_bounded_tagged__vect__append__2__container__fields1 us_split_fields)
(declare-const result2 us_split_fields__ref)
(declare-const v__split_fields3 us_split_fields)
(declare-const indefinite_bounded_tagged__vect__append__2__container__fields2 us_split_fields)
(declare-const result3 us_split_fields__ref)
(declare-const v__split_fields4 us_split_fields)
(declare-const indefinite_bounded_tagged__vect__reserve_capacity__container__fields us_split_fields)
...
(declare-const indefinite_bounded_tagged__vect__replace_element__container__fields us_split_fields)
(declare-const result6 us_split_fields__ref)
(declare-const v__split_fields6 us_split_fields)
(declare-const indefinite_bounded_tagged__vect__swap__container__fields us_split_fields)
(declare-const result7 us_split_fields__ref)
(declare-const v__split_fields7 us_split_fields)
(declare-const indefinite_bounded_tagged__vect__delete_last__container__fields us_split_fields)
(declare-const result8 us_split_fields__ref)
(declare-const v__split_fields8 us_split_fields)
(declare-const indefinite_bounded_tagged__vect__reverse_elements__container__fields us_split_fields)
(declare-const result9 us_split_fields__ref)
(declare-const v__split_fields9 us_split_fields)
(declare-const indefinite_bounded_tagged__sort__sort__container__fields us_split_fields)
(declare-const result10 us_split_fields__ref)
(declare-const v__split_fields10 us_split_fields)
(declare-const indefinite_bounded_tagged__vect__replace_element__container__fields1 us_split_fields)
(declare-const result11 us_split_fields__ref)
(declare-const v__split_fields11 us_split_fields)
(define-fun o12 () us_rep1 (mk___rep1 (mk___split_fields1 o6 o7) o8))
(define-fun o13 () us_rep1 (mk___rep1 (mk___split_fields1 o3 o4) o5))
(define-fun o14 () us_rep1 (mk___rep1 (mk___split_fields1 o o1) o2))
(assert (and (= us 5) (in_range1 5)))
(assert (default_initial_assumption1 (mk___rep v__split_discrs (mk___split_fields v__split_fields)) false))
(assert (= 5 (to_rep (rec__indefinite_bounded_tagged__vect__vector__capacity v__split_discrs))))
(assert (= (length (mk___rep v__split_discrs indefinite_bounded_tagged__vect__clear__container__fields)) 0))
(assert (= result (mk___split_fields__ref (mk___split_fields v__split_fields))))
(assert (= v__split_fields1 indefinite_bounded_tagged__vect__clear__container__fields))
(assert (= (is_empty (mk___rep v__split_discrs v__split_fields1)) true))
(assert (= (oeq (mk___rep v__split_discrs v__split_fields1) (empty_vector Tuple0)) true))
(assert (= (capacity (mk___rep v__split_discrs v__split_fields1)) 5))
(assert (and (= o14 (f 1)) (and (and (= (of_rep1 1) o) (= us_null_ext__ o1)) (= us_tag o2))))
(assert (and (and (= (length (mk___rep v__split_discrs indefinite_bounded_tagged__vect__append__2__container__fields)) (+ (length (mk___rep v__split_discrs v__split_fields1)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields1)) (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__vect__append__2__container__fields))) true)) (= (let ((temp___452 (get (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__vect__append__2__container__fields)) (+ (last (model__ (mk___rep v__split_discrs v__split_fields1))) 1)))) (ite (= (attr__tag temp___452) o2) (us_dispatch_eq temp___452 o14) false)) true)))
(assert (= result1 (mk___split_fields__ref v__split_fields1)))
(assert (= v__split_fields2 indefinite_bounded_tagged__vect__append__2__container__fields))
(assert (and (= o13 (f 2)) (and (and (= (of_rep1 2) o3) (= us_null_ext__ o4)) (= us_tag o5))))
(assert (and (and (= (length (mk___rep v__split_discrs indefinite_bounded_tagged__vect__append__2__container__fields1)) (+ (length (mk___rep v__split_discrs v__split_fields2)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields2)) (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__vect__append__2__container__fields1))) true)) (= (let ((temp___452 (get (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__vect__append__2__container__fields1)) (+ (last (model__ (mk___rep v__split_discrs v__split_fields2))) 1)))) (ite (= (attr__tag temp___452) o5) (us_dispatch_eq temp___452 o13) false)) true)))
(assert (= result2 (mk___split_fields__ref v__split_fields2)))
(assert (= v__split_fields3 indefinite_bounded_tagged__vect__append__2__container__fields1))
(assert (and (= o12 (f 3)) (and (and (= (of_rep1 3) o6) (= us_null_ext__ o7)) (= us_tag o8))))
(assert (and (and (= (length (mk___rep v__split_discrs indefinite_bounded_tagged__vect__append__2__container__fields2)) (+ (length (mk___rep v__split_discrs v__split_fields3)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields3)) (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__vect__append__2__container__fields2))) true)) (= (let ((temp___452 (get (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__vect__append__2__container__fields2)) (+ (last (model__ (mk___rep v__split_discrs v__split_fields3))) 1)))) (ite (= (attr__tag temp___452) o8) (us_dispatch_eq temp___452 o12) false)) true)))
...
(assert (= (let ((temp___581 (f 1))) (let ((temp___580 (get (model__ (mk___rep v__split_discrs v__split_fields4)) 1))) (ite (= (attr__tag temp___580) (attr__tag temp___581)) (us_dispatch_eq temp___580 temp___581) false))) true))
(assert (= (let ((temp___585 (f 2))) (let ((temp___584 (get (model__ (mk___rep v__split_discrs v__split_fields4)) 2))) (ite (= (attr__tag temp___584) (attr__tag temp___585)) (us_dispatch_eq temp___584 temp___585) false))) true))
(assert (= (let ((temp___589 (f 3))) (let ((temp___588 (get (model__ (mk___rep v__split_discrs v__split_fields4)) 3))) (ite (= (attr__tag temp___588) (attr__tag temp___589)) (us_dispatch_eq temp___588 temp___589) false))) true))
(assert (= (oeq1 (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__vect__reserve_capacity__container__fields)) (model__ (mk___rep v__split_discrs v__split_fields4))) true))
...
(assert (and (= indefinite_bounded_tagged__test__B_1__w__assume (copy (mk___rep v__split_discrs v__split_fields5) 6)) (and (= (oeq1 (model__ indefinite_bounded_tagged__test__B_1__w__assume) (model__ (mk___rep v__split_discrs v__split_fields5))) true) (ite (= 6 0) (= (to_rep (rec__indefinite_bounded_tagged__vect__vector__capacity (us_split_discrs1 indefinite_bounded_tagged__test__B_1__w__assume))) (length (mk___rep v__split_discrs v__split_fields5))) (= (to_rep (rec__indefinite_bounded_tagged__vect__vector__capacity (us_split_discrs1 indefinite_bounded_tagged__test__B_1__w__assume))) 6)))))
(assert (= result5 (mk___split_fields__ref (mk___split_fields w__split_fields))))
(assert (= w__split_fields1 (us_split_fields1 indefinite_bounded_tagged__test__B_1__w__assume)))
...
(assert (= (let ((temp___594 (f 1))) (let ((temp___593 (get (model__ (mk___rep w__split_discrs w__split_fields1)) 1))) (ite (= (attr__tag temp___593) (attr__tag temp___594)) (us_dispatch_eq temp___593 temp___594) false))) true))
(assert (= (let ((temp___598 (f 2))) (let ((temp___597 (get (model__ (mk___rep w__split_discrs w__split_fields1)) 2))) (ite (= (attr__tag temp___597) (attr__tag temp___598)) (us_dispatch_eq temp___597 temp___598) false))) true))
(assert (= (let ((temp___602 (f 3))) (let ((temp___601 (get (model__ (mk___rep w__split_discrs w__split_fields1)) 3))) (ite (= (attr__tag temp___601) (attr__tag temp___602)) (us_dispatch_eq temp___601 temp___602) false))) true))
...
(assert (= (let ((temp___606 (f 1))) (let ((temp___605 (get (model__ (mk___rep w__split_discrs w__split_fields2)) 1))) (ite (= (attr__tag temp___605) (attr__tag temp___606)) (us_dispatch_eq temp___605 temp___606) false))) true))
(assert (= (let ((temp___610 (f 2))) (let ((temp___609 (get (model__ (mk___rep w__split_discrs w__split_fields2)) 2))) (ite (= (attr__tag temp___609) (attr__tag temp___610)) (us_dispatch_eq temp___609 temp___610) false))) true))
(assert (= (let ((temp___614 (f 3))) (let ((temp___613 (get (model__ (mk___rep w__split_discrs w__split_fields2)) 3))) (ite (= (attr__tag temp___613) (attr__tag temp___614)) (us_dispatch_eq temp___613 temp___614) false))) true))
(assert (= (let ((temp___618 (f 1))) (let ((temp___617 (get (model__ (mk___rep w__split_discrs w__split_fields2)) 4))) (ite (= (attr__tag temp___617) (attr__tag temp___618)) (us_dispatch_eq temp___617 temp___618) false))) true))
(assert (= (let ((temp___622 (f 2))) (let ((temp___621 (get (model__ (mk___rep w__split_discrs w__split_fields2)) 5))) (ite (= (attr__tag temp___621) (attr__tag temp___622)) (us_dispatch_eq temp___621 temp___622) false))) true))
(assert (= (let ((temp___626 (f 3))) (let ((temp___625 (get (model__ (mk___rep w__split_discrs w__split_fields2)) 6))) (ite (= (attr__tag temp___625) (attr__tag temp___626)) (us_dispatch_eq temp___625 temp___626) false))) true))
(assert (and (= o9 (empty_vector Tuple0)) (= (length o9) 0)))
(assert (= (oeq1 (model__ (mk___rep w__split_discrs w__split_fields3)) (model__ o9)) true))
...
(assert (and (= o10 (f 4)) (= o10 (mk___rep1 (mk___split_fields1 (of_rep1 4) us_null_ext__) us_tag))))
(assert (and (and (= (length (mk___rep v__split_discrs indefinite_bounded_tagged__vect__replace_element__container__fields)) (length (mk___rep v__split_discrs v__split_fields5))) (= (let ((temp___430 (get (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__vect__replace_element__container__fields)) 2))) (ite (= (attr__tag temp___430) (attr__tag o10)) (us_dispatch_eq temp___430 o10) false)) true)) (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields5)) (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__vect__replace_element__container__fields)) 2) true)))
...
(assert (= (let ((temp___631 (f 1))) (let ((temp___630 (get (model__ (mk___rep v__split_discrs v__split_fields6)) 1))) (ite (= (attr__tag temp___630) (attr__tag temp___631)) (us_dispatch_eq temp___630 temp___631) false))) true))
(assert (= (let ((temp___635 (f 4))) (let ((temp___634 (get (model__ (mk___rep v__split_discrs v__split_fields6)) 2))) (ite (= (attr__tag temp___634) (attr__tag temp___635)) (us_dispatch_eq temp___634 temp___635) false))) true))
(assert (= (let ((temp___639 (f 3))) (let ((temp___638 (get (model__ (mk___rep v__split_discrs v__split_fields6)) 3))) (ite (= (attr__tag temp___638) (attr__tag temp___639)) (us_dispatch_eq temp___638 temp___639) false))) true))
(assert (= (m_elements_swapped (model__ (mk___rep v__split_discrs v__split_fields6)) (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__vect__swap__container__fields)) 1 3) true))
...
(assert (= (let ((temp___644 (f 3))) (let ((temp___643 (get (model__ (mk___rep v__split_discrs v__split_fields7)) 1))) (ite (= (attr__tag temp___643) (attr__tag temp___644)) (us_dispatch_eq temp___643 temp___644) false))) true))
(assert (= (let ((temp___648 (f 4))) (let ((temp___647 (get (model__ (mk___rep v__split_discrs v__split_fields7)) 2))) (ite (= (attr__tag temp___647) (attr__tag temp___648)) (us_dispatch_eq temp___647 temp___648) false))) true))
(assert (= (let ((temp___652 (f 1))) (let ((temp___651 (get (model__ (mk___rep v__split_discrs v__split_fields7)) 3))) (ite (= (attr__tag temp___651) (attr__tag temp___652)) (us_dispatch_eq temp___651 temp___652) false))) true))
(assert (and (= (length (mk___rep v__split_discrs indefinite_bounded_tagged__vect__delete_last__container__fields)) (- (length (mk___rep v__split_discrs v__split_fields7)) 1)) (= (olt (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__vect__delete_last__container__fields)) (model__ (mk___rep v__split_discrs v__split_fields7))) true)))
...
(assert (= (let ((temp___657 (f 3))) (let ((temp___656 (get (model__ (mk___rep v__split_discrs v__split_fields8)) 1))) (ite (= (attr__tag temp___656) (attr__tag temp___657)) (us_dispatch_eq temp___656 temp___657) false))) true))
(assert (= (let ((temp___661 (f 4))) (let ((temp___660 (get (model__ (mk___rep v__split_discrs v__split_fields8)) 2))) (ite (= (attr__tag temp___660) (attr__tag temp___661)) (us_dispatch_eq temp___660 temp___661) false))) true))
(assert (= (m_elements_reversed (model__ (mk___rep v__split_discrs v__split_fields8)) (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__vect__reverse_elements__container__fields))) true))
...
(assert (not (= (is_empty (mk___rep v__split_discrs v__split_fields9)) true)))
(assert (= (length (mk___rep v__split_discrs v__split_fields9)) 2))
(assert (= (capacity (mk___rep v__split_discrs v__split_fields9)) 5))
(assert (= (let ((temp___666 (f 4))) (let ((temp___665 (get (model__ (mk___rep v__split_discrs v__split_fields9)) 1))) (ite (= (attr__tag temp___665) (attr__tag temp___666)) (us_dispatch_eq temp___665 temp___666) false))) true))
(assert (= (let ((temp___670 (f 3))) (let ((temp___669 (get (model__ (mk___rep v__split_discrs v__split_fields9)) 2))) (ite (= (attr__tag temp___669) (attr__tag temp___670)) (us_dispatch_eq temp___669 temp___670) false))) true))
(assert (= (last (model__ (mk___rep v__split_discrs v__split_fields9))) 2))
(assert (= (let ((temp___674 (f 4))) (let ((temp___673 (get (model__ (mk___rep v__split_discrs v__split_fields9)) 1))) (ite (= (attr__tag temp___673) (attr__tag temp___674)) (us_dispatch_eq temp___673 temp___674) false))) true))
(assert (= (let ((temp___678 (f 3))) (let ((temp___677 (last_element (mk___rep v__split_discrs v__split_fields9)))) (ite (= (attr__tag temp___677) (attr__tag temp___678)) (us_dispatch_eq temp___677 temp___678) false))) true))
(assert (= (find_index (mk___rep v__split_discrs v__split_fields9) (f 0) 1) 0))
(assert (= (find_index (mk___rep v__split_discrs v__split_fields9) (f 4) 1) 1))
(assert (= (find_index (mk___rep v__split_discrs v__split_fields9) (f 4) 2) 0))
(assert (= (reverse_find_index (mk___rep v__split_discrs v__split_fields9) (f 0) 2147483647) 0))
(assert (= (reverse_find_index (mk___rep v__split_discrs v__split_fields9) (f 4) 2147483647) 1))
(assert (= (reverse_find_index (mk___rep v__split_discrs v__split_fields9) (f 4) 2) 1))
(assert (= (contains1 (mk___rep v__split_discrs v__split_fields9) (f 4)) true))
(assert (not (= (contains1 (mk___rep v__split_discrs v__split_fields9) (f 0)) true)))
(assert (= (has_element (mk___rep v__split_discrs v__split_fields9) 1) true))
(assert (not (= (has_element (mk___rep v__split_discrs v__split_fields9) 0) true)))
(assert (not (= (has_element (mk___rep v__split_discrs v__split_fields9) 3) true)))
(assert (not (= (is_sorted (mk___rep v__split_discrs v__split_fields9)) true)))
(assert (and (and (and (= (length (mk___rep v__split_discrs indefinite_bounded_tagged__sort__sort__container__fields)) (length (mk___rep v__split_discrs v__split_fields9))) (= (m_elements_sorted (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__sort__sort__container__fields))) true)) (= (m_elements_included (model__ (mk___rep v__split_discrs v__split_fields9)) 1 (last (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__sort__sort__container__fields))) (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__sort__sort__container__fields)) 1 (last (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__sort__sort__container__fields)))) true)) (= (m_elements_included (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__sort__sort__container__fields)) 1 (last (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__sort__sort__container__fields))) (model__ (mk___rep v__split_discrs v__split_fields9)) 1 (last (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__sort__sort__container__fields)))) true)))
(assert (= result10 (mk___split_fields__ref v__split_fields9)))
(assert (= v__split_fields10 indefinite_bounded_tagged__sort__sort__container__fields))
(assert (not (= (is_empty (mk___rep v__split_discrs v__split_fields10)) true)))
(assert (= (length (mk___rep v__split_discrs v__split_fields10)) 2))
(assert (= (capacity (mk___rep v__split_discrs v__split_fields10)) 5))
(assert (= (let ((temp___683 (f 3))) (let ((temp___682 (get (model__ (mk___rep v__split_discrs v__split_fields10)) 1))) (ite (= (attr__tag temp___682) (attr__tag temp___683)) (us_dispatch_eq temp___682 temp___683) false))) true))
(assert (= (let ((temp___687 (f 4))) (let ((temp___686 (get (model__ (mk___rep v__split_discrs v__split_fields10)) 2))) (ite (= (attr__tag temp___686) (attr__tag temp___687)) (us_dispatch_eq temp___686 temp___687) false))) true))
(assert (= (is_sorted (mk___rep v__split_discrs v__split_fields10)) true))
(assert (and (= o11 (get (model__ (mk___rep v__split_discrs v__split_fields10)) 2)) (= (let ((temp___426 (get (model__ (mk___rep v__split_discrs v__split_fields10)) 2))) (ite (= (attr__tag o11) (attr__tag temp___426)) (us_dispatch_eq o11 temp___426) false)) true)))
(assert (and (and (= (length (mk___rep v__split_discrs indefinite_bounded_tagged__vect__replace_element__container__fields1)) (length (mk___rep v__split_discrs v__split_fields10))) (= (let ((temp___430 (get (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__vect__replace_element__container__fields1)) 1))) (ite (= (attr__tag temp___430) (attr__tag o11)) (us_dispatch_eq temp___430 o11) false)) true)) (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields10)) (model__ (mk___rep v__split_discrs indefinite_bounded_tagged__vect__replace_element__container__fields1)) 1) true)))
(assert (= result11 (mk___split_fields__ref v__split_fields10)))
(assert (= v__split_fields11 indefinite_bounded_tagged__vect__replace_element__container__fields1))
(assert (not (= (capacity (mk___rep v__split_discrs v__split_fields11)) 5)))
(check-sat)
(exit)
