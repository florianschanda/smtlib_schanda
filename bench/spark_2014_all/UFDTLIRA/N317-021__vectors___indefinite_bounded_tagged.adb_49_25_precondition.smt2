...
(declare-const temp___604 us_rep1)
...
(assert (and (= temp___604 (f 1)) (= temp___604 (mk___rep1 (mk___split_fields1 (of_rep1 1) us_null_ext__) us_tag))))
(assert (not (<= 1 (last (model__ (mk___rep w__split_discrs w__split_fields2))))))
(check-sat)
(exit)
