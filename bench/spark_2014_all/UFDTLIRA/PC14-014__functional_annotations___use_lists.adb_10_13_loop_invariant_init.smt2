...
(assert (and (= result1 (has_key (positions l) (mk___rep cu__split_fields2))) (= (= result1 true) (= (has_key (positions l) (mk___rep cu__split_fields2)) true))))
(assert (= result1 true))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i (- (get1 (positions l) (mk___rep cu__split_fields2)) 1)))
(assert (not (not (= (get (model__ l) i) e))))
(check-sat)
(exit)
