...
(assert (= (to_rep g__split_discrs) 0))
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___204 o1))
(assert (= rliteral temp___2041))
(assert (= rliteral temp___2042))
(assert (= true temp___2043))
(assert (= true temp___2044))
(assert (= g__attr__constrained true))
(assert (not (= temp___204 g__split_discrs)))
(check-sat)
(exit)
