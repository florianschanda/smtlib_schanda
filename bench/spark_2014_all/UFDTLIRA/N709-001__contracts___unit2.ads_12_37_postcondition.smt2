...
(assert (forall ((unit1__create__x__fields us_split_fields) (unit1__create__x__old__fields us_split_fields)) (forall ((x__attr__tag Int)) (! (=> (create__specific_post us_tag1 unit1__create__x__fields x__attr__tag unit1__create__x__old__fields) (let ((temp___x_167 (of_base (mk___rep unit1__create__x__fields x__attr__tag)))) (and (= (to_rep (rec__unit1__t1__c11 (us_split_fields3 temp___x_167))) 0) (= (to_rep (rec__unit2__t2__c2 (us_split_fields3 temp___x_167))) 0)))) :pattern ((create__specific_post us_tag1 unit1__create__x__fields x__attr__tag unit1__create__x__old__fields))))))
(assert (forall ((unit1__create__x__fields us_split_fields) (unit1__create__x__old__fields us_split_fields)) (forall ((x__attr__tag Int)) (! (=> (create__specific_post us_tag unit1__create__x__fields x__attr__tag unit1__create__x__old__fields) (= (to_rep (rec__unit1__t1__c1 (us_split_fields1 (mk___rep unit1__create__x__fields x__attr__tag)))) 0)) :pattern ((create__specific_post us_tag unit1__create__x__fields x__attr__tag unit1__create__x__old__fields))))))
...
(assert (forall ((x us_rep1)) (! (= (= (is_zero2 x) true) (and (= (is_zero (to_base x)) true) (= (to_rep (rec__unit2__t2__c2 (us_split_fields3 x))) 0))) :pattern ((is_zero2 x)))))
(assert true)
(assert true)
...
(assert (forall ((x us_rep)) (! (= (= (is_zero x) true) (= (to_rep (rec__unit1__t1__c1 (us_split_fields1 x))) 0)) :pattern ((is_zero x)))))
...
(declare-const unit1__create__x__fields integer)
(declare-const unit1__create__x__fields1 us_private)
...
(assert (= (to_rep unit1__create__x__fields) 0))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= result2 x__split_fields2))
(assert (= (mk___split_fields1 x__split_fields3 x__split_fields4 x__split_fields5) (us_split_fields3 (of_base (mk___rep (mk___split_fields unit1__create__x__fields unit1__create__x__fields1) x__attr__tag)))))
(assert (= result3 x__split_fields3))
(assert (= result4 x__split_fields4))
(assert (= result5 x__split_fields5))
(assert (= rliteral x__split_fields6))
(assert (= x__split_fields4 x__split_fields7))
(assert (= x__split_fields5 x__split_fields8))
...
(assert (= x__split_fields12 x__split_fields6))
(assert (= x__split_fields13 x__split_fields7))
(assert (= x__split_fields14 x__split_fields8))
(assert (not (= (to_rep x__split_fields9) 0)))
(check-sat)
(exit)
