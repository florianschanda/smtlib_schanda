...
(declare-const temp___6706 et3)
(declare-const temp___67061 et1)
(declare-const temp___67062 et2)
(declare-const temp___67063 enum1ta)
...
(assert (= temp___6706 o5))
(assert (= temp___67061 o6))
(assert (= temp___67062 o7))
(assert (= temp___67063 o8))
...
(assert (= temp___6706 r__split_fields4))
(assert (= temp___67061 r__split_fields5))
(assert (= temp___67062 r__split_fields6))
(assert (= temp___67063 r__split_fields7))
(assert (= r__split_fields8 (mk___split_fields__ref1 r__split_fields10)))
(assert (= r__split_fields9 r__split_fields10))
(assert (not (= (to_rep3 (rec__ar__rec2t__h2 (us_split_fields__content1 r__split_fields8))) (to_rep3 r__split_fields3))))
(check-sat)
(exit)
