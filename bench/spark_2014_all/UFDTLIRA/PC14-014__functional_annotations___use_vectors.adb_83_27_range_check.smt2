...
(assert (forall ((i1 Int)) (=> (and (<= first4 i1) (<= i1 (- fst1 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) i1) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i1)))))
(assert (forall ((i1 Int)) (=> (and (<= current2 i1) (<= i1 (last2 (model__ (mk___rep v__split_discrs v__split_fields2))))) (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) i1) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i1)))))
(assert (and (and (=> (<= fst1 lst1) (dynamic_property6 fst1 lst1 current2)) (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)))) (and (<= fst1 current2) (<= current2 lst1))))
(assert (and (= o (- fst1 1)) (in_range1 (- fst1 1))))
(assert (= o1 (ite (<= i o) true false)))
(assert (= result1 (ite (<= first4 i) o1 false)))
(assert (= result1 true))
(assert (and (= us i) (dynamic_property2 first1 last3 i)))
(assert (= o2 i))
(assert (and (= o3 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) o2)) (in_range3 o3)))
(assert (not (dynamic_property3 first2 last4 i)))
(check-sat)
(exit)
