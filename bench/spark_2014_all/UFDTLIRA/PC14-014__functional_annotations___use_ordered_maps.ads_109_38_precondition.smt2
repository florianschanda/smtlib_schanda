...
(declare-const temp___857 us_rep1)
...
(assert (and (= temp___857 (keys s)) (and (and (and (= (length1 temp___857) (length s)) (forall ((temp___439 Int)) (=> (and (in_range3 temp___439) (= (iter_has_element temp___857 temp___439) true)) (= (has_key (model__ s) (get temp___857 temp___439)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ s) key) true)) (and (< 0 (find temp___857 key)) (= (equivalent_keys (get temp___857 (find temp___857 key)) key) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (and (= (find temp___857 (get temp___857 i)) i) (= (k_is_find temp___857 (get temp___857 i) i) true)))))))
(assert (and (= o (iter_has_element temp___857 temp___856)) (= (= o true) (and (<= 1 temp___856) (<= temp___856 (last temp___857))))))
(assert (= (= o1 true) (in_range3 temp___856)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (and (= k (get temp___857 temp___856)) (in_range2 k)))
