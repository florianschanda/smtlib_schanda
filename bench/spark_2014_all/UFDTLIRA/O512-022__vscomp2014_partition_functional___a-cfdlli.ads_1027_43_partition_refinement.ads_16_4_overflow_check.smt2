...
(assert (and (= o (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range o) (<= o (to_rep (rec__partition_refinement__partitioning_sets__list__capacity target__split_discrs))))))
(assert (= o1 (- (to_rep (rec__partition_refinement__partitioning_sets__list__capacity target__split_discrs)) o)))
