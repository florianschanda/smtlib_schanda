...
(declare-const temp___587 integer)
(declare-const temp___5871 us_private)
(declare-const temp___5872 Int)
...
(assert (and (= (mk___rep1 (mk___split_fields1 temp___587 temp___5871) temp___5872) (f 3)) (and (and (= (of_rep1 3) temp___587) (= us_null_ext__ temp___5871)) (= us_tag temp___5872))))
(assert (not (<= 3 (last (model__ (mk___rep v__split_discrs v__split_fields4))))))
(check-sat)
(exit)
