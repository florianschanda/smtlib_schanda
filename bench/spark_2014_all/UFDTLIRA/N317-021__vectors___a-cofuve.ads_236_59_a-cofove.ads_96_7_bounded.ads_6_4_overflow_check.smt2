...
(define-fun dynamic_invariant1 ((temp___expr_266 Int) (temp___is_init_262 Bool) (temp___skip_constant_263 Bool) (temp___do_toplevel_264 Bool) (temp___do_typ_inv_265 Bool)) Bool (=> (or (= temp___is_init_262 true) (<= 0 2147483647)) (in_range2 temp___expr_266)))
...
(define-fun dynamic_invariant2 ((temp___expr_252 Int) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool) (temp___do_typ_inv_251 Bool)) Bool (=> (or (= temp___is_init_248 true) (<= 1 2147483647)) (in_range4 temp___expr_252)))
