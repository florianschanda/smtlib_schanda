...
(assert (and (= (length (mk___rep l__split_discrs l__split_fields2)) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1)) (ite (= (bool_eq2 cu no_element) true) (and (and (and (and (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (last1 (mk___rep l__split_discrs l__split_fields2))) (length (mk___rep l__split_discrs l__split_fields2))) (= (keys_included_except (positions (mk___rep l__split_discrs l__split_fields2)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (last1 (mk___rep l__split_discrs l__split_fields2))) true)) (= (ole1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields2))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (length (mk___rep l__split_discrs l__split_fields2))) 0)) (= (ole (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields2))) true)) (and (and (and (= (range_equal (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields2)) 1 (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu) 1)) true) (= (range_shifted (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu)) 0)) (= (p_positions_shifted (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu) 1) true)))))
(assert (not (or (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) cu) true) (= (bool_eq2 cu no_element) true))))
(check-sat)
(exit)
