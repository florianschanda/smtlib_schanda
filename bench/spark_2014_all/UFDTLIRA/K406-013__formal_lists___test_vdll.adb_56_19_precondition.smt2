...
(assert (and (= o7 (first (mk___rep l2__split_discrs l2__split_fields4))) (ite (= (= (length (mk___rep l2__split_discrs l2__split_fields4)) 0) true) (= (bool_eq3 o7 no_element) true) (and (= (has_key (positions (mk___rep l2__split_discrs l2__split_fields4)) o7) true) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields4)) o7) 1)))))
(assert (and (= o8 (next (mk___rep l2__split_discrs l2__split_fields4) o7)) (ite (= (ite (= (bool_eq3 o7 no_element) false) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields4)) o7) (length (mk___rep l2__split_discrs l2__split_fields4))) true) true) (= (bool_eq3 o8 no_element) true) (and (= (has_key (positions (mk___rep l2__split_discrs l2__split_fields4)) o8) true) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields4)) o8) (+ (get1 (positions (mk___rep l2__split_discrs l2__split_fields4)) o7) 1))))))
(assert (not (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields3)) o8) true)))
(check-sat)
(exit)
