...
(assert (forall ((container us_rep1)) (forall ((key1 Int)) (! (=> (dynamic_invariant5 key1 true true true true) (let ((result (find container key1))) (and (=> (< 0 result) (and (<= result (length1 container)) (= (equivalent_keys key1 (get container result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container key1))))))
...
(assert (forall ((container us_rep2)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant6 key1 true true true true) (= (has_key container key1) true)) (let ((result (get1 container key1))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key1))) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key container k) true)) (= (= (equivalent_keys k key1) true) (= (witness container key1) (witness container k))))))) (dynamic_invariant7 result true false true true)))) :pattern ((get1 container key1))))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant6 key1 true true true true) (= (has_key container key1) true)) (let ((result (witness container key1))) (and (= (has_witness container result) true) (dynamic_invariant result true false true true)))) :pattern ((witness container key1))))))
...
(assert (= result true))
(assert (and (= o2 (keys s)) (and (and (and (= (length1 o2) (length s)) (forall ((temp___439 Int)) (=> (and (in_range3 temp___439) (= (iter_has_element o2 temp___439) true)) (= (has_key (model__ s) (get o2 temp___439)) true)))) (forall ((key1 Int)) (=> (and (in_range4 key1) (= (has_key (model__ s) key1) true)) (and (< 0 (find o2 key1)) (= (equivalent_keys (get o2 (find o2 key1)) key1) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o2 (get o2 i1)) i1) (= (k_is_find o2 (get o2 i1) i1) true)))))))
