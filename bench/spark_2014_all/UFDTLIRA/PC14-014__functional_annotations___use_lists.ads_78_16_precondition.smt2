...
(assert (and (= o4 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (not (= (has_key o4 no_element) true)) (forall ((i us_rep2)) (=> (= (has_key o4 i) true) (and (and (<= 1 (get1 o4 i)) (<= (get1 o4 i) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (forall ((j us_rep2)) (=> (= (has_key o4 j) true) (=> (= (get1 o4 i) (get1 o4 j)) (= (bool_eq2 i j) true))))))))))
(assert (and (= result (has_key o4 fst)) (=> (= (distinct 0 0) true) (=> (exists ((k us_rep2)) (and (= (has_key o4 k) true) (= (bool_eq2 k fst) true))) (= result true)))))
(assert (= result true))
(assert (and (= o3 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (not (= (has_key o3 no_element) true)) (forall ((i us_rep2)) (=> (= (has_key o3 i) true) (and (and (<= 1 (get1 o3 i)) (<= (get1 o3 i) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (forall ((j us_rep2)) (=> (= (has_key o3 j) true) (=> (= (get1 o3 i) (get1 o3 j)) (= (bool_eq2 i j) true))))))))))
(assert (and (= result1 (has_key o3 lst)) (=> (= (distinct 0 0) true) (=> (exists ((k us_rep2)) (and (= (has_key o3 k) true) (= (bool_eq2 k lst) true))) (= result1 true)))))
(assert (= result1 true))
(assert (and (= o1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (not (= (has_key o1 no_element) true)) (forall ((i us_rep2)) (=> (= (has_key o1 i) true) (and (and (<= 1 (get1 o1 i)) (<= (get1 o1 i) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (forall ((j us_rep2)) (=> (= (has_key o1 j) true) (=> (= (get1 o1 i) (get1 o1 j)) (= (bool_eq2 i j) true))))))))))
(assert (and (= o2 (get1 o1 fst)) (and (in_range4 o2) (=> (= (distinct 0 0) true) (and (= o2 (w_get o1 (witness o1 fst))) (forall ((k us_rep2)) (=> (= (has_key o1 k) true) (= (= (bool_eq2 k fst) true) (= (witness o1 fst) (witness o1 k))))))))))
(assert (and (= o (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (not (= (has_key o no_element) true)) (forall ((i us_rep2)) (=> (= (has_key o i) true) (and (and (<= 1 (get1 o i)) (<= (get1 o i) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (forall ((j us_rep2)) (=> (= (has_key o j) true) (=> (= (get1 o i) (get1 o j)) (= (bool_eq2 i j) true))))))))))
(assert (not (= (has_key o lst) true)))
(check-sat)
(exit)
