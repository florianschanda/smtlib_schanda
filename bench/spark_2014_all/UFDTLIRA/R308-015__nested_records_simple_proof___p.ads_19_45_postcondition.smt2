...
(assert (= (mk___rep (mk___split_fields p__create_type_1__result24 p__create_type_1__result25 p__create_type_1__result26 p__create_type_1__result27 p__create_type_1__result28 p__create_type_1__result29 p__create_type_1__result30 p__create_type_1__result31)) (mk___rep (mk___split_fields p__create_type_1__result8 p__create_type_1__result9 p__create_type_1__result10 p__create_type_1__result11 p__create_type_1__result12 p__create_type_1__result13 p__create_type_1__result14 p__create_type_1__result15))))
...
(assert (= rliteral p__create_type_1__result8))
(assert (= rliteral p__create_type_1__result9))
(assert (= rliteral p__create_type_1__result10))
(assert (= rliteral p__create_type_1__result11))
(assert (= rliteral p__create_type_1__result12))
(assert (= rliteral p__create_type_1__result13))
(assert (= rliteral p__create_type_1__result14))
(assert (= rliteral p__create_type_1__result15))
...
(assert (not (= (to_rep p__create_type_1__result33) 0)))
(check-sat)
(exit)
