...
(assert (forall ((i tTdSP1)) (and (<= 1 (tTdSP1qtint i)) (<= (tTdSP1qtint i) 2))))
...
(declare-datatypes () ((tTdSP1__ref (mk_tTdSP1__ref (tTdSP1__content tTdSP1)))))
(define-fun tTdSP1__ref___projection ((a tTdSP1__ref)) tTdSP1 (tTdSP1__content a))
(declare-sort tTdSP2 0)
(declare-fun tTdSP2qtint (tTdSP2) Int)
(assert (forall ((i tTdSP2)) (and (<= 1 (tTdSP2qtint i)) (<= (tTdSP2qtint i) 2))))
...
(declare-datatypes () ((tTdSP2__ref (mk_tTdSP2__ref (tTdSP2__content tTdSP2)))))
(define-fun tTdSP2__ref___projection ((a tTdSP2__ref)) tTdSP2 (tTdSP2__content a))
(declare-sort t8b 0)
...
(assert (forall ((i tTeSP1)) (and (<= 1 (tTeSP1qtint i)) (<= (tTeSP1qtint i) 2))))
...
(declare-datatypes () ((tTeSP1__ref (mk_tTeSP1__ref (tTeSP1__content tTeSP1)))))
(define-fun tTeSP1__ref___projection ((a tTeSP1__ref)) tTeSP1 (tTeSP1__content a))
(declare-sort tTeSP2 0)
(declare-fun tTeSP2qtint (tTeSP2) Int)
(assert (forall ((i tTeSP2)) (and (<= 1 (tTeSP2qtint i)) (<= (tTeSP2qtint i) 2))))
...
(declare-datatypes () ((tTeSP2__ref (mk_tTeSP2__ref (tTeSP2__content tTeSP2)))))
(define-fun tTeSP2__ref___projection ((a tTeSP2__ref)) tTeSP2 (tTeSP2__content a))
(declare-sort t11b 0)
(declare-fun t11bqtint (t11b) Int)
(assert (forall ((i t11b)) (and (<= 3 (t11bqtint i)) (<= (t11bqtint i) 4))))
...
(assert (forall ((i t12b)) (and (<= 0 (t12bqtint i)) (<= (t12bqtint i) 1))))
...
(assert (forall ((temp___305 Int)) (=> (dynamic_invariant temp___305 true true true true) (forall ((temp___306 Int) (temp___307 Int)) (= (get (array_aggr__bi_dim_aggr_ok__aggregate_ko1__d__aggregate_def temp___305) temp___306 temp___307) rliteral)))))
(assert (forall ((temp___310 Int)) (=> (dynamic_invariant temp___310 true true true true) (forall ((temp___311 Int) (temp___312 Int)) (= (get (array_aggr__bi_dim_aggr_ok__aggregate_ko1__e__aggregate_def temp___310) temp___311 temp___312) rliteral)))))
...
(assert (<= one 1))
(assert (= result d))
(assert (= d1 (slide (array_aggr__bi_dim_aggr_ok__aggregate_ko1__d__aggregate_def 0) 0 1 3 1)))
(assert (<= 1 2))
(assert (not (<= 2 2147483647)))
(check-sat)
(exit)
