...
(define-fun o8 () us_rep1 (mk___rep1 (mk___split_fields1 o6)))
...
(assert (and (= o8 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) 0) true) (= (bool_eq1 o8 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) o8) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) o8) 1)))))
(assert (and (= o7 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields2)) o8)) (and (in_range2 o7) (= o7 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) o8))))))
(assert (= result (ite (= o7 i) true false)))
(assert (= result true))
(assert (and (= o2 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (in_range1 o2) (<= o2 (to_rep (rec__int_list__my_lists__list__capacity l__split_discrs))))))
(assert (= o3 (+ o2 1)))
(assert (and (= o4 o3) (in_range3 o3)))
(assert (and (= o5 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (and (in_range1 o5) (<= o5 (to_rep (rec__int_list__my_lists__list__capacity l__split_discrs))))))
