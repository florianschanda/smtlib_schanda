...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dic_pred__s__f natural)))))
(define-fun us_split_fields_F__2__projection ((a us_split_fields)) natural (rec__dic_pred__s__f a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__dic_pred__s__f (us_split_fields1 a))) (to_rep (rec__dic_pred__s__f (us_split_fields1 b)))) true false))
...
(assert (= c (id 0)))
(define-fun default_initial_assumption ((temp___expr_170 us_rep) (temp___skip_top_level_171 Bool)) Bool (and (= (to_rep (rec__dic_pred__s__f (us_split_fields1 temp___expr_170))) c) (=> (not (= temp___skip_top_level_171 true)) (<= 0 c))))
(assert (in_range c))
(assert (= (id 0) c))
