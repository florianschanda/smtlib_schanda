...
(assert (and (= o7 (last1 (mk___rep l3__split_discrs l3__split_fields2))) (ite (= (= (length (mk___rep l3__split_discrs l3__split_fields2)) 0) true) (= (bool_eq3 o7 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o7) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o7) (length (mk___rep l3__split_discrs l3__split_fields2)))))))
(assert (not (or (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) no_element) true) (= (bool_eq3 no_element no_element) true))))
(check-sat)
(exit)
