...
(assert (=> (= result1 true) (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 (length (mk___rep l2__split_discrs l2__split_fields12)))) (= (is_incr (get (model__ l1) n1) (get (model__ (mk___rep l2__split_discrs l2__split_fields12)) n1)) true)))))
...
(assert (and (= o6 (length l1)) (and (in_range1 o6) (<= o6 (to_rep (rec__use_lists__my_lists__list__capacity (us_split_discrs1 l1)))))))
(assert (= o7 (ite (<= n o6) true false)))
(assert (= result4 (ite (<= 1 n) o7 false)))
(assert (= result4 true))
(assert (and (= o8 (model__ (mk___rep l2__split_discrs (us_split_fields__content l2__split_fields8)))) (= (length1 o8) (length (mk___rep l2__split_discrs (us_split_fields__content l2__split_fields8))))))
(assert (not (<= 1 n)))
(check-sat)
(exit)
