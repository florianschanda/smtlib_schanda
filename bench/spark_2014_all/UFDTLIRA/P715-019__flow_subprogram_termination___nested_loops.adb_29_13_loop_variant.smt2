...
(assert (<= 1 i1))
(assert (<= i1 5))
(assert (and (=> (<= 1 5) (in_range2 i2)) (and (<= 1 i2) (<= i2 5))))
(assert (= temp___166 result4))
(assert (= temp___1661 i2))
(assert (=> (= (distinct 1 0) true) (not (= (distinct 1 0) true))))
(assert (not (= i2 5)))
(assert (= result5 i2))
(assert (= i3 (+ i2 1)))
(assert (not (< temp___1661 i3)))
(check-sat)
(exit)
