...
(assert (and (= result1 (has_key (positions s1) (mk___rep cu__split_fields2))) (= (= result1 true) (= (has_key (positions s1) (mk___rep cu__split_fields2)) true))))
(assert (= result1 true))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i (- (get1 (positions s1) (mk___rep cu__split_fields2)) 1)))
