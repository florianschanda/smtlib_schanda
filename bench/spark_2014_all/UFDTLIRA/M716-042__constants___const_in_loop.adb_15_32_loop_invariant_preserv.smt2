...
(define-fun dynamic_invariant2 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool) (const_in_loop__B_2__x Int)) Bool (=> (or (= temp___is_init_154 true) (<= 1 (last const_in_loop__B_2__x))) (dynamic_property 1 (last const_in_loop__B_2__x) temp___expr_158)))
...
(assert (= v12 v22))
(assert (= v13 (last x2)))
(assert (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 v13)) (=> (<= (- 2147483648) 2147483647) (in_range1 v23))) (=> (<= (- 2147483648) 2147483647) (in_range1 x2))) (=> (<= 1 2147483647) (in_range2 z2))))
(assert (= z2 result6))
(assert (= z3 2))
(assert (= (distinct 1 0) true))
(assert (= x2 result7))
