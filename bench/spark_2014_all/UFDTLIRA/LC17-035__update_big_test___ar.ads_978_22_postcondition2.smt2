...
(assert (not (= (to_rep2 (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields__content2 r__split_fields7))))) (to_rep2 (rec__ar__rec2t__f2 (us_split_fields3 a))))))
(check-sat)
(exit)
