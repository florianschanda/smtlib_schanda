...
(define-fun dynamic_invariant ((temp___expr_580 Int) (temp___is_init_576 Bool) (temp___skip_constant_577 Bool) (temp___do_toplevel_578 Bool) (temp___do_typ_inv_579 Bool)) Bool (=> (or (= temp___is_init_576 true) (<= 0 2147483647)) (in_range temp___expr_580)))
...
(define-fun dynamic_invariant1 ((temp___expr_594 Int) (temp___is_init_590 Bool) (temp___skip_constant_591 Bool) (temp___do_toplevel_592 Bool) (temp___do_typ_inv_593 Bool)) Bool (=> (or (= temp___is_init_590 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_594)))
(define-fun default_initial_assumption ((temp___expr_608 us_rep1) (temp___skip_top_level_609 Bool)) Bool (= (to_rep (rec__instances__lists__cursor__node (us_split_fields3 temp___expr_608))) 0))
...
(define-fun default_initial_assumption1 ((temp___expr_667 us_rep2) (temp___skip_top_level_668 Bool)) Bool (=> (not (= temp___skip_top_level_668 true)) (and (= (is_empty temp___expr_667) true) (= (length1 temp___expr_667) 0))))
(define-fun default_initial_assumption2 ((temp___expr_653 us_rep1) (temp___skip_top_level_654 Bool)) Bool (= (to_rep (rec__instances__lists__cursor__node (us_split_fields3 temp___expr_653))) 0))
...
(define-fun dynamic_invariant2 ((temp___expr_659 Int) (temp___is_init_655 Bool) (temp___skip_constant_656 Bool) (temp___do_toplevel_657 Bool) (temp___do_typ_inv_658 Bool)) Bool (=> (or (= temp___is_init_655 true) (<= 1 2147483647)) (in_range4 temp___expr_659)))
...
(assert (not (in_range1 (- (to_rep (rec__instances__lists__list__capacity container__split_discrs)) count))))
(check-sat)
(exit)
