...
(declare-datatypes () ((file__ref (mk_file__ref (file__content us_rep1)))))
(define-fun file__ref___projection ((a file__ref)) us_rep1 (file__content a))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-fun local_invariant (us_rep1 us_split_fields us_split_discrs Int us_split_fields us_split_discrs Int) Bool)
(declare-fun local_invariant__function_guard (Bool us_rep1 us_split_fields us_split_discrs Int us_split_fields us_split_discrs Int) Bool)
...
(define-fun dynamic_invariant3 ((temp___expr_515 Int) (temp___is_init_511 Bool) (temp___skip_constant_512 Bool) (temp___do_toplevel_513 Bool) (temp___do_typ_inv_514 Bool)) Bool (=> (or (= temp___is_init_511 true) (<= 0 2)) (in_range4 temp___expr_515)))
...
(declare-const temp___1004 us_rep1)
(declare-const temp___1006 Int)
(declare-const temp___1003 read_status)
(declare-const temp___10031 character)
(declare-const temp___10032 Bool)
...
(declare-const temp___10071 Int)
...
(declare-const the_file3 us_rep1)
...
(declare-const temp___10072 Int)
(declare-const result int__ref)
(declare-const temp___10073 Int)
(declare-const the_file4 us_rep1)
...
(declare-const the_file5 us_rep1)
...
(declare-const the_file7 us_rep1)
...
(declare-const the_file9 us_rep1)
...
(declare-const the_file11 us_rep1)
...
(declare-const temp___10074 int__ref)
(declare-const the_file13 us_rep1)
...
(declare-const temp___10075 Int)
...
(declare-const temp___10076 int__ref)
(declare-const the_file15 us_rep1)
...
(declare-const temp___10077 Int)
...
(declare-const temp___10078 int__ref)
(declare-const the_file17 us_rep1)
...
(declare-const temp___10079 Int)
...
(declare-const the_file19 us_rep1)
...
(declare-const the_file21 us_rep1)
...
(declare-const the_file23 us_rep1)
...
(define-fun temp___100710 () int__ref (mk_int__ref temp___1007))
...
(assert (= temp___1005 next_idx))
(assert (= temp___1004 the_file))
(assert (= temp___1006 current_idx))
(assert (and (= temp___1003 next_read__split_discrs) (and (= temp___10031 next_read__split_fields) (= temp___10032 next_read__attr__constrained))))
(assert (= temp___1002 current_idx))
(assert (= temp___1001 current_col))
(assert (= temp___1000 current_line))
(assert (and (= temp___999 current_read__split_discrs) (and (= temp___9991 current_read__split_fields) (= temp___9992 current_read__attr__constrained))))
(assert (= 0 temp___1007))
...
(assert (not (<= current_idx (int__content current_idx22))))
(check-sat)
(exit)
