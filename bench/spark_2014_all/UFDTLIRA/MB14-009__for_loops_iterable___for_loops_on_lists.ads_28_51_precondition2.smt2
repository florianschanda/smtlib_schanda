...
(define-fun o8 () us_rep2 (mk___rep1 (mk___split_fields1 o4)))
...
(assert (and (= o9 (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq2 o9 no_element) true) (and (= (has_key (positions l) o9) true) (= (get1 (positions l) o9) 1)))))
(assert (= temp___547 o))
...
(assert (=> (= result4 true) (and (= o8 (next l temp___5472)) (ite (= (ite (= (bool_eq2 temp___5472 no_element) false) (= (get1 (positions l) temp___5472) (length1 l)) true) true) (= (bool_eq2 o8 no_element) true) (and (= (has_key (positions l) o8) true) (= (get1 (positions l) o8) (+ (get1 (positions l) temp___5472) 1)))))))
(assert (=> (= result4 true) (and (= o5 (has_key (positions l) o8)) (= (= o5 true) (= (has_key (positions l) o8) true)))))
...
(assert (and (= o6 (iter_has_element temp___553 temp___552)) (= (= o6 true) (and (<= 1 temp___552) (<= temp___552 (last temp___553))))))
(assert (= (= o7 true) (in_range4 temp___552)))
(assert (= result9 (ite (= o7 true) o6 false)))
(assert (= result9 true))
(assert (not (<= 1 temp___552)))
(check-sat)
(exit)
