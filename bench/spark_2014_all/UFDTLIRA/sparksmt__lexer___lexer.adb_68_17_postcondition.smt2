...
(define-fun current_col6 () int__ref (mk_int__ref current_col))
...
(assert (< current_pos 2147483647))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (=> (= (to_rep current_read__split_fields) 10) (and (= o (+ current_line 1)) (in_range (+ current_line 1))))))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (=> (= (to_rep current_read__split_fields) 10) (= (mk_int__ref result) (mk_int__ref current_line)))))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (=> (= (to_rep current_read__split_fields) 10) (= current_line2 o))))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (=> (= (to_rep current_read__split_fields) 10) (= (mk_int__ref result1) current_col6))))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (=> (= (to_rep current_read__split_fields) 10) (= current_col2 0))))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (=> (not (= (to_rep current_read__split_fields) 10)) (=> (= (to_rep current_read__split_fields) 13) (= current_col3 current_col)))))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (=> (not (= (to_rep current_read__split_fields) 10)) (=> (= (to_rep current_read__split_fields) 13) (= current_col3 current_col1)))))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (=> (not (= (to_rep current_read__split_fields) 10)) (=> (not (= (to_rep current_read__split_fields) 13)) (and (= o1 (+ current_col 1)) (in_range (+ current_col 1)))))))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (=> (not (= (to_rep current_read__split_fields) 10)) (=> (not (= (to_rep current_read__split_fields) 13)) (= (mk_int__ref result2) current_col6)))))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (=> (not (= (to_rep current_read__split_fields) 10)) (=> (not (= (to_rep current_read__split_fields) 13)) (= current_col3 o1)))))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (=> (not (= (to_rep current_read__split_fields) 10)) (= current_col2 current_col3))))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (=> (not (= (to_rep current_read__split_fields) 10)) (= current_line2 current_line))))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (=> (not (= (to_rep current_read__split_fields) 10)) (= current_col2 current_col3))))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (=> (not (= (to_rep current_read__split_fields) 10)) (= current_line2 current_line1))))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (and (= o2 (+ current_pos 1)) (in_range (+ current_pos 1)))))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (= result3 current_pos)))
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (= current_pos2 o2)))
(assert (=> (not (= (to_rep1 current_read__split_discrs) 0)) (= current_pos2 current_pos)))
(assert (=> (not (= (to_rep1 current_read__split_discrs) 0)) (= current_col2 current_col)))
(assert (=> (not (= (to_rep1 current_read__split_discrs) 0)) (= current_line2 current_line)))
(assert (=> (not (= (to_rep1 current_read__split_discrs) 0)) (= current_pos2 current_pos1)))
(assert (=> (not (= (to_rep1 current_read__split_discrs) 0)) (= current_col2 current_col1)))
(assert (=> (not (= (to_rep1 current_read__split_discrs) 0)) (= current_line2 current_line1)))
(assert (= current_pos2 current_pos3))
(assert (= current_col4 current_col2))
(assert (= current_line3 current_line2))
(assert (= current_pos4 current_pos2))
(assert (= current_col5 current_col2))
(assert (= current_line4 current_line2))
(assert (not (<= current_pos current_pos3)))
(check-sat)
(exit)
