...
(assert (and (= o8 (previous (mk___rep l3__split_discrs l3__split_fields2) o7)) (ite (= (ite (= (bool_eq3 o7 no_element) false) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o7) 1) true) true) (= (bool_eq3 o8 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o8) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o8) (- (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o7) 1))))))
