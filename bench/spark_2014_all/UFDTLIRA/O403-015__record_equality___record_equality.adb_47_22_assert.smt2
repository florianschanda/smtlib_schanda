...
(declare-const result8 natural)
(declare-const result9 us_private)
(declare-const r_g1__split_fields2 natural)
(declare-const r_g1__split_fields3 us_private)
...
(assert (= (to_rep (rec__record_equality__root__c c_pu1__split_discrs)) r14b))
...
(assert (= (to_rep (rec__record_equality__root__c c_pu1__split_discrs)) r16b))
...
(assert (= result8 r_g1__split_fields))
(assert (= result9 r_g1__split_fields1))
(assert (= g_pu1__split_fields5 r_g1__split_fields2))
(assert (= (hide_ext__1 g_pu1__split_fields4 g_pu1__split_fields6 g_pu1__split_fields7) r_g1__split_fields3))
(assert (= r_g1__split_discrs g_pu1__split_discrs))
(assert (= r_g1__attr__tag g_pu1__attr__tag))
(assert (= result10 r_g2__split_fields))
(assert (= result11 r_g2__split_fields1))
(assert (= r_g2__split_fields2 (mk___split_fields g_pu2__split_fields5 (hide_ext__1 g_pu2__split_fields4 g_pu2__split_fields6 g_pu2__split_fields7))))
(assert (= r_g2__split_discrs g_pu2__split_discrs))
(assert (= r_g2__attr__tag g_pu2__attr__tag))
(assert (not (= (ite (= r_g1__attr__tag r_g2__attr__tag) (us_dispatch_eq (mk___rep r_g1__split_discrs (mk___split_fields r_g1__split_fields2 r_g1__split_fields3) r_g1__attr__tag) (mk___rep r_g2__split_discrs r_g2__split_fields2 r_g2__attr__tag)) false) true)))
(check-sat)
(exit)
