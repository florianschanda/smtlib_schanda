...
(declare-const temp___6659 et1)
(declare-const temp___66591 et2)
(declare-const o3 et2)
(declare-const o4 et1)
(declare-const o5 et2)
(declare-const temp___6661 et1)
(declare-const temp___66611 et2)
...
(assert (= temp___6659 o1))
(assert (= temp___66591 o2))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___6659 r__split_fields2))
(assert (= temp___66591 r__split_fields3))
(assert (= (to_rep1 o3) f))
(assert (= r__split_fields2 o4))
(assert (= o3 o5))
(assert (= temp___6661 o4))
(assert (= temp___66611 o5))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___6661 r__split_fields4))
(assert (= temp___66611 r__split_fields5))
...
(assert (not (= (bool_eq (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (of_rep e) (of_rep1 f)))) true)))
(check-sat)
(exit)
