...
(assert (forall ((x enum1t)) (! (in_range5 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun dynamic_invariant5 ((temp___expr_246 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool) (temp___do_typ_inv_245 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 4)) (in_range3 temp___expr_246)))
...
(declare-const temp___7394 us_rep3)
...
(assert (= r__split_fields7 (mk___split_fields3 (mk___rep2 (mk___split_fields2 b (rec__ar__rec3t__g3 (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields6))))) (rec__ar__rec4t__g4 r__split_fields6))))
(assert (= result2 (mk___split_fields__ref3 r__split_fields7)))
(assert (= r__split_fields8 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields7))))) c (rec__ar__rec2t__h2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields7))))))) (rec__ar__rec3t__g3 (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields7))))) (rec__ar__rec4t__g4 r__split_fields7))))
(assert (= (to_rep o) d))
(assert (= o o1))
(assert (= (rec__ar__rec1t__g1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields8))))))) o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields8))))) o5))
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= (rec__ar__rec2t__h2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields8))))) o8))
(assert (= o9 o5))
(assert (= o10 o6))
(assert (= o11 o7))
(assert (= o12 o8))
...
(assert (= o15 o11))
(assert (= o16 o12))
(assert (= (rec__ar__rec3t__g3 (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields8))) o17))
(assert (= o18 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)) o16)) o17))))
(assert (= o19 (mk___split_fields3 o18 (rec__ar__rec4t__g4 r__split_fields8))))
(assert (= temp___7394 (mk___rep3 o19)))
(assert (= result3 (mk___split_fields__ref3 r__split_fields8)))
(assert (= r__split_fields9 (us_split_fields7 temp___7394)))
(assert (= r__split_fields10 (mk___split_fields__ref3 r__split_fields9)))
(assert (= r__split_fields11 r__split_fields9))
(assert (not (= (bool_eq3 (mk___rep3 (us_split_fields__content3 r__split_fields10)) (mk___rep3 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (mk___rep1 (let ((usq_ (us_split_fields3 b))) (mk___split_fields1 (rec__ar__rec2t__f2 usq_) (mk___rep (mk___split_fields (of_rep d) (rec__ar__rec1t__g1 (us_split_fields1 c)))) (rec__ar__rec2t__h2 usq_)))) (rec__ar__rec3t__g3 (us_split_fields5 a)))) r__split_fields5))) true)))
(check-sat)
(exit)
