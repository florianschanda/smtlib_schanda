...
(assert (not (< (length (mk___rep front__split_discrs (mk___split_fields front__split_fields))) (capacity (mk___rep front__split_discrs (mk___split_fields front__split_fields))))))
(check-sat)
(exit)
