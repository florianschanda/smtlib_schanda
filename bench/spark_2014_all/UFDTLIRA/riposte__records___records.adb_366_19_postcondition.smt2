...
(declare-const records__make_optional_pair_a_1__result Bool)
(declare-const records__make_optional_pair_a_1__result1 unsigned_byte)
(declare-const records__make_optional_pair_a_1__result2 unsigned_byte)
...
(declare-const r__split_fields6 Bool)
(declare-const r__split_fields7 unsigned_byte)
(declare-const r__split_fields8 unsigned_byte)
(declare-const result6 optional_pair__ref)
(declare-const records__make_optional_pair_a_1__result3 us_rep1)
(declare-const records__make_optional_pair_a_1__result4 optional_pair__ref)
(declare-const records__make_optional_pair_a_1__result5 us_rep1)
(declare-const r__split_fields9 us_split_fields__ref1)
(declare-const records__make_optional_pair_a_1__result6 optional_pair__ref)
(declare-const r__split_fields10 us_split_fields2)
(declare-const records__make_optional_pair_a_1__result7 us_rep1)
(define-fun r__split_fields11 () us_split_fields2 (mk___split_fields1 r__split_fields6 (mk___rep (mk___split_fields r__split_fields7 r__split_fields8))))
(declare-const result7 Bool)
(declare-const result8 unsigned_byte)
(declare-const result9 unsigned_byte)
...
(assert (= rliteral r__split_fields5))
...
(assert (= x (mk___rep (mk___split_fields r__split_fields7 r__split_fields8))))
(assert (= records__make_optional_pair_a_1__result4 (mk_optional_pair__ref records__make_optional_pair_a_1__result3)))
(assert (= records__make_optional_pair_a_1__result5 records__make_optional_pair_a_1__result3))
(assert (= result6 (mk_optional_pair__ref (mk___rep1 (mk___split_fields1 records__make_optional_pair_a_1__result (mk___rep (mk___split_fields records__make_optional_pair_a_1__result1 records__make_optional_pair_a_1__result2)))))))
(assert (= records__make_optional_pair_a_1__result3 (mk___rep1 r__split_fields11)))
(assert (= records__make_optional_pair_a_1__result6 records__make_optional_pair_a_1__result4))
(assert (= r__split_fields9 (mk___split_fields__ref1 r__split_fields11)))
(assert (= records__make_optional_pair_a_1__result7 records__make_optional_pair_a_1__result5))
(assert (= r__split_fields10 r__split_fields11))
(assert (= (mk___rep1 (mk___split_fields1 result7 (mk___rep (mk___split_fields result8 result9)))) (optional_pair__content records__make_optional_pair_a_1__result6)))
(assert (not (= (bool_eq1 (optional_pair__content records__make_optional_pair_a_1__result6) (mk___rep1 (mk___split_fields1 (distinct 1 0) x))) true)))
(check-sat)
(exit)
