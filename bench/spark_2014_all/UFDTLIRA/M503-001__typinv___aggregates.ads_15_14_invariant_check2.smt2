...
(assert (and (type_invariant (to_rep x__split_fields)) (type_invariant (to_rep x__split_fields1))))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= x__split_fields1 x__split_fields2))
...
(assert (not (type_invariant (to_rep x__split_fields4))))
(check-sat)
(exit)
