...
(assert (forall ((i headdegree)) (and (<= 0 (headdegreeqtint i)) (<= (headdegreeqtint i) 359))))
...
(define-fun dynamic_invariant1 ((temp___expr_186 Int) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool) (temp___do_typ_inv_185 Bool)) Bool (=> (or (= temp___is_init_182 true) (<= 0 359)) (in_range2 temp___expr_186)))
