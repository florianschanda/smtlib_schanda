...
(assert (not (= (to_rep x__split_discrs) 0)))
(assert (not (= (to_rep x__split_discrs) 1)))
(assert (= (to_rep x__split_discrs) r13b))
(assert (in_range2 r13b))
(assert (= (to_rep o) 2))
(assert (= o o1))
(assert (= temp___201 o1))
(assert (= rliteral temp___2011))
(assert (= dummy temp___2012))
(assert (= true temp___2013))
(assert (= true temp___2014))
(assert (= x__attr__constrained true))
(assert (not (= temp___201 x__split_discrs)))
(check-sat)
(exit)
