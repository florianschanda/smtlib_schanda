...
(declare-const temp___350 us_rep1)
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___350 (mk___rep1 (mk___split_fields1 o5 (mk___rep (mk___split_fields o6 o7))))))
(assert (= result (mk___split_fields__ref1 x__split_fields3)))
(assert (= x__split_fields4 (us_split_fields3 temp___350)))
