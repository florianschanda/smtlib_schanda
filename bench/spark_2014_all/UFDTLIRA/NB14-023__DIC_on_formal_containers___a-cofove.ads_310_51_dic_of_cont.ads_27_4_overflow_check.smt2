...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dic_of_cont__my_fove__vector us_main_type)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields)) us_main_type (rec__dic_of_cont__my_fove__vector a))
...
(define-fun us_rep___22__projection ((a us_rep)) us_split_discrs (us_split_discrs1 a))
...
(define-fun capacity ((container us_rep)) Int (ite (= (distinct 1 0) true) (to_rep (rec__dic_of_cont__my_fove__vector__capacity (us_split_discrs1 container))) 2147483647))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_1610 Int) (temp___is_init_1606 Bool) (temp___skip_constant_1607 Bool) (temp___do_toplevel_1608 Bool) (temp___do_typ_inv_1609 Bool)) Bool (=> (or (= temp___is_init_1606 true) (<= 0 2147483647)) (in_range1 temp___expr_1610)))
...
(define-fun sequence__ref___6__projection ((a sequence__ref)) us_rep1 (sequence__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_1603 Int) (temp___is_init_1599 Bool) (temp___skip_constant_1600 Bool) (temp___do_toplevel_1601 Bool) (temp___do_typ_inv_1602 Bool)) Bool (=> (or (= temp___is_init_1599 true) (<= 0 2147483647)) (in_range2 temp___expr_1603)))
...
(define-fun dynamic_invariant2 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range4 temp___expr_197)))
...
(define-fun default_initial_assumption ((temp___expr_1649 us_rep1) (temp___skip_top_level_1650 Bool)) Bool (=> (not (= temp___skip_top_level_1650 true)) (= (length1 temp___expr_1649) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_1641 Int) (temp___is_init_1637 Bool) (temp___skip_constant_1638 Bool) (temp___do_toplevel_1639 Bool) (temp___do_typ_inv_1640 Bool)) Bool (=> (or (= temp___is_init_1637 true) (<= 0 2147483647)) (in_range5 temp___expr_1641)))
...
(define-fun element_type__ref___21__projection ((a element_type__ref)) element_type (element_type__content a))
(define-fun dynamic_invariant4 ((temp___expr_1634 Int) (temp___is_init_1630 Bool) (temp___skip_constant_1631 Bool) (temp___do_toplevel_1632 Bool) (temp___do_typ_inv_1633 Bool)) Bool (=> (or (= temp___is_init_1630 true) (<= 0 2147483647)) (in_range6 temp___expr_1634)))
...
(assert (=> (not (= before 0)) (and (= o5 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (in_range2 o5) (= o5 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))))
(assert (=> (not (= before 0)) (= o6 (ite (= (- before 1) o5) true false))))
(assert (=> (not (not (= before 0))) (= o6 false)))
(assert (and (= o3 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (in_range2 o3) (= o3 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))))))
...
(assert (and (= o1 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o1) (= o1 (ite (= (distinct 1 0) true) (to_rep (rec__dic_of_cont__my_fove__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o2 (- o1 o)))
