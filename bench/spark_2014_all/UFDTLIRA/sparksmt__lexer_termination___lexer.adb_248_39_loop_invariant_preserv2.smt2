...
(declare-const temp___10511 Int)
(declare-const result2 int__ref)
(declare-const temp___10501 Int)
...
(assert (and (and (and (and (= (local_invariant the_file1 current_read__split_fields1 current_read__split_discrs1 current_idx1 next_read__split_fields1 next_read__split_discrs1 next_idx1) true) (= (bool_eq (mk___rep current_read__split_discrs1 current_read__split_fields1 current_read__attr__constrained) (mk___rep (mk___split_discrs next_read__split_discrs) (mk___split_fields next_read__split_fields) next_read__attr__constrained)) true)) (= current_idx1 next_idx)) (<= current_idx current_idx1)) (and (and (and (in_range2 current_line1) (in_range1 current_col1)) (in_range1 current_idx1)) (in_range1 next_idx1))))
(assert (=> (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs1)) 0) (= result (ite (not (= (to_rep (rec__file_io__read_result__c current_read__split_fields1)) 10)) true false))))
(assert (=> (not (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs1)) 0)) (= result false)))
(assert (= result true))
(assert (and (= (local_invariant the_file2 current_read__split_fields2 current_read__split_discrs2 current_idx2 next_read__split_fields2 next_read__split_discrs2 next_idx2) true) (<= current_idx1 current_idx2)))
(assert (and (and (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1 current_idx2)) (in_range1 next_idx2)) (and (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs2)) 0) (not (= (to_rep (rec__file_io__read_result__c current_read__split_fields2)) 10)))))
(assert (= result1 (mk_int__ref temp___1051)))
(assert (= temp___10511 next_idx2))
(assert (= result2 (mk_int__ref temp___1050)))
(assert (= temp___10501 (ite (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs2)) 0) true false) 1 0)))
(assert (and (and (and (and (= (local_invariant the_file3 current_read__split_fields3 current_read__split_discrs3 current_idx3 next_read__split_fields3 next_read__split_discrs3 next_idx3) true) (= (bool_eq (mk___rep current_read__split_discrs3 current_read__split_fields3 current_read__attr__constrained) (mk___rep next_read__split_discrs2 next_read__split_fields2 next_read__attr__constrained)) true)) (= current_idx3 next_idx2)) (<= current_idx2 current_idx3)) (and (and (and (in_range2 current_line3) (in_range1 current_col3)) (in_range1 current_idx3)) (in_range1 next_idx3))))
(assert (=> (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs3)) 0) (= o (ite (not (= (to_rep (rec__file_io__read_result__c current_read__split_fields3)) 10)) true false))))
(assert (=> (not (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs3)) 0)) (= o false)))
(assert (= result3 (ite (not (= o true)) true false)))
(assert (not (= result3 true)))
(assert (not (= (local_invariant the_file3 current_read__split_fields3 current_read__split_discrs3 current_idx3 next_read__split_fields3 next_read__split_discrs3 next_idx3) true)))
(check-sat)
(exit)
