...
(assert (and (= o3 (length m)) (and (in_range2 o3) (<= o3 (capacity m)))))
(assert (and (= o1 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range2 o1) (<= o1 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (and (= o2 (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range2 o2) (<= o2 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= o4 (+ o2 o1)))
(assert (= result1 (ite (= o4 o3) true false)))
(assert (=> (= result1 true) (and (= o (length m)) (and (in_range2 o) (<= o (capacity m))))))
...
(assert (not (<= (length (rec__amortized_queue__queue__rear (us_split_fields3 q))) 1000)))
(check-sat)
(exit)
