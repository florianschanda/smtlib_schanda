...
(assert (ite (= (<= (length (mk___rep l__split_discrs l__split_fields8)) 3) true) (= (length (mk___rep l__split_discrs my_lists__m__delete_first__2__container__fields)) 0) (and (and (= (length (mk___rep l__split_discrs my_lists__m__delete_first__2__container__fields)) (- (length (mk___rep l__split_discrs l__split_fields8)) 3)) (= (range_shifted (model__ (mk___rep l__split_discrs my_lists__m__delete_first__2__container__fields)) (model__ (mk___rep l__split_discrs l__split_fields8)) 1 (length (mk___rep l__split_discrs my_lists__m__delete_first__2__container__fields)) 3) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs my_lists__m__delete_first__2__container__fields)) (positions (mk___rep l__split_discrs l__split_fields8)) 1 3) true))))
(assert (= result12 (mk___split_fields__ref l__split_fields8)))
(assert (= l__split_fields9 my_lists__m__delete_first__2__container__fields))
(assert (not (<= (length (mk___rep l__split_discrs l__split_fields9)) 3)))
(check-sat)
(exit)
