...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__instances__vectors__vector us_main_type1)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields)) us_main_type1 (rec__instances__vectors__vector a))
...
(define-fun dynamic_invariant ((temp___expr_792 Int) (temp___is_init_788 Bool) (temp___skip_constant_789 Bool) (temp___do_toplevel_790 Bool) (temp___do_typ_inv_791 Bool)) Bool (=> (or (= temp___is_init_788 true) (<= 0 1001)) (in_range2 temp___expr_792)))
...
(define-fun dynamic_invariant1 ((temp___expr_778 Int) (temp___is_init_774 Bool) (temp___skip_constant_775 Bool) (temp___do_toplevel_776 Bool) (temp___do_typ_inv_777 Bool)) Bool (=> (or (= temp___is_init_774 true) (<= 1 1000)) (in_range3 temp___expr_778)))
...
(define-fun dynamic_invariant2 ((temp___expr_785 Int) (temp___is_init_781 Bool) (temp___skip_constant_782 Bool) (temp___do_toplevel_783 Bool) (temp___do_typ_inv_784 Bool)) Bool (=> (or (= temp___is_init_781 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_785)))
...
(define-fun dynamic_invariant3 ((temp___expr_580 Int) (temp___is_init_576 Bool) (temp___skip_constant_577 Bool) (temp___do_toplevel_578 Bool) (temp___do_typ_inv_579 Bool)) Bool (=> (or (= temp___is_init_576 true) (<= 0 2147483647)) (in_range6 temp___expr_580)))
(define-fun dynamic_invariant4 ((temp___expr_799 Int) (temp___is_init_795 Bool) (temp___skip_constant_796 Bool) (temp___do_toplevel_797 Bool) (temp___do_typ_inv_798 Bool)) Bool (=> (or (= temp___is_init_795 true) (<= 0 1000)) (in_range1 temp___expr_799)))
...
(define-fun capacity ((container1 us_rep1)) Int (ite (= (distinct 1 0) true) (to_rep (rec__instances__vectors__vector__capacity (us_split_discrs1 container1))) 1000))
...
(define-fun dynamic_invariant5 ((temp___expr_830 Int) (temp___is_init_826 Bool) (temp___skip_constant_827 Bool) (temp___do_toplevel_828 Bool) (temp___do_typ_inv_829 Bool)) Bool (=> (or (= temp___is_init_826 true) (<= 0 1000)) (in_range5 temp___expr_830)))
...
(define-fun dynamic_invariant6 ((temp___expr_823 Int) (temp___is_init_819 Bool) (temp___skip_constant_820 Bool) (temp___do_toplevel_821 Bool) (temp___do_typ_inv_822 Bool)) Bool (=> (or (= temp___is_init_819 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_823)))
