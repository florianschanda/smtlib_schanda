...
(declare-const temp___3011 natural)
...
(assert (and (= (mk___rep (mk___split_fields temp___301 temp___3011)) (from_integer i)) (and (= (>= i 0) temp___301) (= (of_rep (abs i)) temp___3011))))
(assert (= (to_rep temp___3011) 0))
(assert (not (= temp___301 true)))
(check-sat)
(exit)
