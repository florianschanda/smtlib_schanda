...
(assert (forall ((e1 Int)) (=> (and (in_range2 e1) (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) e1) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (length (mk___rep s2__split_discrs s2__split_fields2)))) (= (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i1) e1))))))
(assert (and (= temp___814 (model__ (mk___rep s2__split_discrs s2__split_fields2))) (= (length3 temp___814) (length (mk___rep s2__split_discrs s2__split_fields2)))))
(assert (and (= o (contains temp___814 e)) (=> (= (distinct 1 0) true) (=> (exists ((e1 Int)) (and (and (in_range2 e1) (= (contains temp___814 e1) true)) (= (equivalent_elements e1 e) true))) (= o true)))))
(assert (= (= o1 true) (in_range2 e)))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (and (= o2 (length (mk___rep s2__split_discrs s2__split_fields2))) (and (in_range1 o2) (<= o2 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s2__split_discrs))))))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result3 (ite (<= 1 i) o3 false)))
(assert (= result3 true))
(assert (and (= o4 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (and (and (= (length1 o4) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (forall ((temp___432 Int)) (=> (and (in_range4 temp___432) (= (iter_has_element o4 temp___432) true)) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get o4 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) item) true)) (and (< 0 (find o4 item)) (= (equivalent_elements (get o4 (find o4 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (and (= (find o4 (get o4 i1)) i1) (= (e_is_find o4 (get o4 i1) i1) true)))))))
