...
(assert (forall ((i element_type)) (and (<= 0 (element_typeqtint i)) (<= (element_typeqtint i) 100))))
...
(define-fun dynamic_invariant1 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 100)) (in_range2 temp___expr_221)))
...
(assert (not (in_range1 (- (to_rep (rec__my_lists__my_lists__list__capacity container__split_discrs)) count))))
(check-sat)
(exit)
