...
(declare-const temp___337 us_rep1)
...
(assert (= o15 o16))
(assert (= (mk___rep (mk___split_discrs discr__r5__d1__assume) discr__r5__d1__assume1) o15))
...
(assert (= result (mk___split_discrs__ref (mk___split_discrs d2__split_discrs))))
...
(assert (=> (= h__split_fields1 true) (= (rec__discr__with_default__c d1__split_discrs) h__split_fields)))
...
(assert (= temp___333 (mk___rep1 o12)))
(assert (= result1 (mk___split_fields__ref (mk___split_fields (mk___rep (mk___split_discrs h__split_fields) h__split_fields1)))))
(assert (= h__split_fields2 (us_split_fields1 temp___333)))
(assert (not (= (attr__constrained (rec__discr__holder__content h__split_fields2)) true)))
(assert (= (to_rep (rec__discr__with_default__c (us_split_discrs1 (rec__discr__holder__content h__split_fields2)))) c))
(assert (=> (= (attr__constrained (rec__discr__holder__content h__split_fields2)) true) (= (rec__discr__with_default__c d2__split_discrs1) (rec__discr__with_default__c (us_split_discrs1 (rec__discr__holder__content h__split_fields2))))))
(assert (= usq_2 (mk___rep d2__split_discrs1 d2__attr__constrained)))
(assert (= o13 (mk___rep (us_split_discrs1 usq_2) (attr__constrained (rec__discr__holder__content h__split_fields2)))))
(assert (= o14 (mk___split_fields o13)))
(assert (= temp___337 (mk___rep1 o14)))
(assert (= result2 (mk___split_fields__ref h__split_fields2)))
(assert (= h__split_fields3 (us_split_fields1 temp___337)))
(assert (not (= (attr__constrained (rec__discr__holder__content h__split_fields3)) true)))
(assert (not (= (to_rep (rec__discr__with_default__c (us_split_discrs1 (rec__discr__holder__content h__split_fields3)))) c)))
(check-sat)
(exit)
