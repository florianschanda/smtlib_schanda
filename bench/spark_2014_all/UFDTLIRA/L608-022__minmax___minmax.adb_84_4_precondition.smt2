...
(define-fun dynamic_invariant1 ((temp___expr_207 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 1 127)) (in_range1 temp___expr_207)))
...
(define-fun dynamic_invariant2 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 3)) (in_range2 temp___expr_214)))
...
(define-fun dynamic_invariant3 ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= 1 127)) (in_range3 temp___expr_200)))
(declare-const x Int)
(declare-const y Int)
...
(assert (= result4 aa))
(assert (= aa1 0))
(assert (in_range2 aa1))
(assert (= result5 cc))
(assert (= cc1 2))
(assert (in_range2 cc1))
(assert (=> (<= 0 3) (in_range2 mine)))
(assert (=> (<= 0 3) (in_range2 maxe)))
(assert (and (in_range min1) (in_range max1)))
(assert (and (= o1 y1) (in_range3 y1)))
(assert (and (= o x1) (in_range3 x1)))
(assert (not (< o o1)))
(check-sat)
(exit)
