...
(declare-const temp___570 us_rep1)
...
(declare-const temp___588 us_rep1)
(declare-const temp___593 us_rep1)
...
(assert (and (= o (last1 (mk___rep l__split_discrs l__split_fields3))) (ite (= (= (length (mk___rep l__split_discrs l__split_fields3)) 0) true) (= (bool_eq1 o no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) o) true) (= (get (positions (mk___rep l__split_discrs l__split_fields3)) o) (length (mk___rep l__split_discrs l__split_fields3)))))))
(assert (and (= temp___570 (previous (mk___rep l__split_discrs l__split_fields3) o)) (ite (= (ite (= (bool_eq1 o no_element) false) (= (get (positions (mk___rep l__split_discrs l__split_fields3)) o) 1) true) true) (= (bool_eq1 temp___570 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) temp___570) true) (= (get (positions (mk___rep l__split_discrs l__split_fields3)) temp___570) (- (get (positions (mk___rep l__split_discrs l__split_fields3)) o) 1))))))
(assert (= result2 (mk___split_fields__ref1 c__split_fields1)))
(assert (= c__split_fields2 (us_split_fields3 temp___570)))
...
(assert (and (= o1 (next (mk___rep l__split_discrs l__split_fields7) (mk___rep1 c__split_fields2))) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields2) no_element) false) (= (get (positions (mk___rep l__split_discrs l__split_fields7)) (mk___rep1 c__split_fields2)) (length (mk___rep l__split_discrs l__split_fields7))) true) true) (= (bool_eq1 o1 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields7)) o1) true) (= (get (positions (mk___rep l__split_discrs l__split_fields7)) o1) (+ (get (positions (mk___rep l__split_discrs l__split_fields7)) (mk___rep1 c__split_fields2)) 1))))))
(assert (and (and (and (= (length (mk___rep l__split_discrs my_lists__m__replace_element__container__fields1)) (length (mk___rep l__split_discrs l__split_fields7))) (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields7)) (positions (mk___rep l__split_discrs my_lists__m__replace_element__container__fields1))) true)) (= (get1 (model__ (mk___rep l__split_discrs my_lists__m__replace_element__container__fields1)) (get (positions (mk___rep l__split_discrs my_lists__m__replace_element__container__fields1)) o1)) 16)) (= (equal_except (model__ (mk___rep l__split_discrs l__split_fields7)) (model__ (mk___rep l__split_discrs my_lists__m__replace_element__container__fields1)) (get (positions (mk___rep l__split_discrs my_lists__m__replace_element__container__fields1)) o1)) true)))
...
(assert (and (= o3 (last1 (mk___rep l__split_discrs l__split_fields9))) (ite (= (= (length (mk___rep l__split_discrs l__split_fields9)) 0) true) (= (bool_eq1 o3 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields9)) o3) true) (= (get (positions (mk___rep l__split_discrs l__split_fields9)) o3) (length (mk___rep l__split_discrs l__split_fields9)))))))
(assert (and (= o2 (first (mk___rep l__split_discrs l__split_fields9))) (ite (= (= (length (mk___rep l__split_discrs l__split_fields9)) 0) true) (= (bool_eq1 o2 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields9)) o2) true) (= (get (positions (mk___rep l__split_discrs l__split_fields9)) o2) 1)))))
(assert (and (= (m_elements_swapped (model__ (mk___rep l__split_discrs l__split_fields9)) (model__ (mk___rep l__split_discrs my_lists__m__swap__container__fields)) (get (positions (mk___rep l__split_discrs l__split_fields9)) o2) (get (positions (mk___rep l__split_discrs l__split_fields9)) o3)) true) (= (oeq1 (positions (mk___rep l__split_discrs my_lists__m__swap__container__fields)) (positions (mk___rep l__split_discrs l__split_fields9))) true)))
(assert (= result9 (mk___split_fields__ref l__split_fields9)))
(assert (= l__split_fields10 my_lists__m__swap__container__fields))
(assert (and (= o5 (last1 (mk___rep l__split_discrs l__split_fields10))) (ite (= (= (length (mk___rep l__split_discrs l__split_fields10)) 0) true) (= (bool_eq1 o5 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields10)) o5) true) (= (get (positions (mk___rep l__split_discrs l__split_fields10)) o5) (length (mk___rep l__split_discrs l__split_fields10)))))))
(assert (and (= o4 (first (mk___rep l__split_discrs l__split_fields10))) (ite (= (= (length (mk___rep l__split_discrs l__split_fields10)) 0) true) (= (bool_eq1 o4 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields10)) o4) true) (= (get (positions (mk___rep l__split_discrs l__split_fields10)) o4) 1)))))
(assert (and (= (m_elements_swapped (model__ (mk___rep l__split_discrs l__split_fields10)) (model__ (mk___rep l__split_discrs my_lists__m__swap_links__container__fields)) (get (positions (mk___rep l__split_discrs l__split_fields10)) o4) (get (positions (mk___rep l__split_discrs l__split_fields10)) o5)) true) (= (p_positions_swapped (positions (mk___rep l__split_discrs l__split_fields10)) (positions (mk___rep l__split_discrs my_lists__m__swap_links__container__fields)) o4 o5) true)))
...
(assert (and (= o6 (last1 (mk___rep l__split_discrs l__split_fields16))) (ite (= (= (length (mk___rep l__split_discrs l__split_fields16)) 0) true) (= (bool_eq1 o6 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields16)) o6) true) (= (get (positions (mk___rep l__split_discrs l__split_fields16)) o6) (length (mk___rep l__split_discrs l__split_fields16)))))))
(assert (and (= temp___588 (previous (mk___rep l__split_discrs l__split_fields16) o6)) (ite (= (ite (= (bool_eq1 o6 no_element) false) (= (get (positions (mk___rep l__split_discrs l__split_fields16)) o6) 1) true) true) (= (bool_eq1 temp___588 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields16)) temp___588) true) (= (get (positions (mk___rep l__split_discrs l__split_fields16)) temp___588) (- (get (positions (mk___rep l__split_discrs l__split_fields16)) o6) 1))))))
(assert (= result20 (mk___split_fields__ref1 c__split_fields2)))
(assert (= c__split_fields3 (us_split_fields3 temp___588)))
...
(assert (= (length (mk___rep l__split_discrs l__split_fields17)) 10))
(assert (= (oeq (model__ (mk___rep k__split_discrs my_lists__m__assign__target__fields1)) (model__ (mk___rep l__split_discrs l__split_fields17))) true))
(assert (= result23 (mk___split_fields__ref k__split_fields6)))
(assert (= k__split_fields7 my_lists__m__assign__target__fields1))
(assert (and (and (and (and (= (length (mk___rep k__split_discrs my_lists__m__delete_last__container__fields)) (- (length (mk___rep k__split_discrs k__split_fields7)) 1)) (= (ole (model__ (mk___rep k__split_discrs my_lists__m__delete_last__container__fields)) (model__ (mk___rep k__split_discrs k__split_fields7))) true)) (not (= (has_key (positions (mk___rep k__split_discrs my_lists__m__delete_last__container__fields)) (last1 (mk___rep k__split_discrs k__split_fields7))) true))) (= (keys_included_except (positions (mk___rep k__split_discrs k__split_fields7)) (positions (mk___rep k__split_discrs k__split_fields7)) (last1 (mk___rep k__split_discrs k__split_fields7))) true)) (= (ole1 (positions (mk___rep k__split_discrs my_lists__m__delete_last__container__fields)) (positions (mk___rep k__split_discrs k__split_fields7))) true)))
(assert (= result24 (mk___split_fields__ref k__split_fields7)))
(assert (= k__split_fields8 my_lists__m__delete_last__container__fields))
(assert (and (= temp___593 (first (mk___rep l__split_discrs l__split_fields17))) (ite (= (= (length (mk___rep l__split_discrs l__split_fields17)) 0) true) (= (bool_eq1 temp___593 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields17)) temp___593) true) (= (get (positions (mk___rep l__split_discrs l__split_fields17)) temp___593) 1)))))
(assert (= result25 (mk___split_fields__ref1 c__split_fields3)))
(assert (= c__split_fields4 (us_split_fields3 temp___593)))
(assert (not (= (has_key (positions (mk___rep l__split_discrs l__split_fields17)) (mk___rep1 c__split_fields4)) true)))
(check-sat)
(exit)
