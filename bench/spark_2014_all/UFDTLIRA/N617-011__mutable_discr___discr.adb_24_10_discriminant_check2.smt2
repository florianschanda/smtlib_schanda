...
(define-fun dynamic_invariant1 ((temp___expr_210 us_rep) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (and (=> (not (= temp___skip_constant_207 true)) (in_range2 c temp___expr_210)) (= (attr__constrained temp___expr_210) true)))
(define-fun default_initial_assumption1 ((temp___expr_212 us_rep) (temp___skip_top_level_213 Bool)) Bool (and (= (attr__constrained temp___expr_212) true) (= (to_rep (rec__discr__with_default__c (us_split_discrs1 temp___expr_212))) c)))
...
(declare-const temp___310 natural)
(declare-const temp___3101 Bool)
(declare-const usq_ natural)
(declare-const usq_1 Bool)
(declare-const temp___312 natural)
(declare-const temp___3121 Bool)
(declare-const usq_2 natural)
(declare-const usq_3 Bool)
(declare-const temp___315 natural)
(declare-const temp___3151 Bool)
(declare-const o4 natural)
(declare-const o5 natural)
(declare-const temp___316 natural)
(declare-const temp___3161 Bool)
...
(assert (= (to_rep o2) c))
(assert (= o2 o3))
(assert (= temp___310 o3))
(assert (= true temp___3101))
(assert (=> (= d__attr__constrained true) (= temp___310 (rec__discr__with_default__c d__split_discrs1))))
(assert (= (mk___rep (mk___split_discrs usq_) usq_1) (mk___rep (mk___split_discrs temp___310) temp___3101)))
(assert (= usq_ temp___312))
(assert (= d__attr__constrained temp___3121))
(assert (= result1 (mk___split_discrs__ref d__split_discrs1)))
(assert (= d__split_discrs2 (mk___split_discrs temp___312)))
(assert (=> (= d__attr__constrained true) (= rliteral (rec__discr__with_default__c d__split_discrs2))))
(assert (= rliteral usq_2))
(assert (= true usq_3))
(assert (= usq_2 temp___315))
(assert (= d__attr__constrained temp___3151))
(assert (= result2 (mk___split_discrs__ref d__split_discrs2)))
(assert (= d__split_discrs3 (mk___split_discrs temp___315)))
(assert (not (= d2__attr__constrained true)))
(assert (= (to_rep d2__split_discrs) 0))
(assert (= (to_rep o4) c))
(assert (= o4 o5))
(assert (= temp___316 o5))
(assert (= true temp___3161))
(assert (= d2__attr__constrained true))
(assert (not (= temp___316 d2__split_discrs)))
(check-sat)
(exit)
