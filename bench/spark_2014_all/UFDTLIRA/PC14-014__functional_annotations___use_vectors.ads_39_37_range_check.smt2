...
(assert (= o11 n))
(assert (and (= o12 (get (model__ (mk___rep v2__split_discrs (us_split_fields__content v2__split_fields8))) o11)) (and (in_range3 o12) (= o12 (get (model__ (mk___rep v2__split_discrs (us_split_fields__content v2__split_fields8))) o11)))))
