...
(define-fun dynamic_invariant1 ((temp___expr_317 Int) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool) (temp___do_typ_inv_316 Bool)) Bool (=> (or (= temp___is_init_313 true) (<= (- 1) 2147483647)) (in_range2 temp___expr_317)))
...
(define-fun dynamic_invariant3 ((temp___expr_310 Int) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool) (temp___do_typ_inv_309 Bool)) Bool (=> (or (= temp___is_init_306 true) (<= 0 255)) (in_range5 temp___expr_310)))
...
(define-fun default_initial_assumption ((temp___expr_363 us_rep1) (temp___skip_top_level_364 Bool)) Bool (=> (not (= temp___skip_top_level_364 true)) (= (length1 temp___expr_363) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_355 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool) (temp___do_typ_inv_354 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= (- 1) 2147483646)) (in_range6 temp___expr_355)))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant2 result true false true true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_348 Int) (temp___is_init_344 Bool) (temp___skip_constant_345 Bool) (temp___do_toplevel_346 Bool) (temp___do_typ_inv_347 Bool)) Bool (=> (or (= temp___is_init_344 true) (<= 0 255)) (in_range7 temp___expr_348)))
...
(assert (=> (not (= before (- 1))) (and (= o4 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (in_range2 o4) (= o4 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))))
