...
(assert (= result3 true))
(assert (and (= us4 n) (dynamic_property3 first2 last4 n)))
(assert (= o11 n))
(assert (and (= o12 (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) o11)) (and (in_range4 o12) (= o12 (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) o11)))))
(assert (and (= us3 n) (dynamic_property2 first1 last3 n)))
(assert (= o10 n))
(assert (not (<= o10 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(check-sat)
(exit)
