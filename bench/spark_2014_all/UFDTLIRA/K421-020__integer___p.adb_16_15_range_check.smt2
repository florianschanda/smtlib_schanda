...
(assert (forall ((i ttmp3S)) (and (<= 1 (ttmp3Sqtint i)) (<= (ttmp3Sqtint i) 5))))
...
(define-fun dynamic_invariant3 ((temp___expr_172 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 1 5)) (in_range3 temp___expr_172)))
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-sort ttmp4S 0)
(declare-fun ttmp4Sqtint (ttmp4S) Int)
(assert (forall ((i ttmp4S)) (and (<= 1 (ttmp4Sqtint i)) (<= (ttmp4Sqtint i) 5))))
...
(define-fun dynamic_invariant4 ((temp___expr_179 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 1 5)) (in_range4 temp___expr_179)))
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-sort ttmp5S 0)
(declare-fun ttmp5Sqtint (ttmp5S) Int)
(assert (forall ((i ttmp5S)) (and (<= 1 (ttmp5Sqtint i)) (<= (ttmp5Sqtint i) 5))))
...
(define-fun dynamic_invariant5 ((temp___expr_186 Int) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool) (temp___do_typ_inv_185 Bool)) Bool (=> (or (= temp___is_init_182 true) (<= 1 5)) (in_range5 temp___expr_186)))
