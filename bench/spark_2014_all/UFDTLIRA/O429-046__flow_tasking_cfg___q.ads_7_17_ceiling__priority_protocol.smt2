...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__p__po1T__content integer)))))
(define-fun us_split_fields_Content__projection ((a us_split_fields)) integer (rec__p__po1T__content a))
...
(define-fun default_initial_assumption ((temp___expr_201 us_rep) (temp___skip_top_level_202 Bool)) Bool (= (to_rep (rec__p__po1T__content (us_split_fields1 temp___expr_201))) 0))
(assert (forall ((self__ us_rep)) (! (dynamic_invariant (get_content self__) true false true true) :pattern ((get_content self__)))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__q__po2T__content integer)))))
(define-fun us_split_fields_Content__2__projection ((a us_split_fields2)) integer (rec__q__po2T__content a))
...
(define-fun default_initial_assumption1 ((temp___expr_208 us_rep1) (temp___skip_top_level_209 Bool)) Bool (= (to_rep (rec__q__po2T__content (us_split_fields3 temp___expr_208))) 0))
