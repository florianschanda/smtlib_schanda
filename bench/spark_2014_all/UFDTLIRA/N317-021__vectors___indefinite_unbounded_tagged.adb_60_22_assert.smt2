...
(assert (not (= (let ((temp___639 (f 3))) (let ((temp___638 (get (model__ (mk___rep v__split_discrs v__split_fields6)) 3))) (ite (= (attr__tag temp___638) (attr__tag temp___639)) (us_dispatch_eq temp___638 temp___639) false))) true)))
(check-sat)
(exit)
