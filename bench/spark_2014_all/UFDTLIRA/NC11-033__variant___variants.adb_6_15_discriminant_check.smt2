...
(assert (forall ((x e)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun variants__t__d__pred ((a us_rep)) Bool (= (to_rep1 (rec__variants__t__c (us_split_discrs1 a))) 0))
(define-fun variants__t__e__pred ((a us_rep)) Bool (= (to_rep1 (rec__variants__t__c (us_split_discrs1 a))) 1))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__variants__t__c (us_split_discrs1 a))) (to_rep1 (rec__variants__t__c (us_split_discrs1 b)))) (and (=> (variants__t__d__pred a) (= (to_rep (rec__variants__t__d (us_split_fields1 a))) (to_rep (rec__variants__t__d (us_split_fields1 b))))) (=> (variants__t__e__pred a) (= (to_rep (rec__variants__t__e (us_split_fields1 a))) (to_rep (rec__variants__t__e (us_split_fields1 b))))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_167 us_rep) (temp___skip_top_level_168 Bool)) Bool (and (= (attr__constrained temp___expr_167) false) (= (to_rep1 (rec__variants__t__c (us_split_discrs1 temp___expr_167))) 0)))
(define-fun in_range2 ((rec__variants__t__c1 Int) (a us_rep)) Bool (= rec__variants__t__c1 (to_rep1 (rec__variants__t__c (us_split_discrs1 a)))))
...
(define-fun default_initial_assumption1 ((temp___expr_178 us_rep) (temp___skip_top_level_179 Bool)) Bool (and (= (attr__constrained temp___expr_178) true) (= (to_rep1 (rec__variants__t__c (us_split_discrs1 temp___expr_178))) 0)))
(define-fun in_range3 ((rec__variants__t__c1 Int) (a us_rep)) Bool (= rec__variants__t__c1 (to_rep1 (rec__variants__t__c (us_split_discrs1 a)))))
...
(define-fun default_initial_assumption2 ((temp___expr_189 us_rep) (temp___skip_top_level_190 Bool)) Bool (and (= (attr__constrained temp___expr_189) true) (= (to_rep1 (rec__variants__t__c (us_split_discrs1 temp___expr_189))) 1)))
...
(define-fun dynamic_invariant3 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 0 1)) (in_range1 temp___expr_158)))
(assert (and (= 0 (to_rep1 (rec__variants__t__c y__split_discrs))) (= y__attr__constrained true)))
(assert (and (= 1 (to_rep1 (rec__variants__t__c z__split_discrs))) (= z__attr__constrained true)))
(assert (not (= 1 (to_rep1 (rec__variants__t__c y__split_discrs)))))
(check-sat)
(exit)
