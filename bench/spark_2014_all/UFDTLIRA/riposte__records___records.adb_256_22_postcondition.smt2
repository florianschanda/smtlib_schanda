...
(declare-const temp___3751 unsigned_byte)
(declare-const temp___3752 unsigned_byte)
...
(declare-const temp___378 us_rep1)
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___375 o5))
(assert (= temp___3751 o6))
(assert (= temp___3752 o7))
(assert (= result1 (mk___split_fields__ref1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields x__split_fields1 x__split_fields2))))))
(assert (= x__split_fields3 (mk___split_fields1 temp___375 (mk___rep (mk___split_fields temp___3751 temp___3752)))))
(assert (= (to_rep o8) tmp1))
(assert (= (rec__records_prooffuncs__pair__a (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair x__split_fields3))) o9))
(assert (= o8 o10))
(assert (= o11 o9))
(assert (= o12 o10))
(assert (= (rec__records_prooffuncs__optional_pair__exists x__split_fields3) o13))
(assert (= o14 o11))
(assert (= o15 o12))
(assert (= temp___378 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15))))))
(assert (= result2 (mk___split_fields__ref1 x__split_fields3)))
(assert (= x__split_fields4 (us_split_fields3 temp___378)))
...
(assert (not (= (bool_eq1 (mk___rep1 (us_split_fields__content1 x__split_fields5)) (mk___rep1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields x__split_fields2 x__split_fields1))))) true)))
(check-sat)
(exit)
