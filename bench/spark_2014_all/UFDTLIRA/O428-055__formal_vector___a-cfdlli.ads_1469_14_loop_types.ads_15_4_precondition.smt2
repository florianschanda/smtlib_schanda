...
(assert (=> (= (bool_eq2 position no_element) true) (and (= o2 (length container)) (and (in_range1 o2) (<= o2 (to_rep (rec__loop_types__lists__list__capacity (us_split_discrs1 container))))))))
