...
(assert (= records__is_valid_c__result1 (ite (or (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 a)) true) (= (bool_eq (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 a)) (mk___rep (mk___split_fields rliteral1 rliteral))) true)) true false)))
(assert (= (mk_bool__ref records__is_valid_c__result4) (mk_bool__ref records__is_valid_c__result2)))
