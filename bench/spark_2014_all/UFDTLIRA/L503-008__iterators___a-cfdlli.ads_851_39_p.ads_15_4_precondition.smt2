...
(define-fun dynamic_invariant1 ((temp___expr_287 Int) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool) (temp___do_typ_inv_286 Bool)) Bool (=> (or (= temp___is_init_283 true) (<= 1 2147483647)) (in_range2 temp___expr_287)))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(declare-fun is_empty (us_rep2) Bool)
(declare-fun is_empty__function_guard (Bool us_rep2) Bool)
(define-fun default_initial_assumption ((temp___expr_295 us_rep2) (temp___skip_top_level_296 Bool)) Bool (=> (not (= temp___skip_top_level_296 true)) (and (= (is_empty temp___expr_295) true) (= (length1 temp___expr_295) 0))))
(define-fun default_initial_assumption1 ((temp___expr_281 us_rep1) (temp___skip_top_level_282 Bool)) Bool (= (to_rep (rec__p__my_lists__cursor__node (us_split_fields3 temp___expr_281))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_236 us_rep1) (temp___skip_top_level_237 Bool)) Bool (= (to_rep (rec__p__my_lists__cursor__node (us_split_fields3 temp___expr_236))) 0))
