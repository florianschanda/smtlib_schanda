...
(assert (and (= us7 temp___525) (dynamic_property2 first1 last3 temp___525)))
(assert (= o11 temp___525))
(assert (and (= o12 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) o11)) (in_range3 o12)))
