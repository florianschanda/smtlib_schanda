...
(declare-const subnat__f__result Int)
(declare-const result Int)
(declare-const subnat__f__result1 Int)
(declare-const subnat__f__result2 Int)
(declare-const subnat__f__result3 Int)
(declare-const subnat__f__result4 Int)
(declare-const subnat__f__result5 Int)
...
(assert (= (mk_int__ref subnat__f__result4) (mk_int__ref subnat__f__result2)))
(assert (= subnat__f__result5 subnat__f__result3))
(assert (= result1 subnat__f__result4))
(assert (not (<= 0 subnat__f__result4)))
(check-sat)
(exit)
