...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__for_loops_on_lists__my_lists__cursor__node count_type)))))
(define-fun us_split_fields_Node__projection ((a us_split_fields)) count_type (rec__for_loops_on_lists__my_lists__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__for_loops_on_lists__my_lists__cursor__node (us_split_fields1 a))) (to_rep (rec__for_loops_on_lists__my_lists__cursor__node (us_split_fields1 b)))) true false))
...
(define-fun default_initial_assumption2 ((temp___expr_273 us_rep1) (temp___skip_top_level_274 Bool)) Bool (= (to_rep (rec__for_loops_on_lists__my_lists__cursor__node (us_split_fields1 temp___expr_273))) 0))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__for_loops_on_lists__my_lists__list us_main_type2)))))
(define-fun us_split_fields_List__projection ((a us_split_fields2)) us_main_type2 (rec__for_loops_on_lists__my_lists__list a))
...
(define-fun bool_eq3 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (to_rep (rec__for_loops_on_lists__my_lists__list__capacity (us_split_discrs1 a))) (to_rep (rec__for_loops_on_lists__my_lists__list__capacity (us_split_discrs1 b)))) (= (us_main_eq2 (rec__for_loops_on_lists__my_lists__list (us_split_fields3 a)) (rec__for_loops_on_lists__my_lists__list (us_split_fields3 b))) true)) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 2147483647)) (in_range5 temp___expr_214)))
(declare-fun first (us_rep3) us_rep1)
(declare-fun first__function_guard (us_rep1 us_rep3) Bool)
(define-fun default_initial_assumption3 ((temp___expr_228 us_rep1) (temp___skip_top_level_229 Bool)) Bool (= (to_rep (rec__for_loops_on_lists__my_lists__cursor__node (us_split_fields1 temp___expr_228))) 0))
...
(assert (forall ((container us_rep3)) (! (let ((result (length2 container))) (and (<= result (to_rep (rec__for_loops_on_lists__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant4 result true false true true))) :pattern ((length2 container)))))
...
(define-fun cu3 () us_rep1 (mk___rep (mk___split_fields cu1)))
(define-fun o6 () us_rep1 (mk___rep (mk___split_fields o)))
(assert (= (mk___rep (mk___split_fields rliteral)) no_element))
(assert (and (= o6 (first l)) (ite (= (= (length2 l) 0) true) (= (bool_eq1 o6 no_element) true) (and (= (has_key (positions l) o6) true) (= (get1 (positions l) o6) 1)))))
(assert (= (mk_cursor__ref (mk___rep (mk___split_fields result))) (mk_cursor__ref (mk___rep (mk___split_fields cu)))))
(assert (= cu3 o6))
(assert (and (= result1 (has_key (positions l) cu3)) (= (= result1 true) (= (has_key (positions l) cu3) true))))
(assert (= result1 true))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions l) cu2) 1))) (not (= (get (model__ l) i1) 0)))))
(assert (= (has_key (positions l) cu2) true))
(assert (and (= o1 (positions l)) (and (not (= (has_key o1 no_element) true)) (forall ((i1 us_rep1)) (=> (= (has_key o1 i1) true) (and (and (<= 1 (get1 o1 i1)) (<= (get1 o1 i1) (length2 l))) (forall ((j us_rep1)) (=> (= (has_key o1 j) true) (=> (= (get1 o1 i1) (get1 o1 j)) (= (bool_eq1 i1 j) true))))))))))
(assert (and (= o2 (get1 o1 cu2)) (and (in_range4 o2) (=> (= (distinct 0 0) true) (and (= o2 (w_get o1 (witness o1 cu2))) (forall ((k us_rep1)) (=> (= (has_key o1 k) true) (= (= (bool_eq1 k cu2) true) (= (witness o1 cu2) (witness o1 k))))))))))
(assert (= o3 (- o2 1)))
(assert (= o4 (ite (<= i o3) true false)))
(assert (= result2 (ite (<= 1 i) o4 false)))
(assert (= result2 true))
(assert (and (= o5 (model__ l)) (= (length o5) (length2 l))))
