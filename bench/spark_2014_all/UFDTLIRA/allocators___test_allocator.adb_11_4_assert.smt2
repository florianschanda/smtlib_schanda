...
(define-fun model____split_fields6 () us_split_fields (mk___split_fields model____split_fields4 model____split_fields5))
(define-fun model____split_fields7 () us_split_fields (mk___split_fields model____split_fields2 model____split_fields3))
(assert (=> (<= 0 10000) (in_range res1)))
(assert (=> (<= 0 10000) (in_range res2)))
(assert (=> (<= 0 10000) (in_range res3)))
(assert (=> (<= 0 10000) (in_range res4)))
(assert (and (and (= (is_valid state model____split_fields7) true) (ite (= (= (length model____split_fields) 0) true) (and (= res11 0) (= (oeq (mk___rep model____split_fields7) (mk___rep (mk___split_fields model____split_fields model____split_fields1))) true)) (and (= (is_prepend model____split_fields2 res11 model____split_fields) true) (= (is_add model____split_fields1 res11 model____split_fields3) true)))) (in_range res11)))
(assert (not (= res11 0)))
(assert (= (is_allocated res11 state) true))
(assert (and (and (= (is_valid state1 model____split_fields6) true) (ite (= (= (length model____split_fields2) 0) true) (and (= res21 0) (= (oeq (mk___rep model____split_fields6) (mk___rep model____split_fields7)) true)) (and (= (is_prepend model____split_fields4 res21 model____split_fields2) true) (= (is_add model____split_fields3 res21 model____split_fields5) true)))) (in_range res21)))
(assert (not (= res21 0)))
(assert (not (= (is_allocated res21 state1) true)))
(check-sat)
(exit)
