...
(define-fun dynamic_invariant1 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 1 10)) (in_range1 temp___expr_158)))
...
(assert (=> (<= 1 10) (in_range1 current_id)))
(assert (=> (<= 1 2147483647) (in_range current_cycles)))
(assert (= result current_id))
(assert (= current_id1 1))
(assert (= result1 current_cycles))
(assert (= current_cycles1 2147483647))
...
(assert (not (= (get_current_cycles1 current_cycles2) 2147483647)))
(check-sat)
(exit)
