...
(assert (= index8 10))
(assert (=> (and (<= 1 index8) (<= index8 10)) (= temp___193 t8)))
(assert (=> (and (<= 1 index8) (<= index8 10)) (= temp___192 index8)))
(assert (=> (and (<= 1 index8) (<= index8 10)) (= t9 (+ index9 1))))
(assert (=> (and (<= 1 index8) (<= index8 10)) (and (and (=> (<= 1 10) (in_range3 index9)) (=> (<= (- 2147483648) 2147483647) (in_range1 t9))) (and (<= 1 index9) (<= index9 10)))))
(assert (=> (and (<= 1 index8) (<= index8 10)) (= t9 result5)))
(assert (=> (and (<= 1 index8) (<= index8 10)) (= t10 index9)))
(assert (=> (and (<= 1 index8) (<= index8 10)) (= index9 1)))
(assert (=> (and (<= 1 index8) (<= index8 10)) (= index10 (mk_int__ref index9))))
...
(assert (=> (not (and (<= 1 index8) (<= index8 10))) (= index12 (mk_int__ref index8))))
(assert (=> (not (and (<= 1 index8) (<= index8 10))) (= t13 (mk_int__ref t8))))
(assert (=> (not (and (<= 1 index8) (<= index8 10))) (= index13 index8)))
(assert (=> (not (and (<= 1 index8) (<= index8 10))) (= t14 t8)))
(assert (not (= (int__content t13) 1)))
(check-sat)
(exit)
