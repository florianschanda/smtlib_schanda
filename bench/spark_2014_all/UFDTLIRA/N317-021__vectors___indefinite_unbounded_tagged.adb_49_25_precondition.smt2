...
(declare-const temp___620 us_rep1)
...
(assert (and (= temp___620 (f 2)) (= temp___620 (mk___rep1 (mk___split_fields1 (of_rep1 2) us_null_ext__) us_tag))))
(assert (not (<= 5 (last (model__ (mk___rep w__split_discrs w__split_fields2))))))
(check-sat)
(exit)
