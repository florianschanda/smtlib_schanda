...
(define-fun default_initial_assumption ((temp___expr_451 us_rep) (temp___skip_top_level_452 Bool)) Bool (=> (not (= temp___skip_top_level_452 true)) (= (length temp___expr_451) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_443 Int) (temp___is_init_439 Bool) (temp___skip_constant_440 Bool) (temp___do_toplevel_441 Bool) (temp___do_typ_inv_442 Bool)) Bool (=> (or (= temp___is_init_439 true) (<= 0 2147483647)) (in_range2 temp___expr_443)))
...
(define-fun dynamic_invariant2 ((temp___expr_429 Int) (temp___is_init_425 Bool) (temp___skip_constant_426 Bool) (temp___do_toplevel_427 Bool) (temp___do_typ_inv_428 Bool)) Bool (=> (or (= temp___is_init_425 true) (<= 1 2147483647)) (in_range4 temp___expr_429)))
...
(define-fun dynamic_invariant3 ((temp___expr_436 Int) (temp___is_init_432 Bool) (temp___skip_constant_433 Bool) (temp___do_toplevel_434 Bool) (temp___do_typ_inv_435 Bool)) Bool (=> (or (= temp___is_init_432 true) (<= 0 2147483647)) (in_range5 temp___expr_436)))
