...
(assert (=> (and (<= 1 c2) (<= c2 10)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- c3 1))) (and (= (to_rep (get m2 5 i1)) (to_rep (get temp___267 7 i1))) (= (to_rep (get m2 7 i1)) (to_rep (get temp___268 5 i1))))))))
