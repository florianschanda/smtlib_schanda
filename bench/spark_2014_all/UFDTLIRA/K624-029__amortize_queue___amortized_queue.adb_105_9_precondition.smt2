...
(define-fun o9 () us_rep (mk___rep (mk___split_discrs o2) (mk___split_fields o3)))
(define-fun o10 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1)))
...
(assert (= o5 o4))
(assert (= o6 o5))
(assert (and (= o10 (copy (rec__amortized_queue__queue__front (us_split_fields3 q)) 1000)) (and (= (oeq1 (model__ o10) (model__ (rec__amortized_queue__queue__front (us_split_fields3 q)))) true) (ite (= 1000 0) (= (to_rep o) (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (= (to_rep o) 1000)))))
(assert (= o9 o10))
(assert (= o7 o9))
...
(assert (not (< (length (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__rear result____split_fields4)) (us_split_fields1 (rec__amortized_queue__queue__rear result____split_fields4)))) (capacity (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__rear result____split_fields4)) (us_split_fields1 (rec__amortized_queue__queue__rear result____split_fields4)))))))
(check-sat)
(exit)
