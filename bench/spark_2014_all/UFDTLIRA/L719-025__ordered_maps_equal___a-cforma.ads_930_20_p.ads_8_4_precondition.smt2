...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__p__my_maps__cursor__node count_type)))))
(define-fun us_split_fields_Node__projection ((a us_split_fields)) count_type (rec__p__my_maps__cursor__node a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__p__my_maps__cursor__node (us_split_fields1 a))) (to_rep (rec__p__my_maps__cursor__node (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 2147483647)) (in_range2 temp___expr_433)))
...
(define-fun default_initial_assumption ((temp___expr_441 us_rep1) (temp___skip_top_level_442 Bool)) Bool (=> (not (= temp___skip_top_level_442 true)) (and (= (is_empty temp___expr_441) true) (= (length temp___expr_441) 0))))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__p__my_maps__map us_main_type1)))))
(define-fun us_split_fields_Map__projection ((a us_split_fields2)) us_main_type1 (rec__p__my_maps__map a))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__p__my_maps__map__capacity (us_split_discrs1 a))) (to_rep (rec__p__my_maps__map__capacity (us_split_discrs1 b)))) (= (us_main_eq1 (rec__p__my_maps__map (us_split_fields3 a)) (rec__p__my_maps__map (us_split_fields3 b))) true)) true false))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__p__my_maps__map__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
