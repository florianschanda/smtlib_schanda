...
(define-fun dynamic_invariant1 ((temp___expr_1726 us_rep2) (temp___is_init_1722 Bool) (temp___skip_constant_1723 Bool) (temp___do_toplevel_1724 Bool) (temp___do_typ_inv_1725 Bool)) Bool (= (valid_combination (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1726))) true))
(define-fun default_initial_assumption2 ((temp___expr_1728 us_rep2) (temp___skip_top_level_1729 Bool)) Bool (and (and (= (rec__traffic_lights__traffic_lightT__last_state_change (us_split_fields3 temp___expr_1728)) time_first) (= (rec__traffic_lights__traffic_lightT__change_state (us_split_fields3 temp___expr_1728)) (distinct 0 0))) (and (and (and (and (= (rec__traffic_lights__lights_state__vehicles_green (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1728)))) (distinct 0 0)) (= (rec__traffic_lights__lights_state__vehicles_yellow (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1728)))) (distinct 0 0))) (= (rec__traffic_lights__lights_state__vehicles_red (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1728)))) (distinct 1 0))) (= (rec__traffic_lights__lights_state__pedestrians_green (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1728)))) (distinct 1 0))) (= (rec__traffic_lights__lights_state__pedestrians_red (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1728)))) (distinct 0 0)))))
(declare-const self__ us_rep2)
(declare-const temp___1752 Bool)
(declare-const temp___17521 Bool)
(declare-const temp___17522 Bool)
(declare-const temp___17523 Bool)
(declare-const temp___17524 Bool)
(assert (and (and (and (and (= temp___1752 (distinct 0 0)) (= temp___17521 (distinct 0 0))) (= temp___17522 (distinct 1 0))) (= temp___17523 (distinct 1 0))) (= temp___17524 (distinct 0 0))))
(assert (not (= (valid_combination (mk___rep (mk___split_fields temp___1752 temp___17521 temp___17522 temp___17523 temp___17524))) true)))
(check-sat)
(exit)
