...
(define-fun dynamic_invariant ((temp___expr_799 Int) (temp___is_init_795 Bool) (temp___skip_constant_796 Bool) (temp___do_toplevel_797 Bool) (temp___do_typ_inv_798 Bool)) Bool (=> (or (= temp___is_init_795 true) (<= 0 1000)) (in_range1 temp___expr_799)))
...
(define-fun dynamic_invariant1 ((temp___expr_792 Int) (temp___is_init_788 Bool) (temp___skip_constant_789 Bool) (temp___do_toplevel_790 Bool) (temp___do_typ_inv_791 Bool)) Bool (=> (or (= temp___is_init_788 true) (<= 0 1001)) (in_range2 temp___expr_792)))
...
(define-fun dynamic_invariant2 ((temp___expr_778 Int) (temp___is_init_774 Bool) (temp___skip_constant_775 Bool) (temp___do_toplevel_776 Bool) (temp___do_typ_inv_777 Bool)) Bool (=> (or (= temp___is_init_774 true) (<= 1 1000)) (in_range3 temp___expr_778)))
...
(define-fun dynamic_invariant3 ((temp___expr_580 Int) (temp___is_init_576 Bool) (temp___skip_constant_577 Bool) (temp___do_toplevel_578 Bool) (temp___do_typ_inv_579 Bool)) Bool (=> (or (= temp___is_init_576 true) (<= 0 2147483647)) (in_range4 temp___expr_580)))
...
(define-fun default_initial_assumption ((temp___expr_838 us_rep1) (temp___skip_top_level_839 Bool)) Bool (=> (not (= temp___skip_top_level_839 true)) (= (length1 temp___expr_838) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_830 Int) (temp___is_init_826 Bool) (temp___skip_constant_827 Bool) (temp___do_toplevel_828 Bool) (temp___do_typ_inv_829 Bool)) Bool (=> (or (= temp___is_init_826 true) (<= 0 1000)) (in_range5 temp___expr_830)))
...
(define-fun dynamic_invariant5 ((temp___expr_823 Int) (temp___is_init_819 Bool) (temp___skip_constant_820 Bool) (temp___do_toplevel_821 Bool) (temp___do_typ_inv_822 Bool)) Bool (=> (or (= temp___is_init_819 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_823)))
