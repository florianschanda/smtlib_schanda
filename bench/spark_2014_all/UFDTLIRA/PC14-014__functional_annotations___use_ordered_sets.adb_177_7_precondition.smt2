...
(assert (forall ((container us_rep1)) (! (let ((result (is_empty container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range2 item) (= (contains container item) true))))) (= (= result true) (= (length2 container) 0)))) :pattern ((is_empty container)))))
...
(assert (forall ((left us_rep3) (right us_rep3)) (! (= (= (oeq3 left right) true) (and (forall ((key us_rep4)) (=> (= (has_key left key) true) (and (= (has_key right key) true) (= (get1 right key) (get1 left key))))) (forall ((key us_rep4)) (=> (= (has_key right key) true) (= (has_key left key) true))))) :pattern ((oeq3 left right)))))
...
(assert (and (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) 1) true) (ite (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 1) true) (and (and (and (= (oeq2 (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (model__ (mk___rep s__split_discrs s__split_fields2))) true) (= (oeq3 (positions (mk___rep s__split_discrs s__split_fields2)) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) true)) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (find (elements (mk___rep s__split_discrs s__split_fields2)) 1)) 1)) (= (equal_except (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (elements (mk___rep s__split_discrs s__split_fields2)) (find (elements (mk___rep s__split_discrs s__split_fields2)) 1)) true)) (and (and (and (and (and (and (= (length (mk___rep s__split_discrs s__split_fields2)) (+ (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 1)) (= (ole (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (model__ (mk___rep s__split_discrs s__split_fields2))) true)) (= (included_except (model__ (mk___rep s__split_discrs s__split_fields2)) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 1) true)) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (find (elements (mk___rep s__split_discrs s__split_fields2)) 1)) 1)) (= (range_equal (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (elements (mk___rep s__split_discrs s__split_fields2)) 1 (- (find (elements (mk___rep s__split_discrs s__split_fields2)) 1) 1)) true)) (= (range_shifted (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (elements (mk___rep s__split_discrs s__split_fields2)) (find (elements (mk___rep s__split_discrs s__split_fields2)) 1) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 1) true)) (= (p_positions_shifted (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (positions (mk___rep s__split_discrs s__split_fields2)) (find (elements (mk___rep s__split_discrs s__split_fields2)) 1) 1) true)))))
(assert (not (or (< (length (mk___rep s__split_discrs s__split_fields2)) (to_rep (rec__use_ordered_sets__my_sets__set__capacity s__split_discrs))) (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) 2) true))))
(check-sat)
(exit)
