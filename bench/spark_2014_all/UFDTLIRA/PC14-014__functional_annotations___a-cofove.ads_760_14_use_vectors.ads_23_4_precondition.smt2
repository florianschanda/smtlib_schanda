...
(assert (and (= o2 (last1 (model__ container))) (and (dynamic_property3 first2 last4 o2) (= o2 (last1 (model__ container))))))
(assert (= result (ite (<= index o2) true false)))
(assert (=> (= result true) (and (= us1 index) (dynamic_property4 first3 last5 index))))
(assert (=> (= result true) (= o3 index)))
(assert (=> (not (= result true)) (and (= temp___465 (last1 (model__ container))) (and (dynamic_property3 first2 last4 temp___465) (= temp___465 (last1 (model__ container)))))))
(assert (=> (not (= result true)) (and (= us2 temp___465) (dynamic_property4 first3 last5 temp___465))))
(assert (=> (not (= result true)) (= o3 temp___465)))
(assert (and (= us first1) (dynamic_property first last first1)))
(assert (= o1 first1))
(assert (and (= o (model__ container)) (= (length o) (length1 container))))
(assert (not (<= o3 (last1 o))))
(check-sat)
(exit)
