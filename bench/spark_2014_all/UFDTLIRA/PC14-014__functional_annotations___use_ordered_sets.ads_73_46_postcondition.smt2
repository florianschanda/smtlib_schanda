...
(define-fun dynamic_invariant1 ((temp___expr_382 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool) (temp___do_typ_inv_381 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_382)))
...
(define-fun dynamic_invariant2 ((temp___expr_389 Int) (temp___is_init_385 Bool) (temp___skip_constant_386 Bool) (temp___do_toplevel_387 Bool) (temp___do_typ_inv_388 Bool)) Bool (=> (or (= temp___is_init_385 true) (<= 0 2147483647)) (in_range3 temp___expr_389)))
...
(assert (forall ((a us_rep2) (b us_rep2)) (! (= (user_eq3 a b) (oeq2 a b)) :pattern ((user_eq3 a b)))))
...
(define-fun dynamic_invariant3 ((temp___expr_412 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool) (temp___do_typ_inv_411 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 1 2147483647)) (in_range4 temp___expr_412)))
...
(assert (forall ((container us_rep4)) (forall ((key us_rep3)) (! (=> (= (has_key container key) true) (let ((result (get1 container key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep3)) (=> (= (has_key container k) true) (= (= (bool_eq3 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant3 result true false true true)))) :pattern ((get1 container key))))))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length1 result) (length container)) (forall ((temp___435 Int)) (=> (and (in_range3 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container) (get result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 2147483647)) (in_range8 temp___expr_346)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length1 container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container item))))))
...
(define-fun dynamic_invariant6 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_353)))
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range5 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((container us_rep1)) (! (let ((result (is_empty container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range5 item) (= (contains container item) true))))) (= (= result true) (= (length3 container) 0)))) :pattern ((is_empty container)))))
(assert (forall ((left us_rep1) (right us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range5 e) (= (contains left e) true)) (or (= (contains right e) true) (= (equivalent_elements e item) true)))))) :pattern ((included_except left right item))))))
...
(declare-const use_ordered_sets__move_4__cu__assume count_type)
(declare-const temp___824 count_type)
(declare-const temp___823 count_type)
(declare-const temp___8231 us_main_type)
(declare-const o Int)
(declare-const temp___822 count_type)
...
(define-fun temp___8221 () us_rep3 (mk___rep1 (mk___split_fields1 temp___822)))
(define-fun use_ordered_sets__move_4__cu__assume1 () us_rep3 (mk___rep1 (mk___split_fields1 use_ordered_sets__move_4__cu__assume)))
...
(assert (and (= use_ordered_sets__move_4__cu__assume1 (first (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (ite (= (= (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) 0) true) (= (bool_eq3 use_ordered_sets__move_4__cu__assume1 no_element) true) (and (= (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) use_ordered_sets__move_4__cu__assume1) true) (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) use_ordered_sets__move_4__cu__assume1) 1)))))
(assert (= (mk___split_fields__ref1 (mk___split_fields1 result)) (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields))))
(assert (= use_ordered_sets__move_4__cu__assume cu__split_fields1))
...
(assert (=> (= result1 true) (= temp___824 cu__split_fields1)))
(assert (=> (= result1 true) (and (= (mk___split_discrs temp___823) s2__split_discrs) (= temp___8231 s2__split_fields))))
...
(assert (=> (= result1 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s2__split_discrs s2__split_fields9)))) (= (get (elements (mk___rep s2__split_discrs s2__split_fields9)) i) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i))))))
...
(assert (=> (= result1 true) (and (= temp___8221 (next (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)) (mk___rep1 cu__split_fields10))) (ite (= (ite (= (bool_eq3 (mk___rep1 cu__split_fields10) no_element) false) (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields10)) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) true) true) (= (bool_eq3 temp___8221 no_element) true) (and (= (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) temp___8221) true) (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) temp___8221) (+ (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields10)) 1)))))))
(assert (=> (= result1 true) (= result2 (mk___split_fields__ref1 cu__split_fields10))))
(assert (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___822))))
...
(assert (not (= (oeq2 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (elements (mk___rep s2__split_discrs (us_split_fields__content s2__split_fields7)))) true)))
(check-sat)
(exit)
