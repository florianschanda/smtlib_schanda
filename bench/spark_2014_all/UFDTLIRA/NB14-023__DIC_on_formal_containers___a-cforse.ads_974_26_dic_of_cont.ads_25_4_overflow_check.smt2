...
(define-fun default_initial_assumption ((temp___expr_1423 us_rep2) (temp___skip_top_level_1424 Bool)) Bool (=> (not (= temp___skip_top_level_1424 true)) (= (length1 temp___expr_1423) 0)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length1 result) (length container)) (forall ((temp___1461 Int)) (=> (and (in_range5 temp___1461) (= (iter_has_element result temp___1461) true)) (= (contains (model__ container) (get result temp___1461)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container)))))
...
(assert (and (= o (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range o) (<= o (to_rep (rec__dic_of_cont__my_orse__set__capacity target__split_discrs))))))
(assert (= o1 (- (to_rep (rec__dic_of_cont__my_orse__set__capacity target__split_discrs)) o)))
