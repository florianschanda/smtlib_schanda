...
(define-fun dynamic_invariant ((temp___expr_472 Int) (temp___is_init_468 Bool) (temp___skip_constant_469 Bool) (temp___do_toplevel_470 Bool) (temp___do_typ_inv_471 Bool)) Bool (=> (or (= temp___is_init_468 true) (<= 0 4)) (in_range2 temp___expr_472)))
(define-fun dynamic_invariant1 ((temp___expr_479 Int) (temp___is_init_475 Bool) (temp___skip_constant_476 Bool) (temp___do_toplevel_477 Bool) (temp___do_typ_inv_478 Bool)) Bool (=> (or (= temp___is_init_475 true) (<= 1 4)) (in_range3 temp___expr_479)))
...
(define-fun dynamic_invariant3 ((temp___expr_409 Int) (temp___is_init_405 Bool) (temp___skip_constant_406 Bool) (temp___do_toplevel_407 Bool) (temp___do_typ_inv_408 Bool)) Bool (=> (or (= temp___is_init_405 true) (<= 1 3)) (in_range4 temp___expr_409)))
...
(define-fun theadmin__split_fields6 () us_split_fields (mk___split_fields theadmin__split_fields theadmin__split_fields1))
(assert (and (not (= (ispresent (mk___rep theadmin__split_fields6)) true)) (not (= (isdoingop (mk___rep theadmin__split_fields6)) true))))
(assert (= theadmin__split_fields2 theadmin__split_fields))
(assert (= theadmin__split_fields3 theadmin__split_fields1))
(assert (= theadmin__split_fields4 theadmin__split_fields))
(assert (= theadmin__split_fields5 theadmin__split_fields1))
(assert (not (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))) true))))
(check-sat)
(exit)
