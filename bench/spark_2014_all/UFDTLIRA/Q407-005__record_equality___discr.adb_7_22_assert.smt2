...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (= (to_rep1 (rec__discr__t_record__row_first (us_split_discrs1 a))) (to_rep1 (rec__discr__t_record__row_first (us_split_discrs1 b)))) (= (to_rep1 (rec__discr__t_record__row_last (us_split_discrs1 a))) (to_rep1 (rec__discr__t_record__row_last (us_split_discrs1 b))))) (= (to_rep1 (rec__discr__t_record__col_first (us_split_discrs1 a))) (to_rep1 (rec__discr__t_record__col_first (us_split_discrs1 b))))) (= (to_rep1 (rec__discr__t_record__col_last (us_split_discrs1 a))) (to_rep1 (rec__discr__t_record__col_last (us_split_discrs1 b))))) (= (bool_eq2 (rec__discr__t_record__data (us_split_fields1 a)) (rec__discr__t_record__data (us_split_fields1 b))) true)) true false))
...
(assert (= (to_rep data_copy__first) (to_rep (first (mk (to_rep (first3 (rt1 (rec__discr__t_record__data (us_split_fields1 rec__))))) (to_rep (last3 (rt1 (rec__discr__t_record__data (us_split_fields1 rec__))))))))))
(assert (= (to_rep data_copy__last) (to_rep (last (mk (to_rep (first3 (rt1 (rec__discr__t_record__data (us_split_fields1 rec__))))) (to_rep (last3 (rt1 (rec__discr__t_record__data (us_split_fields1 rec__))))))))))
(assert (= (to_rep data_copy__first_2) (to_rep (first1 (mk1 (to_rep (first4 (rt_21 (rec__discr__t_record__data (us_split_fields1 rec__))))) (to_rep (last4 (rt_21 (rec__discr__t_record__data (us_split_fields1 rec__))))))))))
(assert (= (to_rep data_copy__last_2) (to_rep (last1 (mk1 (to_rep (first4 (rt_21 (rec__discr__t_record__data (us_split_fields1 rec__))))) (to_rep (last4 (rt_21 (rec__discr__t_record__data (us_split_fields1 rec__))))))))))
(assert (dynamic_property2 1 2147483647 (to_rep data_copy__first) (to_rep data_copy__last) 1 2147483647 (to_rep data_copy__first_2) (to_rep data_copy__last_2)))
(assert (not (= (let ((temp___235 (rec__discr__t_record__data (us_split_fields1 rec__)))) (bool_eq data_copy1 (to_rep data_copy__first) (to_rep data_copy__last) (to_rep data_copy__first_2) (to_rep data_copy__last_2) (elts1 temp___235) (to_rep (first3 (rt1 temp___235))) (to_rep (last3 (rt1 temp___235))) (to_rep (first4 (rt_21 temp___235))) (to_rep (last4 (rt_21 temp___235))))) true)))
(check-sat)
(exit)
