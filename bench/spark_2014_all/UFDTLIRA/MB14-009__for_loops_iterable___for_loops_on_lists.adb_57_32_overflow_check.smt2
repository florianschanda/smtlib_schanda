...
(define-fun o8 () us_rep2 (mk___rep1 (mk___split_fields1 o6)))
(define-fun o9 () us_rep2 (mk___rep1 (mk___split_fields1 o4)))
...
(assert (and (= o10 (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq2 o10 no_element) true) (and (= (has_key (positions l) o10) true) (= (get1 (positions l) o10) 1)))))
(assert (= temp___547 o))
...
(assert (and (= o9 (next l temp___5471)) (ite (= (ite (= (bool_eq2 temp___5471 no_element) false) (= (get1 (positions l) temp___5471) (length1 l)) true) true) (= (bool_eq2 o9 no_element) true) (and (= (has_key (positions l) o9) true) (= (get1 (positions l) o9) (+ (get1 (positions l) temp___5471) 1))))))
(assert (and (= o5 (has_key (positions l) o9)) (= (= o5 true) (= (has_key (positions l) o9) true))))
(assert (= result7 (ite (not (= o5 true)) true false)))
(assert (not (= result7 true)))
(assert (and (= o8 (next l temp___5471)) (ite (= (ite (= (bool_eq2 temp___5471 no_element) false) (= (get1 (positions l) temp___5471) (length1 l)) true) true) (= (bool_eq2 o8 no_element) true) (and (= (has_key (positions l) o8) true) (= (get1 (positions l) o8) (+ (get1 (positions l) temp___5471) 1))))))
(assert (= result8 (mk_cursor__ref temp___5471)))
(assert (= temp___5472 o8))
(assert (and (= result9 (has_key (positions l) temp___5472)) (= (= result9 true) (= (has_key (positions l) temp___5472) true))))
(assert (=> (= result9 true) (and (= o7 (element l temp___5472)) (and (in_range6 o7) (= o7 (get (model__ l) (get1 (positions l) temp___5472)))))))
(assert (=> (= result9 true) (= result10 (mk_int__ref e3))))
(assert (=> (= result9 true) (= e4 o7)))
(assert (=> (not (= result9 true)) (= e4 e3)))
(assert (= e4 0))
(assert (not (in_range1 (+ count_03 1))))
(check-sat)
(exit)
