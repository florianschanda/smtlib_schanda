...
(assert (and (= o (element (mk___rep l__split_discrs l__split_fields4) (mk___rep1 cu__split_fields3))) (and (in_range5 o) (= o (get (model__ (mk___rep l__split_discrs l__split_fields4)) (get1 (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields3)))))))
(assert (= result2 (ite (< o 2147483647) true false)))
(assert (=> (= result2 true) (and (= o1 (element (mk___rep l__split_discrs l__split_fields4) (mk___rep1 cu__split_fields3))) (and (in_range5 o1) (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields4)) (get1 (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields3))))))))
...
(assert (not (or (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) true) (= (bool_eq2 (mk___rep1 cu__split_fields3) no_element) true))))
(check-sat)
(exit)
