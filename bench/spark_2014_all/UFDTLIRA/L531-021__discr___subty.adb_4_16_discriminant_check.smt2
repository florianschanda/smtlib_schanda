...
(assert (= true o5))
(assert (= dummy1 o6))
(assert (= (mk___rep (mk___split_discrs o7) (mk___split_fields o8 o9 o10 o11)) (mk___rep (mk___split_discrs o2) (mk___split_fields o3 o4 o5 o6))))
(assert (not (= 0 (to_rep1 o7))))
(check-sat)
(exit)
