...
(assert (and (= o14 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))))) (and (dynamic_property4 first3 last5 o14) (= o14 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))))))))
...
(assert (= (= o17 true) (forall ((j3 Int)) (=> (and (<= (+ i 7) j3) (<= j3 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8)))))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))) j3) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (- j3 7)))))))
(assert (and (= o9 (+ i 7)) (in_range1 (+ i 7))))
(assert (= o10 (- o9 1)))
(assert (= o11 (ite (<= j1 o10) true false)))
(assert (= result1 (ite (<= i j1) o11 false)))
(assert (= (= o12 true) (forall ((j3 Int)) (=> (and (<= i j3) (<= j3 (- (+ i 7) 1))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))) j3) 0)))))
(assert (and (= o7 (- i 1)) (in_range1 (- i 1))))
(assert (= o8 (ite (<= j o7) true false)))
(assert (= result2 (ite (<= first4 j) o8 false)))
(assert (= result2 true))
(assert (not (dynamic_property2 first1 last3 j)))
(check-sat)
(exit)
