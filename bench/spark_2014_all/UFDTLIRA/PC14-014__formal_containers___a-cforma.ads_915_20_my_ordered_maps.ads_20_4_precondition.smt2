...
(define-fun default_initial_assumption ((temp___expr_654 us_rep2) (temp___skip_top_level_655 Bool)) Bool (=> (not (= temp___skip_top_level_655 true)) (and (= (is_empty temp___expr_654) true) (= (length1 temp___expr_654) 0))))
...
(assert (forall ((container1 us_rep4)) (! (dynamic_invariant (length2 container1) true false true true) :pattern ((length2 container1)))))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep (rec__my_ordered_maps__n__map__capacity (us_split_discrs1 container)))))))
