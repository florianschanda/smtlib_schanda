...
(define-fun dynamic_invariant ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (and (=> (or (= temp___is_init_196 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_200)) (=> (= temp___do_toplevel_198 true) (=> (= temp___is_init_196 true) (= (blocking_true Tuple0) true)))))
(define-fun dynamic_predicate ((temp___204 Int)) Bool (= (blocking_true Tuple0) true))
(declare-sort pt 0)
