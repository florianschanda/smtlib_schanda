...
(define-fun dynamic_invariant ((temp___expr_491 Int) (temp___is_init_487 Bool) (temp___skip_constant_488 Bool) (temp___do_toplevel_489 Bool) (temp___do_typ_inv_490 Bool)) Bool (=> (or (= temp___is_init_487 true) (<= 0 2147483647)) (in_range5 temp___expr_491)))
...
(define-fun dynamic_invariant1 ((temp___expr_474 Int) (temp___is_init_470 Bool) (temp___skip_constant_471 Bool) (temp___do_toplevel_472 Bool) (temp___do_typ_inv_473 Bool)) Bool (=> (or (= temp___is_init_470 true) (<= 1 2147483647)) (in_range6 temp___expr_474)))
...
(define-fun dynamic_invariant3 ((temp___expr_296 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= 0 2147483646)) (in_range3 temp___expr_296)))
(define-fun dynamic_invariant4 ((temp___expr_210 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 2147483647)) (in_range2 temp___expr_210)))
...
(define-fun dynamic_invariant6 ((temp___expr_498 Int) (temp___is_init_494 Bool) (temp___skip_constant_495 Bool) (temp___do_toplevel_496 Bool) (temp___do_typ_inv_497 Bool)) Bool (=> (or (= temp___is_init_494 true) (<= 0 2147483647)) (in_range4 temp___expr_498)))
...
(define-fun capacity ((container1 us_rep2)) Int (ite (= (distinct 0 0) true) (to_rep3 (rec__names__entry_tables__vector__capacity (us_split_discrs1 container1))) 2147483647))
