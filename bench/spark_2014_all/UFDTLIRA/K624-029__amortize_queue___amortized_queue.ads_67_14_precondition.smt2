...
(define-fun dynamic_invariant7 ((temp___expr_280 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool) (temp___do_typ_inv_279 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= 0 1000)) (in_range7 temp___expr_280)))
...
(define-fun dynamic_invariant8 ((temp___expr_273 Int) (temp___is_init_269 Bool) (temp___skip_constant_270 Bool) (temp___do_toplevel_271 Bool) (temp___do_typ_inv_272 Bool)) Bool (=> (or (= temp___is_init_269 true) (<= (- 2147483648) 2147483647)) (in_range8 temp___expr_273)))
...
(declare-const amortized_queue__front__result Int)
(declare-const o Int)
(declare-const o1 capacity_range)
(declare-const o2 us_main_type)
(declare-const result Int)
(declare-const amortized_queue__front__result1 Int)
(declare-const amortized_queue__front__result2 Int)
(declare-const amortized_queue__front__result3 Int)
(declare-const amortized_queue__front__result4 Int)
(declare-const amortized_queue__front__result5 Int)
(define-fun o3 () us_rep (mk___rep (mk___split_discrs o1) (mk___split_fields o2)))
...
(assert (= amortized_queue__front__result1 amortized_queue__front__result2))
(assert (= amortized_queue__front__result3 amortized_queue__front__result1))
(assert (and (= o (last_element (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range2 o) (= o (get (model__ (rec__amortized_queue__queue__front (us_split_fields3 q))) (last (model__ (rec__amortized_queue__queue__front (us_split_fields3 q)))))))))
(assert (= (mk_int__ref result) (mk_int__ref amortized_queue__front__result)))
(assert (= amortized_queue__front__result1 o))
(assert (= (mk_int__ref amortized_queue__front__result4) (mk_int__ref amortized_queue__front__result2)))
(assert (= amortized_queue__front__result5 amortized_queue__front__result3))
(assert (and (= o3 (model__1 q)) (= (is_model q o3) true)))
(assert (not (not (= (is_empty o3) true))))
(check-sat)
(exit)
