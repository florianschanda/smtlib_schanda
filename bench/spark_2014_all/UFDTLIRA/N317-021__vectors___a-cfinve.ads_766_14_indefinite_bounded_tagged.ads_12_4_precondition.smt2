...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__indefinite_bounded_tagged__vect__vector us_main_type1)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields2)) us_main_type1 (rec__indefinite_bounded_tagged__vect__vector a))
...
(define-fun default_initial_assumption ((temp___expr_322 us_rep1) (temp___skip_top_level_323 Bool)) Bool (=> (not (= temp___skip_top_level_323 true)) (= (length temp___expr_322) 0)))
...
(define-fun dynamic_invariant ((temp___expr_278 Int) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool (=> (or (= temp___is_init_274 true) (<= 0 2147483647)) (in_range3 temp___expr_278)))
(define-fun default_initial_assumption1 ((temp___expr_249 us_rep) (temp___skip_top_level_250 Bool)) Bool (= (attr__tag temp___expr_249) us_tag))
...
(define-fun dynamic_invariant1 ((temp___expr_266 Int) (temp___is_init_262 Bool) (temp___skip_constant_263 Bool) (temp___do_toplevel_264 Bool) (temp___do_typ_inv_265 Bool)) Bool (=> (or (= temp___is_init_262 true) (<= 1 2147483647)) (in_range4 temp___expr_266)))
...
(define-fun dynamic_invariant4 ((temp___expr_285 Int) (temp___is_init_281 Bool) (temp___skip_constant_282 Bool) (temp___do_toplevel_283 Bool) (temp___do_typ_inv_284 Bool)) Bool (=> (or (= temp___is_init_281 true) (<= 0 2147483647)) (in_range2 temp___expr_285)))
...
(define-fun capacity ((container1 us_rep2)) Int (ite (= (distinct 1 0) true) (to_rep1 (rec__indefinite_bounded_tagged__vect__vector__capacity (us_split_discrs1 container1))) 2147483647))
...
(assert (=> (not (= result true)) (and (= o2 (last (model__ container))) (and (in_range3 o2) (= o2 (last (model__ container)))))))
