...
(assert (= (to_rep x__split_discrs) r2b))
(assert (in_range1 r2b))
(assert (= (to_rep o) 2))
(assert (= o o1))
(assert (= temp___183 o1))
(assert (= rliteral temp___1831))
(assert (= dummy temp___1832))
(assert (= true temp___1833))
(assert (= true temp___1834))
(assert (= x__attr__constrained true))
(assert (not (= temp___183 x__split_discrs)))
(check-sat)
(exit)
