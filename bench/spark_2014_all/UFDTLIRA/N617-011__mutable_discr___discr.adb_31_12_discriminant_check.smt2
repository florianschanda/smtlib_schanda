...
(define-fun dynamic_invariant1 ((temp___expr_219 us_rep) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool) (temp___do_typ_inv_218 Bool)) Bool (and (=> (not (= temp___skip_constant_216 true)) (in_range1 c temp___expr_219)) (= (attr__constrained temp___expr_219) true)))
(define-fun default_initial_assumption ((temp___expr_221 us_rep) (temp___skip_top_level_222 Bool)) Bool (and (= (attr__constrained temp___expr_221) true) (= (to_rep (rec__discr__with_default__c (us_split_discrs1 temp___expr_221))) c)))
...
(define-fun default_initial_assumption1 ((temp___expr_193 us_rep) (temp___skip_top_level_194 Bool)) Bool (and (= (attr__constrained temp___expr_193) false) (= (to_rep (rec__discr__with_default__c (us_split_discrs1 temp___expr_193))) 0)))
...
(declare-const temp___3221 Bool)
(define-fun o8 () us_rep (mk___rep (mk___split_discrs o6) o7))
(define-fun o9 () us_rep (mk___rep (mk___split_discrs o4) o5))
(assert (in_range c))
(assert (and (= us c) (in_range c)))
(assert (and (= d__attr__constrained true) (= (to_rep (rec__discr__with_default__c d__split_discrs)) c)))
(assert (and (= c (to_rep (rec__discr__with_default__c d__split_discrs))) (= d__attr__constrained true)))
(assert (= (to_rep o) c))
(assert (= o o1))
(assert (= o2 o1))
(assert (= true o3))
(assert (= o9 (mk___rep (mk___split_discrs o2) o3)))
(assert (= o8 o9))
(assert (= (mk___rep (mk___split_discrs temp___322) temp___3221) o8))
(assert (= d__split_discrs (mk___split_discrs temp___322)))
(assert (not (= c (to_rep rliteral))))
(check-sat)
(exit)
