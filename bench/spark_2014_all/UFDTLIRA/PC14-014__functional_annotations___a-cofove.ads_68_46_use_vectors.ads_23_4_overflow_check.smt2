...
(assert (=> (< last (- 1)) (= result true)))
(assert (=> (not (< last (- 1))) (and (= o last) (in_range2 last))))
(assert (=> (not (< last (- 1))) (= o1 (- o 2147483647))))
(assert (=> (not (< last (- 1))) (and (= o2 o1) (in_range2 o1))))
(assert (=> (not (< last (- 1))) (and (= o3 first) (in_range2 first))))
(assert (=> (not (< last (- 1))) (= result (ite (< o2 o3) true false))))
(assert (= result true))
(assert (and (= o4 first) (in_range2 first)))
(assert (and (= o5 last) (in_range2 last)))
(assert (= o6 (- o5 o4)))
