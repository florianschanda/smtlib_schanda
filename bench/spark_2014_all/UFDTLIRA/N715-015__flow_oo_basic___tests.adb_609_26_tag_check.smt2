...
(assert (= temp___489 (mk___rep1 (us_split_fields3 usq_4) f__attr__tag)))
(assert (= result5 (mk___split_fields__ref1 (mk___split_fields1 f__split_fields f__split_fields1 f__split_fields2))))
(assert (= f__split_fields3 (us_split_fields3 temp___489)))
(assert (= g__attr__tag (attr__tag1 (of_base (mk___rep (mk___split_fields (hide_ext__1 (rec__foo__nice_widget_t__round (us_split_fields5 (rec__tests__pair__b (us_split_fields7 c)))) (rec__foo__widget_t__x1 (us_split_fields5 (rec__tests__pair__b (us_split_fields7 c)))) (rec__foo__widget_t__y1 (us_split_fields5 (rec__tests__pair__b (us_split_fields7 c)))) (rec__ext__2 (us_split_fields5 (rec__tests__pair__b (us_split_fields7 c)))))) (attr__tag2 (rec__tests__pair__b (us_split_fields7 c))))))))
(assert (= usq_5 (of_base (mk___rep (mk___split_fields (hide_ext__1 (rec__foo__nice_widget_t__round (us_split_fields5 (rec__tests__pair__b (us_split_fields7 c)))) (rec__foo__widget_t__x1 (us_split_fields5 (rec__tests__pair__b (us_split_fields7 c)))) (rec__foo__widget_t__y1 (us_split_fields5 (rec__tests__pair__b (us_split_fields7 c)))) (rec__ext__2 (us_split_fields5 (rec__tests__pair__b (us_split_fields7 c)))))) (attr__tag2 (rec__tests__pair__b (us_split_fields7 c)))))))
(assert (= temp___491 (mk___rep1 (us_split_fields3 usq_5) g__attr__tag)))
(assert (= result6 (mk___split_fields__ref1 (mk___split_fields1 g__split_fields g__split_fields1 g__split_fields2))))
(assert (= g__split_fields3 (us_split_fields3 temp___491)))
(assert (not (= h__attr__tag (attr__tag1 (of_base (mk___rep (mk___split_fields (hide_ext__1 (rec__foo__nice_widget_t__round (us_split_fields5 nw)) (rec__foo__widget_t__x1 (us_split_fields5 nw)) (rec__foo__widget_t__y1 (us_split_fields5 nw)) (rec__ext__2 (us_split_fields5 nw)))) (attr__tag2 nw)))))))
(check-sat)
(exit)
