...
(declare-const prop__37 bool__ref)
(declare-const j37 int__ref)
(declare-const prop__38 Bool)
(declare-const j38 Int)
(define-fun j39 () int__ref (mk_int__ref j1))
(define-fun j40 () int__ref (mk_int__ref j))
(define-fun prop__39 () bool__ref (mk_bool__ref prop__))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i3 1))
(assert (=> (and (<= 1 i3) (<= i3 3)) (= temp___203 i3)))
(assert (=> (and (<= 1 i3) (<= i3 3)) (= temp___202 prop__)))
(assert (=> (and (<= 1 i3) (<= i3 3)) (= (mk_bool__ref result1) prop__39)))
(assert (=> (and (<= 1 i3) (<= i3 3)) (= prop__2 (distinct 0 0))))
(assert (=> (and (<= 1 i3) (<= i3 3)) (= (mk_int__ref result2) j40)))
...
(assert (=> (not (and (<= 1 i3) (<= i3 3))) (= j14 j40)))
(assert (=> (not (and (<= 1 i3) (<= i3 3))) (= i7 (mk_int__ref i3))))
(assert (=> (not (and (<= 1 i3) (<= i3 3))) (= prop__12 prop__39)))
...
(assert (=> (and (<= 1 i9) (<= i9 3)) (= result6 j39)))
...
(assert (=> (not (and (<= 1 i9) (<= i9 3))) (= j25 j39)))
...
(assert (<= 1 j34))
(assert (<= j34 10))
(assert (= prop__35 true))
(assert (and (=> (<= 1 10) (in_range6 j35)) (and (<= 1 j35) (<= j35 10))))
(assert (= result15 (mk_bool__ref prop__35)))
(assert (= prop__36 prop__35))
(assert (not (= j35 10)))
(assert (= result16 (mk_int__ref j35)))
(assert (= j36 (+ j35 1)))
(assert (= j37 (mk_int__ref j36)))
(assert (= prop__37 (mk_bool__ref prop__36)))
(assert (= j38 j36))
(assert (= prop__38 prop__36))
(assert (not (= (bool__content prop__37) true)))
(check-sat)
(exit)
