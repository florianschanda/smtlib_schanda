...
(declare-const temp___6655 et1)
(declare-const temp___66551 et2)
(declare-const o3 et2)
(declare-const o4 et1)
(declare-const o5 et2)
(declare-const temp___6657 et1)
(declare-const temp___66571 et2)
...
(assert (= temp___6655 o1))
(assert (= temp___66551 o2))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___6655 r__split_fields2))
(assert (= temp___66551 r__split_fields3))
(assert (= (to_rep1 o3) f))
(assert (= r__split_fields2 o4))
(assert (= o3 o5))
(assert (= temp___6657 o4))
(assert (= temp___66571 o5))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___6657 r__split_fields4))
(assert (= temp___66571 r__split_fields5))
...
(assert (not (= (to_rep1 r__split_fields7) f)))
(check-sat)
(exit)
