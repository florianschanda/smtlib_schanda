...
(define-fun default_initial_assumption1 ((temp___expr_273 us_rep1) (temp___skip_top_level_274 Bool)) Bool (= (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields3 temp___expr_273))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_228 us_rep1) (temp___skip_top_level_229 Bool)) Bool (= (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields3 temp___expr_228))) 0))
