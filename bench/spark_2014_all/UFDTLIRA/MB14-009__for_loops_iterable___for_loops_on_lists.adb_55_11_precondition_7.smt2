...
(assert (and (= o6 (next l temp___5471)) (ite (= (ite (= (bool_eq2 temp___5471 no_element) false) (= (get1 (positions l) temp___5471) (length1 l)) true) true) (= (bool_eq2 o6 no_element) true) (and (= (has_key (positions l) o6) true) (= (get1 (positions l) o6) (+ (get1 (positions l) temp___5471) 1))))))
(assert (and (= o5 (has_key (positions l) o6)) (= (= o5 true) (= (has_key (positions l) o6) true))))
