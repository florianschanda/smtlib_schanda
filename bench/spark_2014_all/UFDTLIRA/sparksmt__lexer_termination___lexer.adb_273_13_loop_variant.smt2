...
(assert (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs1)) 0))
(assert (= (to_rep (rec__file_io__read_result__c current_read__split_fields1)) 59))
(assert (and (and (= (local_invariant the_file2 current_read__split_fields2 current_read__split_discrs2 current_idx2 next_read__split_fields2 next_read__split_discrs2 next_idx2) true) (ite (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs2)) 0) (< current_idx1 current_idx2) (<= current_idx1 current_idx2))) (and (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1 current_idx2)) (in_range1 next_idx2))))
(assert (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs2)) 0))
(assert (and (= (local_invariant the_file3 current_read__split_fields3 current_read__split_discrs3 current_idx3 next_read__split_fields3 next_read__split_discrs3 next_idx3) true) (< current_idx current_idx3)))
(assert (and (and (and (in_range2 current_line3) (in_range1 current_col3)) (in_range1 current_idx3)) (in_range1 next_idx3)))
(assert (= result (mk_int__ref temp___1007)))
(assert (= temp___10071 current_idx3))
(assert (and (and (= (local_invariant the_file4 current_read__split_fields4 current_read__split_discrs4 current_idx4 next_read__split_fields4 next_read__split_discrs4 next_idx4) true) (<= current_idx3 current_idx4)) (and (and (and (in_range2 current_line4) (in_range1 current_col4)) (in_range1 current_idx4)) (in_range1 next_idx4))))
(assert (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs4)) 0))
(assert (= (to_rep (rec__file_io__read_result__c current_read__split_fields4)) 59))
(assert (and (and (= (local_invariant the_file5 current_read__split_fields5 current_read__split_discrs5 current_idx5 next_read__split_fields5 next_read__split_discrs5 next_idx5) true) (ite (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs5)) 0) (< current_idx4 current_idx5) (<= current_idx4 current_idx5))) (and (and (and (in_range2 current_line5) (in_range1 current_col5)) (in_range1 current_idx5)) (in_range1 next_idx5))))
(assert (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs5)) 0))
(assert (not (< temp___10071 current_idx5)))
(check-sat)
(exit)
