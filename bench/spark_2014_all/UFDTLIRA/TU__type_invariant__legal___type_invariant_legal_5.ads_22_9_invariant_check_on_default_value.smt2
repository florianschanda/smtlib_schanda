...
(define-fun dynamic_invariant ((temp___expr_160 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 0 2147483647)) (in_range1 temp___expr_160)))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const temp___163 Int)
(assert (in_range temp___163))
(assert (not (type_invariant temp___163)))
(check-sat)
(exit)
