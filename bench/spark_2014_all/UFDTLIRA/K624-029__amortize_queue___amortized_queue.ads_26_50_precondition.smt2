...
(assert (and (= o7 (length right)) (and (in_range2 o7) (<= o7 (capacity right)))))
(assert (= o8 (+ 1 o7)))
(assert (and (= o9 (length (vector__content amortized_queue__Oconcat__2__result5))) (and (in_range2 o9) (<= o9 (capacity (vector__content amortized_queue__Oconcat__2__result5))))))
(assert (= result4 (ite (= o9 o8) true false)))
(assert (= result4 true))
(assert (and (= o6 (get (model__ (vector__content amortized_queue__Oconcat__2__result5)) 1)) (and (in_range5 o6) (= o6 (get (model__ (vector__content amortized_queue__Oconcat__2__result5)) 1)))))
...
(assert (not (<= o5 (last (model__ right)))))
(check-sat)
(exit)
