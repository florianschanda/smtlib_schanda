...
(define-fun dynamic_invariant1 ((temp___expr_316 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool) (temp___do_typ_inv_315 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_316)))
...
(assert (forall ((a us_rep) (b us_rep)) (! (= (user_eq8 a b) (oeq1 a b)) :pattern ((user_eq8 a b)))))
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep (rec__replacement__inverse_sets__map__capacity (us_split_discrs1 container)))) (dynamic_invariant2 result true false true true))) :pattern ((length1 container)))))
...
(define-fun default_initial_assumption ((temp___expr_404 us_rep3) (temp___skip_top_level_405 Bool)) Bool (=> (not (= temp___skip_top_level_405 true)) (= (length temp___expr_404) 0)))
(assert (forall ((container us_rep3)) (forall ((key1 Int)) (! (=> (dynamic_invariant1 key1 true true true true) (let ((result (find container key1))) (and (=> (< 0 result) (and (<= result (length container)) (= (equivalent_keys key1 (get container result)) true))) (dynamic_invariant2 result true false true true)))) :pattern ((find container key1))))))
...
(define-fun default_initial_assumption1 ((temp___expr_368 us_rep4) (temp___skip_top_level_369 Bool)) Bool (=> (not (= temp___skip_top_level_369 true)) (and (= (is_empty temp___expr_368) true) (= (length2 temp___expr_368) 0))))
(assert true)
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (= (length result) (length1 container)) (forall ((temp___442 Int)) (=> (and (in_range5 temp___442) (= (iter_has_element result temp___442) true)) (= (has_key1 (model__ container) (get result temp___442)) true)))) (forall ((key1 Int)) (=> (and (in_range4 key1) (= (has_key1 (model__ container) key1) true)) (and (< 0 (find result key1)) (= (equivalent_keys (get result (find result key1)) key1) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (and (= (find result (get result i)) i) (= (k_is_find result (get result i) i) true)))))) :pattern ((keys container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_427 us_rep2) (temp___skip_top_level_428 Bool)) Bool (=> (not (= temp___skip_top_level_428 true)) (and (= (is_empty1 temp___expr_427) true) (= (length3 temp___expr_427) 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_353)))
(assert (forall ((container us_rep4)) (forall ((key1 Int)) (! (=> (dynamic_invariant3 key1 true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k1 Int)) (and (and (in_range4 k1) (= (has_key1 container k1) true)) (= (equivalent_keys k1 key1) true))) (= (has_key1 container key1) true)))) :pattern ((has_key1 container key1))))))
...
(define-fun dynamic_invariant4 ((temp___expr_360 Int) (temp___is_init_356 Bool) (temp___skip_constant_357 Bool) (temp___do_toplevel_358 Bool) (temp___do_typ_inv_359 Bool)) Bool (=> (or (= temp___is_init_356 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_360)))
(assert (forall ((container us_rep4)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant3 key1 true true true true) (= (has_key1 container key1) true)) (let ((result (get2 container key1))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key1))) (forall ((k1 Int)) (=> (and (in_range4 k1) (= (has_key1 container k1) true)) (= (= (equivalent_keys k1 key1) true) (= (witness container key1) (witness container k1))))))) (dynamic_invariant4 result true false true true)))) :pattern ((get2 container key1))))))
(assert (forall ((container us_rep4)) (! (dynamic_invariant2 (length2 container) true false true true) :pattern ((length2 container)))))
(assert (forall ((left us_rep4) (right us_rep4)) (! (= (= (oeq3 left right) true) (and (forall ((key1 Int)) (=> (and (in_range4 key1) (= (has_key1 left key1) true)) (and (= (has_key1 right key1) true) (= (get2 right key1) (get2 left key1))))) (forall ((key1 Int)) (=> (and (in_range4 key1) (= (has_key1 right key1) true)) (= (has_key1 left key1) true))))) :pattern ((oeq3 left right)))))
(assert (forall ((container us_rep4)) (! (= (= (is_empty container) true) (forall ((key1 Int)) (not (and (in_range4 key1) (= (has_key1 container key1) true))))) :pattern ((is_empty container)))))
(assert (forall ((left us_rep4) (right us_rep4)) (! (= (= (keys_included left right) true) (forall ((key1 Int)) (=> (and (in_range4 key1) (= (has_key1 left key1) true)) (= (has_key1 right key1) true)))) :pattern ((keys_included left right)))))
(assert (forall ((left us_rep4) (right us_rep4)) (forall ((new_key Int)) (! (=> (dynamic_invariant3 new_key true true true true) (= (= (elements_equal_except left right new_key) true) (forall ((key1 Int)) (=> (and (in_range4 key1) (= (has_key1 left key1) true)) (=> (not (= (equivalent_keys key1 new_key) true)) (and (= (has_key1 right key1) true) (= (get2 left key1) (get2 right key1)))))))) :pattern ((elements_equal_except left right new_key))))))
(declare-fun has_witness (us_rep4 Int) Bool)
(declare-fun has_witness__function_guard (Bool us_rep4 Int) Bool)
(assert true)
(assert (forall ((container us_rep4)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant3 key1 true true true true) (= (has_key1 container key1) true)) (let ((result (witness container key1))) (and (= (has_witness container result) true) (dynamic_invariant2 result true false true true)))) :pattern ((witness container key1))))))
(assert (forall ((container us_rep4)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant2 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant4 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
(define-fun dynamic_invariant5 ((temp___expr_396 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool) (temp___do_typ_inv_395 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 0 2147483647)) (in_range5 temp___expr_396)))
(assert (forall ((container us_rep3)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant2 result true false true true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant6 ((temp___expr_389 Int) (temp___is_init_385 Bool) (temp___skip_constant_386 Bool) (temp___do_toplevel_387 Bool) (temp___do_typ_inv_388 Bool)) Bool (=> (or (= temp___is_init_385 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_389)))
(assert (forall ((container us_rep3)) (forall ((position Int)) (! (=> (and (dynamic_invariant5 position true true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant6 (get container position) true false true true)) :pattern ((get container position))))))
...
(define-fun dynamic_invariant7 ((temp___expr_419 Int) (temp___is_init_415 Bool) (temp___skip_constant_416 Bool) (temp___do_toplevel_417 Bool) (temp___do_typ_inv_418 Bool)) Bool (=> (or (= temp___is_init_415 true) (<= 1 2147483647)) (in_range8 temp___expr_419)))
(assert (forall ((container us_rep2)) (forall ((key1 us_rep1)) (! (=> (= (has_key container key1) true) (let ((result (get1 container key1))) (and (=> (= (distinct 0 0) true) (and (= result (w_get1 container (witness1 container key1))) (forall ((k1 us_rep1)) (=> (= (has_key container k1) true) (= (= (bool_eq1 k1 key1) true) (= (witness1 container key1) (witness1 container k1))))))) (dynamic_invariant7 result true false true true)))) :pattern ((get1 container key1))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant2 (length3 container) true false true true) :pattern ((length3 container)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key1 us_rep1)) (! (=> (= (has_key container key1) true) (let ((result (witness1 container key1))) (and (= (has_witness1 container result) true) (dynamic_invariant2 result true false true true)))) :pattern ((witness1 container key1))))))
(assert (forall ((container us_rep2)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant2 witness2 true true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant7 (w_get1 container witness2) true false true true)) :pattern ((w_get1 container witness2))))))
