...
(assert (=> (= result3 true) (= o7 0)))
(assert (=> (not (= result3 true)) (and (= o6 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (= (length1 o6) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
(assert (=> (not (= result3 true)) (and (= o7 (get o6 i)) (in_range2 o7))))
