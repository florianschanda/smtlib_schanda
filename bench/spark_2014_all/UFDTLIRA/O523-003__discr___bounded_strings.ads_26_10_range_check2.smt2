...
(define-fun dynamic_invariant ((temp___expr_160 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 1 65536)) (in_range1 temp___expr_160)))
...
(declare-const temp___bound_211 Int)
(assert (in_range1 temp___bound_211))
(assert (<= 1 temp___bound_211))
(assert (not (<= 1 1)))
(check-sat)
(exit)
