...
(define-fun dynamic_invariant1 ((temp___expr_659 Int) (temp___is_init_655 Bool) (temp___skip_constant_656 Bool) (temp___do_toplevel_657 Bool) (temp___do_typ_inv_658 Bool)) Bool (=> (or (= temp___is_init_655 true) (<= 1 2147483647)) (in_range2 temp___expr_659)))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(declare-fun is_empty (us_rep2) Bool)
(declare-fun is_empty__function_guard (Bool us_rep2) Bool)
(define-fun default_initial_assumption ((temp___expr_667 us_rep2) (temp___skip_top_level_668 Bool)) Bool (=> (not (= temp___skip_top_level_668 true)) (and (= (is_empty temp___expr_667) true) (= (length1 temp___expr_667) 0))))
(define-fun default_initial_assumption1 ((temp___expr_653 us_rep1) (temp___skip_top_level_654 Bool)) Bool (= (to_rep (rec__instances__lists__cursor__node (us_split_fields3 temp___expr_653))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_608 us_rep1) (temp___skip_top_level_609 Bool)) Bool (= (to_rep (rec__instances__lists__cursor__node (us_split_fields3 temp___expr_608))) 0))
