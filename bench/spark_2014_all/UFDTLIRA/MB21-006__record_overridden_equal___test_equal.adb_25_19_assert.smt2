...
(assert (forall ((i my_int)) (and (<= 0 (my_intqtint i)) (<= (my_intqtint i) 7))))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__test_equal__my_int_mod__content my_int)))))
(define-fun us_split_fields_Content__projection ((a us_split_fields)) my_int (rec__test_equal__my_int_mod__content a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__test_equal__my_int_mod__content (us_split_fields1 a))) (to_rep (rec__test_equal__my_int_mod__content (us_split_fields1 b)))) true false))
...
(assert (< test_equal__my_int_mod__content__first__bit test_equal__my_int_mod__content__last__bit))
(assert (<= 0 test_equal__my_int_mod__content__position))
(declare-fun user_eq1 (us_rep us_rep) Bool)
(declare-const dummy1 us_rep)
(declare-datatypes () ((my_int_mod__ref (mk_my_int_mod__ref (my_int_mod__content us_rep)))))
(define-fun my_int_mod__ref___projection ((a my_int_mod__ref)) us_rep (my_int_mod__content a))
(declare-fun oeq (us_rep us_rep) Bool)
(declare-fun oeq__function_guard (Bool us_rep us_rep) Bool)
(assert (forall ((a us_rep) (b us_rep)) (! (= (user_eq1 a b) (oeq a b)) :pattern ((user_eq1 a b)))))
(assert true)
(assert (forall ((x us_rep) (y us_rep)) (! (= (= (oeq x y) true) (or (= (to_rep (rec__test_equal__my_int_mod__content (us_split_fields1 x))) (to_rep (rec__test_equal__my_int_mod__content (us_split_fields1 y)))) (ite (< (to_rep (rec__test_equal__my_int_mod__content (us_split_fields1 x))) (to_rep (rec__test_equal__my_int_mod__content (us_split_fields1 y)))) (= (- (to_rep (rec__test_equal__my_int_mod__content (us_split_fields1 y))) (to_rep (rec__test_equal__my_int_mod__content (us_split_fields1 x)))) 4) (= (- (to_rep (rec__test_equal__my_int_mod__content (us_split_fields1 x))) (to_rep (rec__test_equal__my_int_mod__content (us_split_fields1 y)))) 4)))) :pattern ((oeq x y)))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__test_equal__my_rec__content us_rep)))))
(define-fun us_split_fields_Content__2__projection ((a us_split_fields2)) us_rep (rec__test_equal__my_rec__content a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (user_eq1 (rec__test_equal__my_rec__content (us_split_fields3 a)) (rec__test_equal__my_rec__content (us_split_fields3 b))) true) true false))
...
(assert (< test_equal__my_rec__content__first__bit test_equal__my_rec__content__last__bit))
...
(assert (= content_x (mk___rep (mk___split_fields rliteral))))
(declare-const rliteral1 my_int)
(assert (= (my_intqtint rliteral1) 5))
(assert (= content_y (mk___rep (mk___split_fields rliteral1))))
(assert (= x (mk___rep1 (mk___split_fields1 content_x))))
(assert (= y (mk___rep1 (mk___split_fields1 content_y))))
(assert (= (mk___rep (mk___split_fields rliteral)) content_x))
(assert (= (mk___rep (mk___split_fields rliteral1)) content_y))
(assert (= (mk___rep1 (mk___split_fields1 content_x)) x))
(assert (= (mk___rep1 (mk___split_fields1 content_y)) y))
(assert (not (= (oeq content_x content_y) true)))
(check-sat)
(exit)
