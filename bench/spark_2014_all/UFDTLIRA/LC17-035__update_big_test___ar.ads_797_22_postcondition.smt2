...
(declare-const temp___6742 et3)
(declare-const temp___67421 et1)
(declare-const temp___67422 et2)
(declare-const temp___67423 enum1ta)
...
(declare-const temp___6745 et3)
(declare-const temp___67451 et1)
(declare-const temp___67452 et2)
(declare-const temp___67453 enum1ta)
...
(assert (= temp___6742 o5))
(assert (= temp___67421 o6))
(assert (= temp___67422 o7))
(assert (= temp___67423 o8))
...
(assert (= r__split_fields4 (mk___split_fields1 temp___6742 (mk___rep (mk___split_fields temp___67421 temp___67422)) temp___67423)))
(assert (= (to_rep1 o9) f))
...
(assert (= temp___6745 o14))
(assert (= temp___67451 o15))
(assert (= temp___67452 o16))
(assert (= temp___67453 o17))
(assert (= result1 (mk___split_fields__ref1 r__split_fields4)))
(assert (= r__split_fields5 (mk___split_fields1 temp___6745 (mk___rep (mk___split_fields temp___67451 temp___67452)) temp___67453)))
