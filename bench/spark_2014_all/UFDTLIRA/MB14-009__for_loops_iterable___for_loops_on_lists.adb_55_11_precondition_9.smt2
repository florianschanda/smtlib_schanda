...
(define-fun dynamic_invariant1 ((temp___expr_250 Int) (temp___is_init_246 Bool) (temp___skip_constant_247 Bool) (temp___do_toplevel_248 Bool) (temp___do_typ_inv_249 Bool)) Bool (=> (or (= temp___is_init_246 true) (<= 0 2147483647)) (in_range3 temp___expr_250)))
...
(define-fun dynamic_invariant2 ((temp___expr_257 Int) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool) (temp___do_typ_inv_256 Bool)) Bool (=> (or (= temp___is_init_253 true) (<= 0 2147483647)) (in_range4 temp___expr_257)))
...
(define-fun dynamic_invariant3 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 2147483647)) (in_range6 temp___expr_214)))
...
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= result (to_rep (rec__for_loops_on_lists__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant5 result true false true true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant6 ((temp___expr_279 Int) (temp___is_init_275 Bool) (temp___skip_constant_276 Bool) (temp___do_toplevel_277 Bool) (temp___do_typ_inv_278 Bool)) Bool (=> (or (= temp___is_init_275 true) (<= 1 2147483647)) (in_range7 temp___expr_279)))
...
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant5 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant6 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
(declare-const count_0 Int)
(declare-const count_1 Int)
(declare-const e Int)
(declare-const o count_type)
(declare-const temp___547 count_type)
...
(declare-const temp___5471 us_rep2)
(declare-const result6 int__ref)
(declare-const count_13 Int)
(define-fun o4 () us_rep2 (mk___rep1 (mk___split_fields1 o)))
...
(assert (and (= o4 (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq2 o4 no_element) true) (and (= (has_key (positions l) o4) true) (= (get1 (positions l) o4) 1)))))
(assert (= temp___547 o))
(assert (and (= result2 (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___547)))) (= (= result2 true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___547))) true))))
(assert (=> (= result2 true) (and (= o1 (element l (mk___rep1 (mk___split_fields1 temp___547)))) (and (in_range6 o1) (= o1 (get (model__ l) (get1 (positions l) (mk___rep1 (mk___split_fields1 temp___547)))))))))
...
(assert (and (= result4 (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___547)))) (= (= result4 true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___547))) true))))
(assert (= result4 true))
(assert (=> (= e2 0) (and (= o2 (+ count_01 1)) (in_range1 (+ count_01 1)))))
(assert (=> (= e2 0) (= result5 (mk_int__ref count_01))))
(assert (=> (= e2 0) (= count_02 o2)))
(assert (=> (not (= e2 0)) (= count_02 count_01)))
(assert (=> (< 0 count_03) (exists ((cu us_rep2)) (and (= (has_key (positions l) cu) true) (= (element l cu) 0)))))
(assert (=> (< 0 count_12) (exists ((cu us_rep2)) (and (= (has_key (positions l) cu) true) (= (element l cu) 1)))))
(assert (and (and (and (=> (<= 0 2147483647) (in_range2 count_03)) (=> (<= 0 2147483647) (in_range2 count_12))) (=> (<= 0 2147483647) (in_range6 e3))) (and (= (has_key (positions l) temp___5471) true) (= e3 (element l temp___5471)))))
(assert (=> (= e3 1) (and (= o3 (+ count_12 1)) (in_range1 (+ count_12 1)))))
(assert (=> (= e3 1) (= result6 (mk_int__ref count_12))))
(assert (=> (= e3 1) (= count_13 o3)))
(assert (=> (not (= e3 1)) (= count_13 count_12)))
(assert (not (or (= (has_key (positions l) temp___5471) true) (= (bool_eq2 temp___5471 no_element) true))))
(check-sat)
(exit)
