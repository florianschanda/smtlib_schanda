...
(define-fun dynamic_invariant ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 100)) (in_range1 temp___expr_249)))
...
(assert (forall ((i1 extended_index1)) (and (<= 0 (extended_indexqtint1 i1)) (<= (extended_indexqtint1 i1) 100))))
...
(assert (forall ((i1 element_type)) (and (<= 1 (element_typeqtint i1)) (<= (element_typeqtint i1) 100))))
