...
(assert (and (= o (length s)) (and (in_range1 o) (<= o (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 s)))))))
(assert (= o1 (ite (<= i o) true false)))
(assert (= result (ite (<= 1 i) o1 false)))
(assert (= result true))
(assert (and (= o2 (elements s)) (and (and (and (= (length1 o2) (length s)) (forall ((temp___432 Int)) (=> (and (in_range3 temp___432) (= (iter_has_element o2 temp___432) true)) (= (contains (model__ s) (get o2 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ s) item) true)) (and (< 0 (find o2 item)) (= (equivalent_elements (get o2 (find o2 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o2 (get o2 i1)) i1) (= (e_is_find o2 (get o2 i1) i1) true)))))))
