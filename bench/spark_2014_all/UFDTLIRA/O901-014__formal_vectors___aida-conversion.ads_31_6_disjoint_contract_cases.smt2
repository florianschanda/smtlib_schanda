...
(assert (not (<= (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ 0 (ite (= (= source 48) true) 1 0)) (ite (= (= source 49) true) 1 0)) (ite (= (= source 50) true) 1 0)) (ite (= (= source 51) true) 1 0)) (ite (= (= source 52) true) 1 0)) (ite (= (= source 53) true) 1 0)) (ite (= (= source 54) true) 1 0)) (ite (= (= source 55) true) 1 0)) (ite (= (= source 56) true) 1 0)) (ite (= (= source 57) true) 1 0)) 1)))
(check-sat)
(exit)
