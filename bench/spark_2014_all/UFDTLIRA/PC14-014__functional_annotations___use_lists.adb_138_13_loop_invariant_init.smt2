...
(define-fun current__split_fields2 () us_split_fields2 (mk___split_fields1 current__split_fields1))
...
(assert (not (= (bool_eq2 (mk___rep1 current__split_fields2) (mk___rep1 n_last__split_fields3)) true)))
(declare-const i Int)
(assert (<= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) fst) i))
(assert (<= i (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 current__split_fields2)) 1)))
