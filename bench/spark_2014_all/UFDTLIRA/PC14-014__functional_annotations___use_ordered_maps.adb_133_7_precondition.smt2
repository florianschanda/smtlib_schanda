...
(define-fun m__split_fields2 () us_split_fields (mk___split_fields m__split_fields1))
...
(assert (and (and (and (and (and (and (and (and (= (length (mk___rep m__split_discrs m__split_fields2)) (+ (length (mk___rep m__split_discrs (mk___split_fields m__split_fields))) 1)) (= (has_key (model__ (mk___rep m__split_discrs m__split_fields2)) 1) true)) (= (get1 (keys (mk___rep m__split_discrs m__split_fields2)) (find (keys (mk___rep m__split_discrs m__split_fields2)) 1)) 1)) (= (get (model__ (mk___rep m__split_discrs m__split_fields2)) 1) 0)) (= (ole (model__ (mk___rep m__split_discrs (mk___split_fields m__split_fields))) (model__ (mk___rep m__split_discrs m__split_fields2))) true)) (= (keys_included_except (model__ (mk___rep m__split_discrs m__split_fields2)) (model__ (mk___rep m__split_discrs (mk___split_fields m__split_fields))) 1) true)) (= (range_equal (keys (mk___rep m__split_discrs (mk___split_fields m__split_fields))) (keys (mk___rep m__split_discrs m__split_fields2)) 1 (- (find (keys (mk___rep m__split_discrs m__split_fields2)) 1) 1)) true)) (= (range_shifted (keys (mk___rep m__split_discrs (mk___split_fields m__split_fields))) (keys (mk___rep m__split_discrs m__split_fields2)) (find (keys (mk___rep m__split_discrs m__split_fields2)) 1) (length (mk___rep m__split_discrs (mk___split_fields m__split_fields))) 1) true)) (= (p_positions_shifted (positions (mk___rep m__split_discrs (mk___split_fields m__split_fields))) (positions (mk___rep m__split_discrs m__split_fields2)) (find (keys (mk___rep m__split_discrs m__split_fields2)) 1) 1) true)))
(assert (not (not (= (has_key (model__ (mk___rep m__split_discrs m__split_fields2)) 2) true))))
(check-sat)
(exit)
