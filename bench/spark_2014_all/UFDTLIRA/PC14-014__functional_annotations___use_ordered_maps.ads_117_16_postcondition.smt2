...
(define-fun dynamic_invariant4 ((temp___expr_323 Int) (temp___is_init_319 Bool) (temp___skip_constant_320 Bool) (temp___do_toplevel_321 Bool) (temp___do_typ_inv_322 Bool)) Bool (=> (or (= temp___is_init_319 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_323)))
...
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (dynamic_invariant6 key true true true true) (let ((result (find container key))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (equivalent_keys key (get container result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container key))))))
