...
(assert (not (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 current__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) lst))))
(check-sat)
(exit)
