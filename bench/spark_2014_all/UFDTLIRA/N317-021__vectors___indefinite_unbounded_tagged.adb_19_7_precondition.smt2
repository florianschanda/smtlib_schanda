...
(define-fun o6 () us_rep1 (mk___rep1 (mk___split_fields1 o o1) o2))
...
(assert (and (= o6 (f 1)) (and (and (= (of_rep1 1) o) (= us_null_ext__ o1)) (= us_tag o2))))
...
(assert (and (= (mk___rep1 (mk___split_fields1 o3 o4) o5) (f 2)) (and (and (= (of_rep1 2) o3) (= us_null_ext__ o4)) (= us_tag o5))))
