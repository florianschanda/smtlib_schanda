...
(assert (= idx1 r23b))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (= temp___560 idx1)))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (and (= result____split_discrs (mk___split_discrs temp___559)) (= temp___5591 result____split_fields1))))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (and (= o1 idx1) (in_range4 idx1))))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (and (= o2 (get (model__ right) o1)) (and (in_range5 o2) (= o2 (get (model__ right) o1))))))
...
(assert (and (= o3 (length right)) (and (in_range2 o3) (<= o3 (capacity right)))))
(assert (= o4 (+ 1 o3)))
(assert (and (= o5 (length (vector__content amortized_queue__Oconcat__2__result5))) (and (in_range2 o5) (<= o5 (capacity (vector__content amortized_queue__Oconcat__2__result5))))))
(assert (= result4 (ite (= o5 o4) true false)))
(assert (= result4 true))
(assert (not (<= 1 (last (model__ (vector__content amortized_queue__Oconcat__2__result5))))))
(check-sat)
(exit)
