...
(assert (= (bool_eq1 (mk___rep1 c_pu1__split_discrs (mk___split_fields1 c_pu1__split_fields c_pu1__split_fields1 c_pu1__split_fields2) c_pu1__attr__tag) (mk___rep1 c_pu2__split_discrs (mk___split_fields1 c_pu2__split_fields c_pu2__split_fields1 c_pu2__split_fields2) c_pu2__attr__tag)) true))
(assert (not (not (= (ite (= r_pu1__attr__tag c_pu1__attr__tag) (us_dispatch_eq (mk___rep r_pu1__split_discrs (mk___split_fields r_pu1__split_fields r_pu1__split_fields1) r_pu1__attr__tag) (mk___rep c_pu1__split_discrs (mk___split_fields c_pu1__split_fields1 (hide_ext__ c_pu1__split_fields c_pu1__split_fields2)) c_pu1__attr__tag)) false) true))))
(check-sat)
(exit)
