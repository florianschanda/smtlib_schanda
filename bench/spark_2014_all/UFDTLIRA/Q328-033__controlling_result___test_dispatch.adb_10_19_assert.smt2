...
(assert (forall ((us_void_param tuple0)) (! (= (init us_void_param) (mk___rep (mk___split_fields rliteral us_null_ext__) us_tag)) :pattern ((init us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (= (init2 us_void_param) (mk___rep1 (mk___split_fields1 rliteral1 rliteral1 us_null_ext__) us_tag1)) :pattern ((init2 us_void_param)))))
