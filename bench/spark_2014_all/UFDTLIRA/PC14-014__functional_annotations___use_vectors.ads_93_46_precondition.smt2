...
(assert (and (= o12 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))))) (and (dynamic_property4 first3 last5 o12) (= o12 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))))))))
...
(assert (= (= o15 true) (forall ((j2 Int)) (=> (and (<= (+ i 7) j2) (<= j2 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8)))))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))) j2) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (- j2 7)))))))
...
(assert (= o10 j))
(assert (not (<= o10 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8)))))))
(check-sat)
(exit)
