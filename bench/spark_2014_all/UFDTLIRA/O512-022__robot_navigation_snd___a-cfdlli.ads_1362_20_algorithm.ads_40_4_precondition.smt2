...
(define-fun dynamic_invariant1 ((temp___expr_521 Int) (temp___is_init_517 Bool) (temp___skip_constant_518 Bool) (temp___do_toplevel_519 Bool) (temp___do_typ_inv_520 Bool)) Bool (=> (or (= temp___is_init_517 true) (<= 1 2147483647)) (in_range2 temp___expr_521)))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(declare-fun is_empty (us_rep2) Bool)
(declare-fun is_empty__function_guard (Bool us_rep2) Bool)
(define-fun default_initial_assumption ((temp___expr_529 us_rep2) (temp___skip_top_level_530 Bool)) Bool (=> (not (= temp___skip_top_level_530 true)) (and (= (is_empty temp___expr_529) true) (= (length1 temp___expr_529) 0))))
(define-fun default_initial_assumption1 ((temp___expr_515 us_rep1) (temp___skip_top_level_516 Bool)) Bool (= (to_rep (rec__algorithm__gap_vectors__cursor__node (us_split_fields3 temp___expr_515))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_466 us_rep1) (temp___skip_top_level_467 Bool)) Bool (= (to_rep (rec__algorithm__gap_vectors__cursor__node (us_split_fields3 temp___expr_466))) 0))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep (rec__algorithm__gap_vectors__list__capacity (us_split_discrs1 container)))))))
