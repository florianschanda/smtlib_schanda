...
(assert (and (= o6 (last1 left)) (and (dynamic_property1 first1 last2 o6) (= o6 (+ (- first 1) (length left))))))
(assert (= result (ite (<= lst1 o6) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o4 first) (in_range3 first))))
...
(assert (= result1 true))
(assert (<= fst1 lst1))
(assert (and (= o3 lst1) (in_range3 lst1)))
