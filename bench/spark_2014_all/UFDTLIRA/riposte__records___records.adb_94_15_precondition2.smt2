...
(assert (<= (+ (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) 1) (- 255 (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))))
(assert (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b))))))
