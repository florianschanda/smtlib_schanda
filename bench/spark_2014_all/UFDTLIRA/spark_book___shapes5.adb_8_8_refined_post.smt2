...
(assert (=> (<= (- 100 y) r3) (and (= o2 (- 100 y)) (in_range3 (- 100 y)))))
(assert (=> (<= (- 100 y) r3) (= r3 result3)))
(assert (=> (<= (- 100 y) r3) (= r4 o2)))
(assert (=> (not (<= (- 100 y) r3)) (= r4 r3)))
(assert (=> (<= (- y (- 100)) r4) (and (= o3 (- y (- 100))) (in_range3 (- y (- 100))))))
...
(assert (= r7 r5))
(assert (not (in_range2 (- (to_rep (rec__shapes5__circle__center_x (us_split_fields1 (circle__content shapes5__make_circle__result10)))) (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 (circle__content shapes5__make_circle__result10))))))))
(check-sat)
(exit)
