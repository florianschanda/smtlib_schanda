...
(assert (= j1 1))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= temp___201 j1)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= temp___200 prop__1)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= prop__2 true)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (and (=> (<= 1 10) (in_range2 j2)) (and (<= 1 j2) (<= j2 10)))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= prop__2 result3)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= prop__3 (distinct 1 0))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= j2 10)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= j2 j3)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= prop__3 prop__4)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= j4 j2)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= prop__5 prop__3)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= (mk_int__ref j5) (mk_int__ref j3))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= (mk_bool__ref prop__6) (mk_bool__ref prop__4))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= j6 j4)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= prop__7 prop__5)))
(assert (=> (not (and (<= 1 j1) (<= j1 10))) (= j1 j5)))
(assert (=> (not (and (<= 1 j1) (<= j1 10))) (= prop__1 prop__6)))
(assert (=> (not (and (<= 1 j1) (<= j1 10))) (= j6 j1)))
(assert (=> (not (and (<= 1 j1) (<= j1 10))) (= prop__7 prop__1)))
(assert (and (=> (<= 1 3) (in_range1 i2)) (and (<= 1 i2) (<= i2 3))))
(assert (not (= i2 3)))
(assert (= result4 i2))
(assert (= i3 (+ i2 1)))
(assert (= result5 (mk_bool__ref prop__8)))
(assert (= prop__9 (distinct 0 0)))
(assert (= result6 (mk_int__ref j7)))
(assert (= j8 1))
(assert (<= 1 j8))
(assert (<= j8 10))
(assert (not (= prop__9 true)))
(check-sat)
(exit)
