...
(define-fun o23 () us_rep (mk___rep (mk___split_discrs o12) (mk___split_fields o13 o14 o15 o16)))
(define-fun o24 () us_rep (mk___rep (mk___split_discrs o7) (mk___split_fields o8 o9 o10 o11)))
...
(assert (= true o5))
(assert (= dummy1 o6))
(assert (= o24 (mk___rep (mk___split_discrs o2) (mk___split_fields o3 o4 o5 o6))))
(assert (= o23 o24))
...
(assert (= z__split_discrs (mk___split_discrs temp___198)))
(assert (not (= (to_rep (rec__basic__r__a_field z__split_fields5)) (+ (to_rep (rec__basic__r__a_field (us_split_fields1 v))) 1))))
(check-sat)
(exit)
