...
(define-fun dynamic_invariant ((temp___expr_406 Int) (temp___is_init_402 Bool) (temp___skip_constant_403 Bool) (temp___do_toplevel_404 Bool) (temp___do_typ_inv_405 Bool)) Bool (=> (or (= temp___is_init_402 true) (<= 1 2147483647)) (in_range4 temp___expr_406)))
...
(define-fun dynamic_invariant1 ((temp___expr_413 Int) (temp___is_init_409 Bool) (temp___skip_constant_410 Bool) (temp___do_toplevel_411 Bool) (temp___do_typ_inv_412 Bool)) Bool (=> (or (= temp___is_init_409 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_413)))
...
(define-fun dynamic_invariant2 ((temp___expr_420 Int) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool (=> (or (= temp___is_init_416 true) (<= 0 2147483647)) (in_range6 temp___expr_420)))
(assert (forall ((container us_rep)) (forall ((item Int) (index Int)) (! (=> (and (dynamic_invariant1 item true true true true) (dynamic_invariant index true true true true)) (let ((result (find_index container item index))) (and (ite (or (< (last_index container) index) (not (= (contains (model__ container) index (last_index container) item) true))) (= result 0) (and (and (and (<= index result) (<= result (last_index container))) (= (get (model__ container) result) item)) (not (= (contains (model__ container) index (- result 1) item) true)))) (dynamic_invariant2 result true false true true)))) :pattern ((find_index container item index))))))
...
(define-fun dynamic_invariant3 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 2147483647)) (in_range7 temp___expr_228)))
...
(define-fun dynamic_invariant4 ((temp___expr_235 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= (- 2147483648) 2147483647)) (in_range8 temp___expr_235)))
...
(define-fun dynamic_invariant5 ((temp___expr_269 us_rep1) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool) (temp___do_typ_inv_268 Bool)) Bool (in_range2 (to_rep1 (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 temp___expr_269))) (rec__hnco__test2__v_type_owner__vector_type__hidden_vector (us_split_fields3 temp___expr_269))))
...
(define-fun dynamic_invariant7 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 2147483647)) (in_range temp___expr_249)))
(define-fun dynamic_invariant8 ((temp___expr_256 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= 0 2147483647)) (in_range1 temp___expr_256)))
...
(assert (in_range8 item))
(assert (in_range7 index))
