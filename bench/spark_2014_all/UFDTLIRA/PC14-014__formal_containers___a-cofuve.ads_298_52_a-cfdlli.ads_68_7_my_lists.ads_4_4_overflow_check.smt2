...
(define-fun dynamic_invariant2 ((temp___expr_243 Int) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool (=> (or (= temp___is_init_239 true) (<= 1 2147483647)) (in_range4 temp___expr_243)))
...
(define-fun dynamic_invariant3 ((temp___expr_250 Int) (temp___is_init_246 Bool) (temp___skip_constant_247 Bool) (temp___do_toplevel_248 Bool) (temp___do_typ_inv_249 Bool)) Bool (=> (or (= temp___is_init_246 true) (<= 1 2147483647)) (in_range5 temp___expr_250)))
