...
(assert (not (= (bool_eq1 (mk___rep1 (mk___split_fields1 r__split_fields8 (mk___rep (mk___split_fields r__split_fields9 r__split_fields10)) r__split_fields11)) (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields (rec__ar__rec1t__f1 (us_split_fields1 a)) (rec__ar__rec1t__g1 (us_split_fields1 a)))) r__split_fields3))) true)))
(check-sat)
(exit)
