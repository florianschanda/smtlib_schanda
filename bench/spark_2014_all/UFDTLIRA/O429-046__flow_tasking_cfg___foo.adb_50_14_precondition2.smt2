...
(assert (= po_1__split_fields1 (mk___split_fields1 (rec__foo__thing__a (us_split_fields1 us_self__compl4)) (rec__foo__thing__x (us_split_fields1 us_self__compl4)))))
...
(assert (= o7 o10))
(assert (= o8 o11))
(assert (= o12 (p_func (mk___rep (mk___split_discrs o9) (mk___split_fields o10 o11)))))
...
(assert (= o16 (mk___rep (mk___split_discrs o13) (mk___split_fields o14 o15))))
