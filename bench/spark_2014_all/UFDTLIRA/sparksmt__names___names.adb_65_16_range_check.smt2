...
(assert (<= 1 (last (model__ (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))))))
(assert (not (<= (last (model__ (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields)))) 2147483647)))
(check-sat)
(exit)
