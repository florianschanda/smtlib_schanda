...
(assert (forall ((i Int)) (=> (and (<= first4 i) (<= i (- fst1 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields4)) i) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i)))))
(assert (forall ((i Int)) (=> (and (<= current2 i) (<= i (last2 (model__ (mk___rep v__split_discrs v__split_fields4))))) (= (get (model__ (mk___rep v__split_discrs v__split_fields4)) i) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i)))))
