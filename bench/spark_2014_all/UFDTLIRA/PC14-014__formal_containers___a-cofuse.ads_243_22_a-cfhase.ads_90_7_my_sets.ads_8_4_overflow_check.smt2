...
(define-fun default_initial_assumption ((temp___expr_387 us_rep) (temp___skip_top_level_388 Bool)) Bool (=> (not (= temp___skip_top_level_388 true)) (= (is_empty temp___expr_387) true)))
...
(define-fun dynamic_invariant1 ((temp___expr_379 Int) (temp___is_init_375 Bool) (temp___skip_constant_376 Bool) (temp___do_toplevel_377 Bool) (temp___do_typ_inv_378 Bool)) Bool (=> (or (= temp___is_init_375 true) (<= 1 2147483647)) (in_range3 temp___expr_379)))
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range3 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
