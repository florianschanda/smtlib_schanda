...
(assert (=> (= (distinct 1 0) true) (<= capacity (to_rep1 (rec__hnco__test2__v_type_owner__vector_type__capacity container__split_discrs)))))
(assert (= (to_rep1 (rec__hnco__test2__v_type_owner__vector_type__capacity container__split_discrs)) r210s))
(assert (in_range1 r210s))
(assert (and (= us r210s) (in_range2 r210s)))
(assert (= (distinct 1 0) true))
(assert (not (<= capacity (to_rep container__split_fields))))
(check-sat)
(exit)
