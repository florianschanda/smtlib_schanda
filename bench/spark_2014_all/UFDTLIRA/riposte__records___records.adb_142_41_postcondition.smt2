...
(assert (= (distinct 0 0) dst__split_fields6))
...
(assert (not (= (bool_eq1 (mk___rep1 (mk___split_fields1 dst__split_fields9 (mk___rep (mk___split_fields dst__split_fields10 dst__split_fields11)))) src) true)))
(check-sat)
(exit)
