...
(define-fun dynamic_invariant ((temp___expr_589 Int) (temp___is_init_585 Bool) (temp___skip_constant_586 Bool) (temp___do_toplevel_587 Bool) (temp___do_typ_inv_588 Bool)) Bool (=> (or (= temp___is_init_585 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_589)))
