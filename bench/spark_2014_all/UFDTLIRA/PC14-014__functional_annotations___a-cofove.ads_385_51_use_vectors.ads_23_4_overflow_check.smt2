...
(assert (= last5 last1))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ (- first 1) result) last1) (dynamic_invariant3 result true false true true))) :pattern ((length1 container)))))
...
(assert (=> (not (= before no_index)) (and (= o4 (last2 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (dynamic_property3 first2 last4 o4) (= o4 (last2 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))))
...
(assert (and (= o2 (last2 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (dynamic_property3 first2 last4 o2) (= o2 (last2 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))))))
(assert (= o3 (ite (<= before o2) true false)))
(assert (= o7 (ite (<= first1 before) o3 false)))
