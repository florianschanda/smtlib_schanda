...
(assert (and (= o2 (+ (to_rep1 (rec__ints__approx_int__precision (us_split_fields3 arg1))) (to_rep1 (rec__ints__approx_int__precision (us_split_fields3 arg2))))) (in_range (+ (to_rep1 (rec__ints__approx_int__precision (us_split_fields3 arg1))) (to_rep1 (rec__ints__approx_int__precision (us_split_fields3 arg2)))))))
(assert (and (= o (- (to_rep (rec__ints__int__value1 (us_split_fields3 arg1))) (to_rep (rec__ints__int__value1 (us_split_fields3 arg2))))) (in_range (- (to_rep (rec__ints__int__value1 (us_split_fields3 arg1))) (to_rep (rec__ints__int__value1 (us_split_fields3 arg2)))))))
(assert (= o1 (abs o)))
