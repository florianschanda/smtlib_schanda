...
(define-fun default_initial_assumption1 ((temp___expr_595 us_rep1) (temp___skip_top_level_596 Bool)) Bool (= (attr__tag1 temp___expr_595) us_tag1))
...
(define-fun arg__split_fields16 () us_split_fields (mk___split_fields arg__split_fields4 arg__split_fields5 arg__split_fields6 arg__split_fields7))
(assert (< (to_rep arg__split_fields2) (- (to_rep arg__split_fields1) 10)))
(assert (and (< (to_rep arg__split_fields2) (to_rep arg__split_fields6)) (bump__specific_post arg__attr__tag arg__split_fields16 arg__attr__tag (mk___split_fields arg__split_fields arg__split_fields1 arg__split_fields2 arg__split_fields3))))
(assert (= arg__split_fields8 arg__split_fields4))
(assert (= arg__split_fields9 arg__split_fields5))
(assert (= arg__split_fields10 arg__split_fields6))
(assert (= arg__split_fields11 arg__split_fields7))
(assert (= (mk___split_fields arg__split_fields12 arg__split_fields13 arg__split_fields14 arg__split_fields15) arg__split_fields16))
(assert (not (< (to_rep arg__split_fields2) (to_rep arg__split_fields10))))
(check-sat)
(exit)
