...
(define-fun dynamic_invariant ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 0 2)) (in_range2 temp___expr_158)))
...
(define-fun in_range3 ((rec__definite__t__d1 Int) (a us_rep)) Bool (= rec__definite__t__d1 (to_rep (rec__definite__t__d (us_split_discrs1 a)))))
...
(declare-datatypes () ((t33b__ref (mk_t33b__ref (t33b__content us_rep)))))
(define-fun t33b__ref___projection ((a t33b__ref)) us_rep (t33b__content a))
(declare-const r35b Int)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(define-fun in_range4 ((rec__definite__t__d1 Int) (a us_rep)) Bool (= rec__definite__t__d1 (to_rep (rec__definite__t__d (us_split_discrs1 a)))))
...
(declare-datatypes () ((t36b__ref (mk_t36b__ref (t36b__content us_rep)))))
(define-fun t36b__ref___projection ((a t36b__ref)) us_rep (t36b__content a))
(declare-const r38b Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(define-fun in_range5 ((rec__definite__t__d1 Int) (a us_rep)) Bool (= rec__definite__t__d1 (to_rep (rec__definite__t__d (us_split_discrs1 a)))))
...
(declare-datatypes () ((t39b__ref (mk_t39b__ref (t39b__content us_rep)))))
(define-fun t39b__ref___projection ((a t39b__ref)) us_rep (t39b__content a))
...
(declare-const temp___231 status)
(declare-const temp___2311 natural)
(declare-const temp___2312 natural)
(declare-const temp___2313 Bool)
(declare-const temp___2314 Bool)
(declare-const result Int)
(declare-const y1 Int)
(assert (=> (<= 0 2) (in_range2 y)))
(assert (= result y))
(assert (= y1 (to_rep x__split_discrs)))
(assert (= y1 0))
(assert (= (to_rep x__split_discrs) r32b))
(assert (in_range2 r32b))
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___231 o1))
(assert (= rliteral temp___2311))
(assert (= rliteral temp___2312))
(assert (= true temp___2313))
(assert (= true temp___2314))
(assert (= x__attr__constrained true))
(assert (not (= temp___231 x__split_discrs)))
(check-sat)
(exit)
