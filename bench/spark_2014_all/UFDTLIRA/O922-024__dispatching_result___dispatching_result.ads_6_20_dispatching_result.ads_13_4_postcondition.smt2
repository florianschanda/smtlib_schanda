...
(define-fun dispatching_result__init__2__result24 () us_rep1 (mk___rep1 (mk___split_fields1 dispatching_result__init__2__result4 dispatching_result__init__2__result5 dispatching_result__init__2__result6) dispatching_result__init__2__result7))
...
(assert (= (mk___rep1 (mk___split_fields1 dispatching_result__init__2__result12 dispatching_result__init__2__result13 dispatching_result__init__2__result14) dispatching_result__init__2__result15) dispatching_result__init__2__result24))
(assert (= (to_rep o) v))
(assert (= (to_rep o1) v))
(assert (= o1 o2))
(assert (= o o3))
...
(assert (= dispatching_result__init__2__result24 (mk___rep1 (mk___split_fields1 o5 o6 o7) o8)))
