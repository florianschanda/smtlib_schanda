...
(declare-fun user_eq1 (readerstatet readerstatet) Bool)
(declare-const dummy1 readerstatet)
...
(define-fun dynamic_invariant1 ((temp___expr_1640 Int) (temp___is_init_1636 Bool) (temp___skip_constant_1637 Bool) (temp___do_toplevel_1638 Bool) (temp___do_typ_inv_1639 Bool)) Bool (=> (or (= temp___is_init_1636 true) (<= 0 6)) (in_range2 temp___expr_1640)))
(assert (in_range1 readerstate))
(assert (<= 0 readerstate))
(assert (<= readerstate 6))
(assert (not (in_range2 readerstate)))
(check-sat)
(exit)
