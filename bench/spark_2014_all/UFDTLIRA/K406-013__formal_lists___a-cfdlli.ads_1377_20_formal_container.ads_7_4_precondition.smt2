...
(define-fun default_initial_assumption1 ((temp___expr_273 us_rep) (temp___skip_top_level_274 Bool)) Bool (= (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields1 temp___expr_273))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_228 us_rep) (temp___skip_top_level_229 Bool)) Bool (= (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields1 temp___expr_228))) 0))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
