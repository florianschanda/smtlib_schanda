...
(assert (not (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i) (ite (<= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i) threshold) 0 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)))))
(check-sat)
(exit)
