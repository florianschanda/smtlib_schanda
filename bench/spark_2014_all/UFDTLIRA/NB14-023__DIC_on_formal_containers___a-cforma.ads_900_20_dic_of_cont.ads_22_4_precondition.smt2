...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__dic_of_cont__my_orma__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__dic_of_cont__my_orma__cursor__node count_type)))))
(define-fun us_split_fields_Node__4__projection ((a us_split_fields2)) count_type (rec__dic_of_cont__my_orma__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__dic_of_cont__my_orma__cursor__node (us_split_fields3 a))) (to_rep (rec__dic_of_cont__my_orma__cursor__node (us_split_fields3 b)))) true false))
...
(assert (< dic_of_cont__my_orma__cursor__node__first__bit dic_of_cont__my_orma__cursor__node__last__bit))
...
(define-fun cursor__ref___4__projection ((a cursor__ref)) us_rep1 (cursor__content a))
(declare-datatypes () ((key_type__ref (mk_key_type__ref (key_type__content us_rep1)))))
(define-fun key_type__ref___8__projection ((a key_type__ref)) us_rep1 (key_type__content a))
...
(define-fun map__ref___8__projection ((a map__ref1)) us_rep2 (map__content1 a))
...
(define-fun element_type__ref___15__projection ((a element_type__ref)) element_type (element_type__content a))
(define-fun dynamic_invariant1 ((temp___expr_1240 Int) (temp___is_init_1236 Bool) (temp___skip_constant_1237 Bool) (temp___do_toplevel_1238 Bool) (temp___do_typ_inv_1239 Bool)) Bool (=> (or (= temp___is_init_1236 true) (<= 1 2147483647)) (in_range2 temp___expr_1240)))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(declare-fun is_empty (us_rep2) Bool)
(declare-fun is_empty__function_guard (Bool us_rep2) Bool)
(define-fun default_initial_assumption ((temp___expr_1248 us_rep2) (temp___skip_top_level_1249 Bool)) Bool (=> (not (= temp___skip_top_level_1249 true)) (and (= (is_empty temp___expr_1248) true) (= (length1 temp___expr_1248) 0))))
...
(define-fun map__ref___7__projection ((a map__ref2)) us_rep3 (map__content2 a))
...
(define-fun default_initial_assumption1 ((temp___expr_1189 us_rep3) (temp___skip_top_level_1190 Bool)) Bool (=> (not (= temp___skip_top_level_1190 true)) (and (= (is_empty1 temp___expr_1189) true) (= (length2 temp___expr_1189) 0))))
(assert true)
...
(define-fun key_type__ref___7__projection ((a key_type__ref1)) key_type (key_type__content1 a))
...
(define-fun element_type__ref___13__projection ((a element_type__ref1)) element_type1 (element_type__content1 a))
(define-fun dynamic_invariant3 ((temp___expr_1181 Int) (temp___is_init_1177 Bool) (temp___skip_constant_1178 Bool) (temp___do_toplevel_1179 Bool) (temp___do_typ_inv_1180 Bool)) Bool (=> (or (= temp___is_init_1177 true) (<= 0 2147483647)) (in_range4 temp___expr_1181)))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep (rec__dic_of_cont__my_orma__map__capacity (us_split_discrs1 container)))))))
