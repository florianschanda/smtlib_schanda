...
(define-fun cu2 () us_rep1 (mk___rep (mk___split_fields cu1)))
...
(assert (= cu2 o1))
(assert (and (= result1 (has_key (positions l) cu2)) (= (= result1 true) (= (has_key (positions l) cu2) true))))
(assert (= result1 true))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i (- (get1 (positions l) cu2) 1)))
