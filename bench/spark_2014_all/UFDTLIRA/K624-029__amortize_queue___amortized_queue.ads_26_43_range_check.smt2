...
(assert (and (= o9 (length right)) (and (in_range2 o9) (<= o9 (capacity right)))))
(assert (= o10 (+ 1 o9)))
(assert (and (= o11 (length (vector__content amortized_queue__Oconcat__2__result5))) (and (in_range2 o11) (<= o11 (capacity (vector__content amortized_queue__Oconcat__2__result5))))))
(assert (= result4 (ite (= o11 o10) true false)))
(assert (= result4 true))
(assert (and (= o8 (get (model__ (vector__content amortized_queue__Oconcat__2__result5)) 1)) (and (in_range5 o8) (= o8 (get (model__ (vector__content amortized_queue__Oconcat__2__result5)) 1)))))
...
(assert (and (= o7 (get (model__ right) o6)) (and (in_range5 o7) (= o7 (get (model__ right) o6)))))
