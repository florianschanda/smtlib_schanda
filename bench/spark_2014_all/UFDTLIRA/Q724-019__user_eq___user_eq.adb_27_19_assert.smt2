...
(assert (= result2 (mk___split_fields__ref1 (mk___split_fields1 (mk___rep (mk___split_fields y__split_fields y__split_fields1))))))
(assert (= y__split_fields2 (mk___split_fields1 (mk___rep (mk___split_fields rliteral rliteral1)))))
(assert (= result3 (mk___split_fields__ref2 (mk___split_fields2 (mk___rep (mk___split_fields z__split_fields z__split_fields1))))))
(assert (= z__split_fields2 (mk___split_fields2 (mk___rep (mk___split_fields rliteral rliteral)))))
(assert (= result4 (mk___split_fields__ref2 (mk___split_fields2 (mk___rep (mk___split_fields w__split_fields w__split_fields1))))))
(assert (= w__split_fields2 (mk___split_fields2 (mk___rep (mk___split_fields rliteral rliteral1)))))
(assert (not (= (bool_eq1 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields x__split_fields2 x__split_fields3)))) (mk___rep1 y__split_fields2)) true)))
(check-sat)
(exit)
