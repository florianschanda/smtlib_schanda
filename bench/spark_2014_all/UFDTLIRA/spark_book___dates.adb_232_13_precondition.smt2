...
(define-fun current_date__split_fields6 () us_split_fields (mk___split_fields current_date__split_fields3 current_date__split_fields4 current_date__split_fields5))
...
(assert (not (= (bool_eq (mk___rep current_date__split_fields6) (maximum_date Tuple0)) true)))
(assert (and (=> (<= 1 r36b) (dynamic_property 1 r36b i2)) (and (<= 1 i2) (<= i2 r36b))))
(assert (not (not (= (bool_eq (mk___rep current_date__split_fields6) (maximum_date Tuple0)) true))))
(check-sat)
(exit)
