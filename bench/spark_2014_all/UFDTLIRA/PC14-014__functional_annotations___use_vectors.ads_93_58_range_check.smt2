...
(assert (and (= o11 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))))) (and (dynamic_property4 first3 last5 o11) (= o11 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))))))))
(assert (= o12 (ite (<= j1 o11) true false)))
(assert (and (= o10 (+ i 7)) (in_range1 (+ i 7))))
(assert (= o13 (ite (<= o10 j1) true false)))
(assert (= result (ite (= o13 true) o12 false)))
(assert (= (= o14 true) (forall ((j2 Int)) (=> (and (<= (+ i 7) j2) (<= j2 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8)))))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))) j2) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (- j2 7)))))))
(assert (and (= o7 (+ i 7)) (in_range1 (+ i 7))))
(assert (= o8 (- o7 1)))
(assert (= o9 (ite (<= j o8) true false)))
(assert (= result1 (ite (<= i j) o9 false)))
(assert (= result1 true))
(assert (not (dynamic_property3 first2 last4 j)))
(check-sat)
(exit)
