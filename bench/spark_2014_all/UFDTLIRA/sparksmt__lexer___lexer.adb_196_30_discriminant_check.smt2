...
(declare-const temp___992 read_status)
(declare-const temp___9921 character)
(declare-const temp___9922 Bool)
(declare-const temp___991 Int)
(declare-const temp___990 Int)
(declare-const temp___989 Int)
(declare-const temp___988 us_rep)
...
(assert (=> (= result true) (= temp___993 the_file)))
(assert (=> (= result true) (and (= next_read__split_discrs1 (mk___split_discrs temp___992)) (and (= next_read__split_fields1 (mk___split_fields temp___9921)) (= next_read__attr__constrained temp___9922)))))
(assert (=> (= result true) (= temp___991 current_pos1)))
(assert (=> (= result true) (= temp___990 current_col1)))
(assert (=> (= result true) (= temp___989 current_line1)))
(assert (=> (= result true) (= temp___988 (mk___rep current_read__split_discrs1 current_read__split_fields1 current_read__attr__constrained))))
(assert (=> (= result true) (and (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1 current_pos2)) (and (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs2)) 0) (let ((temp___995 (to_rep (rec__file_io__read_result__c current_read__split_fields2)))) (or (= temp___995 10) (or (= temp___995 13) (or (= temp___995 32) (= temp___995 9)))))))))
(assert (=> (= result true) (and (and (and (= (local_invariant current_read__split_fields3 current_read__split_discrs3 next_read__split_fields3 next_read__split_discrs3) true) (= (bool_eq (mk___rep current_read__split_discrs3 current_read__split_fields3 current_read__attr__constrained) (mk___rep next_read__split_discrs2 next_read__split_fields2 next_read__attr__constrained)) true)) (<= current_pos2 current_pos3)) (and (and (in_range2 current_line3) (in_range1 current_col3)) (in_range1 current_pos3)))))
...
(assert (= result2 true))
(assert (and (and (and (= (local_invariant current_read__split_fields8 current_read__split_discrs8 next_read__split_fields8 next_read__split_discrs8) true) (= (bool_eq (mk___rep current_read__split_discrs8 current_read__split_fields8 current_read__attr__constrained) (mk___rep (us_split_discrs__content next_read__split_discrs6) (us_split_fields__content next_read__split_fields6) next_read__attr__constrained)) true)) (<= (int__content current_pos6) current_pos8)) (and (and (in_range2 current_line8) (in_range1 current_col8)) (in_range1 current_pos8))))
(assert (=> (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs8)) 0) (= result3 (ite (not (= (to_rep (rec__file_io__read_result__c current_read__split_fields8)) 10)) true false))))
(assert (=> (not (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs8)) 0)) (= result3 false)))
(assert (= result3 true))
(assert (and (and (and (in_range2 current_line9) (in_range1 current_col9)) (in_range1 current_pos9)) (and (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs9)) 0) (not (= (to_rep (rec__file_io__read_result__c current_read__split_fields9)) 10)))))
(assert (and (and (and (= (local_invariant current_read__split_fields10 current_read__split_discrs10 next_read__split_fields10 next_read__split_discrs10) true) (= (bool_eq (mk___rep current_read__split_discrs10 current_read__split_fields10 current_read__attr__constrained) (mk___rep next_read__split_discrs9 next_read__split_fields9 next_read__attr__constrained)) true)) (<= current_pos9 current_pos10)) (and (and (in_range2 current_line10) (in_range1 current_col10)) (in_range1 current_pos10))))
(assert (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs10)) 0))
(assert (not (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs10)) 0)))
(check-sat)
(exit)
