...
(define-fun dynamic_invariant ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= (- 100) 100)) (in_range temp___expr_158)))
(define-fun dynamic_invariant1 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 10)) (in_range1 temp___expr_165)))
(declare-fun in_bounds (us_rep) Bool)
(declare-fun in_bounds__function_guard (Bool us_rep) Bool)
(define-fun default_initial_assumption ((temp___expr_173 us_rep) (temp___skip_top_level_174 Bool)) Bool (and (and (= (to_rep (rec__shapes4__circle__center_x (us_split_fields1 temp___expr_173))) 0) (= (to_rep (rec__shapes4__circle__center_y (us_split_fields1 temp___expr_173))) 0)) (= (to_rep1 (rec__shapes4__circle__radius (us_split_fields1 temp___expr_173))) 0)))
(define-fun type_invariant ((temp___175 us_rep)) Bool (= (in_bounds temp___175) true))
(declare-const x Int)
