...
(assert (= result2 true))
(assert (and (= o10 i) (in_range5 i)))
(assert (and (= o11 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o10)) (and (in_range4 o11) (= o11 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o10)))))
...
(assert (not (<= o9 (last (model__ (mk___rep front__split_discrs front__split_fields3))))))
(check-sat)
(exit)
