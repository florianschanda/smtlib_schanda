...
(define-fun dynamic_invariant1 ((temp___expr_308 Int) (temp___is_init_304 Bool) (temp___skip_constant_305 Bool) (temp___do_toplevel_306 Bool) (temp___do_typ_inv_307 Bool)) Bool (=> (or (= temp___is_init_304 true) (<= (- 1) 2147483646)) (in_range2 temp___expr_308)))
...
(define-fun dynamic_invariant2 ((temp___expr_294 Int) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool) (temp___do_typ_inv_293 Bool)) Bool (=> (or (= temp___is_init_290 true) (<= 0 2147483646)) (in_range4 temp___expr_294)))
...
(define-fun dynamic_invariant3 ((temp___expr_301 Int) (temp___is_init_297 Bool) (temp___skip_constant_298 Bool) (temp___do_toplevel_299 Bool) (temp___do_typ_inv_300 Bool)) Bool (=> (or (= temp___is_init_297 true) (<= 0 255)) (in_range5 temp___expr_301)))
...
(assert (and (= o5 (last left)) (and (in_range2 o5) (= o5 (+ (- 1) (length left))))))
(assert (= result (ite (<= lst o5) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o4 (- (- 2147483648) offset)) (in_range3 (- (- 2147483648) offset)))))
