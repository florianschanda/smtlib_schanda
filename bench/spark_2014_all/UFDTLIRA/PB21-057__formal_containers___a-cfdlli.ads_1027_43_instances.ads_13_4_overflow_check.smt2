...
(define-fun dynamic_invariant1 ((temp___expr_659 Int) (temp___is_init_655 Bool) (temp___skip_constant_656 Bool) (temp___do_toplevel_657 Bool) (temp___do_typ_inv_658 Bool)) Bool (=> (or (= temp___is_init_655 true) (<= 1 2147483647)) (in_range3 temp___expr_659)))
...
(assert (and (= o (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range o) (<= o (to_rep (rec__instances__lists__list__capacity target__split_discrs))))))
(assert (= o1 (- (to_rep (rec__instances__lists__list__capacity target__split_discrs)) o)))
