...
(assert (= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) (+ (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 1)))
(assert (not (= (local_invariant the_file (mk___split_fields1 current_read__split_fields) (mk___split_discrs1 current_read__split_discrs) current_idx (mk___split_fields1 next_read__split_fields) (mk___split_discrs1 next_read__split_discrs) next_idx) true)))
(check-sat)
(exit)
