...
(assert (and (= o6 (last left)) (and (in_range4 o6) (= o6 (+ 0 (length left))))))
(assert (= result (ite (<= lst o6) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o5 (- (- 2147483648) offset)) (in_range5 (- (- 2147483648) offset)))))
