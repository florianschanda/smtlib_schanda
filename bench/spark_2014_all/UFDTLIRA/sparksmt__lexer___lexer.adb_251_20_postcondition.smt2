...
(declare-const temp___1023 token_kind)
(declare-const temp___10231 natural)
(declare-const temp___10232 natural)
(declare-const temp___10233 natural)
(declare-const temp___10234 name_id)
(declare-const temp___10235 Bool)
...
(declare-const temp___1025 token_kind)
(declare-const temp___10251 natural)
(declare-const temp___10252 natural)
(declare-const temp___10253 natural)
(declare-const temp___10254 name_id)
(declare-const temp___10255 Bool)
...
(declare-const temp___1026 token_kind)
(declare-const temp___10261 natural)
(declare-const temp___10262 natural)
(declare-const temp___10263 natural)
(declare-const temp___10264 name_id)
(declare-const temp___10265 Bool)
(declare-const usq_6 us_rep)
(declare-const temp___1028 us_rep)
...
(assert (=> (= kind 1) (= o o7)))
(assert (=> (= kind 1) (= temp___1023 o7)))
(assert (=> (= kind 1) (= temp___10231 o3)))
(assert (=> (= kind 1) (= temp___10232 o4)))
(assert (=> (= kind 1) (= temp___10233 o5)))
(assert (=> (= kind 1) (= temp___10234 o6)))
(assert (=> (= kind 1) (= true temp___10235)))
(assert (=> (= kind 1) (=> (= t__attr__constrained true) (= temp___1023 t__split_discrs))))
(assert (=> (= kind 1) (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1 usq_2 usq_3 usq_4) usq_5) (mk___rep (mk___split_discrs temp___1023) (mk___split_fields temp___10231 temp___10232 temp___10233 temp___10234) temp___10235))))
(assert (=> (= kind 1) (= usq_ temp___1025)))
(assert (=> (= kind 1) (= usq_1 temp___10251)))
(assert (=> (= kind 1) (= usq_2 temp___10252)))
(assert (=> (= kind 1) (= usq_3 temp___10253)))
(assert (=> (= kind 1) (= usq_4 temp___10254)))
(assert (=> (= kind 1) (= t__attr__constrained temp___10255)))
(assert (=> (= kind 1) (= result t__split_fields8)))
(assert (=> (= kind 1) (= t__split_fields4 (mk___split_fields temp___10251 temp___10252 temp___10253 temp___10254))))
(assert (=> (= kind 1) (= result1 t__split_discrs5)))
(assert (=> (= kind 1) (= t__split_discrs1 (mk___split_discrs temp___1025))))
...
(assert (=> (not (= kind 1)) (= temp___1026 o15)))
(assert (=> (not (= kind 1)) (= temp___10261 o11)))
(assert (=> (not (= kind 1)) (= temp___10262 o12)))
(assert (=> (not (= kind 1)) (= temp___10263 o13)))
(assert (=> (not (= kind 1)) (= temp___10264 o14)))
(assert (=> (not (= kind 1)) (= true temp___10265)))
(assert (=> (not (= kind 1)) (=> (= t__attr__constrained true) (= temp___1026 t__split_discrs))))
(assert (=> (not (= kind 1)) (= usq_6 (mk___rep (mk___split_discrs temp___1026) (mk___split_fields temp___10261 temp___10262 temp___10263 temp___10264) temp___10265))))
(assert (=> (not (= kind 1)) (= temp___1028 (mk___rep (us_split_discrs1 usq_6) (us_split_fields1 usq_6) t__attr__constrained))))
(assert (=> (not (= kind 1)) (= result2 t__split_fields8)))
(assert (=> (not (= kind 1)) (= t__split_fields5 (us_split_fields1 temp___1028))))
(assert (=> (not (= kind 1)) (= result3 t__split_discrs5)))
(assert (=> (not (= kind 1)) (= t__split_discrs2 (us_split_discrs1 temp___1028))))
