...
(assert (forall ((i type_3)) (and (<= (- 2147483648) (type_3qtint i)) (<= (type_3qtint i) 2147483647))))
...
(declare-const rliteral type_3)
(assert (= (type_3qtint rliteral) 0))
(declare-const p__create_type_5__result type_5__ref)
...
(declare-const result type_5__ref)
(declare-const p__create_type_5__result1 us_rep3)
(declare-const p__create_type_5__result2 type_5__ref)
(declare-const p__create_type_5__result3 us_rep3)
(declare-const p__create_type_5__result4 type_5__ref)
(declare-const p__create_type_5__result5 us_rep3)
(declare-const result1 us_rep3)
(assert (= p__create_type_5__result2 (let ((subject p__create_type_5__result)) (mk_type_5__ref p__create_type_5__result1))))
(assert (= p__create_type_5__result3 p__create_type_5__result1))
(assert (and (= o (create_type_4 Tuple0)) (and (= (bool_eq (rec__p__type_4__field_0 (us_split_fields5 o)) (create_type_1 Tuple0)) true) (and (= (bool_eq (rec__p__type_4__field_1 (us_split_fields5 o)) (create_type_1 Tuple0)) true) (and (= (bool_eq1 (rec__p__type_4__field_2 (us_split_fields5 o)) (create_type_2 Tuple0)) true) (= (bool_eq1 (rec__p__type_4__field_3 (us_split_fields5 o)) (create_type_2 Tuple0)) true))))))
(assert (and (= o1 (create_type_4 Tuple0)) (and (= (bool_eq (rec__p__type_4__field_0 (us_split_fields5 o1)) (create_type_1 Tuple0)) true) (and (= (bool_eq (rec__p__type_4__field_1 (us_split_fields5 o1)) (create_type_1 Tuple0)) true) (and (= (bool_eq1 (rec__p__type_4__field_2 (us_split_fields5 o1)) (create_type_2 Tuple0)) true) (= (bool_eq1 (rec__p__type_4__field_3 (us_split_fields5 o1)) (create_type_2 Tuple0)) true))))))
(assert (and (= o2 (create_type_2 Tuple0)) (and (= (bool_eq (rec__p__type_2__field_0 (us_split_fields3 o2)) (create_type_1 Tuple0)) true) (and (= (bool_eq (rec__p__type_2__field_1 (us_split_fields3 o2)) (create_type_1 Tuple0)) true) (and (= (bool_eq (rec__p__type_2__field_2 (us_split_fields3 o2)) (create_type_1 Tuple0)) true) (and (= (bool_eq (rec__p__type_2__field_3 (us_split_fields3 o2)) (create_type_1 Tuple0)) true) (= (bool_eq (rec__p__type_2__field_4 (us_split_fields3 o2)) (create_type_1 Tuple0)) true)))))))
(assert (and (= o3 (create_type_4 Tuple0)) (and (= (bool_eq (rec__p__type_4__field_0 (us_split_fields5 o3)) (create_type_1 Tuple0)) true) (and (= (bool_eq (rec__p__type_4__field_1 (us_split_fields5 o3)) (create_type_1 Tuple0)) true) (and (= (bool_eq1 (rec__p__type_4__field_2 (us_split_fields5 o3)) (create_type_2 Tuple0)) true) (= (bool_eq1 (rec__p__type_4__field_3 (us_split_fields5 o3)) (create_type_2 Tuple0)) true))))))
(assert (= o4 (mk___split_fields3 rliteral o3 o2 o1 o)))
(assert (= o5 (mk___rep3 o4)))
(assert (= result p__create_type_5__result))
(assert (= (let ((subject p__create_type_5__result)) p__create_type_5__result1) o5))
(assert (= p__create_type_5__result4 p__create_type_5__result2))
(assert (= p__create_type_5__result5 p__create_type_5__result3))
(assert (= result1 (type_5__content p__create_type_5__result4)))
(assert (not (= (bool_eq2 (rec__p__type_5__field_1 (us_split_fields7 (type_5__content p__create_type_5__result4))) (create_type_4 Tuple0)) true)))
(check-sat)
(exit)
