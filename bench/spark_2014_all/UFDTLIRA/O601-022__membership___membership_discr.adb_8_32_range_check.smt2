...
(define-fun dynamic_invariant ((temp___expr_230 us_rep) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool) (temp___do_typ_inv_229 Bool)) Bool (=> (not (= temp___skip_constant_227 true)) (in_range3 0 temp___expr_230)))
(define-fun default_initial_assumption ((temp___expr_232 us_rep) (temp___skip_top_level_233 Bool)) Bool (and (= (attr__tag temp___expr_232) us_tag3) (= (to_rep (rec__membership_discr__root__c (us_split_discrs1 temp___expr_232))) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_239 us_rep) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (not (= temp___skip_constant_236 true)) (in_range4 0 temp___expr_239)))
(define-fun default_initial_assumption1 ((temp___expr_241 us_rep) (temp___skip_top_level_242 Bool)) Bool (and (= (attr__tag temp___expr_241) us_tag4) (= (to_rep (rec__membership_discr__root__c (us_split_discrs1 temp___expr_241))) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_248 us_rep) (temp___is_init_244 Bool) (temp___skip_constant_245 Bool) (temp___do_toplevel_246 Bool) (temp___do_typ_inv_247 Bool)) Bool (=> (not (= temp___skip_constant_245 true)) (in_range5 0 temp___expr_248)))
(define-fun default_initial_assumption2 ((temp___expr_250 us_rep) (temp___skip_top_level_251 Bool)) Bool (and (= (attr__tag temp___expr_250) us_tag5) (= (to_rep (rec__membership_discr__root__c (us_split_discrs1 temp___expr_250))) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_281 us_rep) (temp___is_init_277 Bool) (temp___skip_constant_278 Bool) (temp___do_toplevel_279 Bool) (temp___do_typ_inv_280 Bool)) Bool (=> (not (= temp___skip_constant_278 true)) (in_range7 0 temp___expr_281)))
(define-fun default_initial_assumption3 ((temp___expr_283 us_rep) (temp___skip_top_level_284 Bool)) Bool (and (= (attr__tag temp___expr_283) us_tag7) (= (to_rep (rec__membership_discr__root__c (us_split_discrs1 temp___expr_283))) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_290 us_rep) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool) (temp___do_typ_inv_289 Bool)) Bool (=> (not (= temp___skip_constant_287 true)) (in_range8 0 temp___expr_290)))
(define-fun default_initial_assumption4 ((temp___expr_292 us_rep) (temp___skip_top_level_293 Bool)) Bool (and (= (attr__tag temp___expr_292) us_tag8) (= (to_rep (rec__membership_discr__root__c (us_split_discrs1 temp___expr_292))) 0)))
...
(define-fun dynamic_invariant6 ((temp___expr_215 us_rep) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool (=> (not (= temp___skip_constant_212 true)) (in_range2 0 temp___expr_215)))
(define-fun default_initial_assumption5 ((temp___expr_217 us_rep) (temp___skip_top_level_218 Bool)) Bool (and (= (attr__tag temp___expr_217) us_tag1) (= (to_rep (rec__membership_discr__root__c (us_split_discrs1 temp___expr_217))) 0)))
(define-fun dynamic_invariant7 ((temp___expr_257 us_rep) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool) (temp___do_typ_inv_256 Bool)) Bool (=> (not (= temp___skip_constant_254 true)) (in_range6 0 temp___expr_257)))
(define-fun default_initial_assumption6 ((temp___expr_259 us_rep) (temp___skip_top_level_260 Bool)) Bool (and (= (attr__tag temp___expr_259) us_tag6) (= (to_rep (rec__membership_discr__root__c (us_split_discrs1 temp___expr_259))) 0)))
