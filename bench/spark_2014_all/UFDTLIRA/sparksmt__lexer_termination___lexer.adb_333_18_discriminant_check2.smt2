...
(assert (= (to_rep1 o) 1))
(assert (= o o7))
(assert (= temp___1058 o7))
(assert (= temp___10581 o3))
(assert (= temp___10582 o4))
(assert (= temp___10583 o5))
(assert (= temp___10584 o6))
(assert (= true temp___10585))
(assert (= t__attr__constrained true))
(assert (not (= temp___1058 t__split_discrs)))
(check-sat)
(exit)
