...
(assert (= current_date__split_fields3 current_date__split_fields6))
(assert (= rliteral4 current_date__split_fields7))
(assert (= current_date__split_fields5 current_date__split_fields8))
(assert (not (in_range (+ (to_rep current_date__split_fields8) 1))))
(check-sat)
(exit)
