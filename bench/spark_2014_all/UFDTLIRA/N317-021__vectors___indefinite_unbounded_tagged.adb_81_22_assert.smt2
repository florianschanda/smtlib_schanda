...
(assert (not (= (let ((temp___674 (f 4))) (let ((temp___673 (get (model__ (mk___rep v__split_discrs v__split_fields9)) 1))) (ite (= (attr__tag temp___673) (attr__tag temp___674)) (us_dispatch_eq temp___673 temp___674) false))) true)))
(check-sat)
(exit)
