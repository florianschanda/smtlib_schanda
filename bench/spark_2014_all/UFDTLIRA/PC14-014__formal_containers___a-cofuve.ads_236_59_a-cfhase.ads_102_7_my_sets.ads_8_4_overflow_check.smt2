...
(define-fun default_initial_assumption ((temp___expr_423 us_rep) (temp___skip_top_level_424 Bool)) Bool (=> (not (= temp___skip_top_level_424 true)) (= (length temp___expr_423) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_401 Int) (temp___is_init_397 Bool) (temp___skip_constant_398 Bool) (temp___do_toplevel_399 Bool) (temp___do_typ_inv_400 Bool)) Bool (=> (or (= temp___is_init_397 true) (<= 1 2147483647)) (in_range4 temp___expr_401)))
...
(define-fun dynamic_invariant3 ((temp___expr_408 Int) (temp___is_init_404 Bool) (temp___skip_constant_405 Bool) (temp___do_toplevel_406 Bool) (temp___do_typ_inv_407 Bool)) Bool (=> (or (= temp___is_init_404 true) (<= 1 2147483647)) (in_range5 temp___expr_408)))
