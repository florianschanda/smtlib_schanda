...
(define-fun dynamic_invariant3 ((temp___expr_194 Int) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool (=> (or (= temp___is_init_190 true) (<= 0 1)) (in_range4 temp___expr_194)))
...
(assert (in_range4 d))
(assert (and (= o2 (length s1)) (and (in_range o2) (<= (+ 0 o2) 2147483647))))
(assert (and (= o1 (length s2)) (and (in_range o1) (<= (+ 0 o1) 2147483647))))
(assert (= o3 (- o1 1)))
...
(assert (= result true))
(assert (and (= o (length s2)) (and (in_range o) (<= (+ 0 o) 2147483647))))
(assert (not (<= 1 o)))
(check-sat)
(exit)
