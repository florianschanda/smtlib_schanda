...
(assert (and (= o13 (length m)) (and (in_range2 o13) (<= o13 (capacity m)))))
(assert (and (= o11 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range2 o11) (<= o11 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (and (= o12 (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range2 o12) (<= o12 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= o14 (+ o12 o11)))
(assert (= result2 (ite (= o14 o13) true false)))
(assert (=> (= result2 true) (and (= o10 (length m)) (and (in_range2 o10) (<= o10 (capacity m))))))
(assert (=> (= result2 true) (= result1 (ite (<= o10 1000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o8 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range2 o8) (<= o8 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q))))))))
(assert (=> (= result1 true) (= o9 (ite (<= i1 o8) true false))))
(assert (=> (= result1 true) (= result3 (ite (<= 1 i1) o9 false))))
(assert (=> (= result1 true) (= (= result true) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (rec__amortized_queue__queue__rear (us_split_fields3 q))))) (= (get (model__ m) i2) (get (model__ (rec__amortized_queue__queue__rear (us_split_fields3 q))) (+ (- (length (rec__amortized_queue__queue__rear (us_split_fields3 q))) i2) 1))))))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (and (= o (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range2 o) (<= o (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= o1 (ite (<= i o) true false)))
(assert (= result4 (ite (<= 1 i) o1 false)))
(assert (= result4 true))
(assert (and (= o6 i) (in_range6 i)))
(assert (and (= o7 (get (model__ (rec__amortized_queue__queue__front (us_split_fields3 q))) o6)) (and (in_range3 o7) (= o7 (get (model__ (rec__amortized_queue__queue__front (us_split_fields3 q))) o6)))))
(assert (and (= o2 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range2 o2) (<= o2 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (= o3 (+ i o2)))
(assert (and (= o4 o3) (in_range1 o3)))
(assert (and (= o5 o4) (in_range6 o4)))
(assert (not (<= o5 (last (model__ m)))))
(check-sat)
(exit)
