...
(define-fun in_range ((x Int)) Bool (and (<= 50 x) (<= x 59)))
(declare-fun attr__ATTRIBUTE_IMAGE (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE (us_image) Int)
(declare-fun user_eq (et4 et4) Bool)
(declare-const dummy et4)
(declare-datatypes () ((et4__ref (mk_et4__ref (et4__content et4)))))
(define-fun et4__ref___projection ((a et4__ref)) et4 (et4__content a))
(define-fun to_rep ((x et4)) Int (et4qtint x))
(declare-fun of_rep (Int) et4)
(assert (forall ((x et4)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x et4)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (bool_eq1 (rec__ar__rec3t__f3 (us_split_fields5 a)) (rec__ar__rec3t__f3 (us_split_fields5 b))) true) (= (to_rep (rec__ar__rec3t__g3 (us_split_fields5 a))) (to_rep (rec__ar__rec3t__g3 (us_split_fields5 b))))) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_225 Int) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool) (temp___do_typ_inv_224 Bool)) Bool (=> (or (= temp___is_init_221 true) (<= 50 59)) (in_range temp___expr_225)))
...
(assert (not (= (bool_eq1 (rec__ar__rec3t__f3 (us_split_fields__content2 r__split_fields11)) (mk___rep1 (let ((usq_ (us_split_fields3 a))) (mk___split_fields1 (rec__ar__rec2t__f2 usq_) b (rec__ar__rec2t__h2 usq_))))) true)))
(check-sat)
(exit)
