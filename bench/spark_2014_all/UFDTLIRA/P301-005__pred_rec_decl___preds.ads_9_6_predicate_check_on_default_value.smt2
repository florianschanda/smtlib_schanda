...
(declare-const x Int)
(declare-const temp___360 int_bad)
(assert (dynamic_invariant i9s true false true true))
(assert (dynamic_invariant x false false true true))
(assert (= (to_rep temp___360) 0))
(define-fun temp___362 () Int (to_rep temp___360))
(assert (not (or (and (<= (- 2147483648) temp___362) (<= temp___362 (- 1))) (and (<= 1 temp___362) (<= temp___362 2147483647)))))
(check-sat)
(exit)
