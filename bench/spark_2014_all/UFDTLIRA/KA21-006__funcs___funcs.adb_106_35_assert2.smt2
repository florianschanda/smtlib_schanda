...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (= (= (q2 x) true) (< 0 x))) :pattern ((q2 x)))))
(assert (forall ((x Int)) (! (= (= (q2 x) true) (< 0 x)) :pattern ((q2 x)))))
(declare-fun q5 (Int) Bool)
(declare-fun q5__function_guard (Bool Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (= (= (q5 x) true) (< 0 x))) :pattern ((q5 x)))))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (= (= (q4 x) true) (< 0 x))) :pattern ((q4 x)))))
...
(assert (= (p4 3) true))
(assert (and (= o11 (p4 3)) (= (= o11 true) (< 0 3))))
(assert (= result12 y11))
(assert (= y12 o11))
...
(assert (= result13 y12))
(assert (= y13 o12))
(assert (= (= y13 true) (= (p5 3) true)))
(assert (and (= o13 (q2 3)) (= (= o13 true) (< 0 3))))
(assert (= result14 y13))
(assert (= y14 o13))
(assert (= (= y14 true) (= (q2 3) true)))
(assert (and (= o14 (q4 3)) (= (= o14 true) (< 0 3))))
(assert (= result15 y14))
(assert (= y15 o14))
(assert (= y15 true))
(assert (not (= (q4 3) true)))
(check-sat)
(exit)
