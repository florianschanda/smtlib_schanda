...
(assert (= c1 1))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= temp___266 c1)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= temp___263 m1)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= temp___268 m1)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= temp___267 m1)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= temp___262 tmp)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (forall ((i Int)) (=> (and (<= 1 i) (<= i (- c2 1))) (and (= (to_rep (get m2 5 i)) (to_rep (get temp___267 7 i))) (= (to_rep (get m2 7 i)) (to_rep (get temp___268 5 i))))))))
(assert (=> (and (<= 1 c1) (<= c1 10)) (and (and (and (=> (<= 0 2147483647) (in_range2 tmp2)) (forall ((temp___264 Int) (temp___265 Int)) (=> (and (and (<= 1 temp___264) (<= temp___264 10)) (and (<= 1 temp___265) (<= temp___265 10))) (=> (and (or (< 10 temp___265) (or (< temp___265 1) (or (<= c2 temp___265) (not (= 7 temp___264))))) (or (< 10 temp___265) (or (< temp___265 1) (or (<= c2 temp___265) (not (= 5 temp___264)))))) (= (get m2 temp___264 temp___265) (get temp___263 temp___264 temp___265)))))) (=> (<= 1 10) (in_range5 c2))) (and (<= 1 c2) (<= c2 10)))))
...
(assert (not (= i 5)))
(assert (= i 7))
(assert (not (= (to_rep (get m7 i j)) 1)))
(check-sat)
(exit)
