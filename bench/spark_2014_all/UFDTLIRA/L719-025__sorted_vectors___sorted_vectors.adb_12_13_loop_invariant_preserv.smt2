...
(assert (and (= o3 (+ position2 1)) (in_range8 (+ position2 1))))
(assert (= position2 result3))
(assert (= position3 o3))
(assert (and (= o5 (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range2 o5) (<= o5 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))
(assert (= result5 (ite (<= position3 o5) true false)))
(assert (=> (= result5 true) (and (= o4 (get (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))) position3)) (and (in_range6 o4) (= o4 (get (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))) position3))))))
...
(assert (not (or (= position3 1) (< (get (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))) (- position3 1)) new_item))))
(check-sat)
(exit)
