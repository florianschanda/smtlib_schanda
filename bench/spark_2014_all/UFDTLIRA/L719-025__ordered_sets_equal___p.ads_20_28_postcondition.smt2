...
(assert (not (= (oeq1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)))
(check-sat)
(exit)
