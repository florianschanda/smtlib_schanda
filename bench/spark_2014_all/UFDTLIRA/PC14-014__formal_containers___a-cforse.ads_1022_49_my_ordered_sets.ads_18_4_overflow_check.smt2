...
(define-fun element_type__ref___7__projection ((a element_type__ref1)) us_rep1 (element_type__content1 a))
...
(define-fun oeq1 ((left1 us_rep2) (right1 us_rep2)) Bool (and (= (length1 left1) (length1 right1)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left1))) (= (bool_eq1 (get left1 n) (get right1 n)) true))) true false)))
...
(define-fun e_elements_included ((left1 us_rep2) (right1 us_rep2)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 left1))) (and (< 0 (find right1 (get left1 i))) (= (bool_eq1 (get right1 (find right1 (get left1 i))) (get left1 i)) true)))) true false))
...
(define-fun default_initial_assumption1 ((temp___expr_607 us_rep3) (temp___skip_top_level_608 Bool)) Bool (=> (not (= temp___skip_top_level_608 true)) (= (is_empty temp___expr_607) true)))
...
(assert (forall ((container us_rep3)) (forall ((item us_rep1)) (! (=> (= (distinct 1 0) true) (=> (exists ((e us_rep1)) (and (= (contains container e) true) (= (equivalent_elements e item) true))) (= (contains container item) true))) :pattern ((contains container item))))))
(assert (forall ((container us_rep3)) (! (dynamic_invariant (length2 container) true false true true) :pattern ((length2 container)))))
(assert (forall ((container us_rep3)) (! (let ((result (is_empty container))) (and (= (= result true) (forall ((item us_rep1)) (not (= (contains container item) true)))) (= (= result true) (= (length2 container) 0)))) :pattern ((is_empty container)))))
...
(assert (and (= o (length right)) (and (in_range o) (<= o (to_rep (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 right)))))))
