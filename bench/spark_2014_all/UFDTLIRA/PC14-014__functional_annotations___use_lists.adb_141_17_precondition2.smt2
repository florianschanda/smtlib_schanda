...
(assert (and (= o2 (positions (mk___rep l__split_discrs l__split_fields2))) (and (not (= (has_key o2 no_element) true)) (forall ((i1 us_rep2)) (=> (= (has_key o2 i1) true) (and (and (<= 1 (get1 o2 i1)) (<= (get1 o2 i1) (length (mk___rep l__split_discrs l__split_fields2)))) (forall ((j us_rep2)) (=> (= (has_key o2 j) true) (=> (= (get1 o2 i1) (get1 o2 j)) (= (bool_eq2 i1 j) true))))))))))
(assert (and (= o3 (get1 o2 (mk___rep1 current__split_fields3))) (and (in_range4 o3) (=> (= (distinct 0 0) true) (and (= o3 (w_get o2 (witness o2 (mk___rep1 current__split_fields3)))) (forall ((k us_rep2)) (=> (= (has_key o2 k) true) (= (= (bool_eq2 k (mk___rep1 current__split_fields3)) true) (= (witness o2 (mk___rep1 current__split_fields3)) (witness o2 k))))))))))
(assert (= o4 (- o3 1)))
