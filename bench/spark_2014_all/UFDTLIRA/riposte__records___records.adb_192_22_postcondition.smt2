...
(declare-const temp___3341 unsigned_byte)
(declare-const temp___3342 unsigned_byte)
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___334 o5))
(assert (= temp___3341 o6))
(assert (= temp___3342 o7))
...
(assert (= x__split_fields3 (mk___split_fields1 temp___334 (mk___rep (mk___split_fields temp___3341 temp___3342)))))
...
(assert (= o14 o11))
(assert (= o15 o12))
(assert (= temp___337 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15))))))
(assert (= result2 (mk___split_fields__ref1 x__split_fields3)))
(assert (= x__split_fields4 (us_split_fields3 temp___337)))
...
(assert (not (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields__content1 x__split_fields5)) true)))
(check-sat)
(exit)
