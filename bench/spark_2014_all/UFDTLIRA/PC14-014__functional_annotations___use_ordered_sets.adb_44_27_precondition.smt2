...
(define-fun dynamic_invariant ((temp___expr_382 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool) (temp___do_typ_inv_381 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_382)))
...
(define-fun default_initial_assumption1 ((temp___expr_397 us_rep1) (temp___skip_top_level_398 Bool)) Bool (=> (not (= temp___skip_top_level_398 true)) (= (length1 temp___expr_397) 0)))
...
(define-fun default_initial_assumption2 ((temp___expr_420 us_rep3) (temp___skip_top_level_421 Bool)) Bool (=> (not (= temp___skip_top_level_421 true)) (and (= (is_empty1 temp___expr_420) true) (= (length2 temp___expr_420) 0))))
...
(assert (forall ((container us_rep4)) (! (let ((result (elements container))) (and (and (and (= (length1 result) (length3 container)) (forall ((temp___435 Int)) (=> (and (in_range3 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container) (get result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range1 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container)))))
...
(define-fun dynamic_invariant4 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 2147483647)) (in_range4 temp___expr_166)))
(declare-const rliteral count_type)
(assert (= (count_typeqtint rliteral) 0))
(assert (= no_element (mk___rep (mk___split_fields rliteral))))
(assert (forall ((container us_rep4)) (! (let ((result (length3 container))) (and (<= result (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant4 result true false true true))) :pattern ((length3 container)))))
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length1 container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant4 result true false true true)))) :pattern ((find container item))))))
...
(define-fun dynamic_invariant5 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_353)))
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range1 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(define-fun use_ordered_sets__are_disjoint__cu__assume1 () us_rep2 (mk___rep (mk___split_fields use_ordered_sets__are_disjoint__cu__assume)))
(assert (and (= use_ordered_sets__are_disjoint__cu__assume1 (first s1)) (ite (= (= (length3 s1) 0) true) (= (bool_eq2 use_ordered_sets__are_disjoint__cu__assume1 no_element) true) (and (= (has_key (positions s1) use_ordered_sets__are_disjoint__cu__assume1) true) (= (get1 (positions s1) use_ordered_sets__are_disjoint__cu__assume1) 1)))))
...
(assert (not (= (has_key (positions s1) (mk___rep cu__split_fields3)) true)))
(check-sat)
(exit)
