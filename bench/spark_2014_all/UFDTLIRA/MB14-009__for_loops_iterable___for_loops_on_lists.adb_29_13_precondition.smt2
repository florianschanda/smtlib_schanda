...
(define-fun o8 () us_rep2 (mk___rep1 (mk___split_fields1 o)))
(assert (= (mk___rep1 (mk___split_fields1 rliteral)) no_element))
(assert (and (= o8 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq2 o8 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o8) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o8) 1)))))
...
(assert (= cu3 o7))
(assert (not (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) cu3) true)))
(check-sat)
(exit)
