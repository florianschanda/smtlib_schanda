...
(define-fun v2__split_fields2 () us_split_fields (mk___split_fields v2__split_fields1))
...
(assert (and (= (length (mk___rep v2__split_discrs (mk___split_fields v2__split_fields))) 0) (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v2__split_discrs)))))
(assert (= lst2 r1b))
...
(assert (<= first3 i1))
(assert (<= i1 r1b))
(assert (= (length (mk___rep v2__split_discrs v2__split_fields2)) (- i2 first3)))
(assert (forall ((n1 Int)) (=> (and (<= first3 n1) (<= n1 (last2 (model__ (mk___rep v2__split_discrs v2__split_fields2))))) (= (is_incr (get (model__ v1) n1) (get (model__ (mk___rep v2__split_discrs v2__split_fields2)) n1)) true))))
(assert (and (and (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v2__split_discrs))) (=> (<= first3 r1b) (dynamic_property5 first3 r1b i2))) (and (<= first3 i2) (<= i2 r1b))))
(assert (and (= o1 (last2 (model__ (mk___rep v2__split_discrs v2__split_fields2)))) (and (dynamic_property3 first2 last4 o1) (= o1 (last2 (model__ (mk___rep v2__split_discrs v2__split_fields2)))))))
(assert (= o2 (ite (<= n o1) true false)))
(assert (= result2 (ite (<= first3 n) o2 false)))
(assert (= result2 true))
(assert (and (= us1 n) (dynamic_property2 first1 last3 n)))
(assert (= o4 n))
(assert (and (= o5 (get (model__ (mk___rep v2__split_discrs v2__split_fields2)) o4)) (and (in_range3 o5) (= o5 (get (model__ (mk___rep v2__split_discrs v2__split_fields2)) o4)))))
(assert (and (= us n) (dynamic_property2 first1 last3 n)))
(assert (= o3 n))
(assert (not (<= o3 (last2 (model__ v1)))))
(check-sat)
(exit)
