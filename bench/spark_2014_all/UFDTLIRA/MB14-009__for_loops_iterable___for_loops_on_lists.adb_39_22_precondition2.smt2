...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields1)) cu2) 1))) (and (< 0 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1)) (= (get (model__ (mk___rep l__split_discrs l__split_fields1)) i1) (- (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1) 1))))))
(assert (forall ((i1 Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields1)) cu2) i1) (<= i1 (length (mk___rep l__split_discrs l__split_fields1)))) (= (get (model__ (mk___rep l__split_discrs l__split_fields1)) i1) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1)))))
...
(assert (and (= o2 (positions (mk___rep l__split_discrs l__split_fields1))) (and (not (= (has_key o2 no_element) true)) (forall ((i1 us_rep2)) (=> (= (has_key o2 i1) true) (and (and (<= 1 (get1 o2 i1)) (<= (get1 o2 i1) (length (mk___rep l__split_discrs l__split_fields1)))) (forall ((j us_rep2)) (=> (= (has_key o2 j) true) (=> (= (get1 o2 i1) (get1 o2 j)) (= (bool_eq2 i1 j) true))))))))))
(assert (and (= o3 (get1 o2 cu2)) (and (in_range4 o3) (=> (= (distinct 0 0) true) (and (= o3 (w_get o2 (witness o2 cu2))) (forall ((k us_rep2)) (=> (= (has_key o2 k) true) (= (= (bool_eq2 k cu2) true) (= (witness o2 cu2) (witness o2 k))))))))))
(assert (= o4 (- o3 1)))
(assert (= o5 (ite (<= i o4) true false)))
(assert (= result3 (ite (<= 1 i) o5 false)))
(assert (= result3 true))
(assert (and (= o7 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (= (length1 o7) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (and (= o8 (get o7 i)) (in_range2 o8)))
(assert (= result4 (ite (< 0 o8) true false)))
(assert (= result4 true))
(assert (and (= o6 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (= (length1 o6) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
