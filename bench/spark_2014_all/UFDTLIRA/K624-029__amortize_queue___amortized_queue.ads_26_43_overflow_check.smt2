...
(assert (= o9 (+ 1 o8)))
(assert (and (= o10 (length (vector__content amortized_queue__Oconcat__2__result5))) (and (in_range2 o10) (<= o10 (capacity (vector__content amortized_queue__Oconcat__2__result5))))))
(assert (= result4 (ite (= o10 o9) true false)))
(assert (= result4 true))
(assert (and (= o7 (get (model__ (vector__content amortized_queue__Oconcat__2__result5)) 1)) (and (in_range5 o7) (= o7 (get (model__ (vector__content amortized_queue__Oconcat__2__result5)) 1)))))
