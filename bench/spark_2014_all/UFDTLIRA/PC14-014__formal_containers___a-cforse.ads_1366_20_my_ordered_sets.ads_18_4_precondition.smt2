...
(define-fun e_is_find ((container1 us_rep4) (item us_rep3) (position1 Int)) Bool (and (ite (< 0 position1) (e_bigger_than_range container1 1 (- position1 1) item) (distinct 1 0)) (ite (< position1 (length2 container1)) (e_smaller_than_range container1 (+ position1 1) (length2 container1) item) (distinct 1 0))))
