...
(define-fun in_range1 ((rec__private_record__result_ty__found1 Bool) (a us_rep)) Bool (= rec__private_record__result_ty__found1 (rec__private_record__result_ty__found (us_split_discrs1 a))))
...
(declare-datatypes () ((res_false__ref (mk_res_false__ref (res_false__content us_rep)))))
(define-fun res_false__ref___projection ((a res_false__ref)) us_rep (res_false__content a))
(declare-const r us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_239 us_rep) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (not (= temp___skip_constant_236 true)) (in_range1 (distinct 0 0) temp___expr_239)))
(define-fun default_initial_assumption ((temp___expr_241 us_rep) (temp___skip_top_level_242 Bool)) Bool (= (rec__private_record__result_ty__found (us_split_discrs1 temp___expr_241)) (distinct 0 0)))
(assert (not (= (distinct 0 0) (rec__private_record__result_ty__found (us_split_discrs1 r)))))
(check-sat)
(exit)
