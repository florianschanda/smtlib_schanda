...
(define-fun dynamic_invariant5 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_214)))
(assert true)
...
(declare-fun user_eq10 (telement_typeB telement_typeB) Bool)
(declare-const dummy10 telement_typeB)
...
(declare-const use_lists__incr_all_3__cu__assume count_type)
(declare-const temp___541 count_type)
(declare-const temp___5411 us_main_type)
(declare-const temp___542 Int)
(declare-const temp___545 us_rep3)
(declare-const temp___543 us_rep1)
...
(define-fun use_lists__incr_all_3__cu__assume1 () us_rep2 (mk___rep1 (mk___split_fields1 use_lists__incr_all_3__cu__assume)))
(assert (and (= use_lists__incr_all_3__cu__assume1 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq2 use_lists__incr_all_3__cu__assume1 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) use_lists__incr_all_3__cu__assume1) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) use_lists__incr_all_3__cu__assume1) 1)))))
(assert (= (mk___split_fields__ref1 (mk___split_fields1 result)) (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields))))
(assert (= use_lists__incr_all_3__cu__assume cu__split_fields1))
(assert (and (= result1 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields12))) (= (= result1 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields12)) true))))
(assert (=> (= result1 true) (and (= l__split_discrs (mk___split_discrs temp___541)) (= l__split_fields temp___5411))))
(assert (=> (= result1 true) (= temp___542 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result1 true) (= temp___545 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result1 true) (= temp___543 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result1 true) (= temp___540 cu__split_fields1)))
(assert (=> (= result1 true) (= temp___544 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result1 true) (= (length (mk___rep l__split_discrs l__split_fields11)) temp___542)))
(assert (=> (= result1 true) (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) 1))) (= (is_incr (get temp___543 n1) (get (model__ (mk___rep l__split_discrs l__split_fields11)) n1)) true)))))
(assert (=> (= result1 true) (forall ((n1 Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) n1) (<= n1 (length (mk___rep l__split_discrs l__split_fields11)))) (= (get temp___544 n1) (get (model__ (mk___rep l__split_discrs l__split_fields11)) n1))))))
(assert (=> (= result1 true) (= (oeq1 temp___545 (positions (mk___rep l__split_discrs l__split_fields11))) true)))
(assert (=> (= result1 true) (and (= o (element (mk___rep l__split_discrs l__split_fields11) (mk___rep1 cu__split_fields11))) (and (in_range5 o) (= o (get (model__ (mk___rep l__split_discrs l__split_fields11)) (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11))))))))
(assert (=> (= result1 true) (= result2 (ite (< o 2147483647) true false))))
(assert (=> (= result1 true) (=> (= result2 true) (and (= o1 (element (mk___rep l__split_discrs l__split_fields11) (mk___rep1 cu__split_fields11))) (and (in_range5 o1) (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields11)) (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)))))))))
(assert (=> (= result1 true) (=> (= result2 true) (= o2 (+ o1 1)))))
(assert (=> (= result1 true) (=> (= result2 true) (and (= o3 o2) (in_range7 o2)))))
(assert (=> (= result1 true) (=> (= result2 true) (and (and (and (= (length (mk___rep l__split_discrs l__split_fields10)) (length (mk___rep l__split_discrs l__split_fields11))) (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields11)) (positions (mk___rep l__split_discrs l__split_fields10))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields11))) o3)) (= (equal_except (model__ (mk___rep l__split_discrs l__split_fields11)) (model__ (mk___rep l__split_discrs l__split_fields10)) (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields11))) true)))))
(assert (=> (= result1 true) (=> (not (= result2 true)) (= l__split_fields10 l__split_fields11))))
(assert (=> (= result1 true) (ite (= (ite (= (bool_eq2 (mk___rep1 cu__split_fields11) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields11)) (length (mk___rep l__split_discrs l__split_fields10))) true) true) (= (bool_eq2 (mk___rep1 cu__split_fields10) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields11)) 1))))))
(assert (=> (= result1 true) (and (= o4 (has_key (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10))) (= (= o4 true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10)) true)))))
(assert (=> (= result1 true) (= result3 (ite (not (= o4 true)) true false))))
(assert (=> (= result1 true) (= result3 true)))
(assert (=> (= result1 true) (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields10))))
(assert (=> (= result1 true) (= l__split_fields4 (mk___split_fields__ref l__split_fields10))))
(assert (=> (= result1 true) (= cu__split_fields5 cu__split_fields10)))
(assert (=> (= result1 true) (= l__split_fields5 l__split_fields10)))
...
(assert (=> (not (= result1 true)) (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields12))))
(assert (=> (not (= result1 true)) (= l__split_fields6 (mk___split_fields__ref (mk___split_fields l__split_fields)))))
(assert (=> (not (= result1 true)) (= cu__split_fields7 cu__split_fields12)))
...
(assert (and (= o8 (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (and (not (= (has_key o8 no_element) true)) (forall ((i us_rep2)) (=> (= (has_key o8 i) true) (and (and (<= 1 (get1 o8 i)) (<= (get1 o8 i) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))) (forall ((j us_rep2)) (=> (= (has_key o8 j) true) (=> (= (get1 o8 i) (get1 o8 j)) (= (bool_eq2 i j) true))))))))))
(assert (and (= o9 (oeq1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o8)) (= (= o9 true) (and (forall ((key us_rep2)) (=> (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) key) true) (and (= (has_key o8 key) true) (= (get1 o8 key) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) key))))) (forall ((key us_rep2)) (=> (= (has_key o8 key) true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) key) true)))))))
(assert (and (= o5 (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (and (in_range1 o5) (<= o5 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
(assert (= o6 (ite (<= n o5) true false)))
(assert (= result4 (ite (<= 1 n) o6 false)))
(assert (= result4 true))
(assert (and (= o7 (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (= (length1 o7) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))))
(assert (not (<= n (last o7))))
(check-sat)
(exit)
