...
(assert (=> (= output_value (- 1)) (and (= out_11 0) (and (in_range1 out_11) (in_range1 output_port1)))))
(assert (=> (= output_value (- 1)) (and (= out_21 output_value) (and (in_range1 out_21) (in_range1 output_port2)))))
(assert (=> (not (= output_value (- 1))) (and (= out_12 output_value) (and (in_range1 out_12) (in_range1 output_port3)))))
