...
(declare-const result20 cursor__ref)
(declare-const temp___6342 us_rep)
(declare-const result21 Bool)
(define-fun e6 () int__ref (mk_int__ref e))
...
(assert (=> (= result15 true) (= result16 e6)))
(assert (=> (= result15 true) (= e2 o6)))
(assert (=> (= result15 true) (= e3 (mk_int__ref e2))))
(assert (=> (= result15 true) (= e4 e2)))
(assert (=> (not (= result15 true)) (= e3 e6)))
(assert (=> (not (= result15 true)) (= e4 e1)))
...
(assert (and (= (has_element (mk___rep1 my_container__split_fields1) temp___6341) true) (= e5 (element (mk___rep1 my_container__split_fields1) temp___6341))))
(assert (= result18 (mk_bool__ref b8)))
(assert (= b9 (distinct 0 0)))
(assert (and (= o7 (next (mk___rep1 my_container__split_fields1) temp___6341)) (= o7 (ite (< (to_rep (rec__container__cursor__index (us_split_fields1 temp___6341))) 200) (mk___rep (mk___split_fields (of_rep (+ (to_rep (rec__container__cursor__index (us_split_fields1 temp___6341))) 1)))) (mk___rep (mk___split_fields rliteral1))))))
(assert (and (= o8 (has_element (mk___rep1 my_container__split_fields1) o7)) (= (= o8 true) (and (<= 1 (to_rep (rec__container__cursor__index (us_split_fields1 o7)))) (<= (to_rep (rec__container__cursor__index (us_split_fields1 o7))) 200)))))
(assert (= result19 (ite (not (= o8 true)) true false)))
(assert (not (= result19 true)))
(assert (and (= o9 (next (mk___rep1 my_container__split_fields1) temp___6341)) (= o9 (ite (< (to_rep (rec__container__cursor__index (us_split_fields1 temp___6341))) 200) (mk___rep (mk___split_fields (of_rep (+ (to_rep (rec__container__cursor__index (us_split_fields1 temp___6341))) 1)))) (mk___rep (mk___split_fields rliteral1))))))
(assert (= result20 (mk_cursor__ref temp___6341)))
(assert (= temp___6342 o9))
(assert (and (= result21 (has_element (mk___rep1 my_container__split_fields1) temp___6342)) (= (= result21 true) (and (<= 1 (to_rep (rec__container__cursor__index (us_split_fields1 temp___6342)))) (<= (to_rep (rec__container__cursor__index (us_split_fields1 temp___6342))) 200)))))
(assert (= result21 true))
(assert (not (= (has_element (mk___rep1 my_container__split_fields1) temp___6342) true)))
(check-sat)
(exit)
