...
(define-fun tint_arrayD1__ref___7__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___7__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t176b__ref (mk_t176b__ref (t176b__content integer)))))
(define-fun t176b__ref___projection ((a t176b__ref)) integer (t176b__content a))
(declare-sort t2 0)
...
(define-fun tnumber_array_typeD1__ref___7__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___7__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t180b__ref (mk_t180b__ref (t180b__content integer)))))
(define-fun t180b__ref___projection ((a t180b__ref)) integer (t180b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t182b__ref (mk_t182b__ref (t182b__content integer)))))
(define-fun t182b__ref___projection ((a t182b__ref)) integer (t182b__content a))
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__aggregate_def (Int Int Int Int Int Int Int Int Int Int Int Int) us_t2)
(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__aggregate_def (Int Int Int) us_t4)
...
(define-fun tint_arrayB__ref___7__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-const rliteral integer)
(assert (= (integerqtint rliteral) 2))
(declare-const rliteral1 integer)
(assert (= (integerqtint rliteral1) 1))
(declare-const rliteral2 integer)
(assert (= (integerqtint rliteral2) 4))
(declare-const rliteral3 integer)
(assert (= (integerqtint rliteral3) 6))
(declare-const rliteral4 integer)
(assert (= (integerqtint rliteral4) 9))
(assert (forall ((temp___1512 Int) (temp___1513 Int) (temp___1514 Int) (temp___1515 Int) (temp___1516 Int) (temp___1517 Int) (temp___1518 Int) (temp___1519 Int) (temp___1520 Int) (temp___1521 Int) (temp___1522 Int) (temp___1523 Int)) (let ((temp___1511 (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__aggregate_def temp___1512 temp___1513 temp___1514 temp___1515 temp___1516 temp___1517 temp___1518 temp___1519 temp___1520 temp___1521 temp___1522 temp___1523))) (=> (and (and (and (and (and (and (and (and (and (dynamic_invariant temp___1512 true true true true) (dynamic_invariant temp___1513 true true true true)) (dynamic_invariant temp___1514 true true true true)) (dynamic_invariant temp___1515 true true true true)) (dynamic_invariant temp___1516 true true true true)) (dynamic_invariant temp___1517 true true true true)) (dynamic_invariant temp___1518 true true true true)) (dynamic_invariant temp___1519 true true true true)) (dynamic_invariant temp___1520 true true true true)) (dynamic_invariant temp___1521 true true true true)) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1522 temp___1523) (and (= (first5 temp___1511) temp___1522) (= (last5 temp___1511) temp___1523))) (and (and (and (and (and (and (and (and (and (= (select (to_array2 temp___1511) (+ (first1 source) 0)) rliteral) (= (select (to_array2 temp___1511) (+ (first1 source) 1)) rliteral1)) (= (select (to_array2 temp___1511) (+ (first1 source) 2)) rliteral2)) (= (select (to_array2 temp___1511) (+ (first1 source) 3)) rliteral3)) (= (select (to_array2 temp___1511) (+ (first1 source) 4)) rliteral4)) (= (select (to_array2 temp___1511) (+ (first1 source) 5)) rliteral4)) (= (select (to_array2 temp___1511) (+ (first1 source) 6)) rliteral4)) (= (select (to_array2 temp___1511) (+ (first1 source) 7)) rliteral4)) (= (select (to_array2 temp___1511) (+ (first1 source) 8)) rliteral4)) (= (select (to_array2 temp___1511) (+ (first1 source) 9)) rliteral4)))))))
(define-fun dynamic_invariant4 ((temp___expr_314 us_t3) (temp___is_init_310 Bool) (temp___skip_constant_311 Bool) (temp___do_toplevel_312 Bool) (temp___do_typ_inv_313 Bool)) Bool (=> (not (= temp___skip_constant_311 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_314) (last7 temp___expr_314)) (and (= (first7 temp___expr_314) (first1 source)) (= (last7 temp___expr_314) (+ (first1 source) 9))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___7__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-const rliteral5 integer)
(assert (= (integerqtint rliteral5) 0))
(assert (forall ((temp___1529 Int) (temp___1530 Int) (temp___1531 Int)) (let ((temp___1528 (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__aggregate_def temp___1529 temp___1530 temp___1531))) (=> (dynamic_invariant temp___1529 true true true true) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1530 temp___1531) (and (= (first9 temp___1528) temp___1530) (= (last9 temp___1528) temp___1531))) (forall ((temp___1532 Int)) (= (select (to_array4 temp___1528) temp___1532) rliteral5)))))))
...
(declare-const temp___1526 (Array Int integer))
(declare-const temp___15261 t2)
...
(declare-const temp___1534 (Array Int integer))
(declare-const temp___15341 t4)
...
(declare-const temp___1539 (Array Int integer))
(declare-const o Int)
...
(assert (and (and (= (length source) 10) (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55))) (forall ((index7 Int)) (=> (and (<= (to_rep1 (first (rt source))) index7) (<= index7 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index7))) true)))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__aggregate_def 2 1 4 6 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__aggregate_def 2 1 4 6 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t2 temp___1526 temp___15261) (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__aggregate_def 2 1 4 6 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___15261)) (to_rep1 (last4 temp___15261))) (+ (- (to_rep1 (last4 temp___15261)) (to_rep1 (first4 temp___15261))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1526 (to_rep1 (first4 temp___15261)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__assume))
(assert (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__assume1))
(assert (= (mk_map__ref1 result) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__assume1))))
...
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t4 temp___1534 temp___15341) (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___15341)) (to_rep1 (last8 temp___15341))) (+ (- (to_rep1 (last8 temp___15341)) (to_rep1 (first8 temp___15341))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1534 (to_rep1 (first8 temp___15341)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__assume))
(assert (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__assume1))))
...
(assert (and (= temp___1537 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= temp___1541 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= temp___1539 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= o index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= o1 (select n1 o))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= o3 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= o5 (to_rep o4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= o7 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= n1 result3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= n2 o8)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (forall ((i Int)) (=> (and (<= (to_rep1 (first (rt source))) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt source))) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (and (and (forall ((temp___1540 Int)) (=> (and (<= (to_rep1 n__first) temp___1540) (<= temp___1540 (to_rep1 n__last))) (=> (or (< temp___1537 temp___1540) (or (< temp___1540 (to_rep1 (first (rt source)))) (< index2 temp___1540))) (= (select n3 temp___1540) (select temp___1539 temp___1540))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= index2 temp___1537)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= index2 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= n3 n4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= index4 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= n5 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= index6 index4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537)) (= n7 n5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537))) (= index6 index1)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1537))) (= n7 n1)))
...
(assert (and (= temp___1542 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1542) (<= temp___1542 (to_rep1 n__last))))
(assert (= o9 temp___1542))
(assert (= o10 (select (map__content1 n6) o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= result4 (mk_int__ref target)))
(assert (= target1 o11))
(assert (<= target1 9))
(assert (and (= temp___1543 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1543) (<= temp___1543 (to_rep1 n__last))))
(assert (= o12 temp___1543))
...
(assert (= target2 o18))
(assert (<= target2 99))
(assert (and (= temp___1544 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___1544) (<= temp___1544 (to_rep1 n__last))))
(assert (= o19 temp___1544))
...
(assert (= target3 o25))
(assert (<= target3 999))
(assert (and (= temp___1545 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___1545) (<= temp___1545 (to_rep1 n__last))))
(assert (= o26 temp___1545))
...
(assert (= target4 o32))
(assert (<= target4 9999))
(assert (and (= temp___1546 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___1546) (<= temp___1546 (to_rep1 n__last))))
(assert (= o33 temp___1546))
...
(assert (and (= temp___1547 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___1547) (<= temp___1547 (to_rep1 n__last))))
(assert (= o40 temp___1547))
...
(assert (and (= temp___1548 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___1548) (<= temp___1548 (to_rep1 n__last))))
(assert (= o47 temp___1548))
...
(assert (= target7 o53))
(assert (<= target7 6999999))
(assert (not (in_range1 (+ target7 2140000000))))
(check-sat)
(exit)
