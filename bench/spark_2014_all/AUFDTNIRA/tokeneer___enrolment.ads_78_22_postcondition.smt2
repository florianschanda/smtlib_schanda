...
(declare-const temp___1748 us_t)
...
(declare-const thistisinfo__split_fields13 us_split_fields2)
(declare-const state20 us_private)
(declare-const store11 us_private)
(declare-const thistisinfo__split_fields14 us_split_fields__ref1)
(declare-const state21 us_private__ref)
(declare-const store12 us_private__ref)
(declare-const thistisinfo__split_fields15 us_split_fields2)
...
(declare-const thistisinfo__split_fields16 us_split_fields__ref1)
...
(declare-const thistisinfo__split_fields17 us_split_fields2)
...
(assert (=> (not (= closedok true)) (dynamic_property 1 2147483647 1 29)))
(assert (=> (not (= closedok true)) (= temp___1748 (mk___t (temp___String_Literal_1747 Tuple0) (mk 1 29)))))
(assert (=> (not (= closedok true)) (dynamic_predicate temp___1748)))
(assert (=> (not (= closedok true)) (= o10 temp___1748)))
(assert (=> (not (= closedok true)) (= o11 (makedescription o10 (int__content certno7)))))
(assert (=> (not (= closedok true)) (= result7 description8)))
(assert (=> (not (= closedok true)) (= description10 o11)))
(assert (=> (not (= closedok true)) (= result8 dataok7)))
(assert (=> (not (= closedok true)) (= dataok9 (distinct 0 0))))
...
(assert (=> (not (= (bool__content dataok10) true)) (not (= (privatekeypresent thistisinfo__split_fields13 state20) true))))
...
(assert (=> (not (= (bool__content dataok10) true)) (= thistisinfo__split_fields14 (mk___split_fields__ref1 thistisinfo__split_fields13))))
(assert (=> (not (= (bool__content dataok10) true)) (= store13 store11)))
(assert (=> (not (= (bool__content dataok10) true)) (= state22 state20)))
(assert (=> (not (= (bool__content dataok10) true)) (= thistisinfo__split_fields15 thistisinfo__split_fields13)))
(assert (=> (not (not (= (bool__content dataok10) true))) (= store12 store9)))
(assert (=> (not (not (= (bool__content dataok10) true))) (= state21 state17)))
(assert (=> (not (not (= (bool__content dataok10) true))) (= thistisinfo__split_fields14 thistisinfo__split_fields11)))
(assert (=> (not (not (= (bool__content dataok10) true))) (= store13 store10)))
(assert (=> (not (not (= (bool__content dataok10) true))) (= state22 state19)))
(assert (=> (not (not (= (bool__content dataok10) true))) (= thistisinfo__split_fields15 thistisinfo__split_fields12)))
...
(assert (= auditsystemfault10 auditsystemfault8))
(assert (= auditalarm10 auditalarm8))
(assert (= logfilestate__split_fields16 logfilestate__split_fields14))
(assert (= logfilesstatus10 logfilesstatus8))
(assert (= logfiles10 logfiles8))
...
(assert (= auditsystemfault11 auditsystemfault9))
(assert (= auditalarm11 auditalarm9))
(assert (= logfilestate__split_fields17 logfilestate__split_fields15))
(assert (= logfilesstatus11 logfilesstatus9))
(assert (= logfiles11 logfiles9))
(assert (= (privatekeypresent (us_split_fields__content1 thistisinfo__split_fields16) (us_private__content state24)) true))
(assert (not (= (bool__content dataok12) true)))
(check-sat)
(exit)
