...
(assert (=> (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo result____split_fields3))) (= result5 (ite (<= (extended_indexqtint (rec__sums__slice_bounds__hi result____split_fields3)) (to_rep (last (rt x)))) true false))))
(assert (=> (not (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo result____split_fields3)))) (= result5 false)))
(assert (= result5 true))
