...
(define-fun o23 () us_rep10 (mk___rep5 (mk___split_fields5 o5 o6 o7)))
(assert (and (= o21 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o21) (= o21 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o19 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o19) (<= o19 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (= o20 (* 2 o19)))
(assert (and (= o22 o20) (in_range10 o20)))
(assert (= result (ite (<= o22 o21) true false)))
(assert (= result true))
(assert (and (= o18 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o18) (<= o18 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (= result1 (ite (<= o18 5000) true false)))
(assert (= result1 true))
...
(assert (= result2 true))
(assert (and (= o16 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1)) (= (= o16 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1) true))))
(assert (= o17 true))
...
(assert (= result3 true))
(assert (and (= o14 (has_key (positions x) c)) (= (= o14 true) (= (has_key (positions x) c) true))))
(assert (= o15 true))
...
(assert (and (= o23 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) o4)) (= (bool_eq9 o23 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) o4)) true)))
(assert (= o5 o8))
(assert (= o6 o9))
(assert (= o7 o10))
(assert (= o11 o9))
...
(assert (not (<= o3 (last (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(check-sat)
(exit)
