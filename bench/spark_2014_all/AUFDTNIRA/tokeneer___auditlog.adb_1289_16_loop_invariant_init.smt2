...
(assert (not (= (to_rep4 logfilestate__split_fields1) (+ (* (- (to_rep5 logfilestate__split_fields5) 1) 1024) (to_rep6 (select logfilestate__split_fields6 (to_rep3 logfilestate__split_fields)))))))
(check-sat)
(exit)
