...
(assert (<= 1 i9))
(assert (<= i9 200))
(assert (and (= o17 (+ x31 1)) (in_range4 (+ x31 1))))
(assert (= result34 (mk_int__ref x31)))
(assert (= x32 o17))
(assert (and (and (=> (<= 1 200) (in_range4 i10)) (=> (<= 1 200) (in_range4 x33))) (and (<= 1 i10) (<= i10 200))))
(assert (= result35 (mk_int__ref temp___648)))
(assert (= temp___6481 i10))
(assert (= result36 (mk_int__ref temp___649)))
(assert (= temp___6491 x33))
(assert (not (= i10 200)))
(assert (= result37 (mk_int__ref i10)))
(assert (= i11 (+ i10 1)))
(assert (and (= o18 (+ x33 1)) (in_range4 (+ x33 1))))
(assert (= result38 (mk_int__ref x33)))
(assert (= x34 o18))
(assert (not (< temp___6481 i11)))
(check-sat)
(exit)
