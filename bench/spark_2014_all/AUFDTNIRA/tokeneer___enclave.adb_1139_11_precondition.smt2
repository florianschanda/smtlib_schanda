...
(assert (= status 6))
(assert (and (= result (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result true) (in_range7 (to_rep2 theadmin__split_fields)))))
(assert (= result true))
(assert (and (= result1 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result1 true) (in_range6 (to_rep3 theadmin__split_fields1)))))
(assert (= result1 true))
