...
(assert (and (= o20 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range1 o20) (= o20 (to_rep theadmin__split_fields)))))
(assert (and (= o21 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range1 o21) (= o21 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= o22 (ite (= o21 o20) true false)))
(assert (and (= o12 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range1 o12) (= o12 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result (ite (= o12 1) true false)))
(assert (=> (= result true) (and (= o16 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o16 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result true) (= o17 (ite (not (= o16 true)) true false))))
(assert (=> (= result true) (and (= o13 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range3 o13))))
(assert (=> (= result true) (= o14 (ite (= o13 3) true false))))
(assert (=> (= result true) (and (= o15 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o15 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
...
(assert (and (= result2 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result2 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (=> (= result2 true) (and (= o9 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range3 o9))))
(assert (=> (= result2 true) (= result1 (ite (= o9 3) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o10 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range1 o10) (= o10 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result1 true) (= o11 (ite (= o10 1) true false))))
(assert (=> (not (= result1 true)) (= o11 (distinct 1 0))))
(assert (and (= o2 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range1 o2) (= o2 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result3 (ite (= o2 1) true false)))
(assert (=> (= result3 true) (and (= o5 (theauthcertrole tokenpresence state tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content6 idcert__split_fields))) (and (in_range1 o5) (= o5 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content9 authcert__split_fields))))))))
(assert (=> (= result3 true) (= o6 (ite (= o5 1) true false))))
(assert (=> (= result3 true) (and (= o3 (authcertvalid tokenpresence state tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content6 idcert__split_fields))) (= (= o3 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content9 authcert__split_fields)) true)))))
(assert (=> (= result3 true) (and (= o4 (isgood tokenpresence state tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content6 idcert__split_fields))) (= (= o4 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content6 idcert__split_fields)) true)))))
...
(assert (=> (= (int__content status3) 3) (and (= o (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
