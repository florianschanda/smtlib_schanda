...
(declare-const temp___1816 logfileindext)
(declare-const temp___18161 logentrycountt)
(declare-const temp___18162 (Array Int logfileindext))
(declare-const temp___18163 logfileindext)
(declare-const temp___18164 logfileindext)
(declare-const temp___18165 logfilecountt)
(declare-const temp___18166 (Array Int fileentrycountt))
...
(assert (and (= o (+ (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1)) (in_range6 (+ (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1))))
(assert (= (to_rep4 o1) o))
(assert (= o2 (store logfilestate__split_fields6 (to_rep1 logfilestate__split_fields) o1)))
(assert (= logfilestate__split_fields o3))
(assert (= logfilestate__split_fields1 o4))
(assert (= logfilestate__split_fields2 o5))
(assert (= logfilestate__split_fields3 o6))
(assert (= logfilestate__split_fields4 o7))
(assert (= logfilestate__split_fields5 o8))
(assert (= o2 o9))
(assert (= temp___1816 o3))
(assert (= temp___18161 o4))
(assert (= temp___18162 o5))
(assert (= temp___18163 o6))
(assert (= temp___18164 o7))
(assert (= temp___18165 o8))
(assert (= temp___18166 o9))
(assert (= result2 logfilestate__split_fields))
(assert (= result3 logfilestate__split_fields1))
(assert (= result4 logfilestate__split_fields2))
(assert (= result5 logfilestate__split_fields3))
(assert (= result6 logfilestate__split_fields4))
(assert (= result7 logfilestate__split_fields5))
(assert (= result8 logfilestate__split_fields6))
(assert (= temp___1816 logfilestate__split_fields7))
(assert (= temp___18161 logfilestate__split_fields8))
(assert (= temp___18162 logfilestate__split_fields9))
(assert (= temp___18163 logfilestate__split_fields10))
(assert (= temp___18164 logfilestate__split_fields11))
(assert (= temp___18165 logfilestate__split_fields12))
(assert (= temp___18166 logfilestate__split_fields13))
...
(assert (not (= (to_rep4 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields14)) (to_rep1 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields14))))) (+ (to_rep4 (select logfilestate__split_fields6 (to_rep1 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields14))))) 1))))
(check-sat)
(exit)
