...
(assert (<= 1 (to_rep1 (rec__partition_refinement__interval__count p_elem__split_fields1))))
(assert (<= (to_rep1 (rec__partition_refinement__interval__count p_elem__split_fields1)) (- (to_rep2 (rec__partition_refinement__interval__last p_elem__split_fields1)) (to_rep2 (rec__partition_refinement__interval__first p_elem__split_fields1)))))
(assert (and (= o1 (+ (to_rep2 (rec__partition_refinement__interval__first p_elem__split_fields1)) (to_rep1 (rec__partition_refinement__interval__count p_elem__split_fields1)))) (in_range3 (+ (to_rep2 (rec__partition_refinement__interval__first p_elem__split_fields1)) (to_rep1 (rec__partition_refinement__interval__count p_elem__split_fields1))))))
(assert (= (to_rep2 o2) o1))
(assert (= o3 (mk___split_fields1 o2 (rec__partition_refinement__interval__last p_elem__split_fields1) rliteral)))
(assert (= temp___1288 (mk___rep1 o3)))
(assert (= result2 (mk___split_fields__ref1 p_prime__split_fields)))
(assert (= p_prime__split_fields1 (us_split_fields3 temp___1288)))
...
(assert (= o6 (mk___split_fields1 (rec__partition_refinement__interval__first p_elem__split_fields1) o5 (rec__partition_refinement__interval__count p_elem__split_fields1))))
(assert (= temp___1290 (mk___rep1 o6)))
(assert (= result3 (mk___split_fields__ref1 p_elem__split_fields1)))
(assert (= p_elem__split_fields2 (us_split_fields3 temp___1290)))
(assert (= result4 (mk___split_fields__ref1 p_elem__split_fields2)))
(assert (= p_elem__split_fields3 (mk___split_fields1 (rec__partition_refinement__interval__first p_elem__split_fields2) (rec__partition_refinement__interval__last p_elem__split_fields2) rliteral)))
(assert (and (and (= (length (mk___rep p__split_discrs partition_refinement__partitions__replace_element__container__fields)) (length (mk___rep p__split_discrs p__split_fields1))) (= (bool_eq (get (model__ (mk___rep p__split_discrs partition_refinement__partitions__replace_element__container__fields)) j2) (mk___rep1 p_elem__split_fields3)) true)) (= (equal_except (model__ (mk___rep p__split_discrs p__split_fields1)) (model__ (mk___rep p__split_discrs partition_refinement__partitions__replace_element__container__fields)) j2) true)))
(assert (= result5 (mk___split_fields__ref p__split_fields1)))
...
(assert (= (length (mk___rep p__split_discrs p__split_fields3)) (+ save_length 1)))
(assert (= p_prime_index2 (- (length (mk___rep p__split_discrs p__split_fields3)) 1)))
(assert (= (bool_eq (get (model__ (mk___rep p__split_discrs p__split_fields3)) p_prime_index2) (mk___rep1 p_prime__split_fields1)) true))
(assert (= f1 f_loop_entry))
(assert (= (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) r54b))
(assert (in_range3 r54b))
(assert (= (to_rep2 (rec__partition_refinement__interval__last p_prime__split_fields1)) r55b))
(assert (in_range3 r55b))
(assert (= result8 (mk_int__ref i)))
(assert (= i1 r54b))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (= temp___1299 i1)))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (= temp___1297 f1)))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (= (to_rep3 o9) p_prime_index2)))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (= o10 (store f1 i1 o9))))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (= result9 (mk_map__ref f1))))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (= f2 o10)))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (forall ((k1 Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) k1) (<= k1 i2)) (= (to_rep3 (select f3 k1)) p_prime_index2)))))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 (- (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) 1))) (= (to_rep3 (select f3 k1)) (to_rep3 (select f_loop_entry k1)))))))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 5)) (= (to_rep3 (select f3 k1)) (to_rep3 (select f_loop_entry k1)))))))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (and (and (forall ((temp___1298 Int)) (=> (and (<= 0 temp___1298) (<= temp___1298 5)) (=> (or (< r55b temp___1298) (or (< temp___1298 r54b) (< i2 temp___1298))) (= (select f3 temp___1298) (select temp___1297 temp___1298))))) (=> (<= r54b r55b) (dynamic_property r54b r55b i2))) (and (<= r54b i2) (<= i2 r55b)))))
...
(assert (forall ((k1 Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) k1) (<= k1 (to_rep2 (rec__partition_refinement__interval__last p_prime__split_fields1)))) (= (to_rep3 (select (map__content f6) k1)) (- (length (mk___rep p__split_discrs p__split_fields3)) 1)))))
(assert (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 (- (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) 1))) (and (<= 0 (to_rep3 (select (map__content f6) k1))) (<= (to_rep3 (select (map__content f6) k1)) (- (length (mk___rep p__split_discrs p__split_fields3)) 1))))))
(assert (forall ((k1 Int)) (=> (and (<= (+ (to_rep2 (rec__partition_refinement__interval__last p_prime__split_fields1)) 1) k1) (<= k1 5)) (and (<= 0 (to_rep3 (select (map__content f6) k1))) (<= (to_rep3 (select (map__content f6) k1)) (- (length (mk___rep p__split_discrs p__split_fields3)) 1))))))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first p_elem__split_fields3)) k1) (<= k1 (to_rep2 (rec__partition_refinement__interval__last p_elem__split_fields3)))) (= (bool_eq (get (model__ (mk___rep p__split_discrs p__split_fields3)) (to_rep3 (select (map__content f6) k1))) (mk___rep1 p_elem__split_fields3)) true))))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first p_elem__split_fields3)) k1) (<= k1 (to_rep2 (rec__partition_refinement__interval__last p_elem__split_fields3)))) (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) (to_rep3 (select (map__content f6) k1)))))) k1) (<= k1 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) (to_rep3 (select (map__content f6) k1)))))))))))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) k1) (<= k1 (to_rep2 (rec__partition_refinement__interval__last p_prime__split_fields1)))) (= (bool_eq (get (model__ (mk___rep p__split_discrs p__split_fields3)) (to_rep3 (select (map__content f6) k1))) (mk___rep1 p_prime__split_fields1)) true))))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) k1) (<= k1 (to_rep2 (rec__partition_refinement__interval__last p_prime__split_fields1)))) (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) (to_rep3 (select (map__content f6) k1)))))) k1) (<= k1 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) (to_rep3 (select (map__content f6) k1)))))))))))
(assert (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 (- (to_rep2 (rec__partition_refinement__interval__first p_elem__split_fields3)) 1))) (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) (to_rep3 (select (map__content f6) k1)))))) k1) (<= k1 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) (to_rep3 (select (map__content f6) k1)))))))))))
(assert (forall ((k1 Int)) (=> (and (<= (+ (to_rep2 (rec__partition_refinement__interval__last p_prime__split_fields1)) 1) k1) (<= k1 5)) (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) (to_rep3 (select (map__content f6) k1)))))) k1) (<= k1 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) (to_rep3 (select (map__content f6) k1)))))))))))
(assert (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 (- j2 1))) (forall ((l1 Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) k1)))) l1) (<= l1 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) k1)))))) (= (to_rep3 (select (map__content f6) l1)) k1))))))
(assert (forall ((l1 Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) j2)))) l1) (<= l1 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) j2)))))) (= (to_rep3 (select (map__content f6) l1)) j2))))
(assert (and (= o12 (length (mk___rep p__split_discrs p__split_fields3))) (and (in_range1 o12) (<= o12 (capacity (mk___rep p__split_discrs p__split_fields3))))))
(assert (= o13 (- o12 1)))
(assert (= o14 (ite (<= k o13) true false)))
(assert (and (= o11 (+ j2 1)) (in_range7 (+ j2 1))))
(assert (= o15 (ite (<= o11 k) true false)))
(assert (= result10 (ite (= o15 true) o14 false)))
(assert (= result10 true))
(assert (and (= o21 k) (in_range9 k)))
(assert (and (= o22 (get (model__ (mk___rep p__split_discrs p__split_fields3)) o21)) (= (bool_eq o22 (get (model__ (mk___rep p__split_discrs p__split_fields3)) o21)) true)))
(assert (= o23 (us_split_fields3 o22)))
(assert (= o24 (rec__partition_refinement__interval__last o23)))
(assert (= o25 (to_rep2 o24)))
(assert (= o26 (ite (<= l o25) true false)))
(assert (and (= o16 k) (in_range9 k)))
(assert (and (= o17 (get (model__ (mk___rep p__split_discrs p__split_fields3)) o16)) (= (bool_eq o17 (get (model__ (mk___rep p__split_discrs p__split_fields3)) o16)) true)))
(assert (= o18 (us_split_fields3 o17)))
(assert (= o19 (rec__partition_refinement__interval__first o18)))
(assert (= o20 (to_rep2 o19)))
(assert (= o27 (ite (<= o20 l) true false)))
(assert (= result11 (ite (= o27 true) o26 false)))
