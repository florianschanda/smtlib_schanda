...
(define-fun in_range20 ((x Int)) Bool (and (<= 0 x) (<= x 8)))
...
(declare-fun user_eq30 (statust statust) Bool)
(declare-const dummy30 statust)
...
(define-fun dynamic_invariant5 ((temp___expr_2867 Int) (temp___is_init_2863 Bool) (temp___skip_constant_2864 Bool) (temp___do_toplevel_2865 Bool) (temp___do_typ_inv_2866 Bool)) Bool (=> (or (= temp___is_init_2863 true) (<= 0 8)) (in_range20 temp___expr_2867)))
(assert true)
...
(declare-fun user_eq31 (enrolmentstates enrolmentstates) Bool)
(declare-const dummy31 enrolmentstates)
...
(assert true)
(assert (forall ((enclave__status Int)) (! (= (= (enrolmentisinprogress enclave__status) true) (in_range21 enclave__status)) :pattern ((enrolmentisinprogress enclave__status)))))
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-fun ispresent1 (Int us_private Int Int us_split_fields18 us_split_fields12) Bool)
(declare-fun ispresent__function_guard1 (Bool Int us_private Int Int us_split_fields18 us_split_fields12) Bool)
(declare-fun adminlogoncanstart (Int us_split_fields Int us_private Int Int us_split_fields18 us_split_fields12) Bool)
(declare-fun adminlogoncanstart__function_guard (Bool Int us_split_fields Int us_private Int Int us_split_fields18 us_split_fields12) Bool)
(assert true)
(assert (forall ((enclave__status Int) (admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((enclave__startadminactivity__theadmin__fields us_split_fields)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields18)) (forall ((admintoken__idcert__fields us_split_fields12)) (! (= (= (adminlogoncanstart enclave__status enclave__startadminactivity__theadmin__fields admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true) (and (and (not (= (ispresent (mk___rep enclave__startadminactivity__theadmin__fields)) true)) (= enclave__status 3)) (= (ispresent1 admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true))) :pattern ((adminlogoncanstart enclave__status enclave__startadminactivity__theadmin__fields admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields)))))))))
(declare-fun adminopcanstart (Int us_split_fields Int us_private Int Int us_split_fields18 us_split_fields12) Bool)
(declare-fun adminopcanstart__function_guard (Bool Int us_split_fields Int us_private Int Int us_split_fields18 us_split_fields12) Bool)
(assert true)
(assert (forall ((enclave__status Int) (admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((enclave__startadminactivity__theadmin__fields us_split_fields)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields18)) (forall ((admintoken__idcert__fields us_split_fields12)) (! (= (= (adminopcanstart enclave__status enclave__startadminactivity__theadmin__fields admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true) (and (and (= (ispresent (mk___rep enclave__startadminactivity__theadmin__fields)) true) (= enclave__status 3)) (= (ispresent1 admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true))) :pattern ((adminopcanstart enclave__status enclave__startadminactivity__theadmin__fields admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields)))))))))
(declare-sort filestatust 0)
(define-fun in_range22 ((x Int)) Bool (and (<= 0 x) (<= x 2)))
...
(declare-fun user_eq32 (filestatust filestatust) Bool)
(declare-const dummy32 filestatust)
...
(assert (forall ((x filestatust)) (! (in_range22 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(define-fun in_range23 ((x Int)) Bool (and (<= 1 x) (<= x 17)))
...
(declare-fun user_eq33 (logfileindext logfileindext) Bool)
(declare-const dummy33 logfileindext)
...
(assert (forall ((x logfileindext)) (! (in_range23 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(define-fun in_range24 ((x Int)) Bool (and (<= 0 x) (<= x 17408)))
...
(declare-fun user_eq34 (logentrycountt logentrycountt) Bool)
(declare-const dummy34 logentrycountt)
...
(assert (forall ((x logentrycountt)) (! (in_range24 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(define-fun in_range25 ((x Int)) Bool (and (<= 0 x) (<= x 17)))
...
(declare-fun user_eq35 (logfilecountt logfilecountt) Bool)
(declare-const dummy35 logfilecountt)
...
(assert (forall ((x logfilecountt)) (! (in_range25 (to_rep17 x)) :pattern ((to_rep17 x)))))
...
(declare-const dummy36 (Array Int logfileindext))
...
(declare-fun user_eq36 ((Array Int logfileindext) (Array Int logfileindext)) Bool)
...
(define-fun in_range26 ((x Int)) Bool (and (<= 0 x) (<= x 1024)))
...
(declare-fun user_eq38 (fileentrycountt fileentrycountt) Bool)
(declare-const dummy38 fileentrycountt)
...
(assert (forall ((x fileentrycountt)) (! (in_range26 (to_rep18 x)) :pattern ((to_rep18 x)))))
...
(declare-const dummy39 (Array Int fileentrycountt))
...
(declare-fun user_eq39 ((Array Int fileentrycountt) (Array Int fileentrycountt)) Bool)
...
(declare-fun user_eq40 (us_rep11 us_rep11) Bool)
(declare-const dummy40 us_rep11)
...
(declare-fun user_eq41 (us_rep12 us_rep12) Bool)
(declare-const dummy41 us_rep12)
(declare-datatypes () ((t__ref1 (mk_t__ref1 (t__content1 us_rep12)))))
(define-fun t__ref___2__projection ((a t__ref1)) us_rep12 (t__content1 a))
...
(define-fun dynamic_invariant6 ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 1)) (in_range27 temp___expr_548)))
...
(define-fun dynamic_invariant8 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range10 temp___expr_74)))
(define-fun dynamic_invariant9 ((temp___expr_2954 Int) (temp___is_init_2950 Bool) (temp___skip_constant_2951 Bool) (temp___do_toplevel_2952 Bool) (temp___do_typ_inv_2953 Bool)) Bool (=> (or (= temp___is_init_2950 true) (<= 0 2)) (in_range21 temp___expr_2954)))
(define-fun dynamic_invariant10 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 4)) (in_range2 temp___expr_496)))
(define-fun dynamic_invariant11 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 3)) (in_range4 temp___expr_433)))
(define-fun dynamic_invariant12 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range16 temp___expr_440)))
(assert true)
(define-fun dynamic_invariant13 ((temp___expr_1092 Int) (temp___is_init_1088 Bool) (temp___skip_constant_1089 Bool) (temp___do_toplevel_1090 Bool) (temp___do_typ_inv_1091 Bool)) Bool (=> (or (= temp___is_init_1088 true) (<= 0 40)) (in_range9 temp___expr_1092)))
(define-fun dynamic_invariant14 ((temp___expr_1116 Int) (temp___is_init_1112 Bool) (temp___skip_constant_1113 Bool) (temp___do_toplevel_1114 Bool) (temp___do_typ_inv_1115 Bool)) Bool (=> (or (= temp___is_init_1112 true) (<= 0 4294967295)) (in_range11 temp___expr_1116)))
(define-fun dynamic_invariant15 ((temp___expr_1140 Int) (temp___is_init_1136 Bool) (temp___skip_constant_1137 Bool) (temp___do_toplevel_1138 Bool) (temp___do_typ_inv_1139 Bool)) Bool (=> (or (= temp___is_init_1136 true) (<= 0 10)) (in_range13 temp___expr_1140)))
(define-fun dynamic_invariant16 ((temp___expr_1154 Int) (temp___is_init_1150 Bool) (temp___skip_constant_1151 Bool) (temp___do_toplevel_1152 Bool) (temp___do_typ_inv_1153 Bool)) Bool (=> (or (= temp___is_init_1150 true) (<= 0 4294967295)) (in_range14 temp___expr_1154)))
(define-fun dynamic_invariant17 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 128)) (in_range15 temp___expr_1161)))
(define-fun dynamic_invariant18 ((temp___expr_1276 Int) (temp___is_init_1272 Bool) (temp___skip_constant_1273 Bool) (temp___do_toplevel_1274 Bool) (temp___do_typ_inv_1275 Bool)) Bool (=> (or (= temp___is_init_1272 true) (<= 0 17)) (in_range25 temp___expr_1276)))
(define-fun dynamic_invariant19 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 1 17)) (in_range23 temp___expr_1283)))
(define-fun dynamic_invariant20 ((temp___expr_1409 Int) (temp___is_init_1405 Bool) (temp___skip_constant_1406 Bool) (temp___do_toplevel_1407 Bool) (temp___do_typ_inv_1408 Bool)) Bool (=> (or (= temp___is_init_1405 true) (<= 0 2)) (in_range22 temp___expr_1409)))
(define-fun dynamic_invariant21 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 0 17408)) (in_range24 temp___expr_1290)))
(define-fun dynamic_invariant22 ((temp___expr_1321 Int) (temp___is_init_1317 Bool) (temp___skip_constant_1318 Bool) (temp___do_toplevel_1319 Bool) (temp___do_typ_inv_1320 Bool)) Bool (=> (or (= temp___is_init_1317 true) (<= 0 1024)) (in_range26 temp___expr_1321)))
(assert true)
...
(define-fun dynamic_invariant23 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range5 temp___expr_625)))
(define-fun dynamic_invariant24 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range6 temp___expr_632)))
(define-fun dynamic_invariant25 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range7 temp___expr_639)))
(define-fun dynamic_invariant26 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range8 temp___expr_671)))
(define-fun dynamic_invariant27 ((temp___expr_1596 Int) (temp___is_init_1592 Bool) (temp___skip_constant_1593 Bool) (temp___do_toplevel_1594 Bool) (temp___do_typ_inv_1595 Bool)) Bool (=> (or (= temp___is_init_1592 true) (<= 0 4294967295)) (in_range12 temp___expr_1596)))
...
(assert (in_range27 auditalarm))
(assert (and (= o21 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range1 o21) (= o21 (to_rep theadmin__split_fields)))))
(assert (= result (ite (= o21 1) true false)))
(assert (=> (= result true) (and (= o23 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o23 true) (in_range3 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result true) (= o24 (ite (not (= o23 true)) true false))))
(assert (=> (= result true) (and (= result1 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result1 true) (in_range3 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result true) (=> (= result1 true) (and (= o22 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o22)))))
(assert (=> (= result true) (=> (= result1 true) (= o25 (ite (= o22 3) true false)))))
(assert (=> (= result true) (=> (not (= result1 true)) (= o25 false))))
(assert (=> (= result true) (= o26 (ite (= o25 false) o24 true))))
(assert (=> (not (= result true)) (= o26 (distinct 1 0))))
(assert (and (= result3 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result3 true) (in_range3 (to_rep1 theadmin__split_fields1)))))
(assert (=> (= result3 true) (and (= o19 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o19))))
(assert (=> (= result3 true) (= result2 (ite (= o19 4) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o20 (statusiswaitingstartadminop status)) (= (= o20 true) (= status 6)))))
(assert (=> (not (= result2 true)) (= o20 (distinct 1 0))))
(assert (and (= result4 (statusisshutdown status)) (= (= result4 true) (= status 8))))
(assert (=> (= result4 true) (and (= o15 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range1 o15) (= o15 (to_rep theadmin__split_fields))))))
(assert (=> (= result4 true) (= o16 (ite (= o15 0) true false))))
(assert (=> (= result4 true) (and (= o14 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o14 true) (in_range3 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result4 true) (= o17 (ite (not (= o14 true)) true false))))
(assert (=> (= result4 true) (= o18 (ite (= o17 true) o16 false))))
(assert (=> (not (= result4 true)) (= o18 (distinct 1 0))))
(assert (and (= result5 (statusisenclavequiescent status)) (= (= result5 true) (= status 3))))
(assert (=> (= result5 true) (and (= o12 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o12 true) (in_range3 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result5 true) (= o13 (ite (not (= o12 true)) true false))))
(assert (=> (not (= result5 true)) (= o13 (distinct 1 0))))
(assert (and (= o7 (statusiswaitingfinishadminop status)) (= (= o7 true) (= status 7))))
(assert (and (= o8 (statusiswaitingstartadminop status)) (= (= o8 true) (= status 6))))
(assert (= result6 (ite (= o8 false) o7 true)))
(assert (=> (= result6 true) (and (= o9 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o9 true) (in_range3 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result6 true) (and (= o10 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o10 true) (in_range4 (to_rep theadmin__split_fields))))))
(assert (=> (= result6 true) (= o11 (ite (= o10 true) o9 false))))
(assert (=> (not (= result6 true)) (= o11 (distinct 1 0))))
(assert (and (= o3 (statusiswaitingremoveadmintokenfail status)) (= (= o3 true) (= status 4))))
(assert (and (= o4 (statusisgotadmintoken status)) (= (= o4 true) (= status 5))))
(assert (= result7 (ite (= o4 false) o3 true)))
(assert (=> (= result7 true) (and (= o5 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o5 true) (in_range4 (to_rep theadmin__split_fields))))))
(assert (=> (= result7 true) (= o6 (ite (not (= o5 true)) true false))))
(assert (=> (not (= result7 true)) (= o6 (distinct 1 0))))
(assert (and (= o (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o true) (in_range4 (to_rep theadmin__split_fields)))))
(assert (= result8 (ite (not (= o true)) true false)))
(assert (=> (= result8 true) (and (= o1 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o1 true) (in_range3 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result8 true) (= o2 (ite (not (= o1 true)) true false))))
(assert (=> (not (= result8 true)) (= o2 (distinct 1 0))))
(assert (and (= result9 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result9 true) (in_range3 (to_rep1 theadmin__split_fields1)))))
(assert (= result9 true))
