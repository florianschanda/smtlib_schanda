...
(assert (=> (= (mod2 above 2) 0) (and (= temp___321 (+ above 1)) (in_range (+ above 1)))))
(assert (=> (= (mod2 above 2) 0) (= (mod2 temp___321 2) 0)))
(assert (=> (= (mod2 above 2) 0) (= o1 temp___321)))
...
(assert (=> (not (= (mod2 above 2) 0)) (and (= temp___319 (+ above 1)) (in_range (+ above 1)))))
(assert (=> (not (= (mod2 above 2) 0)) (= (mod2 temp___319 2) 0)))
(assert (=> (not (= (mod2 above 2) 0)) (= o4 temp___319)))
...
(assert (not (in_range (+ (to_rep (select result__2 1)) 4))))
(check-sat)
(exit)
