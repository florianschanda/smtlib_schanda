...
(declare-const o5 (Array Int element_2))
...
(declare-const result5 (Array Int element_2))
...
(assert (= r1 o2))
(assert (forall ((k Int)) (=> (and (<= (to_rep (first4 (rt2 a))) k) (<= k i2)) (and (= (in_range5 (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))))) (to_rep2 (select r2 k)) (+ (- k (to_rep (first4 (rt2 a)))) 1)) true) (= (to_rep2 (select r2 k)) (+ (to_rep1 (select (elts2 a) k)) (ite (= k (to_rep (first4 (rt2 a)))) init (to_rep2 (select r2 (- k 1))))))))))
...
(assert (= acc2 result3))
(assert (= acc3 (to_rep2 (select r2 i2))))
(assert (not (= i2 (to_rep (last4 (rt2 a))))))
(assert (= i2 result4))
(assert (= i3 (+ i2 1)))
(assert (and (= o3 (+ (to_rep1 (select (elts2 a) i3)) acc3)) (in_range1 (+ (to_rep1 (select (elts2 a) i3)) acc3))))
(assert (= (to_rep2 o4) o3))
(assert (= o5 (store r2 i3 o4)))
(assert (= result5 r2))
(assert (= r3 o5))
(declare-const k Int)
(assert (<= (to_rep (first4 (rt2 a))) k))
(assert (<= k i3))
(assert (not (= (in_range5 (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))))) (to_rep2 (select r3 k)) (+ (- k (to_rep (first4 (rt2 a)))) 1)) true)))
(check-sat)
(exit)
