...
(assert (forall ((idx1 Int)) (=> (and (<= (to_rep1 item__first) idx1) (<= idx1 last6)) (= (to_rep (select item2 idx1)) (to_rep (select the_file (+ (- idx1 (to_rep1 item__first)) cur_position)))))))
(assert (= cur_position1 (+ (- (+ cur_position last6) (to_rep1 item__first)) 1)))
(assert (and (and (and (and (=> (<= 0 2147483647) (in_range4 n2)) (=> (<= 0 2147483647) (in_range4 last6))) (=> (<= (- 2147483648) 2147483647) (in_range1 rest1))) (in_range2 cur_position1)) (<= 80 n2)))
(assert (<= (to_rep1 item__first) idx))
(assert (<= idx last6))
(assert (not (<= (+ (- idx (to_rep1 item__first)) cur_position) 2147483647)))
(check-sat)
(exit)
