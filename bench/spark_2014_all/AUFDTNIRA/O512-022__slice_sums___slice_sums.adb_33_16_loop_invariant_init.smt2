...
(assert (<= (indexqtint (rec__sums__slice_bounds__lo result____split_fields3)) (extended_indexqtint (rec__sums__slice_bounds__hi result____split_fields3))))
(assert (not (<= (extended_indexqtint (rec__sums__slice_bounds__hi result____split_fields3)) (to_rep (last (rt x))))))
(check-sat)
(exit)
