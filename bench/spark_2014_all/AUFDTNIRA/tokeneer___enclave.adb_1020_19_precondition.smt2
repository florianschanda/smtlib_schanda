...
(assert (and (= result (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result true) (in_range6 (to_rep3 theadmin__split_fields1)))))
(assert (= result true))
(assert (and (= o12 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range6 o12)))
(assert (= result1 (ite (= o12 3) true false)))
(assert (= result1 true))
(assert (and (= o11 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range4 o11) (= o11 (to_rep2 theadmin__split_fields)))))
(assert (= result2 (ite (= o11 1) true false)))
(assert (= result2 true))
(assert (and (= o5 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range4 o5) (= o5 (to_rep2 theadmin__split_fields)))))
(assert (= result4 (ite (= o5 1) true false)))
(assert (=> (= result4 true) (and (= o8 (theauthcertrole tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields))) (and (in_range4 o8) (= o8 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content11 authcert__split_fields))))))))
(assert (=> (= result4 true) (= o9 (ite (= o8 1) true false))))
(assert (=> (= result4 true) (and (= o6 (authcertvalid tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields))) (= (= o6 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content11 authcert__split_fields)) true)))))
(assert (=> (= result4 true) (and (= o7 (isgood tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields))) (= (= o7 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content8 idcert__split_fields)) true)))))
...
(assert (= result3 true))
(assert (and (= result7 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result7 true) (in_range6 (to_rep3 theadmin__split_fields1)))))
(assert (=> (= result7 true) (and (= o3 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range6 o3))))
(assert (=> (= result7 true) (= result6 (ite (= o3 3) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (=> (= result6 true) (and (= o4 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range4 o4) (= o4 (to_rep2 theadmin__split_fields))))))
(assert (=> (= result6 true) (= result5 (ite (= o4 1) true false))))
(assert (=> (not (= result6 true)) (= result5 (distinct 1 0))))
(assert (= result5 true))
(assert (and (= o (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range4 o) (= o (to_rep2 theadmin__split_fields)))))
(assert (= result8 (ite (= o 1) true false)))
(assert (= result8 true))
(assert (and (= o1 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o1 true) (in_range6 (to_rep3 theadmin__split_fields1)))))
(assert (= o2 (ite (not (= o1 true)) true false)))
(assert (and (= result9 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result9 true) (in_range6 (to_rep3 theadmin__split_fields1)))))
(assert (= result9 true))
