...
(assert (and (= o18 (next (mk___rep1 my_container__split_fields1) (let ((subject temp___655)) temp___6551))) (= o18 (ite (< (to_rep (rec__container__cursor__index (us_split_fields1 (let ((subject temp___655)) temp___6551)))) 200) (mk___rep (mk___split_fields (of_rep (+ (to_rep (rec__container__cursor__index (us_split_fields1 (let ((subject temp___655)) temp___6551)))) 1)))) (mk___rep (mk___split_fields rliteral1))))))
(assert (and (= o19 (has_element (mk___rep1 my_container__split_fields1) o18)) (= (= o19 true) (and (<= 1 (to_rep (rec__container__cursor__index (us_split_fields1 o18)))) (<= (to_rep (rec__container__cursor__index (us_split_fields1 o18))) 200)))))
(assert (= result37 (ite (not (= o19 true)) true false)))
