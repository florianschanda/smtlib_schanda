...
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (forall ((k Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) k) (<= k i2)) (= (to_rep3 (select f3 k)) p_prime_index2)))))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (forall ((k Int)) (=> (and (<= 0 k) (<= k (- (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) 1))) (= (to_rep3 (select f3 k)) (to_rep3 (select f_loop_entry k)))))))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (forall ((k Int)) (=> (and (<= (+ i2 1) k) (<= k 5)) (= (to_rep3 (select f3 k)) (to_rep3 (select f_loop_entry k)))))))
...
(assert (forall ((k Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) k) (<= k (to_rep2 (rec__partition_refinement__interval__last p_prime__split_fields1)))) (= (to_rep3 (select (map__content f6) k)) (- (length (mk___rep p__split_discrs p__split_fields3)) 1)))))
(assert (forall ((k Int)) (=> (and (<= 0 k) (<= k (- (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) 1))) (and (<= 0 (to_rep3 (select (map__content f6) k))) (<= (to_rep3 (select (map__content f6) k)) (- (length (mk___rep p__split_discrs p__split_fields3)) 1))))))
(assert (forall ((k Int)) (=> (and (<= (+ (to_rep2 (rec__partition_refinement__interval__last p_prime__split_fields1)) 1) k) (<= k 5)) (and (<= 0 (to_rep3 (select (map__content f6) k))) (<= (to_rep3 (select (map__content f6) k)) (- (length (mk___rep p__split_discrs p__split_fields3)) 1))))))
(assert (forall ((k Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first p_elem__split_fields3)) k) (<= k (to_rep2 (rec__partition_refinement__interval__last p_elem__split_fields3)))) (= (bool_eq (get (model__ (mk___rep p__split_discrs p__split_fields3)) (to_rep3 (select (map__content f6) k))) (mk___rep1 p_elem__split_fields3)) true))))
...
(assert (forall ((k Int)) (=> (and (<= 0 k) (<= k (- (to_rep2 (rec__partition_refinement__interval__first p_elem__split_fields3)) 1))) (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) (to_rep3 (select (map__content f6) k)))))) k) (<= k (to_rep2 (rec__partition_refinement__interval__last (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) (to_rep3 (select (map__content f6) k)))))))))))
(assert (<= (+ (to_rep2 (rec__partition_refinement__interval__last p_prime__split_fields1)) 1) 5))
(assert (not (<= 5 5)))
(check-sat)
(exit)
