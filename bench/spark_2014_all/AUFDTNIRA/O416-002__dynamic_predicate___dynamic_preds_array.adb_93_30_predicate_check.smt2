...
(assert (=> (not (= (mod2 above 2) 0)) (and (= temp___311 (+ above 1)) (in_range (+ above 1)))))
(assert (=> (not (= (mod2 above 2) 0)) (= (mod2 temp___311 2) 0)))
(assert (=> (not (= (mod2 above 2) 0)) (= o3 temp___311)))
...
(assert (and (= temp___315 (+ (to_rep (select result__1 1)) 2)) (in_range (+ (to_rep (select result__1 1)) 2))))
(assert (not (= (mod2 temp___315 2) 0)))
(check-sat)
(exit)
