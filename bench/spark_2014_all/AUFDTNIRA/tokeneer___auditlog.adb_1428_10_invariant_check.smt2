...
(define-fun logfilestate__split_fields19 () us_split_fields__ref1 (mk___split_fields__ref1 (mk___split_fields1 logfilestate__split_fields logfilestate__split_fields1 (mk___rep (mk___split_fields logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6)))
(define-fun logfilesstatus10 () map__ref1 (mk_map__ref1 logfilesstatus))
(define-fun logfiles9 () map__ref4 (mk_map__ref4 logfiles))
...
(assert (=> (not (< 1 (to_rep5 logfilestate__split_fields5))) (= auditsystemfault7 auditsystemfault9)))
(assert (=> (not (< 1 (to_rep5 logfilestate__split_fields5))) (= logfilestate__split_fields17 logfilestate__split_fields19)))
(assert (=> (not (< 1 (to_rep5 logfilestate__split_fields5))) (= logfilesstatus8 logfilesstatus10)))
(assert (=> (not (< 1 (to_rep5 logfilestate__split_fields5))) (= logfiles7 logfiles9)))
