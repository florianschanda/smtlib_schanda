...
(assert (forall ((temp___2000 Int) (temp___2001 Int) (temp___2002 Int) (temp___2003 Int) (temp___2004 Int) (temp___2005 Int)) (let ((temp___1999 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__int_array__aggregate_def temp___2000 temp___2001 temp___2002 temp___2003 temp___2004 temp___2005))) (=> (and (and (and (dynamic_invariant temp___2000 true true true true) (dynamic_invariant temp___2001 true true true true)) (dynamic_invariant temp___2002 true true true true)) (dynamic_invariant temp___2003 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 7) (+ (first1 source) 10) temp___2004 temp___2005) (and (= (first5 temp___1999) temp___2004) (= (last5 temp___1999) temp___2005))) (and (and (and (= (select (to_array2 temp___1999) (+ (+ (first1 source) 7) 0)) rliteral) (= (select (to_array2 temp___1999) (+ (+ (first1 source) 7) 1)) rliteral1)) (= (select (to_array2 temp___1999) (+ (+ (first1 source) 7) 2)) rliteral1)) (= (select (to_array2 temp___1999) (+ (+ (first1 source) 7) 3)) rliteral1)))))))
(define-fun dynamic_invariant4 ((temp___expr_634 us_t3) (temp___is_init_630 Bool) (temp___skip_constant_631 Bool) (temp___do_toplevel_632 Bool) (temp___do_typ_inv_633 Bool)) Bool (=> (not (= temp___skip_constant_631 true)) (and (dynamic_property6 (+ (first1 source) 7) (+ (first1 source) 10) (first7 temp___expr_634) (last7 temp___expr_634)) (and (= (first7 temp___expr_634) (+ (first1 source) 7)) (= (last7 temp___expr_634) (+ (first1 source) 10))))))
(declare-sort t6 0)
...
(assert (forall ((temp___2011 Int) (temp___2012 Int) (temp___2013 Int)) (let ((temp___2010 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__n__aggregate_def temp___2011 temp___2012 temp___2013))) (=> (dynamic_invariant temp___2011 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 7) (+ (first1 source) 10) temp___2012 temp___2013) (and (= (first9 temp___2010) temp___2012) (= (last9 temp___2010) temp___2013))) (forall ((temp___2014 Int)) (= (select (to_array4 temp___2010) temp___2014) rliteral2)))))))
...
(declare-const temp___2008 (Array Int integer))
(declare-const temp___20081 t2)
...
(declare-const temp___2016 (Array Int integer))
(declare-const temp___20161 t4)
...
(declare-const temp___2018 Int)
(declare-const temp___2019 Int)
(declare-const temp___2022 (Array Int integer))
(declare-const temp___2020 Int)
(declare-const o Int)
...
(assert (and (= (length source) 11) (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 56)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 51)) (forall ((index7 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 7) index7) (<= index7 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index7))) true))))))
...
(assert (= (mk___t2 temp___2008 temp___20081) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__int_array__aggregate_def 2 9 9 9 (+ (to_rep1 (first (rt source))) 7) (+ (+ (to_rep1 (first (rt source))) 7) 3))))
(assert (= (ite (<= (to_rep1 (first4 temp___20081)) (to_rep1 (last4 temp___20081))) (+ (- (to_rep1 (last4 temp___20081)) (to_rep1 (first4 temp___20081))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 7)) 1) 0)))
(assert (= (slide1 temp___2008 (to_rep1 (first4 temp___20081)) (+ (to_rep1 (first (rt source))) 7)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__int_array__assume))
...
(assert (= (mk___t4 temp___2016 temp___20161) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___20161)) (to_rep1 (last8 temp___20161))) (+ (- (to_rep1 (last8 temp___20161)) (to_rep1 (first8 temp___20161))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 7)) 1) 0)))
(assert (= (slide1 temp___2016 (to_rep1 (first8 temp___20161)) (+ (to_rep1 (first (rt source))) 7)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__n__assume))
...
(assert (and (= temp___2018 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (= temp___2019 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2018))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= temp___2022 n1)))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= temp___2020 index1)))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= o index1)))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= o3 index1)))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= o7 index1)))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= n1 result3)))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= n2 o8)))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 7) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 7) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (and (and (=> (<= (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10) index2)) (forall ((temp___2023 Int)) (=> (and (<= (to_rep1 n__first) temp___2023) (<= temp___2023 (to_rep1 n__last))) (=> (or (< temp___2019 temp___2023) (or (< temp___2023 temp___2018) (< index2 temp___2023))) (= (select n3 temp___2023) (select temp___2022 temp___2023)))))) (and (<= (+ (to_rep1 (first (rt source))) 7) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= index2 temp___2019)))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= index2 index3)))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= n3 n4)))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= index4 index2)))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= n5 n3)))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= index6 index4)))
(assert (=> (and (<= temp___2018 index1) (<= index1 temp___2019)) (= n7 n5)))
(assert (=> (not (and (<= temp___2018 index1) (<= index1 temp___2019))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2018 index1) (<= index1 temp___2019))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2018 index1) (<= index1 temp___2019))) (= index6 index1)))
(assert (=> (not (and (<= temp___2018 index1) (<= index1 temp___2019))) (= n7 n1)))
...
(assert (and (= temp___2024 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___2024) (<= temp___2024 (to_rep1 n__last))))
(assert (= o9 temp___2024))
...
(assert (= target1 o13))
(assert (<= (- 9) target1))
(assert (and (= temp___2025 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___2025) (<= temp___2025 (to_rep1 n__last))))
(assert (= o14 temp___2025))
...
(assert (= target2 o20))
(assert (<= (- 99) target2))
(assert (and (= temp___2026 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___2026) (<= temp___2026 (to_rep1 n__last))))
(assert (= o21 temp___2026))
...
(assert (= target3 o27))
(assert (<= (- 999) target3))
(assert (and (= temp___2027 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2027) (<= temp___2027 (to_rep1 n__last))))
(assert (= o28 temp___2027))
