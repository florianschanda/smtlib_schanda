...
(define-fun dynamic_invariant5 ((temp___expr_1038 Int) (temp___is_init_1034 Bool) (temp___skip_constant_1035 Bool) (temp___do_toplevel_1036 Bool) (temp___do_typ_inv_1037 Bool)) Bool (=> (or (= temp___is_init_1034 true) (<= 0 10)) (in_range16 temp___expr_1038)))
...
(declare-fun temp_____aggregate_def_1835 (Int) (Array Int character))
(declare-fun temp___String_Literal_1840 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_1840 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_1840 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1840 us_void_param) 3)) 103)) (= (to_rep (select (temp___String_Literal_1840 us_void_param) 4)) 110)) :pattern ((temp___String_Literal_1840 us_void_param)))))
...
(assert (= mechanism 8))
(assert (forall ((temp___1837 Int)) (=> (dynamic_invariant7 temp___1837 true true true true) (forall ((temp___1838 Int)) (= (to_rep (select (temp_____aggregate_def_1835 temp___1837) temp___1838)) temp___1837)))))
...
(define-fun dynamic_invariant14 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 1 150)) (in_range15 temp___expr_471)))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(define-fun dynamic_invariant15 ((temp___expr_1207 Int) (temp___is_init_1203 Bool) (temp___skip_constant_1204 Bool) (temp___do_toplevel_1205 Bool) (temp___do_typ_inv_1206 Bool)) Bool (=> (or (= temp___is_init_1203 true) (<= 0 17)) (in_range7 temp___expr_1207)))
(define-fun dynamic_invariant16 ((temp___expr_1214 Int) (temp___is_init_1210 Bool) (temp___skip_constant_1211 Bool) (temp___do_toplevel_1212 Bool) (temp___do_typ_inv_1213 Bool)) Bool (=> (or (= temp___is_init_1210 true) (<= 1 17)) (in_range5 temp___expr_1214)))
(define-fun dynamic_invariant17 ((temp___expr_1340 Int) (temp___is_init_1336 Bool) (temp___skip_constant_1337 Bool) (temp___do_toplevel_1338 Bool) (temp___do_typ_inv_1339 Bool)) Bool (=> (or (= temp___is_init_1336 true) (<= 0 2)) (in_range4 temp___expr_1340)))
(define-fun dynamic_invariant18 ((temp___expr_1221 Int) (temp___is_init_1217 Bool) (temp___skip_constant_1218 Bool) (temp___do_toplevel_1219 Bool) (temp___do_typ_inv_1220 Bool)) Bool (=> (or (= temp___is_init_1217 true) (<= 0 17408)) (in_range6 temp___expr_1221)))
(define-fun dynamic_invariant19 ((temp___expr_1252 Int) (temp___is_init_1248 Bool) (temp___skip_constant_1249 Bool) (temp___do_toplevel_1250 Bool) (temp___do_typ_inv_1251 Bool)) Bool (=> (or (= temp___is_init_1248 true) (<= 0 1024)) (in_range8 temp___expr_1252)))
(assert true)
...
(assert (forall ((temp___1281 Int)) (=> (dynamic_invariant19 temp___1281 true true true true) (forall ((temp___1282 Int)) (= (select (temp_____aggregate_def_1279 temp___1281) temp___1282) rliteral2)))))
(assert (forall ((temp___1277 Int)) (=> (dynamic_invariant16 temp___1277 true true true true) (forall ((temp___1278 Int)) (= (select (temp_____aggregate_def_1275 temp___1277) temp___1278) rliteral)))))
...
(assert (in_range16 mechanism))
(assert (=> (<= 0 4294967295) (in_range12 theprivatekeyh)))
...
(assert (not (dynamic_property1 1 2147483647 1 4)))
(check-sat)
(exit)
