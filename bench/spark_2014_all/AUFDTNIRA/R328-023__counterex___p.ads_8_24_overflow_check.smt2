...
(assert (forall ((i index)) (and (<= 0 (indexqtint i)) (<= (indexqtint i) 38))))
...
(define-fun dynamic_invariant ((temp___expr_166 us_t) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (not (= temp___skip_constant_163 true)) (dynamic_property 0 38 (first1 temp___expr_166) (last1 temp___expr_166))))
...
(define-fun dynamic_invariant2 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 38)) (in_range1 temp___expr_159)))
(declare-const o Int)
...
(assert (and (= o3 (- (to_rep (last (rt a))) (to_rep (first (rt b))))) (in_range (- (to_rep (last (rt a))) (to_rep (first (rt b)))))))
(assert (= o4 (- o3 o2)))
