...
(assert (forall ((x filestatust)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq2 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_198 Int)) (=> (and (<= a__first temp___idx_198) (<= temp___idx_198 a__last)) (= (to_rep2 (select a temp___idx_198)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_198))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_198 Int)) (=> (and (<= a__first temp___idx_198) (<= temp___idx_198 a__last)) (= (to_rep2 (select a temp___idx_198)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_198)))))))))))
...
(assert (forall ((x logfileindext)) (! (in_range4 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x logentrycountt)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x logfilecountt)) (! (in_range6 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun bool_eq3 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_195 Int)) (=> (and (<= a__first temp___idx_195) (<= temp___idx_195 a__last)) (= (to_rep3 (select a temp___idx_195)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_195))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_195 Int)) (=> (and (<= a__first temp___idx_195) (<= temp___idx_195 a__last)) (= (to_rep3 (select a temp___idx_195)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_195)))))))))))
...
(assert (forall ((x fileentrycountt)) (! (in_range7 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(define-fun bool_eq5 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep6 (select a temp___idx_196)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_196))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep6 (select a temp___idx_196)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_196)))))))))))
...
(define-fun bool_eq8 ((a (Array Int us_rep2)) (a__first Int) (a__last Int) (b (Array Int us_rep2)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq7 (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true)))) true false))
(assert (forall ((a (Array Int us_rep2)) (b (Array Int us_rep2))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq7 (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true))))))))
...
(define-fun dynamic_invariant ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 1)) (in_range8 temp___expr_548)))
...
(define-fun dynamic_invariant1 ((temp___expr_1338 us_rep1) (temp___is_init_1334 Bool) (temp___skip_constant_1335 Bool) (temp___do_toplevel_1336 Bool) (temp___do_typ_inv_1337 Bool)) Bool (=> (= temp___do_typ_inv_1337 true) (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1338))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1338))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1338)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1338))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1342 us_rep1) (temp___skip_top_level_1343 Bool)) Bool (and (and (and (= (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1342))) 1) (= (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1342))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1342)) (mk___rep (mk___split_fields (temp_____aggregate_def_1344 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1342)) (temp_____aggregate_def_1348 0))))
(define-fun type_invariant ((temp___1352 us_rep1)) Bool (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1352))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1352))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1352)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1352))) true))
...
(define-fun to_rep7 ((x yearst)) Int (yearstqtint x))
(declare-fun of_rep7 (Int) yearst)
(assert (forall ((x yearst)) (! (= (of_rep7 (to_rep7 x)) x) :pattern ((to_rep7 x)))))
(assert (forall ((x yearst)) (! (in_range9 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(define-fun to_rep8 ((x monthst)) Int (monthstqtint x))
(declare-fun of_rep8 (Int) monthst)
(assert (forall ((x monthst)) (! (= (of_rep8 (to_rep8 x)) x) :pattern ((to_rep8 x)))))
(assert (forall ((x monthst)) (! (in_range10 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(define-fun to_rep9 ((x dayst)) Int (daystqtint x))
(declare-fun of_rep9 (Int) dayst)
(assert (forall ((x dayst)) (! (= (of_rep9 (to_rep9 x)) x) :pattern ((to_rep9 x)))))
(assert (forall ((x dayst)) (! (in_range11 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(define-fun to_rep10 ((x millisecst)) Int (millisecstqtint x))
(declare-fun of_rep10 (Int) millisecst)
(assert (forall ((x millisecst)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert (forall ((x millisecst)) (! (in_range12 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(define-fun bool_eq9 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (to_rep7 (rec__clock__timet__year (us_split_fields5 a))) (to_rep7 (rec__clock__timet__year (us_split_fields5 b)))) (= (to_rep8 (rec__clock__timet__month (us_split_fields5 a))) (to_rep8 (rec__clock__timet__month (us_split_fields5 b))))) (= (to_rep9 (rec__clock__timet__day (us_split_fields5 a))) (to_rep9 (rec__clock__timet__day (us_split_fields5 b))))) (= (to_rep10 (rec__clock__timet__millisec (us_split_fields5 a))) (to_rep10 (rec__clock__timet__millisec (us_split_fields5 b))))) true false))
...
(declare-fun user_eq20 (namecountt namecountt) Bool)
(declare-const dummy20 namecountt)
...
(assert (forall ((x namecountt)) (! (in_range13 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(declare-fun user_eq22 (issueridt issueridt) Bool)
(declare-const dummy22 issueridt)
...
(assert (forall ((x issueridt)) (! (in_range14 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(declare-fun user_eq24 (serialnumbert serialnumbert) Bool)
(declare-const dummy24 serialnumbert)
...
(assert (forall ((x serialnumbert)) (! (in_range15 (to_rep13 x)) :pattern ((to_rep13 x)))))
(assert (forall ((x Int)) (! (=> (in_range15 x) (= (to_rep13 (of_rep13 x)) x)) :pattern ((to_rep13 (of_rep13 x))))))
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__certtypes__idt__issuer us_rep4) (rec__certtypes__idt__serialnumber serialnumbert)))))
(define-fun us_split_fields_Issuer__projection ((a us_split_fields8)) us_rep4 (rec__certtypes__idt__issuer a))
...
(define-fun us_rep___14__projection ((a us_rep5)) us_split_fields8 (us_split_fields9 a))
(define-fun bool_eq11 ((a us_rep5) (b us_rep5)) Bool (ite (and (= (bool_eq10 (rec__certtypes__idt__issuer (us_split_fields9 a)) (rec__certtypes__idt__issuer (us_split_fields9 b))) true) (= (to_rep13 (rec__certtypes__idt__serialnumber (us_split_fields9 a))) (to_rep13 (rec__certtypes__idt__serialnumber (us_split_fields9 b))))) true false))
...
(declare-datatypes () ((idt__ref (mk_idt__ref (idt__content us_rep5)))))
(define-fun idt__ref___projection ((a idt__ref)) us_rep5 (idt__content a))
...
(assert (forall ((x algorithmt)) (! (in_range16 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(declare-fun user_eq27 (keyidt keyidt) Bool)
(declare-const dummy27 keyidt)
...
(assert (forall ((x keyidt)) (! (in_range17 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(declare-fun user_eq28 (keylengtht keylengtht) Bool)
(declare-const dummy28 keylengtht)
...
(assert (forall ((x keylengtht)) (! (in_range18 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(define-fun us_rep___8__projection ((a us_rep6)) us_split_fields10 (us_split_fields11 a))
(define-fun bool_eq12 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (= (to_rep14 (rec__cryptotypes__keypartt__algorithmid (us_split_fields11 a))) (to_rep14 (rec__cryptotypes__keypartt__algorithmid (us_split_fields11 b)))) (= (to_rep15 (rec__cryptotypes__keypartt__keyid (us_split_fields11 a))) (to_rep15 (rec__cryptotypes__keypartt__keyid (us_split_fields11 b))))) (= (to_rep16 (rec__cryptotypes__keypartt__keylength (us_split_fields11 a))) (to_rep16 (rec__cryptotypes__keypartt__keylength (us_split_fields11 b))))) true false))
...
(declare-datatypes () ((keypartt__ref (mk_keypartt__ref (keypartt__content us_rep6)))))
(define-fun keypartt__ref___projection ((a keypartt__ref)) us_rep6 (keypartt__content a))
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__cert__id__contentst__id us_rep5) (rec__cert__id__contentst__notbefore us_rep3) (rec__cert__id__contentst__notafter us_rep3) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep4) (rec__cert__id__contentst__subjectpublickey us_rep6)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields12)) us_rep5 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields12)) us_rep3 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields12)) us_rep3 (rec__cert__id__contentst__notafter a))
(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields12)) algorithmt (rec__cert__id__contentst__mechanism a))
(define-fun us_split_fields_Subject__projection ((a us_split_fields12)) us_rep4 (rec__cert__id__contentst__subject a))
(define-fun us_split_fields_SubjectPublicKey__projection ((a us_split_fields12)) us_rep6 (rec__cert__id__contentst__subjectpublickey a))
(declare-datatypes () ((us_split_fields__ref6 (mk___split_fields__ref6 (us_split_fields__content6 us_split_fields12)))))
(define-fun us_split_fields__ref___18__projection ((a us_split_fields__ref6)) us_split_fields12 (us_split_fields__content6 a))
...
(define-fun bool_eq13 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (and (and (and (= (bool_eq11 (rec__cert__id__contentst__id (us_split_fields13 a)) (rec__cert__id__contentst__id (us_split_fields13 b))) true) (= (bool_eq9 (rec__cert__id__contentst__notbefore (us_split_fields13 a)) (rec__cert__id__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq9 (rec__cert__id__contentst__notafter (us_split_fields13 a)) (rec__cert__id__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep14 (rec__cert__id__contentst__mechanism (us_split_fields13 a))) (to_rep14 (rec__cert__id__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq10 (rec__cert__id__contentst__subject (us_split_fields13 a)) (rec__cert__id__contentst__subject (us_split_fields13 b))) true)) (= (bool_eq12 (rec__cert__id__contentst__subjectpublickey (us_split_fields13 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields13 b))) true)) true false))
...
(define-fun contentst__ref___4__projection ((a contentst__ref)) us_rep7 (contentst__content a))
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__admintoken__valididcertt__valid Bool) (rec__admintoken__valididcertt__contents us_rep7)))))
(define-fun us_split_fields_Valid__2__projection ((a us_split_fields14)) Bool (rec__admintoken__valididcertt__valid a))
(define-fun us_split_fields_Contents__2__projection ((a us_split_fields14)) us_rep7 (rec__admintoken__valididcertt__contents a))
(declare-datatypes () ((us_split_fields__ref7 (mk___split_fields__ref7 (us_split_fields__content7 us_split_fields14)))))
(define-fun us_split_fields__ref___20__projection ((a us_split_fields__ref7)) us_split_fields14 (us_split_fields__content7 a))
(declare-datatypes () ((us_rep8 (mk___rep7 (us_split_fields15 us_split_fields14)))))
(define-fun us_rep___21__projection ((a us_rep8)) us_split_fields14 (us_split_fields15 a))
(define-fun bool_eq14 ((a us_rep8) (b us_rep8)) Bool (ite (and (= (rec__admintoken__valididcertt__valid (us_split_fields15 a)) (rec__admintoken__valididcertt__valid (us_split_fields15 b))) (= (bool_eq13 (rec__admintoken__valididcertt__contents (us_split_fields15 a)) (rec__admintoken__valididcertt__contents (us_split_fields15 b))) true)) true false))
...
(declare-fun user_eq32 (classt classt) Bool)
(declare-const dummy32 classt)
...
(assert (forall ((x classt)) (! (in_range19 (to_rep17 x)) :pattern ((to_rep17 x)))))
(assert (forall ((x Int)) (! (=> (in_range19 x) (= (to_rep17 (of_rep17 x)) x)) :pattern ((to_rep17 (of_rep17 x))))))
(declare-datatypes () ((us_split_fields16 (mk___split_fields8 (rec__privtypes__clearancet__class classt)))))
(define-fun us_split_fields_Class__projection ((a us_split_fields16)) classt (rec__privtypes__clearancet__class a))
(declare-datatypes () ((us_split_fields__ref8 (mk___split_fields__ref8 (us_split_fields__content8 us_split_fields16)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref8)) us_split_fields16 (us_split_fields__content8 a))
(declare-datatypes () ((us_rep9 (mk___rep8 (us_split_fields17 us_split_fields16)))))
(define-fun us_rep___projection ((a us_rep9)) us_split_fields16 (us_split_fields17 a))
(define-fun bool_eq15 ((a us_rep9) (b us_rep9)) Bool (ite (= (to_rep17 (rec__privtypes__clearancet__class (us_split_fields17 a))) (to_rep17 (rec__privtypes__clearancet__class (us_split_fields17 b)))) true false))
...
(declare-datatypes () ((clearancet__ref (mk_clearancet__ref (clearancet__content us_rep9)))))
(define-fun clearancet__ref___projection ((a clearancet__ref)) us_rep9 (clearancet__content a))
(declare-sort privileget 0)
(define-fun in_range20 ((x Int)) Bool (and (<= 0 x) (<= x 3)))
...
(declare-fun user_eq34 (privileget privileget) Bool)
(declare-const dummy34 privileget)
...
(assert (forall ((x privileget)) (! (in_range20 (to_rep18 x)) :pattern ((to_rep18 x)))))
(assert (forall ((x Int)) (! (=> (in_range20 x) (= (to_rep18 (of_rep18 x)) x)) :pattern ((to_rep18 (of_rep18 x))))))
(declare-datatypes () ((us_split_fields18 (mk___split_fields9 (rec__cert__attr__auth__contentst__id us_rep5) (rec__cert__attr__auth__contentst__notbefore us_rep3) (rec__cert__attr__auth__contentst__notafter us_rep3) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep5) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep9)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields18)) us_rep5 (rec__cert__attr__auth__contentst__id a))
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields18)) us_rep3 (rec__cert__attr__auth__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields18)) us_rep3 (rec__cert__attr__auth__contentst__notafter a))
(define-fun us_split_fields_Mechanism__3__projection ((a us_split_fields18)) algorithmt (rec__cert__attr__auth__contentst__mechanism a))
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields18)) us_rep5 (rec__cert__attr__auth__contentst__basecertid a))
(define-fun us_split_fields_Role__projection ((a us_split_fields18)) privileget (rec__cert__attr__auth__contentst__role a))
(define-fun us_split_fields_Clearance__projection ((a us_split_fields18)) us_rep9 (rec__cert__attr__auth__contentst__clearance a))
(declare-datatypes () ((us_split_fields__ref9 (mk___split_fields__ref9 (us_split_fields__content9 us_split_fields18)))))
(define-fun us_split_fields__ref___17__projection ((a us_split_fields__ref9)) us_split_fields18 (us_split_fields__content9 a))
(declare-datatypes () ((us_rep10 (mk___rep9 (us_split_fields19 us_split_fields18)))))
(define-fun us_rep___18__projection ((a us_rep10)) us_split_fields18 (us_split_fields19 a))
(define-fun bool_eq16 ((a us_rep10) (b us_rep10)) Bool (ite (and (and (and (and (and (and (= (bool_eq11 (rec__cert__attr__auth__contentst__id (us_split_fields19 a)) (rec__cert__attr__auth__contentst__id (us_split_fields19 b))) true) (= (bool_eq9 (rec__cert__attr__auth__contentst__notbefore (us_split_fields19 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields19 b))) true)) (= (bool_eq9 (rec__cert__attr__auth__contentst__notafter (us_split_fields19 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields19 b))) true)) (= (to_rep14 (rec__cert__attr__auth__contentst__mechanism (us_split_fields19 a))) (to_rep14 (rec__cert__attr__auth__contentst__mechanism (us_split_fields19 b))))) (= (bool_eq11 (rec__cert__attr__auth__contentst__basecertid (us_split_fields19 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields19 b))) true)) (= (to_rep18 (rec__cert__attr__auth__contentst__role (us_split_fields19 a))) (to_rep18 (rec__cert__attr__auth__contentst__role (us_split_fields19 b))))) (= (bool_eq15 (rec__cert__attr__auth__contentst__clearance (us_split_fields19 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields19 b))) true)) true false))
...
(define-fun contentst__ref___3__projection ((a contentst__ref1)) us_rep10 (contentst__content1 a))
(declare-datatypes () ((us_split_fields20 (mk___split_fields10 (rec__admintoken__validauthcertt__valid Bool) (rec__admintoken__validauthcertt__contents us_rep10)))))
(define-fun us_split_fields_Valid__projection ((a us_split_fields20)) Bool (rec__admintoken__validauthcertt__valid a))
(define-fun us_split_fields_Contents__projection ((a us_split_fields20)) us_rep10 (rec__admintoken__validauthcertt__contents a))
...
(define-fun us_rep___20__projection ((a us_rep11)) us_split_fields20 (us_split_fields21 a))
(define-fun bool_eq17 ((a us_rep11) (b us_rep11)) Bool (ite (and (= (rec__admintoken__validauthcertt__valid (us_split_fields21 a)) (rec__admintoken__validauthcertt__valid (us_split_fields21 b))) (= (bool_eq16 (rec__admintoken__validauthcertt__contents (us_split_fields21 a)) (rec__admintoken__validauthcertt__contents (us_split_fields21 b))) true)) true false))
...
(declare-datatypes () ((validauthcertt__ref (mk_validauthcertt__ref (validauthcertt__content us_rep11)))))
(define-fun validauthcertt__ref___projection ((a validauthcertt__ref)) us_rep11 (validauthcertt__content a))
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-fun extractuser (Int us_private Int Int us_split_fields20 us_split_fields14) (Array Int character))
(declare-fun extractuser__function_guard ((Array Int character) Int us_private Int Int us_split_fields20 us_split_fields14) Bool)
...
(declare-fun user_eq37 (presencet presencet) Bool)
(declare-const dummy37 presencet)
...
(define-fun dynamic_invariant2 ((temp___expr_245 Int) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool) (temp___do_typ_inv_244 Bool)) Bool (=> (or (= temp___is_init_241 true) (<= 0 1)) (in_range21 temp___expr_245)))
...
(declare-fun user_eq38 (tokenidt tokenidt) Bool)
(declare-const dummy38 tokenidt)
...
(define-fun dynamic_invariant3 ((temp___expr_1517 Int) (temp___is_init_1513 Bool) (temp___skip_constant_1514 Bool) (temp___do_toplevel_1515 Bool) (temp___do_typ_inv_1516 Bool)) Bool (=> (or (= temp___is_init_1513 true) (<= 0 4294967295)) (in_range22 temp___expr_1517)))
(declare-sort tryt 0)
(define-fun in_range23 ((x Int)) Bool (and (<= 0 x) (<= x 2)))
...
(declare-fun user_eq39 (tryt tryt) Bool)
(declare-const dummy39 tryt)
...
(define-fun dynamic_invariant4 ((temp___expr_1524 Int) (temp___is_init_1520 Bool) (temp___skip_constant_1521 Bool) (temp___do_toplevel_1522 Bool) (temp___do_typ_inv_1523 Bool)) Bool (=> (or (= temp___is_init_1520 true) (<= 0 2)) (in_range23 temp___expr_1524)))
(assert true)
(declare-fun theauthcertrole (Int us_private Int Int us_split_fields20 us_split_fields14) Int)
(declare-fun theauthcertrole__function_guard (Int Int us_private Int Int us_split_fields20 us_split_fields14) Bool)
(declare-fun isgood (Int us_private Int Int us_split_fields20 us_split_fields14) Bool)
(declare-fun isgood__function_guard (Bool Int us_private Int Int us_split_fields20 us_split_fields14) Bool)
(declare-fun authcertvalid (Int us_private Int Int us_split_fields20 us_split_fields14) Bool)
(declare-fun authcertvalid__function_guard (Bool Int us_private Int Int us_split_fields20 us_split_fields14) Bool)
...
(define-fun in_range25 ((x Int)) Bool (and (<= 1 x) (<= x 150)))
...
(declare-fun user_eq41 (descriptioni descriptioni) Bool)
(declare-const dummy41 descriptioni)
...
(declare-fun user_eq42 (statust1 statust1) Bool)
(declare-const dummy42 statust1)
...
(define-fun dynamic_invariant5 ((temp___expr_2867 Int) (temp___is_init_2863 Bool) (temp___skip_constant_2864 Bool) (temp___do_toplevel_2865 Bool) (temp___do_typ_inv_2866 Bool)) Bool (=> (or (= temp___is_init_2863 true) (<= 0 8)) (in_range26 temp___expr_2867)))
...
(define-fun dynamic_invariant9 ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_18)))
(define-fun dynamic_invariant10 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 3)) (in_range20 temp___expr_426)))
(define-fun dynamic_invariant11 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 3)) (in_range24 temp___expr_433)))
(define-fun dynamic_invariant12 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range19 temp___expr_440)))
(declare-fun therole (us_rep10) Int)
(declare-fun therole__function_guard (Int us_rep10) Bool)
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields20)) (forall ((admintoken__idcert__fields us_split_fields14)) (! (=> (and (and (dynamic_invariant2 admintoken__tokenpresence true true true true) (dynamic_invariant4 admintoken__tokentry true true true true)) (dynamic_invariant3 admintoken__tokenid true true true true)) (dynamic_invariant10 (theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true false true true)) :pattern ((theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields20)) (forall ((admintoken__idcert__fields us_split_fields14)) (! (=> (and (and (dynamic_invariant2 admintoken__tokenpresence true true true true) (dynamic_invariant4 admintoken__tokentry true true true true)) (dynamic_invariant3 admintoken__tokenid true true true true)) (= (theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) (therole (rec__admintoken__validauthcertt__contents (us_split_fields21 (mk___rep10 admintoken__authcert__fields)))))) :pattern ((theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(assert true)
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields20)) (forall ((admintoken__idcert__fields us_split_fields14)) (! (= (= (isgood admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true) (= (rec__admintoken__valididcertt__valid (us_split_fields15 (mk___rep7 admintoken__idcert__fields))) true)) :pattern ((isgood admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(assert true)
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields20)) (forall ((admintoken__idcert__fields us_split_fields14)) (! (= (= (authcertvalid admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true) (= (rec__admintoken__validauthcertt__valid (us_split_fields21 (mk___rep10 admintoken__authcert__fields))) true)) :pattern ((authcertvalid admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(define-fun dynamic_invariant13 ((temp___expr_1092 Int) (temp___is_init_1088 Bool) (temp___skip_constant_1089 Bool) (temp___do_toplevel_1090 Bool) (temp___do_typ_inv_1091 Bool)) Bool (=> (or (= temp___is_init_1088 true) (<= 0 40)) (in_range13 temp___expr_1092)))
(define-fun dynamic_invariant14 ((temp___expr_1116 Int) (temp___is_init_1112 Bool) (temp___skip_constant_1113 Bool) (temp___do_toplevel_1114 Bool) (temp___do_typ_inv_1115 Bool)) Bool (=> (or (= temp___is_init_1112 true) (<= 0 4294967295)) (in_range14 temp___expr_1116)))
(define-fun dynamic_invariant15 ((temp___expr_1140 Int) (temp___is_init_1136 Bool) (temp___skip_constant_1137 Bool) (temp___do_toplevel_1138 Bool) (temp___do_typ_inv_1139 Bool)) Bool (=> (or (= temp___is_init_1136 true) (<= 0 10)) (in_range16 temp___expr_1140)))
(define-fun dynamic_invariant16 ((temp___expr_1154 Int) (temp___is_init_1150 Bool) (temp___skip_constant_1151 Bool) (temp___do_toplevel_1152 Bool) (temp___do_typ_inv_1153 Bool)) Bool (=> (or (= temp___is_init_1150 true) (<= 0 4294967295)) (in_range17 temp___expr_1154)))
(define-fun dynamic_invariant17 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 128)) (in_range18 temp___expr_1161)))
(define-fun dynamic_invariant18 ((temp___expr_1276 Int) (temp___is_init_1272 Bool) (temp___skip_constant_1273 Bool) (temp___do_toplevel_1274 Bool) (temp___do_typ_inv_1275 Bool)) Bool (=> (or (= temp___is_init_1272 true) (<= 0 17)) (in_range6 temp___expr_1276)))
(define-fun dynamic_invariant19 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 1 17)) (in_range4 temp___expr_1283)))
(define-fun dynamic_invariant20 ((temp___expr_1409 Int) (temp___is_init_1405 Bool) (temp___skip_constant_1406 Bool) (temp___do_toplevel_1407 Bool) (temp___do_typ_inv_1408 Bool)) Bool (=> (or (= temp___is_init_1405 true) (<= 0 2)) (in_range3 temp___expr_1409)))
(define-fun dynamic_invariant21 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 0 17408)) (in_range5 temp___expr_1290)))
(define-fun dynamic_invariant22 ((temp___expr_1321 Int) (temp___is_init_1317 Bool) (temp___skip_constant_1318 Bool) (temp___do_toplevel_1319 Bool) (temp___do_typ_inv_1320 Bool)) Bool (=> (or (= temp___is_init_1317 true) (<= 0 1024)) (in_range7 temp___expr_1321)))
(assert true)
...
(assert (forall ((temp___1350 Int)) (=> (dynamic_invariant22 temp___1350 true true true true) (forall ((temp___1351 Int)) (= (select (temp_____aggregate_def_1348 temp___1350) temp___1351) rliteral2)))))
(define-fun dynamic_invariant23 ((temp___expr_573 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool) (temp___do_typ_inv_572 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 150)) (in_range25 temp___expr_573)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (forall ((temp___179 Int)) (=> (dynamic_invariant7 temp___179 true true true true) (forall ((temp___180 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___179) temp___180)) temp___179)))))
(define-fun dynamic_invariant24 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range9 temp___expr_625)))
(define-fun dynamic_invariant25 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range10 temp___expr_632)))
(define-fun dynamic_invariant26 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range11 temp___expr_639)))
(define-fun dynamic_invariant27 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range12 temp___expr_671)))
(define-fun dynamic_invariant28 ((temp___expr_1596 Int) (temp___is_init_1592 Bool) (temp___skip_constant_1593 Bool) (temp___do_toplevel_1594 Bool) (temp___do_typ_inv_1595 Bool)) Bool (=> (or (= temp___is_init_1592 true) (<= 0 4294967295)) (in_range15 temp___expr_1596)))
(assert (forall ((contents us_rep10)) (! (dynamic_invariant10 (therole contents) true false true true) :pattern ((therole contents)))))
(assert (forall ((contents us_rep10)) (! (= (therole contents) (to_rep18 (rec__cert__attr__auth__contentst__role (us_split_fields19 contents)))) :pattern ((therole contents)))))
(assert (forall ((temp___1346 Int)) (=> (dynamic_invariant19 temp___1346 true true true true) (forall ((temp___1347 Int)) (= (select (temp_____aggregate_def_1344 temp___1346) temp___1347) rliteral)))))
...
(declare-const authcert__split_fields us_split_fields__ref10)
(declare-const idcert__split_fields us_split_fields__ref7)
...
(declare-const authcert__split_fields1 us_split_fields20)
(declare-const idcert__split_fields1 us_split_fields14)
...
(declare-const authcert__split_fields2 us_split_fields__ref10)
(declare-const idcert__split_fields2 us_split_fields__ref7)
...
(declare-const authcert__split_fields3 us_split_fields20)
(declare-const idcert__split_fields3 us_split_fields14)
...
(define-fun logfilestate__split_fields23 () us_split_fields2 (mk___split_fields1 logfilestate__split_fields14 logfilestate__split_fields15 (mk___rep (mk___split_fields logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20))
(assert (= (audittypes__nodescription__aggregate_def 32) nodescription))
(assert (=> (<= 0 8) (in_range26 status)))
(assert (in_range21 tokenpresence))
(assert (in_range23 tokentry))
(assert (in_range22 tokenid))
...
(assert (= o (extractuser tokenpresence state tokentry tokenid (us_split_fields__content10 authcert__split_fields) (us_split_fields__content7 idcert__split_fields))))
(assert (and (= (valid_numberlogentries (to_rep3 logfilestate__split_fields7) (to_rep4 logfilestate__split_fields8) (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13) true) (in_range8 auditalarm1)))
(assert (= result status))
(assert (= status1 3))
(assert (and (= (valid_numberlogentries (to_rep3 logfilestate__split_fields14) (to_rep4 logfilestate__split_fields15) (mk___rep (mk___split_fields logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20) true) (in_range8 auditalarm2)))
(assert (and (and (not (= (isgood tokenpresence1 state3 tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true)) (and (not (= (authcertvalid tokenpresence1 state3 tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true)) (not (in_range24 (theauthcertrole tokenpresence1 state3 tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)))))) (and (and (in_range23 tokentry1) (in_range22 tokenid1)) (in_range21 tokenpresence1))))
(assert (= state6 (mk___private__ref state2)))
(assert (= state5 (mk___private__ref state3)))
(assert (= state4 (mk___private__ref state1)))
(assert (= filestate1 (mk___private__ref filestate)))
(assert (= status2 (mk_int__ref status1)))
(assert (= idcert__split_fields2 (let ((subject idcert__split_fields)) (mk___split_fields__ref7 idcert__split_fields1))))
(assert (= authcert__split_fields2 (let ((subject authcert__split_fields)) (mk___split_fields__ref10 authcert__split_fields1))))
...
(assert (= logfilestate__split_fields21 (mk___split_fields__ref1 logfilestate__split_fields23)))
(assert (= logfilesstatus1 (mk_map__ref1 logfilesstatus)))
(assert (= logfiles1 (mk_map__ref4 logfiles)))
(assert (= state9 state2))
(assert (= state8 state3))
(assert (= state7 state1))
...
(assert (= logfilestate__split_fields22 logfilestate__split_fields23))
(assert (= logfilesstatus2 logfilesstatus))
(assert (= logfiles2 logfiles))
(assert (not (= (int__content status2) 3)))
(check-sat)
(exit)
