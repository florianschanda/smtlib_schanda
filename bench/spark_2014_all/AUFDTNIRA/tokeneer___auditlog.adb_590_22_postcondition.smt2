...
(assert (not (= (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content1 logfilestate__split_fields22))) (+ (to_rep1 logfilestate__split_fields1) 1))))
(check-sat)
(exit)
