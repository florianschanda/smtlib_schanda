...
(declare-const o16 slice_bounds)
...
(assert (<= (to_rep (first (rt x))) hi))
(assert (<= hi (to_rep (last (rt x)))))
(assert (= (extended_indexqtint o13) hi))
(assert (= (indexqtint o14) lo))
(assert (= o15 (mk___split_fields o14 o13)))
(assert (= o16 (mk_slice_bounds o15)))
(assert (not (or (< (extended_indexqtint (rec__sums__slice_bounds__hi (us_split_fields1 o16))) (indexqtint (rec__sums__slice_bounds__lo (us_split_fields1 o16)))) (and (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo (us_split_fields1 o16)))) (<= (extended_indexqtint (rec__sums__slice_bounds__hi (us_split_fields1 o16))) (to_rep (last (rt x))))))))
(check-sat)
(exit)
