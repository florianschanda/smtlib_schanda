...
(assert (forall ((x filestatust)) (! (in_range8 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x logfileindext)) (! (in_range9 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((x logentrycountt)) (! (in_range10 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((x logfilecountt)) (! (in_range11 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(assert (forall ((x fileentrycountt)) (! (in_range12 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep8 (select a temp___idx_196)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_196)))))))))))
...
(define-fun bool_eq7 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 a))) (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 b)))) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 a))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 b))))) (= (bool_eq5 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 b))) true)) (= (bool_eq6 (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 b)) 1 17) true)) true false))
...
(define-fun bool_eq9 ((a (Array Int us_rep3)) (a__first Int) (a__last Int) (b (Array Int us_rep3)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq8 (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true)))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 1)) (in_range13 temp___expr_548)))
...
(define-fun dynamic_invariant2 ((temp___expr_1338 us_rep2) (temp___is_init_1334 Bool) (temp___skip_constant_1335 Bool) (temp___do_toplevel_1336 Bool) (temp___do_typ_inv_1337 Bool)) Bool (=> (= temp___do_typ_inv_1337 true) (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1338))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1338))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1338)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1338))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1342 us_rep2) (temp___skip_top_level_1343 Bool)) Bool (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1342))) 1) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1342))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1342)) (mk___rep1 (mk___split_fields1 (temp_____aggregate_def_1344 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1342)) (temp_____aggregate_def_1348 0))))
(define-fun type_invariant ((temp___1352 us_rep2)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1352))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1352))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1352)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1352))) true))
(declare-sort yearst 0)
(declare-fun yearstqtint (yearst) Int)
(assert (forall ((i yearst)) (and (<= 1901 (yearstqtint i)) (<= (yearstqtint i) 2099))))
(define-fun in_range14 ((x Int)) Bool (and (<= 1901 x) (<= x 2099)))
(declare-fun attr__ATTRIBUTE_IMAGE14 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check14 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE14 (us_image) Int)
(declare-fun user_eq20 (yearst yearst) Bool)
(declare-const dummy20 yearst)
...
(define-fun to_rep9 ((x yearst)) Int (yearstqtint x))
(declare-fun of_rep9 (Int) yearst)
(assert (forall ((x yearst)) (! (= (of_rep9 (to_rep9 x)) x) :pattern ((to_rep9 x)))))
(assert (forall ((x yearst)) (! (in_range14 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(declare-fun user_eq21 (monthst monthst) Bool)
(declare-const dummy21 monthst)
...
(define-fun to_rep10 ((x monthst)) Int (monthstqtint x))
(declare-fun of_rep10 (Int) monthst)
(assert (forall ((x monthst)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert (forall ((x monthst)) (! (in_range15 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(define-fun in_range16 ((x Int)) Bool (and (<= 1 x) (<= x 31)))
...
(declare-fun user_eq22 (dayst dayst) Bool)
(declare-const dummy22 dayst)
...
(define-fun to_rep11 ((x dayst)) Int (daystqtint x))
(declare-fun of_rep11 (Int) dayst)
(assert (forall ((x dayst)) (! (= (of_rep11 (to_rep11 x)) x) :pattern ((to_rep11 x)))))
(assert (forall ((x dayst)) (! (in_range16 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(define-fun in_range17 ((x Int)) Bool (and (<= 0 x) (<= x 86399999)))
...
(declare-fun user_eq23 (millisecst millisecst) Bool)
(declare-const dummy23 millisecst)
...
(define-fun to_rep12 ((x millisecst)) Int (millisecstqtint x))
(declare-fun of_rep12 (Int) millisecst)
(assert (forall ((x millisecst)) (! (= (of_rep12 (to_rep12 x)) x) :pattern ((to_rep12 x)))))
(assert (forall ((x millisecst)) (! (in_range17 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(define-fun us_split_fields_Year__projection ((a us_split_fields6)) yearst (rec__clock__timet__year a))
(define-fun us_split_fields_Month__projection ((a us_split_fields6)) monthst (rec__clock__timet__month a))
(define-fun us_split_fields_Day__projection ((a us_split_fields6)) dayst (rec__clock__timet__day a))
...
(define-fun bool_eq10 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (= (to_rep9 (rec__clock__timet__year (us_split_fields7 a))) (to_rep9 (rec__clock__timet__year (us_split_fields7 b)))) (= (to_rep10 (rec__clock__timet__month (us_split_fields7 a))) (to_rep10 (rec__clock__timet__month (us_split_fields7 b))))) (= (to_rep11 (rec__clock__timet__day (us_split_fields7 a))) (to_rep11 (rec__clock__timet__day (us_split_fields7 b))))) (= (to_rep12 (rec__clock__timet__millisec (us_split_fields7 a))) (to_rep12 (rec__clock__timet__millisec (us_split_fields7 b))))) true false))
...
(declare-datatypes () ((timet__ref (mk_timet__ref (timet__content us_rep4)))))
(define-fun timet__ref___projection ((a timet__ref)) us_rep4 (timet__content a))
...
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__cert__id__contentst__id us_rep6) (rec__cert__id__contentst__notbefore us_rep4) (rec__cert__id__contentst__notafter us_rep4) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep5) (rec__cert__id__contentst__subjectpublickey us_rep7)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields14)) us_rep6 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields14)) us_rep4 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields14)) us_rep4 (rec__cert__id__contentst__notafter a))
...
(declare-datatypes () ((us_split_fields20 (mk___split_fields10 (rec__cert__attr__auth__contentst__id us_rep6) (rec__cert__attr__auth__contentst__notbefore us_rep4) (rec__cert__attr__auth__contentst__notafter us_rep4) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep6) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep10)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields20)) us_rep6 (rec__cert__attr__auth__contentst__id a))
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields20)) us_rep4 (rec__cert__attr__auth__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields20)) us_rep4 (rec__cert__attr__auth__contentst__notafter a))
...
(define-fun dynamic_invariant3 ((temp___expr_245 Int) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool) (temp___do_typ_inv_244 Bool)) Bool (=> (or (= temp___is_init_241 true) (<= 0 1)) (in_range25 temp___expr_245)))
...
(define-fun dynamic_invariant4 ((temp___expr_1517 Int) (temp___is_init_1513 Bool) (temp___skip_constant_1514 Bool) (temp___do_toplevel_1515 Bool) (temp___do_typ_inv_1516 Bool)) Bool (=> (or (= temp___is_init_1513 true) (<= 0 4294967295)) (in_range26 temp___expr_1517)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant5 ((temp___expr_1524 Int) (temp___is_init_1520 Bool) (temp___skip_constant_1521 Bool) (temp___do_toplevel_1522 Bool) (temp___do_typ_inv_1523 Bool)) Bool (=> (or (= temp___is_init_1520 true) (<= 0 2)) (in_range27 temp___expr_1524)))
(assert true)
...
(define-fun dynamic_invariant6 ((temp___expr_2867 Int) (temp___is_init_2863 Bool) (temp___skip_constant_2864 Bool) (temp___do_toplevel_2865 Bool) (temp___do_typ_inv_2866 Bool)) Bool (=> (or (= temp___is_init_2863 true) (<= 0 8)) (in_range28 temp___expr_2867)))
(assert (forall ((enclave__status Int)) (! (=> (dynamic_invariant6 enclave__status true true true true) (dynamic_invariant6 (getstatus enclave__status) true false true true)) :pattern ((getstatus enclave__status)))))
(assert (forall ((enclave__status Int)) (! (=> (dynamic_invariant6 enclave__status true true true true) (= (getstatus enclave__status) enclave__status)) :pattern ((getstatus enclave__status)))))
...
(declare-fun presentadminhasdeparted (us_rep Int us_private Int Int us_split_fields22 us_split_fields16) Bool)
(declare-fun presentadminhasdeparted__function_guard (Bool us_rep Int us_private Int Int us_split_fields22 us_split_fields16) Bool)
(assert true)
...
(define-fun in_range30 ((x Int)) Bool (and (<= 1 x) (<= x 150)))
...
(define-fun dynamic_invariant11 ((temp___expr_2954 Int) (temp___is_init_2950 Bool) (temp___skip_constant_2951 Bool) (temp___do_toplevel_2952 Bool) (temp___do_typ_inv_2953 Bool)) Bool (=> (or (= temp___is_init_2950 true) (<= 0 2)) (in_range29 temp___expr_2954)))
(define-fun dynamic_invariant12 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 4)) (in_range5 temp___expr_496)))
(define-fun dynamic_invariant13 ((temp___expr_503 Int) (temp___is_init_499 Bool) (temp___skip_constant_500 Bool) (temp___do_toplevel_501 Bool) (temp___do_typ_inv_502 Bool)) Bool (=> (or (= temp___is_init_499 true) (<= 1 4)) (in_range6 temp___expr_503)))
(define-fun dynamic_invariant14 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 3)) (in_range7 temp___expr_433)))
(define-fun dynamic_invariant15 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range24 temp___expr_440)))
(define-fun dynamic_invariant16 ((temp___expr_1092 Int) (temp___is_init_1088 Bool) (temp___skip_constant_1089 Bool) (temp___do_toplevel_1090 Bool) (temp___do_typ_inv_1091 Bool)) Bool (=> (or (= temp___is_init_1088 true) (<= 0 40)) (in_range18 temp___expr_1092)))
(define-fun dynamic_invariant17 ((temp___expr_1116 Int) (temp___is_init_1112 Bool) (temp___skip_constant_1113 Bool) (temp___do_toplevel_1114 Bool) (temp___do_typ_inv_1115 Bool)) Bool (=> (or (= temp___is_init_1112 true) (<= 0 4294967295)) (in_range19 temp___expr_1116)))
(define-fun dynamic_invariant18 ((temp___expr_1140 Int) (temp___is_init_1136 Bool) (temp___skip_constant_1137 Bool) (temp___do_toplevel_1138 Bool) (temp___do_typ_inv_1139 Bool)) Bool (=> (or (= temp___is_init_1136 true) (<= 0 10)) (in_range21 temp___expr_1140)))
(define-fun dynamic_invariant19 ((temp___expr_1154 Int) (temp___is_init_1150 Bool) (temp___skip_constant_1151 Bool) (temp___do_toplevel_1152 Bool) (temp___do_typ_inv_1153 Bool)) Bool (=> (or (= temp___is_init_1150 true) (<= 0 4294967295)) (in_range22 temp___expr_1154)))
(define-fun dynamic_invariant20 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 128)) (in_range23 temp___expr_1161)))
(define-fun dynamic_invariant21 ((temp___expr_1276 Int) (temp___is_init_1272 Bool) (temp___skip_constant_1273 Bool) (temp___do_toplevel_1274 Bool) (temp___do_typ_inv_1275 Bool)) Bool (=> (or (= temp___is_init_1272 true) (<= 0 17)) (in_range11 temp___expr_1276)))
(define-fun dynamic_invariant22 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 1 17)) (in_range9 temp___expr_1283)))
(define-fun dynamic_invariant23 ((temp___expr_1409 Int) (temp___is_init_1405 Bool) (temp___skip_constant_1406 Bool) (temp___do_toplevel_1407 Bool) (temp___do_typ_inv_1408 Bool)) Bool (=> (or (= temp___is_init_1405 true) (<= 0 2)) (in_range8 temp___expr_1409)))
(define-fun dynamic_invariant24 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 0 17408)) (in_range10 temp___expr_1290)))
(define-fun dynamic_invariant25 ((temp___expr_1321 Int) (temp___is_init_1317 Bool) (temp___skip_constant_1318 Bool) (temp___do_toplevel_1319 Bool) (temp___do_typ_inv_1320 Bool)) Bool (=> (or (= temp___is_init_1317 true) (<= 0 1024)) (in_range12 temp___expr_1321)))
(assert true)
...
(define-fun dynamic_invariant26 ((temp___expr_573 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool) (temp___do_typ_inv_572 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 150)) (in_range30 temp___expr_573)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (forall ((temp___179 Int)) (=> (dynamic_invariant8 temp___179 true true true true) (forall ((temp___180 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___179) temp___180)) temp___179)))))
(define-fun dynamic_invariant27 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range14 temp___expr_625)))
(define-fun dynamic_invariant28 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range15 temp___expr_632)))
(define-fun dynamic_invariant29 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range16 temp___expr_639)))
(define-fun dynamic_invariant30 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range17 temp___expr_671)))
(define-fun dynamic_invariant31 ((temp___expr_1596 Int) (temp___is_init_1592 Bool) (temp___skip_constant_1593 Bool) (temp___do_toplevel_1594 Bool) (temp___do_typ_inv_1595 Bool)) Bool (=> (or (= temp___is_init_1592 true) (<= 0 4294967295)) (in_range20 temp___expr_1596)))
...
(assert (and (not (= (enrolmentisinprogress status) true)) (=> (or (= (statusiswaitingstartadminop status) true) (= (statusiswaitingfinishadminop status) true)) (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)))))
(assert (= result (presentadminhasdeparted (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)) tokenpresence state tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields))))
(assert (= result true))
(assert (= status 3))
(assert (= o (extractuser tokenpresence state tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields))))
