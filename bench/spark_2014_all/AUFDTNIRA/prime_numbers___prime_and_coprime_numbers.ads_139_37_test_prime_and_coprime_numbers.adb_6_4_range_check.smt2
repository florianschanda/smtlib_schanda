...
(assert (< test_prime_and_coprime_numbers__p__nearest_prime_number__result4 value))
(assert (and (= o1 (+ test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1)) (in_range1 (+ test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1))))
