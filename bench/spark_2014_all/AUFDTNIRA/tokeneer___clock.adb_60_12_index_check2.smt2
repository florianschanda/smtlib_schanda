...
(assert (in_range2 sstart))
(assert (in_range2 send))
(assert (and (<= send (to_rep1 s__last)) (<= (to_rep1 s__first) sstart)))
(assert (=> (<= 0 2147483647) (in_range4 v)))
(assert (= result v))
(assert (= v1 value))
(assert (= result1 i))
(assert (= i1 send))
(assert (<= sstart i1))
(assert (<= i1 send))
(assert (and (and (forall ((temp___504 Int)) (=> (and (<= (to_rep1 s__first) temp___504) (<= temp___504 (to_rep1 s__last))) (=> (or (< send temp___504) (or (< temp___504 sstart) (<= temp___504 i2))) (= (select s1 temp___504) (select s temp___504))))) (=> (<= 0 2147483647) (in_range4 v2))) (and (<= sstart i2) (<= i2 send))))
