...
(assert (and (= o3 (capacity (mk___rep p__split_discrs (mk___split_fields p__split_fields)))) (and (in_range1 o3) (= o3 (ite (= (distinct 1 0) true) (to_rep (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o1 (length (mk___rep p__split_discrs (mk___split_fields p__split_fields)))) (and (in_range1 o1) (<= o1 (capacity (mk___rep p__split_discrs (mk___split_fields p__split_fields)))))))
(assert (= o2 (* 2 o1)))
(assert (and (= o4 o2) (in_range4 o2)))
...
(assert (= result1 (ite (<= o 5000) true false)))
(assert (= result1 true))
...
(assert (<= 0 j))
(assert (<= j 5))
(assert (not (<= 0 (to_rep3 (select f j)))))
(check-sat)
(exit)
