...
(assert (and (= o9 (- i1 (to_rep (first4 (rt2 a))))) (in_range1 (- i1 (to_rep (first4 (rt2 a)))))))
...
(assert (= o6 i1))
(assert (= o7 (select (elts1 (acc_array__content test_higher_order__sum__acc_f__result5)) o6)))
(assert (= o8 (to_rep2 o7)))
(assert (and (= result6 (in_range5 (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))))) o8 o12)) (= (= result6 true) (and (<= (+ (- 2147483648) (* 100 (- (length (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))))) o12))) o8) (<= o8 (- 2147483647 (* 100 (- (length (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))))) o12))))))))
(assert (= result6 true))
(assert (=> (= i1 (to_rep (first4 (rt2 a)))) (= o5 init)))
(assert (=> (not (= i1 (to_rep (first4 (rt2 a))))) (and (= temp___399 (- i1 1)) (in_range1 (- i1 1)))))
(assert (=> (not (= i1 (to_rep (first4 (rt2 a))))) (and (<= (to_rep (first2 (rt1 (acc_array__content test_higher_order__sum__acc_f__result5)))) temp___399) (<= temp___399 (to_rep (last2 (rt1 (acc_array__content test_higher_order__sum__acc_f__result5))))))))
(assert (=> (not (= i1 (to_rep (first4 (rt2 a))))) (= o3 temp___399)))
(assert (=> (not (= i1 (to_rep (first4 (rt2 a))))) (= o4 (select (elts1 (acc_array__content test_higher_order__sum__acc_f__result5)) o3))))
(assert (=> (not (= i1 (to_rep (first4 (rt2 a))))) (= o5 (to_rep2 o4))))
(assert (not (<= i1 (to_rep (last4 (rt2 a))))))
(check-sat)
(exit)
