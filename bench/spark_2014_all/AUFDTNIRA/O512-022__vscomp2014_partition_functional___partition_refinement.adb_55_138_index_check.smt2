...
(define-fun o28 () us_rep1 (mk___rep1 (mk___split_fields1 o13 o14 o15)))
(define-fun o29 () us_rep1 (mk___rep1 (mk___split_fields1 o4 o5 o6)))
(assert (and (= o26 (capacity (mk___rep p__split_discrs (mk___split_fields p__split_fields)))) (and (in_range1 o26) (= o26 (ite (= (distinct 1 0) true) (to_rep (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o24 (length (mk___rep p__split_discrs (mk___split_fields p__split_fields)))) (and (in_range1 o24) (<= o24 (capacity (mk___rep p__split_discrs (mk___split_fields p__split_fields)))))))
(assert (= o25 (* 2 o24)))
(assert (and (= o27 o25) (in_range4 o25)))
(assert (= result (ite (<= o27 o26) true false)))
(assert (= result true))
(assert (and (= o23 (length (mk___rep p__split_discrs (mk___split_fields p__split_fields)))) (and (in_range1 o23) (<= o23 (capacity (mk___rep p__split_discrs (mk___split_fields p__split_fields)))))))
(assert (= result1 (ite (<= o23 5000) true false)))
(assert (= result1 true))
(assert (= (= result2 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= 0 (to_rep3 (select f j1))) (<= (to_rep3 (select f j1)) (- (length (mk___rep p__split_discrs (mk___split_fields p__split_fields))) 1)))))))
(assert (= result2 true))
(assert (= (= result3 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields3 (get (model__ (mk___rep p__split_discrs (mk___split_fields p__split_fields))) (to_rep3 (select f j1)))))) j1) (<= j1 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields3 (get (model__ (mk___rep p__split_discrs (mk___split_fields p__split_fields))) (to_rep3 (select f j1))))))))))))
(assert (= result3 true))
...
(assert (= result4 true))
(assert (and (= o12 j) (in_range9 j)))
(assert (and (= o28 (get (model__ (mk___rep p__split_discrs (mk___split_fields p__split_fields))) o12)) (= (bool_eq o28 (get (model__ (mk___rep p__split_discrs (mk___split_fields p__split_fields))) o12)) true)))
(assert (= o13 o16))
(assert (= o14 o17))
(assert (= o15 o18))
(assert (= o19 o17))
...
(assert (and (= o3 j) (in_range9 j)))
(assert (and (= o29 (get (model__ (mk___rep p__split_discrs (mk___split_fields p__split_fields))) o3)) (= (bool_eq o29 (get (model__ (mk___rep p__split_discrs (mk___split_fields p__split_fields))) o3)) true)))
(assert (= o4 o7))
(assert (= o5 o8))
(assert (= o6 o9))
(assert (= o10 o7))
(assert (= o11 (to_rep2 o10)))
(assert (= o22 (ite (<= o11 k) true false)))
(assert (= result5 (ite (= o22 true) o21 false)))
(assert (= result5 true))
(assert (not (<= k 5)))
(check-sat)
(exit)
