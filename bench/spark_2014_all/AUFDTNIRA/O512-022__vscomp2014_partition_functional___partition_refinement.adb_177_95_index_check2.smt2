...
(assert (<= r54b i1))
(assert (<= i1 r55b))
(assert (= (to_rep3 o9) p_prime_index2))
(assert (= o10 (store f1 i1 o9)))
(assert (= result9 (mk_map__ref f1)))
(assert (= f2 o10))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) k1) (<= k1 i2)) (= (to_rep3 (select f3 k1)) p_prime_index2))))
(assert (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 (- (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) 1))) (= (to_rep3 (select f3 k1)) (to_rep3 (select f_loop_entry k1))))))
(assert (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 5)) (= (to_rep3 (select f3 k1)) (to_rep3 (select f_loop_entry k1))))))
(assert (and (and (forall ((temp___1298 Int)) (=> (and (<= 0 temp___1298) (<= temp___1298 5)) (=> (or (< r55b temp___1298) (or (< temp___1298 r54b) (< i2 temp___1298))) (= (select f3 temp___1298) (select f1 temp___1298))))) (=> (<= r54b r55b) (dynamic_property r54b r55b i2))) (and (<= r54b i2) (<= i2 r55b))))
(assert (<= 0 k))
(assert (<= k (- (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) 1)))
(assert (and (<= 0 k) (<= k 5)))
(assert (= o11 k))
(assert (= o12 (select f_loop_entry o11)))
