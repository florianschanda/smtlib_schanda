...
(declare-const i Int)
(declare-const temp___189 (Array Int natural))
...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___189 a2)))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___188 i1)))
...
(assert (=> (and (<= 2 i1) (<= i1 30)) (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___190 Int)) (=> (and (<= 0 temp___190) (<= temp___190 30)) (=> (or (< 30 temp___190) (or (< temp___190 2) (< i2 temp___190))) (= (select a4 temp___190) (select temp___189 temp___190)))))) (and (<= 2 i2) (<= i2 30)))))
