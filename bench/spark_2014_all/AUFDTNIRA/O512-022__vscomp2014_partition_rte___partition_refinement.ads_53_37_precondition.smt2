...
(assert (and (= o6 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o6) (= o6 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
...
(assert (= o5 (* 2 o4)))
(assert (and (= o7 o5) (in_range11 o5)))
(assert (= result (ite (<= o7 o6) true false)))
(assert (= result true))
(assert (and (= o3 (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o3) (<= o3 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
...
(assert (= result2 true))
(assert (and (= o (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1)) (= (= o true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1) true))))
(assert (= o1 true))
(assert (= result3 (ite (= o1 true) o false)))
(assert (= result3 true))
(assert (and (= o2 (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c1)) (and (in_range5 o2) (= o2 (get2 (keys (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (get3 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1))))))
