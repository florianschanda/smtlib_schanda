...
(assert (<= 1 i1))
(assert (<= i1 17))
(assert (< 0 (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))))))
(assert (not (< (to_rep2 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))) i1)))
(check-sat)
(exit)
