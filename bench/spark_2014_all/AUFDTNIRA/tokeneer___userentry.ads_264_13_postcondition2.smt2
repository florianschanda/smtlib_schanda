...
(declare-const logfilestate__split_fields7 us_split_fields__ref4)
...
(assert (= (and (and (= (islocked (int__content currentlatch1) (us_private__content state4) (us_split_fields__content latchtimeout__split_fields4)) true) (= (thecurrentdoor (us_private__content state5)) 0)) (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) (us_private__content currenttime)) (alarm_timeout (us_private__content state5))) true)) (= (thedooralarm (us_private__content state5)) 0)))
(assert (and (and (and (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content4 logfilestate__split_fields7))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content4 logfilestate__split_fields7))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content4 logfilestate__split_fields7)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content4 logfilestate__split_fields7))) true) (in_range5 (int__content currentlatch1))) (in_range7 (int__content auditalarm1))) (in_range11 (int__content status1))))
(assert (= (islocked (int__content currentlatch1) (us_private__content state4) (us_split_fields__content latchtimeout__split_fields4)) true))
(assert (= (thecurrentdoor (us_private__content state5)) 0))
(assert (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) (us_private__content currenttime)) (alarm_timeout (us_private__content state5))) true))
