...
(assert (=> (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo (us_split_fields1 (slice_bounds__content slice_sums__maximal_sum_slice_bounds_2__result5))))) (= result13 (ite (<= (extended_indexqtint (rec__sums__slice_bounds__hi (us_split_fields1 (slice_bounds__content slice_sums__maximal_sum_slice_bounds_2__result5)))) (to_rep (last (rt x)))) true false))))
(assert (=> (not (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo (us_split_fields1 (slice_bounds__content slice_sums__maximal_sum_slice_bounds_2__result5)))))) (= result13 false)))
(assert (= result13 true))
(assert (<= (to_rep (first (rt x))) lo))
(assert (<= lo (to_rep (last (rt x)))))
