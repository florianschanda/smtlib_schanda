...
(define-fun dynamic_invariant1 ((temp___expr_237 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool) (temp___do_typ_inv_236 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= 0 1)) (in_range9 temp___expr_237)))
...
(declare-fun user_eq16 (returnvaluet returnvaluet) Bool)
(declare-const dummy16 returnvaluet)
...
(define-fun dynamic_invariant3 ((temp___expr_1684 Int) (temp___is_init_1680 Bool) (temp___skip_constant_1681 Bool) (temp___do_toplevel_1682 Bool) (temp___do_typ_inv_1683 Bool)) Bool (=> (or (= temp___is_init_1680 true) (<= 0 28)) (in_range10 temp___expr_1684)))
...
(declare-fun user_eq17 (unsigned32t unsigned32t) Bool)
(declare-const dummy17 unsigned32t)
...
(assert (forall ((x unsigned32t)) (! (in_range11 (to_rep7 x)) :pattern ((to_rep7 x)))))
(assert (forall ((x Int)) (! (=> (in_range11 x) (= (to_rep7 (of_rep7 x)) x)) :pattern ((to_rep7 (of_rep7 x))))))
(declare-fun to_rep8 (returnvaluet) Int)
(declare-fun of_rep8 (Int) returnvaluet)
(assert (forall ((x returnvaluet)) (! (= (of_rep8 (to_rep8 x)) x) :pattern ((to_rep8 x)))))
(assert (forall ((x returnvaluet)) (! (in_range10 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(define-fun to_rep9 ((x bytet)) Int (bytetqtint x))
(declare-fun of_rep9 (Int) bytet)
(assert (forall ((x bytet)) (! (= (of_rep9 (to_rep9 x)) x) :pattern ((to_rep9 x)))))
(assert (forall ((x bytet)) (! (in_range12 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(define-fun bool_eq10 ((a (Array Int bytet)) (a__first Int) (a__last Int) (b (Array Int bytet)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_164 Int)) (=> (and (<= a__first temp___idx_164) (<= temp___idx_164 a__last)) (= (to_rep9 (select a temp___idx_164)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_164))))))) true false))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_164 Int)) (=> (and (<= a__first temp___idx_164) (<= temp___idx_164 a__last)) (= (to_rep9 (select a temp___idx_164)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_164)))))))))))
...
(define-fun us_split_fields__ref___14__projection ((a us_split_fields__ref2)) us_split_fields4 (us_split_fields__content2 a))
(declare-datatypes () ((us_rep3 (mk___rep2 (us_split_fields5 us_split_fields4)))))
(define-fun us_rep___15__projection ((a us_rep3)) us_split_fields4 (us_split_fields5 a))
(define-fun bool_eq11 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (to_rep7 (rec__keystore__interfac__digestt__digestid (us_split_fields5 a))) (to_rep7 (rec__keystore__interfac__digestt__digestid (us_split_fields5 b)))) (= (to_rep8 (rec__keystore__interfac__digestt__signreturn (us_split_fields5 a))) (to_rep8 (rec__keystore__interfac__digestt__signreturn (us_split_fields5 b))))) (= (to_rep8 (rec__keystore__interfac__digestt__verifyreturn (us_split_fields5 a))) (to_rep8 (rec__keystore__interfac__digestt__verifyreturn (us_split_fields5 b))))) (= (bool_eq10 (rec__keystore__interfac__digestt__pad (us_split_fields5 a)) 1 20 (rec__keystore__interfac__digestt__pad (us_split_fields5 b)) 1 20) true)) true false))
...
(declare-datatypes () ((digestt__ref (mk_digestt__ref (digestt__content us_rep3)))))
(define-fun digestt__ref___projection ((a digestt__ref)) us_rep3 (digestt__content a))
...
(define-fun dynamic_invariant5 ((temp___expr_244 Int) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool) (temp___do_typ_inv_243 Bool)) Bool (=> (or (= temp___is_init_240 true) (<= 0 4294967295)) (in_range11 temp___expr_244)))
(assert true)
...
(declare-fun user_eq22 (descriptioni descriptioni) Bool)
(declare-const dummy22 descriptioni)
...
(declare-fun user_eq23 (algorithmt algorithmt) Bool)
(declare-const dummy23 algorithmt)
...
(define-fun dynamic_invariant6 ((temp___expr_1038 Int) (temp___is_init_1034 Bool) (temp___skip_constant_1035 Bool) (temp___do_toplevel_1036 Bool) (temp___do_typ_inv_1037 Bool)) Bool (=> (or (= temp___is_init_1034 true) (<= 0 10)) (in_range14 temp___expr_1038)))
...
(declare-fun user_eq24 (rawcertificatei rawcertificatei) Bool)
(declare-const dummy24 rawcertificatei)
...
(define-fun to_rep10 ((x rawcertificatei)) Int (rawcertificateiqtint x))
(declare-fun of_rep10 (Int) rawcertificatei)
(assert (forall ((x rawcertificatei)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert (forall ((x rawcertificatei)) (! (in_range15 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(define-fun bool_eq13 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (bool_eq (rec__certtypes__rawdatat__rawdata (us_split_fields7 a)) 1 4096 (rec__certtypes__rawdatat__rawdata (us_split_fields7 b)) 1 4096) true) (= (to_rep10 (rec__certtypes__rawdatat__datalength (us_split_fields7 a))) (to_rep10 (rec__certtypes__rawdatat__datalength (us_split_fields7 b))))) true false))
...
(declare-const nulldigest us_rep3)
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-fun temp_____aggregate_def_190 (Int) (Array Int bytet))
...
(declare-fun temp___String_Literal_1901 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1901 us_void_param) 1)) 68) (= (to_rep (select (temp___String_Literal_1901 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1901 us_void_param) 3)) 103)) (= (to_rep (select (temp___String_Literal_1901 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1901 us_void_param) 5)) 115)) (= (to_rep (select (temp___String_Literal_1901 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_1901 us_void_param) 7)) 73)) (= (to_rep (select (temp___String_Literal_1901 us_void_param) 8)) 110)) (= (to_rep (select (temp___String_Literal_1901 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1901 us_void_param) 10)) 116)) :pattern ((temp___String_Literal_1901 us_void_param)))))
(declare-fun temp___String_Literal_1903 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1903 us_void_param) 1)) 68) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 3)) 103)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 5)) 115)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 7)) 85)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 8)) 112)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 9)) 100)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 10)) 97)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 11)) 116)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 12)) 101)) :pattern ((temp___String_Literal_1903 us_void_param)))))
(declare-fun temp___String_Literal_1905 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1905 us_void_param) 1)) 68) (= (to_rep (select (temp___String_Literal_1905 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1905 us_void_param) 3)) 103)) (= (to_rep (select (temp___String_Literal_1905 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1905 us_void_param) 5)) 115)) (= (to_rep (select (temp___String_Literal_1905 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_1905 us_void_param) 7)) 70)) (= (to_rep (select (temp___String_Literal_1905 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1905 us_void_param) 9)) 110)) (= (to_rep (select (temp___String_Literal_1905 us_void_param) 10)) 97)) (= (to_rep (select (temp___String_Literal_1905 us_void_param) 11)) 108)) :pattern ((temp___String_Literal_1905 us_void_param)))))
...
(define-fun dynamic_invariant10 ((temp___expr_265 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool) (temp___do_typ_inv_264 Bool)) Bool (=> (or (= temp___is_init_261 true) (<= 0 255)) (in_range12 temp___expr_265)))
...
(define-fun dynamic_invariant12 ((temp___expr_1451 Int) (temp___is_init_1447 Bool) (temp___skip_constant_1448 Bool) (temp___do_toplevel_1449 Bool) (temp___do_typ_inv_1450 Bool)) Bool (=> (or (= temp___is_init_1447 true) (<= 1 4096)) (in_range15 temp___expr_1451)))
(define-fun dynamic_invariant13 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 1 150)) (in_range13 temp___expr_471)))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(define-fun dynamic_invariant14 ((temp___expr_1207 Int) (temp___is_init_1203 Bool) (temp___skip_constant_1204 Bool) (temp___do_toplevel_1205 Bool) (temp___do_typ_inv_1206 Bool)) Bool (=> (or (= temp___is_init_1203 true) (<= 0 17)) (in_range7 temp___expr_1207)))
(define-fun dynamic_invariant15 ((temp___expr_1214 Int) (temp___is_init_1210 Bool) (temp___skip_constant_1211 Bool) (temp___do_toplevel_1212 Bool) (temp___do_typ_inv_1213 Bool)) Bool (=> (or (= temp___is_init_1210 true) (<= 1 17)) (in_range5 temp___expr_1214)))
(define-fun dynamic_invariant16 ((temp___expr_1340 Int) (temp___is_init_1336 Bool) (temp___skip_constant_1337 Bool) (temp___do_toplevel_1338 Bool) (temp___do_typ_inv_1339 Bool)) Bool (=> (or (= temp___is_init_1336 true) (<= 0 2)) (in_range4 temp___expr_1340)))
(define-fun dynamic_invariant17 ((temp___expr_1221 Int) (temp___is_init_1217 Bool) (temp___skip_constant_1218 Bool) (temp___do_toplevel_1219 Bool) (temp___do_typ_inv_1220 Bool)) Bool (=> (or (= temp___is_init_1217 true) (<= 0 17408)) (in_range6 temp___expr_1221)))
(define-fun dynamic_invariant18 ((temp___expr_1252 Int) (temp___is_init_1248 Bool) (temp___skip_constant_1249 Bool) (temp___do_toplevel_1250 Bool) (temp___do_typ_inv_1251 Bool)) Bool (=> (or (= temp___is_init_1248 true) (<= 0 1024)) (in_range8 temp___expr_1252)))
(assert true)
...
(assert (forall ((temp___1281 Int)) (=> (dynamic_invariant18 temp___1281 true true true true) (forall ((temp___1282 Int)) (= (select (temp_____aggregate_def_1279 temp___1281) temp___1282) rliteral2)))))
(declare-const rliteral3 unsigned32t)
(assert (= (unsigned32tqtint rliteral3) 0))
(assert (= nulldigest (mk___rep2 (mk___split_fields2 rliteral3 (of_rep8 3) (of_rep8 3) (temp_____aggregate_def_190 0)))))
(declare-const rliteral4 bytet)
(assert (= (bytetqtint rliteral4) 0))
(assert (forall ((temp___192 Int)) (=> (dynamic_invariant10 temp___192 true true true true) (forall ((temp___193 Int)) (= (select (temp_____aggregate_def_190 temp___192) temp___193) rliteral4)))))
(assert (forall ((temp___1277 Int)) (=> (dynamic_invariant15 temp___1277 true true true true) (forall ((temp___1278 Int)) (= (select (temp_____aggregate_def_1275 temp___1277) temp___1278) rliteral)))))
...
(declare-const temp___1917 us_rep3)
...
(declare-const thedigest__split_fields4 us_split_fields4)
...
(assert (= (to_rep8 o) 3))
(assert (= (to_rep8 o1) 3))
(assert (= o2 (mk___split_fields2 rliteral3 o1 o (temp_____aggregate_def_190 0))))
(assert (= temp___1917 (mk___rep2 o2)))
(assert (= temp___1917 nulldigest))
(assert (in_range14 mechanism))
...
(assert (= size1 100))
(assert (in_range11 size1))
(assert (= result3 (mk___split_fields__ref2 (mk___split_fields2 thedigest__split_fields thedigest__split_fields1 thedigest__split_fields2 thedigest__split_fields3))))
(assert (= thedigest__split_fields4 (us_split_fields5 nulldigest)))
(assert (in_range10 retvalini1))
(assert (= retvalini1 0))
(assert (= result4 (mk_int__ref loopmax)))
(assert (= loopmax1 (+ (div1 (- (to_rep10 (rec__certtypes__rawdatat__datalength (us_split_fields7 rawcertdata))) 1) 100) 1)))
(assert (= result5 (mk_int__ref bytesleft)))
(assert (= bytesleft1 (to_rep10 (rec__certtypes__rawdatat__datalength (us_split_fields7 rawcertdata)))))
...
(assert (<= 1 j1))
(assert (<= j1 r29b))
(assert (and (and (and (and (and (= loopmax1 (+ (div1 (- (to_rep10 (rec__certtypes__rawdatat__datalength (us_split_fields7 rawcertdata))) 1) 100) 1)) (and (<= 1 j2) (<= j2 loopmax1))) (= bytesleft2 (- (to_rep10 (rec__certtypes__rawdatat__datalength (us_split_fields7 rawcertdata))) (* (- j2 1) 100)))) (and (<= 1 size2) (<= size2 100))) (= retvalini1 0)) (= retvalfin1 0)))
(assert (and (and (and (and (=> (<= 1 2147483647) (in_range2 bytesleft2)) (=> (<= 0 28) (in_range10 retvalupd2))) (=> (<= 0 4294967295) (in_range11 size2))) (=> (<= 1 r29b) (dynamic_property3 1 r29b j2))) (and (<= 1 j2) (<= j2 r29b))))
(assert (and (= o3 (* (- j2 1) 100)) (in_range1 (* (- j2 1) 100))))
(assert (= o4 (- (to_rep10 (rec__certtypes__rawdatat__datalength (us_split_fields7 rawcertdata))) o3)))
