...
(declare-const thistisinfo__split_fields4 us_split_fields__ref1)
...
(assert (and (= (= (privatekeypresent (us_split_fields__content1 thistisinfo__split_fields4) (us_private__content state1)) true) (not (= (enrolmentisinprogress (int__content status1)) true))) (or (= (enrolmentisinprogress (int__content status1)) true) (= (int__content status1) 3))))
(assert (and (and (in_range4 (int__content status1)) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content3 logfilestate__split_fields7))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content3 logfilestate__split_fields7))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content3 logfilestate__split_fields7)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content3 logfilestate__split_fields7))) true)) (in_range11 (int__content auditalarm1))))
(assert (= (privatekeypresent (us_split_fields__content1 thistisinfo__split_fields4) (us_private__content state1)) true))
(assert (not (not (= (enrolmentisinprogress (int__content status1)) true))))
(check-sat)
(exit)
