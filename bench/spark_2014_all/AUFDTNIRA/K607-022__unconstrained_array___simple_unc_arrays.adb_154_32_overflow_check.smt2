...
(define-fun dynamic_invariant2 ((temp___expr_589 Int) (temp___is_init_585 Bool) (temp___skip_constant_586 Bool) (temp___do_toplevel_587 Bool) (temp___do_typ_inv_588 Bool)) Bool (=> (or (= temp___is_init_585 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_589)))
...
(define-fun dynamic_invariant6 ((temp___expr_828 us_t2) (temp___is_init_824 Bool) (temp___skip_constant_825 Bool) (temp___do_toplevel_826 Bool) (temp___do_typ_inv_827 Bool)) Bool (=> (not (= temp___skip_constant_825 true)) (and (dynamic_property4 1 r63b (first6 temp___expr_828) (last6 temp___expr_828)) (and (= (first6 temp___expr_828) 1) (= (last6 temp___expr_828) r63b)))))
...
(assert (and (<= (to_rep1 (first a__split_fields1)) pivot_index1) (<= pivot_index1 (to_rep1 (last a__split_fields1)))))
...
(assert (= right1 last4))
(assert (and (and (dynamic_invariant1 (mk___rep a__split_discrs (mk___split_fields (mk___t a__split_fields2 a__split_fields3))) true true true true) (=> (<= 0 2147483647) (in_range2 right2))) (=> (<= 0 2147483647) (in_range2 left2))))
(assert (=> (< left2 last4) (and (<= (to_rep1 (first a__split_fields3)) left2) (<= left2 (to_rep1 (last a__split_fields3))))))
