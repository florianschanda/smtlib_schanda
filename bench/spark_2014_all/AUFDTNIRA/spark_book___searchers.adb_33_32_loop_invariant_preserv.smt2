...
(assert (<= (to_rep (select items low_index2)) search_item))
(assert (<= search_item (to_rep (select items high_index2))))
(assert (and (and (and (=> (<= 1 100) (in_range2 result__3)) (=> (<= 1 100) (in_range2 low_index2))) (=> (<= 1 100) (in_range2 mid_index2))) (=> (<= 1 100) (in_range2 high_index2))))
(assert (=> (< (to_rep (select items mid_index2)) search_item) (= low_index2 result5)))
(assert (=> (< (to_rep (select items mid_index2)) search_item) (= low_index3 mid_index2)))
(assert (=> (< (to_rep (select items mid_index2)) search_item) (= high_index3 high_index2)))
(assert (=> (not (< (to_rep (select items mid_index2)) search_item)) (= high_index2 result6)))
...
(assert (not (<= search_item (to_rep (select items high_index3)))))
(check-sat)
(exit)
