...
(declare-const logfilestate__split_fields14 us_split_fields22)
...
(declare-const logfilestate__split_fields15 us_split_fields__ref11)
...
(declare-const logfilestate__split_fields16 us_split_fields22)
...
(define-fun logfilestate__split_fields17 () us_split_fields22 (mk___split_fields11 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep10 (mk___split_fields10 logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13))
...
(assert (=> (= result true) (= logfilestate__split_fields14 (mk___split_fields11 logfilestate__split_fields logfilestate__split_fields1 (mk___rep10 (mk___split_fields10 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))))
...
(assert (= logfilestate__split_fields15 (mk___split_fields__ref11 logfilestate__split_fields14)))
...
(assert (and (= o10 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range1 o10) (= o10 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result3 (ite (= o10 1) true false)))
(assert (=> (= result3 true) (and (= o12 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o12 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result3 true) (= o13 (ite (not (= o12 true)) true false))))
(assert (=> (= result3 true) (and (= result4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result4 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result3 true) (=> (= result4 true) (and (= o11 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range3 o11)))))
(assert (=> (= result3 true) (=> (= result4 true) (= o14 (ite (= o11 3) true false)))))
(assert (=> (= result3 true) (=> (not (= result4 true)) (= o14 false))))
(assert (=> (= result3 true) (= o15 (ite (= o14 false) o13 true))))
(assert (=> (not (= result3 true)) (= o15 (distinct 1 0))))
(assert (and (= result6 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result6 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (=> (= result6 true) (and (= o7 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range3 o7))))
(assert (=> (= result6 true) (= result5 (ite (= o7 3) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (=> (= result5 true) (and (= o8 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range1 o8) (= o8 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result5 true) (= o9 (ite (= o8 1) true false))))
(assert (=> (not (= result5 true)) (= o9 (distinct 1 0))))
...
(assert (=> (= result7 true) (and (= o3 (theauthcertrole tokenpresence state1 tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content6 idcert__split_fields))) (and (in_range1 o3) (= o3 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content9 authcert__split_fields))))))))
(assert (=> (= result7 true) (= o4 (ite (= o3 1) true false))))
(assert (=> (= result7 true) (and (= o1 (authcertvalid tokenpresence state1 tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content6 idcert__split_fields))) (= (= o1 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content9 authcert__split_fields)) true)))))
(assert (=> (= result7 true) (and (= o2 (isgood tokenpresence state1 tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content6 idcert__split_fields))) (= (= o2 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content6 idcert__split_fields)) true)))))
(assert (=> (= result7 true) (= o5 (ite (= o2 true) o1 false))))
(assert (=> (= result7 true) (= o6 (ite (= o5 true) o4 false))))
(assert (=> (not (= result7 true)) (= o6 (distinct 1 0))))
(assert (and (= result8 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result8 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result8 true))
