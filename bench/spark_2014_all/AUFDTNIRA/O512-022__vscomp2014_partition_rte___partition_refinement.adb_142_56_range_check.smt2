...
(assert (not (in_range3 (- (+ (to_rep2 (rec__partition_refinement__interval__first p_elem__split_fields3)) (to_rep1 (rec__partition_refinement__interval__count p_elem__split_fields3))) 1))))
(check-sat)
(exit)
