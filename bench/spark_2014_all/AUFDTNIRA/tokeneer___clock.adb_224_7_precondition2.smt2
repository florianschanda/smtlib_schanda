...
(assert (= localtext3 (slide clock__setstringsegment__s1 (to_rep1 (first (mk 1 10))) 1)))
(assert (= (to_rep1 o5) 10))
(assert (= (to_rep1 o4) 1))
(assert (= result3 localtext3))
(assert (= localtext4 (slide clock__setstringsegment__s2 (to_rep1 (first (mk 1 10))) 1)))
(assert (= (to_rep1 o7) 10))
(assert (= (to_rep1 o6) 1))
(assert (not (<= 10 (to_rep1 o7))))
(check-sat)
(exit)
