...
(assert (forall ((temp___2037 Int) (temp___2038 Int) (temp___2039 Int) (temp___2040 Int) (temp___2041 Int) (temp___2042 Int) (temp___2043 Int)) (let ((temp___2036 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__aggregate_def temp___2037 temp___2038 temp___2039 temp___2040 temp___2041 temp___2042 temp___2043))) (=> (and (and (and (and (dynamic_invariant temp___2037 true true true true) (dynamic_invariant temp___2038 true true true true)) (dynamic_invariant temp___2039 true true true true)) (dynamic_invariant temp___2040 true true true true)) (dynamic_invariant temp___2041 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 6) (+ (first1 source) 10) temp___2042 temp___2043) (and (= (first5 temp___2036) temp___2042) (= (last5 temp___2036) temp___2043))) (and (and (and (and (= (select (to_array2 temp___2036) (+ (+ (first1 source) 6) 0)) rliteral) (= (select (to_array2 temp___2036) (+ (+ (first1 source) 6) 1)) rliteral1)) (= (select (to_array2 temp___2036) (+ (+ (first1 source) 6) 2)) rliteral1)) (= (select (to_array2 temp___2036) (+ (+ (first1 source) 6) 3)) rliteral1)) (= (select (to_array2 temp___2036) (+ (+ (first1 source) 6) 4)) rliteral1)))))))
(define-fun dynamic_invariant4 ((temp___expr_654 us_t3) (temp___is_init_650 Bool) (temp___skip_constant_651 Bool) (temp___do_toplevel_652 Bool) (temp___do_typ_inv_653 Bool)) Bool (=> (not (= temp___skip_constant_651 true)) (and (dynamic_property6 (+ (first1 source) 6) (+ (first1 source) 10) (first7 temp___expr_654) (last7 temp___expr_654)) (and (= (first7 temp___expr_654) (+ (first1 source) 6)) (= (last7 temp___expr_654) (+ (first1 source) 10))))))
(declare-sort t6 0)
...
(assert (forall ((temp___2049 Int) (temp___2050 Int) (temp___2051 Int)) (let ((temp___2048 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__aggregate_def temp___2049 temp___2050 temp___2051))) (=> (dynamic_invariant temp___2049 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 6) (+ (first1 source) 10) temp___2050 temp___2051) (and (= (first9 temp___2048) temp___2050) (= (last9 temp___2048) temp___2051))) (forall ((temp___2052 Int)) (= (select (to_array4 temp___2048) temp___2052) rliteral2)))))))
...
(declare-const temp___2046 (Array Int integer))
(declare-const temp___20461 t2)
...
(declare-const temp___2054 (Array Int integer))
(declare-const temp___20541 t4)
...
(declare-const temp___2057 Int)
(declare-const temp___2061 Int)
(declare-const temp___2059 (Array Int integer))
(declare-const o Int)
...
(declare-const temp___2062 Int)
(declare-const o9 Int)
(declare-const o10 integer)
(declare-const o11 Int)
(declare-const o12 Int)
(declare-const o13 Int)
(declare-const temp___2063 Int)
...
(assert (and (= (length source) 11) (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 56)) (forall ((index7 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 6) index7) (<= index7 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index7))) true))))))
...
(assert (= (mk___t2 temp___2046 temp___20461) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__aggregate_def 7 9 9 9 9 (+ (to_rep1 (first (rt source))) 6) (+ (+ (to_rep1 (first (rt source))) 6) 4))))
(assert (= (ite (<= (to_rep1 (first4 temp___20461)) (to_rep1 (last4 temp___20461))) (+ (- (to_rep1 (last4 temp___20461)) (to_rep1 (first4 temp___20461))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 6)) 1) 0)))
(assert (= (slide1 temp___2046 (to_rep1 (first4 temp___20461)) (+ (to_rep1 (first (rt source))) 6)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__assume))
...
(assert (= (mk___t4 temp___2054 temp___20541) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___20541)) (to_rep1 (last8 temp___20541))) (+ (- (to_rep1 (last8 temp___20541)) (to_rep1 (first8 temp___20541))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 6)) 1) 0)))
(assert (= (slide1 temp___2054 (to_rep1 (first8 temp___20541)) (+ (to_rep1 (first (rt source))) 6)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__assume))
...
(assert (and (= temp___2056 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (= temp___2057 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2056))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= temp___2061 index1)))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= temp___2059 n1)))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= o index1)))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= o3 index1)))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= o7 index1)))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= n1 result3)))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= n2 o8)))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 6) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 6) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (and (and (forall ((temp___2060 Int)) (=> (and (<= (to_rep1 n__first) temp___2060) (<= temp___2060 (to_rep1 n__last))) (=> (or (< temp___2057 temp___2060) (or (< temp___2060 temp___2056) (< index2 temp___2060))) (= (select n3 temp___2060) (select temp___2059 temp___2060))))) (=> (<= (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 6) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= index2 temp___2057)))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= index2 index3)))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= n3 n4)))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= index4 index2)))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= n5 n3)))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= index6 index4)))
(assert (=> (and (<= temp___2056 index1) (<= index1 temp___2057)) (= n7 n5)))
(assert (=> (not (and (<= temp___2056 index1) (<= index1 temp___2057))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2056 index1) (<= index1 temp___2057))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2056 index1) (<= index1 temp___2057))) (= index6 index1)))
(assert (=> (not (and (<= temp___2056 index1) (<= index1 temp___2057))) (= n7 n1)))
...
(assert (and (= temp___2062 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___2062) (<= temp___2062 (to_rep1 n__last))))
(assert (= o9 temp___2062))
...
(assert (= target1 o13))
(assert (<= (- 9) target1))
(assert (and (= temp___2063 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___2063) (<= temp___2063 (to_rep1 n__last))))
(assert (= o14 temp___2063))
...
(assert (= target2 o20))
(assert (<= (- 99) target2))
(assert (and (= temp___2064 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___2064) (<= temp___2064 (to_rep1 n__last))))
(assert (= o21 temp___2064))
...
(assert (= target3 o27))
(assert (<= (- 999) target3))
(assert (and (= temp___2065 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2065) (<= temp___2065 (to_rep1 n__last))))
(assert (= o28 temp___2065))
...
(assert (= target4 o34))
(assert (<= (- 9999) target4))
(assert (and (= temp___2066 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (not (<= temp___2066 (to_rep1 n__last))))
(check-sat)
(exit)
