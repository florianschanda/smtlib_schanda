...
(declare-const temp___319 (Array Int natural))
...
(assert (dynamic_predicate1 x9))
(assert (= temp___319 x9))
(assert (= o34 (select temp___319 3)))
(assert (= o35 (to_rep o34)))
(assert (dynamic_predicate1 x9))
(assert (= temp___317 x9))
(assert (= o32 (select temp___317 2)))
(assert (= o33 (to_rep o32)))
(assert (= o36 (div1 o33 o35)))
(assert (not (in_range o36)))
(check-sat)
(exit)
