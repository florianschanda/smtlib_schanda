...
(assert (= (rolepresent (mk___rep1 (us_split_fields__content1 theadmin__split_fields4))) 1))
(assert (not (= (isgood tokenpresence state1 tokentry tokenid (us_split_fields__content12 authcert__split_fields) (us_split_fields__content9 idcert__split_fields)) true)))
(check-sat)
(exit)
