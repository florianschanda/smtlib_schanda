...
(assert (= result3 (ite (<= (to_rep (first (rt x))) lo_index) o1 false)))
(assert (= result3 true))
(assert (<= (to_rep (first (rt x))) hi_index))
(assert (<= hi_index (to_rep (last (rt x)))))
(assert (= (extended_indexqtint o2) hi_index))
(assert (= (indexqtint o3) lo_index))
(assert (= o3 o4))
(assert (= o2 o5))
(assert (= o6 o4))
(assert (= o7 o5))
(assert (not (or (< (extended_indexqtint o7) (indexqtint o6)) (and (<= (to_rep (first (rt x))) (indexqtint o6)) (<= (extended_indexqtint o7) (to_rep (last (rt x))))))))
(check-sat)
(exit)
