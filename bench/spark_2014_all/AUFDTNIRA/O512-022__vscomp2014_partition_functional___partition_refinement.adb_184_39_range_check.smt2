...
(assert (<= 0 (- (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) 1)))
(assert (not (<= (- (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) 1) 5)))
(check-sat)
(exit)
