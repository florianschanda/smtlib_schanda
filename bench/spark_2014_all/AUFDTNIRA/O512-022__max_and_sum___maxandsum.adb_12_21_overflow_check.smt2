...
(assert (<= 1 i1))
(assert (<= i1 100))
(assert (<= sum2 (* (- i2 1) max2)))
(assert (and (and (and (=> (<= 0 2147483647) (in_range2 sum2)) (=> (<= 0 100) (in_range3 max2))) (=> (<= 1 100) (in_range5 i2))) (and (<= 1 i2) (<= i2 100))))
(assert (not (in_range1 (+ sum2 (to_rep (select a i2))))))
(check-sat)
(exit)
