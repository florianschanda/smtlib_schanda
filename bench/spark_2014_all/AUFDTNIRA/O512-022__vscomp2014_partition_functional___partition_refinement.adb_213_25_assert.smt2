...
(assert (forall ((k Int)) (=> (and (<= 0 k) (<= k 5)) (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields3 (get (model__ (mk___rep p__split_discrs (us_split_fields__content p__split_fields4))) (to_rep3 (select (map__content f8) k)))))) k) (<= k (to_rep2 (rec__partition_refinement__interval__last (us_split_fields3 (get (model__ (mk___rep p__split_discrs (us_split_fields__content p__split_fields4))) (to_rep3 (select (map__content f8) k)))))))))))
(declare-const k Int)
(assert (<= 0 k))
(assert (<= k (- (length (mk___rep p__split_discrs (us_split_fields__content p__split_fields4))) 1)))
(declare-const l Int)
(assert (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields3 (get (model__ (mk___rep p__split_discrs (us_split_fields__content p__split_fields4))) k)))) l))
(assert (<= l (to_rep2 (rec__partition_refinement__interval__last (us_split_fields3 (get (model__ (mk___rep p__split_discrs (us_split_fields__content p__split_fields4))) k))))))
(assert (not (= (to_rep3 (select (map__content f8) l)) k)))
(check-sat)
(exit)
