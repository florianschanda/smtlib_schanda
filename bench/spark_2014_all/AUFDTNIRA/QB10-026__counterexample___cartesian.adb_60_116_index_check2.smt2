...
(assert (forall ((i1 Int)) (=> (and (<= (to_rep (first2 (rt1 array1))) i1) (<= i1 index12)) (forall ((j1 Int)) (=> (and (<= (to_rep (first2 (rt1 array2))) j1) (<= j1 (to_rep (last2 (rt1 array2))))) (= (to_rep (select (select result__8 (+ (+ (* (- i1 (to_rep (first2 (rt1 array1)))) (length1 array2)) (- j1 (to_rep (first2 (rt1 array2))))) 1)) 1)) (to_rep (select (elts1 array1) i1))))))))
(assert (forall ((i1 Int)) (=> (and (<= (to_rep (first2 (rt1 array1))) i1) (<= i1 index12)) (forall ((j1 Int)) (=> (and (<= (to_rep (first2 (rt1 array2))) j1) (<= j1 (to_rep (last2 (rt1 array2))))) (= (to_rep (select (select result__8 (+ (+ (* (- i1 (to_rep (first2 (rt1 array1)))) (length1 array2)) (- j1 (to_rep (first2 (rt1 array2))))) 1)) 2)) (to_rep (select (elts1 array2) j1))))))))
...
(assert (not (<= (to_rep (first2 (rt1 array1))) i)))
(check-sat)
(exit)
