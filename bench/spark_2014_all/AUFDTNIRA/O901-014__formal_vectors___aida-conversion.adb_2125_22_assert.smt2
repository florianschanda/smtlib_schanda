...
(assert (forall ((temp___2426 Int) (temp___2427 Int) (temp___2428 Int) (temp___2429 Int) (temp___2430 Int) (temp___2431 Int) (temp___2432 Int)) (let ((temp___2425 (aida__conversion__calculate_negative_target_length_6__int_array__aggregate_def temp___2426 temp___2427 temp___2428 temp___2429 temp___2430 temp___2431 temp___2432))) (=> (and (and (and (and (dynamic_invariant temp___2426 true true true true) (dynamic_invariant temp___2427 true true true true)) (dynamic_invariant temp___2428 true true true true)) (dynamic_invariant temp___2429 true true true true)) (dynamic_invariant temp___2430 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 5) temp___2431 temp___2432) (and (= (first5 temp___2425) temp___2431) (= (last5 temp___2425) temp___2432))) (and (and (and (and (= (select (to_array2 temp___2425) (+ (+ (first1 source) 1) 0)) rliteral) (= (select (to_array2 temp___2425) (+ (+ (first1 source) 1) 1)) rliteral)) (= (select (to_array2 temp___2425) (+ (+ (first1 source) 1) 2)) rliteral)) (= (select (to_array2 temp___2425) (+ (+ (first1 source) 1) 3)) rliteral)) (= (select (to_array2 temp___2425) (+ (+ (first1 source) 1) 4)) rliteral)))))))
(define-fun dynamic_invariant4 ((temp___expr_854 us_t3) (temp___is_init_850 Bool) (temp___skip_constant_851 Bool) (temp___do_toplevel_852 Bool) (temp___do_typ_inv_853 Bool)) Bool (=> (not (= temp___skip_constant_851 true)) (and (dynamic_property6 (+ (first1 source) 1) (+ (first1 source) 5) (first7 temp___expr_854) (last7 temp___expr_854)) (and (= (first7 temp___expr_854) (+ (first1 source) 1)) (= (last7 temp___expr_854) (+ (first1 source) 5))))))
(declare-sort t6 0)
...
(assert (forall ((temp___2438 Int) (temp___2439 Int) (temp___2440 Int)) (let ((temp___2437 (aida__conversion__calculate_negative_target_length_6__n__aggregate_def temp___2438 temp___2439 temp___2440))) (=> (dynamic_invariant temp___2438 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 5) temp___2439 temp___2440) (and (= (first9 temp___2437) temp___2439) (= (last9 temp___2437) temp___2440))) (forall ((temp___2441 Int)) (= (select (to_array4 temp___2437) temp___2441) rliteral1)))))))
...
(declare-const temp___2435 (Array Int integer))
(declare-const temp___24351 t2)
...
(declare-const temp___2443 (Array Int integer))
(declare-const temp___24431 t4)
...
(declare-const temp___2445 Int)
(declare-const temp___2446 Int)
(declare-const temp___2450 Int)
(declare-const temp___2448 (Array Int integer))
(declare-const o Int)
...
(assert (and (= (length source) 6) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index7 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index7) (<= index7 (+ (to_rep1 (first (rt source))) 5))) (= (is_digit (to_rep (select (elts source) index7))) true))))))
...
(assert (= (mk___t2 temp___2435 temp___24351) (aida__conversion__calculate_negative_target_length_6__int_array__aggregate_def 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 4))))
(assert (= (ite (<= (to_rep1 (first4 temp___24351)) (to_rep1 (last4 temp___24351))) (+ (- (to_rep1 (last4 temp___24351)) (to_rep1 (first4 temp___24351))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5)) (+ (- (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2435 (to_rep1 (first4 temp___24351)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_6__int_array__assume))
...
(assert (= (mk___t4 temp___2443 temp___24431) (aida__conversion__calculate_negative_target_length_6__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5))))
(assert (= (ite (<= (to_rep1 (first8 temp___24431)) (to_rep1 (last8 temp___24431))) (+ (- (to_rep1 (last8 temp___24431)) (to_rep1 (first8 temp___24431))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5)) (+ (- (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2443 (to_rep1 (first8 temp___24431)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_6__n__assume))
...
(assert (and (= temp___2445 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2446 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2445))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= temp___2450 index1)))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= temp___2448 n1)))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= o index1)))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= o3 index1)))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= o7 index1)))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= n1 result3)))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= n2 o8)))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (and (and (forall ((temp___2449 Int)) (=> (and (<= (to_rep1 n__first) temp___2449) (<= temp___2449 (to_rep1 n__last))) (=> (or (< temp___2446 temp___2449) (or (< temp___2449 temp___2445) (< index2 temp___2449))) (= (select n3 temp___2449) (select temp___2448 temp___2449))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 5))))))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= index2 temp___2446)))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= index2 index3)))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= n3 n4)))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= index4 index2)))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= n5 n3)))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= index6 index4)))
(assert (=> (and (<= temp___2445 index1) (<= index1 temp___2446)) (= n7 n5)))
(assert (=> (not (and (<= temp___2445 index1) (<= index1 temp___2446))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2445 index1) (<= index1 temp___2446))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2445 index1) (<= index1 temp___2446))) (= index6 index1)))
(assert (=> (not (and (<= temp___2445 index1) (<= index1 temp___2446))) (= n7 n1)))
...
(assert (and (= temp___2451 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2451) (<= temp___2451 (to_rep1 n__last))))
(assert (= o9 temp___2451))
...
(assert (= target1 o13))
(assert (<= (- 9) target1))
(assert (and (= temp___2452 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2452) (<= temp___2452 (to_rep1 n__last))))
(assert (= o14 temp___2452))
...
(assert (= target2 o20))
(assert (<= (- 99) target2))
(assert (and (= temp___2453 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___2453) (<= temp___2453 (to_rep1 n__last))))
(assert (= o21 temp___2453))
...
(assert (= target3 o27))
(assert (<= (- 999) target3))
(assert (and (= temp___2454 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___2454) (<= temp___2454 (to_rep1 n__last))))
(assert (= o28 temp___2454))
...
(assert (= target4 o34))
(assert (<= (- 9999) target4))
(assert (and (= temp___2455 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___2455) (<= temp___2455 (to_rep1 n__last))))
(assert (= o35 temp___2455))
