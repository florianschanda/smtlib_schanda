...
(assert (and (and (and (and (not (= (enrolmentisinprogress (int__content status1)) true)) (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields2))) 0)) (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2))) true))) (or (or (= (int__content status1) 3) (= (int__content status1) 4)) (= (int__content status1) status))) (not (or (= (int__content status1) 6) (= (int__content status1) 7)))))
(assert (and (and (and (and (and (in_range28 (int__content status1)) (in_range27 (int__content tokentry1))) (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content2 logfilestate__split_fields7))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content2 logfilestate__split_fields7))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content2 logfilestate__split_fields7)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content2 logfilestate__split_fields7))) true)) (in_range26 (int__content tokenid1))) (in_range13 (int__content auditalarm1))) (in_range25 (int__content tokenpresence1))))
(assert (not (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields2))) 0)))
(check-sat)
(exit)
