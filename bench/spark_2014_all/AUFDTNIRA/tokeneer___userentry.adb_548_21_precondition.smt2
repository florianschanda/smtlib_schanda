...
(assert (forall ((configdata__state us_private)) (! (dynamic_invariant (thesystemmaxfar configdata__state) true false true true) :pattern ((thesystemmaxfar configdata__state)))))
...
(assert (forall ((x logentrycountt)) (! (in_range5 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x logfilecountt)) (! (in_range6 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x fileentrycountt)) (! (in_range7 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_565 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool) (temp___do_typ_inv_564 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 0 1)) (in_range9 temp___expr_565)))
...
(define-fun dynamic_invariant2 ((temp___expr_1226 us_rep1) (temp___is_init_1222 Bool) (temp___skip_constant_1223 Bool) (temp___do_toplevel_1224 Bool) (temp___do_typ_inv_1225 Bool)) Bool (=> (= temp___do_typ_inv_1225 true) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1226))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1226))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1226)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1226))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1230 us_rep1) (temp___skip_top_level_1231 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1230))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1230))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1230)) (mk___rep (mk___split_fields (temp_____aggregate_def_1232 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1230)) (temp_____aggregate_def_1236 0))))
(define-fun type_invariant ((temp___1240 us_rep1)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1240))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1240))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1240)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1240))) true))
...
(assert (forall ((x fart)) (! (in_range3 (to_rep7 x)) :pattern ((to_rep7 x)))))
(assert (forall ((x Int)) (! (=> (in_range3 x) (= (to_rep7 (of_rep7 x)) x)) :pattern ((to_rep7 (of_rep7 x))))))
...
(declare-fun user_eq16 (bytet bytet) Bool)
(declare-const dummy16 bytet)
...
(assert (forall ((x bytet)) (! (in_range10 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(declare-const dummy17 (Array Int bytet))
...
(declare-fun user_eq17 ((Array Int bytet) (Array Int bytet)) Bool)
...
(declare-fun user_eq18 (templatelengtht templatelengtht) Bool)
(declare-const dummy18 templatelengtht)
...
(assert (forall ((x templatelengtht)) (! (in_range11 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(declare-fun user_eq21 (matchresultt matchresultt) Bool)
(declare-const dummy21 matchresultt)
...
(define-fun dynamic_invariant3 ((temp___expr_500 Int) (temp___is_init_496 Bool) (temp___skip_constant_497 Bool) (temp___do_toplevel_498 Bool) (temp___do_typ_inv_499 Bool)) Bool (=> (or (= temp___is_init_496 true) (<= 0 1)) (in_range12 temp___expr_500)))
...
(define-fun to_rep10 ((x statscount)) Int (statscountqtint x))
(declare-fun of_rep10 (Int) statscount)
(assert (forall ((x statscount)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert (forall ((x statscount)) (! (in_range13 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(define-fun bool_eq11 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (= (to_rep10 (rec__stats__t__successentry (us_split_fields7 a))) (to_rep10 (rec__stats__t__successentry (us_split_fields7 b)))) (= (to_rep10 (rec__stats__t__failentry (us_split_fields7 a))) (to_rep10 (rec__stats__t__failentry (us_split_fields7 b))))) (= (to_rep10 (rec__stats__t__successbio (us_split_fields7 a))) (to_rep10 (rec__stats__t__successbio (us_split_fields7 b))))) (= (to_rep10 (rec__stats__t__failbio (us_split_fields7 a))) (to_rep10 (rec__stats__t__failbio (us_split_fields7 b))))) true false))
...
(define-fun t__ref___4__projection ((a t__ref1)) us_rep4 (t__content1 a))
...
(assert true)
(declare-fun getiandatemplate (us_private) us_rep3)
(declare-fun getiandatemplate__function_guard (us_rep3 us_private) Bool)
(assert true)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-sort statust1 0)
(define-fun in_range14 ((x Int)) Bool (and (<= 0 x) (<= x 7)))
(declare-fun attr__ATTRIBUTE_IMAGE14 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check14 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE14 (us_image) Int)
(declare-fun user_eq24 (statust1 statust1) Bool)
(declare-const dummy24 statust1)
...
(define-fun dynamic_invariant4 ((temp___expr_2551 Int) (temp___is_init_2547 Bool) (temp___skip_constant_2548 Bool) (temp___do_toplevel_2549 Bool) (temp___do_typ_inv_2550 Bool)) Bool (=> (or (= temp___is_init_2547 true) (<= 0 7)) (in_range14 temp___expr_2551)))
...
(define-fun dynamic_invariant8 ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_18)))
(define-fun dynamic_invariant9 ((temp___expr_1164 Int) (temp___is_init_1160 Bool) (temp___skip_constant_1161 Bool) (temp___do_toplevel_1162 Bool) (temp___do_typ_inv_1163 Bool)) Bool (=> (or (= temp___is_init_1160 true) (<= 0 17)) (in_range6 temp___expr_1164)))
(define-fun dynamic_invariant10 ((temp___expr_1171 Int) (temp___is_init_1167 Bool) (temp___skip_constant_1168 Bool) (temp___do_toplevel_1169 Bool) (temp___do_typ_inv_1170 Bool)) Bool (=> (or (= temp___is_init_1167 true) (<= 1 17)) (in_range4 temp___expr_1171)))
(define-fun dynamic_invariant11 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 0 2)) (in_range8 temp___expr_1297)))
(define-fun dynamic_invariant12 ((temp___expr_1178 Int) (temp___is_init_1174 Bool) (temp___skip_constant_1175 Bool) (temp___do_toplevel_1176 Bool) (temp___do_typ_inv_1177 Bool)) Bool (=> (or (= temp___is_init_1174 true) (<= 0 17408)) (in_range5 temp___expr_1178)))
(define-fun dynamic_invariant13 ((temp___expr_1209 Int) (temp___is_init_1205 Bool) (temp___skip_constant_1206 Bool) (temp___do_toplevel_1207 Bool) (temp___do_typ_inv_1208 Bool)) Bool (=> (or (= temp___is_init_1205 true) (<= 0 1024)) (in_range7 temp___expr_1209)))
(assert true)
...
(define-fun dynamic_invariant14 ((temp___expr_590 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool) (temp___do_typ_inv_589 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 1 150)) (in_range15 temp___expr_590)))
(define-fun dynamic_invariant15 ((temp___expr_215 Int) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool (=> (or (= temp___is_init_211 true) (<= 0 255)) (in_range10 temp___expr_215)))
(define-fun dynamic_invariant16 ((temp___expr_524 Int) (temp___is_init_520 Bool) (temp___skip_constant_521 Bool) (temp___do_toplevel_522 Bool) (temp___do_typ_inv_523 Bool)) Bool (=> (or (= temp___is_init_520 true) (<= 0 4294967295)) (in_range11 temp___expr_524)))
(define-fun dynamic_invariant17 ((temp___expr_1774 Int) (temp___is_init_1770 Bool) (temp___skip_constant_1771 Bool) (temp___do_toplevel_1772 Bool) (temp___do_typ_inv_1773 Bool)) Bool (=> (or (= temp___is_init_1770 true) (<= 0 2147483647)) (in_range13 temp___expr_1774)))
...
(declare-const temp___2686 templatelengtht)
(declare-const temp___26861 fart)
(declare-const temp___26862 (Array Int character))
(declare-const temp___26863 (Array Int bytet))
...
(declare-const thetemplate__split_fields4 us_split_fields4)
...
(assert (=> (<= 0 1) (in_range12 matchresult)))
...
(assert (= (mk___rep2 (mk___split_fields2 temp___2686 temp___26861 temp___26862 temp___26863)) (getiandatemplate state1)))
(assert (= result1 (mk___split_fields__ref2 (mk___split_fields2 thetemplate__split_fields thetemplate__split_fields1 thetemplate__split_fields2 thetemplate__split_fields3))))
(assert (= thetemplate__split_fields4 (mk___split_fields2 temp___2686 temp___26861 temp___26862 temp___26863)))
(assert (and (= o1 (thesystemmaxfar state)) (in_range3 o1)))
(assert (= result2 (mk_int__ref maxfar)))
(assert (= maxfar1 o1))
(assert (=> (< (to_rep7 (rec__iandatypes__templatet__requiredmaxfar thetemplate__split_fields4)) maxfar1) (= result3 (mk_int__ref maxfar1))))
(assert (=> (< (to_rep7 (rec__iandatypes__templatet__requiredmaxfar thetemplate__split_fields4)) maxfar1) (= maxfar2 (to_rep7 (rec__iandatypes__templatet__requiredmaxfar thetemplate__split_fields4)))))
(assert (=> (not (< (to_rep7 (rec__iandatypes__templatet__requiredmaxfar thetemplate__split_fields4)) maxfar1)) (= maxfar2 maxfar1)))
(assert (and (and (and (in_range12 matchresult1) (in_range3 achievedfar1)) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true)) (in_range9 auditalarm1)))
