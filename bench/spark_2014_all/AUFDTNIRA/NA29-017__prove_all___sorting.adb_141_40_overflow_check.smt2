...
(assert (= l1 1))
(assert (and (and (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 2147483647)) (=> (< (* j1 l2) length1) (= (sorted (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* j1 l2)) (ite (< l2 (- length1 (* j1 l2))) l2 (- length1 (* j1 l2)))) true)))) (= (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first length1) true)) (<= 1 l2)))
(assert (and (and (=> (<= 0 2147483647) (in_range2 i1)) (=> (<= 0 2147483647) (in_range2 l2))) (=> (<= 0 2147483647) (in_range2 k1))))
(assert (= i1 result1))
(assert (= i2 0))
(assert (and (and (and (and (and (<= i3 length1) (=> (< i3 length1) (= (mod2 i3 (* l2 2)) 0))) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 2147483647)) (=> (< (* (* j1 l2) 2) i3) (= (sorted (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* (* j1 l2) 2)) (ite (< (* l2 2) (- length1 (* (* j1 l2) 2))) (* l2 2) (- length1 (* (* j1 l2) 2)))) true))))) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 2147483647)) (=> (< (* j1 l2) (- length1 i3)) (= (sorted (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (+ (+ a_first i3) (* j1 l2)) (ite (< l2 (- (- length1 i3) (* j1 l2))) l2 (- (- length1 i3) (* j1 l2)))) true))))) (= (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first length1) true)) (<= 1 l2)))
(assert (and (=> (<= 0 2147483647) (in_range2 i3)) (=> (<= 0 2147483647) (in_range2 k2))))
(assert (= o11 (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
(assert (<= 0 j))
(assert (<= j 2147483647))
(assert (and (= o (- length1 i3)) (in_range1 (- length1 i3))))
(assert (and (= o1 (* j l2)) (in_range1 (* j l2))))
(assert (= result2 (ite (< o1 o) true false)))
(assert (= result2 true))
(assert (and (= o5 (* j l2)) (in_range1 (* j l2))))
(assert (and (= o6 (- length1 i3)) (in_range1 (- length1 i3))))
(assert (= o7 (- o6 o5)))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (= o9 (ite (< l2 o8) l2 o8)))
(assert (and (= o10 o9) (in_range2 o9)))
(assert (and (= o2 (* j l2)) (in_range1 (* j l2))))
(assert (and (= o3 (+ a_first i3)) (in_range1 (+ a_first i3))))
(assert (= o4 (+ o3 o2)))
