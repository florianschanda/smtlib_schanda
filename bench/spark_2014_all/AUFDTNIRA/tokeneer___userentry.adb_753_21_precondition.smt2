...
(assert (forall ((configdata__state us_private)) (! (dynamic_invariant (thetokenremovalduration configdata__state) true false true true) :pattern ((thetokenremovalduration configdata__state)))))
...
(define-fun dynamic_invariant3 ((temp___expr_1123 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool) (temp___do_typ_inv_1122 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 5)) (in_range14 temp___expr_1123)))
...
(define-fun dynamic_invariant4 ((temp___expr_2551 Int) (temp___is_init_2547 Bool) (temp___skip_constant_2548 Bool) (temp___do_toplevel_2549 Bool) (temp___do_typ_inv_2550 Bool)) Bool (=> (or (= temp___is_init_2547 true) (<= 0 7)) (in_range16 temp___expr_2551)))
...
(define-fun dynamic_invariant15 ((temp___expr_642 Int) (temp___is_init_638 Bool) (temp___skip_constant_639 Bool) (temp___do_toplevel_640 Bool) (temp___do_typ_inv_641 Bool)) Bool (=> (or (= temp___is_init_638 true) (<= 1901 2099)) (in_range3 temp___expr_642)))
(define-fun dynamic_invariant16 ((temp___expr_649 Int) (temp___is_init_645 Bool) (temp___skip_constant_646 Bool) (temp___do_toplevel_647 Bool) (temp___do_typ_inv_648 Bool)) Bool (=> (or (= temp___is_init_645 true) (<= 1 12)) (in_range4 temp___expr_649)))
(define-fun dynamic_invariant17 ((temp___expr_656 Int) (temp___is_init_652 Bool) (temp___skip_constant_653 Bool) (temp___do_toplevel_654 Bool) (temp___do_typ_inv_655 Bool)) Bool (=> (or (= temp___is_init_652 true) (<= 1 31)) (in_range5 temp___expr_656)))
(define-fun dynamic_invariant18 ((temp___expr_688 Int) (temp___is_init_684 Bool) (temp___skip_constant_685 Bool) (temp___do_toplevel_686 Bool) (temp___do_typ_inv_687 Bool)) Bool (=> (or (= temp___is_init_684 true) (<= 0 86399999)) (in_range6 temp___expr_688)))
...
(assert (and (= o1 (getclass state1)) (in_range14 o1)))
