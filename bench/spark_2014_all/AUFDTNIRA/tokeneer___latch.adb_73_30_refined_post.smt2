...
(define-fun bool_eq4 ((a (Array Int us_rep1)) (a__first Int) (a__last Int) (b (Array Int us_rep1)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq3 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true)))) true false))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep6 (select a temp___idx_175)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep7 (select a temp___idx_172)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_172)))))))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep10 (select a temp___idx_173)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__auditlog__logfilestatet__currentlogfile logfileindext) (rec__auditlog__logfilestatet__numberlogentries logentrycountt) (rec__auditlog__logfilestatet__usedlogfiles us_rep2) (rec__auditlog__logfilestatet__logfileentries (Array Int fileentrycountt))))))
...
(define-fun us_split_fields_UsedLogFiles__projection ((a us_split_fields4)) us_rep2 (rec__auditlog__logfilestatet__usedlogfiles a))
...
(define-fun bool_eq9 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 a))) (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 b)))) (= (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 a))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 b))))) (= (bool_eq7 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 b))) true)) (= (bool_eq8 (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 b)) 1 17) true)) true false))
...
(define-fun dynamic_invariant8 ((temp___expr_1160 Int) (temp___is_init_1156 Bool) (temp___skip_constant_1157 Bool) (temp___do_toplevel_1158 Bool) (temp___do_typ_inv_1159 Bool)) Bool (=> (or (= temp___is_init_1156 true) (<= 0 17)) (in_range11 temp___expr_1160)))
(define-fun dynamic_invariant9 ((temp___expr_1167 Int) (temp___is_init_1163 Bool) (temp___skip_constant_1164 Bool) (temp___do_toplevel_1165 Bool) (temp___do_typ_inv_1166 Bool)) Bool (=> (or (= temp___is_init_1163 true) (<= 1 17)) (in_range9 temp___expr_1167)))
(define-fun dynamic_invariant10 ((temp___expr_1293 Int) (temp___is_init_1289 Bool) (temp___skip_constant_1290 Bool) (temp___do_toplevel_1291 Bool) (temp___do_typ_inv_1292 Bool)) Bool (=> (or (= temp___is_init_1289 true) (<= 0 2)) (in_range8 temp___expr_1293)))
(define-fun dynamic_invariant11 ((temp___expr_1174 Int) (temp___is_init_1170 Bool) (temp___skip_constant_1171 Bool) (temp___do_toplevel_1172 Bool) (temp___do_typ_inv_1173 Bool)) Bool (=> (or (= temp___is_init_1170 true) (<= 0 17408)) (in_range10 temp___expr_1174)))
(define-fun dynamic_invariant12 ((temp___expr_1205 Int) (temp___is_init_1201 Bool) (temp___skip_constant_1202 Bool) (temp___do_toplevel_1203 Bool) (temp___do_typ_inv_1204 Bool)) Bool (=> (or (= temp___is_init_1201 true) (<= 0 1024)) (in_range12 temp___expr_1205)))
(assert true)
...
(assert (forall ((temp___1234 Int)) (=> (dynamic_invariant12 temp___1234 true true true true) (forall ((temp___1235 Int)) (= (select (temp_____aggregate_def_1232 temp___1234) temp___1235) rliteral2)))))
(define-fun dynamic_invariant13 ((temp___expr_424 Int) (temp___is_init_420 Bool) (temp___skip_constant_421 Bool) (temp___do_toplevel_422 Bool) (temp___do_typ_inv_423 Bool)) Bool (=> (or (= temp___is_init_420 true) (<= 1 150)) (in_range16 temp___expr_424)))
...
(define-fun dynamic_invariant14 ((temp___expr_476 Int) (temp___is_init_472 Bool) (temp___skip_constant_473 Bool) (temp___do_toplevel_474 Bool) (temp___do_typ_inv_475 Bool)) Bool (=> (or (= temp___is_init_472 true) (<= 1901 2099)) (in_range4 temp___expr_476)))
(define-fun dynamic_invariant15 ((temp___expr_483 Int) (temp___is_init_479 Bool) (temp___skip_constant_480 Bool) (temp___do_toplevel_481 Bool) (temp___do_typ_inv_482 Bool)) Bool (=> (or (= temp___is_init_479 true) (<= 1 12)) (in_range5 temp___expr_483)))
(define-fun dynamic_invariant16 ((temp___expr_490 Int) (temp___is_init_486 Bool) (temp___skip_constant_487 Bool) (temp___do_toplevel_488 Bool) (temp___do_typ_inv_489 Bool)) Bool (=> (or (= temp___is_init_486 true) (<= 1 31)) (in_range6 temp___expr_490)))
(define-fun dynamic_invariant17 ((temp___expr_522 Int) (temp___is_init_518 Bool) (temp___skip_constant_519 Bool) (temp___do_toplevel_520 Bool) (temp___do_typ_inv_521 Bool)) Bool (=> (or (= temp___is_init_518 true) (<= 0 86399999)) (in_range7 temp___expr_522)))
(assert true)
...
(assert (forall ((temp___1230 Int)) (=> (dynamic_invariant9 temp___1230 true true true true) (forall ((temp___1231 Int)) (= (select (temp_____aggregate_def_1228 temp___1230) temp___1231) rliteral)))))
...
(declare-const logfiles3 map__ref1)
(declare-const logfilesstatus3 map__ref2)
...
(assert (=> (<= 0 1) (in_range14 locallatch)))
...
(assert (and (= result (greaterthanorequal o4 (mk___rep (mk___split_fields latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)))) (= (= result true) (or (= (greaterthan o4 (mk___rep (mk___split_fields latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) true) (= (bool_eq2 o4 (mk___rep (mk___split_fields latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) true)))))
(assert (=> (= result true) (= result1 locallatch5)))
(assert (=> (= result true) (= locallatch1 0)))
(assert (=> (= result true) (= result2 id5)))
(assert (=> (= result true) (= id1 8)))
(assert (=> (not (= result true)) (= result3 locallatch5)))
(assert (=> (not (= result true)) (= locallatch2 1)))
(assert (=> (not (= result true)) (= result4 id5)))
(assert (=> (not (= result true)) (= id2 9)))
(assert (=> (not (= result true)) (= id1 id2)))
(assert (=> (not (= result true)) (= locallatch1 locallatch2)))
(assert (=> (not (= currentlatch locallatch1)) (and (in_range13 auditalarm2) (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields14)) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields14)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields14)) true))))
(assert (=> (not (not (= currentlatch locallatch1))) (= filestate2 filestate)))
(assert (=> (not (not (= currentlatch locallatch1))) (= state2 state)))
(assert (=> (not (not (= currentlatch locallatch1))) (= auditsystemfault2 auditsystemfault)))
(assert (=> (not (not (= currentlatch locallatch1))) (= auditalarm2 auditalarm)))
(assert (=> (not (not (= currentlatch locallatch1))) (= logfilestate__split_fields14 (mk___split_fields2 logfilestate__split_fields logfilestate__split_fields1 (mk___rep1 (mk___split_fields1 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))))
(assert (=> (not (not (= currentlatch locallatch1))) (= logfilesstatus2 logfilesstatus)))
(assert (=> (not (not (= currentlatch locallatch1))) (= logfiles2 logfiles)))
(assert (=> (not (not (= currentlatch locallatch1))) (= filestate2 filestate1)))
(assert (=> (not (not (= currentlatch locallatch1))) (= state2 state1)))
(assert (=> (not (not (= currentlatch locallatch1))) (= auditsystemfault2 auditsystemfault1)))
(assert (=> (not (not (= currentlatch locallatch1))) (= auditalarm2 auditalarm1)))
...
(assert (=> (not (not (= currentlatch locallatch1))) (= logfilesstatus2 logfilesstatus1)))
(assert (=> (not (not (= currentlatch locallatch1))) (= logfiles2 logfiles1)))
(assert (= result5 (mk_int__ref currentlatch)))
...
(assert (= locallatch3 (mk_int__ref locallatch1)))
...
(assert (= logfilesstatus3 (mk_map__ref2 logfilesstatus2)))
(assert (= logfiles3 (mk_map__ref1 logfiles2)))
...
(assert (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (mk___rep (mk___split_fields latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) true))
(assert (not (= (islocked (int__content currentlatch2)) true)))
(check-sat)
(exit)
