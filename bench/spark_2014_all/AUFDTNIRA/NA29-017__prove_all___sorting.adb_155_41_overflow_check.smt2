...
(assert (= b7 b5))
(assert (= a8 a6))
(assert (= o15 (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t (map__content a7) (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
(assert (<= 0 j))
(assert (<= j 2147483647))
...
(assert (= result3 true))
(assert (and (= o7 (* j l2)) (in_range1 (* j l2))))
(assert (= o8 (* o7 2)))
(assert (and (= o9 o8) (in_range1 o8)))
(assert (= o10 (- length1 o9)))
(assert (and (= o11 o10) (in_range1 o10)))
(assert (and (= o12 (* l2 2)) (in_range1 (* l2 2))))
(assert (= o13 (ite (< o12 o11) o12 o11)))
