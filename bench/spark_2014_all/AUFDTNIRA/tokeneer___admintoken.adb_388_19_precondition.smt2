...
(define-fun bool_eq5 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (bool_eq4 (rec__cert__contentst__id (us_split_fields7 a)) (rec__cert__contentst__id (us_split_fields7 b))) true) (= (bool_eq2 (rec__cert__contentst__notbefore (us_split_fields7 a)) (rec__cert__contentst__notbefore (us_split_fields7 b))) true)) (= (bool_eq2 (rec__cert__contentst__notafter (us_split_fields7 a)) (rec__cert__contentst__notafter (us_split_fields7 b))) true)) (= (to_rep9 (rec__cert__contentst__mechanism (us_split_fields7 a))) (to_rep9 (rec__cert__contentst__mechanism (us_split_fields7 b))))) true false))
...
(assert true)
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__cert__attr__contentst__id us_rep2) (rec__cert__attr__contentst__notbefore us_rep) (rec__cert__attr__contentst__notafter us_rep) (rec__cert__attr__contentst__mechanism algorithmt) (rec__cert__attr__contentst__basecertid us_rep2)))))
(define-fun us_split_fields_ID__4__projection ((a us_split_fields8)) us_rep2 (rec__cert__attr__contentst__id a))
(define-fun us_split_fields_NotBefore__2__projection ((a us_split_fields8)) us_rep (rec__cert__attr__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__2__projection ((a us_split_fields8)) us_rep (rec__cert__attr__contentst__notafter a))
...
(define-fun us_split_fields_BaseCertID__projection ((a us_split_fields8)) us_rep2 (rec__cert__attr__contentst__basecertid a))
...
(define-fun bool_eq6 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (and (= (bool_eq4 (rec__cert__attr__contentst__id (us_split_fields9 a)) (rec__cert__attr__contentst__id (us_split_fields9 b))) true) (= (bool_eq2 (rec__cert__attr__contentst__notbefore (us_split_fields9 a)) (rec__cert__attr__contentst__notbefore (us_split_fields9 b))) true)) (= (bool_eq2 (rec__cert__attr__contentst__notafter (us_split_fields9 a)) (rec__cert__attr__contentst__notafter (us_split_fields9 b))) true)) (= (to_rep9 (rec__cert__attr__contentst__mechanism (us_split_fields9 a))) (to_rep9 (rec__cert__attr__contentst__mechanism (us_split_fields9 b))))) (= (bool_eq4 (rec__cert__attr__contentst__basecertid (us_split_fields9 a)) (rec__cert__attr__contentst__basecertid (us_split_fields9 b))) true)) true false))
...
(declare-fun thebasecert (us_rep4) us_rep2)
(declare-fun thebasecert__function_guard (us_rep2 us_rep4) Bool)
(assert true)
...
(assert (forall ((x classt)) (! (in_range12 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(define-fun bool_eq7 ((a us_rep5) (b us_rep5)) Bool (ite (= (to_rep10 (rec__privtypes__clearancet__class (us_split_fields11 a))) (to_rep10 (rec__privtypes__clearancet__class (us_split_fields11 b)))) true false))
...
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__cert__attr__auth__contentst__id us_rep2) (rec__cert__attr__auth__contentst__notbefore us_rep) (rec__cert__attr__auth__contentst__notafter us_rep) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep2) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep5)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields12)) us_rep2 (rec__cert__attr__auth__contentst__id a))
...
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields12)) us_rep2 (rec__cert__attr__auth__contentst__basecertid a))
...
(define-fun us_rep___16__projection ((a us_rep6)) us_split_fields12 (us_split_fields13 a))
(define-fun bool_eq8 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (and (and (and (and (= (bool_eq4 (rec__cert__attr__auth__contentst__id (us_split_fields13 a)) (rec__cert__attr__auth__contentst__id (us_split_fields13 b))) true) (= (bool_eq2 (rec__cert__attr__auth__contentst__notbefore (us_split_fields13 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq2 (rec__cert__attr__auth__contentst__notafter (us_split_fields13 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep9 (rec__cert__attr__auth__contentst__mechanism (us_split_fields13 a))) (to_rep9 (rec__cert__attr__auth__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq4 (rec__cert__attr__auth__contentst__basecertid (us_split_fields13 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields13 b))) true)) (= (to_rep11 (rec__cert__attr__auth__contentst__role (us_split_fields13 a))) (to_rep11 (rec__cert__attr__auth__contentst__role (us_split_fields13 b))))) (= (bool_eq7 (rec__cert__attr__auth__contentst__clearance (us_split_fields13 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields13 b))) true)) true false))
...
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__keystore__optionalprivatekeyt__ispresent Bool) (rec__keystore__optionalprivatekeyt__owner us_rep1)))))
(define-fun us_split_fields_IsPresent__projection ((a us_split_fields14)) Bool (rec__keystore__optionalprivatekeyt__ispresent a))
(define-fun us_split_fields_Owner__projection ((a us_split_fields14)) us_rep1 (rec__keystore__optionalprivatekeyt__owner a))
...
(define-fun us_rep___13__projection ((a us_rep7)) us_split_fields14 (us_split_fields15 a))
(define-fun bool_eq9 ((a us_rep7) (b us_rep7)) Bool (ite (and (= (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields15 a)) (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields15 b))) (= (bool_eq3 (rec__keystore__optionalprivatekeyt__owner (us_split_fields15 a)) (rec__keystore__optionalprivatekeyt__owner (us_split_fields15 b))) true)) true false))
...
(declare-datatypes () ((optionalprivatekeyt__ref (mk_optionalprivatekeyt__ref (optionalprivatekeyt__content us_rep7)))))
(define-fun optionalprivatekeyt__ref___projection ((a optionalprivatekeyt__ref)) us_rep7 (optionalprivatekeyt__content a))
...
(assert (forall ((x filestatust)) (! (in_range14 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(define-fun to_rep13 ((x logfileindext)) Int (logfileindextqtint x))
(declare-fun of_rep13 (Int) logfileindext)
(assert (forall ((x logfileindext)) (! (= (of_rep13 (to_rep13 x)) x) :pattern ((to_rep13 x)))))
(assert (forall ((x logfileindext)) (! (in_range15 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun to_rep14 ((x logentrycountt)) Int (logentrycounttqtint x))
(declare-fun of_rep14 (Int) logentrycountt)
(assert (forall ((x logentrycountt)) (! (= (of_rep14 (to_rep14 x)) x) :pattern ((to_rep14 x)))))
(assert (forall ((x logentrycountt)) (! (in_range16 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(define-fun to_rep15 ((x logfilecountt)) Int (logfilecounttqtint x))
(declare-fun of_rep15 (Int) logfilecountt)
(assert (forall ((x logfilecountt)) (! (= (of_rep15 (to_rep15 x)) x) :pattern ((to_rep15 x)))))
(assert (forall ((x logfilecountt)) (! (in_range17 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(define-fun bool_eq11 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep13 (select a temp___idx_175)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_175))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq11 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep13 (select a temp___idx_175)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(declare-datatypes () ((us_split_fields16 (mk___split_fields8 (rec__auditlog__logfilelistt__list (Array Int logfileindext)) (rec__auditlog__logfilelistt__head logfileindext) (rec__auditlog__logfilelistt__lasti logfileindext) (rec__auditlog__logfilelistt__length logfilecountt)))))
(define-fun us_split_fields_List__projection ((a us_split_fields16)) (Array Int logfileindext) (rec__auditlog__logfilelistt__list a))
(define-fun us_split_fields_Head__projection ((a us_split_fields16)) logfileindext (rec__auditlog__logfilelistt__head a))
(define-fun us_split_fields_LastI__projection ((a us_split_fields16)) logfileindext (rec__auditlog__logfilelistt__lasti a))
(define-fun us_split_fields_Length__2__projection ((a us_split_fields16)) logfilecountt (rec__auditlog__logfilelistt__length a))
(declare-datatypes () ((us_split_fields__ref8 (mk___split_fields__ref8 (us_split_fields__content8 us_split_fields16)))))
(define-fun us_split_fields__ref___10__projection ((a us_split_fields__ref8)) us_split_fields16 (us_split_fields__content8 a))
(declare-datatypes () ((us_rep8 (mk___rep8 (us_split_fields17 us_split_fields16)))))
(define-fun us_rep___11__projection ((a us_rep8)) us_split_fields16 (us_split_fields17 a))
(define-fun bool_eq12 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (= (bool_eq11 (rec__auditlog__logfilelistt__list (us_split_fields17 a)) 1 17 (rec__auditlog__logfilelistt__list (us_split_fields17 b)) 1 17) true) (= (to_rep13 (rec__auditlog__logfilelistt__head (us_split_fields17 a))) (to_rep13 (rec__auditlog__logfilelistt__head (us_split_fields17 b))))) (= (to_rep13 (rec__auditlog__logfilelistt__lasti (us_split_fields17 a))) (to_rep13 (rec__auditlog__logfilelistt__lasti (us_split_fields17 b))))) (= (to_rep15 (rec__auditlog__logfilelistt__length (us_split_fields17 a))) (to_rep15 (rec__auditlog__logfilelistt__length (us_split_fields17 b))))) true false))
...
(declare-datatypes () ((logfilelistt__ref (mk_logfilelistt__ref (logfilelistt__content us_rep8)))))
(define-fun logfilelistt__ref___projection ((a logfilelistt__ref)) us_rep8 (logfilelistt__content a))
...
(define-fun to_rep16 ((x fileentrycountt)) Int (fileentrycounttqtint x))
(declare-fun of_rep16 (Int) fileentrycountt)
(assert (forall ((x fileentrycountt)) (! (= (of_rep16 (to_rep16 x)) x) :pattern ((to_rep16 x)))))
(assert (forall ((x fileentrycountt)) (! (in_range18 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(define-fun bool_eq13 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep16 (select a temp___idx_176)) (to_rep16 (select b (+ (- b__first a__first) temp___idx_176))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq13 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep16 (select a temp___idx_176)) (to_rep16 (select b (+ (- b__first a__first) temp___idx_176)))))))))))
...
(declare-datatypes () ((us_split_fields18 (mk___split_fields9 (rec__auditlog__logfilestatet__currentlogfile logfileindext) (rec__auditlog__logfilestatet__numberlogentries logentrycountt) (rec__auditlog__logfilestatet__usedlogfiles us_rep8) (rec__auditlog__logfilestatet__logfileentries (Array Int fileentrycountt))))))
(define-fun us_split_fields_CurrentLogFile__projection ((a us_split_fields18)) logfileindext (rec__auditlog__logfilestatet__currentlogfile a))
(define-fun us_split_fields_NumberLogEntries__projection ((a us_split_fields18)) logentrycountt (rec__auditlog__logfilestatet__numberlogentries a))
(define-fun us_split_fields_UsedLogFiles__projection ((a us_split_fields18)) us_rep8 (rec__auditlog__logfilestatet__usedlogfiles a))
(define-fun us_split_fields_LogFileEntries__projection ((a us_split_fields18)) (Array Int fileentrycountt) (rec__auditlog__logfilestatet__logfileentries a))
...
(define-fun us_rep___12__projection ((a us_rep9)) us_split_fields18 (us_split_fields19 a))
(define-fun bool_eq14 ((a us_rep9) (b us_rep9)) Bool (ite (and (and (and (= (to_rep13 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields19 a))) (to_rep13 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields19 b)))) (= (to_rep14 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields19 a))) (to_rep14 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields19 b))))) (= (bool_eq12 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields19 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields19 b))) true)) (= (bool_eq13 (rec__auditlog__logfilestatet__logfileentries (us_split_fields19 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields19 b)) 1 17) true)) true false))
...
(declare-datatypes () ((logfilestatet__ref (mk_logfilestatet__ref (logfilestatet__content us_rep9)))))
(define-fun logfilestatet__ref___projection ((a logfilestatet__ref)) us_rep9 (logfilestatet__content a))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-sort us_main_type 0)
(declare-fun us_main_eq (us_main_type us_main_type) Bool)
(declare-sort us_rep10 0)
(declare-fun bool_eq15 (us_rep10 us_rep10) Bool)
...
(declare-datatypes () ((t__ref (mk_t__ref (t__content us_rep10)))))
(define-fun t__ref___projection ((a t__ref)) us_rep10 (t__content a))
(declare-datatypes () ((map__ref4 (mk_map__ref4 (map__content4 (Array Int us_rep10))))))
(declare-fun slide4 ((Array Int us_rep10) Int Int) (Array Int us_rep10))
(assert (forall ((a (Array Int us_rep10))) (forall ((first2 Int)) (! (= (slide4 a first2 first2) a) :pattern ((slide4 a first2 first2))))))
(assert (forall ((a (Array Int us_rep10))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide4 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide4 a old_first new_first) i))))))))
(define-fun bool_eq16 ((a (Array Int us_rep10)) (a__first Int) (a__last Int) (b (Array Int us_rep10)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_177 Int)) (=> (and (<= a__first temp___idx_177) (<= temp___idx_177 a__last)) (= (bool_eq15 (select a temp___idx_177) (select b (+ (- b__first a__first) temp___idx_177))) true)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_593 Int) (temp___is_init_589 Bool) (temp___skip_constant_590 Bool) (temp___do_toplevel_591 Bool) (temp___do_typ_inv_592 Bool)) Bool (=> (or (= temp___is_init_589 true) (<= 0 1)) (in_range19 temp___expr_593)))
(declare-fun valid_numberlogentries (Int Int us_rep8 (Array Int fileentrycountt)) Bool)
(declare-fun valid_numberlogentries__function_guard (Bool Int Int us_rep8 (Array Int fileentrycountt)) Bool)
...
(define-fun dynamic_invariant1 ((temp___expr_1330 us_rep9) (temp___is_init_1326 Bool) (temp___skip_constant_1327 Bool) (temp___do_toplevel_1328 Bool) (temp___do_typ_inv_1329 Bool)) Bool (=> (= temp___do_typ_inv_1329 true) (= (valid_numberlogentries (to_rep13 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields19 temp___expr_1330))) (to_rep14 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields19 temp___expr_1330))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields19 temp___expr_1330)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields19 temp___expr_1330))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1334 us_rep9) (temp___skip_top_level_1335 Bool)) Bool (and (and (and (= (to_rep13 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields19 temp___expr_1334))) 1) (= (to_rep14 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields19 temp___expr_1334))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields19 temp___expr_1334)) (mk___rep8 (mk___split_fields8 (temp_____aggregate_def_1336 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields19 temp___expr_1334)) (temp_____aggregate_def_1340 0))))
(define-fun type_invariant ((temp___1344 us_rep9)) Bool (= (valid_numberlogentries (to_rep13 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields19 temp___1344))) (to_rep14 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields19 temp___1344))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields19 temp___1344)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields19 temp___1344))) true))
...
(declare-fun user_eq34 (keyidt keyidt) Bool)
(declare-const dummy34 keyidt)
...
(assert (forall ((x keyidt)) (! (in_range20 (to_rep17 x)) :pattern ((to_rep17 x)))))
...
(define-fun in_range21 ((x Int)) Bool (and (<= 0 x) (<= x 128)))
...
(declare-fun user_eq35 (keylengtht keylengtht) Bool)
(declare-const dummy35 keylengtht)
...
(assert (forall ((x keylengtht)) (! (in_range21 (to_rep18 x)) :pattern ((to_rep18 x)))))
...
(define-fun us_split_fields__ref___2__projection ((a us_split_fields__ref10)) us_split_fields20 (us_split_fields__content10 a))
(declare-datatypes () ((us_rep11 (mk___rep10 (us_split_fields21 us_split_fields20)))))
(define-fun us_rep___2__projection ((a us_rep11)) us_split_fields20 (us_split_fields21 a))
(define-fun bool_eq17 ((a us_rep11) (b us_rep11)) Bool (ite (and (and (= (to_rep9 (rec__cryptotypes__keypartt__algorithmid (us_split_fields21 a))) (to_rep9 (rec__cryptotypes__keypartt__algorithmid (us_split_fields21 b)))) (= (to_rep17 (rec__cryptotypes__keypartt__keyid (us_split_fields21 a))) (to_rep17 (rec__cryptotypes__keypartt__keyid (us_split_fields21 b))))) (= (to_rep18 (rec__cryptotypes__keypartt__keylength (us_split_fields21 a))) (to_rep18 (rec__cryptotypes__keypartt__keylength (us_split_fields21 b))))) true false))
...
(declare-datatypes () ((us_split_fields22 (mk___split_fields11 (rec__cert__id__contentst__id us_rep2) (rec__cert__id__contentst__notbefore us_rep) (rec__cert__id__contentst__notafter us_rep) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep1) (rec__cert__id__contentst__subjectpublickey us_rep11)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields22)) us_rep2 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields22)) us_rep (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields22)) us_rep (rec__cert__id__contentst__notafter a))
(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields22)) algorithmt (rec__cert__id__contentst__mechanism a))
(define-fun us_split_fields_Subject__projection ((a us_split_fields22)) us_rep1 (rec__cert__id__contentst__subject a))
...
(define-fun us_split_fields__ref___16__projection ((a us_split_fields__ref11)) us_split_fields22 (us_split_fields__content11 a))
(declare-datatypes () ((us_rep12 (mk___rep11 (us_split_fields23 us_split_fields22)))))
(define-fun us_rep___17__projection ((a us_rep12)) us_split_fields22 (us_split_fields23 a))
(define-fun bool_eq18 ((a us_rep12) (b us_rep12)) Bool (ite (and (and (and (and (and (= (bool_eq4 (rec__cert__id__contentst__id (us_split_fields23 a)) (rec__cert__id__contentst__id (us_split_fields23 b))) true) (= (bool_eq2 (rec__cert__id__contentst__notbefore (us_split_fields23 a)) (rec__cert__id__contentst__notbefore (us_split_fields23 b))) true)) (= (bool_eq2 (rec__cert__id__contentst__notafter (us_split_fields23 a)) (rec__cert__id__contentst__notafter (us_split_fields23 b))) true)) (= (to_rep9 (rec__cert__id__contentst__mechanism (us_split_fields23 a))) (to_rep9 (rec__cert__id__contentst__mechanism (us_split_fields23 b))))) (= (bool_eq3 (rec__cert__id__contentst__subject (us_split_fields23 a)) (rec__cert__id__contentst__subject (us_split_fields23 b))) true)) (= (bool_eq17 (rec__cert__id__contentst__subjectpublickey (us_split_fields23 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields23 b))) true)) true false))
...
(define-fun contentst__ref___4__projection ((a contentst__ref3)) us_rep12 (contentst__content3 a))
(declare-fun cert_id_to_cert (us_rep12) us_rep3)
(declare-fun cert_id_to_cert__function_guard (us_rep3 us_rep12) Bool)
(assert true)
...
(define-fun in_range22 ((x Int)) Bool (and (<= 1 x) (<= x 150)))
...
(declare-fun user_eq38 (descriptioni descriptioni) Bool)
(declare-const dummy38 descriptioni)
...
(declare-fun temp___String_Literal_2137 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2137 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 27)) 78)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 28)) 111)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 29)) 116)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 31)) 67)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 32)) 117)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 33)) 114)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 34)) 114)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 35)) 101)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 36)) 110)) (= (to_rep (select (temp___String_Literal_2137 us_void_param) 37)) 116)) :pattern ((temp___String_Literal_2137 us_void_param)))))
(declare-fun temp___String_Literal_2138 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2138 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 27)) 78)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 28)) 111)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 29)) 116)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 31)) 86)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 32)) 101)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 33)) 114)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 34)) 105)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 35)) 102)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 36)) 105)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 37)) 97)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 38)) 98)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 39)) 108)) (= (to_rep (select (temp___String_Literal_2138 us_void_param) 40)) 101)) :pattern ((temp___String_Literal_2138 us_void_param)))))
(declare-fun temp___String_Literal_2139 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2139 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 27)) 66)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 28)) 97)) (= (to_rep (select (temp___String_Literal_2139 us_void_param) 29)) 100)) :pattern ((temp___String_Literal_2139 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 40)) (in_range8 temp___expr_402)))
(define-fun dynamic_invariant7 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 4294967295)) (in_range9 temp___expr_426)))
(define-fun dynamic_invariant8 ((temp___expr_450 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool) (temp___do_typ_inv_449 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 0 10)) (in_range11 temp___expr_450)))
(define-fun dynamic_invariant9 ((temp___expr_464 Int) (temp___is_init_460 Bool) (temp___skip_constant_461 Bool) (temp___do_toplevel_462 Bool) (temp___do_typ_inv_463 Bool)) Bool (=> (or (= temp___is_init_460 true) (<= 0 4294967295)) (in_range20 temp___expr_464)))
(define-fun dynamic_invariant10 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 0 128)) (in_range21 temp___expr_471)))
(define-fun dynamic_invariant11 ((temp___expr_1268 Int) (temp___is_init_1264 Bool) (temp___skip_constant_1265 Bool) (temp___do_toplevel_1266 Bool) (temp___do_typ_inv_1267 Bool)) Bool (=> (or (= temp___is_init_1264 true) (<= 0 17)) (in_range17 temp___expr_1268)))
(define-fun dynamic_invariant12 ((temp___expr_1275 Int) (temp___is_init_1271 Bool) (temp___skip_constant_1272 Bool) (temp___do_toplevel_1273 Bool) (temp___do_typ_inv_1274 Bool)) Bool (=> (or (= temp___is_init_1271 true) (<= 1 17)) (in_range15 temp___expr_1275)))
(define-fun dynamic_invariant13 ((temp___expr_1401 Int) (temp___is_init_1397 Bool) (temp___skip_constant_1398 Bool) (temp___do_toplevel_1399 Bool) (temp___do_typ_inv_1400 Bool)) Bool (=> (or (= temp___is_init_1397 true) (<= 0 2)) (in_range14 temp___expr_1401)))
(define-fun dynamic_invariant14 ((temp___expr_1282 Int) (temp___is_init_1278 Bool) (temp___skip_constant_1279 Bool) (temp___do_toplevel_1280 Bool) (temp___do_typ_inv_1281 Bool)) Bool (=> (or (= temp___is_init_1278 true) (<= 0 17408)) (in_range16 temp___expr_1282)))
(define-fun dynamic_invariant15 ((temp___expr_1313 Int) (temp___is_init_1309 Bool) (temp___skip_constant_1310 Bool) (temp___do_toplevel_1311 Bool) (temp___do_typ_inv_1312 Bool)) Bool (=> (or (= temp___is_init_1309 true) (<= 0 1024)) (in_range18 temp___expr_1313)))
(assert true)
(assert (forall ((currentlogfile Int) (numberlogentries Int)) (forall ((usedlogfiles us_rep8)) (forall ((logfileentries (Array Int fileentrycountt))) (! (= (= (valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries) true) (and (<= 1 (to_rep15 (rec__auditlog__logfilelistt__length (us_split_fields17 usedlogfiles)))) (= numberlogentries (+ (* (- (to_rep15 (rec__auditlog__logfilelistt__length (us_split_fields17 usedlogfiles))) 1) 1024) (to_rep16 (select logfileentries currentlogfile)))))) :pattern ((valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries)))))))
(declare-const rliteral2 fileentrycountt)
(assert (= (fileentrycounttqtint rliteral2) 0))
(assert (forall ((temp___1342 Int)) (=> (dynamic_invariant15 temp___1342 true true true true) (forall ((temp___1343 Int)) (= (select (temp_____aggregate_def_1340 temp___1342) temp___1343) rliteral2)))))
(define-fun dynamic_invariant16 ((temp___expr_618 Int) (temp___is_init_614 Bool) (temp___skip_constant_615 Bool) (temp___do_toplevel_616 Bool) (temp___do_typ_inv_617 Bool)) Bool (=> (or (= temp___is_init_614 true) (<= 1 150)) (in_range22 temp___expr_618)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (forall ((temp___162 Int)) (=> (dynamic_invariant4 temp___162 true true true true) (forall ((temp___163 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___162) temp___163)) temp___162)))))
(define-fun dynamic_invariant17 ((temp___expr_670 Int) (temp___is_init_666 Bool) (temp___skip_constant_667 Bool) (temp___do_toplevel_668 Bool) (temp___do_typ_inv_669 Bool)) Bool (=> (or (= temp___is_init_666 true) (<= 1901 2099)) (in_range4 temp___expr_670)))
(define-fun dynamic_invariant18 ((temp___expr_677 Int) (temp___is_init_673 Bool) (temp___skip_constant_674 Bool) (temp___do_toplevel_675 Bool) (temp___do_typ_inv_676 Bool)) Bool (=> (or (= temp___is_init_673 true) (<= 1 12)) (in_range5 temp___expr_677)))
(define-fun dynamic_invariant19 ((temp___expr_684 Int) (temp___is_init_680 Bool) (temp___skip_constant_681 Bool) (temp___do_toplevel_682 Bool) (temp___do_typ_inv_683 Bool)) Bool (=> (or (= temp___is_init_680 true) (<= 1 31)) (in_range6 temp___expr_684)))
(define-fun dynamic_invariant20 ((temp___expr_716 Int) (temp___is_init_712 Bool) (temp___skip_constant_713 Bool) (temp___do_toplevel_714 Bool) (temp___do_typ_inv_715 Bool)) Bool (=> (or (= temp___is_init_712 true) (<= 0 86399999)) (in_range7 temp___expr_716)))
(define-fun dynamic_invariant21 ((temp___expr_1213 Int) (temp___is_init_1209 Bool) (temp___skip_constant_1210 Bool) (temp___do_toplevel_1211 Bool) (temp___do_typ_inv_1212 Bool)) Bool (=> (or (= temp___is_init_1209 true) (<= 0 3)) (in_range13 temp___expr_1213)))
(define-fun dynamic_invariant22 ((temp___expr_1227 Int) (temp___is_init_1223 Bool) (temp___skip_constant_1224 Bool) (temp___do_toplevel_1225 Bool) (temp___do_typ_inv_1226 Bool)) Bool (=> (or (= temp___is_init_1223 true) (<= 0 5)) (in_range12 temp___expr_1227)))
(define-fun dynamic_invariant23 ((temp___expr_553 Int) (temp___is_init_549 Bool) (temp___skip_constant_550 Bool) (temp___do_toplevel_551 Bool) (temp___do_typ_inv_552 Bool)) Bool (=> (or (= temp___is_init_549 true) (<= 0 4294967295)) (in_range10 temp___expr_553)))
(assert (forall ((temp___1338 Int)) (=> (dynamic_invariant12 temp___1338 true true true true) (forall ((temp___1339 Int)) (= (select (temp_____aggregate_def_1336 temp___1338) temp___1339) rliteral)))))
...
(declare-const logfiles (Array Int us_rep10))
...
(declare-const idcertcontents__split_fields us_split_fields__ref11)
(declare-const extractok Bool)
(declare-const verified Bool)
(declare-const current Bool)
(declare-const baseidmatches bool__ref)
...
(declare-const logfiles1 (Array Int us_rep10))
(declare-const logfilesstatus1 (Array Int filestatust))
(declare-const logfilestate__split_fields7 us_split_fields18)
...
(declare-const logfiles2 (Array Int us_rep10))
(declare-const logfilesstatus2 (Array Int filestatust))
(declare-const logfilestate__split_fields8 us_split_fields18)
...
(assert (= (valid_numberlogentries (to_rep13 logfilestate__split_fields) (to_rep14 logfilestate__split_fields1) (mk___rep8 (mk___split_fields8 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6) true))
(assert (in_range19 auditalarm))
...
(assert (= result3 baseidmatches))
(assert (= (let ((subject baseidmatches)) baseidmatches1) (distinct 0 0)))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (= o (cert_id_to_cert (mk___rep11 (us_split_fields__content11 idcertcontents__split_fields)))))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o3 (theid o)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o4 (bool_eq4 o3 o2)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= result4 (let ((subject baseidmatches)) (mk_bool__ref baseidmatches1))))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= (let ((subject baseidmatches)) baseidmatches2) o4))))
(assert (=> (= certfound true) (=> (= extractok2 true) (and (= (valid_numberlogentries (to_rep13 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep14 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range19 auditalarm2)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o5 (cert_attr_auth_to_cert (mk___rep6 (let ((subject authcertcontents__split_fields)) authcertcontents__split_fields2)))))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o6 (iscurrent o5 (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) (us_private__content currenttime))))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= result5 (mk_bool__ref current1)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= current2 o6))))
...
(assert (=> (= certfound true) (=> (not (= extractok2 true)) (= (let ((subject baseidmatches)) (mk_bool__ref baseidmatches2)) (let ((subject baseidmatches)) (mk_bool__ref baseidmatches1))))))
...
(assert (=> (= certfound true) (=> (not (= extractok2 true)) (= logfilestate__split_fields8 (mk___split_fields9 logfilestate__split_fields logfilestate__split_fields1 (mk___rep8 (mk___split_fields8 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6)))))
...
(assert (=> (not (= certfound true)) (= (let ((subject baseidmatches)) (mk_bool__ref baseidmatches2)) (let ((subject baseidmatches)) (mk_bool__ref baseidmatches1)))))
...
(assert (=> (not (= certfound true)) (= logfilestate__split_fields8 (mk___split_fields9 logfilestate__split_fields logfilestate__split_fields1 (mk___rep8 (mk___split_fields8 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))))
...
(assert (= authvalid1 (ite (= (ite (= (ite (= (ite (= certfound true) extractok2 false) true) (let ((subject baseidmatches)) baseidmatches2) false) true) verified2 false) true) current2 false)))
(assert (= (bool_eq description 1 150 nodescription 1 150) true))
(assert (not (not (= certfound true))))
(assert (not (not (= extractok2 true))))
(assert (not (not (= (let ((subject baseidmatches)) baseidmatches2) true))))
