...
(declare-const o5 us_rep10)
(declare-const o6 us_split_fields10)
(declare-const o7 index)
(declare-const o8 Int)
(declare-const o9 Int)
(declare-const o10 us_rep10)
(declare-const o11 us_split_fields10)
...
(assert (and (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 5)) (= (to_rep (select a1 k1)) (ite (= k1 (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o)) (to_rep (select a (+ (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))) (to_rep3 (rec__partition_refinement__interval__count (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o)))))))))) (ite (= k1 (+ (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))) (to_rep3 (rec__partition_refinement__interval__count (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))))) (to_rep (select a (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))) (to_rep (select a k1))))))) (and (= (capacity (mk___rep4 p__split_discrs p__split_fields1)) (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (= (length1 (mk___rep4 p__split_discrs p__split_fields1)) (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields1)) (to_rep (select a1 j1))) true))) (and (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields1)) c) true) (= (to_rep (select a1 (element1 (mk___rep3 d__split_discrs d__split_fields1) c))) (key (mk___rep3 d__split_discrs d__split_fields1) c)))) (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c) true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields1)) c) true)))))))))
...
(assert (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 (- (length1 (mk___rep4 p__split_discrs p__split_fields2)) 1))) (forall ((k1 Int)) (=> (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields2)) j1)))) k1) (<= k1 (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields2)) j1)))))) (= (to_rep5 (select f k1)) j1))))))
(assert (and (= o1 (length1 (mk___rep4 p__split_discrs p__split_fields2))) (and (in_range6 o1) (<= o1 (capacity (mk___rep4 p__split_discrs p__split_fields2))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= j o2) true false)))
(assert (= result2 (ite (<= 0 j) o3 false)))
(assert (= result2 true))
(assert (and (= o9 j) (in_range11 j)))
(assert (and (= o10 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields2)) o9)) (= (bool_eq9 o10 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields2)) o9)) true)))
(assert (= o11 (us_split_fields11 o10)))
(assert (= o12 (rec__partition_refinement__interval__last o11)))
(assert (= o13 (to_rep4 o12)))
(assert (= o14 (ite (<= k o13) true false)))
(assert (and (= o4 j) (in_range11 j)))
(assert (and (= o5 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields2)) o4)) (= (bool_eq9 o5 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields2)) o4)) true)))
(assert (= o6 (us_split_fields11 o5)))
(assert (= o7 (rec__partition_refinement__interval__first o6)))
(assert (= o8 (to_rep4 o7)))
(assert (= o15 (ite (<= o8 k) true false)))
