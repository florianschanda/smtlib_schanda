...
(assert (<= (indexqtint (rec__sums__slice_bounds__lo result____split_fields2)) (extended_indexqtint (rec__sums__slice_bounds__hi result____split_fields2))))
(assert (not (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo result____split_fields2)))))
(check-sat)
(exit)
