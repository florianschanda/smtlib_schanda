...
(assert (=> (= result true) (and (= o29 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o29))))
(assert (=> (= result true) (= o30 (ite (= o29 3) true false))))
(assert (=> (= result true) (and (= o31 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o31 true) (in_range3 (to_rep1 theadmin__split_fields1))))))
...
(assert (and (= o16 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o16 true) (in_range4 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result2 (ite (not (= o16 true)) true false)))
(assert (=> (= result2 true) (and (= o17 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o17 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2))))))))
(assert (=> (= result2 true) (= o18 (ite (not (= o17 true)) true false))))
(assert (=> (not (= result2 true)) (= o18 (distinct 1 0))))
(assert (and (= o10 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields2)))) (and (in_range1 o10) (= o10 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result3 (ite (= o10 1) true false)))
(assert (=> (= result3 true) (and (= o12 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o12 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2))))))))
...
(assert (=> (= result3 true) (=> (= result4 true) (and (= o11 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range3 o11)))))
...
(assert (and (= result6 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= result6 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2)))))))
(assert (=> (= result6 true) (and (= o7 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range3 o7))))
(assert (=> (= result6 true) (= result5 (ite (= o7 3) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (=> (= result5 true) (and (= o8 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields2)))) (and (in_range1 o8) (= o8 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields2))))))))
...
(assert (and (= result8 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= result8 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result8 true))
