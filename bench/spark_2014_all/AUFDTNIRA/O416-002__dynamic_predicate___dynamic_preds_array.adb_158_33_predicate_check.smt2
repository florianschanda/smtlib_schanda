...
(assert (forall ((x (Array Int even))) (! (=> (dynamic_invariant x true true true true) (dynamic_invariant (get_even_close_pair__2 x) true false true true)) :pattern ((get_even_close_pair__2 x)))))
...
(assert (dynamic_predicate x))
(assert (= o x))
(assert (and (= o1 (get_even_close_pair__2 o)) (dynamic_invariant o1 true false true true)))
(assert (= result x))
(assert (= x1 o1))
(assert (not (dynamic_predicate x1)))
(check-sat)
(exit)
