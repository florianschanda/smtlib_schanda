...
(declare-const temp___2221 ar_index)
(declare-const temp___2222 length_type)
...
(declare-const temp___2241 ar_index)
(declare-const temp___2242 length_type)
...
(assert (= temp___222 r__split_fields3))
(assert (= temp___2221 r__split_fields4))
(assert (= temp___2222 r__split_fields5))
...
(assert (= temp___2242 o9))
(assert (= result3 r__split_fields3))
(assert (= result4 r__split_fields4))
(assert (= result5 r__split_fields5))
(assert (= temp___224 r__split_fields6))
(assert (= temp___2241 r__split_fields7))
(assert (= temp___2242 r__split_fields8))
