...
(assert (and (= temp___323 (+ (to_rep (select result__2 1)) 4)) (in_range (+ (to_rep (select result__2 1)) 4))))
(assert (= (mod2 temp___323 2) 0))
(assert (= o7 temp___323))
(assert (= (to_rep o8) o7))
(assert (= o9 (store result__2 2 o8)))
(assert (= result3 result__2))
(assert (= result__4 o9))
(assert (not (dynamic_predicate result__4)))
(check-sat)
(exit)
