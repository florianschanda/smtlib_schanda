...
(declare-const dummy4 signal_type)
(declare-fun attr__ATTRIBUTE_IMAGE3 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Int)
(declare-fun to_fixed (signal_type) Int)
(declare-fun of_fixed (Int) signal_type)
(declare-fun user_eq4 (signal_type signal_type) Bool)
...
(assert (forall ((x signal_type)) (! (= (of_fixed (to_fixed x)) x) :pattern ((to_fixed x)))))
(assert (forall ((x signal_type)) (in_range3 (to_fixed x))))
...
(declare-fun add_signals (signal_type signal_type) signal_type)
(declare-fun add_signals__function_guard (signal_type signal_type signal_type) Bool)
(assert true)
(declare-const a signal_type)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const b signal_type)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const c signal_type)
...
(assert (= a (of_fixed 400)))
(assert (= b (of_fixed (- 800))))
(assert (= c (add_signals a b)))
(assert (not (< 0 (+ (to_fixed a) (to_fixed b)))))
(check-sat)
(exit)
