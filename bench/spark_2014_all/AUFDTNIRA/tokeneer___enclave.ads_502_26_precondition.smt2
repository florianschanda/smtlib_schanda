...
(assert (=> (= result true) (and (= o16 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o16))))
(assert (=> (= result true) (= o17 (ite (= o16 3) true false))))
(assert (=> (= result true) (and (= o18 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o18 true) (in_range3 (to_rep1 theadmin__split_fields1))))))
...
(assert (and (= o3 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o3 true) (in_range4 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result2 (ite (not (= o3 true)) true false)))
(assert (=> (= result2 true) (and (= o4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o4 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2))))))))
...
(assert (= result3 true))
(assert (and (= o1 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o1 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2)))))))
(assert (= o2 (ite (not (= o1 true)) true false)))
(assert (and (= result4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= result4 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result4 true))
