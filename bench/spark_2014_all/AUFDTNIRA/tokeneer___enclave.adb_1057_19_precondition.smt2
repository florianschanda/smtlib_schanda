...
(assert (=> (= result1 true) (and (= o6 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range6 o6))))
(assert (=> (= result1 true) (= o7 (ite (= o6 3) true false))))
(assert (=> (= result1 true) (and (= o8 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o8 true) (in_range6 (to_rep3 theadmin__split_fields1))))))
(assert (=> (= result1 true) (= o9 (ite (= o8 true) o7 false))))
(assert (=> (not (= result1 true)) (= o9 (distinct 1 0))))
(assert (and (= o1 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields3)))) (and (in_range4 o1) (= o1 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields3)))))))
(assert (= result2 (ite (= o1 1) true false)))
(assert (= result2 true))
(assert (and (= o2 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o2 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3)))))))
(assert (= o3 (ite (not (= o2 true)) true false)))
(assert (and (= result3 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= result3 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3)))))))
(assert (= result3 true))
