...
(assert (<= 0 k))
(assert (<= k (- (to_rep2 (rec__partition_refinement__interval__first p_elem__split_fields3)) 1)))
(assert (and (<= 0 k) (<= k 5)))
(assert (= o11 k))
(assert (= o12 (select (map__content f6) o11)))
(assert (= o13 (to_rep3 o12)))
(assert (and (= o14 (get (model__ (mk___rep p__split_discrs p__split_fields3)) o13)) (= (bool_eq o14 (get (model__ (mk___rep p__split_discrs p__split_fields3)) o13)) true)))
(assert (= o15 (us_split_fields3 o14)))
