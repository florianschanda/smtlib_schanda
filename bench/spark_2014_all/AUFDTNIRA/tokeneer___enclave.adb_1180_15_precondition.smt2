...
(assert (and (= o33 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range4 o33) (= o33 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result2 (ite (= o33 1) true false)))
(assert (=> (= result2 true) (and (= o37 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o37 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result2 true) (= o38 (ite (not (= o37 true)) true false))))
(assert (=> (= result2 true) (and (= o34 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range6 o34))))
(assert (=> (= result2 true) (= o35 (ite (= o34 3) true false))))
(assert (=> (= result2 true) (and (= o36 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o36 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result2 true) (= o39 (ite (= o36 true) o35 false))))
(assert (=> (= result2 true) (= o40 (ite (= o39 false) o38 true))))
(assert (=> (not (= result2 true)) (= o40 (distinct 1 0))))
...
(assert (=> (= result4 true) (and (= o30 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range6 o30))))
(assert (=> (= result4 true) (= result3 (ite (= o30 3) true false))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (=> (= result3 true) (and (= o31 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range4 o31) (= o31 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result3 true) (= o32 (ite (= o31 1) true false))))
(assert (=> (not (= result3 true)) (= o32 (distinct 1 0))))
(assert (and (= o22 (islocked (int__content currentlatch3) (us_private__content state23) (us_split_fields__content1 latchtimeout__split_fields6))) (= (= o22 true) (= (int__content currentlatch3) 0))))
(assert (= o23 (ite (not (= o22 true)) true false)))
(assert (= result5 (ite (= o23 true) (islocked currentlatch (us_private__content state2) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (=> (= result5 true) (and (= o26 (theauthcertrole (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content11 authcert__split_fields3) (us_split_fields__content8 idcert__split_fields3))) (and (in_range4 o26) (= o26 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content11 authcert__split_fields3))))))))
(assert (=> (= result5 true) (= o27 (ite (= o26 1) true false))))
(assert (=> (= result5 true) (and (= o24 (authcertvalid (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content11 authcert__split_fields3) (us_split_fields__content8 idcert__split_fields3))) (= (= o24 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content11 authcert__split_fields3)) true)))))
(assert (=> (= result5 true) (and (= o25 (isgood (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content11 authcert__split_fields3) (us_split_fields__content8 idcert__split_fields3))) (= (= o25 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content8 idcert__split_fields3)) true)))))
(assert (=> (= result5 true) (= o28 (ite (= o25 true) o24 false))))
(assert (=> (= result5 true) (= o29 (ite (= o28 true) o27 false))))
(assert (=> (not (= result5 true)) (= o29 (distinct 1 0))))
(assert (and (= o15 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range4 o15) (= o15 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result6 (ite (= o15 1) true false)))
(assert (=> (= result6 true) (and (= o18 (theauthcertrole (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content11 authcert__split_fields3) (us_split_fields__content8 idcert__split_fields3))) (and (in_range4 o18) (= o18 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content11 authcert__split_fields3))))))))
(assert (=> (= result6 true) (= o19 (ite (= o18 1) true false))))
(assert (=> (= result6 true) (and (= o16 (authcertvalid (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content11 authcert__split_fields3) (us_split_fields__content8 idcert__split_fields3))) (= (= o16 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content11 authcert__split_fields3)) true)))))
(assert (=> (= result6 true) (and (= o17 (isgood (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content11 authcert__split_fields3) (us_split_fields__content8 idcert__split_fields3))) (= (= o17 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content8 idcert__split_fields3)) true)))))
(assert (=> (= result6 true) (= o20 (ite (= o17 true) o16 false))))
(assert (=> (= result6 true) (= o21 (ite (= o20 true) o19 false))))
(assert (=> (not (= result6 true)) (= o21 (distinct 1 0))))
(assert (and (= o10 (thedooralarm (us_private__content state24))) (in_range17 o10)))
(assert (= o11 (ite (= o10 0) true false)))
(assert (= o12 (ite o11 1 0)))
(assert (= o6 (alarm_timeout (us_private__content state24))))
...
(assert (and (= o7 (greaterthanorequal o5 o6)) (= (= o7 true) (or (= (greaterthan o5 o6) true) (= (bool_eq3 o5 o6) true)))))
(assert (and (= o2 (thecurrentdoor (us_private__content state24))) (in_range29 o2)))
(assert (= o3 (ite (= o2 0) true false)))
(assert (and (= o4 (islocked (int__content currentlatch3) (us_private__content state23) (us_split_fields__content1 latchtimeout__split_fields6))) (= (= o4 true) (= (int__content currentlatch3) 0))))
