...
(assert (forall ((i durationt)) (and (<= 0 (durationtqtint i)) (<= (durationtqtint i) 2000))))
...
(define-fun dynamic_invariant ((temp___expr_1142 Int) (temp___is_init_1138 Bool) (temp___skip_constant_1139 Bool) (temp___do_toplevel_1140 Bool) (temp___do_typ_inv_1141 Bool)) Bool (=> (or (= temp___is_init_1138 true) (<= 0 2000)) (in_range7 temp___expr_1142)))
(assert (forall ((configdata__state us_private)) (! (dynamic_invariant (thefingerwaitduration configdata__state) true false true true) :pattern ((thefingerwaitduration configdata__state)))))
...
(assert (forall ((x logfileindext)) (! (in_range8 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((x logentrycountt)) (! (in_range9 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(assert (forall ((x logfilecountt)) (! (in_range10 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(assert (forall ((x fileentrycountt)) (! (in_range11 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_565 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool) (temp___do_typ_inv_564 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 0 1)) (in_range13 temp___expr_565)))
...
(define-fun in_range14 ((x Int)) Bool (and (<= 0 x) (<= x 40)))
...
(assert (forall ((x namecountt)) (! (in_range14 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(assert (forall ((x issueridt)) (! (in_range15 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(declare-fun user_eq26 (statscount statscount) Bool)
(declare-const dummy26 statscount)
...
(assert (forall ((x statscount)) (! (in_range16 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(declare-fun user_eq28 (statust1 statust1) Bool)
(declare-const dummy28 statust1)
...
(define-fun dynamic_invariant3 ((temp___expr_2551 Int) (temp___is_init_2547 Bool) (temp___skip_constant_2548 Bool) (temp___do_toplevel_2549 Bool) (temp___do_typ_inv_2550 Bool)) Bool (=> (or (= temp___is_init_2547 true) (<= 0 7)) (in_range17 temp___expr_2551)))
...
(define-fun in_range18 ((x Int)) Bool (and (<= 1 x) (<= x 150)))
...
(declare-fun user_eq29 (descriptioni descriptioni) Bool)
(declare-const dummy29 descriptioni)
...
(define-fun dynamic_invariant8 ((temp___expr_1164 Int) (temp___is_init_1160 Bool) (temp___skip_constant_1161 Bool) (temp___do_toplevel_1162 Bool) (temp___do_typ_inv_1163 Bool)) Bool (=> (or (= temp___is_init_1160 true) (<= 0 17)) (in_range10 temp___expr_1164)))
(define-fun dynamic_invariant9 ((temp___expr_1171 Int) (temp___is_init_1167 Bool) (temp___skip_constant_1168 Bool) (temp___do_toplevel_1169 Bool) (temp___do_typ_inv_1170 Bool)) Bool (=> (or (= temp___is_init_1167 true) (<= 1 17)) (in_range8 temp___expr_1171)))
(define-fun dynamic_invariant10 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 0 2)) (in_range12 temp___expr_1297)))
(define-fun dynamic_invariant11 ((temp___expr_1178 Int) (temp___is_init_1174 Bool) (temp___skip_constant_1175 Bool) (temp___do_toplevel_1176 Bool) (temp___do_typ_inv_1177 Bool)) Bool (=> (or (= temp___is_init_1174 true) (<= 0 17408)) (in_range9 temp___expr_1178)))
(define-fun dynamic_invariant12 ((temp___expr_1209 Int) (temp___is_init_1205 Bool) (temp___skip_constant_1206 Bool) (temp___do_toplevel_1207 Bool) (temp___do_typ_inv_1208 Bool)) Bool (=> (or (= temp___is_init_1205 true) (<= 0 1024)) (in_range11 temp___expr_1209)))
(assert true)
...
(assert (forall ((temp___1238 Int)) (=> (dynamic_invariant12 temp___1238 true true true true) (forall ((temp___1239 Int)) (= (select (temp_____aggregate_def_1236 temp___1238) temp___1239) rliteral2)))))
(define-fun dynamic_invariant13 ((temp___expr_590 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool) (temp___do_typ_inv_589 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 1 150)) (in_range18 temp___expr_590)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (forall ((temp___167 Int)) (=> (dynamic_invariant5 temp___167 true true true true) (forall ((temp___168 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___167) temp___168)) temp___167)))))
(define-fun dynamic_invariant14 ((temp___expr_642 Int) (temp___is_init_638 Bool) (temp___skip_constant_639 Bool) (temp___do_toplevel_640 Bool) (temp___do_typ_inv_641 Bool)) Bool (=> (or (= temp___is_init_638 true) (<= 1901 2099)) (in_range3 temp___expr_642)))
(define-fun dynamic_invariant15 ((temp___expr_649 Int) (temp___is_init_645 Bool) (temp___skip_constant_646 Bool) (temp___do_toplevel_647 Bool) (temp___do_typ_inv_648 Bool)) Bool (=> (or (= temp___is_init_645 true) (<= 1 12)) (in_range4 temp___expr_649)))
(define-fun dynamic_invariant16 ((temp___expr_656 Int) (temp___is_init_652 Bool) (temp___skip_constant_653 Bool) (temp___do_toplevel_654 Bool) (temp___do_typ_inv_655 Bool)) Bool (=> (or (= temp___is_init_652 true) (<= 1 31)) (in_range5 temp___expr_656)))
(define-fun dynamic_invariant17 ((temp___expr_688 Int) (temp___is_init_684 Bool) (temp___skip_constant_685 Bool) (temp___do_toplevel_686 Bool) (temp___do_typ_inv_687 Bool)) Bool (=> (or (= temp___is_init_684 true) (<= 0 86399999)) (in_range6 temp___expr_688)))
(define-fun dynamic_invariant18 ((temp___expr_403 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool) (temp___do_typ_inv_402 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 40)) (in_range14 temp___expr_403)))
(define-fun dynamic_invariant19 ((temp___expr_427 Int) (temp___is_init_423 Bool) (temp___skip_constant_424 Bool) (temp___do_toplevel_425 Bool) (temp___do_typ_inv_426 Bool)) Bool (=> (or (= temp___is_init_423 true) (<= 0 4294967295)) (in_range15 temp___expr_427)))
(define-fun dynamic_invariant20 ((temp___expr_1774 Int) (temp___is_init_1770 Bool) (temp___skip_constant_1771 Bool) (temp___do_toplevel_1772 Bool) (temp___do_typ_inv_1773 Bool)) Bool (=> (or (= temp___is_init_1770 true) (<= 0 2147483647)) (in_range16 temp___expr_1774)))
(assert (forall ((temp___1234 Int)) (=> (dynamic_invariant9 temp___1234 true true true true) (forall ((temp___1235 Int)) (= (select (temp_____aggregate_def_1232 temp___1234) temp___1235) rliteral)))))
