...
(declare-fun temp___String_Literal_1636 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1636 us_void_param) 1)) 46) (= (to_rep (select (temp___String_Literal_1636 us_void_param) 2)) 47)) (= (to_rep (select (temp___String_Literal_1636 us_void_param) 3)) 83)) (= (to_rep (select (temp___String_Literal_1636 us_void_param) 4)) 121)) (= (to_rep (select (temp___String_Literal_1636 us_void_param) 5)) 115)) (= (to_rep (select (temp___String_Literal_1636 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_1636 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_1636 us_void_param) 8)) 109)) (= (to_rep (select (temp___String_Literal_1636 us_void_param) 9)) 47)) (= (to_rep (select (temp___String_Literal_1636 us_void_param) 10)) 99)) (= (to_rep (select (temp___String_Literal_1636 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1636 us_void_param) 12)) 114)) (= (to_rep (select (temp___String_Literal_1636 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1636 us_void_param) 14)) 46)) (= (to_rep (select (temp___String_Literal_1636 us_void_param) 15)) 100)) (= (to_rep (select (temp___String_Literal_1636 us_void_param) 16)) 97)) (= (to_rep (select (temp___String_Literal_1636 us_void_param) 17)) 116)) :pattern ((temp___String_Literal_1636 us_void_param)))))
(declare-fun temp___String_Literal_1638 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1638 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 13)) 83)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 15)) 111)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 17)) 101)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 19)) 114)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 20)) 101)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 21)) 97)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 22)) 100)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 24)) 101)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 25)) 114)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 26)) 114)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 27)) 111)) (= (to_rep (select (temp___String_Literal_1638 us_void_param) 28)) 114)) :pattern ((temp___String_Literal_1638 us_void_param)))))
...
(define-fun dynamic_invariant8 ((temp___expr_1171 Int) (temp___is_init_1167 Bool) (temp___skip_constant_1168 Bool) (temp___do_toplevel_1169 Bool) (temp___do_typ_inv_1170 Bool)) Bool (=> (or (= temp___is_init_1167 true) (<= 0 17)) (in_range7 temp___expr_1171)))
(define-fun dynamic_invariant9 ((temp___expr_1178 Int) (temp___is_init_1174 Bool) (temp___skip_constant_1175 Bool) (temp___do_toplevel_1176 Bool) (temp___do_typ_inv_1177 Bool)) Bool (=> (or (= temp___is_init_1174 true) (<= 1 17)) (in_range5 temp___expr_1178)))
(define-fun dynamic_invariant10 ((temp___expr_1304 Int) (temp___is_init_1300 Bool) (temp___skip_constant_1301 Bool) (temp___do_toplevel_1302 Bool) (temp___do_typ_inv_1303 Bool)) Bool (=> (or (= temp___is_init_1300 true) (<= 0 2)) (in_range4 temp___expr_1304)))
(define-fun dynamic_invariant11 ((temp___expr_1185 Int) (temp___is_init_1181 Bool) (temp___skip_constant_1182 Bool) (temp___do_toplevel_1183 Bool) (temp___do_typ_inv_1184 Bool)) Bool (=> (or (= temp___is_init_1181 true) (<= 0 17408)) (in_range6 temp___expr_1185)))
(define-fun dynamic_invariant12 ((temp___expr_1216 Int) (temp___is_init_1212 Bool) (temp___skip_constant_1213 Bool) (temp___do_toplevel_1214 Bool) (temp___do_typ_inv_1215 Bool)) Bool (=> (or (= temp___is_init_1212 true) (<= 0 1024)) (in_range8 temp___expr_1216)))
(assert true)
...
(assert (forall ((temp___1245 Int)) (=> (dynamic_invariant12 temp___1245 true true true true) (forall ((temp___1246 Int)) (= (select (temp_____aggregate_def_1243 temp___1245) temp___1246) rliteral2)))))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(assert (forall ((temp___1241 Int)) (=> (dynamic_invariant9 temp___1241 true true true true) (forall ((temp___1242 Int)) (= (select (temp_____aggregate_def_1239 temp___1241) temp___1242) rliteral)))))
...
(declare-const temp___1637 (Array Int character))
(declare-const temp___16371 t1)
...
(assert (= (temp___String_Literal_1636 Tuple0) temp___1637))
(assert (= (mk1 1 17) temp___16371))
(assert (dynamic_predicate (mk___t1 temp___1637 temp___16371)))
(assert (= o temp___1637))
(assert (= o1 temp___16371))
