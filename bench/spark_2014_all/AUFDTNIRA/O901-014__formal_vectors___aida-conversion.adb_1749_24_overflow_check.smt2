...
(assert (forall ((temp___2154 Int) (temp___2155 Int) (temp___2156 Int) (temp___2157 Int) (temp___2158 Int) (temp___2159 Int) (temp___2160 Int) (temp___2161 Int) (temp___2162 Int) (temp___2163 Int)) (let ((temp___2153 (aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__int_array__aggregate_def temp___2154 temp___2155 temp___2156 temp___2157 temp___2158 temp___2159 temp___2160 temp___2161 temp___2162 temp___2163))) (=> (and (and (and (and (and (and (and (dynamic_invariant temp___2154 true true true true) (dynamic_invariant temp___2155 true true true true)) (dynamic_invariant temp___2156 true true true true)) (dynamic_invariant temp___2157 true true true true)) (dynamic_invariant temp___2158 true true true true)) (dynamic_invariant temp___2159 true true true true)) (dynamic_invariant temp___2160 true true true true)) (dynamic_invariant temp___2161 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 3) (+ (first1 source) 10) temp___2162 temp___2163) (and (= (first5 temp___2153) temp___2162) (= (last5 temp___2153) temp___2163))) (and (and (and (and (and (and (and (= (select (to_array2 temp___2153) (+ (+ (first1 source) 3) 0)) rliteral) (= (select (to_array2 temp___2153) (+ (+ (first1 source) 3) 1)) rliteral1)) (= (select (to_array2 temp___2153) (+ (+ (first1 source) 3) 2)) rliteral1)) (= (select (to_array2 temp___2153) (+ (+ (first1 source) 3) 3)) rliteral1)) (= (select (to_array2 temp___2153) (+ (+ (first1 source) 3) 4)) rliteral1)) (= (select (to_array2 temp___2153) (+ (+ (first1 source) 3) 5)) rliteral1)) (= (select (to_array2 temp___2153) (+ (+ (first1 source) 3) 6)) rliteral1)) (= (select (to_array2 temp___2153) (+ (+ (first1 source) 3) 7)) rliteral1)))))))
(define-fun dynamic_invariant4 ((temp___expr_714 us_t3) (temp___is_init_710 Bool) (temp___skip_constant_711 Bool) (temp___do_toplevel_712 Bool) (temp___do_typ_inv_713 Bool)) Bool (=> (not (= temp___skip_constant_711 true)) (and (dynamic_property6 (+ (first1 source) 3) (+ (first1 source) 10) (first7 temp___expr_714) (last7 temp___expr_714)) (and (= (first7 temp___expr_714) (+ (first1 source) 3)) (= (last7 temp___expr_714) (+ (first1 source) 10))))))
(declare-sort t6 0)
...
(assert (forall ((temp___2169 Int) (temp___2170 Int) (temp___2171 Int)) (let ((temp___2168 (aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__n__aggregate_def temp___2169 temp___2170 temp___2171))) (=> (dynamic_invariant temp___2169 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 3) (+ (first1 source) 10) temp___2170 temp___2171) (and (= (first9 temp___2168) temp___2170) (= (last9 temp___2168) temp___2171))) (forall ((temp___2172 Int)) (= (select (to_array4 temp___2168) temp___2172) rliteral2)))))))
...
(declare-const temp___2166 (Array Int integer))
(declare-const temp___21661 t2)
...
(declare-const temp___2174 (Array Int integer))
(declare-const temp___21741 t4)
...
(declare-const temp___2177 Int)
(declare-const temp___2181 Int)
(declare-const temp___2179 (Array Int integer))
(declare-const o Int)
...
(declare-const temp___2182 Int)
(declare-const o9 Int)
(declare-const o10 integer)
(declare-const o11 Int)
(declare-const o12 Int)
(declare-const o13 Int)
(declare-const temp___2183 Int)
...
(assert (and (= (length source) 11) (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (forall ((index7 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 3) index7) (<= index7 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index7))) true))))))
...
(assert (= (mk___t2 temp___2166 temp___21661) (aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__int_array__aggregate_def 3 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 3) (+ (+ (to_rep1 (first (rt source))) 3) 7))))
(assert (= (ite (<= (to_rep1 (first4 temp___21661)) (to_rep1 (last4 temp___21661))) (+ (- (to_rep1 (last4 temp___21661)) (to_rep1 (first4 temp___21661))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 3)) 1) 0)))
(assert (= (slide1 temp___2166 (to_rep1 (first4 temp___21661)) (+ (to_rep1 (first (rt source))) 3)) aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__int_array__assume))
...
(assert (= (mk___t4 temp___2174 temp___21741) (aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___21741)) (to_rep1 (last8 temp___21741))) (+ (- (to_rep1 (last8 temp___21741)) (to_rep1 (first8 temp___21741))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 3)) 1) 0)))
(assert (= (slide1 temp___2174 (to_rep1 (first8 temp___21741)) (+ (to_rep1 (first (rt source))) 3)) aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__n__assume))
...
(assert (and (= temp___2176 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (= temp___2177 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2176))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= temp___2181 index1)))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= temp___2179 n1)))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= o index1)))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= o3 index1)))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= o7 index1)))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= n1 result3)))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= n2 o8)))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 3) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 3) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (and (and (forall ((temp___2180 Int)) (=> (and (<= (to_rep1 n__first) temp___2180) (<= temp___2180 (to_rep1 n__last))) (=> (or (< temp___2177 temp___2180) (or (< temp___2180 temp___2176) (< index2 temp___2180))) (= (select n3 temp___2180) (select temp___2179 temp___2180))))) (=> (<= (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 3) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= index2 temp___2177)))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= index2 index3)))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= n3 n4)))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= index4 index2)))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= n5 n3)))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= index6 index4)))
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (= n7 n5)))
(assert (=> (not (and (<= temp___2176 index1) (<= index1 temp___2177))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2176 index1) (<= index1 temp___2177))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2176 index1) (<= index1 temp___2177))) (= index6 index1)))
(assert (=> (not (and (<= temp___2176 index1) (<= index1 temp___2177))) (= n7 n1)))
...
(assert (and (= temp___2182 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___2182) (<= temp___2182 (to_rep1 n__last))))
(assert (= o9 temp___2182))
...
(assert (= target1 o13))
(assert (<= (- 9) target1))
(assert (and (= temp___2183 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___2183) (<= temp___2183 (to_rep1 n__last))))
(assert (= o14 temp___2183))
...
(assert (= target2 o20))
(assert (<= (- 99) target2))
(assert (and (= temp___2184 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___2184) (<= temp___2184 (to_rep1 n__last))))
(assert (= o21 temp___2184))
...
(assert (= target3 o27))
(assert (<= (- 999) target3))
(assert (and (= temp___2185 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2185) (<= temp___2185 (to_rep1 n__last))))
(assert (= o28 temp___2185))
...
(assert (= target4 o34))
(assert (<= (- 9999) target4))
(assert (and (= temp___2186 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2186) (<= temp___2186 (to_rep1 n__last))))
(assert (= o35 temp___2186))
...
(assert (and (= temp___2187 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2187) (<= temp___2187 (to_rep1 n__last))))
(assert (= o42 temp___2187))
...
(assert (and (= temp___2188 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2188) (<= temp___2188 (to_rep1 n__last))))
(assert (= o49 temp___2188))
...
(assert (and (= temp___2189 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___2189) (<= temp___2189 (to_rep1 n__last))))
(assert (= o56 temp___2189))
...
(assert (= target8 o62))
(assert (<= (- 39999999) target8))
(assert (not (in_range1 (- target8 2100000000))))
(check-sat)
(exit)
