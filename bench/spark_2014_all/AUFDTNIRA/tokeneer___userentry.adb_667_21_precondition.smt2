...
(assert (forall ((x logfileindext)) (! (in_range7 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((x logentrycountt)) (! (in_range8 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(assert (forall ((x logfilecountt)) (! (in_range9 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(define-fun bool_eq3 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep6 (select a temp___idx_172)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_172))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep6 (select a temp___idx_172)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_172)))))))))))
...
(assert (forall ((x fileentrycountt)) (! (in_range10 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(define-fun bool_eq5 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep9 (select a temp___idx_173)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_173))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep9 (select a temp___idx_173)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
...
(define-fun bool_eq8 ((a (Array Int us_rep3)) (a__first Int) (a__last Int) (b (Array Int us_rep3)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq7 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true)))) true false))
...
(assert (forall ((x filestatust)) (! (in_range11 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(define-fun bool_eq9 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep10 (select a temp___idx_175)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_175))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq9 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep10 (select a temp___idx_175)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(define-fun dynamic_invariant ((temp___expr_565 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool) (temp___do_typ_inv_564 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 0 1)) (in_range12 temp___expr_565)))
...
(define-fun dynamic_invariant1 ((temp___expr_1226 us_rep2) (temp___is_init_1222 Bool) (temp___skip_constant_1223 Bool) (temp___do_toplevel_1224 Bool) (temp___do_typ_inv_1225 Bool)) Bool (=> (= temp___do_typ_inv_1225 true) (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1226))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1226))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1226)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1226))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1230 us_rep2) (temp___skip_top_level_1231 Bool)) Bool (and (and (and (= (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1230))) 1) (= (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1230))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1230)) (mk___rep1 (mk___split_fields1 (temp_____aggregate_def_1232 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1230)) (temp_____aggregate_def_1236 0))))
(define-fun type_invariant ((temp___1240 us_rep2)) Bool (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1240))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1240))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1240)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1240))) true))
...
(define-fun to_rep13 ((x statscount)) Int (statscountqtint x))
(declare-fun of_rep13 (Int) statscount)
(assert (forall ((x statscount)) (! (= (of_rep13 (to_rep13 x)) x) :pattern ((to_rep13 x)))))
(assert (forall ((x statscount)) (! (in_range15 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun in_range16 ((x Int)) Bool (and (<= 0 x) (<= x 7)))
...
(declare-fun user_eq27 (statust1 statust1) Bool)
(declare-const dummy27 statust1)
...
(define-fun dynamic_invariant2 ((temp___expr_2551 Int) (temp___is_init_2547 Bool) (temp___skip_constant_2548 Bool) (temp___do_toplevel_2549 Bool) (temp___do_typ_inv_2550 Bool)) Bool (=> (or (= temp___is_init_2547 true) (<= 0 7)) (in_range16 temp___expr_2551)))
...
(declare-fun user_eq28 (descriptioni descriptioni) Bool)
(declare-const dummy28 descriptioni)
...
(define-fun dynamic_invariant7 ((temp___expr_1164 Int) (temp___is_init_1160 Bool) (temp___skip_constant_1161 Bool) (temp___do_toplevel_1162 Bool) (temp___do_typ_inv_1163 Bool)) Bool (=> (or (= temp___is_init_1160 true) (<= 0 17)) (in_range9 temp___expr_1164)))
(define-fun dynamic_invariant8 ((temp___expr_1171 Int) (temp___is_init_1167 Bool) (temp___skip_constant_1168 Bool) (temp___do_toplevel_1169 Bool) (temp___do_typ_inv_1170 Bool)) Bool (=> (or (= temp___is_init_1167 true) (<= 1 17)) (in_range7 temp___expr_1171)))
(define-fun dynamic_invariant9 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 0 2)) (in_range11 temp___expr_1297)))
(define-fun dynamic_invariant10 ((temp___expr_1178 Int) (temp___is_init_1174 Bool) (temp___skip_constant_1175 Bool) (temp___do_toplevel_1176 Bool) (temp___do_typ_inv_1177 Bool)) Bool (=> (or (= temp___is_init_1174 true) (<= 0 17408)) (in_range8 temp___expr_1178)))
(define-fun dynamic_invariant11 ((temp___expr_1209 Int) (temp___is_init_1205 Bool) (temp___skip_constant_1206 Bool) (temp___do_toplevel_1207 Bool) (temp___do_typ_inv_1208 Bool)) Bool (=> (or (= temp___is_init_1205 true) (<= 0 1024)) (in_range10 temp___expr_1209)))
(assert true)
...
(define-fun dynamic_invariant12 ((temp___expr_590 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool) (temp___do_typ_inv_589 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 1 150)) (in_range17 temp___expr_590)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (forall ((temp___167 Int)) (=> (dynamic_invariant4 temp___167 true true true true) (forall ((temp___168 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___167) temp___168)) temp___167)))))
(define-fun dynamic_invariant13 ((temp___expr_642 Int) (temp___is_init_638 Bool) (temp___skip_constant_639 Bool) (temp___do_toplevel_640 Bool) (temp___do_typ_inv_641 Bool)) Bool (=> (or (= temp___is_init_638 true) (<= 1901 2099)) (in_range3 temp___expr_642)))
(define-fun dynamic_invariant14 ((temp___expr_649 Int) (temp___is_init_645 Bool) (temp___skip_constant_646 Bool) (temp___do_toplevel_647 Bool) (temp___do_typ_inv_648 Bool)) Bool (=> (or (= temp___is_init_645 true) (<= 1 12)) (in_range4 temp___expr_649)))
(define-fun dynamic_invariant15 ((temp___expr_656 Int) (temp___is_init_652 Bool) (temp___skip_constant_653 Bool) (temp___do_toplevel_654 Bool) (temp___do_typ_inv_655 Bool)) Bool (=> (or (= temp___is_init_652 true) (<= 1 31)) (in_range5 temp___expr_656)))
(define-fun dynamic_invariant16 ((temp___expr_688 Int) (temp___is_init_684 Bool) (temp___skip_constant_685 Bool) (temp___do_toplevel_686 Bool) (temp___do_typ_inv_687 Bool)) Bool (=> (or (= temp___is_init_684 true) (<= 0 86399999)) (in_range6 temp___expr_688)))
(define-fun dynamic_invariant17 ((temp___expr_403 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool) (temp___do_typ_inv_402 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 40)) (in_range13 temp___expr_403)))
(define-fun dynamic_invariant18 ((temp___expr_427 Int) (temp___is_init_423 Bool) (temp___skip_constant_424 Bool) (temp___do_toplevel_425 Bool) (temp___do_typ_inv_426 Bool)) Bool (=> (or (= temp___is_init_423 true) (<= 0 4294967295)) (in_range14 temp___expr_427)))
(define-fun dynamic_invariant19 ((temp___expr_1774 Int) (temp___is_init_1770 Bool) (temp___skip_constant_1771 Bool) (temp___do_toplevel_1772 Bool) (temp___do_typ_inv_1773 Bool)) Bool (=> (or (= temp___is_init_1770 true) (<= 0 2147483647)) (in_range15 temp___expr_1774)))
...
(assert (in_range12 auditalarm))
(assert (= (privatekeypresent (mk___split_fields4 thistisinfo__split_fields (mk___rep3 (mk___split_fields3 thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) state) true))
(assert (= o (ispresent (us_private__content state1))))
(assert (= result (ite (not (= o true)) true false)))
(assert (not (= result true)))
(assert (and (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true) (in_range12 auditalarm1)))
(assert (= result1 (mk_int__ref status)))
(assert (= status3 5))
(assert (=> (= updateok true) (and (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range12 auditalarm2))))
(assert (=> (not (= updateok true)) (= (let ((subject output)) (mk___private__ref output2)) output)))
(assert (=> (not (= updateok true)) (= (let ((subject status1)) (mk___private__ref status4)) status1)))
...
(assert (=> (not (= updateok true)) (= auditsystemfault1 auditsystemfault)))
(assert (=> (not (= updateok true)) (= auditalarm2 auditalarm1)))
(assert (=> (not (= updateok true)) (= logfilestate__split_fields8 logfilestate__split_fields7)))
(assert (=> (not (= updateok true)) (= logfilesstatus1 logfilesstatus)))
(assert (=> (not (= updateok true)) (= logfiles1 logfiles)))
...
(assert (= o1 (extractuser (let ((subject state1)) state3))))
