...
(define-fun in_range15 ((x Int)) Bool (and (<= 0 x) (<= x 43)))
(declare-fun attr__ATTRIBUTE_IMAGE15 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check15 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE15 (us_image) Int)
(declare-fun user_eq21 (elementt elementt) Bool)
(declare-const dummy21 elementt)
...
(define-fun dynamic_invariant3 ((temp___expr_406 Int) (temp___is_init_402 Bool) (temp___skip_constant_403 Bool) (temp___do_toplevel_404 Bool) (temp___do_typ_inv_405 Bool)) Bool (=> (or (= temp___is_init_402 true) (<= 0 43)) (in_range15 temp___expr_406)))
...
(declare-fun user_eq22 (severityt severityt) Bool)
(declare-const dummy22 severityt)
...
(define-fun dynamic_invariant4 ((temp___expr_417 Int) (temp___is_init_413 Bool) (temp___skip_constant_414 Bool) (temp___do_toplevel_415 Bool) (temp___do_typ_inv_416 Bool)) Bool (=> (or (= temp___is_init_413 true) (<= 0 2)) (in_range16 temp___expr_417)))
...
(define-fun dynamic_invariant5 ((temp___expr_1424 Int) (temp___is_init_1420 Bool) (temp___skip_constant_1421 Bool) (temp___do_toplevel_1422 Bool) (temp___do_typ_inv_1423 Bool)) Bool (=> (or (= temp___is_init_1420 true) (<= 0 1)) (in_range18 temp___expr_1424)))
...
(define-fun dynamic_invariant10 ((temp___expr_1160 Int) (temp___is_init_1156 Bool) (temp___skip_constant_1157 Bool) (temp___do_toplevel_1158 Bool) (temp___do_typ_inv_1159 Bool)) Bool (=> (or (= temp___is_init_1156 true) (<= 0 17)) (in_range11 temp___expr_1160)))
(define-fun dynamic_invariant11 ((temp___expr_1167 Int) (temp___is_init_1163 Bool) (temp___skip_constant_1164 Bool) (temp___do_toplevel_1165 Bool) (temp___do_typ_inv_1166 Bool)) Bool (=> (or (= temp___is_init_1163 true) (<= 1 17)) (in_range9 temp___expr_1167)))
(define-fun dynamic_invariant12 ((temp___expr_1293 Int) (temp___is_init_1289 Bool) (temp___skip_constant_1290 Bool) (temp___do_toplevel_1291 Bool) (temp___do_typ_inv_1292 Bool)) Bool (=> (or (= temp___is_init_1289 true) (<= 0 2)) (in_range8 temp___expr_1293)))
(define-fun dynamic_invariant13 ((temp___expr_1174 Int) (temp___is_init_1170 Bool) (temp___skip_constant_1171 Bool) (temp___do_toplevel_1172 Bool) (temp___do_typ_inv_1173 Bool)) Bool (=> (or (= temp___is_init_1170 true) (<= 0 17408)) (in_range10 temp___expr_1174)))
(define-fun dynamic_invariant14 ((temp___expr_1205 Int) (temp___is_init_1201 Bool) (temp___skip_constant_1202 Bool) (temp___do_toplevel_1203 Bool) (temp___do_typ_inv_1204 Bool)) Bool (=> (or (= temp___is_init_1201 true) (<= 0 1024)) (in_range12 temp___expr_1205)))
(assert true)
...
(assert (forall ((temp___1234 Int)) (=> (dynamic_invariant14 temp___1234 true true true true) (forall ((temp___1235 Int)) (= (select (temp_____aggregate_def_1232 temp___1234) temp___1235) rliteral2)))))
(define-fun dynamic_invariant15 ((temp___expr_424 Int) (temp___is_init_420 Bool) (temp___skip_constant_421 Bool) (temp___do_toplevel_422 Bool) (temp___do_typ_inv_423 Bool)) Bool (=> (or (= temp___is_init_420 true) (<= 1 150)) (in_range17 temp___expr_424)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (forall ((temp___156 Int)) (=> (dynamic_invariant7 temp___156 true true true true) (forall ((temp___157 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___156) temp___157)) temp___156)))))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(define-fun dynamic_invariant16 ((temp___expr_476 Int) (temp___is_init_472 Bool) (temp___skip_constant_473 Bool) (temp___do_toplevel_474 Bool) (temp___do_typ_inv_475 Bool)) Bool (=> (or (= temp___is_init_472 true) (<= 1901 2099)) (in_range4 temp___expr_476)))
(define-fun dynamic_invariant17 ((temp___expr_483 Int) (temp___is_init_479 Bool) (temp___skip_constant_480 Bool) (temp___do_toplevel_481 Bool) (temp___do_typ_inv_482 Bool)) Bool (=> (or (= temp___is_init_479 true) (<= 1 12)) (in_range5 temp___expr_483)))
(define-fun dynamic_invariant18 ((temp___expr_490 Int) (temp___is_init_486 Bool) (temp___skip_constant_487 Bool) (temp___do_toplevel_488 Bool) (temp___do_typ_inv_489 Bool)) Bool (=> (or (= temp___is_init_486 true) (<= 1 31)) (in_range6 temp___expr_490)))
(define-fun dynamic_invariant19 ((temp___expr_522 Int) (temp___is_init_518 Bool) (temp___skip_constant_519 Bool) (temp___do_toplevel_520 Bool) (temp___do_typ_inv_521 Bool)) Bool (=> (or (= temp___is_init_518 true) (<= 0 86399999)) (in_range7 temp___expr_522)))
(assert true)
...
(assert (forall ((temp___1230 Int)) (=> (dynamic_invariant11 temp___1230 true true true true) (forall ((temp___1231 Int)) (= (select (temp_____aggregate_def_1228 temp___1230) temp___1231) rliteral)))))
...
(define-fun severity5 () int__ref (mk_int__ref severity))
(define-fun localalarm5 () int__ref (mk_int__ref localalarm))
...
(assert (=> (<= 0 1) (in_range13 localalarm)))
(assert (=> (<= 0 2) (in_range16 severity)))
(assert (=> (<= 0 43) (in_range15 id)))
...
(assert (=> (= result true) (= result1 localalarm5)))
(assert (=> (= result true) (= localalarm1 0)))
(assert (=> (= result true) (= result2 severity5)))
(assert (=> (= result true) (= severity1 2)))
(assert (=> (= result true) (= result3 id5)))
(assert (=> (= result true) (= id1 10)))
(assert (=> (not (= result true)) (= result4 localalarm5)))
(assert (=> (not (= result true)) (= localalarm2 1)))
(assert (=> (not (= result true)) (= result5 severity5)))
(assert (=> (not (= result true)) (= severity2 0)))
(assert (=> (not (= result true)) (= result6 id5)))
...
(assert (=> (not (= dooralarm localalarm1)) (and (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range13 auditalarm2))))
(assert (=> (not (not (= dooralarm localalarm1))) (= (let ((subject state)) (mk___private__ref state3)) state)))
(assert (=> (not (not (= dooralarm localalarm1))) (= (let ((subject filestate)) (mk___private__ref filestate2)) filestate)))
(assert (=> (not (not (= dooralarm localalarm1))) (= auditsystemfault2 auditsystemfault)))
(assert (=> (not (not (= dooralarm localalarm1))) (= auditalarm2 auditalarm)))
(assert (=> (not (not (= dooralarm localalarm1))) (= logfilestate__split_fields8 (mk___split_fields2 logfilestate__split_fields logfilestate__split_fields1 (mk___rep1 (mk___split_fields1 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))))
(assert (=> (not (not (= dooralarm localalarm1))) (= logfilesstatus2 logfilesstatus)))
(assert (=> (not (not (= dooralarm localalarm1))) (= logfiles2 logfiles)))
(assert (=> (not (not (= dooralarm localalarm1))) (= state3 state2)))
(assert (=> (not (not (= dooralarm localalarm1))) (= filestate2 filestate1)))
(assert (=> (not (not (= dooralarm localalarm1))) (= auditsystemfault2 auditsystemfault1)))
(assert (=> (not (not (= dooralarm localalarm1))) (= auditalarm2 auditalarm1)))
(assert (=> (not (not (= dooralarm localalarm1))) (= logfilestate__split_fields8 logfilestate__split_fields7)))
(assert (=> (not (not (= dooralarm localalarm1))) (= logfilesstatus2 logfilesstatus1)))
(assert (=> (not (not (= dooralarm localalarm1))) (= logfiles2 logfiles1)))
...
(assert (= (int__content dooralarm2) 0))
(assert (not (= currentdoor 0)))
(check-sat)
(exit)
