...
(assert (=> (= result3 true) (and (= o2 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o2 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
...
(assert (=> (= result3 true) (=> (= result4 true) (and (= o1 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range3 o1)))))
...
(assert (and (= result5 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result5 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result5 true))
