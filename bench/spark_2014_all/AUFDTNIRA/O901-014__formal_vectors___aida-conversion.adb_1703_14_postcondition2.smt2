...
(assert (and (= (length source) 11) (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (forall ((index9 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 3) index9) (<= index9 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index9))) true))))))
...
(assert (and (= o63 (- target8 2100000000)) (in_range1 (- target8 2100000000))))
(assert (= result12 (mk_int__ref target8)))
(assert (= target9 o63))
(assert (<= (- 2139999999) target9))
