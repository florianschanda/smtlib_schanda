...
(define-fun dynamic_invariant2 ((temp___expr_379 Int) (temp___is_init_375 Bool) (temp___skip_constant_376 Bool) (temp___do_toplevel_377 Bool) (temp___do_typ_inv_378 Bool)) Bool (=> (or (= temp___is_init_375 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_379)))
...
(define-fun dynamic_invariant3 ((temp___expr_435 Int) (temp___is_init_431 Bool) (temp___skip_constant_432 Bool) (temp___do_toplevel_433 Bool) (temp___do_typ_inv_434 Bool)) Bool (=> (or (= temp___is_init_431 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_435)))
...
(define-fun dynamic_invariant4 ((temp___expr_474 Int) (temp___is_init_470 Bool) (temp___skip_constant_471 Bool) (temp___do_toplevel_472 Bool) (temp___do_typ_inv_473 Bool)) Bool (=> (or (= temp___is_init_470 true) (<= 0 2147483647)) (in_range4 temp___expr_474)))
...
(assert (= (to_rep (select the_file cur_position)) eof_ch))
(assert (not (= ch2 eof)))
(check-sat)
(exit)
