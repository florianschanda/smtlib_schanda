...
(assert (=> (= result1 true) (and (= o9 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range6 o9))))
(assert (=> (= result1 true) (= o10 (ite (= o9 3) true false))))
(assert (=> (= result1 true) (and (= o11 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o11 true) (in_range6 (to_rep3 theadmin__split_fields1))))))
...
(assert (=> (= result2 true) (and (= o3 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o3 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result2 true) (= o4 (ite (not (= o3 true)) true false))))
(assert (=> (= result2 true) (and (= result3 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= result3 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result2 true) (=> (= result3 true) (and (= o2 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (in_range6 o2)))))
...
(assert (and (= result4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= result4 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3)))))))
(assert (= result4 true))
