...
(assert (and (= o (thetokentry (us_private__content state))) (in_range17 o)))
...
(assert (= tokentry1 2))
(assert (and (= o1 (thetokenid (us_private__content state))) (in_range16 o1)))
(assert (= result1 (mk_int__ref tokenid)))
(assert (= tokenid1 o1))
(assert (and (= (valid_numberlogentries (to_rep15 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep16 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true) (in_range23 auditalarm1)))
...
(assert (and (= o2 (therole (mk___rep4 (let ((subject authcertcontents__split_fields)) authcertcontents__split_fields2)))) (and (in_range13 o2) (= o2 (to_rep11 (rec__cert__attr__auth__contentst__role (let ((subject authcertcontents__split_fields)) authcertcontents__split_fields2)))))))
(assert (= result2 (ite (in_range24 o2) true false)))
(assert (not (= result2 true)))
(assert (not (= (to_rep1 (first (mk 1 47))) 1)))
(check-sat)
(exit)
