...
(assert (=> (= result2 true) (= temp___219 x1)))
(assert (=> (= result2 true) (and (=> (<= 0 2147483647) (in_range2 x2)) (and (in_range3 x2) (< (* x2 i1) 2147483647)))))
(assert (=> (= result2 true) (and (= o1 (* x2 i1)) (in_range1 (* x2 i1)))))
(assert (=> (= result2 true) (and (= o2 o1) (in_range2 o1))))
(assert (=> (= result2 true) (= result3 x2)))
(assert (=> (= result2 true) (= x3 o2)))
(assert (=> (= result2 true) (= (= o3 true) (< (* x3 i1) 2147483647))))
(assert (=> (= result2 true) (= o4 (ite (in_range3 x3) o3 false))))
(assert (=> (= result2 true) (= result4 (ite (not (= o4 true)) true false))))
(assert (=> (= result2 true) (= result4 true)))
(assert (=> (= result2 true) (= x3 x4)))
(assert (=> (= result2 true) (= x5 x3)))
(assert (=> (= result2 true) (= (mk_int__ref x6) (mk_int__ref x4))))
(assert (=> (= result2 true) (= x7 x5)))
(assert (=> (not (= result2 true)) (= x1 x6)))
(assert (=> (not (= result2 true)) (= x7 x1)))
(assert (= (to_rep o5) x6))
(assert (= o6 (store a i1 o5)))
(assert (= result5 a))
(assert (= a1 o6))
(assert (= result6 i1))
(assert (= i2 2))
...
(assert (= x8 1))
(assert (in_range2 x8))
(assert (= (= o7 true) (< (* x8 i2) 2147483647)))
(assert (= result8 (ite (in_range3 x8) o7 false)))
(assert (= result8 true))
(assert (and (=> (<= 0 2147483647) (in_range2 x9)) (and (in_range3 x9) (< (* x9 i2) 2147483647))))
(assert (and (= o8 (* x9 i2)) (in_range1 (* x9 i2))))
