...
(assert (forall ((x namecountt)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x classt)) (! (in_range9 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(assert (forall ((x algorithmt)) (! (in_range10 (to_rep9 x)) :pattern ((to_rep9 x)))))
(assert (forall ((x Int)) (! (=> (in_range10 x) (= (to_rep9 (of_rep9 x)) x)) :pattern ((to_rep9 (of_rep9 x))))))
(declare-sort privileget 0)
(define-fun in_range11 ((x Int)) Bool (and (<= 0 x) (<= x 3)))
...
(assert (forall ((x privileget)) (! (in_range11 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__admintoken__validauthcertt__valid Bool) (rec__admintoken__validauthcertt__contents us_rep4)))))
(define-fun us_split_fields_Valid__projection ((a us_split_fields10)) Bool (rec__admintoken__validauthcertt__valid a))
(define-fun us_split_fields_Contents__projection ((a us_split_fields10)) us_rep4 (rec__admintoken__validauthcertt__contents a))
(declare-datatypes () ((us_split_fields__ref5 (mk___split_fields__ref5 (us_split_fields__content5 us_split_fields10)))))
(define-fun us_split_fields__ref___17__projection ((a us_split_fields__ref5)) us_split_fields10 (us_split_fields__content5 a))
(declare-datatypes () ((us_rep5 (mk___rep5 (us_split_fields11 us_split_fields10)))))
(define-fun us_rep___18__projection ((a us_rep5)) us_split_fields10 (us_split_fields11 a))
(define-fun bool_eq6 ((a us_rep5) (b us_rep5)) Bool (ite (and (= (rec__admintoken__validauthcertt__valid (us_split_fields11 a)) (rec__admintoken__validauthcertt__valid (us_split_fields11 b))) (= (bool_eq5 (rec__admintoken__validauthcertt__contents (us_split_fields11 a)) (rec__admintoken__validauthcertt__contents (us_split_fields11 b))) true)) true false))
...
(declare-datatypes () ((validauthcertt__ref (mk_validauthcertt__ref (validauthcertt__content us_rep5)))))
(define-fun validauthcertt__ref___projection ((a validauthcertt__ref)) us_rep5 (validauthcertt__content a))
...
(define-fun dynamic_invariant ((temp___expr_1213 Int) (temp___is_init_1209 Bool) (temp___skip_constant_1210 Bool) (temp___do_toplevel_1211 Bool) (temp___do_typ_inv_1212 Bool)) Bool (=> (or (= temp___is_init_1209 true) (<= 0 3)) (in_range11 temp___expr_1213)))
(assert (forall ((admintoken__authcert__fields us_split_fields10)) (! (dynamic_invariant (theauthcertrole admintoken__authcert__fields) true false true true) :pattern ((theauthcertrole admintoken__authcert__fields)))))
(assert (forall ((admintoken__authcert__fields us_split_fields10)) (! (= (theauthcertrole admintoken__authcert__fields) (therole (rec__admintoken__validauthcertt__contents (us_split_fields11 (mk___rep5 admintoken__authcert__fields))))) :pattern ((theauthcertrole admintoken__authcert__fields)))))
...
(assert (forall ((x keyidt)) (! (in_range12 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(assert (forall ((x keylengtht)) (! (in_range13 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(define-fun us_rep___2__projection ((a us_rep6)) us_split_fields12 (us_split_fields13 a))
(define-fun bool_eq7 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (= (to_rep9 (rec__cryptotypes__keypartt__algorithmid (us_split_fields13 a))) (to_rep9 (rec__cryptotypes__keypartt__algorithmid (us_split_fields13 b)))) (= (to_rep11 (rec__cryptotypes__keypartt__keyid (us_split_fields13 a))) (to_rep11 (rec__cryptotypes__keypartt__keyid (us_split_fields13 b))))) (= (to_rep12 (rec__cryptotypes__keypartt__keylength (us_split_fields13 a))) (to_rep12 (rec__cryptotypes__keypartt__keylength (us_split_fields13 b))))) true false))
...
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__cert__id__contentst__id us_rep2) (rec__cert__id__contentst__notbefore us_rep) (rec__cert__id__contentst__notafter us_rep) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep1) (rec__cert__id__contentst__subjectpublickey us_rep6)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields14)) us_rep2 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields14)) us_rep (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields14)) us_rep (rec__cert__id__contentst__notafter a))
...
(define-fun us_split_fields_SubjectPublicKey__projection ((a us_split_fields14)) us_rep6 (rec__cert__id__contentst__subjectpublickey a))
...
(define-fun us_rep___17__projection ((a us_rep7)) us_split_fields14 (us_split_fields15 a))
(define-fun bool_eq8 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (and (and (and (= (bool_eq3 (rec__cert__id__contentst__id (us_split_fields15 a)) (rec__cert__id__contentst__id (us_split_fields15 b))) true) (= (bool_eq (rec__cert__id__contentst__notbefore (us_split_fields15 a)) (rec__cert__id__contentst__notbefore (us_split_fields15 b))) true)) (= (bool_eq (rec__cert__id__contentst__notafter (us_split_fields15 a)) (rec__cert__id__contentst__notafter (us_split_fields15 b))) true)) (= (to_rep9 (rec__cert__id__contentst__mechanism (us_split_fields15 a))) (to_rep9 (rec__cert__id__contentst__mechanism (us_split_fields15 b))))) (= (bool_eq2 (rec__cert__id__contentst__subject (us_split_fields15 a)) (rec__cert__id__contentst__subject (us_split_fields15 b))) true)) (= (bool_eq7 (rec__cert__id__contentst__subjectpublickey (us_split_fields15 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields15 b))) true)) true false))
...
(declare-datatypes () ((contentst__ref1 (mk_contentst__ref1 (contentst__content1 us_rep7)))))
(define-fun contentst__ref___4__projection ((a contentst__ref1)) us_rep7 (contentst__content1 a))
(declare-datatypes () ((us_split_fields16 (mk___split_fields8 (rec__admintoken__valididcertt__valid Bool) (rec__admintoken__valididcertt__contents us_rep7)))))
(define-fun us_split_fields_Valid__2__projection ((a us_split_fields16)) Bool (rec__admintoken__valididcertt__valid a))
(define-fun us_split_fields_Contents__2__projection ((a us_split_fields16)) us_rep7 (rec__admintoken__valididcertt__contents a))
...
(define-fun bool_eq9 ((a us_rep8) (b us_rep8)) Bool (ite (and (= (rec__admintoken__valididcertt__valid (us_split_fields17 a)) (rec__admintoken__valididcertt__valid (us_split_fields17 b))) (= (bool_eq8 (rec__admintoken__valididcertt__contents (us_split_fields17 a)) (rec__admintoken__valididcertt__contents (us_split_fields17 b))) true)) true false))
...
(assert true)
(assert (forall ((admintoken__authcert__fields us_split_fields10)) (! (= (= (authcertvalid admintoken__authcert__fields) true) (= (rec__admintoken__validauthcertt__valid (us_split_fields11 (mk___rep5 admintoken__authcert__fields))) true)) :pattern ((authcertvalid admintoken__authcert__fields)))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_178 Int)) (=> (and (<= a__first temp___idx_178) (<= temp___idx_178 a__last)) (= (to_rep13 (select a temp___idx_178)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_178)))))))))))
...
(define-fun in_range15 ((x Int)) Bool (and (<= 1 x) (<= x 17)))
(declare-fun attr__ATTRIBUTE_IMAGE15 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check15 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE15 (us_image) Int)
(declare-fun user_eq24 (logfileindext logfileindext) Bool)
(declare-const dummy24 logfileindext)
...
(define-fun to_rep14 ((x logfileindext)) Int (logfileindextqtint x))
(declare-fun of_rep14 (Int) logfileindext)
(assert (forall ((x logfileindext)) (! (= (of_rep14 (to_rep14 x)) x) :pattern ((to_rep14 x)))))
(assert (forall ((x logfileindext)) (! (in_range15 (to_rep14 x)) :pattern ((to_rep14 x)))))
(assert (forall ((x Int)) (! (=> (in_range15 x) (= (to_rep14 (of_rep14 x)) x)) :pattern ((to_rep14 (of_rep14 x))))))
...
(define-fun in_range16 ((x Int)) Bool (and (<= 0 x) (<= x 17408)))
...
(declare-fun user_eq25 (logentrycountt logentrycountt) Bool)
(declare-const dummy25 logentrycountt)
...
(define-fun to_rep15 ((x logentrycountt)) Int (logentrycounttqtint x))
(declare-fun of_rep15 (Int) logentrycountt)
(assert (forall ((x logentrycountt)) (! (= (of_rep15 (to_rep15 x)) x) :pattern ((to_rep15 x)))))
(assert (forall ((x logentrycountt)) (! (in_range16 (to_rep15 x)) :pattern ((to_rep15 x)))))
(assert (forall ((x Int)) (! (=> (in_range16 x) (= (to_rep15 (of_rep15 x)) x)) :pattern ((to_rep15 (of_rep15 x))))))
...
(define-fun in_range17 ((x Int)) Bool (and (<= 0 x) (<= x 17)))
...
(declare-fun user_eq26 (logfilecountt logfilecountt) Bool)
(declare-const dummy26 logfilecountt)
...
(define-fun to_rep16 ((x logfilecountt)) Int (logfilecounttqtint x))
(declare-fun of_rep16 (Int) logfilecountt)
(assert (forall ((x logfilecountt)) (! (= (of_rep16 (to_rep16 x)) x) :pattern ((to_rep16 x)))))
(assert (forall ((x logfilecountt)) (! (in_range17 (to_rep16 x)) :pattern ((to_rep16 x)))))
(assert (forall ((x Int)) (! (=> (in_range17 x) (= (to_rep16 (of_rep16 x)) x)) :pattern ((to_rep16 (of_rep16 x))))))
...
(define-fun bool_eq11 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep14 (select a temp___idx_175)) (to_rep14 (select b (+ (- b__first a__first) temp___idx_175))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq11 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep14 (select a temp___idx_175)) (to_rep14 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
(declare-const dummy27 (Array Int logfileindext))
(declare-const value__size10 Int)
(declare-fun object__size10 ((Array Int logfileindext)) Int)
(declare-const value__component__size1 Int)
(declare-fun object__component__size1 ((Array Int logfileindext)) Int)
(declare-const value__alignment10 Int)
(declare-fun object__alignment10 ((Array Int logfileindext)) Int)
(assert (<= 0 value__size10))
(assert (forall ((a (Array Int logfileindext))) (<= 0 (object__size10 a))))
(assert (<= 0 value__component__size1))
(assert (forall ((a (Array Int logfileindext))) (<= 0 (object__component__size1 a))))
(assert (<= 0 value__alignment10))
(assert (forall ((a (Array Int logfileindext))) (<= 0 (object__alignment10 a))))
(declare-fun user_eq27 ((Array Int logfileindext) (Array Int logfileindext)) Bool)
...
(define-fun bool_eq12 ((a us_rep9) (b us_rep9)) Bool (ite (and (and (and (= (bool_eq11 (rec__auditlog__logfilelistt__list (us_split_fields19 a)) 1 17 (rec__auditlog__logfilelistt__list (us_split_fields19 b)) 1 17) true) (= (to_rep14 (rec__auditlog__logfilelistt__head (us_split_fields19 a))) (to_rep14 (rec__auditlog__logfilelistt__head (us_split_fields19 b))))) (= (to_rep14 (rec__auditlog__logfilelistt__lasti (us_split_fields19 a))) (to_rep14 (rec__auditlog__logfilelistt__lasti (us_split_fields19 b))))) (= (to_rep16 (rec__auditlog__logfilelistt__length (us_split_fields19 a))) (to_rep16 (rec__auditlog__logfilelistt__length (us_split_fields19 b))))) true false))
...
(declare-fun user_eq28 (us_rep9 us_rep9) Bool)
(declare-const dummy28 us_rep9)
...
(define-fun in_range18 ((x Int)) Bool (and (<= 0 x) (<= x 1024)))
...
(declare-fun user_eq29 (fileentrycountt fileentrycountt) Bool)
(declare-const dummy29 fileentrycountt)
...
(define-fun to_rep17 ((x fileentrycountt)) Int (fileentrycounttqtint x))
(declare-fun of_rep17 (Int) fileentrycountt)
(assert (forall ((x fileentrycountt)) (! (= (of_rep17 (to_rep17 x)) x) :pattern ((to_rep17 x)))))
(assert (forall ((x fileentrycountt)) (! (in_range18 (to_rep17 x)) :pattern ((to_rep17 x)))))
(assert (forall ((x Int)) (! (=> (in_range18 x) (= (to_rep17 (of_rep17 x)) x)) :pattern ((to_rep17 (of_rep17 x))))))
...
(define-fun bool_eq13 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep17 (select a temp___idx_176)) (to_rep17 (select b (+ (- b__first a__first) temp___idx_176))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq13 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep17 (select a temp___idx_176)) (to_rep17 (select b (+ (- b__first a__first) temp___idx_176)))))))))))
(declare-const dummy30 (Array Int fileentrycountt))
(declare-const value__size12 Int)
(declare-fun object__size12 ((Array Int fileentrycountt)) Int)
(declare-const value__component__size2 Int)
(declare-fun object__component__size2 ((Array Int fileentrycountt)) Int)
(declare-const value__alignment12 Int)
(declare-fun object__alignment12 ((Array Int fileentrycountt)) Int)
(assert (<= 0 value__size12))
(assert (forall ((a (Array Int fileentrycountt))) (<= 0 (object__size12 a))))
(assert (<= 0 value__component__size2))
(assert (forall ((a (Array Int fileentrycountt))) (<= 0 (object__component__size2 a))))
(assert (<= 0 value__alignment12))
(assert (forall ((a (Array Int fileentrycountt))) (<= 0 (object__alignment12 a))))
(declare-fun user_eq30 ((Array Int fileentrycountt) (Array Int fileentrycountt)) Bool)
...
(define-fun bool_eq14 ((a us_rep10) (b us_rep10)) Bool (ite (and (and (and (= (to_rep14 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields21 a))) (to_rep14 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields21 b)))) (= (to_rep15 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields21 a))) (to_rep15 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields21 b))))) (= (bool_eq12 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields21 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields21 b))) true)) (= (bool_eq13 (rec__auditlog__logfilestatet__logfileentries (us_split_fields21 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields21 b)) 1 17) true)) true false))
...
(declare-fun user_eq31 (us_rep10 us_rep10) Bool)
(declare-const dummy31 us_rep10)
...
(declare-fun bool_eq15 (us_rep11 us_rep11) Bool)
...
(declare-fun user_eq32 (us_rep11 us_rep11) Bool)
(declare-const dummy32 us_rep11)
...
(assert (forall ((a (Array Int us_rep11))) (forall ((first Int)) (! (= (slide4 a first first) a) :pattern ((slide4 a first first))))))
...
(define-fun bool_eq16 ((a (Array Int us_rep11)) (a__first Int) (a__last Int) (b (Array Int us_rep11)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_177 Int)) (=> (and (<= a__first temp___idx_177) (<= temp___idx_177 a__last)) (= (bool_eq15 (select a temp___idx_177) (select b (+ (- b__first a__first) temp___idx_177))) true)))) true false))
(assert (forall ((a (Array Int us_rep11)) (b (Array Int us_rep11))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq16 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_177 Int)) (=> (and (<= a__first temp___idx_177) (<= temp___idx_177 a__last)) (= (bool_eq15 (select a temp___idx_177) (select b (+ (- b__first a__first) temp___idx_177))) true))))))))
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-sort statust 0)
(define-fun in_range19 ((x Int)) Bool (and (<= 0 x) (<= x 1)))
...
(define-fun dynamic_invariant1 ((temp___expr_593 Int) (temp___is_init_589 Bool) (temp___skip_constant_590 Bool) (temp___do_toplevel_591 Bool) (temp___do_typ_inv_592 Bool)) Bool (=> (or (= temp___is_init_589 true) (<= 0 1)) (in_range19 temp___expr_593)))
...
(define-fun dynamic_invariant2 ((temp___expr_1330 us_rep10) (temp___is_init_1326 Bool) (temp___skip_constant_1327 Bool) (temp___do_toplevel_1328 Bool) (temp___do_typ_inv_1329 Bool)) Bool (=> (= temp___do_typ_inv_1329 true) (= (valid_numberlogentries (to_rep14 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields21 temp___expr_1330))) (to_rep15 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields21 temp___expr_1330))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields21 temp___expr_1330)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields21 temp___expr_1330))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1334 us_rep10) (temp___skip_top_level_1335 Bool)) Bool (and (and (and (= (to_rep14 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields21 temp___expr_1334))) 1) (= (to_rep15 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields21 temp___expr_1334))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields21 temp___expr_1334)) (mk___rep9 (mk___split_fields9 (temp_____aggregate_def_1336 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields21 temp___expr_1334)) (temp_____aggregate_def_1340 0))))
(define-fun type_invariant ((temp___1344 us_rep10)) Bool (= (valid_numberlogentries (to_rep14 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields21 temp___1344))) (to_rep15 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields21 temp___1344))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields21 temp___1344)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields21 temp___1344))) true))
(declare-fun thetokenpresence (us_private) Int)
(declare-fun thetokenpresence__function_guard (Int us_private) Bool)
...
(declare-fun user_eq34 (presencet presencet) Bool)
(declare-const dummy34 presencet)
...
(define-fun dynamic_invariant3 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 1)) (in_range20 temp___expr_221)))
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(define-fun dynamic_invariant4 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range6 temp___expr_74)))
(define-fun dynamic_invariant5 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 40)) (in_range5 temp___expr_402)))
(define-fun dynamic_invariant6 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 4294967295)) (in_range7 temp___expr_426)))
(define-fun dynamic_invariant7 ((temp___expr_450 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool) (temp___do_typ_inv_449 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 0 10)) (in_range10 temp___expr_450)))
(define-fun dynamic_invariant8 ((temp___expr_464 Int) (temp___is_init_460 Bool) (temp___skip_constant_461 Bool) (temp___do_toplevel_462 Bool) (temp___do_typ_inv_463 Bool)) Bool (=> (or (= temp___is_init_460 true) (<= 0 4294967295)) (in_range12 temp___expr_464)))
(define-fun dynamic_invariant9 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 0 128)) (in_range13 temp___expr_471)))
(define-fun dynamic_invariant10 ((temp___expr_1268 Int) (temp___is_init_1264 Bool) (temp___skip_constant_1265 Bool) (temp___do_toplevel_1266 Bool) (temp___do_typ_inv_1267 Bool)) Bool (=> (or (= temp___is_init_1264 true) (<= 0 17)) (in_range17 temp___expr_1268)))
(define-fun dynamic_invariant11 ((temp___expr_1275 Int) (temp___is_init_1271 Bool) (temp___skip_constant_1272 Bool) (temp___do_toplevel_1273 Bool) (temp___do_typ_inv_1274 Bool)) Bool (=> (or (= temp___is_init_1271 true) (<= 1 17)) (in_range15 temp___expr_1275)))
(define-fun dynamic_invariant12 ((temp___expr_1401 Int) (temp___is_init_1397 Bool) (temp___skip_constant_1398 Bool) (temp___do_toplevel_1399 Bool) (temp___do_typ_inv_1400 Bool)) Bool (=> (or (= temp___is_init_1397 true) (<= 0 2)) (in_range14 temp___expr_1401)))
(define-fun dynamic_invariant13 ((temp___expr_1282 Int) (temp___is_init_1278 Bool) (temp___skip_constant_1279 Bool) (temp___do_toplevel_1280 Bool) (temp___do_typ_inv_1281 Bool)) Bool (=> (or (= temp___is_init_1278 true) (<= 0 17408)) (in_range16 temp___expr_1282)))
(define-fun dynamic_invariant14 ((temp___expr_1313 Int) (temp___is_init_1309 Bool) (temp___skip_constant_1310 Bool) (temp___do_toplevel_1311 Bool) (temp___do_typ_inv_1312 Bool)) Bool (=> (or (= temp___is_init_1309 true) (<= 0 1024)) (in_range18 temp___expr_1313)))
(assert true)
(assert (forall ((currentlogfile Int) (numberlogentries Int)) (forall ((usedlogfiles us_rep9)) (forall ((logfileentries (Array Int fileentrycountt))) (! (= (= (valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries) true) (and (<= 1 (to_rep16 (rec__auditlog__logfilelistt__length (us_split_fields19 usedlogfiles)))) (= numberlogentries (+ (* (- (to_rep16 (rec__auditlog__logfilelistt__length (us_split_fields19 usedlogfiles))) 1) 1024) (to_rep17 (select logfileentries currentlogfile)))))) :pattern ((valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries)))))))
...
(define-fun dynamic_invariant15 ((temp___expr_670 Int) (temp___is_init_666 Bool) (temp___skip_constant_667 Bool) (temp___do_toplevel_668 Bool) (temp___do_typ_inv_669 Bool)) Bool (=> (or (= temp___is_init_666 true) (<= 1901 2099)) (in_range1 temp___expr_670)))
(define-fun dynamic_invariant16 ((temp___expr_677 Int) (temp___is_init_673 Bool) (temp___skip_constant_674 Bool) (temp___do_toplevel_675 Bool) (temp___do_typ_inv_676 Bool)) Bool (=> (or (= temp___is_init_673 true) (<= 1 12)) (in_range2 temp___expr_677)))
(define-fun dynamic_invariant17 ((temp___expr_684 Int) (temp___is_init_680 Bool) (temp___skip_constant_681 Bool) (temp___do_toplevel_682 Bool) (temp___do_typ_inv_683 Bool)) Bool (=> (or (= temp___is_init_680 true) (<= 1 31)) (in_range3 temp___expr_684)))
(define-fun dynamic_invariant18 ((temp___expr_716 Int) (temp___is_init_712 Bool) (temp___skip_constant_713 Bool) (temp___do_toplevel_714 Bool) (temp___do_typ_inv_715 Bool)) Bool (=> (or (= temp___is_init_712 true) (<= 0 86399999)) (in_range4 temp___expr_716)))
(define-fun dynamic_invariant19 ((temp___expr_1227 Int) (temp___is_init_1223 Bool) (temp___skip_constant_1224 Bool) (temp___do_toplevel_1225 Bool) (temp___do_typ_inv_1226 Bool)) Bool (=> (or (= temp___is_init_1223 true) (<= 0 5)) (in_range9 temp___expr_1227)))
(define-fun dynamic_invariant20 ((temp___expr_553 Int) (temp___is_init_549 Bool) (temp___skip_constant_550 Bool) (temp___do_toplevel_551 Bool) (temp___do_typ_inv_552 Bool)) Bool (=> (or (= temp___is_init_549 true) (<= 0 4294967295)) (in_range8 temp___expr_553)))
