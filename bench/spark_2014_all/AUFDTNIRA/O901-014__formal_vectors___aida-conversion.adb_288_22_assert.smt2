...
(assert (= (integerqtint rliteral6) 6))
(declare-const rliteral7 integer)
(assert (= (integerqtint rliteral7) 9))
(assert (forall ((temp___1302 Int) (temp___1303 Int) (temp___1304 Int) (temp___1305 Int) (temp___1306 Int) (temp___1307 Int) (temp___1308 Int) (temp___1309 Int) (temp___1310 Int) (temp___1311 Int) (temp___1312 Int) (temp___1313 Int)) (let ((temp___1301 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__aggregate_def temp___1302 temp___1303 temp___1304 temp___1305 temp___1306 temp___1307 temp___1308 temp___1309 temp___1310 temp___1311 temp___1312 temp___1313))) (=> (and (and (and (and (and (and (and (and (and (dynamic_invariant temp___1302 true true true true) (dynamic_invariant temp___1303 true true true true)) (dynamic_invariant temp___1304 true true true true)) (dynamic_invariant temp___1305 true true true true)) (dynamic_invariant temp___1306 true true true true)) (dynamic_invariant temp___1307 true true true true)) (dynamic_invariant temp___1308 true true true true)) (dynamic_invariant temp___1309 true true true true)) (dynamic_invariant temp___1310 true true true true)) (dynamic_invariant temp___1311 true true true true)) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1312 temp___1313) (and (= (first5 temp___1301) temp___1312) (= (last5 temp___1301) temp___1313))) (and (and (and (and (and (and (and (and (and (= (select (to_array2 temp___1301) (+ (first1 source) 0)) rliteral) (= (select (to_array2 temp___1301) (+ (first1 source) 1)) rliteral1)) (= (select (to_array2 temp___1301) (+ (first1 source) 2)) rliteral2)) (= (select (to_array2 temp___1301) (+ (first1 source) 3)) rliteral3)) (= (select (to_array2 temp___1301) (+ (first1 source) 4)) rliteral2)) (= (select (to_array2 temp___1301) (+ (first1 source) 5)) rliteral4)) (= (select (to_array2 temp___1301) (+ (first1 source) 6)) rliteral5)) (= (select (to_array2 temp___1301) (+ (first1 source) 7)) rliteral6)) (= (select (to_array2 temp___1301) (+ (first1 source) 8)) rliteral5)) (= (select (to_array2 temp___1301) (+ (first1 source) 9)) rliteral7)))))))
(define-fun dynamic_invariant4 ((temp___expr_214 us_t3) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (not (= temp___skip_constant_211 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_214) (last7 temp___expr_214)) (and (= (first7 temp___expr_214) (first1 source)) (= (last7 temp___expr_214) (+ (first1 source) 9))))))
(declare-sort t6 0)
...
(assert (forall ((temp___1319 Int) (temp___1320 Int) (temp___1321 Int)) (let ((temp___1318 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__aggregate_def temp___1319 temp___1320 temp___1321))) (=> (dynamic_invariant temp___1319 true true true true) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1320 temp___1321) (and (= (first9 temp___1318) temp___1320) (= (last9 temp___1318) temp___1321))) (forall ((temp___1322 Int)) (= (select (to_array4 temp___1318) temp___1322) rliteral8)))))))
...
(declare-const temp___1316 (Array Int integer))
(declare-const temp___13161 t2)
...
(declare-const temp___1324 (Array Int integer))
(declare-const temp___13241 t4)
...
(declare-const temp___1327 Int)
(declare-const temp___1330 (Array Int integer))
...
(assert (and (and (= (length source) 10) (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 56)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 51)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 54)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 8))) 52))) (forall ((index7 Int)) (=> (and (<= (to_rep1 (first (rt source))) index7) (<= index7 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index7))) true)))))
...
(assert (= (mk___t2 temp___1316 temp___13161) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__aggregate_def 2 1 4 7 4 8 3 6 3 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___13161)) (to_rep1 (last4 temp___13161))) (+ (- (to_rep1 (last4 temp___13161)) (to_rep1 (first4 temp___13161))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1316 (to_rep1 (first4 temp___13161)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__assume))
...
(assert (= (mk___t4 temp___1324 temp___13241) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___13241)) (to_rep1 (last8 temp___13241))) (+ (- (to_rep1 (last8 temp___13241)) (to_rep1 (first8 temp___13241))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1324 (to_rep1 (first8 temp___13241)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__assume))
...
(assert (and (= temp___1327 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= temp___1330 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= temp___1328 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= o index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= o1 (select n1 o))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= o3 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= o5 (to_rep o4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= o7 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= n1 result3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= n2 o8)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (forall ((i Int)) (=> (and (<= (to_rep1 (first (rt source))) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt source))) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index2)) (forall ((temp___1331 Int)) (=> (and (<= (to_rep1 n__first) temp___1331) (<= temp___1331 (to_rep1 n__last))) (=> (or (< temp___1327 temp___1331) (or (< temp___1331 (to_rep1 (first (rt source)))) (< index2 temp___1331))) (= (select n3 temp___1331) (select temp___1330 temp___1331)))))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= index2 temp___1327)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= index2 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= n3 n4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= index4 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= n5 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= index6 index4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327)) (= n7 n5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327))) (= index6 index1)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1327))) (= n7 n1)))
...
(assert (and (= temp___1332 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1332) (<= temp___1332 (to_rep1 n__last))))
(assert (= o9 temp___1332))
(assert (= o10 (select (map__content1 n6) o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= result4 (mk_int__ref target)))
(assert (= target1 o11))
(assert (<= target1 9))
(assert (and (= temp___1333 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1333) (<= temp___1333 (to_rep1 n__last))))
(assert (= o12 temp___1333))
