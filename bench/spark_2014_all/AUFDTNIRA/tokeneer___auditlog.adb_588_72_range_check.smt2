...
(assert (=> (< (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024) (= o10 (ite (= (to_rep3 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields22)) (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields22))))) (+ (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1)) (ite (= (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22))))) (to_rep2 logfilestate__split_fields5)) true false) false))))
(assert (=> (not (< (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024)) (= o10 (distinct 1 0))))
(assert (=> (= (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024) (= o9 (ite (= (to_rep3 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields22)) (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields22))))) 1) (ite (= (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22))))) (+ (to_rep2 logfilestate__split_fields5) 1)) true false) false))))
(assert (=> (not (= (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024)) (= o9 (distinct 1 0))))
(assert (not (in_range2 (- (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22))))) 1))))
(check-sat)
(exit)
