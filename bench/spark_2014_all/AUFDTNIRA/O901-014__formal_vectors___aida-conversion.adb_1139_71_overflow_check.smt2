...
(assert (= (= (length source) 7) true))
(assert (and (= temp___1898 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1898) (<= temp___1898 (to_rep1 (last (rt source))))))
(assert (= o39 temp___1898))
...
(assert (and (= temp___1897 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1897) (<= temp___1897 (to_rep1 (last (rt source))))))
(assert (= o33 temp___1897))
...
(assert (and (= temp___1896 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1896) (<= temp___1896 (to_rep1 (last (rt source))))))
(assert (= o27 temp___1896))
(assert (= o28 (select (elts source) o27)))
(assert (= o29 (to_rep o28)))
(assert (and (= o30 (convert_character_digit_to_integer o29)) (and (in_range1 o30) (and (and (<= 0 o30) (<= o30 9)) (ite (= (= o29 48) true) (= o30 0) (ite (= (= o29 49) true) (= o30 1) (ite (= (= o29 50) true) (= o30 2) (ite (= (= o29 51) true) (= o30 3) (ite (= (= o29 52) true) (= o30 4) (ite (= (= o29 53) true) (= o30 5) (ite (= (= o29 54) true) (= o30 6) (ite (= (= o29 55) true) (= o30 7) (ite (= (= o29 56) true) (= o30 8) (=> (= (= o29 57) true) (= o30 9)))))))))))))))
(assert (= o31 (* o30 100)))
(assert (and (= o32 o31) (in_range1 o31)))
(assert (and (= temp___1895 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1895) (<= temp___1895 (to_rep1 (last (rt source))))))
(assert (= o21 temp___1895))
...
(assert (and (= temp___1894 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1894) (<= temp___1894 (to_rep1 (last (rt source))))))
(assert (= o13 temp___1894))
...
(assert (= o17 (* o16 10000)))
(assert (and (= o18 o17) (in_range1 o17)))
(assert (and (= temp___1893 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1893) (<= temp___1893 (to_rep1 (last (rt source))))))
(assert (= o5 temp___1893))
...
(assert (and (= temp___1892 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1892) (<= temp___1892 (to_rep1 (last (rt source))))))
(assert (= o temp___1892))
