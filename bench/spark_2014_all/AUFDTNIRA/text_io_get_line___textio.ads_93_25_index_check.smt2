...
(assert (and (and (forall ((idx1 Int)) (=> (and (<= 1 idx1) (<= idx1 num1)) (= (to_rep (select o idx1)) (to_rep (select the_file1 (+ (- idx1 1) cur_position_at_start)))))) (and (= cur_position1 (+ cur_position_at_start num1)) (or (= (to_rep (select the_file1 cur_position1)) eof_ch) (= (to_rep (select the_file1 cur_position1)) 10)))) (and (in_range4 num1) (in_range2 cur_position1))))
(assert (= num1 num2))
(assert (= o result__))
...
(assert (<= 1 idx))
(assert (<= idx num2))
(assert (not (<= idx (to_rep1 result____last))))
(check-sat)
(exit)
