...
(assert (and (and (= (length source) 10) (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 56)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 51)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 54)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 8))) 52))) (forall ((index9 Int)) (=> (and (<= (to_rep1 (first (rt source))) index9) (<= index9 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index9))) true)))))
...
(assert (= target2 o18))
(assert (<= target2 39))
(assert (and (= o19 (+ target2 2147483600)) (in_range1 (+ target2 2147483600))))
(assert (= result6 (mk_int__ref target2)))
(assert (= target3 o19))
(assert (<= target3 2147483639))
