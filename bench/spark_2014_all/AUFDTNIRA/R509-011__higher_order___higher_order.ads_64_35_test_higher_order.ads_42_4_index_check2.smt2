...
(declare-const o Int)
(declare-const temp___407 (Array Int element_2))
(declare-const temp___4071 t1)
...
(define-fun temp___4072 () us_t1 (mk___t1 temp___407 temp___4071))
...
(assert (and (= temp___4072 (acc_f a init)) (and (dynamic_invariant5 temp___4072 true false true true) (and (= (to_rep (first2 temp___4071)) (to_rep (first4 (rt2 a)))) (and (= (to_rep (last2 temp___4071)) (to_rep (last4 (rt2 a)))) (forall ((i13 Int)) (=> (and (<= (to_rep (first4 (rt2 a))) i13) (<= i13 (to_rep (last4 (rt2 a))))) (and (= (in_range4 (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))))) (to_rep2 (select temp___407 i13)) (+ (- i13 (to_rep (first4 (rt2 a)))) 1)) true) (= (to_rep2 (select temp___407 i13)) (+ (to_rep1 (select (elts2 a) i13)) (ite (= i13 (to_rep (first4 (rt2 a)))) init (to_rep2 (select temp___407 (- i13 1))))))))))))))
(assert (not (<= (to_rep (first2 temp___4071)) (to_rep (last4 (rt2 a))))))
(check-sat)
(exit)
