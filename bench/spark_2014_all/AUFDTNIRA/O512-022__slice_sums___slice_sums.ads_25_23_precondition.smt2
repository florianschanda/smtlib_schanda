...
(assert (=> (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo (us_split_fields1 (slice_bounds__content slice_sums__maximal_sum_slice_bounds_2__result5))))) (= result14 (ite (<= (extended_indexqtint (rec__sums__slice_bounds__hi (us_split_fields1 (slice_bounds__content slice_sums__maximal_sum_slice_bounds_2__result5)))) (to_rep (last (rt x)))) true false))))
(assert (=> (not (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo (us_split_fields1 (slice_bounds__content slice_sums__maximal_sum_slice_bounds_2__result5)))))) (= result14 false)))
(assert (=> (= result14 true) (= (= result13 true) (forall ((lo Int)) (=> (and (<= (to_rep (first (rt x))) lo) (<= lo (to_rep (last (rt x))))) (forall ((hi Int)) (=> (and (<= (to_rep (first (rt x))) hi) (<= hi (to_rep (last (rt x))))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo) (of_rep1 hi)))) (sum__logic x (slice_bounds__content slice_sums__maximal_sum_slice_bounds_2__result5))))))))))
(assert (=> (not (= result14 true)) (= result13 false)))
(assert (= result13 true))
(assert (not (or (< (extended_indexqtint (rec__sums__slice_bounds__hi (us_split_fields1 (slice_bounds__content slice_sums__maximal_sum_slice_bounds_2__result5)))) (indexqtint (rec__sums__slice_bounds__lo (us_split_fields1 (slice_bounds__content slice_sums__maximal_sum_slice_bounds_2__result5))))) (and (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo (us_split_fields1 (slice_bounds__content slice_sums__maximal_sum_slice_bounds_2__result5))))) (<= (extended_indexqtint (rec__sums__slice_bounds__hi (us_split_fields1 (slice_bounds__content slice_sums__maximal_sum_slice_bounds_2__result5)))) (to_rep (last (rt x))))))))
(check-sat)
(exit)
