...
(assert (and (= o6 (+ archivedfilecount2 1)) (in_range7 (+ archivedfilecount2 1))))
(assert (= result10 (mk_int__ref archivedfilecount2)))
(assert (= archivedfilecount3 o6))
(assert (and (= o7 (nextlistindex fileindexinusedlist2)) (and (in_range5 o7) (= o7 (ite (= fileindexinusedlist2 17) 1 (+ fileindexinusedlist2 1))))))
(assert (= result11 (mk_int__ref fileindexinusedlist2)))
(assert (= fileindexinusedlist3 o7))
(assert (< archivedfilecount3 4))
(assert (< archivedfilecount3 (to_rep5 logfilestate__split_fields5)))
