...
(assert (forall ((i t16b)) (and (<= 2 (t16bqtint i)) (<= (t16bqtint i) 30))))
...
(assert (= a2 result3))
(assert (= a3 o2))
(assert (and (and (and (= (to_rep (select a4 0)) 0) (= (to_rep (select a4 1)) 1)) (forall ((j1 Int)) (=> (and (<= 2 j1) (<= j1 i2)) (= (to_rep (select a4 j1)) (+ (to_rep (select a4 (- j1 1))) (to_rep (select a4 (- j1 2)))))))) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 i2)) (and (<= 0 (to_rep (select a4 j1))) (< (to_rep (select a4 j1)) (power 2 j1)))))))
(assert (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___190 Int)) (=> (and (<= 0 temp___190) (<= temp___190 30)) (=> (or (< 30 temp___190) (or (< temp___190 2) (< i2 temp___190))) (= (select a4 temp___190) (select a2 temp___190)))))) (and (<= 2 i2) (<= i2 30))))
(assert (= (= o6 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 i2)) (and (<= 0 (to_rep (select a4 j1))) (< (to_rep (select a4 j1)) (power 2 j1)))))))
(assert (<= 2 j))
(assert (<= j i2))
