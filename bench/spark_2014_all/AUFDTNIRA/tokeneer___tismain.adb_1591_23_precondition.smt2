...
(assert (=> (= result1 true) (and (= o25 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o25 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result1 true) (= o26 (ite (not (= o25 true)) true false))))
(assert (=> (= result1 true) (and (= o24 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o24 true) (in_range4 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result1 true) (= o27 (ite (not (= o24 true)) true false))))
(assert (=> (= result1 true) (= o28 (ite (= o27 true) o26 false))))
(assert (=> (not (= result1 true)) (= o28 (distinct 1 0))))
(assert (and (= result2 (statusisshutdown status3 (let ((subject state7)) state23))) (= (= result2 true) (= status3 8))))
(assert (=> (= result2 true) (and (= o20 (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (and (in_range1 o20) (= o20 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result2 true) (= o21 (ite (= o20 0) true false))))
(assert (=> (= result2 true) (and (= o19 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o19 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result2 true) (= o22 (ite (not (= o19 true)) true false))))
(assert (=> (= result2 true) (= o23 (ite (= o22 true) o21 false))))
(assert (=> (not (= result2 true)) (= o23 (distinct 1 0))))
(assert (and (= result3 (statusisenclavequiescent status3 (let ((subject state7)) state23))) (= (= result3 true) (= status3 3))))
(assert (=> (= result3 true) (and (= o17 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o17 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result3 true) (= o18 (ite (not (= o17 true)) true false))))
(assert (=> (not (= result3 true)) (= o18 (distinct 1 0))))
(assert (and (= o12 (statusiswaitingfinishadminop status3 (let ((subject state7)) state23))) (= (= o12 true) (= status3 7))))
(assert (and (= o13 (statusiswaitingstartadminop status3 (let ((subject state7)) state23))) (= (= o13 true) (= status3 6))))
(assert (= result4 (ite (= o13 false) o12 true)))
(assert (=> (= result4 true) (and (= o14 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o14 true) (in_range4 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result4 true) (and (= o15 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o15 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result4 true) (= o16 (ite (= o15 true) o14 false))))
(assert (=> (not (= result4 true)) (= o16 (distinct 1 0))))
(assert (and (= o8 (statusiswaitingremoveadmintokenfail status3 (let ((subject state7)) state23))) (= (= o8 true) (= status3 4))))
(assert (and (= o9 (statusisgotadmintoken status3 (let ((subject state7)) state23))) (= (= o9 true) (= status3 5))))
(assert (= result5 (ite (= o9 false) o8 true)))
(assert (=> (= result5 true) (and (= o10 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o10 true) (in_range4 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result5 true) (= o11 (ite (not (= o10 true)) true false))))
(assert (=> (not (= result5 true)) (= o11 (distinct 1 0))))
...
(assert (=> (= result7 true) (and (= o6 (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (in_range3 o6))))
(assert (=> (= result7 true) (= result6 (ite (= o6 4) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (=> (= result6 true) (and (= o7 (statusiswaitingstartadminop status3 (let ((subject state7)) state23))) (= (= o7 true) (= status3 6)))))
(assert (=> (not (= result6 true)) (= o7 (distinct 1 0))))
(assert (and (= o3 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o3 true) (in_range4 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields5)))))))
(assert (= result8 (ite (not (= o3 true)) true false)))
(assert (=> (= result8 true) (and (= o4 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o4 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
...
(assert (= result9 true))
(assert (and (= o1 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o1 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields5)))))))
(assert (= o2 (ite (not (= o1 true)) true false)))
(assert (and (= result10 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= result10 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields5)))))))
