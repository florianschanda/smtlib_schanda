...
(assert (=> (=> (not (= space3 4)) (=> (not (= space3 2)) (= space3 1))) (and (= o1 (* (* (div1 4 space3) 8) 1000000)) (in_range3 (* (* (div1 4 space3) 8) 1000000)))))
(assert (=> (=> (not (= space3 4)) (=> (not (= space3 2)) (= space3 1))) (and (= result3 (all_elements_in a2 o1)) (= (= result3 true) (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 7)) (and (<= (- o1) (to_rep (select a2 k1))) (<= (to_rep (select a2 k1)) o1))))))))
