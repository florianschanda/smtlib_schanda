...
(assert (not (= (bool_eq1 (mk___rep1 c__split_fields4) no_element) true)))
(assert (and (= o4 (positions x)) (and (not (= (has_key o4 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o4 i) true) (and (and (<= 1 (get o4 i)) (<= (get o4 i) (length x))) (forall ((j us_rep1)) (=> (= (has_key o4 j) true) (=> (= (get o4 i) (get o4 j)) (= (bool_eq1 i j) true))))))))))
(assert (not (= (has_key o4 (mk___rep1 c__split_fields4)) true)))
(check-sat)
(exit)
