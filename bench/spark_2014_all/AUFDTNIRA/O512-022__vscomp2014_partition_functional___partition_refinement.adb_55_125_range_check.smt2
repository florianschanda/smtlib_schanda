...
(assert (and (= o6 (capacity (mk___rep p__split_discrs (mk___split_fields p__split_fields)))) (and (in_range1 o6) (= o6 (ite (= (distinct 1 0) true) (to_rep (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o4 (length (mk___rep p__split_discrs (mk___split_fields p__split_fields)))) (and (in_range1 o4) (<= o4 (capacity (mk___rep p__split_discrs (mk___split_fields p__split_fields)))))))
(assert (= o5 (* 2 o4)))
(assert (and (= o7 o5) (in_range4 o5)))
(assert (= result (ite (<= o7 o6) true false)))
(assert (= result true))
(assert (and (= o3 (length (mk___rep p__split_discrs (mk___split_fields p__split_fields)))) (and (in_range1 o3) (<= o3 (capacity (mk___rep p__split_discrs (mk___split_fields p__split_fields)))))))
