...
(assert (and (= o3 (* space2 1000000)) (in_range3 (* space2 1000000))))
(assert (and (= o4 (all_elements_in a1 o3)) (= (= o4 true) (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 7)) (and (<= (- o3) (to_rep (select a1 k1))) (<= (to_rep (select a1 k1)) o3)))))))
(assert (= result1 (ite (and (= o4 true) (=> (not (= space2 1)) (=> (not (= space2 2)) (= space2 4)))) true false)))
(assert (= result1 true))
(assert (<= 0 k))
(assert (<= k 7))
