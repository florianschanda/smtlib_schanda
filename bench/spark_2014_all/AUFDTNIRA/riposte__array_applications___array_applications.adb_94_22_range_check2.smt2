...
(assert (forall ((i t26b)) (and (<= 2 (t26bqtint i)) (<= (t26bqtint i) 30))))
...
(assert (= a2 result3))
(assert (= a3 o2))
(assert (and (and (and (= (to_rep (select a4 0)) 0) (= (to_rep (select a4 1)) 1)) (forall ((j Int)) (=> (and (<= 2 j) (<= j i2)) (= (to_rep (select a4 j)) (+ (to_rep (select a4 (- j 1))) (to_rep (select a4 (- j 2)))))))) (forall ((j Int)) (=> (and (<= 0 j) (<= j i2)) (and (<= 0 (to_rep (select a4 j))) (< (to_rep (select a4 j)) (power 2 j)))))))
(assert (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___200 Int)) (=> (and (<= 0 temp___200) (<= temp___200 30)) (=> (or (< 30 temp___200) (or (< temp___200 2) (< i2 temp___200))) (= (select a4 temp___200) (select a2 temp___200)))))) (and (<= 2 i2) (<= i2 30))))
(assert (= (= o3 true) (forall ((j Int)) (=> (and (<= 0 j) (<= j i2)) (and (<= 0 (to_rep (select a4 j))) (< (to_rep (select a4 j)) (power 2 j)))))))
(assert (<= 2 i2))
(assert (not (<= 0 2)))
(check-sat)
(exit)
