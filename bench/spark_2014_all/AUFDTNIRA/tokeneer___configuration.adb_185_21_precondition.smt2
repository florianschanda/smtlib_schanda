...
(define-fun dynamic_invariant ((temp___expr_454 Int) (temp___is_init_450 Bool) (temp___skip_constant_451 Bool) (temp___do_toplevel_452 Bool) (temp___do_typ_inv_453 Bool)) Bool (=> (or (= temp___is_init_450 true) (<= 0 4194304)) (in_range3 temp___expr_454)))
...
(define-fun dynamic_invariant1 ((temp___expr_507 Int) (temp___is_init_503 Bool) (temp___skip_constant_504 Bool) (temp___do_toplevel_505 Bool) (temp___do_typ_inv_506 Bool)) Bool (=> (or (= temp___is_init_503 true) (<= 0 864000)) (in_range4 temp___expr_507)))
(declare-sort fart 0)
...
(define-fun dynamic_invariant2 ((temp___expr_1046 Int) (temp___is_init_1042 Bool) (temp___skip_constant_1043 Bool) (temp___do_toplevel_1044 Bool) (temp___do_typ_inv_1045 Bool)) Bool (=> (or (= temp___is_init_1042 true) (<= 0 2147483647)) (in_range5 temp___expr_1046)))
...
(define-fun dynamic_invariant3 ((temp___expr_1136 Int) (temp___is_init_1132 Bool) (temp___skip_constant_1133 Bool) (temp___do_toplevel_1134 Bool) (temp___do_typ_inv_1135 Bool)) Bool (=> (or (= temp___is_init_1132 true) (<= 0 5)) (in_range6 temp___expr_1136)))
...
(define-fun in_range7 ((x Int)) Bool (and (<= 0 x) (<= x 2000)))
...
(define-fun dynamic_invariant4 ((temp___expr_1155 Int) (temp___is_init_1151 Bool) (temp___skip_constant_1152 Bool) (temp___do_toplevel_1153 Bool) (temp___do_typ_inv_1154 Bool)) Bool (=> (or (= temp___is_init_1151 true) (<= 0 2000)) (in_range7 temp___expr_1155)))
...
(define-fun dynamic_invariant5 ((temp___expr_1166 Int) (temp___is_init_1162 Bool) (temp___skip_constant_1163 Bool) (temp___do_toplevel_1164 Bool) (temp___do_typ_inv_1165 Bool)) Bool (=> (or (= temp___is_init_1162 true) (<= 0 1)) (in_range8 temp___expr_1166)))
...
(declare-fun user_eq11 (filestatust filestatust) Bool)
(declare-const dummy11 filestatust)
...
(assert (forall ((x filestatust)) (! (in_range9 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x logfileindext)) (! (in_range10 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x logentrycountt)) (! (in_range11 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x logfilecountt)) (! (in_range12 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((x fileentrycountt)) (! (in_range13 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((a (Array Int us_rep))) (forall ((first2 Int)) (! (= (slide4 a first2 first2) a) :pattern ((slide4 a first2 first2))))))
...
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq2 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true))))))))
...
(define-fun dynamic_invariant6 ((temp___expr_674 Int) (temp___is_init_670 Bool) (temp___skip_constant_671 Bool) (temp___do_toplevel_672 Bool) (temp___do_typ_inv_673 Bool)) Bool (=> (or (= temp___is_init_670 true) (<= 0 1)) (in_range14 temp___expr_674)))
...
(declare-fun temp_____aggregate_def_1245 (Int) (Array Int logfileindext))
(declare-fun temp_____aggregate_def_1249 (Int) (Array Int fileentrycountt))
(define-fun dynamic_invariant7 ((temp___expr_1239 us_rep2) (temp___is_init_1235 Bool) (temp___skip_constant_1236 Bool) (temp___do_toplevel_1237 Bool) (temp___do_typ_inv_1238 Bool)) Bool (=> (= temp___do_typ_inv_1238 true) (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1239))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1239))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1239)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1239))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1243 us_rep2) (temp___skip_top_level_1244 Bool)) Bool (and (and (and (= (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1243))) 1) (= (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1243))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1243)) (mk___rep (mk___split_fields (temp_____aggregate_def_1245 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1243)) (temp_____aggregate_def_1249 0))))
(define-fun type_invariant ((temp___1253 us_rep2)) Bool (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1253))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1253))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1253)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1253))) true))
...
(assert (forall ((x yearst)) (! (in_range15 (to_rep7 x)) :pattern ((to_rep7 x)))))
(assert (forall ((x Int)) (! (=> (in_range15 x) (= (to_rep7 (of_rep7 x)) x)) :pattern ((to_rep7 (of_rep7 x))))))
...
(assert (forall ((x monthst)) (! (in_range16 (to_rep8 x)) :pattern ((to_rep8 x)))))
(assert (forall ((x Int)) (! (=> (in_range16 x) (= (to_rep8 (of_rep8 x)) x)) :pattern ((to_rep8 (of_rep8 x))))))
...
(assert (forall ((x dayst)) (! (in_range17 (to_rep9 x)) :pattern ((to_rep9 x)))))
(assert (forall ((x Int)) (! (=> (in_range17 x) (= (to_rep9 (of_rep9 x)) x)) :pattern ((to_rep9 (of_rep9 x))))))
...
(assert (forall ((x millisecst)) (! (in_range18 (to_rep10 x)) :pattern ((to_rep10 x)))))
(assert (forall ((x Int)) (! (=> (in_range18 x) (= (to_rep10 (of_rep10 x)) x)) :pattern ((to_rep10 (of_rep10 x))))))
...
(define-fun in_range19 ((x Int)) Bool (and (<= 0 x) (<= x 40)))
...
(declare-fun user_eq26 (namecountt namecountt) Bool)
(declare-const dummy26 namecountt)
...
(assert (forall ((x namecountt)) (! (in_range19 (to_rep11 x)) :pattern ((to_rep11 x)))))
(assert (forall ((x Int)) (! (=> (in_range19 x) (= (to_rep11 (of_rep11 x)) x)) :pattern ((to_rep11 (of_rep11 x))))))
(declare-const dummy27 (Array Int character))
...
(declare-fun user_eq27 ((Array Int character) (Array Int character)) Bool)
...
(declare-fun user_eq28 (issueridt issueridt) Bool)
(declare-const dummy28 issueridt)
...
(assert (forall ((x issueridt)) (! (in_range20 (to_rep12 x)) :pattern ((to_rep12 x)))))
(assert (forall ((x Int)) (! (=> (in_range20 x) (= (to_rep12 (of_rep12 x)) x)) :pattern ((to_rep12 (of_rep12 x))))))
...
(define-fun us_split_fields__ref___2__projection ((a us_split_fields__ref3)) us_split_fields6 (us_split_fields__content3 a))
(declare-datatypes () ((us_rep4 (mk___rep3 (us_split_fields7 us_split_fields6)))))
(define-fun us_rep___2__projection ((a us_rep4)) us_split_fields6 (us_split_fields7 a))
...
(declare-fun user_eq29 (us_rep4 us_rep4) Bool)
(declare-const dummy29 us_rep4)
...
(declare-fun user_eq30 (serialnumbert serialnumbert) Bool)
(declare-const dummy30 serialnumbert)
...
(assert (forall ((x serialnumbert)) (! (in_range21 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(declare-fun user_eq31 (us_rep5 us_rep5) Bool)
(declare-const dummy31 us_rep5)
...
(assert (forall ((x classt)) (! (in_range6 (to_rep14 x)) :pattern ((to_rep14 x)))))
(assert (forall ((x Int)) (! (=> (in_range6 x) (= (to_rep14 (of_rep14 x)) x)) :pattern ((to_rep14 (of_rep14 x))))))
...
(define-fun bool_eq12 ((a us_rep6) (b us_rep6)) Bool (ite (= (to_rep14 (rec__privtypes__clearancet__class (us_split_fields11 a))) (to_rep14 (rec__privtypes__clearancet__class (us_split_fields11 b)))) true false))
...
(declare-datatypes () ((clearancet__ref (mk_clearancet__ref (clearancet__content us_rep6)))))
(define-fun clearancet__ref___projection ((a clearancet__ref)) us_rep6 (clearancet__content a))
...
(define-fun in_range23 ((x Int)) Bool (and (<= 0 x) (<= x 3)))
...
(declare-fun to_rep16 (privileget) Int)
(declare-fun of_rep16 (Int) privileget)
(assert (forall ((x privileget)) (! (= (of_rep16 (to_rep16 x)) x) :pattern ((to_rep16 x)))))
(assert (forall ((x privileget)) (! (in_range23 (to_rep16 x)) :pattern ((to_rep16 x)))))
(assert (forall ((x Int)) (! (=> (in_range23 x) (= (to_rep16 (of_rep16 x)) x)) :pattern ((to_rep16 (of_rep16 x))))))
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__cert__attr__auth__contentst__id us_rep5) (rec__cert__attr__auth__contentst__notbefore us_rep3) (rec__cert__attr__auth__contentst__notafter us_rep3) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep5) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep6)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields12)) us_rep5 (rec__cert__attr__auth__contentst__id a))
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields12)) us_rep3 (rec__cert__attr__auth__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields12)) us_rep3 (rec__cert__attr__auth__contentst__notafter a))
...
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields12)) us_rep5 (rec__cert__attr__auth__contentst__basecertid a))
(define-fun us_split_fields_Role__projection ((a us_split_fields12)) privileget (rec__cert__attr__auth__contentst__role a))
(define-fun us_split_fields_Clearance__projection ((a us_split_fields12)) us_rep6 (rec__cert__attr__auth__contentst__clearance a))
...
(define-fun bool_eq13 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (and (and (and (and (= (bool_eq11 (rec__cert__attr__auth__contentst__id (us_split_fields13 a)) (rec__cert__attr__auth__contentst__id (us_split_fields13 b))) true) (= (bool_eq9 (rec__cert__attr__auth__contentst__notbefore (us_split_fields13 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq9 (rec__cert__attr__auth__contentst__notafter (us_split_fields13 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep15 (rec__cert__attr__auth__contentst__mechanism (us_split_fields13 a))) (to_rep15 (rec__cert__attr__auth__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq11 (rec__cert__attr__auth__contentst__basecertid (us_split_fields13 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields13 b))) true)) (= (to_rep16 (rec__cert__attr__auth__contentst__role (us_split_fields13 a))) (to_rep16 (rec__cert__attr__auth__contentst__role (us_split_fields13 b))))) (= (bool_eq12 (rec__cert__attr__auth__contentst__clearance (us_split_fields13 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields13 b))) true)) true false))
...
(declare-fun user_eq35 (us_rep7 us_rep7) Bool)
(declare-const dummy35 us_rep7)
...
(define-fun bool_eq14 ((a us_rep8) (b us_rep8)) Bool (ite (and (= (rec__admintoken__validauthcertt__valid (us_split_fields15 a)) (rec__admintoken__validauthcertt__valid (us_split_fields15 b))) (= (bool_eq13 (rec__admintoken__validauthcertt__contents (us_split_fields15 a)) (rec__admintoken__validauthcertt__contents (us_split_fields15 b))) true)) true false))
...
(declare-fun user_eq36 (us_rep8 us_rep8) Bool)
(declare-const dummy36 us_rep8)
...
(define-fun us_split_fields__ref___3__projection ((a us_split_fields__ref8)) us_split_fields16 (us_split_fields__content8 a))
(declare-datatypes () ((us_rep9 (mk___rep8 (us_split_fields17 us_split_fields16)))))
(define-fun us_rep___3__projection ((a us_rep9)) us_split_fields16 (us_split_fields17 a))
(define-fun bool_eq15 ((a us_rep9) (b us_rep9)) Bool (ite (and (and (= (to_rep15 (rec__cryptotypes__keypartt__algorithmid (us_split_fields17 a))) (to_rep15 (rec__cryptotypes__keypartt__algorithmid (us_split_fields17 b)))) (= (to_rep17 (rec__cryptotypes__keypartt__keyid (us_split_fields17 a))) (to_rep17 (rec__cryptotypes__keypartt__keyid (us_split_fields17 b))))) (= (to_rep18 (rec__cryptotypes__keypartt__keylength (us_split_fields17 a))) (to_rep18 (rec__cryptotypes__keypartt__keylength (us_split_fields17 b))))) true false))
...
(declare-datatypes () ((us_split_fields18 (mk___split_fields9 (rec__cert__id__contentst__id us_rep5) (rec__cert__id__contentst__notbefore us_rep3) (rec__cert__id__contentst__notafter us_rep3) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep4) (rec__cert__id__contentst__subjectpublickey us_rep9)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields18)) us_rep5 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields18)) us_rep3 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields18)) us_rep3 (rec__cert__id__contentst__notafter a))
(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields18)) algorithmt (rec__cert__id__contentst__mechanism a))
(define-fun us_split_fields_Subject__projection ((a us_split_fields18)) us_rep4 (rec__cert__id__contentst__subject a))
...
(define-fun bool_eq16 ((a us_rep10) (b us_rep10)) Bool (ite (and (and (and (and (and (= (bool_eq11 (rec__cert__id__contentst__id (us_split_fields19 a)) (rec__cert__id__contentst__id (us_split_fields19 b))) true) (= (bool_eq9 (rec__cert__id__contentst__notbefore (us_split_fields19 a)) (rec__cert__id__contentst__notbefore (us_split_fields19 b))) true)) (= (bool_eq9 (rec__cert__id__contentst__notafter (us_split_fields19 a)) (rec__cert__id__contentst__notafter (us_split_fields19 b))) true)) (= (to_rep15 (rec__cert__id__contentst__mechanism (us_split_fields19 a))) (to_rep15 (rec__cert__id__contentst__mechanism (us_split_fields19 b))))) (= (bool_eq10 (rec__cert__id__contentst__subject (us_split_fields19 a)) (rec__cert__id__contentst__subject (us_split_fields19 b))) true)) (= (bool_eq15 (rec__cert__id__contentst__subjectpublickey (us_split_fields19 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields19 b))) true)) true false))
...
(define-fun bool_eq17 ((a us_rep11) (b us_rep11)) Bool (ite (and (= (rec__admintoken__valididcertt__valid (us_split_fields21 a)) (rec__admintoken__valididcertt__valid (us_split_fields21 b))) (= (bool_eq16 (rec__admintoken__valididcertt__contents (us_split_fields21 a)) (rec__admintoken__valididcertt__contents (us_split_fields21 b))) true)) true false))
...
(declare-fun user_eq41 (us_rep11 us_rep11) Bool)
(declare-const dummy41 us_rep11)
...
(declare-fun extractuser (Int us_private Int Int us_split_fields14 us_split_fields20) (Array Int character))
(declare-fun extractuser__function_guard ((Array Int character) Int us_private Int Int us_split_fields14 us_split_fields20) Bool)
...
(declare-fun user_eq42 (presencet presencet) Bool)
(declare-const dummy42 presencet)
...
(define-fun dynamic_invariant8 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 1)) (in_range26 temp___expr_221)))
...
(declare-fun user_eq43 (tokenidt tokenidt) Bool)
(declare-const dummy43 tokenidt)
...
(define-fun dynamic_invariant9 ((temp___expr_660 Int) (temp___is_init_656 Bool) (temp___skip_constant_657 Bool) (temp___do_toplevel_658 Bool) (temp___do_typ_inv_659 Bool)) Bool (=> (or (= temp___is_init_656 true) (<= 0 4294967295)) (in_range27 temp___expr_660)))
(declare-sort tryt 0)
...
(declare-fun user_eq44 (tryt tryt) Bool)
(declare-const dummy44 tryt)
...
(define-fun dynamic_invariant10 ((temp___expr_667 Int) (temp___is_init_663 Bool) (temp___skip_constant_664 Bool) (temp___do_toplevel_665 Bool) (temp___do_typ_inv_666 Bool)) Bool (=> (or (= temp___is_init_663 true) (<= 0 2)) (in_range28 temp___expr_667)))
(assert true)
...
(declare-fun makedescription (Int Int Int Int Int Int Int Int Int Int Int Int Int) (Array Int character))
(declare-fun makedescription__function_guard ((Array Int character) Int Int Int Int Int Int Int Int Int Int Int Int Int) Bool)
(assert true)
...
(declare-fun temp___String_Literal_2036 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2036 us_void_param) 1)) 69) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 4)) 111)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 5)) 114)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 7)) 87)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 8)) 114)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 12)) 110)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 13)) 103)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 15)) 78)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 17)) 119)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 19)) 67)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 20)) 111)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 21)) 110)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 22)) 102)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 23)) 105)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 24)) 103)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 26)) 68)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 27)) 97)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 28)) 116)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 29)) 97)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 31)) 116)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 32)) 111)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 34)) 102)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 35)) 105)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 36)) 108)) (= (to_rep (select (temp___String_Literal_2036 us_void_param) 37)) 101)) :pattern ((temp___String_Literal_2036 us_void_param)))))
(define-fun dynamic_invariant11 ((temp___expr_46 Int) (temp___is_init_42 Bool) (temp___skip_constant_43 Bool) (temp___do_toplevel_44 Bool) (temp___do_typ_inv_45 Bool)) Bool (=> (or (= temp___is_init_42 true) (<= 1 2147483647)) (in_range1 temp___expr_46)))
(define-fun dynamic_invariant12 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range2 temp___expr_74)))
(define-fun dynamic_invariant13 ((temp___expr_96 us_t) (temp___is_init_92 Bool) (temp___skip_constant_93 Bool) (temp___do_toplevel_94 Bool) (temp___do_typ_inv_95 Bool)) Bool (=> (not (= temp___skip_constant_93 true)) (dynamic_property 1 2147483647 (first1 temp___expr_96) (last1 temp___expr_96))))
(define-fun dynamic_invariant14 ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_18)))
(define-fun dynamic_invariant15 ((temp___expr_574 Int) (temp___is_init_570 Bool) (temp___skip_constant_571 Bool) (temp___do_toplevel_572 Bool) (temp___do_typ_inv_573 Bool)) Bool (=> (or (= temp___is_init_570 true) (<= 0 40)) (in_range19 temp___expr_574)))
(define-fun dynamic_invariant16 ((temp___expr_598 Int) (temp___is_init_594 Bool) (temp___skip_constant_595 Bool) (temp___do_toplevel_596 Bool) (temp___do_typ_inv_597 Bool)) Bool (=> (or (= temp___is_init_594 true) (<= 0 4294967295)) (in_range20 temp___expr_598)))
(define-fun dynamic_invariant17 ((temp___expr_622 Int) (temp___is_init_618 Bool) (temp___skip_constant_619 Bool) (temp___do_toplevel_620 Bool) (temp___do_typ_inv_621 Bool)) Bool (=> (or (= temp___is_init_618 true) (<= 0 10)) (in_range22 temp___expr_622)))
(define-fun dynamic_invariant18 ((temp___expr_636 Int) (temp___is_init_632 Bool) (temp___skip_constant_633 Bool) (temp___do_toplevel_634 Bool) (temp___do_typ_inv_635 Bool)) Bool (=> (or (= temp___is_init_632 true) (<= 0 4294967295)) (in_range24 temp___expr_636)))
(define-fun dynamic_invariant19 ((temp___expr_643 Int) (temp___is_init_639 Bool) (temp___skip_constant_640 Bool) (temp___do_toplevel_641 Bool) (temp___do_typ_inv_642 Bool)) Bool (=> (or (= temp___is_init_639 true) (<= 0 128)) (in_range25 temp___expr_643)))
(define-fun dynamic_invariant20 ((temp___expr_1177 Int) (temp___is_init_1173 Bool) (temp___skip_constant_1174 Bool) (temp___do_toplevel_1175 Bool) (temp___do_typ_inv_1176 Bool)) Bool (=> (or (= temp___is_init_1173 true) (<= 0 17)) (in_range12 temp___expr_1177)))
(define-fun dynamic_invariant21 ((temp___expr_1184 Int) (temp___is_init_1180 Bool) (temp___skip_constant_1181 Bool) (temp___do_toplevel_1182 Bool) (temp___do_typ_inv_1183 Bool)) Bool (=> (or (= temp___is_init_1180 true) (<= 1 17)) (in_range10 temp___expr_1184)))
(define-fun dynamic_invariant22 ((temp___expr_1310 Int) (temp___is_init_1306 Bool) (temp___skip_constant_1307 Bool) (temp___do_toplevel_1308 Bool) (temp___do_typ_inv_1309 Bool)) Bool (=> (or (= temp___is_init_1306 true) (<= 0 2)) (in_range9 temp___expr_1310)))
(define-fun dynamic_invariant23 ((temp___expr_1191 Int) (temp___is_init_1187 Bool) (temp___skip_constant_1188 Bool) (temp___do_toplevel_1189 Bool) (temp___do_typ_inv_1190 Bool)) Bool (=> (or (= temp___is_init_1187 true) (<= 0 17408)) (in_range11 temp___expr_1191)))
(define-fun dynamic_invariant24 ((temp___expr_1222 Int) (temp___is_init_1218 Bool) (temp___skip_constant_1219 Bool) (temp___do_toplevel_1220 Bool) (temp___do_typ_inv_1221 Bool)) Bool (=> (or (= temp___is_init_1218 true) (<= 0 1024)) (in_range13 temp___expr_1222)))
(assert true)
...
(assert (forall ((temp___1251 Int)) (=> (dynamic_invariant24 temp___1251 true true true true) (forall ((temp___1252 Int)) (= (select (temp_____aggregate_def_1249 temp___1251) temp___1252) rliteral2)))))
(define-fun dynamic_invariant25 ((temp___expr_420 Int) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool (=> (or (= temp___is_init_416 true) (<= 1 150)) (in_range29 temp___expr_420)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (forall ((temp___156 Int)) (=> (dynamic_invariant12 temp___156 true true true true) (forall ((temp___157 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___156) temp___157)) temp___156)))))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(define-fun dynamic_invariant26 ((temp___expr_472 Int) (temp___is_init_468 Bool) (temp___skip_constant_469 Bool) (temp___do_toplevel_470 Bool) (temp___do_typ_inv_471 Bool)) Bool (=> (or (= temp___is_init_468 true) (<= 1901 2099)) (in_range15 temp___expr_472)))
(define-fun dynamic_invariant27 ((temp___expr_479 Int) (temp___is_init_475 Bool) (temp___skip_constant_476 Bool) (temp___do_toplevel_477 Bool) (temp___do_typ_inv_478 Bool)) Bool (=> (or (= temp___is_init_475 true) (<= 1 12)) (in_range16 temp___expr_479)))
(define-fun dynamic_invariant28 ((temp___expr_486 Int) (temp___is_init_482 Bool) (temp___skip_constant_483 Bool) (temp___do_toplevel_484 Bool) (temp___do_typ_inv_485 Bool)) Bool (=> (or (= temp___is_init_482 true) (<= 1 31)) (in_range17 temp___expr_486)))
(define-fun dynamic_invariant29 ((temp___expr_518 Int) (temp___is_init_514 Bool) (temp___skip_constant_515 Bool) (temp___do_toplevel_516 Bool) (temp___do_typ_inv_517 Bool)) Bool (=> (or (= temp___is_init_514 true) (<= 0 86399999)) (in_range18 temp___expr_518)))
(define-fun dynamic_invariant30 ((temp___expr_1122 Int) (temp___is_init_1118 Bool) (temp___skip_constant_1119 Bool) (temp___do_toplevel_1120 Bool) (temp___do_typ_inv_1121 Bool)) Bool (=> (or (= temp___is_init_1118 true) (<= 0 3)) (in_range23 temp___expr_1122)))
(define-fun dynamic_invariant31 ((temp___expr_1483 Int) (temp___is_init_1479 Bool) (temp___skip_constant_1480 Bool) (temp___do_toplevel_1481 Bool) (temp___do_typ_inv_1482 Bool)) Bool (=> (or (= temp___is_init_1479 true) (<= 0 4294967295)) (in_range21 temp___expr_1483)))
(assert (forall ((temp___1247 Int)) (=> (dynamic_invariant21 temp___1247 true true true true) (forall ((temp___1248 Int)) (= (select (temp_____aggregate_def_1245 temp___1247) temp___1248) rliteral)))))
...
(declare-const theminentryclass int__ref)
(declare-const theminpreservedlogsize int__ref)
(declare-const thealarmthresholdsize int__ref)
(declare-const thesystemmaxfar int__ref)
(declare-const success bool__ref)
(declare-const state us_private__ref)
(declare-const o (Array Int character))
(declare-const o1 (Array Int character))
(declare-const o2 us_t)
(declare-const datavalid Bool)
(declare-const thelatchunlockduration1 Int)
(declare-const thealarmsilentduration1 Int)
(declare-const thefingerwaitduration1 Int)
(declare-const thetokenremovalduration1 Int)
(declare-const theenclaveclearance1 Int)
(declare-const theworkinghoursstart1 Int)
(declare-const theworkinghoursend1 Int)
(declare-const themaxauthduration1 Int)
(declare-const theaccesspolicy1 Int)
(declare-const theminentryclass1 Int)
(declare-const theminpreservedlogsize1 Int)
(declare-const thealarmthresholdsize1 Int)
(declare-const thesystemmaxfar1 Int)
...
(assert (in_range26 tokenpresence))
...
(assert (=> (<= 0 2000) (in_range7 thelatchunlockduration)))
(assert (=> (<= 0 2000) (in_range7 thealarmsilentduration)))
(assert (=> (<= 0 2000) (in_range7 thefingerwaitduration)))
(assert (=> (<= 0 2000) (in_range7 thetokenremovalduration)))
(assert (=> (<= 0 5) (in_range6 theenclaveclearance)))
(assert (=> (<= 0 864000) (in_range4 theworkinghoursstart)))
(assert (=> (<= 0 864000) (in_range4 theworkinghoursend)))
(assert (=> (<= 0 864000) (in_range4 themaxauthduration)))
(assert (=> (<= 0 1) (in_range8 theaccesspolicy)))
(assert (=> (<= 0 5) (in_range6 (int__content theminentryclass))))
(assert (=> (<= 0 4194304) (in_range3 (int__content theminpreservedlogsize))))
(assert (=> (<= 0 4194304) (in_range3 (int__content thealarmthresholdsize))))
(assert (=> (<= 0 2147483647) (in_range5 (int__content thesystemmaxfar))))
(assert (and (and (and (and (and (and (and (and (and (and (and (and (in_range7 thelatchunlockduration1) (in_range7 thealarmsilentduration1)) (in_range7 thefingerwaitduration1)) (in_range7 thetokenremovalduration1)) (in_range6 theenclaveclearance1)) (in_range4 theworkinghoursstart1)) (in_range4 theworkinghoursend1)) (in_range4 themaxauthduration1)) (in_range8 theaccesspolicy1)) (in_range6 (let ((subject theminentryclass)) theminentryclass1))) (in_range3 (let ((subject theminpreservedlogsize)) theminpreservedlogsize1))) (in_range3 (let ((subject thealarmthresholdsize)) thealarmthresholdsize1))) (in_range5 (let ((subject thesystemmaxfar)) thesystemmaxfar1))))
(assert (= datavalid true))
(assert (= o1 (makedescription thelatchunlockduration1 thealarmsilentduration1 thefingerwaitduration1 thetokenremovalduration1 theenclaveclearance1 theworkinghoursstart1 theworkinghoursend1 themaxauthduration1 theaccesspolicy1 (let ((subject theminentryclass)) theminentryclass1) (let ((subject theminpreservedlogsize)) theminpreservedlogsize1) (let ((subject thealarmthresholdsize)) thealarmthresholdsize1) (let ((subject thesystemmaxfar)) thesystemmaxfar1))))
(assert (= o2 (mk___t o1 (mk 1 150))))
(assert (= o (extractuser tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content7 authcert__split_fields) (us_split_fields__content10 idcert__split_fields))))
(assert (and (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true) (in_range14 auditalarm1)))
(assert (not (= (let ((subject success)) success1) true)))
(assert (not (= (to_rep1 (first (mk 1 37))) 1)))
(check-sat)
(exit)
