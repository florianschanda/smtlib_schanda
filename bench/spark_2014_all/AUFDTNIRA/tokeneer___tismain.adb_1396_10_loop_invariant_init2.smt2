...
(assert (and (and (and (and (and (and (and (and (and (and (and (= (not (= (enrolmentisinprogress status1 (let ((subject state3)) state7)) true)) (= (privatekeypresent thistisinfo__split_fields (let ((subject state)) state4)) true)) (or (= (enrolmentisinprogress status1 (let ((subject state3)) state7)) true) (= (statusisenclavequiescent status1 (let ((subject state3)) state7)) true))) (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields1))) true))) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields1))) true))) (not (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields1))) 1))) (not (= (statusiswaitingstartadminop status1 (let ((subject state3)) state7)) true))) (not (= (statusiswaitingfinishadminop status1 (let ((subject state3)) state7)) true))) (not (= (statusisshutdown status1 (let ((subject state3)) state7)) true))) (not (= (isgood tokenpresence1 (let ((subject state1)) state5) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true))) (not (= (authcertvalid tokenpresence1 (let ((subject state1)) state5) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true))) (not (= (theauthcertrole tokenpresence1 (let ((subject state1)) state5) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) 1))) (and (and (and (and (and (and (in_range24 tokenid1) (in_range14 auditalarm1)) (in_range28 status1)) (in_range23 tokenpresence1)) (in_range25 tokentry1)) (in_range26 currentlatch1)) (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true))))
(assert (= (= (islocked currentlatch1 (let ((subject state2)) state6) latchtimeout__split_fields) true) (= (latchislocked Tuple0) true)))
(assert (not (= (enrolmentisinprogress status1 (let ((subject state3)) state7)) true)))
(assert (not (= (privatekeypresent thistisinfo__split_fields (let ((subject state)) state4)) true)))
(check-sat)
(exit)
