...
(assert (= temp___1906 (mk___t1 (temp___String_Literal_1905 Tuple0) (mk1 1 11))))
(assert (dynamic_predicate temp___1906))
(assert (= o11 temp___1906))
(assert (= o12 (convertretvaltotext (int__content retvalfin5) o11)))
(assert (= o13 (mk___t o12 (mk 1 150))))
(assert (not (= (to_rep1 (first (rt o13))) 1)))
(check-sat)
(exit)
