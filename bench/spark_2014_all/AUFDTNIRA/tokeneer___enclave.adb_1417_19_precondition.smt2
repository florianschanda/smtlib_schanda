...
(declare-fun user_eq33 (filestatust filestatust) Bool)
(declare-const dummy33 filestatust)
...
(assert (forall ((x filestatust)) (! (in_range23 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(define-fun in_range24 ((x Int)) Bool (and (<= 1 x) (<= x 17)))
...
(declare-fun user_eq34 (logfileindext logfileindext) Bool)
(declare-const dummy34 logfileindext)
...
(assert (forall ((x logfileindext)) (! (in_range24 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(define-fun in_range25 ((x Int)) Bool (and (<= 0 x) (<= x 17408)))
...
(declare-fun user_eq35 (logentrycountt logentrycountt) Bool)
(declare-const dummy35 logentrycountt)
...
(assert (forall ((x logentrycountt)) (! (in_range25 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(define-fun in_range26 ((x Int)) Bool (and (<= 0 x) (<= x 17)))
...
(declare-fun user_eq36 (logfilecountt logfilecountt) Bool)
(declare-const dummy36 logfilecountt)
...
(assert (forall ((x logfilecountt)) (! (in_range26 (to_rep17 x)) :pattern ((to_rep17 x)))))
...
(declare-const dummy37 (Array Int logfileindext))
...
(declare-fun user_eq37 ((Array Int logfileindext) (Array Int logfileindext)) Bool)
...
(define-fun in_range27 ((x Int)) Bool (and (<= 0 x) (<= x 1024)))
...
(declare-fun user_eq39 (fileentrycountt fileentrycountt) Bool)
(declare-const dummy39 fileentrycountt)
...
(assert (forall ((x fileentrycountt)) (! (in_range27 (to_rep18 x)) :pattern ((to_rep18 x)))))
...
(declare-const dummy40 (Array Int fileentrycountt))
...
(declare-fun user_eq40 ((Array Int fileentrycountt) (Array Int fileentrycountt)) Bool)
...
(define-fun dynamic_invariant9 ((temp___expr_2867 Int) (temp___is_init_2863 Bool) (temp___skip_constant_2864 Bool) (temp___do_toplevel_2865 Bool) (temp___do_typ_inv_2866 Bool)) Bool (=> (or (= temp___is_init_2863 true) (<= 0 8)) (in_range28 temp___expr_2867)))
...
(define-fun dynamic_invariant13 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range16 temp___expr_440)))
(define-fun dynamic_invariant14 ((temp___expr_1092 Int) (temp___is_init_1088 Bool) (temp___skip_constant_1089 Bool) (temp___do_toplevel_1090 Bool) (temp___do_typ_inv_1091 Bool)) Bool (=> (or (= temp___is_init_1088 true) (<= 0 40)) (in_range9 temp___expr_1092)))
(define-fun dynamic_invariant15 ((temp___expr_1116 Int) (temp___is_init_1112 Bool) (temp___skip_constant_1113 Bool) (temp___do_toplevel_1114 Bool) (temp___do_typ_inv_1115 Bool)) Bool (=> (or (= temp___is_init_1112 true) (<= 0 4294967295)) (in_range11 temp___expr_1116)))
(define-fun dynamic_invariant16 ((temp___expr_1140 Int) (temp___is_init_1136 Bool) (temp___skip_constant_1137 Bool) (temp___do_toplevel_1138 Bool) (temp___do_typ_inv_1139 Bool)) Bool (=> (or (= temp___is_init_1136 true) (<= 0 10)) (in_range13 temp___expr_1140)))
(define-fun dynamic_invariant17 ((temp___expr_1154 Int) (temp___is_init_1150 Bool) (temp___skip_constant_1151 Bool) (temp___do_toplevel_1152 Bool) (temp___do_typ_inv_1153 Bool)) Bool (=> (or (= temp___is_init_1150 true) (<= 0 4294967295)) (in_range14 temp___expr_1154)))
(define-fun dynamic_invariant18 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 128)) (in_range15 temp___expr_1161)))
(define-fun dynamic_invariant19 ((temp___expr_1276 Int) (temp___is_init_1272 Bool) (temp___skip_constant_1273 Bool) (temp___do_toplevel_1274 Bool) (temp___do_typ_inv_1275 Bool)) Bool (=> (or (= temp___is_init_1272 true) (<= 0 17)) (in_range26 temp___expr_1276)))
(define-fun dynamic_invariant20 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 1 17)) (in_range24 temp___expr_1283)))
(define-fun dynamic_invariant21 ((temp___expr_1409 Int) (temp___is_init_1405 Bool) (temp___skip_constant_1406 Bool) (temp___do_toplevel_1407 Bool) (temp___do_typ_inv_1408 Bool)) Bool (=> (or (= temp___is_init_1405 true) (<= 0 2)) (in_range23 temp___expr_1409)))
(define-fun dynamic_invariant22 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 0 17408)) (in_range25 temp___expr_1290)))
(define-fun dynamic_invariant23 ((temp___expr_1321 Int) (temp___is_init_1317 Bool) (temp___skip_constant_1318 Bool) (temp___do_toplevel_1319 Bool) (temp___do_typ_inv_1320 Bool)) Bool (=> (or (= temp___is_init_1317 true) (<= 0 1024)) (in_range27 temp___expr_1321)))
(assert true)
...
(assert (forall ((temp___1350 Int)) (=> (dynamic_invariant23 temp___1350 true true true true) (forall ((temp___1351 Int)) (= (select (temp_____aggregate_def_1348 temp___1350) temp___1351) rliteral2)))))
(define-fun dynamic_invariant24 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range5 temp___expr_625)))
(define-fun dynamic_invariant25 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range6 temp___expr_632)))
(define-fun dynamic_invariant26 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range7 temp___expr_639)))
(define-fun dynamic_invariant27 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range8 temp___expr_671)))
(assert true)
...
(declare-const idcert__split_fields3 us_split_fields__ref6)
...
(declare-const logfiles5 (Array Int us_rep12))
...
(assert (=> (= result true) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref6 idcert__split_fields2)) idcert__split_fields)))
(assert (=> (= result true) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields2)) authcert__split_fields)))
...
(assert (=> (not (= result true)) (=> (= result1 true) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref6 idcert__split_fields2)) idcert__split_fields))))
(assert (=> (not (= result true)) (=> (= result1 true) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields2)) authcert__split_fields))))
...
(assert (=> (not (= result true)) (=> (not (= result1 true)) (=> (= result2 true) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref6 idcert__split_fields2)) idcert__split_fields)))))
(assert (=> (not (= result true)) (=> (not (= result1 true)) (=> (= result2 true) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields2)) authcert__split_fields)))))
...
(assert (= idcert__split_fields3 (let ((subject idcert__split_fields)) (mk___split_fields__ref6 idcert__split_fields2))))
...
(assert (= logfilestate__split_fields11 (mk___split_fields__ref11 logfilestate__split_fields7)))
(assert (= logfilesstatus4 (mk_map__ref1 logfilesstatus)))
(assert (= logfiles4 (mk_map__ref4 logfiles)))
...
(assert (and (= o6 (islocked (int__content currentlatch4) (us_private__content state38) (us_split_fields__content1 latchtimeout__split_fields7))) (= (= o6 true) (= (int__content currentlatch4) 0))))
(assert (= o7 (ite (not (= o6 true)) true false)))
(assert (= result3 (ite (= o7 true) (islocked currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (=> (= result3 true) (and (= result4 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result4 true) (in_range3 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result3 true) (=> (= result4 true) (and (= o8 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o8)))))
(assert (=> (= result3 true) (=> (= result4 true) (= o9 (ite (= o8 3) true false)))))
(assert (=> (= result3 true) (=> (not (= result4 true)) (= o9 false))))
(assert (=> (not (= result3 true)) (= o9 (distinct 1 0))))
(assert (and (= o3 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields6)))) (and (in_range1 o3) (= o3 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields6)))))))
(assert (= result5 (ite (= o3 1) true false)))
(assert (= result5 true))
(assert (and (= o4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (= (= o4 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields6)))))))
(assert (= o5 (ite (not (= o4 true)) true false)))
(assert (and (= result6 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (= (= result6 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields6)))))))
(assert (= result6 true))
