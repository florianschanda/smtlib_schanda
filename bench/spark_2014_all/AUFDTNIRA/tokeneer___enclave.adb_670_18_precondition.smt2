...
(assert (and (= o8 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range1 o8) (= o8 (to_rep theadmin__split_fields)))))
(assert (and (= o9 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range1 o9) (= o9 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
...
(assert (=> (= result true) (and (= o4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o4 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result true) (= o5 (ite (not (= o4 true)) true false))))
(assert (=> (= result true) (and (= o1 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range3 o1))))
(assert (=> (= result true) (= o2 (ite (= o1 3) true false))))
(assert (=> (= result true) (and (= o3 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o3 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
...
(assert (and (= result1 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result1 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result1 true))
