...
(define-fun dynamic_invariant1 ((temp___expr_1190 Int) (temp___is_init_1186 Bool) (temp___skip_constant_1187 Bool) (temp___do_toplevel_1188 Bool) (temp___do_typ_inv_1189 Bool)) Bool (=> (or (= temp___is_init_1186 true) (<= 0 1)) (in_range4 temp___expr_1190)))
...
(assert (forall ((a (Array Int filestatust))) (forall ((first2 Int)) (! (= (slide3 a first2 first2) a) :pattern ((slide3 a first2 first2))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep6 (select a temp___idx_175)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(define-fun in_range10 ((x Int)) Bool (and (<= 0 x) (<= x 43)))
(declare-fun attr__ATTRIBUTE_IMAGE10 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check10 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE10 (us_image) Int)
(declare-fun user_eq15 (elementt elementt) Bool)
(declare-const dummy15 elementt)
...
(define-fun dynamic_invariant2 ((temp___expr_538 Int) (temp___is_init_534 Bool) (temp___skip_constant_535 Bool) (temp___do_toplevel_536 Bool) (temp___do_typ_inv_537 Bool)) Bool (=> (or (= temp___is_init_534 true) (<= 0 43)) (in_range10 temp___expr_538)))
(declare-sort severityt 0)
(define-fun in_range11 ((x Int)) Bool (and (<= 0 x) (<= x 2)))
(declare-fun attr__ATTRIBUTE_IMAGE11 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check11 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE11 (us_image) Int)
(declare-fun user_eq16 (severityt severityt) Bool)
(declare-const dummy16 severityt)
...
(define-fun dynamic_invariant3 ((temp___expr_549 Int) (temp___is_init_545 Bool) (temp___skip_constant_546 Bool) (temp___do_toplevel_547 Bool) (temp___do_typ_inv_548 Bool)) Bool (=> (or (= temp___is_init_545 true) (<= 0 2)) (in_range11 temp___expr_549)))
...
(define-fun dynamic_invariant7 ((temp___expr_1197 Int) (temp___is_init_1193 Bool) (temp___skip_constant_1194 Bool) (temp___do_toplevel_1195 Bool) (temp___do_typ_inv_1196 Bool)) Bool (=> (or (= temp___is_init_1193 true) (<= 0 17)) (in_range7 temp___expr_1197)))
(define-fun dynamic_invariant8 ((temp___expr_1204 Int) (temp___is_init_1200 Bool) (temp___skip_constant_1201 Bool) (temp___do_toplevel_1202 Bool) (temp___do_typ_inv_1203 Bool)) Bool (=> (or (= temp___is_init_1200 true) (<= 1 17)) (in_range5 temp___expr_1204)))
(define-fun dynamic_invariant9 ((temp___expr_1317 Int) (temp___is_init_1313 Bool) (temp___skip_constant_1314 Bool) (temp___do_toplevel_1315 Bool) (temp___do_typ_inv_1316 Bool)) Bool (=> (or (= temp___is_init_1313 true) (<= 0 2)) (in_range9 temp___expr_1317)))
...
(assert (forall ((temp___1266 Int)) (=> (dynamic_invariant8 temp___1266 true true true true) (forall ((temp___1267 Int)) (= (select (temp_____aggregate_def_1264 temp___1266) temp___1267) rliteral)))))
...
(define-fun logfilestate__split_fields29 () us_split_fields2 (mk___split_fields1 logfilestate__split_fields14 logfilestate__split_fields15 (mk___rep (mk___split_fields logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20))
(assert (= (audittypes__nodescription__aggregate_def 32) nodescription))
(assert (= (temp___String_Literal_158 Tuple0) nouser))
(assert (in_range10 elementid))
(assert (in_range11 severity))
...
(assert (= (to_rep1 (first (rt description))) 1))
(assert (=> (<= 0 1) (in_range4 oldalarm)))
(assert (= (mk_int__ref result) (mk_int__ref oldalarm)))
(assert (= oldalarm1 auditalarm))
(assert (= o (converttoauditdescription description)))
(assert (and (and (<= 1 (to_rep4 logfilestate__split_fields12)) (= (to_rep3 logfilestate__split_fields8) (+ (* (- (to_rep4 logfilestate__split_fields12) 1) 1024) (to_rep5 (select logfilestate__split_fields13 (to_rep2 logfilestate__split_fields7)))))) (in_range4 auditalarm1)))
(assert (in_range4 auditalarm2))
(assert (=> (not (= oldalarm1 auditalarm2)) (and (and (<= 1 (to_rep4 logfilestate__split_fields19)) (= (to_rep3 logfilestate__split_fields15) (+ (* (- (to_rep4 logfilestate__split_fields19) 1) 1024) (to_rep5 (select logfilestate__split_fields20 (to_rep2 logfilestate__split_fields14)))))) (in_range4 auditalarm3))))
(assert (=> (not (not (= oldalarm1 auditalarm2))) (= auditsystemfault1 auditsystemfault)))
(assert (=> (not (not (= oldalarm1 auditalarm2))) (= auditalarm3 auditalarm2)))
(assert (=> (not (not (= oldalarm1 auditalarm2))) (= logfilestate__split_fields29 (mk___split_fields1 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13))))
(assert (=> (not (not (= oldalarm1 auditalarm2))) (= logfilesstatus1 logfilesstatus)))
(assert (=> (not (not (= oldalarm1 auditalarm2))) (= logfiles1 logfiles)))
(assert (= oldalarm2 (mk_int__ref oldalarm1)))
(assert (= auditsystemfault2 (mk_bool__ref auditsystemfault1)))
(assert (= auditalarm4 (mk_int__ref auditalarm3)))
(assert (= logfilestate__split_fields21 logfilestate__split_fields14))
(assert (= logfilestate__split_fields22 logfilestate__split_fields15))
(assert (= logfilestate__split_fields23 logfilestate__split_fields16))
(assert (= logfilestate__split_fields24 logfilestate__split_fields17))
(assert (= logfilestate__split_fields25 logfilestate__split_fields18))
(assert (= logfilestate__split_fields26 logfilestate__split_fields19))
(assert (= logfilestate__split_fields27 logfilestate__split_fields20))
(assert (= logfilesstatus1 logfilesstatus2))
(assert (= logfiles1 logfiles2))
(assert (= oldalarm3 oldalarm1))
(assert (= auditsystemfault3 auditsystemfault1))
(assert (= auditalarm5 auditalarm3))
(assert (= logfilestate__split_fields28 logfilestate__split_fields29))
(assert (= logfilesstatus3 logfilesstatus1))
(assert (= logfiles3 logfiles1))
(assert (and (= o1 (- (to_rep4 logfilestate__split_fields26) 1)) (in_range6 (- (to_rep4 logfilestate__split_fields26) 1))))
(assert (= o2 (* o1 1024)))
(assert (and (= o3 o2) (in_range12 o2)))
(assert (= o4 (+ o3 (to_rep5 (select logfilestate__split_fields27 (to_rep2 logfilestate__split_fields21))))))
(assert (not (in_range12 o4)))
(check-sat)
(exit)
