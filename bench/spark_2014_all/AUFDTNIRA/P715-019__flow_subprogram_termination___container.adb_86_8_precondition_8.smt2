...
(declare-const result27 cursor__ref)
...
(assert (=> (= result17 true) (and (= (has_element (mk___rep1 my_container__split_fields1) temp___6342) true) (= e7 (element (mk___rep1 my_container__split_fields1) temp___6342)))))
...
(assert (and (=> (<= 1 200) (in_range4 x20)) (and (= (has_element (mk___rep1 my_container__split_fields1) (let ((subject temp___641)) temp___6411)) true) (= e15 (element (mk___rep1 my_container__split_fields1) (let ((subject temp___641)) temp___6411))))))
(assert (= temp___637 x20))
(assert (= temp___638 (mk_int__ref 0)))
(assert (and (= o11 (+ x20 1)) (in_range4 (+ x20 1))))
(assert (= result23 (mk_int__ref x20)))
(assert (= x21 o11))
(assert (=> (<= 1 200) (in_range4 x22)))
(assert (= result24 (let ((subject temp___638)) (mk_int__ref temp___6381))))
(assert (= (let ((subject temp___638)) temp___6382) x22))
(assert (= x22 5))
(assert (= x23 (mk_int__ref x22)))
(assert (= rho temp___6382))
(assert (= x24 x22))
(assert (= x25 x23))
(assert (= rho1 rho))
(assert (= x26 x24))
(assert (= result25 (mk_bool__ref b14)))
(assert (= b15 (distinct 0 0)))
(assert (and (= o12 (next (mk___rep1 my_container__split_fields1) (let ((subject temp___641)) temp___6411))) (= o12 (ite (< (to_rep (rec__container__cursor__index (us_split_fields1 (let ((subject temp___641)) temp___6411)))) 200) (mk___rep (mk___split_fields (of_rep (+ (to_rep (rec__container__cursor__index (us_split_fields1 (let ((subject temp___641)) temp___6411)))) 1)))) (mk___rep (mk___split_fields rliteral1))))))
(assert (and (= o13 (has_element (mk___rep1 my_container__split_fields1) o12)) (= (= o13 true) (and (<= 1 (to_rep (rec__container__cursor__index (us_split_fields1 o12)))) (<= (to_rep (rec__container__cursor__index (us_split_fields1 o12))) 200)))))
(assert (= result26 (ite (not (= o13 true)) true false)))
(assert (not (= result26 true)))
(assert (and (= o14 (next (mk___rep1 my_container__split_fields1) (let ((subject temp___641)) temp___6411))) (= o14 (ite (< (to_rep (rec__container__cursor__index (us_split_fields1 (let ((subject temp___641)) temp___6411)))) 200) (mk___rep (mk___split_fields (of_rep (+ (to_rep (rec__container__cursor__index (us_split_fields1 (let ((subject temp___641)) temp___6411)))) 1)))) (mk___rep (mk___split_fields rliteral1))))))
(assert (= result27 (let ((subject temp___641)) (mk_cursor__ref temp___6411))))
(assert (= (let ((subject temp___641)) temp___6412) o14))
(assert (and (= result28 (has_element (mk___rep1 my_container__split_fields1) (let ((subject temp___641)) temp___6412))) (= (= result28 true) (and (<= 1 (to_rep (rec__container__cursor__index (us_split_fields1 (let ((subject temp___641)) temp___6412))))) (<= (to_rep (rec__container__cursor__index (us_split_fields1 (let ((subject temp___641)) temp___6412)))) 200)))))
(assert (= result28 true))
(assert (not (= (has_element (mk___rep1 my_container__split_fields1) (let ((subject temp___641)) temp___6412)) true)))
(check-sat)
(exit)
