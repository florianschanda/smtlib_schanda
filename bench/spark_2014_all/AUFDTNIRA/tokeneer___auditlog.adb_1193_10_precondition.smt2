...
(declare-const logfilestate__split_fields9 logfilecountt)
(declare-const logfilestate__split_fields10 (Array Int fileentrycountt))
...
(assert (and (and (<= 1 (to_rep4 logfilestate__split_fields9)) (= (to_rep3 logfilestate__split_fields8) (+ (* (- (to_rep4 logfilestate__split_fields9) 1) 1024) (to_rep5 (select logfilestate__split_fields10 (to_rep2 logfilestate__split_fields7)))))) (in_range4 auditalarm1)))
(assert (in_range4 auditalarm2))
(assert (not (= oldalarm1 auditalarm2)))
(assert (not (= (to_rep3 logfilestate__split_fields8) (+ (* (- (to_rep4 logfilestate__split_fields9) 1) 1024) (to_rep5 (select logfilestate__split_fields10 (to_rep2 logfilestate__split_fields7)))))))
(check-sat)
(exit)
