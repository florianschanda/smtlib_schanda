...
(declare-const o5 (Array Int Bool))
...
(assert (= result__1 o2))
(assert (forall ((v Int)) (=> (and (<= 0 v) (<= v index2)) (= (= (select result__2 v) true) (= (are_coprime value v) true)))))
(assert (and (and (forall ((temp___263 Int)) (=> (and (<= 0 temp___263) (<= temp___263 100000)) (=> (or (< 100000 temp___263) (or (< temp___263 0) (< index2 temp___263))) (= (select result__2 temp___263) (select result__ temp___263))))) (=> (<= 0 100000) (in_range3 index2))) (and (<= 0 index2) (<= index2 100000))))
(assert (not (= index2 100000)))
(assert (= index2 result2))
(assert (= index3 (+ index2 1)))
(assert (and (= o3 (euclid value index3)) (and (in_range1 o3) (ite (= (are_coprime value index3) true) (= o3 1) (< 1 o3)))))
(assert (= o4 (ite (= o3 1) true false)))
(assert (= o5 (store result__2 index3 o4)))
...
(assert (not (= (select result__3 v) true)))
(check-sat)
(exit)
