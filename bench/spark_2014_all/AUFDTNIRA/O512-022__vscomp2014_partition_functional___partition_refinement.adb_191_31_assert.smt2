...
(assert (not (<= k (to_rep2 (rec__partition_refinement__interval__last (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) (to_rep3 (select (map__content f6) k)))))))))
(check-sat)
(exit)
