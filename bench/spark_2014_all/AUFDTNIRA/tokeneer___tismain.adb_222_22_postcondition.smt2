...
(assert (= (privatekeypresent (us_split_fields__content5 thistisinfo__split_fields1) (us_private__content state27)) true))
(assert (not (not (= (enrolmentisinprogress (int__content status6) (us_private__content state36)) true))))
(check-sat)
(exit)
