...
(assert (= result true))
(assert (not (not (= (privatekeypresent (mk___split_fields3 thistisinfo__split_fields (mk___rep2 (mk___split_fields2 thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) (us_private__content state)) true))))
(check-sat)
(exit)
