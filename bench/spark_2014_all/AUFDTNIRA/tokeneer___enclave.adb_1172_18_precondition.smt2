...
(define-fun dynamic_invariant7 ((temp___expr_2153 Int) (temp___is_init_2149 Bool) (temp___skip_constant_2150 Bool) (temp___do_toplevel_2151 Bool) (temp___do_typ_inv_2152 Bool)) Bool (=> (or (= temp___is_init_2149 true) (<= 0 1)) (in_range28 temp___expr_2153)))
...
(define-fun dynamic_invariant8 ((temp___expr_2176 Int) (temp___is_init_2172 Bool) (temp___skip_constant_2173 Bool) (temp___do_toplevel_2174 Bool) (temp___do_typ_inv_2175 Bool)) Bool (=> (or (= temp___is_init_2172 true) (<= 0 1)) (in_range29 temp___expr_2176)))
...
(define-fun dynamic_invariant9 ((temp___expr_2867 Int) (temp___is_init_2863 Bool) (temp___skip_constant_2864 Bool) (temp___do_toplevel_2865 Bool) (temp___do_typ_inv_2866 Bool)) Bool (=> (or (= temp___is_init_2863 true) (<= 0 8)) (in_range31 temp___expr_2867)))
...
(define-fun dynamic_invariant15 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 3)) (in_range7 temp___expr_433)))
(define-fun dynamic_invariant16 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range24 temp___expr_440)))
(define-fun dynamic_invariant17 ((temp___expr_1092 Int) (temp___is_init_1088 Bool) (temp___skip_constant_1089 Bool) (temp___do_toplevel_1090 Bool) (temp___do_typ_inv_1091 Bool)) Bool (=> (or (= temp___is_init_1088 true) (<= 0 40)) (in_range18 temp___expr_1092)))
(define-fun dynamic_invariant18 ((temp___expr_1116 Int) (temp___is_init_1112 Bool) (temp___skip_constant_1113 Bool) (temp___do_toplevel_1114 Bool) (temp___do_typ_inv_1115 Bool)) Bool (=> (or (= temp___is_init_1112 true) (<= 0 4294967295)) (in_range19 temp___expr_1116)))
(define-fun dynamic_invariant19 ((temp___expr_1140 Int) (temp___is_init_1136 Bool) (temp___skip_constant_1137 Bool) (temp___do_toplevel_1138 Bool) (temp___do_typ_inv_1139 Bool)) Bool (=> (or (= temp___is_init_1136 true) (<= 0 10)) (in_range21 temp___expr_1140)))
(define-fun dynamic_invariant20 ((temp___expr_1154 Int) (temp___is_init_1150 Bool) (temp___skip_constant_1151 Bool) (temp___do_toplevel_1152 Bool) (temp___do_typ_inv_1153 Bool)) Bool (=> (or (= temp___is_init_1150 true) (<= 0 4294967295)) (in_range22 temp___expr_1154)))
(define-fun dynamic_invariant21 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 128)) (in_range23 temp___expr_1161)))
(define-fun dynamic_invariant22 ((temp___expr_1276 Int) (temp___is_init_1272 Bool) (temp___skip_constant_1273 Bool) (temp___do_toplevel_1274 Bool) (temp___do_typ_inv_1275 Bool)) Bool (=> (or (= temp___is_init_1272 true) (<= 0 17)) (in_range15 temp___expr_1276)))
(define-fun dynamic_invariant23 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 1 17)) (in_range13 temp___expr_1283)))
(define-fun dynamic_invariant24 ((temp___expr_1409 Int) (temp___is_init_1405 Bool) (temp___skip_constant_1406 Bool) (temp___do_toplevel_1407 Bool) (temp___do_typ_inv_1408 Bool)) Bool (=> (or (= temp___is_init_1405 true) (<= 0 2)) (in_range12 temp___expr_1409)))
(define-fun dynamic_invariant25 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 0 17408)) (in_range14 temp___expr_1290)))
(define-fun dynamic_invariant26 ((temp___expr_1321 Int) (temp___is_init_1317 Bool) (temp___skip_constant_1318 Bool) (temp___do_toplevel_1319 Bool) (temp___do_typ_inv_1320 Bool)) Bool (=> (or (= temp___is_init_1317 true) (<= 0 1024)) (in_range16 temp___expr_1321)))
(assert true)
...
(define-fun dynamic_invariant27 ((temp___expr_573 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool) (temp___do_typ_inv_572 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 150)) (in_range30 temp___expr_573)))
...
(define-fun dynamic_invariant28 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range8 temp___expr_625)))
(define-fun dynamic_invariant29 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range9 temp___expr_632)))
(define-fun dynamic_invariant30 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range10 temp___expr_639)))
(define-fun dynamic_invariant31 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range11 temp___expr_671)))
(assert true)
...
(define-fun dynamic_invariant32 ((temp___expr_1596 Int) (temp___is_init_1592 Bool) (temp___skip_constant_1593 Bool) (temp___do_toplevel_1594 Bool) (temp___do_typ_inv_1595 Bool)) Bool (=> (or (= temp___is_init_1592 true) (<= 0 4294967295)) (in_range20 temp___expr_1596)))
...
(assert (and (= status 6) (and (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (and (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 4) (and (= (and (and (= (islocked currentlatch (us_private__content state2) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) true) (= (thecurrentdoor (us_private__content state3)) 0)) (= (greaterthanorequal (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (alarm_timeout (us_private__content state3))) true)) (= (thedooralarm (us_private__content state3)) 0)) (and (=> (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1) (and (and (= (isgood tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields)) true) (= (authcertvalid tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields)) true)) (= (theauthcertrole tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields)) 1))) (=> (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1) (or (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3)) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)))))))))))
(assert (and (= o (thecurrentdoor (us_private__content state3))) (in_range29 o)))
(assert (= result (ite (= o 1) true false)))
(assert (=> (= result true) (and (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true) (in_range17 auditalarm1))))
(assert (=> (= result true) (and (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range17 auditalarm2))))
(assert (=> (= result true) (= result1 (mk_int__ref status))))
(assert (=> (= result true) (= status2 8)))
(assert (=> (= result true) (and (and (= (and (and (= (islocked currentlatch2 (let ((subject state2)) state14) latchtimeout__split_fields5) true) (= (thecurrentdoor (let ((subject state3)) state15)) 0)) (= (greaterthanorequal (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (alarm_timeout (let ((subject state3)) state15))) true)) (= (thedooralarm (let ((subject state3)) state15)) 0)) (= (islocked currentlatch2 (let ((subject state2)) state14) latchtimeout__split_fields5) true)) (and (and (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range17 auditalarm3)) (in_range28 currentlatch2)))))
(assert (=> (= result true) (and (not (= (ispresent (mk___rep theadmin__split_fields3)) true)) (not (= (isdoingop (mk___rep theadmin__split_fields3)) true)))))
(assert (=> (= result true) (= o1 (extractuser tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields)))))
(assert (=> (= result true) (and (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true) (in_range17 auditalarm4))))
(assert (=> (= result true) (and (and (not (= (isgood tokenpresence2 (let ((subject state1)) state18) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true)) (and (not (= (authcertvalid tokenpresence2 (let ((subject state1)) state18) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true)) (not (in_range7 (theauthcertrole tokenpresence2 (let ((subject state1)) state18) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)))))) (and (and (in_range27 tokentry2) (in_range26 tokenid2)) (in_range25 tokenpresence2)))))
(assert (=> (not (= result true)) (and (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true) (in_range17 auditalarm5))))
(assert (=> (not (= result true)) (= (let ((subject state6)) (mk___private__ref state17)) state6)))
(assert (=> (not (= result true)) (= (let ((subject state5)) (mk___private__ref state12)) (let ((subject state5)) (mk___private__ref state20)))))
(assert (=> (not (= result true)) (= (let ((subject state4)) (mk___private__ref state13)) state4)))
(assert (=> (not (= result true)) (= (let ((subject state3)) (mk___private__ref state15)) state3)))
(assert (=> (not (= result true)) (= (let ((subject state2)) (mk___private__ref state14)) state2)))
(assert (=> (not (= result true)) (= (let ((subject state1)) (mk___private__ref state18)) state1)))
(assert (=> (not (= result true)) (= (let ((subject state)) (mk___private__ref state16)) (let ((subject state)) (mk___private__ref state19)))))
(assert (=> (not (= result true)) (= filestate filestate1)))
(assert (=> (not (= result true)) (= theadmin__split_fields3 (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
(assert (=> (not (= result true)) (= status2 status)))
(assert (=> (not (= result true)) (= latchtimeout__split_fields5 (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))))
(assert (=> (not (= result true)) (= currentlatch2 currentlatch)))
(assert (=> (not (= result true)) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref8 idcert__split_fields2)) idcert__split_fields)))
(assert (=> (not (= result true)) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref11 authcert__split_fields2)) authcert__split_fields)))
(assert (=> (not (= result true)) (= tokenid2 tokenid)))
(assert (=> (not (= result true)) (= tokentry2 tokentry)))
(assert (=> (not (= result true)) (= tokenpresence2 tokenpresence)))
(assert (=> (not (= result true)) (= auditsystemfault auditsystemfault1)))
(assert (=> (not (= result true)) (= auditalarm4 auditalarm5)))
(assert (=> (not (= result true)) (= logfilestate__split_fields10 logfilestate__split_fields11)))
(assert (=> (not (= result true)) (= logfilesstatus logfilesstatus1)))
(assert (=> (not (= result true)) (= logfiles logfiles1)))
(assert (=> (not (= result true)) (= state17 state11)))
(assert (=> (not (= result true)) (= state12 state20)))
(assert (=> (not (= result true)) (= state13 state10)))
(assert (=> (not (= result true)) (= state15 state9)))
(assert (=> (not (= result true)) (= state14 state8)))
(assert (=> (not (= result true)) (= state18 state7)))
(assert (=> (not (= result true)) (= state16 state19)))
(assert (=> (not (= result true)) (= filestate filestate1)))
(assert (=> (not (= result true)) (= theadmin__split_fields3 theadmin__split_fields2)))
(assert (=> (not (= result true)) (= status2 status1)))
(assert (=> (not (= result true)) (= latchtimeout__split_fields5 latchtimeout__split_fields4)))
(assert (=> (not (= result true)) (= currentlatch2 currentlatch1)))
(assert (=> (not (= result true)) (= idcert__split_fields2 idcert__split_fields1)))
(assert (=> (not (= result true)) (= authcert__split_fields2 authcert__split_fields1)))
(assert (=> (not (= result true)) (= tokenid2 tokenid1)))
(assert (=> (not (= result true)) (= tokentry2 tokentry1)))
(assert (=> (not (= result true)) (= tokenpresence2 tokenpresence1)))
(assert (=> (not (= result true)) (= auditsystemfault auditsystemfault1)))
(assert (=> (not (= result true)) (= auditalarm4 auditalarm5)))
(assert (=> (not (= result true)) (= logfilestate__split_fields10 logfilestate__split_fields11)))
(assert (=> (not (= result true)) (= logfilesstatus logfilesstatus1)))
(assert (=> (not (= result true)) (= logfiles logfiles1)))
(assert (= state27 (let ((subject state6)) (mk___private__ref state17))))
(assert (= state26 (let ((subject state5)) (mk___private__ref state12))))
(assert (= state25 (let ((subject state4)) (mk___private__ref state13))))
(assert (= state24 (let ((subject state3)) (mk___private__ref state15))))
(assert (= state23 (let ((subject state2)) (mk___private__ref state14))))
(assert (= state22 (let ((subject state1)) (mk___private__ref state18))))
(assert (= state21 (let ((subject state)) (mk___private__ref state16))))
...
(assert (= idcert__split_fields3 (let ((subject idcert__split_fields)) (mk___split_fields__ref8 idcert__split_fields2))))
(assert (= authcert__split_fields3 (let ((subject authcert__split_fields)) (mk___split_fields__ref11 authcert__split_fields2))))
...
(assert (= auditalarm6 (mk_int__ref auditalarm4)))
(assert (= logfilestate__split_fields12 (mk___split_fields__ref3 logfilestate__split_fields10)))
(assert (= logfilesstatus2 (mk_map__ref1 logfilesstatus)))
(assert (= logfiles2 (mk_map__ref4 logfiles)))
(assert (= state34 state17))
(assert (= state33 state12))
(assert (= state32 state13))
(assert (= state31 state15))
(assert (= state30 state14))
(assert (= state29 state18))
(assert (= state28 state16))
...
(assert (= auditalarm7 auditalarm4))
(assert (= logfilestate__split_fields13 logfilestate__split_fields10))
(assert (= logfilesstatus3 logfilesstatus))
(assert (= logfiles3 logfiles))
(assert (and (= o48 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range4 o48) (= o48 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result2 (ite (= o48 1) true false)))
(assert (=> (= result2 true) (and (= o52 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o52 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result2 true) (= o53 (ite (not (= o52 true)) true false))))
(assert (=> (= result2 true) (and (= o49 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range6 o49))))
(assert (=> (= result2 true) (= o50 (ite (= o49 3) true false))))
(assert (=> (= result2 true) (and (= o51 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o51 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result2 true) (= o54 (ite (= o51 true) o50 false))))
(assert (=> (= result2 true) (= o55 (ite (= o54 false) o53 true))))
(assert (=> (not (= result2 true)) (= o55 (distinct 1 0))))
(assert (and (= result4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result4 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (=> (= result4 true) (and (= o45 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range6 o45))))
(assert (=> (= result4 true) (= result3 (ite (= o45 3) true false))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (=> (= result3 true) (and (= o46 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range4 o46) (= o46 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result3 true) (= o47 (ite (= o46 1) true false))))
(assert (=> (not (= result3 true)) (= o47 (distinct 1 0))))
(assert (and (= o37 (islocked (int__content currentlatch3) (us_private__content state23) (us_split_fields__content1 latchtimeout__split_fields6))) (= (= o37 true) (= (int__content currentlatch3) 0))))
(assert (= o38 (ite (not (= o37 true)) true false)))
(assert (= result5 (ite (= o38 true) (islocked currentlatch (us_private__content state2) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (=> (= result5 true) (and (= o41 (theauthcertrole (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content11 authcert__split_fields3) (us_split_fields__content8 idcert__split_fields3))) (and (in_range4 o41) (= o41 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content11 authcert__split_fields3))))))))
(assert (=> (= result5 true) (= o42 (ite (= o41 1) true false))))
(assert (=> (= result5 true) (and (= o39 (authcertvalid (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content11 authcert__split_fields3) (us_split_fields__content8 idcert__split_fields3))) (= (= o39 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content11 authcert__split_fields3)) true)))))
(assert (=> (= result5 true) (and (= o40 (isgood (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content11 authcert__split_fields3) (us_split_fields__content8 idcert__split_fields3))) (= (= o40 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content8 idcert__split_fields3)) true)))))
(assert (=> (= result5 true) (= o43 (ite (= o40 true) o39 false))))
(assert (=> (= result5 true) (= o44 (ite (= o43 true) o42 false))))
(assert (=> (not (= result5 true)) (= o44 (distinct 1 0))))
(assert (and (= o30 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range4 o30) (= o30 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result6 (ite (= o30 1) true false)))
(assert (=> (= result6 true) (and (= o33 (theauthcertrole (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content11 authcert__split_fields3) (us_split_fields__content8 idcert__split_fields3))) (and (in_range4 o33) (= o33 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content11 authcert__split_fields3))))))))
(assert (=> (= result6 true) (= o34 (ite (= o33 1) true false))))
(assert (=> (= result6 true) (and (= o31 (authcertvalid (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content11 authcert__split_fields3) (us_split_fields__content8 idcert__split_fields3))) (= (= o31 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content11 authcert__split_fields3)) true)))))
(assert (=> (= result6 true) (and (= o32 (isgood (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content11 authcert__split_fields3) (us_split_fields__content8 idcert__split_fields3))) (= (= o32 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content8 idcert__split_fields3)) true)))))
(assert (=> (= result6 true) (= o35 (ite (= o32 true) o31 false))))
(assert (=> (= result6 true) (= o36 (ite (= o35 true) o34 false))))
(assert (=> (not (= result6 true)) (= o36 (distinct 1 0))))
(assert (and (= o25 (thedooralarm (us_private__content state24))) (in_range17 o25)))
(assert (= o26 (ite (= o25 0) true false)))
(assert (= o27 (ite o26 1 0)))
(assert (= o21 (alarm_timeout (us_private__content state24))))
(assert (and (= o20 (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime)) (= o20 (mk___rep1 (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3)))))
(assert (and (= o22 (greaterthanorequal o20 o21)) (= (= o22 true) (or (= (greaterthan o20 o21) true) (= (bool_eq3 o20 o21) true)))))
(assert (and (= o17 (thecurrentdoor (us_private__content state24))) (in_range29 o17)))
(assert (= o18 (ite (= o17 0) true false)))
(assert (and (= o19 (islocked (int__content currentlatch3) (us_private__content state23) (us_split_fields__content1 latchtimeout__split_fields6))) (= (= o19 true) (= (int__content currentlatch3) 0))))
(assert (= o23 (ite (= o19 true) o18 false)))
(assert (= o24 (ite (= o23 true) o22 false)))
(assert (= o28 (ite o24 1 0)))
(assert (= o29 (ite (= o28 o27) true false)))
(assert (and (= result7 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result7 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (=> (= result7 true) (and (= o13 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range6 o13))))
(assert (=> (= result7 true) (= o14 (ite (= o13 4) true false))))
(assert (=> (not (= result7 true)) (= o14 false)))
(assert (= o15 (ite o14 1 0)))
(assert (= o16 (ite (= o15 (ite (ite (= (int__content status3) 6) true false) 1 0)) true false)))
(assert (=> (= (int__content status3) 8) (and (= o9 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o9 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= (int__content status3) 8) (= o10 (ite (not (= o9 true)) true false))))
(assert (=> (= (int__content status3) 8) (and (= o7 (islocked (int__content currentlatch3) (us_private__content state23) (us_split_fields__content1 latchtimeout__split_fields6))) (= (= o7 true) (= (int__content currentlatch3) 0)))))
(assert (=> (= (int__content status3) 8) (and (= o6 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range4 o6) (= o6 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= (int__content status3) 8) (= o8 (ite (= o6 0) true false))))
(assert (=> (= (int__content status3) 8) (= o11 (ite (= o8 true) o7 false))))
(assert (=> (= (int__content status3) 8) (= o12 (ite (= o11 true) o10 false))))
(assert (=> (not (= (int__content status3) 8)) (= o12 (distinct 1 0))))
(assert (and (= o4 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range4 o4) (= o4 (to_rep2 theadmin__split_fields)))))
(assert (and (= o5 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range4 o5) (= o5 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result12 (ite (= o5 o4) true false)))
(assert (=> (= result12 true) (and (= result11 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result11 true) (in_range7 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (=> (= result11 true) (and (= result10 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result10 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (not (= result11 true)) (= result10 false)))
(assert (=> (= result10 true) (and (= o3 (current_latch (int__content currentlatch3) (us_private__content state23) (us_split_fields__content1 latchtimeout__split_fields6))) (and (in_range28 o3) (= o3 (int__content currentlatch3))))))
(assert (=> (= result10 true) (= result9 (ite (= o3 (current_latch currentlatch (us_private__content state2) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) true false))))
(assert (=> (not (= result10 true)) (= result9 false)))
(assert (=> (= result9 true) (and (= o2 (latch_timeout (int__content currentlatch3) (us_private__content state23) (us_split_fields__content1 latchtimeout__split_fields6))) (= o2 (mk___rep1 (us_split_fields__content1 latchtimeout__split_fields6))))))
(assert (=> (= result9 true) (= result8 (bool_eq3 o2 (latch_timeout currentlatch (us_private__content state2) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))))))
