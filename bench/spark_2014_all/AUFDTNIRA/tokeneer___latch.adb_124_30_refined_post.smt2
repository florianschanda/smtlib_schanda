...
(define-fun dynamic_invariant ((temp___expr_190 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool) (temp___do_typ_inv_189 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 1)) (in_range9 temp___expr_190)))
...
(define-fun dynamic_invariant2 ((temp___expr_1401 Int) (temp___is_init_1397 Bool) (temp___skip_constant_1398 Bool) (temp___do_toplevel_1399 Bool) (temp___do_typ_inv_1400 Bool)) Bool (=> (or (= temp___is_init_1397 true) (<= 0 1)) (in_range10 temp___expr_1401)))
(assert true)
...
(declare-fun temp___String_Literal_1434 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1434 us_void_param) 1)) 76) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 2)) 65)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 3)) 84)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 5)) 72)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 7)) 83)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 8)) 84)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 9)) 65)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 10)) 84)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 11)) 69)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 13)) 67)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 14)) 65)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 15)) 78)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 16)) 78)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 17)) 79)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 18)) 84)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 20)) 66)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 21)) 69)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 23)) 68)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 24)) 69)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 25)) 84)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 26)) 69)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 27)) 82)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 28)) 77)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 29)) 73)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 30)) 78)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 31)) 69)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 32)) 68)) (= (to_rep (select (temp___String_Literal_1434 us_void_param) 33)) 46)) :pattern ((temp___String_Literal_1434 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_1160 Int) (temp___is_init_1156 Bool) (temp___skip_constant_1157 Bool) (temp___do_toplevel_1158 Bool) (temp___do_typ_inv_1159 Bool)) Bool (=> (or (= temp___is_init_1156 true) (<= 0 17)) (in_range7 temp___expr_1160)))
(define-fun dynamic_invariant8 ((temp___expr_1167 Int) (temp___is_init_1163 Bool) (temp___skip_constant_1164 Bool) (temp___do_toplevel_1165 Bool) (temp___do_typ_inv_1166 Bool)) Bool (=> (or (= temp___is_init_1163 true) (<= 1 17)) (in_range5 temp___expr_1167)))
(define-fun dynamic_invariant9 ((temp___expr_1293 Int) (temp___is_init_1289 Bool) (temp___skip_constant_1290 Bool) (temp___do_toplevel_1291 Bool) (temp___do_typ_inv_1292 Bool)) Bool (=> (or (= temp___is_init_1289 true) (<= 0 2)) (in_range4 temp___expr_1293)))
(define-fun dynamic_invariant10 ((temp___expr_1174 Int) (temp___is_init_1170 Bool) (temp___skip_constant_1171 Bool) (temp___do_toplevel_1172 Bool) (temp___do_typ_inv_1173 Bool)) Bool (=> (or (= temp___is_init_1170 true) (<= 0 17408)) (in_range6 temp___expr_1174)))
(define-fun dynamic_invariant11 ((temp___expr_1205 Int) (temp___is_init_1201 Bool) (temp___skip_constant_1202 Bool) (temp___do_toplevel_1203 Bool) (temp___do_typ_inv_1204 Bool)) Bool (=> (or (= temp___is_init_1201 true) (<= 0 1024)) (in_range8 temp___expr_1205)))
(assert true)
...
(assert (forall ((temp___1234 Int)) (=> (dynamic_invariant11 temp___1234 true true true true) (forall ((temp___1235 Int)) (= (select (temp_____aggregate_def_1232 temp___1234) temp___1235) rliteral2)))))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(assert (forall ((temp___1230 Int)) (=> (dynamic_invariant8 temp___1230 true true true true) (forall ((temp___1231 Int)) (= (select (temp_____aggregate_def_1228 temp___1230) temp___1231) rliteral)))))
...
(declare-const systemfault2 bool__ref)
...
(assert (=> (= systemfault true) (and (in_range9 auditalarm2) (= (valid_numberlogentries (to_rep3 logfilestate__split_fields14) (to_rep4 logfilestate__split_fields15) (mk___rep (mk___split_fields logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20) true))))
(assert (=> (not (= systemfault true)) (= filestate2 filestate)))
(assert (=> (not (= systemfault true)) (= state2 state)))
(assert (=> (not (= systemfault true)) (= auditsystemfault2 auditsystemfault)))
(assert (=> (not (= systemfault true)) (= auditalarm2 auditalarm)))
(assert (=> (not (= systemfault true)) (= logfilestate__split_fields logfilestate__split_fields14)))
(assert (=> (not (= systemfault true)) (= logfilestate__split_fields1 logfilestate__split_fields15)))
(assert (=> (not (= systemfault true)) (= logfilestate__split_fields2 logfilestate__split_fields16)))
(assert (=> (not (= systemfault true)) (= logfilestate__split_fields3 logfilestate__split_fields17)))
(assert (=> (not (= systemfault true)) (= logfilestate__split_fields4 logfilestate__split_fields18)))
(assert (=> (not (= systemfault true)) (= logfilestate__split_fields5 logfilestate__split_fields19)))
(assert (=> (not (= systemfault true)) (= logfilestate__split_fields6 logfilestate__split_fields20)))
(assert (=> (not (= systemfault true)) (= logfilesstatus2 logfilesstatus)))
(assert (=> (not (= systemfault true)) (= logfiles2 logfiles)))
(assert (=> (not (= systemfault true)) (= filestate2 filestate1)))
(assert (=> (not (= systemfault true)) (= state2 state1)))
(assert (=> (not (= systemfault true)) (= auditsystemfault2 auditsystemfault1)))
(assert (=> (not (= systemfault true)) (= auditalarm2 auditalarm1)))
(assert (=> (not (= systemfault true)) (= logfilestate__split_fields7 logfilestate__split_fields14)))
(assert (=> (not (= systemfault true)) (= logfilestate__split_fields8 logfilestate__split_fields15)))
(assert (=> (not (= systemfault true)) (= logfilestate__split_fields9 logfilestate__split_fields16)))
(assert (=> (not (= systemfault true)) (= logfilestate__split_fields10 logfilestate__split_fields17)))
(assert (=> (not (= systemfault true)) (= logfilestate__split_fields11 logfilestate__split_fields18)))
(assert (=> (not (= systemfault true)) (= logfilestate__split_fields12 logfilestate__split_fields19)))
(assert (=> (not (= systemfault true)) (= logfilestate__split_fields13 logfilestate__split_fields20)))
(assert (=> (not (= systemfault true)) (= logfilesstatus2 logfilesstatus1)))
(assert (=> (not (= systemfault true)) (= logfiles2 logfiles1)))
...
(assert (= systemfault2 (mk_bool__ref systemfault)))
...
(assert (= logfilesstatus2 logfilesstatus3))
(assert (= logfiles2 logfiles3))
...
(assert (not (or (= (= (islocked1 currentlatch) true) (= (islocked Tuple0) true)) (= (bool__content systemfault2) true))))
(check-sat)
(exit)
