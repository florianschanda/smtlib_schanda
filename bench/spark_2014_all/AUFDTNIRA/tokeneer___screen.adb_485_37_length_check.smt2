...
(declare-const temp___1996 (Array Int character))
(declare-const temp___19961 t3)
(declare-const temp___1998 Int)
(declare-const o7 (Array Int character))
(declare-const temp___1999 (Array Int character))
(declare-const temp___19991 t3)
...
(assert (= (ite (<= (to_rep1 (first8 temp___19951)) (to_rep1 (last8 temp___19951))) (+ (- (to_rep1 (last8 temp___19951)) (to_rep1 (first8 temp___19951))) 1) 0) (ite (<= 1 (- (to_rep1 data__last) 1)) (+ (- (- (to_rep1 data__last) 1) 1) 1) 0)))
(assert (= (slide temp___1995 (to_rep1 (first8 temp___19951)) 1) temp___1996))
(assert (= (mk3 1 (- (to_rep1 data__last) 1)) temp___19961))
(assert (and (= temp___1998 (- (to_rep1 data__last) 1)) (in_range (- (to_rep1 data__last) 1))))
(assert (=> (<= 1 temp___1998) (and (and (<= 1 1) (<= 1 15)) (and (<= 1 temp___1998) (<= temp___1998 15)))))
(assert (= o7 result__1))
(assert (= o7 temp___1999))
(assert (= (mk3 1 temp___1998) temp___19991))
(assert (not (= (ite (<= (to_rep1 (first6 temp___19961)) (to_rep1 (last6 temp___19961))) (+ (- (to_rep1 (last6 temp___19961)) (to_rep1 (first6 temp___19961))) 1) 0) (ite (<= (to_rep1 (first6 temp___19991)) (to_rep1 (last6 temp___19991))) (+ (- (to_rep1 (last6 temp___19991)) (to_rep1 (first6 temp___19991))) 1) 0))))
(check-sat)
(exit)
