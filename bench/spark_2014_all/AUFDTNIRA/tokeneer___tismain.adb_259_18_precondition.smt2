...
(define-fun t__ref___2__projection ((a t__ref1)) us_rep2 (t__content1 a))
...
(assert (forall ((a (Array Int us_rep2))) (forall ((first2 Int)) (! (= (slide1 a first2 first2) a) :pattern ((slide1 a first2 first2))))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_195 Int)) (=> (and (<= a__first temp___idx_195) (<= temp___idx_195 a__last)) (= (to_rep9 (select a temp___idx_195)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_195)))))))))))
...
(define-fun bool_eq8 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (bool_eq7 (rec__auditlog__logfilelistt__list (us_split_fields5 a)) 1 17 (rec__auditlog__logfilelistt__list (us_split_fields5 b)) 1 17) true) (= (to_rep9 (rec__auditlog__logfilelistt__head (us_split_fields5 a))) (to_rep9 (rec__auditlog__logfilelistt__head (us_split_fields5 b))))) (= (to_rep9 (rec__auditlog__logfilelistt__lasti (us_split_fields5 a))) (to_rep9 (rec__auditlog__logfilelistt__lasti (us_split_fields5 b))))) (= (to_rep11 (rec__auditlog__logfilelistt__length (us_split_fields5 a))) (to_rep11 (rec__auditlog__logfilelistt__length (us_split_fields5 b))))) true false))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq9 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep12 (select a temp___idx_196)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_196)))))))))))
...
(define-fun bool_eq10 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (= (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 a))) (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 b)))) (= (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 a))) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 b))))) (= (bool_eq8 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 b))) true)) (= (bool_eq9 (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 b)) 1 17) true)) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_648 Int) (temp___is_init_644 Bool) (temp___skip_constant_645 Bool) (temp___do_toplevel_646 Bool) (temp___do_typ_inv_647 Bool)) Bool (=> (or (= temp___is_init_644 true) (<= 0 1)) (in_range17 temp___expr_648)))
...
(define-fun dynamic_invariant2 ((temp___expr_1352 us_rep4) (temp___is_init_1348 Bool) (temp___skip_constant_1349 Bool) (temp___do_toplevel_1350 Bool) (temp___do_typ_inv_1351 Bool)) Bool (=> (= temp___do_typ_inv_1351 true) (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1352))) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1352))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1352)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1352))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1356 us_rep4) (temp___skip_top_level_1357 Bool)) Bool (and (and (and (= (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1356))) 1) (= (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1356))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1356)) (mk___rep2 (mk___split_fields2 (temp_____aggregate_def_1358 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1356)) (temp_____aggregate_def_1362 0))))
(define-fun type_invariant ((temp___1366 us_rep4)) Bool (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1366))) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1366))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1366)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1366))) true))
...
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__certtypes__idt__issuer us_rep5) (rec__certtypes__idt__serialnumber serialnumbert)))))
(define-fun us_split_fields_Issuer__projection ((a us_split_fields12)) us_rep5 (rec__certtypes__idt__issuer a))
...
(define-fun bool_eq13 ((a us_rep7) (b us_rep7)) Bool (ite (and (= (bool_eq11 (rec__certtypes__idt__issuer (us_split_fields13 a)) (rec__certtypes__idt__issuer (us_split_fields13 b))) true) (= (to_rep15 (rec__certtypes__idt__serialnumber (us_split_fields13 a))) (to_rep15 (rec__certtypes__idt__serialnumber (us_split_fields13 b))))) true false))
...
(declare-fun to_rep16 (classt) Int)
(declare-fun of_rep16 (Int) classt)
(assert (forall ((x classt)) (! (= (of_rep16 (to_rep16 x)) x) :pattern ((to_rep16 x)))))
(assert (forall ((x classt)) (! (in_range21 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(define-fun us_rep___projection ((a us_rep8)) us_split_fields14 (us_split_fields15 a))
(define-fun bool_eq14 ((a us_rep8) (b us_rep8)) Bool (ite (= (to_rep16 (rec__privtypes__clearancet__class (us_split_fields15 a))) (to_rep16 (rec__privtypes__clearancet__class (us_split_fields15 b)))) true false))
...
(declare-fun user_eq33 (us_rep8 us_rep8) Bool)
(declare-const dummy33 us_rep8)
(declare-datatypes () ((clearancet__ref (mk_clearancet__ref (clearancet__content us_rep8)))))
(define-fun clearancet__ref___projection ((a clearancet__ref)) us_rep8 (clearancet__content a))
...
(assert (forall ((x algorithmt)) (! (in_range22 (to_rep17 x)) :pattern ((to_rep17 x)))))
(assert (forall ((x Int)) (! (=> (in_range22 x) (= (to_rep17 (of_rep17 x)) x)) :pattern ((to_rep17 (of_rep17 x))))))
(declare-datatypes () ((us_split_fields16 (mk___split_fields8 (rec__cert__attr__auth__contentst__id us_rep7) (rec__cert__attr__auth__contentst__notbefore us_rep1) (rec__cert__attr__auth__contentst__notafter us_rep1) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep7) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep8)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields16)) us_rep7 (rec__cert__attr__auth__contentst__id a))
...
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields16)) us_rep7 (rec__cert__attr__auth__contentst__basecertid a))
(define-fun us_split_fields_Role__projection ((a us_split_fields16)) privileget (rec__cert__attr__auth__contentst__role a))
(define-fun us_split_fields_Clearance__projection ((a us_split_fields16)) us_rep8 (rec__cert__attr__auth__contentst__clearance a))
...
(define-fun bool_eq15 ((a us_rep9) (b us_rep9)) Bool (ite (and (and (and (and (and (and (= (bool_eq13 (rec__cert__attr__auth__contentst__id (us_split_fields17 a)) (rec__cert__attr__auth__contentst__id (us_split_fields17 b))) true) (= (bool_eq3 (rec__cert__attr__auth__contentst__notbefore (us_split_fields17 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields17 b))) true)) (= (bool_eq3 (rec__cert__attr__auth__contentst__notafter (us_split_fields17 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields17 b))) true)) (= (to_rep17 (rec__cert__attr__auth__contentst__mechanism (us_split_fields17 a))) (to_rep17 (rec__cert__attr__auth__contentst__mechanism (us_split_fields17 b))))) (= (bool_eq13 (rec__cert__attr__auth__contentst__basecertid (us_split_fields17 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields17 b))) true)) (= (to_rep2 (rec__cert__attr__auth__contentst__role (us_split_fields17 a))) (to_rep2 (rec__cert__attr__auth__contentst__role (us_split_fields17 b))))) (= (bool_eq14 (rec__cert__attr__auth__contentst__clearance (us_split_fields17 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields17 b))) true)) true false))
...
(assert (forall ((x keyidt)) (! (in_range23 (to_rep18 x)) :pattern ((to_rep18 x)))))
...
(define-fun in_range24 ((x Int)) Bool (and (<= 0 x) (<= x 128)))
...
(assert (forall ((x keylengtht)) (! (in_range24 (to_rep19 x)) :pattern ((to_rep19 x)))))
...
(define-fun bool_eq17 ((a us_rep11) (b us_rep11)) Bool (ite (and (and (= (to_rep17 (rec__cryptotypes__keypartt__algorithmid (us_split_fields21 a))) (to_rep17 (rec__cryptotypes__keypartt__algorithmid (us_split_fields21 b)))) (= (to_rep18 (rec__cryptotypes__keypartt__keyid (us_split_fields21 a))) (to_rep18 (rec__cryptotypes__keypartt__keyid (us_split_fields21 b))))) (= (to_rep19 (rec__cryptotypes__keypartt__keylength (us_split_fields21 a))) (to_rep19 (rec__cryptotypes__keypartt__keylength (us_split_fields21 b))))) true false))
...
(define-fun bool_eq18 ((a us_rep12) (b us_rep12)) Bool (ite (and (and (and (and (and (= (bool_eq13 (rec__cert__id__contentst__id (us_split_fields23 a)) (rec__cert__id__contentst__id (us_split_fields23 b))) true) (= (bool_eq3 (rec__cert__id__contentst__notbefore (us_split_fields23 a)) (rec__cert__id__contentst__notbefore (us_split_fields23 b))) true)) (= (bool_eq3 (rec__cert__id__contentst__notafter (us_split_fields23 a)) (rec__cert__id__contentst__notafter (us_split_fields23 b))) true)) (= (to_rep17 (rec__cert__id__contentst__mechanism (us_split_fields23 a))) (to_rep17 (rec__cert__id__contentst__mechanism (us_split_fields23 b))))) (= (bool_eq11 (rec__cert__id__contentst__subject (us_split_fields23 a)) (rec__cert__id__contentst__subject (us_split_fields23 b))) true)) (= (bool_eq17 (rec__cert__id__contentst__subjectpublickey (us_split_fields23 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields23 b))) true)) true false))
...
(define-fun dynamic_invariant4 ((temp___expr_634 Int) (temp___is_init_630 Bool) (temp___skip_constant_631 Bool) (temp___do_toplevel_632 Bool) (temp___do_typ_inv_633 Bool)) Bool (=> (or (= temp___is_init_630 true) (<= 0 4294967295)) (in_range26 temp___expr_634)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant5 ((temp___expr_641 Int) (temp___is_init_637 Bool) (temp___skip_constant_638 Bool) (temp___do_toplevel_639 Bool) (temp___do_typ_inv_640 Bool)) Bool (=> (or (= temp___is_init_637 true) (<= 0 2)) (in_range27 temp___expr_641)))
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields18)) (forall ((admintoken__idcert__fields us_split_fields24)) (! (=> (and (and (dynamic_invariant3 admintoken__tokenpresence true true true true) (dynamic_invariant5 admintoken__tokentry true true true true)) (dynamic_invariant4 admintoken__tokenid true true true true)) (dynamic_invariant (theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true false true true)) :pattern ((theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields18)) (forall ((admintoken__idcert__fields us_split_fields24)) (! (=> (and (and (dynamic_invariant3 admintoken__tokenpresence true true true true) (dynamic_invariant5 admintoken__tokentry true true true true)) (dynamic_invariant4 admintoken__tokenid true true true true)) (= (theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) (therole (rec__admintoken__validauthcertt__contents (us_split_fields19 (mk___rep9 admintoken__authcert__fields)))))) :pattern ((theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
...
(define-fun dynamic_invariant6 ((temp___expr_2141 Int) (temp___is_init_2137 Bool) (temp___skip_constant_2138 Bool) (temp___do_toplevel_2139 Bool) (temp___do_typ_inv_2140 Bool)) Bool (=> (or (= temp___is_init_2137 true) (<= 0 1)) (in_range28 temp___expr_2141)))
...
(define-fun in_range29 ((x Int)) Bool (and (<= 0 x) (<= x 2147483647)))
...
(define-fun to_rep20 ((x statscount)) Int (statscountqtint x))
(declare-fun of_rep20 (Int) statscount)
(assert (forall ((x statscount)) (! (= (of_rep20 (to_rep20 x)) x) :pattern ((to_rep20 x)))))
(assert (forall ((x statscount)) (! (in_range29 (to_rep20 x)) :pattern ((to_rep20 x)))))
...
(define-fun bool_eq20 ((a us_rep14) (b us_rep14)) Bool (ite (and (and (and (= (to_rep20 (rec__stats__t__successentry (us_split_fields27 a))) (to_rep20 (rec__stats__t__successentry (us_split_fields27 b)))) (= (to_rep20 (rec__stats__t__failentry (us_split_fields27 a))) (to_rep20 (rec__stats__t__failentry (us_split_fields27 b))))) (= (to_rep20 (rec__stats__t__successbio (us_split_fields27 a))) (to_rep20 (rec__stats__t__successbio (us_split_fields27 b))))) (= (to_rep20 (rec__stats__t__failbio (us_split_fields27 a))) (to_rep20 (rec__stats__t__failbio (us_split_fields27 b))))) true false))
...
(declare-datatypes () ((t__ref3 (mk_t__ref3 (t__content3 us_rep14)))))
(define-fun t__ref___5__projection ((a t__ref3)) us_rep14 (t__content3 a))
...
(define-fun dynamic_invariant7 ((temp___expr_2880 Int) (temp___is_init_2876 Bool) (temp___skip_constant_2877 Bool) (temp___do_toplevel_2878 Bool) (temp___do_typ_inv_2879 Bool)) Bool (=> (or (= temp___is_init_2876 true) (<= 0 8)) (in_range30 temp___expr_2880)))
(assert true)
...
(define-fun in_range31 ((x Int)) Bool (and (<= 0 x) (<= x 2)))
...
(declare-fun user_eq49 (enrolmentstates enrolmentstates) Bool)
(declare-const dummy49 enrolmentstates)
...
(assert true)
(assert (forall ((enclave__status Int)) (forall ((enclave__state us_private)) (! (= (= (enrolmentisinprogress enclave__status enclave__state) true) (in_range31 enclave__status)) :pattern ((enrolmentisinprogress enclave__status enclave__state))))))
...
(define-fun in_range32 ((x Int)) Bool (and (<= 1 x) (<= x 150)))
...
(declare-fun user_eq50 (descriptioni descriptioni) Bool)
(declare-const dummy50 descriptioni)
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_184 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_184 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 3)) 85)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 4)) 115)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 28)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 29)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 39)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 41)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 44)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 45)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 47)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 48)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 49)) 32)) (= (to_rep (select (temp___String_Literal_184 us_void_param) 50)) 32)) :pattern ((temp___String_Literal_184 us_void_param)))))
...
(define-fun dynamic_invariant16 ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 40)) (in_range18 temp___expr_548)))
(define-fun dynamic_invariant17 ((temp___expr_572 Int) (temp___is_init_568 Bool) (temp___skip_constant_569 Bool) (temp___do_toplevel_570 Bool) (temp___do_typ_inv_571 Bool)) Bool (=> (or (= temp___is_init_568 true) (<= 0 4294967295)) (in_range19 temp___expr_572)))
(define-fun dynamic_invariant18 ((temp___expr_596 Int) (temp___is_init_592 Bool) (temp___skip_constant_593 Bool) (temp___do_toplevel_594 Bool) (temp___do_typ_inv_595 Bool)) Bool (=> (or (= temp___is_init_592 true) (<= 0 10)) (in_range22 temp___expr_596)))
(define-fun dynamic_invariant19 ((temp___expr_610 Int) (temp___is_init_606 Bool) (temp___skip_constant_607 Bool) (temp___do_toplevel_608 Bool) (temp___do_typ_inv_609 Bool)) Bool (=> (or (= temp___is_init_606 true) (<= 0 4294967295)) (in_range23 temp___expr_610)))
(define-fun dynamic_invariant20 ((temp___expr_617 Int) (temp___is_init_613 Bool) (temp___skip_constant_614 Bool) (temp___do_toplevel_615 Bool) (temp___do_typ_inv_616 Bool)) Bool (=> (or (= temp___is_init_613 true) (<= 0 128)) (in_range24 temp___expr_617)))
(define-fun dynamic_invariant21 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 0 17)) (in_range15 temp___expr_1290)))
(define-fun dynamic_invariant22 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 1 17)) (in_range13 temp___expr_1297)))
(define-fun dynamic_invariant23 ((temp___expr_1423 Int) (temp___is_init_1419 Bool) (temp___skip_constant_1420 Bool) (temp___do_toplevel_1421 Bool) (temp___do_typ_inv_1422 Bool)) Bool (=> (or (= temp___is_init_1419 true) (<= 0 2)) (in_range12 temp___expr_1423)))
(define-fun dynamic_invariant24 ((temp___expr_1304 Int) (temp___is_init_1300 Bool) (temp___skip_constant_1301 Bool) (temp___do_toplevel_1302 Bool) (temp___do_typ_inv_1303 Bool)) Bool (=> (or (= temp___is_init_1300 true) (<= 0 17408)) (in_range14 temp___expr_1304)))
(define-fun dynamic_invariant25 ((temp___expr_1335 Int) (temp___is_init_1331 Bool) (temp___skip_constant_1332 Bool) (temp___do_toplevel_1333 Bool) (temp___do_typ_inv_1334 Bool)) Bool (=> (or (= temp___is_init_1331 true) (<= 0 1024)) (in_range16 temp___expr_1335)))
(assert true)
...
(assert (forall ((temp___1364 Int)) (=> (dynamic_invariant25 temp___1364 true true true true) (forall ((temp___1365 Int)) (= (select (temp_____aggregate_def_1362 temp___1364) temp___1365) rliteral2)))))
(define-fun dynamic_invariant26 ((temp___expr_673 Int) (temp___is_init_669 Bool) (temp___skip_constant_670 Bool) (temp___do_toplevel_671 Bool) (temp___do_typ_inv_672 Bool)) Bool (=> (or (= temp___is_init_669 true) (<= 1 150)) (in_range32 temp___expr_673)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (forall ((temp___182 Int)) (=> (dynamic_invariant9 temp___182 true true true true) (forall ((temp___183 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___182) temp___183)) temp___182)))))
(assert (= nouser (temp___String_Literal_184 Tuple0)))
(define-fun dynamic_invariant27 ((temp___expr_725 Int) (temp___is_init_721 Bool) (temp___skip_constant_722 Bool) (temp___do_toplevel_723 Bool) (temp___do_typ_inv_724 Bool)) Bool (=> (or (= temp___is_init_721 true) (<= 1901 2099)) (in_range8 temp___expr_725)))
(define-fun dynamic_invariant28 ((temp___expr_732 Int) (temp___is_init_728 Bool) (temp___skip_constant_729 Bool) (temp___do_toplevel_730 Bool) (temp___do_typ_inv_731 Bool)) Bool (=> (or (= temp___is_init_728 true) (<= 1 12)) (in_range9 temp___expr_732)))
(define-fun dynamic_invariant29 ((temp___expr_739 Int) (temp___is_init_735 Bool) (temp___skip_constant_736 Bool) (temp___do_toplevel_737 Bool) (temp___do_typ_inv_738 Bool)) Bool (=> (or (= temp___is_init_735 true) (<= 1 31)) (in_range10 temp___expr_739)))
(define-fun dynamic_invariant30 ((temp___expr_771 Int) (temp___is_init_767 Bool) (temp___skip_constant_768 Bool) (temp___do_toplevel_769 Bool) (temp___do_typ_inv_770 Bool)) Bool (=> (or (= temp___is_init_767 true) (<= 0 86399999)) (in_range11 temp___expr_771)))
...
(assert (forall ((contents us_rep9)) (! (dynamic_invariant (therole contents) true false true true) :pattern ((therole contents)))))
...
(define-fun dynamic_invariant32 ((temp___expr_2967 Int) (temp___is_init_2963 Bool) (temp___skip_constant_2964 Bool) (temp___do_toplevel_2965 Bool) (temp___do_typ_inv_2966 Bool)) Bool (=> (or (= temp___is_init_2963 true) (<= 0 2)) (in_range31 temp___expr_2967)))
(define-fun dynamic_invariant33 ((temp___expr_2369 Int) (temp___is_init_2365 Bool) (temp___skip_constant_2366 Bool) (temp___do_toplevel_2367 Bool) (temp___do_typ_inv_2368 Bool)) Bool (=> (or (= temp___is_init_2365 true) (<= 0 2147483647)) (in_range29 temp___expr_2369)))
(assert (forall ((temp___1360 Int)) (=> (dynamic_invariant22 temp___1360 true true true true) (forall ((temp___1361 Int)) (= (select (temp_____aggregate_def_1358 temp___1360) temp___1361) rliteral)))))
...
(assert (= (temp___String_Literal_184 Tuple0) nouser))
(assert (=> (<= 0 1) (in_range25 tokenpresence)))
(assert (=> (<= 0 2) (in_range27 tokentry)))
(assert (=> (<= 0 4294967295) (in_range26 tokenid)))
...
(assert (=> (<= 0 1) (in_range17 auditalarm)))
(assert (=> (<= 0 1) (in_range28 currentlatch)))
(assert (=> (<= 0 8) (in_range30 status)))
(assert (and (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields1))) true)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields1))) true))))
(assert (and (in_range17 auditalarm1) (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true)))
(assert (and (in_range17 auditalarm2) (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true)))
(assert (and (= o (privatekeypresent thistisinfo__split_fields (let ((subject state)) state3))) (= (= o true) (= (rec__keystore__optionalprivatekeyt__ispresent thistisinfo__split_fields) true))))
(assert (and (= o1 (privatekeypresent thistisinfo__split_fields (let ((subject state)) state3))) (= (= o1 true) (= (rec__keystore__optionalprivatekeyt__ispresent thistisinfo__split_fields) true))))
(assert (and (in_range17 auditalarm3) (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true)))
(assert (in_range28 currentlatch1))
(assert (and (in_range17 auditalarm4) (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true)))
(assert (and (in_range17 auditalarm5) (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true)))
(assert (and (and (and (not (= (isgood tokenpresence1 (let ((subject state1)) state4) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true)) (not (= (authcertvalid tokenpresence1 (let ((subject state1)) state4) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true))) (not (in_range7 (theauthcertrole tokenpresence1 (let ((subject state1)) state4) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1))))) (and (and (in_range26 tokenid1) (in_range25 tokenpresence1)) (in_range27 tokentry1))))
(assert (and (and (= (= (privatekeypresent thistisinfo__split_fields (let ((subject state)) state3)) true) (not (= (enrolmentisinprogress status1 (let ((subject state2)) state5)) true))) (or (= (enrolmentisinprogress status1 (let ((subject state2)) state5)) true) (= (statusisenclavequiescent status1 (let ((subject state2)) state5)) true))) (in_range30 status1)))
(assert (and (= result (privatekeypresent thistisinfo__split_fields (let ((subject state)) state3))) (= (= result true) (= (rec__keystore__optionalprivatekeyt__ispresent thistisinfo__split_fields) true))))
(assert (= result true))
