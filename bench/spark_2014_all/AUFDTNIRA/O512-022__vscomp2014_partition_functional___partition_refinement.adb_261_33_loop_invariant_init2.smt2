...
(assert (<= 0 j))
(assert (<= j 5))
(assert (not (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields1)) (to_rep5 (select f j)))))) j)))
(check-sat)
(exit)
