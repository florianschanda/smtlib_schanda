...
(assert (forall ((i element)) (and (<= 0 (elementqtint i)) (<= (elementqtint i) 100))))
...
(assert (forall ((i telementarrayC)) (and (<= 1 (telementarrayCqtint i)) (<= (telementarrayCqtint i) 100))))
(define-fun in_range4 ((x Int)) Bool (and (<= 1 x) (<= x 100)))
(declare-fun attr__ATTRIBUTE_IMAGE4 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Int)
(declare-fun user_eq3 (telementarrayC telementarrayC) Bool)
(declare-const dummy3 telementarrayC)
(declare-datatypes () ((telementarrayC__ref (mk_telementarrayC__ref (telementarrayC__content telementarrayC)))))
(define-fun telementarrayC__ref___projection ((a telementarrayC__ref)) telementarrayC (telementarrayC__content a))
(define-fun to_rep ((x telementarrayC)) Int (telementarrayCqtint x))
(declare-fun of_rep (Int) telementarrayC)
(assert (forall ((x telementarrayC)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x telementarrayC)) (! (in_range4 (to_rep x)) :pattern ((to_rep x)))))
(assert (forall ((x Int)) (! (=> (in_range4 x) (= (to_rep (of_rep x)) x)) :pattern ((to_rep (of_rep x))))))
(declare-datatypes () ((map__ref (mk_map__ref (map__content (Array Int telementarrayC))))))
(declare-fun slide ((Array Int telementarrayC) Int Int) (Array Int telementarrayC))
(assert (forall ((a (Array Int telementarrayC))) (forall ((first Int)) (! (= (slide a first first) a) :pattern ((slide a first first))))))
(assert (forall ((a (Array Int telementarrayC))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide a old_first new_first) i))))))))
(define-fun bool_eq ((a (Array Int telementarrayC)) (a__first Int) (a__last Int) (b (Array Int telementarrayC)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep (select a temp___idx_154)) (to_rep (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
(assert (forall ((a (Array Int telementarrayC)) (b (Array Int telementarrayC))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep (select a temp___idx_154)) (to_rep (select b (+ (- b__first a__first) temp___idx_154)))))))))))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___177 i1)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___176 max1)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___175 sum1)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (<= sum2 (* (- i2 1) max2))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (and (and (=> (<= 0 2147483647) (in_range2 sum2)) (=> (<= 0 100) (in_range3 max2))) (=> (<= 1 100) (in_range5 i2))) (and (<= 1 i2) (<= i2 100)))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (= o (+ sum2 (to_rep (select a i2)))) (in_range1 (+ sum2 (to_rep (select a i2)))))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= sum2 result3)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= sum3 o)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (=> (< max2 (to_rep (select a i2))) (= max2 result4))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (=> (< max2 (to_rep (select a i2))) (= max3 (to_rep (select a i2))))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (=> (not (< max2 (to_rep (select a i2)))) (= max3 max2))))
