...
(assert (= j7 result5))
(assert (= j8 0))
(assert (=> (and (<= 0 j8) (<= j8 9)) (= temp___2101 j8)))
(assert (=> (and (<= 0 j8) (<= j8 9)) (= temp___2091 r8)))
(assert (=> (and (<= 0 j8) (<= j8 9)) (and (= o1 (+ r8 (to_rep (select (select x i3) j8)))) (in_range4 (+ r8 (to_rep (select (select x i3) j8)))))))
(assert (=> (and (<= 0 j8) (<= j8 9)) (= r8 result6)))
(assert (=> (and (<= 0 j8) (<= j8 9)) (= r9 o1)))
(assert (=> (and (<= 0 j8) (<= j8 9)) (<= r10 (+ (+ (* i3 10) j9) 1))))
(assert (=> (and (<= 0 j8) (<= j8 9)) (and (and (=> (<= 0 100) (in_range4 r10)) (=> (<= 0 9) (in_range3 j9))) (and (<= 0 j9) (<= j9 9)))))
(assert (=> (and (<= 0 j8) (<= j8 9)) (= j9 9)))
(assert (=> (and (<= 0 j8) (<= j8 9)) (= j10 (mk_int__ref j9))))
(assert (=> (and (<= 0 j8) (<= j8 9)) (= r11 (mk_int__ref r10))))
(assert (=> (and (<= 0 j8) (<= j8 9)) (= j11 j9)))
(assert (=> (and (<= 0 j8) (<= j8 9)) (= r12 r10)))
(assert (=> (and (<= 0 j8) (<= j8 9)) (= j12 j10)))
(assert (=> (and (<= 0 j8) (<= j8 9)) (= r13 r11)))
(assert (=> (and (<= 0 j8) (<= j8 9)) (= j13 j11)))
(assert (=> (and (<= 0 j8) (<= j8 9)) (= r14 r12)))
(assert (=> (not (and (<= 0 j8) (<= j8 9))) (= j12 (mk_int__ref j8))))
(assert (=> (not (and (<= 0 j8) (<= j8 9))) (= r13 (mk_int__ref r8))))
(assert (=> (not (and (<= 0 j8) (<= j8 9))) (= j13 j8)))
(assert (=> (not (and (<= 0 j8) (<= j8 9))) (= r14 r8)))
(assert (= j14 j12))
...
(assert (= i5 i3))
(assert (= r16 r14))
(assert (not (<= (int__content r15) (* (+ (int__content i4) 1) 10))))
(check-sat)
(exit)
