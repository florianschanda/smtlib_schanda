...
(assert (not (= (to_rep3 logfilestate__split_fields22) (+ (* (- (to_rep4 logfilestate__split_fields26) 1) 1024) (to_rep5 (select logfilestate__split_fields27 (to_rep2 logfilestate__split_fields21)))))))
(check-sat)
(exit)
