...
(assert (and (<= (to_rep1 (first (rt source))) temp___1840) (<= temp___1840 (to_rep1 (last (rt source))))))
(assert (= o26 temp___1840))
...
(assert (and (= temp___1839 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (not (<= temp___1839 (to_rep1 (last (rt source))))))
(check-sat)
(exit)
