...
(assert (and (= o13 (- i1 (to_rep (first4 (rt2 a))))) (in_range1 (- i1 (to_rep (first4 (rt2 a)))))))
...
(assert (= o10 i1))
(assert (= o11 (select (elts1 (acc_array__content test_higher_order__sum__acc_f__result5)) o10)))
(assert (= o12 (to_rep2 o11)))
(assert (and (= result6 (in_range5 (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))))) o12 o16)) (= (= result6 true) (and (<= (+ (- 2147483648) (* 100 (- (length (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))))) o16))) o12) (<= o12 (- 2147483647 (* 100 (- (length (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))))) o16))))))))
(assert (= result6 true))
(assert (=> (= i1 (to_rep (first4 (rt2 a)))) (= o7 init)))
...
(assert (=> (not (= i1 (to_rep (first4 (rt2 a))))) (= o5 temp___399)))
(assert (=> (not (= i1 (to_rep (first4 (rt2 a))))) (= o6 (select (elts1 (acc_array__content test_higher_order__sum__acc_f__result5)) o5))))
(assert (=> (not (= i1 (to_rep (first4 (rt2 a))))) (= o7 (to_rep2 o6))))
(assert (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))))
(assert (= o3 i1))
