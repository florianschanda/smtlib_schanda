...
(assert (not (= (length1 temp___19872) 0)))
(assert (=> (<= 1 7) (= o (+ (- 7 1) 1))))
(assert (=> (not (<= 1 7)) (= o 0)))
(assert (=> (<= (to_rep1 (first2 temp___19871)) (to_rep1 (last2 temp___19871))) (= o1 (+ (- (to_rep1 (last2 temp___19871)) (to_rep1 (first2 temp___19871))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___19871)) (to_rep1 (last2 temp___19871)))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first2 temp___19871)) o2)))
(assert (= o4 (- o3 1)))
