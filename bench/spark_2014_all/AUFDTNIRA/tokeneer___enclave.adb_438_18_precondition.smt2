...
(assert (=> (= result true) (and (= o2 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o2 true) (in_range6 (to_rep3 theadmin__split_fields1))))))
(assert (=> (= result true) (= o3 (ite (not (= o2 true)) true false))))
(assert (=> (= result true) (and (= result1 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result1 true) (in_range6 (to_rep3 theadmin__split_fields1))))))
(assert (=> (= result true) (=> (= result1 true) (and (= o1 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range6 o1)))))
...
(assert (and (= result2 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result2 true) (in_range6 (to_rep3 theadmin__split_fields1)))))
(assert (= result2 true))
