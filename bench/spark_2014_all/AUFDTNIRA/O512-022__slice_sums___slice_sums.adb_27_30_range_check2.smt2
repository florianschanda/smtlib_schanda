...
(assert (forall ((lo_index1 Int)) (=> (and (<= (to_rep (first (rt x))) lo_index1) (<= lo_index1 (- lo2 1))) (forall ((hi_index1 Int)) (=> (and (<= (to_rep (first (rt x))) hi_index1) (<= hi_index1 (to_rep (last (rt x))))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index1) (of_rep1 hi_index1)))) max_sum2))))))
...
(assert (<= (to_rep (first (rt x))) hi1))
(assert (<= hi1 (to_rep (last (rt x)))))
(assert (and (forall ((lo_index1 Int)) (=> (and (<= (to_rep (first (rt x))) lo_index1) (<= lo_index1 (- lo2 1))) (forall ((hi_index1 Int)) (=> (and (<= (to_rep (first (rt x))) hi_index1) (<= hi_index1 (to_rep (last (rt x))))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index1) (of_rep1 hi_index1)))) max_sum3))))) (forall ((hi_index1 Int)) (=> (and (<= (to_rep (first (rt x))) hi_index1) (<= hi_index1 (- hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo2) (of_rep1 hi_index1)))) max_sum3)))))
(assert (=> (<= (indexqtint (rec__sums__slice_bounds__lo result____split_fields4)) (extended_indexqtint (rec__sums__slice_bounds__hi result____split_fields4))) (and (and (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo result____split_fields4))) (<= (extended_indexqtint (rec__sums__slice_bounds__hi result____split_fields4)) (to_rep (last (rt x))))) (= max_sum3 (sum__logic x (mk_slice_bounds result____split_fields4))))))
(assert (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 current_sum2)) (=> (<= (to_rep (first (rt x))) (to_rep (last (rt x)))) (dynamic_property2 (to_rep (first (rt x))) (to_rep (last (rt x))) hi2))) (=> (<= 0 2147483647) (in_range2 max_sum3))) (and (<= (to_rep (first (rt x))) hi2) (<= hi2 (to_rep (last (rt x)))))))
(assert (and (= o2 (- hi2 1)) (in_range1 (- hi2 1))))
(assert (= o3 (ite (<= hi_index o2) true false)))
(assert (= result4 (ite (<= (to_rep (first (rt x))) hi_index) o3 false)))
(assert (= (= o4 true) (forall ((hi_index1 Int)) (=> (and (<= (to_rep (first (rt x))) hi_index1) (<= hi_index1 (- hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo2) (of_rep1 hi_index1)))) max_sum3)))))
(assert (and (= o (- lo2 1)) (in_range1 (- lo2 1))))
(assert (= o1 (ite (<= lo_index o) true false)))
(assert (= result5 (ite (<= (to_rep (first (rt x))) lo_index) o1 false)))
(assert (= result5 true))
(assert (<= (to_rep (first (rt x))) (to_rep (last (rt x)))))
