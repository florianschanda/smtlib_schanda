...
(assert (forall ((i tTsSP1)) (and (<= 1 (tTsSP1qtint i)) (<= (tTsSP1qtint i) 11))))
...
(declare-const temp___579 (Array Int character))
(declare-const temp___578 Int)
...
(declare-const int__5 Int)
(declare-const s4 (Array Int character))
(declare-const first9 Int)
(declare-const val__4 Int)
(declare-const int__6 Int)
(declare-const s5 (Array Int character))
(declare-const first10 Int)
(declare-const val__5 int__ref)
(declare-const int__7 Int)
(declare-const s6 (Array Int character))
(declare-const first11 Int)
(declare-const val__6 Int)
(declare-const result6 int__ref)
(declare-const first12 Int)
(declare-const result7 map__ref)
(declare-const s7 (Array Int character))
(declare-const s8 map__ref)
(declare-const first13 int__ref)
(declare-const s9 (Array Int character))
(declare-const first14 Int)
(define-fun first15 () int__ref (mk_int__ref first10))
(define-fun s10 () map__ref (mk_map__ref s5))
(assert (in_range x))
...
(assert (= int__1 o))
(assert (= temp___582 val__))
(assert (= temp___581 first5))
(assert (= temp___579 s))
(assert (= temp___578 int__1))
...
(assert (= first15 (mk_int__ref first8)))
(assert (= s10 (mk_map__ref s3)))
(assert (= (mk_int__ref int__6) (mk_int__ref int__4)))
(assert (= val__6 val__4))
(assert (= first11 first9))
(assert (= s6 s4))
(assert (= int__7 int__5))
(assert (=> (< x 0) (and (= o9 (- first10 1)) (in_range3 (- first10 1)))))
(assert (=> (< x 0) (= result6 first15)))
(assert (=> (< x 0) (= first12 o9)))
(assert (=> (< x 0) (= (to_rep o10) 45)))
(assert (=> (< x 0) (and (<= 1 first12) (<= first12 11))))
(assert (=> (< x 0) (= o11 first12)))
(assert (=> (< x 0) (= o12 (store s5 o11 o10))))
(assert (=> (< x 0) (= result7 s10)))
(assert (=> (< x 0) (= s7 o12)))
(assert (=> (< x 0) (= first13 (mk_int__ref first12))))
(assert (=> (< x 0) (= s8 (mk_map__ref s7))))
(assert (=> (< x 0) (= first14 first12)))
(assert (=> (< x 0) (= s9 s7)))
(assert (=> (not (< x 0)) (= first13 first15)))
(assert (=> (not (< x 0)) (= s8 s10)))
(assert (=> (not (< x 0)) (= first14 first11)))
(assert (=> (not (< x 0)) (= s9 s6)))
(assert (= (int__content first13) r1b))
(assert (in_range3 r1b))
(assert (<= r1b 11))
(assert (not (<= 1 r1b)))
(check-sat)
(exit)
