...
(define-fun c2 () us_rep4 (mk___rep2 (mk___split_fields2 c1)))
(define-fun c3 () us_rep1 (mk___rep1 (mk___split_fields1 c)))
(assert (= (mk___rep1 (mk___split_fields1 rliteral)) no_element))
(assert (and (= o7 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o7) (= o7 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o5 (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o5) (<= o5 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (= o6 (* 2 o5)))
(assert (and (= o8 o6) (in_range11 o6)))
(assert (= result (ite (<= o8 o7) true false)))
(assert (= result true))
(assert (and (= o4 (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o4) (<= o4 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
...
(assert (= result2 true))
(assert (and (= o2 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2)) (= (= o2 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2) true))))
(assert (= o3 true))
(assert (= result4 (ite (= o3 true) o2 false)))
(assert (= (= result3 true) (forall ((c4 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c4) true) (= (to_rep (select a (element1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c4))) (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c4))))))
(assert (= result3 true))
(assert (and (= o (has_key (positions x) c3)) (= (= o true) (= (has_key (positions x) c3) true))))
(assert (= o1 true))
(assert (= result6 (ite (= o1 true) o false)))
(assert (= (= result5 true) (forall ((c4 us_rep1)) (=> (= (has_key (positions x) c4) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (element x c4)) true)))))
(assert (= result5 true))
(assert (= (= result7 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= 0 (to_rep5 (select f j1))) (<= (to_rep5 (select f j1)) (- (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 1)))))))
(assert (= result7 true))
(assert (<= 0 j))
(assert (<= j 5))
(assert (not (<= 0 (to_rep5 (select f j)))))
(check-sat)
(exit)
