...
(assert (forall ((lo_index1 Int)) (=> (and (<= (to_rep (first (rt x))) lo_index1) (<= lo_index1 (- current_hi2 1))) (forall ((hi_index Int)) (=> (and (<= (to_rep (first (rt x))) hi_index) (<= hi_index (- current_hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index1) (of_rep1 hi_index)))) max_sum2))))))
...
(assert (= (extended_indexqtint o4) (- current_lo2 1)))
(assert (= (indexqtint o5) lo_index))
(assert (= o5 o6))
(assert (= o4 o7))
(assert (= o8 (mk_slice_bounds (mk___split_fields o6 o7))))
(assert (not (or (< (extended_indexqtint (rec__sums__slice_bounds__hi (us_split_fields1 o8))) (indexqtint (rec__sums__slice_bounds__lo (us_split_fields1 o8)))) (and (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo (us_split_fields1 o8)))) (<= (extended_indexqtint (rec__sums__slice_bounds__hi (us_split_fields1 o8))) (to_rep (last (rt x))))))))
(check-sat)
(exit)
