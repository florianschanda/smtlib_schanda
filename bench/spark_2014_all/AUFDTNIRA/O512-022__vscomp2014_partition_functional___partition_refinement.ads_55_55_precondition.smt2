...
(assert (and (= o5 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o5) (= o5 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o3 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o3) (<= o3 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (= o4 (* 2 o3)))
(assert (and (= o6 o4) (in_range10 o4)))
(assert (= result (ite (<= o6 o5) true false)))
(assert (= result true))
(assert (and (= o2 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o2) (<= o2 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
...
(assert (= result2 true))
(assert (and (= o (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c)) (= (= o true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c) true))))
(assert (= o1 true))
(assert (= result3 (ite (= o1 true) o false)))
(assert (= result3 true))
(assert (not (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c) true)))
(check-sat)
(exit)
