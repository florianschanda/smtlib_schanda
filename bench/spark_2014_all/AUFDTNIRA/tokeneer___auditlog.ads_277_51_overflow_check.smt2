...
(assert (and (= o (- (to_rep (rec__auditlog__logfilelistt__length (us_split_fields1 usedlogfiles))) 1)) (in_range3 (- (to_rep (rec__auditlog__logfilelistt__length (us_split_fields1 usedlogfiles))) 1))))
(assert (= o1 (* o 1024)))
