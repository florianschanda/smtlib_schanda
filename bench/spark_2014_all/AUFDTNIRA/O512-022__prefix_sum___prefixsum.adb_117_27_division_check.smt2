...
(assert (= (= result5 true) (forall ((k Int)) (=> (and (<= 0 k) (<= k 7)) (ite (and (<= 0 k) (<= k (- right3 (* space3 2)))) (ite (= (mod2 (+ k 1) (* 2 space3)) 0) (= (to_rep (select a3 k)) (+ (to_rep (select a2 k)) (to_rep (select a2 (- k space3))))) (ite (= (mod2 (+ k 1) space3) 0) (= (to_rep (select a3 k)) (to_rep (select a2 (+ k space3)))) (= (to_rep (select a3 k)) (to_rep (select a2 k))))) (= (to_rep (select a3 k)) (to_rep (select a2 k))))))))
(assert (= result5 true))
(assert (not (not (= (* space3 2) 0))))
(check-sat)
(exit)
