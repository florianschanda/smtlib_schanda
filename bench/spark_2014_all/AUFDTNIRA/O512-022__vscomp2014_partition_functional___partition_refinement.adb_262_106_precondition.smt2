...
(assert (= result2 true))
(assert (and (= o5 j) (in_range11 j)))
(assert (and (= o6 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields2)) o5)) (= (bool_eq9 o6 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields2)) o5)) true)))
(assert (= o7 (us_split_fields11 o6)))
(assert (= o8 (rec__partition_refinement__interval__last o7)))
(assert (= o9 (to_rep4 o8)))
(assert (= o10 (ite (<= k o9) true false)))
(assert (and (= o4 j) (in_range11 j)))
(assert (not (<= o4 (last (model__2 (mk___rep4 p__split_discrs p__split_fields2))))))
(check-sat)
(exit)
