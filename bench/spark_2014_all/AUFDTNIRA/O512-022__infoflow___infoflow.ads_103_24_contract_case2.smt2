...
(declare-const o (Array Int content))
(declare-const o1 (Array Int content))
...
(assert (in_range1 i))
(assert (forall ((k Int)) (=> (and (<= (to_rep h_v1__first) k) (<= k (to_rep h_v1__last))) (ite (<= k (div1 (to_rep h_v1__last) 2)) (= (to_rep1 (select o k)) (to_rep1 (select h_v1 (+ k (div1 (to_rep h_v1__last) 2))))) (= (to_rep1 (select o k)) (to_rep1 (select h_v1 (- k (div1 (to_rep h_v1__last) 2)))))))))
(assert (forall ((k Int)) (=> (and (<= (to_rep h_v2__first) k) (<= k (to_rep h_v2__last))) (ite (<= k (div1 (to_rep h_v2__last) 2)) (= (to_rep1 (select o1 k)) (to_rep1 (select h_v2 (+ k (div1 (to_rep h_v2__last) 2))))) (= (to_rep1 (select o1 k)) (to_rep1 (select h_v2 (- k (div1 (to_rep h_v2__last) 2)))))))))
(assert (= o1 h_v21))
(assert (= o h_v11))
(assert (= h_v22 o1))
(assert (= h_v12 o))
(assert (=> (= (ite (= (ite (= (ite (= (ite (= (ite (<= (to_rep h_v1__first) i) (ite (<= i (to_rep h_v1__last)) (= (to_rep h_v1__first) 1) false) false) true) (= (to_rep h_v2__first) 1) false) true) (= (to_rep h_v1__last) (to_rep h_v2__last)) false) true) (<= i (div1 (to_rep h_v1__last) 2)) false) true) (= (to_rep1 (select h_v1 (+ i (div1 (to_rep h_v1__last) 2)))) (to_rep1 (select h_v2 (+ i (div1 (to_rep h_v2__last) 2))))) false) true) (= (to_rep1 (select h_v11 i)) (to_rep1 (select h_v21 i)))))
...
(assert (not (= (to_rep1 (select h_v11 i)) (to_rep1 (select h_v21 i)))))
(check-sat)
(exit)
