...
(declare-const temp___375 (Array Int character))
(declare-const temp___3751 t4)
...
(assert (= (to_rep1 (first8 (rt4 (instr__display_value__4__s2__aggregate_def (to_rep (rec__instr__graphic_gauge__empty (us_split_fields7 x))) (+ lg 1) (to_rep1 (rec__instr__graphic_gauge__size (us_split_fields7 x))))))) (+ lg 1)))
(assert (= (to_rep1 (last8 (rt4 (instr__display_value__4__s2__aggregate_def (to_rep (rec__instr__graphic_gauge__empty (us_split_fields7 x))) (+ lg 1) (to_rep1 (rec__instr__graphic_gauge__size (us_split_fields7 x))))))) (to_rep1 (rec__instr__graphic_gauge__size (us_split_fields7 x)))))
(assert (= (mk___t4 temp___375 temp___3751) (instr__display_value__4__s2__aggregate_def (to_rep (rec__instr__graphic_gauge__empty (us_split_fields7 x))) (+ lg 1) (to_rep1 (rec__instr__graphic_gauge__size (us_split_fields7 x))))))
(assert (not (= (ite (<= (to_rep1 (first8 temp___3751)) (to_rep1 (last8 temp___3751))) (+ (- (to_rep1 (last8 temp___3751)) (to_rep1 (first8 temp___3751))) 1) 0) (ite (<= (+ lg 1) (to_rep1 (rec__instr__graphic_gauge__size (us_split_fields7 x)))) (+ (- (to_rep1 (rec__instr__graphic_gauge__size (us_split_fields7 x))) (+ lg 1)) 1) 0))))
(check-sat)
(exit)
