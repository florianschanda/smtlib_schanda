...
(assert (<= j index21))
(assert (not (= (to_rep (select (select result__2 (+ (+ (* (- index11 (to_rep (first2 (rt1 array1)))) (length1 array2)) (- j (to_rep (first2 (rt1 array2))))) 1)) 1)) (to_rep (select (elts1 array1) index11)))))
(check-sat)
(exit)
