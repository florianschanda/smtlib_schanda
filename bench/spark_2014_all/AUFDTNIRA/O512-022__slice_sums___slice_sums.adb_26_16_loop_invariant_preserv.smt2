...
(assert (and (forall ((lo_index Int)) (=> (and (<= (to_rep (first (rt x))) lo_index) (<= lo_index (- lo2 1))) (forall ((hi_index Int)) (=> (and (<= (to_rep (first (rt x))) hi_index) (<= hi_index (to_rep (last (rt x))))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index) (of_rep1 hi_index)))) max_sum3))))) (forall ((hi_index Int)) (=> (and (<= (to_rep (first (rt x))) hi_index) (<= hi_index (- hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo2) (of_rep1 hi_index)))) max_sum3)))))
...
(assert (and (= o1 hi2) (in_range4 hi2)))
(assert (= (extended_indexqtint o2) o1))
(assert (and (= o lo2) (in_range3 lo2)))
(assert (= (indexqtint o3) o))
(assert (= o4 (mk___split_fields o3 o2)))
(assert (= temp___185 (mk_slice_bounds o4)))
(assert (= result4 (mk___split_fields__ref current_slice__split_fields)))
(assert (= current_slice__split_fields1 (us_split_fields1 temp___185)))
(assert (= result5 (mk_int__ref current_sum2)))
(assert (= current_sum3 (sum__logic x (mk_slice_bounds current_slice__split_fields1))))
(assert (=> (< max_sum3 current_sum3) (= result6 (mk___split_fields__ref result____split_fields4))))
(assert (=> (< max_sum3 current_sum3) (= result____split_fields5 current_slice__split_fields1)))
(assert (=> (< max_sum3 current_sum3) (and (= o5 current_sum3) (in_range2 current_sum3))))
(assert (=> (< max_sum3 current_sum3) (= result7 (mk_int__ref max_sum3))))
(assert (=> (< max_sum3 current_sum3) (= max_sum4 o5)))
(assert (=> (not (< max_sum3 current_sum3)) (= result____split_fields5 result____split_fields4)))
(assert (=> (not (< max_sum3 current_sum3)) (= max_sum4 max_sum3)))
(assert (not (= hi2 (to_rep (last (rt x))))))
(assert (= result8 (mk_int__ref hi2)))
(assert (= hi3 (+ hi2 1)))
(declare-const hi_index Int)
(assert (<= (to_rep (first (rt x))) hi_index))
(assert (<= hi_index (- hi3 1)))
(assert (not (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo2) (of_rep1 hi_index)))) max_sum4)))
(check-sat)
(exit)
