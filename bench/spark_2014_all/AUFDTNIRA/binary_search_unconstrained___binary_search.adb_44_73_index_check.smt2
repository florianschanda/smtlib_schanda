...
(assert (= med1 result6))
(assert (= med2 o15))
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (forall ((i21 Int)) (=> (and (<= i1 i21) (<= i21 (to_rep1 (last (rt a))))) (<= (to_rep (select (elts a) i1)) (to_rep (select (elts a) i21))))))))
