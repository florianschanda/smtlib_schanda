...
(define-fun o19 () us_rep1 (mk___rep1 (mk___split_fields1 o5 o6 o7)))
(assert (and (= o17 (capacity (mk___rep p__split_discrs (mk___split_fields p__split_fields)))) (and (in_range1 o17) (= o17 (ite (= (distinct 1 0) true) (to_rep (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o15 (length (mk___rep p__split_discrs (mk___split_fields p__split_fields)))) (and (in_range1 o15) (<= o15 (capacity (mk___rep p__split_discrs (mk___split_fields p__split_fields)))))))
(assert (= o16 (* 2 o15)))
(assert (and (= o18 o16) (in_range4 o16)))
(assert (= result (ite (<= o18 o17) true false)))
(assert (= result true))
(assert (and (= o14 (length (mk___rep p__split_discrs (mk___split_fields p__split_fields)))) (and (in_range1 o14) (<= o14 (capacity (mk___rep p__split_discrs (mk___split_fields p__split_fields)))))))
(assert (= result1 (ite (<= o14 5000) true false)))
(assert (= result1 true))
...
(assert (= result4 true))
(assert (and (= o4 j) (in_range9 j)))
(assert (and (= o19 (get (model__ (mk___rep p__split_discrs (mk___split_fields p__split_fields))) o4)) (= (bool_eq o19 (get (model__ (mk___rep p__split_discrs (mk___split_fields p__split_fields))) o4)) true)))
(assert (= o5 o8))
(assert (= o6 o9))
(assert (= o7 o10))
(assert (= o11 o9))
(assert (= o12 (to_rep2 o11)))
(assert (= o13 (ite (<= k o12) true false)))
