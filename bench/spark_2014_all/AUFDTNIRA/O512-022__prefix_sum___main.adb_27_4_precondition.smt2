...
(assert (= result9 j8))
(assert (= j9 7))
(assert (and (and (= (all_elements_in a2 8000000) true) (and (= space1 8) (= (intermediate_form a2 a1) true))) (in_range1 space1)))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 space1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 space1)))))) (= o (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 space1))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 space1)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 space1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 space1))))))) (= o 0)))
(assert (=> (<= 1 3) (= o1 (+ (- 3 1) 1))))
(assert (=> (not (<= 1 3)) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ 1 o2)))
...
(assert (= o6 (concat1 (temp___String_Literal_616 Tuple0) 1 3 (elts (to_string (attr__ATTRIBUTE_IMAGE3 space1))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 space1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 space1))))))))
(assert (= o7 (mk 1 o5)))
(assert (= result10 j1))
(assert (= j10 0))
(assert (= result11 j10))
...
(assert (= j17 7))
(assert (not (= (all_elements_in a2 8000000) true)))
(check-sat)
(exit)
