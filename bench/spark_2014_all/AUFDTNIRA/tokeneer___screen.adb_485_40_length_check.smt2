...
(declare-const temp___1995 (Array Int character))
(declare-const temp___19951 t4)
...
(define-fun temp___19872 () us_t1 (mk___t1 temp___1987 temp___19871))
(assert (in_range3 value))
(assert (and (= temp___19872 (filesizet_image (div1 value 1024))) (and (dynamic_invariant temp___19872 true false true true) (= temp___19872 (let ((temp___518 (to_string (attr__ATTRIBUTE_IMAGE3 (div1 value 1024))))) (mk___t1 (elts temp___518) (mk1 (to_rep1 (first (rt temp___518))) (to_rep1 (last (rt temp___518))))))))))
(assert (=> (= (length1 temp___19872) 0) (= (temp___String_Literal_1986 Tuple0) screen__writeconfigdata__filesizestring__data__assume)))
(assert (=> (= (length1 temp___19872) 0) (= (mk 1 7) screen__writeconfigdata__filesizestring__data__assume1)))
(assert (=> (not (= (length1 temp___19872) 0)) (=> (<= 1 7) (= o (+ (- 7 1) 1)))))
(assert (=> (not (= (length1 temp___19872) 0)) (=> (not (<= 1 7)) (= o 0))))
(assert (=> (not (= (length1 temp___19872) 0)) (=> (<= (to_rep1 (first2 temp___19871)) (to_rep1 (last2 temp___19871))) (= o1 (+ (- (to_rep1 (last2 temp___19871)) (to_rep1 (first2 temp___19871))) 1)))))
(assert (=> (not (= (length1 temp___19872) 0)) (=> (not (<= (to_rep1 (first2 temp___19871)) (to_rep1 (last2 temp___19871)))) (= o1 0))))
(assert (=> (not (= (length1 temp___19872) 0)) (= o2 (+ o1 o))))
(assert (=> (not (= (length1 temp___19872) 0)) (= o3 (+ (to_rep1 (first2 temp___19871)) o2))))
(assert (=> (not (= (length1 temp___19872) 0)) (= o4 (- o3 1))))
(assert (=> (not (= (length1 temp___19872) 0)) (and (= o5 o4) (in_range1 o4))))
(assert (=> (not (= (length1 temp___19872) 0)) (= (concat1 temp___1987 (to_rep1 (first2 temp___19871)) (to_rep1 (last2 temp___19871)) (temp___String_Literal_1986 Tuple0) 1 7) screen__writeconfigdata__filesizestring__data__assume)))
(assert (=> (not (= (length1 temp___19872) 0)) (= (mk (to_rep1 (first2 temp___19871)) o5) screen__writeconfigdata__filesizestring__data__assume1)))
(assert (= result data))
...
(assert (= o6 data1))
(assert (= o6 temp___1995))
(assert (= (mk4 2 (to_rep1 data__last)) temp___19951))
(assert (not (= (ite (<= (to_rep1 (first8 temp___19951)) (to_rep1 (last8 temp___19951))) (+ (- (to_rep1 (last8 temp___19951)) (to_rep1 (first8 temp___19951))) 1) 0) (ite (<= 1 (- (to_rep1 data__last) 1)) (+ (- (- (to_rep1 data__last) 1) 1) 1) 0))))
(check-sat)
(exit)
