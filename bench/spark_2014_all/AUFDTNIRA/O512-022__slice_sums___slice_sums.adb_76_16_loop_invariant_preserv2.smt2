...
(assert (<= (indexqtint (rec__sums__slice_bounds__lo result____split_fields5)) (extended_indexqtint (rec__sums__slice_bounds__hi result____split_fields5))))
(assert (not (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo result____split_fields5)))))
(check-sat)
(exit)
