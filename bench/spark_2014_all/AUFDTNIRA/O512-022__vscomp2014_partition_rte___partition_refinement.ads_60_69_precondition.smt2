...
(assert (and (= o12 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o12) (= o12 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o10 (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o10) (<= o10 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (= o11 (* 2 o10)))
(assert (and (= o13 o11) (in_range11 o11)))
(assert (= result (ite (<= o13 o12) true false)))
(assert (= result true))
(assert (and (= o9 (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o9) (<= o9 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
...
(assert (= result2 true))
(assert (and (= o7 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2)) (= (= o7 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2) true))))
(assert (= o8 true))
...
(assert (= result3 true))
(assert (and (= o5 (has_key (positions x) c3)) (= (= o5 true) (= (has_key (positions x) c3) true))))
(assert (= o6 true))
...
(assert (= result8 true))
(assert (and (= o (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o) (<= o (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (and (= o1 o) (in_range10 o)))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= j o2) true false)))
(assert (= result9 (ite (<= 0 j) o3 false)))
(assert (= result9 true))
(assert (and (= o4 j) (in_range12 j)))
(assert (not (<= o4 (last (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(check-sat)
(exit)
