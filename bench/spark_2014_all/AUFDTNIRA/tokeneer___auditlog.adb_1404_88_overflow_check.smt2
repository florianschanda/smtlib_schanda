...
(assert (and (= o (- (to_rep5 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7)))) 1)) (in_range6 (- (to_rep5 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7)))) 1))))
(assert (= o1 (* o 1024)))
(assert (and (= o2 o1) (in_range11 o1)))
(assert (= o3 (+ o2 (to_rep6 (select (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7) (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)))))))
(assert (not (in_range11 o3)))
(check-sat)
(exit)
