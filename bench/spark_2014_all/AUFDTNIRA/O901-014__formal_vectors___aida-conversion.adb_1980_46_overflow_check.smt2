...
(assert (= (integerqtint rliteral) 9))
(assert (forall ((temp___2318 Int) (temp___2319 Int) (temp___2320 Int) (temp___2321 Int) (temp___2322 Int) (temp___2323 Int) (temp___2324 Int) (temp___2325 Int) (temp___2326 Int) (temp___2327 Int)) (let ((temp___2317 (aida__conversion__calculate_negative_target_length_9__int_array__aggregate_def temp___2318 temp___2319 temp___2320 temp___2321 temp___2322 temp___2323 temp___2324 temp___2325 temp___2326 temp___2327))) (=> (and (and (and (and (and (and (and (dynamic_invariant temp___2318 true true true true) (dynamic_invariant temp___2319 true true true true)) (dynamic_invariant temp___2320 true true true true)) (dynamic_invariant temp___2321 true true true true)) (dynamic_invariant temp___2322 true true true true)) (dynamic_invariant temp___2323 true true true true)) (dynamic_invariant temp___2324 true true true true)) (dynamic_invariant temp___2325 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 8) temp___2326 temp___2327) (and (= (first5 temp___2317) temp___2326) (= (last5 temp___2317) temp___2327))) (and (and (and (and (and (and (and (= (select (to_array2 temp___2317) (+ (+ (first1 source) 1) 0)) rliteral) (= (select (to_array2 temp___2317) (+ (+ (first1 source) 1) 1)) rliteral)) (= (select (to_array2 temp___2317) (+ (+ (first1 source) 1) 2)) rliteral)) (= (select (to_array2 temp___2317) (+ (+ (first1 source) 1) 3)) rliteral)) (= (select (to_array2 temp___2317) (+ (+ (first1 source) 1) 4)) rliteral)) (= (select (to_array2 temp___2317) (+ (+ (first1 source) 1) 5)) rliteral)) (= (select (to_array2 temp___2317) (+ (+ (first1 source) 1) 6)) rliteral)) (= (select (to_array2 temp___2317) (+ (+ (first1 source) 1) 7)) rliteral)))))))
(define-fun dynamic_invariant4 ((temp___expr_794 us_t3) (temp___is_init_790 Bool) (temp___skip_constant_791 Bool) (temp___do_toplevel_792 Bool) (temp___do_typ_inv_793 Bool)) Bool (=> (not (= temp___skip_constant_791 true)) (and (dynamic_property6 (+ (first1 source) 1) (+ (first1 source) 8) (first7 temp___expr_794) (last7 temp___expr_794)) (and (= (first7 temp___expr_794) (+ (first1 source) 1)) (= (last7 temp___expr_794) (+ (first1 source) 8))))))
(declare-sort t6 0)
...
(assert (forall ((temp___2333 Int) (temp___2334 Int) (temp___2335 Int)) (let ((temp___2332 (aida__conversion__calculate_negative_target_length_9__n__aggregate_def temp___2333 temp___2334 temp___2335))) (=> (dynamic_invariant temp___2333 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 8) temp___2334 temp___2335) (and (= (first9 temp___2332) temp___2334) (= (last9 temp___2332) temp___2335))) (forall ((temp___2336 Int)) (= (select (to_array4 temp___2332) temp___2336) rliteral1)))))))
...
(declare-const temp___2330 (Array Int integer))
(declare-const temp___23301 t2)
...
(declare-const temp___2338 (Array Int integer))
(declare-const temp___23381 t4)
...
(declare-const temp___2340 Int)
(declare-const temp___2341 Int)
(declare-const temp___2344 (Array Int integer))
(declare-const temp___2342 Int)
(declare-const o Int)
...
(declare-const temp___2346 Int)
(declare-const o9 Int)
(declare-const o10 integer)
(declare-const o11 Int)
(declare-const o12 Int)
(declare-const o13 Int)
(declare-const temp___2347 Int)
...
(assert (and (= (length source) 9) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index7 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index7) (<= index7 (+ (to_rep1 (first (rt source))) 8))) (= (is_digit (to_rep (select (elts source) index7))) true))))))
...
(assert (= (mk___t2 temp___2330 temp___23301) (aida__conversion__calculate_negative_target_length_9__int_array__aggregate_def 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 7))))
(assert (= (ite (<= (to_rep1 (first4 temp___23301)) (to_rep1 (last4 temp___23301))) (+ (- (to_rep1 (last4 temp___23301)) (to_rep1 (first4 temp___23301))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) (+ (- (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2330 (to_rep1 (first4 temp___23301)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_9__int_array__assume))
...
(assert (= (mk___t4 temp___2338 temp___23381) (aida__conversion__calculate_negative_target_length_9__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8))))
(assert (= (ite (<= (to_rep1 (first8 temp___23381)) (to_rep1 (last8 temp___23381))) (+ (- (to_rep1 (last8 temp___23381)) (to_rep1 (first8 temp___23381))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) (+ (- (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2338 (to_rep1 (first8 temp___23381)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_9__n__assume))
...
(assert (and (= temp___2340 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2341 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2340))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= temp___2344 n1)))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= temp___2342 index1)))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= o index1)))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= o3 index1)))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= o7 index1)))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= n1 result3)))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= n2 o8)))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8) index2)) (forall ((temp___2345 Int)) (=> (and (<= (to_rep1 n__first) temp___2345) (<= temp___2345 (to_rep1 n__last))) (=> (or (< temp___2341 temp___2345) (or (< temp___2345 temp___2340) (< index2 temp___2345))) (= (select n3 temp___2345) (select temp___2344 temp___2345)))))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 8))))))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= index2 temp___2341)))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= index2 index3)))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= n3 n4)))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= index4 index2)))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= n5 n3)))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= index6 index4)))
(assert (=> (and (<= temp___2340 index1) (<= index1 temp___2341)) (= n7 n5)))
(assert (=> (not (and (<= temp___2340 index1) (<= index1 temp___2341))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2340 index1) (<= index1 temp___2341))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2340 index1) (<= index1 temp___2341))) (= index6 index1)))
(assert (=> (not (and (<= temp___2340 index1) (<= index1 temp___2341))) (= n7 n1)))
...
(assert (and (= temp___2346 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___2346) (<= temp___2346 (to_rep1 n__last))))
(assert (= o9 temp___2346))
...
(assert (= target1 o13))
(assert (<= (- 9) target1))
(assert (and (= temp___2347 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2347) (<= temp___2347 (to_rep1 n__last))))
(assert (= o14 temp___2347))
...
(assert (= target2 o20))
(assert (<= (- 99) target2))
(assert (and (= temp___2348 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2348) (<= temp___2348 (to_rep1 n__last))))
(assert (= o21 temp___2348))
...
(assert (= target3 o27))
(assert (<= (- 999) target3))
(assert (and (= temp___2349 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2349) (<= temp___2349 (to_rep1 n__last))))
(assert (= o28 temp___2349))
...
(assert (= target4 o34))
(assert (<= (- 9999) target4))
(assert (and (= temp___2350 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2350) (<= temp___2350 (to_rep1 n__last))))
(assert (= o35 temp___2350))
...
(assert (and (= temp___2351 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___2351) (<= temp___2351 (to_rep1 n__last))))
(assert (= o42 temp___2351))
...
(assert (and (= temp___2352 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___2352) (<= temp___2352 (to_rep1 n__last))))
(assert (= o49 temp___2352))
...
(assert (and (= temp___2353 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___2353) (<= temp___2353 (to_rep1 n__last))))
(assert (= o56 temp___2353))
