...
(declare-const o1 us_split_fields10)
...
(assert (and (= o12 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o12) (= o12 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o10 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o10) (<= o10 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (= o11 (* 2 o10)))
(assert (and (= o13 o11) (in_range10 o11)))
...
(assert (<= 0 j))
(assert (<= j 5))
(assert (and (= o (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f j)))) (= (bool_eq9 o (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f j)))) true)))
(assert (= o1 (us_split_fields11 o)))
(assert (= o2 (rec__partition_refinement__interval__last o1)))
(assert (= o3 (to_rep4 o2)))
