...
(assert (<= (indexqtint (rec__sums__slice_bounds__lo result____split_fields4)) (extended_indexqtint (rec__sums__slice_bounds__hi result____split_fields4))))
(assert (=> (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo result____split_fields4))) (= result4 (ite (<= (extended_indexqtint (rec__sums__slice_bounds__hi result____split_fields4)) (to_rep (last (rt x)))) true false))))
(assert (=> (not (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo result____split_fields4)))) (= result4 false)))
(assert (= result4 true))
(assert (not (or (< (extended_indexqtint (rec__sums__slice_bounds__hi result____split_fields4)) (indexqtint (rec__sums__slice_bounds__lo result____split_fields4))) (and (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo result____split_fields4))) (<= (extended_indexqtint (rec__sums__slice_bounds__hi result____split_fields4)) (to_rep (last (rt x))))))))
(check-sat)
(exit)
