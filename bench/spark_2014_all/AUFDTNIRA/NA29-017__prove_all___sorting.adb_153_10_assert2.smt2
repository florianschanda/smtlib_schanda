...
(assert (= l1 1))
(assert (and (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 2147483647)) (=> (< (* j l2) length1) (= (sorted (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* j l2)) (ite (< l2 (- length1 (* j l2))) l2 (- length1 (* j l2)))) true)))) (= (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first length1) true)) (<= 1 l2)))
...
(assert (= temp___242 b))
(assert (and (and (and (and (and (<= i3 length1) (=> (< i3 length1) (= (mod2 i3 (* l2 2)) 0))) (forall ((j Int)) (=> (and (<= 0 j) (<= j 2147483647)) (=> (< (* (* j l2) 2) i3) (= (sorted (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* (* j l2) 2)) (ite (< (* l2 2) (- length1 (* (* j l2) 2))) (* l2 2) (- length1 (* (* j l2) 2)))) true))))) (forall ((j Int)) (=> (and (<= 0 j) (<= j 2147483647)) (=> (< (* j l2) (- length1 i3)) (= (sorted (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (+ (+ a_first i3) (* j l2)) (ite (< l2 (- (- length1 i3) (* j l2))) l2 (- (- length1 i3) (* j l2)))) true))))) (= (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first length1) true)) (<= 1 l2)))
...
(assert (<= 0 j))
(assert (<= j 2147483647))
(assert (< (* (* j l2) 2) length1))
(assert (not (= (sorted (mk___t (map__content a7) (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* (* j l2) 2)) (ite (< (* l2 2) (- length1 (* (* j l2) 2))) (* l2 2) (- length1 (* (* j l2) 2)))) true)))
(check-sat)
(exit)
