...
(assert (= a14 a12))
(assert (and (= result9 (all_elements_in (map__content a13) 8000000)) (= (= result9 true) (forall ((k Int)) (=> (and (<= 0 k) (<= k 7)) (and (<= (- 8000000) (to_rep (select (map__content a13) k))) (<= (to_rep (select (map__content a13) k)) 8000000)))))))
(assert (= result9 true))
(assert (= (int__content output_space2) 8))
