...
(assert (forall ((x privileget)) (! (in_range10 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(declare-fun user_eq16 (opandnullt opandnullt) Bool)
(declare-const dummy16 opandnullt)
...
(declare-fun to_rep8 (opandnullt) Int)
(declare-fun of_rep8 (Int) opandnullt)
(assert (forall ((x opandnullt)) (! (= (of_rep8 (to_rep8 x)) x) :pattern ((to_rep8 x)))))
(assert (forall ((x opandnullt)) (! (in_range11 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(define-fun bool_eq9 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (to_rep7 (rec__admin__t__rolepresent (us_split_fields5 a))) (to_rep7 (rec__admin__t__rolepresent (us_split_fields5 b)))) (= (to_rep8 (rec__admin__t__currentop (us_split_fields5 a))) (to_rep8 (rec__admin__t__currentop (us_split_fields5 b))))) true false))
...
(define-fun t__ref___5__projection ((a t__ref1)) us_rep3 (t__content1 a))
(declare-fun ispresent (us_rep3) Bool)
(declare-fun ispresent__function_guard (Bool us_rep3) Bool)
(declare-sort adminprivileget 0)
(define-fun in_range12 ((x Int)) Bool (and (<= 1 x) (<= x 3)))
(declare-fun attr__ATTRIBUTE_IMAGE12 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check12 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE12 (us_image) Int)
(declare-fun user_eq18 (adminprivileget adminprivileget) Bool)
(declare-const dummy18 adminprivileget)
...
(assert true)
(assert (forall ((theadmin us_rep3)) (! (= (= (ispresent theadmin) true) (in_range12 (to_rep7 (rec__admin__t__rolepresent (us_split_fields5 theadmin))))) :pattern ((ispresent theadmin)))))
(declare-fun securityofficerispresent (us_rep3) Bool)
(declare-fun securityofficerispresent__function_guard (Bool us_rep3) Bool)
(assert true)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-sort msgtextt 0)
(define-fun in_range13 ((x Int)) Bool (and (<= 0 x) (<= x 14)))
(declare-fun attr__ATTRIBUTE_IMAGE13 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check13 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE13 (us_image) Int)
(declare-fun user_eq19 (msgtextt msgtextt) Bool)
(declare-const dummy19 msgtextt)
...
(define-fun dynamic_invariant2 ((temp___expr_1622 Int) (temp___is_init_1618 Bool) (temp___skip_constant_1619 Bool) (temp___do_toplevel_1620 Bool) (temp___do_typ_inv_1621 Bool)) Bool (=> (or (= temp___is_init_1618 true) (<= 0 14)) (in_range13 temp___expr_1622)))
...
(define-fun in_range14 ((x Int)) Bool (and (<= 0 x) (<= x 4194304)))
(declare-fun attr__ATTRIBUTE_IMAGE14 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check14 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE14 (us_image) Int)
(declare-fun user_eq20 (filesizet filesizet) Bool)
(declare-const dummy20 filesizet)
...
(define-fun to_rep9 ((x filesizet)) Int (filesizetqtint x))
(declare-fun of_rep9 (Int) filesizet)
(assert (forall ((x filesizet)) (! (= (of_rep9 (to_rep9 x)) x) :pattern ((to_rep9 x)))))
(assert (forall ((x filesizet)) (! (in_range14 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(define-fun in_range15 ((x Int)) Bool (and (<= 0 x) (<= x 864000)))
(declare-fun attr__ATTRIBUTE_IMAGE15 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check15 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE15 (us_image) Int)
(declare-fun user_eq21 (durationt durationt) Bool)
(declare-const dummy21 durationt)
...
(define-fun to_rep10 ((x durationt)) Int (durationtqtint x))
(declare-fun of_rep10 (Int) durationt)
(assert (forall ((x durationt)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert (forall ((x durationt)) (! (in_range15 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(declare-fun user_eq22 (fart fart) Bool)
(declare-const dummy22 fart)
...
(assert (forall ((x fart)) (! (in_range16 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(assert (forall ((x classt)) (! (in_range17 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(declare-fun user_eq24 (accesspolicyt accesspolicyt) Bool)
(declare-const dummy24 accesspolicyt)
...
(declare-fun to_rep13 (accesspolicyt) Int)
(declare-fun of_rep13 (Int) accesspolicyt)
(assert (forall ((x accesspolicyt)) (! (= (of_rep13 (to_rep13 x)) x) :pattern ((to_rep13 x)))))
(assert (forall ((x accesspolicyt)) (! (in_range18 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun bool_eq10 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep10 (rec__screen__displayedconfigt__latchunlock (us_split_fields7 a))) (to_rep10 (rec__screen__displayedconfigt__latchunlock (us_split_fields7 b)))) (= (to_rep10 (rec__screen__displayedconfigt__alarmsilent (us_split_fields7 a))) (to_rep10 (rec__screen__displayedconfigt__alarmsilent (us_split_fields7 b))))) (= (to_rep10 (rec__screen__displayedconfigt__fingerwait (us_split_fields7 a))) (to_rep10 (rec__screen__displayedconfigt__fingerwait (us_split_fields7 b))))) (= (to_rep10 (rec__screen__displayedconfigt__tokenremove (us_split_fields7 a))) (to_rep10 (rec__screen__displayedconfigt__tokenremove (us_split_fields7 b))))) (= (to_rep10 (rec__screen__displayedconfigt__workstart (us_split_fields7 a))) (to_rep10 (rec__screen__displayedconfigt__workstart (us_split_fields7 b))))) (= (to_rep10 (rec__screen__displayedconfigt__workend (us_split_fields7 a))) (to_rep10 (rec__screen__displayedconfigt__workend (us_split_fields7 b))))) (= (to_rep10 (rec__screen__displayedconfigt__authduration (us_split_fields7 a))) (to_rep10 (rec__screen__displayedconfigt__authduration (us_split_fields7 b))))) (= (to_rep13 (rec__screen__displayedconfigt__policy (us_split_fields7 a))) (to_rep13 (rec__screen__displayedconfigt__policy (us_split_fields7 b))))) (= (to_rep9 (rec__screen__displayedconfigt__minpreservedlog (us_split_fields7 a))) (to_rep9 (rec__screen__displayedconfigt__minpreservedlog (us_split_fields7 b))))) (= (to_rep9 (rec__screen__displayedconfigt__alarmthreshold (us_split_fields7 a))) (to_rep9 (rec__screen__displayedconfigt__alarmthreshold (us_split_fields7 b))))) (= (to_rep12 (rec__screen__displayedconfigt__minentry (us_split_fields7 a))) (to_rep12 (rec__screen__displayedconfigt__minentry (us_split_fields7 b))))) (= (to_rep12 (rec__screen__displayedconfigt__clearance (us_split_fields7 a))) (to_rep12 (rec__screen__displayedconfigt__clearance (us_split_fields7 b))))) (= (to_rep11 (rec__screen__displayedconfigt__maxfar (us_split_fields7 a))) (to_rep11 (rec__screen__displayedconfigt__maxfar (us_split_fields7 b))))) true false))
...
(declare-datatypes () ((displayedconfigt__ref (mk_displayedconfigt__ref (displayedconfigt__content us_rep4)))))
(define-fun displayedconfigt__ref___projection ((a displayedconfigt__ref)) us_rep4 (displayedconfigt__content a))
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__screen__screenconfigt__isdisplayed Bool) (rec__screen__screenconfigt__data us_rep4)))))
(define-fun us_split_fields_IsDisplayed__2__projection ((a us_split_fields8)) Bool (rec__screen__screenconfigt__isdisplayed a))
(define-fun us_split_fields_Data__2__projection ((a us_split_fields8)) us_rep4 (rec__screen__screenconfigt__data a))
...
(define-fun bool_eq11 ((a us_rep5) (b us_rep5)) Bool (ite (and (= (rec__screen__screenconfigt__isdisplayed (us_split_fields9 a)) (rec__screen__screenconfigt__isdisplayed (us_split_fields9 b))) (= (bool_eq10 (rec__screen__screenconfigt__data (us_split_fields9 a)) (rec__screen__screenconfigt__data (us_split_fields9 b))) true)) true false))
...
(declare-datatypes () ((screenconfigt__ref (mk_screenconfigt__ref (screenconfigt__content us_rep5)))))
(define-fun screenconfigt__ref___projection ((a screenconfigt__ref)) us_rep5 (screenconfigt__content a))
...
(define-fun to_rep14 ((x statscount)) Int (statscountqtint x))
(declare-fun of_rep14 (Int) statscount)
(assert (forall ((x statscount)) (! (= (of_rep14 (to_rep14 x)) x) :pattern ((to_rep14 x)))))
(assert (forall ((x statscount)) (! (in_range19 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(define-fun bool_eq12 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (and (= (to_rep14 (rec__stats__t__successentry (us_split_fields11 a))) (to_rep14 (rec__stats__t__successentry (us_split_fields11 b)))) (= (to_rep14 (rec__stats__t__failentry (us_split_fields11 a))) (to_rep14 (rec__stats__t__failentry (us_split_fields11 b))))) (= (to_rep14 (rec__stats__t__successbio (us_split_fields11 a))) (to_rep14 (rec__stats__t__successbio (us_split_fields11 b))))) (= (to_rep14 (rec__stats__t__failbio (us_split_fields11 a))) (to_rep14 (rec__stats__t__failbio (us_split_fields11 b))))) true false))
...
(declare-datatypes () ((t__ref2 (mk_t__ref2 (t__content2 us_rep6)))))
(define-fun t__ref___4__projection ((a t__ref2)) us_rep6 (t__content2 a))
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__screen__screenstatst__isdisplayed Bool) (rec__screen__screenstatst__data us_rep6)))))
(define-fun us_split_fields_IsDisplayed__projection ((a us_split_fields12)) Bool (rec__screen__screenstatst__isdisplayed a))
(define-fun us_split_fields_Data__projection ((a us_split_fields12)) us_rep6 (rec__screen__screenstatst__data a))
...
(define-fun bool_eq13 ((a us_rep7) (b us_rep7)) Bool (ite (and (= (rec__screen__screenstatst__isdisplayed (us_split_fields13 a)) (rec__screen__screenstatst__isdisplayed (us_split_fields13 b))) (= (bool_eq12 (rec__screen__screenstatst__data (us_split_fields13 a)) (rec__screen__screenstatst__data (us_split_fields13 b))) true)) true false))
...
(declare-datatypes () ((screenstatst__ref (mk_screenstatst__ref (screenstatst__content us_rep7)))))
(define-fun screenstatst__ref___projection ((a screenstatst__ref)) us_rep7 (screenstatst__content a))
...
(declare-const thestats us_rep6)
(declare-const attr__ATTRIBUTE_ADDRESS12 Int)
(declare-const theadmin us_rep3)
...
(declare-fun temp___String_Literal_1916 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1916 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 2)) 99)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 8)) 85)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 9)) 112)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 10)) 100)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 11)) 97)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 12)) 116)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 13)) 101)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 15)) 70)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 16)) 97)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 17)) 105)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 18)) 108)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 19)) 117)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1916 us_void_param) 21)) 101)) :pattern ((temp___String_Literal_1916 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_1570 Int) (temp___is_init_1566 Bool) (temp___skip_constant_1567 Bool) (temp___do_toplevel_1568 Bool) (temp___do_typ_inv_1569 Bool)) Bool (=> (or (= temp___is_init_1566 true) (<= 0 4)) (in_range11 temp___expr_1570)))
(define-fun dynamic_invariant8 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 3)) (in_range10 temp___expr_1161)))
(define-fun dynamic_invariant9 ((temp___expr_1168 Int) (temp___is_init_1164 Bool) (temp___skip_constant_1165 Bool) (temp___do_toplevel_1166 Bool) (temp___do_typ_inv_1167 Bool)) Bool (=> (or (= temp___is_init_1164 true) (<= 1 3)) (in_range12 temp___expr_1168)))
(define-fun dynamic_invariant10 ((temp___expr_1175 Int) (temp___is_init_1171 Bool) (temp___skip_constant_1172 Bool) (temp___do_toplevel_1173 Bool) (temp___do_typ_inv_1174 Bool)) Bool (=> (or (= temp___is_init_1171 true) (<= 0 5)) (in_range17 temp___expr_1175)))
(define-fun dynamic_invariant11 ((temp___expr_1216 Int) (temp___is_init_1212 Bool) (temp___skip_constant_1213 Bool) (temp___do_toplevel_1214 Bool) (temp___do_typ_inv_1215 Bool)) Bool (=> (or (= temp___is_init_1212 true) (<= 0 17)) (in_range7 temp___expr_1216)))
(define-fun dynamic_invariant12 ((temp___expr_1223 Int) (temp___is_init_1219 Bool) (temp___skip_constant_1220 Bool) (temp___do_toplevel_1221 Bool) (temp___do_typ_inv_1222 Bool)) Bool (=> (or (= temp___is_init_1219 true) (<= 1 17)) (in_range5 temp___expr_1223)))
(define-fun dynamic_invariant13 ((temp___expr_1349 Int) (temp___is_init_1345 Bool) (temp___skip_constant_1346 Bool) (temp___do_toplevel_1347 Bool) (temp___do_typ_inv_1348 Bool)) Bool (=> (or (= temp___is_init_1345 true) (<= 0 2)) (in_range4 temp___expr_1349)))
(define-fun dynamic_invariant14 ((temp___expr_1230 Int) (temp___is_init_1226 Bool) (temp___skip_constant_1227 Bool) (temp___do_toplevel_1228 Bool) (temp___do_typ_inv_1229 Bool)) Bool (=> (or (= temp___is_init_1226 true) (<= 0 17408)) (in_range6 temp___expr_1230)))
(define-fun dynamic_invariant15 ((temp___expr_1261 Int) (temp___is_init_1257 Bool) (temp___skip_constant_1258 Bool) (temp___do_toplevel_1259 Bool) (temp___do_typ_inv_1260 Bool)) Bool (=> (or (= temp___is_init_1257 true) (<= 0 1024)) (in_range8 temp___expr_1261)))
(assert true)
...
(assert (forall ((temp___1290 Int)) (=> (dynamic_invariant15 temp___1290 true true true true) (forall ((temp___1291 Int)) (= (select (temp_____aggregate_def_1288 temp___1290) temp___1291) rliteral2)))))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(define-fun dynamic_invariant16 ((temp___expr_514 Int) (temp___is_init_510 Bool) (temp___skip_constant_511 Bool) (temp___do_toplevel_512 Bool) (temp___do_typ_inv_513 Bool)) Bool (=> (or (= temp___is_init_510 true) (<= 0 4194304)) (in_range14 temp___expr_514)))
(define-fun dynamic_invariant17 ((temp___expr_567 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool) (temp___do_typ_inv_566 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 0 864000)) (in_range15 temp___expr_567)))
(define-fun dynamic_invariant18 ((temp___expr_1205 Int) (temp___is_init_1201 Bool) (temp___skip_constant_1202 Bool) (temp___do_toplevel_1203 Bool) (temp___do_typ_inv_1204 Bool)) Bool (=> (or (= temp___is_init_1201 true) (<= 0 1)) (in_range18 temp___expr_1205)))
(define-fun dynamic_invariant19 ((temp___expr_1085 Int) (temp___is_init_1081 Bool) (temp___skip_constant_1082 Bool) (temp___do_toplevel_1083 Bool) (temp___do_typ_inv_1084 Bool)) Bool (=> (or (= temp___is_init_1081 true) (<= 0 2147483647)) (in_range16 temp___expr_1085)))
(define-fun dynamic_invariant20 ((temp___expr_1511 Int) (temp___is_init_1507 Bool) (temp___skip_constant_1508 Bool) (temp___do_toplevel_1509 Bool) (temp___do_typ_inv_1510 Bool)) Bool (=> (or (= temp___is_init_1507 true) (<= 0 2147483647)) (in_range19 temp___expr_1511)))
(assert (forall ((temp___1286 Int)) (=> (dynamic_invariant12 temp___1286 true true true true) (forall ((temp___1287 Int)) (= (select (temp_____aggregate_def_1284 temp___1286) temp___1287) rliteral)))))
...
(declare-const currentconfig__split_fields14 us_split_fields8)
...
(declare-const result6 us_split_fields__ref6)
(declare-const currentstats__split_fields5 us_split_fields12)
...
(declare-const currentconfig__split_fields15 us_split_fields8)
...
(declare-const currentconfig__split_fields16 us_split_fields8)
(assert (= (temp___String_Literal_158 Tuple0) nouser))
(assert (in_range13 themsg))
(assert (in_range13 currentmsg))
(assert (in_range9 currentdooralarm))
(assert (in_range9 currentlogalarm))
...
(assert (in_range13 currentmsg1))
(assert (= result (mk_bool__ref screenok)))
(assert (= screenok1 (ite (= (let ((subject writeok)) writeok1) true) screenok false)))
(assert (and (= o1 (theauditalarm logfilesstatus (us_private__content state) (mk___split_fields1 logfilestate__split_fields logfilestate__split_fields1 (mk___rep (mk___split_fields logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6) auditalarm auditsystemfault)) (in_range9 o1)))
(assert (and (= o (thedooralarm (us_private__content state1))) (in_range9 o)))
(assert (and (in_range9 currentdooralarm1) (in_range9 currentlogalarm1)))
(assert (= result1 (mk_bool__ref screenok1)))
(assert (= screenok2 (ite (= (let ((subject writeok)) writeok2) true) screenok1 false)))
(assert (and (= o2 (ispresent theadmin)) (= (= o2 true) (in_range12 (to_rep7 (rec__admin__t__rolepresent (us_split_fields5 theadmin)))))))
...
(assert (=> (not (= (let ((subject shoulddisplaystats)) shoulddisplaystats1) true)) (= screenok4 screenok5)))
(assert (= result6 (mk___split_fields__ref6 (mk___split_fields6 currentstats__split_fields (mk___rep5 (mk___split_fields5 currentstats__split_fields1 currentstats__split_fields2 currentstats__split_fields3 currentstats__split_fields4))))))
(assert (= currentstats__split_fields5 (mk___split_fields6 (let ((subject shoulddisplaystats)) shoulddisplaystats1) thestats)))
...
(assert (=> (not (= (let ((subject shoulddisplayconfig)) shoulddisplayconfig1) true)) (= currentconfig__split_fields15 (mk___split_fields4 currentconfig__split_fields (mk___rep3 (mk___split_fields3 currentconfig__split_fields1 currentconfig__split_fields2 currentconfig__split_fields3 currentconfig__split_fields4 currentconfig__split_fields5 currentconfig__split_fields6 currentconfig__split_fields7 currentconfig__split_fields8 currentconfig__split_fields9 currentconfig__split_fields10 currentconfig__split_fields11 currentconfig__split_fields12 currentconfig__split_fields13))))))
...
(assert (= result11 (mk___split_fields__ref4 currentconfig__split_fields15)))
(assert (= currentconfig__split_fields16 (mk___split_fields4 (let ((subject shoulddisplayconfig)) shoulddisplayconfig1) (rec__screen__screenconfigt__data currentconfig__split_fields15))))
