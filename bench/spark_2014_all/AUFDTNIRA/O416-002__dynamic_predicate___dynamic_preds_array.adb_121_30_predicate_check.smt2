...
(assert (=> (= (mod2 above 2) 0) (= temp___332 (store result__ 1 o1))))
(assert (=> (= (mod2 above 2) 0) (dynamic_predicate temp___332)))
(assert (=> (= (mod2 above 2) 0) (= o2 temp___332)))
(assert (=> (= (mod2 above 2) 0) (= result result__)))
(assert (=> (= (mod2 above 2) 0) (= result__1 o2)))
(assert (=> (not (= (mod2 above 2) 0)) (and (= temp___327 (+ above 1)) (in_range (+ above 1)))))
(assert (=> (not (= (mod2 above 2) 0)) (= (mod2 temp___327 2) 0)))
(assert (=> (not (= (mod2 above 2) 0)) (= o3 temp___327)))
(assert (=> (not (= (mod2 above 2) 0)) (= (to_rep o4) o3)))
(assert (=> (not (= (mod2 above 2) 0)) (= temp___329 (store result__ 1 o4))))
(assert (=> (not (= (mod2 above 2) 0)) (dynamic_predicate temp___329)))
(assert (=> (not (= (mod2 above 2) 0)) (= o5 temp___329)))
...
(assert (and (= temp___333 (+ (to_rep (select result__1 1)) 2)) (in_range (+ (to_rep (select result__1 1)) 2))))
(assert (not (= (mod2 temp___333 2) 0)))
(check-sat)
(exit)
