...
(assert (and (= o8 (- index11 (to_rep (first2 (rt1 array1))))) (in_range1 (- index11 (to_rep (first2 (rt1 array1)))))))
(assert (= o9 (* o8 o7)))
(assert (and (= o11 o9) (in_range1 o9)))
(assert (= o12 (+ o11 o10)))
(assert (and (= o13 o12) (in_range1 o12)))
(assert (= o14 (+ o13 1)))
(assert (and (= temp___283 o14) (in_range1 o14)))
(assert (not (<= temp___283 (to_rep result____last))))
(check-sat)
(exit)
