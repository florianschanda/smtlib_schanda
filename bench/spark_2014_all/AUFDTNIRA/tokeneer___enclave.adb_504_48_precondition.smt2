...
(define-fun dynamic_invariant ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 3)) (in_range4 temp___expr_426)))
...
(assert true)
(assert (forall ((theadmin us_rep)) (! (= (= (isdoingop theadmin) true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields1 theadmin))))) :pattern ((isdoingop theadmin)))))
(declare-fun thecurrentop (us_rep) Int)
(declare-fun thecurrentop__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant1 ((temp___expr_503 Int) (temp___is_init_499 Bool) (temp___skip_constant_500 Bool) (temp___do_toplevel_501 Bool) (temp___do_typ_inv_502 Bool)) Bool (=> (or (= temp___is_init_499 true) (<= 1 4)) (in_range6 temp___expr_503)))
...
(assert true)
(assert (forall ((theadmin us_rep)) (! (= (= (ispresent theadmin) true) (in_range7 (to_rep2 (rec__admin__t__rolepresent (us_split_fields1 theadmin))))) :pattern ((ispresent theadmin)))))
...
(define-fun to_rep4 ((x yearst)) Int (yearstqtint x))
...
(define-fun to_rep5 ((x monthst)) Int (monthstqtint x))
...
(define-fun to_rep6 ((x dayst)) Int (daystqtint x))
...
(define-fun to_rep7 ((x millisecst)) Int (millisecstqtint x))
...
(assert (forall ((x filestatust)) (! (in_range12 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(define-fun to_rep9 ((x logfileindext)) Int (logfileindextqtint x))
(declare-fun of_rep9 (Int) logfileindext)
(assert (forall ((x logfileindext)) (! (= (of_rep9 (to_rep9 x)) x) :pattern ((to_rep9 x)))))
(assert (forall ((x logfileindext)) (! (in_range13 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(define-fun to_rep10 ((x logentrycountt)) Int (logentrycounttqtint x))
(declare-fun of_rep10 (Int) logentrycountt)
(assert (forall ((x logentrycountt)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert (forall ((x logentrycountt)) (! (in_range14 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(define-fun to_rep11 ((x logfilecountt)) Int (logfilecounttqtint x))
(declare-fun of_rep11 (Int) logfilecountt)
(assert (forall ((x logfilecountt)) (! (= (of_rep11 (to_rep11 x)) x) :pattern ((to_rep11 x)))))
(assert (forall ((x logfilecountt)) (! (in_range15 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(define-fun bool_eq6 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (= (bool_eq5 (rec__auditlog__logfilelistt__list (us_split_fields5 a)) 1 17 (rec__auditlog__logfilelistt__list (us_split_fields5 b)) 1 17) true) (= (to_rep9 (rec__auditlog__logfilelistt__head (us_split_fields5 a))) (to_rep9 (rec__auditlog__logfilelistt__head (us_split_fields5 b))))) (= (to_rep9 (rec__auditlog__logfilelistt__lasti (us_split_fields5 a))) (to_rep9 (rec__auditlog__logfilelistt__lasti (us_split_fields5 b))))) (= (to_rep11 (rec__auditlog__logfilelistt__length (us_split_fields5 a))) (to_rep11 (rec__auditlog__logfilelistt__length (us_split_fields5 b))))) true false))
...
(define-fun to_rep12 ((x fileentrycountt)) Int (fileentrycounttqtint x))
(declare-fun of_rep12 (Int) fileentrycountt)
(assert (forall ((x fileentrycountt)) (! (= (of_rep12 (to_rep12 x)) x) :pattern ((to_rep12 x)))))
(assert (forall ((x fileentrycountt)) (! (in_range16 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(define-fun bool_eq7 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep12 (select a temp___idx_196)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_196))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep12 (select a temp___idx_196)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_196)))))))))))
...
(define-fun bool_eq8 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 a))) (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 b)))) (= (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 a))) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 b))))) (= (bool_eq6 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 b))) true)) (= (bool_eq7 (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 b)) 1 17) true)) true false))
...
(declare-fun user_eq24 (statust statust) Bool)
(declare-const dummy24 statust)
...
(define-fun dynamic_invariant2 ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 1)) (in_range17 temp___expr_548)))
...
(define-fun dynamic_invariant3 ((temp___expr_1338 us_rep3) (temp___is_init_1334 Bool) (temp___skip_constant_1335 Bool) (temp___do_toplevel_1336 Bool) (temp___do_typ_inv_1337 Bool)) Bool (=> (= temp___do_typ_inv_1337 true) (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1338))) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1338))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1338)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1338))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1342 us_rep3) (temp___skip_top_level_1343 Bool)) Bool (and (and (and (= (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1342))) 1) (= (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1342))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1342)) (mk___rep2 (mk___split_fields2 (temp_____aggregate_def_1344 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1342)) (temp_____aggregate_def_1348 0))))
(define-fun type_invariant ((temp___1352 us_rep3)) Bool (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1352))) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1352))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1352)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1352))) true))
...
(declare-fun user_eq25 (namecountt namecountt) Bool)
(declare-const dummy25 namecountt)
...
(define-fun to_rep13 ((x namecountt)) Int (namecounttqtint x))
(declare-fun of_rep13 (Int) namecountt)
(assert (forall ((x namecountt)) (! (= (of_rep13 (to_rep13 x)) x) :pattern ((to_rep13 x)))))
(assert (forall ((x namecountt)) (! (in_range18 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun to_rep14 ((x issueridt)) Int (issueridtqtint x))
...
(define-fun bool_eq11 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (= (to_rep14 (rec__cryptotypes__issuert__id (us_split_fields9 a))) (to_rep14 (rec__cryptotypes__issuert__id (us_split_fields9 b)))) (= (to_rep13 (rec__cryptotypes__issuert__namelength (us_split_fields9 a))) (to_rep13 (rec__cryptotypes__issuert__namelength (us_split_fields9 b))))) (= (bool_eq (rec__cryptotypes__issuert__name (us_split_fields9 a)) 1 40 (rec__cryptotypes__issuert__name (us_split_fields9 b)) 1 40) true)) true false))
...
(declare-fun user_eq29 (serialnumbert serialnumbert) Bool)
(declare-const dummy29 serialnumbert)
...
(define-fun to_rep15 ((x serialnumbert)) Int (serialnumbertqtint x))
...
(define-fun bool_eq12 ((a us_rep6) (b us_rep6)) Bool (ite (and (= (bool_eq11 (rec__certtypes__idt__issuer (us_split_fields11 a)) (rec__certtypes__idt__issuer (us_split_fields11 b))) true) (= (to_rep15 (rec__certtypes__idt__serialnumber (us_split_fields11 a))) (to_rep15 (rec__certtypes__idt__serialnumber (us_split_fields11 b))))) true false))
...
(declare-fun user_eq30 (us_rep6 us_rep6) Bool)
(declare-const dummy30 us_rep6)
...
(define-fun in_range21 ((x Int)) Bool (and (<= 0 x) (<= x 10)))
...
(declare-fun user_eq31 (algorithmt algorithmt) Bool)
(declare-const dummy31 algorithmt)
...
(declare-fun to_rep16 (algorithmt) Int)
(declare-fun of_rep16 (Int) algorithmt)
(assert (forall ((x algorithmt)) (! (= (of_rep16 (to_rep16 x)) x) :pattern ((to_rep16 x)))))
(assert (forall ((x algorithmt)) (! (in_range21 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(define-fun to_rep17 ((x keyidt)) Int (keyidtqtint x))
(declare-fun of_rep17 (Int) keyidt)
(assert (forall ((x keyidt)) (! (= (of_rep17 (to_rep17 x)) x) :pattern ((to_rep17 x)))))
(assert (forall ((x keyidt)) (! (in_range22 (to_rep17 x)) :pattern ((to_rep17 x)))))
...
(define-fun in_range23 ((x Int)) Bool (and (<= 0 x) (<= x 128)))
...
(define-fun to_rep18 ((x keylengtht)) Int (keylengthtqtint x))
(declare-fun of_rep18 (Int) keylengtht)
(assert (forall ((x keylengtht)) (! (= (of_rep18 (to_rep18 x)) x) :pattern ((to_rep18 x)))))
(assert (forall ((x keylengtht)) (! (in_range23 (to_rep18 x)) :pattern ((to_rep18 x)))))
(assert (forall ((x Int)) (! (=> (in_range23 x) (= (to_rep18 (of_rep18 x)) x)) :pattern ((to_rep18 (of_rep18 x))))))
...
(define-fun us_rep___8__projection ((a us_rep7)) us_split_fields12 (us_split_fields13 a))
(define-fun bool_eq13 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (= (to_rep16 (rec__cryptotypes__keypartt__algorithmid (us_split_fields13 a))) (to_rep16 (rec__cryptotypes__keypartt__algorithmid (us_split_fields13 b)))) (= (to_rep17 (rec__cryptotypes__keypartt__keyid (us_split_fields13 a))) (to_rep17 (rec__cryptotypes__keypartt__keyid (us_split_fields13 b))))) (= (to_rep18 (rec__cryptotypes__keypartt__keylength (us_split_fields13 a))) (to_rep18 (rec__cryptotypes__keypartt__keylength (us_split_fields13 b))))) true false))
...
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__cert__id__contentst__id us_rep6) (rec__cert__id__contentst__notbefore us_rep1) (rec__cert__id__contentst__notafter us_rep1) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep5) (rec__cert__id__contentst__subjectpublickey us_rep7)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields14)) us_rep6 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields14)) us_rep1 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields14)) us_rep1 (rec__cert__id__contentst__notafter a))
(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields14)) algorithmt (rec__cert__id__contentst__mechanism a))
(define-fun us_split_fields_Subject__projection ((a us_split_fields14)) us_rep5 (rec__cert__id__contentst__subject a))
...
(define-fun us_split_fields__ref___18__projection ((a us_split_fields__ref7)) us_split_fields14 (us_split_fields__content7 a))
...
(define-fun bool_eq14 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (and (and (= (bool_eq12 (rec__cert__id__contentst__id (us_split_fields15 a)) (rec__cert__id__contentst__id (us_split_fields15 b))) true) (= (bool_eq3 (rec__cert__id__contentst__notbefore (us_split_fields15 a)) (rec__cert__id__contentst__notbefore (us_split_fields15 b))) true)) (= (bool_eq3 (rec__cert__id__contentst__notafter (us_split_fields15 a)) (rec__cert__id__contentst__notafter (us_split_fields15 b))) true)) (= (to_rep16 (rec__cert__id__contentst__mechanism (us_split_fields15 a))) (to_rep16 (rec__cert__id__contentst__mechanism (us_split_fields15 b))))) (= (bool_eq11 (rec__cert__id__contentst__subject (us_split_fields15 a)) (rec__cert__id__contentst__subject (us_split_fields15 b))) true)) (= (bool_eq13 (rec__cert__id__contentst__subjectpublickey (us_split_fields15 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields15 b))) true)) true false))
...
(define-fun contentst__ref___4__projection ((a contentst__ref)) us_rep8 (contentst__content a))
(declare-datatypes () ((us_split_fields16 (mk___split_fields8 (rec__admintoken__valididcertt__valid Bool) (rec__admintoken__valididcertt__contents us_rep8)))))
(define-fun us_split_fields_Valid__2__projection ((a us_split_fields16)) Bool (rec__admintoken__valididcertt__valid a))
(define-fun us_split_fields_Contents__2__projection ((a us_split_fields16)) us_rep8 (rec__admintoken__valididcertt__contents a))
(declare-datatypes () ((us_split_fields__ref8 (mk___split_fields__ref8 (us_split_fields__content8 us_split_fields16)))))
(define-fun us_split_fields__ref___20__projection ((a us_split_fields__ref8)) us_split_fields16 (us_split_fields__content8 a))
(declare-datatypes () ((us_rep9 (mk___rep8 (us_split_fields17 us_split_fields16)))))
(define-fun us_rep___21__projection ((a us_rep9)) us_split_fields16 (us_split_fields17 a))
(define-fun bool_eq15 ((a us_rep9) (b us_rep9)) Bool (ite (and (= (rec__admintoken__valididcertt__valid (us_split_fields17 a)) (rec__admintoken__valididcertt__valid (us_split_fields17 b))) (= (bool_eq14 (rec__admintoken__valididcertt__contents (us_split_fields17 a)) (rec__admintoken__valididcertt__contents (us_split_fields17 b))) true)) true false))
...
(declare-datatypes () ((valididcertt__ref (mk_valididcertt__ref (valididcertt__content us_rep9)))))
(define-fun valididcertt__ref___projection ((a valididcertt__ref)) us_rep9 (valididcertt__content a))
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-sort classt 0)
(define-fun in_range24 ((x Int)) Bool (and (<= 0 x) (<= x 5)))
...
(declare-fun user_eq37 (classt classt) Bool)
(declare-const dummy37 classt)
...
(declare-fun to_rep19 (classt) Int)
(declare-fun of_rep19 (Int) classt)
(assert (forall ((x classt)) (! (= (of_rep19 (to_rep19 x)) x) :pattern ((to_rep19 x)))))
(assert (forall ((x classt)) (! (in_range24 (to_rep19 x)) :pattern ((to_rep19 x)))))
(assert (forall ((x Int)) (! (=> (in_range24 x) (= (to_rep19 (of_rep19 x)) x)) :pattern ((to_rep19 (of_rep19 x))))))
...
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref9)) us_split_fields18 (us_split_fields__content9 a))
(declare-datatypes () ((us_rep10 (mk___rep9 (us_split_fields19 us_split_fields18)))))
(define-fun us_rep___projection ((a us_rep10)) us_split_fields18 (us_split_fields19 a))
(define-fun bool_eq16 ((a us_rep10) (b us_rep10)) Bool (ite (= (to_rep19 (rec__privtypes__clearancet__class (us_split_fields19 a))) (to_rep19 (rec__privtypes__clearancet__class (us_split_fields19 b)))) true false))
...
(declare-datatypes () ((us_split_fields20 (mk___split_fields10 (rec__cert__attr__auth__contentst__id us_rep6) (rec__cert__attr__auth__contentst__notbefore us_rep1) (rec__cert__attr__auth__contentst__notafter us_rep1) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep6) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep10)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields20)) us_rep6 (rec__cert__attr__auth__contentst__id a))
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields20)) us_rep1 (rec__cert__attr__auth__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields20)) us_rep1 (rec__cert__attr__auth__contentst__notafter a))
(define-fun us_split_fields_Mechanism__3__projection ((a us_split_fields20)) algorithmt (rec__cert__attr__auth__contentst__mechanism a))
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields20)) us_rep6 (rec__cert__attr__auth__contentst__basecertid a))
(define-fun us_split_fields_Role__projection ((a us_split_fields20)) privileget (rec__cert__attr__auth__contentst__role a))
(define-fun us_split_fields_Clearance__projection ((a us_split_fields20)) us_rep10 (rec__cert__attr__auth__contentst__clearance a))
(declare-datatypes () ((us_split_fields__ref10 (mk___split_fields__ref10 (us_split_fields__content10 us_split_fields20)))))
(define-fun us_split_fields__ref___17__projection ((a us_split_fields__ref10)) us_split_fields20 (us_split_fields__content10 a))
(declare-datatypes () ((us_rep11 (mk___rep10 (us_split_fields21 us_split_fields20)))))
(define-fun us_rep___18__projection ((a us_rep11)) us_split_fields20 (us_split_fields21 a))
(define-fun bool_eq17 ((a us_rep11) (b us_rep11)) Bool (ite (and (and (and (and (and (and (= (bool_eq12 (rec__cert__attr__auth__contentst__id (us_split_fields21 a)) (rec__cert__attr__auth__contentst__id (us_split_fields21 b))) true) (= (bool_eq3 (rec__cert__attr__auth__contentst__notbefore (us_split_fields21 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields21 b))) true)) (= (bool_eq3 (rec__cert__attr__auth__contentst__notafter (us_split_fields21 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields21 b))) true)) (= (to_rep16 (rec__cert__attr__auth__contentst__mechanism (us_split_fields21 a))) (to_rep16 (rec__cert__attr__auth__contentst__mechanism (us_split_fields21 b))))) (= (bool_eq12 (rec__cert__attr__auth__contentst__basecertid (us_split_fields21 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields21 b))) true)) (= (to_rep2 (rec__cert__attr__auth__contentst__role (us_split_fields21 a))) (to_rep2 (rec__cert__attr__auth__contentst__role (us_split_fields21 b))))) (= (bool_eq16 (rec__cert__attr__auth__contentst__clearance (us_split_fields21 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields21 b))) true)) true false))
...
(define-fun contentst__ref___3__projection ((a contentst__ref1)) us_rep11 (contentst__content1 a))
(declare-datatypes () ((us_split_fields22 (mk___split_fields11 (rec__admintoken__validauthcertt__valid Bool) (rec__admintoken__validauthcertt__contents us_rep11)))))
(define-fun us_split_fields_Valid__projection ((a us_split_fields22)) Bool (rec__admintoken__validauthcertt__valid a))
(define-fun us_split_fields_Contents__projection ((a us_split_fields22)) us_rep11 (rec__admintoken__validauthcertt__contents a))
(declare-datatypes () ((us_split_fields__ref11 (mk___split_fields__ref11 (us_split_fields__content11 us_split_fields22)))))
(define-fun us_split_fields__ref___19__projection ((a us_split_fields__ref11)) us_split_fields22 (us_split_fields__content11 a))
(declare-datatypes () ((us_rep12 (mk___rep11 (us_split_fields23 us_split_fields22)))))
(define-fun us_rep___20__projection ((a us_rep12)) us_split_fields22 (us_split_fields23 a))
(define-fun bool_eq18 ((a us_rep12) (b us_rep12)) Bool (ite (and (= (rec__admintoken__validauthcertt__valid (us_split_fields23 a)) (rec__admintoken__validauthcertt__valid (us_split_fields23 b))) (= (bool_eq17 (rec__admintoken__validauthcertt__contents (us_split_fields23 a)) (rec__admintoken__validauthcertt__contents (us_split_fields23 b))) true)) true false))
...
(declare-datatypes () ((validauthcertt__ref (mk_validauthcertt__ref (validauthcertt__content us_rep12)))))
(define-fun validauthcertt__ref___projection ((a validauthcertt__ref)) us_rep12 (validauthcertt__content a))
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-fun theauthcertrole (Int us_private Int Int us_split_fields22 us_split_fields16) Int)
(declare-fun theauthcertrole__function_guard (Int Int us_private Int Int us_split_fields22 us_split_fields16) Bool)
(declare-fun therole (us_rep11) Int)
(declare-fun therole__function_guard (Int us_rep11) Bool)
(declare-sort presencet 0)
(define-fun in_range25 ((x Int)) Bool (and (<= 0 x) (<= x 1)))
...
(declare-fun user_eq41 (presencet presencet) Bool)
(declare-const dummy41 presencet)
...
(define-fun dynamic_invariant4 ((temp___expr_245 Int) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool) (temp___do_typ_inv_244 Bool)) Bool (=> (or (= temp___is_init_241 true) (<= 0 1)) (in_range25 temp___expr_245)))
...
(declare-fun user_eq42 (tokenidt tokenidt) Bool)
(declare-const dummy42 tokenidt)
...
(define-fun dynamic_invariant5 ((temp___expr_1517 Int) (temp___is_init_1513 Bool) (temp___skip_constant_1514 Bool) (temp___do_toplevel_1515 Bool) (temp___do_typ_inv_1516 Bool)) Bool (=> (or (= temp___is_init_1513 true) (<= 0 4294967295)) (in_range26 temp___expr_1517)))
(declare-sort tryt 0)
(define-fun in_range27 ((x Int)) Bool (and (<= 0 x) (<= x 2)))
...
(declare-fun user_eq43 (tryt tryt) Bool)
(declare-const dummy43 tryt)
...
(define-fun dynamic_invariant6 ((temp___expr_1524 Int) (temp___is_init_1520 Bool) (temp___skip_constant_1521 Bool) (temp___do_toplevel_1522 Bool) (temp___do_typ_inv_1523 Bool)) Bool (=> (or (= temp___is_init_1520 true) (<= 0 2)) (in_range27 temp___expr_1524)))
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields22)) (forall ((admintoken__idcert__fields us_split_fields16)) (! (=> (and (and (dynamic_invariant4 admintoken__tokenpresence true true true true) (dynamic_invariant6 admintoken__tokentry true true true true)) (dynamic_invariant5 admintoken__tokenid true true true true)) (dynamic_invariant (theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true false true true)) :pattern ((theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields22)) (forall ((admintoken__idcert__fields us_split_fields16)) (! (=> (and (and (dynamic_invariant4 admintoken__tokenpresence true true true true) (dynamic_invariant6 admintoken__tokentry true true true true)) (dynamic_invariant5 admintoken__tokenid true true true true)) (= (theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) (therole (rec__admintoken__validauthcertt__contents (us_split_fields23 (mk___rep11 admintoken__authcert__fields)))))) :pattern ((theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(declare-fun isgood (Int us_private Int Int us_split_fields22 us_split_fields16) Bool)
(declare-fun isgood__function_guard (Bool Int us_private Int Int us_split_fields22 us_split_fields16) Bool)
(assert true)
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields22)) (forall ((admintoken__idcert__fields us_split_fields16)) (! (= (= (isgood admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true) (= (rec__admintoken__valididcertt__valid (us_split_fields17 (mk___rep8 admintoken__idcert__fields))) true)) :pattern ((isgood admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(declare-fun authcertvalid (Int us_private Int Int us_split_fields22 us_split_fields16) Bool)
(declare-fun authcertvalid__function_guard (Bool Int us_private Int Int us_split_fields22 us_split_fields16) Bool)
(assert true)
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields22)) (forall ((admintoken__idcert__fields us_split_fields16)) (! (= (= (authcertvalid admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true) (= (rec__admintoken__validauthcertt__valid (us_split_fields23 (mk___rep11 admintoken__authcert__fields))) true)) :pattern ((authcertvalid admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(declare-datatypes () ((us_split_fields24 (mk___split_fields12 (rec__keystore__optionalprivatekeyt__ispresent Bool) (rec__keystore__optionalprivatekeyt__owner us_rep5)))))
...
(define-fun us_split_fields_Owner__projection ((a us_split_fields24)) us_rep5 (rec__keystore__optionalprivatekeyt__owner a))
...
(declare-fun ispresent1 (Int us_private Int Int us_split_fields22 us_split_fields16) Bool)
(declare-fun ispresent__function_guard1 (Bool Int us_private Int Int us_split_fields22 us_split_fields16) Bool)
(assert true)
(declare-fun extractuser (Int us_private Int Int us_split_fields22 us_split_fields16) (Array Int character))
(declare-fun extractuser__function_guard ((Array Int character) Int us_private Int Int us_split_fields22 us_split_fields16) Bool)
(assert true)
(declare-fun getrole (Int us_private Int Int us_split_fields22 us_split_fields16) Int)
(declare-fun getrole__function_guard (Int Int us_private Int Int us_split_fields22 us_split_fields16) Bool)
(define-fun dynamic_invariant7 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 3)) (in_range7 temp___expr_433)))
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields22)) (forall ((admintoken__idcert__fields us_split_fields16)) (! (=> (and (and (and (dynamic_invariant4 admintoken__tokenpresence true true true true) (dynamic_invariant6 admintoken__tokentry true true true true)) (dynamic_invariant5 admintoken__tokenid true true true true)) (and (= (isgood admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true) (and (= (authcertvalid admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true) (in_range7 (theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))) (dynamic_invariant7 (getrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true false true true)) :pattern ((getrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields22)) (forall ((admintoken__idcert__fields us_split_fields16)) (! (=> (and (and (dynamic_invariant4 admintoken__tokenpresence true true true true) (dynamic_invariant6 admintoken__tokentry true true true true)) (dynamic_invariant5 admintoken__tokenid true true true true)) (= (getrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) (therole (rec__admintoken__validauthcertt__contents (us_split_fields23 (mk___rep11 admintoken__authcert__fields)))))) :pattern ((getrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
...
(declare-fun user_eq45 (statust1 statust1) Bool)
(declare-const dummy45 statust1)
...
(define-fun dynamic_invariant8 ((temp___expr_2867 Int) (temp___is_init_2863 Bool) (temp___skip_constant_2864 Bool) (temp___do_toplevel_2865 Bool) (temp___do_typ_inv_2866 Bool)) Bool (=> (or (= temp___is_init_2863 true) (<= 0 8)) (in_range28 temp___expr_2867)))
...
(define-fun in_range29 ((x Int)) Bool (and (<= 1 x) (<= x 150)))
...
(declare-fun user_eq46 (descriptioni descriptioni) Bool)
(declare-const dummy46 descriptioni)
...
(define-fun dynamic_invariant13 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 4)) (in_range5 temp___expr_496)))
(define-fun dynamic_invariant14 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range24 temp___expr_440)))
(define-fun dynamic_invariant15 ((temp___expr_1092 Int) (temp___is_init_1088 Bool) (temp___skip_constant_1089 Bool) (temp___do_toplevel_1090 Bool) (temp___do_typ_inv_1091 Bool)) Bool (=> (or (= temp___is_init_1088 true) (<= 0 40)) (in_range18 temp___expr_1092)))
(define-fun dynamic_invariant16 ((temp___expr_1116 Int) (temp___is_init_1112 Bool) (temp___skip_constant_1113 Bool) (temp___do_toplevel_1114 Bool) (temp___do_typ_inv_1115 Bool)) Bool (=> (or (= temp___is_init_1112 true) (<= 0 4294967295)) (in_range19 temp___expr_1116)))
(define-fun dynamic_invariant17 ((temp___expr_1140 Int) (temp___is_init_1136 Bool) (temp___skip_constant_1137 Bool) (temp___do_toplevel_1138 Bool) (temp___do_typ_inv_1139 Bool)) Bool (=> (or (= temp___is_init_1136 true) (<= 0 10)) (in_range21 temp___expr_1140)))
(define-fun dynamic_invariant18 ((temp___expr_1154 Int) (temp___is_init_1150 Bool) (temp___skip_constant_1151 Bool) (temp___do_toplevel_1152 Bool) (temp___do_typ_inv_1153 Bool)) Bool (=> (or (= temp___is_init_1150 true) (<= 0 4294967295)) (in_range22 temp___expr_1154)))
(define-fun dynamic_invariant19 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 128)) (in_range23 temp___expr_1161)))
(define-fun dynamic_invariant20 ((temp___expr_1276 Int) (temp___is_init_1272 Bool) (temp___skip_constant_1273 Bool) (temp___do_toplevel_1274 Bool) (temp___do_typ_inv_1275 Bool)) Bool (=> (or (= temp___is_init_1272 true) (<= 0 17)) (in_range15 temp___expr_1276)))
(define-fun dynamic_invariant21 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 1 17)) (in_range13 temp___expr_1283)))
(define-fun dynamic_invariant22 ((temp___expr_1409 Int) (temp___is_init_1405 Bool) (temp___skip_constant_1406 Bool) (temp___do_toplevel_1407 Bool) (temp___do_typ_inv_1408 Bool)) Bool (=> (or (= temp___is_init_1405 true) (<= 0 2)) (in_range12 temp___expr_1409)))
(define-fun dynamic_invariant23 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 0 17408)) (in_range14 temp___expr_1290)))
(define-fun dynamic_invariant24 ((temp___expr_1321 Int) (temp___is_init_1317 Bool) (temp___skip_constant_1318 Bool) (temp___do_toplevel_1319 Bool) (temp___do_typ_inv_1320 Bool)) Bool (=> (or (= temp___is_init_1317 true) (<= 0 1024)) (in_range16 temp___expr_1321)))
(assert true)
(assert (forall ((currentlogfile Int) (numberlogentries Int)) (forall ((usedlogfiles us_rep2)) (forall ((logfileentries (Array Int fileentrycountt))) (! (= (= (valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries) true) (and (<= 1 (to_rep11 (rec__auditlog__logfilelistt__length (us_split_fields5 usedlogfiles)))) (= numberlogentries (+ (* (- (to_rep11 (rec__auditlog__logfilelistt__length (us_split_fields5 usedlogfiles))) 1) 1024) (to_rep12 (select logfileentries currentlogfile)))))) :pattern ((valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries)))))))
(declare-const rliteral2 fileentrycountt)
(assert (= (fileentrycounttqtint rliteral2) 0))
(assert (forall ((temp___1350 Int)) (=> (dynamic_invariant24 temp___1350 true true true true) (forall ((temp___1351 Int)) (= (select (temp_____aggregate_def_1348 temp___1350) temp___1351) rliteral2)))))
(define-fun dynamic_invariant25 ((temp___expr_573 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool) (temp___do_typ_inv_572 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 150)) (in_range29 temp___expr_573)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (forall ((temp___179 Int)) (=> (dynamic_invariant10 temp___179 true true true true) (forall ((temp___180 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___179) temp___180)) temp___179)))))
(define-fun dynamic_invariant26 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range8 temp___expr_625)))
(define-fun dynamic_invariant27 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range9 temp___expr_632)))
(define-fun dynamic_invariant28 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range10 temp___expr_639)))
(define-fun dynamic_invariant29 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range11 temp___expr_671)))
(define-fun dynamic_invariant30 ((temp___expr_1596 Int) (temp___is_init_1592 Bool) (temp___skip_constant_1593 Bool) (temp___do_toplevel_1594 Bool) (temp___do_typ_inv_1595 Bool)) Bool (=> (or (= temp___is_init_1592 true) (<= 0 4294967295)) (in_range20 temp___expr_1596)))
(assert (forall ((contents us_rep11)) (! (dynamic_invariant (therole contents) true false true true) :pattern ((therole contents)))))
(assert (forall ((contents us_rep11)) (! (= (therole contents) (to_rep2 (rec__cert__attr__auth__contentst__role (us_split_fields21 contents)))) :pattern ((therole contents)))))
(assert (forall ((temp___1346 Int)) (=> (dynamic_invariant21 temp___1346 true true true true) (forall ((temp___1347 Int)) (= (select (temp_____aggregate_def_1344 temp___1346) temp___1347) rliteral)))))
...
(declare-const authcert__split_fields us_split_fields__ref11)
...
(declare-const authcert__split_fields1 us_split_fields22)
...
(assert (=> (<= 0 8) (in_range28 status)))
(assert (in_range25 tokenpresence))
(assert (in_range27 tokentry))
(assert (in_range26 tokenid))
(assert (= (valid_numberlogentries (to_rep9 logfilestate__split_fields) (to_rep10 logfilestate__split_fields1) (mk___rep2 (mk___split_fields2 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6) true))
(assert (in_range17 auditalarm))
(assert (and (and (and (and (not (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true))) (=> (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1) (and (and (= (isgood tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields)) true) (= (authcertvalid tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields)) true)) (= (theauthcertrole tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields)) 1)))) (=> (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3)) (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1))) (=> (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1) (or (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3)) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true))))))
(assert (= o (ispresent1 tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields))))
(assert (= result (ite (not (= o true)) true false)))
(assert (not (= result true)))
(assert (and (= (= tokenok true) (and (and (= (isgood tokenpresence1 (let ((subject state)) state1) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true) (= (authcertvalid tokenpresence1 (let ((subject state)) state1) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true)) (in_range7 (theauthcertrole tokenpresence1 (let ((subject state)) state1) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1))))) (and (and (and (and (in_range27 tokentry1) (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true)) (in_range26 tokenid1)) (in_range17 auditalarm1)) (in_range25 tokenpresence1))))
(assert (= o1 (extractuser tokenpresence1 (let ((subject state)) state1) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1))))
(assert (and (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range17 auditalarm2)))
(assert (= tokenok true))
(assert (= o2 (extractuser tokenpresence1 (let ((subject state)) state1) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1))))
(assert (and (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range17 auditalarm3)))
(assert (and (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true) (in_range17 auditalarm4)))
(assert (= result1 (mk_int__ref status)))
(assert (= status1 3))
(assert (not (= (authcertvalid tokenpresence1 (let ((subject state)) state1) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true)))
(check-sat)
(exit)
