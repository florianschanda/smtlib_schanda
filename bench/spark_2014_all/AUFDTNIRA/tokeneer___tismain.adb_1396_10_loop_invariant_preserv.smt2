...
(assert (= (privatekeypresent thistisinfo__split_fields2 (let ((subject state)) state13)) true))
(assert (not (not (= (enrolmentisinprogress status3 (let ((subject state4)) state15)) true))))
(check-sat)
(exit)
