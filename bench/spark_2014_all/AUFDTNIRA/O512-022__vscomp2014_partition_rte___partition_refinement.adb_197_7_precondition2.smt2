...
(declare-const temp___1209 (Array Int positive))
(declare-const temp___1208 us_rep1)
(declare-const temp___1211 Int)
(declare-const temp___1210 Int)
(declare-const temp___1207 us_rep9)
(declare-const temp___1206 us_rep6)
(declare-const temp___1215 int__ref)
(declare-const o Int)
...
(declare-const temp___12152 Int)
...
(assert (=> (= result1 true) (= temp___1209 a)))
(assert (=> (= result1 true) (= temp___1208 (mk___rep1 c__split_fields1))))
(assert (=> (= result1 true) (= temp___1211 (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))))))
(assert (=> (= result1 true) (= temp___1210 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))))))
(assert (=> (= result1 true) (= temp___1207 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))
(assert (=> (= result1 true) (= temp___1206 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)))))
(assert (=> (= result1 true) (= temp___1215 (mk_int__ref 0))))
(assert (=> (= result1 true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (element x (mk___rep1 c__split_fields1))) true)))
(assert (=> (= result1 true) (and (= o (element x (mk___rep1 c__split_fields1))) (and (in_range4 o) (= o (get1 (model__ x) (get (positions x) (mk___rep1 c__split_fields1))))))))
(assert (=> (= result1 true) (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 5)) (= (to_rep (select a2 k)) (ite (= k (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o)) (to_rep (select a (+ (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))) (to_rep3 (rec__partition_refinement__interval__count (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o)))))))))) (ite (= k (+ (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))) (to_rep3 (rec__partition_refinement__interval__count (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))))) (to_rep (select a (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))) (to_rep (select a k))))))) (and (= (capacity (mk___rep4 p__split_discrs p__split_fields2)) (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (= (length2 (mk___rep4 p__split_discrs p__split_fields2)) (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) (to_rep (select a2 j))) true))) (and (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c) true) (= (to_rep (select a2 (element1 (mk___rep3 d__split_discrs d__split_fields2) c))) (key (mk___rep3 d__split_discrs d__split_fields2) c)))) (= (oeq (keys (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (keys (mk___rep3 d__split_discrs d__split_fields2))) true))))))))
(assert (=> (= result1 true) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields1) no_element) false) (= (get (positions x) (mk___rep1 c__split_fields1)) (length x)) true) true) (= (bool_eq1 (mk___rep1 c__split_fields2) no_element) true) (and (= (has_key (positions x) (mk___rep1 c__split_fields2)) true) (= (get (positions x) (mk___rep1 c__split_fields2)) (+ (get (positions x) (mk___rep1 c__split_fields1)) 1))))))
(assert (=> (= result1 true) (= (capacity (mk___rep4 p__split_discrs p__split_fields3)) temp___1210)))
(assert (=> (= result1 true) (= (length2 (mk___rep4 p__split_discrs p__split_fields3)) temp___1211)))
...
(assert (=> (= result1 true) (forall ((c us_rep1)) (=> (= (has_key (positions x) c) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) (element x c)) true)))))
...
(assert (=> (= result1 true) (=> (= (bool_eq1 (mk___rep1 c__split_fields3) no_element) true) (= o1 (length x)))))
(assert (=> (= result1 true) (=> (not (= (bool_eq1 (mk___rep1 c__split_fields3) no_element) true)) (= o1 (- (get (positions x) (mk___rep1 c__split_fields3)) 1)))))
(assert (=> (= result1 true) (= result2 (let ((subject temp___1215)) (mk_int__ref temp___12151)))))
(assert (=> (= result1 true) (= (let ((subject temp___1215)) temp___12152) o1)))
(assert (=> (= result1 true) (and (= o2 (has_key (positions x) (mk___rep1 c__split_fields3))) (= (= o2 true) (= (has_key (positions x) (mk___rep1 c__split_fields3)) true)))))
...
(assert (not (<= (* 2 (length2 (mk___rep4 p__split_discrs (us_split_fields__content4 p__split_fields6)))) (capacity (mk___rep4 p__split_discrs (us_split_fields__content4 p__split_fields6))))))
(check-sat)
(exit)
