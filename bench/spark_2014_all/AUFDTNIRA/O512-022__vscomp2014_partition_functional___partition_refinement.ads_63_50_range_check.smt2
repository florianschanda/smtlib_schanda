...
(assert (= result8 true))
(assert (and (= o1 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o1) (<= o1 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= j o2) true false)))
(assert (= result10 (ite (<= 0 j) o3 false)))
(assert (= (= result9 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 (- (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 1))) (forall ((k Int)) (=> (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) j1)))) k) (<= k (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) j1)))))) (= (to_rep5 (select f k)) j1)))))))
(assert (= result9 true))
