...
(assert (< i1 10))
(assert (<= (- 100 (* 10 i2)) r2))
(assert (and (and (=> (<= 1 200) (in_range4 r2)) (=> (<= 1 10) (in_range5 i2))) (< i2 10)))
(assert (= result8 (mk_int__ref temp___627)))
(assert (= temp___6271 i2))
(assert (= result9 (mk_int__ref temp___626)))
(assert (= temp___6261 r2))
(assert (and (= o1 (- r2 i2)) (in_range4 (- r2 i2))))
(assert (= result10 (mk_int__ref r2)))
(assert (= r3 o1))
(assert (not (in_range5 (+ i2 1))))
(check-sat)
(exit)
