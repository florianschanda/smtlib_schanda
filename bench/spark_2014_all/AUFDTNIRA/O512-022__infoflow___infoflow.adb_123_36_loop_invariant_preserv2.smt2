...
(declare-const h_v24 map__ref)
(declare-const t_v23 int__ref)
(declare-const q_v24 int__ref)
(declare-const h_v25 (Array Int content))
(declare-const t_v24 Int)
...
(assert (and (<= (to_rep h_v2__first) temp___437) (<= temp___437 (to_rep h_v2__last))))
(assert (= o3 temp___437))
...
(assert (and (= temp___438 (+ q_v22 m_v21)) (in_range1 (+ q_v22 m_v21))))
(assert (and (<= (to_rep h_v2__first) temp___438) (<= temp___438 (to_rep h_v2__last))))
(assert (= o10 temp___438))
(assert (= o11 (store h_v22 o10 o9)))
(assert (= result4 (mk_map__ref h_v22)))
(assert (= h_v23 o11))
(assert (not (= q_v22 r17b)))
(assert (= result5 (mk_int__ref q_v22)))
(assert (= q_v23 (+ q_v22 1)))
(assert (= q_v24 (mk_int__ref q_v23)))
(assert (= t_v23 (mk_int__ref t_v22)))
(assert (= h_v24 (mk_map__ref h_v23)))
(assert (= q_v25 q_v23))
(assert (= t_v24 t_v22))
(assert (= h_v25 h_v23))
(declare-const k Int)
...
(assert (< k (int__content q_v24)))
(assert (not (= (to_rep1 (select (map__content h_v24) k)) (to_rep1 (select h_v2 (+ k m_v21))))))
(check-sat)
(exit)
