...
(assert (= (temp___String_Literal_1840 Tuple0) temp___1841))
(assert (= (mk1 1 4) temp___18411))
(assert (not (dynamic_predicate (mk___t1 temp___1841 temp___18411))))
(check-sat)
(exit)
