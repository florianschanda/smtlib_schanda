...
(assert (and (= o6 (* space2 1000000)) (in_range3 (* space2 1000000))))
(assert (and (= o7 (all_elements_in a1 o6)) (= (= o7 true) (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 7)) (and (<= (- o6) (to_rep (select a1 k1))) (<= (to_rep (select a1 k1)) o6)))))))
(assert (= result1 (ite (and (= o7 true) (=> (not (= space2 1)) (=> (not (= space2 2)) (= space2 4)))) true false)))
(assert (= result1 true))
(assert (<= 0 k))
(assert (<= k 7))
