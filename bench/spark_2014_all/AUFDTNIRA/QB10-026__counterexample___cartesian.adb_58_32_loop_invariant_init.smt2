...
(assert (not (= (to_rep (select (select (map__content1 result__6) (+ (+ (* (- i (to_rep (first2 (rt1 array1)))) (length1 array2)) (- j (to_rep (first2 (rt1 array2))))) 1)) 1)) (to_rep (select (elts1 array1) i)))))
(check-sat)
(exit)
