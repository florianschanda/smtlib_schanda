...
(assert (not (or (not (= (int__content status3) 6)) (and (and (and (and (and (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4))) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4))) true)) (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))) true)) (= (current_latch (int__content currentlatch3) (us_private__content state23) (us_split_fields__content1 latchtimeout__split_fields6)) (current_latch currentlatch (us_private__content state2) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)))) (= (bool_eq3 (latch_timeout (int__content currentlatch3) (us_private__content state23) (us_split_fields__content1 latchtimeout__split_fields6)) (latch_timeout currentlatch (us_private__content state2) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) true)) (= (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4))) 4)))))
(check-sat)
(exit)
