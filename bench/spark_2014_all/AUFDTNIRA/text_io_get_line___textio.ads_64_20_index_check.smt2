...
(assert true)
(assert (forall ((textio__current_in__fields us_split_fields)) (! (= (current_file textio__current_in__fields) (mk___rep textio__current_in__fields)) :pattern ((current_file textio__current_in__fields)))))
...
(define-fun dynamic_invariant3 ((temp___expr_379 Int) (temp___is_init_375 Bool) (temp___skip_constant_376 Bool) (temp___do_toplevel_377 Bool) (temp___do_typ_inv_378 Bool)) Bool (=> (or (= temp___is_init_375 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_379)))
...
(assert (forall ((file us_rep)) (forall ((helpers__cur_position Int)) (forall ((helpers__the_file (Array Int character))) (! (=> (dynamic_invariant1 helpers__cur_position true true true true) (dynamic_invariant3 (fpeek file helpers__cur_position helpers__the_file) true false true true)) :pattern ((fpeek file helpers__cur_position helpers__the_file)))))))
...
(declare-const current_in__split_fields file_descr)
(declare-const current_in__split_fields1 Bool)
(declare-const current_in__split_fields2 Bool)
(declare-const current_in__split_fields3 count)
(declare-const current_in__split_fields4 count)
(declare-const current_in__split_fields5 count)
(declare-const current_in__split_fields6 Bool)
...
(declare-const current_in__split_fields7 file_descr)
(declare-const current_in__split_fields8 Bool)
(declare-const current_in__split_fields9 Bool)
(declare-const current_in__split_fields10 count)
(declare-const current_in__split_fields11 count)
(declare-const current_in__split_fields12 count)
(declare-const current_in__split_fields13 Bool)
(declare-const cur_position2 Int)
(declare-const item (Array Int character))
(declare-const last4 Int)
(declare-const current_in__split_fields14 file_descr)
(declare-const current_in__split_fields15 Bool)
(declare-const current_in__split_fields16 Bool)
(declare-const current_in__split_fields17 count)
(declare-const current_in__split_fields18 count)
(declare-const current_in__split_fields19 count)
(declare-const current_in__split_fields20 Bool)
(declare-const cur_position3 Int)
(declare-const item1 (Array Int character))
(declare-const last5 Int)
(declare-const current_in__split_fields21 file_descr)
(declare-const current_in__split_fields22 Bool)
(declare-const current_in__split_fields23 Bool)
(declare-const current_in__split_fields24 count)
(declare-const current_in__split_fields25 count)
(declare-const current_in__split_fields26 count)
(declare-const current_in__split_fields27 Bool)
...
(assert (not (= (end_of_file (current_file (mk___split_fields current_in__split_fields current_in__split_fields1 current_in__split_fields2 current_in__split_fields3 current_in__split_fields4 current_in__split_fields5 current_in__split_fields6)) cur_position the_file) true)))
(assert (and (ite (< (to_rep1 item__last) (to_rep1 item__first)) (= last3 (- (to_rep1 item__first) 1)) (and (and (and (or (= last3 (- (to_rep1 item__first) 1)) (and (<= (to_rep1 item__first) last3) (<= last3 (to_rep1 item__last)))) (forall ((idx1 Int)) (=> (and (<= (to_rep1 item__first) idx1) (<= idx1 last3)) (= (to_rep (select o3 idx1)) (to_rep (select the_file (+ (- idx1 (to_rep1 item__first)) cur_position))))))) (= cur_position1 (+ (- (+ cur_position last3) (to_rep1 item__first)) 1))) (or (or (= last3 (to_rep1 item__last)) (= (to_rep (select the_file cur_position1)) eof_ch)) (= (to_rep (select the_file cur_position1)) 10)))) (and (in_range4 last3) (in_range2 cur_position1))))
...
(assert (= (mk___split_fields current_in__split_fields21 current_in__split_fields22 current_in__split_fields23 current_in__split_fields24 current_in__split_fields25 current_in__split_fields26 current_in__split_fields27) (mk___split_fields current_in__split_fields7 current_in__split_fields8 current_in__split_fields9 current_in__split_fields10 current_in__split_fields11 current_in__split_fields12 current_in__split_fields13)))
(assert (= last5 last3))
(assert (= item1 o3))
(assert (= cur_position3 cur_position1))
(assert (=> (= (< (to_rep1 item__last) (to_rep1 item__first)) true) (= last4 (- (to_rep1 item__first) 1))))
(assert (not (= (< (to_rep1 item__last) (to_rep1 item__first)) true)))
(assert (=> (not (= last4 (- (to_rep1 item__first) 1))) (<= (to_rep1 item__first) last4)))
(assert (=> (not (= last4 (- (to_rep1 item__first) 1))) (<= last4 (to_rep1 item__last))))
(assert (<= (to_rep1 item__first) idx))
(assert (<= idx last4))
(assert (and (<= 1 (+ (- idx (to_rep1 item__first)) cur_position)) (<= (+ (- idx (to_rep1 item__first)) cur_position) 2147483647)))
(assert (= o (+ (- idx (to_rep1 item__first)) cur_position)))
(assert (= o1 (select the_file o)))
(assert (= o2 (to_rep o1)))
(assert (not (<= idx (to_rep1 item__last))))
(check-sat)
(exit)
