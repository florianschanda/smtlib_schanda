...
(declare-const latchtimeout__split_fields us_split_fields__ref)
...
(assert (and (= (and (and (= currentdoor 0) (= (islocked (int__content currentlatch1) (us_private__content state) (us_split_fields__content latchtimeout__split_fields)) true)) (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (mk___rep (us_split_fields__content alarmtimeout__split_fields))) true)) (= (int__content dooralarm1) 0)) (= (islocked (int__content currentlatch1) (us_private__content state) (us_split_fields__content latchtimeout__split_fields)) true)))
(assert (and (and (and (in_range5 (int__content currentlatch1)) (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content2 logfilestate__split_fields7))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content2 logfilestate__split_fields7))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content2 logfilestate__split_fields7)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content2 logfilestate__split_fields7))) true)) (in_range11 (int__content auditalarm1))) (in_range11 (int__content dooralarm1))))
(assert (= (thedooralarm (int__content dooralarm1)) 0))
(assert (not (= (islocked (int__content currentlatch1) (us_private__content state) (us_split_fields__content latchtimeout__split_fields)) true)))
(check-sat)
(exit)
