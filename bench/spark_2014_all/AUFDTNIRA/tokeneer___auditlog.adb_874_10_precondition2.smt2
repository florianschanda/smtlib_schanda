...
(assert (and (and (and (and (<= 1 (to_rep3 logfilestate__split_fields9)) (= (to_rep4 (select logfilestate__split_fields10 (to_rep1 logfilestate__split_fields4))) (to_rep4 (select logfilestate__split_fields3 (to_rep1 logfilestate__split_fields))))) (= (to_rep3 logfilestate__split_fields9) 16)) (= (to_rep2 logfilestate__split_fields5) (* (to_rep3 logfilestate__split_fields9) 1024))) (in_range7 auditalarm1)))
