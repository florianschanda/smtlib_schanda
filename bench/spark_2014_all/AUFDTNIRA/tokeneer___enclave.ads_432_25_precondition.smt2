...
(assert (and (= o10 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range1 o10) (= o10 (to_rep theadmin__split_fields)))))
(assert (= result (ite (= o10 1) true false)))
(assert (=> (= result true) (and (= o12 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o12 true) (in_range3 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result true) (= o13 (ite (not (= o12 true)) true false))))
...
(assert (=> (= result true) (=> (= result1 true) (and (= o11 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o11)))))
(assert (=> (= result true) (=> (= result1 true) (= o14 (ite (= o11 3) true false)))))
(assert (=> (= result true) (=> (not (= result1 true)) (= o14 false))))
(assert (=> (= result true) (= o15 (ite (= o14 false) o13 true))))
(assert (=> (not (= result true)) (= o15 (distinct 1 0))))
...
(assert (=> (= result3 true) (and (= o7 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o7))))
(assert (=> (= result3 true) (= result2 (ite (= o7 3) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o8 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range1 o8) (= o8 (to_rep theadmin__split_fields))))))
(assert (=> (= result2 true) (= o9 (ite (= o8 1) true false))))
(assert (=> (not (= result2 true)) (= o9 (distinct 1 0))))
...
(assert (= result4 (ite (= o 1) true false)))
(assert (=> (= result4 true) (and (= o3 (theauthcertrole tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content6 idcert__split_fields))) (and (in_range1 o3) (= o3 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content9 authcert__split_fields))))))))
(assert (=> (= result4 true) (= o4 (ite (= o3 1) true false))))
(assert (=> (= result4 true) (and (= o1 (authcertvalid tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content6 idcert__split_fields))) (= (= o1 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content9 authcert__split_fields)) true)))))
(assert (=> (= result4 true) (and (= o2 (isgood tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content6 idcert__split_fields))) (= (= o2 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content6 idcert__split_fields)) true)))))
(assert (=> (= result4 true) (= o5 (ite (= o2 true) o1 false))))
(assert (=> (= result4 true) (= o6 (ite (= o5 true) o4 false))))
(assert (=> (not (= result4 true)) (= o6 (distinct 1 0))))
(assert (and (= result5 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result5 true) (in_range3 (to_rep1 theadmin__split_fields1)))))
(assert (= result5 true))
