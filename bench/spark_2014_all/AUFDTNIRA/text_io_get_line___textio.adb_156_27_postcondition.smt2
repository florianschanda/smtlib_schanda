...
(assert (and (ite (< (to_rep1 buffer__last) (to_rep1 buffer__first)) (= last11 (- (to_rep1 buffer__first) 1)) (and (and (and (or (= last11 (- (to_rep1 buffer__first) 1)) (and (<= (to_rep1 buffer__first) last11) (<= last11 (to_rep1 buffer__last)))) (forall ((idx Int)) (=> (and (<= (to_rep1 buffer__first) idx) (<= idx last11)) (= (to_rep (select o17 idx)) (to_rep (select the_file (+ (- idx (to_rep1 buffer__first)) cur_position))))))) (= cur_position1 (+ (- (+ cur_position last11) (to_rep1 buffer__first)) 1))) (or (or (= last11 (to_rep1 buffer__last)) (= (to_rep (select the_file cur_position1)) eof_ch)) (= (to_rep (select the_file cur_position1)) 10)))) (and (in_range4 last11) (in_range2 cur_position1))))
(assert (= last11 r74b))
...
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (not (= result2 true)) (and (and (forall ((idx Int)) (=> (and (<= 1 idx) (<= idx num2)) (= (to_rep (select o18 idx)) (to_rep (select the_file2 (+ (- idx 1) cur_position_at_start)))))) (and (= cur_position2 (+ cur_position_at_start num2)) (or (= (to_rep (select the_file2 cur_position2)) eof_ch) (= (to_rep (select the_file2 cur_position2)) 10)))) (and (in_range4 num2) (in_range2 cur_position2))))))
...
(assert (not (= (int__content cur_position3) (+ cur_position_at_start (int__content num3)))))
(check-sat)
(exit)
