...
(define-fun dynamic_invariant ((temp___expr_1401 Int) (temp___is_init_1397 Bool) (temp___skip_constant_1398 Bool) (temp___do_toplevel_1399 Bool) (temp___do_typ_inv_1400 Bool)) Bool (=> (or (= temp___is_init_1397 true) (<= 0 1)) (in_range5 temp___expr_1401)))
(assert true)
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep4 (select a temp___idx_175)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep5 (select a temp___idx_172)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_172)))))))))))
...
(define-fun t__ref___projection ((a t__ref1)) us_rep3 (t__content1 a))
...
(define-fun bool_eq7 ((a (Array Int us_rep3)) (a__first Int) (a__last Int) (b (Array Int us_rep3)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq6 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true)))) true false))
...
(declare-fun user_eq16 (statust statust) Bool)
(declare-const dummy16 statust)
...
(define-fun dynamic_invariant1 ((temp___expr_190 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool) (temp___do_typ_inv_189 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 1)) (in_range11 temp___expr_190)))
...
(define-fun dynamic_invariant2 ((temp___expr_1222 us_rep2) (temp___is_init_1218 Bool) (temp___skip_constant_1219 Bool) (temp___do_toplevel_1220 Bool) (temp___do_typ_inv_1221 Bool)) Bool (=> (= temp___do_typ_inv_1221 true) (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1222))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1222))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1222)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1222))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1226 us_rep2) (temp___skip_top_level_1227 Bool)) Bool (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1226))) 1) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1226))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1226)) (mk___rep1 (mk___split_fields1 (temp_____aggregate_def_1228 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1226)) (temp_____aggregate_def_1232 0))))
(define-fun type_invariant ((temp___1236 us_rep2)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1236))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1236))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1236)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1236))) true))
...
(define-fun dynamic_invariant3 ((temp___expr_1424 Int) (temp___is_init_1420 Bool) (temp___skip_constant_1421 Bool) (temp___do_toplevel_1422 Bool) (temp___do_typ_inv_1423 Bool)) Bool (=> (or (= temp___is_init_1420 true) (<= 0 1)) (in_range12 temp___expr_1424)))
...
(assert (forall ((door__dooralarm Int)) (! (=> (dynamic_invariant1 door__dooralarm true true true true) (dynamic_invariant1 (thedooralarm door__dooralarm) true false true true)) :pattern ((thedooralarm door__dooralarm)))))
(assert (forall ((door__dooralarm Int)) (! (=> (dynamic_invariant1 door__dooralarm true true true true) (= (thedooralarm door__dooralarm) door__dooralarm)) :pattern ((thedooralarm door__dooralarm)))))
(define-fun dynamic_invariant4 ((temp___expr_1160 Int) (temp___is_init_1156 Bool) (temp___skip_constant_1157 Bool) (temp___do_toplevel_1158 Bool) (temp___do_typ_inv_1159 Bool)) Bool (=> (or (= temp___is_init_1156 true) (<= 0 17)) (in_range9 temp___expr_1160)))
(define-fun dynamic_invariant5 ((temp___expr_1167 Int) (temp___is_init_1163 Bool) (temp___skip_constant_1164 Bool) (temp___do_toplevel_1165 Bool) (temp___do_typ_inv_1166 Bool)) Bool (=> (or (= temp___is_init_1163 true) (<= 1 17)) (in_range7 temp___expr_1167)))
(define-fun dynamic_invariant6 ((temp___expr_1293 Int) (temp___is_init_1289 Bool) (temp___skip_constant_1290 Bool) (temp___do_toplevel_1291 Bool) (temp___do_typ_inv_1292 Bool)) Bool (=> (or (= temp___is_init_1289 true) (<= 0 2)) (in_range6 temp___expr_1293)))
(define-fun dynamic_invariant7 ((temp___expr_1174 Int) (temp___is_init_1170 Bool) (temp___skip_constant_1171 Bool) (temp___do_toplevel_1172 Bool) (temp___do_typ_inv_1173 Bool)) Bool (=> (or (= temp___is_init_1170 true) (<= 0 17408)) (in_range8 temp___expr_1174)))
(define-fun dynamic_invariant8 ((temp___expr_1205 Int) (temp___is_init_1201 Bool) (temp___skip_constant_1202 Bool) (temp___do_toplevel_1203 Bool) (temp___do_typ_inv_1204 Bool)) Bool (=> (or (= temp___is_init_1201 true) (<= 0 1024)) (in_range10 temp___expr_1205)))
(assert true)
...
(assert (forall ((temp___1234 Int)) (=> (dynamic_invariant8 temp___1234 true true true true) (forall ((temp___1235 Int)) (= (select (temp_____aggregate_def_1232 temp___1234) temp___1235) rliteral2)))))
(define-fun dynamic_invariant9 ((temp___expr_476 Int) (temp___is_init_472 Bool) (temp___skip_constant_473 Bool) (temp___do_toplevel_474 Bool) (temp___do_typ_inv_475 Bool)) Bool (=> (or (= temp___is_init_472 true) (<= 1901 2099)) (in_range1 temp___expr_476)))
(define-fun dynamic_invariant10 ((temp___expr_483 Int) (temp___is_init_479 Bool) (temp___skip_constant_480 Bool) (temp___do_toplevel_481 Bool) (temp___do_typ_inv_482 Bool)) Bool (=> (or (= temp___is_init_479 true) (<= 1 12)) (in_range2 temp___expr_483)))
(define-fun dynamic_invariant11 ((temp___expr_490 Int) (temp___is_init_486 Bool) (temp___skip_constant_487 Bool) (temp___do_toplevel_488 Bool) (temp___do_typ_inv_489 Bool)) Bool (=> (or (= temp___is_init_486 true) (<= 1 31)) (in_range3 temp___expr_490)))
(define-fun dynamic_invariant12 ((temp___expr_522 Int) (temp___is_init_518 Bool) (temp___skip_constant_519 Bool) (temp___do_toplevel_520 Bool) (temp___do_typ_inv_521 Bool)) Bool (=> (or (= temp___is_init_518 true) (<= 0 86399999)) (in_range4 temp___expr_522)))
(assert true)
...
(assert true)
(assert (forall ((latch__currentlatch Int)) (forall ((latch__state us_private)) (forall ((latch__latchtimeout__fields us_split_fields)) (! (=> (dynamic_invariant latch__currentlatch true true true true) (= (latch_timeout latch__currentlatch latch__state latch__latchtimeout__fields) (mk___rep latch__latchtimeout__fields))) :pattern ((latch_timeout latch__currentlatch latch__state latch__latchtimeout__fields)))))))
(assert (forall ((temp___1230 Int)) (=> (dynamic_invariant5 temp___1230 true true true true) (forall ((temp___1231 Int)) (= (select (temp_____aggregate_def_1228 temp___1230) temp___1231) rliteral)))))
...
(declare-const temp___1486 us_rep)
(declare-const currentlatch1 Int)
(declare-const latchtimeout__split_fields us_split_fields)
...
(declare-const latchtimeout__split_fields1 us_split_fields)
...
(declare-const latchtimeout__split_fields2 us_split_fields__ref)
...
(declare-const latchtimeout__split_fields3 us_split_fields)
...
(assert (and (= (bool_eq (latch_timeout currentlatch1 state latchtimeout__split_fields) o) true) (in_range5 currentlatch1)))
(assert (and (= temp___1486 (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime)) (= temp___1486 (mk___rep (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3)))))
(assert (= result (mk___split_fields__ref (mk___split_fields alarmtimeout__split_fields alarmtimeout__split_fields1 alarmtimeout__split_fields2 alarmtimeout__split_fields3))))
(assert (= alarmtimeout__split_fields4 (us_split_fields1 temp___1486)))
(assert (and (and (= (= (islocked currentlatch2 state1 latchtimeout__split_fields1) true) (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (latch_timeout currentlatch2 state1 latchtimeout__split_fields1)) true)) (= (bool_eq (latch_timeout currentlatch2 state1 latchtimeout__split_fields1) (latch_timeout currentlatch1 state latchtimeout__split_fields)) true)) (and (and (in_range5 currentlatch2) (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true)) (in_range11 auditalarm1))))
(assert (and (= (and (and (= currentdoor 0) (= (islocked currentlatch2 state1 latchtimeout__split_fields1) true)) (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (mk___rep alarmtimeout__split_fields4)) true)) (= dooralarm1 0)) (and (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range11 auditalarm2)) (in_range11 dooralarm1))))
...
(assert (= latchtimeout__split_fields2 (mk___split_fields__ref latchtimeout__split_fields1)))
...
(assert (= latchtimeout__split_fields3 latchtimeout__split_fields1))
...
(assert (= (islocked (int__content currentlatch3) (us_private__content state4) (us_split_fields__content latchtimeout__split_fields2)) true))
