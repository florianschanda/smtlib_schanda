...
(assert (forall ((i tbitfieldD1)) (and (<= 1 (tbitfieldD1qtint i)) (<= (tbitfieldD1qtint i) 1000))))
...
(declare-datatypes () ((tbitfieldD1__ref (mk_tbitfieldD1__ref (tbitfieldD1__content tbitfieldD1)))))
(define-fun tbitfieldD1__ref___projection ((a tbitfieldD1__ref)) tbitfieldD1 (tbitfieldD1__content a))
...
(declare-fun temp_____aggregate_def_245 (Bool Bool) (Array Int Bool))
...
(assert (forall ((temp___247 Bool) (temp___248 Bool)) (let ((temp___246 (temp_____aggregate_def_245 temp___247 temp___248))) (forall ((temp___249 Int)) (ite (= temp___249 1) (= (select temp___246 temp___249) temp___247) (= (select temp___246 temp___249) temp___248))))))
...
(declare-const p2 (Array Int Bool))
(declare-const n1 Int)
(declare-const i2 Int)
(assert (=> (<= 1 2147483647) (in_range2 n)))
(assert (= result p))
(assert (= p1 (temp_____aggregate_def_245 (distinct 0 0) (distinct 1 0))))
(assert (= result1 i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 1000))
(assert (and (=> (<= 1 2147483647) (in_range2 n1)) (and (<= 1 i2) (<= i2 1000))))
(assert (= (select p2 i2) true))
(assert (not (in_range1 (* 2 i2))))
(check-sat)
(exit)
