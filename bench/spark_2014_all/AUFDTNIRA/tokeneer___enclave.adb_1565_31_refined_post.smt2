...
(declare-const logfilestate__split_fields10 us_split_fields__ref3)
(declare-const auditalarm4 int__ref)
(declare-const auditsystemfault3 bool__ref)
(declare-const thistisinfo__split_fields6 us_split_fields__ref1)
...
(assert (=> (= localstatus1 0) (and (in_range5 status1) (and (and (in_range4 status1) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true)) (in_range11 auditalarm1)))))
(assert (=> (= localstatus1 0) (= store3 store1)))
(assert (=> (= localstatus1 0) (= state9 state)))
(assert (=> (= localstatus1 0) (= thistisinfo__split_fields5 (mk___split_fields1 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))))))
...
(assert (=> (not (= localstatus1 0)) (=> (not (= localstatus1 1)) (= thistisinfo__split_fields5 (mk___split_fields1 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3)))))))
...
(assert (= thistisinfo__split_fields6 (mk___split_fields__ref1 thistisinfo__split_fields5)))
(assert (= auditsystemfault3 (mk_bool__ref auditsystemfault)))
(assert (= auditalarm4 (mk_int__ref auditalarm1)))
(assert (= logfilestate__split_fields10 (mk___split_fields__ref3 logfilestate__split_fields7)))
...
(assert (not (= (enrolmentisinprogress (int__content status4)) true)))
(assert (not (= (privatekeypresent (us_split_fields__content1 thistisinfo__split_fields6) (us_private__content state16)) true)))
(check-sat)
(exit)
