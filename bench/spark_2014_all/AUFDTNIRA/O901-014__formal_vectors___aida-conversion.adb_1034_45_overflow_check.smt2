...
(assert (and (<= (to_rep1 (first (rt source))) temp___1839) (<= temp___1839 (to_rep1 (last (rt source))))))
(assert (= o26 temp___1839))
...
(assert (= o30 (* o29 100)))
(assert (and (= o37 o30) (in_range1 o30)))
(assert (= o38 (+ o37 o36)))
(assert (and (= o45 o38) (in_range1 o38)))
(assert (= o46 (+ o45 o44)))
(assert (not (in_range1 o46)))
(check-sat)
(exit)
