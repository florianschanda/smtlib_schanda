...
(define-fun locallatch3 () int__ref (mk_int__ref locallatch))
...
(assert (=> (= result true) (= result1 locallatch3)))
(assert (=> (= result true) (= locallatch1 0)))
(assert (=> (= result true) (= result2 id3)))
(assert (=> (= result true) (= id1 8)))
(assert (=> (not (= result true)) (= result3 locallatch3)))
(assert (=> (not (= result true)) (= locallatch2 1)))
(assert (=> (not (= result true)) (= result4 id3)))
