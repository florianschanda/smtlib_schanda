...
(assert (<= j index22))
(assert (and (<= (to_rep (first2 (rt1 array1))) index11) (<= index11 (to_rep (last2 (rt1 array1))))))
(assert (= o15 index11))
(assert (= o16 (select (elts1 array1) o15)))
...
(assert (= o14 (+ o13 1)))
(assert (and (= temp___279 o14) (in_range1 o14)))
(assert (not (<= temp___279 (to_rep result____last))))
(check-sat)
(exit)
