...
(declare-const temp___1902 us_t1)
(declare-const o5 us_t1)
...
(declare-const thedigest__split_fields5 us_split_fields4)
(declare-const retvalfin2 Int)
(declare-const thedigest__split_fields6 us_split_fields__ref2)
(declare-const retvalfin3 int__ref)
(declare-const thedigest__split_fields7 us_split_fields4)
(declare-const retvalfin4 Int)
(declare-const thedigest__split_fields8 us_split_fields__ref2)
...
(declare-const thedigest__split_fields9 us_split_fields4)
...
(assert (=> (= retvalini1 0) (= loopmax2 (+ (div1 (- (to_rep10 (rec__certtypes__rawdatat__datalength (us_split_fields7 rawcertdata))) 1) 100) 1))))
(assert (=> (= retvalini1 0) (= result5 bytesleft13)))
(assert (=> (= retvalini1 0) (= bytesleft2 (to_rep10 (rec__certtypes__rawdatat__datalength (us_split_fields7 rawcertdata))))))
...
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= temp___1899 j2))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= temp___1898 size1))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= temp___1897 retvalupd1))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= temp___1896 block))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= temp___1895 bytesleft2))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= temp___1900 loopmax2))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (and (and (and (and (and (and (= loopmax2 (+ (div1 (- (to_rep10 (rec__certtypes__rawdatat__datalength (us_split_fields7 rawcertdata))) 1) 100) 1)) (= loopmax2 temp___1900)) (and (<= 1 j3) (<= j3 loopmax2))) (= bytesleft3 (- (to_rep10 (rec__certtypes__rawdatat__datalength (us_split_fields7 rawcertdata))) (* (- j3 1) 100)))) (and (<= 1 size2) (<= size2 100))) (= retvalini1 0)) (= retvalfin1 0)))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (and (and (and (and (=> (<= 1 2147483647) (in_range2 bytesleft3)) (=> (<= 0 28) (in_range10 retvalupd2))) (=> (<= 0 4294967295) (in_range11 size2))) (=> (<= 1 r29b) (dynamic_property3 1 r29b j3))) (and (<= 1 j3) (<= j3 r29b))))))
...
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= o3 (getblock (rec__certtypes__rawdatat__rawdata (us_split_fields7 rawcertdata)) j3 size3)))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= result8 (mk_map__ref block2)))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= block3 o3))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (in_range10 retvalupd3))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (or (and (and (= bytesleft5 (mk_int__ref bytesleft3)) (= bytesleft6 bytesleft3)) (=> (= retvalupd3 0) (= j3 loopmax2))) (and (not (=> (= retvalupd3 0) (= j3 loopmax2))) (and (and (= bytesleft5 (mk_int__ref bytesleft4)) (= bytesleft6 bytesleft4)) (and (and (and (= o4 (- bytesleft3 100)) (in_range2 (- bytesleft3 100))) (and (= result9 (mk_int__ref bytesleft3)) (= bytesleft4 o4))) (= j3 r29b))))))))
...
(assert (=> (= retvalini1 0) (=> (= (int__content retvalupd6) 0) (in_range10 retvalfin2))))
(assert (=> (= retvalini1 0) (=> (= (int__content retvalupd6) 0) (= retvalfin3 (mk_int__ref retvalfin2)))))
(assert (=> (= retvalini1 0) (=> (= (int__content retvalupd6) 0) (= thedigest__split_fields6 (mk___split_fields__ref2 thedigest__split_fields5)))))
...
(assert (=> (= retvalini1 0) (=> (not (= (int__content retvalupd6) 0)) (= thedigest__split_fields6 (mk___split_fields__ref2 thedigest__split_fields4)))))
...
(assert (=> (not (= retvalini1 0)) (= thedigest__split_fields8 (mk___split_fields__ref2 thedigest__split_fields4))))
...
(assert (= temp___1902 (mk___t1 (temp___String_Literal_1901 Tuple0) (mk1 1 10))))
(assert (dynamic_predicate temp___1902))
(assert (= o5 temp___1902))
(assert (= o6 (convertretvaltotext retvalini1 o5)))
(assert (= o7 (mk___t o6 (mk 1 150))))
(assert (not (= (to_rep1 (first (rt o7))) 1)))
(check-sat)
(exit)
