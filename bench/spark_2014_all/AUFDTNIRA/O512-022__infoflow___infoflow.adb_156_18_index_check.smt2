...
(assert (and (<= (to_rep h__first) temp___521) (<= temp___521 (to_rep h__last))))
(assert (= o3 temp___521))
...
(assert (and (= temp___522 (+ q2 m1)) (in_range1 (+ q2 m1))))
(assert (not (<= temp___522 (to_rep h__last))))
(check-sat)
(exit)
