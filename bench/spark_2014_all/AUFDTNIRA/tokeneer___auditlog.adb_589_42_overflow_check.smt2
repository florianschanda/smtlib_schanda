...
(declare-const o Int)
(declare-const o1 logentrycountt)
(declare-const o2 logfileindext)
(declare-const o3 logentrycountt)
...
(declare-const o8 (Array Int fileentrycountt))
(declare-const temp___1782 logfileindext)
(declare-const temp___17821 logentrycountt)
(declare-const temp___17822 (Array Int logfileindext))
(declare-const temp___17823 logfileindext)
(declare-const temp___17824 logfileindext)
(declare-const temp___17825 logfilecountt)
(declare-const temp___17826 (Array Int fileentrycountt))
...
(declare-const result logfileindext)
(declare-const result1 logentrycountt)
(declare-const result2 (Array Int logfileindext))
(declare-const result3 logfileindext)
(declare-const result4 logfileindext)
(declare-const result5 logfilecountt)
(declare-const result6 (Array Int fileentrycountt))
...
(assert (and (= o (+ (to_rep1 logfilestate__split_fields8) 1)) (in_range2 (+ (to_rep1 logfilestate__split_fields8) 1))))
(assert (= (to_rep1 o1) o))
(assert (= logfilestate__split_fields7 o2))
(assert (= o1 o3))
(assert (= logfilestate__split_fields9 o4))
(assert (= logfilestate__split_fields10 o5))
(assert (= logfilestate__split_fields11 o6))
(assert (= logfilestate__split_fields12 o7))
(assert (= logfilestate__split_fields13 o8))
(assert (= temp___1782 o2))
(assert (= temp___17821 o3))
(assert (= temp___17822 o4))
(assert (= temp___17823 o5))
(assert (= temp___17824 o6))
(assert (= temp___17825 o7))
(assert (= temp___17826 o8))
(assert (= result logfilestate__split_fields7))
(assert (= result1 logfilestate__split_fields8))
(assert (= result2 logfilestate__split_fields9))
(assert (= result3 logfilestate__split_fields10))
(assert (= result4 logfilestate__split_fields11))
(assert (= result5 logfilestate__split_fields12))
(assert (= result6 logfilestate__split_fields13))
(assert (= logfilestate__split_fields21 (mk___split_fields1 temp___1782 temp___17821 (mk___rep (mk___split_fields temp___17822 temp___17823 temp___17824 temp___17825)) temp___17826)))
(assert (= logfilestate__split_fields22 (mk___split_fields__ref1 logfilestate__split_fields21)))
...
(assert (=> (< (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024) (= o14 (ite (= (to_rep3 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields22)) (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields22))))) (+ (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1)) (ite (= (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22))))) (to_rep2 logfilestate__split_fields5)) true false) false))))
(assert (=> (not (< (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024)) (= o14 (distinct 1 0))))
(assert (=> (= (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024) (= o13 (ite (= (to_rep3 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields22)) (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields22))))) 1) (ite (= (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22))))) (+ (to_rep2 logfilestate__split_fields5) 1)) true false) false))))
(assert (=> (not (= (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024)) (= o13 (distinct 1 0))))
(assert (and (= o9 (- (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22))))) 1)) (in_range2 (- (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22))))) 1))))
(assert (= o10 (* o9 1024)))
(assert (and (= o11 o10) (in_range9 o10)))
(assert (= o12 (+ o11 (to_rep3 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields22)) (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields22))))))))
(assert (not (in_range9 o12)))
(check-sat)
(exit)
