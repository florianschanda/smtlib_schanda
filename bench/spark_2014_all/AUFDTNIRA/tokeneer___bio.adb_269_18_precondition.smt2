...
(declare-const o Int)
(declare-const temp___1490 (Array Int character))
(declare-const temp___14901 t1)
...
(define-fun o6 () us_t1 (mk___t1 o1 o2))
(define-fun temp___14902 () us_t1 (mk___t1 temp___1490 temp___14901))
...
(assert (= (temp___String_Literal_1489 Tuple0) temp___1490))
(assert (= (mk1 1 25) temp___14901))
(assert (dynamic_predicate temp___14902))
(assert (= o6 temp___14902))
(assert (= o3 (makedescription o6 numericreturn1)))
(assert (= o3 o4))
(assert (= (mk 1 150) o5))
(assert (not (= (to_rep1 (first o5)) 1)))
(check-sat)
(exit)
