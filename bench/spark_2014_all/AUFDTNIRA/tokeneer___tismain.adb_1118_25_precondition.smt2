...
(assert (and (= result (enrolmentisinprogress status (us_private__content state))) (= (= result true) (in_range23 status))))
(assert (=> (= result true) (and (= o17 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o17 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result true) (= o18 (ite (not (= o17 true)) true false))))
(assert (=> (= result true) (and (= o16 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o16 true) (in_range4 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
...
(assert (=> (= result1 true) (and (= o12 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (and (in_range1 o12) (= o12 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result1 true) (= o13 (ite (= o12 0) true false))))
(assert (=> (= result1 true) (and (= o11 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o11 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
...
(assert (=> (= result2 true) (and (= o9 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o9 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
...
(assert (=> (= result3 true) (and (= o6 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o6 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result3 true) (and (= o7 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o7 true) (in_range4 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
...
(assert (=> (= result4 true) (and (= o2 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o2 true) (in_range4 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result4 true) (= o3 (ite (not (= o2 true)) true false))))
(assert (=> (not (= result4 true)) (= o3 (distinct 1 0))))
(assert (and (= result5 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= result5 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields)))))))
(assert (= result5 true))
