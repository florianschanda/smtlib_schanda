...
(assert (= result5 true))
(assert (and (= o (+ (to_rep2 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10)))) 1)) (in_range6 (+ (to_rep2 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10)))) 1))))
(assert (= (to_rep2 o1) o))
(assert (= o2 (mk___split_fields (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10))) (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10))) o1 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10))))))
(assert (= o3 (mk___rep o2)))
(assert (= o4 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10) o3 (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10))))
(assert (= temp___1546 (mk___rep1 o4)))
(assert (= result6 (mk___split_fields__ref1 logfilestate__split_fields10)))
(assert (= logfilestate__split_fields11 (us_split_fields3 temp___1546)))
(assert (and (= o5 (+ (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11)))) 1)) (in_range8 (+ (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11)))) 1))))
(assert (= (to_rep4 o6) o5))
(assert (= o7 (mk___split_fields (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11))) (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11))) (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11))) o6)))
(assert (= o8 (mk___rep o7)))
(assert (= o9 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11) o8 (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11))))
(assert (= temp___1549 (mk___rep1 o9)))
(assert (= result7 (mk___split_fields__ref1 logfilestate__split_fields11)))
(assert (= logfilestate__split_fields12 (us_split_fields3 temp___1549)))
(assert (= (to_rep2 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12)))) r78b))
(assert (in_range6 r78b))
(assert (and (= temp___1550 (+ j2 1)) (in_range11 (+ j2 1))))
(assert (= result8 (mk_int__ref k)))
(assert (= k1 r78b))
(assert (<= temp___1550 k1))
(assert (<= k1 r78b))
(assert (and (and (and (and (= (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields13) (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields12)) (= (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields13) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields12))) (and (and (and (forall ((temp___1559 Int)) (=> (and (<= 1 temp___1559) (<= temp___1559 17)) (=> (or (< r78b temp___1559) (or (< temp___1559 temp___1550) (<= temp___1559 k2))) (= (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13))) temp___1559) (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12))) temp___1559))))) (= (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13))) (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12))))) (= (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13))) (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12))))) (= (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13))) (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12)))))) (= (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields13) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields12))) (and (<= (+ j2 1) k2) (<= k2 r78b))))
(assert (and (= temp___1553 (- k2 1)) (in_range11 (- k2 1))))
(assert (and (<= 1 temp___1553) (<= temp___1553 17)))
(assert (= o10 temp___1553))
(assert (= o11 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13))) o10)))
