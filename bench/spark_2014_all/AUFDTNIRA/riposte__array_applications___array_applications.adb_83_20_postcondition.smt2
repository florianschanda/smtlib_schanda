...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___199 a2)))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___198 i1)))
...
(assert (=> (and (<= 2 i1) (<= i1 30)) (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___200 Int)) (=> (and (<= 0 temp___200) (<= temp___200 30)) (=> (or (< 30 temp___200) (or (< temp___200 2) (< i2 temp___200))) (= (select a4 temp___200) (select temp___199 temp___200)))))) (and (<= 2 i2) (<= i2 30)))))
