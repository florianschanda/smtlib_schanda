...
(declare-const temp___322 (Array Int natural))
(assert (not (= (to_rep (select i5b 3)) 0)))
(assert (not (= (to_rep (select a 3)) 0)))
(assert (and (= o (div1 (to_rep (select a 2)) (to_rep (select a 3)))) (in_range1 (div1 (to_rep (select a 2)) (to_rep (select a 3))))))
(assert (= (to_rep o1) o))
(assert (= temp___322 (store a 1 o1)))
(assert (not (dynamic_predicate temp___322)))
(check-sat)
(exit)
