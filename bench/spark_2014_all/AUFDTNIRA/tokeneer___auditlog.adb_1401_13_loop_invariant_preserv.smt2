...
(assert (not (= (to_rep2 (select logfilesstatus2 (to_rep3 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11))) (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11)))))))) 1)))
(check-sat)
(exit)
