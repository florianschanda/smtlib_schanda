...
(declare-const logfilestate__split_fields1 logfilecountt)
(declare-const logfilestate__split_fields2 (Array Int fileentrycountt))
(declare-const o Int)
...
(assert (<= 1 (to_rep3 logfilestate__split_fields1)))
(assert (and (= o (- (to_rep3 logfilestate__split_fields1) 1)) (in_range3 (- (to_rep3 logfilestate__split_fields1) 1))))
(assert (= o1 (* o 1024)))
(assert (and (= o2 o1) (in_range10 o1)))
(assert (= o3 (+ o2 (to_rep4 (select logfilestate__split_fields2 (to_rep1 logfilestate__split_fields))))))
(assert (not (in_range10 o3)))
(check-sat)
(exit)
