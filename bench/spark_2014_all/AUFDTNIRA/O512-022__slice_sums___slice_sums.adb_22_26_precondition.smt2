...
(assert (=> (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo result____split_fields3))) (= result3 (ite (<= (extended_indexqtint (rec__sums__slice_bounds__hi result____split_fields3)) (to_rep (last (rt x)))) true false))))
(assert (=> (not (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo result____split_fields3)))) (= result3 false)))
(assert (= result3 true))
(assert (not (or (< (extended_indexqtint (rec__sums__slice_bounds__hi result____split_fields3)) (indexqtint (rec__sums__slice_bounds__lo result____split_fields3))) (and (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo result____split_fields3))) (<= (extended_indexqtint (rec__sums__slice_bounds__hi result____split_fields3)) (to_rep (last (rt x))))))))
(check-sat)
(exit)
