...
(assert (= result1 true))
(assert (and (= o21 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range6 o21)))
(assert (= result2 (ite (= o21 4) true false)))
(assert (= result2 true))
(assert (and (= o17 (thedooralarm (us_private__content state2))) (in_range17 o17)))
(assert (= o18 (ite (= o17 0) true false)))
(assert (= o19 (ite o18 1 0)))
(assert (= o13 (alarm_timeout (us_private__content state2))))
(assert (and (= o12 (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime)) (= o12 (mk___rep1 (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3)))))
(assert (and (= o14 (greaterthanorequal o12 o13)) (= (= o14 true) (or (= (greaterthan o12 o13) true) (= (bool_eq3 o12 o13) true)))))
(assert (and (= o9 (thecurrentdoor (us_private__content state2))) (in_range29 o9)))
(assert (= o10 (ite (= o9 0) true false)))
(assert (and (= o11 (islocked currentlatch (us_private__content state1) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) (= (= o11 true) (= currentlatch 0))))
(assert (= o15 (ite (= o11 true) o10 false)))
(assert (= o16 (ite (= o15 true) o14 false)))
(assert (= o20 (ite o16 1 0)))
(assert (= result3 (ite (= o20 o19) true false)))
(assert (= result3 true))
(assert (and (= o3 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range4 o3) (= o3 (to_rep2 theadmin__split_fields)))))
(assert (= result5 (ite (= o3 1) true false)))
(assert (=> (= result5 true) (and (= o6 (theauthcertrole tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields))) (and (in_range4 o6) (= o6 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content11 authcert__split_fields))))))))
(assert (=> (= result5 true) (= o7 (ite (= o6 1) true false))))
(assert (=> (= result5 true) (and (= o4 (authcertvalid tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields))) (= (= o4 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content11 authcert__split_fields)) true)))))
(assert (=> (= result5 true) (and (= o5 (isgood tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields))) (= (= o5 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content8 idcert__split_fields)) true)))))
(assert (=> (= result5 true) (= o8 (ite (= o5 true) o4 false))))
(assert (=> (= result5 true) (= result4 (ite (= o8 true) o7 false))))
(assert (=> (not (= result5 true)) (= result4 (distinct 1 0))))
(assert (= result4 true))
...
(assert (= result6 (ite (= o 1) true false)))
(assert (= result6 true))
