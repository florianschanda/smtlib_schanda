...
(declare-fun user_eq20 (presencet presencet) Bool)
(declare-const dummy20 presencet)
...
(define-fun dynamic_invariant2 ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= 0 1)) (in_range13 temp___expr_222)))
...
(declare-fun user_eq21 (statscount statscount) Bool)
(declare-const dummy21 statscount)
...
(define-fun in_range15 ((x Int)) Bool (and (<= 0 x) (<= x 7)))
(declare-fun attr__ATTRIBUTE_IMAGE15 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check15 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE15 (us_image) Int)
(declare-fun user_eq23 (statust1 statust1) Bool)
(declare-const dummy23 statust1)
...
(define-fun dynamic_invariant3 ((temp___expr_2551 Int) (temp___is_init_2547 Bool) (temp___skip_constant_2548 Bool) (temp___do_toplevel_2549 Bool) (temp___do_typ_inv_2550 Bool)) Bool (=> (or (= temp___is_init_2547 true) (<= 0 7)) (in_range15 temp___expr_2551)))
...
(define-fun dynamic_invariant8 ((temp___expr_1164 Int) (temp___is_init_1160 Bool) (temp___skip_constant_1161 Bool) (temp___do_toplevel_1162 Bool) (temp___do_typ_inv_1163 Bool)) Bool (=> (or (= temp___is_init_1160 true) (<= 0 17)) (in_range9 temp___expr_1164)))
(define-fun dynamic_invariant9 ((temp___expr_1171 Int) (temp___is_init_1167 Bool) (temp___skip_constant_1168 Bool) (temp___do_toplevel_1169 Bool) (temp___do_typ_inv_1170 Bool)) Bool (=> (or (= temp___is_init_1167 true) (<= 1 17)) (in_range7 temp___expr_1171)))
(define-fun dynamic_invariant10 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 0 2)) (in_range11 temp___expr_1297)))
(define-fun dynamic_invariant11 ((temp___expr_1178 Int) (temp___is_init_1174 Bool) (temp___skip_constant_1175 Bool) (temp___do_toplevel_1176 Bool) (temp___do_typ_inv_1177 Bool)) Bool (=> (or (= temp___is_init_1174 true) (<= 0 17408)) (in_range8 temp___expr_1178)))
(define-fun dynamic_invariant12 ((temp___expr_1209 Int) (temp___is_init_1205 Bool) (temp___skip_constant_1206 Bool) (temp___do_toplevel_1207 Bool) (temp___do_typ_inv_1208 Bool)) Bool (=> (or (= temp___is_init_1205 true) (<= 0 1024)) (in_range10 temp___expr_1209)))
(assert true)
...
(define-fun dynamic_invariant13 ((temp___expr_590 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool) (temp___do_typ_inv_589 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 1 150)) (in_range16 temp___expr_590)))
...
(define-fun dynamic_invariant18 ((temp___expr_1774 Int) (temp___is_init_1770 Bool) (temp___skip_constant_1771 Bool) (temp___do_toplevel_1772 Bool) (temp___do_typ_inv_1773 Bool)) Bool (=> (or (= temp___is_init_1770 true) (<= 0 2147483647)) (in_range14 temp___expr_1774)))
...
(assert (= status 2))
(assert (=> (<= 0 1) (in_range13 fingerpresence)))
(assert (= o (ispresent state)))
(assert (= result (ite (not (= o true)) true false)))
(assert (not (= result true)))
(assert (and (= o6 (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime)) (and (= currenttimevar__split_fields o1) (and (= currenttimevar__split_fields1 o2) (and (= currenttimevar__split_fields2 o3) (= currenttimevar__split_fields3 o4))))))
(assert (and (= result1 (greaterthan o6 (mk___rep (mk___split_fields fingertimeout__split_fields fingertimeout__split_fields1 fingertimeout__split_fields2 fingertimeout__split_fields3)))) (= (= result1 true) (or (or (or (< (to_rep2 fingertimeout__split_fields) (to_rep2 o1)) (and (= (to_rep2 o1) (to_rep2 fingertimeout__split_fields)) (< (to_rep3 fingertimeout__split_fields1) (to_rep3 o2)))) (and (and (= (to_rep2 o1) (to_rep2 fingertimeout__split_fields)) (= (to_rep3 o2) (to_rep3 fingertimeout__split_fields1))) (< (to_rep4 fingertimeout__split_fields2) (to_rep4 o3)))) (and (and (and (= (to_rep2 o1) (to_rep2 fingertimeout__split_fields)) (= (to_rep3 o2) (to_rep3 fingertimeout__split_fields1))) (= (to_rep4 o3) (to_rep4 fingertimeout__split_fields2))) (< (to_rep5 fingertimeout__split_fields3) (to_rep5 o4)))))))
(assert (= result1 true))
(assert (= o5 (extractuser state)))
