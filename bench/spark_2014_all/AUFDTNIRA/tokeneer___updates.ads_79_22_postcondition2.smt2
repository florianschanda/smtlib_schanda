...
(define-fun dynamic_invariant1 ((temp___expr_545 Int) (temp___is_init_541 Bool) (temp___skip_constant_542 Bool) (temp___do_toplevel_543 Bool) (temp___do_typ_inv_544 Bool)) Bool (=> (or (= temp___is_init_541 true) (<= 0 1)) (in_range11 temp___expr_545)))
...
(define-fun dynamic_invariant3 ((temp___expr_1273 Int) (temp___is_init_1269 Bool) (temp___skip_constant_1270 Bool) (temp___do_toplevel_1271 Bool) (temp___do_typ_inv_1272 Bool)) Bool (=> (or (= temp___is_init_1269 true) (<= 0 17)) (in_range9 temp___expr_1273)))
(define-fun dynamic_invariant4 ((temp___expr_1280 Int) (temp___is_init_1276 Bool) (temp___skip_constant_1277 Bool) (temp___do_toplevel_1278 Bool) (temp___do_typ_inv_1279 Bool)) Bool (=> (or (= temp___is_init_1276 true) (<= 1 17)) (in_range7 temp___expr_1280)))
(define-fun dynamic_invariant5 ((temp___expr_1406 Int) (temp___is_init_1402 Bool) (temp___skip_constant_1403 Bool) (temp___do_toplevel_1404 Bool) (temp___do_typ_inv_1405 Bool)) Bool (=> (or (= temp___is_init_1402 true) (<= 0 2)) (in_range6 temp___expr_1406)))
(define-fun dynamic_invariant6 ((temp___expr_1287 Int) (temp___is_init_1283 Bool) (temp___skip_constant_1284 Bool) (temp___do_toplevel_1285 Bool) (temp___do_typ_inv_1286 Bool)) Bool (=> (or (= temp___is_init_1283 true) (<= 0 17408)) (in_range8 temp___expr_1287)))
(define-fun dynamic_invariant7 ((temp___expr_1318 Int) (temp___is_init_1314 Bool) (temp___skip_constant_1315 Bool) (temp___do_toplevel_1316 Bool) (temp___do_typ_inv_1317 Bool)) Bool (=> (or (= temp___is_init_1314 true) (<= 0 1024)) (in_range10 temp___expr_1318)))
(assert true)
...
(assert (forall ((temp___1347 Int)) (=> (dynamic_invariant7 temp___1347 true true true true) (forall ((temp___1348 Int)) (= (select (temp_____aggregate_def_1345 temp___1347) temp___1348) rliteral2)))))
(define-fun dynamic_invariant8 ((temp___expr_622 Int) (temp___is_init_618 Bool) (temp___skip_constant_619 Bool) (temp___do_toplevel_620 Bool) (temp___do_typ_inv_621 Bool)) Bool (=> (or (= temp___is_init_618 true) (<= 1901 2099)) (in_range1 temp___expr_622)))
(define-fun dynamic_invariant9 ((temp___expr_629 Int) (temp___is_init_625 Bool) (temp___skip_constant_626 Bool) (temp___do_toplevel_627 Bool) (temp___do_typ_inv_628 Bool)) Bool (=> (or (= temp___is_init_625 true) (<= 1 12)) (in_range2 temp___expr_629)))
(define-fun dynamic_invariant10 ((temp___expr_636 Int) (temp___is_init_632 Bool) (temp___skip_constant_633 Bool) (temp___do_toplevel_634 Bool) (temp___do_typ_inv_635 Bool)) Bool (=> (or (= temp___is_init_632 true) (<= 1 31)) (in_range3 temp___expr_636)))
(define-fun dynamic_invariant11 ((temp___expr_668 Int) (temp___is_init_664 Bool) (temp___skip_constant_665 Bool) (temp___do_toplevel_666 Bool) (temp___do_typ_inv_667 Bool)) Bool (=> (or (= temp___is_init_664 true) (<= 0 86399999)) (in_range4 temp___expr_668)))
(assert (forall ((temp___1343 Int)) (=> (dynamic_invariant4 temp___1343 true true true true) (forall ((temp___1344 Int)) (= (select (temp_____aggregate_def_1341 temp___1343) temp___1344) rliteral)))))
...
(assert (and (or (= (= (islocked currentlatch state (mk___split_fields latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) true) (= (latchislocked Tuple0) true)) (= systemfault true)) (and (= (valid_numberlogentries (to_rep5 logfilestate__split_fields7) (to_rep6 logfilestate__split_fields8) (mk___rep1 (mk___split_fields1 logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13) true) (in_range11 auditalarm1))))
