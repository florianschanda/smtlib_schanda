...
(assert (= o13 result__))
(assert (= o13 temp___716))
(assert (= (mk3 1 r77b) temp___7161))
(assert (not (= (ite (<= (to_rep1 (first6 temp___7141)) (to_rep1 (last6 temp___7141))) (+ (- (to_rep1 (last6 temp___7141)) (to_rep1 (first6 temp___7141))) 1) 0) (ite (<= (to_rep1 (first6 temp___7161)) (to_rep1 (last6 temp___7161))) (+ (- (to_rep1 (last6 temp___7161)) (to_rep1 (first6 temp___7161))) 1) 0))))
(check-sat)
(exit)
