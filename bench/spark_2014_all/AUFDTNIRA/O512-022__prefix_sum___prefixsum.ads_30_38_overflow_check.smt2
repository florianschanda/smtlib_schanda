...
(define-fun dynamic_invariant2 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 7)) (in_range3 temp___expr_159)))
(declare-const k Int)
(declare-const o Int)
...
(assert (= o6 (to_rep o5)))
(assert (and (<= 0 (- k 1)) (<= (- k 1) 7)))
(assert (= o (- k 1)))
(assert (= o1 (select b o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (+ (to_rep (select b k)) o2)))
(assert (and (= o7 o3) (in_range1 o3)))
(assert (= o8 (+ o7 o6)))
