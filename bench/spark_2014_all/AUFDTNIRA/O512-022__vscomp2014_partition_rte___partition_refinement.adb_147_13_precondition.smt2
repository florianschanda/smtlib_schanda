...
(declare-const temp___1288 index)
(declare-const temp___12881 index)
(declare-const temp___12882 index_count)
(declare-const o6 Int)
(declare-const o7 index)
(declare-const o8 index)
(declare-const o9 index)
(declare-const o10 index_count)
(declare-const temp___1290 index)
(declare-const temp___12901 index)
(declare-const temp___12902 index_count)
...
(define-fun p__split_fields3 () us_split_fields (mk___split_fields p__split_fields1))
...
(assert (<= 0 j1))
(assert (<= j1 r29b))
(assert (= (capacity (mk___rep p__split_discrs p__split_fields3)) (capacity (mk___rep p__split_discrs (mk___split_fields p__split_fields)))))
(assert (and (<= 0 (- (length (mk___rep p__split_discrs p__split_fields3)) (length (mk___rep p__split_discrs (mk___split_fields p__split_fields))))) (<= (- (length (mk___rep p__split_discrs p__split_fields3)) (length (mk___rep p__split_discrs (mk___split_fields p__split_fields)))) j2)))
(assert (and (and (=> (<= 0 10000) (in_range6 p_prime_index1)) (=> (<= 0 r29b) (dynamic_property 0 r29b j2))) (and (<= 0 j2) (<= j2 r29b))))
(assert (and (= temp___12873 (get (model__ (mk___rep p__split_discrs p__split_fields3)) j2)) (= (bool_eq temp___12873 (get (model__ (mk___rep p__split_discrs p__split_fields3)) j2)) true)))
...
(assert (= o2 o3))
(assert (= (rec__partition_refinement__interval__last p_elem__split_fields3) o4))
(assert (= rliteral o5))
(assert (= temp___1288 o3))
(assert (= temp___12881 o4))
(assert (= temp___12882 o5))
(assert (= result2 (mk___split_fields__ref1 p_prime__split_fields)))
(assert (= p_prime__split_fields1 (mk___split_fields1 temp___1288 temp___12881 temp___12882)))
(assert (and (= o6 (- (+ (to_rep2 (rec__partition_refinement__interval__first p_elem__split_fields3)) (to_rep1 (rec__partition_refinement__interval__count p_elem__split_fields3))) 1)) (in_range3 (- (+ (to_rep2 (rec__partition_refinement__interval__first p_elem__split_fields3)) (to_rep1 (rec__partition_refinement__interval__count p_elem__split_fields3))) 1))))
(assert (= (to_rep2 o7) o6))
(assert (= (rec__partition_refinement__interval__first p_elem__split_fields3) o8))
(assert (= o7 o9))
(assert (= (rec__partition_refinement__interval__count p_elem__split_fields3) o10))
(assert (= temp___1290 o8))
(assert (= temp___12901 o9))
(assert (= temp___12902 o10))
(assert (= result3 (mk___split_fields__ref1 p_elem__split_fields3)))
(assert (= p_elem__split_fields4 (mk___split_fields1 temp___1290 temp___12901 temp___12902)))
(assert (= result4 (mk___split_fields__ref1 p_elem__split_fields4)))
(assert (= p_elem__split_fields5 (mk___split_fields1 (rec__partition_refinement__interval__first p_elem__split_fields4) (rec__partition_refinement__interval__last p_elem__split_fields4) rliteral)))
(assert (and (and (= (length (mk___rep p__split_discrs partition_refinement__partitions__replace_element__container__fields)) (length (mk___rep p__split_discrs p__split_fields3))) (= (bool_eq (get (model__ (mk___rep p__split_discrs partition_refinement__partitions__replace_element__container__fields)) j2) (mk___rep1 p_elem__split_fields5)) true)) (= (equal_except (model__ (mk___rep p__split_discrs p__split_fields3)) (model__ (mk___rep p__split_discrs partition_refinement__partitions__replace_element__container__fields)) j2) true)))
(assert (= result5 (mk___split_fields__ref p__split_fields3)))
(assert (= p__split_fields2 partition_refinement__partitions__replace_element__container__fields))
(assert (and (= o11 (length (mk___rep p__split_discrs p__split_fields2))) (and (in_range1 o11) (<= o11 (capacity (mk___rep p__split_discrs p__split_fields2))))))
(assert (and (= o12 o11) (in_range6 o11)))
(assert (= result6 (mk_int__ref p_prime_index1)))
(assert (= p_prime_index2 o12))
(assert (not (< (length (mk___rep p__split_discrs p__split_fields2)) (capacity (mk___rep p__split_discrs p__split_fields2)))))
(check-sat)
(exit)
