...
(assert (forall ((x issueridt)) (! (in_range6 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun bool_eq5 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields3 a)) (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields3 b))) (= (bool_eq4 (rec__keystore__optionalprivatekeyt__owner (us_split_fields3 a)) (rec__keystore__optionalprivatekeyt__owner (us_split_fields3 b))) true)) true false))
...
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq11 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq3 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true))))))))
...
(declare-fun user_eq21 (algorithmt algorithmt) Bool)
(declare-const dummy21 algorithmt)
...
(assert (forall ((x algorithmt)) (! (in_range12 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(assert (forall ((x keyidt)) (! (in_range13 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(assert (forall ((x keylengtht)) (! (in_range14 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(define-fun bool_eq12 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (= (to_rep9 (rec__cryptotypes__keypartt__algorithmid (us_split_fields9 a))) (to_rep9 (rec__cryptotypes__keypartt__algorithmid (us_split_fields9 b)))) (= (to_rep10 (rec__cryptotypes__keypartt__keyid (us_split_fields9 a))) (to_rep10 (rec__cryptotypes__keypartt__keyid (us_split_fields9 b))))) (= (to_rep11 (rec__cryptotypes__keypartt__keylength (us_split_fields9 a))) (to_rep11 (rec__cryptotypes__keypartt__keylength (us_split_fields9 b))))) true false))
...
(declare-fun user_eq25 (statust statust) Bool)
(declare-const dummy25 statust)
...
(define-fun dynamic_invariant2 ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= 0 1)) (in_range15 temp___expr_200)))
...
(declare-fun user_eq26 (yearst yearst) Bool)
(declare-const dummy26 yearst)
...
(define-fun to_rep12 ((x yearst)) Int (yearstqtint x))
(declare-fun of_rep12 (Int) yearst)
(assert (forall ((x yearst)) (! (= (of_rep12 (to_rep12 x)) x) :pattern ((to_rep12 x)))))
(assert (forall ((x yearst)) (! (in_range16 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(declare-fun user_eq27 (monthst monthst) Bool)
(declare-const dummy27 monthst)
...
(define-fun to_rep13 ((x monthst)) Int (monthstqtint x))
(declare-fun of_rep13 (Int) monthst)
(assert (forall ((x monthst)) (! (= (of_rep13 (to_rep13 x)) x) :pattern ((to_rep13 x)))))
(assert (forall ((x monthst)) (! (in_range17 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(declare-fun user_eq28 (dayst dayst) Bool)
(declare-const dummy28 dayst)
...
(define-fun to_rep14 ((x dayst)) Int (daystqtint x))
(declare-fun of_rep14 (Int) dayst)
(assert (forall ((x dayst)) (! (= (of_rep14 (to_rep14 x)) x) :pattern ((to_rep14 x)))))
(assert (forall ((x dayst)) (! (in_range18 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(declare-fun user_eq29 (millisecst millisecst) Bool)
(declare-const dummy29 millisecst)
...
(define-fun to_rep15 ((x millisecst)) Int (millisecstqtint x))
(declare-fun of_rep15 (Int) millisecst)
(assert (forall ((x millisecst)) (! (= (of_rep15 (to_rep15 x)) x) :pattern ((to_rep15 x)))))
(assert (forall ((x millisecst)) (! (in_range19 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(declare-fun user_eq31 (serialnumbert serialnumbert) Bool)
(declare-const dummy31 serialnumbert)
...
(assert (forall ((x serialnumbert)) (! (in_range20 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(define-fun bool_eq14 ((a us_rep7) (b us_rep7)) Bool (ite (and (= (bool_eq4 (rec__certtypes__idt__issuer (us_split_fields13 a)) (rec__certtypes__idt__issuer (us_split_fields13 b))) true) (= (to_rep16 (rec__certtypes__idt__serialnumber (us_split_fields13 a))) (to_rep16 (rec__certtypes__idt__serialnumber (us_split_fields13 b))))) true false))
...
(declare-fun user_eq32 (us_rep7 us_rep7) Bool)
(declare-const dummy32 us_rep7)
...
(define-fun bool_eq15 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (= (bool_eq14 (rec__cert__contentst__id (us_split_fields15 a)) (rec__cert__contentst__id (us_split_fields15 b))) true) (= (bool_eq13 (rec__cert__contentst__notbefore (us_split_fields15 a)) (rec__cert__contentst__notbefore (us_split_fields15 b))) true)) (= (bool_eq13 (rec__cert__contentst__notafter (us_split_fields15 a)) (rec__cert__contentst__notafter (us_split_fields15 b))) true)) (= (to_rep9 (rec__cert__contentst__mechanism (us_split_fields15 a))) (to_rep9 (rec__cert__contentst__mechanism (us_split_fields15 b))))) true false))
...
(assert true)
(declare-datatypes () ((us_split_fields16 (mk___split_fields8 (rec__cert__id__contentst__id us_rep7) (rec__cert__id__contentst__notbefore us_rep6) (rec__cert__id__contentst__notafter us_rep6) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep1) (rec__cert__id__contentst__subjectpublickey us_rep5)))))
...
(define-fun us_split_fields_SubjectPublicKey__projection ((a us_split_fields16)) us_rep5 (rec__cert__id__contentst__subjectpublickey a))
...
(define-fun bool_eq16 ((a us_rep9) (b us_rep9)) Bool (ite (and (and (and (and (and (= (bool_eq14 (rec__cert__id__contentst__id (us_split_fields17 a)) (rec__cert__id__contentst__id (us_split_fields17 b))) true) (= (bool_eq13 (rec__cert__id__contentst__notbefore (us_split_fields17 a)) (rec__cert__id__contentst__notbefore (us_split_fields17 b))) true)) (= (bool_eq13 (rec__cert__id__contentst__notafter (us_split_fields17 a)) (rec__cert__id__contentst__notafter (us_split_fields17 b))) true)) (= (to_rep9 (rec__cert__id__contentst__mechanism (us_split_fields17 a))) (to_rep9 (rec__cert__id__contentst__mechanism (us_split_fields17 b))))) (= (bool_eq4 (rec__cert__id__contentst__subject (us_split_fields17 a)) (rec__cert__id__contentst__subject (us_split_fields17 b))) true)) (= (bool_eq12 (rec__cert__id__contentst__subjectpublickey (us_split_fields17 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields17 b))) true)) true false))
...
(assert true)
(declare-fun thepublickey (us_rep9) us_rep5)
(declare-fun thepublickey__function_guard (us_rep5 us_rep9) Bool)
(assert true)
...
(define-fun bool_eq17 ((x us_t2) (y us_t2)) Bool (bool_eq (elts2 x) (to_rep1 (first4 (rt2 x))) (to_rep1 (last4 (rt2 x))) (elts2 y) (to_rep1 (first4 (rt2 y))) (to_rep1 (last4 (rt2 y)))))
(declare-fun user_eq35 (us_t2 us_t2) Bool)
(declare-const dummy35 us_t2)
...
(define-fun dynamic_invariant4 ((temp___expr_350 us_t1) (temp___is_init_346 Bool) (temp___skip_constant_347 Bool) (temp___do_toplevel_348 Bool) (temp___do_typ_inv_349 Bool)) Bool (and (=> (not (= temp___skip_constant_347 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_350) (last3 temp___expr_350))) (=> (= temp___do_toplevel_348 true) (=> (= temp___is_init_346 true) (and (let ((temp___352 (of_array2 (to_array1 temp___expr_350) (first3 temp___expr_350) (last3 temp___expr_350)))) (and (= (first5 temp___352) 1) (<= 0 (last5 temp___352)))) (<= (last3 temp___expr_350) 1000))))))
...
(define-fun in_range21 ((x Int)) Bool (and (<= 1 x) (<= x 4096)))
...
(declare-fun user_eq36 (rawcertificatei rawcertificatei) Bool)
(declare-const dummy36 rawcertificatei)
...
(declare-fun temp___String_Literal_1790 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1790 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 13)) 99)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 14)) 111)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 15)) 117)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 16)) 108)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 17)) 100)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 19)) 110)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 20)) 111)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 21)) 116)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 23)) 98)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 24)) 101)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 26)) 118)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 27)) 101)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 28)) 114)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 29)) 105)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 30)) 102)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 31)) 105)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 32)) 101)) (= (to_rep (select (temp___String_Literal_1790 us_void_param) 33)) 100)) :pattern ((temp___String_Literal_1790 us_void_param)))))
(declare-fun temp___String_Literal_1792 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1792 us_void_param) 1)) 75) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 5)) 99)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 7)) 117)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 8)) 108)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 9)) 100)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 11)) 110)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 15)) 98)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 18)) 97)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 19)) 100)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 20)) 100)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 22)) 100)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 25)) 111)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 27)) 116)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 28)) 104)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 29)) 101)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 31)) 75)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 32)) 101)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 33)) 121)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 35)) 83)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 36)) 116)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 37)) 111)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 38)) 114)) (= (to_rep (select (temp___String_Literal_1792 us_void_param) 39)) 101)) :pattern ((temp___String_Literal_1792 us_void_param)))))
(declare-fun temp___String_Literal_1794 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1794 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 13)) 99)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 14)) 111)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 15)) 110)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 16)) 116)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 17)) 101)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 18)) 110)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 20)) 115)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 23)) 111)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 24)) 117)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 25)) 108)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 26)) 100)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 28)) 110)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 29)) 111)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 30)) 116)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 32)) 98)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 33)) 101)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 35)) 101)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 36)) 120)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 37)) 116)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 38)) 114)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 39)) 97)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 40)) 99)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 41)) 116)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 42)) 101)) (= (to_rep (select (temp___String_Literal_1794 us_void_param) 43)) 100)) :pattern ((temp___String_Literal_1794 us_void_param)))))
...
(define-fun dynamic_invariant9 ((temp___expr_1170 Int) (temp___is_init_1166 Bool) (temp___skip_constant_1167 Bool) (temp___do_toplevel_1168 Bool) (temp___do_typ_inv_1169 Bool)) Bool (=> (or (= temp___is_init_1166 true) (<= 0 17)) (in_range10 temp___expr_1170)))
(define-fun dynamic_invariant10 ((temp___expr_1177 Int) (temp___is_init_1173 Bool) (temp___skip_constant_1174 Bool) (temp___do_toplevel_1175 Bool) (temp___do_typ_inv_1176 Bool)) Bool (=> (or (= temp___is_init_1173 true) (<= 1 17)) (in_range8 temp___expr_1177)))
(define-fun dynamic_invariant11 ((temp___expr_1303 Int) (temp___is_init_1299 Bool) (temp___skip_constant_1300 Bool) (temp___do_toplevel_1301 Bool) (temp___do_typ_inv_1302 Bool)) Bool (=> (or (= temp___is_init_1299 true) (<= 0 2)) (in_range7 temp___expr_1303)))
(define-fun dynamic_invariant12 ((temp___expr_1184 Int) (temp___is_init_1180 Bool) (temp___skip_constant_1181 Bool) (temp___do_toplevel_1182 Bool) (temp___do_typ_inv_1183 Bool)) Bool (=> (or (= temp___is_init_1180 true) (<= 0 17408)) (in_range9 temp___expr_1184)))
(define-fun dynamic_invariant13 ((temp___expr_1215 Int) (temp___is_init_1211 Bool) (temp___skip_constant_1212 Bool) (temp___do_toplevel_1213 Bool) (temp___do_typ_inv_1214 Bool)) Bool (=> (or (= temp___is_init_1211 true) (<= 0 1024)) (in_range11 temp___expr_1215)))
(assert true)
...
(assert (forall ((temp___1244 Int)) (=> (dynamic_invariant13 temp___1244 true true true true) (forall ((temp___1245 Int)) (= (select (temp_____aggregate_def_1242 temp___1244) temp___1245) rliteral2)))))
...
(define-fun dynamic_invariant14 ((temp___expr_486 Int) (temp___is_init_482 Bool) (temp___skip_constant_483 Bool) (temp___do_toplevel_484 Bool) (temp___do_typ_inv_485 Bool)) Bool (=> (or (= temp___is_init_482 true) (<= 1901 2099)) (in_range16 temp___expr_486)))
(define-fun dynamic_invariant15 ((temp___expr_493 Int) (temp___is_init_489 Bool) (temp___skip_constant_490 Bool) (temp___do_toplevel_491 Bool) (temp___do_typ_inv_492 Bool)) Bool (=> (or (= temp___is_init_489 true) (<= 1 12)) (in_range17 temp___expr_493)))
(define-fun dynamic_invariant16 ((temp___expr_500 Int) (temp___is_init_496 Bool) (temp___skip_constant_497 Bool) (temp___do_toplevel_498 Bool) (temp___do_typ_inv_499 Bool)) Bool (=> (or (= temp___is_init_496 true) (<= 1 31)) (in_range18 temp___expr_500)))
(define-fun dynamic_invariant17 ((temp___expr_532 Int) (temp___is_init_528 Bool) (temp___skip_constant_529 Bool) (temp___do_toplevel_530 Bool) (temp___do_typ_inv_531 Bool)) Bool (=> (or (= temp___is_init_528 true) (<= 0 86399999)) (in_range19 temp___expr_532)))
(define-fun dynamic_invariant18 ((temp___expr_953 Int) (temp___is_init_949 Bool) (temp___skip_constant_950 Bool) (temp___do_toplevel_951 Bool) (temp___do_typ_inv_952 Bool)) Bool (=> (or (= temp___is_init_949 true) (<= 0 40)) (in_range5 temp___expr_953)))
(define-fun dynamic_invariant19 ((temp___expr_977 Int) (temp___is_init_973 Bool) (temp___skip_constant_974 Bool) (temp___do_toplevel_975 Bool) (temp___do_typ_inv_976 Bool)) Bool (=> (or (= temp___is_init_973 true) (<= 0 4294967295)) (in_range6 temp___expr_977)))
(define-fun dynamic_invariant20 ((temp___expr_1001 Int) (temp___is_init_997 Bool) (temp___skip_constant_998 Bool) (temp___do_toplevel_999 Bool) (temp___do_typ_inv_1000 Bool)) Bool (=> (or (= temp___is_init_997 true) (<= 0 10)) (in_range12 temp___expr_1001)))
(define-fun dynamic_invariant21 ((temp___expr_1015 Int) (temp___is_init_1011 Bool) (temp___skip_constant_1012 Bool) (temp___do_toplevel_1013 Bool) (temp___do_typ_inv_1014 Bool)) Bool (=> (or (= temp___is_init_1011 true) (<= 0 4294967295)) (in_range13 temp___expr_1015)))
(define-fun dynamic_invariant22 ((temp___expr_1022 Int) (temp___is_init_1018 Bool) (temp___skip_constant_1019 Bool) (temp___do_toplevel_1020 Bool) (temp___do_typ_inv_1021 Bool)) Bool (=> (or (= temp___is_init_1018 true) (<= 0 128)) (in_range14 temp___expr_1022)))
(define-fun dynamic_invariant23 ((temp___expr_1411 Int) (temp___is_init_1407 Bool) (temp___skip_constant_1408 Bool) (temp___do_toplevel_1409 Bool) (temp___do_typ_inv_1410 Bool)) Bool (=> (or (= temp___is_init_1407 true) (<= 1 4096)) (in_range21 temp___expr_1411)))
...
(define-fun dynamic_invariant24 ((temp___expr_1476 Int) (temp___is_init_1472 Bool) (temp___skip_constant_1473 Bool) (temp___do_toplevel_1474 Bool) (temp___do_typ_inv_1475 Bool)) Bool (=> (or (= temp___is_init_1472 true) (<= 0 4294967295)) (in_range20 temp___expr_1476)))
(assert (forall ((temp___1240 Int)) (=> (dynamic_invariant10 temp___1240 true true true true) (forall ((temp___1241 Int)) (= (select (temp_____aggregate_def_1238 temp___1240) temp___1241) rliteral)))))
...
(declare-const thepublickey__split_fields us_split_fields__ref4)
...
(declare-const temp___1785 (Array Int character))
(declare-const temp___1784 us_rep)
(declare-const o2 integer)
(declare-const o3 integer)
(declare-const o4 Bool)
(declare-const o5 Bool)
(declare-const o6 Bool)
(declare-const temp___1787 us_rep1)
(declare-const o7 us_rep8)
(declare-const temp___1788 us_rep1)
(declare-const temp___1789 us_rep5)
(declare-const o8 us_rep8)
(declare-const temp___1795 us_t1)
(declare-const o9 us_t1)
(declare-const o10 (Array Int character))
(declare-const temp___1793 us_t1)
(declare-const o11 us_t1)
(declare-const o12 (Array Int character))
(declare-const temp___1791 us_t1)
...
(declare-const thepublickey__split_fields1 us_split_fields8)
...
(declare-const thistisinfo__split_fields8 us_split_fields__ref1)
...
(declare-const thistisinfo__split_fields9 us_split_fields2)
...
(declare-const logfiles11 map__ref4)
(declare-const logfilesstatus11 map__ref1)
...
(declare-const logfiles14 map__ref4)
(declare-const logfilesstatus14 map__ref1)
...
(declare-const logfiles16 map__ref4)
(declare-const logfilesstatus16 map__ref1)
...
(declare-const thepublickey__split_fields2 us_split_fields__ref4)
...
(declare-const thepublickey__split_fields3 us_split_fields8)
...
(define-fun thistisinfo__split_fields18 () us_split_fields__ref1 (mk___split_fields__ref1 (mk___split_fields1 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3)))))
...
(define-fun logfilesstatus18 () map__ref1 (mk_map__ref1 logfilesstatus))
(define-fun logfiles18 () map__ref4 (mk_map__ref4 logfiles))
...
(assert (=> (= result5 true) (= temp___1786 (let ((subject stop)) stop1))))
(assert (=> (= result5 true) (= temp___1785 thecert1)))
(assert (=> (= result5 true) (= temp___1784 thefile)))
...
(assert (= temp___1787 (thesubject (mk___rep8 (let ((subject thecontents__split_fields)) thecontents__split_fields1)))))
...
(assert (= theissuer__split_fields3 (us_split_fields1 temp___1788)))
(assert (= temp___1789 (thepublickey (mk___rep8 (let ((subject thecontents__split_fields)) thecontents__split_fields1)))))
(assert (= result10 thepublickey__split_fields))
(assert (= (let ((subject thepublickey__split_fields)) thepublickey__split_fields1) (us_split_fields9 temp___1789)))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (and (ite (= (ite (= (ite (= (let ((subject addedok)) addedok2) true) (ite (= (distinct 1 0) false) (privatekeypresent thistisinfo__split_fields5 (let ((subject state1)) state5)) false) false) false) (ite (= (let ((subject addedok)) addedok2) true) (ite (= (distinct 1 0) false) false (= (ite (privatekeypresent thistisinfo__split_fields5 (let ((subject state1)) state5)) 1 0) (ite (privatekeypresent (mk___split_fields1 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) (us_private__content state1)) 1 0))) (= (ite (privatekeypresent thistisinfo__split_fields5 (let ((subject state1)) state5)) 1 0) (ite (privatekeypresent (mk___split_fields1 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) (us_private__content state1)) 1 0))) true) true) (ite (= (ite (= (ite (= (let ((subject addedok)) addedok2) true) (ite (= (distinct 1 0) false) (privatekeypresent thistisinfo__split_fields5 (let ((subject state1)) state5)) false) false) true) (ite (= (let ((subject addedok)) addedok2) true) (ite (= (distinct 1 0) false) false (= (ite (privatekeypresent thistisinfo__split_fields5 (let ((subject state1)) state5)) 1 0) (ite (privatekeypresent (mk___split_fields1 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) (us_private__content state1)) 1 0))) (= (ite (privatekeypresent thistisinfo__split_fields5 (let ((subject state1)) state5)) 1 0) (ite (privatekeypresent (mk___split_fields1 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) (us_private__content state1)) 1 0))) false) false) true false) false) (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range15 auditalarm2))))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= store4 (let ((subject store1)) (mk___private__ref store3))))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= state7 (let ((subject state1)) (mk___private__ref state5))))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= state6 (let ((subject state)) (mk___private__ref state4))))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= filestate3 (let ((subject filestate)) (mk___private__ref filestate2))))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= addedok3 (let ((subject addedok)) (mk_bool__ref addedok2))))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= thistisinfo__split_fields6 (mk___split_fields__ref1 thistisinfo__split_fields5)))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= auditsystemfault3 (mk_bool__ref auditsystemfault2)))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= auditalarm3 (mk_int__ref auditalarm2)))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= logfilestate__split_fields9 (mk___split_fields__ref3 logfilestate__split_fields8)))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= logfilesstatus3 (mk_map__ref1 logfilesstatus2)))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= logfiles3 (mk_map__ref4 logfiles2)))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= store5 store3))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= state9 state5))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= state8 state4))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= filestate4 filestate2))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= addedok4 addedok2))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= thistisinfo__split_fields7 thistisinfo__split_fields5))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= auditsystemfault4 auditsystemfault2))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= auditalarm4 auditalarm2))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= logfilestate__split_fields10 logfilestate__split_fields8))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= logfilesstatus4 logfilesstatus2))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (= logfiles4 logfiles2))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= store4 store1))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= state7 state1))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= state6 state))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= filestate3 filestate))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= addedok3 (let ((subject addedok)) (mk_bool__ref addedok1))))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= thistisinfo__split_fields6 thistisinfo__split_fields18))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= auditsystemfault3 auditsystemfault18))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= auditalarm3 auditalarm18))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= logfilestate__split_fields9 logfilestate__split_fields24))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= logfilesstatus3 logfilesstatus18))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= logfiles3 logfiles18))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= store5 store2))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= state9 state3))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= state8 state2))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= filestate4 filestate1))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= addedok4 addedok1))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= thistisinfo__split_fields7 thistisinfo__split_fields4))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= auditsystemfault4 auditsystemfault1))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= auditalarm4 auditalarm1))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= logfilestate__split_fields10 logfilestate__split_fields7))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= logfilesstatus4 logfilesstatus1))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= logfiles4 logfiles1))))
...
(assert (=> (= (ite (= (let ((subject extracted)) extracted1) true) (bool__content addedok5) false) true) (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields13)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields13)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields13)) true) (in_range15 auditalarm7))))
...
(assert (=> (= (ite (= (let ((subject extracted)) extracted1) true) (bool__content addedok5) false) true) (= logfilesstatus8 (mk_map__ref1 logfilesstatus7))))
(assert (=> (= (ite (= (let ((subject extracted)) extracted1) true) (bool__content addedok5) false) true) (= logfiles8 (mk_map__ref4 logfiles7))))
...
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (and (ite (= (ite (= (ite (= (let ((subject addedok)) addedok7) true) (ite (= (distinct 1 0) false) (privatekeypresent thistisinfo__split_fields10 (let ((subject state1)) state18)) false) false) false) (ite (= (let ((subject addedok)) addedok7) true) (ite (= (distinct 1 0) false) false (= (ite (privatekeypresent thistisinfo__split_fields10 (let ((subject state1)) state18)) 1 0) (ite (privatekeypresent (us_split_fields__content1 thistisinfo__split_fields8) (us_private__content state11)) 1 0))) (= (ite (privatekeypresent thistisinfo__split_fields10 (let ((subject state1)) state18)) 1 0) (ite (privatekeypresent (us_split_fields__content1 thistisinfo__split_fields8) (us_private__content state11)) 1 0))) true) true) (ite (= (ite (= (ite (= (let ((subject addedok)) addedok7) true) (ite (= (distinct 1 0) false) (privatekeypresent thistisinfo__split_fields10 (let ((subject state1)) state18)) false) false) true) (ite (= (let ((subject addedok)) addedok7) true) (ite (= (distinct 1 0) false) false (= (ite (privatekeypresent thistisinfo__split_fields10 (let ((subject state1)) state18)) 1 0) (ite (privatekeypresent (us_split_fields__content1 thistisinfo__split_fields8) (us_private__content state11)) 1 0))) (= (ite (privatekeypresent thistisinfo__split_fields10 (let ((subject state1)) state18)) 1 0) (ite (privatekeypresent (us_split_fields__content1 thistisinfo__split_fields8) (us_private__content state11)) 1 0))) false) false) true false) false) (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields16)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields16)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields16) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields16)) true) (in_range15 auditalarm10)))))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= store9 (let ((subject store1)) (mk___private__ref store8)))))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= state20 (let ((subject state1)) (mk___private__ref state18)))))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= state19 (let ((subject state)) (mk___private__ref state17)))))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= filestate11 (let ((subject filestate)) (mk___private__ref filestate10)))))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= addedok8 (let ((subject addedok)) (mk_bool__ref addedok7)))))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= thistisinfo__split_fields11 (mk___split_fields__ref1 thistisinfo__split_fields10))))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= auditsystemfault11 (mk_bool__ref auditsystemfault10))))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= auditalarm11 (mk_int__ref auditalarm10))))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= logfilestate__split_fields17 (mk___split_fields__ref3 logfilestate__split_fields16))))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= logfilesstatus11 (mk_map__ref1 logfilesstatus10))))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= logfiles11 (mk_map__ref4 logfiles10))))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= store10 store8)))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= state22 state18)))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= state21 state17)))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= filestate12 filestate10)))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= addedok9 addedok7)))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= thistisinfo__split_fields12 thistisinfo__split_fields10)))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= auditsystemfault12 auditsystemfault10)))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= auditalarm12 auditalarm10)))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= logfilestate__split_fields18 logfilestate__split_fields16)))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= logfilesstatus12 logfilesstatus10)))
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (= logfiles12 logfiles10)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= store9 store6)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= state20 state11)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= state19 state15)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= filestate11 filestate8)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= addedok8 addedok5)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= thistisinfo__split_fields11 thistisinfo__split_fields8)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= auditsystemfault11 auditsystemfault8)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= auditalarm11 auditalarm8)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= logfilestate__split_fields17 logfilestate__split_fields14)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= logfilesstatus11 logfilesstatus8)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= logfiles11 logfiles8)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= store10 store7)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= state22 state13)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= state21 state16)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= filestate12 filestate9)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= addedok9 addedok6)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= thistisinfo__split_fields12 thistisinfo__split_fields9)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= auditsystemfault12 auditsystemfault9)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= auditalarm12 auditalarm9)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= logfilestate__split_fields18 logfilestate__split_fields15)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= logfilesstatus12 logfilesstatus9)))
(assert (=> (not (ite (= (bool__content verifiedok3) true) (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false)) (= logfiles12 logfiles9)))
(assert (=> (= (ite (= (ite (= (bool__content verifiedok3) true) (bool__content addedok8) false) true) istis false) true) (and (ite (= (ite (= (ite (= (let ((subject addedok)) addedok10) true) (ite (= (distinct 0 0) false) (privatekeypresent thistisinfo__split_fields13 (let ((subject state1)) state24)) false) false) false) (ite (= (let ((subject addedok)) addedok10) true) (ite (= (distinct 0 0) false) false (= (ite (privatekeypresent thistisinfo__split_fields13 (let ((subject state1)) state24)) 1 0) (ite (privatekeypresent (us_split_fields__content1 thistisinfo__split_fields11) (us_private__content state20)) 1 0))) (= (ite (privatekeypresent thistisinfo__split_fields13 (let ((subject state1)) state24)) 1 0) (ite (privatekeypresent (us_split_fields__content1 thistisinfo__split_fields11) (us_private__content state20)) 1 0))) true) true) (ite (= (ite (= (ite (= (let ((subject addedok)) addedok10) true) (ite (= (distinct 0 0) false) (privatekeypresent thistisinfo__split_fields13 (let ((subject state1)) state24)) false) false) true) (ite (= (let ((subject addedok)) addedok10) true) (ite (= (distinct 0 0) false) false (= (ite (privatekeypresent thistisinfo__split_fields13 (let ((subject state1)) state24)) 1 0) (ite (privatekeypresent (us_split_fields__content1 thistisinfo__split_fields11) (us_private__content state20)) 1 0))) (= (ite (privatekeypresent thistisinfo__split_fields13 (let ((subject state1)) state24)) 1 0) (ite (privatekeypresent (us_split_fields__content1 thistisinfo__split_fields11) (us_private__content state20)) 1 0))) false) false) true false) false) (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields19)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields19)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields19) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields19)) true) (in_range15 auditalarm13)))))
...
(assert (=> (= (ite (= (ite (= (bool__content verifiedok3) true) (bool__content addedok8) false) true) istis false) true) (= thistisinfo__split_fields14 (mk___split_fields__ref1 thistisinfo__split_fields13))))
...
(assert (=> (= (ite (= (ite (= (bool__content verifiedok3) true) (bool__content addedok8) false) true) istis false) true) (= logfilesstatus14 (mk_map__ref1 logfilesstatus13))))
(assert (=> (= (ite (= (ite (= (bool__content verifiedok3) true) (bool__content addedok8) false) true) istis false) true) (= logfiles14 (mk_map__ref4 logfiles13))))
...
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= temp___1795 (mk___t1 (temp___String_Literal_1794 Tuple0) (mk1 1 43)))))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (dynamic_predicate temp___1795)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= o9 temp___1795)))
...
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (= (bool__content addedok11) true)) (= temp___1793 (mk___t1 (temp___String_Literal_1792 Tuple0) (mk1 1 39))))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (= (bool__content addedok11) true)) (dynamic_predicate temp___1793))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (= (bool__content addedok11) true)) (= o11 temp___1793))))
...
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (= temp___1791 (mk___t1 (temp___String_Literal_1790 Tuple0) (mk1 1 33)))))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (dynamic_predicate temp___1791)))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (= o13 temp___1791)))))
...
(assert (= thepublickey__split_fields2 (let ((subject thepublickey__split_fields)) (mk___split_fields__ref4 thepublickey__split_fields1))))
...
(assert (not (and (= istis true) (= (bool__content keyadded2) true))))
(assert (= (privatekeypresent (us_split_fields__content1 thistisinfo__split_fields16) (us_private__content state30)) true))
(assert (not (= (privatekeypresent (mk___split_fields1 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) (us_private__content state1)) true)))
(check-sat)
(exit)
