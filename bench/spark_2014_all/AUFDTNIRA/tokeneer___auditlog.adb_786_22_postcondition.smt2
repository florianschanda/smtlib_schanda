...
(declare-const temp___1866 us_rep2)
...
(assert (and (= o22 (- (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) 1024)) (in_range8 (- (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) 1024))))
(assert (= (to_rep5 o23) o22))
...
(assert (= temp___1866 (mk___rep1 o24)))
(assert (= result6 (mk___split_fields__ref1 logfilestate__split_fields9)))
(assert (= logfilestate__split_fields10 (us_split_fields3 temp___1866)))
...
(assert (not (= (to_rep2 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields11)) (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields11))))) (to_rep2 (select logfilestate__split_fields6 (to_rep4 logfilestate__split_fields))))))
(check-sat)
(exit)
