...
(assert (in_range1 x))
(assert (and (bvult x #x000F4240) (fp.leq state (fp.mul RNE ((_ to_fp_unsigned 11 53) RNE x) (fp #b0 #b10000000010 #b0110000000000000000000000000000000000000000000000000)))))
(assert (not (fp.isFinite64 (fp.add RNE state (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000)))))
(check-sat)
(exit)
