...
(assert (fp.leq (fp.sub RNE (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) bound) new_speed1))
...
(assert (fp.leq new_speed1 (fp.add RNE (fp.mul RNE (of_int RNE n) bound) bound)))
(assert (fp.leq new_speed1 (fp.mul RNE (of_int RNE (+ n 1)) bound)))
