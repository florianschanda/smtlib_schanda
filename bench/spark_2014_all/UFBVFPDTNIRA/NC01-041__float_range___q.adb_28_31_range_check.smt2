...
(declare-datatypes () ((input_t__ref (mk_input_t__ref (input_t__content input_t)))))
(define-fun input_t__ref___projection ((a input_t__ref)) input_t (input_t__content a))
(define-fun dynamic_invariant1 ((temp___expr_158 (_ BitVec 16)) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool true)
(declare-sort scale_t 0)
(define-fun in_range1 ((x Float32)) Bool (and (fp.isFinite32 x) (and (fp.leq (fp #b0 #b01111101 #b00000000000000000000000) x) (fp.leq x (fp #b0 #b01111111 #b00000000000000000000000)))))
(declare-fun user_eq2 (scale_t scale_t) Bool)
(declare-fun attr__ATTRIBUTE_IMAGE3 (Float32) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Float32)
(declare-const dummy2 scale_t)
(declare-datatypes () ((scale_t__ref (mk_scale_t__ref (scale_t__content scale_t)))))
(define-fun scale_t__ref___projection ((a scale_t__ref)) scale_t (scale_t__content a))
(define-fun dynamic_invariant2 ((temp___expr_165 Float32) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (fp.leq (fp #b0 #b01111101 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (in_range1 temp___expr_165)))
(declare-sort output_t 0)
(define-fun in_range2 ((x Float32)) Bool (and (fp.isFinite32 x) (and (fp.leq (fp.neg (fp #b0 #b10000100 #b00000000000000000000000)) x) (fp.leq x (fp #b0 #b10000100 #b00000000000000000000000)))))
(declare-fun user_eq3 (output_t output_t) Bool)
(declare-fun attr__ATTRIBUTE_IMAGE4 (Float32) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Float32)
(declare-const dummy3 output_t)
(declare-datatypes () ((output_t__ref (mk_output_t__ref (output_t__content output_t)))))
(define-fun output_t__ref___projection ((a output_t__ref)) output_t (output_t__content a))
(define-fun dynamic_invariant3 ((temp___expr_172 Float32) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (fp.leq (fp.neg (fp #b0 #b10000100 #b00000000000000000000000)) (fp #b0 #b10000100 #b00000000000000000000000))) (in_range2 temp___expr_172)))
...
(assert (=> (fp.leq (fp.neg (fp #b0 #b10000100 #b00000000000000000000000)) (fp #b0 #b10000100 #b00000000000000000000000)) (in_range2 value)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 x)))
(assert (= result x))
(assert (= x1 (fp.div RNE ((_ to_fp_unsigned 8 24) RNE raw_in) (fp #b0 #b10001010 #b10011001100110011001101))))
(assert (=> (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) x1) (and (= o (fp.sub RNE x1 (fp #b0 #b10000011 #b01000000000000000000000))) (fp.isFinite32 (fp.sub RNE x1 (fp #b0 #b10000011 #b01000000000000000000000))))))
(assert (=> (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) x1) (= result1 x1)))
(assert (=> (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) x1) (= x2 o)))
(assert (=> (not (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) x1)) (= x2 x1)))
(assert (and (fp.leq (fp.neg (fp #b0 #b10000011 #b01000000000000000000000)) x2) (fp.leq x2 (fp #b0 #b10000011 #b01000000000000000000000))))
(assert (and (= o1 (fp.div RNE x2 scale)) (fp.isFinite32 (fp.div RNE x2 scale))))
(assert (= result2 x2))
(assert (= x3 o1))
(assert (not (fp.leq (fp #b0 #b10000100 #b00000000000000000000000) x3)))
(assert (not (fp.leq x3 (fp.neg (fp #b0 #b10000100 #b00000000000000000000000)))))
(assert (not (in_range2 x3)))
(check-sat)
(exit)
