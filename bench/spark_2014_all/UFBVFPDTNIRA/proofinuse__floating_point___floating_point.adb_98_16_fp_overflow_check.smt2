...
(define-fun dynamic_invariant ((temp___expr_180 (_ BitVec 16)) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool true)
...
(assert (not (= x #x0000)))
(assert (fp.leq (fp #b0 #b01111110 #b11001100110011001100110) ((_ to_fp_unsigned 8 24) RNE x)))
(assert (not (fp.isFinite32 (fp.div RNE (fp #b0 #b10010101 #b11000000110001000110000) ((_ to_fp_unsigned 8 24) RNE x)))))
(check-sat)
(exit)
