...
(assert (= i1 0))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (= temp___306 min1)))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (= temp___305 i1)))
...
(assert (not (exists ((i9 Int)) (and (and (<= 0 i9) (<= i9 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i9)))) x) (fp.eq (t__content step_function__minimum_until_point__result4) (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i9))))))))))
(check-sat)
(exit)
