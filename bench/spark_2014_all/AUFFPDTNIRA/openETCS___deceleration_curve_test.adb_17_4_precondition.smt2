...
(define-fun dynamic_invariant1 ((temp___expr_179 Float32) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool (=> (or (= temp___is_init_175 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_179)))
(assert (forall ((speed Float32)) (! (=> (and (dynamic_invariant1 speed true true true true) (= (is_valid_speed_km_per_h speed) true)) (dynamic_invariant (m_per_s_from_km_per_h speed) true false true true)) :pattern ((m_per_s_from_km_per_h speed)))))
(assert (forall ((speed Float32)) (! (=> (dynamic_invariant1 speed true true true true) (= (m_per_s_from_km_per_h speed) (fp.div RNE (fp.mul RNE speed (fp #b0 #b10001000 #b11110100000000000000000)) (fp #b0 #b10001010 #b11000010000000000000000)))) :pattern ((m_per_s_from_km_per_h speed)))))
(declare-fun distance_to_speed (Float32 Float32 Float32) Int)
(declare-fun distance_to_speed__function_guard (Int Float32 Float32 Float32) Bool)
...
(define-fun dynamic_invariant2 ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= 0 2147483647)) (in_range1 temp___expr_200)))
...
(assert (forall ((x distance_t)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x distance_t)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
(assert (forall ((x Int)) (! (=> (in_range1 x) (= (to_rep (of_rep x)) x)) :pattern ((to_rep (of_rep x))))))
(declare-fun to_rep1 (speed_t) Float32)
(declare-fun of_rep1 (Float32) speed_t)
(assert (forall ((x speed_t)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x speed_t)) (! (fp.isFinite32 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__deceleration_curve__braking_curve_entry__location (us_split_fields1 a))) (to_rep (rec__deceleration_curve__braking_curve_entry__location (us_split_fields1 b)))) (= (to_rep1 (rec__deceleration_curve__braking_curve_entry__speed (us_split_fields1 a))) (to_rep1 (rec__deceleration_curve__braking_curve_entry__speed (us_split_fields1 b))))) true false))
...
(define-fun bool_eq3 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (= (rec__deceleration_curve__target_t__supervise (us_split_fields5 a)) (rec__deceleration_curve__target_t__supervise (us_split_fields5 b))) (= (to_rep (rec__deceleration_curve__target_t__location (us_split_fields5 a))) (to_rep (rec__deceleration_curve__target_t__location (us_split_fields5 b))))) (= (to_rep1 (rec__deceleration_curve__target_t__speed (us_split_fields5 a))) (to_rep1 (rec__deceleration_curve__target_t__speed (us_split_fields5 b))))) true false))
...
(assert (and (= o (m_per_s_from_km_per_h (fp #b0 #b10000110 #b01000000000000000000000))) (and (fp.isFinite32 o) (= o (fp.div RNE (fp.mul RNE (fp #b0 #b10000110 #b01000000000000000000000) (fp #b0 #b10001000 #b11110100000000000000000)) (fp #b0 #b10001010 #b11000010000000000000000))))))
...
(assert (= deceleration_curve_test__target__assume1 o3))
(assert (= deceleration_curve_test__target__assume2 o4))
...
(assert (= (distance_to_speed initial_speed1 (fp #b0 #b00000000 #b00000000000000000000000) (fp.neg (fp #b0 #b01111111 #b00000000000000000000000))) 1000))
(assert (not (<= (to_rep target__split_fields4) 5000)))
(check-sat)
(exit)
