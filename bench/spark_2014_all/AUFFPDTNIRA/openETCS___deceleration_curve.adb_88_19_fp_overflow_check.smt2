...
(assert (= o22 (fp.mul RNE o21 (fp #b0 #b10000001 #b01000000000000000000000))))
(assert (and (= o23 o22) (fp.isFinite32 o22)))
(assert (and (= o24 (fp.mul RNE speed2 speed2)) (fp.isFinite32 (fp.mul RNE speed2 speed2))))
