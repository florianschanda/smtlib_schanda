...
(assert (and (fp.leq (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (to_rep1 (select d4 4))) (fp.leq (to_rep1 (select d4 4)) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i 4))
(assert (not (fp.leq (to_rep1 (select d4 i)) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(check-sat)
(exit)
