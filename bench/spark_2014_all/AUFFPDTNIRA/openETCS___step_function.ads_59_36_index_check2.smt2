...
(define-fun o16 () us_rep (mk___rep (mk___split_fields o1 o2)))
(define-fun i13 () int__ref (mk_int__ref i))
(assert (in_range2 x))
(assert (= (is_valid sfun) true))
(assert (or (and (and (and (= step_function__get_value__result11 (mk_t__ref step_function__get_value__result3)) (= i8 (mk_int__ref i3))) (and (= step_function__get_value__result12 step_function__get_value__result3) (= i9 i3))) (and (= temp___266 0) (and (= temp___267 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)) (and (and (= result4 i13) (= i2 temp___266)) (and (and (<= temp___266 i2) (<= i2 temp___267)) (and (= temp___272 i2) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j i3)) (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j)))) x))) (and (and (=> (<= 0 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)) (dynamic_property 0 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1) i3)) (and (<= 0 i3) (<= i3 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)))) (and (and (and (and (and (and (and (and (and (= temp___270 (+ i3 1)) (in_range3 (+ i3 1))) (and (and (<= 0 temp___270) (<= temp___270 10)) (= o temp___270))) (= o16 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) o))) (and (= o1 o3) (= o2 o4))) (= o5 o3)) (= o6 (to_rep2 o5))) (= o7 (ite (< x o6) true false))) (= result1 (ite (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i3)))) x) o7 false))) (and (= result1 true) (and (= step_function__get_value__result2 result2) (= step_function__get_value__result3 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i3)))))))))))))))) (and (and (and (= result4 i13) (= i2 0)) (ite (and (<= 0 i2) (<= i2 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1))) (and (and (and (= temp___272 i2) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j i3)) (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j)))) x))) (and (and (=> (<= 0 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)) (dynamic_property 0 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1) i3)) (and (<= 0 i3) (<= i3 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)))) (and (and (and (and (and (and (and (and (and (and (= temp___270 (+ i3 1)) (in_range3 (+ i3 1))) (and (and (<= 0 temp___270) (<= temp___270 10)) (= o temp___270))) (= o16 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) o))) (and (= o1 o3) (= o2 o4))) (= o5 o3)) (= o6 (to_rep2 o5))) (= o7 (ite (< x o6) true false))) (= result1 (ite (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i3)))) x) o7 false))) (and (not (= result1 true)) (= step_function__get_value__result3 step_function__get_value__result2))) (= i3 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)))))) (and (and (= step_function__get_value__result3 step_function__get_value__result4) (= i3 i4)) (and (= step_function__get_value__result5 step_function__get_value__result3) (= i5 i3)))) (and (and (= step_function__get_value__result15 (mk_t__ref step_function__get_value__result4)) (= i12 (mk_int__ref i4))) (and (= step_function__get_value__result7 step_function__get_value__result5) (= i7 i5)))) (and (and (= step_function__get_value__result15 (mk_t__ref step_function__get_value__result)) (= i2 i6)) (and (= step_function__get_value__result7 step_function__get_value__result1) (= i7 i2))))) (and (and (and (= step_function__get_value__result11 step_function__get_value__result9) (= i8 i12)) (and (= step_function__get_value__result12 step_function__get_value__result10) (= i9 i7))) (and (and (= step_function__get_value__result9 (mk_t__ref step_function__get_value__result8)) (= step_function__get_value__result10 step_function__get_value__result8)) (and (= (mk_t__ref result3) step_function__get_value__result15) (= step_function__get_value__result8 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))))))))))))
...
(assert (= o8 i1))
(assert (= (mk___rep (mk___split_fields o9 o10)) (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) o8)))
(assert (= o9 o11))
(assert (= o10 o12))
(assert (= o13 o12))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (fp.eq (t__content step_function__get_value__result13) o14) true false)))
(assert (not (<= 0 (+ i1 1))))
(check-sat)
(exit)
