...
(assert (and (= o62 (fp.mul RNE (to_rep (select (map__content lambda12) i2)) (to_rep (select kvp2 i2)))) (fp.isFinite32 (fp.mul RNE (to_rep (select (map__content lambda12) i2)) (to_rep (select kvp2 i2))))))
(assert (= (to_rep o63) o62))
(assert (= o64 (store kvmax1 i2 o63)))
(assert (= result19 (mk_map__ref kvmax1)))
(assert (= kvmax2 o64))
(assert (not (fp.isFinite32 (fp.mul RNE (to_rep (select (map__content upsilon12) i2)) (to_rep (select ka i2))))))
(check-sat)
(exit)
