...
(assert (forall ((d Float32) (kv Float32) (ka Float32)) (! (=> (and (and (and (dynamic_invariant d true true true true) (dynamic_invariant kv true true true true)) (dynamic_invariant ka true true true true)) (and (and (not (fp.eq d (fp #b0 #b00000000 #b00000000000000000000000))) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kv)) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) ka))) (let ((result (adjust2triangle d kv ka))) (and (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) result) (fp.leq result kv)) (dynamic_invariant result true false true true)))) :pattern ((adjust2triangle d kv ka)))))
(declare-sort joint_index 0)
(declare-fun joint_indexqtint (joint_index) Int)
(assert (forall ((i joint_index)) (and (<= 1 (joint_indexqtint i)) (<= (joint_indexqtint i) 2))))
...
(assert (forall ((temp___200 Float32)) (=> (dynamic_invariant temp___200 true true true true) (forall ((temp___201 Int)) (= (to_rep (select (temp_____aggregate_def_198 temp___200) temp___201)) temp___200)))))
(assert (forall ((temp___204 Float32)) (=> (dynamic_invariant temp___204 true true true true) (forall ((temp___205 Int)) (= (to_rep (select (temp_____aggregate_def_202 temp___204) temp___205)) temp___204)))))
...
(assert (= j1 1))
(assert (not (= i1 j1)))
(assert (not (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 i1)) (fp.abs (to_rep (select d j1)))))))
(check-sat)
(exit)
