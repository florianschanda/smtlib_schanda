...
(assert (<= 1 i1))
(assert (<= i1 1000))
(assert (not (fp.eq (to_rep1 (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))) (to_rep1 (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))))))
(check-sat)
(exit)
