...
(assert (= o16 i1))
(assert (= (mk___rep (mk___split_fields o17 o18)) (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) o16)))
(assert (= o17 o19))
(assert (= o18 o20))
(assert (= o21 o20))
(assert (= o22 (to_rep o21)))
(assert (= o23 (ite (fp.eq (t__content step_function__get_value__result13) o22) true false)))
