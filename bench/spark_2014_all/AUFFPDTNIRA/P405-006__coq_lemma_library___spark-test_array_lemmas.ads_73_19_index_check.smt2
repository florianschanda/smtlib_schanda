...
(assert (<= (+ (to_rep1 (first2 (rt1 arr))) 1) i))
(assert (<= i (to_rep1 (last2 (rt1 arr)))))
(assert (and (<= (to_rep1 (first2 (rt1 arr))) i) (<= i (to_rep1 (last2 (rt1 arr))))))
(assert (= o i))
(assert (= o1 (select (elts1 arr) o)))
(assert (= o2 (to_rep o1)))
(assert (not (<= (- i 1) (to_rep1 (last2 (rt1 arr))))))
(check-sat)
(exit)
