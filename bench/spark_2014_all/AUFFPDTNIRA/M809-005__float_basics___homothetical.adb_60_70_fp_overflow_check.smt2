...
(assert (= j2 2))
(assert (not (= i1 j2)))
(assert (and (= o15 (fp.mul RNE (to_rep (select kvp2 i1)) (fp.abs (to_rep (select d j2))))) (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 i1)) (fp.abs (to_rep (select d j2)))))))
(assert (and (= o14 (fp.mul RNE (to_rep (select kvp2 j2)) (fp.abs (to_rep (select d i1))))) (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 j2)) (fp.abs (to_rep (select d i1)))))))
...
(assert (= lambda5 o20))
(assert (and (= o22 (fp.mul RNE (to_rep (select ka i1)) (fp.abs (to_rep (select d j2))))) (fp.isFinite32 (fp.mul RNE (to_rep (select ka i1)) (fp.abs (to_rep (select d j2)))))))
(assert (and (= o21 (fp.mul RNE (to_rep (select ka j2)) (fp.abs (to_rep (select d i1))))) (fp.isFinite32 (fp.mul RNE (to_rep (select ka j2)) (fp.abs (to_rep (select d i1)))))))
(assert (= o23 (fp.div RNE o21 o22)))
(assert (not (fp.isFinite32 o23)))
(check-sat)
(exit)
