...
(assert (not (fp.isFinite32 (fp.sub RNE (to_rep5 (rec__robot_iface__proxy__max_range (us_split_fields9 (rec__algorithm__controller__robot (us_split_fields15 this))))) (fp #b0 #b01111000 #b01000111101011100001010)))))
(check-sat)
(exit)
