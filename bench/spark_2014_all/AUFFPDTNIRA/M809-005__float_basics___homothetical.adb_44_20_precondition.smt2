...
(assert (and (and (=> (<= 1 2) (in_range2 i2)) (forall ((temp___197 Int)) (=> (and (<= 1 temp___197) (<= temp___197 2)) (=> (or (< 2 temp___197) (or (< temp___197 1) (<= i2 temp___197))) (= (select kvp2 temp___197) (select kvp1 temp___197)))))) (and (<= 1 i2) (<= i2 2))))
(assert (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select kv i2)))))
(check-sat)
(exit)
