...
(declare-fun user_eq3 (positive_float positive_float) Bool)
(declare-fun attr__ATTRIBUTE_IMAGE3 (Float32) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Float32)
(declare-const dummy3 positive_float)
...
(declare-fun to_rep1 (positive_float) Float32)
(declare-fun of_rep1 (Float32) positive_float)
(assert (forall ((x positive_float)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x positive_float)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(declare-fun user_eq4 (nonnegative_float nonnegative_float) Bool)
(declare-fun attr__ATTRIBUTE_IMAGE4 (Float32) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Float32)
(declare-const dummy4 nonnegative_float)
...
(assert (forall ((x nonnegative_float)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x nonnegative_float)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq1 ((a (Array Int nonnegative_float)) (a__first Int) (a__last Int) (b (Array Int nonnegative_float)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep2 (select a temp___idx_154)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(define-fun us_split_fields_modulus__projection ((a us_split_fields2)) float (rec__robot_iface__speed_option__modulus a))
(define-fun us_split_fields_angle__projection ((a us_split_fields2)) float (rec__robot_iface__speed_option__angle a))
...
(define-fun us_split_fields_robot_radius__projection ((a us_split_fields4)) positive_float (rec__robot_iface__proxy__robot_radius a))
(define-fun us_split_fields_min_gap_width__projection ((a us_split_fields4)) positive_float (rec__robot_iface__proxy__min_gap_width a))
(define-fun us_split_fields_obstacle_avoid_dist__projection ((a us_split_fields4)) positive_float (rec__robot_iface__proxy__obstacle_avoid_dist a))
(define-fun us_split_fields_max_speed__projection ((a us_split_fields4)) positive_float (rec__robot_iface__proxy__max_speed a))
(define-fun us_split_fields_max_turn_rate__projection ((a us_split_fields4)) positive_float (rec__robot_iface__proxy__max_turn_rate a))
(define-fun us_split_fields_goal_position_tol__projection ((a us_split_fields4)) nonnegative_float (rec__robot_iface__proxy__goal_position_tol a))
(define-fun us_split_fields_goal_angle_tol__projection ((a us_split_fields4)) nonnegative_float (rec__robot_iface__proxy__goal_angle_tol a))
(define-fun us_split_fields_goalX__projection ((a us_split_fields4)) float (rec__robot_iface__proxy__goalx a))
(define-fun us_split_fields_goalY__projection ((a us_split_fields4)) float (rec__robot_iface__proxy__goaly a))
(define-fun us_split_fields_goalA__projection ((a us_split_fields4)) float (rec__robot_iface__proxy__goala a))
(define-fun us_split_fields_scan_Count__projection ((a us_split_fields4)) natural (rec__robot_iface__proxy__scan_count a))
(define-fun us_split_fields_scan_Res__projection ((a us_split_fields4)) positive_float (rec__robot_iface__proxy__scan_res a))
(define-fun us_split_fields_max_Range__projection ((a us_split_fields4)) positive_float (rec__robot_iface__proxy__max_range a))
...
(define-fun us_split_fields_X__projection ((a us_split_fields4)) unbounded_float (rec__robot_iface__proxy__x a))
(define-fun us_split_fields_Y__projection ((a us_split_fields4)) unbounded_float (rec__robot_iface__proxy__y a))
(define-fun us_split_fields_Yaw__projection ((a us_split_fields4)) unbounded_float (rec__robot_iface__proxy__yaw a))
...
(define-fun bool_eq3 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep1 (rec__robot_iface__proxy__robot_radius (us_split_fields5 a))) (to_rep1 (rec__robot_iface__proxy__robot_radius (us_split_fields5 b)))) (= (to_rep1 (rec__robot_iface__proxy__min_gap_width (us_split_fields5 a))) (to_rep1 (rec__robot_iface__proxy__min_gap_width (us_split_fields5 b))))) (= (to_rep1 (rec__robot_iface__proxy__obstacle_avoid_dist (us_split_fields5 a))) (to_rep1 (rec__robot_iface__proxy__obstacle_avoid_dist (us_split_fields5 b))))) (= (to_rep1 (rec__robot_iface__proxy__max_speed (us_split_fields5 a))) (to_rep1 (rec__robot_iface__proxy__max_speed (us_split_fields5 b))))) (= (to_rep1 (rec__robot_iface__proxy__max_turn_rate (us_split_fields5 a))) (to_rep1 (rec__robot_iface__proxy__max_turn_rate (us_split_fields5 b))))) (= (to_rep2 (rec__robot_iface__proxy__goal_position_tol (us_split_fields5 a))) (to_rep2 (rec__robot_iface__proxy__goal_position_tol (us_split_fields5 b))))) (= (to_rep2 (rec__robot_iface__proxy__goal_angle_tol (us_split_fields5 a))) (to_rep2 (rec__robot_iface__proxy__goal_angle_tol (us_split_fields5 b))))) (= (to_rep4 (rec__robot_iface__proxy__goalx (us_split_fields5 a))) (to_rep4 (rec__robot_iface__proxy__goalx (us_split_fields5 b))))) (= (to_rep4 (rec__robot_iface__proxy__goaly (us_split_fields5 a))) (to_rep4 (rec__robot_iface__proxy__goaly (us_split_fields5 b))))) (= (to_rep4 (rec__robot_iface__proxy__goala (us_split_fields5 a))) (to_rep4 (rec__robot_iface__proxy__goala (us_split_fields5 b))))) (= (to_rep3 (rec__robot_iface__proxy__scan_count (us_split_fields5 a))) (to_rep3 (rec__robot_iface__proxy__scan_count (us_split_fields5 b))))) (= (to_rep1 (rec__robot_iface__proxy__scan_res (us_split_fields5 a))) (to_rep1 (rec__robot_iface__proxy__scan_res (us_split_fields5 b))))) (= (to_rep1 (rec__robot_iface__proxy__max_range (us_split_fields5 a))) (to_rep1 (rec__robot_iface__proxy__max_range (us_split_fields5 b))))) (= (bool_eq1 (rec__robot_iface__proxy__scans (us_split_fields5 a)) 1 1000 (rec__robot_iface__proxy__scans (us_split_fields5 b)) 1 1000) true)) (= (to_rep5 (rec__robot_iface__proxy__x (us_split_fields5 a))) (to_rep5 (rec__robot_iface__proxy__x (us_split_fields5 b))))) (= (to_rep5 (rec__robot_iface__proxy__y (us_split_fields5 a))) (to_rep5 (rec__robot_iface__proxy__y (us_split_fields5 b))))) (= (to_rep5 (rec__robot_iface__proxy__yaw (us_split_fields5 a))) (to_rep5 (rec__robot_iface__proxy__yaw (us_split_fields5 b))))) (= (bool_eq2 (rec__robot_iface__proxy__speed (us_split_fields5 a)) (rec__robot_iface__proxy__speed (us_split_fields5 b))) true)) (= (rec__robot_iface__proxy__goal_reached (us_split_fields5 a)) (rec__robot_iface__proxy__goal_reached (us_split_fields5 b)))) true false))
...
(define-fun us_split_fields_first__projection ((a us_split_fields6)) nonnegative_float (rec__algorithm__laser_scan_data__first a))
...
(define-fun us_split_fields_obsAvoidDelta__projection ((a us_split_fields10)) float (rec__algorithm__controller__obsavoiddelta a))
...
(declare-fun temp_____aggregate_def_684 (us_rep3) (Array Int us_rep3))
(define-fun dynamic_invariant2 ((temp___expr_673 us_rep5) (temp___is_init_669 Bool) (temp___skip_constant_670 Bool) (temp___do_toplevel_671 Bool) (temp___do_typ_inv_672 Bool)) Bool (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 temp___expr_673))))) false) (in_range7 1000 (rec__algorithm__controller__gapvec (us_split_fields11 temp___expr_673)))))
(declare-const rliteral natural)
(assert (= (naturalqtint rliteral) 0))
(define-fun default_initial_assumption ((temp___expr_678 us_rep5) (temp___skip_top_level_679 Bool)) Bool (and (and (and (and (= (rec__algorithm__controller__robot (us_split_fields11 temp___expr_678)) (mk___rep2 (mk___split_fields2 (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) rliteral (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000)) (temp_____aggregate_def_680 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep5 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep5 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep5 (fp #b0 #b00000000 #b00000000000000000000000)) (let ((usq_ (mk___rep1 (mk___split_discrs (of_rep6 0)) (mk___split_fields1 dummy dummy) true))) (mk___rep1 (us_split_discrs1 usq_) (us_split_fields3 usq_) false)) (distinct 0 0)))) (= (rec__algorithm__controller__laserscan (us_split_fields11 temp___expr_678)) (temp_____aggregate_def_684 (mk___rep3 (mk___split_fields3 (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) null_angle))))) (and (= (to_rep7 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 (rec__algorithm__controller__gapvec (us_split_fields11 temp___expr_678))))) 1000) (= (is_empty (rec__algorithm__controller__gapvec (us_split_fields11 temp___expr_678))) true))) (= (to_rep4 (rec__algorithm__controller__obsavoiddelta (us_split_fields11 temp___expr_678))) (fp #b0 #b00000000 #b00000000000000000000000))) (= (rec__algorithm__controller__driveangle (us_split_fields11 temp___expr_678)) null_angle)))
...
(define-fun dynamic_invariant3 ((temp___expr_748 Float32) (temp___is_init_744 Bool) (temp___skip_constant_745 Bool) (temp___do_toplevel_746 Bool) (temp___do_typ_inv_747 Bool)) Bool (=> (or (= temp___is_init_744 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (in_range9 temp___expr_748)))
...
(define-fun to_rep8 ((x integer)) Int (integerqtint x))
...
(define-fun dynamic_invariant5 ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range10 temp___expr_18)))
(define-fun dynamic_invariant6 ((temp___expr_640 us_rep4) (temp___is_init_636 Bool) (temp___skip_constant_637 Bool) (temp___do_toplevel_638 Bool) (temp___do_typ_inv_639 Bool)) Bool (=> (not (= temp___skip_constant_637 true)) (in_range7 1000 temp___expr_640)))
(define-fun default_initial_assumption1 ((temp___expr_642 us_rep4) (temp___skip_top_level_643 Bool)) Bool (and (= (to_rep7 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 temp___expr_642))) 1000) (=> (not (= temp___skip_top_level_643 true)) (= (is_empty temp___expr_642) true))))
(assert (forall ((temp___686 us_rep3)) (forall ((temp___687 Int)) (= (select (temp_____aggregate_def_684 temp___686) temp___687) temp___686))))
(define-fun dynamic_invariant7 ((temp___expr_254 Int) (temp___is_init_250 Bool) (temp___skip_constant_251 Bool) (temp___do_toplevel_252 Bool) (temp___do_typ_inv_253 Bool)) Bool (=> (or (= temp___is_init_250 true) (<= 0 1)) (in_range5 temp___expr_254)))
(define-fun default_initial_assumption2 ((temp___expr_263 us_rep1) (temp___skip_top_level_264 Bool)) Bool (and (= (attr__constrained temp___expr_263) false) (= (to_rep6 (rec__robot_iface__speed_option__opt (us_split_discrs1 temp___expr_263))) 0)))
(define-fun dynamic_invariant8 ((temp___expr_272 us_rep2) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool) (temp___do_typ_inv_271 Bool)) Bool (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields5 temp___expr_272))) false))
(define-fun default_initial_assumption3 ((temp___expr_275 us_rep2) (temp___skip_top_level_276 Bool)) Bool (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields5 temp___expr_275))) false) (= (to_rep6 (rec__robot_iface__speed_option__opt (us_split_discrs1 (rec__robot_iface__proxy__speed (us_split_fields5 temp___expr_275))))) 0)))
(define-fun dynamic_invariant9 ((temp___expr_163 Float32) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool) (temp___do_typ_inv_162 Bool)) Bool (=> (or (= temp___is_init_159 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range2 temp___expr_163)))
(define-fun dynamic_invariant10 ((temp___expr_184 Float32) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool) (temp___do_typ_inv_183 Bool)) Bool (=> (or (= temp___is_init_180 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_184)))
(assert (= null_angle (mk___rep (mk___split_fields (of_rep (fp #b0 #b00000000 #b00000000000000000000000))))))
(define-fun dynamic_invariant11 ((temp___expr_198 Float32) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool (=> (or (= temp___is_init_194 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000001 #b10010010000111111011011))) (in_range1 temp___expr_198)))
(define-fun dynamic_invariant12 ((temp___expr_365 Int) (temp___is_init_361 Bool) (temp___skip_constant_362 Bool) (temp___do_toplevel_363 Bool) (temp___do_typ_inv_364 Bool)) Bool (=> (or (= temp___is_init_361 true) (<= 0 2147483647)) (in_range6 temp___expr_365)))
(declare-fun length (us_rep4) Int)
(declare-fun length__function_guard (Int us_rep4) Bool)
(assert (forall ((container us_rep4)) (! (let ((result (length container))) (and (<= result (to_rep7 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 container)))) (dynamic_invariant12 result true false true true))) :pattern ((length container)))))
(assert (forall ((container us_rep4)) (! (= (= (is_empty container) true) (= (length container) 0)) :pattern ((is_empty container)))))
(assert (forall ((temp___682 Float32)) (=> (dynamic_invariant1 temp___682 true true true true) (forall ((temp___683 Int)) (= (to_rep2 (select (temp_____aggregate_def_680 temp___682) temp___683)) temp___682)))))
...
(assert (<= 1 i1))
(assert (<= i1 1000))
(assert (fp.eq (to_rep1 (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))) (to_rep1 (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this)))))))
(assert (and (and (and (and (and (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 obstacleavoiddelta2)) (=> (<= 1 1000) (dynamic_property 1 1000 i2))) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000)) (in_range9 deltamag1))) (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 deltaangle1))) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111)) (in_range3 deltaareasum2))) (and (<= 1 i2) (<= i2 1000))))
(assert (and (= o (fp.add RNE safetydist (to_rep1 (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))))) (fp.isFinite32 (fp.add RNE safetydist (to_rep1 (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this)))))))))
(assert (= result3 (ite (fp.leq (to_rep2 (rec__algorithm__laser_scan_data__first (us_split_fields7 (select (rec__algorithm__controller__laserscan (us_split_fields11 this)) i2)))) o) true false)))
(assert (= result3 true))
(assert (and (= o1 (fp.add RNE safetydist (to_rep1 (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))))) (fp.isFinite32 (fp.add RNE safetydist (to_rep1 (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this)))))))))
(assert (= o2 (fp.sub RNE o1 (to_rep2 (rec__algorithm__laser_scan_data__first (us_split_fields7 (select (rec__algorithm__controller__laserscan (us_split_fields11 this)) i2)))))))
...
(assert (= o12 (oadd (rec__algorithm__laser_scan_data__second (us_split_fields7 (select (rec__algorithm__controller__laserscan (us_split_fields11 this)) i2))) o13)))
(assert (and (= o10 (aldiff (rec__algorithm__controller__driveangle (us_split_fields11 this)) o12)) (and (fp.isFinite32 o10) (and (fp.lt (fp.neg (fp #b0 #b10000000 #b10010010000111111011011)) o10) (fp.leq o10 (fp #b0 #b10000000 #b10010010000111111011011))))))
(assert (= deltaangle1 result5))
(assert (= deltaangle2 o10))
(assert (and (= o11 (fp.add RNE deltaareasum2 (fp.mul RNE deltamag2 deltamag2))) (fp.isFinite32 (fp.add RNE deltaareasum2 (fp.mul RNE deltamag2 deltamag2)))))
(assert (= deltaareasum2 result6))
(assert (= deltaareasum3 o11))
(assert (not (fp.isFinite32 (fp.mul RNE (fp.mul RNE (fp.mul RNE deltamag2 deltamag2) deltamag2) deltaangle2))))
(check-sat)
(exit)
