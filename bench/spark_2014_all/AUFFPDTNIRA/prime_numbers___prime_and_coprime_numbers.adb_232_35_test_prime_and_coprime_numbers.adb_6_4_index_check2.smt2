...
(assert (= is_prime6 o3))
(assert (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 index_22)) (= (= (select is_prime7 v1) true) (= (is_prime v1) true)))))
(assert (forall ((v1 Int)) (=> (and (<= index_22 v1) (<= v1 100000)) (= (= (select is_prime7 v1) true) (and (forall ((div2 Int)) (=> (and (<= 2 div2) (<= div2 (- index_22 1))) (not (= (mod2 v1 div2) 0)))) (=> (and (<= (+ index_22 1) v1) (<= v1 index_33)) (not (= (mod2 v1 index_22) 0))))))))
...
(assert (= result8 (ite (= o5 true) (ite (<= v index_33) true false) false)))
(assert (=> (= result8 true) (= o6 (ite (not (= (mod2 v index_22) 0)) true false))))
(assert (=> (not (= result8 true)) (= o6 (distinct 1 0))))
(assert (= (= o7 true) (forall ((div2 Int)) (=> (and (<= 2 div2) (<= div2 (- index_22 1))) (not (= (mod2 v div2) 0))))))
