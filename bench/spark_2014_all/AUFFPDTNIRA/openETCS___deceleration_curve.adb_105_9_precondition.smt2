...
(define-fun dynamic_invariant1 ((temp___expr_182 Float32) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool) (temp___do_typ_inv_181 Bool)) Bool (=> (or (= temp___is_init_178 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_182)))
(assert (forall ((speed Float32)) (! (=> (and (dynamic_invariant speed true true true true) (= (is_valid_speed speed) true)) (dynamic_invariant1 (km_per_h_from_m_per_s speed) true false true true)) :pattern ((km_per_h_from_m_per_s speed)))))
...
(define-fun dynamic_invariant2 ((temp___expr_203 Int) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool) (temp___do_typ_inv_202 Bool)) Bool (=> (or (= temp___is_init_199 true) (<= 0 2147483647)) (in_range4 temp___expr_203)))
...
(define-fun dynamic_invariant3 ((temp___expr_362 Int) (temp___is_init_358 Bool) (temp___skip_constant_359 Bool) (temp___do_toplevel_360 Bool) (temp___do_typ_inv_361 Bool)) Bool (=> (or (= temp___is_init_358 true) (<= 0 1000)) (in_range5 temp___expr_362)))
...
(define-fun to_rep3 ((x distance_t)) Int (distance_tqtint x))
...
(define-fun bool_eq3 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_170 Int)) (=> (and (<= a__first temp___idx_170) (<= temp___idx_170 a__last)) (= (bool_eq2 (select a temp___idx_170) (select b (+ (- b__first a__first) temp___idx_170))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_170 Int)) (=> (and (<= a__first temp___idx_170) (<= temp___idx_170 a__last)) (= (bool_eq2 (select a temp___idx_170) (select b (+ (- b__first a__first) temp___idx_170))) true))))))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_452 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_452 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_452 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_452 us_void_param) 4)) 32)) :pattern ((temp___String_Literal_452 us_void_param)))))
...
(assert (not (<= (to_rep3 (rec__deceleration_curve__braking_curve_t__end_point (us_split_fields3 braking_curve))) 5000)))
(check-sat)
(exit)
