...
(assert (= o30 (fp.div RNE o29 (fp #b0 #b10000000 #b00000000000000000000000))))
(assert (= result6 (mk_t__ref speed2)))
(assert (= speed3 o30))
(assert (=> (fp.lt maximum_valid_speed speed3) (= result7 (mk_t__ref speed3))))
(assert (=> (fp.lt maximum_valid_speed speed3) (= speed4 maximum_valid_speed)))
(assert (=> (not (fp.lt maximum_valid_speed speed3)) (= speed4 speed3)))
(assert (and (= o31 (* i2 5)) (in_range4 (* i2 5))))
