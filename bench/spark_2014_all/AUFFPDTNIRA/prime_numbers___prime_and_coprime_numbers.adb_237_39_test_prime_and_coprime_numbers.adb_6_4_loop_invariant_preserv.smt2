...
(assert (= is_prime6 o3))
(assert (forall ((v Int)) (=> (and (<= 0 v) (<= v index_22)) (= (= (select is_prime7 v) true) (= (is_prime v) true)))))
(assert (forall ((v Int)) (=> (and (<= index_22 v) (<= v 100000)) (= (= (select is_prime7 v) true) (and (forall ((div2 Int)) (=> (and (<= 2 div2) (<= div2 (- index_22 1))) (not (= (mod2 v div2) 0)))) (=> (and (<= (+ index_22 1) v) (<= v index_33)) (not (= (mod2 v index_22) 0))))))))
...
(assert (and (= o4 (+ index_33 index_12)) (in_range1 (+ index_33 index_12))))
...
(assert (= is_prime8 o6))
(assert (not (= (mod2 index_34 index_22) 0)))
(check-sat)
(exit)
