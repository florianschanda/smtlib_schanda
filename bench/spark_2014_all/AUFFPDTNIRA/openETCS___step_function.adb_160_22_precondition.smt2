...
(assert (= scan_sfun12 true))
(assert (= scan_sfun22 true))
(assert (not (< (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun1)) i12)))) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun2)) i22)))))))
(assert (< (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun2)) i22)))) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun1)) i12))))))
(assert (= (to_rep2 o8) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun2)) i22))))))
(assert (= o9 (mk___split_fields o8 (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step merge__split_fields3) im2))))))
(assert (= o10 (mk___rep o9)))
(assert (= o11 (store (rec__step_function__step_function_t__step merge__split_fields3) im2 o10)))
(assert (= o12 (mk___split_fields1 (rec__step_function__step_function_t__number_of_delimiters merge__split_fields3) o11)))
(assert (= temp___387 (mk___rep1 o12)))
(assert (= result6 (mk___split_fields__ref1 merge__split_fields3)))
(assert (= merge__split_fields4 (us_split_fields3 temp___387)))
(assert (not (= (is_valid sfun2) true)))
(check-sat)
(exit)
