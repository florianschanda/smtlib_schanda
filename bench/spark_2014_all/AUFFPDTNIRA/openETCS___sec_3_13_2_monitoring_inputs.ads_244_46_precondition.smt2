...
(define-fun dynamic_invariant1 ((temp___expr_181 Float32) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool) (temp___do_typ_inv_180 Bool)) Bool (=> (or (= temp___is_init_177 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_181)))
...
(define-fun dynamic_invariant3 ((temp___expr_202 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool) (temp___do_typ_inv_201 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= 0 2147483647)) (in_range2 temp___expr_202)))
...
(define-fun dynamic_invariant4 ((temp___expr_209 Float32) (temp___is_init_205 Bool) (temp___skip_constant_206 Bool) (temp___do_toplevel_207 Bool) (temp___do_typ_inv_208 Bool)) Bool (=> (or (= temp___is_init_205 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_209)))
...
(assert (forall ((x function_range)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x num_delimiters_range)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq2 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep2 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 a))) (to_rep2 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 b)))) (= (bool_eq1 (rec__step_function__step_function_t__step (us_split_fields3 a)) 0 10 (rec__step_function__step_function_t__step (us_split_fields3 b)) 0 10) true)) true false))
...
(assert (= rliteral o11))
(assert (= o10 o12))
(assert (= sec_3_13_2_monitoring_inputs__a_brake_emergency_model__assume o11))
(assert (= sec_3_13_2_monitoring_inputs__a_brake_emergency_model__assume1 o12))
...
(assert (= o22 (temp_____aggregate_def_160 o21 (mk___rep (mk___split_fields o19 o20)))))
(assert (= o23 (mk___split_fields1 rliteral o22)))
(assert (= sec_3_13_2_monitoring_inputs__kdry_rst_model__assume (mk___rep1 o23)))
...
(assert (= sec_3_13_2_monitoring_inputs__kwet_rst_model__assume (mk___rep1 o31)))
