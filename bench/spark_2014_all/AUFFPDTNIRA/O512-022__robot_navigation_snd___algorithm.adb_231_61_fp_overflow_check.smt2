...
(define-fun in_range1 ((x Float32)) Bool (and (fp.isFinite32 x) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.leq x (fp #b0 #b10000001 #b10010010000111111011011)))))
...
(assert (forall ((x normalized2pi)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x normalized2pi)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__spaces__angles__angle__theta (us_split_fields1 a))) (to_rep (rec__spaces__angles__angle__theta (us_split_fields1 b)))) true false))
...
(assert (forall ((x idir_t)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x idir_t)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun us_split_fields_distance__projection ((a us_split_fields2)) float (rec__gaps__gap__distance a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (bool_eq (rec__gaps__gap__bearing (us_split_fields3 a)) (rec__gaps__gap__bearing (us_split_fields3 b))) true) (= (to_rep1 (rec__gaps__gap__distance (us_split_fields3 a))) (to_rep1 (rec__gaps__gap__distance (us_split_fields3 b))))) (= (to_rep2 (rec__gaps__gap__idir (us_split_fields3 a))) (to_rep2 (rec__gaps__gap__idir (us_split_fields3 b))))) true false))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep3 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs1 a))) (to_rep3 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs1 b)))) (= (us_main_eq (rec__algorithm__gap_vectors__list (us_split_fields5 a)) (rec__algorithm__gap_vectors__list (us_split_fields5 b))) true)) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_365 Int) (temp___is_init_361 Bool) (temp___skip_constant_362 Bool) (temp___do_toplevel_363 Bool) (temp___do_typ_inv_364 Bool)) Bool (=> (or (= temp___is_init_361 true) (<= 0 2147483647)) (in_range3 temp___expr_365)))
(assert (forall ((container us_rep2)) (! (let ((result (length container))) (and (<= result (to_rep3 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs1 container)))) (dynamic_invariant1 result true false true true))) :pattern ((length container)))))
...
(define-fun ole ((left us_rep3) (right us_rep3)) Bool (and (<= (length1 left) (length1 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (bool_eq1 (get left n) (get right n)) true))) true false)))
...
(define-fun bool_eq4 ((a us_rep4) (b us_rep4)) Bool (ite (= (to_rep3 (rec__algorithm__gap_vectors__cursor__node (us_split_fields7 a))) (to_rep3 (rec__algorithm__gap_vectors__cursor__node (us_split_fields7 b)))) true false))
...
(declare-fun keys_included_except__function_guard (Bool us_rep5 us_rep5 us_rep4) Bool)
...
(define-fun element_type__ref___projection ((a element_type__ref1)) us_rep1 (element_type__content1 a))
...
(assert (forall ((x nonnegative_float)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)))))
(assert (forall ((x Float32)) (! (=> (in_range5 x) (= (to_rep4 (of_rep4 x)) x)) :pattern ((to_rep4 (of_rep4 x))))))
(define-fun in_range6 ((rec__algorithm__gap_vectors__list__capacity1 Int) (a us_rep2)) Bool (= rec__algorithm__gap_vectors__list__capacity1 (to_rep3 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs1 a)))))
...
(define-fun default_initial_assumption ((temp___expr_642 us_rep2) (temp___skip_top_level_643 Bool)) Bool (and (= (to_rep3 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs1 temp___expr_642))) 1000) (=> (not (= temp___skip_top_level_643 true)) (= (is_empty temp___expr_642) true))))
...
(define-fun us_split_fields_first__projection ((a us_split_fields8)) nonnegative_float (rec__algorithm__laser_scan_data__first a))
...
(define-fun bool_eq6 ((a us_rep6) (b us_rep6)) Bool (ite (and (= (to_rep4 (rec__algorithm__laser_scan_data__first (us_split_fields9 a))) (to_rep4 (rec__algorithm__laser_scan_data__first (us_split_fields9 b)))) (= (bool_eq (rec__algorithm__laser_scan_data__second (us_split_fields9 a)) (rec__algorithm__laser_scan_data__second (us_split_fields9 b))) true)) true false))
...
(assert (forall ((i t27b)) (and (<= 2 (t27bqtint i)) (<= (t27bqtint i) 999))))
...
(define-fun dynamic_invariant5 ((temp___expr_198 Float32) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool (=> (or (= temp___is_init_194 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000001 #b10010010000111111011011))) (in_range1 temp___expr_198)))
(define-fun dynamic_invariant6 ((temp___expr_323 Int) (temp___is_init_319 Bool) (temp___skip_constant_320 Bool) (temp___do_toplevel_321 Bool) (temp___do_typ_inv_322 Bool)) Bool (=> (or (= temp___is_init_319 true) (<= (- 1) 1)) (in_range2 temp___expr_323)))
(define-fun default_initial_assumption1 ((temp___expr_466 us_rep4) (temp___skip_top_level_467 Bool)) Bool (= (to_rep3 (rec__algorithm__gap_vectors__cursor__node (us_split_fields7 temp___expr_466))) 0))
...
(define-fun oeq ((left us_rep3) (right us_rep3)) Bool (and (= (length1 left) (length1 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (bool_eq1 (get left n) (get right n)) true))) true false)))
...
(define-fun default_initial_assumption4 ((temp___expr_515 us_rep4) (temp___skip_top_level_516 Bool)) Bool (= (to_rep3 (rec__algorithm__gap_vectors__cursor__node (us_split_fields7 temp___expr_515))) 0))
(assert (forall ((container us_rep2)) (! (let ((result (positions container))) (and (not (= (has_key result no_element) true)) (forall ((i us_rep4)) (=> (= (has_key result i) true) (and (and (<= 1 (get1 result i)) (<= (get1 result i) (length container))) (forall ((j us_rep4)) (=> (= (has_key result j) true) (=> (= (get1 result i) (get1 result j)) (= (bool_eq4 i j) true))))))))) :pattern ((positions container)))))
(assert (forall ((container us_rep2)) (! (= (= (is_empty container) true) (= (length container) 0)) :pattern ((is_empty container)))))
(define-fun has_element ((container us_rep2) (position us_rep4)) Bool (has_key (positions container) position))
(declare-fun has_element__function_guard (Bool us_rep2 us_rep4) Bool)
(assert (forall ((container us_rep2)) (! (let ((result (last1 container))) (ite (= (length container) 0) (= (bool_eq4 result no_element) true) (and (= (has_element container result) true) (= (get1 (positions container) result) (length container))))) :pattern ((last1 container)))))
...
(assert (forall ((container us_rep3)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant1 result true false true true))) :pattern ((length1 container)))))
(assert true)
(assert (forall ((container us_rep5)) (forall ((key us_rep4)) (! (=> (= (distinct 0 0) true) (=> (exists ((k us_rep4)) (and (= (has_key container k) true) (= (bool_eq4 k key) true))) (= (has_key container key) true))) :pattern ((has_key container key))))))
...
(assert (forall ((container us_rep5)) (forall ((key us_rep4)) (! (=> (= (has_key container key) true) (let ((result (get1 container key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep4)) (=> (= (has_key container k) true) (= (= (bool_eq4 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant8 result true false true true)))) :pattern ((get1 container key))))))
(assert (forall ((container us_rep5)) (! (dynamic_invariant1 (length2 container) true false true true) :pattern ((length2 container)))))
(assert (forall ((left us_rep5) (right us_rep5)) (! (= (= (ole1 left right) true) (forall ((key us_rep4)) (=> (= (has_key left key) true) (and (= (has_key right key) true) (= (get1 right key) (get1 left key)))))) :pattern ((ole1 left right)))))
(assert (forall ((container us_rep5)) (! (= (= (is_empty1 container) true) (forall ((key us_rep4)) (not (= (has_key container key) true)))) :pattern ((is_empty1 container)))))
(assert (forall ((left us_rep5) (right us_rep5)) (forall ((new_key us_rep4)) (! (= (= (keys_included_except left right new_key) true) (forall ((key us_rep4)) (=> (= (has_key left key) true) (=> (not (= (bool_eq4 key new_key) true)) (= (has_key right key) true))))) :pattern ((keys_included_except left right new_key))))))
(declare-fun has_witness (us_rep5 Int) Bool)
(declare-fun has_witness__function_guard (Bool us_rep5 Int) Bool)
(assert true)
(assert (forall ((container us_rep5)) (forall ((key us_rep4)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant1 result true false true true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep5)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant1 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant8 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
(declare-const i Int)
(declare-const temp___891 nonnegative_float)
(declare-const temp___8911 normalized2pi)
(declare-const temp___890 nonnegative_float)
(declare-const temp___8901 normalized2pi)
(declare-const temp___889 us_rep2)
...
(assert (= 1000 (to_rep3 (rec__algorithm__gap_vectors__list__capacity gapvec__split_discrs))))
(assert (in_range4 robotradius))
(assert (in_range4 mingapwidth))
(assert (in_range4 fmaxrange))
(assert (and (= (to_rep3 (rec__algorithm__gap_vectors__list__capacity gapvec__split_discrs)) 1000) (<= (length (mk___rep2 gapvec__split_discrs gapvec__split_fields)) 1)))
(assert (= result (mk_int__ref i)))
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 999)) (= (mk___split_fields4 temp___891 (mk___rep (mk___split_fields temp___8911))) rayl__split_fields)))
(assert (=> (and (<= 2 i1) (<= i1 999)) (= (mk___split_fields4 temp___890 (mk___rep (mk___split_fields temp___8901))) rayr__split_fields)))
(assert (=> (and (<= 2 i1) (<= i1 999)) (= temp___889 (mk___rep2 gapvec__split_discrs gapvec__split_fields))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (= temp___888 i1)))
(assert (=> (and (<= 2 i1) (<= i1 999)) (and (= (to_rep3 (rec__algorithm__gap_vectors__list__capacity gapvec__split_discrs)) 1000) (< (length (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) i2))))
...
(assert (=> (and (<= 2 i1) (<= i1 999)) (and (= algorithm__buildgapvector__B_9__dist__assume (fp.sub RNE (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)))) (fp.isFinite32 (fp.sub RNE (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)))))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (= algorithm__buildgapvector__B_9__dist__assume dist1)))
(assert (=> (and (<= 2 i1) (<= i1 999)) (fp.isFinite32 dist1)))
(assert (=> (and (<= 2 i1) (<= i1 999)) (=> (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange))) (= o (create__2 (rec__algorithm__laser_scan_data__second rayr__split_fields2) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) (- 1))))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (=> (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange))) (and (and (and (and (and (= (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)) (+ (length (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) 1)) (= (get1 (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)) (last1 (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)))) (= (keys_included_except (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)) (positions (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (last1 (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) true)) (= (ole1 (positions (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) true)) (= (bool_eq1 (get (model__ (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)) (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) o) true)) (= (ole (model__ (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (model__ (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) true)))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (=> (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange))) (= result3 (mk___split_fields__ref2 gapvec__split_fields1)))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (=> (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange))) (= gapvec__split_fields2 algorithm__gap_vectors__append__container__fields))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (=> (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange))) (= algorithm__gap_vectors__append__container__fields1 rho1))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange)))) (=> (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange))) (= o1 (create__2 (rec__algorithm__laser_scan_data__second rayl__split_fields2) (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) 1))))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange)))) (=> (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange))) (and (and (and (and (and (= (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1)) (+ (length (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) 1)) (= (get1 (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1)) (last1 (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1))) (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1)))) (= (keys_included_except (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1)) (positions (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (last1 (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1))) true)) (= (ole1 (positions (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1))) true)) (= (bool_eq1 (get (model__ (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1)) (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1))) o1) true)) (= (ole (model__ (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (model__ (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1))) true))))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange)))) (=> (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange))) (= result4 (mk___split_fields__ref2 gapvec__split_fields1))))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange)))) (=> (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange))) (= gapvec__split_fields3 algorithm__gap_vectors__append__container__fields1)))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange)))) (=> (not (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange)))) (= gapvec__split_fields3 gapvec__split_fields1)))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange)))) (=> (not (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange)))) (= algorithm__gap_vectors__append__container__fields1 rho1)))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange)))) (=> (not (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange)))) (= gapvec__split_fields3 gapvec__split_fields1)))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange)))) (= gapvec__split_fields2 gapvec__split_fields3))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange)))) (= algorithm__gap_vectors__append__container__fields rho))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) fmaxrange)))) (= gapvec__split_fields2 gapvec__split_fields3))))
...
(assert (and (= o5 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields7)))) (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields7))))))
(assert (= o6 (fp.mul RNE o5 (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields7)))))
(assert (and (= o9 o6) (fp.isFinite32 o6)))
(assert (= o10 (fp.mul RNE o9 o8)))
(assert (and (= o11 o10) (fp.isFinite32 o10)))
(assert (and (= o2 (fp.mul RNE (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields7)) (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields7)))) (fp.isFinite32 (fp.mul RNE (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields7)) (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields7))))))
(assert (and (= o3 (fp.mul RNE (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields7)) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields7)))) (fp.isFinite32 (fp.mul RNE (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields7)) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields7))))))
