...
(assert (not (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep6 (rec__robot_iface__proxy__scan_res (us_split_fields11 (rec__algorithm__controller__robot (let ((subject this__split_fields)) this__split_fields1)))))))))
(check-sat)
(exit)
