...
(assert (= j2 2))
(assert (not (= i1 j2)))
(assert (and (= o14 (fp.mul RNE (to_rep (select kvp2 i1)) (fp.abs (to_rep (select d j2))))) (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 i1)) (fp.abs (to_rep (select d j2)))))))
(assert (not (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 j2)) (fp.abs (to_rep (select d i1)))))))
(check-sat)
(exit)
