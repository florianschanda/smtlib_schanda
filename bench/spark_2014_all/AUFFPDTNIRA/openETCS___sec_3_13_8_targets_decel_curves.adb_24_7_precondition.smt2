...
(assert true)
(assert (forall ((sec_3_13_8_targets_decel_curves__target (Array Int us_rep2))) (! (= (= (is_valid_target sec_3_13_8_targets_decel_curves__target) true) (and (and (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep1 (rec__deceleration_curve__target_t__speed (us_split_fields5 (select sec_3_13_8_targets_decel_curves__target 2))))) (= (rec__deceleration_curve__target_t__supervise (us_split_fields5 (select sec_3_13_8_targets_decel_curves__target 1))) true)) (=> (fp.eq (to_rep1 (rec__deceleration_curve__target_t__speed (us_split_fields5 (select sec_3_13_8_targets_decel_curves__target 2)))) (fp #b0 #b00000000 #b00000000000000000000000)) (and (= (rec__deceleration_curve__target_t__supervise (us_split_fields5 (select sec_3_13_8_targets_decel_curves__target 2))) true) (= (rec__deceleration_curve__target_t__supervise (us_split_fields5 (select sec_3_13_8_targets_decel_curves__target 3))) true)))) (fp.eq (to_rep1 (rec__deceleration_curve__target_t__speed (us_split_fields5 (select sec_3_13_8_targets_decel_curves__target 4)))) (fp #b0 #b00000000 #b00000000000000000000000)))) :pattern ((is_valid_target sec_3_13_8_targets_decel_curves__target)))))
...
(assert (and (= (is_valid_target target) true) (fp.eq (to_rep1 (rec__deceleration_curve__target_t__speed (us_split_fields5 (select target 3)))) (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (not (<= (to_rep (rec__deceleration_curve__target_t__location (us_split_fields5 (select target 3)))) 5000)))
(check-sat)
(exit)
