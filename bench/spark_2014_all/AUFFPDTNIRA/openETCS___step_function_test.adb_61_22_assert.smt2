...
(assert (and (and (and (= (is_valid (mk___rep1 sfun_merge__split_fields)) true) (forall ((i3 Int)) (=> (and (<= 0 i3) (<= i3 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun3__split_fields2)))) (exists ((j Int)) (and (and (<= 0 j) (<= j (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun_merge__split_fields)))) (= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun_merge__split_fields) j)))) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) i3)))))))))) (forall ((i3 Int)) (=> (and (<= 0 i3) (<= i3 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun4__split_fields2)))) (exists ((j Int)) (and (and (<= 0 j) (<= j (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun_merge__split_fields)))) (= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun_merge__split_fields) j)))) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) i3)))))))))) (forall ((i3 Int)) (=> (and (<= 0 i3) (<= i3 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun_merge__split_fields)))) (fp.eq (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun_merge__split_fields) i3)))) (min (get_value (mk___rep1 sfun3__split_fields2) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun_merge__split_fields) i3))))) (get_value (mk___rep1 sfun4__split_fields2) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun_merge__split_fields) i3)))))))))))
...
(assert (= i2 1))
(assert (not (fp.eq (get_value (mk___rep1 sfun_merge__split_fields) i2) (min (get_value (mk___rep1 sfun3__split_fields2) i2) (get_value (mk___rep1 sfun4__split_fields2) i2)))))
(check-sat)
(exit)
