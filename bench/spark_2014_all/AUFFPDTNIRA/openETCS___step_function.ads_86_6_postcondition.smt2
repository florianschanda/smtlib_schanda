...
(assert (in_range1 i))
(assert (=> (< i (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun)))) (and (= o (+ i 1)) (in_range1 (+ i 1)))))
(assert (=> (< i (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun)))) (= result i)))
(assert (=> (< i (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun)))) (= i2 o)))
(assert (=> (< i (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun)))) (= scan2 scan)))
(assert (=> (< i (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun)))) (= scan2 scan1)))
(assert (=> (not (< i (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))) (= result1 scan)))
(assert (=> (not (< i (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))) (= scan2 (distinct 0 0))))
(assert (=> (not (< i (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))) (= i2 i)))
(assert (=> (not (< i (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))) (= i2 i1)))
(assert (= scan2 scan3))
(assert (= i2 i3))
(assert (= scan4 scan2))
(assert (= i4 i2))
