...
(assert (and (= o4 (ccwdiff (rec__algorithm__laser_scan_data__second rayr__split_fields7) (rec__algorithm__laser_scan_data__second rayl__split_fields7))) (fp.isFinite32 o4)))
(assert (and (= o5 (cos1 o4)) (and (fp.isFinite32 o5) (and (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) o5) (fp.leq o5 (fp #b0 #b01111111 #b00000000000000000000000))) (=> (fp.eq o4 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq o5 (fp #b0 #b01111111 #b00000000000000000000000)))))))
(assert (and (= o2 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields7)))) (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields7))))))
(assert (= o3 (fp.mul RNE o2 (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields7)))))
(assert (not (fp.isFinite32 o3)))
(check-sat)
(exit)
