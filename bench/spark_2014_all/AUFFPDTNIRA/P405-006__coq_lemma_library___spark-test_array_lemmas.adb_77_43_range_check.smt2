...
(assert (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first2 (rt1 arr))) 1) i) (<= i (to_rep1 (last2 (rt1 arr))))) (fp.lt (to_rep (select (elts1 arr) (- i 1))) (to_rep (select (elts1 arr) i))))))
(assert (not (dynamic_property (- 2147483648) 2147483647 (to_rep1 (first2 (rt1 arr))) (to_rep1 (last2 (rt1 arr))))))
(check-sat)
(exit)
