...
(assert (= tl5 o60))
(assert (not (fp.isFinite32 (fp.add RNE (to_rep (rec__untangle_tests__coordinate__y (us_split_fields1 (select (rec__untangle_tests__triangle__vertices (us_split_fields3 (select tl5 t2))) v2)))) (to_rep (rec__untangle_tests__coordinate__y (us_split_fields1 o)))))))
(check-sat)
(exit)
