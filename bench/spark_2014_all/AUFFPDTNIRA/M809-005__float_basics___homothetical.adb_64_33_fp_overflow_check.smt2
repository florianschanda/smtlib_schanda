...
(assert (forall ((j5 Int)) (=> (and (<= 1 j5) (<= j5 2)) (and (and (not (fp.eq (to_rep (select d j5)) (fp #b0 #b00000000 #b00000000000000000000000))) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select kv j5)))) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select ka j5)))))))
...
(assert (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 2)) (and (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select ka i3))) (not (fp.eq (to_rep (select kvp2 i3)) (fp #b0 #b00000000 #b00000000000000000000000)))) (not (fp.eq (to_rep (select d i3)) (fp #b0 #b00000000 #b00000000000000000000000)))))))
...
(assert (and (= o28 (fp.mul RNE (to_rep (select (map__content lambda6) i1)) (to_rep (select kvp2 i1)))) (fp.isFinite32 (fp.mul RNE (to_rep (select (map__content lambda6) i1)) (to_rep (select kvp2 i1))))))
(assert (= (to_rep o29) o28))
(assert (= o30 (store kvmax i1 o29)))
(assert (= result10 (mk_map__ref kvmax)))
(assert (= kvmax1 o30))
(assert (and (= o31 (fp.mul RNE (to_rep (select (map__content upsilon6) i1)) (to_rep (select ka i1)))) (fp.isFinite32 (fp.mul RNE (to_rep (select (map__content upsilon6) i1)) (to_rep (select ka i1))))))
...
(assert (= j3 1))
(assert (=> (not (= i2 j3)) (and (= o35 (fp.mul RNE (to_rep (select kvp2 i2)) (fp.abs (to_rep (select d j3))))) (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 i2)) (fp.abs (to_rep (select d j3))))))))
(assert (=> (not (= i2 j3)) (and (= o34 (fp.mul RNE (to_rep (select kvp2 j3)) (fp.abs (to_rep (select d i2))))) (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 j3)) (fp.abs (to_rep (select d i2))))))))
(assert (=> (not (= i2 j3)) (= o36 (fp.div RNE o34 o35))))
(assert (=> (not (= i2 j3)) (and (= o37 o36) (fp.isFinite32 o36))))
(assert (=> (not (= i2 j3)) (= o38 (fp.min (to_rep (select (map__content lambda6) i2)) o37))))
...
(assert (=> (not (= i2 j3)) (and (= o42 (fp.mul RNE (to_rep (select ka i2)) (fp.abs (to_rep (select d j3))))) (fp.isFinite32 (fp.mul RNE (to_rep (select ka i2)) (fp.abs (to_rep (select d j3))))))))
(assert (=> (not (= i2 j3)) (and (= o41 (fp.mul RNE (to_rep (select ka j3)) (fp.abs (to_rep (select d i2))))) (fp.isFinite32 (fp.mul RNE (to_rep (select ka j3)) (fp.abs (to_rep (select d i2))))))))
(assert (=> (not (= i2 j3)) (= o43 (fp.div RNE o41 o42))))
(assert (=> (not (= i2 j3)) (and (= o44 o43) (fp.isFinite32 o43))))
(assert (=> (not (= i2 j3)) (= o45 (fp.min (to_rep (select (map__content upsilon6) i2)) o44))))
(assert (=> (not (= i2 j3)) (= (to_rep o46) o45)))
(assert (=> (not (= i2 j3)) (= o47 (store (map__content upsilon6) i2 o46))))
...
(assert (= j4 2))
(assert (=> (not (= i2 j4)) (and (= o49 (fp.mul RNE (to_rep (select kvp2 i2)) (fp.abs (to_rep (select d j4))))) (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 i2)) (fp.abs (to_rep (select d j4))))))))
(assert (=> (not (= i2 j4)) (and (= o48 (fp.mul RNE (to_rep (select kvp2 j4)) (fp.abs (to_rep (select d i2))))) (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 j4)) (fp.abs (to_rep (select d i2))))))))
(assert (=> (not (= i2 j4)) (= o50 (fp.div RNE o48 o49))))
(assert (=> (not (= i2 j4)) (and (= o51 o50) (fp.isFinite32 o50))))
(assert (=> (not (= i2 j4)) (= o52 (fp.min (to_rep (select (map__content lambda9) i2)) o51))))
...
(assert (=> (not (= i2 j4)) (and (= o56 (fp.mul RNE (to_rep (select ka i2)) (fp.abs (to_rep (select d j4))))) (fp.isFinite32 (fp.mul RNE (to_rep (select ka i2)) (fp.abs (to_rep (select d j4))))))))
(assert (=> (not (= i2 j4)) (and (= o55 (fp.mul RNE (to_rep (select ka j4)) (fp.abs (to_rep (select d i2))))) (fp.isFinite32 (fp.mul RNE (to_rep (select ka j4)) (fp.abs (to_rep (select d i2))))))))
(assert (=> (not (= i2 j4)) (= o57 (fp.div RNE o55 o56))))
(assert (=> (not (= i2 j4)) (and (= o58 o57) (fp.isFinite32 o57))))
(assert (=> (not (= i2 j4)) (= o59 (fp.min (to_rep (select (map__content upsilon9) i2)) o58))))
(assert (=> (not (= i2 j4)) (= (to_rep o60) o59)))
(assert (=> (not (= i2 j4)) (= o61 (store (map__content upsilon9) i2 o60))))
...
(assert (not (fp.isFinite32 (fp.mul RNE (to_rep (select (map__content lambda12) i2)) (to_rep (select kvp2 i2))))))
(check-sat)
(exit)
