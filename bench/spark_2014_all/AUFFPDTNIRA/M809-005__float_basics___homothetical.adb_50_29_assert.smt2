...
(assert (=> (and (<= 1 i1) (<= i1 2)) (and (and (=> (<= 1 2) (in_range2 i2)) (forall ((temp___197 Int)) (=> (and (<= 1 temp___197) (<= temp___197 2)) (=> (or (< 2 temp___197) (or (< temp___197 1) (<= i2 temp___197))) (= (select kvp2 temp___197) (select temp___196 temp___197)))))) (and (<= 1 i2) (<= i2 2)))))
...
(assert (= kvmax1 (temp_____aggregate_def_198 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (= result6 (mk_map__ref kamax)))
(assert (= kamax1 (temp_____aggregate_def_202 (fp #b0 #b00000000 #b00000000000000000000000))))
(declare-const i7 Int)
(assert (<= 1 i7))
(assert (<= i7 2))
(assert (not (not (fp.eq (to_rep (select kvp6 i7)) (fp #b0 #b00000000 #b00000000000000000000000)))))
(check-sat)
(exit)
