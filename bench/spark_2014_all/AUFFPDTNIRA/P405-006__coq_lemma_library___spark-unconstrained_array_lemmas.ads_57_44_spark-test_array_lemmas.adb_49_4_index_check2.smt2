...
(define-fun dynamic_invariant ((temp___expr_248 us_t) (temp___is_init_244 Bool) (temp___skip_constant_245 Bool) (temp___do_toplevel_246 Bool) (temp___do_typ_inv_247 Bool)) Bool (=> (not (= temp___skip_constant_245 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_248) (last1 temp___expr_248))))
...
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 (first (rt arr))) i1) (<= i1 (to_rep1 (last (rt arr))))) (=> (not (= i1 (to_rep1 (first (rt arr))))) (fp.lt (to_rep (select (elts arr) (- i1 1))) (to_rep (select (elts arr) i1)))))))
