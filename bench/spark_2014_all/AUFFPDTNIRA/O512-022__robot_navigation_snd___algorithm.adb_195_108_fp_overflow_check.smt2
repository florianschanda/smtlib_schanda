...
(assert (and (= o2 (ccwdiff (rec__algorithm__laser_scan_data__second rayr__split_fields2) (rec__algorithm__laser_scan_data__second rayl__split_fields2))) (fp.isFinite32 o2)))
...
(assert (and (= o (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)))) (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2))))))
(assert (= o1 (fp.mul RNE o (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)))))
