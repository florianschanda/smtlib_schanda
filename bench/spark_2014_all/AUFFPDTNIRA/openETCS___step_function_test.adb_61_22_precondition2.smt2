...
(assert (and (and (and (= (is_valid (mk___rep1 sfun_merge__split_fields)) true) (forall ((i2 Int)) (=> (and (<= 0 i2) (<= i2 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun3__split_fields2)))) (exists ((j Int)) (and (and (<= 0 j) (<= j (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun_merge__split_fields)))) (= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun_merge__split_fields) j)))) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) i2)))))))))) (forall ((i2 Int)) (=> (and (<= 0 i2) (<= i2 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun4__split_fields2)))) (exists ((j Int)) (and (and (<= 0 j) (<= j (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun_merge__split_fields)))) (= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun_merge__split_fields) j)))) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) i2)))))))))) (forall ((i2 Int)) (=> (and (<= 0 i2) (<= i2 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun_merge__split_fields)))) (fp.eq (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun_merge__split_fields) i2)))) (min (get_value (mk___rep1 sfun3__split_fields2) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun_merge__split_fields) i2))))) (get_value (mk___rep1 sfun4__split_fields2) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun_merge__split_fields) i2)))))))))))
(assert (= result4 (mk_int__ref i)))
(assert (= i1 0))
(assert (and (= o82 (get_value (mk___rep1 sfun4__split_fields2) i1)) (and (fp.isFinite32 o82) (or (exists ((i2 Int)) (and (and (<= 0 i2) (<= i2 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun4__split_fields2)) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) i2)))) i1) (< i1 (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) (+ i2 1))))))) (fp.eq o82 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) i2)))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun4__split_fields2)))))) i1) (fp.eq o82 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun4__split_fields2))))))))))))
(assert (and (= o81 (get_value (mk___rep1 sfun3__split_fields2) i1)) (and (fp.isFinite32 o81) (or (exists ((i2 Int)) (and (and (<= 0 i2) (<= i2 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun3__split_fields2)) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) i2)))) i1) (< i1 (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) (+ i2 1))))))) (fp.eq o81 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) i2)))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun3__split_fields2)))))) i1) (fp.eq o81 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun3__split_fields2))))))))))))
(assert (and (= o83 (min o81 o82)) (and (fp.isFinite32 o83) (ite (fp.leq o81 o82) (fp.eq o83 o81) (fp.eq o83 o82)))))
(assert (not (= (is_valid (mk___rep1 sfun_merge__split_fields)) true)))
(check-sat)
(exit)
