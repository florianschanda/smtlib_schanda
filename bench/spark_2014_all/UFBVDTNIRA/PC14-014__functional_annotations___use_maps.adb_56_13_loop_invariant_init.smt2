...
(assert (= result1 true))
(define-fun temp___855 () us_rep2 (keys (mk___rep r__split_discrs r__split_fields1)))
(declare-const temp___854 Int)
(assert (in_range4 temp___854))
(assert (= (iter_has_element temp___855 temp___854) true))
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields2)) 1))) (= (get temp___855 temp___854) (get (keys s) i))))))
(check-sat)
(exit)
