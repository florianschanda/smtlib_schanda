...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (contains (model__ (mk___rep r__split_discrs r__split_fields3)) (f (get (elements s) i))) true))))
(assert (let ((temp___913 (elements (mk___rep r__split_discrs r__split_fields3)))) (forall ((temp___912 Int)) (=> (and (in_range3 temp___912) (= (iter_has_element temp___913 temp___912) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___913 temp___912) (f (get (elements s) i)))))))))
(assert (and (= temp___909 (elements (mk___rep r__split_discrs r__split_fields3))) (and (and (and (and (= (length1 temp___909) (length (mk___rep r__split_discrs r__split_fields3))) (forall ((temp___467 Int)) (=> (and (in_range3 temp___467) (= (iter_has_element temp___909 temp___467) true)) (= (contains (model__ (mk___rep r__split_discrs r__split_fields3)) (get temp___909 temp___467)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep r__split_discrs r__split_fields3)) item) true)) (and (< 0 (find temp___909 item)) (= (get temp___909 (find temp___909 item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields3)))) (= (find temp___909 (get temp___909 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields3)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs r__split_fields3)))) (=> (= (get temp___909 i) (get temp___909 j)) (= i j)))))))))
