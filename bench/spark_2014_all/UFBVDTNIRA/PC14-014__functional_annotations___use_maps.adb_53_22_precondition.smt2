...
(assert (= result2 true))
(assert (and (= o11 (keys s)) (and (and (and (and (= (length2 o11) (length s)) (forall ((temp___474 Int)) (=> (and (in_range4 temp___474) (= (iter_has_element o11 temp___474) true)) (= (has_key (model__ s) (get o11 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ s) key1) true)) (and (< 0 (find o11 key1)) (= (get o11 (find o11 key1)) key1))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o11 (get o11 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o11 i1) (get o11 j)) (= i1 j)))))))))
