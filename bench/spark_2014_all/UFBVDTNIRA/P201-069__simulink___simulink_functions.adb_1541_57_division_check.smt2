...
(define-fun dynamic_invariant ((temp___expr_347 (_ BitVec 32)) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool) (temp___do_typ_inv_346 Bool)) Bool true)
...
(define-fun target__ref___8__projection ((a target__ref)) target (target__content a))
(define-fun dynamic_invariant1 ((temp___expr_354 (_ BitVec 8)) (temp___is_init_350 Bool) (temp___skip_constant_351 Bool) (temp___do_toplevel_352 Bool) (temp___do_typ_inv_353 Bool)) Bool true)
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant s true true true true) (dynamic_invariant1 (u32tou8 s) true false true true)) :pattern ((u32tou8 s)))))
...
(declare-const o Int)
(assert (and (= o (bv2nat right)) (in_range (bv2nat right))))
(assert (not (not (= 32 0))))
(check-sat)
(exit)
