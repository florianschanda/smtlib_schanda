...
(define-fun temp___806 () us_rep2 (keys (mk___rep r__split_discrs r__split_fields1)))
(assert (not (exists ((temp___805 Int)) (and (and (in_range4 temp___805) (= (iter_has_element temp___806 temp___805) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields1)) (get temp___806 temp___805)) (f (get2 (model__ s) (get (keys s) i))))))))
(check-sat)
(exit)
