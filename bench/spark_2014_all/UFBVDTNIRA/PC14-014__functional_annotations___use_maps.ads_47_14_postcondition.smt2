...
(define-fun temp___871 () us_rep2 (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))
(declare-const temp___870 Int)
(assert (in_range4 temp___870))
(assert (= (iter_has_element temp___871 temp___870) true))
(assert (not (= (has_key (model__ s) (get temp___871 temp___870)) true)))
(check-sat)
(exit)
