...
(assert (in_range2 shift_amount1))
...
(assert (not (= v1 #x0000000000000000)))
(assert (and (and (=> (<= 0 63) (in_range2 result__2)) (=> (<= 0 63) (in_range2 shift_amount2))) (and (not (= shift_amount2 0)) (not (= v2 #x0000000000000000)))))
...
(assert (= new_v1 o))
(assert (not (= new_v1 #x0000000000000000)))
(assert (in_range2 (+ result__2 shift_amount2)))
(assert (not (in_range2 (+ result__2 shift_amount2))))
(check-sat)
(exit)
