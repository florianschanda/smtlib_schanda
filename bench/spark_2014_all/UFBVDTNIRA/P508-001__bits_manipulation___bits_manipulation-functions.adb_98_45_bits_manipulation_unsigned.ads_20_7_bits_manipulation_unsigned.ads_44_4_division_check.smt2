...
(assert (= new_v1 o))
(assert (=> (not (= new_v1 #x00000000)) (in_range2 (+ result__2 shift_amount2))))
(assert (=> (not (= new_v1 #x00000000)) (and (= o1 (+ result__2 shift_amount2)) (in_range2 (+ result__2 shift_amount2)))))
