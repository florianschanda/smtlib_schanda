...
(define-fun source__ref___10__projection ((a source__ref)) source (source__content a))
(define-fun dynamic_invariant ((temp___expr_375 (_ BitVec 32)) (temp___is_init_371 Bool) (temp___skip_constant_372 Bool) (temp___do_toplevel_373 Bool) (temp___do_typ_inv_374 Bool)) Bool true)
(declare-sort target 0)
(declare-fun targetqtint (target) Int)
(assert (forall ((i target)) (and (<= (- 128) (targetqtint i)) (<= (targetqtint i) 127))))
...
(define-fun target__ref___10__projection ((a target__ref)) target (target__content a))
(define-fun dynamic_invariant1 ((temp___expr_382 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool) (temp___do_typ_inv_381 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= (- 128) 127)) (in_range1 temp___expr_382)))
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant s true true true true) (dynamic_invariant1 (u32toint8 s) true false true true)) :pattern ((u32toint8 s)))))
