...
(assert (= new_v1 o))
(assert (=> (not (= new_v1 #x0000000000000000)) (in_range2 (+ result__2 shift_amount2))))
(assert (=> (not (= new_v1 #x0000000000000000)) (and (= o1 (+ result__2 shift_amount2)) (in_range2 (+ result__2 shift_amount2)))))
(assert (=> (not (= new_v1 #x0000000000000000)) (= result__2 result4)))
(assert (=> (not (= new_v1 #x0000000000000000)) (= result__3 o1)))
(assert (=> (not (= new_v1 #x0000000000000000)) (= v2 result5)))
(assert (=> (not (= new_v1 #x0000000000000000)) (= v3 new_v1)))
(assert (=> (not (not (= new_v1 #x0000000000000000))) (= v3 v2)))
(assert (=> (not (not (= new_v1 #x0000000000000000))) (= result__3 result__2)))
