...
(define-fun dynamic_invariant1 ((temp___expr_2087 (_ BitVec 32)) (temp___is_init_2083 Bool) (temp___skip_constant_2084 Bool) (temp___do_toplevel_2085 Bool) (temp___do_typ_inv_2086 Bool)) Bool (=> (or (= temp___is_init_2083 true) (bvule #x00000000 #x0001869F)) (in_range2 temp___expr_2087)))
...
(declare-const interval1 Int)
(assert (in_range2 level_nbr))
(assert (and (= o (* (- 11 (mod2 (bv2nat level_nbr) 11)) 50)) (in_range (* (- 11 (mod2 (bv2nat level_nbr) 11)) 50))))
(assert (and (= o1 o) (in_range1 o)))
(assert (= result interval))
(assert (= interval1 o1))
(assert (in_range1 interval1))
(assert (= speed_up true))
(assert (not (not (= 3 0))))
(check-sat)
(exit)
