...
(assert (= result1 true))
(define-fun temp___812 () us_rep2 (keys (mk___rep r__split_discrs r__split_fields1)))
(declare-const temp___811 Int)
(assert (in_range4 temp___811))
(assert (= (iter_has_element temp___812 temp___811) true))
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields2)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields1)) (get temp___812 temp___811)) (f (get2 (model__ s) (get (keys s) i))))))))
(check-sat)
(exit)
