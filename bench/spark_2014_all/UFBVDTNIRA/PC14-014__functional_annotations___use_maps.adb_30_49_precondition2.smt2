...
(declare-const temp___800 us_rep2)
...
(assert (and (= o1 (get1 o (mk___rep1 cu__split_fields3))) (and (in_range5 o1) (=> (= (distinct 0 0) true) (and (= o1 (w_get o (witness o (mk___rep1 cu__split_fields3)))) (forall ((k1 us_rep3)) (=> (= (has_key1 o k1) true) (= (= (bool_eq3 k1 (mk___rep1 cu__split_fields3)) true) (= (witness o (mk___rep1 cu__split_fields3)) (witness o k1))))))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result2 (ite (<= 1 i) o3 false)))
(assert (= result2 true))
(assert (and (= temp___800 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (and (= (length2 temp___800) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___474 Int)) (=> (and (in_range4 temp___474) (= (iter_has_element temp___800 temp___474) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___800 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key1) true)) (and (< 0 (find temp___800 key1)) (= (get temp___800 (find temp___800 key1)) key1))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields2)))) (= (find temp___800 (get temp___800 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields2)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs r__split_fields2)))) (=> (= (get temp___800 i1) (get temp___800 j)) (= i1 j)))))))))
(assert (and (= o4 (iter_has_element temp___800 temp___799)) (= (= o4 true) (and (<= 1 temp___799) (<= temp___799 (last temp___800))))))
(assert (= (= o5 true) (in_range4 temp___799)))
(assert (= result3 (ite (= o5 true) o4 false)))
(assert (= result3 true))
(assert (and (= k (get temp___800 temp___799)) (in_range3 k)))
