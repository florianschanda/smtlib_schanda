...
(declare-fun power4 ((_ BitVec 64) Int) (_ BitVec 64))
...
(define-fun dynamic_invariant2 ((temp___expr_151 Int) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool) (temp___do_typ_inv_150 Bool)) Bool (=> (or (= temp___is_init_147 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range1 temp___expr_151)))
...
(assert (<= 0 n))
(assert (<= n 15))
(assert (and (= o1 (power 2 n)) (in_range1 (power 2 n))))
(assert (= o2 (ite (= o1 0) true false)))
(assert (= result (ite (not (= o2 true)) true false)))
(assert (= result true))
(assert (=> (< n 65536) (= o (bvshl #x0001 ((_ int2bv 16) n)))))
(assert (=> (not (< n 65536)) (= o #x0000)))
(assert (not (not (= o #x0000))))
(check-sat)
(exit)
