...
(assert (not (or (= (has_key1 (positions s) (mk___rep1 cu__split_fields3)) true) (= (bool_eq3 (mk___rep1 cu__split_fields3) no_element) true))))
(check-sat)
(exit)
