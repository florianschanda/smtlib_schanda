...
(assert (and (= temp___808 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (and (= (length2 temp___808) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___474 Int)) (=> (and (in_range4 temp___474) (= (iter_has_element temp___808 temp___474) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___808 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key1) true)) (and (< 0 (find temp___808 key1)) (= (get temp___808 (find temp___808 key1)) key1))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields2)))) (= (find temp___808 (get temp___808 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields2)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs r__split_fields2)))) (=> (= (get temp___808 i) (get temp___808 j)) (= i j)))))))))
...
(assert (= result2 true))
(assert (not (<= temp___807 (last temp___808))))
(check-sat)
(exit)
