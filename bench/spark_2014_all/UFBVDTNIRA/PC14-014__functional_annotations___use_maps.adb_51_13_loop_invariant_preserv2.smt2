...
(assert (let ((temp___855 (keys (mk___rep r__split_discrs r__split_fields4)))) (forall ((temp___854 Int)) (=> (and (in_range4 temp___854) (= (iter_has_element temp___855 temp___854) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (= (get temp___855 temp___854) (get (keys s) i))))))))
...
(assert (and (= temp___8471 (next s (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq3 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields4)) (length s)) true) true) (= (bool_eq3 temp___8471 no_element) true) (and (= (has_key1 (positions s) temp___8471) true) (= (get1 (positions s) temp___8471) (+ (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))))))
(assert (= result2 cu__split_fields2))
(assert (= cu__split_fields3 (mk___split_fields1 temp___847)))
