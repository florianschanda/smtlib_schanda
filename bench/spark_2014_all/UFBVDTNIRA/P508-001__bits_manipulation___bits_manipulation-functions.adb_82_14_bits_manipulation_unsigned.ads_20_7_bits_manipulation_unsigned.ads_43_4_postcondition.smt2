...
(assert (=> (and (not (= shift_amount1 0)) (not (= v1 #x0000))) (and (and (=> (<= 0 15) (in_range2 result__2)) (=> (<= 0 15) (in_range2 shift_amount2))) (and (not (= shift_amount2 0)) (not (= v2 #x0000))))))
...
(assert (=> (and (not (= shift_amount1 0)) (not (= v1 #x0000))) (=> (not (= new_v3 #x0000)) (in_range2 (+ result__2 shift_amount2)))))
(assert (=> (and (not (= shift_amount1 0)) (not (= v1 #x0000))) (=> (not (= new_v3 #x0000)) (and (= o1 (+ result__2 shift_amount2)) (in_range2 (+ result__2 shift_amount2))))))
