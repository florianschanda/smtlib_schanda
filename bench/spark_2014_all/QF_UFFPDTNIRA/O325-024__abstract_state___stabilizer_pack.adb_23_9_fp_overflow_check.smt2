...
(assert (= asl_tmp1 o5))
(assert (and (= o6 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) asl_alpha_long)) (fp.isFinite32 (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) asl_alpha_long))))
(assert (= o7 (fp.mul RNE asl_raw o6)))
(assert (and (= o8 o7) (fp.isFinite32 o7)))
(assert (and (= o9 (fp.mul RNE asl_long asl_alpha_long)) (fp.isFinite32 (fp.mul RNE asl_long asl_alpha_long))))
