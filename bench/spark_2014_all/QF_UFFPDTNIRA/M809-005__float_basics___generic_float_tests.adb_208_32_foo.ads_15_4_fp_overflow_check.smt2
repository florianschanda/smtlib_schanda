...
(assert (and (fp.eq x (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (fp.eq y (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))))
(assert (not (fp.isFinite64 (fp.div RNE x y))))
(check-sat)
(exit)
