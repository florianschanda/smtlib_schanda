...
(assert (and (= o (fp.mul RNE (fp #b0 #b10001011 #b01101010100000000000000) (fp.abs b))) (fp.isFinite32 (fp.mul RNE (fp #b0 #b10001011 #b01101010100000000000000) (fp.abs b)))))
(assert (not (fp.isFinite32 (fp.mul RNE (fp.abs a) (fp.abs c)))))
(check-sat)
(exit)
