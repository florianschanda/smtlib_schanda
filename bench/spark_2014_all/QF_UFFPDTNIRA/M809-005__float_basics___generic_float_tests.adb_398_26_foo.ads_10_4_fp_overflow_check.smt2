...
(assert (= biggest_representable_int (fp #b0 #b10010111 #b00000000000000000000000)))
...
(assert (= (fp #b0 #b10010111 #b00000000000000000000000) biggest_representable_int))
...
(assert (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.leq x biggest_representable_int)))
(assert (= (mk_t__ref result) (mk_t__ref y)))
(assert (= y1 (fp.roundToIntegral RNA x)))
(assert (= y1 y2))
(assert (= y3 y1))
(assert (and (= o (fp.add RNE x (fp #b0 #b01111110 #b00000000000000000000000))) (fp.isFinite32 (fp.add RNE x (fp #b0 #b01111110 #b00000000000000000000000)))))
(assert (= o1 (ite (fp.leq y2 o) true false)))
(assert (not (fp.isFinite32 (fp.sub RNE x (fp #b0 #b01111110 #b00000000000000000000000)))))
(check-sat)
(exit)
