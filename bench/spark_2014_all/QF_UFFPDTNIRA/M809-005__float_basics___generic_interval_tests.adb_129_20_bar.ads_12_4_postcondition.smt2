...
(assert (and (= o (fp.add RNE x (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (fp.isFinite64 (fp.add RNE x (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (= result z))
(assert (= z1 o))
(assert (= z1 z2))
(assert (= z3 z1))
(assert (not (ite (= (ite (= (fp.leq z2 (fp #b0 #b10000000001 #b1000000000000000000000000000000000000000000000000000)) false) (fp.geq z2 (fp #b0 #b10000000010 #b0110000000000000000000000000000000000000000000000000)) true) true) (ite (= (ite (= (fp.leq z2 (fp #b0 #b10000000001 #b1000000000000000000000000000000000000000000000000000)) true) (fp.geq z2 (fp #b0 #b10000000010 #b0110000000000000000000000000000000000000000000000000)) false) false) true false) true)))
(check-sat)
(exit)
