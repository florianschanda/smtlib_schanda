...
(assert (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) (fp.div RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) x))))
(check-sat)
(exit)
