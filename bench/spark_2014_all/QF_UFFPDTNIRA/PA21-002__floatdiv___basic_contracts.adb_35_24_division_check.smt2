...
(assert (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) numerator) (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) denominator)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 res)))
(assert (not (not (fp.isZero denominator))))
(check-sat)
(exit)
