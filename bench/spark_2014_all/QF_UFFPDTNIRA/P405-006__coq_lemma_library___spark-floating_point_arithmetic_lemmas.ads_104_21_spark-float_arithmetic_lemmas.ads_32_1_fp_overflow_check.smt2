...
(assert (and (and (fp.leq (fp.neg (fp #b0 #b10111110 #b00000000000000000000000)) val1) (fp.leq val1 fl_last_sqrt)) (and (and (fp.leq (fp.neg (fp #b0 #b10111110 #b00000000000000000000000)) val2) (fp.leq val2 fl_last_sqrt)) (and (and (fp.leq (fp #b0 #b01000000 #b00000000000000000000000) val3) (fp.leq val3 (fp #b0 #b11111110 #b11111111111111111111111))) (fp.leq val1 val2)))))
(assert (and (= o (fp.div RNE val2 val3)) (fp.isFinite32 (fp.div RNE val2 val3))))
(assert (not (fp.isFinite32 (fp.div RNE val1 val3))))
(check-sat)
(exit)
