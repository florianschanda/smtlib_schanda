...
(assert (= foo__double_tests__negate_wrong__result1 foo__double_tests__negate_wrong__result2))
(assert (= foo__double_tests__negate_wrong__result3 foo__double_tests__negate_wrong__result1))
(assert (and (= o (fp.sub RNE (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) x)) (fp.isFinite64 (fp.sub RNE (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) x))))
(assert (= result foo__double_tests__negate_wrong__result))
(assert (= foo__double_tests__negate_wrong__result1 o))
(assert (= (mk_t__ref foo__double_tests__negate_wrong__result4) (mk_t__ref foo__double_tests__negate_wrong__result2)))
(assert (= foo__double_tests__negate_wrong__result5 foo__double_tests__negate_wrong__result3))
(assert (= result1 foo__double_tests__negate_wrong__result4))
(assert (not (fp.eq foo__double_tests__negate_wrong__result4 (fp.neg x))))
(check-sat)
(exit)
