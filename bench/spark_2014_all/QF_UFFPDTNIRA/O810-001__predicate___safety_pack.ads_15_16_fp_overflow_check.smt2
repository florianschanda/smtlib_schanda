...
(declare-datatypes () ((natural_float__ref (mk_natural_float__ref (natural_float__content natural_float)))))
(define-fun natural_float__ref___projection ((a natural_float__ref)) natural_float (natural_float__content a))
(define-fun dynamic_invariant1 ((temp___expr_1473 Float32) (temp___is_init_1469 Bool) (temp___skip_constant_1470 Bool) (temp___do_toplevel_1471 Bool) (temp___do_typ_inv_1472 Bool)) Bool (=> (or (= temp___is_init_1469 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range1 temp___expr_1473)))
...
(assert (not (and (fp.leq (fp.neg threshold) value) (fp.leq value threshold))))
