...
(assert (not (and (fp.leq (fp.neg (fp #b0 #b00110101 #b00000000000000000000000)) x) (fp.leq x (fp #b0 #b00000000 #b00000000000000000000000)))))
(assert (not (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.leq x (fp #b0 #b00110101 #b00000000000000000000000)))))
(define-fun temp___1562 () Float32 x)
(assert (not (or (or (fp.eq temp___1562 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.leq temp___1562 (fp.neg (fp #b0 #b00110101 #b00000000000000000000000)))) (fp.leq (fp #b0 #b00110101 #b00000000000000000000000) temp___1562))))
(check-sat)
(exit)
