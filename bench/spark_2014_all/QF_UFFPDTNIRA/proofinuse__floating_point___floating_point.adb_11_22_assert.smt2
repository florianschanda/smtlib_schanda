...
(assert (and (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) x) (fp.leq x (fp #b0 #b10001000 #b11110100000000000000000))))
(assert (and (= o (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000))) (fp.isFinite32 (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000)))))
(assert (= result res))
(assert (= res1 o))
(assert (not (fp.leq (fp #b0 #b10000010 #b10000000000000000000000) res1)))
(check-sat)
(exit)
