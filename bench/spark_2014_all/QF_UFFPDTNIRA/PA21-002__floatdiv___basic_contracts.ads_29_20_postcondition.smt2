...
(assert (and (= o (fp.div RNE numerator denominator)) (fp.isFinite32 (fp.div RNE numerator denominator))))
(assert (= result res))
(assert (= res1 o))
(assert (= basic_contracts__average_float__result1 basic_contracts__average_float__result2))
(assert (= basic_contracts__average_float__result3 basic_contracts__average_float__result1))
(assert (= result1 basic_contracts__average_float__result))
(assert (= basic_contracts__average_float__result1 res1))
(assert (= (mk_t__ref basic_contracts__average_float__result4) (mk_t__ref basic_contracts__average_float__result2)))
(assert (= res2 res1))
(assert (= basic_contracts__average_float__result5 basic_contracts__average_float__result3))
(assert (= res3 res1))
(assert (= result2 basic_contracts__average_float__result4))
(assert (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) basic_contracts__average_float__result4)))
(check-sat)
(exit)
