...
(assert (not (fp.lt a (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))))
(assert (not (fp.eq a (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))))
(assert (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) a)))
(check-sat)
(exit)
