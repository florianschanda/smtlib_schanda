...
(assert (= o9 (fp.add RNE o8 (fp #b0 #b10000001 #b01000000000000000000000))))
(assert (and (= o10 o9) (fp.isFinite32 o9)))
(assert (= o11 (ite (fp.leq o10 (fp #b0 #b11111110 #b11111111111111111111111)) true false)))
(assert (not (fp.isFinite32 (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000)))))
(check-sat)
(exit)
