...
(define-fun step_function__min__result9 () t__ref (mk_t__ref step_function__min__result5))
(declare-const result2 Float32)
(assert (fp.isFinite32 x1))
(assert (fp.isFinite32 x2))
(assert (= step_function__min__result9 (mk_t__ref step_function__min__result3)))
(assert (= step_function__min__result6 step_function__min__result4))
(assert (=> (fp.leq x1 x2) (= step_function__min__result1 step_function__min__result3)))
(assert (=> (fp.leq x1 x2) (= step_function__min__result4 step_function__min__result1)))
(assert (=> (fp.leq x1 x2) (= result step_function__min__result)))
(assert (=> (fp.leq x1 x2) (= step_function__min__result1 x1)))
(assert (=> (not (fp.leq x1 x2)) (= step_function__min__result2 step_function__min__result3)))
(assert (=> (not (fp.leq x1 x2)) (= step_function__min__result4 step_function__min__result2)))
(assert (=> (not (fp.leq x1 x2)) (= result1 step_function__min__result)))
(assert (=> (not (fp.leq x1 x2)) (= step_function__min__result2 x2)))
(assert (= (mk_t__ref step_function__min__result7) step_function__min__result9))
...
(assert (not (fp.eq step_function__min__result7 x2)))
(check-sat)
(exit)
