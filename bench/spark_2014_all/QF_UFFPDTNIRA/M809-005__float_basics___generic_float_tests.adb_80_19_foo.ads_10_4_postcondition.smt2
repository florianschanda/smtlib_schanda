...
(assert (= foo__float_tests__underflow_1__result1 foo__float_tests__underflow_1__result2))
(assert (= foo__float_tests__underflow_1__result3 foo__float_tests__underflow_1__result1))
(assert (and (= o (fp.div RNE a b)) (fp.isFinite32 (fp.div RNE a b))))
(assert (= result foo__float_tests__underflow_1__result))
(assert (= foo__float_tests__underflow_1__result1 o))
(assert (= (mk_t__ref foo__float_tests__underflow_1__result4) (mk_t__ref foo__float_tests__underflow_1__result2)))
(assert (= foo__float_tests__underflow_1__result5 foo__float_tests__underflow_1__result3))
(assert (= result1 foo__float_tests__underflow_1__result4))
(assert (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) foo__float_tests__underflow_1__result4)))
(check-sat)
(exit)
