...
(assert (and (= o4 (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000))) (fp.isFinite32 (fp.add RNE x (fp #b0 #b10000000 #b00000000000000000000000)))))
(assert (= o5 (fp.mul RNE o4 x)))
(assert (and (= o6 o5) (fp.isFinite32 o5)))
(assert (= o7 (fp.add RNE o6 (fp #b0 #b10000000 #b10000000000000000000000))))
(assert (and (= o8 o7) (fp.isFinite32 o7)))
(assert (= o9 (fp.add RNE o8 (fp #b0 #b10000001 #b00000000000000000000000))))
(assert (and (= o10 o9) (fp.isFinite32 o9)))
(assert (= o11 (fp.mul RNE o10 x)))
(assert (and (= o12 o11) (fp.isFinite32 o11)))
(assert (= o13 (fp.add RNE o12 (fp #b0 #b10000001 #b01000000000000000000000))))
(assert (and (= o14 o13) (fp.isFinite32 o13)))
(assert (= o15 (ite (fp.leq o14 (fp #b0 #b11111110 #b11111111111111111111111)) true false)))
