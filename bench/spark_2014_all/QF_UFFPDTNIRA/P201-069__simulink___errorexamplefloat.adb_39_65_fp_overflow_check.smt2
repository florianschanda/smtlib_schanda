...
(define-fun dynamic_invariant1 ((temp___expr_158 Float64) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp #b0 #b10000000101 #b1001000000000000000000000000000000000000000000000000))) (in_range temp___expr_158)))
...
(define-fun dynamic_invariant2 ((temp___expr_165 Float64) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (fp.leq (fp #b0 #b01111001011 #b0000000000000000000000000000000000000000000000000000) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111))) (in_range1 temp___expr_165)))
...
(assert (not (fp.eq requested_force (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))))
(assert (and (= o (fp.sub RNE requested_force calculated_force)) (fp.isFinite64 (fp.sub RNE requested_force calculated_force))))
(assert (= o1 (fp.div RNE o requested_force)))
(assert (not (fp.isFinite64 o1)))
(check-sat)
(exit)
