...
(assert (= biggest_representable_int (fp #b0 #b10000110100 #b0000000000000000000000000000000000000000000000000000)))
...
(assert (= (fp #b0 #b10000110100 #b0000000000000000000000000000000000000000000000000000) biggest_representable_int))
...
(assert (and (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) x) (fp.leq x biggest_representable_int)))
(assert (= (mk_t__ref result) (mk_t__ref y)))
(assert (= y1 (fp.roundToIntegral RNA x)))
(assert (= y1 y2))
(assert (= y3 y1))
(assert (not (fp.isFinite64 (fp.add RNE x (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000)))))
(check-sat)
(exit)
