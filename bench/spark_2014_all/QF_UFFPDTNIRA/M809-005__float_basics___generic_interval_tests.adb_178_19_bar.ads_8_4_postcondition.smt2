...
(assert (and (and (and (and (and (and (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) a) (fp.leq a (fp #b0 #b10000001 #b01000000000000000000000))) (and (fp.leq (fp #b0 #b10000001 #b01000000000000000000000) b) (fp.leq b (fp #b0 #b10000010 #b01000000000000000000000)))) (and (fp.leq (fp #b0 #b10000001 #b00000000000000000000000) c) (fp.leq c (fp #b0 #b10000001 #b10000000000000000000000)))) (fp.lt a d)) (fp.lt d b)) (fp.leq c a)) (fp.leq b c)))
(assert (fp.lt a b))
(assert (fp.eq c (fp #b0 #b10000001 #b01000000000000000000000)))
(assert (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) d) (fp.leq d (fp #b0 #b10000010 #b01000000000000000000000))))
(assert (and (= o (fp.add RNE a b)) (fp.isFinite32 (fp.add RNE a b))))
...
(assert (= z1 z2))
(assert (= z3 z1))
(assert (not (fp.lt (fp #b0 #b10000010 #b01000000000000000000000) z2)))
(check-sat)
(exit)
