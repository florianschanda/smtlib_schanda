...
(assert (and (= o (fp.mul RNE x (fp.abs x))) (fp.isFinite64 (fp.mul RNE x (fp.abs x)))))
(assert (= o1 (ite (fp.leq o (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) true false)))
