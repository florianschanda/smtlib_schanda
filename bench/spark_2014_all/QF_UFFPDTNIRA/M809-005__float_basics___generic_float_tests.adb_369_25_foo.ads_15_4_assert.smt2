...
(assert (fp.eq x (fp #b0 #b10000000010 #b1000000000000000000000000000000000000000000000000000)))
(assert (not (fp.eq (fp.roundToIntegral RTN x) (fp #b0 #b10000000010 #b1000000000000000000000000000000000000000000000000000))))
(check-sat)
(exit)
