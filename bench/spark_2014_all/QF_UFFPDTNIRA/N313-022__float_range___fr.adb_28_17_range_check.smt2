...
(define-fun dynamic_invariant1 ((temp___expr_207 Float32) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool (=> (or (= temp___is_init_203 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000000 #b00001100110011001100110))) (in_range2 temp___expr_207)))
...
(assert (= result z))
(assert (= z1 (fp.mul RNE (fp #b0 #b10000000 #b00101010001111010111000) x)))
(assert (not (in_range2 (fp.mul RNE (fp #b0 #b10000000 #b00101011100001010001111) x))))
(check-sat)
(exit)
