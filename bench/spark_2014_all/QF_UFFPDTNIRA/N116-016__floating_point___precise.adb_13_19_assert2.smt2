...
(assert (= result2 z))
(assert (= z1 o))
(assert (and (fp.leq (fp #b0 #b10000010 #b01001100110011001011100) z1) (fp.leq z1 (fp #b0 #b10000010 #b01001100110011001110001))))
(assert (and (= o1 (fp.sub RNE x1 y1)) (fp.isFinite32 (fp.sub RNE x1 y1))))
(assert (= result3 z1))
(assert (= z2 o1))
(assert (and (fp.leq (fp #b0 #b10000010 #b00110011001100110001111) z2) (fp.leq z2 (fp #b0 #b10000010 #b00110011001100110100100))))
(assert (and (= o2 (fp.mul RNE x1 y1)) (fp.isFinite32 (fp.mul RNE x1 y1))))
(assert (= result4 z2))
(assert (= z3 o2))
(assert (and (fp.leq (fp #b0 #b10000000 #b10110011001100101110000) z3) (fp.leq z3 (fp #b0 #b10000001 #b00000000000000000010101))))
(assert (and (= o3 (fp.div RNE x1 y1)) (fp.isFinite32 (fp.div RNE x1 y1))))
(assert (= result5 z3))
(assert (= z4 o3))
(assert (not (fp.leq (fp #b0 #b10000011 #b10001111111111111111011) z4)))
(check-sat)
(exit)
