...
(assert (and (and (fp.leq (fp.neg (fp #b0 #b10111111110 #b0000000000000000000000000000000000000000000000000000)) val1) (fp.leq val1 fl_last_sqrt)) (and (and (fp.leq (fp.neg (fp #b0 #b10111111110 #b0000000000000000000000000000000000000000000000000000)) val2) (fp.leq val2 fl_last_sqrt)) (and (and (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) val3) (fp.leq val3 (fp.neg (fp #b0 #b01000000000 #b0000000000000000000000000000000000000000000000000000)))) (fp.leq val1 val2)))))
(assert (and (= o (fp.div RNE val1 val3)) (fp.isFinite64 (fp.div RNE val1 val3))))
(assert (not (not (fp.isZero val3))))
(check-sat)
(exit)
