...
(assert (and (fp.leq (fp.neg (fp #b0 #b10001011 #b11100111100000000000000)) x) (fp.leq x (fp #b0 #b10001011 #b11100111100000000000000))))
(assert (and (fp.leq (fp.neg (fp #b0 #b10001011 #b11100111100000000000000)) y) (fp.leq y (fp #b0 #b10001011 #b11100111100000000000000))))
...
(assert (= o4 (ite (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o3) true false)))
(assert (= result res))
(assert (= res1 o4))
