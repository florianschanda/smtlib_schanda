...
(assert (= foo__double_tests__inverse_reciprocal__result1 foo__double_tests__inverse_reciprocal__result2))
(assert (= foo__double_tests__inverse_reciprocal__result3 foo__double_tests__inverse_reciprocal__result1))
(assert (and (= o (fp.div RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) a)) (fp.isFinite64 (fp.div RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) a))))
(assert (= o1 (fp.div RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) o)))
...
(assert (= (mk_t__ref foo__double_tests__inverse_reciprocal__result4) (mk_t__ref foo__double_tests__inverse_reciprocal__result2)))
(assert (= foo__double_tests__inverse_reciprocal__result5 foo__double_tests__inverse_reciprocal__result3))
(assert (= result1 foo__double_tests__inverse_reciprocal__result4))
(assert (not (fp.eq foo__double_tests__inverse_reciprocal__result4 a)))
(check-sat)
(exit)
