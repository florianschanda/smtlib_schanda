...
(define-fun dynamic_invariant ((temp___expr_1543 Float32) (temp___is_init_1539 Bool) (temp___skip_constant_1540 Bool) (temp___do_toplevel_1541 Bool) (temp___do_typ_inv_1542 Bool)) Bool (=> (or (= temp___is_init_1539 true) (fp.leq (fp.neg (fp #b0 #b10000011 #b00000000000000000000000)) (fp #b0 #b10000011 #b00000000000000000000000))) (in_range1 temp___expr_1543)))
(declare-const x Float32)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(assert (in_range1 x))
(assert (not (fp.eq x (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (fp.leq (fp.neg (fp #b0 #b00110101 #b00000000000000000000000)) x))
(assert (fp.leq x (fp #b0 #b00000000 #b00000000000000000000000)))
(define-fun temp___1566 () Float32 (fp.neg (fp #b0 #b00110101 #b00000000000000000000000)))
(assert (not (or (or (fp.eq temp___1566 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.leq temp___1566 (fp.neg (fp #b0 #b00110101 #b00000000000000000000000)))) (fp.leq (fp #b0 #b00110101 #b00000000000000000000000) temp___1566))))
(check-sat)
(exit)
