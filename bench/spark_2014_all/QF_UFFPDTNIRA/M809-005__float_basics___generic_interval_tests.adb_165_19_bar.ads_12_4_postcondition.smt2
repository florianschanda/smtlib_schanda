...
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp.isFinite64 z)))
(assert (and (and (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) x) (fp.leq x (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000))) (and (fp.leq (fp #b0 #b10000000001 #b0100000000000000000000000000000000000000000000000000) x) (fp.leq x (fp #b0 #b10000000011 #b0100000000000000000000000000000000000000000000000000)))))
(assert (and (= o (fp.mul RNE x (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000))) (fp.isFinite64 (fp.mul RNE x (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000)))))
(assert (= o1 (fp.sub RNE o (fp #b0 #b10000000001 #b0100000000000000000000000000000000000000000000000000))))
(assert (and (= o2 o1) (fp.isFinite64 o1)))
(assert (= result z))
(assert (= z1 o2))
(assert (= z1 z2))
(assert (= z3 z1))
(assert (not (fp.leq x z2)))
(check-sat)
(exit)
