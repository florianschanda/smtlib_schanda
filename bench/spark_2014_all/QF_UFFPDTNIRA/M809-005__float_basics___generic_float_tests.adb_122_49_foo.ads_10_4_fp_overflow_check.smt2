...
(assert (= foo__float_tests__bad_optimisation_1__result1 foo__float_tests__bad_optimisation_1__result2))
(assert (= foo__float_tests__bad_optimisation_1__result3 foo__float_tests__bad_optimisation_1__result1))
(assert (and (= o (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) b)) (fp.isFinite32 (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) b))))
(assert (= o1 (fp.mul RNE a o)))
(assert (and (= o2 o1) (fp.isFinite32 o1)))
(assert (= (mk_t__ref result) (mk_t__ref foo__float_tests__bad_optimisation_1__result)))
(assert (= foo__float_tests__bad_optimisation_1__result1 o2))
(assert (= (mk_t__ref foo__float_tests__bad_optimisation_1__result4) (mk_t__ref foo__float_tests__bad_optimisation_1__result2)))
(assert (= foo__float_tests__bad_optimisation_1__result5 foo__float_tests__bad_optimisation_1__result3))
