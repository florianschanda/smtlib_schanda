...
(declare-datatypes () ((trealB__ref (mk_trealB__ref (trealB__content trealB)))))
(define-fun trealB__ref___projection ((a trealB__ref)) trealB (trealB__content a))
...
(declare-datatypes () ((real____ref (mk_real____ref (real____content real__)))))
(define-fun real____ref___projection ((a real____ref)) real__ (real____content a))
...
(assert (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) left) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) right)))
...
(assert (not (not (fp.isZero (fp #b0 #b11111110 #b11111111111111111111111)))))
(check-sat)
(exit)
