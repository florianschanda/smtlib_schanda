...
(define-fun dynamic_invariant ((temp___expr_160 Float32) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (or (= temp___is_init_156 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_160)))
...
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 a)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 b)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 c)))
(assert (and (= o (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) x)) (fp.isFinite32 (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) x))))
(assert (= result a))
(assert (= a1 o))
(assert (and (= o1 (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) a1)) (fp.isFinite32 (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) a1))))
(assert (= result1 b))
(assert (= b1 o1))
(assert (and (= o2 (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) b1)) (fp.isFinite32 (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) b1))))
(assert (= result2 c))
(assert (= c1 o2))
(assert (not (fp.eq x b1)))
(check-sat)
(exit)
