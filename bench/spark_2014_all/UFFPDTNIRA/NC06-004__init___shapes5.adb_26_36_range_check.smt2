...
(assert (fp.leq (fp.sub RNE (fp #b0 #b10000000101 #b1001000000000000000000000000000000000000000000000000) y) r3))
(assert (not (in_range3 (fp.sub RNE (fp #b0 #b10000000101 #b1001000000000000000000000000000000000000000000000000) y))))
(check-sat)
(exit)
