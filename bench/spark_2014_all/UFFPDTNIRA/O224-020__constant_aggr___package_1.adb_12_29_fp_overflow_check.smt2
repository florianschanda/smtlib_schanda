...
(assert (and (= o4 (fp.add RNE scalar_const (to_rep (rec__package_1__record_t__a (us_split_fields1 record_const))))) (fp.isFinite32 (fp.add RNE scalar_const (to_rep (rec__package_1__record_t__a (us_split_fields1 record_const)))))))
(assert (= result1 res_2))
(assert (= res_21 o4))
(assert (not (fp.isFinite32 (fp.add RNE scalar_const temp))))
(check-sat)
(exit)
