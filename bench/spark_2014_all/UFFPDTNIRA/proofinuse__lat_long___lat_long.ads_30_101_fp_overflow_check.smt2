...
(assert (and (= o11 (delta_long_in_meters source destination)) (and (fp.isFinite32 o11) (and (= o11 (fp.div RNE (fp.mul RNE (fp.sub RNE (to_rep1 (rec__lat_long__coordinates__long (us_split_fields1 destination))) (to_rep1 (rec__lat_long__coordinates__long (us_split_fields1 source)))) r) (cos1 (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source)))))) (= (olt (fp.abs o11) (fp #b0 #b10011000 #b00110001001111000100110)) true)))))
(assert (and (= o12 (delta_long_in_meters source destination)) (and (fp.isFinite32 o12) (and (= o12 (fp.div RNE (fp.mul RNE (fp.sub RNE (to_rep1 (rec__lat_long__coordinates__long (us_split_fields1 destination))) (to_rep1 (rec__lat_long__coordinates__long (us_split_fields1 source)))) r) (cos1 (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source)))))) (= (olt (fp.abs o12) (fp #b0 #b10011000 #b00110001001111000100110)) true)))))
(assert (= o13 (fp.mul RNE o12 o11)))
(assert (and (= o14 o13) (fp.isFinite32 o13)))
(assert (and (= o8 (delta_lat_in_meters source destination)) (and (fp.isFinite32 o8) (and (= o8 (fp.mul RNE (fp.mul RNE (fp.sub RNE (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 destination))) (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source)))) r) conv_deg_to_rad)) (= (olt (fp.abs o8) (fp #b0 #b10010111 #b00110001001111000100110)) true)))))
(assert (and (= o9 (delta_lat_in_meters source destination)) (and (fp.isFinite32 o9) (and (= o9 (fp.mul RNE (fp.mul RNE (fp.sub RNE (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 destination))) (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source)))) r) conv_deg_to_rad)) (= (olt (fp.abs o9) (fp #b0 #b10010111 #b00110001001111000100110)) true)))))
