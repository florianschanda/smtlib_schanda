...
(assert (not (<= 1 (+ (+ (+ (+ (+ (+ (+ (+ (+ 0 (ite (= (fp.eq x (fp.neg (fp #b0 #b01111111111 #b1001100110011001100110011001100110011001100110011010))) true) 1 0)) (ite (= (fp.eq x (fp.neg (fp #b0 #b01111111111 #b1000000000000000000000000000000000000000000000000000))) true) 1 0)) (ite (= (fp.eq x (fp.neg (fp #b0 #b01111111111 #b0110011001100110011001100110011001100110011001100110))) true) 1 0)) (ite (= (fp.eq x (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) true) 1 0)) (ite (= (fp.eq x (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) true) 1 0)) (ite (= (fp.eq x (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) true) 1 0)) (ite (= (fp.eq x (fp #b0 #b01111111111 #b0110011001100110011001100110011001100110011001100110)) true) 1 0)) (ite (= (fp.eq x (fp #b0 #b01111111111 #b1000000000000000000000000000000000000000000000000000)) true) 1 0)) (ite (= (fp.eq x (fp #b0 #b01111111111 #b1001100110011001100110011001100110011001100110011010)) true) 1 0)))))
(check-sat)
(exit)
