...
(define-fun us_split_fields_C2__projection ((a us_split_fields)) float (rec__pred__r__c2 a))
...
(define-fun dynamic_invariant1 ((temp___expr_180 us_rep) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (= temp___do_toplevel_178 true) (=> (= temp___is_init_176 true) (and (= (prop__ (to_rep1 (rec__pred__r__d (us_split_discrs1 temp___expr_180)))) true) (ite (= (to_rep1 (rec__pred__r__d (us_split_discrs1 temp___expr_180))) 1) (not (= (to_rep (rec__pred__r__c1 (us_split_fields1 temp___expr_180))) 0)) (ite (= (to_rep1 (rec__pred__r__d (us_split_discrs1 temp___expr_180))) 2) (not (fp.eq (to_rep2 (rec__pred__r__c2 (us_split_fields1 temp___expr_180))) (fp #b0 #b00000000 #b00000000000000000000000))) (not (= (rec__pred__r__c3 (us_split_fields1 temp___expr_180)) (distinct 0 0)))))))))
(define-fun dynamic_predicate ((temp___183 us_rep)) Bool (and (= (prop__ (to_rep1 (rec__pred__r__d (us_split_discrs1 temp___183)))) true) (ite (= (to_rep1 (rec__pred__r__d (us_split_discrs1 temp___183))) 1) (not (= (to_rep (rec__pred__r__c1 (us_split_fields1 temp___183))) 0)) (ite (= (to_rep1 (rec__pred__r__d (us_split_discrs1 temp___183))) 2) (not (fp.eq (to_rep2 (rec__pred__r__c2 (us_split_fields1 temp___183))) (fp #b0 #b00000000 #b00000000000000000000000))) (not (= (rec__pred__r__c3 (us_split_fields1 temp___183)) (distinct 0 0)))))))
