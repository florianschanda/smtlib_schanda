...
(assert (and (= us1 y) (dynamic_property1 (fp #b0 #b01111111 #b00000000000000000000000) last1 y)))
(assert (= o2 y))
(assert (= o2 test_dynamic_property__dyn_param__x))
(assert (dynamic_property1 (fp #b0 #b01111111 #b00000000000000000000000) last1 test_dynamic_property__dyn_param__x1))
(assert (and (= us2 test_dynamic_property__dyn_param__x1) (dynamic_property (fp #b0 #b00000000 #b00000000000000000000000) last test_dynamic_property__dyn_param__x1)))
(assert (= o3 test_dynamic_property__dyn_param__x1))
(assert (= (mk_t__ref result2) (mk_t__ref y)))
(assert (= y1 o3))
(assert (not (fp.leq y1 c)))
(check-sat)
(exit)
