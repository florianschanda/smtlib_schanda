...
(define-fun dynamic_invariant1 ((temp___expr_189 Float32) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (or (= temp___is_init_185 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_189)))
...
(define-fun dynamic_invariant3 ((temp___expr_60 Float32) (temp___is_init_56 Bool) (temp___skip_constant_57 Bool) (temp___do_toplevel_58 Bool) (temp___do_typ_inv_59 Bool)) Bool (=> (or (= temp___is_init_56 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_60)))
(assert (= minimum_valid_speed (fp #b0 #b01111011 #b10011001100110011001101)))
(assert (= maximum_valid_speed (m_per_s_from_km_per_h maximum_valid_speed_km_per_h)))
(assert (= minimum_valid_acceleration (fp.neg (fp #b0 #b10000010 #b01000000000000000000000))))
...
(assert (= (fp #b0 #b01111011 #b10011001100110011001101) minimum_valid_speed))
...
(assert (= (fp.neg (fp #b0 #b10000010 #b01000000000000000000000)) minimum_valid_acceleration))
(assert (fp.isFinite32 initial_speed))
(assert (fp.isFinite32 final_speed))
(assert (fp.isFinite32 acceleration))
(assert (and (and (and (and (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) initial_speed) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) final_speed)) (fp.leq initial_speed maximum_valid_speed)) (fp.lt final_speed initial_speed)) (fp.lt acceleration (fp #b0 #b00000000 #b00000000000000000000000))) (fp.leq minimum_valid_acceleration acceleration)))
(assert (= result speed))
...
(assert (and (fp.leq minimum_valid_acceleration acceleration) (fp.lt acceleration (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (and (fp.lt minimum_valid_speed speed2) (fp.leq speed2 initial_speed)))
(assert (and (and (and (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 delta_speed1)) (=> (<= 0 2147483647) (in_range2 distance2))) (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 speed2))) (and (fp.lt final_speed speed2) (fp.lt minimum_valid_speed speed2))))
(assert (and (= o (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) speed2)) (fp.isFinite32 (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) speed2))))
(assert (= o1 (ite (fp.lt o (fp #b0 #b10000010 #b01000000000000000000000)) true false)))
(assert (not (fp.isFinite32 (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) speed2))))
(check-sat)
(exit)
