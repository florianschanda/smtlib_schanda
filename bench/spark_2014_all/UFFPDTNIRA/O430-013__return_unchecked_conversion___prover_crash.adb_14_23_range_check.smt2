...
(assert (forall ((i source)) (and (<= 0 (sourceqtint i)) (<= (sourceqtint i) 4294967295))))
...
(define-fun dynamic_invariant ((temp___expr_172 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 0 4294967295)) (in_range temp___expr_172)))
...
(assert (forall ((s Int)) (! (=> (dynamic_invariant s true true true true) (dynamic_invariant1 (conv s) true false true true)) :pattern ((conv s)))))
(declare-sort myint 0)
(declare-fun myintqtint (myint) Int)
(assert (forall ((i myint)) (and (<= 0 (myintqtint i)) (<= (myintqtint i) 4294967295))))
...
(define-fun dynamic_invariant2 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 0 4294967295)) (in_range1 temp___expr_158)))
(declare-const x Int)
