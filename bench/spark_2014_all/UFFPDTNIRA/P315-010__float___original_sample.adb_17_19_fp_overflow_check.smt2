...
(assert (= t_fp1 o))
(assert (and (= o1 (fp.add RNE t_fp1 (fp.mul RNE (of_int RNE nb_of_fp) delta_time))) (fp.isFinite32 (fp.add RNE t_fp1 (fp.mul RNE (of_int RNE nb_of_fp) delta_time)))))
(assert (= (mk_t__ref result2) (mk_t__ref t_pp)))
(assert (= t_pp1 o1))
(assert (not (fp.isFinite32 (fp.add RNE t_pp1 (fp.mul RNE (fp.mul RNE (fp #b0 #b01111110 #b00000000000000000000000) (of_int RNE nb_of_fp)) delta_time)))))
(check-sat)
(exit)
