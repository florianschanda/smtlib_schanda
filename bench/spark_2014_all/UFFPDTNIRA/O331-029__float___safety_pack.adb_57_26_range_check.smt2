...
(define-fun dynamic_invariant1 ((temp___expr_1466 Int) (temp___is_init_1462 Bool) (temp___skip_constant_1463 Bool) (temp___do_toplevel_1464 Bool) (temp___do_typ_inv_1465 Bool)) Bool (=> (or (= temp___is_init_1462 true) (<= (- 32768) 32767)) (in_range temp___expr_1466)))
