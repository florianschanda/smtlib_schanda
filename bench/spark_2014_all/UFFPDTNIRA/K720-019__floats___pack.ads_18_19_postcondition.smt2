...
(assert (= pack__associativity_test__result1 pack__associativity_test__result2))
(assert (= pack__associativity_test__result3 pack__associativity_test__result1))
(assert (and (= o1 (add (fp #b0 #b01111100 #b10011001100110011001101) (fp #b0 #b01111101 #b00110011001100110011010))) (and (fp.isFinite32 o1) (fp.eq o1 (fp.add RNE (fp #b0 #b01111100 #b10011001100110011001101) (fp #b0 #b01111101 #b00110011001100110011010))))))
(assert (and (= o2 (add (fp #b0 #b01111011 #b10011001100110011001101) o1)) (and (fp.isFinite32 o2) (fp.eq o2 (fp.add RNE (fp #b0 #b01111011 #b10011001100110011001101) o1)))))
(assert (and (= o (add (fp #b0 #b01111011 #b10011001100110011001101) (fp #b0 #b01111100 #b10011001100110011001101))) (and (fp.isFinite32 o) (fp.eq o (fp.add RNE (fp #b0 #b01111011 #b10011001100110011001101) (fp #b0 #b01111100 #b10011001100110011001101))))))
(assert (and (= o3 (add o (fp #b0 #b01111101 #b00110011001100110011010))) (and (fp.isFinite32 o3) (fp.eq o3 (fp.add RNE o (fp #b0 #b01111101 #b00110011001100110011010))))))
...
(assert (= (mk_bool__ref pack__associativity_test__result4) (mk_bool__ref pack__associativity_test__result2)))
(assert (= pack__associativity_test__result5 pack__associativity_test__result3))
(assert (= result1 pack__associativity_test__result4))
(assert (not (= pack__associativity_test__result4 true)))
(check-sat)
(exit)
