...
(assert (in_range1 c))
(assert (= d c))
(assert (dynamic_property (fp #b0 #b00000000 #b00000000000000000000000) last x))
(assert (and (= o (fp.add RNE x (fp #b0 #b01111111 #b00000000000000000000000))) (fp.isFinite32 (fp.add RNE x (fp #b0 #b01111111 #b00000000000000000000000)))))
(assert (= result (ite (fp.leq o c) true false)))
(assert (= result true))
(assert (and (= temp___177 (fp.add RNE x (fp #b0 #b01111111 #b00000000000000000000000))) (fp.isFinite32 (fp.add RNE x (fp #b0 #b01111111 #b00000000000000000000000)))))
(assert (not (dynamic_property (fp #b0 #b00000000 #b00000000000000000000000) last temp___177)))
(check-sat)
(exit)
