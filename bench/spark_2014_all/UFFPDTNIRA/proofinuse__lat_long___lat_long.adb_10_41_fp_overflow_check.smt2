...
(assert (forall ((x Float32)) (! (=> (dynamic_invariant x true true true true) (dynamic_invariant (sqrt2 x) true false true true)) :pattern ((sqrt2 x)))))
(assert (forall ((x Float32)) (! (=> (dynamic_invariant x true true true true) (= (sqrt2 x) (fp.sqrt RNE x))) :pattern ((sqrt2 x)))))
...
(define-fun us_split_fields_Lat__projection ((a us_split_fields)) latitude (rec__lat_long__coordinates__lat a))
(define-fun us_split_fields_Long__projection ((a us_split_fields)) longitude (rec__lat_long__coordinates__long a))
...
(assert (forall ((source us_rep) (destination us_rep)) (! (let ((result (delta_lat_in_meters source destination))) (and (= (olt (fp.abs result) (fp #b0 #b10010111 #b00110001001111000100110)) true) (dynamic_invariant result true false true true))) :pattern ((delta_lat_in_meters source destination)))))
(assert (forall ((source us_rep) (destination us_rep)) (! (= (delta_lat_in_meters source destination) (fp.mul RNE (fp.mul RNE (fp.sub RNE (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 destination))) (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source)))) r) conv_deg_to_rad)) :pattern ((delta_lat_in_meters source destination)))))
...
(assert (forall ((source us_rep) (destination us_rep)) (! (let ((result (delta_long_in_meters source destination))) (and (= (olt (fp.abs result) (fp #b0 #b10011000 #b00110001001111000100110)) true) (dynamic_invariant result true false true true))) :pattern ((delta_long_in_meters source destination)))))
(assert (forall ((source us_rep) (destination us_rep)) (! (= (delta_long_in_meters source destination) (fp.div RNE (fp.mul RNE (fp.sub RNE (to_rep1 (rec__lat_long__coordinates__long (us_split_fields1 destination))) (to_rep1 (rec__lat_long__coordinates__long (us_split_fields1 source)))) r) (cos1 (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source)))))) :pattern ((delta_long_in_meters source destination)))))
...
(assert (= delta_lat1 (fp.mul RNE (fp.mul RNE (fp.sub RNE (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 destination))) (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source)))) r) conv_deg_to_rad)))
...
(assert (= o1 (fp.div RNE (fp.mul RNE (fp.sub RNE (to_rep1 (rec__lat_long__coordinates__long (us_split_fields1 destination))) (to_rep1 (rec__lat_long__coordinates__long (us_split_fields1 source)))) r) o)))
