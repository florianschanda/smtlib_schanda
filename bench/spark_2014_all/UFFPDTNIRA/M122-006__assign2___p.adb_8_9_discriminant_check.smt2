...
(define-fun us_split_fields_Y__projection ((a us_split_fields)) float (rec__types__r__y a))
...
(define-fun types__r__x__pred ((a us_rep)) Bool (= (to_rep (rec__types__r__i (us_split_discrs1 a))) 0))
(define-fun types__r__y__pred ((a us_rep)) Bool (= (to_rep (rec__types__r__i (us_split_discrs1 a))) 1))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__types__r__i (us_split_discrs1 a))) (to_rep (rec__types__r__i (us_split_discrs1 b)))) (and (=> (types__r__x__pred a) (= (to_rep1 (rec__types__r__x (us_split_fields1 a))) (to_rep1 (rec__types__r__x (us_split_fields1 b))))) (=> (types__r__y__pred a) (= (to_rep2 (rec__types__r__y (us_split_fields1 a))) (to_rep2 (rec__types__r__y (us_split_fields1 b))))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_167 us_rep) (temp___skip_top_level_168 Bool)) Bool (and (= (attr__constrained temp___expr_167) false) (= (to_rep (rec__types__r__i (us_split_discrs1 temp___expr_167))) 0)))
(define-fun in_range2 ((rec__types__r__i1 Int) (a us_rep)) Bool (= rec__types__r__i1 (to_rep (rec__types__r__i (us_split_discrs1 a)))))
...
(define-fun in_range3 ((rec__types__r__i1 Int) (a us_rep)) Bool (= rec__types__r__i1 (to_rep (rec__types__r__i (us_split_discrs1 a)))))
