...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__interval__interval__low float) (rec__interval__interval__high float)))))
(define-fun us_split_fields_Low__projection ((a us_split_fields)) float (rec__interval__interval__low a))
(define-fun us_split_fields_High__projection ((a us_split_fields)) float (rec__interval__interval__high a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__interval__interval__low (us_split_fields1 a))) (to_rep (rec__interval__interval__low (us_split_fields1 b)))) (= (to_rep (rec__interval__interval__high (us_split_fields1 a))) (to_rep (rec__interval__interval__high (us_split_fields1 b))))) true false))
...
(assert (< interval__interval__low__first__bit interval__interval__low__last__bit))
...
(assert (< interval__interval__high__first__bit interval__interval__high__last__bit))
...
(define-fun default_initial_assumption ((temp___expr_159 us_rep) (temp___skip_top_level_160 Bool)) Bool (and (= (to_rep (rec__interval__interval__low (us_split_fields1 temp___expr_159))) (fp #b0 #b00000000 #b00000000000000000000000)) (= (to_rep (rec__interval__interval__high (us_split_fields1 temp___expr_159))) (fp #b0 #b00000000 #b00000000000000000000000))))
(define-fun type_invariant ((temp___161 us_rep)) Bool (= (has_valid_order temp___161) true))
(declare-const low Float32)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const high Float32)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(assert true)
(assert (forall ((int__ us_rep)) (! (= (= (has_valid_order int__) true) (fp.leq (to_rep (rec__interval__interval__low (us_split_fields1 int__))) (to_rep (rec__interval__interval__high (us_split_fields1 int__))))) :pattern ((has_valid_order int__)))))
(declare-const interval__make__result float)
(declare-const interval__make__result1 float)
...
(declare-const interval__make__result2 float)
(declare-const interval__make__result3 float)
(declare-const result2 float)
(declare-const result3 float)
(declare-const interval__make__result4 float)
(declare-const interval__make__result5 float)
(declare-const interval__make__result6 float)
(declare-const interval__make__result7 float)
(declare-const interval__make__result8 us_rep)
(declare-const interval__make__result9 interval__ref)
(declare-const interval__make__result10 us_rep)
(declare-const interval__make__result11 interval__ref)
(declare-const interval__make__result12 us_rep)
(define-fun interval__make__result13 () us_rep (mk___rep (mk___split_fields interval__make__result4 interval__make__result5)))
(define-fun interval__make__result14 () us_rep (mk___rep (mk___split_fields interval__make__result2 interval__make__result3)))
(assert (fp.isFinite32 low))
(assert (fp.isFinite32 high))
(assert (= interval__make__result9 (mk_interval__ref (mk___rep (mk___split_fields interval__make__result6 interval__make__result7)))))
(assert (= interval__make__result10 interval__make__result8))
(assert (=> (fp.leq low high) (= interval__make__result6 interval__make__result2)))
(assert (=> (fp.leq low high) (= interval__make__result7 interval__make__result3)))
(assert (=> (fp.leq low high) (= interval__make__result8 interval__make__result14)))
...
(assert (=> (fp.leq low high) (= interval__make__result14 (mk___rep (mk___split_fields o4 o5)))))
(assert (=> (not (fp.leq low high)) (= interval__make__result6 interval__make__result4)))
(assert (=> (not (fp.leq low high)) (= interval__make__result7 interval__make__result5)))
(assert (=> (not (fp.leq low high)) (= interval__make__result8 interval__make__result13)))
...
(assert (=> (not (fp.leq low high)) (= interval__make__result13 (mk___rep (mk___split_fields o10 o11)))))
(assert (= interval__make__result11 interval__make__result9))
(assert (= interval__make__result12 interval__make__result10))
(assert (not (= (has_valid_order (interval__content interval__make__result11)) true)))
(check-sat)
(exit)
