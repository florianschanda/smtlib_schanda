...
(assert (and (= o1 (pow8 x)) (and (fp.isFinite32 o1) (= o1 (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE x x) x) x) x) x) x) x)))))
(assert (= o2 (fp.div RNE o1 (fp #b0 #b10001110 #b00111011000000000000000))))
(assert (and (= o (pow6 x)) (and (fp.isFinite32 o) (= o (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE x x) x) x) x) x)))))
(assert (not (not (fp.isZero (fp #b0 #b10001000 #b01101000000000000000000)))))
(check-sat)
(exit)
