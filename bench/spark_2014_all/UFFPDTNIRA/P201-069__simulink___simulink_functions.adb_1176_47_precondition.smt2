...
(declare-fun arctanh__function_guard (Float32 Float32) Bool)
(assert (forall ((x Float32)) (! (=> (and (dynamic_invariant x true true true true) (fp.lt (fp.abs x) (fp #b0 #b01111111 #b00000000000000000000000))) (let ((result (arctanh x))) (and (=> (fp.eq x (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq result (fp #b0 #b00000000 #b00000000000000000000000))) (dynamic_invariant result true false true true)))) :pattern ((arctanh x)))))
(declare-const f Float32)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(assert (fp.isFinite32 f))
(assert (not (fp.lt (fp.abs f) (fp #b0 #b01111111 #b00000000000000000000000))))
(check-sat)
(exit)
