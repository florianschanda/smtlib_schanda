...
(assert (and (= o (fp.div RNE acceleration speed2)) (fp.isFinite32 (fp.div RNE acceleration speed2))))
(assert (= o1 (fp.mul RNE o (fp #b0 #b10000001 #b01000000000000000000000))))
