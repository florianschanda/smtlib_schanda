...
(assert (and (= (to_rep temp___163) (fp #b0 #b00000000 #b00000000000000000000000)) (= (to_rep temp___1631) (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (not (= (has_valid_order (mk___rep (mk___split_fields temp___163 temp___1631))) true)))
(check-sat)
(exit)
