...
(assert (= (mk___rep1 (mk___split_discrs usq_) (mk___split_fields1 usq_1 usq_2 usq_3 usq_4 usq_5 usq_6 usq_7) usq_8) (mk___rep1 (mk___split_discrs temp___256) (mk___split_fields1 temp___2561 temp___2562 temp___2563 temp___2564 temp___2565 temp___2566 temp___2567) temp___2568)))
...
(assert (= v__split_fields21 (mk___split_fields1 v__split_fields7 v__split_fields8 v__split_fields9 v__split_fields10 v__split_fields11 v__split_fields12 v__split_fields13)))
(assert (not (= (is_zero__3 (mk___rep1 v__split_discrs (mk___split_fields1 v__split_fields14 v__split_fields15 v__split_fields16 v__split_fields17 v__split_fields18 v__split_fields19 v__split_fields20) v__attr__tag)) true)))
(check-sat)
(exit)
