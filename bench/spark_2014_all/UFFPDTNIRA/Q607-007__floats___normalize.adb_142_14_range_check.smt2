...
(assert (in_range1 x))
(assert (and (= o (r4 (fp.div RNE x (fp #b0 #b10000111 #b01101000000000000000000)))) (and (in_range o) (and (= o (fp.roundToIntegral RTN (fp.div RNE x (fp #b0 #b10000111 #b01101000000000000000000)))) (fp.eq o (fp.roundToIntegral RTN (fp.div RNE x (fp #b0 #b10000111 #b01101000000000000000000))))))))
