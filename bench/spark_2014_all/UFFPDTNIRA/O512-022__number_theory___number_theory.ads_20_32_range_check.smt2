...
(assert (and (= o1 (fib o)) (and (in_range2 o1) (and (= o1 (ite (or (= o 0) (= o 1)) o (+ (fib (- o 1)) (fib (- o 2))))) (fp.lt (of_int RNE o1) (fp.add RNE (fp.div RNE (power (fp #b0 #b01111111 #b10011110001110111100111) o) (fp #b0 #b10000000 #b00011110001101010100000)) (fp #b0 #b01111111 #b00000000000000000000000)))))))
(assert (not (in_range3 (- n 1))))
(check-sat)
(exit)
