...
(assert (and (= o8 (delta_long_in_meters source destination)) (and (fp.isFinite32 o8) (and (= o8 (fp.div RNE (fp.mul RNE (fp.sub RNE (to_rep1 (rec__lat_long__coordinates__long (us_split_fields1 destination))) (to_rep1 (rec__lat_long__coordinates__long (us_split_fields1 source)))) r) (cos1 (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source)))))) (= (olt (fp.abs o8) (fp #b0 #b10011000 #b00110001001111000100110)) true)))))
(assert (and (= o9 (delta_long_in_meters source destination)) (and (fp.isFinite32 o9) (and (= o9 (fp.div RNE (fp.mul RNE (fp.sub RNE (to_rep1 (rec__lat_long__coordinates__long (us_split_fields1 destination))) (to_rep1 (rec__lat_long__coordinates__long (us_split_fields1 source)))) r) (cos1 (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source)))))) (= (olt (fp.abs o9) (fp #b0 #b10011000 #b00110001001111000100110)) true)))))
