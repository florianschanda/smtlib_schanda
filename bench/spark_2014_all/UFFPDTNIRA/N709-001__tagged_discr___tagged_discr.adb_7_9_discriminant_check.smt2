...
(define-fun us_split_fields_YY__projection ((a us_split_fields4)) float (rec__tagged_discr__u2__yy a))
...
(define-fun us_split_fields_Y__3__projection ((a us_split_fields4)) float (rec__tagged_discr__t__y2 a))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs3 a))) (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs3 b)))) (and (and (and (and (and (= (to_rep (rec__tagged_discr__u2__w (us_split_fields5 a))) (to_rep (rec__tagged_discr__u2__w (us_split_fields5 b)))) (= (to_rep (rec__tagged_discr__u2__xx (us_split_fields5 a))) (to_rep (rec__tagged_discr__u2__xx (us_split_fields5 b))))) (= (to_rep1 (rec__tagged_discr__u2__yy (us_split_fields5 a))) (to_rep1 (rec__tagged_discr__u2__yy (us_split_fields5 b))))) (= (rec__tagged_discr__t__z2 (us_split_fields5 a)) (rec__tagged_discr__t__z2 (us_split_fields5 b)))) (=> (tagged_discr__t__x__pred2 a) (= (to_rep (rec__tagged_discr__t__x2 (us_split_fields5 a))) (to_rep (rec__tagged_discr__t__x2 (us_split_fields5 b)))))) (=> (tagged_discr__t__y__pred2 a) (= (to_rep1 (rec__tagged_discr__t__y2 (us_split_fields5 a))) (to_rep1 (rec__tagged_discr__t__y2 (us_split_fields5 b))))))) true false))
...
(assert (forall ((v us_rep)) (! (= (ite (is_zero__2 (of_base v)) 1 0) (ite (is_zero1 us_tag1 v) 1 0)) :pattern ((is_zero1 us_tag1 v)))))
(assert (forall ((v us_rep)) (! (= (ite (is_zero__3 (of_base1 v)) 1 0) (ite (is_zero1 us_tag2 v) 1 0)) :pattern ((is_zero1 us_tag2 v)))))
(assert (forall ((v us_rep)) (! (= (ite (is_zero v) 1 0) (ite (is_zero1 us_tag3 v) 1 0)) :pattern ((is_zero1 us_tag3 v)))))
(assert (forall ((v us_rep)) (! (= (ite (is_zero v) 1 0) (ite (is_zero1 us_tag4 v) 1 0)) :pattern ((is_zero1 us_tag4 v)))))
(assert (forall ((v us_rep)) (! (= (ite (is_zero__2 (of_base v)) 1 0) (ite (is_zero1 us_tag5 v) 1 0)) :pattern ((is_zero1 us_tag5 v)))))
(assert (forall ((v us_rep)) (! (= (ite (is_zero v) 1 0) (ite (is_zero1 us_tag6 v) 1 0)) :pattern ((is_zero1 us_tag6 v)))))
(assert (forall ((v us_rep)) (! (= (ite (is_zero__3 (of_base1 v)) 1 0) (ite (is_zero1 us_tag7 v) 1 0)) :pattern ((is_zero1 us_tag7 v)))))
(assert (forall ((v us_rep)) (! (= (= (is_zero v) true) (and (not (= (rec__tagged_discr__t__z (us_split_fields1 v)) true)) (ite (or (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs1 v))) 0) (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs1 v))) 2)) (= (to_rep (rec__tagged_discr__t__x (us_split_fields1 v))) 0) (fp.eq (to_rep1 (rec__tagged_discr__t__y (us_split_fields1 v))) (fp #b0 #b00000000 #b00000000000000000000000))))) :pattern ((is_zero v)))))
...
(assert (forall ((v us_rep1)) (! (= (ite (is_zero__2 v) 1 0) (ite (is_zero__21 us_tag5 v) 1 0)) :pattern ((is_zero__21 us_tag5 v)))))
...
(assert true)
(assert true)
(assert (forall ((v us_rep2)) (! (= (ite (is_zero__3 v) 1 0) (ite (is_zero__31 us_tag2 v) 1 0)) :pattern ((is_zero__31 us_tag2 v)))))
(assert (forall ((v us_rep2)) (! (= (ite (is_zero__3 v) 1 0) (ite (is_zero__31 us_tag7 v) 1 0)) :pattern ((is_zero__31 us_tag7 v)))))
(assert (forall ((v us_rep2)) (! (= (= (is_zero__3 v) true) (and (and (and (= (is_zero (to_base1 v)) true) (= (to_rep (rec__tagged_discr__u2__w (us_split_fields5 v))) 0)) (= (to_rep (rec__tagged_discr__u2__xx (us_split_fields5 v))) 0)) (fp.eq (to_rep1 (rec__tagged_discr__u2__yy (us_split_fields5 v))) (fp #b0 #b00000000 #b00000000000000000000000)))) :pattern ((is_zero__3 v)))))
...
(assert (= (distinct 0 0) temp___2261))
(assert (= rliteral temp___2262))
(assert (= dummy1 temp___2263))
(assert (= us_null_ext__ temp___2264))
(assert (= us_tag3 temp___2265))
(assert (not (= temp___226 (rec__tagged_discr__t__discr v__split_discrs))))
(check-sat)
(exit)
