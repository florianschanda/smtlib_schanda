...
(assert (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) measured)))
(assert (not (fp.isFinite32 (fp.add RNE (fp #b0 #b11111110 #b11111111111111111111111) measured))))
(check-sat)
(exit)
