...
(assert (and (= o7 (pow7 x)) (and (fp.isFinite32 o7) (= o7 (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE x x) x) x) x) x) x)))))
(assert (= o8 (fp.div RNE o7 (fp #b0 #b10001011 #b00111011000000000000000))))
(assert (and (= o3 (pow5 x)) (and (fp.isFinite32 o3) (= o3 (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE x x) x) x) x)))))
(assert (= o4 (fp.div RNE o3 (fp #b0 #b10000101 #b11100000000000000000000))))
(assert (and (= o (pow3 x)) (and (fp.isFinite32 o) (= o (fp.mul RNE (fp.mul RNE x x) x)))))
(assert (= o1 (fp.div RNE o (fp #b0 #b10000001 #b10000000000000000000000))))
