...
(assert true)
(assert (forall ((n Int)) (forall ((speed Float64) (distance Float64)) (! (= (= (invariant__ n speed distance) true) (and (and (fp.leq (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) speed) (fp.leq speed (fp.mul RNE (of_int RNE n) max_speed_variance))) (and (fp.leq (fp.mul RNE (fp.mul RNE (fp.mul RNE (of_int RNE n) (of_int RNE (+ n 1))) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000)) distance) (fp.leq distance (fp.mul RNE (fp.mul RNE (fp.mul RNE (of_int RNE n) (of_int RNE (+ n 1))) max_speed_variance) (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000)))))) :pattern ((invariant__ n speed distance))))))
...
(assert (= max_speed_variance (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))
...
(assert (= average1 o2))
(assert (and (= o3 (fp.add RNE distance (fp.mul RNE average1 (fp #b0 #b01111111000 #b0100011110101110000101000111101011100001010001111011)))) (fp.isFinite64 (fp.add RNE distance (fp.mul RNE average1 (fp #b0 #b01111111000 #b0100011110101110000101000111101011100001010001111011))))))
