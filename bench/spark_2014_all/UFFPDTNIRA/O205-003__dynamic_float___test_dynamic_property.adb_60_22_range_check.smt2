...
(define-fun dynamic_invariant1 ((temp___expr_172 Float32) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) last)) (dynamic_property (fp #b0 #b00000000 #b00000000000000000000000) last temp___expr_172)))
(assert (= last c))
...
(define-fun dynamic_invariant2 ((temp___expr_165 Float32) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) last1)) (dynamic_property1 (fp #b0 #b01111111 #b00000000000000000000000) last1 temp___expr_165)))
(assert (= last1 c))
...
(define-fun dynamic_invariant3 ((temp___expr_158 Float32) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) (fp #b0 #b10000101 #b10010000000000000000000))) (in_range1 temp___expr_158)))
...
(assert (in_range1 c))
(assert (and (= us c) (dynamic_property1 (fp #b0 #b01111111 #b00000000000000000000000) last1 c)))
(assert (= o c))
(assert (= result x))
(assert (= x1 o))
(assert (dynamic_property1 (fp #b0 #b01111111 #b00000000000000000000000) last1 x1))
(assert (dynamic_property (fp #b0 #b00000000 #b00000000000000000000000) last y))
(assert (and (= o1 (dyn_return (fp #b0 #b10000011 #b11100000000000000000000))) (dynamic_property1 (fp #b0 #b01111111 #b00000000000000000000000) last1 o1)))
(assert (= result1 x1))
(assert (= x2 o1))
(assert (fp.leq x2 c))
(assert (fp.leq (dyn_return (fp #b0 #b10000100 #b01000000000000000000000)) c))
(assert (dynamic_property1 (fp #b0 #b01111111 #b00000000000000000000000) last1 x3))
(assert (fp.leq x3 c))
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (and (= us1 y) (dynamic_property1 (fp #b0 #b01111111 #b00000000000000000000000) last1 y))))
...
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (dynamic_property1 (fp #b0 #b01111111 #b00000000000000000000000) last1 test_dynamic_property__dyn_param__x1)))
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (and (= us2 test_dynamic_property__dyn_param__x1) (dynamic_property (fp #b0 #b00000000 #b00000000000000000000000) last test_dynamic_property__dyn_param__x1))))
...
(assert (and (= us3 x3) (dynamic_property (fp #b0 #b00000000 #b00000000000000000000000) last x3)))
(assert (= o4 x3))
(assert (= o4 test_dynamic_property__nested__dyn_param__x))
(assert (and (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) test_dynamic_property__nested__dyn_param__x1) (dynamic_property (fp #b0 #b00000000 #b00000000000000000000000) last test_dynamic_property__nested__dyn_param__x1)))
(assert (not (dynamic_property1 (fp #b0 #b01111111 #b00000000000000000000000) last1 test_dynamic_property__nested__dyn_param__x1)))
(check-sat)
(exit)
