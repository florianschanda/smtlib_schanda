...
(assert (not (= (bool_eq4 position no_element) true)))
(assert (and (= o (positions container)) (and (not (= (has_key o no_element) true)) (forall ((i us_rep4)) (=> (= (has_key o i) true) (and (and (<= 1 (get1 o i)) (<= (get1 o i) (length container))) (forall ((j us_rep4)) (=> (= (has_key o j) true) (=> (= (get1 o i) (get1 o j)) (= (bool_eq4 i j) true))))))))))
