...
(assert (forall ((left Float64) (right Float64)) (! (=> (and (dynamic_invariant1 left true true true true) (dynamic_invariant1 right true true true true)) (dynamic_invariant1 (atan2__2 left right) true false true true)) :pattern ((atan2__2 left right)))))
