...
(assert (and (= o7 (sqrt2 o6)) (and (fp.isFinite32 o7) (= o7 (fp.sqrt RNE o6)))))
...
(assert (not (fp.eq lat_long__distance__result4 (sqrt2 (fp.add RNE (fp.mul RNE (delta_lat_in_meters source destination) (delta_lat_in_meters source destination)) (fp.mul RNE (delta_long_in_meters source destination) (delta_long_in_meters source destination)))))))
(check-sat)
(exit)
