...
(assert (and (= o3 (pow7 x)) (and (fp.isFinite32 o3) (= o3 (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE x x) x) x) x) x) x)))))
(assert (= o4 (fp.div RNE o3 (fp #b0 #b10001011 #b00111011000000000000000))))
(assert (and (= o1 (pow5 x)) (and (fp.isFinite32 o1) (= o1 (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE x x) x) x) x)))))
(assert (= o2 (fp.div RNE o1 (fp #b0 #b10000101 #b11100000000000000000000))))
(assert (and (= o (pow3 x)) (and (fp.isFinite32 o) (= o (fp.mul RNE (fp.mul RNE x x) x)))))
(assert (not (not (fp.isZero (fp #b0 #b10000001 #b10000000000000000000000)))))
(check-sat)
(exit)
