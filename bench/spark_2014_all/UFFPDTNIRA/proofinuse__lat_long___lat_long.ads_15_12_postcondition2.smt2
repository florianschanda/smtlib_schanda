...
(assert (= (mk_t__ref lat_long__cos__result4) (mk_t__ref lat_long__cos__result2)))
(assert (= lat_long__cos__result5 lat_long__cos__result3))
(assert (= result1 lat_long__cos__result4))
(assert (fp.leq (fp.neg (fp #b0 #b10000101 #b00101100000000000000000)) x))
(assert (fp.leq x (fp #b0 #b10000101 #b00101100000000000000000)))
(assert (not (fp.leq (fp #b0 #b01111011 #b10011001100110011001101) lat_long__cos__result4)))
(check-sat)
(exit)
