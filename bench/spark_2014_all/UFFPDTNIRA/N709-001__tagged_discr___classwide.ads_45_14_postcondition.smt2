...
(declare-const temp___2301 integer)
(declare-const temp___2302 float)
(declare-const temp___2303 us_private)
...
(assert (= v__split_fields4 v__split_fields8))
(assert (= rliteral v__split_fields9))
(assert (= v__split_fields6 v__split_fields10))
(assert (= v__split_fields7 v__split_fields11))
(assert (= (to_rep o) (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (= v__split_fields8 o1))
(assert (= v__split_fields9 o2))
(assert (= o o3))
(assert (= v__split_fields11 o4))
(assert (= temp___230 o1))
(assert (= temp___2301 o2))
(assert (= temp___2302 o3))
(assert (= temp___2303 o4))
(assert (= v__attr__tag temp___2304))
...
(assert (= temp___230 v__split_fields12))
(assert (= temp___2301 v__split_fields13))
(assert (= temp___2302 v__split_fields14))
(assert (= temp___2303 v__split_fields15))
...
(assert (not (= (is_zero (mk___rep (mk___split_fields v__split_fields16 v__split_fields17 v__split_fields18 v__split_fields19) v__attr__tag)) true)))
(check-sat)
(exit)
