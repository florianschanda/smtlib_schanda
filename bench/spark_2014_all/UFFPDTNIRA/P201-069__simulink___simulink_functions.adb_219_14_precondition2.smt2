...
(assert (forall ((x Float64) (base Float64)) (! (=> (and (and (dynamic_invariant x true true true true) (dynamic_invariant base true true true true)) (and (and (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) x) (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) base)) (not (fp.eq base (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))) (let ((result (log__2 x base))) (and (=> (fp.eq x (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.eq result (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (dynamic_invariant result true false true true)))) :pattern ((log__2 x base)))))
