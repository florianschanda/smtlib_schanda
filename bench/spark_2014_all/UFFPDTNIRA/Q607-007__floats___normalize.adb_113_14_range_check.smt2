...
(assert (in_range1 x))
(assert (and (= o (r3 (fp.div RNE x (fp #b0 #b10000111 #b01101000000000000000000)))) (and (in_range o) (and (= o (fp.roundToIntegral RTN (fp.div RNE x (fp #b0 #b10000111 #b01101000000000000000000)))) (and (fp.leq o (fp.div RNE x (fp #b0 #b10000111 #b01101000000000000000000))) (fp.leq (fp.sub RNE (fp.div RNE x (fp #b0 #b10000111 #b01101000000000000000000)) (fp #b0 #b01111111 #b00000000000000000000000)) o))))))
