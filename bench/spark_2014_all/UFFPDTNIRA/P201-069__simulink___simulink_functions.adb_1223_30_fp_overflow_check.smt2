...
(assert (= result__1 o2))
(assert (not (fp.leq left (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))))
(assert (not (fp.isFinite64 (fp.add RNE result__1 pi_over_two))))
(check-sat)
(exit)
