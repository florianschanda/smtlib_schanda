...
(assert (and (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 approx2)) (fp.lt tolerance (fp.abs (fp.sub RNE x1 (fp.mul RNE approx2 approx2))))))
...
(assert (= o22 (fp.mul RNE (fp #b0 #b01111110 #b00000000000000000000000) o21)))
(assert (= result48 (mk_t__ref approx2)))
(assert (= approx3 o22))
(assert (and (= o23 (fp.mul RNE approx3 approx3)) (fp.isFinite32 (fp.mul RNE approx3 approx3))))
(assert (= o24 (fp.sub RNE x1 o23)))
