...
(define-fun us_split_fields_Desired__projection ((a us_split_fields)) float (rec__test_pack__pid_obj__desired a))
(define-fun us_split_fields_Error__projection ((a us_split_fields)) float (rec__test_pack__pid_obj__error a))
...
(assert (not (fp.isFinite32 (fp.add RNE (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) measured))))
(check-sat)
(exit)
