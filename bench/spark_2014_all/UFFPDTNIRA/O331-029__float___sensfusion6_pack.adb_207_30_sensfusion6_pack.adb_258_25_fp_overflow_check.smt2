...
(assert (and (= o37 (fp.add RNE rad_gx1 integral_fbx1)) (fp.isFinite32 (fp.add RNE rad_gx1 integral_fbx1))))
(assert (= result19 (mk_t__ref rad_gx1)))
(assert (= rad_gx2 o37))
(assert (not (fp.isFinite32 (fp.add RNE rad_gy1 integral_fby1))))
(check-sat)
(exit)
