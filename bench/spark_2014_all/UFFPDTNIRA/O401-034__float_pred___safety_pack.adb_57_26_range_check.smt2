...
(define-fun dynamic_invariant1 ((temp___expr_1469 Int) (temp___is_init_1465 Bool) (temp___skip_constant_1466 Bool) (temp___do_toplevel_1467 Bool) (temp___do_typ_inv_1468 Bool)) Bool (=> (or (= temp___is_init_1465 true) (<= (- 32768) 32767)) (in_range temp___expr_1469)))
