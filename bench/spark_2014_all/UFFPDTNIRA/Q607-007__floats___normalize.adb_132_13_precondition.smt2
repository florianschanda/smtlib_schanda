...
(assert (forall ((x Float32)) (! (=> (and (dynamic_invariant x true true true true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111101110)) x)) (let ((result (r3 x))) (and (and (fp.leq result x) (fp.leq (fp.sub RNE x (fp #b0 #b01111111 #b00000000000000000000000)) result)) (dynamic_invariant result true false true true)))) :pattern ((r3 x)))))
(assert (forall ((x Float32)) (! (=> (dynamic_invariant x true true true true) (= (r3 x) (fp.roundToIntegral RTN x))) :pattern ((r3 x)))))
(declare-sort t1 0)
