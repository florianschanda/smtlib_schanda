...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs1 a))) (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs1 b)))) (and (and (= (rec__tagged_discr__t__z (us_split_fields1 a)) (rec__tagged_discr__t__z (us_split_fields1 b))) (=> (tagged_discr__t__x__pred a) (= (to_rep (rec__tagged_discr__t__x (us_split_fields1 a))) (to_rep (rec__tagged_discr__t__x (us_split_fields1 b)))))) (=> (tagged_discr__t__y__pred a) (= (to_rep1 (rec__tagged_discr__t__y (us_split_fields1 a))) (to_rep1 (rec__tagged_discr__t__y (us_split_fields1 b))))))) true false))
...
(define-fun us_split_fields_Y__2__projection ((a us_split_fields2)) float (rec__tagged_discr__t__y1 a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs2 a))) (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs2 b)))) (and (and (and (= (to_rep (rec__tagged_discr__u1__w (us_split_fields3 a))) (to_rep (rec__tagged_discr__u1__w (us_split_fields3 b)))) (= (rec__tagged_discr__t__z1 (us_split_fields3 a)) (rec__tagged_discr__t__z1 (us_split_fields3 b)))) (=> (tagged_discr__t__x__pred1 a) (= (to_rep (rec__tagged_discr__t__x1 (us_split_fields3 a))) (to_rep (rec__tagged_discr__t__x1 (us_split_fields3 b)))))) (=> (tagged_discr__t__y__pred1 a) (= (to_rep1 (rec__tagged_discr__t__y1 (us_split_fields3 a))) (to_rep1 (rec__tagged_discr__t__y1 (us_split_fields3 b))))))) true false))
...
(assert true)
(assert true)
(assert (forall ((v us_rep1)) (! (= (ite (is_zero__2 v) 1 0) (ite (is_zero__21 us_tag1 v) 1 0)) :pattern ((is_zero__21 us_tag1 v)))))
(assert (forall ((v us_rep1)) (! (= (ite (is_zero__2 v) 1 0) (ite (is_zero__21 us_tag2 v) 1 0)) :pattern ((is_zero__21 us_tag2 v)))))
(assert (forall ((v us_rep1)) (! (= (= (is_zero__2 v) true) (and (and (not (= (rec__tagged_discr__t__z1 (us_split_fields3 v)) true)) (ite (or (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs2 v))) 0) (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs2 v))) 2)) (= (to_rep (rec__tagged_discr__t__x1 (us_split_fields3 v))) 0) (fp.eq (to_rep1 (rec__tagged_discr__t__y1 (us_split_fields3 v))) (fp #b0 #b00000000 #b00000000000000000000000)))) (= (to_rep (rec__tagged_discr__u1__w (us_split_fields3 v))) 0))) :pattern ((is_zero__2 v)))))
...
(assert (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) r5b))
(assert (in_range2 r5b))
(assert (= (to_rep2 o) 0))
(assert (= o o1))
(assert (= tagged_discr__init__2__R7b__assume o1))
(assert (= (distinct 0 0) tagged_discr__init__2__R7b__assume1))
(assert (= rliteral tagged_discr__init__2__R7b__assume2))
(assert (= dummy1 tagged_discr__init__2__R7b__assume3))
(assert (= us_null_ext__ tagged_discr__init__2__R7b__assume4))
...
(assert (= 0 (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs1 r7b)))))
(assert (not (= (rec__tagged_discr__t__discr (us_split_discrs1 r7b)) (rec__tagged_discr__t__discr v__split_discrs))))
(check-sat)
(exit)
