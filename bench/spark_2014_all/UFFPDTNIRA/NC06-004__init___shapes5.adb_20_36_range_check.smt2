...
(assert (= r1 radius))
(assert (in_range3 r1))
(assert (fp.leq (fp.sub RNE (fp #b0 #b10000000101 #b1001000000000000000000000000000000000000000000000000) x) r1))
(assert (not (in_range3 (fp.sub RNE (fp #b0 #b10000000101 #b1001000000000000000000000000000000000000000000000000) x))))
(check-sat)
(exit)
