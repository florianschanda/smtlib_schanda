...
(assert (= r7 r5))
(assert (not (in_range2 (fp.sub RNE (to_rep (rec__shapes5__circle__center_x (us_split_fields1 (circle__content shapes5__make_circle__result10)))) (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 (circle__content shapes5__make_circle__result10))))))))
(check-sat)
(exit)
