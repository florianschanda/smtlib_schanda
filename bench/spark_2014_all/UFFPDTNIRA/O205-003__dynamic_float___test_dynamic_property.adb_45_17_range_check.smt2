...
(assert (= result true))
(assert (and (= temp___181 (fp.add RNE x (fp #b0 #b01111111 #b00000000000000000000000))) (fp.isFinite32 (fp.add RNE x (fp #b0 #b01111111 #b00000000000000000000000)))))
(assert (not (dynamic_property (fp #b0 #b01111111 #b00000000000000000000000) last temp___181)))
(check-sat)
(exit)
