...
(define-fun us_split_fields_A__projection ((a us_split_fields)) ft (rec__foo__float_tests__test_record_1__rec__a a))
(define-fun us_split_fields_B__projection ((a us_split_fields)) ft (rec__foo__float_tests__test_record_1__rec__b a))
(define-fun us_split_fields_C__projection ((a us_split_fields)) ft (rec__foo__float_tests__test_record_1__rec__c a))
...
(declare-const temp___2391 ft)
(declare-const temp___2392 ft)
(declare-const o6 ft)
(declare-const o7 ft)
(declare-const o8 ft)
(declare-const o9 ft)
(declare-const temp___241 ft)
(declare-const temp___2411 ft)
(declare-const temp___2412 ft)
...
(assert (= temp___2391 o4))
(assert (= temp___2392 o5))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= result2 r__split_fields2))
(assert (= temp___239 r__split_fields3))
(assert (= temp___2391 r__split_fields4))
(assert (= temp___2392 r__split_fields5))
(assert (= (to_rep o6) (to_rep r__split_fields4)))
(assert (= o6 o7))
(assert (= r__split_fields4 o8))
(assert (= r__split_fields5 o9))
(assert (= temp___241 o7))
(assert (= temp___2411 o8))
(assert (= temp___2412 o9))
(assert (= result3 r__split_fields3))
(assert (= result4 r__split_fields4))
(assert (= result5 r__split_fields5))
(assert (= temp___241 r__split_fields6))
(assert (= temp___2411 r__split_fields7))
(assert (= temp___2412 r__split_fields8))
(assert (= result6 y))
