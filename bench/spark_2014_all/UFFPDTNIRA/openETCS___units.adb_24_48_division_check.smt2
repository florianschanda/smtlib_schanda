...
(assert true)
(assert (forall ((speed1 Float32)) (! (= (= (is_valid_speed_km_per_h speed1) true) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) speed1) (fp.leq speed1 maximum_valid_speed_km_per_h))) :pattern ((is_valid_speed_km_per_h speed1)))))
(assert (forall ((speed1 Float32)) (! (=> (and (dynamic_invariant2 speed1 true true true true) (= (is_valid_speed_km_per_h speed1) true)) (dynamic_invariant (m_per_s_from_km_per_h speed1) true false true true)) :pattern ((m_per_s_from_km_per_h speed1)))))
(assert (forall ((speed1 Float32)) (! (=> (dynamic_invariant2 speed1 true true true true) (= (m_per_s_from_km_per_h speed1) (fp.div RNE (fp.mul RNE speed1 (fp #b0 #b10001000 #b11110100000000000000000)) (fp #b0 #b10001010 #b11000010000000000000000)))) :pattern ((m_per_s_from_km_per_h speed1)))))
(declare-const o Float32)
(assert (fp.isFinite32 speed))
(assert (= (is_valid_speed speed) true))
(assert (and (= o (fp.mul RNE speed (fp #b0 #b10001010 #b11000010000000000000000))) (fp.isFinite32 (fp.mul RNE speed (fp #b0 #b10001010 #b11000010000000000000000)))))
