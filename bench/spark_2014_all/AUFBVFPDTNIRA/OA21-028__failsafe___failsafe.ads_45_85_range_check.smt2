...
(declare-const o12 battery_level_type)
...
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (= temp___303 (bvsub current_time o9))))
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (and (= o10 (t__content failsafe__model__time_below_threshold__result4)) (in_range1 (t__content failsafe__model__time_below_threshold__result4)))))
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (= result8 (ite (bvult current_time o10) true false))))
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (=> (= result8 true) (= o11 (bvadd temp___303 #x32)))))
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (=> (not (= result8 true)) (= o11 temp___303))))
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (= o12 (select battery_level_at o11))))
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (= o13 (to_rep o12))))
(assert (=> (bvult (t__content failsafe__model__time_below_threshold__result4) #x32) (= result7 (ite (fp.leq battery_threshold o13) true false))))
...
(assert (= (= result10 true) (forall ((s17 (_ BitVec 8))) (=> (and (bvule #x00 s17) (bvule s17 current_time)) (fp.lt (to_rep (select battery_level_at s17)) battery_threshold)))))
(assert (= result10 true))
(assert (and (= o8 (bvsub (t__content failsafe__model__time_below_threshold__result4) #x01)) (in_range1 (bvsub (t__content failsafe__model__time_below_threshold__result4) #x01))))
(assert (= temp___306 (bvsub current_time o8)))
