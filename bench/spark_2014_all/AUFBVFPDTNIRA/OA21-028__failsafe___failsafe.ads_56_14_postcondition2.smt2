...
(assert (=> (fp.lt battery_level battery_threshold) (and (= o3 (bv_min (bvadd counter #x01) #x32)) (in_range3 (bv_min (bvadd counter #x01) #x32)))))
(assert (=> (fp.lt battery_level battery_threshold) (= (mk_t__ref result2) (mk_t__ref counter))))
(assert (=> (fp.lt battery_level battery_threshold) (= counter1 o3)))
(assert (=> (fp.lt battery_level battery_threshold) (=> (fp.leq battery_threshold (to_rep (select battery_level_at1 current_time1))) (= counter1 #x00))))
(assert (=> (fp.lt battery_level battery_threshold) (=> (= c #x32) (= counter1 #x32))))
(assert (=> (fp.lt battery_level battery_threshold) (=> (and (not (= c #x32)) (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) battery_threshold)))) (= c #x31))))
(assert (=> (fp.lt battery_level battery_threshold) (=> (and (not (= c #x32)) (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) battery_threshold)))) (= counter1 #x32))))
(assert (=> (fp.lt battery_level battery_threshold) (=> (and (fp.lt (to_rep (select battery_level_at1 current_time1)) battery_threshold) (not (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) battery_threshold))))) (and (fp.leq battery_threshold (to_rep (select battery_level_at1 (let ((temp___323 (bvsub current_time1 counter1))) (ite (bvult current_time1 counter1) (bvadd temp___323 #x32) temp___323))))) (ite (bvuge current_time1 (bvsub counter1 #x01)) (forall ((s (_ BitVec 8))) (=> (and (bvule (let ((temp___324 (bvsub current_time1 (bvsub counter1 #x01)))) (ite (bvult current_time1 (bvsub counter1 #x01)) (bvadd temp___324 #x32) temp___324)) s) (bvule s current_time1)) (fp.lt (to_rep (select battery_level_at1 s)) battery_threshold))) (and (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s current_time1)) (fp.lt (to_rep (select battery_level_at1 s)) battery_threshold))) (forall ((s (_ BitVec 8))) (=> (and (bvule (let ((temp___325 (bvsub current_time1 (bvsub counter1 #x01)))) (ite (bvult current_time1 (bvsub counter1 #x01)) (bvadd temp___325 #x32) temp___325)) s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) battery_threshold)))))))))
(assert (=> (fp.lt battery_level battery_threshold) (= counter1 (time_below_threshold battery_level_at1 current_time1))))
(assert (=> (not (fp.lt battery_level battery_threshold)) (= result3 counter)))
(assert (=> (not (fp.lt battery_level battery_threshold)) (= counter2 #x00)))
(assert (=> (not (fp.lt battery_level battery_threshold)) (= counter1 counter2)))
