...
(assert (=> (and (fp.lt (to_rep (select battery_level_at1 current_time1)) battery_threshold) (not (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) battery_threshold))))) (and (fp.leq battery_threshold (to_rep (select battery_level_at1 (let ((temp___323 (bvsub current_time1 counter1))) (ite (bvult current_time1 counter1) (bvadd temp___323 #x32) temp___323))))) (ite (bvuge current_time1 (bvsub counter1 #x01)) (forall ((s (_ BitVec 8))) (=> (and (bvule (let ((temp___324 (bvsub current_time1 (bvsub counter1 #x01)))) (ite (bvult current_time1 (bvsub counter1 #x01)) (bvadd temp___324 #x32) temp___324)) s) (bvule s current_time1)) (fp.lt (to_rep (select battery_level_at1 s)) battery_threshold))) (and (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s current_time1)) (fp.lt (to_rep (select battery_level_at1 s)) battery_threshold))) (forall ((s (_ BitVec 8))) (=> (and (bvule (let ((temp___325 (bvsub current_time1 (bvsub counter1 #x01)))) (ite (bvult current_time1 (bvsub counter1 #x01)) (bvadd temp___325 #x32) temp___325)) s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) battery_threshold))))))))
(assert (not (= counter1 (time_below_threshold battery_level_at1 current_time1))))
(check-sat)
(exit)
