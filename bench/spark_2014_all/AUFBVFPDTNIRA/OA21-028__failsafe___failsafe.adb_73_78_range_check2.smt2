...
(assert (=> (and (not (= c #x32)) (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) battery_threshold)))) (= c #x31)))
(assert (=> (and (not (= c #x32)) (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) battery_threshold)))) (= counter1 #x32)))
(assert (= (= o4 true) (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s #x31)) (fp.lt (to_rep (select battery_level_at1 s)) battery_threshold)))))
(assert (= o5 (ite (not (= o4 true)) true false)))
(assert (= result3 (ite (fp.lt (to_rep (select battery_level_at1 current_time1)) battery_threshold) o5 false)))
(assert (= result3 true))
(assert (and (= o7 counter1) (in_range1 counter1)))
(assert (= temp___318 (bvsub current_time1 o7)))
(assert (and (= o8 counter1) (in_range1 counter1)))
(assert (= result5 (ite (bvult current_time1 o8) true false)))
(assert (=> (= result5 true) (= o9 (bvadd temp___318 #x32))))
(assert (=> (not (= result5 true)) (= o9 temp___318)))
(assert (= o10 (select battery_level_at1 o9)))
(assert (= o11 (to_rep o10)))
(assert (= result4 (ite (fp.leq battery_threshold o11) true false)))
(assert (= result4 true))
...
(assert (= (= result7 true) (forall ((s (_ BitVec 8))) (=> (and (bvule #x00 s) (bvule s current_time1)) (fp.lt (to_rep (select battery_level_at1 s)) battery_threshold)))))
(assert (= result7 true))
