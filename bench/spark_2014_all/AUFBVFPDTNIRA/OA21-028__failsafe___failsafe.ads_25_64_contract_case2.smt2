...
(assert (= s13 s11))
(assert (= res11 res9))
(assert (= (fp.geq (to_rep (select battery_level_at current_time)) battery_threshold) true))
(assert (not (= (t__content failsafe__model__time_below_threshold__result4) #x00)))
(check-sat)
(exit)
