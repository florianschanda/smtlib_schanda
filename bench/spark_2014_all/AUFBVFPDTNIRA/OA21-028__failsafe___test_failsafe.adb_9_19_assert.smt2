...
(define-fun failsafe_state7 () us_private__ref (mk___private__ref failsafe_state5))
...
(assert (=> (and (<= 1 j1) (<= j1 49)) (and (and (= (is_valid failsafe_state2 battery_level_at2 current_time3) true) (and (= current_time3 (let ((temp___273 (bvadd current_time2 #x01))) (ite (bvule (bvsub #x32 current_time2) #x01) (bvsub temp___273 #x32) temp___273))) (fp.eq (to_rep (select battery_level_at2 current_time3)) (fp #b0 #b01111011 #b10011001100110011001101)))) (in_range1 current_time3))))
...
(assert (=> (and (<= 1 j1) (<= j1 49)) (= failsafe_state7 (mk___private__ref failsafe_state3))))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= (mk_int__ref j5) (mk_int__ref j3))))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= current_time8 (mk_t__ref current_time4))))
(assert (=> (and (<= 1 j1) (<= j1 49)) (= battery_level_at7 (mk_map__ref battery_level_at3))))
...
(assert (=> (not (and (<= 1 j1) (<= j1 49))) (= failsafe_state7 (mk___private__ref failsafe_state))))
(assert (=> (not (and (<= 1 j1) (<= j1 49))) (= j1 j5)))
(assert (=> (not (and (<= 1 j1) (<= j1 49))) (= current_time8 (mk_t__ref current_time))))
(assert (=> (not (and (<= 1 j1) (<= j1 49))) (= battery_level_at7 (mk_map__ref battery_level_at))))
...
(assert (not (not (= (is_raised failsafe_state5 battery_level_at5 current_time6) true))))
(check-sat)
(exit)
