...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__p__r__a integer) (rec__p__r__b float)))))
(define-fun us_split_fields_A__projection ((a us_split_fields)) integer (rec__p__r__a a))
(define-fun us_split_fields_B__projection ((a us_split_fields)) float (rec__p__r__b a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__p__r__a (us_split_fields1 a))) (to_rep1 (rec__p__r__a (us_split_fields1 b)))) (= (to_rep (rec__p__r__b (us_split_fields1 a))) (to_rep (rec__p__r__b (us_split_fields1 b))))) true false))
...
(define-fun bool_eq1 ((a (Array Int unsigned_8)) (a__first Int) (a__last Int) (b (Array Int unsigned_8)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep2 (select a temp___idx_154)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(assert (forall ((i r_raw_index)) (and (<= 1 (r_raw_indexqtint i)) (<= (r_raw_indexqtint i) 8))))
...
(declare-datatypes () ((r_raw_index__ref (mk_r_raw_index__ref (r_raw_index__content r_raw_index)))))
(define-fun r_raw_index__ref___projection ((a r_raw_index__ref)) r_raw_index (r_raw_index__content a))
...
(define-fun dynamic_invariant2 ((temp___expr_290 Int) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool) (temp___do_typ_inv_289 Bool)) Bool (=> (or (= temp___is_init_286 true) (<= 1 8)) (in_range2 temp___expr_290)))
(declare-const rliteral integer)
(assert (= (integerqtint rliteral) 0))
(assert (= null_r (mk___rep (mk___split_fields rliteral (of_rep (fp #b0 #b00000000 #b00000000000000000000000))))))
(assert (= null_raw_r (p__null_raw_r__aggregate_def #x00)))
(define-fun dynamic_invariant3 ((temp___expr_190 (_ BitVec 8)) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool) (temp___do_typ_inv_189 Bool)) Bool true)
(assert (forall ((temp___156 (_ BitVec 8))) (=> (dynamic_invariant3 temp___156 true true true true) (forall ((temp___157 Int)) (= (to_rep2 (select (p__null_raw_r__aggregate_def temp___156) temp___157)) temp___156)))))
...
(declare-const temp___310 integer)
(declare-const temp___3101 float)
...
(assert (= rliteral o1))
(assert (= o o2))
(assert (= temp___310 o1))
(assert (= temp___3101 o2))
(assert (= (mk___rep (mk___split_fields temp___310 temp___3101)) null_r))
(assert (= (p__null_raw_r__aggregate_def #x00) null_raw_r))
(assert (= result full_s__split_fields))
(assert (= result1 full_s__split_fields1))
(assert (= (mk___split_fields full_s__split_fields2 full_s__split_fields3) (us_split_fields1 null_r)))
(assert (= raw_s raw_s1))
...
(assert (not (= (bool_eq1 raw_s1 1 8 null_raw_r 1 8) true)))
(check-sat)
(exit)
