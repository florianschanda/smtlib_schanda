...
(assert (bvule (let ((temp___324 (bvsub current_time1 (bvsub counter1 #x01)))) (ite (bvult current_time1 (bvsub counter1 #x01)) (bvadd temp___324 #x32) temp___324)) s))
(assert (bvule s current_time1))
(assert (not (fp.lt (to_rep (select battery_level_at1 s)) battery_threshold)))
(check-sat)
(exit)
