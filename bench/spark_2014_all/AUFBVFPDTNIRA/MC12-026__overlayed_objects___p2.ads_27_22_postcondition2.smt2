...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__p2__r__a integer) (rec__p2__r__b float)))))
(define-fun us_split_fields_A__projection ((a us_split_fields)) integer (rec__p2__r__a a))
(define-fun us_split_fields_B__projection ((a us_split_fields)) float (rec__p2__r__b a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__p2__r__a (us_split_fields1 a))) (to_rep1 (rec__p2__r__a (us_split_fields1 b)))) (= (to_rep (rec__p2__r__b (us_split_fields1 a))) (to_rep (rec__p2__r__b (us_split_fields1 b))))) true false))
...
(assert (forall ((temp___156 (_ BitVec 8))) (=> (dynamic_invariant3 temp___156 true true true true) (forall ((temp___157 Int)) (= (to_rep2 (select (p2__null_raw_r__aggregate_def temp___156) temp___157)) temp___156)))))
...
(declare-const temp___309 integer)
(declare-const temp___3091 float)
...
(assert (= temp___3091 o2))
(assert (= (mk___rep (mk___split_fields temp___309 temp___3091)) null_r))
...
(assert (not (= (bool_eq (mk___rep (mk___split_fields full_s__split_fields4 full_s__split_fields5)) null_r) true)))
(check-sat)
(exit)
