...
(assert (= temp___318 (bvsub current_time1 o8)))
(assert (and (= o9 counter1) (in_range1 counter1)))
(assert (= result5 (ite (bvult current_time1 o9) true false)))
(assert (=> (= result5 true) (= o10 (bvadd temp___318 #x32))))
(assert (=> (not (= result5 true)) (= o10 temp___318)))
(assert (= o11 (select battery_level_at1 o10)))
(assert (= o12 (to_rep o11)))
(assert (= result4 (ite (fp.leq battery_threshold o12) true false)))
(assert (= result4 true))
(assert (and (= o6 (bvsub counter1 #x01)) (in_range1 (bvsub counter1 #x01))))
(assert (= result6 (ite (bvuge current_time1 o6) true false)))
(assert (= result6 true))
(assert (and (= o7 (bvsub counter1 #x01)) (in_range1 (bvsub counter1 #x01))))
(assert (= temp___319 (bvsub current_time1 o7)))
