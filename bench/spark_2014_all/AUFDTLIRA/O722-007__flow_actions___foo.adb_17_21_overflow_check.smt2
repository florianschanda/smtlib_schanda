...
(assert (= o new_str))
(assert (= o temp___181))
(assert (= (mk pos1 5) temp___1811))
(assert (= o1 (bool_eq temp___181 (to_rep1 (first temp___1811)) (to_rep1 (last temp___1811)) new_sub 1 5)))
(assert (= result1 (ite (not (= o1 true)) true false)))
(assert (= result1 true))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 pos2)) (not (= (bool_eq new_str (to_rep1 (first (mk pos2 5))) (to_rep1 (last (mk pos2 5))) new_sub 1 5) true))))
