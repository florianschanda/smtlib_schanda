...
(assert (= b1 o13))
(assert (not (= (bool_eq a (to_rep (first6 (mk3 (to_rep a__first) (+ (to_rep a__first) j1)))) (to_rep (last6 (mk3 (to_rep a__first) (+ (to_rep a__first) j1)))) b1 (to_rep (first8 (mk4 (to_rep b__first) (+ (to_rep b__first) j1)))) (to_rep (last8 (mk4 (to_rep b__first) (+ (to_rep b__first) j1))))) true)))
(check-sat)
(exit)
