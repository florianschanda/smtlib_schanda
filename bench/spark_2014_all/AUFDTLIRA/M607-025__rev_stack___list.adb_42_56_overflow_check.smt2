...
(assert (and (= o14 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range5 o14) (<= o14 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
(assert (= result6 (ite (= o14 o13) true false)))
(assert (=> (= result6 true) (and (= o9 (- last5 i9)) (in_range1 (- last5 i9)))))
(assert (=> (= result6 true) (= o10 (+ o9 1))))
(assert (=> (= result6 true) (and (= o11 o10) (in_range1 o10))))
(assert (=> (= result6 true) (and (= o8 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 o8 true false true true) (and (= (to_rep (first (rt o8))) 1) (<= 0 (to_rep (last (rt o8)))))))))
...
(assert (=> (= result5 true) (and (= o4 (- last5 i9)) (in_range1 (- last5 i9)))))
