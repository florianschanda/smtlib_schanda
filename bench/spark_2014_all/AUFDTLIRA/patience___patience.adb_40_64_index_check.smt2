...
(assert (and (<= 0 topstacki2) (<= topstacki2 99)))
(assert (= o35 topstacki2))
(assert (= o36 (select s__split_fields5 o35)))
(assert (= o37 (to_rep o36)))
(assert (= result10 (ite (<= 0 o37) true false)))
(assert (=> (= result10 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result10 true) (= o32 topstacki2)))
(assert (=> (= result10 true) (= o33 (select s__split_fields5 o32))))
(assert (=> (= result10 true) (= o34 (to_rep o33))))
(assert (=> (= result10 true) (= result9 (ite (< o34 (to_rep s__split_fields2)) true false))))
...
(assert (=> (= result9 true) (= o30 (select s__split_fields6 o29))))
(assert (=> (= result9 true) (= o31 (to_rep o30))))
(assert (=> (= result9 true) (= result8 (ite (<= 0 o31) true false))))
...
(assert (=> (= result8 true) (= temp___574 (to_rep o24))))
(assert (=> (= result8 true) (and (<= 0 temp___574) (<= temp___574 99))))
(assert (=> (= result8 true) (= o25 temp___574)))
(assert (=> (= result8 true) (= o26 (select s__split_fields3 o25))))
(assert (=> (= result8 true) (= o27 (to_rep o26))))
(assert (=> (= result8 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result8 true) (= o21 topstacki2)))
(assert (=> (= result8 true) (= o22 (select s__split_fields6 o21))))
(assert (=> (= result8 true) (= o28 (to_rep o22))))
(assert (=> (= result8 true) (= result7 (ite (< o28 o27) true false))))
(assert (=> (not (= result8 true)) (= result7 false)))
(assert (=> (= result7 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result7 true) (= o13 topstacki2)))
(assert (=> (= result7 true) (= o14 (select s__split_fields5 o13))))
(assert (=> (= result7 true) (= temp___577 (to_rep o14))))
(assert (=> (= result7 true) (and (<= 0 temp___577) (<= temp___577 99))))
(assert (=> (= result7 true) (= o15 temp___577)))
(assert (=> (= result7 true) (= temp___578 (select s__split_fields4 o15))))
(assert (=> (= result7 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result7 true) (= o16 topstacki2)))
(assert (=> (= result7 true) (= o17 (select s__split_fields6 o16))))
(assert (=> (= result7 true) (= temp___580 (to_rep o17))))
(assert (=> (= result7 true) (and (<= 0 temp___580) (<= temp___580 99))))
(assert (=> (= result7 true) (= o18 temp___580)))
(assert (=> (= result7 true) (= o19 (select temp___578 o18))))
(assert (=> (= result7 true) (= o20 (to_rep o19))))
(assert (=> (= result7 true) (= result6 (ite (= o20 topstacki2) true false))))
...
(assert (=> (= result6 true) (= o12 (to_rep o11))))
(assert (=> (= result6 true) (= result5 (ite (= o12 i2) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (= result5 true))
(assert (not (<= topstacki2 99)))
(check-sat)
(exit)
