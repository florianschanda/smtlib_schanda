...
(assert (= (bool_eq2 a 1 16 (temp_____aggregate_def_5380 t k (temp_____aggregate_def_5386 (select t k) j (temp_____aggregate_def_5392 (select (select t k) j) i e))) 1 16) true))
...
(assert (< k 16))
(assert (< 0 e))
(assert (and (= o6 (- e 1)) (in_range3 (- e 1))))
(assert (not (<= (+ k 1) 16)))
(check-sat)
(exit)
