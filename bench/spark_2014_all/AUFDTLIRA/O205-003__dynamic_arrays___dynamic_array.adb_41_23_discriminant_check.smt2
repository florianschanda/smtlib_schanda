...
(assert (= o26 j))
(assert (= o27 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) o26)))
(assert (= o28 (us_split_discrs1 o27)))
(assert (= result2 (rec__dynamic_array__rec__b o28)))
(assert (= result2 true))
(assert (and (= o21 (new_holder c)) (and (dynamic_invariant1 o21 true false true true) (ite (= c 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o21))) 0) (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o21))) c)))))
(assert (= o22 (us_split_fields3 o21)))
(assert (= temp___247 (rec__dynamic_array__holder__content o22)))
(assert (and (<= (to_rep1 (first (rt temp___247))) j) (<= j (to_rep1 (last1 (rt temp___247))))))
(assert (= o23 j))
(assert (= o24 (select (elts temp___247) o23)))
(assert (and (= o25 (increment o24)) (and (in_range2 o25) (= o25 (ite (= (rec__dynamic_array__rec__b (us_split_discrs1 o24)) true) (ite (< (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 o24))) c) (+ (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 o24))) 1) (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 o24)))) (ite (< (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 o24))) c) (+ (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 o24))) 1) (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 o24)))))))))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__dynamic_array__holder__content1 h__split_fields3)))) j) (<= j (to_rep1 (last3 (rt1 (rec__dynamic_array__holder__content1 h__split_fields3)))))))
(assert (= o19 j))
(assert (= o20 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) o19)))
(assert (not (= (ite (rec__dynamic_array__rec__b (us_split_discrs1 o20)) 1 0) 1)))
(check-sat)
(exit)
