...
(assert (and (= o55 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 o55)))
(assert (= result13 (ite (in_range7 o55) true false)))
(assert (=> (= result13 true) (and (= o51 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o51))))
(assert (=> (= result13 true) (= result14 (ite (< j o51) true false))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o52 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o53 (get (rec__list_allocator__m__t__available model____split_fields3) o52)) (in_range4 o53)))))
(assert (=> (= result13 true) (=> (not (= result14 true)) (= o53 0))))
(assert (=> (= result13 true) (and (= temp___431 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 temp___431))))
(assert (=> (= result13 true) (and (<= 1 temp___431) (<= temp___431 3))))
(assert (=> (= result13 true) (= o47 temp___431)))
(assert (=> (= result13 true) (= o48 (select data3 o47))))
(assert (=> (= result13 true) (= o49 (us_split_fields3 o48))))
(assert (=> (= result13 true) (= o50 (rec__list_allocator__cell__next o49))))
(assert (=> (= result13 true) (= o54 (to_rep o50))))
(assert (=> (= result13 true) (= result12 (ite (= o54 o53) true false))))
(assert (=> (not (= result13 true)) (= result12 false)))
(assert (=> (= result12 true) (=> (< 1 j) (and (= o44 (- j 1)) (in_range2 (- j 1))))))
(assert (=> (= result12 true) (=> (< 1 j) (and (= o45 (get (rec__list_allocator__m__t__available model____split_fields3) o44)) (in_range4 o45)))))
(assert (=> (= result12 true) (=> (not (< 1 j)) (= o45 0))))
(assert (=> (= result12 true) (and (= temp___432 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 temp___432))))
(assert (=> (= result12 true) (and (<= 1 temp___432) (<= temp___432 3))))
(assert (=> (= result12 true) (= o40 temp___432)))
(assert (=> (= result12 true) (= o41 (select data3 o40))))
(assert (=> (= result12 true) (= o42 (us_split_fields3 o41))))
(assert (=> (= result12 true) (= o43 (rec__list_allocator__cell__prev o42))))
(assert (=> (= result12 true) (= o46 (to_rep o43))))
(assert (=> (= result12 true) (= result11 (ite (= o46 o45) true false))))
...
(assert (= o39 (ite (<= k o38) true false)))
(assert (= result15 (ite (<= 1 k) o39 false)))
