...
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o50 (size (mk___rep2 (us_split_fields__content2 f__split_fields7)))) (and (in_range3 o50) (= o50 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))))))
...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o44 (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j)) (and (in_range2 o44) (= o44 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 j))))))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
