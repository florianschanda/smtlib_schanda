...
(assert (= o120 i1))
(assert (= o121 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o120)))
(assert (= o122 (to_rep o121)))
(assert (= o123 (ite (<= o122 (- (to_rep (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o117 i1))
(assert (= o118 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o117)))
(assert (= o119 (to_rep o118)))
(assert (= o124 (ite (<= 0 o119) true false)))
(assert (= result23 (ite (= o124 true) o123 false)))
(assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result23 true) (= o108 i1)))
(assert (=> (= result23 true) (= o109 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o108))))
(assert (=> (= result23 true) (= temp___681 (to_rep o109))))
(assert (=> (= result23 true) (and (<= 0 temp___681) (<= temp___681 99))))
(assert (=> (= result23 true) (= o110 temp___681)))
(assert (=> (= result23 true) (= o111 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) o110))))
(assert (=> (= result23 true) (= o112 (to_rep o111))))
(assert (=> (= result23 true) (= o113 (- o112 1))))
(assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result23 true) (= o106 i1)))
(assert (=> (= result23 true) (= o107 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o106))))
(assert (=> (= result23 true) (= o114 (to_rep o107))))
(assert (=> (= result23 true) (= o115 (ite (<= o114 o113) true false))))
(assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result23 true) (= o103 i1)))
(assert (=> (= result23 true) (= o104 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o103))))
(assert (=> (= result23 true) (= o105 (to_rep o104))))
(assert (=> (= result23 true) (= o116 (ite (<= 0 o105) true false))))
(assert (=> (= result23 true) (= result22 (ite (= o116 true) o115 false))))
