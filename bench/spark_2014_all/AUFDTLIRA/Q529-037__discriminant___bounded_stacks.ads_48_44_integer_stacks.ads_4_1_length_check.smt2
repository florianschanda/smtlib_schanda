...
(declare-const temp___269 (Array Int element))
(declare-const temp___2691 t4)
(assert (in_range1 temp___267))
(assert (= temp___267 (to_rep1 temp___266)))
(assert (= (to_rep2 (first8 (rt4 (temp_____aggregate_def_245 0 1 temp___267)))) 1))
(assert (= (to_rep2 (last8 (rt4 (temp_____aggregate_def_245 0 1 temp___267)))) temp___267))
(assert (= (mk___t4 temp___269 temp___2691) (temp_____aggregate_def_245 0 1 temp___267)))
(assert (not (= (ite (<= (to_rep2 (first8 temp___2691)) (to_rep2 (last8 temp___2691))) (+ (- (to_rep2 (last8 temp___2691)) (to_rep2 (first8 temp___2691))) 1) 0) (ite (<= 1 temp___267) (+ (- temp___267 1) 1) 0))))
(check-sat)
(exit)
