...
(assert (<= temp___2445 index1))
(assert (<= index1 temp___2446))
...
(assert (and (and (forall ((temp___2449 Int)) (=> (and (<= (to_rep1 n__first) temp___2449) (<= temp___2449 (to_rep1 n__last))) (=> (or (< temp___2446 temp___2449) (or (< temp___2449 temp___2445) (< index2 temp___2449))) (= (select n3 temp___2449) (select n1 temp___2449))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 5)))))
