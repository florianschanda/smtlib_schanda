...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i x2)) (= (= (select r2 i) true) (= i (+ c 1))))))
(assert (and (and (forall ((temp___182 Int)) (=> (and (<= (- 2147483648) temp___182) (<= temp___182 2147483647)) (=> (or (< 100 temp___182) (or (< temp___182 1) (< x2 temp___182))) (= (select r2 temp___182) (select r temp___182))))) (=> (<= 1 100) (in_range2 x2))) (and (<= 1 x2) (<= x2 100))))
(assert (<= 1 x2))
