...
(define-fun dynamic_invariant1 ((temp___expr_970 Int) (temp___is_init_966 Bool) (temp___skip_constant_967 Bool) (temp___do_toplevel_968 Bool) (temp___do_typ_inv_969 Bool)) Bool (=> (or (= temp___is_init_966 true) (<= 0 4294967295)) (in_range3 temp___expr_970)))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true true) (= (issueridt_image x) (let ((temp___976 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___976) (first1 temp___976) (last1 temp___976))))) :pattern ((issueridt_image x)))))
(declare-sort t3 0)
...
(define-fun dynamic_invariant3 ((temp___expr_1469 Int) (temp___is_init_1465 Bool) (temp___skip_constant_1466 Bool) (temp___do_toplevel_1467 Bool) (temp___do_typ_inv_1468 Bool)) Bool (=> (or (= temp___is_init_1465 true) (<= 0 4294967295)) (in_range4 temp___expr_1469)))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant3 x true true true true) (= (serialnumbert_image x) (let ((temp___1475 (to_string (attr__ATTRIBUTE_IMAGE4 x)))) (of_array3 (to_array temp___1475) (first1 temp___1475) (last1 temp___1475))))) :pattern ((serialnumbert_image x)))))
...
(declare-fun temp___String_Literal_1690 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1690 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 3)) 85)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 4)) 115)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 28)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 29)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 39)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 41)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 44)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 45)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 47)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 48)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 49)) 32)) (= (to_rep (select (temp___String_Literal_1690 us_void_param) 50)) 32)) :pattern ((temp___String_Literal_1690 us_void_param)))))
(declare-fun temp___String_Literal_1691 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1691 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1691 us_void_param) 2)) 115)) (= (to_rep (select (temp___String_Literal_1691 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_1691 us_void_param) 4)) 117)) (= (to_rep (select (temp___String_Literal_1691 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1691 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1691 us_void_param) 7)) 58)) (= (to_rep (select (temp___String_Literal_1691 us_void_param) 8)) 32)) :pattern ((temp___String_Literal_1691 us_void_param)))))
(declare-fun temp___String_Literal_1694 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1694 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1694 us_void_param) 2)) 83)) (= (to_rep (select (temp___String_Literal_1694 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_1694 us_void_param) 4)) 114)) (= (to_rep (select (temp___String_Literal_1694 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1694 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_1694 us_void_param) 7)) 108)) (= (to_rep (select (temp___String_Literal_1694 us_void_param) 8)) 78)) (= (to_rep (select (temp___String_Literal_1694 us_void_param) 9)) 111)) (= (to_rep (select (temp___String_Literal_1694 us_void_param) 10)) 58)) (= (to_rep (select (temp___String_Literal_1694 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_1694 us_void_param) 12)) 32)) :pattern ((temp___String_Literal_1694 us_void_param)))))
...
(define-fun dynamic_invariant8 ((temp___expr_437 Int) (temp___is_init_433 Bool) (temp___skip_constant_434 Bool) (temp___do_toplevel_435 Bool) (temp___do_typ_inv_436 Bool)) Bool (=> (or (= temp___is_init_433 true) (<= 1 50)) (in_range6 temp___expr_437)))
...
(define-fun dynamic_invariant14 ((temp___expr_946 Int) (temp___is_init_942 Bool) (temp___skip_constant_943 Bool) (temp___do_toplevel_944 Bool) (temp___do_typ_inv_945 Bool)) Bool (=> (or (= temp___is_init_942 true) (<= 0 40)) (in_range5 temp___expr_946)))
(define-fun dynamic_invariant15 ((temp___expr_994 Int) (temp___is_init_990 Bool) (temp___skip_constant_991 Bool) (temp___do_toplevel_992 Bool) (temp___do_typ_inv_993 Bool)) Bool (=> (or (= temp___is_init_990 true) (<= 0 10)) (in_range11 temp___expr_994)))
(declare-const localuser (Array Int character))
(declare-const fullstring (Array Int character))
(declare-const temp___1698 (Array Int character))
(declare-const temp___16981 t3)
(declare-const temp___1693 (Array Int character))
(declare-const temp___16931 t1)
(declare-const o Int)
...
(declare-const temp___1695 (Array Int character))
(declare-const temp___16951 t)
...
(declare-const temp___1697 (Array Int character))
(declare-const temp___16971 t)
...
(define-fun temp___16932 () us_t1 (mk___t1 temp___1693 temp___16931))
(define-fun temp___16982 () us_t3 (mk___t3 temp___1698 temp___16981))
(assert (= result localuser))
(assert (= localuser1 (temp___String_Literal_1690 Tuple0)))
(assert (and (= temp___16982 (serialnumbert_image (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))) (and (dynamic_invariant2 temp___16982 true false true true) (= temp___16982 (let ((temp___1473 (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))))) (mk___t3 (elts temp___1473) (mk3 (to_rep1 (first (rt temp___1473))) (to_rep1 (last (rt temp___1473))))))))))
(assert (and (= temp___16932 (issueridt_image (to_rep3 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))))) (and (dynamic_invariant temp___16932 true false true true) (= temp___16932 (let ((temp___974 (to_string (attr__ATTRIBUTE_IMAGE3 (to_rep3 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))))))) (mk___t1 (elts temp___974) (mk1 (to_rep1 (first (rt temp___974))) (to_rep1 (last (rt temp___974))))))))))
(assert (=> (<= (to_rep1 (first2 temp___16931)) (to_rep1 (last2 temp___16931))) (= o (+ (- (to_rep1 (last2 temp___16931)) (to_rep1 (first2 temp___16931))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___16931)) (to_rep1 (last2 temp___16931)))) (= o 0)))
(assert (=> (<= 1 8) (= o1 (+ (- 8 1) 1))))
(assert (=> (not (<= 1 8)) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ 1 o2)))
...
(assert (= (concat1 (temp___String_Literal_1691 Tuple0) 1 8 temp___1693 (to_rep1 (first2 temp___16931)) (to_rep1 (last2 temp___16931))) temp___1695))
(assert (= (mk 1 o5) temp___16951))
(assert (=> (= (length (mk___t temp___1695 temp___16951)) 0) (= (temp___String_Literal_1694 Tuple0) temp___1697)))
(assert (=> (= (length (mk___t temp___1695 temp___16951)) 0) (= (mk 1 12) temp___16971)))
(assert (=> (not (= (length (mk___t temp___1695 temp___16951)) 0)) (=> (<= 1 12) (= o6 (+ (- 12 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1695 temp___16951)) 0)) (=> (not (<= 1 12)) (= o6 0))))
(assert (=> (not (= (length (mk___t temp___1695 temp___16951)) 0)) (=> (<= (to_rep1 (first temp___16951)) (to_rep1 (last temp___16951))) (= o7 (+ (- (to_rep1 (last temp___16951)) (to_rep1 (first temp___16951))) 1)))))
(assert (=> (not (= (length (mk___t temp___1695 temp___16951)) 0)) (=> (not (<= (to_rep1 (first temp___16951)) (to_rep1 (last temp___16951)))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___1695 temp___16951)) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length (mk___t temp___1695 temp___16951)) 0)) (= o9 (+ (to_rep1 (first temp___16951)) o8))))
(assert (=> (not (= (length (mk___t temp___1695 temp___16951)) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length (mk___t temp___1695 temp___16951)) 0)) (and (= o11 o10) (in_range1 o10))))
(assert (=> (not (= (length (mk___t temp___1695 temp___16951)) 0)) (= (concat1 temp___1695 (to_rep1 (first temp___16951)) (to_rep1 (last temp___16951)) (temp___String_Literal_1694 Tuple0) 1 12) temp___1697)))
(assert (=> (not (= (length (mk___t temp___1695 temp___16951)) 0)) (= (mk (to_rep1 (first temp___16951)) o11) temp___16971)))
(assert (=> (= (length (mk___t temp___1697 temp___16971)) 0) (= temp___1698 cert__attr__extractuser__fullstring__assume)))
(assert (=> (= (length (mk___t temp___1697 temp___16971)) 0) (= (mk (to_rep1 (first6 temp___16981)) (to_rep1 (last6 temp___16981))) cert__attr__extractuser__fullstring__assume1)))
(assert (=> (not (= (length (mk___t temp___1697 temp___16971)) 0)) (=> (<= (to_rep1 (first6 temp___16981)) (to_rep1 (last6 temp___16981))) (= o12 (+ (- (to_rep1 (last6 temp___16981)) (to_rep1 (first6 temp___16981))) 1)))))
(assert (=> (not (= (length (mk___t temp___1697 temp___16971)) 0)) (=> (not (<= (to_rep1 (first6 temp___16981)) (to_rep1 (last6 temp___16981)))) (= o12 0))))
(assert (=> (not (= (length (mk___t temp___1697 temp___16971)) 0)) (=> (<= (to_rep1 (first temp___16971)) (to_rep1 (last temp___16971))) (= o13 (+ (- (to_rep1 (last temp___16971)) (to_rep1 (first temp___16971))) 1)))))
(assert (=> (not (= (length (mk___t temp___1697 temp___16971)) 0)) (=> (not (<= (to_rep1 (first temp___16971)) (to_rep1 (last temp___16971)))) (= o13 0))))
(assert (=> (not (= (length (mk___t temp___1697 temp___16971)) 0)) (= o14 (+ o13 o12))))
(assert (=> (not (= (length (mk___t temp___1697 temp___16971)) 0)) (= o15 (+ (to_rep1 (first temp___16971)) o14))))
(assert (=> (not (= (length (mk___t temp___1697 temp___16971)) 0)) (= o16 (- o15 1))))
(assert (=> (not (= (length (mk___t temp___1697 temp___16971)) 0)) (and (= o17 o16) (in_range1 o16))))
(assert (=> (not (= (length (mk___t temp___1697 temp___16971)) 0)) (= (concat1 temp___1697 (to_rep1 (first temp___16971)) (to_rep1 (last temp___16971)) temp___1698 (to_rep1 (first6 temp___16981)) (to_rep1 (last6 temp___16981))) cert__attr__extractuser__fullstring__assume)))
(assert (=> (not (= (length (mk___t temp___1697 temp___16971)) 0)) (= (mk (to_rep1 (first temp___16971)) o17) cert__attr__extractuser__fullstring__assume1)))
