...
(assert (= (ite (<= (to_rep1 (first temp___4051)) (to_rep1 (last temp___4051))) (+ (- (to_rep1 (last temp___4051)) (to_rep1 (first temp___4051))) 1) 0) (ite (<= 1 128) (+ (- 128 1) 1) 0)))
(assert (= o6 (slide temp___405 (to_rep1 (first temp___4051)) 1)))
(assert (= o6 o7))
(assert (= (rec__datebook__event_record__description_size (us_split_fields7 (select event_array (int__content available8)))) o8))
(assert (= (rec__datebook__event_record__date (us_split_fields7 (select event_array (int__content available8)))) (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o9 o10 o11)) (mk___rep1 (mk___split_fields1 o12 o13 o14))))))
(assert (= (rec__datebook__event_record__is_used (us_split_fields7 (select event_array (int__content available8)))) o15))
(assert (= o16 o7))
(assert (= o17 o8))
(assert (= o18 o9))
(assert (= o19 o10))
...
(assert (= o23 o14))
(assert (= o24 o15))
(assert (= o25 (store event_array (int__content available8) (mk___rep3 (mk___split_fields3 o16 o17 (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o18 o19 o20)) (mk___rep1 (mk___split_fields1 o21 o22 o23)))) o24)))))
