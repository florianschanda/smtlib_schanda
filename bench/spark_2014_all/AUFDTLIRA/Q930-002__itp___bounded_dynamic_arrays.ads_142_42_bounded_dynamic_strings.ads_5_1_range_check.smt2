...
(declare-const temp___1186 (Array Int character))
...
(declare-const temp___1188 (Array Int character))
(declare-const temp___11881 t4)
(declare-const o8 (Array Int character))
(declare-const temp___1191 (Array Int character))
(declare-const temp___11911 t4)
(declare-const temp___1193 (Array Int character))
(declare-const temp___11931 t4)
...
(declare-const temp___1196 natural_index)
(declare-const temp___11961 natural_index)
(declare-const temp___11962 (Array Int character))
(declare-const temp___11963 t1)
(declare-const temp___1197 natural_index)
(declare-const temp___11971 natural_index)
(declare-const temp___11972 (Array Int character))
(declare-const temp___11973 t1)
(declare-const o14 natural_index)
(declare-const o15 natural_index)
(declare-const o16 (Array Int character))
(declare-const o17 t1)
(declare-const temp___1199 us_rep)
(declare-const temp___1200 us_rep)
(declare-const temp___1204 us_t2)
...
(define-fun temp___11964 () us_rep (mk___rep (mk___split_discrs temp___1196) (mk___split_fields temp___11961 (mk___t1 temp___11962 temp___11963))))
(define-fun temp___11862 () us_t2 (mk___t2 temp___1186 temp___11861))
...
(assert (and (<= 1 (+ (length3 tail) (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))))) (<= (+ (length3 tail) (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity to____split_discrs)))))
(assert (and (= o (length3 tail)) (in_range1 (length3 tail))))
...
(assert (and (= temp___11862 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (and (dynamic_invariant2 temp___11862 true false true true) (and (and (= to____split_fields1 temp___1186) (= (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 to____split_fields)))) (to_rep1 (last6 (mk3 1 (to_rep2 to____split_fields))))) temp___11861)) (and (and (and (= (length3 temp___11862) (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (= (to_rep1 (first4 temp___11861)) 1)) (= (to_rep1 (last4 temp___11861)) (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))))) (= (< 0 (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (not (= (empty (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))) true))))))))
(assert (=> (= (length3 temp___11862) 0) (= (elts2 tail) temp___1187)))
(assert (=> (= (length3 temp___11862) 0) (= (mk (to_rep1 (first4 (rt2 tail))) (to_rep1 (last4 (rt2 tail)))) temp___11871)))
(assert (=> (not (= (length3 temp___11862) 0)) (=> (<= (to_rep1 (first4 (rt2 tail))) (to_rep1 (last4 (rt2 tail)))) (= o2 (+ (- (to_rep1 (last4 (rt2 tail))) (to_rep1 (first4 (rt2 tail)))) 1)))))
(assert (=> (not (= (length3 temp___11862) 0)) (=> (not (<= (to_rep1 (first4 (rt2 tail))) (to_rep1 (last4 (rt2 tail))))) (= o2 0))))
(assert (=> (not (= (length3 temp___11862) 0)) (=> (<= (to_rep1 (first4 temp___11861)) (to_rep1 (last4 temp___11861))) (= o3 (+ (- (to_rep1 (last4 temp___11861)) (to_rep1 (first4 temp___11861))) 1)))))
(assert (=> (not (= (length3 temp___11862) 0)) (=> (not (<= (to_rep1 (first4 temp___11861)) (to_rep1 (last4 temp___11861)))) (= o3 0))))
(assert (=> (not (= (length3 temp___11862) 0)) (= o4 (+ o3 o2))))
(assert (=> (not (= (length3 temp___11862) 0)) (= o5 (+ (to_rep1 (first4 temp___11861)) o4))))
(assert (=> (not (= (length3 temp___11862) 0)) (= o6 (- o5 1))))
(assert (=> (not (= (length3 temp___11862) 0)) (and (= o7 o6) (in_range2 o6))))
(assert (=> (not (= (length3 temp___11862) 0)) (= (concat1 temp___1186 (to_rep1 (first4 temp___11861)) (to_rep1 (last4 temp___11861)) (elts2 tail) (to_rep1 (first4 (rt2 tail))) (to_rep1 (last4 (rt2 tail)))) temp___1187)))
(assert (=> (not (= (length3 temp___11862) 0)) (= (mk (to_rep1 (first4 temp___11861)) o7) temp___11871)))
(assert (= (ite (<= (to_rep1 (first temp___11871)) (to_rep1 (last temp___11871))) (+ (- (to_rep1 (last temp___11871)) (to_rep1 (first temp___11871))) 1) 0) (ite (<= 1 new_length) (+ (- new_length 1) 1) 0)))
(assert (= (slide temp___1187 (to_rep1 (first temp___11871)) 1) temp___1188))
(assert (= (mk4 1 new_length) temp___11881))
...
(assert (= o8 temp___1191))
(assert (= (mk4 1 new_length) temp___11911))
(assert (= (ite (<= (to_rep1 (first8 temp___11881)) (to_rep1 (last8 temp___11881))) (+ (- (to_rep1 (last8 temp___11881)) (to_rep1 (first8 temp___11881))) 1) 0) (ite (<= (to_rep1 (first8 temp___11911)) (to_rep1 (last8 temp___11911))) (+ (- (to_rep1 (last8 temp___11911)) (to_rep1 (first8 temp___11911))) 1) 0)))
(assert (= (mk___t4 temp___1193 temp___11931) (mk___t4 temp___1188 temp___11881)))
(assert (and (and (= (to_rep1 (first2 to____split_fields2)) (to_rep1 (first2 o10))) (= (to_rep1 (last2 to____split_fields2)) (to_rep1 (last2 o10)))) (forall ((temp___1194 Int)) (ite (and (<= 1 temp___1194) (<= temp___1194 new_length)) (= (select o9 temp___1194) (select temp___1193 temp___1194)) (= (select o9 temp___1194) (select to____split_fields1 temp___1194))))))
(assert (= to____split_fields o11))
(assert (= o12 o9))
(assert (= o13 o10))
(assert (= to____split_discrs (mk___split_discrs temp___1196)))
(assert (= temp___11961 o11))
(assert (= temp___11962 o12))
(assert (= temp___11963 o13))
(assert (dynamic_predicate temp___11964))
(assert (= (mk___rep (mk___split_discrs temp___1197) (mk___split_fields temp___11971 (mk___t1 temp___11972 temp___11973))) temp___11964))
...
(assert (= to____split_fields3 (mk___split_fields temp___11971 (mk___t1 temp___11972 temp___11973))))
(assert (= to____split_discrs (mk___split_discrs temp___1197)))
(assert (= (to_rep2 o14) new_length))
(assert (= o14 o15))
(assert (= (rec__bounded_dynamic_strings__sequence__content to____split_fields3) (mk___t1 o16 o17)))
(assert (= temp___1199 (mk___rep to____split_discrs (mk___split_fields o15 (mk___t1 o16 o17)))))
(assert (dynamic_predicate temp___1199))
(assert (= temp___1200 temp___1199))
(assert (= result1 (mk___split_fields__ref to____split_fields3)))
(assert (= to____split_fields4 (us_split_fields1 temp___1200)))
(assert (= to____split_discrs (us_split_discrs1 temp___1200)))
(assert (= to____split_fields5 (mk___split_fields__ref to____split_fields4)))
(assert (= to____split_fields6 to____split_fields4))
(assert (and (= o23 (length3 tail)) (in_range1 (length3 tail))))
(assert (and (= o24 (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (and (in_range4 o24) (= o24 (to_rep2 to____split_fields)))))
(assert (= o25 (+ o24 o23)))
(assert (and (= o26 (length2 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (and (in_range4 o26) (= o26 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content to____split_fields5)))))))
(assert (= o27 (ite (= o26 o25) true false)))
(assert (and (= temp___1204 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (and (dynamic_invariant2 temp___1204 true false true true) (and (= temp___1204 (mk___t2 to____split_fields1 (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 to____split_fields)))) (to_rep1 (last6 (mk3 1 (to_rep2 to____split_fields))))))) (and (and (and (= (length3 temp___1204) (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (= (to_rep1 (first4 (rt2 temp___1204))) 1)) (= (to_rep1 (last4 (rt2 temp___1204))) (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))))) (= (< 0 (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (not (= (empty (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))) true))))))))
(assert (not (= (length3 temp___1204) 0)))
(assert (=> (<= (to_rep1 (first4 (rt2 tail))) (to_rep1 (last4 (rt2 tail)))) (= o18 (+ (- (to_rep1 (last4 (rt2 tail))) (to_rep1 (first4 (rt2 tail)))) 1))))
(assert (=> (not (<= (to_rep1 (first4 (rt2 tail))) (to_rep1 (last4 (rt2 tail))))) (= o18 0)))
(assert (=> (<= (to_rep1 (first4 (rt2 temp___1204))) (to_rep1 (last4 (rt2 temp___1204)))) (= o19 (+ (- (to_rep1 (last4 (rt2 temp___1204))) (to_rep1 (first4 (rt2 temp___1204)))) 1))))
(assert (=> (not (<= (to_rep1 (first4 (rt2 temp___1204))) (to_rep1 (last4 (rt2 temp___1204))))) (= o19 0)))
(assert (= o20 (+ o19 o18)))
(assert (= o21 (+ (to_rep1 (first4 (rt2 temp___1204))) o20)))
(assert (= o22 (- o21 1)))
