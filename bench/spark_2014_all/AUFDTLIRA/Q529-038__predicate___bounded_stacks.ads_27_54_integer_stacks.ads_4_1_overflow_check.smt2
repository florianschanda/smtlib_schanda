...
(define-fun in_range5 ((rec__integer_stacks__stack__capacity1 Int) (a us_rep)) Bool (= rec__integer_stacks__stack__capacity1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 a)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true true) (dynamic_invariant (extent this) true false true true)) :pattern ((extent this)))))
(assert (forall ((attr__tag4 Int)) (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true true) (dynamic_invariant (extent1 attr__tag4 this) true false true true)) :pattern ((extent1 attr__tag4 this))))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true true) (= (extent this) (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 this))))) :pattern ((extent this)))))
...
(define-fun dynamic_invariant2 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_165)))
...
(assert (dynamic_invariant1 (mk___rep this__split_discrs (mk___split_fields (mk___t this__split_fields4 this__split_fields5) this__split_fields6 this__split_fields7) this__attr__tag) true true true true))
(assert (and (= o (extent (mk___rep this__split_discrs (mk___split_fields (mk___t this__split_fields this__split_fields1) this__split_fields2 this__split_fields3) this__attr__tag))) (and (in_range3 o) (= o (to_rep1 this__split_fields2)))))
(assert (= o1 (+ o 1)))
