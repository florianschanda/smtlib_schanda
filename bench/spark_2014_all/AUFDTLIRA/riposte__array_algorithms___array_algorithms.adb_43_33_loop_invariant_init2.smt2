...
(assert (forall ((x tindex_typeB)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x tindex_typeB)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x value_type)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x value_type)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq ((a (Array Int value_type)) (a__first Int) (a__last Int) (b (Array Int value_type)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep1 (select a temp___idx_154)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_166)))
...
(assert true)
(assert (forall ((a us_t)) (forall ((lastindex Int) (val__ Int)) (! (= (= (has_value_inc a lastindex val__) true) (exists ((i Int)) (and (and (<= (first1 a) i) (<= i lastindex)) (= (to_rep1 (select (to_array a) i)) val__)))) :pattern ((has_value_inc a lastindex val__))))))
(declare-fun has_value_exc (us_t Int Int) Bool)
(declare-fun has_value_exc__function_guard (Bool us_t Int Int) Bool)
(assert true)
(assert (forall ((a us_t)) (forall ((lastindex Int) (val__ Int)) (! (= (= (has_value_exc a lastindex val__) true) (exists ((i Int)) (and (and (<= (first1 a) i) (<= i lastindex)) (and (< i lastindex) (= (to_rep1 (select (to_array a) i)) val__))))) :pattern ((has_value_exc a lastindex val__))))))
