...
(assert (not (<= (to_rep1 (rec__money__amount__raw (us_split_fields1 sum))) (to_rep1 (rec__money__amount__raw (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account)))))))))
(check-sat)
(exit)
