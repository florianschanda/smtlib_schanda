...
(assert (and (= o5 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o5) (<= (+ 0 o5) 2147483647))))
(assert (= result1 (ite (<= o5 10000) true false)))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o3 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o3) (<= (+ 0 o3) 2147483647))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= result2 (ite (< 0 o3) true false)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result2 true) (and (= o2 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) 1)) (in_range3 o2))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result2 true) (= result (ite (= o2 first_available) true false))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (not (= result2 true)) (= result false)))))
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (and (= o4 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o4) (<= (+ 0 o4) 2147483647))))))
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (= result (ite (= o4 0) true false)))))
