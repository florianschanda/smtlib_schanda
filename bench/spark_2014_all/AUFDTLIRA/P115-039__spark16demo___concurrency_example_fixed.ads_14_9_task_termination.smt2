...
(define-fun dynamic_invariant1 ((temp___expr_259 Int) (temp___is_init_255 Bool) (temp___skip_constant_256 Bool) (temp___do_toplevel_257 Bool) (temp___do_typ_inv_258 Bool)) Bool (=> (or (= temp___is_init_255 true) (<= 0 97)) (in_range2 temp___expr_259)))
(assert (not true))
(check-sat)
(exit)
