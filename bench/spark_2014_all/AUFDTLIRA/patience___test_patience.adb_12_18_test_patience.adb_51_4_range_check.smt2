...
(assert (= o17 (attr__ATTRIBUTE_IMAGE5 o16)))
(assert (= (mk___t temp___853 temp___8531) (to_string o17)))
(assert (=> (<= (to_rep1 (first temp___8531)) (to_rep1 (last temp___8531))) (= o18 (+ (- (to_rep1 (last temp___8531)) (to_rep1 (first temp___8531))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___8531)) (to_rep1 (last temp___8531)))) (= o18 0)))
