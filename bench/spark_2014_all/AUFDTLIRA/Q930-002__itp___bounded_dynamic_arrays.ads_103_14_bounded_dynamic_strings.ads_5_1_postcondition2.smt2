...
(assert (not (= (let ((temp___1076 (value (sequence__content bounded_dynamic_strings__Oconcat__4__result10)))) (bool_eq (elts2 temp___1076) (to_rep1 (first4 (rt2 temp___1076))) (to_rep1 (last4 (rt2 temp___1076))) (let ((temp___1075 (value left))) (ite (= (length3 temp___1075) 0) (singleton1 (of_rep right) 1) (concat_singleton_right (elts2 temp___1075) (to_rep1 (first4 (rt2 temp___1075))) (to_rep1 (last4 (rt2 temp___1075))) (of_rep right)))) (to_rep1 (first (let ((temp___1075 (value left))) (ite (= (length3 temp___1075) 0) (mk 1 1) (mk (to_rep1 (first4 (rt2 temp___1075))) (- (+ (to_rep1 (first4 (rt2 temp___1075))) (+ (ite (<= (to_rep1 (first4 (rt2 temp___1075))) (to_rep1 (last4 (rt2 temp___1075)))) (+ (- (to_rep1 (last4 (rt2 temp___1075))) (to_rep1 (first4 (rt2 temp___1075)))) 1) 0) 1)) 1)))))) (to_rep1 (last (let ((temp___1075 (value left))) (ite (= (length3 temp___1075) 0) (mk 1 1) (mk (to_rep1 (first4 (rt2 temp___1075))) (- (+ (to_rep1 (first4 (rt2 temp___1075))) (+ (ite (<= (to_rep1 (first4 (rt2 temp___1075))) (to_rep1 (last4 (rt2 temp___1075)))) (+ (- (to_rep1 (last4 (rt2 temp___1075))) (to_rep1 (first4 (rt2 temp___1075)))) 1) 0) 1)) 1)))))))) true)))
(check-sat)
(exit)
