...
(assert (or (and (and (and (= j10 j15) (and (= i10 i15) (= a7 a12))) (and (= j11 j1) (and (= i11 i1) (= a8 a1)))) (< (to_rep a__last) (to_rep a__first))) (and (not (< (to_rep a__last) (to_rep a__first))) (and (and (and (= j10 j14) (and (= i10 i14) (= a7 a11))) (and (= j11 j9) (and (= i11 i9) (= a8 a6)))) (and (and (and (= o (to_rep a__first)) (in_range2 (to_rep a__first))) (and (= (mk_int__ref result) i15) (= i2 o))) (and (and (and (= o1 (to_rep a__last)) (in_range2 (to_rep a__last))) (and (= (mk_int__ref result1) j15) (= j2 o1))) (ite (<= i2 j2) (and (and (and (= temp___196 j2) (and (= temp___195 i2) (and (= temp___194 a) (and (= 0 temp___197) (and (and (and (and (and (<= (to_rep a__first) i3) (<= i3 (to_rep a__last))) (and (<= (to_rep a__first) j3) (<= j3 (to_rep a__last)))) (forall ((k1 Int)) (=> (and (<= (to_rep a__first) k1) (<= k1 (- i3 1))) (not (= (select a2 k1) true))))) (forall ((k1 Int)) (=> (and (<= (+ j3 1) k1) (<= k1 (to_rep a__last))) (= (select a2 k1) true)))) (and (and (and (=> (<= 0 1000000) (in_range2 i3)) (=> (<= 0 1000000) (in_range2 j3))) (<= i3 j3)) (and (and (= temp___1971 result2) (= temp___1972 (- j3 i3))) (and (and (and (and (and (and (<= (to_rep a__first) i3) (<= i3 (to_rep a__last))) (= o2 i3)) (= o3 (select a2 o2))) (= result3 (ite (not (= o3 true)) true false))) (ite (= result3 true) (and (and (and (= o4 (+ i3 1)) (in_range2 (+ i3 1))) (and (= i3 result4) (= i4 o4))) (and (= j4 j3) (= o9 a2))) (and (and (and (and (and (<= (to_rep a__first) j3) (<= j3 (to_rep a__last))) (= o5 j3)) (= result5 (select a2 o5))) (ite (= result5 true) (and (and (and (= o6 (- j3 1)) (in_range2 (- j3 1))) (and (= j3 result6) (= j4 o6))) (and (= i5 i3) (= o9 a2))) (and (and (and (and (= (= (select o9 i3) true) (= (select a2 j3) true)) (= (= (select o9 j3) true) (= (select a2 i3) true))) (forall ((k1 Int)) (=> (and (<= (to_rep a__first) k1) (<= k1 (to_rep a__last))) (=> (and (not (= k1 i3)) (not (= k1 j3))) (= (= (select o9 k1) true) (= (select a2 k1) true)))))) (and (and (and (= o7 (+ i3 1)) (in_range2 (+ i3 1))) (and (= i3 result7) (= i5 o7))) (and (and (= o8 (- j3 1)) (in_range2 (- j3 1))) (and (= j3 result8) (= j5 o8))))) (= j4 j5)))) (= i4 i5)))) (not (<= i4 j4)))))))))) (and (and (= j4 j6) (and (= i4 i6) (= o9 a3))) (and (= j7 j4) (and (= i7 i4) (= a4 o9))))) (and (and (= j14 (mk_int__ref j6)) (and (= i14 (mk_int__ref i6)) (= a11 (mk_map__ref a3)))) (and (= j9 j7) (and (= i9 i7) (= a6 a4))))) (and (and (= j2 j8) (and (= i2 i8) (= a11 a12))) (and (= j9 j2) (and (= i9 i2) (= a6 a1)))))))))))
(assert (= j12 j10))
(assert (= i12 i10))
(assert (= a9 a7))
(assert (= j13 j11))
...
(assert (= (= result9 true) (forall ((j16 Int)) (=> (and (<= (to_rep a__first) j16) (<= j16 k)) (not (= (select (map__content a9) j16) true))))))
(assert (= result9 true))
