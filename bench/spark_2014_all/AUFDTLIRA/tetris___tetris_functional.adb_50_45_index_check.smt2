...
(assert (= (mk_int__ref result) (mk_int__ref y)))
(assert (= y1 0))
(assert (<= 0 y1))
(assert (<= y1 3))
...
(assert (<= 0 x1))
(assert (<= x1 3))
(assert (and (forall ((temp___780 Int)) (=> (and (<= 1 temp___780) (<= temp___780 50)) (=> (not (= (+ (to_rep3 cur_piece__split_fields3) y2) temp___780)) (= (select cur_board2 temp___780) (select cur_board1 temp___780))))) (and (<= 0 x2) (<= x2 3))))
...
(assert (= o2 (store (select cur_board2 (+ (to_rep3 cur_piece__split_fields3) y2)) o1 o)))
(assert (not (<= (+ (to_rep3 cur_piece__split_fields3) y2) 50)))
(check-sat)
(exit)
