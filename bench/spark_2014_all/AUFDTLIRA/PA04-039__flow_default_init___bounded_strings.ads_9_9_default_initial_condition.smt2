...
(declare-const temp___206 index_type)
(declare-const temp___2061 (Array Int character))
(declare-const temp___2062 t)
(declare-const temp___2063 length_type)
(define-fun temp___2064 () us_rep (mk___rep (mk___split_discrs temp___206) (mk___split_fields (mk___t temp___2061 temp___2062) temp___2063)))
(assert (in_range temp___197))
(assert (= temp___197 (to_rep temp___196)))
(assert (and (dynamic_invariant1 temp___2064 true false true true) (and (let ((temp___208 (temp_____aggregate_def_198 32 1 (to_rep temp___206)))) (and (= temp___2061 (elts1 temp___208)) (= temp___2062 (mk (to_rep3 (first2 (rt1 temp___208))) (to_rep3 (last2 (rt1 temp___208))))))) (= (to_rep1 temp___2063) 0))))
(assert (not (= (length1 temp___2064) 0)))
(check-sat)
(exit)
