...
(assert (forall ((str us_t)) (! (=> (dynamic_invariant str true true true true) (let ((result (to_camel_case str))) (and (and (= (first1 result) (first1 str)) (and (= (last1 result) (last1 str)) (= (to_caml_char2 str result (last1 str)) true))) (dynamic_invariant result true false true true)))) :pattern ((to_camel_case str)))))
...
(define-fun dynamic_invariant1 ((temp___expr_611 Int) (temp___is_init_607 Bool) (temp___skip_constant_608 Bool) (temp___do_toplevel_609 Bool) (temp___do_typ_inv_610 Bool)) Bool (=> (or (= temp___is_init_607 true) (<= 0 1)) (in_range3 temp___expr_611)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_173 us_void_param) 1)) 72) (= (to_rep (select (temp___String_Literal_173 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_173 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_173 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_173 us_void_param) 5)) 111)) :pattern ((temp___String_Literal_173 us_void_param)))))
(declare-fun temp___String_Literal_174 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_174 us_void_param) 1)) 72) (= (to_rep (select (temp___String_Literal_174 us_void_param) 2)) 105)) :pattern ((temp___String_Literal_174 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_176 us_void_param) 1)) 32) :pattern ((temp___String_Literal_176 us_void_param)))))
(declare-fun temp___String_Literal_647 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_647 us_void_param) 1)) 33) :pattern ((temp___String_Literal_647 us_void_param)))))
...
(assert (= prefix (ite (= (length who) 0) (of_array (temp___String_Literal_175 Tuple0) 1 0) (of_array (temp___String_Literal_176 Tuple0) 1 1))))
(assert (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true true) (dynamic_invariant4 (to_lower item) true false true true)) :pattern ((to_lower item)))))
(assert (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true true) (dynamic_invariant4 (to_upper item) true false true true)) :pattern ((to_upper item)))))
...
(declare-const temp___6461 t)
(declare-const o Int)
(declare-const o1 Int)
(declare-const o2 Int)
(declare-const o3 Int)
(declare-const o4 Int)
(define-fun temp___6462 () us_t (mk___t temp___646 temp___6461))
(assert (in_range3 g_lang_level))
(assert (dynamic_invariant who true false true true))
(assert (=> (= g_lang_level 0) (= (temp___String_Literal_173 Tuple0) hello__say_hello__hello__assume)))
(assert (=> (= g_lang_level 0) (= (mk 1 5) hello__say_hello__hello__assume1)))
(assert (=> (not (= g_lang_level 0)) (= (temp___String_Literal_174 Tuple0) hello__say_hello__hello__assume)))
...
(assert (dynamic_invariant hello true false true true))
(assert (=> (= (length who) 0) (= (temp___String_Literal_175 Tuple0) hello__say_hello__prefix__assume)))
(assert (=> (= (length who) 0) (= (mk 1 0) hello__say_hello__prefix__assume1)))
(assert (=> (not (= (length who) 0)) (= (temp___String_Literal_176 Tuple0) hello__say_hello__prefix__assume)))
...
(assert (dynamic_invariant prefix true false true true))
(assert (and (= temp___6462 (to_camel_case who)) (and (dynamic_invariant temp___6462 true false true true) (and (= (to_rep1 (first temp___6461)) (to_rep1 (first (rt who)))) (and (= (to_rep1 (last temp___6461)) (to_rep1 (last (rt who)))) (= (to_caml_char2 who temp___6462 (to_rep1 (last (rt who)))) true))))))
(assert (not (= (length hello) 0)))
(assert (=> (<= (to_rep1 (first (rt prefix))) (to_rep1 (last (rt prefix)))) (= o (+ (- (to_rep1 (last (rt prefix))) (to_rep1 (first (rt prefix)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt prefix))) (to_rep1 (last (rt prefix))))) (= o 0)))
(assert (=> (<= (to_rep1 (first (rt hello))) (to_rep1 (last (rt hello)))) (= o1 (+ (- (to_rep1 (last (rt hello))) (to_rep1 (first (rt hello)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt hello))) (to_rep1 (last (rt hello))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first (rt hello))) o2)))
(assert (= o4 (- o3 1)))
