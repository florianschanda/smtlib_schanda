...
(assert (and (= o (has_key1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c)) (= (= o true) (= (has_key1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c) true))))
(assert (= o1 true))
(assert (= result1 (ite (= o1 true) o false)))
(assert (= result1 true))
(assert (and (= o2 (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c)) (and (in_range5 o2) (= o2 (get (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (get1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c))))))
(assert (= o3 (ite (= o2 (to_rep (select a1 j))) true false)))
(assert (= o4 (ite (not (= o3 true)) true false)))
(assert (not (= (has_key1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c) true)))
(check-sat)
(exit)
