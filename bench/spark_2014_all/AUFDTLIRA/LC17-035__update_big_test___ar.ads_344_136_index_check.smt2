...
(assert (and (and (= (bool_eq1 a 5 50 (temp_____aggregate_def_4776 t j (temp_____aggregate_def_4782 (select t j) i e)) 5 50) true) (or (and (= j 50) (= j_next1 5)) (and (< j 50) (= j_next1 (+ j 1))))) (in_range2 j_next1)))
...
(assert (< j 50))
(assert (< 0 e))
(assert (and (= o4 (- e 1)) (in_range3 (- e 1))))
(assert (not (<= (+ j 1) 50)))
(check-sat)
(exit)
