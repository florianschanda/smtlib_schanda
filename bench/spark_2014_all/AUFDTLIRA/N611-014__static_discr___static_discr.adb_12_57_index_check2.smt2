...
(assert (and (= o9 (+ (to_rep (rec__static_discr__holder__length1 (us_split_fields__content4 current__split_fields5))) 1)) (in_range1 (+ (to_rep (rec__static_discr__holder__length1 (us_split_fields__content4 current__split_fields5))) 1))))
(assert (= o10 (ite (<= o9 i) true false)))
(assert (= result7 (ite (= o10 true) (ite (<= i (to_rep current__split_fields3)) true false) false)))
(assert (= result7 true))
(assert (not (<= 1 i)))
(check-sat)
(exit)
