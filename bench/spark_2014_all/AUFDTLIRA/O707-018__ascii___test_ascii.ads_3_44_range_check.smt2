...
(assert (forall ((s us_t)) (! (=> (dynamic_invariant s true true true true) (dynamic_invariant (id s) true false true true)) :pattern ((id s)))))
(assert (forall ((s us_t)) (! (=> (dynamic_invariant s true true true true) (= (id s) s)) :pattern ((id s)))))
(declare-const concat2 us_t)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun temp___String_Literal_154 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_154 us_void_param) 1)) 116) (= (to_rep (select (temp___String_Literal_154 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_154 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_154 us_void_param) 4)) 111)) :pattern ((temp___String_Literal_154 us_void_param)))))
...
(assert (= concat2 (let ((temp___156 0)) (let ((temp___155 (id (of_array (temp___String_Literal_154 Tuple0) 1 4)))) (ite (= (length temp___155) 0) (of_array (singleton1 (of_rep temp___156) 1) 1 1) (of_array (concat_singleton_right (to_array temp___155) (first1 temp___155) (last1 temp___155) (of_rep temp___156)) (first1 temp___155) (- (+ (first1 temp___155) (+ (ite (<= (first1 temp___155) (last1 temp___155)) (+ (- (last1 temp___155) (first1 temp___155)) 1) 0) 1)) 1)))))))
(declare-const temp___161 (Array Int character))
(declare-const temp___1611 t)
(declare-const o Int)
(declare-const o1 Int)
(declare-const o2 Int)
(declare-const o3 Int)
(define-fun temp___1612 () us_t (mk___t temp___161 temp___1611))
(assert (and (= temp___1612 (id (mk___t (temp___String_Literal_154 Tuple0) (mk 1 4)))) (and (dynamic_invariant temp___1612 true false true true) (and (= (temp___String_Literal_154 Tuple0) temp___161) (= (mk 1 4) temp___1611)))))
(assert (not (= (length temp___1612) 0)))
(assert (=> (<= (to_rep1 (first temp___1611)) (to_rep1 (last temp___1611))) (= o (+ (- (to_rep1 (last temp___1611)) (to_rep1 (first temp___1611))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___1611)) (to_rep1 (last temp___1611)))) (= o 0)))
(assert (= o1 (+ o 1)))
(assert (= o2 (+ (to_rep1 (first temp___1611)) o1)))
(assert (= o3 (- o2 1)))
