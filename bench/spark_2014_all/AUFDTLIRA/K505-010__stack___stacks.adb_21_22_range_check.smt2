...
(assert (forall ((x element)) (! (in_range5 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun dynamic_invariant5 ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_167)))
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant1 s true true true true) (dynamic_invariant2 (size s) true false true true)) :pattern ((size s)))))
(assert (forall ((attr__tag1 Int)) (forall ((s us_rep)) (! (=> (dynamic_invariant1 s true true true true) (dynamic_invariant2 (size1 attr__tag1 s) true false true true)) :pattern ((size1 attr__tag1 s))))))
...
(assert (and (= result (is_empty (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2) s__split_fields3) s__attr__tag))) (= (= result true) (= (size (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2) s__split_fields3) s__attr__tag)) 0))))
