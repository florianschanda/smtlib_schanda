...
(assert (and (= o2 (remove_last r)) (and (dynamic_invariant1 o2 true false true true) (and (= (elts r) o) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1))))) o1)))))
(assert (not (= (bool_eq b1 (to_rep (first (mk (to_rep b__first) (to_rep b__last)))) (to_rep (last (mk (to_rep b__first) (to_rep b__last)))) o (to_rep (first o1)) (to_rep (last o1))) true)))
(check-sat)
(exit)
