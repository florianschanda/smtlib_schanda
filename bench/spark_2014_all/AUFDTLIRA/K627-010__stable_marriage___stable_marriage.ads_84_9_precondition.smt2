...
(assert (and (= temp___519 (invert_2 r2)) (and (forall ((rank Int)) (=> (and (<= 1 rank) (<= rank 64)) (= (to_rep1 (select temp___519 (to_rep (select r2 rank)))) rank))) (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (= (to_rep (select r2 (to_rep1 (select temp___519 g2)))) g2))))))
