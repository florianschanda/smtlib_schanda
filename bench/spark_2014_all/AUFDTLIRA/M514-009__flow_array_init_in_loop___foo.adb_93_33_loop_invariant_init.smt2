...
(assert (forall ((i index_t)) (and (<= 1 (index_tqtint i)) (<= (index_tqtint i) 10))))
...
(define-fun dynamic_invariant1 ((temp___expr_161 Int) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool) (temp___do_typ_inv_160 Bool)) Bool (=> (or (= temp___is_init_157 true) (<= 1 10)) (in_range2 temp___expr_161)))
...
(assert (<= 1 n))
(assert (<= n i1))
(assert (not (< 0 (to_rep (select a1 n)))))
(check-sat)
(exit)
