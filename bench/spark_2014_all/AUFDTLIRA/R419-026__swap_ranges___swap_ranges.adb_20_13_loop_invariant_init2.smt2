...
(assert (< l1 (to_rep b__last)))
(define-fun swap_ranges__swap_ranges_with_error__L_1__R31b () Int (+ l1 1))
(define-fun swap_ranges__swap_ranges_with_error__L_1__R28b () Int (+ l1 1))
(assert (not (= (bool_eq b (to_rep (first10 (mk5 swap_ranges__swap_ranges_with_error__L_1__R28b (to_rep b__last)))) (to_rep (last10 (mk5 swap_ranges__swap_ranges_with_error__L_1__R28b (to_rep b__last)))) b1 (to_rep (first12 (mk6 swap_ranges__swap_ranges_with_error__L_1__R31b (to_rep b__last)))) (to_rep (last12 (mk6 swap_ranges__swap_ranges_with_error__L_1__R31b (to_rep b__last))))) true)))
(check-sat)
(exit)
