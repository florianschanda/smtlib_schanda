...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f1 root) i))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f1 root) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) i))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) j)))) true)) (and (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f2 root) i))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f2 root) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) i))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) j)))) true)) (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) i)))) 1)) (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) i)))) 1))))))))))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i 100))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f1 root) i))) true))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f1 root) j))) true))
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) i))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) j)))) true))
(assert (not (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) i)))) 1)) 0)))
(assert (not (< (to_rep (select values i)) (to_rep (select values j)))))
(check-sat)
(exit)
