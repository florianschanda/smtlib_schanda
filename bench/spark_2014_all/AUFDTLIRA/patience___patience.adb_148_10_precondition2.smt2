...
(declare-datatypes () ((us_t (mk___t (elts (Array Int card1)) (rt t)))))
(define-fun to_array ((a us_t)) (Array Int card1) (elts a))
(define-fun of_array ((a (Array Int card1)) (f Int) (l Int)) us_t (mk___t a (mk f l)))
(define-fun first1 ((a us_t)) Int (to_rep2 (first (rt a))))
(define-fun last1 ((a us_t)) Int (to_rep2 (last (rt a))))
(define-fun length ((a us_t)) Int (ite (<= (first1 a) (last1 a)) (+ (- (last1 a) (first1 a)) 1) 0))
(declare-const value__size4 Int)
(declare-fun object__size4 ((Array Int card1)) Int)
(declare-const value__component__size3 Int)
(declare-fun object__component__size3 ((Array Int card1)) Int)
(declare-const value__alignment4 Int)
(declare-fun object__alignment4 ((Array Int card1)) Int)
(assert (<= 0 value__size4))
(assert (forall ((a (Array Int card1))) (<= 0 (object__size4 a))))
(assert (<= 0 value__component__size3))
(assert (forall ((a (Array Int card1))) (<= 0 (object__component__size3 a))))
(assert (<= 0 value__alignment4))
(assert (forall ((a (Array Int card1))) (<= 0 (object__alignment4 a))))
(define-fun bool_eq4 ((x us_t) (y us_t)) Bool (bool_eq (elts x) (to_rep2 (first (rt x))) (to_rep2 (last (rt x))) (elts y) (to_rep2 (first (rt y))) (to_rep2 (last (rt y)))))
...
(define-fun dynamic_invariant3 ((temp___expr_189 Int) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (or (= temp___is_init_185 true) (<= 1 52)) (in_range3 temp___expr_189)))
(define-fun dynamic_invariant4 ((temp___expr_202 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool) (temp___do_typ_inv_201 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= (- 1) 100)) (in_range2 temp___expr_202)))
(declare-const rliteral cardindex)
(assert (= (cardindexqtint rliteral) 0))
(assert (= null_state (mk___rep (mk___split_fields rliteral (temp_____aggregate_def_157 1) rliteral (temp_____aggregate_def_161 (- 1)) (temp_____aggregate_def_165 (temp_____aggregate_def_169 (- 1))) (temp_____aggregate_def_173 (- 1)) (temp_____aggregate_def_177 (- 1)) (temp_____aggregate_def_181 (- 1))))))
(declare-const rliteral1 card1)
(assert (= (cardqtint rliteral1) 1))
(assert (forall ((temp___159 Int)) (=> (dynamic_invariant3 temp___159 true true true true) (forall ((temp___160 Int)) (= (select (temp_____aggregate_def_157 temp___159) temp___160) rliteral1)))))
(declare-const rliteral2 cardindex)
(assert (= (cardindexqtint rliteral2) (- 1)))
(assert (forall ((temp___163 Int)) (=> (dynamic_invariant4 temp___163 true true true true) (forall ((temp___164 Int)) (= (select (temp_____aggregate_def_161 temp___163) temp___164) rliteral2)))))
(assert (forall ((temp___167 (Array Int cardindex))) (forall ((temp___168 Int)) (= (select (temp_____aggregate_def_165 temp___167) temp___168) temp___167))))
(assert (forall ((temp___171 Int)) (=> (dynamic_invariant4 temp___171 true true true true) (forall ((temp___172 Int)) (= (select (temp_____aggregate_def_169 temp___171) temp___172) rliteral2)))))
(assert (forall ((temp___183 Int)) (=> (dynamic_invariant4 temp___183 true true true true) (forall ((temp___184 Int)) (= (select (temp_____aggregate_def_181 temp___183) temp___184) rliteral2)))))
(assert (forall ((temp___175 Int)) (=> (dynamic_invariant4 temp___175 true true true true) (forall ((temp___176 Int)) (= (select (temp_____aggregate_def_173 temp___175) temp___176) rliteral2)))))
(assert (forall ((temp___179 Int)) (=> (dynamic_invariant4 temp___179 true true true true) (forall ((temp___180 Int)) (= (select (temp_____aggregate_def_177 temp___179) temp___180) rliteral2)))))
...
(declare-const result1 (Array Int card1))
...
(declare-const s__split_fields9 (Array Int card1))
...
(declare-const s__split_fields16 cardindex)
(declare-const s__split_fields17 (Array Int card1))
(declare-const s__split_fields18 cardindex)
(declare-const s__split_fields19 (Array Int cardindex))
(declare-const s__split_fields20 (Array Int (Array Int cardindex)))
(declare-const s__split_fields21 (Array Int cardindex))
(declare-const s__split_fields22 (Array Int cardindex))
(declare-const s__split_fields23 (Array Int cardindex))
(declare-const i2 Int)
(define-fun s__split_fields24 () us_split_fields (mk___split_fields s__split_fields16 s__split_fields17 s__split_fields18 s__split_fields19 s__split_fields20 s__split_fields21 s__split_fields22 s__split_fields23))
(assert (= (mk___rep (mk___split_fields rliteral (temp_____aggregate_def_157 1) rliteral (temp_____aggregate_def_161 (- 1)) (temp_____aggregate_def_165 (temp_____aggregate_def_169 (- 1))) (temp_____aggregate_def_173 (- 1)) (temp_____aggregate_def_177 (- 1)) (temp_____aggregate_def_181 (- 1)))) null_state))
...
(assert (= (mk___split_fields s__split_fields8 s__split_fields9 s__split_fields10 s__split_fields11 s__split_fields12 s__split_fields13 s__split_fields14 s__split_fields15) (us_split_fields1 null_state)))
(assert (= (mk_int__ref result8) (mk_int__ref i)))
(assert (= i1 (to_rep2 (first (rt cards)))))
(assert (<= (to_rep2 (first (rt cards))) i1))
(assert (<= i1 (to_rep2 (last (rt cards)))))
(assert (= (to_rep s__split_fields16) (- i2 (to_rep2 (first (rt cards))))))
(assert (= (inv (mk___rep s__split_fields24)) true))
(assert (and (=> (<= (to_rep2 (first (rt cards))) (to_rep2 (last (rt cards)))) (dynamic_property1 (to_rep2 (first (rt cards))) (to_rep2 (last (rt cards))) i2)) (and (<= (to_rep2 (first (rt cards))) i2) (<= i2 (to_rep2 (last (rt cards)))))))
(assert (not (= (inv (mk___rep s__split_fields24)) true)))
(check-sat)
(exit)
