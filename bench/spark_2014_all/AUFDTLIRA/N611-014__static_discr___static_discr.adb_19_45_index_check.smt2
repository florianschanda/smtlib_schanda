...
(assert (in_range2 e))
(assert (and (<= 1 (to_rep current__split_fields2)) (<= (to_rep current__split_fields2) (to_rep (rec__static_discr__holder__c current__split_discrs)))))
(assert (not (<= (to_rep current__split_fields2) 100)))
(check-sat)
(exit)
