...
(assert (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4) index2)) (forall ((temp___1789 Int)) (=> (and (<= (to_rep1 n__first) temp___1789) (<= temp___1789 (to_rep1 n__last))) (=> (or (< temp___1785 temp___1789) (or (< temp___1789 (to_rep1 (first (rt source)))) (< index2 temp___1789))) (= (select n3 temp___1789) (select n1 temp___1789)))))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 4)))))
(assert (not (= index2 temp___1785)))
