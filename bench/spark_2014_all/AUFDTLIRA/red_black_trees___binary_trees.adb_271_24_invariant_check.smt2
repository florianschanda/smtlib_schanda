...
(declare-const n Int)
(declare-const i Int)
(declare-const temp___728 (Array Int us_rep3))
...
(assert (= (mk___rep2 (mk___split_fields2 o4 o5)) (select temp___729 i)))
(assert (= o4 o6))
(assert (= o5 o7))
(assert (= o8 o6))
...
(assert (= (tree_structure f) true))
(assert (and (= temp___728 (model__ f t1)) (and (dynamic_invariant2 temp___728 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___728 t1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___728 t1)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 t1)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___728 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___728 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___728 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___728 i1))) true) (not (= i1 t1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___728 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___728 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___728 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___728 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___728 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___728 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___728 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep2 (mk___split_fields2 o o1)) (select temp___728 i)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= o11 o3))
