...
(declare-const temp___1664 (Array Int us_rep3))
...
(assert (and (<= 1 k) (<= k 100)))
(assert (= o15 k))
(assert (= o16 (select temp___1665 o15)))
...
(assert (and (= temp___1664 (model__ f root)) (and (dynamic_invariant5 temp___1664 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1664 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1664 root)))) 0) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (not (= i3 root)) (ite (and (not (= (parent f i3) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1664 (parent f i3)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1664 i3))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1664 i3))) true)))))) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1664 i3))) true) (not (= i3 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1664 (parent f i3)))) (position f i3) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1664 i3)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1664 i3)))) 0)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1664 i3))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1664 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1664 i3))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1664 j1)))) true)) (= j1 i3))))))))))))))
(assert (= o12 (select temp___1664 j)))
