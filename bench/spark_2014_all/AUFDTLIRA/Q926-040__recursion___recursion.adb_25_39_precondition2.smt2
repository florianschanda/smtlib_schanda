...
(define-fun current_increment3 () int__ref (mk_int__ref current_increment))
...
(assert (=> (= result true) (= (mk_int__ref result1) current_increment3)))
(assert (=> (= result true) (= current_increment1 1)))
(assert (=> (not (= result true)) (= (mk_int__ref result2) current_increment3)))
(assert (=> (not (= result true)) (= current_increment2 0)))
(assert (=> (not (= result true)) (= current_increment1 current_increment2)))
(assert (not (= index (to_rep (first (rt arr))))))
(assert (and (= o1 (- index 1)) (in_range3 (- index 1))))
(assert (not (< (to_rep (first (rt arr))) (to_rep (last (rt arr))))))
(check-sat)
(exit)
