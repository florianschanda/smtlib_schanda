...
(assert (not (= kind 6)))
(assert (not (= kind 7)))
(assert (= (to_rep4 t__split_discrs) r46b))
(assert (in_range6 r46b))
...
(assert (= temp___1080 (mk___rep o7 o6 true)))
(assert (= t__attr__constrained true))
(assert (not (= (rec__lexer__token__kind (us_split_discrs1 temp___1080)) t__split_discrs)))
(check-sat)
(exit)
