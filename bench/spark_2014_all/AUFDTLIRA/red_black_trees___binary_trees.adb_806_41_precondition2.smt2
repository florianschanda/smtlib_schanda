...
(assert (= result2 true))
(assert (and (= o14 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1))))) (in_range5 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1)))))))
...
(assert (= o11 (select temp___1522 ki1)))
(assert (= o12 (us_split_fields1 o11)))
(assert (= o13 (rec__tree_model__path_type__a o12)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
...
(assert (= o8 (select temp___1521 ki1)))
