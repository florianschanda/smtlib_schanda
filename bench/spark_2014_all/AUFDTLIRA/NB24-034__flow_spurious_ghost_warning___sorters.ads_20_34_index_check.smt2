...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (=> (not (= smallest2 current1)) (and (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t o13 (mk (to_rep values__first) (to_rep values__last)))) true) (and (= (to_rep (select o13 o7)) (to_rep (select values smallest2))) (and (= (to_rep (select o13 smallest2)) (to_rep (select values o7))) (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 (to_rep values__last))) (=> (and (not (= j1 o7)) (not (= j1 smallest2))) (= (to_rep (select o13 j1)) (to_rep (select values j1))))))))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (=> (not (not (= smallest2 current1))) (= o13 values))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (=> (not (not (= smallest2 current1))) (= o13 values1))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (= (perm_transitive (mk___t temp___221 (mk (to_rep values__first) (to_rep values__last))) (mk___t values_last2 (mk (to_rep values_last__first) (to_rep values_last__last))) (mk___t o13 (mk (to_rep values__first) (to_rep values__last)))) true)))
...
(assert (= result4 true))
(assert (and (= temp___231 (+ j 1)) (in_range1 (+ j 1))))
(assert (and (<= (to_rep values__first) temp___231) (<= temp___231 (to_rep values__last))))
(assert (= o10 temp___231))
(assert (= o11 (select (map__content values7) o10)))
