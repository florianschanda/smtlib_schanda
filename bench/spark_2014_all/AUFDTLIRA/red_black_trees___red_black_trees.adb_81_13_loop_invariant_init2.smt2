...
(assert (< n1 (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res1 i))))))
(assert (not (< (length (rec__tree_model__path_type__a (us_split_fields7 (select m i)))) (- 100 n1))))
(check-sat)
(exit)
