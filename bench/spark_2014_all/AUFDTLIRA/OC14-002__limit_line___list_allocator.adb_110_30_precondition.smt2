...
(assert (and (= o47 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 o47)))
(assert (= result12 (ite (in_range7 o47) true false)))
(assert (=> (= result12 true) (and (= o43 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o43))))
(assert (=> (= result12 true) (= result13 (ite (< j o43) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o44 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o45 (get (rec__list_allocator__m__t__available model____split_fields3) o44)) (in_range4 o45)))))
...
(assert (=> (= result12 true) (= o39 temp___431)))
...
(assert (not (<= o38 (length (rec__list_allocator__m__t__available model____split_fields3)))))
(check-sat)
(exit)
