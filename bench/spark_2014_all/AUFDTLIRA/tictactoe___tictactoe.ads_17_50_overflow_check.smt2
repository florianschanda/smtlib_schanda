...
(assert (in_range2 x))
(assert (in_range2 y))
(assert (=> (<= 3 x) (=> (<= 3 y) (and (= o16 (one_free_slot 3 3 my_board)) (and (in_range o16) (= o16 (ite (= (to_rep (select (select my_board 3) 3)) 0) 1 0)))))))
(assert (=> (<= 3 x) (=> (not (<= 3 y)) (= o16 0))))
(assert (=> (<= 3 x) (=> (<= 2 y) (and (= o13 (one_free_slot 3 2 my_board)) (and (in_range o13) (= o13 (ite (= (to_rep (select (select my_board 3) 2)) 0) 1 0)))))))
(assert (=> (<= 3 x) (=> (not (<= 2 y)) (= o13 0))))
(assert (=> (<= 3 x) (and (= o14 (one_free_slot 3 1 my_board)) (and (in_range o14) (= o14 (ite (= (to_rep (select (select my_board 3) 1)) 0) 1 0))))))
