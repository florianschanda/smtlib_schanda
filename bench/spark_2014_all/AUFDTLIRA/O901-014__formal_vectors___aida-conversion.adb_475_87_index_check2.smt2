...
(assert (and (and (= (length source) 10) (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 52))) (forall ((index3 Int)) (=> (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index3))) true)))))
...
(assert (and (and (forall ((temp___1498 Int)) (=> (and (<= (to_rep1 n__first) temp___1498) (<= temp___1498 (to_rep1 n__last))) (=> (or (< temp___1495 temp___1498) (or (< temp___1498 (to_rep1 (first (rt source)))) (< index2 temp___1498))) (= (select n3 temp___1498) (select n1 temp___1498))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9)))))
