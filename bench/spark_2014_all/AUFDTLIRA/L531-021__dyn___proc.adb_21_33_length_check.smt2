...
(assert (not (= (ite (<= (to_rep item__first) (to_rep item__last)) (+ (- (to_rep item__last) (to_rep item__first)) 1) 0) (ite (<= 1 (ite (<= (to_rep item__first) (to_rep item__last)) (+ (- (to_rep item__last) (to_rep item__first)) 1) 0)) (+ (- (ite (<= (to_rep item__first) (to_rep item__last)) (+ (- (to_rep item__last) (to_rep item__first)) 1) 0) 1) 1) 0))))
(check-sat)
(exit)
