...
(assert (= begidx11 r23b))
(assert (in_range4 r23b))
(assert (= endidx8 r24b))
(assert (in_range4 r24b))
(assert (= result6 (mk_int__ref i)))
(assert (= i2 r23b))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= temp___1621 i2)))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= temp___1619 newdomainname1)))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= temp___1622 endidx8)))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (and (and (<= 1 begidx11) (<= (+ (- endidx8 begidx11) 1) 128)) (= endidx8 temp___1622))))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (and (=> (<= r23b r24b) (dynamic_property r23b r24b i3)) (and (<= r23b i3) (<= i3 r24b)))))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= (to_rep o5) (to_rep (select zonefileline i3)))))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (and (= o3 (+ i3 1)) (in_range1 (+ i3 1)))))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= o4 (- o3 begidx11))))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (and (= temp___1618 o4) (in_range1 o4))))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (and (<= 1 temp___1618) (<= temp___1618 128))))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= o6 temp___1618)))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= o7 (store newdomainname2 o6 o5))))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= result7 (mk_map__ref newdomainname2))))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= newdomainname3 o7)))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= i3 r24b)))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= i4 (mk_int__ref i3))))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= newdomainname4 (mk_map__ref newdomainname3))))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= i5 i3)))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= newdomainname5 newdomainname3)))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= i6 i4)))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= newdomainname6 newdomainname4)))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= i7 i5)))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= newdomainname7 newdomainname5)))
(assert (=> (not (and (<= r23b i2) (<= i2 r24b))) (= i6 (mk_int__ref i2))))
(assert (=> (not (and (<= r23b i2) (<= i2 r24b))) (= newdomainname6 (mk_map__ref newdomainname1))))
(assert (=> (not (and (<= r23b i2) (<= i2 r24b))) (= i7 i2)))
(assert (=> (not (and (<= r23b i2) (<= i2 r24b))) (= newdomainname7 newdomainname1)))
(assert (= (+ endidx8 1) r26b))
...
(assert (<= i8 128))
(assert (<= 1 endidx8))
(assert (and (and (forall ((temp___1626 Int)) (=> (and (<= 1 temp___1626) (<= temp___1626 128)) (=> (or (< 128 temp___1626) (or (< temp___1626 r26b) (<= i9 temp___1626))) (= (select newdomainname8 temp___1626) (select (map__content newdomainname6) temp___1626))))) (=> (<= r26b 128) (dynamic_property1 r26b 128 i9))) (and (<= r26b i9) (<= i9 128))))
(assert (= (to_rep o8) 32))
(assert (= o9 (store newdomainname8 i9 o8)))
(assert (= result9 (mk_map__ref newdomainname8)))
