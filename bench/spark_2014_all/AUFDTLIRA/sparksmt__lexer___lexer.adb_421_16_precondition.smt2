...
(assert (= o6 (concat_singleton_right (temp___String_Literal_923 Tuple0) 1 19 o)))
(assert (= temp___926 (mk___t o6 (mk 1 o5))))
(assert (=> (= (length temp___926) 0) (= o13 (mk___t (temp___String_Literal_925 Tuple0) (mk 1 1)))))
(assert (=> (not (= (length temp___926) 0)) (=> (<= 1 1) (= o7 (+ (- 1 1) 1)))))
(assert (=> (not (= (length temp___926) 0)) (=> (not (<= 1 1)) (= o7 0))))
(assert (=> (not (= (length temp___926) 0)) (=> (<= (to_rep1 (first (rt temp___926))) (to_rep1 (last (rt temp___926)))) (= o8 (+ (- (to_rep1 (last (rt temp___926))) (to_rep1 (first (rt temp___926)))) 1)))))
(assert (=> (not (= (length temp___926) 0)) (=> (not (<= (to_rep1 (first (rt temp___926))) (to_rep1 (last (rt temp___926))))) (= o8 0))))
(assert (=> (not (= (length temp___926) 0)) (= o9 (+ o8 o7))))
(assert (=> (not (= (length temp___926) 0)) (= o10 (+ (to_rep1 (first (rt temp___926))) o9))))
(assert (=> (not (= (length temp___926) 0)) (= o11 (- o10 1))))
(assert (=> (not (= (length temp___926) 0)) (and (= o12 o11) (in_range2 o11))))
(assert (=> (not (= (length temp___926) 0)) (= o13 (mk___t (concat1 (elts temp___926) (to_rep1 (first (rt temp___926))) (to_rep1 (last (rt temp___926))) (temp___String_Literal_925 Tuple0) 1 1) (mk (to_rep1 (first (rt temp___926))) o12)))))
