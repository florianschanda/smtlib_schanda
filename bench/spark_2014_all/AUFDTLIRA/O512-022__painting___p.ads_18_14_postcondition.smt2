...
(declare-const temp___235 (Array Int us_rep))
(declare-const temp___2351 (Array Int us_rep))
...
(assert (= c1 0))
(assert (=> (and (<= 0 c1) (<= c1 2)) (and (= p__split_fields temp___238) (= p__split_fields1 temp___2381))))
(assert (=> (and (<= 0 c1) (<= c1 2)) (= temp___237 c1)))
(assert (=> (and (<= 0 c1) (<= c1 2)) (and (= p__split_fields temp___235) (= p__split_fields1 temp___2351))))
(assert (=> (and (<= 0 c1) (<= c1 2)) (and (= (bool_eq1 p__split_fields4 0 2 temp___238 0 2) true) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- c2 1))) (=> (= (bool_eq (select p__split_fields4 j) d) true) (= (bool_eq (select p__split_fields5 j) d) true)))))))
(assert (=> (and (<= 0 c1) (<= c1 2)) (and (and (and (= p__split_fields4 temp___235) (forall ((temp___236 Int)) (=> (and (<= 0 temp___236) (<= temp___236 2)) (=> (or (< 2 temp___236) (or (< temp___236 0) (<= c2 temp___236))) (= (select p__split_fields5 temp___236) (select temp___2351 temp___236)))))) (=> (<= 0 2) (in_range2 c2))) (and (<= 0 c2) (<= c2 2)))))
