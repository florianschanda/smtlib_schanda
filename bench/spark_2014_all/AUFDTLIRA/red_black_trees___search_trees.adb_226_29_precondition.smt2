...
(assert (= o17 (select temp___1356 i2)))
...
(assert (=> (= result6 true) (= o15 (select temp___1357 o14))))
(assert (=> (= result6 true) (= o16 (us_split_fields5 o15))))
...
(assert (= o10 k))
(assert (= o11 (select temp___1359 o10)))
