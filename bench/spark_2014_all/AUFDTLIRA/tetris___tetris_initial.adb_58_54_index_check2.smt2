...
(assert (<= 0 x1))
(assert (<= x1 2))
(assert (and (forall ((temp___776 Int)) (=> (and (<= 1 temp___776) (<= temp___776 50)) (=> (not (= (+ (to_rep2 cur_piece__split_fields1) y2) temp___776)) (= (select cur_board1 temp___776) (select cur_board temp___776))))) (and (<= 0 x2) (<= x2 2))))
