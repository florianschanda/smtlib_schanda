...
(assert (and (= o15 (- (int__content right11) value)) (in_range1 (- (int__content right11) value))))
(assert (= o16 (abs o15)))
(assert (and (= o17 o16) (in_range1 o16)))
(assert (and (= o13 (- (int__content left11) value)) (in_range1 (- (int__content left11) value))))
(assert (= o14 (abs o13)))
(assert (and (= o18 o14) (in_range1 o14)))
(assert (= result17 (ite (<= o18 o17) true false)))
(assert (not (= result17 true)))
(assert (not (in_range2 (int__content right11))))
(check-sat)
(exit)
