...
(assert (and (= (length source) 8) (forall ((index3 Int)) (=> (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index3))) true)))))
