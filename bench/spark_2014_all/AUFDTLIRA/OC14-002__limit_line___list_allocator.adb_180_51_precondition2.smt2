...
(assert (=> (not (= first_available1 0)) (and (= o38 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o38))))
(assert (=> (not (= first_available1 0)) (= result11 (ite (< 0 o38) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result11 true) (and (= o37 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range4 o37)))))
(assert (=> (not (= first_available1 0)) (=> (= result11 true) (= result10 (ite (= o37 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result11 true)) (= result10 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o39 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o39))))
(assert (=> (not (not (= first_available1 0))) (= result10 (ite (= o39 0) true false))))
...
(assert (= result12 (ite (< 0 o36) true false)))
