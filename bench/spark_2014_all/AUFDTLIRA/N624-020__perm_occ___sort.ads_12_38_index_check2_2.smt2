...
(declare-const temp___275 (Array Int natural))
(declare-const temp___276 Int)
(declare-const temp___280 (Array Int natural))
...
(define-fun values11 () map__ref (mk_map__ref values))
...
(assert (or (and (and (and (= current8 current12) (and (= previous8 previous12) (and (= smallest8 smallest12) (= values7 values11)))) (and (= current9 current1) (and (= previous9 previous1) (and (= smallest9 smallest1) (= values8 values1))))) (and (and (ite (<= (to_rep1 values__first) (to_rep1 values__last)) (= o (+ (- (to_rep1 values__last) (to_rep1 values__first)) 1)) (= o 0)) (= result (ite (= o 0) true false))) (= result true))) (and (and (and (ite (<= (to_rep1 values__first) (to_rep1 values__last)) (= o (+ (- (to_rep1 values__last) (to_rep1 values__first)) 1)) (= o 0)) (= result (ite (= o 0) true false))) (not (= result true))) (and (and (and (= current8 current6) (and (= previous8 previous6) (and (= smallest8 smallest6) (= values7 values5)))) (and (= current9 current7) (and (= previous9 previous7) (and (= smallest9 smallest7) (= values8 values6))))) (and (and (= temp___270 (- (to_rep1 values__last) 1)) (in_range1 (- (to_rep1 values__last) 1))) (and (and (= (mk_int__ref result1) current12) (= current2 (to_rep1 values__first))) (ite (and (<= (to_rep1 values__first) current2) (<= current2 temp___270)) (and (and (and (= temp___279 previous) (and (= temp___277 smallest) (and (= temp___275 values) (and (= temp___276 current2) (and (= temp___280 values) (and (and (and (and (and (and (=> (<= current2 (to_rep1 values__last)) (and (and (<= (to_rep1 values__first) current2) (<= current2 (to_rep1 values__last))) (and (<= (to_rep1 values__first) (to_rep1 values__last)) (<= (to_rep1 values__last) (to_rep1 values__last))))) (= o1 values)) (and (= o1 temp___272) (= (mk2 current2 (to_rep1 values__last)) temp___2721))) (and (= temp___272 o2) (= (mk (to_rep1 (first4 temp___2721)) (to_rep1 (last4 temp___2721))) o3))) (and (= o4 (index_of_minimum (mk___t o2 o3))) (and (in_range3 o4) (and (and (<= (to_rep1 (first o3)) o4) (<= o4 (to_rep1 (last o3)))) (forall ((i1 Int)) (=> (and (<= (to_rep1 (first o3)) i1) (<= i1 (to_rep1 (last o3)))) (<= (to_rep (select o2 o4)) (to_rep (select o2 i1))))))))) (and (= (mk_int__ref result2) smallest12) (= smallest2 o4))) (and (ite (not (= smallest2 current2)) (and (and (and (and (and (= (slide values (to_rep1 values__first) (to_rep1 values__first)) temp___273) (= (mk1 (to_rep1 values__first) (to_rep1 values__last)) temp___2731)) (and (= (ite (<= (to_rep1 (first2 temp___2731)) (to_rep1 (last2 temp___2731))) (+ (- (to_rep1 (last2 temp___2731)) (to_rep1 (first2 temp___2731))) 1) 0) (ite (<= (to_rep1 previous__first) (to_rep1 previous__last)) (+ (- (to_rep1 previous__last) (to_rep1 previous__first)) 1) 0)) (= (mk___t1 o5 o6) (mk___t1 temp___273 temp___2731)))) (= o7 o5)) (and (= (mk_map__ref result3) previous12) (= previous2 o7))) (and (and (= o8 current2) (in_range3 current2)) (and (and (and (= (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t o12 (mk (to_rep1 values__first) (to_rep1 values__last)))) true) (= (to_rep (select o12 o8)) (to_rep (select values smallest2)))) (= (to_rep (select o12 smallest2)) (to_rep (select values o8)))) (forall ((z Int)) (=> (and (<= (to_rep1 values__first) z) (<= z (to_rep1 values__last))) (=> (and (not (= z o8)) (not (= z smallest2))) (= (to_rep (select o12 z)) (to_rep (select values z))))))))) (and (and (= previous2 previous) (= o12 values)) (and (= previous2 previous1) (= o12 values1)))) (and (and (forall ((i1 Int)) (=> (and (<= (to_rep1 values__first) i1) (<= i1 current3)) (forall ((j Int)) (=> (and (<= (+ i1 1) j) (<= j (to_rep1 values__last))) (<= (to_rep (select values2 i1)) (to_rep (select values2 j))))))) (= (is_perm (mk___t temp___280 (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t values2 (mk (to_rep1 values__first) (to_rep1 values__last)))) true)) (and (and (and (=> (<= (to_rep1 values__first) (- (to_rep1 values__last) 1)) (dynamic_property3 (to_rep1 values__first) (- (to_rep1 values__last) 1) current3)) (=> (<= 1 2147483647) (in_range3 smallest3))) (and (<= (to_rep1 values__first) current3) (<= current3 (- (to_rep1 values__last) 1)))) (= current3 temp___270)))))))))) (and (and (= current4 (mk_int__ref current3)) (and (= previous4 (mk_map__ref previous3)) (and (= smallest4 (mk_int__ref smallest3)) (= values3 (mk_map__ref values2))))) (and (= current5 current3) (and (= previous5 previous3) (and (= smallest5 smallest3) (= values4 values2)))))) (and (and (= current6 current4) (and (= previous6 previous4) (and (= smallest6 smallest4) (= values5 values3)))) (and (= current7 current5) (and (= previous7 previous5) (and (= smallest7 smallest5) (= values6 values4)))))) (and (and (= current6 (mk_int__ref current2)) (and (= previous6 previous12) (and (= smallest6 smallest12) (= values5 values11)))) (and (= current7 current2) (and (= previous7 previous1) (and (= smallest7 smallest1) (= values6 values1))))))))))))
...
(assert (and (= result4 (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t (map__content values9) (mk (to_rep1 values__first) (to_rep1 values__last))))) (= (= result4 true) (forall ((e Int)) (=> (and (<= 0 e) (<= e 2147483647)) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e) (occ (mk___t (map__content values9) (mk (to_rep1 values__first) (to_rep1 values__last))) e)))))))
(assert (= result4 true))
(assert (=> (<= (to_rep1 values__first) (to_rep1 values__last)) (= o9 (+ (- (to_rep1 values__last) (to_rep1 values__first)) 1))))
(assert (=> (not (<= (to_rep1 values__first) (to_rep1 values__last))) (= o9 0)))
(assert (= result5 (ite (< 0 o9) true false)))
(assert (= result5 true))
(assert (and (= o10 (- (to_rep1 values__last) 1)) (in_range1 (- (to_rep1 values__last) 1))))
(assert (= o11 (ite (<= i o10) true false)))
(assert (= result6 (ite (<= (to_rep1 values__first) i) o11 false)))
(assert (= result6 true))
(assert (and (= temp___282 (+ i 1)) (in_range1 (+ i 1))))
(assert (not (<= (to_rep1 values__first) temp___282)))
(check-sat)
(exit)
