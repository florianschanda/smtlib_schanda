...
(assert (= (indexqtint rliteral) 100))
...
(assert (= rliteral a__split_fields3))
...
(assert (= a__split_fields7 a__split_fields10))
(assert (= (store a__split_fields8 101 rliteral2) a__split_fields11))
(assert (= (to_rep (select a__split_fields11 101)) 23))
(assert (= a__split_fields12 a__split_fields9))
(assert (= a__split_fields13 a__split_fields10))
(assert (= a__split_fields14 a__split_fields11))
(assert (= (mk___split_fields a__split_fields15 a__split_fields16 a__split_fields17) (mk___split_fields a__split_fields9 a__split_fields10 a__split_fields11)))
(assert (not (= (to_rep (select a__split_fields13 17)) 23)))
(check-sat)
(exit)
