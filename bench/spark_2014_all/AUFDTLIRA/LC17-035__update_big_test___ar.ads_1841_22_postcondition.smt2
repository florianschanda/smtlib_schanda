...
(define-fun dynamic_invariant ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 90 99)) (in_range temp___expr_197)))
(define-fun to_rep ((x it4)) Int (it4qtint x))
...
(define-fun to_rep1 ((x et1)) Int (et1qtint x))
...
(define-fun to_rep2 ((x et2)) Int (et2qtint x))
...
(define-fun bool_eq3 ((a (Array Int us_rep2)) (a__first Int) (a__last Int) (b (Array Int us_rep2)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_161 Int)) (=> (and (<= a__first temp___idx_161) (<= temp___idx_161 a__last)) (= (bool_eq2 (select a temp___idx_161) (select b (+ (- b__first a__first) temp___idx_161))) true)))) true false))
(assert (forall ((a (Array Int us_rep2)) (b (Array Int us_rep2))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_161 Int)) (=> (and (<= a__first temp___idx_161) (<= temp___idx_161 a__last)) (= (bool_eq2 (select a temp___idx_161) (select b (+ (- b__first a__first) temp___idx_161))) true))))))))
...
(declare-fun temp_____aggregate_def_4203 ((Array Int us_rep2) Int us_rep2 Int us_rep2) (Array Int us_rep2))
...
(define-fun dynamic_invariant4 ((temp___expr_246 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool) (temp___do_typ_inv_245 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 4)) (in_range4 temp___expr_246)))
(assert (forall ((temp___4205 (Array Int us_rep2))) (forall ((temp___4206 Int) (temp___4208 Int)) (forall ((temp___4207 us_rep2) (temp___4209 us_rep2)) (let ((temp___4204 (temp_____aggregate_def_4203 temp___4205 temp___4206 temp___4207 temp___4208 temp___4209))) (=> (and (dynamic_invariant temp___4206 true true true true) (dynamic_invariant temp___4208 true true true true)) (forall ((temp___4210 Int)) (ite (= temp___4210 temp___4208) (= (select temp___4204 temp___4210) temp___4209) (ite (= temp___4210 temp___4206) (= (select temp___4204 temp___4210) temp___4207) (= (select temp___4204 temp___4210) (select temp___4205 temp___4210)))))))))))
...
(assert (not (= (bool_eq4 (mk___rep3 (us_split_fields__content3 r__split_fields5)) (mk___rep3 (mk___split_fields3 (of_rep i) (temp_____aggregate_def_4203 r__split_fields1 i (mk___rep2 (let ((usq_ (us_split_fields5 (select r__split_fields1 i)))) (mk___split_fields2 (mk___rep1 (let ((usq_1 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select r__split_fields1 i)))))) (mk___split_fields1 (rec__ar__rec2t__f2 usq_1) (mk___rep (mk___split_fields (of_rep1 e) (rec__ar__rec1t__g1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select r__split_fields1 i))))))))) (rec__ar__rec2t__h2 usq_1)))) (rec__ar__rec5t__g5 usq_) (rec__ar__rec5t__h5 usq_)))) (to_rep r__split_fields) (mk___rep2 (let ((usq_ (us_split_fields5 (select r__split_fields1 (to_rep r__split_fields))))) (mk___split_fields2 (mk___rep1 (let ((usq_1 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select r__split_fields1 (to_rep r__split_fields))))))) (mk___split_fields1 (rec__ar__rec2t__f2 usq_1) (mk___rep (mk___split_fields (of_rep1 e) (rec__ar__rec1t__g1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select r__split_fields1 (to_rep r__split_fields)))))))))) (rec__ar__rec2t__h2 usq_1)))) (rec__ar__rec5t__g5 usq_) (rec__ar__rec5t__h5 usq_)))))))) true)))
(check-sat)
(exit)
