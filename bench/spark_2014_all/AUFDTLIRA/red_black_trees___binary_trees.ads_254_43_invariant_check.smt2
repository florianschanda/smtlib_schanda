...
(assert (= result5 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o45 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 o45) (and (= o45 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= o45 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o45) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o45) i)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) d)))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) d)) (= o45 j1)))))))))
...
(assert (<= j 100))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o42 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j)) (and (in_range2 o42) (and (= o42 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) j))))) (and (=> (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) true) (= o42 0)) (=> (= (size (mk___rep2 (us_split_fields__content2 f__split_fields7))) 0) (= o42 0)))))))
(assert (= o43 (ite (= o42 0) true false)))
(assert (= o44 (ite (not (= o43 true)) true false)))
(assert (= result10 (ite (not (= j v)) o44 false)))
