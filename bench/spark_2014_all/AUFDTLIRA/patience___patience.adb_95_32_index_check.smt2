...
(assert (= o125 (ite (<= o124 (- (to_rep (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o119 i1))
...
(assert (=> (= result23 true) (= temp___681 (to_rep o111))))
...
(assert (=> (= result23 true) (= o114 (to_rep o113))))
...
(assert (=> (= result23 true) (= o116 (to_rep o109))))
...
(assert (=> (= result23 true) (= o107 (to_rep o106))))
