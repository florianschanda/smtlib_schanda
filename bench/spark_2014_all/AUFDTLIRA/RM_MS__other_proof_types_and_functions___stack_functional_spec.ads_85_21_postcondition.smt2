...
(assert (not (= (stack_entry (state__2 (us_split_fields__content my_stack__split_fields4)) (count (state__2 (us_split_fields__content my_stack__split_fields4)))) (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) (- (count (state__2 (us_split_fields__content my_stack__split_fields4))) 1)))))
(check-sat)
(exit)
