...
(define-fun dynamic_invariant3 ((temp___expr_175 us_t) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool) (temp___do_typ_inv_174 Bool)) Bool (=> (not (= temp___skip_constant_172 true)) (dynamic_property 1 2147483647 (first1 temp___expr_175) (last1 temp___expr_175))))
...
(assert (and (<= (to_rep1 x__first) 1) (<= 1 (to_rep1 x__last))))
(assert (= o 1))
(assert (= o1 (select x o)))
(assert (= o2 (to_rep o1)))
(assert (not (<= (to_rep1 i__first) 1)))
(check-sat)
(exit)
