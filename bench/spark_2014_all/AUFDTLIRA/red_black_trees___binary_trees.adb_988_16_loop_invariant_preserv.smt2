...
(assert (=> (and (<= 1 ki1) (<= ki1 100)) (=> (= result3 true) (and (= temp___1782 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant1 temp___1782 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1782 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1782 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1782 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1782 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1782 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1782 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1782 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1782 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1782 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1782 i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1782 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1782 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1782 j)))) true)) (= j i))))))))))))))))
(assert (=> (and (<= 1 ki1) (<= ki1 100)) (=> (= result3 true) (= o (select temp___1782 ki1)))))
(assert (=> (and (<= 1 ki1) (<= ki1 100)) (=> (= result3 true) (= o1 (us_split_fields1 o)))))
(assert (=> (and (<= 1 ki1) (<= ki1 100)) (=> (= result3 true) (= o2 (rec__tree_model__path_type__a o1)))))
(assert (=> (and (<= 1 ki1) (<= ki1 100)) (=> (= result3 true) (and (= o3 (length o2)) (and (in_range1 o3) (<= (+ 0 o3) 2147483647))))))
(assert (=> (and (<= 1 ki1) (<= ki1 100)) (=> (= result3 true) (= result2 (ite (= o3 n2) true false)))))
(assert (=> (and (<= 1 ki1) (<= ki1 100)) (=> (not (= result3 true)) (= result2 false))))
(assert (=> (and (<= 1 ki1) (<= ki1 100)) (=> (= result2 true) (and (= o20 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1))))) (in_range5 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1)))))))))
...
(assert (< (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root) i)))) (int__content n4)))
