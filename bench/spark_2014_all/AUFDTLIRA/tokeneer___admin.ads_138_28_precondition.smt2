...
(assert (= op2 1))
(assert (=> (and (<= 1 op2) (<= op2 4)) (= temp___593 op2)))
(assert (=> (and (<= 1 op2) (<= op2 4)) (= temp___592 theop1)))
(assert (=> (and (<= 1 op2) (<= op2 4)) (= theop2 0)))
(assert (=> (and (<= 1 op2) (<= op2 4)) (and (and (=> (<= 0 4) (in_range7 theop2)) (=> (<= 1 4) (in_range3 op3))) (and (<= 1 op3) (<= op3 4)))))
(assert (=> (and (<= 1 op2) (<= op2 4)) (or (and (and (= theop3 theop4) (= theop5 theop3)) (and (and (= result2 (str_comp keyedop op3)) (= (= result2 true) (and (and (<= (to_rep3 (rec__admin__datat__minmatchlength (us_split_fields3 (select optokeyed op3)))) (to_rep (rec__keyboard__datat__length (us_split_fields1 keyedop)))) (<= (to_rep (rec__keyboard__datat__length (us_split_fields1 keyedop))) (to_rep2 (rec__admin__datat__length (us_split_fields3 (select optokeyed op3)))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep (rec__keyboard__datat__length (us_split_fields1 keyedop))))) (= (to_rep1 (select (rec__admin__datat__text (us_split_fields3 (select optokeyed op3))) i)) (to_rep1 (select (rec__keyboard__datat__text (us_split_fields1 keyedop)) i)))))))) (and (= result2 true) (and (and (and (and (and (<= 1 (to_rep4 (rec__admin__t__rolepresent (us_split_fields5 theadmin)))) (<= (to_rep4 (rec__admin__t__rolepresent (us_split_fields5 theadmin))) 3)) (= o (to_rep4 (rec__admin__t__rolepresent (us_split_fields5 theadmin))))) (= temp___591 (select isavailable o))) (= result3 (select temp___591 op3))) (ite (= result3 true) (and (= theop2 result4) (= theop3 op3)) (= theop3 theop2)))))) (and (and (and (= result2 (str_comp keyedop op3)) (= (= result2 true) (and (and (<= (to_rep3 (rec__admin__datat__minmatchlength (us_split_fields3 (select optokeyed op3)))) (to_rep (rec__keyboard__datat__length (us_split_fields1 keyedop)))) (<= (to_rep (rec__keyboard__datat__length (us_split_fields1 keyedop))) (to_rep2 (rec__admin__datat__length (us_split_fields3 (select optokeyed op3)))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep (rec__keyboard__datat__length (us_split_fields1 keyedop))))) (= (to_rep1 (select (rec__admin__datat__text (us_split_fields3 (select optokeyed op3))) i)) (to_rep1 (select (rec__keyboard__datat__text (us_split_fields1 keyedop)) i)))))))) (and (not (= result2 true)) (= theop3 theop2))) (and (and (= theop3 theop4) (= theop5 theop3)) (= op3 4))))))
...
(assert (= (= o1 true) (exists ((op11 Int)) (and (and (<= 1 op11) (<= op11 4)) (and (and (= (str_comp keyedop op11) true) (= (allowedop theadmin op11) true)) (= admin__opisavailable__result4 op11))))))
(assert (= o2 (ite (= o1 true) (ite (= admin__opisavailable__result4 0) true false) false)))
(assert (= o3 (ite (= o2 false) true false)))
(assert (<= 1 op1))
(assert (<= op1 4))
