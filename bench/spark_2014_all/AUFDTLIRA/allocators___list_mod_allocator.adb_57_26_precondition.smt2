...
(assert (and (= o12 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o12) (<= (+ 0 o12) 2147483647))))
(assert (= result3 (ite (<= o12 10000) true false)))
(assert (=> (= result3 true) (=> (not (= first_available 0)) (and (= o10 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o10) (<= (+ 0 o10) 2147483647))))))
(assert (=> (= result3 true) (=> (not (= first_available 0)) (= result4 (ite (< 0 o10) true false)))))
(assert (=> (= result3 true) (=> (not (= first_available 0)) (=> (= result4 true) (and (= o9 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) 1)) (in_range3 o9))))))
(assert (=> (= result3 true) (=> (not (= first_available 0)) (=> (= result4 true) (= result2 (ite (= o9 first_available) true false))))))
(assert (=> (= result3 true) (=> (not (= first_available 0)) (=> (not (= result4 true)) (= result2 false)))))
(assert (=> (= result3 true) (=> (not (not (= first_available 0))) (and (= o11 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o11) (<= (+ 0 o11) 2147483647))))))
(assert (=> (= result3 true) (=> (not (not (= first_available 0))) (= result2 (ite (= o11 0) true false)))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o7 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o7) (<= (+ 0 o7) 2147483647)))))
(assert (=> (= result2 true) (= o8 (ite (<= j2 o7) true false))))
(assert (=> (= result2 true) (= result5 (ite (<= 1 j2) o8 false))))
...
(assert (=> (= result1 true) (and (= o5 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o5) (<= (+ 0 o5) 2147483647)))))
(assert (=> (= result1 true) (= o6 (ite (<= j1 o5) true false))))
(assert (=> (= result1 true) (= result6 (ite (<= 1 j1) o6 false))))
...
(assert (= result true))
(assert (and (= o (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o) (<= (+ 0 o) 2147483647))))
(assert (= o1 (ite (<= j o) true false)))
(assert (= result7 (ite (<= 1 j) o1 false)))
(assert (= result7 true))
(assert (and (= o2 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o2) (<= (+ 0 o2) 2147483647))))
(assert (= o3 (ite (<= k o2) true false)))
(assert (= result8 (ite (<= 1 k) o3 false)))
(assert (= result8 true))
(assert (and (= o4 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) k)) (in_range3 o4)))
(assert (not (<= j (last (rec__list_mod_allocator__m__t__available (us_split_fields1 m))))))
(check-sat)
(exit)
