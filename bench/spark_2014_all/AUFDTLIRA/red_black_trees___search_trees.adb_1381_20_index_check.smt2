...
(assert (= (to_rep1 t__split_fields) 0))
(assert (and (and (= (size (mk___rep1 binary_trees__init__f__fields)) (+ (size (mk___rep1 (mk___split_fields1 t__split_fields1 t__split_fields2))) 1)) (and (not (= (valid_root (mk___rep1 (mk___split_fields1 t__split_fields1 t__split_fields2)) binary_trees__init__root) true)) (and (= (valid_root (mk___rep1 binary_trees__init__f__fields) binary_trees__init__root) true) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (= (parent (mk___rep1 binary_trees__init__f__fields) i2) (parent (mk___rep1 (mk___split_fields1 t__split_fields1 t__split_fields2)) i2)))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= (parent (mk___rep1 binary_trees__init__f__fields) i2) 0)) (= (position (mk___rep1 binary_trees__init__f__fields) i2) (position (mk___rep1 (mk___split_fields1 t__split_fields1 t__split_fields2)) i2))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (valid_root (mk___rep1 (mk___split_fields1 t__split_fields1 t__split_fields2)) i2) true) (= (valid_root (mk___rep1 binary_trees__init__f__fields) i2) true)))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (and (= (valid_root (mk___rep1 binary_trees__init__f__fields) i2) true) (not (= i2 binary_trees__init__root))) (= (valid_root (mk___rep1 (mk___split_fields1 t__split_fields1 t__split_fields2)) i2) true)))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (valid_root (mk___rep1 (mk___split_fields1 t__split_fields1 t__split_fields2)) i2) true) (= (oeq2 (model__ (mk___rep1 binary_trees__init__f__fields) i2) (model__ (mk___rep1 (mk___split_fields1 t__split_fields1 t__split_fields2)) i2)) true)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 binary_trees__init__root)) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (mk___rep1 binary_trees__init__f__fields) binary_trees__init__root) i2))) true))))))))))))) (and (= (tree_structure (mk___rep1 binary_trees__init__f__fields)) true) (in_range8 binary_trees__init__root))))
(assert (= result1 (mk___split_fields__ref3 (mk___split_fields3 t__split_fields (mk___rep1 (mk___split_fields1 t__split_fields1 t__split_fields2)) t__split_fields3))))
(assert (= t__split_fields4 (mk___split_fields3 t__split_fields (mk___rep1 binary_trees__init__f__fields) t__split_fields3)))
(assert (= result2 (mk_int__ref i)))
(assert (= i1 binary_trees__init__root))
(assert (= (to_rep o) v))
(assert (not (<= i1 100)))
(check-sat)
(exit)
