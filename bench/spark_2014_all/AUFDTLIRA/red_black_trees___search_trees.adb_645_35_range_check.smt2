...
(declare-const i Int)
(declare-const o Int)
(declare-const temp___1874 (Array Int us_rep3))
...
(assert (and (= temp___1874 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o)) (and (dynamic_invariant8 temp___1874 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1874 o))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1874 o)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1874 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1874 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1874 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1874 i1))) true) (not (= i1 o))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1874 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1874 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1874 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1874 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1874 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1874 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1874 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep2 (mk___split_fields2 o1 o2)) (select temp___1874 i)))
(assert (= o1 o3))
(assert (= o2 o4))
(assert (= result o4))
(assert (= result true))
