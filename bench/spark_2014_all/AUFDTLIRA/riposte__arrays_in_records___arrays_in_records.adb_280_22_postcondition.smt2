...
(declare-const temp___423 index)
(declare-const temp___4231 (Array Int value))
(declare-const temp___4232 (Array Int value))
...
(declare-const temp___426 index)
(declare-const temp___4261 (Array Int value))
(declare-const temp___4262 (Array Int value))
...
(assert (= temp___423 o2))
(assert (= temp___4231 o3))
(assert (= temp___4232 o4))
(assert (= result1 a__split_fields))
(assert (= result2 a__split_fields1))
(assert (= result3 a__split_fields2))
(assert (= temp___423 a__split_fields3))
(assert (= temp___4231 a__split_fields4))
(assert (= temp___4232 a__split_fields5))
(assert (= (to_rep o5) tmp1))
(assert (= o6 (store a__split_fields5 j o5)))
(assert (= a__split_fields3 o7))
(assert (= a__split_fields4 o8))
(assert (= o6 o9))
(assert (= temp___426 o7))
(assert (= temp___4261 o8))
(assert (= temp___4262 o9))
(assert (= result4 a__split_fields3))
(assert (= result5 a__split_fields4))
(assert (= result6 a__split_fields5))
(assert (= temp___426 a__split_fields6))
(assert (= temp___4261 a__split_fields7))
(assert (= temp___4262 a__split_fields8))
(assert (= tmp2 tmp1))
