...
(declare-const temp___196 (Array Int character))
...
(assert (=> (= b1 true) (=> (<= pos1 5) (and (and (<= 1 pos1) (<= pos1 5)) (and (<= 1 5) (<= 5 5))))))
(assert (=> (= b1 true) (= o new_str)))
(assert (=> (= b1 true) (= o temp___196)))
(assert (=> (= b1 true) (= (mk pos1 5) temp___1961)))
(assert (=> (= b1 true) (= o1 (bool_eq temp___196 (to_rep1 (first temp___1961)) (to_rep1 (last temp___1961)) new_sub 1 5))))
