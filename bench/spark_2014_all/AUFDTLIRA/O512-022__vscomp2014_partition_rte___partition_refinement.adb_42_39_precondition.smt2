...
(assert (= result5 true))
(assert (and (= o7 (capacity (mk___rep2 p__split_discrs (us_split_fields__content2 p__split_fields2)))) (and (in_range7 o7) (= o7 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (= result6 (ite (= o7 (capacity (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))) true false)))
(assert (= result6 true))
(assert (and (= o6 (length2 (mk___rep2 p__split_discrs (us_split_fields__content2 p__split_fields2)))) (and (in_range7 o6) (<= o6 (capacity (mk___rep2 p__split_discrs (us_split_fields__content2 p__split_fields2)))))))
(assert (= result7 (ite (= o6 (length2 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))) true false)))
(assert (= result7 true))
