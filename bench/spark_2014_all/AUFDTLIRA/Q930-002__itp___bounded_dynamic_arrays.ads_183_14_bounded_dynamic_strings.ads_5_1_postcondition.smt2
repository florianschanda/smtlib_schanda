...
(assert true)
(assert (forall ((within us_rep)) (forall ((fragment us_t)) (! (= (= (contains__2 within fragment) true) (and (and (<= 1 (length fragment)) (<= (length fragment) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))))) (exists ((k Int)) (and (and (<= 1 k) (<= k (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1))) (= (let ((temp___482 (let ((temp___480 (- (+ k (length fragment)) 1))) (let ((temp___481 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within)))) (of_array2 (to_array1 temp___481) k temp___480))))) (bool_eq (to_array2 temp___482) (first5 temp___482) (last5 temp___482) (to_array fragment) (first1 fragment) (last1 fragment))) true))))) :pattern ((contains__2 within fragment))))))
...
(declare-const temp___1303 Int)
(declare-const o6 Int)
(declare-const o7 Int)
(declare-const temp___1300 Int)
(declare-const o8 (Array Int character))
(declare-const temp___1302 (Array Int character))
(declare-const temp___13021 t3)
(declare-const o9 Int)
(declare-const o10 Int)
(declare-const temp___13001 Int)
(declare-const o11 (Array Int character))
(declare-const temp___13022 (Array Int character))
(declare-const temp___13023 t3)
...
(assert (not (<= (int__content bounded_dynamic_strings__location__2__result18) (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 within))))))
(check-sat)
(exit)
