...
(assert (forall ((x tindex_aB)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((i t20b)) (and (<= (- 3) (t20bqtint i)) (<= (t20bqtint i) (- 1)))))
...
(define-fun dynamic_invariant2 ((temp___expr_201 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= (- 3) 15)) (in_range3 temp___expr_201)))
...
(define-fun dynamic_invariant4 ((temp___expr_215 us_t1) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool (=> (not (= temp___skip_constant_212 true)) (dynamic_property1 (- 3) 15 (first3 temp___expr_215) (last3 temp___expr_215))))
(define-fun dynamic_invariant5 ((temp___expr_221 us_t) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (not (= temp___skip_constant_218 true)) (dynamic_property 3 15 (first1 temp___expr_221) (last1 temp___expr_221))))
...
(assert (forall ((temp___288 Int) (temp___289 Int) (temp___290 Int)) (let ((temp___287 (essai05__a__aggregate_def temp___288 temp___289 temp___290))) (=> (and (and (dynamic_invariant1 temp___288 true true true true) (dynamic_invariant1 temp___289 true true true true)) (dynamic_invariant1 temp___290 true true true true)) (and (and (= (select temp___287 (- 3)) rliteral) (= (select temp___287 (- 2)) rliteral1)) (= (select temp___287 (- 1)) rliteral2))))))
(declare-const a (Array Int integer))
(declare-const result (Array Int integer))
(declare-const a1 (Array Int integer))
(assert (= result a))
(assert (= a1 (essai05__a__aggregate_def 0 1 2)))
(assert (= (to_rep a__first) (to_rep (first2 (mk1 (- 3) (- 1))))))
(assert (= (to_rep a__last) (to_rep (last2 (mk1 (- 3) (- 1))))))
(assert (dynamic_property1 (- 3) 15 (to_rep a__first) (to_rep a__last)))
