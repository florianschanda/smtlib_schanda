...
(declare-const o27 us_rep6)
(declare-const o28 us_split_fields10)
...
(declare-const o37 us_rep6)
(declare-const o38 us_split_fields10)
...
(assert (= result8 true))
(assert (and (= o36 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 0)) (and (in_range2 o36) (= o36 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i1 0)))))
(assert (= o37 (select (map__content4 red_black_trees__nb_blacks__result4) o36)))
(assert (= o38 (us_split_fields11 o37)))
(assert (= o39 (rec__red_black_trees__black_count__count o38)))
(assert (= o40 (to_rep o39)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i1)) 0) (= o41 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i1)) 0)) (= o41 0)))
(assert (= o42 (+ o41 o40)))
(assert (and (= o43 o42) (in_range7 o42)))
(assert (= o44 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (map__content4 red_black_trees__nb_blacks__result4) i1)))) o43) true false)))
(assert (and (= o26 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 1)) (and (in_range2 o26) (= o26 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i1 1)))))
(assert (= o27 (select (map__content4 red_black_trees__nb_blacks__result4) o26)))
(assert (= o28 (us_split_fields11 o27)))
(assert (= o29 (rec__red_black_trees__black_count__depth o28)))
(assert (= o30 (to_rep o29)))
(assert (and (= o22 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 0)) (and (in_range2 o22) (= o22 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i1 0)))))
(assert (= o23 (select (map__content4 red_black_trees__nb_blacks__result4) o22)))
(assert (= o24 (us_split_fields11 o23)))
(assert (= o25 (rec__red_black_trees__black_count__depth o24)))
(assert (= o31 (to_rep o25)))
(assert (= o32 (ite (< o31 o30) o30 o31)))
(assert (= o33 (+ 1 o32)))
(assert (and (= o34 o33) (in_range7 o33)))
(assert (= o35 (ite (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (map__content4 red_black_trees__nb_blacks__result4) i1)))) o34) true false)))
(assert (and (= o17 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 1)) (and (in_range2 o17) (= o17 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i1 1)))))
