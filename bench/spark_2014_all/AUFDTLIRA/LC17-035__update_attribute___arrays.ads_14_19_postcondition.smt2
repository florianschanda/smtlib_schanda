...
(declare-fun temp_____aggregate_def_227 (Int Int Int) (Array Int integer))
(declare-fun arrays__f1__arr__aggregate_def (Int) (Array Int integer))
(assert (forall ((temp___407 Int)) (=> (dynamic_invariant temp___407 true true true true) (forall ((temp___408 Int)) (= (to_rep (select (arrays__f1__arr__aggregate_def temp___407) temp___408)) temp___407)))))
(assert (forall ((temp___229 Int) (temp___230 Int) (temp___231 Int)) (let ((temp___228 (temp_____aggregate_def_227 temp___229 temp___230 temp___231))) (=> (and (and (dynamic_invariant temp___229 true true true true) (dynamic_invariant temp___230 true true true true)) (dynamic_invariant temp___231 true true true true)) (forall ((temp___232 Int)) (ite (= temp___232 3) (= (to_rep (select temp___228 temp___232)) temp___230) (ite (and (<= 1 temp___232) (<= temp___232 2)) (= (to_rep (select temp___228 temp___232)) temp___229) (= (to_rep (select temp___228 temp___232)) temp___231))))))))
(define-fun dynamic_invariant1 ((temp___expr_164 Int) (temp___is_init_160 Bool) (temp___skip_constant_161 Bool) (temp___do_toplevel_162 Bool) (temp___do_typ_inv_163 Bool)) Bool (=> (or (= temp___is_init_160 true) (<= 1 8)) (in_range2 temp___expr_164)))
(declare-const x Int)
...
(assert (= arr6 arr4))
(assert (= result5 arrays__f1__result4))
(assert (not (= (bool_eq arrays__f1__result4 1 8 (temp_____aggregate_def_227 x (+ init_val 1) (to_rep (select an_arr 5))) 1 8) true)))
(check-sat)
(exit)
