...
(assert (and (= o5 (- last3 i9)) (in_range1 (- last3 i9))))
(assert (and (= o4 (to__ (mk___rep s__split_fields10))) (dynamic_invariant1 o4 true false true true)))
(assert (= o6 (to_rep (last (rt o4)))))
(assert (= result3 (ite (= o6 o5) true false)))
(assert (= result3 true))
(assert (and (= temp___518 (- last3 i9)) (in_range1 (- last3 i9))))
(assert (=> (<= first2 temp___518) (and (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) first2) (<= first2 (to_rep (last (rt list__reverse_list__L_2__R20b))))) (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) temp___518) (<= temp___518 (to_rep (last (rt list__reverse_list__L_2__R20b))))))))
(assert (= o3 (elts list__reverse_list__L_2__R20b)))
(assert (= temp___520 (mk___t2 o3 (mk2 first2 temp___518))))
(assert (and (= temp___517 (- last3 i9)) (in_range1 (- last3 i9))))
(assert (<= first2 temp___517))
(assert (not (<= (to_rep (first (rt list__reverse_list__L_2__R16b))) first2)))
(check-sat)
(exit)
