...
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o23 (size (mk___rep2 (us_split_fields__content2 f__split_fields7)))) (and (in_range2 o23) (= o23 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))))))
(assert (= result6 (ite (= o23 (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)))) true false)))
(assert (= result6 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
...
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o22 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 o22) (and (= o22 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= o22 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o22) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o22) i)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) d)))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) d)) (= o22 j1)))))))))
(assert (= result8 (ite (= o22 0) true false)))
(assert (= result8 true))
...
(assert (<= j 100))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o18 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j)) (and (in_range2 o18) (and (= o18 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) j))))) (and (=> (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) true) (= o18 0)) (=> (= (size (mk___rep2 (us_split_fields__content2 f__split_fields7))) 0) (= o18 0)))))))
(assert (= o19 (ite (= o18 0) true false)))
(assert (= o20 (ite (not (= o19 true)) true false)))
(assert (= result10 (ite (not (= j (int__content v2))) o20 false)))
(assert (= result10 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o21 (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j)) (and (in_range4 o21) (= o21 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 j))))))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (not (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) 0))))
(check-sat)
(exit)
