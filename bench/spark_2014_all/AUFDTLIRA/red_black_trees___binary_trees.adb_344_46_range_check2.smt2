...
(assert (and (= temp___1104 (model__ f1 root)) (and (dynamic_invariant1 temp___1104 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1104 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1104 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f1 i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1104 (parent f1 i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1104 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1104 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1104 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1104 (parent f1 i)))) (position f1 i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1104 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1104 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1104 i))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1104 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1104 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1104 j2)))) true)) (= j2 i))))))))))))))
...
(assert (= result2 true))
(assert (not (in_range5 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f1)) j1)))))))
(check-sat)
(exit)
