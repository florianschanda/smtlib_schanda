...
(assert (and (= (length source) 11) (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (forall ((index3 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index3))) true))))))
...
(assert (<= temp___2260 index1))
(assert (<= index1 temp___2261))
...
(assert (and (and (forall ((temp___2264 Int)) (=> (and (<= (to_rep1 n__first) temp___2264) (<= temp___2264 (to_rep1 n__last))) (=> (or (< temp___2261 temp___2264) (or (< temp___2264 temp___2260) (< index2 temp___2264))) (= (select n3 temp___2264) (select n1 temp___2264))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
