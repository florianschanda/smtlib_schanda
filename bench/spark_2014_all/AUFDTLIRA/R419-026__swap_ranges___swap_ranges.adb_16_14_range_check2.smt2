...
(declare-const o18 (Array Int t))
(declare-const temp___242 (Array Int t))
(declare-const temp___2421 t3)
...
(assert (=> (<= (to_rep a__first) r11b2) (and (and (<= (to_rep a__first) (to_rep a__first)) (<= (to_rep a__first) (to_rep a__last))) (and (<= (to_rep a__first) r11b2) (<= r11b2 (to_rep a__last))))))
(assert (= o18 a2))
(assert (= temp___242 o18))
(assert (= temp___2421 (mk2 (to_rep a__first) r11b2)))
(assert (<= (to_rep b__first) r8b2))
(assert (not (<= (to_rep b__first) (to_rep b__first))))
(check-sat)
(exit)
