...
(declare-const temp___8014 (Array Int et1))
(declare-const temp___80141 enum2t)
(declare-const o3 et1)
(declare-const o4 (Array Int et1))
(declare-const o5 (Array Int et1))
(declare-const o6 enum2t)
(declare-const temp___8017 (Array Int et1))
(declare-const temp___80171 enum2t)
...
(assert (= o o2))
(assert (= temp___8014 o1))
(assert (= temp___80141 o2))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___8014 r__split_fields2))
(assert (= temp___80141 r__split_fields3))
(assert (= (to_rep o3) e))
(assert (= o4 (store r__split_fields2 i o3)))
(assert (= o4 o5))
(assert (= r__split_fields3 o6))
(assert (= temp___8017 o5))
(assert (= temp___80171 o6))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8017 r__split_fields4))
(assert (= temp___80171 r__split_fields5))
...
(assert (not (in_range3 (to_rep1 r__split_fields7))))
(check-sat)
(exit)
