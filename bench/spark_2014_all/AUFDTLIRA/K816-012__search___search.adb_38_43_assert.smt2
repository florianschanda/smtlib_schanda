...
(assert (< found4 2))
(assert (=> (and (not (= found12 true)) (= (to_rep (select (elts table) i2)) value1)) (= found12 result6)))
(assert (=> (and (not (= found12 true)) (= (to_rep (select (elts table) i2)) value1)) (= found13 (distinct 1 0))))
(assert (=> (and (not (= found12 true)) (= (to_rep (select (elts table) i2)) value1)) (= index12 result7)))
(assert (=> (and (not (= found12 true)) (= (to_rep (select (elts table) i2)) value1)) (= index13 i2)))
(assert (=> (and (not (= found12 true)) (= (to_rep (select (elts table) i2)) value1)) (and (= o (+ found4 1)) (in_range1 (+ found4 1)))))
(assert (=> (and (not (= found12 true)) (= (to_rep (select (elts table) i2)) value1)) (= found4 result8)))
(assert (=> (and (not (= found12 true)) (= (to_rep (select (elts table) i2)) value1)) (= found5 o)))
(assert (=> (and (not (= found12 true)) (= (to_rep (select (elts table) i2)) value1)) (and (= found13 true) (= index13 i2))))
(assert (=> (and (not (= found12 true)) (= (to_rep (select (elts table) i2)) value1)) (<= found5 2)))
(assert (=> (not (and (not (= found12 true)) (= (to_rep (select (elts table) i2)) value1))) (= found5 found4)))
(assert (=> (not (and (not (= found12 true)) (= (to_rep (select (elts table) i2)) value1))) (= index13 index12)))
(assert (=> (not (and (not (= found12 true)) (= (to_rep (select (elts table) i2)) value1))) (= found13 found12)))
(assert (not (= found22 true)))
(assert (= (to_rep (select (elts table) i2)) value2))
(assert (= found22 result9))
(assert (= found23 (distinct 1 0)))
(assert (= index22 result10))
(assert (= index23 i2))
(assert (and (= o1 (+ found5 1)) (in_range1 (+ found5 1))))
(assert (= found5 result11))
(assert (= found6 o1))
(assert (not (= index23 i2)))
(check-sat)
(exit)
