...
(assert (= i8 1))
(assert (=> (and (<= 1 i8) (<= i8 10)) (= temp___413 outkeys_v2)))
(assert (=> (and (<= 1 i8) (<= i8 10)) (= temp___412 i8)))
...
(assert (=> (and (<= 1 i8) (<= i8 10)) (and (and (=> (<= 1 10) (in_range2 i9)) (forall ((temp___414 Int)) (=> (and (<= 1 temp___414) (<= temp___414 10)) (=> (or (< 10 temp___414) (or (< temp___414 1) (< i9 temp___414))) (= (select outkeys_v23 temp___414) (select temp___413 temp___414)))))) (and (<= 1 i9) (<= i9 10)))))
