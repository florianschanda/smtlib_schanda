...
(assert (<= 31 i15))
(assert (<= i15 40))
(assert (and (and (=> (<= 31 40) (dynamic_property3 31 40 i16)) (forall ((temp___344 Int)) (=> (and (<= (to_rep a__first) temp___344) (<= temp___344 (to_rep a__last))) (=> (or (<= i16 temp___344) (or (< 40 temp___344) (< temp___344 31))) (= (select a14 temp___344) (select (map__content a12) temp___344)))))) (and (<= 31 i16) (<= i16 40))))
(assert (= (to_rep (first4 (rt2 (temp_____aggregate_def_318 3 i16 i16)))) i16))
(assert (= (to_rep (last4 (rt2 (temp_____aggregate_def_318 3 i16 i16)))) i16))
(assert (= (mk___t2 temp___325 temp___3251) (temp_____aggregate_def_318 3 i16 i16)))
(assert (= (ite (<= (to_rep (first4 temp___3251)) (to_rep (last4 temp___3251))) (+ (- (to_rep (last4 temp___3251)) (to_rep (first4 temp___3251))) 1) 0) (ite (<= i16 i16) (+ (- i16 i16) 1) 0)))
(assert (= (slide temp___325 (to_rep (first4 temp___3251)) i16) temp___326))
(assert (= (mk1 i16 i16) temp___3261))
(assert (=> (<= 31 40) (and (and (<= (to_rep a__first) 31) (<= 31 (to_rep a__last))) (and (<= (to_rep a__first) 40) (<= 40 (to_rep a__last))))))
(assert (= temp___329 a14))
(assert (= temp___330 temp___329))
(assert (<= i16 i16))
(assert (not (<= i16 40)))
(check-sat)
(exit)
