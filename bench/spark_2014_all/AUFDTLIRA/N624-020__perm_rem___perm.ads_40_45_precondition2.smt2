...
(assert (forall ((a1 us_t)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant a1 true true true true) (dynamic_invariant4 i true true true true)) (and (= (invariant__ a1) true) (and (<= (first1 a1) i) (<= i (last1 a1))))) (let ((result (remove a1 i))) (and (and (= (invariant__ result) true) (and (= (last1 result) (- (last1 a1) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i 1))) (= (to_rep1 (select (to_array a1) k)) (to_rep1 (select (to_array result) k))))) (and (forall ((k Int)) (=> (and (<= (+ i 1) k) (<= k (last1 a1))) (= (to_rep1 (select (to_array a1) k)) (to_rep1 (select (to_array result) (- k 1)))))) (forall ((k Int)) (=> (and (<= i k) (<= k (- (last1 a1) 1))) (= (to_rep1 (select (to_array a1) (+ k 1))) (to_rep1 (select (to_array result) k))))))))) (dynamic_invariant result true false true true)))) :pattern ((remove a1 i))))))
