...
(assert (= (ite (<= (to_rep (first2 temp___2781)) (to_rep (last2 temp___2781))) (+ (- (to_rep (last2 temp___2781)) (to_rep (first2 temp___2781))) 1) 0) (ite (<= 0 x) (+ (- x 0) 1) 0)))
(assert (= temp___278 temp___279))
(assert (= (mk (to_rep (first2 temp___2781)) (to_rep (last2 temp___2781))) temp___2791))
(assert (not (= (ite (<= (to_rep (first temp___2791)) (to_rep (last temp___2791))) (+ (- (to_rep (last temp___2791)) (to_rep (first temp___2791))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0))))
(check-sat)
(exit)
