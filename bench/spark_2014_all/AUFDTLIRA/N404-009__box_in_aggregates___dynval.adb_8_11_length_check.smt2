...
(assert (not (= (ite (<= (to_rep (first3 temp___1801)) (to_rep (last3 temp___1801))) (+ (- (to_rep (last3 temp___1801)) (to_rep (first3 temp___1801))) 1) 0) (ite (<= first last) (+ (- last first) 1) 0))))
(check-sat)
(exit)
