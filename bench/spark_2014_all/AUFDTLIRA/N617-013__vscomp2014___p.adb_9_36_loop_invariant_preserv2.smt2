...
(assert (and (and (forall ((temp___179 Int)) (=> (and (<= 1 temp___179) (<= temp___179 10)) (=> (or (< 10 temp___179) (or (< temp___179 1) (< i2 temp___179))) (= (select f2 temp___179) (select f temp___179))))) (=> (<= 1 10) (in_range1 i2))) (and (<= 1 i2) (<= i2 10))))
(assert (not (= i2 10)))
(assert (= result3 i2))
(assert (= i3 (+ i2 1)))
(assert (= (to_rep o2) j1))
