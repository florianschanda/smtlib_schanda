...
(assert (= (bool_eq7 a1 0 5 a_update 0 5) true))
(assert (forall ((c1 us_rep3)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c1) true) (=> (and (not (= (key (mk___rep d__split_discrs d__split_fields1) c1) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs d__split_fields1) c1) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields1) c1))) (key (mk___rep d__split_discrs d__split_fields1) c1))))))
(assert (forall ((c1 us_rep3)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c1) true) (=> (= (key (mk___rep d__split_discrs d__split_fields1) c1) (to_rep (select a1 i))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields1) c1))) (key (mk___rep d__split_discrs d__split_fields1) c1))))))
...
(assert (= (bool_eq7 a1 0 5 a_update 0 5) true))
(assert (forall ((c1 us_rep3)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c1) true) (=> (and (not (= (key (mk___rep d__split_discrs d__split_fields2) c1) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs d__split_fields2) c1) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c1))) (key (mk___rep d__split_discrs d__split_fields2) c1))))))
(assert (forall ((c1 us_rep3)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c1) true) (=> (= (key (mk___rep d__split_discrs d__split_fields2) c1) (to_rep (select a1 i))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c1))) (key (mk___rep d__split_discrs d__split_fields2) c1))))))
(assert (forall ((c1 us_rep3)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c1) true) (=> (= (key (mk___rep d__split_discrs d__split_fields2) c1) (to_rep (select a1 j))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c1))) (key (mk___rep d__split_discrs d__split_fields2) c1))))))
