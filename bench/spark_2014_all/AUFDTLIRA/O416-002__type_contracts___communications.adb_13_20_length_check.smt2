...
(assert (= (to_rep (rec__communications__communication__num coms__split_discrs)) (length1 a)))
...
(assert (not (= (ite (<= (to_rep1 (first2 (rt1 a))) (to_rep1 (last2 (rt1 a)))) (+ (- (to_rep1 (last2 (rt1 a))) (to_rep1 (first2 (rt1 a)))) 1) 0) (ite (<= 1 (length1 a)) (+ (- (length1 a) 1) 1) 0))))
(check-sat)
(exit)
