...
(assert (= result9 (ite (<= o16 (to_rep (last (rt a)))) true false)))
(assert (=> (= result9 true) (and (= o15 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result9 true) (= result8 (ite (<= o15 (to_rep (last (rt a)))) true false))))
