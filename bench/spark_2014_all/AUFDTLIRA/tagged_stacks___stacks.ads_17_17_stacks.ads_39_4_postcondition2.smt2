...
(declare-const stacks__get_model__2__result (Array Int element))
(declare-const stacks__get_model__2__result1 t)
...
(declare-const stacks__get_model__2__result2 (Array Int element))
(declare-const stacks__get_model__2__result3 t)
(declare-const stacks__get_model__2__result4 (Array Int element))
(declare-const stacks__get_model__2__result5 t)
(declare-const stacks__get_model__2__result6 (Array Int element))
(declare-const stacks__get_model__2__result7 t)
(declare-const stacks__get_model__2__result8 (Array Int element))
(declare-const stacks__get_model__2__result9 t)
(declare-const stacks__get_model__2__result10 (Array Int element))
(declare-const stacks__get_model__2__result11 t)
(define-fun stacks__get_model__2__result12 () us_t (mk___t stacks__get_model__2__result2 stacks__get_model__2__result3))
(declare-const result2 (Array Int element))
(declare-const result3 t)
(assert (= stacks__get_model__2__result4 stacks__get_model__2__result2))
(assert (= stacks__get_model__2__result5 stacks__get_model__2__result3))
(assert (= (mk___t stacks__get_model__2__result6 stacks__get_model__2__result7) stacks__get_model__2__result12))
...
(assert (dynamic_property 1 2147483647 (to_rep2 (first2 temp___5081)) (to_rep2 (last2 temp___5081))))
(assert (= temp___508 o1))
(assert (= (mk (to_rep2 (first2 temp___5081)) (to_rep2 (last2 temp___5081))) o2))
(assert (= result stacks__get_model__2__result))
(assert (= result1 stacks__get_model__2__result1))
(assert (= stacks__get_model__2__result12 (mk___t o1 o2)))
(assert (= (mk_model____ref (mk___t stacks__get_model__2__result8 stacks__get_model__2__result9)) (mk_model____ref (mk___t stacks__get_model__2__result4 stacks__get_model__2__result5))))
(assert (= stacks__get_model__2__result10 stacks__get_model__2__result6))
(assert (= stacks__get_model__2__result11 stacks__get_model__2__result7))
(assert (= result2 stacks__get_model__2__result8))
(assert (= result3 stacks__get_model__2__result9))
(assert (not (= (length (mk___t stacks__get_model__2__result8 stacks__get_model__2__result9)) (size s))))
(check-sat)
(exit)
