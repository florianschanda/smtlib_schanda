...
(assert (=> (not (= (contains model____split_fields1 res) true)) (= (oeq1 (mk___rep (us_split_fields__content model____split_fields6)) (mk___rep (mk___split_fields model____split_fields model____split_fields1))) true)))
