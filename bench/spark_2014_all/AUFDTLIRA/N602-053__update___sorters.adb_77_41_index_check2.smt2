...
(assert (= result2 true))
(assert (and (= temp___214 (+ j 1)) (in_range1 (+ j 1))))
(assert (not (<= (to_rep values__first) temp___214)))
(check-sat)
(exit)
