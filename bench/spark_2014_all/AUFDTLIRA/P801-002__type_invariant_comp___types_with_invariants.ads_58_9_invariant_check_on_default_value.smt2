...
(define-fun temp___2552 () us_t3 (mk___t3 temp___255 temp___2551))
(assert (in_range2 temp___c_270))
(assert (and (= us 0) (in_range5 0)))
(assert (dynamic_invariant3 temp___2552 true false true true))
(assert (forall ((temp___257 Int)) (=> (and (<= (to_rep (first6 temp___2551)) temp___257) (<= temp___257 (to_rep (last6 temp___2551)))) (= (to_rep (select temp___255 temp___257)) 1))))
(assert (not (type_invariant3 temp___2552)))
(check-sat)
(exit)
