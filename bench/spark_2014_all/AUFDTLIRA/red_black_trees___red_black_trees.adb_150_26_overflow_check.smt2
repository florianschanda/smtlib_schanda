...
(assert (= o3 (rec__red_black_trees__black_count__count o2)))
(assert (= o4 (to_rep o3)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0) (= o5 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0)) (= o5 0)))
(assert (= o6 (+ o5 o4)))
(assert (not (in_range7 o6)))
(check-sat)
(exit)
