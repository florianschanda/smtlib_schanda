...
(assert (and (= o22 (remove (mk___t values2 (mk 1 100)) o16)) (and (dynamic_invariant3 o22 true false true true) (and (= (invariant__ o22) true) (and (= (to_rep1 (last o18)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o16 1))) (= (to_rep (select values2 k)) (to_rep (select o17 k))))) (and (forall ((k Int)) (=> (and (<= (+ o16 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select o17 (- k 1)))))) (forall ((k Int)) (=> (and (<= o16 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select o17 k))))))))))))
(assert (and (= o13 y) (in_range4 y)))
(assert (and (= o23 (remove (mk___t interm1 (mk 1 100)) o13)) (and (dynamic_invariant3 o23 true false true true) (and (= (invariant__ o23) true) (and (= (to_rep1 (last o15)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select interm1 k)) (to_rep (select o14 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select o14 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select o14 k))))))))))))
(assert (and (= o20 (remove_eq o23 o22 o19)) (and (in_range5 o20) (=> (= (distinct o20 0) true) (= (let ((temp___188 (remove o22 o19))) (let ((temp___187 (remove o23 o19))) (bool_eq (elts temp___187) (to_rep1 (first (rt temp___187))) (to_rep1 (last (rt temp___187))) (elts temp___188) (to_rep1 (first (rt temp___188))) (to_rep1 (last (rt temp___188)))))) true)))))
(assert (= result4 (mk_int__ref hr1)))
(assert (= hr2 o20))
(assert (and (= o21 x) (in_range4 x)))
