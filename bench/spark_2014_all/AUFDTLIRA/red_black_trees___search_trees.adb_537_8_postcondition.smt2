...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f1 root) i))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f1 root) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) i))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) i)))) 1)) 0) (< (to_rep (select values j)) (to_rep (select values i))) (< (to_rep (select values i)) (to_rep (select values j))))))))))
(assert (not (= (ordered_leafs f1 root values) true)))
(check-sat)
(exit)
