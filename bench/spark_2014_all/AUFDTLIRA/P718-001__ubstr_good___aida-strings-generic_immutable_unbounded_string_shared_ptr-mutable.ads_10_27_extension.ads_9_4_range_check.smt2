...
(declare-datatypes () ((mutable_t__ref1 (mk_mutable_t__ref1 (mutable_t__content1 us_rep)))))
(define-fun mutable_t__ref___2__projection ((a mutable_t__ref1)) us_rep (mutable_t__content1 a))
...
(assert (forall ((this us_rep)) (! (= (length1 this) (length2 us_tag2 this)) :pattern ((length2 us_tag2 this)))))
...
(define-fun default_initial_assumption ((temp___expr_883 us_rep) (temp___skip_top_level_884 Bool)) Bool (and (= (attr__tag temp___expr_883) us_tag2) (=> (not (= temp___skip_top_level_884 true)) (= (length1 temp___expr_883) 0))))
...
(define-fun default_initial_assumption2 ((temp___expr_856 us_rep) (temp___skip_top_level_857 Bool)) Bool (and (= (attr__tag temp___expr_856) us_tag1) (=> (not (= temp___skip_top_level_857 true)) (= (length1 temp___expr_856) 0))))
(declare-const o Int)
(declare-const this__split_fields us_main_type)
(declare-const this__split_fields1 us_private)
(assert (dynamic_invariant text true false true true))
(assert (and (= o (length1 (mk___rep (mk___split_fields this__split_fields this__split_fields1) this__attr__tag))) (in_range3 o)))
(assert (not (in_range4 (length text))))
(check-sat)
(exit)
