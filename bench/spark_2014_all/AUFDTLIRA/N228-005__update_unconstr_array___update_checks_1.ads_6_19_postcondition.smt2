...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (let ((temp___431 (temp_____aggregate_def_248 (mk___t a (mk (to_rep a__first) (to_rep a__last))) i new_val))) (bool_eq a2 (to_rep a__first) (to_rep a__last) (elts temp___431) (to_rep (first (rt temp___431))) (to_rep (last (rt temp___431))))) true)))
(check-sat)
(exit)
