...
(assert (and (= o6 (length2 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))) (and (in_range7 o6) (<= o6 (capacity (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))))))
...
(assert (= result1 true))
(assert (and (= o2 (length2 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))) (and (in_range7 o2) (<= o2 (capacity (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))))))
(assert (= o3 (- o2 1)))
