...
(declare-fun user_eq5 (tlast_charS tlast_charS) Bool)
...
(define-fun dynamic_invariant ((temp___expr_652 Int) (temp___is_init_648 Bool) (temp___skip_constant_649 Bool) (temp___do_toplevel_650 Bool) (temp___do_typ_inv_651 Bool)) Bool (=> (or (= temp___is_init_648 true) (<= 0 1024)) (in_range4 temp___expr_652)))
