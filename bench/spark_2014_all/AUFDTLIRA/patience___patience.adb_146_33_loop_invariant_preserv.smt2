...
(assert (and (and (= (inv (mk___rep (mk___split_fields s__split_fields24 s__split_fields25 s__split_fields26 s__split_fields27 s__split_fields28 s__split_fields29 s__split_fields30 s__split_fields31))) true) (= (to_rep1 (select s__split_fields25 (to_rep s__split_fields16))) (to_rep1 (select (elts cards) i2)))) (= (to_rep s__split_fields24) (+ (to_rep s__split_fields16) 1))))
(assert (not (= i2 (to_rep2 (last (rt cards))))))
(assert (= result9 i2))
(assert (= i3 (+ i2 1)))
(assert (not (= (to_rep s__split_fields24) (- i3 (to_rep2 (first (rt cards)))))))
(check-sat)
(exit)
