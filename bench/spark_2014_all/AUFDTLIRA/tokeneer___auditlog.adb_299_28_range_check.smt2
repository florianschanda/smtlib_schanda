...
(assert (= (concat1 (temp___String_Literal_1742 Tuple0) 1 55 firsttime1 1 21) temp___1745))
(assert (= (mk 1 o7) temp___17451))
(assert (not (= (length (mk___t temp___1745 temp___17451)) 0)))
(assert (=> (<= 1 5) (= o8 (+ (- 5 1) 1))))
(assert (=> (not (<= 1 5)) (= o8 0)))
(assert (=> (<= (to_rep1 (first temp___17451)) (to_rep1 (last temp___17451))) (= o9 (+ (- (to_rep1 (last temp___17451)) (to_rep1 (first temp___17451))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___17451)) (to_rep1 (last temp___17451)))) (= o9 0)))
(assert (= o10 (+ o9 o8)))
(assert (= o11 (+ (to_rep1 (first temp___17451)) o10)))
(assert (= o12 (- o11 1)))
