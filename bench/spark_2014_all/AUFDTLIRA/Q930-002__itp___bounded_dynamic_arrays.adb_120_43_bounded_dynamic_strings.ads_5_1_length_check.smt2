...
(assert (not (= (ite (<= (to_rep2 (first8 temp___10931)) (to_rep2 (last9 temp___10931))) (+ (- (to_rep2 (last9 temp___10931)) (to_rep2 (first8 temp___10931))) 1) 0) (ite (<= 1 last6) (+ (- last6 1) 1) 0))))
(check-sat)
(exit)
