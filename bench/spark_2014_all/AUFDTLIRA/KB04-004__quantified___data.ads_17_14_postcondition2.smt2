...
(declare-const temp___188 (Array Int Bool))
...
(define-fun x10 () map__ref (mk_map__ref x6))
(assert (= x x_old))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___190 i1)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___188 x)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i2 1))) (= (= (select x2 k) true) (not (= (select x_old k) true))))) (forall ((k Int)) (=> (and (<= i2 k) (<= k 10)) (= (= (select x2 k) true) (= (select x_old k) true)))))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (and (forall ((temp___189 Int)) (=> (and (<= 1 temp___189) (<= temp___189 10)) (=> (or (< 10 temp___189) (or (< temp___189 1) (<= i2 temp___189))) (= (select x2 temp___189) (select temp___188 temp___189))))) (=> (<= 1 10) (in_range2 i2))) (and (<= 1 i2) (<= i2 10)))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= x2 result1)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= x3 (store x2 i2 (ite (not (= (select x2 i2) true)) true false)))))
...
(assert (=> (and (<= 1 i1) (<= i1 10)) (= x10 (mk_map__ref x4))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= i6 i4)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= x7 x5)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= i1 i5)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= x10 (mk_map__ref x))))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= i6 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= x7 x1)))
(assert (= i7 i5))
(assert (= (mk_map__ref x8) x10))
(assert (= i8 i6))
(assert (= x9 x7))
(declare-const i9 Int)
(assert (<= 1 i9))
(assert (<= i9 10))
(assert (= (select x8 i9) true))
(assert (not (not (= (select x i9) true))))
(check-sat)
(exit)
