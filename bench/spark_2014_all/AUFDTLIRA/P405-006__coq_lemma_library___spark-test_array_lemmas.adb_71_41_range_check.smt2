...
(assert (forall ((i Int)) (=> (and (<= (+ (to_rep (first2 (rt1 arr))) 1) i) (<= i (to_rep (last2 (rt1 arr))))) (< (to_rep (select (elts1 arr) (- i 1))) (to_rep (select (elts1 arr) i))))))
(assert (not (dynamic_property (- 2147483648) 2147483647 (to_rep (first2 (rt1 arr))) (to_rep (last2 (rt1 arr))))))
(check-sat)
(exit)
