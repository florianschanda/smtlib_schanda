...
(assert (forall ((x value)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x index)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 1001)) (in_range1 temp___expr_166)))
(define-fun dynamic_invariant1 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= (- 23) 69)) (in_range temp___expr_173)))
(declare-const rliteral value)
(assert (= (valueqtint rliteral) 42))
...
(assert (= (store a__split_fields1 17 rliteral) a__split_fields4))
(assert (= a__split_fields2 a__split_fields5))
...
(assert (not (= (to_rep (select a__split_fields10 17)) 42)))
(check-sat)
(exit)
