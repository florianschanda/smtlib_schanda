...
(define-fun o5 () us_rep (mk___rep (mk___split_discrs o1) (mk___split_fields o2 (mk___t o3 o4))))
...
(assert (and (= o5 (instance o content)) (and (dynamic_invariant1 o5 true false true true) (and (and (= (to_rep1 o1) o) (= (length1 o5) (length2 content))) (= (let ((temp___274 (value o5))) (bool_eq (elts1 temp___274) (to_rep2 (first2 (rt1 temp___274))) (to_rep2 (last2 (rt1 temp___274))) (elts1 content) (to_rep2 (first2 (rt1 content))) (to_rep2 (last2 (rt1 content))))) true)))))
...
(assert (= bounded_dynamic_strings__instance__3__result15 o5))
