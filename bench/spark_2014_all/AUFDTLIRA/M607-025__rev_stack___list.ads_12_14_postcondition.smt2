...
(assert (= i8 first4))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= temp___529 i8)))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___528 temp___5281))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (and (= res__split_discrs (mk___split_discrs temp___527)) (= res__split_fields1 (mk___split_fields1 temp___5271)))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (= temp___531 (mk___rep (us_split_fields__content s__split_fields7)))))
(assert (=> (and (<= first4 i8) (<= i8 last5)) (and (and (and (= (length2 (mk___rep1 res__split_discrs res__split_fields2)) (- i9 first4)) (= (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) (+ (- last5 i9) 1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (+ (- last5 i9) 1))) (= (to_rep (select (elts (to__ (mk___rep s__split_fields9))) j)) (to_rep (select (elts (to__ temp___531)) j)))))) (forall ((j Int)) (=> (and (<= first4 j) (<= j (- i9 1))) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields2)) j) (get (model__ l) (+ (- last5 j) first4))))))))
