...
(define-fun bool_eq2 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep (rec__union_init__union_test__discr (us_split_discrs1 a))) (to_rep (rec__union_init__union_test__discr (us_split_discrs1 b)))) (and (and (=> (union_init__union_test__field1__pred a) (= (to_rep (rec__union_init__union_test__field1 (us_split_fields3 a))) (to_rep (rec__union_init__union_test__field1 (us_split_fields3 b))))) (=> (union_init__union_test__field2__pred a) (= (bool_eq1 (rec__union_init__union_test__field2 (us_split_fields3 a)) (rec__union_init__union_test__field2 (us_split_fields3 b))) true))) (=> (union_init__union_test__field3__pred a) (= (to_rep1 (rec__union_init__union_test__field3 (us_split_fields3 a))) (to_rep1 (rec__union_init__union_test__field3 (us_split_fields3 b))))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_184 us_rep1) (temp___skip_top_level_185 Bool)) Bool (and (= (attr__constrained temp___expr_184) false) (and (and (and (= (to_rep (rec__union_init__union_test__discr (us_split_discrs1 temp___expr_184))) 0) (=> (union_init__union_test__field1__pred temp___expr_184) (= (to_rep (rec__union_init__union_test__field1 (us_split_fields3 temp___expr_184))) 0))) (=> (union_init__union_test__field2__pred temp___expr_184) (and (= (to_rep (rec__union_init__basic_record__length (us_split_fields1 (rec__union_init__union_test__field2 (us_split_fields3 temp___expr_184))))) 0) (= (rec__union_init__basic_record__basic_array (us_split_fields1 (rec__union_init__union_test__field2 (us_split_fields3 temp___expr_184)))) (temp_____aggregate_def_173 0))))) (=> (union_init__union_test__field3__pred temp___expr_184) (= (to_rep1 (rec__union_init__union_test__field3 (us_split_fields3 temp___expr_184))) 0)))))
...
(define-fun default_initial_assumption1 ((temp___expr_171 us_rep) (temp___skip_top_level_172 Bool)) Bool (and (= (to_rep (rec__union_init__basic_record__length (us_split_fields1 temp___expr_171))) 0) (= (rec__union_init__basic_record__basic_array (us_split_fields1 temp___expr_171)) (temp_____aggregate_def_173 0))))
(declare-const rliteral integer)
(assert (= (integerqtint rliteral) 0))
(assert (forall ((temp___175 Int)) (=> (dynamic_invariant temp___175 true true true true) (forall ((temp___176 Int)) (= (select (temp_____aggregate_def_173 temp___175) temp___176) rliteral)))))
...
(assert (not (= rliteral1 test__split_discrs)))
(check-sat)
(exit)
