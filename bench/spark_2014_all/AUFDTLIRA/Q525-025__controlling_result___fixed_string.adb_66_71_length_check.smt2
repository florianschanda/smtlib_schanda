...
(assert (not (= (ite (<= (to_rep1 (first2 temp___2571)) (to_rep1 (last2 temp___2571))) (+ (- (to_rep1 (last2 temp___2571)) (to_rep1 (first2 temp___2571))) 1) 0) (ite (<= (to_rep1 (first2 temp___2591)) (to_rep1 (last2 temp___2591))) (+ (- (to_rep1 (last2 temp___2591)) (to_rep1 (first2 temp___2591))) 1) 0))))
(check-sat)
(exit)
