...
(declare-const temp___1521 (Array Int us_rep3))
...
(assert (= (mk___rep2 (mk___split_fields2 o14 o15)) (select temp___1523 i)))
(assert (= o14 o16))
(assert (= o15 o17))
(assert (= o18 o16))
...
(assert (= (mk___rep2 (mk___split_fields2 o9 o10)) (select temp___1522 i)))
(assert (= o9 o11))
(assert (= o10 o12))
(assert (= o13 o11))
(assert (and (= temp___1521 (model__ f_old root)) (and (dynamic_invariant5 temp___1521 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1521 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1521 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f_old i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1521 (parent f_old i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1521 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1521 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1521 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1521 (parent f_old i1)))) (position f_old i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1521 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1521 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1521 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1521 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1521 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1521 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep2 (mk___split_fields2 o4 o5)) (select temp___1521 v)))
(assert (= o4 o6))
(assert (= o5 o7))
(assert (= o8 o6))
