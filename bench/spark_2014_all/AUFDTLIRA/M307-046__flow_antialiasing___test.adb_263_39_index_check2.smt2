...
(assert (forall ((i t110b)) (and (<= 3 (t110bqtint i)) (<= (t110bqtint i) 12))))
(define-fun in_range3 ((x Int)) Bool (and (<= 3 x) (<= x 12)))
(declare-fun attr__ATTRIBUTE_IMAGE3 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Int)
(declare-fun user_eq4 (t110b t110b) Bool)
(declare-const dummy4 t110b)
...
(assert (= temp___548 a))
(assert (= test__op_string_char__x__compl temp___548))
(assert (and (<= (to_rep1 a__first) n) (<= n (to_rep1 a__last))))
(assert (= o n))
...
(assert (forall ((temp___551 Int)) (ite (and (<= 3 temp___551) (<= temp___551 12)) (= (select o5 temp___551) (select (slide test__op_string_char__x (to_rep1 (first (mk 3 12))) 3) temp___551)) (= (select o5 temp___551) (select a temp___551)))))
(assert (= result a))
(assert (= a1 o5))
(assert (= (to_rep o6) test__op_string_char__y1))
(assert (not (<= (to_rep1 a__first) n)))
(check-sat)
(exit)
