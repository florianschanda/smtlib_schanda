...
(assert (and (and (<= (to_rep1 (first (rt values))) min3) (<= min3 (to_rep1 (last (rt values))))) (forall ((i Int)) (=> (and (<= (to_rep1 (first (rt values))) i) (<= i index3)) (<= (to_rep (select (elts values) min3)) (to_rep (select (elts values) i)))))))
...
(assert (and (<= (to_rep1 (first (rt values))) min3) (<= min3 (to_rep1 (last (rt values))))))
(assert (= o5 min3))
(assert (= o6 (select (elts values) o5)))
(assert (= o7 (to_rep o6)))
(assert (= result5 (ite (< (to_rep (select (elts values) index4)) o7) true false)))
(assert (=> (= result5 true) (and (= o8 index4) (in_range2 index4))))
(assert (=> (= result5 true) (= result6 min3)))
(assert (=> (= result5 true) (= min4 o8)))
(assert (=> (not (= result5 true)) (= min4 min3)))
(assert (not (<= min4 (to_rep1 (last (rt values))))))
(check-sat)
(exit)
