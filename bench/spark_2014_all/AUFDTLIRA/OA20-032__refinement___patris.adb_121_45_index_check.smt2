...
(assert (forall ((yy Int)) (=> (and (<= 0 yy) (<= yy 3)) (forall ((xx Int)) (=> (and (<= 0 xx) (<= xx 3)) (=> (= (get (select possible_i_shapes (to_rep3 cur_piece__split_fields1)) yy xx) true) (= (is_empty cur_board (+ (to_rep2 cur_piece__split_fields3) yy) (+ (to_rep1 cur_piece__split_fields2) xx)) true)))))))
(assert (= (mk_int__ref result) (mk_int__ref y)))
(assert (= y1 0))
(assert (= (mk_int__ref result1) (mk_int__ref x)))
(assert (= x1 0))
(assert (= (get (select possible_i_shapes (to_rep3 cur_piece__split_fields1)) y1 x1) true))
(assert (= (to_rep4 o) (to_rep cur_piece__split_fields)))
(assert (and (<= 1 (+ (to_rep1 cur_piece__split_fields2) x1)) (<= (+ (to_rep1 cur_piece__split_fields2) x1) 10)))
(assert (= o1 (+ (to_rep1 cur_piece__split_fields2) x1)))
(assert (= o2 (store (select cur_board (+ (to_rep2 cur_piece__split_fields3) y1)) o1 o)))
(assert (not (<= (+ (to_rep2 cur_piece__split_fields3) y1) 20)))
(check-sat)
(exit)
