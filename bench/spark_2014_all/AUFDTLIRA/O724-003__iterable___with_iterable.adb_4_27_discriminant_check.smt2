...
(assert true)
(assert (forall ((a us_rep1)) (forall ((cu us_rep)) (! (= (= (has_element a cu) true) (and (<= 1 (to_rep (rec__with_iterable__cursor__i (us_split_fields1 cu)))) (<= (to_rep (rec__with_iterable__cursor__i (us_split_fields1 cu))) 100))) :pattern ((has_element a cu))))))
(declare-fun contains_0 (us_rep1) Bool)
(declare-fun contains_0__function_guard (Bool us_rep1) Bool)
(declare-fun get (us_rep1 Int) Int)
(declare-fun get__function_guard (Int us_rep1 Int) Bool)
(assert true)
(assert (forall ((a us_rep1)) (! (= (= (contains_0 a) true) (exists ((cu us_rep)) (and (and (dynamic_invariant cu true false true true) (= (has_element a cu) true)) (= (get a (to_rep (rec__with_iterable__cursor__i (us_split_fields1 cu)))) 0)))) :pattern ((contains_0 a)))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun in_range2 ((rec__with_iterable__cursor__c1 Int) (a us_rep)) Bool (= rec__with_iterable__cursor__c1 (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 a)))))
...
(define-fun dynamic_predicate1 ((temp___228 us_rep)) Bool (and (<= 1 (to_rep (rec__with_iterable__cursor__i (us_split_fields1 temp___228)))) (<= (to_rep (rec__with_iterable__cursor__i (us_split_fields1 temp___228))) (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 temp___228))))))
...
(assert (forall ((a us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 i true true true true) (and (<= 1 i) (<= i 100))) (dynamic_invariant1 (get a i) true false true true)) :pattern ((get a i))))))
(assert (forall ((a us_rep1)) (forall ((i Int)) (! (=> (dynamic_invariant1 i true true true true) (= (get a i) (to_rep (let ((temp___207 (rec__with_iterable__container__content (us_split_fields3 a)))) (select temp___207 i))))) :pattern ((get a i))))))
...
(assert (dynamic_predicate1 (mk___rep (mk___split_discrs rliteral) (mk___split_fields rliteral1))))
(assert (= rliteral o))
(assert (= rliteral1 o1))
(assert (= (mk___rep (mk___split_discrs o2) (mk___split_fields o3)) (mk___rep (mk___split_discrs o) (mk___split_fields o1))))
(assert (not (= 101 (to_rep o2))))
(check-sat)
(exit)
