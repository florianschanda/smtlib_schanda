...
(declare-const temp___7933 (Array Int et1))
(declare-const temp___79331 enum2t)
...
(assert (= temp___7933 o2))
(assert (= temp___79331 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___7933 r__split_fields2))
(assert (= temp___79331 r__split_fields3))
...
(assert (<= n 10))
(assert (not (= n i)))
(assert (not (= (to_rep (select r__split_fields4 n)) (to_rep (select r__split_fields n)))))
(check-sat)
(exit)
