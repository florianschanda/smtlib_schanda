...
(assert (=> (< threshold (to_rep (select b i2))) (and (= o (+ cur2 1)) (in_range1 (+ cur2 1)))))
(assert (=> (< threshold (to_rep (select b i2))) (= cur2 result2)))
(assert (=> (< threshold (to_rep (select b i2))) (= cur3 o)))
(assert (=> (< threshold (to_rep (select b i2))) (= (to_rep o1) (to_rep (select b i2)))))
(assert (=> (< threshold (to_rep (select b i2))) (and (<= 1 cur3) (<= cur3 10))))
