...
(declare-fun temp_____aggregate_def_4448 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___4450 (Array Int et1))) (forall ((temp___4451 Int) (temp___4452 Int)) (let ((temp___4449 (temp_____aggregate_def_4448 temp___4450 temp___4451 temp___4452))) (=> (and (dynamic_invariant temp___4451 true true true true) (dynamic_invariant1 temp___4452 true true true true)) (forall ((temp___4453 Int)) (ite (= temp___4453 temp___4451) (= (to_rep (select temp___4449 temp___4453)) temp___4452) (= (select temp___4449 temp___4453) (select temp___4450 temp___4453)))))))))
(declare-const j Int)
(declare-const f Int)
(declare-const o Int)
...
(assert (and (and (= (bool_eq a 1 10 (temp_____aggregate_def_4448 t i e) 1 10) true) (or (and (= i 10) (= j1 1)) (and (< i 10) (= j1 (+ i 1))))) (in_range1 j1)))
...
(assert (<= 1 n))
(assert (<= n 10))
(assert (not (in_range2 (to_rep (select a2 n)))))
(check-sat)
(exit)
