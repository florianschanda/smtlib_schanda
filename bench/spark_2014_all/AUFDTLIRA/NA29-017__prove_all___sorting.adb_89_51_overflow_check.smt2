...
(assert (and (= o7 (- length2 j2)) (in_range1 (- length2 j2))))
(assert (and (= o8 o7) (in_range2 o7)))
(assert (and (= o6 (+ i2 j2)) (in_range1 (+ i2 j2))))
(assert (and (= o3 (+ a_first length1)) (in_range1 (+ a_first length1))))
(assert (= o4 (+ o3 j2)))
(assert (and (= o5 o4) (in_range1 o4)))
(assert (and (= o2 (to_rep b__first)) (in_range2 (to_rep b__first))))
(assert (= o9 (le_array (mk___t b (mk (to_rep b__first) (to_rep b__last))) (mk___t a (mk (to_rep a__first) (to_rep a__last))) o2 o5 o6 o8)))
