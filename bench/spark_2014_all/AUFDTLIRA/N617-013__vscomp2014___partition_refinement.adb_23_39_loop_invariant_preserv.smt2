...
(declare-const o10 partition_index)
(declare-const o11 (Array Int partition_index))
...
(assert (= i3 (+ i2 1)))
(assert (= (to_rep3 o10) p_prime_index2))
(assert (= o11 (store f2 i3 o10)))
(assert (= result9 (mk_map__ref f2)))
(assert (= f3 o11))
(declare-const j3 Int)
(assert (<= (+ i3 1) j3))
(assert (<= j3 5))
(assert (not (= (to_rep3 (select f3 j3)) (to_rep3 (select f j3)))))
(check-sat)
(exit)
