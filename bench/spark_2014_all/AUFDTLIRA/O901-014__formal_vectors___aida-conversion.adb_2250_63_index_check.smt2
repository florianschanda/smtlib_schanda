...
(assert (and (= o1 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
...
(assert (= (= o4 true) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index1) (<= index1 (+ (to_rep1 (first (rt source))) 1))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
(assert (and (= temp___2542 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (not (<= temp___2542 (to_rep1 (last (rt source))))))
(check-sat)
(exit)
