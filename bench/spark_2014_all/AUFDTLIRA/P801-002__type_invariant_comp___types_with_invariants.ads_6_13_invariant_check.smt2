...
(declare-const types_with_invariants__get__result Bool)
(declare-const types_with_invariants__get__result1 natural)
(declare-const o Int)
(declare-const o1 Bool)
(declare-const o2 natural)
(declare-const result Bool)
(declare-const result1 natural)
(declare-const types_with_invariants__get__result2 Bool)
(declare-const types_with_invariants__get__result3 natural)
(declare-const types_with_invariants__get__result4 Bool)
(declare-const types_with_invariants__get__result5 natural)
(declare-const types_with_invariants__get__result6 Bool)
(declare-const types_with_invariants__get__result7 natural)
(declare-const types_with_invariants__get__result8 Bool)
(declare-const types_with_invariants__get__result9 natural)
(declare-const types_with_invariants__get__result10 Bool)
(declare-const types_with_invariants__get__result11 natural)
(define-fun types_with_invariants__get__result12 () us_rep (mk___rep (mk___split_fields types_with_invariants__get__result2 types_with_invariants__get__result3)))
(define-fun o3 () us_rep (mk___rep (mk___split_fields o1 o2)))
...
(assert (= types_with_invariants__get__result4 types_with_invariants__get__result2))
(assert (= types_with_invariants__get__result5 types_with_invariants__get__result3))
(assert (= (mk___rep (mk___split_fields types_with_invariants__get__result6 types_with_invariants__get__result7)) types_with_invariants__get__result12))
(assert (and (<= (to_rep1 (first (rt (rec__types_with_invariants__container__content (us_split_fields3 c))))) i) (<= i (to_rep1 (last (rt (rec__types_with_invariants__container__content (us_split_fields3 c))))))))
(assert (= o i))
(assert (= o3 (select (elts (rec__types_with_invariants__container__content (us_split_fields3 c))) o)))
(assert (= result types_with_invariants__get__result))
(assert (= result1 types_with_invariants__get__result1))
(assert (= types_with_invariants__get__result12 o3))
(assert (= (mk_my_integer__ref (mk___rep (mk___split_fields types_with_invariants__get__result8 types_with_invariants__get__result9))) (mk_my_integer__ref (mk___rep (mk___split_fields types_with_invariants__get__result4 types_with_invariants__get__result5)))))
(assert (= types_with_invariants__get__result10 types_with_invariants__get__result6))
(assert (= types_with_invariants__get__result11 types_with_invariants__get__result7))
(assert (= (to_rep types_with_invariants__get__result9) 0))
(assert (not (= types_with_invariants__get__result8 true)))
(check-sat)
(exit)
