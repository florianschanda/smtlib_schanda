...
(define-fun dynamic_invariant ((temp___expr_341 us_t1) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool) (temp___do_typ_inv_340 Bool)) Bool (and (=> (not (= temp___skip_constant_338 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_341) (last3 temp___expr_341))) (=> (= temp___do_toplevel_339 true) (=> (= temp___is_init_337 true) (and (let ((temp___343 (of_array2 (to_array1 temp___expr_341) (first3 temp___expr_341) (last3 temp___expr_341)))) (and (= (first5 temp___343) 1) (<= 0 (last5 temp___343)))) (<= (last3 temp___expr_341) 12))))))
(define-fun dynamic_predicate ((temp___345 us_t1)) Bool (and (let ((temp___347 (of_array2 (to_array1 temp___345) (first3 temp___345) (last3 temp___345)))) (and (= (first5 temp___347) 1) (<= 0 (last5 temp___347)))) (<= (last3 temp___345) 12)))
...
(define-fun dynamic_invariant1 ((temp___expr_1163 Int) (temp___is_init_1159 Bool) (temp___skip_constant_1160 Bool) (temp___do_toplevel_1161 Bool) (temp___do_typ_inv_1162 Bool)) Bool (=> (or (= temp___is_init_1159 true) (<= 0 1)) (in_range3 temp___expr_1163)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_317 us_t2) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool) (temp___do_typ_inv_316 Bool)) Bool (and (=> (not (= temp___skip_constant_314 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_317) (last5 temp___expr_317))) (=> (= temp___do_toplevel_315 true) (=> (= temp___is_init_313 true) (and (= (first5 temp___expr_317) 1) (<= 0 (last5 temp___expr_317)))))))
(define-fun dynamic_predicate1 ((temp___320 us_t2)) Bool (and (= (first5 temp___320) 1) (<= 0 (last5 temp___320))))
(declare-const temp___1500 (Array Int character))
(declare-const temp___15001 t1)
(assert (in_range3 x))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___1500))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___15001))
(assert (not (dynamic_predicate (mk___t1 temp___1500 temp___15001))))
(check-sat)
(exit)
