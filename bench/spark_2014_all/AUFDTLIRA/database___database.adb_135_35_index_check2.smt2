...
(assert (not (= (to_rep (rec__database__availability__account_link__next (us_split_fields1 (select links2 account)))) 0)))
(assert (= (to_rep o9) (to_rep (rec__database__availability__account_link__prev (us_split_fields1 (select links2 account))))))
(assert (= (rec__database__availability__account_link__available (us_split_fields1 (select links2 (to_rep (rec__database__availability__account_link__next (us_split_fields1 (select links2 account))))))) o10))
(assert (= o9 o11))
(assert (= (rec__database__availability__account_link__next (us_split_fields1 (select links2 (to_rep (rec__database__availability__account_link__next (us_split_fields1 (select links2 account))))))) o12))
(assert (= o13 o10))
(assert (= o14 o11))
(assert (= o15 o12))
(assert (not (<= 1 (to_rep (rec__database__availability__account_link__next (us_split_fields1 (select links2 account)))))))
(check-sat)
(exit)
