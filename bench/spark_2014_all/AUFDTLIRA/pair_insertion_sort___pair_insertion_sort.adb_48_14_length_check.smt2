...
(assert (= (mk___t2 temp___334 temp___3341) (mk___t2 temp___333 temp___3331)))
(assert (not (= (ite (<= (to_rep (first4 temp___3341)) (to_rep (last4 temp___3341))) (+ (- (to_rep (last4 temp___3341)) (to_rep (first4 temp___3341))) 1) 0) (ite (<= (to_rep interm__first) (to_rep interm__last)) (+ (- (to_rep interm__last) (to_rep interm__first)) 1) 0))))
(check-sat)
(exit)
