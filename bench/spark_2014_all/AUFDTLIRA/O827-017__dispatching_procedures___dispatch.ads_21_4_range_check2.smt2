...
(assert (and (dynamic_property1 1 b_max (to_rep a1__first) (to_rep a1__last)) (and (= (to_rep a1__first) 1) (= (to_rep a1__last) b_max))))
(assert (and (dynamic_property3 1 b_max (to_rep a2__first) (to_rep a2__last)) (and (= (to_rep a2__first) 1) (= (to_rep a2__last) b_max))))
(assert (<= 1 b_max))
(assert (not (<= 1 1)))
(check-sat)
(exit)
