...
(assert (and (and (and (= (is_readable standard_input2) true) (= (let ((temp___788 (name standard_input1))) (let ((temp___787 (name standard_input2))) (bool_eq (elts temp___787) (to_rep1 (first (rt temp___787))) (to_rep1 (last (rt temp___787))) (elts temp___788) (to_rep1 (first (rt temp___788))) (to_rep1 (last (rt temp___788)))))) true)) (= (let ((temp___790 (form standard_input1))) (let ((temp___789 (form standard_input2))) (bool_eq (elts temp___789) (to_rep1 (first (rt temp___789))) (to_rep1 (last (rt temp___789))) (elts temp___790) (to_rep1 (first (rt temp___790))) (to_rep1 (last (rt temp___790)))))) true)) (= (= (is_standard_file standard_input2) true) (= (is_standard_file standard_input1) true))))
...
(assert (and (= o2 (status standard_error1)) (in_range4 o2)))
