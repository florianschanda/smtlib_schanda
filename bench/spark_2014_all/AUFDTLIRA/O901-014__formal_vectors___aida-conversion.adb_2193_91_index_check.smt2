...
(assert (and (= (length source) 4) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index3 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 3))) (= (is_digit (to_rep (select (elts source) index3))) true))))))
...
(assert (<= temp___2505 index1))
(assert (<= index1 temp___2506))
...
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3) index2)) (forall ((temp___2510 Int)) (=> (and (<= (to_rep1 n__first) temp___2510) (<= temp___2510 (to_rep1 n__last))) (=> (or (< temp___2506 temp___2510) (or (< temp___2510 temp___2505) (< index2 temp___2510))) (= (select n3 temp___2510) (select n1 temp___2510)))))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 3)))))
