...
(declare-fun temp_____aggregate_def_2894 ((Array Int us_rep) Int us_rep Int us_rep) (Array Int us_rep))
...
(assert (= temp3 temp1))
(assert (= a4 a2))
(assert (not (= (bool_eq1 a3 1 10 (temp_____aggregate_def_2894 a i (mk___rep (mk___split_fields (rec__ar__rec1t__f1 (us_split_fields1 (select a i))) (rec__ar__rec1t__g1 (us_split_fields1 (select a j))))) j (mk___rep (mk___split_fields (rec__ar__rec1t__f1 (us_split_fields1 (select a j))) (rec__ar__rec1t__g1 (us_split_fields1 (select a i)))))) 1 10) true)))
(check-sat)
(exit)
