...
(assert (and (and (forall ((temp___1672 Int)) (=> (and (<= (to_rep1 n__first) temp___1672) (<= temp___1672 (to_rep1 n__last))) (=> (or (< temp___1669 temp___1672) (or (< temp___1672 (to_rep1 (first (rt source)))) (< index2 temp___1672))) (= (select n3 temp___1672) (select n1 temp___1672))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 8)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 8) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 8)))))
