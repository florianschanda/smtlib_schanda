...
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o109 i1))
(assert (= temp___659 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o109)))
(assert (and (<= 0 j) (<= j 99)))
(assert (= o110 j))
(assert (= o111 (select temp___659 o110)))
(assert (= o112 (to_rep o111)))
(assert (= o113 (ite (< o112 (to_rep (rec__patience__state__numelts (us_split_fields__content s__split_fields20)))) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o108 i1))
(assert (= temp___657 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o108)))
(assert (not (<= 0 j)))
(check-sat)
(exit)
