...
(assert (and (= o (has_value_exc a (int__content location13) val__)) (= (= o true) (exists ((i15 Int)) (and (and (<= (to_rep (first (rt a))) i15) (<= i15 (int__content location13))) (and (< i15 (int__content location13)) (= (to_rep1 (select (elts a) i15)) val__)))))))
(assert (= o1 (ite (not (= o true)) true false)))
(assert (not (<= (to_rep (last (rt a))) (to_rep (last (rt a))))))
(check-sat)
(exit)
