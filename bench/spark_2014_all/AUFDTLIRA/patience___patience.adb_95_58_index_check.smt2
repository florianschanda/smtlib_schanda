...
(assert (= o123 i1))
(assert (= o124 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o123)))
(assert (= o125 (to_rep o124)))
(assert (= o126 (ite (<= o125 (- (to_rep (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o120 i1))
(assert (= o121 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o120)))
(assert (= o122 (to_rep o121)))
(assert (= o127 (ite (<= 0 o122) true false)))
(assert (= result23 (ite (= o127 true) o126 false)))
(assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result23 true) (= o111 i1)))
(assert (=> (= result23 true) (= o112 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o111))))
(assert (=> (= result23 true) (= temp___681 (to_rep o112))))
(assert (=> (= result23 true) (and (<= 0 temp___681) (<= temp___681 99))))
(assert (=> (= result23 true) (= o113 temp___681)))
(assert (=> (= result23 true) (= o114 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) o113))))
(assert (=> (= result23 true) (= o115 (to_rep o114))))
(assert (=> (= result23 true) (= o116 (- o115 1))))
(assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result23 true) (= o109 i1)))
(assert (=> (= result23 true) (= o110 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o109))))
(assert (=> (= result23 true) (= o117 (to_rep o110))))
(assert (=> (= result23 true) (= o118 (ite (<= o117 o116) true false))))
(assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))
...
(assert (=> (= result23 true) (= o108 (to_rep o107))))
(assert (=> (= result23 true) (= o119 (ite (<= 0 o108) true false))))
(assert (=> (= result23 true) (= result22 (ite (= o119 true) o118 false))))
