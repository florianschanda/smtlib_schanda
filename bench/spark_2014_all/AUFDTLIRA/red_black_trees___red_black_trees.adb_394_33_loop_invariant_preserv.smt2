...
(declare-const rho14 us_split_fields4)
(declare-const rho15 us_split_fields4)
(declare-const rho16 us_split_fields4)
(declare-const rho17 us_split_fields4)
...
(assert (and (= o126 (root (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields30)))) (and (in_range4 o126) (= o126 (to_rep (rec__search_trees__search_tree__root (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields30)))))))))
(assert (= o127 (ite (= (int__content x15) o126) true false)))
(assert (= result34 (ite (not (= o127 true)) true false)))
(assert (=> (= result34 true) (and (= o123 (int__content x15)) (in_range4 (int__content x15)))))
...
(assert (not (= (oeq (values (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields32))) (values (rec__red_black_trees__rbt__struct t__split_fields6))) true)))
(check-sat)
(exit)
