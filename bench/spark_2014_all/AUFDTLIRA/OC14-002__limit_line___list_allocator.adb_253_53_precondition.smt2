...
(assert (and (= o61 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 o61)))
...
(assert (not (<= o60 (length (rec__list_allocator__m__t__available model____split_fields3)))))
(check-sat)
(exit)
