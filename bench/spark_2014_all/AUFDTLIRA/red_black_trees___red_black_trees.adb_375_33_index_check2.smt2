...
(assert (<= i 100))
(assert (not (= i x1)))
(assert (and (= o4 (parent (rec__red_black_trees__rbt__struct t__split_fields6) i)) (and (in_range2 o4) (and (= o4 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct t__split_fields6))) i)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields6)) 0) (= o4 0))))))
(assert (= result3 (ite (= o4 0) true false)))
(assert (not (= result3 true)))
(assert (and (= temp___671 (parent (rec__red_black_trees__rbt__struct t__split_fields6) i)) (and (in_range2 temp___671) (and (= temp___671 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct t__split_fields6))) i)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields6)) 0) (= temp___671 0))))))
(assert (not (<= 1 temp___671)))
(check-sat)
(exit)
