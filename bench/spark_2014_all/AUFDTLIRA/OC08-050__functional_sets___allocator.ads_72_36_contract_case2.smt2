...
(define-fun dynamic_invariant ((temp___expr_330 Int) (temp___is_init_326 Bool) (temp___skip_constant_327 Bool) (temp___do_toplevel_328 Bool) (temp___do_typ_inv_329 Bool)) Bool (=> (or (= temp___is_init_326 true) (<= 0 3)) (in_range temp___expr_330)))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (user_eq (rec__allocator__m__t__available (us_split_fields1 a)) (rec__allocator__m__t__available (us_split_fields1 b))) true) (= (user_eq (rec__allocator__m__t__allocated (us_split_fields1 a)) (rec__allocator__m__t__allocated (us_split_fields1 b))) true)) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_310 Int) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool) (temp___do_typ_inv_309 Bool)) Bool (=> (or (= temp___is_init_306 true) (<= 0 3)) (in_range2 temp___expr_310)))
...
(define-fun dynamic_invariant2 ((temp___expr_370 Int) (temp___is_init_366 Bool) (temp___skip_constant_367 Bool) (temp___do_toplevel_368 Bool) (temp___do_typ_inv_369 Bool)) Bool (=> (or (= temp___is_init_366 true) (<= 0 1)) (in_range1 temp___expr_370)))
(define-fun dynamic_invariant3 ((temp___expr_317 Int) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool) (temp___do_typ_inv_316 Bool)) Bool (=> (or (= temp___is_init_313 true) (<= 1 3)) (in_range3 temp___expr_317)))
(assert true)
(assert (forall ((m us_rep1)) (forall ((allocator__data (Array Int status))) (! (= (= (is_valid m allocator__data) true) (and (and (forall ((e Int)) (=> (and (in_range e) (= (mem (rec__allocator__m__t__available (us_split_fields1 m)) e) true)) (in_range3 e))) (forall ((e Int)) (=> (and (in_range e) (= (mem (rec__allocator__m__t__allocated (us_split_fields1 m)) e) true)) (in_range3 e)))) (forall ((r Int)) (=> (and (<= 1 r) (<= r 3)) (ite (= (to_rep (select allocator__data r)) 0) (and (= (mem (rec__allocator__m__t__available (us_split_fields1 m)) r) true) (not (= (mem (rec__allocator__m__t__allocated (us_split_fields1 m)) r) true))) (and (not (= (mem (rec__allocator__m__t__available (us_split_fields1 m)) r) true)) (= (mem (rec__allocator__m__t__allocated (us_split_fields1 m)) r) true))))))) :pattern ((is_valid m allocator__data))))))
(assert (forall ((s1 us_rep) (s2 us_rep)) (! (= (= (oeq s1 s2) true) (and (forall ((e Int)) (=> (and (in_range e) (= (mem s1 e) true)) (= (mem s2 e) true))) (forall ((e Int)) (=> (and (in_range e) (= (mem s2 e) true)) (= (mem s1 e) true))))) :pattern ((oeq s1 s2)))))
(assert (forall ((s us_rep)) (! (= (= (is_empty s) true) (forall ((e Int)) (not (and (in_range e) (= (mem s e) true))))) :pattern ((is_empty s)))))
...
(assert (= data2 data3))
(assert (= data4 data2))
(assert (= (mem (rec__allocator__m__t__allocated (us_split_fields1 (model__ data))) res) true))
(assert (not (= (is_add (rec__allocator__m__t__available (us_split_fields1 (model__ data))) res (rec__allocator__m__t__available (us_split_fields1 (model__ data3)))) true)))
(check-sat)
(exit)
