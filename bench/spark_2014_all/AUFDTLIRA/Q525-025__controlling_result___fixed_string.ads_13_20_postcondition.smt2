...
(assert (forall ((temp___164 Int)) (=> (dynamic_invariant3 temp___164 true true true true) (forall ((temp___165 Int)) (= (to_rep (select (temp_____aggregate_def_162 temp___164) temp___165)) temp___164)))))
...
(assert (and (= this__attr__tag us_tag) (and (= (to_rep2 this__split_fields) 0) (= this__split_fields1 (temp_____aggregate_def_162 0)))))
