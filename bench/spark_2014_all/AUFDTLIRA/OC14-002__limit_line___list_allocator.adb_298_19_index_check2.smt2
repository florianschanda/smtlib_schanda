...
(assert (=> (not (= first_available1 0)) (and (= o69 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o69))))
(assert (=> (not (= first_available1 0)) (= result13 (ite (< 0 o69) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (and (= o68 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range4 o68)))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (= result12 (ite (= o68 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result13 true)) (= result12 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o70 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o70))))
(assert (=> (not (not (= first_available1 0))) (= result12 (ite (= o70 0) true false))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (and (= o66 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o66)))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (= result14 (ite (< 0 o66) true false)))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (=> (= result14 true) (and (= o65 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range4 o65))))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (=> (= result14 true) (= result11 (ite (= o65 first_allocated2) true false))))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (=> (not (= result14 true)) (= result11 false)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated2 0))) (and (= o67 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o67)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated2 0))) (= result11 (ite (= o67 0) true false)))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (=> (= result11 true) (and (= o63 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o63))))
(assert (=> (= result11 true) (= o64 (ite (<= j1 o63) true false))))
(assert (=> (= result11 true) (= result15 (ite (<= 1 j1) o64 false))))
...
(assert (= result16 (ite (<= 1 j) o58 false)))
(assert (= result16 true))
(assert (and (= o62 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 o62)))
(assert (= result17 (ite (in_range7 o62) true false)))
(assert (= result17 true))
(assert (and (= o59 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o59)))
(assert (= result18 (ite (< j o59) true false)))
(assert (=> (= result18 true) (and (= o60 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (= result18 true) (and (= o61 (get (rec__list_allocator__m__t__allocated model____split_fields3) o60)) (in_range4 o61))))
(assert (=> (not (= result18 true)) (= o61 0)))
(assert (and (= temp___465 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 temp___465)))
(assert (not (<= 1 temp___465)))
(check-sat)
(exit)
