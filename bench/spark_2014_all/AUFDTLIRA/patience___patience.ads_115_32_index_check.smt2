...
(assert (= o29 (ite (<= o28 (- (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o23 i))
...
(assert (=> (= result6 true) (= o22 (to_rep o21))))
...
(assert (=> (= result9 true) (= o11 (to_rep o10))))
...
(assert (= temp___542 (to_rep o4)))
(assert (not (<= temp___542 99)))
(check-sat)
(exit)
