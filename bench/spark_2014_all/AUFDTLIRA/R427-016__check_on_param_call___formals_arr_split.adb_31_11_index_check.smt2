...
(declare-datatypes () ((my_index__ref (mk_my_index__ref (my_index__content integer)))))
(define-fun my_index__ref___projection ((a my_index__ref)) integer (my_index__content a))
(declare-sort t 0)
(declare-fun first (t) integer)
(declare-fun last1 (t) integer)
(declare-fun mk (Int Int) t)
(assert (forall ((f Int) (l Int)) (! (=> (in_range2 f) (=> (in_range2 l) (and (= (to_rep (first (mk f l))) f) (= (to_rep (last1 (mk f l))) l)))) :pattern ((mk f l)))))
...
(define-fun bool_eq1 ((x us_t) (y1 us_t)) Bool (bool_eq (elts x) (to_rep (first (rt x))) (to_rep (last1 (rt x))) (elts y1) (to_rep (first (rt y1))) (to_rep (last1 (rt y1)))))
(declare-fun user_eq4 (us_t us_t) Bool)
(declare-const dummy4 us_t)
(declare-datatypes () ((my_array_3__ref (mk_my_array_3__ref (my_array_3__content us_t)))))
(define-fun my_array_3__ref___projection ((a my_array_3__ref)) us_t (my_array_3__content a))
...
(define-fun dynamic_invariant3 ((temp___expr_185 Int) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool) (temp___do_typ_inv_184 Bool)) Bool (=> (or (= temp___is_init_181 true) (<= 0 last)) (dynamic_property 0 last temp___expr_185)))
(assert (= last y))
(define-fun dynamic_invariant4 ((temp___expr_192 us_t) (temp___is_init_188 Bool) (temp___skip_constant_189 Bool) (temp___do_toplevel_190 Bool) (temp___do_typ_inv_191 Bool)) Bool (=> (not (= temp___skip_constant_189 true)) (dynamic_property1 0 last (first1 temp___expr_192) (last2 temp___expr_192))))
(assert (in_range1 y))
(assert (dynamic_property1 0 last (to_rep a__first) (to_rep a__last)))
(assert (< 0 (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0)))
