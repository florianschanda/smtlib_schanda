...
(assert (= result2 a2))
(assert (= a3 (store a2 i (mk___rep (mk___split_fields d (rec__ar__rofa1__t1 (us_split_fields1 (select a2 i))))))))
(assert (= (to_rep o) e))
(assert (= o1 (store (rec__ar__rofa1__s1 (us_split_fields1 (select a3 i))) j o)))
(assert (= o1 o2))
...
(assert (<= m 16))
(assert (not (= m i)))
(assert (not (= (bool_eq1 (select a5 m) (select b m)) true)))
(check-sat)
(exit)
