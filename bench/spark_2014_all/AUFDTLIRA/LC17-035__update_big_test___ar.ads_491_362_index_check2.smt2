...
(assert (= a4 a2))
(assert (< k 16))
(assert (=> (< 0 e) (and (= o7 (- e 1)) (in_range4 (- e 1)))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o6 (+ k 1))))
(assert (=> (< 0 e) (= temp___5570 (select a o6))))
(assert (=> (< 0 e) (= o8 (select temp___5570 j))))
(assert (=> (< 0 e) (= o9 (temp_____aggregate_def_1904 o8 i o7))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o5 (+ k 1))))
(assert (=> (< 0 e) (= o10 (select a o5))))
(assert (=> (< 0 e) (= o11 (temp_____aggregate_def_1897 o10 j o9))))
(assert (=> (< 0 e) (and (= o12 (+ k 1)) (in_range3 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5571 (temp_____aggregate_def_1874 a k (temp_____aggregate_def_1882 (select a k) j (temp_____aggregate_def_1889 (select (select a k) j) i e)) o12 o11))))
(assert (=> (< 0 e) (= result3 (bool_eq2 a3 1 16 temp___5571 1 16))))
