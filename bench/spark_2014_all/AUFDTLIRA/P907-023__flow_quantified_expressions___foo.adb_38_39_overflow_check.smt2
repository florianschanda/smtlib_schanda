...
(define-fun dynamic_invariant ((temp___expr_160 us_t) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (not (= temp___skip_constant_157 true)) (dynamic_property 1 2147483647 (first1 temp___expr_160) (last1 temp___expr_160))))
...
(assert (<= (to_rep (first (rt a))) i))
(assert (<= i (to_rep (last (rt a)))))
