...
(declare-const temp___8609 enum1tb)
(declare-const temp___86091 (Array Int (Array Int (Array Int et1))))
(declare-const temp___86092 Bool)
...
(assert (= temp___8609 o4))
(assert (= temp___86091 o5))
(assert (= temp___86092 o6))
(assert (= result9 r__split_fields9))
(assert (= result10 r__split_fields10))
(assert (= result11 r__split_fields11))
(assert (= temp___8609 r__split_fields12))
(assert (= temp___86091 r__split_fields13))
(assert (= temp___86092 r__split_fields14))
...
(assert (<= n 50))
(assert (not (= n j)))
(assert (not (= (bool_eq (select (select r__split_fields19 i) n) 1 10 (select b n) 1 10) true)))
(check-sat)
(exit)
