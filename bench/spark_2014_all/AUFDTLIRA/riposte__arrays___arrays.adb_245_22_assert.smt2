...
(assert (forall ((c Int)) (! (=> (dynamic_invariant c true true true true) (forall ((i Int)) (=> (and (<= 0 i) (<= i 255)) (= (= (select (single_char_set_broken c) i) true) (< c i))))) :pattern ((single_char_set_broken c)))))
