...
(assert (= i22 result3))
(assert (= i221 1))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= temp___297 i221)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= temp___302 x3)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= temp___292 x3)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= (bool_eq2 x4 (to_rep (first8 (mk4 (+ i32 1) 3))) (to_rep (last8 (mk4 (+ i32 1) 3))) temp___302 (to_rep (first10 (mk5 (+ i32 1) 3))) (to_rep (last10 (mk5 (+ i32 1) 3)))) true)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (and (and (forall ((temp___293 Int)) (=> (and (<= 1 temp___293) (<= temp___293 3)) (ite (not (= i32 temp___293)) (= (select x4 temp___293) (select temp___292 temp___293)) (forall ((temp___294 Int) (temp___295 Int)) (=> (and (and (<= 1 temp___294) (<= temp___294 3)) (and (<= 1 temp___295) (<= temp___295 3))) (=> (or (< 3 temp___295) (or (< temp___295 1) (or (<= i222 temp___295) (not (= i212 temp___294))))) (= (get (select x4 temp___293) temp___294 temp___295) (get (select temp___292 temp___293) temp___294 temp___295)))))))) (=> (<= 1 3) (in_range2 i222))) (and (<= 1 i222) (<= i222 3)))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= i11 result4)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= i12 1)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= temp___278 i12))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= temp___273 x4))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= temp___283 x4))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= x4 result5))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= x5 (store x4 i32 (set (select x4 i32) i212 i222 (store (get (select x4 i32) i212 i222) i12 rliteral1)))))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= (bool_eq2 x6 (to_rep (first12 (mk6 (+ i32 1) 3))) (to_rep (last12 (mk6 (+ i32 1) 3))) temp___283 (to_rep (first14 (mk7 (+ i32 1) 3))) (to_rep (last14 (mk7 (+ i32 1) 3)))) true))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (and (and (forall ((temp___274 Int)) (=> (and (<= 1 temp___274) (<= temp___274 3)) (ite (not (= i32 temp___274)) (= (select x6 temp___274) (select temp___273 temp___274)) (forall ((temp___275 Int) (temp___276 Int)) (=> (and (and (<= 1 temp___275) (<= temp___275 3)) (and (<= 1 temp___276) (<= temp___276 3))) (ite (or (not (= i222 temp___276)) (not (= i212 temp___275))) (= (get (select x6 temp___274) temp___275 temp___276) (get (select temp___273 temp___274) temp___275 temp___276)) (forall ((temp___277 Int)) (=> (and (<= 1 temp___277) (<= temp___277 3)) (=> (or (< 3 temp___277) (or (< temp___277 1) (< i13 temp___277))) (= (select (get (select x6 temp___274) temp___275 temp___276) temp___277) (select (get (select temp___273 temp___274) temp___275 temp___276) temp___277))))))))))) (=> (<= 1 3) (in_range2 i13))) (and (<= 1 i13) (<= i13 3))))))
