...
(define-fun o17 () us_rep3 (mk___rep1 (mk___split_fields1 o13 o14)))
...
(assert (and (= o17 (model__ (map__content data6) first_available1)) (= (model_is_well_formed o17 (map__content data6) first_available1) true)))
(assert (= o13 o15))
(assert (= o14 o16))
