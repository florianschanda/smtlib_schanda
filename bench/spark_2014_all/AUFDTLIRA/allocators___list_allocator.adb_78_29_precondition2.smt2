...
(define-fun range_equal ((left us_rep) (right us_rep) (fst Int) (lst Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (get left i) (get right i)))) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_193 Int) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool) (temp___do_typ_inv_192 Bool)) Bool (=> (or (= temp___is_init_189 true) (<= 1 2147483647)) (in_range4 temp___expr_193)))
(assert (forall ((container us_rep)) (forall ((position Int)) (! (=> (and (dynamic_invariant3 position true true true true) (and (<= 1 position) (<= position (last container)))) (let ((result (remove container position))) (and (= (length result) (- (length container) 1)) (and (= (range_equal container result 1 (- position 1)) true) (= (range_shifted result container position (last result) 1) true))))) :pattern ((remove container position))))))
...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (and (dynamic_invariant4 item true true true true) (and (not (= (contains container item) true)) (< (length1 container) 2147483647))) (let ((result (add container item))) (and (and (and (= (length1 result) (+ (length1 container) 1)) (= (contains result item) true)) (= (ole container result) true)) (= (included_except result container item) true)))) :pattern ((add container item))))))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__list_allocator__cell__stat status) (rec__list_allocator__cell__next resource)))))
...
(define-fun bool_eq3 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields3 a))) (to_rep1 (rec__list_allocator__cell__stat (us_split_fields3 b)))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 a))) (to_rep (rec__list_allocator__cell__next (us_split_fields3 b))))) true false))
...
(declare-fun is_valid ((Array Int us_rep3) Int us_split_fields) Bool)
(declare-fun is_valid__function_guard (Bool (Array Int us_rep3) Int us_split_fields) Bool)
...
(assert true)
(assert (forall ((list_allocator__data (Array Int us_rep3))) (forall ((list_allocator__first_available Int)) (forall ((list_allocator__m__model__fields us_split_fields)) (! (= (= (is_valid list_allocator__data list_allocator__first_available list_allocator__m__model__fields) true) (and (and (and (and (and (and (<= (length (rec__list_allocator__m__t__available (us_split_fields1 (mk___rep list_allocator__m__model__fields)))) 10000) (<= (length1 (rec__list_allocator__m__t__allocated (us_split_fields1 (mk___rep list_allocator__m__model__fields)))) 10000)) (= (+ (length (rec__list_allocator__m__t__available (us_split_fields1 (mk___rep list_allocator__m__model__fields)))) (length1 (rec__list_allocator__m__t__allocated (us_split_fields1 (mk___rep list_allocator__m__model__fields))))) 10000)) (ite (not (= list_allocator__first_available 0)) (and (< 0 (length (rec__list_allocator__m__t__available (us_split_fields1 (mk___rep list_allocator__m__model__fields))))) (= (get (rec__list_allocator__m__t__available (us_split_fields1 (mk___rep list_allocator__m__model__fields))) 1) list_allocator__first_available)) (= (length (rec__list_allocator__m__t__available (us_split_fields1 (mk___rep list_allocator__m__model__fields)))) 0))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__available (us_split_fields1 (mk___rep list_allocator__m__model__fields)))))) (and (and (in_range8 (get (rec__list_allocator__m__t__available (us_split_fields1 (mk___rep list_allocator__m__model__fields))) j)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select list_allocator__data (get (rec__list_allocator__m__t__available (us_split_fields1 (mk___rep list_allocator__m__model__fields))) j))))) (ite (< j (length (rec__list_allocator__m__t__available (us_split_fields1 (mk___rep list_allocator__m__model__fields))))) (get (rec__list_allocator__m__t__available (us_split_fields1 (mk___rep list_allocator__m__model__fields))) (+ j 1)) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (- j 1))) (not (= (get (rec__list_allocator__m__t__available (us_split_fields1 (mk___rep list_allocator__m__model__fields))) j) (get (rec__list_allocator__m__t__available (us_split_fields1 (mk___rep list_allocator__m__model__fields))) k))))))))) (forall ((e Int)) (=> (and (in_range5 e) (= (contains (rec__list_allocator__m__t__allocated (us_split_fields1 (mk___rep list_allocator__m__model__fields))) e) true)) (in_range8 e)))) (forall ((r Int)) (=> (and (<= 1 r) (<= r 10000)) (ite (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields3 (select list_allocator__data r)))) 0) (and (= (contains1 (rec__list_allocator__m__t__available (us_split_fields1 (mk___rep list_allocator__m__model__fields))) r) true) (not (= (contains (rec__list_allocator__m__t__allocated (us_split_fields1 (mk___rep list_allocator__m__model__fields))) r) true))) (and (not (= (contains1 (rec__list_allocator__m__t__available (us_split_fields1 (mk___rep list_allocator__m__model__fields))) r) true)) (= (contains (rec__list_allocator__m__t__allocated (us_split_fields1 (mk___rep list_allocator__m__model__fields))) r) true))))))) :pattern ((is_valid list_allocator__data list_allocator__first_available list_allocator__m__model__fields)))))))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(define-fun dynamic_invariant6 ((temp___expr_263 Int) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool) (temp___do_typ_inv_262 Bool)) Bool (=> (or (= temp___is_init_259 true) (<= 0 1)) (in_range7 temp___expr_263)))
...
(declare-const o13 (Array Int us_rep3))
(declare-const o14 us_rep)
(declare-const o15 us_rep)
(declare-const o16 us_rep1)
(declare-const temp___320 us_rep)
(declare-const temp___3201 us_rep1)
...
(assert (=> (<= 0 10000) (in_range6 res)))
(assert (= (is_valid data first_available (mk___split_fields model____split_fields model____split_fields1)) true))
(assert (=> (<= 0 10000) (in_range6 next_avail)))
...
(assert (= (mk___rep1 (mk___split_fields1 o1 o2)) (select data o)))
(assert (= o1 o3))
(assert (= o2 o4))
(assert (= o5 o4))
(assert (= o6 (to_rep o5)))
(assert (= result2 (mk_int__ref next_avail)))
(assert (= next_avail1 o6))
(assert (= (to_rep1 o7) 1))
(assert (= o7 o8))
(assert (= rliteral o9))
(assert (= o10 o8))
...
(assert (= o12 res1))
(assert (= o13 (store data o12 (mk___rep1 (mk___split_fields1 o10 o11)))))
(assert (= result3 (mk_map__ref data)))
(assert (= data1 o13))
(assert (= result4 (mk_int__ref first_available)))
(assert (= first_available1 next_avail1))
(assert (and (= o14 (remove model____split_fields 1)) (and (= (length o14) (- (length model____split_fields) 1)) (and (= (range_equal model____split_fields o14 1 (- 1 1)) true) (= (range_shifted o14 model____split_fields 1 (last o14) 1) true)))))
(assert (= o14 o15))
(assert (= model____split_fields1 o16))
(assert (= temp___320 o15))
(assert (= temp___3201 o16))
(assert (= result5 (mk___split_fields__ref (mk___split_fields model____split_fields model____split_fields1))))
(assert (= model____split_fields2 (mk___split_fields temp___320 temp___3201)))
(assert (not (not (= (contains (rec__list_allocator__m__t__allocated model____split_fields2) res1) true))))
(check-sat)
(exit)
