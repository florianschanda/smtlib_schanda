...
(assert (not (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields9))) o32))) true)))
(check-sat)
(exit)
