...
(assert (forall ((i13 Int)) (=> (and (<= 0 i13) (<= i13 (- (to_rep (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1))) (<= 1 (to_rep (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) i13))))))
(assert (forall ((i13 Int)) (=> (and (<= 0 i13) (<= i13 (- (to_rep (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1))) (and (<= (to_rep (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) i13)) (to_rep (rec__patience__state__numelts (us_split_fields__content s__split_fields20)))) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (to_rep (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) i13)) 1))) (and (<= 0 (to_rep (select (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) i13) j))) (< (to_rep (select (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) i13) j)) (to_rep (rec__patience__state__numelts (us_split_fields__content s__split_fields20)))))))))))
(assert (= (= result22 true) (forall ((i13 Int)) (=> (and (<= 0 i13) (<= i13 (- (to_rep (rec__patience__state__numelts (us_split_fields__content s__split_fields20))) 1))) (and (and (and (<= 0 (to_rep (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) i13))) (<= (to_rep (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) i13)) (- (to_rep (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1))) (and (<= 0 (to_rep (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) i13))) (<= (to_rep (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) i13)) (- (to_rep (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) (to_rep (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) i13)))) 1)))) (= (to_rep (select (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) (to_rep (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) i13))) (to_rep (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) i13)))) i13))))))
(assert (= result22 true))
(assert (<= 0 ist))
(assert (<= ist (- (to_rep (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)))
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o103 ist))
(assert (= o104 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) o103)))
(assert (= o105 (to_rep o104)))
(assert (= o106 (- o105 1)))
(assert (= o107 (ite (<= ip o106) true false)))
(assert (= result23 (ite (<= 0 ip) o107 false)))
(assert (= result23 true))
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o108 ist))
(assert (= temp___703 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o108)))
(assert (not (<= ip 99)))
(check-sat)
(exit)
