...
(define-fun dynamic_invariant1 ((temp___expr_269 Int) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool) (temp___do_typ_inv_268 Bool)) Bool (=> (or (= temp___is_init_265 true) (<= 0 1)) (in_range3 temp___expr_269)))
...
(assert (not (<= first_available 10000)))
(check-sat)
(exit)
