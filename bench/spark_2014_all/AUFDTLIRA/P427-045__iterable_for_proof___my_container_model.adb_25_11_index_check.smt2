...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__my_container_model__cursor__index (us_split_fields1 a))) (to_rep (rec__my_container_model__cursor__index (us_split_fields1 b)))) true false))
...
(assert (not (<= (to_rep (rec__my_container_model__cursor__index (us_split_fields1 p))) 100)))
(check-sat)
(exit)
