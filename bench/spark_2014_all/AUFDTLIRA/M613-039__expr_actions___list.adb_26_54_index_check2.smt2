...
(declare-const j Int)
(declare-const temp___508 (Array Int integer))
(declare-const temp___5081 t)
...
(define-fun o10 () us_t (mk___t o4 o5))
(define-fun temp___5082 () us_t (mk___t temp___508 temp___5081))
...
(assert (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields3))))) (+ (- i2 first2) 1)) (forall ((j1 Int)) (=> (and (<= first2 j1) (<= j1 i2)) (= (to_rep (select (elts (to__ (mk___rep s__split_fields3))) j1)) (get (model__ l) j1))))))
(assert (and (=> (<= first2 last3) (dynamic_property1 first2 last3 i2)) (and (<= first2 i2) (<= i2 last3))))
(assert (and (= o6 (- i2 first2)) (in_range1 (- i2 first2))))
(assert (= o7 (+ o6 1)))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (and (= o10 (to__ (mk___rep s__split_fields3))) (dynamic_invariant1 o10 true false true true)))
(assert (= o9 (to_rep (last o5))))
(assert (= result1 (ite (= o9 o8) true false)))
(assert (= result1 true))
(assert (<= first2 j))
(assert (<= j i2))
(assert (and (= o2 j) (in_range6 j)))
(assert (and (= o3 (get (model__ l) o2)) (and (in_range7 o3) (= o3 (get (model__ l) o2)))))
(assert (and (= temp___5082 (to__ (mk___rep s__split_fields3))) (dynamic_invariant1 temp___5082 true false true true)))
(assert (not (<= (to_rep (first temp___5081)) j)))
(check-sat)
(exit)
