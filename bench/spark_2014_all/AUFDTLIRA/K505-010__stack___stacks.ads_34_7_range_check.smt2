...
(declare-const empty_stack_str us_t)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun temp___String_Literal_154 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_154 us_void_param) 1)) 101) (= (to_rep (select (temp___String_Literal_154 us_void_param) 2)) 109)) (= (to_rep (select (temp___String_Literal_154 us_void_param) 3)) 112)) (= (to_rep (select (temp___String_Literal_154 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_154 us_void_param) 5)) 121)) (= (to_rep (select (temp___String_Literal_154 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_154 us_void_param) 7)) 115)) (= (to_rep (select (temp___String_Literal_154 us_void_param) 8)) 116)) (= (to_rep (select (temp___String_Literal_154 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_154 us_void_param) 10)) 99)) (= (to_rep (select (temp___String_Literal_154 us_void_param) 11)) 107)) :pattern ((temp___String_Literal_154 us_void_param)))))
...
(assert (= empty_stack_str (of_array (temp___String_Literal_154 Tuple0) 1 11)))
(declare-const temp___max_219 Int)
(assert (dynamic_invariant1 empty_stack_str true false true true))
(assert (in_range1 temp___max_219))
(assert (<= 1 temp___max_219))
(assert (not (<= temp___max_219 2147483647)))
(check-sat)
(exit)
