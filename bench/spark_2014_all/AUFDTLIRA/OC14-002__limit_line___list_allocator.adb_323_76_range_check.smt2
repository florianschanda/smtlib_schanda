...
(declare-const temp___392 (Array Int us_rep))
...
(declare-const temp___398 us_rep2)
...
(assert (= r2 1))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= temp___394 r2)))
(assert (=> (and (<= 1 r2) (<= r2 3)) (= temp___392 data1)))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= (to_rep o8) (- r2 1)))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data1 r2))) o9))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= o8 o10))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= (rec__list_allocator__cell__next (us_split_fields1 (select data1 r2))) o11))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= o12 o9))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= o13 o10))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= o14 o11))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= o15 (store data1 r2 (mk___rep (mk___split_fields o12 o13 o14)))))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= result4 (mk_map__ref data1)))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< 1 r2) (= data2 o15))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (not (< 1 r2)) (= data2 data1))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (and (= o16 (+ r2 1)) (in_range1 (+ r2 1))))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= (to_rep o17) o16))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data2 r2))) o18))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= (rec__list_allocator__cell__prev (us_split_fields1 (select data2 r2))) o19))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= o17 o20))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= o21 o18))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= o22 o19))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= o23 o20))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= o24 (store data2 r2 (mk___rep (mk___split_fields o21 o22 o23)))))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= result5 (mk_map__ref data2)))))
(assert (=> (and (<= 1 r2) (<= r2 3)) (=> (< r2 3) (= data3 o24))))
...
(assert (=> (and (<= 1 r2) (<= r2 3)) (and (and (forall ((temp___393 Int)) (=> (and (<= 1 temp___393) (<= temp___393 3)) (ite (or (< 3 temp___393) (or (< temp___393 1) (< r3 temp___393))) (= (select data4 temp___393) (select temp___392 temp___393)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data4 temp___393))) (rec__list_allocator__cell__stat (us_split_fields1 (select temp___392 temp___393))))))) (=> (<= 1 3) (in_range6 r3))) (and (<= 1 r3) (<= r3 3)))))
...
(assert (<= 1 r8))
(assert (<= r8 3))
(assert (and (= o25 (add model____split_fields r8)) (= (is_add model____split_fields r8 o25) true)))
(assert (= o26 (mk___split_fields1 o25 model____split_fields1)))
(assert (= temp___398 (mk___rep1 o26)))
(assert (= result7 (mk___split_fields__ref1 (mk___split_fields1 model____split_fields model____split_fields1))))
(assert (= model____split_fields2 (us_split_fields3 temp___398)))
...
(assert (and (and (= (rec__list_allocator__m__t__allocated model____split_fields3) model____split_fields1) (=> (<= 1 3) (in_range6 r9))) (and (<= 1 r9) (<= r9 3))))
(assert (<= 1 rr))
(assert (<= rr r9))
(assert (not (in_range1 rr)))
(check-sat)
(exit)
