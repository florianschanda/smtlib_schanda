...
(define-fun dynamic_invariant4 ((temp___expr_618 Int) (temp___is_init_614 Bool) (temp___skip_constant_615 Bool) (temp___do_toplevel_616 Bool) (temp___do_typ_inv_617 Bool)) Bool (=> (or (= temp___is_init_614 true) (<= 1 150)) (in_range3 temp___expr_618)))
...
(declare-const temp___2117 (Array Int character))
(declare-const temp___21171 t1)
...
(assert (= (slide (elts text) (to_rep1 (first (rt text))) 1) temp___2114))
(assert (= (mk1 1 (to_rep1 (last (rt text)))) temp___21141))
(assert (=> (<= 1 (to_rep1 (last (rt text)))) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 (to_rep1 (last (rt text)))) (<= (to_rep1 (last (rt text))) 150)))))
(assert (= o result__1))
(assert (= o temp___2117))
(assert (= (mk1 1 (to_rep1 (last (rt text)))) temp___21171))
(assert (not (= (ite (<= (to_rep1 (first2 temp___21141)) (to_rep1 (last2 temp___21141))) (+ (- (to_rep1 (last2 temp___21141)) (to_rep1 (first2 temp___21141))) 1) 0) (ite (<= (to_rep1 (first2 temp___21171)) (to_rep1 (last2 temp___21171))) (+ (- (to_rep1 (last2 temp___21171)) (to_rep1 (first2 temp___21171))) 1) 0))))
(check-sat)
(exit)
