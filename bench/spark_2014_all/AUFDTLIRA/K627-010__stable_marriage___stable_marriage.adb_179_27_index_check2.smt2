...
(declare-const temp___580 (Array Int ranking))
...
(assert (and (= temp___580 (invert_1 o1)) (and (forall ((rank Int)) (=> (and (<= 1 rank) (<= rank 64)) (= (to_rep1 (select temp___580 (to_rep (select o1 rank)))) rank))) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (= (to_rep (select o1 (to_rep1 (select temp___580 g1)))) g1))))))
(assert (not (<= 1 prev)))
(check-sat)
(exit)
