...
(define-fun to_rep2 ((x positive_less_than_max)) Int (positive_less_than_maxqtint x))
...
(assert (forall ((x positive_less_than_max)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((s us_rep1)) (! (= (= (wraps_around s) true) (< 100 (- (+ (to_rep2 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1))) :pattern ((wraps_around s)))))
...
(define-fun dynamic_invariant2 ((temp___expr_373 Int) (temp___is_init_369 Bool) (temp___skip_constant_370 Bool) (temp___do_toplevel_371 Bool) (temp___do_typ_inv_372 Bool)) Bool (=> (or (= temp___is_init_369 true) (<= 1 100)) (in_range3 temp___expr_373)))
(declare-const o Bool)
(declare-const result Bool)
(assert (and (= o (wraps_around s)) (= (= o true) (< 100 (- (+ (to_rep2 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1)))))
(assert (= result (ite (not (= o true)) true false)))
(assert (not (= result true)))
(assert (not (in_range1 (- (- (+ (to_rep2 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) 100))))
(check-sat)
(exit)
