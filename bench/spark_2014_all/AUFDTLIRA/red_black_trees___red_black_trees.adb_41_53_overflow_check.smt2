...
(assert (= result8 true))
(assert (and (= o29 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 0)) (and (in_range2 o29) (= o29 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i1 0)))))
(assert (= o30 (select (map__content4 red_black_trees__nb_blacks__result4) o29)))
(assert (= o31 (us_split_fields11 o30)))
(assert (= o32 (rec__red_black_trees__black_count__count o31)))
(assert (= o33 (to_rep o32)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i1)) 0) (= o34 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i1)) 0)) (= o34 0)))
(assert (= o35 (+ o34 o33)))
(assert (and (= o36 o35) (in_range7 o35)))
(assert (= o37 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (map__content4 red_black_trees__nb_blacks__result4) i1)))) o36) true false)))
