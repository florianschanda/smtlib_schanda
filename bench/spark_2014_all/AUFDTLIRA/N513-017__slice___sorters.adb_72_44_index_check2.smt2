...
(assert (=> (not (= smallest1 current1)) (and (= (to_rep (select o7 o4)) (to_rep (select values smallest1))) (and (= (to_rep (select o7 smallest1)) (to_rep (select values o4))) (forall ((j2 Int)) (=> (and (<= (to_rep values__first) j2) (<= j2 (to_rep values__last))) (=> (and (not (= j2 o4)) (not (= j2 smallest1))) (= (to_rep (select o7 j2)) (to_rep (select values j2))))))))))
...
(assert (=> (= result3 true) (= result4 (ite (<= (to_rep values__first) j1) o6 false))))
