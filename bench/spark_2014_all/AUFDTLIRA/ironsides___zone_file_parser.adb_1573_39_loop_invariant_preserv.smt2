...
(assert (<= i36 128))
(assert (<= 1 endidx11))
(assert (and (and (forall ((temp___1813 Int)) (=> (and (<= 1 temp___1813) (<= temp___1813 128)) (=> (or (< 128 temp___1813) (or (< temp___1813 r105b) (<= i37 temp___1813))) (= (select newemail8 temp___1813) (select (map__content newemail6) temp___1813))))) (=> (<= r105b 128) (dynamic_property3 r105b 128 i37))) (and (<= r105b i37) (<= i37 128))))
