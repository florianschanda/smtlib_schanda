...
(define-fun dynamic_invariant2 ((temp___expr_580 us_rep1) (temp___is_init_576 Bool) (temp___skip_constant_577 Bool) (temp___do_toplevel_578 Bool) (temp___do_typ_inv_579 Bool)) Bool (=> (not (= temp___skip_constant_577 true)) (in_range2 10 (to_base temp___expr_580))))
...
(assert (dynamic_invariant1 (mk___rep x__split_discrs (mk___split_fields (mk___t x__split_fields x__split_fields1))) true false true true))
(assert (= 10 (to_rep (rec__do_checks__do_discriminant_check__r1__j y__split_discrs))))
(assert (= (to_rep (rec__do_checks__do_discriminant_check__r1__j x__split_discrs)) 10))
(assert (= (to_rep (rec__do_checks__do_discriminant_check__r1__j x__split_discrs)) r102b))
(assert (in_range r102b))
