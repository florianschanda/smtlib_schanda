...
(assert (forall ((temp___656 Int)) (=> (dynamic_invariant temp___656 true true true true) (forall ((temp___657 Int)) (= (select (temp_____aggregate_def_654 temp___656) temp___657) rliteral)))))
