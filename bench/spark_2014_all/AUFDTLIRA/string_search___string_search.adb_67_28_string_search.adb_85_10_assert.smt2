...
(assert (and (forall ((c Int)) (=> (and (<= 0 c) (<= c 255)) (and (<= 1 (to_rep (select bad_shift c))) (<= (to_rep (select bad_shift c)) (+ (length needle) 1))))) (forall ((c Int)) (=> (and (<= 0 c) (<= c 255)) (ite (= (to_rep (select bad_shift c)) (+ (length needle) 1)) (forall ((k4 Int)) (=> (and (<= (to_rep2 (first (rt needle))) k4) (<= k4 (to_rep2 (last (rt needle))))) (not (= c (to_rep1 (select (elts needle) k4)))))) (and (= (to_rep1 (select (elts needle) (+ (- (length needle) (to_rep (select bad_shift c))) 1))) c) (forall ((k4 Int)) (=> (and (<= (+ (- (length needle) (to_rep (select bad_shift c))) 2) k4) (<= k4 (to_rep2 (last (rt needle))))) (not (= (to_rep1 (select (elts needle) k4)) c))))))))))
...
(assert (forall ((l Int)) (=> (and (<= 1 l) (<= l k2)) (not (= (match_at needle haystack l) true)))))
(assert (and (=> (<= r58b1 r59b1) (dynamic_property3 r58b1 r59b1 k2)) (and (<= r58b1 k2) (<= k2 r59b1))))
(assert (not (= k2 r59b1)))
(assert (= k2 result10))
(assert (= k3 (+ k2 1)))
(assert (not (not (= (to_rep1 (select (elts haystack) (+ i1 (length needle)))) (to_rep1 (select (elts needle) (+ (- (+ i1 (length needle)) k3) 1)))))))
(check-sat)
(exit)
