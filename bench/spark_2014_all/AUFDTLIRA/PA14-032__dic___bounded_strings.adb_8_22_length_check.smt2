...
(assert (not (= (ite (<= (to_rep3 (first6 temp___2261)) (to_rep3 (last6 temp___2261))) (+ (- (to_rep3 (last6 temp___2261)) (to_rep3 (first6 temp___2261))) 1) 0) (ite (<= 1 upper_bound) (+ (- upper_bound 1) 1) 0))))
(check-sat)
(exit)
