...
(assert (=> (not (= result7 true)) (=> (= j2 (to_rep (first (rt p)))) (= o17 i4))))
(assert (=> (not (= result7 true)) (=> (= j2 (to_rep (first (rt p)))) (= o18 (store next2 o17 rliteral)))))
(assert (=> (not (= result7 true)) (=> (= j2 (to_rep (first (rt p)))) (= result12 (mk_map__ref next2)))))
(assert (=> (not (= result7 true)) (=> (= j2 (to_rep (first (rt p)))) (= next4 o18))))
...
(assert (=> (not (= result7 true)) (=> (not (= j2 (to_rep (first (rt p))))) (= o19 j2))))
(assert (=> (not (= result7 true)) (=> (not (= j2 (to_rep (first (rt p))))) (= o20 (select next2 o19)))))
(assert (=> (not (= result7 true)) (=> (not (= j2 (to_rep (first (rt p))))) (= o21 (to_rep o20)))))
(assert (=> (not (= result7 true)) (=> (not (= j2 (to_rep (first (rt p))))) (= result13 (mk_int__ref j2)))))
(assert (=> (not (= result7 true)) (=> (not (= j2 (to_rep (first (rt p))))) (= j4 o21))))
...
(assert (and (= o22 (- (to_rep (last (rt p))) 1)) (in_range1 (- (to_rep (last (rt p))) 1))))
(assert (= o23 (ite (<= i3 o22) true false)))
(assert (= o24 (ite (<= (to_rep (first (rt p))) i3) o23 false)))
(assert (= result14 (ite (not (= o24 true)) true false)))
(assert (not (= result14 true)))
(assert (and (= o25 (- i3 j3)) (in_range1 (- i3 j3))))
...
(assert (and (= o26 (- j3 1)) (in_range1 (- j3 1))))
