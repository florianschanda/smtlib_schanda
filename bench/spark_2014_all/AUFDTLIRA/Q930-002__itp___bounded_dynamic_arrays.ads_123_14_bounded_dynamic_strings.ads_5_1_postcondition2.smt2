...
(define-fun temp___11304 () us_rep (mk___rep (mk___split_discrs temp___1130) (mk___split_fields temp___11301 (mk___t temp___11302 temp___11303))))
...
(assert (dynamic_predicate temp___11304))
(assert (= temp___1131 temp___11304))
(assert (= result1 (mk___split_fields__ref to____split_fields3)))
(assert (= to____split_fields4 (us_split_fields1 temp___1131)))
(assert (= to____split_discrs (us_split_discrs1 temp___1131)))
(assert (= to____split_fields5 (mk___split_fields__ref to____split_fields4)))
(assert (= to____split_fields6 to____split_fields4))
(assert (not (= (let ((temp___1138 (value (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))))) (bool_eq (elts1 temp___1138) (to_rep2 (first2 (rt1 temp___1138))) (to_rep2 (last2 (rt1 temp___1138))) (elts1 source) (to_rep2 (first2 (rt1 source))) (to_rep2 (last2 (rt1 source))))) true)))
(check-sat)
(exit)
