...
(declare-fun temp_____aggregate_def_174 (Int Int Int) us_t1)
...
(assert (forall ((temp___176 Int) (temp___177 Int) (temp___178 Int)) (let ((temp___175 (temp_____aggregate_def_174 temp___176 temp___177 temp___178))) (=> (dynamic_invariant1 temp___176 true true true true) (and (=> (dynamic_property 1 2147483647 temp___177 temp___178) (and (= (first3 temp___175) temp___177) (= (last3 temp___175) temp___178))) (forall ((temp___179 Int)) (= (to_rep (select (to_array1 temp___175) temp___179)) temp___176)))))))
...
(assert (= (to_rep1 (first2 (rt1 (temp_____aggregate_def_174 120 (to_rep1 x__first) (to_rep1 x__last))))) (to_rep1 x__first)))
(assert (= (to_rep1 (last2 (rt1 (temp_____aggregate_def_174 120 (to_rep1 x__first) (to_rep1 x__last))))) (to_rep1 x__last)))
(assert (= (mk___t1 temp___181 temp___1811) (temp_____aggregate_def_174 120 (to_rep1 x__first) (to_rep1 x__last))))
(assert (= temp___181 temp___182))
(assert (= (mk (to_rep1 (first2 temp___1811)) (to_rep1 (last2 temp___1811))) temp___1821))
(assert (not (= (ite (<= (to_rep1 (first temp___1821)) (to_rep1 (last temp___1821))) (+ (- (to_rep1 (last temp___1821)) (to_rep1 (first temp___1821))) 1) 0) (ite (<= (to_rep1 x__first) (to_rep1 x__last)) (+ (- (to_rep1 x__last) (to_rep1 x__first)) 1) 0))))
(check-sat)
(exit)
