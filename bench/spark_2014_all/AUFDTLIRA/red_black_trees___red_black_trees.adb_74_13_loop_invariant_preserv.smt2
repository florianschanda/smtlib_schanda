...
(assert (<= 1 i9))
(assert (<= i9 100))
(assert (not (or (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (map__content4 res12) i9)))) 100) (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (map__content4 res12) i9)))) (int__content n4)))))
(check-sat)
(exit)
