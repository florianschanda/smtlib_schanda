...
(assert (= o j))
(assert (= (mk___rep5 (mk___split_fields5 o1 o2 o3)) (select res3 o)))
(assert (= o4 (mk___split_fields5 o1 o2 o3)))
(assert (= o5 (rec__red_black_trees__black_count__depth o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (<= o6 (+ n2 1)) true false)))
(assert (not (<= j 100)))
(check-sat)
(exit)
