...
(assert (= result26 (int__content string_search__qs__result22)))
(assert (not (<= (int__content string_search__qs__result22) (+ (- (length haystack) (length needle)) 1))))
(check-sat)
(exit)
