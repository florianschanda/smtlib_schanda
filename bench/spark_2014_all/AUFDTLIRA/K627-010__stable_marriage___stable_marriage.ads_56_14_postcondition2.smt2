...
(assert (forall ((temp___493 Int)) (=> (dynamic_invariant temp___493 true true true true) (forall ((temp___494 Int)) (= (select (stable_marriage__invert_2__result__aggregate_def temp___493) temp___494) rliteral)))))
(define-fun dynamic_invariant1 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 1 64)) (in_range1 temp___expr_173)))
...
(declare-const temp___497 (Array Int ranking))
...
(declare-const result3 (Array Int ranking))
...
(assert (= rank1 1))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= temp___499 rank1)))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= temp___497 result__1)))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (forall ((prev Int)) (=> (and (<= 1 prev) (<= prev (- rank2 1))) (= (to_rep1 (select result__2 (to_rep (select r2 prev)))) prev)))))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (=> (exists ((prev Int)) (and (and (<= 1 prev) (<= prev (- rank2 1))) (= (to_rep (select r2 prev)) g2))) (= (to_rep (select r2 (to_rep1 (select result__2 g2)))) g2))))))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (and (=> (<= 1 64) (in_range2 rank2)) (and (<= 1 rank2) (<= rank2 64)))))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= (to_rep1 o) rank2)))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= o1 (store result__2 (to_rep (select r2 rank2)) o))))
...
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= rank9 (mk_int__ref rank3))))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= result__10 (mk_map__ref1 result__4))))
...
(assert (=> (not (and (<= 1 rank1) (<= rank1 64))) (= result__1 result__6)))
(assert (=> (not (and (<= 1 rank1) (<= rank1 64))) (= rank6 rank1)))
(assert (=> (not (and (<= 1 rank1) (<= rank1 64))) (= result__7 result__1)))
(assert (= stable_marriage__invert_2__result1 stable_marriage__invert_2__result2))
(assert (= stable_marriage__invert_2__result3 stable_marriage__invert_2__result1))
(assert (= result3 stable_marriage__invert_2__result))
(assert (= stable_marriage__invert_2__result1 result__6))
(assert (= (mk_map__ref1 stable_marriage__invert_2__result4) (mk_map__ref1 stable_marriage__invert_2__result2)))
(assert (= (mk_int__ref rank7) rank9))
(assert (= (mk_map__ref1 result__8) result__10))
(assert (= stable_marriage__invert_2__result5 stable_marriage__invert_2__result3))
(assert (= rank8 rank6))
(assert (= result__9 result__7))
(assert (= result4 stable_marriage__invert_2__result4))
(declare-const rank10 Int)
(assert (<= 1 rank10))
(assert (<= rank10 64))
(assert (not (= (to_rep1 (select stable_marriage__invert_2__result4 (to_rep (select r2 rank10)))) rank10)))
(check-sat)
(exit)
