...
(assert (= l2 result5))
(assert (= l3 o8))
(assert (and (= o13 (+ x l3)) (in_range1 (+ x l3))))
(assert (= result7 (ite (<= o13 1000) true false)))
(assert (=> (= result7 true) (and (= o12 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result7 true) (= result6 (ite (<= o12 1000) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (= result6 true))
(assert (and (= temp___1931 (+ y l3)) (in_range1 (+ y l3))))
(assert (and (<= 1 temp___1931) (<= temp___1931 1000)))
(assert (= o9 temp___1931))
