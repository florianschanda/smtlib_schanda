...
(assert (not (= (ite (<= (to_rep1 r__first) (to_rep1 r__last)) (+ (- (to_rep1 r__last) (to_rep1 r__first)) 1) 0) (ite (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (+ (- (to_rep1 (last (rt a))) (to_rep1 (first (rt a)))) 1) 0))))
(check-sat)
(exit)
