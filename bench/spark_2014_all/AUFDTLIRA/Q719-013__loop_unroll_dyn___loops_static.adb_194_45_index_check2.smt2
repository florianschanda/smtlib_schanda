...
(assert (<= 1 i1))
(assert (<= i1 2))
(assert (and (forall ((temp___416 Int)) (=> (and (<= (to_rep1 r__first) temp___416) (<= temp___416 (to_rep1 r__last))) (=> (or (< 2 temp___416) (or (< temp___416 1) (<= i2 temp___416))) (= (select r2 temp___416) (select r1 temp___416))))) (and (<= 1 i2) (<= i2 2))))
(assert (and (<= (to_rep1 r__first) i2) (<= i2 (to_rep1 r__last))))
(assert (= o i2))
(assert (= o1 (store r2 o rliteral)))
(assert (= r2 result2))
(assert (= r3 o1))
