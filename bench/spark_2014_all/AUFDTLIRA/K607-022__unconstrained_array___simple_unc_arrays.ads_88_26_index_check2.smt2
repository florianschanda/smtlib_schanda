...
(assert (= (= result9 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))) 1))) (<= (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))) j1)) (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))) (+ j1 1))))))))
(assert (= result9 true))
(assert (<= 1 j))
(assert (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a)))))
(assert (<= 1 k))
(assert (<= k (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a)))))
(assert (and (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))))) k) (<= k (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))))))))
(assert (= o9 k))
