...
(assert (and (= o7 (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) (in_range5 (to_rep1 (rec__search_trees__search_tree__root t__split_fields5)))))
(assert (not (= (valid_root (rec__search_trees__search_tree__struct t__split_fields5) o7) true)))
(check-sat)
(exit)
