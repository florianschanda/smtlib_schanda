...
(assert (and (= (mk___rep (mk___split_fields for_loop_iterable__p4__g__assume)) (from_nat_array a1)) (= a1 for_loop_iterable__p4__g__assume)))
...
(assert (and (= o (first (mk___rep (mk___split_fields h__split_fields1)))) (and (in_range2 o) (= o 1))))
(assert (= o temp___295))
(assert (and (= result3 (has_element (mk___rep (mk___split_fields h__split_fields1)) temp___295)) (= (= result3 true) (in_range3 temp___295))))
(assert (= result3 true))
(assert (not (= (has_element (mk___rep (mk___split_fields h__split_fields1)) temp___295) true)))
(check-sat)
(exit)
