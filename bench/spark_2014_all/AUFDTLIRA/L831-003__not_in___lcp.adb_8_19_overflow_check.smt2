...
(assert (and (= o3 (+ x l2)) (in_range1 (+ x l2))))
(assert (= o4 (ite (<= o3 (to_rep (last (rt a)))) true false)))
(assert (and (= o2 (+ x l2)) (in_range1 (+ x l2))))
(assert (= o5 (ite (<= (to_rep (first (rt a))) o2) true false)))
(assert (= o6 (ite (= o5 true) o4 false)))
(assert (= result2 (ite (not (= o6 true)) true false)))
(assert (not (= result2 true)))
(assert (and (= o (+ y l2)) (in_range1 (+ y l2))))
(assert (= o1 (ite (<= o (to_rep (last (rt a)))) true false)))
(assert (not (in_range1 (+ y l2))))
(check-sat)
(exit)
