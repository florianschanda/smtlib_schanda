...
(assert (= r2 result3))
(assert (= r3 (+ r2 1)))
(assert (=> (= (to_rep (select data r3)) 0) (and (= o2 (add avail3 r3)) (and (and (and (= (length o2) (+ (length avail3) 1)) (= (contains o2 r3) true)) (= (ole avail3 o2) true)) (= (included_except o2 avail3 r3) true)))))
...
(assert (=> (not (= (to_rep (select data r3)) 0)) (and (= o3 (add alloc3 r3)) (and (and (and (= (length o3) (+ (length alloc3) 1)) (= (contains o3 r3) true)) (= (ole alloc3 o3) true)) (= (included_except o3 alloc3 r3) true)))))
...
(assert (not (= (+ (length avail4) (length alloc4)) r3)))
(check-sat)
(exit)
