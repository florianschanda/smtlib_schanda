...
(assert (=> (not (= smallest1 current1)) (and (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t o15 (mk (to_rep values__first) (to_rep values__last)))) true) (and (= (to_rep (select o15 o7)) (to_rep (select values smallest1))) (and (= (to_rep (select o15 smallest1)) (to_rep (select values o7))) (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j (to_rep values__last))) (=> (and (not (= j o7)) (not (= j smallest1))) (= (to_rep (select o15 j)) (to_rep (select values j)))))))))))
(assert (=> (not (not (= smallest1 current1))) (= o15 values)))
(assert (=> (not (not (= smallest1 current1))) (= o15 values1)))
(assert (= (perm_transitive (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values_last1 (mk (to_rep values_last__first) (to_rep values_last__last))) (mk___t o15 (mk (to_rep values__first) (to_rep values__last)))) true))
