...
(assert true)
(declare-const i Int)
(declare-const temp___1722 (Array Int us_rep3))
(declare-const o us_rep)
(declare-const o1 Bool)
(declare-const o2 us_rep)
(declare-const o3 Bool)
(declare-const temp___1721 (Array Int us_rep3))
...
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___1722 (model__ f_old root)) (and (dynamic_invariant5 temp___1722 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1722 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1722 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f_old i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1722 (parent f_old i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1722 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1722 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1722 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1722 (parent f_old i1)))) (position f_old i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1722 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1722 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1722 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1722 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1722 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1722 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep2 (mk___split_fields2 o o1)) (select temp___1722 i)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= result11 o3))
(assert (= result11 true))
(assert (and (= temp___1721 (model__ f root)) (and (dynamic_invariant5 temp___1721 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1721 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1721 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1721 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1721 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1721 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1721 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1721 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1721 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1721 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1721 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1721 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1721 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1721 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep2 (mk___split_fields2 o4 o5)) (select temp___1721 i)))
(assert (= o4 o6))
(assert (= o5 o7))
(assert (= o8 o6))
