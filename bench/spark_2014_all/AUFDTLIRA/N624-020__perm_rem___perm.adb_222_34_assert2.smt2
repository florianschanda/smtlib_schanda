...
(define-fun o17 () us_t (mk___t o14 o15))
(define-fun o18 () us_t (mk___t o11 o12))
(define-fun o19 () us_t (mk___t o8 o9))
(define-fun o20 () us_t (mk___t o6 o7))
...
(assert (and (= o18 (remove a o10)) (and (dynamic_invariant o18 true false true true) (and (= (invariant__ o18) true) (and (= (to_rep1 (last o12)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o10 1))) (= (to_rep (select (elts a) k)) (to_rep (select o11 k))))) (and (forall ((k Int)) (=> (and (<= (+ o10 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o11 (- k 1)))))) (forall ((k Int)) (=> (and (<= o10 k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o11 k))))))))))))
(assert (and (= o17 (remove o18 o13)) (and (dynamic_invariant o17 true false true true) (and (= (invariant__ o17) true) (and (= (to_rep1 (last o15)) (- (to_rep1 (last o12)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select o11 k)) (to_rep (select o14 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last o12)))) (= (to_rep (select o11 k)) (to_rep (select o14 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep1 (last o12)) 1))) (= (to_rep (select o11 (+ k 1))) (to_rep (select o14 k))))))))))))
(assert (and (= o19 (remove bb ib1)) (and (dynamic_invariant o19 true false true true) (and (= (invariant__ o19) true) (and (= (to_rep1 (last o9)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o8 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o8 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o8 k))))))))))))
(assert (and (= o5 ia1) (in_range3 ia1)))
(assert (and (= o20 (remove aa o5)) (and (dynamic_invariant o20 true false true true) (and (= (invariant__ o20) true) (and (= (to_rep1 (last o7)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o5 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o6 k))))) (and (forall ((k Int)) (=> (and (<= (+ o5 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o6 (- k 1)))))) (forall ((k Int)) (=> (and (<= o5 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o6 k))))))))))))
(assert (and (= o16 (shift_perm_l o20 o19 o17)) (and (in_range4 o16) (=> (= (distinct o16 0) true) (= (is_perm o17 o19) true)))))
(assert (= result4 (mk_int__ref ih2)))
(assert (= ih3 o16))
(assert (not (= (distinct ih3 0) true)))
(check-sat)
(exit)
