...
(assert (=> (<= (- 128) 127) (in_range3 pos2)))
(assert (= result2 (mk_int__ref temp___208)))
(assert (= temp___2081 pos2))
(assert (and (= o3 (+ pos2 1)) (in_range3 (+ pos2 1))))
