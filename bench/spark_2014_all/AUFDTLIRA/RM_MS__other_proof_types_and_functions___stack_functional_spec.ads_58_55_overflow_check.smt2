...
(assert (and (= o23 (count (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) (and (in_range3 o23) (= o23 (to_rep1 (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))))))))
(assert (= o24 (ite (<= i o23) true false)))
(assert (= result4 (ite (<= 1 i) o24 false)))
(assert (= (= o25 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (count (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1))))) (= (stack_entry (state__2 (us_split_fields__content my_stack__split_fields5)) i1) (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) i1))))))
(assert (and (= o26 (state__2 (us_split_fields__content my_stack__split_fields5))) (= (us_split_fields__content my_stack__split_fields5) (mk___split_fields o18 o19))))
(assert (and (= o20 (count o26)) (and (in_range3 o20) (= o20 (to_rep1 o19)))))
(assert (and (= o27 (state__2 (us_split_fields__content my_stack__split_fields5))) (= (us_split_fields__content my_stack__split_fields5) (mk___split_fields o16 o17))))
(assert (and (= o21 (stack_entry o27 o20)) (and (in_range1 o21) (= o21 (to_rep (select o16 o20))))))
(assert (= o22 (ite (= o21 x) true false)))
(assert (and (= o13 (max_stack_size Tuple0)) (and (in_range3 o13) (= o13 100))))
(assert (and (= o28 (state__2 (us_split_fields__content my_stack__split_fields5))) (= (us_split_fields__content my_stack__split_fields5) (mk___split_fields o11 o12))))
(assert (and (= o14 (count o28)) (and (in_range3 o14) (= o14 (to_rep1 o12)))))
