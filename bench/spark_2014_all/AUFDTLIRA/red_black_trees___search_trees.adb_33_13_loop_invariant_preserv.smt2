...
(declare-const temp___6711 (Array Int us_rep4))
...
(assert (= j2 result4))
(assert (= j3 (+ j2 1)))
(assert (and (= o9 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range6 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (and (= temp___6711 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o9)) (and (dynamic_invariant5 temp___6711 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___6711 o9))) true) (and (= (length1 (rec__tree_model__path_type__a (us_split_fields5 (select temp___6711 o9)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i o9)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___6711 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___6711 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___6711 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___6711 i))) true) (not (= i o9))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___6711 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i) (rec__tree_model__path_type__a (us_split_fields5 (select temp___6711 i)))) true) (= (length1 (rec__tree_model__path_type__a (us_split_fields5 (select temp___6711 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___6711 i))) true) (forall ((j4 Int)) (=> (and (<= 1 j4) (<= j4 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___6711 j4))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___6711 i))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___6711 j4)))) true)) (= j4 i))))))))))))))
(assert (= (mk___rep2 (mk___split_fields2 o10 o11)) (select temp___6711 j3)))
(assert (= o10 o12))
(assert (= o11 o13))
(assert (= result6 o13))
(assert (=> (= result6 true) (and (= o8 (contains s3 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j3)))) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range2 e) (= (contains s3 e) true)) (= e (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j3))))) (= o8 true))))))
(assert (=> (= result6 true) (= result5 (ite (not (= o8 true)) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (=> (= result5 true) (and (= o14 (add s3 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j3)))) (and (and (and (= (length o14) (+ (length s3) 1)) (= (contains o14 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j3))) true)) (= (ole s3 o14) true)) (= (included_except o14 s3 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j3))) true)))))
(assert (=> (= result5 true) (= o15 o14)))
(assert (=> (= result5 true) (= result7 s3)))
(assert (=> (= result5 true) (= s4 o15)))
(assert (=> (not (= result5 true)) (= s4 s3)))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i j3))
(assert (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) true))
(assert (not (= (contains s4 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i))) true)))
(check-sat)
(exit)
