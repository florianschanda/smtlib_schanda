...
(assert (= (mk___rep (mk___split_fields o4 o5)) (select temp___1151 i)))
(assert (= o6 (mk___split_fields o4 o5)))
(assert (= o7 (rec__tree_model__path_type__a o6)))
(assert (and (= o8 (length o7)) (and (in_range1 o8) (<= (+ 0 o8) 2147483647))))
(assert (= o9 (ite (< o8 n2) true false)))
(assert (= (tree_structure f2) true))
(assert (and (= temp___1150 (model__ f2 root)) (and (dynamic_invariant1 temp___1150 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1150 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1150 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f2 i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1150 (parent f2 i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1150 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1150 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1150 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1150 (parent f2 i1)))) (position f2 i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1150 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1150 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1150 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1150 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1150 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1150 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o o1)) (select temp___1150 i)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= o10 o3))
