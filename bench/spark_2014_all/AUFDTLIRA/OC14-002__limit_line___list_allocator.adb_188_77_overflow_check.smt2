...
(assert (= (mk___rep1 (mk___split_fields1 o1 o2 o3)) (select data o)))
(assert (= o1 o4))
(assert (= o2 o5))
(assert (= o3 o6))
(assert (= o7 o6))
...
(assert (= o17 res1))
(assert (= o18 (store data o17 (mk___rep1 (mk___split_fields1 o14 o15 o16)))))
(assert (= result3 (mk_map__ref data)))
(assert (= data1 o18))
(assert (=> (not (= next_avail1 0)) (and (<= 1 next_avail1) (<= next_avail1 3))))
(assert (=> (not (= next_avail1 0)) (= o19 next_avail1)))
(assert (=> (not (= next_avail1 0)) (= o20 (store data1 o19 (mk___rep1 (mk___split_fields1 (rec__list_allocator__cell__stat (us_split_fields3 (select data1 next_avail1))) rliteral (rec__list_allocator__cell__next (us_split_fields3 (select data1 next_avail1)))))))))
(assert (=> (not (= next_avail1 0)) (= result4 (mk_map__ref data1))))
(assert (=> (not (= next_avail1 0)) (= data2 o20)))
(assert (=> (not (not (= next_avail1 0))) (= data2 data1)))
(assert (=> (not (= first_allocated 0)) (= (to_rep o21) first_available)))
(assert (=> (not (= first_allocated 0)) (= (rec__list_allocator__cell__stat (us_split_fields3 (select data2 first_allocated))) o22)))
(assert (=> (not (= first_allocated 0)) (= o21 o23)))
(assert (=> (not (= first_allocated 0)) (= (rec__list_allocator__cell__next (us_split_fields3 (select data2 first_allocated))) o24)))
(assert (=> (not (= first_allocated 0)) (= o25 o22)))
(assert (=> (not (= first_allocated 0)) (= o26 o23)))
(assert (=> (not (= first_allocated 0)) (= o27 o24)))
(assert (=> (not (= first_allocated 0)) (and (<= 1 first_allocated) (<= first_allocated 3))))
(assert (=> (not (= first_allocated 0)) (= o28 first_allocated)))
(assert (=> (not (= first_allocated 0)) (= o29 (store data2 o28 (mk___rep1 (mk___split_fields1 o25 o26 o27))))))
(assert (=> (not (= first_allocated 0)) (= result5 (mk_map__ref data2))))
(assert (=> (not (= first_allocated 0)) (= data3 o29)))
...
(assert (and (= o30 (remove_at model____split_fields 1)) (= (is_removed_at model____split_fields 1 o30) true)))
(assert (= o30 o31))
(assert (= model____split_fields1 o32))
(assert (= temp___428 o31))
(assert (= temp___4281 o32))
(assert (= result8 (mk___split_fields__ref (mk___split_fields model____split_fields model____split_fields1))))
(assert (= model____split_fields2 (mk___split_fields temp___428 temp___4281)))
(assert (and (= o33 (prepend (rec__list_allocator__m__t__allocated model____split_fields2) res1)) (= (is_prepend (rec__list_allocator__m__t__allocated model____split_fields2) res1 o33) true)))
(assert (= (rec__list_allocator__m__t__available model____split_fields2) o34))
(assert (= o33 o35))
(assert (= temp___430 (mk___rep (mk___split_fields o34 o35))))
(assert (= result9 (mk___split_fields__ref model____split_fields2)))
(assert (= model____split_fields3 (us_split_fields1 temp___430)))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length (rec__list_allocator__m__t__available model____split_fields3)))) (and (and (and (in_range7 (get (rec__list_allocator__m__t__available model____split_fields3) j1)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j1))))) (ite (< j1 (length (rec__list_allocator__m__t__available model____split_fields3))) (get (rec__list_allocator__m__t__available model____split_fields3) (+ j1 1)) 0))) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j1))))) (ite (< 1 j1) (get (rec__list_allocator__m__t__available model____split_fields3) (- j1 1)) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (length (rec__list_allocator__m__t__available model____split_fields3)))) (=> (not (= j1 k)) (not (= (get (rec__list_allocator__m__t__available model____split_fields3) j1) (get (rec__list_allocator__m__t__available model____split_fields3) k))))))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (and (and (and (in_range7 (get (rec__list_allocator__m__t__allocated model____split_fields3) j1)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__allocated model____split_fields3) j1))))) (ite (< j1 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (get (rec__list_allocator__m__t__allocated model____split_fields3) (+ j1 1)) 0))) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__allocated model____split_fields3) j1))))) (ite (< 1 j1) (get (rec__list_allocator__m__t__allocated model____split_fields3) (- j1 1)) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (=> (not (= j1 k)) (not (= (get (rec__list_allocator__m__t__allocated model____split_fields3) j1) (get (rec__list_allocator__m__t__allocated model____split_fields3) k))))))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length (rec__list_allocator__m__t__available model____split_fields3)))) (= (bool_eq2 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j1)) (select data3 (get ma1 (+ j1 1)))) true))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- (length ma1) 2))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get ma1 (+ j1 1)))))) (get ma1 (+ j1 2))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- (length (rec__list_allocator__m__t__available model____split_fields3)) 1))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get ma1 (+ j1 1)))))) (get ma1 (+ j1 2))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length (rec__list_allocator__m__t__available model____split_fields3)))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get ma1 (+ j1 1)))))) (ite (< j1 (length (rec__list_allocator__m__t__available model____split_fields3))) (get ma1 (+ j1 2)) 0)))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length (rec__list_allocator__m__t__available model____split_fields3)))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j1))))) (ite (< j1 (length (rec__list_allocator__m__t__available model____split_fields3))) (get ma1 (+ j1 2)) 0)))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length (rec__list_allocator__m__t__available model____split_fields3)))) (and (in_range7 (get (rec__list_allocator__m__t__available model____split_fields3) j1)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j1))))) (ite (< j1 (length (rec__list_allocator__m__t__available model____split_fields3))) (get (rec__list_allocator__m__t__available model____split_fields3) (+ j1 1)) 0))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (in_range7 (get (rec__list_allocator__m__t__allocated model____split_fields3) j1)))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (and (in_range7 (get (rec__list_allocator__m__t__allocated model____split_fields3) j1)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__allocated model____split_fields3) j1))))) (ite (< j1 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (get (rec__list_allocator__m__t__allocated model____split_fields3) (+ j1 1)) 0))))))
(assert (forall ((r Int)) (=> (and (<= 1 r) (<= r 3)) (ite (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields3 (select data3 r)))) 0) (and (= (mem (rec__list_allocator__m__t__available model____split_fields3) r) true) (not (= (mem (rec__list_allocator__m__t__allocated model____split_fields3) r) true))) (and (not (= (mem (rec__list_allocator__m__t__available model____split_fields3) r) true)) (= (mem (rec__list_allocator__m__t__allocated model____split_fields3) r) true))))))
(assert (=> (not (= first_available1 0)) (and (= o44 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o44))))
(assert (=> (not (= first_available1 0)) (= result12 (ite (< 0 o44) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (and (= o43 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range4 o43)))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (= result11 (ite (= o43 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result12 true)) (= result11 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o45 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o45))))
(assert (=> (not (not (= first_available1 0))) (= result11 (ite (= o45 0) true false))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (and (= o41 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o41)))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (= result13 (ite (< 0 o41) true false)))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (= result13 true) (and (= o40 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range4 o40))))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (= result13 true) (= result10 (ite (= o40 first_allocated1) true false))))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (not (= result13 true)) (= result10 false)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated1 0))) (and (= o42 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o42)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated1 0))) (= result10 (ite (= o42 0) true false)))))
(assert (=> (not (= result11 true)) (= result10 false)))
(assert (= result10 true))
(assert (and (= o36 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o36)))
(assert (= o37 (ite (<= j o36) true false)))
(assert (= result14 (ite (<= 1 j) o37 false)))
(assert (= result14 true))
(assert (and (= o39 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 o39)))
(assert (= result15 (ite (in_range7 o39) true false)))
(assert (= result15 true))
(assert (and (= o38 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o38)))
(assert (= result16 (ite (< j o38) true false)))
