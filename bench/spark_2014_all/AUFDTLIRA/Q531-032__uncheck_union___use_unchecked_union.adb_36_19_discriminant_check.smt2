...
(assert (= output__split_fields4 (mk___split_fields2 (mk___rep (mk___split_fields output__split_fields output__split_fields1)) (mk___rep1 (mk___split_fields1 rliteral output__split_fields3)))))
(assert (= result1 (mk___split_discrs__ref (mk___split_discrs output__split_discrs))))
(assert (= output__split_discrs1 (mk___split_discrs output__split_discrs)))
