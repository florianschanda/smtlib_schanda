...
(declare-const o Int)
(declare-const temp___1955 (Array Int us_rep3))
(declare-const o1 us_rep3)
(declare-const o2 us_split_fields4)
(declare-const o3 Int)
(declare-const o4 Int)
(declare-const temp___1954 (Array Int us_rep3))
...
(assert (and (= temp___1955 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o)) (and (dynamic_invariant8 temp___1955 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1955 o))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1955 o)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1955 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1955 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1955 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1955 i1))) true) (not (= i1 o))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1955 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1955 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1955 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1955 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1955 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1955 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1955 j)))) true)) (= j i1))))))))))))))
(assert (= o1 (select temp___1955 ki1)))
(assert (= o2 (us_split_fields5 o1)))
(assert (= result1 (rec__tree_model__path_type__k o2)))
(assert (= result1 true))
...
(assert (and (= temp___1954 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o4)) (and (dynamic_invariant8 temp___1954 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1954 o4))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1954 o4)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o4)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1954 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1954 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1954 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1954 i1))) true) (not (= i1 o4))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1954 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1954 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1954 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1954 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1954 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1954 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1954 j)))) true)) (= j i1))))))))))))))
...
(assert (and (= o3 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range8 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (not (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) o3) true)))
(check-sat)
(exit)
