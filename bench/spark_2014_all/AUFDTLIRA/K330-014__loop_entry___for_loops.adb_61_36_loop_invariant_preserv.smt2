...
(assert (= x2 1))
(assert (=> (and (<= 1 x2) (<= x2 r8b)) (= temp___587 counter1)))
...
(assert (=> (and (<= 1 x2) (<= x2 r8b)) (=> (and (<= r10b y3) (<= y3 3)) (= temp___586 y3))))
(assert (=> (and (<= 1 x2) (<= x2 r8b)) (=> (and (<= r10b y3) (<= y3 3)) (= temp___587 1))))
...
(assert (<= y14 3))
(assert (= counter1 1))
(assert (and (=> (<= r15b 3) (dynamic_property4 r15b 3 y15)) (and (<= r15b y15) (<= y15 3))))
(assert (not (= y15 3)))
