...
(assert (not (= (length (mk___t temp___669 temp___6691)) 0)))
...
(assert (=> (<= (to_rep1 (first temp___6691)) (to_rep1 (last temp___6691))) (= o21 (+ (- (to_rep1 (last temp___6691)) (to_rep1 (first temp___6691))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6691)) (to_rep1 (last temp___6691)))) (= o21 0)))
(assert (= o22 (+ o21 o20)))
(assert (= o23 (+ (to_rep1 (first temp___6691)) o22)))
(assert (= o24 (- o23 1)))
