...
(assert (= o29 (select temp___1605 i2)))
(assert (= o30 (us_split_fields5 o29)))
(assert (= o31 (rec__tree_model__path_type__a o30)))
(assert (and (= o32 (length o31)) (and (in_range2 o32) (<= (+ 0 o32) 2147483647))))
(assert (= o33 (+ o32 1)))
(assert (and (= o34 o33) (in_range8 o33)))
