...
(assert (and (and (<= (to_rep1 (first (rt s))) courant2) (<= courant2 (to_rep1 (last (rt s))))) (not (exists ((i Int)) (and (and (<= (to_rep1 (first (rt s))) i) (<= i (- courant2 1))) (exists ((j Int)) (and (and (<= (to_rep1 (first (rt c))) j) (<= j (to_rep1 (last (rt c))))) (= (to_rep (select (elts s) i)) (to_rep (select (elts c) j))))))))))
(assert (=> (<= 1 2147483647) (in_range2 courant2)))
(assert (and (= o1 (to_rep1 (first (rt c)))) (in_range2 (to_rep1 (first (rt c))))))
(assert (= possible result2))
(assert (= possible1 o1))
(assert (in_range2 possible1))
(assert (= temp___176 possible1))
(assert (and (and (and (and (<= (to_rep1 (first (rt s))) courant2) (<= courant2 (to_rep1 (last (rt s))))) (not (exists ((i Int)) (and (and (<= (to_rep1 (first (rt s))) i) (<= i (- courant2 1))) (exists ((j Int)) (and (and (<= (to_rep1 (first (rt c))) j) (<= j (to_rep1 (last (rt c))))) (= (to_rep (select (elts s) i)) (to_rep (select (elts c) j))))))))) (and (<= (to_rep1 (first (rt c))) possible2) (<= possible2 (to_rep1 (last (rt c)))))) (not (exists ((j Int)) (and (and (<= (to_rep1 (first (rt c))) j) (<= j (- possible2 1))) (= (to_rep (select (elts s) courant2)) (to_rep (select (elts c) j))))))))
...
(assert (and (<= (to_rep1 (first (rt c))) possible2) (<= possible2 (to_rep1 (last (rt c))))))
(assert (= o4 possible2))
(assert (= o5 (select (elts c) o4)))
(assert (= o6 (to_rep o5)))
(assert (and (<= (to_rep1 (first (rt s))) courant2) (<= courant2 (to_rep1 (last (rt s))))))
(assert (= o2 courant2))
...
(assert (not (not (= courant2 2147483647))))
(check-sat)
(exit)
