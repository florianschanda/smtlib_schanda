...
(define-fun dynamic_invariant ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= 0 2147483647)) (in_range3 temp___expr_222)))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep2 (first4 (mk2 f l))) f) (= (to_rep2 (last4 (mk2 f l))) l)))) :pattern ((mk2 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep2 (first6 (mk3 f l))) f) (= (to_rep2 (last6 (mk3 f l))) l)))) :pattern ((mk3 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep2 (first8 (mk4 f l))) f) (= (to_rep2 (last8 (mk4 f l))) l)))) :pattern ((mk4 f l)))))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (rec__bounded_dynamic_strings__sequence__current_length1 (us_split_fields3 a)) (let ((temp___159 (rec__bounded_dynamic_strings__sequence__content1 (us_split_fields3 a)))) (of_array (to_array4 temp___159) (first9 temp___159) (last9 temp___159))))))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 r)) (let ((temp___158 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 r)))) (of_array4 (to_array temp___158) (first1 temp___158) (last1 temp___158))))))
...
(define-fun in_range5 ((rec__bounded_dynamic_strings__sequence__capacity1 Int) (a us_rep)) Bool (= rec__bounded_dynamic_strings__sequence__capacity1 (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant3 ((temp___expr_553 us_rep1) (temp___is_init_549 Bool) (temp___skip_constant_550 Bool) (temp___do_toplevel_551 Bool) (temp___do_typ_inv_552 Bool)) Bool (and (and (=> (not (= temp___skip_constant_550 true)) (in_range5 capacity (to_base temp___expr_553))) (=> (= temp___do_toplevel_551 true) (=> (= temp___is_init_549 true) (and (<= 0 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (to_base temp___expr_553))))) (<= (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (to_base temp___expr_553)))) (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (to_base temp___expr_553))))))))) (and (dynamic_property8 1 capacity (first9 (rec__bounded_dynamic_strings__sequence__content1 (us_split_fields3 temp___expr_553))) (last9 (rec__bounded_dynamic_strings__sequence__content1 (us_split_fields3 temp___expr_553)))) (and (= (first9 (rec__bounded_dynamic_strings__sequence__content1 (us_split_fields3 temp___expr_553))) 1) (= (last9 (rec__bounded_dynamic_strings__sequence__content1 (us_split_fields3 temp___expr_553))) capacity)))))
(define-fun default_initial_assumption ((temp___expr_557 us_rep1) (temp___skip_top_level_558 Bool)) Bool (and (and (= (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs2 temp___expr_557))) capacity) (= (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length1 (us_split_fields3 temp___expr_557))) 0)) (= (rec__bounded_dynamic_strings__sequence__content1 (us_split_fields3 temp___expr_557)) (let ((temp___560 (temp_____aggregate_def_530 32 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs2 temp___expr_557)))))) (of_array4 (to_array3 temp___560) (first7 temp___560) (last7 temp___560))))))
(define-fun dynamic_predicate1 ((temp___561 us_rep1)) Bool (and (<= 0 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (to_base temp___561))))) (<= (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (to_base temp___561)))) (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (to_base temp___561)))))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep2 (first10 (mk5 f l))) f) (= (to_rep2 (last10 (mk5 f l))) l)))) :pattern ((mk5 f l)))))
...
(declare-datatypes () ((t90b__ref (mk_t90b__ref (t90b__content us_t5)))))
(define-fun t90b__ref___projection ((a t90b__ref)) us_t5 (t90b__content a))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep2 (first12 (mk6 f l))) f) (= (to_rep2 (last12 (mk6 f l))) l)))) :pattern ((mk6 f l)))))
(define-fun dynamic_property11 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range1 low) (and (in_range1 high) (=> (<= low high) (and (in_range4 low) (in_range4 high))))))
...
(declare-fun to_string (us_image) us_t6)
(declare-fun from_string (us_t6) us_image)
(declare-datatypes () ((string__ref (mk_string__ref (string__content us_t6)))))
(define-fun string__ref___projection ((a string__ref)) us_t6 (string__content a))
(define-fun dynamic_invariant6 ((temp___expr_96 us_t6) (temp___is_init_92 Bool) (temp___skip_constant_93 Bool) (temp___do_toplevel_94 Bool) (temp___do_typ_inv_95 Bool)) Bool (=> (not (= temp___skip_constant_93 true)) (dynamic_property11 1 2147483647 (first13 temp___expr_96) (last13 temp___expr_96))))
...
(assert (in_range3 capacity))
(assert (dynamic_invariant2 content true false true true))
(assert (<= (length2 content) capacity))
(assert (and (= us capacity) (in_range3 capacity)))
(assert (default_initial_assumption (mk___rep1 result____split_discrs (mk___split_fields1 result____split_fields (mk___t4 result____split_fields1 result____split_fields2))) false))
(assert (dynamic_invariant3 (mk___rep1 result____split_discrs (mk___split_fields1 result____split_fields (mk___t4 result____split_fields1 result____split_fields2))) false false true true))
(assert (not (in_range3 (length2 content))))
(check-sat)
(exit)
