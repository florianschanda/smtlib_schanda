...
(assert (=> (= result2 true) (and (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))))
(assert (=> (= result2 true) (= o6 i2)))
(assert (=> (= result2 true) (= o7 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o6))))
(assert (=> (= result2 true) (= o8 (to_rep2 o7))))
...
(assert (<= 1 j))
(assert (<= j (- i3 1)))
(assert (not (<= res3 (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j)))))
(check-sat)
(exit)
