...
(declare-const bounded_dynamic_strings__Oconcat__3__result3 t1)
(declare-const o Int)
(declare-const o1 Int)
(declare-const temp___1053 (Array Int character))
(declare-const temp___10531 t2)
...
(declare-const temp___1054 (Array Int character))
(declare-const temp___10541 t)
...
(declare-const temp___1057 (Array Int character))
(declare-const temp___10571 t2)
...
(declare-const bounded_dynamic_strings__Oconcat__3__result7 t1)
...
(define-fun bounded_dynamic_strings__Oconcat__3__result12 () us_rep (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__3__result4) (mk___split_fields bounded_dynamic_strings__Oconcat__3__result5 (mk___t1 bounded_dynamic_strings__Oconcat__3__result6 bounded_dynamic_strings__Oconcat__3__result7))))
(define-fun temp___10572 () us_t2 (mk___t2 temp___1057 temp___10571))
(define-fun o28 () us_rep (mk___rep (mk___split_discrs o10) (mk___split_fields o11 (mk___t1 o12 o13))))
(define-fun o29 () us_t2 (mk___t2 o8 o9))
(define-fun temp___10532 () us_t2 (mk___t2 temp___1053 temp___10531))
...
(assert (<= (+ (length3 left) (length2 right)) 2147483647))
...
(assert (and (= temp___10532 (value right)) (and (dynamic_invariant2 temp___10532 true false true true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 right))) temp___1053) (= (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))))) temp___10531)) (and (and (and (= (length3 temp___10532) (length2 right)) (= (to_rep1 (first4 temp___10531)) 1)) (= (to_rep1 (last4 temp___10531)) (length2 right))) (= (< 0 (length2 right)) (not (= (empty right) true))))))))
(assert (=> (= (length3 left) 0) (= temp___1053 temp___1054)))
(assert (=> (= (length3 left) 0) (= (mk (to_rep1 (first4 temp___10531)) (to_rep1 (last4 temp___10531))) temp___10541)))
(assert (=> (not (= (length3 left) 0)) (=> (<= (to_rep1 (first4 temp___10531)) (to_rep1 (last4 temp___10531))) (= o2 (+ (- (to_rep1 (last4 temp___10531)) (to_rep1 (first4 temp___10531))) 1)))))
(assert (=> (not (= (length3 left) 0)) (=> (not (<= (to_rep1 (first4 temp___10531)) (to_rep1 (last4 temp___10531)))) (= o2 0))))
(assert (=> (not (= (length3 left) 0)) (=> (<= (to_rep1 (first4 (rt2 left))) (to_rep1 (last4 (rt2 left)))) (= o3 (+ (- (to_rep1 (last4 (rt2 left))) (to_rep1 (first4 (rt2 left)))) 1)))))
(assert (=> (not (= (length3 left) 0)) (=> (not (<= (to_rep1 (first4 (rt2 left))) (to_rep1 (last4 (rt2 left))))) (= o3 0))))
(assert (=> (not (= (length3 left) 0)) (= o4 (+ o3 o2))))
(assert (=> (not (= (length3 left) 0)) (= o5 (+ (to_rep1 (first4 (rt2 left))) o4))))
(assert (=> (not (= (length3 left) 0)) (= o6 (- o5 1))))
(assert (=> (not (= (length3 left) 0)) (and (= o7 o6) (in_range2 o6))))
(assert (=> (not (= (length3 left) 0)) (= (concat1 (elts2 left) (to_rep1 (first4 (rt2 left))) (to_rep1 (last4 (rt2 left))) temp___1053 (to_rep1 (first4 temp___10531)) (to_rep1 (last4 temp___10531))) temp___1054)))
(assert (=> (not (= (length3 left) 0)) (= (mk (to_rep1 (first4 (rt2 left))) o7) temp___10541)))
(assert (dynamic_property3 1 2147483647 (to_rep1 (first temp___10541)) (to_rep1 (last temp___10541))))
(assert (= temp___1054 o8))
(assert (= (mk2 (to_rep1 (first temp___10541)) (to_rep1 (last temp___10541))) o9))
(assert (and (= o (length3 left)) (in_range1 (length3 left))))
(assert (= o1 (+ o (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))))
(assert (and (= o28 (instance o1 o29)) (and (dynamic_invariant1 o28 true false true true) (and (and (= (to_rep2 o10) o1) (= (length2 o28) (length3 o29))) (= (let ((temp___274 (value o28))) (bool_eq (elts2 temp___274) (to_rep1 (first4 (rt2 temp___274))) (to_rep1 (last4 (rt2 temp___274))) o8 (to_rep1 (first4 o9)) (to_rep1 (last4 o9)))) true)))))
(assert (= (mk_sequence__ref (mk___rep (mk___split_discrs result) (mk___split_fields result1 (mk___t1 result2 result3)))) (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__3__result) (mk___split_fields bounded_dynamic_strings__Oconcat__3__result1 (mk___t1 bounded_dynamic_strings__Oconcat__3__result2 bounded_dynamic_strings__Oconcat__3__result3))))))
(assert (= bounded_dynamic_strings__Oconcat__3__result12 o28))
...
(assert (and (= o24 (length2 right)) (and (in_range4 o24) (= o24 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))))
(assert (and (= o25 (length3 left)) (in_range1 (length3 left))))
(assert (= o26 (+ o25 o24)))
(assert (= o27 (ite (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (sequence__content bounded_dynamic_strings__Oconcat__3__result10)))) o26) true false)))
(assert (and (= o19 (length2 right)) (and (in_range4 o19) (= o19 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))))
(assert (and (= o20 (length3 left)) (in_range1 (length3 left))))
(assert (= o21 (+ o20 o19)))
(assert (and (= o22 (length2 (sequence__content bounded_dynamic_strings__Oconcat__3__result10))) (and (in_range4 o22) (= o22 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (sequence__content bounded_dynamic_strings__Oconcat__3__result10))))))))
(assert (= o23 (ite (= o22 o21) true false)))
(assert (and (= temp___10572 (value right)) (and (dynamic_invariant2 temp___10572 true false true true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 right))) temp___1057) (= (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))))) temp___10571)) (and (and (and (= (length3 temp___10572) (length2 right)) (= (to_rep1 (first4 temp___10571)) 1)) (= (to_rep1 (last4 temp___10571)) (length2 right))) (= (< 0 (length2 right)) (not (= (empty right) true))))))))
(assert (not (= (length3 left) 0)))
(assert (=> (<= (to_rep1 (first4 temp___10571)) (to_rep1 (last4 temp___10571))) (= o14 (+ (- (to_rep1 (last4 temp___10571)) (to_rep1 (first4 temp___10571))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___10571)) (to_rep1 (last4 temp___10571)))) (= o14 0)))
(assert (=> (<= (to_rep1 (first4 (rt2 left))) (to_rep1 (last4 (rt2 left)))) (= o15 (+ (- (to_rep1 (last4 (rt2 left))) (to_rep1 (first4 (rt2 left)))) 1))))
(assert (=> (not (<= (to_rep1 (first4 (rt2 left))) (to_rep1 (last4 (rt2 left))))) (= o15 0)))
(assert (= o16 (+ o15 o14)))
(assert (= o17 (+ (to_rep1 (first4 (rt2 left))) o16)))
(assert (= o18 (- o17 1)))
(assert (not (in_range2 o18)))
(check-sat)
(exit)
