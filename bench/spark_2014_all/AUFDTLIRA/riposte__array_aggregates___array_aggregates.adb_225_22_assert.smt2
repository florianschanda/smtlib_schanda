...
(declare-fun temp_____aggregate_def_539 ((Array Int unsigned_byte) (Array Int unsigned_byte)) (Array Int (Array Int unsigned_byte)))
(declare-fun temp_____aggregate_def_544 (Int Int Int Int) (Array Int unsigned_byte))
(declare-fun temp_____aggregate_def_551 (Int Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___541 (Array Int unsigned_byte)) (temp___542 (Array Int unsigned_byte))) (let ((temp___540 (temp_____aggregate_def_539 temp___541 temp___542))) (forall ((temp___543 Int)) (ite (or (= temp___543 2) (and (<= 4 temp___543) (<= temp___543 6))) (= (select temp___540 temp___543) temp___541) (= (select temp___540 temp___543) temp___542))))))
...
(assert (forall ((temp___546 Int) (temp___547 Int) (temp___548 Int) (temp___549 Int)) (let ((temp___545 (temp_____aggregate_def_544 temp___546 temp___547 temp___548 temp___549))) (=> (and (and (and (dynamic_invariant temp___546 true true true true) (dynamic_invariant temp___547 true true true true)) (dynamic_invariant temp___548 true true true true)) (dynamic_invariant temp___549 true true true true)) (forall ((temp___550 Int)) (ite (= temp___550 3) (= (select temp___545 temp___550) rliteral) (ite (= temp___550 2) (= (select temp___545 temp___550) rliteral1) (ite (= temp___550 1) (= (select temp___545 temp___550) rliteral2) (= (select temp___545 temp___550) rliteral3)))))))))
...
(assert (forall ((temp___553 Int) (temp___554 Int)) (let ((temp___552 (temp_____aggregate_def_551 temp___553 temp___554))) (=> (and (dynamic_invariant temp___553 true true true true) (dynamic_invariant temp___554 true true true true)) (forall ((temp___555 Int)) (ite (= temp___555 5) (= (select temp___552 temp___555) rliteral4) (= (select temp___552 temp___555) rliteral5)))))))
...
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_539 (temp_____aggregate_def_544 1 2 3 0) (temp_____aggregate_def_551 10 12))))
