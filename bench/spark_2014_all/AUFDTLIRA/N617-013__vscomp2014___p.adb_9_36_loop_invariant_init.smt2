...
(define-fun i8 () int__ref (mk_int__ref i5))
(define-fun f9 () map__ref (mk_map__ref f6))
(define-fun f10 () map__ref (mk_map__ref f))
(assert (= f saved))
(assert (= result j))
(assert (= j1 1))
...
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_map__ref result2) f10)))
