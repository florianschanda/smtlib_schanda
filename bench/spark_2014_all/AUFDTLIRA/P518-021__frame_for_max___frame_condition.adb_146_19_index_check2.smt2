...
(define-fun dynamic_invariant ((temp___expr_169 us_t) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool) (temp___do_typ_inv_168 Bool)) Bool (=> (not (= temp___skip_constant_166 true)) (dynamic_property 1 2147483647 (first1 temp___expr_169) (last1 temp___expr_169))))
(declare-const a__first integer)
(declare-const a__last integer)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const old_a us_t)
...
(assert (dynamic_invariant old_a true false true true))
(assert (dynamic_property 1 2147483647 (to_rep1 a__first) (to_rep1 a__last)))
(assert (and (= (to_rep1 (first (rt old_a))) (to_rep1 a__first)) (= (to_rep1 (last (rt old_a))) (to_rep1 a__last))))
(assert (<= (to_rep1 a__first) i))
(assert (<= i (to_rep1 a__last)))
(assert (and (<= (to_rep1 (first (rt old_a))) i) (<= i (to_rep1 (last (rt old_a))))))
(assert (= o17 i))
(assert (= (mk___rep (mk___split_fields o18 o19 o20)) (select (elts old_a) o17)))
(assert (= o18 o21))
(assert (= o19 o22))
(assert (= o20 o23))
(assert (= o24 o22))
...
(assert (= o9 i))
(assert (= (mk___rep (mk___split_fields o10 o11 o12)) (select a o9)))
(assert (= o10 o13))
(assert (= o11 o14))
(assert (= o12 o15))
(assert (= o16 o14))
...
(assert (and (<= (to_rep1 (first (rt old_a))) i) (<= i (to_rep1 (last (rt old_a))))))
(assert (= o i))
(assert (= (mk___rep (mk___split_fields o1 o2 o3)) (select (elts old_a) o)))
(assert (= o1 o4))
(assert (= o2 o5))
(assert (= o3 o6))
(assert (= o7 o4))
