...
(define-fun dynamic_invariant2 ((temp___expr_177 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool) (temp___do_typ_inv_176 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= 0 2147483647)) (in_range3 temp___expr_177)))
...
(define-fun dynamic_invariant4 ((temp___expr_231 us_t1) (temp___is_init_227 Bool) (temp___skip_constant_228 Bool) (temp___do_toplevel_229 Bool) (temp___do_typ_inv_230 Bool)) Bool (and (=> (not (= temp___skip_constant_228 true)) (and (dynamic_property2 (to_rep values__first) (to_rep values__last) (first3 temp___expr_231) (last3 temp___expr_231)) (and (= (first3 temp___expr_231) (to_rep values__first)) (= (last3 temp___expr_231) (to_rep values__last))))) (=> (= temp___do_toplevel_229 true) (=> (= temp___is_init_227 true) (= (first3 temp___expr_231) 0)))))
...
(assert (forall ((a us_t)) (! (=> (dynamic_invariant1 a true true true true) (= (remove_last a) (let ((temp___189 (let ((temp___188 (- (last1 a) 1))) (let ((temp___187 (first1 a))) (of_array3 (to_array a) temp___187 temp___188))))) (of_array (to_array3 temp___189) (first7 temp___189) (last7 temp___189))))) :pattern ((remove_last a)))))
...
(assert (in_range2 x))
(assert (in_range2 y))
(assert (dynamic_invariant4 init true false true true))
(assert (and (and (dynamic_property4 (to_rep values__first) (to_rep values__last) (to_rep interm__first) (to_rep interm__last)) (and (= (to_rep interm__first) (to_rep values__first)) (= (to_rep interm__last) (to_rep values__last)))) (= (to_rep interm__first) 0)))
(assert (<= (to_rep values__first) x))
(assert (<= x (to_rep values__last)))
(assert (<= (to_rep values__first) y))
(assert (<= y (to_rep values__last)))
(assert (and (<= (to_rep (first2 (rt1 init))) y) (<= y (to_rep (last2 (rt1 init))))))
(assert (= o y))
(assert (= o1 (select (elts1 init) o)))
(assert (= o2 (to_rep o1)))
(assert (and (= result (is_set (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) x o2 (mk___t interm (mk (to_rep interm__first) (to_rep interm__last))))) (= (= result true) (and (and (and (= (to_rep (first (mk (to_rep interm__first) (to_rep interm__last)))) (to_rep (first (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))))) (= (to_rep (last (mk (to_rep interm__first) (to_rep interm__last)))) (to_rep (last (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init)))))))) (= (to_rep (select interm x)) o2)) (forall ((j Int)) (=> (and (<= (to_rep (first (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init)))))) j) (<= j (to_rep (last (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init)))))))) (=> (not (= x j)) (= (to_rep (select interm j)) (to_rep (select (elts1 init) j))))))))))
(assert (= result true))
(assert (not (<= (to_rep (first2 (rt1 init))) x)))
(check-sat)
(exit)
