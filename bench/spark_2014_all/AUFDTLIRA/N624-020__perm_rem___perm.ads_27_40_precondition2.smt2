...
(declare-const temp___629 (Array Int natural))
(declare-const temp___6291 t)
...
(define-fun temp___6292 () us_t (mk___t temp___629 temp___6291))
...
(assert (and (= temp___6292 (remove b i)) (and (dynamic_invariant temp___6292 true false true true) (and (= (invariant__ temp___6292) true) (and (= (to_rep1 (last temp___6291)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i 1))) (= (to_rep (select (elts b) k)) (to_rep (select temp___629 k))))) (and (forall ((k Int)) (=> (and (<= (+ i 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select temp___629 (- k 1)))))) (forall ((k Int)) (=> (and (<= i k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select temp___629 k))))))))))))
