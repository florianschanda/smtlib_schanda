...
(assert (not (= (let ((temp___1064 (value (sequence__content bounded_dynamic_strings__Oconcat__3__result10)))) (bool_eq (elts2 temp___1064) (to_rep1 (first4 (rt2 temp___1064))) (to_rep1 (last4 (rt2 temp___1064))) (let ((temp___1063 (value right))) (ite (= (length3 left) 0) (elts2 temp___1063) (concat1 (elts2 left) (to_rep1 (first4 (rt2 left))) (to_rep1 (last4 (rt2 left))) (elts2 temp___1063) (to_rep1 (first4 (rt2 temp___1063))) (to_rep1 (last4 (rt2 temp___1063)))))) (to_rep1 (first (let ((temp___1063 (value right))) (ite (= (length3 left) 0) (mk (to_rep1 (first4 (rt2 temp___1063))) (to_rep1 (last4 (rt2 temp___1063)))) (mk (to_rep1 (first4 (rt2 left))) (- (+ (to_rep1 (first4 (rt2 left))) (+ (ite (<= (to_rep1 (first4 (rt2 left))) (to_rep1 (last4 (rt2 left)))) (+ (- (to_rep1 (last4 (rt2 left))) (to_rep1 (first4 (rt2 left)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 temp___1063))) (to_rep1 (last4 (rt2 temp___1063)))) (+ (- (to_rep1 (last4 (rt2 temp___1063))) (to_rep1 (first4 (rt2 temp___1063)))) 1) 0))) 1)))))) (to_rep1 (last (let ((temp___1063 (value right))) (ite (= (length3 left) 0) (mk (to_rep1 (first4 (rt2 temp___1063))) (to_rep1 (last4 (rt2 temp___1063)))) (mk (to_rep1 (first4 (rt2 left))) (- (+ (to_rep1 (first4 (rt2 left))) (+ (ite (<= (to_rep1 (first4 (rt2 left))) (to_rep1 (last4 (rt2 left)))) (+ (- (to_rep1 (last4 (rt2 left))) (to_rep1 (first4 (rt2 left)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 temp___1063))) (to_rep1 (last4 (rt2 temp___1063)))) (+ (- (to_rep1 (last4 (rt2 temp___1063))) (to_rep1 (first4 (rt2 temp___1063)))) 1) 0))) 1)))))))) true)))
(check-sat)
(exit)
