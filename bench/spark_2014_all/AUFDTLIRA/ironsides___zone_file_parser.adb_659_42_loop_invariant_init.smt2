...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i31 Int)) (=> (and (<= begidx2 i31) (<= i31 endidx1)) (and (<= 48 (to_rep (select zonefileline i31))) (<= (to_rep (select zonefileline i31)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 foundtype1))))
...
(assert (=> (and (not (= foundtype1 3)) (< endidx1 zlength)) (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i31 Int)) (=> (and (<= begidx5 i31) (<= i31 endidx3)) (and (<= 48 (to_rep (select zonefileline i31))) (<= (to_rep (select zonefileline i31)) 57)))))) (and (and (in_range4 begidx5) (in_range4 endidx3)) (in_range3 foundtype3)))))
...
(assert (= begidx10 o1))
(assert (and (and (and (and (<= begidx11 endidx8) (<= begidx11 zlength)) (<= endidx8 zlength)) (=> (= foundtype8 1) (forall ((i31 Int)) (=> (and (<= begidx11 i31) (<= i31 endidx8)) (and (<= 48 (to_rep (select zonefileline i31))) (<= (to_rep (select zonefileline i31)) 57)))))) (and (and (in_range4 begidx11) (in_range4 endidx8)) (in_range3 foundtype8))))
...
(assert (=> (< 128 lengthoftoken1) (= i19 i29)))
(assert (=> (< 128 lengthoftoken1) (= i18 i30)))
...
(assert (=> (not (< 128 lengthoftoken1)) (= result7 i30)))
...
(assert (=> (not (< 128 lengthoftoken1)) (= result9 i29)))
...
(assert (= begidx12 o10))
(assert (and (and (and (and (<= begidx13 endidx9) (<= begidx13 zlength)) (<= endidx9 zlength)) (=> (= foundtype9 1) (forall ((i31 Int)) (=> (and (<= begidx13 i31) (<= i31 endidx9)) (and (<= 48 (to_rep (select zonefileline i31))) (<= (to_rep (select zonefileline i31)) 57)))))) (and (and (in_range4 begidx13) (in_range4 endidx9)) (in_range3 foundtype9))))
