...
(declare-const o4 t4)
(declare-const temp___954 natural_index)
(declare-const temp___9541 natural_index)
(declare-const temp___9542 (Array Int character))
(declare-const temp___9543 t4)
(declare-const temp___955 us_rep1)
(declare-const temp___956 us_t5)
(declare-const result us_split_fields__ref1)
(declare-const result____split_fields3 us_split_fields2)
(define-fun temp___9544 () us_rep1 (mk___rep1 (mk___split_discrs temp___954) (mk___split_fields1 temp___9541 (mk___t4 temp___9542 temp___9543))))
...
(assert (= result____split_discrs (mk___split_discrs temp___954)))
(assert (= temp___9541 o2))
(assert (= temp___9542 o3))
(assert (= temp___9543 o4))
(assert (dynamic_predicate1 temp___9544))
(assert (= temp___955 temp___9544))
...
(assert (= result____split_fields3 (us_split_fields3 temp___955)))
(assert (= result____split_discrs (us_split_discrs2 temp___955)))
(assert (= (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length1 result____split_fields3)) r88b))
(assert (in_range3 r88b))
(assert (= (ite (<= (to_rep2 (first2 (rt1 content))) (to_rep2 (last2 (rt1 content)))) (+ (- (to_rep2 (last2 (rt1 content))) (to_rep2 (first2 (rt1 content)))) 1) 0) (ite (<= 1 r88b) (+ (- r88b 1) 1) 0)))
(assert (= temp___956 (mk___t5 (slide (elts1 content) (to_rep2 (first2 (rt1 content))) 1) (mk5 1 r88b))))
(assert (<= 1 r88b))
(assert (not (<= (to_rep2 (first8 (rt4 (rec__bounded_dynamic_strings__sequence__content1 result____split_fields3)))) 1)))
(check-sat)
(exit)
