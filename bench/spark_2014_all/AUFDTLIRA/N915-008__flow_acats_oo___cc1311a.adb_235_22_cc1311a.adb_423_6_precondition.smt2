...
(assert (forall ((x month_type)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(declare-fun user_eq6 (first_half first_half) Bool)
(declare-const dummy6 first_half)
...
(define-fun component_type__ref___5__projection ((a component_type__ref)) us_rep (component_type__content a))
(declare-const default_value us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const c430b map1)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-fun temp_____aggregate_def_708 (us_rep) map1)
(declare-fun temp_____aggregate_def_714 (us_rep) map1)
(declare-fun temp___String_Literal_721 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_721 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_721 us_void_param) 2)) 82)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 3)) 79)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 4)) 66)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 5)) 76)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 6)) 69)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 7)) 77)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 8)) 83)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 10)) 87)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 11)) 73)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 12)) 84)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 13)) 72)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 15)) 84)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 16)) 72)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 17)) 82)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 18)) 69)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 19)) 69)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 21)) 68)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 22)) 73)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 23)) 77)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 24)) 69)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 25)) 78)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 26)) 83)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 27)) 73)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 28)) 79)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 29)) 78)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 30)) 65)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 31)) 76)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 33)) 65)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 34)) 82)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 35)) 82)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 36)) 65)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 37)) 89)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 38)) 44)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 39)) 32)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 40)) 80)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 41)) 82)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 42)) 79)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 43)) 67)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 44)) 69)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 45)) 68)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 46)) 85)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 47)) 82)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 48)) 69)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 49)) 44)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 50)) 32)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 51)) 65)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 52)) 78)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 53)) 68)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 54)) 32)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 55)) 80)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 56)) 65)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 57)) 67)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 58)) 75)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 59)) 65)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 60)) 71)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 61)) 69)) (= (to_rep (select (temp___String_Literal_721 us_void_param) 62)) 46)) :pattern ((temp___String_Literal_721 us_void_param)))))
...
(define-fun dynamic_invariant5 ((temp___expr_251 Int) (temp___is_init_247 Bool) (temp___skip_constant_248 Bool) (temp___do_toplevel_249 Bool) (temp___do_typ_inv_250 Bool)) Bool (=> (or (= temp___is_init_247 true) (<= 0 11)) (in_range5 temp___expr_251)))
(define-fun dynamic_invariant6 ((temp___expr_258 Int) (temp___is_init_254 Bool) (temp___skip_constant_255 Bool) (temp___do_toplevel_256 Bool) (temp___do_typ_inv_257 Bool)) Bool (=> (or (= temp___is_init_254 true) (<= 0 5)) (in_range6 temp___expr_258)))
...
(assert (forall ((temp___716 us_rep)) (forall ((temp___717 Int) (temp___718 Int) (temp___719 Int)) (= (get (temp_____aggregate_def_714 temp___716) temp___717 temp___718 temp___719) temp___716))))
(assert (forall ((temp___710 us_rep)) (forall ((temp___711 Int) (temp___712 Int) (temp___713 Int)) (= (get (temp_____aggregate_def_708 temp___710) temp___711 temp___712 temp___713) temp___710))))
...
(declare-const temp___726 month_type)
(declare-const temp___7261 day_type)
(declare-const temp___7262 year_type)
...
(assert (= temp___7261 o2))
(assert (= temp___7262 o3))
(assert (= (mk___rep (mk___split_fields temp___726 temp___7261 temp___7262)) today))
(assert (= today default_value))
(assert (= (temp_____aggregate_def_708 default_value) c430b))
(assert (= result results))
(assert (= results1 c430b))
(assert (not (= (bool_eq3 results1 (- 9) 0 0 5 65 69 (temp_____aggregate_def_714 default_value) (- 9) 0 0 5 65 69) true)))
(check-sat)
(exit)
