...
(declare-const a_length1 Int)
(declare-const result3 Int)
(declare-const i2 Int)
(declare-const result4 (Array Int natural))
(declare-const a2 (Array Int natural))
(declare-const result5 Int)
(declare-const a_length2 Int)
(assert (dynamic_property (- 2147483648) 2147483647 (to_rep1 a__first) (to_rep1 a__last)))
(assert (not (not (and (and (= (mk_int__ref result) (mk_int__ref i)) (= i1 1)) (and (and (and (and (and (<= (to_rep1 a__first) i1) (<= i1 (to_rep1 a__last))) (= o i1)) (= o1 (store a o rliteral))) (and (= (mk_map__ref result1) (mk_map__ref a)) (= a1 o1))) (and (and (and (and (and (and (and (= o2 (- i1 (to_rep1 a__first))) (in_range1 (- i1 (to_rep1 a__first)))) (= o3 (+ o2 1))) (and (= o4 o3) (in_range1 o3))) (and (= o5 o4) (in_range2 o4))) (and (= (mk_int__ref result2) (mk_int__ref a_length)) (= a_length1 o5))) (in_range2 a_length1)) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 a_length1)) (= (to_rep (select a1 (+ (to_rep1 a__first) i3))) 0))) (and (and (= i1 result3) (= i2 2)) (and (and (and (and (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last))) (= o6 i2)) (= o7 (store a1 o6 rliteral))) (and (= a1 result4) (= a2 o7))) (and (and (and (and (and (and (and (= o8 (- i2 (to_rep1 a__first))) (in_range1 (- i2 (to_rep1 a__first)))) (= o9 (+ o8 1))) (and (= o10 o9) (in_range1 o9))) (and (= o11 o10) (in_range2 o10))) (and (= a_length1 result5) (= a_length2 o11))) (in_range2 a_length2)) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 a_length2)) (= (to_rep (select a2 (+ (to_rep1 a__first) i3))) 0)))))))))))))
(check-sat)
(exit)
