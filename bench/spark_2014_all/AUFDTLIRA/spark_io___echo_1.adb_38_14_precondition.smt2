...
(assert (= result1 true))
(assert (and (and (and (and (and (and (and (= (is_writable standard_output2) true) (= (is_open standard_output2) true)) (= (mode__2 standard_output2) (mode__2 standard_output1))) (= (let ((temp___798 (name standard_output1))) (let ((temp___797 (name standard_output2))) (bool_eq (elts temp___797) (to_rep1 (first (rt temp___797))) (to_rep1 (last (rt temp___797))) (elts temp___798) (to_rep1 (first (rt temp___798))) (to_rep1 (last (rt temp___798)))))) true)) (= (let ((temp___800 (form standard_output1))) (let ((temp___799 (form standard_output2))) (bool_eq (elts temp___799) (to_rep1 (first (rt temp___799))) (to_rep1 (last (rt temp___799))) (elts temp___800) (to_rep1 (first (rt temp___800))) (to_rep1 (last (rt temp___800)))))) true)) (= (line_length__2 standard_output2) (line_length__2 standard_output1))) (= (page_length__2 standard_output2) (page_length__2 standard_output1))) (= (= (is_standard_file standard_output2) true) (= (is_standard_file standard_output1) true))))
(assert (= standard_error2 standard_error1))
(assert (not (= (is_readable standard_input2) true)))
(check-sat)
(exit)
