...
(assert (forall ((name us_t) (directory us_t)) (forall ((resolve_links Bool)) (! (=> (and (dynamic_invariant name true true true true) (dynamic_invariant directory true true true true)) (dynamic_invariant (normalize_pathname name directory resolve_links) true false true true)) :pattern ((normalize_pathname name directory resolve_links))))))
(declare-fun test (us_t us_t) us_t)
(declare-fun test__function_guard (us_t us_t us_t) Bool)
(assert (forall ((name us_t) (directory us_t)) (! (=> (and (dynamic_invariant name true true true true) (dynamic_invariant directory true true true true)) (dynamic_invariant (test name directory) true false true true)) :pattern ((test name directory)))))
(declare-fun is_valid (us_t) Bool)
(declare-fun is_valid__function_guard (Bool us_t) Bool)
(assert true)
(assert (forall ((name us_t)) (! (= (is_valid name) true) :pattern ((is_valid name)))))
