...
(assert (and (= o12 (length2 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))) (and (in_range7 o12) (<= o12 (capacity (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))))))
...
(assert (= result1 true))
(assert (and (= o7 (length2 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))) (and (in_range7 o7) (<= o7 (capacity (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))))))
(assert (= o8 (- o7 1)))
