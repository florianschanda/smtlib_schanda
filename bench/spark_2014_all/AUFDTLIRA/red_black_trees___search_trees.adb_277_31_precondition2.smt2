...
(declare-const temp___1430 (Array Int us_rep3))
...
(assert (= result7 true))
(assert (and (= temp___1430 (model__ f_old root)) (and (dynamic_invariant5 temp___1430 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1430 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1430 root)))) 0) (and (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 100)) (=> (not (= i10 root)) (ite (and (not (= (parent f_old i10) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1430 (parent f_old i10)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1430 i10))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1430 i10))) true)))))) (and (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1430 i10))) true) (not (= i10 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1430 (parent f_old i10)))) (position f_old i10) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1430 i10)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1430 i10)))) 0)))) (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1430 i10))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1430 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1430 i10))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1430 j15)))) true)) (= j15 i10))))))))))))))
(assert (= o20 (select temp___1430 j14)))
