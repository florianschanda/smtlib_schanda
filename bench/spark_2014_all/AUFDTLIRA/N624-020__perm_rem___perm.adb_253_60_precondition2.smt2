...
(assert (= ib1 o5))
(assert (and (= o6 ia1) (in_range3 ia1)))
(assert (and (= o7 (remove a o6)) (and (dynamic_invariant o7 true false true true) (and (= (invariant__ o7) true) (and (= (to_rep1 (last (rt o7))) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o6 1))) (= (to_rep (select (elts a) k)) (to_rep (select (elts o7) k))))) (and (forall ((k Int)) (=> (and (<= (+ o6 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select (elts o7) (- k 1)))))) (forall ((k Int)) (=> (and (<= o6 k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o7) k))))))))))))
(assert (and (= o8 (remove o7 (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant o8 true false true true) (and (= (invariant__ o8) true) (and (= (to_rep1 (last (rt o8))) (- (to_rep1 (last (rt o7))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep (select (elts o7) k)) (to_rep (select (elts o8) k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k) (<= k (to_rep1 (last (rt o7))))) (= (to_rep (select (elts o7) k)) (to_rep (select (elts o8) (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) k) (<= k (- (to_rep1 (last (rt o7))) 1))) (= (to_rep (select (elts o7) (+ k 1))) (to_rep (select (elts o8) k))))))))))))
