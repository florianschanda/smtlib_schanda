...
(assert (and (and (<= (to_rep1 (first (mk (to_rep1 x__first) (to_rep1 x__last)))) 1) (<= 3 (to_rep1 (last (mk (to_rep1 x__first) (to_rep1 x__last)))))) (not (= (to_rep (select o12 3)) 0))))
(assert (and (<= (to_rep1 x__first) 1) (<= 3 (to_rep1 x__last))))
(assert (and (<= (to_rep1 x__first) 1) (<= 3 (to_rep1 x__last))))
(assert (and (<= (to_rep1 x__first) 1) (<= 3 (to_rep1 x__last))))
(assert (and (<= (to_rep1 x__first) 1) (<= 3 (to_rep1 x__last))))
(assert (and (<= (to_rep1 x__first) 1) (<= 3 (to_rep1 x__last))))
(assert (and (and (<= (to_rep1 (first (mk (to_rep1 x__first) (to_rep1 x__last)))) 1) (<= 3 (to_rep1 (last (mk (to_rep1 x__first) (to_rep1 x__last)))))) (not (= (to_rep (select o13 3)) 0))))
(assert (and (<= (to_rep1 x__first) 1) (<= 3 (to_rep1 x__last))))
(assert (and (<= (to_rep1 x__first) 1) (<= 3 (to_rep1 x__last))))
(assert (and (<= (to_rep1 x__first) 1) (<= 3 (to_rep1 x__last))))
(assert (dynamic_property1 (- 2147483648) 2147483647 (to_rep1 x__first) (to_rep1 x__last)))
(assert (= o14 temp___316))
...
(assert (and (and (<= (to_rep1 (first (mk (to_rep1 y__first) (to_rep1 y__last)))) 1) (<= 3 (to_rep1 (last (mk (to_rep1 y__first) (to_rep1 y__last)))))) (not (= (to_rep (select o16 3)) 0))))
(assert (and (and (<= (to_rep1 (first (mk (to_rep1 y__first) (to_rep1 y__last)))) 1) (<= 3 (to_rep1 (last (mk (to_rep1 y__first) (to_rep1 y__last)))))) (not (= (to_rep (select o17 3)) 0))))
(assert (and (and (<= (to_rep1 (first (mk (to_rep1 y__first) (to_rep1 y__last)))) 1) (<= 3 (to_rep1 (last (mk (to_rep1 y__first) (to_rep1 y__last)))))) (not (= (to_rep (select o17 3)) 0))))
...
(assert (dynamic_predicate1 (mk___t1 formals_arr_split_pred__p2__a (mk1 (to_rep1 (first (mk (to_rep1 (first (mk (to_rep1 y__first) (to_rep1 y__last)))) (to_rep1 (last (mk (to_rep1 y__first) (to_rep1 y__last))))))) (to_rep1 (last (mk (to_rep1 (first (mk (to_rep1 y__first) (to_rep1 y__last)))) (to_rep1 (last (mk (to_rep1 y__first) (to_rep1 y__last)))))))))))
(assert (= formals_arr_split_pred__p2__a o7))
(assert (= (mk1 (to_rep1 (first (mk (to_rep1 (first (mk (to_rep1 y__first) (to_rep1 y__last)))) (to_rep1 (last (mk (to_rep1 y__first) (to_rep1 y__last))))))) (to_rep1 (last (mk (to_rep1 (first (mk (to_rep1 y__first) (to_rep1 y__last)))) (to_rep1 (last (mk (to_rep1 y__first) (to_rep1 y__last)))))))) o8))
(assert (= o9 o7))
(assert (= result4 o17))
(assert (= o18 o9))
(assert (and (and (<= (to_rep1 (first (mk (to_rep1 u__first) (to_rep1 u__last)))) 1) (<= 3 (to_rep1 (last (mk (to_rep1 u__first) (to_rep1 u__last)))))) (not (= (to_rep (select u2 3)) 0))))
(assert (and (and (<= (to_rep1 (first (mk (to_rep1 u__first) (to_rep1 u__last)))) 1) (<= 3 (to_rep1 (last (mk (to_rep1 u__first) (to_rep1 u__last)))))) (not (= (to_rep (select u2 3)) 0))))
(assert (= (to_rep1 o11) (to_rep1 (last (mk (to_rep1 u__first) (to_rep1 u__last))))))
(assert (= (to_rep1 o10) (to_rep1 (first (mk (to_rep1 u__first) (to_rep1 u__last))))))
(assert (and (<= (to_rep1 o10) 1) (<= 3 (to_rep1 o11))))
(assert (not (dynamic_predicate2 (mk___t2 formals_arr_split_pred__p2__a1 (mk2 (to_rep1 (first (mk (to_rep1 (first (mk (to_rep1 u__first) (to_rep1 u__last)))) (to_rep1 (last (mk (to_rep1 u__first) (to_rep1 u__last))))))) (to_rep1 (last (mk (to_rep1 (first (mk (to_rep1 u__first) (to_rep1 u__last)))) (to_rep1 (last (mk (to_rep1 u__first) (to_rep1 u__last))))))))))))
(check-sat)
(exit)
