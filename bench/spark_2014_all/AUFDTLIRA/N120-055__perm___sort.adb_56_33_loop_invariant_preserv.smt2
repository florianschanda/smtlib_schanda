...
(assert (=> (not (= smallest1 current1)) (= (is_perm__logic (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t o13 (mk (to_rep values__first) (to_rep values__last)))) true)))
(assert (=> (not (not (= smallest1 current1))) (= o13 values)))
(assert (=> (not (not (= smallest1 current1))) (= o13 values1)))
...
(assert (=> (not (= smallest3 current3)) (and (= o12 smallest3) (in_range4 smallest3))))
(assert (=> (not (= smallest3 current3)) (and (= o11 current3) (in_range4 current3))))
(assert (=> (not (= smallest3 current3)) (= (is_perm__logic (mk___t values2 (mk (to_rep values__first) (to_rep values__last))) (mk___t o14 (mk (to_rep values__first) (to_rep values__last)))) true)))
(assert (=> (not (not (= smallest3 current3))) (= o14 values2)))
(assert (not (= (is_perm__logic (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t o14 (mk (to_rep values__first) (to_rep values__last)))) true)))
(check-sat)
(exit)
