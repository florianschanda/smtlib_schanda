...
(assert (= (= o27 true) (forall ((i1 Int)) (=> (and (<= last3 i1) (<= i1 first3)) (forall ((j1 Int)) (=> (and (<= i1 j1) (<= j1 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a7) j1)))) (get_max_left i1 (map__content a7)))))))))
(assert (<= first3 i))
(assert (<= i last3))
(assert (<= i j))
(assert (<= j last3))
