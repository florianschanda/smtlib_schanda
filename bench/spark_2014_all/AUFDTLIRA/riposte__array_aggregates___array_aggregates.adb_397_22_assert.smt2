...
(define-fun dynamic_invariant ((temp___expr_175 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool) (temp___do_typ_inv_174 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 0 100)) (in_range temp___expr_175)))
(assert (forall ((the_stack us_rep)) (! (dynamic_invariant (get_length the_stack) true false true true) :pattern ((get_length the_stack)))))
...
(declare-fun temp_____aggregate_def_678 (us_rep) (Array Int us_rep))
...
(assert (forall ((temp___680 us_rep)) (forall ((temp___681 Int)) (= (select (temp_____aggregate_def_678 temp___680) temp___681) temp___680))))
...
(assert (and (= o3 (create_stack Tuple0)) (= (get_length o3) 0)))
(assert (= o2 (temp_____aggregate_def_678 o3)))
(assert (= result x))
(assert (= x1 o2))
(assert (not (= (get_length (select x1 2)) 2)))
(check-sat)
(exit)
