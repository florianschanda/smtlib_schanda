...
(assert (and (forall ((c Int)) (=> (and (<= 0 c) (<= c 255)) (and (<= 1 (to_rep (select bad_shift c))) (<= (to_rep (select bad_shift c)) (+ (length needle) 1))))) (forall ((c Int)) (=> (and (<= 0 c) (<= c 255)) (ite (= (to_rep (select bad_shift c)) (+ (length needle) 1)) (forall ((k13 Int)) (=> (and (<= (to_rep2 (first (rt needle))) k13) (<= k13 (to_rep2 (last (rt needle))))) (not (= c (to_rep1 (select (elts needle) k13)))))) (and (= (to_rep1 (select (elts needle) (+ (- (length needle) (to_rep (select bad_shift c))) 1))) c) (forall ((k13 Int)) (=> (and (<= (+ (- (length needle) (to_rep (select bad_shift c))) 2) k13) (<= k13 (to_rep2 (last (rt needle))))) (not (= (to_rep1 (select (elts needle) k13)) c))))))))))
...
(assert (forall ((k13 Int)) (=> (and (<= 1 k13) (<= k13 (- (+ i2 (to_rep (select bad_shift (to_rep1 (select (elts haystack) (+ i2 (length needle))))))) 1))) (not (= (match_at needle haystack k13) true)))))
...
(assert (<= r58b3 k8))
(assert (<= k8 r59b3))
(assert (not (= (to_rep1 (select (elts haystack) (+ i3 (length needle)))) (to_rep1 (select (elts needle) (+ (- (+ i3 (length needle)) k8) 1))))))
(assert (forall ((l Int)) (=> (and (<= 1 l) (<= l k9)) (not (= (match_at needle haystack l) true)))))
(assert (and (=> (<= r58b3 r59b3) (dynamic_property3 r58b3 r59b3 k9)) (and (<= r58b3 k9) (<= k9 r59b3))))
(assert (not (= k9 r59b3)))
(assert (= result21 (mk_int__ref k9)))
(assert (= k10 (+ k9 1)))
(assert (not (= (to_rep1 (select (elts haystack) (+ i3 (length needle)))) (to_rep1 (select (elts needle) (+ (- (+ i3 (length needle)) k10) 1))))))
(assert (= k11 (mk_int__ref k10)))
(assert (= k12 k10))
(declare-const l Int)
(assert (<= 1 l))
(assert (<= l (int__content k11)))
