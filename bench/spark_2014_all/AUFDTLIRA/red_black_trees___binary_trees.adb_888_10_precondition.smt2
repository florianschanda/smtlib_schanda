...
(define-fun f__split_fields6 () us_split_fields__ref2 (mk___split_fields__ref2 (mk___split_fields2 f__split_fields f__split_fields1)))
...
(assert (and (<= 1 v) (<= v 100)))
(assert (= o39 v))
(assert (= o40 (store (rec__binary_trees__forest__c f__split_fields4) o39 o38)))
(assert (= o41 (mk___split_fields2 (rec__binary_trees__forest__s f__split_fields4) o40)))
(assert (= temp___864 (mk___rep2 o41)))
(assert (= result4 (mk___split_fields__ref2 f__split_fields4)))
(assert (= f__split_fields5 (us_split_fields5 temp___864)))
(assert (and (= (tree_structure (mk___rep2 f_old__split_fields2)) true) (= (tree_structure (mk___rep2 f__split_fields5)) true)))
(assert (not (<= root (to_rep (rec__binary_trees__forest__s f__split_fields5)))))
(check-sat)
(exit)
