...
(declare-const temp___194 Bool)
(declare-const temp___1941 null_record_type)
...
(assert (= temp___194 o6))
(assert (= temp___1941 o7))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= x__split_fields2 temp___194))
(assert (= x__split_fields3 temp___1941))
(assert (not (<= i 10)))
(check-sat)
(exit)
