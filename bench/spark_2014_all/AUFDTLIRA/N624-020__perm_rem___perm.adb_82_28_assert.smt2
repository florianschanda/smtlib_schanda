...
(assert (and (= perm__perm_reflexive__induction_hypothesis__B_3__ih__assume (induction_hypothesis o7 o6)) (and (in_range4 perm__perm_reflexive__induction_hypothesis__B_3__ih__assume) (=> (= (distinct perm__perm_reflexive__induction_hypothesis__B_3__ih__assume 0) true) (= (is_perm o7 o6) true)))))
