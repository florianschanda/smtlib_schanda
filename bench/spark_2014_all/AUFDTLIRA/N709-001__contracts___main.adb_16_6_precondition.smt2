...
(define-fun x2__split_fields3 () us_split_fields2 (mk___split_fields1 x2__split_fields x2__split_fields1 x2__split_fields2))
...
(assert (= (is_zero2 (mk___rep1 x2__split_fields3 x2__attr__tag)) true))
(assert (not (not (= (is_max2 (mk___rep1 x2__split_fields3 x2__attr__tag)) true))))
(check-sat)
(exit)
