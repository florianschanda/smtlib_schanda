...
(assert (= r3 (+ r2 1)))
(assert (=> (< r3 10000) (and (= o13 (+ r3 1)) (in_range2 (+ r3 1)))))
(assert (=> (< r3 10000) (= (to_rep o14) o13)))
(assert (=> (< r3 10000) (= (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data3 r3))) o15)))
...
(assert (<= 1 rr))
(assert (<= rr 10000))
(assert (not (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data4 rr)))) 0)))
(check-sat)
(exit)
