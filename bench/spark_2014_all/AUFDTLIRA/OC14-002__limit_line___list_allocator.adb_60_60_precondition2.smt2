...
(assert (=> (not (= first_available 0)) (and (= o34 (length model____split_fields)) (in_range3 o34))))
(assert (=> (not (= first_available 0)) (= result3 (ite (< 0 o34) true false))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o33 (get model____split_fields 1)) (in_range4 o33)))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (= result2 (ite (= o33 first_available) true false)))))
(assert (=> (not (= first_available 0)) (=> (not (= result3 true)) (= result2 false))))
(assert (=> (not (not (= first_available 0))) (and (= o35 (length model____split_fields)) (in_range3 o35))))
(assert (=> (not (not (= first_available 0))) (= result2 (ite (= o35 0) true false))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o31 (length model____split_fields1)) (in_range3 o31)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o31) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o30 (get model____split_fields1 1)) (in_range4 o30))))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (= result1 (ite (= o30 first_allocated) true false))))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (not (= result4 true)) (= result1 false)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (and (= o32 (length model____split_fields1)) (in_range3 o32)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (= result1 (ite (= o32 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o28 (length model____split_fields)) (in_range3 o28))))
(assert (=> (= result1 true) (= o29 (ite (<= j1 o28) true false))))
(assert (=> (= result1 true) (= result5 (ite (<= 1 j1) o29 false))))
(assert (=> (= result1 true) (= (= result true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (length model____split_fields))) (and (and (and (in_range6 (get model____split_fields j2)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data (get model____split_fields j2))))) (ite (< j2 (length model____split_fields)) (get model____split_fields (+ j2 1)) 0))) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields1 (select data (get model____split_fields j2))))) (ite (< 1 j2) (get model____split_fields (- j2 1)) 0))) (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (length model____split_fields))) (=> (not (= j2 k1)) (not (= (get model____split_fields j2) (get model____split_fields k1))))))))))))
...
(assert (= result6 true))
(assert (and (= o27 (get model____split_fields1 j)) (in_range4 o27)))
(assert (= result9 (ite (in_range6 o27) true false)))
(assert (=> (= result9 true) (and (= o23 (length model____split_fields1)) (in_range3 o23))))
(assert (=> (= result9 true) (= result10 (ite (< j o23) true false))))
(assert (=> (= result9 true) (=> (= result10 true) (and (= o24 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result9 true) (=> (= result10 true) (and (= o25 (get model____split_fields1 o24)) (in_range4 o25)))))
(assert (=> (= result9 true) (=> (not (= result10 true)) (= o25 0))))
(assert (=> (= result9 true) (and (= temp___420 (get model____split_fields1 j)) (in_range4 temp___420))))
(assert (=> (= result9 true) (and (<= 1 temp___420) (<= temp___420 3))))
(assert (=> (= result9 true) (= o15 temp___420)))
(assert (=> (= result9 true) (= (mk___rep (mk___split_fields o16 o17 o18)) (select data o15))))
(assert (=> (= result9 true) (= o16 o19)))
(assert (=> (= result9 true) (= o17 o20)))
(assert (=> (= result9 true) (= o18 o21)))
(assert (=> (= result9 true) (= o22 o21)))
(assert (=> (= result9 true) (= o26 (to_rep o22))))
(assert (=> (= result9 true) (= result8 (ite (= o26 o25) true false))))
(assert (=> (not (= result9 true)) (= result8 false)))
(assert (=> (= result8 true) (=> (< 1 j) (and (= o12 (- j 1)) (in_range2 (- j 1))))))
(assert (=> (= result8 true) (=> (< 1 j) (and (= o13 (get model____split_fields1 o12)) (in_range4 o13)))))
(assert (=> (= result8 true) (=> (not (< 1 j)) (= o13 0))))
(assert (=> (= result8 true) (and (= temp___421 (get model____split_fields1 j)) (in_range4 temp___421))))
(assert (=> (= result8 true) (and (<= 1 temp___421) (<= temp___421 3))))
(assert (=> (= result8 true) (= o4 temp___421)))
(assert (=> (= result8 true) (= (mk___rep (mk___split_fields o5 o6 o7)) (select data o4))))
(assert (=> (= result8 true) (= o5 o8)))
(assert (=> (= result8 true) (= o6 o9)))
(assert (=> (= result8 true) (= o7 o10)))
(assert (=> (= result8 true) (= o11 o9)))
(assert (=> (= result8 true) (= o14 (to_rep o11))))
(assert (=> (= result8 true) (= result7 (ite (= o14 o13) true false))))
(assert (=> (not (= result8 true)) (= result7 false)))
(assert (= result7 true))
(assert (and (= o2 (length model____split_fields1)) (in_range3 o2)))
(assert (= o3 (ite (<= k o2) true false)))
(assert (= result11 (ite (<= 1 k) o3 false)))
