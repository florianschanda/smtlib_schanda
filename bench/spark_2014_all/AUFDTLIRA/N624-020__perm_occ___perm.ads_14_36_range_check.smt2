...
(assert (=> (not (= (length a) 0)) (and (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (<= (to_rep1 (last (rt a))) (to_rep1 (last (rt a)))))))
(assert (=> (not (= (length a) 0)) (= o (to_rep1 (last (rt a))))))
...
(assert (=> (not (= (length a) 0)) (=> (= result true) (and (= o11 (remove_last a)) (and (dynamic_invariant1 o11 true false true true) (and (= (elts a) o3) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1))))) o4)))))))
(assert (=> (not (= (length a) 0)) (=> (= result true) (and (= o5 (occ_def o11 e)) (and (in_range3 o5) (and (= o5 (ite (= (length o11) 0) 0 (ite (= (to_rep (select o3 (to_rep1 (last o4)))) e) (+ (occ_def (remove_last o11) e) 1) (occ_def (remove_last o11) e)))) (<= o5 (length o11))))))))
(assert (=> (not (= (length a) 0)) (=> (= result true) (= o6 (+ o5 1)))))
(assert (=> (not (= (length a) 0)) (=> (= result true) (and (= o9 o6) (in_range3 o6)))))
(assert (=> (not (= (length a) 0)) (=> (not (= result true)) (and (= o10 (remove_last a)) (and (dynamic_invariant1 o10 true false true true) (and (= (elts a) o7) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1))))) o8)))))))
(assert (=> (not (= (length a) 0)) (=> (not (= result true)) (and (= o9 (occ_def o10 e)) (and (in_range3 o9) (and (= o9 (ite (= (length o10) 0) 0 (ite (= (to_rep (select o7 (to_rep1 (last o8)))) e) (+ (occ_def (remove_last o10) e) 1) (occ_def (remove_last o10) e)))) (<= o9 (length o10))))))))
