...
(assert (forall ((c Int)) (=> (and (<= 0 c) (<= c 255)) (and (<= 1 (to_rep (select bad_shift3 c))) (<= (to_rep (select bad_shift3 c)) (+ (length needle) 1))))))
(assert (forall ((c Int)) (=> (and (<= 0 c) (<= c 255)) (ite (= (to_rep (select bad_shift3 c)) (+ (length needle) 1)) (forall ((k Int)) (=> (and (<= 1 k) (<= k j2)) (not (= c (to_rep1 (select (elts needle) k)))))) (and (= (to_rep1 (select (elts needle) (+ (- (length needle) (to_rep (select bad_shift3 c))) 1))) c) (forall ((k Int)) (=> (and (<= (+ (- (length needle) (to_rep (select bad_shift3 c))) 2) k) (<= k j2)) (not (= (to_rep1 (select (elts needle) k)) c)))))))))
...
(assert (= o19 (store bad_shift3 (to_rep1 (select (elts needle) j3)) o18)))
(assert (= result4 bad_shift3))
(assert (= bad_shift4 o19))
(declare-const c Int)
(assert (<= 0 c))
(assert (<= c 255))
(assert (not (<= 1 (to_rep (select bad_shift4 c)))))
(check-sat)
(exit)
