...
(assert (and (= o6 (remove c (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant o6 true false true true) (and (= (invariant__ o6) true) (and (= (to_rep (last o5)) (- (to_rep (last (rt c))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep1 (select (elts c) k)) (to_rep1 (select o4 k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k) (<= k (to_rep (last (rt c))))) (= (to_rep1 (select (elts c) k)) (to_rep1 (select o4 (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) k) (<= k (- (to_rep (last (rt c))) 1))) (= (to_rep1 (select (elts c) (+ k 1))) (to_rep1 (select o4 k))))))))))))
