...
(assert (and (= o46 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 o46)))
(assert (= result12 (ite (in_range7 o46) true false)))
(assert (=> (= result12 true) (and (= o42 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o42))))
(assert (=> (= result12 true) (= result13 (ite (< j o42) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o43 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o44 (get (rec__list_allocator__m__t__available model____split_fields3) o43)) (in_range4 o44)))))
(assert (=> (= result12 true) (=> (not (= result13 true)) (= o44 0))))
...
(assert (=> (= result12 true) (= o38 temp___431)))
(assert (=> (= result12 true) (= o39 (select data3 o38))))
(assert (=> (= result12 true) (= o40 (us_split_fields3 o39))))
(assert (=> (= result12 true) (= o41 (rec__list_allocator__cell__next o40))))
(assert (=> (= result12 true) (= o45 (to_rep o41))))
(assert (=> (= result12 true) (= result11 (ite (= o45 o44) true false))))
