...
(assert (and (= o10 (count o13)) (and (in_range3 o10) (= o10 (to_rep1 o9)))))
...
(assert (and (= o7 (count (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) (and (in_range3 o7) (= o7 (to_rep1 (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))))))))
(assert (not (<= 1 o7)))
(check-sat)
(exit)
