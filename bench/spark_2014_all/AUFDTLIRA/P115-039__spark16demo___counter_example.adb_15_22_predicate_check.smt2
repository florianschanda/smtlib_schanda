...
(assert (forall ((x category)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_169 Int) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool) (temp___do_typ_inv_168 Bool)) Bool (=> (or (= temp___is_init_165 true) (<= 1 8)) (in_range2 temp___expr_169)))
...
(assert (forall ((cat Int)) (! (=> (dynamic_invariant1 cat true true true true) (dynamic_invariant (pick_last cat) true false true true)) :pattern ((pick_last cat)))))
(assert (forall ((cat Int)) (! (=> (dynamic_invariant1 cat true true true true) (= (pick_last cat) (to_rep (select (to_array num_item_per_category) cat)))) :pattern ((pick_last cat)))))
(define-fun dynamic_invariant2 ((temp___expr_182 us_rep) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool) (temp___do_typ_inv_181 Bool)) Bool (=> (= temp___do_toplevel_180 true) (=> (= temp___is_init_178 true) (<= (to_rep (rec__counter_example__item__idx (us_split_fields1 temp___expr_182))) (to_rep (select (to_array num_item_per_category) (to_rep1 (rec__counter_example__item__cat (us_split_fields1 temp___expr_182)))))))))
...
(define-fun dynamic_invariant4 ((temp___expr_176 us_t) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool) (temp___do_typ_inv_175 Bool)) Bool (=> (not (= temp___skip_constant_173 true)) (dynamic_property 1 8 (first1 temp___expr_176) (last1 temp___expr_176))))
(declare-sort t3s 0)
...
(declare-const temp___192 category)
(declare-const temp___1921 natural)
(declare-const result Bool)
(declare-const pick11 Bool)
(assert (in_range2 cat1))
(assert (in_range2 cat2))
(assert (and (= counter_example__get_best_item__idx1__assume (pick_last cat1)) (and (in_range1 counter_example__get_best_item__idx1__assume) (= counter_example__get_best_item__idx1__assume (to_rep (select (elts num_item_per_category) cat1))))))
(assert (= counter_example__get_best_item__idx1__assume idx1))
(assert (in_range1 idx1))
(assert (and (= counter_example__get_best_item__idx2__assume (pick_last cat2)) (and (in_range1 counter_example__get_best_item__idx2__assume) (= counter_example__get_best_item__idx2__assume (to_rep (select (elts num_item_per_category) cat2))))))
(assert (= counter_example__get_best_item__idx2__assume idx2))
(assert (in_range1 idx2))
(assert (= result pick1))
(assert (= pick11 (distinct 0 0)))
...
(assert (not (<= (to_rep temp___1921) (to_rep (select (elts num_item_per_category) (to_rep1 temp___192))))))
(check-sat)
(exit)
