...
(define-fun o8 () us_rep (mk___rep (mk___split_discrs o5) (mk___split_fields (mk___t1 o6 o7))))
...
(assert (and (= o8 (add (mk___rep t1__split_discrs t1__split_fields2) (mk___rep t2__split_discrs t2__split_fields2))) (and (dynamic_invariant o8 true false true true) (and (= (same_range o8 (mk___rep t1__split_discrs t1__split_fields2)) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (= (to_rep3 (select o6 j)) (+ (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)) (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t2__split_fields2)) j))))))))))
(assert (not (= 10 (to_rep2 o5))))
(check-sat)
(exit)
