...
(assert true)
(assert (forall ((e Int)) (forall ((use_stack__stacks__content (Array Int positive))) (! (= (= (all_eq e use_stack__stacks__content) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep1 content__last))) (= (to_rep (select use_stack__stacks__content i)) e)))) :pattern ((all_eq e use_stack__stacks__content))))))
(declare-const e Int)
...
(declare-const o2 (Array Int positive))
(declare-const j Int)
...
(declare-const content1 (Array Int positive))
(declare-const content2 (Array Int positive))
...
(assert (and (= us max) (dynamic_property 0 last max)))
(assert (= o max))
...
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 (to_rep1 content__last)))
(assert (= (to_rep o1) e))
(assert (= o2 (store content i1 o1)))
(assert (= (mk_map__ref result2) (mk_map__ref content)))
(assert (= content1 o2))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 i2)) (= (to_rep (select content2 j1)) e))))
(assert (and (and (forall ((temp___255 Int)) (=> (and (<= (to_rep1 content__first) temp___255) (<= temp___255 (to_rep1 content__last))) (=> (or (< (to_rep1 content__last) temp___255) (or (< temp___255 1) (< i2 temp___255))) (= (select content2 temp___255) (select content temp___255))))) (=> (<= 1 (to_rep1 content__last)) (dynamic_property3 1 (to_rep1 content__last) i2))) (and (<= 1 i2) (<= i2 (to_rep1 content__last)))))
(assert (<= 1 j))
(assert (<= j i2))
(assert (not (<= j (to_rep1 content__last))))
(check-sat)
(exit)
