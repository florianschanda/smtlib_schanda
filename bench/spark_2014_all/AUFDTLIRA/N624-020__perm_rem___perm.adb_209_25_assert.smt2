...
(assert (and (= o (extended_perm aa bb)) (and (in_range4 o) (=> (= (distinct o 0) true) (forall ((ia Int)) (=> (and (<= (to_rep1 (first (rt aa))) ia) (<= ia (to_rep1 (last (rt aa))))) (exists ((ib Int)) (and (and (<= (to_rep1 (first (rt bb))) ib) (<= ib (to_rep1 (last (rt bb))))) (and (= (to_rep (select (elts aa) ia)) (to_rep (select (elts bb) ib))) (= (is_perm (remove aa ia) (remove bb ib)) true))))))))))
