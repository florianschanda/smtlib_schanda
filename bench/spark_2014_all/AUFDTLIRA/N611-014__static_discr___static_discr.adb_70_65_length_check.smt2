...
(assert (= (to_rep o1) o))
(assert (not (= (ite (<= (to_rep1 (first6 (rt3 a))) (to_rep1 (last6 (rt3 a)))) (+ (- (to_rep1 (last6 (rt3 a))) (to_rep1 (first6 (rt3 a)))) 1) 0) (ite (<= 1 (to_rep1 (last6 (rt3 a)))) (+ (- (to_rep1 (last6 (rt3 a))) 1) 1) 0))))
(check-sat)
(exit)
