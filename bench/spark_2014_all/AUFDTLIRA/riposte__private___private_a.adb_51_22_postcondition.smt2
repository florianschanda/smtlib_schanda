...
(declare-const temp___2651 length_t)
(declare-const temp___2652 (Array Int integer))
...
(declare-const stack__push__the_stack__fields us_split_fields)
...
(define-fun o6 () us_rep (mk___rep (mk___split_fields o o1)))
(assert (in_range1 n))
(assert (and (= o6 (create_stack Tuple0)) (= (get_length o6) 0)))
...
(assert (= temp___265 s__split_fields3))
(assert (= temp___2651 s__split_fields4))
(assert (= temp___2652 s__split_fields5))
(assert (= s__split_fields3 true))
(assert (and (= (get_length (mk___rep stack__push__the_stack__fields)) (+ (get_length (mk___rep (mk___split_fields s__split_fields4 s__split_fields5))) 1)) (= (top (mk___rep stack__push__the_stack__fields)) n)))
(assert (= result3 (mk___split_fields__ref1 (mk___split_fields1 s__split_fields3 (mk___rep (mk___split_fields s__split_fields4 s__split_fields5))))))
(assert (= s__split_fields6 (mk___split_fields1 s__split_fields3 (mk___rep stack__push__the_stack__fields))))
(assert (and (= o5 (top (rec__private_a__optional_stack__the_stack s__split_fields6))) (in_range1 o5)))
(assert (= result4 (mk_int__ref n)))
(assert (= n1 o5))
(assert (= s__split_fields7 (mk___split_fields__ref1 s__split_fields6)))
(assert (= n2 (mk_int__ref n1)))
(assert (= s__split_fields8 s__split_fields6))
(assert (= n3 n1))
(assert (not (= (int__content n2) n)))
(check-sat)
(exit)
