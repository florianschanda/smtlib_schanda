...
(define-fun tab41 () map__ref (mk_map__ref tab))
(assert (in_range1 a))
(assert (in_range1 b))
...
(assert (=> (<= j1 b) (= (mk_map__ref result1) tab41)))
(assert (=> (<= j1 b) (= tab2 o2)))
...
(assert (= result40 (mk_int__ref temp___209)))
(assert (= temp___2091 j47))
(assert (= result41 (mk_int__ref temp___210)))
(assert (= temp___2101 k26))
(assert (<= j47 b))
(assert (= (to_rep o34) j47))
(assert (and (<= (to_rep tab__first) j47) (<= j47 (to_rep tab__last))))
(assert (= o35 j47))
(assert (= o36 (store tab39 o35 o34)))
(assert (= result42 (mk_map__ref tab39)))
(assert (= tab40 o36))
(assert (and (= o37 (+ j47 1)) (in_range1 (+ j47 1))))
(assert (= result43 (mk_int__ref j47)))
(assert (= j48 o37))
(assert (and (= o38 (+ k26 1)) (in_range1 (+ k26 1))))
(assert (= result44 (mk_int__ref k26)))
(assert (= k27 o38))
(assert (not (< temp___2101 k27)))
(check-sat)
(exit)
