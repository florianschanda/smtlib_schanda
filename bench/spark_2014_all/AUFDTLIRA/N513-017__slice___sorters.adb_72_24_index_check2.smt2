...
(assert (=> (not (= smallest1 current1)) (and (= (to_rep (select o10 o4)) (to_rep (select values smallest1))) (and (= (to_rep (select o10 smallest1)) (to_rep (select values o4))) (forall ((j2 Int)) (=> (and (<= (to_rep values__first) j2) (<= j2 (to_rep values__last))) (=> (and (not (= j2 o4)) (not (= j2 smallest1))) (= (to_rep (select o10 j2)) (to_rep (select values j2))))))))))
(assert (=> (not (not (= smallest1 current1))) (= o10 values)))
(assert (=> (not (not (= smallest1 current1))) (= o10 values1)))
(assert (and (and (and (<= (to_rep values__first) current2) (< current2 (to_rep values__last))) (forall ((j2 Int)) (=> (and (<= (to_rep values__first) j2) (<= j2 (- current2 1))) (<= (to_rep (select values2 j2)) (to_rep (select values2 (+ j2 1))))))) (forall ((j2 Int)) (=> (and (<= current2 j2) (<= j2 (to_rep values__last))) (<= (to_rep (select values2 current2)) (to_rep (select values2 j2)))))))
...
(assert (=> (= result3 true) (and (= o8 (- current2 1)) (in_range1 (- current2 1)))))
(assert (=> (= result3 true) (= o9 (ite (<= j1 o8) true false))))
(assert (=> (= result3 true) (= result4 (ite (<= (to_rep values__first) j1) o9 false))))
(assert (=> (= result3 true) (= (= result2 true) (forall ((j2 Int)) (=> (and (<= (to_rep values__first) j2) (<= j2 (- current2 1))) (<= (to_rep (select values2 j2)) (to_rep (select values2 (+ j2 1)))))))))
