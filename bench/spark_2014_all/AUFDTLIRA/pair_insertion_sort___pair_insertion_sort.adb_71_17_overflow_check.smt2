...
(assert (=> (= result8 true) (and (and (= (is_perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t o51 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select o51 o14)) (to_rep (select a o15))) (and (= (to_rep (select o51 o15)) (to_rep (select a o14))) (forall ((z7 Int)) (=> (and (<= (to_rep a__first) z7) (<= z7 (to_rep a__last))) (=> (and (not (= z7 o14)) (not (= z7 o15))) (= (to_rep (select o51 z7)) (to_rep (select a z7))))))))) (= (to_rep a__first) 0))))
...
(assert (=> (= result8 true) (= (sorted (mk___t o52 (mk (to_rep a__first) (to_rep a__last))) 0 (- j2 1)) true)))
(assert (=> (= result8 true) (= (sorted (mk___t o52 (mk (to_rep a__first) (to_rep a__last))) (+ j2 2) (+ i1 1)) true)))
(assert (=> (= result8 true) (=> (< 0 j2) (<= (to_rep (select o52 (- j2 1))) (to_rep (select o52 (+ j2 2)))))))
(assert (=> (= result8 true) (< x2 (to_rep (select o52 (+ j2 2))))))
(assert (=> (= result8 true) (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t o52 (mk (to_rep a__first) (to_rep a__last)))) true)))
(assert (=> (= result8 true) (or (and (= (to_rep (select o52 j2)) x2) (= (to_rep (select o52 (+ j2 1))) y2)) (and (= (to_rep (select o52 j2)) y2) (= (to_rep (select o52 (+ j2 1))) x2)))))
...
(assert (=> (= result8 true) (=> (<= 0 j3) (= o18 (select o52 o17)))))
...
(assert (=> (= result8 true) (= a2 (mk_map__ref o52))))
(assert (=> (= result8 true) (= j5 j3)))
(assert (=> (= result8 true) (= a3 o52)))
...
(assert (=> (= result11 true) (and (and (= (is_perm (mk___t (map__content a4) (mk (to_rep a__first) (to_rep a__last))) (mk___t (let ((subject a4)) o53) (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select (let ((subject a4)) o53) o26)) (to_rep (select (map__content a4) o28))) (and (= (to_rep (select (let ((subject a4)) o53) o28)) (to_rep (select (map__content a4) o26))) (forall ((z7 Int)) (=> (and (<= (to_rep a__first) z7) (<= z7 (to_rep a__last))) (=> (and (not (= z7 o26)) (not (= z7 o28))) (= (to_rep (select (let ((subject a4)) o53) z7)) (to_rep (select (map__content a4) z7))))))))) (= (to_rep a__first) 0))))
(assert (=> (= result11 true) (= (to_rep a__first) 0)))
(assert (=> (= result11 true) (= a6 (mk_map__ref o53))))
(assert (=> (= result11 true) (= a7 o53)))
...
(assert (=> (= result12 true) (and (and (= (is_perm (mk___t (map__content a6) (mk (to_rep a__first) (to_rep a__last))) (mk___t (let ((subject a6)) o54) (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select (let ((subject a6)) o54) o33)) (to_rep (select (map__content a6) o34))) (and (= (to_rep (select (let ((subject a6)) o54) o34)) (to_rep (select (map__content a6) o33))) (forall ((z7 Int)) (=> (and (<= (to_rep a__first) z7) (<= z7 (to_rep a__last))) (=> (and (not (= z7 o33)) (not (= z7 o34))) (= (to_rep (select (let ((subject a6)) o54) z7)) (to_rep (select (map__content a6) z7))))))))) (= (to_rep a__first) 0))))
...
(assert (=> (= result12 true) (= (sorted (mk___t o55 (mk (to_rep a__first) (to_rep a__last))) 0 (- j8 1)) true)))
(assert (=> (= result12 true) (= (sorted (mk___t o55 (mk (to_rep a__first) (to_rep a__last))) (+ j8 1) (+ i1 1)) true)))
(assert (=> (= result12 true) (=> (< 0 j8) (<= (to_rep (select o55 (- j8 1))) (to_rep (select o55 (+ j8 1)))))))
(assert (=> (= result12 true) (< y2 (to_rep (select o55 (+ j8 1))))))
(assert (=> (= result12 true) (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t o55 (mk (to_rep a__first) (to_rep a__last)))) true)))
(assert (=> (= result12 true) (= (to_rep (select o55 j8)) y2)))
...
(assert (=> (= result12 true) (=> (<= 0 j9) (= o37 (select o55 o36)))))
...
(assert (=> (= result12 true) (= a8 (mk_map__ref o55))))
(assert (=> (= result12 true) (= j11 j9)))
(assert (=> (= result12 true) (= a9 o55)))
