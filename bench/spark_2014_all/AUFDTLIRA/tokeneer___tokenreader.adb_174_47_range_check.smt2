...
(assert (not (= (length1 text) 0)))
(assert (=> (<= 1 2) (= o (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o 0)))
(assert (=> (<= (to_rep1 (first2 (rt1 text))) (to_rep1 (last2 (rt1 text)))) (= o1 (+ (- (to_rep1 (last2 (rt1 text))) (to_rep1 (first2 (rt1 text)))) 1))))
(assert (=> (not (<= (to_rep1 (first2 (rt1 text))) (to_rep1 (last2 (rt1 text))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first2 (rt1 text))) o2)))
(assert (= o4 (- o3 1)))
