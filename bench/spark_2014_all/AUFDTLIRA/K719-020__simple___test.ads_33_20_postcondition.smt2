...
(assert (= result x))
(assert (= x1 (store x 11 (mk___rep (mk___split_fields (rec__test__t__a (us_split_fields1 (select x 11))) (rec__test__t__b (us_split_fields1 (select x 11))) (store (rec__test__t__c (us_split_fields1 (select x 11))) 2 rliteral))))))
(assert (= x1 x2))
(assert (= x3 x1))
