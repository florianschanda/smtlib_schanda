...
(assert (=> (< 0 e) (= o11 (temp_____aggregate_def_940 o10 i o9))))
(assert (=> (< 0 e) (and (= o12 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (< 0 e) (= temp___4643 (temp_____aggregate_def_925 a j (temp_____aggregate_def_933 (select a j) i e) o12 o11))))
