...
(declare-const temp___398 int_ok)
...
(assert (= (to_rep temp___398) 1))
(define-fun temp___400 () Int (to_rep temp___398))
(assert (not (or (and (<= (- 2147483648) temp___400) (<= temp___400 (- 1))) (and (<= 1 temp___400) (<= temp___400 2147483647)))))
(check-sat)
(exit)
