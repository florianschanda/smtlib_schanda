...
(assert (forall ((i message_index_type)) (and (<= 1 (message_index_typeqtint i)) (<= (message_index_typeqtint i) 64))))
...
(assert (forall ((i message_count_type)) (and (<= 0 (message_count_typeqtint i)) (<= (message_count_typeqtint i) 64))))
...
(assert (forall ((temp___238 Int)) (=> (dynamic_invariant temp___238 true true true true) (forall ((temp___239 Int)) (= (to_rep (select (temp_____aggregate_def_236 temp___238) temp___239)) temp___238)))))
(declare-const m Int)
...
(declare-const o Int)
(declare-const o1 message_count_type)
...
(declare-const result2 message_index_type)
(declare-const result3 message_count_type)
(declare-const result4 Bool)
(declare-const result5 (Array Int message_type))
...
(declare-const result7 message_index_type)
(declare-const result8 message_count_type)
(declare-const result9 Bool)
(declare-const result10 (Array Int message_type))
...
(define-fun self__15 () us_rep (mk___rep (mk___split_fields self__5 self__6 self__7 self__8 self__9)))
(assert (=> (<= 0 1) (in_range1 m)))
(assert (= self__3 true))
(assert (= result m))
(assert (= m1 (to_rep (select self__4 (to_rep1 self__1)))))
(assert (and (= o (- (to_rep2 self__2) 1)) (in_range3 (- (to_rep2 self__2) 1))))
(assert (= (to_rep2 o1) o))
(assert (= self__ o2))
(assert (= self__1 o3))
(assert (= o1 o4))
...
(assert (= result5 self__4))
(assert (= self__15 (mk___rep (mk___split_fields o7 o8 o9 o10 o11))))
(assert (=> (= (to_rep2 self__7) 0) (= result6 self__5)))
(assert (=> (= (to_rep2 self__7) 0) (= result7 self__6)))
(assert (=> (= (to_rep2 self__7) 0) (= result8 self__7)))
(assert (=> (= (to_rep2 self__7) 0) (= result9 self__8)))
(assert (=> (= (to_rep2 self__7) 0) (= result10 self__9)))
(assert (=> (= (to_rep2 self__7) 0) (= self__5 self__10)))
(assert (=> (= (to_rep2 self__7) 0) (= self__6 self__11)))
(assert (=> (= (to_rep2 self__7) 0) (= self__7 self__12)))
(assert (=> (= (to_rep2 self__7) 0) (= (distinct 0 0) self__13)))
(assert (=> (= (to_rep2 self__7) 0) (= self__9 self__14)))
(assert (=> (not (= (to_rep2 self__7) 0)) (= (mk___rep (mk___split_fields self__10 self__11 self__12 self__13 self__14)) self__15)))
(assert (not (= (to_rep1 self__11) 64)))
(assert (not (in_range2 (+ (to_rep1 self__11) 1))))
(check-sat)
(exit)
