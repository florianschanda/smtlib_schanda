...
(assert (and (= o6 (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) (in_range5 (to_rep1 (rec__search_trees__search_tree__root t__split_fields5)))))
(assert (not (= (valid_root (mk___rep2 f_old__split_fields2) o6) true)))
(check-sat)
(exit)
