...
(assert (not (or (or (and (and (= found4 0) (not (= found12 true))) (not (= found22 true))) (and (= found4 1) (or (= found12 true) (= found22 true)))) (and (and (= found4 2) (= found12 true)) (= found22 true)))))
(check-sat)
(exit)
