...
(assert (= (= o10 true) (forall ((i16 Int)) (=> (and (<= (to_rep1 (first (rt a))) i16) (<= i16 (- (int__content location13) 1))) (= (to_rep (select (elts a) i16)) (to_rep (select (elts b) i16)))))))
(assert (not (<= (int__content location13) (to_rep1 (last (rt b))))))
(check-sat)
(exit)
