...
(declare-fun temp_____aggregate_def_314 (Int) (Array Int positive))
...
(assert (forall ((temp___316 Int)) (=> (dynamic_invariant1 temp___316 true true true true) (forall ((temp___317 Int)) (= (to_rep (select (temp_____aggregate_def_314 temp___316) temp___317)) temp___316)))))
...
(declare-const temp___320 (Array Int positive))
...
(define-fun bad_shift10 () map__ref1 (mk_map__ref1 bad_shift6))
...
(assert (= o3 (temp_____aggregate_def_314 o2)))
...
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= temp___322 j1)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= temp___320 bad_shift1)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (and (= o4 (length needle)) (in_range1 (length needle)))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= o5 (- o4 j1))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (and (= o6 o5) (in_range1 o5))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= o7 (+ o6 1))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (and (= o8 o7) (in_range1 o7))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (and (= o9 o8) (in_range2 o8))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= (to_rep o10) o9)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= o11 (store bad_shift1 (to_rep1 (select (elts needle) j1)) o10))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= bad_shift1 result2)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= bad_shift2 o11)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (forall ((c1 Int)) (=> (and (<= 0 c1) (<= c1 255)) (and (<= 1 (to_rep (select bad_shift3 c1))) (<= (to_rep (select bad_shift3 c1)) (+ (length needle) 1)))))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (forall ((c1 Int)) (=> (and (<= 0 c1) (<= c1 255)) (ite (= (to_rep (select bad_shift3 c1)) (+ (length needle) 1)) (forall ((k Int)) (=> (and (<= 1 k) (<= k j2)) (not (= c1 (to_rep1 (select (elts needle) k)))))) (and (= (to_rep1 (select (elts needle) (+ (- (length needle) (to_rep (select bad_shift3 c1))) 1))) c1) (forall ((k Int)) (=> (and (<= (+ (- (length needle) (to_rep (select bad_shift3 c1))) 2) k) (<= k j2)) (not (= (to_rep1 (select (elts needle) k)) c1))))))))))
...
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= j2 j3)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= bad_shift3 bad_shift4)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= j4 j2)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= bad_shift5 bad_shift3)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= j9 (mk_int__ref j3))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= bad_shift10 (mk_map__ref1 bad_shift4))))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= j6 j4)))
(assert (=> (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle))))) (= bad_shift7 bad_shift5)))
(assert (=> (not (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle)))))) (= j1 j5)))
(assert (=> (not (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle)))))) (= bad_shift1 bad_shift6)))
(assert (=> (not (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle)))))) (= j6 j1)))
(assert (=> (not (and (<= (to_rep2 (first (rt needle))) j1) (<= j1 (to_rep2 (last (rt needle)))))) (= bad_shift7 bad_shift1)))
(assert (= (mk_int__ref j7) j9))
(assert (= (mk_map__ref1 bad_shift8) bad_shift10))
(assert (= j8 j6))
(assert (= bad_shift9 bad_shift7))
(assert (= (= result3 true) (forall ((c1 Int)) (=> (and (<= 0 c1) (<= c1 255)) (and (<= 1 (to_rep (select bad_shift8 c1))) (<= (to_rep (select bad_shift8 c1)) (+ (length needle) 1)))))))
(assert (= result3 true))
(assert (<= 0 c))
(assert (<= c 255))
...
(assert (= result4 (ite (= (to_rep (select bad_shift8 c)) o14) true false)))
(assert (not (= result4 true)))
(assert (and (= o15 (length needle)) (in_range1 (length needle))))
(assert (= o16 (- o15 (to_rep (select bad_shift8 c)))))
(assert (= o17 (+ o16 2)))
