...
(declare-const bounded_strings__make__result2 t)
...
(assert (= result____split_fields5 (mk___split_fields1 (rec__bounded_strings__bounded_string__text1 result____split_fields4) rliteral)))
...
(assert (= result3 (mk_bounded_string__ref (mk___rep (mk___split_discrs bounded_strings__make__result) (mk___split_fields (mk___t bounded_strings__make__result1 bounded_strings__make__result2) bounded_strings__make__result3)))))
...
(assert (= (mk___rep (mk___split_discrs result4) (mk___split_fields (mk___t result5 result6) result7)) (bounded_string__content bounded_strings__make__result7)))
(assert (not (= (length1 (bounded_string__content bounded_strings__make__result7)) 1)))
(check-sat)
(exit)
