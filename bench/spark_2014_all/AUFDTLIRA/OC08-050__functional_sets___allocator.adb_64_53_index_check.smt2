...
(define-fun dynamic_invariant2 ((temp___expr_370 Int) (temp___is_init_366 Bool) (temp___skip_constant_367 Bool) (temp___do_toplevel_368 Bool) (temp___do_typ_inv_369 Bool)) Bool (=> (or (= temp___is_init_366 true) (<= 0 1)) (in_range2 temp___expr_370)))
(define-fun dynamic_invariant3 ((temp___expr_317 Int) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool) (temp___do_typ_inv_316 Bool)) Bool (=> (or (= temp___is_init_313 true) (<= 1 3)) (in_range4 temp___expr_317)))
(assert true)
(assert (forall ((m us_rep1)) (forall ((allocator__data (Array Int status))) (! (= (= (is_valid m allocator__data) true) (and (and (forall ((e Int)) (=> (and (in_range1 e) (= (mem (rec__allocator__m__t__available (us_split_fields1 m)) e) true)) (in_range4 e))) (forall ((e Int)) (=> (and (in_range1 e) (= (mem (rec__allocator__m__t__allocated (us_split_fields1 m)) e) true)) (in_range4 e)))) (forall ((r Int)) (=> (and (<= 1 r) (<= r 3)) (ite (= (to_rep (select allocator__data r)) 0) (and (= (mem (rec__allocator__m__t__available (us_split_fields1 m)) r) true) (not (= (mem (rec__allocator__m__t__allocated (us_split_fields1 m)) r) true))) (and (not (= (mem (rec__allocator__m__t__available (us_split_fields1 m)) r) true)) (= (mem (rec__allocator__m__t__allocated (us_split_fields1 m)) r) true))))))) :pattern ((is_valid m allocator__data))))))
...
(assert (<= 1 r1))
(assert (<= r1 3))
(assert (not (= (to_rep (select data r1)) 0)))
(assert (= data2 data))
(assert (= res2 res))
(assert (= data2 data1))
(assert (= res2 res1))
(assert (and (= (bool_eq2 data3 1 3 data 1 3) true) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (= (to_rep (select data3 rr1)) 1)))))
(assert (and (and (and (forall ((temp___410 Int)) (=> (and (<= 1 temp___410) (<= temp___410 3)) (=> (or (< 3 temp___410) (or (< temp___410 1) (< r2 temp___410))) (= (select data3 temp___410) (select data temp___410))))) (=> (<= 0 3) (in_range3 res3))) (=> (<= 1 3) (in_range4 r2))) (and (<= 1 r2) (<= r2 3))))
(assert (= (bool_eq2 data3 1 3 data 1 3) true))
(assert (<= 1 rr))
(assert (<= rr r2))
(assert (not (<= rr 3)))
(check-sat)
