...
(assert (and (and (= (length2 (mk___rep2 p__split_discrs partition_refinement__partitions__replace_element__container__fields)) (length2 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))) (= (bool_eq5 (get3 (model__1 (mk___rep2 p__split_discrs partition_refinement__partitions__replace_element__container__fields)) (to_rep5 (select f i))) (mk___rep3 p_elem__split_fields4)) true)) (= (equal_except1 (model__1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields))) (model__1 (mk___rep2 p__split_discrs partition_refinement__partitions__replace_element__container__fields)) (to_rep5 (select f i))) true)))
