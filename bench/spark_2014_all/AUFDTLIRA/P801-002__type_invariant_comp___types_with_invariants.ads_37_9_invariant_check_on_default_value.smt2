...
(declare-const temp___278 (Array Int us_rep))
(declare-const temp___2781 t)
(assert (dynamic_invariant1 (mk___t temp___278 temp___2781) true false true true))
(assert (forall ((temp___279 Int)) (=> (and (<= (to_rep (first temp___2781)) temp___279) (<= temp___279 (to_rep (last temp___2781)))) (and (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 (select temp___278 temp___279))) (distinct 1 0)) (= (to_rep1 (rec__types_with_invariants__my_integer__val (us_split_fields1 (select temp___278 temp___279)))) 0)))))
(declare-const temp___281 Int)
(assert (<= (to_rep (first temp___2781)) temp___281))
(assert (<= temp___281 (to_rep (last temp___2781))))
(define-fun temp___164 () us_rep (select temp___278 temp___281))
(assert (= (to_rep1 (rec__types_with_invariants__my_integer__val (us_split_fields1 temp___164))) 0))
(assert (not (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 temp___164)) true)))
(check-sat)
(exit)
