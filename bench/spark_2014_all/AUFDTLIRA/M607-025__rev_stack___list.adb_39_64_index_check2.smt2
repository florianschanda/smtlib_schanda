...
(assert (and (= o12 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range5 o12) (<= o12 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
...
(assert (not (<= (to_rep (first (rt temp___532))) j)))
(check-sat)
(exit)
