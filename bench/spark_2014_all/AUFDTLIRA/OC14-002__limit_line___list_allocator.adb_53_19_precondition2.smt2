...
(assert (=> (not (= first_available 0)) (and (= o12 (length model____split_fields)) (in_range3 o12))))
(assert (=> (not (= first_available 0)) (= result3 (ite (< 0 o12) true false))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o11 (get model____split_fields 1)) (in_range4 o11)))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (= result2 (ite (= o11 first_available) true false)))))
(assert (=> (not (= first_available 0)) (=> (not (= result3 true)) (= result2 false))))
(assert (=> (not (not (= first_available 0))) (and (= o13 (length model____split_fields)) (in_range3 o13))))
(assert (=> (not (not (= first_available 0))) (= result2 (ite (= o13 0) true false))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o9 (length model____split_fields1)) (in_range3 o9)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o9) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o8 (get model____split_fields1 1)) (in_range4 o8))))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (= result1 (ite (= o8 first_allocated) true false))))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (not (= result4 true)) (= result1 false)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (and (= o10 (length model____split_fields1)) (in_range3 o10)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (= result1 (ite (= o10 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o6 (length model____split_fields)) (in_range3 o6))))
(assert (=> (= result1 true) (= o7 (ite (<= j1 o6) true false))))
(assert (=> (= result1 true) (= result5 (ite (<= 1 j1) o7 false))))
...
(assert (= result6 true))
(assert (and (= o5 (get model____split_fields1 j)) (in_range4 o5)))
(assert (= result7 (ite (in_range6 o5) true false)))
(assert (= result7 true))
(assert (and (= o2 (length model____split_fields1)) (in_range3 o2)))
(assert (= result8 (ite (< j o2) true false)))
(assert (=> (= result8 true) (and (= o3 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (= result8 true) (and (= o4 (get model____split_fields1 o3)) (in_range4 o4))))
(assert (=> (not (= result8 true)) (= o4 0)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
