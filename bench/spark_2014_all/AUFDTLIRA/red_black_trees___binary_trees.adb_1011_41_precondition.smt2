...
(assert (= result5 true))
(assert (and (= o30 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki3))))) (in_range5 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki3)))))))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
...
(assert (= o27 (select temp___17901 ki3)))
