...
(assert (<= 0 x1))
(assert (<= x1 2))
(assert (and (forall ((temp___776 Int)) (=> (and (<= 1 temp___776) (<= temp___776 50)) (=> (not (= (+ (to_rep2 cur_piece__split_fields3) y2) temp___776)) (= (select cur_board1 temp___776) (select cur_board temp___776))))) (and (<= 0 x2) (<= x2 2))))
(assert (and (<= 3 (to_rep cur_piece__split_fields)) (<= (to_rep cur_piece__split_fields) 7)))
(assert (= o (to_rep cur_piece__split_fields)))
(assert (= temp___771 (get1 possible_three_shapes o (to_rep3 cur_piece__split_fields1))))
(assert (= result2 (get temp___771 y2 x2)))
(assert (= result2 true))
...
(assert (= o2 (+ (to_rep1 cur_piece__split_fields2) x2)))
(assert (= o3 (store (select cur_board1 (+ (to_rep2 cur_piece__split_fields3) y2)) o2 o1)))
(assert (not (<= 1 (+ (to_rep2 cur_piece__split_fields3) y2))))
(check-sat)
(exit)
