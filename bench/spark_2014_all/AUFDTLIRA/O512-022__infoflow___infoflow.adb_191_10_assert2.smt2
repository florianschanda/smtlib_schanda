...
(declare-const temp___485 (Array Int integer))
...
(declare-const a_v14 map__ref)
(declare-const i_v13 int__ref)
(declare-const a_v15 (Array Int integer))
(declare-const i_v14 Int)
(declare-const a_v16 map__ref)
...
(assert (forall ((m Int)) (=> (and (<= (to_rep a_v1__first) m) (<= m k_1)) (= (to_rep (select a_v1 m)) (to_rep (select (elts b_v1) m))))))
(assert (and (= temp___480 (+ k_1 1)) (in_range1 (+ k_1 1))))
(assert (= (mk_int__ref result) (mk_int__ref i_v1)))
(assert (= i_v11 temp___480))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= temp___485 a_v1)))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= temp___483 i_v11)))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (and (forall ((m Int)) (=> (and (<= (to_rep a_v1__first) m) (<= m k_1)) (= (to_rep (select a_v12 m)) (to_rep (select (elts b_v1) m))))) (forall ((m Int)) (=> (and (<= (+ k_1 1) m) (<= m (- i_v12 1))) (= (to_rep (select a_v12 m)) (to_rep (select (elts c_v1) (- m k_1)))))))))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (and (and (=> (<= (+ k_1 1) (to_rep a_v1__last)) (dynamic_property2 (+ k_1 1) (to_rep a_v1__last) i_v12)) (forall ((temp___486 Int)) (=> (and (<= (to_rep a_v1__first) temp___486) (<= temp___486 (to_rep a_v1__last))) (=> (or (< (to_rep a_v1__last) temp___486) (or (< temp___486 temp___480) (<= i_v12 temp___486))) (= (select a_v12 temp___486) (select temp___485 temp___486)))))) (and (<= (+ k_1 1) i_v12) (<= i_v12 (to_rep a_v1__last))))))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (and (= temp___482 (- i_v12 k_1)) (in_range1 (- i_v12 k_1)))))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (and (<= (to_rep (first (rt c_v1))) temp___482) (<= temp___482 (to_rep (last (rt c_v1)))))))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= o temp___482)))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= o1 (select (elts c_v1) o))))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= o2 (to_rep o1))))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= (to_rep o3) o2)))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (and (<= (to_rep a_v1__first) i_v12) (<= i_v12 (to_rep a_v1__last)))))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= o4 i_v12)))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= o5 (store a_v12 o4 o3))))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= a_v12 result1)))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= a_v13 o5)))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= i_v12 (to_rep a_v1__last))))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= i_v13 (mk_int__ref i_v12))))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= a_v14 (mk_map__ref a_v13))))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= i_v14 i_v12)))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= a_v15 a_v13)))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= i_v15 i_v13)))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= a_v16 a_v14)))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= i_v16 i_v14)))
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (= a_v17 a_v15)))
(assert (=> (not (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last)))) (= i_v15 (mk_int__ref i_v11))))
(assert (=> (not (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last)))) (= a_v16 (mk_map__ref a_v1))))
(assert (=> (not (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last)))) (= i_v16 i_v11)))
(assert (=> (not (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last)))) (= a_v17 a_v11)))
(declare-const m Int)
(assert (<= (to_rep a_v1__first) m))
(assert (<= m k_1))
(assert (not (= (to_rep (select (map__content a_v16) m)) (to_rep (select (elts b_v1) m)))))
(check-sat)
(exit)
