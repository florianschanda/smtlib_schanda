...
(declare-fun user_eq4 (shape shape) Bool)
(declare-const dummy4 shape)
...
(assert (forall ((x shape)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun in_range5 ((x Int)) Bool (and (<= (- 1) x) (<= x 9)))
(declare-fun attr__ATTRIBUTE_IMAGE5 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check5 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE5 (us_image) Int)
(declare-fun user_eq5 (px_coord px_coord) Bool)
(declare-const dummy5 px_coord)
...
(assert (forall ((x px_coord)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun in_range6 ((x Int)) Bool (and (<= (- 1) x) (<= x 49)))
(declare-fun attr__ATTRIBUTE_IMAGE6 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check6 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE6 (us_image) Int)
(declare-fun user_eq6 (py_coord py_coord) Bool)
(declare-const dummy6 py_coord)
...
(assert (forall ((x py_coord)) (! (in_range6 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(declare-fun user_eq7 (direction direction) Bool)
(declare-const dummy7 direction)
...
(assert (forall ((x direction)) (! (in_range7 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(declare-fun user_eq9 (state state) Bool)
(declare-const dummy9 state)
...
(define-fun dynamic_invariant2 ((temp___expr_627 Int) (temp___is_init_623 Bool) (temp___skip_constant_624 Bool) (temp___do_toplevel_625 Bool) (temp___do_typ_inv_626 Bool)) Bool (=> (or (= temp___is_init_623 true) (<= 0 3)) (in_range8 temp___expr_627)))
(assert true)
...
(define-fun dynamic_invariant3 ((temp___expr_565 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool) (temp___do_typ_inv_564 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 1 50)) (in_range9 temp___expr_565)))
...
(define-fun dynamic_invariant5 ((temp___expr_544 Int) (temp___is_init_540 Bool) (temp___skip_constant_541 Bool) (temp___do_toplevel_542 Bool) (temp___do_typ_inv_543 Bool)) Bool (=> (or (= temp___is_init_540 true) (<= 1 7)) (in_range4 temp___expr_544)))
...
(define-fun dynamic_invariant7 ((temp___expr_595 Int) (temp___is_init_591 Bool) (temp___skip_constant_592 Bool) (temp___do_toplevel_593 Bool) (temp___do_typ_inv_594 Bool)) Bool (=> (or (= temp___is_init_591 true) (<= (- 1) 9)) (in_range5 temp___expr_595)))
(define-fun dynamic_invariant8 ((temp___expr_602 Int) (temp___is_init_598 Bool) (temp___skip_constant_599 Bool) (temp___do_toplevel_600 Bool) (temp___do_typ_inv_601 Bool)) Bool (=> (or (= temp___is_init_598 true) (<= (- 1) 49)) (in_range6 temp___expr_602)))
(define-fun dynamic_invariant9 ((temp___expr_609 Int) (temp___is_init_605 Bool) (temp___skip_constant_606 Bool) (temp___do_toplevel_607 Bool) (temp___do_typ_inv_608 Bool)) Bool (=> (or (= temp___is_init_605 true) (<= 0 3)) (in_range7 temp___expr_609)))
(declare-sort map1 0)
...
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (forall ((y Int) (x Int)) (! (= (= (is_empty b y x) true) (and (and (in_range10 x) (in_range9 y)) (= (to_rep (let ((temp___673 (select b y))) (select temp___673 x))) 0))) :pattern ((is_empty b y x))))))
(assert true)
...
(declare-const temp___813 (Array Int (Array Int cell)))
(declare-const temp___826 Int)
(declare-const temp___825 Int)
(declare-const temp___824 Int)
(declare-const temp___828 Int)
(declare-const temp___827 Int)
(declare-const temp___822 (Array Int (Array Int cell)))
...
(declare-const to_line14 int__ref)
(declare-const from_line6 int__ref)
(declare-const cur_board16 (Array Int (Array Int cell)))
(declare-const num_deleted9 Int)
(declare-const to_line15 Int)
(declare-const from_line7 Int)
(declare-const cur_board17 map__ref1)
(declare-const num_deleted10 int__ref)
(declare-const to_line16 int__ref)
(declare-const from_line8 int__ref)
(declare-const cur_board18 (Array Int (Array Int cell)))
(declare-const num_deleted11 Int)
(declare-const to_line17 Int)
(declare-const from_line9 Int)
(declare-const result14 int__ref)
(declare-const cur_state1 Int)
(declare-const cur_board19 map__ref1)
(declare-const cur_state2 int__ref)
(declare-const num_deleted12 int__ref)
(declare-const to_line18 int__ref)
(declare-const has_complete_lines8 bool__ref)
(declare-const del_line7 int__ref)
(declare-const from_line10 int__ref)
(declare-const cur_board20 (Array Int (Array Int cell)))
(declare-const cur_state3 Int)
(declare-const num_deleted13 Int)
(declare-const to_line19 Int)
(declare-const has_complete_lines9 Bool)
(declare-const del_line8 Int)
(declare-const from_line11 Int)
(define-fun from_line12 () int__ref (mk_int__ref from_line))
(define-fun cur_board21 () map__ref1 (mk_map__ref1 cur_board))
(assert (in_range8 cur_state))
...
(assert (= del_line1 1))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___817 to_line1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___816 del_line1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___815 has_complete_lines1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___813 cur_board)))
...
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (=> (= result3 true) (= (mk_map__ref1 result4) cur_board21))))
...
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (and (and (and (forall ((temp___814 Int)) (=> (and (<= 1 temp___814) (<= temp___814 50)) (=> (or (< 50 temp___814) (or (< temp___814 1) (< del_line2 temp___814))) (= (select cur_board3 temp___814) (select temp___813 temp___814))))) (=> (<= 1 50) (in_range9 del_line2))) (=> (<= 1 50) (in_range9 to_line3))) (and (<= 1 del_line2) (<= del_line2 50)))))
...
(assert (=> (not (and (<= 1 del_line1) (<= del_line1 50))) (= cur_board6 cur_board21)))
...
(assert (=> (= (bool__content has_complete_lines6) true) (= (- (int__content to_line6) 1) r7b)))
(assert (=> (= (bool__content has_complete_lines6) true) (in_range1 r7b)))
(assert (=> (= (bool__content has_complete_lines6) true) (= result8 from_line12)))
(assert (=> (= (bool__content has_complete_lines6) true) (= from_line2 r7b)))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= temp___826 (int__content to_line6)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= temp___825 from_line2))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= temp___824 num_deleted1))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= temp___828 (int__content to_line6)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= temp___827 num_deleted1))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= temp___822 (map__content1 cur_board6)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= (no_complete_lines cur_board8) true))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (< from_line3 to_line8))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= (+ num_deleted2 to_line8) (+ temp___827 temp___828)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (and (and (and (=> (<= 0 2147483647) (in_range2 num_deleted2)) (=> (<= 1 r7b) (dynamic_property 1 r7b from_line3))) (=> (<= 1 50) (in_range9 to_line8))) (and (<= 1 from_line3) (<= from_line3 r7b))))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (and (= o (is_empty_line (select cur_board8 from_line3))) (= (= o true) (forall ((x Int)) (=> (and (<= 1 x) (<= x 10)) (= (to_rep (select (select cur_board8 from_line3) x)) 0))))))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= result9 (ite (not (= o true)) true false)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (= result10 (mk_map__ref1 cur_board8))))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (= cur_board9 (store cur_board8 to_line8 (select cur_board8 from_line3)))))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (= result11 (mk_map__ref1 cur_board9))))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (= cur_board10 (store cur_board9 from_line3 empty_line))))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (and (= o1 (- to_line8 1)) (in_range9 (- to_line8 1)))))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (= result12 (mk_int__ref to_line8))))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (= to_line9 o1)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (and (= o2 (+ num_deleted2 1)) (in_range1 (+ num_deleted2 1)))))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (= result13 (mk_int__ref num_deleted2))))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (= num_deleted3 o2)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (= (to_rep (select (select cur_board10 from_line3) 1)) 0)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (= to_line10 (mk_int__ref to_line9))))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (= num_deleted4 (mk_int__ref num_deleted3))))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (= cur_board11 (mk_map__ref1 cur_board10))))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (= to_line11 to_line9)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (= num_deleted5 num_deleted3)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (= result9 true) (= cur_board12 cur_board10)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (not (= result9 true)) (= to_line10 (mk_int__ref to_line8))))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (not (= result9 true)) (= num_deleted4 (mk_int__ref num_deleted2))))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (not (= result9 true)) (= cur_board11 (mk_map__ref1 cur_board8))))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (not (= result9 true)) (= to_line11 to_line8)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (not (= result9 true)) (= num_deleted5 num_deleted2)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (=> (not (= result9 true)) (= cur_board12 cur_board8)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= from_line3 1))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= from_line4 (mk_int__ref from_line3)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= to_line12 to_line10))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= num_deleted6 num_deleted4))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= cur_board13 cur_board11))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= from_line5 from_line3))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= to_line13 to_line11))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= num_deleted7 num_deleted5))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= cur_board14 cur_board12))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= from_line6 from_line4))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= to_line14 to_line12))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= num_deleted8 num_deleted6))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= cur_board15 cur_board13))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= from_line7 from_line5))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= to_line15 to_line13))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= num_deleted9 num_deleted7))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (and (<= 1 from_line2) (<= from_line2 r7b)) (= cur_board16 cur_board14))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (not (and (<= 1 from_line2) (<= from_line2 r7b))) (= from_line6 (mk_int__ref from_line2)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (not (and (<= 1 from_line2) (<= from_line2 r7b))) (= to_line14 to_line6))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (not (and (<= 1 from_line2) (<= from_line2 r7b))) (= num_deleted8 (mk_int__ref num_deleted1)))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (not (and (<= 1 from_line2) (<= from_line2 r7b))) (= cur_board15 cur_board6))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (not (and (<= 1 from_line2) (<= from_line2 r7b))) (= from_line7 from_line2))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (not (and (<= 1 from_line2) (<= from_line2 r7b))) (= to_line15 to_line7))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (not (and (<= 1 from_line2) (<= from_line2 r7b))) (= num_deleted9 num_deleted1))))
(assert (=> (= (bool__content has_complete_lines6) true) (=> (not (and (<= 1 from_line2) (<= from_line2 r7b))) (= cur_board16 cur_board7))))
(assert (=> (= (bool__content has_complete_lines6) true) (= from_line8 from_line6)))
(assert (=> (= (bool__content has_complete_lines6) true) (= to_line16 to_line14)))
(assert (=> (= (bool__content has_complete_lines6) true) (= num_deleted10 num_deleted8)))
(assert (=> (= (bool__content has_complete_lines6) true) (= cur_board17 cur_board15)))
(assert (=> (= (bool__content has_complete_lines6) true) (= from_line9 from_line7)))
(assert (=> (= (bool__content has_complete_lines6) true) (= to_line17 to_line15)))
(assert (=> (= (bool__content has_complete_lines6) true) (= num_deleted11 num_deleted9)))
(assert (=> (= (bool__content has_complete_lines6) true) (= cur_board18 cur_board16)))
(assert (=> (not (= (bool__content has_complete_lines6) true)) (= from_line8 from_line12)))
(assert (=> (not (= (bool__content has_complete_lines6) true)) (= to_line16 to_line6)))
(assert (=> (not (= (bool__content has_complete_lines6) true)) (= num_deleted10 (mk_int__ref num_deleted1))))
(assert (=> (not (= (bool__content has_complete_lines6) true)) (= cur_board17 cur_board6)))
(assert (=> (not (= (bool__content has_complete_lines6) true)) (= from_line9 from_line1)))
(assert (=> (not (= (bool__content has_complete_lines6) true)) (= to_line17 to_line7)))
(assert (=> (not (= (bool__content has_complete_lines6) true)) (= num_deleted11 num_deleted1)))
(assert (=> (not (= (bool__content has_complete_lines6) true)) (= cur_board18 cur_board7)))
(assert (= result14 (mk_int__ref cur_state)))
(assert (= cur_state1 3))
(assert (= from_line10 from_line8))
(assert (= del_line7 del_line5))
(assert (= has_complete_lines8 has_complete_lines6))
(assert (= to_line18 to_line16))
(assert (= num_deleted12 num_deleted10))
(assert (= cur_state2 (mk_int__ref cur_state1)))
(assert (= cur_board19 cur_board17))
(assert (= from_line11 from_line9))
(assert (= del_line8 del_line6))
(assert (= has_complete_lines9 has_complete_lines7))
(assert (= to_line19 to_line17))
(assert (= num_deleted13 num_deleted11))
(assert (= cur_state3 cur_state1))
(assert (= cur_board20 cur_board18))
(assert (not (= (valid_configuration (map__content1 cur_board19) (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 cur_piece__split_fields3) (int__content cur_state2)) true)))
(check-sat)
(exit)
