...
(assert (=> (not (= first_available1 0)) (and (= o42 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o42))))
(assert (=> (not (= first_available1 0)) (= result12 (ite (< 0 o42) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (and (= o41 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range4 o41)))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (= result11 (ite (= o41 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result12 true)) (= result11 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o43 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o43))))
(assert (=> (not (not (= first_available1 0))) (= result11 (ite (= o43 0) true false))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (and (= o39 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o39)))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (= result13 (ite (< 0 o39) true false)))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (= result13 true) (and (= o38 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range4 o38))))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (= result13 true) (= result10 (ite (= o38 first_allocated1) true false))))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (not (= result13 true)) (= result10 false)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated1 0))) (and (= o40 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o40)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated1 0))) (= result10 (ite (= o40 0) true false)))))
...
(assert (not (<= j (length (rec__list_allocator__m__t__available model____split_fields3)))))
(check-sat)
(exit)
