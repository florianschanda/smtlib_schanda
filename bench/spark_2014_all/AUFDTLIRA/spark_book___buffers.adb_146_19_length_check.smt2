...
(assert (not (= (ite (<= (to_rep1 (first temp___3111)) (to_rep1 (last temp___3111))) (+ (- (to_rep1 (last temp___3111)) (to_rep1 (first temp___3111))) 1) 0) (ite (<= (to_rep1 destination__first) (to_rep1 destination__last)) (+ (- (to_rep1 destination__last) (to_rep1 destination__first)) 1) 0))))
(check-sat)
(exit)
