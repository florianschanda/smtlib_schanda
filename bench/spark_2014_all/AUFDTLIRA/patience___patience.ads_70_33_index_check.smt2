...
(declare-const temp___419 (Array Int cardindex))
...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o6 i))
(assert (= temp___421 (select (rec__patience__state__stacks (us_split_fields1 s)) o6)))
(assert (and (<= 0 j) (<= j 99)))
(assert (= o7 j))
(assert (= o8 (select temp___421 o7)))
(assert (= o9 (to_rep o8)))
(assert (= o10 (ite (< o9 (to_rep (rec__patience__state__numelts (us_split_fields1 s)))) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o5 i))
(assert (= temp___419 (select (rec__patience__state__stacks (us_split_fields1 s)) o5)))
(assert (not (<= j 99)))
(check-sat)
(exit)
