...
(declare-const temp___514 (Array Int ranking))
...
(assert (and (= temp___514 (invert_1 r1)) (and (forall ((rank Int)) (=> (and (<= 1 rank) (<= rank 64)) (= (to_rep1 (select temp___514 (to_rep (select r1 rank)))) rank))) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (= (to_rep (select r1 (to_rep1 (select temp___514 g1)))) g1))))))
(assert (= o1 (select temp___514 g1_b)))
