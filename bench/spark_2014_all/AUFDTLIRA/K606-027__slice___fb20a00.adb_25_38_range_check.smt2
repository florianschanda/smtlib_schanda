...
(assert (and (and (forall ((temp___249 Int)) (=> (and (<= (to_rep1 ret__first) temp___249) (<= temp___249 (to_rep1 ret__last))) (=> (or (< (to_rep1 (last (rt str))) temp___249) (or (< temp___249 (to_rep1 (first (rt str)))) (<= i2 temp___249))) (= (select ret1 temp___249) (select ret temp___249))))) (=> (<= (- 2147483648) 2147483647) (in_range1 pos1))) (and (<= (to_rep1 (first (rt str))) i2) (<= i2 (to_rep1 (last (rt str)))))))
