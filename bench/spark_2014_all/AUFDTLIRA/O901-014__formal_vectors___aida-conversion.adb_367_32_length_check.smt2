...
(assert (not (= (ite (<= (to_rep1 (first8 temp___14081)) (to_rep1 (last8 temp___14081))) (+ (- (to_rep1 (last8 temp___14081)) (to_rep1 (first8 temp___14081))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0))))
(check-sat)
(exit)
