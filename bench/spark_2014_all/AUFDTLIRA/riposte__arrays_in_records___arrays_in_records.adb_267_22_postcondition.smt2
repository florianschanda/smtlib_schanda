...
(declare-const temp___414 index)
(declare-const temp___4141 (Array Int value))
(declare-const temp___4142 (Array Int value))
...
(declare-const temp___417 index)
(declare-const temp___4171 (Array Int value))
(declare-const temp___4172 (Array Int value))
...
(assert (= (to_rep o) (to_rep (select a__split_fields2 5))))
(assert (= o1 (store a__split_fields1 17 o)))
(assert (= a__split_fields o2))
(assert (= o1 o3))
(assert (= a__split_fields2 o4))
(assert (= temp___414 o2))
(assert (= temp___4141 o3))
(assert (= temp___4142 o4))
(assert (= result1 a__split_fields))
(assert (= result2 a__split_fields1))
(assert (= result3 a__split_fields2))
(assert (= temp___414 a__split_fields3))
(assert (= temp___4141 a__split_fields4))
(assert (= temp___4142 a__split_fields5))
(assert (= (to_rep o5) tmp1))
(assert (= o6 (store a__split_fields5 5 o5)))
(assert (= a__split_fields3 o7))
(assert (= a__split_fields4 o8))
(assert (= o6 o9))
(assert (= temp___417 o7))
(assert (= temp___4171 o8))
(assert (= temp___4172 o9))
(assert (= result4 a__split_fields3))
(assert (= result5 a__split_fields4))
(assert (= result6 a__split_fields5))
(assert (= temp___417 a__split_fields6))
(assert (= temp___4171 a__split_fields7))
(assert (= temp___4172 a__split_fields8))
(assert (= tmp2 tmp1))
