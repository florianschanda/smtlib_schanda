...
(assert (not (= (let ((temp___1184 (value (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))))) (bool_eq (elts2 temp___1184) (to_rep1 (first4 (rt2 temp___1184))) (to_rep1 (last4 (rt2 temp___1184))) (let ((temp___1183 (value tail))) (let ((temp___1182 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))))) (ite (= (length3 temp___1182) 0) (elts2 temp___1183) (concat1 (elts2 temp___1182) (to_rep1 (first4 (rt2 temp___1182))) (to_rep1 (last4 (rt2 temp___1182))) (elts2 temp___1183) (to_rep1 (first4 (rt2 temp___1183))) (to_rep1 (last4 (rt2 temp___1183))))))) (to_rep1 (first (let ((temp___1183 (value tail))) (let ((temp___1182 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))))) (ite (= (length3 temp___1182) 0) (mk (to_rep1 (first4 (rt2 temp___1183))) (to_rep1 (last4 (rt2 temp___1183)))) (mk (to_rep1 (first4 (rt2 temp___1182))) (- (+ (to_rep1 (first4 (rt2 temp___1182))) (+ (ite (<= (to_rep1 (first4 (rt2 temp___1182))) (to_rep1 (last4 (rt2 temp___1182)))) (+ (- (to_rep1 (last4 (rt2 temp___1182))) (to_rep1 (first4 (rt2 temp___1182)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 temp___1183))) (to_rep1 (last4 (rt2 temp___1183)))) (+ (- (to_rep1 (last4 (rt2 temp___1183))) (to_rep1 (first4 (rt2 temp___1183)))) 1) 0))) 1))))))) (to_rep1 (last (let ((temp___1183 (value tail))) (let ((temp___1182 (value (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))))) (ite (= (length3 temp___1182) 0) (mk (to_rep1 (first4 (rt2 temp___1183))) (to_rep1 (last4 (rt2 temp___1183)))) (mk (to_rep1 (first4 (rt2 temp___1182))) (- (+ (to_rep1 (first4 (rt2 temp___1182))) (+ (ite (<= (to_rep1 (first4 (rt2 temp___1182))) (to_rep1 (last4 (rt2 temp___1182)))) (+ (- (to_rep1 (last4 (rt2 temp___1182))) (to_rep1 (first4 (rt2 temp___1182)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 temp___1183))) (to_rep1 (last4 (rt2 temp___1183)))) (+ (- (to_rep1 (last4 (rt2 temp___1183))) (to_rep1 (first4 (rt2 temp___1183)))) 1) 0))) 1))))))))) true)))
(check-sat)
(exit)
