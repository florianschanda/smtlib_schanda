...
(assert (= o27 (select temp___1273 ki1)))
...
(assert (=> (= result6 true) (= o23 (select temp___1274 ki1))))
(assert (=> (= result6 true) (= o24 (us_split_fields1 o23))))
(assert (=> (= result6 true) (= o25 (rec__tree_model__path_type__a o24))))
(assert (=> (= result6 true) (and (= o26 (length o25)) (and (in_range1 o26) (<= (+ 0 o26) 2147483647)))))
