...
(declare-fun tTtc_itemsSP1qtint (tTtc_itemsSP1) Int)
(assert (forall ((i tTtc_itemsSP1)) (and (<= 1 (tTtc_itemsSP1qtint i)) (<= (tTtc_itemsSP1qtint i) 10))))
...
(declare-datatypes () ((tTtc_itemsSP1__ref (mk_tTtc_itemsSP1__ref (tTtc_itemsSP1__content tTtc_itemsSP1)))))
(define-fun tTtc_itemsSP1__ref___projection ((a tTtc_itemsSP1__ref)) tTtc_itemsSP1 (tTtc_itemsSP1__content a))
...
(declare-const tc_items (Array Int integer))
...
(assert (=> (<= 1 r5b) (and (and (<= 1 1) (<= 1 10)) (and (<= 1 r5b) (<= r5b 10)))))
(assert (= o tc_items))
(assert (= o temp___179))
(assert (= (mk 1 r5b) temp___1791))
(assert (not (<= 1 (to_rep (last temp___1791)))))
(check-sat)
(exit)
