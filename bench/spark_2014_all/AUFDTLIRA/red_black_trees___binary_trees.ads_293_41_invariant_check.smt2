...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o51 (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)))) (and (in_range2 o51) (= o51 (to_rep f__split_fields)))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o52 (size (mk___rep2 (us_split_fields__content2 f__split_fields7)))) (and (in_range2 o52) (= o52 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))))))
(assert (= result5 (ite (= o52 o51) true false)))
(assert (= result5 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o50 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 o50) (and (= o50 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= o50 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o50) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o50) i)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) d)))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j1) d)) (= o50 j1)))))))))
(assert (= result6 (ite (= v o50) true false)))
(assert (= result6 true))
...
(assert (= o47 (select temp___872 j)))
