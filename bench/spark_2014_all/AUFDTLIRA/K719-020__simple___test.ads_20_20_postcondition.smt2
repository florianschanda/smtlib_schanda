...
(declare-const test__f2__result Int)
(declare-const result Int)
(declare-const test__f2__result1 Int)
(declare-const test__f2__result2 Int)
(declare-const test__f2__result3 Int)
(declare-const test__f2__result4 Int)
(declare-const test__f2__result5 Int)
...
(assert (= test__f2__result1 (to_rep (select (rec__test__t__c (us_split_fields1 x)) 1))))
(assert (= (mk_int__ref test__f2__result4) (mk_int__ref test__f2__result2)))
(assert (= test__f2__result5 test__f2__result3))
(assert (= result1 test__f2__result4))
(assert (not (< 11 test__f2__result4)))
(check-sat)
(exit)
