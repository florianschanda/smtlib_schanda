...
(declare-fun temp_____aggregate_def_2707 ((Array Int (Array Int (Array Int (Array Int et1)))) Int (Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int (Array Int et1)))) (Array Int (Array Int (Array Int (Array Int et1)))))
(declare-fun temp_____aggregate_def_2715 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp_____aggregate_def_2722 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_2730 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp_____aggregate_def_2737 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
...
(assert (forall ((temp___2709 (Array Int (Array Int (Array Int (Array Int et1)))))) (forall ((temp___2710 Int) (temp___2712 Int)) (forall ((temp___2711 (Array Int (Array Int (Array Int et1)))) (temp___2713 (Array Int (Array Int (Array Int et1))))) (let ((temp___2708 (temp_____aggregate_def_2707 temp___2709 temp___2710 temp___2711 temp___2712 temp___2713))) (=> (and (dynamic_invariant2 temp___2710 true true true true) (dynamic_invariant2 temp___2712 true true true true)) (forall ((temp___2714 Int)) (ite (= temp___2714 temp___2712) (= (select temp___2708 temp___2714) temp___2713) (ite (= temp___2714 temp___2710) (= (select temp___2708 temp___2714) temp___2711) (= (select temp___2708 temp___2714) (select temp___2709 temp___2714)))))))))))
(assert (forall ((temp___2717 (Array Int (Array Int (Array Int et1))))) (forall ((temp___2718 Int)) (forall ((temp___2719 (Array Int (Array Int et1)))) (let ((temp___2716 (temp_____aggregate_def_2715 temp___2717 temp___2718 temp___2719))) (=> (dynamic_invariant1 temp___2718 true true true true) (forall ((temp___2720 Int)) (ite (= temp___2720 temp___2718) (= (select temp___2716 temp___2720) temp___2719) (= (select temp___2716 temp___2720) (select temp___2717 temp___2720))))))))))
(assert (forall ((temp___2724 (Array Int (Array Int et1)))) (forall ((temp___2725 Int)) (forall ((temp___2726 (Array Int et1))) (let ((temp___2723 (temp_____aggregate_def_2722 temp___2724 temp___2725 temp___2726))) (=> (dynamic_invariant temp___2725 true true true true) (forall ((temp___2727 Int)) (ite (= temp___2727 temp___2725) (= (select temp___2723 temp___2727) temp___2726) (= (select temp___2723 temp___2727) (select temp___2724 temp___2727))))))))))
(assert (forall ((temp___2732 (Array Int (Array Int (Array Int et1))))) (forall ((temp___2733 Int)) (forall ((temp___2734 (Array Int (Array Int et1)))) (let ((temp___2731 (temp_____aggregate_def_2730 temp___2732 temp___2733 temp___2734))) (=> (dynamic_invariant1 temp___2733 true true true true) (forall ((temp___2735 Int)) (ite (= temp___2735 temp___2733) (= (select temp___2731 temp___2735) temp___2734) (= (select temp___2731 temp___2735) (select temp___2732 temp___2735))))))))))
(assert (forall ((temp___2739 (Array Int (Array Int et1)))) (forall ((temp___2740 Int)) (forall ((temp___2741 (Array Int et1))) (let ((temp___2738 (temp_____aggregate_def_2737 temp___2739 temp___2740 temp___2741))) (=> (dynamic_invariant temp___2740 true true true true) (forall ((temp___2742 Int)) (ite (= temp___2742 temp___2740) (= (select temp___2738 temp___2742) temp___2741) (= (select temp___2738 temp___2742) (select temp___2739 temp___2742))))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq3 a3 90 99 (temp_____aggregate_def_2707 a i1 (temp_____aggregate_def_2715 (select a i1) j1 (temp_____aggregate_def_2722 (select (select a i1) j1) k1 b)) i2 (temp_____aggregate_def_2730 (select a i2) j2 (temp_____aggregate_def_2737 (select (select a i2) j2) k2 c))) 90 99) true)))
(check-sat)
(exit)
