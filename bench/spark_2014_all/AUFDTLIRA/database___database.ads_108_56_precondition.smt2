...
(assert (not (<= (+ (to_rep1 (rec__money__amount__raw (us_split_fields1 (balance account links accounts_balance)))) (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))) 1000000)))
(check-sat)
(exit)
