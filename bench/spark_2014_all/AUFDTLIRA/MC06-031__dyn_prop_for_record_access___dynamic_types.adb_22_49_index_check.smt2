...
(assert (=> (= (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 (result_type__content dynamic_types__search__search_range__result11)))) 0) (= (= result5 true) (forall ((i Int)) (=> (and (<= from i) (<= i (to_rep1 (select (rec__dynamic_types__search__result_type__from (us_split_fields1 (result_type__content dynamic_types__search__search_range__result11))) 1)))) (not (= (to_rep (select (elts a) i)) c)))))))
...
(assert (<= (to_rep1 (first1 (rt a))) (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 (result_type__content dynamic_types__search__search_range__result11))))))
(assert (<= (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 (result_type__content dynamic_types__search__search_range__result11)))) (to_rep1 (last1 (rt a)))))
(assert (not (<= (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 (result_type__content dynamic_types__search__search_range__result11)))) (to_rep1 (last1 (rt a))))))
(check-sat)
(exit)
