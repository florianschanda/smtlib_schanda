...
(define-fun dynamic_invariant ((temp___expr_276 us_t1) (temp___is_init_272 Bool) (temp___skip_constant_273 Bool) (temp___do_toplevel_274 Bool) (temp___do_typ_inv_275 Bool)) Bool (and (=> (not (= temp___skip_constant_273 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_276) (last3 temp___expr_276))) (=> (= temp___do_toplevel_274 true) (=> (= temp___is_init_272 true) (and (let ((temp___278 (of_array (to_array1 temp___expr_276) (first3 temp___expr_276) (last3 temp___expr_276)))) (and (= (first1 temp___278) 1) (<= 0 (last1 temp___278)))) (<= (last3 temp___expr_276) 20))))))
(define-fun dynamic_predicate ((temp___280 us_t1)) Bool (and (let ((temp___282 (of_array (to_array1 temp___280) (first3 temp___280) (last3 temp___280)))) (and (= (first1 temp___282) 1) (<= 0 (last1 temp___282)))) (<= (last3 temp___280) 20)))
(declare-const i13s us_t1)
...
(assert (dynamic_invariant i13s true false false true))
(assert (not (dynamic_property 1 2147483647 (to_rep1 (first2 (rt1 i13s))) (to_rep1 (last2 (rt1 i13s))))))
(check-sat)
(exit)
