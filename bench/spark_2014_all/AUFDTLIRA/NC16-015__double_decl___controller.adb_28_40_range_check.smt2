...
(declare-datatypes () ((cell_type__ref (mk_cell_type__ref (cell_type__content cell_type)))))
(define-fun cell_type__ref___projection ((a cell_type__ref)) cell_type (cell_type__content a))
(declare-fun to_rep (cell_type) Int)
(declare-fun of_rep (Int) cell_type)
(assert (forall ((x cell_type)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x cell_type)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
(assert (forall ((x Int)) (! (=> (in_range1 x) (= (to_rep (of_rep x)) x)) :pattern ((to_rep (of_rep x))))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__tetris__cell__kind cell_type)))))
(define-fun us_split_fields_Kind__projection ((a us_split_fields)) cell_type (rec__tetris__cell__kind a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__tetris__cell__kind (us_split_fields1 a))) (to_rep (rec__tetris__cell__kind (us_split_fields1 b)))) true false))
...
(declare-datatypes () ((map__ref1 (mk_map__ref1 (map__content1 (Array Int (Array Int us_rep)))))))
(declare-fun slide1 ((Array Int (Array Int us_rep)) Int Int) (Array Int (Array Int us_rep)))
(assert (forall ((a (Array Int (Array Int us_rep)))) (forall ((first Int)) (! (= (slide1 a first first) a) :pattern ((slide1 a first first))))))
(assert (forall ((a (Array Int (Array Int us_rep)))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide1 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide1 a old_first new_first) i))))))))
(define-fun bool_eq2 ((a (Array Int (Array Int us_rep))) (a__first Int) (a__last Int) (b (Array Int (Array Int us_rep))) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_155 Int)) (=> (and (<= a__first temp___idx_155) (<= temp___idx_155 a__last)) (= (bool_eq1 (select a temp___idx_155) 1 8 (select b (+ (- b__first a__first) temp___idx_155)) 1 8) true)))) true false))
...
(declare-fun is_empty_cell__function_guard (Bool (Array Int (Array Int us_rep)) Int Int) Bool)
...
(define-fun dynamic_invariant ((temp___expr_160 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 1 8)) (in_range2 temp___expr_160)))
...
(define-fun dynamic_invariant1 ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 1 16)) (in_range3 temp___expr_167)))
(assert true)
(assert (forall ((the_board (Array Int (Array Int us_rep)))) (forall ((xpos Int) (ypos Int)) (! (= (= (is_empty_cell the_board xpos ypos) true) (= (to_rep (rec__tetris__cell__kind (us_split_fields1 (let ((temp___254 (select the_board ypos))) (select temp___254 xpos))))) 0)) :pattern ((is_empty_cell the_board xpos ypos))))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-sort piece_count_type 0)
(declare-fun piece_count_typeqtint (piece_count_type) Int)
(assert (forall ((i piece_count_type)) (and (<= 0 (piece_count_typeqtint i)) (<= (piece_count_typeqtint i) 1000))))
...
(declare-datatypes () ((piece_count_type__ref (mk_piece_count_type__ref (piece_count_type__content piece_count_type)))))
(define-fun piece_count_type__ref___projection ((a piece_count_type__ref)) piece_count_type (piece_count_type__content a))
(define-fun dynamic_invariant2 ((temp___expr_380 Int) (temp___is_init_376 Bool) (temp___skip_constant_377 Bool) (temp___do_toplevel_378 Bool) (temp___do_typ_inv_379 Bool)) Bool (=> (or (= temp___is_init_376 true) (<= 0 1000)) (in_range4 temp___expr_380)))
(define-fun dynamic_invariant3 ((temp___expr_188 Int) (temp___is_init_184 Bool) (temp___skip_constant_185 Bool) (temp___do_toplevel_186 Bool) (temp___do_typ_inv_187 Bool)) Bool (=> (or (= temp___is_init_184 true) (<= 0 7)) (in_range1 temp___expr_188)))
...
(assert (= (ite create_piece 1 0) (ite (distinct 1 0) 1 0)))
(assert (and (= result (is_empty_cell game_board 4 1)) (= (= result true) (= (to_rep (rec__tetris__cell__kind (us_split_fields1 (select (select game_board 1) 4)))) 0))))
(assert (= result true))
(assert (= result1 create_piece))
(assert (= create_piece1 (distinct 0 0)))
(assert (not (in_range4 (+ piece_count 1))))
(check-sat)
(exit)
