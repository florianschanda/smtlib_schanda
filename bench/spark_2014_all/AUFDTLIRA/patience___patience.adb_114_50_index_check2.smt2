...
(assert (=> (= result23 true) (= (= result22 true) (forall ((i14 Int)) (=> (and (<= 0 i14) (<= i14 (- (to_rep (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1))) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 (- (to_rep (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) i14)) 2))) (forall ((k Int)) (=> (and (<= (+ j1 1) k) (<= k (- (to_rep (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) i14)) 1))) (< (to_rep (select (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) i14) j1)) (to_rep (select (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) i14) k))))))))))))
