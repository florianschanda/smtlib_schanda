...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o44 (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)))) (and (in_range2 o44) (= o44 (to_rep f__split_fields)))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
...
(assert (= result5 (ite (= o45 o44) true false)))
(assert (= result5 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
...
(assert (= result6 (ite (= v o43) true false)))
(assert (= result6 true))
