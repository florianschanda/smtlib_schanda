...
(declare-const temp___404 (Array Int character))
(declare-const temp___4041 t1)
(declare-const o Int)
...
(assert (= (to_rep1 (first2 (rt1 (temp_____aggregate_def_397 32 1 (- 128 (length description)))))) 1))
(assert (= (to_rep1 (last2 (rt1 (temp_____aggregate_def_397 32 1 (- 128 (length description)))))) (- 128 (length description))))
(assert (= (mk___t1 temp___404 temp___4041) (temp_____aggregate_def_397 32 1 (- 128 (length description)))))
(assert (not (= (length description) 0)))
(assert (=> (<= (to_rep1 (first2 temp___4041)) (to_rep1 (last2 temp___4041))) (= o (+ (- (to_rep1 (last2 temp___4041)) (to_rep1 (first2 temp___4041))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___4041)) (to_rep1 (last2 temp___4041)))) (= o 0)))
(assert (=> (<= (to_rep1 (first (rt description))) (to_rep1 (last (rt description)))) (= o1 (+ (- (to_rep1 (last (rt description))) (to_rep1 (first (rt description)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt description))) (to_rep1 (last (rt description))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first (rt description))) o2)))
(assert (= o4 (- o3 1)))
