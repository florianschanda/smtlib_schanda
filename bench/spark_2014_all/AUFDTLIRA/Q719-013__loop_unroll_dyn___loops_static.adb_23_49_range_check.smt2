...
(assert (<= 1 i1))
(assert (<= i1 2))
(assert (and (forall ((temp___430 Int)) (=> (and (<= (to_rep1 a__first) temp___430) (<= temp___430 (to_rep1 a__last))) (=> (or (< 2 temp___430) (or (< temp___430 1) (<= i2 temp___430))) (= (select a1 temp___430) (select a temp___430))))) (and (<= 1 i2) (<= i2 2))))
(assert (= j result1))
(assert (= j1 1))
(assert (<= 1 j1))
(assert (<= j1 2))
(assert (and (forall ((temp___427 Int)) (=> (and (<= (to_rep1 a__first) temp___427) (<= temp___427 (to_rep1 a__last))) (=> (not (= i2 temp___427)) (= (select a2 temp___427) (select a1 temp___427))))) (and (<= 1 j2) (<= j2 2))))
(assert (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last))))
(assert (= o i2))
(assert (= o1 (store a2 o rliteral)))
(assert (= a2 result2))
(assert (= a3 o1))
(assert (<= (to_rep1 a__first) i2))
(assert (not (<= (to_rep1 a__first) (to_rep1 a__last))))
(check-sat)
(exit)
