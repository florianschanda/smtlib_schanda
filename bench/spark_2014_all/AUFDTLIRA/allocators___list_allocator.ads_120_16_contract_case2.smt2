...
(assert (=> (= (contains model____split_fields1 res) true) (and (= (is_prepend model____split_fields res (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields6))) true) (= (is_add (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields6)) res model____split_fields1) true))))
(assert (not (= (contains model____split_fields1 res) true)))
(assert (not (= (oeq1 (mk___rep (us_split_fields__content model____split_fields6)) (mk___rep (mk___split_fields model____split_fields model____split_fields1))) true)))
(check-sat)
(exit)
