...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (= temp___227 current1)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (= temp___226 smallest)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (= temp___228 values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (= temp___225 values_last)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (= temp___223 values)))
