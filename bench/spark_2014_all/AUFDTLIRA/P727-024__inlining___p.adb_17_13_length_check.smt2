...
(assert (forall ((i tvec_10_subP1)) (and (<= 0 (tvec_10_subP1qtint i)) (<= (tvec_10_subP1qtint i) 10))))
...
(declare-datatypes () ((tvec_10_subP1__ref (mk_tvec_10_subP1__ref (tvec_10_subP1__content tvec_10_subP1)))))
(define-fun tvec_10_subP1__ref___projection ((a tvec_10_subP1__ref)) tvec_10_subP1 (tvec_10_subP1__content a))
...
(declare-datatypes () ((tTaSP1__ref (mk_tTaSP1__ref (tTaSP1__content integer)))))
(define-fun tTaSP1__ref___projection ((a tTaSP1__ref)) integer (tTaSP1__content a))
(declare-sort t 0)
(declare-fun first (t) integer)
(declare-fun last (t) integer)
(declare-fun mk (Int Int) t)
(assert (forall ((f1 Int) (l Int)) (! (=> (in_range f1) (=> (in_range l) (and (= (to_rep (first (mk f1 l))) f1) (= (to_rep (last (mk f1 l))) l)))) :pattern ((mk f1 l)))))
...
(define-fun of_array ((a (Array Int integer)) (f1 Int) (l Int)) us_t (mk___t a (mk f1 l)))
...
(assert (forall ((f1 Int) (l Int)) (! (=> (in_range f1) (=> (in_range l) (and (= (to_rep (first2 (mk1 f1 l))) f1) (= (to_rep (last2 (mk1 f1 l))) l)))) :pattern ((mk1 f1 l)))))
...
(define-fun dynamic_property4 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range low) (and (in_range high) (=> (<= low high) (and (in_range low) (in_range high))))))
...
(define-fun dynamic_invariant1 ((temp___expr_201 us_t2) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (not (= temp___skip_constant_198 true)) (dynamic_property4 (- 2147483648) 2147483647 (first5 temp___expr_201) (last5 temp___expr_201))))
(declare-const rliteral integer)
(assert (= (integerqtint rliteral) 0))
(assert (forall ((temp___224 Int) (temp___225 Int) (temp___226 Int)) (let ((temp___223 (p__a__aggregate_def temp___224 temp___225 temp___226))) (=> (dynamic_invariant temp___224 true true true true) (and (=> (dynamic_property4 (- 2147483648) 2147483647 temp___225 temp___226) (and (= (first3 temp___223) temp___225) (= (last3 temp___223) temp___226))) (forall ((temp___227 Int)) (= (select (to_array1 temp___223) temp___227) rliteral)))))))
(define-fun dynamic_invariant2 ((temp___expr_217 us_t) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool (=> (not (= temp___skip_constant_214 true)) (and (dynamic_property1 r4b 10 (first1 temp___expr_217) (last1 temp___expr_217)) (and (= (first1 temp___expr_217) r4b) (= (last1 temp___expr_217) 10)))))
...
(assert (= (mk___t1 temp___229 temp___2291) (p__a__aggregate_def 0 r4b 10)))
(assert (= (ite (<= (to_rep (first2 temp___2291)) (to_rep (last2 temp___2291))) (+ (- (to_rep (last2 temp___2291)) (to_rep (first2 temp___2291))) 1) 0) (ite (<= r4b 10) (+ (- 10 r4b) 1) 0)))
(assert (= (slide temp___229 (to_rep (first2 temp___2291)) r4b) p__a__assume))
...
(assert (and (dynamic_property1 r4b 10 (to_rep a__first) (to_rep a__last)) (and (= (to_rep a__first) r4b) (= (to_rep a__last) 10))))
(assert (not (= (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0) (ite (<= 0 10) (+ (- 10 0) 1) 0))))
(check-sat)
(exit)
