...
(assert (<= temp___982 i1))
(assert (<= i1 (to_rep1 (last (rt source)))))
(assert (and (<= (to_rep1 (first (rt source))) i1) (<= i1 (to_rep1 (last (rt source))))))
(assert (= o3 i1))
(assert (= o4 (select (elts source) o3)))
(assert (= o5 (to_rep o4)))
(assert (and (= o6 (is_digit o5)) (ite (= (= o5 48) true) (= o6 true) (ite (= (= o5 49) true) (= o6 true) (ite (= (= o5 50) true) (= o6 true) (ite (= (= o5 51) true) (= o6 true) (ite (= (= o5 52) true) (= o6 true) (ite (= (= o5 53) true) (= o6 true) (ite (= (= o5 54) true) (= o6 true) (ite (= (= o5 55) true) (= o6 true) (ite (= (= o5 56) true) (= o6 true) (ite (= (= o5 57) true) (= o6 true) (ite (= (> o5 57) true) (not (= o6 true)) (=> (= (< o5 48) true) (not (= o6 true))))))))))))))))
(assert (= result2 (ite (not (= o6 true)) true false)))
(assert (not (= result2 true)))
(assert (= has_failed5 has_failed4))
(assert (= target5 target4))
(assert (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j) (<= j i2)) (= (is_digit (to_rep (select (elts source) j))) true))))
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (to_rep1 (last (rt source)))) (dynamic_property1 (+ (to_rep1 (first (rt source))) 1) (to_rep1 (last (rt source))) i2)) (=> (<= (- 2147483648) 2147483647) (in_range1 target6))) (and (<= (+ (to_rep1 (first (rt source))) 1) i2) (<= i2 (to_rep1 (last (rt source)))))))
(assert (not (= i2 (to_rep1 (last (rt source))))))
(assert (= i2 result3))
(assert (= i3 (+ i2 1)))
(assert (and (<= (to_rep1 (first (rt source))) i3) (<= i3 (to_rep1 (last (rt source))))))
(assert (= o7 i3))
(assert (= o8 (select (elts source) o7)))
(assert (= o9 (to_rep o8)))
(assert (and (= o10 (is_digit o9)) (ite (= (= o9 48) true) (= o10 true) (ite (= (= o9 49) true) (= o10 true) (ite (= (= o9 50) true) (= o10 true) (ite (= (= o9 51) true) (= o10 true) (ite (= (= o9 52) true) (= o10 true) (ite (= (= o9 53) true) (= o10 true) (ite (= (= o9 54) true) (= o10 true) (ite (= (= o9 55) true) (= o10 true) (ite (= (= o9 56) true) (= o10 true) (ite (= (= o9 57) true) (= o10 true) (ite (= (> o9 57) true) (not (= o10 true)) (=> (= (< o9 48) true) (not (= o10 true))))))))))))))))
