...
(assert (= a1 (store a 17 (mk___rep (mk___split_fields (distinct 1 0) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a 17))) (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a 17))))))))
(assert (= a1 result1))
(assert (= a2 (store a1 17 (mk___rep (mk___split_fields (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a1 17))) rliteral (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a1 17))))))))
(assert (= a2 result2))
(assert (= a3 (store a2 101 (mk___rep (mk___split_fields (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a2 101))) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a2 101))) rliteral1)))))
(assert (= (to_rep (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a3 101)))) 23))
(assert (= a3 a4))
(assert (= a5 a3))
(assert (not (= (to_rep (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a4 17)))) 23)))
(check-sat)
(exit)
