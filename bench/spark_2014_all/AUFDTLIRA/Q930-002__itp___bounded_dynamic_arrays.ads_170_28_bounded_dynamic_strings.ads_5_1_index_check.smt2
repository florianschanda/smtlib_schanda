...
(declare-const o7 t)
(declare-const temp___1276 natural_index)
(declare-const temp___12761 natural_index)
(declare-const temp___12762 (Array Int character))
(declare-const temp___12763 t)
(declare-const temp___1277 natural_index)
(declare-const temp___12771 natural_index)
(declare-const temp___12772 (Array Int character))
(declare-const temp___12773 t)
(declare-const temp___1280 (Array Int character))
(declare-const temp___12801 t1)
...
(declare-const this__split_fields8 t)
(declare-const this__split_fields9 us_split_fields)
(define-fun temp___12802 () us_t1 (mk___t1 temp___1280 temp___12801))
(define-fun temp___12764 () us_rep (mk___rep (mk___split_discrs temp___1276) (mk___split_fields temp___12761 (mk___t temp___12762 temp___12763))))
...
(assert (and (<= (to_rep2 (first this__split_fields2)) start) (<= start (to_rep2 (last this__split_fields2)))))
(assert (= o1 start))
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= this__split_discrs (mk___split_discrs temp___1276)))
(assert (= temp___12761 o5))
(assert (= temp___12762 o6))
(assert (= temp___12763 o7))
(assert (dynamic_predicate temp___12764))
(assert (= (mk___rep (mk___split_discrs temp___1277) (mk___split_fields temp___12771 (mk___t temp___12772 temp___12773))) temp___12764))
(assert (= (mk___split_fields__ref (mk___split_fields result (mk___t result1 result2))) (mk___split_fields__ref (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2)))))
(assert (= temp___12771 this__split_fields3))
(assert (= temp___12772 this__split_fields4))
(assert (= temp___12773 this__split_fields5))
(assert (= this__split_discrs (mk___split_discrs temp___1277)))
...
(assert (= this__split_fields9 (mk___split_fields this__split_fields3 (mk___t this__split_fields4 this__split_fields5))))
(assert (and (= o8 (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t this__split_fields7 this__split_fields8))))) (and (in_range2 o8) (= o8 (to_rep1 this__split_fields6)))))
(assert (= o9 (ite (= o8 (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2))))) true false)))
(assert (and (= temp___12802 (value (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t this__split_fields7 this__split_fields8))))) (and (dynamic_invariant2 temp___12802 true false true true) (and (and (= this__split_fields7 temp___1280) (= (mk1 (to_rep2 (first4 (mk2 1 (to_rep1 this__split_fields6)))) (to_rep2 (last4 (mk2 1 (to_rep1 this__split_fields6))))) temp___12801)) (and (and (and (= (length2 temp___12802) (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t this__split_fields7 this__split_fields8))))) (= (to_rep2 (first2 temp___12801)) 1)) (= (to_rep2 (last2 temp___12801)) (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t this__split_fields7 this__split_fields8)))))) (= (< 0 (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t this__split_fields7 this__split_fields8))))) (not (= (empty (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t this__split_fields7 this__split_fields8)))) true))))))))
(assert (not (<= start (to_rep2 (last2 temp___12801)))))
(check-sat)
(exit)
