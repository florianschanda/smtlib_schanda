...
(assert (and (<= 1 temp___617) (<= temp___617 3)))
(assert (= o temp___617))
(assert (= o1 (set ta9 o 2 rliteral1)))
(assert (= result4 ta9))
(assert (= ta10 o1))
(assert (= result5 outer))
(assert (= outer1 1))
(assert (= (mk_int__ref result6) (mk_int__ref inner)))
(assert (= inner1 1))
(assert (<= 1 inner1))
(assert (<= inner1 2))
(assert (not (= (to_rep2 (get ta10 outer1 inner1)) 0)))
(check-sat)
(exit)
