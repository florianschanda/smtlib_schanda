...
(assert (and (= o67 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 o67)))
(assert (= result12 (ite (in_range7 o67) true false)))
(assert (=> (= result12 true) (and (= o63 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o63))))
(assert (=> (= result12 true) (= result13 (ite (< j o63) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o64 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o65 (get (rec__list_allocator__m__t__allocated model____split_fields3) o64)) (in_range4 o65)))))
(assert (=> (= result12 true) (=> (not (= result13 true)) (= o65 0))))
...
(assert (=> (= result12 true) (= o59 temp___462)))
(assert (=> (= result12 true) (= o60 (select data3 o59))))
(assert (=> (= result12 true) (= o61 (us_split_fields3 o60))))
(assert (=> (= result12 true) (= o62 (rec__list_allocator__cell__next o61))))
(assert (=> (= result12 true) (= o66 (to_rep o62))))
(assert (=> (= result12 true) (= result11 (ite (= o66 o65) true false))))
