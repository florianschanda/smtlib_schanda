...
(declare-const dummy6 (Array Int cell))
...
(define-fun dynamic_invariant ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_18)))
...
(declare-fun user_eq8 (x_coord x_coord) Bool)
(declare-const dummy8 x_coord)
...
(declare-fun user_eq9 (y_coord y_coord) Bool)
(declare-const dummy9 y_coord)
...
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (forall ((y Int) (x Int)) (! (= (= (is_empty b y x) true) (and (and (in_range7 x) (in_range8 y)) (= (to_rep4 (let ((temp___2238 (select b y))) (select temp___2238 x))) 0))) :pattern ((is_empty b y x))))))
...
(define-fun dynamic_invariant1 ((temp___expr_2094 Int) (temp___is_init_2090 Bool) (temp___skip_constant_2091 Bool) (temp___do_toplevel_2092 Bool) (temp___do_typ_inv_2093 Bool)) Bool (=> (or (= temp___is_init_2090 true) (<= 0 7)) (in_range5 temp___expr_2094)))
(define-fun dynamic_invariant2 ((temp___expr_2101 Int) (temp___is_init_2097 Bool) (temp___skip_constant_2098 Bool) (temp___do_toplevel_2099 Bool) (temp___do_typ_inv_2100 Bool)) Bool (=> (or (= temp___is_init_2097 true) (<= 1 7)) (in_range1 temp___expr_2101)))
(define-fun dynamic_invariant3 ((temp___expr_2108 Int) (temp___is_init_2104 Bool) (temp___skip_constant_2105 Bool) (temp___do_toplevel_2106 Bool) (temp___do_typ_inv_2107 Bool)) Bool (=> (or (= temp___is_init_2104 true) (<= 3 7)) (in_range9 temp___expr_2108)))
(define-fun dynamic_invariant4 ((temp___expr_2115 Int) (temp___is_init_2111 Bool) (temp___skip_constant_2112 Bool) (temp___do_toplevel_2113 Bool) (temp___do_typ_inv_2114 Bool)) Bool (=> (or (= temp___is_init_2111 true) (<= 1 10)) (in_range7 temp___expr_2115)))
(define-fun dynamic_invariant5 ((temp___expr_2122 Int) (temp___is_init_2118 Bool) (temp___skip_constant_2119 Bool) (temp___do_toplevel_2120 Bool) (temp___do_typ_inv_2121 Bool)) Bool (=> (or (= temp___is_init_2118 true) (<= 1 20)) (in_range8 temp___expr_2122)))
(define-fun dynamic_invariant6 ((temp___expr_2160 Int) (temp___is_init_2156 Bool) (temp___skip_constant_2157 Bool) (temp___do_toplevel_2158 Bool) (temp___do_typ_inv_2159 Bool)) Bool (=> (or (= temp___is_init_2156 true) (<= (- 1) 9)) (in_range2 temp___expr_2160)))
(define-fun dynamic_invariant7 ((temp___expr_2167 Int) (temp___is_init_2163 Bool) (temp___skip_constant_2164 Bool) (temp___do_toplevel_2165 Bool) (temp___do_typ_inv_2166 Bool)) Bool (=> (or (= temp___is_init_2163 true) (<= (- 1) 19)) (in_range3 temp___expr_2167)))
(define-fun dynamic_invariant8 ((temp___expr_2174 Int) (temp___is_init_2170 Bool) (temp___skip_constant_2171 Bool) (temp___do_toplevel_2172 Bool) (temp___do_typ_inv_2173 Bool)) Bool (=> (or (= temp___is_init_2170 true) (<= 0 3)) (in_range4 temp___expr_2174)))
...
(assert (<= 0 x))
(assert (<= x 2))
(assert (not (<= 3 (to_rep (rec__patris__piece__s (us_split_fields1 p))))))
(check-sat)
(exit)
