...
(assert (and (and (and (and (<= (to_rep1 (first (rt s))) courant2) (<= courant2 (to_rep1 (last (rt s))))) (not (exists ((i1 Int)) (and (and (<= (to_rep1 (first (rt s))) i1) (<= i1 (- courant2 1))) (exists ((j1 Int)) (and (and (<= (to_rep1 (first (rt c))) j1) (<= j1 (to_rep1 (last (rt c))))) (= (to_rep (select (elts s) i1)) (to_rep (select (elts c) j1))))))))) (and (<= (to_rep1 (first (rt c))) possible2) (<= possible2 (to_rep1 (last (rt c)))))) (not (exists ((j1 Int)) (and (and (<= (to_rep1 (first (rt c))) j1) (<= j1 (- possible2 1))) (= (to_rep (select (elts s) courant2)) (to_rep (select (elts c) j1))))))))
