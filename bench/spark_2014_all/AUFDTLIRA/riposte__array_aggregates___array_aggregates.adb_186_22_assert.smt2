...
(declare-fun temp_____aggregate_def_510 (us_rep us_rep) (Array Int us_rep))
...
(assert (forall ((temp___512 us_rep) (temp___513 us_rep)) (let ((temp___511 (temp_____aggregate_def_510 temp___512 temp___513))) (forall ((temp___514 Int)) (ite (or (= temp___514 2) (and (<= 4 temp___514) (<= temp___514 6))) (= (select temp___511 temp___514) temp___512) (= (select temp___511 temp___514) temp___513))))))
(declare-const rliteral small_index_t)
(assert (= (small_index_tqtint rliteral) 10))
(declare-const rliteral1 small_index_t)
(assert (= (small_index_tqtint rliteral1) 5))
...
(declare-const o5 small_index_t)
(declare-const o6 Bool)
(declare-const o7 enum_t)
(declare-const o8 small_index_t)
(declare-const o9 Bool)
(declare-const o10 enum_t)
(declare-const o11 small_index_t)
(declare-const o12 Bool)
(declare-const o13 enum_t)
...
(assert (= o12 o2))
(assert (= o13 o3))
(assert (= o14 (temp_____aggregate_def_510 (mk___rep (mk___split_fields o11 o12 o13)) (mk___rep (mk___split_fields o8 o9 o10)))))
(assert (= result x))
(assert (= x1 o14))
