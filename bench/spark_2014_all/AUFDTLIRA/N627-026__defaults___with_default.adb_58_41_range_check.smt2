...
(define-fun to_rep2 ((x scalar_with_default)) Int (scalar_with_defaultqtint x))
...
(define-fun to_rep3 ((x tscalar_with_defaultB)) Int (tscalar_with_defaultBqtint x))
...
(assert (forall ((i t17b)) (and (<= 1 (t17bqtint i)) (<= (t17bqtint i) 100))))
...
(declare-fun tTall_0SP1qtint (tTall_0SP1) Int)
(assert (forall ((i tTall_0SP1)) (and (<= 1 (tTall_0SP1qtint i)) (<= (tTall_0SP1qtint i) 100))))
...
(declare-fun tTall_1SP1qtint (tTall_1SP1) Int)
(assert (forall ((i tTall_1SP1)) (and (<= 1 (tTall_1SP1qtint i)) (<= (tTall_1SP1qtint i) 100))))
...
(declare-fun tTall_2SP1qtint (tTall_2SP1) Int)
(assert (forall ((i tTall_2SP1)) (and (<= 1 (tTall_2SP1qtint i)) (<= (tTall_2SP1qtint i) 100))))
