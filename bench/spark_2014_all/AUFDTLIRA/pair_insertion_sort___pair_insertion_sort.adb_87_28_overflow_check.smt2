...
(assert (=> (= result23 true) (= (sorted (mk___t o73 (mk (to_rep a__first) (to_rep a__last))) 0 (- j16 1)) true)))
(assert (=> (= result23 true) (= (sorted (mk___t o73 (mk (to_rep a__first) (to_rep a__last))) (+ j16 2) (+ i3 1)) true)))
(assert (=> (= result23 true) (=> (< 0 j16) (<= (to_rep (select o73 (- j16 1))) (to_rep (select o73 (+ j16 2)))))))
(assert (=> (= result23 true) (< (int__content x6) (to_rep (select o73 (+ j16 2))))))
(assert (=> (= result23 true) (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t o73 (mk (to_rep a__first) (to_rep a__last)))) true)))
(assert (=> (= result23 true) (or (and (= (to_rep (select o73 j16)) (int__content x6)) (= (to_rep (select o73 (+ j16 1))) (int__content y6))) (and (= (to_rep (select o73 j16)) (int__content y6)) (= (to_rep (select o73 (+ j16 1))) (int__content x6))))))
...
(assert (=> (= result23 true) (=> (<= 0 j17) (= o60 (select o73 o59)))))
...
(assert (=> (= result23 true) (= a13 (mk_map__ref o73))))
(assert (=> (= result23 true) (= j19 j17)))
(assert (=> (= result23 true) (= a14 o73)))
...
(assert (not (in_range1 (+ (int__content j20) 1))))
(check-sat)
(exit)
