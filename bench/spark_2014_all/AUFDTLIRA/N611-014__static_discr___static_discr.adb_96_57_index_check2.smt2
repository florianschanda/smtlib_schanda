...
(declare-datatypes () ((tT45bP1__ref (mk_tT45bP1__ref (tT45bP1__content integer)))))
(define-fun tT45bP1__ref___projection ((a tT45bP1__ref)) integer (tT45bP1__content a))
(declare-sort t2 0)
...
(define-fun us_split_fields_Content__15__projection ((a us_split_fields6)) us_t2 (rec__static_discr__i_holder__content2 a))
(declare-datatypes () ((us_split_fields__ref3 (mk___split_fields__ref3 (us_split_fields__content3 us_split_fields6)))))
(define-fun us_split_fields__ref___15__projection ((a us_split_fields__ref3)) us_split_fields6 (us_split_fields__content3 a))
(declare-datatypes () ((us_rep3 (mk___rep3 (us_split_discrs5 us_split_discrs) (us_split_fields7 us_split_fields6)))))
(define-fun us_rep___29__projection ((a us_rep3)) us_split_discrs (us_split_discrs5 a))
(define-fun us_rep___30__projection ((a us_rep3)) us_split_fields6 (us_split_fields7 a))
(define-fun to_base1 ((a us_rep3)) us_rep (mk___rep (us_split_discrs5 a) (mk___split_fields (let ((temp___169 (rec__static_discr__i_holder__content2 (us_split_fields7 a)))) (of_array (to_array2 temp___169) (first5 temp___169) (last5 temp___169))))))
(define-fun of_base1 ((r us_rep)) us_rep3 (mk___rep3 (us_split_discrs1 r) (mk___split_fields3 (let ((temp___168 (rec__static_discr__i_holder__content (us_split_fields1 r)))) (of_array2 (to_array temp___168) (first1 temp___168) (last1 temp___168))))))
...
(define-fun dynamic_invariant4 ((temp___expr_302 us_rep3) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool) (temp___do_typ_inv_301 Bool)) Bool (and (=> (not (= temp___skip_constant_299 true)) (in_range4 r43b r44b (to_base1 temp___expr_302))) (and (dynamic_property5 1 r44b (first5 (rec__static_discr__i_holder__content2 (us_split_fields7 temp___expr_302))) (last5 (rec__static_discr__i_holder__content2 (us_split_fields7 temp___expr_302)))) (and (= (first5 (rec__static_discr__i_holder__content2 (us_split_fields7 temp___expr_302))) 1) (= (last5 (rec__static_discr__i_holder__content2 (us_split_fields7 temp___expr_302))) r44b)))))
(define-fun default_initial_assumption ((temp___expr_306 us_rep3) (temp___skip_top_level_307 Bool)) Bool (and (= (to_rep (rec__static_discr__i_holder__unused (us_split_discrs5 temp___expr_306))) r43b) (= (to_rep (rec__static_discr__i_holder__c (us_split_discrs5 temp___expr_306))) r44b)))
...
(declare-const temp___439 natural)
(declare-const temp___4391 natural)
(declare-const temp___4392 natural)
(declare-const temp___4393 natural)
(declare-const temp___4394 (Array Int natural))
(declare-const temp___4395 t1)
(declare-const temp___4396 natural)
(declare-const i Int)
...
(assert (dynamic_invariant1 (mk___rep2 current__split_discrs (mk___split_fields2 (mk___rep1 (mk___split_discrs current__split_fields current__split_fields1) (mk___split_fields1 (mk___t1 current__split_fields2 current__split_fields3))) current__split_fields4)) true false true true))
...
(assert (= (to_rep (rec__static_discr__holder__unused current__split_discrs)) r43b))
(assert (in_range2 r43b))
(assert (= (to_rep (rec__static_discr__holder__c current__split_discrs)) r44b))
(assert (in_range2 r44b))
(assert (and (= us r44b) (in_range2 r44b)))
(assert (and (= us1 r43b) (in_range2 r43b)))
(assert (and (<= (to_rep1 (first4 (rt2 (rec__static_discr__i_holder__content2 (us_split_fields7 (of_base1 (to_base (mk___rep1 (mk___split_discrs current__split_fields current__split_fields1) (mk___split_fields1 (mk___t1 current__split_fields2 current__split_fields3)))))))))) (to_rep current__split_fields4)) (<= (to_rep current__split_fields4) (to_rep1 (last4 (rt2 (rec__static_discr__i_holder__content2 (us_split_fields7 (of_base1 (to_base (mk___rep1 (mk___split_discrs current__split_fields current__split_fields1) (mk___split_fields1 (mk___t1 current__split_fields2 current__split_fields3)))))))))))))
(assert (= o (to_rep current__split_fields4)))
(assert (= o1 (select (elts2 (rec__static_discr__i_holder__content2 (us_split_fields7 (of_base1 (to_base (mk___rep1 (mk___split_discrs current__split_fields current__split_fields1) (mk___split_fields1 (mk___t1 current__split_fields2 current__split_fields3)))))))) o)))
(assert (= o2 (to_rep o1)))
...
(assert (= o4 o9))
(assert (= current__split_discrs (mk___split_discrs1 temp___439 temp___4391)))
(assert (= temp___4392 o5))
(assert (= temp___4393 o6))
(assert (= temp___4394 o7))
(assert (= temp___4395 o8))
(assert (= temp___4396 o9))
(assert (= result3 (mk___split_fields__ref2 (mk___split_fields2 (mk___rep1 (mk___split_discrs current__split_fields current__split_fields1) (mk___split_fields1 (mk___t1 current__split_fields2 current__split_fields3))) current__split_fields4))))
(assert (= current__split_fields5 (mk___split_fields2 (mk___rep1 (mk___split_discrs temp___4392 temp___4393) (mk___split_fields1 (mk___t1 temp___4394 temp___4395))) temp___4396)))
(assert (= current__split_discrs (mk___split_discrs1 temp___439 temp___4391)))
(assert (= result__3 (mk_int__ref result__1)))
(assert (= current__split_fields6 (mk___split_fields__ref2 current__split_fields5)))
(assert (= result__4 result__1))
(assert (= current__split_fields7 current__split_fields5))
(assert (= (bool_eq (elts1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields__content2 current__split_fields6))))) (to_rep1 (first2 (rt1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields__content2 current__split_fields6))))))) (to_rep1 (last2 (rt1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields__content2 current__split_fields6))))))) current__split_fields2 (to_rep1 (first2 current__split_fields3)) (to_rep1 (last2 current__split_fields3))) true))
(assert (< (to_rep (rec__static_discr__holder__length (us_split_fields__content2 current__split_fields6))) (to_rep current__split_fields4)))
(assert (= (int__content result__3) 0))
(assert (and (= o10 (+ (to_rep (rec__static_discr__holder__length (us_split_fields__content2 current__split_fields6))) 1)) (in_range1 (+ (to_rep (rec__static_discr__holder__length (us_split_fields__content2 current__split_fields6))) 1))))
(assert (= o11 (ite (<= o10 i) true false)))
(assert (= result4 (ite (= o11 true) (ite (<= i (to_rep current__split_fields4)) true false) false)))
(assert (= result4 true))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields__content2 current__split_fields6))))))) i)))
(check-sat)
(exit)
