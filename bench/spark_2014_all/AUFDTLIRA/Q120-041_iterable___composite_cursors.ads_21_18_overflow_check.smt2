...
(declare-fun temp_____aggregate_def_201 (Int) (Array Int natural))
...
(assert (forall ((temp___203 Int)) (=> (dynamic_invariant1 temp___203 true true true true) (= (to_rep (select (temp_____aggregate_def_201 temp___203) 1)) temp___203))))
...
(assert (not (in_range (+ (to_rep (select p 1)) 1))))
(check-sat)
(exit)
