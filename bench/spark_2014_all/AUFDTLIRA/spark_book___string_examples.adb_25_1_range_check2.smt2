...
(assert (= (concat1 name3 1 20 name3 1 20) temp___606))
(assert (= (mk 1 o9) temp___6061))
(assert (= (ite (<= (to_rep1 (first temp___6061)) (to_rep1 (last temp___6061))) (+ (- (to_rep1 (last temp___6061)) (to_rep1 (first temp___6061))) 1) 0) (ite (<= 1 40) (+ (- 40 1) 1) 0)))
(assert (= o10 (slide temp___606 (to_rep1 (first temp___6061)) 1)))
(assert (= result6 address2))
(assert (= address3 o10))
(assert (forall ((temp___608 Int)) (ite (and (<= 9 temp___608) (<= temp___608 28)) (= (select o11 temp___608) (select (slide name3 1 9) temp___608)) (= (select o11 temp___608) (select address3 temp___608)))))
...
(assert (= (temp___String_Literal_609 Tuple0) temp___610))
(assert (= (mk1 1 5) temp___6101))
(assert (<= 1 r9b))
(assert (not (<= 1 1)))
(check-sat)
(exit)
