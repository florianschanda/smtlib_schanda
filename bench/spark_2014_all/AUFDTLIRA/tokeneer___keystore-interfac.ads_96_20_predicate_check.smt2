...
(define-fun dynamic_invariant ((temp___expr_358 us_t1) (temp___is_init_354 Bool) (temp___skip_constant_355 Bool) (temp___do_toplevel_356 Bool) (temp___do_typ_inv_357 Bool)) Bool (and (=> (not (= temp___skip_constant_355 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_358) (last3 temp___expr_358))) (=> (= temp___do_toplevel_356 true) (=> (= temp___is_init_354 true) (and (let ((temp___360 (of_array2 (to_array1 temp___expr_358) (first3 temp___expr_358) (last3 temp___expr_358)))) (and (= (first5 temp___360) 1) (<= 0 (last5 temp___360)))) (<= (last3 temp___expr_358) 1000))))))
(define-fun dynamic_predicate ((temp___362 us_t1)) Bool (and (let ((temp___364 (of_array2 (to_array1 temp___362) (first3 temp___362) (last3 temp___362)))) (and (= (first5 temp___364) 1) (<= 0 (last5 temp___364)))) (<= (last3 temp___362) 1000)))
...
(define-fun returnvaluet__ref___2__projection ((a returnvaluet__ref)) returnvaluet (returnvaluet__content a))
(define-fun dynamic_invariant1 ((temp___expr_1945 Int) (temp___is_init_1941 Bool) (temp___skip_constant_1942 Bool) (temp___do_toplevel_1943 Bool) (temp___do_typ_inv_1944 Bool)) Bool (=> (or (= temp___is_init_1941 true) (<= 0 28)) (in_range3 temp___expr_1945)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_321 us_t2) (temp___is_init_317 Bool) (temp___skip_constant_318 Bool) (temp___do_toplevel_319 Bool) (temp___do_typ_inv_320 Bool)) Bool (and (=> (not (= temp___skip_constant_318 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_321) (last5 temp___expr_321))) (=> (= temp___do_toplevel_319 true) (=> (= temp___is_init_317 true) (and (= (first5 temp___expr_321) 1) (<= 0 (last5 temp___expr_321)))))))
(define-fun dynamic_predicate1 ((temp___324 us_t2)) Bool (and (= (first5 temp___324) 1) (<= 0 (last5 temp___324))))
(declare-const temp___1982 (Array Int character))
(declare-const temp___19821 t1)
(assert (in_range3 x))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___1982))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___19821))
(assert (not (dynamic_predicate (mk___t1 temp___1982 temp___19821))))
(check-sat)
(exit)
