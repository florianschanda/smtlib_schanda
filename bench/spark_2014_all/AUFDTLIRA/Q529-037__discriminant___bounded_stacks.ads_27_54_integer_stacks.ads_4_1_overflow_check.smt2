...
(define-fun dynamic_property8 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range1 low) (and (in_range1 high) (=> (<= low high) (and (in_range2 low) (in_range2 high))))))
...
(assert (forall ((temp___247 Int) (temp___248 Int) (temp___249 Int)) (let ((temp___246 (temp_____aggregate_def_245 temp___247 temp___248 temp___249))) (=> (dynamic_invariant2 temp___247 true true true true) (and (=> (dynamic_property8 1 2147483647 temp___248 temp___249) (and (= (first11 temp___246) temp___248) (= (last11 temp___246) temp___249))) (forall ((temp___250 Int)) (= (select (to_array5 temp___246) temp___250) rliteral)))))))
...
(define-fun dynamic_invariant6 ((temp___expr_257 us_rep3) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool) (temp___do_typ_inv_256 Bool)) Bool (and (=> (not (= temp___skip_constant_254 true)) (in_range7 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (to_base2 temp___expr_257))) (and (dynamic_property7 1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_257))) (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_257)))) (and (= (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_257))) 1) (= (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_257))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left))))))))
(define-fun default_initial_assumption ((temp___expr_260 us_rep3) (temp___skip_top_level_261 Bool)) Bool (and (and (= (attr__tag3 temp___expr_260) us_tag3) (and (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_260))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left)))) (= (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_260)) (let ((temp___263 (temp_____aggregate_def_245 0 1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_260)))))) (of_array3 (to_array5 temp___263) (first11 temp___263) (last11 temp___263))))) (= (to_rep1 (rec__integer_stacks__stack__top3 (us_split_fields7 temp___expr_260))) 0))) (=> (not (= temp___skip_top_level_261 true)) (= (empty (to_base2 temp___expr_260)) true))))
