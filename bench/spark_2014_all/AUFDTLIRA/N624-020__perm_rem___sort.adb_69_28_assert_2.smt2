...
(assert (not (= (let ((temp___253 (remove (remove (mk___t values2 (mk 1 100)) y) x))) (let ((temp___252 (remove (remove (mk___t interm1 (mk 1 100)) x) (- y 1)))) (bool_eq (elts temp___252) (to_rep1 (first (rt temp___252))) (to_rep1 (last (rt temp___252))) (elts temp___253) (to_rep1 (first (rt temp___253))) (to_rep1 (last (rt temp___253)))))) true)))
(check-sat)
(exit)
