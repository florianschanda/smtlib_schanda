...
(declare-const result9 (Array Int value))
...
(assert (= (to_rep o) (to_rep (select a__split_fields4 5))))
(assert (= o1 (store a__split_fields4 17 o)))
(assert (= a__split_fields3 o2))
(assert (= o1 o3))
(assert (= a__split_fields5 o4))
(assert (= temp___368 o2))
(assert (= temp___3681 o3))
(assert (= temp___3682 o4))
(assert (= result4 a__split_fields3))
(assert (= result5 a__split_fields4))
(assert (= result6 a__split_fields5))
(assert (= temp___368 a__split_fields6))
(assert (= temp___3681 a__split_fields7))
(assert (= temp___3682 a__split_fields8))
(assert (= (to_rep o5) tmp1))
(assert (= o6 (store a__split_fields8 23 o5)))
(assert (= a__split_fields6 o7))
(assert (= a__split_fields7 o8))
(assert (= o6 o9))
(assert (= temp___371 o7))
(assert (= temp___3711 o8))
(assert (= temp___3712 o9))
(assert (= result7 a__split_fields6))
(assert (= result8 a__split_fields7))
(assert (= result9 a__split_fields8))
(assert (= a__split_fields9 (mk___split_fields temp___371 temp___3711 temp___3712)))
(assert (= (to_rep o10) tmp1))
(assert (= o11 (store (rec__arrays_in_records__record_with_arrays__first_array a__split_fields9) 5 o10)))
(assert (= (rec__arrays_in_records__record_with_arrays__counter a__split_fields9) o12))
(assert (= o11 o13))
(assert (= (rec__arrays_in_records__record_with_arrays__second_array a__split_fields9) o14))
(assert (= temp___374 o12))
(assert (= temp___3741 o13))
(assert (= temp___3742 o14))
(assert (= result10 (mk___split_fields__ref a__split_fields9)))
(assert (= a__split_fields10 (mk___split_fields temp___374 temp___3741 temp___3742)))
...
(assert (not (not (= (bool_eq1 (mk___rep (us_split_fields__content a__split_fields11)) (mk___rep (mk___split_fields a__split_fields a__split_fields1 a__split_fields2))) true))))
(check-sat)
(exit)
