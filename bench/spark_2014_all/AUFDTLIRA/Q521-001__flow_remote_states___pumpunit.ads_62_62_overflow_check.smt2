...
(assert (= result true))
(assert (and (= o (get_cur_price (mk___split_fields cur_pump__split_fields cur_pump__split_fields1 cur_pump__split_fields2 cur_pump__split_fields3))) (and (in_range4 o) (= o (to_rep2 cur_pump__split_fields2)))))
