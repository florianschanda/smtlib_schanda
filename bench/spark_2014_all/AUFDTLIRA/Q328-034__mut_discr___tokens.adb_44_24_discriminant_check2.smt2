...
(declare-const temp___272 us_rep1)
...
(assert (= result6 true))
(assert (= (to_rep4 (rec__tokens__token__kind v__split_discrs)) r13b))
(assert (in_range6 r13b))
(assert (= o35 (read1 (mk___t word1 (mk (to_rep1 word__first) (to_rep1 word__last))))))
(assert (= o36 (mk___split_fields1 o35 dummy6 dummy4)))
(assert (= (to_rep4 o34) 0))
(assert (= o37 (mk___split_discrs o34)))
(assert (= temp___272 (mk___rep1 o37 o36 true)))
(assert (= v__attr__constrained true))
(assert (not (= (rec__tokens__token__kind (us_split_discrs1 temp___272)) (rec__tokens__token__kind v__split_discrs))))
(check-sat)
(exit)
