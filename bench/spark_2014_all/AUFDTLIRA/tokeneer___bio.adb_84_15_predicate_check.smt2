...
(define-fun dynamic_invariant1 ((temp___expr_1411 Int) (temp___is_init_1407 Bool) (temp___skip_constant_1408 Bool) (temp___do_toplevel_1409 Bool) (temp___do_typ_inv_1410 Bool)) Bool (=> (or (= temp___is_init_1407 true) (<= 0 16)) (in_range3 temp___expr_1411)))
(declare-const x Int)
...
(declare-const temp___1503 (Array Int character))
(declare-const temp___15031 t1)
(assert (in_range3 x))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___1503))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___15031))
(assert (not (dynamic_predicate (mk___t1 temp___1503 temp___15031))))
(check-sat)
(exit)
