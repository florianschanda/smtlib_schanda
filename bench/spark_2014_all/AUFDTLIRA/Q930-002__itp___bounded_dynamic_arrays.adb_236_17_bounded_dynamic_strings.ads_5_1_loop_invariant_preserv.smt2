...
(assert (not (= k2 temp___1299)))
(assert (= k2 result3))
(assert (= k3 (+ k2 1)))
(assert (and (= o9 (length fragment)) (in_range1 (length fragment))))
(assert (= o10 (+ k3 o9)))
(assert (= temp___13001 (- o10 1)))
(assert (=> (<= k3 temp___13001) (and (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k3) (<= k3 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))) (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) temp___13001) (<= temp___13001 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))))))
(assert (= o11 (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within)))))
(assert (= o11 temp___13022))
(assert (= (mk3 k3 temp___13001) temp___13023))
(assert (= result4 (bool_eq temp___13022 (to_rep1 (first6 temp___13023)) (to_rep1 (last6 temp___13023)) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment))))))
