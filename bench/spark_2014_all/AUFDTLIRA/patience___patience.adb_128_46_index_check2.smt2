...
(assert (= o112 i1))
(assert (= o113 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o112)))
(assert (= o114 (to_rep o113)))
(assert (= o115 (ite (<= o114 (- (to_rep (rec__patience__state__numelts (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o109 i1))
(assert (= o110 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o109)))
(assert (= o111 (to_rep o110)))
(assert (= o116 (ite (<= (- 1) o111) true false)))
(assert (= result27 (ite (= o116 true) o115 false)))
(assert (=> (= result27 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result27 true) (= o106 i1)))
(assert (=> (= result27 true) (= o107 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o106))))
(assert (=> (= result27 true) (= o108 (to_rep o107))))
(assert (=> (= result27 true) (= result26 (ite (< o108 i1) true false))))
...
(assert (= result28 (ite (< o105 0) true false)))
