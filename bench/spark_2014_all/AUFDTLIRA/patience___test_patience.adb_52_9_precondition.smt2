...
(assert (=> (and (<= (to_rep1 input__first) i1) (<= i1 (to_rep1 input__last))) (= o16 (to_rep3 o15))))
(assert (=> (and (<= (to_rep1 input__first) i1) (<= i1 (to_rep1 input__last))) (= o17 (attr__ATTRIBUTE_IMAGE5 o16))))
(assert (=> (and (<= (to_rep1 input__first) i1) (<= i1 (to_rep1 input__last))) (= (mk___t temp___853 temp___8531) (to_string o17))))
(assert (=> (and (<= (to_rep1 input__first) i1) (<= i1 (to_rep1 input__last))) (=> (<= (to_rep1 (first temp___8531)) (to_rep1 (last temp___8531))) (= o18 (+ (- (to_rep1 (last temp___8531)) (to_rep1 (first temp___8531))) 1)))))
(assert (=> (and (<= (to_rep1 input__first) i1) (<= i1 (to_rep1 input__last))) (=> (not (<= (to_rep1 (first temp___8531)) (to_rep1 (last temp___8531)))) (= o18 0))))
...
(assert (=> (and (<= (to_rep1 input__first) i1) (<= i1 (to_rep1 input__last))) (= o24 (concat1 (temp___String_Literal_851 Tuple0) 1 1 temp___853 (to_rep1 (first temp___8531)) (to_rep1 (last temp___8531))))))
...
(assert (not (<= (length1 (mk___t1 input1 (mk1 (to_rep1 input__first) (to_rep1 input__last)))) 100)))
(check-sat)
(exit)
