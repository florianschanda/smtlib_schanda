...
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1579)) (forall ((i1 Int)) (=> (and (<= (to_rep1 (first (rt source))) i1) (<= i1 index2)) (and (<= 0 (to_rep1 (select n3 i1))) (<= (to_rep1 (select n3 i1)) 9))))))
