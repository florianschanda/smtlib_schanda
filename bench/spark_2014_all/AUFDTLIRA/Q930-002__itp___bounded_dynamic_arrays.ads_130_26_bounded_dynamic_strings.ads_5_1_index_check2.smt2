...
(assert (and (= o8 (length1 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (and (in_range2 o8) (= o8 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content to____split_fields5)))))))
(assert (= o9 (ite (= o8 1) true false)))
(assert (and (= temp___11492 (value (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (and (dynamic_invariant2 temp___11492 true false true true) (and (and (= (elts (rec__bounded_dynamic_strings__sequence__content (us_split_fields__content to____split_fields5))) temp___1149) (= (mk1 (to_rep2 (first4 (mk2 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content to____split_fields5)))))) (to_rep2 (last4 (mk2 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content to____split_fields5))))))) temp___11491)) (and (and (and (= (length2 temp___11492) (length1 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (= (to_rep2 (first2 temp___11491)) 1)) (= (to_rep2 (last2 temp___11491)) (length1 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))))) (= (< 0 (length1 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (not (= (empty (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))) true))))))))
(assert (not (<= (to_rep2 (first2 temp___11491)) 1)))
(check-sat)
(exit)
