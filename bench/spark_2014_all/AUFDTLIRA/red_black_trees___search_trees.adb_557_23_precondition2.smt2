...
(declare-const temp___1833 (Array Int us_rep1))
...
(assert (= o13 (select temp___1834 i)))
...
(assert (and (= temp___1833 (model__ f1 root)) (and (dynamic_invariant3 temp___1833 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1833 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1833 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f1 i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1833 (parent f1 i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1833 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1833 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1833 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1833 (parent f1 i1)))) (position f1 i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1833 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1833 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1833 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1833 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1833 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1833 j1)))) true)) (= j1 i1))))))))))))))
(assert (= o10 (select temp___1833 j)))
