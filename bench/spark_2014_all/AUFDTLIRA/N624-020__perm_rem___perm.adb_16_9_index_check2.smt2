...
(define-fun o21 () us_t (mk___t o12 o13))
(define-fun o22 () us_t (mk___t o9 o10))
(define-fun o23 () us_t (mk___t o3 o4))
(define-fun o24 () us_t (mk___t o o1))
...
(assert (or (and (and (and (= perm__get_witness__result2 perm__get_witness__result5) (= ib1 ib4)) (and (= perm__get_witness__result6 perm__get_witness__result2) (= ib5 ib1))) (and (and (and (and (and (and (and (<= (to_rep1 (first (rt a))) ia) (<= ia (to_rep1 (last (rt a))))) (= o5 ia)) (= o6 (select (elts a) o5))) (= o7 (to_rep o6))) (= result2 (ite (= o7 (to_rep (select (elts b) ib1))) true false))) (ite (= result2 true) (and (and (and (= o2 ib1) (in_range3 ib1)) (and (= o23 (remove b o2)) (and (dynamic_invariant o23 true false true true) (and (= (invariant__ o23) true) (and (= (to_rep1 (last o4)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o2 1))) (= (to_rep (select (elts b) k)) (to_rep (select o3 k))))) (and (forall ((k Int)) (=> (and (<= (+ o2 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o3 (- k 1)))))) (forall ((k Int)) (=> (and (<= o2 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o3 k)))))))))))) (and (and (= o24 (remove a ia)) (and (dynamic_invariant o24 true false true true) (and (= (invariant__ o24) true) (and (= (to_rep1 (last o1)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o k))))))))))) (and (= result1 (is_perm o24 o23)) (= (= result1 true) (or (and (= (length o24) 0) (= (length o23) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first o1)) ia1) (<= ia1 (to_rep1 (last o1)))) (exists ((ib10 Int)) (and (and (<= (to_rep1 (first o4)) ib10) (<= ib10 (to_rep1 (last o4)))) (and (= (to_rep (select o ia1)) (to_rep (select o3 ib10))) (= (is_perm (remove o24 ia1) (remove o23 ib10)) true))))))))))) (= result1 false))) (and (= result1 true) (and (and (= o8 ib1) (in_range3 ib1)) (and (= (mk_int__ref result3) (mk_int__ref perm__get_witness__result)) (= perm__get_witness__result2 o8)))))) (and (and (and (and (and (and (and (and (<= (to_rep1 (first (rt a))) ia) (<= ia (to_rep1 (last (rt a))))) (= o5 ia)) (= o6 (select (elts a) o5))) (= o7 (to_rep o6))) (= result2 (ite (= o7 (to_rep (select (elts b) ib1))) true false))) (ite (= result2 true) (and (and (and (= o2 ib1) (in_range3 ib1)) (and (= o23 (remove b o2)) (and (dynamic_invariant o23 true false true true) (and (= (invariant__ o23) true) (and (= (to_rep1 (last o4)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o2 1))) (= (to_rep (select (elts b) k)) (to_rep (select o3 k))))) (and (forall ((k Int)) (=> (and (<= (+ o2 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o3 (- k 1)))))) (forall ((k Int)) (=> (and (<= o2 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o3 k)))))))))))) (and (and (= o24 (remove a ia)) (and (dynamic_invariant o24 true false true true) (and (= (invariant__ o24) true) (and (= (to_rep1 (last o1)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o k))))))))))) (and (= result1 (is_perm o24 o23)) (= (= result1 true) (or (and (= (length o24) 0) (= (length o23) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first o1)) ia1) (<= ia1 (to_rep1 (last o1)))) (exists ((ib10 Int)) (and (and (<= (to_rep1 (first o4)) ib10) (<= ib10 (to_rep1 (last o4)))) (and (= (to_rep (select o ia1)) (to_rep (select o3 ib10))) (= (is_perm (remove o24 ia1) (remove o23 ib10)) true))))))))))) (= result1 false))) (and (not (= result1 true)) (and (= perm__get_witness__result2 perm__get_witness__result) (= perm__get_witness__result2 perm__get_witness__result1)))) (and (and (and (= perm__get_witness__result4 perm__get_witness__result5) (= ib3 ib4)) (and (= perm__get_witness__result6 perm__get_witness__result4) (= ib5 ib3))) (and (forall ((kb Int)) (=> (and (<= 1 kb) (<= kb ib2)) (not (and (= (to_rep (select (elts a) ia)) (to_rep (select (elts b) kb))) (= (is_perm (remove a ia) (remove b kb)) true))))) (and (and (=> (<= (to_rep1 (first (rt b))) (to_rep1 (last (rt b)))) (dynamic_property1 (to_rep1 (first (rt b))) (to_rep1 (last (rt b))) ib2)) (and (<= (to_rep1 (first (rt b))) ib2) (<= ib2 (to_rep1 (last (rt b)))))) (and (not (= ib2 temp___648)) (and (and (= ib2 result4) (= ib3 (+ ib2 1))) (and (and (and (and (and (and (and (<= (to_rep1 (first (rt a))) ia) (<= ia (to_rep1 (last (rt a))))) (= o14 ia)) (= o15 (select (elts a) o14))) (= o16 (to_rep o15))) (= result6 (ite (= o16 (to_rep (select (elts b) ib3))) true false))) (ite (= result6 true) (and (and (and (= o11 ib3) (in_range3 ib3)) (and (= o21 (remove b o11)) (and (dynamic_invariant o21 true false true true) (and (= (invariant__ o21) true) (and (= (to_rep1 (last o13)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o11 1))) (= (to_rep (select (elts b) k)) (to_rep (select o12 k))))) (and (forall ((k Int)) (=> (and (<= (+ o11 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o12 (- k 1)))))) (forall ((k Int)) (=> (and (<= o11 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o12 k)))))))))))) (and (and (= o22 (remove a ia)) (and (dynamic_invariant o22 true false true true) (and (= (invariant__ o22) true) (and (= (to_rep1 (last o10)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o9 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o9 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o9 k))))))))))) (and (= result5 (is_perm o22 o21)) (= (= result5 true) (or (and (= (length o22) 0) (= (length o21) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first o10)) ia1) (<= ia1 (to_rep1 (last o10)))) (exists ((ib10 Int)) (and (and (<= (to_rep1 (first o13)) ib10) (<= ib10 (to_rep1 (last o13)))) (and (= (to_rep (select o9 ia1)) (to_rep (select o12 ib10))) (= (is_perm (remove o22 ia1) (remove o21 ib10)) true))))))))))) (= result5 false))) (and (= result5 true) (and (and (= o17 ib3) (in_range3 ib3)) (and (= perm__get_witness__result3 result7) (= perm__get_witness__result4 o17)))))))))))))
...
(assert (= o18 (int__content perm__get_witness__result9)))
