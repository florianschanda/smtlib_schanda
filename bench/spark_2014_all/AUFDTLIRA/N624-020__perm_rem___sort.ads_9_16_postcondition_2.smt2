...
(declare-const o Int)
(declare-const temp___234 (Array Int natural))
(declare-const temp___233 Int)
(declare-const temp___232 Int)
(declare-const temp___231 (Array Int natural))
(declare-const temp___230 Int)
(declare-const temp___229 (Array Int natural))
...
(declare-const prec4 map__ref)
(declare-const hr4 int__ref)
...
(assert (= current1 1))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___234 values)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___233 current1)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___232 smallest)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___231 values)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___230 hr1)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= temp___229 prec1)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (and (= o1 (index_of_minimum values current1 100)) (and (in_range1 o1) (and (<= current1 o1) (<= o1 100))))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= (mk_int__ref result3) smallest10)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= smallest2 o1)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (=> (not (= smallest2 current1)) (= prec1 result4))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (=> (not (= smallest2 current1)) (= prec2 values))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (=> (not (= smallest2 current1)) (= (is_perm (mk___t values (mk 1 100)) (mk___t values2 (mk 1 100))) true))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (=> (not (= smallest2 current1)) (and (= o2 (perm_transitive (mk___t init (mk 1 100)) (mk___t prec2 (mk 1 100)) (mk___t values2 (mk 1 100)))) (and (in_range5 o2) (=> (= (distinct o2 0) true) (= (is_perm (mk___t init (mk 1 100)) (mk___t values2 (mk 1 100))) true)))))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (=> (not (= smallest2 current1)) (= hr1 result5))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (=> (not (= smallest2 current1)) (= hr2 o2))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (=> (not (not (= smallest2 current1))) (= hr2 hr1))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (=> (not (not (= smallest2 current1))) (= prec2 prec1))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (=> (not (not (= smallest2 current1))) (= values2 values))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (=> (not (not (= smallest2 current1))) (= hr2 hr1))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (=> (not (not (= smallest2 current1))) (= prec2 prec1))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (=> (not (not (= smallest2 current1))) (= values2 values1))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= (is_perm (mk___t temp___234 (mk 1 100)) (mk___t values3 (mk 1 100))) true)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (and (and (and (=> (<= 1 1) (in_range5 hr3)) (=> (<= 1 2147483647) (in_range1 smallest3))) (=> (<= 1 99) (in_range7 current2))) (and (<= 1 current2) (<= current2 99)))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= current2 99)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= current3 (mk_int__ref current2))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= hr4 (mk_int__ref hr3))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= prec4 (mk_map__ref prec3))))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= smallest4 (mk_int__ref smallest3))))
...
(assert (=> (and (<= 1 current1) (<= current1 99)) (= smallest5 smallest3)))
...
(assert (=> (and (<= 1 current1) (<= current1 99)) (= smallest6 smallest4)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= values6 (mk_map__ref values4))))
...
(assert (=> (and (<= 1 current1) (<= current1 99)) (= smallest7 smallest5)))
(assert (=> (and (<= 1 current1) (<= current1 99)) (= values7 values5)))
(assert (=> (not (and (<= 1 current1) (<= current1 99))) (= current5 (mk_int__ref current1))))
(assert (=> (not (and (<= 1 current1) (<= current1 99))) (= hr6 (mk_int__ref hr1))))
(assert (=> (not (and (<= 1 current1) (<= current1 99))) (= prec6 (mk_map__ref prec1))))
(assert (=> (not (and (<= 1 current1) (<= current1 99))) (= smallest6 smallest10)))
(assert (=> (not (and (<= 1 current1) (<= current1 99))) (= values6 (mk_map__ref values))))
(assert (=> (not (and (<= 1 current1) (<= current1 99))) (= current6 current1)))
(assert (=> (not (and (<= 1 current1) (<= current1 99))) (= hr7 hr1)))
(assert (=> (not (and (<= 1 current1) (<= current1 99))) (= prec7 prec1)))
(assert (=> (not (and (<= 1 current1) (<= current1 99))) (= smallest7 smallest1)))
(assert (=> (not (and (<= 1 current1) (<= current1 99))) (= values7 values1)))
...
(assert (not (= (is_perm (mk___t values (mk 1 100)) (mk___t (map__content values8) (mk 1 100))) true)))
(check-sat)
(exit)
