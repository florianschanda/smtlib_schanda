...
(assert (<= 1 i1))
(assert (<= i1 r7b))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (to_rep2 (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields2)) j)) (+ (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j)) (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 b))) j)))))))
...
(assert (and (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 b))))) i2) (<= i2 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 b))))))))
(assert (= o i2))
(assert (= o1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 b))) o)))
(assert (= o2 (to_rep2 o1)))
(assert (not (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2)))
(check-sat)
(exit)
