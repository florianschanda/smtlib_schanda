...
(assert (=> (= result7 true) (= o17 (to_rep o16))))
(assert (=> (= result7 true) (= result6 (ite (< o17 (to_rep s__split_fields2)) true false))))
...
(assert (=> (= result6 true) (= o14 (to_rep o13))))
...
(assert (= temp___574 (to_rep o11)))
(assert (not (<= temp___574 99)))
(check-sat)
(exit)
