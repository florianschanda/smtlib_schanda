...
(assert (=> (= result12 true) (and (= o61 (get (rec__list_allocator__m__t__available model____split_fields3) o60)) (in_range4 o61))))
(assert (=> (not (= result12 true)) (= o61 0)))
(assert (and (= temp___460 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 temp___460)))
(assert (not (<= 1 temp___460)))
(check-sat)
(exit)
