...
(assert (and (= k1 l) (forall ((x Int)) (=> (and (<= l x) (<= x l)) (<= (to_rep (select arr k1)) (to_rep (select arr x)))))))
...
(assert (=> (< l u) (=> (and (<= (+ l 1) i2) (<= i2 u)) (and (and (and (and (and (and (<= (+ l 1) i3) (<= i3 u)) (= l temp___215)) (= u temp___216)) (< l u)) (forall ((x Int)) (=> (and (<= l x) (<= x i3)) (<= (to_rep (select arr k3)) (to_rep (select arr x)))))) (and (<= l k3) (<= k3 u))))))
...
(assert (= i11 i9))
(assert (= k11 k9))
(assert (= result3 t3q5__sort__find_smallest__result4))
(assert (not (<= l t3q5__sort__find_smallest__result4)))
(check-sat)
(exit)
