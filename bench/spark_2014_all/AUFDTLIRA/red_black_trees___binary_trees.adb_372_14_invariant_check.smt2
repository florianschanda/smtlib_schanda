...
(assert (=> (and (<= 1 n1) (<= n1 100)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) i1))) true) (forall ((d Int)) (=> (and (<= 0 d) (<= d 1)) (=> (= (peek f i1 d) 0) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) j))) true) (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i1))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j)))) true)) (<= (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i1)))) n2))) (not (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i1)))) 1)) d)))))))))))))
