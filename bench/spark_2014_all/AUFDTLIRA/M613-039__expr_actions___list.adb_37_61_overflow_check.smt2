...
(assert (and (= o8 (- last3 i9)) (in_range1 (- last3 i9))))
(assert (and (= o7 (to__ (mk___rep s__split_fields10))) (dynamic_invariant1 o7 true false true true)))
(assert (= o9 (to_rep (last (rt o7)))))
(assert (= result4 (ite (= o9 o8) true false)))
(assert (=> (= result4 true) (and (= temp___518 (- last3 i9)) (in_range1 (- last3 i9)))))
(assert (=> (= result4 true) (=> (<= first2 temp___518) (and (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) first2) (<= first2 (to_rep (last (rt list__reverse_list__L_2__R20b))))) (and (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) temp___518) (<= temp___518 (to_rep (last (rt list__reverse_list__L_2__R20b)))))))))
(assert (=> (= result4 true) (= o5 (elts list__reverse_list__L_2__R20b))))
(assert (=> (= result4 true) (= temp___520 (mk___t2 o5 (mk2 first2 temp___518)))))
(assert (=> (= result4 true) (and (= temp___517 (- last3 i9)) (in_range1 (- last3 i9)))))
(assert (=> (= result4 true) (=> (<= first2 temp___517) (and (and (<= (to_rep (first (rt list__reverse_list__L_2__R16b))) first2) (<= first2 (to_rep (last (rt list__reverse_list__L_2__R16b))))) (and (<= (to_rep (first (rt list__reverse_list__L_2__R16b))) temp___517) (<= temp___517 (to_rep (last (rt list__reverse_list__L_2__R16b)))))))))
(assert (=> (= result4 true) (= o6 (elts list__reverse_list__L_2__R16b))))
(assert (=> (= result4 true) (= temp___519 (mk___t1 o6 (mk1 first2 temp___517)))))
(assert (=> (= result4 true) (= result3 (bool_eq (elts1 temp___519) (to_rep (first3 (rt1 temp___519))) (to_rep (last4 (rt1 temp___519))) (elts2 temp___520) (to_rep (first5 (rt2 temp___520))) (to_rep (last6 (rt2 temp___520)))))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (= result3 true))
(assert (<= first2 j))
(assert (<= j i9))
(assert (and (= o3 (last2 (model__ l))) (and (in_range5 o3) (= o3 (last2 (model__ l))))))
(assert (= o4 (- o3 j)))
