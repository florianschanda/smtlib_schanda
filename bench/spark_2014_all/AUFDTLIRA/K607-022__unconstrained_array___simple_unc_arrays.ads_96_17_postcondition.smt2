...
(assert (not (exists ((k Int)) (and (and (<= 1 k) (<= k (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)))) (= (to_rep2 (select a__split_fields j)) (to_rep2 (select a__split_fields4 k)))))))
(check-sat)
(exit)
