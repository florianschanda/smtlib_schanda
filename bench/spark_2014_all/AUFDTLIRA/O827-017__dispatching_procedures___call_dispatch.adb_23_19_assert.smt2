...
(assert (not (= (to_rep (rec__dispatch__root__i (let ((subject v2__split_fields)) v2__split_fields2))) (to_rep (rec__dispatch__root__i (let ((subject v1__split_fields)) v1__split_fields1))))))
(check-sat)
(exit)
