...
(assert (and (= o33 (remove (mk___t values2 (mk 1 100)) o27)) (and (dynamic_invariant3 o33 true false true true) (and (= (invariant__ o33) true) (and (= (to_rep1 (last o29)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o27 1))) (= (to_rep (select values2 k)) (to_rep (select o28 k))))) (and (forall ((k Int)) (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select o28 (- k 1)))))) (forall ((k Int)) (=> (and (<= o27 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select o28 k))))))))))))
(assert (and (= temp___280 (remove o33 o30)) (and (dynamic_invariant3 temp___280 true false true true) (and (= (invariant__ temp___280) true) (and (= (to_rep1 (last (rt temp___280))) (- (to_rep1 (last o29)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o30 1))) (= (to_rep (select o28 k)) (to_rep (select (elts temp___280) k))))) (and (forall ((k Int)) (=> (and (<= (+ o30 1) k) (<= k (to_rep1 (last o29)))) (= (to_rep (select o28 k)) (to_rep (select (elts temp___280) (- k 1)))))) (forall ((k Int)) (=> (and (<= o30 k) (<= k (- (to_rep1 (last o29)) 1))) (= (to_rep (select o28 (+ k 1))) (to_rep (select (elts temp___280) k))))))))))))
(assert (and (= o32 y) (in_range4 y)))
(assert (and (= o31 x) (in_range4 x)))
(assert (not (<= (to_rep1 (first (mk 1 100))) o31)))
(check-sat)
(exit)
