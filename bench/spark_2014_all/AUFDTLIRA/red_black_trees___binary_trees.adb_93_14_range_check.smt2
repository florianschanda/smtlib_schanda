...
(define-fun dynamic_invariant3 ((temp___expr_196 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool) (temp___do_typ_inv_195 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 1)) (in_range3 temp___expr_196)))
(assert (in_range2 i))
(assert (= (tree_structure f) true))
(assert (not (= (parent f i) 0)))
(assert (not (in_range3 (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i)))))))
(check-sat)
(exit)
