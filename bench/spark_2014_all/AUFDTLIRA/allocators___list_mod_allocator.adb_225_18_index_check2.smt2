...
(assert (<= 1 r1))
(assert (<= r1 10000))
(assert (=> (< r1 10000) (and (= o6 (+ r1 1)) (in_range2 (+ r1 1)))))
(assert (=> (< r1 10000) (= (to_rep o7) o6)))
(assert (=> (< r1 10000) (= (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data1 r1))) o8)))
...
(assert (=> (< r1 10000) (= result3 (mk_map__ref data1))))
(assert (=> (< r1 10000) (= data2 o12)))
(assert (=> (not (< r1 10000)) (= data2 data1)))
(assert (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data3 rr1)))) (ite (= rr1 10000) 0 (+ rr1 1))))))
(assert (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data3 10000)))) 0))
(assert (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 10000)) (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data3 rr1)))) 0))))
(assert (and (and (forall ((temp___297 Int)) (=> (and (<= 1 temp___297) (<= temp___297 10000)) (ite (or (< 10000 temp___297) (or (< temp___297 1) (< r2 temp___297))) (= (select data3 temp___297) (select data1 temp___297)) (= (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data3 temp___297))) (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data1 temp___297))))))) (=> (<= 1 10000) (in_range8 r2))) (and (<= 1 r2) (<= r2 10000))))
(assert (<= 1 rr))
(assert (<= rr r2))
(assert (=> (= rr 10000) (= o13 0)))
(assert (=> (not (= rr 10000)) (and (= o13 (+ rr 1)) (in_range7 (+ rr 1)))))
(assert (not (<= 1 rr)))
(check-sat)
(exit)
