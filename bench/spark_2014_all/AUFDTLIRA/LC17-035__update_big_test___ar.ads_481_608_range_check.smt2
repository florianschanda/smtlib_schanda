...
(declare-const temp___5431 (Array Int (Array Int (Array Int et1))))
...
(assert (= a4 a2))
(assert (=> (< k 16) (=> (< 0 e) (and (= o15 (- e 1)) (in_range3 (- e 1))))))
(assert (=> (< k 16) (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))))
(assert (=> (< k 16) (=> (< 0 e) (= o14 (+ k 1)))))
(assert (=> (< k 16) (=> (< 0 e) (= temp___5420 (select a o14)))))
(assert (=> (< k 16) (=> (< 0 e) (= o16 (select temp___5420 j)))))
(assert (=> (< k 16) (=> (< 0 e) (= o17 (temp_____aggregate_def_1734 o16 i o15)))))
(assert (=> (< k 16) (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))))
(assert (=> (< k 16) (=> (< 0 e) (= o13 (+ k 1)))))
(assert (=> (< k 16) (=> (< 0 e) (= o18 (select a o13)))))
(assert (=> (< k 16) (=> (< 0 e) (= o19 (temp_____aggregate_def_1727 o18 j o17)))))
(assert (=> (< k 16) (=> (< 0 e) (and (= o20 (+ k 1)) (in_range2 (+ k 1))))))
(assert (=> (< k 16) (=> (< 0 e) (= temp___5421 (temp_____aggregate_def_1704 a k (temp_____aggregate_def_1712 (select a k) j (temp_____aggregate_def_1719 (select (select a k) j) i e)) o20 o19)))))
(assert (=> (< k 16) (=> (< 0 e) (= result6 (bool_eq2 a3 1 16 temp___5421 1 16)))))
(assert (=> (< k 16) (=> (not (< 0 e)) (= result6 false))))
(assert (=> (< k 16) (=> (= result6 true) (= result5 true))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= o7 (+ k 1))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= temp___5430 (select a o7))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= o8 (select temp___5430 j))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= o9 (temp_____aggregate_def_1773 o8 i 99))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= o6 (+ k 1))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= o10 (select a o6))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= o11 (temp_____aggregate_def_1766 o10 j o9))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (and (= o12 (+ k 1)) (in_range2 (+ k 1)))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= temp___5431 (temp_____aggregate_def_1743 a k (temp_____aggregate_def_1751 (select a k) j (temp_____aggregate_def_1758 (select (select a k) j) i e)) o12 o11))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= result5 (bool_eq2 a3 1 16 temp___5431 1 16))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (not (= e 0)) (= result5 false)))))
