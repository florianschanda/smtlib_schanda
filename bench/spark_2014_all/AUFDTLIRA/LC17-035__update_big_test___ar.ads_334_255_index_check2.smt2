...
(assert (= a4 a2))
(assert (< j 50))
(assert (=> (< 0 e) (and (= o6 (- e 1)) (in_range2 (- e 1)))))
(assert (=> (< 0 e) (and (<= 5 (+ j 1)) (<= (+ j 1) 50))))
(assert (=> (< 0 e) (= o5 (+ j 1))))
(assert (=> (< 0 e) (= o7 (select a o5))))
(assert (=> (< 0 e) (= o8 (temp_____aggregate_def_1041 o7 i o6))))
(assert (=> (< 0 e) (and (= o9 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (< 0 e) (= temp___4721 (temp_____aggregate_def_1026 a j (temp_____aggregate_def_1034 (select a j) i e) o9 o8))))
(assert (=> (< 0 e) (= result5 (bool_eq1 a3 5 50 temp___4721 5 50))))
