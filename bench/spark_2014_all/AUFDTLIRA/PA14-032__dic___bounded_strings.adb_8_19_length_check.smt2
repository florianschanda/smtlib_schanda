...
(define-fun dynamic_invariant1 ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 0 65536)) (in_range3 temp___expr_167)))
(define-fun dynamic_invariant2 ((temp___expr_174 us_rep) (temp___is_init_170 Bool) (temp___skip_constant_171 Bool) (temp___do_toplevel_172 Bool) (temp___do_typ_inv_173 Bool)) Bool (let ((temp___175 (rec__bounded_strings__bounded_string__bound (us_split_discrs1 temp___expr_174)))) (and (dynamic_property1 1 (to_rep1 temp___175) (first1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_174))) (last1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_174)))) (and (= (first1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_174))) 1) (= (last1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_174))) (to_rep1 temp___175))))))
...
(define-fun dynamic_invariant3 ((temp___expr_160 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 1 65536)) (in_range2 temp___expr_160)))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___155 (rec__bounded_strings__bounded_string__text1 (us_split_fields3 a)))) (of_array (to_array2 temp___155) (first5 temp___155) (last5 temp___155))) (rec__bounded_strings__bounded_string__length1 (us_split_fields3 a)))))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___154 (rec__bounded_strings__bounded_string__text (us_split_fields1 r)))) (of_array2 (to_array temp___154) (first1 temp___154) (last1 temp___154))) (rec__bounded_strings__bounded_string__length (us_split_fields1 r)))))
...
(define-fun default_initial_assumption ((temp___expr_192 us_rep1) (temp___skip_top_level_193 Bool)) Bool (and (and (and (= (to_rep1 (rec__bounded_strings__bounded_string__bound (us_split_discrs2 temp___expr_192))) upper_bound) (= (rec__bounded_strings__bounded_string__text1 (us_split_fields3 temp___expr_192)) (let ((temp___201 (temp_____aggregate_def_195 32 1 (to_rep1 (rec__bounded_strings__bounded_string__bound (us_split_discrs2 temp___expr_192)))))) (of_array2 (to_array1 temp___201) (first3 temp___201) (last3 temp___201))))) (= (to_rep2 (rec__bounded_strings__bounded_string__length1 (us_split_fields3 temp___expr_192))) 0)) (=> (not (= temp___skip_top_level_193 true)) (= (length1 (to_base temp___expr_192)) 0))))
...
(assert (forall ((temp___221 Int) (temp___222 Int) (temp___223 Int)) (let ((temp___220 (temp_____aggregate_def_219 temp___221 temp___222 temp___223))) (=> (dynamic_invariant temp___221 true true true true) (and (=> (dynamic_property8 1 2147483647 temp___222 temp___223) (and (= (first7 temp___220) temp___222) (= (last7 temp___220) temp___223))) (forall ((temp___224 Int)) (= (to_rep (select (to_array3 temp___220) temp___224)) temp___221)))))))
(assert (forall ((temp___197 Int) (temp___198 Int) (temp___199 Int)) (let ((temp___196 (temp_____aggregate_def_195 temp___197 temp___198 temp___199))) (=> (dynamic_invariant temp___197 true true true true) (and (=> (dynamic_property8 1 2147483647 temp___198 temp___199) (and (= (first3 temp___196) temp___198) (= (last3 temp___196) temp___199))) (forall ((temp___200 Int)) (= (to_rep (select (to_array1 temp___196) temp___200)) temp___197)))))))
...
(assert (= (to_rep3 (first6 (rt3 (temp_____aggregate_def_219 32 1 upper_bound)))) 1))
(assert (= (to_rep3 (last6 (rt3 (temp_____aggregate_def_219 32 1 upper_bound)))) upper_bound))
(assert (= (mk___t3 temp___226 temp___2261) (temp_____aggregate_def_219 32 1 upper_bound)))
...
(assert (not (= (ite (<= (to_rep3 (first4 temp___2271)) (to_rep3 (last4 temp___2271))) (+ (- (to_rep3 (last4 temp___2271)) (to_rep3 (first4 temp___2271))) 1) 0) (ite (<= (to_rep3 (first4 result____split_fields1)) (to_rep3 (last4 result____split_fields1))) (+ (- (to_rep3 (last4 result____split_fields1)) (to_rep3 (first4 result____split_fields1))) 1) 0))))
(check-sat)
(exit)
