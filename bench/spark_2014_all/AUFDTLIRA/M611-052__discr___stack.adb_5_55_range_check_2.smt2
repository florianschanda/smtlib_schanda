...
(declare-const temp___2661 t2)
(assert (dynamic_invariant s true false true true))
(assert (=> (<= 1 (- (to_rep1 (rec__stack__stack__top (us_split_fields1 s))) 1)) (and (and (<= (to_rep (first2 (rt1 (rec__stack__stack__content (us_split_fields1 s))))) 1) (<= 1 (to_rep (last2 (rt1 (rec__stack__stack__content (us_split_fields1 s))))))) (and (<= (to_rep (first2 (rt1 (rec__stack__stack__content (us_split_fields1 s))))) (- (to_rep1 (rec__stack__stack__top (us_split_fields1 s))) 1)) (<= (- (to_rep1 (rec__stack__stack__top (us_split_fields1 s))) 1) (to_rep (last2 (rt1 (rec__stack__stack__content (us_split_fields1 s))))))))))
(assert (= o (elts1 (rec__stack__stack__content (us_split_fields1 s)))))
(assert (= o temp___266))
(assert (= (mk2 1 (- (to_rep1 (rec__stack__stack__top (us_split_fields1 s))) 1)) temp___2661))
(assert (not (dynamic_property 1 2147483647 (to_rep (first4 temp___2661)) (to_rep (last4 temp___2661)))))
(check-sat)
(exit)
