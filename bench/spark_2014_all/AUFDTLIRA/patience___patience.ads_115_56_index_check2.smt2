...
(assert (= o23 (ite (<= o22 (- (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o17 i))
...
(assert (=> (= result9 true) (= o5 (to_rep o4))))
