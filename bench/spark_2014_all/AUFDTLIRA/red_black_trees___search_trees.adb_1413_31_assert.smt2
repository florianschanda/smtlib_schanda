...
(assert (= i4 0))
(assert (exists ((i5 Int)) (and (and (<= 1 i5) (<= i5 100)) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__1 (mk___rep3 t__split_fields5)) i5))) true) (= (to_rep (select (rec__search_trees__search_tree__values t__split_fields5) i5)) v)))))
(assert (not (= (contains1 (mk___rep3 t__split_fields5) v) true)))
(check-sat)
(exit)
