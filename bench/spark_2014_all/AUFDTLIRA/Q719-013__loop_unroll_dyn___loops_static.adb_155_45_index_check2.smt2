...
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= temp___400 bad1))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (and (<= (to_rep1 a__first) j4) (<= j4 i1)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (and (<= (to_rep1 a__first) j4) (<= j4 (to_rep1 a__last))))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= o2 j4))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= o3 (select a1 o2)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= o4 (to_rep o3)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= o5 (ite (= o4 0) true false)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= result5 (ite (not (= o5 true)) true false)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (=> (= result5 true) (= bad3 result6)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (=> (= result5 true) (= bad4 (distinct 1 0))))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (=> (not (= result5 true)) (= bad4 bad3)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= j4 i1))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= j4 j5))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= bad4 bad5))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= j6 j4))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= bad6 bad4))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= j12 (mk_int__ref j5)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= bad11 (mk_bool__ref bad5)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= j8 j6))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= bad8 bad6))))
(assert (=> (not (= i1 1)) (=> (not (and (<= (to_rep1 a__first) j3) (<= j3 i1))) (= j3 j7))))
(assert (=> (not (= i1 1)) (=> (not (and (<= (to_rep1 a__first) j3) (<= j3 i1))) (= bad1 bad7))))
(assert (=> (not (= i1 1)) (=> (not (and (<= (to_rep1 a__first) j3) (<= j3 i1))) (= j8 j3))))
(assert (=> (not (= i1 1)) (=> (not (and (<= (to_rep1 a__first) j3) (<= j3 i1))) (= bad8 bad1))))
