...
(assert (=> (and (<= (to_rep inventory__first) i1) (<= i1 (to_rep inventory__last))) (= temp___512 inventory)))
(assert (=> (and (<= (to_rep inventory__first) i1) (<= i1 (to_rep inventory__last))) (and (forall ((temp___513 Int)) (=> (and (<= (to_rep inventory__first) temp___513) (<= temp___513 (to_rep inventory__last))) (=> (or (< (to_rep inventory__last) temp___513) (or (< temp___513 (to_rep inventory__first)) (<= i2 temp___513))) (= (select inventory2 temp___513) (select temp___512 temp___513))))) (and (<= (to_rep inventory__first) i2) (<= i2 (to_rep inventory__last))))))
