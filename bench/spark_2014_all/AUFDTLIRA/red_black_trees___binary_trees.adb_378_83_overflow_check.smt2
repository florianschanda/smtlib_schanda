...
(declare-const temp___1213 (Array Int us_rep3))
...
(assert (= result3 true))
(assert (= (tree_structure f) true))
(assert (and (= temp___1213 (model__ f root)) (and (dynamic_invariant6 temp___1213 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1213 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1213 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1213 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1213 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1213 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1213 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1213 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1213 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1213 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1213 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1213 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1213 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1213 j1)))) true)) (= j1 i1))))))))))))))
(assert (= o11 (select temp___1213 i)))
(assert (= o12 (us_split_fields5 o11)))
(assert (= o13 (rec__tree_model__path_type__a o12)))
(assert (and (= o14 (length o13)) (and (in_range1 o14) (<= (+ 0 o14) 2147483647))))
(assert (= o15 (+ o14 1)))
(assert (not (in_range8 o15)))
(check-sat)
(exit)
