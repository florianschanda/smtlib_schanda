...
(assert (=> (=> (not (< (length name) 1)) (< 255 (length name))) (= i11 i17)))
...
(assert (=> (=> (not (< (length name) 1)) (< 255 (length name))) (= i12 i2)))
...
(assert (=> (=> (not (< (length name) 1)) (< 255 (length name))) (= names__is_domain_name__result2 (distinct 0 0))))
...
(assert (=> (not (=> (not (< (length name) 1)) (< 255 (length name)))) (= i12 i10)))
...
(assert (and (<= (to_rep1 (first (rt name))) i1) (<= i1 (to_rep1 (last (rt name))))))
(assert (= o16 i1))
(assert (= o17 (select (elts name) o16)))
(assert (= o18 (to_rep o17)))
(assert (= o19 (ite (= o18 45) true false)))
(assert (and (<= (to_rep1 (first (rt name))) i1) (<= i1 (to_rep1 (last (rt name))))))
(assert (= o12 i1))
(assert (= o13 (select (elts name) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (is_digit o14)))
(assert (not (<= i1 (to_rep1 (last (rt name))))))
(check-sat)
(exit)
