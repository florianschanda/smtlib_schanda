...
(declare-const o7 us_split_fields10)
...
(assert (and (= o5 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0)) (and (in_range2 o5) (= o5 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j 0)))))
(assert (= o6 (select res3 o5)))
(assert (= o7 (us_split_fields11 o6)))
(assert (= o8 (rec__red_black_trees__black_count__count o7)))
(assert (= o9 (to_rep o8)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0) (= o10 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0)) (= o10 0)))
(assert (= o11 (+ o10 o9)))
(assert (and (= o12 o11) (in_range7 o11)))
(assert (= o13 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 j)))) o12) true false)))
(assert (and (= o (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 1)) (and (in_range2 o) (= o (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j 1)))))
