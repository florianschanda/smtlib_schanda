...
(assert (= a3 a1))
(assert (not (= (capacity (mk___rep2 p__split_discrs (us_split_fields__content2 p__split_fields2))) (capacity (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields))))))
(check-sat)
(exit)
