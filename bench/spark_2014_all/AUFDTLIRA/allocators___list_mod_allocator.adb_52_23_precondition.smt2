...
(assert (and (= o7 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o7) (<= (+ 0 o7) 2147483647))))
(assert (= result2 (ite (<= o7 10000) true false)))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (and (= o5 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o5) (<= (+ 0 o5) 2147483647))))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (= result3 (ite (< 0 o5) true false)))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (=> (= result3 true) (and (= o4 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) 1)) (in_range3 o4))))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (=> (= result3 true) (= result1 (ite (= o4 first_available) true false))))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (=> (not (= result3 true)) (= result1 false)))))
(assert (=> (= result2 true) (=> (not (not (= first_available 0))) (and (= o6 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o6) (<= (+ 0 o6) 2147483647))))))
(assert (=> (= result2 true) (=> (not (not (= first_available 0))) (= result1 (ite (= o6 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o2 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o2) (<= (+ 0 o2) 2147483647)))))
(assert (=> (= result1 true) (= o3 (ite (<= j1 o2) true false))))
(assert (=> (= result1 true) (= result4 (ite (<= 1 j1) o3 false))))
