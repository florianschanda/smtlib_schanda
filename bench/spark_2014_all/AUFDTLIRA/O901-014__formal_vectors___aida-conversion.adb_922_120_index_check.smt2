...
(assert (and (= (length source) 6) (forall ((index3 Int)) (=> (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index3))) true)))))
...
(assert (and (and (forall ((temp___1762 Int)) (=> (and (<= (to_rep1 n__first) temp___1762) (<= temp___1762 (to_rep1 n__last))) (=> (or (< temp___1759 temp___1762) (or (< temp___1762 (to_rep1 (first (rt source)))) (< index2 temp___1762))) (= (select n3 temp___1762) (select n1 temp___1762))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 5)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 5) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 5)))))
(assert (<= (to_rep1 (first (rt source))) j))
(assert (<= j index2))
(assert (not (<= j (to_rep1 (last (rt source))))))
(check-sat)
(exit)
