...
(assert (and (= o31 (remove (mk___t values2 (mk 1 100)) o27)) (and (dynamic_invariant3 o31 true false true true) (and (= (invariant__ o31) true) (and (= (to_rep1 (last o29)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o27 1))) (= (to_rep (select values2 k)) (to_rep (select o28 k))))) (and (forall ((k Int)) (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select o28 (- k 1)))))) (forall ((k Int)) (=> (and (<= o27 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select o28 k))))))))))))
(assert (not (<= (to_rep1 (first o29)) o30)))
(check-sat)
(exit)
