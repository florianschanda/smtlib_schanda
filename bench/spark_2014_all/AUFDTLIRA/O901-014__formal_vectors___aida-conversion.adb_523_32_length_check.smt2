...
(assert (not (= (ite (<= (to_rep1 (first8 temp___15341)) (to_rep1 (last8 temp___15341))) (+ (- (to_rep1 (last8 temp___15341)) (to_rep1 (first8 temp___15341))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0))))
(check-sat)
(exit)
