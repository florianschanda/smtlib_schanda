...
(assert (and (and (forall ((temp___660 Int)) (=> (and (<= (to_rep1 ret__first) temp___660) (<= temp___660 (to_rep1 ret__last))) (=> (or (< (to_rep1 (last (rt str))) temp___660) (or (< temp___660 (to_rep1 (first (rt str)))) (< idx2 temp___660))) (= (select ret4 temp___660) (select ret1 temp___660))))) (=> (<= (to_rep1 (first (rt str))) (to_rep1 (last (rt str)))) (dynamic_property3 (to_rep1 (first (rt str))) (to_rep1 (last (rt str))) idx2))) (and (<= (to_rep1 (first (rt str))) idx2) (<= idx2 (to_rep1 (last (rt str)))))))
(assert (<= idx2 j))
