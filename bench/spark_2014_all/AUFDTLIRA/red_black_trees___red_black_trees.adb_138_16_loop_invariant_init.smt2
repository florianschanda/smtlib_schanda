...
(assert (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 1)))))))
(assert (not (= (rec__red_black_trees__black_count__status (us_split_fields11 (select res2 j))) true)))
(check-sat)
(exit)
