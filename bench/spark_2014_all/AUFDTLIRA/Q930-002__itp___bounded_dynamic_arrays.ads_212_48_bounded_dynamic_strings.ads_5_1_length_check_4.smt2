...
(declare-const temp___927 natural_index)
(declare-const temp___930 (Array Int character))
(declare-const temp___9301 t3)
(assert (= (bounded_dynamic_strings__null_list__aggregate_def 32) null_list))
(assert (and (= us 0) (in_range2 0)))
(assert (= 0 (to_rep1 temp___927)))
(assert (= (to_rep2 (first6 (rt3 (temp_____aggregate_def_530 32 1 0)))) 1))
(assert (= (to_rep2 (last6 (rt3 (temp_____aggregate_def_530 32 1 0)))) 0))
(assert (= (mk___t3 temp___930 temp___9301) (temp_____aggregate_def_530 32 1 0)))
(assert (not (= (ite (<= (to_rep2 (first6 temp___9301)) (to_rep2 (last6 temp___9301))) (+ (- (to_rep2 (last6 temp___9301)) (to_rep2 (first6 temp___9301))) 1) 0) (ite (<= 1 0) (+ (- 0 1) 1) 0))))
(check-sat)
(exit)
