...
(define-fun o13 () us_t (mk___t o11 o12))
(define-fun o14 () us_t (mk___t o9 o10))
...
(assert (= ia21 o4))
(assert (and (= o5 (remove_swap b ib2 ib)) (and (in_range4 o5) (=> (= (distinct o5 0) true) (= (let ((temp___182 (remove (remove b ib) ib2))) (let ((temp___181 (remove (remove b ib2) (- ib 1)))) (bool_eq (elts temp___181) (to_rep1 (first (rt temp___181))) (to_rep1 (last (rt temp___181))) (elts temp___182) (to_rep1 (first (rt temp___182))) (to_rep1 (last (rt temp___182)))))) true)))))
(assert (= result4 (mk_int__ref h3)))
(assert (= h4 o5))
(assert (= (distinct h4 0) true))
(assert (and (= o13 (remove bb ib2)) (and (dynamic_invariant o13 true false true true) (and (= (invariant__ o13) true) (and (= (to_rep1 (last o12)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib2 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o11 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib2 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o11 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib2 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o11 k))))))))))))
(assert (and (= o14 (remove aa ia21)) (and (dynamic_invariant o14 true false true true) (and (= (invariant__ o14) true) (and (= (to_rep1 (last o10)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia21 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o9 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia21 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o9 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia21 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o9 k))))))))))))
(assert (and (= o6 (- ib 1)) (in_range3 (- ib 1))))
(assert (and (= o15 (remove bb2 o6)) (and (dynamic_invariant o15 true false true true) (and (= (invariant__ o15) true) (and (= (to_rep1 (last o8)) (- (to_rep1 (last (rt bb2))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o6 1))) (= (to_rep (select (elts bb2) k)) (to_rep (select o7 k))))) (and (forall ((k Int)) (=> (and (<= (+ o6 1) k) (<= k (to_rep1 (last (rt bb2))))) (= (to_rep (select (elts bb2) k)) (to_rep (select o7 (- k 1)))))) (forall ((k Int)) (=> (and (<= o6 k) (<= k (- (to_rep1 (last (rt bb2))) 1))) (= (to_rep (select (elts bb2) (+ k 1))) (to_rep (select o7 k))))))))))))
(assert (not (= (invariant__ o14) true)))
(check-sat)
(exit)
