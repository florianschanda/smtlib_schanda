...
(assert (= result5 st2))
(assert (= st3 (+ st2 1)))
(assert (not (or (and (forall ((s Int)) (=> (and (<= 1 s) (<= s (- st3 1))) (not (= (select sel s) true)))) (= lowest_max3 2147483647)) (exists ((s Int)) (and (and (<= 1 s) (<= s (- st3 1))) (and (= (select sel s) true) (= (to_rep (select max s)) lowest_max3)))))))
(check-sat)
(exit)
