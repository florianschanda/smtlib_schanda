...
(assert (= (length source) 6))
(assert (and (= o1 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
...
(assert (= (= o4 true) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index1) (<= index1 (+ (to_rep1 (first (rt source))) 5))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
(assert (and (= temp___2456 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (not (<= (to_rep1 (first (rt source))) temp___2456)))
(check-sat)
(exit)
