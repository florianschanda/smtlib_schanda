...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 20)) (not (= (distinct (to_rep (select (elts r1) i1)) 0) true)))))
(assert (forall ((i1 Int)) (=> (and (<= 31 i1) (<= i1 40)) (not (= (distinct (to_rep (select (elts r1) i1)) 0) true)))))
(assert (<= 21 i))
(assert (<= i 30))
(assert (not (<= (to_rep1 (first (rt r1))) i)))
(check-sat)
(exit)
