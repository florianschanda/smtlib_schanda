...
(declare-const b_acct__split_fields us_split_fields)
(declare-const c392008__apply_service_charge__acct__fields us_split_fields)
(declare-const result11 us_split_fields__ref1)
(declare-const c_acct__split_fields9 us_split_fields2)
(declare-const c392008__apply_service_charge__acct__fields1 us_split_fields)
(declare-const result12 us_split_fields__ref2)
(declare-const ic_acct__split_fields9 us_split_fields4)
(define-fun c_acct__split_fields10 () us_split_fields2 (mk___split_fields1 c_acct__split_fields6 c_acct__split_fields7 c_acct__split_fields8))
(define-fun ic_acct__split_fields10 () us_split_fields4 (mk___split_fields2 ic_acct__split_fields4 ic_acct__split_fields5 ic_acct__split_fields6 ic_acct__split_fields7))
...
(assert (= ic_acct__split_fields10 (us_split_fields5 (of_base1 (mk___rep (mk___split_fields c392008__new_account__acct__fields2 c392008__new_account__acct__fields3) ic_acct__attr__tag)))))
(assert (= result7 c_acct__split_fields3))
(assert (= result8 c_acct__split_fields4))
(assert (= result9 c_acct__split_fields5))
(assert (= c_acct__split_fields10 (us_split_fields3 (of_base (mk___rep (mk___split_fields c392008__annual_interest__acct__fields c392008__annual_interest__acct__fields1) c_acct__attr__tag)))))
(assert (= result10 (mk___split_fields__ref2 ic_acct__split_fields10)))
...
(assert (= result11 (mk___split_fields__ref1 c_acct__split_fields10)))
(assert (= c_acct__split_fields9 (us_split_fields3 (of_base (mk___rep c392008__apply_service_charge__acct__fields c_acct__attr__tag)))))
(assert (= result12 (mk___split_fields__ref2 ic_acct__split_fields8)))
(assert (= ic_acct__split_fields9 (us_split_fields5 (of_base1 (mk___rep c392008__apply_service_charge__acct__fields1 ic_acct__attr__tag)))))
(assert (not (not (=> (= (to_rep2 (rec__c392008_0__account__current_balance b_acct__split_fields)) 500) (=> (= (to_rep2 (rec__c392008_0__account__current_balance1 c_acct__split_fields9)) 1500) (not (= (to_rep2 (rec__c392008_0__account__current_balance2 ic_acct__split_fields9)) 8500)))))))
(check-sat)
(exit)
