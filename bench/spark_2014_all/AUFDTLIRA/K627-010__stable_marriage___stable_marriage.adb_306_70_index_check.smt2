...
(declare-const o13 (Array Int group1_id))
...
(assert (and (forall ((g21 Int)) (=> (and (<= 1 g21) (<= g21 64)) (= (is_permutation_1 (select ranking_2 g21)) true))) (and (= (bool_eq2 (invert ranking_2) 1 64 ranking_2_inverted 1 64) true) (and (= (invariant_holds (mk___split_fields unmatched_g1_set__split_fields unmatched_g1_set__split_fields1) proposals_made result__ unmatched_g2_set) true) (< 0 (to_rep2 unmatched_g1_set__split_fields1))))))
...
(assert (and (= o7 already_asked1) (in_range2 already_asked1)))
(assert (= o8 (+ o7 1)))
(assert (and (= o9 o8) (in_range2 o8)))
(assert (= result4 (mk_int__ref rank1)))
(assert (= rank2 o9))
(assert (and (<= 1 (- rank2 1)) (<= (- rank2 1) 64)))
(assert (= o10 (- rank2 1)))
(assert (= o11 (select (select ranking_1 g11) o10)))
(assert (= o12 (to_rep3 o11)))
(assert (= o13 (select ranking_2 o12)))
(assert (not (<= (- rank2 1) 64)))
(check-sat)
(exit)
