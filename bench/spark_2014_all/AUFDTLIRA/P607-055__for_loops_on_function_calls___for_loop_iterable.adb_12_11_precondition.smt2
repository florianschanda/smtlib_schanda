...
(assert (forall ((temp___265 Int)) (=> (dynamic_invariant1 temp___265 true true true true) (forall ((temp___266 Int)) (= (select (for_loop_iterable__p1__a__aggregate_def temp___265) temp___266) rliteral)))))
...
(declare-const temp___2721 Int)
(declare-const result4 (Array Int natural))
(declare-const a3 (Array Int natural))
(declare-const result5 Bool)
(declare-const result6 Int)
(declare-const temp___2722 Int)
(declare-const result7 Bool)
(define-fun temp___2711 () us_rep (mk___rep (mk___split_fields temp___271)))
(assert (= result a))
(assert (= a1 (for_loop_iterable__p1__a__aggregate_def 0)))
(assert (and (= temp___2711 (from_nat_array a1)) (= a1 temp___271)))
(assert (and (= o (first temp___2711)) (and (in_range2 o) (= o 1))))
(assert (= o temp___272))
(assert (and (= result1 (has_element temp___2711 temp___272)) (= (= result1 true) (in_range3 temp___272))))
(assert (=> (= result1 true) (and (= o1 (element temp___2711 temp___272)) (and (in_range1 o1) (= o1 (to_rep (select temp___271 temp___272)))))))
(assert (=> (= result1 true) (= result2 e)))
(assert (=> (= result1 true) (= e2 o1)))
(assert (=> (not (= result1 true)) (= e2 e)))
(assert (=> (not (= result1 true)) (= e2 e1)))
(assert (and (= result3 (has_element temp___2711 temp___272)) (= (= result3 true) (in_range3 temp___272))))
(assert (= result3 true))
(assert (and (forall ((temp___270 Int)) (=> (and (<= 1 temp___270) (<= temp___270 100)) (=> (not (= 2 temp___270)) (= (select a2 temp___270) (select a1 temp___270))))) (and (= (has_element temp___2711 temp___2721) true) (= e3 (element temp___2711 temp___2721)))))
(assert (= result4 a2))
(assert (= a3 (store a2 2 rliteral1)))
(assert (= e3 0))
(assert (and (= o2 (next temp___2711 temp___2721)) (and (in_range2 o2) (= o2 (ite (= temp___2721 100) 0 (+ temp___2721 1))))))
(assert (and (= o3 (has_element temp___2711 o2)) (= (= o3 true) (in_range3 o2))))
(assert (= result5 (ite (not (= o3 true)) true false)))
(assert (not (= result5 true)))
(assert (and (= o4 (next temp___2711 temp___2721)) (and (in_range2 o4) (= o4 (ite (= temp___2721 100) 0 (+ temp___2721 1))))))
(assert (= result6 temp___2721))
(assert (= temp___2722 o4))
(assert (and (= result7 (has_element temp___2711 temp___2722)) (= (= result7 true) (in_range3 temp___2722))))
(assert (= result7 true))
(assert (not (= (has_element temp___2711 temp___2722) true)))
(check-sat)
(exit)
