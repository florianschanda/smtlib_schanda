...
(assert (not (= j v)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o42 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j)) (and (in_range2 o42) (and (= o42 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 j))))) (and (=> (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j) true) (= o42 0)) (=> (= (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 0) (= o42 0)))))))
