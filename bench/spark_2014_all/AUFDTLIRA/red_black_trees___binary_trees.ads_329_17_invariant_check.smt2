...
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o43 (size (mk___rep2 (us_split_fields__content2 f__split_fields7)))) (and (in_range3 o43) (= o43 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))))))
(assert (= result7 (ite (= o43 (+ (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 1)) true false)))
(assert (= result7 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
...
(assert (= o41 (select temp___1003 i)))
(assert (= o42 (us_split_fields1 o41)))
(assert (= result8 (rec__tree_model__path_type__k o42)))
(assert (= result8 true))
