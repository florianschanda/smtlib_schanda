...
(define-fun dynamic_invariant3 ((temp___expr_182 Int) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool) (temp___do_typ_inv_181 Bool)) Bool (=> (or (= temp___is_init_178 true) (<= 0 100)) (in_range temp___expr_182)))
...
(assert (forall ((t us_rep2)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant4 t true true true true) (dynamic_invariant i true true true true)) (type_invariant1 t)) (let ((result (parent1 t i))) (and (=> (= (size1 t) 0) (= result 0)) (dynamic_invariant3 result true false true true)))) :pattern ((parent1 t i))))))
(assert (forall ((t us_rep2)) (forall ((i Int)) (! (=> (and (dynamic_invariant4 t true true true true) (dynamic_invariant i true true true true)) (= (parent1 t i) (parent (rec__search_trees__search_tree__struct (us_split_fields5 t)) i))) :pattern ((parent1 t i))))))
...
(assert (forall ((t1 us_rep2)) (! (=> (and (dynamic_invariant4 t1 true true true true) (type_invariant1 t1)) (dynamic_invariant3 (size1 t1) true false true true)) :pattern ((size1 t1)))))
(assert (forall ((t1 us_rep2)) (! (=> (dynamic_invariant4 t1 true true true true) (= (size1 t1) (size (rec__search_trees__search_tree__struct (us_split_fields5 t1))))) :pattern ((size1 t1)))))
...
(define-fun dynamic_invariant6 ((temp___expr_189 Int) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (or (= temp___is_init_185 true) (<= 0 2)) (in_range1 temp___expr_189)))
...
(assert (forall ((f us_rep1)) (! (=> (dynamic_invariant2 f true true true true) (dynamic_invariant3 (size f) true false true true)) :pattern ((size f)))))
...
(assert (forall ((f us_rep1)) (forall ((i1 Int)) (! (=> (and (dynamic_invariant2 f true true true true) (dynamic_invariant i1 true true true true)) (let ((result (parent f i1))) (and (and (=> (= (valid_root f i1) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant3 result true false true true)))) :pattern ((parent f i1))))))
