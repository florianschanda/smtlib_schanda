...
(assert (and (forall ((m Int)) (=> (and (<= (to_rep a_v1__first) m) (<= m k_1)) (= (to_rep (select (map__content a_v1) m)) (to_rep (select (elts b_v1) m))))) (forall ((m Int)) (=> (and (<= (+ k_1 1) m) (<= m (to_rep a_v1__last))) (= (to_rep (select (map__content a_v1) m)) (to_rep (select (elts c_v1) (- m k_1))))))))
(assert (= result (mk_int__ref i_v2)))
(assert (= i_v21 (to_rep a_v2__first)))
(assert (<= (to_rep a_v2__first) i_v21))
(assert (<= i_v21 k_2))
(assert (forall ((m Int)) (=> (and (<= (to_rep a_v2__first) m) (<= m (- i_v22 1))) (= (to_rep (select a_v21 m)) (to_rep (select (elts b_v2) m))))))
(assert (and (and (forall ((temp___495 Int)) (=> (and (<= (to_rep a_v2__first) temp___495) (<= temp___495 (to_rep a_v2__last))) (=> (or (< k_2 temp___495) (or (< temp___495 (to_rep a_v2__first)) (<= i_v22 temp___495))) (= (select a_v21 temp___495) (select a_v2 temp___495))))) (=> (<= (to_rep a_v2__first) k_2) (dynamic_property3 (to_rep a_v2__first) k_2 i_v22))) (and (<= (to_rep a_v2__first) i_v22) (<= i_v22 k_2))))
(assert (and (<= (to_rep (first (rt b_v2))) i_v22) (<= i_v22 (to_rep (last (rt b_v2))))))
(assert (= o i_v22))
(assert (= o1 (select (elts b_v2) o)))
(assert (= o2 (to_rep o1)))
(assert (= (to_rep o3) o2))
(assert (and (<= (to_rep a_v2__first) i_v22) (<= i_v22 (to_rep a_v2__last))))
(assert (= o4 i_v22))
(assert (= o5 (store a_v21 o4 o3)))
(assert (= result1 (mk_map__ref a_v21)))
(assert (= a_v22 o5))
(assert (not (= i_v22 k_2)))
...
(assert (<= m (- (int__content i_v24) 1)))
(assert (not (= (to_rep (select (map__content a_v23) m)) (to_rep (select (elts b_v2) m)))))
(check-sat)
(exit)
