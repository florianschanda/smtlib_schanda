...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__p3__limited_record_with_user_eq__x integer)))))
(define-fun us_split_fields_X__3__projection ((a us_split_fields)) integer (rec__p3__limited_record_with_user_eq__x a))
...
(declare-datatypes () ((limited_record_with_user_eq__ref (mk_limited_record_with_user_eq__ref (limited_record_with_user_eq__content us_rep)))))
(define-fun limited_record_with_user_eq__ref___projection ((a limited_record_with_user_eq__ref)) us_rep (limited_record_with_user_eq__content a))
...
(assert true)
(assert (forall ((left us_rep) (right us_rep)) (! (= (= (oeq left right) true) (= (to_rep (rec__p3__limited_record_with_user_eq__x (us_split_fields1 left))) (to_rep (rec__p3__limited_record_with_user_eq__x (us_split_fields1 right))))) :pattern ((oeq left right)))))
...
(declare-fun oeq1 ((Array Int us_rep) (Array Int us_rep)) Bool)
(declare-fun oeq__function_guard1 (Bool (Array Int us_rep) (Array Int us_rep)) Bool)
(assert true)
(assert (forall ((left (Array Int us_rep)) (right (Array Int us_rep))) (! (= (= (oeq1 left right) true) (forall ((x Int)) (=> (and (<= 1 x) (<= x 3)) (= (oeq (select left x) (select right x)) true)))) :pattern ((oeq1 left right)))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__p1__normal_record__x integer)))))
(define-fun us_split_fields_X__projection ((a us_split_fields2)) integer (rec__p1__normal_record__x a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__p1__normal_record__x (us_split_fields3 a))) (to_rep (rec__p1__normal_record__x (us_split_fields3 b)))) true false))
...
(declare-datatypes () ((normal_record__ref (mk_normal_record__ref (normal_record__content us_rep1)))))
(define-fun normal_record__ref___projection ((a normal_record__ref)) us_rep1 (normal_record__content a))
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__p2__limited_record__x integer)))))
(define-fun us_split_fields_X__2__projection ((a us_split_fields4)) integer (rec__p2__limited_record__x a))
...
(declare-datatypes () ((limited_record__ref (mk_limited_record__ref (limited_record__content us_rep2)))))
(define-fun limited_record__ref___projection ((a limited_record__ref)) us_rep2 (limited_record__content a))
...
(assert (= (bool_eq1 (mk___rep1 (mk___split_fields1 x__split_fields)) (mk___rep1 (mk___split_fields1 x__split_fields))) true))
(assert (= (oeq (mk___rep (mk___split_fields z__split_fields)) (mk___rep (mk___split_fields z__split_fields))) true))
(assert (not (= (bool_eq2 a 1 3 a 1 3) true)))
(check-sat)
(exit)
