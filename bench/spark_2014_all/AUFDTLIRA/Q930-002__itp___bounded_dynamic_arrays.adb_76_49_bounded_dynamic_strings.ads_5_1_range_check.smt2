...
(declare-const temp___10411 t)
(declare-const o6 (Array Int character))
(declare-const o7 t2)
(define-fun temp___10402 () us_t2 (mk___t2 temp___1040 temp___10401))
...
(assert (<= (+ (length2 left) (length3 right)) 2147483647))
(assert (and (= temp___10402 (value left)) (and (dynamic_invariant2 temp___10402 true false true true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 left))) temp___1040) (= (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))))))) temp___10401)) (and (and (and (= (length3 temp___10402) (length2 left)) (= (to_rep1 (first4 temp___10401)) 1)) (= (to_rep1 (last4 temp___10401)) (length2 left))) (= (< 0 (length2 left)) (not (= (empty left) true))))))))
(assert (=> (= (length3 temp___10402) 0) (= (elts2 right) temp___1041)))
(assert (=> (= (length3 temp___10402) 0) (= (mk (to_rep1 (first4 (rt2 right))) (to_rep1 (last4 (rt2 right)))) temp___10411)))
(assert (=> (not (= (length3 temp___10402) 0)) (=> (<= (to_rep1 (first4 (rt2 right))) (to_rep1 (last4 (rt2 right)))) (= o (+ (- (to_rep1 (last4 (rt2 right))) (to_rep1 (first4 (rt2 right)))) 1)))))
(assert (=> (not (= (length3 temp___10402) 0)) (=> (not (<= (to_rep1 (first4 (rt2 right))) (to_rep1 (last4 (rt2 right))))) (= o 0))))
(assert (=> (not (= (length3 temp___10402) 0)) (=> (<= (to_rep1 (first4 temp___10401)) (to_rep1 (last4 temp___10401))) (= o1 (+ (- (to_rep1 (last4 temp___10401)) (to_rep1 (first4 temp___10401))) 1)))))
(assert (=> (not (= (length3 temp___10402) 0)) (=> (not (<= (to_rep1 (first4 temp___10401)) (to_rep1 (last4 temp___10401)))) (= o1 0))))
(assert (=> (not (= (length3 temp___10402) 0)) (= o2 (+ o1 o))))
(assert (=> (not (= (length3 temp___10402) 0)) (= o3 (+ (to_rep1 (first4 temp___10401)) o2))))
(assert (=> (not (= (length3 temp___10402) 0)) (= o4 (- o3 1))))
(assert (=> (not (= (length3 temp___10402) 0)) (and (= o5 o4) (in_range2 o4))))
(assert (=> (not (= (length3 temp___10402) 0)) (= (concat1 temp___1040 (to_rep1 (first4 temp___10401)) (to_rep1 (last4 temp___10401)) (elts2 right) (to_rep1 (first4 (rt2 right))) (to_rep1 (last4 (rt2 right)))) temp___1041)))
(assert (=> (not (= (length3 temp___10402) 0)) (= (mk (to_rep1 (first4 temp___10401)) o5) temp___10411)))
(assert (dynamic_property3 1 2147483647 (to_rep1 (first temp___10411)) (to_rep1 (last temp___10411))))
(assert (= temp___1041 o6))
(assert (= (mk2 (to_rep1 (first temp___10411)) (to_rep1 (last temp___10411))) o7))
(assert (not (in_range1 (length3 right))))
(check-sat)
(exit)
