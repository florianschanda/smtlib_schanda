...
(declare-const temp___648 (Array Int character))
(declare-const temp___6481 t)
...
(assert (=> (= (length hello) 0) (= (elts prefix) temp___645)))
(assert (=> (= (length hello) 0) (= (mk (to_rep1 (first (rt prefix))) (to_rep1 (last (rt prefix)))) temp___6451)))
...
(assert (=> (not (= (length hello) 0)) (= (concat1 (elts hello) (to_rep1 (first (rt hello))) (to_rep1 (last (rt hello))) (elts prefix) (to_rep1 (first (rt prefix))) (to_rep1 (last (rt prefix)))) temp___645)))
(assert (=> (not (= (length hello) 0)) (= (mk (to_rep1 (first (rt hello))) o5) temp___6451)))
(assert (=> (= (length (mk___t temp___645 temp___6451)) 0) (= temp___646 temp___648)))
(assert (=> (= (length (mk___t temp___645 temp___6451)) 0) (= (mk (to_rep1 (first temp___6461)) (to_rep1 (last temp___6461))) temp___6481)))
(assert (=> (not (= (length (mk___t temp___645 temp___6451)) 0)) (=> (<= (to_rep1 (first temp___6461)) (to_rep1 (last temp___6461))) (= o6 (+ (- (to_rep1 (last temp___6461)) (to_rep1 (first temp___6461))) 1)))))
(assert (=> (not (= (length (mk___t temp___645 temp___6451)) 0)) (=> (not (<= (to_rep1 (first temp___6461)) (to_rep1 (last temp___6461)))) (= o6 0))))
(assert (=> (not (= (length (mk___t temp___645 temp___6451)) 0)) (=> (<= (to_rep1 (first temp___6451)) (to_rep1 (last temp___6451))) (= o7 (+ (- (to_rep1 (last temp___6451)) (to_rep1 (first temp___6451))) 1)))))
(assert (=> (not (= (length (mk___t temp___645 temp___6451)) 0)) (=> (not (<= (to_rep1 (first temp___6451)) (to_rep1 (last temp___6451)))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___645 temp___6451)) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length (mk___t temp___645 temp___6451)) 0)) (= o9 (+ (to_rep1 (first temp___6451)) o8))))
(assert (=> (not (= (length (mk___t temp___645 temp___6451)) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length (mk___t temp___645 temp___6451)) 0)) (and (= o11 o10) (in_range1 o10))))
(assert (=> (not (= (length (mk___t temp___645 temp___6451)) 0)) (= (concat1 temp___645 (to_rep1 (first temp___6451)) (to_rep1 (last temp___6451)) temp___646 (to_rep1 (first temp___6461)) (to_rep1 (last temp___6461))) temp___648)))
(assert (=> (not (= (length (mk___t temp___645 temp___6451)) 0)) (= (mk (to_rep1 (first temp___6451)) o11) temp___6481)))
(assert (not (= (length (mk___t temp___648 temp___6481)) 0)))
(assert (=> (<= 1 1) (= o12 (+ (- 1 1) 1))))
(assert (=> (not (<= 1 1)) (= o12 0)))
(assert (=> (<= (to_rep1 (first temp___6481)) (to_rep1 (last temp___6481))) (= o13 (+ (- (to_rep1 (last temp___6481)) (to_rep1 (first temp___6481))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6481)) (to_rep1 (last temp___6481)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first temp___6481)) o14)))
(assert (= o16 (- o15 1)))
