...
(assert (not (= (ite (<= (to_rep1 (first temp___11561)) (to_rep1 (last temp___11561))) (+ (- (to_rep1 (last temp___11561)) (to_rep1 (first temp___11561))) 1) 0) (ite (<= 1 new_length) (+ (- new_length 1) 1) 0))))
(check-sat)
(exit)
