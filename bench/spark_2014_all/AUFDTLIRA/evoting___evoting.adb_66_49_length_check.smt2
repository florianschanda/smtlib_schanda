...
(assert (= o8 temp___707))
(assert (= (mk1 1 r17b) temp___7071))
(assert (not (= (ite (<= (to_rep1 (first2 temp___7041)) (to_rep1 (last2 temp___7041))) (+ (- (to_rep1 (last2 temp___7041)) (to_rep1 (first2 temp___7041))) 1) 0) (ite (<= (to_rep1 (first2 temp___7071)) (to_rep1 (last2 temp___7071))) (+ (- (to_rep1 (last2 temp___7071)) (to_rep1 (first2 temp___7071))) 1) 0))))
(check-sat)
(exit)
