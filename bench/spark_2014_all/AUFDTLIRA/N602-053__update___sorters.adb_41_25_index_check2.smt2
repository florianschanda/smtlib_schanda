...
(assert (and (and (=> (<= 1 2147483647) (in_range2 min2)) (=> (<= (to_rep (first (rt unsorted))) (to_rep (last (rt unsorted)))) (dynamic_property1 (to_rep (first (rt unsorted))) (to_rep (last (rt unsorted))) index2))) (and (<= (to_rep (first (rt unsorted))) index2) (<= index2 (to_rep (last (rt unsorted)))))))
