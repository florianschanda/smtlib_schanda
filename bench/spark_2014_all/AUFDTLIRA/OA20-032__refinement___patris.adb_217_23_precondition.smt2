...
(assert (and (= result (move_is_possible (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 cur_piece__split_fields3)) a)) (= (= result true) (ite (= a 0) (in_range2 (- (to_rep1 cur_piece__split_fields2) 1)) (ite (= a 1) (in_range2 (+ (to_rep1 cur_piece__split_fields2) 1)) (=> (= a 2) (in_range3 (+ (to_rep2 cur_piece__split_fields3) 1))))))))
(assert (= result true))
