...
(declare-const temp___271 us_rep)
...
(assert (= r1 1))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___271 avail)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___270 r1)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___269 alloc)))
