...
(assert (= o11 (sorted (mk___t a (mk (to_rep a__first) (to_rep a__last))) o10 length2)))
(assert (= o9 (sorted (mk___t a (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
(assert (and (= o7 (+ length1 length2)) (in_range1 (+ length1 length2))))
(assert (= o8 (ite (<= o7 2147483647) true false)))
(assert (=> (<= (to_rep b__first) (to_rep b__last)) (= o3 (+ (- (to_rep b__last) (to_rep b__first)) 1))))
(assert (=> (not (<= (to_rep b__first) (to_rep b__last))) (= o3 0)))
(assert (and (= o4 o3) (in_range1 o3)))
(assert (and (= o5 (+ length1 length2)) (in_range1 (+ length1 length2))))
(assert (= o6 (ite (<= o5 o4) true false)))
(assert (and (= o2 (+ (to_rep a__last) 1)) (in_range1 (+ (to_rep a__last) 1))))
(assert (and (= o (+ a_first length1)) (in_range1 (+ a_first length1))))
(assert (= o1 (+ o length2)))
