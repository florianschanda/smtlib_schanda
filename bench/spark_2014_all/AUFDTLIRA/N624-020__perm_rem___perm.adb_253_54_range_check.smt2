...
(assert (and (= o10 (remove o9 (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant o10 true false true true) (and (= (invariant__ o10) true) (and (= (to_rep1 (last (rt o10))) (- (to_rep1 (last (rt o9))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep (select (elts o9) k)) (to_rep (select (elts o10) k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k) (<= k (to_rep1 (last (rt o9))))) (= (to_rep (select (elts o9) k)) (to_rep (select (elts o10) (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) k) (<= k (- (to_rep1 (last (rt o9))) 1))) (= (to_rep (select (elts o9) (+ k 1))) (to_rep (select (elts o10) k))))))))))))
