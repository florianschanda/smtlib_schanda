...
(define-fun dynamic_invariant ((temp___expr_306 us_t1) (temp___is_init_302 Bool) (temp___skip_constant_303 Bool) (temp___do_toplevel_304 Bool) (temp___do_typ_inv_305 Bool)) Bool (and (=> (not (= temp___skip_constant_303 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_306) (last3 temp___expr_306))) (=> (= temp___do_toplevel_304 true) (=> (= temp___is_init_302 true) (and (let ((temp___308 (of_array2 (to_array1 temp___expr_306) (first3 temp___expr_306) (last3 temp___expr_306)))) (and (= (first5 temp___308) 1) (<= 0 (last5 temp___308)))) (<= (last3 temp___expr_306) 1000))))))
(define-fun dynamic_predicate ((temp___310 us_t1)) Bool (and (let ((temp___312 (of_array2 (to_array1 temp___310) (first3 temp___310) (last3 temp___310)))) (and (= (first5 temp___312) 1) (<= 0 (last5 temp___312)))) (<= (last3 temp___310) 1000)))
...
(define-fun dynamic_invariant1 ((temp___expr_424 Int) (temp___is_init_420 Bool) (temp___skip_constant_421 Bool) (temp___do_toplevel_422 Bool) (temp___do_typ_inv_423 Bool)) Bool (=> (or (= temp___is_init_420 true) (<= 0 4194304)) (in_range3 temp___expr_424)))
(declare-const x Int)
