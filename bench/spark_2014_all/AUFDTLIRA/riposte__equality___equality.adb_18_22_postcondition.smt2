...
(assert (forall ((i byte)) (and (<= 0 (byteqtint i)) (<= (byteqtint i) 255))))
...
(assert (= (bool_eq (rec__equality__sf_record_t__x (us_split_fields1 a)) 0 255 (rec__equality__sf_record_t__x (us_split_fields1 d)) 0 255) true))
(assert (not (= equality__l611_019_reduced_testcase__result4 true)))
(check-sat)
(exit)
