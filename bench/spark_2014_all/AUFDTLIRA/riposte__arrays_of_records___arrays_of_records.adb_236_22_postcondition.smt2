...
(assert (= result1 a))
(assert (= a1 (store a i (mk___rep (mk___split_fields (distinct 0 0) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a i))) (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a i))))))))
(assert (= (to_rep o) (to_rep (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a1 j))))))
...
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a2 j))) o9))
(assert (= (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a2 j))) o10))
(assert (= o8 o11))
(assert (= o12 o9))
(assert (= o13 o10))
(assert (= o14 o11))
(assert (= o15 (store a2 j (mk___rep (mk___split_fields o12 o13 o14)))))
(assert (= result3 a2))
(assert (= a3 o15))
(assert (= (to_rep o16) tmp1))
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a3 j))) o17))
(assert (= o16 o18))
(assert (= (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a3 j))) o19))
(assert (= o20 o17))
(assert (= o21 o18))
(assert (= o22 o19))
(assert (= o23 (store a3 j (mk___rep (mk___split_fields o20 o21 o22)))))
(assert (= result4 a3))
(assert (= a4 o23))
(assert (= tmp2 tmp1))
(assert (= a4 a5))
