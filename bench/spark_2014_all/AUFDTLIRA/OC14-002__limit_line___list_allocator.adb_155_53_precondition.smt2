...
(assert (and (= o40 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 o40)))
(assert (= result11 (ite (in_range7 o40) true false)))
...
(assert (and (= o39 (+ j 1)) (in_range1 (+ j 1))))
(assert (not (<= o39 (length (rec__list_allocator__m__t__available model____split_fields3)))))
(check-sat)
(exit)
