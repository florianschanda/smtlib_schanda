...
(assert (and (=> (<= 0 100) (in_range3 n2)) (and (<= 0 n2) (<= n2 100))))
(assert (<= 1 j))
(assert (<= j 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= temp___1920 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant1 temp___1920 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1920 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1920 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1920 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1920 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1920 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1920 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1920 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1920 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1920 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1920 i))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1920 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1920 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1920 j1)))) true)) (= j1 i))))))))))))))
(assert (= (mk___rep (mk___split_fields o o1)) (select temp___1920 j)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= o4 o3))
