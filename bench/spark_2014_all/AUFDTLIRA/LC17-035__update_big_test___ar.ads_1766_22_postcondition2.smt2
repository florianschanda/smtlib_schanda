...
(declare-const temp___9335 (Array Int us_rep))
(declare-const temp___93351 Bool)
(declare-const temp___93352 enum1t)
...
(assert (= temp___9335 o6))
(assert (= temp___93351 o7))
(assert (= temp___93352 o8))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= result2 r__split_fields2))
(assert (= temp___9335 r__split_fields3))
(assert (= temp___93351 r__split_fields4))
(assert (= temp___93352 r__split_fields5))
...
(assert (<= 1 n))
(assert (<= n 10))
(assert (not (in_range2 (to_rep (rec__ar__rec1t__f1 (us_split_fields1 (select r__split_fields6 n)))))))
(check-sat)
(exit)
