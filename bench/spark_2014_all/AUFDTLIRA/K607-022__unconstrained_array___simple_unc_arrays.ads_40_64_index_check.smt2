...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (= temp___924 res1)))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (= temp___923 i1)))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (<= res2 (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j1)))))))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (and (and (=> (<= 2 r25b) (dynamic_property2 2 r25b i2)) (=> (<= (- 2147483648) 2147483647) (in_range3 res2))) (and (<= 2 i2) (<= i2 r25b)))))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (and (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (= o3 i2)))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (= o4 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o3))))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (= o5 (to_rep2 o4))))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (= result2 (ite (< o5 res2) true false))))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (=> (= result2 true) (and (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))))))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (=> (= result2 true) (= o6 i2))))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (=> (= result2 true) (= o7 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o6)))))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (=> (= result2 true) (= o8 (to_rep2 o7)))))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (=> (= result2 true) (= res2 result3))))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (=> (= result2 true) (= res3 o8))))
(assert (=> (and (<= 2 i1) (<= i1 r25b)) (=> (not (= result2 true)) (= res3 res2))))
...
(assert (= simple_unc_arrays__min__result1 simple_unc_arrays__min__result2))
(assert (= simple_unc_arrays__min__result3 simple_unc_arrays__min__result1))
(assert (= (mk_int__ref result4) (mk_int__ref simple_unc_arrays__min__result)))
(assert (= simple_unc_arrays__min__result1 res6))
(assert (= (mk_int__ref simple_unc_arrays__min__result4) (mk_int__ref simple_unc_arrays__min__result2)))
(assert (= (mk_int__ref i7) i9))
(assert (= (mk_int__ref res8) res10))
(assert (= simple_unc_arrays__min__result5 simple_unc_arrays__min__result3))
(assert (= i8 i6))
(assert (= res9 res7))
(assert (<= 1 j))
