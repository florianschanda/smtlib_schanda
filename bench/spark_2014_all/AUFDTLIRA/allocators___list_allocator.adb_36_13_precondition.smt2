...
(assert (and (= o10 (length model____split_fields)) (and (in_range2 o10) (<= (+ 0 o10) 2147483647))))
(assert (= result3 (ite (<= o10 10000) true false)))
(assert (=> (= result3 true) (and (= o9 (length1 model____split_fields1)) (in_range2 o9))))
(assert (=> (= result3 true) (= result2 (ite (<= o9 10000) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o5 (length1 model____split_fields1)) (in_range2 o5))))
(assert (=> (= result2 true) (and (= o6 (length model____split_fields)) (and (in_range2 o6) (<= (+ 0 o6) 2147483647)))))
(assert (=> (= result2 true) (= o7 (+ o6 o5))))
(assert (=> (= result2 true) (and (= o8 o7) (in_range7 o7))))
(assert (=> (= result2 true) (= result1 (ite (= o8 10000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o3 (length model____split_fields)) (and (in_range2 o3) (<= (+ 0 o3) 2147483647))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= result4 (ite (< 0 o3) true false)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result4 true) (and (= o2 (get model____split_fields 1)) (in_range3 o2))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result4 true) (= result (ite (= o2 first_available) true false))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (not (= result4 true)) (= result false)))))
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (and (= o4 (length model____split_fields)) (and (in_range2 o4) (<= (+ 0 o4) 2147483647))))))
