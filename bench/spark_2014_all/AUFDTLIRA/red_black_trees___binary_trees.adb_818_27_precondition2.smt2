...
(assert (= o29 (select temp___1524 ki1)))
...
(assert (and (= o24 v) (in_range2 v)))
(assert (not (= (valid_root (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o24) true)))
(check-sat)
(exit)
