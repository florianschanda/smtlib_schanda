...
(assert (= result3 true))
(assert (and (= o4 (+ current_candidate1 1)) (in_range7 (+ current_candidate1 1))))
(assert (= current_candidate1 result4))
(assert (= current_candidate2 o4))
(assert (forall ((i Int)) (=> (and (<= current_candidate3 i) (<= i 20)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 70)) (= (to_rep (select (select candidates3 i) j)) 32))))))
(assert (and (and (=> (<= 0 2147483647) (in_range4 last7)) (forall ((temp___714 Int)) (=> (and (<= 0 temp___714) (<= temp___714 20)) (forall ((temp___715 Int)) (=> (and (<= 1 temp___715) (<= temp___715 70)) (=> (< temp___715 1) (= (select (select candidates3 temp___714) temp___715) (select (select candidates2 temp___714) temp___715)))))))) (=> (<= 0 20) (in_range7 current_candidate3))))
(assert (= (to_rep1 o6) 70))
(assert (= (to_rep1 o5) 1))
(assert (in_range4 last8))
(assert (= item result5))
(assert (= item1 (slide ada__text_io__get_line__item (to_rep1 (first (mk 1 70))) 1)))
(assert (= last8 r17b))
(assert (in_range4 r17b))
(assert (= last8 r20b))
(assert (in_range4 r20b))
(assert (=> (<= 1 r20b) (and (and (<= 1 1) (<= 1 70)) (and (<= 1 r20b) (<= r20b 70)))))
(assert (= o7 item1))
(assert (= o7 temp___703))
(assert (= (mk2 1 r20b) temp___7031))
(assert (= (ite (<= (to_rep1 (first4 temp___7031)) (to_rep1 (last4 temp___7031))) (+ (- (to_rep1 (last4 temp___7031)) (to_rep1 (first4 temp___7031))) 1) 0) (ite (<= 1 r17b) (+ (- r17b 1) 1) 0)))
(assert (= temp___703 temp___704))
(assert (= (mk1 (to_rep1 (first4 temp___7031)) (to_rep1 (last4 temp___7031))) temp___7041))
(assert (<= 1 r17b))
(assert (not (<= 1 70)))
(check-sat)
(exit)
