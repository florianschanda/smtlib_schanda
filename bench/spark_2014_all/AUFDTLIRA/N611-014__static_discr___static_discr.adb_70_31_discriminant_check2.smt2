...
(define-fun o33 () us_rep (mk___rep (mk___split_discrs o22 o23) (mk___split_fields (mk___t o24 o25))))
(define-fun o34 () us_rep (mk___rep (mk___split_discrs o18 o19) (mk___split_fields (mk___t o20 o21))))
...
(assert (= o16 o10))
(assert (= o17 o11))
(assert (= o34 (to_base5 (mk___rep7 (mk___split_discrs o14 o15) (mk___split_fields7 (mk___t5 o16 o17))))))
(assert (= o33 o34))
(assert (= o28 (of_base3 o33)))
...
(assert (not (= (to_rep1 (last6 (rt3 a))) (to_rep (rec__static_discr__holder__unused (us_split_discrs4 o32))))))
(check-sat)
(exit)
