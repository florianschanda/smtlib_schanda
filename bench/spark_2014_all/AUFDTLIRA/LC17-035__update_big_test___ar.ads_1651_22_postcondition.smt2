...
(declare-fun temp_____aggregate_def_3620 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
(declare-fun temp_____aggregate_def_3627 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (forall ((temp___3622 (Array Int us_rep))) (forall ((temp___3623 Int)) (forall ((temp___3624 us_rep)) (let ((temp___3621 (temp_____aggregate_def_3620 temp___3622 temp___3623 temp___3624))) (=> (dynamic_invariant1 temp___3623 true true true true) (forall ((temp___3625 Int)) (ite (= temp___3625 temp___3623) (= (select temp___3621 temp___3625) temp___3624) (= (select temp___3621 temp___3625) (select temp___3622 temp___3625))))))))))
(assert (forall ((temp___3629 (Array Int et1))) (forall ((temp___3630 Int) (temp___3631 Int)) (let ((temp___3628 (temp_____aggregate_def_3627 temp___3629 temp___3630 temp___3631))) (=> (and (dynamic_invariant temp___3630 true true true true) (dynamic_invariant2 temp___3631 true true true true)) (forall ((temp___3632 Int)) (ite (= temp___3632 temp___3630) (= (to_rep (select temp___3628 temp___3632)) temp___3631) (= (select temp___3628 temp___3632) (select temp___3629 temp___3632)))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq2 a2 1 16 (temp_____aggregate_def_3620 a i (mk___rep (mk___split_fields (temp_____aggregate_def_3627 (rec__ar__rofa1__s1 (us_split_fields1 (select a i))) j e) (rec__ar__rofa1__t1 (us_split_fields1 (select a i)))))) 1 16) true)))
(check-sat)
(exit)
