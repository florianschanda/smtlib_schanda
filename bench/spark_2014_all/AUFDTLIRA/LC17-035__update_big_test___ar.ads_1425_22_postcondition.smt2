...
(declare-fun temp_____aggregate_def_3063 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (forall ((temp___3065 (Array Int et1))) (forall ((temp___3066 Int) (temp___3067 Int)) (let ((temp___3064 (temp_____aggregate_def_3063 temp___3065 temp___3066 temp___3067))) (=> (and (dynamic_invariant temp___3066 true true true true) (dynamic_invariant1 temp___3067 true true true true)) (forall ((temp___3068 Int)) (ite (= temp___3068 temp___3066) (= (to_rep (select temp___3064 temp___3068)) temp___3067) (= (select temp___3064 temp___3068) (select temp___3065 temp___3068)))))))))
...
(declare-const temp___7948 (Array Int et1))
(declare-const temp___79481 enum2t)
...
(assert (= temp___7948 o2))
(assert (= temp___79481 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___7948 r__split_fields2))
(assert (= temp___79481 r__split_fields3))
...
(assert (not (= (bool_eq1 (mk___rep (mk___split_fields r__split_fields4 r__split_fields5)) (mk___rep (mk___split_fields (temp_____aggregate_def_3063 r__split_fields i e) r__split_fields1))) true)))
(check-sat)
(exit)
