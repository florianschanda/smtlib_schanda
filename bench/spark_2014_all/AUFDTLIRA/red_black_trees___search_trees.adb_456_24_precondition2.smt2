...
(assert (= o39 (select temp___1629 i2)))
(assert (= o40 (us_split_fields5 o39)))
(assert (= o41 (rec__tree_model__path_type__a o40)))
(assert (and (= o42 (length o41)) (and (in_range2 o42) (<= (+ 0 o42) 2147483647))))
(assert (= o43 (+ o42 1)))
(assert (and (= o44 o43) (in_range8 o43)))
