...
(assert (= o11 (+ o10 1)))
(assert (and (= o12 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range6 o12)))
...
(assert (and (= temp___2106 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)) (and (dynamic_invariant8 temp___2106 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2106 o1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___2106 o1)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o1)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2106 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2106 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2106 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2106 i1))) true) (not (= i1 o1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___2106 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___2106 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___2106 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2106 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2106 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___2106 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___2106 j)))) true)) (= j i1))))))))))))))
(assert (and (<= 1 i) (<= i 100)))
(assert (= o2 i))
(assert (= (mk___rep2 (mk___split_fields2 o3 o4)) (select temp___2106 o2)))
(assert (= o3 o5))
(assert (= o4 o6))
(assert (= o7 o5))
