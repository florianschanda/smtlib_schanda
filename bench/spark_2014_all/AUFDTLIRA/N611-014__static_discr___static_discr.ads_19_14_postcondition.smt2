...
(assert (= result6 (int__content static_discr__search_max__result4)))
(assert (= (int__content static_discr__search_max__result4) 0))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i (to_rep (rec__static_discr__holder__length1 (us_split_fields9 a)))))
(assert (not (not (= (to_rep (select (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 a)))) i)) e))))
(check-sat)
(exit)
