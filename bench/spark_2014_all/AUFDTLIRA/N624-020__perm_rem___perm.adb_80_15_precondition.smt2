...
(assert (and (= o3 (to_rep (first (rt b)))) (in_range3 (to_rep (first (rt b))))))
(assert (and (= o6 (remove b o3)) (and (dynamic_invariant o6 true false true true) (and (= (invariant__ o6) true) (and (= (to_rep (last o5)) (- (to_rep (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o3 1))) (= (to_rep1 (select (elts b) k)) (to_rep1 (select o4 k))))) (and (forall ((k Int)) (=> (and (<= (+ o3 1) k) (<= k (to_rep (last (rt b))))) (= (to_rep1 (select (elts b) k)) (to_rep1 (select o4 (- k 1)))))) (forall ((k Int)) (=> (and (<= o3 k) (<= k (- (to_rep (last (rt b))) 1))) (= (to_rep1 (select (elts b) (+ k 1))) (to_rep1 (select o4 k))))))))))))
(assert (and (= o (to_rep (first (rt a)))) (in_range3 (to_rep (first (rt a))))))
(assert (and (= o7 (remove a o)) (and (dynamic_invariant o7 true false true true) (and (= (invariant__ o7) true) (and (= (to_rep (last o2)) (- (to_rep (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o 1))) (= (to_rep1 (select (elts a) k)) (to_rep1 (select o1 k))))) (and (forall ((k Int)) (=> (and (<= (+ o 1) k) (<= k (to_rep (last (rt a))))) (= (to_rep1 (select (elts a) k)) (to_rep1 (select o1 (- k 1)))))) (forall ((k Int)) (=> (and (<= o k) (<= k (- (to_rep (last (rt a))) 1))) (= (to_rep1 (select (elts a) (+ k 1))) (to_rep1 (select o1 k))))))))))))
(assert (not (= (invariant__ o6) true)))
(check-sat)
(exit)
