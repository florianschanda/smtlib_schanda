...
(declare-const temp___516 capacity_range)
(declare-const temp___5161 us_main_type)
(declare-const temp___515 Int)
(declare-const temp___521 r1)
(declare-const temp___5211 (Array Int integer))
(declare-const temp___514 r1)
(declare-const temp___5141 (Array Int integer))
...
(assert (= i3 first2))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (and (= s__split_fields temp___507) (= s__split_fields1 temp___5071))))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (= temp___506 i3)))
(assert (=> (and (<= first2 i3) (<= i3 last3)) (and (= o i3) (in_range6 i3))))
...
(assert (= i9 first2))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (and (= res__split_discrs (mk___split_discrs temp___516)) (= res__split_fields temp___5161))))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= temp___515 i9)))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___521 temp___5211))))
(assert (=> (and (<= first2 i9) (<= i9 last3)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___514 temp___5141))))
...
(assert (=> (and (<= first2 i9) (<= i9 last3)) (and (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields10))))) (- last3 i10)) (= (bool_eq (elts (to__ (mk___rep s__split_fields10))) (to_rep (first3 (mk1 first2 (- last3 i10)))) (to_rep (last4 (mk1 first2 (- last3 i10)))) (elts (to__ (mk___rep (mk___split_fields temp___521 temp___5211)))) (to_rep (first5 (mk2 first2 (- last3 i10)))) (to_rep (last6 (mk2 first2 (- last3 i10))))) true)) (forall ((j Int)) (=> (and (<= first2 j) (<= j i10)) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields3)) j) (get (model__ l) (+ (- (last2 (model__ l)) j) 1))))))))
...
(assert (and (= o4 (last2 (model__ l))) (and (in_range5 o4) (= o4 (last2 (model__ l))))))
...
(assert (= result4 true))
(assert (and (= o8 (last2 (model__ l))) (and (in_range5 o8) (= o8 (last2 (model__ l))))))
(assert (= o9 (- o8 i2)))
