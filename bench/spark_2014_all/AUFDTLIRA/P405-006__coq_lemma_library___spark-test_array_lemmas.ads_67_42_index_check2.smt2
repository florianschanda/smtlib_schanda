...
(assert (forall ((i1 Int)) (=> (and (<= (+ (to_rep (first2 (rt1 arr))) 1) i1) (<= i1 (to_rep (last2 (rt1 arr))))) (< (to_rep (select (elts1 arr) (- i1 1))) (to_rep (select (elts1 arr) i1))))))
(assert (dynamic_property (- 2147483648) 2147483647 (to_rep (first2 (rt1 arr))) (to_rep (last2 (rt1 arr)))))
(assert (= (elts1 arr) o))
(assert (= (mk (to_rep (first2 (rt1 arr))) (to_rep (last2 (rt1 arr)))) o1))
(assert (forall ((i1 Int)) (=> (and (<= (to_rep (first o1)) i1) (<= i1 (to_rep (last o1)))) (forall ((j1 Int)) (=> (and (<= (to_rep (first o1)) j1) (<= j1 (to_rep (last o1)))) (=> (< i1 j1) (< (to_rep (select o i1)) (to_rep (select o j1)))))))))
(assert (<= (to_rep (first2 (rt1 arr))) i))
(assert (<= i (to_rep (last2 (rt1 arr)))))
(assert (<= (to_rep (first2 (rt1 arr))) j))
(assert (<= j (to_rep (last2 (rt1 arr)))))
(assert (< i j))
(assert (and (<= (to_rep (first2 (rt1 arr))) j) (<= j (to_rep (last2 (rt1 arr))))))
(assert (= o2 j))
