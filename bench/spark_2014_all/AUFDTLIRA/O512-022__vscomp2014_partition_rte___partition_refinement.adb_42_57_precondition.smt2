...
(assert (forall ((c1 us_rep3)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c1) true) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c1))) (key (mk___rep d__split_discrs d__split_fields2) c1)))))
...
(assert (= result5 true))
(assert (and (= o6 (capacity (mk___rep2 p__split_discrs (us_split_fields__content2 p__split_fields2)))) (and (in_range7 o6) (= o6 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (= result6 (ite (= o6 (capacity (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))) true false)))
(assert (= result6 true))
(assert (and (= o5 (length2 (mk___rep2 p__split_discrs (us_split_fields__content2 p__split_fields2)))) (and (in_range7 o5) (<= o5 (capacity (mk___rep2 p__split_discrs (us_split_fields__content2 p__split_fields2)))))))
(assert (= result7 (ite (= o5 (length2 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))) true false)))
(assert (= result7 true))
(assert (= (= result8 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (= (has_key (model__ (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) (to_rep (select (map__content3 a2) j1))) true)))))
(assert (= result8 true))
