...
(declare-const temp___1662 (Array Int character))
(declare-const temp___16621 t5)
(declare-const temp___1663 (Array Int character))
(declare-const temp___16631 t4)
(declare-const o5 (Array Int character))
(declare-const temp___1665 (Array Int character))
(declare-const temp___16651 t4)
...
(assert (= o4 str1))
(assert (= o4 temp___1662))
(assert (= (mk5 2 r10b) temp___16621))
(assert (= (ite (<= (to_rep1 (first10 temp___16621)) (to_rep1 (last10 temp___16621))) (+ (- (to_rep1 (last10 temp___16621)) (to_rep1 (first10 temp___16621))) 1) 0) (ite (<= 1 r6b) (+ (- r6b 1) 1) 0)))
(assert (= (slide temp___1662 (to_rep1 (first10 temp___16621)) 1) temp___1663))
(assert (= (mk4 1 r6b) temp___16631))
(assert (=> (<= 1 r6b) (and (and (<= 1 1) (<= 1 10)) (and (<= 1 r6b) (<= r6b 10)))))
(assert (= o5 text))
(assert (= o5 temp___1665))
(assert (= (mk4 1 r6b) temp___16651))
(assert (not (= (ite (<= (to_rep1 (first8 temp___16631)) (to_rep1 (last8 temp___16631))) (+ (- (to_rep1 (last8 temp___16631)) (to_rep1 (first8 temp___16631))) 1) 0) (ite (<= (to_rep1 (first8 temp___16651)) (to_rep1 (last8 temp___16651))) (+ (- (to_rep1 (last8 temp___16651)) (to_rep1 (first8 temp___16651))) 1) 0))))
(check-sat)
(exit)
