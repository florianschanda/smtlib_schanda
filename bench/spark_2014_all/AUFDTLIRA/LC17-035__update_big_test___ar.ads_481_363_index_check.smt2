...
(declare-const temp___5420 (Array Int (Array Int et1)))
(declare-const o8 Int)
(declare-const o9 (Array Int et1))
(declare-const o10 (Array Int et1))
(declare-const o11 (Array Int (Array Int et1)))
(declare-const o12 (Array Int (Array Int et1)))
(declare-const o13 Int)
(declare-const temp___5421 (Array Int (Array Int (Array Int et1))))
...
(assert (=> (< 0 e) (= o7 (+ k 1))))
(assert (=> (< 0 e) (= temp___5420 (select a o7))))
(assert (=> (< 0 e) (= o9 (select temp___5420 j))))
(assert (=> (< 0 e) (= o10 (temp_____aggregate_def_1734 o9 i o8))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o6 (+ k 1))))
(assert (=> (< 0 e) (= o11 (select a o6))))
(assert (=> (< 0 e) (= o12 (temp_____aggregate_def_1727 o11 j o10))))
(assert (=> (< 0 e) (and (= o13 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5421 (temp_____aggregate_def_1704 a k (temp_____aggregate_def_1712 (select a k) j (temp_____aggregate_def_1719 (select (select a k) j) i e)) o13 o12))))
(assert (=> (< 0 e) (= result5 (bool_eq2 a3 1 16 temp___5421 1 16))))
