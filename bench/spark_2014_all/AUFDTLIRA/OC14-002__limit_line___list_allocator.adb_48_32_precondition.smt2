...
(assert (=> (not (= first_available 0)) (and (= o33 (length model____split_fields)) (in_range3 o33))))
(assert (=> (not (= first_available 0)) (= result2 (ite (< 0 o33) true false))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (and (= o32 (get model____split_fields 1)) (in_range4 o32)))))
...
(assert (=> (not (not (= first_available 0))) (and (= o34 (length model____split_fields)) (in_range3 o34))))
(assert (=> (not (not (= first_available 0))) (= result1 (ite (= o34 0) true false))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (and (= o30 (length model____split_fields1)) (in_range3 o30)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o30) true false)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (and (= o29 (get model____split_fields1 1)) (in_range4 o29))))))
...
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (and (= o31 (length model____split_fields1)) (in_range3 o31)))))
...
(assert (= result4 true))
(assert (and (= o28 (get model____split_fields j)) (in_range4 o28)))
(assert (= result7 (ite (in_range6 o28) true false)))
(assert (=> (= result7 true) (and (= o24 (length model____split_fields)) (in_range3 o24))))
(assert (=> (= result7 true) (= result8 (ite (< j o24) true false))))
(assert (=> (= result7 true) (=> (= result8 true) (and (= o25 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result7 true) (=> (= result8 true) (and (= o26 (get model____split_fields o25)) (in_range4 o26)))))
...
(assert (=> (= result6 true) (=> (< 1 j) (and (= o14 (get model____split_fields o13)) (in_range4 o14)))))
...
(assert (= result9 true))
(assert (not (= j k)))
(assert (and (= o4 (get model____split_fields k)) (in_range4 o4)))
