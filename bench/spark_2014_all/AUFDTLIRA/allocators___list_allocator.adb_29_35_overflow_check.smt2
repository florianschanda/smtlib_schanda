...
(assert (forall ((x status)) (! (in_range9 (to_rep1 x)) :pattern ((to_rep1 x)))))
(assert (forall ((x Int)) (! (=> (in_range9 x) (= (to_rep1 (of_rep1 x)) x)) :pattern ((to_rep1 (of_rep1 x))))))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 a))) (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 b)))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 a))) (to_rep (rec__list_allocator__cell__next (us_split_fields1 b))))) true false))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__list_allocator__m__t__available us_rep) (rec__list_allocator__m__t__allocated us_rep1)))))
...
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (user_eq1 (rec__list_allocator__m__t__available (us_split_fields3 a)) (rec__list_allocator__m__t__available (us_split_fields3 b))) true) (= (bool_eq1 (rec__list_allocator__m__t__allocated (us_split_fields3 a)) (rec__list_allocator__m__t__allocated (us_split_fields3 b))) true)) true false))
...
(define-fun dynamic_invariant6 ((temp___expr_263 Int) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool) (temp___do_typ_inv_262 Bool)) Bool (=> (or (= temp___is_init_259 true) (<= 0 1)) (in_range9 temp___expr_263)))
...
(assert (and (= o4 (length model____split_fields)) (and (in_range2 o4) (<= (+ 0 o4) 2147483647))))
(assert (= result1 (ite (<= o4 10000) true false)))
(assert (=> (= result1 true) (and (= o3 (length1 model____split_fields1)) (in_range2 o3))))
(assert (=> (= result1 true) (= result (ite (<= o3 10000) true false))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (and (= o (length1 model____split_fields1)) (in_range2 o)))
(assert (and (= o1 (length model____split_fields)) (and (in_range2 o1) (<= (+ 0 o1) 2147483647))))
(assert (= o2 (+ o1 o)))
(assert (not (in_range7 o2)))
(check-sat)
(exit)
