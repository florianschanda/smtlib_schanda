...
(assert (not (= (bool_eq a (to_rep (first6 (mk3 (to_rep a__first) r18b1))) (to_rep (last6 (mk3 (to_rep a__first) r18b1))) b1 (to_rep (first8 (mk4 (to_rep b__first) r21b1))) (to_rep (last8 (mk4 (to_rep b__first) r21b1)))) true)))
(check-sat)
(exit)
