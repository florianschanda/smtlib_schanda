...
(assert (= result a))
(assert (= a1 (test_array_eq_bad__a__aggregate_def (mk___rep (mk___split_fields rliteral rliteral1)) (mk___rep (mk___split_fields rliteral2 rliteral3)))))
(assert (= result1 b))
(assert (= b1 (test_array_eq_bad__b__aggregate_def (mk___rep (mk___split_fields rliteral rliteral)) (mk___rep (mk___split_fields rliteral2 rliteral2)))))
