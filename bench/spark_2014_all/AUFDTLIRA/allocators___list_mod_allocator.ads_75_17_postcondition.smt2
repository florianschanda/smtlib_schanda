...
(declare-const list_mod_allocator__m__model__result us_rep)
(declare-const list_mod_allocator__m__model__result1 us_rep1)
...
(declare-const temp___330 us_rep)
...
(declare-const unseen11 us_rep1)
...
(declare-const unseen13 us_rep1)
...
(declare-const alloc9 us_rep1)
(declare-const unseen15 us_rep1)
...
(declare-const result12 us_rep1)
...
(assert (=> (= result4 true) (= temp___332 r8)))
(assert (=> (= result4 true) (= temp___331 (set__content unseen6))))
(assert (=> (= result4 true) (= temp___330 avail)))
(assert (=> (= result4 true) (= 0 temp___336)))
(assert (=> (= result4 true) (and (= o4 (remove (set__content unseen6) r8)) (and (and (and (= (length1 o4) (- (length1 (set__content unseen6)) 1)) (not (= (contains o4 r8) true))) (= (ole1 o4 (set__content unseen6)) true)) (= (included_except (set__content unseen6) o4 r8) true)))))
(assert (=> (= result4 true) (= result5 unseen6)))
(assert (=> (= result4 true) (= unseen8 o4)))
(assert (=> (= result4 true) (and (= o5 (add avail r8)) (and (= (length o5) (+ (length avail) 1)) (and (= (get o5 (last o5)) r8) (= (ole avail o5) true))))))
...
(assert (=> (= result4 true) (= (mk___rep (mk___split_fields o7 o8)) (select data o6))))
...
(assert (=> (= result4 true) (<= (length avail3) (- 10000 (length1 unseen9)))))
(assert (=> (= result4 true) (forall ((e Int)) (=> (and (<= 1 e) (<= e 10000)) (=> (and (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data e)))) 0) (not (= (contains1 avail3 e) true))) (= (contains unseen9 e) true))))))
(assert (=> (= result4 true) (and (< 0 (length avail3)) (= (get avail3 1) first_available))))
(assert (=> (= result4 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length avail3))) (in_range8 (get avail3 j))))))
(assert (=> (= result4 true) (= r10 (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data (get avail3 (length avail3)))))))))
(assert (=> (= result4 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- (length avail3) 1))) (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data (get avail3 j))))) (get avail3 (+ j 1)))))))
(assert (=> (= result4 true) (forall ((j Int)) (=> (and (<= 2 j) (<= j (length avail3))) (= (get avail3 j) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data (get avail3 (- j 1)))))))))))
(assert (=> (= result4 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length avail3))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (length avail3))) (=> (= (get avail3 j) (get avail3 k)) (= j k))))))))
(assert (=> (= result4 true) (forall ((e Int)) (=> (and (<= 1 e) (<= e 10000)) (=> (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data e)))) 1) (not (= (contains1 avail3 e) true)))))))
(assert (=> (= result4 true) (=> (<= 0 10000) (in_range6 r10))))
(assert (=> (= result4 true) (= result8 (mk_int__ref temp___3361))))
(assert (=> (= result4 true) (= temp___3362 (length avail3))))
(assert (=> (= result4 true) (and (= o13 (contains1 avail3 r10)) (= (= o13 true) (exists ((i Int)) (and (and (<= 1 i) (<= i (length avail3))) (= (get avail3 i) r10)))))))
(assert (=> (= result4 true) (= o14 (ite (not (= o13 true)) true false))))
(assert (=> (= result4 true) (= o15 (ite (not (= r10 0)) o14 false))))
(assert (=> (= result4 true) (= result9 (ite (not (= o15 true)) true false))))
...
(assert (= list_mod_allocator__m__model__result3 (mk_t__ref list_mod_allocator__m__model__result2)))
(assert (= list_mod_allocator__m__model__result4 list_mod_allocator__m__model__result2))
(assert (= result10 (mk_t__ref (mk___rep1 (mk___split_fields1 list_mod_allocator__m__model__result list_mod_allocator__m__model__result1)))))
(assert (= list_mod_allocator__m__model__result2 (mk___rep1 (mk___split_fields1 (sequence__content avail6) (set__content alloc6)))))
(assert (= list_mod_allocator__m__model__result5 list_mod_allocator__m__model__result3))
(assert (= r16 r13))
(assert (= r15 r6))
(assert (= unseen14 unseen12))
(assert (= alloc8 alloc6))
(assert (= avail8 avail6))
(assert (= list_mod_allocator__m__model__result6 list_mod_allocator__m__model__result4))
(assert (= r18 r14))
(assert (= r17 r7))
(assert (= unseen15 unseen13))
(assert (= alloc9 alloc7))
(assert (= avail9 avail7))
(assert (= (mk___rep1 (mk___split_fields1 result11 result12)) (t__content list_mod_allocator__m__model__result5)))
(assert (not (= (model_is_well_formed (t__content list_mod_allocator__m__model__result5) data first_available) true)))
(check-sat)
(exit)
