...
(assert (=> (and (and (= (ite (select winners3 0) 1 0) (ite (distinct 0 0) 1 0)) (< latest_highest_score2 i2)) (= (select winners3 latest_highest_score2) true)) (= (= result4 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (=> (< latest_highest_score2 j) (< (to_rep (select counters j)) (to_rep (select counters latest_highest_score2)))))))))
