...
(assert (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) (get_content (result_ty__content record_discr__search_upto_3__result15)))) e)))
(check-sat)
(exit)
