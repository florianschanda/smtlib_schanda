...
(assert (in_range1 e))
(assert (= us (ite (ite (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) true false) 1 0)))
...
(assert (=> (not (= result true)) (and (= o20 (search_upto o21 e)) (ite (= o18 true) (and (<= (get_content o20) (to_rep o15)) (= (to_rep (select o16 (get_content o20))) e)) (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep o15))) (not (= (to_rep (select o16 i)) e))))))))
...
(assert (= (mk___rep (mk___split_discrs result4) (mk___split_fields result5)) (result_ty__content record_discr__search_upto__result8)))
(assert (= (rec__private_record__result_ty__found (us_split_discrs1 (result_ty__content record_discr__search_upto__result8))) true))
(assert (not (= (to_rep (select (elts (rec__record_discr__interm_result__to_search (us_split_fields3 r))) (get_content (result_ty__content record_discr__search_upto__result8)))) e)))
(check-sat)
(exit)
