...
(declare-const rr_type__wirenamelength__result Int)
...
(declare-const rr_type__wirenamelength__result1 Int)
(declare-const rr_type__wirenamelength__result2 Int)
(declare-const rr_type__wirenamelength__result3 Int)
(declare-const index8 Int)
(declare-const rr_type__wirenamelength__result4 Int)
(declare-const index9 Int)
(declare-const rr_type__wirenamelength__result5 Int)
...
(assert (= index1 1))
(assert (=> (and (< index1 129) (not (= (to_rep (select name index1)) 0))) (= temp___361 index1)))
(assert (=> (and (< index1 129) (not (= (to_rep (select name index1)) 0))) (and (< index2 129) (forall ((q Int)) (=> (and (<= 1 q) (<= q index2)) (not (= (to_rep (select name q)) 0)))))))
(assert (=> (and (< index1 129) (not (= (to_rep (select name index1)) 0))) (and (=> (<= 1 129) (in_range3 index2)) (and (< index2 129) (not (= (to_rep (select name index2)) 0))))))
(assert (=> (and (< index1 129) (not (= (to_rep (select name index1)) 0))) (and (= o (+ index2 1)) (in_range3 (+ index2 1)))))
(assert (=> (and (< index1 129) (not (= (to_rep (select name index1)) 0))) (= index2 result1)))
(assert (=> (and (< index1 129) (not (= (to_rep (select name index1)) 0))) (= index3 o)))
(assert (=> (and (< index1 129) (not (= (to_rep (select name index1)) 0))) (not (and (< index3 129) (not (= (to_rep (select name index3)) 0))))))
(assert (=> (and (< index1 129) (not (= (to_rep (select name index1)) 0))) (= index3 index4)))
(assert (=> (and (< index1 129) (not (= (to_rep (select name index1)) 0))) (= index5 index3)))
(assert (=> (and (< index1 129) (not (= (to_rep (select name index1)) 0))) (= index10 (mk_int__ref index4))))
(assert (=> (and (< index1 129) (not (= (to_rep (select name index1)) 0))) (= index7 index5)))
(assert (=> (not (and (< index1 129) (not (= (to_rep (select name index1)) 0)))) (= index1 index6)))
(assert (=> (not (and (< index1 129) (not (= (to_rep (select name index1)) 0)))) (= index7 index1)))
(assert (= rr_type__wirenamelength__result1 rr_type__wirenamelength__result2))
(assert (= rr_type__wirenamelength__result3 rr_type__wirenamelength__result1))
(assert (= (mk_int__ref result2) (mk_int__ref rr_type__wirenamelength__result)))
(assert (= rr_type__wirenamelength__result1 index6))
(assert (= (mk_int__ref rr_type__wirenamelength__result4) (mk_int__ref rr_type__wirenamelength__result2)))
(assert (= (mk_int__ref index8) index10))
(assert (= rr_type__wirenamelength__result5 rr_type__wirenamelength__result3))
(assert (= index9 index7))
(assert (= result3 rr_type__wirenamelength__result4))
(assert (not (or (= rr_type__wirenamelength__result4 129) (and (= (to_rep (select name rr_type__wirenamelength__result4)) 0) (forall ((q Int)) (=> (and (<= 1 q) (<= q (- rr_type__wirenamelength__result4 1))) (not (= (to_rep (select name q)) 0))))))))
(check-sat)
(exit)
