...
(declare-const temp___349 (Array Int Bool))
...
(assert (= x1 0))
(assert (=> (and (<= 0 x1) (<= x1 255)) (= temp___351 x1)))
(assert (=> (and (<= 0 x1) (<= x1 255)) (= temp___349 r)))
...
(assert (=> (and (<= 0 x1) (<= x1 255)) (and (and (forall ((temp___350 Int)) (=> (and (<= 0 temp___350) (<= temp___350 255)) (=> (or (< 255 temp___350) (or (< temp___350 0) (< x2 temp___350))) (= (select r3 temp___350) (select temp___349 temp___350))))) (=> (<= 0 255) (in_range1 x2))) (and (<= 0 x2) (<= x2 255)))))
...
(assert (<= i 255))
(assert (= i c))
(assert (not (= (select arrays__single_char_set__result4 i) true)))
(check-sat)
(exit)
