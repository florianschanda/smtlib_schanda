...
(define-fun dynamic_invariant1 ((temp___expr_261 Int) (temp___is_init_257 Bool) (temp___skip_constant_258 Bool) (temp___do_toplevel_259 Bool) (temp___do_typ_inv_260 Bool)) Bool (=> (or (= temp___is_init_257 true) (<= 0 12)) (in_range4 temp___expr_261)))
(assert (forall ((fruit Int)) (! (=> (dynamic_invariant fruit true true true true) (dynamic_invariant1 (fruits_to_fruits_and_weapons fruit) true false true true)) :pattern ((fruits_to_fruits_and_weapons fruit)))))
(assert (forall ((fruit Int)) (! (=> (dynamic_invariant fruit true true true true) (= (fruits_to_fruits_and_weapons fruit) fruit)) :pattern ((fruits_to_fruits_and_weapons fruit)))))
(declare-fun to_rep1 (fruits_and_weapons) Int)
(declare-fun of_rep1 (Int) fruits_and_weapons)
(assert (forall ((x fruits_and_weapons)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x fruits_and_weapons)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x fruits)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x fruits)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq ((a (Array Int fruits)) (a__first Int) (a__last Int) (b (Array Int fruits)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep2 (select a temp___idx_156)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_156))))))) true false))
...
(assert (forall ((a (Array Int fruits_and_weapons))) (forall ((first Int)) (! (= (slide1 a first first) a) :pattern ((slide1 a first first))))))
...
(define-fun dynamic_invariant2 ((temp___expr_371 us_t) (temp___is_init_367 Bool) (temp___skip_constant_368 Bool) (temp___do_toplevel_369 Bool) (temp___do_typ_inv_370 Bool)) Bool (=> (not (= temp___skip_constant_368 true)) (dynamic_property 1 2147483647 (first1 temp___expr_371) (last1 temp___expr_371))))
...
(declare-datatypes () ((new_item_t__ref (mk_new_item_t__ref (new_item_t__content new_item_t)))))
(define-fun new_item_t__ref___projection ((a new_item_t__ref)) new_item_t (new_item_t__content a))
(define-fun dynamic_invariant3 ((temp___expr_412 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool) (temp___do_typ_inv_411 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 0 12)) (in_range5 temp___expr_412)))
(declare-sort t1 0)
...
(define-fun dynamic_invariant6 ((temp___expr_419 us_t1) (temp___is_init_415 Bool) (temp___skip_constant_416 Bool) (temp___do_toplevel_417 Bool) (temp___do_typ_inv_418 Bool)) Bool (=> (not (= temp___skip_constant_416 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_419) (last3 temp___expr_419))))
...
(assert (dynamic_invariant2 old_inventory true false true true))
(assert (dynamic_property1 1 2147483647 (to_rep new_inventory__first) (to_rep new_inventory__last)))
(assert (in_range5 new_content))
(assert (and (= (to_rep (first (rt old_inventory))) (to_rep new_inventory__first)) (= (to_rep (last (rt old_inventory))) (to_rep new_inventory__last))))
(assert (= result i))
(assert (= i1 (to_rep (first (rt old_inventory)))))
(assert (<= (to_rep (first (rt old_inventory))) i1))
(assert (<= i1 (to_rep (last (rt old_inventory)))))
(assert (and (forall ((temp___523 Int)) (=> (and (<= (to_rep new_inventory__first) temp___523) (<= temp___523 (to_rep new_inventory__last))) (=> (or (< (to_rep (last (rt old_inventory))) temp___523) (or (< temp___523 (to_rep (first (rt old_inventory)))) (<= i2 temp___523))) (= (select new_inventory1 temp___523) (select new_inventory temp___523))))) (and (<= (to_rep (first (rt old_inventory))) i2) (<= i2 (to_rep (last (rt old_inventory)))))))
(assert (and (= result1 (found_none (to_rep2 (select (elts old_inventory) i2)))) (= (= result1 true) (= (to_rep2 (select (elts old_inventory) i2)) 0))))
(assert (not (= result1 true)))
(assert (and (= o (fruits_to_fruits_and_weapons (to_rep2 (select (elts old_inventory) i2)))) (and (in_range4 o) (= o (to_rep2 (select (elts old_inventory) i2))))))
(assert (= (to_rep1 o1) o))
(assert (not (<= (to_rep new_inventory__first) i2)))
(check-sat)
(exit)
