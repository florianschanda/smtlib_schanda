...
(declare-const o44 track_id)
(declare-const o45 track_id)
(declare-const o46 Int)
(declare-const o47 track_id)
(declare-const o48 natural)
(declare-const o49 track_id)
...
(assert (= o46 other_train))
(assert (= (mk___rep (mk___split_fields o47 o48 o49)) (select trains o46)))
(assert (= o50 (mk___split_fields o47 o48 o49)))
(assert (= o51 (rec__trains__train_position__track_begin o50)))
(assert (= o52 (to_rep o51)))
(assert (and (<= 1 train) (<= train 10)))
(assert (= o38 train))
(assert (= (mk___rep (mk___split_fields o39 o40 o41)) (select trains o38)))
(assert (= o39 o42))
(assert (= o40 o43))
(assert (= o41 o44))
(assert (= o45 o42))
(assert (= o53 (to_rep o45)))
(assert (= o54 (ite (= o53 o52) true false)))
(assert (= result2 (ite (not (= o54 true)) true false)))
(assert (=> (= result2 true) (and (<= 1 other_train) (<= other_train 10))))
(assert (=> (= result2 true) (= o27 other_train)))
(assert (=> (= result2 true) (= (mk___rep (mk___split_fields o28 o29 o30)) (select trains o27))))
(assert (=> (= result2 true) (= o28 o31)))
(assert (=> (= result2 true) (= o29 o32)))
(assert (=> (= result2 true) (= o30 o33)))
(assert (=> (= result2 true) (= o34 o33)))
(assert (=> (= result2 true) (= o35 (to_rep o34))))
(assert (=> (= result2 true) (and (<= 1 train) (<= train 10))))
(assert (=> (= result2 true) (= o19 train)))
(assert (=> (= result2 true) (= (mk___rep (mk___split_fields o20 o21 o22)) (select trains o19))))
(assert (=> (= result2 true) (= o20 o23)))
(assert (=> (= result2 true) (= o21 o24)))
(assert (=> (= result2 true) (= o22 o25)))
(assert (=> (= result2 true) (= o26 o23)))
(assert (=> (= result2 true) (= o36 (to_rep o26))))
(assert (=> (= result2 true) (= o37 (ite (= o36 o35) true false))))
(assert (=> (= result2 true) (= result1 (ite (not (= o37 true)) true false))))
