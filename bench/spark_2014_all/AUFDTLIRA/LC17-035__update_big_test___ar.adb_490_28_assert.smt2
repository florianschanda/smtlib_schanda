...
(declare-fun temp_____aggregate_def_4672 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_4678 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___4674 (Array Int (Array Int et1)))) (forall ((temp___4675 Int)) (forall ((temp___4676 (Array Int et1))) (let ((temp___4673 (temp_____aggregate_def_4672 temp___4674 temp___4675 temp___4676))) (=> (dynamic_invariant1 temp___4675 true true true true) (forall ((temp___4677 Int)) (ite (= temp___4677 temp___4675) (= (select temp___4673 temp___4677) temp___4676) (= (select temp___4673 temp___4677) (select temp___4674 temp___4677))))))))))
(assert (forall ((temp___4680 (Array Int et1))) (forall ((temp___4681 Int) (temp___4682 Int)) (let ((temp___4679 (temp_____aggregate_def_4678 temp___4680 temp___4681 temp___4682))) (=> (and (dynamic_invariant temp___4681 true true true true) (dynamic_invariant2 temp___4682 true true true true)) (forall ((temp___4683 Int)) (ite (= temp___4683 temp___4681) (= (to_rep (select temp___4679 temp___4683)) temp___4682) (= (select temp___4679 temp___4683) (select temp___4680 temp___4683)))))))))
...
(assert (= result1 a))
(assert (= a1 o2))
(assert (not (= (bool_eq1 a1 5 50 (temp_____aggregate_def_4672 t1 j (temp_____aggregate_def_4678 (select t1 j) i e)) 5 50) true)))
(check-sat)
(exit)
