...
(assert (= o4 (+ o3 1)))
(assert (and (= temp___308 o4) (in_range1 o4)))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 temp___308))
(assert (and (= o5 (- (to_rep1 (last (rt needle))) 1)) (in_range1 (- (to_rep1 (last (rt needle))) 1))))
(assert (= o6 (+ i1 o5)))
(assert (and (= temp___309 o6) (in_range1 o6)))
(assert (<= i1 temp___309))
(assert (not (<= (to_rep1 (first (rt haystack))) i1)))
(check-sat)
(exit)
