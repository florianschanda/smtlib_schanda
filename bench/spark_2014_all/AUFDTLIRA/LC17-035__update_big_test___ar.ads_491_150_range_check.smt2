...
(assert (< k 16))
(assert (< 0 e))
(assert (and (= o7 (- e 1)) (in_range4 (- e 1))))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o6 (+ k 1)))
(assert (= temp___5570 (select a o6)))
(assert (= o8 (select temp___5570 j)))
(assert (= o9 (temp_____aggregate_def_1904 o8 i o7)))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o5 (+ k 1)))
(assert (= o10 (select a o5)))
(assert (= o11 (temp_____aggregate_def_1897 o10 j o9)))
