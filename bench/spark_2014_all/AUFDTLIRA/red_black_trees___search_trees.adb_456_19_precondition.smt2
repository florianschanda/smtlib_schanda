...
(declare-const temp___1626 (Array Int us_rep3))
...
(assert (= o42 (select temp___1629 i2)))
(assert (= o43 (us_split_fields5 o42)))
(assert (= o44 (rec__tree_model__path_type__a o43)))
(assert (and (= o45 (length o44)) (and (in_range2 o45) (<= (+ 0 o45) 2147483647))))
(assert (= o46 (+ o45 1)))
(assert (and (= o47 o46) (in_range8 o46)))
...
(assert (= o33 (select temp___1627 i2)))
...
(assert (and (= temp___1626 (model__ f root)) (and (dynamic_invariant5 temp___1626 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1626 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1626 root)))) 0) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (not (= i3 root)) (ite (and (not (= (parent f i3) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1626 (parent f i3)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1626 i3))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1626 i3))) true)))))) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1626 i3))) true) (not (= i3 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1626 (parent f i3)))) (position f i3) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1626 i3)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1626 i3)))) 0)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1626 i3))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1626 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1626 i3))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1626 j2)))) true)) (= j2 i3))))))))))))))
(assert (= o30 (select temp___1626 v)))
