...
(assert (<= i 100))
(assert (not (= i x2)))
(assert (and (= o9 (parent (rec__red_black_trees__rbt__struct t__split_fields7) i)) (and (in_range2 o9) (and (= o9 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct t__split_fields7))) i)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields7)) 0) (= o9 0))))))
(assert (= result5 (ite (= o9 0) true false)))
(assert (not (= result5 true)))
(assert (and (= temp___992 (parent (rec__red_black_trees__rbt__struct t__split_fields7) i)) (and (in_range2 temp___992) (and (= temp___992 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct t__split_fields7))) i)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields7)) 0) (= temp___992 0))))))
(assert (not (<= temp___992 100)))
(check-sat)
(exit)
