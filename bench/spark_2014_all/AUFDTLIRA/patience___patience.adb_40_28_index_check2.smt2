...
(declare-const temp___578 (Array Int cardindex))
...
(assert (and (<= 0 topstacki2) (< topstacki2 (to_rep s__split_fields))))
(assert (and (<= 0 topstacki2) (<= topstacki2 99)))
(assert (= o32 topstacki2))
(assert (= o33 (select s__split_fields5 o32)))
(assert (= o34 (to_rep o33)))
(assert (= result9 (ite (<= 0 o34) true false)))
(assert (=> (= result9 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result9 true) (= o29 topstacki2)))
(assert (=> (= result9 true) (= o30 (select s__split_fields5 o29))))
(assert (=> (= result9 true) (= o31 (to_rep o30))))
(assert (=> (= result9 true) (= result8 (ite (< o31 (to_rep s__split_fields2)) true false))))
(assert (=> (not (= result9 true)) (= result8 false)))
(assert (=> (= result8 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result8 true) (= o26 topstacki2)))
(assert (=> (= result8 true) (= o27 (select s__split_fields6 o26))))
(assert (=> (= result8 true) (= o28 (to_rep o27))))
(assert (=> (= result8 true) (= result7 (ite (<= 0 o28) true false))))
(assert (=> (not (= result8 true)) (= result7 false)))
(assert (=> (= result7 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result7 true) (= o20 topstacki2)))
(assert (=> (= result7 true) (= o21 (select s__split_fields5 o20))))
(assert (=> (= result7 true) (= temp___574 (to_rep o21))))
(assert (=> (= result7 true) (and (<= 0 temp___574) (<= temp___574 99))))
(assert (=> (= result7 true) (= o22 temp___574)))
(assert (=> (= result7 true) (= o23 (select s__split_fields3 o22))))
(assert (=> (= result7 true) (= o24 (to_rep o23))))
(assert (=> (= result7 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result7 true) (= o18 topstacki2)))
(assert (=> (= result7 true) (= o19 (select s__split_fields6 o18))))
(assert (=> (= result7 true) (= o25 (to_rep o19))))
(assert (=> (= result7 true) (= result6 (ite (< o25 o24) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (=> (= result6 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result6 true) (= o10 topstacki2)))
(assert (=> (= result6 true) (= o11 (select s__split_fields5 o10))))
(assert (=> (= result6 true) (= temp___577 (to_rep o11))))
(assert (=> (= result6 true) (and (<= 0 temp___577) (<= temp___577 99))))
(assert (=> (= result6 true) (= o12 temp___577)))
(assert (=> (= result6 true) (= temp___578 (select s__split_fields4 o12))))
(assert (=> (= result6 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result6 true) (= o13 topstacki2)))
(assert (=> (= result6 true) (= o14 (select s__split_fields6 o13))))
(assert (=> (= result6 true) (= temp___580 (to_rep o14))))
(assert (=> (= result6 true) (and (<= 0 temp___580) (<= temp___580 99))))
(assert (=> (= result6 true) (= o15 temp___580)))
(assert (=> (= result6 true) (= o16 (select temp___578 o15))))
(assert (=> (= result6 true) (= o17 (to_rep o16))))
(assert (=> (= result6 true) (= result5 (ite (= o17 topstacki2) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (= result5 true))
(assert (not (<= 0 topstacki2)))
(check-sat)
(exit)
