...
(assert (not (<= (to_rep1 (first6 (rt3 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields__content4 current__split_fields6))))))) (int__content result__3))))
(check-sat)
(exit)
