...
(assert (and (and (forall ((temp___1582 Int)) (=> (and (<= (to_rep1 n__first) temp___1582) (<= temp___1582 (to_rep1 n__last))) (=> (or (< temp___1579 temp___1582) (or (< temp___1582 (to_rep1 (first (rt source)))) (< index2 temp___1582))) (= (select n3 temp___1582) (select n1 temp___1582))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9)))))
