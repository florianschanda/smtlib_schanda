...
(assert (forall ((x set_length)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x element_t)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert true)
(assert (forall ((s us_rep)) (! (= (= (valid s) true) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep (rec__natural_set__t__len (us_split_fields1 s))))) (in_range2 (to_rep1 (let ((temp___202 (rec__natural_set__t__m (us_split_fields1 s)))) (select temp___202 i)))))) (forall ((i Int)) (=> (and (<= (+ (to_rep (rec__natural_set__t__len (us_split_fields1 s))) 1) i) (<= i 10)) (= (to_rep1 (let ((temp___203 (rec__natural_set__t__m (us_split_fields1 s)))) (select temp___203 i))) (- 1)))))) :pattern ((valid s)))))
...
(define-fun dynamic_invariant1 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= (- 1) 2147483647)) (in_range1 temp___expr_173)))
...
(assert (not (= (members (mk___rep (mk___split_fields s__split_fields4 s__split_fields5))) 0)))
(check-sat)
(exit)
