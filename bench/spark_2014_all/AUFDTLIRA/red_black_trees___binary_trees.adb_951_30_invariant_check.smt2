...
(declare-const temp___1888 (Array Int us_rep1))
...
(assert (and (= temp___1888 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant1 temp___1888 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1888 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1888 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1888 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1888 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1888 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1888 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1888 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1888 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1888 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1888 i))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1888 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1888 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1888 j1)))) true)) (= j1 i))))))))))))))
(assert (= (mk___rep (mk___split_fields o5 o6)) (select temp___1888 v)))
(assert (= o5 o7))
(assert (= o6 o8))
(assert (= o9 o8))
(assert (= result (ite (not (= o9 true)) true false)))
(assert (= result true))
(assert (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 v)))) 0)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
(assert (and (= temp___1884 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant1 temp___1884 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1884 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1884 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1884 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1884 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1884 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1884 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1884 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1884 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1884 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1884 i))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1884 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1884 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1884 j1)))) true)) (= j1 i))))))))))))))
(assert (and (<= 1 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 v))))) (<= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 v)))) 100)))
(assert (= o (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 v))))))
(assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___1884 o)))
(assert (= o1 o3))
(assert (= o2 o4))
(assert (= result1 o4))
(assert (= result1 true))
(assert (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 v)))) 0))
(assert (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 v)))) 0))
...
(assert (= result3 true))
(assert (= (= result4 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root) j1))) true)) (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 j1)))) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f_old__split_fields1 j1))))))))))
(assert (= result4 true))
(assert (<= 1 j))
(assert (<= j 100))
