...
(define-fun dynamic_invariant2 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= first 1)) (dynamic_property first 1 temp___expr_249)))
(assert (= first zero))
...
(define-fun taS__ref___2__projection ((a taS__ref1)) integer (taS__content1 a))
(define-fun dynamic_invariant3 ((temp___expr_256 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= first1 last)) (dynamic_property1 first1 last temp___expr_256)))
(assert (= first1 zero))
(assert (= last (- zero 1)))
...
(assert (forall ((i tTaSP1)) (and (<= 1 (tTaSP1qtint i)) (<= (tTaSP1qtint i) 10))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep1 (first2 (mk f l))) f) (= (to_rep1 (last1 (mk f l))) l)))) :pattern ((mk f l)))))
...
(define-fun length ((a us_t)) Int (ite (<= (first3 a) (last2 a)) (+ (- (last2 a) (first3 a)) 1) 0))
...
(define-fun bool_eq1 ((x us_t) (y us_t)) Bool (bool_eq (elts x) (to_rep1 (first2 (rt x))) (to_rep1 (last1 (rt x))) (elts y) (to_rep1 (first2 (rt y))) (to_rep1 (last1 (rt y)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep1 (first4 (mk1 f l))) f) (= (to_rep1 (last3 (mk1 f l))) l)))) :pattern ((mk1 f l)))))
...
(define-fun first5 ((a us_t1)) Int (to_rep1 (first4 (rt1 a))))
(define-fun last4 ((a us_t1)) Int (to_rep1 (last3 (rt1 a))))
(define-fun length1 ((a us_t1)) Int (ite (<= (first5 a) (last4 a)) (+ (- (last4 a) (first5 a)) 1) 0))
...
(define-fun bool_eq2 ((x us_t1) (y us_t1)) Bool (bool_eq (elts1 x) (to_rep1 (first4 (rt1 x))) (to_rep1 (last3 (rt1 x))) (elts1 y) (to_rep1 (first4 (rt1 y))) (to_rep1 (last3 (rt1 y)))))
...
(declare-fun do_checks__do_range_check__B_17__a__aggregate_def (Int Int Int) us_t)
(declare-fun do_checks__do_range_check__B_18__a__aggregate_def (Int Int Int) us_t1)
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep1 (first6 (mk2 f l))) f) (= (to_rep1 (last5 (mk2 f l))) l)))) :pattern ((mk2 f l)))))
(define-fun dynamic_property6 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range1 low) (and (in_range1 high) (=> (<= low high) (and (in_range3 low) (in_range3 high))))))
...
(define-fun length2 ((a us_t2)) Int (ite (<= (first7 a) (last6 a)) (+ (- (last6 a) (first7 a)) 1) 0))
...
(define-fun bool_eq3 ((x us_t2) (y us_t2)) Bool (bool_eq (elts2 x) (to_rep1 (first6 (rt2 x))) (to_rep1 (last5 (rt2 x))) (elts2 y) (to_rep1 (first6 (rt2 y))) (to_rep1 (last5 (rt2 y)))))
...
(define-fun dynamic_invariant6 ((temp___expr_96 us_t2) (temp___is_init_92 Bool) (temp___skip_constant_93 Bool) (temp___do_toplevel_94 Bool) (temp___do_typ_inv_95 Bool)) Bool (=> (not (= temp___skip_constant_93 true)) (dynamic_property6 1 2147483647 (first7 temp___expr_96) (last6 temp___expr_96))))
(assert (forall ((temp___871 Int) (temp___872 Int) (temp___873 Int)) (let ((temp___870 (do_checks__do_range_check__B_17__a__aggregate_def temp___871 temp___872 temp___873))) (=> (dynamic_invariant5 temp___871 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___872 temp___873) (and (= (first3 temp___870) temp___872) (= (last2 temp___870) temp___873))) (forall ((temp___874 Int)) (= (to_rep (select (to_array temp___870) temp___874)) temp___871)))))))
(assert (forall ((temp___878 Int) (temp___879 Int) (temp___880 Int)) (let ((temp___877 (do_checks__do_range_check__B_18__a__aggregate_def temp___878 temp___879 temp___880))) (=> (dynamic_invariant5 temp___878 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___879 temp___880) (and (= (first5 temp___877) temp___879) (= (last4 temp___877) temp___880))) (forall ((temp___881 Int)) (= (to_rep (select (to_array1 temp___877) temp___881)) temp___878)))))))
...
(assert (not (= branch 8)))
(assert (not (= branch 9)))
(assert (not (= branch 10)))
(assert (not (= branch 11)))
(assert (not (= branch 12)))
(assert (not (= branch 13)))
(assert (not (= branch 16)))
(assert (not (= branch 17)))
(assert (= branch 18))
(assert (<= zero 1))
(assert (not (<= 1 2147483647)))
(check-sat)
(exit)
