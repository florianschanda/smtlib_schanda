...
(declare-fun temp_____aggregate_def_530 (Int Int Int) us_t1)
...
(assert (forall ((temp___532 Int) (temp___533 Int) (temp___534 Int)) (let ((temp___531 (temp_____aggregate_def_530 temp___532 temp___533 temp___534))) (=> (dynamic_invariant3 temp___532 true true true true) (and (=> (dynamic_property4 1 2147483647 temp___533 temp___534) (and (= (first3 temp___531) temp___533) (= (last3 temp___531) temp___534))) (forall ((temp___535 Int)) (= (to_rep1 (select (to_array1 temp___531) temp___535)) temp___532)))))))
(declare-const temp___908 Int)
(declare-const temp___907 natural_index)
(declare-const temp___910 (Array Int character))
(declare-const temp___9101 t1)
(assert (in_range temp___908))
(assert (= temp___908 (to_rep temp___907)))
(assert (= (to_rep2 (first2 (rt1 (temp_____aggregate_def_530 32 1 temp___908)))) 1))
(assert (= (to_rep2 (last2 (rt1 (temp_____aggregate_def_530 32 1 temp___908)))) temp___908))
(assert (= (mk___t1 temp___910 temp___9101) (temp_____aggregate_def_530 32 1 temp___908)))
(assert (not (= (ite (<= (to_rep2 (first2 temp___9101)) (to_rep2 (last2 temp___9101))) (+ (- (to_rep2 (last2 temp___9101)) (to_rep2 (first2 temp___9101))) 1) 0) (ite (<= 1 temp___908) (+ (- temp___908 1) 1) 0))))
(check-sat)
(exit)
