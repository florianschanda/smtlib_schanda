...
(assert (= ic__split_fields8 (mk___split_fields i__split_fields9 i__split_fields10 i__split_fields11 i__split_fields12)))
...
(assert (not (< (to_rep1 (rec__ints__int__value ic__split_fields10)) (- (to_rep1 (rec__ints__int__max ic__split_fields10)) 10))))
(check-sat)
(exit)
