...
(assert (not (= (ite (<= (to_rep1 (first8 temp___25031)) (to_rep1 (last8 temp___25031))) (+ (- (to_rep1 (last8 temp___25031)) (to_rep1 (first8 temp___25031))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3)) (+ (- (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 1)) 1) 0))))
(check-sat)
(exit)
