...
(declare-fun temp_____aggregate_def_312 (Int Int Int) us_t1)
...
(assert (forall ((temp___314 Int) (temp___315 Int) (temp___316 Int)) (let ((temp___313 (temp_____aggregate_def_312 temp___314 temp___315 temp___316))) (=> (dynamic_invariant2 temp___314 true true true true) (and (=> (dynamic_property 1 2147483647 temp___315 temp___316) (and (= (first3 temp___313) temp___315) (= (last3 temp___313) temp___316))) (forall ((temp___317 Int)) (= (to_rep (select (to_array1 temp___313) temp___317)) temp___314)))))))
(declare-const b Int)
(declare-const temp___319 (Array Int character))
(declare-const temp___3191 t1)
(declare-const temp___320 (Array Int character))
(declare-const temp___3201 t)
...
(assert (= (to_rep1 (first2 (rt1 (temp_____aggregate_def_312 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__first)))
(assert (= (to_rep1 (last2 (rt1 (temp_____aggregate_def_312 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__last)))
(assert (= (mk___t1 temp___319 temp___3191) (temp_____aggregate_def_312 32 (to_rep1 a__first) (to_rep1 a__last))))
(assert (= temp___319 temp___320))
(assert (= (mk (to_rep1 (first2 temp___3191)) (to_rep1 (last2 temp___3191))) temp___3201))
(assert (not (= (ite (<= (to_rep1 (first temp___3201)) (to_rep1 (last temp___3201))) (+ (- (to_rep1 (last temp___3201)) (to_rep1 (first temp___3201))) 1) 0) (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1) 0))))
(check-sat)
(exit)
