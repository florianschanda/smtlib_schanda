...
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i2))) (=> (and (<= 0 j1) (<= j1 (- i2 1))) (= temp___777 winners3))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i2))) (=> (and (<= 0 j1) (<= j1 (- i2 1))) (= temp___776 j1))))
...
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i2))) (=> (and (<= 0 j1) (<= j1 (- i2 1))) (and (and (=> (<= 0 (- i2 1)) (dynamic_property1 0 (- i2 1) j2)) (forall ((temp___778 Int)) (=> (and (<= 0 temp___778) (<= temp___778 20)) (=> (or (< (- i2 1) temp___778) (or (< temp___778 0) (<= j2 temp___778))) (= (select winners4 temp___778) (select temp___777 temp___778)))))) (and (<= 0 j2) (<= j2 (- i2 1)))))))
...
(assert (not (< (int__content latest_highest_score7) (int__content i4))))
(check-sat)
(exit)
