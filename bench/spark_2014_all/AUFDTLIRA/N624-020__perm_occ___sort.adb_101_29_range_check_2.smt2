...
(assert (=> (not (= smallest1 current1)) (and (and (and (= (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t o16 (mk (to_rep1 values__first) (to_rep1 values__last)))) true) (= (to_rep (select o16 o8)) (to_rep (select values smallest1)))) (= (to_rep (select o16 smallest1)) (to_rep (select values o8)))) (forall ((z Int)) (=> (and (<= (to_rep1 values__first) z) (<= z (to_rep1 values__last))) (=> (and (not (= z o8)) (not (= z smallest1))) (= (to_rep (select o16 z)) (to_rep (select values z)))))))))
...
(assert (= (ite (<= (to_rep1 (first2 temp___2733)) (to_rep1 (last2 temp___2733))) (+ (- (to_rep1 (last2 temp___2733)) (to_rep1 (first2 temp___2733))) 1) 0) (ite (<= (to_rep1 previous__first) (to_rep1 previous__last)) (+ (- (to_rep1 previous__last) (to_rep1 previous__first)) 1) 0)))
(assert (= (mk___t1 o13 o14) (mk___t1 temp___2732 temp___2733)))
(assert (= o15 o13))
(assert (= previous3 result6))
(assert (= previous4 o15))
(assert (not (in_range3 current3)))
(check-sat)
(exit)
