...
(assert (not (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f v) j14))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f v) i9)))) 1)) 0)))
(assert (not (< (to_rep (select values i9)) (to_rep (select values j14)))))
(check-sat)
(exit)
