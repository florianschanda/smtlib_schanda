...
(define-fun o25 () us_t (mk___t o23 o24))
(define-fun o26 () us_t (mk___t o20 o21))
(define-fun o27 () us_t (mk___t o18 o19))
(define-fun o28 () us_t (mk___t o14 o15))
(define-fun o29 () us_t (mk___t o11 o12))
(define-fun o30 () us_t (mk___t o8 o9))
(define-fun o31 () us_t (mk___t o6 o7))
...
(assert (and (= o29 (remove a o10)) (and (dynamic_invariant o29 true false true true) (and (= (invariant__ o29) true) (and (= (to_rep1 (last o12)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o10 1))) (= (to_rep (select (elts a) k)) (to_rep (select o11 k))))) (and (forall ((k Int)) (=> (and (<= (+ o10 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o11 (- k 1)))))) (forall ((k Int)) (=> (and (<= o10 k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o11 k))))))))))))
(assert (and (= o28 (remove o29 o13)) (and (dynamic_invariant o28 true false true true) (and (= (invariant__ o28) true) (and (= (to_rep1 (last o15)) (- (to_rep1 (last o12)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select o11 k)) (to_rep (select o14 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last o12)))) (= (to_rep (select o11 k)) (to_rep (select o14 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep1 (last o12)) 1))) (= (to_rep (select o11 (+ k 1))) (to_rep (select o14 k))))))))))))
(assert (and (= o30 (remove bb ib1)) (and (dynamic_invariant o30 true false true true) (and (= (invariant__ o30) true) (and (= (to_rep1 (last o9)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o8 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o8 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o8 k))))))))))))
(assert (and (= o5 ia1) (in_range3 ia1)))
(assert (and (= o31 (remove aa o5)) (and (dynamic_invariant o31 true false true true) (and (= (invariant__ o31) true) (and (= (to_rep1 (last o7)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o5 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o6 k))))) (and (forall ((k Int)) (=> (and (<= (+ o5 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o6 (- k 1)))))) (forall ((k Int)) (=> (and (<= o5 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o6 k))))))))))))
(assert (and (= o16 (shift_perm_l o31 o30 o28)) (and (in_range4 o16) (=> (= (distinct o16 0) true) (= (is_perm o28 o30) true)))))
...
(assert (and (= o22 (- (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)) (in_range3 (- (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))
(assert (and (= o26 (remove b ib1)) (and (dynamic_invariant o26 true false true true) (and (= (invariant__ o26) true) (and (= (to_rep1 (last o21)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts b) k)) (to_rep (select o20 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o20 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o20 k))))))))))))
(assert (and (= o25 (remove o26 o22)) (and (dynamic_invariant o25 true false true true) (and (= (invariant__ o25) true) (and (= (to_rep1 (last o24)) (- (to_rep1 (last o21)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o22 1))) (= (to_rep (select o20 k)) (to_rep (select o23 k))))) (and (forall ((k Int)) (=> (and (<= (+ o22 1) k) (<= k (to_rep1 (last o21)))) (= (to_rep (select o20 k)) (to_rep (select o23 (- k 1)))))) (forall ((k Int)) (=> (and (<= o22 k) (<= k (- (to_rep1 (last o21)) 1))) (= (to_rep (select o20 (+ k 1))) (to_rep (select o23 k))))))))))))
(assert (and (= o27 (remove bb ib1)) (and (dynamic_invariant o27 true false true true) (and (= (invariant__ o27) true) (and (= (to_rep1 (last o19)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o18 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o18 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o18 k))))))))))))
(assert (not (in_range3 (- (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))))
(check-sat)
(exit)
