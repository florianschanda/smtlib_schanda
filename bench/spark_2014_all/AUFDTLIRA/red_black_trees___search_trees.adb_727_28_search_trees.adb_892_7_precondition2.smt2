...
(assert (not (= yl1 0)))
(assert (and (= o9 yl1) (in_range5 yl1)))
...
(assert (and (= temp___863 (model__ (mk___rep2 f_2__split_fields3) y1)) (and (dynamic_invariant3 temp___863 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___863 y1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___863 y1)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 y1)) (ite (and (not (= (parent (mk___rep2 f_2__split_fields3) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___863 (parent (mk___rep2 f_2__split_fields3) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___863 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___863 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___863 i1))) true) (not (= i1 y1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___863 (parent (mk___rep2 f_2__split_fields3) i1)))) (position (mk___rep2 f_2__split_fields3) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___863 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___863 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___863 i1))) true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___863 j3))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___863 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___863 j3)))) true)) (= j3 i1))))))))))))))
(assert (and (<= 1 yl1) (<= yl1 100)))
(assert (= o10 yl1))
(assert (= o11 (select temp___863 o10)))
