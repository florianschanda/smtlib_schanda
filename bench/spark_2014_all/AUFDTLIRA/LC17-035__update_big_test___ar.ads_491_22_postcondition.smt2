...
(assert (= a4 a2))
(assert (not (or (and (< k 16) (or (and (< 0 e) (= (bool_eq2 a3 1 16 (temp_____aggregate_def_1874 a k (temp_____aggregate_def_1882 (select a k) j (temp_____aggregate_def_1889 (select (select a k) j) i e)) (+ k 1) (temp_____aggregate_def_1897 (select a (+ k 1)) j (temp_____aggregate_def_1904 (select (select a (+ k 1)) j) i (- e 1)))) 1 16) true)) (and (= e 0) (= (bool_eq2 a3 1 16 (temp_____aggregate_def_1913 a k (temp_____aggregate_def_1921 (select a k) j (temp_____aggregate_def_1928 (select (select a k) j) i e)) (+ k 1) (temp_____aggregate_def_1936 (select a (+ k 1)) j (temp_____aggregate_def_1943 (select (select a (+ k 1)) j) i 99))) 1 16) true)))) (and (= k 16) (or (and (< 0 e) (= (bool_eq2 a3 1 16 (temp_____aggregate_def_1952 a k (temp_____aggregate_def_1960 (select a k) j (temp_____aggregate_def_1967 (select (select a k) j) i e)) 1 (temp_____aggregate_def_1975 (select a 1) j (temp_____aggregate_def_1982 (select (select a 1) j) i (- e 1)))) 1 16) true)) (and (= e 0) (= (bool_eq2 a3 1 16 (temp_____aggregate_def_1991 a k (temp_____aggregate_def_1999 (select a k) j (temp_____aggregate_def_2006 (select (select a k) j) i e)) 1 (temp_____aggregate_def_2014 (select a 1) j (temp_____aggregate_def_2021 (select (select a 1) j) i 99))) 1 16) true)))))))
(check-sat)
(exit)
