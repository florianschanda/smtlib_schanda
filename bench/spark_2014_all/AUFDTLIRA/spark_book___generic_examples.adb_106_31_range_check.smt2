...
(assert (= (mk2 (to_rep my_percents__first) (to_rep my_percents__last)) o5))
(assert (and (= o6 (percent_count (mk___t2 o4 o5) 5)) (in_range3 o6)))
(assert (= result3 the_count2))
(assert (= the_count3 o6))
(assert (not (dynamic_property3 0 255 (to_rep my_percents__first) (to_rep my_percents__last))))
(check-sat)
(exit)
