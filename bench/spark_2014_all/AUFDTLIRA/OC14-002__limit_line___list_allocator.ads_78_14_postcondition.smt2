...
(assert (=> (= (mem model____split_fields1 res) true) (and (and (= (is_prepend model____split_fields res (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields5))) true) (= (length (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields5))) (- (length model____split_fields1) 1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length model____split_fields1))) (=> (not (= (get model____split_fields1 j) res)) (= (mem (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields5)) (get model____split_fields1 j)) true)))))))
(assert (=> (not (= (mem model____split_fields1 res) true)) (= (oeq1 (mk___rep (us_split_fields__content model____split_fields5)) (mk___rep (mk___split_fields model____split_fields model____split_fields1))) true)))
(assert (not (= (is_valid (int__content first_available3) (int__content first_allocated3) (us_split_fields__content model____split_fields5) (map__content data5)) true)))
(check-sat)
(exit)
