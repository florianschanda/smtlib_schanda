...
(declare-const equality__l611_019_reduced_testcase_2__result Bool)
(declare-const result Bool)
(declare-const equality__l611_019_reduced_testcase_2__result1 Bool)
(declare-const equality__l611_019_reduced_testcase_2__result2 Bool)
(declare-const equality__l611_019_reduced_testcase_2__result3 Bool)
(declare-const equality__l611_019_reduced_testcase_2__result4 Bool)
(declare-const equality__l611_019_reduced_testcase_2__result5 Bool)
(declare-const result1 Bool)
(assert (and (and (and (= (bool_eq (rec__equality__sf_record_t__x (us_split_fields1 a)) 0 255 (rec__equality__sf_record_t__x (us_split_fields1 b)) 0 255) true) (= (bool_eq (rec__equality__sf_record_t__x (us_split_fields1 b)) 0 255 (rec__equality__sf_record_t__x (us_split_fields1 c)) 0 255) true)) (= (bool_eq (rec__equality__sf_record_t__x (us_split_fields1 c)) 0 255 (rec__equality__sf_record_t__x (us_split_fields1 d)) 0 255) true)) (or (= (bool_eq (rec__equality__sf_record_t__x (us_split_fields1 a)) 0 255 (rec__equality__sf_record_t__x (us_split_fields1 c)) 0 255) true) (not (= (bool_eq (rec__equality__sf_record_t__x (us_split_fields1 a)) 0 255 (rec__equality__sf_record_t__x (us_split_fields1 c)) 0 255) true)))))
(assert (= equality__l611_019_reduced_testcase_2__result1 equality__l611_019_reduced_testcase_2__result2))
(assert (= equality__l611_019_reduced_testcase_2__result3 equality__l611_019_reduced_testcase_2__result1))
(assert (= result equality__l611_019_reduced_testcase_2__result))
(assert (= equality__l611_019_reduced_testcase_2__result1 (distinct 1 0)))
(assert (= (mk_bool__ref equality__l611_019_reduced_testcase_2__result4) (mk_bool__ref equality__l611_019_reduced_testcase_2__result2)))
(assert (= equality__l611_019_reduced_testcase_2__result5 equality__l611_019_reduced_testcase_2__result3))
