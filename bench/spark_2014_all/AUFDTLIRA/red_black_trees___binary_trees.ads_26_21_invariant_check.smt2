...
(assert (= (tree_structure f) true))
(assert (and (= result2 (valid_root f i)) (and (= (= result2 true) (and (<= i (to_rep (rec__binary_trees__forest__s (us_split_fields3 f)))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i)))) 2))) (=> (< (size f) i) (not (= result2 true))))))
(assert (=> (= result2 true) (= result1 (ite (= binary_trees__parent__result4 0) true false))))
(assert (=> (not (= result2 true)) (= result1 (distinct 1 0))))
(assert (= result1 true))
