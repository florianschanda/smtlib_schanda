...
(assert (and (= o61 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 o61)))
(assert (= result11 (ite (in_range7 o61) true false)))
(assert (= result11 true))
(assert (and (= o59 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o59)))
(assert (= result12 (ite (< j o59) true false)))
(assert (= result12 true))
(assert (and (= o60 (+ j 1)) (in_range1 (+ j 1))))
(assert (not (<= o60 (length (rec__list_allocator__m__t__allocated model____split_fields3)))))
(check-sat)
(exit)
