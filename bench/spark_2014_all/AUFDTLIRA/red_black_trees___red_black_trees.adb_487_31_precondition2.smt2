...
(assert (and (= o29 (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields9)) o28)) (and (in_range2 o29) (and (= o29 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields9)))) o28)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields9))) 0) (= o29 0))))))
(assert (and (= o30 o29) (in_range4 o29)))
(assert (and (= o31 (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields9)) o30)) (and (in_range2 o31) (and (= o31 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields9)))) o30)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields9))) 0) (= o31 0))))))
(assert (and (= o32 o31) (in_range4 o31)))
(assert (not (not (= (size (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields9))) 0))))
(check-sat)
(exit)
