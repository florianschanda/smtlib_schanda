...
(declare-fun temp_____aggregate_def_1417 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(assert (forall ((temp___1419 (Array Int (Array Int (Array Int et1))))) (forall ((temp___1420 Int)) (forall ((temp___1421 (Array Int (Array Int et1)))) (let ((temp___1418 (temp_____aggregate_def_1417 temp___1419 temp___1420 temp___1421))) (=> (dynamic_invariant temp___1420 true true true true) (forall ((temp___1422 Int)) (ite (= temp___1422 temp___1420) (= (select temp___1418 temp___1422) temp___1421) (= (select temp___1418 temp___1422) (select temp___1419 temp___1422))))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq2 a2 1 16 (temp_____aggregate_def_1417 a i b) 1 16) true)))
(check-sat)
(exit)
