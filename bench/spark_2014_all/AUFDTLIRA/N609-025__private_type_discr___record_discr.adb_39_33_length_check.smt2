...
(assert (=> (<= 1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) (and (and (<= (to_rep1 (first (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))) 1) (<= 1 (to_rep1 (last (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))))) (and (<= (to_rep1 (first (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))) (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) (<= (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1) (to_rep1 (last (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))))))))
(assert (= o4 (elts (rec__record_discr__interm_result__to_search (us_split_fields3 r)))))
(assert (= o4 temp___297))
(assert (= (mk2 1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) temp___2971))
(assert (not (= (ite (<= (to_rep1 (first4 temp___2971)) (to_rep1 (last4 temp___2971))) (+ (- (to_rep1 (last4 temp___2971)) (to_rep1 (first4 temp___2971))) 1) 0) (ite (<= 1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) (+ (- (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1) 1) 1) 0))))
(check-sat)
(exit)
