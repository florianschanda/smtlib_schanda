...
(assert (<= 0 i13))
(assert (<= i13 (- (to_rep (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)))
(assert (not (<= (to_rep (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) i13)) (to_rep (rec__patience__state__numelts (us_split_fields__content s__split_fields20))))))
(check-sat)
(exit)
