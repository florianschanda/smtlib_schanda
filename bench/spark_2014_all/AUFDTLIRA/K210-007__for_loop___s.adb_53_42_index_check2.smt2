...
(assert (and (forall ((j1 Int)) (=> (and (<= index2 j1) (<= j1 10)) (= (to_rep (select dest2 j1)) (to_rep (select src j1))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- index2 1))) (= (to_rep (select src2 j1)) (to_rep (select src j1)))))))
...
(assert (= (= o5 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- index2 1))) (= (to_rep (select src2 j1)) (to_rep (select src j1)))))))
(assert (<= index2 j))
(assert (<= j 10))
(assert (and (<= 1 j) (<= j 10)))
(assert (= o2 j))
