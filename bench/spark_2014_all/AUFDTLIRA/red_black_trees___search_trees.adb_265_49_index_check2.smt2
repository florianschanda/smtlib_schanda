...
(declare-const temp___1457 (Array Int us_rep3))
...
(assert (and (<= 1 k) (<= k 100)))
(assert (= o25 k))
(assert (= o26 (select temp___1458 o25)))
...
(assert (and (= temp___1457 (model__ f v)) (and (dynamic_invariant5 temp___1457 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1457 v))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1457 v)))) 0) (and (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 100)) (=> (not (= i10 v)) (ite (and (not (= (parent f i10) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1457 (parent f i10)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1457 i10))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1457 i10))) true)))))) (and (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1457 i10))) true) (not (= i10 v))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1457 (parent f i10)))) (position f i10) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1457 i10)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1457 i10)))) 0)))) (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1457 i10))) true) (forall ((j14 Int)) (=> (and (<= 1 j14) (<= j14 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1457 j14))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1457 i10))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1457 j14)))) true)) (= j14 i10))))))))))))))
(assert (= o22 (select temp___1457 j1)))
(assert (= o23 (us_split_fields5 o22)))
(assert (= o24 (rec__tree_model__path_type__a o23)))
(assert (and (= o32 (get o24 o31)) (in_range3 o32)))
