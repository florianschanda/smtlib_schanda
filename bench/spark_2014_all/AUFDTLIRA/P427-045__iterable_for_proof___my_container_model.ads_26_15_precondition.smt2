...
(assert (= i8 i6))
(assert (= c9 c7))
(assert (and (= temp___229 (get_model c8)) (= temp___229 c8)))
(assert (and (= o (m_has_element temp___229 temp___228)) (= (= o true) (and (<= 1 temp___228) (<= temp___228 100)))))
(assert (= (= o1 true) (in_range1 temp___228)))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (not (= (m_has_element temp___229 temp___228) true)))
(check-sat)
(exit)
