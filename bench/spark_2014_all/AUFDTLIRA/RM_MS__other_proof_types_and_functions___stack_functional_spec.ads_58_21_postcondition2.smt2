...
(assert (not (= (count (state__2 (us_split_fields__content my_stack__split_fields5))) (+ (count (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1))) 1))))
(check-sat)
(exit)
