...
(assert (and (= (length source) 11) (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 48)) (forall ((index3 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index3))) true))))))
...
(assert (<= temp___2218 index1))
(assert (<= index1 temp___2219))
...
(assert (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) j1) (<= j1 index2)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1))))))
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10) index2)) (forall ((temp___2223 Int)) (=> (and (<= (to_rep1 n__first) temp___2223) (<= temp___2223 (to_rep1 n__last))) (=> (or (< temp___2219 temp___2223) (or (< temp___2223 temp___2218) (< index2 temp___2223))) (= (select n3 temp___2223) (select n1 temp___2223)))))) (and (<= (+ (to_rep1 (first (rt source))) 2) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
(assert (and (= o9 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (= o10 (ite (<= o9 j) true false)))
(assert (= result4 (ite (= o10 true) (ite (<= j index2) true false) false)))
(assert (= result4 true))
(assert (not (<= (to_rep1 int_array__first) j)))
(check-sat)
(exit)
