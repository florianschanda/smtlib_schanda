...
(declare-const j Int)
(declare-const temp___520 (Array Int integer))
(declare-const temp___5201 t)
...
(define-fun temp___5202 () us_t (mk___t temp___520 temp___5201))
...
(assert (and (= o6 (- i2 first4)) (in_range1 (- i2 first4))))
(assert (= o7 (+ o6 1)))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (and (= o10 (to__ (mk___rep s__split_fields4))) (and (dynamic_invariant1 o10 true false true true) (and (= (to_rep (first o5)) 1) (<= 0 (to_rep (last o5)))))))
...
(assert (and (= temp___5202 (to__ (mk___rep s__split_fields4))) (and (dynamic_invariant1 temp___5202 true false true true) (and (= (to_rep (first temp___5201)) 1) (<= 0 (to_rep (last temp___5201)))))))
(assert (not (in_range1 (- j first4))))
(check-sat)
(exit)
