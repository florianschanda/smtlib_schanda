...
(assert (not (= (ite (<= (to_rep (first temp___2781)) (to_rep (last temp___2781))) (+ (- (to_rep (last temp___2781)) (to_rep (first temp___2781))) 1) 0) (ite (<= (to_rep (first temp___2821)) (to_rep (last temp___2821))) (+ (- (to_rep (last temp___2821)) (to_rep (first temp___2821))) 1) 0))))
(check-sat)
(exit)
