...
(declare-const j Int)
(declare-const o Int)
(declare-const temp___2114 (Array Int us_rep3))
...
(assert (and (= temp___2114 (model__ (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o)) (and (dynamic_invariant8 temp___2114 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2114 o))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___2114 o)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o)) (ite (and (not (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2114 (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2114 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2114 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2114 i1))) true) (not (= i1 o))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___2114 (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i1)))) (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___2114 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___2114 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2114 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2114 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___2114 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___2114 j1)))) true)) (= j1 i1))))))))))))))
(assert (= (mk___rep2 (mk___split_fields2 o1 o2)) (select temp___2114 j)))
(assert (= o1 o3))
(assert (= o2 o4))
(assert (= result9 o4))
(assert (= result9 true))
