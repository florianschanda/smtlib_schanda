...
(declare-fun temp_____aggregate_def_3072 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (forall ((temp___3074 (Array Int et1))) (forall ((temp___3075 Int) (temp___3076 Int)) (let ((temp___3073 (temp_____aggregate_def_3072 temp___3074 temp___3075 temp___3076))) (=> (and (dynamic_invariant temp___3075 true true true true) (dynamic_invariant1 temp___3076 true true true true)) (forall ((temp___3077 Int)) (ite (= temp___3077 temp___3075) (= (to_rep (select temp___3073 temp___3077)) temp___3076) (= (select temp___3073 temp___3077) (select temp___3074 temp___3077)))))))))
...
(declare-const temp___7956 (Array Int et1))
(declare-const temp___79561 enum2t)
...
(assert (= temp___7956 o2))
(assert (= temp___79561 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___7956 r__split_fields2))
(assert (= temp___79561 r__split_fields3))
...
(assert (not (= (to_rep1 r__split_fields5) (to_rep1 r__split_fields1))))
(check-sat)
(exit)
