...
(declare-const temp___2069 Int)
(declare-const temp___2070 Int)
(declare-const o Int)
(declare-const o1 character)
(declare-const o2 Int)
(declare-const o3 Bool)
(declare-const temp___2071 Int)
(declare-const o4 Int)
(declare-const o5 character)
(declare-const o6 Int)
(declare-const o7 Bool)
(declare-const temp___2072 Int)
(declare-const o8 Int)
(declare-const o9 character)
(declare-const o10 Int)
(declare-const o11 Bool)
(declare-const temp___2073 Int)
...
(assert (= o18 (ite (<= index o17) true false)))
(assert (and (= o16 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (= o19 (ite (<= o16 index) true false)))
(assert (= result (ite (= o19 true) o18 false)))
(assert (= (= o20 true) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 6) index1) (<= index1 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
(assert (and (= temp___2073 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2073) (<= temp___2073 (to_rep1 (last (rt source))))))
(assert (= o12 temp___2073))
(assert (= o13 (select (elts source) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (< o14 56) true false)))
(assert (and (= temp___2072 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2072) (<= temp___2072 (to_rep1 (last (rt source))))))
(assert (= o8 temp___2072))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (= o10 52) true false)))
(assert (and (= temp___2071 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2071) (<= temp___2071 (to_rep1 (last (rt source))))))
(assert (= o4 temp___2071))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 55) true false)))
(assert (and (= temp___2070 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2070) (<= temp___2070 (to_rep1 (last (rt source))))))
(assert (= o temp___2070))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 52) true false)))
(assert (and (= temp___2069 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (not (<= (to_rep1 (first (rt source))) temp___2069)))
(check-sat)
(exit)
