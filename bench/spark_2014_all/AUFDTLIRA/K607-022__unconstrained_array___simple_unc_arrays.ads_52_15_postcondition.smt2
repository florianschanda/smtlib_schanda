...
(assert (not (exists ((j Int)) (and (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (= simple_unc_arrays__max__result4 (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j)))))))
(check-sat)
(exit)
