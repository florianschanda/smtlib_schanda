...
(assert (forall ((i t17b)) (and (<= 1 (t17bqtint i)) (<= (t17bqtint i) 9))))
...
(assert (forall ((i t21b)) (and (<= 1 (t21bqtint i)) (<= (t21bqtint i) 9))))
...
(assert (= z1 o7))
(assert (= (to_rep (select z1 1)) 1))
(assert (= (to_rep (select z1 10)) (to_rep (select x 9))))
(assert (<= 1 9))
(assert (not (<= 1 1)))
(check-sat)
(exit)
