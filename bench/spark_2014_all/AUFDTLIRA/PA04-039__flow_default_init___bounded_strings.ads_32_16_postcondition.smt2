...
(assert (= (length_typeqtint rliteral) 0))
...
(declare-const temp___235 index_type)
(declare-const temp___2351 (Array Int character))
(declare-const temp___2352 t)
(declare-const temp___2353 length_type)
...
(assert (= (ite (<= (to_rep3 (first2 temp___2311)) (to_rep3 (last2 temp___2311))) (+ (- (to_rep3 (last2 temp___2311)) (to_rep3 (first2 temp___2311))) 1) 0) (ite (<= (to_rep3 (first target__split_fields1)) (to_rep3 (last target__split_fields1))) (+ (- (to_rep3 (last target__split_fields1)) (to_rep3 (first target__split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___233 temp___2331) (mk___t1 temp___231 temp___2311)))
(assert (= temp___233 o))
(assert (= (mk (to_rep3 (first2 temp___2331)) (to_rep3 (last2 temp___2331))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= target__split_fields2 o4))
(assert (= target__split_discrs (mk___split_discrs temp___235)))
...
(assert (= temp___2351 target__split_fields3))
(assert (= temp___2352 target__split_fields4))
(assert (= temp___2353 target__split_fields5))
(assert (= target__split_discrs (mk___split_discrs temp___235)))
(assert (= result3 target__split_fields3))
(assert (= result4 target__split_fields4))
(assert (= result5 target__split_fields5))
(assert (= target__split_fields6 (mk___split_fields (mk___t target__split_fields3 target__split_fields4) rliteral)))
(assert (= target__split_fields7 (mk___split_fields__ref target__split_fields6)))
(assert (= target__split_fields8 target__split_fields6))
(assert (not (= (length1 (mk___rep target__split_discrs (us_split_fields__content target__split_fields7))) 0)))
(check-sat)
(exit)
