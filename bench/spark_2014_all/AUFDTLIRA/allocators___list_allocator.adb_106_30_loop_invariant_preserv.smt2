...
(declare-const o17 status)
(declare-const o18 resource)
...
(assert (<= 1 r1))
(assert (<= r1 10000))
(assert (=> (< r1 10000) (and (= o6 (+ r1 1)) (in_range1 (+ r1 1)))))
(assert (=> (< r1 10000) (= (to_rep o7) o6)))
(assert (=> (< r1 10000) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data1 r1))) o8)))
(assert (=> (< r1 10000) (= o7 o9)))
(assert (=> (< r1 10000) (= o10 o8)))
(assert (=> (< r1 10000) (= o11 o9)))
(assert (=> (< r1 10000) (= o12 (store data1 r1 (mk___rep (mk___split_fields o10 o11))))))
(assert (=> (< r1 10000) (= data1 result3)))
(assert (=> (< r1 10000) (= data2 o12)))
(assert (=> (not (< r1 10000)) (= data2 data1)))
(assert (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r2)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 rr)))) (ite (= rr 10000) 0 (+ rr 1))))))
(assert (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 10000)))) 0))
(assert (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr 10000)) (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select data3 rr)))) 0))))
(assert (and (and (forall ((temp___291 Int)) (=> (and (<= 1 temp___291) (<= temp___291 10000)) (ite (or (< 10000 temp___291) (or (< temp___291 1) (< r2 temp___291))) (= (select data3 temp___291) (select data1 temp___291)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data3 temp___291))) (rec__list_allocator__cell__stat (us_split_fields1 (select data1 temp___291))))))) (=> (<= 1 10000) (in_range3 r2))) (and (<= 1 r2) (<= r2 10000))))
(assert (not (= r2 10000)))
(assert (= r2 result4))
(assert (= r3 (+ r2 1)))
(assert (=> (< r3 10000) (and (= o13 (+ r3 1)) (in_range1 (+ r3 1)))))
(assert (=> (< r3 10000) (= (to_rep o14) o13)))
(assert (=> (< r3 10000) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data3 r3))) o15)))
(assert (=> (< r3 10000) (= o14 o16)))
(assert (=> (< r3 10000) (= o17 o15)))
(assert (=> (< r3 10000) (= o18 o16)))
(assert (=> (< r3 10000) (= o19 (store data3 r3 (mk___rep (mk___split_fields o17 o18))))))
(assert (=> (< r3 10000) (= result5 data3)))
(assert (=> (< r3 10000) (= data4 o19)))
(assert (=> (not (< r3 10000)) (= data4 data3)))
(assert (not (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 10000)))) 0)))
(check-sat)
(exit)
