...
(define-fun dynamic_invariant ((temp___expr_337 us_t1) (temp___is_init_333 Bool) (temp___skip_constant_334 Bool) (temp___do_toplevel_335 Bool) (temp___do_typ_inv_336 Bool)) Bool (and (=> (not (= temp___skip_constant_334 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_337) (last3 temp___expr_337))) (=> (= temp___do_toplevel_335 true) (=> (= temp___is_init_333 true) (and (let ((temp___339 (of_array2 (to_array1 temp___expr_337) (first3 temp___expr_337) (last3 temp___expr_337)))) (and (= (first5 temp___339) 1) (<= 0 (last5 temp___339)))) (<= (last3 temp___expr_337) 1000))))))
(define-fun dynamic_predicate ((temp___341 us_t1)) Bool (and (let ((temp___343 (of_array2 (to_array1 temp___341) (first3 temp___341) (last3 temp___341)))) (and (= (first5 temp___343) 1) (<= 0 (last5 temp___343)))) (<= (last3 temp___341) 1000)))
(declare-sort fart 0)
...
(define-fun dynamic_invariant1 ((temp___expr_489 Int) (temp___is_init_485 Bool) (temp___skip_constant_486 Bool) (temp___do_toplevel_487 Bool) (temp___do_typ_inv_488 Bool)) Bool (=> (or (= temp___is_init_485 true) (<= 0 2147483647)) (in_range3 temp___expr_489)))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true true) (= (fart_image x) (let ((temp___495 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___495) (first1 temp___495) (last1 temp___495))))) :pattern ((fart_image x)))))
...
(declare-fun temp___String_Literal_2696 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2696 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_2696 us_void_param) 2)) 99)) (= (to_rep (select (temp___String_Literal_2696 us_void_param) 3)) 104)) (= (to_rep (select (temp___String_Literal_2696 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_2696 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_2696 us_void_param) 6)) 118)) (= (to_rep (select (temp___String_Literal_2696 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_2696 us_void_param) 8)) 100)) (= (to_rep (select (temp___String_Literal_2696 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_2696 us_void_param) 10)) 70)) (= (to_rep (select (temp___String_Literal_2696 us_void_param) 11)) 65)) (= (to_rep (select (temp___String_Literal_2696 us_void_param) 12)) 82)) (= (to_rep (select (temp___String_Literal_2696 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_2696 us_void_param) 14)) 58)) (= (to_rep (select (temp___String_Literal_2696 us_void_param) 15)) 32)) :pattern ((temp___String_Literal_2696 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_590 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool) (temp___do_typ_inv_589 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 1 150)) (in_range4 temp___expr_590)))
(define-fun dynamic_invariant7 ((temp___expr_300 us_t2) (temp___is_init_296 Bool) (temp___skip_constant_297 Bool) (temp___do_toplevel_298 Bool) (temp___do_typ_inv_299 Bool)) Bool (and (=> (not (= temp___skip_constant_297 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_300) (last5 temp___expr_300))) (=> (= temp___do_toplevel_298 true) (=> (= temp___is_init_296 true) (and (= (first5 temp___expr_300) 1) (<= 0 (last5 temp___expr_300)))))))
(define-fun dynamic_predicate1 ((temp___303 us_t2)) Bool (and (= (first5 temp___303) 1) (<= 0 (last5 temp___303))))
(declare-const achievedfar Int)
(declare-const result__ (Array Int character))
(declare-const fullstring (Array Int character))
(declare-const temp___2698 (Array Int character))
(declare-const temp___26981 t1)
(declare-const o Int)
...
(declare-const temp___2703 (Array Int character))
(declare-const temp___27031 t3)
(declare-const o6 (Array Int character))
(declare-const temp___2706 (Array Int character))
(declare-const temp___27061 t3)
(declare-const result (Array Int character))
(declare-const fullstring1 (Array Int character))
(define-fun temp___26982 () us_t1 (mk___t1 temp___2698 temp___26981))
(assert (in_range3 achievedfar))
(assert (and (= temp___26982 (fart_image achievedfar)) (and (dynamic_invariant temp___26982 true false true true) (= temp___26982 (let ((temp___493 (to_string (attr__ATTRIBUTE_IMAGE3 achievedfar)))) (mk___t1 (elts temp___493) (mk1 (to_rep1 (first (rt temp___493))) (to_rep1 (last (rt temp___493))))))))))
(assert (=> (<= (to_rep1 (first2 temp___26981)) (to_rep1 (last2 temp___26981))) (= o (+ (- (to_rep1 (last2 temp___26981)) (to_rep1 (first2 temp___26981))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___26981)) (to_rep1 (last2 temp___26981)))) (= o 0)))
...
(assert (= (concat1 (temp___String_Literal_2696 Tuple0) 1 15 temp___2698 (to_rep1 (first2 temp___26981)) (to_rep1 (last2 temp___26981))) userentry__validatefinger__achievedfardescription__setresultstring__fullstring__assume))
...
(assert (= (slide fullstring1 (to_rep1 fullstring__first) 1) temp___2703))
(assert (= (mk3 1 (to_rep1 fullstring__last)) temp___27031))
(assert (=> (<= 1 (to_rep1 fullstring__last)) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 (to_rep1 fullstring__last)) (<= (to_rep1 fullstring__last) 150)))))
(assert (= o6 result__))
(assert (= o6 temp___2706))
(assert (= (mk3 1 (to_rep1 fullstring__last)) temp___27061))
(assert (not (= (ite (<= (to_rep1 (first6 temp___27031)) (to_rep1 (last6 temp___27031))) (+ (- (to_rep1 (last6 temp___27031)) (to_rep1 (first6 temp___27031))) 1) 0) (ite (<= (to_rep1 (first6 temp___27061)) (to_rep1 (last6 temp___27061))) (+ (- (to_rep1 (last6 temp___27061)) (to_rep1 (first6 temp___27061))) 1) 0))))
(check-sat)
(exit)
