...
(assert (and (and (forall ((temp___1812 Int)) (=> (and (<= (to_rep1 n__first) temp___1812) (<= temp___1812 (to_rep1 n__last))) (=> (or (< temp___1809 temp___1812) (or (< temp___1812 (to_rep1 (first (rt source)))) (< index2 temp___1812))) (= (select n3 temp___1812) (select n1 temp___1812))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 3)))))
