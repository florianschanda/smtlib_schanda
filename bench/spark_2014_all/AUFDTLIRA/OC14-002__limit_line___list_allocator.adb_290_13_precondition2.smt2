...
(assert (=> (not (= first_available1 0)) (and (= o63 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o63))))
(assert (=> (not (= first_available1 0)) (= result12 (ite (< 0 o63) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (and (= o62 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range4 o62)))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (= result11 (ite (= o62 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result12 true)) (= result11 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o64 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o64))))
(assert (=> (not (not (= first_available1 0))) (= result11 (ite (= o64 0) true false))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (and (= o60 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o60)))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (= result13 (ite (< 0 o60) true false)))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (= result13 true) (and (= o59 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range4 o59))))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (= result13 true) (= result10 (ite (= o59 first_allocated2) true false))))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (not (= result13 true)) (= result10 false)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated2 0))) (and (= o61 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o61)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated2 0))) (= result10 (ite (= o61 0) true false)))))
