...
(assert (not (= (let ((temp___1038 (value (sequence__content bounded_dynamic_strings__Oconcat__result10)))) (bool_eq (elts2 temp___1038) (to_rep1 (first4 (rt2 temp___1038))) (to_rep1 (last4 (rt2 temp___1038))) (let ((temp___1037 (value right))) (let ((temp___1036 (value left))) (ite (= (length3 temp___1036) 0) (elts2 temp___1037) (concat1 (elts2 temp___1036) (to_rep1 (first4 (rt2 temp___1036))) (to_rep1 (last4 (rt2 temp___1036))) (elts2 temp___1037) (to_rep1 (first4 (rt2 temp___1037))) (to_rep1 (last4 (rt2 temp___1037))))))) (to_rep1 (first (let ((temp___1037 (value right))) (let ((temp___1036 (value left))) (ite (= (length3 temp___1036) 0) (mk (to_rep1 (first4 (rt2 temp___1037))) (to_rep1 (last4 (rt2 temp___1037)))) (mk (to_rep1 (first4 (rt2 temp___1036))) (- (+ (to_rep1 (first4 (rt2 temp___1036))) (+ (ite (<= (to_rep1 (first4 (rt2 temp___1036))) (to_rep1 (last4 (rt2 temp___1036)))) (+ (- (to_rep1 (last4 (rt2 temp___1036))) (to_rep1 (first4 (rt2 temp___1036)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 temp___1037))) (to_rep1 (last4 (rt2 temp___1037)))) (+ (- (to_rep1 (last4 (rt2 temp___1037))) (to_rep1 (first4 (rt2 temp___1037)))) 1) 0))) 1))))))) (to_rep1 (last (let ((temp___1037 (value right))) (let ((temp___1036 (value left))) (ite (= (length3 temp___1036) 0) (mk (to_rep1 (first4 (rt2 temp___1037))) (to_rep1 (last4 (rt2 temp___1037)))) (mk (to_rep1 (first4 (rt2 temp___1036))) (- (+ (to_rep1 (first4 (rt2 temp___1036))) (+ (ite (<= (to_rep1 (first4 (rt2 temp___1036))) (to_rep1 (last4 (rt2 temp___1036)))) (+ (- (to_rep1 (last4 (rt2 temp___1036))) (to_rep1 (first4 (rt2 temp___1036)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 temp___1037))) (to_rep1 (last4 (rt2 temp___1037)))) (+ (- (to_rep1 (last4 (rt2 temp___1037))) (to_rep1 (first4 (rt2 temp___1037)))) 1) 0))) 1))))))))) true)))
(check-sat)
(exit)
