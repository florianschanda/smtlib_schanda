...
(assert (not (= (ite (<= (to_rep1 (first8 temp___19791)) (to_rep1 (last8 temp___19791))) (+ (- (to_rep1 (last8 temp___19791)) (to_rep1 (first8 temp___19791))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 8)) 1) 0))))
(check-sat)
(exit)
