...
(assert (not (= (bool_eq1 r__split_fields4 5 50 (temp_____aggregate_def_3211 r__split_fields i (temp_____aggregate_def_3217 (select r__split_fields i) j e)) 5 50) true)))
(check-sat)
(exit)
