...
(define-fun o2 () us_t1 (mk___t1 o o1))
...
(assert (and (= o2 (value by__)) (and (dynamic_invariant2 o2 true false true true) (and (and (= (elts (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 by__))) o) (= (mk1 (to_rep2 (first4 (mk2 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__)))))) (to_rep2 (last4 (mk2 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__))))))) o1)) (and (and (and (= (length2 o2) (length1 by__)) (= (to_rep2 (first2 o1)) 1)) (= (to_rep2 (last2 o1)) (length1 by__))) (= (< 0 (length1 by__)) (not (= (empty by__) true))))))))
(assert (and (and (= (bool_eq (elts1 (value (mk___rep this__split_discrs this__split_fields12))) (to_rep2 (first6 (mk3 start (- (+ start (length2 o2)) 1)))) (to_rep2 (last6 (mk3 start (- (+ start (length2 o2)) 1)))) o (to_rep2 (first2 o1)) (to_rep2 (last2 o1))) true) (ite (< (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2)))) (- (+ start (length2 o2)) 1)) (= (length1 (mk___rep this__split_discrs this__split_fields12)) (- (+ start (length2 o2)) 1)) (= (length1 (mk___rep this__split_discrs this__split_fields12)) (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2))))))) (dynamic_invariant1 (mk___rep this__split_discrs this__split_fields12) true true true true)))
...
(assert (not (= (let ((temp___1248 (value by__))) (bool_eq (elts1 (value (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t this__split_fields7 this__split_fields8))))) (to_rep2 (first8 (mk4 start (- (+ start (length1 by__)) 1)))) (to_rep2 (last8 (mk4 start (- (+ start (length1 by__)) 1)))) (elts1 temp___1248) (to_rep2 (first2 (rt1 temp___1248))) (to_rep2 (last2 (rt1 temp___1248))))) true)))
(check-sat)
(exit)
