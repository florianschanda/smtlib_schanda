...
(assert (=> (and (<= temp___480 i_v11) (<= i_v11 (to_rep a_v1__last))) (and (forall ((m1 Int)) (=> (and (<= (to_rep a_v1__first) m1) (<= m1 k_1)) (= (to_rep (select a_v12 m1)) (to_rep (select (elts b_v1) m1))))) (forall ((m1 Int)) (=> (and (<= (+ k_1 1) m1) (<= m1 (- i_v12 1))) (= (to_rep (select a_v12 m1)) (to_rep (select (elts c_v1) (- m1 k_1)))))))))
...
(assert (= (= result2 true) (forall ((m1 Int)) (=> (and (<= (to_rep a_v1__first) m1) (<= m1 k_1)) (= (to_rep (select (map__content a_v16) m1)) (to_rep (select (elts b_v1) m1)))))))
(assert (= result2 true))
(assert (<= (+ k_1 1) m))
