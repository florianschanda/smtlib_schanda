...
(assert (and (= o8 (to_rep1 (rec__search_trees__search_tree__root t__split_fields6))) (in_range5 (to_rep1 (rec__search_trees__search_tree__root t__split_fields6)))))
(assert (not (= (valid_root (rec__search_trees__search_tree__struct t__split_fields6) o8) true)))
(check-sat)
(exit)
