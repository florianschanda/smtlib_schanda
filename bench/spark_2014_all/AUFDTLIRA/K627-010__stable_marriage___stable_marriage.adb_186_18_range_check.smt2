...
(define-fun to_rep1 ((x count)) Int (countqtint x))
...
(define-fun dynamic_invariant ((temp___expr_343 Int) (temp___is_init_339 Bool) (temp___skip_constant_340 Bool) (temp___do_toplevel_341 Bool) (temp___do_typ_inv_342 Bool)) Bool (=> (or (= temp___is_init_339 true) (<= 0 64)) (in_range2 temp___expr_343)))
(define-fun dynamic_invariant1 ((temp___expr_350 Int) (temp___is_init_346 Bool) (temp___skip_constant_347 Bool) (temp___do_toplevel_348 Bool) (temp___do_typ_inv_349 Bool)) Bool (=> (or (= temp___is_init_346 true) (<= 1 64)) (in_range3 temp___expr_350)))
(define-fun dynamic_invariant2 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 1 64)) (in_range1 temp___expr_166)))
(declare-const unmatched_g1_set__split_fields count)
(assert (<= 1 (to_rep1 unmatched_g1_set__split_fields)))
(assert (not (<= (to_rep1 unmatched_g1_set__split_fields) 64)))
(check-sat)
(exit)
