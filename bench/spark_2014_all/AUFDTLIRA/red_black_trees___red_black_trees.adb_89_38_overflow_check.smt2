...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (<= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i1)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i1))))))))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (or (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i1)))) 100) (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i1)))) n2)))))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields7 (select m i1))) true) (< n2 (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i1)))))) (< (length (rec__tree_model__path_type__a (us_split_fields7 (select m i1)))) (- 100 n2)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i1))) true) (and (and (and (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i1)))) n2) (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select res2 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 1)))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1 0)))))))))))))
...
(assert (<= 1 i))
(assert (<= i 100))
(assert (not (ite (= (rec__tree_model__path_type__k (us_split_fields7 (select m i))) true) (< n2 (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i))))) false)))
(assert (= (rec__tree_model__path_type__k (us_split_fields7 (select m i))) true))
(assert (and (= o20 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0)) (and (in_range2 o20) (= o20 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i 0)))))
(assert (= (mk___rep5 (mk___split_fields5 o21 o22 o23)) (select res2 o20)))
(assert (= o21 o24))
(assert (= o22 o25))
(assert (= o23 o26))
(assert (= o27 o26))
(assert (= o28 (to_rep o27)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0) (= o29 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0)) (= o29 0)))
(assert (= o30 (+ o29 o28)))
(assert (and (= o31 o30) (in_range7 o30)))
(assert (= o32 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i)))) o31) true false)))
(assert (and (= o8 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 1)) (and (in_range2 o8) (= o8 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i 1)))))
(assert (= (mk___rep5 (mk___split_fields5 o9 o10 o11)) (select res2 o8)))
(assert (= o9 o12))
(assert (= o10 o13))
(assert (= o11 o14))
(assert (= o15 o13))
(assert (= o16 (to_rep o15)))
(assert (and (= o (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0)) (and (in_range2 o) (= o (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i 0)))))
(assert (= (mk___rep5 (mk___split_fields5 o1 o2 o3)) (select res2 o)))
(assert (= o1 o4))
(assert (= o2 o5))
(assert (= o3 o6))
(assert (= o7 o5))
(assert (= o17 (to_rep o7)))
(assert (= o18 (ite (< o17 o16) o16 o17)))
(assert (= o19 (+ 1 o18)))
(assert (not (in_range7 o19)))
(check-sat)
(exit)
