...
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o27 (size (mk___rep2 (us_split_fields__content2 f__split_fields7)))) (and (in_range2 o27) (= o27 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))))))
(assert (= result6 (ite (= o27 (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)))) true false)))
(assert (= result6 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
...
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o26 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 o26) (and (= o26 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= o26 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o26) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o26) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) d)) (= o26 j)))))))))
(assert (= result8 (ite (= o26 0) true false)))
(assert (= result8 true))
...
(assert (=> (not (= (int__content v2) 0)) (and (= o24 (int__content v2)) (in_range1 (int__content v2)))))
...
(assert (=> (not (= (int__content v2) 0)) (and (= result14 (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) o25)) (and (= (= result14 true) (and (<= o25 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) o25)))) 2))) (=> (< (size (mk___rep2 (us_split_fields__content2 f__split_fields7))) o25) (not (= result14 true)))))))
(assert (=> (not (not (= (int__content v2) 0))) (= result14 (distinct 1 0))))
(assert (= result14 true))
(assert (<= 1 i1))
(assert (<= i1 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i1))) true))
(assert (=> (not (= (int__content v2) 0)) (and (<= 1 (int__content v2)) (<= (int__content v2) 100))))
(assert (=> (not (= (int__content v2) 0)) (= o18 (int__content v2))))
(assert (=> (not (= (int__content v2) 0)) (= o19 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) o18))))
(assert (=> (not (= (int__content v2) 0)) (= o20 (us_split_fields1 o19))))
(assert (=> (not (= (int__content v2) 0)) (= o21 (rec__tree_model__path_type__a o20))))
(assert (=> (not (= (int__content v2) 0)) (and (= result15 (ole o21 (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i1))))) (= (= result15 true) (and (<= (length o21) (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i1))))) (forall ((n Int)) (=> (and (<= 1 n) (<= n (last o21))) (= (get o21 n) (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i1))) n)))))))))
(assert (=> (not (not (= (int__content v2) 0))) (= result15 false)))
(assert (= result15 true))
(assert (and (= o22 (int__content v2)) (in_range1 (int__content v2))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o23 (int__content v2)) (in_range1 (int__content v2))))
(assert (not (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) o23) true)))
(check-sat)
(exit)
