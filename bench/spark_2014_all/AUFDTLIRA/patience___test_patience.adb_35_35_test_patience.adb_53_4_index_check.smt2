...
(declare-const temp___885 (Array Int character))
(declare-const temp___8851 t)
...
(assert (=> (= (length (mk___t temp___882 temp___8821)) 0) (= (elts (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))) temp___885)))
(assert (=> (= (length (mk___t temp___882 temp___8821)) 0) (= (mk (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16)))))))) temp___8851)))
(assert (=> (not (= (length (mk___t temp___882 temp___8821)) 0)) (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16)))))))) (= o62 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16)))))))) 1)))))
(assert (=> (not (= (length (mk___t temp___882 temp___8821)) 0)) (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))))))) (= o62 0))))
(assert (=> (not (= (length (mk___t temp___882 temp___8821)) 0)) (=> (<= (to_rep1 (first temp___8821)) (to_rep1 (last temp___8821))) (= o63 (+ (- (to_rep1 (last temp___8821)) (to_rep1 (first temp___8821))) 1)))))
(assert (=> (not (= (length (mk___t temp___882 temp___8821)) 0)) (=> (not (<= (to_rep1 (first temp___8821)) (to_rep1 (last temp___8821)))) (= o63 0))))
(assert (=> (not (= (length (mk___t temp___882 temp___8821)) 0)) (= o64 (+ o63 o62))))
(assert (=> (not (= (length (mk___t temp___882 temp___8821)) 0)) (= o65 (+ (to_rep1 (first temp___8821)) o64))))
(assert (=> (not (= (length (mk___t temp___882 temp___8821)) 0)) (= o66 (- o65 1))))
(assert (=> (not (= (length (mk___t temp___882 temp___8821)) 0)) (and (= o67 o66) (in_range2 o66))))
(assert (=> (not (= (length (mk___t temp___882 temp___8821)) 0)) (= (concat1 temp___882 (to_rep1 (first temp___8821)) (to_rep1 (last temp___8821)) (elts (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16)))))))) temp___885)))
(assert (=> (not (= (length (mk___t temp___882 temp___8821)) 0)) (= (mk (to_rep1 (first temp___8821)) o67) temp___8851)))
(assert (=> (= (length (mk___t temp___885 temp___8851)) 0) (= o74 (mk___t (temp___String_Literal_884 Tuple0) (mk 1 2)))))
(assert (=> (not (= (length (mk___t temp___885 temp___8851)) 0)) (=> (<= 1 2) (= o68 (+ (- 2 1) 1)))))
(assert (=> (not (= (length (mk___t temp___885 temp___8851)) 0)) (=> (not (<= 1 2)) (= o68 0))))
(assert (=> (not (= (length (mk___t temp___885 temp___8851)) 0)) (=> (<= (to_rep1 (first temp___8851)) (to_rep1 (last temp___8851))) (= o69 (+ (- (to_rep1 (last temp___8851)) (to_rep1 (first temp___8851))) 1)))))
(assert (=> (not (= (length (mk___t temp___885 temp___8851)) 0)) (=> (not (<= (to_rep1 (first temp___8851)) (to_rep1 (last temp___8851)))) (= o69 0))))
(assert (=> (not (= (length (mk___t temp___885 temp___8851)) 0)) (= o70 (+ o69 o68))))
(assert (=> (not (= (length (mk___t temp___885 temp___8851)) 0)) (= o71 (+ (to_rep1 (first temp___8851)) o70))))
(assert (=> (not (= (length (mk___t temp___885 temp___8851)) 0)) (= o72 (- o71 1))))
(assert (=> (not (= (length (mk___t temp___885 temp___8851)) 0)) (and (= o73 o72) (in_range2 o72))))
(assert (=> (not (= (length (mk___t temp___885 temp___8851)) 0)) (= o74 (mk___t (concat1 temp___885 (to_rep1 (first temp___8851)) (to_rep1 (last temp___8851)) (temp___String_Literal_884 Tuple0) 1 2) (mk (to_rep1 (first temp___8851)) o73)))))
(assert (= result6 (mk_int__ref j)))
(assert (= j1 0))
(assert (<= 0 j1))
(assert (<= j1 (- (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16)) 1)))
(assert (and (=> (<= (- 1) 100) (in_range4 idx1)) (and (<= 0 j2) (<= j2 (- (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16)) 1)))))
(assert (not (<= j2 99)))
(check-sat)
(exit)
