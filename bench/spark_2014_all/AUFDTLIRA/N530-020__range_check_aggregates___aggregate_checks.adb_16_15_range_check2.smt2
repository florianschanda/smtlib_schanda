...
(declare-fun twrapper2D1qtint (twrapper2D1) Int)
(assert (forall ((i twrapper2D1)) (and (<= 1 (twrapper2D1qtint i)) (<= (twrapper2D1qtint i) 1))))
...
(define-fun dynamic_invariant1 ((temp___expr_226 (Array Int integer)) (temp___is_init_222 Bool) (temp___skip_constant_223 Bool) (temp___do_toplevel_224 Bool) (temp___do_typ_inv_225 Bool)) Bool (forall ((temp___227 Int)) (=> (and (<= 1 temp___227) (<= temp___227 1)) (=> (or (= temp___is_init_222 true) (<= first2 last2)) (dynamic_property1 first2 last2 (to_rep (select temp___expr_226 temp___227)))))))
...
(define-fun dynamic_invariant5 ((temp___expr_219 Int) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool) (temp___do_typ_inv_218 Bool)) Bool (=> (or (= temp___is_init_215 true) (<= first2 last2)) (dynamic_property1 first2 last2 temp___expr_219)))
...
(assert (forall ((temp___157 Int)) (=> (dynamic_invariant5 temp___157 true true true true) (= (to_rep (select (aggregate_checks__do_wrong_aggregate_2__should_fail2__aggregate_def temp___157) 1)) temp___157))))
