...
(assert (and (= o (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2))))) (and (in_range4 o) (= o (to_rep2 to____split_fields)))))
(assert (not (in_range1 (length3 tail))))
(check-sat)
(exit)
