...
(assert (forall ((a us_rep)) (forall ((i Int)) (! (=> (and (dynamic_invariant i true true true true) (and (<= 1 i) (<= i 100))) (dynamic_invariant (get a i) true false true true)) :pattern ((get a i))))))
(assert (forall ((a us_rep)) (forall ((i Int)) (! (=> (dynamic_invariant i true true true true) (= (get a i) (to_rep (let ((temp___207 (rec__with_iterable__container__content (us_split_fields1 a)))) (select temp___207 i))))) :pattern ((get a i))))))
...
(assert (= (= o1 true) (dynamic_invariant1 cu2 true false true true)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (<= (to_rep cu1) 100)))
(check-sat)
(exit)
