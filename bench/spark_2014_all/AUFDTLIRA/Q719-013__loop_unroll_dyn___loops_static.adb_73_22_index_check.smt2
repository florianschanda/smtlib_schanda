...
(declare-const temp___349 (Array Int natural))
(declare-const temp___3491 t1)
...
(assert (= o2 a2))
(assert (= o2 temp___349))
(assert (= (mk1 (to_rep1 a__first) i2) temp___3491))
(assert (= temp___349 loops_static__loop4__B_11__a_begins__assume))
(assert (= (mk (to_rep1 (first2 temp___3491)) (to_rep1 (last2 temp___3491))) loops_static__loop4__B_11__a_begins__assume1))
