...
(assert (= a4 a2))
(assert (not (= j1 j2)))
(assert (not (= (bool_eq1 a3 5 50 (temp_____aggregate_def_867 a j1 (temp_____aggregate_def_875 (select a j1) i1 e) j2 (temp_____aggregate_def_882 (select a j2) i2 f)) 5 50) true)))
(check-sat)
(exit)
