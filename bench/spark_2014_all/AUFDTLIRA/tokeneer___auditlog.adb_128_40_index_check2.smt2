...
(assert (= temp___1720 (- o 1)))
(assert (= result1 i))
(assert (= i1 0))
(assert (<= 0 i1))
(assert (<= i1 temp___1720))
(assert (and (<= 0 i2) (<= i2 (- (length description) 1))))
(assert (and (= temp___1721 (+ (to_rep1 (first (rt description))) i2)) (in_range1 (+ (to_rep1 (first (rt description))) i2))))
(assert (and (<= (to_rep1 (first (rt description))) temp___1721) (<= temp___1721 (to_rep1 (last (rt description))))))
(assert (= o1 temp___1721))
(assert (= o2 (select (elts description) o1)))
(assert (= o3 (to_rep o2)))
(assert (= (to_rep o4) o3))
(assert (and (= temp___1722 (+ 1 i2)) (in_range1 (+ 1 i2))))
(assert (not (<= 1 temp___1722)))
(check-sat)
(exit)
