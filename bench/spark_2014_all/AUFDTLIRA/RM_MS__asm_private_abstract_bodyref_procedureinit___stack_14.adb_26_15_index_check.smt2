...
(define-fun dynamic_invariant1 ((temp___expr_163 Int) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool) (temp___do_typ_inv_162 Bool)) Bool (=> (or (= temp___is_init_159 true) (<= 0 100)) (in_range1 temp___expr_163)))
...
(define-fun dynamic_invariant2 ((temp___expr_170 Int) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool) (temp___do_typ_inv_169 Bool)) Bool (=> (or (= temp___is_init_166 true) (<= 1 100)) (in_range2 temp___expr_170)))
(declare-const x Int)
(declare-const pointer Int)
(assert (in_range1 pointer))
(assert (=> (<= (- 2147483648) 2147483647) (in_range x)))
(assert (not (<= pointer 100)))
(check-sat)
(exit)
