...
(define-fun dynamic_invariant1 ((temp___expr_165 us_rep) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (let ((temp___166 (rec__containers__container__c (us_split_discrs1 temp___expr_165)))) (and (dynamic_property1 1 (to_rep temp___166) (first1 (rec__containers__container__v (us_split_fields1 temp___expr_165))) (last1 (rec__containers__container__v (us_split_fields1 temp___expr_165)))) (and (= (first1 (rec__containers__container__v (us_split_fields1 temp___expr_165))) 1) (= (last1 (rec__containers__container__v (us_split_fields1 temp___expr_165))) (to_rep temp___166))))))
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant1 x true true true true) (dynamic_invariant (length1 x) true false true true)) :pattern ((length1 x)))))
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant1 x true true true true) (= (length1 x) (to_rep (rec__containers__container__l (us_split_fields1 x))))) :pattern ((length1 x)))))
...
(declare-const temp___173 natural)
(declare-const temp___175 natural)
(declare-const temp___1751 natural)
(declare-const temp___1752 (Array Int natural))
(declare-const temp___1753 t)
(define-fun temp___1754 () us_rep (mk___rep (mk___split_discrs temp___175) (mk___split_fields temp___1751 (mk___t temp___1752 temp___1753))))
(assert (in_range temp___174))
(assert (= temp___174 (to_rep temp___173)))
(assert (and (dynamic_invariant1 temp___1754 true false true true) (= (to_rep temp___1751) 0)))
(assert (not (= (length1 temp___1754) 0)))
(check-sat)
(exit)
