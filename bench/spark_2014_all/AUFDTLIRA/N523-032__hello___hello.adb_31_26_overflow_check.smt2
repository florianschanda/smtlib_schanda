...
(assert (= o7 temp___6531))
(assert (= o8 (select (elts str) o7)))
(assert (= o9 (to_rep o8)))
(assert (= o10 (ite (<= o9 122) true false)))
(assert (and (= temp___653 (- j 1)) (in_range1 (- j 1))))
(assert (and (<= (to_rep1 (first (rt str))) temp___653) (<= temp___653 (to_rep1 (last (rt str))))))
(assert (= o4 temp___653))
(assert (= o5 (select (elts str) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o11 (ite (<= 97 o6) true false)))
(assert (= o12 (ite (= o11 true) o10 false)))
(assert (= result (ite (not (= o12 true)) true false)))
(assert (= result true))
(assert (and (= temp___654 (- j 1)) (in_range1 (- j 1))))
(assert (and (<= (to_rep1 (first (rt str))) temp___654) (<= temp___654 (to_rep1 (last (rt str))))))
(assert (= o temp___654))
(assert (= o1 (select (elts str) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (<= o2 90) true false)))
