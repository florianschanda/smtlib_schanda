...
(assert (and (= (length source) 9) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index3 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 8))) (= (is_digit (to_rep (select (elts source) index3))) true))))))
...
(assert (<= temp___2340 index1))
(assert (<= index1 temp___2341))
...
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8) index2)) (forall ((temp___2345 Int)) (=> (and (<= (to_rep1 n__first) temp___2345) (<= temp___2345 (to_rep1 n__last))) (=> (or (< temp___2341 temp___2345) (or (< temp___2345 temp___2340) (< index2 temp___2345))) (= (select n3 temp___2345) (select n1 temp___2345)))))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 8)))))
