...
(assert (forall ((x length_t)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__arrays__string_t__len length_t) (rec__arrays__string_t__elem (Array Int character))))))
(define-fun us_split_fields_Len__projection ((a us_split_fields)) length_t (rec__arrays__string_t__len a))
(define-fun us_split_fields_Elem__projection ((a us_split_fields)) (Array Int character) (rec__arrays__string_t__elem a))
...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__arrays__string_t__len (us_split_fields1 a))) (to_rep1 (rec__arrays__string_t__len (us_split_fields1 b)))) (= (bool_eq (rec__arrays__string_t__elem (us_split_fields1 a)) 1 5 (rec__arrays__string_t__elem (us_split_fields1 b)) 1 5) true)) true false))
...
(assert (< arrays__string_t__len__first__bit arrays__string_t__len__last__bit))
...
(assert (< arrays__string_t__elem__first__bit arrays__string_t__elem__last__bit))
...
(define-fun dynamic_invariant1 ((temp___expr_273 Int) (temp___is_init_269 Bool) (temp___skip_constant_270 Bool) (temp___do_toplevel_271 Bool) (temp___do_typ_inv_272 Bool)) Bool (=> (or (= temp___is_init_269 true) (<= 0 5)) (in_range2 temp___expr_273)))
(define-fun dynamic_invariant2 ((temp___expr_280 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool) (temp___do_typ_inv_279 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= 1 5)) (in_range3 temp___expr_280)))
(declare-const s__split_fields length_t)
(declare-const s__split_fields1 (Array Int character))
(declare-const o Int)
(declare-const o1 length_t)
(declare-const o2 length_t)
(declare-const o3 (Array Int character))
(declare-const temp___330 length_t)
(declare-const temp___3301 (Array Int character))
...
(declare-const s__split_fields3 (Array Int character))
(assert (and (forall ((i Int)) (=> (and (<= (+ (to_rep1 s__split_fields) 1) i) (<= i 5)) (= (to_rep (select s__split_fields1 i)) 32))) (< (to_rep1 s__split_fields) 5)))
(assert (and (= o (+ (to_rep1 s__split_fields) 1)) (in_range2 (+ (to_rep1 s__split_fields) 1))))
(assert (= (to_rep1 o1) o))
(assert (= o1 o2))
(assert (= s__split_fields1 o3))
(assert (= temp___330 o2))
(assert (= temp___3301 o3))
...
(assert (= temp___330 s__split_fields2))
(assert (= temp___3301 s__split_fields3))
(assert (= (to_rep o4) 120))
