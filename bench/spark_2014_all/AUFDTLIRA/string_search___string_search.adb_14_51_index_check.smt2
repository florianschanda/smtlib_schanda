...
(assert (and (= temp___302 (+ j2 (- i1 1))) (in_range1 (+ j2 (- i1 1)))))
(assert (and (<= (to_rep1 (first (rt haystack))) temp___302) (<= temp___302 (to_rep1 (last (rt haystack))))))
(assert (= o10 temp___302))
