...
(assert (= o2 i2))
(assert (= o3 (select (elts (rec__simple_unc_arrays__table__v res__split_fields4)) o2)))
(assert (= o4 (to_rep2 o3)))
(assert (and (= temp___980 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (and (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v res__split_fields4)))) temp___980) (<= temp___980 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v res__split_fields4)))))))
(assert (= o temp___980))
...
(assert (= result5 true))
(assert (= (to_rep (rec__simple_unc_arrays__table__last res__split_discrs)) r59b))
(assert (in_range2 r59b))
(assert (= (ite (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v res__split_fields4)))) (to_rep1 (last (rt (rec__simple_unc_arrays__table__v res__split_fields4))))) (+ (- (to_rep1 (last (rt (rec__simple_unc_arrays__table__v res__split_fields4)))) (to_rep1 (first (rt (rec__simple_unc_arrays__table__v res__split_fields4))))) 1) 0) (ite (<= 1 r59b) (+ (- r59b 1) 1) 0)))
(assert (= (elts (rec__simple_unc_arrays__table__v res__split_fields4)) simple_unc_arrays__swap_cells__a__compl))
(assert (= (mk2 (to_rep1 (first (rt (rec__simple_unc_arrays__table__v res__split_fields4)))) (to_rep1 (last (rt (rec__simple_unc_arrays__table__v res__split_fields4))))) simple_unc_arrays__swap_cells__a__compl1))
(assert (and (= o8 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= (to_rep1 o7) (to_rep1 (last4 simple_unc_arrays__swap_cells__a__compl1))))
(assert (= (to_rep1 o6) (to_rep1 (first4 simple_unc_arrays__swap_cells__a__compl1))))
(assert (not (<= (to_rep1 o6) i2)))
(check-sat)
(exit)
