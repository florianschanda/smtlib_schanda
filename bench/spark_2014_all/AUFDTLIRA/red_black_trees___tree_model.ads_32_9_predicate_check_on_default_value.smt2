...
(declare-const temp___6381 Bool)
...
(assert (and (= o (all_indexes Tuple0)) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (= (contains o i) true))) (= (length1 o) 100))))
(assert (= result1 (mk_set__ref unseen)))
(assert (= unseen1 o))
(assert (=> (<= 1 100) (= o1 (+ (- 100 1) 1))))
(assert (=> (not (<= 1 100)) (= o1 0)))
(assert (= result2 (ite (< 0 o1) true false)))
(assert (= result2 true))
(assert (and (= (length temp___638) 0) (= temp___6381 (distinct 0 0))))
(assert (not (< (length temp___638) 100)))
(check-sat)
(exit)
