...
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___200 index1)))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___201 src)))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___198 src)))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___196 dest)))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___202 src)))
...
(assert (=> (and (<= 1 index1) (<= index1 10)) (= src2 (store src index1 rliteral))))
(assert (=> (and (<= 1 index1) (<= index1 10)) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j index2)) (= (to_rep (select dest3 j)) (to_rep (select temp___201 j))))) (forall ((j Int)) (=> (and (<= (+ index2 1) j) (<= j 10)) (= (to_rep (select src3 j)) (to_rep (select temp___202 j))))))))
(assert (=> (and (<= 1 index1) (<= index1 10)) (and (and (and (forall ((temp___197 Int)) (=> (and (<= 1 temp___197) (<= temp___197 10)) (=> (or (< 10 temp___197) (or (< temp___197 1) (< index2 temp___197))) (= (select dest3 temp___197) (select temp___196 temp___197))))) (forall ((temp___199 Int)) (=> (and (<= 1 temp___199) (<= temp___199 10)) (=> (or (< 10 temp___199) (or (< temp___199 1) (< index2 temp___199))) (= (select src3 temp___199) (select temp___198 temp___199)))))) (=> (<= 1 10) (in_range3 index2))) (and (<= 1 index2) (<= index2 10)))))
