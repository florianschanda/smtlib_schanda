...
(assert (and (= partition_refinement__refine_one__i__assume (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range4 partition_refinement__refine_one__i__assume) (= partition_refinement__refine_one__i__assume (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
...
(assert (in_range7 (+ (to_rep4 (rec__partition_refinement__interval__first p_elem__split_fields3)) (to_rep3 (rec__partition_refinement__interval__count p_elem__split_fields3)))))
(assert (and (= partition_refinement__refine_one__j__assume (+ (to_rep4 (rec__partition_refinement__interval__first p_elem__split_fields3)) (to_rep3 (rec__partition_refinement__interval__count p_elem__split_fields3)))) (in_range7 (+ (to_rep4 (rec__partition_refinement__interval__first p_elem__split_fields3)) (to_rep3 (rec__partition_refinement__interval__count p_elem__split_fields3))))))
...
(assert (= (bool_eq7 a1 0 5 a_update 0 5) true))
(assert (forall ((c1 us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c1) true) (=> (and (not (= (key (mk___rep d__split_discrs d__split_fields2) c1) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs d__split_fields2) c1) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c1))) (key (mk___rep d__split_discrs d__split_fields2) c1))))))
(assert (forall ((c1 us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c1) true) (=> (= (key (mk___rep d__split_discrs d__split_fields2) c1) (to_rep (select a1 i))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c1))) (key (mk___rep d__split_discrs d__split_fields2) c1))))))
