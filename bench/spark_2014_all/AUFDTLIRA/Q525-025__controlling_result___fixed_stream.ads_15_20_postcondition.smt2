...
(declare-sort t4s 0)
(declare-fun t4sqtint (t4s) Int)
(assert (forall ((i t4s)) (and (<= 1 (t4sqtint i)) (<= (t4sqtint i) 20))))
(define-fun in_range4 ((x Int)) Bool (and (<= 1 x) (<= x 20)))
(declare-fun attr__ATTRIBUTE_IMAGE4 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Int)
(declare-fun user_eq7 (t4s t4s) Bool)
(declare-const dummy7 t4s)
...
(assert (forall ((temp___204 Int)) (=> (dynamic_invariant3 temp___204 true true true true) (forall ((temp___205 Int)) (= (to_rep (select (temp_____aggregate_def_202 temp___204) temp___205)) temp___204)))))
...
(declare-const temp___280 natural)
(declare-const temp___2801 (Array Int character))
(declare-const temp___2802 us_private)
(declare-const temp___2803 Int)
...
(assert (and (= this__attr__tag us_tag) (and (= (to_rep2 this__split_fields) 0) (= this__split_fields1 (temp_____aggregate_def_202 0)))))
(assert (= (to_rep2 o) elem_width))
(assert (= o o1))
(assert (= this__split_fields1 o2))
(assert (= this__split_fields2 o3))
(assert (= temp___280 o1))
(assert (= temp___2801 o2))
(assert (= temp___2802 o3))
(assert (= this__attr__tag temp___2803))
(assert (= result this__split_fields))
(assert (= result1 this__split_fields1))
(assert (= result2 this__split_fields2))
(assert (= temp___280 this__split_fields3))
(assert (= temp___2801 this__split_fields4))
(assert (= temp___2802 this__split_fields5))
(assert (= (to_rep1 o5) 20))
(assert (= (to_rep1 o4) 1))
(assert (forall ((i Int)) (=> (and (<= (to_rep1 o4) i) (<= i (to_rep1 o5))) (or (and (and (or (< (to_rep1 (first (rt name))) 0) (<= (- i (to_rep1 o4)) (- 2147483647 (to_rep1 (first (rt name)))))) (<= (+ (- i (to_rep1 o4)) (to_rep1 (first (rt name)))) (to_rep1 (last (rt name))))) (= (to_rep (select fixed_stream__trim_string__change i)) (to_rep (select (elts name) (+ (- i (to_rep1 o4)) (to_rep1 (first (rt name)))))))) (= (to_rep (select fixed_stream__trim_string__change i)) 0)))))
...
(assert (= (slide fixed_stream__trim_string__change (to_rep1 (first (mk 1 20))) 1) this__split_fields7))
...
(assert (= fixed_stream__create__result12 (mk___rep (mk___split_fields fixed_stream__create__result4 fixed_stream__create__result5 fixed_stream__create__result6) fixed_stream__create__result7)))
...
(assert (= fixed_stream__create__result13 (mk_object__ref (mk___rep (mk___split_fields fixed_stream__create__result8 fixed_stream__create__result9 fixed_stream__create__result10) fixed_stream__create__result11))))
...
(assert (= (mk___rep (mk___split_fields result10 result11 result12) result13) (object__content fixed_stream__create__result13)))
(assert (not (= (elements (object__content fixed_stream__create__result13)) elem_width)))
(check-sat)
(exit)
