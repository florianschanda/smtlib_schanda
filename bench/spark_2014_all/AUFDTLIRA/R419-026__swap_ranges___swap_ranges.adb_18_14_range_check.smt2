...
(declare-const temp___251 (Array Int t))
(declare-const temp___2511 t5)
...
(assert (=> (<= (to_rep b__first) r21b2) (and (and (<= (to_rep b__first) (to_rep b__first)) (<= (to_rep b__first) (to_rep b__last))) (and (<= (to_rep b__first) r21b2) (<= r21b2 (to_rep b__last))))))
(assert (= o18 b2))
(assert (= temp___251 o18))
(assert (= temp___2511 (mk4 (to_rep b__first) r21b2)))
(assert (<= (to_rep a__first) r18b2))
