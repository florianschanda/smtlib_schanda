...
(assert (=> (= (rec__split_records__record_with_mutable_discrs__present split_records__update_field_if_possible__r__discrs3) true) (= (to_rep (rec__split_records__record_with_mutable_discrs__field split_records__update_field_if_possible__r__fields3)) 0)))
(assert (= result10 (mk_map__ref a3)))
(assert (= a4 (store a3 1 (mk___rep split_records__update_field_if_possible__r__discrs3 split_records__update_field_if_possible__r__fields3 (attr__constrained (select a3 1))))))
(assert (=> (= (attr__constrained (select a3 1)) true) (= split_records__update_field_if_possible__r__discrs3 (us_split_discrs1 (select a3 1)))))
(assert (not (not (= (rec__split_records__record_with_mutable_discrs__present (us_split_discrs1 (select a4 1))) true))))
(check-sat)
(exit)
