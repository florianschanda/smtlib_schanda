...
(assert (= o12 v))
(assert (= (mk___rep1 (mk___split_fields1 o13 o14 o15 o16)) (select f_old__split_fields1 o12)))
(assert (= o13 o17))
(assert (= o14 o18))
(assert (= o15 o19))
(assert (= o16 o20))
...
(assert (= result (ite (= o22 2) true false)))
(assert (= result true))
(assert (and (<= 1 v) (<= v 100)))
(assert (= o v))
(assert (= (mk___rep1 (mk___split_fields1 o1 o2 o3 o4)) (select f__split_fields1 o)))
(assert (= o1 o5))
(assert (= o2 o6))
(assert (= o3 o7))
(assert (= o4 o8))
