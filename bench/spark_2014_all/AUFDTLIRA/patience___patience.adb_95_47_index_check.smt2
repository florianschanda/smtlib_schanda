...
(declare-const temp___685 (Array Int cardindex))
...
(assert (= o125 i1))
(assert (= o126 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o125)))
(assert (= o127 (to_rep o126)))
(assert (= o128 (ite (<= o127 (- (to_rep (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o122 i1))
(assert (= o123 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o122)))
(assert (= o124 (to_rep o123)))
(assert (= o129 (ite (<= 0 o124) true false)))
(assert (= result23 (ite (= o129 true) o128 false)))
(assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result23 true) (= o113 i1)))
(assert (=> (= result23 true) (= o114 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o113))))
(assert (=> (= result23 true) (= temp___681 (to_rep o114))))
(assert (=> (= result23 true) (and (<= 0 temp___681) (<= temp___681 99))))
(assert (=> (= result23 true) (= o115 temp___681)))
(assert (=> (= result23 true) (= o116 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) o115))))
(assert (=> (= result23 true) (= o117 (to_rep o116))))
(assert (=> (= result23 true) (= o118 (- o117 1))))
(assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result23 true) (= o111 i1)))
(assert (=> (= result23 true) (= o112 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o111))))
(assert (=> (= result23 true) (= o119 (to_rep o112))))
(assert (=> (= result23 true) (= o120 (ite (<= o119 o118) true false))))
(assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result23 true) (= o108 i1)))
(assert (=> (= result23 true) (= o109 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o108))))
(assert (=> (= result23 true) (= o110 (to_rep o109))))
(assert (=> (= result23 true) (= o121 (ite (<= 0 o110) true false))))
(assert (=> (= result23 true) (= result22 (ite (= o121 true) o120 false))))
(assert (=> (not (= result23 true)) (= result22 false)))
(assert (= result22 true))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o103 i1))
(assert (= o104 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o103)))
(assert (= temp___684 (to_rep o104)))
(assert (and (<= 0 temp___684) (<= temp___684 99)))
(assert (= o105 temp___684))
(assert (= temp___685 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o105)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o106 i1))
(assert (= o107 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o106)))
(assert (= temp___687 (to_rep o107)))
(assert (not (<= temp___687 99)))
(check-sat)
(exit)
