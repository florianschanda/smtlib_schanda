...
(declare-const temp___189 (Array Int integer_subtype))
...
(assert (= i1 0))
(assert (=> (and (<= 0 i1) (<= i1 2)) (= temp___191 i1)))
(assert (=> (and (<= 0 i1) (<= i1 2)) (= temp___189 result__)))
...
(assert (=> (and (<= 0 i1) (<= i1 2)) (and (and (forall ((temp___190 Int)) (=> (and (<= 0 temp___190) (<= temp___190 2)) (=> (or (< 2 temp___190) (or (< temp___190 0) (< i2 temp___190))) (= (select result__3 temp___190) (select temp___189 temp___190))))) (=> (<= 0 2) (in_range5 i2))) (and (<= 0 i2) (<= i2 2)))))
