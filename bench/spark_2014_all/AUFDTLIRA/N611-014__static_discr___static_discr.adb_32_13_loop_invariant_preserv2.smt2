...
(assert (= (to_rep (rec__static_discr__holder__unused current__split_discrs)) 100))
(assert (= (bool_eq (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 a)))) 1 100 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields9))) 1 100) true))
(assert (= result__3 0))
(assert (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields9))))
(assert (not (<= 1 (to_rep (rec__static_discr__holder__length1 current__split_fields9)))))
(check-sat)
(exit)
