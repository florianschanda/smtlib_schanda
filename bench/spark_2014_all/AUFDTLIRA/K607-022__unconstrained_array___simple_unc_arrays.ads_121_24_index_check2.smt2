...
(assert (= tmp4 tmp2))
(assert (= a4 a2))
(assert (= (= o25 true) (forall ((k Int)) (=> (and (<= (to_rep a__first) k) (<= k (to_rep a__last))) (=> (and (not (= k i)) (not (= k j))) (= (to_rep1 (select a3 k)) (to_rep1 (select a k))))))))
(assert (and (<= (to_rep a__first) i) (<= i (to_rep a__last))))
(assert (= o20 i))
