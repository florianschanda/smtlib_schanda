...
(define-fun tab34 () map__ref (mk_map__ref tab))
(assert (in_range1 a))
(assert (in_range1 b))
...
(assert (=> (<= j1 b) (= (mk_map__ref result1) tab34)))
(assert (=> (<= j1 b) (= tab2 o2)))
...
(assert (=> (<= j24 b) (forall ((l1 Int)) (=> (and (<= a l1) (<= l1 (- j26 1))) (= (to_rep (select tab21 l1)) l1)))))
...
(assert (=> (<= j31 b) (forall ((l1 Int)) (=> (and (<= a l1) (<= l1 (- j33 1))) (= (to_rep (select tab27 l1)) l1)))))
...
(assert (= k18 o28))
(assert (= j40 (+ a k19)))
(assert (forall ((l1 Int)) (=> (and (<= a l1) (<= l1 (- j40 1))) (= (to_rep (select tab33 l1)) l1))))
(assert (forall ((l1 Int)) (=> (and (<= a l1) (<= l1 (- (+ a k19) 1))) (= (to_rep (select tab33 l1)) l1))))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 j40)) (=> (<= (- 2147483648) 2147483647) (in_range1 k19))))
(assert (and (= o29 (- j40 1)) (in_range1 (- j40 1))))
(assert (= o30 (ite (<= l o29) true false)))
(assert (= result33 (ite (<= a l) o30 false)))
(assert (= result33 true))
(assert (not (<= (to_rep tab__first) l)))
(check-sat)
(exit)
