...
(declare-const o2 us_rep6)
(declare-const o3 us_split_fields10)
(declare-const o4 extended_index_type)
(declare-const o5 Int)
(declare-const o6 Int)
(declare-const o7 Int)
(declare-const o8 us_rep6)
(declare-const o9 us_split_fields10)
...
(assert (= o12 j))
(assert (= o13 (select m o12)))
(assert (= o14 (us_split_fields7 o13)))
(assert (= result5 (rec__tree_model__path_type__k o14)))
(assert (=> (= result5 true) (and (= o6 j) (in_range5 j))))
(assert (=> (= result5 true) (and (= o7 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) o6 0)) (and (in_range2 o7) (= o7 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) o6 0))))))
(assert (=> (= result5 true) (= o8 (select res3 o7))))
(assert (=> (= result5 true) (= o9 (us_split_fields11 o8))))
(assert (=> (= result5 true) (= o10 (rec__red_black_trees__black_count__depth o9))))
(assert (=> (= result5 true) (= o11 (to_rep o10))))
(assert (=> (= result5 true) (= result4 (ite (<= o11 n2) true false))))
(assert (=> (not (= result5 true)) (= result4 false)))
(assert (=> (= result4 true) (and (= o j) (in_range5 j))))
(assert (=> (= result4 true) (and (= o1 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) o 1)) (and (in_range2 o1) (= o1 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) o 1))))))
(assert (=> (= result4 true) (= o2 (select res3 o1))))
(assert (=> (= result4 true) (= o3 (us_split_fields11 o2))))
(assert (=> (= result4 true) (= o4 (rec__red_black_trees__black_count__depth o3))))
(assert (=> (= result4 true) (= o5 (to_rep o4))))
