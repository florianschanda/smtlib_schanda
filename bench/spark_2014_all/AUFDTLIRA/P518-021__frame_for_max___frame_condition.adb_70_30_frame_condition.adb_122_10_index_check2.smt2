...
(declare-const temp___310 (Array Int us_rep))
(declare-const temp___307 Int)
(declare-const temp___305 (Array Int us_rep))
...
(assert (= temp___309 max1))
(assert (= temp___308 c238b))
(assert (= temp___310 a))
(assert (= temp___307 k1))
(assert (= temp___305 a))
(assert (= temp___303 c239b))
...
(assert (= (frame_left (mk___t temp___310 (mk (to_rep1 a__first) (to_rep1 a__last))) a2) true))
(assert (and (and (and (and (=> (<= 0 2147483647) (in_range2 c239b2)) (forall ((temp___306 Int)) (=> (and (<= (to_rep1 a__first) temp___306) (<= temp___306 (to_rep1 a__last))) (and (= (rec__frame_condition__cell__value (us_split_fields1 (select a2 temp___306))) (rec__frame_condition__cell__value (us_split_fields1 (select temp___305 temp___306)))) (= (rec__frame_condition__cell__max_right (us_split_fields1 (select a2 temp___306))) (rec__frame_condition__cell__max_right (us_split_fields1 (select temp___305 temp___306)))))))) (=> (<= 1 2147483647) (in_range3 k2))) (=> (<= 1 2147483647) (in_range3 c238b2))) (=> (<= 0 2147483647) (in_range2 max3))))
...
(assert (= k10 k8))
(assert (= a8 a6))
(assert (and (= o30 (frame_left (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) (map__content a7))) (= (= o30 true) (forall ((i1 Int)) (=> (and (<= (to_rep1 a__first) i1) (<= i1 (to_rep1 a__last))) (= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a7) i1)))) (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a i1))))))))))
(assert (= (= o29 true) (forall ((i1 Int)) (=> (and (<= last3 i1) (<= i1 first3)) (forall ((j1 Int)) (=> (and (<= i1 j1) (<= j1 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a7) j1)))) (get_max_left i1 (map__content a7)))))))))
(assert (<= first3 i))
(assert (<= i last3))
(assert (<= i j))
(assert (<= j last3))
(assert (and (= o27 j) (in_range3 j)))
(assert (and (= o28 (get_max_left o27 (map__content a7))) (and (in_range2 o28) (= o28 (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a7) o27))))))))
