...
(define-fun dynamic_invariant2 ((temp___expr_227 us_rep1) (temp___is_init_223 Bool) (temp___skip_constant_224 Bool) (temp___do_toplevel_225 Bool) (temp___do_typ_inv_226 Bool)) Bool (=> (not (= temp___skip_constant_224 true)) (in_range4 15 (to_base temp___expr_227))))
(define-fun default_initial_assumption ((temp___expr_230 us_rep1) (temp___skip_top_level_231 Bool)) Bool (= (to_rep (rec__main__discr_type__discr (us_split_discrs2 temp___expr_230))) 15))
...
(define-fun dynamic_invariant4 ((temp___expr_39 Int) (temp___is_init_35 Bool) (temp___skip_constant_36 Bool) (temp___do_toplevel_37 Bool) (temp___do_typ_inv_38 Bool)) Bool (=> (or (= temp___is_init_35 true) (<= 0 2147483647)) (in_range temp___expr_39)))
(declare-const temp___discr_236 Int)
(assert (in_range1 temp___discr_236))
(assert (<= 0 temp___discr_236))
(assert (not (<= 0 0)))
(check-sat)
(exit)
