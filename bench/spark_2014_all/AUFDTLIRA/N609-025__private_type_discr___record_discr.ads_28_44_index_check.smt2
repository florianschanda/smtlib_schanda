...
(define-fun o21 () us_rep (mk___rep (mk___split_discrs o18) (mk___split_fields o19)))
(define-fun o22 () us_rep1 (mk___rep1 (mk___split_discrs1 o15) (mk___split_fields1 (mk___t o16 o17))))
...
(assert (=> (not (= result true)) (= o22 (to_base (mk___rep2 (mk___split_discrs1 o12) (mk___split_fields2 (mk___t1 o13 o14)))))))
(assert (=> (not (= result true)) (and (= o21 (search_upto o22 e)) (ite (= o18 true) (and (<= (get_content o21) (to_rep o15)) (= (to_rep (select o16 (get_content o21))) e)) (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep o15))) (not (= (to_rep (select o16 i)) e))))))))
(assert (=> (not (= result true)) (= result3 record_discr__search_upto__result10)))
(assert (=> (not (= result true)) (= record_discr__search_upto__result3 o21)))
...
(assert (and (= o20 (get_content (result_ty__content record_discr__search_upto__result8))) (in_range2 o20)))
(assert (= result4 (ite (<= o20 (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r)))) true false)))
(assert (= result4 true))
(assert (and (= temp___302 (get_content (result_ty__content record_discr__search_upto__result8))) (in_range2 temp___302)))
(assert (not (<= temp___302 (to_rep1 (last (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))))))
(check-sat)
(exit)
