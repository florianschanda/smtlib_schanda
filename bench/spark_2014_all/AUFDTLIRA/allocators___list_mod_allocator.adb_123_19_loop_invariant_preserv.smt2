...
(assert (not (= (int__content r12) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data (get (sequence__content avail4) (length (sequence__content avail4))))))))))
(check-sat)
(exit)
