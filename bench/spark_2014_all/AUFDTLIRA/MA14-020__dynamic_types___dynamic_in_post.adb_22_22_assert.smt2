...
(declare-datatypes () ((t29b__ref (mk_t29b__ref (t29b__content us_t1)))))
(define-fun t29b__ref___projection ((a t29b__ref)) us_t1 (t29b__content a))
(assert (forall ((s us_t)) (! (=> (dynamic_invariant1 s true true true true) (let ((result (get_last s))) (and (= result (last3 (let ((temp___206 (last1 s))) (let ((temp___205 (first1 s))) (of_array1 (to_array s) temp___205 temp___206))))) (dynamic_invariant result true false true true)))) :pattern ((get_last s)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_236 us_void_param) 1)) 104) (= (to_rep (select (temp___String_Literal_236 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_236 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_236 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_236 us_void_param) 5)) 111)) :pattern ((temp___String_Literal_236 us_void_param)))))
(declare-fun temp___String_Literal_238 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_238 us_void_param) 1)) 121) (= (to_rep (select (temp___String_Literal_238 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_238 us_void_param) 3)) 117)) :pattern ((temp___String_Literal_238 us_void_param)))))
...
(assert (= result x))
(assert (= x1 (temp___String_Literal_236 Tuple0)))
...
(assert (= result1 y))
(assert (= y1 (temp___String_Literal_238 Tuple0)))
...
(assert (and (= o (get_last (mk___t x1 (mk (to_rep1 x__first) (to_rep1 x__last))))) (and (in_range o) (= o (to_rep1 (last2 (mk1 (to_rep1 (first (mk (to_rep1 x__first) (to_rep1 x__last)))) (to_rep1 (last (mk (to_rep1 x__first) (to_rep1 x__last)))))))))))
(assert (= result2 a))
(assert (= a1 o))
(assert (in_range a1))
(assert (and (= o1 (get_last (mk___t y1 (mk (to_rep1 y__first) (to_rep1 y__last))))) (and (in_range o1) (= o1 (to_rep1 (last2 (mk1 (to_rep1 (first (mk (to_rep1 y__first) (to_rep1 y__last)))) (to_rep1 (last (mk (to_rep1 y__first) (to_rep1 y__last)))))))))))
(assert (= result3 b))
(assert (= b1 o1))
(assert (in_range b1))
(assert (not (= a1 b1)))
