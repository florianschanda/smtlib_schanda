...
(assert (not (<= (int__content result__3) (to_rep1 (last2 (rt1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields__content2 current__split_fields6))))))))))
(check-sat)
(exit)
