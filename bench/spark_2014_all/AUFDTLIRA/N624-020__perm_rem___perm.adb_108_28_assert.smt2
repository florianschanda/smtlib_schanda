...
(assert (not (= (to_rep (select (elts b) (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))))) (to_rep (select (elts a) (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))))))))
(check-sat)
(exit)
