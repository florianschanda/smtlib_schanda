...
(assert (= (mk___rep (mk___split_discrs result4) (mk___split_fields result5 (mk___t result6 result7))) (sequence__content bounded_dynamic_strings__instance__3__result13)))
(assert (not (= (let ((temp___994 (value (sequence__content bounded_dynamic_strings__instance__3__result13)))) (bool_eq (elts1 temp___994) (to_rep2 (first2 (rt1 temp___994))) (to_rep2 (last2 (rt1 temp___994))) (elts1 content) (to_rep2 (first2 (rt1 content))) (to_rep2 (last2 (rt1 content))))) true)))
(check-sat)
(exit)
