...
(assert (not (= (ite (<= (to_rep1 (first14 temp___16751)) (to_rep1 (last14 temp___16751))) (+ (- (to_rep1 (last14 temp___16751)) (to_rep1 (first14 temp___16751))) 1) 0) (ite (<= r15b 10) (+ (- 10 r15b) 1) 0))))
(check-sat)
(exit)
