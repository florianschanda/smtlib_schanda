...
(define-fun dynamic_invariant1 ((temp___expr_342 Int) (temp___is_init_338 Bool) (temp___skip_constant_339 Bool) (temp___do_toplevel_340 Bool) (temp___do_typ_inv_341 Bool)) Bool (=> (or (= temp___is_init_338 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_342)))
(declare-const eof Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-fun temp_____aggregate_def_412 ((Array Int character) Int Int) (Array Int character))
...
(declare-fun temp_____aggregate_def_433 ((Array Int character) Int Int) (Array Int character))
...
(assert (forall ((temp___435 (Array Int character))) (forall ((temp___436 Int) (temp___437 Int)) (let ((temp___434 (temp_____aggregate_def_433 temp___435 temp___436 temp___437))) (=> (and (dynamic_invariant temp___436 true true true true) (dynamic_invariant2 temp___437 true true true true)) (forall ((temp___438 Int)) (ite (= temp___438 temp___436) (= (to_rep (select temp___434 temp___438)) temp___437) (= (select temp___434 temp___438) (select temp___435 temp___438)))))))))
(assert (forall ((temp___414 (Array Int character))) (forall ((temp___415 Int) (temp___416 Int)) (let ((temp___413 (temp_____aggregate_def_412 temp___414 temp___415 temp___416))) (=> (and (dynamic_invariant temp___415 true true true true) (dynamic_invariant2 temp___416 true true true true)) (forall ((temp___417 Int)) (ite (= temp___417 temp___415) (= (to_rep (select temp___413 temp___417)) temp___416) (= (select temp___413 temp___417) (select temp___414 temp___417)))))))))
(define-fun dynamic_invariant3 ((temp___expr_398 Int) (temp___is_init_394 Bool) (temp___skip_constant_395 Bool) (temp___do_toplevel_396 Bool) (temp___do_typ_inv_397 Bool)) Bool (=> (or (= temp___is_init_394 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_398)))
...
(assert (=> (not (= ch eof)) (and (=> (not (= result__2 eof)) (and (= cur_position2 (- cur_position 1)) (= (bool_eq the_file2 1 2147483647 (temp_____aggregate_def_412 the_file cur_position2 ch) 1 2147483647) true))) (and (in_range2 result__2) (in_range cur_position2)))))
