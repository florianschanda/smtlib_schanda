...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__containers__container__l natural) (rec__containers__container__v us_t)))))
(define-fun us_split_fields_L__projection ((a us_split_fields)) natural (rec__containers__container__l a))
(define-fun us_split_fields_V__projection ((a us_split_fields)) us_t (rec__containers__container__v a))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__containers__container__c (us_split_discrs1 a))) (to_rep (rec__containers__container__c (us_split_discrs1 b)))) (and (= (to_rep (rec__containers__container__l (us_split_fields1 a))) (to_rep (rec__containers__container__l (us_split_fields1 b)))) (= (bool_eq1 (rec__containers__container__v (us_split_fields1 a)) (rec__containers__container__v (us_split_fields1 b))) true))) true false))
...
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__dic_pred__s__f (us_split_fields3 a))) (to_rep (rec__dic_pred__s__f (us_split_fields3 b)))) true false))
...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__dic_pred__t__f natural)))))
(define-fun us_split_fields_F__projection ((a us_split_fields4)) natural (rec__dic_pred__t__f a))
...
(define-fun bool_eq4 ((a us_rep2) (b us_rep2)) Bool (ite (= (to_rep (rec__dic_pred__t__f (us_split_fields5 a))) (to_rep (rec__dic_pred__t__f (us_split_fields5 b)))) true false))
...
(declare-fun get (us_rep2) Int)
(declare-fun get__function_guard (Int us_rep2) Bool)
(define-fun dynamic_invariant2 ((temp___expr_170 us_rep2) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool) (temp___do_typ_inv_169 Bool)) Bool (=> (= temp___do_toplevel_168 true) (=> (= temp___is_init_166 true) (< 0 (id (to_rep (rec__dic_pred__t__f (us_split_fields5 temp___expr_170))))))))
(define-fun default_initial_assumption ((temp___expr_172 us_rep2) (temp___skip_top_level_173 Bool)) Bool (and (= (to_rep (rec__dic_pred__t__f (us_split_fields5 temp___expr_172))) 0) (=> (not (= temp___skip_top_level_173 true)) (< 0 (get temp___expr_172)))))
(define-fun dynamic_predicate ((temp___175 us_rep2)) Bool (< 0 (id (to_rep (rec__dic_pred__t__f (us_split_fields5 temp___175))))))
...
(declare-fun tT1sP1qtint (tT1sP1) Int)
(assert (forall ((i tT1sP1)) (and (<= 1 (tT1sP1qtint i)) (<= (tT1sP1qtint i) 10))))
...
(define-fun to_base ((a us_rep3)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (rec__containers__container__l1 (us_split_fields7 a)) (of_array (rec__containers__container__v1 (us_split_fields7 a)) 1 10))))
(define-fun of_base ((r us_rep)) us_rep3 (mk___rep3 (us_split_discrs1 r) (mk___split_fields3 (rec__containers__container__l (us_split_fields1 r)) (let ((temp___155 (rec__containers__container__v (us_split_fields1 r)))) (to_array temp___155)))))
(define-fun bool_eq5 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (to_rep (rec__containers__container__c (us_split_discrs2 a))) (to_rep (rec__containers__container__c (us_split_discrs2 b)))) (and (= (to_rep (rec__containers__container__l1 (us_split_fields7 a))) (to_rep (rec__containers__container__l1 (us_split_fields7 b)))) (= (bool_eq (rec__containers__container__v1 (us_split_fields7 a)) 1 10 (rec__containers__container__v1 (us_split_fields7 b)) 1 10) true))) true false))
(define-fun in_range3 ((rec__containers__container__c1 Int) (a us_rep)) Bool (= rec__containers__container__c1 (to_rep (rec__containers__container__c (us_split_discrs1 a)))))
...
(assert (= c (id 0)))
(assert (forall ((x us_rep2)) (! (=> (dynamic_invariant2 x true true true true) (dynamic_invariant (get x) true false true true)) :pattern ((get x)))))
(assert (forall ((x us_rep2)) (! (=> (dynamic_invariant2 x true true true true) (= (get x) (id (to_rep (rec__dic_pred__t__f (us_split_fields5 x)))))) :pattern ((get x)))))
(define-fun dynamic_invariant3 ((temp___expr_195 us_rep) (temp___is_init_191 Bool) (temp___skip_constant_192 Bool) (temp___do_toplevel_193 Bool) (temp___do_typ_inv_194 Bool)) Bool (let ((temp___196 (rec__containers__container__c (us_split_discrs1 temp___expr_195)))) (and (dynamic_property1 1 (to_rep temp___196) (first1 (rec__containers__container__v (us_split_fields1 temp___expr_195))) (last1 (rec__containers__container__v (us_split_fields1 temp___expr_195)))) (and (= (first1 (rec__containers__container__v (us_split_fields1 temp___expr_195))) 1) (= (last1 (rec__containers__container__v (us_split_fields1 temp___expr_195))) (to_rep temp___196))))))
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant3 x true true true true) (dynamic_invariant1 (length1 x) true false true true)) :pattern ((length1 x)))))
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant3 x true true true true) (= (length1 x) (to_rep (rec__containers__container__l (us_split_fields1 x))))) :pattern ((length1 x)))))
...
(assert (in_range c))
(assert (= (id 0) c))
(assert (default_initial_assumption (mk___rep2 (mk___split_fields2 x__split_fields)) false))
(assert (and (= (to_rep y__split_fields) c) (<= 0 c)))
(assert (and (= us 10) (in_range1 10)))
(assert (and (and (= (to_rep (rec__containers__container__c v__split_discrs)) 10) (= (to_rep v__split_fields) 0)) (= (length1 (mk___rep v__split_discrs (mk___split_fields v__split_fields (mk___t v__split_fields1 (mk 1 10))))) 0)))
