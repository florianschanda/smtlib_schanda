...
(assert true)
(declare-const i Int)
(declare-const temp___1731 (Array Int us_rep3))
...
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___1731 (model__ f_old root)) (and (dynamic_invariant5 temp___1731 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1731 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1731 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f_old i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1731 (parent f_old i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1731 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1731 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1731 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1731 (parent f_old i1)))) (position f_old i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1731 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1731 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1731 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1731 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1731 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1731 j)))) true)) (= j i1))))))))))))))
