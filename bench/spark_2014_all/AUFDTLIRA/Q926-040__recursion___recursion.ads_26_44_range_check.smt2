...
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= temp___188 count1)))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= temp___187 index1)))
