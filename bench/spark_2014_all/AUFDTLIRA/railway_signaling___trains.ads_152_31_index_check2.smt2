...
(assert (and (= o14 (get_previous_track o23 id)) (and (in_range5 o14) (= o14 (to_rep4 (select (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 o13)))))) id))))))
...
(assert (=> (= result1 true) (and (= temp___370 (get_previous_track o22 id)) (and (in_range5 temp___370) (= temp___370 (to_rep4 (select (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 o19)))))) id)))))))
(assert (=> (= result1 true) (and (<= 1 temp___370) (<= temp___370 8))))
(assert (=> (= result1 true) (= o20 temp___370)))
(assert (=> (= result1 true) (= o21 (select track_signals o20))))
(assert (=> (= result1 true) (= temp___371 (to_rep5 o21))))
...
(assert (and (= o4 (get_other_previous_track o25 id)) (and (in_range5 o4) (= o4 (ite (= (to_rep4 (select (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 o1)))))) id)) (to_rep1 o3)) 0 (to_rep4 (select (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 o1)))))) id)))))))
...
(assert (and (= temp___372 (get_other_previous_track o24 id)) (and (in_range5 temp___372) (= temp___372 (ite (= (to_rep4 (select (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 o7)))))) id)) (to_rep1 o9)) 0 (to_rep4 (select (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 o7)))))) id)))))))
(assert (not (<= 1 temp___372)))
(check-sat)
(exit)
