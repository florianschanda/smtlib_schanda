...
(assert (= o10 i))
(assert (= o11 (select change3 o10)))
(assert (= o12 (to_rep o11)))
(assert (= o13 (ite (= o12 0) true false)))
(assert (not (< (to_rep1 (first (rt new_val))) 0)))
(assert (and (= o9 (- 2147483647 (to_rep1 (first (rt new_val))))) (in_range1 (- 2147483647 (to_rep1 (first (rt new_val)))))))
