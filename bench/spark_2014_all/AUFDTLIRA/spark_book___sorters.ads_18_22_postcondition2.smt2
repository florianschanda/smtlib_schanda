...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (and (= o6 (index_of_minimum (mk___t o4 o5))) (and (in_range2 o6) (and (and (<= (to_rep (first o5)) o6) (<= o6 (to_rep (last o5)))) (forall ((j Int)) (=> (and (<= (to_rep (first o5)) j) (<= j (to_rep (last o5)))) (<= (to_rep (select o4 o6)) (to_rep (select o4 j))))))))))
...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (=> (not (= smallest2 current1)) (and (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t o8 (mk (to_rep values__first) (to_rep values__last)))) true) (and (= (to_rep (select o8 o7)) (to_rep (select values smallest2))) (and (= (to_rep (select o8 smallest2)) (to_rep (select values o7))) (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j (to_rep values__last))) (=> (and (not (= j o7)) (not (= j smallest2))) (= (to_rep (select o8 j)) (to_rep (select values j))))))))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (=> (not (not (= smallest2 current1))) (= o8 values))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (=> (not (not (= smallest2 current1))) (= o8 values1))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (= (perm_transitive (mk___t temp___221 (mk (to_rep values__first) (to_rep values__last))) (mk___t values_last2 (mk (to_rep values_last__first) (to_rep values_last__last))) (mk___t o8 (mk (to_rep values__first) (to_rep values__last)))) true)))
...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (forall ((j Int)) (=> (and (<= current2 j) (<= j (to_rep values__last))) (<= (to_rep (select values2 current2)) (to_rep (select values2 j)))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___217)) (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j current2)) (<= (to_rep (select values2 j)) (to_rep (select values2 (+ j 1))))))))
...
(assert (not (<= (to_rep (select (map__content values7) j)) (to_rep (select (map__content values7) (+ j 1))))))
(check-sat)
(exit)
