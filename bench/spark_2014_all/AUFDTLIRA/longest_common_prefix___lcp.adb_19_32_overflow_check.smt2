...
(assert (= l2 result5))
(assert (= l3 o8))
(assert (and (= o10 (+ x l3)) (in_range1 (+ x l3))))
(assert (= result7 (ite (<= o10 (to_rep (last (rt a)))) true false)))
(assert (=> (= result7 true) (and (= o9 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result7 true) (= result6 (ite (<= o9 (to_rep (last (rt a)))) true false))))
