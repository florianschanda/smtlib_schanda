...
(define-fun dynamic_invariant3 ((temp___expr_589 Int) (temp___is_init_585 Bool) (temp___skip_constant_586 Bool) (temp___do_toplevel_587 Bool) (temp___do_typ_inv_588 Bool)) Bool (=> (or (= temp___is_init_585 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_589)))
...
(declare-const a__split_fields5 t)
(declare-const tmp2 Int)
(declare-const a__split_fields6 (Array Int value))
(declare-const a__split_fields7 t)
(declare-const tmp3 Int)
(declare-const result1 Bool)
(define-fun a__split_fields8 () us_split_fields (mk___split_fields (mk___t a__split_fields2 a__split_fields3)))
(assert (dynamic_invariant1 (mk___rep a__split_discrs (mk___split_fields (mk___t a__split_fields a__split_fields1))) true false true true))
(assert (= (mk_int__ref result) (mk_int__ref tmp)))
(assert (= tmp1 (to_rep (rec__simple_unc_arrays__table__last a__split_discrs))))
(assert (in_range2 tmp1))
(assert (dynamic_invariant1 (mk___rep a__split_discrs a__split_fields8) true true true true))
(assert (= tmp1 tmp2))
(assert (= a__split_fields4 a__split_fields2))
(assert (= a__split_fields5 a__split_fields3))
(assert (= tmp3 tmp1))
(assert (= (mk___split_fields (mk___t a__split_fields6 a__split_fields7)) a__split_fields8))
(assert (= (= result1 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) 1))) (<= (to_rep2 (select a__split_fields4 j1)) (to_rep2 (select a__split_fields4 (+ j1 1))))))))
(assert (= result1 true))
(assert (<= 1 j))
(assert (<= j (to_rep (rec__simple_unc_arrays__table__last a__split_discrs))))
(assert (<= 1 k))
(assert (<= k (to_rep (rec__simple_unc_arrays__table__last a__split_discrs))))
(assert (and (<= (to_rep1 (first a__split_fields5)) k) (<= k (to_rep1 (last a__split_fields5)))))
(assert (= o k))
(assert (= o1 (select a__split_fields4 o)))
(assert (= o2 (to_rep2 o1)))
(assert (not (<= (to_rep1 (first a__split_fields1)) j)))
(check-sat)
(exit)
