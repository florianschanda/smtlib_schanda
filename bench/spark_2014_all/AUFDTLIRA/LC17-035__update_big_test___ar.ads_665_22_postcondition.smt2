...
(declare-fun temp_____aggregate_def_2624 ((Array Int (Array Int (Array Int (Array Int et1)))) Int (Array Int (Array Int (Array Int et1)))) (Array Int (Array Int (Array Int (Array Int et1)))))
(declare-fun temp_____aggregate_def_2630 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp_____aggregate_def_2636 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
...
(assert (forall ((temp___2626 (Array Int (Array Int (Array Int (Array Int et1)))))) (forall ((temp___2627 Int)) (forall ((temp___2628 (Array Int (Array Int (Array Int et1))))) (let ((temp___2625 (temp_____aggregate_def_2624 temp___2626 temp___2627 temp___2628))) (=> (dynamic_invariant2 temp___2627 true true true true) (forall ((temp___2629 Int)) (ite (= temp___2629 temp___2627) (= (select temp___2625 temp___2629) temp___2628) (= (select temp___2625 temp___2629) (select temp___2626 temp___2629))))))))))
(assert (forall ((temp___2632 (Array Int (Array Int (Array Int et1))))) (forall ((temp___2633 Int)) (forall ((temp___2634 (Array Int (Array Int et1)))) (let ((temp___2631 (temp_____aggregate_def_2630 temp___2632 temp___2633 temp___2634))) (=> (dynamic_invariant1 temp___2633 true true true true) (forall ((temp___2635 Int)) (ite (= temp___2635 temp___2633) (= (select temp___2631 temp___2635) temp___2634) (= (select temp___2631 temp___2635) (select temp___2632 temp___2635))))))))))
(assert (forall ((temp___2638 (Array Int (Array Int et1)))) (forall ((temp___2639 Int)) (forall ((temp___2640 (Array Int et1))) (let ((temp___2637 (temp_____aggregate_def_2636 temp___2638 temp___2639 temp___2640))) (=> (dynamic_invariant temp___2639 true true true true) (forall ((temp___2641 Int)) (ite (= temp___2641 temp___2639) (= (select temp___2637 temp___2641) temp___2640) (= (select temp___2637 temp___2641) (select temp___2638 temp___2641))))))))))
...
(assert (= a3 a4))
(assert (= a5 a3))
(assert (not (= (bool_eq3 a4 90 99 (temp_____aggregate_def_2624 a i (temp_____aggregate_def_2630 b j (temp_____aggregate_def_2636 c k d))) 90 99) true)))
(check-sat)
(exit)
