...
(assert (and (and (=> (<= 1 100) (in_range3 i2)) (forall ((temp___203 Int)) (=> (and (<= 1 temp___203) (<= temp___203 100)) (=> (or (< 100 temp___203) (or (< temp___203 1) (< i2 temp___203))) (= (select c3 temp___203) (select c temp___203)))))) (and (<= 1 i2) (<= i2 100))))
(assert (not (= i2 100)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
