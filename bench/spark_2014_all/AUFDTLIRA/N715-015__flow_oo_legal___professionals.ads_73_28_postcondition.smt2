...
(assert (forall ((x professions)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x professions)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x skills)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x skills)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x Int)) (! (=> (in_range3 x) (= (to_rep3 (of_rep3 x)) x)) :pattern ((to_rep3 (of_rep3 x))))))
(declare-datatypes () ((map__ref (mk_map__ref (map__content (Array Int skills))))))
(declare-fun slide ((Array Int skills) Int Int) (Array Int skills))
(assert (forall ((a (Array Int skills))) (forall ((first Int)) (! (= (slide a first first) a) :pattern ((slide a first first))))))
(assert (forall ((a (Array Int skills))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide a old_first new_first) i))))))))
(define-fun bool_eq2 ((a (Array Int skills)) (a__first Int) (a__last Int) (b (Array Int skills)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_181 Int)) (=> (and (<= a__first temp___idx_181) (<= temp___idx_181 a__last)) (= (to_rep3 (select a temp___idx_181)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_181))))))) true false))
...
(declare-fun object__size2 ((Array Int skills)) Int)
(declare-const value__component__size Int)
(declare-fun object__component__size ((Array Int skills)) Int)
(declare-const value__alignment2 Int)
(declare-fun object__alignment2 ((Array Int skills)) Int)
(assert (<= 0 value__size2))
(assert (forall ((a (Array Int skills))) (<= 0 (object__size2 a))))
(assert (<= 0 value__component__size))
(assert (forall ((a (Array Int skills))) (<= 0 (object__component__size a))))
(assert (<= 0 value__alignment2))
(assert (forall ((a (Array Int skills))) (<= 0 (object__alignment2 a))))
...
(assert (forall ((x character)) (! (in_range6 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_91 Int)) (=> (and (<= a__first temp___idx_91) (<= temp___idx_91 a__last)) (= (to_rep4 (select a temp___idx_91)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_91)))))))))))
(declare-sort t 0)
...
(define-fun dynamic_property ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range low) (and (in_range high) (=> (<= low high) (and (in_range5 low) (in_range5 high))))))
...
(define-fun bool_eq5 ((x us_t) (y us_t)) Bool (bool_eq4 (elts x) (to_rep1 (first (rt x))) (to_rep1 (last (rt x))) (elts y) (to_rep1 (first (rt y))) (to_rep1 (last (rt y)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep4 (select (temp___String_Literal_1005 us_void_param) 1)) 78) (= (to_rep4 (select (temp___String_Literal_1005 us_void_param) 2)) 97)) (= (to_rep4 (select (temp___String_Literal_1005 us_void_param) 3)) 109)) (= (to_rep4 (select (temp___String_Literal_1005 us_void_param) 4)) 101)) (= (to_rep4 (select (temp___String_Literal_1005 us_void_param) 5)) 108)) (= (to_rep4 (select (temp___String_Literal_1005 us_void_param) 6)) 101)) (= (to_rep4 (select (temp___String_Literal_1005 us_void_param) 7)) 115)) (= (to_rep4 (select (temp___String_Literal_1005 us_void_param) 8)) 115)) :pattern ((temp___String_Literal_1005 us_void_param)))))
...
(define-fun dynamic_invariant2 ((temp___expr_46 Int) (temp___is_init_42 Bool) (temp___skip_constant_43 Bool) (temp___do_toplevel_44 Bool) (temp___do_typ_inv_45 Bool)) Bool (=> (or (= temp___is_init_42 true) (<= 1 2147483647)) (in_range5 temp___expr_46)))
...
(define-fun dynamic_invariant5 ((temp___expr_1022 Int) (temp___is_init_1018 Bool) (temp___skip_constant_1019 Bool) (temp___do_toplevel_1020 Bool) (temp___do_typ_inv_1021 Bool)) Bool (=> (or (= temp___is_init_1018 true) (<= 0 3)) (in_range2 temp___expr_1022)))
(define-fun dynamic_invariant6 ((temp___expr_1029 Int) (temp___is_init_1025 Bool) (temp___skip_constant_1026 Bool) (temp___do_toplevel_1027 Bool) (temp___do_typ_inv_1028 Bool)) Bool (=> (or (= temp___is_init_1025 true) (<= 0 12)) (in_range3 temp___expr_1029)))
(assert true)
(assert true)
...
(assert (forall ((p us_rep2)) (! (= (= (has_licence_to_kill p) true) (let ((temp___1082 (to_rep2 (rec__professionals__professional__profession (us_split_fields3 p))))) (or (= temp___1082 2) (= temp___1082 3)))) :pattern ((has_licence_to_kill p)))))
(assert true)
(assert true)
(assert true)
...
(declare-const temp___1216 professions)
(declare-const temp___12161 (Array Int skills))
(declare-const temp___12162 natural)
(declare-const temp___12163 us_rep)
(declare-const temp___12164 integer)
(declare-const temp___12165 Bool)
(declare-const temp___12166 us_private)
(declare-const temp___12167 Int)
...
(assert (= temp___1216 o2))
(assert (= temp___12161 o3))
(assert (= temp___12162 o4))
(assert (= temp___12163 o5))
(assert (= temp___12164 o6))
(assert (= temp___12165 o7))
(assert (= temp___12166 o8))
(assert (= killer__attr__tag temp___12167))
...
(assert (= temp___1216 killer__split_fields7))
(assert (= temp___12161 killer__split_fields8))
(assert (= temp___12162 killer__split_fields9))
(assert (= temp___12163 killer__split_fields10))
(assert (= temp___12164 killer__split_fields11))
(assert (= temp___12165 killer__split_fields12))
(assert (= temp___12166 killer__split_fields13))
...
(assert (not (not (= (is_alive1 victim__attr__tag (mk___rep (mk___split_fields victim__split_fields8 victim__split_fields9 victim__split_fields10 victim__split_fields11) victim__attr__tag)) true))))
(check-sat)
(exit)
