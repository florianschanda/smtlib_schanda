...
(assert (= (bool_eq (temp_____aggregate_def_707 32) 1 5 (temp_____aggregate_def_711 32 32) 1 5) true))
(assert (not (= (bool_eq1 (mk___rep (mk___split_fields rliteral (temp_____aggregate_def_720 32))) (mk___rep (mk___split_fields rliteral (temp_____aggregate_def_724 32 32)))) true)))
(check-sat)
(exit)
