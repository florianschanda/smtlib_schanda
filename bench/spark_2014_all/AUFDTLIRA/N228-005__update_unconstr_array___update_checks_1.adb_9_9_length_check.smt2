...
(declare-fun temp_____aggregate_def_248 (us_t Int Int) us_t)
(declare-fun temp_____aggregate_def_417 (us_t Int Int) us_t)
...
(assert (= o i))
(assert (= (mk___t temp___423 temp___4231) (temp_____aggregate_def_417 (mk___t a (mk (to_rep a__first) (to_rep a__last))) o new_val)))
(assert (not (= (ite (<= (to_rep (first temp___4231)) (to_rep (last temp___4231))) (+ (- (to_rep (last temp___4231)) (to_rep (first temp___4231))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0))))
(check-sat)
(exit)
