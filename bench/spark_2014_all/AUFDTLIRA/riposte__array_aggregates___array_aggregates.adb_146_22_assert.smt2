...
(assert (forall ((temp___492 Int) (temp___493 Int)) (let ((temp___491 (temp_____aggregate_def_490 temp___492 temp___493))) (=> (and (dynamic_invariant temp___492 true true true true) (dynamic_invariant temp___493 true true true true)) (forall ((temp___494 Int)) (ite (or (= temp___494 2) (and (<= 4 temp___494) (<= temp___494 6))) (= (select temp___491 temp___494) rliteral) (= (select temp___491 temp___494) rliteral1)))))))
