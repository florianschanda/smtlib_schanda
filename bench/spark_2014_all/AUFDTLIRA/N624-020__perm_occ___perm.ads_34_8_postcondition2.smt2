...
(define-fun dynamic_invariant2 ((temp___expr_172 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 0 100)) (in_range4 temp___expr_172)))
...
(define-fun dynamic_invariant3 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 1 100)) (in_range3 temp___expr_159)))
(assert true)
...
(assert (and (= perm__occ_set__b__assume2 (remove_last a)) (and (dynamic_invariant1 perm__occ_set__b__assume2 true false true true) (and (= (elts a) perm__occ_set__b__assume) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1))))) perm__occ_set__b__assume1)))))
...
(assert (or (and (and (= b1 b3) (= b4 b1)) (= (length a) 0)) (and (not (= (length a) 0)) (and (and (= b2 b3) (= b4 b2)) (ite (= i (to_rep1 (last (rt a)))) (and (and (and (= o11 (remove_last r)) (and (dynamic_invariant1 o11 true false true true) (and (= (elts r) o) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1))))) o1)))) (= (occ (mk___t b1 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (occ o11 e))) (= b2 b1)) (and (and (and (= (to_rep o2) v) (and (and (and (<= (to_rep1 b__first) i) (<= i (to_rep1 b__last))) (= o3 i)) (= o4 (store b1 o3 o2)))) (and (= b1 result1) (= b2 o4))) (and (and (and (= o10 (remove_last r)) (and (dynamic_invariant1 o10 true false true true) (and (= (elts r) o5) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1))))) o6)))) (= (occ o10 e) (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e))) (and (and (= o9 (remove_last a)) (and (dynamic_invariant1 o9 true false true true) (and (= (elts a) o7) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1))))) o8)))) (ite (= v (to_rep (select o7 i))) (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (occ o9 e)) (ite (= v e) (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (+ (occ o9 e) 1)) (ite (= (to_rep (select o7 i)) e) (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (- (occ o9 e) 1)) (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (occ o9 e)))))))))))))
