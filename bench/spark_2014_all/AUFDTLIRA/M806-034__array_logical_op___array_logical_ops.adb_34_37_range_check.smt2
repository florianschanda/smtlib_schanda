...
(assert (forall ((i t19b)) (and (<= 6 (t19bqtint i)) (<= (t19bqtint i) 45))))
...
(assert (forall ((i t21b)) (and (<= 1 (t21bqtint i)) (<= (t21bqtint i) 40))))
...
(assert (forall ((temp___179 Int) (temp___180 Int) (temp___181 Int)) (let ((temp___178 (array_logical_ops__test_ok3__v__aggregate_def temp___179 temp___180 temp___181))) (=> (and (and (dynamic_invariant2 temp___179 true true true true) (dynamic_invariant2 temp___180 true true true true)) (dynamic_invariant2 temp___181 true true true true)) (forall ((temp___182 Int)) (ite (and (<= 36 temp___182) (<= temp___182 45)) (= (to_rep (select temp___178 temp___182)) temp___181) (ite (and (<= 16 temp___182) (<= temp___182 35)) (= (to_rep (select temp___178 temp___182)) temp___180) (=> (and (<= 6 temp___182) (<= temp___182 15)) (= (to_rep (select temp___178 temp___182)) temp___179)))))))))
(assert (= x (of_array (array_logical_ops__test_ok3__x__aggregate_def 1 0 1 0) 1 40)))
(assert (forall ((temp___184 Int) (temp___185 Int) (temp___186 Int) (temp___187 Int)) (let ((temp___183 (array_logical_ops__test_ok3__x__aggregate_def temp___184 temp___185 temp___186 temp___187))) (=> (and (and (and (dynamic_invariant2 temp___184 true true true true) (dynamic_invariant2 temp___185 true true true true)) (dynamic_invariant2 temp___186 true true true true)) (dynamic_invariant2 temp___187 true true true true)) (forall ((temp___188 Int)) (ite (and (<= 31 temp___188) (<= temp___188 40)) (= (to_rep (select temp___183 temp___188)) temp___187) (ite (and (<= 21 temp___188) (<= temp___188 30)) (= (to_rep (select temp___183 temp___188)) temp___186) (ite (and (<= 11 temp___188) (<= temp___188 20)) (= (to_rep (select temp___183 temp___188)) temp___185) (=> (and (<= 1 temp___188) (<= temp___188 10)) (= (to_rep (select temp___183 temp___188)) temp___184))))))))))
