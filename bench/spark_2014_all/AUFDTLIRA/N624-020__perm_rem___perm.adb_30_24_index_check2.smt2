...
(assert (in_range3 ia))
(assert (and (= (invariant__ a) true) (and (= (invariant__ b) true) (and (and (<= (to_rep1 (first (rt a))) ia) (<= ia (to_rep1 (last (rt a))))) (exists ((ib3 Int)) (and (and (<= (to_rep1 (first (rt b))) ib3) (<= ib3 (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) ia)) (to_rep (select (elts b) ib3))) (= (is_perm (remove a ia) (remove b ib3)) true))))))))
...
(assert (=> (= result2 true) (and (= o11 (remove b o2)) (and (dynamic_invariant o11 true false true true) (and (= (invariant__ o11) true) (and (= (to_rep1 (last o4)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o2 1))) (= (to_rep (select (elts b) k)) (to_rep (select o3 k))))) (and (forall ((k Int)) (=> (and (<= (+ o2 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o3 (- k 1)))))) (forall ((k Int)) (=> (and (<= o2 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o3 k)))))))))))))
(assert (=> (= result2 true) (and (= o12 (remove a ia)) (and (dynamic_invariant o12 true false true true) (and (= (invariant__ o12) true) (and (= (to_rep1 (last o1)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o k)))))))))))))
(assert (=> (= result2 true) (and (= result1 (is_perm o12 o11)) (= (= result1 true) (or (and (= (length o12) 0) (= (length o11) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first o1)) ia1) (<= ia1 (to_rep1 (last o1)))) (exists ((ib3 Int)) (and (and (<= (to_rep1 (first o4)) ib3) (<= ib3 (to_rep1 (last o4)))) (and (= (to_rep (select o ia1)) (to_rep (select o3 ib3))) (= (is_perm (remove o12 ia1) (remove o11 ib3)) true)))))))))))
...
(assert (forall ((kb1 Int)) (=> (and (<= 1 kb1) (<= kb1 ib2)) (not (and (= (to_rep (select (elts a) ia)) (to_rep (select (elts b) kb1))) (= (is_perm (remove a ia) (remove b kb1)) true))))))
(assert (and (=> (<= (to_rep1 (first (rt b))) (to_rep1 (last (rt b)))) (dynamic_property1 (to_rep1 (first (rt b))) (to_rep1 (last (rt b))) ib2)) (and (<= (to_rep1 (first (rt b))) ib2) (<= ib2 (to_rep1 (last (rt b)))))))
(assert (<= 1 kb))
(assert (<= kb ib2))
