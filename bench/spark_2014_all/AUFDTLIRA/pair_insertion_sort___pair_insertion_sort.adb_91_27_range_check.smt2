...
(assert (= (sorted (mk___t o44 (mk (to_rep a__first) (to_rep a__last))) 0 (- j8 1)) true))
(assert (= (sorted (mk___t o44 (mk (to_rep a__first) (to_rep a__last))) (+ j8 1) (+ i1 1)) true))
(assert (=> (< 0 j8) (<= (to_rep (select o44 (- j8 1))) (to_rep (select o44 (+ j8 1))))))
(assert (< y2 (to_rep (select o44 (+ j8 1)))))
(assert (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t o44 (mk (to_rep a__first) (to_rep a__last)))) true))
(assert (= (to_rep (select o44 j8)) y2))
...
(assert (=> (<= 0 j9) (= o36 j9)))
(assert (=> (<= 0 j9) (= o37 (select o44 o36))))
