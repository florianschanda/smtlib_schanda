...
(assert (= (let ((subject state)) state21) 1))
(assert (= (let ((subject c)) c8) 124))
(assert (not (= (to_rep4 (rec__file_io__read_result__status current_read__split_discrs8)) 0)))
(check-sat)
(exit)
