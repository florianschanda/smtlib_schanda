...
(assert (not (= (bool_eq b (to_rep (first2 (mk1 (to_rep b__first) r8b1))) (to_rep (last2 (mk1 (to_rep b__first) r8b1))) a1 (to_rep (first4 (mk2 (to_rep a__first) r11b1))) (to_rep (last4 (mk2 (to_rep a__first) r11b1)))) true)))
(check-sat)
(exit)
