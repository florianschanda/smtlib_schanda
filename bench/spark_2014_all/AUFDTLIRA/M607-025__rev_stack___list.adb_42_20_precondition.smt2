...
(assert (and (= o20 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range5 o20) (<= o20 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
...
(assert (and (= o4 j) (in_range7 j)))
(assert (not (<= o4 (last4 (model__ (mk___rep1 res__split_discrs res__split_fields2))))))
(check-sat)
(exit)
