...
(assert (<= i 100))
(assert (not (= i x1)))
(assert (or (= (parent (rec__red_black_trees__rbt__struct t__split_fields6) i) 0) (= (to_rep3 (select (rec__red_black_trees__rbt__color t__split_fields6) (parent (rec__red_black_trees__rbt__struct t__split_fields6) i))) 1)))
(assert (not (= (to_rep3 (select (rec__red_black_trees__rbt__color t__split_fields6) i)) 0)))
(check-sat)
(exit)
