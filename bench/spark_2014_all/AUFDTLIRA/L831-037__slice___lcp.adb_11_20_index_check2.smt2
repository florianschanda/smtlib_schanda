...
(assert (= result2 (ite (<= o4 (to_rep (last (rt a)))) true false)))
(assert (=> (= result2 true) (and (= o3 (+ y l1)) (in_range1 (+ y l1)))))
(assert (=> (= result2 true) (= result1 (ite (<= o3 (to_rep (last (rt a)))) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (= result1 true))
(assert (and (= temp___200 (+ y l1)) (in_range1 (+ y l1))))
(assert (and (<= (to_rep (first (rt a))) temp___200) (<= temp___200 (to_rep (last (rt a))))))
(assert (= o temp___200))
(assert (= o1 (select (elts a) o)))
(assert (= o2 (to_rep o1)))
(assert (and (= temp___199 (+ x l1)) (in_range1 (+ x l1))))
(assert (not (<= (to_rep (first (rt a))) temp___199)))
(check-sat)
(exit)
