...
(assert (forall ((x index_type)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x element_type)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_171 Int) (temp___is_init_167 Bool) (temp___skip_constant_168 Bool) (temp___do_toplevel_169 Bool) (temp___do_typ_inv_170 Bool)) Bool (=> (or (= temp___is_init_167 true) (<= 0 3)) (in_range4 temp___expr_171)))
(define-fun dynamic_invariant2 ((temp___expr_190 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool) (temp___do_typ_inv_189 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 128)) (in_range2 temp___expr_190)))
(declare-fun back (tuple0) Int)
(declare-fun back__function_guard (Int tuple0) Bool)
(declare-sort iterator 0)
(declare-fun iteratorqtint (iterator) Int)
(assert (forall ((i iterator)) (and (<= 0 (iteratorqtint i)) (<= (iteratorqtint i) 128))))
(define-fun in_range5 ((x Int)) Bool (and (<= 0 x) (<= x 128)))
(declare-fun attr__ATTRIBUTE_IMAGE5 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check5 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE5 (us_image) Int)
(declare-fun user_eq5 (iterator iterator) Bool)
(declare-const dummy5 iterator)
(declare-datatypes () ((iterator__ref (mk_iterator__ref (iterator__content iterator)))))
(define-fun iterator__ref___projection ((a iterator__ref)) iterator (iterator__content a))
(define-fun dynamic_invariant3 ((temp___expr_178 Int) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool) (temp___do_typ_inv_177 Bool)) Bool (=> (or (= temp___is_init_174 true) (<= 0 128)) (in_range5 temp___expr_178)))
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant3 (back us_void_param) true false true true) :pattern ((back us_void_param)))))
...
(define-fun dynamic_invariant4 ((temp___expr_164 Int) (temp___is_init_160 Bool) (temp___skip_constant_161 Bool) (temp___do_toplevel_162 Bool) (temp___do_typ_inv_163 Bool)) Bool (=> (or (= temp___is_init_160 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_164)))
...
(assert (in_range2 free))
(assert (= result current))
(assert (= current1 lower))
(assert (in_range1 current1))
(assert (=> (<= 0 3) (in_range4 status)))
(assert (<= current1 upper))
(assert (and (and (and (and (in_range2 free1) (=> (<= (- 2147483648) 2147483647) (in_range1 current2))) (=> (<= 0 3) (in_range4 status1))) (in_range2 count1)) (<= current2 upper)))
(assert (and (= o (back Tuple0)) (in_range5 o)))
(assert (and (and (in_range4 status2) (in_range2 free2)) (in_range2 count2)))
