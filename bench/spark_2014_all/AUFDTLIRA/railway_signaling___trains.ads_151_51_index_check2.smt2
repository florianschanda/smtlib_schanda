...
(define-fun o12 () us_rep (mk___rep (mk___split_fields o7 o8 o9)))
(define-fun o13 () us_rep (mk___rep (mk___split_fields o1 o2 o3)))
...
(assert (= o train))
(assert (= o13 (select trains o)))
(assert (and (= o4 (get_previous_track o13 id)) (and (in_range5 o4) (= o4 (to_rep4 (select (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 o3)))))) id))))))
(assert (= o5 (ite (= o4 0) true false)))
(assert (= result1 (ite (not (= o5 true)) true false)))
(assert (=> (= result1 true) (and (<= 1 train) (<= train 10))))
(assert (=> (= result1 true) (= o6 train)))
(assert (=> (= result1 true) (= o12 (select trains o6))))
(assert (=> (= result1 true) (and (= temp___370 (get_previous_track o12 id)) (and (in_range5 temp___370) (= temp___370 (to_rep4 (select (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 o9)))))) id)))))))
(assert (=> (= result1 true) (and (<= 1 temp___370) (<= temp___370 8))))
(assert (=> (= result1 true) (= o10 temp___370)))
(assert (=> (= result1 true) (= o11 (select track_signals o10))))
(assert (=> (= result1 true) (= temp___371 (to_rep5 o11))))
