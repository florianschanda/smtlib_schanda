...
(assert (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f v) j22))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f v) k)))) 1)) 0))
