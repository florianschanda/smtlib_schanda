...
(define-fun dynamic_invariant ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= (- 1) 2147483647)) (in_range1 temp___expr_173)))
(define-fun dynamic_invariant1 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 10)) (in_range temp___expr_159)))
...
(assert (= natural_set__members__result1 (to_rep (rec__natural_set__t__len (us_split_fields1 s)))))
(assert (= (mk_int__ref natural_set__members__result4) (mk_int__ref natural_set__members__result2)))
(assert (= natural_set__members__result5 natural_set__members__result3))
(assert (= result1 natural_set__members__result4))
(assert (not (<= 0 natural_set__members__result4)))
(check-sat)
(exit)
