...
(assert (and (= result (invariant__ a)) (= (= result true) (and (= (to_rep (first (rt a))) 1) (<= 0 (to_rep (last (rt a))))))))
(assert (= result true))
(assert (and (= result1 (invariant__ b)) (= (= result1 true) (and (= (to_rep (first (rt b))) 1) (<= 0 (to_rep (last (rt b))))))))
(assert (= result1 true))
(assert (and (= result2 (invariant__ c)) (= (= result2 true) (and (= (to_rep (first (rt c))) 1) (<= 0 (to_rep (last (rt c))))))))
(assert (= result2 true))
