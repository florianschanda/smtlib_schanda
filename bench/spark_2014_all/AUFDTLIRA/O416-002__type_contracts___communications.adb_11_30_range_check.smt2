...
(define-fun dynamic_property2 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range low) (and (in_range high) (=> (<= low high) (and (in_range low) (in_range high))))))
...
(define-fun bool_eq5 ((x us_t1) (y us_t1)) Bool (bool_eq2 (elts1 x) (to_rep1 (first2 (rt1 x))) (to_rep1 (last2 (rt1 x))) (elts1 y) (to_rep1 (first2 (rt1 y))) (to_rep1 (last2 (rt1 y)))))
(declare-fun user_eq9 (us_t1 us_t1) Bool)
(declare-const dummy9 us_t1)
(declare-datatypes () ((message_arr__ref (mk_message_arr__ref (message_arr__content us_t1)))))
(define-fun message_arr__ref___projection ((a message_arr__ref)) us_t1 (message_arr__content a))
(define-fun dynamic_invariant1 ((temp___expr_203 us_t1) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool) (temp___do_typ_inv_202 Bool)) Bool (and (=> (not (= temp___skip_constant_200 true)) (dynamic_property2 (- 2147483648) 2147483647 (first3 temp___expr_203) (last3 temp___expr_203))) (forall ((temp___204 Int)) (=> (and (<= (first3 temp___expr_203) temp___204) (<= temp___204 (last3 temp___expr_203))) (=> (= temp___is_init_199 true) (let ((temp___205 (select (to_array1 temp___expr_203) temp___204))) (<= (let ((temp___207 (rec__messages__message__received (us_split_fields1 temp___205)))) (let ((temp___206 (rec__messages__message__sent (us_split_fields1 temp___205)))) (compare temp___206 1 10 temp___207 1 10))) 0)))))))
...
(define-fun to_base ((a1 us_rep2)) us_rep1 (mk___rep1 (us_split_discrs2 a1) (mk___split_fields1 (let ((temp___158 (rec__communications__communication__msgs1 (us_split_fields5 a1)))) (of_array (to_array2 temp___158) (first5 temp___158) (last5 temp___158))))))
(define-fun of_base ((r us_rep1)) us_rep2 (mk___rep2 (us_split_discrs1 r) (mk___split_fields2 (let ((temp___157 (rec__communications__communication__msgs (us_split_fields3 r)))) (of_array2 (to_array temp___157) (first1 temp___157) (last1 temp___157))))))
(define-fun bool_eq7 ((a1 us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__communications__communication__num (us_split_discrs2 a1))) (to_rep (rec__communications__communication__num (us_split_discrs2 b)))) (= (bool_eq6 (rec__communications__communication__msgs1 (us_split_fields5 a1)) (rec__communications__communication__msgs1 (us_split_fields5 b))) true)) true false))
(define-fun in_range4 ((rec__communications__communication__num1 Int) (a1 us_rep1)) Bool (= rec__communications__communication__num1 (to_rep (rec__communications__communication__num (us_split_discrs1 a1)))))
...
(define-fun dynamic_invariant3 ((temp___expr_296 us_rep2) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool (and (=> (not (= temp___skip_constant_293 true)) (in_range4 (length1 a) (to_base temp___expr_296))) (and (and (dynamic_property4 1 (length1 a) (first5 (rec__communications__communication__msgs1 (us_split_fields5 temp___expr_296))) (last5 (rec__communications__communication__msgs1 (us_split_fields5 temp___expr_296)))) (and (= (first5 (rec__communications__communication__msgs1 (us_split_fields5 temp___expr_296))) 1) (= (last5 (rec__communications__communication__msgs1 (us_split_fields5 temp___expr_296))) (length1 a)))) (forall ((temp___298 Int)) (=> (and (<= (first5 (rec__communications__communication__msgs1 (us_split_fields5 temp___expr_296))) temp___298) (<= temp___298 (last5 (rec__communications__communication__msgs1 (us_split_fields5 temp___expr_296))))) (=> (= temp___is_init_292 true) (let ((temp___299 (select (to_array2 (rec__communications__communication__msgs1 (us_split_fields5 temp___expr_296))) temp___298))) (<= (let ((temp___301 (rec__messages__message__received (us_split_fields1 temp___299)))) (let ((temp___300 (rec__messages__message__sent (us_split_fields1 temp___299)))) (compare temp___300 1 10 temp___301 1 10))) 0))))))))
(define-fun default_initial_assumption ((temp___expr_304 us_rep2) (temp___skip_top_level_305 Bool)) Bool (= (to_rep (rec__communications__communication__num (us_split_discrs2 temp___expr_304))) (length1 a)))
...
(assert (and (= o (length1 a)) (in_range (length1 a))))
