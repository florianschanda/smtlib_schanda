...
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 (first1 (rt a))) i1) (<= i1 (- from2 1))) (not (= (to_rep (select (elts a) i1)) c)))))
...
(assert (= result1 (ite (<= (to_rep1 (first1 (rt a))) i) o2 false)))
(assert (= result1 true))
(assert (not (<= i (to_rep1 (last1 (rt a))))))
(check-sat)
(exit)
