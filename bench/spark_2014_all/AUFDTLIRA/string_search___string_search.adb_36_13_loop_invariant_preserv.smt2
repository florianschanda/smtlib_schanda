...
(assert (=> (<= i1 temp___309) (and (and (<= (to_rep1 (first (rt haystack))) i1) (<= i1 (to_rep1 (last (rt haystack))))) (and (<= (to_rep1 (first (rt haystack))) temp___309) (<= temp___309 (to_rep1 (last (rt haystack))))))))
(assert (= o7 (elts haystack)))
(assert (= o7 temp___310))
(assert (= (mk1 i1 temp___309) temp___3101))
(assert (= result1 (bool_eq (elts needle) (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle))) temp___310 (to_rep1 (first2 temp___3101)) (to_rep1 (last2 temp___3101)))))
(assert (not (= result1 true)))
(assert (= string_search__brute_force_slice__result2 string_search__brute_force_slice__result))
(assert (= string_search__brute_force_slice__result2 string_search__brute_force_slice__result1))
...
(assert (not (= i2 temp___308)))
(assert (= i2 result2))
(assert (= i3 (+ i2 1)))
(assert (and (= o8 (- (to_rep1 (last (rt needle))) 1)) (in_range1 (- (to_rep1 (last (rt needle))) 1))))
(assert (= o9 (+ i3 o8)))
(assert (and (= temp___3091 o9) (in_range1 o9)))
(assert (=> (<= i3 temp___3091) (and (and (<= (to_rep1 (first (rt haystack))) i3) (<= i3 (to_rep1 (last (rt haystack))))) (and (<= (to_rep1 (first (rt haystack))) temp___3091) (<= temp___3091 (to_rep1 (last (rt haystack))))))))
(assert (= o10 (elts haystack)))
(assert (= o10 temp___3102))
(assert (= (mk1 i3 temp___3091) temp___3103))
(assert (= result3 (bool_eq (elts needle) (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle))) temp___3102 (to_rep1 (first2 temp___3103)) (to_rep1 (last2 temp___3103)))))
(assert (not (= result3 true)))
(assert (= string_search__brute_force_slice__result4 string_search__brute_force_slice__result3))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k i3))
