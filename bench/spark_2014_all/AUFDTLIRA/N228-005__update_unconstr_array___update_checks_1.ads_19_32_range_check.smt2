...
(declare-fun temp_____aggregate_def_294 (us_t Int Int) us_t)
(declare-fun temp_____aggregate_def_484 (us_t Int Int) us_t)
...
(assert (= o i))
(assert (= temp___4902 (temp_____aggregate_def_484 (mk___t a (mk (to_rep a__first) (to_rep a__last))) o new_val)))
