...
(declare-fun temp_____aggregate_def_308 (Int Int Int) us_t1)
...
(assert (forall ((temp___310 Int) (temp___311 Int) (temp___312 Int)) (let ((temp___309 (temp_____aggregate_def_308 temp___310 temp___311 temp___312))) (=> (dynamic_invariant4 temp___310 true true true true) (and (=> (dynamic_property 1 2147483647 temp___311 temp___312) (and (= (first3 temp___309) temp___311) (= (last3 temp___309) temp___312))) (forall ((temp___313 Int)) (= (to_rep (select (to_array1 temp___309) temp___313)) temp___310)))))))
...
(declare-const temp___315 (Array Int character))
(declare-const temp___3151 t1)
(declare-const temp___316 (Array Int character))
(declare-const temp___3161 t)
(declare-const temp___317 (Array Int character))
(declare-const temp___3171 t)
(declare-const o5 (Array Int character))
(declare-const fixed_stream__trim_string__R5b__assume Int)
(declare-const fixed_stream__trim_string__R8b__assume Int)
(declare-const o6 (Array Int character))
(declare-const temp___319 (Array Int character))
(declare-const temp___3191 t3)
(declare-const temp___320 (Array Int character))
(declare-const temp___3201 t2)
(declare-const o7 (Array Int character))
(declare-const temp___322 (Array Int character))
(declare-const temp___3221 t2)
(declare-const temp___323 (Array Int character))
(declare-const temp___3231 t2)
...
(declare-const change2 (Array Int character))
(declare-const change3 (Array Int character))
(declare-const len2 Int)
(declare-const change4 (Array Int character))
(declare-const len3 Int)
(declare-const result3 Bool)
(declare-const result4 Bool)
(assert (dynamic_property 1 2147483647 (to_rep1 change__first) (to_rep1 change__last)))
(assert (dynamic_invariant2 new_val true false true true))
(assert (and (= o1 (length new_val)) (in_range1 (length new_val))))
(assert (=> (<= (to_rep1 change__first) (to_rep1 change__last)) (= o (+ (- (to_rep1 change__last) (to_rep1 change__first)) 1))))
(assert (=> (not (<= (to_rep1 change__first) (to_rep1 change__last))) (= o 0)))
...
(assert (= (to_rep1 (first2 (rt1 (temp_____aggregate_def_308 0 (to_rep1 change__first) (to_rep1 change__last))))) (to_rep1 change__first)))
(assert (= (to_rep1 (last2 (rt1 (temp_____aggregate_def_308 0 (to_rep1 change__first) (to_rep1 change__last))))) (to_rep1 change__last)))
(assert (= (mk___t1 temp___315 temp___3151) (temp_____aggregate_def_308 0 (to_rep1 change__first) (to_rep1 change__last))))
(assert (= temp___315 temp___316))
(assert (= (mk (to_rep1 (first2 temp___3151)) (to_rep1 (last2 temp___3151))) temp___3161))
(assert (= (ite (<= (to_rep1 (first temp___3161)) (to_rep1 (last temp___3161))) (+ (- (to_rep1 (last temp___3161)) (to_rep1 (first temp___3161))) 1) 0) (ite (<= (to_rep1 change__first) (to_rep1 change__last)) (+ (- (to_rep1 change__last) (to_rep1 change__first)) 1) 0)))
(assert (= (mk___t temp___317 temp___3171) (mk___t temp___316 temp___3161)))
(assert (= o5 (slide temp___317 (to_rep1 (first temp___3171)) (to_rep1 change__first))))
(assert (= (mk_map__ref result1) (mk_map__ref change)))
(assert (= change1 o5))
(assert (and (= fixed_stream__trim_string__R5b__assume (+ (to_rep1 change__first) (- len1 1))) (in_range1 (+ (to_rep1 change__first) (- len1 1)))))
(assert (= fixed_stream__trim_string__R5b__assume r5b))
(assert (in_range1 r5b))
(assert (and (= fixed_stream__trim_string__R8b__assume (+ (to_rep1 (first (rt new_val))) (- len1 1))) (in_range1 (+ (to_rep1 (first (rt new_val))) (- len1 1)))))
(assert (= fixed_stream__trim_string__R8b__assume r8b))
(assert (in_range1 r8b))
(assert (=> (<= (to_rep1 (first (rt new_val))) r8b) (and (and (<= (to_rep1 (first (rt new_val))) (to_rep1 (first (rt new_val)))) (<= (to_rep1 (first (rt new_val))) (to_rep1 (last (rt new_val))))) (and (<= (to_rep1 (first (rt new_val))) r8b) (<= r8b (to_rep1 (last (rt new_val))))))))
(assert (= o6 (elts new_val)))
(assert (= o6 temp___319))
(assert (= (mk3 (to_rep1 (first (rt new_val))) r8b) temp___3191))
(assert (= (ite (<= (to_rep1 (first6 temp___3191)) (to_rep1 (last6 temp___3191))) (+ (- (to_rep1 (last6 temp___3191)) (to_rep1 (first6 temp___3191))) 1) 0) (ite (<= (to_rep1 change__first) r5b) (+ (- r5b (to_rep1 change__first)) 1) 0)))
(assert (= (slide temp___319 (to_rep1 (first6 temp___3191)) (to_rep1 change__first)) temp___320))
(assert (= (mk2 (to_rep1 change__first) r5b) temp___3201))
(assert (=> (<= (to_rep1 change__first) r5b) (and (and (<= (to_rep1 change__first) (to_rep1 change__first)) (<= (to_rep1 change__first) (to_rep1 change__last))) (and (<= (to_rep1 change__first) r5b) (<= r5b (to_rep1 change__last))))))
(assert (= o7 change1))
(assert (= o7 temp___322))
(assert (= (mk2 (to_rep1 change__first) r5b) temp___3221))
(assert (= (ite (<= (to_rep1 (first4 temp___3201)) (to_rep1 (last4 temp___3201))) (+ (- (to_rep1 (last4 temp___3201)) (to_rep1 (first4 temp___3201))) 1) 0) (ite (<= (to_rep1 (first4 temp___3221)) (to_rep1 (last4 temp___3221))) (+ (- (to_rep1 (last4 temp___3221)) (to_rep1 (first4 temp___3221))) 1) 0)))
(assert (= (mk___t2 temp___323 temp___3231) (mk___t2 temp___320 temp___3201)))
(assert (forall ((temp___324 Int)) (ite (and (<= (to_rep1 change__first) temp___324) (<= temp___324 r5b)) (= (select o8 temp___324) (select temp___323 temp___324)) (= (select o8 temp___324) (select change1 temp___324)))))
...
(assert (= o19 i))
(assert (= o20 (select change3 o19)))
(assert (= o21 (to_rep o20)))
(assert (= o22 (ite (= o21 0) true false)))
(assert (=> (< (to_rep1 (first (rt new_val))) 0) (= result4 true)))
(assert (=> (not (< (to_rep1 (first (rt new_val))) 0)) (and (= o17 (- 2147483647 (to_rep1 (first (rt new_val))))) (in_range1 (- 2147483647 (to_rep1 (first (rt new_val))))))))
(assert (=> (not (< (to_rep1 (first (rt new_val))) 0)) (and (= o18 (- i (to_rep1 change__first))) (in_range1 (- i (to_rep1 change__first))))))
(assert (=> (not (< (to_rep1 (first (rt new_val))) 0)) (= result4 (ite (<= o18 o17) true false))))
(assert (=> (= result4 true) (and (= o14 (- i (to_rep1 change__first))) (in_range1 (- i (to_rep1 change__first))))))
(assert (=> (= result4 true) (= o15 (+ o14 (to_rep1 (first (rt new_val)))))))
(assert (=> (= result4 true) (and (= o16 o15) (in_range1 o15))))
(assert (=> (= result4 true) (= result3 (ite (<= o16 (to_rep1 (last (rt new_val)))) true false))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (= result3 true))
(assert (and (= o9 (- i (to_rep1 change__first))) (in_range1 (- i (to_rep1 change__first)))))
(assert (= o10 (+ o9 (to_rep1 (first (rt new_val))))))
(assert (and (= temp___325 o10) (in_range1 o10)))
(assert (and (<= (to_rep1 (first (rt new_val))) temp___325) (<= temp___325 (to_rep1 (last (rt new_val))))))
(assert (= o11 temp___325))
(assert (= o12 (select (elts new_val) o11)))
(assert (= o13 (to_rep o12)))
(assert (not (<= (to_rep1 change__first) i)))
(check-sat)
(exit)
