...
(declare-datatypes () ((t73s__ref (mk_t73s__ref (t73s__content us_t1)))))
(define-fun t73s__ref___projection ((a t73s__ref)) us_t1 (t73s__content a))
...
(define-fun dynamic_property3 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range low) (and (in_range high) (=> (<= low high) (and (in_range5 low) (in_range5 high))))))
...
(assert (forall ((s us_rep1)) (! (= (peek__3 s) (peek__31 us_tag1 s)) :pattern ((peek__31 us_tag1 s)))))
(assert (forall ((s us_rep1)) (! (= (peek__3 s) (to_rep1 (let ((temp___439 (rec__stacks__stack_root__content1 (us_split_fields3 s)))) (select temp___439 (last2 s))))) :pattern ((peek__3 s)))))
...
(assert (and (= temp___598 (last2 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag))) (and (in_range3 temp___598) (= temp___598 (ite (not (= (wraps_around (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)) true)) (- (+ (to_rep3 s__split_fields) (to_rep2 s__split_fields2)) 1) (- (- (+ (to_rep3 s__split_fields) (to_rep2 s__split_fields2)) 1) 100))))))
(assert (and (<= 1 temp___598) (<= temp___598 100)))
(assert (= o temp___598))
(assert (= o1 (select s__split_fields1 o)))
(assert (= o2 (to_rep1 o1)))
(assert (= (mk_int__ref result) (mk_int__ref e)))
(assert (= e1 o2))
(assert (and (= o3 (- (to_rep2 s__split_fields2) 1)) (in_range3 (- (to_rep2 s__split_fields2) 1))))
(assert (= (to_rep2 o4) o3))
(assert (= s__split_fields o5))
(assert (= s__split_fields1 o6))
(assert (= o4 o7))
(assert (= s__split_fields3 o8))
(assert (= temp___600 o5))
(assert (= temp___6001 o6))
(assert (= temp___6002 o7))
(assert (= temp___6003 o8))
...
(assert (not (= e2 (peek__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))))
(check-sat)
(exit)
