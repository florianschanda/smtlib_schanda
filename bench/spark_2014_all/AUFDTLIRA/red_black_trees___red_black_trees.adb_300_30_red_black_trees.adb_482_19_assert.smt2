...
(assert (= n5 1))
(assert (=> (and (<= 1 n5) (<= n5 100)) (= temp___693 n5)))
(assert (=> (and (<= 1 n5) (<= n5 100)) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c100b) i)))) n6)) (not (= i y2))) (= (eq (select (nb_blacks c101b) i) (select (nb_blacks c100b) i)) true))))))
