...
(declare-const temp___3271 (Array Int element))
(declare-const temp___3272 t)
(declare-const temp___3273 natural)
(declare-const temp___3274 us_private)
(declare-const temp___3275 Int)
...
(assert (<= (to_rep temp___3263) (to_rep1 temp___326)))
(assert (= (mk___rep (mk___split_discrs temp___327) (mk___split_fields (mk___t temp___3271 temp___3272) temp___3273 temp___3274) temp___3275) (mk___rep (mk___split_discrs temp___326) (mk___split_fields (mk___t temp___3261 temp___3262) temp___3263 temp___3264) temp___3265)))
...
(assert (= temp___3271 this__split_fields4))
(assert (= temp___3272 this__split_fields5))
(assert (= temp___3273 this__split_fields6))
(assert (= temp___3274 this__split_fields7))
(assert (= this__split_discrs (mk___split_discrs temp___327)))
...
(assert (= item3 item1))
(assert (= this__split_fields12 (mk___split_fields (mk___t this__split_fields4 this__split_fields5) this__split_fields6 this__split_fields7)))
(assert (not (= (extent (mk___rep this__split_discrs (mk___split_fields (mk___t this__split_fields8 this__split_fields9) this__split_fields10 this__split_fields11) this__attr__tag)) (- (extent (mk___rep this__split_discrs (mk___split_fields (mk___t this__split_fields this__split_fields1) this__split_fields2 this__split_fields3) this__attr__tag)) 1))))
(check-sat)
(exit)
