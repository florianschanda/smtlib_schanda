...
(assert (and (and (and (= (+ (length avail3) (length alloc3)) r2) (forall ((e2 Int)) (=> (and (in_range1 e2) (= (contains avail3 e2) true)) (and (<= 1 e2) (<= e2 r2))))) (forall ((e2 Int)) (=> (and (in_range1 e2) (= (contains alloc3 e2) true)) (and (<= 1 e2) (<= e2 r2))))) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (ite (= (to_rep (select data rr1)) 0) (and (= (contains avail3 rr1) true) (not (= (contains alloc3 rr1) true))) (and (not (= (contains avail3 rr1) true)) (= (contains alloc3 rr1) true)))))))
(assert (and (=> (<= 1 10000) (in_range4 r2)) (and (<= 1 r2) (<= r2 10000))))
(assert (and (= o11 (length alloc3)) (in_range2 o11)))
(assert (and (= o12 (length avail3)) (in_range2 o12)))
(assert (= o13 (+ o12 o11)))
(assert (and (= o14 o13) (in_range5 o13)))
(assert (= result5 (ite (= o14 r2) true false)))
(assert (=> (= result5 true) (and (= o9 (contains avail3 e1)) (=> (= (distinct 1 0) true) (=> (exists ((e2 Int)) (and (and (in_range1 e2) (= (contains avail3 e2) true)) (= e2 e1))) (= o9 true))))))
(assert (=> (= result5 true) (= (= o10 true) (in_range1 e1))))
(assert (=> (= result5 true) (= result6 (ite (= o10 true) o9 false))))
(assert (=> (= result5 true) (= (= result4 true) (forall ((e2 Int)) (=> (and (in_range1 e2) (= (contains avail3 e2) true)) (and (<= 1 e2) (<= e2 r2)))))))
(assert (=> (not (= result5 true)) (= result4 false)))
(assert (=> (= result4 true) (and (= o7 (contains alloc3 e)) (=> (= (distinct 1 0) true) (=> (exists ((e2 Int)) (and (and (in_range1 e2) (= (contains alloc3 e2) true)) (= e2 e))) (= o7 true))))))
(assert (=> (= result4 true) (= (= o8 true) (in_range1 e))))
(assert (=> (= result4 true) (= result7 (ite (= o8 true) o7 false))))
(assert (=> (= result4 true) (= (= result3 true) (forall ((e2 Int)) (=> (and (in_range1 e2) (= (contains alloc3 e2) true)) (and (<= 1 e2) (<= e2 r2)))))))
...
(assert (and (= o6 (contains alloc3 o5)) (=> (= (distinct 1 0) true) (=> (exists ((e2 Int)) (and (and (in_range1 e2) (= (contains alloc3 e2) true)) (= e2 o5))) (= o6 true)))))
