...
(assert (not (= (let ((temp___289 (to__ (mk___rep (mk___split_fields s__split_fields4 s__split_fields5))))) (bool_eq (elts temp___289) (to_rep (first (rt temp___289))) (to_rep (last (rt temp___289))) (elts (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))) (to_rep (first4 (mk2 1 (- (to_rep (last (rt (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))))) 1)))) (to_rep (last4 (mk2 1 (- (to_rep (last (rt (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))))) 1)))))) true)))
(check-sat)
(exit)
