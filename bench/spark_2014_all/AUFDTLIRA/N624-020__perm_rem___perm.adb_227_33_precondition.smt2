...
(define-fun o28 () us_t (mk___t o22 o23))
(define-fun o29 () us_t (mk___t o20 o21))
...
(assert (and (= o24 (- (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)) (in_range3 (- (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))
(assert (and (= o28 (remove b ib1)) (and (dynamic_invariant o28 true false true true) (and (= (invariant__ o28) true) (and (= (to_rep1 (last o23)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts b) k)) (to_rep (select o22 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o22 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o22 k))))))))))))
(assert (and (= o27 (remove o28 o24)) (and (dynamic_invariant o27 true false true true) (and (= (invariant__ o27) true) (and (= (to_rep1 (last o26)) (- (to_rep1 (last o23)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o24 1))) (= (to_rep (select o22 k)) (to_rep (select o25 k))))) (and (forall ((k Int)) (=> (and (<= (+ o24 1) k) (<= k (to_rep1 (last o23)))) (= (to_rep (select o22 k)) (to_rep (select o25 (- k 1)))))) (forall ((k Int)) (=> (and (<= o24 k) (<= k (- (to_rep1 (last o23)) 1))) (= (to_rep (select o22 (+ k 1))) (to_rep (select o25 k))))))))))))
(assert (and (= o29 (remove bb ib1)) (and (dynamic_invariant o29 true false true true) (and (= (invariant__ o29) true) (and (= (to_rep1 (last o21)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o20 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o20 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o20 k))))))))))))
(assert (and (= o19 (- (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1)) (in_range3 (- (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))))
(assert (and (= o18 ia1) (in_range3 ia1)))
(assert (not (<= (to_rep1 (first (rt a))) o18)))
(check-sat)
(exit)
