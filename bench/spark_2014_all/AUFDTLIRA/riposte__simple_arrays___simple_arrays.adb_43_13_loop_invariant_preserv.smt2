...
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 i2)) (forall ((temp___322 Int)) (=> (and (<= (- 2147483648) temp___322) (<= temp___322 2147483647)) (=> (or (< 2147483647 temp___322) (or (< temp___322 (- 2147483648)) (< i2 temp___322))) (= (select a2 temp___322) (select a temp___322)))))) (and (<= (- 2147483648) i2) (<= i2 2147483647))))
...
(assert (<= (- 2147483648) j))
(assert (<= j i3))
(assert (not (= (to_rep (select a3 j)) (to_rep (select b j)))))
(check-sat)
(exit)
