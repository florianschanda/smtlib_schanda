...
(declare-const tmp__first integer)
(declare-const tmp__last integer)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const a us_t)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-fun temp___String_Literal_282 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_282 us_void_param) 1)) 102) (= (to_rep (select (temp___String_Literal_282 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_282 us_void_param) 3)) 111)) :pattern ((temp___String_Literal_282 us_void_param)))))
...
(assert (=> (<= 1 3) (= o (+ (- 3 1) 1))))
(assert (=> (not (<= 1 3)) (= o 0)))
(assert (=> (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (= o1 (+ (- (to_rep1 (last (rt a))) (to_rep1 (first (rt a)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first (rt a))) o2)))
(assert (= o4 (- o3 1)))
