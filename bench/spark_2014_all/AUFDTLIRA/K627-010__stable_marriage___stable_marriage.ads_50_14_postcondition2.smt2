...
(declare-const stable_marriage__invert_1__result (Array Int ranking))
(declare-const temp___489 Int)
(declare-const temp___487 (Array Int ranking))
...
(declare-const stable_marriage__invert_1__result1 (Array Int ranking))
(declare-const stable_marriage__invert_1__result2 (Array Int ranking))
(declare-const stable_marriage__invert_1__result3 (Array Int ranking))
(declare-const result__8 (Array Int ranking))
(declare-const rank7 Int)
(declare-const stable_marriage__invert_1__result4 (Array Int ranking))
(declare-const result__9 (Array Int ranking))
(declare-const rank8 Int)
(declare-const stable_marriage__invert_1__result5 (Array Int ranking))
...
(assert (= rank1 1))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= temp___489 rank1)))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= temp___487 result__1)))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (forall ((prev Int)) (=> (and (<= 1 prev) (<= prev (- rank2 1))) (= (to_rep1 (select result__2 (to_rep (select r1 prev)))) prev)))))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (=> (exists ((prev Int)) (and (and (<= 1 prev) (<= prev (- rank2 1))) (= (to_rep (select r1 prev)) g1))) (= (to_rep (select r1 (to_rep1 (select result__2 g1)))) g1))))))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (and (=> (<= 1 64) (in_range2 rank2)) (and (<= 1 rank2) (<= rank2 64)))))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= (to_rep1 o) rank2)))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= o1 (store result__2 (to_rep (select r1 rank2)) o))))
...
(assert (= stable_marriage__invert_1__result1 stable_marriage__invert_1__result2))
(assert (= stable_marriage__invert_1__result3 stable_marriage__invert_1__result1))
(assert (= result3 stable_marriage__invert_1__result))
(assert (= stable_marriage__invert_1__result1 result__6))
(assert (= (mk_map__ref1 stable_marriage__invert_1__result4) (mk_map__ref1 stable_marriage__invert_1__result2)))
(assert (= (mk_int__ref rank7) rank9))
(assert (= (mk_map__ref1 result__8) result__10))
(assert (= stable_marriage__invert_1__result5 stable_marriage__invert_1__result3))
(assert (= rank8 rank6))
...
(assert (<= 1 rank10))
(assert (<= rank10 64))
(assert (not (= (to_rep1 (select stable_marriage__invert_1__result4 (to_rep (select r1 rank10)))) rank10)))
(check-sat)
(exit)
