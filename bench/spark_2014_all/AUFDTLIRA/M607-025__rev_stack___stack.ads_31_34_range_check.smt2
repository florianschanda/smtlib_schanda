...
(declare-fun temp_____aggregate_def_217 (Int) (Array Int integer))
...
(assert (forall ((temp___219 Int)) (=> (dynamic_invariant temp___219 true true true true) (= (to_rep (select (temp_____aggregate_def_217 temp___219) 1)) temp___219))))
...
(declare-const temp___265 r1)
(declare-const temp___2651 (Array Int integer))
...
(assert (= temp___265 s__split_fields4))
(assert (= temp___2651 s__split_fields5))
...
(assert (not (= (length (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))) 0)))
(assert (=> (<= 1 1) (= o9 (+ (- 1 1) 1))))
(assert (=> (not (<= 1 1)) (= o9 0)))
(assert (=> (<= (to_rep (first (rt (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))))) (to_rep (last (rt (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1))))))) (= o10 (+ (- (to_rep (last (rt (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))))) (to_rep (first (rt (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1))))))) 1))))
(assert (=> (not (<= (to_rep (first (rt (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))))) (to_rep (last (rt (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))))))) (= o10 0)))
(assert (= o11 (+ o10 o9)))
(assert (= o12 (+ (to_rep (first (rt (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))))) o11)))
(assert (= o13 (- o12 1)))
