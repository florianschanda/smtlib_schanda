...
(assert (not (= (rec__private_record__result_ty__found (us_split_discrs1 (result_ty__content record_discr__search_upto_3__result15))) true)))
(assert (<= 1 i))
(assert (<= i (to_rep (rec__record_discr__interm_result__upto (us_split_discrs4 r)))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
