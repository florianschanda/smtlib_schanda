...
(assert (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains s3 v1) true) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 100)) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1)) v1))))))))
(assert (and (=> (<= 1 100) (in_range6 j2)) (and (<= 1 j2) (<= j2 100))))
(assert (<= 0 v))
(assert (<= v 2147483647))
(assert (and (= result4 (contains s3 v)) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range2 e) (= (contains s3 e) true)) (= e v))) (= result4 true)))))
(assert (= result4 true))
(assert (<= 1 i))
(assert (<= i 100))
