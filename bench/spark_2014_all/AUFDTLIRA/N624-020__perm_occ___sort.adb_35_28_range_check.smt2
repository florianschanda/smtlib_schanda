...
(assert (forall ((f Int)) (=> (and (<= 0 f) (<= f e2)) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) f) (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) f)))))
(assert (and (=> (<= 0 2147483647) (in_range1 e2)) (and (<= 0 e2) (<= e2 2147483647))))
(assert (not (= e2 2147483647)))
(assert (= e2 result1))
(assert (= e3 (+ e2 1)))
(assert (and (<= (to_rep1 (first2 (rt1 init))) y) (<= y (to_rep1 (last2 (rt1 init))))))
(assert (= o8 y))
(assert (= o9 (select (elts1 init) o8)))
