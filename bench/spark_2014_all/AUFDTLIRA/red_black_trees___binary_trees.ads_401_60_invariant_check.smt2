...
(assert (<= i 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
(assert (and (= o5 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i)) (and (= (= o5 true) (and (<= i (to_rep f__split_fields4)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields5 i)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) i) (not (= o5 true))))))
(assert (= result11 (ite (= o5 true) (ite (not (= i root2)) true false) false)))
