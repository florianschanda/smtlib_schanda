...
(assert (= o8 (sorted (mk___t a (mk (to_rep a__first) (to_rep a__last))) o7 length2)))
(assert (= o6 (sorted (mk___t a (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
...
(assert (not (in_range1 (+ (to_rep a__last) 1))))
(check-sat)
(exit)
