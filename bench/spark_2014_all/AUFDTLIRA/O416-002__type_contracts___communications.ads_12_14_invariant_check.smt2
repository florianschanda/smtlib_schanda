...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep2 (select (temp___String_Literal_155 us_void_param) 1)) 50) (= (to_rep2 (select (temp___String_Literal_155 us_void_param) 2)) 48)) (= (to_rep2 (select (temp___String_Literal_155 us_void_param) 3)) 49)) (= (to_rep2 (select (temp___String_Literal_155 us_void_param) 4)) 50)) (= (to_rep2 (select (temp___String_Literal_155 us_void_param) 5)) 45)) (= (to_rep2 (select (temp___String_Literal_155 us_void_param) 6)) 48)) (= (to_rep2 (select (temp___String_Literal_155 us_void_param) 7)) 49)) (= (to_rep2 (select (temp___String_Literal_155 us_void_param) 8)) 45)) (= (to_rep2 (select (temp___String_Literal_155 us_void_param) 9)) 48)) (= (to_rep2 (select (temp___String_Literal_155 us_void_param) 10)) 49)) :pattern ((temp___String_Literal_155 us_void_param)))))
(declare-fun temp___String_Literal_156 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep2 (select (temp___String_Literal_156 us_void_param) 1)) 50) (= (to_rep2 (select (temp___String_Literal_156 us_void_param) 2)) 48)) (= (to_rep2 (select (temp___String_Literal_156 us_void_param) 3)) 49)) (= (to_rep2 (select (temp___String_Literal_156 us_void_param) 4)) 50)) (= (to_rep2 (select (temp___String_Literal_156 us_void_param) 5)) 45)) (= (to_rep2 (select (temp___String_Literal_156 us_void_param) 6)) 48)) (= (to_rep2 (select (temp___String_Literal_156 us_void_param) 7)) 49)) (= (to_rep2 (select (temp___String_Literal_156 us_void_param) 8)) 45)) (= (to_rep2 (select (temp___String_Literal_156 us_void_param) 9)) 48)) (= (to_rep2 (select (temp___String_Literal_156 us_void_param) 10)) 49)) :pattern ((temp___String_Literal_156 us_void_param)))))
...
(declare-datatypes () ((tS3bP1__ref (mk_tS3bP1__ref (tS3bP1__content integer)))))
(define-fun tS3bP1__ref___projection ((a tS3bP1__ref)) integer (tS3bP1__content a))
(declare-sort t1 0)
...
(declare-fun temp_____aggregate_def_354 (us_rep Int Int) us_t2)
...
(assert (= null_msg (mk___rep (mk___split_fields (temp___String_Literal_155 Tuple0) (temp___String_Literal_156 Tuple0)))))
(declare-sort t3 0)
...
(define-fun dynamic_property6 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range1 low) (and (in_range1 high) (=> (<= low high) (and (in_range1 low) (in_range1 high))))))
...
(define-fun bool_eq7 ((x us_t3) (y us_t3)) Bool (bool_eq2 (elts3 x) (to_rep1 (first6 (rt3 x))) (to_rep1 (last6 (rt3 x))) (elts3 y) (to_rep1 (first6 (rt3 y))) (to_rep1 (last6 (rt3 y)))))
(declare-fun user_eq13 (us_t3 us_t3) Bool)
(declare-const dummy13 us_t3)
(declare-datatypes () ((message_arr__ref (mk_message_arr__ref (message_arr__content us_t3)))))
(define-fun message_arr__ref___projection ((a message_arr__ref)) us_t3 (message_arr__content a))
(assert (forall ((temp___356 us_rep)) (forall ((temp___357 Int) (temp___358 Int)) (let ((temp___355 (temp_____aggregate_def_354 temp___356 temp___357 temp___358))) (=> (dynamic_invariant1 temp___356 true true true true) (and (=> (dynamic_property6 (- 2147483648) 2147483647 temp___357 temp___358) (and (= (first5 temp___355) temp___357) (= (last5 temp___355) temp___358))) (forall ((temp___359 Int)) (= (select (to_array2 temp___355) temp___359) temp___356))))))))
(define-fun dynamic_invariant5 ((temp___expr_203 us_t3) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool) (temp___do_typ_inv_202 Bool)) Bool (and (=> (not (= temp___skip_constant_200 true)) (dynamic_property6 (- 2147483648) 2147483647 (first7 temp___expr_203) (last7 temp___expr_203))) (forall ((temp___204 Int)) (=> (and (<= (first7 temp___expr_203) temp___204) (<= temp___204 (last7 temp___expr_203))) (=> (= temp___is_init_199 true) (let ((temp___205 (select (to_array3 temp___expr_203) temp___204))) (<= (let ((temp___207 (rec__messages__message__received (us_split_fields1 temp___205)))) (let ((temp___206 (rec__messages__message__sent (us_split_fields1 temp___205)))) (compare temp___206 1 10 temp___207 1 10))) 0)))))))
(define-fun dynamic_invariant6 ((temp___expr_254 us_t1) (temp___is_init_250 Bool) (temp___skip_constant_251 Bool) (temp___do_toplevel_252 Bool) (temp___do_typ_inv_253 Bool)) Bool (and (=> (not (= temp___skip_constant_251 true)) (and (dynamic_property3 1 r4b (first3 temp___expr_254) (last3 temp___expr_254)) (and (= (first3 temp___expr_254) 1) (= (last3 temp___expr_254) r4b)))) (forall ((temp___255 Int)) (=> (and (<= (first3 temp___expr_254) temp___255) (<= temp___255 (last3 temp___expr_254))) (=> (= temp___is_init_250 true) (let ((temp___256 (select (to_array1 temp___expr_254) temp___255))) (<= (let ((temp___258 (rec__messages__message__received (us_split_fields1 temp___256)))) (let ((temp___257 (rec__messages__message__sent (us_split_fields1 temp___256)))) (compare temp___257 1 10 temp___258 1 10))) 0)))))))
...
(declare-const temp___361 (Array Int us_rep))
(declare-const temp___3611 t2)
(declare-const temp___362 (Array Int us_rep))
(declare-const temp___3621 t1)
(declare-const temp___364 (Array Int us_rep))
(declare-const temp___3641 t1)
(declare-const o (Array Int us_rep))
(declare-const o1 t)
(declare-const o2 (Array Int us_rep))
(declare-const o3 t)
(declare-const temp___366 positive)
(declare-const temp___3661 (Array Int us_rep))
(declare-const temp___3662 t)
...
(assert (dynamic_invariant2 (mk___rep1 com__split_discrs (mk___split_fields1 (mk___t com__split_fields com__split_fields1))) true false true true))
(assert (type_invariant (mk___rep1 com__split_discrs (mk___split_fields1 (mk___t com__split_fields com__split_fields1)))))
(assert (<= (compare (temp___String_Literal_155 Tuple0) 1 10 (temp___String_Literal_156 Tuple0) 1 10) 0))
(assert (= (temp___String_Literal_155 Tuple0) communications__mark_duplicates__null_msg__assume))
(assert (= (temp___String_Literal_156 Tuple0) communications__mark_duplicates__null_msg__assume1))
(assert (= (mk___rep (mk___split_fields communications__mark_duplicates__null_msg__assume communications__mark_duplicates__null_msg__assume1)) null_msg))
(assert (let ((temp___174 null_msg)) (<= (compare (rec__messages__message__sent (us_split_fields1 temp___174)) 1 10 (rec__messages__message__received (us_split_fields1 temp___174)) 1 10) 0)))
(assert (= (to_rep (rec__communications__communication__num com__split_discrs)) r4b))
(assert (in_range r4b))
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_354 null_msg 1 r4b)))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_354 null_msg 1 r4b)))) r4b))
(assert (= (mk___t2 temp___361 temp___3611) (temp_____aggregate_def_354 null_msg 1 r4b)))
(assert (= (ite (<= (to_rep1 (first4 temp___3611)) (to_rep1 (last4 temp___3611))) (+ (- (to_rep1 (last4 temp___3611)) (to_rep1 (first4 temp___3611))) 1) 0) (ite (<= 1 r4b) (+ (- r4b 1) 1) 0)))
(assert (= temp___361 temp___362))
(assert (= (mk1 (to_rep1 (first4 temp___3611)) (to_rep1 (last4 temp___3611))) temp___3621))
(assert (= (ite (<= (to_rep1 (first2 temp___3621)) (to_rep1 (last2 temp___3621))) (+ (- (to_rep1 (last2 temp___3621)) (to_rep1 (first2 temp___3621))) 1) 0) (ite (<= (to_rep1 (first com__split_fields1)) (to_rep1 (last com__split_fields1))) (+ (- (to_rep1 (last com__split_fields1)) (to_rep1 (first com__split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___364 temp___3641) (mk___t1 temp___362 temp___3621)))
(assert (= temp___364 o))
(assert (= (mk (to_rep1 (first2 temp___3641)) (to_rep1 (last2 temp___3641))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= com__split_discrs (mk___split_discrs temp___366)))
(assert (= temp___3661 o2))
(assert (= temp___3662 o3))
(assert (= result com__split_fields))
(assert (= result1 com__split_fields1))
(assert (= temp___3661 com__split_fields2))
(assert (= temp___3662 com__split_fields3))
(assert (= com__split_discrs (mk___split_discrs temp___366)))
(assert (= com__split_fields4 com__split_fields2))
(assert (= com__split_fields5 com__split_fields3))
(assert (= com__split_fields6 (mk___split_fields1 (mk___t com__split_fields2 com__split_fields3))))
(assert (not (type_invariant (mk___rep1 com__split_discrs (mk___split_fields1 (mk___t com__split_fields4 com__split_fields5))))))
(check-sat)
(exit)
