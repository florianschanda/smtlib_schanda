...
(assert (in_range3 ic))
(assert (and (= o2 (remove c ic)) (and (dynamic_invariant o2 true false true true) (and (= (invariant__ o2) true) (and (= (to_rep (last o1)) (- (to_rep (last (rt c))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ic 1))) (= (to_rep1 (select (elts c) k)) (to_rep1 (select o k))))) (and (forall ((k Int)) (=> (and (<= (+ ic 1) k) (<= k (to_rep (last (rt c))))) (= (to_rep1 (select (elts c) k)) (to_rep1 (select o (- k 1)))))) (forall ((k Int)) (=> (and (<= ic k) (<= k (- (to_rep (last (rt c))) 1))) (= (to_rep1 (select (elts c) (+ k 1))) (to_rep1 (select o k))))))))))))
