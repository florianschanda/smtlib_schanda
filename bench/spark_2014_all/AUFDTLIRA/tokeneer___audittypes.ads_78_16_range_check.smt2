...
(define-fun dynamic_invariant ((temp___expr_280 us_t1) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool) (temp___do_typ_inv_279 Bool)) Bool (and (=> (not (= temp___skip_constant_277 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_280) (last3 temp___expr_280))) (=> (= temp___do_toplevel_278 true) (=> (= temp___is_init_276 true) (and (let ((temp___282 (of_array2 (to_array1 temp___expr_280) (first3 temp___expr_280) (last3 temp___expr_280)))) (and (= (first5 temp___282) 1) (<= 0 (last5 temp___282)))) (<= (last3 temp___expr_280) 20))))))
(define-fun dynamic_predicate ((temp___284 us_t1)) Bool (and (let ((temp___286 (of_array2 (to_array1 temp___284) (first3 temp___284) (last3 temp___284)))) (and (= (first5 temp___286) 1) (<= 0 (last5 temp___286)))) (<= (last3 temp___284) 20)))
...
(define-fun dynamic_invariant1 ((temp___expr_372 Int) (temp___is_init_368 Bool) (temp___skip_constant_369 Bool) (temp___do_toplevel_370 Bool) (temp___do_typ_inv_371 Bool)) Bool (=> (or (= temp___is_init_368 true) (<= 0 43)) (in_range3 temp___expr_372)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_269 us_t2) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool) (temp___do_typ_inv_268 Bool)) Bool (and (=> (not (= temp___skip_constant_266 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_269) (last5 temp___expr_269))) (=> (= temp___do_toplevel_267 true) (=> (= temp___is_init_265 true) (and (= (first5 temp___expr_269) 1) (<= 0 (last5 temp___expr_269)))))))
(define-fun dynamic_predicate1 ((temp___272 us_t2)) Bool (and (= (first5 temp___272) 1) (<= 0 (last5 temp___272))))
(assert (in_range3 x))
