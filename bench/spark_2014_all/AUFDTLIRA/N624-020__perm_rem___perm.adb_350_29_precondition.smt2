...
(assert (and (= o7 (- ib2 1)) (in_range3 (- ib2 1))))
(assert (and (= o10 (remove bb o7)) (and (dynamic_invariant o10 true false true true) (and (= (invariant__ o10) true) (and (= (to_rep1 (last o9)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o7 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o8 k))))) (and (forall ((k Int)) (=> (and (<= (+ o7 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o8 (- k 1)))))) (forall ((k Int)) (=> (and (<= o7 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o8 k))))))))))))
(assert (and (= o11 (remove aa ia21)) (and (dynamic_invariant o11 true false true true) (and (= (invariant__ o11) true) (and (= (to_rep1 (last o6)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia21 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o5 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia21 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o5 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia21 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o5 k))))))))))))
(assert (not (<= (to_rep1 (first (rt bb2))) ib)))
(check-sat)
(exit)
