...
(define-fun o36 () us_rep (mk___rep (mk___split_discrs o22 o23) (mk___split_fields (mk___t o24 o25))))
(define-fun o37 () us_rep (mk___rep (mk___split_discrs o18 o19) (mk___split_fields (mk___t o20 o21))))
...
(assert (= o16 o10))
(assert (= o17 o11))
(assert (= o37 (to_base5 (mk___rep7 (mk___split_discrs o14 o15) (mk___split_fields7 (mk___t5 o16 o17))))))
(assert (= o36 o37))
(assert (= o28 (of_base3 o36)))
...
(assert (<= (to_rep1 (first6 (rt3 a))) (to_rep (rec__static_discr__holder__length1 current__split_fields6))))
(assert (<= (to_rep (rec__static_discr__holder__length1 current__split_fields6)) (to_rep1 (last6 (rt3 a)))))
(assert (= (bool_eq (elts3 a) (to_rep1 (first6 (rt3 a))) (to_rep1 (last6 (rt3 a))) (elts2 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields6)))) (to_rep1 (first4 (rt2 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields6)))))) (to_rep1 (last4 (rt2 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields6))))))) true))
(assert (and (= o34 (+ (to_rep (rec__static_discr__holder__length1 current__split_fields6)) 1)) (in_range1 (+ (to_rep (rec__static_discr__holder__length1 current__split_fields6)) 1))))
(assert (= o35 (ite (<= o34 i) true false)))
(assert (= result2 (ite (= o35 true) (ite (<= i (to_rep1 (last6 (rt3 a)))) true false) false)))
(assert (= result2 true))
(assert (not (<= i (to_rep1 (last6 (rt3 a))))))
(check-sat)
(exit)
