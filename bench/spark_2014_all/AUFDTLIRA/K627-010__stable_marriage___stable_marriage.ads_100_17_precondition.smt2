...
(assert (and (= o (invert ranking_2)) (forall ((g21 Int)) (=> (and (<= 1 g21) (<= g21 64)) (= (bool_eq2 (select o g21) 1 64 (invert_1 (select ranking_2 g21)) 1 64) true)))))
(assert (= result5 (mk_map__ref3 ranking_2_inverted)))
(assert (= ranking_2_inverted1 o))
(assert (= result6 (mk_int__ref g1)))
(assert (= g12 1))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= unmatched_g1_set__split_fields2 (mk___split_fields temp___545 temp___5451))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= temp___544 g12)))
...
(assert (=> (and (<= 1 g12) (<= g12 64)) (and (= o1 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 1)))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= (to_rep3 o2) o1)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) o3)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= o2 o4)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= temp___539 o3)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= temp___5391 o4)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= result7 (mk___split_fields__ref unmatched_g1_set__split_fields3))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= unmatched_g1_set__split_fields4 (mk___split_fields temp___539 temp___5391))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= (to_rep o5) c175b)))
...
(assert (=> (and (<= 1 g12) (<= g12 64)) (= o6 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= o7 (store (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) o6 o5))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= o7 o8)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4) o9)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= temp___543 o8)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= temp___5431 o9)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= result8 (mk___split_fields__ref unmatched_g1_set__split_fields4))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= unmatched_g1_set__split_fields5 (mk___split_fields temp___543 temp___5431))))
...
(assert (= (= result10 true) (forall ((g110 Int)) (=> (and (<= 1 g110) (<= g110 64)) (exists ((g21 Int)) (and (and (<= 1 g21) (<= g21 64)) (= (to_rep (select (map__content stable_marriage__matching__result4) g21)) g110)))))))
(assert (= result10 true))
(assert (<= 1 g11))
(assert (<= g11 64))
(assert (<= 1 g2))
(assert (<= g2 64))
(assert (and (= o10 (is_preferred_1 (to_rep (select (map__content stable_marriage__matching__result4) g2)) g11 (select ranking_2 g2))) (= (= o10 true) (<= (to_rep2 (select (invert_1 (select ranking_2 g2)) (to_rep (select (map__content stable_marriage__matching__result4) g2)))) (to_rep2 (select (invert_1 (select ranking_2 g2)) g11))))))
(declare-const g110 Int)
(assert (<= 1 g110))
(assert (<= g110 64))
(assert (not (exists ((g21 Int)) (and (and (<= 1 g21) (<= g21 64)) (= (to_rep (select (map__content stable_marriage__matching__result4) g21)) g110)))))
(check-sat)
(exit)
