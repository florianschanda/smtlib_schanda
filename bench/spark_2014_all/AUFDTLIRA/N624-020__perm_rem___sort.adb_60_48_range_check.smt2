...
(assert (and (= o19 y) (in_range4 y)))
(assert (and (= o17 x) (in_range4 x)))
(assert (and (= o18 (remove (mk___t values2 (mk 1 100)) o17)) (and (dynamic_invariant3 o18 true false true true) (and (= (invariant__ o18) true) (and (= (to_rep1 (last (rt o18))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o17 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o18) k))))) (and (forall ((k Int)) (=> (and (<= (+ o17 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o18) (- k 1)))))) (forall ((k Int)) (=> (and (<= o17 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o18) k))))))))))))
(assert (and (= o20 (remove o18 o19)) (and (dynamic_invariant3 o20 true false true true) (and (= (invariant__ o20) true) (and (= (to_rep1 (last (rt o20))) (- (to_rep1 (last (rt o18))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o19 1))) (= (to_rep (select (elts o18) k)) (to_rep (select (elts o20) k))))) (and (forall ((k Int)) (=> (and (<= (+ o19 1) k) (<= k (to_rep1 (last (rt o18))))) (= (to_rep (select (elts o18) k)) (to_rep (select (elts o20) (- k 1)))))) (forall ((k Int)) (=> (and (<= o19 k) (<= k (- (to_rep1 (last (rt o18))) 1))) (= (to_rep (select (elts o18) (+ k 1))) (to_rep (select (elts o20) k))))))))))))
(assert (and (= o15 y) (in_range4 y)))
(assert (and (= o13 x) (in_range4 x)))
(assert (and (= o14 (remove (mk___t init (mk 1 100)) o13)) (and (dynamic_invariant3 o14 true false true true) (and (= (invariant__ o14) true) (and (= (to_rep1 (last (rt o14))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select init k)) (to_rep (select (elts o14) k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o14) (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o14) k))))))))))))
(assert (and (= o16 (remove o14 o15)) (and (dynamic_invariant3 o16 true false true true) (and (= (invariant__ o16) true) (and (= (to_rep1 (last (rt o16))) (- (to_rep1 (last (rt o14))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o15 1))) (= (to_rep (select (elts o14) k)) (to_rep (select (elts o16) k))))) (and (forall ((k Int)) (=> (and (<= (+ o15 1) k) (<= k (to_rep1 (last (rt o14))))) (= (to_rep (select (elts o14) k)) (to_rep (select (elts o16) (- k 1)))))) (forall ((k Int)) (=> (and (<= o15 k) (<= k (- (to_rep1 (last (rt o14))) 1))) (= (to_rep (select (elts o14) (+ k 1))) (to_rep (select (elts o16) k))))))))))))
(assert (and (= o21 (perm_reflexive o16 o20)) (and (in_range5 o21) (=> (= (distinct o21 0) true) (= (is_perm o16 o20) true)))))
(assert (= result4 (mk_int__ref hr)))
(assert (= hr2 o21))
(assert (and (= o23 x) (in_range4 x)))
(assert (and (= o22 y) (in_range4 y)))
...
(assert (= hr3 o24))
(assert (and (= o31 (- x 1)) (in_range4 (- x 1))))
(assert (and (= o29 y) (in_range4 y)))
...
(assert (and (= o27 y) (in_range4 y)))
(assert (and (= o25 x) (in_range4 x)))
(assert (and (= o26 (remove (mk___t values2 (mk 1 100)) o25)) (and (dynamic_invariant3 o26 true false true true) (and (= (invariant__ o26) true) (and (= (to_rep1 (last (rt o26))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o25 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o26) k))))) (and (forall ((k Int)) (=> (and (<= (+ o25 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o26) (- k 1)))))) (forall ((k Int)) (=> (and (<= o25 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o26) k))))))))))))
(assert (and (= o28 (remove o26 o27)) (and (dynamic_invariant3 o28 true false true true) (and (= (invariant__ o28) true) (and (= (to_rep1 (last (rt o28))) (- (to_rep1 (last (rt o26))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o27 1))) (= (to_rep (select (elts o26) k)) (to_rep (select (elts o28) k))))) (and (forall ((k Int)) (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last (rt o26))))) (= (to_rep (select (elts o26) k)) (to_rep (select (elts o28) (- k 1)))))) (forall ((k Int)) (=> (and (<= o27 k) (<= k (- (to_rep1 (last (rt o26))) 1))) (= (to_rep (select (elts o26) (+ k 1))) (to_rep (select (elts o28) k))))))))))))
(assert (and (= o33 (perm_reflexive o28 o32)) (and (in_range5 o33) (=> (= (distinct o33 0) true) (= (is_perm o28 o32) true)))))
(assert (= result6 (mk_int__ref hr3)))
(assert (= hr4 o33))
(assert (and (= o44 (- x 1)) (in_range4 (- x 1))))
(assert (and (= o42 y) (in_range4 y)))
(assert (and (= o43 (remove (mk___t values2 (mk 1 100)) o42)) (and (dynamic_invariant3 o43 true false true true) (and (= (invariant__ o43) true) (and (= (to_rep1 (last (rt o43))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o42 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o43) k))))) (and (forall ((k Int)) (=> (and (<= (+ o42 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o43) (- k 1)))))) (forall ((k Int)) (=> (and (<= o42 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o43) k))))))))))))
(assert (and (= o45 (remove o43 o44)) (and (dynamic_invariant3 o45 true false true true) (and (= (invariant__ o45) true) (and (= (to_rep1 (last (rt o45))) (- (to_rep1 (last (rt o43))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o44 1))) (= (to_rep (select (elts o43) k)) (to_rep (select (elts o45) k))))) (and (forall ((k Int)) (=> (and (<= (+ o44 1) k) (<= k (to_rep1 (last (rt o43))))) (= (to_rep (select (elts o43) k)) (to_rep (select (elts o45) (- k 1)))))) (forall ((k Int)) (=> (and (<= o44 k) (<= k (- (to_rep1 (last (rt o43))) 1))) (= (to_rep (select (elts o43) (+ k 1))) (to_rep (select (elts o45) k))))))))))))
(assert (and (= o40 y) (in_range4 y)))
(assert (and (= o38 x) (in_range4 x)))
(assert (and (= o39 (remove (mk___t values2 (mk 1 100)) o38)) (and (dynamic_invariant3 o39 true false true true) (and (= (invariant__ o39) true) (and (= (to_rep1 (last (rt o39))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o38 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o39) k))))) (and (forall ((k Int)) (=> (and (<= (+ o38 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o39) (- k 1)))))) (forall ((k Int)) (=> (and (<= o38 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o39) k))))))))))))
(assert (and (= o41 (remove o39 o40)) (and (dynamic_invariant3 o41 true false true true) (and (= (invariant__ o41) true) (and (= (to_rep1 (last (rt o41))) (- (to_rep1 (last (rt o39))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o40 1))) (= (to_rep (select (elts o39) k)) (to_rep (select (elts o41) k))))) (and (forall ((k Int)) (=> (and (<= (+ o40 1) k) (<= k (to_rep1 (last (rt o39))))) (= (to_rep (select (elts o39) k)) (to_rep (select (elts o41) (- k 1)))))) (forall ((k Int)) (=> (and (<= o40 k) (<= k (- (to_rep1 (last (rt o39))) 1))) (= (to_rep (select (elts o39) (+ k 1))) (to_rep (select (elts o41) k))))))))))))
(assert (and (= o36 y) (in_range4 y)))
(assert (and (= o34 x) (in_range4 x)))
(assert (and (= o35 (remove (mk___t init (mk 1 100)) o34)) (and (dynamic_invariant3 o35 true false true true) (and (= (invariant__ o35) true) (and (= (to_rep1 (last (rt o35))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o34 1))) (= (to_rep (select init k)) (to_rep (select (elts o35) k))))) (and (forall ((k Int)) (=> (and (<= (+ o34 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o35) (- k 1)))))) (forall ((k Int)) (=> (and (<= o34 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o35) k))))))))))))
(assert (and (= o37 (remove o35 o36)) (and (dynamic_invariant3 o37 true false true true) (and (= (invariant__ o37) true) (and (= (to_rep1 (last (rt o37))) (- (to_rep1 (last (rt o35))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o36 1))) (= (to_rep (select (elts o35) k)) (to_rep (select (elts o37) k))))) (and (forall ((k Int)) (=> (and (<= (+ o36 1) k) (<= k (to_rep1 (last (rt o35))))) (= (to_rep (select (elts o35) k)) (to_rep (select (elts o37) (- k 1)))))) (forall ((k Int)) (=> (and (<= o36 k) (<= k (- (to_rep1 (last (rt o35))) 1))) (= (to_rep (select (elts o35) (+ k 1))) (to_rep (select (elts o37) k))))))))))))
(assert (and (= o46 (perm_transitive o37 o41 o45)) (and (in_range5 o46) (=> (= (distinct o46 0) true) (= (is_perm o37 o45) true)))))
...
(assert (and (= o47 y) (in_range4 y)))
(assert (and (= o48 (remove (mk___t values2 (mk 1 100)) o47)) (and (dynamic_invariant3 o48 true false true true) (and (= (invariant__ o48) true) (and (= (to_rep1 (last (rt o48))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o47 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o48) k))))) (and (forall ((k Int)) (=> (and (<= (+ o47 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o48) (- k 1)))))) (forall ((k Int)) (=> (and (<= o47 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o48) k))))))))))))
(assert (not (in_range4 x)))
(check-sat)
(exit)
