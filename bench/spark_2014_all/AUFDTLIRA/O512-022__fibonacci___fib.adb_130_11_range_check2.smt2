...
(assert (in_range2 k1))
(assert (in_range2 k2))
(assert (and (= k1 k2) (and (<= 0 k1) (and (<= k1 100) (and (<= 0 k2) (and (<= k2 100) (and (forall ((i Int)) (=> (and (<= 0 i) (<= i k1)) (= (to_rep (select b1 i)) (to_rep (select b2 i))))) (forall ((i Int)) (=> (and (<= (+ k1 1) i) (<= i 100)) (= (to_rep (select c1 (- i k1))) (to_rep (select c2 (- i k2)))))))))))))
(assert (<= 0 k1))
(assert (not (<= 0 0)))
(check-sat)
(exit)
