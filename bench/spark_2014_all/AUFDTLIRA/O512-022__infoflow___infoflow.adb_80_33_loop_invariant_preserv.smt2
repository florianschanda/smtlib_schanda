...
(assert (and (and (forall ((temp___408 Int)) (=> (and (<= 1 temp___408) (<= temp___408 10)) (=> (or (< 10 temp___408) (or (< temp___408 1) (< i2 temp___408))) (= (select outkeys_v12 temp___408) (select outkeys_v1 temp___408))))) (=> (<= 1 10) (in_range2 i2))) (and (<= 1 i2) (<= i2 10))))
(assert (not (= i2 10)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
