...
(assert (=> (<= 0 r12b2) (and (and (<= (to_rep (first (rt p))) 0) (<= 0 (to_rep (last (rt p))))) (and (<= (to_rep (first (rt p))) r12b2) (<= r12b2 (to_rep (last (rt p))))))))
(assert (= o5 (elts p)))
(assert (= temp___198 o5))
(assert (= temp___1981 (mk4 0 r12b2)))
(assert (<= r8b2 r9b2))
(assert (not (<= r8b2 (to_rep (last (rt p))))))
(check-sat)
(exit)
