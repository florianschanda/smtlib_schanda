...
(assert (=> (not (= smallest1 current1)) (= (is_perm__logic (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t o12 (mk (to_rep values__first) (to_rep values__last)))) true)))
...
(assert (and (= o11 smallest3) (in_range4 smallest3)))
(assert (not (in_range4 current3)))
(check-sat)
(exit)
