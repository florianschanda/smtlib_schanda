...
(declare-const temp___199 (Array Int natural))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___201 i1)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___199 c)))
...
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (and (forall ((temp___200 Int)) (=> (and (<= 1 temp___200) (<= temp___200 100)) (=> (or (< 100 temp___200) (or (< temp___200 1) (< i2 temp___200))) (= (select c3 temp___200) (select temp___199 temp___200))))) (=> (<= 1 100) (in_range3 i2))) (and (<= 1 i2) (<= i2 100)))))
...
(assert (= i8 i6))
(assert (= c9 c7))
(assert (and (= o (has_element c8 temp___2031)) (= (= o true) (and (<= 1 (to_rep temp___203)) (<= (to_rep temp___203) 100)))))
(assert (= o1 true))
