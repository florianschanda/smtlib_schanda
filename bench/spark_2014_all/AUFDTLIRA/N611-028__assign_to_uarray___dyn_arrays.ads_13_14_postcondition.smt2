...
(assert (= from temp___204))
(assert (= (mk 1 100) temp___2041))
(assert (= o (slide temp___204 (to_rep1 (first temp___2041)) (to_rep1 to____first))))
...
(assert (not (= (to_rep (select to__2 i)) (to_rep (select from i)))))
(check-sat)
(exit)
