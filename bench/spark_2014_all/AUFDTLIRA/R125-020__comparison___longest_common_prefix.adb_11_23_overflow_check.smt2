...
(assert (= result9 (ite (<= o15 1000) true false)))
(assert (=> (= result9 true) (and (= o14 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result9 true) (= result8 (ite (<= o14 1000) true false))))
(assert (=> (not (= result9 true)) (= result8 false)))
(assert (= result8 true))
(assert (and (= temp___1971 (+ y l3)) (in_range1 (+ y l3))))
(assert (and (<= 1 temp___1971) (<= temp___1971 1000)))
(assert (= o11 temp___1971))
