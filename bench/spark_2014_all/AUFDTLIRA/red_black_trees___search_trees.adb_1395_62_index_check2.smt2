...
(declare-const d Int)
(declare-const o Int)
(declare-const temp___763 (Array Int us_rep4))
...
(assert (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) current2))) true))
(assert (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) i4))) true) (=> (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) i4))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) current2)))) true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) current2))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) i4)))) 1)) 0) (< v (to_rep (select (rec__search_trees__search_tree__values t__split_fields5) i4))) (< (to_rep (select (rec__search_trees__search_tree__values t__split_fields5) i4)) v)))))))
(assert (and (and (and (and (=> (<= 0 100) (in_range6 previous2)) (=> (<= 0 1) (in_range9 d2))) (=> (<= 0 100) (in_range6 i3))) (=> (<= 0 100) (in_range6 current2))) (not (= current2 0))))
(assert (and (= o (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) (in_range8 (to_rep1 (rec__search_trees__search_tree__root t__split_fields5)))))
(assert (and (= temp___763 (model__ (rec__search_trees__search_tree__struct t__split_fields5) o)) (and (dynamic_invariant9 temp___763 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___763 o))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___763 o)))) 0) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (not (= i4 o)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct t__split_fields5) i4) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___763 (parent (rec__search_trees__search_tree__struct t__split_fields5) i4)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___763 i4))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___763 i4))) true)))))) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___763 i4))) true) (not (= i4 o))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___763 (parent (rec__search_trees__search_tree__struct t__split_fields5) i4)))) (position (rec__search_trees__search_tree__struct t__split_fields5) i4) (rec__tree_model__path_type__a (us_split_fields5 (select temp___763 i4)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___763 i4)))) 0)))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___763 i4))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___763 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___763 i4))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___763 j)))) true)) (= j i4))))))))))))))
(assert (not (<= 1 current2)))
(check-sat)
(exit)
