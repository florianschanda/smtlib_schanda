...
(assert (= (mk___split_fields2 ic_acct__split_fields4 ic_acct__split_fields5 ic_acct__split_fields6 ic_acct__split_fields7) (us_split_fields5 (of_base1 (mk___rep (mk___split_fields c392008__new_account__acct__fields2 c392008__new_account__acct__fields3) ic_acct__attr__tag)))))
(assert (not (not (=> (= (to_rep2 b_acct__split_fields) 1000) (=> (= (to_rep2 c_acct__split_fields4) 2000) (not (= (to_rep2 ic_acct__split_fields5) 3000)))))))
(check-sat)
(exit)
