...
(assert (= o19 (select temp___1635 i)))
...
(assert (and (= temp___1634 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o15)) (and (dynamic_invariant1 temp___1634 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1634 o15))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1634 o15)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o15)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1634 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1634 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1634 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1634 i1))) true) (not (= i1 o15))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1634 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1634 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1634 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1634 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1634 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1634 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1634 j)))) true)) (= j i1))))))))))))))
(assert (= o16 (select temp___1634 i)))
...
(assert (= o10 v))
(assert (= o11 (select temp___1633 o10)))
