...
(assert (not (= (is_prepend (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields6)) (int__content res3) model____split_fields) true)))
(check-sat)
(exit)
