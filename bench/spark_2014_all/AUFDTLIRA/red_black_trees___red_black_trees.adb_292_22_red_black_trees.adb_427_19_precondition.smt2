...
(declare-const temp___860 (Array Int us_rep7))
(declare-const o28 us_rep7)
(declare-const o29 us_split_fields10)
(declare-const o30 extended_index_type)
(declare-const o31 Int)
(declare-const temp___859 (Array Int us_rep7))
...
(assert (and (= temp___860 (nb_blacks c81b)) (and (= (bool_eq11 (select temp___860 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___860 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___860 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___860 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___860 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___860 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___860 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___860 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___860 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___860 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c81b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___860 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 0))))))))))))))
(assert (= o28 (select temp___860 c83b)))
(assert (= o29 (us_split_fields11 o28)))
(assert (= o30 (rec__red_black_trees__black_count__depth o29)))
(assert (= o31 (to_rep o30)))
(assert (= result13 (ite (< o31 n6) true false)))
(assert (= result13 true))
(assert (and (= temp___859 (nb_blacks c81b)) (and (= (bool_eq11 (select temp___859 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___859 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___859 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___859 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___859 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___859 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___859 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___859 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___859 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___859 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c81b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___859 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 0))))))))))))))
(assert (= o32 (select temp___859 y)))
(assert (not (not (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c82b))) 0))))
(check-sat)
(exit)
