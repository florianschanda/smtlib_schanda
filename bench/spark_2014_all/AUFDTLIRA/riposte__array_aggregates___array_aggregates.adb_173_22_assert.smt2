...
(assert (forall ((temp___507 Int) (temp___508 Int)) (let ((temp___506 (temp_____aggregate_def_505 temp___507 temp___508))) (=> (and (dynamic_invariant temp___507 true true true true) (dynamic_invariant temp___508 true true true true)) (forall ((temp___509 Int)) (ite (or (= temp___509 2) (and (<= 4 temp___509) (<= temp___509 6))) (= (to_rep (select temp___506 temp___509)) temp___507) (= (to_rep (select temp___506 temp___509)) temp___508)))))))
(declare-const x (Array Int enum_t))
(declare-const result (Array Int enum_t))
(declare-const x1 (Array Int enum_t))
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_505 0 1)))
(assert (not (= (to_rep (select x1 3)) 1)))
(check-sat)
(exit)
