...
(assert (= result2 true))
(assert (and (= o18 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f1)) j1))))) (in_range5 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f1)) j1)))))))
...
(assert (= o15 (select temp___1112 j1)))
...
(assert (= o12 (select temp___1111 j1)))
...
(assert (= o9 (select temp___1108 o8)))
