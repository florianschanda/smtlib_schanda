...
(assert (and (= o17 (add (rec__list_allocator__m__t__allocated model____split_fields2) res1)) (and (and (and (= (length1 o17) (+ (length1 (rec__list_allocator__m__t__allocated model____split_fields2)) 1)) (= (contains o17 res1) true)) (= (ole (rec__list_allocator__m__t__allocated model____split_fields2) o17) true)) (= (included_except o17 (rec__list_allocator__m__t__allocated model____split_fields2) res1) true))))
(assert (= (rec__list_allocator__m__t__available model____split_fields2) o18))
(assert (= o17 o19))
(assert (= temp___322 o18))
(assert (= temp___3221 o19))
(assert (= result6 (mk___split_fields__ref model____split_fields2)))
(assert (= model____split_fields3 (mk___split_fields temp___322 temp___3221)))
(assert (and (= o20 (length (rec__list_allocator__m__t__available model____split_fields3))) (and (in_range1 o20) (<= (+ 0 o20) 2147483647))))
(assert (= o21 (ite (<= j o20) true false)))
(assert (= result7 (ite (<= 1 j) o21 false)))
(assert (= result7 true))
(assert (<= 1 k))
(assert (<= k (- j 1)))
(assert (and (= o22 (get (rec__list_allocator__m__t__available model____split_fields3) k)) (in_range2 o22)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
