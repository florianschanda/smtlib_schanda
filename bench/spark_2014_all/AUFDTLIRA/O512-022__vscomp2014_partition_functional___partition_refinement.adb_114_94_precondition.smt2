...
(assert (= result3 true))
(assert (and (= o4 (key (mk___rep d__split_discrs d__split_fields2) c)) (and (in_range3 o4) (= o4 (get (keys (mk___rep d__split_discrs d__split_fields2)) (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c))))))
(assert (= o5 (ite (= o4 (to_rep (select a1 j))) true false)))
(assert (= o6 (ite (not (= o5 true)) true false)))
(assert (and (= o2 (key (mk___rep d__split_discrs d__split_fields2) c)) (and (in_range3 o2) (= o2 (get (keys (mk___rep d__split_discrs d__split_fields2)) (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c))))))
(assert (= o3 (ite (= o2 (to_rep (select a1 i))) true false)))
(assert (= o7 (ite (not (= o3 true)) true false)))
(assert (= result4 (ite (= o7 true) o6 false)))
(assert (= result4 true))
(assert (and (= o8 (key (mk___rep d__split_discrs d__split_fields2) c)) (and (in_range3 o8) (= o8 (get (keys (mk___rep d__split_discrs d__split_fields2)) (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c))))))
