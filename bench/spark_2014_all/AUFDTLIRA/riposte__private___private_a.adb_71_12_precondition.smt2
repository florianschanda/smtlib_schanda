...
(assert (forall ((x length_t)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 0 100)) (in_range2 temp___expr_180)))
(assert (forall ((the_stack us_rep)) (! (dynamic_invariant1 (get_length the_stack) true false true true) :pattern ((get_length the_stack)))))
...
(assert (forall ((the_stack us_rep)) (! (=> (< 0 (get_length the_stack)) (dynamic_invariant (top the_stack) true false true true)) :pattern ((top the_stack)))))
...
(declare-const temp___2721 length_t)
(declare-const temp___2722 (Array Int integer))
...
(assert (= temp___2721 o3))
(assert (= temp___2722 o4))
(assert (= (mk___split_fields__ref1 (mk___split_fields1 result (mk___rep (mk___split_fields result1 result2)))) (mk___split_fields__ref1 (mk___split_fields1 s__split_fields (mk___rep (mk___split_fields s__split_fields1 s__split_fields2))))))
(assert (= temp___272 s__split_fields3))
(assert (= temp___2721 s__split_fields4))
(assert (= temp___2722 s__split_fields5))
(assert (= s__split_fields3 true))
(assert (not (< (get_length (mk___rep (mk___split_fields s__split_fields4 s__split_fields5))) 100)))
(check-sat)
(exit)
