...
(declare-datatypes () ((p_array__ref (mk_p_array__ref (p_array__content us_t)))))
(define-fun p_array__ref___projection ((a p_array__ref)) us_t (p_array__content a))
...
(define-fun dynamic_invariant3 ((temp___expr_159 us_t) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (not (= temp___skip_constant_156 true)) (dynamic_property 0 2147483647 (first1 temp___expr_159) (last1 temp___expr_159))))
(declare-const a (Array Int positive))
(declare-const o Int)
(declare-const o1 positive)
(declare-const o2 Int)
(declare-const aliasing__swap__y Int)
(declare-const o3 Int)
(declare-const o4 positive)
(declare-const o5 Int)
(declare-const aliasing__swap__x Int)
(declare-const o6 positive)
(declare-const o7 Int)
(declare-const o8 (Array Int positive))
(declare-const o9 positive)
(declare-const aliasing__swap__y1 Int)
(declare-const aliasing__swap__x1 Int)
(declare-const result (Array Int positive))
(declare-const a1 (Array Int positive))
(assert (dynamic_property 0 2147483647 (to_rep1 a__first) (to_rep1 a__last)))
(assert (in_range i))
(assert (in_range j))
...
(assert (= o2 (to_rep o1)))
(assert (= o2 aliasing__swap__y))
(assert (and (<= (to_rep1 a__first) i) (<= i (to_rep1 a__last))))
(assert (= o3 i))
(assert (= o4 (select a o3)))
(assert (= o5 (to_rep o4)))
(assert (= o5 aliasing__swap__x))
(assert (and (in_range1 aliasing__swap__x1) (in_range1 aliasing__swap__y1)))
(assert (= (to_rep o6) aliasing__swap__x1))
(assert (and (<= (to_rep1 a__first) i) (<= i (to_rep1 a__last))))
(assert (= o7 i))
(assert (= o8 (store a o7 o6)))
(assert (= result a))
(assert (= a1 o8))
(assert (= (to_rep o9) aliasing__swap__y1))
