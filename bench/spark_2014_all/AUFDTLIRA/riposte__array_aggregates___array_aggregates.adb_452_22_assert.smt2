...
(declare-fun temp_____aggregate_def_729 (Bool) (Array Int Bool))
(declare-fun temp_____aggregate_def_733 (Bool) (Array Int Bool))
...
(assert (forall ((temp___731 Bool)) (forall ((temp___732 Int)) (= (select (temp_____aggregate_def_729 temp___731) temp___732) temp___731))))
(assert (forall ((temp___735 Bool)) (forall ((temp___736 Int)) (= (select (temp_____aggregate_def_733 temp___735) temp___736) temp___735))))
(declare-const x (Array Int Bool))
(declare-const result (Array Int Bool))
(declare-const x1 (Array Int Bool))
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_729 (distinct 1 0))))
(declare-const n Int)
(assert (<= 0 n))
(assert (<= n 255))
(assert (not (= (bool_eq x1 0 255 (temp_____aggregate_def_733 (= n n)) 0 255) true)))
(check-sat)
(exit)
