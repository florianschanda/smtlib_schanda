...
(assert (<= 1 id1))
(assert (<= id1 3))
(assert (and (= o2 (get_previous_track cur_position id1)) (and (in_range3 o2) (= o2 (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 (rec__trains__train_position__track_end (us_split_fields3 cur_position)))))))) id1))))))
