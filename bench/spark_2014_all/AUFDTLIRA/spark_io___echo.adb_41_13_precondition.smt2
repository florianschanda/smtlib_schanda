...
(define-fun default_initial_assumption ((temp___expr_675 us_rep1) (temp___skip_top_level_676 Bool)) Bool (and (= (attr__constrained temp___expr_675) false) (= (to_rep2 (rec__spark__text_io__character_result__status (us_split_discrs1 temp___expr_675))) 3)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_884 us_void_param) 1)) 69) (= (to_rep (select (temp___String_Literal_884 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 4)) 111)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 5)) 114)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 7)) 111)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 8)) 110)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 10)) 83)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 11)) 116)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 14)) 100)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 15)) 97)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 17)) 100)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 18)) 95)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 19)) 73)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 20)) 110)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 21)) 112)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 22)) 117)) (= (to_rep (select (temp___String_Literal_884 us_void_param) 23)) 116)) :pattern ((temp___String_Literal_884 us_void_param)))))
(declare-fun temp___String_Literal_885 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_885 us_void_param) 1)) 69) (= (to_rep (select (temp___String_Literal_885 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 4)) 111)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 5)) 114)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 7)) 111)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 8)) 110)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 10)) 83)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 11)) 116)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 14)) 100)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 15)) 97)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 17)) 100)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 18)) 95)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 19)) 79)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 20)) 117)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 21)) 116)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 22)) 112)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 23)) 117)) (= (to_rep (select (temp___String_Literal_885 us_void_param) 24)) 116)) :pattern ((temp___String_Literal_885 us_void_param)))))
...
(define-fun dynamic_invariant5 ((temp___expr_614 Int) (temp___is_init_610 Bool) (temp___skip_constant_611 Bool) (temp___do_toplevel_612 Bool) (temp___do_typ_inv_613 Bool)) Bool (=> (or (= temp___is_init_610 true) (<= 0 2)) (in_range5 temp___expr_614)))
...
(define-fun dynamic_invariant6 ((temp___expr_621 Int) (temp___is_init_617 Bool) (temp___skip_constant_618 Bool) (temp___do_toplevel_619 Bool) (temp___do_typ_inv_620 Bool)) Bool (=> (or (= temp___is_init_617 true) (<= 0 2147483647)) (in_range6 temp___expr_621)))
...
(assert (and (and (and (and (and (= (is_readable standard_input2) true) (= (let ((temp___793 (name standard_input1))) (let ((temp___792 (name standard_input2))) (bool_eq (elts temp___792) (to_rep1 (first (rt temp___792))) (to_rep1 (last (rt temp___792))) (elts temp___793) (to_rep1 (first (rt temp___793))) (to_rep1 (last (rt temp___793)))))) true)) (= (let ((temp___795 (form standard_input1))) (let ((temp___794 (form standard_input2))) (bool_eq (elts temp___794) (to_rep1 (first (rt temp___794))) (to_rep1 (last (rt temp___794))) (elts temp___795) (to_rep1 (first (rt temp___795))) (to_rep1 (last (rt temp___795)))))) true)) (= (is_standard_file standard_input2) true)) (= (is_standard_input standard_input2) true)) (=> (= (to_rep2 c__split_discrs1) 1) (= (status standard_input2) 1))))
(assert (= (to_rep2 c__split_discrs1) 1))
(assert (and (= o1 (status standard_output)) (in_range4 o1)))
