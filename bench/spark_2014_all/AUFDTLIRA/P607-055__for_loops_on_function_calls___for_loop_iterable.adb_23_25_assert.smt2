...
(declare-const dummy1 valid_cursor)
...
(declare-fun for_loop_iterable__p2__a__aggregate_def (Int) (Array Int natural))
...
(assert (forall ((temp___274 Int)) (=> (dynamic_invariant temp___274 true true true true) (forall ((temp___275 Int)) (= (select (for_loop_iterable__p2__a__aggregate_def temp___274) temp___275) rliteral)))))
...
(assert (<= 1 c8b1))
(assert (<= c8b1 100))
(assert (and (forall ((temp___279 Int)) (=> (and (<= 1 temp___279) (<= temp___279 100)) (=> (not (= 2 temp___279)) (= (select a2 temp___279) (select a1 temp___279))))) (and (<= 1 c8b2) (<= c8b2 100))))
(assert (= result2 a2))
(assert (= a3 (store a2 2 rliteral1)))
(assert (not (= (to_rep (select a3 c8b2)) 0)))
(check-sat)
(exit)
