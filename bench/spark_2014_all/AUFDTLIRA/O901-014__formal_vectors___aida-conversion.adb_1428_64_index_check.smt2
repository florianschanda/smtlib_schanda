...
(assert (= (= o36 true) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 8) index1) (<= index1 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
...
(assert (= o8 temp___1993))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (= o10 52) true false)))
(assert (and (= temp___1992 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1992) (<= temp___1992 (to_rep1 (last (rt source))))))
(assert (= o4 temp___1992))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 49) true false)))
(assert (and (= temp___1991 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1991) (<= temp___1991 (to_rep1 (last (rt source))))))
(assert (= o temp___1991))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (<= o2 50) true false)))
(assert (and (= temp___1990 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (not (<= temp___1990 (to_rep1 (last (rt source))))))
(check-sat)
(exit)
