...
(assert (forall ((i3 Int)) (=> (and (<= (to_rep1 a__first) i3) (<= i3 (to_rep1 a__last))) (= (a_small_enough (to_rep (select a i3))) true))))
...
(assert (= a1 o3))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep1 a__first) k1) (<= k1 i2)) (= (to_rep (select a2 k1)) (add_one (to_rep (select a k1)))))))
...
(assert (= o6 (to_rep o5)))
(assert (and (= o7 (add_one o6)) (and (in_range3 o7) (= o7 (+ o6 1)))))
(assert (not (<= (to_rep1 a__first) k)))
(check-sat)
(exit)
