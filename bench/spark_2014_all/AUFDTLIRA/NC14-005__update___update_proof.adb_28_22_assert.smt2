...
(assert (forall ((i ta_tD1)) (and (<= 1 (ta_tD1qtint i)) (<= (ta_tD1qtint i) 2))))
...
(assert (forall ((i tb_tD1)) (and (<= 1 (tb_tD1qtint i)) (<= (tb_tD1qtint i) 2))))
...
(declare-fun temp_____aggregate_def_221 ((Array Int integer) Int Int) (Array Int integer))
(declare-fun update_proof__B_1__a__aggregate_def (Int Int) (Array Int integer))
(declare-fun temp_____aggregate_def_233 (Int) (Array Int integer))
(declare-fun temp_____aggregate_def_241 (Int) (Array Int integer))
(declare-fun temp_____aggregate_def_249 ((Array Int (Array Int integer)) Int (Array Int integer)) (Array Int (Array Int integer)))
(declare-fun temp_____aggregate_def_255 (Int) (Array Int integer))
(declare-fun temp_____aggregate_def_261 (Int) (Array Int integer))
...
(declare-fun temp_____aggregate_def_280 (Int Int) (Array Int integer))
(define-fun dynamic_invariant ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_18)))
(declare-const rliteral integer)
(assert (= (integerqtint rliteral) 1))
(declare-const rliteral1 integer)
(assert (= (integerqtint rliteral1) 2))
(assert (forall ((temp___230 Int) (temp___231 Int)) (let ((temp___229 (update_proof__B_1__a__aggregate_def temp___230 temp___231))) (=> (and (dynamic_invariant temp___230 true true true true) (dynamic_invariant temp___231 true true true true)) (and (= (select temp___229 1) rliteral) (= (select temp___229 2) rliteral1))))))
(declare-const rliteral2 integer)
(assert (= (integerqtint rliteral2) 0))
(assert (forall ((temp___223 (Array Int integer))) (forall ((temp___224 Int) (temp___225 Int)) (let ((temp___222 (temp_____aggregate_def_221 temp___223 temp___224 temp___225))) (=> (and (in_range2 temp___224) (dynamic_invariant temp___225 true true true true)) (forall ((temp___226 Int)) (ite (= temp___226 temp___224) (= (select temp___222 temp___226) rliteral2) (= (select temp___222 temp___226) (select temp___223 temp___226)))))))))
...
(assert (forall ((temp___277 Int) (temp___278 Int)) (let ((temp___276 (temp_____aggregate_def_275 temp___277 temp___278))) (=> (and (dynamic_invariant temp___277 true true true true) (dynamic_invariant temp___278 true true true true)) (and (= (select temp___276 1) rliteral3) (= (select temp___276 2) rliteral4))))))
...
(assert (forall ((temp___282 Int) (temp___283 Int)) (let ((temp___281 (temp_____aggregate_def_280 temp___282 temp___283))) (=> (and (dynamic_invariant temp___282 true true true true) (dynamic_invariant temp___283 true true true true)) (and (= (select temp___281 1) rliteral5) (= (select temp___281 2) rliteral6))))))
(assert (forall ((temp___235 Int)) (=> (dynamic_invariant temp___235 true true true true) (forall ((temp___236 Int)) (= (select (temp_____aggregate_def_233 temp___235) temp___236) rliteral2)))))
(assert (forall ((temp___243 Int)) (=> (dynamic_invariant temp___243 true true true true) (forall ((temp___244 Int)) (= (select (temp_____aggregate_def_241 temp___243) temp___244) rliteral2)))))
(assert (forall ((temp___251 (Array Int (Array Int integer)))) (forall ((temp___252 Int)) (forall ((temp___253 (Array Int integer))) (let ((temp___250 (temp_____aggregate_def_249 temp___251 temp___252 temp___253))) (=> (in_range3 temp___252) (forall ((temp___254 Int)) (ite (= temp___254 temp___252) (= (select temp___250 temp___254) temp___253) (= (select temp___250 temp___254) (select temp___251 temp___254))))))))))
(assert (forall ((temp___257 Int)) (=> (dynamic_invariant temp___257 true true true true) (forall ((temp___258 Int)) (= (select (temp_____aggregate_def_255 temp___257) temp___258) rliteral2)))))
(assert (forall ((temp___263 Int)) (=> (dynamic_invariant temp___263 true true true true) (forall ((temp___264 Int)) (= (select (temp_____aggregate_def_261 temp___263) temp___264) rliteral2)))))
...
(assert (= a1 o_a))
(assert (= a1 result1))
(assert (= a2 (store a1 2 rliteral2)))
(assert (= (to_rep (select a2 1)) (to_rep (select o_a 1))))
(assert (= (to_rep (select a2 2)) 0))
(assert (= (bool_eq a2 1 2 (temp_____aggregate_def_221 o_a 2 0) 1 2) true))
(assert (= result2 b))
(assert (= b1 (update_proof__B_2__b__aggregate_def (temp_____aggregate_def_275 11 12) (temp_____aggregate_def_280 21 22))))
(assert (= b1 o_b))
(assert (= result3 b1))
(assert (= b2 (store b1 2 (temp_____aggregate_def_233 0))))
(assert (= (bool_eq (select b2 1) 1 2 (select o_b 1) 1 2) true))
(assert (not (= (bool_eq (select b2 2) 1 2 (temp_____aggregate_def_241 0) 1 2) true)))
(check-sat)
(exit)
