...
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (to_rep2 (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields4)) j)) (+ (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j)) (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 b))) j))))))))
...
(assert (= (mk___rep (mk___split_discrs result3) (mk___split_fields (mk___t result4 result5))) (table__content simple_unc_arrays__add__result6)))
(assert (not (= (same_range (table__content simple_unc_arrays__add__result6) a) true)))
(check-sat)
(exit)
