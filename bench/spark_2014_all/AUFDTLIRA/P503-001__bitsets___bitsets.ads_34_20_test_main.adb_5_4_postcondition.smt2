...
(declare-fun temp_____aggregate_def_362 (Bool) (Array Int Bool))
(assert (forall ((temp___364 Bool)) (forall ((temp___365 Int)) (= (select (temp_____aggregate_def_362 temp___364) temp___365) temp___364))))
(declare-const test_main__my_sets__empty__result (Array Int Bool))
(declare-const result (Array Int Bool))
(declare-const test_main__my_sets__empty__result1 (Array Int Bool))
(declare-const test_main__my_sets__empty__result2 (Array Int Bool))
(declare-const test_main__my_sets__empty__result3 (Array Int Bool))
(declare-const test_main__my_sets__empty__result4 (Array Int Bool))
(declare-const test_main__my_sets__empty__result5 (Array Int Bool))
(declare-const result1 (Array Int Bool))
(assert (= test_main__my_sets__empty__result1 test_main__my_sets__empty__result2))
(assert (= test_main__my_sets__empty__result3 test_main__my_sets__empty__result1))
(assert (= result test_main__my_sets__empty__result))
(assert (= test_main__my_sets__empty__result1 (temp_____aggregate_def_362 (distinct 0 0))))
(assert (= (mk_map__ref test_main__my_sets__empty__result4) (mk_map__ref test_main__my_sets__empty__result2)))
(assert (= test_main__my_sets__empty__result5 test_main__my_sets__empty__result3))
(assert (= result1 test_main__my_sets__empty__result4))
(declare-const elt Int)
(assert (<= 1 elt))
(assert (<= elt 10))
(assert (not (not (= (mem test_main__my_sets__empty__result4 elt) true))))
(check-sat)
(exit)
