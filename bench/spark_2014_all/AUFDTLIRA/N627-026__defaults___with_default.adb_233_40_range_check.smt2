...
(define-fun dynamic_invariant1 ((temp___expr_649 us_rep1) (temp___is_init_645 Bool) (temp___skip_constant_646 Bool) (temp___do_toplevel_647 Bool) (temp___do_typ_inv_648 Bool)) Bool (forall ((temp___650 Int)) (=> (and (<= 1 temp___650) (<= temp___650 0)) (= (attr__constrained (select (rec__with_default__ok_nested_defaults__non_init1__e (us_split_fields1 temp___expr_649)) temp___650)) false))))
(define-fun default_initial_assumption ((temp___expr_652 us_rep1) (temp___skip_top_level_653 Bool)) Bool (forall ((temp___655 Int)) (=> (and (<= 1 temp___655) (<= temp___655 0)) (and (= (attr__constrained (select (rec__with_default__ok_nested_defaults__non_init1__e (us_split_fields1 temp___expr_652)) temp___655)) false) (= (to_rep1 (rec__with_default__ok_nested_defaults__empty_rec1__d (us_split_discrs1 (select (rec__with_default__ok_nested_defaults__non_init1__e (us_split_fields1 temp___expr_652)) temp___655)))) c)))))
(declare-sort t37b 0)
(declare-fun t37bqtint (t37b) Int)
(assert (forall ((i t37b)) (and (<= 1 (t37bqtint i)) (<= (t37bqtint i) 100))))
...
(define-fun dynamic_invariant2 ((temp___expr_679 us_rep3) (temp___is_init_675 Bool) (temp___skip_constant_676 Bool) (temp___do_toplevel_677 Bool) (temp___do_typ_inv_678 Bool)) Bool (forall ((temp___680 Int)) (=> (and (<= 1 temp___680) (<= temp___680 100)) (= (attr__constrained1 (select (rec__with_default__ok_nested_defaults__non_init2__e (us_split_fields3 temp___expr_679)) temp___680)) false))))
(define-fun default_initial_assumption1 ((temp___expr_682 us_rep3) (temp___skip_top_level_683 Bool)) Bool (forall ((temp___685 Int)) (=> (and (<= 1 temp___685) (<= temp___685 100)) (and (= (attr__constrained1 (select (rec__with_default__ok_nested_defaults__non_init2__e (us_split_fields3 temp___expr_682)) temp___685)) false) (= (to_rep1 (rec__with_default__ok_nested_defaults__empty_rec2__d (us_split_discrs3 (select (rec__with_default__ok_nested_defaults__non_init2__e (us_split_fields3 temp___expr_682)) temp___685)))) 1)))))
...
(define-fun default_initial_assumption2 ((temp___expr_635 us_rep) (temp___skip_top_level_636 Bool)) Bool (and (= (attr__constrained temp___expr_635) false) (= (to_rep1 (rec__with_default__ok_nested_defaults__empty_rec1__d (us_split_discrs1 temp___expr_635))) c)))
(define-fun default_initial_assumption3 ((temp___expr_665 us_rep2) (temp___skip_top_level_666 Bool)) Bool (and (= (attr__constrained1 temp___expr_665) false) (= (to_rep1 (rec__with_default__ok_nested_defaults__empty_rec2__d (us_split_discrs3 temp___expr_665))) 1)))
(declare-const o Int)
