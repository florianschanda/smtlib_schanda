...
(assert (= j1 o1))
(assert (<= i1 j1))
(assert (and (and (and (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (and (<= (to_rep a__first) j2) (<= j2 (to_rep a__last)))) (forall ((k1 Int)) (=> (and (<= (to_rep a__first) k1) (<= k1 (- i2 1))) (not (= (select a k1) true))))) (forall ((k1 Int)) (=> (and (<= (+ j2 1) k1) (<= k1 (to_rep a__last))) (= (select a k1) true)))))
(assert (and (and (=> (<= 0 1000000) (in_range2 i2)) (=> (<= 0 1000000) (in_range2 j2))) (<= i2 j2)))
(assert (=> (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (= result3 (ite (<= (to_rep a__first) j2) (ite (<= j2 (to_rep a__last)) true false) false))))
(assert (=> (not (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last)))) (= result3 false)))
(assert (=> (= result3 true) (= (= result2 true) (forall ((k1 Int)) (=> (and (<= (to_rep a__first) k1) (<= k1 (- i2 1))) (not (= (select a k1) true)))))))
