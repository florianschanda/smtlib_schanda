...
(assert (<= j 100))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= result8 (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) j)) (and (= (= result8 true) (and (<= j (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) j)))) 2))) (=> (< (size (mk___rep2 (us_split_fields__content2 f__split_fields7))) j) (not (= result8 true))))))
(assert (= result8 true))
