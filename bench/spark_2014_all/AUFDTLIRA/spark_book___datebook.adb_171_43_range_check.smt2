...
(define-fun dynamic_invariant ((temp___expr_257 Int) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool) (temp___do_typ_inv_256 Bool)) Bool (=> (or (= temp___is_init_253 true) (<= 0 3)) (in_range10 temp___expr_257)))
...
(define-fun dynamic_invariant1 ((temp___expr_294 Int) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool) (temp___do_typ_inv_293 Bool)) Bool (=> (or (= temp___is_init_290 true) (<= 0 128)) (in_range11 temp___expr_294)))
...
(define-fun dynamic_invariant2 ((temp___expr_333 Int) (temp___is_init_329 Bool) (temp___skip_constant_330 Bool) (temp___do_toplevel_331 Bool) (temp___do_typ_inv_332 Bool)) Bool (=> (or (= temp___is_init_329 true) (<= 1 64)) (in_range12 temp___expr_333)))
...
(declare-fun temp_____aggregate_def_433 (Int Int Int) us_t1)
...
(assert (forall ((temp___435 Int) (temp___436 Int) (temp___437 Int)) (let ((temp___434 (temp_____aggregate_def_433 temp___435 temp___436 temp___437))) (=> (dynamic_invariant4 temp___435 true true true true) (and (=> (dynamic_property 1 2147483647 temp___436 temp___437) (and (= (first3 temp___434) temp___436) (= (last3 temp___434) temp___437))) (forall ((temp___438 Int)) (= (to_rep (select (to_array1 temp___434) temp___438)) temp___435)))))))
...
(assert (= status1 3))
(assert (= (to_rep1 (first2 (rt1 (temp_____aggregate_def_433 32 (to_rep1 description__first) (to_rep1 description__last))))) (to_rep1 description__first)))
(assert (= (to_rep1 (last2 (rt1 (temp_____aggregate_def_433 32 (to_rep1 description__first) (to_rep1 description__last))))) (to_rep1 description__last)))
(assert (= (mk___t1 temp___440 temp___4401) (temp_____aggregate_def_433 32 (to_rep1 description__first) (to_rep1 description__last))))
(assert (= temp___440 temp___441))
(assert (= (mk (to_rep1 (first2 temp___4401)) (to_rep1 (last2 temp___4401))) temp___4411))
(assert (= (ite (<= (to_rep1 (first temp___4411)) (to_rep1 (last temp___4411))) (+ (- (to_rep1 (last temp___4411)) (to_rep1 (first temp___4411))) 1) 0) (ite (<= (to_rep1 description__first) (to_rep1 description__last)) (+ (- (to_rep1 description__last) (to_rep1 description__first)) 1) 0)))
(assert (= (mk___t temp___442 temp___4421) (mk___t temp___441 temp___4411)))
(assert (= o (slide temp___442 (to_rep1 (first temp___4421)) (to_rep1 description__first))))
...
(assert (<= 1 j1))
(assert (<= j1 r13b))
(assert (and (<= (to_rep8 (rec__datebook__event_record__description_size (us_split_fields7 (select event_array index2)))) (ite (<= (to_rep1 description__first) (to_rep1 description__last)) (+ (- (to_rep1 description__last) (to_rep1 description__first)) 1) 0)) (< (- j2 1) (ite (<= (to_rep1 description__first) (to_rep1 description__last)) (+ (- (to_rep1 description__last) (to_rep1 description__first)) 1) 0))))
(assert (and (=> (<= 1 r13b) (dynamic_property3 1 r13b j2)) (and (<= 1 j2) (<= j2 r13b))))
...
(assert (= o6 (ite (<= (to_rep8 (rec__datebook__event_record__description_size (us_split_fields7 (select event_array index2)))) o5) true false)))
(assert (= result5 (ite (= o6 true) true false)))
(assert (= result5 true))
