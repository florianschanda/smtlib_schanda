...
(assert (and (= (mk___rep (mk___split_fields o9 o10)) (state__2 (us_split_fields__content my_stack__split_fields5))) (= (us_split_fields__content my_stack__split_fields5) (mk___split_fields o9 o10))))
(assert (not (<= 1 o13)))
(check-sat)
(exit)
