...
(assert (not (= (length (mk___t temp___1821 temp___18211)) 0)))
(assert (=> (<= (to_rep1 (first2 temp___18221)) (to_rep1 (last2 temp___18221))) (= o6 (+ (- (to_rep1 (last2 temp___18221)) (to_rep1 (first2 temp___18221))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___18221)) (to_rep1 (last2 temp___18221)))) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___18211)) (to_rep1 (last temp___18211))) (= o7 (+ (- (to_rep1 (last temp___18211)) (to_rep1 (first temp___18211))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___18211)) (to_rep1 (last temp___18211)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___18211)) o8)))
(assert (= o10 (- o9 1)))
