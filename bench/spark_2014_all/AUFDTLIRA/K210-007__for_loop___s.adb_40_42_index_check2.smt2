...
(assert (forall ((i t10b)) (and (<= 1 (t10bqtint i)) (<= (t10bqtint i) 10))))
...
(assert (= src1 (store src index1 rliteral)))
(assert (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 index2)) (= (to_rep (select dest2 j1)) (to_rep (select src j1))))) (forall ((j1 Int)) (=> (and (<= (+ index2 1) j1) (<= j1 10)) (= (to_rep (select src2 j1)) (to_rep (select src j1)))))))
(assert (and (and (and (forall ((temp___197 Int)) (=> (and (<= 1 temp___197) (<= temp___197 10)) (=> (or (< 10 temp___197) (or (< temp___197 1) (< index2 temp___197))) (= (select dest2 temp___197) (select dest temp___197))))) (forall ((temp___199 Int)) (=> (and (<= 1 temp___199) (<= temp___199 10)) (=> (or (< 10 temp___199) (or (< temp___199 1) (< index2 temp___199))) (= (select src2 temp___199) (select src temp___199)))))) (=> (<= 1 10) (in_range3 index2))) (and (<= 1 index2) (<= index2 10))))
(assert (= (= o5 true) (forall ((j1 Int)) (=> (and (<= (+ index2 1) j1) (<= j1 10)) (= (to_rep (select src2 j1)) (to_rep (select src j1)))))))
(assert (<= 1 j))
(assert (<= j index2))
(assert (and (<= 1 j) (<= j 10)))
(assert (= o2 j))
(assert (= o3 (select src o2)))
(assert (= o4 (to_rep o3)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
