...
(assert (in_range1 i))
(assert (and (and (not (= done__ true)) (forall ((j Int)) (=> (and (<= 1 j) (<= j i)) (= (to_rep (select c j)) (to_rep (select b j)))))) (=> (< 1 i) (= (consistent b (- i 1)) true))))
(assert (or (and (and (and (= done__2 done__4) (= b2 b3)) (and (= done__5 done__2) (= b4 b2))) (and (and (= result (consistent b i)) (= (= result true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i1 1))) (and (and (not (= (to_rep (select b i1)) (to_rep (select b j)))) (not (= (- i1 j) (- (to_rep (select b i1)) (to_rep (select b j)))))) (not (= (- i1 j) (- (to_rep (select b j)) (to_rep (select b i1)))))))))))) (and (= result true) (ite (= 8 i) (and (and (= (mk_bool__ref result1) (mk_bool__ref done__)) (= done__2 (distinct 1 0))) (and (= b2 b) (= b2 b1))) (and (and (and (= o (+ i 1)) (in_range1 (+ i 1))) (and (ite (= done__3 true) (= (consistent b2 8) true) (not (= (consistent c 8) true))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- o 1))) (= (to_rep (select b2 j)) (to_rep (select b j))))))) (= done__2 done__3)))))) (and (and (and (= result (consistent b i)) (= (= result true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i1 1))) (and (and (not (= (to_rep (select b i1)) (to_rep (select b j)))) (not (= (- i1 j) (- (to_rep (select b i1)) (to_rep (select b j)))))) (not (= (- i1 j) (- (to_rep (select b j)) (to_rep (select b i1)))))))))))) (and (not (= result true)) (and (and (not (= (consistent c i) true)) (not (forall ((j Int)) (=> (and (<= i j) (<= j 8)) (= (consistent c j) true))))) (and (and (= done__2 done__) (= b2 b)) (and (= done__2 done__1) (= b2 b1)))))) (and (and (= done__2 done__4) (= b2 b3)) (and (= done__5 done__2) (= b4 b2))))))
(assert (= (mk_bool__ref done__6) (mk_bool__ref done__4)))
(assert (= (mk_map__ref b5) (mk_map__ref b3)))
(assert (= done__7 done__5))
(assert (= b6 b4))
(assert (not (= done__6 true)))
(assert (not (not (= (consistent c 8) true))))
(check-sat)
(exit)
