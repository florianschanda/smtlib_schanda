...
(assert (<= 1 i))
(assert (<= i 100))
(assert (not (and (= (rec__tree_model__path_type__k (us_split_fields7 (select m i))) true) (< n1 (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res1 i))))))))
(assert (= (rec__tree_model__path_type__k (us_split_fields7 (select m i))) true))
(assert (not (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res1 i)))) n1)))
(check-sat)
(exit)
