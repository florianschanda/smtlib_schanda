...
(assert (forall ((use_stack__stacks__top Int)) (forall ((use_stack__stacks__content (Array Int positive))) (! (=> (dynamic_invariant1 use_stack__stacks__top true true true true) (= (peek use_stack__stacks__top use_stack__stacks__content) (to_rep (select use_stack__stacks__content use_stack__stacks__top)))) :pattern ((peek use_stack__stacks__top use_stack__stacks__content))))))
(declare-const e Int)
...
(declare-const content3 (Array Int positive))
...
(assert (and (= temp___246 (+ top 1)) (in_range1 (+ top 1))))
(assert (and (= us temp___246) (dynamic_property 0 last temp___246)))
(assert (= o temp___246))
(assert (= (mk_int__ref result) (mk_int__ref top)))
(assert (= top1 o))
(assert (= (to_rep o1) e))
(assert (and (<= (to_rep1 content__first) top1) (<= top1 (to_rep1 content__last))))
(assert (= o2 top1))
...
(assert (= top3 top1))
(assert (not (= (peek top2 content2) e)))
(check-sat)
(exit)
