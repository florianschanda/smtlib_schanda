...
(assert (and (<= 1 (to_rep2 cur_piece__split_fields3)) (<= (to_rep2 cur_piece__split_fields3) 20)))
(assert (= o13 (to_rep2 cur_piece__split_fields3)))
...
(assert (and (<= 1 (+ (to_rep1 cur_piece__split_fields2) 1)) (<= (+ (to_rep1 cur_piece__split_fields2) 1) 10)))
(assert (= o16 (+ (to_rep1 cur_piece__split_fields2) 1)))
(assert (= o17 (store (select cur_board3 (+ (to_rep2 cur_piece__split_fields3) 1)) o16 o15)))
(assert (not (<= (+ (to_rep2 cur_piece__split_fields3) 1) 20)))
(check-sat)
(exit)
