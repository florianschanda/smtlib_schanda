...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o45 (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)))) (and (in_range2 o45) (= o45 (to_rep f__split_fields)))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
...
(assert (= result5 (ite (= o46 o45) true false)))
(assert (= result5 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o44 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 o44) (and (= o44 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= o44 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o44) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o44) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) d)) (= o44 j)))))))))
(assert (= result6 (ite (= v o44) true false)))
(assert (= result6 true))
...
(assert (<= i1 100))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= temp___893 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root)) (and (dynamic_invariant temp___893 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___893 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___893 root)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 root)) (ite (and (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___893 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___893 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___893 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___893 i2))) true) (not (= i2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___893 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)))) (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___893 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___893 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___893 i2))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___893 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___893 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___893 j)))) true)) (= j i2))))))))))))))
(assert (= o42 (select temp___893 i1)))
(assert (= o43 (us_split_fields1 o42)))
(assert (= result14 (rec__tree_model__path_type__k o43)))
