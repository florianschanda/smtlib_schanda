...
(assert (=> (not (= first_available1 0)) (= result13 (ite (< 0 o67) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (and (= o66 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range4 o66)))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (= result12 (ite (= o66 first_available1) true false)))))
...
(assert (=> (not (not (= first_available1 0))) (= result12 (ite (= o68 0) true false))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (and (= o64 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o64)))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (= result14 (ite (< 0 o64) true false)))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (=> (= result14 true) (and (= o63 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range4 o63))))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (=> (= result14 true) (= result11 (ite (= o63 first_allocated2) true false))))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (=> (not (= result14 true)) (= result11 false)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated2 0))) (and (= o65 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o65)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated2 0))) (= result11 (ite (= o65 0) true false)))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (=> (= result11 true) (and (= o61 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o61))))
(assert (=> (= result11 true) (= o62 (ite (<= j1 o61) true false))))
(assert (=> (= result11 true) (= result15 (ite (<= 1 j1) o62 false))))
...
(assert (= result17 (ite (in_range7 o60) true false)))
