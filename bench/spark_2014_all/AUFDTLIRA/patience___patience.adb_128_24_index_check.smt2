...
(assert (= o120 (ite (<= o119 (- (to_rep (rec__patience__state__numelts (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o114 i1))
(assert (= o115 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o114)))
(assert (= o116 (to_rep o115)))
(assert (= o121 (ite (<= (- 1) o116) true false)))
(assert (= result27 (ite (= o121 true) o120 false)))
(assert (=> (= result27 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result27 true) (= o111 i1)))
(assert (=> (= result27 true) (= o112 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o111))))
(assert (=> (= result27 true) (= o113 (to_rep o112))))
(assert (=> (= result27 true) (= result26 (ite (< o113 i1) true false))))
