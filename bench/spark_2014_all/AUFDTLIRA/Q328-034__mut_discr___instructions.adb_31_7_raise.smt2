...
(define-fun dynamic_invariant4 ((temp___expr_183 Int) (temp___is_init_179 Bool) (temp___skip_constant_180 Bool) (temp___do_toplevel_181 Bool) (temp___do_typ_inv_182 Bool)) Bool (=> (or (= temp___is_init_179 true) (<= 0 2)) (in_range3 temp___expr_183)))
(declare-const i Int)
(declare-const instructions__read__result Int)
(declare-const instructions__read__result1 Int)
(declare-const result Int)
(declare-const i1 Int)
(declare-const instructions__read__result2 Int)
(declare-const result1 Int)
(declare-const i2 Int)
(declare-const instructions__read__result3 Int)
(declare-const result2 Int)
(declare-const i3 Int)
(declare-const instructions__read__result4 Int)
(assert (dynamic_invariant word true false true true))
(assert (not (not (and (and (= result i) (= i1 0)) (and (and (not (= (bool_eq (elts (to_string (attr__ATTRIBUTE_IMAGE3 i1))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 i1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 i1))))) (elts word) (to_rep1 (first (rt word))) (to_rep1 (last (rt word)))) true)) (and (= instructions__read__result2 instructions__read__result) (= instructions__read__result2 instructions__read__result1))) (and (and (= result1 i1) (= i2 1)) (and (and (not (= (bool_eq (elts (to_string (attr__ATTRIBUTE_IMAGE3 i2))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 i2))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 i2))))) (elts word) (to_rep1 (first (rt word))) (to_rep1 (last (rt word)))) true)) (= instructions__read__result3 instructions__read__result2)) (and (and (= result2 i2) (= i3 2)) (and (not (= (bool_eq (elts (to_string (attr__ATTRIBUTE_IMAGE3 i3))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 i3))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 i3))))) (elts word) (to_rep1 (first (rt word))) (to_rep1 (last (rt word)))) true)) (= instructions__read__result4 instructions__read__result3))))))))))
(check-sat)
(exit)
