...
(assert (= result10 (ite (<= 1 j) o37 false)))
(assert (= result10 true))
(assert (and (= o41 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 o41)))
(assert (= result11 (ite (in_range7 o41) true false)))
(assert (= result11 true))
(assert (and (= o38 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o38)))
(assert (= result12 (ite (< j o38) true false)))
(assert (=> (= result12 true) (and (= o39 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (= result12 true) (and (= o40 (get (rec__list_allocator__m__t__allocated model____split_fields3) o39)) (in_range4 o40))))
(assert (=> (not (= result12 true)) (= o40 0)))
(assert (and (= temp___442 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 temp___442)))
(assert (not (<= 1 temp___442)))
(check-sat)
(exit)
