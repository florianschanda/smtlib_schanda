...
(assert (<= 1 i1))
(assert (<= i1 10))
(assert (or (and (= pos2 0) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (not (= (to_rep (select t j)) v))))) (and (= (to_rep (select t pos2)) v) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- pos2 1))) (not (= (to_rep (select t j)) v)))))))
