...
(assert (= j25 o19))
(assert (forall ((l1 Int)) (=> (and (<= a l1) (<= l1 (- j26 1))) (= (to_rep (select tab21 l1)) l1))))
(assert (=> (<= (- 2147483648) 2147483647) (in_range1 j26)))
(assert (and (= o20 (- j26 1)) (in_range1 (- j26 1))))
(assert (= o21 (ite (<= l o20) true false)))
(assert (= result23 (ite (<= a l) o21 false)))
