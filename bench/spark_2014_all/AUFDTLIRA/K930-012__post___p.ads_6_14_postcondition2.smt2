...
(assert (forall ((i index)) (and (<= (- 2147483648) (indexqtint i)) (<= (indexqtint i) 2147483647))))
...
(assert (forall ((i tarrD1)) (and (<= 1 (tarrD1qtint i)) (<= (tarrD1qtint i) 10))))
...
(assert (in_range2 j))
(assert (in_range2 k))
(assert (and (and (<= 1 j) (<= j 10)) (and (<= 1 k) (<= k 10))))
(assert (and (<= 1 j) (<= j 10)))
(assert (= o j))
...
(assert (and (<= 1 j) (<= j 10)))
(assert (= o7 j))
(assert (= o8 (store a o7 o6)))
(assert (= (mk_map__ref result1) (mk_map__ref a)))
(assert (= a1 o8))
(assert (= (to_rep o9) tmp1))
(assert (and (<= 1 k) (<= k 10)))
(assert (= o10 k))
(assert (= o11 (store a1 o10 o9)))
(assert (= a1 result2))
(assert (= a2 o11))
(assert (= tmp1 tmp2))
(assert (= a2 a3))
(assert (= tmp3 tmp1))
(assert (= a4 a2))
(assert (not (= (to_rep (select a3 j)) (to_rep (select a k)))))
(check-sat)
(exit)
