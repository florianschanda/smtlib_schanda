...
(assert (=> (not (= smallest1 current1)) (and (= (to_rep (select o9 o4)) (to_rep (select values smallest1))) (and (= (to_rep (select o9 smallest1)) (to_rep (select values o4))) (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j (to_rep values__last))) (=> (and (not (= j o4)) (not (= j smallest1))) (= (to_rep (select o9 j)) (to_rep (select values j))))))))))
(assert (=> (not (not (= smallest1 current1))) (= o9 values)))
(assert (=> (not (not (= smallest1 current1))) (= o9 values1)))
(assert (and (and (and (<= (to_rep values__first) current2) (< current2 (to_rep values__last))) (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j (- current2 1))) (<= (to_rep (select values2 j)) (to_rep (select values2 (+ j 1))))))) (forall ((j Int)) (=> (and (<= current2 j) (<= j (to_rep values__last))) (<= (to_rep (select values2 current2)) (to_rep (select values2 j)))))))
