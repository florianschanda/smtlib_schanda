...
(declare-const temp___1146 natural_index)
(declare-const temp___11461 natural_index)
(declare-const temp___11462 (Array Int character))
(declare-const temp___11463 t)
...
(assert (dynamic_predicate (mk___rep to____split_discrs (mk___split_fields rliteral (rec__bounded_dynamic_strings__sequence__content to____split_fields3)))))
(assert (= to____split_discrs (mk___split_discrs temp___1146)))
(assert (= rliteral temp___11461))
(assert (= (rec__bounded_dynamic_strings__sequence__content to____split_fields3) (mk___t temp___11462 temp___11463)))
(assert (= result3 (mk___split_fields__ref to____split_fields3)))
(assert (= to____split_fields4 (mk___split_fields temp___11461 (mk___t temp___11462 temp___11463))))
(assert (= to____split_discrs (mk___split_discrs temp___1146)))
(assert (= to____split_fields5 (mk___split_fields__ref to____split_fields4)))
(assert (= to____split_fields6 to____split_fields4))
(assert (not (= (length1 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))) 1)))
(check-sat)
(exit)
