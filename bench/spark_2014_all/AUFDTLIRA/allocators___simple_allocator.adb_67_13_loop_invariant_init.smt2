...
(define-fun dynamic_invariant1 ((temp___expr_238 Int) (temp___is_init_234 Bool) (temp___skip_constant_235 Bool) (temp___do_toplevel_236 Bool) (temp___do_typ_inv_237 Bool)) Bool (=> (or (= temp___is_init_234 true) (<= 0 1)) (in_range3 temp___expr_238)))
(define-fun dynamic_invariant2 ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 1 10000)) (in_range4 temp___expr_180)))
(assert true)
...
(define-fun dynamic_invariant3 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 2147483647)) (in_range5 temp___expr_166)))
(define-fun dynamic_invariant4 ((temp___expr_193 Int) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool) (temp___do_typ_inv_192 Bool)) Bool (=> (or (= temp___is_init_189 true) (<= 0 10000)) (in_range1 temp___expr_193)))
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range1 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
(assert (forall ((container us_rep)) (! (dynamic_invariant3 (length container) true false true true) :pattern ((length container)))))
...
(assert (forall ((left us_rep) (right us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range1 e) (= (contains left e) true)) (or (= (contains right e) true) (= e item)))))) :pattern ((included_except left right item))))))
...
(assert (<= 1 rr))
(assert (<= rr r1))
(assert (not (= (to_rep (select data2 rr)) 1)))
(check-sat)
(exit)
