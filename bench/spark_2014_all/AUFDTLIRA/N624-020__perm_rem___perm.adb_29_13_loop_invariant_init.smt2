...
(assert (=> (= result2 true) (and (= o2 ib1) (in_range3 ib1))))
(assert (=> (= result2 true) (and (= o8 (remove b o2)) (and (dynamic_invariant o8 true false true true) (and (= (invariant__ o8) true) (and (= (to_rep1 (last o4)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o2 1))) (= (to_rep (select (elts b) k)) (to_rep (select o3 k))))) (and (forall ((k Int)) (=> (and (<= (+ o2 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o3 (- k 1)))))) (forall ((k Int)) (=> (and (<= o2 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o3 k)))))))))))))
(assert (=> (= result2 true) (and (= o9 (remove a ia)) (and (dynamic_invariant o9 true false true true) (and (= (invariant__ o9) true) (and (= (to_rep1 (last o1)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o k)))))))))))))
(assert (=> (= result2 true) (and (= result1 (is_perm o9 o8)) (= (= result1 true) (or (and (= (length o9) 0) (= (length o8) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first o1)) ia1) (<= ia1 (to_rep1 (last o1)))) (exists ((ib2 Int)) (and (and (<= (to_rep1 (first o4)) ib2) (<= ib2 (to_rep1 (last o4)))) (and (= (to_rep (select o ia1)) (to_rep (select o3 ib2))) (= (is_perm (remove o9 ia1) (remove o8 ib2)) true)))))))))))
...
(assert (<= 1 kb))
(assert (<= kb ib1))
(assert (not (not (and (= (to_rep (select (elts a) ia)) (to_rep (select (elts b) kb))) (= (is_perm (remove a ia) (remove b kb)) true)))))
(check-sat)
(exit)
