...
(assert (and (= temp___2022 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)) (and (dynamic_invariant8 temp___2022 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2022 o1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___2022 o1)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 o1)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2022 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2022 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2022 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2022 i2))) true) (not (= i2 o1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___2022 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i2)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i2) (rec__tree_model__path_type__a (us_split_fields5 (select temp___2022 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___2022 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2022 i2))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2022 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___2022 i2))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___2022 j1)))) true)) (= j1 i2))))))))))))))
(assert (and (<= 1 i1) (<= i1 100)))
(assert (= o2 i1))
(assert (= o3 (select temp___2022 o2)))
