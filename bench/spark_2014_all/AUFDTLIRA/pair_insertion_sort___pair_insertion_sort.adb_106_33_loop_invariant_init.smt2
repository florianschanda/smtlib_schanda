...
(assert (=> (= result8 true) (and (and (= (is_perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t o40 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select o40 o14)) (to_rep (select a o15))) (and (= (to_rep (select o40 o15)) (to_rep (select a o14))) (forall ((z3 Int)) (=> (and (<= (to_rep a__first) z3) (<= z3 (to_rep a__last))) (=> (and (not (= z3 o14)) (not (= z3 o15))) (= (to_rep (select o40 z3)) (to_rep (select a z3))))))))) (= (to_rep a__first) 0))))
...
(assert (=> (= result8 true) (= (sorted (mk___t o41 (mk (to_rep a__first) (to_rep a__last))) 0 (- j2 1)) true)))
(assert (=> (= result8 true) (= (sorted (mk___t o41 (mk (to_rep a__first) (to_rep a__last))) (+ j2 2) (+ i1 1)) true)))
(assert (=> (= result8 true) (=> (< 0 j2) (<= (to_rep (select o41 (- j2 1))) (to_rep (select o41 (+ j2 2)))))))
(assert (=> (= result8 true) (< x2 (to_rep (select o41 (+ j2 2))))))
(assert (=> (= result8 true) (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t o41 (mk (to_rep a__first) (to_rep a__last)))) true)))
(assert (=> (= result8 true) (or (and (= (to_rep (select o41 j2)) x2) (= (to_rep (select o41 (+ j2 1))) y2)) (and (= (to_rep (select o41 j2)) y2) (= (to_rep (select o41 (+ j2 1))) x2)))))
...
(assert (=> (= result8 true) (=> (<= 0 j3) (= o18 (select o41 o17)))))
...
(assert (=> (= result8 true) (= a2 (mk_map__ref o41))))
(assert (=> (= result8 true) (= j5 j3)))
(assert (=> (= result8 true) (= a3 o41)))
...
(assert (=> (= result11 true) (and (and (= (is_perm (mk___t (map__content a4) (mk (to_rep a__first) (to_rep a__last))) (mk___t (let ((subject a4)) o42) (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select (let ((subject a4)) o42) o26)) (to_rep (select (map__content a4) o28))) (and (= (to_rep (select (let ((subject a4)) o42) o28)) (to_rep (select (map__content a4) o26))) (forall ((z3 Int)) (=> (and (<= (to_rep a__first) z3) (<= z3 (to_rep a__last))) (=> (and (not (= z3 o26)) (not (= z3 o28))) (= (to_rep (select (let ((subject a4)) o42) z3)) (to_rep (select (map__content a4) z3))))))))) (= (to_rep a__first) 0))))
(assert (=> (= result11 true) (= (to_rep a__first) 0)))
(assert (=> (= result11 true) (= a6 (mk_map__ref o42))))
(assert (=> (= result11 true) (= a7 o42)))
...
(assert (=> (= result12 true) (and (and (= (is_perm (mk___t (map__content a6) (mk (to_rep a__first) (to_rep a__last))) (mk___t (let ((subject a6)) o43) (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select (let ((subject a6)) o43) o33)) (to_rep (select (map__content a6) o34))) (and (= (to_rep (select (let ((subject a6)) o43) o34)) (to_rep (select (map__content a6) o33))) (forall ((z3 Int)) (=> (and (<= (to_rep a__first) z3) (<= z3 (to_rep a__last))) (=> (and (not (= z3 o33)) (not (= z3 o34))) (= (to_rep (select (let ((subject a6)) o43) z3)) (to_rep (select (map__content a6) z3))))))))) (= (to_rep a__first) 0))))
...
(assert (=> (= result12 true) (= (sorted (mk___t o44 (mk (to_rep a__first) (to_rep a__last))) 0 (- j8 1)) true)))
(assert (=> (= result12 true) (= (sorted (mk___t o44 (mk (to_rep a__first) (to_rep a__last))) (+ j8 1) (+ i1 1)) true)))
(assert (=> (= result12 true) (=> (< 0 j8) (<= (to_rep (select o44 (- j8 1))) (to_rep (select o44 (+ j8 1)))))))
(assert (=> (= result12 true) (< y2 (to_rep (select o44 (+ j8 1))))))
(assert (=> (= result12 true) (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t o44 (mk (to_rep a__first) (to_rep a__last)))) true)))
(assert (=> (= result12 true) (= (to_rep (select o44 j8)) y2)))
...
(assert (=> (= result12 true) (=> (<= 0 j9) (= o37 (select o44 o36)))))
...
(assert (=> (= result12 true) (= a8 (mk_map__ref o44))))
(assert (=> (= result12 true) (= j11 j9)))
(assert (=> (= result12 true) (= a9 o44)))
...
(assert (not (<= i1 (- (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0) 2))))
(check-sat)
(exit)
