...
(define-fun dynamic_property4 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range low) (and (in_range high) (=> (<= low high) (and (in_range2 low) (in_range2 high))))))
...
(define-fun dynamic_invariant4 ((temp___expr_200 us_rep) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (let ((temp___201 (rec__p__pt__x (us_split_discrs1 temp___expr_200)))) (and (dynamic_property1 1 (to_rep temp___201) (first1 (rec__p__pt__s (us_split_fields1 temp___expr_200))) (last1 (rec__p__pt__s (us_split_fields1 temp___expr_200)))) (and (= (first1 (rec__p__pt__s (us_split_fields1 temp___expr_200))) 1) (= (last1 (rec__p__pt__s (us_split_fields1 temp___expr_200))) (to_rep temp___201))))))
(assert (forall ((temp___217 Int) (temp___218 Int) (temp___219 Int)) (let ((temp___216 (temp_____aggregate_def_215 temp___217 temp___218 temp___219))) (=> (dynamic_invariant2 temp___217 true true true true) (and (=> (dynamic_property4 1 2147483647 temp___218 temp___219) (and (= (first3 temp___216) temp___218) (= (last3 temp___216) temp___219))) (forall ((temp___220 Int)) (= (to_rep1 (select (to_array1 temp___216) temp___220)) temp___217)))))))
(declare-const self__ us_rep)
(declare-const temp___229 (Array Int character))
(declare-const temp___2291 t1)
(assert (= (to_rep (first2 (rt1 (temp_____aggregate_def_215 32 1 (to_rep (rec__p__pt__x (us_split_discrs1 self__))))))) 1))
(assert (= (to_rep (last2 (rt1 (temp_____aggregate_def_215 32 1 (to_rep (rec__p__pt__x (us_split_discrs1 self__))))))) (to_rep (rec__p__pt__x (us_split_discrs1 self__)))))
(assert (= (mk___t1 temp___229 temp___2291) (temp_____aggregate_def_215 32 1 (to_rep (rec__p__pt__x (us_split_discrs1 self__))))))
(assert (not (= (ite (<= (to_rep (first2 temp___2291)) (to_rep (last2 temp___2291))) (+ (- (to_rep (last2 temp___2291)) (to_rep (first2 temp___2291))) 1) 0) (ite (<= 1 (to_rep (rec__p__pt__x (us_split_discrs1 self__)))) (+ (- (to_rep (rec__p__pt__x (us_split_discrs1 self__))) 1) 1) 0))))
(check-sat)
(exit)
