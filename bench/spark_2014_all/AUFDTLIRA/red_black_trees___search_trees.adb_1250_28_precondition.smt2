...
(assert (= result4 true))
(assert (and (= o4 (to_rep1 t_old__split_fields)) (in_range8 (to_rep1 t_old__split_fields))))
(assert (and (= temp___2126 (model__ (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o4)) (and (dynamic_invariant8 temp___2126 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2126 o4))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___2126 o4)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 o4)) (ite (and (not (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2126 (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2126 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2126 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2126 i2))) true) (not (= i2 o4))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___2126 (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i2)))) (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i2) (rec__tree_model__path_type__a (us_split_fields5 (select temp___2126 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___2126 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2126 i2))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2126 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___2126 i2))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___2126 j)))) true)) (= j i2))))))))))))))
(assert (= o5 (select temp___2126 l)))
