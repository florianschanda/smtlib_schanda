...
(declare-const temp___399 us_rep2)
...
(declare-const model____split_fields7 us_split_fields__ref1)
(declare-const r12 int__ref)
(declare-const model____split_fields8 us_split_fields2)
(declare-const r13 Int)
(define-fun model____split_fields9 () us_split_fields__ref1 (mk___split_fields__ref1 (mk___split_fields1 model____split_fields model____split_fields1)))
...
(assert (= r8 1))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= temp___400 r8)))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= temp___399 (mk___rep1 (mk___split_fields1 model____split_fields model____split_fields1)))))
(assert (=> (and (<= 1 r8) (<= r8 3)) (and (= o25 (add model____split_fields r8)) (= (is_add model____split_fields r8 o25) true))))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= o26 (mk___split_fields1 o25 model____split_fields1))))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= temp___398 (mk___rep1 o26))))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= result7 model____split_fields9)))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= model____split_fields3 (us_split_fields3 temp___398))))
(assert (=> (and (<= 1 r8) (<= r8 3)) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r9)) (= (mem (rec__list_allocator__m__t__available model____split_fields4) rr) true)))))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= (length (rec__list_allocator__m__t__allocated model____split_fields4)) 0)))
(assert (=> (and (<= 1 r8) (<= r8 3)) (and (and (= (rec__list_allocator__m__t__allocated model____split_fields4) (rec__list_allocator__m__t__allocated (us_split_fields3 temp___399))) (=> (<= 1 3) (in_range6 r9))) (and (<= 1 r9) (<= r9 3)))))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= r9 3)))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= r10 (mk_int__ref r9))))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= model____split_fields5 (mk___split_fields__ref1 model____split_fields4))))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= r11 r9)))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= model____split_fields6 model____split_fields4)))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= r12 r10)))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= model____split_fields7 model____split_fields5)))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= r13 r11)))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= model____split_fields8 model____split_fields6)))
(assert (=> (not (and (<= 1 r8) (<= r8 3))) (= r12 (mk_int__ref r8))))
(assert (=> (not (and (<= 1 r8) (<= r8 3))) (= model____split_fields7 model____split_fields9)))
(assert (=> (not (and (<= 1 r8) (<= r8 3))) (= r13 r8)))
(assert (=> (not (and (<= 1 r8) (<= r8 3))) (= model____split_fields8 model____split_fields2)))
(assert (and (= result8 (all_available (map__content data7))) (= (= result8 true) (forall ((r14 Int)) (=> (and (<= 1 r14) (<= r14 3)) (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select (map__content data7) r14)))) 0))))))
