...
(assert (= i3 (+ i2 1)))
(assert (and (= o2 i3) (in_range6 i3)))
(assert (and (= o3 (get (model__ l) o2)) (and (in_range7 o3) (= o3 (get (model__ l) o2)))))
(assert (and (= (top (mk___rep s__split_fields4)) o3) (= (let ((temp___208 (to__ (mk___rep s__split_fields3)))) (let ((temp___207 (to_but_top (mk___rep s__split_fields4)))) (bool_eq (elts temp___207) (to_rep (first (rt temp___207))) (to_rep (last (rt temp___207))) (elts temp___208) (to_rep (first (rt temp___208))) (to_rep (last (rt temp___208)))))) true)))
(declare-const j Int)
(assert (<= first2 j))
(assert (<= j i3))
(assert (not (= (to_rep (select (elts (to__ (mk___rep s__split_fields4))) j)) (get (model__ l) j))))
(check-sat)
(exit)
