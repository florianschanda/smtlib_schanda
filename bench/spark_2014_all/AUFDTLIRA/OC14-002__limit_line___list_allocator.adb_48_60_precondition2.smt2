...
(assert (=> (not (= first_available 0)) (and (= o32 (length model____split_fields)) (in_range3 o32))))
(assert (=> (not (= first_available 0)) (= result2 (ite (< 0 o32) true false))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (and (= o31 (get model____split_fields 1)) (in_range4 o31)))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (= result1 (ite (= o31 first_available) true false)))))
(assert (=> (not (= first_available 0)) (=> (not (= result2 true)) (= result1 false))))
(assert (=> (not (not (= first_available 0))) (and (= o33 (length model____split_fields)) (in_range3 o33))))
(assert (=> (not (not (= first_available 0))) (= result1 (ite (= o33 0) true false))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (and (= o29 (length model____split_fields1)) (in_range3 o29)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o29) true false)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (and (= o28 (get model____split_fields1 1)) (in_range4 o28))))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (= result (ite (= o28 first_allocated) true false))))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (not (= result3 true)) (= result false)))))
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (and (= o30 (length model____split_fields1)) (in_range3 o30)))))
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (= result (ite (= o30 0) true false)))))
...
(assert (= result4 true))
(assert (and (= o27 (get model____split_fields j)) (in_range4 o27)))
(assert (= result7 (ite (in_range6 o27) true false)))
(assert (=> (= result7 true) (and (= o23 (length model____split_fields)) (in_range3 o23))))
(assert (=> (= result7 true) (= result8 (ite (< j o23) true false))))
(assert (=> (= result7 true) (=> (= result8 true) (and (= o24 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result7 true) (=> (= result8 true) (and (= o25 (get model____split_fields o24)) (in_range4 o25)))))
(assert (=> (= result7 true) (=> (not (= result8 true)) (= o25 0))))
(assert (=> (= result7 true) (and (= temp___418 (get model____split_fields j)) (in_range4 temp___418))))
(assert (=> (= result7 true) (and (<= 1 temp___418) (<= temp___418 3))))
(assert (=> (= result7 true) (= o15 temp___418)))
(assert (=> (= result7 true) (= (mk___rep (mk___split_fields o16 o17 o18)) (select data o15))))
(assert (=> (= result7 true) (= o16 o19)))
(assert (=> (= result7 true) (= o17 o20)))
(assert (=> (= result7 true) (= o18 o21)))
(assert (=> (= result7 true) (= o22 o21)))
(assert (=> (= result7 true) (= o26 (to_rep o22))))
(assert (=> (= result7 true) (= result6 (ite (= o26 o25) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (=> (= result6 true) (=> (< 1 j) (and (= o12 (- j 1)) (in_range2 (- j 1))))))
(assert (=> (= result6 true) (=> (< 1 j) (and (= o13 (get model____split_fields o12)) (in_range4 o13)))))
(assert (=> (= result6 true) (=> (not (< 1 j)) (= o13 0))))
(assert (=> (= result6 true) (and (= temp___419 (get model____split_fields j)) (in_range4 temp___419))))
(assert (=> (= result6 true) (and (<= 1 temp___419) (<= temp___419 3))))
(assert (=> (= result6 true) (= o4 temp___419)))
...
(assert (=> (= result6 true) (= o11 o9)))
(assert (=> (= result6 true) (= o14 (to_rep o11))))
(assert (=> (= result6 true) (= result5 (ite (= o14 o13) true false))))
...
(assert (= result9 (ite (<= 1 k) o3 false)))
(assert (= result9 true))
(assert (not (= j k)))
(assert (not (<= 1 k)))
(check-sat)
