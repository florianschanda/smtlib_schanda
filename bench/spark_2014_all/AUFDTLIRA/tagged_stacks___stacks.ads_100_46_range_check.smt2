...
(assert (=> (<= (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) 100) (and (and (<= 1 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s)))) (<= (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) 100)) (and (<= 1 100) (<= 100 100)))))
(assert (= o1 (rec__stacks__stack_root__content1 (us_split_fields3 s))))
(assert (= o1 temp___559))
(assert (= (mk2 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) 100) temp___5591))
(assert (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)))
(assert (=> (<= (to_rep2 (first6 temp___5601)) (to_rep2 (last8 temp___5601))) (= o2 (+ (- (to_rep2 (last8 temp___5601)) (to_rep2 (first6 temp___5601))) 1))))
(assert (=> (not (<= (to_rep2 (first6 temp___5601)) (to_rep2 (last8 temp___5601)))) (= o2 0)))
(assert (=> (<= (to_rep2 (first4 temp___5591)) (to_rep2 (last6 temp___5591))) (= o3 (+ (- (to_rep2 (last6 temp___5591)) (to_rep2 (first4 temp___5591))) 1))))
(assert (=> (not (<= (to_rep2 (first4 temp___5591)) (to_rep2 (last6 temp___5591)))) (= o3 0)))
(assert (= o4 (+ o3 o2)))
(assert (= o5 (+ 1 o4)))
(assert (= o6 (- o5 1)))
