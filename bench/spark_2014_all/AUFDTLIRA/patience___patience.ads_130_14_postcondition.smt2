...
(declare-const patience__playgame__result1 (Array Int card1))
...
(declare-const temp___859 cardindex)
(declare-const temp___8591 (Array Int card1))
(declare-const temp___8592 cardindex)
(declare-const temp___8593 (Array Int cardindex))
(declare-const temp___8594 (Array Int (Array Int cardindex)))
(declare-const temp___8595 (Array Int cardindex))
(declare-const temp___8596 (Array Int cardindex))
(declare-const temp___8597 (Array Int cardindex))
...
(declare-const s__split_fields32 cardindex)
(declare-const s__split_fields33 (Array Int card1))
(declare-const s__split_fields34 cardindex)
(declare-const s__split_fields35 (Array Int cardindex))
(declare-const s__split_fields36 (Array Int (Array Int cardindex)))
(declare-const s__split_fields37 (Array Int cardindex))
(declare-const s__split_fields38 (Array Int cardindex))
(declare-const s__split_fields39 (Array Int cardindex))
...
(define-fun s__split_fields45 () us_split_fields (mk___split_fields s__split_fields24 s__split_fields25 s__split_fields26 s__split_fields27 s__split_fields28 s__split_fields29 s__split_fields30 s__split_fields31))
(define-fun s__split_fields46 () us_split_fields (mk___split_fields s__split_fields8 s__split_fields9 s__split_fields10 s__split_fields11 s__split_fields12 s__split_fields13 s__split_fields14 s__split_fields15))
(declare-const result10 cardindex)
(declare-const result11 (Array Int card1))
...
(assert (= s__split_fields46 (us_split_fields1 null_state)))
(assert (= (mk_int__ref result8) (mk_int__ref i)))
(assert (= i1 (to_rep2 (first (rt cards)))))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= temp___860 i1)))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (and (= temp___859 s__split_fields8) (and (= temp___8591 s__split_fields9) (and (= temp___8592 s__split_fields10) (and (= temp___8593 s__split_fields11) (and (= temp___8594 s__split_fields12) (and (= temp___8595 s__split_fields13) (and (= temp___8596 s__split_fields14) (= temp___8597 s__split_fields15))))))))))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= (to_rep s__split_fields16) (- i2 (to_rep2 (first (rt cards)))))))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= (inv (mk___rep (mk___split_fields s__split_fields16 s__split_fields17 s__split_fields18 s__split_fields19 s__split_fields20 s__split_fields21 s__split_fields22 s__split_fields23))) true)))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (and (=> (<= (to_rep2 (first (rt cards))) (to_rep2 (last (rt cards)))) (dynamic_property1 (to_rep2 (first (rt cards))) (to_rep2 (last (rt cards))) i2)) (and (<= (to_rep2 (first (rt cards))) i2) (<= i2 (to_rep2 (last (rt cards))))))))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (and (and (= (inv (mk___rep s__split_fields45)) true) (= (to_rep1 (select s__split_fields25 (to_rep s__split_fields16))) (to_rep1 (select (elts cards) i2)))) (= (to_rep s__split_fields24) (+ (to_rep s__split_fields16) 1)))))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= i2 (to_rep2 (last (rt cards))))))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= s__split_fields32 s__split_fields24)))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= s__split_fields33 s__split_fields25)))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= s__split_fields34 s__split_fields26)))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= s__split_fields35 s__split_fields27)))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= s__split_fields36 s__split_fields28)))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= s__split_fields37 s__split_fields29)))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= s__split_fields38 s__split_fields30)))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= s__split_fields39 s__split_fields31)))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= i4 i2)))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= s__split_fields40 s__split_fields45)))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= i5 i3)))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= s__split_fields41 (mk___split_fields__ref (mk___split_fields s__split_fields32 s__split_fields33 s__split_fields34 s__split_fields35 s__split_fields36 s__split_fields37 s__split_fields38 s__split_fields39)))))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= i6 i4)))
(assert (=> (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards))))) (= s__split_fields42 s__split_fields40)))
(assert (=> (not (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards)))))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards)))))) (= s__split_fields41 (mk___split_fields__ref s__split_fields46))))
(assert (=> (not (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards)))))) (= i6 i1)))
(assert (=> (not (and (<= (to_rep2 (first (rt cards))) i1) (<= i1 (to_rep2 (last (rt cards)))))) (= s__split_fields42 s__split_fields46)))
...
(assert (= patience__playgame__result8 (mk___rep (us_split_fields__content s__split_fields41))))
(assert (= patience__playgame__result11 patience__playgame__result9))
(assert (= i7 i5))
(assert (= s__split_fields43 s__split_fields41))
(assert (= patience__playgame__result12 patience__playgame__result10))
(assert (= i8 i6))
(assert (= s__split_fields44 s__split_fields42))
