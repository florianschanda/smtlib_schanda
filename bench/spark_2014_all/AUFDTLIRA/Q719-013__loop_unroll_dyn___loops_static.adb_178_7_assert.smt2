...
(define-fun loops_static__loop9__result6 () bool__ref (mk_bool__ref loops_static__loop9__result2))
(define-fun j6 () int__ref (mk_int__ref j2))
(define-fun bad6 () bool__ref (mk_bool__ref bad2))
...
(assert (not (not (and (and (= (mk_int__ref result1) (mk_int__ref i)) (= i1 1)) (and (and (and (and (and (<= (to_rep1 r__first) i1) (<= i1 (to_rep1 r__last))) (= o i1)) (= o1 (store r1 o rliteral))) (and (= r1 result2) (= r2 o1))) (and (and (not (= i1 (to_rep1 (last (rt a))))) (and (and (= loops_static__loop9__result6 (mk_bool__ref loops_static__loop9__result)) (and (= j6 (mk_int__ref j)) (= bad6 (mk_bool__ref bad)))) (and (= loops_static__loop9__result3 loops_static__loop9__result1) (and (= j3 j1) (= bad3 bad1))))) (and (forall ((j7 Int)) (=> (and (<= (to_rep1 (first (rt a))) j7) (<= j7 i1)) (= (to_rep (select r2 j7)) 0))) (and (and (= i1 result3) (= i2 2)) (and (and (and (and (and (<= (to_rep1 r__first) i2) (<= i2 (to_rep1 r__last))) (= o2 i2)) (= o3 (store r2 o2 rliteral))) (and (= r2 result4) (= r3 o3))) (and (and (not (= i2 (to_rep1 (last (rt a))))) (and (and (= (mk_bool__ref loops_static__loop9__result4) loops_static__loop9__result6) (and (= (mk_int__ref j4) j6) (= (mk_bool__ref bad4) bad6))) (and (= loops_static__loop9__result5 loops_static__loop9__result3) (and (= j5 j3) (= bad5 bad3))))) (forall ((j7 Int)) (=> (and (<= (to_rep1 (first (rt a))) j7) (<= j7 i2)) (= (to_rep (select r3 j7)) 0)))))))))))))
(check-sat)
(exit)
