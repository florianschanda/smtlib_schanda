...
(assert (= j3 1))
(assert (=> (and (<= 1 j3) (<= j3 i)) (= temp___204 j3)))
(assert (=> (and (<= 1 j3) (<= j3 i)) (= temp___202 r1)))
(assert (=> (and (<= 1 j3) (<= j3 i)) (forall ((k Int)) (=> (and (<= 1 k) (<= k (- j4 1))) (= (to_rep (select r2 k)) (to_rep (select b k)))))))
(assert (=> (and (<= 1 j3) (<= j3 i)) (and (and (forall ((temp___203 Int)) (=> (and (<= 1 temp___203) (<= temp___203 8)) (=> (or (< i temp___203) (or (< temp___203 1) (<= j4 temp___203))) (= (select r2 temp___203) (select temp___202 temp___203))))) (=> (<= 1 i) (dynamic_property 1 i j4))) (and (<= 1 j4) (<= j4 i)))))
...
(assert (= j9 (+ i 1)))
(assert (=> (and (<= (+ i 1) j9) (<= j9 8)) (= temp___209 j9)))
(assert (=> (and (<= (+ i 1) j9) (<= j9 8)) (= temp___207 r6)))
(assert (=> (and (<= (+ i 1) j9) (<= j9 8)) (forall ((k Int)) (=> (and (<= 1 k) (<= k i)) (= (to_rep (select r8 k)) (to_rep (select b k)))))))
(assert (=> (and (<= (+ i 1) j9) (<= j9 8)) (and (and (forall ((temp___208 Int)) (=> (and (<= 1 temp___208) (<= temp___208 8)) (=> (or (< 8 temp___208) (or (< temp___208 (+ i 1)) (<= j10 temp___208))) (= (select r8 temp___208) (select temp___207 temp___208))))) (=> (<= (+ i 1) 8) (dynamic_property1 (+ i 1) 8 j10))) (and (<= (+ i 1) j10) (<= j10 8)))))
