...
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o41 (size (mk___rep2 (us_split_fields__content2 f__split_fields7)))) (and (in_range3 o41) (= o41 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))))))
