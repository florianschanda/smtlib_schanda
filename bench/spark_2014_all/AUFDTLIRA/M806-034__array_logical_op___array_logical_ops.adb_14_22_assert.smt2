...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 20)) (not (= (distinct (to_rep (select (elts r1) i)) 0) true)))))
(assert (forall ((i Int)) (=> (and (<= 31 i) (<= i 40)) (not (= (distinct (to_rep (select (elts r1) i)) 0) true)))))
(declare-const i Int)
(assert (<= 21 i))
(assert (<= i 30))
(assert (not (= (distinct (to_rep (select (elts r1) i)) 0) true)))
(check-sat)
(exit)
