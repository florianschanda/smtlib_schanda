...
(define-fun temp___10822 () us_t2 (mk___t2 temp___1082 temp___10821))
(define-fun o24 () us_rep (mk___rep (mk___split_discrs o9) (mk___split_fields o10 (mk___t1 o11 o12))))
(define-fun o25 () us_t2 (mk___t2 o7 o8))
...
(assert (and (= o24 (instance (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))) 1) o25)) (and (dynamic_invariant1 o24 true false true true) (and (and (= (to_rep2 o9) (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))) 1)) (= (length2 o24) (length3 o25))) (= (let ((temp___274 (value o24))) (bool_eq (elts2 temp___274) (to_rep1 (first4 (rt2 temp___274))) (to_rep1 (last4 (rt2 temp___274))) o7 (to_rep1 (first4 o8)) (to_rep1 (last4 o8)))) true)))))
...
(assert (= bounded_dynamic_strings__Oconcat__5__result12 o24))
...
(assert (and (= o21 (length2 right)) (and (in_range4 o21) (= o21 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))))
(assert (= o22 (+ 1 o21)))
(assert (= o23 (ite (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (sequence__content bounded_dynamic_strings__Oconcat__5__result10)))) o22) true false)))
...
(assert (= o18 (+ 1 o17)))
(assert (and (= o19 (length2 (sequence__content bounded_dynamic_strings__Oconcat__5__result10))) (and (in_range4 o19) (= o19 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (sequence__content bounded_dynamic_strings__Oconcat__5__result10))))))))
(assert (= o20 (ite (= o19 o18) true false)))
(assert (and (= temp___10822 (value right)) (and (dynamic_invariant2 temp___10822 true false true true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 right))) temp___1082) (= (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))))) temp___10821)) (and (and (and (= (length3 temp___10822) (length2 right)) (= (to_rep1 (first4 temp___10821)) 1)) (= (to_rep1 (last4 temp___10821)) (length2 right))) (= (< 0 (length2 right)) (not (= (empty right) true))))))))
(assert (=> (<= (to_rep1 (first4 temp___10821)) (to_rep1 (last4 temp___10821))) (= o13 (+ (- (to_rep1 (last4 temp___10821)) (to_rep1 (first4 temp___10821))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___10821)) (to_rep1 (last4 temp___10821)))) (= o13 0)))
(assert (= o14 (+ 1 o13)))
(assert (= o15 (+ 1 o14)))
(assert (= o16 (- o15 1)))
