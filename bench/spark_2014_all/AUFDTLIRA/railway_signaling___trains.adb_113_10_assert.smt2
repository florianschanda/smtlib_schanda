...
(assert (= id1 1))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___405 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___404 prev)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___403 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___406 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___401 id1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (and (= o2 (get_previous_track cur_position id1)) (and (in_range3 o2) (= o2 (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 (rec__trains__train_position__track_end (us_split_fields3 cur_position)))))))) id1)))))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= result6 prev8)))
...
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (not (= prev2 0)) (= result7 (ite (= o5 1) true false)))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (not (not (= prev2 0))) (= result7 false))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (= result7 true) (and (= o6 prev2) (in_range5 prev2)))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (= result7 true) (and (ite (exists ((t Int)) (and (and (<= 1 t) (<= t cur_num_trains)) (= (is_previous_track (select trains1 t) o6) true))) (= (to_rep5 (select track_signals2 o6)) 1) (= (to_rep5 (select track_signals2 o6)) 0)) (forall ((other_track Int)) (=> (and (<= 1 other_track) (<= other_track 8)) (=> (not (= other_track o6)) (= (to_rep5 (select track_signals2 other_track)) (to_rep5 (select track_signals1 other_track))))))))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (not (= result7 true)) (= track_signals2 track_signals1))))
(assert (=> (and (<= 1 id1) (<= id1 3)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 8)) (and (=> (= (to_rep5 (select temp___405 j)) 2) (= (to_rep5 (select track_signals3 j)) 2)) (=> (and (= (to_rep5 (select temp___406 j)) 1) (exists ((t Int)) (and (and (<= 1 t) (<= t cur_num_trains)) (= (is_previous_track (select trains1 t) j) true)))) (= (to_rep5 (select track_signals3 j)) 1)))))))
...
(assert (forall ((train1 Int)) (=> (and (<= 1 train1) (<= train1 cur_num_trains)) (forall ((id7 Int)) (=> (and (<= 1 id7) (<= id7 3)) (and (=> (not (= (get_previous_track (select trains1 train1) id7) 0)) (let ((temp___415 (to_rep5 (select (map__content4 track_signals6) (get_previous_track (select trains1 train1) id7))))) (or (= temp___415 1) (= temp___415 2)))) (=> (not (= (get_other_previous_track (select trains1 train1) id7) 0)) (let ((temp___416 (to_rep5 (select (map__content4 track_signals6) (get_other_previous_track (select trains1 train1) id7))))) (or (= temp___416 1) (= temp___416 2))))))))))
(assert (= (previous_tracks_on_orange_or_red cur_num_trains trains1 (map__content4 track_signals6)) true))
(assert (not (= (safe_signaling cur_num_trains trains1 (map__content4 track_signals6)) true)))
(check-sat)
(exit)
