...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (<= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i))))))))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (or (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i)))) 100) (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i)))) n2)))))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields7 (select m i))) true) (< n2 (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i)))))) (< (length (rec__tree_model__path_type__a (us_split_fields7 (select m i)))) (- 100 n2)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m i))) true) (and (and (and (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i)))) n2) (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select res2 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 1)))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0)))))))))))))
...
(assert (<= 1 j))
(assert (<= j 100))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (and (= o (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0)) (and (in_range2 o) (= o (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j 0))))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (= (mk___rep5 (mk___split_fields5 o1 o2 o3)) (select res2 o))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (= o1 o4)))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (= o2 o5)))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (= o3 o6)))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (= o7 o5)))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (= o8 (to_rep o7))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (= result2 (ite (< o8 n2) true false))))
(assert (=> (not (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true)) (= result2 false)))
(assert (= result2 true))
(assert (not (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 t))) j))) true)))
(check-sat)
(exit)
