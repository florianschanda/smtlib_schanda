...
(define-fun dynamic_invariant4 ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_167)))
...
(assert true)
(assert true)
(assert (forall ((s1 us_rep)) (! (= (ite (is_empty s1) 1 0) (ite (is_empty1 us_tag s1) 1 0)) :pattern ((is_empty1 us_tag s1)))))
(assert (forall ((s1 us_rep)) (! (= (= (is_empty s1) true) (= (size s1) 0)) :pattern ((is_empty s1)))))
(assert (forall ((s1 us_rep)) (! (=> (dynamic_invariant s1 true true true true) (dynamic_invariant1 (size s1) true false true true)) :pattern ((size s1)))))
(assert (forall ((attr__tag1 Int)) (forall ((s1 us_rep)) (! (=> (dynamic_invariant s1 true true true true) (dynamic_invariant1 (size1 attr__tag1 s1) true false true true)) :pattern ((size1 attr__tag1 s1))))))
(assert (forall ((s1 us_rep)) (! (= (size s1) (size1 us_tag s1)) :pattern ((size1 us_tag s1)))))
(assert (forall ((s1 us_rep)) (! (=> (dynamic_invariant s1 true true true true) (= (size s1) (to_rep (rec__stacks__stack__top (us_split_fields1 s1))))) :pattern ((size s1)))))
(assert (dynamic_invariant s true false true true))
(assert (not (= (is_empty s) true)))
(assert (not (<= (to_rep (rec__stacks__stack__top (us_split_fields1 s))) (to_rep2 (last (rt (rec__stacks__stack__data (us_split_fields1 s))))))))
(check-sat)
(exit)
