...
(assert (not (not (= (bool_eq1 (mk___rep (mk___split_fields a__split_fields6 a__split_fields7 a__split_fields8)) (mk___rep (mk___split_fields a__split_fields a__split_fields1 a__split_fields2))) true))))
(check-sat)
(exit)
