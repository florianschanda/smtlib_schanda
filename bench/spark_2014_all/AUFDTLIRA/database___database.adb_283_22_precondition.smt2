...
(define-fun o7 () us_rep (mk___rep (mk___split_fields o o1)))
...
(assert (and (= o7 (balance account links accounts_balance)) (= o7 (rec__database__account_balance__value (us_split_fields7 (select accounts_balance account))))))
(assert (= o o2))
(assert (= o1 o3))
(assert (= o4 o3))
...
(assert (= (bool_eq (rec__database__account_rec__owner_name (us_split_fields5 (select accounts account))) 1 255 customer 1 255) true))
(assert (= (bool_eq4 (rec__database__account_rec__owner_id (us_split_fields5 (select accounts account))) 0 2 id 0 2) true))
(assert (= result1 accounts))
(assert (= accounts1 (store accounts account no_account_rec)))
(assert (not (not (= (is_available account links) true))))
(check-sat)
(exit)
