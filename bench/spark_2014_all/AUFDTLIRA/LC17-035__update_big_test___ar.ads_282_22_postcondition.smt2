...
(declare-fun temp_____aggregate_def_819 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_825 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___821 (Array Int (Array Int et1)))) (forall ((temp___822 Int)) (forall ((temp___823 (Array Int et1))) (let ((temp___820 (temp_____aggregate_def_819 temp___821 temp___822 temp___823))) (=> (dynamic_invariant1 temp___822 true true true true) (forall ((temp___824 Int)) (ite (= temp___824 temp___822) (= (select temp___820 temp___824) temp___823) (= (select temp___820 temp___824) (select temp___821 temp___824))))))))))
(assert (forall ((temp___827 (Array Int et1))) (forall ((temp___828 Int) (temp___829 Int)) (let ((temp___826 (temp_____aggregate_def_825 temp___827 temp___828 temp___829))) (=> (and (dynamic_invariant temp___828 true true true true) (dynamic_invariant2 temp___829 true true true true)) (forall ((temp___830 Int)) (ite (= temp___830 temp___828) (= (to_rep (select temp___826 temp___830)) temp___829) (= (select temp___826 temp___830) (select temp___827 temp___830)))))))))
...
(assert (in_range2 e))
(assert (= (to_rep o) e))
(assert (= o1 (store (select a i2) i1 o)))
(assert (= o2 (store a i2 o1)))
(assert (= result a))
(assert (= a1 o2))
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq1 a2 5 50 (temp_____aggregate_def_819 a i2 (temp_____aggregate_def_825 (select a i2) i1 e)) 5 50) true)))
(check-sat)
(exit)
