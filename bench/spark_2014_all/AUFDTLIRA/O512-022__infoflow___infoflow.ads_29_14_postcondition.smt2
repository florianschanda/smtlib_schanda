...
(define-fun dynamic_invariant ((temp___expr_161 Int) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool) (temp___do_typ_inv_160 Bool)) Bool (=> (or (= temp___is_init_157 true) (<= 1 10)) (in_range1 temp___expr_161)))
...
(define-fun dynamic_invariant1 ((temp___expr_168 Int) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool) (temp___do_typ_inv_167 Bool)) Bool (=> (or (= temp___is_init_164 true) (<= 0 4)) (in_range2 temp___expr_168)))
...
(assert (forall ((x flagvalue)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (<= k 10))
(assert (not (= k flag)))
(assert (not (= (to_rep (select flags2 k)) (to_rep (select flags k)))))
(check-sat)
(exit)
