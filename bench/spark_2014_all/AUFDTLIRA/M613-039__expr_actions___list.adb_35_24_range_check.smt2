...
(assert (and (= o4 (- last3 i9)) (in_range1 (- last3 i9))))
(assert (and (= o3 (to__ (mk___rep s__split_fields10))) (dynamic_invariant1 o3 true false true true)))
(assert (= o5 (to_rep (last (rt o3)))))
(assert (= result3 (ite (= o5 o4) true false)))
(assert (= result3 true))
(assert (and (= temp___518 (- last3 i9)) (in_range1 (- last3 i9))))
(assert (<= first2 temp___518))
(assert (not (<= first2 (to_rep (last (rt list__reverse_list__L_2__R20b))))))
(check-sat)
(exit)
