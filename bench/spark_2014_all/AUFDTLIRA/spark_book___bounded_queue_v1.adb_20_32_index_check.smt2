...
(assert (not (<= (to_rep (rec__bounded_queue_v1__queue_type__front (us_split_fields1 queue))) (to_rep2 (last (rt (rec__bounded_queue_v1__queue_type__items (us_split_fields1 queue))))))))
(check-sat)
(exit)
