...
(assert (and (= o21 (size (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)))) (in_range6 o21)))
(assert (= result (ite (< 0 o21) true false)))
(assert (= result true))
(assert (not (= (to_rep (select t_old__split_fields3 l)) v)))
(assert (and (= o18 (to_rep1 t_old__split_fields)) (in_range8 (to_rep1 t_old__split_fields))))
(assert (and (= temp___2136 (model__ (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o18)) (and (dynamic_invariant8 temp___2136 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2136 o18))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___2136 o18)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 o18)) (ite (and (not (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2136 (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2136 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2136 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2136 i2))) true) (not (= i2 o18))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___2136 (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i2)))) (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i2) (rec__tree_model__path_type__a (us_split_fields5 (select temp___2136 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___2136 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2136 i2))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2136 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___2136 i2))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___2136 j)))) true)) (= j i2))))))))))))))
(assert (= o19 (select temp___2136 l)))
(assert (= o20 (us_split_fields5 o19)))
(assert (= result1 (rec__tree_model__path_type__k o20)))
(assert (= result1 true))
...
(assert (= result2 true))
(assert (and (= o17 (peek (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) l d)) (and (in_range6 o17) (and (ite (not (= o17 0)) (and (= (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o17) d) (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o17) l)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j) l) (not (= (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j) l) (= (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j) d)) (= o17 j))))))))
(assert (= result3 (ite (= o17 0) true false)))
(assert (= result3 true))
(assert (<= 1 i1))
(assert (<= i1 100))
