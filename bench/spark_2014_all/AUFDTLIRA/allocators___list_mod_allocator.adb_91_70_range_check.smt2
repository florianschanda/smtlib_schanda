...
(assert (<= 1 r1))
(assert (<= r1 10000))
(assert (forall ((e1 Int)) (=> (and (in_range5 e1) (= (contains alloc1 e1) true)) (and (<= 1 e1) (<= e1 (- r2 1))))))
(assert (forall ((e1 Int)) (=> (and (in_range5 e1) (= (contains unseen1 e1) true)) (and (<= 1 e1) (<= e1 (- r2 1))))))
(assert (forall ((e1 Int)) (=> (and (<= 1 e1) (<= e1 10000)) (=> (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data e1)))) 0) (not (= (contains alloc1 e1) true))))))
(assert (forall ((e1 Int)) (=> (and (<= 1 e1) (<= e1 (- r2 1))) (ite (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data e1)))) 1) (= (contains alloc1 e1) true) (= (contains unseen1 e1) true)))))
(assert (<= (length1 alloc1) (- r2 1)))
(assert (<= (length1 unseen1) (- r2 1)))
(assert (and (=> (<= 1 10000) (in_range8 r2)) (and (<= 1 r2) (<= r2 10000))))
(assert (<= 1 e))
(assert (<= e (- r2 1)))
(assert (and (<= 1 e) (<= e 10000)))
(assert (= o e))
(assert (= (mk___rep (mk___split_fields o1 o2)) (select data o)))
(assert (= o1 o3))
(assert (= o2 o4))
(assert (= o5 o3))
(assert (= o6 (to_rep1 o5)))
(assert (= result1 (ite (= o6 1) true false)))
(assert (= result1 true))
(assert (not (in_range5 e)))
(check-sat)
(exit)
