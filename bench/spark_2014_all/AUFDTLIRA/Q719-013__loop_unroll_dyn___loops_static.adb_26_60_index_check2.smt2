...
(assert (<= 1 i2))
(assert (<= i2 2))
(assert (and (forall ((temp___430 Int)) (=> (and (<= (to_rep1 a__first) temp___430) (<= temp___430 (to_rep1 a__last))) (=> (or (< 2 temp___430) (or (< temp___430 1) (<= i3 temp___430))) (= (select a1 temp___430) (select a temp___430))))) (and (<= 1 i3) (<= i3 2))))
(assert (= j result1))
(assert (= j1 1))
(assert (<= 1 j1))
(assert (<= j1 2))
(assert (and (forall ((temp___427 Int)) (=> (and (<= (to_rep1 a__first) temp___427) (<= temp___427 (to_rep1 a__last))) (=> (not (= i3 temp___427)) (= (select a2 temp___427) (select a1 temp___427))))) (and (<= 1 j2) (<= j2 2))))
...
(assert (= o2 a3))
(assert (= o2 temp___424))
(assert (= (mk1 (to_rep1 a__first) i3) temp___4241))
(assert (= temp___424 loops_static__loop11__B_5__a_begins__assume))
(assert (= (mk (to_rep1 (first2 temp___4241)) (to_rep1 (last2 temp___4241))) loops_static__loop11__B_5__a_begins__assume1))
