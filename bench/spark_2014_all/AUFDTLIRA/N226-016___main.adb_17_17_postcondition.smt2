...
(define-fun dynamic_invariant ((temp___expr_240 Int) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool) (temp___do_typ_inv_239 Bool)) Bool (=> (or (= temp___is_init_236 true) (<= 0 1)) (in_range temp___expr_240)))
...
(assert (forall ((x id_type)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(declare-const main__with_postcondition__result Int)
(declare-const result Int)
(declare-const main__with_postcondition__result1 Int)
(declare-const main__with_postcondition__result2 Int)
(declare-const main__with_postcondition__result3 Int)
(declare-const main__with_postcondition__result4 Int)
(declare-const main__with_postcondition__result5 Int)
(declare-const result1 Int)
(assert (= (main__map__aggregate_def 1 0) map1))
(assert (in_range id))
(assert (= main__with_postcondition__result1 main__with_postcondition__result2))
(assert (= main__with_postcondition__result3 main__with_postcondition__result1))
(assert (= result main__with_postcondition__result))
(assert (= main__with_postcondition__result1 (to_rep (select map1 id))))
(assert (= (mk_int__ref main__with_postcondition__result4) (mk_int__ref main__with_postcondition__result2)))
(assert (= main__with_postcondition__result5 main__with_postcondition__result3))
(assert (= result1 main__with_postcondition__result4))
(assert (not (not (= id main__with_postcondition__result4))))
(check-sat)
(exit)
