...
(declare-const temp___279 (Array Int value))
...
(assert (= j8 i))
(assert (=> (and (<= i j8) (<= j8 1001)) (= temp___279 tmp6)))
(assert (=> (and (<= i j8) (<= j8 1001)) (= temp___278 j8)))
(assert (=> (and (<= i j8) (<= j8 1001)) (= (mk_map__ref result4) tmp16)))
(assert (=> (and (<= i j8) (<= j8 1001)) (= tmp8 (store tmp6 j8 rliteral2))))
(assert (=> (and (<= i j8) (<= j8 1001)) (forall ((k Int)) (=> (and (<= 0 k) (<= k j9)) (and (=> (< k i) (= (to_rep (select tmp9 k)) (- 23))) (=> (<= i k) (= (to_rep (select tmp9 k)) 69)))))))
(assert (=> (and (<= i j8) (<= j8 1001)) (and (and (=> (<= i 1001) (dynamic_property1 i 1001 j9)) (forall ((temp___280 Int)) (=> (and (<= 0 temp___280) (<= temp___280 1001)) (=> (or (< 1001 temp___280) (or (< temp___280 i) (< j9 temp___280))) (= (select tmp9 temp___280) (select temp___279 temp___280)))))) (and (<= i j9) (<= j9 1001)))))
