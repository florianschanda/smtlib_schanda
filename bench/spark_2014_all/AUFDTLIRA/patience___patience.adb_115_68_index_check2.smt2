...
(assert (= o106 (- o105 2)))
(assert (= o107 (ite (<= j o106) true false)))
(assert (= result25 (ite (<= 0 j) o107 false)))
(assert (= result25 true))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o109 i1))
(assert (= o110 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) o109)))
(assert (= o111 (to_rep o110)))
(assert (= o112 (- o111 1)))
(assert (= o113 (ite (<= k o112) true false)))
(assert (and (= o108 (+ j 1)) (in_range1 (+ j 1))))
(assert (= o114 (ite (<= o108 k) true false)))
(assert (= result26 (ite (= o114 true) o113 false)))
(assert (= result26 true))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o115 i1))
(assert (= temp___750 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o115)))
(assert (not (<= 0 k)))
(check-sat)
(exit)
