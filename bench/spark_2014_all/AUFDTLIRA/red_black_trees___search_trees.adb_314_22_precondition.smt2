...
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k 100)) (forall ((j26 Int)) (=> (and (<= 1 j26) (<= j26 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f v) k))) true) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f v) j26))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f v) k))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f v) j26)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f v) j26))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f v) k)))) 1)) 0) (< (to_rep (select values j26)) (to_rep (select values k))) (< (to_rep (select values k)) (to_rep (select values j26))))))))))
