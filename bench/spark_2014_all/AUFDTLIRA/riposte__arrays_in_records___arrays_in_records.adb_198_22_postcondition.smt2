...
(declare-const temp___357 index)
(declare-const temp___3571 (Array Int value))
(declare-const temp___3572 (Array Int value))
...
(declare-const temp___360 index)
(declare-const temp___3601 (Array Int value))
(declare-const temp___3602 (Array Int value))
...
(assert (= result tmp))
(assert (= tmp1 (to_rep (select a__split_fields1 i))))
(assert (= (to_rep o) (to_rep (select a__split_fields1 j))))
(assert (= o1 (store a__split_fields1 i o)))
(assert (= a__split_fields o2))
(assert (= o1 o3))
(assert (= a__split_fields2 o4))
(assert (= temp___357 o2))
(assert (= temp___3571 o3))
(assert (= temp___3572 o4))
(assert (= result1 a__split_fields))
(assert (= result2 a__split_fields1))
(assert (= result3 a__split_fields2))
(assert (= temp___357 a__split_fields3))
(assert (= temp___3571 a__split_fields4))
(assert (= temp___3572 a__split_fields5))
(assert (= (to_rep o5) tmp1))
(assert (= o6 (store a__split_fields4 j o5)))
(assert (= a__split_fields3 o7))
(assert (= o6 o8))
(assert (= a__split_fields5 o9))
(assert (= temp___360 o7))
(assert (= temp___3601 o8))
(assert (= temp___3602 o9))
(assert (= result4 a__split_fields3))
(assert (= result5 a__split_fields4))
(assert (= result6 a__split_fields5))
(assert (= temp___360 a__split_fields6))
(assert (= temp___3601 a__split_fields7))
(assert (= temp___3602 a__split_fields8))
(assert (= tmp2 tmp1))
...
(assert (not (not (= (bool_eq1 (mk___rep (mk___split_fields a__split_fields9 a__split_fields10 a__split_fields11)) (mk___rep (mk___split_fields a__split_fields a__split_fields1 a__split_fields2))) true))))
(check-sat)
(exit)
