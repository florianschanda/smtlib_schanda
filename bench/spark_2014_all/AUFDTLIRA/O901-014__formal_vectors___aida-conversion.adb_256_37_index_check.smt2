...
(assert (and (= temp___1342 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1342) (<= temp___1342 (to_rep1 (last (rt source))))))
(assert (= o12 temp___1342))
(assert (= o13 (select (elts source) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (< o14 52) true false)))
(assert (and (= temp___1341 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1341) (<= temp___1341 (to_rep1 (last (rt source))))))
(assert (= o8 temp___1341))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (= o10 54) true false)))
(assert (and (= temp___1340 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1340) (<= temp___1340 (to_rep1 (last (rt source))))))
(assert (= o4 temp___1340))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 51) true false)))
(assert (and (= temp___1339 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1339) (<= temp___1339 (to_rep1 (last (rt source))))))
(assert (= o temp___1339))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 56) true false)))
(assert (and (= temp___1338 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (not (<= temp___1338 (to_rep1 (last (rt source))))))
(check-sat)
(exit)
