...
(declare-const temp___8250 (Array Int (Array Int et1)))
(declare-const temp___82501 Bool)
...
(declare-const temp___8255 (Array Int (Array Int et1)))
(declare-const temp___82551 Bool)
...
(assert (not (= (to_rep (select (select r__split_fields6 m) n)) (to_rep (select (select r__split_fields m) n)))))
(check-sat)
(exit)
