...
(assert (=> (< j 50) (=> (< 0 e) (= o11 (temp_____aggregate_def_1142 o10 i o9)))))
(assert (=> (< j 50) (=> (< 0 e) (and (= o12 (+ j 1)) (in_range2 (+ j 1))))))
(assert (=> (< j 50) (=> (< 0 e) (= temp___4799 (temp_____aggregate_def_1127 a j (temp_____aggregate_def_1135 (select a j) i e) o12 o11)))))
...
(assert (=> (< j 50) (=> (not (= result4 true)) (=> (= e 0) (= o6 (temp_____aggregate_def_1165 o5 i 99))))))
(assert (=> (< j 50) (=> (not (= result4 true)) (=> (= e 0) (and (= o7 (+ j 1)) (in_range2 (+ j 1)))))))
(assert (=> (< j 50) (=> (not (= result4 true)) (=> (= e 0) (= temp___4804 (temp_____aggregate_def_1150 a j (temp_____aggregate_def_1158 (select a j) i e) o7 o6))))))
