...
(assert (and (and (and (and (and (= (is_empty model____split_fields1) true) (= (length1 model____split_fields1) 0)) (= (length model____split_fields) 10000)) (= (get model____split_fields 1) 1)) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 10000)) (= (get model____split_fields rr1) rr1)))) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 10000)) (= (contains model____split_fields rr1) true)))))
...
(assert (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 rr1)))) (ite (= rr1 10000) 0 (+ rr1 1))))))
(assert (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 10000)))) 0))
(assert (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 10000)) (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select data3 rr1)))) 0))))
