...
(assert (=> (not (= first_available1 0)) (and (= o45 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o45))))
(assert (=> (not (= first_available1 0)) (= result12 (ite (< 0 o45) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (and (= o44 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range4 o44)))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (= result11 (ite (= o44 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result12 true)) (= result11 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o46 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o46))))
(assert (=> (not (not (= first_available1 0))) (= result11 (ite (= o46 0) true false))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (and (= o42 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o42)))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (= result13 (ite (< 0 o42) true false)))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (= result13 true) (and (= o41 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range4 o41))))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (= result13 true) (= result10 (ite (= o41 first_allocated1) true false))))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (not (= result13 true)) (= result10 false)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated1 0))) (and (= o43 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o43)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated1 0))) (= result10 (ite (= o43 0) true false)))))
...
(assert (= result15 (ite (in_range7 o40) true false)))
