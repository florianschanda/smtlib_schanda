...
(assert (= o22 (ite (<= o21 (- (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o16 i))
(assert (= o17 (select (rec__patience__state__posstack (us_split_fields1 s)) o16)))
(assert (= o18 (to_rep o17)))
(assert (= o23 (ite (<= 0 o18) true false)))
(assert (= result2 (ite (= o23 true) o22 false)))
(assert (=> (= result2 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result2 true) (= o7 i)))
(assert (=> (= result2 true) (= o8 (select (rec__patience__state__posstack (us_split_fields1 s)) o7))))
(assert (=> (= result2 true) (= temp___438 (to_rep o8))))
(assert (=> (= result2 true) (and (<= 0 temp___438) (<= temp___438 99))))
(assert (=> (= result2 true) (= o9 temp___438)))
(assert (=> (= result2 true) (= o10 (select (rec__patience__state__stacksizes (us_split_fields1 s)) o9))))
(assert (=> (= result2 true) (= o11 (to_rep o10))))
(assert (=> (= result2 true) (= o12 (- o11 1))))
(assert (=> (= result2 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result2 true) (= o5 i)))
(assert (=> (= result2 true) (= o6 (select (rec__patience__state__posheight (us_split_fields1 s)) o5))))
(assert (=> (= result2 true) (= o13 (to_rep o6))))
(assert (=> (= result2 true) (= o14 (ite (<= o13 o12) true false))))
(assert (=> (= result2 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result2 true) (= o2 i)))
(assert (=> (= result2 true) (= o3 (select (rec__patience__state__posheight (us_split_fields1 s)) o2))))
(assert (=> (= result2 true) (= o4 (to_rep o3))))
(assert (=> (= result2 true) (= o15 (ite (<= 0 o4) true false))))
(assert (=> (= result2 true) (= result1 (ite (= o15 true) o14 false))))
