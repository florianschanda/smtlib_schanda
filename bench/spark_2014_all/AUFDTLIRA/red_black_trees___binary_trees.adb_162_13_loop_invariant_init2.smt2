...
(assert (and (= o (all_indexes Tuple0)) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (= (contains o i2) true))) (= (length1 o) 100))))
...
(assert (<= 1 j))
(assert (<= j 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields5 (select r1 j))) true))
(assert (not (= j root)))
(assert (not (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) j)))) 0))))
(check-sat)
(exit)
