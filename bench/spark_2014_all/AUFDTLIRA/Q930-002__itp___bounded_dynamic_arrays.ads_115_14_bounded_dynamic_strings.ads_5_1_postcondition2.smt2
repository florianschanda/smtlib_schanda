...
(assert (not (= (let ((temp___1117 (value source))) (let ((temp___1116 (value (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))))) (bool_eq (elts1 temp___1116) (to_rep2 (first2 (rt1 temp___1116))) (to_rep2 (last2 (rt1 temp___1116))) (elts1 temp___1117) (to_rep2 (first2 (rt1 temp___1117))) (to_rep2 (last2 (rt1 temp___1117)))))) true)))
(check-sat)
(exit)
