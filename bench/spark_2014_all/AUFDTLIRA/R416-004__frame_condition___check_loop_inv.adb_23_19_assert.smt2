...
(assert (= i2 11))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= temp___213 i2)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= temp___211 a1)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= temp___209 v1)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 v2)) (forall ((temp___212 Int)) (=> (and (<= (to_rep a__first) temp___212) (<= temp___212 (to_rep a__last))) (=> (or (< r6b temp___212) (or (< temp___212 11) (<= i3 temp___212))) (= (select a2 temp___212) (select temp___211 temp___212)))))) (=> (<= 11 r6b) (dynamic_property1 11 r6b i3))) (and (<= 11 i3) (<= i3 r6b)))))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= v2 result3)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= v3 0)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (and (<= (to_rep a__first) i3) (<= i3 (to_rep a__last)))))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= o i3)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= o1 (store a2 o rliteral1))))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= result4 a2)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= a3 o1)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= i3 r6b)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= i3 i4)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= a3 a4)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= v3 v4)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= i5 i3)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= a5 a3)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= v5 v3)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= i6 (mk_int__ref i4))))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= a6 (mk_map__ref a4))))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= (mk_int__ref v6) (mk_int__ref v4))))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= i7 i5)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= a7 a5)))
(assert (=> (and (<= 11 i2) (<= i2 r6b)) (= v7 v5)))
(assert (=> (not (and (<= 11 i2) (<= i2 r6b))) (= i6 (mk_int__ref i2))))
(assert (=> (not (and (<= 11 i2) (<= i2 r6b))) (= a6 (mk_map__ref a1))))
(assert (=> (not (and (<= 11 i2) (<= i2 r6b))) (= v1 v6)))
(assert (=> (not (and (<= 11 i2) (<= i2 r6b))) (= i7 i2)))
(assert (=> (not (and (<= 11 i2) (<= i2 r6b))) (= a7 a1)))
(assert (=> (not (and (<= 11 i2) (<= i2 r6b))) (= v7 v1)))
...
(assert (= i8 21))
(assert (=> (and (<= 21 i8) (<= i8 30)) (= temp___262 (map__content a6))))
(assert (=> (and (<= 21 i8) (<= i8 30)) (= temp___260 i8)))
(assert (=> (and (<= 21 i8) (<= i8 30)) (and (and (=> (<= 21 30) (dynamic_property2 21 30 i9)) (forall ((temp___263 Int)) (=> (and (<= (to_rep a__first) temp___263) (<= temp___263 (to_rep a__last))) (=> (or (< 30 temp___263) (or (< temp___263 21) (<= i9 temp___263))) (= (select a8 temp___263) (select temp___262 temp___263)))))) (and (<= 21 i9) (<= i9 30)))))
(assert (=> (and (<= 21 i8) (<= i8 30)) (forall ((temp___259 Int)) (ite (and (<= 21 temp___259) (<= temp___259 30)) (= (select o2 temp___259) (select (store a8 i9 rliteral2) temp___259)) (= (select o2 temp___259) (select a8 temp___259))))))
(assert (=> (and (<= 21 i8) (<= i8 30)) (= result6 (mk_map__ref a8))))
(assert (=> (and (<= 21 i8) (<= i8 30)) (= a9 o2)))
(assert (=> (and (<= 21 i8) (<= i8 30)) (= i9 30)))
(assert (=> (and (<= 21 i8) (<= i8 30)) (= i10 (mk_int__ref i9))))
(assert (=> (and (<= 21 i8) (<= i8 30)) (= a10 (mk_map__ref a9))))
(assert (=> (and (<= 21 i8) (<= i8 30)) (= i11 i9)))
(assert (=> (and (<= 21 i8) (<= i8 30)) (= a11 a9)))
(assert (=> (and (<= 21 i8) (<= i8 30)) (= i12 i10)))
(assert (=> (and (<= 21 i8) (<= i8 30)) (= a12 a10)))
(assert (=> (and (<= 21 i8) (<= i8 30)) (= i13 i11)))
(assert (=> (and (<= 21 i8) (<= i8 30)) (= a13 a11)))
(assert (=> (not (and (<= 21 i8) (<= i8 30))) (= i12 (mk_int__ref i8))))
(assert (=> (not (and (<= 21 i8) (<= i8 30))) (= a12 a6)))
(assert (=> (not (and (<= 21 i8) (<= i8 30))) (= i13 i8)))
(assert (=> (not (and (<= 21 i8) (<= i8 30))) (= a13 a7)))
...
(assert (not (= (bool_eq (map__content a12) 21 30 (temp_____aggregate_def_306 2) 21 30) true)))
(check-sat)
(exit)
