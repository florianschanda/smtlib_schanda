...
(define-fun dynamic_invariant ((temp___expr_192 Int) (temp___is_init_188 Bool) (temp___skip_constant_189 Bool) (temp___do_toplevel_190 Bool) (temp___do_typ_inv_191 Bool)) Bool (=> (or (= temp___is_init_188 true) (<= 0 255)) (in_range1 temp___expr_192)))
(declare-sort list_index 0)
(declare-fun list_indexqtint (list_index) Int)
(assert (forall ((i list_index)) (and (<= 1 (list_indexqtint i)) (<= (list_indexqtint i) 2147483647))))
...
(define-fun dynamic_invariant1 ((temp___expr_199 Int) (temp___is_init_195 Bool) (temp___skip_constant_196 Bool) (temp___do_toplevel_197 Bool) (temp___do_typ_inv_198 Bool)) Bool (=> (or (= temp___is_init_195 true) (<= 1 2147483647)) (in_range2 temp___expr_199)))
...
(declare-const temp___capacity_906 Int)
...
(assert (in_range4 temp___capacity_906))
(assert (<= 1 temp___capacity_906))
(assert (not (<= 1 1)))
(check-sat)
(exit)
