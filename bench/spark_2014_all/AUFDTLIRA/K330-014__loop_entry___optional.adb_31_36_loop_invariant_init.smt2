...
(declare-const inner3 int__ref)
(declare-const inner4 Int)
(declare-const inner5 int__ref)
(declare-const inner6 Int)
...
(assert (= inner1 1))
(assert (=> (and (<= 1 inner1) (<= inner1 2)) (= temp___623 ta10)))
(assert (=> (and (<= 1 inner1) (<= inner1 2)) (= temp___622 inner1)))
(assert (=> (and (<= 1 inner1) (<= inner1 2)) (= (to_rep2 (get temp___623 outer1 inner2)) 0)))
(assert (=> (and (<= 1 inner1) (<= inner1 2)) (and (=> (<= 1 2) (in_range8 inner2)) (and (<= 1 inner2) (<= inner2 2)))))
(assert (=> (and (<= 1 inner1) (<= inner1 2)) (= inner2 2)))
(assert (=> (and (<= 1 inner1) (<= inner1 2)) (= inner3 (mk_int__ref inner2))))
(assert (=> (and (<= 1 inner1) (<= inner1 2)) (= inner4 inner2)))
(assert (=> (and (<= 1 inner1) (<= inner1 2)) (= inner5 inner3)))
(assert (=> (and (<= 1 inner1) (<= inner1 2)) (= inner6 inner4)))
(assert (=> (not (and (<= 1 inner1) (<= inner1 2))) (= inner5 (mk_int__ref inner1))))
(assert (=> (not (and (<= 1 inner1) (<= inner1 2))) (= inner6 inner1)))
(assert (= result7 (mk_int__ref outer1)))
(assert (= outer2 2))
(assert (= result8 inner5))
(assert (= inner7 1))
(assert (<= 1 inner7))
(assert (<= inner7 2))
(assert (not (= (to_rep2 (get ta10 outer2 inner7)) 0)))
(check-sat)
(exit)
