...
(assert (not (= (length (mk___t temp___667 temp___6671)) 0)))
(assert (=> (<= 1 7) (= o14 (+ (- 7 1) 1))))
(assert (=> (not (<= 1 7)) (= o14 0)))
(assert (=> (<= (to_rep1 (first temp___6671)) (to_rep1 (last temp___6671))) (= o15 (+ (- (to_rep1 (last temp___6671)) (to_rep1 (first temp___6671))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6671)) (to_rep1 (last temp___6671)))) (= o15 0)))
(assert (= o16 (+ o15 o14)))
(assert (= o17 (+ (to_rep1 (first temp___6671)) o16)))
(assert (= o18 (- o17 1)))
