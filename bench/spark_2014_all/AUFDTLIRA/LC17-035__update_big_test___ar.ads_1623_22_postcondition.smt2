...
(declare-const temp___8759 (Array Int et1))
(declare-const temp___87591 (Array Int (Array Int et1)))
...
(declare-const temp___8764 (Array Int et1))
(declare-const temp___87641 (Array Int (Array Int et1)))
...
(assert (<= m 10))
(assert (not (= m j)))
(assert (not (= (to_rep (select (select r__split_fields7 i) m)) (to_rep (select (select r__split_fields1 i) m)))))
(check-sat)
(exit)
