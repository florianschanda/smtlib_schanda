...
(assert (<= 1 inner7))
(assert (<= inner7 2))
(assert (= (to_rep2 (get ta10 outer2 inner8)) 0))
(assert (and (=> (<= 1 2) (in_range8 inner8)) (and (<= 1 inner8) (<= inner8 2))))
(assert (not (= inner8 2)))
(assert (= result9 (mk_int__ref inner8)))
(assert (= inner9 (+ inner8 1)))
(assert (= inner10 (mk_int__ref inner9)))
(assert (= inner11 inner9))
(assert (not (= (to_rep2 (get ta10 outer2 (int__content inner10))) 0)))
(check-sat)
(exit)
