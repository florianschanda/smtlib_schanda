...
(assert (=> (< 0 e) (= o7 (temp_____aggregate_def_1142 o6 i o5))))
(assert (=> (< 0 e) (and (= o8 (+ j 1)) (in_range2 (+ j 1)))))
(assert (=> (< 0 e) (= temp___4799 (temp_____aggregate_def_1127 a j (temp_____aggregate_def_1135 (select a j) i e) o8 o7))))
