...
(assert (and (= temp___292 (remove (mk___t values2 (mk 1 100)) o48)) (and (dynamic_invariant3 temp___292 true false true true) (and (= (invariant__ temp___292) true) (and (= (to_rep1 (last (rt temp___292))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o48 1))) (= (to_rep (select values2 k)) (to_rep (select (elts temp___292) k))))) (and (forall ((k Int)) (=> (and (<= (+ o48 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts temp___292) (- k 1)))))) (forall ((k Int)) (=> (and (<= o48 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts temp___292) k))))))))))))
(assert (and (<= (to_rep1 (first (rt temp___292))) (- x 1)) (<= (- x 1) (to_rep1 (last (rt temp___292))))))
(assert (= o49 (- x 1)))
(assert (= o50 (select (elts temp___292) o49)))
