...
(assert (= (frame_left (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) a2) true))
(assert (and (and (and (and (=> (<= 0 2147483647) (in_range2 c239b2)) (forall ((temp___306 Int)) (=> (and (<= (to_rep1 a__first) temp___306) (<= temp___306 (to_rep1 a__last))) (and (= (rec__frame_condition__cell__value (us_split_fields1 (select a2 temp___306))) (rec__frame_condition__cell__value (us_split_fields1 (select a temp___306)))) (= (rec__frame_condition__cell__max_right (us_split_fields1 (select a2 temp___306))) (rec__frame_condition__cell__max_right (us_split_fields1 (select a temp___306)))))))) (=> (<= 1 2147483647) (in_range3 k2))) (=> (<= 1 2147483647) (in_range3 c238b2))) (=> (<= 0 2147483647) (in_range2 max3))))
(assert (= (= o27 true) (forall ((i1 Int)) (=> (and (<= k2 i1) (<= i1 first3)) (forall ((j1 Int)) (=> (and (<= i1 j1) (<= j1 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 j1)))) (get_max_left i1 a2))))))))
(assert (<= first3 i))
(assert (<= i k2))
(assert (<= i j))
(assert (<= j k2))
(assert (not (in_range3 j)))
(check-sat)
(exit)
