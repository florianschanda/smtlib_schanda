...
(assert (=> (< 0 e) (= o10 (+ k 1))))
(assert (=> (< 0 e) (= temp___5420 (select a o10))))
(assert (=> (< 0 e) (= o12 (select temp___5420 j))))
(assert (=> (< 0 e) (= o13 (temp_____aggregate_def_1734 o12 i o11))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o9 (+ k 1))))
(assert (=> (< 0 e) (= o14 (select a o9))))
(assert (=> (< 0 e) (= o15 (temp_____aggregate_def_1727 o14 j o13))))
(assert (=> (< 0 e) (and (= o16 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5421 (temp_____aggregate_def_1704 a k (temp_____aggregate_def_1712 (select a k) j (temp_____aggregate_def_1719 (select (select a k) j) i e)) o16 o15))))
...
(assert (= o6 (+ k 1)))
(assert (= temp___5430 (select a o6)))
(assert (= o7 (select temp___5430 j)))
(assert (= o8 (temp_____aggregate_def_1773 o7 i 99)))
(assert (not (<= (+ k 1) 16)))
(check-sat)
(exit)
