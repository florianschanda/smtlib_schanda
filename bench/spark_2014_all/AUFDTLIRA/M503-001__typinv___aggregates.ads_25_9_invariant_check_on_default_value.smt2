...
(declare-const temp___191 (Array Int t))
(declare-const temp___1911 t1)
(assert (dynamic_property 1 2 (to_rep1 (first temp___1911)) (to_rep1 (last temp___1911))))
(assert (forall ((temp___193 Int)) (=> (and (<= (to_rep1 (first temp___1911)) temp___193) (<= temp___193 (to_rep1 (last temp___1911)))) (= (to_rep (select temp___191 temp___193)) 42))))
(declare-const temp___195 Int)
(assert (<= (to_rep1 (first temp___1911)) temp___195))
(assert (<= temp___195 (to_rep1 (last temp___1911))))
(assert (not (type_invariant (to_rep (select temp___191 temp___195)))))
(check-sat)
(exit)
