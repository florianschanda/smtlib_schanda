...
(declare-fun temp_____aggregate_def_247 (Int) (Array Int integer))
...
(assert (forall ((temp___249 Int)) (=> (dynamic_invariant temp___249 true true true true) (forall ((temp___250 Int)) (= (select (temp_____aggregate_def_247 temp___249) temp___250) rliteral)))))
...
(assert (forall ((s us_rep)) (! (let ((result (to__ s))) (and (and (= (first1 result) 1) (<= 0 (last1 result))) (dynamic_invariant2 result true false true true))) :pattern ((to__ s)))))
...
(declare-const e__split_fields r1)
(declare-const e__split_fields1 (Array Int integer))
(declare-const stack__empty_stack__result r1)
(declare-const stack__empty_stack__result1 (Array Int integer))
(declare-const result r1)
(declare-const result1 (Array Int integer))
(declare-const e__split_fields2 r1)
(declare-const e__split_fields3 (Array Int integer))
(declare-const result2 r1)
(declare-const result3 (Array Int integer))
(declare-const e__split_fields4 r1)
(declare-const e__split_fields5 (Array Int integer))
(declare-const result4 r1)
(declare-const result5 (Array Int integer))
(declare-const stack__empty_stack__result2 r1)
(declare-const stack__empty_stack__result3 (Array Int integer))
(declare-const stack__empty_stack__result4 r1)
(declare-const stack__empty_stack__result5 (Array Int integer))
(declare-const stack__empty_stack__result6 r1)
(declare-const stack__empty_stack__result7 (Array Int integer))
(declare-const e__split_fields6 us_split_fields__ref)
(declare-const stack__empty_stack__result8 stack__ref)
(declare-const e__split_fields7 us_split_fields)
(declare-const stack__empty_stack__result9 us_rep)
(define-fun stack__empty_stack__result10 () us_rep (mk___rep (mk___split_fields stack__empty_stack__result6 stack__empty_stack__result7)))
(define-fun e__split_fields8 () us_split_fields (mk___split_fields e__split_fields4 e__split_fields5))
(declare-const result6 r1)
(declare-const result7 (Array Int integer))
(assert (= result e__split_fields))
(assert (= result1 e__split_fields1))
(assert (= rliteral1 e__split_fields2))
(assert (= e__split_fields1 e__split_fields3))
(assert (= result2 e__split_fields2))
(assert (= result3 e__split_fields3))
(assert (= e__split_fields2 e__split_fields4))
(assert (= (temp_____aggregate_def_247 0) e__split_fields5))
...
(assert (= stack__empty_stack__result10 (mk___rep (mk___split_fields stack__empty_stack__result2 stack__empty_stack__result3))))
...
(assert (= stack__empty_stack__result8 (mk_stack__ref (mk___rep (mk___split_fields stack__empty_stack__result4 stack__empty_stack__result5)))))
(assert (= e__split_fields6 (mk___split_fields__ref e__split_fields8)))
(assert (= stack__empty_stack__result9 stack__empty_stack__result10))
(assert (= e__split_fields7 e__split_fields8))
(assert (= (mk___rep (mk___split_fields result6 result7)) (stack__content stack__empty_stack__result8)))
(assert (not (= (is_empty (stack__content stack__empty_stack__result8)) true)))
(check-sat)
(exit)
