...
(assert (not (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o) l))) true)))
(check-sat)
(exit)
