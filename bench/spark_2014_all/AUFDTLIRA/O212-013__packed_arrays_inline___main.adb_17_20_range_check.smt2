...
(define-fun dynamic_invariant1 ((temp___expr_319 us_rep) (temp___is_init_315 Bool) (temp___skip_constant_316 Bool) (temp___do_toplevel_317 Bool) (temp___do_typ_inv_318 Bool)) Bool (let ((temp___320 (rec__main__discr_type__discr (us_split_discrs1 temp___expr_319)))) (and (dynamic_property1 0 (to_rep temp___320) (first1 (rec__main__discr_type__m_array (us_split_fields1 temp___expr_319))) (last1 (rec__main__discr_type__m_array (us_split_fields1 temp___expr_319)))) (and (= (first1 (rec__main__discr_type__m_array (us_split_fields1 temp___expr_319))) 0) (= (last1 (rec__main__discr_type__m_array (us_split_fields1 temp___expr_319))) (to_rep temp___320))))))
(declare-sort tT9bP1 0)
(declare-fun tT9bP1qtint (tT9bP1) Int)
(assert (forall ((i tT9bP1)) (and (<= 0 (tT9bP1qtint i)) (<= (tT9bP1qtint i) 15))))
...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___156 (rec__main__discr_type__m_array (us_split_fields1 r)))) (to_array temp___156)))))
...
(define-fun dynamic_invariant2 ((temp___expr_338 us_rep1) (temp___is_init_334 Bool) (temp___skip_constant_335 Bool) (temp___do_toplevel_336 Bool) (temp___do_typ_inv_337 Bool)) Bool (=> (not (= temp___skip_constant_335 true)) (in_range4 15 (to_base temp___expr_338))))
(define-fun default_initial_assumption ((temp___expr_341 us_rep1) (temp___skip_top_level_342 Bool)) Bool (= (to_rep (rec__main__discr_type__discr (us_split_discrs2 temp___expr_341))) 15))
...
(declare-const temp___discr_347 Int)
(assert (in_range1 temp___discr_347))
