...
(define-fun dynamic_invariant ((temp___expr_302 us_t) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool) (temp___do_typ_inv_301 Bool)) Bool (and (=> (not (= temp___skip_constant_299 true)) (dynamic_property 1 2147483647 (first1 temp___expr_302) (last1 temp___expr_302))) (=> (= temp___do_toplevel_300 true) (=> (= temp___is_init_298 true) (and (let ((temp___304 (of_array1 (to_array temp___expr_302) (first1 temp___expr_302) (last1 temp___expr_302)))) (and (= (first3 temp___304) 1) (<= 0 (last3 temp___304)))) (<= (last1 temp___expr_302) 1000))))))
(define-fun dynamic_predicate ((temp___306 us_t)) Bool (and (let ((temp___308 (of_array1 (to_array temp___306) (first1 temp___306) (last1 temp___306)))) (and (= (first3 temp___308) 1) (<= 0 (last3 temp___308)))) (<= (last1 temp___306) 1000)))
...
(assert (dynamic_invariant i17s true false false true))
(assert (not (dynamic_property1 1 2147483647 (to_rep1 (first (rt i17s))) (to_rep1 (last (rt i17s))))))
(check-sat)
(exit)
