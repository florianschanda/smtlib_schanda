...
(assert (= (mk___rep2 (mk___split_fields2 o23 o24)) (select temp___1176 j)))
(assert (= o23 o25))
(assert (= o24 o26))
(assert (= result4 o26))
...
(assert (=> (= result4 true) (= (mk___rep2 (mk___split_fields2 o18 o19)) (select temp___1178 j))))
...
(assert (=> (= result4 true) (= (mk___rep2 (mk___split_fields2 o13 o14)) (select temp___1177 i))))
...
(assert (= o11 (+ o10 n2)))
(assert (and (= o12 o11) (in_range8 o11)))
