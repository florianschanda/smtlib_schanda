...
(define-fun dynamic_invariant1 ((temp___expr_175 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool) (temp___do_typ_inv_174 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 1 100)) (in_range2 temp___expr_175)))
(define-fun dynamic_invariant2 ((temp___expr_189 Int) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (or (= temp___is_init_185 true) (<= 0 2)) (in_range1 temp___expr_189)))
(declare-const temp___614 extended_index_type)
(declare-const temp___6141 (Array Int us_rep))
(assert (and (= (to_rep temp___614) 0) (default_initial_assumption1 temp___6141 false)))
(assert (not (= (tree_structure (mk___rep1 (mk___split_fields1 temp___614 temp___6141))) true)))
(check-sat)
(exit)
