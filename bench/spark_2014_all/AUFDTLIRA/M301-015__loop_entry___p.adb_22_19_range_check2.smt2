...
(assert (and (and (forall ((temp___312 Int)) (=> (and (<= 1 temp___312) (<= temp___312 3)) (ite (not (= i32 temp___312)) (= (select x3 temp___312) (select x2 temp___312)) (forall ((temp___313 Int) (temp___314 Int)) (=> (and (and (<= 1 temp___313) (<= temp___313 3)) (and (<= 1 temp___314) (<= temp___314 3))) (=> (or (< 3 temp___313) (or (< temp___313 1) (<= i212 temp___313))) (= (get (select x3 temp___312) temp___313 temp___314) (get (select x2 temp___312) temp___313 temp___314)))))))) (=> (<= 1 3) (in_range2 i212))) (and (<= 1 i212) (<= i212 3))))
(assert (= i22 result3))
(assert (= i221 1))
(assert (<= 1 i221))
(assert (<= i221 3))
...
(assert (and (and (forall ((temp___293 Int)) (=> (and (<= 1 temp___293) (<= temp___293 3)) (ite (not (= i32 temp___293)) (= (select x4 temp___293) (select x3 temp___293)) (forall ((temp___294 Int) (temp___295 Int)) (=> (and (and (<= 1 temp___294) (<= temp___294 3)) (and (<= 1 temp___295) (<= temp___295 3))) (=> (or (< 3 temp___295) (or (< temp___295 1) (or (<= i222 temp___295) (not (= i212 temp___294))))) (= (get (select x4 temp___293) temp___294 temp___295) (get (select x3 temp___293) temp___294 temp___295)))))))) (=> (<= 1 3) (in_range2 i222))) (and (<= 1 i222) (<= i222 3))))
(assert (= i1 result4))
(assert (= i11 1))
(assert (<= 1 i11))
(assert (<= i11 3))
(assert (= x4 result5))
(assert (= x5 (store x4 i32 (set (select x4 i32) i212 i222 (store (get (select x4 i32) i212 i222) i11 rliteral1)))))
(assert (= (bool_eq2 x6 (to_rep (first12 (mk6 (+ i32 1) 3))) (to_rep (last12 (mk6 (+ i32 1) 3))) x4 (to_rep (first14 (mk7 (+ i32 1) 3))) (to_rep (last14 (mk7 (+ i32 1) 3)))) true))
(assert (and (and (forall ((temp___274 Int)) (=> (and (<= 1 temp___274) (<= temp___274 3)) (ite (not (= i32 temp___274)) (= (select x6 temp___274) (select x4 temp___274)) (forall ((temp___275 Int) (temp___276 Int)) (=> (and (and (<= 1 temp___275) (<= temp___275 3)) (and (<= 1 temp___276) (<= temp___276 3))) (ite (or (not (= i222 temp___276)) (not (= i212 temp___275))) (= (get (select x6 temp___274) temp___275 temp___276) (get (select x4 temp___274) temp___275 temp___276)) (forall ((temp___277 Int)) (=> (and (<= 1 temp___277) (<= temp___277 3)) (=> (or (< 3 temp___277) (or (< temp___277 1) (< i12 temp___277))) (= (select (get (select x6 temp___274) temp___275 temp___276) temp___277) (select (get (select x4 temp___274) temp___275 temp___276) temp___277))))))))))) (=> (<= 1 3) (in_range2 i12))) (and (<= 1 i12) (<= i12 3))))
(assert (=> (<= (+ i32 1) 3) (and (and (<= 1 (+ i32 1)) (<= (+ i32 1) 3)) (and (<= 1 3) (<= 3 3)))))
(assert (= o x4))
(assert (= temp___285 o))
(assert (= temp___2851 (mk7 (+ i32 1) 3)))
(assert (<= (+ i32 1) 3))
(assert (not (<= 1 (+ i32 1))))
(check-sat)
(exit)
