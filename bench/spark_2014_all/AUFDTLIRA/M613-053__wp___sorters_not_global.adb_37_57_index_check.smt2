...
(assert (=> (and (<= (+ starting_at 1) index1) (<= index1 limit)) (and (and (and (= limit temp___203) (<= starting_at min2)) (<= min2 limit)) (forall ((j1 Int)) (=> (and (<= starting_at j1) (<= j1 (- index2 1))) (<= (to_rep (select values min2)) (to_rep (select values j1))))))))
