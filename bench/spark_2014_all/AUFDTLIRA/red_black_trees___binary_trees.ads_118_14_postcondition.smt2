...
(assert (=> (and (<= 1 n1) (<= n1 100)) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f t1) i))) true) (< (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f t1) i)))) n2)) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f t2) i))) true)))))))
...
(assert (<= 1 i))
(assert (<= i 100))
(assert (not (or (not (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f t1) i))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f t2) i))) true)))))
(check-sat)
(exit)
