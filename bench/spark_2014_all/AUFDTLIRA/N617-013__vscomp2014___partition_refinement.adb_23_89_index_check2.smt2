...
(declare-const o9 (Array Int partition_index))
(declare-const j1 Int)
(declare-const o10 Int)
(declare-const o11 Bool)
(declare-const o12 Int)
(declare-const o13 partition_index)
...
(assert (<= 0 j2))
(assert (<= j2 r1b))
(assert (and (=> (<= 0 10000) (in_range6 p_prime_index1)) (and (<= 0 j3) (<= j3 r1b))))
(assert (and (= temp___5433 (get (model__ (mk___rep p__split_discrs (mk___split_fields p__split_fields))) j3)) (= (bool_eq temp___5433 (get (model__ (mk___rep p__split_discrs (mk___split_fields p__split_fields))) j3)) true)))
...
(assert (= p_prime_index2 o7))
(assert (= (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields3)) r3b))
(assert (in_range3 r3b))
(assert (= (to_rep2 (rec__partition_refinement__interval__last p_prime__split_fields3)) r4b))
(assert (in_range3 r4b))
(assert (= result6 (mk_int__ref i)))
(assert (= i1 r3b))
(assert (<= r3b i1))
(assert (<= i1 r4b))
(assert (= (to_rep3 o8) p_prime_index2))
(assert (= o9 (store f i1 o8)))
(assert (= result7 (mk_map__ref f)))
(assert (= f1 o9))
(assert (forall ((j4 Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields3)) j4) (<= j4 i2)) (= (to_rep3 (select f2 j4)) p_prime_index2))))
(assert (forall ((j4 Int)) (=> (and (<= 0 j4) (<= j4 (- (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields3)) 1))) (= (to_rep3 (select f2 j4)) (to_rep3 (select f j4))))))
(assert (forall ((j4 Int)) (=> (and (<= (+ i2 1) j4) (<= j4 5)) (= (to_rep3 (select f2 j4)) (to_rep3 (select f j4))))))
(assert (and (and (=> (<= r3b r4b) (dynamic_property r3b r4b i2)) (forall ((temp___549 Int)) (=> (and (<= 0 temp___549) (<= temp___549 5)) (=> (or (< r4b temp___549) (or (< temp___549 r3b) (< i2 temp___549))) (= (select f2 temp___549) (select f temp___549)))))) (and (<= r3b i2) (<= i2 r4b))))
(assert (and (= o10 (+ i2 1)) (in_range4 (+ i2 1))))
(assert (= o11 (ite (<= o10 j1) true false)))
(assert (= result8 (ite (= o11 true) (ite (<= j1 5) true false) false)))
(assert (= result8 true))
(assert (and (<= 0 j1) (<= j1 5)))
(assert (= o12 j1))
(assert (= o13 (select f o12)))
(assert (= o14 (to_rep3 o13)))
(assert (not (<= 0 j1)))
(check-sat)
(exit)
