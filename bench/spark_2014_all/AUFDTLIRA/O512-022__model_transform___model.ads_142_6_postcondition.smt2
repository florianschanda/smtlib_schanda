...
(assert (forall ((x uml_action_access)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_286 Int) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool) (temp___do_typ_inv_285 Bool)) Bool (=> (or (= temp___is_init_282 true) (<= 0 100)) (in_range2 temp___expr_286)))
...
(assert (not (= (bool_eq3 (owned_flow (mk___rep2 (mk___split_fields2 self__split_fields4 self__split_fields5))) 0 100 (owned_flow (mk___rep2 (mk___split_fields2 self__split_fields self__split_fields1))) 0 100) true)))
(check-sat)
(exit)
