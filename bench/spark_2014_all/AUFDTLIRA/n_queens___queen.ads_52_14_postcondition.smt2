...
(assert (=> (and (<= 1 r1) (<= r1 8)) (and (and (not (= done__2 true)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i 1))) (= (to_rep (select b2 j)) (to_rep (select temp___218 j)))))) (=> (< (to_rep (select c i)) r2) (not (= (consistent c 8) true))))))
...
(assert (=> (and (<= 1 r1) (<= r1 8)) (=> (= (to_rep (select c i)) r2) (and (ite (= done__3 true) (= (consistent b4 8) true) (not (= (consistent c 8) true))) (forall ((j Int)) (=> (and (<= 1 j) (<= j i)) (= (to_rep (select b4 j)) (to_rep (select b3 j)))))))))
(assert (=> (and (<= 1 r1) (<= r1 8)) (=> (not (= (to_rep (select c i)) r2)) (and (= o2 (copy_until b3 i c)) (forall ((j Int)) (=> (and (<= 1 j) (<= j i)) (= (to_rep (select o2 j)) (to_rep (select b3 j)))))))))
(assert (=> (and (<= 1 r1) (<= r1 8)) (=> (not (= (to_rep (select c i)) r2)) (and (ite (= done__4 true) (= (consistent b5 8) true) (not (= (consistent o2 8) true))) (forall ((j Int)) (=> (and (<= 1 j) (<= j i)) (= (to_rep (select b5 j)) (to_rep (select b3 j)))))))))
