...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o9 i))
(assert (= o10 (select (rec__patience__state__posstack (us_split_fields1 s)) o9)))
(assert (= o11 (to_rep o10)))
(assert (= o12 (ite (<= o11 (- (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o6 i))
(assert (= o7 (select (rec__patience__state__posstack (us_split_fields1 s)) o6)))
(assert (= o8 (to_rep o7)))
(assert (= o13 (ite (<= 0 o8) true false)))
(assert (= result1 (ite (= o13 true) o12 false)))
(assert (= result1 true))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o i))
(assert (= o1 (select (rec__patience__state__posstack (us_split_fields1 s)) o)))
(assert (= temp___438 (to_rep o1)))
(assert (and (<= 0 temp___438) (<= temp___438 99)))
(assert (= o2 temp___438))
(assert (= o3 (select (rec__patience__state__stacksizes (us_split_fields1 s)) o2)))
(assert (= o4 (to_rep o3)))
(assert (= o5 (- o4 1)))
(assert (not (<= 0 i)))
(check-sat)
