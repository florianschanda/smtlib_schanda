...
(define-fun dynamic_invariant1 ((temp___expr_241 Int) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool) (temp___do_typ_inv_240 Bool)) Bool (=> (or (= temp___is_init_237 true) (<= 0 200000)) (in_range1 temp___expr_241)))
...
(assert (= links6 (store links5 account (mk___rep (mk___split_fields (distinct 1 0) (rec__database__availability__account_link__prev (us_split_fields1 (select links5 account))) (rec__database__availability__account_link__next (us_split_fields1 (select links5 account))))))))
...
(assert (<= 1 act))
(assert (<= act 200000))
(assert (not (= act account)))
(assert (= (rec__database__availability__account_link__available (us_split_fields1 (select (map__content links7) act))) true))
