...
(assert (and (= o24 (remove b ib1)) (and (dynamic_invariant o24 true false true true) (and (= (invariant__ o24) true) (and (= (to_rep1 (last o19)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts b) k)) (to_rep (select o18 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o18 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o18 k))))))))))))
(assert (and (= o23 (remove o24 o20)) (and (dynamic_invariant o23 true false true true) (and (= (invariant__ o23) true) (and (= (to_rep1 (last o22)) (- (to_rep1 (last o19)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o20 1))) (= (to_rep (select o18 k)) (to_rep (select o21 k))))) (and (forall ((k Int)) (=> (and (<= (+ o20 1) k) (<= k (to_rep1 (last o19)))) (= (to_rep (select o18 k)) (to_rep (select o21 (- k 1)))))) (forall ((k Int)) (=> (and (<= o20 k) (<= k (- (to_rep1 (last o19)) 1))) (= (to_rep (select o18 (+ k 1))) (to_rep (select o21 k))))))))))))
