...
(assert (and (= o27 (state__2 (us_split_fields__content my_stack__split_fields4))) (= o27 (mk___rep (us_split_fields__content my_stack__split_fields4)))))
(assert (and (= o28 (count o27)) (and (in_range2 o28) (= o28 (to_rep1 (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 o27)))))))
(assert (= o29 (- o28 2)))
(assert (= o30 (ite (<= i o29) true false)))
(assert (= result3 (ite (<= 1 i) o30 false)))
(assert (= (= o31 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (count (state__2 (us_split_fields__content my_stack__split_fields4))) 2))) (= (stack_entry (state__2 (us_split_fields__content my_stack__split_fields4)) i1) (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) i1))))))
(assert (and (= o32 (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o23 o24))))
(assert (and (= o25 (count o32)) (and (in_range2 o25) (= o25 (to_rep1 o24)))))
...
(assert (and (= o33 (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o18 o19))))
(assert (and (= o20 (count o33)) (and (in_range2 o20) (= o20 (to_rep1 o19)))))
(assert (= o21 (- o20 1)))
