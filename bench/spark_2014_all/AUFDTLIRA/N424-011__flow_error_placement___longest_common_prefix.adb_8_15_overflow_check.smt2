...
(assert (and (= o7 (+ x l)) (in_range1 (+ x l))))
(assert (= result2 (ite (<= o7 1000) true false)))
(assert (=> (= result2 true) (and (= o6 (+ y l)) (in_range1 (+ y l)))))
(assert (=> (= result2 true) (= result1 (ite (<= o6 1000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= temp___178 (+ y l)) (in_range1 (+ y l)))))
(assert (=> (= result1 true) (and (<= 1 temp___178) (<= temp___178 1000))))
(assert (=> (= result1 true) (= o2 temp___178)))
(assert (=> (= result1 true) (= o3 (select a o2))))
(assert (=> (= result1 true) (= o4 (to_rep o3))))
(assert (=> (= result1 true) (and (= temp___177 (+ x l)) (in_range1 (+ x l)))))
(assert (=> (= result1 true) (and (<= 1 temp___177) (<= temp___177 1000))))
(assert (=> (= result1 true) (= o temp___177)))
(assert (=> (= result1 true) (= o1 (select a o))))
(assert (=> (= result1 true) (= o5 (to_rep o1))))
(assert (=> (= result1 true) (= result (ite (= o5 o4) true false))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (and (=> (<= 0 2147483647) (in_range2 l1)) (and (and (<= (+ x l1) 1000) (<= (+ y l1) 1000)) (= (to_rep (select a (+ x l1))) (to_rep (select a (+ y l1)))))))
