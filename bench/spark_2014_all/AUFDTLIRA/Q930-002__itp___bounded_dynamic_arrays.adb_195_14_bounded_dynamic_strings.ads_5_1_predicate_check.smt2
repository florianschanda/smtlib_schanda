...
(assert (< (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8))
(assert (= (to_rep1 o9) last8))
(assert (= o9 o10))
(assert (= (rec__bounded_dynamic_strings__sequence__content this__split_fields3) (mk___t o11 o12)))
(assert (= this__split_discrs (mk___split_discrs temp___1259)))
(assert (= temp___12591 o10))
(assert (= temp___12592 o11))
(assert (= temp___12593 o12))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___1259) (mk___split_fields temp___12591 (mk___t temp___12592 temp___12593))))))
(check-sat)
(exit)
