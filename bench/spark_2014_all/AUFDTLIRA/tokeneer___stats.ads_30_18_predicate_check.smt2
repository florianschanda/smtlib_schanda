...
(define-fun dynamic_invariant1 ((temp___expr_368 Int) (temp___is_init_364 Bool) (temp___skip_constant_365 Bool) (temp___do_toplevel_366 Bool) (temp___do_typ_inv_367 Bool)) Bool (=> (or (= temp___is_init_364 true) (<= 0 2147483647)) (in_range3 temp___expr_368)))
(declare-const x Int)
...
(declare-const temp___388 (Array Int character))
(declare-const temp___3881 t1)
(assert (in_range3 x))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___388))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___3881))
(assert (not (dynamic_predicate (mk___t1 temp___388 temp___3881))))
(check-sat)
(exit)
