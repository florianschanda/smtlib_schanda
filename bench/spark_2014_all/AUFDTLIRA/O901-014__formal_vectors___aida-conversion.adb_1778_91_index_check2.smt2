...
(assert (= n1 result3))
(assert (= n2 o8))
(assert (forall ((i1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) i1) (<= i1 index2)) (and (<= 0 (to_rep1 (select n3 i1))) (<= (to_rep1 (select n3 i1)) 9)))))
...
(assert (= result4 (ite (= o10 true) (ite (<= i index2) true false) false)))
(assert (= result4 true))
