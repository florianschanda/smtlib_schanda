...
(define-fun dynamic_invariant ((temp___expr_182 Int) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool) (temp___do_typ_inv_181 Bool)) Bool (=> (or (= temp___is_init_178 true) (<= 0 100)) (in_range temp___expr_182)))
...
(define-fun dynamic_invariant1 ((temp___expr_315 us_rep1) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (=> (= temp___do_typ_inv_314 true) (= (tree_structure temp___expr_315) true)))
...
(assert (forall ((f us_rep1)) (! (=> (dynamic_invariant1 f true true true true) (dynamic_invariant (size f) true false true true)) :pattern ((size f)))))
...
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 f true true true true) (dynamic_invariant2 i true true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
...
(assert true)
(assert (forall ((f us_rep1)) (forall ((root Int)) (forall ((values (Array Int natural))) (! (= (= (ordered_leafs f root values) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (let ((temp___526 (model__ f root))) (select temp___526 i)))) true) (= (rec__tree_model__path_type__k (us_split_fields7 (let ((temp___527 (model__ f root))) (select temp___527 j)))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___528 (model__ f root))) (select temp___528 i)))) (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___529 (model__ f root))) (select temp___529 j))))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___524 (model__ f root))) (select temp___524 j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___525 (model__ f root))) (select temp___525 i))))) 1)) 0) (< (to_rep2 (select values j)) (to_rep2 (select values i))) (< (to_rep2 (select values i)) (to_rep2 (select values j)))))))))) :pattern ((ordered_leafs f root values)))))))
(declare-fun temp_____aggregate_def_431 (Int) (Array Int natural))
(define-fun dynamic_invariant3 ((temp___expr_420 us_rep2) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool (=> (= temp___do_typ_inv_419 true) (= (tree_structure (rec__search_trees__search_tree__struct (us_split_fields5 temp___expr_420))) true)))
...
(assert (forall ((t us_rep2)) (! (=> (and (dynamic_invariant3 t true true true true) (type_invariant1 t)) (dynamic_invariant (size1 t) true false true true)) :pattern ((size1 t)))))
(assert (forall ((t us_rep2)) (! (=> (dynamic_invariant3 t true true true true) (= (size1 t) (size (rec__search_trees__search_tree__struct (us_split_fields5 t))))) :pattern ((size1 t)))))
...
(define-fun dynamic_invariant5 ((temp___expr_189 Int) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (or (= temp___is_init_185 true) (<= 0 2)) (in_range1 temp___expr_189)))
...
(define-fun dynamic_invariant6 ((temp___expr_196 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool) (temp___do_typ_inv_195 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 1)) (in_range5 temp___expr_196)))
(define-fun dynamic_invariant7 ((temp___expr_239 us_rep4) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (= temp___do_toplevel_237 true) (=> (= temp___is_init_235 true) (< (length (rec__tree_model__path_type__a (us_split_fields7 temp___expr_239))) 100))))
(define-fun default_initial_assumption2 ((temp___expr_241 us_rep4) (temp___skip_top_level_242 Bool)) Bool (and (= (length (rec__tree_model__path_type__a (us_split_fields7 temp___expr_241))) 0) (= (rec__tree_model__path_type__k (us_split_fields7 temp___expr_241)) (distinct 0 0))))
...
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 f true true true true) (dynamic_invariant2 i true true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant result true false true true)))) :pattern ((parent f i))))))
(declare-fun position (us_rep1 Int) Int)
(declare-fun position__function_guard (Int us_rep1 Int) Bool)
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant1 f true true true true) (dynamic_invariant2 i true true true true)) (not (= (parent f i) 0))) (dynamic_invariant6 (position f i) true false true true)) :pattern ((position f i))))))
(assert (forall ((f us_rep1)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant1 f true true true true) (dynamic_invariant2 root true true true true)) (= (valid_root f root) true)) (let ((result (model__ f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields7 (select result root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f i) 0)) (= (rec__tree_model__path_type__k (us_split_fields7 (select result (parent f i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields7 (select result (parent f i)))) (position f i) (rec__tree_model__path_type__a (us_split_fields7 (select result i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields7 (select result i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields7 (select result i))) (rec__tree_model__path_type__a (us_split_fields7 (select result j)))) true)) (= j i))))))))))) (dynamic_invariant8 result true false true true)))) :pattern ((model__ f root))))))
...
(declare-const temp___643 extended_index_type)
(declare-const temp___6431 extended_index_type)
(declare-const temp___6432 (Array Int us_rep))
(declare-const o Int)
(declare-const o1 Int)
(declare-const o2 Int)
(declare-const result Bool)
(declare-const result1 Bool)
(assert (= (tree_structure (mk___rep1 (mk___split_fields1 temp___6431 temp___6432))) true))
(assert (and (= o (size (mk___rep1 (mk___split_fields1 temp___6431 temp___6432)))) (in_range o)))
(assert (= result (ite (= o 0) true false)))
(assert (not (= result true)))
(assert (=> (not (= (to_rep temp___643) 0)) (and (= o2 (to_rep temp___643)) (in_range2 (to_rep temp___643)))))
(assert (=> (not (= (to_rep temp___643) 0)) (and (= result1 (valid_root (mk___rep1 (mk___split_fields1 temp___6431 temp___6432)) o2)) (=> (< (size (mk___rep1 (mk___split_fields1 temp___6431 temp___6432))) o2) (not (= result1 true))))))
(assert (=> (not (not (= (to_rep temp___643) 0))) (= result1 false)))
(assert (= result1 true))
(assert (and (= o1 (to_rep temp___643)) (in_range2 (to_rep temp___643))))
(assert (not (= (valid_root (mk___rep1 (mk___split_fields1 temp___6431 temp___6432)) o1) true)))
(check-sat)
(exit)
