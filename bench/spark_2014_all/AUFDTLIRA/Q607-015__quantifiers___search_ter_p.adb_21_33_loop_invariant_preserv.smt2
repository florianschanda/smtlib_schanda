...
(assert (= result____split_fields4 (mk___split_fields result____split_fields2 result____split_fields3)))
...
(assert (= result5 (mk_int__ref temp___230)))
(assert (= temp___2301 i2))
(assert (not (= i2 temp___223)))
...
(assert (not (not (= (has_sub_range_in_prefix a i3 b) true))))
(check-sat)
(exit)
