...
(assert (and (= temp___1340 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant1 temp___1340 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1340 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1340 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1340 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1340 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1340 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1340 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1340 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1340 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1340 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1340 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1340 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1340 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1340 j)))) true)) (= j i1))))))))))))))
(assert (= o (select temp___1340 i)))
