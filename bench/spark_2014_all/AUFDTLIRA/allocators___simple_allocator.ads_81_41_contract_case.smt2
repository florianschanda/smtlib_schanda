...
(assert (not (= (is_add (rec__simple_allocator__m__t__allocated (us_split_fields1 (model__ data3))) res (rec__simple_allocator__m__t__allocated (us_split_fields1 (model__ data)))) true)))
(check-sat)
(exit)
