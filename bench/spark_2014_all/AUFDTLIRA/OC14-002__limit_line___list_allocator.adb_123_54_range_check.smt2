...
(assert (and (= o46 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 o46)))
(assert (= result12 (ite (in_range7 o46) true false)))
(assert (=> (= result12 true) (and (= o42 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o42))))
(assert (=> (= result12 true) (= result13 (ite (< j o42) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o43 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o44 (get (rec__list_allocator__m__t__allocated model____split_fields3) o43)) (in_range4 o44)))))
...
(assert (=> (= result12 true) (= o38 temp___433)))
