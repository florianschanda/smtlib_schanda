...
(assert (=> (= result7 true) (and (= o6 prev1) (in_range5 prev1))))
...
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j 8)) (and (=> (= (to_rep5 (select track_signals1 j)) 2) (= (to_rep5 (select track_signals3 j)) 2)) (=> (and (= (to_rep5 (select track_signals1 j)) 1) (exists ((t Int)) (and (and (<= 1 t) (<= t cur_num_trains)) (= (is_previous_track (select trains1 t) j) true)))) (= (to_rep5 (select track_signals3 j)) 1))))))
(assert (and (and (=> (<= 1 3) (in_range8 id2)) (=> (<= 0 8) (in_range3 prev2))) (and (<= 1 id2) (<= id2 3))))
(assert (not (= id2 3)))
(assert (= result8 (mk_int__ref id2)))
(assert (= id3 (+ id2 1)))
(assert (and (= o7 (get_previous_track cur_position id3)) (and (in_range3 o7) (= o7 (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 (rec__trains__train_position__track_end (us_split_fields3 cur_position)))))))) id3))))))
...
(assert (=> (= result10 true) (and (= o11 prev3) (in_range5 prev3))))
(assert (=> (= result10 true) (and (ite (exists ((t Int)) (and (and (<= 1 t) (<= t cur_num_trains)) (= (is_previous_track (select trains1 t) o11) true))) (= (to_rep5 (select track_signals4 o11)) 1) (= (to_rep5 (select track_signals4 o11)) 0)) (forall ((other_track Int)) (=> (and (<= 1 other_track) (<= other_track 8)) (=> (not (= other_track o11)) (= (to_rep5 (select track_signals4 other_track)) (to_rep5 (select track_signals3 other_track)))))))))
(assert (=> (not (= result10 true)) (= track_signals4 track_signals3)))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j 8))
(assert (= (to_rep5 (select track_signals1 j)) 2))
(assert (not (= (to_rep5 (select track_signals4 j)) 2)))
(check-sat)
(exit)
