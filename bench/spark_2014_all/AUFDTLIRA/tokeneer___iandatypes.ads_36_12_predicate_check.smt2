...
(define-fun dynamic_invariant ((temp___expr_313 us_t1) (temp___is_init_309 Bool) (temp___skip_constant_310 Bool) (temp___do_toplevel_311 Bool) (temp___do_typ_inv_312 Bool)) Bool (and (=> (not (= temp___skip_constant_310 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_313) (last3 temp___expr_313))) (=> (= temp___do_toplevel_311 true) (=> (= temp___is_init_309 true) (and (let ((temp___315 (of_array2 (to_array1 temp___expr_313) (first3 temp___expr_313) (last3 temp___expr_313)))) (and (= (first5 temp___315) 1) (<= 0 (last5 temp___315)))) (<= (last3 temp___expr_313) 1000))))))
(define-fun dynamic_predicate ((temp___317 us_t1)) Bool (and (let ((temp___319 (of_array2 (to_array1 temp___317) (first3 temp___317) (last3 temp___317)))) (and (= (first5 temp___319) 1) (<= 0 (last5 temp___319)))) (<= (last3 temp___317) 1000)))
(declare-sort fart 0)
...
(define-fun dynamic_invariant1 ((temp___expr_465 Int) (temp___is_init_461 Bool) (temp___skip_constant_462 Bool) (temp___do_toplevel_463 Bool) (temp___do_typ_inv_464 Bool)) Bool (=> (or (= temp___is_init_461 true) (<= 0 2147483647)) (in_range3 temp___expr_465)))
(declare-const x Int)
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___538))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___5381))
(assert (not (dynamic_predicate (mk___t1 temp___538 temp___5381))))
(check-sat)
(exit)
