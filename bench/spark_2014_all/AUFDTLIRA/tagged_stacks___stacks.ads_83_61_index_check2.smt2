...
(define-fun dynamic_invariant2 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 100)) (in_range3 temp___expr_159)))
...
(assert (forall ((s1 us_rep)) (! (dynamic_invariant2 (size s1) true false true true) :pattern ((size s1)))))
...
(assert (forall ((s1 us_rep)) (! (let ((result (get_model__2 s1))) (and (and (= (length result) (size s1)) (and (in_range3 (last1 result)) (in_range3 (first1 result)))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__2 s1)))))
(assert (forall ((attr__tag2 Int)) (forall ((s1 us_rep)) (! (let ((result (get_model__21 attr__tag2 s1))) (and (and (= (length result) (size s1)) (and (in_range3 (last1 result)) (in_range3 (first1 result)))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__21 attr__tag2 s1))))))
(assert (forall ((s1 us_rep)) (! (= (get_model__2 s1) (get_model__21 us_tag1 s1)) :pattern ((get_model__21 us_tag1 s1)))))
(assert (forall ((s1 us_rep)) (! (= (get_model__3 (of_base s1)) (get_model__21 us_tag2 s1)) :pattern ((get_model__21 us_tag2 s1)))))
(assert (forall ((s1 us_rep)) (! (= (get_model__2 s1) (let ((temp___310 (let ((temp___308 (to_rep2 (rec__stacks__stack_root__length (us_split_fields1 s1))))) (let ((temp___307 1)) (let ((temp___309 (rec__stacks__stack_root__content (us_split_fields1 s1)))) (of_array1 temp___309 temp___307 temp___308)))))) (of_array (to_array1 temp___310) (first3 temp___310) (last3 temp___310)))) :pattern ((get_model__2 s1)))))
...
(define-fun dynamic_property3 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range low) (and (in_range high) (=> (<= low high) (and (in_range4 low) (in_range4 high))))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range f) (=> (in_range l) (and (= (to_rep (first10 (mk5 f l))) f) (= (to_rep (last12 (mk5 f l))) l)))) :pattern ((mk5 f l)))))
...
(assert (forall ((s1 us_rep1)) (! (= (get_model__3 s1) (get_model__31 us_tag2 s1)) :pattern ((get_model__31 us_tag2 s1)))))
(assert (forall ((s1 us_rep1)) (! (= (get_model__3 s1) (ite (= (wraps_around s1) true) (let ((stacks__get_model__3__R86s (last4 s1))) (let ((temp___413 (let ((temp___412 (let ((temp___409 1)) (let ((temp___410 (rec__stacks__stack_root__content1 (us_split_fields3 s1)))) (of_array4 temp___410 temp___409 stacks__get_model__3__R86s))))) (let ((temp___411 (let ((temp___407 100)) (let ((temp___406 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s1))))) (let ((temp___408 (rec__stacks__stack_root__content1 (us_split_fields3 s1)))) (of_array3 temp___408 temp___406 temp___407)))))) (ite (= (length3 temp___411) 0) (of_array2 (to_array4 temp___412) (first9 temp___412) (last11 temp___412)) (of_array2 (slide (concat1 (to_array3 temp___411) (first7 temp___411) (last9 temp___411) (to_array4 temp___412) (first9 temp___412) (last11 temp___412)) (first7 temp___411) 1) 1 (- (+ 1 (+ (ite (<= (first7 temp___411) (last9 temp___411)) (+ (- (last9 temp___411) (first7 temp___411)) 1) 0) (ite (<= (first9 temp___412) (last11 temp___412)) (+ (- (last11 temp___412) (first9 temp___412)) 1) 0))) 1))))))) (of_array (to_array2 temp___413) (first5 temp___413) (last7 temp___413)))) (let ((stacks__get_model__3__R89s (last4 s1))) (let ((temp___416 (let ((temp___414 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s1))))) (let ((temp___415 (rec__stacks__stack_root__content1 (us_split_fields3 s1)))) (of_array5 temp___415 temp___414 stacks__get_model__3__R89s))))) (of_array (to_array5 temp___416) (first11 temp___416) (last13 temp___416)))))) :pattern ((get_model__3 s1)))))
...
(assert true)
(assert true)
(assert (forall ((s1 us_rep1)) (! (= (ite (wraps_around s1) 1 0) (ite (wraps_around1 us_tag2 s1) 1 0)) :pattern ((wraps_around1 us_tag2 s1)))))
...
(assert (forall ((s1 us_rep1)) (! (dynamic_invariant2 (last4 s1) true false true true) :pattern ((last4 s1)))))
(assert (forall ((attr__tag2 Int)) (forall ((s1 us_rep1)) (! (dynamic_invariant2 (last5 attr__tag2 s1) true false true true) :pattern ((last5 attr__tag2 s1))))))
(assert (forall ((s1 us_rep1)) (! (= (last4 s1) (last5 us_tag2 s1)) :pattern ((last5 us_tag2 s1)))))
(assert (forall ((s1 us_rep1)) (! (= (last4 s1) (ite (not (= (wraps_around s1) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s1))) (to_rep2 (rec__stacks__stack_root__length1 (us_split_fields3 s1)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s1))) (to_rep2 (rec__stacks__stack_root__length1 (us_split_fields3 s1)))) 1) 100))) :pattern ((last4 s1)))))
(assert (not (= (is_empty s) true)))
(assert (not (<= 1 (to_rep2 (rec__stacks__stack_root__length (us_split_fields1 s))))))
(check-sat)
(exit)
