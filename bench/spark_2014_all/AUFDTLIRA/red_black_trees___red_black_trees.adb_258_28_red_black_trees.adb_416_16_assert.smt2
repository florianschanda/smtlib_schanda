...
(assert (not (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c76b) c77b)))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c75b) c77b)))))))
(check-sat)
(exit)
