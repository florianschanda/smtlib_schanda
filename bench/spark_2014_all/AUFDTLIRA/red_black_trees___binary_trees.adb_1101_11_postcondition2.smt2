...
(assert (forall ((x tcount_typeB)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(declare-datatypes () ((t324b__ref (mk_t324b__ref (t324b__content tcount_typeB)))))
(define-fun t324b__ref___projection ((a t324b__ref)) tcount_typeB (t324b__content a))
...
(define-fun dynamic_invariant4 ((temp___expr_196 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool) (temp___do_typ_inv_195 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 1)) (in_range6 temp___expr_196)))
...
(assert (and (and (<= (+ (to_rep f_old__split_fields) 1) root) (<= root (to_rep f__split_fields))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i)))) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f_old__split_fields1 i))))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i)))) (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 i))))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 i)))) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f_old__split_fields1 i))))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select f_old__split_fields1 i))))))))))))
(assert (= (mk_int__ref result) (mk_int__ref n)))
(assert (= n1 0))
(assert (=> (and (<= 0 n1) (<= n1 100)) (= temp___1918 n1)))
(assert (=> (and (<= 0 n1) (<= n1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) j))) true) (not (= j root))) (< n2 (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) j))))))))))
(assert (=> (and (<= 0 n1) (<= n1 100)) (and (=> (<= 0 100) (in_range3 n2)) (and (<= 0 n2) (<= n2 100)))))
(assert (=> (and (<= 0 n1) (<= n1 100)) (= n2 100)))
(assert (=> (and (<= 0 n1) (<= n1 100)) (= n2 n3)))
(assert (=> (and (<= 0 n1) (<= n1 100)) (= n4 n2)))
(assert (=> (and (<= 0 n1) (<= n1 100)) (= n9 (mk_int__ref n3))))
(assert (=> (and (<= 0 n1) (<= n1 100)) (= n6 n4)))
(assert (=> (not (and (<= 0 n1) (<= n1 100))) (= n1 n5)))
(assert (=> (not (and (<= 0 n1) (<= n1 100))) (= n6 n1)))
(assert (= (to_rep f_old__split_fields) r323b))
(assert (in_range3 r323b))
(assert (= result1 (mk_int__ref r)))
(assert (= r1 1))
(assert (=> (and (<= 1 r1) (<= r1 r323b)) (= temp___1928 r1)))
(assert (=> (and (<= 1 r1) (<= r1 r323b)) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r1)))) 2) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 r1)))) 2) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r1) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) r1)) true)))))
(assert (=> (and (<= 1 r1) (<= r1 r323b)) (forall ((p Int)) (=> (and (<= 1 p) (<= p r2)) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 p)))) 2) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) p) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) p)) true))))))
(assert (=> (and (<= 1 r1) (<= r1 r323b)) (and (=> (<= 1 r323b) (dynamic_property 1 r323b r2)) (and (<= 1 r2) (<= r2 r323b)))))
(assert (=> (and (<= 1 r1) (<= r1 r323b)) (= r2 r323b)))
(assert (=> (and (<= 1 r1) (<= r1 r323b)) (= r3 (mk_int__ref r2))))
(assert (=> (and (<= 1 r1) (<= r1 r323b)) (= r4 r2)))
(assert (=> (and (<= 1 r1) (<= r1 r323b)) (= r5 r3)))
(assert (=> (and (<= 1 r1) (<= r1 r323b)) (= r6 r4)))
(assert (=> (not (and (<= 1 r1) (<= r1 r323b))) (= r5 (mk_int__ref r1))))
(assert (=> (not (and (<= 1 r1) (<= r1 r323b))) (= r6 r1)))
(assert (= r7 r5))
(assert (= n7 n9))
(assert (= r8 r6))
(assert (= n8 n6))
...
(assert (<= 1 r9))
(assert (<= r9 (to_rep f_old__split_fields)))
(assert (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r9)))) 2))
(assert (not (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r9) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) r9)) true)))
(check-sat)
(exit)
