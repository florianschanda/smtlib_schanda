...
(assert (forall ((k Int)) (=> (and (<= (to_rep1 (first (rt v))) k) (<= k i2)) (<= (to_rep (select (elts v) k)) result__3))))
(assert (exists ((k Int)) (and (and (<= (to_rep1 (first (rt v))) k) (<= k i2)) (= result__3 (to_rep (select (elts v) k))))))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 result__3)) (=> (<= (to_rep1 (first (rt v))) (to_rep1 (last (rt v)))) (dynamic_property1 (to_rep1 (first (rt v))) (to_rep1 (last (rt v))) i2))) (and (<= (to_rep1 (first (rt v))) i2) (<= i2 (to_rep1 (last (rt v)))))))
(assert (= temp___188 result3))
(assert (= temp___1881 i2))
(assert (not (= i2 (to_rep1 (last (rt v))))))
(assert (= i2 result4))
(assert (= i3 (+ i2 1)))
(assert (=> (< result__3 (to_rep (select (elts v) i3))) (= result__3 result5)))
(assert (=> (< result__3 (to_rep (select (elts v) i3))) (= result__4 (to_rep (select (elts v) i3)))))
(assert (=> (not (< result__3 (to_rep (select (elts v) i3)))) (= result__4 result__3)))
(assert (and (<= (to_rep1 (first (rt v))) i3) (<= i3 (to_rep1 (last (rt v))))))
(assert (not (< temp___1881 i3)))
(check-sat)
(exit)
