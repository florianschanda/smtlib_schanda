...
(assert (= a2 result2))
(assert (= a3 (store a2 j (mk___rep (mk___split_fields (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a2 j))) rliteral2 (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a2 j))))))))
(assert (= a3 result3))
