...
(assert (= (bool_eq old__1 (to_rep1 old____first) (to_rep1 old____last) s (to_rep1 s__first) (to_rep1 s__last)) true))
(assert (= old__1 old__2))
(assert (= old__3 old__1))
(assert (not (= (bool_eq s (to_rep1 s__first) (to_rep1 s__last) s (to_rep1 s__first) (to_rep1 s__last)) true)))
(check-sat)
(exit)
