...
(define-fun dynamic_invariant1 ((temp___expr_357 us_t1) (temp___is_init_353 Bool) (temp___skip_constant_354 Bool) (temp___do_toplevel_355 Bool) (temp___do_typ_inv_356 Bool)) Bool (and (=> (not (= temp___skip_constant_354 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_357) (last3 temp___expr_357))) (=> (= temp___do_toplevel_355 true) (=> (= temp___is_init_353 true) (and (let ((temp___359 (of_array2 (to_array1 temp___expr_357) (first3 temp___expr_357) (last3 temp___expr_357)))) (and (let ((temp___360 (of_array3 (to_array2 temp___359) (first5 temp___359) (last5 temp___359)))) (and (= (first7 temp___360) 1) (<= 0 (last7 temp___360)))) (<= (last5 temp___359) 1000))) (<= 2 (length1 temp___expr_357)))))))
(define-fun dynamic_predicate ((temp___362 us_t1)) Bool (and (let ((temp___364 (of_array2 (to_array1 temp___362) (first3 temp___362) (last3 temp___362)))) (and (let ((temp___365 (of_array3 (to_array2 temp___364) (first5 temp___364) (last5 temp___364)))) (and (= (first7 temp___365) 1) (<= 0 (last7 temp___365)))) (<= (last5 temp___364) 1000))) (<= 2 (length1 temp___362))))
...
(declare-const dummy7 serialnumbert)
...
(define-fun dynamic_invariant2 ((temp___expr_1477 Int) (temp___is_init_1473 Bool) (temp___skip_constant_1474 Bool) (temp___do_toplevel_1475 Bool) (temp___do_typ_inv_1476 Bool)) Bool (=> (or (= temp___is_init_1473 true) (<= 0 4294967295)) (in_range3 temp___expr_1477)))
(assert (forall ((x Int)) (! (=> (dynamic_invariant2 x true true true true) (dynamic_invariant1 (serialnumbert_image x) true false true true)) :pattern ((serialnumbert_image x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant2 x true true true true) (= (serialnumbert_image x) (let ((temp___1483 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___1483) (first1 temp___1483) (last1 temp___1483))))) :pattern ((serialnumbert_image x)))))
(declare-sort rawnexti 0)
(declare-fun rawnextiqtint (rawnexti) Int)
(assert (forall ((i rawnexti)) (and (<= 1 (rawnextiqtint i)) (<= (rawnextiqtint i) 10))))
...
(define-fun dynamic_invariant3 ((temp___expr_1623 Int) (temp___is_init_1619 Bool) (temp___skip_constant_1620 Bool) (temp___do_toplevel_1621 Bool) (temp___do_typ_inv_1622 Bool)) Bool (=> (or (= temp___is_init_1619 true) (<= 1 10)) (in_range4 temp___expr_1623)))
...
(declare-fun temp_____aggregate_def_1668 (Int Int Int) us_t7)
...
(assert (forall ((temp___1670 Int) (temp___1671 Int) (temp___1672 Int)) (let ((temp___1669 (temp_____aggregate_def_1668 temp___1670 temp___1671 temp___1672))) (=> (dynamic_invariant5 temp___1670 true true true true) (and (=> (dynamic_property 1 2147483647 temp___1671 temp___1672) (and (= (first15 temp___1669) temp___1671) (= (last15 temp___1669) temp___1672))) (forall ((temp___1673 Int)) (= (to_rep (select (to_array7 temp___1669) temp___1673)) temp___1670)))))))
(define-fun dynamic_invariant7 ((temp___expr_307 us_t3) (temp___is_init_303 Bool) (temp___skip_constant_304 Bool) (temp___do_toplevel_305 Bool) (temp___do_typ_inv_306 Bool)) Bool (and (=> (not (= temp___skip_constant_304 true)) (dynamic_property3 1 2147483647 (first7 temp___expr_307) (last7 temp___expr_307))) (=> (= temp___do_toplevel_305 true) (=> (= temp___is_init_303 true) (and (= (first7 temp___expr_307) 1) (<= 0 (last7 temp___expr_307)))))))
(define-fun dynamic_predicate1 ((temp___310 us_t3)) Bool (and (= (first7 temp___310) 1) (<= 0 (last7 temp___310))))
(define-fun dynamic_invariant8 ((temp___expr_344 us_t2) (temp___is_init_340 Bool) (temp___skip_constant_341 Bool) (temp___do_toplevel_342 Bool) (temp___do_typ_inv_343 Bool)) Bool (and (=> (not (= temp___skip_constant_341 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_344) (last5 temp___expr_344))) (=> (= temp___do_toplevel_342 true) (=> (= temp___is_init_340 true) (and (let ((temp___346 (of_array3 (to_array2 temp___expr_344) (first5 temp___expr_344) (last5 temp___expr_344)))) (and (= (first7 temp___346) 1) (<= 0 (last7 temp___346)))) (<= (last5 temp___expr_344) 1000))))))
(define-fun dynamic_predicate2 ((temp___348 us_t2)) Bool (and (let ((temp___350 (of_array3 (to_array2 temp___348) (first5 temp___348) (last5 temp___348)))) (and (= (first7 temp___350) 1) (<= 0 (last7 temp___350)))) (<= (last5 temp___348) 1000)))
(declare-const length8 Int)
(declare-const str (Array Int character))
(declare-const temp___1659 (Array Int character))
(declare-const temp___16591 t1)
...
(define-fun temp___16592 () us_t1 (mk___t1 temp___1659 temp___16591))
(assert (in_range3 num))
(assert (=> (<= 1 10) (in_range4 length8)))
(assert (and (= temp___16592 (serialnumbert_image num)) (and (dynamic_invariant1 temp___16592 true false true true) (= temp___16592 (let ((temp___1481 (to_string (attr__ATTRIBUTE_IMAGE3 num)))) (mk___t1 (elts temp___1481) (mk1 (to_rep1 (first (rt temp___1481))) (to_rep1 (last (rt temp___1481))))))))))
(assert (= temp___1659 certificatestore__putnextserialnumber__convertfrom32__str__assume))
(assert (= (mk (to_rep1 (first2 temp___16591)) (to_rep1 (last2 temp___16591))) certificatestore__putnextserialnumber__convertfrom32__str__assume1))
(assert (= result str))
...
(assert (<= 2 r10b))
(assert (not (<= (to_rep1 str__first) 2)))
(check-sat)
(exit)
