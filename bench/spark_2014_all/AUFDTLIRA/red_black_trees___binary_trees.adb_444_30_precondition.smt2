...
(declare-const j Int)
(declare-const temp___1453 (Array Int us_rep1))
(declare-const o Int)
...
(assert (= (to_rep f__split_fields) (to_rep f_old__split_fields)))
(assert (<= root (to_rep f__split_fields)))
(assert (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 root)))) 2))
(assert (not (= v root)))
(assert (<= 1 v))
(assert (<= v (to_rep f__split_fields)))
(assert (and (<= 1 v) (<= v 100)))
(assert (= o5 v))
(assert (= (mk___rep1 (mk___split_fields1 o6 o7 o8 o9)) (select f__split_fields1 o5)))
(assert (= o6 o10))
(assert (= o7 o11))
(assert (= o8 o12))
(assert (= o9 o13))
...
(assert (= result (ite (= o15 2) true false)))
(assert (= result true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
(assert (and (= temp___1453 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant1 temp___1453 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1453 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1453 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1453 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1453 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1453 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1453 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1453 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1453 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1453 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1453 i))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1453 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1453 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1453 j1)))) true)) (= j1 i))))))))))))))
(assert (and (<= 1 v) (<= v 100)))
(assert (= o v))
(assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___1453 o)))
(assert (= o1 o3))
(assert (= o2 o4))
(assert (= result1 o4))
(assert (= result1 true))
(assert (= (= result2 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i v)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i)))) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f_old__split_fields1 i))))))))))
(assert (= result2 true))
(assert (= (= result3 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i)))) (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 i))))))))))
(assert (= result3 true))
(assert (<= 1 j))
(assert (<= j 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
