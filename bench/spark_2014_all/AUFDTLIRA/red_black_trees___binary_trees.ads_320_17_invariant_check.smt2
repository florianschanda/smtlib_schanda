...
(declare-const v Int)
(declare-const o Int)
(declare-const temp___1006 (Array Int us_rep1))
...
(assert (= result true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= temp___1006 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant temp___1006 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1006 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1006 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1006 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1006 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1006 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1006 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1006 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1006 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1006 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1006 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1006 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1006 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1006 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___1006 i)))
(assert (= o1 o3))
(assert (= o2 o4))
(assert (= result1 o4))
(assert (= result1 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o (peek (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i d)) (and (in_range3 o) (and (= o (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 i)))))) (and (ite (not (= o 0)) (and (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o) d) (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j) i) (not (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j) i) (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j) d)) (= o j)))))))))
