...
(define-fun dynamic_invariant1 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 4294967295)) (in_range3 temp___expr_426)))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true true) (= (issueridt_image x) (let ((temp___432 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___432) (first1 temp___432) (last1 temp___432))))) :pattern ((issueridt_image x)))))
(declare-sort t3 0)
...
(declare-datatypes () ((stringf1l2to1000__ref (mk_stringf1l2to1000__ref (stringf1l2to1000__content us_t3)))))
(define-fun stringf1l2to1000__ref___projection ((a stringf1l2to1000__ref)) us_t3 (stringf1l2to1000__content a))
(declare-fun serialnumbert_image (Int) us_t3)
(declare-fun serialnumbert_image__function_guard (us_t3 Int) Bool)
(define-fun dynamic_invariant2 ((temp___expr_349 us_t3) (temp___is_init_345 Bool) (temp___skip_constant_346 Bool) (temp___do_toplevel_347 Bool) (temp___do_typ_inv_348 Bool)) Bool (and (=> (not (= temp___skip_constant_346 true)) (dynamic_property3 1 2147483647 (first7 temp___expr_349) (last7 temp___expr_349))) (=> (= temp___do_toplevel_347 true) (=> (= temp___is_init_345 true) (and (let ((temp___351 (of_array1 (to_array3 temp___expr_349) (first7 temp___expr_349) (last7 temp___expr_349)))) (and (let ((temp___352 (of_array2 (to_array1 temp___351) (first3 temp___351) (last3 temp___351)))) (and (= (first5 temp___352) 1) (<= 0 (last5 temp___352)))) (<= (last3 temp___351) 1000))) (<= 2 (length3 temp___expr_349)))))))
(define-fun dynamic_predicate1 ((temp___354 us_t3)) Bool (and (let ((temp___356 (of_array1 (to_array3 temp___354) (first7 temp___354) (last7 temp___354)))) (and (let ((temp___357 (of_array2 (to_array1 temp___356) (first3 temp___356) (last3 temp___356)))) (and (= (first5 temp___357) 1) (<= 0 (last5 temp___357)))) (<= (last3 temp___356) 1000))) (<= 2 (length3 temp___354))))
...
(define-fun dynamic_invariant3 ((temp___expr_553 Int) (temp___is_init_549 Bool) (temp___skip_constant_550 Bool) (temp___do_toplevel_551 Bool) (temp___do_typ_inv_552 Bool)) Bool (=> (or (= temp___is_init_549 true) (<= 0 4294967295)) (in_range4 temp___expr_553)))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant3 x true true true true) (= (serialnumbert_image x) (let ((temp___559 (to_string (attr__ATTRIBUTE_IMAGE4 x)))) (of_array3 (to_array temp___559) (first1 temp___559) (last1 temp___559))))) :pattern ((serialnumbert_image x)))))
...
(assert (forall ((x namecountt)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(declare-fun usertextiqtint (usertexti) Int)
(assert (forall ((i usertexti)) (and (<= 1 (usertextiqtint i)) (<= (usertextiqtint i) 50))))
(define-fun in_range6 ((x Int)) Bool (and (<= 1 x) (<= x 50)))
(declare-fun attr__ATTRIBUTE_IMAGE6 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check6 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE6 (us_image) Int)
(declare-fun user_eq13 (usertexti usertexti) Bool)
(declare-const dummy13 usertexti)
...
(define-fun bool_eq8 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (bool_eq6 (rec__cert__contentst__id (us_split_fields7 a)) (rec__cert__contentst__id (us_split_fields7 b))) true) (= (bool_eq7 (rec__cert__contentst__notbefore (us_split_fields7 a)) (rec__cert__contentst__notbefore (us_split_fields7 b))) true)) (= (bool_eq7 (rec__cert__contentst__notafter (us_split_fields7 a)) (rec__cert__contentst__notafter (us_split_fields7 b))) true)) (= (to_rep9 (rec__cert__contentst__mechanism (us_split_fields7 a))) (to_rep9 (rec__cert__contentst__mechanism (us_split_fields7 b))))) true false))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1889 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 3)) 85)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 4)) 115)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 28)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 29)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 39)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 41)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 44)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 45)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 47)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 48)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 49)) 32)) (= (to_rep (select (temp___String_Literal_1889 us_void_param) 50)) 32)) :pattern ((temp___String_Literal_1889 us_void_param)))))
(declare-fun temp___String_Literal_1890 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1890 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1890 us_void_param) 2)) 115)) (= (to_rep (select (temp___String_Literal_1890 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_1890 us_void_param) 4)) 117)) (= (to_rep (select (temp___String_Literal_1890 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1890 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1890 us_void_param) 7)) 58)) (= (to_rep (select (temp___String_Literal_1890 us_void_param) 8)) 32)) :pattern ((temp___String_Literal_1890 us_void_param)))))
(declare-fun temp___String_Literal_1893 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1893 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1893 us_void_param) 2)) 83)) (= (to_rep (select (temp___String_Literal_1893 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_1893 us_void_param) 4)) 114)) (= (to_rep (select (temp___String_Literal_1893 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1893 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_1893 us_void_param) 7)) 108)) (= (to_rep (select (temp___String_Literal_1893 us_void_param) 8)) 78)) (= (to_rep (select (temp___String_Literal_1893 us_void_param) 9)) 111)) (= (to_rep (select (temp___String_Literal_1893 us_void_param) 10)) 58)) (= (to_rep (select (temp___String_Literal_1893 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_1893 us_void_param) 12)) 32)) :pattern ((temp___String_Literal_1893 us_void_param)))))
...
(define-fun dynamic_invariant8 ((temp___expr_1070 Int) (temp___is_init_1066 Bool) (temp___skip_constant_1067 Bool) (temp___do_toplevel_1068 Bool) (temp___do_typ_inv_1069 Bool)) Bool (=> (or (= temp___is_init_1066 true) (<= 1 50)) (in_range6 temp___expr_1070)))
(define-fun dynamic_invariant9 ((temp___expr_299 us_t2) (temp___is_init_295 Bool) (temp___skip_constant_296 Bool) (temp___do_toplevel_297 Bool) (temp___do_typ_inv_298 Bool)) Bool (and (=> (not (= temp___skip_constant_296 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_299) (last5 temp___expr_299))) (=> (= temp___do_toplevel_297 true) (=> (= temp___is_init_295 true) (and (= (first5 temp___expr_299) 1) (<= 0 (last5 temp___expr_299)))))))
(define-fun dynamic_predicate2 ((temp___302 us_t2)) Bool (and (= (first5 temp___302) 1) (<= 0 (last5 temp___302))))
(define-fun dynamic_invariant10 ((temp___expr_933 Int) (temp___is_init_929 Bool) (temp___skip_constant_930 Bool) (temp___do_toplevel_931 Bool) (temp___do_typ_inv_932 Bool)) Bool (=> (or (= temp___is_init_929 true) (<= 1901 2099)) (in_range7 temp___expr_933)))
(define-fun dynamic_invariant11 ((temp___expr_940 Int) (temp___is_init_936 Bool) (temp___skip_constant_937 Bool) (temp___do_toplevel_938 Bool) (temp___do_typ_inv_939 Bool)) Bool (=> (or (= temp___is_init_936 true) (<= 1 12)) (in_range8 temp___expr_940)))
(define-fun dynamic_invariant12 ((temp___expr_947 Int) (temp___is_init_943 Bool) (temp___skip_constant_944 Bool) (temp___do_toplevel_945 Bool) (temp___do_typ_inv_946 Bool)) Bool (=> (or (= temp___is_init_943 true) (<= 1 31)) (in_range9 temp___expr_947)))
(define-fun dynamic_invariant13 ((temp___expr_979 Int) (temp___is_init_975 Bool) (temp___skip_constant_976 Bool) (temp___do_toplevel_977 Bool) (temp___do_typ_inv_978 Bool)) Bool (=> (or (= temp___is_init_975 true) (<= 0 86399999)) (in_range10 temp___expr_979)))
(define-fun dynamic_invariant14 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 40)) (in_range5 temp___expr_402)))
(define-fun dynamic_invariant15 ((temp___expr_450 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool) (temp___do_typ_inv_449 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 0 10)) (in_range11 temp___expr_450)))
(declare-const localuser (Array Int character))
(declare-const fullstring (Array Int character))
(declare-const temp___1897 (Array Int character))
(declare-const temp___18971 t3)
(declare-const temp___1892 (Array Int character))
(declare-const temp___18921 t1)
(declare-const o Int)
...
(declare-const temp___1894 (Array Int character))
(declare-const temp___18941 t)
...
(declare-const temp___1896 (Array Int character))
(declare-const temp___18961 t)
...
(declare-const temp___1902 (Array Int character))
(declare-const temp___19021 t4)
...
(define-fun temp___18922 () us_t1 (mk___t1 temp___1892 temp___18921))
(define-fun temp___18972 () us_t3 (mk___t3 temp___1897 temp___18971))
(assert (= result localuser))
(assert (= localuser1 (temp___String_Literal_1889 Tuple0)))
(assert (and (= temp___18972 (serialnumbert_image (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents))))))) (and (dynamic_invariant2 temp___18972 true false true true) (= temp___18972 (let ((temp___557 (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents))))))))) (mk___t3 (elts temp___557) (mk3 (to_rep1 (first (rt temp___557))) (to_rep1 (last (rt temp___557))))))))))
(assert (and (= temp___18922 (issueridt_image (to_rep3 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents))))))))) (and (dynamic_invariant temp___18922 true false true true) (= temp___18922 (let ((temp___430 (to_string (attr__ATTRIBUTE_IMAGE3 (to_rep3 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents))))))))))) (mk___t1 (elts temp___430) (mk1 (to_rep1 (first (rt temp___430))) (to_rep1 (last (rt temp___430))))))))))
(assert (=> (<= (to_rep1 (first2 temp___18921)) (to_rep1 (last2 temp___18921))) (= o (+ (- (to_rep1 (last2 temp___18921)) (to_rep1 (first2 temp___18921))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___18921)) (to_rep1 (last2 temp___18921)))) (= o 0)))
(assert (=> (<= 1 8) (= o1 (+ (- 8 1) 1))))
(assert (=> (not (<= 1 8)) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ 1 o2)))
...
(assert (= (concat1 (temp___String_Literal_1890 Tuple0) 1 8 temp___1892 (to_rep1 (first2 temp___18921)) (to_rep1 (last2 temp___18921))) temp___1894))
(assert (= (mk 1 o5) temp___18941))
(assert (=> (= (length (mk___t temp___1894 temp___18941)) 0) (= (temp___String_Literal_1893 Tuple0) temp___1896)))
(assert (=> (= (length (mk___t temp___1894 temp___18941)) 0) (= (mk 1 12) temp___18961)))
(assert (=> (not (= (length (mk___t temp___1894 temp___18941)) 0)) (=> (<= 1 12) (= o6 (+ (- 12 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1894 temp___18941)) 0)) (=> (not (<= 1 12)) (= o6 0))))
(assert (=> (not (= (length (mk___t temp___1894 temp___18941)) 0)) (=> (<= (to_rep1 (first temp___18941)) (to_rep1 (last temp___18941))) (= o7 (+ (- (to_rep1 (last temp___18941)) (to_rep1 (first temp___18941))) 1)))))
(assert (=> (not (= (length (mk___t temp___1894 temp___18941)) 0)) (=> (not (<= (to_rep1 (first temp___18941)) (to_rep1 (last temp___18941)))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___1894 temp___18941)) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length (mk___t temp___1894 temp___18941)) 0)) (= o9 (+ (to_rep1 (first temp___18941)) o8))))
(assert (=> (not (= (length (mk___t temp___1894 temp___18941)) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length (mk___t temp___1894 temp___18941)) 0)) (and (= o11 o10) (in_range1 o10))))
(assert (=> (not (= (length (mk___t temp___1894 temp___18941)) 0)) (= (concat1 temp___1894 (to_rep1 (first temp___18941)) (to_rep1 (last temp___18941)) (temp___String_Literal_1893 Tuple0) 1 12) temp___1896)))
(assert (=> (not (= (length (mk___t temp___1894 temp___18941)) 0)) (= (mk (to_rep1 (first temp___18941)) o11) temp___18961)))
(assert (=> (= (length (mk___t temp___1896 temp___18961)) 0) (= temp___1897 cert__extractuser__fullstring__assume)))
(assert (=> (= (length (mk___t temp___1896 temp___18961)) 0) (= (mk (to_rep1 (first6 temp___18971)) (to_rep1 (last6 temp___18971))) cert__extractuser__fullstring__assume1)))
(assert (=> (not (= (length (mk___t temp___1896 temp___18961)) 0)) (=> (<= (to_rep1 (first6 temp___18971)) (to_rep1 (last6 temp___18971))) (= o12 (+ (- (to_rep1 (last6 temp___18971)) (to_rep1 (first6 temp___18971))) 1)))))
(assert (=> (not (= (length (mk___t temp___1896 temp___18961)) 0)) (=> (not (<= (to_rep1 (first6 temp___18971)) (to_rep1 (last6 temp___18971)))) (= o12 0))))
(assert (=> (not (= (length (mk___t temp___1896 temp___18961)) 0)) (=> (<= (to_rep1 (first temp___18961)) (to_rep1 (last temp___18961))) (= o13 (+ (- (to_rep1 (last temp___18961)) (to_rep1 (first temp___18961))) 1)))))
(assert (=> (not (= (length (mk___t temp___1896 temp___18961)) 0)) (=> (not (<= (to_rep1 (first temp___18961)) (to_rep1 (last temp___18961)))) (= o13 0))))
(assert (=> (not (= (length (mk___t temp___1896 temp___18961)) 0)) (= o14 (+ o13 o12))))
(assert (=> (not (= (length (mk___t temp___1896 temp___18961)) 0)) (= o15 (+ (to_rep1 (first temp___18961)) o14))))
(assert (=> (not (= (length (mk___t temp___1896 temp___18961)) 0)) (= o16 (- o15 1))))
(assert (=> (not (= (length (mk___t temp___1896 temp___18961)) 0)) (and (= o17 o16) (in_range1 o16))))
(assert (=> (not (= (length (mk___t temp___1896 temp___18961)) 0)) (= (concat1 temp___1896 (to_rep1 (first temp___18961)) (to_rep1 (last temp___18961)) temp___1897 (to_rep1 (first6 temp___18971)) (to_rep1 (last6 temp___18971))) cert__extractuser__fullstring__assume)))
(assert (=> (not (= (length (mk___t temp___1896 temp___18961)) 0)) (= (mk (to_rep1 (first temp___18961)) o17) cert__extractuser__fullstring__assume1)))
(assert (= result1 fullstring))
(assert (= fullstring1 cert__extractuser__fullstring__assume))
(assert (= (to_rep1 fullstring__first) (to_rep1 (first cert__extractuser__fullstring__assume1))))
(assert (= (to_rep1 fullstring__last) (to_rep1 (last cert__extractuser__fullstring__assume1))))
...
(assert (= (ite (<= (to_rep1 fullstring__first) (to_rep1 fullstring__last)) (+ (- (to_rep1 fullstring__last) (to_rep1 fullstring__first)) 1) 0) (ite (<= 1 (to_rep1 fullstring__last)) (+ (- (to_rep1 fullstring__last) 1) 1) 0)))
(assert (= (slide fullstring1 (to_rep1 fullstring__first) 1) temp___1902))
(assert (= (mk4 1 (to_rep1 fullstring__last)) temp___19021))
(assert (<= 1 (to_rep1 fullstring__last)))
(assert (not (<= 1 1)))
(check-sat)
(exit)
