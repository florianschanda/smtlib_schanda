...
(assert (= o23 (concat1 (temp___String_Literal_1153 Tuple0) 1 11 (elts (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i1))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i1))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i1))))))))))
(assert (= o24 (mk 1 o22)))
(assert (not (= (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i1)) 0)))
(assert (= result2 i1))
(assert (= i2 2))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i2))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i2)))))))) (= o25 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i2))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i2)))))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i2))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i2))))))))) (= o25 0)))
(assert (=> (<= 1 11) (= o26 (+ (- 11 1) 1))))
(assert (=> (not (<= 1 11)) (= o26 0)))
(assert (= o27 (+ o26 o25)))
(assert (= o28 (+ 1 o27)))
(assert (= o29 (- o28 1)))
