...
(assert (= l2 result7))
(assert (= l3 o10))
(assert (and (= o12 (+ x l3)) (in_range1 (+ x l3))))
(assert (= result9 (ite (<= o12 1000) true false)))
(assert (=> (= result9 true) (and (= o11 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result9 true) (= result8 (ite (<= o11 1000) true false))))
