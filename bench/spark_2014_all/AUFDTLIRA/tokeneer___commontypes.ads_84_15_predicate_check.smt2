...
(define-fun dynamic_invariant5 ((temp___expr_265 us_t2) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool) (temp___do_typ_inv_264 Bool)) Bool (and (=> (not (= temp___skip_constant_262 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_265) (last5 temp___expr_265))) (=> (= temp___do_toplevel_263 true) (=> (= temp___is_init_261 true) (and (= (first5 temp___expr_265) 1) (<= 0 (last5 temp___expr_265)))))))
(define-fun dynamic_predicate1 ((temp___268 us_t2)) Bool (and (= (first5 temp___268) 1) (<= 0 (last5 temp___268))))
(declare-const temp___384 (Array Int character))
(declare-const temp___3841 t1)
(assert (in_range x))
(assert (dynamic_property1 1 2147483647 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE x)))))))
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE x))) temp___384))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE x)))))) temp___3841))
(assert (not (dynamic_predicate (mk___t1 temp___384 temp___3841))))
(check-sat)
(exit)
