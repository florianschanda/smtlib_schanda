...
(define-fun dynamic_invariant1 ((temp___expr_624 Int) (temp___is_init_620 Bool) (temp___skip_constant_621 Bool) (temp___do_toplevel_622 Bool) (temp___do_typ_inv_623 Bool)) Bool (=> (or (= temp___is_init_620 true) (<= 0 3)) (in_range1 temp___expr_624)))
(assert true)
...
(define-fun dynamic_invariant3 ((temp___expr_574 Int) (temp___is_init_570 Bool) (temp___skip_constant_571 Bool) (temp___do_toplevel_572 Bool) (temp___do_typ_inv_573 Bool)) Bool (=> (or (= temp___is_init_570 true) (<= 0 1000)) (in_range2 temp___expr_574)))
