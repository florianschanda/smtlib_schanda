...
(assert (and (<= (to_rep1 (first (rt source))) temp___1200) (<= temp___1200 (to_rep1 (last (rt source))))))
(assert (= o48 temp___1200))
...
(assert (and (= temp___1201 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1201) (<= temp___1201 (to_rep1 (last (rt source))))))
(assert (= o51 temp___1201))
...
(assert (and (= temp___1202 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1202) (<= temp___1202 (to_rep1 (last (rt source))))))
(assert (= o54 temp___1202))
(assert (= o55 (select (elts source) o54)))
(assert (= o56 (to_rep o55)))
(assert (= result19 (ite (< 56 o56) true false)))
(assert (not (= result19 true)))
(assert (= has_failed20 has_failed19))
