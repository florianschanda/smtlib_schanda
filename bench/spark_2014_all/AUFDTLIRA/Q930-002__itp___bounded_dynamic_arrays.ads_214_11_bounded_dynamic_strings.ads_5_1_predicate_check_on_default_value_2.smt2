...
(declare-const temp___951 natural_index)
(declare-const temp___9511 natural_index)
(declare-const temp___9512 (Array Int character))
(declare-const temp___9513 t4)
(define-fun temp___9514 () us_rep1 (mk___rep1 (mk___split_discrs temp___951) (mk___split_fields1 temp___9511 (mk___t4 temp___9512 temp___9513))))
...
(assert (default_initial_assumption temp___9514 false))
(assert (not (dynamic_predicate1 temp___9514)))
(check-sat)
(exit)
