...
(assert (and (= o67 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 o67)))
(assert (= result12 (ite (in_range7 o67) true false)))
(assert (=> (= result12 true) (and (= o63 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o63))))
(assert (=> (= result12 true) (= result13 (ite (< j o63) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o64 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o65 (get (rec__list_allocator__m__t__available model____split_fields3) o64)) (in_range4 o65)))))
(assert (=> (= result12 true) (=> (not (= result13 true)) (= o65 0))))
(assert (=> (= result12 true) (and (= temp___460 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 temp___460))))
(assert (=> (= result12 true) (and (<= 1 temp___460) (<= temp___460 3))))
(assert (=> (= result12 true) (= o59 temp___460)))
