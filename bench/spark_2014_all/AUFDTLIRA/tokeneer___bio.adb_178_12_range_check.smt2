...
(assert (not (= (length (mk___t temp___1511 temp___15111)) 0)))
(assert (=> (<= (to_rep1 (first2 temp___15121)) (to_rep1 (last2 temp___15121))) (= o6 (+ (- (to_rep1 (last2 temp___15121)) (to_rep1 (first2 temp___15121))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___15121)) (to_rep1 (last2 temp___15121)))) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___15111)) (to_rep1 (last temp___15111))) (= o7 (+ (- (to_rep1 (last temp___15111)) (to_rep1 (first temp___15111))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___15111)) (to_rep1 (last temp___15111)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___15111)) o8)))
(assert (= o10 (- o9 1)))
