...
(declare-const temp___9653 us_rep3)
(declare-const o29 it4)
(declare-const o30 us_split_fields6)
(declare-const temp___9655 us_rep3)
...
(declare-const temp___9664 us_rep3)
...
(assert (= temp___9664 (mk___rep3 o39)))
(assert (= result2 (mk___split_fields__ref3 r__split_fields3)))
(assert (= r__split_fields4 (us_split_fields7 temp___9664)))
(assert (= r__split_fields5 (mk___split_fields__ref3 r__split_fields4)))
(assert (= r__split_fields6 r__split_fields4))
(declare-const n Int)
(assert (<= 90 n))
(assert (<= n 99))
(assert (not (in_range4 (to_rep3 (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select (rec__ar__rofaofr2__b2 (us_split_fields__content3 r__split_fields5)) n)))))))))
(check-sat)
(exit)
