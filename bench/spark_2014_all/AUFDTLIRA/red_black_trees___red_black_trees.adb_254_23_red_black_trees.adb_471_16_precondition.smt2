...
(assert (<= 1 n5))
(assert (<= n5 100))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))) i1))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c94b) i1)))) n6)) (ite (= (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i1) c96b) (and (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c95b) i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c95b) i1)))) (+ (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c94b) i1)))) 1))) (= (eq (select (nb_blacks c95b) i1) (select (nb_blacks c94b) i1)) true))))))
(assert (and (=> (<= 1 100) (in_range4 n6)) (and (<= 1 n6) (<= n6 100))))
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___813 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)))) (and (dynamic_invariant5 temp___813 true false true true) (= temp___813 (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))))))))))
(assert (= o42 (select temp___813 i)))
(assert (= o43 (us_split_fields7 o42)))
(assert (= result15 (rec__tree_model__path_type__k o43)))
(assert (=> (= result15 true) (and (= temp___814 (nb_blacks c94b)) (and (= (bool_eq11 (select temp___814 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___814 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___814 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___814 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___814 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___814 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___814 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___814 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___814 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___814 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c94b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___814 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 0)))))))))))))))
(assert (=> (= result15 true) (= o38 (select temp___814 i))))
...
(assert (and (= o44 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)) i)) (and (in_range2 o44) (and (= o44 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c95b)))) i)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c95b))) 0) (= o44 0))))))
