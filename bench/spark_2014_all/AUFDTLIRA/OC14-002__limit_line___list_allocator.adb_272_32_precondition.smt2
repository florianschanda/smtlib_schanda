...
(assert (and (= o77 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 o77)))
(assert (= result13 (ite (in_range7 o77) true false)))
(assert (=> (= result13 true) (and (= o73 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o73))))
(assert (=> (= result13 true) (= result14 (ite (< j o73) true false))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o74 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o75 (get (rec__list_allocator__m__t__allocated model____split_fields3) o74)) (in_range4 o75)))))
(assert (=> (= result13 true) (=> (not (= result14 true)) (= o75 0))))
(assert (=> (= result13 true) (and (= temp___462 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 temp___462))))
(assert (=> (= result13 true) (and (<= 1 temp___462) (<= temp___462 3))))
(assert (=> (= result13 true) (= o69 temp___462)))
...
(assert (=> (= result12 true) (=> (< 1 j) (and (= o67 (get (rec__list_allocator__m__t__allocated model____split_fields3) o66)) (in_range4 o67)))))
(assert (=> (= result12 true) (=> (not (< 1 j)) (= o67 0))))
(assert (=> (= result12 true) (and (= temp___463 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 temp___463))))
(assert (=> (= result12 true) (and (<= 1 temp___463) (<= temp___463 3))))
(assert (=> (= result12 true) (= o62 temp___463)))
...
(assert (not (= j k)))
(assert (and (= o61 (get (rec__list_allocator__m__t__allocated model____split_fields3) k)) (in_range4 o61)))
