...
(assert (=> (not (= smallest1 current1)) (and (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t o11 (mk (to_rep values__first) (to_rep values__last)))) true) (and (= (to_rep (select o11 o7)) (to_rep (select values smallest1))) (and (= (to_rep (select o11 smallest1)) (to_rep (select values o7))) (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 (to_rep values__last))) (=> (and (not (= j1 o7)) (not (= j1 smallest1))) (= (to_rep (select o11 j1)) (to_rep (select values j1)))))))))))
(assert (=> (not (not (= smallest1 current1))) (= o11 values)))
(assert (=> (not (not (= smallest1 current1))) (= o11 values1)))
(assert (= (perm_transitive (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values_last1 (mk (to_rep values_last__first) (to_rep values_last__last))) (mk___t o11 (mk (to_rep values__first) (to_rep values__last)))) true))
...
(assert (forall ((j1 Int)) (=> (and (<= current2 j1) (<= j1 (to_rep values__last))) (<= (to_rep (select values2 current2)) (to_rep (select values2 j1))))))
(assert (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 current2)) (<= (to_rep (select values2 j1)) (to_rep (select values2 (+ j1 1)))))))
...
(assert (= o8 j))
(assert (= o9 (select values2 o8)))
(assert (= o10 (to_rep o9)))
(assert (not (<= current2 (to_rep values__last))))
(check-sat)
(exit)
