...
(assert (and (= o17 (remove o16 (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))))) (and (dynamic_invariant o17 true false true true) (and (= (invariant__ o17) true) (and (= (to_rep1 (last (rt o17))) (- (to_rep1 (last (rt o16))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))) (= (to_rep (select (elts o16) k)) (to_rep (select (elts o17) k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k) (<= k (to_rep1 (last (rt o16))))) (= (to_rep (select (elts o16) k)) (to_rep (select (elts o17) (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) k) (<= k (- (to_rep1 (last (rt o16))) 1))) (= (to_rep (select (elts o16) (+ k 1))) (to_rep (select (elts o17) k))))))))))))
