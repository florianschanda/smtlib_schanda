...
(define-fun dynamic_invariant1 ((temp___expr_236 Int) (temp___is_init_232 Bool) (temp___skip_constant_233 Bool) (temp___do_toplevel_234 Bool) (temp___do_typ_inv_235 Bool)) Bool (=> (or (= temp___is_init_232 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_236)))
...
(assert (forall ((x item)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
...
(declare-const dummy3 tTstack_vectorSP1)
...
(assert (not (<= 100 index)))
(assert (and (= o (+ index 1)) (in_range (+ index 1))))
(assert (= result index))
(assert (= index1 o))
(assert (= (to_rep o1) e))
(assert (not (<= index1 100)))
(check-sat)
(exit)
