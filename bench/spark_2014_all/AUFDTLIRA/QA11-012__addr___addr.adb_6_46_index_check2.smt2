...
(declare-const arr__first integer)
(declare-const arr__last integer)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-fun temp___String_Literal_196 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_196 us_void_param) 1)) 104) (= (to_rep (select (temp___String_Literal_196 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_196 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_196 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_196 us_void_param) 5)) 111)) :pattern ((temp___String_Literal_196 us_void_param)))))
...
(declare-const arr1 (Array Int character))
(declare-const result1 Int)
(declare-const i1 Int)
(declare-const i2 Int)
(assert (= result arr))
(assert (= arr1 (temp___String_Literal_196 Tuple0)))
(assert (= (to_rep1 arr__first) (to_rep1 (first (mk 1 5)))))
(assert (= (to_rep1 arr__last) (to_rep1 (last (mk 1 5)))))
(assert (dynamic_property 1 2147483647 (to_rep1 arr__first) (to_rep1 arr__last)))
(assert (= result1 i))
(assert (= i1 (to_rep1 arr__first)))
(assert (<= (to_rep1 arr__first) i1))
(assert (<= i1 (to_rep1 arr__last)))
(assert (and (<= (to_rep1 arr__first) i2) (<= i2 (to_rep1 arr__last))))
(assert (not (<= (to_rep1 arr__first) i2)))
(check-sat)
(exit)
