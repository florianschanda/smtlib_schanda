...
(assert (and (= o1 (+ x l)) (in_range1 (+ x l))))
(assert (= result1 (ite (<= o1 1000) true false)))
(assert (=> (= result1 true) (and (= o (+ y l)) (in_range1 (+ y l)))))
(assert (=> (= result1 true) (= result (ite (<= o 1000) true false))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (and (= temp___178 (+ y l)) (in_range1 (+ y l))))
(assert (not (<= temp___178 1000)))
(check-sat)
(exit)
