...
(declare-fun user_eq6 (statscount statscount) Bool)
(declare-const dummy6 statscount)
...
(define-fun dynamic_invariant1 ((temp___expr_1511 Int) (temp___is_init_1507 Bool) (temp___skip_constant_1508 Bool) (temp___do_toplevel_1509 Bool) (temp___do_typ_inv_1510 Bool)) Bool (=> (or (= temp___is_init_1507 true) (<= 0 2147483647)) (in_range3 temp___expr_1511)))
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true true) (dynamic_invariant (statscount_image x) true false true true)) :pattern ((statscount_image x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true true) (= (statscount_image x) (let ((temp___1528 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___1528) (first1 temp___1528) (last1 temp___1528))))) :pattern ((statscount_image x)))))
(declare-sort statscountstringi 0)
(declare-fun statscountstringiqtint (statscountstringi) Int)
(assert (forall ((i statscountstringi)) (and (<= 1 (statscountstringiqtint i)) (<= (statscountstringiqtint i) 10))))
...
(declare-datatypes () ((t144b__ref (mk_t144b__ref (t144b__content us_t3)))))
(define-fun t144b__ref___projection ((a t144b__ref)) us_t3 (t144b__content a))
...
(declare-datatypes () ((t147b__ref (mk_t147b__ref (t147b__content us_t4)))))
(define-fun t147b__ref___projection ((a t147b__ref)) us_t4 (t147b__content a))
...
(define-fun dynamic_invariant6 ((temp___expr_1884 Int) (temp___is_init_1880 Bool) (temp___skip_constant_1881 Bool) (temp___do_toplevel_1882 Bool) (temp___do_typ_inv_1883 Bool)) Bool (=> (or (= temp___is_init_1880 true) (<= 1 10)) (in_range4 temp___expr_1884)))
(assert (forall ((temp___2045 Int)) (=> (dynamic_invariant3 temp___2045 true true true true) (forall ((temp___2046 Int)) (= (to_rep (select (screen__writestatsdata__statscountstring__result__aggregate_def temp___2045) temp___2046)) temp___2045)))))
...
(declare-const temp___2049 (Array Int character))
(declare-const temp___20491 t4)
(declare-const temp___2050 (Array Int character))
(declare-const temp___20501 t3)
...
(define-fun temp___20422 () us_t1 (mk___t1 temp___2042 temp___20421))
(assert (in_range3 value))
(assert (and (= temp___20422 (statscount_image value)) (and (dynamic_invariant temp___20422 true false true true) (= temp___20422 (let ((temp___1526 (to_string (attr__ATTRIBUTE_IMAGE3 value)))) (mk___t1 (elts temp___1526) (mk1 (to_rep1 (first (rt temp___1526))) (to_rep1 (last (rt temp___1526))))))))))
(assert (= temp___2042 screen__writestatsdata__statscountstring__data__assume))
(assert (= (mk (to_rep1 (first2 temp___20421)) (to_rep1 (last2 temp___20421))) screen__writestatsdata__statscountstring__data__assume1))
(assert (= result data))
...
(assert (<= (ite (<= (to_rep1 data__first) (to_rep1 data__last)) (+ (- (to_rep1 data__last) (to_rep1 data__first)) 1) 0) 11))
...
(assert (= (mk4 2 (to_rep1 data__last)) temp___20491))
(assert (= (ite (<= (to_rep1 (first8 temp___20491)) (to_rep1 (last8 temp___20491))) (+ (- (to_rep1 (last8 temp___20491)) (to_rep1 (first8 temp___20491))) 1) 0) (ite (<= 1 (- (to_rep1 data__last) 1)) (+ (- (- (to_rep1 data__last) 1) 1) 1) 0)))
(assert (= (slide temp___2049 (to_rep1 (first8 temp___20491)) 1) temp___2050))
(assert (= (mk3 1 (- (to_rep1 data__last) 1)) temp___20501))
(assert (and (= temp___2052 (- (to_rep1 data__last) 1)) (in_range (- (to_rep1 data__last) 1))))
(assert (<= 1 temp___2052))
(assert (not (<= 1 10)))
(check-sat)
(exit)
