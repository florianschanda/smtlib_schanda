...
(assert (forall ((x ar_index)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(declare-fun temp_____aggregate_def_211 (Int) (Array Int integer))
...
(assert (forall ((temp___213 Int)) (=> (dynamic_invariant temp___213 true true true true) (forall ((temp___214 Int)) (= (select (temp_____aggregate_def_211 temp___213) temp___214) rliteral)))))
(define-fun dynamic_invariant1 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 9999)) (in_range temp___expr_159)))
(define-fun dynamic_invariant2 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 10000)) (in_range1 temp___expr_166)))
...
(declare-const r__split_fields15 (Array Int integer))
...
(assert (= r__split_fields1 r__split_fields4))
(assert (= rliteral1 r__split_fields5))
...
(assert (= rliteral2 r__split_fields7))
...
(assert (= (temp_____aggregate_def_211 0) r__split_fields9))
...
(assert (not (= (is_empty (mk___rep (mk___split_fields r__split_fields12 r__split_fields13 r__split_fields14))) true)))
(check-sat)
(exit)
