...
(declare-const temp___2811 index)
(declare-const temp___2812 (Array Int integer))
(declare-const temp___2813 t1)
...
(assert (= s__split_discrs (mk___split_discrs temp___277)))
(assert (= (to_rep o5) x))
(assert (and (<= (to_rep (first2 (rt1 (rec__stack__stack__content s__split_fields3)))) (to_rep1 (rec__stack__stack__top s__split_fields3))) (<= (to_rep1 (rec__stack__stack__top s__split_fields3)) (to_rep (last2 (rt1 (rec__stack__stack__content s__split_fields3)))))))
(assert (= o6 (to_rep1 (rec__stack__stack__top s__split_fields3))))
(assert (= o7 (store (elts1 (rec__stack__stack__content s__split_fields3)) o6 o5)))
(assert (= o7 o8))
(assert (= (rt1 (rec__stack__stack__content s__split_fields3)) o9))
(assert (= (rec__stack__stack__top s__split_fields3) o10))
(assert (= o11 o8))
(assert (= o12 o9))
(assert (= s__split_discrs (mk___split_discrs temp___281)))
(assert (= temp___2811 o10))
(assert (= temp___2812 o11))
(assert (= temp___2813 o12))
(assert (= result3 (mk___split_fields__ref s__split_fields3)))
(assert (= s__split_fields4 (mk___split_fields temp___2811 (mk___t1 temp___2812 temp___2813))))
(assert (= s__split_discrs (mk___split_discrs temp___281)))
(assert (= s__split_fields5 (mk___split_fields__ref s__split_fields4)))
(assert (= s__split_fields6 s__split_fields4))
(assert (not (= (let ((temp___290 (to__ (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t1 s__split_fields1 s__split_fields2)))))) (let ((temp___289 (to_but_top (mk___rep s__split_discrs (us_split_fields__content s__split_fields5))))) (bool_eq (elts temp___289) (to_rep (first (rt temp___289))) (to_rep (last (rt temp___289))) (elts temp___290) (to_rep (first (rt temp___290))) (to_rep (last (rt temp___290)))))) true)))
(check-sat)
(exit)
