...
(define-fun cur_board9 () map__ref1 (mk_map__ref1 cur_board))
...
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (=> (= result3 true) (= (mk_map__ref1 result4) cur_board9))))
...
(assert (=> (not (and (<= 1 del_line1) (<= del_line1 50))) (= cur_board6 cur_board9)))
...
(assert (and (and (and (=> (<= 0 2147483647) (in_range2 num_deleted2)) (=> (<= 1 r7b) (dynamic_property 1 r7b from_line2))) (=> (<= 1 50) (in_range9 to_line8))) (and (<= 1 from_line2) (<= from_line2 r7b))))
(assert (not (in_range1 (+ num_deleted1 (int__content to_line6)))))
(check-sat)
(exit)
