...
(assert (=> (not (= current1 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))) true)))
(assert (=> (not (= current1 0)) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) true) (=> (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2)))) true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i)))) 1)) 0) (< v (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i))) (< (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i)) v))))))))
(assert (=> (not (= current1 0)) (and (and (and (=> (<= 0 100) (in_range6 current2)) (=> (<= 0 100) (in_range6 previous2))) (=> (<= 0 1) (in_range9 d2))) (not (= current2 0)))))
(assert (=> (not (= current1 0)) (= result3 (mk_int__ref temp___7341))))
(assert (=> (not (= current1 0)) (= temp___7342 (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2)))))))
...
(assert (=> (not (= current1 0)) (=> (= result6 true) (and (= o6 current2) (in_range8 current2)))))
...
(assert (=> (not (= current1 0)) (=> (not (= result6 true)) (and (= o8 current2) (in_range8 current2)))))
...
(assert (and (= o11 (int__content previous6)) (in_range8 (int__content previous6))))
(assert (not (< 0 (size (rec__search_trees__search_tree__struct (us_split_fields7 t))))))
(check-sat)
(exit)
