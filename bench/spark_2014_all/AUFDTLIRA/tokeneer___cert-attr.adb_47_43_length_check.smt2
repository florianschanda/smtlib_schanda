...
(declare-const temp___1703 (Array Int character))
(declare-const temp___17031 t4)
(declare-const o18 (Array Int character))
(declare-const temp___1706 (Array Int character))
(declare-const temp___17061 t4)
...
(assert (= (slide fullstring1 (to_rep1 fullstring__first) 1) temp___1703))
(assert (= (mk4 1 (to_rep1 fullstring__last)) temp___17031))
...
(assert (= o18 temp___1706))
(assert (= (mk4 1 (to_rep1 fullstring__last)) temp___17061))
(assert (not (= (ite (<= (to_rep1 (first8 temp___17031)) (to_rep1 (last8 temp___17031))) (+ (- (to_rep1 (last8 temp___17031)) (to_rep1 (first8 temp___17031))) 1) 0) (ite (<= (to_rep1 (first8 temp___17061)) (to_rep1 (last8 temp___17061))) (+ (- (to_rep1 (last8 temp___17061)) (to_rep1 (first8 temp___17061))) 1) 0))))
(check-sat)
(exit)
