...
(assert (forall ((m Int)) (=> (and (<= (- 2147483648) m) (<= m 2147483647)) (=> (and (forall ((n Int)) (=> (and (<= 1 n) (<= n i)) (<= (to_rep (select a n)) m))) (exists ((n Int)) (and (and (<= 1 n) (<= n i)) (= (to_rep (select a n)) m)))) (= m max)))))
(assert (<= 1 (- i 1)))
(assert (not (<= (- i 1) 10)))
(check-sat)
(exit)
