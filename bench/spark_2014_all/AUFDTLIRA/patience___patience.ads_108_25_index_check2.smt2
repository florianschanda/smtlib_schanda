...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o6 i))
(assert (= o7 (select (rec__patience__state__preds (us_split_fields1 s)) o6)))
(assert (= o8 (to_rep o7)))
(assert (= o9 (ite (<= o8 (- (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o3 i))
(assert (= o4 (select (rec__patience__state__preds (us_split_fields1 s)) o3)))
(assert (= o5 (to_rep o4)))
(assert (= o10 (ite (<= (- 1) o5) true false)))
(assert (= result6 (ite (= o10 true) o9 false)))
(assert (=> (= result6 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result6 true) (= o i)))
(assert (=> (= result6 true) (= o1 (select (rec__patience__state__preds (us_split_fields1 s)) o))))
(assert (=> (= result6 true) (= o2 (to_rep o1))))
(assert (=> (= result6 true) (= result5 (ite (< o2 i) true false))))
