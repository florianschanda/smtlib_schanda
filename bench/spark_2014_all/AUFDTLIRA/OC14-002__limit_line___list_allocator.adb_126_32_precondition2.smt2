...
(assert (and (= o56 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 o56)))
(assert (= result13 (ite (in_range7 o56) true false)))
(assert (=> (= result13 true) (and (= o52 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o52))))
(assert (=> (= result13 true) (= result14 (ite (< j o52) true false))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o53 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o54 (get (rec__list_allocator__m__t__allocated model____split_fields3) o53)) (in_range4 o54)))))
(assert (=> (= result13 true) (=> (not (= result14 true)) (= o54 0))))
(assert (=> (= result13 true) (and (= temp___433 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 temp___433))))
(assert (=> (= result13 true) (and (<= 1 temp___433) (<= temp___433 3))))
(assert (=> (= result13 true) (= o48 temp___433)))
(assert (=> (= result13 true) (= o49 (select data3 o48))))
(assert (=> (= result13 true) (= o50 (us_split_fields3 o49))))
(assert (=> (= result13 true) (= o51 (rec__list_allocator__cell__next o50))))
(assert (=> (= result13 true) (= o55 (to_rep o51))))
(assert (=> (= result13 true) (= result12 (ite (= o55 o54) true false))))
(assert (=> (not (= result13 true)) (= result12 false)))
(assert (=> (= result12 true) (=> (< 1 j) (and (= o45 (- j 1)) (in_range2 (- j 1))))))
(assert (=> (= result12 true) (=> (< 1 j) (and (= o46 (get (rec__list_allocator__m__t__allocated model____split_fields3) o45)) (in_range4 o46)))))
(assert (=> (= result12 true) (=> (not (< 1 j)) (= o46 0))))
(assert (=> (= result12 true) (and (= temp___434 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 temp___434))))
(assert (=> (= result12 true) (and (<= 1 temp___434) (<= temp___434 3))))
(assert (=> (= result12 true) (= o41 temp___434)))
(assert (=> (= result12 true) (= o42 (select data3 o41))))
(assert (=> (= result12 true) (= o43 (us_split_fields3 o42))))
(assert (=> (= result12 true) (= o44 (rec__list_allocator__cell__prev o43))))
(assert (=> (= result12 true) (= o47 (to_rep o44))))
...
(assert (not (= j k)))
(assert (and (= o40 (get (rec__list_allocator__m__t__allocated model____split_fields3) k)) (in_range4 o40)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
