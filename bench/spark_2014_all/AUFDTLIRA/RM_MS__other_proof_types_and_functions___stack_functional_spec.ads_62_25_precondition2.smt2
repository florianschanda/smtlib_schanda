...
(assert (and (= o9 (count (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) (and (in_range3 o9) (= o9 (to_rep1 (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))))))))
(assert (= o10 (ite (<= i o9) true false)))
(assert (= result4 (ite (<= 1 i) o10 false)))
(assert (= result4 true))
...
(assert (and (= (mk___rep (mk___split_fields o11 o12)) (state__2 (us_split_fields__content my_stack__split_fields5))) (= (us_split_fields__content my_stack__split_fields5) (mk___split_fields o11 o12))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
