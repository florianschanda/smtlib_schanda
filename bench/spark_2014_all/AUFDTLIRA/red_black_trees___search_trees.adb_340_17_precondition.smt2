...
(assert (= result4 true))
(assert (and (= result5 (ordered_leafs f_old root values)) (= (= result5 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old root) i))) true) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old root) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) i))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) i)))) 1)) 0) (< (to_rep (select values j)) (to_rep (select values i))) (< (to_rep (select values i)) (to_rep (select values j))))))))))))
(assert (= result5 true))
