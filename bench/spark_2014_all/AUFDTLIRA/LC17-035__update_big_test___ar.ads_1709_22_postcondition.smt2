...
(declare-fun temp_____aggregate_def_3785 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
(declare-fun temp_____aggregate_def_3791 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (forall ((temp___3787 (Array Int us_rep))) (forall ((temp___3788 Int)) (forall ((temp___3789 us_rep)) (let ((temp___3786 (temp_____aggregate_def_3785 temp___3787 temp___3788 temp___3789))) (=> (dynamic_invariant1 temp___3788 true true true true) (forall ((temp___3790 Int)) (ite (= temp___3790 temp___3788) (= (select temp___3786 temp___3790) temp___3789) (= (select temp___3786 temp___3790) (select temp___3787 temp___3790))))))))))
(assert (forall ((temp___3793 (Array Int et1))) (forall ((temp___3794 Int) (temp___3795 Int)) (let ((temp___3792 (temp_____aggregate_def_3791 temp___3793 temp___3794 temp___3795))) (=> (and (dynamic_invariant temp___3794 true true true true) (dynamic_invariant2 temp___3795 true true true true)) (forall ((temp___3796 Int)) (ite (= temp___3796 temp___3794) (= (to_rep (select temp___3792 temp___3796)) temp___3795) (= (select temp___3792 temp___3796) (select temp___3793 temp___3796)))))))))
...
(assert (= a4 a5))
(assert (= a6 a4))
(assert (not (= (bool_eq2 a5 1 16 (temp_____aggregate_def_3785 b i (mk___rep (mk___split_fields (temp_____aggregate_def_3791 d j e) (rec__ar__rofa1__t1 (us_split_fields1 c))))) 1 16) true)))
(check-sat)
(exit)
