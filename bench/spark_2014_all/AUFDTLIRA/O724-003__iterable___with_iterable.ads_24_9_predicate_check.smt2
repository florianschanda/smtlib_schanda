...
(define-fun dynamic_invariant ((temp___expr_191 us_rep) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool) (temp___do_typ_inv_190 Bool)) Bool (and (=> (not (= temp___skip_constant_188 true)) (in_range2 101 temp___expr_191)) (=> (= temp___do_toplevel_189 true) (=> (= temp___is_init_187 true) (and (<= 1 (to_rep (rec__with_iterable__cursor__i (us_split_fields1 temp___expr_191)))) (<= (to_rep (rec__with_iterable__cursor__i (us_split_fields1 temp___expr_191))) (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 temp___expr_191)))))))))
...
(define-fun dynamic_invariant3 ((temp___expr_180 us_rep) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (= temp___do_toplevel_178 true) (=> (= temp___is_init_176 true) (and (<= 1 (to_rep (rec__with_iterable__cursor__i (us_split_fields1 temp___expr_180)))) (<= (to_rep (rec__with_iterable__cursor__i (us_split_fields1 temp___expr_180))) (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 temp___expr_180))))))))
(define-fun dynamic_predicate1 ((temp___183 us_rep)) Bool (and (<= 1 (to_rep (rec__with_iterable__cursor__i (us_split_fields1 temp___183)))) (<= (to_rep (rec__with_iterable__cursor__i (us_split_fields1 temp___183))) (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 temp___183))))))
(declare-const o Int)
(declare-const o1 Int)
(declare-const o2 natural)
(declare-const o3 natural)
(declare-const temp___242 natural)
(declare-const temp___2421 natural)
(assert (dynamic_invariant i10s true false true true))
(assert (dynamic_invariant cu true false true true))
(assert (= (has_element a cu) true))
(assert (and (= o (+ (to_rep (rec__with_iterable__cursor__i (us_split_fields1 cu))) 1)) (in_range (+ (to_rep (rec__with_iterable__cursor__i (us_split_fields1 cu))) 1))))
(assert (and (= o1 o) (in_range1 o)))
(assert (= (to_rep o2) o1))
(assert (= o2 o3))
(assert (= (us_split_discrs1 cu) (mk___split_discrs temp___242)))
(assert (= temp___2421 o3))
(assert (not (dynamic_predicate (mk___rep (mk___split_discrs temp___242) (mk___split_fields temp___2421)))))
(check-sat)
(exit)
