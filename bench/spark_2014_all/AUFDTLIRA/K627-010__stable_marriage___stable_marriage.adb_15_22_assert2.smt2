...
(declare-const temp___447 Int)
(declare-const temp___445 (Array Int Bool))
...
(assert (= rank1 1))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= temp___447 rank1)))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= temp___445 seen1)))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (= (= (select seen2 g1) true) (exists ((prev Int)) (and (and (<= 1 prev) (<= prev (- rank2 1))) (= (to_rep (select r1 prev)) g1))))))))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (and (=> (<= 1 64) (in_range2 rank2)) (and (<= 1 rank2) (<= rank2 64)))))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= seen2 result2)))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= seen3 (store seen2 (to_rep (select r1 rank2)) (distinct 1 0)))))
...
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= (mk_int__ref rank5) (mk_int__ref rank3))))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= (mk_map__ref1 seen6) (mk_map__ref1 seen4))))
...
(assert (= (bool_eq1 seen6 1 64 (temp_____aggregate_def_448 (distinct 1 0)) 1 64) true))
(declare-const g1 Int)
(assert (<= 1 g1))
(assert (<= g1 64))
(assert (not (= (select seen6 g1) true)))
(check-sat)
(exit)
