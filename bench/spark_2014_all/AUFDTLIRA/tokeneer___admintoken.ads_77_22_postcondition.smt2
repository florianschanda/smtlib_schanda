...
(declare-fun user_eq23 (presencet presencet) Bool)
(declare-const dummy23 presencet)
...
(define-fun dynamic_invariant1 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 1)) (in_range14 temp___expr_221)))
...
(declare-fun user_eq24 (tokenidt tokenidt) Bool)
(declare-const dummy24 tokenidt)
...
(define-fun dynamic_invariant2 ((temp___expr_579 Int) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool) (temp___do_typ_inv_578 Bool)) Bool (=> (or (= temp___is_init_575 true) (<= 0 4294967295)) (in_range15 temp___expr_579)))
(declare-sort tryt 0)
...
(declare-fun user_eq25 (tryt tryt) Bool)
(declare-const dummy25 tryt)
...
(define-fun dynamic_invariant3 ((temp___expr_586 Int) (temp___is_init_582 Bool) (temp___skip_constant_583 Bool) (temp___do_toplevel_584 Bool) (temp___do_typ_inv_585 Bool)) Bool (=> (or (= temp___is_init_582 true) (<= 0 2)) (in_range16 temp___expr_586)))
(declare-sort adminprivileget 0)
(define-fun in_range17 ((x Int)) Bool (and (<= 1 x) (<= x 3)))
...
(declare-fun user_eq26 (adminprivileget adminprivileget) Bool)
(declare-const dummy26 adminprivileget)
...
(define-fun dynamic_invariant10 ((temp___expr_670 Int) (temp___is_init_666 Bool) (temp___skip_constant_667 Bool) (temp___do_toplevel_668 Bool) (temp___do_typ_inv_669 Bool)) Bool (=> (or (= temp___is_init_666 true) (<= 1901 2099)) (in_range1 temp___expr_670)))
(define-fun dynamic_invariant11 ((temp___expr_677 Int) (temp___is_init_673 Bool) (temp___skip_constant_674 Bool) (temp___do_toplevel_675 Bool) (temp___do_typ_inv_676 Bool)) Bool (=> (or (= temp___is_init_673 true) (<= 1 12)) (in_range2 temp___expr_677)))
(define-fun dynamic_invariant12 ((temp___expr_684 Int) (temp___is_init_680 Bool) (temp___skip_constant_681 Bool) (temp___do_toplevel_682 Bool) (temp___do_typ_inv_683 Bool)) Bool (=> (or (= temp___is_init_680 true) (<= 1 31)) (in_range3 temp___expr_684)))
(define-fun dynamic_invariant13 ((temp___expr_716 Int) (temp___is_init_712 Bool) (temp___skip_constant_713 Bool) (temp___do_toplevel_714 Bool) (temp___do_typ_inv_715 Bool)) Bool (=> (or (= temp___is_init_712 true) (<= 0 86399999)) (in_range4 temp___expr_716)))
(define-fun dynamic_invariant14 ((temp___expr_1220 Int) (temp___is_init_1216 Bool) (temp___skip_constant_1217 Bool) (temp___do_toplevel_1218 Bool) (temp___do_typ_inv_1219 Bool)) Bool (=> (or (= temp___is_init_1216 true) (<= 1 3)) (in_range17 temp___expr_1220)))
(define-fun dynamic_invariant15 ((temp___expr_1227 Int) (temp___is_init_1223 Bool) (temp___skip_constant_1224 Bool) (temp___do_toplevel_1225 Bool) (temp___do_typ_inv_1226 Bool)) Bool (=> (or (= temp___is_init_1223 true) (<= 0 5)) (in_range9 temp___expr_1227)))
(define-fun dynamic_invariant16 ((temp___expr_553 Int) (temp___is_init_549 Bool) (temp___skip_constant_550 Bool) (temp___do_toplevel_551 Bool) (temp___do_typ_inv_552 Bool)) Bool (=> (or (= temp___is_init_549 true) (<= 0 4294967295)) (in_range8 temp___expr_553)))
...
(assert (=> (<= 0 1) (in_range14 tokenpresence)))
(assert (=> (<= 0 2) (in_range16 tokentry)))
(assert (=> (<= 0 4294967295) (in_range15 tokenid)))
(assert (and (and (not (= (isgood (let ((subject idcert__split_fields)) idcert__split_fields1)) true)) (and (not (= (authcertvalid (let ((subject authcert__split_fields)) authcert__split_fields1)) true)) (not (in_range17 (theauthcertrole (let ((subject authcert__split_fields)) authcert__split_fields1)))))) (and (and (in_range14 tokenpresence1) (in_range16 tokentry1)) (in_range15 tokenid1))))
...
(assert (= authcert__split_fields2 (let ((subject authcert__split_fields)) (mk___split_fields__ref5 authcert__split_fields1))))
...
(assert (not (not (= (authcertvalid (us_split_fields__content5 authcert__split_fields2)) true))))
(check-sat)
(exit)
