...
(assert (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))) (= temp___231 found1)))
(assert (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))) (= temp___230 i1)))
(assert (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))) (= temp___229 location1)))
(assert (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))) (or (and (and (and (= i1 i6) (and (= location2 location7) (= found2 found7))) (and (= i7 i1) (and (= location8 location2) (= found8 found2)))) (and (= (to_rep1 (select (elts a) i1)) val__) (and (and (= found1 result3) (= found2 (distinct 1 0))) (and (= location1 result4) (= location2 i1))))) (and (and (not (= (to_rep1 (select (elts a) i1)) val__)) (and (= location2 location1) (= found2 found1))) (and (and (and (= i14 (mk_int__ref i4)) (and (= location15 (mk_int__ref location5)) (= found16 (mk_bool__ref found5)))) (and (= i7 i5) (and (= location8 location6) (= found8 found6)))) (and (and (forall ((j Int)) (=> (and (<= (to_rep (first (rt a))) j) (<= j i2)) (not (= (to_rep1 (select (elts a) j)) val__)))) (not (= found3 true))) (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range3 location3)) (=> (<= (to_rep (first (rt a))) (to_rep (last (rt a)))) (dynamic_property1 (to_rep (first (rt a))) (to_rep (last (rt a))) i2))) (and (<= (to_rep (first (rt a))) i2) (<= i2 (to_rep (last (rt a)))))) (or (and (and (and (= i2 i4) (and (= location3 location5) (= found3 found5))) (and (= i5 i2) (and (= location6 location3) (= found6 found3)))) (= i2 (to_rep (last (rt a))))) (and (not (= i2 (to_rep (last (rt a))))) (and (and (and (= i3 i4) (and (= location4 location5) (= found4 found5))) (and (= i5 i3) (and (= location6 location4) (= found6 found4)))) (and (and (= i2 result5) (= i3 (+ i2 1))) (and (= (to_rep1 (select (elts a) i3)) val__) (and (and (= found3 result6) (= found4 (distinct 1 0))) (and (= location3 result7) (= location4 i3)))))))))))))))
(assert (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))) (= i8 i14)))
(assert (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))) (= location9 location15)))
(assert (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))) (= found15 found16)))
(assert (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))) (= i9 i7)))
(assert (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))) (= location10 location8)))
(assert (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))) (= found10 found8)))
(assert (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))) (= i10 i8)))
(assert (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))) (= location11 location9)))
(assert (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))) (= found11 found15)))
(assert (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))) (= i11 i9)))
(assert (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))) (= location12 location10)))
(assert (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))) (= found12 found10)))
(assert (=> (not (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a)))))) (= i10 (mk_int__ref i1))))
(assert (=> (not (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a)))))) (= location11 (mk_int__ref location1))))
(assert (=> (not (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a)))))) (= found11 (mk_bool__ref found1))))
(assert (=> (not (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a)))))) (= i11 i1)))
(assert (=> (not (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a)))))) (= location12 location1)))
(assert (=> (not (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a)))))) (= found12 found1)))
(assert (= i12 i10))
...
(assert (and (= o1 (has_value_exc a (int__content location13) val__)) (= (= o1 true) (exists ((i15 Int)) (and (and (<= (to_rep (first (rt a))) i15) (<= i15 (int__content location13))) (and (< i15 (int__content location13)) (= (to_rep1 (select (elts a) i15)) val__)))))))
(assert (= o2 (ite (not (= o1 true)) true false)))
(assert (and (= o (has_value_inc a (to_rep (last (rt a))) val__)) (= (= o true) (exists ((i15 Int)) (and (and (<= (to_rep (first (rt a))) i15) (<= i15 (to_rep (last (rt a))))) (= (to_rep1 (select (elts a) i15)) val__))))))
(assert (not (<= (to_rep (first (rt a))) (int__content location13))))
(check-sat)
(exit)
