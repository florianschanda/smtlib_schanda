...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__aggregate_checks__do_wrong_aggregate__wrapper__content integer)))))
(define-fun us_split_fields_Content__projection ((a1 us_split_fields)) integer (rec__aggregate_checks__do_wrong_aggregate__wrapper__content a1))
...
(define-fun bool_eq2 ((a1 us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__aggregate_checks__do_wrong_aggregate__wrapper__content (us_split_fields1 a1))) (to_rep (rec__aggregate_checks__do_wrong_aggregate__wrapper__content (us_split_fields1 b)))) true false))
...
(declare-const aggregate_checks__do_wrong_aggregate__wrapper__content__first__bit Int)
(declare-const aggregate_checks__do_wrong_aggregate__wrapper__content__last__bit Int)
(declare-const aggregate_checks__do_wrong_aggregate__wrapper__content__position Int)
(assert (<= 0 aggregate_checks__do_wrong_aggregate__wrapper__content__first__bit))
(assert (< aggregate_checks__do_wrong_aggregate__wrapper__content__first__bit aggregate_checks__do_wrong_aggregate__wrapper__content__last__bit))
(assert (<= 0 aggregate_checks__do_wrong_aggregate__wrapper__content__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((wrapper__ref (mk_wrapper__ref (wrapper__content us_rep)))))
(define-fun wrapper__ref___projection ((a1 wrapper__ref)) us_rep (wrapper__content a1))
(define-fun dynamic_invariant1 ((temp___expr_201 us_rep) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= first2 last2)) (dynamic_property1 first2 last2 (to_rep (rec__aggregate_checks__do_wrong_aggregate__wrapper__content (us_split_fields1 temp___expr_201))))))
(declare-const should_fail us_rep)
...
(define-fun dynamic_invariant5 ((temp___expr_194 Int) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool (=> (or (= temp___is_init_190 true) (<= first2 last2)) (dynamic_property1 first2 last2 temp___expr_194)))
(assert (= first2 (first1 a)))
(assert (= last2 (last1 a)))
(assert (= should_fail (mk___rep (mk___split_fields (of_rep 0)))))
