...
(assert (= (int__content i8) (to_rep (rec__patience__state__numstacks s__split_fields10))))
(assert (= result11 i8))
(assert (= i10 (to_rep (rec__patience__state__numstacks s__split_fields10))))
(assert (and (= o45 (+ (to_rep (rec__patience__state__numstacks s__split_fields10)) 1)) (in_range2 (+ (to_rep (rec__patience__state__numstacks s__split_fields10)) 1))))
...
(assert (and (<= 0 i10) (<= i10 99)))
(assert (= o55 i10))
(assert (= o56 (store (rec__patience__state__stacksizes s__split_fields11) o55 rliteral)))
(assert (= (rec__patience__state__numelts s__split_fields11) o57))
(assert (= (rec__patience__state__values s__split_fields11) o58))
(assert (= (rec__patience__state__numstacks s__split_fields11) o59))
(assert (= o56 o60))
(assert (= (rec__patience__state__stacks s__split_fields11) o61))
(assert (= (rec__patience__state__posstack s__split_fields11) o62))
(assert (= (rec__patience__state__posheight s__split_fields11) o63))
(assert (= (rec__patience__state__preds s__split_fields11) o64))
(assert (= temp___639 o57))
(assert (= temp___6391 o58))
(assert (= temp___6392 o59))
(assert (= temp___6393 o60))
(assert (= temp___6394 o61))
(assert (= temp___6395 o62))
(assert (= temp___6396 o63))
(assert (= temp___6397 o64))
(assert (= result13 (mk___split_fields__ref s__split_fields11)))
(assert (= s__split_fields12 (mk___split_fields temp___639 temp___6391 temp___6392 temp___6393 temp___6394 temp___6395 temp___6396 temp___6397)))
(assert (and (= o65 idx1) (in_range2 idx1)))
(assert (= (to_rep o66) o65))
(assert (= o67 (store (select (rec__patience__state__stacks s__split_fields12) i10) 0 o66)))
(assert (and (<= 0 i10) (<= i10 99)))
(assert (= o68 i10))
(assert (= o69 (store (rec__patience__state__stacks s__split_fields12) o68 o67)))
(assert (= o70 (mk___split_fields (rec__patience__state__numelts s__split_fields12) (rec__patience__state__values s__split_fields12) (rec__patience__state__numstacks s__split_fields12) (rec__patience__state__stacksizes s__split_fields12) o69 (rec__patience__state__posstack s__split_fields12) (rec__patience__state__posheight s__split_fields12) (rec__patience__state__preds s__split_fields12))))
(assert (= temp___644 (mk___rep o70)))
(assert (= result14 (mk___split_fields__ref s__split_fields12)))
(assert (= s__split_fields13 (us_split_fields1 temp___644)))
(assert (and (= o71 i10) (in_range2 i10)))
(assert (= (to_rep o72) o71))
(assert (not (<= idx1 99)))
(check-sat)
(exit)
