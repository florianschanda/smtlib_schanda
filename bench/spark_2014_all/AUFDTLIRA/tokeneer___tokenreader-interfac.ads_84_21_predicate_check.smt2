...
(define-fun dynamic_invariant ((temp___expr_349 us_t1) (temp___is_init_345 Bool) (temp___skip_constant_346 Bool) (temp___do_toplevel_347 Bool) (temp___do_typ_inv_348 Bool)) Bool (and (=> (not (= temp___skip_constant_346 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_349) (last3 temp___expr_349))) (=> (= temp___do_toplevel_347 true) (=> (= temp___is_init_345 true) (and (let ((temp___351 (of_array2 (to_array1 temp___expr_349) (first3 temp___expr_349) (last3 temp___expr_349)))) (and (= (first5 temp___351) 1) (<= 0 (last5 temp___351)))) (<= (last3 temp___expr_349) 1000))))))
(define-fun dynamic_predicate ((temp___353 us_t1)) Bool (and (let ((temp___355 (of_array2 (to_array1 temp___353) (first3 temp___353) (last3 temp___353)))) (and (= (first5 temp___355) 1) (<= 0 (last5 temp___355)))) (<= (last3 temp___353) 1000)))
...
(define-fun responsecodet__ref___2__projection ((a responsecodet__ref)) responsecodet (responsecodet__content a))
(define-fun dynamic_invariant1 ((temp___expr_2064 Int) (temp___is_init_2060 Bool) (temp___skip_constant_2061 Bool) (temp___do_toplevel_2062 Bool) (temp___do_typ_inv_2063 Bool)) Bool (=> (or (= temp___is_init_2060 true) (<= 0 20)) (in_range3 temp___expr_2064)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_312 us_t2) (temp___is_init_308 Bool) (temp___skip_constant_309 Bool) (temp___do_toplevel_310 Bool) (temp___do_typ_inv_311 Bool)) Bool (and (=> (not (= temp___skip_constant_309 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_312) (last5 temp___expr_312))) (=> (= temp___do_toplevel_310 true) (=> (= temp___is_init_308 true) (and (= (first5 temp___expr_312) 1) (<= 0 (last5 temp___expr_312)))))))
(define-fun dynamic_predicate1 ((temp___315 us_t2)) Bool (and (= (first5 temp___315) 1) (<= 0 (last5 temp___315))))
(declare-const temp___2091 (Array Int character))
(declare-const temp___20911 t1)
(assert (in_range3 x))
(assert (dynamic_property1 1 2147483647 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))))
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___2091))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___20911))
(assert (not (dynamic_predicate (mk___t1 temp___2091 temp___20911))))
(check-sat)
(exit)
