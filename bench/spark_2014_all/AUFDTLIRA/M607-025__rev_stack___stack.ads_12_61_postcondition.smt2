...
(define-fun stack__model__to__result12 () us_t (mk___t stack__model__to__result2 stack__model__to__result3))
...
(assert (= (mk___t stack__model__to__result6 stack__model__to__result7) stack__model__to__result12))
(assert (=> (<= 1 (to_rep1 (rec__stack__stack__top (us_split_fields1 s)))) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 (to_rep1 (rec__stack__stack__top (us_split_fields1 s)))) (<= (to_rep1 (rec__stack__stack__top (us_split_fields1 s))) 100)))))
(assert (= o (rec__stack__stack__content (us_split_fields1 s))))
(assert (= o temp___238))
(assert (= (mk1 1 (to_rep1 (rec__stack__stack__top (us_split_fields1 s)))) temp___2381))
(assert (dynamic_property 1 2147483647 (to_rep (first2 temp___2381)) (to_rep (last2 temp___2381))))
(assert (= temp___238 o1))
(assert (= (mk (to_rep (first2 temp___2381)) (to_rep (last2 temp___2381))) o2))
...
(assert (= (mk_m__ref (mk___t stack__model__to__result8 stack__model__to__result9)) (mk_m__ref (mk___t stack__model__to__result4 stack__model__to__result5))))
...
(assert (not (<= 0 (to_rep (last stack__model__to__result9)))))
(check-sat)
(exit)
