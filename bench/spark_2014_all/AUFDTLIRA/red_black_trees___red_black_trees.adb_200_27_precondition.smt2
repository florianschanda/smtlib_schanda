...
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep2 (select a temp___idx_156)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_156)))))))))))
...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__search_trees__search_tree__root extended_index_type) (rec__search_trees__search_tree__struct us_rep1) (rec__search_trees__search_tree__values (Array Int natural))))))
...
(define-fun us_split_fields_Struct__projection ((a us_split_fields4)) us_rep1 (rec__search_trees__search_tree__struct a))
...
(define-fun bool_eq4 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (= (to_rep (rec__search_trees__search_tree__root (us_split_fields5 a))) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 b)))) (= (bool_eq2 (rec__search_trees__search_tree__struct (us_split_fields5 a)) (rec__search_trees__search_tree__struct (us_split_fields5 b))) true)) (= (bool_eq3 (rec__search_trees__search_tree__values (us_split_fields5 a)) 1 100 (rec__search_trees__search_tree__values (us_split_fields5 b)) 1 100) true)) true false))
...
(declare-datatypes () ((search_tree__ref (mk_search_tree__ref (search_tree__content us_rep2)))))
(define-fun search_tree__ref___projection ((a search_tree__ref)) us_rep2 (search_tree__content a))
(declare-fun size1 (us_rep2) Int)
(declare-fun size__function_guard1 (Int us_rep2) Bool)
(define-fun dynamic_invariant ((temp___expr_184 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool) (temp___do_typ_inv_183 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 100)) (in_range1 temp___expr_184)))
...
(declare-fun ordered_leafs (us_rep1 Int (Array Int natural)) Bool)
(declare-fun ordered_leafs__function_guard (Bool us_rep1 Int (Array Int natural)) Bool)
...
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__tree_model__path_type__a us_rep3) (rec__tree_model__path_type__k Bool)))))
(define-fun us_split_fields_A__projection ((a us_split_fields6)) us_rep3 (rec__tree_model__path_type__a a))
...
(define-fun bool_eq6 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (user_eq9 (rec__tree_model__path_type__a (us_split_fields7 a)) (rec__tree_model__path_type__a (us_split_fields7 b))) true) (= (rec__tree_model__path_type__k (us_split_fields7 a)) (rec__tree_model__path_type__k (us_split_fields7 b)))) true false))
...
(assert (forall ((t us_rep2)) (! (=> (and (dynamic_invariant1 t true true true true) (not (= (size1 t) 0))) (dynamic_invariant2 (model__ t) true false true true)) :pattern ((model__ t)))))
(assert (forall ((t us_rep2)) (! (=> (dynamic_invariant1 t true true true true) (= (model__ t) (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 t)) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 t)))))) :pattern ((model__ t)))))
...
(declare-fun user_eq12 (color_type color_type) Bool)
(declare-const dummy12 color_type)
...
(assert (forall ((x color_type)) (! (in_range5 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x Int)) (! (=> (in_range5 x) (= (to_rep3 (of_rep3 x)) x)) :pattern ((to_rep3 (of_rep3 x))))))
(declare-datatypes () ((map__ref4 (mk_map__ref4 (map__content4 (Array Int color_type))))))
(declare-fun slide4 ((Array Int color_type) Int Int) (Array Int color_type))
(assert (forall ((a (Array Int color_type))) (forall ((first Int)) (! (= (slide4 a first first) a) :pattern ((slide4 a first first))))))
(assert (forall ((a (Array Int color_type))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide4 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide4 a old_first new_first) i))))))))
...
(assert (forall ((a (Array Int color_type)) (b (Array Int color_type))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_157 Int)) (=> (and (<= a__first temp___idx_157) (<= temp___idx_157 a__last)) (= (to_rep3 (select a temp___idx_157)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_157)))))))))))
(declare-const dummy13 (Array Int color_type))
...
(declare-fun user_eq13 ((Array Int color_type) (Array Int color_type)) Bool)
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__red_black_trees__rbt__struct us_rep2) (rec__red_black_trees__rbt__color (Array Int color_type))))))
(define-fun us_split_fields_Struct__2__projection ((a us_split_fields10)) us_rep2 (rec__red_black_trees__rbt__struct a))
(define-fun us_split_fields_Color__projection ((a us_split_fields10)) (Array Int color_type) (rec__red_black_trees__rbt__color a))
...
(define-fun bool_eq11 ((a us_rep6) (b us_rep6)) Bool (ite (and (= (bool_eq4 (rec__red_black_trees__rbt__struct (us_split_fields11 a)) (rec__red_black_trees__rbt__struct (us_split_fields11 b))) true) (= (bool_eq10 (rec__red_black_trees__rbt__color (us_split_fields11 a)) 1 100 (rec__red_black_trees__rbt__color (us_split_fields11 b)) 1 100) true)) true false))
...
(declare-fun nb_blacks (us_rep6) (Array Int us_rep5))
(declare-fun nb_blacks__function_guard ((Array Int us_rep5) us_rep6) Bool)
...
(define-fun dynamic_invariant3 ((temp___expr_534 us_rep6) (temp___is_init_530 Bool) (temp___skip_constant_531 Bool) (temp___do_toplevel_532 Bool) (temp___do_typ_inv_533 Bool)) Bool (and (=> (= temp___do_typ_inv_533 true) (let ((temp___535 (rec__red_black_trees__rbt__struct (us_split_fields11 temp___expr_534)))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields5 temp___535))) 0) (= (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___535))) 0) (and (and (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___535))) 0)) (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields5 temp___535)) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___535)))) true)) (= (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields5 temp___535)) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 temp___535))) (rec__search_trees__search_tree__values (us_split_fields5 temp___535))) true))))) (=> (= temp___do_typ_inv_533 true) (= (tree_structure (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields11 temp___expr_534))))) true))))
(define-fun default_initial_assumption2 ((temp___expr_540 us_rep6) (temp___skip_top_level_541 Bool)) Bool (and (and (and (and (= (to_rep (rec__search_trees__search_tree__root (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields11 temp___expr_540))))) 0) (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields11 temp___expr_540))))))) 0) (forall ((temp___545 Int)) (=> (and (<= 1 temp___545) (<= temp___545 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields11 temp___expr_540)))))) temp___545)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields11 temp___expr_540)))))) temp___545)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields11 temp___expr_540)))))) temp___545)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields11 temp___expr_540)))))) temp___545)))) 2))))) (= (size (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields11 temp___expr_540))))) 0))) (= (rec__search_trees__search_tree__values (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields11 temp___expr_540)))) (temp_____aggregate_def_434 0))) (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields11 temp___expr_540))) 0)) (= (rec__red_black_trees__rbt__color (us_split_fields11 temp___expr_540)) (temp_____aggregate_def_549 0))))
...
(assert (forall ((t us_rep6)) (! (=> (and (dynamic_invariant3 t true true true true) (not (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields11 t))) 0))) (let ((result (nb_blacks t))) (and (= (bool_eq8 (select result 0) (mk___rep4 (mk___split_fields4 (distinct 1 0) rliteral rliteral))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (let ((temp___616 (model__ (rec__red_black_trees__rbt__struct (us_split_fields11 t))))) (select temp___616 i)))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields9 (select result i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields9 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields11 t)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields9 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields11 t)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields9 (select result i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields9 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields11 t)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields9 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields11 t)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields9 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields11 t)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields9 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields11 t)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields9 (select result i)))) (+ (ite (= (to_rep3 (let ((temp___615 (rec__red_black_trees__rbt__color (us_split_fields11 t)))) (select temp___615 i))) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields9 (select result (peek (rec__red_black_trees__rbt__struct (us_split_fields11 t)) i 0)))))))))))))) :pattern ((nb_blacks t)))))
(declare-const t us_rep6)
...
(define-fun dynamic_invariant5 ((temp___expr_517 Int) (temp___is_init_513 Bool) (temp___skip_constant_514 Bool) (temp___do_toplevel_515 Bool) (temp___do_typ_inv_516 Bool)) Bool (=> (or (= temp___is_init_513 true) (<= 0 1)) (in_range5 temp___expr_517)))
(assert (forall ((temp___551 Int)) (=> (dynamic_invariant5 temp___551 true true true true) (forall ((temp___552 Int)) (= (to_rep3 (select (temp_____aggregate_def_549 temp___551) temp___552)) temp___551)))))
(declare-fun same_nb_blacks (us_rep6) Bool)
(declare-fun same_nb_blacks__function_guard (Bool us_rep6) Bool)
(assert true)
(assert (forall ((t1 us_rep6)) (! (= (= (same_nb_blacks t1) true) (or (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields11 t1))) 0) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (let ((temp___585 (model__ (rec__red_black_trees__rbt__struct (us_split_fields11 t1))))) (select temp___585 i)))) true) (= (rec__red_black_trees__black_count__status (us_split_fields9 (let ((temp___584 (nb_blacks t1))) (select temp___584 i)))) true)))))) :pattern ((same_nb_blacks t1)))))
(declare-fun parent (us_rep2 Int) Int)
(declare-fun parent__function_guard (Int us_rep2 Int) Bool)
(assert true)
(assert (forall ((t1 us_rep6)) (! (= (= (invariant__ t1) true) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (or (= (parent (rec__red_black_trees__rbt__struct (us_split_fields11 t1)) i) 0) (= (to_rep3 (let ((temp___589 (rec__red_black_trees__rbt__color (us_split_fields11 t1)))) (select temp___589 (parent (rec__red_black_trees__rbt__struct (us_split_fields11 t1)) i)))) 1)) (= (to_rep3 (let ((temp___588 (rec__red_black_trees__rbt__color (us_split_fields11 t1)))) (select temp___588 i))) 0)))) (= (same_nb_blacks t1) true))) :pattern ((invariant__ t1)))))
(define-fun dynamic_invariant6 ((temp___expr_177 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool) (temp___do_typ_inv_176 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= 1 100)) (in_range4 temp___expr_177)))
(define-fun dynamic_invariant7 ((temp___expr_191 Int) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool) (temp___do_typ_inv_190 Bool)) Bool (=> (or (= temp___is_init_187 true) (<= 0 2)) (in_range2 temp___expr_191)))
(declare-sort direction 0)
(define-fun in_range6 ((x Int)) Bool (and (<= 0 x) (<= x 1)))
(declare-fun attr__ATTRIBUTE_IMAGE6 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check6 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE6 (us_image) Int)
(declare-fun user_eq15 (direction direction) Bool)
(declare-const dummy15 direction)
...
(define-fun dynamic_invariant8 ((temp___expr_198 Int) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool (=> (or (= temp___is_init_194 true) (<= 0 1)) (in_range6 temp___expr_198)))
(define-fun dynamic_invariant9 ((temp___expr_241 us_rep4) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool) (temp___do_typ_inv_240 Bool)) Bool (=> (= temp___do_toplevel_239 true) (=> (= temp___is_init_237 true) (< (length (rec__tree_model__path_type__a (us_split_fields7 temp___expr_241))) 100))))
(define-fun default_initial_assumption3 ((temp___expr_243 us_rep4) (temp___skip_top_level_244 Bool)) Bool (and (= (length (rec__tree_model__path_type__a (us_split_fields7 temp___expr_243))) 0) (= (rec__tree_model__path_type__k (us_split_fields7 temp___expr_243)) (distinct 0 0))))
...
(define-fun olt ((left us_rep3) (right us_rep3)) Bool (and (< (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
(declare-fun olt__function_guard (Bool us_rep3 us_rep3) Bool)
(declare-fun is_add (us_rep3 Int us_rep3) Bool)
(declare-fun is_add__function_guard (Bool us_rep3 Int us_rep3) Bool)
...
(assert (forall ((a us_rep3) (b us_rep3)) (! (= (user_eq9 a b) (oeq a b)) :pattern ((user_eq9 a b)))))
(define-fun default_initial_assumption4 ((temp___expr_234 us_rep3) (temp___skip_top_level_235 Bool)) Bool (=> (not (= temp___skip_top_level_235 true)) (= (length temp___expr_234) 0)))
(assert true)
(assert (forall ((s1 us_rep3) (s2 us_rep3)) (forall ((d Int)) (! (= (= (is_add s1 d s2) true) (and (and (= (- (length s2) 1) (length s1)) (= (olt s1 s2) true)) (= (get s2 (length s2)) d))) :pattern ((is_add s1 d s2))))))
...
(declare-fun parent1 (us_rep1 Int) Int)
(declare-fun parent__function_guard1 (Int us_rep1 Int) Bool)
(assert (forall ((t1 us_rep2)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 t1 true true true true) (dynamic_invariant6 i true true true true)) (let ((result (parent t1 i))) (and (=> (= (size1 t1) 0) (= result 0)) (dynamic_invariant result true false true true)))) :pattern ((parent t1 i))))))
(assert (forall ((t1 us_rep2)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 t1 true true true true) (dynamic_invariant6 i true true true true)) (= (parent t1 i) (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 t1)) i))) :pattern ((parent t1 i))))))
(declare-fun peek1 (us_rep1 Int Int) Int)
(declare-fun peek__function_guard1 (Int us_rep1 Int Int) Bool)
(assert (forall ((t1 us_rep2)) (forall ((i Int) (d Int)) (! (=> (and (and (and (dynamic_invariant1 t1 true true true true) (dynamic_invariant6 i true true true true)) (dynamic_invariant8 d true true true true)) (and (not (= (size1 t1) 0)) (= (rec__tree_model__path_type__k (us_split_fields7 (let ((temp___466 (model__ t1))) (select temp___466 i)))) true))) (dynamic_invariant (peek t1 i d) true false true true)) :pattern ((peek t1 i d))))))
(assert (forall ((t1 us_rep2)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant1 t1 true true true true) (dynamic_invariant6 i true true true true)) (dynamic_invariant8 d true true true true)) (= (peek t1 i d) (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 t1)) i d))) :pattern ((peek t1 i d))))))
(declare-const rliteral1 natural)
(assert (= (naturalqtint rliteral1) 0))
(assert (forall ((temp___436 Int)) (=> (dynamic_invariant4 temp___436 true true true true) (forall ((temp___437 Int)) (= (select (temp_____aggregate_def_434 temp___436) temp___437) rliteral1)))))
(define-fun dynamic_invariant11 ((temp___expr_317 us_rep1) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool) (temp___do_typ_inv_316 Bool)) Bool (=> (= temp___do_typ_inv_316 true) (= (tree_structure temp___expr_317) true)))
(define-fun default_initial_assumption5 ((temp___expr_320 us_rep1) (temp___skip_top_level_321 Bool)) Bool (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields3 temp___expr_320))) 0) (forall ((temp___323 Int)) (=> (and (<= 1 temp___323) (<= temp___323 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_320)) temp___323)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_320)) temp___323)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_320)) temp___323)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 temp___expr_320)) temp___323)))) 2))))) (=> (not (= temp___skip_top_level_321 true)) (= (size temp___expr_320) 0))))
(define-fun type_invariant2 ((temp___326 us_rep1)) Bool (= (tree_structure temp___326) true))
(assert true)
(assert (forall ((f us_rep1)) (! (=> (dynamic_invariant11 f true true true true) (dynamic_invariant (size f) true false true true)) :pattern ((size f)))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant11 f true true true true) (dynamic_invariant6 i true true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant11 f true true true true) (dynamic_invariant6 i true true true true)) (let ((result (parent1 f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant result true false true true)))) :pattern ((parent1 f i))))))
(declare-fun position (us_rep1 Int) Int)
(declare-fun position__function_guard (Int us_rep1 Int) Bool)
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant11 f true true true true) (dynamic_invariant6 i true true true true)) (not (= (parent1 f i) 0))) (dynamic_invariant8 (position f i) true false true true)) :pattern ((position f i))))))
(assert (forall ((f us_rep1)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant11 f true true true true) (dynamic_invariant6 i true true true true)) (dynamic_invariant8 d true true true true)) (let ((result (peek1 f i d))) (and (and (ite (not (= result 0)) (and (= (position f result) d) (= (parent1 f result) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent1 f j) i) (not (= (position f j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent1 f j) i) (= (position f j) d)) (= result j))))) (dynamic_invariant result true false true true)))) :pattern ((peek1 f i d))))))
(assert (forall ((f us_rep1)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant11 f true true true true) (dynamic_invariant6 root true true true true)) (= (valid_root f root) true)) (let ((result (model__1 f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields7 (select result root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent1 f i) 0)) (= (rec__tree_model__path_type__k (us_split_fields7 (select result (parent1 f i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields7 (select result (parent1 f i)))) (position f i) (rec__tree_model__path_type__a (us_split_fields7 (select result i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields7 (select result i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select result i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields7 (select result i))) (rec__tree_model__path_type__a (us_split_fields7 (select result j)))) true)) (= j i))))))))))) (dynamic_invariant2 result true false true true)))) :pattern ((model__1 f root))))))
(define-fun default_initial_assumption6 ((temp___expr_301 us_rep) (temp___skip_top_level_302 Bool)) Bool (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 temp___expr_301))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 temp___expr_301))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 temp___expr_301))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 temp___expr_301))) 2)))
(define-fun default_initial_assumption7 ((temp___expr_309 (Array Int us_rep)) (temp___skip_top_level_310 Bool)) Bool (forall ((temp___311 Int)) (=> (and (<= 1 temp___311) (<= temp___311 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select temp___expr_309 temp___311)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 (select temp___expr_309 temp___311)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select temp___expr_309 temp___311)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select temp___expr_309 temp___311)))) 2)))))
(assert true)
...
(assert (forall ((container us_rep3)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant10 result true false true true))) :pattern ((length container)))))
...
(assert (forall ((container us_rep3)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant12 position1 true true true true) (and (<= 1 position1) (<= position1 (last container)))) (dynamic_invariant13 (get container position1) true false true true)) :pattern ((get container position1))))))
(declare-const i Int)
(declare-const temp___1035 (Array Int us_rep4))
...
(assert (dynamic_invariant3 t true false true true))
(assert (and (= o4 (size1 (rec__red_black_trees__rbt__struct (us_split_fields11 t)))) (and (in_range1 o4) (= o4 (size (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields11 t)))))))))
(assert (= result (ite (= o4 0) true false)))
(assert (not (= result true)))
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___1035 (model__ (rec__red_black_trees__rbt__struct (us_split_fields11 t)))) (and (dynamic_invariant2 temp___1035 true false true true) (= temp___1035 (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields11 t)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields11 t))))))))))
(assert (= (mk___rep3 (mk___split_fields3 o o1)) (select temp___1035 i)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= result1 o3))
(assert (= result1 true))
(assert (not (not (= (size1 (rec__red_black_trees__rbt__struct (us_split_fields11 t))) 0))))
(check-sat)
(exit)
