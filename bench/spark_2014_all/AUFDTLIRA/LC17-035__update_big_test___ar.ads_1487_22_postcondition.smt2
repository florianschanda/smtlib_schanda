...
(declare-fun temp_____aggregate_def_3145 ((Array Int et1) Int Int Int Int) (Array Int et1))
...
(assert (not (= (bool_eq1 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp_____aggregate_def_3145 r__split_fields i e j f) r__split_fields1))) true)))
(check-sat)
(exit)
