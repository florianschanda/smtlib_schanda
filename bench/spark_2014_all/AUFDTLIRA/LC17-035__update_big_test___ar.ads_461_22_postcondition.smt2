...
(declare-fun temp_____aggregate_def_1504 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp_____aggregate_def_1510 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq2 a3 1 16 (temp_____aggregate_def_1504 a i (temp_____aggregate_def_1510 b j c)) 1 16) true)))
(check-sat)
(exit)
