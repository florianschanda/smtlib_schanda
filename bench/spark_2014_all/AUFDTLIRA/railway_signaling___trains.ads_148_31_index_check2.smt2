...
(define-fun o10 () us_rep (mk___rep (mk___split_fields o7 o8 o9)))
(define-fun o11 () us_rep (mk___rep (mk___split_fields o1 o2 o3)))
...
(assert (= o train))
(assert (= o11 (select trains o)))
(assert (and (= o4 (get_previous_track o11 id)) (and (in_range5 o4) (= o4 (to_rep4 (select (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 o3)))))) id))))))
(assert (= o5 (ite (= o4 0) true false)))
(assert (= result (ite (not (= o5 true)) true false)))
(assert (= result true))
(assert (and (<= 1 train) (<= train 10)))
(assert (= o6 train))
(assert (= o10 (select trains o6)))
(assert (and (= temp___370 (get_previous_track o10 id)) (and (in_range5 temp___370) (= temp___370 (to_rep4 (select (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 o9)))))) id))))))
(assert (not (<= 1 temp___370)))
(check-sat)
(exit)
