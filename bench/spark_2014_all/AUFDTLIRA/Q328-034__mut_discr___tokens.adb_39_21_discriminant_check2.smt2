...
(define-fun dynamic_invariant2 ((temp___expr_177 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool) (temp___do_typ_inv_176 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= 0 2)) (in_range4 temp___expr_177)))
(assert (forall ((word us_t)) (! (=> (dynamic_invariant1 word true true true true) (dynamic_invariant2 (read word) true false true true)) :pattern ((read word)))))
...
(define-fun dynamic_invariant3 ((temp___expr_204 Int) (temp___is_init_200 Bool) (temp___skip_constant_201 Bool) (temp___do_toplevel_202 Bool) (temp___do_typ_inv_203 Bool)) Bool (=> (or (= temp___is_init_200 true) (<= 0 3)) (in_range5 temp___expr_204)))
(assert (forall ((op us_t)) (! (=> (dynamic_invariant1 op true true true true) (dynamic_invariant3 (read2 op) true false true true)) :pattern ((read2 op)))))
...
(define-fun dynamic_invariant4 ((temp___expr_213 Int) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool) (temp___do_typ_inv_212 Bool)) Bool (=> (or (= temp___is_init_209 true) (<= 0 2)) (in_range6 temp___expr_213)))
...
(define-fun default_initial_assumption ((temp___expr_222 us_rep1) (temp___skip_top_level_223 Bool)) Bool (and (= (attr__constrained temp___expr_222) false) (= (to_rep4 (rec__tokens__token__kind (us_split_discrs1 temp___expr_222))) 0)))
...
(assert (forall ((i tTword_bufferSP1)) (and (<= 1 (tTword_bufferSP1qtint i)) (<= (tTword_bufferSP1qtint i) 1024))))
...
(assert (= o2 temp___260))
(assert (= (mk1 1 r1b) temp___2601))
(assert (= temp___260 tokens__next__read_a_valid_token__word__assume))
(assert (= (mk (to_rep1 (first2 temp___2601)) (to_rep1 (last2 temp___2601))) tokens__next__read_a_valid_token__word__assume1))
...
(assert (= result4 true))
(assert (= (to_rep4 (rec__tokens__token__kind v__split_discrs)) r9b))
(assert (in_range6 r9b))
(assert (and (= o31 (read2 (mk___t word1 (mk (to_rep1 word__first) (to_rep1 word__last))))) (in_range5 o31)))
(assert (= (to_rep3 o32) o31))
(assert (= o33 (mk___split_fields1 dummy5 o32 dummy4)))
(assert (= (to_rep4 o30) 1))
(assert (= o34 (mk___split_discrs o30)))
(assert (= temp___266 (mk___rep1 o34 o33 true)))
(assert (= v__attr__constrained true))
(assert (not (= (rec__tokens__token__kind (us_split_discrs1 temp___266)) (rec__tokens__token__kind v__split_discrs))))
(check-sat)
(exit)
