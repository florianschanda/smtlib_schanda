...
(assert true)
(assert (forall ((stack_functional_spec__my_stack__fields us_split_fields)) (! (= (= (is_full stack_functional_spec__my_stack__fields) true) (= (count (state__2 stack_functional_spec__my_stack__fields)) (max_stack_size Tuple0))) :pattern ((is_full stack_functional_spec__my_stack__fields)))))
...
(declare-const temp___2271 pointer_range)
...
(define-fun o17 () us_rep (mk___rep (mk___split_fields o11 o12)))
...
(assert (and (= o (+ (to_rep1 my_stack__split_fields1) 1)) (in_range2 (+ (to_rep1 my_stack__split_fields1) 1))))
(assert (= (to_rep1 o1) o))
(assert (= my_stack__split_fields o2))
(assert (= o1 o3))
(assert (= temp___227 o2))
(assert (= temp___2271 o3))
...
(assert (= temp___227 my_stack__split_fields2))
(assert (= temp___2271 my_stack__split_fields3))
(assert (= (to_rep o4) x))
...
(assert (= temp___231 o7))
(assert (= temp___2311 o8))
(assert (= result2 my_stack__split_fields2))
(assert (= result3 my_stack__split_fields3))
(assert (= my_stack__split_fields4 (mk___split_fields temp___231 temp___2311)))
(assert (= my_stack__split_fields5 (mk___split_fields__ref my_stack__split_fields4)))
(assert (= my_stack__split_fields6 my_stack__split_fields4))
(assert (and (= o14 (count (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) (and (in_range3 o14) (= o14 (to_rep1 (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))))))))
(assert (= o15 (ite (<= i o14) true false)))
(assert (= result4 (ite (<= 1 i) o15 false)))
(assert (= (= o16 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (count (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1))))) (= (stack_entry (state__2 (us_split_fields__content my_stack__split_fields5)) i1) (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) i1))))))
(assert (and (= o17 (state__2 (us_split_fields__content my_stack__split_fields5))) (= (us_split_fields__content my_stack__split_fields5) (mk___split_fields o11 o12))))
(assert (and (= o13 (count o17)) (and (in_range3 o13) (= o13 (to_rep1 o12)))))
(assert (and (= o18 (state__2 (us_split_fields__content my_stack__split_fields5))) (= (us_split_fields__content my_stack__split_fields5) (mk___split_fields o9 o10))))
(assert (not (<= o13 (count o18))))
(check-sat)
(exit)
