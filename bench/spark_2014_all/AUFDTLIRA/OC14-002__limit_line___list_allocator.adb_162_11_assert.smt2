...
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__available model____split_fields3)))) (and (and (and (in_range7 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j))))) (ite (< j (length (rec__list_allocator__m__t__available model____split_fields3))) (get (rec__list_allocator__m__t__available model____split_fields3) (+ j 1)) 0))) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j))))) (ite (< 1 j) (get (rec__list_allocator__m__t__available model____split_fields3) (- j 1)) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (length (rec__list_allocator__m__t__available model____split_fields3)))) (=> (not (= j k)) (not (= (get (rec__list_allocator__m__t__available model____split_fields3) j) (get (rec__list_allocator__m__t__available model____split_fields3) k))))))))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (and (and (and (in_range7 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__allocated model____split_fields3) j))))) (ite (< j (length (rec__list_allocator__m__t__allocated model____split_fields3))) (get (rec__list_allocator__m__t__allocated model____split_fields3) (+ j 1)) 0))) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__allocated model____split_fields3) j))))) (ite (< 1 j) (get (rec__list_allocator__m__t__allocated model____split_fields3) (- j 1)) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (=> (not (= j k)) (not (= (get (rec__list_allocator__m__t__allocated model____split_fields3) j) (get (rec__list_allocator__m__t__allocated model____split_fields3) k))))))))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__available model____split_fields3)))) (= (bool_eq2 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (select data3 (get ma1 (+ j 1)))) true))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- (length ma1) 2))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get ma1 (+ j 1)))))) (get ma1 (+ j 2))))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- (length (rec__list_allocator__m__t__available model____split_fields3)) 1))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get ma1 (+ j 1)))))) (get ma1 (+ j 2))))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__available model____split_fields3)))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get ma1 (+ j 1)))))) (ite (< j (length (rec__list_allocator__m__t__available model____split_fields3))) (get ma1 (+ j 2)) 0)))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__available model____split_fields3)))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j))))) (ite (< j (length (rec__list_allocator__m__t__available model____split_fields3))) (get ma1 (+ j 2)) 0)))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__available model____split_fields3)))) (and (in_range7 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j))))) (ite (< j (length (rec__list_allocator__m__t__available model____split_fields3))) (get (rec__list_allocator__m__t__available model____split_fields3) (+ j 1)) 0))))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (in_range7 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)))))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j (length (rec__list_allocator__m__t__allocated model____split_fields3))))
(assert (not (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__allocated model____split_fields3) j))))) (ite (< j (length (rec__list_allocator__m__t__allocated model____split_fields3))) (get (rec__list_allocator__m__t__allocated model____split_fields3) (+ j 1)) 0))))
(check-sat)
(exit)
