...
(assert (not (= (ite (<= (to_rep (first4 temp___2051)) (to_rep (last4 temp___2051))) (+ (- (to_rep (last4 temp___2051)) (to_rep (first4 temp___2051))) 1) 0) (ite (<= (to_rep (first (rt input))) (to_rep (last (rt input)))) (+ (- (to_rep (last (rt input))) (to_rep (first (rt input)))) 1) 0))))
(check-sat)
(exit)
