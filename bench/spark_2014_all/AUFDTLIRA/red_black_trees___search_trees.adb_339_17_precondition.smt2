...
(assert (= result3 true))
(assert (and (= temp___1760 (model__ f root)) (and (dynamic_invariant5 temp___1760 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1760 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1760 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f i) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1760 (parent f i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1760 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1760 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1760 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1760 (parent f i)))) (position f i) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1760 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1760 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1760 i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1760 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1760 i))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1760 j)))) true)) (= j i))))))))))))))
