...
(assert (not (= (length3 temp___10232) 0)))
(assert (=> (<= (to_rep1 (first4 temp___10241)) (to_rep1 (last4 temp___10241))) (= o (+ (- (to_rep1 (last4 temp___10241)) (to_rep1 (first4 temp___10241))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___10241)) (to_rep1 (last4 temp___10241)))) (= o 0)))
(assert (=> (<= (to_rep1 (first4 temp___10231)) (to_rep1 (last4 temp___10231))) (= o1 (+ (- (to_rep1 (last4 temp___10231)) (to_rep1 (first4 temp___10231))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___10231)) (to_rep1 (last4 temp___10231)))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first4 temp___10231)) o2)))
(assert (= o4 (- o3 1)))
