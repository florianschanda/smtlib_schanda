...
(declare-const stacks__peek__2__result1 Int)
(declare-const stacks__peek__2__result2 Int)
(declare-const stacks__peek__2__result3 Int)
(declare-const stacks__peek__2__result4 Int)
(declare-const stacks__peek__2__result5 Int)
(declare-const result1 Int)
(assert (not (= (is_empty s) true)))
(assert (= stacks__peek__2__result1 stacks__peek__2__result2))
(assert (= stacks__peek__2__result3 stacks__peek__2__result1))
(assert (and (<= 1 (to_rep2 (rec__stacks__stack_root__length (us_split_fields1 s)))) (<= (to_rep2 (rec__stacks__stack_root__length (us_split_fields1 s))) 100)))
(assert (= o (to_rep2 (rec__stacks__stack_root__length (us_split_fields1 s)))))
(assert (= o1 (select (rec__stacks__stack_root__content (us_split_fields1 s)) o)))
(assert (= o2 (to_rep1 o1)))
(assert (= result stacks__peek__2__result))
(assert (= stacks__peek__2__result1 o2))
(assert (= (mk_int__ref stacks__peek__2__result4) (mk_int__ref stacks__peek__2__result2)))
(assert (= stacks__peek__2__result5 stacks__peek__2__result3))
(assert (= result1 stacks__peek__2__result4))
(assert (not (not (= (is_empty s) true))))
(check-sat)
(exit)
