...
(assert (forall ((i length_t)) (and (<= 0 (length_tqtint i)) (<= (length_tqtint i) 1000))))
...
(define-fun dynamic_invariant ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 1000)) (in_range2 temp___expr_159)))
...
(define-fun dynamic_invariant2 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 1 1000)) (in_range3 temp___expr_166)))
(assert (in_range2 l))
(assert (<= 1 l))
(assert (not (<= l 1000)))
(check-sat)
