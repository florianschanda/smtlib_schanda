...
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 100)) (= temp___272 d__split_fields)))
(assert (=> (and (<= 1 i2) (<= i2 100)) (= temp___277 (mk___rep1 (mk___split_fields1 d__split_fields d__split_fields1)))))
(assert (=> (and (<= 1 i2) (<= i2 100)) (= temp___274 d__split_fields1)))
(assert (=> (and (<= 1 i2) (<= i2 100)) (and (and (forall ((temp___278 Int)) (=> (and (<= 1 temp___278) (<= temp___278 100)) (ite (or (< 100 temp___278) (or (< temp___278 1) (<= i3 temp___278))) (= (select (rec__do_loops__r_array_record__f3 d__split_fields3) temp___278) (select (rec__do_loops__r_array_record__f3 (us_split_fields3 temp___277)) temp___278)) (= (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields3) temp___278))) (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 (us_split_fields3 temp___277)) temp___278))))))) (= (rec__do_loops__r_array_record__f4 d__split_fields3) (rec__do_loops__r_array_record__f4 (us_split_fields3 temp___277)))) (and (<= 1 i3) (<= i3 100)))))
(assert (=> (and (<= 1 i2) (<= i2 100)) (= result2 (mk___split_fields__ref1 d__split_fields3))))
(assert (=> (and (<= 1 i2) (<= i2 100)) (= d__split_fields4 (mk___split_fields1 (store (rec__do_loops__r_array_record__f3 d__split_fields3) i3 (mk___rep (mk___split_fields rliteral (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields3) i3)))))) (rec__do_loops__r_array_record__f4 d__split_fields3)))))
(assert (=> (and (<= 1 i2) (<= i2 100)) (= (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields4) i3)))) (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select temp___272 i3)))))))
(assert (=> (and (<= 1 i2) (<= i2 100)) (= (bool_eq1 (rec__do_loops__r_array_record__f4 d__split_fields4) 1 100 temp___274 1 100) true)))
...
(assert (<= 1 i8))
(assert (<= i8 100))
(assert (and (and (forall ((temp___298 Int)) (=> (and (<= 1 temp___298) (<= temp___298 100)) (ite (or (< 100 temp___298) (or (< temp___298 1) (<= i9 temp___298))) (= (select (rec__do_loops__r_array_record__f3 d__split_fields9) temp___298) (select (rec__do_loops__r_array_record__f3 (us_split_fields__content1 d__split_fields7)) temp___298)) (= (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields9) temp___298))) (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 (us_split_fields__content1 d__split_fields7)) temp___298))))))) (forall ((temp___299 Int)) (=> (and (<= 1 temp___299) (<= temp___299 100)) (ite (or (< 100 temp___299) (or (< temp___299 1) (<= i9 temp___299))) (= (select (rec__do_loops__r_array_record__f4 d__split_fields9) temp___299) (select (rec__do_loops__r_array_record__f4 (us_split_fields__content1 d__split_fields7)) temp___299)) (= (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f4 d__split_fields9) temp___299))) (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f4 (us_split_fields__content1 d__split_fields7)) temp___299)))))))) (and (<= 1 i9) (<= i9 100))))
(assert (= result4 (mk___split_fields__ref1 d__split_fields9)))
(assert (= d__split_fields10 (mk___split_fields1 (store (rec__do_loops__r_array_record__f3 d__split_fields9) i9 (mk___rep (mk___split_fields rliteral (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields9) i9)))))) (rec__do_loops__r_array_record__f4 d__split_fields9))))
(assert (= result5 (mk___split_fields__ref1 d__split_fields10)))
(assert (= d__split_fields11 (mk___split_fields1 (rec__do_loops__r_array_record__f3 d__split_fields10) (store (rec__do_loops__r_array_record__f4 d__split_fields10) i9 (mk___rep (mk___split_fields rliteral (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f4 d__split_fields10) i9)))))))))
(assert (= (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 d__split_fields11) i9)))) (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select (rec__do_loops__r_array_record__f3 (us_split_fields__content1 d__split_fields7)) i9))))))
(assert (not (= (bool_eq1 (rec__do_loops__r_array_record__f4 d__split_fields11) 1 100 (rec__do_loops__r_array_record__f4 (us_split_fields__content1 d__split_fields7)) 1 100) true)))
(check-sat)
(exit)
