...
(declare-fun temp_____aggregate_def_3725 ((Array Int us_rep) Int us_rep Int us_rep) (Array Int us_rep))
(declare-fun temp_____aggregate_def_3734 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (forall ((temp___3727 (Array Int us_rep))) (forall ((temp___3728 Int) (temp___3730 Int)) (forall ((temp___3729 us_rep) (temp___3731 us_rep)) (let ((temp___3726 (temp_____aggregate_def_3725 temp___3727 temp___3728 temp___3729 temp___3730 temp___3731))) (=> (and (dynamic_invariant1 temp___3728 true true true true) (dynamic_invariant1 temp___3730 true true true true)) (forall ((temp___3732 Int)) (ite (= temp___3732 temp___3730) (= (select temp___3726 temp___3732) temp___3731) (ite (= temp___3732 temp___3728) (= (select temp___3726 temp___3732) temp___3729) (= (select temp___3726 temp___3732) (select temp___3727 temp___3732)))))))))))
(assert (forall ((temp___3736 (Array Int et1))) (forall ((temp___3737 Int) (temp___3738 Int)) (let ((temp___3735 (temp_____aggregate_def_3734 temp___3736 temp___3737 temp___3738))) (=> (and (dynamic_invariant temp___3737 true true true true) (dynamic_invariant2 temp___3738 true true true true)) (forall ((temp___3739 Int)) (ite (= temp___3739 temp___3737) (= (to_rep (select temp___3735 temp___3739)) temp___3738) (= (select temp___3735 temp___3739) (select temp___3736 temp___3739)))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq2 a3 1 16 (temp_____aggregate_def_3725 a x r i (mk___rep (mk___split_fields (temp_____aggregate_def_3734 (rec__ar__rofa1__s1 (us_split_fields1 (select a i))) j e) (rec__ar__rofa1__t1 (us_split_fields1 (select a i)))))) 1 16) true)))
(check-sat)
(exit)
