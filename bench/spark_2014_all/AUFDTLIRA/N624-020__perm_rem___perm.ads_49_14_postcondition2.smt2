...
(declare-const perm__perm_transitive__result Int)
(declare-const o Int)
(declare-const result Int)
(declare-const perm__perm_transitive__result1 Int)
(declare-const perm__perm_transitive__result2 Int)
(declare-const perm__perm_transitive__result3 Int)
(declare-const perm__perm_transitive__result4 Int)
(declare-const perm__perm_transitive__result5 Int)
...
(assert (= perm__perm_transitive__result1 perm__perm_transitive__result2))
(assert (= perm__perm_transitive__result3 perm__perm_transitive__result1))
(assert (and (= o (induction_hypothesis a b c)) (and (in_range4 o) (=> (= (distinct o 0) true) (= (is_perm a c) true)))))
(assert (= (mk_int__ref result) (mk_int__ref perm__perm_transitive__result)))
(assert (= perm__perm_transitive__result1 o))
(assert (= (mk_int__ref perm__perm_transitive__result4) (mk_int__ref perm__perm_transitive__result2)))
(assert (= perm__perm_transitive__result5 perm__perm_transitive__result3))
(assert (= result1 perm__perm_transitive__result4))
(assert (= (distinct perm__perm_transitive__result4 0) true))
