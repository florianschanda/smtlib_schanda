...
(assert (not (< (length description) 150)))
(assert (= result1 i))
(assert (= i1 0))
(assert (<= 0 i1))
(assert (<= i1 149))
(assert (and (<= 0 i2) (<= i2 149)))
(assert (and (= temp___1716 (+ (to_rep1 (first (rt description))) i2)) (in_range1 (+ (to_rep1 (first (rt description))) i2))))
(assert (not (<= (to_rep1 (first (rt description))) temp___1716)))
(check-sat)
(exit)
