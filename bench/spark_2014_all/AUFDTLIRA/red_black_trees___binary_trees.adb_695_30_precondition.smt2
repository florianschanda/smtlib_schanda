...
(assert (and (= temp___1736 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant1 temp___1736 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1736 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1736 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1736 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1736 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1736 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1736 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1736 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1736 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1736 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1736 i))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1736 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1736 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1736 j1)))) true)) (= j1 i))))))))))))))
(assert (and (<= 1 v) (<= v 100)))
(assert (= o v))
...
(assert (= o4 o8))
(assert (= o9 o7))
(assert (= temp___1738 (to_rep o9)))
(assert (and (<= 1 temp___1738) (<= temp___1738 100)))
(assert (= o10 temp___1738))
(assert (= (mk___rep (mk___split_fields o11 o12)) (select temp___1736 o10)))
(assert (= o11 o13))
(assert (= o12 o14))
(assert (= result2 o14))
(assert (= result2 true))
(assert (= (= result3 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i v)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i)))) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f_old__split_fields1 i))))))))))
(assert (= result3 true))
(assert (= (= result4 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i)))) (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 i))))))))))
(assert (= result4 true))
(assert (= (= result5 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root) j1))) true)) (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 j1)))) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f_old__split_fields1 j1))))))))))
(assert (= result5 true))
(assert (<= 1 j))
(assert (<= j 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
