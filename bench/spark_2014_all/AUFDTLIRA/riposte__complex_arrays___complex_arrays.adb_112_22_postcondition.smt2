...
(define-fun dynamic_invariant1 ((temp___expr_174 Int) (temp___is_init_170 Bool) (temp___skip_constant_171 Bool) (temp___do_toplevel_172 Bool) (temp___do_typ_inv_173 Bool)) Bool (=> (or (= temp___is_init_170 true) (<= (- 23) 69)) (in_range1 temp___expr_174)))
...
(assert (= result tmp))
(assert (= tmp1 (to_rep (select (select a i) j))))
(assert (= (to_rep o) (to_rep (select (select a j) i))))
(assert (= o1 (store (select a i) j o)))
(assert (= o2 (store a i o1)))
(assert (= result1 a))
(assert (= a1 o2))
(assert (= (to_rep o3) tmp1))
(assert (= o4 (store (select a1 j) i o3)))
(assert (= o5 (store a1 j o4)))
(assert (= result2 a1))
(assert (= a2 o5))
(assert (= tmp2 tmp1))
(assert (= a2 a3))
