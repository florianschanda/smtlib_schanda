...
(assert (and (= o (invert_1 r1)) (and (forall ((rank Int)) (=> (and (<= 1 rank) (<= rank 64)) (= (to_rep1 (select o (to_rep (select r1 rank)))) rank))) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (= (to_rep (select r1 (to_rep1 (select o g1)))) g1))))))
(assert (= (mk_map__ref1 result) (mk_map__ref1 inverted)))
(assert (= inverted1 o))
(assert (= stable_marriage__is_preferred_1__result1 stable_marriage__is_preferred_1__result2))
(assert (= stable_marriage__is_preferred_1__result3 stable_marriage__is_preferred_1__result1))
(assert (= (mk_bool__ref result1) (mk_bool__ref stable_marriage__is_preferred_1__result)))
(assert (= stable_marriage__is_preferred_1__result1 (ite (<= (to_rep1 (select inverted1 g1_a)) (to_rep1 (select inverted1 g1_b))) true false)))
(assert (= (mk_bool__ref stable_marriage__is_preferred_1__result4) (mk_bool__ref stable_marriage__is_preferred_1__result2)))
(assert (= inverted1 inverted2))
(assert (= stable_marriage__is_preferred_1__result5 stable_marriage__is_preferred_1__result3))
(assert (= inverted3 inverted1))
(assert (not (= (is_permutation_1 r1) true)))
(check-sat)
(exit)
