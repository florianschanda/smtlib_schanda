...
(assert (and (<= 0 k) (<= k 99)))
(assert (= o116 k))
(assert (= o117 (select temp___750 o116)))
(assert (= temp___751 (to_rep o117)))
(assert (and (<= 0 temp___751) (<= temp___751 99)))
(assert (= o118 temp___751))
(assert (= o119 (select (rec__patience__state__values (us_split_fields__content s__split_fields20)) o118)))
