...
(assert (and (and (forall ((temp___1854 Int)) (=> (and (<= (to_rep1 n__first) temp___1854) (<= temp___1854 (to_rep1 n__last))) (=> (or (< temp___1851 temp___1854) (or (< temp___1854 (to_rep1 (first (rt source)))) (< index2 temp___1854))) (= (select n3 temp___1854) (select n1 temp___1854))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 1)))))
