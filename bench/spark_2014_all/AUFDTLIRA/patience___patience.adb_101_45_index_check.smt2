...
(declare-const temp___699 (Array Int cardindex))
...
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o109 ist))
(assert (= temp___703 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o109)))
(assert (and (<= 0 ip) (<= ip 99)))
(assert (= o110 ip))
(assert (= o111 (select temp___703 o110)))
(assert (= temp___704 (to_rep o111)))
(assert (and (<= 0 temp___704) (<= temp___704 99)))
(assert (= o112 temp___704))
(assert (= o113 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o112)))
(assert (= o114 (to_rep o113)))
(assert (= o115 (ite (= ip o114) true false)))
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o108 ist))
(assert (= temp___699 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o108)))
(assert (not (<= ip 99)))
(check-sat)
(exit)
