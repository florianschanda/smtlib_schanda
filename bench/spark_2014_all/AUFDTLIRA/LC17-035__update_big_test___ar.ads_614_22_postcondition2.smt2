...
(declare-fun user_eq1 (it4 it4) Bool)
(declare-const dummy1 it4)
(declare-datatypes () ((it4__ref (mk_it4__ref (it4__content it4)))))
(define-fun it4__ref___projection ((a it4__ref)) it4 (it4__content a))
(define-fun dynamic_invariant ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 90 99)) (in_range2 temp___expr_197)))
(declare-sort et1 0)
...
(declare-const dummy5 (Array Int (Array Int (Array Int et1))))
...
(declare-fun user_eq5 ((Array Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1)))) Bool)
...
(assert (<= n 99))
(assert (not (= n i)))
(assert (not (= (bool_eq2 (select a2 n) 1 16 (select a n) 1 16) true)))
(check-sat)
(exit)
