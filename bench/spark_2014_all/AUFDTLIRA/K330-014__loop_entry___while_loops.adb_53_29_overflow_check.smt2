...
(assert (=> (= result4 true) (= temp___575 counter6)))
(assert (=> (= result4 true) (= temp___576 (sum_of counter6))))
(assert (=> (= result4 true) (< temp___576 0)))
...
(assert (= result7 true))
(assert (and (=> (<= 0 2147483647) (in_range4 counter14)) (< (sum_of counter14) 4)))
(assert (and (= o9 (sum_of 2)) (in_range4 o9)))
(assert (= result8 (ite (< o9 0) true false)))
(assert (=> (= result8 true) (< 0 counter12)))
(assert (=> (= result8 true) (< (sum_of 2) 0)))
(assert (=> (= result8 true) (and (= o10 (sum_of 2)) (in_range4 o10))))
(assert (=> (= result8 true) (= o11 (ite (< o10 0) true false))))
(assert (=> (= result8 true) (= result9 (ite (not (= o11 true)) true false))))
(assert (=> (= result8 true) (= result9 true)))
(assert (not (in_range1 (+ counter14 1))))
(check-sat)
(exit)
