...
(assert (and (and (and (=> (<= 0 r9b) (dynamic_property6 0 r9b i2)) (dynamic_invariant2 (mk___rep branch__split_discrs branch__split_fields3) false true true true)) (forall ((temp___262 Int)) (=> (and (<= (to_rep1 (first (rt (rec__main__branch_type__m_nodes branch__split_fields3)))) temp___262) (<= temp___262 (to_rep1 (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))))) (=> (or (< r9b temp___262) (or (< temp___262 0) (<= i2 temp___262))) (= (select (elts (rec__main__branch_type__m_nodes branch__split_fields3)) temp___262) (select (elts (rec__main__branch_type__m_nodes branch__split_fields2)) temp___262)))))) (and (<= 0 i2) (<= i2 r9b))))
(assert (= i2 (to_rep1 (last (rt (rec__main__branch_type__m_nodes branch__split_fields3))))))
(assert (= (to_rep1 (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))) r11b))
