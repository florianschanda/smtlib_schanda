...
(define-fun dynamic_invariant2 ((temp___expr_558 Int) (temp___is_init_554 Bool) (temp___skip_constant_555 Bool) (temp___do_toplevel_556 Bool) (temp___do_typ_inv_557 Bool)) Bool (=> (or (= temp___is_init_554 true) (<= 1 10)) (in_range2 temp___expr_558)))
(define-fun dynamic_invariant3 ((temp___expr_565 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool) (temp___do_typ_inv_564 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 1 50)) (in_range3 temp___expr_565)))
(declare-const o Int)
(declare-const temp___719 (Array Int cell))
(assert (in_range y))
(assert (in_range x))
(assert (in_range2 x))
(assert (in_range3 y))
