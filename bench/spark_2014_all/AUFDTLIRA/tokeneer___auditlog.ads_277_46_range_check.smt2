...
(declare-fun user_eq (logfilecountt logfilecountt) Bool)
(declare-const dummy logfilecountt)
...
(define-fun to_rep ((x logfilecountt)) Int (logfilecounttqtint x))
(declare-fun of_rep (Int) logfilecountt)
(assert (forall ((x logfilecountt)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x logfilecountt)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(declare-fun user_eq2 (tlogentrycounttB tlogentrycounttB) Bool)
(declare-const dummy2 tlogentrycounttB)
...
(define-fun dynamic_invariant1 ((temp___expr_1211 Int) (temp___is_init_1207 Bool) (temp___skip_constant_1208 Bool) (temp___do_toplevel_1209 Bool) (temp___do_typ_inv_1210 Bool)) Bool (=> (or (= temp___is_init_1207 true) (<= 0 17408)) (in_range3 temp___expr_1211)))
...
(assert (forall ((x logfileindext)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep1 (select a temp___idx_172)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_172)))))))))))
...
(define-fun dynamic_invariant2 ((temp___expr_1197 Int) (temp___is_init_1193 Bool) (temp___skip_constant_1194 Bool) (temp___do_toplevel_1195 Bool) (temp___do_typ_inv_1196 Bool)) Bool (=> (or (= temp___is_init_1193 true) (<= 0 17)) (in_range temp___expr_1197)))
(define-fun dynamic_invariant3 ((temp___expr_1242 Int) (temp___is_init_1238 Bool) (temp___skip_constant_1239 Bool) (temp___do_toplevel_1240 Bool) (temp___do_typ_inv_1241 Bool)) Bool (=> (or (= temp___is_init_1238 true) (<= 0 1024)) (in_range4 temp___expr_1242)))
(assert (in_range1 currentlogfile))
(assert (in_range3 numberlogentries))
(assert (<= 1 (to_rep (rec__auditlog__logfilelistt__length (us_split_fields1 usedlogfiles)))))
(assert (not (in_range3 (- (to_rep (rec__auditlog__logfilelistt__length (us_split_fields1 usedlogfiles))) 1))))
(check-sat)
(exit)
