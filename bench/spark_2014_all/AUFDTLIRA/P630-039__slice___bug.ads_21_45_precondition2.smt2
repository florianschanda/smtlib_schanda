...
(declare-const temp___198 (Array Int t))
(declare-const temp___1981 t2)
...
(assert (=> (<= temp___196 (to_rep (last (rt a)))) (and (and (<= (to_rep (first (rt a))) temp___196) (<= temp___196 (to_rep (last (rt a))))) (and (<= (to_rep (first (rt a))) (to_rep (last (rt a)))) (<= (to_rep (last (rt a))) (to_rep (last (rt a))))))))
(assert (= o2 (elts a)))
(assert (= o2 temp___198))
(assert (= (mk1 temp___196 (to_rep (last (rt a)))) temp___1981))
(assert (= temp___198 o3))
(assert (= (mk (to_rep (first2 temp___1981)) (to_rep (last2 temp___1981))) o4))
(assert (not (<= size_b (length (mk___t o3 o4)))))
(check-sat)
(exit)
