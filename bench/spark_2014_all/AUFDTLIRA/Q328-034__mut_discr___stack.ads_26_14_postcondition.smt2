...
(define-fun dynamic_invariant1 ((temp___expr_182 Int) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool) (temp___do_typ_inv_181 Bool)) Bool (=> (or (= temp___is_init_178 true) (<= 0 200)) (in_range3 temp___expr_182)))
...
(assert (forall ((v us_rep)) (! (dynamic_invariant2 (to_string1 v) true false true true) :pattern ((to_string1 v)))))
...
(define-fun bool_eq3 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (bool_eq2 (select a temp___idx_154) (select b (+ (- b__first a__first) temp___idx_154))) true)))) true false))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_203 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_203 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_203 us_void_param) 3)) 112)) (= (to_rep (select (temp___String_Literal_203 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_203 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_203 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_203 us_void_param) 7)) 103)) (= (to_rep (select (temp___String_Literal_203 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_203 us_void_param) 9)) 60)) (= (to_rep (select (temp___String_Literal_203 us_void_param) 10)) 45)) (= (to_rep (select (temp___String_Literal_203 us_void_param) 11)) 32)) :pattern ((temp___String_Literal_203 us_void_param)))))
...
(declare-const o Int)
(declare-const temp___202 integer)
...
(define-fun temp___2052 () us_t (mk___t temp___205 temp___2051))
...
(assert (= o last2))
(assert (= (mk___rep (mk___split_fields temp___202)) (select tab o)))
(assert (= (mk___split_fields__ref (mk___split_fields result1)) (mk___split_fields__ref (mk___split_fields v__split_fields))))
(assert (= temp___202 v__split_fields1))
(assert (and (= o1 (- last2 1)) (in_range3 (- last2 1))))
(assert (= (mk_int__ref result2) (mk_int__ref last2)))
(assert (= last3 o1))
(assert (and (= temp___2052 (to_string1 (mk___rep v__split_fields4))) (dynamic_invariant2 temp___2052 true false true true)))
(assert (=> (<= (to_rep1 (first temp___2051)) (to_rep1 (last temp___2051))) (= o2 (+ (- (to_rep1 (last temp___2051)) (to_rep1 (first temp___2051))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___2051)) (to_rep1 (last temp___2051)))) (= o2 0)))
...
(assert (= (concat1 (temp___String_Literal_203 Tuple0) 1 11 temp___205 (to_rep1 (first temp___2051)) (to_rep1 (last temp___2051))) o8))
(assert (= (mk 1 o7) o9))
(assert (= last3 last4))
(assert (= v__split_fields2 v__split_fields1))
(assert (= last5 last3))
(assert (= (mk___split_fields v__split_fields3) v__split_fields4))
(assert (not (= (size last4) (- (size last2) 1))))
(check-sat)
(exit)
