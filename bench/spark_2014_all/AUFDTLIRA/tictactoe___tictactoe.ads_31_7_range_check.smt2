...
(define-fun dynamic_invariant1 ((temp___expr_584 Int) (temp___is_init_580 Bool) (temp___skip_constant_581 Bool) (temp___do_toplevel_582 Bool) (temp___do_typ_inv_583 Bool)) Bool (=> (or (= temp___is_init_580 true) (<= 1 3)) (in_range3 temp___expr_584)))
(assert (forall ((x Int) (y Int)) (forall ((tictactoe__my_board (Array Int (Array Int slot)))) (! (=> (and (dynamic_invariant1 x true true true true) (dynamic_invariant1 y true true true true)) (dynamic_invariant (count_free_slots x y tictactoe__my_board) true false true true)) :pattern ((count_free_slots x y tictactoe__my_board))))))
(assert (forall ((x Int) (y Int)) (forall ((tictactoe__my_board (Array Int (Array Int slot)))) (! (=> (and (dynamic_invariant1 x true true true true) (dynamic_invariant1 y true true true true)) (= (count_free_slots x y tictactoe__my_board) (+ (+ (+ (+ (one_free_slot 1 1 tictactoe__my_board) (ite (<= 2 y) (one_free_slot 1 2 tictactoe__my_board) 0)) (ite (<= 3 y) (one_free_slot 1 3 tictactoe__my_board) 0)) (ite (<= 2 x) (+ (+ (one_free_slot 2 1 tictactoe__my_board) (ite (<= 2 y) (one_free_slot 2 2 tictactoe__my_board) 0)) (ite (<= 3 y) (one_free_slot 2 3 tictactoe__my_board) 0)) 0)) (ite (<= 3 x) (+ (+ (one_free_slot 3 1 tictactoe__my_board) (ite (<= 2 y) (one_free_slot 3 2 tictactoe__my_board) 0)) (ite (<= 3 y) (one_free_slot 3 3 tictactoe__my_board) 0)) 0)))) :pattern ((count_free_slots x y tictactoe__my_board))))))
...
(define-fun dynamic_invariant3 ((temp___expr_577 Int) (temp___is_init_573 Bool) (temp___skip_constant_574 Bool) (temp___do_toplevel_575 Bool) (temp___do_typ_inv_576 Bool)) Bool (=> (or (= temp___is_init_573 true) (<= 0 2)) (in_range1 temp___expr_577)))
(assert (forall ((x Int) (y Int)) (forall ((tictactoe__my_board (Array Int (Array Int slot)))) (! (=> (and (dynamic_invariant1 x true true true true) (dynamic_invariant1 y true true true true)) (dynamic_invariant (one_free_slot x y tictactoe__my_board) true false true true)) :pattern ((one_free_slot x y tictactoe__my_board))))))
(assert (forall ((x Int) (y Int)) (forall ((tictactoe__my_board (Array Int (Array Int slot)))) (! (=> (and (dynamic_invariant1 x true true true true) (dynamic_invariant1 y true true true true)) (= (one_free_slot x y tictactoe__my_board) (ite (= (to_rep (let ((temp___615 (select tictactoe__my_board x))) (select temp___615 y))) 0) 1 0))) :pattern ((one_free_slot x y tictactoe__my_board))))))
(declare-const my_board (Array Int (Array Int slot)))
(declare-const o Int)
(assert (and (= o (count_free_slots 3 3 my_board)) (and (in_range2 o) (= o (+ (+ (+ (+ (one_free_slot 1 1 my_board) (ite (<= 2 3) (one_free_slot 1 2 my_board) 0)) (ite (<= 3 3) (one_free_slot 1 3 my_board) 0)) (ite (<= 2 3) (+ (+ (one_free_slot 2 1 my_board) (ite (<= 2 3) (one_free_slot 2 2 my_board) 0)) (ite (<= 3 3) (one_free_slot 2 3 my_board) 0)) 0)) (ite (<= 3 3) (+ (+ (one_free_slot 3 1 my_board) (ite (<= 2 3) (one_free_slot 3 2 my_board) 0)) (ite (<= 3 3) (one_free_slot 3 3 my_board) 0)) 0))))))
