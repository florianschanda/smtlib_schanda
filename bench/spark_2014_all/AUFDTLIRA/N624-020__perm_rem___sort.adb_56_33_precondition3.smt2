...
(assert (= hr4 o33))
(assert (and (= o43 (- x 1)) (in_range4 (- x 1))))
(assert (and (= o41 y) (in_range4 y)))
(assert (and (= o42 (remove (mk___t values2 (mk 1 100)) o41)) (and (dynamic_invariant3 o42 true false true true) (and (= (invariant__ o42) true) (and (= (to_rep1 (last (rt o42))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o41 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o42) k))))) (and (forall ((k Int)) (=> (and (<= (+ o41 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o42) (- k 1)))))) (forall ((k Int)) (=> (and (<= o41 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o42) k))))))))))))
(assert (and (= o44 (remove o42 o43)) (and (dynamic_invariant3 o44 true false true true) (and (= (invariant__ o44) true) (and (= (to_rep1 (last (rt o44))) (- (to_rep1 (last (rt o42))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o43 1))) (= (to_rep (select (elts o42) k)) (to_rep (select (elts o44) k))))) (and (forall ((k Int)) (=> (and (<= (+ o43 1) k) (<= k (to_rep1 (last (rt o42))))) (= (to_rep (select (elts o42) k)) (to_rep (select (elts o44) (- k 1)))))) (forall ((k Int)) (=> (and (<= o43 k) (<= k (- (to_rep1 (last (rt o42))) 1))) (= (to_rep (select (elts o42) (+ k 1))) (to_rep (select (elts o44) k))))))))))))
(assert (and (= o39 y) (in_range4 y)))
(assert (and (= o37 x) (in_range4 x)))
(assert (and (= o38 (remove (mk___t values2 (mk 1 100)) o37)) (and (dynamic_invariant3 o38 true false true true) (and (= (invariant__ o38) true) (and (= (to_rep1 (last (rt o38))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o37 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o38) k))))) (and (forall ((k Int)) (=> (and (<= (+ o37 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o38) (- k 1)))))) (forall ((k Int)) (=> (and (<= o37 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o38) k))))))))))))
(assert (and (= o40 (remove o38 o39)) (and (dynamic_invariant3 o40 true false true true) (and (= (invariant__ o40) true) (and (= (to_rep1 (last (rt o40))) (- (to_rep1 (last (rt o38))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o39 1))) (= (to_rep (select (elts o38) k)) (to_rep (select (elts o40) k))))) (and (forall ((k Int)) (=> (and (<= (+ o39 1) k) (<= k (to_rep1 (last (rt o38))))) (= (to_rep (select (elts o38) k)) (to_rep (select (elts o40) (- k 1)))))) (forall ((k Int)) (=> (and (<= o39 k) (<= k (- (to_rep1 (last (rt o38))) 1))) (= (to_rep (select (elts o38) (+ k 1))) (to_rep (select (elts o40) k))))))))))))
