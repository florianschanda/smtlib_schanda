...
(assert (and (= temp___1453 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant1 temp___1453 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1453 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1453 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1453 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1453 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1453 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1453 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1453 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1453 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1453 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1453 i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1453 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1453 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1453 j)))) true)) (= j i))))))))))))))
(assert (not (<= v 100)))
(check-sat)
(exit)
