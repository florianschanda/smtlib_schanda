...
(define-fun dynamic_invariant1 ((temp___expr_1175 Int) (temp___is_init_1171 Bool) (temp___skip_constant_1172 Bool) (temp___do_toplevel_1173 Bool) (temp___do_typ_inv_1174 Bool)) Bool (=> (or (= temp___is_init_1171 true) (<= 0 5)) (in_range3 temp___expr_1175)))
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true true) (dynamic_invariant (classt_image x) true false true true)) :pattern ((classt_image x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true true) (= (classt_image x) (let ((temp___1181 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___1181) (first1 temp___1181) (last1 temp___1181))))) :pattern ((classt_image x)))))
...
(declare-datatypes () ((t92b__ref (mk_t92b__ref (t92b__content integer)))))
(define-fun t92b__ref___projection ((a t92b__ref)) integer (t92b__content a))
(declare-sort t3 0)
...
(declare-datatypes () ((t93b__ref (mk_t93b__ref (t93b__content us_t3)))))
(define-fun t93b__ref___projection ((a t93b__ref)) us_t3 (t93b__content a))
(declare-fun screen__writeconfigdata__classstring__result__aggregate_def (Int) (Array Int character))
...
(assert (forall ((temp___2016 Int)) (=> (dynamic_invariant3 temp___2016 true true true true) (forall ((temp___2017 Int)) (= (to_rep (select (screen__writeconfigdata__classstring__result__aggregate_def temp___2016) temp___2017)) temp___2016)))))
...
(declare-const temp___2013 (Array Int character))
(declare-const temp___20131 t1)
(declare-const screen__writeconfigdata__classstring__data__assume (Array Int character))
(declare-const screen__writeconfigdata__classstring__data__assume1 t)
(declare-const temp___2018 (Array Int character))
(declare-const temp___20181 t3)
(declare-const o (Array Int character))
(declare-const temp___2021 (Array Int character))
(declare-const temp___20211 t3)
...
(define-fun temp___20132 () us_t1 (mk___t1 temp___2013 temp___20131))
(assert (in_range3 value))
(assert (and (= temp___20132 (classt_image value)) (and (dynamic_invariant temp___20132 true false true true) (= temp___20132 (let ((temp___1179 (to_string (attr__ATTRIBUTE_IMAGE3 value)))) (mk___t1 (elts temp___1179) (mk1 (to_rep1 (first (rt temp___1179))) (to_rep1 (last (rt temp___1179))))))))))
(assert (= temp___2013 screen__writeconfigdata__classstring__data__assume))
(assert (= (mk (to_rep1 (first2 temp___20131)) (to_rep1 (last2 temp___20131))) screen__writeconfigdata__classstring__data__assume1))
(assert (= result data))
(assert (= data1 screen__writeconfigdata__classstring__data__assume))
(assert (= (to_rep1 data__first) (to_rep1 (first screen__writeconfigdata__classstring__data__assume1))))
(assert (= (to_rep1 data__last) (to_rep1 (last screen__writeconfigdata__classstring__data__assume1))))
(assert (dynamic_property 1 2147483647 (to_rep1 data__first) (to_rep1 data__last)))
(assert (= result1 result__))
(assert (= result__1 (screen__writeconfigdata__classstring__result__aggregate_def 32)))
...
(assert (= (slide data1 (to_rep1 data__first) 1) temp___2018))
(assert (= (mk3 1 (to_rep1 data__last)) temp___20181))
(assert (=> (<= 1 (to_rep1 data__last)) (and (and (<= 1 1) (<= 1 12)) (and (<= 1 (to_rep1 data__last)) (<= (to_rep1 data__last) 12)))))
(assert (= o result__1))
(assert (= o temp___2021))
(assert (= (mk3 1 (to_rep1 data__last)) temp___20211))
(assert (not (= (ite (<= (to_rep1 (first6 temp___20181)) (to_rep1 (last6 temp___20181))) (+ (- (to_rep1 (last6 temp___20181)) (to_rep1 (first6 temp___20181))) 1) 0) (ite (<= (to_rep1 (first6 temp___20211)) (to_rep1 (last6 temp___20211))) (+ (- (to_rep1 (last6 temp___20211)) (to_rep1 (first6 temp___20211))) 1) 0))))
(check-sat)
(exit)
