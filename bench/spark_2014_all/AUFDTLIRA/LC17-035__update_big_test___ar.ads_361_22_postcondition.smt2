...
(declare-fun temp_____aggregate_def_1240 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq1 a3 5 50 (temp_____aggregate_def_1240 a i b j c) 5 50) true)))
(check-sat)
(exit)
