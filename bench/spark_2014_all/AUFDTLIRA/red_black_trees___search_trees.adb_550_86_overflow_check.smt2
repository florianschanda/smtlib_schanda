...
(assert (= o31 (select temp___1785 i)))
(assert (= o32 (us_split_fields1 o31)))
(assert (= result5 (rec__tree_model__path_type__k o32)))
...
(assert (=> (= result5 true) (= o29 (select temp___1786 j))))
(assert (=> (= result5 true) (= o30 (us_split_fields1 o29))))
(assert (=> (= result5 true) (= result4 (rec__tree_model__path_type__k o30))))
...
(assert (=> (= result4 true) (= o26 (select temp___1788 j))))
(assert (=> (= result4 true) (= o27 (us_split_fields1 o26))))
(assert (=> (= result4 true) (= o28 (rec__tree_model__path_type__a o27))))
...
(assert (=> (= result4 true) (= o23 (select temp___1787 i))))
(assert (=> (= result4 true) (= o24 (us_split_fields1 o23))))
(assert (=> (= result4 true) (= o25 (rec__tree_model__path_type__a o24))))
(assert (=> (= result4 true) (and (= result3 (olt o25 o28)) (= (= result3 true) (and (< (length o25) (length o28)) (forall ((n Int)) (=> (and (<= 1 n) (<= n (last o25))) (= (get o25 n) (get o28 n)))))))))
...
(assert (= o18 (select temp___1792 i)))
(assert (= o19 (us_split_fields1 o18)))
(assert (= o20 (rec__tree_model__path_type__a o19)))
(assert (and (= o21 (length o20)) (and (in_range2 o21) (<= (+ 0 o21) 2147483647))))
(assert (= o22 (+ o21 1)))
(assert (not (in_range8 o22)))
(check-sat)
(exit)
