...
(declare-const o7 uml_state_access)
(declare-const o8 uml_state_access)
...
(define-fun o18 () us_rep1 (mk___rep1 (mk___split_fields1 o7 o8)))
(define-fun o19 () us_rep (mk___rep (mk___split_fields o)))
...
(assert (=> (and (<= 0 s2) (<= s2 100)) (= o19 (select temp___475 s3))))
(assert (=> (and (<= 0 s2) (<= s2 100)) (and (= o1 (name o19)) (and (in_range1 o1) (= o1 (to_rep o))))))
...
(assert (<= 0 t))
(assert (<= t (- s9 1)))
(assert (and (= o11 t) (in_range4 t)))
(assert (= o12 (select cfv2 o11)))
(assert (and (= o13 (to__2 o12)) (and (in_range3 o13) (= o13 (to_rep2 (rec__model__uml_control_flow__to_data (us_split_fields9 o12)))))))
(assert (= o14 (select (map__content2 av6) o13)))
(assert (and (= o15 (name__2 o14)) (and (in_range1 o15) (= o15 (to_rep (rec__model__uml_action__name_data (us_split_fields7 o14)))))))
...
(assert (= o6 t))
(assert (= o18 (select temp___492 o6)))
(assert (and (= o9 (to__ o18)) (and (in_range2 o9) (= o9 (to_rep1 o8)))))
(assert (= o10 (select temp___491 o9)))
(assert (and (= o16 (name o10)) (and (in_range1 o16) (= o16 (to_rep (rec__model__uml_state__name_data (us_split_fields1 o10)))))))
