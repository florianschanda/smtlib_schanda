...
(assert (=> (= (length2 (mk___t2 temp___559 temp___5591)) 0) (= (mk1 (to_rep2 (first6 temp___5601)) (to_rep2 (last8 temp___5601))) temp___5611)))
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (=> (<= (to_rep2 (first6 temp___5601)) (to_rep2 (last8 temp___5601))) (= o2 (+ (- (to_rep2 (last8 temp___5601)) (to_rep2 (first6 temp___5601))) 1)))))
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (=> (not (<= (to_rep2 (first6 temp___5601)) (to_rep2 (last8 temp___5601)))) (= o2 0))))
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (=> (<= (to_rep2 (first4 temp___5591)) (to_rep2 (last6 temp___5591))) (= o3 (+ (- (to_rep2 (last6 temp___5591)) (to_rep2 (first4 temp___5591))) 1)))))
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (=> (not (<= (to_rep2 (first4 temp___5591)) (to_rep2 (last6 temp___5591)))) (= o3 0))))
...
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (and (= o7 o6) (in_range6 o6))))
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (= (slide (concat1 temp___559 (to_rep2 (first4 temp___5591)) (to_rep2 (last6 temp___5591)) temp___560 (to_rep2 (first6 temp___5601)) (to_rep2 (last8 temp___5601))) (to_rep2 (first4 temp___5591)) 1) temp___561)))
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (= (mk1 1 o7) temp___5611)))
(assert (not (dynamic_property 1 2147483647 (to_rep2 (first2 temp___5611)) (to_rep2 (last4 temp___5611)))))
(check-sat)
(exit)
