...
(assert (not (= (bool_eq (elts1 (value (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (to_rep2 (first6 (mk3 start (- (+ start (length2 by__)) 1)))) (to_rep2 (last6 (mk3 start (- (+ start (length2 by__)) 1)))) (elts1 by__) (to_rep2 (first2 (rt1 by__))) (to_rep2 (last2 (rt1 by__)))) true)))
(check-sat)
(exit)
