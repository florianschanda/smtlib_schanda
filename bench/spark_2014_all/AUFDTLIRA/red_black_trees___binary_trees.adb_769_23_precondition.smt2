...
(assert (=> (= result2 true) (= temp___1607 (to_rep o3))))
(assert (=> (= result2 true) (and (<= 1 temp___1607) (<= temp___1607 100))))
(assert (=> (= result2 true) (= o4 temp___1607)))
(assert (=> (= result2 true) (= o5 (select temp___1605 o4))))
