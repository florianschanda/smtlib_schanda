...
(define-fun o6 () us_rep (mk___rep (mk___split_fields o1 o2 o3)))
...
(assert (= o train))
(assert (= o6 (select trains o)))
(assert (and (= o4 (get_previous_track o6 id)) (and (in_range5 o4) (= o4 (to_rep4 (select (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 o3)))))) id))))))
