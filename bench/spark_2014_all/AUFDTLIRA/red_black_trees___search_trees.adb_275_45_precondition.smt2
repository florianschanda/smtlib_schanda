...
(assert (= o22 (select temp___14251 i9)))
(assert (= o23 (us_split_fields5 o22)))
(assert (= result12 (rec__tree_model__path_type__k o23)))
...
(assert (=> (= result12 true) (= o20 (select temp___14261 j16))))
(assert (=> (= result12 true) (= o21 (us_split_fields5 o20))))
(assert (=> (= result12 true) (= result11 (rec__tree_model__path_type__k o21))))
