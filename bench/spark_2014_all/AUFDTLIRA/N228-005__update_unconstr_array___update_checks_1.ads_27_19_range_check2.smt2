...
(declare-const temp___509 (Array Int integer))
(declare-const temp___5091 t4)
(declare-const temp___510 (Array Int integer))
(declare-const temp___5101 t3)
(declare-const o (Array Int integer))
(declare-const temp___512 (Array Int integer))
(declare-const temp___5121 t3)
(declare-const temp___513 (Array Int integer))
(declare-const temp___5131 t3)
(declare-const o1 (Array Int integer))
(declare-const temp___519 (Array Int integer))
(declare-const temp___5191 t2)
...
(assert (= (to_rep (first8 (rt4 (temp_____aggregate_def_502 new_val 2 i)))) 2))
(assert (= (to_rep (last8 (rt4 (temp_____aggregate_def_502 new_val 2 i)))) i))
(assert (= (mk___t4 temp___509 temp___5091) (temp_____aggregate_def_502 new_val 2 i)))
(assert (= (ite (<= (to_rep (first8 temp___5091)) (to_rep (last8 temp___5091))) (+ (- (to_rep (last8 temp___5091)) (to_rep (first8 temp___5091))) 1) 0) (ite (<= 2 i) (+ (- i 2) 1) 0)))
(assert (= temp___509 temp___510))
(assert (= (mk3 (to_rep (first8 temp___5091)) (to_rep (last8 temp___5091))) temp___5101))
(assert (=> (<= 2 i) (and (and (<= (to_rep a__first) 2) (<= 2 (to_rep a__last))) (and (<= (to_rep a__first) i) (<= i (to_rep a__last))))))
(assert (= o a))
(assert (= o temp___512))
(assert (= (mk3 2 i) temp___5121))
(assert (= (ite (<= (to_rep (first6 temp___5101)) (to_rep (last6 temp___5101))) (+ (- (to_rep (last6 temp___5101)) (to_rep (first6 temp___5101))) 1) 0) (ite (<= (to_rep (first6 temp___5121)) (to_rep (last6 temp___5121))) (+ (- (to_rep (last6 temp___5121)) (to_rep (first6 temp___5121))) 1) 0)))
(assert (= (mk___t3 temp___513 temp___5131) (mk___t3 temp___510 temp___5101)))
(assert (forall ((temp___514 Int)) (ite (and (<= 2 temp___514) (<= temp___514 i)) (= (select o1 temp___514) (select temp___513 temp___514)) (= (select o1 temp___514) (select a temp___514)))))
(assert (= (mk_map__ref result) (mk_map__ref a)))
(assert (= a1 o1))
(assert (= a1 a2))
(assert (= a3 a1))
(assert (= (to_rep (first4 (rt2 (temp_____aggregate_def_308 new_val 1 i)))) 1))
(assert (= (to_rep (last4 (rt2 (temp_____aggregate_def_308 new_val 1 i)))) i))
(assert (= (mk___t2 temp___519 temp___5191) (temp_____aggregate_def_308 new_val 1 i)))
(assert (<= 1 i))
