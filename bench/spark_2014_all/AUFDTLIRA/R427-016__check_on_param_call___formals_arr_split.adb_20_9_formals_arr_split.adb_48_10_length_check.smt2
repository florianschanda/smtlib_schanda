...
(declare-const temp___269 (Array Int natural))
...
(assert (= v2 temp___269))
(assert (= (mk2 (to_rep v__first) (to_rep v__last)) temp___2691))
(assert (not (= (ite (<= (to_rep (first4 temp___2681)) (to_rep (last4 temp___2681))) (+ (- (to_rep (last4 temp___2681)) (to_rep (first4 temp___2681))) 1) 0) (ite (<= (to_rep (first4 temp___2691)) (to_rep (last4 temp___2691))) (+ (- (to_rep (last4 temp___2691)) (to_rep (first4 temp___2691))) 1) 0))))
(check-sat)
(exit)
