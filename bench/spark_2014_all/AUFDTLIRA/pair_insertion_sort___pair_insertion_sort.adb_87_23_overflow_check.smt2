...
(assert (=> (= result8 true) (and (and (= (is_perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t o69 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select o69 o14)) (to_rep (select a o15))) (and (= (to_rep (select o69 o15)) (to_rep (select a o14))) (forall ((z7 Int)) (=> (and (<= (to_rep a__first) z7) (<= z7 (to_rep a__last))) (=> (and (not (= z7 o14)) (not (= z7 o15))) (= (to_rep (select o69 z7)) (to_rep (select a z7))))))))) (= (to_rep a__first) 0))))
...
(assert (=> (= result8 true) (= (sorted (mk___t o70 (mk (to_rep a__first) (to_rep a__last))) 0 (- j2 1)) true)))
(assert (=> (= result8 true) (= (sorted (mk___t o70 (mk (to_rep a__first) (to_rep a__last))) (+ j2 2) (+ i1 1)) true)))
(assert (=> (= result8 true) (=> (< 0 j2) (<= (to_rep (select o70 (- j2 1))) (to_rep (select o70 (+ j2 2)))))))
(assert (=> (= result8 true) (< x2 (to_rep (select o70 (+ j2 2))))))
(assert (=> (= result8 true) (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t o70 (mk (to_rep a__first) (to_rep a__last)))) true)))
(assert (=> (= result8 true) (or (and (= (to_rep (select o70 j2)) x2) (= (to_rep (select o70 (+ j2 1))) y2)) (and (= (to_rep (select o70 j2)) y2) (= (to_rep (select o70 (+ j2 1))) x2)))))
...
(assert (=> (= result8 true) (=> (<= 0 j3) (= o18 (select o70 o17)))))
...
(assert (=> (= result8 true) (= a2 (mk_map__ref o70))))
(assert (=> (= result8 true) (= j5 j3)))
(assert (=> (= result8 true) (= a3 o70)))
...
(assert (=> (= result11 true) (and (and (= (is_perm (mk___t (map__content a4) (mk (to_rep a__first) (to_rep a__last))) (mk___t (let ((subject a4)) o71) (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select (let ((subject a4)) o71) o26)) (to_rep (select (map__content a4) o28))) (and (= (to_rep (select (let ((subject a4)) o71) o28)) (to_rep (select (map__content a4) o26))) (forall ((z7 Int)) (=> (and (<= (to_rep a__first) z7) (<= z7 (to_rep a__last))) (=> (and (not (= z7 o26)) (not (= z7 o28))) (= (to_rep (select (let ((subject a4)) o71) z7)) (to_rep (select (map__content a4) z7))))))))) (= (to_rep a__first) 0))))
(assert (=> (= result11 true) (= (to_rep a__first) 0)))
(assert (=> (= result11 true) (= a6 (mk_map__ref o71))))
(assert (=> (= result11 true) (= a7 o71)))
...
(assert (=> (= result12 true) (and (and (= (is_perm (mk___t (map__content a6) (mk (to_rep a__first) (to_rep a__last))) (mk___t (let ((subject a6)) o72) (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select (let ((subject a6)) o72) o33)) (to_rep (select (map__content a6) o34))) (and (= (to_rep (select (let ((subject a6)) o72) o34)) (to_rep (select (map__content a6) o33))) (forall ((z7 Int)) (=> (and (<= (to_rep a__first) z7) (<= z7 (to_rep a__last))) (=> (and (not (= z7 o33)) (not (= z7 o34))) (= (to_rep (select (let ((subject a6)) o72) z7)) (to_rep (select (map__content a6) z7))))))))) (= (to_rep a__first) 0))))
...
(assert (=> (= result12 true) (= (sorted (mk___t o73 (mk (to_rep a__first) (to_rep a__last))) 0 (- j8 1)) true)))
(assert (=> (= result12 true) (= (sorted (mk___t o73 (mk (to_rep a__first) (to_rep a__last))) (+ j8 1) (+ i1 1)) true)))
(assert (=> (= result12 true) (=> (< 0 j8) (<= (to_rep (select o73 (- j8 1))) (to_rep (select o73 (+ j8 1)))))))
(assert (=> (= result12 true) (< y2 (to_rep (select o73 (+ j8 1))))))
(assert (=> (= result12 true) (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t o73 (mk (to_rep a__first) (to_rep a__last)))) true)))
(assert (=> (= result12 true) (= (to_rep (select o73 j8)) y2)))
...
(assert (=> (= result12 true) (=> (<= 0 j9) (= o37 (select o73 o36)))))
...
(assert (=> (= result12 true) (= a8 (mk_map__ref o73))))
(assert (=> (= result12 true) (= j11 j9)))
(assert (=> (= result12 true) (= a9 o73)))
...
(assert (=> (= result23 true) (and (and (= (is_perm (mk___t a12 (mk (to_rep a__first) (to_rep a__last))) (mk___t o74 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select o74 o56)) (to_rep (select a12 o57))) (and (= (to_rep (select o74 o57)) (to_rep (select a12 o56))) (forall ((z7 Int)) (=> (and (<= (to_rep a__first) z7) (<= z7 (to_rep a__last))) (=> (and (not (= z7 o56)) (not (= z7 o57))) (= (to_rep (select o74 z7)) (to_rep (select a12 z7))))))))) (= (to_rep a__first) 0))))
...
(assert (=> (= result23 true) (= (sorted (mk___t o75 (mk (to_rep a__first) (to_rep a__last))) 0 (- j16 1)) true)))
(assert (=> (= result23 true) (= (sorted (mk___t o75 (mk (to_rep a__first) (to_rep a__last))) (+ j16 2) (+ i3 1)) true)))
(assert (=> (= result23 true) (=> (< 0 j16) (<= (to_rep (select o75 (- j16 1))) (to_rep (select o75 (+ j16 2)))))))
(assert (=> (= result23 true) (< (int__content x6) (to_rep (select o75 (+ j16 2))))))
(assert (=> (= result23 true) (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t o75 (mk (to_rep a__first) (to_rep a__last)))) true)))
(assert (=> (= result23 true) (or (and (= (to_rep (select o75 j16)) (int__content x6)) (= (to_rep (select o75 (+ j16 1))) (int__content y6))) (and (= (to_rep (select o75 j16)) (int__content y6)) (= (to_rep (select o75 (+ j16 1))) (int__content x6))))))
...
(assert (=> (= result23 true) (=> (<= 0 j17) (= o60 (select o75 o59)))))
...
(assert (=> (= result23 true) (= a13 (mk_map__ref o75))))
(assert (=> (= result23 true) (= j19 j17)))
(assert (=> (= result23 true) (= a14 o75)))
