...
(assert (dynamic_invariant2 (mk___rep1 (mk___split_discrs temp___317) (mk___split_fields1 (mk___t temp___3171 temp___3172))) true false true true))
(assert (<= 1 idx))
(assert (<= idx (- (to_rep temp___317) 1)))
(assert (and (= temp___320 (+ idx 1)) (in_range1 (+ idx 1))))
(assert (not (<= (to_rep2 (first temp___3172)) temp___320)))
(check-sat)
(exit)
