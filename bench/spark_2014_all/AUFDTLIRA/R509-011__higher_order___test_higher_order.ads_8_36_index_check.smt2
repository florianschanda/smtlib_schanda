...
(declare-datatypes () ((small_enough__ref (mk_small_enough__ref (small_enough__content us_t)))))
(define-fun small_enough__ref___projection ((a small_enough__ref)) us_t (small_enough__content a))
(define-fun dynamic_invariant ((temp___expr_167 us_t) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (and (=> (not (= temp___skip_constant_164 true)) (dynamic_property 1 2147483647 (first1 temp___expr_167) (last1 temp___expr_167))) (=> (= temp___do_toplevel_165 true) (=> (= temp___is_init_163 true) (forall ((i Int)) (=> (and (<= (first1 temp___expr_167) i) (<= i (last1 temp___expr_167))) (< (to_rep (select (to_array temp___expr_167) i)) 2147483647)))))))
(define-fun dynamic_predicate ((temp___170 us_t)) Bool (forall ((i Int)) (=> (and (<= (first1 temp___170) i) (<= i (last1 temp___170))) (< (to_rep (select (to_array temp___170) i)) 2147483647))))
(declare-const i4s us_t)
...
(declare-const i Int)
(assert (dynamic_invariant i4s true false false true))
(assert (<= (to_rep1 (first (rt i4s))) i))
(assert (<= i (to_rep1 (last (rt i4s)))))
(assert (not (<= i (to_rep1 (last (rt i4s))))))
(check-sat)
(exit)
