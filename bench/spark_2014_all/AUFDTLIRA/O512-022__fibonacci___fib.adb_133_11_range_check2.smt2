...
(define-fun a18 () map__ref (mk_map__ref a16))
(assert (in_range2 k1))
(assert (in_range2 k2))
(assert (and (= k1 k2) (and (<= 0 k1) (and (<= k1 100) (and (<= 0 k2) (and (<= k2 100) (and (forall ((i7 Int)) (=> (and (<= 0 i7) (<= i7 k1)) (= (to_rep (select b1 i7)) (to_rep (select b2 i7))))) (forall ((i7 Int)) (=> (and (<= (+ k1 1) i7) (<= i7 100)) (= (to_rep (select c1 (- i7 k1))) (to_rep (select c2 (- i7 k2)))))))))))))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 0))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= temp___220 a1)))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (and (forall ((temp___221 Int)) (=> (and (<= 0 temp___221) (<= temp___221 100)) (=> (or (< k1 temp___221) (or (< temp___221 0) (<= i2 temp___221))) (= (select a12 temp___221) (select temp___220 temp___221))))) (and (<= 0 i2) (<= i2 k1)))))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (and (<= 0 i2) (<= i2 100))))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= o i2)))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= o1 (select b1 o))))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= o2 (to_rep o1))))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= (to_rep o3) o2)))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (and (<= 0 i2) (<= i2 100))))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= o4 i2)))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= o5 (store a12 o4 o3))))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= a12 result1)))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= a13 o5)))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= i2 k1)))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= i2 i3)))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= a13 a14)))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= i4 i2)))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= a15 a13)))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= (mk_int__ref i5) (mk_int__ref i3))))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= a18 (mk_map__ref a14))))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= i6 i4)))
(assert (=> (and (<= 0 i1) (<= i1 k1)) (= a17 a15)))
(assert (=> (not (and (<= 0 i1) (<= i1 k1))) (= i1 i5)))
(assert (=> (not (and (<= 0 i1) (<= i1 k1))) (= a18 (mk_map__ref a1))))
(assert (=> (not (and (<= 0 i1) (<= i1 k1))) (= i6 i1)))
(assert (=> (not (and (<= 0 i1) (<= i1 k1))) (= a17 a11)))
(assert (<= (+ k1 1) 0))
(assert (not (<= 0 (+ k1 1))))
(check-sat)
(exit)
