...
(assert (= result5 true))
(assert (not (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) i2))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) j1)))) true)))
(check-sat)
(exit)
