...
(declare-fun user_eq5 (instruction instruction) Bool)
(declare-const dummy5 instruction)
...
(define-fun default_initial_assumption ((temp___expr_230 us_rep1) (temp___skip_top_level_231 Bool)) Bool (and (= (attr__constrained temp___expr_230) false) (= (to_rep4 (rec__tokens__token__kind (us_split_discrs1 temp___expr_230))) 0)))
...
(define-fun in_range7 ((x Int)) Bool (and (<= 0 x) (<= x 200)))
(declare-fun attr__ATTRIBUTE_IMAGE7 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check7 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE7 (us_image) Int)
(declare-fun user_eq9 (tlastS tlastS) Bool)
(declare-const dummy9 tlastS)
...
(define-fun dynamic_invariant ((temp___expr_193 Int) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool) (temp___do_typ_inv_192 Bool)) Bool (=> (or (= temp___is_init_189 true) (<= 0 200)) (in_range7 temp___expr_193)))
...
(define-fun dynamic_invariant1 ((temp___expr_39 Int) (temp___is_init_35 Bool) (temp___skip_constant_36 Bool) (temp___do_toplevel_37 Bool) (temp___do_typ_inv_38 Bool)) Bool (=> (or (= temp___is_init_35 true) (<= 0 2147483647)) (in_range8 temp___expr_39)))
(declare-fun argument_count (tuple0) Int)
(declare-fun argument_count__function_guard (Int tuple0) Bool)
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant1 (argument_count us_void_param) true false true true) :pattern ((argument_count us_void_param)))))
...
(assert (forall ((number Int)) (! (=> (and (dynamic_invariant2 number true true true true) (<= number (argument_count Tuple0))) (dynamic_invariant3 (argument number) true false true true)) :pattern ((argument number)))))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const t__attr__constrained Bool)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-fun temp___String_Literal_656 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_656 us_void_param) 1)) 87) (= (to_rep (select (temp___String_Literal_656 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 4)) 99)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 6)) 109)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 9)) 116)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 10)) 111)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 12)) 115)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 13)) 100)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 14)) 99)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 15)) 46)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 17)) 71)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 20)) 97)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 21)) 104)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 22)) 101)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 24)) 100)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 26)) 116)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 27)) 121)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 28)) 112)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 29)) 101)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 31)) 121)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 32)) 111)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 33)) 117)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 34)) 114)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 36)) 99)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 37)) 111)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 38)) 109)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 39)) 109)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 40)) 97)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 41)) 110)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 42)) 100)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 43)) 115)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 44)) 32)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 45)) 46)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 46)) 46)) (= (to_rep (select (temp___String_Literal_656 us_void_param) 47)) 46)) :pattern ((temp___String_Literal_656 us_void_param)))))
...
(assert (forall ((stack__last Int)) (! (=> (dynamic_invariant stack__last true true true true) (dynamic_invariant4 (size stack__last) true false true true)) :pattern ((size stack__last)))))
...
(define-fun dynamic_invariant6 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 2)) (in_range6 temp___expr_221)))
(define-fun dynamic_invariant7 ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= 0 2)) (in_range4 temp___expr_200)))
(define-fun dynamic_invariant8 ((temp___expr_212 Int) (temp___is_init_208 Bool) (temp___skip_constant_209 Bool) (temp___do_toplevel_210 Bool) (temp___do_typ_inv_211 Bool)) Bool (=> (or (= temp___is_init_208 true) (<= 0 3)) (in_range5 temp___expr_212)))
...
(assert (=> (= result true) (and (= o3 (argument 1)) (dynamic_invariant3 o3 true false true true))))
(assert (=> (not (= result true)) (= file2 file)))
(assert (=> (not (= result true)) (= file2 file1)))
(assert (in_range7 last3))
(assert (= (to_rep4 t__split_discrs1) 0))
(assert (= (to_rep4 t__split_discrs1) 1))
(assert (not (<= 2 (size last3))))
(check-sat)
(exit)
