...
(assert (not (= (ite (<= (to_rep1 (first temp___2361)) (to_rep1 (last temp___2361))) (+ (- (to_rep1 (last temp___2361)) (to_rep1 (first temp___2361))) 1) 0) (ite (<= (to_rep1 (first (rt sub))) (to_rep1 (last (rt sub)))) (+ (- (to_rep1 (last (rt sub))) (to_rep1 (first (rt sub)))) 1) 0))))
(check-sat)
(exit)
