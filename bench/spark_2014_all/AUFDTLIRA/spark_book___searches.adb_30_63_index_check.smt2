...
(assert (=> (not (< (to_rep (last (rt list))) position1)) (and (<= (to_rep (first (rt list))) position1) (<= position1 (to_rep (last (rt list)))))))
(assert (=> (not (< (to_rep (last (rt list))) position1)) (= o1 position1)))
(assert (=> (not (< (to_rep (last (rt list))) position1)) (= o2 (select (elts list) o1))))
(assert (=> (not (< (to_rep (last (rt list))) position1)) (= o3 (to_rep o2))))
(assert (=> (not (< (to_rep (last (rt list))) position1)) (= result1 (ite (= o3 value) true false))))
(assert (not (= result1 true)))
(assert (and (= o4 (+ position1 1)) (in_range1 (+ position1 1))))
(assert (= position1 result2))
(assert (= position2 o4))
(assert (and (and (<= (to_rep (first (rt list))) position3) (<= position3 (+ (to_rep (last (rt list))) 1))) (forall ((j1 Int)) (=> (and (<= (to_rep (first (rt list))) j1) (<= j1 (- position3 1))) (not (= (to_rep (select (elts list) j1)) value))))))
(assert (=> (<= 1 2147483647) (in_range2 position3)))
(assert (and (= o5 (+ (to_rep (last (rt list))) 1)) (in_range1 (+ (to_rep (last (rt list))) 1))))
(assert (= o6 (ite (<= position3 o5) true false)))
(assert (= result3 (ite (<= (to_rep (first (rt list))) position3) o6 false)))
(assert (= result3 true))
(assert (<= (to_rep (first (rt list))) j))
(assert (<= j (- position3 1)))
