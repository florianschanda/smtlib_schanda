...
(declare-const temp___1293 (Array Int us_rep3))
...
(assert (= (mk___rep2 (mk___split_fields2 o23 o24)) (select temp___1294 i)))
(assert (= o23 o25))
(assert (= o24 o26))
(assert (= o27 o25))
...
(assert (and (= temp___1293 (model__ f root)) (and (dynamic_invariant5 temp___1293 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1293 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1293 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1293 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1293 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1293 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1293 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1293 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1293 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1293 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1293 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1293 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1293 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1293 j1)))) true)) (= j1 i1))))))))))))))
(assert (= (mk___rep2 (mk___split_fields2 o18 o19)) (select temp___1293 j)))
(assert (= o18 o20))
(assert (= o19 o21))
(assert (= o22 o20))
