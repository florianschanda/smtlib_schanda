...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 a))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 b)))) (and (= (bool_eq1 (rec__integer_stacks__stack__values (us_split_fields1 a)) (rec__integer_stacks__stack__values (us_split_fields1 b))) true) (= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 a))) (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 b)))))) true false))
...
(define-fun bool_eq4 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs2 a))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs2 b)))) (and (= (bool_eq3 (rec__integer_stacks__stack__values1 (us_split_fields3 a)) (rec__integer_stacks__stack__values1 (us_split_fields3 b))) true) (= (to_rep1 (rec__integer_stacks__stack__top1 (us_split_fields3 a))) (to_rep1 (rec__integer_stacks__stack__top1 (us_split_fields3 b)))))) true false))
(declare-const us_tag1 Int)
(define-fun in_range4 ((rec__integer_stacks__stack__capacity1 Int) (a us_rep)) Bool (= rec__integer_stacks__stack__capacity1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 a)))))
...
(declare-fun temp_____aggregate_def_288 (Int Int Int) us_t2)
...
(define-fun bool_eq7 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs3 a))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs3 b)))) (and (= (bool_eq6 (rec__integer_stacks__stack__values2 (us_split_fields5 a)) (rec__integer_stacks__stack__values2 (us_split_fields5 b))) true) (= (to_rep1 (rec__integer_stacks__stack__top2 (us_split_fields5 a))) (to_rep1 (rec__integer_stacks__stack__top2 (us_split_fields5 b)))))) true false))
(declare-const us_tag2 Int)
(define-fun in_range6 ((rec__integer_stacks__stack__capacity1 Int) (a us_rep)) Bool (= rec__integer_stacks__stack__capacity1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 a)))))
...
(define-fun bool_eq9 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs4 a))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs4 b)))) (and (= (bool_eq8 (rec__integer_stacks__stack__values3 (us_split_fields7 a)) (rec__integer_stacks__stack__values3 (us_split_fields7 b))) true) (= (to_rep1 (rec__integer_stacks__stack__top3 (us_split_fields7 a))) (to_rep1 (rec__integer_stacks__stack__top3 (us_split_fields7 b)))))) true false))
(declare-const us_tag3 Int)
(define-fun in_range7 ((rec__integer_stacks__stack__capacity1 Int) (a us_rep)) Bool (= rec__integer_stacks__stack__capacity1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 a)))))
...
(assert (forall ((this us_rep)) (! (= (= (empty this) true) (= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 this))) 0)) :pattern ((empty this)))))
(assert true)
(assert true)
...
(assert (forall ((this us_rep)) (! (= (= (full this) true) (= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 this))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 this))))) :pattern ((full this)))))
(declare-sort t5 0)
...
(declare-fun temp_____aggregate_def_245 (Int Int Int) us_t6)
(declare-const rliteral element)
(assert (= (elementqtint rliteral) 0))
(assert (forall ((temp___247 Int) (temp___248 Int) (temp___249 Int)) (let ((temp___246 (temp_____aggregate_def_245 temp___247 temp___248 temp___249))) (=> (dynamic_invariant5 temp___247 true true true true) (and (=> (dynamic_property10 1 2147483647 temp___248 temp___249) (and (= (first13 temp___246) temp___248) (= (last13 temp___246) temp___249))) (forall ((temp___250 Int)) (= (select (to_array6 temp___246) temp___250) rliteral)))))))
(assert (forall ((a us_rep1) (b us_rep1)) (! (= (user_eq9 a b) (oeq (to_base a) (to_base b))) :pattern ((user_eq9 a b)))))
(assert (forall ((temp___290 Int) (temp___291 Int) (temp___292 Int)) (let ((temp___289 (temp_____aggregate_def_288 temp___290 temp___291 temp___292))) (=> (dynamic_invariant5 temp___290 true true true true) (and (=> (dynamic_property10 1 2147483647 temp___291 temp___292) (and (= (first5 temp___289) temp___291) (= (last5 temp___289) temp___292))) (forall ((temp___293 Int)) (= (select (to_array2 temp___289) temp___293) rliteral)))))))
...
(define-fun dynamic_invariant6 ((temp___expr_257 us_rep3) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool) (temp___do_typ_inv_256 Bool)) Bool (and (=> (not (= temp___skip_constant_254 true)) (in_range7 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (to_base2 temp___expr_257))) (and (dynamic_property9 1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (first9 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_257))) (last9 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_257)))) (and (= (first9 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_257))) 1) (= (last9 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_257))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left))))))))
(define-fun default_initial_assumption ((temp___expr_260 us_rep3) (temp___skip_top_level_261 Bool)) Bool (and (and (= (attr__tag3 temp___expr_260) us_tag3) (and (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_260))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left)))) (= (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_260)) (let ((temp___263 (temp_____aggregate_def_245 0 1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_260)))))) (of_array4 (to_array6 temp___263) (first13 temp___263) (last13 temp___263))))) (= (to_rep1 (rec__integer_stacks__stack__top3 (us_split_fields7 temp___expr_260))) 0))) (=> (not (= temp___skip_top_level_261 true)) (= (empty (to_base2 temp___expr_260)) true))))
...
(define-fun dynamic_invariant7 ((temp___expr_239 us_rep2) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (and (=> (not (= temp___skip_constant_236 true)) (in_range6 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (to_base1 temp___expr_239))) (and (dynamic_property7 1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (first7 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_239))) (last7 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_239)))) (and (= (first7 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_239))) 1) (= (last7 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_239))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 right))))))))
(define-fun default_initial_assumption1 ((temp___expr_242 us_rep2) (temp___skip_top_level_243 Bool)) Bool (and (and (= (attr__tag2 temp___expr_242) us_tag2) (and (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs3 temp___expr_242))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 right)))) (= (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_242)) (let ((temp___251 (temp_____aggregate_def_245 0 1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs3 temp___expr_242)))))) (of_array3 (to_array6 temp___251) (first13 temp___251) (last13 temp___251))))) (= (to_rep1 (rec__integer_stacks__stack__top2 (us_split_fields5 temp___expr_242))) 0))) (=> (not (= temp___skip_top_level_243 true)) (= (empty (to_base1 temp___expr_242)) true))))
...
(define-fun temp___2966 () us_rep (mk___rep (mk___split_discrs temp___296) (mk___split_fields (mk___t temp___2961 temp___2962) temp___2963 temp___2964) temp___2965))
...
(assert (= (to_rep (rec__integer_stacks__stack__capacity this__split_discrs)) r17b))
(assert (in_range1 r17b))
(assert (= (to_rep (rec__integer_stacks__stack__capacity this__split_discrs)) r20b))
(assert (in_range1 r20b))
(assert (= (to_rep2 (first4 (rt2 (temp_____aggregate_def_288 0 1 r20b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp_____aggregate_def_288 0 1 r20b)))) r20b))
(assert (= (mk___t2 temp___295 temp___2951) (temp_____aggregate_def_288 0 1 r20b)))
...
(assert (= temp___295 o))
(assert (= (mk1 (to_rep2 (first4 temp___2951)) (to_rep2 (last4 temp___2951))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= rliteral1 o4))
(assert (= us_null_ext__ o5))
(assert (= (rec__integer_stacks__stack__capacity this__split_discrs) o6))
(assert (= o7 o2))
(assert (= o8 o3))
(assert (= o9 o4))
(assert (= o10 o5))
(assert (= us_tag1 o11))
(assert (= temp___2966 (to_base (mk___rep1 (mk___split_discrs o6) (mk___split_fields1 (mk___t1 o7 o8) o9 o10) o11))))
(assert (= temp___296 (rec__integer_stacks__stack__capacity this__split_discrs)))
(assert (= (mk___rep (mk___split_discrs usq_) (mk___split_fields (mk___t usq_1 usq_2) usq_3 usq_4) usq_5) temp___2966))
(assert (= usq_ temp___298))
(assert (= usq_1 temp___2981))
(assert (= usq_2 temp___2982))
(assert (= usq_3 temp___2983))
(assert (= usq_4 temp___2984))
(assert (= this__attr__tag temp___2985))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t this__split_fields this__split_fields1) this__split_fields2 this__split_fields3))))
(assert (= this__split_fields4 (mk___split_fields (mk___t temp___2981 temp___2982) temp___2983 temp___2984)))
(assert (= this__split_discrs (mk___split_discrs temp___298)))
(assert (= this__split_fields5 (mk___split_fields__ref this__split_fields4)))
(assert (= this__split_fields6 this__split_fields4))
(assert (not (not (= (full (mk___rep this__split_discrs (us_split_fields__content this__split_fields5) this__attr__tag)) true))))
(check-sat)
(exit)
