...
(define-fun dynamic_invariant1 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= (- 23) 69)) (in_range2 temp___expr_173)))
...
(assert (= a1 (store a i (mk___rep (mk___split_fields (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a i))) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a i))) rliteral)))))
(assert (= a1 result1))
(assert (= a2 (store a1 i (mk___rep (mk___split_fields (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a1 i))) rliteral1 (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a1 i))))))))
(assert (= a2 result2))
(assert (= a3 (store a2 i (mk___rep (mk___split_fields (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a2 i))) rliteral2 (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a2 i))))))))
(assert (= a3 result3))
(assert (= a4 (store a3 i (mk___rep (mk___split_fields (distinct 0 0) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a3 i))) (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a3 i))))))))
(assert (not (= (to_rep (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a4 i)))) 69)))
(check-sat)
(exit)
