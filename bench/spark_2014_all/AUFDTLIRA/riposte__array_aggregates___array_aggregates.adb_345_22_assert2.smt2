...
(declare-fun temp_____aggregate_def_648 (Int Int Int) (Array Int enum_t))
...
(assert (forall ((temp___650 Int) (temp___651 Int) (temp___652 Int)) (let ((temp___649 (temp_____aggregate_def_648 temp___650 temp___651 temp___652))) (=> (and (and (dynamic_invariant1 temp___650 true true true true) (dynamic_invariant1 temp___651 true true true true)) (dynamic_invariant1 temp___652 true true true true)) (forall ((temp___653 Int)) (ite (= temp___653 1000) (= (to_rep (select temp___649 temp___653)) temp___651) (ite (or (= temp___653 2) (and (<= 4 temp___653) (<= temp___653 6))) (= (to_rep (select temp___649 temp___653)) temp___650) (= (to_rep (select temp___649 temp___653)) temp___652))))))))
(declare-const x (Array Int enum_t))
(declare-const result (Array Int enum_t))
(declare-const x1 (Array Int enum_t))
(assert (in_range2 n))
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_648 0 2 1)))
