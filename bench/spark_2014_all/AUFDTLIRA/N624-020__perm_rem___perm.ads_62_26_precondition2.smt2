...
(define-fun o27 () us_t (mk___t o25 o26))
(define-fun o28 () us_t (mk___t o21 o22))
(define-fun o29 () us_t (mk___t o19 o20))
(define-fun o30 () us_t (mk___t o17 o18))
(define-fun o31 () us_t (mk___t o10 o11))
(define-fun o32 () us_t (mk___t o7 o8))
(define-fun o33 () us_t (mk___t o5 o6))
...
(assert (or (and (and (and (= perm__remove_perm__result6 (mk_int__ref perm__remove_perm__result2)) (and (= ia24 ia28) (= h9 (mk_int__ref h1)))) (and (= perm__remove_perm__result7 perm__remove_perm__result2) (and (= ia25 ia21) (= h10 h1)))) (and (= ib ib2) (and (= (mk_int__ref result1) (mk_int__ref perm__remove_perm__result)) (= perm__remove_perm__result2 1)))) (and (and (not (= ib ib2)) (and (= perm__remove_perm__result2 perm__remove_perm__result) (= perm__remove_perm__result2 perm__remove_perm__result1))) (and (and (and (= perm__remove_perm__result6 perm__remove_perm__result4) (and (= ia24 (mk_int__ref ia22)) (= h9 (mk_int__ref h8)))) (and (= perm__remove_perm__result7 perm__remove_perm__result5) (and (= ia25 ia22) (= h10 h8)))) (and (and (and (= o1 (perm_symmetric aa bb2)) (and (in_range4 o1) (=> (= (distinct o1 0) true) (= (is_perm bb2 aa) true)))) (and (= h1 result2) (= h2 o1))) (and (= (distinct h2 0) true) (and (and (and (= o2 (extended_perm bb2 aa)) (and (in_range4 o2) (=> (= (distinct o2 0) true) (forall ((ia3 Int)) (=> (and (<= (to_rep1 (first (rt bb2))) ia3) (<= ia3 (to_rep1 (last (rt bb2))))) (exists ((ib3 Int)) (and (and (<= (to_rep1 (first (rt aa))) ib3) (<= ib3 (to_rep1 (last (rt aa))))) (and (= (to_rep (select (elts bb2) ia3)) (to_rep (select (elts aa) ib3))) (= (is_perm (remove bb2 ia3) (remove aa ib3)) true))))))))) (and (= h2 result3) (= h3 o2))) (and (= (distinct h3 0) true) (and (ite (< ib ib2) (and (and (and (= o3 (get_witness bb2 aa ib)) (and (in_range3 o3) (and (and (<= (to_rep1 (first (rt aa))) o3) (<= o3 (to_rep1 (last (rt aa))))) (and (= (to_rep (select (elts bb2) ib)) (to_rep (select (elts aa) o3))) (= (is_perm (remove bb2 ib) (remove aa o3)) true))))) (and (= (mk_int__ref result4) ia28) (= ia22 o3))) (and (and (and (= o4 (remove_swap b ib ib2)) (and (in_range4 o4) (=> (= (distinct o4 0) true) (= (let ((temp___182 (remove (remove b ib2) ib))) (let ((temp___181 (remove (remove b ib) (- ib2 1)))) (bool_eq (elts temp___181) (to_rep1 (first (rt temp___181))) (to_rep1 (last (rt temp___181))) (elts temp___182) (to_rep1 (first (rt temp___182))) (to_rep1 (last (rt temp___182)))))) true)))) (and (= h3 result5) (= h4 o4))) (and (= (distinct h4 0) true) (and (and (and (and (and (= o9 (- ib2 1)) (in_range3 (- ib2 1))) (and (= o31 (remove bb o9)) (and (dynamic_invariant o31 true false true true) (and (= (invariant__ o31) true) (and (= (to_rep1 (last o11)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o9 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o10 k))))) (and (forall ((k Int)) (=> (and (<= (+ o9 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o10 (- k 1)))))) (forall ((k Int)) (=> (and (<= o9 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o10 k)))))))))))) (and (and (= o32 (remove aa ia22)) (and (dynamic_invariant o32 true false true true) (and (= (invariant__ o32) true) (and (= (to_rep1 (last o8)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia22 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o7 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia22 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o7 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia22 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o7 k))))))))))) (and (and (= o33 (remove bb2 ib)) (and (dynamic_invariant o33 true false true true) (and (= (invariant__ o33) true) (and (= (to_rep1 (last o6)) (- (to_rep1 (last (rt bb2))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib 1))) (= (to_rep (select (elts bb2) k)) (to_rep (select o5 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib 1) k) (<= k (to_rep1 (last (rt bb2))))) (= (to_rep (select (elts bb2) k)) (to_rep (select o5 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib k) (<= k (- (to_rep1 (last (rt bb2))) 1))) (= (to_rep (select (elts bb2) (+ k 1))) (to_rep (select o5 k))))))))))) (and (= o12 (shift_perm_l o33 o32 o31)) (and (in_range4 o12) (=> (= (distinct o12 0) true) (= (is_perm o31 o32) true))))))) (and (= h4 result6) (= h5 o12))) (= (distinct h5 0) true))))) (and (and (and (and (and (= o13 (- ib 1)) (in_range3 (- ib 1))) (and (= o14 (get_witness bb2 aa o13)) (and (in_range3 o14) (and (and (<= (to_rep1 (first (rt aa))) o14) (<= o14 (to_rep1 (last (rt aa))))) (and (= (to_rep (select (elts bb2) o13)) (to_rep (select (elts aa) o14))) (= (is_perm (remove bb2 o13) (remove aa o14)) true)))))) (and (= result7 ia28) (= ia23 o14))) (and (and (and (= o15 (remove_swap b ib2 ib)) (and (in_range4 o15) (=> (= (distinct o15 0) true) (= (let ((temp___182 (remove (remove b ib) ib2))) (let ((temp___181 (remove (remove b ib2) (- ib 1)))) (bool_eq (elts temp___181) (to_rep1 (first (rt temp___181))) (to_rep1 (last (rt temp___181))) (elts temp___182) (to_rep1 (first (rt temp___182))) (to_rep1 (last (rt temp___182)))))) true)))) (and (= result8 (mk_int__ref h3)) (= h6 o15))) (and (= (distinct h6 0) true) (and (and (and (and (= o28 (remove bb ib2)) (and (dynamic_invariant o28 true false true true) (and (= (invariant__ o28) true) (and (= (to_rep1 (last o22)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib2 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o21 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib2 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o21 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib2 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o21 k))))))))))) (and (and (= o29 (remove aa ia23)) (and (dynamic_invariant o29 true false true true) (and (= (invariant__ o29) true) (and (= (to_rep1 (last o20)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia23 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o19 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia23 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o19 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia23 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o19 k))))))))))) (and (and (and (= o16 (- ib 1)) (in_range3 (- ib 1))) (and (= o30 (remove bb2 o16)) (and (dynamic_invariant o30 true false true true) (and (= (invariant__ o30) true) (and (= (to_rep1 (last o18)) (- (to_rep1 (last (rt bb2))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o16 1))) (= (to_rep (select (elts bb2) k)) (to_rep (select o17 k))))) (and (forall ((k Int)) (=> (and (<= (+ o16 1) k) (<= k (to_rep1 (last (rt bb2))))) (= (to_rep (select (elts bb2) k)) (to_rep (select o17 (- k 1)))))) (forall ((k Int)) (=> (and (<= o16 k) (<= k (- (to_rep1 (last (rt bb2))) 1))) (= (to_rep (select (elts bb2) (+ k 1))) (to_rep (select o17 k)))))))))))) (and (= o23 (shift_perm_l o30 o29 o28)) (and (in_range4 o23) (=> (= (distinct o23 0) true) (= (is_perm o28 o29) true))))))) (and (= result9 (mk_int__ref h6)) (= h7 o23))) (= (distinct h7 0) true))))) (and (= ia22 ia23) (= h5 h7)))) (and (and (and (= o24 (perm_symmetric bb aa)) (and (in_range4 o24) (=> (= (distinct o24 0) true) (= (is_perm aa bb) true)))) (and (= result10 (mk_int__ref h5)) (= h8 o24))) (and (and (= perm__remove_perm__result4 (mk_int__ref perm__remove_perm__result3)) (= perm__remove_perm__result5 perm__remove_perm__result3)) (and (= result11 (mk_int__ref perm__remove_perm__result2)) (= perm__remove_perm__result3 h8)))))))))))))
...
(assert (and (= o27 (remove b ib)) (and (dynamic_invariant o27 true false true true) (and (= (invariant__ o27) true) (and (= (to_rep1 (last o26)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib 1))) (= (to_rep (select (elts b) k)) (to_rep (select o25 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o25 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o25 k))))))))))))
