...
(assert true)
(assert (forall ((y Int) (x Int)) (! (= (= (within_bounds y x) true) (and (in_range3 y) (in_range2 x))) :pattern ((within_bounds y x)))))
...
(assert (forall ((x px_coord)) (! (in_range5 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x py_coord)) (! (in_range6 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x direction)) (! (in_range7 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun in_range8 ((x Int)) Bool (and (<= 3 x) (<= x 7)))
...
(define-fun dynamic_invariant1 ((temp___expr_544 Int) (temp___is_init_540 Bool) (temp___skip_constant_541 Bool) (temp___do_toplevel_542 Bool) (temp___do_typ_inv_543 Bool)) Bool (=> (or (= temp___is_init_540 true) (<= 1 7)) (in_range4 temp___expr_544)))
(define-fun dynamic_invariant2 ((temp___expr_551 Int) (temp___is_init_547 Bool) (temp___skip_constant_548 Bool) (temp___do_toplevel_549 Bool) (temp___do_typ_inv_550 Bool)) Bool (=> (or (= temp___is_init_547 true) (<= 3 7)) (in_range8 temp___expr_551)))
(define-fun dynamic_invariant3 ((temp___expr_558 Int) (temp___is_init_554 Bool) (temp___skip_constant_555 Bool) (temp___do_toplevel_556 Bool) (temp___do_typ_inv_557 Bool)) Bool (=> (or (= temp___is_init_554 true) (<= 1 10)) (in_range2 temp___expr_558)))
(define-fun dynamic_invariant4 ((temp___expr_565 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool) (temp___do_typ_inv_564 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 1 50)) (in_range3 temp___expr_565)))
(define-fun dynamic_invariant5 ((temp___expr_595 Int) (temp___is_init_591 Bool) (temp___skip_constant_592 Bool) (temp___do_toplevel_593 Bool) (temp___do_typ_inv_594 Bool)) Bool (=> (or (= temp___is_init_591 true) (<= (- 1) 9)) (in_range5 temp___expr_595)))
(define-fun dynamic_invariant6 ((temp___expr_602 Int) (temp___is_init_598 Bool) (temp___skip_constant_599 Bool) (temp___do_toplevel_600 Bool) (temp___do_typ_inv_601 Bool)) Bool (=> (or (= temp___is_init_598 true) (<= (- 1) 49)) (in_range6 temp___expr_602)))
(define-fun dynamic_invariant7 ((temp___expr_609 Int) (temp___is_init_605 Bool) (temp___skip_constant_606 Bool) (temp___do_toplevel_607 Bool) (temp___do_typ_inv_608 Bool)) Bool (=> (or (= temp___is_init_605 true) (<= 0 3)) (in_range7 temp___expr_609)))
...
(assert (not (= (to_rep (rec__tetris_integrity__piece__s (us_split_fields1 p))) 2)))
(assert (not (= (to_rep (rec__tetris_integrity__piece__s (us_split_fields1 p))) 1)))
(assert (<= 0 y))
(assert (<= y 2))
(assert (<= 0 x))
(assert (<= x 2))
(assert (not (<= 3 (to_rep (rec__tetris_integrity__piece__s (us_split_fields1 p))))))
(check-sat)
(exit)
