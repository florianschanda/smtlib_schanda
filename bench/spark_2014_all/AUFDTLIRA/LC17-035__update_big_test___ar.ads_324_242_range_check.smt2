...
(assert (= a4 a2))
(assert (< j 50))
(assert (=> (< 0 e) (and (= o12 (- e 1)) (in_range2 (- e 1)))))
(assert (=> (< 0 e) (and (<= 5 (+ j 1)) (<= (+ j 1) 50))))
(assert (=> (< 0 e) (= o11 (+ j 1))))
(assert (=> (< 0 e) (= o13 (select a o11))))
(assert (=> (< 0 e) (= o14 (temp_____aggregate_def_940 o13 i o12))))
(assert (=> (< 0 e) (and (= o15 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (< 0 e) (= temp___4643 (temp_____aggregate_def_925 a j (temp_____aggregate_def_933 (select a j) i e) o15 o14))))
(assert (=> (< 0 e) (= result6 (bool_eq1 a3 5 50 temp___4643 5 50))))
...
(assert (= o10 (temp_____aggregate_def_963 o9 i 99)))
