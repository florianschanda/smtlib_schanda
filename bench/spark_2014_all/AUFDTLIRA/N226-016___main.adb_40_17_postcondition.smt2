...
(assert (in_range1 id))
(assert (and (= (to_rep (select map1 0)) 1) (= (to_rep (select map1 1)) 0)))
(assert (forall ((id1 Int)) (=> (and (<= 0 id1) (<= id1 1)) (not (= (to_rep (select map1 id1)) id1)))))
(assert (= main__with_spoon_feeding__result1 main__with_spoon_feeding__result2))
(assert (= main__with_spoon_feeding__result3 main__with_spoon_feeding__result1))
(assert (= result main__with_spoon_feeding__result))
(assert (= main__with_spoon_feeding__result1 (to_rep (select map1 id))))
(assert (= (mk_int__ref main__with_spoon_feeding__result4) (mk_int__ref main__with_spoon_feeding__result2)))
(assert (= main__with_spoon_feeding__result5 main__with_spoon_feeding__result3))
(assert (= result1 main__with_spoon_feeding__result4))
(assert (not (not (= id main__with_spoon_feeding__result4))))
(check-sat)
(exit)
