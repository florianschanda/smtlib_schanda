...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) true) (=> (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2)))) true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i)))) 1)) 0) (< v (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i))) (< (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i)) v)))))))
(assert (and (and (and (=> (<= 0 100) (in_range6 current2)) (=> (<= 0 100) (in_range6 previous2))) (=> (<= 0 1) (in_range9 d2))) (not (= current2 0))))
(assert (= result3 (mk_int__ref temp___734)))
(assert (= temp___7341 (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))))))
(assert (= result4 (mk_int__ref previous2)))
(assert (= previous3 current2))
(assert (and (<= 1 current2) (<= current2 100)))
(assert (= o current2))
(assert (= o1 (select (rec__search_trees__search_tree__values (us_split_fields7 t)) o)))
(assert (= o2 (to_rep o1)))
(assert (= result5 (ite (= v o2) true false)))
(assert (not (= result5 true)))
(assert (and (<= 1 current2) (<= current2 100)))
(assert (= o3 current2))
(assert (= o4 (select (rec__search_trees__search_tree__values (us_split_fields7 t)) o3)))
(assert (= o5 (to_rep o4)))
(assert (= result6 (ite (< v o5) true false)))
(assert (=> (= result6 true) (= result7 (mk_int__ref d2))))
(assert (=> (= result6 true) (= d3 0)))
(assert (=> (= result6 true) (and (= o6 current2) (in_range8 current2))))
(assert (=> (= result6 true) (and (= o7 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) o6 0)) (and (in_range6 o7) (and (ite (not (= o7 0)) (and (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o7) 0) (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o7) o6)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o6) (not (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 0)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o6) (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 0)) (= o7 j)))))))))
(assert (=> (= result6 true) (= result8 (mk_int__ref current2))))
(assert (=> (= result6 true) (= current3 o7)))
(assert (=> (not (= result6 true)) (= result9 (mk_int__ref d2))))
(assert (=> (not (= result6 true)) (= d4 1)))
(assert (=> (not (= result6 true)) (and (= o8 current2) (in_range8 current2))))
(assert (=> (not (= result6 true)) (and (= o9 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) o8 1)) (and (in_range6 o9) (and (ite (not (= o9 0)) (and (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o9) 1) (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o9) o8)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o8) (not (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 1)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o8) (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 1)) (= o9 j)))))))))
(assert (=> (not (= result6 true)) (= result10 (mk_int__ref current2))))
(assert (=> (not (= result6 true)) (= current4 o9)))
(assert (=> (not (= result6 true)) (= d3 d4)))
(assert (=> (not (= result6 true)) (= current3 current4)))
(assert (= search_trees__contains__result1 search_trees__contains__result))
(assert (not (= current3 0)))
(assert (not (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current3))) true)))
(check-sat)
(exit)
