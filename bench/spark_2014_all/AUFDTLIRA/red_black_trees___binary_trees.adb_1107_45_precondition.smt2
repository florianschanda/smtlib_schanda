...
(assert (= r8 r6))
(assert (= n8 n6))
(assert (= (= result2 true) (forall ((r9 Int)) (=> (and (<= 1 r9) (<= r9 (to_rep f_old__split_fields))) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r9)))) 2) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r9) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) r9)) true))))))
(assert (= result2 true))
(assert (<= 1 i))
(assert (<= i 100))
(assert (not (= i root)))
