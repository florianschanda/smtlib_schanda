...
(assert (= (to_rep1 (first6 (rt3 (essai05__conv2__r__aggregate_def 0 (to_rep1 (first2 (rt1 v))) (to_rep1 (last2 (rt1 v))))))) (to_rep1 (first2 (rt1 v)))))
(assert (= (to_rep1 (last6 (rt3 (essai05__conv2__r__aggregate_def 0 (to_rep1 (first2 (rt1 v))) (to_rep1 (last2 (rt1 v))))))) (to_rep1 (last2 (rt1 v)))))
(assert (= (mk___t3 temp___302 temp___3021) (essai05__conv2__r__aggregate_def 0 (to_rep1 (first2 (rt1 v))) (to_rep1 (last2 (rt1 v))))))
(assert (not (= (ite (<= (to_rep1 (first6 temp___3021)) (to_rep1 (last6 temp___3021))) (+ (- (to_rep1 (last6 temp___3021)) (to_rep1 (first6 temp___3021))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 v))) (to_rep1 (last2 (rt1 v)))) (+ (- (to_rep1 (last2 (rt1 v))) (to_rep1 (first2 (rt1 v)))) 1) 0))))
(check-sat)
(exit)
