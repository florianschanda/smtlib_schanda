...
(assert (= (mk___rep (mk___split_discrs result4) (mk___split_fields result5 (mk___t1 result6 result7))) (sequence__content bounded_dynamic_strings__Oconcat__3__result10)))
(assert (not (= (length2 (sequence__content bounded_dynamic_strings__Oconcat__3__result10)) (+ (length3 left) (length2 right)))))
(check-sat)
(exit)
