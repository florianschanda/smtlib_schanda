...
(assert (= c1 0))
(assert (in_range3 c1))
(assert (and (= o (create_step_array i)) (forall ((j4 Int)) (=> (and (<= 0 j4) (<= j4 1001)) (and (=> (< j4 i) (= (to_rep (select o j4)) (- 23))) (=> (<= i j4) (= (to_rep (select o j4)) 69)))))))
...
(assert (<= 0 j1))
(assert (<= j1 1001))
(assert (=> (= (to_rep (select step1 j1)) (- 23)) (and (= o1 (+ c1 1)) (in_range3 (+ c1 1)))))
...
(assert (and (and (=> (<= 0 1002) (in_range3 c3)) (=> (<= 0 1001) (in_range2 j2))) (and (<= 0 j2) (<= j2 1001))))
(assert (not (= j2 1001)))
(assert (= j2 result4))
(assert (= j3 (+ j2 1)))
(assert (= (to_rep (select step1 j3)) (- 23)))
(assert (not (in_range3 (+ c3 1))))
(check-sat)
(exit)
