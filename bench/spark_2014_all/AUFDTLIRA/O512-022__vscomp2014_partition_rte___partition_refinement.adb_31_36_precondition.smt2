...
(define-fun o14 () us_rep6 (mk___rep3 (mk___split_fields3 o6 o7 o8)))
...
(assert (and (= o14 (get3 (model__1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields))) o5)) (= (bool_eq5 o14 (get3 (model__1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields))) o5)) true)))
(assert (= o6 o9))
(assert (= o7 o10))
(assert (= o8 o11))
(assert (= o12 o11))
...
(assert (= o2 (to_rep5 o1)))
(assert (not (<= o2 (last1 (model__1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))))))
(check-sat)
(exit)
