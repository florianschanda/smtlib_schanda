...
(assert (= a4 a2))
(assert (not (or (and (< k 16) (or (and (< 0 e) (= (bool_eq2 a3 1 16 (temp_____aggregate_def_1534 a k (temp_____aggregate_def_1542 (select a k) j (temp_____aggregate_def_1549 (select (select a k) j) i e)) (+ k 1) (temp_____aggregate_def_1557 (select a (+ k 1)) j (temp_____aggregate_def_1564 (select (select a (+ k 1)) j) i (- e 1)))) 1 16) true)) (and (= e 0) (= (bool_eq2 a3 1 16 (temp_____aggregate_def_1573 a k (temp_____aggregate_def_1581 (select a k) j (temp_____aggregate_def_1588 (select (select a k) j) i e)) (+ k 1) (temp_____aggregate_def_1596 (select a (+ k 1)) j (temp_____aggregate_def_1603 (select (select a (+ k 1)) j) i 99))) 1 16) true)))) (and (= k 16) (or (and (< 0 e) (= (bool_eq2 a3 1 16 (temp_____aggregate_def_1612 a k (temp_____aggregate_def_1620 (select a k) j (temp_____aggregate_def_1627 (select (select a k) j) i e)) 1 (temp_____aggregate_def_1635 (select a 1) j (temp_____aggregate_def_1642 (select (select a 1) j) i (- e 1)))) 1 16) true)) (and (= e 0) (= (bool_eq2 a3 1 16 (temp_____aggregate_def_1651 a k (temp_____aggregate_def_1659 (select a k) j (temp_____aggregate_def_1666 (select (select a k) j) i e)) 1 (temp_____aggregate_def_1674 (select a 1) j (temp_____aggregate_def_1681 (select (select a 1) j) i 99))) 1 16) true)))))))
(check-sat)
(exit)
