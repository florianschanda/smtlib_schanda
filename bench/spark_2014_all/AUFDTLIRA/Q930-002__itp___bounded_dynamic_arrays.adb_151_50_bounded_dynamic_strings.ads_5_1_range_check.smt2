...
(assert (not (= (length3 temp___11542) 0)))
(assert (=> (<= (to_rep1 (first4 temp___11551)) (to_rep1 (last4 temp___11551))) (= o2 (+ (- (to_rep1 (last4 temp___11551)) (to_rep1 (first4 temp___11551))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___11551)) (to_rep1 (last4 temp___11551)))) (= o2 0)))
(assert (=> (<= (to_rep1 (first4 temp___11541)) (to_rep1 (last4 temp___11541))) (= o3 (+ (- (to_rep1 (last4 temp___11541)) (to_rep1 (first4 temp___11541))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___11541)) (to_rep1 (last4 temp___11541)))) (= o3 0)))
(assert (= o4 (+ o3 o2)))
(assert (= o5 (+ (to_rep1 (first4 temp___11541)) o4)))
(assert (= o6 (- o5 1)))
