...
(declare-const temp___214 index_type)
(declare-const temp___217 (Array Int character))
...
(assert (= upper_bound (to_rep1 temp___214)))
(assert (= (to_rep3 (first2 (rt1 (temp_____aggregate_def_195 32 1 upper_bound)))) 1))
(assert (= (to_rep3 (last2 (rt1 (temp_____aggregate_def_195 32 1 upper_bound)))) upper_bound))
(assert (= (mk___t1 temp___217 temp___2171) (temp_____aggregate_def_195 32 1 upper_bound)))
(assert (not (= (ite (<= (to_rep3 (first2 temp___2171)) (to_rep3 (last2 temp___2171))) (+ (- (to_rep3 (last2 temp___2171)) (to_rep3 (first2 temp___2171))) 1) 0) (ite (<= 1 upper_bound) (+ (- upper_bound 1) 1) 0))))
(check-sat)
(exit)
