...
(define-fun dynamic_invariant1 ((temp___expr_218 us_rep2) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool) (temp___do_typ_inv_217 Bool)) Bool (let ((temp___220 (rec__p__pp__c (us_split_discrs4 temp___expr_218)))) (and (in_range4 (to_rep temp___220) (to_base (rec__p__pp__r (us_split_fields5 temp___expr_218)))) (and (dynamic_property3 1 (to_rep temp___220) (first3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r (us_split_fields5 temp___expr_218))))) (last3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r (us_split_fields5 temp___expr_218)))))) (and (= (first3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r (us_split_fields5 temp___expr_218))))) 1) (= (last3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r (us_split_fields5 temp___expr_218))))) (to_rep temp___220)))))))
(assert true)
(assert (forall ((self__ us_rep2)) (! (= (= (prot self__) true) (and (= (rec__p__pp__b (us_split_discrs4 self__)) true) (= (rec__p__pp__dummy (us_split_fields5 self__)) true))) :pattern ((prot self__)))))
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__p__pp__dummy1 Bool) (rec__p__pp__r1 us_rep1)))))
(define-fun us_split_fields_Dummy__2__projection ((a us_split_fields6)) Bool (rec__p__pp__dummy1 a))
(define-fun us_split_fields_R__2__projection ((a us_split_fields6)) us_rep1 (rec__p__pp__r1 a))
...
(declare-datatypes () ((us_rep3 (mk___rep3 (us_split_discrs5 us_split_discrs3) (us_split_fields7 us_split_fields6)))))
(define-fun us_rep___9__projection ((a us_rep3)) us_split_discrs3 (us_split_discrs5 a))
(define-fun us_rep___10__projection ((a us_rep3)) us_split_fields6 (us_split_fields7 a))
(define-fun to_base1 ((a us_rep3)) us_rep2 (mk___rep2 (us_split_discrs5 a) (mk___split_fields2 (rec__p__pp__dummy1 (us_split_fields7 a)) (rec__p__pp__r1 (us_split_fields7 a)))))
(define-fun of_base1 ((r us_rep2)) us_rep3 (mk___rep3 (us_split_discrs4 r) (mk___split_fields3 (rec__p__pp__dummy (us_split_fields5 r)) (rec__p__pp__r (us_split_fields5 r)))))
(define-fun in_range5 ((rec__p__pp__b1 Bool) (rec__p__pp__c1 Int) (a us_rep2)) Bool (and (= rec__p__pp__b1 (rec__p__pp__b (us_split_discrs4 a))) (= rec__p__pp__c1 (to_rep (rec__p__pp__c (us_split_discrs4 a))))))
...
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__p__my_rec__content2 us_t2)))))
(define-fun us_split_fields_Content__3__projection ((a us_split_fields8)) us_t2 (rec__p__my_rec__content2 a))
(declare-datatypes () ((us_split_fields__ref4 (mk___split_fields__ref4 (us_split_fields__content4 us_split_fields8)))))
(define-fun us_split_fields__ref___3__projection ((a us_split_fields__ref4)) us_split_fields8 (us_split_fields__content4 a))
(declare-datatypes () ((us_rep4 (mk___rep4 (us_split_discrs6 us_split_discrs) (us_split_fields9 us_split_fields8)))))
(define-fun us_rep___5__projection ((a us_rep4)) us_split_discrs (us_split_discrs6 a))
(define-fun us_rep___6__projection ((a us_rep4)) us_split_fields8 (us_split_fields9 a))
(define-fun to_base2 ((a us_rep4)) us_rep (mk___rep (us_split_discrs6 a) (mk___split_fields (let ((temp___158 (rec__p__my_rec__content2 (us_split_fields9 a)))) (of_array (to_array2 temp___158) (first5 temp___158) (last5 temp___158))))))
(define-fun of_base2 ((r us_rep)) us_rep4 (mk___rep4 (us_split_discrs1 r) (mk___split_fields4 (let ((temp___157 (rec__p__my_rec__content (us_split_fields1 r)))) (of_array2 (to_array temp___157) (first1 temp___157) (last1 temp___157))))))
(define-fun bool_eq6 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (to_rep (rec__p__my_rec__c (us_split_discrs6 a))) (to_rep (rec__p__my_rec__c (us_split_discrs6 b)))) (= (bool_eq5 (rec__p__my_rec__content2 (us_split_fields9 a)) (rec__p__my_rec__content2 (us_split_fields9 b))) true)) true false))
(define-fun in_range6 ((rec__p__my_rec__c1 Int) (a us_rep)) Bool (= rec__p__my_rec__c1 (to_rep (rec__p__my_rec__c (us_split_discrs1 a)))))
...
(declare-fun temp_____aggregate_def_243 (Int Int Int) us_t3)
(define-fun dynamic_invariant2 ((temp___expr_234 us_rep3) (temp___is_init_230 Bool) (temp___skip_constant_231 Bool) (temp___do_toplevel_232 Bool) (temp___do_typ_inv_233 Bool)) Bool (and (=> (not (= temp___skip_constant_231 true)) (in_range5 (distinct 1 0) 10 (to_base1 temp___expr_234))) (let ((temp___236 (rec__p__pp__c (us_split_discrs5 temp___expr_234)))) (and (in_range4 (to_rep temp___236) (to_base (rec__p__pp__r1 (us_split_fields7 temp___expr_234)))) (and (dynamic_property3 1 (to_rep temp___236) (first3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r1 (us_split_fields7 temp___expr_234))))) (last3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r1 (us_split_fields7 temp___expr_234)))))) (and (= (first3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r1 (us_split_fields7 temp___expr_234))))) 1) (= (last3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r1 (us_split_fields7 temp___expr_234))))) (to_rep temp___236))))))))
(define-fun default_initial_assumption ((temp___expr_239 us_rep3) (temp___skip_top_level_240 Bool)) Bool (let ((temp___242 (rec__p__pp__c (us_split_discrs5 temp___expr_239)))) (and (and (and (= (rec__p__pp__b (us_split_discrs5 temp___expr_239)) (distinct 1 0)) (= (to_rep (rec__p__pp__c (us_split_discrs5 temp___expr_239))) 10)) (= (rec__p__pp__dummy1 (us_split_fields7 temp___expr_239)) (distinct 1 0))) (= (rec__p__pp__r1 (us_split_fields7 temp___expr_239)) (of_base (to_base2 (mk___rep4 (mk___split_discrs temp___242) (mk___split_fields4 (let ((temp___249 (temp_____aggregate_def_243 0 1 (to_rep temp___242)))) (of_array2 (to_array3 temp___249) (first7 temp___249) (last7 temp___249)))))))))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range3 f) (=> (in_range3 l) (and (= (to_rep1 (first8 (mk4 f l))) f) (= (to_rep1 (last8 (mk4 f l))) l)))) :pattern ((mk4 f l)))))
(define-fun dynamic_property8 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (in_range2 low) (in_range2 high))))))
...
(define-fun dynamic_invariant5 ((temp___expr_205 us_t4) (temp___is_init_201 Bool) (temp___skip_constant_202 Bool) (temp___do_toplevel_203 Bool) (temp___do_typ_inv_204 Bool)) Bool (=> (not (= temp___skip_constant_202 true)) (dynamic_property8 1 2147483647 (first9 temp___expr_205) (last9 temp___expr_205))))
(define-fun dynamic_invariant6 ((temp___expr_211 us_rep) (temp___is_init_207 Bool) (temp___skip_constant_208 Bool) (temp___do_toplevel_209 Bool) (temp___do_typ_inv_210 Bool)) Bool (let ((temp___212 (rec__p__my_rec__c (us_split_discrs1 temp___expr_211)))) (and (dynamic_property1 1 (to_rep temp___212) (first1 (rec__p__my_rec__content (us_split_fields1 temp___expr_211))) (last1 (rec__p__my_rec__content (us_split_fields1 temp___expr_211)))) (and (= (first1 (rec__p__my_rec__content (us_split_fields1 temp___expr_211))) 1) (= (last1 (rec__p__my_rec__content (us_split_fields1 temp___expr_211))) (to_rep temp___212))))))
(declare-const rliteral natural)
(assert (= (naturalqtint rliteral) 0))
(assert (forall ((temp___245 Int) (temp___246 Int) (temp___247 Int)) (let ((temp___244 (temp_____aggregate_def_243 temp___245 temp___246 temp___247))) (=> (dynamic_invariant temp___245 true true true true) (and (=> (dynamic_property8 1 2147483647 temp___246 temp___247) (and (= (first7 temp___244) temp___246) (= (last7 temp___244) temp___247))) (forall ((temp___248 Int)) (= (select (to_array3 temp___244) temp___248) rliteral)))))))
(declare-const x__split_fields Bool)
(declare-const x__split_fields1 natural)
(declare-const x__split_fields2 (Array Int natural))
(declare-const x__split_fields3 t1)
(declare-const temp___c_259 Int)
...
(declare-const p__c__assume Bool)
(declare-const x__split_fields4 us_split_fields6)
(assert (in_range1 temp___c_259))
(assert (and (= us 10) (in_range1 10)))
(assert (default_initial_assumption (mk___rep3 x__split_discrs (mk___split_fields3 x__split_fields (mk___rep1 (mk___split_discrs x__split_fields1) (mk___split_fields1 (mk___t1 x__split_fields2 x__split_fields3))))) false))
(assert (dynamic_invariant2 (mk___rep3 x__split_discrs (mk___split_fields3 x__split_fields (mk___rep1 (mk___split_discrs x__split_fields1) (mk___split_fields1 (mk___t1 x__split_fields2 x__split_fields3))))) false false true true))
(assert (dynamic_invariant2 (mk___rep3 x__split_discrs x__split_fields4) true true true true))
(assert (= x__split_discrs (mk___split_discrs1 o o1)))
(assert (= x__split_fields4 (mk___split_fields3 o2 (mk___rep1 (mk___split_discrs o3) (mk___split_fields1 (mk___t1 o4 o5))))))
(assert (= o o6))
(assert (= o1 o7))
(assert (= p__c__assume o6))
(assert (= p__c__assume c))
(assert (not (= c true)))
(check-sat)
(exit)
