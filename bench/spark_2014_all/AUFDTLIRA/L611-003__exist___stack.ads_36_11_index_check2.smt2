...
(define-fun dynamic_invariant1 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= (- 1) 2147483647)) (in_range2 temp___expr_166)))
...
(assert (in_range1 s))
(assert (= (= o true) (forall ((i1 Int)) (=> (and (<= (+ s 1) i1) (<= i1 100)) (= (to_rep (select t i1)) (- 1))))))
(assert (<= 1 i))
(assert (<= i s))
(assert (not (<= 1 i)))
(check-sat)
