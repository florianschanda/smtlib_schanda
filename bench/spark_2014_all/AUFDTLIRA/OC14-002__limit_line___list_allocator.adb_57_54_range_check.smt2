...
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o20 (get model____split_fields 1)) (in_range4 o20)))))
...
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o18 (length model____split_fields1)) (in_range3 o18)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o18) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o17 (get model____split_fields1 1)) (in_range4 o17))))))
...
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (and (= o19 (length model____split_fields1)) (in_range3 o19)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (= result1 (ite (= o19 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o15 (length model____split_fields)) (in_range3 o15))))
...
(assert (= result6 true))
(assert (and (= o14 (get model____split_fields1 j)) (in_range4 o14)))
(assert (= result8 (ite (in_range6 o14) true false)))
(assert (=> (= result8 true) (and (= o10 (length model____split_fields1)) (in_range3 o10))))
(assert (=> (= result8 true) (= result9 (ite (< j o10) true false))))
(assert (=> (= result8 true) (=> (= result9 true) (and (= o11 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result8 true) (=> (= result9 true) (and (= o12 (get model____split_fields1 o11)) (in_range4 o12)))))
