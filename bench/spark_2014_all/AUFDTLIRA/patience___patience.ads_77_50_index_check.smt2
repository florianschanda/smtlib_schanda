...
(assert (= o7 (to_rep o6)))
(assert (= o8 (ite (<= o7 (- (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o2 i))
(assert (= o3 (select (rec__patience__state__posstack (us_split_fields1 s)) o2)))
(assert (= o4 (to_rep o3)))
