...
(assert (forall ((temp___517 us_rep) (temp___518 us_rep)) (let ((temp___516 (temp_____aggregate_def_515 temp___517 temp___518))) (forall ((temp___519 Int)) (ite (or (= temp___519 2) (and (<= 4 temp___519) (<= temp___519 6))) (= (select temp___516 temp___519) temp___517) (= (select temp___516 temp___519) temp___518))))))
...
(assert (= o12 o2))
(assert (= o13 o3))
(assert (= o14 (temp_____aggregate_def_515 (mk___rep (mk___split_fields o11 o12 o13)) (mk___rep (mk___split_fields o8 o9 o10)))))
(assert (= result x))
(assert (= x1 o14))
