...
(assert (<= 0 x1))
(assert (<= x1 3))
(assert (and (forall ((temp___761 Int)) (=> (and (<= 1 temp___761) (<= temp___761 50)) (=> (not (= (+ (to_rep2 cur_piece__split_fields3) y2) temp___761)) (= (select cur_board1 temp___761) (select cur_board temp___761))))) (and (<= 0 x2) (<= x2 3))))
