...
(assert (forall ((x (Array Int t)) (inline_for_proof__y (Array Int t))) (forall ((i Int)) (forall ((inline_for_proof__b Bool)) (! (=> (and (dynamic_invariant i true true true true) (and (<= 1 i) (<= i 100))) (let ((result (get2 x i inline_for_proof__y inline_for_proof__b))) (and (= result (ite (= inline_for_proof__b true) (to_rep (select x i)) (to_rep (select inline_for_proof__y i)))) (dynamic_invariant1 result true false true true)))) :pattern ((get2 x i inline_for_proof__y inline_for_proof__b)))))))
(assert (forall ((x (Array Int t)) (inline_for_proof__y (Array Int t))) (forall ((i Int)) (forall ((inline_for_proof__b Bool)) (! (=> (dynamic_invariant i true true true true) (= (get2 x i inline_for_proof__y inline_for_proof__b) (ite (= inline_for_proof__b true) (to_rep (select x i)) (to_rep (select inline_for_proof__y i))))) :pattern ((get2 x i inline_for_proof__y inline_for_proof__b)))))))
(declare-sort taD1 0)
...
(declare-const j Int)
(declare-const o Int)
(assert (forall ((temp___208 Int)) (=> (and (<= 1 temp___208) (<= temp___208 100)) (exists ((temp___209 Int)) (and (and (<= 1 temp___209) (<= temp___209 100)) (= (to_rep (select x temp___208)) (to_rep (select y temp___209))))))))
(assert (<= 1 i))
(assert (<= i 100))
(assert (<= 1 j))
(assert (<= j 100))
(assert (and (= o (get2 y j y b)) (and (in_range1 o) (= o (to_rep (select y j))))))
(assert (not (<= i 100)))
(check-sat)
(exit)
