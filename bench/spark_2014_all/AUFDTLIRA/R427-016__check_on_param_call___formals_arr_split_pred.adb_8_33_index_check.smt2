...
(assert (dynamic_invariant i9b true false false true))
(assert (<= (to_rep1 (first (mk (to_rep1 (first2 (rt1 i9b))) (to_rep1 (last2 (rt1 i9b)))))) 1))
(assert (<= 3 (to_rep1 (last (mk (to_rep1 (first2 (rt1 i9b))) (to_rep1 (last2 (rt1 i9b))))))))
(assert (not (<= 3 (to_rep1 (last2 (rt1 i9b))))))
(check-sat)
(exit)
