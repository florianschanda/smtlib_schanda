...
(define-fun dynamic_invariant1 ((temp___expr_698 Int) (temp___is_init_694 Bool) (temp___skip_constant_695 Bool) (temp___do_toplevel_696 Bool) (temp___do_typ_inv_697 Bool)) Bool (=> (or (= temp___is_init_694 true) (<= 0 4)) (in_range7 temp___expr_698)))
(assert true)
(assert (forall ((p us_rep)) (forall ((a Int)) (! (= (= (move_is_possible p a) true) (ite (= a 0) (in_range3 (- (to_rep2 (rec__tetris_functional__piece__x (us_split_fields1 p))) 1)) (ite (= a 1) (in_range3 (+ (to_rep2 (rec__tetris_functional__piece__x (us_split_fields1 p))) 1)) (=> (= a 2) (in_range4 (+ (to_rep3 (rec__tetris_functional__piece__y (us_split_fields1 p))) 1)))))) :pattern ((move_is_possible p a))))))
...
(assert true)
(assert (forall ((p us_rep)) (forall ((a Int)) (! (=> (dynamic_invariant1 a true true true true) (= (move p a) (ite (= a 0) (mk___rep (let ((usq_ (us_split_fields1 p))) (mk___split_fields (rec__tetris_functional__piece__s usq_) (rec__tetris_functional__piece__d usq_) (of_rep2 (- (to_rep2 (rec__tetris_functional__piece__x (us_split_fields1 p))) 1)) (rec__tetris_functional__piece__y usq_)))) (ite (= a 1) (mk___rep (let ((usq_ (us_split_fields1 p))) (mk___split_fields (rec__tetris_functional__piece__s usq_) (rec__tetris_functional__piece__d usq_) (of_rep2 (+ (to_rep2 (rec__tetris_functional__piece__x (us_split_fields1 p))) 1)) (rec__tetris_functional__piece__y usq_)))) (ite (= a 2) (mk___rep (let ((usq_ (us_split_fields1 p))) (mk___split_fields (rec__tetris_functional__piece__s usq_) (rec__tetris_functional__piece__d usq_) (rec__tetris_functional__piece__x usq_) (of_rep3 (+ (to_rep3 (rec__tetris_functional__piece__y (us_split_fields1 p))) 1))))) (mk___rep (let ((usq_ (us_split_fields1 p))) (mk___split_fields (rec__tetris_functional__piece__s usq_) (of_rep4 (turn_direction (to_rep4 (rec__tetris_functional__piece__d (us_split_fields1 p))) a)) (rec__tetris_functional__piece__x usq_) (rec__tetris_functional__piece__y usq_))))))))) :pattern ((move p a))))))
(declare-const a Int)
...
(define-fun dynamic_invariant3 ((temp___expr_537 Int) (temp___is_init_533 Bool) (temp___skip_constant_534 Bool) (temp___do_toplevel_535 Bool) (temp___do_typ_inv_536 Bool)) Bool (=> (or (= temp___is_init_533 true) (<= 0 7)) (in_range1 temp___expr_537)))
(define-fun dynamic_invariant4 ((temp___expr_544 Int) (temp___is_init_540 Bool) (temp___skip_constant_541 Bool) (temp___do_toplevel_542 Bool) (temp___do_typ_inv_543 Bool)) Bool (=> (or (= temp___is_init_540 true) (<= 1 7)) (in_range2 temp___expr_544)))
...
(define-fun dynamic_invariant5 ((temp___expr_558 Int) (temp___is_init_554 Bool) (temp___skip_constant_555 Bool) (temp___do_toplevel_556 Bool) (temp___do_typ_inv_557 Bool)) Bool (=> (or (= temp___is_init_554 true) (<= 1 10)) (in_range9 temp___expr_558)))
...
(define-fun dynamic_invariant6 ((temp___expr_565 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool) (temp___do_typ_inv_564 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 1 50)) (in_range10 temp___expr_565)))
...
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (forall ((y Int) (x Int)) (! (= (= (is_empty b y x) true) (and (and (in_range9 x) (in_range10 y)) (= (to_rep (let ((temp___673 (select b y))) (select temp___673 x))) 0))) :pattern ((is_empty b y x))))))
...
(define-fun dynamic_invariant10 ((temp___expr_712 Int) (temp___is_init_708 Bool) (temp___skip_constant_709 Bool) (temp___do_toplevel_710 Bool) (temp___do_typ_inv_711 Bool)) Bool (=> (or (= temp___is_init_708 true) (<= 3 4)) (in_range11 temp___expr_712)))
...
(declare-const temp___755 shape)
(declare-const temp___7551 direction)
(declare-const temp___7552 px_coord)
(declare-const temp___7553 py_coord)
...
(define-fun temp___7554 () us_rep (mk___rep (mk___split_fields temp___755 temp___7551 temp___7552 temp___7553)))
...
(assert (in_range7 a))
(assert (= (valid_configuration cur_board (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 cur_piece__split_fields3) cur_state) true))
(assert (or (and (and (and (= candidate__split_fields12 (mk___split_fields__ref candidate__split_fields16)) (and (= success4 (mk_bool__ref success2)) (and (= cur_piece__split_fields12 cur_piece__split_fields8) (and (= cur_piece__split_fields13 cur_piece__split_fields9) (and (= cur_piece__split_fields14 cur_piece__split_fields10) (= cur_piece__split_fields15 cur_piece__split_fields11)))))) (and (= candidate__split_fields13 candidate__split_fields16) (and (= success5 success2) (= cur_piece__split_fields16 cur_piece__split_fields19)))) (and (and (= result (move_is_possible (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 cur_piece__split_fields3)) a)) (= (= result true) (ite (= a 0) (in_range3 (- (to_rep2 cur_piece__split_fields2) 1)) (ite (= a 1) (in_range3 (+ (to_rep2 cur_piece__split_fields2) 1)) (=> (= a 2) (in_range4 (+ (to_rep3 cur_piece__split_fields3) 1))))))) (and (= result true) (and (and (and (= temp___7554 (move (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 cur_piece__split_fields3)) a)) (= temp___7554 (ite (= a 0) (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 (of_rep2 (- (to_rep2 cur_piece__split_fields2) 1)) cur_piece__split_fields3)) (ite (= a 1) (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 (of_rep2 (+ (to_rep2 cur_piece__split_fields2) 1)) cur_piece__split_fields3)) (ite (= a 2) (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 (of_rep3 (+ (to_rep3 cur_piece__split_fields3) 1)))) (mk___rep (mk___split_fields cur_piece__split_fields (of_rep4 (turn_direction (to_rep4 cur_piece__split_fields1) a)) cur_piece__split_fields2 cur_piece__split_fields3))))))) (and (= result12 candidate__split_fields17) (and (= temp___755 candidate__split_fields8) (and (= temp___7551 candidate__split_fields9) (and (= temp___7552 candidate__split_fields10) (= temp___7553 candidate__split_fields11)))))) (and (and (= result5 (no_overlap cur_board (mk___rep candidate__split_fields16))) (= (= result5 true) (ite (= (to_rep1 candidate__split_fields8) 2) (and (and (and (= (is_empty cur_board (to_rep3 candidate__split_fields11) (to_rep2 candidate__split_fields10)) true) (= (is_empty cur_board (to_rep3 candidate__split_fields11) (+ (to_rep2 candidate__split_fields10) 1)) true)) (= (is_empty cur_board (+ (to_rep3 candidate__split_fields11) 1) (to_rep2 candidate__split_fields10)) true)) (= (is_empty cur_board (+ (to_rep3 candidate__split_fields11) 1) (+ (to_rep2 candidate__split_fields10) 1)) true)) (ite (= (to_rep1 candidate__split_fields8) 1) (forall ((y Int)) (=> (and (<= 0 y) (<= y 3)) (forall ((x Int)) (=> (and (<= 0 x) (<= x 3)) (=> (= (get (select possible_i_shapes (to_rep4 candidate__split_fields9)) y x) true) (= (is_empty cur_board (+ (to_rep3 candidate__split_fields11) y) (+ (to_rep2 candidate__split_fields10) x)) true)))))) (forall ((y Int)) (=> (and (<= 0 y) (<= y 2)) (forall ((x Int)) (=> (and (<= 0 x) (<= x 2)) (=> (= (get (get1 possible_three_shapes (to_rep1 candidate__split_fields8) (to_rep4 candidate__split_fields9)) y x) true) (= (is_empty cur_board (+ (to_rep3 candidate__split_fields11) y) (+ (to_rep2 candidate__split_fields10) x)) true)))))))))) (and (= result5 true) (and (and (and (= result6 cur_piece__split_fields) (and (= result7 cur_piece__split_fields1) (and (= result8 cur_piece__split_fields2) (= result9 cur_piece__split_fields3)))) (= cur_piece__split_fields19 candidate__split_fields16)) (and (= result10 success) (= success2 (distinct 1 0)))))))))) (and (and (and (= result (move_is_possible (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 cur_piece__split_fields3)) a)) (= (= result true) (ite (= a 0) (in_range3 (- (to_rep2 cur_piece__split_fields2) 1)) (ite (= a 1) (in_range3 (+ (to_rep2 cur_piece__split_fields2) 1)) (=> (= a 2) (in_range4 (+ (to_rep3 cur_piece__split_fields3) 1))))))) (ite (= result true) (and (and (and (= temp___7554 (move (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 cur_piece__split_fields3)) a)) (= temp___7554 (ite (= a 0) (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 (of_rep2 (- (to_rep2 cur_piece__split_fields2) 1)) cur_piece__split_fields3)) (ite (= a 1) (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 (of_rep2 (+ (to_rep2 cur_piece__split_fields2) 1)) cur_piece__split_fields3)) (ite (= a 2) (mk___rep (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 (of_rep3 (+ (to_rep3 cur_piece__split_fields3) 1)))) (mk___rep (mk___split_fields cur_piece__split_fields (of_rep4 (turn_direction (to_rep4 cur_piece__split_fields1) a)) cur_piece__split_fields2 cur_piece__split_fields3))))))) (and (= result12 candidate__split_fields17) (and (= temp___755 candidate__split_fields8) (and (= temp___7551 candidate__split_fields9) (and (= temp___7552 candidate__split_fields10) (= temp___7553 candidate__split_fields11)))))) (and (and (= result5 (no_overlap cur_board (mk___rep candidate__split_fields16))) (= (= result5 true) (ite (= (to_rep1 candidate__split_fields8) 2) (and (and (and (= (is_empty cur_board (to_rep3 candidate__split_fields11) (to_rep2 candidate__split_fields10)) true) (= (is_empty cur_board (to_rep3 candidate__split_fields11) (+ (to_rep2 candidate__split_fields10) 1)) true)) (= (is_empty cur_board (+ (to_rep3 candidate__split_fields11) 1) (to_rep2 candidate__split_fields10)) true)) (= (is_empty cur_board (+ (to_rep3 candidate__split_fields11) 1) (+ (to_rep2 candidate__split_fields10) 1)) true)) (ite (= (to_rep1 candidate__split_fields8) 1) (forall ((y Int)) (=> (and (<= 0 y) (<= y 3)) (forall ((x Int)) (=> (and (<= 0 x) (<= x 3)) (=> (= (get (select possible_i_shapes (to_rep4 candidate__split_fields9)) y x) true) (= (is_empty cur_board (+ (to_rep3 candidate__split_fields11) y) (+ (to_rep2 candidate__split_fields10) x)) true)))))) (forall ((y Int)) (=> (and (<= 0 y) (<= y 2)) (forall ((x Int)) (=> (and (<= 0 x) (<= x 2)) (=> (= (get (get1 possible_three_shapes (to_rep1 candidate__split_fields8) (to_rep4 candidate__split_fields9)) y x) true) (= (is_empty cur_board (+ (to_rep3 candidate__split_fields11) y) (+ (to_rep2 candidate__split_fields10) x)) true)))))))))) (and (not (= result5 true)) (and (and (= success2 success) (and (= cur_piece__split_fields cur_piece__split_fields8) (and (= cur_piece__split_fields1 cur_piece__split_fields9) (and (= cur_piece__split_fields2 cur_piece__split_fields10) (= cur_piece__split_fields3 cur_piece__split_fields11))))) (and (= success2 success1) (= cur_piece__split_fields19 cur_piece__split_fields20)))))) (and (and (and (= candidate__split_fields candidate__split_fields8) (and (= candidate__split_fields1 candidate__split_fields9) (and (= candidate__split_fields2 candidate__split_fields10) (= candidate__split_fields3 candidate__split_fields11)))) (and (= success2 success) (and (= cur_piece__split_fields cur_piece__split_fields8) (and (= cur_piece__split_fields1 cur_piece__split_fields9) (and (= cur_piece__split_fields2 cur_piece__split_fields10) (= cur_piece__split_fields3 cur_piece__split_fields11)))))) (and (and (= candidate__split_fields4 candidate__split_fields8) (and (= candidate__split_fields5 candidate__split_fields9) (and (= candidate__split_fields6 candidate__split_fields10) (= candidate__split_fields7 candidate__split_fields11)))) (and (= success2 success1) (= cur_piece__split_fields19 cur_piece__split_fields20)))))) (and (and (and (= candidate__split_fields12 (mk___split_fields__ref candidate__split_fields16)) (and (= success4 (mk_bool__ref success3)) (and (= cur_piece__split_fields12 cur_piece__split_fields8) (and (= cur_piece__split_fields13 cur_piece__split_fields9) (and (= cur_piece__split_fields14 cur_piece__split_fields10) (= cur_piece__split_fields15 cur_piece__split_fields11)))))) (and (= candidate__split_fields13 candidate__split_fields16) (and (= success5 success3) (= cur_piece__split_fields16 cur_piece__split_fields19)))) (and (= result11 success2) (= success3 (distinct 0 0)))))))
...
(assert (not (= (valid_configuration cur_board (us_split_fields__content cur_piece__split_fields17) cur_state) true)))
(check-sat)
(exit)
