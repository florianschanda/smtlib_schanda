...
(assert (= smallest3 o3))
(assert (=> (not (= smallest3 current3)) (= prec3 result8)))
(assert (=> (not (= smallest3 current3)) (= prec4 values3)))
(assert (=> (not (= smallest3 current3)) (= (is_perm (mk___t values3 (mk 1 100)) (mk___t values4 (mk 1 100))) true)))
(assert (=> (not (= smallest3 current3)) (and (= o4 (perm_transitive (mk___t init (mk 1 100)) (mk___t prec4 (mk 1 100)) (mk___t values4 (mk 1 100)))) (and (in_range5 o4) (=> (= (distinct o4 0) true) (= (is_perm (mk___t init (mk 1 100)) (mk___t values4 (mk 1 100))) true))))))
(assert (=> (not (= smallest3 current3)) (= result9 hr3)))
(assert (=> (not (= smallest3 current3)) (= hr4 o4)))
(assert (=> (not (not (= smallest3 current3))) (= hr4 hr3)))
(assert (=> (not (not (= smallest3 current3))) (= prec4 prec3)))
(assert (=> (not (not (= smallest3 current3))) (= values4 values3)))
(assert (not (= (is_perm (mk___t values (mk 1 100)) (mk___t values4 (mk 1 100))) true)))
(check-sat)
(exit)
