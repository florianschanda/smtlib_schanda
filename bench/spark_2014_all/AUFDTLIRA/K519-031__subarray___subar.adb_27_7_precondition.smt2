...
(assert (forall ((i tTadSP1)) (and (<= 1 (tTadSP1qtint i)) (<= (tTadSP1qtint i) 10))))
...
(assert (forall ((temp___285 Int)) (=> (dynamic_invariant1 temp___285 true true true true) (forall ((temp___286 Int)) (= (select (temp_____aggregate_def_283 temp___285) temp___286) rliteral)))))
