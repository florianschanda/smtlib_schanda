...
(assert (and (= o12 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= o15 (ite (<= o12 index) true false)))
(assert (= result (ite (= o15 true) o14 false)))
(assert (= (= o16 true) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 10) index1) (<= index1 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
...
(assert (= o8 temp___1927))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (< o10 57) true false)))
...
(assert (not (<= temp___1924 (to_rep1 (last (rt source))))))
(check-sat)
(exit)
