...
(assert (<= temp___2412 index1))
(assert (<= index1 temp___2413))
...
(assert (and (and (forall ((temp___2416 Int)) (=> (and (<= (to_rep1 n__first) temp___2416) (<= temp___2416 (to_rep1 n__last))) (=> (or (< temp___2413 temp___2416) (or (< temp___2416 temp___2412) (< index2 temp___2416))) (= (select n3 temp___2416) (select n1 temp___2416))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 6)))))
(assert (not (= index2 temp___2413)))
...
(assert (= n4 o17))
(declare-const i Int)
(assert (<= (+ (to_rep1 (first (rt source))) 1) i))
(assert (<= i index3))
