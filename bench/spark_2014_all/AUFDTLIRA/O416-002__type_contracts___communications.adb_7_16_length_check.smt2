...
(assert (not (= (ite (<= (to_rep1 (first2 temp___3621)) (to_rep1 (last2 temp___3621))) (+ (- (to_rep1 (last2 temp___3621)) (to_rep1 (first2 temp___3621))) 1) 0) (ite (<= (to_rep1 (first com__split_fields1)) (to_rep1 (last com__split_fields1))) (+ (- (to_rep1 (last com__split_fields1)) (to_rep1 (first com__split_fields1))) 1) 0))))
(check-sat)
(exit)
