...
(assert (=> (and (<= l i1) (<= i1 u)) (and (forall ((n Int)) (=> (and (<= l n) (<= n i2)) (= (to_rep (select a3 n)) 0))) (forall ((n Int)) (=> (and (<= 1 n) (<= n 100)) (=> (or (< n l) (< i2 n)) (= (to_rep (select a3 n)) (to_rep (select temp___187 n)))))))))
...
(assert (<= n 100))
(assert (or (< n l) (< u n)))
(assert (not (= (to_rep (select a8 n)) (to_rep (select a n)))))
(check-sat)
(exit)
