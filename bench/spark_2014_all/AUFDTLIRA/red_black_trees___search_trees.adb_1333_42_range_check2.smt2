...
(assert (and (= temp___1954 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o3)) (and (dynamic_invariant8 temp___1954 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1954 o3))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1954 o3)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o3)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1954 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1954 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1954 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1954 i1))) true) (not (= i1 o3))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1954 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1954 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1954 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1954 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1954 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1954 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1954 j)))) true)) (= j i1))))))))))))))
(assert (and (<= 1 i) (<= i 100)))
(assert (= o4 i))
(assert (= o5 (select temp___1954 o4)))
