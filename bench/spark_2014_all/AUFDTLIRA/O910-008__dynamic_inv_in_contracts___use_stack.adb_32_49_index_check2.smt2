...
(define-fun dynamic_invariant2 ((temp___expr_222 us_t) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (not (= temp___skip_constant_219 true)) (and (dynamic_property1 1 max (first1 temp___expr_222) (last1 temp___expr_222)) (and (= (first1 temp___expr_222) 1) (= (last1 temp___expr_222) max)))))
(declare-const i Int)
(assert (in_range1 max))
(assert (in_range1 e))
(assert (and (dynamic_property1 1 max (to_rep1 content__first) (to_rep1 content__last)) (and (= (to_rep1 content__first) 1) (= (to_rep1 content__last) max))))
(assert (<= 1 i))
(assert (<= i (to_rep1 content__last)))
(assert (not (<= (to_rep1 content__first) i)))
(check-sat)
(exit)
