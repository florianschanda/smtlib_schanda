...
(assert (ite (= o11 (to_rep (select (elts1 init) o8))) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e3) (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e3)) (ite (= o11 e3) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e3) (+ (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e3) 1)) (ite (= (to_rep (select (elts1 init) o8)) e3) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e3) (- (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e3) 1)) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e3) (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e3))))))
(assert (and (<= (to_rep1 (first2 (rt1 init))) x) (<= x (to_rep1 (last2 (rt1 init))))))
(assert (= o12 x))
