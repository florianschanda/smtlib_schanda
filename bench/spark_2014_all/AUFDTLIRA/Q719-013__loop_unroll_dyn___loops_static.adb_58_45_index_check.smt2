...
(assert (= j2 (to_rep1 a__first)))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= temp___338 bad1)))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (and (<= (to_rep1 a__first) j3) (<= j3 i1))))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (and (<= (to_rep1 a__first) j3) (<= j3 (to_rep1 a__last)))))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= o2 j3)))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= o3 (select a1 o2))))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= o4 (to_rep o3))))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= o5 (ite (= o4 0) true false))))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= result4 (ite (not (= o5 true)) true false))))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (=> (= result4 true) (= bad2 result5))))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (=> (= result4 true) (= bad3 (distinct 1 0)))))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (=> (not (= result4 true)) (= bad3 bad2))))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= j3 i1)))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= j3 j4)))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= bad3 bad4)))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= j5 j3)))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= bad5 bad3)))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= (mk_int__ref j6) (mk_int__ref j4))))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= (mk_bool__ref bad6) (mk_bool__ref bad4))))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= j7 j5)))
(assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= bad7 bad5)))
(assert (=> (not (and (<= (to_rep1 a__first) j2) (<= j2 i1))) (= j2 j6)))
(assert (=> (not (and (<= (to_rep1 a__first) j2) (<= j2 i1))) (= bad1 bad6)))
(assert (=> (not (and (<= (to_rep1 a__first) j2) (<= j2 i1))) (= j7 j2)))
(assert (=> (not (and (<= (to_rep1 a__first) j2) (<= j2 i1))) (= bad7 bad1)))
(assert (<= (to_rep1 a__first) j1))
(assert (<= j1 i1))
(assert (not (<= j1 (to_rep1 a__last))))
(check-sat)
(exit)
