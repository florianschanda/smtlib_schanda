...
(assert (and (= o4 right3) (not (= right3 2147483647))))
(assert (= o5 (+ o4 1)))
(assert (= right3 result6))
(assert (= right4 o5))
(assert (= right_is_out2 result7))
(assert (= right_is_out3 (ite (< 100000 right4) true false)))
(assert (=> (= right_is_out3 true) (= result8 true)))
(assert (=> (not (= right_is_out3 true)) (and (<= 0 right4) (<= right4 100000))))
(assert (=> (not (= right_is_out3 true)) (= o6 right4)))
(assert (=> (not (= right_is_out3 true)) (= result8 (select number_list o6))))
