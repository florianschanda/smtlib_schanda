...
(declare-datatypes () ((arr_int_unconstrained__ref (mk_arr_int_unconstrained__ref (arr_int_unconstrained__content us_t1)))))
(define-fun arr_int_unconstrained__ref___projection ((a arr_int_unconstrained__ref)) us_t1 (arr_int_unconstrained__content a))
...
(define-fun dynamic_invariant2 ((temp___expr_189 us_t1) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (not (= temp___skip_constant_186 true)) (dynamic_property1 (- 2147483648) 2147483647 (first3 temp___expr_189) (last3 temp___expr_189))))
(define-fun dynamic_invariant3 ((temp___expr_217 us_t) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool (=> (not (= temp___skip_constant_214 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_217) (last1 temp___expr_217))))
(declare-const temp___281 (Array Int integer))
(declare-const temp___2811 t1)
(declare-const o (Array Int integer))
(declare-const o1 t)
(assert (forall ((i Int)) (=> (and (<= 2 i) (<= i 10)) (< (to_rep (select arr (- i 1))) (to_rep (select arr i))))))
(assert (dynamic_property1 (- 2147483648) 2147483647 1 10))
(assert (= arr temp___281))
(assert (= (mk1 1 10) temp___2811))
(assert (dynamic_property (- 2147483648) 2147483647 (to_rep (first2 temp___2811)) (to_rep (last2 temp___2811))))
(assert (= temp___281 o))
(assert (= (mk (to_rep (first2 temp___2811)) (to_rep (last2 temp___2811))) o1))
(assert (forall ((i Int)) (=> (and (<= (to_rep (first o1)) i) (<= i (to_rep (last o1)))) (forall ((j Int)) (=> (and (<= (to_rep (first o1)) j) (<= j (to_rep (last o1)))) (=> (< i j) (< (to_rep (select o i)) (to_rep (select o j)))))))))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i 10))
(declare-const j Int)
...
(assert (<= j 10))
(assert (< i j))
(assert (not (< (to_rep (select arr i)) (to_rep (select arr j)))))
(check-sat)
(exit)
