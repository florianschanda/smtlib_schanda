...
(assert (not (= (length (mk___t temp___1695 temp___16951)) 0)))
(assert (=> (<= 1 12) (= o6 (+ (- 12 1) 1))))
(assert (=> (not (<= 1 12)) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___16951)) (to_rep1 (last temp___16951))) (= o7 (+ (- (to_rep1 (last temp___16951)) (to_rep1 (first temp___16951))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___16951)) (to_rep1 (last temp___16951)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___16951)) o8)))
(assert (= o10 (- o9 1)))
