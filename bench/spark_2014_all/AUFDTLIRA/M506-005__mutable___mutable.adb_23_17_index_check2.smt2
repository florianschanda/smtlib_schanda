...
(declare-const x__split_fields7 (Array Int integer))
(declare-const x__split_fields8 t)
(declare-const x__split_discrs2 d)
...
(assert (=> (< 0 (to_rep1 x__split_discrs)) (= x__split_discrs x__split_discrs2)))
(assert (=> (< 0 (to_rep1 x__split_discrs)) (= x__split_fields x__split_fields6)))
(assert (=> (< 0 (to_rep1 x__split_discrs)) (= x__split_fields1 x__split_fields7)))
(assert (=> (< 0 (to_rep1 x__split_discrs)) (= x__split_fields2 x__split_fields8)))
(assert (=> (< 0 (to_rep1 x__split_discrs)) (= x__split_discrs1 x__split_discrs2)))
(assert (=> (< 0 (to_rep1 x__split_discrs)) (= x__split_fields3 x__split_fields6)))
(assert (=> (< 0 (to_rep1 x__split_discrs)) (= x__split_fields4 x__split_fields7)))
(assert (=> (< 0 (to_rep1 x__split_discrs)) (= x__split_fields5 x__split_fields8)))
(assert (=> (not (< 0 (to_rep1 x__split_discrs))) (dynamic_invariant1 (mk___rep (mk___split_discrs x__split_discrs2) (mk___split_fields x__split_fields6 (mk___t x__split_fields7 x__split_fields8)) x__attr__constrained) true true true true)))
(assert (not (<= (to_rep2 (first x__split_fields8)) 1)))
(check-sat)
(exit)
