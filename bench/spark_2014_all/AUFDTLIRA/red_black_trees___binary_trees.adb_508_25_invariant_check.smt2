...
(assert (= o13 (select temp___1324 i)))
...
(assert (= o9 v))
(assert (= o10 (select temp___1323 o9)))
(assert (= o11 (us_split_fields1 o10)))
(assert (= o12 (rec__tree_model__path_type__a o11)))
(assert (and (= result3 (ole o12 o15)) (= (= result3 true) (and (<= (length o12) (length o15)) (forall ((n3 Int)) (=> (and (<= 1 n3) (<= n3 (last o12))) (= (get o12 n3) (get o15 n3))))))))
(assert (= result3 true))
(assert (and (= o16 v) (in_range2 v)))
