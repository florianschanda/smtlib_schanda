...
(declare-const temp___1591 (Array Int us_rep3))
...
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) i2))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) j3)))) true))
(assert (and (= temp___1591 (model__ f root)) (and (dynamic_invariant5 temp___1591 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1591 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1591 root)))) 0) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (not (= i3 root)) (ite (and (not (= (parent f i3) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1591 (parent f i3)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1591 i3))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1591 i3))) true)))))) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1591 i3))) true) (not (= i3 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1591 (parent f i3)))) (position f i3) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1591 i3)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1591 i3)))) 0)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1591 i3))) true) (forall ((j4 Int)) (=> (and (<= 1 j4) (<= j4 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1591 j4))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1591 i3))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1591 j4)))) true)) (= j4 i3))))))))))))))
(assert (= o44 (select temp___1591 i2)))
