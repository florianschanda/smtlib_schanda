...
(assert (= o26 (select temp___1785 i)))
(assert (= o27 (us_split_fields1 o26)))
(assert (= result5 (rec__tree_model__path_type__k o27)))
...
(assert (=> (= result5 true) (= o24 (select temp___1786 j))))
(assert (=> (= result5 true) (= o25 (us_split_fields1 o24))))
(assert (=> (= result5 true) (= result4 (rec__tree_model__path_type__k o25))))
...
(assert (=> (= result4 true) (= o21 (select temp___1788 j))))
(assert (=> (= result4 true) (= o22 (us_split_fields1 o21))))
(assert (=> (= result4 true) (= o23 (rec__tree_model__path_type__a o22))))
...
(assert (=> (= result4 true) (= o18 (select temp___1787 i))))
(assert (=> (= result4 true) (= o19 (us_split_fields1 o18))))
(assert (=> (= result4 true) (= o20 (rec__tree_model__path_type__a o19))))
(assert (=> (= result4 true) (and (= result3 (olt o20 o23)) (= (= result3 true) (and (< (length o20) (length o23)) (forall ((n Int)) (=> (and (<= 1 n) (<= n (last o20))) (= (get o20 n) (get o23 n)))))))))
