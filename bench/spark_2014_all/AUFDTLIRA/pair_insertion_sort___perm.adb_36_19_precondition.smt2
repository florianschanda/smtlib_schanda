...
(assert (= o1 i))
(assert (= temp___267 (store b1 o1 o)))
(assert (= (to_rep b__first) 0))
(assert (= o2 temp___267))
(assert (= b1 result1))
(assert (= b2 o2))
(assert (and (= o5 (remove_last r)) (and (dynamic_invariant1 o5 true false true true) (and (= (elts r) o3) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1))))) o4)))))
