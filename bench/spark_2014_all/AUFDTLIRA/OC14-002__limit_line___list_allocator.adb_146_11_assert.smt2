...
(assert (not (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j))))) (ite (< j (length (rec__list_allocator__m__t__available model____split_fields3))) (get ma1 (+ j 2)) 0))))
(check-sat)
(exit)
