...
(assert (and (and (forall ((m1 Int)) (=> (and (<= (to_rep a_v1__first) m1) (<= m1 k_1)) (= (to_rep (select (map__content a_v1) m1)) (to_rep (select (elts b_v1) m1))))) (forall ((m1 Int)) (=> (and (<= (+ k_1 1) m1) (<= m1 (to_rep a_v1__last))) (= (to_rep (select (map__content a_v1) m1)) (to_rep (select (elts c_v1) (- m1 k_1))))))) (forall ((m1 Int)) (=> (and (<= (to_rep a_v2__first) m1) (<= m1 k_2)) (= (to_rep (select (map__content a_v2) m1)) (to_rep (select (elts b_v2) m1)))))))
(assert (and (= temp___501 (+ k_2 1)) (in_range1 (+ k_2 1))))
(assert (= result (mk_int__ref i_v2)))
(assert (= i_v21 temp___501))
(assert (<= temp___501 i_v21))
(assert (<= i_v21 (to_rep a_v2__last)))
(assert (and (forall ((m1 Int)) (=> (and (<= (to_rep a_v2__first) m1) (<= m1 k_2)) (= (to_rep (select a_v21 m1)) (to_rep (select (elts b_v2) m1))))) (forall ((m1 Int)) (=> (and (<= (+ k_2 1) m1) (<= m1 (- i_v22 1))) (= (to_rep (select a_v21 m1)) (to_rep (select (elts c_v2) (- m1 k_2))))))))
(assert (and (and (forall ((temp___506 Int)) (=> (and (<= (to_rep a_v2__first) temp___506) (<= temp___506 (to_rep a_v2__last))) (=> (or (< (to_rep a_v2__last) temp___506) (or (< temp___506 temp___501) (<= i_v22 temp___506))) (= (select a_v21 temp___506) (select (map__content a_v2) temp___506))))) (=> (<= (+ k_2 1) (to_rep a_v2__last)) (dynamic_property4 (+ k_2 1) (to_rep a_v2__last) i_v22))) (and (<= (+ k_2 1) i_v22) (<= i_v22 (to_rep a_v2__last)))))
(assert (= (= result1 true) (forall ((m1 Int)) (=> (and (<= (to_rep a_v2__first) m1) (<= m1 k_2)) (= (to_rep (select a_v21 m1)) (to_rep (select (elts b_v2) m1)))))))
(assert (= result1 true))
(assert (<= (+ k_2 1) m))
(assert (<= m (- i_v22 1)))
(assert (and (<= (to_rep (first (rt c_v2))) (- m k_2)) (<= (- m k_2) (to_rep (last (rt c_v2))))))
(assert (= o (- m k_2)))
(assert (= o1 (select (elts c_v2) o)))
(assert (= o2 (to_rep o1)))
(assert (not (<= m (to_rep a_v2__last))))
(check-sat)
(exit)
