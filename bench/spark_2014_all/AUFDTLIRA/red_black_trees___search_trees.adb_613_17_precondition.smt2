...
(assert (in_range7 l))
(assert (in_range1 v))
(assert (and (= o2 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range5 o2)))
(assert (= result (ite (< 0 o2) true false)))
(assert (= result true))
(assert (not (= (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) 0)))
(assert (and (= o1 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range7 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (and (= result1 (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) o1) (not (= result1 true)))))
(assert (= result1 true))
