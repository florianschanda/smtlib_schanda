...
(define-fun s__split_fields6 () us_split_fields (mk___split_fields s__split_fields3 s__split_fields4 s__split_fields5))
(assert (=> (<= 0 2147483647) (in_range2 e)))
(assert (and (= (is_empty (mk___rep s__split_fields6 s__attr__tag)) true) (reset__specific_post s__attr__tag s__split_fields6 s__attr__tag (mk___split_fields s__split_fields s__split_fields1 s__split_fields2))))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 1))
(assert (not (not (= (is_full (mk___rep s__split_fields6 s__attr__tag)) true))))
(check-sat)
(exit)
