...
(declare-const temp___1516 (Array Int character))
(declare-const temp___15161 t)
...
(declare-const temp___1519 (Array Int character))
(declare-const temp___15191 t)
...
(declare-const bio__makedescription__setresultstring__fullstring__assume (Array Int character))
(declare-const bio__makedescription__setresultstring__fullstring__assume1 t)
(declare-const temp___1525 (Array Int character))
(declare-const temp___15251 t3)
...
(assert (=> (= (length (mk___t temp___1514 temp___15141)) 0) (= (temp___String_Literal_1513 Tuple0) temp___1516)))
(assert (=> (= (length (mk___t temp___1514 temp___15141)) 0) (= (mk 1 3) temp___15161)))
(assert (=> (not (= (length (mk___t temp___1514 temp___15141)) 0)) (=> (<= 1 3) (= o12 (+ (- 3 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1514 temp___15141)) 0)) (=> (not (<= 1 3)) (= o12 0))))
(assert (=> (not (= (length (mk___t temp___1514 temp___15141)) 0)) (=> (<= (to_rep1 (first temp___15141)) (to_rep1 (last temp___15141))) (= o13 (+ (- (to_rep1 (last temp___15141)) (to_rep1 (first temp___15141))) 1)))))
(assert (=> (not (= (length (mk___t temp___1514 temp___15141)) 0)) (=> (not (<= (to_rep1 (first temp___15141)) (to_rep1 (last temp___15141)))) (= o13 0))))
(assert (=> (not (= (length (mk___t temp___1514 temp___15141)) 0)) (= o14 (+ o13 o12))))
(assert (=> (not (= (length (mk___t temp___1514 temp___15141)) 0)) (= o15 (+ (to_rep1 (first temp___15141)) o14))))
(assert (=> (not (= (length (mk___t temp___1514 temp___15141)) 0)) (= o16 (- o15 1))))
(assert (=> (not (= (length (mk___t temp___1514 temp___15141)) 0)) (and (= o17 o16) (in_range2 o16))))
(assert (=> (not (= (length (mk___t temp___1514 temp___15141)) 0)) (= (concat1 temp___1514 (to_rep1 (first temp___15141)) (to_rep1 (last temp___15141)) (temp___String_Literal_1513 Tuple0) 1 3) temp___1516)))
(assert (=> (not (= (length (mk___t temp___1514 temp___15141)) 0)) (= (mk (to_rep1 (first temp___15141)) o17) temp___15161)))
(assert (=> (= (length (mk___t temp___1516 temp___15161)) 0) (= temp___1517 temp___1519)))
(assert (=> (= (length (mk___t temp___1516 temp___15161)) 0) (= (mk (to_rep1 (first2 temp___15171)) (to_rep1 (last2 temp___15171))) temp___15191)))
(assert (=> (not (= (length (mk___t temp___1516 temp___15161)) 0)) (=> (<= (to_rep1 (first2 temp___15171)) (to_rep1 (last2 temp___15171))) (= o18 (+ (- (to_rep1 (last2 temp___15171)) (to_rep1 (first2 temp___15171))) 1)))))
(assert (=> (not (= (length (mk___t temp___1516 temp___15161)) 0)) (=> (not (<= (to_rep1 (first2 temp___15171)) (to_rep1 (last2 temp___15171)))) (= o18 0))))
(assert (=> (not (= (length (mk___t temp___1516 temp___15161)) 0)) (=> (<= (to_rep1 (first temp___15161)) (to_rep1 (last temp___15161))) (= o19 (+ (- (to_rep1 (last temp___15161)) (to_rep1 (first temp___15161))) 1)))))
(assert (=> (not (= (length (mk___t temp___1516 temp___15161)) 0)) (=> (not (<= (to_rep1 (first temp___15161)) (to_rep1 (last temp___15161)))) (= o19 0))))
(assert (=> (not (= (length (mk___t temp___1516 temp___15161)) 0)) (= o20 (+ o19 o18))))
(assert (=> (not (= (length (mk___t temp___1516 temp___15161)) 0)) (= o21 (+ (to_rep1 (first temp___15161)) o20))))
(assert (=> (not (= (length (mk___t temp___1516 temp___15161)) 0)) (= o22 (- o21 1))))
(assert (=> (not (= (length (mk___t temp___1516 temp___15161)) 0)) (and (= o23 o22) (in_range2 o22))))
(assert (=> (not (= (length (mk___t temp___1516 temp___15161)) 0)) (= (concat1 temp___1516 (to_rep1 (first temp___15161)) (to_rep1 (last temp___15161)) temp___1517 (to_rep1 (first2 temp___15171)) (to_rep1 (last2 temp___15171))) temp___1519)))
(assert (=> (not (= (length (mk___t temp___1516 temp___15161)) 0)) (= (mk (to_rep1 (first temp___15161)) o23) temp___15191)))
(assert (=> (= (length (mk___t temp___1519 temp___15191)) 0) (= (temp___String_Literal_1518 Tuple0) bio__makedescription__setresultstring__fullstring__assume)))
(assert (=> (= (length (mk___t temp___1519 temp___15191)) 0) (= (mk 1 2) bio__makedescription__setresultstring__fullstring__assume1)))
(assert (=> (not (= (length (mk___t temp___1519 temp___15191)) 0)) (=> (<= 1 2) (= o24 (+ (- 2 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1519 temp___15191)) 0)) (=> (not (<= 1 2)) (= o24 0))))
(assert (=> (not (= (length (mk___t temp___1519 temp___15191)) 0)) (=> (<= (to_rep1 (first temp___15191)) (to_rep1 (last temp___15191))) (= o25 (+ (- (to_rep1 (last temp___15191)) (to_rep1 (first temp___15191))) 1)))))
(assert (=> (not (= (length (mk___t temp___1519 temp___15191)) 0)) (=> (not (<= (to_rep1 (first temp___15191)) (to_rep1 (last temp___15191)))) (= o25 0))))
(assert (=> (not (= (length (mk___t temp___1519 temp___15191)) 0)) (= o26 (+ o25 o24))))
(assert (=> (not (= (length (mk___t temp___1519 temp___15191)) 0)) (= o27 (+ (to_rep1 (first temp___15191)) o26))))
(assert (=> (not (= (length (mk___t temp___1519 temp___15191)) 0)) (= o28 (- o27 1))))
(assert (=> (not (= (length (mk___t temp___1519 temp___15191)) 0)) (and (= o29 o28) (in_range2 o28))))
(assert (=> (not (= (length (mk___t temp___1519 temp___15191)) 0)) (= (concat1 temp___1519 (to_rep1 (first temp___15191)) (to_rep1 (last temp___15191)) (temp___String_Literal_1518 Tuple0) 1 2) bio__makedescription__setresultstring__fullstring__assume)))
(assert (=> (not (= (length (mk___t temp___1519 temp___15191)) 0)) (= (mk (to_rep1 (first temp___15191)) o29) bio__makedescription__setresultstring__fullstring__assume1)))
(assert (= result fullstring))
(assert (= fullstring1 bio__makedescription__setresultstring__fullstring__assume))
(assert (= (to_rep1 fullstring__first) (to_rep1 (first bio__makedescription__setresultstring__fullstring__assume1))))
(assert (= (to_rep1 fullstring__last) (to_rep1 (last bio__makedescription__setresultstring__fullstring__assume1))))
...
(assert (= (slide fullstring1 (to_rep1 fullstring__first) 1) temp___1525))
(assert (= (mk3 1 (to_rep1 fullstring__last)) temp___15251))
