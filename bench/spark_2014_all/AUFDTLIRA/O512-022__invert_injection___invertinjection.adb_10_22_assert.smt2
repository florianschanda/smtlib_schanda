...
(assert (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (to_rep (select a i7)) (to_rep (select a j))) (= i7 j)))))) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (not (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (not (= (to_rep (select a j)) i7)))))))))
...
(assert (<= 1 j))
(assert (<= j 100))
(assert (not (= (to_rep (select b6 (to_rep (select a j)))) j)))
(check-sat)
(exit)
