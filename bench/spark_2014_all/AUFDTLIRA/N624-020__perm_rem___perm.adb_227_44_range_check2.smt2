...
(assert (and (= o23 (- (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)) (in_range3 (- (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))
(assert (and (= o27 (remove b ib1)) (and (dynamic_invariant o27 true false true true) (and (= (invariant__ o27) true) (and (= (to_rep1 (last o22)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts b) k)) (to_rep (select o21 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o21 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o21 k))))))))))))
(assert (and (= o26 (remove o27 o23)) (and (dynamic_invariant o26 true false true true) (and (= (invariant__ o26) true) (and (= (to_rep1 (last o25)) (- (to_rep1 (last o22)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o23 1))) (= (to_rep (select o21 k)) (to_rep (select o24 k))))) (and (forall ((k Int)) (=> (and (<= (+ o23 1) k) (<= k (to_rep1 (last o22)))) (= (to_rep (select o21 k)) (to_rep (select o24 (- k 1)))))) (forall ((k Int)) (=> (and (<= o23 k) (<= k (- (to_rep1 (last o22)) 1))) (= (to_rep (select o21 (+ k 1))) (to_rep (select o24 k))))))))))))
(assert (and (= o28 (remove bb ib1)) (and (dynamic_invariant o28 true false true true) (and (= (invariant__ o28) true) (and (= (to_rep1 (last o20)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o19 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o19 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o19 k))))))))))))
(assert (and (= o18 (- (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1)) (in_range3 (- (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))))
