...
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= temp___1621 i5))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= temp___1619 newdomainname1))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= temp___1622 endidx8))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (and (and (<= 1 begidx11) (<= (+ (- endidx8 begidx11) 1) 128)) (= endidx8 temp___1622)))))
...
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (and (= temp___1618 o4) (in_range1 o4)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (and (<= 1 temp___1618) (<= temp___1618 128)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i5) (<= i5 r24b)) (= o6 temp___1618))))
...
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= temp___1627 i11))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (= temp___1625 (map__content newdomainname6)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (<= 1 endidx8))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i11) (<= i11 128)) (and (and (forall ((temp___1626 Int)) (=> (and (<= 1 temp___1626) (<= temp___1626 128)) (=> (or (< 128 temp___1626) (or (< temp___1626 r26b) (<= i12 temp___1626))) (= (select newdomainname8 temp___1626) (select temp___1625 temp___1626))))) (=> (<= r26b 128) (dynamic_property1 r26b 128 i12))) (and (<= r26b i12) (<= i12 128))))))
...
(assert (= i21 r28b))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= temp___1634 endidx9)))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= temp___1632 rrstring1)))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= temp___1631 i21)))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (and (and (<= 1 begidx13) (<= (+ (- endidx9 begidx13) 1) 128)) (= endidx9 temp___1634))))
...
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (and (= temp___1630 o13) (in_range1 o13))))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (and (<= 1 temp___1630) (<= temp___1630 256))))
(assert (=> (and (<= r28b i21) (<= i21 r29b)) (= o15 temp___1630)))
