...
(assert (= o39 temp___436))
(assert (= o40 (select data3 o39)))
(assert (and (= temp___435 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 temp___435)))
(assert (not (<= temp___435 3)))
(check-sat)
(exit)
