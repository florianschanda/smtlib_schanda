...
(assert (and (= o24 x) (in_range4 x)))
(assert (and (= o22 y) (in_range4 y)))
(assert (and (= o23 (remove (mk___t values2 (mk 1 100)) o22)) (and (dynamic_invariant3 o23 true false true true) (and (= (invariant__ o23) true) (and (= (to_rep1 (last (rt o23))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o22 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o23) k))))) (and (forall ((k Int)) (=> (and (<= (+ o22 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o23) (- k 1)))))) (forall ((k Int)) (=> (and (<= o22 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o23) k))))))))))))
(assert (and (= temp___251 (remove o23 o24)) (and (dynamic_invariant3 temp___251 true false true true) (and (= (invariant__ temp___251) true) (and (= (to_rep1 (last (rt temp___251))) (- (to_rep1 (last (rt o23))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o24 1))) (= (to_rep (select (elts o23) k)) (to_rep (select (elts temp___251) k))))) (and (forall ((k Int)) (=> (and (<= (+ o24 1) k) (<= k (to_rep1 (last (rt o23))))) (= (to_rep (select (elts o23) k)) (to_rep (select (elts temp___251) (- k 1)))))) (forall ((k Int)) (=> (and (<= o24 k) (<= k (- (to_rep1 (last (rt o23))) 1))) (= (to_rep (select (elts o23) (+ k 1))) (to_rep (select (elts temp___251) k))))))))))))
(assert (and (= o27 (- y 1)) (in_range4 (- y 1))))
(assert (and (= o25 x) (in_range4 x)))
(assert (and (= o26 (remove (mk___t interm1 (mk 1 100)) o25)) (and (dynamic_invariant3 o26 true false true true) (and (= (invariant__ o26) true) (and (= (to_rep1 (last (rt o26))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o25 1))) (= (to_rep (select interm1 k)) (to_rep (select (elts o26) k))))) (and (forall ((k Int)) (=> (and (<= (+ o25 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select (elts o26) (- k 1)))))) (forall ((k Int)) (=> (and (<= o25 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o26) k))))))))))))
(assert (not (<= (to_rep1 (first (rt o26))) o27)))
(check-sat)
(exit)
