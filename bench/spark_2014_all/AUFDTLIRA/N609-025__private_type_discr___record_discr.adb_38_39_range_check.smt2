...
(assert (= (ite (<= (to_rep1 (first4 temp___2971)) (to_rep1 (last4 temp___2971))) (+ (- (to_rep1 (last4 temp___2971)) (to_rep1 (first4 temp___2971))) 1) 0) (ite (<= 1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) (+ (- (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1) 1) 1) 0)))
(assert (= temp___297 o5))
(assert (= (mk1 (to_rep1 (first4 temp___2971)) (to_rep1 (last4 temp___2971))) o6))
(assert (= o7 o5))
(assert (= o8 o6))
(assert (not (in_range1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1))))
(check-sat)
(exit)
