...
(define-fun dynamic_invariant ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 0 255)) (in_range1 temp___expr_167)))
(assert (not (exists ((b Bool)) (and (and (<= 0 (ite b 1 0)) (<= (ite b 1 0) 1)) (< 0 (to_rep (select a (ite b 1 0))))))))
(check-sat)
(exit)
