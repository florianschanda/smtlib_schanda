...
(assert (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (exists ((g22 Int)) (and (and (<= 1 g22) (<= g22 64)) (= (to_rep (select g2_to_g1 g22)) g1))))))
(assert (= (mk_map__ref1 result) (mk_map__ref1 result__)))
(assert (= result__1 (stable_marriage__invert_map__result__aggregate_def 64)))
(assert (forall ((g211 Int)) (=> (and (<= 1 g211) (<= g211 64)) (forall ((g22 Int)) (=> (and (<= 1 g22) (<= g22 64)) (=> (not (= g211 g22)) (not (= (to_rep (select g2_to_g1 g211)) (to_rep (select g2_to_g1 g22))))))))))
...
(assert (<= 1 g1))
(assert (<= g1 64))
(assert (exists ((prev2 Int)) (and (and (<= 1 prev2) (<= prev2 (- g21 1))) (= (to_rep (select g2_to_g1 prev2)) g1))))
(assert (not (= (to_rep (select g2_to_g1 (to_rep1 (select result__1 g1)))) g1)))
(check-sat)
(exit)
