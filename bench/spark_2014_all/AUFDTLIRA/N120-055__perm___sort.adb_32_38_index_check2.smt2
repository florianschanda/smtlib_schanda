...
(assert (and (<= (to_rep1 (first (rt values))) min2) (<= min2 (to_rep1 (last (rt values))))))
(assert (and (and (=> (<= (to_rep1 (first (rt values))) (to_rep1 (last (rt values)))) (dynamic_property1 (to_rep1 (first (rt values))) (to_rep1 (last (rt values))) index3)) (=> (<= 1 2147483647) (in_range2 min2))) (and (<= (to_rep1 (first (rt values))) index3) (<= index3 (to_rep1 (last (rt values)))))))
