...
(assert (and (= o2 (remove_last r)) (and (dynamic_invariant1 o2 true false true true) (and (= (elts r) o) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1))))) o1)))))
(assert (not (= (bool_eq b1 (to_rep1 (first (mk (to_rep1 b__first) (to_rep1 b__last)))) (to_rep1 (last (mk (to_rep1 b__first) (to_rep1 b__last)))) o (to_rep1 (first o1)) (to_rep1 (last o1))) true)))
(check-sat)
(exit)
