...
(assert (forall ((i small_index_t)) (and (<= 1 (small_index_tqtint i)) (<= (small_index_tqtint i) 1000))))
...
(declare-fun temp_____aggregate_def_357 (Int) (Array Int unsigned_byte))
(define-fun dynamic_invariant1 ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 0 255)) (in_range temp___expr_167)))
(define-fun dynamic_invariant2 ((temp___expr_244 Int) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool) (temp___do_typ_inv_243 Bool)) Bool (=> (or (= temp___is_init_240 true) (<= 1 1000)) (in_range2 temp___expr_244)))
(declare-const rliteral unsigned_byte)
(assert (= (unsigned_byteqtint rliteral) 0))
(assert (forall ((temp___359 Int)) (=> (dynamic_invariant1 temp___359 true true true true) (forall ((temp___360 Int)) (= (select (temp_____aggregate_def_357 temp___359) temp___360) rliteral)))))
...
(assert (= result a))
(assert (= a1 (temp_____aggregate_def_357 0)))
