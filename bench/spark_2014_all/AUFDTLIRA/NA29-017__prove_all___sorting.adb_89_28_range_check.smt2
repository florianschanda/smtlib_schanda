...
(assert (and (= o9 (- length2 j2)) (in_range1 (- length2 j2))))
...
(assert (and (= o4 (to_rep b__first)) (in_range2 (to_rep b__first))))
(assert (= o11 (le_array (mk___t b (mk (to_rep b__first) (to_rep b__last))) (mk___t a (mk (to_rep a__first) (to_rep a__last))) o4 o7 o8 o10)))
(assert (and (= o2 (- length1 i2)) (in_range1 (- length1 i2))))
(assert (and (= o3 o2) (in_range2 o2)))
(assert (and (= o1 (+ i2 j2)) (in_range1 (+ i2 j2))))
(assert (and (= o (+ a_first i2)) (in_range1 (+ a_first i2))))
