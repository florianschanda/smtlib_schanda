...
(assert (forall ((i tTmy_s3SP1)) (and (<= 1 (tTmy_s3SP1qtint i)) (<= (tTmy_s3SP1qtint i) 4))))
...
(declare-datatypes () ((tTmy_s3SP1__ref (mk_tTmy_s3SP1__ref (tTmy_s3SP1__content tTmy_s3SP1)))))
(define-fun tTmy_s3SP1__ref___projection ((a tTmy_s3SP1__ref)) tTmy_s3SP1 (tTmy_s3SP1__content a))
(declare-sort t123b 0)
(declare-fun t123bqtint (t123b) Int)
(assert (forall ((i t123b)) (and (<= 2 (t123bqtint i)) (<= (t123bqtint i) 5))))
...
(assert (<= 2 5))
(assert (not (<= 2 (to_rep1 glob__last))))
(check-sat)
(exit)
