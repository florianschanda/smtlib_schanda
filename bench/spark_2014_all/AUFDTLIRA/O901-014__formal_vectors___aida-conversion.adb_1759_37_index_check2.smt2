...
(declare-const temp___2233 Int)
(declare-const temp___2234 Int)
(declare-const o Int)
...
(assert (and (= o4 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (= o7 (ite (<= o4 index) true false)))
(assert (= result (ite (= o7 true) o6 false)))
(assert (= (= o8 true) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) index1) (<= index1 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
(assert (and (= temp___2234 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2234) (<= temp___2234 (to_rep1 (last (rt source))))))
(assert (= o temp___2234))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 48) true false)))
(assert (and (= temp___2233 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (not (<= (to_rep1 (first (rt source))) temp___2233)))
(check-sat)
(exit)
