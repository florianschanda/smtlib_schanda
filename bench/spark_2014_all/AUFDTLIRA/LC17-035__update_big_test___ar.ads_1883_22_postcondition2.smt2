...
(declare-const temp___10071 (Array Int us_rep))
(declare-const temp___100711 (Array Int et1))
...
(assert (= temp___10071 o7))
(assert (= temp___100711 o8))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___10071 r__split_fields2))
(assert (= temp___100711 r__split_fields3))
...
(assert (<= m 16))
(assert (not (= m i)))
(assert (not (= (bool_eq1 (select r__split_fields4 m) (select r__split_fields m)) true)))
(check-sat)
(exit)
