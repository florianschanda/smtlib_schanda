...
(assert (=> (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c87b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) y1))))) n11) (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c88b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) y1)))) true)))
(assert (not (= n11 100)))
(assert (= result17 (mk_int__ref n11)))
(assert (= n12 (+ n11 1)))
(assert (= n13 (mk_int__ref n12)))
(assert (= n14 n12))
(assert (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c87b) c89b)))) (int__content n13)))
(assert (not (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c88b) c89b)))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c87b) y1)))))))
(check-sat)
(exit)
