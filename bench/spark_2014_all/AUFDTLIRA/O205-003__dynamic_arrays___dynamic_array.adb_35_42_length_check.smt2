...
(assert (= usq_2 o6))
(assert (= false o7))
(assert (= temp___2292 (temp_____aggregate_def_223 (mk___rep (mk___split_discrs o4) (mk___split_fields o5 o6) o7) 1 c)))
(assert (= (to_rep1 (first6 temp___2291)) 1))
(assert (= (to_rep1 (last7 temp___2291)) c))
(assert (= (mk___t3 temp___230 temp___2301) temp___2292))
(assert (not (= (ite (<= (to_rep1 (first6 temp___2301)) (to_rep1 (last7 temp___2301))) (+ (- (to_rep1 (last7 temp___2301)) (to_rep1 (first6 temp___2301))) 1) 0) (ite (<= 1 c) (+ (- c 1) 1) 0))))
(check-sat)
(exit)
