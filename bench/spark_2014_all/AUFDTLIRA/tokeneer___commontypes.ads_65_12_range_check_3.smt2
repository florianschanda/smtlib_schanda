...
(declare-const temp___3741 t)
(assert (dynamic_invariant i21s true false false true))
(assert (dynamic_property 1 2147483647 (to_rep1 (first4 (rt2 i21s))) (to_rep1 (last4 (rt2 i21s)))))
(assert (= (elts2 i21s) temp___374))
(assert (= (mk (to_rep1 (first4 (rt2 i21s))) (to_rep1 (last4 (rt2 i21s)))) temp___3741))
(assert (not (dynamic_property1 1 2147483647 (to_rep1 (first temp___3741)) (to_rep1 (last temp___3741)))))
(check-sat)
(exit)
