...
(assert (= o109 (ite (<= o108 (- (to_rep (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o103 i1))
...
(assert (= result22 (ite (= o110 true) o109 false)))
