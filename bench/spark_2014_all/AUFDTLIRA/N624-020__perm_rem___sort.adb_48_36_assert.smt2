...
(assert (= hr5 o32))
(assert (not (= (let ((temp___286 (remove (remove (mk___t values2 (mk 1 100)) x) y))) (let ((temp___285 (remove (remove (mk___t init (mk 1 100)) x) y))) (bool_eq (elts temp___285) (to_rep1 (first (rt temp___285))) (to_rep1 (last (rt temp___285))) (elts temp___286) (to_rep1 (first (rt temp___286))) (to_rep1 (last (rt temp___286)))))) true)))
(check-sat)
(exit)
