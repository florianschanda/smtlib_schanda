...
(assert (=> (not (= result3 true)) (=> (= result5 true) (= o9 a))))
(assert (=> (not (= result3 true)) (=> (not (= result5 true)) (and (and (= (= (select o9 i2) true) (= (select a j2) true)) (= (= (select o9 j2) true) (= (select a i2) true))) (forall ((k Int)) (=> (and (<= (to_rep a__first) k) (<= k (to_rep a__last))) (=> (and (not (= k i2)) (not (= k j2))) (= (= (select o9 k) true) (= (select a k) true)))))))))
