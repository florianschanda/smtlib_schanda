...
(assert (not (= (ite (<= (to_rep2 (first8 temp___12491)) (to_rep2 (last9 temp___12491))) (+ (- (to_rep2 (last9 temp___12491)) (to_rep2 (first8 temp___12491))) 1) 0) (ite (<= (to_rep2 (first8 temp___12511)) (to_rep2 (last9 temp___12511))) (+ (- (to_rep2 (last9 temp___12511)) (to_rep2 (first8 temp___12511))) 1) 0))))
(check-sat)
(exit)
