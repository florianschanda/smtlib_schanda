...
(assert (=> (= result11 true) (and (= o59 (length (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields5)))) (in_range3 o59))))
(assert (=> (= result11 true) (= result10 (ite (= o59 (- (length model____split_fields1) 1)) true false))))
(assert (=> (not (= result11 true)) (= result10 false)))
(assert (= result10 true))
(assert (<= 1 j))
(assert (<= j (length model____split_fields1)))
(assert (and (= o57 (get model____split_fields1 j)) (in_range4 o57)))
(assert (= o58 (ite (= o57 res) true false)))
(assert (= result12 (ite (not (= o58 true)) true false)))
