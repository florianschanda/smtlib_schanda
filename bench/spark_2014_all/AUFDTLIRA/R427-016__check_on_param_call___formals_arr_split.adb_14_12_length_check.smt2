...
(declare-const temp___2781 t1)
(assert (in_range2 x))
(assert (and (dynamic_property1 0 x (to_rep a__first) (to_rep a__last)) (and (= (to_rep a__first) 0) (= (to_rep a__last) x))))
(assert (= (to_rep (first2 (rt1 (temp_____aggregate_def_271 1 0 x)))) 0))
(assert (= (to_rep (last2 (rt1 (temp_____aggregate_def_271 1 0 x)))) x))
(assert (= (mk___t1 temp___278 temp___2781) (temp_____aggregate_def_271 1 0 x)))
(assert (not (= (ite (<= (to_rep (first2 temp___2781)) (to_rep (last2 temp___2781))) (+ (- (to_rep (last2 temp___2781)) (to_rep (first2 temp___2781))) 1) 0) (ite (<= 0 x) (+ (- x 0) 1) 0))))
(check-sat)
(exit)
