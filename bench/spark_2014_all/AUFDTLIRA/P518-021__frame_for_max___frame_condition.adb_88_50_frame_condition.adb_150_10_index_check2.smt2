...
(assert (and (forall ((i1 Int)) (=> (and (<= first3 i1) (<= i1 k2)) (forall ((j Int)) (=> (and (<= i1 j) (<= j k2)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i1)))) (get_max_right j a2)))))) (forall ((i1 Int)) (=> (and (<= k2 i1) (<= i1 first3)) (forall ((j Int)) (=> (and (<= i1 j) (<= j first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 j)))) (get_max_right i1 a2))))))))
...
(assert (= (= o27 true) (forall ((i1 Int)) (=> (and (<= k2 i1) (<= i1 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i1)))) max3)))))
(assert (<= first3 i))
(assert (<= i k2))
