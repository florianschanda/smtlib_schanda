...
(assert (<= t 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o18 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t)) (and (= (= o18 true) (and (<= t (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 t)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) t) (not (= o18 true))))))
(assert (= o19 (ite (and (= o18 true) (not (= root t))) true false)))
(assert (= result13 (ite (and (= o19 true) (not (= (int__content v2) t))) true false)))
(assert (= result13 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o20 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t)) (and (dynamic_invariant o20 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o20 t))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o20 t)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 t)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o20 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o20 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o20 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o20 i1))) true) (not (= i1 t))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o20 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select o20 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o20 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o20 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o20 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o20 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select o20 j)))) true)) (= j i1))))))))))))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
