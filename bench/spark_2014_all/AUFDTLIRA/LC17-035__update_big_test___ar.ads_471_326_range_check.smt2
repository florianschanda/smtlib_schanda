...
(assert (=> (< 0 e) (= o20 (temp_____aggregate_def_1564 o19 i o18))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o16 (+ k 1))))
(assert (=> (< 0 e) (= o21 (select a o16))))
(assert (=> (< 0 e) (= o22 (temp_____aggregate_def_1557 o21 j o20))))
(assert (=> (< 0 e) (and (= o23 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5271 (temp_____aggregate_def_1534 a k (temp_____aggregate_def_1542 (select a k) j (temp_____aggregate_def_1549 (select (select a k) j) i e)) o23 o22))))
...
(assert (= o13 (temp_____aggregate_def_1603 o12 i 99)))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o10 (+ k 1)))
(assert (= o14 (select a o10)))
(assert (= o15 (temp_____aggregate_def_1596 o14 j o13)))
