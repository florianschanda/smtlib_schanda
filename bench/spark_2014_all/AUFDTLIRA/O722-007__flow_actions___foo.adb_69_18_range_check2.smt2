...
(assert (=> (<= r48b 5) (and (and (<= 1 r48b) (<= r48b 5)) (and (<= 1 5) (<= 5 5)))))
(assert (= o new_str))
(assert (= o temp___204))
(assert (= (mk r48b 5) temp___2041))
(assert (= o1 (bool_eq temp___204 (to_rep1 (first temp___2041)) (to_rep1 (last temp___2041)) new_sub 1 5)))
