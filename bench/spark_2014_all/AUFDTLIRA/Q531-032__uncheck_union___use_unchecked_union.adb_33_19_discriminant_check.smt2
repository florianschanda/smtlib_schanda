...
(declare-const output__split_fields4 integer)
(declare-const output__split_fields5 (Array Int integer))
(declare-const output__split_fields6 integer)
(declare-const output__split_fields7 (Array Int integer))
(declare-const result4 integer)
(declare-const output__split_discrs1 us_split_discrs)
(assert (in_range num))
(assert (= num 0))
(assert (= result output__split_fields))
(assert (= result1 output__split_fields1))
(assert (= result2 output__split_fields2))
(assert (= result3 output__split_fields3))
(assert (= rliteral output__split_fields4))
(assert (= output__split_fields1 output__split_fields5))
(assert (= output__split_fields2 output__split_fields6))
(assert (= output__split_fields3 output__split_fields7))
(assert (= result4 output__split_discrs))
