...
(assert (and (= o3 (index_of_minimum (mk___t o1 o2))) (and (in_range2 o3) (and (and (<= (to_rep (first o2)) o3) (<= o3 (to_rep (last o2)))) (forall ((j1 Int)) (=> (and (<= (to_rep (first o2)) j1) (<= j1 (to_rep (last o2)))) (<= (to_rep (select o1 o3)) (to_rep (select o1 j1)))))))))
(assert (= (mk_int__ref result1) (mk_int__ref smallest)))
(assert (= smallest1 o3))
(assert (=> (not (= smallest1 current1)) (and (= o4 current1) (in_range2 current1))))
(assert (=> (not (= smallest1 current1)) (and (= (to_rep (select o7 o4)) (to_rep (select values smallest1))) (and (= (to_rep (select o7 smallest1)) (to_rep (select values o4))) (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 (to_rep values__last))) (=> (and (not (= j1 o4)) (not (= j1 smallest1))) (= (to_rep (select o7 j1)) (to_rep (select values j1))))))))))
(assert (=> (not (not (= smallest1 current1))) (= o7 values)))
(assert (=> (not (not (= smallest1 current1))) (= o7 values1)))
(assert (and (and (and (<= (to_rep values__first) current2) (< current2 (to_rep values__last))) (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 (- current2 1))) (<= (to_rep (select values2 j1)) (to_rep (select values2 (+ j1 1))))))) (forall ((j1 Int)) (=> (and (<= current2 j1) (<= j1 (to_rep values__last))) (<= (to_rep (select values2 current2)) (to_rep (select values2 j1)))))))
...
(assert (=> (<= (to_rep values__first) current2) (= result3 (ite (< current2 (to_rep values__last)) true false))))
(assert (=> (not (<= (to_rep values__first) current2)) (= result3 false)))
(assert (=> (= result3 true) (and (= o5 (- current2 1)) (in_range1 (- current2 1)))))
(assert (=> (= result3 true) (= o6 (ite (<= j o5) true false))))
(assert (=> (= result3 true) (= result4 (ite (<= (to_rep values__first) j) o6 false))))
(assert (=> (= result3 true) (= (= result2 true) (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 (- current2 1))) (<= (to_rep (select values2 j1)) (to_rep (select values2 (+ j1 1)))))))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (= result2 true))
(assert (<= current2 (to_rep values__last)))
(assert (not (<= (to_rep values__last) 2147483647)))
(check-sat)
(exit)
