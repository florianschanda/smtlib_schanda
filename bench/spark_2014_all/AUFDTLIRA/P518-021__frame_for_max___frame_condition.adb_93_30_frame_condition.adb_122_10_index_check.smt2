...
(assert (= (= o29 true) (forall ((i1 Int)) (=> (and (<= k2 i1) (<= i1 first3)) (forall ((j1 Int)) (=> (and (<= i1 j1) (<= j1 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 j1)))) (get_max_left i1 a2))))))))
(assert (<= first3 i))
(assert (<= i k2))
(assert (<= i j))
(assert (<= j k2))
(assert (and (= o27 j) (in_range3 j)))
(assert (and (= o28 (get_max_left o27 a2)) (and (in_range2 o28) (= o28 (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a2 o27))))))))
