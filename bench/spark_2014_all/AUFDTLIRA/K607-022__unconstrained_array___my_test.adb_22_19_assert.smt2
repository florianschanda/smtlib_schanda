...
(declare-const temp___362 us_rep3)
...
(define-fun o15 () us_rep (mk___rep (mk___split_discrs o11) (mk___split_fields (mk___t1 o12 o13))))
(define-fun o16 () us_rep (mk___rep (mk___split_discrs o5) (mk___split_fields (mk___t1 o6 o7))))
...
(assert (and (= o16 (add (mk___rep t1__split_discrs t1__split_fields2) (mk___rep t2__split_discrs t2__split_fields2))) (and (dynamic_invariant o16 true false true true) (and (= (same_range o16 (mk___rep t1__split_discrs t1__split_fields2)) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (= (to_rep3 (select o6 j)) (+ (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)) (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t2__split_fields2)) j))))))))))
(assert (= (mk___rep (mk___split_discrs o8) (mk___split_fields (mk___t1 o9 o10))) o16))
...
(assert (and (= o15 (bubble_sort (mk___rep t1__split_discrs t1__split_fields2))) (and (dynamic_invariant o15 true false true true) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (- (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)) 1))) (<= (to_rep3 (select o12 j)) (to_rep3 (select o12 (+ j 1)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (exists ((k Int)) (and (and (<= 1 k) (<= k (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (= (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)) (to_rep3 (select o12 k)))))))))))
(assert (= o14 o15))
(assert (= temp___362 (mk___rep3 (us_split_discrs1 o14) (mk___split_fields3 (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 o14)))))))
(assert (= result3 (mk___split_fields__ref3 t3__split_fields1)))
(assert (= t3__split_fields2 (us_split_fields7 temp___362)))
(assert (= t3__split_discrs (us_split_discrs4 temp___362)))
(assert (and (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (- (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)) 1))) (<= (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields3)) j)) (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields3)) (+ j 1)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (exists ((k Int)) (and (and (<= 1 k) (<= k (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (= (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)) (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields3)) k)))))))) (dynamic_invariant (mk___rep t1__split_discrs t1__split_fields3) true true true true)))
(assert (not (= (bool_eq4 (mk___rep t1__split_discrs t1__split_fields3) (mk___rep t3__split_discrs (mk___split_fields (mk___t1 (rec__simple_unc_arrays__table__v3 t3__split_fields2) (mk1 1 10))))) true)))
(check-sat)
(exit)
