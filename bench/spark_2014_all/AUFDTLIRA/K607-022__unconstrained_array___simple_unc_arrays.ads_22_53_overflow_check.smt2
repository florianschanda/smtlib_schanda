...
(assert (= o17 j))
(assert (= o18 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 b))) o17)))
...
(assert (= o15 j))
(assert (= o16 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o15)))
(assert (= o20 (to_rep2 o16)))
(assert (= o21 (+ o20 o19)))
