...
(assert (not (<= (to_rep1 (first1 (rt a))) (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 (result_type__content dynamic_types__search__search_range__result11)))))))
(check-sat)
(exit)
