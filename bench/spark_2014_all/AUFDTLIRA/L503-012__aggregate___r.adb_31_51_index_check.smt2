...
(declare-fun temp_____aggregate_def_311 (us_rep) (Array Int us_rep))
(declare-fun temp_____aggregate_def_315 (Int Int) (Array Int int5))
...
(assert (forall ((temp___313 us_rep)) (forall ((temp___314 Int)) (= (select (temp_____aggregate_def_311 temp___313) temp___314) temp___313))))
(declare-const rliteral int5)
(assert (= (int5qtint rliteral) 1))
(assert (forall ((temp___317 Int) (temp___318 Int)) (let ((temp___316 (temp_____aggregate_def_315 temp___317 temp___318))) (=> (and (dynamic_invariant1 temp___317 true true true true) (dynamic_invariant1 temp___318 true true true true)) (forall ((temp___319 Int)) (ite (= temp___319 2) (= (select temp___316 temp___319) rliteral) (= (to_rep (select temp___316 temp___319)) temp___318)))))))
(assert (in_range1 n))
(assert (and (<= 2 n) (<= n 6)))
(assert (not (<= n 5)))
(check-sat)
