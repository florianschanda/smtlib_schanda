...
(assert (=> (= (to_rep (select buffer1 index2)) ch) (and (= o (+ count2 1)) (in_range2 (+ count2 1)))))
...
(assert (=> (= (to_rep (select buffer1 index2)) ch) (= o2 (store buffer1 index2 o1))))
(assert (=> (= (to_rep (select buffer1 index2)) ch) (= result3 buffer1)))
(assert (=> (= (to_rep (select buffer1 index2)) ch) (= buffer2 o2)))
(assert (=> (not (= (to_rep (select buffer1 index2)) ch)) (= count3 count2)))
(assert (=> (not (= (to_rep (select buffer1 index2)) ch)) (= buffer2 buffer1)))
(assert (not (= index2 1024)))
(assert (= result4 index2))
(assert (= index3 (+ index2 1)))
(assert (not (< count3 index3)))
(check-sat)
(exit)
