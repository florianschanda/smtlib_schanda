...
(assert (not (= (let ((temp___268 (to__ (mk___rep (mk___split_fields s__split_fields4 s__split_fields5))))) (let ((temp___267 (to_but_top (mk___rep (mk___split_fields s__split_fields s__split_fields1))))) (bool_eq (elts temp___267) (to_rep (first (rt temp___267))) (to_rep (last (rt temp___267))) (elts temp___268) (to_rep (first (rt temp___268))) (to_rep (last (rt temp___268)))))) true)))
(check-sat)
(exit)
