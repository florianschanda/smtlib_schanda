...
(assert (and (<= 1 previous3) (<= previous3 100)))
(assert (= o3 previous3))
(assert (= o4 (select (rec__search_trees__search_tree__values t__split_fields5) o3)))
(assert (= o5 (to_rep o4)))
