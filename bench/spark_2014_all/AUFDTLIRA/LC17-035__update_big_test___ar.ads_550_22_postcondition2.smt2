...
(declare-fun temp_____aggregate_def_2189 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp_____aggregate_def_2195 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_2205 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1)) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp_____aggregate_def_2213 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_2220 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
...
(assert (forall ((temp___2207 (Array Int (Array Int (Array Int et1))))) (forall ((temp___2208 Int) (temp___2210 Int)) (forall ((temp___2209 (Array Int (Array Int et1))) (temp___2211 (Array Int (Array Int et1)))) (let ((temp___2206 (temp_____aggregate_def_2205 temp___2207 temp___2208 temp___2209 temp___2210 temp___2211))) (=> (and (dynamic_invariant1 temp___2208 true true true true) (dynamic_invariant1 temp___2210 true true true true)) (forall ((temp___2212 Int)) (ite (= temp___2212 temp___2210) (= (select temp___2206 temp___2212) temp___2211) (ite (= temp___2212 temp___2208) (= (select temp___2206 temp___2212) temp___2209) (= (select temp___2206 temp___2212) (select temp___2207 temp___2212)))))))))))
(assert (forall ((temp___2215 (Array Int (Array Int et1)))) (forall ((temp___2216 Int)) (forall ((temp___2217 (Array Int et1))) (let ((temp___2214 (temp_____aggregate_def_2213 temp___2215 temp___2216 temp___2217))) (=> (dynamic_invariant temp___2216 true true true true) (forall ((temp___2218 Int)) (ite (= temp___2218 temp___2216) (= (select temp___2214 temp___2218) temp___2217) (= (select temp___2214 temp___2218) (select temp___2215 temp___2218))))))))))
(assert (forall ((temp___2222 (Array Int (Array Int et1)))) (forall ((temp___2223 Int)) (forall ((temp___2224 (Array Int et1))) (let ((temp___2221 (temp_____aggregate_def_2220 temp___2222 temp___2223 temp___2224))) (=> (dynamic_invariant temp___2223 true true true true) (forall ((temp___2225 Int)) (ite (= temp___2225 temp___2223) (= (select temp___2221 temp___2225) temp___2224) (= (select temp___2221 temp___2225) (select temp___2222 temp___2225))))))))))
(assert (forall ((temp___2191 (Array Int (Array Int (Array Int et1))))) (forall ((temp___2192 Int)) (forall ((temp___2193 (Array Int (Array Int et1)))) (let ((temp___2190 (temp_____aggregate_def_2189 temp___2191 temp___2192 temp___2193))) (=> (dynamic_invariant1 temp___2192 true true true true) (forall ((temp___2194 Int)) (ite (= temp___2194 temp___2192) (= (select temp___2190 temp___2194) temp___2193) (= (select temp___2190 temp___2194) (select temp___2191 temp___2194))))))))))
(assert (forall ((temp___2197 (Array Int (Array Int et1)))) (forall ((temp___2198 Int) (temp___2200 Int)) (forall ((temp___2199 (Array Int et1)) (temp___2201 (Array Int et1))) (let ((temp___2196 (temp_____aggregate_def_2195 temp___2197 temp___2198 temp___2199 temp___2200 temp___2201))) (=> (and (dynamic_invariant temp___2198 true true true true) (dynamic_invariant temp___2200 true true true true)) (forall ((temp___2202 Int)) (ite (= temp___2202 temp___2200) (= (select temp___2196 temp___2202) temp___2201) (ite (= temp___2202 temp___2198) (= (select temp___2196 temp___2202) temp___2199) (= (select temp___2196 temp___2202) (select temp___2197 temp___2202)))))))))))
...
(assert (= a4 a2))
(assert (not (= i1 i2)))
(assert (not (= (bool_eq2 a3 1 16 (temp_____aggregate_def_2205 a i1 (temp_____aggregate_def_2213 (select a i1) j1 b) i2 (temp_____aggregate_def_2220 (select a i2) j2 c)) 1 16) true)))
(check-sat)
(exit)
