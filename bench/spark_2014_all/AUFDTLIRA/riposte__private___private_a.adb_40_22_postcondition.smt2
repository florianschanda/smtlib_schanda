...
(define-fun s__split_fields10 () us_split_fields (mk___split_fields s__split_fields4 s__split_fields5))
...
(assert (and (= (get_length (mk___rep s__split_fields10)) (+ (get_length (mk___rep (mk___split_fields s__split_fields2 s__split_fields3))) 1)) (= (top (mk___rep s__split_fields10)) n)))
(assert (and (= o (top (mk___rep s__split_fields10))) (in_range o)))
(assert (= result2 n))
(assert (= n1 o))
(assert (= s__split_fields6 s__split_fields4))
(assert (= s__split_fields7 s__split_fields5))
(assert (= n1 n2))
(assert (= (mk___split_fields s__split_fields8 s__split_fields9) s__split_fields10))
(assert (= n3 n1))
(assert (not (= n2 n)))
(check-sat)
(exit)
