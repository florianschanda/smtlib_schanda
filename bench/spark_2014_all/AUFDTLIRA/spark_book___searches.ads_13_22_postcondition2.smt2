...
(assert (= position1 o))
(assert (= temp___183 position1))
(assert (or (and (and (= position1 position4) (= position5 position1)) (and (and (and (and (and (and (<= (to_rep (first (rt list))) position1) (<= position1 (to_rep (last (rt list))))) (= o1 position1)) (= o2 (select (elts list) o1))) (= o3 (to_rep o2))) (= result1 (ite (= o3 value) true false))) (= result1 true))) (and (and (and (and (and (and (and (<= (to_rep (first (rt list))) position1) (<= position1 (to_rep (last (rt list))))) (= o1 position1)) (= o2 (select (elts list) o1))) (= o3 (to_rep o2))) (= result1 (ite (= o3 value) true false))) (not (= result1 true))) (and (and (= position3 position4) (= position5 position3)) (and (and (and (= o4 (+ position1 1)) (in_range1 (+ position1 1))) (and (= position1 result2) (= position2 o4))) (and (and (and (<= (to_rep (first (rt list))) position3) (<= position3 (to_rep (last (rt list))))) (forall ((j Int)) (=> (and (<= (to_rep (first (rt list))) j) (<= j (- position3 1))) (not (= (to_rep (select (elts list) j)) value))))) (and (=> (<= 1 2147483647) (in_range2 position3)) (and (and (and (and (and (and (<= (to_rep (first (rt list))) position3) (<= position3 (to_rep (last (rt list))))) (= o5 position3)) (= o6 (select (elts list) o5))) (= o7 (to_rep o6))) (= result3 (ite (= o7 value) true false))) (= result3 true)))))))))
...
(assert (not (<= (to_rep (first (rt list))) position10)))
(check-sat)
(exit)
