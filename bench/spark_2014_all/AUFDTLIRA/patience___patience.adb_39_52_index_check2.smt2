...
(assert (and (<= 0 topstacki2) (<= topstacki2 99)))
(assert (= o29 topstacki2))
(assert (= o30 (select s__split_fields5 o29)))
(assert (= o31 (to_rep o30)))
(assert (= result8 (ite (<= 0 o31) true false)))
(assert (=> (= result8 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result8 true) (= o26 topstacki2)))
(assert (=> (= result8 true) (= o27 (select s__split_fields5 o26))))
(assert (=> (= result8 true) (= o28 (to_rep o27))))
(assert (=> (= result8 true) (= result7 (ite (< o28 (to_rep s__split_fields2)) true false))))
(assert (=> (not (= result8 true)) (= result7 false)))
(assert (=> (= result7 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result7 true) (= o23 topstacki2)))
(assert (=> (= result7 true) (= o24 (select s__split_fields6 o23))))
(assert (=> (= result7 true) (= o25 (to_rep o24))))
(assert (=> (= result7 true) (= result6 (ite (<= 0 o25) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (=> (= result6 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result6 true) (= o17 topstacki2)))
(assert (=> (= result6 true) (= o18 (select s__split_fields5 o17))))
(assert (=> (= result6 true) (= temp___574 (to_rep o18))))
(assert (=> (= result6 true) (and (<= 0 temp___574) (<= temp___574 99))))
(assert (=> (= result6 true) (= o19 temp___574)))
(assert (=> (= result6 true) (= o20 (select s__split_fields3 o19))))
(assert (=> (= result6 true) (= o21 (to_rep o20))))
(assert (=> (= result6 true) (and (<= 0 topstacki2) (<= topstacki2 99))))
(assert (=> (= result6 true) (= o15 topstacki2)))
(assert (=> (= result6 true) (= o16 (select s__split_fields6 o15))))
(assert (=> (= result6 true) (= o22 (to_rep o16))))
(assert (=> (= result6 true) (= result5 (ite (< o22 o21) true false))))
...
(assert (= o14 (select s__split_fields6 o13)))
(assert (= temp___580 (to_rep o14)))
(assert (not (<= 0 temp___580)))
(check-sat)
(exit)
