...
(assert (forall ((i Int)) (=> (and (<= (- 2147483648) i) (<= i 2147483647)) (= (to_rep (select a i)) (to_rep (select b i))))))
(assert (not (= (bool_eq a (- 2147483648) 2147483647 b (- 2147483648) 2147483647) true)))
(check-sat)
(exit)
