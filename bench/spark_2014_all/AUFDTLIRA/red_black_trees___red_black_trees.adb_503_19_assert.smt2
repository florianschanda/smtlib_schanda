...
(assert (<= 1 i))
(assert (<= i 100))
(assert (or (= (parent (rec__red_black_trees__rbt__struct t__split_fields13) i) 0) (= (to_rep3 (select (rec__red_black_trees__rbt__color t__split_fields13) (parent (rec__red_black_trees__rbt__struct t__split_fields13) i))) 1)))
(assert (not (= (to_rep3 (select (rec__red_black_trees__rbt__color t__split_fields13) i)) 0)))
(check-sat)
(exit)
