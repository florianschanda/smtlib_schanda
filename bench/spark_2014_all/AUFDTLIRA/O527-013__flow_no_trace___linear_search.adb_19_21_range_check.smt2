...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (rec__linear_search__search_result__found (us_split_fields1 a)) (rec__linear_search__search_result__found (us_split_fields1 b))) (= (to_rep (rec__linear_search__search_result__at_index (us_split_fields1 a))) (to_rep (rec__linear_search__search_result__at_index (us_split_fields1 b))))) true false))
