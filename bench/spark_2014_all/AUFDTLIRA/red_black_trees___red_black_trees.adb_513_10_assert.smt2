...
(assert (<= 1 i))
(assert (<= i 100))
(assert (not (= i (root (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields34))))))
(assert (or (= (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields34)) i) 0) (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields__content4 t__split_fields34)) (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields34)) i))) 1)))
(assert (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields__content4 t__split_fields34)) i)) 0)))
(check-sat)
(exit)
