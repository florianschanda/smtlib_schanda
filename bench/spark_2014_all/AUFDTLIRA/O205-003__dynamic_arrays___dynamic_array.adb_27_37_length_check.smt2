...
(assert (= o1 o2))
(assert (= dummy3 o3))
(assert (= usq_ (mk___rep (mk___split_discrs (distinct 1 0)) (mk___split_fields o2 o3) true)))
(assert (= o4 (mk___rep (us_split_discrs1 usq_) (us_split_fields1 usq_) false)))
(assert (= temp___263 (temp_____aggregate_def_257 o4 1 d)))
