...
(assert (and (= o20 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= o23 (ite (<= o20 index) true false)))
(assert (= result (ite (= o23 true) o22 false)))
(assert (= (= o24 true) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 9) index1) (<= index1 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
(assert (and (= temp___1962 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1962) (<= temp___1962 (to_rep1 (last (rt source))))))
(assert (= o16 temp___1962))
(assert (= o17 (select (elts source) o16)))
(assert (= o18 (to_rep o17)))
(assert (= o19 (ite (< o18 52) true false)))
(assert (and (= temp___1961 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1961) (<= temp___1961 (to_rep1 (last (rt source))))))
(assert (= o12 temp___1961))
(assert (= o13 (select (elts source) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (= o14 54) true false)))
(assert (and (= temp___1960 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1960) (<= temp___1960 (to_rep1 (last (rt source))))))
(assert (= o8 temp___1960))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (= o10 51) true false)))
(assert (and (= temp___1959 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1959) (<= temp___1959 (to_rep1 (last (rt source))))))
(assert (= o4 temp___1959))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 56) true false)))
(assert (and (= temp___1958 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1958) (<= temp___1958 (to_rep1 (last (rt source))))))
(assert (= o temp___1958))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 52) true false)))
(assert (and (= temp___1957 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (not (<= temp___1957 (to_rep1 (last (rt source))))))
(check-sat)
(exit)
