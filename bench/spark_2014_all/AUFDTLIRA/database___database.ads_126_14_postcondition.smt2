...
(assert (or (and (and (= accounts_balance3 accounts_balance7) (= accounts_balance4 accounts_balance1)) (and (and (and (and (and (= o6 (currency account accounts_balance)) (and (in_range o6) (= o6 (to_rep (rec__money__amount__currency (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))))))) (= o7 (ite (= o6 (to_rep (rec__money__amount__currency (us_split_fields1 sum)))) true false))) (= result1 (ite (not (= o7 true)) true false))) (ite (= result1 true) (= result true) (and (and (and (and (and (= o18 (balance account links accounts_balance)) (= o18 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))) (and (= o o2) (= o1 o3))) (= o4 o3)) (= o5 (to_rep1 o4))) (= result (ite (< o5 (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))) true false))))) (= result true))) (and (and (and (and (and (and (= o6 (currency account accounts_balance)) (and (in_range o6) (= o6 (to_rep (rec__money__amount__currency (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))))))) (= o7 (ite (= o6 (to_rep (rec__money__amount__currency (us_split_fields1 sum)))) true false))) (= result1 (ite (not (= o7 true)) true false))) (ite (= result1 true) (= result true) (and (and (and (and (and (= o18 (balance account links accounts_balance)) (= o18 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))) (and (= o o2) (= o1 o3))) (= o4 o3)) (= o5 (to_rep1 o4))) (= result (ite (< o5 (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))) true false))))) (not (= result true))) (and (and (= accounts_balance3 (mk_map__ref1 accounts_balance2)) (= accounts_balance4 accounts_balance2)) (and (and (and (and (and (= o17 (osubtract (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))) sum)) (= (bool_eq o17 (mk___rep (mk___split_fields (rec__money__amount__currency (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))) (of_rep1 (- (to_rep1 (rec__money__amount__raw (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account)))))) (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))))))) true)) (and (and (= o10 o8) (= o11 o9)) (= (rec__database__account_balance__account (us_split_fields5 (select accounts_balance account))) o12))) (and (and (= o13 o10) (= o14 o11)) (= o15 o12))) (= o16 (store accounts_balance account (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o13 o14)) o15))))) (and (= result2 accounts_balance7) (= accounts_balance2 o16)))))))
(assert (= accounts_balance5 accounts_balance3))
(assert (= accounts_balance6 accounts_balance4))
(assert (not (= (bool_eq (balance account links (map__content1 accounts_balance5)) (osubtract (balance account links accounts_balance) sum)) true)))
(check-sat)
(exit)
