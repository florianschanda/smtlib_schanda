...
(assert (<= 1 j1))
(assert (<= j1 i))
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k (- j2 1))) (= (to_rep (select r2 k)) (to_rep (select b k))))))
(assert (and (and (forall ((temp___203 Int)) (=> (and (<= 1 temp___203) (<= temp___203 8)) (=> (or (< i temp___203) (or (< temp___203 1) (<= j2 temp___203))) (= (select r2 temp___203) (select r1 temp___203))))) (=> (<= 1 i) (dynamic_property 1 i j2))) (and (<= 1 j2) (<= j2 i))))
...
(assert (<= 1 k))
(assert (<= k (- j3 1)))
(assert (not (= (to_rep (select r3 k)) (to_rep (select b k)))))
(check-sat)
(exit)
