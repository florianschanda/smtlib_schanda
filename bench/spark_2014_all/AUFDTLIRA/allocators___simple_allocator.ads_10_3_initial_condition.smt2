...
(assert true)
(assert (forall ((simple_allocator__data (Array Int status))) (! (= (= (all_available simple_allocator__data) true) (forall ((r Int)) (=> (and (<= 1 r) (<= r 10000)) (= (to_rep (select simple_allocator__data r)) 0)))) :pattern ((all_available simple_allocator__data)))))
...
(define-fun dynamic_invariant1 ((temp___expr_238 Int) (temp___is_init_234 Bool) (temp___skip_constant_235 Bool) (temp___do_toplevel_236 Bool) (temp___do_typ_inv_237 Bool)) Bool (=> (or (= temp___is_init_234 true) (<= 0 1)) (in_range temp___expr_238)))
(assert (forall ((temp___252 Int)) (=> (dynamic_invariant1 temp___252 true true true true) (forall ((temp___253 Int)) (= (to_rep (select (simple_allocator__data__aggregate_def temp___252) temp___253)) temp___252)))))
...
(assert (and (= result1 (all_available data1)) (= (= result1 true) (forall ((r Int)) (=> (and (<= 1 r) (<= r 10000)) (= (to_rep (select data1 r)) 0))))))
