...
(assert (=> (= result8 true) (and (and (= (is_perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t o25 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select o25 o14)) (to_rep (select a o15))) (and (= (to_rep (select o25 o15)) (to_rep (select a o14))) (forall ((z3 Int)) (=> (and (<= (to_rep a__first) z3) (<= z3 (to_rep a__last))) (=> (and (not (= z3 o14)) (not (= z3 o15))) (= (to_rep (select o25 z3)) (to_rep (select a z3))))))))) (= (to_rep a__first) 0))))
...
(assert (=> (= result8 true) (= (sorted (mk___t o26 (mk (to_rep a__first) (to_rep a__last))) 0 (- j2 1)) true)))
(assert (=> (= result8 true) (= (sorted (mk___t o26 (mk (to_rep a__first) (to_rep a__last))) (+ j2 2) (+ i1 1)) true)))
(assert (=> (= result8 true) (=> (< 0 j2) (<= (to_rep (select o26 (- j2 1))) (to_rep (select o26 (+ j2 2)))))))
(assert (=> (= result8 true) (< x2 (to_rep (select o26 (+ j2 2))))))
(assert (=> (= result8 true) (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t o26 (mk (to_rep a__first) (to_rep a__last)))) true)))
(assert (=> (= result8 true) (or (and (= (to_rep (select o26 j2)) x2) (= (to_rep (select o26 (+ j2 1))) y2)) (and (= (to_rep (select o26 j2)) y2) (= (to_rep (select o26 (+ j2 1))) x2)))))
...
(assert (=> (= result8 true) (=> (<= 0 j3) (= o18 (select o26 o17)))))
...
(assert (=> (= result8 true) (= a2 (mk_map__ref o26))))
(assert (=> (= result8 true) (= j5 j3)))
(assert (=> (= result8 true) (= a3 o26)))
...
(assert (not (in_range1 (+ (int__content j6) 1))))
(check-sat)
(exit)
