...
(assert (= (ite (<= (to_rep1 (first (rt source))) (to_rep1 (last (rt source)))) (+ (- (to_rep1 (last (rt source))) (to_rep1 (first (rt source)))) 1) 0) (ite (<= 1 r2b) (+ (- r2b 1) 1) 0)))
(assert (= (slide (elts source) (to_rep1 (first (rt source))) 1) temp___206))
(assert (= (mk1 1 r2b) temp___2061))
(assert (<= 1 r2b))
(assert (not (<= 1 10)))
(check-sat)
(exit)
