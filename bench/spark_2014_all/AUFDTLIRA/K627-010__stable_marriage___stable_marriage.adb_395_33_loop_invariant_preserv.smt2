...
(assert (= (invariant_holds unmatched_g1_set__split_fields11 proposals_made3 result__3 unmatched_g2_set3) true))
(assert (< 0 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields11))))
(assert (= result__4 (mk_map__ref result__3)))
(assert (= unmatched_g2_set4 (mk_map__ref5 unmatched_g2_set3)))
(assert (= unmatched_g1_set__split_fields12 (mk___split_fields__ref unmatched_g1_set__split_fields11)))
(assert (= proposals_made4 (mk_map__ref6 proposals_made3)))
(assert (= result__5 result__3))
(assert (= unmatched_g2_set5 unmatched_g2_set3))
(assert (= unmatched_g1_set__split_fields13 unmatched_g1_set__split_fields11))
(assert (= proposals_made5 proposals_made3))
(assert (not (= (invariant_holds (us_split_fields__content unmatched_g1_set__split_fields12) (map__content6 proposals_made4) (map__content result__4) (map__content5 unmatched_g2_set4)) true)))
(check-sat)
(exit)
