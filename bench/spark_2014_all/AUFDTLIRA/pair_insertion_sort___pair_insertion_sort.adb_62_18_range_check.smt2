...
(assert (=> (= result8 true) (and (and (= (is_perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t o42 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select o42 o14)) (to_rep (select a o15))) (and (= (to_rep (select o42 o15)) (to_rep (select a o14))) (forall ((z4 Int)) (=> (and (<= (to_rep a__first) z4) (<= z4 (to_rep a__last))) (=> (and (not (= z4 o14)) (not (= z4 o15))) (= (to_rep (select o42 z4)) (to_rep (select a z4))))))))) (= (to_rep a__first) 0))))
...
(assert (=> (= result12 true) (= (sorted (mk___t o46 (mk (to_rep a__first) (to_rep a__last))) 0 (- j8 1)) true)))
(assert (=> (= result12 true) (= (sorted (mk___t o46 (mk (to_rep a__first) (to_rep a__last))) (+ j8 1) (+ i1 1)) true)))
(assert (=> (= result12 true) (=> (< 0 j8) (<= (to_rep (select o46 (- j8 1))) (to_rep (select o46 (+ j8 1)))))))
(assert (=> (= result12 true) (< y2 (to_rep (select o46 (+ j8 1))))))
(assert (=> (= result12 true) (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t o46 (mk (to_rep a__first) (to_rep a__last)))) true)))
(assert (=> (= result12 true) (= (to_rep (select o46 j8)) y2)))
...
(assert (=> (= result12 true) (=> (<= 0 j9) (= o37 (select o46 o36)))))
...
(assert (=> (= result12 true) (= a8 (mk_map__ref o46))))
(assert (=> (= result12 true) (= j11 j9)))
(assert (=> (= result12 true) (= a9 o46)))
