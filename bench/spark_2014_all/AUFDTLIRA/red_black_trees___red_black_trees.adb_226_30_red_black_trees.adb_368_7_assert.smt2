...
(assert (=> (= result3 true) (=> (and (<= 1 n6) (<= n6 100)) (= temp___656 n6))))
(assert (=> (= result3 true) (=> (and (<= 1 n6) (<= n6 100)) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c67b) i)))) n7)) (not (= i (root (rec__red_black_trees__rbt__struct (us_split_fields9 c68b)))))) (= (eq (select (nb_blacks c68b) i) (select (nb_blacks c67b) i)) true)))))))
(assert (=> (= result3 true) (=> (and (<= 1 n6) (<= n6 100)) (and (=> (<= 1 100) (in_range4 n7)) (and (<= 1 n7) (<= n7 100))))))
