...
(declare-const tmp_b__first integer)
(declare-const tmp_b__last integer)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const tmp_c us_t)
...
(assert (= tmp_c (to_string (attr__ATTRIBUTE_IMAGE a))))
(declare-const b Int)
(declare-const c Int)
...
(assert (= result tmp_b))
(assert (= tmp_b1 (elts (to_string (attr__ATTRIBUTE_IMAGE a)))))
(assert (= (to_rep1 tmp_b__first) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE a)))))))
(assert (= (to_rep1 tmp_b__last) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE a)))))))
(assert (dynamic_property 1 2147483647 (to_rep1 tmp_b__first) (to_rep1 tmp_b__last)))
(assert (= (to_string (attr__ATTRIBUTE_IMAGE a)) tmp_c))
(assert (dynamic_invariant1 tmp_c true false true true))
(assert (=> (<= (to_rep1 tmp_b__first) (to_rep1 tmp_b__last)) (= o (+ (- (to_rep1 tmp_b__last) (to_rep1 tmp_b__first)) 1))))
(assert (=> (not (<= (to_rep1 tmp_b__first) (to_rep1 tmp_b__last))) (= o 0)))
