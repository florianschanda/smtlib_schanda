...
(define-fun dynamic_invariant ((temp___expr_160 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 0 100)) (in_range1 temp___expr_160)))
...
(define-fun dynamic_invariant1 ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 1 100)) (in_range2 temp___expr_167)))
(assert (forall ((sel (Array Int Bool))) (forall ((from Int)) (! (=> (dynamic_invariant1 from true true true true) (= (partial_count_selected_locations sel from) (+ (ite (= (select sel from) true) 1 0) (ite (< from 100) (partial_count_selected_locations sel (+ from 1)) 0)))) :pattern ((partial_count_selected_locations sel from))))))
...
(assert (=> (< from 100) (and (= o (+ from 1)) (in_range2 (+ from 1)))))
(assert (=> (< from 100) (and (= o1 (partial_count_selected_locations sel o)) (and (in_range1 o1) (and (= o1 (+ (ite (= (select sel o) true) 1 0) (ite (< o 100) (partial_count_selected_locations sel (+ o 1)) 0))) (<= o1 (+ (- 100 o) 1)))))))
(assert (=> (not (< from 100)) (= o1 0)))
(assert (=> (= (select sel from) true) (= o2 1)))
(assert (=> (not (= (select sel from) true)) (= o2 0)))
(assert (= o3 (+ o2 o1)))
