...
(assert (= result true))
(assert (and (<= (to_rep x__first) (to_rep x__first)) (<= (to_rep x__first) (to_rep x__last))))
(assert (= o1 (to_rep x__first)))
(assert (= o2 (select x o1)))
(assert (= o3 (to_rep o2)))
(assert (= result1 tmp))
(assert (= tmp1 o3))
(assert (and (<= (to_rep x__first) (to_rep x__last)) (<= (to_rep x__last) (to_rep x__last))))
(assert (= o4 (to_rep x__last)))
(assert (= o5 (select x o4)))
(assert (= o6 (to_rep o5)))
(assert (= (to_rep o7) o6))
(assert (and (<= (to_rep x__first) (to_rep x__first)) (<= (to_rep x__first) (to_rep x__last))))
(assert (= o8 (to_rep x__first)))
(assert (= o9 (store x o8 o7)))
(assert (= result2 x))
(assert (= x1 o9))
(assert (= (to_rep o10) tmp1))
(assert (not (<= (to_rep x__last) (to_rep x__last))))
(check-sat)
(exit)
