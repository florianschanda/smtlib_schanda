...
(assert (in_range e))
(assert (= (bool_eq (elts a) (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) (elts b) (to_rep1 (first (rt b))) (to_rep1 (last (rt b)))) true))
(assert (or (= (length a) 0) (and (not (= (length a) 0)) (and (and (and (and (and (and (and (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (<= (to_rep1 (last (rt a))) (to_rep1 (last (rt a))))) (= o (to_rep1 (last (rt a))))) (= o1 (select (elts a) o))) (= o2 (to_rep o1))) (= result (ite (= o2 e) true false))) (ite (= result true) (= (to_rep (select (elts b) (to_rep1 (last (rt b))))) e) (not (= (to_rep (select (elts b) (to_rep1 (last (rt b))))) e)))) (and (and (= o7 (remove_last b)) (and (dynamic_invariant1 o7 true false true true) (and (= (elts b) o5) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt b))) (- (to_rep1 (last (rt b))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt b))) (- (to_rep1 (last (rt b))) 1))))) o6)))) (and (and (= o8 (remove_last a)) (and (dynamic_invariant1 o8 true false true true) (and (= (elts a) o3) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1))))) o4)))) (= (occ o8 e) (occ o7 e))))))))
(assert (not (= (occ a e) (occ b e))))
(check-sat)
(exit)
