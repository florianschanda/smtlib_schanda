...
(assert (forall ((s us_t)) (! (=> (dynamic_invariant2 s true true true true) (dynamic_invariant1 (get_last s) true false true true)) :pattern ((get_last s)))))
(assert (forall ((s us_t)) (! (=> (dynamic_invariant2 s true true true true) (= (get_last s) (last3 (let ((temp___223 (last1 s))) (let ((temp___222 (first1 s))) (of_array1 (to_array s) temp___222 temp___223)))))) :pattern ((get_last s)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_224 us_void_param) 1)) 121) (= (to_rep (select (temp___String_Literal_224 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_224 us_void_param) 3)) 117)) :pattern ((temp___String_Literal_224 us_void_param)))))
(declare-fun temp___String_Literal_226 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_226 us_void_param) 1)) 104) (= (to_rep (select (temp___String_Literal_226 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_226 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_226 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_226 us_void_param) 5)) 111)) :pattern ((temp___String_Literal_226 us_void_param)))))
(declare-fun temp___String_Literal_231 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_231 us_void_param) 1)) 104) (= (to_rep (select (temp___String_Literal_231 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_231 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_231 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_231 us_void_param) 5)) 111)) :pattern ((temp___String_Literal_231 us_void_param)))))
...
(assert (= x2 (temp___String_Literal_226 Tuple0)))
...
(assert (= y1 (temp___String_Literal_224 Tuple0)))
...
(assert (= (get_last (mk___t x2 (mk (to_rep1 x__first) (to_rep1 x__last)))) (get_last (mk___t y1 (mk (to_rep1 y__first) (to_rep1 y__last))))))
(assert (= result2 s))
(assert (= s1 (temp___String_Literal_231 Tuple0)))
...
(assert (= x3 1))
(assert (in_range2 x3))
(assert (=> (<= (to_rep1 s__first) x3) (and (and (<= (to_rep1 s__first) (to_rep1 s__first)) (<= (to_rep1 s__first) (to_rep1 s__last))) (and (<= (to_rep1 s__first) x3) (<= x3 (to_rep1 s__last))))))
(assert (= o s1))
(assert (= o o1))
...
(assert (= result4 true))
(assert (and (=> (<= 1 2147483647) (in_range2 x4)) (= (to_rep1 (last4 (mk2 (to_rep1 s__first) x4))) x4)))
(assert (not (= x4 1)))
(check-sat)
(exit)
