...
(assert (and (<= (to_rep (first (rt a))) temp___183) (<= temp___183 (to_rep (last (rt a))))))
(assert (= o10 temp___183))
(assert (= o11 (select (elts a) o10)))
(assert (= o12 (to_rep o11)))
(assert (and (= temp___182 (+ x l2)) (in_range1 (+ x l2))))
(assert (not (<= (to_rep (first (rt a))) temp___182)))
(check-sat)
(exit)
