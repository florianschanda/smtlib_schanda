...
(assert (and (= o9 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o9) (<= (+ 0 o9) 2147483647))))
(assert (= result1 (ite (<= o9 10000) true false)))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o7 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o7) (<= (+ 0 o7) 2147483647))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= result2 (ite (< 0 o7) true false)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result2 true) (and (= o6 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) 1)) (in_range3 o6))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result2 true) (= result (ite (= o6 first_available) true false))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (not (= result2 true)) (= result false)))))
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (and (= o8 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o8) (<= (+ 0 o8) 2147483647))))))
...
(assert (= result3 (ite (<= 1 j) o1 false)))
(assert (= result3 true))
(assert (and (= o5 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) j)) (in_range3 o5)))
(assert (= result4 (ite (in_range7 o5) true false)))
(assert (= result4 true))
(assert (and (= o2 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o2) (<= (+ 0 o2) 2147483647))))
(assert (= result5 (ite (< j o2) true false)))
(assert (= result5 true))
(assert (and (= o3 (+ j 1)) (in_range1 (+ j 1))))
(assert (and (= o4 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) o3)) (in_range3 o4)))
(assert (and (= temp___315 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) j)) (in_range3 temp___315)))
(assert (not (<= 1 temp___315)))
(check-sat)
(exit)
