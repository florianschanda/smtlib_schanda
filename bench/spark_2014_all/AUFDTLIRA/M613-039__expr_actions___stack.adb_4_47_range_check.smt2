...
(assert (= o temp___235))
(assert (= (mk1 1 (to_rep1 (rec__stack__stack__top (us_split_fields1 s)))) temp___2351))
(assert (not (dynamic_property 1 2147483647 (to_rep (first2 temp___2351)) (to_rep (last2 temp___2351)))))
(check-sat)
(exit)
