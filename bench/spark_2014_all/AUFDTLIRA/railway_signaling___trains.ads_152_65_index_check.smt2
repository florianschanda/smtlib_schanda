...
(define-fun to_rep2 ((x location)) Int (locationqtint x))
(declare-fun of_rep2 (Int) location)
(assert (forall ((x location)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x location)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep2 (rec__trains__track__from (us_split_fields3 a))) (to_rep2 (rec__trains__track__from (us_split_fields3 b)))) (= (to_rep2 (rec__trains__track__to (us_split_fields3 a))) (to_rep2 (rec__trains__track__to (us_split_fields3 b))))) (= (to_rep3 (rec__trains__track__length (us_split_fields3 a))) (to_rep3 (rec__trains__track__length (us_split_fields3 b))))) true false))
...
(declare-fun user_eq6 (track_opt_id track_opt_id) Bool)
(declare-const dummy6 track_opt_id)
...
(define-fun dynamic_invariant ((temp___expr_227 Int) (temp___is_init_223 Bool) (temp___skip_constant_224 Bool) (temp___do_toplevel_225 Bool) (temp___do_typ_inv_226 Bool)) Bool (=> (or (= temp___is_init_223 true) (<= 0 8)) (in_range5 temp___expr_227)))
(define-fun to_rep4 ((x track_opt_id)) Int (track_opt_idqtint x))
(declare-fun of_rep4 (Int) track_opt_id)
(assert (forall ((x track_opt_id)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x track_opt_id)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(declare-fun user_eq7 (prev_id prev_id) Bool)
(declare-const dummy7 prev_id)
...
(define-fun dynamic_invariant1 ((temp___expr_241 Int) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool) (temp___do_typ_inv_240 Bool)) Bool (=> (or (= temp___is_init_237 true) (<= 1 3)) (in_range6 temp___expr_241)))
...
(define-fun bool_eq3 ((a (Array Int track_opt_id)) (a__first Int) (a__last Int) (b (Array Int track_opt_id)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_165 Int)) (=> (and (<= a__first temp___idx_165) (<= temp___idx_165 a__last)) (= (to_rep4 (select a temp___idx_165)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_165))))))) true false))
(assert (forall ((a (Array Int track_opt_id)) (b (Array Int track_opt_id))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_165 Int)) (=> (and (<= a__first temp___idx_165) (<= temp___idx_165 a__last)) (= (to_rep4 (select a temp___idx_165)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_165)))))))))))
(declare-const dummy8 (Array Int track_opt_id))
...
(declare-fun user_eq8 ((Array Int track_opt_id) (Array Int track_opt_id)) Bool)
...
(define-fun bool_eq4 ((a (Array Int (Array Int track_opt_id))) (a__first Int) (a__last Int) (b (Array Int (Array Int track_opt_id))) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_166 Int)) (=> (and (<= a__first temp___idx_166) (<= temp___idx_166 a__last)) (= (bool_eq3 (select a temp___idx_166) 1 3 (select b (+ (- b__first a__first) temp___idx_166)) 1 3) true)))) true false))
(assert (forall ((a (Array Int (Array Int track_opt_id))) (b (Array Int (Array Int track_opt_id)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_166 Int)) (=> (and (<= a__first temp___idx_166) (<= temp___idx_166 a__last)) (= (bool_eq3 (select a temp___idx_166) 1 3 (select b (+ (- b__first a__first) temp___idx_166)) 1 3) true))))))))
(declare-const previous_tracks (Array Int (Array Int track_opt_id)))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(assert (forall ((position us_rep)) (forall ((id Int)) (! (=> (dynamic_invariant1 id true true true true) (dynamic_invariant (get_previous_track position id) true false true true)) :pattern ((get_previous_track position id))))))
(assert (forall ((position us_rep)) (forall ((id Int)) (! (=> (dynamic_invariant1 id true true true true) (= (get_previous_track position id) (to_rep4 (let ((temp___292 (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 (rec__trains__train_position__track_end (us_split_fields1 position)))))))))) (select temp___292 id))))) :pattern ((get_previous_track position id))))))
...
(assert (forall ((position us_rep)) (forall ((id Int)) (! (=> (dynamic_invariant1 id true true true true) (dynamic_invariant (get_other_previous_track position id) true false true true)) :pattern ((get_other_previous_track position id))))))
(assert (forall ((position us_rep)) (forall ((id Int)) (! (=> (dynamic_invariant1 id true true true true) (= (get_other_previous_track position id) (ite (= (to_rep4 (let ((temp___296 (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 (rec__trains__train_position__track_begin (us_split_fields1 position)))))))))) (select temp___296 id))) (to_rep1 (rec__trains__train_position__track_end (us_split_fields1 position)))) 0 (to_rep4 (let ((temp___295 (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 (rec__trains__train_position__track_begin (us_split_fields1 position)))))))))) (select temp___295 id)))))) :pattern ((get_other_previous_track position id))))))
...
(declare-fun user_eq9 (train_id train_id) Bool)
(declare-const dummy9 train_id)
...
(define-fun dynamic_invariant2 ((temp___expr_260 Int) (temp___is_init_256 Bool) (temp___skip_constant_257 Bool) (temp___do_toplevel_258 Bool) (temp___do_typ_inv_259 Bool)) Bool (=> (or (= temp___is_init_256 true) (<= 1 10)) (in_range7 temp___expr_260)))
...
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_204 Int)) (=> (and (<= a__first temp___idx_204) (<= temp___idx_204 a__last)) (= (bool_eq (select a temp___idx_204) (select b (+ (- b__first a__first) temp___idx_204))) true))))))))
...
(define-fun dynamic_invariant5 ((temp___expr_210 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 1 5)) (in_range3 temp___expr_210)))
(define-fun dynamic_invariant6 ((temp___expr_234 Int) (temp___is_init_230 Bool) (temp___skip_constant_231 Bool) (temp___do_toplevel_232 Bool) (temp___do_typ_inv_233 Bool)) Bool (=> (or (= temp___is_init_230 true) (<= 1 8)) (in_range2 temp___expr_234)))
...
(assert (forall ((temp___200 Int) (temp___201 Int) (temp___202 Int)) (let ((temp___199 (temp_____aggregate_def_198 temp___200 temp___201 temp___202))) (=> (and (and (dynamic_invariant temp___200 true true true true) (dynamic_invariant temp___201 true true true true)) (dynamic_invariant temp___202 true true true true)) (and (and (= (select temp___199 1) rliteral12) (= (select temp___199 2) rliteral13)) (= (select temp___199 3) rliteral14))))))
(define-fun dynamic_invariant7 ((temp___expr_282 Int) (temp___is_init_278 Bool) (temp___skip_constant_279 Bool) (temp___do_toplevel_280 Bool) (temp___do_typ_inv_281 Bool)) Bool (=> (or (= temp___is_init_278 true) (<= 0 2)) (in_range8 temp___expr_282)))
...
(assert (in_range7 cur_num_trains))
(assert (<= 1 train))
...
(assert (and (= o10 (get_previous_track o19 id)) (and (in_range5 o10) (= o10 (to_rep4 (select (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 o9)))))) id))))))
...
(assert (=> (= result1 true) (and (= temp___370 (get_previous_track o18 id)) (and (in_range5 temp___370) (= temp___370 (to_rep4 (select (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 o15)))))) id)))))))
...
(assert (=> (= result1 true) (= temp___371 (to_rep5 o17))))
...
(assert (and (= o4 (get_other_previous_track o20 id)) (and (in_range5 o4) (= o4 (ite (= (to_rep4 (select (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 o1)))))) id)) (to_rep1 o3)) 0 (to_rep4 (select (select previous_tracks (to_rep2 (rec__trains__track__from (us_split_fields3 (select tracks (to_rep1 o1)))))) id)))))))
