...
(assert (= result2 true))
(assert (and (= o11 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f1)) j1))))) (in_range5 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f1)) j1)))))))
...
(assert (= o8 (select temp___1112 j1)))
