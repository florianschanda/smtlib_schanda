...
(declare-const temp___1611 (Array Int us_rep3))
...
(assert (= result5 true))
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) i2))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) j1)))) true))
(assert (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j1))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i2)))) 1)) (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) j1))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) i2)))) 1))))
(assert (and (= temp___1611 (model__ f root)) (and (dynamic_invariant5 temp___1611 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1611 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1611 root)))) 0) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (not (= i3 root)) (ite (and (not (= (parent f i3) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1611 (parent f i3)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1611 i3))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1611 i3))) true)))))) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1611 i3))) true) (not (= i3 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1611 (parent f i3)))) (position f i3) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1611 i3)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1611 i3)))) 0)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1611 i3))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1611 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1611 i3))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1611 j2)))) true)) (= j2 i3))))))))))))))
(assert (= o20 (select temp___1611 i2)))
