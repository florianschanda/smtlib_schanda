...
(assert (= empty_line (tetris_flow__delete_complete_lines__empty_line__aggregate_def 0)))
...
(assert (forall ((temp___531 Int)) (=> (dynamic_invariant3 temp___531 true true true true) (forall ((temp___532 Int)) (= (to_rep (select (tetris_flow__delete_complete_lines__empty_line__aggregate_def temp___531) temp___532)) temp___531)))))
...
(declare-const temp___799 (Array Int (Array Int cell)))
(declare-const temp___798 Bool)
...
(assert (= (tetris_flow__delete_complete_lines__empty_line__aggregate_def 0) empty_line))
...
(assert (= del_line1 1))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___801 to_line1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___799 cur_board)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___798 has_complete_lines1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (and (and (forall ((temp___800 Int)) (=> (and (<= 1 temp___800) (<= temp___800 50)) (=> (or (< 50 temp___800) (or (< temp___800 1) (<= del_line2 temp___800))) (= (select cur_board2 temp___800) (select temp___799 temp___800))))) (=> (<= 1 50) (in_range4 to_line2))) (and (<= 1 del_line2) (<= del_line2 50)))))
