...
(assert (=> (not (= smallest1 current1)) (and (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t o8 (mk (to_rep values__first) (to_rep values__last)))) true) (and (= (to_rep (select o8 o7)) (to_rep (select values smallest1))) (and (= (to_rep (select o8 smallest1)) (to_rep (select values o7))) (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j (to_rep values__last))) (=> (and (not (= j o7)) (not (= j smallest1))) (= (to_rep (select o8 j)) (to_rep (select values j)))))))))))
...
(assert (not (= (ite (<= (to_rep (first2 temp___2183)) (to_rep (last2 temp___2183))) (+ (- (to_rep (last2 temp___2183)) (to_rep (first2 temp___2183))) 1) 0) (ite (<= (to_rep values_last__first) (to_rep values_last__last)) (+ (- (to_rep values_last__last) (to_rep values_last__first)) 1) 0))))
(check-sat)
(exit)
