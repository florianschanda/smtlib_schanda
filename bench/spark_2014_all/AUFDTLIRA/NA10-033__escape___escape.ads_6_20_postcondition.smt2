...
(declare-const temp___184 (Array Int character))
...
(assert (=> (and (<= (to_rep1 (first (rt s))) i2) (<= i2 (to_rep1 (last (rt s))))) (= i20 (mk_int__ref i4))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i2) (<= i2 (to_rep1 (last (rt s))))) (= count_bs10 (mk_int__ref count_bs4))))
...
(assert (= escape__backslash_escape__result3 (mk_string__ref escape__backslash_escape__result2)))
(assert (= i14 i12))
(assert (= ti11 ti9))
(assert (= result__11 result__9))
(assert (= escape__backslash_escape__result4 escape__backslash_escape__result2))
(assert (= i15 i13))
(assert (= ti12 ti10))
...
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= temp___186 ti1)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= temp___184 result__)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (and (=> (<= 1 2147483647) (in_range2 ti2)) (and (<= (to_rep1 (first (rt s))) i9) (<= i9 (to_rep1 (last (rt s))))))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= (to_rep o4) (to_rep (select (elts s) i9)))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (and (<= (to_rep1 result____first) ti2) (<= ti2 (to_rep1 result____last)))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= o5 ti2)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= o6 (store result__2 o5 o4))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= result__2 result5)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= result__3 o6)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (and (= o7 (+ ti2 1)) (in_range1 (+ ti2 1)))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= ti2 result6)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= ti3 o7)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (= (to_rep (select (elts s) i9)) 92) (= (to_rep o8) 92))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (= (to_rep (select (elts s) i9)) 92) (and (<= (to_rep1 result____first) ti3) (<= ti3 (to_rep1 result____last))))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (= (to_rep (select (elts s) i9)) 92) (= o9 ti3))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (= (to_rep (select (elts s) i9)) 92) (= o10 (store result__3 o9 o8)))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (= (to_rep (select (elts s) i9)) 92) (= result__3 result7))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (= (to_rep (select (elts s) i9)) 92) (= result__4 o10))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (= (to_rep (select (elts s) i9)) 92) (and (= o11 (+ ti3 1)) (in_range1 (+ ti3 1))))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (= (to_rep (select (elts s) i9)) 92) (= result8 (mk_int__ref ti3)))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (= (to_rep (select (elts s) i9)) 92) (= ti4 o11))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (= (to_rep (select (elts s) i9)) 92) (= ti5 (mk_int__ref ti4)))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (= (to_rep (select (elts s) i9)) 92) (= result__5 (mk_map__ref result__4)))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (= (to_rep (select (elts s) i9)) 92) (= ti6 ti4))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (= (to_rep (select (elts s) i9)) 92) (= result__6 result__4))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (not (= (to_rep (select (elts s) i9)) 92)) (= ti5 (mk_int__ref ti3)))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (not (= (to_rep (select (elts s) i9)) 92)) (= result__5 (mk_map__ref result__3)))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (not (= (to_rep (select (elts s) i9)) 92)) (= ti6 ti3))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (=> (not (= (to_rep (select (elts s) i9)) 92)) (= result__6 result__3))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= i9 (to_rep1 (last (rt s))))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= i10 (mk_int__ref i9))))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= ti7 ti5)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= result__7 result__5)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= i11 i9)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= ti8 ti6)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= result__8 result__6)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= i12 i10)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= ti9 ti7)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= result__9 result__7)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= i13 i11)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= ti10 ti8)))
(assert (=> (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s))))) (= result__10 result__8)))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s)))))) (= i12 (mk_int__ref i8))))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s)))))) (= ti9 (mk_int__ref ti1))))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s)))))) (= result__9 (mk_map__ref result__))))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s)))))) (= i13 i8)))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s)))))) (= ti10 ti1)))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) i8) (<= i8 (to_rep1 (last (rt s)))))) (= result__10 result__1)))
(assert (= result9 (mk_string__ref (mk___t escape__backslash_escape__result escape__backslash_escape__result1))))
(assert (= escape__backslash_escape__result2 (mk___t (map__content result__9) (mk (to_rep1 result____first) (to_rep1 result____last)))))
(assert (= escape__backslash_escape__result5 escape__backslash_escape__result3))
(assert (= i17 i14))
(assert (= ti13 ti11))
(assert (= result__13 result__11))
(assert (= i16 i20))
(assert (= count_bs8 count_bs10))
(assert (= escape__backslash_escape__result6 escape__backslash_escape__result4))
(assert (= i19 i15))
(assert (= ti14 ti12))
(assert (= result__14 result__12))
(assert (= i18 i7))
(assert (= count_bs9 count_bs7))
(assert (= (mk___t result10 result11) (string__content escape__backslash_escape__result5)))
(assert (not (<= (length s) (length (string__content escape__backslash_escape__result5)))))
(check-sat)
(exit)
