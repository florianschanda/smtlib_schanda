...
(assert (not (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) i2))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) j3)))) true)))
(check-sat)
(exit)
