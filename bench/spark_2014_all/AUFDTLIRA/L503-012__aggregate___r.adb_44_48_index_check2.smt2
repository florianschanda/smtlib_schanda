...
(assert (forall ((i int6)) (and (<= 1 (int6qtint i)) (<= (int6qtint i) 6))))
...
(assert (forall ((i tar37P1)) (and (<= 3 (tar37P1qtint i)) (<= (tar37P1qtint i) 7))))
...
(declare-fun temp_____aggregate_def_326 ((Array Int int5)) (Array Int (Array Int int5)))
(declare-fun temp_____aggregate_def_330 (Int Int) (Array Int int5))
...
(assert (forall ((temp___328 (Array Int int5))) (forall ((temp___329 Int)) (= (select (temp_____aggregate_def_326 temp___328) temp___329) temp___328))))
(declare-const rliteral int5)
(assert (= (int5qtint rliteral) 1))
(assert (forall ((temp___332 Int) (temp___333 Int)) (let ((temp___331 (temp_____aggregate_def_330 temp___332 temp___333))) (=> (and (dynamic_invariant2 temp___332 true true true true) (dynamic_invariant2 temp___333 true true true true)) (forall ((temp___334 Int)) (ite (= temp___334 3) (= (select temp___331 temp___334) rliteral) (= (to_rep (select temp___331 temp___334)) temp___333)))))))
(declare-const a (Array Int (Array Int int5)))
(declare-const i Int)
(declare-const o Int)
(declare-const temp___325 (Array Int int5))
(declare-const o1 Int)
(declare-const o2 int5)
(declare-const o3 Int)
(declare-const o4 Int)
(declare-const o5 Int)
(declare-const temp___335 (Array Int int5))
...
(assert (and (<= 3 n) (<= n 7)))
(assert (= o n))
(assert (= temp___325 (select a o)))
(assert (and (<= 2 n) (<= n 6)))
(assert (= o1 n))
(assert (= o2 (select temp___325 o1)))
(assert (= o3 (to_rep o2)))
