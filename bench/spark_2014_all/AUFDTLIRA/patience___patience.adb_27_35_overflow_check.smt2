...
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep s__split_fields) 1))) (= o3 temp___600)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep s__split_fields) 1))) (= temp___601 (select s__split_fields4 o3))))
...
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep s__split_fields) 1))) (= o4 temp___603)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep s__split_fields) 1))) (= o5 (select s__split_fields3 o4))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep s__split_fields) 1))) (= o6 (to_rep o5))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep s__split_fields) 1))) (= temp___604 (- o6 1))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep s__split_fields) 1))) (and (<= 0 temp___604) (<= temp___604 99))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep s__split_fields) 1))) (= o7 temp___604)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep s__split_fields) 1))) (= o8 (select temp___601 o7))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep s__split_fields) 1))) (= o9 (to_rep o8))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep s__split_fields) 1))) (= result3 (ite (= pred2 o9) true false))))
(assert (=> (not (and (<= 0 pred2) (<= pred2 (- (to_rep s__split_fields) 1)))) (= result3 false)))
(assert (=> (= result3 true) (and (<= 0 pred2) (<= pred2 99))))
(assert (=> (= result3 true) (= o pred2)))
(assert (=> (= result3 true) (= o1 (select s__split_fields1 o))))
(assert (=> (= result3 true) (= o2 (to_rep1 o1))))
(assert (=> (= result3 true) (= result2 (ite (< o2 c) true false))))
