...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__partition_refinement__inverse_sets__map us_main_type1)))))
(define-fun us_split_fields_Map__projection ((a us_split_fields)) us_main_type1 (rec__partition_refinement__inverse_sets__map a))
...
(define-fun us_rep___10__projection ((a us_rep1)) us_split_discrs (us_split_discrs1 a))
(define-fun us_rep___11__projection ((a us_rep1)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep1 (rec__partition_refinement__inverse_sets__map__capacity (us_split_discrs1 a))) (to_rep1 (rec__partition_refinement__inverse_sets__map__capacity (us_split_discrs1 b)))) (= (us_main_eq1 (rec__partition_refinement__inverse_sets__map (us_split_fields1 a)) (rec__partition_refinement__inverse_sets__map (us_split_fields1 b))) true)) true false))
...
(assert (forall ((a us_rep1) (b us_rep1)) (! (= (user_eq3 a b) (oeq1 a b)) :pattern ((user_eq3 a b)))))
...
(define-fun default_initial_assumption ((temp___expr_628 us_rep) (temp___skip_top_level_629 Bool)) Bool (=> (not (= temp___skip_top_level_629 true)) (= (length temp___expr_628) 0)))
(assert (forall ((container us_rep1)) (! (let ((result (keys container))) (and (and (and (= (length result) (length1 container)) (forall ((temp___666 Int)) (=> (and (in_range4 temp___666) (= (iter_has_element result temp___666) true)) (= (has_key (model__ container) (get result temp___666)) true)))) (forall ((key Int)) (=> (and (in_range3 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (equivalent_keys (get result (find result key)) key) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (and (= (find result (get result i)) i) (= (k_is_find result (get result i) i) true)))))) :pattern ((keys container)))))
...
(define-fun us_rep___12__projection ((a us_rep3)) us_split_fields2 (us_split_fields3 a))
(define-fun bool_eq3 ((a us_rep3) (b us_rep3)) Bool (ite (= (to_rep1 (rec__partition_refinement__inverse_sets__cursor__node (us_split_fields3 a))) (to_rep1 (rec__partition_refinement__inverse_sets__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun map__ref___4__projection ((a map__ref2)) us_rep4 (map__content2 a))
...
(define-fun dynamic_invariant1 ((temp___expr_540 Int) (temp___is_init_536 Bool) (temp___skip_constant_537 Bool) (temp___do_toplevel_538 Bool) (temp___do_typ_inv_539 Bool)) Bool (=> (or (= temp___is_init_536 true) (<= 1 2147483647)) (in_range5 temp___expr_540)))
...
(define-fun dynamic_invariant2 ((temp___expr_547 Int) (temp___is_init_543 Bool) (temp___skip_constant_544 Bool) (temp___do_toplevel_545 Bool) (temp___do_typ_inv_546 Bool)) Bool (=> (or (= temp___is_init_543 true) (<= 0 5)) (in_range6 temp___expr_547)))
...
(define-fun equal_except ((left us_rep) (right us_rep) (position Int)) Bool (and (= (length left) (length right)) (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (last left))) (=> (not (= i position)) (= (get left i) (get right i))))) true false)))
(declare-fun equal_except__function_guard (Bool us_rep us_rep Int) Bool)
...
(define-fun dynamic_invariant3 ((temp___expr_799 Int) (temp___is_init_795 Bool) (temp___skip_constant_796 Bool) (temp___do_toplevel_797 Bool) (temp___do_typ_inv_798 Bool)) Bool (=> (or (= temp___is_init_795 true) (<= 0 10001)) (in_range7 temp___expr_799)))
(declare-fun length2 (us_rep5) Int)
(declare-fun length__function_guard2 (Int us_rep5) Bool)
(assert (forall ((container us_rep5)) (! (let ((result (length2 container))) (and (<= result (capacity container)) (dynamic_invariant3 result true false true true))) :pattern ((length2 container)))))
...
(define-fun last1 ((container us_rep7)) Int (+ (- 1) (length3 container)))
...
(define-fun equal_except1 ((left us_rep7) (right us_rep7) (position Int)) Bool (and (= (length3 left) (length3 right)) (ite (forall ((i Int)) (=> (and (<= 0 i) (<= i (last1 left))) (=> (not (= i position)) (= (bool_eq5 (get3 left i) (get3 right i)) true)))) true false)))
...
(define-fun dynamic_invariant4 ((temp___expr_333 Int) (temp___is_init_329 Bool) (temp___skip_constant_330 Bool) (temp___do_toplevel_331 Bool) (temp___do_typ_inv_332 Bool)) Bool (=> (or (= temp___is_init_329 true) (<= 0 5)) (in_range9 temp___expr_333)))
...
(declare-datatypes () ((inverse_set__ref (mk_inverse_set__ref (inverse_set__content us_rep1)))))
(define-fun inverse_set__ref___projection ((a inverse_set__ref)) us_rep1 (inverse_set__content a))
(assert (forall ((a us_rep1) (b us_rep1)) (! (= (user_eq17 a b) (oeq1 a b)) :pattern ((user_eq17 a b)))))
...
(declare-fun user_eq18 (partition_index partition_index) Bool)
(declare-const dummy18 partition_index)
...
(define-fun dynamic_invariant5 ((temp___expr_326 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool) (temp___do_typ_inv_325 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 0 6)) (in_range8 temp___expr_326)))
(define-fun dynamic_invariant6 ((temp___expr_768 Int) (temp___is_init_764 Bool) (temp___skip_constant_765 Bool) (temp___do_toplevel_766 Bool) (temp___do_typ_inv_767 Bool)) Bool (=> (or (= temp___is_init_764 true) (<= 0 10000)) (in_range10 temp___expr_768)))
...
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= result (to_rep1 (rec__partition_refinement__inverse_sets__map__capacity (us_split_discrs1 container)))) (dynamic_invariant7 result true false true true))) :pattern ((length1 container)))))
(assert (forall ((container us_rep)) (forall ((key1 Int)) (! (=> (dynamic_invariant1 key1 true true true true) (let ((result (find container key1))) (and (=> (< 0 result) (and (<= result (length container)) (= (equivalent_keys key1 (get container result)) true))) (dynamic_invariant7 result true false true true)))) :pattern ((find container key1))))))
...
(define-fun default_initial_assumption1 ((temp___expr_592 us_rep2) (temp___skip_top_level_593 Bool)) Bool (=> (not (= temp___skip_top_level_593 true)) (and (= (is_empty temp___expr_592) true) (= (length4 temp___expr_592) 0))))
(assert true)
...
(define-fun default_initial_assumption2 ((temp___expr_651 us_rep4) (temp___skip_top_level_652 Bool)) Bool (=> (not (= temp___skip_top_level_652 true)) (and (= (is_empty1 temp___expr_651) true) (= (length5 temp___expr_651) 0))))
(assert (forall ((container us_rep1)) (! (let ((result (positions container))) (and (not (= (has_key1 result no_element) true)) (forall ((i1 us_rep3)) (=> (= (has_key1 result i1) true) (and (and (<= 1 (get1 result i1)) (<= (get1 result i1) (length1 container))) (forall ((j1 us_rep3)) (=> (= (has_key1 result j1) true) (=> (= (get1 result i1) (get1 result j1)) (= (bool_eq3 i1 j1) true))))))))) :pattern ((positions container)))))
(declare-fun oeq3 (us_rep2 us_rep2) Bool)
(declare-fun oeq__function_guard3 (Bool us_rep2 us_rep2) Bool)
(assert (forall ((left us_rep1) (right us_rep1)) (! (= (= (oeq1 left right) true) (= (oeq3 (model__ left) (model__ right)) true)) :pattern ((oeq1 left right)))))
(define-fun dynamic_invariant8 ((temp___expr_577 Int) (temp___is_init_573 Bool) (temp___skip_constant_574 Bool) (temp___do_toplevel_575 Bool) (temp___do_typ_inv_576 Bool)) Bool (=> (or (= temp___is_init_573 true) (<= 1 2147483647)) (in_range3 temp___expr_577)))
(assert (forall ((container us_rep2)) (forall ((key1 Int)) (! (=> (dynamic_invariant8 key1 true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range3 k) (= (has_key container k) true)) (= (equivalent_keys k key1) true))) (= (has_key container key1) true)))) :pattern ((has_key container key1))))))
...
(assert (forall ((container us_rep2)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant8 key1 true true true true) (= (has_key container key1) true)) (let ((result (get2 container key1))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key1))) (forall ((k Int)) (=> (and (in_range3 k) (= (has_key container k) true)) (= (= (equivalent_keys k key1) true) (= (witness container key1) (witness container k))))))) (dynamic_invariant9 result true false true true)))) :pattern ((get2 container key1))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant7 (length4 container) true false true true) :pattern ((length4 container)))))
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (oeq3 left right) true) (and (forall ((key1 Int)) (=> (and (in_range3 key1) (= (has_key left key1) true)) (and (= (has_key right key1) true) (= (get2 right key1) (get2 left key1))))) (forall ((key1 Int)) (=> (and (in_range3 key1) (= (has_key right key1) true)) (= (has_key left key1) true))))) :pattern ((oeq3 left right)))))
(assert (forall ((container us_rep2)) (! (= (= (is_empty container) true) (forall ((key1 Int)) (not (and (in_range3 key1) (= (has_key container key1) true))))) :pattern ((is_empty container)))))
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (keys_included left right) true) (forall ((key1 Int)) (=> (and (in_range3 key1) (= (has_key left key1) true)) (= (has_key right key1) true)))) :pattern ((keys_included left right)))))
(assert (forall ((left us_rep2) (right us_rep2)) (forall ((new_key Int)) (! (=> (dynamic_invariant8 new_key true true true true) (= (= (elements_equal_except left right new_key) true) (forall ((key1 Int)) (=> (and (in_range3 key1) (= (has_key left key1) true)) (=> (not (= (equivalent_keys key1 new_key) true)) (and (= (has_key right key1) true) (= (get2 left key1) (get2 right key1)))))))) :pattern ((elements_equal_except left right new_key))))))
(declare-fun has_witness (us_rep2 Int) Bool)
(declare-fun has_witness__function_guard (Bool us_rep2 Int) Bool)
(assert true)
(assert (forall ((container us_rep2)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant8 key1 true true true true) (= (has_key container key1) true)) (let ((result (witness container key1))) (and (= (has_witness container result) true) (dynamic_invariant7 result true false true true)))) :pattern ((witness container key1))))))
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant7 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant9 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
(define-fun dynamic_invariant10 ((temp___expr_620 Int) (temp___is_init_616 Bool) (temp___skip_constant_617 Bool) (temp___do_toplevel_618 Bool) (temp___do_typ_inv_619 Bool)) Bool (=> (or (= temp___is_init_616 true) (<= 0 2147483647)) (in_range4 temp___expr_620)))
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant7 result true false true true))) :pattern ((length container)))))
...
(assert (forall ((container us_rep)) (forall ((position Int)) (! (=> (and (dynamic_invariant10 position true true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant11 (get container position) true false true true)) :pattern ((get container position))))))
...
(assert (forall ((container us_rep4)) (forall ((key1 us_rep3)) (! (=> (= (has_key1 container key1) true) (let ((result (get1 container key1))) (and (=> (= (distinct 0 0) true) (and (= result (w_get1 container (witness1 container key1))) (forall ((k us_rep3)) (=> (= (has_key1 container k) true) (= (= (bool_eq3 k key1) true) (= (witness1 container key1) (witness1 container k))))))) (dynamic_invariant12 result true false true true)))) :pattern ((get1 container key1))))))
(assert (forall ((container us_rep4)) (! (dynamic_invariant7 (length5 container) true false true true) :pattern ((length5 container)))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key1 us_rep3)) (! (=> (= (has_key1 container key1) true) (let ((result (witness1 container key1))) (and (= (has_witness1 container result) true) (dynamic_invariant7 result true false true true)))) :pattern ((witness1 container key1))))))
(assert (forall ((container us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant7 witness2 true true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant12 (w_get1 container witness2) true false true true)) :pattern ((w_get1 container witness2))))))
...
(define-fun oeq4 ((left us_rep7) (right us_rep7)) Bool (and (= (length3 left) (length3 right)) (ite (forall ((n Int)) (=> (and (<= 0 n) (<= n (last1 left))) (= (bool_eq5 (get3 left n) (get3 right n)) true))) true false)))
(declare-fun oeq__function_guard4 (Bool us_rep7 us_rep7) Bool)
(assert (forall ((a us_rep7) (b us_rep7)) (! (= (user_eq16 a b) (oeq4 a b)) :pattern ((user_eq16 a b)))))
(define-fun default_initial_assumption3 ((temp___expr_841 us_rep7) (temp___skip_top_level_842 Bool)) Bool (=> (not (= temp___skip_top_level_842 true)) (= (length3 temp___expr_841) 0)))
(assert (forall ((container us_rep5)) (! (= (length3 (model__1 container)) (length2 container)) :pattern ((model__1 container)))))
...
(assert (forall ((container us_rep7)) (! (let ((result (length3 container))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant7 result true false true true))) :pattern ((length3 container)))))
(assert true)
(declare-const a (Array Int positive))
(declare-const d__split_fields us_main_type1)
...
(declare-const o Int)
(declare-const o1 index_count)
(declare-const o2 us_split_fields6)
(declare-const temp___1260 us_rep6)
(declare-const result us_split_fields__ref3)
(declare-const p_elem__split_fields3 us_split_fields6)
...
(declare-const p_elem__split_fields4 us_split_fields6)
(define-fun partition_refinement__refine_one__p_elem__assume3 () us_rep6 (mk___rep3 (mk___split_fields3 partition_refinement__refine_one__p_elem__assume partition_refinement__refine_one__p_elem__assume1 partition_refinement__refine_one__p_elem__assume2)))
(assert (in_range1 x_elem))
(assert (and (< (length2 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields))) 10000) (and (= (has_key (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem) true) (and (and (<= 0 (to_rep5 (select f (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))) (<= (to_rep5 (select f (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem))) (- (length2 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields))) 1))) (and (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (= (has_key (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (to_rep (select a j1))) true))) (forall ((c us_rep3)) (=> (= (has_key1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c) true) (= (to_rep (select a (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c)))))))))
(assert (and (= partition_refinement__refine_one__i__assume (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range6 partition_refinement__refine_one__i__assume) (= partition_refinement__refine_one__i__assume (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
(assert (= partition_refinement__refine_one__i__assume i))
(assert (in_range9 i))
(assert (and (= partition_refinement__refine_one__p_elem__assume3 (get3 (model__1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields))) (to_rep5 (select f i)))) (= (bool_eq5 partition_refinement__refine_one__p_elem__assume3 (get3 (model__1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields))) (to_rep5 (select f i)))) true)))
(assert (= result (mk___split_fields__ref3 (mk___split_fields3 p_elem__split_fields p_elem__split_fields1 p_elem__split_fields2))))
(assert (= p_elem__split_fields3 (mk___split_fields3 partition_refinement__refine_one__p_elem__assume partition_refinement__refine_one__p_elem__assume1 partition_refinement__refine_one__p_elem__assume2)))
(assert (in_range9 (+ (to_rep4 (rec__partition_refinement__interval__first p_elem__split_fields3)) (to_rep3 (rec__partition_refinement__interval__count p_elem__split_fields3)))))
(assert (and (= partition_refinement__refine_one__j__assume (+ (to_rep4 (rec__partition_refinement__interval__first p_elem__split_fields3)) (to_rep3 (rec__partition_refinement__interval__count p_elem__split_fields3)))) (in_range9 (+ (to_rep4 (rec__partition_refinement__interval__first p_elem__split_fields3)) (to_rep3 (rec__partition_refinement__interval__count p_elem__split_fields3))))))
(assert (= partition_refinement__refine_one__j__assume j))
(assert (in_range9 j))
(assert (= a a_old))
(assert (= (temp_____aggregate_def_157 a_old i (to_rep (select a_old j)) j (to_rep (select a_old i))) a_update))
(assert (= (bool_eq7 a1 0 5 (temp_____aggregate_def_954 a i (to_rep (select a j)) j (to_rep (select a i))) 0 5) true))
(assert (= (bool_eq7 a1 0 5 a_update 0 5) true))
(assert (forall ((c us_rep3)) (=> (= (has_key1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c) true) (=> (and (not (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c))))))
...
(assert (= (bool_eq7 a1 0 5 a_update 0 5) true))
(assert (forall ((c us_rep3)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c) true) (=> (and (not (= (key (mk___rep d__split_discrs d__split_fields1) c) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs d__split_fields1) c) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields1) c))) (key (mk___rep d__split_discrs d__split_fields1) c))))))
(assert (forall ((c us_rep3)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c) true) (=> (= (key (mk___rep d__split_discrs d__split_fields1) c) (to_rep (select a1 i))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields1) c))) (key (mk___rep d__split_discrs d__split_fields1) c))))))
(assert (and (and (and (and (and (= (oeq2 (positions (mk___rep d__split_discrs partition_refinement__inverse_sets__replace__container__fields1)) (positions (mk___rep d__split_discrs d__split_fields1))) true) (= (get (keys (mk___rep d__split_discrs partition_refinement__inverse_sets__replace__container__fields1)) (find (keys (mk___rep d__split_discrs partition_refinement__inverse_sets__replace__container__fields1)) (to_rep (select a1 j)))) (to_rep (select a1 j)))) (= (equal_except (keys (mk___rep d__split_discrs d__split_fields1)) (keys (mk___rep d__split_discrs partition_refinement__inverse_sets__replace__container__fields1)) (find (keys (mk___rep d__split_discrs partition_refinement__inverse_sets__replace__container__fields1)) (to_rep (select a1 j)))) true)) (= (get2 (model__ (mk___rep d__split_discrs partition_refinement__inverse_sets__replace__container__fields1)) (to_rep (select a1 j))) j)) (= (same_keys (model__ (mk___rep d__split_discrs partition_refinement__inverse_sets__replace__container__fields1)) (model__ (mk___rep d__split_discrs d__split_fields1))) true)) (= (elements_equal_except (model__ (mk___rep d__split_discrs partition_refinement__inverse_sets__replace__container__fields1)) (model__ (mk___rep d__split_discrs d__split_fields1)) (to_rep (select a1 j))) true)))
...
(assert (= (bool_eq7 a1 0 5 a_update 0 5) true))
(assert (forall ((c us_rep3)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c) true) (=> (and (not (= (key (mk___rep d__split_discrs d__split_fields2) c) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs d__split_fields2) c) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c))) (key (mk___rep d__split_discrs d__split_fields2) c))))))
(assert (forall ((c us_rep3)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c) true) (=> (= (key (mk___rep d__split_discrs d__split_fields2) c) (to_rep (select a1 i))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c))) (key (mk___rep d__split_discrs d__split_fields2) c))))))
(assert (forall ((c us_rep3)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c) true) (=> (= (key (mk___rep d__split_discrs d__split_fields2) c) (to_rep (select a1 j))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c))) (key (mk___rep d__split_discrs d__split_fields2) c))))))
(assert (forall ((c us_rep3)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c) true) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c))) (key (mk___rep d__split_discrs d__split_fields2) c)))))
(assert (and (= o (+ (to_rep3 (rec__partition_refinement__interval__count p_elem__split_fields3)) 1)) (in_range8 (+ (to_rep3 (rec__partition_refinement__interval__count p_elem__split_fields3)) 1))))
(assert (= (to_rep3 o1) o))
(assert (= o2 (mk___split_fields3 (rec__partition_refinement__interval__first p_elem__split_fields3) (rec__partition_refinement__interval__last p_elem__split_fields3) o1)))
(assert (= temp___1260 (mk___rep3 o2)))
(assert (= result3 (mk___split_fields__ref3 p_elem__split_fields3)))
(assert (= p_elem__split_fields4 (us_split_fields7 temp___1260)))
(assert (not (<= 0 (to_rep5 (select f i)))))
(check-sat)
(exit)
