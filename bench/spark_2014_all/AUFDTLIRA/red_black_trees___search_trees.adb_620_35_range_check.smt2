...
(assert (and (= result2 (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 t)) o (rec__search_trees__search_tree__values (us_split_fields7 t)))) (= (= result2 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o) i))) true) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o) i))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o) i)))) 1)) 0) (< (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j)) (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i))) (< (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i)) (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j))))))))))))
(assert (= result2 true))
