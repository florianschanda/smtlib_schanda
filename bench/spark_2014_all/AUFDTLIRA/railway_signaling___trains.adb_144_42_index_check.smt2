...
(assert (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 id2)) (=> (not (= (get_other_previous_track new_position k1) 0)) (let ((temp___396 (to_rep5 (select track_signals3 (get_other_previous_track new_position k1))))) (or (= temp___396 1) (= temp___396 2)))))))
...
(assert (<= 1 k))
(assert (<= k id2))
(assert (and (= o9 k) (in_range8 k)))
(assert (and (= o10 (get_other_previous_track new_position o9)) (and (in_range3 o10) (= o10 (ite (= (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) o9)) (to_rep4 (rec__trains__train_position__track_end (us_split_fields3 new_position)))) 0 (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) o9)))))))
(assert (= o11 (ite (= o10 0) true false)))
(assert (= result10 (ite (not (= o11 true)) true false)))
(assert (= result10 true))
(assert (and (= o12 k) (in_range8 k)))
(assert (and (= temp___393 (get_other_previous_track new_position o12)) (and (in_range3 temp___393) (= temp___393 (ite (= (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) o12)) (to_rep4 (rec__trains__train_position__track_end (us_split_fields3 new_position)))) 0 (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 (rec__trains__train_position__track_begin (us_split_fields3 new_position)))))))) o12)))))))
(assert (not (<= temp___393 8)))
(check-sat)
(exit)
