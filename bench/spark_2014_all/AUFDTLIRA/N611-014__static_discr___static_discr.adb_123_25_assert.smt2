...
(assert (and (and (and (<= 1 (to_rep (rec__static_discr__holder__length current__split_fields6))) (<= (to_rep (rec__static_discr__holder__length current__split_fields6)) (to_rep (rec__static_discr__holder__length (us_split_fields5 a))))) (= (let ((temp___381 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content current__split_fields6))))) (let ((temp___380 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 a)))))) (bool_eq (elts temp___380) (to_rep1 (first (rt temp___380))) (to_rep1 (last (rt temp___380))) (elts temp___381) (to_rep1 (first (rt temp___381))) (to_rep1 (last (rt temp___381)))))) true)) (forall ((i Int)) (=> (and (<= (+ (to_rep (rec__static_discr__holder__length current__split_fields6)) 1) i) (<= i (to_rep (rec__static_discr__holder__length (us_split_fields5 a))))) (not (= (to_rep (select (elts (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 a))))) i)) e))))))
(assert (and (and (dynamic_invariant1 (mk___rep2 current__split_discrs current__split_fields6) false true true true) (=> (<= 0 2147483647) (in_range2 result__2))) (and (= result__2 0) (< 0 (to_rep (rec__static_discr__holder__length current__split_fields6))))))
