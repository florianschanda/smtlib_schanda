...
(assert (and (= o7 (size (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)))) (in_range6 o7)))
...
(assert (= result4 true))
(assert (and (= o (size (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)))) (in_range6 o)))
(assert (= o1 (+ o 1)))
(assert (and (= o2 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range6 o2)))
