...
(assert (= (bool_eq a1 1 10 (temp_____aggregate_def_4424 t i e) 1 10) true))
...
(assert (=> (< i 10) (=> (< 0 e) (= temp___4436 (temp_____aggregate_def_700 a i e o6 o5)))))
...
(assert (=> (< i 10) (=> (not (= result6 true)) (=> (= e 0) (= temp___4438 (temp_____aggregate_def_709 a i e o4 99))))))
