...
(define-fun to_rep ((x fileentrycountt)) Int (fileentrycounttqtint x))
...
(define-fun dynamic_invariant1 ((temp___expr_1317 Int) (temp___is_init_1313 Bool) (temp___skip_constant_1314 Bool) (temp___do_toplevel_1315 Bool) (temp___do_typ_inv_1316 Bool)) Bool (=> (or (= temp___is_init_1313 true) (<= 0 2)) (in_range3 temp___expr_1317)))
(define-fun dynamic_invariant2 ((temp___expr_1242 Int) (temp___is_init_1238 Bool) (temp___skip_constant_1239 Bool) (temp___do_toplevel_1240 Bool) (temp___do_typ_inv_1241 Bool)) Bool (=> (or (= temp___is_init_1238 true) (<= 0 1024)) (in_range2 temp___expr_1242)))
(declare-const rliteral fileentrycountt)
(assert (= (fileentrycounttqtint rliteral) 0))
...
(assert (= logfileentries1 (store logfileentries index rliteral)))
