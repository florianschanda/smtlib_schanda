...
(assert (and (= o6 (length1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))) (and (in_range5 o6) (<= o6 (capacity (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))))))
(assert (= result (ite (< o6 10000) true false)))
(assert (= result true))
(assert (and (= result1 (has_key1 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (= (= result1 true) (= (has_key1 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem) true))))
(assert (= result1 true))
(assert (and (= o2 (length1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))) (and (in_range5 o2) (<= o2 (capacity (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))))))
(assert (= o3 (- o2 1)))
(assert (and (= o (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range4 o) (= o (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
(assert (= o1 (select f o)))
(assert (= o4 (to_rep5 o1)))
