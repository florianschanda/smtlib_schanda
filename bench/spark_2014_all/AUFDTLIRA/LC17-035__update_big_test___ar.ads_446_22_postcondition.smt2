...
(declare-fun temp_____aggregate_def_1455 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp_____aggregate_def_1461 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
...
(assert (forall ((temp___1457 (Array Int (Array Int (Array Int et1))))) (forall ((temp___1458 Int)) (forall ((temp___1459 (Array Int (Array Int et1)))) (let ((temp___1456 (temp_____aggregate_def_1455 temp___1457 temp___1458 temp___1459))) (=> (dynamic_invariant1 temp___1458 true true true true) (forall ((temp___1460 Int)) (ite (= temp___1460 temp___1458) (= (select temp___1456 temp___1460) temp___1459) (= (select temp___1456 temp___1460) (select temp___1457 temp___1460))))))))))
(assert (forall ((temp___1463 (Array Int (Array Int et1)))) (forall ((temp___1464 Int)) (forall ((temp___1465 (Array Int et1))) (let ((temp___1462 (temp_____aggregate_def_1461 temp___1463 temp___1464 temp___1465))) (=> (dynamic_invariant temp___1464 true true true true) (forall ((temp___1466 Int)) (ite (= temp___1466 temp___1464) (= (select temp___1462 temp___1466) temp___1465) (= (select temp___1462 temp___1466) (select temp___1463 temp___1466))))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq2 a2 1 16 (temp_____aggregate_def_1455 a i (temp_____aggregate_def_1461 (select a i) j b)) 1 16) true)))
(check-sat)
(exit)
