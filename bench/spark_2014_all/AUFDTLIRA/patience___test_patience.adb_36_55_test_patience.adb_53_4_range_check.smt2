...
(assert (= o80 (to_rep3 o79)))
(assert (= o81 (attr__ATTRIBUTE_IMAGE5 o80)))
(assert (= temp___899 (to_string o81)))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 idx2))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 idx2)))))) (= o82 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 idx2))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 idx2)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 idx2))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 idx2))))))) (= o82 0)))
...
(assert (= temp___895 (mk___t (concat1 (temp___String_Literal_891 Tuple0) 1 1 (elts (to_string (attr__ATTRIBUTE_IMAGE4 idx2))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 idx2))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 idx2)))))) (mk 1 o87))))
(assert (=> (= (length temp___895) 0) (= temp___898 (mk___t (temp___String_Literal_894 Tuple0) (mk 1 3)))))
(assert (=> (not (= (length temp___895) 0)) (=> (<= 1 3) (= o88 (+ (- 3 1) 1)))))
(assert (=> (not (= (length temp___895) 0)) (=> (not (<= 1 3)) (= o88 0))))
(assert (=> (not (= (length temp___895) 0)) (=> (<= (to_rep1 (first (rt temp___895))) (to_rep1 (last (rt temp___895)))) (= o89 (+ (- (to_rep1 (last (rt temp___895))) (to_rep1 (first (rt temp___895)))) 1)))))
(assert (=> (not (= (length temp___895) 0)) (=> (not (<= (to_rep1 (first (rt temp___895))) (to_rep1 (last (rt temp___895))))) (= o89 0))))
(assert (=> (not (= (length temp___895) 0)) (= o90 (+ o89 o88))))
(assert (=> (not (= (length temp___895) 0)) (= o91 (+ (to_rep1 (first (rt temp___895))) o90))))
(assert (=> (not (= (length temp___895) 0)) (= o92 (- o91 1))))
(assert (=> (not (= (length temp___895) 0)) (and (= o93 o92) (in_range2 o92))))
(assert (=> (not (= (length temp___895) 0)) (= temp___898 (mk___t (concat1 (elts temp___895) (to_rep1 (first (rt temp___895))) (to_rep1 (last (rt temp___895))) (temp___String_Literal_894 Tuple0) 1 3) (mk (to_rep1 (first (rt temp___895))) o93)))))
(assert (not (= (length temp___898) 0)))
(assert (=> (<= (to_rep1 (first (rt temp___899))) (to_rep1 (last (rt temp___899)))) (= o94 (+ (- (to_rep1 (last (rt temp___899))) (to_rep1 (first (rt temp___899)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___899))) (to_rep1 (last (rt temp___899))))) (= o94 0)))
(assert (=> (<= (to_rep1 (first (rt temp___898))) (to_rep1 (last (rt temp___898)))) (= o95 (+ (- (to_rep1 (last (rt temp___898))) (to_rep1 (first (rt temp___898)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___898))) (to_rep1 (last (rt temp___898))))) (= o95 0)))
(assert (= o96 (+ o95 o94)))
(assert (= o97 (+ (to_rep1 (first (rt temp___898))) o96)))
(assert (= o98 (- o97 1)))
