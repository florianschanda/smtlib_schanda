...
(declare-const ta1 map1)
(declare-const temp___612 Int)
(declare-const temp___610 (Array Int natural))
(declare-const temp___613 (Array Int natural))
(declare-const temp___617 Int)
...
(declare-const ta4 (Array Int natural))
(declare-const ta5 (Array Int natural))
(declare-const index3 Int)
(declare-const ta6 (Array Int natural))
(declare-const index4 Int)
(declare-const ta7 (Array Int natural))
(declare-const index5 Int)
(declare-const ta8 (Array Int natural))
(declare-const index6 Int)
(declare-const result3 map1)
(declare-const ta9 map1)
(assert (= (mk_map__ref1 result) (mk_map__ref1 ta)))
(assert (= ta2 (optional__B_1__ta__aggregate_def 0)))
(assert (= (mk_int__ref result1) (mk_int__ref index)))
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= temp___612 index1)))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= temp___610 ta2)))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= temp___613 ta2)))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= (to_rep2 (select temp___613 index2)) 0)))
(assert (=> (and (<= 1 index1) (<= index1 5)) (and (and (forall ((temp___611 Int)) (=> (and (<= 1 temp___611) (<= temp___611 5)) (=> (or (< 5 temp___611) (or (< temp___611 1) (<= index2 temp___611))) (= (select ta3 temp___611) (select temp___610 temp___611))))) (=> (<= 1 5) (in_range6 index2))) (and (<= 1 index2) (<= index2 5)))))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= ta3 result2)))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= ta4 (store ta3 index2 rliteral1))))
...
(assert (=> (and (<= 1 index1) (<= index1 5)) (= (mk_int__ref index5) (mk_int__ref index3))))
(assert (=> (and (<= 1 index1) (<= index1 5)) (= (mk_map__ref1 ta7) (mk_map__ref1 ta5))))
...
(assert (= result3 ta1))
(assert (= ta9 (optional__B_3__ta__aggregate_def 0)))
(assert (and (= temp___617 (sum_of 2)) (in_range4 temp___617)))
(assert (not (<= temp___617 3)))
(check-sat)
(exit)
