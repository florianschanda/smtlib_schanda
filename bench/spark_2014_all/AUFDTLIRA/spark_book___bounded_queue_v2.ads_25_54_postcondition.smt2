...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__bounded_queue_v2__queue_type__max_size (us_split_discrs1 a))) (to_rep (rec__bounded_queue_v2__queue_type__max_size (us_split_discrs1 b)))) (and (and (and (= (to_rep1 (rec__bounded_queue_v2__queue_type__count (us_split_fields1 a))) (to_rep1 (rec__bounded_queue_v2__queue_type__count (us_split_fields1 b)))) (= (to_rep (rec__bounded_queue_v2__queue_type__front (us_split_fields1 a))) (to_rep (rec__bounded_queue_v2__queue_type__front (us_split_fields1 b))))) (= (to_rep (rec__bounded_queue_v2__queue_type__rear (us_split_fields1 a))) (to_rep (rec__bounded_queue_v2__queue_type__rear (us_split_fields1 b))))) (= (bool_eq1 (rec__bounded_queue_v2__queue_type__items (us_split_fields1 a)) (rec__bounded_queue_v2__queue_type__items (us_split_fields1 b))) true))) true false))
...
(declare-const o5 t)
(declare-const temp___304 positive)
(declare-const temp___3041 natural)
(declare-const temp___3042 positive)
(declare-const temp___3043 positive)
(declare-const temp___3044 (Array Int element_type))
(declare-const temp___3045 t)
...
(assert (= (to_rep o) (to_rep (rec__bounded_queue_v2__queue_type__max_size queue__split_discrs))))
...
(assert (= queue__split_discrs (mk___split_discrs temp___304)))
(assert (= temp___3041 o1))
(assert (= temp___3042 o2))
(assert (= temp___3043 o3))
(assert (= temp___3044 o4))
(assert (= temp___3045 o5))
...
(assert (= queue__split_fields15 (mk___split_fields temp___3041 temp___3042 temp___3043 (mk___t temp___3044 temp___3045))))
(assert (= queue__split_discrs (mk___split_discrs temp___304)))
...
(assert (not (= (size (mk___rep queue__split_discrs (us_split_fields__content queue__split_fields16))) 0)))
(check-sat)
(exit)
