...
(declare-const i Int)
(declare-const temp___696 (Array Int us_rep5))
...
(assert (<= 1 n5))
(assert (<= n5 100))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))) i1))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c100b) i1)))) n6)) (not (= i1 y2))) (= (eq (select (nb_blacks c101b) i1) (select (nb_blacks c100b) i1)) true)))))
...
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___696 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)))) (and (dynamic_invariant5 temp___696 true false true true) (= temp___696 (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))))))))))
(assert (= o28 (select temp___696 i)))
