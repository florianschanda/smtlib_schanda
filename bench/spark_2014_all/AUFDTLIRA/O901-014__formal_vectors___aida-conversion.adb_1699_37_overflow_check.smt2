...
(declare-const temp___2192 Int)
(declare-const o Int)
(declare-const o1 character)
(declare-const o2 Int)
(declare-const o3 Bool)
(declare-const temp___2193 Int)
...
(assert (and (= o8 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (= o11 (ite (<= o8 index) true false)))
(assert (= result (ite (= o11 true) o10 false)))
(assert (= (= o12 true) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 3) index1) (<= index1 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
(assert (and (= temp___2193 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2193) (<= temp___2193 (to_rep1 (last (rt source))))))
(assert (= o4 temp___2193))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (< o6 52) true false)))
(assert (and (= temp___2192 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2192) (<= temp___2192 (to_rep1 (last (rt source))))))
(assert (= o temp___2192))
