...
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i1)) 0) (= o22 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i1)) 0)) (= o22 0)))
(assert (= o23 (+ o22 o21)))
(assert (and (= o24 o23) (in_range7 o23)))
(assert (= o25 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (map__content4 red_black_trees__nb_blacks__result4) i1)))) o24) true false)))
