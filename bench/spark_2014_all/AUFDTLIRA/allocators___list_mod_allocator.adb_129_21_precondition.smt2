...
(declare-fun add1 (us_rep1 Int) us_rep1)
(declare-fun add__function_guard1 (us_rep1 us_rep1 Int) Bool)
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (and (dynamic_invariant3 item true true true true) (and (not (= (contains container item) true)) (< (length1 container) 2147483647))) (let ((result (add1 container item))) (and (and (and (= (length1 result) (+ (length1 container) 1)) (= (contains result item) true)) (= (ole1 container result) true)) (= (included_except result container item) true)))) :pattern ((add1 container item))))))
(declare-fun remove (us_rep1 Int) us_rep1)
(declare-fun remove__function_guard (us_rep1 us_rep1 Int) Bool)
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (and (dynamic_invariant3 item true true true true) (= (contains container item) true)) (let ((result (remove container item))) (and (and (and (= (length1 result) (- (length1 container) 1)) (not (= (contains result item) true))) (= (ole1 result container) true)) (= (included_except container result item) true)))) :pattern ((remove container item))))))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 a))) (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 b)))) (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 a))) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 b))))) true false))
...
(define-fun bool_eq3 ((a (Array Int us_rep2)) (a__first Int) (a__last Int) (b (Array Int us_rep2)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (bool_eq2 (select a temp___idx_154) (select b (+ (- b__first a__first) temp___idx_154))) true)))) true false))
(assert (forall ((a (Array Int us_rep2)) (b (Array Int us_rep2))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (bool_eq2 (select a temp___idx_154) (select b (+ (- b__first a__first) temp___idx_154))) true))))))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-fun is_well_formed ((Array Int us_rep2) Int) Bool)
(declare-fun is_well_formed__function_guard (Bool (Array Int us_rep2) Int) Bool)
(assert true)
(assert (forall ((list_mod_allocator__data (Array Int us_rep2))) (forall ((list_mod_allocator__first_available Int)) (! (= (= (is_well_formed list_mod_allocator__data list_mod_allocator__first_available) true) (and (=> (not (= list_mod_allocator__first_available 0)) (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select list_mod_allocator__data list_mod_allocator__first_available)))) 0)) (forall ((r Int)) (=> (and (<= 1 r) (<= r 10000)) (=> (and (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select list_mod_allocator__data r)))) 0) (not (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select list_mod_allocator__data r)))) 0))) (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select list_mod_allocator__data (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select list_mod_allocator__data r)))))))) 0)))))) :pattern ((is_well_formed list_mod_allocator__data list_mod_allocator__first_available))))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__list_mod_allocator__m__t__available us_rep) (rec__list_mod_allocator__m__t__allocated us_rep1)))))
(define-fun us_split_fields_Available__projection ((a us_split_fields2)) us_rep (rec__list_mod_allocator__m__t__available a))
(define-fun us_split_fields_Allocated__projection ((a us_split_fields2)) us_rep1 (rec__list_mod_allocator__m__t__allocated a))
...
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (user_eq1 (rec__list_mod_allocator__m__t__available (us_split_fields3 a)) (rec__list_mod_allocator__m__t__available (us_split_fields3 b))) true) (= (bool_eq1 (rec__list_mod_allocator__m__t__allocated (us_split_fields3 a)) (rec__list_mod_allocator__m__t__allocated (us_split_fields3 b))) true)) true false))
...
(declare-fun model_is_well_formed (us_rep3 (Array Int us_rep2) Int) Bool)
(declare-fun model_is_well_formed__function_guard (Bool us_rep3 (Array Int us_rep2) Int) Bool)
...
(assert true)
(assert (forall ((m us_rep3)) (forall ((list_mod_allocator__data (Array Int us_rep2))) (forall ((list_mod_allocator__first_available Int)) (! (= (= (model_is_well_formed m list_mod_allocator__data list_mod_allocator__first_available) true) (and (and (and (and (and (and (and (<= (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m))) 10000) (ite (not (= list_mod_allocator__first_available 0)) (and (< 0 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (= (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) 1) list_mod_allocator__first_available)) (= (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m))) 0))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))) (and (in_range8 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) j)) (=> (< j (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select list_mod_allocator__data (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) j))))) (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) (+ j 1)))))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))) (=> (< 1 j) (and (in_range8 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) (- j 1))) (= (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) j) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select list_mod_allocator__data (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) (- j 1)))))))))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))) (=> (= (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) j) (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) k)) (= j k))))))) (=> (and (not (= list_mod_allocator__first_available 0)) (in_range8 (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select list_mod_allocator__data (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))))))))) (= (contains1 (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select list_mod_allocator__data (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))))))) true))) (forall ((e Int)) (=> (and (in_range5 e) (= (contains (rec__list_mod_allocator__m__t__allocated (us_split_fields3 m)) e) true)) (in_range8 e)))) (forall ((r Int)) (=> (and (<= 1 r) (<= r 10000)) (ite (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select list_mod_allocator__data r)))) 0) (not (= (contains (rec__list_mod_allocator__m__t__allocated (us_split_fields3 m)) r) true)) (and (not (= (contains1 (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) r) true)) (= (contains (rec__list_mod_allocator__m__t__allocated (us_split_fields3 m)) r) true))))))) :pattern ((model_is_well_formed m list_mod_allocator__data list_mod_allocator__first_available)))))))
...
(assert (forall ((left us_rep1) (right us_rep1)) (! (= (= (ole1 left right) true) (forall ((item Int)) (=> (and (in_range5 item) (= (contains left item) true)) (= (contains right item) true)))) :pattern ((ole1 left right)))))
...
(assert (forall ((left us_rep1) (right us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range5 e) (= (contains left e) true)) (or (= (contains right e) true) (= e item)))))) :pattern ((included_except left right item))))))
(declare-const data (Array Int us_rep2))
(declare-const first_available Int)
(declare-const avail us_rep)
(declare-const alloc us_rep1)
(declare-const unseen us_rep1)
(declare-const r Int)
(declare-const r1 Int)
(declare-const temp___329 Int)
(declare-const temp___328 us_rep1)
(declare-const temp___327 us_rep1)
...
(assert (= r2 1))
(assert (=> (and (<= 1 r2) (<= r2 10000)) (= temp___329 r2)))
(assert (=> (and (<= 1 r2) (<= r2 10000)) (= temp___328 unseen)))
(assert (=> (and (<= 1 r2) (<= r2 10000)) (= temp___327 alloc)))
(assert (=> (and (<= 1 r2) (<= r2 10000)) (forall ((e Int)) (=> (and (in_range5 e) (= (contains alloc2 e) true)) (and (<= 1 e) (<= e (- r3 1)))))))
(assert (=> (and (<= 1 r2) (<= r2 10000)) (forall ((e Int)) (=> (and (in_range5 e) (= (contains unseen2 e) true)) (and (<= 1 e) (<= e (- r3 1)))))))
...
(assert (=> (and (<= 1 r2) (<= r2 10000)) (and (=> (<= 1 10000) (in_range8 r3)) (and (<= 1 r3) (<= r3 10000)))))
...
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length avail2))) (in_range8 (get avail2 j1)))))
(assert (= r10 (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data (get avail2 (length avail2))))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- (length avail2) 1))) (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data (get avail2 j1))))) (get avail2 (+ j1 1))))))
(assert (forall ((j1 Int)) (=> (and (<= 2 j1) (<= j1 (length avail2))) (= (get avail2 j1) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data (get avail2 (- j1 1))))))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length avail2))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (length avail2))) (=> (= (get avail2 j1) (get avail2 k)) (= j1 k)))))))
...
(assert (=> (<= 0 10000) (in_range6 r10)))
(assert (and (= o13 (length avail2)) (and (in_range2 o13) (<= (+ 0 o13) 2147483647))))
(assert (= o14 (ite (<= j o13) true false)))
(assert (= result8 (ite (<= 2 j) o14 false)))
(assert (= result8 true))
(assert (and (= temp___335 (get avail2 (- j 1))) (in_range3 temp___335)))
(assert (and (<= 1 temp___335) (<= temp___335 10000)))
(assert (= o15 temp___335))
(assert (= (mk___rep (mk___split_fields o16 o17)) (select data o15)))
(assert (= o16 o18))
(assert (= o17 o19))
(assert (= o20 o19))
(assert (= o21 (to_rep o20)))
(assert (not (<= j (last avail2))))
(check-sat)
(exit)
