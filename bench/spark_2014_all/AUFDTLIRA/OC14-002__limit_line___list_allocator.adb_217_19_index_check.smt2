...
(assert (= data1 o36))
(assert (not (= prev_alloc1 0)))
(assert (= (to_rep o37) next_alloc1))
(assert (= (rec__list_allocator__cell__stat (us_split_fields3 (select data1 prev_alloc1))) o38))
(assert (= (rec__list_allocator__cell__prev (us_split_fields3 (select data1 prev_alloc1))) o39))
(assert (= o37 o40))
(assert (= o41 o38))
(assert (= o42 o39))
(assert (= o43 o40))
(assert (not (<= prev_alloc1 3)))
(check-sat)
(exit)
