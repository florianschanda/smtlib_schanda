...
(assert (= index2 first))
(assert (=> (and (<= first index2) (<= index2 last)) (= temp___300 index2)))
(assert (=> (and (<= first index2) (<= index2 last)) (= temp___299 min1)))
...
(assert (not (<= sort__index_of_minimum__result4 last)))
(check-sat)
(exit)
