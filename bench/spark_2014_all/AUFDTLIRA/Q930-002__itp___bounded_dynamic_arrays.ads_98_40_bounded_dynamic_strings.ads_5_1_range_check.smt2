...
(define-fun o19 () us_rep (mk___rep (mk___split_discrs o10) (mk___split_fields o11 (mk___t1 o12 o13))))
(define-fun o20 () us_t2 (mk___t2 o8 o9))
...
(assert (and (= o19 (instance o1 o20)) (and (dynamic_invariant1 o19 true false true true) (and (and (= (to_rep2 o10) o1) (= (length2 o19) (length3 o20))) (= (let ((temp___274 (value o19))) (bool_eq (elts2 temp___274) (to_rep1 (first4 (rt2 temp___274))) (to_rep1 (last4 (rt2 temp___274))) o8 (to_rep1 (first4 o9)) (to_rep1 (last4 o9)))) true)))))
...
(assert (and (= o15 (length2 right)) (and (in_range4 o15) (= o15 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))))
(assert (and (= o16 (length3 left)) (in_range1 (length3 left))))
(assert (= o17 (+ o16 o15)))
