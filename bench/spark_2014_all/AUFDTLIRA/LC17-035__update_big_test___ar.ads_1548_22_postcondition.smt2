...
(assert (= i1 i2))
(assert (not (= (bool_eq2 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp_____aggregate_def_3248 r__split_fields i1 (temp_____aggregate_def_3254 (select r__split_fields i1) j1 e j2 f)) r__split_fields1))) true)))
(check-sat)
(exit)
