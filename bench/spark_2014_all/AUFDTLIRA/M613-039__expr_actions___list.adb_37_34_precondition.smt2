...
(assert (=> (= result4 true) (= temp___520 (mk___t2 o9 (mk2 first2 temp___518)))))
...
(assert (=> (= result4 true) (= temp___519 (mk___t1 o10 (mk1 first2 temp___517)))))
