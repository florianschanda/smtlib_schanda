...
(define-fun dynamic_invariant1 ((temp___expr_670 Int) (temp___is_init_666 Bool) (temp___skip_constant_667 Bool) (temp___do_toplevel_668 Bool) (temp___do_typ_inv_669 Bool)) Bool (=> (or (= temp___is_init_666 true) (<= 0 100)) (in_range4 temp___expr_670)))
...
(define-fun dynamic_invariant2 ((temp___expr_684 us_t) (temp___is_init_680 Bool) (temp___skip_constant_681 Bool) (temp___do_toplevel_682 Bool) (temp___do_typ_inv_683 Bool)) Bool (=> (not (= temp___skip_constant_681 true)) (dynamic_property 0 255 (first1 temp___expr_684) (last1 temp___expr_684))))
