...
(assert (not (exists ((k Int)) (and (and (<= 1 k) (<= k (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (= (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j)) (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 (table__content simple_unc_arrays__bubble_sort__result6)))) k)))))))
(check-sat)
(exit)
