...
(declare-fun temp_____aggregate_def_479 (Int Int Int) (Array Int unsigned_byte))
...
(assert (= (unsigned_byteqtint rliteral2) 8))
(assert (forall ((temp___481 Int) (temp___482 Int) (temp___483 Int)) (let ((temp___480 (temp_____aggregate_def_479 temp___481 temp___482 temp___483))) (=> (and (and (dynamic_invariant temp___481 true true true true) (dynamic_invariant temp___482 true true true true)) (dynamic_invariant temp___483 true true true true)) (forall ((temp___484 Int)) (ite (= temp___484 7) (= (select temp___480 temp___484) rliteral) (ite (= temp___484 2) (= (select temp___480 temp___484) rliteral1) (= (select temp___480 temp___484) rliteral2))))))))
...
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_479 2 10 8)))
(assert (not (= (to_rep (select x1 7)) 2)))
(check-sat)
(exit)
