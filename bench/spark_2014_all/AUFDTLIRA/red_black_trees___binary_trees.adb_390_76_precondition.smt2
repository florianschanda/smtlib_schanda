...
(assert (= (mk___rep2 (mk___split_fields2 o15 o16)) (select temp___1176 j)))
(assert (= o15 o17))
(assert (= o16 o18))
(assert (= result4 o18))
...
(assert (=> (= result4 true) (= (mk___rep2 (mk___split_fields2 o10 o11)) (select temp___1178 j))))
...
(assert (=> (= result4 true) (= (mk___rep2 (mk___split_fields2 o5 o6)) (select temp___1177 i))))
