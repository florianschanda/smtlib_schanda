...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__stacks__stack__max (us_split_discrs1 a))) (to_rep (rec__stacks__stack__max (us_split_discrs1 b)))) (and (= (to_rep1 (rec__stacks__stack__top (us_split_fields1 a))) (to_rep1 (rec__stacks__stack__top (us_split_fields1 b)))) (= (bool_eq1 (rec__stacks__stack__data (us_split_fields1 a)) (rec__stacks__stack__data (us_split_fields1 b))) true))) true false))
...
(assert (forall ((s us_rep)) (! (= (= (is_full s) true) (= (size s) (to_rep (rec__stacks__stack__max (us_split_discrs1 s))))) :pattern ((is_full s)))))
...
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant s true true true true) (dynamic_invariant1 (size s) true false true true)) :pattern ((size s)))))
(assert (forall ((attr__tag1 Int)) (forall ((s us_rep)) (! (=> (dynamic_invariant s true true true true) (dynamic_invariant1 (size1 attr__tag1 s) true false true true)) :pattern ((size1 attr__tag1 s))))))
(assert (forall ((s us_rep)) (! (= (size s) (size1 us_tag s)) :pattern ((size1 us_tag s)))))
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant s true true true true) (= (size s) (to_rep1 (rec__stacks__stack__top (us_split_fields1 s))))) :pattern ((size s)))))
...
(define-fun dynamic_invariant2 ((temp___expr_160 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 0 1)) (in_range5 temp___expr_160)))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant3 ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_167)))
...
(assert (dynamic_invariant (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2) s__split_fields3) s__attr__tag) true false true true))
(assert (in_range4 e))
(assert (in_range5 mystate))
(assert (and (dynamic_invariant (mk___rep s__split_discrs (mk___split_fields s__split_fields4 (mk___t s__split_fields5 s__split_fields6) s__split_fields7) s__attr__tag) true true true true) (in_range5 mystate1)))
