...
(assert (= result3 fixed_string__null_string__result8))
(assert (= result4 fixed_string__null_string__result9))
(assert (not (= (length (mk___t fixed_string__null_string__result8 fixed_string__null_string__result9)) (elements this))))
(check-sat)
(exit)
