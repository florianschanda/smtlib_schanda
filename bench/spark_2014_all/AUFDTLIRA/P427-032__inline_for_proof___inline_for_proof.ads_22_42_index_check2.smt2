...
(assert (= inline_for_proof__get2__result1 inline_for_proof__get2__result2))
(assert (= inline_for_proof__get2__result3 inline_for_proof__get2__result1))
...
(assert (= (mk_int__ref result) (mk_int__ref inline_for_proof__get2__result)))
(assert (= inline_for_proof__get2__result1 o4))
(assert (= (mk_int__ref inline_for_proof__get2__result4) (mk_int__ref inline_for_proof__get2__result2)))
(assert (= inline_for_proof__get2__result5 inline_for_proof__get2__result3))
(assert (= b true))
(assert (not (<= 1 i)))
(check-sat)
(exit)
