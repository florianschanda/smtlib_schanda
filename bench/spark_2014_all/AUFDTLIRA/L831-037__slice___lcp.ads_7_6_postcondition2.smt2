...
(assert (=> (= result1 true) (and (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 r6b3)) (=> (<= 0 2147483647) (in_range2 l2))) (=> (<= (- 2147483648) 2147483647) (in_range1 r9b3))) (= (- (+ x l2) 1) r6b3)) (= (- (+ y l2) 1) r9b3))))
...
(assert (= r6b9 r6b7))
(assert (= l9 l7))
(assert (=> (= (not (= (to_rep (select (elts a) x)) (to_rep (select (elts a) y)))) true) (= (int__content lcp__result4) 0)))
(assert (=> (= (= x y) true) (= (int__content lcp__result4) (+ (- (to_rep (last (rt a))) x) 1))))
(assert (=> (not (= (ite (= (not (= (to_rep (select (elts a) x)) (to_rep (select (elts a) y)))) false) (= x y) true) true)) (< 0 (int__content lcp__result4))))
(assert (= result12 (int__content lcp__result4)))
(assert (not (= (bool_eq (elts a) (to_rep (first2 (mk1 x (- (+ x (int__content lcp__result4)) 1)))) (to_rep (last2 (mk1 x (- (+ x (int__content lcp__result4)) 1)))) (elts a) (to_rep (first4 (mk2 y (- (+ y (int__content lcp__result4)) 1)))) (to_rep (last4 (mk2 y (- (+ y (int__content lcp__result4)) 1))))) true)))
(check-sat)
(exit)
