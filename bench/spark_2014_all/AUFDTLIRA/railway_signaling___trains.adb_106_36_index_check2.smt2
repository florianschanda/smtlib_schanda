...
(assert (and (= o11 (get_previous_track o18 id1)) (and (in_range3 o11) (= o11 (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 o10)))))) id1))))))
...
(assert (and (= temp___407 (get_previous_track o17 id1)) (and (in_range3 temp___407) (= temp___407 (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 o16)))))) id1))))))
(assert (not (<= 1 temp___407)))
(check-sat)
(exit)
