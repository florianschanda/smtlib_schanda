...
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (not (= (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j)) v)))))
(assert (and (and (=> (<= 0 2147483647) (in_range1 pos2)) (=> (<= 1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))) (dynamic_property2 1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2))) (and (<= 1 i2) (<= i2 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))))
