...
(assert (and (= rr_type__convertdomainnametowire__L_6__C21b__assume o1) (in_range4 o1)))
(assert (= rr_type__convertdomainnametowire__L_6__C21b__assume c21b))
(assert (in_range4 c21b))
(assert (=> (<= 0 255) (in_range2 c22b)))
(assert (=> (<= 1 256) (in_range4 result__)))
...
(assert (=> (= result4 true) (= temp___370 result__1)))
(assert (=> (= result4 true) (and (<= c21b result__2) (< result__2 256))))
(assert (=> (= result4 true) (and (=> (<= 1 256) (in_range4 result__2)) (and (< result__2 128) (not (= (to_rep (select domainnameversion result__2)) 46))))))
(assert (=> (= result4 true) (and (= o6 (+ result__2 1)) (in_range4 (+ result__2 1)))))
...
(assert (not (in_range2 (- result__6 c21b))))
(check-sat)
(exit)
