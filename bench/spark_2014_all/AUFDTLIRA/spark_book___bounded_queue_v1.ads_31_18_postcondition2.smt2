...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__bounded_queue_v1__queue_type__max_size (us_split_discrs1 a))) (to_rep (rec__bounded_queue_v1__queue_type__max_size (us_split_discrs1 b)))) (and (and (and (= (to_rep1 (rec__bounded_queue_v1__queue_type__count (us_split_fields1 a))) (to_rep1 (rec__bounded_queue_v1__queue_type__count (us_split_fields1 b)))) (= (to_rep (rec__bounded_queue_v1__queue_type__front (us_split_fields1 a))) (to_rep (rec__bounded_queue_v1__queue_type__front (us_split_fields1 b))))) (= (to_rep (rec__bounded_queue_v1__queue_type__rear (us_split_fields1 a))) (to_rep (rec__bounded_queue_v1__queue_type__rear (us_split_fields1 b))))) (= (bool_eq1 (rec__bounded_queue_v1__queue_type__items (us_split_fields1 a)) (rec__bounded_queue_v1__queue_type__items (us_split_fields1 b))) true))) true false))
...
(define-fun dynamic_invariant4 ((temp___expr_169 Int) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool) (temp___do_typ_inv_168 Bool)) Bool (=> (or (= temp___is_init_165 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_169)))
...
(declare-const temp___3171 natural)
(declare-const temp___3172 positive)
(declare-const temp___3173 positive)
(declare-const temp___3174 (Array Int element_type))
(declare-const temp___3175 t)
...
(declare-const queue__split_fields10 natural)
(declare-const queue__split_fields11 positive)
(declare-const queue__split_fields12 positive)
(declare-const queue__split_fields13 (Array Int element_type))
(declare-const queue__split_fields14 t)
...
(declare-const queue__split_fields15 us_split_fields)
(declare-const queue__split_fields16 us_split_fields__ref)
(declare-const queue__split_fields17 us_split_fields)
...
(assert (= result queue__split_fields))
(assert (= result1 queue__split_fields1))
(assert (= result2 queue__split_fields2))
(assert (= result3 queue__split_fields3))
(assert (= result4 queue__split_fields4))
(assert (= rliteral queue__split_fields5))
(assert (= queue__split_fields1 queue__split_fields6))
(assert (= queue__split_fields2 queue__split_fields7))
(assert (= queue__split_fields3 queue__split_fields8))
(assert (= queue__split_fields4 queue__split_fields9))
(assert (= result5 queue__split_fields5))
(assert (= result6 queue__split_fields6))
(assert (= result7 queue__split_fields7))
(assert (= result8 queue__split_fields8))
(assert (= result9 queue__split_fields9))
(assert (= queue__split_fields5 queue__split_fields10))
(assert (= rliteral1 queue__split_fields11))
(assert (= queue__split_fields7 queue__split_fields12))
(assert (= queue__split_fields8 queue__split_fields13))
(assert (= queue__split_fields9 queue__split_fields14))
(assert (= (to_rep o) (to_rep (rec__bounded_queue_v1__queue_type__max_size queue__split_discrs))))
(assert (= queue__split_fields10 o1))
(assert (= queue__split_fields11 o2))
(assert (= o o3))
(assert (= queue__split_fields13 o4))
(assert (= queue__split_fields14 o5))
(assert (= queue__split_discrs (mk___split_discrs temp___317)))
(assert (= temp___3171 o1))
(assert (= temp___3172 o2))
(assert (= temp___3173 o3))
(assert (= temp___3174 o4))
(assert (= temp___3175 o5))
(assert (= result10 queue__split_fields10))
(assert (= result11 queue__split_fields11))
(assert (= result12 queue__split_fields12))
(assert (= result13 queue__split_fields13))
(assert (= result14 queue__split_fields14))
(assert (= queue__split_fields15 (mk___split_fields temp___3171 temp___3172 temp___3173 (mk___t temp___3174 temp___3175))))
(assert (= queue__split_discrs (mk___split_discrs temp___317)))
(assert (= queue__split_fields16 (mk___split_fields__ref queue__split_fields15)))
(assert (= queue__split_fields17 queue__split_fields15))
(assert (not (= (empty (mk___rep queue__split_discrs (us_split_fields__content queue__split_fields16))) true)))
(check-sat)
(exit)
