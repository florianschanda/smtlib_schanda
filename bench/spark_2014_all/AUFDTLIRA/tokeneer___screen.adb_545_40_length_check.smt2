...
(assert (not (= (ite (<= (to_rep1 (first8 temp___20311)) (to_rep1 (last8 temp___20311))) (+ (- (to_rep1 (last8 temp___20311)) (to_rep1 (first8 temp___20311))) 1) 0) (ite (<= 1 (- (to_rep1 data__last) 1)) (+ (- (- (to_rep1 data__last) 1) 1) 1) 0))))
(check-sat)
(exit)
