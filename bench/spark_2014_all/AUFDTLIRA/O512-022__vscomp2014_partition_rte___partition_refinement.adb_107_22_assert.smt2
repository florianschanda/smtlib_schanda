...
(assert (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c) true))
(assert (= (key (mk___rep d__split_discrs d__split_fields2) c) (to_rep (select a1 j))))
(assert (not (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c))) (key (mk___rep d__split_discrs d__split_fields2) c))))
(check-sat)
(exit)
