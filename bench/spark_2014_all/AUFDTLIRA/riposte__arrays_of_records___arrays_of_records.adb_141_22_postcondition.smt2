...
(assert (not (= i j)))
(assert (= result a))
(assert (= a1 (store a i (mk___rep (mk___split_fields (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a i))) rliteral (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a i))))))))
(assert (= result1 a1))
(assert (= a2 (store a1 j (mk___rep (mk___split_fields (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a1 j))) rliteral1 (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a1 j))))))))
(assert (= a2 a3))
(assert (= a4 a2))
