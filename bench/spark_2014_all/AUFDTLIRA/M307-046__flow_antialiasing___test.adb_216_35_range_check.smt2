...
(declare-const temp___461 (Array Int character))
...
(assert (=> (<= 1 3) (and (and (<= (to_rep1 a__first) 1) (<= 1 (to_rep1 a__last))) (and (<= (to_rep1 a__first) 3) (<= 3 (to_rep1 a__last))))))
(assert (= temp___461 a))
(assert (= test__op_string_io_i__x__compl temp___461))
(assert (<= 1 3))
(assert (not (<= 1 (to_rep1 b__last))))
(check-sat)
(exit)
