...
(declare-const temp___209 (Array Int integer))
(declare-const temp___2091 t1)
...
(assert (and (= temp___207 (- (to_rep values__last) 1)) (in_range1 (- (to_rep values__last) 1))))
(assert (= result current))
(assert (= current1 (to_rep values__first)))
(assert (<= (to_rep values__first) current1))
(assert (<= current1 temp___207))
...
(assert (= o values))
(assert (= o temp___209))
(assert (= (mk1 current1 (to_rep values__last)) temp___2091))
(assert (= temp___209 o1))
(assert (= (mk (to_rep (first2 temp___2091)) (to_rep (last2 temp___2091))) o2))
...
(assert (=> (not (= smallest1 current1)) (= (let ((temp___174 (temp_____aggregate_def_164 (mk___t values (mk (to_rep values__first) (to_rep values__last))) o4 (to_rep (select values smallest1)) smallest1 (to_rep (select values o4))))) (bool_eq o5 (to_rep values__first) (to_rep values__last) (elts temp___174) (to_rep (first (rt temp___174))) (to_rep (last (rt temp___174))))) true)))
(assert (=> (not (not (= smallest1 current1))) (= o5 values)))
(assert (=> (not (not (= smallest1 current1))) (= o5 values1)))
...
(assert (and (and (=> (<= (to_rep values__first) (- (to_rep values__last) 1)) (dynamic_property1 (to_rep values__first) (- (to_rep values__last) 1) current2)) (=> (<= 1 2147483647) (in_range2 smallest2))) (and (<= (to_rep values__first) current2) (<= current2 (- (to_rep values__last) 1)))))
