...
(assert (= o62 (select temp___1605 i2)))
(assert (= o63 (us_split_fields5 o62)))
(assert (= o64 (rec__tree_model__path_type__a o63)))
(assert (and (= o65 (length o64)) (and (in_range2 o65) (<= (+ 0 o65) 2147483647))))
(assert (= o66 (+ o65 1)))
(assert (and (= o67 o66) (in_range8 o66)))
