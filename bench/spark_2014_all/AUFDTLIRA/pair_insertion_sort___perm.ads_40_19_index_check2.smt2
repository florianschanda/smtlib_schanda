...
(assert (and (= perm__occ_set__b__assume2 (remove_last a)) (and (dynamic_invariant1 perm__occ_set__b__assume2 true false true true) (and (= (elts a) perm__occ_set__b__assume) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1))))) perm__occ_set__b__assume1)))))
