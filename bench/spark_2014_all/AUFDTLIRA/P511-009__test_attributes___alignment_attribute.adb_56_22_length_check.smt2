...
(assert (forall ((temp___293 Int) (temp___294 Int) (temp___295 Int)) (let ((temp___292 (alignment_attribute__q__a1__aggregate_def temp___293 temp___294 temp___295))) (=> (dynamic_invariant temp___293 true true true true) (and (=> (dynamic_property4 1 x temp___294 temp___295) (and (= (first3 temp___292) temp___294) (= (last3 temp___292) temp___295))) (forall ((temp___296 Int)) (= (select (to_array1 temp___292) temp___296) rliteral)))))))
