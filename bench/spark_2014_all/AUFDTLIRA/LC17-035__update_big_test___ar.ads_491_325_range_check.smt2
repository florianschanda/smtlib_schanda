...
(assert (= a4 a2))
(assert (< k 16))
(assert (=> (< 0 e) (and (= o13 (- e 1)) (in_range4 (- e 1)))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o12 (+ k 1))))
(assert (=> (< 0 e) (= temp___5570 (select a o12))))
(assert (=> (< 0 e) (= o14 (select temp___5570 j))))
(assert (=> (< 0 e) (= o15 (temp_____aggregate_def_1904 o14 i o13))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o11 (+ k 1))))
(assert (=> (< 0 e) (= o16 (select a o11))))
(assert (=> (< 0 e) (= o17 (temp_____aggregate_def_1897 o16 j o15))))
(assert (=> (< 0 e) (and (= o18 (+ k 1)) (in_range3 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5571 (temp_____aggregate_def_1874 a k (temp_____aggregate_def_1882 (select a k) j (temp_____aggregate_def_1889 (select (select a k) j) i e)) o18 o17))))
...
(assert (= o6 (+ k 1)))
(assert (= temp___5580 (select a o6)))
(assert (= o7 (select temp___5580 j)))
(assert (= o8 (temp_____aggregate_def_1943 o7 i 99)))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o5 (+ k 1)))
(assert (= o9 (select a o5)))
(assert (= o10 (temp_____aggregate_def_1936 o9 j o8)))
(assert (not (in_range3 (+ k 1))))
(check-sat)
(exit)
