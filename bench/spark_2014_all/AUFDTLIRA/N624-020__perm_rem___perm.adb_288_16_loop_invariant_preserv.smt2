...
(assert (and (= o (extended_perm aa bb)) (and (in_range4 o) (=> (= (distinct o 0) true) (forall ((ia4 Int)) (=> (and (<= (to_rep1 (first (rt aa))) ia4) (<= ia4 (to_rep1 (last (rt aa))))) (exists ((ib1 Int)) (and (and (<= (to_rep1 (first (rt bb))) ib1) (<= ib1 (to_rep1 (last (rt bb))))) (and (= (to_rep (select (elts aa) ia4)) (to_rep (select (elts bb) ib1))) (= (is_perm (remove aa ia4) (remove bb ib1)) true))))))))))
...
(assert (exists ((ib1 Int)) (and (and (<= (to_rep1 (first (rt b))) ib1) (<= ib1 (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib1))) (= (is_perm (remove a ia1) (remove b ib1)) true)))))
(assert (=> (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (dynamic_property1 (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) ia1)))
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k ia2)) (exists ((ib1 Int)) (and (and (<= (to_rep1 (first (rt b))) ib1) (<= ib1 (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) k)) (to_rep (select (elts b) ib1))) (= (is_perm (remove a k) (remove b ib1)) true)))))))
...
(assert (= ia3 (+ ia2 1)))
(assert (exists ((ib1 Int)) (and (and (<= (to_rep1 (first (rt b))) ib1) (<= ib1 (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) ia3)) (to_rep (select (elts b) ib1))) (= (is_perm (remove a ia3) (remove b ib1)) true)))))
(assert (=> (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (dynamic_property1 (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) ia3)))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k ia3))
(assert (not (exists ((ib1 Int)) (and (and (<= (to_rep1 (first (rt b))) ib1) (<= ib1 (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) k)) (to_rep (select (elts b) ib1))) (= (is_perm (remove a k) (remove b ib1)) true))))))
(check-sat)
(exit)
