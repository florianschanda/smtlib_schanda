...
(assert (= o6 my_package__swap__y))
(assert (and (= o7 (to_rep1 (select a1 1))) (in_range (to_rep1 (select a1 1)))))
(assert (= o7 my_package__swap__x))
(assert (and (in_range my_package__swap__x1) (in_range my_package__swap__y1)))
(assert (and (= o8 my_package__swap__x1) (in_range1 my_package__swap__x1)))
(assert (= (to_rep1 o9) o8))
(assert (= o10 (store a1 1 o9)))
(assert (= result9 (mk_map__ref a1)))
(assert (= a2 o10))
(assert (not (in_range1 my_package__swap__y1)))
(check-sat)
(exit)
