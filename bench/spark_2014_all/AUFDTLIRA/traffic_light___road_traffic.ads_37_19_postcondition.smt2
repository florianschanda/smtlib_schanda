...
(declare-fun temp_____aggregate_def_221 ((Array Int light) Int Int) (Array Int light))
...
(assert (forall ((temp___223 (Array Int light))) (forall ((temp___224 Int) (temp___225 Int)) (let ((temp___222 (temp_____aggregate_def_221 temp___223 temp___224 temp___225))) (=> (and (dynamic_invariant temp___224 true true true true) (dynamic_invariant1 temp___225 true true true true)) (forall ((temp___226 Int)) (ite (= temp___226 temp___224) (= (to_rep1 (select temp___222 temp___226)) temp___225) (= (select temp___222 temp___226) (select temp___223 temp___226)))))))))
...
(assert (in_range1 p))
(assert (and (= (safety_property l conflicts) true) (= (to_rep1 (select l p)) 1)))
(assert (= (to_rep1 o) 0))
...
(assert (= l1 l2))
(assert (= l3 l1))
(assert (not (= (bool_eq2 l2 0 3 (temp_____aggregate_def_221 l p 0) 0 3) true)))
(check-sat)
(exit)
