...
(assert (=> (<= y r9b2) (and (and (<= (to_rep (first (rt a))) y) (<= y (to_rep (last (rt a))))) (and (<= (to_rep (first (rt a))) r9b2) (<= r9b2 (to_rep (last (rt a))))))))
(assert (= o14 (elts a)))
(assert (= temp___195 o14))
(assert (= temp___1951 (mk4 y r9b2)))
(assert (<= x r6b2))
