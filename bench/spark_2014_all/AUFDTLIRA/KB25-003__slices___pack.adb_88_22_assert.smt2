...
(assert (forall ((i tTaSP1)) (and (<= 7 (tTaSP1qtint i)) (<= (tTaSP1qtint i) 10))))
...
(assert (= (to_rep o1) 10))
(assert (= (to_rep o) 7))
(assert (forall ((j Int)) (=> (and (<= (to_rep o) j) (<= j (to_rep o1))) (= (to_rep (select pack__init__a j)) 1))))
(assert (= result a))
(assert (= a1 (slide pack__init__a (to_rep (first (mk 7 10))) 7)))
(assert (not (= (to_rep (select a1 8)) 1)))
(check-sat)
(exit)
