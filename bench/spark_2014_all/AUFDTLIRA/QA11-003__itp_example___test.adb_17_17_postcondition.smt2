...
(declare-const test__test_2__result Int)
(declare-const o Int)
(declare-const o1 character)
(declare-const o2 Int)
(declare-const result Int)
(declare-const test__test_2__result1 Int)
(declare-const test__test_2__result2 Int)
(declare-const test__test_2__result3 Int)
(declare-const test__test_2__result4 Int)
(declare-const test__test_2__result5 Int)
(declare-const result1 Int)
(assert (dynamic_invariant a true false true true))
(assert (= test__test_2__result1 test__test_2__result2))
(assert (= test__test_2__result3 test__test_2__result1))
(assert (and (<= (to_rep1 (first (rt a))) 1) (<= 1 (to_rep1 (last (rt a))))))
(assert (= o 1))
(assert (= o1 (select (elts a) o)))
(assert (= o2 (to_rep o1)))
(assert (= result test__test_2__result))
(assert (= test__test_2__result1 o2))
(assert (= (mk_int__ref test__test_2__result4) (mk_int__ref test__test_2__result2)))
(assert (= test__test_2__result5 test__test_2__result3))
(assert (= result1 test__test_2__result4))
(assert (not (= test__test_2__result4 97)))
(check-sat)
(exit)
