...
(assert (forall ((x natural_index)) (! (in_range3 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun dynamic_invariant5 ((temp___expr_206 us_t1) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool (=> (not (= temp___skip_constant_203 true)) (dynamic_property2 1 2147483647 (first3 temp___expr_206) (last3 temp___expr_206))))
(assert (dynamic_invariant1 i52s true false true true))
(assert (dynamic_invariant1 this true false true true))
(assert (<= 1 (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this)))))
(assert (not (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this))))) 1)))
(check-sat)
(exit)
