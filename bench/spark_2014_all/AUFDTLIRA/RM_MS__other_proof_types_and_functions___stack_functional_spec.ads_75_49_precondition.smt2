...
(define-fun o11 () us_rep (mk___rep (mk___split_fields o7 o8)))
...
(assert (= x3 x1))
(assert (and (= o11 (state__2 (mk___split_fields my_stack__split_fields4 my_stack__split_fields5))) (and (= my_stack__split_fields4 o7) (= my_stack__split_fields5 o8))))
(assert (and (= o9 (count o11)) (and (in_range3 o9) (= o9 (to_rep1 o8)))))
(assert (= o10 (ite (<= i o9) true false)))
(assert (= result3 (ite (<= 1 i) o10 false)))
(assert (= result3 true))
(assert (not (<= i (count (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1))))))
(check-sat)
(exit)
