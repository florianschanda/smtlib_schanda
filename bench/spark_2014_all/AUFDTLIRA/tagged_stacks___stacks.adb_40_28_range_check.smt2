...
(assert (forall ((s us_rep1)) (! (dynamic_invariant3 (last2 s) true false true true) :pattern ((last2 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (dynamic_invariant3 (last3 attr__tag2 s) true false true true) :pattern ((last3 attr__tag2 s))))))
