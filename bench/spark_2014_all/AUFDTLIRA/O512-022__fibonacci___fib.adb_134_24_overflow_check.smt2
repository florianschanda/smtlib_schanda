...
(assert (in_range2 k1))
(assert (in_range2 k2))
(assert (and (= k1 k2) (and (<= 0 k1) (and (<= k1 100) (and (<= 0 k2) (and (<= k2 100) (and (forall ((i10 Int)) (=> (and (<= 0 i10) (<= i10 k1)) (= (to_rep (select b1 i10)) (to_rep (select b2 i10))))) (forall ((i10 Int)) (=> (and (<= (+ k1 1) i10) (<= i10 100)) (= (to_rep (select c1 (- i10 k1))) (to_rep (select c2 (- i10 k2)))))))))))))
...
(assert (<= temp___222 i8))
(assert (<= i8 0))
(assert (and (forall ((temp___226 Int)) (=> (and (<= 0 temp___226) (<= temp___226 100)) (=> (or (< 0 temp___226) (or (< temp___226 temp___222) (<= i9 temp___226))) (= (select a18 temp___226) (select a16 temp___226))))) (and (<= (+ k1 1) i9) (<= i9 0))))
(assert (not (in_range1 (- i9 k1))))
(check-sat)
(exit)
