...
(assert (and (= (length source) 3) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index3 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 2))) (= (is_digit (to_rep (select (elts source) index3))) true))))))
...
(assert (<= temp___2532 index1))
(assert (<= index1 temp___2533))
...
(assert (and (and (forall ((temp___2536 Int)) (=> (and (<= (to_rep1 n__first) temp___2536) (<= temp___2536 (to_rep1 n__last))) (=> (or (< temp___2533 temp___2536) (or (< temp___2536 temp___2532) (< index2 temp___2536))) (= (select n3 temp___2536) (select n1 temp___2536))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 2)))))
