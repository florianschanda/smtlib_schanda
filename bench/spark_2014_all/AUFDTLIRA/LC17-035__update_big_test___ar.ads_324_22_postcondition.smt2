...
(assert (= a4 a2))
(assert (not (or (and (< j 50) (or (and (< 0 e) (= (bool_eq1 a3 5 50 (temp_____aggregate_def_925 a j (temp_____aggregate_def_933 (select a j) i e) (+ j 1) (temp_____aggregate_def_940 (select a (+ j 1)) i (- e 1))) 5 50) true)) (and (= e 0) (= (bool_eq1 a3 5 50 (temp_____aggregate_def_948 a j (temp_____aggregate_def_956 (select a j) i e) (+ j 1) (temp_____aggregate_def_963 (select a (+ j 1)) i 99)) 5 50) true)))) (and (= j 50) (or (and (< 0 e) (= (bool_eq1 a3 5 50 (temp_____aggregate_def_971 a j (temp_____aggregate_def_979 (select a j) i e) 5 (temp_____aggregate_def_986 (select a 5) i (- e 1))) 5 50) true)) (and (= e 0) (= (bool_eq1 a3 5 50 (temp_____aggregate_def_994 a j (temp_____aggregate_def_1002 (select a j) i e) 5 (temp_____aggregate_def_1009 (select a 5) i 99)) 5 50) true)))))))
(check-sat)
(exit)
