...
(assert (= o109 i1))
(assert (= o110 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o109)))
(assert (= o111 (to_rep o110)))
(assert (= o112 (ite (<= o111 (- (to_rep (rec__patience__state__numelts (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o106 i1))
(assert (= o107 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o106)))
(assert (= o108 (to_rep o107)))
(assert (= o113 (ite (<= (- 1) o108) true false)))
(assert (= result27 (ite (= o113 true) o112 false)))
(assert (=> (= result27 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result27 true) (= o103 i1)))
(assert (=> (= result27 true) (= o104 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o103))))
(assert (=> (= result27 true) (= o105 (to_rep o104))))
(assert (=> (= result27 true) (= result26 (ite (< o105 i1) true false))))
