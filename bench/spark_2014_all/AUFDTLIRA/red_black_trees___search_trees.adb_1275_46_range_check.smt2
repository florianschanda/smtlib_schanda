...
(assert (= result2 true))
(assert (and (= o12 (peek (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) l d)) (and (in_range6 o12) (and (ite (not (= o12 0)) (and (= (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o12) d) (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o12) l)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j) l) (not (= (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j) l) (= (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j) d)) (= o12 j))))))))
(assert (= result3 (ite (= o12 0) true false)))
(assert (= result3 true))
...
(assert (= o10 (+ o9 1)))
(assert (and (= o11 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range6 o11)))
...
(assert (and (= result6 (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) o8)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) o8) (not (= result6 true)))))
(assert (= result6 true))
(assert (not (= i 0)))
(assert (and (= o7 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) l d)) (and (in_range6 o7) (and (ite (not (= o7 0)) (and (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o7) d) (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o7) l)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) l) (not (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) l) (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) d)) (= o7 j))))))))
(assert (= result7 (ite (= o7 i) true false)))
(assert (= result7 true))
...
(assert (= o1 i))
(assert (= (mk___rep2 (mk___split_fields2 o2 o3)) (select temp___2106 o1)))
(assert (= o2 o4))
(assert (= o3 o5))
(assert (= o6 o4))
