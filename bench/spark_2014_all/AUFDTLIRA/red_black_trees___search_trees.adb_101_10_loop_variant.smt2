...
(assert (not (= ki1 kj1)))
(assert (and (= (rec__tree_model__path_type__k (us_split_fields5 (select m ki2))) true) (= (ole (rec__tree_model__path_type__a (us_split_fields5 (select m ki2))) (rec__tree_model__path_type__a (us_split_fields5 (select m i)))) true)))
(assert (= (ole (rec__tree_model__path_type__a (us_split_fields5 (select m kj2))) (rec__tree_model__path_type__a (us_split_fields5 (select m j)))) true))
(assert (= (rec__tree_model__path_type__k (us_split_fields5 (select m kj2))) true))
(assert (=> (< (length (rec__tree_model__path_type__a (us_split_fields5 (select m kj2)))) (length (rec__tree_model__path_type__a (us_split_fields5 (select m ki2))))) (= kj2 j)))
(assert (=> (< (length (rec__tree_model__path_type__a (us_split_fields5 (select m ki2)))) (length (rec__tree_model__path_type__a (us_split_fields5 (select m kj2))))) (= ki2 i)))
(assert (and (=> (<= 1 100) (in_range6 kj2)) (=> (<= 1 100) (in_range6 ki2))))
(assert (= result2 (mk_int__ref temp___1314)))
(assert (= temp___13141 (length (rec__tree_model__path_type__a (us_split_fields5 (select m ki2))))))
(assert (= result3 (mk_int__ref temp___1313)))
(assert (= temp___13131 (length (rec__tree_model__path_type__a (us_split_fields5 (select m kj2))))))
(assert (and (= o (length (rec__tree_model__path_type__a (us_split_fields5 (select m kj2))))) (and (in_range1 o) (<= (+ 0 o) 2147483647))))
(assert (and (= o1 (length (rec__tree_model__path_type__a (us_split_fields5 (select m ki2))))) (and (in_range1 o1) (<= (+ 0 o1) 2147483647))))
(assert (= result4 (ite (< o o1) true false)))
(assert (=> (= result4 true) (and (= o2 (parent f ki2)) (and (in_range4 o2) (and (=> (= (valid_root f ki2) true) (= o2 0)) (=> (= (size f) 0) (= o2 0)))))))
(assert (=> (= result4 true) (and (= o3 o2) (in_range6 o2))))
(assert (=> (= result4 true) (= result5 (mk_int__ref ki2))))
(assert (=> (= result4 true) (= ki3 o3)))
(assert (=> (= result4 true) (= kj3 kj2)))
(assert (=> (not (= result4 true)) (and (= o4 (length (rec__tree_model__path_type__a (us_split_fields5 (select m ki2))))) (and (in_range1 o4) (<= (+ 0 o4) 2147483647)))))
(assert (=> (not (= result4 true)) (and (= o5 (length (rec__tree_model__path_type__a (us_split_fields5 (select m kj2))))) (and (in_range1 o5) (<= (+ 0 o5) 2147483647)))))
(assert (=> (not (= result4 true)) (= result6 (ite (< o4 o5) true false))))
(assert (=> (not (= result4 true)) (=> (= result6 true) (and (= o6 (parent f kj2)) (and (in_range4 o6) (and (=> (= (valid_root f kj2) true) (= o6 0)) (=> (= (size f) 0) (= o6 0))))))))
(assert (=> (not (= result4 true)) (=> (= result6 true) (and (= o7 o6) (in_range6 o6)))))
...
(assert (=> (not (= result4 true)) (=> (not (= result6 true)) (and (= o8 (parent f ki2)) (and (in_range4 o8) (and (=> (= (valid_root f ki2) true) (= o8 0)) (=> (= (size f) 0) (= o8 0))))))))
(assert (=> (not (= result4 true)) (=> (not (= result6 true)) (and (= o9 o8) (in_range6 o8)))))
(assert (=> (not (= result4 true)) (=> (not (= result6 true)) (= result8 (mk_int__ref ki2)))))
(assert (=> (not (= result4 true)) (=> (not (= result6 true)) (= ki4 o9))))
(assert (=> (not (= result4 true)) (=> (not (= result6 true)) (and (= o10 (parent f kj2)) (and (in_range4 o10) (and (=> (= (valid_root f kj2) true) (= o10 0)) (=> (= (size f) 0) (= o10 0))))))))
(assert (=> (not (= result4 true)) (=> (not (= result6 true)) (and (= o11 o10) (in_range6 o10)))))
...
(assert (not (= ki3 kj3)))
(assert (not (or (< (length (rec__tree_model__path_type__a (us_split_fields5 (select m ki3)))) temp___13141) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select m ki3)))) temp___13141) (< (length (rec__tree_model__path_type__a (us_split_fields5 (select m kj3)))) temp___13131)))))
(check-sat)
(exit)
