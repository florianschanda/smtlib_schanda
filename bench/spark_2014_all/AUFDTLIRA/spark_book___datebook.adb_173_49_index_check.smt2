...
(assert (= (to_rep o3) (to_rep (select (rec__datebook__event_record__description_text (us_split_fields7 (select event_array index2))) j2))))
(assert (and (= temp___446 (+ (to_rep1 description__first) (- j2 1))) (in_range1 (+ (to_rep1 description__first) (- j2 1)))))
(assert (not (<= temp___446 (to_rep1 description__last))))
(check-sat)
(exit)
