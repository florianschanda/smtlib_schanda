...
(declare-const temp___2421 pointer_range)
...
(declare-const temp___2461 pointer_range)
...
(assert (= temp___242 o9))
(assert (= temp___2421 o10))
...
(assert (= temp___242 my_stack__split_fields2))
(assert (= temp___2421 my_stack__split_fields3))
...
(assert (= temp___246 o14))
(assert (= temp___2461 o15))
(assert (= result3 my_stack__split_fields2))
(assert (= result4 my_stack__split_fields3))
(assert (= temp___246 my_stack__split_fields4))
(assert (= temp___2461 my_stack__split_fields5))
(assert (= temp1 temp2))
...
(assert (and (= o17 (count (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (and (in_range2 o17) (= o17 (to_rep1 my_stack__split_fields7)))))
(assert (= o18 (- o17 1)))
(assert (and (= o19 o18) (in_range2 o18)))
(assert (and (= o20 (stack_entry o19 (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (and (in_range1 o20) (= o20 (to_rep (select my_stack__split_fields6 o19))))))
(assert (= o21 (ite (= o20 (stack_entry (count (mk___split_fields my_stack__split_fields my_stack__split_fields1)) (mk___split_fields my_stack__split_fields my_stack__split_fields1))) true false)))
(assert (and (= o16 (count (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (and (in_range2 o16) (= o16 (to_rep1 my_stack__split_fields7)))))
(assert (not (<= o16 (count (mk___split_fields my_stack__split_fields6 my_stack__split_fields7)))))
(check-sat)
(exit)
