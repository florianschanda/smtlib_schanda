...
(assert (and (and (= (bool_eq a1 1 10 (temp_____aggregate_def_4460 t i e) 1 10) true) (or (and (= i 10) (= j1 1)) (and (< i 10) (= j1 (+ i 1))))) (in_range1 j1)))
...
(assert (= j3 j1))
(assert (= a4 a2))
(assert (not (or (and (< i 10) (or (and (< 0 e) (= (bool_eq a3 1 10 (temp_____aggregate_def_740 a i e (+ i 1) (- e 1)) 1 10) true)) (and (= e 0) (= (bool_eq a3 1 10 (temp_____aggregate_def_749 a i e (+ i 1) 99) 1 10) true)))) (and (= i 10) (or (and (< 0 e) (= (bool_eq a3 1 10 (temp_____aggregate_def_758 a i e 1 (- e 1)) 1 10) true)) (and (= e 0) (= (bool_eq a3 1 10 (temp_____aggregate_def_767 a i e 1 99) 1 10) true)))))))
(check-sat)
(exit)
