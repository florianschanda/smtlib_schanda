...
(declare-const temp___311 positive)
(declare-const temp___3111 (Array Int element))
(declare-const temp___3112 t)
(declare-const temp___3113 natural)
(declare-const temp___3114 us_private)
(declare-const temp___3115 Int)
(declare-const temp___312 positive)
(declare-const temp___3121 (Array Int element))
(declare-const temp___3122 t)
(declare-const temp___3123 natural)
(declare-const temp___3124 us_private)
(declare-const temp___3125 Int)
...
(declare-const temp___3161 (Array Int element))
(declare-const temp___3162 t)
(declare-const temp___3163 natural)
(declare-const temp___3164 us_private)
(declare-const temp___3165 Int)
(declare-const temp___317 positive)
(declare-const temp___3171 (Array Int element))
(declare-const temp___3172 t)
(declare-const temp___3173 natural)
(declare-const temp___3174 us_private)
(declare-const temp___3175 Int)
...
(assert (= this__split_discrs (mk___split_discrs temp___311)))
(assert (= temp___3111 o2))
(assert (= temp___3112 o3))
(assert (= temp___3113 o4))
(assert (= temp___3114 o5))
(assert (= this__attr__tag temp___3115))
(assert (<= (to_rep temp___3113) (to_rep1 temp___311)))
(assert (= (mk___rep (mk___split_discrs temp___312) (mk___split_fields (mk___t temp___3121 temp___3122) temp___3123 temp___3124) temp___3125) (mk___rep (mk___split_discrs temp___311) (mk___split_fields (mk___t temp___3111 temp___3112) temp___3113 temp___3114) temp___3115)))
...
(assert (= this__split_fields4 (mk___split_fields (mk___t temp___3121 temp___3122) temp___3123 temp___3124)))
(assert (= this__split_discrs (mk___split_discrs temp___312)))
(assert (= (to_rep3 o6) item))
(assert (and (<= (to_rep2 (first (rt (rec__integer_stacks__stack__values this__split_fields4)))) (to_rep (rec__integer_stacks__stack__top this__split_fields4))) (<= (to_rep (rec__integer_stacks__stack__top this__split_fields4)) (to_rep2 (last (rt (rec__integer_stacks__stack__values this__split_fields4)))))))
(assert (= o7 (to_rep (rec__integer_stacks__stack__top this__split_fields4))))
(assert (= o8 (store (elts (rec__integer_stacks__stack__values this__split_fields4)) o7 o6)))
(assert (= o8 o9))
(assert (= (rt (rec__integer_stacks__stack__values this__split_fields4)) o10))
(assert (= o11 o9))
(assert (= o12 o10))
(assert (= (rec__integer_stacks__stack__top this__split_fields4) o13))
(assert (= (rec__ext__ this__split_fields4) o14))
(assert (= this__split_discrs (mk___split_discrs temp___316)))
(assert (= temp___3161 o11))
(assert (= temp___3162 o12))
(assert (= temp___3163 o13))
(assert (= temp___3164 o14))
(assert (= this__attr__tag temp___3165))
(assert (<= (to_rep temp___3163) (to_rep1 temp___316)))
(assert (= (mk___rep (mk___split_discrs temp___317) (mk___split_fields (mk___t temp___3171 temp___3172) temp___3173 temp___3174) temp___3175) (mk___rep (mk___split_discrs temp___316) (mk___split_fields (mk___t temp___3161 temp___3162) temp___3163 temp___3164) temp___3165)))
(assert (= result1 (mk___split_fields__ref this__split_fields4)))
(assert (= this__split_fields5 (mk___split_fields (mk___t temp___3171 temp___3172) temp___3173 temp___3174)))
(assert (= this__split_discrs (mk___split_discrs temp___317)))
(assert (= this__split_fields6 (mk___split_fields__ref this__split_fields5)))
(assert (= this__split_fields7 this__split_fields5))
(assert (not (not (= (empty (mk___rep this__split_discrs (us_split_fields__content this__split_fields6) this__attr__tag)) true))))
(check-sat)
(exit)
