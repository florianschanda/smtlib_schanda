...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o15 i))
(assert (= temp___507 (select (rec__patience__state__stacks (us_split_fields1 s)) o15)))
(assert (and (<= 0 k) (<= k 99)))
(assert (= o16 k))
(assert (= o17 (select temp___507 o16)))
(assert (= temp___508 (to_rep o17)))
(assert (and (<= 0 temp___508) (<= temp___508 99)))
(assert (= o18 temp___508))
(assert (= o19 (select (rec__patience__state__values (us_split_fields1 s)) o18)))
...
(assert (and (<= 0 j) (<= j 99)))
(assert (= o13 j))
(assert (= o14 (select temp___503 o13)))
(assert (= temp___504 (to_rep o14)))
(assert (not (<= 0 temp___504)))
(check-sat)
(exit)
