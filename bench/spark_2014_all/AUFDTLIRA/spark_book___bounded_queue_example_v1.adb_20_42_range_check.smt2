...
(define-fun my_queue__split_fields26 () us_split_fields2 (mk___split_fields1 my_queue__split_fields12 my_queue__split_fields13 my_queue__split_fields14 my_queue__split_fields15))
...
(define-fun my_queue__split_fields27 () us_split_fields2 (mk___split_fields1 my_queue__split_fields4 my_queue__split_fields5 my_queue__split_fields6 my_queue__split_fields7))
(define-fun bounded_queue_v1__clear__queue__fields6 () us_split_fields (mk___split_fields bounded_queue_v1__clear__queue__fields bounded_queue_v1__clear__queue__fields1 bounded_queue_v1__clear__queue__fields2 (mk___t1 bounded_queue_v1__clear__queue__fields3 bounded_queue_v1__clear__queue__fields4)))
...
(assert (and (and (= (empty (mk___rep my_queue__split_discrs bounded_queue_v1__clear__queue__fields6)) true) (= (size (mk___rep my_queue__split_discrs bounded_queue_v1__clear__queue__fields6)) 0)) (dynamic_invariant2 (mk___rep my_queue__split_discrs bounded_queue_v1__clear__queue__fields6) true true true true)))
...
(assert (=> (and (<= 17 count2) (<= count2 52)) (= my_queue__split_fields16 (mk___split_fields__ref1 my_queue__split_fields26))))
(assert (=> (and (<= 17 count2) (<= count2 52)) (= count5 count3)))
(assert (=> (and (<= 17 count2) (<= count2 52)) (= my_queue__split_fields17 my_queue__split_fields26)))
...
(assert (=> (not (and (<= 17 count2) (<= count2 52))) (= my_queue__split_fields18 (mk___split_fields__ref1 my_queue__split_fields27))))
(assert (=> (not (and (<= 17 count2) (<= count2 52))) (= count7 count2)))
(assert (=> (not (and (<= 17 count2) (<= count2 52))) (= my_queue__split_fields19 my_queue__split_fields27)))
...
(assert (= count9 2))
(assert (and (and (= bounded_queue_v1__dequeue__item1 (first_element (mk___rep my_queue__split_discrs (mk___split_fields (rec__bounded_queue_v1__queue_type__count1 my_queue__split_fields20) (rec__bounded_queue_v1__queue_type__front1 my_queue__split_fields20) (rec__bounded_queue_v1__queue_type__rear1 my_queue__split_fields20) (mk___t1 (rec__bounded_queue_v1__queue_type__items1 my_queue__split_fields20) (mk1 1 100)))))) (= (size (mk___rep my_queue__split_discrs bounded_queue_v1__dequeue__queue__fields1)) (- (size (mk___rep my_queue__split_discrs (mk___split_fields (rec__bounded_queue_v1__queue_type__count1 my_queue__split_fields20) (rec__bounded_queue_v1__queue_type__front1 my_queue__split_fields20) (rec__bounded_queue_v1__queue_type__rear1 my_queue__split_fields20) (mk___t1 (rec__bounded_queue_v1__queue_type__items1 my_queue__split_fields20) (mk1 1 100))))) 1))) (and (dynamic_invariant2 (mk___rep my_queue__split_discrs bounded_queue_v1__dequeue__queue__fields1) true true true true) (in_range5 bounded_queue_v1__dequeue__item1))))
(assert (= result13 (mk___split_fields__ref1 my_queue__split_fields20)))
(assert (= my_queue__split_fields21 (mk___split_fields1 (rec__bounded_queue_v1__queue_type__count bounded_queue_v1__dequeue__queue__fields1) (rec__bounded_queue_v1__queue_type__front bounded_queue_v1__dequeue__queue__fields1) (rec__bounded_queue_v1__queue_type__rear bounded_queue_v1__dequeue__queue__fields1) (elts1 (rec__bounded_queue_v1__queue_type__items bounded_queue_v1__dequeue__queue__fields1)))))
(assert (= result14 (mk_int__ref value1)))
(assert (= value2 bounded_queue_v1__dequeue__item1))
(assert (= result15 (mk_int__ref count9)))
(assert (= count10 3))
(assert (and (and (= bounded_queue_v1__dequeue__item2 (first_element (mk___rep my_queue__split_discrs (mk___split_fields (rec__bounded_queue_v1__queue_type__count1 my_queue__split_fields21) (rec__bounded_queue_v1__queue_type__front1 my_queue__split_fields21) (rec__bounded_queue_v1__queue_type__rear1 my_queue__split_fields21) (mk___t1 (rec__bounded_queue_v1__queue_type__items1 my_queue__split_fields21) (mk1 1 100)))))) (= (size (mk___rep my_queue__split_discrs bounded_queue_v1__dequeue__queue__fields2)) (- (size (mk___rep my_queue__split_discrs (mk___split_fields (rec__bounded_queue_v1__queue_type__count1 my_queue__split_fields21) (rec__bounded_queue_v1__queue_type__front1 my_queue__split_fields21) (rec__bounded_queue_v1__queue_type__rear1 my_queue__split_fields21) (mk___t1 (rec__bounded_queue_v1__queue_type__items1 my_queue__split_fields21) (mk1 1 100))))) 1))) (and (dynamic_invariant2 (mk___rep my_queue__split_discrs bounded_queue_v1__dequeue__queue__fields2) true true true true) (in_range5 bounded_queue_v1__dequeue__item2))))
(assert (= result16 (mk___split_fields__ref1 my_queue__split_fields21)))
(assert (= my_queue__split_fields22 (mk___split_fields1 (rec__bounded_queue_v1__queue_type__count bounded_queue_v1__dequeue__queue__fields2) (rec__bounded_queue_v1__queue_type__front bounded_queue_v1__dequeue__queue__fields2) (rec__bounded_queue_v1__queue_type__rear bounded_queue_v1__dequeue__queue__fields2) (elts1 (rec__bounded_queue_v1__queue_type__items bounded_queue_v1__dequeue__queue__fields2)))))
(assert (= result17 (mk_int__ref value2)))
(assert (= value3 bounded_queue_v1__dequeue__item2))
(assert (= result18 (mk_int__ref count10)))
(assert (= count11 4))
(assert (and (and (= bounded_queue_v1__dequeue__item3 (first_element (mk___rep my_queue__split_discrs (mk___split_fields (rec__bounded_queue_v1__queue_type__count1 my_queue__split_fields22) (rec__bounded_queue_v1__queue_type__front1 my_queue__split_fields22) (rec__bounded_queue_v1__queue_type__rear1 my_queue__split_fields22) (mk___t1 (rec__bounded_queue_v1__queue_type__items1 my_queue__split_fields22) (mk1 1 100)))))) (= (size (mk___rep my_queue__split_discrs bounded_queue_v1__dequeue__queue__fields3)) (- (size (mk___rep my_queue__split_discrs (mk___split_fields (rec__bounded_queue_v1__queue_type__count1 my_queue__split_fields22) (rec__bounded_queue_v1__queue_type__front1 my_queue__split_fields22) (rec__bounded_queue_v1__queue_type__rear1 my_queue__split_fields22) (mk___t1 (rec__bounded_queue_v1__queue_type__items1 my_queue__split_fields22) (mk1 1 100))))) 1))) (and (dynamic_invariant2 (mk___rep my_queue__split_discrs bounded_queue_v1__dequeue__queue__fields3) true true true true) (in_range5 bounded_queue_v1__dequeue__item3))))
(assert (= result19 (mk___split_fields__ref1 my_queue__split_fields22)))
(assert (= my_queue__split_fields23 (mk___split_fields1 (rec__bounded_queue_v1__queue_type__count bounded_queue_v1__dequeue__queue__fields3) (rec__bounded_queue_v1__queue_type__front bounded_queue_v1__dequeue__queue__fields3) (rec__bounded_queue_v1__queue_type__rear bounded_queue_v1__dequeue__queue__fields3) (elts1 (rec__bounded_queue_v1__queue_type__items bounded_queue_v1__dequeue__queue__fields3)))))
(assert (= result20 (mk_int__ref value3)))
(assert (= value4 bounded_queue_v1__dequeue__item3))
(assert (= result21 (mk_int__ref count11)))
(assert (= count12 5))
(assert (and (and (= bounded_queue_v1__dequeue__item4 (first_element (mk___rep my_queue__split_discrs (mk___split_fields (rec__bounded_queue_v1__queue_type__count1 my_queue__split_fields23) (rec__bounded_queue_v1__queue_type__front1 my_queue__split_fields23) (rec__bounded_queue_v1__queue_type__rear1 my_queue__split_fields23) (mk___t1 (rec__bounded_queue_v1__queue_type__items1 my_queue__split_fields23) (mk1 1 100)))))) (= (size (mk___rep my_queue__split_discrs bounded_queue_v1__dequeue__queue__fields4)) (- (size (mk___rep my_queue__split_discrs (mk___split_fields (rec__bounded_queue_v1__queue_type__count1 my_queue__split_fields23) (rec__bounded_queue_v1__queue_type__front1 my_queue__split_fields23) (rec__bounded_queue_v1__queue_type__rear1 my_queue__split_fields23) (mk___t1 (rec__bounded_queue_v1__queue_type__items1 my_queue__split_fields23) (mk1 1 100))))) 1))) (and (dynamic_invariant2 (mk___rep my_queue__split_discrs bounded_queue_v1__dequeue__queue__fields4) true true true true) (in_range5 bounded_queue_v1__dequeue__item4))))
(assert (= result22 (mk___split_fields__ref1 my_queue__split_fields23)))
(assert (= my_queue__split_fields24 (mk___split_fields1 (rec__bounded_queue_v1__queue_type__count bounded_queue_v1__dequeue__queue__fields4) (rec__bounded_queue_v1__queue_type__front bounded_queue_v1__dequeue__queue__fields4) (rec__bounded_queue_v1__queue_type__rear bounded_queue_v1__dequeue__queue__fields4) (elts1 (rec__bounded_queue_v1__queue_type__items bounded_queue_v1__dequeue__queue__fields4)))))
...
(assert (= my_queue__split_fields25 (mk___split_fields1 (rec__bounded_queue_v1__queue_type__count bounded_queue_v1__clear__queue__fields5) (rec__bounded_queue_v1__queue_type__front bounded_queue_v1__clear__queue__fields5) (rec__bounded_queue_v1__queue_type__rear bounded_queue_v1__clear__queue__fields5) (elts1 (rec__bounded_queue_v1__queue_type__items bounded_queue_v1__clear__queue__fields5)))))
(assert (and (= o (size (mk___rep my_queue__split_discrs (mk___split_fields (rec__bounded_queue_v1__queue_type__count1 my_queue__split_fields25) (rec__bounded_queue_v1__queue_type__front1 my_queue__split_fields25) (rec__bounded_queue_v1__queue_type__rear1 my_queue__split_fields25) (mk___t1 (rec__bounded_queue_v1__queue_type__items1 my_queue__split_fields25) (mk1 1 100)))))) (in_range4 o)))
(assert (= result25 (mk_int__ref value5)))
(assert (= value6 o))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE1 value6))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE1 value6)))))) (= o1 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE1 value6))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE1 value6)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE1 value6))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE1 value6))))))) (= o1 0)))
