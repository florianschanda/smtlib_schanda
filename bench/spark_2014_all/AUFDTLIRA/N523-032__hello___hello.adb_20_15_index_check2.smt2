...
(assert (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true true) (dynamic_invariant2 (to_lower item) true false true true)) :pattern ((to_lower item)))))
...
(assert (in_range1 j))
(assert (and (and (<= (to_rep1 (first (rt str))) j) (<= j (to_rep1 (last (rt str))))) (and (<= (to_rep1 (first (rt res))) j) (<= j (to_rep1 (last (rt res)))))))
(assert (not (= j (to_rep1 (first (rt str))))))
(assert (and (= temp___6511 (- j 1)) (in_range1 (- j 1))))
(assert (and (<= (to_rep1 (first (rt str))) temp___6511) (<= temp___6511 (to_rep1 (last (rt str))))))
(assert (= o12 temp___6511))
(assert (= o13 (select (elts str) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (<= o14 122) true false)))
(assert (and (= temp___651 (- j 1)) (in_range1 (- j 1))))
(assert (and (<= (to_rep1 (first (rt str))) temp___651) (<= temp___651 (to_rep1 (last (rt str))))))
(assert (= o9 temp___651))
(assert (= o10 (select (elts str) o9)))
(assert (= o11 (to_rep o10)))
(assert (= o16 (ite (<= 97 o11) true false)))
(assert (= o17 (ite (= o16 true) o15 false)))
(assert (= result1 (ite (not (= o17 true)) true false)))
(assert (=> (= result1 true) (and (= temp___6521 (- j 1)) (in_range1 (- j 1)))))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt str))) temp___6521) (<= temp___6521 (to_rep1 (last (rt str)))))))
(assert (=> (= result1 true) (= o3 temp___6521)))
(assert (=> (= result1 true) (= o4 (select (elts str) o3))))
(assert (=> (= result1 true) (= o5 (to_rep o4))))
(assert (=> (= result1 true) (= o6 (ite (<= o5 90) true false))))
(assert (=> (= result1 true) (and (= temp___652 (- j 1)) (in_range1 (- j 1)))))
(assert (=> (= result1 true) (and (<= (to_rep1 (first (rt str))) temp___652) (<= temp___652 (to_rep1 (last (rt str)))))))
(assert (=> (= result1 true) (= o temp___652)))
(assert (=> (= result1 true) (= o1 (select (elts str) o))))
(assert (=> (= result1 true) (= o2 (to_rep o1))))
(assert (=> (= result1 true) (= o7 (ite (<= 65 o2) true false))))
(assert (=> (= result1 true) (= o8 (ite (= o7 true) o6 false))))
(assert (=> (= result1 true) (= result (ite (not (= o8 true)) true false))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (not (= result true)))
(assert (and (<= (to_rep1 (first (rt str))) j) (<= j (to_rep1 (last (rt str))))))
(assert (= o18 j))
(assert (= o19 (select (elts str) o18)))
(assert (= o20 (to_rep o19)))
(assert (and (= o21 (to_lower o20)) (in_range3 o21)))
(assert (not (<= (to_rep1 (first (rt res))) j)))
(check-sat)
(exit)
