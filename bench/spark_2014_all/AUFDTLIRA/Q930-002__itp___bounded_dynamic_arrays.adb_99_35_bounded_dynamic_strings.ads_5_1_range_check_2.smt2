...
(assert (not (= (length3 temp___10662) 0)))
(assert (=> (<= (to_rep1 (first4 temp___10661)) (to_rep1 (last4 temp___10661))) (= o (+ (- (to_rep1 (last4 temp___10661)) (to_rep1 (first4 temp___10661))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___10661)) (to_rep1 (last4 temp___10661)))) (= o 0)))
(assert (= o1 (+ o 1)))
(assert (= o2 (+ (to_rep1 (first4 temp___10661)) o1)))
(assert (= o3 (- o2 1)))
