...
(define-fun dynamic_invariant ((temp___expr_315 us_t2) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (and (=> (not (= temp___skip_constant_312 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_315) (last5 temp___expr_315))) (=> (= temp___do_toplevel_313 true) (=> (= temp___is_init_311 true) (and (let ((temp___317 (of_array (to_array2 temp___expr_315) (first5 temp___expr_315) (last5 temp___expr_315)))) (and (let ((temp___318 (of_array1 (to_array temp___317) (first1 temp___317) (last1 temp___317)))) (and (= (first3 temp___318) 1) (<= 0 (last3 temp___318)))) (<= (last1 temp___317) 1000))) (<= 2 (length2 temp___expr_315)))))))
(define-fun dynamic_predicate ((temp___320 us_t2)) Bool (and (let ((temp___322 (of_array (to_array2 temp___320) (first5 temp___320) (last5 temp___320)))) (and (let ((temp___323 (of_array1 (to_array temp___322) (first1 temp___322) (last1 temp___322)))) (and (= (first3 temp___323) 1) (<= 0 (last3 temp___323)))) (<= (last1 temp___322) 1000))) (<= 2 (length2 temp___320))))
...
(declare-const temp___3711 t)
(assert (dynamic_invariant i19s true false false true))
(assert (dynamic_property 1 2147483647 (to_rep1 (first4 (rt2 i19s))) (to_rep1 (last4 (rt2 i19s)))))
(assert (= (elts2 i19s) temp___371))
(assert (= (mk (to_rep1 (first4 (rt2 i19s))) (to_rep1 (last4 (rt2 i19s)))) temp___3711))
(assert (not (dynamic_property1 1 2147483647 (to_rep1 (first temp___3711)) (to_rep1 (last temp___3711)))))
(check-sat)
(exit)
