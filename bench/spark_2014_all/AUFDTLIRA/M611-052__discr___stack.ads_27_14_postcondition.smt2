...
(define-fun dynamic_invariant1 ((temp___expr_179 us_t) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool (=> (not (= temp___skip_constant_176 true)) (dynamic_property 1 2147483647 (first1 temp___expr_179) (last1 temp___expr_179))))
...
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant s true true true true) (dynamic_invariant1 (to__ s) true false true true)) :pattern ((to__ s)))))
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant s true true true true) (= (to__ s) (let ((temp___194 (let ((temp___192 (to_rep1 (rec__stack__stack__top (us_split_fields1 s))))) (let ((temp___191 1)) (let ((temp___193 (rec__stack__stack__content (us_split_fields1 s)))) (of_array2 (to_array1 temp___193) temp___191 temp___192)))))) (of_array (to_array2 temp___194) (first5 temp___194) (last5 temp___194))))) :pattern ((to__ s)))))
...
(declare-const temp___2921 index)
(declare-const temp___2922 (Array Int integer))
(declare-const temp___2923 t1)
(declare-const result index)
(declare-const result1 (Array Int integer))
(declare-const result2 t1)
(declare-const s__split_fields3 index)
(declare-const s__split_fields4 (Array Int integer))
(declare-const s__split_fields5 t1)
(declare-const s__split_fields6 index)
(declare-const s__split_fields7 (Array Int integer))
(declare-const s__split_fields8 t1)
(declare-const s__split_fields9 index)
(declare-const s__split_fields10 (Array Int integer))
(declare-const s__split_fields11 t1)
(assert (dynamic_invariant (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t1 s__split_fields1 s__split_fields2))) true false true true))
(assert (not (= (is_empty (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t1 s__split_fields1 s__split_fields2)))) true)))
...
(assert (= s__split_discrs (mk___split_discrs temp___292)))
(assert (= temp___2921 o2))
(assert (= temp___2922 o3))
(assert (= temp___2923 o4))
(assert (= result s__split_fields))
(assert (= result1 s__split_fields1))
(assert (= result2 s__split_fields2))
(assert (= temp___2921 s__split_fields3))
(assert (= temp___2922 s__split_fields4))
(assert (= temp___2923 s__split_fields5))
(assert (= s__split_discrs (mk___split_discrs temp___292)))
...
(assert (not (= (let ((temp___301 (to__ (mk___rep s__split_discrs (mk___split_fields s__split_fields6 (mk___t1 s__split_fields7 s__split_fields8)))))) (let ((temp___300 (to_but_top (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t1 s__split_fields1 s__split_fields2)))))) (bool_eq (elts temp___300) (to_rep (first (rt temp___300))) (to_rep (last (rt temp___300))) (elts temp___301) (to_rep (first (rt temp___301))) (to_rep (last (rt temp___301)))))) true)))
(check-sat)
(exit)
