...
(assert (<= 1 rank1))
(assert (<= rank1 64))
(assert (forall ((prev Int)) (=> (and (<= 1 prev) (<= prev (- rank2 1))) (= (to_rep1 (select result__2 (to_rep (select r2 prev)))) prev))))
(assert (forall ((g21 Int)) (=> (and (<= 1 g21) (<= g21 64)) (=> (exists ((prev Int)) (and (and (<= 1 prev) (<= prev (- rank2 1))) (= (to_rep (select r2 prev)) g21))) (= (to_rep (select r2 (to_rep1 (select result__2 g21)))) g21)))))
