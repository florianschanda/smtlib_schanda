...
(assert (and (= (length source) 5) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index4 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index4) (<= index4 (+ (to_rep1 (first (rt source))) 4))) (= (is_digit (to_rep (select (elts source) index4))) true))))))
