...
(declare-fun temp_____aggregate_def_448 (Bool) (Array Int Bool))
(declare-fun temp_____aggregate_def_454 (Bool) (Array Int Bool))
(assert (forall ((temp___441 Bool)) (forall ((temp___442 Int)) (= (select (stable_marriage__is_permutation_1__seen__aggregate_def temp___441) temp___442) temp___441))))
(assert (forall ((temp___450 Bool)) (forall ((temp___451 Int)) (= (select (temp_____aggregate_def_448 temp___450) temp___451) temp___450))))
(assert (forall ((temp___456 Bool)) (forall ((temp___457 Int)) (= (select (temp_____aggregate_def_454 temp___456) temp___457) temp___456))))
...
(assert (= seen1 (stable_marriage__is_permutation_1__seen__aggregate_def (distinct 0 0))))
(assert (= (mk_int__ref result1) (mk_int__ref rank)))
(assert (= rank1 1))
(assert (<= 1 rank1))
(assert (<= rank1 64))
(assert (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (= (= (select seen2 g1) true) (exists ((prev Int)) (and (and (<= 1 prev) (<= prev (- rank2 1))) (= (to_rep (select r1 prev)) g1)))))))
(assert (and (=> (<= 1 64) (in_range2 rank2)) (and (<= 1 rank2) (<= rank2 64))))
(assert (= seen2 result2))
(assert (= seen3 (store seen2 (to_rep (select r1 rank2)) (distinct 1 0))))
(assert (not (= rank2 64)))
...
(assert (not (exists ((prev Int)) (and (and (<= 1 prev) (<= prev (- rank3 1))) (= (to_rep (select r1 prev)) g1)))))
(check-sat)
(exit)
