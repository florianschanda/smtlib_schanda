...
(assert (dynamic_invariant1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2))) true false true true))
(assert (in_range5 by__))
(assert (in_range6 start))
(assert (<= start (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2))))))
(assert (= (to_rep o) by__))
(assert (not (<= (to_rep2 (first this__split_fields2)) start)))
(check-sat)
(exit)
