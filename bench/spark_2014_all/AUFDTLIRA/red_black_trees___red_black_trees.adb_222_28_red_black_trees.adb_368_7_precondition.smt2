...
(declare-const temp___660 (Array Int us_rep7))
(declare-const o7 us_rep7)
(declare-const o8 us_split_fields10)
(declare-const o9 extended_index_type)
(declare-const o10 Int)
(declare-const temp___659 (Array Int us_rep5))
(declare-const o11 us_rep5)
...
(assert (<= 1 n5))
(assert (<= n5 100))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))) i1))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c67b) i1)))) n6)) (not (= i1 (root (rec__red_black_trees__rbt__struct (us_split_fields9 c68b)))))) (= (eq (select (nb_blacks c68b) i1) (select (nb_blacks c67b) i1)) true)))))
(assert (and (=> (<= 1 100) (in_range4 n6)) (and (<= 1 n6) (<= n6 100))))
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___659 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)))) (and (dynamic_invariant5 temp___659 true false true true) (= temp___659 (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))))))))))
(assert (= o11 (select temp___659 i)))
(assert (= o12 (us_split_fields7 o11)))
(assert (= result7 (rec__tree_model__path_type__k o12)))
(assert (=> (= result7 true) (and (= temp___660 (nb_blacks c67b)) (and (= (bool_eq11 (select temp___660 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___660 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___660 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___660 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___660 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___660 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___660 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___660 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___660 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___660 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c67b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___660 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)) i1 0)))))))))))))))
(assert (=> (= result7 true) (= o7 (select temp___660 i))))
...
(assert (=> (= result6 true) (and (= o5 (root (rec__red_black_trees__rbt__struct (us_split_fields9 c68b)))) (and (in_range4 o5) (= o5 (to_rep (rec__search_trees__search_tree__root (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c68b))))))))))
