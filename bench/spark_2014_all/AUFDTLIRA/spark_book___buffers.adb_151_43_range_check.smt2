...
(assert (= result3 true))
(assert (=> (<= (to_rep1 destination__first) (to_rep1 destination__last)) (= o3 (+ (- (to_rep1 destination__last) (to_rep1 destination__first)) 1))))
(assert (=> (not (<= (to_rep1 destination__first) (to_rep1 destination__last))) (= o3 0)))
