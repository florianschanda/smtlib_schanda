...
(assert (= b1 result1))
(assert (= b2 o1))
(assert (=> (= (to_rep (select c i)) r2) (and (ite (= done__2 true) (= (consistent b3 8) true) (not (= (consistent c 8) true))) (forall ((j Int)) (=> (and (<= 1 j) (<= j i)) (= (to_rep (select b3 j)) (to_rep (select b2 j))))))))
(assert (=> (not (= (to_rep (select c i)) r2)) (and (= o2 (copy_until b2 i c)) (forall ((j Int)) (=> (and (<= 1 j) (<= j i)) (= (to_rep (select o2 j)) (to_rep (select b2 j))))))))
(assert (=> (not (= (to_rep (select c i)) r2)) (and (ite (= done__3 true) (= (consistent b4 8) true) (not (= (consistent o2 8) true))) (forall ((j Int)) (=> (and (<= 1 j) (<= j i)) (= (to_rep (select b4 j)) (to_rep (select b2 j))))))))
(assert (=> (not (= (to_rep (select c i)) r2)) (= done__2 done__3)))
(assert (=> (not (= (to_rep (select c i)) r2)) (= b3 b4)))
(assert (not (= done__2 true)))
(assert (not (= r2 8)))
(assert (= result2 r2))
(assert (= r3 (+ r2 1)))
(assert (not (not (= done__2 true))))
(check-sat)
(exit)
