...
(declare-const temp___528 r1)
(declare-const temp___5281 (Array Int integer))
(declare-const temp___527 capacity_range)
...
(assert (= i3 first4))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= temp___519 i3)))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= s__split_fields2 (mk___split_fields temp___518 temp___5181))))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (and (= o i3) (in_range7 i3))))
...
(assert (= i9 first4))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= temp___529 i9)))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___528 temp___5281))))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (and (= res__split_discrs (mk___split_discrs temp___527)) (= res__split_fields1 (mk___split_fields1 temp___5271)))))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= temp___531 (mk___rep (us_split_fields__content s__split_fields7)))))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (and (and (and (= (length2 (mk___rep1 res__split_discrs res__split_fields2)) (- i10 first4)) (= (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) (+ (- last5 i10) 1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (+ (- last5 i10) 1))) (= (to_rep (select (elts (to__ (mk___rep s__split_fields9))) j)) (to_rep (select (elts (to__ temp___531)) j)))))) (forall ((j Int)) (=> (and (<= first4 j) (<= j (- i10 1))) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields2)) j) (get (model__ l) (+ (- last5 j) first4))))))))
...
(assert (and (= o4 (last4 (model__ l))) (and (in_range6 o4) (= o4 (last4 (model__ l))))))
(assert (= o5 (ite (<= i2 o4) true false)))
(assert (and (= o3 1) (and (in_range7 o3) (= o3 1))))
(assert (= o6 (ite (<= o3 i2) true false)))
(assert (= result6 (ite (= o6 true) o5 false)))
(assert (= result6 true))
(assert (and (= o10 1) (and (in_range7 o10) (= o10 1))))
(assert (and (= o8 (last4 (model__ l))) (and (in_range6 o8) (= o8 (last4 (model__ l))))))
(assert (= o9 (- o8 i2)))
(assert (and (= o11 o9) (in_range1 o9)))
(assert (= o12 (+ o11 o10)))
(assert (and (= o13 o12) (in_range1 o12)))
(assert (and (= o14 o13) (in_range7 o13)))
