...
(declare-const i Int)
(declare-const temp___737 (Array Int us_rep3))
...
(assert (<= i 100))
(assert (= (tree_structure f) true))
(assert (and (= temp___737 (model__ f t2)) (and (dynamic_invariant2 temp___737 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___737 t2))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___737 t2)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 t2)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___737 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___737 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___737 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___737 i1))) true) (not (= i1 t2))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___737 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___737 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___737 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___737 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___737 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___737 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___737 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep2 (mk___split_fields2 o o1)) (select temp___737 i)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= o4 o3))
