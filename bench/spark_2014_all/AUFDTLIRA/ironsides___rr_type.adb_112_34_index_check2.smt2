...
(assert (and (= temp___380 (length s)) (in_range1 (length s))))
(assert (= result1 i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 temp___380))
(assert (and (forall ((temp___382 Int)) (=> (and (<= 1 temp___382) (<= temp___382 128)) (=> (or (< temp___380 temp___382) (or (< temp___382 1) (<= i2 temp___382))) (= (select newdomainname2 temp___382) (select newdomainname1 temp___382))))) (and (<= 1 i2) (<= i2 (length s)))))
(assert (not (<= (to_rep1 (first (rt s))) i2)))
(check-sat)
(exit)
