...
(assert (=> (not (= smallest1 current1)) (and (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t o8 (mk (to_rep values__first) (to_rep values__last)))) true) (and (= (to_rep (select o8 o7)) (to_rep (select values smallest1))) (and (= (to_rep (select o8 smallest1)) (to_rep (select values o7))) (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 (to_rep values__last))) (=> (and (not (= j1 o7)) (not (= j1 smallest1))) (= (to_rep (select o8 j1)) (to_rep (select values j1)))))))))))
(assert (=> (not (not (= smallest1 current1))) (= o8 values)))
(assert (=> (not (not (= smallest1 current1))) (= o8 values1)))
(assert (= (perm_transitive (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values_last1 (mk (to_rep values_last__first) (to_rep values_last__last))) (mk___t o8 (mk (to_rep values__first) (to_rep values__last)))) true))
...
(assert (not (<= temp___229 (to_rep values__last))))
(check-sat)
(exit)
