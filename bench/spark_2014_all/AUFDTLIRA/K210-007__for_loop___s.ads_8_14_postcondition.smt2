...
(assert (or (and (and (and (= s__contains__result3 s__contains__result11) (= index2 index7)) (and (= s__contains__result12 s__contains__result3) (= index8 index2))) (and (= temp___182 1) (and (= temp___183 10) (and (and (= result3 index12) (= index1 temp___182)) (and (and (<= temp___182 index1) (<= index1 temp___183)) (and (= temp___184 index1) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (- index2 1))) (not (= (to_rep (select table j)) value)))) (and (and (=> (<= 1 10) (in_range3 index2)) (and (<= 1 index2) (<= index2 10))) (and (= (to_rep (select table index2)) value) (and (= result1 s__contains__result2) (= s__contains__result3 (distinct 1 0)))))))))))) (and (and (and (= result3 index12) (= index1 1)) (ite (and (<= 1 index1) (<= index1 10)) (and (and (and (= temp___184 index1) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (- index2 1))) (not (= (to_rep (select table j)) value)))) (and (and (=> (<= 1 10) (in_range3 index2)) (and (<= 1 index2) (<= index2 10))) (and (and (not (= (to_rep (select table index2)) value)) (= s__contains__result3 s__contains__result2)) (= index2 10))))) (and (and (= s__contains__result3 s__contains__result4) (= index2 index3)) (and (= s__contains__result5 s__contains__result3) (= index4 index2)))) (and (and (= s__contains__result16 (mk_bool__ref s__contains__result4)) (= index11 (mk_int__ref index3))) (and (= s__contains__result7 s__contains__result5) (= index6 index4)))) (and (and (= s__contains__result16 (mk_bool__ref s__contains__result)) (= index1 index5)) (and (= s__contains__result7 s__contains__result1) (= index6 index1))))) (and (and (and (= s__contains__result15 (mk_bool__ref s__contains__result9)) (= (mk_int__ref index7) index11)) (and (= s__contains__result12 s__contains__result10) (= index8 index6))) (and (and (= s__contains__result8 s__contains__result9) (= s__contains__result10 s__contains__result8)) (and (= result2 s__contains__result6) (= s__contains__result8 (distinct 0 0))))))))
...
(assert (not (= s__contains__result13 true)))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j 10))
