...
(assert (=> (= (to_rep (first (rt r))) (to_rep (first (rt a)))) (= result1 (ite (= (to_rep (last (rt r))) (to_rep (last (rt a)))) true false))))
(assert (=> (not (= (to_rep (first (rt r))) (to_rep (first (rt a))))) (= result1 false)))
(assert (=> (= result1 true) (and (<= (to_rep (first (rt r))) i) (<= i (to_rep (last (rt r)))))))
