...
(declare-const o5 t)
(declare-const temp___293 natural)
(declare-const temp___2931 (Array Int us_rep))
(declare-const temp___2932 t)
...
(assert (= o4 o2))
(assert (= o5 o3))
(assert (= c__split_discrs (mk___split_discrs temp___293)))
(assert (= temp___2931 o4))
(assert (= temp___2932 o5))
(assert (= result c__split_fields))
(assert (= result1 c__split_fields1))
(assert (= temp___2931 c__split_fields2))
(assert (= temp___2932 c__split_fields3))
(assert (= c__split_discrs (mk___split_discrs temp___293)))
...
(assert (<= (to_rep1 (first c__split_fields5)) temp___295))
(assert (<= temp___295 (to_rep1 (last c__split_fields5))))
(define-fun temp___164 () us_rep (select c__split_fields4 temp___295))
(assert (= (to_rep (rec__types_with_invariants__my_integer__val (us_split_fields1 temp___164))) 0))
