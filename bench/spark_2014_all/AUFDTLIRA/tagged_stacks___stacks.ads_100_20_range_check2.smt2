...
(assert (= result true))
(assert (and (= stacks__get_model__3__R86s (last2 s)) (and (in_range1 stacks__get_model__3__R86s) (= stacks__get_model__3__R86s (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) 100))))))
(assert (=> (<= 1 stacks__get_model__3__R86s) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 stacks__get_model__3__R86s) (<= stacks__get_model__3__R86s 100)))))
(assert (= o (rec__stacks__stack_root__content1 (us_split_fields3 s))))
(assert (= o temp___560))
(assert (= (mk3 1 stacks__get_model__3__R86s) temp___5601))
(assert (<= (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) 100))
(assert (not (<= 1 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))))))
(check-sat)
(exit)
