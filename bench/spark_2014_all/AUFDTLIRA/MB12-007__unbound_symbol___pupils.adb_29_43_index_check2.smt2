...
(assert (= i1 0))
(assert (and (<= 1 (+ (to_rep4 p__split_fields) 1)) (<= (+ (to_rep4 p__split_fields) 1) 250)))
(assert (= o54 (+ (to_rep4 p__split_fields) 1)))
(assert (= o55 (select p__split_fields1 o54)))
(assert (= o56 (us_split_fields3 o55)))
(assert (= temp___444 (rec__pupils__pupiltype__scores o56)))
(assert (= o57 (select temp___444 (to_rep1 (rec__pupils__subject_score_pair__subj (us_split_fields7 (select subject_scores1 i1)))))))
...
(assert (= (to_rep o61) (to_rep (rec__pupils__subject_score_pair__score (us_split_fields7 (select subject_scores1 i1))))))
(assert (= o62 (mk___split_fields (rec__pupils__participation__studying (us_split_fields1 (select (rec__pupils__pupiltype__scores (us_split_fields3 (select p__split_fields1 (+ (to_rep4 p__split_fields) 1)))) (to_rep1 (rec__pupils__subject_score_pair__subj (us_split_fields7 (select subject_scores1 i1))))))) o61)))
(assert (= o63 (mk___rep o62)))
(assert (= o64 (store (rec__pupils__pupiltype__scores (us_split_fields3 (select p__split_fields1 (+ (to_rep4 p__split_fields) 1)))) (to_rep1 (rec__pupils__subject_score_pair__subj (us_split_fields7 (select subject_scores1 i1)))) o63)))
(assert (= o65 (mk___split_fields1 (rec__pupils__pupiltype__surname (us_split_fields3 (select p__split_fields1 (+ (to_rep4 p__split_fields) 1)))) (rec__pupils__pupiltype__forename (us_split_fields3 (select p__split_fields1 (+ (to_rep4 p__split_fields) 1)))) (rec__pupils__pupiltype__form (us_split_fields3 (select p__split_fields1 (+ (to_rep4 p__split_fields) 1)))) o64)))
