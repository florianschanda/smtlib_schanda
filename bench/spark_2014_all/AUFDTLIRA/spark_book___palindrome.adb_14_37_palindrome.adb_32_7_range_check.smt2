...
(declare-fun tline_typeP1qtint (tline_typeP1) Int)
(assert (forall ((i tline_typeP1)) (and (<= 1 (tline_typeP1qtint i)) (<= (tline_typeP1qtint i) 100))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_588 us_void_param) 1)) 69) (= (to_rep (select (temp___String_Literal_588 us_void_param) 2)) 110)) (= (to_rep (select (temp___String_Literal_588 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_588 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_588 us_void_param) 5)) 114)) (= (to_rep (select (temp___String_Literal_588 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_588 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_588 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_588 us_void_param) 9)) 108)) (= (to_rep (select (temp___String_Literal_588 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_588 us_void_param) 11)) 110)) (= (to_rep (select (temp___String_Literal_588 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_588 us_void_param) 13)) 46)) :pattern ((temp___String_Literal_588 us_void_param)))))
(declare-fun temp___String_Literal_599 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_599 us_void_param) 1)) 105) (= (to_rep (select (temp___String_Literal_599 us_void_param) 2)) 115)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 4)) 110)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 8)) 97)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 10)) 112)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 11)) 97)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 12)) 108)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 13)) 105)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 14)) 110)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 15)) 100)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 17)) 111)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 18)) 109)) (= (to_rep (select (temp___String_Literal_599 us_void_param) 19)) 101)) :pattern ((temp___String_Literal_599 us_void_param)))))
(declare-fun temp___String_Literal_600 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_600 us_void_param) 1)) 105) (= (to_rep (select (temp___String_Literal_600 us_void_param) 2)) 115)) (= (to_rep (select (temp___String_Literal_600 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_600 us_void_param) 4)) 97)) (= (to_rep (select (temp___String_Literal_600 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_600 us_void_param) 6)) 112)) (= (to_rep (select (temp___String_Literal_600 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_600 us_void_param) 8)) 108)) (= (to_rep (select (temp___String_Literal_600 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_600 us_void_param) 10)) 110)) (= (to_rep (select (temp___String_Literal_600 us_void_param) 11)) 100)) (= (to_rep (select (temp___String_Literal_600 us_void_param) 12)) 114)) (= (to_rep (select (temp___String_Literal_600 us_void_param) 13)) 111)) (= (to_rep (select (temp___String_Literal_600 us_void_param) 14)) 109)) (= (to_rep (select (temp___String_Literal_600 us_void_param) 15)) 101)) :pattern ((temp___String_Literal_600 us_void_param)))))
...
(declare-const temp___594 (Array Int character))
(declare-const temp___5941 t3)
(declare-const o9 Int)
(declare-const o10 character)
(declare-const o11 (Array Int character))
(declare-const temp___596 (Array Int character))
(declare-const temp___5961 t4)
...
(assert (=> (<= right_index2 left_index2) (= result3 true)))
(assert (=> (not (<= right_index2 left_index2)) (=> (<= 1 r5b) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 r5b) (<= r5b 100))))))
(assert (=> (not (<= right_index2 left_index2)) (= o11 line1)))
(assert (=> (not (<= right_index2 left_index2)) (= o11 temp___596)))
(assert (=> (not (<= right_index2 left_index2)) (= (mk4 1 r5b) temp___5961)))
(assert (=> (not (<= right_index2 left_index2)) (and (<= (to_rep1 (first8 temp___5961)) left_index2) (<= left_index2 (to_rep1 (last8 temp___5961))))))
(assert (=> (not (<= right_index2 left_index2)) (= o12 left_index2)))
(assert (=> (not (<= right_index2 left_index2)) (= o13 (select temp___596 o12))))
(assert (=> (not (<= right_index2 left_index2)) (= o14 (to_rep o13))))
(assert (=> (not (<= right_index2 left_index2)) (=> (<= 1 r5b) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 r5b) (<= r5b 100))))))
(assert (=> (not (<= right_index2 left_index2)) (= o8 line1)))
(assert (=> (not (<= right_index2 left_index2)) (= o8 temp___594)))
(assert (=> (not (<= right_index2 left_index2)) (= (mk3 1 r5b) temp___5941)))
(assert (=> (not (<= right_index2 left_index2)) (and (<= (to_rep1 (first6 temp___5941)) right_index2) (<= right_index2 (to_rep1 (last6 temp___5941))))))
(assert (=> (not (<= right_index2 left_index2)) (= o9 right_index2)))
(assert (=> (not (<= right_index2 left_index2)) (= o10 (select temp___594 o9))))
(assert (=> (not (<= right_index2 left_index2)) (= o15 (to_rep o10))))
(assert (=> (not (<= right_index2 left_index2)) (= o16 (ite (= o15 o14) true false))))
(assert (=> (not (<= right_index2 left_index2)) (= result3 (ite (not (= o16 true)) true false))))
(assert (not (= result3 true)))
(assert (and (= o17 (+ left_index2 1)) (in_range (+ left_index2 1))))
(assert (= result4 left_index2))
(assert (= left_index3 o17))
(assert (not (in_range3 (- right_index2 1))))
(check-sat)
(exit)
