...
(assert (= data2 data1))
(assert (= res2 res1))
(assert (and (= (bool_eq2 data3 1 10000 data 1 10000) true) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r2)) (= (to_rep (select data3 rr)) 1)))))
(assert (and (and (and (=> (<= 1 10000) (in_range4 r2)) (=> (<= 0 10000) (in_range2 res3))) (forall ((temp___280 Int)) (=> (and (<= 1 temp___280) (<= temp___280 10000)) (=> (or (< 10000 temp___280) (or (< temp___280 1) (< r2 temp___280))) (= (select data3 temp___280) (select data temp___280)))))) (and (<= 1 r2) (<= r2 10000))))
(assert (not (= r2 10000)))
(assert (= r2 result1))
(assert (= r3 (+ r2 1)))
...
(assert (= data4 data3))
(assert (= res4 res3))
(assert (not (= (bool_eq2 data4 1 10000 data 1 10000) true)))
(check-sat)
(exit)
