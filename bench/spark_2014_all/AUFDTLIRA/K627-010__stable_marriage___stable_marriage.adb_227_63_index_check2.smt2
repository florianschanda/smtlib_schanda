...
(declare-const o Int)
(declare-const o1 group2_id)
(declare-const o2 Int)
(declare-const o3 group1_id)
(declare-const o4 Int)
(declare-const o5 Bool)
(declare-const o6 Int)
(declare-const o7 group2_id)
(declare-const o8 Int)
(declare-const o9 group1_id)
(declare-const o10 Int)
(declare-const o11 Int)
(declare-const o12 group2_id)
(declare-const o13 Int)
(declare-const o14 (Array Int group1_id))
...
(assert (= result true))
(assert (= (= o18 true) (forall ((g1_id1 Int)) (=> (and (<= 1 g1_id1) (<= g1_id1 64)) (=> (forall ((idx Int)) (=> (and (<= 1 idx) (<= idx (to_rep2 unmatched_g1_set__split_fields1))) (not (= (to_rep (select unmatched_g1_set__split_fields idx)) g1_id1)))) (and (< 0 (to_rep2 (select proposals_made g1_id1))) (= (to_rep (select result__ (to_rep3 (select (select ranking_1 g1_id1) (to_rep2 (select proposals_made g1_id1)))))) g1_id1)))))))
(assert (= (= o17 true) (forall ((g1_id1 Int)) (=> (and (<= 1 g1_id1) (<= g1_id1 64)) (=> (= (to_rep2 (select proposals_made g1_id1)) 0) (exists ((idx Int)) (and (and (<= 1 idx) (<= idx (to_rep2 unmatched_g1_set__split_fields1))) (= (to_rep (select unmatched_g1_set__split_fields idx)) g1_id1))))))))
(assert (<= 1 g1_id))
(assert (<= g1_id 64))
(assert (<= 1 rank))
(assert (<= rank (to_rep2 (select proposals_made g1_id))))
(assert (and (<= 1 rank) (<= rank 64)))
(assert (= o rank))
(assert (= o1 (select (select ranking_1 g1_id) o)))
(assert (= o2 (to_rep3 o1)))
(assert (= o3 (select result__ o2)))
(assert (= o4 (to_rep o3)))
(assert (= o5 (ite (= o4 g1_id) true false)))
(assert (= result1 (ite (not (= o5 true)) true false)))
(assert (=> (= result1 true) (and (<= 1 rank) (<= rank 64))))
(assert (=> (= result1 true) (= o11 rank)))
(assert (=> (= result1 true) (= o12 (select (select ranking_1 g1_id) o11))))
(assert (=> (= result1 true) (= o13 (to_rep3 o12))))
(assert (=> (= result1 true) (= o14 (select ranking_2 o13))))
(assert (=> (= result1 true) (and (<= 1 rank) (<= rank 64))))
(assert (=> (= result1 true) (= o6 rank)))
(assert (=> (= result1 true) (= o7 (select (select ranking_1 g1_id) o6))))
(assert (=> (= result1 true) (= o8 (to_rep3 o7))))
(assert (=> (= result1 true) (= o9 (select result__ o8))))
(assert (=> (= result1 true) (= o10 (to_rep o9))))
(assert (=> (= result1 true) (and (= o15 (is_preferred_1 g1_id o10 o14)) (= (= o15 true) (<= (to_rep1 (select (invert_1 o14) g1_id)) (to_rep1 (select (invert_1 o14) o10)))))))
(assert (=> (= result1 true) (= o16 (ite (not (= o15 true)) true false))))
(assert (=> (not (= result1 true)) (= o16 (distinct 1 0))))
(assert (not (<= 1 rank)))
(check-sat)
(exit)
