...
(assert (and (= o1 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i2 0)) (and (in_range2 o1) (= o1 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i2 0)))))
(assert (= red_black_trees__nb_blacks__B_3__count_l__assume (select res3 o1)))
(assert (= red_black_trees__nb_blacks__B_3__count_l__assume count_l))
(assert (= (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_l))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 count_r)))) n2))
(assert (= (to_rep o2) (+ n2 1)))
(assert (= o3 (mk___split_fields5 (rec__red_black_trees__black_count__status (us_split_fields11 (select res3 i2))) o2 (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 i2))))))
(assert (= o4 (mk___rep5 o3)))
(assert (= o5 (store res3 i2 o4)))
(assert (= result3 (mk_map__ref4 res3)))
(assert (= res4 o5))
(assert (= result4 (mk_map__ref4 res4)))
(assert (= res5 (store res4 i2 (mk___rep5 (mk___split_fields5 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 count_r))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 count_l)))) true false) (rec__red_black_trees__black_count__depth (us_split_fields11 (select res4 i2))) (rec__red_black_trees__black_count__count (us_split_fields11 (select res4 i2))))))))
(assert (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i2)) 0))
(assert (not (in_range2 (+ (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 count_l))) 1))))
(check-sat)
(exit)
