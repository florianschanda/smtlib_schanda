...
(assert (= r6b9 r6b7))
(assert (= l9 l7))
(assert (and (= o25 (+ y (int__content lcp__result4))) (in_range1 (+ y (int__content lcp__result4)))))
(assert (= o26 (- o25 1)))
(assert (and (= temp___204 o26) (in_range1 o26)))
...
(assert (= o27 (elts a)))
(assert (= o27 temp___206))
(assert (= (mk2 y temp___204) temp___2061))
(assert (and (= o28 (+ x (int__content lcp__result4))) (in_range1 (+ x (int__content lcp__result4)))))
(assert (= o29 (- o28 1)))
(assert (and (= temp___203 o29) (in_range1 o29)))
