...
(declare-const temp___2391 pointer_range)
...
(declare-const temp___2431 pointer_range)
...
(assert (= temp___239 o9))
(assert (= temp___2391 o10))
...
(assert (= temp___239 my_stack__split_fields2))
(assert (= temp___2391 my_stack__split_fields3))
...
(assert (= temp___243 o14))
(assert (= temp___2431 o15))
(assert (= result3 my_stack__split_fields2))
(assert (= result4 my_stack__split_fields3))
(assert (= temp___243 my_stack__split_fields4))
(assert (= temp___2431 my_stack__split_fields5))
(assert (= temp1 temp2))
