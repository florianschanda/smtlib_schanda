...
(assert (not (= (length (mk___t temp___672 temp___6721)) 0)))
(assert (=> (<= 1 9) (= o26 (+ (- 9 1) 1))))
(assert (=> (not (<= 1 9)) (= o26 0)))
(assert (=> (<= (to_rep1 (first temp___6721)) (to_rep1 (last temp___6721))) (= o27 (+ (- (to_rep1 (last temp___6721)) (to_rep1 (first temp___6721))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6721)) (to_rep1 (last temp___6721)))) (= o27 0)))
(assert (= o28 (+ o27 o26)))
(assert (= o29 (+ (to_rep1 (first temp___6721)) o28)))
(assert (= o30 (- o29 1)))
