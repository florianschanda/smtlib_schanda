...
(assert (and (= o24 x2) (in_range4 x2)))
...
(assert (and (= o29 y6) (in_range4 y6)))
...
(assert (and (= o34 y6) (in_range4 y6)))
(assert (and (= o35 (parent (rec__red_black_trees__rbt__struct t__split_fields10) o34)) (and (in_range2 o35) (and (= o35 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct t__split_fields10))) o34)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields10)) 0) (= o35 0))))))
...
(assert (and (= o36 y6) (in_range4 y6)))
(assert (and (= o37 (parent (rec__red_black_trees__rbt__struct t__split_fields10) o36)) (and (in_range2 o37) (and (= o37 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct t__split_fields10))) o36)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields10)) 0) (= o37 0))))))
(assert (and (= red_black_trees__insert__L_8__C77b__assume o37) (in_range4 o37)))
(assert (= red_black_trees__insert__L_8__C77b__assume c77b))
(assert (in_range4 c77b))
(assert (= (same_nb_blacks c75b) true))
(assert (= result13 (mk_int__ref n4)))
(assert (= n5 1))
(assert (<= 1 n5))
(assert (<= n5 100))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i1))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c75b) i1)))) n6)) (ite (= (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c76b)) i1) c77b) (and (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c76b) i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c76b) i1)))) (+ (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c75b) i1)))) 1))) (= (eq (select (nb_blacks c76b) i1) (select (nb_blacks c75b) i1)) true))))))
(assert (and (=> (<= 1 100) (in_range4 n6)) (and (<= 1 n6) (<= n6 100))))
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___965 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)))) (and (dynamic_invariant5 temp___965 true false true true) (= temp___965 (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))))))))))
(assert (= o42 (select temp___965 i)))
(assert (= o43 (us_split_fields7 o42)))
(assert (= result15 (rec__tree_model__path_type__k o43)))
(assert (=> (= result15 true) (and (= temp___966 (nb_blacks c75b)) (and (= (bool_eq11 (select temp___966 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___966 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___966 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___966 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___966 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___966 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___966 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___966 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___966 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___966 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c75b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___966 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i1 0)))))))))))))))
(assert (=> (= result15 true) (= o38 (select temp___966 i))))
...
(assert (and (= o44 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c76b)) i)) (and (in_range2 o44) (and (= o44 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c76b)))) i)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c76b))) 0) (= o44 0))))))
(assert (= result16 (ite (= o44 c77b) true false)))
(assert (= result16 true))
(assert (and (= temp___962 (nb_blacks c75b)) (and (= (bool_eq11 (select temp___962 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___962 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___962 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___962 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___962 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___962 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___962 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___962 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___962 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___962 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c75b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___962 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i1 0))))))))))))))
(assert (= o45 (select temp___962 i)))
