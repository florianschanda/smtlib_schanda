...
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= temp___3011 j13)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= temp___3001 diff14)))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (and (= temp___2992 (+ j13 (- i3 1))) (in_range1 (+ j13 (- i3 1))))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (and (<= (to_rep1 (first (rt haystack))) temp___2992) (<= temp___2992 (to_rep1 (last (rt haystack)))))))
(assert (=> (and (<= (to_rep1 (first (rt needle))) j13) (<= j13 (to_rep1 (last (rt needle))))) (= o15 temp___2992)))
