...
(define-fun dynamic_invariant ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 99)) (in_range1 temp___expr_173)))
...
(declare-fun temp_____aggregate_def_313 ((Array Int et1) Int Int Int) (Array Int et1))
...
(assert (forall ((temp___315 (Array Int et1))) (forall ((temp___316 Int) (temp___317 Int) (temp___318 Int)) (let ((temp___314 (temp_____aggregate_def_313 temp___315 temp___316 temp___317 temp___318))) (=> (and (and (dynamic_invariant1 temp___316 true true true true) (dynamic_invariant1 temp___317 true true true true)) (dynamic_invariant temp___318 true true true true)) (forall ((temp___319 Int)) (ite (and (<= temp___316 temp___319) (<= temp___319 temp___317)) (= (to_rep (select temp___314 temp___319)) temp___318) (= (select temp___314 temp___319) (select temp___315 temp___319)))))))))
(declare-const o Int)
(declare-const o1 Int)
(assert (in_range1 e))
(assert (and (= o (- e 1)) (in_range1 (- e 1))))
(assert (and (= o1 10) (in_range 10)))
