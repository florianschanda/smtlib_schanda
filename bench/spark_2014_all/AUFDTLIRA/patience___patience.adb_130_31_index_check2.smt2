...
(declare-const o109 card1)
(declare-const o110 Int)
(declare-const o111 card1)
...
(assert (= o120 i1))
(assert (= o121 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o120)))
(assert (= o122 (to_rep o121)))
(assert (= o123 (ite (<= o122 (- (to_rep (rec__patience__state__numelts (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o117 i1))
(assert (= o118 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o117)))
(assert (= o119 (to_rep o118)))
(assert (= o124 (ite (<= (- 1) o119) true false)))
(assert (= result27 (ite (= o124 true) o123 false)))
(assert (=> (= result27 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result27 true) (= o114 i1)))
(assert (=> (= result27 true) (= o115 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o114))))
(assert (=> (= result27 true) (= o116 (to_rep o115))))
(assert (=> (= result27 true) (= result26 (ite (< o116 i1) true false))))
...
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o110 i1))
(assert (= o111 (select (rec__patience__state__values (us_split_fields__content s__split_fields20)) o110)))
(assert (= o112 (to_rep1 o111)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o106 i1))
(assert (= o107 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o106)))
(assert (= temp___780 (to_rep o107)))
(assert (and (<= 0 temp___780) (<= temp___780 99)))
(assert (= o108 temp___780))
(assert (= o109 (select (rec__patience__state__values (us_split_fields__content s__split_fields20)) o108)))
(assert (= o113 (to_rep1 o109)))
(assert (= result29 (ite (< o113 o112) true false)))
