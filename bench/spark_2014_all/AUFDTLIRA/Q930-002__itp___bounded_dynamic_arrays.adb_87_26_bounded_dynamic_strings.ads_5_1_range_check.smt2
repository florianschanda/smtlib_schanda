...
(assert (=> (not (= (length3 left) 0)) (=> (<= (to_rep1 (first4 temp___10531)) (to_rep1 (last4 temp___10531))) (= o (+ (- (to_rep1 (last4 temp___10531)) (to_rep1 (first4 temp___10531))) 1)))))
(assert (=> (not (= (length3 left) 0)) (=> (not (<= (to_rep1 (first4 temp___10531)) (to_rep1 (last4 temp___10531)))) (= o 0))))
(assert (=> (not (= (length3 left) 0)) (=> (<= (to_rep1 (first4 (rt2 left))) (to_rep1 (last4 (rt2 left)))) (= o1 (+ (- (to_rep1 (last4 (rt2 left))) (to_rep1 (first4 (rt2 left)))) 1)))))
(assert (=> (not (= (length3 left) 0)) (=> (not (<= (to_rep1 (first4 (rt2 left))) (to_rep1 (last4 (rt2 left))))) (= o1 0))))
(assert (=> (not (= (length3 left) 0)) (= o2 (+ o1 o))))
(assert (=> (not (= (length3 left) 0)) (= o3 (+ (to_rep1 (first4 (rt2 left))) o2))))
(assert (=> (not (= (length3 left) 0)) (= o4 (- o3 1))))
(assert (=> (not (= (length3 left) 0)) (and (= o5 o4) (in_range2 o4))))
...
(assert (=> (not (= (length3 left) 0)) (= (mk (to_rep1 (first4 (rt2 left))) o5) temp___10541)))
(assert (dynamic_property3 1 2147483647 (to_rep1 (first temp___10541)) (to_rep1 (last temp___10541))))
(assert (= temp___1054 o6))
(assert (= (mk2 (to_rep1 (first temp___10541)) (to_rep1 (last temp___10541))) o7))
