...
(assert (=> (not (= smallest1 current1)) (and (= (to_rep (select o10 o4)) (to_rep (select values smallest1))) (and (= (to_rep (select o10 smallest1)) (to_rep (select values o4))) (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 (to_rep values__last))) (=> (and (not (= j1 o4)) (not (= j1 smallest1))) (= (to_rep (select o10 j1)) (to_rep (select values j1))))))))))
...
(assert (=> (<= (to_rep values__first) current2) (= result2 (ite (< current2 (to_rep values__last)) true false))))
(assert (=> (not (<= (to_rep values__first) current2)) (= result2 false)))
(assert (= result2 true))
(assert (and (= o5 (- current2 1)) (in_range1 (- current2 1))))
(assert (= o6 (ite (<= j o5) true false)))
(assert (= result3 (ite (<= (to_rep values__first) j) o6 false)))
(assert (= result3 true))
(assert (and (= temp___206 (+ j 1)) (in_range1 (+ j 1))))
(assert (and (<= (to_rep values__first) temp___206) (<= temp___206 (to_rep values__last))))
(assert (= o7 temp___206))
(assert (= o8 (select values2 o7)))
(assert (= o9 (to_rep o8)))
