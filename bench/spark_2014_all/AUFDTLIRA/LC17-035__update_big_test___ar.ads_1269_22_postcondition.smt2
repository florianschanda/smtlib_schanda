...
(declare-fun temp_____aggregate_def_2918 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq1 a2 1 10 (temp_____aggregate_def_2918 a i r) 1 10) true)))
(check-sat)
(exit)
