...
(assert (<= 90 n))
(assert (<= n 99))
(assert (not (in_range2 (to_rep1 (rec__ar__rec1t__f1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select (rec__ar__rofaofr2__b2 (us_split_fields__content3 r__split_fields3)) n)))))))))))
(check-sat)
(exit)
