...
(declare-fun temp_____aggregate_def_694 (us_rep) (Array Int us_rep))
(declare-fun temp_____aggregate_def_698 (Int) (Array Int character))
(declare-fun temp_____aggregate_def_702 (Int Int) (Array Int character))
...
(assert (forall ((temp___696 us_rep)) (forall ((temp___697 Int)) (= (select (temp_____aggregate_def_694 temp___696) temp___697) temp___696))))
(assert (forall ((temp___700 Int)) (=> (dynamic_invariant temp___700 true true true true) (forall ((temp___701 Int)) (= (to_rep1 (select (temp_____aggregate_def_698 temp___700) temp___701)) temp___700)))))
(assert (forall ((temp___704 Int) (temp___705 Int)) (let ((temp___703 (temp_____aggregate_def_702 temp___704 temp___705))) (=> (and (dynamic_invariant temp___704 true true true true) (dynamic_invariant temp___705 true true true true)) (forall ((temp___706 Int)) (ite (= temp___706 1) (= (to_rep1 (select temp___703 temp___706)) temp___704) (= (to_rep1 (select temp___703 temp___706)) temp___705)))))))
...
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_694 (mk___rep (mk___split_fields rliteral (temp_____aggregate_def_698 32))))))
(declare-const n Int)
(assert (<= 1 n))
(assert (<= n 1000))
(assert (not (= (bool_eq1 (select x1 n) (mk___rep (mk___split_fields rliteral (temp_____aggregate_def_702 32 32)))) true)))
(check-sat)
(exit)
