...
(assert (= result4 bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result4))
(assert (not (bvule bits_manipulation_unsigned__unsigned_64__functions__extract_bits__result4 (make_mask (+ (- to__ from) 1)))))
(check-sat)
(exit)
