...
(assert (forall ((container1 us_rep3)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant5 position1 true true true true) (and (<= 1 position1) (<= position1 (last container1)))) (dynamic_invariant6 (get1 container1 position1) true false true true)) :pattern ((get1 container1 position1))))))
