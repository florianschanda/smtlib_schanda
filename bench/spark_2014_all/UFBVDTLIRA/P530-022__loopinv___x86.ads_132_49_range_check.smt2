...
(declare-const x86__readreg16__result (_ BitVec 16))
(declare-const result (_ BitVec 16))
(declare-const x86__readreg16__result1 (_ BitVec 16))
(declare-const x86__readreg16__result2 (_ BitVec 16))
(declare-const x86__readreg16__result3 (_ BitVec 16))
(declare-const x86__readreg16__result4 (_ BitVec 16))
(declare-const x86__readreg16__result5 (_ BitVec 16))
(assert (= x86__readreg16__result1 x86__readreg16__result2))
(assert (= x86__readreg16__result3 x86__readreg16__result1))
(assert (= (mk_t__ref result) (mk_t__ref x86__readreg16__result)))
(assert (= x86__readreg16__result1 ((_ extract 15 0) (bvand reg #x000000000000FFFF))))
(assert (= (mk_t__ref x86__readreg16__result4) (mk_t__ref x86__readreg16__result2)))
(assert (= x86__readreg16__result5 x86__readreg16__result3))
(assert (not (bvule (bvand reg #x000000000000FFFF) ((_ zero_extend 48) #xFFFF))))
(check-sat)
(exit)
