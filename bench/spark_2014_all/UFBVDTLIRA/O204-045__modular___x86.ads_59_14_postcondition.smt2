...
(assert (= result rax))
(assert (= rax1 (bvor (bvand rax #x000000000000FF00) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) #x0100)))))
(assert (= rax1 rax2))
(assert (= rax3 rax1))
(assert (not (= rax2 (bvor (bvand rax #x000000000000FF00) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) #x0100))))))
(check-sat)
(exit)
