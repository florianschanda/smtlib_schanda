...
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result (_ BitVec 32))
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__len__assume Int)
(declare-const o Int)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__mask__assume (_ BitVec 32))
...
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result1 (_ BitVec 32))
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result2 (_ BitVec 32))
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result3 (_ BitVec 32))
(declare-const result__2 (_ BitVec 32))
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result4 (_ BitVec 32))
(declare-const result__3 (_ BitVec 32))
(declare-const bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result5 (_ BitVec 32))
(declare-const result2 (_ BitVec 32))
(assert (in_range2 from))
(assert (in_range2 to__))
(assert (<= from to__))
(assert (and (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__len__assume (+ (- to__ from) 1)) (in_range (+ (- to__ from) 1))))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__len__assume len))
(assert (in_range len))
(assert (and (= o len) (in_range1 len)))
(assert (and (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__mask__assume (make_mask o)) (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__mask__assume (shift_right #xFFFFFFFF (- 32 o)))))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__mask__assume mask))
(assert (and (= o1 (shift_right value from)) (= o1 (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< from 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) from)) #x00)) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< from 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) from)) #x0000)) (ite (and (<= 17 32) (<= 32 32)) (bvlshr value ((_ int2bv 32) from)) ((_ extract 31 0) (bvlshr ((_ zero_extend 32) value) ((_ int2bv 64) from)))))))))
(assert (= o2 (bvand o1 mask)))
(assert (= (mk_t__ref result) (mk_t__ref result__)))
(assert (= result__1 o2))
(assert (bvule result__1 mask))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result1 bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result2))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result3 bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result1))
(assert (= (mk_t__ref result1) (mk_t__ref bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result)))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result1 result__1))
(assert (= (mk_t__ref bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result4) (mk_t__ref bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result2)))
(assert (= result__1 result__2))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result5 bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result3))
(assert (= result__3 result__1))
(assert (= result2 bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result4))
(assert (not (bvule bits_manipulation_unsigned__unsigned_32__functions__extract_bits_inline_always__result4 (make_mask (+ (- to__ from) 1)))))
(check-sat)
(exit)
