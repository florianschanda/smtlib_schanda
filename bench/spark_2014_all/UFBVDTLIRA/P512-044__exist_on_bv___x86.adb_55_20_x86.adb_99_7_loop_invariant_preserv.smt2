...
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (bvugt n5 var1_range_size) (= n15 result8))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (bvugt n5 var1_range_size) (= n16 #x0000000000000000))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (bvugt n5 var1_range_size) (= n25 result9))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (bvugt n5 var1_range_size) (= n26 (bvsub n5 var1_range_size)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (bvugt n5 var1_range_size) (bvule n26 var2_range_size))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (not (bvugt n5 var1_range_size)) (=> (bvult n5 var2_range_size) (= n15 result10)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (not (bvugt n5 var1_range_size)) (=> (bvult n5 var2_range_size) (= n17 var1_range_size)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (not (bvugt n5 var1_range_size)) (=> (bvult n5 var2_range_size) (= n25 result11)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (not (bvugt n5 var1_range_size)) (=> (bvult n5 var2_range_size) (= n27 n5)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (not (bvugt n5 var1_range_size)) (=> (not (bvult n5 var2_range_size)) (= n15 result12)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (not (bvugt n5 var1_range_size)) (=> (not (bvult n5 var2_range_size)) (= n18 (bvsub var1_range_size n5))))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (not (bvugt n5 var1_range_size)) (=> (not (bvult n5 var2_range_size)) (= n25 result13)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (not (bvugt n5 var1_range_size)) (=> (not (bvult n5 var2_range_size)) (= n28 #x0000000000000000)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (not (bvugt n5 var1_range_size)) (=> (not (bvult n5 var2_range_size)) (= n27 n28)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (not (bvugt n5 var1_range_size)) (=> (not (bvult n5 var2_range_size)) (= n17 n18)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (not (bvugt n5 var1_range_size)) (= n26 n27))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (=> (not (bvugt n5 var1_range_size)) (= n16 n17))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (and (and (and (bvule #x0000000000000000 n16) (bvule n16 var1_range_size)) (and (bvule #x0000000000000000 n26) (bvule n26 var2_range_size))) (= (bvadd var1 n16) (bvadd var2 n26)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5)) (exists ((i (_ BitVec 64))) (and (and (bvule #x0000000000000000 i) (bvule i var1_range_size)) (exists ((j (_ BitVec 64))) (and (and (bvule #x0000000000000000 j) (bvule j var2_range_size)) (= (bvadd var1 i) (bvadd var2 j))))))))
(assert (=> (not (= var1 (bvadd (bvsub var2 var1_range_size) n5))) (= n26 n25)))
(assert (=> (not (= var1 (bvadd (bvsub var2 var1_range_size) n5))) (= n16 n15)))
(assert (not (or (forall ((m (_ BitVec 64))) (=> (and (bvule #x0000000000000000 m) (bvule m n5)) (not (= var1 (bvadd (bvsub var2 var1_range_size) m))))) (exists ((i (_ BitVec 64))) (and (and (bvule #x0000000000000000 i) (bvule i var1_range_size)) (exists ((j (_ BitVec 64))) (and (and (bvule #x0000000000000000 j) (bvule j var2_range_size)) (= (bvadd var1 i) (bvadd var2 j)))))))))
(check-sat)
(exit)
