...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma1 us_void_param) true) (forall ((size Int)) (=> (and (<= 1 size) (<= size 7)) (bvult (make_mask size) (ite (< size 256) (bvshl #x01 ((_ int2bv 8) size)) #x00))))) :pattern ((lemma1 us_void_param)))))
...
(assert (forall ((size Int)) (=> (and (<= 1 size) (<= size 7)) (bvult (make_mask size) (ite (< size 256) (bvshl #x01 ((_ int2bv 8) size)) #x00)))))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result1 bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result2))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result3 bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result1))
(assert (= o (lemma1_goal Tuple0)))
(assert (= result bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result1 o))
(assert (= (mk_bool__ref bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result4) (mk_bool__ref bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result2)))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result5 bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result3))
(assert (= result1 bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result4))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result4 true))
