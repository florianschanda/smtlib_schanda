...
(declare-const result11 (_ BitVec 16))
(declare-const num3 (_ BitVec 16))
(declare-const result12 (_ BitVec 16))
...
(assert (= result10 res2))
(assert (= res3 o))
(assert (=> (bvuge num2 b1) (= result11 num2)))
(assert (=> (bvuge num2 b1) (= num3 (bvsub num2 b1))))
(assert (=> (bvuge num2 b1) (= result12 res3)))
(assert (=> (bvuge num2 b1) (= res4 (bvor res3 bits2))))
(assert (=> (bvuge num2 b1) (= result13 (mk_t__ref res_g2))))
