...
(assert (= result1 true))
(define-fun temp___956 () us_rep2 (keys (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))
(declare-const temp___955 Int)
(assert (in_range5 temp___955))
(assert (= (iter_has_element temp___956 temp___955) true))
(assert (not (= (prop__ (get (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get1 temp___956 temp___955))) true)))
(check-sat)
(exit)
