...
(assert (= t3__mmul__result1 (bvurem (bvmul x y) #x00000000000000E6)))
...
(assert (not (= ((_ extract 15 0) t3__mmul__result4) (bvurem (bvmul ((_ extract 15 0) x) ((_ extract 15 0) y)) #x00E6))))
(check-sat)
(exit)
