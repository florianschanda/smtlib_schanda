...
(assert (= x86__cl__result1 x86__cl__result2))
(assert (= x86__cl__result3 x86__cl__result1))
(assert (= (mk_t__ref result) (mk_t__ref x86__cl__result)))
(assert (= x86__cl__result1 ((_ extract 7 0) (bvand rcx #x00000000000000FF))))
(assert (= (mk_t__ref x86__cl__result4) (mk_t__ref x86__cl__result2)))
(assert (= x86__cl__result5 x86__cl__result3))
(assert (not (bvule ((_ zero_extend 56) #x00) (bvand rcx #x00000000000000FF))))
(check-sat)
(exit)
