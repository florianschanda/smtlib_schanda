...
(assert (forall ((container us_rep)) (forall ((key Int)) (! (=> (dynamic_invariant1 key true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key container k) true)) (= k key))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(define-fun dynamic_invariant4 ((temp___expr_452 Int) (temp___is_init_448 Bool) (temp___skip_constant_449 Bool) (temp___do_toplevel_450 Bool) (temp___do_typ_inv_451 Bool)) Bool (=> (or (= temp___is_init_448 true) (<= 1 2147483647)) (in_range6 temp___expr_452)))
...
(declare-fun user_eq10 (hash_type hash_type) Bool)
(declare-const dummy10 hash_type)
...
(define-fun dynamic_invariant7 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range5 temp___expr_197)))
(declare-const rliteral count_type)
(assert (= (count_typeqtint rliteral) 0))
(assert (= no_element (mk___rep (mk___split_fields rliteral))))
(assert (forall ((container us_rep4)) (! (let ((result (length3 container))) (and (<= result (to_rep (rec__use_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant7 result true false true true))) :pattern ((length3 container)))))
(assert (forall ((container us_rep1)) (forall ((key1 Int)) (! (=> (dynamic_invariant5 key1 true true true true) (let ((result (find container key1))) (and (=> (< 0 result) (and (<= result (length1 container)) (= key1 (get container result)))) (dynamic_invariant7 result true false true true)))) :pattern ((find container key1))))))
...
(assert (forall ((container us_rep)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant1 key1 true true true true) (= (has_key container key1) true)) (let ((result (get2 container key1))) (and (=> (= (distinct 1 0) true) (and (= result (w_get1 container (witness1 container key1))) (forall ((k1 Int)) (=> (and (in_range2 k1) (= (has_key container k1) true)) (= (= k1 key1) (= (witness1 container key1) (witness1 container k1))))))) (dynamic_invariant8 result true false true true)))) :pattern ((get2 container key1))))))
(assert (forall ((container us_rep)) (! (dynamic_invariant7 (length container) true false true true) :pattern ((length container)))))
...
(assert true)
(assert (forall ((container us_rep)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant1 key1 true true true true) (= (has_key container key1) true)) (let ((result (witness1 container key1))) (and (= (has_witness container result) true) (dynamic_invariant7 result true false true true)))) :pattern ((witness1 container key1))))))
(assert (forall ((container us_rep)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant7 witness2 true true true true) (= (has_witness container witness2) true)) (dynamic_invariant8 (w_get1 container witness2) true false true true)) :pattern ((w_get1 container witness2))))))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant7 result true false true true))) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant7 (length2 container) true false true true) :pattern ((length2 container)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key1 us_rep2)) (! (=> (= (has_key1 container key1) true) (let ((result (witness container key1))) (and (= (has_witness1 container result) true) (dynamic_invariant7 result true false true true)))) :pattern ((witness container key1))))))
(assert (forall ((container us_rep3)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant7 witness2 true true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant4 (w_get container witness2) true false true true)) :pattern ((w_get container witness2))))))
(declare-const cu__split_fields count_type)
(declare-const use_maps__my_find__cu__assume count_type)
(declare-const o Int)
(declare-const result count_type)
(declare-const cu__split_fields1 count_type)
(declare-const result1 Bool)
(declare-const cu__split_fields2 count_type)
(declare-const use_maps__my_find__result count_type)
(declare-const temp___789 Int)
(declare-const result2 Int)
(declare-const temp___7891 Int)
(declare-const result3 Bool)
(declare-const use_maps__my_find__result1 us_rep2)
...
(define-fun use_maps__my_find__cu__assume1 () us_rep2 (mk___rep (mk___split_fields use_maps__my_find__cu__assume)))
(assert (= (mk___rep (mk___split_fields rliteral)) no_element))
(assert (in_range1 k))
(assert (and (= use_maps__my_find__cu__assume1 (first s)) (ite (= (= (length3 s) 0) true) (= (bool_eq2 use_maps__my_find__cu__assume1 no_element) true) (and (= (has_key1 (positions s) use_maps__my_find__cu__assume1) true) (= (get1 (positions s) use_maps__my_find__cu__assume1) 1)))))
(assert (= (mk___split_fields__ref (mk___split_fields result)) (mk___split_fields__ref (mk___split_fields cu__split_fields))))
(assert (= use_maps__my_find__cu__assume cu__split_fields1))
(assert (and (= result1 (has_key1 (positions s) (mk___rep cu__split_fields4))) (= (= result1 true) (= (has_key1 (positions s) (mk___rep cu__split_fields4)) true))))
(assert (= result1 true))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep cu__split_fields3)) 1))) (not (= (get (keys s) i) k)))))
(assert (= (has_key1 (positions s) (mk___rep cu__split_fields3)) true))
(assert (= temp___789 result2))
(assert (= temp___7891 (get1 (positions s) (mk___rep cu__split_fields3))))
(assert (and (= o (key s (mk___rep cu__split_fields3))) (and (in_range7 o) (= o (get (keys s) (get1 (positions s) (mk___rep cu__split_fields3)))))))
(assert (= result3 (ite (= o k) true false)))
(assert (not (= result3 true)))
(assert (= use_maps__my_find__result1 (mk___rep (mk___split_fields use_maps__my_find__result))))
(assert (not (or (= (has_key1 (positions s) (mk___rep cu__split_fields3)) true) (= (bool_eq2 (mk___rep cu__split_fields3) no_element) true))))
(check-sat)
(exit)
