...
(assert (= result__2 o1))
(assert (not (= (bvand result__2 (let ((temp___552 (- i1 1))) (ite (< temp___552 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___552)) #x0000000000000000))) (let ((temp___553 (- i1 1))) (ite (< temp___553 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) temp___553)) #x0000000000000000)))))
(check-sat)
(exit)
