...
(define-fun c__split_fields3 () us_split_fields4 (mk___split_fields2 c__split_fields1))
...
(assert (and (= temp___11981 (next (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep2 c__split_fields3))) (ite (= (ite (= (bool_eq3 (mk___rep2 c__split_fields3) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields3)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq3 temp___11981 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___11981) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___11981) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields3)) 1))))))
...
(assert (not (or (< (length (mk___rep l__split_discrs l__split_fields2)) (to_rep1 (rec__my_maps__n__map__capacity l__split_discrs))) (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 (mk___split_fields1 rliteral1 rliteral4))) true))))
(check-sat)
(exit)
