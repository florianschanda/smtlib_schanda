...
(assert (= result rdx))
(assert (= rdx1 (bvor (bvand rdx #x000000000000FF00) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) #x0100)))))
(assert (= rdx1 rdx2))
(assert (= rdx3 rdx1))
(assert (not (= rdx2 (bvor (bvand rdx #x000000000000FF00) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) #x0100))))))
(check-sat)
(exit)
