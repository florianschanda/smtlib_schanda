...
(declare-fun temp_____aggregate_def_281 (map1 Int (_ BitVec 8) Int Int Int (_ BitVec 8) Int Int) map1)
(declare-fun temp_____aggregate_def_295 (Int) map1)
...
(assert (forall ((temp___297 Int)) (=> (dynamic_invariant temp___297 true true true true) (forall ((temp___298 Int) (temp___300 Int)) (forall ((temp___299 (_ BitVec 8))) (= (get (temp_____aggregate_def_295 temp___297) temp___298 temp___299 temp___300) rliteral))))))
(assert (forall ((temp___283 map1)) (forall ((temp___284 Int) (temp___286 Int) (temp___287 Int) (temp___288 Int) (temp___290 Int) (temp___291 Int)) (forall ((temp___285 (_ BitVec 8)) (temp___289 (_ BitVec 8))) (let ((temp___282 (temp_____aggregate_def_281 temp___283 temp___284 temp___285 temp___286 temp___287 temp___288 temp___289 temp___290 temp___291))) (=> (and (and (and (and (and (and (and (dynamic_invariant1 temp___284 true true true true) (dynamic_invariant2 temp___285 true true true true)) (dynamic_invariant3 temp___286 true true true true)) (dynamic_invariant temp___287 true true true true)) (dynamic_invariant1 temp___288 true true true true)) (dynamic_invariant2 temp___289 true true true true)) (dynamic_invariant3 temp___290 true true true true)) (dynamic_invariant temp___291 true true true true)) (forall ((temp___292 Int) (temp___294 Int)) (forall ((temp___293 (_ BitVec 8))) (ite (and (and (= temp___292 temp___288) (= temp___293 temp___289)) (= temp___294 temp___290)) (= (to_rep (get temp___282 temp___292 temp___293 temp___294)) temp___291) (ite (and (and (= temp___292 temp___284) (= temp___293 temp___285)) (= temp___294 temp___286)) (= (to_rep (get temp___282 temp___292 temp___293 temp___294)) temp___287) (= (get temp___282 temp___292 temp___293 temp___294) (get temp___283 temp___292 temp___293 temp___294))))))))))))
...
(assert (= a3 a4))
(assert (= a5 a3))
(assert (not (= (bool_eq a4 1 10 #x00 #x07 0 2 (temp_____aggregate_def_281 (temp_____aggregate_def_295 1000) 5 #x07 1 v1 x y 2 v2) 1 10 #x00 #x07 0 2) true)))
(check-sat)
(exit)
