...
(assert (and (= o1 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) c1)) (= (= o1 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) c1) true))))
(assert (= o2 true))
(assert (= result1 (ite (= o2 true) o1 false)))
(assert (= result1 true))
(assert (and (= o3 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) c1)) (and (in_range2 o3) (= o3 (get (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) c1))))))
(assert (not (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) c1) true)))
(check-sat)
(exit)
