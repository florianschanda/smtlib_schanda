...
(assert (and (bvule scale_num scale_denom) (and (or (= scale_num #x0000000000000000) (bvule val__ (bvudiv #xFFFFFFFFFFFFFFFF scale_num))) (= res (bvudiv (bvmul val__ scale_num) scale_denom)))))
