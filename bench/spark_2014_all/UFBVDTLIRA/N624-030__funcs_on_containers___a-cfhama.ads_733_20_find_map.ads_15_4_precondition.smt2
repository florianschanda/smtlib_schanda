...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__find_map__index_maps__map__capacity (us_split_discrs1 a))) (to_rep1 (rec__find_map__index_maps__map__capacity (us_split_discrs1 b)))) (= (to_rep (rec__find_map__index_maps__map__modulus (us_split_discrs1 a))) (to_rep (rec__find_map__index_maps__map__modulus (us_split_discrs1 b))))) (= (us_main_eq (rec__find_map__index_maps__map (us_split_fields1 a)) (rec__find_map__index_maps__map (us_split_fields1 b))) true)) true false))
...
(define-fun dynamic_invariant ((temp___expr_198 Int) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool (=> (or (= temp___is_init_194 true) (<= 0 2147483647)) (in_range1 temp___expr_198)))
(declare-fun oeq (us_rep us_rep) Bool)
(declare-fun oeq__function_guard (Bool us_rep us_rep) Bool)
(assert (forall ((a us_rep) (b us_rep)) (! (= (user_eq2 a b) (oeq a b)) :pattern ((user_eq2 a b)))))
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__find_map__index_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep1 (rec__find_map__index_maps__cursor__node (us_split_fields3 a))) (to_rep1 (rec__find_map__index_maps__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_466 Int) (temp___is_init_462 Bool) (temp___skip_constant_463 Bool) (temp___do_toplevel_464 Bool) (temp___do_typ_inv_465 Bool)) Bool (=> (or (= temp___is_init_462 true) (<= 1 2147483647)) (in_range2 temp___expr_466)))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(declare-fun is_empty (us_rep2) Bool)
(declare-fun is_empty__function_guard (Bool us_rep2) Bool)
(define-fun default_initial_assumption ((temp___expr_474 us_rep2) (temp___skip_top_level_475 Bool)) Bool (=> (not (= temp___skip_top_level_475 true)) (and (= (is_empty temp___expr_474) true) (= (length1 temp___expr_474) 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_191 (_ BitVec 32)) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool) (temp___do_typ_inv_190 Bool)) Bool true)
...
(define-fun default_initial_assumption1 ((temp___expr_415 us_rep3) (temp___skip_top_level_416 Bool)) Bool (=> (not (= temp___skip_top_level_416 true)) (and (= (is_empty1 temp___expr_415) true) (= (length2 temp___expr_415) 0))))
(assert true)
...
(define-fun dynamic_invariant4 ((temp___expr_400 Int) (temp___is_init_396 Bool) (temp___skip_constant_397 Bool) (temp___do_toplevel_398 Bool) (temp___do_typ_inv_399 Bool)) Bool (=> (or (= temp___is_init_396 true) (<= 0 2147483647)) (in_range4 temp___expr_400)))
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (dynamic_invariant4 key true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range4 k) (= (has_key1 container1 k) true)) (= (equivalent_keys k key) true))) (= (has_key1 container1 key) true)))) :pattern ((has_key1 container1 key))))))
...
(define-fun dynamic_invariant5 ((temp___expr_407 Int) (temp___is_init_403 Bool) (temp___skip_constant_404 Bool) (temp___do_toplevel_405 Bool) (temp___do_typ_inv_406 Bool)) Bool (=> (or (= temp___is_init_403 true) (<= 1 100)) (in_range5 temp___expr_407)))
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (and (dynamic_invariant4 key true true true true) (= (has_key1 container1 key) true)) (let ((result (get1 container1 key))) (and (=> (= (distinct 1 0) true) (and (= result (w_get1 container1 (witness1 container1 key))) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key1 container1 k) true)) (= (= (equivalent_keys k key) true) (= (witness1 container1 key) (witness1 container1 k))))))) (dynamic_invariant5 result true false true true)))) :pattern ((get1 container1 key))))))
(assert (forall ((container1 us_rep3)) (! (dynamic_invariant (length2 container1) true false true true) :pattern ((length2 container1)))))
(assert (forall ((left us_rep3) (right us_rep3)) (! (= (= (oeq1 left right) true) (and (forall ((key Int)) (=> (and (in_range4 key) (= (has_key1 left key) true)) (and (= (has_key1 right key) true) (= (get1 right key) (get1 left key))))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key1 right key) true)) (= (has_key1 left key) true))))) :pattern ((oeq1 left right)))))
(assert (forall ((container1 us_rep3)) (! (= (= (is_empty1 container1) true) (forall ((key Int)) (not (and (in_range4 key) (= (has_key1 container1 key) true))))) :pattern ((is_empty1 container1)))))
(declare-fun has_witness (us_rep3 Int) Bool)
(declare-fun has_witness__function_guard (Bool us_rep3 Int) Bool)
(assert true)
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (and (dynamic_invariant4 key true true true true) (= (has_key1 container1 key) true)) (let ((result (witness1 container1 key))) (and (= (has_witness container1 result) true) (dynamic_invariant result true false true true)))) :pattern ((witness1 container1 key))))))
(assert (forall ((container1 us_rep3)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant witness2 true true true true) (= (has_witness container1 witness2) true)) (dynamic_invariant5 (w_get1 container1 witness2) true false true true)) :pattern ((w_get1 container1 witness2))))))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep1 (rec__find_map__index_maps__map__capacity (us_split_discrs1 container)))))))
