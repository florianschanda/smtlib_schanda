...
(define-fun n29 () t__ref (mk_t__ref n2))
(define-fun n19 () t__ref (mk_t__ref n1))
(assert (bvule var1_range_size (bvsub #xFFFFFFFFFFFFFFFF var2_range_size)))
(assert (and (= x86__rangesintersect__B100b__res__assume (inrange64 var1 (bvsub var2 var1_range_size) (bvadd var1_range_size var2_range_size))) (= (= x86__rangesintersect__B100b__res__assume true) (exists ((n6 (_ BitVec 64))) (and (and (bvule #x0000000000000000 n6) (bvule n6 (bvadd var1_range_size var2_range_size))) (= var1 (bvadd (bvsub var2 var1_range_size) n6)))))))
(assert (= x86__rangesintersect__B100b__res__assume res))
(assert (= res true))
(assert (= (mk_t__ref result) (mk_t__ref n)))
(assert (= n3 #x0000000000000000))
(assert (bvule #x0000000000000000 n3))
(assert (bvule n3 (bvadd var1_range_size var2_range_size)))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (bvugt n3 var1_range_size) (= (mk_t__ref result1) n19))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (bvugt n3 var1_range_size) (= n12 #x0000000000000000))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (bvugt n3 var1_range_size) (= (mk_t__ref result2) n29))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (bvugt n3 var1_range_size) (= n22 (bvsub n3 var1_range_size)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (bvugt n3 var1_range_size) (bvule n22 var2_range_size))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (bvult n3 var2_range_size) (= (mk_t__ref result3) n19)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (bvult n3 var2_range_size) (= n13 var1_range_size)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (bvult n3 var2_range_size) (= (mk_t__ref result4) n29)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (bvult n3 var2_range_size) (= n23 n3)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= (mk_t__ref result5) n19)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= n14 (bvsub var1_range_size n3))))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= (mk_t__ref result6) n29)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= n24 #x0000000000000000)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= n23 n24)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (=> (not (bvult n3 var2_range_size)) (= n13 n14)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (= n22 n23))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (=> (not (bvugt n3 var1_range_size)) (= n12 n13))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (and (and (and (bvule #x0000000000000000 n12) (bvule n12 var1_range_size)) (and (bvule #x0000000000000000 n22) (bvule n22 var2_range_size))) (= (bvadd var1 n12) (bvadd var2 n22)))))
(assert (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3)) (exists ((i (_ BitVec 64))) (and (and (bvule #x0000000000000000 i) (bvule i var1_range_size)) (exists ((j (_ BitVec 64))) (and (and (bvule #x0000000000000000 j) (bvule j var2_range_size)) (= (bvadd var1 i) (bvadd var2 j))))))))
(assert (=> (not (= var1 (bvadd (bvsub var2 var1_range_size) n3))) (= n22 n2)))
(assert (=> (not (= var1 (bvadd (bvsub var2 var1_range_size) n3))) (= n12 n1)))
(assert (=> (not (= var1 (bvadd (bvsub var2 var1_range_size) n3))) (= n22 n21)))
(assert (=> (not (= var1 (bvadd (bvsub var2 var1_range_size) n3))) (= n12 n11)))
(assert (or (forall ((m (_ BitVec 64))) (=> (and (bvule #x0000000000000000 m) (bvule m n4)) (not (= var1 (bvadd (bvsub var2 var1_range_size) m))))) (exists ((i (_ BitVec 64))) (and (and (bvule #x0000000000000000 i) (bvule i var1_range_size)) (exists ((j (_ BitVec 64))) (and (and (bvule #x0000000000000000 j) (bvule j var2_range_size)) (= (bvadd var1 i) (bvadd var2 j))))))))
(assert (and (=> (bvule #x0000000000000000 (bvadd var1_range_size var2_range_size)) (dynamic_property #x0000000000000000 (bvadd var1_range_size var2_range_size) n4)) (and (bvule #x0000000000000000 n4) (bvule n4 (bvadd var1_range_size var2_range_size)))))
(assert (not (= n4 (bvadd var1_range_size var2_range_size))))
(assert (= n4 result7))
(assert (= n5 (bvadd n4 #x0000000000000001)))
(assert (= var1 (bvadd (bvsub var2 var1_range_size) n5)))
(assert (=> (bvugt n5 var1_range_size) (= n15 result8)))
(assert (=> (bvugt n5 var1_range_size) (= n16 #x0000000000000000)))
(assert (=> (bvugt n5 var1_range_size) (= n25 result9)))
(assert (=> (bvugt n5 var1_range_size) (= n26 (bvsub n5 var1_range_size))))
(assert (=> (bvugt n5 var1_range_size) (bvule n26 var2_range_size)))
(assert (=> (not (bvugt n5 var1_range_size)) (=> (bvult n5 var2_range_size) (= n15 result10))))
(assert (=> (not (bvugt n5 var1_range_size)) (=> (bvult n5 var2_range_size) (= n17 var1_range_size))))
(assert (=> (not (bvugt n5 var1_range_size)) (=> (bvult n5 var2_range_size) (= n25 result11))))
(assert (=> (not (bvugt n5 var1_range_size)) (=> (bvult n5 var2_range_size) (= n27 n5))))
(assert (=> (not (bvugt n5 var1_range_size)) (=> (not (bvult n5 var2_range_size)) (= n15 result12))))
(assert (=> (not (bvugt n5 var1_range_size)) (=> (not (bvult n5 var2_range_size)) (= n18 (bvsub var1_range_size n5)))))
(assert (=> (not (bvugt n5 var1_range_size)) (=> (not (bvult n5 var2_range_size)) (= n25 result13))))
(assert (=> (not (bvugt n5 var1_range_size)) (=> (not (bvult n5 var2_range_size)) (= n28 #x0000000000000000))))
(assert (=> (not (bvugt n5 var1_range_size)) (=> (not (bvult n5 var2_range_size)) (= n27 n28))))
(assert (=> (not (bvugt n5 var1_range_size)) (=> (not (bvult n5 var2_range_size)) (= n17 n18))))
(assert (=> (not (bvugt n5 var1_range_size)) (= n26 n27)))
(assert (=> (not (bvugt n5 var1_range_size)) (= n16 n17)))
(assert (and (and (and (bvule #x0000000000000000 n16) (bvule n16 var1_range_size)) (and (bvule #x0000000000000000 n26) (bvule n26 var2_range_size))) (= (bvadd var1 n16) (bvadd var2 n26))))
