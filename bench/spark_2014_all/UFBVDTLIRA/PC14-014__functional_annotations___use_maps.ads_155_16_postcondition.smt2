...
(define-fun dynamic_invariant ((temp___expr_422 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 1 2147483647)) (in_range1 temp___expr_422)))
...
(define-fun dynamic_invariant1 ((temp___expr_429 Int) (temp___is_init_425 Bool) (temp___skip_constant_426 Bool) (temp___do_toplevel_427 Bool) (temp___do_typ_inv_428 Bool)) Bool (=> (or (= temp___is_init_425 true) (<= 0 2147483647)) (in_range2 temp___expr_429)))
...
(define-fun default_initial_assumption ((temp___expr_437 us_rep) (temp___skip_top_level_438 Bool)) Bool (=> (not (= temp___skip_top_level_438 true)) (= (length temp___expr_437) 0)))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__use_maps__my_maps__map us_main_type1)))))
(define-fun us_split_fields_Map__projection ((a us_split_fields)) us_main_type1 (rec__use_maps__my_maps__map a))
...
(assert (forall ((container us_rep1)) (! (let ((result (keys container))) (and (and (and (and (= (length result) (length1 container)) (forall ((temp___478 Int)) (=> (and (in_range2 temp___478) (= (iter_has_element result temp___478) true)) (= (has_key (model__ container) (get result temp___478)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (get result (find result key)) key))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length1 container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_353)))
...
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= result (to_rep1 (rec__use_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant5 result true false true true))) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep)) (forall ((key1 Int)) (! (=> (dynamic_invariant6 key1 true true true true) (let ((result (find container key1))) (and (=> (< 0 result) (and (<= result (length container)) (= key1 (get container result)))) (dynamic_invariant5 result true false true true)))) :pattern ((find container key1))))))
...
(define-fun default_initial_assumption1 ((temp___expr_401 us_rep2) (temp___skip_top_level_402 Bool)) Bool (=> (not (= temp___skip_top_level_402 true)) (and (= (is_empty temp___expr_401) true) (= (length2 temp___expr_401) 0))))
(assert true)
...
(assert (forall ((container us_rep2)) (forall ((key1 Int)) (! (=> (dynamic_invariant7 key1 true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range4 k) (= (has_key container k) true)) (= k key1))) (= (has_key container key1) true)))) :pattern ((has_key container key1))))))
...
(assert (forall ((container us_rep2)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant7 key1 true true true true) (= (has_key container key1) true)) (let ((result (get2 container key1))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key1))) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key container k) true)) (= (= k key1) (= (witness container key1) (witness container k))))))) (dynamic_invariant8 result true false true true)))) :pattern ((get2 container key1))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant5 (length2 container) true false true true) :pattern ((length2 container)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant7 key1 true true true true) (= (has_key container key1) true)) (let ((result (witness container key1))) (and (= (has_witness container result) true) (dynamic_invariant5 result true false true true)))) :pattern ((witness container key1))))))
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant5 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant8 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key1 us_rep3)) (! (=> (= (has_key1 container key1) true) (let ((result (witness1 container key1))) (and (= (has_witness1 container result) true) (dynamic_invariant5 result true false true true)))) :pattern ((witness1 container key1))))))
(assert (forall ((container us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant5 witness2 true true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant9 (w_get1 container witness2) true false true true)) :pattern ((w_get1 container witness2))))))
(assert (forall ((cu us_rep3)) (=> (= (has_key1 (positions s) cu) true) (= (q (element s cu)) true))))
(assert (let ((temp___487 (keys s))) (forall ((temp___486 Int)) (=> (and (in_range2 temp___486) (= (iter_has_element temp___487 temp___486) true)) (exists ((i us_rep3)) (and (= (has_key1 (positions s) i) true) (= (get (keys s) (get1 (positions s) i)) (get temp___487 temp___486))))))))
(define-fun temp___1029 () us_rep (keys s))
(declare-const temp___1028 Int)
(assert (in_range2 temp___1028))
(assert (= (iter_has_element temp___1029 temp___1028) true))
(assert (not (= (q (get2 (model__ s) (get temp___1029 temp___1028))) true)))
(check-sat)
(exit)
