...
(declare-const temp___1010 us_rep1)
(declare-const k Int)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const result Bool)
(assert (= temp___1010 (model__ s)))
(assert (and (= o (has_key temp___1010 k)) (=> (= (distinct 1 0) true) (=> (exists ((k1 Int)) (and (and (in_range2 k1) (= (has_key temp___1010 k1) true)) (= k1 k))) (= o true)))))
