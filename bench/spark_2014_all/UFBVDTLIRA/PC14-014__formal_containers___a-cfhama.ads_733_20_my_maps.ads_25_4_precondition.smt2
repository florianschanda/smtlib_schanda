...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep1 (rec__my_maps__n__cursor__node (us_split_fields3 a))) (to_rep1 (rec__my_maps__n__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun default_initial_assumption ((temp___expr_736 us_rep2) (temp___skip_top_level_737 Bool)) Bool (=> (not (= temp___skip_top_level_737 true)) (and (= (is_empty temp___expr_736) true) (= (length1 temp___expr_736) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_675 us_rep4) (temp___skip_top_level_676 Bool)) Bool (=> (not (= temp___skip_top_level_676 true)) (and (= (is_empty1 temp___expr_675) true) (= (length2 temp___expr_675) 0))))
(assert true)
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep1 (rec__my_maps__n__map__capacity (us_split_discrs1 container)))))))
