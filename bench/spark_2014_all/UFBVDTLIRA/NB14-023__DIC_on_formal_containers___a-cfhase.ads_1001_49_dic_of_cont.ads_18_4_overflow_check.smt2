...
(define-fun default_initial_assumption ((temp___expr_875 us_rep1) (temp___skip_top_level_876 Bool)) Bool (=> (not (= temp___skip_top_level_876 true)) (= (length1 temp___expr_875) 0)))
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length1 container)) (= item (get container result)))) (dynamic_invariant result true false true true)))) :pattern ((find container item))))))
...
(assert (and (= o (length right)) (and (in_range o) (<= o (to_rep1 (rec__dic_of_cont__my_hase__set__capacity (us_split_discrs1 right)))))))
