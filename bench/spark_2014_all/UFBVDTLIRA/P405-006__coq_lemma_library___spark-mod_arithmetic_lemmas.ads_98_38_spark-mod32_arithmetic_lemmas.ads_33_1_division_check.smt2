...
(assert (=> (= scale_num #x00000000) (= result true)))
(assert (=> (not (= scale_num #x00000000)) (= result (ite (bvule val__ (bvudiv #xFFFFFFFF scale_num)) true false))))
(assert (= result true))
(assert (not (not (= scale_denom #x00000000))))
(check-sat)
(exit)
