...
(assert (= result2 true))
(assert (and (= o4 (keys s1)) (and (and (and (and (= (length1 o4) (length3 s1)) (forall ((temp___474 Int)) (=> (and (in_range3 temp___474) (= (iter_has_element o4 temp___474) true)) (= (has_key (model__ s1) (get o4 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range1 key1) (= (has_key (model__ s1) key1) true)) (and (< 0 (find o4 key1)) (= (get o4 (find o4 key1)) key1))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length3 s1))) (= (find o4 (get o4 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length3 s1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length3 s1))) (=> (= (get o4 i1) (get o4 j)) (= i1 j)))))))))
