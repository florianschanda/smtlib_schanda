...
(define-fun dynamic_invariant3 ((temp___expr_214 (_ BitVec 16)) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool true)
(assert (in_range1 amount))
(assert (not (and (<= 1 32) (<= 32 8))))
(assert (not (and (<= 9 32) (<= 32 16))))
(assert (not (and (<= 17 32) (<= 32 32))))
(assert (not (bvule ((_ zero_extend 32) #x00000000) (bvlshr ((_ zero_extend 32) v) ((_ int2bv 64) amount)))))
(check-sat)
(exit)
