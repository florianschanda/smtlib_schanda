...
(assert (let ((temp___480 (elements s))) (forall ((temp___479 Int)) (=> (and (in_range3 temp___479) (= (iter_has_element temp___480 temp___479) true)) (exists ((i1 us_rep3)) (and (= (has_key (positions s) i1) true) (= (get (elements s) (get1 (positions s) i1)) (get temp___480 temp___479))))))))
