...
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (make_mask j1) (bvsub (ite (< j1 256) (bvshl #x01 ((_ int2bv 8) j1)) #x00) #x01)))))
(assert (and (=> (<= 2 7) (in_range2 i2)) (and (<= 2 i2) (<= i2 7))))
(assert (<= 1 j))
(assert (<= j (- i2 1)))
(assert (=> (< j 256) (= o (bvshl #x01 ((_ int2bv 8) j)))))
(assert (=> (not (< j 256)) (= o #x00)))
(assert (= o1 (bvsub o #x01)))
