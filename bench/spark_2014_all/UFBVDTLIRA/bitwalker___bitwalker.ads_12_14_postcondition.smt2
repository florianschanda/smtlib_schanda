...
(assert (=> (= result true) (= o3 (bvshl #x01 o2))))
(assert (=> (not (= result true)) (= o3 #x00)))
(assert (= o4 (bvand byte o3)))
(assert (= o5 (ite (= o4 #x00) true false)))
(assert (= bitwalker__peekbit8__ret__assume (ite (not (= o5 true)) true false)))
...
(assert (= (mk_bool__ref result1) (mk_bool__ref bitwalker__peekbit8__result)))
(assert (= bitwalker__peekbit8__result1 ret))
(assert (= (mk_bool__ref bitwalker__peekbit8__result4) (mk_bool__ref bitwalker__peekbit8__result2)))
(assert (= bitwalker__peekbit8__result5 bitwalker__peekbit8__result3))
(assert (= result2 bitwalker__peekbit8__result4))
(assert (= (nth byte (- 7 left)) true))
(assert (not (= bitwalker__peekbit8__result4 true)))
(check-sat)
(exit)
