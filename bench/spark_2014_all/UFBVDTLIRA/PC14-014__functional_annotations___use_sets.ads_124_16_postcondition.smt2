...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__use_sets__my_sets__set us_main_type1)))))
(define-fun us_split_fields_Set__projection ((a us_split_fields)) us_main_type1 (rec__use_sets__my_sets__set a))
...
(declare-fun elements (us_rep1) us_rep4)
(declare-fun elements__function_guard (us_rep4 us_rep1) Bool)
(define-fun element ((container us_rep1) (position us_rep2)) Int (get (elements container) (get1 (positions container) position)))
...
(define-fun dynamic_invariant2 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 0 2147483647)) (in_range4 temp___expr_346)))
(assert true)
...
(define-fun dynamic_invariant4 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range2 temp___expr_197)))
...
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__use_sets__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant4 result true false true true))) :pattern ((length container)))))
...
(define-fun oeq1 ((left us_rep4) (right us_rep4)) Bool (and (= (length2 left) (length2 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
(declare-fun oeq__function_guard1 (Bool us_rep4 us_rep4) Bool)
(assert (forall ((a us_rep4) (b us_rep4)) (! (= (user_eq7 a b) (oeq1 a b)) :pattern ((user_eq7 a b)))))
...
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= item (get container result)))) (dynamic_invariant4 result true false true true)))) :pattern ((find container item))))))
...
(assert (forall ((container us_rep1)) (! (let ((result (elements container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___471 Int)) (=> (and (in_range5 temp___471) (= (iter_has_element result temp___471) true)) (= (contains (model__ container) (get result temp___471)) true)))) (forall ((item Int)) (=> (and (in_range1 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(assert (forall ((container us_rep)) (! (dynamic_invariant4 (length1 container) true false true true) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep4)) (! (let ((result (length2 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant4 result true false true true))) :pattern ((length2 container)))))
...
(define-fun dynamic_invariant6 ((temp___expr_415 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool) (temp___do_typ_inv_414 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 0 2147483647)) (in_range6 temp___expr_415)))
(assert (forall ((container us_rep4)) (forall ((position Int)) (! (=> (and (dynamic_invariant5 position true true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant6 (get container position) true false true true)) :pattern ((get container position))))))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant4 (length3 container) true false true true) :pattern ((length3 container)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key us_rep2)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant4 result true false true true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant4 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant7 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
(assert (forall ((e Int)) (=> (and (in_range1 e) (= (contains (model__ s) e) true)) (= (q e) true))))
(declare-const cu us_rep2)
(assert (= (has_key (positions s) cu) true))
(assert (not (= (q (element s cu)) true)))
(check-sat)
(exit)
