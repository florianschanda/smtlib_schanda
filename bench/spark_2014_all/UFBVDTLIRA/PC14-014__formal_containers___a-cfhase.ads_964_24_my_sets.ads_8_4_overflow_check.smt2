...
(define-fun dynamic_invariant2 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 2147483647)) (in_range2 temp___expr_346)))
...
(define-fun default_initial_assumption ((temp___expr_423 us_rep2) (temp___skip_top_level_424 Bool)) Bool (=> (not (= temp___skip_top_level_424 true)) (= (length1 temp___expr_423) 0)))
...
(define-fun default_initial_assumption1 ((temp___expr_387 us_rep1) (temp___skip_top_level_388 Bool)) Bool (=> (not (= temp___skip_top_level_388 true)) (= (is_empty temp___expr_387) true)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length1 result) (length container)) (forall ((temp___464 Int)) (=> (and (in_range5 temp___464) (= (iter_has_element result temp___464) true)) (= (contains (model__ container) (get result temp___464)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_379 Int) (temp___is_init_375 Bool) (temp___skip_constant_376 Bool) (temp___do_toplevel_377 Bool) (temp___do_typ_inv_378 Bool)) Bool (=> (or (= temp___is_init_375 true) (<= 1 2147483647)) (in_range4 temp___expr_379)))
...
(define-fun dynamic_invariant4 ((temp___expr_415 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool) (temp___do_typ_inv_414 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 0 2147483647)) (in_range5 temp___expr_415)))
...
(define-fun dynamic_invariant5 ((temp___expr_408 Int) (temp___is_init_404 Bool) (temp___skip_constant_405 Bool) (temp___do_toplevel_406 Bool) (temp___do_typ_inv_407 Bool)) Bool (=> (or (= temp___is_init_404 true) (<= 1 2147483647)) (in_range6 temp___expr_408)))
...
(assert (and (= o11 (length o15)) (and (in_range o11) (<= o11 (to_rep1 o8)))))
(assert (and (= o6 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range o6) (<= o6 (to_rep1 (rec__my_sets__m__set__capacity target__split_discrs))))))
(assert (= o7 (- (to_rep1 (rec__my_sets__m__set__capacity target__split_discrs)) o6)))
(assert (and (= o12 o7) (in_range1 o7)))
(assert (= o13 (+ o12 o11)))
...
(assert (and (= o3 (length o16)) (and (in_range o3) (<= o3 (to_rep1 o)))))
(assert (and (= o4 (length source)) (and (in_range o4) (<= o4 (to_rep1 (rec__my_sets__m__set__capacity (us_split_discrs1 source)))))))
(assert (= o5 (- o4 o3)))
