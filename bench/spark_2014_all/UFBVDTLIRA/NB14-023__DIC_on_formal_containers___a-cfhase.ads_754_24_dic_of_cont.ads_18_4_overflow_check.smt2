...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__dic_of_cont__my_hase__set__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_798 Int) (temp___is_init_794 Bool) (temp___skip_constant_795 Bool) (temp___do_toplevel_796 Bool) (temp___do_typ_inv_797 Bool)) Bool (=> (or (= temp___is_init_794 true) (<= 0 2147483647)) (in_range2 temp___expr_798)))
...
(define-fun default_initial_assumption ((temp___expr_875 us_rep2) (temp___skip_top_level_876 Bool)) Bool (=> (not (= temp___skip_top_level_876 true)) (= (length1 temp___expr_875) 0)))
...
(define-fun default_initial_assumption1 ((temp___expr_839 us_rep1) (temp___skip_top_level_840 Bool)) Bool (=> (not (= temp___skip_top_level_840 true)) (= (is_empty temp___expr_839) true)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length1 result) (length container)) (forall ((temp___916 Int)) (=> (and (in_range5 temp___916) (= (iter_has_element result temp___916) true)) (= (contains (model__ container) (get result temp___916)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_831 Int) (temp___is_init_827 Bool) (temp___skip_constant_828 Bool) (temp___do_toplevel_829 Bool) (temp___do_typ_inv_830 Bool)) Bool (=> (or (= temp___is_init_827 true) (<= 0 2147483647)) (in_range4 temp___expr_831)))
...
(define-fun dynamic_invariant4 ((temp___expr_867 Int) (temp___is_init_863 Bool) (temp___skip_constant_864 Bool) (temp___do_toplevel_865 Bool) (temp___do_typ_inv_866 Bool)) Bool (=> (or (= temp___is_init_863 true) (<= 0 2147483647)) (in_range5 temp___expr_867)))
...
(define-fun dynamic_invariant5 ((temp___expr_860 Int) (temp___is_init_856 Bool) (temp___skip_constant_857 Bool) (temp___do_toplevel_858 Bool) (temp___do_typ_inv_859 Bool)) Bool (=> (or (= temp___is_init_856 true) (<= 0 2147483647)) (in_range6 temp___expr_860)))
...
(define-fun o9 () us_rep (mk___rep (mk___split_discrs o o1) (mk___split_fields o2)))
(assert (and (= o6 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range o6) (<= o6 (to_rep1 (rec__dic_of_cont__my_hase__set__capacity target__split_discrs))))))
(assert (= o7 (- (to_rep1 (rec__dic_of_cont__my_hase__set__capacity target__split_discrs)) o6)))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (and (= o9 (intersection__2 (mk___rep target__split_discrs (mk___split_fields target__split_fields)) source)) (and (and (and (and (and (= (length o9) (num_overlaps (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source))) (= (ole (model__ o9) (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true)) (= (ole (model__ o9) (model__ source)) true)) (= (includes_intersection (model__ o9) (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source)) true)) (= (e_elements_included (elements o9) (elements (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true)) (= (e_elements_included__2 (elements (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source) (elements o9)) true))))
(assert (and (= o3 (length o9)) (and (in_range o3) (<= o3 (to_rep1 o)))))
(assert (and (= o4 (length source)) (and (in_range o4) (<= o4 (to_rep1 (rec__dic_of_cont__my_hase__set__capacity (us_split_discrs1 source)))))))
(assert (= o5 (- o4 o3)))
