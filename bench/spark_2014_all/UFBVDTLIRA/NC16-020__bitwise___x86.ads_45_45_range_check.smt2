...
(define-fun dynamic_invariant1 ((temp___expr_242 (_ BitVec 32)) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool true)
...
(assert (not (bvule (bvand rax #x00000000FFFFFFFF) ((_ zero_extend 32) #xFFFFFFFF))))
(check-sat)
(exit)
