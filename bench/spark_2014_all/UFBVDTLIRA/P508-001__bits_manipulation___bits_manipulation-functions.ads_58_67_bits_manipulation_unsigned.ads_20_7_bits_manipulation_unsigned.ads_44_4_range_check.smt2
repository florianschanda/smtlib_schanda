...
(assert (bvule #x00000000 val__))
(assert (bvule val__ #xFFFFFFFF))
(assert (not (= val__ #x00000000)))
(assert (<= 0 n))
(assert (<= n 31))
(assert (= (= result true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 n)) (bvuge (shift_right val__ j1) #x00000001)))))
(assert (= result true))
(assert (<= n j))
(assert (<= j 31))
