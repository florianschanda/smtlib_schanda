...
(declare-const x86__bx__result (_ BitVec 16))
(declare-const result (_ BitVec 16))
(declare-const x86__bx__result1 (_ BitVec 16))
(declare-const x86__bx__result2 (_ BitVec 16))
(declare-const x86__bx__result3 (_ BitVec 16))
...
(assert (= x86__bx__result1 ((_ extract 15 0) (bvand rbx #x000000000000FFFF))))
(assert (= (mk_t__ref x86__bx__result4) (mk_t__ref x86__bx__result2)))
(assert (= x86__bx__result5 x86__bx__result3))
(assert (= result1 x86__bx__result4))
(assert (not (= x86__bx__result4 (readreg16 rbx))))
(check-sat)
(exit)
