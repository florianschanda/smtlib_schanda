...
(define-fun in_range ((x (_ BitVec 64))) Bool (and (bvule #x0000000000000001 x) (bvule x #xFFFFFFFFFFFFFFFF)))
...
(define-fun dynamic_invariant1 ((temp___expr_242 (_ BitVec 64)) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (bvule #x0000000000000001 #xFFFFFFFFFFFFFFFF)) (in_range temp___expr_242)))
...
(assert (=> (= scale_num #x0000000000000000) (= result true)))
(assert (=> (not (= scale_num #x0000000000000000)) (= result (ite (bvule val__ (bvudiv #xFFFFFFFFFFFFFFFF scale_num)) true false))))
(assert (= result true))
