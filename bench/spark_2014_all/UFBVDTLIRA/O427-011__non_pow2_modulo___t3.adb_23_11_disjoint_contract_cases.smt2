...
(assert (in_range1 x))
(assert (in_range1 y))
(assert (not (<= (+ (+ (+ (+ (+ 0 (ite (= (ite (= (= x #x0000000000000000) true) (= y #x0000000000000000) false) true) 1 0)) (ite (= (ite (= (not (= x #x0000000000000000)) true) (= y #x0000000000000000) false) true) 1 0)) (ite (= (ite (= (= x #x0000000000000000) true) (not (= y #x0000000000000000)) false) true) 1 0)) (ite (= (ite (= (= x #x0000000000000002) true) (= y #x0000000000000004) false) true) 1 0)) (ite (= (ite (= (= x #x0000000000000004) true) (= y #x0000000000000002) false) true) 1 0)) 1)))
(check-sat)
(exit)
