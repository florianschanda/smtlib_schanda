...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__my_sets__n__cursor__node count_type)))))
(define-fun us_split_fields_Node__2__projection ((a us_split_fields2)) count_type (rec__my_sets__n__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep1 (rec__my_sets__n__cursor__node (us_split_fields3 a))) (to_rep1 (rec__my_sets__n__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_792 Int) (temp___is_init_788 Bool) (temp___skip_constant_789 Bool) (temp___do_toplevel_790 Bool) (temp___do_typ_inv_791 Bool)) Bool (=> (or (= temp___is_init_788 true) (<= 1 2147483647)) (in_range2 temp___expr_792)))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(declare-fun is_empty (us_rep2) Bool)
(declare-fun is_empty__function_guard (Bool us_rep2) Bool)
(define-fun default_initial_assumption ((temp___expr_800 us_rep2) (temp___skip_top_level_801 Bool)) Bool (=> (not (= temp___skip_top_level_801 true)) (and (= (is_empty temp___expr_800) true) (= (length1 temp___expr_800) 0))))
...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__my_sets__my_rec__f positive) (rec__my_sets__my_rec__g integer)))))
(define-fun us_split_fields_F__projection ((a us_split_fields4)) positive (rec__my_sets__my_rec__f a))
(define-fun us_split_fields_G__projection ((a us_split_fields4)) integer (rec__my_sets__my_rec__g a))
...
(define-fun bool_eq3 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (to_rep3 (rec__my_sets__my_rec__f (us_split_fields5 a))) (to_rep3 (rec__my_sets__my_rec__f (us_split_fields5 b)))) (= (to_rep2 (rec__my_sets__my_rec__g (us_split_fields5 a))) (to_rep2 (rec__my_sets__my_rec__g (us_split_fields5 b))))) true false))
...
(define-fun my_eq ((x us_rep3) (y us_rep3)) Bool (= (to_rep3 (rec__my_sets__my_rec__f (us_split_fields5 x))) (to_rep3 (rec__my_sets__my_rec__f (us_split_fields5 y)))))
...
(define-fun element_type__ref___7__projection ((a element_type__ref1)) us_rep3 (element_type__content1 a))
...
(define-fun element_type__ref___5__projection ((a element_type__ref2)) us_rep3 (element_type__content2 a))
...
(define-fun default_initial_assumption1 ((temp___expr_777 us_rep4) (temp___skip_top_level_778 Bool)) Bool (=> (not (= temp___skip_top_level_778 true)) (= (length2 temp___expr_777) 0)))
(assert (forall ((container1 us_rep4)) (forall ((item us_rep3)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (my_eq item (get1 container1 result)) true))) (dynamic_invariant result true false true true))) :pattern ((find container1 item))))))
...
(define-fun default_initial_assumption2 ((temp___expr_739 us_rep5) (temp___skip_top_level_740 Bool)) Bool (=> (not (= temp___skip_top_level_740 true)) (= (is_empty1 temp___expr_739) true)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (and (= (length2 result) (length container1)) (forall ((temp___818 Int)) (=> (and (in_range5 temp___818) (= (iter_has_element result temp___818) true)) (= (contains (model__ container1) (get1 result temp___818)) true)))) (forall ((item us_rep3)) (=> (= (contains (model__ container1) item) true) (and (< 0 (find result item)) (= (my_eq (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (= (find result (get1 result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container1))) (=> (= (my_eq (get1 result i) (get1 result j)) true) (= i j)))))))) :pattern ((elements container1)))))
...
(assert (forall ((container1 us_rep5)) (forall ((item us_rep3)) (! (=> (= (distinct 1 0) true) (=> (exists ((e us_rep3)) (and (= (contains container1 e) true) (= (my_eq e item) true))) (= (contains container1 item) true))) :pattern ((contains container1 item))))))
(assert (forall ((container1 us_rep5)) (! (dynamic_invariant (length3 container1) true false true true) :pattern ((length3 container1)))))
...
(assert (forall ((container1 us_rep4)) (! (let ((result (length2 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant result true false true true))) :pattern ((length2 container1)))))
(assert true)
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep1 (rec__my_sets__n__set__capacity (us_split_discrs1 container)))))))
