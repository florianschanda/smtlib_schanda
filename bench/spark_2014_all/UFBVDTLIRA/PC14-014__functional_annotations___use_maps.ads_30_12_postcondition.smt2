...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (= (to_rep1 (rec__use_maps__my_maps__cursor__node (us_split_fields3 a))) (to_rep1 (rec__use_maps__my_maps__cursor__node (us_split_fields3 b)))) true false))
...
(declare-fun my_find (us_rep1 Int) us_rep2)
(declare-fun my_find__function_guard (us_rep2 us_rep1 Int) Bool)
...
(define-fun has_element ((container us_rep1) (position us_rep2)) Bool (has_key1 (positions container) position))
...
(declare-fun keys (us_rep1) us_rep4)
(declare-fun keys__function_guard (us_rep4 us_rep1) Bool)
(define-fun key ((container us_rep1) (position us_rep2)) Int (get (keys container) (get1 (positions container) position)))
(declare-fun key__function_guard (Int us_rep1 us_rep2) Bool)
...
(assert (forall ((s us_rep1)) (forall ((k Int)) (! (=> (dynamic_invariant k true true true true) (let ((result (my_find s k))) (ite (not (= (bool_eq2 result no_element) true)) (and (= (has_element s result) true) (= (key s result) k)) (not (= (has_key (model__ s) k) true))))) :pattern ((my_find s k))))))
...
(define-fun dynamic_invariant2 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range1 temp___expr_197)))
...
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__use_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant2 result true false true true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 2147483647)) (in_range2 temp___expr_346)))
...
(define-fun oeq1 ((left us_rep4) (right us_rep4)) Bool (and (= (length1 left) (length1 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
...
(define-fun default_initial_assumption ((temp___expr_437 us_rep4) (temp___skip_top_level_438 Bool)) Bool (=> (not (= temp___skip_top_level_438 true)) (= (length1 temp___expr_437) 0)))
(assert (forall ((container us_rep4)) (forall ((key1 Int)) (! (=> (dynamic_invariant3 key1 true true true true) (let ((result (find container key1))) (and (=> (< 0 result) (and (<= result (length1 container)) (= key1 (get container result)))) (dynamic_invariant2 result true false true true)))) :pattern ((find container key1))))))
(declare-fun length2 (us_rep) Int)
(declare-fun length__function_guard2 (Int us_rep) Bool)
(declare-fun is_empty (us_rep) Bool)
(declare-fun is_empty__function_guard (Bool us_rep) Bool)
(define-fun default_initial_assumption1 ((temp___expr_401 us_rep) (temp___skip_top_level_402 Bool)) Bool (=> (not (= temp___skip_top_level_402 true)) (and (= (is_empty temp___expr_401) true) (= (length2 temp___expr_401) 0))))
(assert true)
...
(assert (forall ((container us_rep1)) (! (let ((result (keys container))) (and (and (and (and (= (length1 result) (length container)) (forall ((temp___478 Int)) (=> (and (in_range5 temp___478) (= (iter_has_element result temp___478) true)) (= (has_key (model__ container) (get result temp___478)) true)))) (forall ((key1 Int)) (=> (and (in_range4 key1) (= (has_key (model__ container) key1) true)) (and (< 0 (find result key1)) (= (get result (find result key1)) key1))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((keys container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_460 us_rep3) (temp___skip_top_level_461 Bool)) Bool (=> (not (= temp___skip_top_level_461 true)) (and (= (is_empty1 temp___expr_460) true) (= (length3 temp___expr_460) 0))))
(assert (forall ((container us_rep1)) (! (let ((result (positions container))) (and (not (= (has_key1 result no_element) true)) (forall ((i us_rep2)) (=> (= (has_key1 result i) true) (and (and (<= 1 (get1 result i)) (<= (get1 result i) (length container))) (forall ((j us_rep2)) (=> (= (has_key1 result j) true) (=> (= (get1 result i) (get1 result j)) (= (bool_eq2 i j) true))))))))) :pattern ((positions container)))))
...
(define-fun dynamic_invariant4 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 2147483647)) (in_range4 temp___expr_386)))
(assert (forall ((container us_rep)) (forall ((key1 Int)) (! (=> (dynamic_invariant4 key1 true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k1 Int)) (and (and (in_range4 k1) (= (has_key container k1) true)) (= k1 key1))) (= (has_key container key1) true)))) :pattern ((has_key container key1))))))
...
(define-fun dynamic_invariant5 ((temp___expr_393 Int) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool) (temp___do_typ_inv_392 Bool)) Bool (=> (or (= temp___is_init_389 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_393)))
(assert (forall ((container us_rep)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant4 key1 true true true true) (= (has_key container key1) true)) (let ((result (get2 container key1))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key1))) (forall ((k1 Int)) (=> (and (in_range4 k1) (= (has_key container k1) true)) (= (= k1 key1) (= (witness container key1) (witness container k1))))))) (dynamic_invariant5 result true false true true)))) :pattern ((get2 container key1))))))
(assert (forall ((container us_rep)) (! (dynamic_invariant2 (length2 container) true false true true) :pattern ((length2 container)))))
(assert (forall ((left us_rep) (right us_rep)) (! (= (= (oeq2 left right) true) (and (forall ((key1 Int)) (=> (and (in_range4 key1) (= (has_key left key1) true)) (and (= (has_key right key1) true) (= (get2 right key1) (get2 left key1))))) (forall ((key1 Int)) (=> (and (in_range4 key1) (= (has_key right key1) true)) (= (has_key left key1) true))))) :pattern ((oeq2 left right)))))
(assert (forall ((container us_rep)) (! (= (= (is_empty container) true) (forall ((key1 Int)) (not (and (in_range4 key1) (= (has_key container key1) true))))) :pattern ((is_empty container)))))
(declare-fun has_witness (us_rep Int) Bool)
(declare-fun has_witness__function_guard (Bool us_rep Int) Bool)
(assert true)
(assert (forall ((container us_rep)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant4 key1 true true true true) (= (has_key container key1) true)) (let ((result (witness container key1))) (and (= (has_witness container result) true) (dynamic_invariant2 result true false true true)))) :pattern ((witness container key1))))))
(assert (forall ((container us_rep)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant2 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant5 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
(define-fun dynamic_invariant6 ((temp___expr_429 Int) (temp___is_init_425 Bool) (temp___skip_constant_426 Bool) (temp___do_toplevel_427 Bool) (temp___do_typ_inv_428 Bool)) Bool (=> (or (= temp___is_init_425 true) (<= 0 2147483647)) (in_range5 temp___expr_429)))
...
(define-fun dynamic_invariant7 ((temp___expr_422 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 1 2147483647)) (in_range7 temp___expr_422)))
(assert (forall ((container us_rep4)) (forall ((position Int)) (! (=> (and (dynamic_invariant6 position true true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant7 (get container position) true false true true)) :pattern ((get container position))))))
...
(define-fun dynamic_invariant8 ((temp___expr_452 Int) (temp___is_init_448 Bool) (temp___skip_constant_449 Bool) (temp___do_toplevel_450 Bool) (temp___do_typ_inv_451 Bool)) Bool (=> (or (= temp___is_init_448 true) (<= 1 2147483647)) (in_range8 temp___expr_452)))
(assert (forall ((container us_rep3)) (forall ((key1 us_rep2)) (! (=> (= (has_key1 container key1) true) (let ((result (get1 container key1))) (and (=> (= (distinct 0 0) true) (and (= result (w_get1 container (witness1 container key1))) (forall ((k1 us_rep2)) (=> (= (has_key1 container k1) true) (= (= (bool_eq2 k1 key1) true) (= (witness1 container key1) (witness1 container k1))))))) (dynamic_invariant8 result true false true true)))) :pattern ((get1 container key1))))))
(assert (forall ((container us_rep3)) (! (dynamic_invariant2 (length3 container) true false true true) :pattern ((length3 container)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key1 us_rep2)) (! (=> (= (has_key1 container key1) true) (let ((result (witness1 container key1))) (and (= (has_witness1 container result) true) (dynamic_invariant2 result true false true true)))) :pattern ((witness1 container key1))))))
(assert (forall ((container us_rep3)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant2 witness2 true true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant8 (w_get1 container witness2) true false true true)) :pattern ((w_get1 container witness2))))))
...
(assert (and (= o (has_key (model__ s) k)) (= (= o true) (= (has_key (model__ s) k) true))))
(assert (= result use_maps__my_contains__result))
(assert (= use_maps__my_contains__result1 o))
(assert (= (mk_bool__ref use_maps__my_contains__result4) (mk_bool__ref use_maps__my_contains__result2)))
(assert (= use_maps__my_contains__result5 use_maps__my_contains__result3))
(assert (= result1 use_maps__my_contains__result4))
(assert (not (= use_maps__my_contains__result4 true)))
(assert (not (= (bool_eq2 (my_find s k) no_element) true)))
(check-sat)
(exit)
