...
(assert (= result1 (ite (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_not_inline__result4 o6) true false)))
(assert (= result1 true))
(assert (and (= o1 (+ (- to__ from) 1)) (in_range1 (+ (- to__ from) 1))))
(assert (and (= o2 (make_mask o1)) (= o2 (shift_right #xFF (- 8 o1)))))
(assert (= result2 (ite (bvule bits_manipulation_unsigned__unsigned_8__functions__extract_bits_not_inline__result4 o2) true false)))
(assert (= result2 true))
