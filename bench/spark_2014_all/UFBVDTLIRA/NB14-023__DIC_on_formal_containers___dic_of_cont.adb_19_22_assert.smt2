...
(assert (= (is_empty3 (mk___rep3 dorma__split_discrs (mk___split_fields3 dorma__split_fields))) true))
(assert (= (to_rep (rec__dic_of_cont__my_orma__map__capacity dorma__split_discrs)) capacity))
(assert (= (is_empty4 (mk___rep4 dorse__split_discrs (mk___split_fields4 dorse__split_fields))) true))
(assert (not (= (to_rep (rec__dic_of_cont__my_orse__set__capacity dorse__split_discrs)) capacity)))
(check-sat)
(exit)
