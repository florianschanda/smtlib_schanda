...
(assert (=> (and (bvule #x0000000000000000 n21) (bvule n21 var2_range_size)) (= temp___243 n)))
(assert (=> (and (bvule #x0000000000000000 n21) (bvule n21 var2_range_size)) (= temp___242 n21)))
