...
(assert (= (bvmul (bvadd x y) (bvadd x y)) (bvadd (bvmul x x) (bvmul y (bvadd (bvmul #x0000000000000002 x) y)))))
(assert (not (= (sqr (bvadd x y)) (bvadd (sqr x) (bvmul y (bvadd (bvmul #x0000000000000002 x) y))))))
(check-sat)
(exit)
