...
(assert (=> (= (ite (= (= x #x0000000000000002) true) (= y #x0000000000000004) false) true) (= t3__msub__result4 #x00000000000000E4)))
(assert (= (ite (= (= x #x0000000000000004) true) (= y #x0000000000000002) false) true))
(assert (not (= t3__msub__result4 #x0000000000000002)))
(check-sat)
(exit)
