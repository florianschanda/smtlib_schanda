...
(assert (= t3__mmin__result1 (bvurem (bvsub #x00000000000000E6 x) #x00000000000000E6)))
...
(assert (not (= t3__mmin__result4 (let ((temp___217 (bvadd (let ((temp___216 (bvsub #x00000000000000E5 x))) (ite (bvult #x00000000000000E5 x) (bvadd temp___216 #x00000000000000E6) temp___216)) #x0000000000000001))) (ite (bvule (bvsub #x00000000000000E6 (let ((temp___216 (bvsub #x00000000000000E5 x))) (ite (bvult #x00000000000000E5 x) (bvadd temp___216 #x00000000000000E6) temp___216))) #x0000000000000001) (bvsub temp___217 #x00000000000000E6) temp___217)))))
(check-sat)
(exit)
