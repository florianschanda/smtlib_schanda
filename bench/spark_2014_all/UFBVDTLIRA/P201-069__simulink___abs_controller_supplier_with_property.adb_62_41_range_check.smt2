...
(assert (= sum_out11 o3))
(assert (and (= o4 (boolean_to_integer_8 (ite (< sum_out11 0) true false))) (in_range o4)))
(assert (and (= o5 (boolean_to_integer_8 (ite (< 0 sum_out11) true false))) (in_range o5)))
(assert (= o6 (- o5 o4)))
...
(assert (not (in_range sum_1_out1_sat1)))
(check-sat)
(exit)
