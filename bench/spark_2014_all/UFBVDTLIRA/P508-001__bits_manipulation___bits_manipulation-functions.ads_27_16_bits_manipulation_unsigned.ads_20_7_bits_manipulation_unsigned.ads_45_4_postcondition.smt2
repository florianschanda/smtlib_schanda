...
(assert (= bits_manipulation_unsigned__unsigned_64__functions__msb_index__result1 bits_manipulation_unsigned__unsigned_64__functions__msb_index__result2))
(assert (= result__1 result__3))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__msb_index__result3 bits_manipulation_unsigned__unsigned_64__functions__msb_index__result1))
(assert (= result__4 result__1))
(assert (=> (<= 0 63) (in_range1 result__)))
(assert (=> (= 2 0) (and (= o (msb_index_slow_inline_always value)) (and (in_range1 o) (= (shift_right value o) #x0000000000000001)))))
(assert (=> (= 2 0) (= result result__)))
(assert (=> (= 2 0) (= result__1 o)))
(assert (=> (not (= 2 0)) (and (= o1 (msb_index_fast_inline_always value)) (and (in_range1 o1) (= (shift_right value o1) #x0000000000000001)))))
(assert (=> (not (= 2 0)) (= result1 result__)))
(assert (=> (not (= 2 0)) (= result__2 o1)))
(assert (=> (not (= 2 0)) (= result__1 result__2)))
(assert (= result2 bits_manipulation_unsigned__unsigned_64__functions__msb_index__result))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__msb_index__result1 result__1))
(assert (= (mk_int__ref bits_manipulation_unsigned__unsigned_64__functions__msb_index__result4) (mk_int__ref bits_manipulation_unsigned__unsigned_64__functions__msb_index__result2)))
(assert (= result__5 result__3))
(assert (= bits_manipulation_unsigned__unsigned_64__functions__msb_index__result5 bits_manipulation_unsigned__unsigned_64__functions__msb_index__result3))
(assert (= result__6 result__4))
(assert (= result3 bits_manipulation_unsigned__unsigned_64__functions__msb_index__result4))
(assert (not (= (shift_right value bits_manipulation_unsigned__unsigned_64__functions__msb_index__result4) #x0000000000000001)))
(check-sat)
(exit)
