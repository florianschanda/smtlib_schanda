...
(define-fun dynamic_invariant2 ((temp___expr_318 Int) (temp___is_init_314 Bool) (temp___skip_constant_315 Bool) (temp___do_toplevel_316 Bool) (temp___do_typ_inv_317 Bool)) Bool (=> (or (= temp___is_init_314 true) (<= 0 15)) (in_range2 temp___expr_318)))
(declare-const value (_ BitVec 16))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma61 us_void_param) true) (forall ((val__ (_ BitVec 16))) (=> (and (bvule #x0000 val__) (bvule val__ #xFFFF)) (=> (not (= val__ #x0000)) (and (= (shift_right val__ 0) val__) (exists ((n Int)) (and (and (<= 0 n) (<= n 15)) (and (and (= (shift_right val__ n) #x0001) (forall ((j Int)) (=> (and (<= 0 j) (<= j n)) (bvuge (shift_right val__ j) #x0001)))) (forall ((j Int)) (=> (and (<= n j) (<= j 15)) (bvule (shift_right val__ j) #x0001))))))))))) :pattern ((lemma61 us_void_param)))))
(declare-const result__ Int)
(declare-const i Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result Int)
(declare-const temp___486 Int)
(declare-const temp___485 Int)
...
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result1 Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result2 Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result3 Int)
(declare-const result__13 Int)
(declare-const i12 Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result4 int__ref)
(declare-const result__14 Int)
(declare-const i13 Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result5 Int)
...
(assert (not (= value #x0000)))
(assert (=> (<= 0 15) (in_range2 result__)))
(assert (= (lemma6 Tuple0) true))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 0))
(assert (=> (and (<= 0 i1) (<= i1 15)) (= temp___486 result__)))
(assert (=> (and (<= 0 i1) (<= i1 15)) (= temp___485 i1)))
(assert (=> (and (<= 0 i1) (<= i1 15)) (= (mk_int__ref result1) result__18)))
(assert (=> (and (<= 0 i1) (<= i1 15)) (= result__2 i1)))
(assert (=> (and (<= 0 i1) (<= i1 15)) (or (and (and (and (= i1 i6) (= result__2 result__7)) (and (= i7 i1) (= result__8 result__2))) (and (and (and (= o (shift_right value i1)) (= o (ite (and (<= 1 16) (<= 16 8)) ((_ zero_extend 8) (ite (< i1 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) i1)) #x00)) (ite (and (<= 9 16) (<= 16 16)) (ite (< i1 16) (bvlshr value ((_ int2bv 16) i1)) #x0000) (ite (and (<= 17 16) (<= 16 32)) ((_ extract 15 0) (bvlshr ((_ zero_extend 16) value) ((_ int2bv 32) i1))) ((_ extract 15 0) (bvlshr ((_ zero_extend 48) value) ((_ int2bv 64) i1)))))))) (= result2 (ite (= o #x0001) true false))) (= result2 true))) (and (and (and (and (= o (shift_right value i1)) (= o (ite (and (<= 1 16) (<= 16 8)) ((_ zero_extend 8) (ite (< i1 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) i1)) #x00)) (ite (and (<= 9 16) (<= 16 16)) (ite (< i1 16) (bvlshr value ((_ int2bv 16) i1)) #x0000) (ite (and (<= 17 16) (<= 16 32)) ((_ extract 15 0) (bvlshr ((_ zero_extend 16) value) ((_ int2bv 32) i1))) ((_ extract 15 0) (bvlshr ((_ zero_extend 48) value) ((_ int2bv 64) i1)))))))) (= result2 (ite (= o #x0001) true false))) (not (= result2 true))) (and (and (and (= i15 (mk_int__ref i4)) (= result__17 (mk_int__ref result__5))) (and (= i7 i5) (= result__8 result__6))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j i2)) (bvugt (shift_right value j) #x0001))) (and (and (and (=> (<= 0 15) (in_range2 i2)) (=> (<= 0 15) (in_range2 result__3))) (and (<= 0 i2) (<= i2 15))) (or (and (and (and (= i2 i4) (= result__3 result__5)) (and (= i5 i2) (= result__6 result__3))) (= i2 15)) (and (not (= i2 15)) (and (and (and (= i3 i4) (= result__4 result__5)) (and (= i5 i3) (= result__6 result__4))) (and (and (= i2 result3) (= i3 (+ i2 1))) (and (and (= result__3 result4) (= result__4 i3)) (and (and (and (= o1 (shift_right value i3)) (= o1 (ite (and (<= 1 16) (<= 16 8)) ((_ zero_extend 8) (ite (< i3 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) i3)) #x00)) (ite (and (<= 9 16) (<= 16 16)) (ite (< i3 16) (bvlshr value ((_ int2bv 16) i3)) #x0000) (ite (and (<= 17 16) (<= 16 32)) ((_ extract 15 0) (bvlshr ((_ zero_extend 16) value) ((_ int2bv 32) i3))) ((_ extract 15 0) (bvlshr ((_ zero_extend 48) value) ((_ int2bv 64) i3)))))))) (= result5 (ite (= o1 #x0001) true false))) (= result5 true))))))))))))))
(assert (=> (and (<= 0 i1) (<= i1 15)) (= i14 i15)))
(assert (=> (and (<= 0 i1) (<= i1 15)) (= result__16 result__17)))
(assert (=> (and (<= 0 i1) (<= i1 15)) (= i9 i7)))
(assert (=> (and (<= 0 i1) (<= i1 15)) (= result__10 result__8)))
(assert (=> (and (<= 0 i1) (<= i1 15)) (= (mk_int__ref i10) i14)))
(assert (=> (and (<= 0 i1) (<= i1 15)) (= result__15 result__16)))
(assert (=> (and (<= 0 i1) (<= i1 15)) (= i11 i9)))
(assert (=> (and (<= 0 i1) (<= i1 15)) (= result__12 result__10)))
(assert (=> (not (and (<= 0 i1) (<= i1 15))) (= i1 i10)))
(assert (=> (not (and (<= 0 i1) (<= i1 15))) (= result__15 result__18)))
(assert (=> (not (and (<= 0 i1) (<= i1 15))) (= i11 i1)))
(assert (=> (not (and (<= 0 i1) (<= i1 15))) (= result__12 result__1)))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result1 bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result2))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result3 bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result1))
(assert (= result6 bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result1 result__11))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result4 (mk_int__ref bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result2)))
(assert (= i12 i10))
(assert (= result__13 result__11))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result5 bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result3))
(assert (= i13 i11))
(assert (= result__14 result__12))
(assert (= result7 (int__content bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result4)))
(assert (not (= (shift_right value (int__content bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result4)) #x0001)))
(check-sat)
(exit)
