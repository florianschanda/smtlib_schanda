...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__p__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 100)) (in_range3 temp___expr_346)))
...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length1 container)) (= (my_eq item (get container result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container item))))))
...
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e1 Int)) (and (and (in_range4 e1) (= (contains container e1) true)) (= (my_eq e1 item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((left us_rep4) (right us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true true) (= (= (included_except left right item) true) (forall ((e1 Int)) (=> (and (in_range4 e1) (= (contains left e1) true)) (or (= (contains right e1) true) (= (my_eq e1 item) true)))))) :pattern ((included_except left right item))))))
...
(define-fun cu__split_fields5 () us_split_fields2 (mk___split_fields1 cu__split_fields))
(define-fun l__split_fields6 () us_split_fields (mk___split_fields l__split_fields1))
(define-fun c1 () us_rep2 (mk___rep1 (mk___split_fields1 c)))
(assert (in_range3 e))
(assert (and (< (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (to_rep1 (rec__p__my_sets__set__capacity l__split_discrs))) (not (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true))))
(assert (and (and (and (= (contains (model__ (mk___rep l__split_discrs l__split_fields6)) e) true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 cu__split_fields5)) true)) (= (my_eq (element (mk___rep l__split_discrs l__split_fields6) (mk___rep1 cu__split_fields5)) e) true)) (ite (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true) (and (and (and (not (= i true)) (= (oeq1 (model__ (mk___rep l__split_discrs l__split_fields6)) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (oeq2 (elements (mk___rep l__split_discrs l__split_fields6)) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (oeq3 (positions (mk___rep l__split_discrs l__split_fields6)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (and (and (and (and (and (and (= i true) (= (length (mk___rep l__split_discrs l__split_fields6)) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1))) (= (element (mk___rep l__split_discrs l__split_fields6) (mk___rep1 cu__split_fields5)) e)) (= (ole (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields6))) true)) (= (included_except (model__ (mk___rep l__split_discrs l__split_fields6)) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true)) (= (mapping_preserved (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs l__split_fields6)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields6))) true)) (= (keys_included_except (positions (mk___rep l__split_discrs l__split_fields6)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields5)) true)))))
(assert (= i true))
(assert (and (and (and (and (and (and (and (= (bool_eq2 (mk___rep1 cu__split_fields4) no_element) true) (= (length (mk___rep l__split_discrs l__split_fields5)) (- (length (mk___rep l__split_discrs l__split_fields6)) 1))) (not (= (contains (model__ (mk___rep l__split_discrs l__split_fields5)) (element (mk___rep l__split_discrs l__split_fields6) (mk___rep1 cu__split_fields5))) true))) (not (= (has_key (positions (mk___rep l__split_discrs l__split_fields5)) (mk___rep1 cu__split_fields5)) true))) (= (ole (model__ (mk___rep l__split_discrs l__split_fields5)) (model__ (mk___rep l__split_discrs l__split_fields6))) true)) (= (included_except (model__ (mk___rep l__split_discrs l__split_fields6)) (model__ (mk___rep l__split_discrs l__split_fields5)) (element (mk___rep l__split_discrs l__split_fields6) (mk___rep1 cu__split_fields5))) true)) (= (mapping_preserved (elements (mk___rep l__split_discrs l__split_fields5)) (elements (mk___rep l__split_discrs l__split_fields6)) (positions (mk___rep l__split_discrs l__split_fields5)) (positions (mk___rep l__split_discrs l__split_fields6))) true)) (= (keys_included_except (positions (mk___rep l__split_discrs l__split_fields6)) (positions (mk___rep l__split_discrs l__split_fields5)) (mk___rep1 cu__split_fields5)) true)))
(assert (= i i1))
(assert (= cu__split_fields2 cu__split_fields1))
(assert (= l__split_fields3 l__split_fields2))
(assert (= i2 i))
(assert (= (mk___split_fields1 cu__split_fields3) cu__split_fields4))
(assert (= (mk___split_fields l__split_fields4) l__split_fields5))
(assert (and (= o (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) c1)) (= (= o true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) c1) true))))
(assert (= o1 true))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) c1) true)))
(check-sat)
(exit)
