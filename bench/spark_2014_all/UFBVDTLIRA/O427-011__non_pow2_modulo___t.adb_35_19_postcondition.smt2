...
(assert (= t__mmul__result1 ((_ extract 7 0) (bvurem (bvmul ((_ zero_extend 8) x) ((_ zero_extend 8) y)) #x00E6))))
(assert (= (mk_t__ref t__mmul__result4) (mk_t__ref t__mmul__result2)))
(assert (= t__mmul__result5 t__mmul__result3))
(assert (= result1 t__mmul__result4))
(assert (not (= ((_ zero_extend 8) t__mmul__result4) (bvurem (bvmul ((_ zero_extend 8) x) ((_ zero_extend 8) y)) #x00E6))))
(check-sat)
(exit)
