...
(define-fun dynamic_invariant4 ((temp___expr_228 (_ BitVec 32)) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool true)
(assert (in_range1 amount))
(assert (not (and (<= 1 64) (<= 64 8))))
(assert (<= 9 64))
(assert (<= 64 16))
(assert (< amount 16))
(assert (not (bvule ((_ zero_extend 48) #x0000) v)))
(check-sat)
(exit)
