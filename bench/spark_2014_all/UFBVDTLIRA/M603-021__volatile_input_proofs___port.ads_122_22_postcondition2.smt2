...
(assert (forall ((s (_ BitVec 8))) (! (=> (dynamic_invariant s true true true true) (dynamic_invariant1 (c3 s) true false true true)) :pattern ((c3 s)))))
(declare-sort e 0)
...
(define-fun dynamic_invariant3 ((temp___expr_172 (_ BitVec 8)) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool true)
