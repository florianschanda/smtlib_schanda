...
(assert (forall ((x86__rcx (_ BitVec 64))) (! (=> (dynamic_invariant x86__rcx true true true true) (let ((result (cl x86__rcx))) (and (= result ((_ extract 7 0) (bvand x86__rcx #x00000000000000FF))) (dynamic_invariant1 result true false true true)))) :pattern ((cl x86__rcx)))))
...
(assert (=> (and (not (= carryflag true)) (not (= zeroflag true))) (= rcx1 (bvor (bvand rcx #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) #x01)))))
(assert (=> (not (and (not (= carryflag true)) (not (= zeroflag true)))) (= rcx2 (bvor (bvand rcx #xFFFFFFFFFFFFFF00) ((_ zero_extend 56) #x00)))))
(assert (=> (not (and (not (= carryflag true)) (not (= zeroflag true)))) (= rcx1 rcx2)))
(assert (= rcx1 rcx3))
(assert (= rcx4 rcx1))
(assert (not (= carryflag true)))
(assert (not (= zeroflag true)))
(assert (not (= (cl rcx3) #x01)))
(check-sat)
(exit)
