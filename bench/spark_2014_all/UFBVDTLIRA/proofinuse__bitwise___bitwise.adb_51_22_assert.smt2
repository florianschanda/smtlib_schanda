...
(assert (not (= res1 (bvor ((_ zero_extend 16) (bvor ((_ zero_extend 8) val1) (ite (< 8 16) (bvshl ((_ zero_extend 8) val2) ((_ int2bv 16) 8)) #x0000))) (bvshl ((_ zero_extend 16) (bvor ((_ zero_extend 8) val3) (ite (< 8 16) (bvshl ((_ zero_extend 8) val4) ((_ int2bv 16) 8)) #x0000))) ((_ int2bv 32) 16))))))
(check-sat)
(exit)
