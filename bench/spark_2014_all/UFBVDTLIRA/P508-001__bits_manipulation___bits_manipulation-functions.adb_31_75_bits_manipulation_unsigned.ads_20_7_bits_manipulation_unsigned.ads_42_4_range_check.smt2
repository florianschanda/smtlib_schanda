...
(assert (and (= o6 (make_mask o5)) (= o6 (shift_right #xFF (- 8 o5)))))
(assert (and (= o7 (shift_right value from)) (= o7 (ite (and (<= 1 8) (<= 8 8)) (ite (< from 8) (bvlshr value ((_ int2bv 8) from)) #x00) (ite (and (<= 9 8) (<= 8 16)) ((_ extract 7 0) (ite (< from 16) (bvlshr ((_ zero_extend 8) value) ((_ int2bv 16) from)) #x0000)) (ite (and (<= 17 8) (<= 8 32)) ((_ extract 7 0) (bvlshr ((_ zero_extend 24) value) ((_ int2bv 32) from))) ((_ extract 7 0) (bvlshr ((_ zero_extend 56) value) ((_ int2bv 64) from)))))))))
(assert (= o8 (bvand o7 o6)))
(assert (= result2 (ite (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result4 o8) true false)))
(assert (= result2 true))
(assert (and (= o3 (+ (- to__ from) 1)) (in_range1 (+ (- to__ from) 1))))
(assert (and (= o4 (make_mask o3)) (= o4 (shift_right #xFF (- 8 o3)))))
(assert (= result3 (ite (bvule bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result4 o4) true false)))
(assert (= result3 true))
