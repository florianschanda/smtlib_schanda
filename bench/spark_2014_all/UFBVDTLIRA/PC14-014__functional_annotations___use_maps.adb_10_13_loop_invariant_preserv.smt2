...
(define-fun cu__split_fields5 () us_split_fields (mk___split_fields cu__split_fields1))
(define-fun temp___7871 () us_rep2 (mk___rep (mk___split_fields temp___787)))
...
(assert (and (= result1 (has_key1 (positions s) (mk___rep cu__split_fields5))) (= (= result1 true) (= (has_key1 (positions s) (mk___rep cu__split_fields5)) true))))
(assert (= result1 true))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep cu__split_fields4)) 1))) (not (= (get (keys s) i) k)))))
(assert (= (has_key1 (positions s) (mk___rep cu__split_fields4)) true))
(assert (= temp___789 result2))
(assert (= temp___7891 (get1 (positions s) (mk___rep cu__split_fields4))))
(assert (and (= o (key s (mk___rep cu__split_fields4))) (and (in_range7 o) (= o (get (keys s) (get1 (positions s) (mk___rep cu__split_fields4)))))))
...
(assert (and (= temp___7871 (next s (mk___rep cu__split_fields4))) (ite (= (ite (= (bool_eq2 (mk___rep cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep cu__split_fields4)) (length3 s)) true) true) (= (bool_eq2 temp___7871 no_element) true) (and (= (has_key1 (positions s) temp___7871) true) (= (get1 (positions s) temp___7871) (+ (get1 (positions s) (mk___rep cu__split_fields4)) 1))))))
(assert (= result4 (mk___split_fields__ref cu__split_fields4)))
(assert (= cu__split_fields3 (mk___split_fields temp___787)))
(assert (and (= o1 (has_key1 (positions s) (mk___rep cu__split_fields3))) (= (= o1 true) (= (has_key1 (positions s) (mk___rep cu__split_fields3)) true))))
(assert (= result5 (ite (not (= o1 true)) true false)))
(assert (not (= result5 true)))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i (- (get1 (positions s) (mk___rep cu__split_fields3)) 1)))
