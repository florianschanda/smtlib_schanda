...
(declare-fun ebp ((_ BitVec 64)) (_ BitVec 32))
(declare-fun ebp__function_guard ((_ BitVec 32) (_ BitVec 64)) Bool)
...
(assert (forall ((x86__rbp (_ BitVec 64))) (! (=> (dynamic_invariant x86__rbp true true true true) (let ((result (ebp x86__rbp))) (and (= result ((_ extract 31 0) (bvand x86__rbp #x00000000FFFFFFFF))) (dynamic_invariant1 result true false true true)))) :pattern ((ebp x86__rbp)))))
...
(assert (= result rbp))
(assert (= rbp1 (bvor (bvand rbp #xFFFFFFFF00000000) ((_ zero_extend 32) val__))))
(assert (= rbp1 rbp2))
(assert (= rbp3 rbp1))
(assert (not (= (ebp rbp2) val__)))
(check-sat)
(exit)
