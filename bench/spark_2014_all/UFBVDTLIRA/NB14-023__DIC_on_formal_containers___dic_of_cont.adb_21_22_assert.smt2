...
(assert (= (to_rep (rec__dic_of_cont__my_orse__set__capacity dorse__split_discrs)) capacity))
(assert (= (is_empty5 (mk___rep5 dfove__split_discrs (mk___split_fields5 dfove__split_fields))) true))
(assert (not (= (to_rep2 (rec__dic_of_cont__my_fove__vector__capacity dfove__split_discrs)) capacity)))
(check-sat)
(exit)
