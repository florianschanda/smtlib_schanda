...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__com_map__com_to_rbc_map__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__com_map__com_to_rbc_map__cursor__node count_type)))))
(define-fun us_split_fields_Node__projection ((a us_split_fields2)) count_type (rec__com_map__com_to_rbc_map__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep1 (rec__com_map__com_to_rbc_map__cursor__node (us_split_fields3 a))) (to_rep1 (rec__com_map__com_to_rbc_map__cursor__node (us_split_fields3 b)))) true false))
...
(assert (< com_map__com_to_rbc_map__cursor__node__first__bit com_map__com_to_rbc_map__cursor__node__last__bit))
...
(define-fun dynamic_invariant1 ((temp___expr_459 Int) (temp___is_init_455 Bool) (temp___skip_constant_456 Bool) (temp___do_toplevel_457 Bool) (temp___do_typ_inv_458 Bool)) Bool (=> (or (= temp___is_init_455 true) (<= 1 2147483647)) (in_range2 temp___expr_459)))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(declare-fun is_empty (us_rep2) Bool)
(declare-fun is_empty__function_guard (Bool us_rep2) Bool)
(define-fun default_initial_assumption ((temp___expr_467 us_rep2) (temp___skip_top_level_468 Bool)) Bool (=> (not (= temp___skip_top_level_468 true)) (and (= (is_empty temp___expr_467) true) (= (length1 temp___expr_467) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_408 us_rep3) (temp___skip_top_level_409 Bool)) Bool (=> (not (= temp___skip_top_level_409 true)) (and (= (is_empty1 temp___expr_408) true) (= (length2 temp___expr_408) 0))))
(assert true)
...
(define-fun dynamic_invariant3 ((temp___expr_400 Int) (temp___is_init_396 Bool) (temp___skip_constant_397 Bool) (temp___do_toplevel_398 Bool) (temp___do_typ_inv_399 Bool)) Bool (=> (or (= temp___is_init_396 true) (<= 1 10000)) (in_range3 temp___expr_400)))
...
(assert (forall ((container1 us_rep3)) (forall ((key Int)) (! (=> (and (dynamic_invariant3 key true true true true) (= (has_key1 container1 key) true)) (=> (= (distinct 1 0) true) (and (= (= (get1 container1 key) true) (= (w_get1 container1 (witness1 container1 key)) true)) (forall ((k Int)) (=> (and (in_range3 k) (= (has_key1 container1 k) true)) (= (= k key) (= (witness1 container1 key) (witness1 container1 k)))))))) :pattern ((get1 container1 key))))))
(assert (forall ((container1 us_rep3)) (! (dynamic_invariant (length2 container1) true false true true) :pattern ((length2 container1)))))
(assert (forall ((left us_rep3) (right us_rep3)) (! (= (= (oeq1 left right) true) (and (forall ((key Int)) (=> (and (in_range3 key) (= (has_key1 left key) true)) (and (= (has_key1 right key) true) (= (= (get1 right key) true) (= (get1 left key) true))))) (forall ((key Int)) (=> (and (in_range3 key) (= (has_key1 right key) true)) (= (has_key1 left key) true))))) :pattern ((oeq1 left right)))))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep1 (rec__com_map__com_to_rbc_map__map__capacity (us_split_discrs1 container)))))))
