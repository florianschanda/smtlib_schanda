...
(define-fun state_item__split_fields10 () us_split_fields2 (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields4 state_item__split_fields5))))
(assert (in_range2 st))
(assert (in_range1 my_internal_state))
(assert (= o (read (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields state_item__split_fields1)))))))
(assert (= result (ite (not (= o true)) true false)))
(assert (=> (= result true) (= st c2b)))
(assert (=> (= result true) (in_range2 c2b)))
(assert (=> (= result true) (in_range3 c3b)))
(assert (=> (not (= result true)) (= state_item__split_fields state_item__split_fields4)))
(assert (=> (not (= result true)) (= state_item__split_fields1 state_item__split_fields5)))
(assert (=> (not (= result true)) (= state_item__split_fields10 (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields2 state_item__split_fields3))))))
(assert (= state_item__split_fields6 state_item__split_fields4))
(assert (= state_item__split_fields7 state_item__split_fields5))
(assert (= (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields8 state_item__split_fields9))) state_item__split_fields10))
(assert (ite (= (read (get_state_item (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields state_item__split_fields1))))) false) true false))
(assert (not (= (read (get_state_item (mk___split_fields1 (mk___rep (mk___split_fields state_item__split_fields6 state_item__split_fields7))))) true)))
(check-sat)
(exit)
