...
(declare-fun temp_____aggregate_def_351 (map1 Int (_ BitVec 8) Int Int (_ BitVec 8) Int Int Int (_ BitVec 8) Int Int) map1)
...
(assert (forall ((temp___353 map1)) (forall ((temp___354 Int) (temp___356 Int) (temp___357 Int) (temp___359 Int) (temp___360 Int) (temp___361 Int) (temp___363 Int) (temp___364 Int)) (forall ((temp___355 (_ BitVec 8)) (temp___358 (_ BitVec 8)) (temp___362 (_ BitVec 8))) (let ((temp___352 (temp_____aggregate_def_351 temp___353 temp___354 temp___355 temp___356 temp___357 temp___358 temp___359 temp___360 temp___361 temp___362 temp___363 temp___364))) (=> (and (and (and (and (and (and (and (and (and (and (dynamic_invariant1 temp___354 true true true true) (dynamic_invariant2 temp___355 true true true true)) (dynamic_invariant3 temp___356 true true true true)) (dynamic_invariant1 temp___357 true true true true)) (dynamic_invariant2 temp___358 true true true true)) (dynamic_invariant3 temp___359 true true true true)) (dynamic_invariant temp___360 true true true true)) (dynamic_invariant1 temp___361 true true true true)) (dynamic_invariant2 temp___362 true true true true)) (dynamic_invariant3 temp___363 true true true true)) (dynamic_invariant temp___364 true true true true)) (forall ((temp___365 Int) (temp___367 Int)) (forall ((temp___366 (_ BitVec 8))) (ite (and (and (= temp___365 temp___361) (= temp___366 temp___362)) (= temp___367 temp___363)) (= (to_rep (get temp___352 temp___365 temp___366 temp___367)) temp___364) (ite (or (and (and (= temp___365 temp___354) (= temp___366 temp___355)) (= temp___367 temp___356)) (and (and (= temp___365 temp___357) (= temp___366 temp___358)) (= temp___367 temp___359))) (= (to_rep (get temp___352 temp___365 temp___366 temp___367)) temp___360) (= (get temp___352 temp___365 temp___366 temp___367) (get temp___353 temp___365 temp___366 temp___367))))))))))))
(assert (not true))
(check-sat)
(exit)
