...
(assert (and (= temp___1023 (keys s)) (and (and (and (and (= (length temp___1023) (length1 s)) (forall ((temp___474 Int)) (=> (and (in_range2 temp___474) (= (iter_has_element temp___1023 temp___474) true)) (= (has_key (model__ s) (get temp___1023 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range4 key1) (= (has_key (model__ s) key1) true)) (and (< 0 (find temp___1023 key1)) (= (get temp___1023 (find temp___1023 key1)) key1))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 s))) (= (find temp___1023 (get temp___1023 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length1 s))) (=> (= (get temp___1023 i) (get temp___1023 j)) (= i j)))))))))
(assert (and (= o (iter_has_element temp___1023 temp___1022)) (= (= o true) (and (<= 1 temp___1022) (<= temp___1022 (last temp___1023))))))
(assert (= (= o1 true) (in_range2 temp___1022)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (<= temp___1022 (last temp___1023))))
(check-sat)
(exit)
