...
(define-fun temp___1007 () us_rep1 (keys s))
(declare-const temp___1006 Int)
(assert (in_range3 temp___1006))
(assert (= (iter_has_element temp___1007 temp___1006) true))
(assert (not (= (q (get1 (model__ s) (get temp___1007 temp___1006))) true)))
(check-sat)
(exit)
