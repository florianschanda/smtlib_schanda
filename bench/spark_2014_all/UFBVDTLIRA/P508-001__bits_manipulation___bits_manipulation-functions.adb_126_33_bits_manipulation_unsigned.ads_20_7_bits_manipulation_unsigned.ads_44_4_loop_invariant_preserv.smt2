...
(define-fun dynamic_invariant2 ((temp___expr_366 Int) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool) (temp___do_typ_inv_365 Bool)) Bool (=> (or (= temp___is_init_362 true) (<= 0 31)) (in_range2 temp___expr_366)))
(declare-const value (_ BitVec 32))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma61 us_void_param) true) (forall ((val__ (_ BitVec 32))) (=> (and (bvule #x00000000 val__) (bvule val__ #xFFFFFFFF)) (=> (not (= val__ #x00000000)) (and (= (shift_right val__ 0) val__) (exists ((n Int)) (and (and (<= 0 n) (<= n 31)) (and (and (= (shift_right val__ n) #x00000001) (forall ((j Int)) (=> (and (<= 0 j) (<= j n)) (bvuge (shift_right val__ j) #x00000001)))) (forall ((j Int)) (=> (and (<= n j) (<= j 31)) (bvule (shift_right val__ j) #x00000001))))))))))) :pattern ((lemma61 us_void_param)))))
...
(assert (=> (<= 0 31) (in_range2 result__)))
...
(assert (= result__1 i1))
(assert (and (= o (shift_right value i1)) (= o (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< i1 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) i1)) #x00)) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< i1 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) i1)) #x0000)) (ite (and (<= 17 32) (<= 32 32)) (bvlshr value ((_ int2bv 32) i1)) ((_ extract 31 0) (bvlshr ((_ zero_extend 32) value) ((_ int2bv 64) i1)))))))))
(assert (= result2 (ite (= o #x00000001) true false)))
(assert (not (= result2 true)))
(assert (forall ((j Int)) (=> (and (<= 0 j) (<= j i2)) (bvugt (shift_right value j) #x00000001))))
(assert (and (and (=> (<= 0 31) (in_range2 i2)) (=> (<= 0 31) (in_range2 result__2))) (and (<= 0 i2) (<= i2 31))))
(assert (not (= i2 31)))
(assert (= i2 result3))
(assert (= i3 (+ i2 1)))
(assert (= result__2 result4))
(assert (= result__3 i3))
(assert (and (= o1 (shift_right value i3)) (= o1 (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< i3 8) (bvlshr ((_ extract 7 0) value) ((_ int2bv 8) i3)) #x00)) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< i3 16) (bvlshr ((_ extract 15 0) value) ((_ int2bv 16) i3)) #x0000)) (ite (and (<= 17 32) (<= 32 32)) (bvlshr value ((_ int2bv 32) i3)) ((_ extract 31 0) (bvlshr ((_ zero_extend 32) value) ((_ int2bv 64) i3)))))))))
(assert (= result5 (ite (= o1 #x00000001) true false)))
(assert (not (= result5 true)))
(declare-const j Int)
(assert (<= 0 j))
(assert (<= j i3))
(assert (not (bvugt (shift_right value j) #x00000001)))
(check-sat)
(exit)
