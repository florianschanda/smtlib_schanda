...
(define-fun dynamic_invariant ((temp___expr_214 (_ BitVec 64)) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool true)
...
(declare-const foo__get__data1 (_ BitVec 64))
(assert (= o ((_ zero_extend 32) value)))
(assert (= o1 ((_ extract 31 0) o)))
(assert (= o2 ((_ zero_extend 32) o1)))
(assert (= o3 o2))
(assert (= o3 foo__get__data))
(assert (not (bvule ((_ zero_extend 32) #x00000000) foo__get__data1)))
(check-sat)
(exit)
