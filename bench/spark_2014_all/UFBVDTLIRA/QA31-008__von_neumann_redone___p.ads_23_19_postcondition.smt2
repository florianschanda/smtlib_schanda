...
(assert (not (bvuge (bvsub (bvmul (bvadd (t__content p__sqrt_von_neumann_aux16__result4) #x0001) (bvadd (t__content p__sqrt_von_neumann_aux16__result4) #x0001)) #x0001) x)))
(check-sat)
(exit)
