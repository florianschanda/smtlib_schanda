...
(define-fun dynamic_invariant1 ((temp___expr_221 (_ BitVec 8)) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool true)
...
(assert (not (in_range1 (- (to_rep (rec__foo__lists__list__capacity container__split_discrs)) count))))
(check-sat)
(exit)
