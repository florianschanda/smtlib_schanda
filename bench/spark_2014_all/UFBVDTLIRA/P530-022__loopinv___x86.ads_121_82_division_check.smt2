...
(assert (= x86__readreghigh8__result1 ((_ extract 7 0) (bvudiv (bvand reg #x000000000000FF00) #x0000000000000100))))
(assert (= (mk_t__ref x86__readreghigh8__result4) (mk_t__ref x86__readreghigh8__result2)))
