...
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (dynamic_invariant6 key true true true true) (let ((result (find container key))) (and (=> (< 0 result) (and (<= result (length1 container)) (= key (get container result)))) (dynamic_invariant result true false true true)))) :pattern ((find container key))))))
...
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (dynamic_invariant7 key true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range4 k) (= (has_key container k) true)) (= k key))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (and (dynamic_invariant7 key true true true true) (= (has_key container key) true)) (let ((result (get1 container key))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key))) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key container k) true)) (= (= k key) (= (witness container key) (witness container k))))))) (dynamic_invariant8 result true false true true)))) :pattern ((get1 container key))))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (and (dynamic_invariant7 key true true true true) (= (has_key container key) true)) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant result true false true true)))) :pattern ((witness container key))))))
...
(declare-const temp___1001 us_rep1)
...
(assert (and (= temp___1001 (keys s)) (and (and (and (and (= (length1 temp___1001) (length s)) (forall ((temp___474 Int)) (=> (and (in_range3 temp___474) (= (iter_has_element temp___1001 temp___474) true)) (= (has_key (model__ s) (get temp___1001 temp___474)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ s) key) true)) (and (< 0 (find temp___1001 key)) (= (get temp___1001 (find temp___1001 key)) key))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (= (find temp___1001 (get temp___1001 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get temp___1001 i) (get temp___1001 j)) (= i j)))))))))
(assert (and (= o (iter_has_element temp___1001 temp___1000)) (= (= o true) (and (<= 1 temp___1000) (<= temp___1000 (last temp___1001))))))
(assert (= (= o1 true) (in_range3 temp___1000)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (and (= k (get temp___1001 temp___1000)) (in_range2 k)))
