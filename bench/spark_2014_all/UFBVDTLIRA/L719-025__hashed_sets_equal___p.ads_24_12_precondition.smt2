...
(assert (= result true))
(assert (and (= o2 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) c1)) (and (in_range2 o2) (= o2 (get (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) c1))))))
