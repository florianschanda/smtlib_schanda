...
(define-fun dynamic_invariant2 ((temp___expr_421 Int) (temp___is_init_417 Bool) (temp___skip_constant_418 Bool) (temp___do_toplevel_419 Bool) (temp___do_typ_inv_420 Bool)) Bool (=> (or (= temp___is_init_417 true) (<= 1 64)) (in_range2 temp___expr_421)))
...
(declare-const n Int)
(assert (bvule #x0000000000000000 value))
(assert (bvule value #xFFFFFFFFFFFFFFFF))
(assert (<= 0 n))
(assert (<= n 63))
(assert (not (in_range2 (- 63 n))))
(check-sat)
(exit)
