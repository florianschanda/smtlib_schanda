...
(assert (and (= o (element s1 (mk___rep cu__split_fields3))) (and (in_range6 o) (= o (get (elements s1) (get1 (positions s1) (mk___rep cu__split_fields3)))))))
...
(assert (not (or (= (has_key (positions s1) (mk___rep cu__split_fields3)) true) (= (bool_eq2 (mk___rep cu__split_fields3) no_element) true))))
(check-sat)
(exit)
