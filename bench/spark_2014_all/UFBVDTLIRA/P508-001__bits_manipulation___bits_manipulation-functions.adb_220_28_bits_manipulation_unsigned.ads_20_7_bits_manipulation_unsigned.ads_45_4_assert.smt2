...
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant1 num_bits true true true true) (= (make_mask num_bits) (shift_right #xFFFFFFFFFFFFFFFF (- 64 num_bits)))) :pattern ((make_mask num_bits)))))
...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma2 us_void_param) true) (forall ((size Int)) (=> (and (<= 1 size) (<= size 63)) (= (make_mask size) (bvsub (ite (< size 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) size)) #x0000000000000000) #x0000000000000001))))) :pattern ((lemma2 us_void_param)))))
(declare-fun lemma2_goal (tuple0) Bool)
(declare-fun lemma2_goal__function_guard (Bool tuple0) Bool)
(assert true)
(declare-sort t773s 0)
(declare-fun t773sqtint (t773s) Int)
(assert (forall ((i t773s)) (and (<= 2 (t773sqtint i)) (<= (t773sqtint i) 63))))
...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma81 us_void_param) true) (forall ((val__ (_ BitVec 64))) (=> (and (bvule #x0000000000000000 val__) (bvule val__ #xFFFFFFFFFFFFFFFF)) (forall ((n Int)) (=> (and (<= 1 n) (<= n 63)) (bvult (shift_right val__ (- 64 n)) (ite (< n 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) n)) #x0000000000000000))))))) :pattern ((lemma81 us_void_param)))))
(declare-const i Int)
...
(assert (= (make_mask 1) #x0000000000000001))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 63)) (= temp___536 i1)))
(assert (=> (and (<= 2 i1) (<= i1 63)) (= (make_mask i1) (bvsub (ite (< i1 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) i1)) #x0000000000000000) #x0000000000000001))))
(assert (=> (and (<= 2 i1) (<= i1 63)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (make_mask j) (bvsub (ite (< j 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) j)) #x0000000000000000) #x0000000000000001))))))
(assert (=> (and (<= 2 i1) (<= i1 63)) (and (=> (<= 2 63) (in_range2 i2)) (and (<= 2 i2) (<= i2 63)))))
(assert (=> (and (<= 2 i1) (<= i1 63)) (= i2 63)))
(assert (=> (and (<= 2 i1) (<= i1 63)) (= i2 i3)))
(assert (=> (and (<= 2 i1) (<= i1 63)) (= i4 i2)))
(assert (=> (and (<= 2 i1) (<= i1 63)) (= (mk_int__ref i5) (mk_int__ref i3))))
...
(assert (<= 1 size))
(assert (<= size 63))
(assert (not (= (make_mask size) (bvsub (ite (< size 18446744073709551616) (bvshl #x0000000000000001 ((_ int2bv 64) size)) #x0000000000000000) #x0000000000000001))))
(check-sat)
(exit)
