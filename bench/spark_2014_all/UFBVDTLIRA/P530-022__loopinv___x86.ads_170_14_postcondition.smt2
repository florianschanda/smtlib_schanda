...
(declare-const x86__ah__result (_ BitVec 8))
(declare-const result (_ BitVec 8))
(declare-const x86__ah__result1 (_ BitVec 8))
(declare-const x86__ah__result2 (_ BitVec 8))
(declare-const x86__ah__result3 (_ BitVec 8))
...
(assert (= x86__ah__result1 ((_ extract 7 0) (bvudiv (bvand rax #x000000000000FF00) #x0000000000000100))))
(assert (= (mk_t__ref x86__ah__result4) (mk_t__ref x86__ah__result2)))
(assert (= x86__ah__result5 x86__ah__result3))
(assert (= result1 x86__ah__result4))
(assert (not (= x86__ah__result4 (readreghigh8 rax))))
(check-sat)
(exit)
