...
(define-fun dynamic_invariant2 ((temp___expr_277 Int) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool) (temp___do_typ_inv_276 Bool)) Bool (=> (or (= temp___is_init_273 true) (<= 1 8)) (in_range2 temp___expr_277)))
...
(declare-const n Int)
(assert (bvule #x00 value))
(assert (bvule value #xFF))
(assert (<= 0 n))
(assert (<= n 7))
(assert (not (in_range2 (- 7 n))))
(check-sat)
(exit)
