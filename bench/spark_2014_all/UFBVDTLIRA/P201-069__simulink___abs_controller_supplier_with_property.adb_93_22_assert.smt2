...
(assert (=> (bvugt vehicle_speed #x00000000) (and (= o4 (boolean_to_integer_8 (ite (< sum_out12 0) true false))) (in_range o4))))
(assert (=> (bvugt vehicle_speed #x00000000) (and (= o5 (boolean_to_integer_8 (ite (< 0 sum_out12) true false))) (in_range o5))))
(assert (=> (bvugt vehicle_speed #x00000000) (= o6 (- o5 o4))))
(assert (=> (bvugt vehicle_speed #x00000000) (and (= o7 o6) (in_range1 o6))))
...
(assert (=> (bvugt vehicle_speed #x00000000) (=> (not (< 127 sum_1_out1_sat2)) (=> (not (< sum_1_out1_sat2 (- 128))) (and (= o8 sum_1_out1_sat2) (in_range sum_1_out1_sat2))))))
