...
(assert (and (= (length (mk___rep s2__split_discrs s2__split_fields2)) 0) (= (is_empty (model__ (mk___rep s2__split_discrs s2__split_fields2))) true)))
...
(assert (= result1 true))
(assert (not (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields2)) (+ (length (mk___rep s2__split_discrs s2__split_fields2)) 1))))
(check-sat)
(exit)
