...
(declare-const x86__writereg32post__result Bool)
(declare-const o (_ BitVec 32))
(declare-const o1 Bool)
(declare-const o2 Bool)
(declare-const result Bool)
(declare-const x86__writereg32post__result1 Bool)
(declare-const x86__writereg32post__result2 Bool)
(declare-const x86__writereg32post__result3 Bool)
...
(assert (and (= o (readreg32 regnew)) (= o ((_ extract 31 0) (bvand regnew #x00000000FFFFFFFF)))))
(assert (= o1 (ite (= o val__) true false)))
(assert (= o2 (ite (= o1 true) (ite (= (bvand regnew #xFFFFFFFF00000000) #x0000000000000000) true false) false)))
(assert (= result x86__writereg32post__result))
(assert (= x86__writereg32post__result1 o2))
(assert (= (mk_bool__ref x86__writereg32post__result4) (mk_bool__ref x86__writereg32post__result2)))
(assert (= x86__writereg32post__result5 x86__writereg32post__result3))
(assert (= result1 x86__writereg32post__result4))
(assert (= x86__writereg32post__result4 true))
(assert (not (= (readreg32 regnew) val__)))
(check-sat)
(exit)
