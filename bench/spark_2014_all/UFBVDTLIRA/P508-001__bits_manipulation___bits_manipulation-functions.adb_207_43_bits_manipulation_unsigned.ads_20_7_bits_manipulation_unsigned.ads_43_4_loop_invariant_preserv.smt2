...
(assert (= result__2 o1))
(assert (= (bvand result__3 (let ((temp___494 (- i2 1))) (ite (< temp___494 65536) (bvshl #x0001 ((_ int2bv 16) temp___494)) #x0000))) (let ((temp___495 (- i2 1))) (ite (< temp___495 65536) (bvshl #x0001 ((_ int2bv 16) temp___495)) #x0000))))
...
(assert (= result__4 o3))
(assert (not (= (bvand result__4 (let ((temp___494 (- i3 1))) (ite (< temp___494 65536) (bvshl #x0001 ((_ int2bv 16) temp___494)) #x0000))) (let ((temp___495 (- i3 1))) (ite (< temp___495 65536) (bvshl #x0001 ((_ int2bv 16) temp___495)) #x0000)))))
(check-sat)
(exit)
