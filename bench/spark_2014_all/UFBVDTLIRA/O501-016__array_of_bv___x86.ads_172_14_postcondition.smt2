...
(declare-const x86__bh__result1 (_ BitVec 8))
(declare-const x86__bh__result2 (_ BitVec 8))
(declare-const x86__bh__result3 (_ BitVec 8))
(declare-const x86__bh__result4 (_ BitVec 8))
(declare-const x86__bh__result5 (_ BitVec 8))
(declare-const result1 (_ BitVec 8))
(assert (= x86__bh__result1 x86__bh__result2))
(assert (= x86__bh__result3 x86__bh__result1))
(assert (= (mk_t__ref result) (mk_t__ref x86__bh__result)))
(assert (= x86__bh__result1 ((_ extract 7 0) (bvudiv (bvand rbx #x000000000000FF00) #x0000000000000100))))
(assert (= (mk_t__ref x86__bh__result4) (mk_t__ref x86__bh__result2)))
(assert (= x86__bh__result5 x86__bh__result3))
(assert (= result1 x86__bh__result4))
(assert (not (= x86__bh__result4 ((_ extract 7 0) (bvurem (bvudiv (bvand rbx #x000000000000FF00) #x0000000000000100) ((_ int2bv 64) 256))))))
(check-sat)
(exit)
