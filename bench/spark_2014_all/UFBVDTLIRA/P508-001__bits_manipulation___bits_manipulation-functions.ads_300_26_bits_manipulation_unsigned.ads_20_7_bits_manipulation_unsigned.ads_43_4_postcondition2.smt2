...
(define-fun dynamic_invariant1 ((temp___expr_325 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool) (temp___do_typ_inv_324 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= 1 16)) (in_range1 temp___expr_325)))
...
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant1 num_bits true true true true) (= (make_mask num_bits) (shift_right #xFFFF (- 16 num_bits)))) :pattern ((make_mask num_bits)))))
...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma1 us_void_param) true) (forall ((size Int)) (=> (and (<= 1 size) (<= size 15)) (bvult (make_mask size) (ite (< size 65536) (bvshl #x0001 ((_ int2bv 16) size)) #x0000))))) :pattern ((lemma1 us_void_param)))))
...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma81 us_void_param) true) (forall ((val__ (_ BitVec 16))) (=> (and (bvule #x0000 val__) (bvule val__ #xFFFF)) (forall ((n Int)) (=> (and (<= 1 n) (<= n 15)) (bvult (shift_right val__ (- 16 n)) (ite (< n 65536) (bvshl #x0001 ((_ int2bv 16) n)) #x0000))))))) :pattern ((lemma81 us_void_param)))))
(declare-const bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result Bool)
(declare-const o Bool)
(declare-const result Bool)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result1 Bool)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result2 Bool)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result3 Bool)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result4 Bool)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result5 Bool)
(declare-const result1 Bool)
(assert (= (lemma8 Tuple0) true))
(assert (forall ((size Int)) (=> (and (<= 1 size) (<= size 15)) (bvult (make_mask size) (ite (< size 65536) (bvshl #x0001 ((_ int2bv 16) size)) #x0000)))))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result1 bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result2))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result3 bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result1))
(assert (= o (lemma1_goal Tuple0)))
(assert (= result bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result1 o))
(assert (= (mk_bool__ref bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result4) (mk_bool__ref bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result2)))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result5 bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result3))
(assert (= result1 bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result4))
(assert (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma1__result4 true))
(assert (not (= (lemma1 Tuple0) true)))
(check-sat)
(exit)
