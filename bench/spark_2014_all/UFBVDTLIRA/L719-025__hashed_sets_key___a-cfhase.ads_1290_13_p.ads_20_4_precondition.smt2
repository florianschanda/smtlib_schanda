...
(declare-fun user_eq2 (element_type1 element_type1) Bool)
(declare-const dummy2 element_type1)
...
(define-fun dynamic_invariant1 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 100)) (in_range2 temp___expr_386)))
...
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range2 e) (= (contains container e) true)) (= (my_eq e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__p__my_sets__set us_main_type1)))))
(define-fun us_split_fields_Set__projection ((a us_split_fields)) us_main_type1 (rec__p__my_sets__set a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep1 (rec__p__my_sets__set__capacity (us_split_discrs1 a))) (to_rep1 (rec__p__my_sets__set__capacity (us_split_discrs1 b)))) (= (to_rep (rec__p__my_sets__set__modulus (us_split_discrs1 a))) (to_rep (rec__p__my_sets__set__modulus (us_split_discrs1 b))))) (= (us_main_eq1 (rec__p__my_sets__set (us_split_fields1 a)) (rec__p__my_sets__set (us_split_fields1 b))) true)) true false))
...
(assert (forall ((container1 us_rep1)) (! (let ((result (length container1))) (and (<= result (to_rep1 (rec__p__my_sets__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant5 result true false true true))) :pattern ((length container1)))))
...
(assert (forall ((container1 us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (my_eq item (get container1 result)) true))) (dynamic_invariant5 result true false true true)))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep1)) (! (let ((result (elements container1))) (and (and (and (and (= (length2 result) (length container1)) (forall ((temp___471 Int)) (=> (and (in_range7 temp___471) (= (iter_has_element result temp___471) true)) (= (contains (model__ container1) (get result temp___471)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (my_eq (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container1))) (=> (= (my_eq (get result i) (get result j)) true) (= i j)))))))) :pattern ((elements container1)))))
...
(assert (forall ((container1 us_rep)) (! (dynamic_invariant5 (length1 container1) true false true true) :pattern ((length1 container1)))))
(assert (forall ((container1 us_rep)) (! (let ((result (is_empty container1))) (and (= (= result true) (forall ((item Int)) (not (and (in_range2 item) (= (contains container1 item) true))))) (= (= result true) (= (length1 container1) 0)))) :pattern ((is_empty container1)))))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length2 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant5 result true false true true))) :pattern ((length2 container1)))))
