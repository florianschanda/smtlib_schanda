...
(assert (= usergroup_examples__example_5__result1 (bvxor #x0000000000000049 (bvmul a b))))
...
(assert (not (bvugt usergroup_examples__example_5__result4 #x0000000000000000)))
(check-sat)
(exit)
