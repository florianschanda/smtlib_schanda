...
(assert (= result rcx))
(assert (= rcx1 (bvor (bvand rcx #x000000000000FF00) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) #x0100)))))
(assert (= rcx1 rcx2))
(assert (= rcx3 rcx1))
(assert (not (= rcx2 (bvor (bvand rcx #x000000000000FF00) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) #x0100))))))
(check-sat)
(exit)
