...
(declare-fun titerSqtint (titerS) Int)
(assert (forall ((i titerS)) (and (<= 0 (titerSqtint i)) (<= (titerSqtint i) 31))))
...
(assert (in_range exp1))
(assert (= (mk_t__ref result) (mk_t__ref cur_exp)))
(assert (= cur_exp1 ((_ int2bv 32) exp1)))
...
(assert (= result__2 (power val__ (bv2nat (bvurem ((_ int2bv 32) exp1) (pow21 iter2))))))
(assert (= cur_val2 (power val__ (bv2nat (pow21 iter2)))))
(assert (= cur_exp2 (bvudiv cur_exp1 (pow21 iter2))))
(assert (=> (<= 0 31) (in_range1 iter2)))
(assert (and (= o (pow21 iter2)) (= o (ite (< iter2 4294967296) (bvshl #x00000001 ((_ int2bv 32) iter2)) #x00000000))))
(assert (not (not (= o #x00000000))))
(check-sat)
(exit)
