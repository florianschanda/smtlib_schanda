...
(declare-const x86__r14l__result (_ BitVec 8))
(declare-const result (_ BitVec 8))
(declare-const x86__r14l__result1 (_ BitVec 8))
(declare-const x86__r14l__result2 (_ BitVec 8))
...
(assert (= result x86__r14l__result))
(assert (= x86__r14l__result1 ((_ extract 7 0) (bvand r14 #x00000000000000FF))))
(assert (= (mk_t__ref x86__r14l__result4) (mk_t__ref x86__r14l__result2)))
(assert (= x86__r14l__result5 x86__r14l__result3))
(assert (= result1 x86__r14l__result4))
(assert (not (= x86__r14l__result4 (readreglow8 r14))))
(check-sat)
(exit)
