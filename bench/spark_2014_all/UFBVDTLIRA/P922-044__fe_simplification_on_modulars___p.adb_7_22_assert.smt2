...
(declare-datatypes () ((mod_64__ref (mk_mod_64__ref (mod_64__content mod_64)))))
(define-fun mod_64__ref___projection ((a mod_64__ref)) mod_64 (mod_64__content a))
(define-fun dynamic_invariant ((temp___expr_200 (_ BitVec 64)) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool true)
(declare-const x (_ BitVec 64))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(assert (not (bvult x (bvadd x #x0000000000000001))))
(check-sat)
(exit)
