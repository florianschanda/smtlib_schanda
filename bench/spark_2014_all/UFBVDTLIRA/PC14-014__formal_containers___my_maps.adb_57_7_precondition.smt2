...
(assert (not (or (< (length (mk___rep l__split_discrs l__split_fields2)) (to_rep1 (rec__my_maps__n__map__capacity l__split_discrs))) (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 (mk___split_fields1 rliteral1 rliteral2))) true))))
(check-sat)
(exit)
