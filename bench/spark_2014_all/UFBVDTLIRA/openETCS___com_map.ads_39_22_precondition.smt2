...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__com_map__com_to_rbc_map__map us_main_type1)))))
(define-fun us_split_fields_Map__projection ((a us_split_fields)) us_main_type1 (rec__com_map__com_to_rbc_map__map a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep1 (rec__com_map__com_to_rbc_map__map__capacity (us_split_discrs1 a))) (to_rep1 (rec__com_map__com_to_rbc_map__map__capacity (us_split_discrs1 b)))) (= (to_rep (rec__com_map__com_to_rbc_map__map__modulus (us_split_discrs1 a))) (to_rep (rec__com_map__com_to_rbc_map__map__modulus (us_split_discrs1 b))))) (= (us_main_eq1 (rec__com_map__com_to_rbc_map__map (us_split_fields1 a)) (rec__com_map__com_to_rbc_map__map (us_split_fields1 b))) true)) true false))
...
(declare-fun get (us_rep Int) Bool)
(declare-fun get__function_guard (Bool us_rep Int) Bool)
(define-fun element__2 ((container us_rep1) (key Int)) Bool (get (model__ container) key))
(declare-fun element__2__function_guard (Bool us_rep1 Int) Bool)
...
(declare-fun user_eq4 (rbc_riu_id_t rbc_riu_id_t) Bool)
(declare-const dummy4 rbc_riu_id_t)
...
(define-fun dynamic_invariant ((temp___expr_315 Int) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (=> (or (= temp___is_init_311 true) (<= 1 10000)) (in_range1 temp___expr_315)))
...
(define-fun dynamic_invariant2 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range temp___expr_197)))
(declare-fun length (us_rep) Int)
(declare-fun length__function_guard (Int us_rep) Bool)
(declare-fun is_empty (us_rep) Bool)
(declare-fun is_empty__function_guard (Bool us_rep) Bool)
(define-fun default_initial_assumption ((temp___expr_408 us_rep) (temp___skip_top_level_409 Bool)) Bool (=> (not (= temp___skip_top_level_409 true)) (and (= (is_empty temp___expr_408) true) (= (length temp___expr_408) 0))))
(assert true)
...
(assert (forall ((container us_rep)) (forall ((key Int)) (! (=> (dynamic_invariant3 key true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range3 k) (= (has_key container k) true)) (= k key))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
(declare-fun witness (us_rep Int) Int)
(declare-fun witness__function_guard (Int us_rep Int) Bool)
(declare-fun w_get (us_rep Int) Bool)
(declare-fun w_get__function_guard (Bool us_rep Int) Bool)
(assert (forall ((container us_rep)) (forall ((key Int)) (! (=> (and (dynamic_invariant3 key true true true true) (= (has_key container key) true)) (=> (= (distinct 1 0) true) (and (= (= (get container key) true) (= (w_get container (witness container key)) true)) (forall ((k Int)) (=> (and (in_range3 k) (= (has_key container k) true)) (= (= k key) (= (witness container key) (witness container k)))))))) :pattern ((get container key))))))
(assert (forall ((container us_rep)) (! (dynamic_invariant2 (length container) true false true true) :pattern ((length container)))))
(assert (forall ((left us_rep) (right us_rep)) (! (= (= (oeq1 left right) true) (and (forall ((key Int)) (=> (and (in_range3 key) (= (has_key left key) true)) (and (= (has_key right key) true) (= (= (get right key) true) (= (get left key) true))))) (forall ((key Int)) (=> (and (in_range3 key) (= (has_key right key) true)) (= (has_key left key) true))))) :pattern ((oeq1 left right)))))
(assert (forall ((container us_rep)) (! (= (= (is_empty container) true) (forall ((key Int)) (not (and (in_range3 key) (= (has_key container key) true))))) :pattern ((is_empty container)))))
(declare-fun has_witness (us_rep Int) Bool)
(declare-fun has_witness__function_guard (Bool us_rep Int) Bool)
(assert true)
(assert (forall ((container us_rep)) (forall ((key Int)) (! (=> (and (dynamic_invariant3 key true true true true) (= (has_key container key) true)) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant2 result true false true true)))) :pattern ((witness container key))))))
(assert true)
