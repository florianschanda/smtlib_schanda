...
(declare-const x86__ax__result (_ BitVec 16))
(declare-const result (_ BitVec 16))
(declare-const x86__ax__result1 (_ BitVec 16))
(declare-const x86__ax__result2 (_ BitVec 16))
(declare-const x86__ax__result3 (_ BitVec 16))
(declare-const x86__ax__result4 (_ BitVec 16))
(declare-const x86__ax__result5 (_ BitVec 16))
(declare-const result1 (_ BitVec 16))
(assert (= x86__ax__result1 x86__ax__result2))
(assert (= x86__ax__result3 x86__ax__result1))
(assert (= (mk_t__ref result) (mk_t__ref x86__ax__result)))
(assert (= x86__ax__result1 ((_ extract 15 0) (bvand rax #x000000000000FFFF))))
(assert (= (mk_t__ref x86__ax__result4) (mk_t__ref x86__ax__result2)))
(assert (= x86__ax__result5 x86__ax__result3))
(assert (= result1 x86__ax__result4))
(assert (not (= x86__ax__result4 ((_ extract 15 0) (bvand rax #x000000000000FFFF)))))
(check-sat)
(exit)
