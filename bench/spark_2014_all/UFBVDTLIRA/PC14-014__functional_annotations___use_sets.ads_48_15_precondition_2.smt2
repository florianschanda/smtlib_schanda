...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length1 result) (length container)) (forall ((temp___471 Int)) (=> (and (in_range3 temp___471) (= (iter_has_element result temp___471) true)) (= (contains (model__ container) (get result temp___471)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(define-fun e_elements_included__2 ((left us_rep1) (model__1 us_rep2) (right us_rep1)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 left))) (=> (= (contains model__1 (get left i)) true) (and (< 0 (find right (get left i))) (= (get right (find right (get left i))) (get left i)))))) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 0 2147483647)) (in_range5 temp___expr_346)))
(assert true)
...
(define-fun dynamic_invariant5 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 0 2147483647)) (in_range7 temp___expr_353)))
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length1 container)) (= item (get container result)))) (dynamic_invariant result true false true true)))) :pattern ((find container item))))))
...
(define-fun dynamic_invariant6 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 2147483647)) (in_range4 temp___expr_386)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((container us_rep2)) (! (let ((result (is_empty1 container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range4 item) (= (contains container item) true))))) (= (= result true) (= (length3 container) 0)))) :pattern ((is_empty1 container)))))
(assert (forall ((container us_rep2) (left us_rep2) (right us_rep2)) (! (= (= (includes_intersection container left right) true) (forall ((item Int)) (=> (and (in_range4 item) (= (contains left item) true)) (=> (= (contains right item) true) (= (contains container item) true))))) :pattern ((includes_intersection container left right)))))
(assert (forall ((container us_rep2) (left us_rep2) (right us_rep2)) (! (= (= (included_in_union container left right) true) (forall ((item Int)) (=> (and (in_range4 item) (= (contains container item) true)) (or (= (contains left item) true) (= (contains right item) true))))) :pattern ((included_in_union container left right)))))
(declare-fun no_overlap (us_rep2 us_rep2) Bool)
(declare-fun no_overlap__function_guard (Bool us_rep2 us_rep2) Bool)
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (no_overlap left right) true) (forall ((item Int)) (=> (and (in_range4 item) (= (contains left item) true)) (not (= (contains right item) true))))) :pattern ((no_overlap left right)))))
(declare-fun intersection1 (us_rep2 us_rep2) us_rep2)
(declare-fun intersection__function_guard (us_rep2 us_rep2 us_rep2) Bool)
(assert (forall ((left us_rep2) (right us_rep2)) (! (let ((result (num_overlaps left right))) (and (and (and (and (= result (length3 (intersection1 left right))) (ite (= (ole left right) true) (= result (length3 left)) (< result (length3 left)))) (ite (= (ole right left) true) (= result (length3 right)) (< result (length3 right)))) (= (= result 0) (= (no_overlap left right) true))) (dynamic_invariant result true false true true))) :pattern ((num_overlaps left right)))))
...
(define-fun dynamic_invariant7 ((temp___expr_445 Int) (temp___is_init_441 Bool) (temp___skip_constant_442 Bool) (temp___do_toplevel_443 Bool) (temp___do_typ_inv_444 Bool)) Bool (=> (or (= temp___is_init_441 true) (<= 1 2147483647)) (in_range8 temp___expr_445)))
(assert (forall ((container us_rep3)) (forall ((key us_rep4)) (! (=> (= (has_key container key) true) (let ((result (get1 container key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep4)) (=> (= (has_key container k) true) (= (= (bool_eq4 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant7 result true false true true)))) :pattern ((get1 container key))))))
...
(declare-const temp___966 us_rep1)
(declare-const temp___965 Int)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const temp___970 us_rep1)
...
(assert (and (= o8 (length s2)) (and (in_range1 o8) (<= o8 (to_rep1 (rec__use_sets__my_sets__set__capacity (us_split_discrs1 s2)))))))
(assert (and (= o5 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range1 o5) (<= o5 (to_rep1 (rec__use_sets__my_sets__set__capacity s1__split_discrs))))))
(assert (and (= o6 (capacity (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range1 o6) (= o6 (to_rep1 (rec__use_sets__my_sets__set__capacity s1__split_discrs))))))
(assert (= o7 (- o6 o5)))
(assert (and (= o9 o7) (in_range6 o7)))
(assert (= o10 (ite (< o8 o9) true false)))
(assert (and (= temp___970 (elements s2)) (and (and (and (and (= (length1 temp___970) (length s2)) (forall ((temp___467 Int)) (=> (and (in_range3 temp___467) (= (iter_has_element temp___970 temp___467) true)) (= (contains (model__ s2) (get temp___970 temp___467)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ s2) item) true)) (and (< 0 (find temp___970 item)) (= (get temp___970 (find temp___970 item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s2))) (= (find temp___970 (get temp___970 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s2))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s2))) (=> (= (get temp___970 i) (get temp___970 j)) (= i j)))))))))
(assert (and (= o2 (iter_has_element temp___970 temp___969)) (= (= o2 true) (and (<= 1 temp___969) (<= temp___969 (last temp___970))))))
(assert (= (= o3 true) (in_range3 temp___969)))
(assert (= result (ite (= o3 true) o2 false)))
(assert (= (= o4 true) (let ((temp___972 (elements s2))) (forall ((temp___971 Int)) (=> (and (in_range3 temp___971) (= (iter_has_element temp___972 temp___971) true)) (= (prop__ (get temp___972 temp___971)) true))))))
(assert (and (= temp___966 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (and (and (and (= (length1 temp___966) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (forall ((temp___467 Int)) (=> (and (in_range3 temp___467) (= (iter_has_element temp___966 temp___467) true)) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get temp___966 temp___467)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) item) true)) (and (< 0 (find temp___966 item)) (= (get temp___966 (find temp___966 item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (= (find temp___966 (get temp___966 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (=> (= (get temp___966 i) (get temp___966 j)) (= i j)))))))))
(assert (and (= o (iter_has_element temp___966 temp___965)) (= (= o true) (and (<= 1 temp___965) (<= temp___965 (last temp___966))))))
(assert (= (= o1 true) (in_range3 temp___965)))
(assert (= result1 (ite (= o1 true) o false)))
(assert (= result1 true))
(assert (not (<= temp___965 (last temp___966))))
(check-sat)
(exit)
