...
(declare-const dummy unsigned16)
...
(define-fun dynamic_invariant ((temp___expr_250 (_ BitVec 16)) (temp___is_init_246 Bool) (temp___skip_constant_247 Bool) (temp___do_toplevel_248 Bool) (temp___do_typ_inv_249 Bool)) Bool true)
...
(declare-const retval (_ BitVec 16))
(declare-const x86__signextend8to16__result (_ BitVec 16))
(declare-const result (_ BitVec 16))
(declare-const retval1 (_ BitVec 16))
(declare-const result1 (_ BitVec 16))
(declare-const retval2 (_ BitVec 16))
(declare-const result2 (_ BitVec 16))
(declare-const x86__signextend8to16__result1 (_ BitVec 16))
(declare-const x86__signextend8to16__result2 (_ BitVec 16))
(declare-const x86__signextend8to16__result3 (_ BitVec 16))
(declare-const retval3 (_ BitVec 16))
(declare-const x86__signextend8to16__result4 (_ BitVec 16))
(declare-const retval4 (_ BitVec 16))
(declare-const x86__signextend8to16__result5 (_ BitVec 16))
(define-fun retval5 () t__ref1 (mk_t__ref1 retval))
(assert (=> (bvugt val__ #x7F) (= (mk_t__ref1 result) retval5)))
(assert (=> (bvugt val__ #x7F) (= retval1 (bvor #xFF00 ((_ zero_extend 8) val__)))))
(assert (=> (not (bvugt val__ #x7F)) (= (mk_t__ref1 result1) retval5)))
(assert (=> (not (bvugt val__ #x7F)) (= retval2 ((_ zero_extend 8) val__))))
(assert (=> (not (bvugt val__ #x7F)) (= retval1 retval2)))
...
(assert (= (mk_t__ref1 result2) (mk_t__ref1 x86__signextend8to16__result)))
(assert (= x86__signextend8to16__result1 retval1))
(assert (= (mk_t__ref1 x86__signextend8to16__result4) (mk_t__ref1 x86__signextend8to16__result2)))
