...
(assert (forall ((v (_ BitVec 8))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true true) (dynamic_invariant amount true true true true)) (dynamic_invariant1 (shift_left v amount) true false true true)) :pattern ((shift_left v amount))))))
(assert (forall ((v (_ BitVec 8))) (forall ((amount Int)) (! (=> (and (dynamic_invariant1 v true true true true) (dynamic_invariant amount true true true true)) (= (shift_left v amount) (ite (and (<= 1 8) (<= 8 8)) (ite (< amount 8) (bvshl v ((_ int2bv 8) amount)) #x00) (ite (and (<= 9 8) (<= 8 16)) ((_ extract 7 0) (bvurem (ite (< amount 16) (bvshl ((_ zero_extend 8) v) ((_ int2bv 16) amount)) #x0000) ((_ int2bv 16) 256))) (ite (and (<= 17 8) (<= 8 32)) ((_ extract 7 0) (bvurem (bvshl ((_ zero_extend 24) v) ((_ int2bv 32) amount)) ((_ int2bv 32) 256))) ((_ extract 7 0) (bvurem (bvshl ((_ zero_extend 56) v) ((_ int2bv 64) amount)) ((_ int2bv 64) 256)))))))) :pattern ((shift_left v amount))))))
...
(define-fun dynamic_invariant2 ((temp___expr_277 Int) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool) (temp___do_typ_inv_276 Bool)) Bool (=> (or (= temp___is_init_273 true) (<= 1 8)) (in_range1 temp___expr_277)))
...
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant2 num_bits true true true true) (= (make_mask num_bits) (shift_right #xFF (- 8 num_bits)))) :pattern ((make_mask num_bits)))))
...
(define-fun dynamic_invariant3 ((temp___expr_270 Int) (temp___is_init_266 Bool) (temp___skip_constant_267 Bool) (temp___do_toplevel_268 Bool) (temp___do_typ_inv_269 Bool)) Bool (=> (or (= temp___is_init_266 true) (<= 0 7)) (in_range2 temp___expr_270)))
...
(declare-const bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result (_ BitVec 8))
(declare-const bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__len__assume Int)
(declare-const o Int)
(declare-const bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__mask__assume (_ BitVec 8))
...
(declare-const bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result1 (_ BitVec 8))
(declare-const bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result2 (_ BitVec 8))
(declare-const bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result3 (_ BitVec 8))
(declare-const result__2 (_ BitVec 8))
(declare-const bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result4 (_ BitVec 8))
(declare-const result__3 (_ BitVec 8))
(declare-const bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result5 (_ BitVec 8))
(declare-const result2 (_ BitVec 8))
(assert (in_range2 from))
(assert (in_range2 to__))
(assert (<= from to__))
(assert (and (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__len__assume (+ (- to__ from) 1)) (in_range (+ (- to__ from) 1))))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__len__assume len))
(assert (in_range len))
(assert (and (= o len) (in_range1 len)))
(assert (and (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__mask__assume (make_mask o)) (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__mask__assume (shift_right #xFF (- 8 o)))))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__mask__assume mask))
(assert (and (= o1 (shift_right value from)) (= o1 (ite (and (<= 1 8) (<= 8 8)) (ite (< from 8) (bvlshr value ((_ int2bv 8) from)) #x00) (ite (and (<= 9 8) (<= 8 16)) ((_ extract 7 0) (ite (< from 16) (bvlshr ((_ zero_extend 8) value) ((_ int2bv 16) from)) #x0000)) (ite (and (<= 17 8) (<= 8 32)) ((_ extract 7 0) (bvlshr ((_ zero_extend 24) value) ((_ int2bv 32) from))) ((_ extract 7 0) (bvlshr ((_ zero_extend 56) value) ((_ int2bv 64) from)))))))))
(assert (= o2 (bvand o1 mask)))
(assert (= (mk_t__ref result) (mk_t__ref result__)))
(assert (= result__1 o2))
(assert (bvule result__1 mask))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result1 bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result2))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result3 bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result1))
(assert (= (mk_t__ref result1) (mk_t__ref bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result)))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result1 result__1))
(assert (= (mk_t__ref bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result4) (mk_t__ref bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result2)))
(assert (= result__1 result__2))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result5 bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result3))
(assert (= result__3 result__1))
(assert (= result2 bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result4))
(assert (not (bvule bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result4 (make_mask (+ (- to__ from) 1)))))
(check-sat)
(exit)
