...
(assert (forall ((value (_ BitVec 8))) (forall ((from Int) (to__ Int)) (! (=> (and (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant3 from true true true true)) (dynamic_invariant3 to__ true true true true)) (<= from to__)) (let ((result (extract_bits_inline value from to__))) (and (and (= result (bvand (shift_right value from) (make_mask (+ (- to__ from) 1)))) (and (bvule result (make_mask (+ (- to__ from) 1))) (= (shift_left result from) (bvand value (shift_left (make_mask (+ (- to__ from) 1)) from))))) (dynamic_invariant1 result true false true true)))) :pattern ((extract_bits_inline value from to__))))))
(assert (forall ((value (_ BitVec 8))) (forall ((from Int) (to__ Int)) (! (=> (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant3 from true true true true)) (dynamic_invariant3 to__ true true true true)) (= (extract_bits_inline value from to__) (extract_bits_inline_always value from to__))) :pattern ((extract_bits_inline value from to__))))))
...
(assert (forall ((value (_ BitVec 8))) (forall ((from Int) (to__ Int)) (! (=> (and (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant3 from true true true true)) (dynamic_invariant3 to__ true true true true)) (<= from to__)) (let ((result (extract_bits_not_inline value from to__))) (and (and (= result (bvand (shift_right value from) (make_mask (+ (- to__ from) 1)))) (and (bvule result (make_mask (+ (- to__ from) 1))) (= (shift_left result from) (bvand value (shift_left (make_mask (+ (- to__ from) 1)) from))))) (dynamic_invariant1 result true false true true)))) :pattern ((extract_bits_not_inline value from to__))))))
(assert (forall ((value (_ BitVec 8))) (forall ((from Int) (to__ Int)) (! (=> (and (and (dynamic_invariant1 value true true true true) (dynamic_invariant3 from true true true true)) (dynamic_invariant3 to__ true true true true)) (= (extract_bits_not_inline value from to__) (extract_bits_inline_always value from to__))) :pattern ((extract_bits_not_inline value from to__))))))
