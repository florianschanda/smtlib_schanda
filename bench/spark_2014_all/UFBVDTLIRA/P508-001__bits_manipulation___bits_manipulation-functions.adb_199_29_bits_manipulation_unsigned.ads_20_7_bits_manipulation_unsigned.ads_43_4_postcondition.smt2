...
(declare-const temp___490 (_ BitVec 16))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___491 i1)))
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___490 result__1)))
...
(assert (=> (and (<= 1 i1) (<= i1 amount)) (= (bvand result__3 (let ((temp___494 (- i2 1))) (ite (< temp___494 65536) (bvshl #x0001 ((_ int2bv 16) temp___494)) #x0000))) (let ((temp___495 (- i2 1))) (ite (< temp___495 65536) (bvshl #x0001 ((_ int2bv 16) temp___495)) #x0000)))))
