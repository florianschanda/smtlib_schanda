...
(assert (forall ((num_bits Int)) (! (=> (dynamic_invariant1 num_bits true true true true) (= (make_mask num_bits) (shift_right #xFF (- 8 num_bits)))) :pattern ((make_mask num_bits)))))
...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma2 us_void_param) true) (forall ((size Int)) (=> (and (<= 1 size) (<= size 7)) (= (make_mask size) (bvsub (ite (< size 256) (bvshl #x01 ((_ int2bv 8) size)) #x00) #x01))))) :pattern ((lemma2 us_void_param)))))
(declare-fun lemma2_goal (tuple0) Bool)
(declare-fun lemma2_goal__function_guard (Bool tuple0) Bool)
(assert true)
(declare-sort t584s 0)
(declare-fun t584sqtint (t584s) Int)
(assert (forall ((i t584s)) (and (<= 2 (t584sqtint i)) (<= (t584sqtint i) 7))))
(define-fun in_range2 ((x Int)) Bool (and (<= 2 x) (<= x 7)))
(declare-fun attr__ATTRIBUTE_IMAGE3 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Int)
(declare-fun user_eq2 (t584s t584s) Bool)
(declare-const dummy2 t584s)
(declare-datatypes () ((t584s__ref (mk_t584s__ref (t584s__content t584s)))))
(define-fun t584s__ref___projection ((a t584s__ref)) t584s (t584s__content a))
...
(assert true)
(assert (forall ((us_void_param tuple0)) (! (= (= (lemma81 us_void_param) true) (forall ((val__ (_ BitVec 8))) (=> (and (bvule #x00 val__) (bvule val__ #xFF)) (forall ((n Int)) (=> (and (<= 1 n) (<= n 7)) (bvult (shift_right val__ (- 8 n)) (ite (< n 256) (bvshl #x01 ((_ int2bv 8) n)) #x00))))))) :pattern ((lemma81 us_void_param)))))
(assert (= (lemma8 Tuple0) true))
(assert (not (= (make_mask 1) #x01)))
(check-sat)
(exit)
