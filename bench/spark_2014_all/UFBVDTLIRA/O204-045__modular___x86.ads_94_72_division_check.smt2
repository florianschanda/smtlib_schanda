...
(declare-const x86__ch__result (_ BitVec 8))
(declare-const result (_ BitVec 8))
(declare-const x86__ch__result1 (_ BitVec 8))
(declare-const x86__ch__result2 (_ BitVec 8))
(declare-const x86__ch__result3 (_ BitVec 8))
(declare-const x86__ch__result4 (_ BitVec 8))
(declare-const x86__ch__result5 (_ BitVec 8))
(assert (= x86__ch__result1 x86__ch__result2))
(assert (= x86__ch__result3 x86__ch__result1))
(assert (= (mk_t__ref result) (mk_t__ref x86__ch__result)))
(assert (= x86__ch__result1 ((_ extract 7 0) (bvurem (bvudiv (bvand rcx #x000000000000FF00) #x0000000000000100) ((_ int2bv 64) 256)))))
(assert (= (mk_t__ref x86__ch__result4) (mk_t__ref x86__ch__result2)))
(assert (= x86__ch__result5 x86__ch__result3))
