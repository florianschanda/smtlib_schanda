...
(assert (= result__2 o1))
(assert (not (= (bvand result__2 (let ((temp___494 (- i1 1))) (ite (< temp___494 65536) (bvshl #x0001 ((_ int2bv 16) temp___494)) #x0000))) (let ((temp___495 (- i1 1))) (ite (< temp___495 65536) (bvshl #x0001 ((_ int2bv 16) temp___495)) #x0000)))))
(check-sat)
(exit)
