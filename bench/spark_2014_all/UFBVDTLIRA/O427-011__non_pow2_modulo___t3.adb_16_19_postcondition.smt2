...
(declare-sort m 0)
(define-fun in_range ((x (_ BitVec 64))) Bool (and (bvule #x0000000000000000 x) (bvule x #x00000000000000E5)))
...
(define-fun dynamic_invariant ((temp___expr_207 (_ BitVec 64)) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool (=> (or (= temp___is_init_203 true) (bvule #x0000000000000000 #x00000000000000E5)) (in_range temp___expr_207)))
...
(declare-const t3__madd__result1 (_ BitVec 64))
(declare-const t3__madd__result2 (_ BitVec 64))
(declare-const t3__madd__result3 (_ BitVec 64))
(declare-const t3__madd__result4 (_ BitVec 64))
(declare-const t3__madd__result5 (_ BitVec 64))
(declare-const result1 (_ BitVec 64))
(assert (in_range x))
(assert (in_range y))
(assert (= t3__madd__result1 t3__madd__result2))
(assert (= t3__madd__result3 t3__madd__result1))
(assert (=> (bvule (bvsub #x00000000000000E6 x) y) (= o (bvsub (bvadd x y) #x00000000000000E6))))
(assert (=> (not (bvule (bvsub #x00000000000000E6 x) y)) (= o (bvadd x y))))
...
(assert (not (= ((_ extract 15 0) t3__madd__result4) (bvurem (bvadd ((_ extract 15 0) x) ((_ extract 15 0) y)) #x00E6))))
(check-sat)
(exit)
