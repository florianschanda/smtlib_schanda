...
(assert (forall ((left us_rep) (right us_rep)) (! (let ((result (intersection1 left right))) (and (and (= (ole result left) true) (= (ole result right) true)) (= (includes_intersection result left right) true))) :pattern ((intersection1 left right)))))
...
(define-fun dynamic_invariant ((temp___expr_415 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool) (temp___do_typ_inv_414 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 0 2147483647)) (in_range2 temp___expr_415)))
...
(define-fun dynamic_invariant1 ((temp___expr_422 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 0 2147483647)) (in_range3 temp___expr_422)))
...
(define-fun default_initial_assumption1 ((temp___expr_430 us_rep1) (temp___skip_top_level_431 Bool)) Bool (=> (not (= temp___skip_top_level_431 true)) (= (length1 temp___expr_430) 0)))
(assert (forall ((container us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant1 position true true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant (get container position) true false true true)) :pattern ((get container position))))))
...
(define-fun dynamic_invariant2 ((temp___expr_445 Int) (temp___is_init_441 Bool) (temp___skip_constant_442 Bool) (temp___do_toplevel_443 Bool) (temp___do_typ_inv_444 Bool)) Bool (=> (or (= temp___is_init_441 true) (<= 1 2147483647)) (in_range5 temp___expr_445)))
...
(define-fun default_initial_assumption2 ((temp___expr_453 us_rep3) (temp___skip_top_level_454 Bool)) Bool (=> (not (= temp___skip_top_level_454 true)) (and (= (is_empty1 temp___expr_453) true) (= (length2 temp___expr_453) 0))))
(assert (forall ((container us_rep3)) (forall ((key us_rep2)) (! (=> (= (has_key container key) true) (let ((result (get1 container key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep2)) (=> (= (has_key container k) true) (= (= (bool_eq2 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant2 result true false true true)))) :pattern ((get1 container key))))))
...
(assert (forall ((container us_rep4)) (! (= (length (model__ container)) (length3 container)) :pattern ((model__ container)))))
...
(assert (forall ((container us_rep4)) (! (let ((result (elements container))) (and (and (and (and (= (length1 result) (length3 container)) (forall ((temp___471 Int)) (=> (and (in_range3 temp___471) (= (iter_has_element result temp___471) true)) (= (contains (model__ container) (get result temp___471)) true)))) (forall ((item Int)) (=> (and (in_range1 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length3 container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(assert (forall ((container us_rep4)) (! (let ((result (positions container))) (and (not (= (has_key result no_element) true)) (forall ((i us_rep2)) (=> (= (has_key result i) true) (and (and (<= 1 (get1 result i)) (<= (get1 result i) (length3 container))) (forall ((j us_rep2)) (=> (= (has_key result j) true) (=> (= (get1 result i) (get1 result j)) (= (bool_eq2 i j) true))))))))) :pattern ((positions container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 0 2147483647)) (in_range6 temp___expr_353)))
...
(define-fun dynamic_invariant5 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range4 temp___expr_197)))
(declare-const rliteral count_type)
(assert (= (count_typeqtint rliteral) 0))
(assert (= no_element (mk___rep (mk___split_fields rliteral))))
(assert (forall ((container us_rep4)) (! (let ((result (length3 container))) (and (<= result (to_rep (rec__use_sets__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant5 result true false true true))) :pattern ((length3 container)))))
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length1 container)) (= item (get container result)))) (dynamic_invariant5 result true false true true)))) :pattern ((find container item))))))
...
(assert (forall ((left us_rep4) (right us_rep4)) (! (let ((result (oeq1 left right))) (and (= (= result true) (and (= (length3 left) (length3 right)) (= (e_elements_included (elements left) (elements right)) true))) (= (= result true) (and (= (e_elements_included (elements left) (elements right)) true) (= (e_elements_included (elements right) (elements left)) true))))) :pattern ((oeq1 left right)))))
(define-fun dynamic_invariant6 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 2147483647)) (in_range1 temp___expr_386)))
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range1 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
(assert (forall ((container us_rep)) (! (dynamic_invariant5 (length container) true false true true) :pattern ((length container)))))
...
(assert (forall ((container us_rep) (left us_rep) (right us_rep)) (! (= (= (includes_intersection container left right) true) (forall ((item Int)) (=> (and (in_range1 item) (= (contains left item) true)) (=> (= (contains right item) true) (= (contains container item) true))))) :pattern ((includes_intersection container left right)))))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant5 result true false true true))) :pattern ((length1 container)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key us_rep2)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant5 result true false true true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant5 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant2 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
(declare-const cu__split_fields count_type)
(declare-const use_sets__are_disjoint__cu__assume count_type)
...
(define-fun use_sets__are_disjoint__cu__assume1 () us_rep2 (mk___rep (mk___split_fields use_sets__are_disjoint__cu__assume)))
(assert (and (= use_sets__are_disjoint__cu__assume1 (first s1)) (ite (= (= (length3 s1) 0) true) (= (bool_eq2 use_sets__are_disjoint__cu__assume1 no_element) true) (and (= (has_key (positions s1) use_sets__are_disjoint__cu__assume1) true) (= (get1 (positions s1) use_sets__are_disjoint__cu__assume1) 1)))))
(assert (= (mk___split_fields__ref (mk___split_fields result)) (mk___split_fields__ref (mk___split_fields cu__split_fields))))
(assert (= use_sets__are_disjoint__cu__assume cu__split_fields1))
(assert (and (= result1 (has_key (positions s1) (mk___rep cu__split_fields4))) (= (= result1 true) (= (has_key (positions s1) (mk___rep cu__split_fields4)) true))))
(assert (= result1 true))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s1) (mk___rep cu__split_fields3)) 1))) (not (= (contains (model__ s2) (get (elements s1) i)) true)))))
(assert (= (has_key (positions s1) (mk___rep cu__split_fields3)) true))
(assert (and (= o (positions s1)) (and (not (= (has_key o no_element) true)) (forall ((i us_rep2)) (=> (= (has_key o i) true) (and (and (<= 1 (get1 o i)) (<= (get1 o i) (length3 s1))) (forall ((j us_rep2)) (=> (= (has_key o j) true) (=> (= (get1 o i) (get1 o j)) (= (bool_eq2 i j) true))))))))))
(assert (not (= (has_key o (mk___rep cu__split_fields3)) true)))
(check-sat)
(exit)
