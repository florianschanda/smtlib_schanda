...
(declare-const x86__r11l__result (_ BitVec 8))
(declare-const result (_ BitVec 8))
(declare-const x86__r11l__result1 (_ BitVec 8))
(declare-const x86__r11l__result2 (_ BitVec 8))
(declare-const x86__r11l__result3 (_ BitVec 8))
(declare-const x86__r11l__result4 (_ BitVec 8))
(declare-const x86__r11l__result5 (_ BitVec 8))
(declare-const result1 (_ BitVec 8))
(assert (= x86__r11l__result1 x86__r11l__result2))
(assert (= x86__r11l__result3 x86__r11l__result1))
(assert (= result x86__r11l__result))
(assert (= x86__r11l__result1 ((_ extract 7 0) (bvand r11 #x00000000000000FF))))
(assert (= (mk_t__ref x86__r11l__result4) (mk_t__ref x86__r11l__result2)))
(assert (= x86__r11l__result5 x86__r11l__result3))
(assert (= result1 x86__r11l__result4))
(assert (not (= x86__r11l__result4 (readreglow8 r11))))
(check-sat)
(exit)
