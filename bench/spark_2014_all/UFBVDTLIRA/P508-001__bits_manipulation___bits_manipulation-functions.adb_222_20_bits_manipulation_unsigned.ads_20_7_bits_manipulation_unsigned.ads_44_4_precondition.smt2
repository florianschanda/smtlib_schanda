...
(assert (= (make_mask 1) #x00000001))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 31)) (= temp___507 i1)))
(assert (=> (and (<= 2 i1) (<= i1 31)) (= (make_mask i1) (bvsub (ite (< i1 4294967296) (bvshl #x00000001 ((_ int2bv 32) i1)) #x00000000) #x00000001))))
(assert (=> (and (<= 2 i1) (<= i1 31)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (make_mask j) (bvsub (ite (< j 4294967296) (bvshl #x00000001 ((_ int2bv 32) j)) #x00000000) #x00000001))))))
(assert (=> (and (<= 2 i1) (<= i1 31)) (and (=> (<= 2 31) (in_range2 i2)) (and (<= 2 i2) (<= i2 31)))))
(assert (=> (and (<= 2 i1) (<= i1 31)) (= i2 31)))
(assert (=> (and (<= 2 i1) (<= i1 31)) (= i2 i3)))
(assert (=> (and (<= 2 i1) (<= i1 31)) (= i4 i2)))
(assert (=> (and (<= 2 i1) (<= i1 31)) (= (mk_int__ref i5) (mk_int__ref i3))))
(assert (=> (and (<= 2 i1) (<= i1 31)) (= i6 i4)))
(assert (=> (not (and (<= 2 i1) (<= i1 31))) (= i1 i5)))
(assert (=> (not (and (<= 2 i1) (<= i1 31))) (= i6 i1)))
(assert (forall ((size Int)) (=> (and (<= 1 size) (<= size 31)) (= (make_mask size) (bvsub (ite (< size 4294967296) (bvshl #x00000001 ((_ int2bv 32) size)) #x00000000) #x00000001)))))
