...
(declare-const x86__esp__result (_ BitVec 32))
(declare-const result (_ BitVec 32))
(declare-const x86__esp__result1 (_ BitVec 32))
(declare-const x86__esp__result2 (_ BitVec 32))
(declare-const x86__esp__result3 (_ BitVec 32))
...
(assert (= x86__esp__result1 ((_ extract 31 0) (bvand rsp #x00000000FFFFFFFF))))
...
(assert (not (= x86__esp__result4 ((_ extract 31 0) (bvand rsp #x00000000FFFFFFFF)))))
(check-sat)
(exit)
