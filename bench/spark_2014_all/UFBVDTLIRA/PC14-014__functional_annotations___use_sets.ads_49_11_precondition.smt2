...
(assert (and (= o5 (length s2)) (and (in_range1 o5) (<= o5 (to_rep1 (rec__use_sets__my_sets__set__capacity (us_split_discrs1 s2)))))))
(assert (and (= o2 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range1 o2) (<= o2 (to_rep1 (rec__use_sets__my_sets__set__capacity s1__split_discrs))))))
(assert (and (= o3 (capacity (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range1 o3) (= o3 (to_rep1 (rec__use_sets__my_sets__set__capacity s1__split_discrs))))))
(assert (= o4 (- o3 o2)))
(assert (and (= o6 o4) (in_range6 o4)))
(assert (= o7 (ite (< o5 o6) true false)))
...
(assert (and (= o (iter_has_element temp___970 temp___969)) (= (= o true) (and (<= 1 temp___969) (<= temp___969 (last temp___970))))))
(assert (= (= o1 true) (in_range3 temp___969)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (<= temp___969 (last temp___970))))
(check-sat)
(exit)
