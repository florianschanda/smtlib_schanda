...
(declare-fun msb_index_slow_inline_always__function_guard (Int (_ BitVec 32)) Bool)
...
(assert (forall ((value (_ BitVec 32))) (! (=> (and (dynamic_invariant1 value true true true true) (not (= value #x00000000))) (let ((result (msb_index_slow_inline_always value))) (and (= (shift_right value result) #x00000001) (dynamic_invariant2 result true false true true)))) :pattern ((msb_index_slow_inline_always value)))))
(declare-const value (_ BitVec 32))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result Int)
(declare-const o Int)
(declare-const result Int)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result1 Int)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result2 Int)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result3 Int)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result4 Int)
(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result5 Int)
(declare-const result1 Int)
(assert (not (= value #x00000000)))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result1 bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result2))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result3 bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result1))
(assert (and (= o (msb_index_slow_inline_always value)) (and (in_range1 o) (= (shift_right value o) #x00000001))))
(assert (= result bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result1 o))
(assert (= (mk_int__ref bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result4) (mk_int__ref bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result2)))
(assert (= bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result5 bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result3))
(assert (= result1 bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result4))
(assert (not (= (shift_right value bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_not_inline__result4) #x00000001)))
(check-sat)
(exit)
