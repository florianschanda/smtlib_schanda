...
(assert (and (= o (timefromlastclicktolastupdate prevtime thistime)) (= o (bvsub thistime prevtime))))
(assert (= (mk_t__ref result) (mk_t__ref t1)))
(assert (= t11 o))
(assert (and (= o1 (timesincelastupdate currtime thistime)) (= o1 (bvsub currtime thistime))))
(assert (= (mk_t__ref result1) (mk_t__ref t2)))
(assert (= t21 o1))
(assert (and (= o2 (distancefromlastclicktolastupdate prevcount thiscount)) (= o2 (bvmul #x00CF (bvsub thiscount prevcount)))))
