...
(assert (= result rbx))
(assert (= rbx1 (bvor (bvand rbx #x000000000000FF00) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) #x0100)))))
(assert (= rbx1 rbx2))
(assert (= rbx3 rbx1))
(assert (not (= rbx2 (bvor (bvand rbx #x000000000000FF00) ((_ zero_extend 48) (bvmul ((_ zero_extend 8) val__) #x0100))))))
(check-sat)
(exit)
