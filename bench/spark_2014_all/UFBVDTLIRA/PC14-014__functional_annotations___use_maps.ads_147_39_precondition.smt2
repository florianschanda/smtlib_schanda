...
(define-fun key ((container us_rep1) (position us_rep2)) Int (get1 (keys container) (get2 (positions container) position)))
(declare-fun key__function_guard (Int us_rep1 us_rep2) Bool)
(define-fun element ((container us_rep1) (position us_rep2)) Int (get (model__ container) (key container position)))
...
(define-fun element__2 ((container us_rep1) (key1 Int)) Int (get (model__ container) key1))
...
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= result (to_rep1 (rec__use_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant4 result true false true true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 2147483647)) (in_range5 temp___expr_346)))
(define-fun last ((container us_rep4)) Int (+ 0 (length2 container)))
(declare-fun last__function_guard (Int us_rep4) Bool)
(define-fun oeq1 ((left us_rep4) (right us_rep4)) Bool (and (= (length2 left) (length2 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (get1 left n) (get1 right n)))) true false)))
...
(define-fun default_initial_assumption1 ((temp___expr_437 us_rep4) (temp___skip_top_level_438 Bool)) Bool (=> (not (= temp___skip_top_level_438 true)) (= (length2 temp___expr_437) 0)))
(assert (forall ((container us_rep4)) (forall ((key1 Int)) (! (=> (dynamic_invariant5 key1 true true true true) (let ((result (find container key1))) (and (=> (< 0 result) (and (<= result (length2 container)) (= key1 (get1 container result)))) (dynamic_invariant4 result true false true true)))) :pattern ((find container key1))))))
...
(assert (forall ((container us_rep1)) (! (let ((result (keys container))) (and (and (and (and (= (length2 result) (length1 container)) (forall ((temp___478 Int)) (=> (and (in_range6 temp___478) (= (iter_has_element result temp___478) true)) (= (has_key (model__ container) (get1 result temp___478)) true)))) (forall ((key1 Int)) (=> (and (in_range1 key1) (= (has_key (model__ container) key1) true)) (and (< 0 (find result key1)) (= (get1 result (find result key1)) key1))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (= (find result (get1 result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length1 container))) (=> (= (get1 result i) (get1 result j)) (= i j)))))))) :pattern ((keys container)))))
...
(assert (forall ((container us_rep1)) (! (let ((result (positions container))) (and (not (= (has_key1 result no_element) true)) (forall ((i us_rep2)) (=> (= (has_key1 result i) true) (and (and (<= 1 (get2 result i)) (<= (get2 result i) (length1 container))) (forall ((j us_rep2)) (=> (= (has_key1 result j) true) (=> (= (get2 result i) (get2 result j)) (= (bool_eq2 i j) true))))))))) :pattern ((positions container)))))
...
(assert (forall ((container us_rep)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant key1 true true true true) (= (has_key container key1) true)) (let ((result (get container key1))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key1))) (forall ((k Int)) (=> (and (in_range1 k) (= (has_key container k) true)) (= (= k key1) (= (witness container key1) (witness container k))))))) (dynamic_invariant6 result true false true true)))) :pattern ((get container key1))))))
(assert (forall ((container us_rep)) (! (dynamic_invariant4 (length container) true false true true) :pattern ((length container)))))
(assert (forall ((left us_rep) (right us_rep)) (! (= (= (oeq2 left right) true) (and (forall ((key1 Int)) (=> (and (in_range1 key1) (= (has_key left key1) true)) (and (= (has_key right key1) true) (= (get right key1) (get left key1))))) (forall ((key1 Int)) (=> (and (in_range1 key1) (= (has_key right key1) true)) (= (has_key left key1) true))))) :pattern ((oeq2 left right)))))
...
(assert true)
(assert (forall ((container us_rep)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant key1 true true true true) (= (has_key container key1) true)) (let ((result (witness container key1))) (and (= (has_witness container result) true) (dynamic_invariant4 result true false true true)))) :pattern ((witness container key1))))))
(assert (forall ((container us_rep)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant4 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant6 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
...
(assert (forall ((container us_rep3)) (forall ((key1 us_rep2)) (! (=> (= (has_key1 container key1) true) (let ((result (get2 container key1))) (and (=> (= (distinct 0 0) true) (and (= result (w_get1 container (witness1 container key1))) (forall ((k us_rep2)) (=> (= (has_key1 container k) true) (= (= (bool_eq2 k key1) true) (= (witness1 container key1) (witness1 container k))))))) (dynamic_invariant9 result true false true true)))) :pattern ((get2 container key1))))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key1 us_rep2)) (! (=> (= (has_key1 container key1) true) (let ((result (witness1 container key1))) (and (= (has_witness1 container result) true) (dynamic_invariant4 result true false true true)))) :pattern ((witness1 container key1))))))
(assert (forall ((container us_rep3)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant4 witness2 true true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant9 (w_get1 container witness2) true false true true)) :pattern ((w_get1 container witness2))))))
(declare-const cu count_type)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const result Bool)
(define-fun cu1 () us_rep2 (mk___rep1 (mk___split_fields1 cu)))
(assert (forall ((k Int)) (=> (and (in_range1 k) (= (has_key (model__ s) k) true)) (= (q (get (model__ s) k)) true))))
