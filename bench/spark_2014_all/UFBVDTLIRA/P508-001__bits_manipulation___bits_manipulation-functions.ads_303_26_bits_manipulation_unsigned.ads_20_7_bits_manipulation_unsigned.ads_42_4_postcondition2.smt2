...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 7)) (= temp___449 i1)))
(assert (=> (and (<= 2 i1) (<= i1 7)) (= (make_mask i1) (bvsub (ite (< i1 256) (bvshl #x01 ((_ int2bv 8) i1)) #x00) #x01))))
(assert (=> (and (<= 2 i1) (<= i1 7)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (make_mask j) (bvsub (ite (< j 256) (bvshl #x01 ((_ int2bv 8) j)) #x00) #x01))))))
(assert (=> (and (<= 2 i1) (<= i1 7)) (and (=> (<= 2 7) (in_range2 i2)) (and (<= 2 i2) (<= i2 7)))))
...
(assert (forall ((size Int)) (=> (and (<= 1 size) (<= size 7)) (= (make_mask size) (bvsub (ite (< size 256) (bvshl #x01 ((_ int2bv 8) size)) #x00) #x01)))))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result1 bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result2))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result3 bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result1))
(assert (= o (lemma2_goal Tuple0)))
(assert (= result1 bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result1 o))
(assert (= (mk_bool__ref bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result4) (mk_bool__ref bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result2)))
(assert (= (mk_int__ref i7) i9))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result5 bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result3))
(assert (= i8 i6))
(assert (= result2 bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result4))
(assert (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma2__result4 true))
