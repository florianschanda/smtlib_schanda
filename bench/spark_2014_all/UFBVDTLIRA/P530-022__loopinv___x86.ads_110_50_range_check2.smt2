...
(declare-const x86__readreglow8__result (_ BitVec 8))
(declare-const result (_ BitVec 8))
(declare-const x86__readreglow8__result1 (_ BitVec 8))
(declare-const x86__readreglow8__result2 (_ BitVec 8))
(declare-const x86__readreglow8__result3 (_ BitVec 8))
(declare-const x86__readreglow8__result4 (_ BitVec 8))
(declare-const x86__readreglow8__result5 (_ BitVec 8))
(assert (= x86__readreglow8__result1 x86__readreglow8__result2))
(assert (= x86__readreglow8__result3 x86__readreglow8__result1))
(assert (= (mk_t__ref result) (mk_t__ref x86__readreglow8__result)))
(assert (= x86__readreglow8__result1 ((_ extract 7 0) (bvand reg #x00000000000000FF))))
(assert (= (mk_t__ref x86__readreglow8__result4) (mk_t__ref x86__readreglow8__result2)))
(assert (= x86__readreglow8__result5 x86__readreglow8__result3))
(assert (not (bvule ((_ zero_extend 56) #x00) (bvand reg #x00000000000000FF))))
(check-sat)
(exit)
