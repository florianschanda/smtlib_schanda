...
(assert (= or_out11 (ite (or (or (or (or (= roll_active_out11 true) (= hdg_active_out11 true)) (= nav_active_out11 true)) (= lappr_active_out11 true)) (= lga_active_out11 true)) true false)))
