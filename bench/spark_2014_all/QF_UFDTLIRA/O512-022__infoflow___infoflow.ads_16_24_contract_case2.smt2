...
(assert (=> (ite (= (= in_1_dat_v1 in_1_dat_v2) true) (ite (= in_1_rdy_v1 true) (ite (= out_0_rdy_v1 false) (ite (= in_1_rdy_v2 true) (ite (= out_0_rdy_v2 false) true false) false) false) false) false) (= (int__content out_0_dat_v13) (int__content out_0_dat_v23))))
(assert (= (ite (= (ite (= (= out_0_dat_v1 out_0_dat_v2) true) (ite (= in_1_rdy_v1 false) true out_0_rdy_v1) false) true) (ite (= in_1_rdy_v2 false) true out_0_rdy_v2) false) true))
