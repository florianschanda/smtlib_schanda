...
(assert (forall ((i tcoordinate_typeB)) (and (<= (- 2147483648) (tcoordinate_typeBqtint i)) (<= (tcoordinate_typeBqtint i) 2147483647))))
...
(assert (and (= o2 (abs (- (to_rep (rec__raster_graphics__point__y (us_split_fields1 a))) (to_rep (rec__raster_graphics__point__y (us_split_fields1 b)))))) (in_range (abs (- (to_rep (rec__raster_graphics__point__y (us_split_fields1 a))) (to_rep (rec__raster_graphics__point__y (us_split_fields1 b))))))))
(assert (and (= o3 o2) (in_range1 o2)))
(assert (= result1 delta_y))
(assert (= delta_y1 o3))
(assert (in_range1 delta_y1))
(assert (and (= o4 (* min_distance min_distance)) (in_range (* min_distance min_distance))))
(assert (not (in_range (* delta_y1 delta_y1))))
(check-sat)
(exit)
