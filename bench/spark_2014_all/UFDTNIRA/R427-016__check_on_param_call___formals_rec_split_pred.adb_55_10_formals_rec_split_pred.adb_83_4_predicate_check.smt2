...
(assert (= temp___255 (mk___rep y__split_discrs (mk___split_fields (rec__formals_rec_split_pred__rec__f y__split_fields8) (rec__formals_rec_split_pred__rec__g y__split_fields8) rliteral2))))
(assert (not (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h (us_split_fields1 temp___255))) 0))))
(check-sat)
(exit)
