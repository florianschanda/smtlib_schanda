...
(declare-const temp___229 even)
(declare-const temp___2291 even)
...
(assert (= temp___229 o2))
(assert (= temp___2291 o3))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= temp___229 x__split_fields2))
(assert (= temp___2291 x__split_fields3))
