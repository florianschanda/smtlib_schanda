...
(assert (=> (not (= (int__content a__pgcd__result4) 0)) (and (= o1 (abs a)) (in_range1 (abs a)))))
(assert (=> (not (= (int__content a__pgcd__result4) 0)) (= o2 (ite (<= (int__content a__pgcd__result4) o1) true false))))
(assert (=> (not (= (int__content a__pgcd__result4) 0)) (= result7 (ite (<= 1 (int__content a__pgcd__result4)) o2 false))))
