...
(define-fun in_range2 ((x Int)) Bool (and (<= (- 9999999999) x) (<= x 9999999999)))
...
(assert (=> (= result true) (= (to_fixed1 o2) (- (to_fixed1 stash) (to_fixed2 s)))))
(assert (=> (= result true) (= (mk_money__ref result1) (mk_money__ref stash))))
(assert (=> (= result true) (= stash2 o2)))
(assert (=> (= result true) (= (to_fixed1 o3) (+ (to_fixed1 pocket) (to_fixed2 s)))))
(assert (=> (= result true) (= (mk_money__ref result2) (mk_money__ref pocket))))
...
(assert (not (= (+ (to_fixed1 stash3) (to_fixed1 pocket3)) (+ (to_fixed1 stash) (to_fixed1 pocket)))))
(check-sat)
(exit)
