...
(assert (and (= us4 i1) (dynamic_property2 first1 last3 i1)))
(assert (= o7 i1))
...
(assert (and (= us3 temp___502) (dynamic_property3 first2 last4 temp___502)))
...
(assert (and (= us1 i1) (dynamic_property3 first2 last4 i1)))
(assert (= o3 i1))
