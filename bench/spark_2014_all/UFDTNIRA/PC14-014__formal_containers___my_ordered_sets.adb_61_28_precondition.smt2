...
(assert (and (= o (union__2 (mk___rep k__split_discrs k__split_fields3) (mk___rep l__split_discrs l__split_fields11))) (and (and (and (and (and (and (= (length o) (+ (- (length (mk___rep k__split_discrs k__split_fields3)) (num_overlaps (model__ (mk___rep k__split_discrs k__split_fields3)) (model__ (mk___rep l__split_discrs l__split_fields11)))) (length (mk___rep l__split_discrs l__split_fields11)))) (= (ole (model__ (mk___rep k__split_discrs k__split_fields3)) (model__ o)) true)) (= (ole (model__ (mk___rep l__split_discrs l__split_fields11)) (model__ o)) true)) (= (included_in_union (model__ o) (model__ (mk___rep k__split_discrs k__split_fields3)) (model__ (mk___rep l__split_discrs l__split_fields11))) true)) (= (e_elements_included__3 (elements o) (model__ (mk___rep k__split_discrs k__split_fields3)) (elements (mk___rep k__split_discrs k__split_fields3)) (elements (mk___rep l__split_discrs l__split_fields11))) true)) (= (e_elements_included__2 (elements (mk___rep k__split_discrs k__split_fields3)) (model__ (mk___rep k__split_discrs k__split_fields3)) (elements o)) true)) (= (e_elements_included__3 (elements (mk___rep l__split_discrs l__split_fields11)) (model__ (mk___rep k__split_discrs k__split_fields3)) (elements (mk___rep l__split_discrs l__split_fields11)) (elements o)) true))))
