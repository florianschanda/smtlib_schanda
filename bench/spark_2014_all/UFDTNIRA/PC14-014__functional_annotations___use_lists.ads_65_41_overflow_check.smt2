...
(assert (and (= o9 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (in_range2 o9)))
(assert (and (= o7 (* 2 i)) (in_range6 (* 2 i))))
...
(assert (and (= o10 (get o6 o8)) (in_range2 o10)))
