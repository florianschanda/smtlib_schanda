...
(assert (= offset1 o))
(assert (=> (and (< 40 offset1) (<= offset1 180)) (= (mk_int__ref result2) result__9)))
(assert (=> (and (< 40 offset1) (<= offset1 180)) (= result__2 40)))
(assert (=> (not (and (< 40 offset1) (<= offset1 180))) (=> (and (< 180 offset1) (< offset1 320)) (= (mk_int__ref result3) result__9))))
...
(assert (=> (not (and (< 40 offset1) (<= offset1 180))) (=> (not (and (< 180 offset1) (< offset1 320))) (=> (<= offset1 40) (= (mk_int__ref result4) result__9)))))
...
(assert (=> (not (and (< 40 offset1) (<= offset1 180))) (=> (not (and (< 180 offset1) (< offset1 320))) (=> (not (<= offset1 40)) (= (mk_int__ref result5) result__9)))))
...
(assert (=> (not (< 10 result__6)) (=> (< result__6 (- 10)) (= result9 result__6))))
(assert (=> (not (< 10 result__6)) (=> (< result__6 (- 10)) (= result__8 (- 10)))))
(assert (=> (not (< 10 result__6)) (=> (not (< result__6 (- 10))) (= result__8 result__6))))
