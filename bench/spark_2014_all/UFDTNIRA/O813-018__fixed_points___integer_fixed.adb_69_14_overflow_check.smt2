...
(assert (forall ((x1 Int)) (forall ((y1 Int)) (! (ite (or (= x1 0) (= y1 0)) (= (fxp_mult x1 y1) 0) (ite (or (and (< 0 x1) (< 0 y1)) (and (< x1 0) (< y1 0))) (pos_div_relation (fxp_mult x1 y1) (* (* (* (* x1 y1) 2) 2) 1) (* (* 1 1) 2)) (pos_div_relation (- (fxp_mult x1 y1)) (- (* (* (* (* x1 y1) 2) 2) 1)) (* (* 1 1) 2)))) :pattern ((fxp_mult x1 y1))))))
(declare-fun fxp_div (Int Int) Int)
(assert (forall ((x1 Int)) (forall ((y1 Int)) (! (ite (= x1 0) (= (fxp_div x1 y1) 0) (ite (and (< 0 x1) (< 0 y1)) (pos_div_relation (fxp_div x1 y1) (* (* (* x1 2) 1) 1) (* (* (* y1 1) 2) 2)) (ite (and (< x1 0) (< y1 0)) (pos_div_relation (fxp_div x1 y1) (* (* (* (- x1) 2) 1) 1) (* (* (* (- y1) 1) 2) 2)) (ite (and (< x1 0) (< 0 y1)) (pos_div_relation (- (fxp_div x1 y1)) (* (* (* (- x1) 2) 1) 1) (* (* (* y1 1) 2) 2)) (=> (and (< 0 x1) (< y1 0)) (pos_div_relation (- (fxp_div x1 y1)) (* (* (* x1 2) 1) 1) (* (* (* (- y1) 1) 2) 2))))))) :pattern ((fxp_div x1 y1))))))
(assert (= y (of_fixed1 0)))
(assert (= inv_y (of_fixed1 1)))
...
(assert (=> (not (= (to_fixed1 x) 0)) (= (to_fixed1 z2) 0)))
(assert (=> (not (not (= (to_fixed1 x) 0))) (= z2 z)))
(assert (=> (not (not (= (to_fixed1 x) 0))) (= z2 z1)))
(assert (= (to_fixed1 o1) (fxp_div (to_fixed1 x) 1)))
(assert (= result2 z2))
(assert (= z3 o1))
(assert (= (to_fixed1 z3) (to_fixed1 x)))
(assert (not (in_range2 (fxp_div_int (to_fixed1 x) 2))))
(check-sat)
(exit)
