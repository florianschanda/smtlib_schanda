...
(define-fun result____split_fields12 () us_split_fields (mk___split_fields result____split_fields8 result____split_fields9))
(define-fun result____split_fields13 () us_split_fields (mk___split_fields result____split_fields6 result____split_fields7))
(define-fun result____split_fields14 () us_split_fields (mk___split_fields result____split_fields4 result____split_fields5))
...
(assert (=> (< target_x position_x) (= (mk___split_fields__ref (mk___split_fields result result1)) result____split_fields15)))
...
(assert (=> (not (< target_x position_x)) (=> (< position_x target_x) (= (mk___split_fields__ref (mk___split_fields result2 result3)) result____split_fields15))))
...
(assert (=> (not (< target_x position_x)) (=> (not (< position_x target_x)) (= result____split_fields13 (mk___split_fields result____split_fields2 result____split_fields3)))))
(assert (=> (not (< target_x position_x)) (= result____split_fields14 result____split_fields13)))
...
(assert (=> (not (< target_y position_y)) (=> (< position_y target_y) (= result6 (mk___split_fields__ref result____split_fields14)))))
...
(assert (=> (not (< target_y position_y)) (=> (not (< position_y target_y)) (= result____split_fields10 result____split_fields14))))
(assert (=> (not (< target_y position_y)) (= result____split_fields12 result____split_fields10)))
...
(assert (=> (< c4b 10) (= result7 (mk___split_fields__ref result____split_fields12))))
(assert (=> (< c4b 10) (= result____split_fields11 (mk___split_fields temp___174 temp___1741))))
(assert (=> (not (< c4b 10)) (= result____split_fields11 result____split_fields12)))
...
(assert (< c7b 10))
(assert (and (= o7 (* (to_rep (rec__flight_manager__engine_values__y_speed result____split_fields11)) c7b)) (in_range1 (* (to_rep (rec__flight_manager__engine_values__y_speed result____split_fields11)) c7b))))
(assert (not (not (= 10 0))))
(check-sat)
(exit)
