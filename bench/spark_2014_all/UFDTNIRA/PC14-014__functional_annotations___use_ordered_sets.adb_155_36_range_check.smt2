...
(assert (and (= o5 (* 2 i)) (in_range7 (* 2 i))))
(assert (= o6 (- o5 1)))
(assert (and (= o7 o6) (in_range7 o6)))
(assert (and (= o8 o7) (in_range3 o7)))
(assert (and (= o4 (elements (mk___rep s__split_discrs s__split_fields1))) (and (and (and (= (length1 o4) (length (mk___rep s__split_discrs s__split_fields1))) (forall ((temp___432 Int)) (=> (and (in_range3 temp___432) (= (iter_has_element o4 temp___432) true)) (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) (get o4 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) item) true)) (and (< 0 (find o4 item)) (= (equivalent_elements (get o4 (find o4 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields1)))) (and (= (find o4 (get o4 i1)) i1) (= (e_is_find o4 (get o4 i1) i1) true)))))))
(assert (and (= o10 (get o4 o8)) (in_range2 o10)))
(assert (= o11 (ite (= o10 o9) true false)))
(assert (and (= o1 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)) (in_range2 o1)))
(assert (= o2 (+ o1 1)))
(assert (and (= o3 o2) (in_range8 o2)))
(assert (and (= o (* 2 i)) (in_range7 (* 2 i))))
