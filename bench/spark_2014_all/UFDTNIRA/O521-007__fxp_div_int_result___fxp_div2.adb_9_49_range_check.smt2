...
(assert (forall ((i tduration_repB)) (and (<= (- 9223372036854775808) (tduration_repBqtint i)) (<= (tduration_repBqtint i) 9223372036854775807))))
(define-fun in_range1 ((x Int)) Bool (and (<= (- 9223372036854775808) x) (<= x 9223372036854775807)))
(declare-fun attr__ATTRIBUTE_IMAGE1 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check1 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE1 (us_image) Int)
(declare-fun user_eq1 (tduration_repB tduration_repB) Bool)
(declare-const dummy1 tduration_repB)
...
(assert (forall ((i duration_rep)) (and (<= (- 9223372036854775808) (duration_repqtint i)) (<= (duration_repqtint i) 9223372036854775807))))
(define-fun in_range2 ((x Int)) Bool (and (<= (- 9223372036854775808) x) (<= x 9223372036854775807)))
(declare-fun attr__ATTRIBUTE_IMAGE2 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Int)
(declare-fun user_eq2 (duration_rep duration_rep) Bool)
(declare-const dummy2 duration_rep)
...
(define-fun dynamic_invariant ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range2 temp___expr_200)))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const y Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const z Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const x duration)
...
(assert (= result x))
(assert (= x1 o))
(assert (and (= o1 (fxp_div_result_int (to_fixed x1) (to_fixed x1))) (in_range1 (fxp_div_result_int (to_fixed x1) (to_fixed x1)))))
(assert (and (= fxp_div2__y__assume o1) (in_range2 o1)))
(assert (= fxp_div2__y__assume y))
(assert (in_range2 y))
(assert (and (= o2 (fxp_div_result_int (to_fixed x1) 2)) (in_range1 (fxp_div_result_int (to_fixed x1) 2))))
