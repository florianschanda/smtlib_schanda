...
(assert (= n1 0))
(assert (in_range1 n1))
(assert (and (= result2 (has_key (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 cu__split_fields2))) (= (= result2 true) (= (has_key (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 cu__split_fields2)) true))))
(assert (= result2 true))
(assert (not (= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (+ (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) n1))))
(check-sat)
(exit)
