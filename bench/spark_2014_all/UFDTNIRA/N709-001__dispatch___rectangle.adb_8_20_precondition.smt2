...
(define-fun rec____split_fields18 () us_split_fields2 (mk___split_fields1 rec____split_fields12 rec____split_fields13 rec____split_fields14 rec____split_fields15 rec____split_fields16 rec____split_fields17))
...
(assert (=> (= result true) (= rec____split_fields18 (us_split_fields3 (of_base (mk___rep object__set_area__obj__fields4 rec____attr__tag))))))
...
(assert (=> (not (= result true)) (= rec____split_fields18 (mk___split_fields1 rec____split_fields6 rec____split_fields7 rec____split_fields8 rec____split_fields9 rec____split_fields10 rec____split_fields11))))
(assert (not (= (has_stored_area (mk___rep (mk___split_fields rec____split_fields14 rec____split_fields15 rec____split_fields16 (hide_ext__ rec____split_fields12 rec____split_fields13 rec____split_fields17)) rec____attr__tag)) true)))
(check-sat)
(exit)
