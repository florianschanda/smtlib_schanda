...
(assert (and (= temp___7241 (next s (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq3 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields4)) (length s)) true) true) (= (bool_eq3 temp___7241 no_element) true) (and (= (has_key (positions s) temp___7241) true) (= (get1 (positions s) temp___7241) (+ (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))))))
