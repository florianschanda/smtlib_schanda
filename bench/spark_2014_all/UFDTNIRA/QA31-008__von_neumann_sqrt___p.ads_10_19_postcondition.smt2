...
(define-fun middle10 () int__ref (mk_int__ref middle6))
(define-fun upper11 () int__ref (mk_int__ref upper7))
(define-fun lower11 () int__ref (mk_int__ref lower7))
(define-fun middle11 () int__ref (mk_int__ref middle4))
...
(assert (= upper1 46341))
(assert (= temp___261 upper1))
(assert (= temp___260 lower1))
(assert (= temp___259 middle))
...
(assert (= (+ lower2 1) upper2))
(assert (= middle11 (mk_int__ref middle2)))
...
(assert (= result2 (mk_int__ref p__sqrt_binary__result)))
(assert (= p__sqrt_binary__result1 lower7))
(assert (= p__sqrt_binary__result4 p__sqrt_binary__result2))
(assert (= middle8 middle10))
...
(assert (= result3 (int__content p__sqrt_binary__result4)))
(assert (not (< x (* (+ (int__content p__sqrt_binary__result4) 1) (+ (int__content p__sqrt_binary__result4) 1)))))
(check-sat)
(exit)
