...
(assert (= n1 0))
(assert (in_range1 n1))
(assert (and (= result2 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields3))) (= (= result2 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields3)) true))))
(assert (= result2 true))
...
(assert (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (+ (* 2 n2) 1)))
(assert (=> (<= 0 2147483647) (in_range1 n2)))
(assert (not (in_range6 (+ n2 1))))
(check-sat)
(exit)
