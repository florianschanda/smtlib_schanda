...
(assert (forall ((j1 Int)) (=> (and (<= first4 j1) (<= j1 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))) (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) j1) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) j1)))))
(assert (forall ((j1 Int)) (=> (and (<= first4 j1) (<= j1 (- i2 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) (+ j1 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) j1)))))
...
(assert (and (= us1 j) (dynamic_property2 first1 last3 j)))
(assert (= o2 j))
(assert (and (= o3 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) o2)) (in_range3 o3)))
(assert (and (= us j) (dynamic_property3 first2 last4 j)))
(assert (= o1 j))
(assert (not (<= first2 o1)))
(check-sat)
(exit)
