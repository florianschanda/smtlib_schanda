...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (= temp___201 i1)))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (= temp___200 p11)))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (= p12 (factorial (- i2 1)))))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (and (and (=> (<= 0 2147483647) (in_range2 p12)) (=> (<= 2 n1) (dynamic_property 2 n1 i2))) (and (<= 2 i2) (<= i2 n1)))))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (and (= o (* i2 p12)) (in_range1 (* i2 p12)))))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (and (= o1 o) (in_range2 o))))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (= p12 result2)))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (= p13 o1)))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (= i2 n1)))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (= i2 i3)))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (= p13 p14)))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (= i4 i2)))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (= p15 p13)))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (= (mk_int__ref i5) (mk_int__ref i3))))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (= (mk_int__ref p16) (mk_int__ref p14))))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (= i6 i4)))
(assert (=> (and (<= 2 i1) (<= i1 n1)) (= p17 p15)))
(assert (=> (not (and (<= 2 i1) (<= i1 n1))) (= i1 i5)))
(assert (=> (not (and (<= 2 i1) (<= i1 n1))) (= p11 p16)))
(assert (=> (not (and (<= 2 i1) (<= i1 n1))) (= i6 i1)))
(assert (=> (not (and (<= 2 i1) (<= i1 n1))) (= p17 p11)))
