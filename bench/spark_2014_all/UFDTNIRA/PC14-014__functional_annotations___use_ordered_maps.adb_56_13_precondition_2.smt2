...
(assert (let ((temp___733 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___732 Int)) (=> (and (in_range4 temp___732) (= (iter_has_element temp___733 temp___732) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___733 temp___732) (get (keys s) i))))))))
(assert (and (= temp___729 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (= (length2 temp___729) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___439 Int)) (=> (and (in_range4 temp___439) (= (iter_has_element temp___729 temp___439) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___729 temp___439)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key1) true)) (and (< 0 (find temp___729 key1)) (= (equivalent_keys (get temp___729 (find temp___729 key1)) key1) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields2)))) (and (= (find temp___729 (get temp___729 i)) i) (= (k_is_find temp___729 (get temp___729 i) i) true)))))))
(assert (and (= o (iter_has_element temp___729 temp___728)) (= (= o true) (and (<= 1 temp___728) (<= temp___728 (last temp___729))))))
(assert (= (= o1 true) (in_range4 temp___728)))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (not (<= temp___728 (last temp___729))))
(check-sat)
(exit)
