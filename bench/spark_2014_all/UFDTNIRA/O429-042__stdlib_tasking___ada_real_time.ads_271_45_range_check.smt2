...
(assert (in_range2 sc))
(assert (and (= o14 (* 3 9223372036)) (in_range3 (* 3 9223372036))))
(assert (= o15 (ite (<= sc o14) true false)))
(assert (and (= o13 (* 3 (- 9223372036))) (in_range3 (* 3 (- 9223372036)))))
(assert (= o16 (ite (<= o13 sc) true false)))
(assert (= result (ite (= o16 true) o15 false)))
(assert (= result true))
(assert (and (= o9 (+ 9223372036 1)) (in_range3 (+ 9223372036 1))))
(assert (and (= o10 (result_sc sc ts)) (and (in_range2 o10) (= o10 (+ sc (ts_sc ts))))))
(assert (= o11 (ite (<= o10 o9) true false)))
(assert (and (= o7 (result_sc sc ts)) (and (in_range2 o7) (= o7 (+ sc (ts_sc ts))))))
(assert (and (= o8 (- (- 9223372036) 1)) (in_range3 (- (- 9223372036) 1))))
...
(assert (= result2 true))
(assert (and (= o5 (ts_fraction ts)) (= o5 (of_fixed (- (to_fixed (to_duration__2 ts)) (to_fixed (of_fixed (of_int (ts_sc ts)))))))))
