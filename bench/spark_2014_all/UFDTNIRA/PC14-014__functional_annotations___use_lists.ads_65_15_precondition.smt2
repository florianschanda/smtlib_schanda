...
(define-fun dynamic_invariant4 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_221)))
...
(declare-const temp___570 count_type)
(declare-const temp___571 Int)
(declare-const temp___573 us_rep1)
(declare-const temp___575 us_rep1)
(declare-const temp___572 us_rep1)
(declare-const temp___569 count_type)
(declare-const temp___5691 us_main_type)
...
(define-fun cu__split_fields10 () us_split_fields2 (mk___split_fields1 cu__split_fields3))
(define-fun l__split_fields10 () us_split_fields (mk___split_fields l__split_fields3))
(define-fun cu__split_fields11 () us_split_fields2 (mk___split_fields1 cu__split_fields2))
(define-fun l__split_fields11 () us_split_fields (mk___split_fields l__split_fields2))
(define-fun cu__split_fields12 () us_split_fields2 (mk___split_fields1 cu__split_fields1))
(define-fun use_lists__double_size_2__cu__assume1 () us_rep2 (mk___rep1 (mk___split_fields1 use_lists__double_size_2__cu__assume)))
...
(assert (and (= use_lists__double_size_2__cu__assume1 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq2 use_lists__double_size_2__cu__assume1 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) use_lists__double_size_2__cu__assume1) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) use_lists__double_size_2__cu__assume1) 1)))))
...
(assert (= n1 0))
(assert (in_range1 n1))
(assert (and (= result2 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields12))) (= (= result2 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields12)) true))))
(assert (=> (= result2 true) (= temp___570 cu__split_fields1)))
(assert (=> (= result2 true) (= temp___571 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result2 true) (= temp___573 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result2 true) (= temp___575 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result2 true) (= temp___572 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result2 true) (and (= l__split_discrs (mk___split_discrs temp___569)) (= l__split_fields temp___5691))))
(assert (=> (= result2 true) (= temp___568 n1)))
(assert (=> (= result2 true) (= temp___574 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result2 true) (= (length (mk___rep l__split_discrs l__split_fields11)) (+ temp___571 n2))))
(assert (=> (= result2 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 n2)) (and (= (get (model__ (mk___rep l__split_discrs l__split_fields11)) (* 2 i1)) (get temp___572 i1)) (= (get (model__ (mk___rep l__split_discrs l__split_fields11)) (- (* 2 i1) 1)) (get temp___573 i1)))))))
(assert (=> (= result2 true) (forall ((i1 Int)) (=> (and (<= (+ n2 1) i1) (<= i1 temp___574)) (= (get (model__ (mk___rep l__split_discrs l__split_fields11)) (+ i1 n2)) (get temp___575 i1))))))
(assert (=> (= result2 true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) (+ (* 2 n2) 1))))
(assert (=> (= result2 true) (=> (<= 0 2147483647) (in_range1 n2))))
(assert (=> (= result2 true) (and (= o (element (mk___rep l__split_discrs l__split_fields11) (mk___rep1 cu__split_fields11))) (and (in_range5 o) (= o (get (model__ (mk___rep l__split_discrs l__split_fields11)) (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11))))))))
(assert (=> (= result2 true) (and (= (length (mk___rep l__split_discrs l__split_fields10)) (+ (length (mk___rep l__split_discrs l__split_fields11)) 1)) (ite (= (bool_eq2 (mk___rep1 cu__split_fields11) no_element) true) (and (and (and (and (= (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (last1 (mk___rep l__split_discrs l__split_fields10))) (length (mk___rep l__split_discrs l__split_fields10))) (= (keys_included_except (positions (mk___rep l__split_discrs l__split_fields10)) (positions (mk___rep l__split_discrs l__split_fields11)) (last1 (mk___rep l__split_discrs l__split_fields10))) true)) (= (ole1 (positions (mk___rep l__split_discrs l__split_fields11)) (positions (mk___rep l__split_discrs l__split_fields10))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) (length (mk___rep l__split_discrs l__split_fields10))) o)) (= (ole (model__ (mk___rep l__split_discrs l__split_fields11)) (model__ (mk___rep l__split_discrs l__split_fields10))) true)) (and (and (and (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields11)) (model__ (mk___rep l__split_discrs l__split_fields10)) 1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) 1)) true) (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields11)) (model__ (mk___rep l__split_discrs l__split_fields10)) (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) (length (mk___rep l__split_discrs l__split_fields11)) 1) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11))) o)) (= (p_positions_shifted (positions (mk___rep l__split_discrs l__split_fields11)) (positions (mk___rep l__split_discrs l__split_fields10)) (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) 1) true))))))
(assert (=> (= result2 true) (ite (= (ite (= (bool_eq2 (mk___rep1 cu__split_fields11) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields11)) (length (mk___rep l__split_discrs l__split_fields10))) true) true) (= (bool_eq2 (mk___rep1 cu__split_fields10) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields11)) 1))))))
(assert (=> (= result2 true) (and (= o1 (+ n2 1)) (in_range6 (+ n2 1)))))
(assert (=> (= result2 true) (= result3 (mk_int__ref n2))))
(assert (=> (= result2 true) (= n3 o1)))
(assert (=> (= result2 true) (and (= o2 (has_key (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10))) (= (= o2 true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10)) true)))))
(assert (=> (= result2 true) (= result4 (ite (not (= o2 true)) true false))))
(assert (=> (= result2 true) (= result4 true)))
(assert (=> (= result2 true) (= n4 (mk_int__ref n3))))
(assert (=> (= result2 true) (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields10))))
(assert (=> (= result2 true) (= l__split_fields4 (mk___split_fields__ref l__split_fields10))))
(assert (=> (= result2 true) (= n5 n3)))
(assert (=> (= result2 true) (= cu__split_fields5 cu__split_fields10)))
(assert (=> (= result2 true) (= l__split_fields5 l__split_fields10)))
(assert (=> (= result2 true) (= n6 n4)))
(assert (=> (= result2 true) (= cu__split_fields6 cu__split_fields4)))
(assert (=> (= result2 true) (= l__split_fields6 l__split_fields4)))
(assert (=> (= result2 true) (= n7 n5)))
(assert (=> (= result2 true) (= cu__split_fields7 cu__split_fields5)))
(assert (=> (= result2 true) (= l__split_fields7 l__split_fields5)))
(assert (=> (not (= result2 true)) (= n6 (mk_int__ref n1))))
(assert (=> (not (= result2 true)) (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields12))))
(assert (=> (not (= result2 true)) (= l__split_fields6 (mk___split_fields__ref (mk___split_fields l__split_fields)))))
(assert (=> (not (= result2 true)) (= n7 n1)))
(assert (=> (not (= result2 true)) (= cu__split_fields7 cu__split_fields12)))
(assert (=> (not (= result2 true)) (= l__split_fields7 (mk___split_fields l__split_fields1))))
(assert (= n8 n6))
...
(assert (<= 1 i))
(assert (<= i (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
(assert (and (= o12 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (in_range2 o12)))
(assert (and (= o10 (* 2 i)) (in_range6 (* 2 i))))
(assert (and (= o11 o10) (in_range3 o10)))
(assert (and (= o9 (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (= (length1 o9) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))))
(assert (and (= o13 (get o9 o11)) (in_range2 o13)))
(assert (= o14 (ite (= o13 o12) true false)))
(assert (and (= o8 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (in_range2 o8)))
(assert (and (= o4 (* 2 i)) (in_range6 (* 2 i))))
(assert (= o5 (- o4 1)))
(assert (and (= o6 o5) (in_range6 o5)))
(assert (and (= o7 o6) (in_range3 o6)))
(assert (and (= o3 (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (= (length1 o3) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))))
(assert (not (<= o7 (last o3))))
(check-sat)
(exit)
