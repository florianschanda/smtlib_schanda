...
(assert (not (= (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) (* 2 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
(check-sat)
(exit)
