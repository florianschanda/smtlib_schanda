...
(assert (and (= o (* (+ (int__content p__sqrt_binary__result4) 1) (+ (int__content p__sqrt_binary__result4) 1))) (in_range1 (* (+ (int__content p__sqrt_binary__result4) 1) (+ (int__content p__sqrt_binary__result4) 1)))))
(assert (= o1 (ite (< x o) true false)))
(assert (not (in_range1 (* (int__content p__sqrt_binary__result4) (int__content p__sqrt_binary__result4)))))
(check-sat)
(exit)
