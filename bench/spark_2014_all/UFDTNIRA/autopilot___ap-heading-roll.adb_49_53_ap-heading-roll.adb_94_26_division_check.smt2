...
(define-fun dynamic_invariant1 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= (- 45) 45)) (in_range2 temp___expr_214)))
...
(define-fun in_range4 ((x Int)) Bool (and (<= 0 x) (<= x 359)))
(declare-fun attr__ATTRIBUTE_IMAGE4 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Int)
(declare-fun user_eq3 (headdegree headdegree) Bool)
(declare-const dummy3 headdegree)
...
(define-fun dynamic_invariant3 ((temp___expr_172 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 0 359)) (in_range4 temp___expr_172)))
(assert (forall ((present Int) (target Int)) (! (=> (and (dynamic_invariant3 present true true true true) (dynamic_invariant3 target true true true true)) (dynamic_invariant3 (heading_offset present target) true false true true)) :pattern ((heading_offset present target)))))
...
(define-fun dynamic_invariant4 ((temp___expr_207 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= (- 180) 180)) (in_range5 temp___expr_207)))
(declare-sort bankangle 0)
(declare-fun bankangleqtint (bankangle) Int)
(assert (forall ((i bankangle)) (and (<= (- 45) (bankangleqtint i)) (<= (bankangleqtint i) 45))))
...
(define-fun dynamic_invariant5 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= (- 45) 45)) (in_range6 temp___expr_165)))
...
(assert (in_range4 present_heading))
(assert (in_range4 target_heading))
(assert (in_range6 bank))
(assert (=> (<= (- 180) 180) (in_range7 present_rollrate)))
(assert (=> (<= (- 180) 180) (in_range7 target_rollrate)))
(assert (=> (<= (- 45) 45) (in_range2 aileron_movement)))
(assert (in_range5 ap__heading__roll__rate__calc_rollrate__present_rollrate))
...
(assert (in_range4 c11b))
(assert (= target_heading c12b))
(assert (in_range4 c12b))
(assert (= bank c13b))
(assert (in_range6 c13b))
(assert (=> (<= (- 45) 45) (in_range6 target_bank)))
(assert (=> (<= (- 180) 180) (in_range7 result__)))
(assert (= c11b c16b))
(assert (in_range4 c16b))
(assert (= c12b c17b))
(assert (in_range4 c17b))
(assert (=> (<= (- 45) 45) (in_range6 result__1)))
(assert (=> (<= 0 359) (in_range4 offset)))
(assert (and (= o (heading_offset c16b c17b)) (in_range4 o)))
...
(assert (=> (not (and (< 40 offset1) (<= offset1 180))) (=> (not (and (< 180 offset1) (< offset1 320))) (=> (<= offset1 40) (and (= o1 offset1) (in_range6 offset1))))))
...
(assert (=> (not (and (< 40 offset1) (<= offset1 180))) (=> (not (and (< 180 offset1) (< offset1 320))) (=> (not (<= offset1 40)) (and (= o2 (- 360 offset1)) (in_range6 (- 360 offset1)))))))
