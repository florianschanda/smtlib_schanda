...
(declare-const temp___1981 integer)
(declare-const o3 integer)
(declare-const o4 integer)
(declare-const o5 integer)
(declare-const o6 integer)
(declare-const temp___199 integer)
...
(declare-const temp___200 integer)
(declare-const temp___2001 integer)
...
(declare-const temp___2021 integer)
...
(define-fun r__split_fields10 () us_split_fields (mk___split_fields r__split_fields2 r__split_fields3))
(define-fun r__split_fields11 () us_split_fields__ref (mk___split_fields__ref (mk___split_fields r__split_fields r__split_fields1)))
(assert (in_range one))
(assert (in_range b))
(assert (= one 1))
...
(assert (=> (= b 1) (= temp___198 o1)))
(assert (=> (= b 1) (= temp___1981 o2)))
(assert (=> (= b 1) (= (mk___split_fields__ref (mk___split_fields result result1)) r__split_fields11)))
(assert (=> (= b 1) (= temp___198 r__split_fields2)))
(assert (=> (= b 1) (= temp___1981 r__split_fields3)))
(assert (=> (not (= b 1)) (=> (= b 2) (= (to_rep o3) one))))
(assert (=> (not (= b 1)) (=> (= b 2) (= (to_rep o4) one))))
(assert (=> (not (= b 1)) (=> (= b 2) (= o4 o5))))
(assert (=> (not (= b 1)) (=> (= b 2) (= o3 o6))))
(assert (=> (not (= b 1)) (=> (= b 2) (= temp___199 o5))))
(assert (=> (not (= b 1)) (=> (= b 2) (= temp___1991 o6))))
(assert (=> (not (= b 1)) (=> (= b 2) (= result2 r__split_fields11))))
(assert (=> (not (= b 1)) (=> (= b 2) (= r__split_fields4 (mk___split_fields temp___199 temp___1991)))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= (to_rep o7) one)))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= (to_rep o8) one)))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= o8 o9)))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= o7 o10)))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= temp___200 o9)))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= temp___2001 o10)))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= result3 r__split_fields11)))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= r__split_fields5 (mk___split_fields temp___200 temp___2001))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= (to_rep o11) one))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= rliteral o12))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= o11 o13))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= temp___201 o12))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= temp___2011 o13))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= result4 r__split_fields11))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= r__split_fields6 (mk___split_fields temp___201 temp___2011)))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= (to_rep o14) one))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= o14 o15))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= rliteral o16))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= temp___202 o15))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= temp___2021 o16))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= result5 r__split_fields11))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= r__split_fields7 (mk___split_fields temp___202 temp___2021)))))))
