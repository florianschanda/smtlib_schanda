...
(assert (forall ((i pos)) (and (<= 1 (posqtint i)) (<= (posqtint i) 2147483647))))
...
(define-fun dynamic_invariant1 ((temp___expr_172 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 1 2147483647)) (in_range1 temp___expr_172)))
...
(assert (not (= (mod2 (* arg1 arg2) arg2) 0)))
(check-sat)
(exit)
