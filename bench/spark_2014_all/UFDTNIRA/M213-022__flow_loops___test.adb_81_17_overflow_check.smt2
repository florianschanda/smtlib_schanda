...
(assert (= result3 y))
(assert (= y1 1))
(assert (=> (not (= d1 1)) (= temp___189 x1)))
(assert (=> (not (= d1 1)) (= temp___188 w)))
(assert (=> (not (= d1 1)) (= temp___187 q)))
(assert (=> (not (= d1 1)) (= temp___186 d1)))
(assert (=> (not (= d1 1)) (= temp___185 c1)))
(assert (=> (not (= d1 1)) (= temp___184 y1)))
