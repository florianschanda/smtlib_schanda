...
(assert (= j3 1))
(assert (<= j3 i2))
(assert (= (* 2 innersum4) (* j4 (- j4 1))))
(assert (and (and (=> (<= 0 2147483647) (in_range2 innersum4)) (=> (<= 1 2147483647) (in_range3 j4))) (<= j4 i2)))
(assert (and (= o (+ innersum4 j4)) (in_range1 (+ innersum4 j4))))
(assert (= innersum4 result6))
(assert (= innersum5 o))
