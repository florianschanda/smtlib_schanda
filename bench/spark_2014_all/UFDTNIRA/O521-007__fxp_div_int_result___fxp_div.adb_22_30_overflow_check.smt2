...
(define-fun dynamic_invariant1 ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range3 temp___expr_200)))
(declare-const temp___203 duration)
(assert (= (to_fixed temp___203) 0))
(assert (= temp___203 time_span_zero))
(assert (in_range right))
(assert (< 0 right))
(assert (< (to_fixed time_span_zero) (to_fixed left)))
(assert (not (in_range2 (fxp_div_result_int (to_fixed left) 1))))
(check-sat)
(exit)
