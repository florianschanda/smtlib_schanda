...
(assert (forall ((g Int)) (=> (and (in_range2 g) (= (contains (model__ (mk___rep r__split_discrs r__split_fields2)) g) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= g (f (get (elements s) i1))))))))
(assert (and (= o (positions s)) (and (not (= (has_key o no_element) true)) (forall ((i1 us_rep3)) (=> (= (has_key o i1) true) (and (and (<= 1 (get1 o i1)) (<= (get1 o i1) (length s))) (forall ((j us_rep3)) (=> (= (has_key o j) true) (=> (= (get1 o i1) (get1 o j)) (= (bool_eq3 i1 j) true))))))))))
(assert (and (= o1 (get1 o (mk___rep1 cu__split_fields3))) (and (in_range5 o1) (=> (= (distinct 0 0) true) (and (= o1 (w_get o (witness o (mk___rep1 cu__split_fields3)))) (forall ((k us_rep3)) (=> (= (has_key o k) true) (= (= (bool_eq3 k (mk___rep1 cu__split_fields3)) true) (= (witness o (mk___rep1 cu__split_fields3)) (witness o k))))))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result2 (ite (<= 1 i) o3 false)))
(assert (= result2 true))
(assert (and (= o4 (elements s)) (and (and (and (= (length1 o4) (length s)) (forall ((temp___432 Int)) (=> (and (in_range4 temp___432) (= (iter_has_element o4 temp___432) true)) (= (contains (model__ s) (get o4 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ s) item) true)) (and (< 0 (find o4 item)) (= (equivalent_elements (get o4 (find o4 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o4 (get o4 i1)) i1) (= (e_is_find o4 (get o4 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
