...
(define-fun in_range ((x Int)) Bool (and (<= (- 2147483648) x) (<= x 2146435072)))
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int1 x) 0) (ite (< 0 x) (pos_div_relation (to_int1 x) (* x 1) 1048576) (pos_div_relation (- (to_int1 x)) (* (- x) 1) 1048576))) :pattern ((to_int1 x)))))
(declare-fun of_int (Int) Int)
(assert (forall ((x Int)) (! (ite (= x 0) (= (of_int x) 0) (ite (< 0 x) (pos_div_relation (of_int x) (* x 1048576) 1) (pos_div_relation (- (of_int x)) (* (- x) 1048576) 1))) :pattern ((of_int x)))))
(assert (forall ((x fixed)) (! (= (of_fixed (to_fixed x)) x) :pattern ((to_fixed x)))))
(assert (forall ((x fixed)) (in_range (to_fixed x))))
...
(declare-fun to_fixed1 (tfixedB) Int)
(declare-fun of_fixed1 (Int) tfixedB)
...
(assert (forall ((x tfixedB)) (! (= (of_fixed1 (to_fixed1 x)) x) :pattern ((to_fixed1 x)))))
(assert (forall ((x tfixedB)) (in_range1 (to_fixed1 x))))
...
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (or (= x 0) (= y 0)) (= (fxp_mult x y) 0) (ite (or (and (< 0 x) (< 0 y)) (and (< x 0) (< y 0))) (pos_div_relation (fxp_mult x y) (* (* (* (* x y) 1) 1) 1048576) (* (* 1048576 1048576) 1)) (pos_div_relation (- (fxp_mult x y)) (- (* (* (* (* x y) 1) 1) 1048576)) (* (* 1048576 1048576) 1)))) :pattern ((fxp_mult x y))))))
(declare-fun fxp_div (Int Int) Int)
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (= x 0) (= (fxp_div x y) 0) (ite (and (< 0 x) (< 0 y)) (pos_div_relation (fxp_div x y) (* (* (* x 1) 1048576) 1048576) (* (* (* y 1048576) 1) 1)) (ite (and (< x 0) (< y 0)) (pos_div_relation (fxp_div x y) (* (* (* (- x) 1) 1048576) 1048576) (* (* (* (- y) 1048576) 1) 1)) (ite (and (< x 0) (< 0 y)) (pos_div_relation (- (fxp_div x y)) (* (* (* (- x) 1) 1048576) 1048576) (* (* (* y 1048576) 1) 1)) (=> (and (< 0 x) (< y 0)) (pos_div_relation (- (fxp_div x y)) (* (* (* x 1) 1048576) 1048576) (* (* (* (- y) 1048576) 1) 1))))))) :pattern ((fxp_div x y))))))
...
(declare-const a10 fixed)
(declare-const num fixed)
(declare-const den fixed__ref)
(declare-const res fixed__ref)
...
(declare-const o18 fixed)
(declare-const o19 fixed)
(declare-const o20 fixed)
...
(declare-const result19 fixed__ref)
(declare-const a101 fixed)
(declare-const result20 fixed__ref)
(declare-const num1 fixed)
(declare-const result21 fixed__ref)
(declare-const den1 fixed)
(declare-const result22 fixed__ref)
(declare-const res1 fixed)
(assert (= (to_fixed o) 1048576))
(assert (= result (mk_fixed__ref t1)))
(assert (= t11 o))
(assert (= (to_fixed o1) 349525))
(assert (= result1 (mk_fixed__ref t2)))
(assert (= t21 o1))
(assert (= (to_fixed o2) 209715))
(assert (= result2 (mk_fixed__ref t3)))
(assert (= t31 o2))
(assert (= (to_fixed o3) 149796))
(assert (= result3 (mk_fixed__ref t4)))
(assert (= t41 o3))
(assert (= (to_fixed o4) 116508))
(assert (= result4 (mk_fixed__ref t5)))
(assert (= t51 o4))
(assert (= (to_fixed o5) 95325))
(assert (= result5 (mk_fixed__ref t6)))
(assert (= t61 o5))
(assert (= (to_fixed o6) 80659))
(assert (= result6 (mk_fixed__ref t7)))
(assert (= t71 o6))
(assert (= (to_fixed o7) 69905))
(assert (= result7 (mk_fixed__ref t8)))
(assert (= t81 o7))
(assert (= (to_fixed o8) 61680))
(assert (= result8 (mk_fixed__ref t9)))
(assert (= t91 o8))
(assert (= (to_fixed o9) 55188))
(assert (= result9 (mk_fixed__ref t10)))
(assert (= t101 o9))
(assert (= result10 (mk_fixed__ref a1)))
(assert (= a11 t11))
(assert (= (to_fixed o10) (- (to_fixed a11) (to_fixed t21))))
(assert (= result11 (mk_fixed__ref a2)))
(assert (= a21 o10))
(assert (= (to_fixed o11) (+ (to_fixed a21) (to_fixed t31))))
(assert (= result12 (mk_fixed__ref a3)))
(assert (= a31 o11))
(assert (= (to_fixed o12) (- (to_fixed a31) (to_fixed t41))))
(assert (= result13 (mk_fixed__ref a4)))
(assert (= a41 o12))
(assert (= (to_fixed o13) (+ (to_fixed a41) (to_fixed t51))))
(assert (= result14 (mk_fixed__ref a5)))
(assert (= a51 o13))
(assert (= (to_fixed o14) (- (to_fixed a51) (to_fixed t61))))
(assert (= result15 (mk_fixed__ref a6)))
(assert (= a61 o14))
(assert (= (to_fixed o15) (+ (to_fixed a61) (to_fixed t71))))
(assert (= result16 (mk_fixed__ref a7)))
(assert (= a71 o15))
(assert (= (to_fixed o16) (- (to_fixed a71) (to_fixed t81))))
(assert (= result17 (mk_fixed__ref a8)))
(assert (= a81 o16))
(assert (= (to_fixed o17) (+ (to_fixed a81) (to_fixed t91))))
(assert (= result18 (mk_fixed__ref a9)))
(assert (= a91 o17))
(assert (= (to_fixed o18) (- (to_fixed a91) (to_fixed t101))))
(assert (= result19 (mk_fixed__ref a10)))
(assert (= a101 o18))
(assert (= (to_fixed o19) (* (- (fxp_mult (to_fixed a101) (to_fixed a81)) (fxp_mult (to_fixed a91) (to_fixed a91))) 4)))
(assert (= result20 (mk_fixed__ref num)))
(assert (= num1 o19))
(assert (= (to_fixed o20) (+ (- (to_fixed a101) (* (to_fixed a91) 2)) (to_fixed a81))))
(assert (= result21 den))
(assert (= (let ((subject den)) den1) o20))
(assert (= (to_fixed o21) (fxp_div (to_fixed num1) (to_fixed (let ((subject den)) den1)))))
(assert (= result22 res))
(assert (= (let ((subject res)) res1) o21))
(assert (not (= (to_fixed (let ((subject res)) res1)) 3293842)))
(check-sat)
(exit)
