...
(assert (= m__split_fields1 (us_split_fields1 my_ordered_sets__test_set_pos__B_1__m__assume)))
...
(assert (and (and (= (oeq2 (model__ (mk___rep m__split_discrs m__split_fields2)) (model__ (mk___rep k__split_discrs k__split_fields3))) true) (= (oeq1 (elements (mk___rep m__split_discrs m__split_fields2)) (elements (mk___rep k__split_discrs k__split_fields3))) true)) (= (length (mk___rep m__split_discrs m__split_fields2)) (length (mk___rep k__split_discrs k__split_fields3)))))
(assert (= (oeq (intersection__2 (mk___rep m__split_discrs m__split_fields2) (mk___rep l__split_discrs l__split_fields11)) (intersection__2 (mk___rep k__split_discrs k__split_fields3) (mk___rep l__split_discrs l__split_fields11))) true))
(assert (and (and (and (and (and (and (= (length (mk___rep m__split_discrs m__split_fields3)) (num_overlaps (model__ (mk___rep m__split_discrs m__split_fields2)) (model__ (mk___rep l__split_discrs l__split_fields11)))) (= (ole (model__ (mk___rep m__split_discrs m__split_fields3)) (model__ (mk___rep m__split_discrs m__split_fields2))) true)) (= (ole (model__ (mk___rep m__split_discrs m__split_fields3)) (model__ (mk___rep l__split_discrs l__split_fields11))) true)) (= (includes_intersection (model__ (mk___rep m__split_discrs m__split_fields3)) (model__ (mk___rep l__split_discrs l__split_fields11)) (model__ (mk___rep m__split_discrs m__split_fields2))) true)) (= (e_elements_included (elements (mk___rep m__split_discrs m__split_fields3)) (elements (mk___rep m__split_discrs m__split_fields2))) true)) (= (e_elements_included__2 (elements (mk___rep m__split_discrs m__split_fields2)) (model__ (mk___rep l__split_discrs l__split_fields11)) (elements (mk___rep m__split_discrs m__split_fields3))) true)) (= (mapping_preserved (elements (mk___rep m__split_discrs m__split_fields3)) (elements (mk___rep m__split_discrs m__split_fields2)) (positions (mk___rep m__split_discrs m__split_fields3)) (positions (mk___rep m__split_discrs m__split_fields2))) true)))
(assert (not (<= (length (mk___rep k__split_discrs k__split_fields3)) (- 2147483647 (length (mk___rep l__split_discrs l__split_fields11))))))
(check-sat)
(exit)
