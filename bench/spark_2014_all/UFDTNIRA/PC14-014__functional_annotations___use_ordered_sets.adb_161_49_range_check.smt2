...
(assert (and (= o3 (length (mk___rep s__split_discrs s__split_fields1))) (and (in_range1 o3) (<= o3 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s__split_discrs))))))
(assert (= o4 (ite (<= i o3) true false)))
(assert (and (= o (* 2 n2)) (in_range7 (* 2 n2))))
(assert (= o1 (+ o 1)))
(assert (and (= o2 o1) (in_range7 o1)))
(assert (= o5 (ite (<= o2 i) true false)))
(assert (= result3 (ite (= o5 true) o4 false)))
(assert (= result3 true))
(assert (and (= o6 (- i n2)) (in_range7 (- i n2))))
