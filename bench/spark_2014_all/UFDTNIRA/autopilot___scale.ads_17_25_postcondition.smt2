...
(declare-const gap2 Int)
(declare-const k12 Int)
(declare-const k22 Int)
(declare-const result1 Int)
(declare-const target_angle2 Int)
(declare-const result2 Int)
(declare-const target_angle3 Int)
(declare-const result3 Int)
(declare-const scale__scale_movement__result1 Int)
(declare-const scale__scale_movement__result2 Int)
(declare-const scale__scale_movement__result3 Int)
(declare-const target_angle4 Int)
(declare-const k13 Int)
(declare-const k23 Int)
(declare-const gap3 Int)
(declare-const scale__scale_movement__result4 Int)
(declare-const target_angle5 Int)
(declare-const k14 Int)
(declare-const k24 Int)
(declare-const gap4 Int)
(declare-const scale__scale_movement__result5 Int)
...
(assert (=> (= present target) (= result target_angle)))
(assert (=> (= present target) (= target_angle1 0)))
(assert (=> (= present target) (= gap2 gap)))
(assert (=> (= present target) (= k22 k2)))
(assert (=> (= present target) (= k12 k1)))
(assert (=> (= present target) (= gap2 gap1)))
(assert (=> (= present target) (= k22 k21)))
(assert (=> (= present target) (= k12 k11)))
(assert (=> (not (= present target)) (and (and (in_range3 k12) (< 0 k22)) (<= k12 k22))))
(assert (=> (not (= present target)) (=> (<= (- 2147483648) 2147483647) (in_range1 k12))))
(assert (=> (not (= present target)) (=> (<= (- 2147483648) 2147483647) (in_range1 k22))))
(assert (=> (not (= present target)) (and (= o (* max k12)) (in_range1 (* max k12)))))
(assert (=> (not (= present target)) (= o1 (div1 o k22))))
(assert (=> (not (= present target)) (and (= o2 o1) (in_range1 o1))))
(assert (=> (not (= present target)) (and (= o3 o2) (in_range4 o2))))
(assert (=> (not (= present target)) (= result1 target_angle)))
(assert (=> (not (= present target)) (= target_angle2 o3)))
(assert (=> (not (= present target)) (=> (< target present) (= result2 target_angle2))))
(assert (=> (not (= present target)) (=> (< target present) (= target_angle3 (- target_angle2)))))
(assert (=> (not (= present target)) (=> (not (< target present)) (= target_angle3 target_angle2))))
(assert (=> (not (= present target)) (= target_angle1 target_angle3)))
(assert (= scale__scale_movement__result1 scale__scale_movement__result2))
(assert (= scale__scale_movement__result3 scale__scale_movement__result1))
(assert (= result3 scale__scale_movement__result))
(assert (= scale__scale_movement__result1 target_angle1))
(assert (= (mk_int__ref scale__scale_movement__result4) (mk_int__ref scale__scale_movement__result2)))
(assert (= gap3 gap2))
(assert (= k23 k22))
(assert (= k13 k12))
(assert (= target_angle4 target_angle1))
(assert (= scale__scale_movement__result5 scale__scale_movement__result3))
(assert (= gap4 gap2))
(assert (= k24 k22))
(assert (= k14 k12))
(assert (= target_angle5 target_angle1))
(assert (= result4 scale__scale_movement__result4))
(assert (not (<= scale__scale_movement__result4 max)))
(check-sat)
(exit)
