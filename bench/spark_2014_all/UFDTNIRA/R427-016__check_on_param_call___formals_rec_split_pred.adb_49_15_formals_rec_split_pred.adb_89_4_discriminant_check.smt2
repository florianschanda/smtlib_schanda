...
(declare-const formals_rec_split_pred__p__a__compl8 Bool)
(declare-const formals_rec_split_pred__p__a__compl9 integer)
(declare-const formals_rec_split_pred__p__a__compl10 integer)
(declare-const formals_rec_split_pred__p__a__compl11 natural)
(declare-const temp___249 us_rep)
(declare-const temp___252 us_rep)
(declare-const temp___255 us_rep)
...
(declare-const temp___260 us_rep)
(declare-const temp___263 us_rep)
...
(declare-const x__split_fields7 us_split_fields)
(declare-const formals_rec_split_pred__p__a__fields2 us_split_fields)
(declare-const result5 us_split_fields__ref)
(declare-const x__split_fields8 us_split_fields)
(declare-const y__split_fields4 us_split_fields)
(declare-const formals_rec_split_pred__p2__a__fields us_split_fields)
(declare-const result6 us_split_fields__ref)
(declare-const y__split_fields5 us_split_fields)
(declare-const y__split_fields6 us_split_fields)
(declare-const formals_rec_split_pred__p2__a__fields1 us_split_fields)
(declare-const result7 us_split_fields__ref)
(declare-const y__split_fields7 us_split_fields)
(declare-const u__split_fields4 us_split_fields)
(declare-const formals_rec_split_pred__p2__a__fields2 us_split_fields)
(declare-const result8 us_split_fields__ref)
(declare-const u__split_fields5 us_split_fields)
(declare-const y__split_fields8 us_split_fields)
(declare-const result9 us_split_fields__ref)
(declare-const y__split_fields9 us_split_fields)
(declare-const x__split_fields9 us_split_fields)
(declare-const result10 us_split_fields__ref)
(declare-const x__split_fields10 us_split_fields)
(declare-const u__split_fields6 us_split_fields)
(declare-const result11 us_split_fields__ref)
(declare-const u__split_fields7 us_split_fields)
(declare-const x__split_fields11 us_split_fields)
...
(assert (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h x__split_fields7)) 0)))
(assert (= x__split_discrs (mk___split_discrs formals_rec_split_pred__p__a__compl8)))
(assert (= x__split_fields7 (mk___split_fields formals_rec_split_pred__p__a__compl9 formals_rec_split_pred__p__a__compl10 formals_rec_split_pred__p__a__compl11)))
(assert (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h formals_rec_split_pred__p__a__fields2)) 0)))
(assert (= result5 (mk___split_fields__ref x__split_fields7)))
(assert (= x__split_fields8 formals_rec_split_pred__p__a__fields2))
(assert (= x__split_discrs (mk___split_discrs formals_rec_split_pred__p__a__compl8)))
(assert (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h y__split_fields4)) 0)))
(assert (= result6 (mk___split_fields__ref y__split_fields4)))
(assert (= y__split_fields5 formals_rec_split_pred__p2__a__fields))
(assert (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h y__split_fields5)) 0)))
(assert (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h y__split_fields6)) 0)))
(assert (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h formals_rec_split_pred__p2__a__fields1)) 0)))
(assert (= temp___249 (mk___rep y__split_discrs formals_rec_split_pred__p2__a__fields1)))
(assert (= result7 (mk___split_fields__ref y__split_fields6)))
(assert (= y__split_fields7 (us_split_fields1 temp___249)))
(assert (= y__split_discrs (us_split_discrs1 temp___249)))
(assert (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h u__split_fields4)) 0)))
(assert (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h formals_rec_split_pred__p2__a__fields2)) 0)))
(assert (= temp___252 (mk___rep u__split_discrs formals_rec_split_pred__p2__a__fields2)))
(assert (= result8 (mk___split_fields__ref u__split_fields4)))
(assert (= u__split_fields5 (us_split_fields1 temp___252)))
(assert (= u__split_discrs (us_split_discrs1 temp___252)))
(assert (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h y__split_fields8)) 0)))
(assert (=> (= (to_rep (rec__formals_rec_split_pred__rec__f y__split_fields8)) 0) (not (= (to_rep1 rliteral2) 0))))
(assert (=> (= (to_rep (rec__formals_rec_split_pred__rec__f y__split_fields8)) 0) (= temp___255 (mk___rep y__split_discrs (mk___split_fields (rec__formals_rec_split_pred__rec__f y__split_fields8) (rec__formals_rec_split_pred__rec__g y__split_fields8) rliteral2)))))
(assert (=> (= (to_rep (rec__formals_rec_split_pred__rec__f y__split_fields8)) 0) (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h (us_split_fields1 temp___255))) 0))))
(assert (=> (= (to_rep (rec__formals_rec_split_pred__rec__f y__split_fields8)) 0) (= temp___256 temp___255)))
(assert (=> (= (to_rep (rec__formals_rec_split_pred__rec__f y__split_fields8)) 0) (= result9 (mk___split_fields__ref y__split_fields8))))
(assert (=> (= (to_rep (rec__formals_rec_split_pred__rec__f y__split_fields8)) 0) (= y__split_fields9 (us_split_fields1 temp___256))))
(assert (=> (= (to_rep (rec__formals_rec_split_pred__rec__f y__split_fields8)) 0) (= y__split_discrs (us_split_discrs1 temp___256))))
(assert (=> (not (= (to_rep (rec__formals_rec_split_pred__rec__f y__split_fields8)) 0)) (= y__split_fields9 y__split_fields8)))
(assert (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h x__split_fields9)) 0)))
(assert (= o3 (mk___rep x__split_discrs x__split_fields9)))
(assert (= o4 (rec__formals_rec_split_pred__rec__h (us_split_fields1 o3))))
(assert (= o5 (to_rep1 o4)))
(assert (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h x__split_fields9)) 0)))
(assert (= o (mk___rep x__split_discrs x__split_fields9)))
(assert (= o1 (rec__formals_rec_split_pred__rec__g (us_split_fields1 o))))
(assert (= o2 (to_rep o1)))
(assert (= o6 (div1 o2 o5)))
(assert (= (to_rep o7) o6))
(assert (= o8 (mk___split_fields o7 (rec__formals_rec_split_pred__rec__g x__split_fields9) (rec__formals_rec_split_pred__rec__h x__split_fields9))))
(assert (= temp___260 (mk___rep x__split_discrs o8)))
(assert (= result10 (mk___split_fields__ref x__split_fields9)))
(assert (= x__split_fields10 (us_split_fields1 temp___260)))
(assert (= x__split_discrs (us_split_discrs1 temp___260)))
(assert (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h u__split_fields6)) 0)))
(assert (=> (= (to_rep (rec__formals_rec_split_pred__rec__f u__split_fields6)) 0) (not (= (to_rep1 rliteral2) 0))))
(assert (=> (= (to_rep (rec__formals_rec_split_pred__rec__f u__split_fields6)) 0) (= temp___263 (mk___rep u__split_discrs (mk___split_fields (rec__formals_rec_split_pred__rec__f u__split_fields6) (rec__formals_rec_split_pred__rec__g u__split_fields6) rliteral2)))))
(assert (=> (= (to_rep (rec__formals_rec_split_pred__rec__f u__split_fields6)) 0) (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h (us_split_fields1 temp___263))) 0))))
(assert (=> (= (to_rep (rec__formals_rec_split_pred__rec__f u__split_fields6)) 0) (= temp___264 temp___263)))
(assert (=> (= (to_rep (rec__formals_rec_split_pred__rec__f u__split_fields6)) 0) (= result11 (mk___split_fields__ref u__split_fields6))))
(assert (=> (= (to_rep (rec__formals_rec_split_pred__rec__f u__split_fields6)) 0) (= u__split_fields7 (us_split_fields1 temp___264))))
(assert (=> (= (to_rep (rec__formals_rec_split_pred__rec__f u__split_fields6)) 0) (= u__split_discrs (us_split_discrs1 temp___264))))
(assert (=> (not (= (to_rep (rec__formals_rec_split_pred__rec__f u__split_fields6)) 0)) (= u__split_fields7 u__split_fields6)))
(assert (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h x__split_fields11)) 0)))
(assert (= o10 (mk___rep x__split_discrs x__split_fields11)))
(assert (= o11 (rec__formals_rec_split_pred__rec__h (us_split_fields1 o10))))
(assert (= o12 (to_rep1 o11)))
(assert (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h x__split_fields11)) 0)))
(assert (= o9 (mk___rep x__split_discrs x__split_fields11)))
(assert (not (= (ite (rec__formals_rec_split_pred__rec__d (us_split_discrs1 o9)) 1 0) 1)))
(check-sat)
(exit)
