...
(define-fun temp___687 () us_rep2 (keys (mk___rep r__split_discrs r__split_fields1)))
(assert (not (exists ((temp___686 Int)) (and (and (in_range4 temp___686) (= (iter_has_element temp___687 temp___686) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields1)) (get temp___687 temp___686)) (f (get2 (model__ s) (get (keys s) i))))))))
(check-sat)
(exit)
