...
(declare-const temp___2722 integer)
(declare-const temp___2723 natural)
...
(assert (= a__split_discrs (mk___split_discrs temp___272)))
(assert (= temp___2721 o1))
(assert (= temp___2722 o2))
(assert (= temp___2723 o3))
(assert (not (not (= (to_rep1 temp___2723) 0))))
(check-sat)
(exit)
