...
(assert (= result3 true))
(assert (and (= o8 (- i n2)) (in_range7 (- i n2))))
(assert (and (= o9 o8) (in_range3 o8)))
(assert (and (= o10 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o9)) (in_range2 o10)))
(assert (and (= o7 i) (in_range3 i)))
(assert (and (= o6 (elements (mk___rep s__split_discrs s__split_fields1))) (and (and (and (= (length1 o6) (length (mk___rep s__split_discrs s__split_fields1))) (forall ((temp___432 Int)) (=> (and (in_range3 temp___432) (= (iter_has_element o6 temp___432) true)) (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) (get o6 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) item) true)) (and (< 0 (find o6 item)) (= (equivalent_elements (get o6 (find o6 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields1)))) (and (= (find o6 (get o6 i1)) i1) (= (e_is_find o6 (get o6 i1) i1) true)))))))
(assert (not (<= o7 (last o6))))
(check-sat)
(exit)
