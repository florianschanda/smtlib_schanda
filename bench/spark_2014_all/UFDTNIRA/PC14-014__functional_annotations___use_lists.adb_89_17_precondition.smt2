...
(assert (= (length (mk___rep l__split_discrs l__split_fields2)) (- (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3) 1)))
(assert (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i4) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i4)))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i3 1))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (+ j (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) j)))))
(assert (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)) i3))
(assert (and (=> (<= 1 r27b) (dynamic_property 1 r27b i3)) (and (<= 1 i3) (<= i3 r27b))))
(assert (<= 1 i1))
(assert (<= i1 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
(assert (and (= o2 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1)) (in_range2 o2)))
