...
(declare-const dummy2 tmy_duration2B)
(declare-fun attr__ATTRIBUTE_IMAGE2 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Int)
(declare-fun to_fixed2 (tmy_duration2B) Int)
(declare-fun of_fixed2 (Int) tmy_duration2B)
(declare-fun user_eq2 (tmy_duration2B tmy_duration2B) Bool)
...
(assert (forall ((x tmy_duration2B)) (! (= (of_fixed2 (to_fixed2 x)) x) :pattern ((to_fixed2 x)))))
(assert (forall ((x tmy_duration2B)) (in_range2 (to_fixed2 x))))
(assert (forall ((x Int)) (! (=> (in_range2 x) (= (to_fixed2 (of_fixed2 x)) x)) :pattern ((to_fixed2 (of_fixed2 x))))))
(declare-datatypes () ((tmy_duration2B__ref (mk_tmy_duration2B__ref (tmy_duration2B__content tmy_duration2B)))))
(define-fun tmy_duration2B__ref___projection ((a tmy_duration2B__ref)) tmy_duration2B (tmy_duration2B__content a))
(declare-sort my_duration2 0)
(define-fun in_range3 ((x Int)) Bool (and (<= (- 20000000000) x) (<= x 20000000000)))
(declare-const dummy3 my_duration2)
(declare-fun attr__ATTRIBUTE_IMAGE3 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Int)
(declare-fun to_fixed3 (my_duration2) Int)
(declare-fun of_fixed3 (Int) my_duration2)
(declare-fun user_eq3 (my_duration2 my_duration2) Bool)
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int4 x) 0) (ite (< 0 x) (pos_div_relation (to_int4 x) (* x 1) 1000000000) (pos_div_relation (- (to_int4 x)) (* (- x) 1) 1000000000))) :pattern ((to_int4 x)))))
(declare-fun of_int3 (Int) Int)
(assert (forall ((x Int)) (! (ite (= x 0) (= (of_int3 x) 0) (ite (< 0 x) (pos_div_relation (of_int3 x) (* x 1000000000) 1) (pos_div_relation (- (of_int3 x)) (* (- x) 1000000000) 1))) :pattern ((of_int3 x)))))
(assert (forall ((x my_duration2)) (! (= (of_fixed3 (to_fixed3 x)) x) :pattern ((to_fixed3 x)))))
(assert (forall ((x my_duration2)) (in_range3 (to_fixed3 x))))
(assert (forall ((x Int)) (! (=> (in_range3 x) (= (to_fixed3 (of_fixed3 x)) x)) :pattern ((to_fixed3 (of_fixed3 x))))))
(declare-datatypes () ((my_duration2__ref (mk_my_duration2__ref (my_duration2__content my_duration2)))))
(define-fun my_duration2__ref___projection ((a my_duration2__ref)) my_duration2 (my_duration2__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const md my_duration)
(declare-const md2 my_duration2)
(declare-const o my_duration)
(declare-const o1 my_duration2)
(declare-const result my_duration)
(declare-const md1 my_duration)
(declare-const result1 my_duration2)
(declare-const md21 my_duration2)
(assert (= (to_fixed1 o) (- 10000000000)))
(assert (= result md))
(assert (= md1 o))
(assert (= (to_fixed3 o1) 10000000000))
(assert (= result1 md2))
(assert (= md21 o1))
(assert (not (= (to_fixed (of_fixed (to_fixed1 md1))) (to_fixed (of_fixed (- (to_fixed3 md21)))))))
(check-sat)
(exit)
