...
(assert (forall ((x tcount_typeB)) (! (in_range6 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(declare-datatypes () ((t28b__ref (mk_t28b__ref (t28b__content tcount_typeB)))))
(define-fun t28b__ref___projection ((a t28b__ref)) tcount_typeB (t28b__content a))
...
(declare-const lgth Int)
(declare-const i Int)
(declare-const use_lists__double_size__cu__assume count_type)
(declare-const o Int)
(declare-const temp___555 Int)
(declare-const temp___557 Int)
(declare-const temp___560 us_rep1)
...
(declare-const temp___5531 us_main_type)
(declare-const temp___558 us_rep1)
...
(define-fun use_lists__double_size__cu__assume1 () us_rep2 (mk___rep1 (mk___split_fields1 use_lists__double_size__cu__assume)))
...
(assert (and (= use_lists__double_size__cu__assume1 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq2 use_lists__double_size__cu__assume1 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) use_lists__double_size__cu__assume1) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) use_lists__double_size__cu__assume1) 1)))))
(assert (= (mk___split_fields__ref1 (mk___split_fields1 result)) (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields))))
(assert (= use_lists__double_size__cu__assume cu__split_fields1))
(assert (and (= o (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (in_range1 o) (<= o (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
(assert (= (mk_int__ref result1) (mk_int__ref lgth)))
(assert (= lgth1 o))
(assert (in_range1 lgth1))
(assert (= lgth1 r27b))
(assert (in_range1 r27b))
(assert (= (mk_int__ref result2) (mk_int__ref i)))
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= temp___555 i2)))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= temp___557 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= temp___560 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= temp___559 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= temp___556 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= temp___554 cu__split_fields1)))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (and (= l__split_discrs (mk___split_discrs temp___553)) (= l__split_fields temp___5531))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= temp___558 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= (has_key (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10)) true)))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= (length (mk___rep l__split_discrs l__split_fields10)) (- (+ temp___556 i3) 1))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (forall ((i10 Int)) (=> (and (<= 1 i10) (<= i10 temp___557)) (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) i10) (get temp___558 i10))))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i3 1))) (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) (+ j temp___559)) (get temp___560 j))))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10)) i3)))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (and (=> (<= 1 r27b) (dynamic_property 1 r27b i3)) (and (<= 1 i3) (<= i3 r27b)))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (and (= o1 (element (mk___rep l__split_discrs l__split_fields10) (mk___rep1 cu__split_fields10))) (and (in_range5 o1) (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields10)) (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 cu__split_fields10))))))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (and (and (and (and (and (= (length (mk___rep l__split_discrs l__split_fields3)) (+ (length (mk___rep l__split_discrs l__split_fields10)) 1)) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (last1 (mk___rep l__split_discrs l__split_fields3))) (length (mk___rep l__split_discrs l__split_fields3)))) (= (keys_included_except (positions (mk___rep l__split_discrs l__split_fields3)) (positions (mk___rep l__split_discrs l__split_fields10)) (last1 (mk___rep l__split_discrs l__split_fields3))) true)) (= (ole1 (positions (mk___rep l__split_discrs l__split_fields10)) (positions (mk___rep l__split_discrs l__split_fields3))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (length (mk___rep l__split_discrs l__split_fields3))) o1)) (= (ole (model__ (mk___rep l__split_discrs l__split_fields10)) (model__ (mk___rep l__split_discrs l__split_fields3))) true))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (ite (= (ite (= (bool_eq2 (mk___rep1 cu__split_fields10) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields10)) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq2 (mk___rep1 cu__split_fields3) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields10)) 1))))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= i3 r27b)))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= i4 (mk_int__ref i3))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields3))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= l__split_fields4 (mk___split_fields__ref l__split_fields3))))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= i5 i3)))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= cu__split_fields5 cu__split_fields3)))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= l__split_fields5 l__split_fields3)))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= i6 i4)))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= cu__split_fields6 cu__split_fields4)))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= l__split_fields6 l__split_fields4)))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= i7 i5)))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= cu__split_fields7 cu__split_fields5)))
(assert (=> (and (<= 1 i2) (<= i2 r27b)) (= l__split_fields7 l__split_fields5)))
(assert (=> (not (and (<= 1 i2) (<= i2 r27b))) (= i6 (mk_int__ref i2))))
(assert (=> (not (and (<= 1 i2) (<= i2 r27b))) (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields11))))
(assert (=> (not (and (<= 1 i2) (<= i2 r27b))) (= l__split_fields6 (mk___split_fields__ref (mk___split_fields l__split_fields)))))
(assert (=> (not (and (<= 1 i2) (<= i2 r27b))) (= i7 i2)))
(assert (=> (not (and (<= 1 i2) (<= i2 r27b))) (= cu__split_fields7 cu__split_fields11)))
(assert (=> (not (and (<= 1 i2) (<= i2 r27b))) (= l__split_fields7 (mk___split_fields l__split_fields1))))
(assert (= i8 i6))
(assert (= lgth2 (mk_int__ref lgth1)))
...
(assert (<= 1 i1))
(assert (<= i1 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
(assert (and (= o6 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1)) (in_range2 o6)))
(assert (and (= o5 (+ i1 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (in_range6 (+ i1 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
(assert (and (= o4 (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (= (length1 o4) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))))
(assert (and (= o7 (get o4 o5)) (in_range2 o7)))
(assert (= o8 (ite (= o7 o6) true false)))
(assert (and (= o3 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1)) (in_range2 o3)))
(assert (and (= o2 (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (= (length1 o2) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))))
(assert (not (<= i1 (last o2))))
(check-sat)
(exit)
