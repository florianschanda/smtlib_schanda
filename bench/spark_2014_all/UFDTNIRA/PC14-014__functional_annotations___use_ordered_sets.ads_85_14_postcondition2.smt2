...
(assert (not (= (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (* 2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))))
(check-sat)
(exit)
