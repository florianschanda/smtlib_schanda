...
(assert (=> (= result1 true) (forall ((g Int)) (=> (and (in_range2 g) (= (contains (model__ (mk___rep r__split_discrs r__split_fields10)) g) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (= g (f (get (elements s) i)))))))))
