...
(declare-fun multiply (duration Int) duration)
(declare-fun multiply__function_guard (duration duration Int) Bool)
(declare-const time_span_zero duration)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(assert true)
(declare-const time_span_first duration)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const time_span_last duration)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const time_span_unit duration)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const x duration)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(assert (= time_span_first (of_fixed (- 9223372036854775808))))
(assert (= time_span_last (of_fixed 9223372036854775807)))
(assert (= time_span_zero (of_fixed 0)))
(assert (= time_span_unit (of_fixed 1)))
(assert (= x (multiply time_span_last 1)))
(assert (not (< (to_fixed time_span_zero) (to_fixed time_span_last))))
(check-sat)
(exit)
