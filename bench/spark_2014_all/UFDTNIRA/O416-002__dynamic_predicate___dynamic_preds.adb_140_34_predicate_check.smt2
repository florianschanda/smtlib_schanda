...
(assert (dynamic_invariant (mk___rep dynamic_preds__update_even_pair__x__fields2) true true true true))
...
(assert (and (and (= (to_rep dynamic_preds__update_constant_even_pair__x__fields) 0) (= (to_rep dynamic_preds__update_constant_even_pair__x__fields1) 2)) (dynamic_invariant (mk___rep dynamic_preds__update_constant_even_pair__x__fields2) true true true true)))
