...
(assert (= temp2 x))
(assert (in_range temp2))
(assert (= (mk_int__ref result1) (mk_int__ref temp1)))
(assert (= temp3 y))
(assert (in_range temp3))
(assert (and (= o (* x temp3)) (in_range (* x temp3))))
(assert (= (mk_int__ref result2) (mk_int__ref x)))
(assert (= x1 o))
(assert (not (in_range (* y temp2))))
(check-sat)
(exit)
