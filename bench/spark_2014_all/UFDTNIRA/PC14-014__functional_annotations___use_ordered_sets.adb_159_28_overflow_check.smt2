...
(assert (and (= o (length (mk___rep s__split_discrs s__split_fields1))) (and (in_range1 o) (<= o (to_rep (rec__use_ordered_sets__my_sets__set__capacity s__split_discrs))))))
(assert (= o1 (ite (<= i o) true false)))
(assert (not (in_range7 (* 2 n2))))
(check-sat)
(exit)
