...
(define-fun dynamic_invariant1 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range4 temp___expr_158)))
...
(assert (< 0 right))
(assert (= result (ogt__2 left time_span_zero)))
(assert (= result true))
(assert (= o3 (to_duration__2 time_span_last)))
(assert (= o4 (to_fixed o3)))
(assert (= o5 (fxp_div_result_int o4 1)))
(assert (and (= o6 o5) (in_range3 o5)))
(assert (and (= o7 o6) (in_range4 o6)))
(assert (= o8 (div1 o7 right)))
(assert (and (= o9 o8) (in_range3 o8)))
(assert (= o (to_duration__2 left)))
