...
(declare-const a__split_fields natural)
(assert (and (= (distinct 1 0) (rec__formals_rec_split_pred__rec__d (us_split_discrs1 i1b))) (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h (us_split_fields1 i1b))) 0))))
(assert (and (= (distinct 1 0) (rec__formals_rec_split_pred__rec__d a__split_discrs)) (not (= (to_rep1 a__split_fields) 0))))
(assert (not (= (ite (rec__formals_rec_split_pred__rec__d a__split_discrs) 1 0) 1)))
(check-sat)
(exit)
