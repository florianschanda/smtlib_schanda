...
(define-fun dynamic_preds__update_even_close_pair__x__fields2 () us_split_fields (mk___split_fields dynamic_preds__update_even_close_pair__x__fields dynamic_preds__update_even_close_pair__x__fields1))
...
(assert (= x__split_fields dynamic_preds__update_even_close_pair__x__compl))
(assert (= x__split_fields1 dynamic_preds__update_even_close_pair__x__compl1))
(assert (dynamic_invariant (mk___rep dynamic_preds__update_even_close_pair__x__fields2) true true true true))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= (mk___split_fields x__split_fields2 x__split_fields3) dynamic_preds__update_even_close_pair__x__fields2))
(assert (not (= (to_rep x__split_fields3) (+ (to_rep x__split_fields2) 2))))
(check-sat)
(exit)
