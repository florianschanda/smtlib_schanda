...
(assert (in_range2 sc))
(assert (and (= o18 (* 3 9223372036)) (in_range3 (* 3 9223372036))))
(assert (= o19 (ite (<= sc o18) true false)))
(assert (and (= o17 (* 3 (- 9223372036))) (in_range3 (* 3 (- 9223372036)))))
(assert (= o20 (ite (<= o17 sc) true false)))
(assert (= result (ite (= o20 true) o19 false)))
(assert (= result true))
(assert (and (= o13 (+ 9223372036 1)) (in_range3 (+ 9223372036 1))))
(assert (and (= o14 (result_sc sc ts)) (and (in_range2 o14) (= o14 (+ sc (ts_sc ts))))))
(assert (= o15 (ite (<= o14 o13) true false)))
(assert (and (= o11 (result_sc sc ts)) (and (in_range2 o11) (= o11 (+ sc (ts_sc ts))))))
(assert (and (= o12 (- (- 9223372036) 1)) (in_range3 (- (- 9223372036) 1))))
...
(assert (= result2 true))
(assert (and (= o7 (ts_fraction ts)) (= o7 (of_fixed (- (to_fixed (to_duration__2 ts)) (to_fixed (of_fixed (of_int (ts_sc ts)))))))))
