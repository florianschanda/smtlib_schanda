...
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 q2)) (=> (<= (- 2147483648) 2147483647) (in_range1 r2))) (<= n r2)))
(assert (and (= o (- m r2)) (in_range1 (- m r2))))
(assert (= result2 (ite (<= q2 o) true false)))
(assert (= result2 true))
(assert (not (in_range1 (* q2 n))))
(check-sat)
(exit)
