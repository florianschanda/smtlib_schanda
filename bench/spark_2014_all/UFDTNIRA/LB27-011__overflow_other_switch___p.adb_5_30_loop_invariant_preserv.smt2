...
(assert (forall ((i integer_64)) (and (<= (- 9223372036854775808) (integer_64qtint i)) (<= (integer_64qtint i) 9223372036854775807))))
...
(declare-const dummy1 integer_64)
(declare-datatypes () ((integer_64__ref (mk_integer_64__ref (integer_64__content integer_64)))))
(define-fun integer_64__ref___projection ((a integer_64__ref)) integer_64 (integer_64__content a))
(declare-const n Int)
...
(define-fun dynamic_invariant1 ((temp___expr_144 Int) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool) (temp___do_typ_inv_143 Bool)) Bool (=> (or (= temp___is_init_140 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range2 temp___expr_144)))
...
(assert (and (and (=> (<= 1 5) (in_range3 j2)) (=> (<= (- 2147483648) 2147483647) (in_range1 result__2))) (and (<= 1 j2) (<= j2 5))))
(assert (= result2 result__2))
(assert (= result__3 (* result__2 n)))
(assert (not (= j2 5)))
(assert (= result3 j2))
(assert (= j3 (+ j2 1)))
(assert (not (= result__3 (power n j3))))
(check-sat)
(exit)
