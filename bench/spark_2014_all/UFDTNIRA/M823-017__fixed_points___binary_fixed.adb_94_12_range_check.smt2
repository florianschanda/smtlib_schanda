...
(assert (= result1 y2))
(assert (= y21 o2))
(assert (and (= o3 (to_int1 (+ (to_fixed1 x) (to_fixed1 x)))) (in_range1 (to_int1 (+ (to_fixed1 x) (to_fixed1 x))))))
(assert (and (= o4 o3) (in_range5 o3)))
(assert (= result2 y3))
(assert (= y31 o4))
(assert (and (= o5 (to_int1 (- (+ (to_fixed1 x) (to_fixed1 x)) (to_fixed1 x)))) (in_range5 (to_int1 (- (+ (to_fixed1 x) (to_fixed1 x)) (to_fixed1 x))))))
(assert (= result3 y31))
(assert (= y32 o5))
(assert (= (to_fixed1 o6) (of_int1 y11)))
(assert (= result4 u))
(assert (= u1 o6))
(assert (= (to_fixed1 o7) (of_int1 y21)))
(assert (= result5 u1))
(assert (= u2 o7))
(assert (not (in_range3 (of_int1 y32))))
(check-sat)
(exit)
