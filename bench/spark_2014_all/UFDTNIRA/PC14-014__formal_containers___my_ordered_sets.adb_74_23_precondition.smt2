...
(assert (= (oeq (difference__2 (mk___rep m__split_discrs2 m__split_fields10) (mk___rep l__split_discrs l__split_fields11)) (difference__2 (mk___rep k__split_discrs k__split_fields3) (mk___rep l__split_discrs l__split_fields11))) true))
(assert (and (and (and (and (and (and (= (length (mk___rep m__split_discrs2 m__split_fields11)) (- (length (mk___rep m__split_discrs2 m__split_fields10)) (num_overlaps (model__ (mk___rep m__split_discrs2 m__split_fields10)) (model__ (mk___rep l__split_discrs l__split_fields11))))) (= (ole (model__ (mk___rep m__split_discrs2 m__split_fields11)) (model__ (mk___rep m__split_discrs2 m__split_fields10))) true)) (= (no_overlap (model__ (mk___rep m__split_discrs2 m__split_fields11)) (model__ (mk___rep l__split_discrs l__split_fields11))) true)) (= (included_in_union (model__ (mk___rep m__split_discrs2 m__split_fields10)) (model__ (mk___rep m__split_discrs2 m__split_fields11)) (model__ (mk___rep l__split_discrs l__split_fields11))) true)) (= (e_elements_included (elements (mk___rep m__split_discrs2 m__split_fields11)) (elements (mk___rep m__split_discrs2 m__split_fields10))) true)) (= (e_elements_included__2 (elements (mk___rep m__split_discrs2 m__split_fields10)) (model__ (mk___rep m__split_discrs2 m__split_fields11)) (elements (mk___rep m__split_discrs2 m__split_fields11))) true)) (= (mapping_preserved (elements (mk___rep m__split_discrs2 m__split_fields11)) (elements (mk___rep m__split_discrs2 m__split_fields10)) (positions (mk___rep m__split_discrs2 m__split_fields11)) (positions (mk___rep m__split_discrs2 m__split_fields10))) true)))
