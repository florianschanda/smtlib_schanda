...
(assert (<= 1 j))
(assert (<= j (- i2 1)))
(assert (and (= o1 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) j)) (in_range2 o1)))
(assert (not (in_range6 (+ j (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
(check-sat)
(exit)
