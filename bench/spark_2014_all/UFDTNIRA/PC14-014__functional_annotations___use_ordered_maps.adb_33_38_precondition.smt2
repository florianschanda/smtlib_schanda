...
(declare-const temp___689 us_rep2)
...
(assert (and (= temp___689 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (= (length2 temp___689) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___439 Int)) (=> (and (in_range4 temp___439) (= (iter_has_element temp___689 temp___439) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___689 temp___439)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key1) true)) (and (< 0 (find temp___689 key1)) (= (equivalent_keys (get temp___689 (find temp___689 key1)) key1) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields2)))) (and (= (find temp___689 (get temp___689 i)) i) (= (k_is_find temp___689 (get temp___689 i) i) true)))))))
(assert (and (= o (iter_has_element temp___689 temp___688)) (= (= o true) (and (<= 1 temp___688) (<= temp___688 (last temp___689))))))
(assert (= (= o1 true) (in_range4 temp___688)))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (and (= k (get temp___689 temp___688)) (in_range3 k)))
(assert (and (= o2 (positions s)) (and (not (= (has_key1 o2 no_element) true)) (forall ((i us_rep3)) (=> (= (has_key1 o2 i) true) (and (and (<= 1 (get1 o2 i)) (<= (get1 o2 i) (length s))) (forall ((j us_rep3)) (=> (= (has_key1 o2 j) true) (=> (= (get1 o2 i) (get1 o2 j)) (= (bool_eq3 i j) true))))))))))
