...
(assert (in_range2 sc))
(assert (and (= o12 (* 3 9223372036)) (in_range3 (* 3 9223372036))))
(assert (= o13 (ite (<= sc o12) true false)))
(assert (and (= o11 (* 3 (- 9223372036))) (in_range3 (* 3 (- 9223372036)))))
(assert (= o14 (ite (<= o11 sc) true false)))
(assert (= result (ite (= o14 true) o13 false)))
(assert (= result true))
(assert (and (= o7 (+ 9223372036 1)) (in_range3 (+ 9223372036 1))))
(assert (and (= o8 (result_sc sc ts)) (and (in_range2 o8) (= o8 (+ sc (ts_sc ts))))))
(assert (= o9 (ite (<= o8 o7) true false)))
(assert (and (= o5 (result_sc sc ts)) (and (in_range2 o5) (= o5 (+ sc (ts_sc ts))))))
(assert (and (= o6 (- (- 9223372036) 1)) (in_range3 (- (- 9223372036) 1))))
...
(assert (= result2 true))
(assert (and (= o3 (ts_fraction ts)) (= o3 (of_fixed (- (to_fixed (to_duration__2 ts)) (to_fixed (of_fixed (of_int (ts_sc ts)))))))))
