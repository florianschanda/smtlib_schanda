...
(assert (and (= o2 (floor (mk___rep l__split_discrs l__split_fields8) 1)) (ite (= (ite (= (= (length (mk___rep l__split_discrs l__split_fields8)) 0) false) (< 1 (first_element (mk___rep l__split_discrs l__split_fields8))) true) true) (= (bool_eq1 o2 no_element) true) (and (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields8)) o2) true) (not (< 1 (get1 (elements (mk___rep l__split_discrs l__split_fields8)) (get (positions (mk___rep l__split_discrs l__split_fields8)) o2))))) (= (e_is_find (elements (mk___rep l__split_discrs l__split_fields8)) 1 (get (positions (mk___rep l__split_discrs l__split_fields8)) o2)) true)))))
