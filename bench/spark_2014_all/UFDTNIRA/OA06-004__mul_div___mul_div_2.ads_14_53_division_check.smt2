...
(assert (forall ((i lli)) (and (<= (- 9223372036854775808) (lliqtint i)) (<= (lliqtint i) 9223372036854775807))))
...
(define-fun dynamic_invariant2 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range4 temp___expr_158)))
(declare-const v Int)
...
(define-fun dynamic_invariant3 ((temp___expr_32 Int) (temp___is_init_28 Bool) (temp___skip_constant_29 Bool) (temp___do_toplevel_30 Bool) (temp___do_typ_inv_31 Bool)) Bool (=> (or (= temp___is_init_28 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range1 temp___expr_32)))
