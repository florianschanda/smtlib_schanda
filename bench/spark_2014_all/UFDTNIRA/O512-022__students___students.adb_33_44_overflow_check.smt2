...
(assert (= (rec__students__student_record__resident (us_split_fields1 student)) true))
(assert (= (to_fixed o6) (+ (to_fixed fees1) 512000)))
(assert (= fees1 result7))
(assert (= fees3 o6))
(assert (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields1 student))) 0)))
(assert (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields1 student))) 1))
(assert (not (in_range5 (+ (to_fixed fees3) 12800))))
(check-sat)
(exit)
