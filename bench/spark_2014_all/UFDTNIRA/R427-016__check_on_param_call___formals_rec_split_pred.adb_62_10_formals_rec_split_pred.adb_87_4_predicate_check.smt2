...
(assert (= (to_rep (rec__formals_rec_split_pred__rec__f u__split_fields6)) 0))
(assert (not (= (to_rep1 rliteral2) 0)))
(assert (= temp___263 (mk___rep u__split_discrs (mk___split_fields (rec__formals_rec_split_pred__rec__f u__split_fields6) (rec__formals_rec_split_pred__rec__g u__split_fields6) rliteral2))))
(assert (not (not (= (to_rep1 (rec__formals_rec_split_pred__rec__h (us_split_fields1 temp___263))) 0))))
(check-sat)
(exit)
