...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int1 x) 0) (ite (< 0 x) (pos_div_relation (to_int1 x) (* x 1) 4) (pos_div_relation (- (to_int1 x)) (* (- x) 1) 4))) :pattern ((to_int1 x)))))
(declare-fun of_int (Int) Int)
(assert (forall ((x Int)) (! (ite (= x 0) (= (of_int x) 0) (ite (< 0 x) (pos_div_relation (of_int x) (* x 4) 1) (pos_div_relation (- (of_int x)) (* (- x) 4) 1))) :pattern ((of_int x)))))
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int2 x) 0) (ite (< 0 x) (pos_div_relation (to_int2 x) (* x 1) 4) (pos_div_relation (- (to_int2 x)) (* (- x) 1) 4))) :pattern ((to_int2 x)))))
(declare-fun of_int1 (Int) Int)
(assert (forall ((x Int)) (! (ite (= x 0) (= (of_int1 x) 0) (ite (< 0 x) (pos_div_relation (of_int1 x) (* x 4) 1) (pos_div_relation (- (of_int1 x)) (* (- x) 4) 1))) :pattern ((of_int1 x)))))
...
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (or (= x 0) (= y 0)) (= (fxp_mult x y) 0) (ite (or (and (< 0 x) (< 0 y)) (and (< x 0) (< y 0))) (pos_div_relation (fxp_mult x y) (* (* (* (* x y) 1) 1) 4) (* (* 4 4) 1)) (pos_div_relation (- (fxp_mult x y)) (- (* (* (* (* x y) 1) 1) 4)) (* (* 4 4) 1)))) :pattern ((fxp_mult x y))))))
(declare-fun fxp_div (Int Int) Int)
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (= x 0) (= (fxp_div x y) 0) (ite (and (< 0 x) (< 0 y)) (pos_div_relation (fxp_div x y) (* (* (* x 1) 4) 4) (* (* (* y 4) 1) 1)) (ite (and (< x 0) (< y 0)) (pos_div_relation (fxp_div x y) (* (* (* (- x) 1) 4) 4) (* (* (* (- y) 4) 1) 1)) (ite (and (< x 0) (< 0 y)) (pos_div_relation (- (fxp_div x y)) (* (* (* (- x) 1) 4) 4) (* (* (* y 4) 1) 1)) (=> (and (< 0 x) (< y 0)) (pos_div_relation (- (fxp_div x y)) (* (* (* x 1) 4) 4) (* (* (* (- y) 4) 1) 1))))))) :pattern ((fxp_div x y))))))
(declare-const x f)
(declare-const y f)
(declare-const o f)
(declare-const o1 f)
