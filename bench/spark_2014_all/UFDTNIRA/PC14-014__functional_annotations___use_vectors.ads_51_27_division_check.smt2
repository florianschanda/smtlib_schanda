...
(assert (and (= o1 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields)))) (and (dynamic_property 0 last o1) (<= o1 (capacity (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(assert (and (= o (capacity (mk___rep v__split_discrs (mk___split_fields v__split_fields)))) (and (dynamic_property 0 last o) (= o (ite (= (distinct 0 0) true) (to_rep (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)) last)))))
(assert (not (not (= 2 0))))
(check-sat)
(exit)
