...
(assert (= n1 0))
(assert (in_range1 n1))
(assert (and (= result2 (has_key (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 cu__split_fields3))) (= (= result2 true) (= (has_key (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 cu__split_fields3)) true))))
(assert (= result2 true))
...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 n2)) (and (= (get (elements (mk___rep s__split_discrs s__split_fields1)) (* 2 i1)) (+ (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i1) 1)) (= (get (elements (mk___rep s__split_discrs s__split_fields1)) (- (* 2 i1) 1)) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i1))))))
(assert (forall ((i1 Int)) (=> (and (<= (+ (* 2 n2) 1) i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields1)))) (= (get (elements (mk___rep s__split_discrs s__split_fields1)) i1) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (- i1 n2))))))
(assert (forall ((i1 Int)) (=> (and (<= (+ n2 1) i1) (<= i1 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))))) (= (get (elements (mk___rep s__split_discrs s__split_fields1)) (+ i1 n2)) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i1)))))
...
(assert (and (= o (+ n2 1)) (in_range7 (+ n2 1))))
(assert (= o1 (ite (<= o i) true false)))
(assert (= result3 (ite (= o1 true) (ite (<= i (length (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) true false) false)))
(assert (= result3 true))
(assert (and (= o5 i) (in_range3 i)))
(assert (and (= o6 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o5)) (in_range2 o6)))
(assert (and (= o3 (+ i n2)) (in_range7 (+ i n2))))
(assert (and (= o4 o3) (in_range3 o3)))
(assert (and (= o2 (elements (mk___rep s__split_discrs s__split_fields1))) (and (and (and (= (length1 o2) (length (mk___rep s__split_discrs s__split_fields1))) (forall ((temp___432 Int)) (=> (and (in_range3 temp___432) (= (iter_has_element o2 temp___432) true)) (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) (get o2 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) item) true)) (and (< 0 (find o2 item)) (= (equivalent_elements (get o2 (find o2 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields1)))) (and (= (find o2 (get o2 i1)) i1) (= (e_is_find o2 (get o2 i1) i1) true)))))))
(assert (not (<= 1 o4)))
(check-sat)
(exit)
