...
(assert (= t101 o9))
(assert (not (in_range1 (* (- (+ (- (+ (- (+ (- (+ (- (to_fixed t11) (to_fixed t21)) (to_fixed t31)) (to_fixed t41)) (to_fixed t51)) (to_fixed t61)) (to_fixed t71)) (to_fixed t81)) (to_fixed t91)) (to_fixed t101)) 4))))
(check-sat)
(exit)
