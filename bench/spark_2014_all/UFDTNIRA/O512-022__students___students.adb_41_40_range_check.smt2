...
(assert (not (= (rec__students__student_record__resident (us_split_fields1 student)) true)))
...
(assert (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields1 student))) 2))
(assert (not (in_range1 (+ (to_fixed fees1) 192000))))
(check-sat)
(exit)
