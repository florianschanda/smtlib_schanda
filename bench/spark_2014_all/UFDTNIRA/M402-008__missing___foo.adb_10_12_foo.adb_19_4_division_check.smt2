...
(assert (forall ((i1 i)) (and (<= (- 2147483648) (iqtint i1)) (<= (iqtint i1) 2147483647))))
...
(define-fun dynamic_invariant ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_200)))
