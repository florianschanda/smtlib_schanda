...
(assert (not (= (rec__students__student_record__resident (us_split_fields3 student)) true)))
(assert (not (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 0)))
(assert (= (to_rep1 (rec__students__student_record__meal_plan (us_split_fields3 student))) 1))
(assert (not (in_range5 (+ (to_fixed fees1) 20000))))
(check-sat)
(exit)
