...
(assert (and (= us3 i1) (dynamic_property2 first1 last3 i1)))
(assert (= o6 i1))
...
(assert (and (= us2 temp___502) (dynamic_property3 first2 last4 temp___502)))
