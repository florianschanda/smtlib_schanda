...
(declare-const time_span_unit us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const left us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const right us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(define-fun dynamic_invariant ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range3 temp___expr_158)))
(declare-const o us_rep)
(declare-const o1 Bool)
(declare-const o2 duration)
(declare-const o3 Int)
(declare-const o4 duration)
(declare-const o5 Int)
(declare-const o6 Int)
(declare-const result Bool)
(assert (not (= (bool_eq right time_span_zero) true)))
(assert (= o (osubtract__4 time_span_unit)))
(assert (= o1 (bool_eq right o)))
(assert (= result (ite (and (= o1 true) (= (bool_eq left time_span_first) true)) true false)))
(assert (not (= result true)))
(assert (= o4 (to_duration__2 right)))
(assert (= o5 (to_fixed o4)))
(assert (= o2 (to_duration__2 left)))
(assert (= o3 (to_fixed o2)))
(assert (= o6 (fxp_div_result_int o3 o5)))
