...
(declare-const v fp4)
(declare-const o fp3)
(declare-const o1 fp4)
(declare-const result fp3)
(declare-const u1 fp3)
(declare-const result1 fp4)
(declare-const v1 fp4)
(declare-const u2 fp3)
(declare-const v2 fp4)
(declare-const u3 fp3)
(declare-const v3 fp4)
(assert (and (<= (abs (to_fixed1 x)) 6) (<= (abs (to_fixed3 y)) 20)))
(assert (= (to_fixed5 o) (fxp_mult (to_fixed1 x) (to_fixed3 y))))
(assert (= (mk_fp3__ref result) (mk_fp3__ref u)))
(assert (= u1 o))
(assert (= (to_fixed7 o1) (fxp_mult1 (to_fixed1 x) (to_fixed3 y))))
(assert (= (mk_fp4__ref result1) (mk_fp4__ref v)))
(assert (= v1 o1))
(assert (= v1 v2))
(assert (= u1 u2))
(assert (= v3 v1))
(assert (= u3 u1))
(assert (not (<= (abs (to_fixed5 u2)) 120)))
(check-sat)
(exit)
