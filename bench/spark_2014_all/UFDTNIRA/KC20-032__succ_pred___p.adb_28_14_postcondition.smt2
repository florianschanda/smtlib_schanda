...
(assert (= (to_fixed o) (- (+ (to_fixed v) 1) 1)))
(assert (= result p__ident__3__result))
(assert (= p__ident__3__result1 o))
(assert (= (mk_volt__ref p__ident__3__result4) (mk_volt__ref p__ident__3__result2)))
(assert (= p__ident__3__result5 p__ident__3__result3))
(assert (= result1 p__ident__3__result4))
(assert (not (= (to_fixed p__ident__3__result4) (to_fixed v))))
(check-sat)
(exit)
