...
(assert (forall ((us_void_param tuple0)) (! (let ((result (get_constant_even_pair us_void_param))) (and (and (= (to_rep (rec__dynamic_preds__even_pair__a (us_split_fields1 result))) 0) (= (to_rep (rec__dynamic_preds__even_pair__b (us_split_fields1 result))) 0)) (dynamic_invariant result true false true true))) :pattern ((get_constant_even_pair us_void_param)))))
...
(declare-const temp___250 even)
(declare-const temp___2501 even)
(define-fun o2 () us_rep (mk___rep (mk___split_fields o o1)))
(assert (dynamic_invariant1 i7s true false true true))
(assert (dynamic_invariant2 i11s true false true true))
(assert (dynamic_invariant2 (mk___rep (mk___split_fields x__split_fields x__split_fields1)) false false true true))
(assert (and (= o2 (get_constant_even_pair Tuple0)) (and (dynamic_invariant o2 true false true true) (and (= (to_rep o) 0) (= (to_rep o1) 0)))))
(assert (= (mk___rep (mk___split_fields temp___250 temp___2501)) o2))
(assert (not (= (to_rep temp___2501) (+ (to_rep temp___250) 2))))
(check-sat)
(exit)
