...
(assert (= j2 result5))
(assert (= j3 1))
(assert (=> (<= j3 i2) (= temp___573 j3)))
(assert (=> (<= j3 i2) (= temp___572 innersum3)))
(assert (=> (<= j3 i2) (= (* 2 innersum4) (* j4 (- j4 1)))))
(assert (=> (<= j3 i2) (and (and (=> (<= 0 2147483647) (in_range2 innersum4)) (=> (<= 1 2147483647) (in_range3 j4))) (<= j4 i2))))
(assert (=> (<= j3 i2) (and (= o (+ innersum4 j4)) (in_range1 (+ innersum4 j4)))))
...
(assert (=> (<= j3 i2) (= j7 j5)))
(assert (=> (<= j3 i2) (= (mk_int__ref innersum8) (mk_int__ref innersum6))))
...
(assert (not (in_range1 (+ totalsum2 innersum8))))
(check-sat)
(exit)
