...
(define-fun dynamic_invariant ((temp___expr_25 Int) (temp___is_init_21 Bool) (temp___skip_constant_22 Bool) (temp___do_toplevel_23 Bool) (temp___do_typ_inv_24 Bool)) Bool (=> (or (= temp___is_init_21 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range1 temp___expr_25)))
(declare-const x Int)
...
(assert (and (= o (* x (* x x))) (in_range1 (* x (* x x)))))
(assert (= o1 (- o x)))
