...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (contains (model__ (mk___rep r__split_discrs r__split_fields2)) (f (get (elements s) i))) true))))
(assert (forall ((g Int)) (=> (and (in_range2 g) (= (contains (model__ (mk___rep r__split_discrs r__split_fields2)) g) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= g (f (get (elements s) i))))))))
(assert (not (= (has_key (positions s) (mk___rep1 cu__split_fields3)) true)))
(check-sat)
(exit)
