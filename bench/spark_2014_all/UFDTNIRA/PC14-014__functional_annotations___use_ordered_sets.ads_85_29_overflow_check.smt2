...
(define-fun o7 () us_rep2 (mk___rep1 (mk___split_fields1 o3)))
...
(assert (=> (= result2 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i n2)) (and (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (* 2 i)) (+ (get temp___836 i) 1)) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (- (* 2 i) 1)) (get temp___837 i)))))))
(assert (=> (= result2 true) (forall ((i Int)) (=> (and (<= (+ (* 2 n2) 1) i) (<= i (length (mk___rep s__split_discrs s__split_fields2)))) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) i) (get temp___838 (- i n2)))))))
(assert (=> (= result2 true) (forall ((i Int)) (=> (and (<= (+ n2 1) i) (<= i temp___839)) (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (+ i n2)) (get temp___840 i))))))
...
(assert (=> (= result2 true) (and (= o7 (next (mk___rep s__split_discrs s__split_fields3) (mk___rep1 cu__split_fields2))) (ite (= (ite (= (bool_eq2 (mk___rep1 cu__split_fields2) no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq2 o7 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) o7) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o7) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) 1)))))))
(assert (=> (= result2 true) (and (= temp___8311 (next (mk___rep s__split_discrs s__split_fields3) o7)) (ite (= (ite (= (bool_eq2 o7 no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o7) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq2 temp___8311 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) temp___8311) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) temp___8311) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o7) 1)))))))
...
(assert (= (= o6 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))))) (and (= (get (elements (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (- (* 2 i) 1)) (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)) (= (get (elements (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (* 2 i)) (+ (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i) 1)))))))
(assert (not (in_range7 (* 2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))))
(check-sat)
(exit)
