...
(define-fun fees3 () money_type__ref (mk_money_type__ref fees))
...
(assert (=> (= (rec__students3__student_record__part_time (us_split_fields3 student)) true) (= (mk_money_type__ref result2) fees3)))
...
(assert (=> (not (= (rec__students3__student_record__part_time (us_split_fields3 student)) true)) (= (mk_money_type__ref result3) fees3)))
...
(assert (not (= (rec__students3__student_record__resident (us_split_fields3 student)) true)))
(assert (not (= (to_rep1 (rec__students3__student_record__meal_plan (us_split_fields3 student))) 0)))
(assert (= (to_rep1 (rec__students3__student_record__meal_plan (us_split_fields3 student))) 1))
(assert (not (in_range1 (+ (to_fixed fees1) 20000))))
(check-sat)
(exit)
