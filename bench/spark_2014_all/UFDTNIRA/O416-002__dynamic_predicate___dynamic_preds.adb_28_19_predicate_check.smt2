...
(assert (dynamic_invariant2 (mk___rep (mk___split_fields x__split_fields x__split_fields1)) true false true true))
(assert (in_range dynamic_preds__init_even__x))
(assert (not (= (mod2 dynamic_preds__init_even__x 2) 0)))
(check-sat)
(exit)
