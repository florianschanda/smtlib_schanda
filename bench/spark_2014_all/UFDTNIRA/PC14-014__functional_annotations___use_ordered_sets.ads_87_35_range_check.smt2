...
(define-fun o18 () us_rep2 (mk___rep1 (mk___split_fields1 o3)))
...
(assert (=> (= result2 true) (and (= o18 (next (mk___rep s__split_discrs s__split_fields3) (mk___rep1 cu__split_fields2))) (ite (= (ite (= (bool_eq2 (mk___rep1 cu__split_fields2) no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq2 o18 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) o18) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o18) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields2)) 1)))))))
(assert (=> (= result2 true) (and (= temp___8311 (next (mk___rep s__split_discrs s__split_fields3) o18)) (ite (= (ite (= (bool_eq2 o18 no_element) false) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o18) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq2 temp___8311 no_element) true) (and (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) temp___8311) true) (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) temp___8311) (+ (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o18) 1)))))))
...
(assert (and (= o13 (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)) (in_range2 o13)))
(assert (= o14 (+ o13 1)))
(assert (and (= o15 o14) (in_range8 o14)))
(assert (and (= o11 (* 2 i)) (in_range7 (* 2 i))))
(assert (and (= o12 o11) (in_range3 o11)))
(assert (and (= o10 (elements (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (and (and (and (= (length1 o10) (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (forall ((temp___432 Int)) (=> (and (in_range3 temp___432) (= (iter_has_element o10 temp___432) true)) (= (contains (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (get o10 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) item) true)) (and (< 0 (find o10 item)) (= (equivalent_elements (get o10 (find o10 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (and (= (find o10 (get o10 i1)) i1) (= (e_is_find o10 (get o10 i1) i1) true)))))))
(assert (and (= o16 (get o10 o12)) (in_range2 o16)))
