...
(assert (<= first4 i9))
(assert (<= i9 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (not (= (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) i9) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i9))))
(check-sat)
(exit)
