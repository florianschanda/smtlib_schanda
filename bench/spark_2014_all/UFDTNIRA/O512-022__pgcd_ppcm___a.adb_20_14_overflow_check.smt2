...
(assert (=> (not (= bn1 0)) (= temp___156 bn1)))
(assert (=> (not (= bn1 0)) (= temp___155 an1)))
(assert (=> (not (= bn1 0)) (= temp___154 ao)))
(assert (=> (not (= bn1 0)) (= 0 temp___157)))
(assert (=> (not (= bn1 0)) (and (and (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648)))) (or (<= (abs an2) (abs a)) (<= (abs an2) (abs b)))) (or (<= (abs bn2) (abs a)) (<= (abs bn2) (abs b))))))
(assert (=> (not (= bn1 0)) (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 ao2)) (=> (<= (- 2147483648) 2147483647) (in_range1 an2))) (=> (<= (- 2147483648) 2147483647) (in_range1 bn2))) (not (= bn2 0)))))
(assert (=> (not (= bn1 0)) (= temp___1571 result2)))
(assert (=> (not (= bn1 0)) (= temp___1572 bn2)))
