...
(assert (<= 1 i))
(assert (<= i n1))
(assert (not (= (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (* 2 i)) (+ (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i) 1))))
(check-sat)
(exit)
