...
(assert (= result z))
(assert (= z1 o))
(assert (ite (< 0 (to_fixed1 x)) (< (to_fixed1 z1) 0) (ite (< (to_fixed1 x) 0) (< 0 (to_fixed1 z1)) (= (to_fixed1 z1) (to_fixed1 x)))))
(assert (= (to_fixed1 o1) (- 2)))
(assert (= result1 z1))
(assert (= z2 o1))
(assert (not (<= (to_fixed1 z2) (to_fixed1 x))))
(check-sat)
(exit)
