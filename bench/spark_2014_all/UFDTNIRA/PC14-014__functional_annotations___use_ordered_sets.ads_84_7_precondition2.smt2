...
(declare-const temp___848 us_rep1)
(declare-const temp___847 Int)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const result Bool)
(assert (and (= temp___848 (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) (and (and (and (= (length1 temp___848) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) (forall ((temp___432 Int)) (=> (and (in_range3 temp___432) (= (iter_has_element temp___848 temp___432) true)) (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (get temp___848 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) item) true)) (and (< 0 (find temp___848 item)) (= (equivalent_elements (get temp___848 (find temp___848 item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))))) (and (= (find temp___848 (get temp___848 i)) i) (= (e_is_find temp___848 (get temp___848 i) i) true)))))))
(assert (and (= o (iter_has_element temp___848 temp___847)) (= (= o true) (and (<= 1 temp___847) (<= temp___847 (last temp___848))))))
(assert (= (= o1 true) (in_range3 temp___847)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (<= 1 temp___847)))
(check-sat)
(exit)
