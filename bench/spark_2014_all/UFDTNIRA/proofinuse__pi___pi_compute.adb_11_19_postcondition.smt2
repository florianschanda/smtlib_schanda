...
(assert (= t101 o9))
(assert (= (to_fixed o10) (* (- (+ (- (+ (- (+ (- (+ (- (to_fixed t11) (to_fixed t21)) (to_fixed t31)) (to_fixed t41)) (to_fixed t51)) (to_fixed t61)) (to_fixed t71)) (to_fixed t81)) (to_fixed t91)) (to_fixed t101)) 4)))
(assert (= result10 (mk_fixed__ref res)))
(assert (= res1 o10))
(assert (= (to_fixed res1) 3189596))
(assert (= pi_compute__leibniz_fixed__result2 (mk_fixed__ref pi_compute__leibniz_fixed__result1)))
(assert (= pi_compute__leibniz_fixed__result3 pi_compute__leibniz_fixed__result1))
(assert (= result11 (mk_fixed__ref pi_compute__leibniz_fixed__result)))
(assert (= pi_compute__leibniz_fixed__result1 res1))
(assert (= pi_compute__leibniz_fixed__result4 pi_compute__leibniz_fixed__result2))
...
(assert (= pi_compute__leibniz_fixed__result5 pi_compute__leibniz_fixed__result3))
(assert (= res3 res1))
(assert (= t103 t101))
(assert (= t93 t91))
(assert (= t83 t81))
...
(assert (not (= (to_fixed (fixed__content pi_compute__leibniz_fixed__result4)) 3189596)))
(check-sat)
(exit)
