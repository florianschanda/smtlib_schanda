...
(assert (forall ((g1 Int)) (=> (and (in_range2 g1) (= (contains (model__ (mk___rep r__split_discrs r__split_fields2)) g1) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= g1 (f (get (elements s) i))))))))
...
(assert (= result2 true))
(assert (and (= o2 (positions s)) (and (not (= (has_key o2 no_element) true)) (forall ((i us_rep3)) (=> (= (has_key o2 i) true) (and (and (<= 1 (get1 o2 i)) (<= (get1 o2 i) (length s))) (forall ((j us_rep3)) (=> (= (has_key o2 j) true) (=> (= (get1 o2 i) (get1 o2 j)) (= (bool_eq3 i j) true))))))))))
