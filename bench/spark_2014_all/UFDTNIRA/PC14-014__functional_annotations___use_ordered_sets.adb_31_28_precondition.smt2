...
(declare-const temp___727 us_rep1)
(declare-const g Int)
...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (contains (model__ (mk___rep r__split_discrs r__split_fields2)) (f (get (elements s) i1))) true))))
(assert (forall ((g1 Int)) (=> (and (in_range2 g1) (= (contains (model__ (mk___rep r__split_discrs r__split_fields2)) g1) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= g1 (f (get (elements s) i1))))))))
(assert (and (= temp___727 (model__ (mk___rep r__split_discrs r__split_fields2))) (= (length3 temp___727) (length (mk___rep r__split_discrs r__split_fields2)))))
(assert (and (= o (contains temp___727 g)) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range2 e) (= (contains temp___727 e) true)) (= (equivalent_elements e g) true))) (= o true)))))
(assert (= (= o1 true) (in_range2 g)))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (and (= o2 (positions s)) (and (not (= (has_key o2 no_element) true)) (forall ((i1 us_rep3)) (=> (= (has_key o2 i1) true) (and (and (<= 1 (get1 o2 i1)) (<= (get1 o2 i1) (length s))) (forall ((j us_rep3)) (=> (= (has_key o2 j) true) (=> (= (get1 o2 i1) (get1 o2 j)) (= (bool_eq3 i1 j) true))))))))))
(assert (and (= o3 (get1 o2 (mk___rep1 cu__split_fields3))) (and (in_range5 o3) (=> (= (distinct 0 0) true) (and (= o3 (w_get o2 (witness o2 (mk___rep1 cu__split_fields3)))) (forall ((k us_rep3)) (=> (= (has_key o2 k) true) (= (= (bool_eq3 k (mk___rep1 cu__split_fields3)) true) (= (witness o2 (mk___rep1 cu__split_fields3)) (witness o2 k))))))))))
(assert (= o4 (- o3 1)))
(assert (= o5 (ite (<= i o4) true false)))
(assert (= result3 (ite (<= 1 i) o5 false)))
(assert (= result3 true))
(assert (and (= o6 (elements s)) (and (and (and (= (length1 o6) (length s)) (forall ((temp___432 Int)) (=> (and (in_range4 temp___432) (= (iter_has_element o6 temp___432) true)) (= (contains (model__ s) (get o6 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ s) item) true)) (and (< 0 (find o6 item)) (= (equivalent_elements (get o6 (find o6 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o6 (get o6 i1)) i1) (= (e_is_find o6 (get o6 i1) i1) true)))))))
