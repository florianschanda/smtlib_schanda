...
(declare-fun user_eq (constr_int constr_int) Bool)
(declare-const dummy constr_int)
...
(define-fun dynamic_predicate ((temp___237 Int)) Bool (or (and (<= (- 10) temp___237) (<= temp___237 (- 1))) (and (<= 1 temp___237) (<= temp___237 10))))
(declare-const i7b Int)
