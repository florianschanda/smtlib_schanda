...
(assert (<= 1 i4))
(assert (<= i4 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
(assert (not (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i4) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i4))))
(check-sat)
(exit)
