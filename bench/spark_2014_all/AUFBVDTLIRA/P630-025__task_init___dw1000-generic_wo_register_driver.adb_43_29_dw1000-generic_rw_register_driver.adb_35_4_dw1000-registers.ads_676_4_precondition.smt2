...
(define-fun target__ref___69__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__pmsc_txfseq_type__txfineseq (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__pmsc_txfseq_type__txfineseq (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_8370 us_t1) (temp___is_init_8366 Bool) (temp___skip_constant_8367 Bool) (temp___do_toplevel_8368 Bool) (temp___do_typ_inv_8369 Bool)) Bool (=> (not (= temp___skip_constant_8367 true)) (and (dynamic_property2 1 2 (first3 temp___expr_8370) (last3 temp___expr_8370)) (and (= (first3 temp___expr_8370) 1) (= (last3 temp___expr_8370) 2)))))
...
(define-fun register_byte_array__ref___171__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_8352 us_t2) (temp___is_init_8348 Bool) (temp___skip_constant_8349 Bool) (temp___do_toplevel_8350 Bool) (temp___do_typ_inv_8351 Bool)) Bool (=> (not (= temp___skip_constant_8349 true)) (and (dynamic_property3 1 2 (first5 temp___expr_8352) (last5 temp___expr_8352)) (and (= (first5 temp___expr_8352) 1) (= (last5 temp___expr_8352) 2)))))
...
(declare-const temp___90131 t1)
(declare-const temp___9014 (Array Int bits_8))
(declare-const temp___90141 t2)
...
(define-fun temp___90132 () us_t1 (mk___t1 temp___9013 temp___90131))
...
(assert (and (= temp___90132 (register_to_bytes reg)) (dynamic_invariant temp___90132 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___90131)) (to_rep (last2 temp___90131))) (+ (- (to_rep (last2 temp___90131)) (to_rep (first2 temp___90131))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___9013 temp___9014))
(assert (= (mk2 (to_rep (first2 temp___90131)) (to_rep (last2 temp___90131))) temp___90141))
(assert (= (ite (<= (to_rep (first4 temp___90141)) (to_rep (last4 temp___90141))) (+ (- (to_rep (last4 temp___90141)) (to_rep (first4 temp___90141))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___9014 temp___90141)))
(assert (= o2 o))
