...
(declare-fun temp_____aggregate_def_1082 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1084 (_ BitVec 8))) (forall ((temp___1085 Int) (temp___1086 Int)) (let ((temp___1083 (temp_____aggregate_def_1082 temp___1084 temp___1085 temp___1086))) (=> (dynamic_invariant temp___1084 true true true true) (and (=> (dynamic_property6 1 65536 temp___1085 temp___1086) (and (= (first5 temp___1083) temp___1085) (= (last5 temp___1083) temp___1086))) (forall ((temp___1087 Int)) (= (to_rep2 (select (to_array2 temp___1083) temp___1087)) temp___1084))))))))
...
(declare-const temp___1089 (Array Int octet))
(declare-const temp___10891 t2)
(declare-const temp___1090 (Array Int octet))
(declare-const temp___10901 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___1093 digit_index_type)
(declare-const temp___10931 (Array Int octet))
(declare-const temp___10932 t1)
...
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_1082 #x00 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_1082 #x00 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))) (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))))
(assert (= (mk___t2 temp___1089 temp___10891) (temp_____aggregate_def_1082 #x00 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))
(assert (= (ite (<= (to_rep1 (first4 temp___10891)) (to_rep1 (last4 temp___10891))) (+ (- (to_rep1 (last4 temp___10891)) (to_rep1 (first4 temp___10891))) 1) 0) (ite (<= 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))) (+ (- (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))) 1) 1) 0)))
(assert (= temp___1089 temp___1090))
(assert (= (mk1 (to_rep1 (first4 temp___10891)) (to_rep1 (last4 temp___10891))) temp___10901))
(assert (= (ite (<= (to_rep1 (first2 temp___10901)) (to_rep1 (last2 temp___10901))) (+ (- (to_rep1 (last2 temp___10901)) (to_rep1 (first2 temp___10901))) 1) 0) (ite (<= (to_rep1 (first2 result____split_fields1)) (to_rep1 (last2 result____split_fields1))) (+ (- (to_rep1 (last2 result____split_fields1)) (to_rep1 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___1090 temp___10901)))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1093)))
(assert (= temp___10931 o2))
(assert (= temp___10932 o3))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___10931 temp___10932))))
(assert (= result____split_discrs (mk___split_discrs temp___1093)))
...
(assert (= temp___1101 (- o12 1)))
(assert (not (<= temp___1101 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))))
(check-sat)
(exit)
