...
(define-fun dynamic_invariant3 ((temp___expr_223 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool) (temp___do_typ_inv_222 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= 1 2147483647)) (in_range1 temp___expr_223)))
(define-fun dynamic_invariant4 ((temp___expr_243 us_rep) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool (let ((temp___244 (rec__very_longs__very_long__octet_length (us_split_discrs1 temp___expr_243)))) (and (dynamic_property1 1 (to_rep temp___244) (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_243))) (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_243)))) (and (= (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_243))) 1) (= (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_243))) (to_rep temp___244))))))
...
(declare-datatypes () ((tS9bP1__ref (mk_tS9bP1__ref (tS9bP1__content tdigit_index_typeB)))))
(define-fun tS9bP1__ref___projection ((a tS9bP1__ref)) tdigit_index_typeB (tS9bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((s9b__ref (mk_s9b__ref (s9b__content us_t1)))))
(define-fun s9b__ref___projection ((a s9b__ref)) us_t1 (s9b__content a))
...
(declare-datatypes () ((t11b__ref (mk_t11b__ref (t11b__content tdigit_index_typeB)))))
(define-fun t11b__ref___projection ((a t11b__ref)) tdigit_index_typeB (t11b__content a))
(declare-sort t2 0)
...
(declare-fun temp_____aggregate_def_1213 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1215 (_ BitVec 8))) (forall ((temp___1216 Int) (temp___1217 Int)) (let ((temp___1214 (temp_____aggregate_def_1213 temp___1215 temp___1216 temp___1217))) (=> (dynamic_invariant temp___1215 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1216 temp___1217) (and (= (first5 temp___1214) temp___1216) (= (last5 temp___1214) temp___1217))) (forall ((temp___1218 Int)) (= (to_rep2 (select (to_array2 temp___1214) temp___1218)) temp___1215))))))))
...
(define-fun dynamic_invariant6 ((temp___expr_382 us_t1) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool) (temp___do_typ_inv_381 Bool)) Bool (=> (not (= temp___skip_constant_379 true)) (and (dynamic_property3 1 r10b (first3 temp___expr_382) (last3 temp___expr_382)) (and (= (first3 temp___expr_382) 1) (= (last3 temp___expr_382) r10b)))))
...
(declare-const i Int)
(declare-const temp___1220 (Array Int octet))
(declare-const temp___12201 t2)
(declare-const temp___1221 (Array Int octet))
(declare-const temp___12211 t1)
(declare-const temp___1223 (Array Int octet))
(declare-const temp___12231 t1)
(declare-const o (Array Int octet))
(declare-const o1 t)
(declare-const o2 (Array Int octet))
(declare-const o3 t)
(declare-const temp___1225 digit_index_type)
(declare-const temp___12251 (Array Int octet))
(declare-const temp___12252 t)
...
(assert (= (to_rep (rec__very_longs__very_long__octet_length result____split_discrs)) r10b))
(assert (in_range1 r10b))
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_1213 #x00 1 r10b)))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_1213 #x00 1 r10b)))) r10b))
(assert (= (mk___t2 temp___1220 temp___12201) (temp_____aggregate_def_1213 #x00 1 r10b)))
(assert (= (ite (<= (to_rep1 (first4 temp___12201)) (to_rep1 (last4 temp___12201))) (+ (- (to_rep1 (last4 temp___12201)) (to_rep1 (first4 temp___12201))) 1) 0) (ite (<= 1 r10b) (+ (- r10b 1) 1) 0)))
(assert (= temp___1220 temp___1221))
(assert (= (mk1 (to_rep1 (first4 temp___12201)) (to_rep1 (last4 temp___12201))) temp___12211))
(assert (= (ite (<= (to_rep1 (first2 temp___12211)) (to_rep1 (last2 temp___12211))) (+ (- (to_rep1 (last2 temp___12211)) (to_rep1 (first2 temp___12211))) 1) 0) (ite (<= (to_rep1 (first result____split_fields1)) (to_rep1 (last result____split_fields1))) (+ (- (to_rep1 (last result____split_fields1)) (to_rep1 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1223 temp___12231) (mk___t1 temp___1221 temp___12211)))
(assert (= temp___1223 o))
(assert (= (mk (to_rep1 (first2 temp___12231)) (to_rep1 (last2 temp___12231))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1225)))
(assert (= temp___12251 o2))
(assert (= temp___12252 o3))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___12251 temp___12252))))
(assert (= result____split_discrs (mk___split_discrs temp___1225)))
...
(assert (and (and (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1235 Int)) (=> (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1235) (<= temp___1235 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (or (< (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) temp___1235) (or (< temp___1235 1) (<= i2 temp___1235))) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1235) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1235)))))) (and (<= 1 i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
