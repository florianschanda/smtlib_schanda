...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (not (= (oeq (omod (oadd (num_of_big_int (mk___t o (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw1))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i1 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i1 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true)))
(check-sat)
(exit)
