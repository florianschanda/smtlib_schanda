...
(assert (= o22 (omultiply o16 o21)))
(assert (= o24 (osubtract o22 o23)))
(assert (= o13 (from_word32 a_msw2)))
...
(assert (= o6 (num_of_big_int (mk___t o27 (mk (to_rep a__first) (to_rep a__last))) a_first o5)))
(assert (= o15 (oadd o6 o14)))
(assert (= o25 (olt o15 o24)))
