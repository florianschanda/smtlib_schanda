...
(declare-const o16 t)
(declare-const temp___1287 digit_index_type)
(declare-const temp___12871 (Array Int octet))
(declare-const temp___12872 t)
...
(assert (= o15 o13))
(assert (= o16 o14))
(assert (= number__split_discrs (mk___split_discrs temp___1287)))
(assert (= temp___12871 o15))
(assert (= temp___12872 o16))
(assert (= result4 number__split_fields2))
(assert (= result5 number__split_fields3))
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___12871 temp___12872))))
(assert (= number__split_discrs (mk___split_discrs temp___1287)))
