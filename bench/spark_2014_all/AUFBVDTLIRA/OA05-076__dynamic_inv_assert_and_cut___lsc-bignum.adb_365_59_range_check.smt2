...
(declare-const o110 (Array Int word32))
(declare-const o111 (Array Int word32))
(declare-const carry13 (_ BitVec 32))
(declare-const carry23 (_ BitVec 32))
(declare-const result7 (Array Int word32))
(declare-const o112 (Array Int word32))
...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select o108 k)) #x00000000))))
...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (and (= (oeq (omod (oadd (num_of_big_int (mk___t o109 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o109 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true)))
...
(assert (= a_msw3 o37))
(assert (= o105 (from_word32 #x00000001)))
(assert (and (= o99 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o100 (+ o99 1)))
(assert (and (= o101 o100) (in_range1 o100)))
(assert (and (= o102 o101) (in_range2 o101)))
(assert (= o103 (num_of_big_int m m_first o102)))
(assert (= o98 (from_word32 #x00000002)))
(assert (= o104 (omultiply o98 o103)))
(assert (= o106 (osubtract o104 o105)))
(assert (= o95 (from_word32 a_msw3)))
(assert (and (= o90 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o91 (+ o90 1)))
(assert (and (= o92 o91) (in_range1 o91)))
(assert (and (= o93 o92) (in_range2 o92)))
(assert (and (= o89 (base Tuple0)) (= o89 (oexpon (from_word32 #x00000002) 32))))
(assert (= o94 (oexpon o89 o93)))
...
(assert (= o88 (num_of_big_int (mk___t o112 (mk (to_rep a__first) (to_rep a__last))) a_first o87)))
(assert (= o97 (oadd o88 o96)))
(assert (= o107 (olt o97 o106)))
...
(assert (and (= o72 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o73 (- o72 a_first)))
(assert (and (= o74 o73) (in_range1 o73)))
(assert (and (= o75 o74) (in_range2 o74)))
(assert (and (= o70 (base Tuple0)) (= o70 (oexpon (from_word32 #x00000002) 32))))
...
(assert (= o71 (inverse o69 o70)))
(assert (= o76 (oexpon o71 o75)))
(assert (and (= o59 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o60 (+ o59 1)))
(assert (and (= o61 o60) (in_range1 o60)))
(assert (and (= o62 o61) (in_range2 o61)))
(assert (= o63 (num_of_big_int c c_first o62)))
(assert (and (= o54 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o55 (- o54 a_first)))
(assert (and (= o56 o55) (in_range1 o55)))
(assert (and (= o57 o56) (in_range2 o56)))
(assert (= o58 (num_of_big_int b b_first o57)))
(assert (= o64 (omultiply o58 o63)))
(assert (= o77 (omultiply o64 o76)))
(assert (= o83 (omod o77 o82)))
