...
(declare-const temp___311 (Array (_ BitVec 16) integer))
(declare-const temp___3111 ar_index)
(declare-const temp___3112 length_type)
...
(assert (and (= o8 (+ (to_rep2 r__split_fields5) 1)) (in_range1 (+ (to_rep2 r__split_fields5) 1))))
(assert (= (to_rep2 o9) o8))
(assert (= r__split_fields3 o10))
(assert (= r__split_fields4 o11))
(assert (= o9 o12))
(assert (= temp___311 o10))
(assert (= temp___3111 o11))
(assert (= temp___3112 o12))
(assert (= result3 r__split_fields3))
(assert (= result4 r__split_fields4))
(assert (= result5 r__split_fields5))
(assert (= temp___311 r__split_fields6))
(assert (= temp___3111 r__split_fields7))
(assert (= temp___3112 r__split_fields8))
...
(assert (not (= (let ((temp___318 (func_push (to_model (mk___rep (mk___split_fields r__split_fields r__split_fields1 r__split_fields2))) x))) (let ((temp___317 (to_model (mk___rep (mk___split_fields r__split_fields9 r__split_fields10 r__split_fields11))))) (bool_eq (elts temp___317) (to_rep1 (first (rt temp___317))) (to_rep1 (last (rt temp___317))) (elts temp___318) (to_rep1 (first (rt temp___318))) (to_rep1 (last (rt temp___318)))))) true)))
(check-sat)
(exit)
