...
(define-fun target__ref___5__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (bool_eq (rec__dw1000__register_types__tx_buffer_type__tx_buffer (us_split_fields1 a)) 1 1024 (rec__dw1000__register_types__tx_buffer_type__tx_buffer (us_split_fields1 b)) 1 1024) true) true false))
...
(define-fun dynamic_invariant ((temp___expr_2501 us_t1) (temp___is_init_2497 Bool) (temp___skip_constant_2498 Bool) (temp___do_toplevel_2499 Bool) (temp___do_typ_inv_2500 Bool)) Bool (=> (not (= temp___skip_constant_2498 true)) (and (dynamic_property2 1 1024 (first3 temp___expr_2501) (last3 temp___expr_2501)) (and (= (first3 temp___expr_2501) 1) (= (last3 temp___expr_2501) 1024)))))
...
(define-fun register_byte_array__ref___11__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_2480 us_t2) (temp___is_init_2476 Bool) (temp___skip_constant_2477 Bool) (temp___do_toplevel_2478 Bool) (temp___do_typ_inv_2479 Bool)) Bool (=> (not (= temp___skip_constant_2477 true)) (and (dynamic_property3 1 1024 (first5 temp___expr_2480) (last5 temp___expr_2480)) (and (= (first5 temp___expr_2480) 1) (= (last5 temp___expr_2480) 1024)))))
...
(declare-const temp___84921 t1)
(declare-const temp___8493 (Array Int bits_8))
(declare-const temp___84931 t2)
...
(define-fun temp___84922 () us_t1 (mk___t1 temp___8492 temp___84921))
(assert (and (dynamic_property3 1 1024 (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 1024))))
(assert (and (= temp___84922 (register_to_bytes reg)) (dynamic_invariant temp___84922 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___84921)) (to_rep (last2 temp___84921))) (+ (- (to_rep (last2 temp___84921)) (to_rep (first2 temp___84921))) 1) 0) (ite (<= 1 1024) (+ (- 1024 1) 1) 0)))
(assert (= temp___8492 temp___8493))
(assert (= (mk2 (to_rep (first2 temp___84921)) (to_rep (last2 temp___84921))) temp___84931))
(assert (= (ite (<= (to_rep (first4 temp___84931)) (to_rep (last4 temp___84931))) (+ (- (to_rep (last4 temp___84931)) (to_rep (first4 temp___84931))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8493 temp___84931)))
(assert (= o2 o))
