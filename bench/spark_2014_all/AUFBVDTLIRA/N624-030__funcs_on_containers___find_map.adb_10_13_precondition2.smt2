...
(assert (= result2 true))
(assert (and (= o1 k1) (in_range3 k1)))
(assert (not (< (length (mk___rep result____split_discrs result____split_fields2)) (to_rep2 (rec__find_map__index_maps__map__capacity result____split_discrs)))))
(check-sat)
(exit)
