...
(assert (and (= us 1024) (in_range 1024)))
(assert (default_initial_assumption (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields)) false))
(assert (= 1024 (to_rep (rec__names__data__char_tables__vector__capacity char_table__split_discrs))))
(assert (and (= us1 256) (in_range2 256)))
(assert (default_initial_assumption1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields)) false))
(assert (= 256 (to_rep1 (rec__names__data__entry_tables__vector__capacity entry_table__split_discrs))))
(assert (and (= result1 (invariant__ hash_table1 (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields))) (= (= result1 true) (and (and (= (valid_tables (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields)) true) (= (valid_name_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields)) true)) (= (valid_hashes hash_table1 (mk___split_fields1 entry_table__split_fields)) true)))))
(assert (not (= (invariant__ hash_table1 (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields)) true)))
(check-sat)
(exit)
