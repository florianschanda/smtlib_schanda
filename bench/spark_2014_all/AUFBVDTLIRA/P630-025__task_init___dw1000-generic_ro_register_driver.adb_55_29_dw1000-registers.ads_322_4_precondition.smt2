...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__ec_rxtc_type__rx_ts_est bits_32)))))
(define-fun us_split_fields_RX_TS_EST__projection ((a us_split_fields)) bits_32 (rec__dw1000__register_types__ec_rxtc_type__rx_ts_est a))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__ec_rxtc_type__rx_ts_est (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__ec_rxtc_type__rx_ts_est (us_split_fields1 b)))) true false))
...
(assert (< dw1000__register_types__ec_rxtc_type__rx_ts_est__first__bit dw1000__register_types__ec_rxtc_type__rx_ts_est__last__bit))
(assert (<= 0 dw1000__register_types__ec_rxtc_type__rx_ts_est__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((ec_rxtc_type__ref (mk_ec_rxtc_type__ref (ec_rxtc_type__content us_rep)))))
(define-fun ec_rxtc_type__ref___projection ((a ec_rxtc_type__ref)) us_rep (ec_rxtc_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___72__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___52__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___52__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_4127 us_t1) (temp___is_init_4123 Bool) (temp___skip_constant_4124 Bool) (temp___do_toplevel_4125 Bool) (temp___do_typ_inv_4126 Bool)) Bool (=> (not (= temp___skip_constant_4124 true)) (and (dynamic_property2 1 4 (first3 temp___expr_4127) (last3 temp___expr_4127)) (and (= (first3 temp___expr_4127) 1) (= (last3 temp___expr_4127) 4)))))
