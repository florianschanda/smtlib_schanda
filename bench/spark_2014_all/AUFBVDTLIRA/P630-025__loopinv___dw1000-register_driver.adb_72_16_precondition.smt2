...
(declare-const o17 t)
(define-fun o18 () us_rep1 (mk___rep1 (mk___split_fields1 o10 o11 o12 o13 o14)))
...
(assert (let ((temp___806 header1)) (and (= (to_rep4 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___806))) 1) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___806))) 0))))
(assert (= o18 header1))
(assert (= o15 (to_bytes1 o18)))
(assert (= o15 o16))
(assert (= (mk 1 2) o17))
(assert (not (<= (length (mk___t o16 o17)) 3)))
(check-sat)
(exit)
