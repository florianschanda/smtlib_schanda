...
(define-fun target__ref___66__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun dynamic_invariant ((temp___expr_8130 us_t1) (temp___is_init_8126 Bool) (temp___skip_constant_8127 Bool) (temp___do_toplevel_8128 Bool) (temp___do_typ_inv_8129 Bool)) Bool (=> (not (= temp___skip_constant_8127 true)) (and (dynamic_property2 1 4 (first3 temp___expr_8130) (last3 temp___expr_8130)) (and (= (first3 temp___expr_8130) 1) (= (last3 temp___expr_8130) 4)))))
...
(define-fun register_byte_array__ref___165__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_8097 us_t2) (temp___is_init_8093 Bool) (temp___skip_constant_8094 Bool) (temp___do_toplevel_8095 Bool) (temp___do_typ_inv_8096 Bool)) Bool (=> (not (= temp___skip_constant_8094 true)) (and (dynamic_property3 1 4 (first5 temp___expr_8097) (last5 temp___expr_8097)) (and (= (first5 temp___expr_8097) 1) (= (last5 temp___expr_8097) 4)))))
...
(declare-const temp___8992 (Array Int bits_8))
(declare-const temp___89921 t1)
(declare-const temp___8993 (Array Int bits_8))
(declare-const temp___89931 t2)
...
(define-fun temp___89922 () us_t1 (mk___t1 temp___8992 temp___89921))
...
(assert (and (= temp___89922 (register_to_bytes reg)) (dynamic_invariant temp___89922 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___89921)) (to_rep (last2 temp___89921))) (+ (- (to_rep (last2 temp___89921)) (to_rep (first2 temp___89921))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8992 temp___8993))
(assert (= (mk2 (to_rep (first2 temp___89921)) (to_rep (last2 temp___89921))) temp___89931))
(assert (= (ite (<= (to_rep (first4 temp___89931)) (to_rep (last4 temp___89931))) (+ (- (to_rep (last4 temp___89931)) (to_rep (first4 temp___89931))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8993 temp___89931)))
(assert (= o2 o))
