...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select o64 k)) #x00000000))))
...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (and (= (oeq (omod (oadd (num_of_big_int (mk___t o65 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o65 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true)))
...
(assert (= o60 (omultiply o54 o59)))
(assert (= o62 (osubtract o60 o61)))
(assert (= o51 (from_word32 a_msw3)))
(assert (and (= o46 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o47 (+ o46 1)))
(assert (and (= o48 o47) (in_range1 o47)))
(assert (and (= o49 o48) (in_range2 o48)))
(assert (and (= o45 (base Tuple0)) (= o45 (oexpon (from_word32 #x00000002) 32))))
...
(assert (= o44 (num_of_big_int (mk___t o68 (mk (to_rep a__first) (to_rep a__last))) a_first o43)))
(assert (= o53 (oadd o44 o52)))
(assert (= o63 (olt o53 o62)))
