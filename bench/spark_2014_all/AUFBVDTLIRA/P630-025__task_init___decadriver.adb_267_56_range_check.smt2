...
(define-fun in_range4 ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x1F)))
...
(assert (forall ((x bits_5)) (! (in_range4 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x20))) (=> (in_range4 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int7 ((x bits_5)) Int (bv2nat (to_rep3 x)))
...
(define-fun in_range5 ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x3F)))
...
(declare-fun user_eq6 (bits_6 bits_6) Bool)
(declare-const dummy6 bits_6)
...
(declare-fun to_rep4 (bits_6) (_ BitVec 8))
(declare-fun of_rep4 ((_ BitVec 8)) bits_6)
(assert (forall ((x bits_6)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x bits_6)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x40))) (=> (in_range5 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
(define-fun to_int8 ((x bits_6)) Int (bv2nat (to_rep4 x)))
(assert (forall ((x bits_6)) (! (in_range_int4 (to_int8 x)) :pattern ((to_int8 x)))))
...
(define-fun to_int9 ((x bits_8)) Int (bv2nat (to_rep5 x)))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__arx2init (us_split_fields5 a))) (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__arx2init (us_split_fields5 b)))) (= (to_rep5 (rec__dw1000__register_types__pmsc_ctrl1_type__pktseq (us_split_fields5 a))) (to_rep5 (rec__dw1000__register_types__pmsc_ctrl1_type__pktseq (us_split_fields5 b))))) (= (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__atxslp (us_split_fields5 a))) (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__atxslp (us_split_fields5 b))))) (= (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__arxslp (us_split_fields5 a))) (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__arxslp (us_split_fields5 b))))) (= (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__snoze (us_split_fields5 a))) (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__snoze (us_split_fields5 b))))) (= (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__snozr (us_split_fields5 a))) (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__snozr (us_split_fields5 b))))) (= (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__pllsyn (us_split_fields5 a))) (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__pllsyn (us_split_fields5 b))))) (= (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__lderune (us_split_fields5 a))) (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__lderune (us_split_fields5 b))))) (= (to_rep4 (rec__dw1000__register_types__pmsc_ctrl1_type__khzclkdiv (us_split_fields5 a))) (to_rep4 (rec__dw1000__register_types__pmsc_ctrl1_type__khzclkdiv (us_split_fields5 b))))) (= (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_1 (us_split_fields5 a))) (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_1 (us_split_fields5 b))))) (= (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_2 (us_split_fields5 a))) (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_2 (us_split_fields5 b))))) (= (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_3 (us_split_fields5 a))) (to_rep (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_3 (us_split_fields5 b))))) (= (to_rep5 (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_4 (us_split_fields5 a))) (to_rep5 (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_4 (us_split_fields5 b))))) true false))
...
(declare-fun user_eq9 (bits_32 bits_32) Bool)
(declare-const dummy9 bits_32)
...
(define-fun in_range6 ((x (_ BitVec 16))) Bool (and (bvule #x0000 x) (bvule x #x07FF)))
...
(declare-fun user_eq10 (bits_11 bits_11) Bool)
(declare-const dummy10 bits_11)
...
(declare-fun to_rep6 (bits_16) (_ BitVec 16))
(declare-fun of_rep6 ((_ BitVec 16)) bits_16)
(assert (forall ((x bits_16)) (! (= (of_rep6 (to_rep6 x)) x) :pattern ((to_rep6 x)))))
(assert true)
(assert (forall ((x (_ BitVec 16))) (! (= (to_rep6 (of_rep6 x)) x) :pattern ((to_rep6 (of_rep6 x))))))
(define-fun to_int10 ((x bits_16)) Int (bv2nat (to_rep6 x)))
(assert (forall ((x bits_16)) (! (uint_in_range1 (to_int10 x)) :pattern ((to_int10 x)))))
(declare-fun to_rep7 (bits_32) (_ BitVec 32))
(declare-fun of_rep7 ((_ BitVec 32)) bits_32)
(assert (forall ((x bits_32)) (! (= (of_rep7 (to_rep7 x)) x) :pattern ((to_rep7 x)))))
(assert true)
(assert (forall ((x (_ BitVec 32))) (! (= (to_rep7 (of_rep7 x)) x) :pattern ((to_rep7 (of_rep7 x))))))
(define-fun to_int11 ((x bits_32)) Int (bv2nat (to_rep7 x)))
...
(define-fun bool_eq3 ((a (Array Int bits_32)) (a__first Int) (a__last Int) (b (Array Int bits_32)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_206 Int)) (=> (and (<= a__first temp___idx_206) (<= temp___idx_206 a__last)) (= (to_rep7 (select a temp___idx_206)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_206))))))) true false))
(assert (forall ((a (Array Int bits_32)) (b (Array Int bits_32))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_206 Int)) (=> (and (<= a__first temp___idx_206) (<= temp___idx_206 a__last)) (= (to_rep7 (select a temp___idx_206)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_206)))))))))))
...
(define-fun us_split_fields__ref___143__projection ((a us_split_fields__ref3)) us_split_fields6 (us_split_fields__content3 a))
(declare-datatypes () ((us_rep3 (mk___rep3 (us_split_fields7 us_split_fields6)))))
(define-fun us_rep___145__projection ((a us_rep3)) us_split_fields6 (us_split_fields7 a))
...
(define-fun default_initial_assumption ((temp___expr_5039 us_rep3) (temp___skip_top_level_5040 Bool)) Bool (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep7 (rec__decadriver__driver_type__part_id (us_split_fields7 temp___expr_5039))) #x00000000) (= (to_rep7 (rec__decadriver__driver_type__lot_id (us_split_fields7 temp___expr_5039))) #x00000000)) (= (to_rep6 (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields7 temp___expr_5039))) #x0000)) (= (to_rep6 (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields7 temp___expr_5039))) #x0000)) (= (to_rep3 (rec__decadriver__driver_type__xtal_trim (us_split_fields7 temp___expr_5039))) #x10)) (= (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields7 temp___expr_5039)) (temp_____aggregate_def_5041 #x00000000))) (= (rec__decadriver__driver_type__long_frames (us_split_fields7 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields7 temp___expr_5039)) (mk___rep (mk___split_fields (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep1 #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep2 #x00) (of_rep3 #x00))))) (= (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields7 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields7 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields7 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields7 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_phr_error (us_split_fields7 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_rs_error (us_split_fields7 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_fcs_error (us_split_fields7 temp___expr_5039)) (distinct 0 0))))
...
(declare-fun temp_____aggregate_def_5169 ((_ BitVec 32)) (Array Int bits_32))
(assert (forall ((temp___5171 (_ BitVec 32))) (=> (dynamic_invariant temp___5171 true true true true) (forall ((temp___5172 Int)) (= (to_rep7 (select (temp_____aggregate_def_5169 temp___5171) temp___5172)) temp___5171)))))
(assert (forall ((temp___5043 (_ BitVec 32))) (=> (dynamic_invariant temp___5043 true true true true) (forall ((temp___5044 Int)) (= (to_rep7 (select (temp_____aggregate_def_5041 temp___5043) temp___5044)) temp___5043)))))
...
(define-fun dynamic_invariant2 ((temp___expr_322 (_ BitVec 8)) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool) (temp___do_typ_inv_321 Bool)) Bool (=> (or (= temp___is_init_318 true) (bvule #x00 #x03)) (in_range2 temp___expr_322)))
(define-fun dynamic_invariant3 ((temp___expr_329 (_ BitVec 8)) (temp___is_init_325 Bool) (temp___skip_constant_326 Bool) (temp___do_toplevel_327 Bool) (temp___do_typ_inv_328 Bool)) Bool (=> (or (= temp___is_init_325 true) (bvule #x00 #x07)) (in_range3 temp___expr_329)))
(define-fun dynamic_invariant4 ((temp___expr_343 (_ BitVec 8)) (temp___is_init_339 Bool) (temp___skip_constant_340 Bool) (temp___do_toplevel_341 Bool) (temp___do_typ_inv_342 Bool)) Bool (=> (or (= temp___is_init_339 true) (bvule #x00 #x1F)) (in_range4 temp___expr_343)))
(define-fun dynamic_invariant5 ((temp___expr_350 (_ BitVec 8)) (temp___is_init_346 Bool) (temp___skip_constant_347 Bool) (temp___do_toplevel_348 Bool) (temp___do_typ_inv_349 Bool)) Bool (=> (or (= temp___is_init_346 true) (bvule #x00 #x3F)) (in_range5 temp___expr_350)))
...
(define-fun dynamic_invariant7 ((temp___expr_385 (_ BitVec 16)) (temp___is_init_381 Bool) (temp___skip_constant_382 Bool) (temp___do_toplevel_383 Bool) (temp___do_typ_inv_384 Bool)) Bool (=> (or (= temp___is_init_381 true) (bvule #x0000 #x07FF)) (in_range6 temp___expr_385)))
...
(assert (= (to_rep7 o) dw1000__driver__read_otp__word))
...
(assert (= (to_rep7 o3) dw1000__driver__read_otp__word1))
...
(assert (=> (= load_antenna_delay true) (= (to_rep6 o6) ((_ extract 15 0) (bvand word2 #x0000FFFF)))))
(assert (=> (= load_antenna_delay true) (= o7 (mk___split_fields3 (rec__decadriver__driver_type__part_id (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__lot_id (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields7 (let ((subject self__)) self__2))) o6 (rec__decadriver__driver_type__xtal_trim (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__long_frames (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__detect_phr_error (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__detect_rs_error (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__detect_fcs_error (us_split_fields7 (let ((subject self__)) self__2)))))))
(assert (=> (= load_antenna_delay true) (= o8 (mk___rep3 o7))))
(assert (=> (= load_antenna_delay true) (= result2 (let ((subject self__)) (mk_driver_type__ref self__2)))))
(assert (=> (= load_antenna_delay true) (= (let ((subject self__)) self__3) o8)))
(assert (=> (= load_antenna_delay true) (= word2 result3)))
(assert (=> (= load_antenna_delay true) (= word3 (bvlshr word2 ((_ int2bv 32) 16)))))
(assert (=> (= load_antenna_delay true) (= (to_rep6 o9) ((_ extract 15 0) (bvand word3 #x0000FFFF)))))
(assert (=> (= load_antenna_delay true) (= o10 (mk___split_fields3 (rec__decadriver__driver_type__part_id (us_split_fields7 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__lot_id (us_split_fields7 (let ((subject self__)) self__3))) o9 (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields7 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__xtal_trim (us_split_fields7 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields7 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__long_frames (us_split_fields7 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields7 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields7 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields7 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields7 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields7 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__detect_phr_error (us_split_fields7 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__detect_rs_error (us_split_fields7 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__detect_fcs_error (us_split_fields7 (let ((subject self__)) self__3)))))))
(assert (=> (= load_antenna_delay true) (= o11 (mk___rep3 o10))))
(assert (=> (= load_antenna_delay true) (= result4 (let ((subject self__)) (mk_driver_type__ref self__3)))))
(assert (=> (= load_antenna_delay true) (= (let ((subject self__)) self__4) o11)))
(assert (=> (not (= load_antenna_delay true)) (= (to_rep6 o12) #x0000)))
(assert (=> (not (= load_antenna_delay true)) (= o13 (mk___split_fields3 (rec__decadriver__driver_type__part_id (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__lot_id (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields7 (let ((subject self__)) self__2))) o12 (rec__decadriver__driver_type__xtal_trim (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__long_frames (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__detect_phr_error (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__detect_rs_error (us_split_fields7 (let ((subject self__)) self__2))) (rec__decadriver__driver_type__detect_fcs_error (us_split_fields7 (let ((subject self__)) self__2)))))))
(assert (=> (not (= load_antenna_delay true)) (= o14 (mk___rep3 o13))))
(assert (=> (not (= load_antenna_delay true)) (= result5 (let ((subject self__)) (mk_driver_type__ref self__2)))))
(assert (=> (not (= load_antenna_delay true)) (= (let ((subject self__)) self__5) o14)))
(assert (=> (not (= load_antenna_delay true)) (= (to_rep6 o15) #x0000)))
(assert (=> (not (= load_antenna_delay true)) (= o16 (mk___split_fields3 (rec__decadriver__driver_type__part_id (us_split_fields7 (let ((subject self__)) self__5))) (rec__decadriver__driver_type__lot_id (us_split_fields7 (let ((subject self__)) self__5))) o15 (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields7 (let ((subject self__)) self__5))) (rec__decadriver__driver_type__xtal_trim (us_split_fields7 (let ((subject self__)) self__5))) (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields7 (let ((subject self__)) self__5))) (rec__decadriver__driver_type__long_frames (us_split_fields7 (let ((subject self__)) self__5))) (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields7 (let ((subject self__)) self__5))) (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields7 (let ((subject self__)) self__5))) (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields7 (let ((subject self__)) self__5))) (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields7 (let ((subject self__)) self__5))) (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields7 (let ((subject self__)) self__5))) (rec__decadriver__driver_type__detect_phr_error (us_split_fields7 (let ((subject self__)) self__5))) (rec__decadriver__driver_type__detect_rs_error (us_split_fields7 (let ((subject self__)) self__5))) (rec__decadriver__driver_type__detect_fcs_error (us_split_fields7 (let ((subject self__)) self__5)))))))
(assert (=> (not (= load_antenna_delay true)) (= o17 (mk___rep3 o16))))
(assert (=> (not (= load_antenna_delay true)) (= result6 (let ((subject self__)) (mk_driver_type__ref self__5)))))
(assert (=> (not (= load_antenna_delay true)) (= (let ((subject self__)) self__6) o17)))
(assert (=> (not (= load_antenna_delay true)) (= (let ((subject self__)) (mk_driver_type__ref self__4)) (let ((subject self__)) (mk_driver_type__ref self__6)))))
(assert (=> (not (= load_antenna_delay true)) (= device_state1 device_state)))
...
(assert (=> (= load_xtal_trim true) (= (to_rep3 o18) ((_ extract 7 0) (bvand word4 #x0000001F)))))
(assert (=> (= load_xtal_trim true) (= o19 (mk___split_fields3 (rec__decadriver__driver_type__part_id (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__lot_id (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields7 (let ((subject self__)) self__4))) o18 (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__long_frames (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__detect_phr_error (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__detect_rs_error (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__detect_fcs_error (us_split_fields7 (let ((subject self__)) self__4)))))))
(assert (=> (= load_xtal_trim true) (= o20 (mk___rep3 o19))))
(assert (=> (= load_xtal_trim true) (= result7 (let ((subject self__)) (mk_driver_type__ref self__4)))))
(assert (=> (= load_xtal_trim true) (= (let ((subject self__)) self__7) o20)))
(assert (=> (not (= load_xtal_trim true)) (= (to_rep3 o21) #x10)))
(assert (=> (not (= load_xtal_trim true)) (= o22 (mk___split_fields3 (rec__decadriver__driver_type__part_id (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__lot_id (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields7 (let ((subject self__)) self__4))) o21 (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__long_frames (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__detect_phr_error (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__detect_rs_error (us_split_fields7 (let ((subject self__)) self__4))) (rec__decadriver__driver_type__detect_fcs_error (us_split_fields7 (let ((subject self__)) self__4)))))))
(assert (=> (not (= load_xtal_trim true)) (= o23 (mk___rep3 o22))))
(assert (=> (not (= load_xtal_trim true)) (= result8 (let ((subject self__)) (mk_driver_type__ref self__4)))))
(assert (=> (not (= load_xtal_trim true)) (= (let ((subject self__)) self__8) o23)))
(assert (=> (not (= load_xtal_trim true)) (= (let ((subject self__)) (mk_driver_type__ref self__7)) (let ((subject self__)) (mk_driver_type__ref self__8)))))
...
(assert (= result9 i))
(assert (= i1 0))
(assert (and (= o24 (+ 16 i1)) (in_range_int5 (+ 16 i1))))
(assert (= o25 ((_ int2bv 16) o24)))
(assert (= (to_rep7 o26) dw1000__driver__read_otp__word2))
(assert (= o27 (store (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields7 (let ((subject self__)) self__7))) i1 o26)))
(assert (= o28 (mk___split_fields3 (rec__decadriver__driver_type__part_id (us_split_fields7 (let ((subject self__)) self__7))) (rec__decadriver__driver_type__lot_id (us_split_fields7 (let ((subject self__)) self__7))) (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields7 (let ((subject self__)) self__7))) (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields7 (let ((subject self__)) self__7))) (rec__decadriver__driver_type__xtal_trim (us_split_fields7 (let ((subject self__)) self__7))) o27 (rec__decadriver__driver_type__long_frames (us_split_fields7 (let ((subject self__)) self__7))) (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields7 (let ((subject self__)) self__7))) (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields7 (let ((subject self__)) self__7))) (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields7 (let ((subject self__)) self__7))) (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields7 (let ((subject self__)) self__7))) (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields7 (let ((subject self__)) self__7))) (rec__decadriver__driver_type__detect_phr_error (us_split_fields7 (let ((subject self__)) self__7))) (rec__decadriver__driver_type__detect_rs_error (us_split_fields7 (let ((subject self__)) self__7))) (rec__decadriver__driver_type__detect_fcs_error (us_split_fields7 (let ((subject self__)) self__7))))))
(assert (= o29 (mk___rep3 o28)))
(assert (= result10 (let ((subject self__)) (mk_driver_type__ref self__7))))
(assert (= (let ((subject self__)) self__9) o29))
(assert (= result11 i1))
(assert (= i2 1))
(assert (not (in_range_int5 (+ 16 i2))))
(check-sat)
(exit)
