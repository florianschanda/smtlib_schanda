...
(assert (forall ((x mod_16)) (! (uint_in_range1 (to_int3 x)) :pattern ((to_int3 x)))))
...
(define-fun test_length__p3__a2__assume2 () us_t (mk___t test_length__p3__a2__assume test_length__p3__a2__assume1))
(assert (and (= test_length__p3__a2__assume2 (create #xFFFC)) (and (dynamic_invariant1 test_length__p3__a2__assume2 true false true true) (and (= (to_rep (first test_length__p3__a2__assume1)) #x0000) (= (to_rep (last test_length__p3__a2__assume1)) #xFFFC)))))
(assert (= result a2))
(assert (= a21 test_length__p3__a2__assume))
(assert (= (to_rep a2__first) (to_rep (first test_length__p3__a2__assume1))))
(assert (= (to_rep a2__last) (to_rep (last test_length__p3__a2__assume1))))
(assert (dynamic_property #x0000 #xFFFF (to_rep a2__first) (to_rep a2__last)))
(assert (=> (<= (bv2nat (to_rep a2__first)) (bv2nat (to_rep a2__last))) (= o (+ (- (bv2nat (to_rep a2__last)) (bv2nat (to_rep a2__first))) 1))))
(assert (=> (not (<= (bv2nat (to_rep a2__first)) (bv2nat (to_rep a2__last)))) (= o 0)))
