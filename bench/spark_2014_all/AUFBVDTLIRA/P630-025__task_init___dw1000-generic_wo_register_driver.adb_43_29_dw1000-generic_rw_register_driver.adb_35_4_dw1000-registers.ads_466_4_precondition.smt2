...
(define-fun target__ref___43__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep1 (rec__dw1000__register_types__tc_pgdelay_type__tc_pgdelay (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__tc_pgdelay_type__tc_pgdelay (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_6114 us_t1) (temp___is_init_6110 Bool) (temp___skip_constant_6111 Bool) (temp___do_toplevel_6112 Bool) (temp___do_typ_inv_6113 Bool)) Bool (=> (not (= temp___skip_constant_6111 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6114) (last3 temp___expr_6114)) (and (= (first3 temp___expr_6114) 1) (= (last3 temp___expr_6114) 1)))))
...
(define-fun register_byte_array__ref___103__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_6096 us_t2) (temp___is_init_6092 Bool) (temp___skip_constant_6093 Bool) (temp___do_toplevel_6094 Bool) (temp___do_typ_inv_6095 Bool)) Bool (=> (not (= temp___skip_constant_6093 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6096) (last5 temp___expr_6096)) (and (= (first5 temp___expr_6096) 1) (= (last5 temp___expr_6096) 1)))))
...
(declare-const temp___87991 t1)
(declare-const temp___8800 (Array Int bits_8))
(declare-const temp___88001 t2)
...
(define-fun temp___87992 () us_t1 (mk___t1 temp___8799 temp___87991))
...
(assert (and (= temp___87992 (register_to_bytes reg)) (dynamic_invariant temp___87992 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___87991)) (to_rep (last2 temp___87991))) (+ (- (to_rep (last2 temp___87991)) (to_rep (first2 temp___87991))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8799 temp___8800))
(assert (= (mk2 (to_rep (first2 temp___87991)) (to_rep (last2 temp___87991))) temp___88001))
(assert (= (ite (<= (to_rep (first4 temp___88001)) (to_rep (last4 temp___88001))) (+ (- (to_rep (last4 temp___88001)) (to_rep (first4 temp___88001))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8800 temp___88001)))
(assert (= o2 o))
