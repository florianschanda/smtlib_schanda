...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__core__message_record__value (us_split_fields1 a))) (to_rep (rec__core__message_record__value (us_split_fields1 b)))) (= (to_rep3 (rec__core__message_record__size (us_split_fields1 a))) (to_rep3 (rec__core__message_record__size (us_split_fields1 b))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_238 us_rep1) (temp___skip_top_level_239 Bool)) Bool (and (and (and (= (rec__core__mailboxT__messages (us_split_fields3 temp___expr_238)) (temp_____aggregate_def_240 (mk___rep (mk___split_fields rliteral rliteral1)))) (= (to_rep1 (rec__core__mailboxT__next_in (us_split_fields3 temp___expr_238))) #x00)) (= (to_rep1 (rec__core__mailboxT__next_out (us_split_fields3 temp___expr_238))) #x00)) (= (to_rep2 (rec__core__mailboxT__count (us_split_fields3 temp___expr_238))) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_201 (_ BitVec 8)) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (or (= temp___is_init_197 true) (bvule #x00 #x0F)) (in_range1 temp___expr_201)))
(define-fun dynamic_invariant3 ((temp___expr_208 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool) (temp___do_typ_inv_207 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 16)) (in_range2 temp___expr_208)))
...
(declare-const o1 (Array (_ BitVec 8) us_rep))
...
(declare-const result1 (Array (_ BitVec 8) us_rep))
...
(assert (= result n))
(assert (= n1 (to_rep (rec__core__message_record__value (us_split_fields1 (select self__ (to_rep1 self__2)))))))
(assert (= (to_rep1 o) (bvurem (bvadd (to_rep1 self__2) #x01) #x10)))
(assert (= self__ o1))
(assert (= self__1 o2))
(assert (= o o3))
(assert (= self__3 o4))
...
(assert (= (mk___rep1 (mk___split_fields1 self__4 self__5 self__6 self__7)) (mk___rep1 (mk___split_fields1 o5 o6 o7 o8))))
