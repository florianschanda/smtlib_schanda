...
(assert (= (ite (<= (to_rep (first2 temp___90061)) (to_rep (last2 temp___90061))) (+ (- (to_rep (last2 temp___90061)) (to_rep (first2 temp___90061))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___9006 temp___9007))
(assert (= (mk2 (to_rep (first2 temp___90061)) (to_rep (last2 temp___90061))) temp___90071))
(assert (= (ite (<= (to_rep (first4 temp___90071)) (to_rep (last4 temp___90071))) (+ (- (to_rep (last4 temp___90071)) (to_rep (first4 temp___90071))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___9007 temp___90071)))
(assert (= o2 o))
