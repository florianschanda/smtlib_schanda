...
(declare-const result2 (Array Int word32))
...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (and (= (oeq (oadd (oadd (oadd (oadd (num_of_big_int (mk___t a (mk (to_rep a__first) (to_rep a__last))) (+ a_first 1) (- i2 a_first)) (omultiply (num_of_big_int b b_first (- i2 a_first)) (from_word32 x))) (omultiply (num_of_big_int c c_first (- i2 a_first)) (from_word32 y))) (from_word32 carry1)) (omultiply (base Tuple0) (from_word32 carry2))) (oadd (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first (- i2 a_first)) (omultiply (oexpon (base Tuple0) (- i2 a_first)) (oadd (from_word32 carry11) (omultiply (base Tuple0) (from_word32 carry21)))))) true) (forall ((k1 Int)) (=> (and (<= i2 k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a1 k1)) (to_rep1 (select a k1)))))))
(assert (and (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (forall ((temp___811 Int)) (=> (and (<= (to_rep a__first) temp___811) (<= temp___811 (to_rep a__last))) (=> (or (< a_last temp___811) (or (< temp___811 a_first) (<= i2 temp___811))) (= (select a1 temp___811) (select a temp___811)))))) (and (<= a_first i2) (<= i2 a_last))))
(assert (and (= temp___797 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (and (<= (to_rep a__first) temp___797) (<= temp___797 (to_rep a__last))))
(assert (= o temp___797))
(assert (= o1 (select a1 o)))
(assert (= o2 (to_rep1 o1)))
(assert (= temp result1))
(assert (= temp1 o2))
(assert (and (= o8 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (= o9 (+ c_first o8)))
(assert (and (= temp___799 o9) (in_range1 o9)))
(assert (and (<= (to_rep (first (rt c))) temp___799) (<= temp___799 (to_rep (last (rt c))))))
(assert (= o10 temp___799))
(assert (= o11 (select (elts c) o10)))
(assert (= o12 (to_rep1 o11)))
(assert (and (= o3 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (= o4 (+ b_first o3)))
(assert (and (= temp___798 o4) (in_range1 o4)))
(assert (and (<= (to_rep (first (rt b))) temp___798) (<= temp___798 (to_rep (last (rt b))))))
(assert (= o5 temp___798))
(assert (= o6 (select (elts b) o5)))
(assert (= o7 (to_rep1 o6)))
(assert (= (oeq (oadd (oadd (oadd (oadd (from_word32 temp1) (omultiply (from_word32 o7) (from_word32 x))) (omultiply (from_word32 o12) (from_word32 y))) (from_word32 carry11)) (omultiply (base Tuple0) (from_word32 carry21))) (oadd (from_word32 temp2) (omultiply (base Tuple0) (oadd (from_word32 carry12) (omultiply (base Tuple0) (from_word32 carry22)))))) true))
(assert (= (to_rep1 o13) temp2))
(assert (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))))
(assert (= o14 i2))
(assert (= o15 (store a1 o14 o13)))
(assert (= a1 result2))
(assert (= a2 o15))
(assert (and (= o57 (+ a_last 1)) (in_range1 (+ a_last 1))))
(assert (= o58 (ite (<= k o57) true false)))
(assert (and (= o56 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o59 (ite (<= o56 k) true false)))
(assert (= result3 (ite (= o59 true) o58 false)))
(assert (= (= o60 true) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a2 k1)) (to_rep1 (select a k1)))))))
(assert (= o51 (from_word32 carry22)))
(assert (and (= o50 (base Tuple0)) (= o50 (oexpon (from_word32 #x00000002) 32))))
(assert (= o52 (omultiply o50 o51)))
(assert (= o49 (from_word32 carry12)))
(assert (= o53 (oadd o49 o52)))
(assert (and (= o44 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o45 (- o44 a_first)))
(assert (and (= o46 o45) (in_range1 o45)))
(assert (and (= o47 o46) (in_range2 o46)))
(assert (and (= o43 (base Tuple0)) (= o43 (oexpon (from_word32 #x00000002) 32))))
(assert (= o48 (oexpon o43 o47)))
(assert (= o54 (omultiply o48 o53)))
(assert (and (= o38 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o39 (- o38 a_first)))
(assert (and (= o40 o39) (in_range1 o39)))
(assert (and (= o41 o40) (in_range2 o40)))
(assert (= o42 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o41)))
(assert (= o55 (oadd o42 o54)))
(assert (= o36 (from_word32 carry2)))
(assert (and (= o35 (base Tuple0)) (= o35 (oexpon (from_word32 #x00000002) 32))))
(assert (= o37 (omultiply o35 o36)))
(assert (= o34 (from_word32 carry1)))
(assert (= o32 (from_word32 y)))
(assert (and (= o27 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o28 (- o27 a_first)))
(assert (and (= o29 o28) (in_range1 o28)))
(assert (and (= o30 o29) (in_range2 o29)))
(assert (= o31 (num_of_big_int c c_first o30)))
(assert (= o33 (omultiply o31 o32)))
(assert (= o25 (from_word32 x)))
(assert (and (= o20 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o21 (- o20 a_first)))
(assert (and (= o22 o21) (in_range1 o21)))
(assert (and (= o23 o22) (in_range2 o22)))
(assert (= o24 (num_of_big_int b b_first o23)))
(assert (= o26 (omultiply o24 o25)))
(assert (and (= o16 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o17 (- o16 a_first)))
(assert (and (= o18 o17) (in_range1 o17)))
(assert (and (= o19 o18) (in_range2 o18)))
(assert (not (in_range1 (+ a_first 1))))
(check-sat)
(exit)
