...
(declare-datatypes () ((tS8bP1__ref (mk_tS8bP1__ref (tS8bP1__content tdigit_count_typeB)))))
(define-fun tS8bP1__ref___projection ((a tS8bP1__ref)) tdigit_count_typeB (tS8bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((s8b__ref (mk_s8b__ref (s8b__content us_t1)))))
(define-fun s8b__ref___projection ((a s8b__ref)) us_t1 (s8b__content a))
...
(declare-datatypes () ((t10b__ref (mk_t10b__ref (t10b__content tdigit_count_typeB)))))
(define-fun t10b__ref___projection ((a t10b__ref)) tdigit_count_typeB (t10b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t12b__ref (mk_t12b__ref (t12b__content tdigit_count_typeB)))))
(define-fun t12b__ref___projection ((a t12b__ref)) tdigit_count_typeB (t12b__content a))
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-fun temp_____aggregate_def_1191 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(define-fun dynamic_property7 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range2 low) (and (in_range2 high) (=> (<= low high) (and (in_range1 low) (in_range1 high))))))
...
(assert (forall ((temp___1193 (_ BitVec 8))) (forall ((temp___1194 Int) (temp___1195 Int)) (let ((temp___1192 (temp_____aggregate_def_1191 temp___1193 temp___1194 temp___1195))) (=> (dynamic_invariant temp___1193 true true true true) (and (=> (dynamic_property7 1 65536 temp___1194 temp___1195) (and (= (first5 temp___1192) temp___1194) (= (last5 temp___1192) temp___1195))) (forall ((temp___1196 Int)) (= (to_rep2 (select (to_array2 temp___1192) temp___1196)) temp___1193))))))))
(define-fun dynamic_invariant5 ((temp___expr_242 us_t3) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (not (= temp___skip_constant_239 true)) (dynamic_property7 1 65536 (first7 temp___expr_242) (last7 temp___expr_242))))
(define-fun dynamic_invariant6 ((temp___expr_373 us_t1) (temp___is_init_369 Bool) (temp___skip_constant_370 Bool) (temp___do_toplevel_371 Bool) (temp___do_typ_inv_372 Bool)) Bool (=> (not (= temp___skip_constant_370 true)) (and (dynamic_property3 1 r9b (first3 temp___expr_373) (last3 temp___expr_373)) (and (= (first3 temp___expr_373) 1) (= (last3 temp___expr_373) r9b)))))
...
(declare-const i Int)
(declare-const temp___1198 (Array Int octet))
(declare-const temp___11981 t2)
(declare-const temp___1199 (Array Int octet))
(declare-const temp___11991 t1)
(declare-const temp___1201 (Array Int octet))
(declare-const temp___12011 t1)
(declare-const o (Array Int octet))
(declare-const o1 t)
(declare-const o2 (Array Int octet))
(declare-const o3 t)
(declare-const temp___1203 digit_index_type)
(declare-const temp___12031 (Array Int octet))
(declare-const temp___12032 t)
...
(declare-const o18 t)
(declare-const o19 (Array Int octet))
(declare-const o20 t)
(declare-const temp___1210 us_rep)
...
(assert (and (= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))) (= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length result____split_discrs)))))
(assert (= (to_rep (rec__very_longs__very_long__length result____split_discrs)) r9b))
(assert (in_range1 r9b))
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_1191 #x00 1 r9b)))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_1191 #x00 1 r9b)))) r9b))
(assert (= (mk___t2 temp___1198 temp___11981) (temp_____aggregate_def_1191 #x00 1 r9b)))
(assert (= (ite (<= (to_rep1 (first4 temp___11981)) (to_rep1 (last4 temp___11981))) (+ (- (to_rep1 (last4 temp___11981)) (to_rep1 (first4 temp___11981))) 1) 0) (ite (<= 1 r9b) (+ (- r9b 1) 1) 0)))
(assert (= temp___1198 temp___1199))
(assert (= (mk1 (to_rep1 (first4 temp___11981)) (to_rep1 (last4 temp___11981))) temp___11991))
(assert (= (ite (<= (to_rep1 (first2 temp___11991)) (to_rep1 (last2 temp___11991))) (+ (- (to_rep1 (last2 temp___11991)) (to_rep1 (first2 temp___11991))) 1) 0) (ite (<= (to_rep1 (first result____split_fields1)) (to_rep1 (last result____split_fields1))) (+ (- (to_rep1 (last result____split_fields1)) (to_rep1 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1201 temp___12011) (mk___t1 temp___1199 temp___11991)))
(assert (= temp___1201 o))
(assert (= (mk (to_rep1 (first2 temp___12011)) (to_rep1 (last2 temp___12011))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1203)))
(assert (= temp___12031 o2))
(assert (= temp___12032 o3))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___12031 temp___12032))))
(assert (= result____split_discrs (mk___split_discrs temp___1203)))
...
(assert (and (= (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r)))))) (= (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) (to_rep1 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))))
(assert (and (and (and (=> (<= 1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))) (dynamic_property6 1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) i2)) (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true true)) (forall ((temp___1214 Int)) (=> (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1214) (<= temp___1214 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (or (< (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) temp___1214) (or (< temp___1214 1) (<= i2 temp___1214))) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1214) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1214)))))) (and (<= 1 i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (= l_digit1 o7))
(assert (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))) i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))))
(assert (= o8 i2))
...
(assert (= result4 (mk_t__ref1 r_digit)))
(assert (= r_digit1 o11))
(assert (= result5 (mk_t__ref1 sum)))
(assert (= sum1 (bvadd (bvadd l_digit1 r_digit1) carry2)))
(assert (and (= o12 (shift_right sum1 8)) (= o12 (bvudiv sum1 (ite (< 8 65536) (bvshl #x0001 ((_ int2bv 16) 8)) #x0000)))))
(assert (= result6 (mk_t__ref1 carry2)))
(assert (= carry3 o12))
(assert (= o13 (takelsb_from16 sum1)))
...
(assert (= o16 o17))
(assert (= (rt (rec__very_longs__very_long__long_digits result____split_fields3)) o18))
(assert (= o19 o17))
(assert (= o20 o18))
(assert (= temp___1210 (mk___rep result____split_discrs (mk___split_fields (mk___t o19 o20)))))
(assert (= result7 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___1210)))
(assert (= result____split_discrs (us_split_discrs1 temp___1210)))
(assert (not (= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))))
(assert (= result8 (mk_int__ref i2)))
(assert (= i3 (+ i2 1)))
(assert (not (= (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) (to_rep1 (last (rt (rec__very_longs__very_long__long_digits result____split_fields4)))))))
(check-sat)
(exit)
