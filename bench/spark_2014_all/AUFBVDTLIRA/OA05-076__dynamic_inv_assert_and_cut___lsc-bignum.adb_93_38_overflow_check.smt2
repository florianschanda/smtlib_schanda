...
(assert (= result2 (ite (not (= o24 true)) true false)))
(assert (=> (= result2 true) (and (<= (to_rep b__first) k) (<= k (to_rep b__last)))))
(assert (=> (= result2 true) (= o27 k)))
(assert (=> (= result2 true) (= o28 (select b o27))))
(assert (=> (= result2 true) (= o29 (to_rep1 o28))))
(assert (=> (= result2 true) (and (<= (to_rep b__first) k) (<= k (to_rep b__last)))))
(assert (=> (= result2 true) (= o25 k)))
(assert (=> (= result2 true) (= o26 (select b2 o25))))
(assert (=> (= result2 true) (= o30 (to_rep1 o26))))
(assert (=> (= result2 true) (= o31 (ite (= o30 o29) true false))))
(assert (=> (not (= result2 true)) (= o31 (distinct 1 0))))
...
(assert (= result3 true))
(assert (not (in_range1 (+ a_first k))))
(check-sat)
(exit)
