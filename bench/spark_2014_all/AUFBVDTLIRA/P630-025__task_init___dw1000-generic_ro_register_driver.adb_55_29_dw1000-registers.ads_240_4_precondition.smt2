...
(define-fun in_range6 ((x (_ BitVec 16))) Bool (and (bvule #x0000 x) (bvule x #x0FFF)))
...
(assert (forall ((x bits_12)) (! (in_range6 (to_rep6 x)) :pattern ((to_rep6 x)))))
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x #x1000))) (=> (in_range6 y) (= (to_rep6 (of_rep6 x)) y))) :pattern ((to_rep6 (of_rep6 x))))))
...
(define-fun register_type__ref___31__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___22__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___22__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_3155 us_t1) (temp___is_init_3151 Bool) (temp___skip_constant_3152 Bool) (temp___do_toplevel_3153 Bool) (temp___do_typ_inv_3154 Bool)) Bool (=> (not (= temp___skip_constant_3152 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3155) (last3 temp___expr_3155)) (and (= (first3 temp___expr_3155) 1) (= (last3 temp___expr_3155) 4)))))
