...
(define-fun target__ref___44__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep1 (rec__dw1000__register_types__tc_pgtest_type__tc_pgtest (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__tc_pgtest_type__tc_pgtest (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_6178 us_t1) (temp___is_init_6174 Bool) (temp___skip_constant_6175 Bool) (temp___do_toplevel_6176 Bool) (temp___do_typ_inv_6177 Bool)) Bool (=> (not (= temp___skip_constant_6175 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6178) (last3 temp___expr_6178)) (and (= (first3 temp___expr_6178) 1) (= (last3 temp___expr_6178) 1)))))
...
(define-fun register_byte_array__ref___105__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_6160 us_t2) (temp___is_init_6156 Bool) (temp___skip_constant_6157 Bool) (temp___do_toplevel_6158 Bool) (temp___do_typ_inv_6159 Bool)) Bool (=> (not (= temp___skip_constant_6157 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6160) (last5 temp___expr_6160)) (and (= (first5 temp___expr_6160) 1) (= (last5 temp___expr_6160) 1)))))
...
(declare-const temp___88061 t1)
(declare-const temp___8807 (Array Int bits_8))
(declare-const temp___88071 t2)
...
(define-fun temp___88062 () us_t1 (mk___t1 temp___8806 temp___88061))
...
(assert (and (= temp___88062 (register_to_bytes reg)) (dynamic_invariant temp___88062 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___88061)) (to_rep (last2 temp___88061))) (+ (- (to_rep (last2 temp___88061)) (to_rep (first2 temp___88061))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8806 temp___8807))
(assert (= (mk2 (to_rep (first2 temp___88061)) (to_rep (last2 temp___88061))) temp___88071))
(assert (= (ite (<= (to_rep (first4 temp___88071)) (to_rep (last4 temp___88071))) (+ (- (to_rep (last4 temp___88071)) (to_rep (first4 temp___88071))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8807 temp___88071)))
(assert (= o2 o))
