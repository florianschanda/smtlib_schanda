...
(define-fun target__ref___35__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__drx_sfdtoc_type__drx_sfdtoc (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__drx_sfdtoc_type__drx_sfdtoc (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_5499 us_t1) (temp___is_init_5495 Bool) (temp___skip_constant_5496 Bool) (temp___do_toplevel_5497 Bool) (temp___do_typ_inv_5498 Bool)) Bool (=> (not (= temp___skip_constant_5496 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5499) (last3 temp___expr_5499)) (and (= (first3 temp___expr_5499) 1) (= (last3 temp___expr_5499) 2)))))
...
(define-fun register_byte_array__ref___83__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_5481 us_t2) (temp___is_init_5477 Bool) (temp___skip_constant_5478 Bool) (temp___do_toplevel_5479 Bool) (temp___do_typ_inv_5480 Bool)) Bool (=> (not (= temp___skip_constant_5478 true)) (and (dynamic_property3 1 2 (first5 temp___expr_5481) (last5 temp___expr_5481)) (and (= (first5 temp___expr_5481) 1) (= (last5 temp___expr_5481) 2)))))
...
(declare-const temp___87351 t1)
(declare-const temp___8736 (Array Int bits_8))
(declare-const temp___87361 t2)
(define-fun temp___87352 () us_t1 (mk___t1 temp___8735 temp___87351))
...
(assert (and (= temp___87352 (register_to_bytes reg)) (dynamic_invariant temp___87352 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___87351)) (to_rep (last2 temp___87351))) (+ (- (to_rep (last2 temp___87351)) (to_rep (first2 temp___87351))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8735 temp___8736))
(assert (= (mk2 (to_rep (first2 temp___87351)) (to_rep (last2 temp___87351))) temp___87361))
(assert (not (= (ite (<= (to_rep (first4 temp___87361)) (to_rep (last4 temp___87361))) (+ (- (to_rep (last4 temp___87361)) (to_rep (first4 temp___87361))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
