...
(define-fun tregister_byte_arrayP1__ref___5__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___2__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun to_int4 ((x bits_16)) Int (bv2nat (to_rep2 x)))
(assert (forall ((x bits_16)) (! (uint_in_range1 (to_int4 x)) :pattern ((to_int4 x)))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__panadr_type__short_addr bits_16) (rec__dw1000__register_types__panadr_type__pan_id bits_16)))))
(define-fun us_split_fields_SHORT_ADDR__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__panadr_type__short_addr a))
(define-fun us_split_fields_PAN_ID__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__panadr_type__pan_id a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__dw1000__register_types__panadr_type__short_addr (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__panadr_type__short_addr (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__panadr_type__pan_id (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__panadr_type__pan_id (us_split_fields1 b))))) true false))
...
(declare-const dw1000__register_types__panadr_type__short_addr__first__bit Int)
(declare-const dw1000__register_types__panadr_type__short_addr__last__bit Int)
(declare-const dw1000__register_types__panadr_type__short_addr__position Int)
(assert (<= 0 dw1000__register_types__panadr_type__short_addr__first__bit))
(assert (< dw1000__register_types__panadr_type__short_addr__first__bit dw1000__register_types__panadr_type__short_addr__last__bit))
(assert (<= 0 dw1000__register_types__panadr_type__short_addr__position))
(declare-const dw1000__register_types__panadr_type__pan_id__first__bit Int)
(declare-const dw1000__register_types__panadr_type__pan_id__last__bit Int)
(declare-const dw1000__register_types__panadr_type__pan_id__position Int)
(assert (<= 0 dw1000__register_types__panadr_type__pan_id__first__bit))
(assert (< dw1000__register_types__panadr_type__pan_id__first__bit dw1000__register_types__panadr_type__pan_id__last__bit))
(assert (<= 0 dw1000__register_types__panadr_type__pan_id__position))
(declare-fun user_eq7 (us_rep us_rep) Bool)
(declare-const dummy7 us_rep)
(declare-datatypes () ((panadr_type__ref (mk_panadr_type__ref (panadr_type__content us_rep)))))
(define-fun panadr_type__ref___projection ((a panadr_type__ref)) us_rep (panadr_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___2__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_2178 us_t1) (temp___is_init_2174 Bool) (temp___skip_constant_2175 Bool) (temp___do_toplevel_2176 Bool) (temp___do_typ_inv_2177 Bool)) Bool (=> (not (= temp___skip_constant_2175 true)) (and (dynamic_property2 1 4 (first3 temp___expr_2178) (last3 temp___expr_2178)) (and (= (first3 temp___expr_2178) 1) (= (last3 temp___expr_2178) 4)))))
...
(define-fun register_type__ref___7__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___5__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_2159 us_t2) (temp___is_init_2155 Bool) (temp___skip_constant_2156 Bool) (temp___do_toplevel_2157 Bool) (temp___do_typ_inv_2158 Bool)) Bool (=> (not (= temp___skip_constant_2156 true)) (and (dynamic_property3 1 4 (first5 temp___expr_2159) (last5 temp___expr_2159)) (and (= (first5 temp___expr_2159) 1) (= (last5 temp___expr_2159) 4)))))
...
(declare-const temp___8472 (Array Int bits_8))
(declare-const temp___84721 t1)
(declare-const temp___8473 (Array Int bits_8))
(declare-const temp___84731 t2)
...
(define-fun temp___84722 () us_t1 (mk___t1 temp___8472 temp___84721))
...
(assert (and (= temp___84722 (register_to_bytes reg)) (dynamic_invariant temp___84722 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___84721)) (to_rep (last2 temp___84721))) (+ (- (to_rep (last2 temp___84721)) (to_rep (first2 temp___84721))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8472 temp___8473))
(assert (= (mk2 (to_rep (first2 temp___84721)) (to_rep (last2 temp___84721))) temp___84731))
(assert (= (ite (<= (to_rep (first4 temp___84731)) (to_rep (last4 temp___84731))) (+ (- (to_rep (last4 temp___84731)) (to_rep (first4 temp___84731))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8473 temp___84731)))
(assert (= o2 o))
