...
(assert (forall ((n Int)) (forall ((untangle__g Bool)) (! (=> (and (dynamic_invariant n true true true true) (= untangle__g true)) (dynamic_invariant (wibble n untangle__g) true false true true)) :pattern ((wibble n untangle__g))))))
(assert (forall ((n Int)) (forall ((untangle__g Bool)) (! (=> (dynamic_invariant n true true true true) (= (wibble n untangle__g) n)) :pattern ((wibble n untangle__g))))))
(declare-sort byte 0)
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__untangle__word_a__lo byte) (rec__untangle__word_a__hi byte)))))
(define-fun us_split_fields_Lo__projection ((a us_split_fields)) byte (rec__untangle__word_a__lo a))
(define-fun us_split_fields_Hi__projection ((a us_split_fields)) byte (rec__untangle__word_a__hi a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__untangle__word_a__lo (us_split_fields1 a))) (to_rep (rec__untangle__word_a__lo (us_split_fields1 b)))) (= (to_rep (rec__untangle__word_a__hi (us_split_fields1 a))) (to_rep (rec__untangle__word_a__hi (us_split_fields1 b))))) true false))
...
(assert (< untangle__word_a__lo__first__bit untangle__word_a__lo__last__bit))
...
(assert (< untangle__word_a__hi__first__bit untangle__word_a__hi__last__bit))
(assert (<= 0 untangle__word_a__hi__position))
(declare-fun user_eq2 (us_rep us_rep) Bool)
(declare-const dummy2 us_rep)
(declare-datatypes () ((word_a__ref (mk_word_a__ref (word_a__content us_rep)))))
(define-fun word_a__ref___projection ((a word_a__ref)) us_rep (word_a__content a))
(declare-sort tword_arrayD1 0)
(declare-fun tword_arrayD1qtint (tword_arrayD1) Int)
(assert (forall ((i tword_arrayD1)) (and (<= 1 (tword_arrayD1qtint i)) (<= (tword_arrayD1qtint i) 10))))
...
(declare-datatypes () ((tword_arrayD1__ref (mk_tword_arrayD1__ref (tword_arrayD1__content tword_arrayD1)))))
(define-fun tword_arrayD1__ref___projection ((a tword_arrayD1__ref)) tword_arrayD1 (tword_arrayD1__content a))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__untangle__thing__a Bool) (rec__untangle__thing__b (Array Int us_rep)) (rec__untangle__thing__c Bool)))))
(define-fun us_split_fields_A__projection ((a us_split_fields2)) Bool (rec__untangle__thing__a a))
(define-fun us_split_fields_B__projection ((a us_split_fields2)) (Array Int us_rep) (rec__untangle__thing__b a))
(define-fun us_split_fields_C__projection ((a us_split_fields2)) Bool (rec__untangle__thing__c a))
...
(define-fun bool_eq2 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (rec__untangle__thing__a (us_split_fields3 a)) (rec__untangle__thing__a (us_split_fields3 b))) (= (bool_eq1 (rec__untangle__thing__b (us_split_fields3 a)) 1 10 (rec__untangle__thing__b (us_split_fields3 b)) 1 10) true)) (= (rec__untangle__thing__c (us_split_fields3 a)) (rec__untangle__thing__c (us_split_fields3 b)))) true false))
...
(declare-datatypes () ((thing__ref (mk_thing__ref (thing__content us_rep1)))))
(define-fun thing__ref___projection ((a thing__ref)) us_rep1 (thing__content a))
(define-fun in_range2 ((x Int)) Bool (or (= x 0) (= x 1)))
(declare-fun attr__ATTRIBUTE_IMAGE3 (Bool) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Bool)
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__untangle__optional_thing__exists Bool)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) Bool (rec__untangle__optional_thing__exists a))
(declare-datatypes () ((us_split_discrs__ref (mk___split_discrs__ref (us_split_discrs__content us_split_discrs)))))
(define-fun us_split_discrs__ref___projection ((a us_split_discrs__ref)) us_split_discrs (us_split_discrs__content a))
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__untangle__optional_thing__t us_rep1)))))
(define-fun us_split_fields_T__projection ((a us_split_fields4)) us_rep1 (rec__untangle__optional_thing__t a))
...
(define-fun untangle__optional_thing__t__pred ((a us_rep2)) Bool (= (ite (rec__untangle__optional_thing__exists (us_split_discrs1 a)) 1 0) 1))
(define-fun bool_eq3 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (rec__untangle__optional_thing__exists (us_split_discrs1 a)) (rec__untangle__optional_thing__exists (us_split_discrs1 b))) (=> (untangle__optional_thing__t__pred a) (= (bool_eq2 (rec__untangle__optional_thing__t (us_split_fields5 a)) (rec__untangle__optional_thing__t (us_split_fields5 b))) true))) true false))
...
(assert (< untangle__optional_thing__exists__first__bit untangle__optional_thing__exists__last__bit))
...
(assert (< untangle__optional_thing__t__first__bit untangle__optional_thing__t__last__bit))
(assert (<= 0 untangle__optional_thing__t__position))
(declare-fun user_eq6 (us_rep2 us_rep2) Bool)
(declare-const dummy6 us_rep2)
(declare-datatypes () ((optional_thing__ref (mk_optional_thing__ref (optional_thing__content us_rep2)))))
(define-fun optional_thing__ref___projection ((a optional_thing__ref)) us_rep2 (optional_thing__content a))
(define-fun default_initial_assumption ((temp___expr_212 us_rep2) (temp___skip_top_level_213 Bool)) Bool (and (= (attr__constrained temp___expr_212) false) (= (rec__untangle__optional_thing__exists (us_split_discrs1 temp___expr_212)) (distinct 0 0))))
...
(assert (in_range n))
(assert (= (to_rep o) #x00))
(assert (= (rec__untangle__word_a__lo (us_split_fields1 (select x__split_fields (wibble n g)))) o1))
(assert (= o o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (not (= g true)))
