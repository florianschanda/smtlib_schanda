...
(assert (= memory4 o7))
(assert (= (to_rep o8) ((_ extract 7 0) (bvurem (bvudiv val__ #x0000000100000000) #x0000000000000100))))
(assert (= o9 (store memory4 (bvadd addr #x0000000000000004) o8)))
(assert (= memory4 result4))
(assert (= memory5 o9))
(assert (= (to_rep o10) ((_ extract 7 0) (bvurem (bvudiv val__ #x0000010000000000) #x0000000000000100))))
