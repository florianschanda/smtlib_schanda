...
(declare-fun acc_mem_number_typeqtint (acc_mem_number_type) Int)
(assert (forall ((i acc_mem_number_type)) (and (<= (- 32768) (acc_mem_number_typeqtint i)) (<= (acc_mem_number_typeqtint i) 32767))))
...
(define-fun to_rep2 ((x acc_mem_number_type)) Int (acc_mem_number_typeqtint x))
