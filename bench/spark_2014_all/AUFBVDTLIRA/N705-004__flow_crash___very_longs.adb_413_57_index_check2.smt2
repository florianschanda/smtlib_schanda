...
(assert (<= 1 i1))
(assert (<= i1 r130b))
(assert (and (and (dynamic_invariant2 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true true) (forall ((temp___1350 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1350) (<= temp___1350 (to_rep1 (last number__split_fields3)))) (=> (or (< r130b temp___1350) (or (< temp___1350 1) (<= temp___1350 i2))) (= (select number__split_fields2 temp___1350) (select number__split_fields temp___1350)))))) (and (<= 1 i2) (<= i2 r130b))))
...
(assert (= o14 o12))
(assert (= o15 o13))
(assert (= number__split_discrs (mk___split_discrs temp___1343)))
(assert (= temp___13431 o14))
(assert (= temp___13432 o15))
(assert (= result4 number__split_fields2))
(assert (= result5 number__split_fields3))
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___13431 temp___13432))))
(assert (= number__split_discrs (mk___split_discrs temp___1343)))
(assert (=> (< (- 8 distance) 8) (= o16 (bvshl old_overflow2 ((_ int2bv 8) (- 8 distance))))))
(assert (=> (not (< (- 8 distance) 8)) (= o16 #x00)))
