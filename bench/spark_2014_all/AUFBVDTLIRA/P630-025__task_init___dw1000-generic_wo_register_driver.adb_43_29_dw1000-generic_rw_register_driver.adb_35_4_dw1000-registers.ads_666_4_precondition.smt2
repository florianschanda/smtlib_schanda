...
(define-fun tregister_byte_arrayP1__ref___167__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___67__projection ((a target__ref)) us_t1 (target__content a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__pmsc_ctrl1_type__arx2init bits_1) (rec__dw1000__register_types__pmsc_ctrl1_type__pktseq bits_8) (rec__dw1000__register_types__pmsc_ctrl1_type__atxslp bits_1) (rec__dw1000__register_types__pmsc_ctrl1_type__arxslp bits_1) (rec__dw1000__register_types__pmsc_ctrl1_type__snoze bits_1) (rec__dw1000__register_types__pmsc_ctrl1_type__snozr bits_1) (rec__dw1000__register_types__pmsc_ctrl1_type__pllsyn bits_1) (rec__dw1000__register_types__pmsc_ctrl1_type__lderune bits_1) (rec__dw1000__register_types__pmsc_ctrl1_type__khzclkdiv bits_6) (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_1 bits_1) (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_2 bits_1) (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_3 bits_1) (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_4 bits_8)))))
(define-fun us_split_fields_ARX2INIT__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__pmsc_ctrl1_type__arx2init a))
(define-fun us_split_fields_PKTSEQ__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__pmsc_ctrl1_type__pktseq a))
(define-fun us_split_fields_ATXSLP__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__pmsc_ctrl1_type__atxslp a))
(define-fun us_split_fields_ARXSLP__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__pmsc_ctrl1_type__arxslp a))
(define-fun us_split_fields_SNOZE__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__pmsc_ctrl1_type__snoze a))
(define-fun us_split_fields_SNOZR__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__pmsc_ctrl1_type__snozr a))
(define-fun us_split_fields_PLLSYN__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__pmsc_ctrl1_type__pllsyn a))
(define-fun us_split_fields_LDERUNE__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__pmsc_ctrl1_type__lderune a))
(define-fun us_split_fields_KHZCLKDIV__projection ((a us_split_fields)) bits_6 (rec__dw1000__register_types__pmsc_ctrl1_type__khzclkdiv a))
(define-fun us_split_fields_Reserved_1__17__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_1 a))
(define-fun us_split_fields_Reserved_2__17__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_2 a))
(define-fun us_split_fields_Reserved_3__6__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_3 a))
(define-fun us_split_fields_Reserved_4__3__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_4 a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___102__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___102__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__arx2init (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__arx2init (us_split_fields1 b)))) (= (to_rep1 (rec__dw1000__register_types__pmsc_ctrl1_type__pktseq (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__pmsc_ctrl1_type__pktseq (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__atxslp (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__atxslp (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__arxslp (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__arxslp (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__snoze (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__snoze (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__snozr (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__snozr (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__pllsyn (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__pllsyn (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__lderune (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__lderune (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__pmsc_ctrl1_type__khzclkdiv (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__pmsc_ctrl1_type__khzclkdiv (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_1 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_1 (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_2 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_2 (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_3 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_3 (us_split_fields1 b))))) (= (to_rep1 (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_4 (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__pmsc_ctrl1_type__reserved_4 (us_split_fields1 b))))) true false))
...
(declare-datatypes () ((pmsc_ctrl1_type__ref (mk_pmsc_ctrl1_type__ref (pmsc_ctrl1_type__content us_rep)))))
(define-fun pmsc_ctrl1_type__ref___projection ((a pmsc_ctrl1_type__ref)) us_rep (pmsc_ctrl1_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___67__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_8242 us_t1) (temp___is_init_8238 Bool) (temp___skip_constant_8239 Bool) (temp___do_toplevel_8240 Bool) (temp___do_typ_inv_8241 Bool)) Bool (=> (not (= temp___skip_constant_8239 true)) (and (dynamic_property2 1 4 (first3 temp___expr_8242) (last3 temp___expr_8242)) (and (= (first3 temp___expr_8242) 1) (= (last3 temp___expr_8242) 4)))))
...
(define-fun register_type__ref___233__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___167__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_8212 us_t2) (temp___is_init_8208 Bool) (temp___skip_constant_8209 Bool) (temp___do_toplevel_8210 Bool) (temp___do_typ_inv_8211 Bool)) Bool (=> (not (= temp___skip_constant_8209 true)) (and (dynamic_property3 1 4 (first5 temp___expr_8212) (last5 temp___expr_8212)) (and (= (first5 temp___expr_8212) 1) (= (last5 temp___expr_8212) 4)))))
...
(declare-const temp___8999 (Array Int bits_8))
(declare-const temp___89991 t1)
(declare-const temp___9000 (Array Int bits_8))
(declare-const temp___90001 t2)
...
(define-fun temp___89992 () us_t1 (mk___t1 temp___8999 temp___89991))
...
(assert (and (= temp___89992 (register_to_bytes reg)) (dynamic_invariant temp___89992 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___89991)) (to_rep (last2 temp___89991))) (+ (- (to_rep (last2 temp___89991)) (to_rep (first2 temp___89991))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8999 temp___9000))
(assert (= (mk2 (to_rep (first2 temp___89991)) (to_rep (last2 temp___89991))) temp___90001))
(assert (= (ite (<= (to_rep (first4 temp___90001)) (to_rep (last4 temp___90001))) (+ (- (to_rep (last4 temp___90001)) (to_rep (first4 temp___90001))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___9000 temp___90001)))
(assert (= o2 o))
