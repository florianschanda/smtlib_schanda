...
(define-fun target__ref___59__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (= (to_rep2 (rec__dw1000__register_types__otp_sf_type__ops_kick (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__otp_sf_type__ops_kick (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__otp_sf_type__ldo_kick (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__otp_sf_type__ldo_kick (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__otp_sf_type__ops_sel (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__otp_sf_type__ops_sel (us_split_fields1 b))))) (= (to_rep4 (rec__dw1000__register_types__otp_sf_type__reserved_1 (us_split_fields1 a))) (to_rep4 (rec__dw1000__register_types__otp_sf_type__reserved_1 (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__otp_sf_type__reserved_2 (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__otp_sf_type__reserved_2 (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant ((temp___expr_7320 us_t1) (temp___is_init_7316 Bool) (temp___skip_constant_7317 Bool) (temp___do_toplevel_7318 Bool) (temp___do_typ_inv_7319 Bool)) Bool (=> (not (= temp___skip_constant_7317 true)) (and (dynamic_property2 1 1 (first3 temp___expr_7320) (last3 temp___expr_7320)) (and (= (first3 temp___expr_7320) 1) (= (last3 temp___expr_7320) 1)))))
...
(define-fun register_byte_array__ref___136__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_7298 us_t2) (temp___is_init_7294 Bool) (temp___skip_constant_7295 Bool) (temp___do_toplevel_7296 Bool) (temp___do_typ_inv_7297 Bool)) Bool (=> (not (= temp___skip_constant_7295 true)) (and (dynamic_property3 1 1 (first5 temp___expr_7298) (last5 temp___expr_7298)) (and (= (first5 temp___expr_7298) 1) (= (last5 temp___expr_7298) 1)))))
...
(declare-const temp___89131 t1)
(declare-const temp___8914 (Array Int bits_8))
(declare-const temp___89141 t2)
...
(define-fun temp___89132 () us_t1 (mk___t1 temp___8913 temp___89131))
...
(assert (and (= temp___89132 (register_to_bytes reg)) (dynamic_invariant temp___89132 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___89131)) (to_rep (last2 temp___89131))) (+ (- (to_rep (last2 temp___89131)) (to_rep (first2 temp___89131))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8913 temp___8914))
(assert (= (mk2 (to_rep (first2 temp___89131)) (to_rep (last2 temp___89131))) temp___89141))
(assert (= (ite (<= (to_rep (first4 temp___89141)) (to_rep (last4 temp___89141))) (+ (- (to_rep (last4 temp___89141)) (to_rep (first4 temp___89141))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8914 temp___89141)))
(assert (= o2 o))
