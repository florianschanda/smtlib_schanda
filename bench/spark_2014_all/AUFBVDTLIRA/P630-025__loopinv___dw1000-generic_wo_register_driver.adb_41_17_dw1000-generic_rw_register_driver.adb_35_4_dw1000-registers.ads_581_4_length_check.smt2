...
(define-fun tregister_byte_arrayP1__ref___145__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___62__projection ((a target__ref)) us_t1 (target__content a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__lde_cfg2_type__lde_cfg2 bits_16)))))
(define-fun us_split_fields_LDE_CFG2__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__lde_cfg2_type__lde_cfg2 a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___85__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___85__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__lde_cfg2_type__lde_cfg2 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__lde_cfg2_type__lde_cfg2 (us_split_fields1 b)))) true false))
...
(assert (< dw1000__register_types__lde_cfg2_type__lde_cfg2__first__bit dw1000__register_types__lde_cfg2_type__lde_cfg2__last__bit))
(assert (<= 0 dw1000__register_types__lde_cfg2_type__lde_cfg2__position))
(declare-fun user_eq7 (us_rep us_rep) Bool)
(declare-const dummy7 us_rep)
(declare-datatypes () ((lde_cfg2_type__ref (mk_lde_cfg2_type__ref (lde_cfg2_type__content us_rep)))))
(define-fun lde_cfg2_type__ref___projection ((a lde_cfg2_type__ref)) us_rep (lde_cfg2_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___62__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_7570 us_t1) (temp___is_init_7566 Bool) (temp___skip_constant_7567 Bool) (temp___do_toplevel_7568 Bool) (temp___do_typ_inv_7569 Bool)) Bool (=> (not (= temp___skip_constant_7567 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7570) (last3 temp___expr_7570)) (and (= (first3 temp___expr_7570) 1) (= (last3 temp___expr_7570) 2)))))
...
(define-fun register_type__ref___206__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___145__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_7552 us_t2) (temp___is_init_7548 Bool) (temp___skip_constant_7549 Bool) (temp___do_toplevel_7550 Bool) (temp___do_typ_inv_7551 Bool)) Bool (=> (not (= temp___skip_constant_7549 true)) (and (dynamic_property3 1 2 (first5 temp___expr_7552) (last5 temp___expr_7552)) (and (= (first5 temp___expr_7552) 1) (= (last5 temp___expr_7552) 2)))))
...
(declare-const temp___8940 (Array Int bits_8))
(declare-const temp___89401 t1)
(declare-const temp___8941 (Array Int bits_8))
(declare-const temp___89411 t2)
(define-fun temp___89402 () us_t1 (mk___t1 temp___8940 temp___89401))
...
(assert (and (= temp___89402 (register_to_bytes reg)) (dynamic_invariant temp___89402 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___89401)) (to_rep (last2 temp___89401))) (+ (- (to_rep (last2 temp___89401)) (to_rep (first2 temp___89401))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8940 temp___8941))
(assert (= (mk2 (to_rep (first2 temp___89401)) (to_rep (last2 temp___89401))) temp___89411))
(assert (not (= (ite (<= (to_rep (first4 temp___89411)) (to_rep (last4 temp___89411))) (+ (- (to_rep (last4 temp___89411)) (to_rep (first4 temp___89411))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
