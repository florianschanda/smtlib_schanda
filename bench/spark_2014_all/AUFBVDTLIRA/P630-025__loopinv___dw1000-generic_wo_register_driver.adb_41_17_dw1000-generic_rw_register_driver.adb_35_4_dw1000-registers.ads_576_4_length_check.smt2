...
(define-fun target__ref___61__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__lde_rxantd_type__lde_rxantd (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__lde_rxantd_type__lde_rxantd (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_7506 us_t1) (temp___is_init_7502 Bool) (temp___skip_constant_7503 Bool) (temp___do_toplevel_7504 Bool) (temp___do_typ_inv_7505 Bool)) Bool (=> (not (= temp___skip_constant_7503 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7506) (last3 temp___expr_7506)) (and (= (first3 temp___expr_7506) 1) (= (last3 temp___expr_7506) 2)))))
...
(define-fun register_byte_array__ref___143__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_7488 us_t2) (temp___is_init_7484 Bool) (temp___skip_constant_7485 Bool) (temp___do_toplevel_7486 Bool) (temp___do_typ_inv_7487 Bool)) Bool (=> (not (= temp___skip_constant_7485 true)) (and (dynamic_property3 1 2 (first5 temp___expr_7488) (last5 temp___expr_7488)) (and (= (first5 temp___expr_7488) 1) (= (last5 temp___expr_7488) 2)))))
...
(declare-const temp___89331 t1)
(declare-const temp___8934 (Array Int bits_8))
(declare-const temp___89341 t2)
(define-fun temp___89332 () us_t1 (mk___t1 temp___8933 temp___89331))
...
(assert (and (= temp___89332 (register_to_bytes reg)) (dynamic_invariant temp___89332 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___89331)) (to_rep (last2 temp___89331))) (+ (- (to_rep (last2 temp___89331)) (to_rep (first2 temp___89331))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8933 temp___8934))
(assert (= (mk2 (to_rep (first2 temp___89331)) (to_rep (last2 temp___89331))) temp___89341))
(assert (not (= (ite (<= (to_rep (first4 temp___89341)) (to_rep (last4 temp___89341))) (+ (- (to_rep (last4 temp___89341)) (to_rep (first4 temp___89341))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
