...
(assert (=> (= (length1 temp___313) 0) (= temp___315 (mk___t1 (elts1 temp___314) (mk1 (to_rep3 (first2 (rt1 temp___314))) (to_rep3 (last2 (rt1 temp___314))))))))
(assert (=> (not (= (length1 temp___313) 0)) (=> (<= (to_rep3 (first2 (rt1 temp___314))) (to_rep3 (last2 (rt1 temp___314)))) (= o39 (+ (- (to_rep3 (last2 (rt1 temp___314))) (to_rep3 (first2 (rt1 temp___314)))) 1)))))
(assert (=> (not (= (length1 temp___313) 0)) (=> (not (<= (to_rep3 (first2 (rt1 temp___314))) (to_rep3 (last2 (rt1 temp___314))))) (= o39 0))))
(assert (=> (not (= (length1 temp___313) 0)) (=> (<= (to_rep3 (first2 (rt1 temp___313))) (to_rep3 (last2 (rt1 temp___313)))) (= o40 (+ (- (to_rep3 (last2 (rt1 temp___313))) (to_rep3 (first2 (rt1 temp___313)))) 1)))))
(assert (=> (not (= (length1 temp___313) 0)) (=> (not (<= (to_rep3 (first2 (rt1 temp___313))) (to_rep3 (last2 (rt1 temp___313))))) (= o40 0))))
(assert (=> (not (= (length1 temp___313) 0)) (= o41 (+ o40 o39))))
(assert (=> (not (= (length1 temp___313) 0)) (= o42 (+ (to_rep3 (first2 (rt1 temp___313))) o41))))
(assert (=> (not (= (length1 temp___313) 0)) (= o43 (- o42 1))))
(assert (=> (not (= (length1 temp___313) 0)) (and (= o44 o43) (in_range6 o43))))
(assert (=> (not (= (length1 temp___313) 0)) (= temp___315 (mk___t1 (concat2 (elts1 temp___313) (to_rep3 (first2 (rt1 temp___313))) (to_rep3 (last2 (rt1 temp___313))) (elts1 temp___314) (to_rep3 (first2 (rt1 temp___314))) (to_rep3 (last2 (rt1 temp___314)))) (mk1 (to_rep3 (first2 (rt1 temp___313))) o44)))))
(assert (= (ite (<= (to_rep3 (first2 (rt1 temp___315))) (to_rep3 (last2 (rt1 temp___315)))) (+ (- (to_rep3 (last2 (rt1 temp___315))) (to_rep3 (first2 (rt1 temp___315)))) 1) 0) (ite (<= (to_rep3 total_stream__first) (to_rep3 total_stream__last)) (+ (- (to_rep3 total_stream__last) (to_rep3 total_stream__first)) 1) 0)))
(assert (= o45 temp___315))
(assert (= o46 (elts1 o45)))
(assert (= result17 (mk_map__ref1 total_stream1)))
(assert (= total_stream2 o46))
(assert (=> (<= (to_rep3 total_stream__first) (to_rep3 total_stream__last)) (= o47 (+ (- (to_rep3 total_stream__last) (to_rep3 total_stream__first)) 1))))
(assert (=> (not (<= (to_rep3 total_stream__first) (to_rep3 total_stream__last))) (= o47 0)))
(assert (and (= o48 o47) (in_range4 o47)))
(assert (= result18 (mk_int__ref len_n2)))
(assert (= len_n3 o48))
(assert (=> (<= (to_rep3 total_stream__first) (to_rep3 total_stream__last)) (= o49 (+ (- (to_rep3 total_stream__last) (to_rep3 total_stream__first)) 1))))
(assert (=> (not (<= (to_rep3 total_stream__first) (to_rep3 total_stream__last))) (= o49 0)))
(assert (and (= o50 o49) (in_range o49)))
(assert (= result19 (mk_int__ref len_i2)))
(assert (= len_i3 o50))
(assert (=> (<= (to_rep3 total_stream__first) (to_rep3 total_stream__last)) (= o51 (+ (- (to_rep3 total_stream__last) (to_rep3 total_stream__first)) 1))))
(assert (=> (not (<= (to_rep3 total_stream__first) (to_rep3 total_stream__last))) (= o51 0)))
(assert (not (in_range3 o51)))
(check-sat)
(exit)
