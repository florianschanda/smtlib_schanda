...
(define-fun target__ref___57__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun dynamic_invariant ((temp___expr_7158 us_t1) (temp___is_init_7154 Bool) (temp___skip_constant_7155 Bool) (temp___do_toplevel_7156 Bool) (temp___do_typ_inv_7157 Bool)) Bool (=> (not (= temp___skip_constant_7155 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7158) (last3 temp___expr_7158)) (and (= (first3 temp___expr_7158) 1) (= (last3 temp___expr_7158) 2)))))
...
(define-fun register_byte_array__ref___131__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_7138 us_t2) (temp___is_init_7134 Bool) (temp___skip_constant_7135 Bool) (temp___do_toplevel_7136 Bool) (temp___do_typ_inv_7137 Bool)) Bool (=> (not (= temp___skip_constant_7135 true)) (and (dynamic_property3 1 2 (first5 temp___expr_7138) (last5 temp___expr_7138)) (and (= (first5 temp___expr_7138) 1) (= (last5 temp___expr_7138) 2)))))
...
(declare-const temp___88971 t1)
(define-fun temp___88972 () us_t1 (mk___t1 temp___8897 temp___88971))
...
(assert (and (= temp___88972 (register_to_bytes reg)) (dynamic_invariant temp___88972 true false true true)))
(assert (not (= (ite (<= (to_rep (first2 temp___88971)) (to_rep (last2 temp___88971))) (+ (- (to_rep (last2 temp___88971)) (to_rep (first2 temp___88971))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
