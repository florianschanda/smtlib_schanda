...
(assert (=> (and (not (= zeroflag true)) (= (ite signflag 1 0) (ite overflowflag 1 0))) (= temp___426 rbx)))
(assert (=> (and (not (= zeroflag true)) (= (ite signflag 1 0) (ite overflowflag 1 0))) (= temp___425 rsp)))
(assert (=> (and (not (= zeroflag true)) (= (ite signflag 1 0) (ite overflowflag 1 0))) (= temp___424 overflowflag)))
(assert (=> (and (not (= zeroflag true)) (= (ite signflag 1 0) (ite overflowflag 1 0))) (= temp___423 signflag)))
(assert (=> (and (not (= zeroflag true)) (= (ite signflag 1 0) (ite overflowflag 1 0))) (= temp___422 rax)))
(assert (=> (and (not (= zeroflag true)) (= (ite signflag 1 0) (ite overflowflag 1 0))) (= temp___420 carryflag)))
(assert (=> (and (not (= zeroflag true)) (= (ite signflag 1 0) (ite overflowflag 1 0))) (= temp___421 xmm0)))
(assert (=> (and (not (= zeroflag true)) (= (ite signflag 1 0) (ite overflowflag 1 0))) (= temp___419 rbp)))
(assert (=> (and (not (= zeroflag true)) (= (ite signflag 1 0) (ite overflowflag 1 0))) (= temp___418 rdi)))
(assert (=> (and (not (= zeroflag true)) (= (ite signflag 1 0) (ite overflowflag 1 0))) (= temp___427 rsp)))
(assert (=> (and (not (= zeroflag true)) (= (ite signflag 1 0) (ite overflowflag 1 0))) (= temp___417 zeroflag)))
(assert (=> (and (not (= zeroflag true)) (= (ite signflag 1 0) (ite overflowflag 1 0))) (= rsp2 temp___427)))
