...
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___684 o3)))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o6 (mk_map__ref o5))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a (mk_map__ref o5))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= o8 (mk_map__ref o3))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a1 (mk_map__ref o3))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= o9 o3)))
...
(assert (=> (= result2 true) (= (oeq (osubtract (num_of_big_int (mk___t (map__content a1) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (osubtract (num_of_big_int (mk___t (let ((subject a1)) o10) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (num_of_boolean carry4)))) true)))
(assert (=> (= result2 true) (= o11 (mk_map__ref o10))))
(assert (=> (= result2 true) (= carry5 (mk_bool__ref carry4))))
(assert (=> (= result2 true) (= a2 (mk_map__ref o10))))
(assert (=> (= result2 true) (= carry6 carry4)))
(assert (=> (= result2 true) (= o12 o10)))
(assert (=> (not (= result2 true)) (= o11 o8)))
