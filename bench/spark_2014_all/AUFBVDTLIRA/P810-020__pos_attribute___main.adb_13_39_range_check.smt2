...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__main__some_record__c1 unsigned_8) (rec__main__some_record__c2 unsigned_8)))))
(define-fun us_split_fields_c1__projection ((a us_split_fields)) unsigned_8 (rec__main__some_record__c1 a))
(define-fun us_split_fields_c2__projection ((a us_split_fields)) unsigned_8 (rec__main__some_record__c2 a))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__main__some_record__c1 (us_split_fields1 a))) (to_rep2 (rec__main__some_record__c1 (us_split_fields1 b)))) (= (to_rep2 (rec__main__some_record__c2 (us_split_fields1 a))) (to_rep2 (rec__main__some_record__c2 (us_split_fields1 b))))) true false))
...
(assert (< main__some_record__c1__first__bit main__some_record__c1__last__bit))
...
(assert (< main__some_record__c2__first__bit main__some_record__c2__last__bit))
...
(define-fun default_initial_assumption ((temp___expr_573 us_rep) (temp___skip_top_level_574 Bool)) Bool (and (= (to_rep2 (rec__main__some_record__c1 (us_split_fields1 temp___expr_573))) #x00) (= (to_rep2 (rec__main__some_record__c2 (us_split_fields1 temp___expr_573))) #x00)))
...
(assert (not (in_range main__some_record__c1__position)))
(check-sat)
(exit)
