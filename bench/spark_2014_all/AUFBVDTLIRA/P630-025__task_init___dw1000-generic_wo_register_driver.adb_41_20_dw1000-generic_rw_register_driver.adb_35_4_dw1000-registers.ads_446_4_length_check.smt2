...
(define-fun tregister_byte_arrayP1__ref___97__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___41__projection ((a target__ref)) us_t1 (target__content a))
...
(declare-sort bits_40 0)
(define-fun in_range2 ((x (_ BitVec 64))) Bool (and (bvule #x0000000000000000 x) (bvule x #x000000FFFFFFFFFF)))
(define-fun in_range_int ((x Int)) Bool (and (<= 0 x) (<= x 1099511627775)))
...
(declare-fun user_eq6 (bits_40 bits_40) Bool)
(declare-const dummy6 bits_40)
(declare-datatypes () ((bits_40__ref (mk_bits_40__ref (bits_40__content bits_40)))))
(define-fun bits_40__ref___projection ((a bits_40__ref)) bits_40 (bits_40__content a))
(declare-fun to_rep2 (bits_40) (_ BitVec 64))
(declare-fun of_rep2 ((_ BitVec 64)) bits_40)
(assert (forall ((x bits_40)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x bits_40)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x (_ BitVec 64))) (! (let ((y (bvurem x #x0000010000000000))) (=> (in_range2 y) (= (to_rep2 (of_rep2 x)) y))) :pattern ((to_rep2 (of_rep2 x))))))
(define-fun to_int5 ((x bits_40)) Int (bv2nat (to_rep2 x)))
(assert (forall ((x bits_40)) (! (in_range_int (to_int5 x)) :pattern ((to_int5 x)))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__ldotune_type__ldotune bits_40)))))
(define-fun us_split_fields_LDOTUNE__projection ((a us_split_fields)) bits_40 (rec__dw1000__register_types__ldotune_type__ldotune a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___58__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___58__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__ldotune_type__ldotune (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__ldotune_type__ldotune (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__ldotune_type__ldotune__first__bit Int)
(declare-const dw1000__register_types__ldotune_type__ldotune__last__bit Int)
(declare-const dw1000__register_types__ldotune_type__ldotune__position Int)
(assert (<= 0 dw1000__register_types__ldotune_type__ldotune__first__bit))
(assert (< dw1000__register_types__ldotune_type__ldotune__first__bit dw1000__register_types__ldotune_type__ldotune__last__bit))
(assert (<= 0 dw1000__register_types__ldotune_type__ldotune__position))
(declare-fun user_eq7 (us_rep us_rep) Bool)
(declare-const dummy7 us_rep)
(declare-datatypes () ((ldotune_type__ref (mk_ldotune_type__ref (ldotune_type__content us_rep)))))
(define-fun ldotune_type__ref___projection ((a ldotune_type__ref)) us_rep (ldotune_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___41__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_5943 us_t1) (temp___is_init_5939 Bool) (temp___skip_constant_5940 Bool) (temp___do_toplevel_5941 Bool) (temp___do_typ_inv_5942 Bool)) Bool (=> (not (= temp___skip_constant_5940 true)) (and (dynamic_property2 1 5 (first3 temp___expr_5943) (last3 temp___expr_5943)) (and (= (first3 temp___expr_5943) 1) (= (last3 temp___expr_5943) 5)))))
...
(define-fun register_type__ref___137__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___97__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_5925 us_t2) (temp___is_init_5921 Bool) (temp___skip_constant_5922 Bool) (temp___do_toplevel_5923 Bool) (temp___do_typ_inv_5924 Bool)) Bool (=> (not (= temp___skip_constant_5922 true)) (and (dynamic_property3 1 5 (first5 temp___expr_5925) (last5 temp___expr_5925)) (and (= (first5 temp___expr_5925) 1) (= (last5 temp___expr_5925) 5)))))
...
(declare-const temp___8781 (Array Int bits_8))
(declare-const temp___87811 t1)
(define-fun temp___87812 () us_t1 (mk___t1 temp___8781 temp___87811))
(assert (and (dynamic_property3 1 5 (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 5))))
(assert (and (= temp___87812 (register_to_bytes reg)) (dynamic_invariant temp___87812 true false true true)))
(assert (not (= (ite (<= (to_rep (first2 temp___87811)) (to_rep (last2 temp___87811))) (+ (- (to_rep (last2 temp___87811)) (to_rep (first2 temp___87811))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0))))
(check-sat)
(exit)
