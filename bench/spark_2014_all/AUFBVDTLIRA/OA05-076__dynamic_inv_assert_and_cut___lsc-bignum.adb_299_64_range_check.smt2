...
(assert (= a1 result2))
(assert (= a2 o15))
(assert (and (= o56 (+ a_last 1)) (in_range1 (+ a_last 1))))
(assert (= o57 (ite (<= k o56) true false)))
(assert (and (= o55 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o58 (ite (<= o55 k) true false)))
(assert (= result3 (ite (= o58 true) o57 false)))
(assert (= (= o59 true) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a2 k1)) (to_rep1 (select a k1)))))))
(assert (= o50 (from_word32 carry22)))
(assert (and (= o49 (base Tuple0)) (= o49 (oexpon (from_word32 #x00000002) 32))))
(assert (= o51 (omultiply o49 o50)))
(assert (= o48 (from_word32 carry12)))
(assert (= o52 (oadd o48 o51)))
(assert (and (= o43 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o44 (- o43 a_first)))
(assert (and (= o45 o44) (in_range1 o44)))
(assert (and (= o46 o45) (in_range2 o45)))
(assert (and (= o42 (base Tuple0)) (= o42 (oexpon (from_word32 #x00000002) 32))))
(assert (= o47 (oexpon o42 o46)))
(assert (= o53 (omultiply o47 o52)))
...
(assert (= o54 (oadd o41 o53)))
(assert (= o35 (from_word32 carry2)))
(assert (and (= o34 (base Tuple0)) (= o34 (oexpon (from_word32 #x00000002) 32))))
(assert (= o36 (omultiply o34 o35)))
(assert (= o33 (from_word32 carry1)))
(assert (= o31 (from_word32 y)))
(assert (and (= o26 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o27 (- o26 a_first)))
(assert (and (= o28 o27) (in_range1 o27)))
(assert (and (= o29 o28) (in_range2 o28)))
(assert (= o30 (num_of_big_int c c_first o29)))
(assert (= o32 (omultiply o30 o31)))
(assert (= o24 (from_word32 x)))
(assert (and (= o19 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o20 (- o19 a_first)))
(assert (and (= o21 o20) (in_range1 o20)))
(assert (and (= o22 o21) (in_range2 o21)))
(assert (= o23 (num_of_big_int b b_first o22)))
(assert (= o25 (omultiply o23 o24)))
