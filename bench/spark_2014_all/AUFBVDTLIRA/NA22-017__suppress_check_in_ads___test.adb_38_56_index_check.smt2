...
(assert (and (and (=> (<= (to_rep result____first) (to_rep result____last)) (dynamic_property1 (to_rep result____first) (to_rep result____last) i2)) (forall ((temp___335 Int)) (=> (and (<= (to_rep result____first) temp___335) (<= temp___335 (to_rep result____last))) (=> (or (< (to_rep result____last) temp___335) (or (< temp___335 (to_rep result____first)) (< i2 temp___335))) (= (select result__2 temp___335) (select result__ temp___335)))))) (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last)))))
(assert (<= (to_rep result____first) pos))
(assert (<= pos i2))
(assert (not (<= pos (to_rep (last (rt right))))))
(check-sat)
(exit)
