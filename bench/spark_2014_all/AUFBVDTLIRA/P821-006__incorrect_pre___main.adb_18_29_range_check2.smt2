...
(declare-fun from_byte_array_to_integer_32__function_guard (Int (Array Int byte)) Bool)
...
(define-fun dynamic_invariant ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_173)))
(define-fun dynamic_invariant1 ((temp___expr_243 us_t) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool (=> (not (= temp___skip_constant_240 true)) (dynamic_property 0 2147483647 (first1 temp___expr_243) (last1 temp___expr_243))))
(declare-sort tbyte_array_4D1 0)
(declare-fun tbyte_array_4D1qtint (tbyte_array_4D1) Int)
(assert (forall ((i tbyte_array_4D1)) (and (<= 1 (tbyte_array_4D1qtint i)) (<= (tbyte_array_4D1qtint i) 4))))
...
(declare-datatypes () ((tbyte_array_4D1__ref (mk_tbyte_array_4D1__ref (tbyte_array_4D1__content tbyte_array_4D1)))))
(define-fun tbyte_array_4D1__ref___projection ((a tbyte_array_4D1__ref)) tbyte_array_4D1 (tbyte_array_4D1__content a))
(assert (forall ((bytes us_t)) (! (=> (and (dynamic_invariant1 bytes true true true true) (= (length bytes) 4)) (dynamic_invariant (tointeger_32 bytes) true false true true)) :pattern ((tointeger_32 bytes)))))
(assert (forall ((bytes us_t)) (! (=> (dynamic_invariant1 bytes true true true true) (= (tointeger_32 bytes) (from_byte_array_to_integer_32 (slide (to_array bytes) (first1 bytes) 1)))) :pattern ((tointeger_32 bytes)))))
(declare-sort tTarrSP1 0)
(declare-fun tTarrSP1qtint (tTarrSP1) Int)
(assert (forall ((i tTarrSP1)) (and (<= 0 (tTarrSP1qtint i)) (<= (tTarrSP1qtint i) 91))))
...
(declare-datatypes () ((tTarrSP1__ref (mk_tTarrSP1__ref (tTarrSP1__content tTarrSP1)))))
(define-fun tTarrSP1__ref___projection ((a tTarrSP1__ref)) tTarrSP1 (tTarrSP1__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-sort t13b 0)
(declare-fun t13bqtint (t13b) Int)
(assert (forall ((i t13b)) (and (<= 60 (t13bqtint i)) (<= (t13bqtint i) 64))))
...
(declare-fun temp_____aggregate_def_347 ((_ BitVec 8)) (Array Int byte))
...
(define-fun dynamic_invariant4 ((temp___expr_236 (_ BitVec 8)) (temp___is_init_232 Bool) (temp___skip_constant_233 Bool) (temp___do_toplevel_234 Bool) (temp___do_typ_inv_235 Bool)) Bool true)
(assert (forall ((temp___345 (_ BitVec 8))) (=> (dynamic_invariant4 temp___345 true true true true) (forall ((temp___346 Int)) (= (to_rep (select (main__arr__aggregate_def temp___345) temp___346)) temp___345)))))
...
(define-fun dynamic_invariant5 ((temp___expr_275 Int) (temp___is_init_271 Bool) (temp___skip_constant_272 Bool) (temp___do_toplevel_273 Bool) (temp___do_typ_inv_274 Bool)) Bool (=> (or (= temp___is_init_271 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_275)))
(assert (forall ((s (Array Int byte))) (! (dynamic_invariant5 (from_byte_array_to_integer_32 s) true false true true) :pattern ((from_byte_array_to_integer_32 s)))))
(assert (forall ((temp___349 (_ BitVec 8))) (=> (dynamic_invariant4 temp___349 true true true true) (forall ((temp___350 Int)) (= (to_rep (select (temp_____aggregate_def_347 temp___349) temp___350)) temp___349)))))
...
(assert (= result arr))
(assert (= arr1 (main__arr__aggregate_def #x00)))
(assert (=> (<= (- 2147483648) 2147483647) (in_range2 i32)))
(assert (= result1 arr1))
(assert (= arr2 (temp_____aggregate_def_347 #x00)))
(assert (<= 60 64))
(assert (not (<= 0 60)))
(check-sat)
(exit)
