...
(define-fun to_int5 ((x bits_16)) Int (bv2nat (to_rep2 x)))
...
(declare-fun user_eq5 (bits_40 bits_40) Bool)
(declare-const dummy5 bits_40)
...
(declare-fun to_rep3 (bits_40) (_ BitVec 64))
(declare-fun of_rep3 ((_ BitVec 64)) bits_40)
(assert (forall ((x bits_40)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x bits_40)) (! (in_range2 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x (_ BitVec 64))) (! (let ((y (bvurem x #x0000010000000000))) (=> (in_range2 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int6 ((x bits_40)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x bits_40)) (! (in_range_int (to_int6 x)) :pattern ((to_int6 x)))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__rx_time_type__rx_stamp bits_40) (rec__dw1000__register_types__rx_time_type__fp_index bits_16) (rec__dw1000__register_types__rx_time_type__fp_ampl1 bits_16) (rec__dw1000__register_types__rx_time_type__rx_rawst bits_40)))))
(define-fun us_split_fields_RX_STAMP__projection ((a us_split_fields)) bits_40 (rec__dw1000__register_types__rx_time_type__rx_stamp a))
(define-fun us_split_fields_FP_INDEX__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__rx_time_type__fp_index a))
(define-fun us_split_fields_FP_AMPL1__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__rx_time_type__fp_ampl1 a))
(define-fun us_split_fields_RX_RAWST__projection ((a us_split_fields)) bits_40 (rec__dw1000__register_types__rx_time_type__rx_rawst a))
...
(define-fun us_rep___18__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep3 (rec__dw1000__register_types__rx_time_type__rx_stamp (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__rx_time_type__rx_stamp (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__rx_time_type__fp_index (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rx_time_type__fp_index (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__rx_time_type__fp_ampl1 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rx_time_type__fp_ampl1 (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__rx_time_type__rx_rawst (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__rx_time_type__rx_rawst (us_split_fields1 b))))) true false))
...
(declare-const dw1000__register_types__rx_time_type__rx_stamp__first__bit Int)
(declare-const dw1000__register_types__rx_time_type__rx_stamp__last__bit Int)
(declare-const dw1000__register_types__rx_time_type__rx_stamp__position Int)
(assert (<= 0 dw1000__register_types__rx_time_type__rx_stamp__first__bit))
(assert (< dw1000__register_types__rx_time_type__rx_stamp__first__bit dw1000__register_types__rx_time_type__rx_stamp__last__bit))
(assert (<= 0 dw1000__register_types__rx_time_type__rx_stamp__position))
(declare-const dw1000__register_types__rx_time_type__fp_index__first__bit Int)
(declare-const dw1000__register_types__rx_time_type__fp_index__last__bit Int)
(declare-const dw1000__register_types__rx_time_type__fp_index__position Int)
(assert (<= 0 dw1000__register_types__rx_time_type__fp_index__first__bit))
(assert (< dw1000__register_types__rx_time_type__fp_index__first__bit dw1000__register_types__rx_time_type__fp_index__last__bit))
(assert (<= 0 dw1000__register_types__rx_time_type__fp_index__position))
(declare-const dw1000__register_types__rx_time_type__fp_ampl1__first__bit Int)
(declare-const dw1000__register_types__rx_time_type__fp_ampl1__last__bit Int)
(declare-const dw1000__register_types__rx_time_type__fp_ampl1__position Int)
(assert (<= 0 dw1000__register_types__rx_time_type__fp_ampl1__first__bit))
(assert (< dw1000__register_types__rx_time_type__fp_ampl1__first__bit dw1000__register_types__rx_time_type__fp_ampl1__last__bit))
(assert (<= 0 dw1000__register_types__rx_time_type__fp_ampl1__position))
(declare-const dw1000__register_types__rx_time_type__rx_rawst__first__bit Int)
(declare-const dw1000__register_types__rx_time_type__rx_rawst__last__bit Int)
(declare-const dw1000__register_types__rx_time_type__rx_rawst__position Int)
(assert (<= 0 dw1000__register_types__rx_time_type__rx_rawst__first__bit))
(assert (< dw1000__register_types__rx_time_type__rx_rawst__first__bit dw1000__register_types__rx_time_type__rx_rawst__last__bit))
(assert (<= 0 dw1000__register_types__rx_time_type__rx_rawst__position))
(declare-fun user_eq6 (us_rep us_rep) Bool)
(declare-const dummy6 us_rep)
(declare-datatypes () ((rx_time_type__ref (mk_rx_time_type__ref (rx_time_type__content us_rep)))))
(define-fun rx_time_type__ref___projection ((a rx_time_type__ref)) us_rep (rx_time_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___36__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___27__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___27__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_3259 us_t1) (temp___is_init_3255 Bool) (temp___skip_constant_3256 Bool) (temp___do_toplevel_3257 Bool) (temp___do_typ_inv_3258 Bool)) Bool (=> (not (= temp___skip_constant_3256 true)) (and (dynamic_property2 1 14 (first3 temp___expr_3259) (last3 temp___expr_3259)) (and (= (first3 temp___expr_3259) 1) (= (last3 temp___expr_3259) 14)))))
...
(assert (and (dynamic_property2 1 14 (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 14))))
