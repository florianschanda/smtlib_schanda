...
(define-fun frame4 () map__ref (mk_map__ref frame))
...
(assert (=> (= error1 0) (=> (= result2 true) (= result3 frame4))))
...
(assert (=> (= error1 0) (=> (not (= result2 true)) (= result4 frame4))))
...
(assert (not (in_range2 (- (to_rep (rec__decadriver__receiver_type__rx_count (us_split_fields3 self__5))) 1))))
(check-sat)
(exit)
