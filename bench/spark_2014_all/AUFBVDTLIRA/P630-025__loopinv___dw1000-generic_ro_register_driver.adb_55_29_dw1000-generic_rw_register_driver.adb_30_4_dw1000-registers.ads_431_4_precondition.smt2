...
(define-fun register_type__ref___129__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___91__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___91__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_5757 us_t1) (temp___is_init_5753 Bool) (temp___skip_constant_5754 Bool) (temp___do_toplevel_5755 Bool) (temp___do_typ_inv_5756 Bool)) Bool (=> (not (= temp___skip_constant_5754 true)) (and (dynamic_property2 1 1 (first3 temp___expr_5757) (last3 temp___expr_5757)) (and (= (first3 temp___expr_5757) 1) (= (last3 temp___expr_5757) 1)))))
