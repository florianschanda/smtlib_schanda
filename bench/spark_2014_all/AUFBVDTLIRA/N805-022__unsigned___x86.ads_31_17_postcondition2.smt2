...
(assert (= xcx4 xcx5))
(assert (= xcx6 xcx4))
(assert (not (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx5 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx5 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select xcx5 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select xcx5 3))) #x01000000)) val__)))
(check-sat)
(exit)
