...
(assert (=> (< digit_count3 index2) (= (= o6 true) (forall ((j Int)) (=> (and (<= (+ digit_count3 1) j) (<= j index2)) (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j)) #x00))))))
(assert (=> (not (< digit_count3 index2)) (= o6 (distinct 1 0))))
(assert (< 0 digit_count3))
(assert (not (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) digit_count3)))
(check-sat)
(exit)
