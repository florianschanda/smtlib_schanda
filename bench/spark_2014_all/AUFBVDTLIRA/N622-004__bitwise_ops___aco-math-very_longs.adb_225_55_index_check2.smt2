...
(declare-datatypes () ((tT68bP1__ref (mk_tT68bP1__ref (tT68bP1__content tdigit_index_typeB)))))
(define-fun tT68bP1__ref___projection ((a tT68bP1__ref)) tdigit_index_typeB (tT68bP1__content a))
(declare-sort t1 0)
...
(define-fun us_split_fields_Long_Digits__20__projection ((a us_split_fields2)) us_t1 (rec__aco__math__very_longs__very_long__long_digits1 a))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___195 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___195) (first3 temp___195) (last3 temp___195))))))
(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1) (mk___split_fields1 (let ((temp___194 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r1)))) (of_array1 (to_array temp___194) (first1 temp___194) (last1 temp___194))))))
...
(define-fun dynamic_invariant3 ((temp___expr_751 us_rep1) (temp___is_init_747 Bool) (temp___skip_constant_748 Bool) (temp___do_toplevel_749 Bool) (temp___do_typ_inv_750 Bool)) Bool (and (=> (not (= temp___skip_constant_748 true)) (in_range3 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_base temp___expr_751))) (and (dynamic_property3 1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_751))) (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_751)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_751))) 1) (= (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_751))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))))
(define-fun default_initial_assumption ((temp___expr_754 us_rep1) (temp___skip_top_level_755 Bool)) Bool (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_754))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))))
...
(declare-datatypes () ((t69b__ref (mk_t69b__ref (t69b__content tdigit_index_typeB)))))
(define-fun t69b__ref___projection ((a t69b__ref)) tdigit_index_typeB (t69b__content a))
(declare-sort t2 0)
...
(declare-fun temp_____aggregate_def_1232 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1234 (_ BitVec 8))) (forall ((temp___1235 Int) (temp___1236 Int)) (let ((temp___1233 (temp_____aggregate_def_1232 temp___1234 temp___1235 temp___1236))) (=> (dynamic_invariant temp___1234 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1235 temp___1236) (and (= (first5 temp___1233) temp___1235) (= (last5 temp___1233) temp___1236))) (forall ((temp___1237 Int)) (= (to_rep1 (select (to_array2 temp___1233) temp___1237)) temp___1234))))))))
(define-fun dynamic_invariant4 ((temp___expr_302 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool) (temp___do_typ_inv_301 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 1 2147483647)) (in_range1 temp___expr_302)))
...
(declare-const temp___12391 t2)
(declare-const temp___1240 (Array Int octet))
(declare-const temp___12401 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___1243 digit_index_type)
(declare-const temp___12431 (Array Int octet))
(declare-const temp___12432 t1)
...
(assert (= (to_rep2 (first4 (rt2 (temp_____aggregate_def_1232 #x00 1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp_____aggregate_def_1232 #x00 1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___1239 temp___12391) (temp_____aggregate_def_1232 #x00 1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep2 (first4 temp___12391)) (to_rep2 (last4 temp___12391))) (+ (- (to_rep2 (last4 temp___12391)) (to_rep2 (first4 temp___12391))) 1) 0) (ite (<= 1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (+ (- (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___1239 temp___1240))
(assert (= (mk1 (to_rep2 (first4 temp___12391)) (to_rep2 (last4 temp___12391))) temp___12401))
(assert (= (ite (<= (to_rep2 (first2 temp___12401)) (to_rep2 (last2 temp___12401))) (+ (- (to_rep2 (last2 temp___12401)) (to_rep2 (first2 temp___12401))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___1240 temp___12401)))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1243)))
(assert (= temp___12431 o2))
(assert (= temp___12432 o3))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___12431 temp___12432))))
(assert (= result____split_discrs (mk___split_discrs temp___1243)))
...
(assert (and (and (dynamic_invariant3 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (forall ((temp___1253 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))) temp___1253) (<= temp___1253 (to_rep2 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (or (< (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))) temp___1253) (or (< temp___1253 1) (<= i2 temp___1253))) (= (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)) temp___1253) (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields2)) temp___1253)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (= l_digit1 o7))
(assert (not (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))))) i2)))
(check-sat)
(exit)
