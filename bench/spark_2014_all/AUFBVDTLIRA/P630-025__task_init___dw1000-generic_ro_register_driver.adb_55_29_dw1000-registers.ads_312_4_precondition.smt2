...
(assert (forall ((x bits_6)) (! (in_range4 (to_rep4 x)) :pattern ((to_rep4 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x40))) (=> (in_range4 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
(define-fun to_int6 ((x bits_6)) Int (bv2nat (to_rep4 x)))
(assert (forall ((x bits_6)) (! (in_range_int2 (to_int6 x)) :pattern ((to_int6 x)))))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__agc_stat1_type__edg1 bits_5) (rec__dw1000__register_types__agc_stat1_type__edv2 bits_9) (rec__dw1000__register_types__agc_stat1_type__reserved_1 bits_6) (rec__dw1000__register_types__agc_stat1_type__reserved_2 bits_4)))))
(define-fun us_split_fields_EDG1__projection ((a us_split_fields)) bits_5 (rec__dw1000__register_types__agc_stat1_type__edg1 a))
(define-fun us_split_fields_EDV2__projection ((a us_split_fields)) bits_9 (rec__dw1000__register_types__agc_stat1_type__edv2 a))
(define-fun us_split_fields_Reserved_1__7__projection ((a us_split_fields)) bits_6 (rec__dw1000__register_types__agc_stat1_type__reserved_1 a))
(define-fun us_split_fields_Reserved_2__7__projection ((a us_split_fields)) bits_4 (rec__dw1000__register_types__agc_stat1_type__reserved_2 a))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep3 (rec__dw1000__register_types__agc_stat1_type__edg1 (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__agc_stat1_type__edg1 (us_split_fields1 b)))) (= (to_rep5 (rec__dw1000__register_types__agc_stat1_type__edv2 (us_split_fields1 a))) (to_rep5 (rec__dw1000__register_types__agc_stat1_type__edv2 (us_split_fields1 b))))) (= (to_rep4 (rec__dw1000__register_types__agc_stat1_type__reserved_1 (us_split_fields1 a))) (to_rep4 (rec__dw1000__register_types__agc_stat1_type__reserved_1 (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__agc_stat1_type__reserved_2 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__agc_stat1_type__reserved_2 (us_split_fields1 b))))) true false))
...
(assert (< dw1000__register_types__agc_stat1_type__edg1__first__bit dw1000__register_types__agc_stat1_type__edg1__last__bit))
...
(assert (< dw1000__register_types__agc_stat1_type__edv2__first__bit dw1000__register_types__agc_stat1_type__edv2__last__bit))
...
(assert (<= 0 dw1000__register_types__agc_stat1_type__reserved_1__first__bit))
(assert (< dw1000__register_types__agc_stat1_type__reserved_1__first__bit dw1000__register_types__agc_stat1_type__reserved_1__last__bit))
(assert (<= 0 dw1000__register_types__agc_stat1_type__reserved_1__position))
...
(assert (<= 0 dw1000__register_types__agc_stat1_type__reserved_2__first__bit))
(assert (< dw1000__register_types__agc_stat1_type__reserved_2__first__bit dw1000__register_types__agc_stat1_type__reserved_2__last__bit))
(assert (<= 0 dw1000__register_types__agc_stat1_type__reserved_2__position))
(declare-fun user_eq8 (us_rep us_rep) Bool)
(declare-const dummy8 us_rep)
(declare-datatypes () ((agc_stat1_type__ref (mk_agc_stat1_type__ref (agc_stat1_type__content us_rep)))))
(define-fun agc_stat1_type__ref___projection ((a agc_stat1_type__ref)) us_rep (agc_stat1_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___68__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___49__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___49__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_4025 us_t1) (temp___is_init_4021 Bool) (temp___skip_constant_4022 Bool) (temp___do_toplevel_4023 Bool) (temp___do_typ_inv_4024 Bool)) Bool (=> (not (= temp___skip_constant_4022 true)) (and (dynamic_property2 1 3 (first3 temp___expr_4025) (last3 temp___expr_4025)) (and (= (first3 temp___expr_4025) 1) (= (last3 temp___expr_4025) 3)))))
