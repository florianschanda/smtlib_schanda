...
(declare-fun temp_____aggregate_def_1193 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1195 (_ BitVec 8))) (forall ((temp___1196 Int) (temp___1197 Int)) (let ((temp___1194 (temp_____aggregate_def_1193 temp___1195 temp___1196 temp___1197))) (=> (dynamic_invariant temp___1195 true true true true) (and (=> (dynamic_property6 1 65536 temp___1196 temp___1197) (and (= (first5 temp___1194) temp___1196) (= (last5 temp___1194) temp___1197))) (forall ((temp___1198 Int)) (= (to_rep2 (select (to_array2 temp___1194) temp___1198)) temp___1195))))))))
...
(declare-const i Int)
(declare-const temp___1200 (Array Int octet))
(declare-const temp___12001 t2)
(declare-const temp___1201 (Array Int octet))
(declare-const temp___12011 t1)
(declare-const temp___1203 (Array Int octet))
(declare-const temp___12031 t1)
(declare-const o (Array Int octet))
(declare-const o1 t)
(declare-const o2 (Array Int octet))
(declare-const o3 t)
(declare-const temp___1205 digit_index_type)
(declare-const temp___12051 (Array Int octet))
(declare-const temp___12052 t)
...
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_1193 #x00 1 r9b)))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_1193 #x00 1 r9b)))) r9b))
(assert (= (mk___t2 temp___1200 temp___12001) (temp_____aggregate_def_1193 #x00 1 r9b)))
(assert (= (ite (<= (to_rep1 (first4 temp___12001)) (to_rep1 (last4 temp___12001))) (+ (- (to_rep1 (last4 temp___12001)) (to_rep1 (first4 temp___12001))) 1) 0) (ite (<= 1 r9b) (+ (- r9b 1) 1) 0)))
(assert (= temp___1200 temp___1201))
(assert (= (mk1 (to_rep1 (first4 temp___12001)) (to_rep1 (last4 temp___12001))) temp___12011))
(assert (= (ite (<= (to_rep1 (first2 temp___12011)) (to_rep1 (last2 temp___12011))) (+ (- (to_rep1 (last2 temp___12011)) (to_rep1 (first2 temp___12011))) 1) 0) (ite (<= (to_rep1 (first result____split_fields1)) (to_rep1 (last result____split_fields1))) (+ (- (to_rep1 (last result____split_fields1)) (to_rep1 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1203 temp___12031) (mk___t1 temp___1201 temp___12011)))
(assert (= temp___1203 o))
(assert (= (mk (to_rep1 (first2 temp___12031)) (to_rep1 (last2 temp___12031))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1205)))
(assert (= temp___12051 o2))
(assert (= temp___12052 o3))
(assert (= result result____split_fields))
(assert (= result1 result____split_fields1))
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___12051 temp___12052))))
(assert (= result____split_discrs (mk___split_discrs temp___1205)))
...
(assert (and (and (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1215 Int)) (=> (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1215) (<= temp___1215 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (or (< (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) temp___1215) (or (< temp___1215 1) (<= i2 temp___1215))) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1215) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1215)))))) (and (<= 1 i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (= result7 (mk_t__ref1 carry2)))
(assert (= carry3 o12))
