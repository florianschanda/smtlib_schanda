...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__tc_pgtest_type__tc_pgtest bits_8)))))
(define-fun us_split_fields_TC_PGTEST__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__tc_pgtest_type__tc_pgtest a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___63__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___63__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep1 (rec__dw1000__register_types__tc_pgtest_type__tc_pgtest (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__tc_pgtest_type__tc_pgtest (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__tc_pgtest_type__tc_pgtest__first__bit Int)
(declare-const dw1000__register_types__tc_pgtest_type__tc_pgtest__last__bit Int)
(declare-const dw1000__register_types__tc_pgtest_type__tc_pgtest__position Int)
(assert (<= 0 dw1000__register_types__tc_pgtest_type__tc_pgtest__first__bit))
(assert (< dw1000__register_types__tc_pgtest_type__tc_pgtest__first__bit dw1000__register_types__tc_pgtest_type__tc_pgtest__last__bit))
(assert (<= 0 dw1000__register_types__tc_pgtest_type__tc_pgtest__position))
(declare-fun user_eq4 (us_rep us_rep) Bool)
(declare-const dummy4 us_rep)
(declare-datatypes () ((tc_pgtest_type__ref (mk_tc_pgtest_type__ref (tc_pgtest_type__content us_rep)))))
(define-fun tc_pgtest_type__ref___projection ((a tc_pgtest_type__ref)) us_rep (tc_pgtest_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___147__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___104__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___104__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_6142 us_t1) (temp___is_init_6138 Bool) (temp___skip_constant_6139 Bool) (temp___do_toplevel_6140 Bool) (temp___do_typ_inv_6141 Bool)) Bool (=> (not (= temp___skip_constant_6139 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6142) (last3 temp___expr_6142)) (and (= (first3 temp___expr_6142) 1) (= (last3 temp___expr_6142) 1)))))
