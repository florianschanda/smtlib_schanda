...
(assert (= o18 (+ b_first o17)))
(assert (and (= o19 o18) (in_range1 o18)))
(assert (= o20 (ite (<= o19 (to_rep (last (rt b)))) true false)))
(assert (and (= o14 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o15 (+ b_first o14)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (= o21 (ite (<= (to_rep (first (rt b))) o16) true false)))
...
(assert (= o10 (+ c_first o9)))
(assert (and (= o11 o10) (in_range1 o10)))
(assert (= o12 (ite (<= o11 (to_rep (last (rt c)))) true false)))
(assert (and (= o6 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o7 (+ c_first o6)))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (= o13 (ite (<= (to_rep (first (rt c))) o8) true false)))
...
(assert (= o5 (ite (<= o4 (to_rep (last (rt m)))) true false)))
