...
(declare-fun temp_____aggregate_def_1042 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1044 (_ BitVec 8))) (forall ((temp___1045 Int) (temp___1046 Int)) (let ((temp___1043 (temp_____aggregate_def_1042 temp___1044 temp___1045 temp___1046))) (=> (dynamic_invariant temp___1044 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1045 temp___1046) (and (= (first5 temp___1043) temp___1045) (= (last5 temp___1043) temp___1046))) (forall ((temp___1047 Int)) (= (to_rep2 (select (to_array2 temp___1043) temp___1047)) temp___1044))))))))
...
(declare-const temp___1049 (Array Int octet))
(declare-const temp___10491 t2)
(declare-const temp___1050 (Array Int octet))
(declare-const temp___10501 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___1053 digit_index_type)
(declare-const temp___10531 (Array Int octet))
(declare-const temp___10532 t1)
...
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_1042 #x00 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_1042 #x00 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___1049 temp___10491) (temp_____aggregate_def_1042 #x00 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep1 (first4 temp___10491)) (to_rep1 (last4 temp___10491))) (+ (- (to_rep1 (last4 temp___10491)) (to_rep1 (first4 temp___10491))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___1049 temp___1050))
(assert (= (mk1 (to_rep1 (first4 temp___10491)) (to_rep1 (last4 temp___10491))) temp___10501))
(assert (= (ite (<= (to_rep1 (first2 temp___10501)) (to_rep1 (last2 temp___10501))) (+ (- (to_rep1 (last2 temp___10501)) (to_rep1 (first2 temp___10501))) 1) 0) (ite (<= (to_rep1 (first2 result____split_fields1)) (to_rep1 (last2 result____split_fields1))) (+ (- (to_rep1 (last2 result____split_fields1)) (to_rep1 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___1050 temp___10501)))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1053)))
(assert (= temp___10531 o2))
(assert (= temp___10532 o3))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___10531 temp___10532))))
(assert (= result____split_discrs (mk___split_discrs temp___1053)))
