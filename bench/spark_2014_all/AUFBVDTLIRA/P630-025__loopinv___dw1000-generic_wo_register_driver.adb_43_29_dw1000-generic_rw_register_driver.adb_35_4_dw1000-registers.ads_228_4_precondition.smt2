...
(define-fun target__ref___8__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun in_range5 ((x (_ BitVec 16))) Bool (and (bvule #x0000 x) (bvule x #x3FFF)))
...
(declare-fun user_eq9 (bits_14 bits_14) Bool)
(declare-const dummy9 bits_14)
...
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x #x4000))) (=> (in_range5 y) (= (to_rep5 (of_rep5 x)) y))) :pattern ((to_rep5 (of_rep5 x))))))
...
(define-fun dynamic_invariant ((temp___expr_2739 us_t1) (temp___is_init_2735 Bool) (temp___skip_constant_2736 Bool) (temp___do_toplevel_2737 Bool) (temp___do_typ_inv_2738 Bool)) Bool (=> (not (= temp___skip_constant_2736 true)) (and (dynamic_property2 1 4 (first3 temp___expr_2739) (last3 temp___expr_2739)) (and (= (first3 temp___expr_2739) 1) (= (last3 temp___expr_2739) 4)))))
...
(define-fun register_byte_array__ref___17__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_2710 us_t2) (temp___is_init_2706 Bool) (temp___skip_constant_2707 Bool) (temp___do_toplevel_2708 Bool) (temp___do_typ_inv_2709 Bool)) Bool (=> (not (= temp___skip_constant_2707 true)) (and (dynamic_property3 1 4 (first5 temp___expr_2710) (last5 temp___expr_2710)) (and (= (first5 temp___expr_2710) 1) (= (last5 temp___expr_2710) 4)))))
...
(declare-const temp___8515 (Array Int bits_8))
(declare-const temp___85151 t1)
(declare-const temp___8516 (Array Int bits_8))
(declare-const temp___85161 t2)
...
(define-fun temp___85152 () us_t1 (mk___t1 temp___8515 temp___85151))
...
(assert (and (= temp___85152 (register_to_bytes reg)) (dynamic_invariant temp___85152 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___85151)) (to_rep (last2 temp___85151))) (+ (- (to_rep (last2 temp___85151)) (to_rep (first2 temp___85151))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8515 temp___8516))
(assert (= (mk2 (to_rep (first2 temp___85151)) (to_rep (last2 temp___85151))) temp___85161))
(assert (= (ite (<= (to_rep (first4 temp___85161)) (to_rep (last4 temp___85161))) (+ (- (to_rep (last4 temp___85161)) (to_rep (first4 temp___85161))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8516 temp___85161)))
(assert (= o2 o))
