...
(define-fun register_type__ref___57__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___41__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___41__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_3772 us_t1) (temp___is_init_3768 Bool) (temp___skip_constant_3769 Bool) (temp___do_toplevel_3770 Bool) (temp___do_typ_inv_3771 Bool)) Bool (=> (not (= temp___skip_constant_3769 true)) (and (dynamic_property2 1 2 (first3 temp___expr_3772) (last3 temp___expr_3772)) (and (= (first3 temp___expr_3772) 1) (= (last3 temp___expr_3772) 2)))))
