...
(declare-const temp___4247 (Array Int t_uint8))
(declare-const temp___4248 (Array Int t_uint8))
(declare-const temp___42481 t)
...
(assert (= temp___4247 (data_to_byte_array data)))
(assert (= (ite (<= 1 1) (+ (- 1 1) 1) 0) (ite (<= r6b r7b) (+ (- r7b r6b) 1) 0)))
(assert (= (slide temp___4247 1 r6b) temp___4248))
(assert (= (mk r6b r7b) temp___42481))
