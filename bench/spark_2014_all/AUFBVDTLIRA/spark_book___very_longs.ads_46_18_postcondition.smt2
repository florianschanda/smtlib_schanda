...
(declare-datatypes () ((tT70bP1__ref (mk_tT70bP1__ref (tT70bP1__content tdigit_count_typeB)))))
(define-fun tT70bP1__ref___projection ((a tT70bP1__ref)) tdigit_count_typeB (tT70bP1__content a))
(declare-sort t1 0)
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___188 (rec__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___188) (first3 temp___188) (last3 temp___188))))))
(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1) (mk___split_fields1 (let ((temp___187 (rec__very_longs__very_long__long_digits (us_split_fields1 r1)))) (of_array1 (to_array temp___187) (first1 temp___187) (last1 temp___187))))))
...
(define-fun dynamic_invariant4 ((temp___expr_595 us_rep1) (temp___is_init_591 Bool) (temp___skip_constant_592 Bool) (temp___do_toplevel_593 Bool) (temp___do_typ_inv_594 Bool)) Bool (and (=> (not (= temp___skip_constant_592 true)) (in_range4 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_base temp___expr_595))) (and (dynamic_property3 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_595))) (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_595)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_595))) 1) (= (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_595))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))))
(define-fun default_initial_assumption ((temp___expr_598 us_rep1) (temp___skip_top_level_599 Bool)) Bool (= (to_rep (rec__very_longs__very_long__length (us_split_discrs2 temp___expr_598))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))))
...
(declare-datatypes () ((t71b__ref (mk_t71b__ref (t71b__content tdigit_count_typeB)))))
(define-fun t71b__ref___projection ((a t71b__ref)) tdigit_count_typeB (t71b__content a))
(declare-sort t2 0)
...
(declare-fun temp_____aggregate_def_963 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___965 (_ BitVec 8))) (forall ((temp___966 Int) (temp___967 Int)) (let ((temp___964 (temp_____aggregate_def_963 temp___965 temp___966 temp___967))) (=> (dynamic_invariant temp___965 true true true true) (and (=> (dynamic_property6 1 65536 temp___966 temp___967) (and (= (first5 temp___964) temp___966) (= (last5 temp___964) temp___967))) (forall ((temp___968 Int)) (= (to_rep2 (select (to_array2 temp___964) temp___968)) temp___965))))))))
...
(declare-const temp___9701 t2)
(declare-const temp___971 (Array Int octet))
(declare-const temp___9711 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___974 digit_index_type)
(declare-const temp___9741 (Array Int octet))
(declare-const temp___9742 t1)
...
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_963 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_963 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___970 temp___9701) (temp_____aggregate_def_963 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep1 (first4 temp___9701)) (to_rep1 (last4 temp___9701))) (+ (- (to_rep1 (last4 temp___9701)) (to_rep1 (first4 temp___9701))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___970 temp___971))
(assert (= (mk1 (to_rep1 (first4 temp___9701)) (to_rep1 (last4 temp___9701))) temp___9711))
(assert (= (ite (<= (to_rep1 (first2 temp___9711)) (to_rep1 (last2 temp___9711))) (+ (- (to_rep1 (last2 temp___9711)) (to_rep1 (first2 temp___9711))) 1) 0) (ite (<= (to_rep1 (first2 result____split_fields1)) (to_rep1 (last2 result____split_fields1))) (+ (- (to_rep1 (last2 result____split_fields1)) (to_rep1 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___971 temp___9711)))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___974)))
(assert (= temp___9741 o2))
(assert (= temp___9742 o3))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___9741 temp___9742))))
(assert (= result____split_discrs (mk___split_discrs temp___974)))
(assert (= result1 (mk_t__ref1 carry)))
(assert (= carry1 #x0000))
(assert (= result2 (mk_int__ref i)))
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___988 carry1)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___987 sum)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___986 r_digit)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___985 l_digit)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___982 (mk___rep1 result____split_discrs result____split_fields2))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (and (and (dynamic_invariant4 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (forall ((temp___984 Int)) (=> (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___984) (<= temp___984 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (or (< (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) temp___984) (or (< temp___984 1) (<= i2 temp___984))) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___984) (select (elts1 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___982))) temp___984)))))) (and (<= 1 i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))))))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= result5 (mk_t__ref1 sum2))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= sum3 (bvadd (bvadd l_digit3 r_digit3) carry2))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (and (= o12 (shift_right sum3 8)) (= o12 (bvudiv sum3 (ite (< 8 65536) (bvshl #x0001 ((_ int2bv 16) 8)) #x0000))))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= result6 (mk_t__ref1 carry2))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= carry3 o12)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o13 (takelsb_from16 sum3))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= (to_rep2 o14) o13)))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o15 i2)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o16 (store (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) o15 o14))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o17 (mk___t1 o16 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3))))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o18 (mk___split_fields1 o17))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___981 (mk___rep1 result____split_discrs o18))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= result7 (mk___split_fields__ref1 result____split_fields3))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= result____split_fields4 (us_split_fields3 temp___981))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= result____split_discrs (us_split_discrs2 temp___981))))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= sum4 (mk_t__ref1 sum3))))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= sum5 sum3)))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= sum6 sum4)))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= sum7 sum5)))
...
(assert (=> (not (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))) (= sum6 (mk_t__ref1 sum))))
...
(assert (=> (not (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))) (= sum7 sum1)))
...
(assert (= very_longs__modadd__result4 (mk_very_long__ref very_longs__modadd__result3)))
(assert (= very_longs__modadd__result5 very_longs__modadd__result3))
(assert (= result8 (mk_very_long__ref (mk___rep (mk___split_discrs very_longs__modadd__result) (mk___split_fields (mk___t very_longs__modadd__result1 very_longs__modadd__result2))))))
(assert (= very_longs__modadd__result3 (to_base (mk___rep1 result____split_discrs (us_split_fields__content1 result____split_fields7)))))
(assert (= very_longs__modadd__result6 very_longs__modadd__result4))
(assert (= i7 i5))
...
(assert (= very_longs__modadd__result7 very_longs__modadd__result5))
(assert (= i8 i6))
...
(assert (= (mk___rep (mk___split_discrs result9) (mk___split_fields (mk___t result10 result11))) (very_long__content very_longs__modadd__result6)))
(assert (not (= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 (very_long__content very_longs__modadd__result6)))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))
(check-sat)
(exit)
