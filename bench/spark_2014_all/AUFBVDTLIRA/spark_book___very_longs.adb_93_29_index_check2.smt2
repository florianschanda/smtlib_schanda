...
(define-fun dynamic_invariant1 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 65536)) (in_range1 temp___expr_228)))
...
(declare-datatypes () ((tS18bP1__ref (mk_tS18bP1__ref (tS18bP1__content tdigit_count_typeB)))))
(define-fun tS18bP1__ref___projection ((a tS18bP1__ref)) tdigit_count_typeB (tS18bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t20b__ref (mk_t20b__ref (t20b__content tdigit_count_typeB)))))
(define-fun t20b__ref___projection ((a t20b__ref)) tdigit_count_typeB (t20b__content a))
(declare-sort t2 0)
...
(declare-fun temp_____aggregate_def_1220 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1222 (_ BitVec 8))) (forall ((temp___1223 Int) (temp___1224 Int)) (let ((temp___1221 (temp_____aggregate_def_1220 temp___1222 temp___1223 temp___1224))) (=> (dynamic_invariant temp___1222 true true true true) (and (=> (dynamic_property6 1 65536 temp___1223 temp___1224) (and (= (first5 temp___1221) temp___1223) (= (last5 temp___1221) temp___1224))) (forall ((temp___1225 Int)) (= (to_rep2 (select (to_array2 temp___1221) temp___1225)) temp___1222))))))))
(define-fun dynamic_invariant4 ((temp___expr_242 us_t3) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (not (= temp___skip_constant_239 true)) (dynamic_property6 1 65536 (first7 temp___expr_242) (last7 temp___expr_242))))
(define-fun dynamic_invariant5 ((temp___expr_409 us_t1) (temp___is_init_405 Bool) (temp___skip_constant_406 Bool) (temp___do_toplevel_407 Bool) (temp___do_typ_inv_408 Bool)) Bool (=> (not (= temp___skip_constant_406 true)) (and (dynamic_property3 1 r19b (first3 temp___expr_409) (last3 temp___expr_409)) (and (= (first3 temp___expr_409) 1) (= (last3 temp___expr_409) r19b)))))
...
(declare-const temp___12271 t2)
(declare-const temp___1228 (Array Int octet))
(declare-const temp___12281 t1)
(declare-const temp___1230 (Array Int octet))
(declare-const temp___12301 t1)
(declare-const o (Array Int octet))
(declare-const o1 t)
(declare-const o2 (Array Int octet))
(declare-const o3 t)
(declare-const temp___1232 digit_index_type)
(declare-const temp___12321 (Array Int octet))
(declare-const temp___12322 t)
...
(assert (= (to_rep (rec__very_longs__very_long__length result____split_discrs)) r19b))
(assert (in_range1 r19b))
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_1220 #x00 1 r19b)))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_1220 #x00 1 r19b)))) r19b))
(assert (= (mk___t2 temp___1227 temp___12271) (temp_____aggregate_def_1220 #x00 1 r19b)))
(assert (= (ite (<= (to_rep1 (first4 temp___12271)) (to_rep1 (last4 temp___12271))) (+ (- (to_rep1 (last4 temp___12271)) (to_rep1 (first4 temp___12271))) 1) 0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0)))
(assert (= temp___1227 temp___1228))
(assert (= (mk1 (to_rep1 (first4 temp___12271)) (to_rep1 (last4 temp___12271))) temp___12281))
(assert (= (ite (<= (to_rep1 (first2 temp___12281)) (to_rep1 (last2 temp___12281))) (+ (- (to_rep1 (last2 temp___12281)) (to_rep1 (first2 temp___12281))) 1) 0) (ite (<= (to_rep1 (first result____split_fields1)) (to_rep1 (last result____split_fields1))) (+ (- (to_rep1 (last result____split_fields1)) (to_rep1 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1230 temp___12301) (mk___t1 temp___1228 temp___12281)))
(assert (= temp___1230 o))
(assert (= (mk (to_rep1 (first2 temp___12301)) (to_rep1 (last2 temp___12301))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1232)))
(assert (= temp___12321 o2))
(assert (= temp___12322 o3))
(assert (= result result____split_fields))
(assert (= result1 result____split_fields1))
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___12321 temp___12322))))
(assert (= result____split_discrs (mk___split_discrs temp___1232)))
(assert (= result2 (mk_t__ref1 borrow)))
...
(assert (and (and (dynamic_invariant2 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1242 Int)) (=> (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1242) (<= temp___1242 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (or (< (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) temp___1242) (or (< temp___1242 1) (<= i2 temp___1242))) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1242) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1242)))))) (and (<= 1 i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (=> (not (= (bvand difference2 #xFF00) #x0000)) (= result7 (mk_t__ref1 borrow2))))
(assert (=> (not (= (bvand difference2 #xFF00) #x0000)) (= borrow3 #x0001)))
(assert (=> (not (not (= (bvand difference2 #xFF00) #x0000))) (= result8 (mk_t__ref1 borrow2))))
(assert (=> (not (not (= (bvand difference2 #xFF00) #x0000))) (= borrow4 #x0000)))
(assert (=> (not (not (= (bvand difference2 #xFF00) #x0000))) (= borrow3 borrow4)))
(assert (= o12 (takelsb_from16 difference2)))
(assert (= (to_rep2 o13) o12))
(assert (not (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) i2)))
(check-sat)
(exit)
