...
(declare-const temp___8782 (Array Int bits_8))
(declare-const temp___87821 t2)
...
(assert (= (ite (<= (to_rep (first2 temp___87811)) (to_rep (last2 temp___87811))) (+ (- (to_rep (last2 temp___87811)) (to_rep (first2 temp___87811))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))
(assert (= temp___8781 temp___8782))
(assert (= (mk2 (to_rep (first2 temp___87811)) (to_rep (last2 temp___87811))) temp___87821))
(assert (not (= (ite (<= (to_rep (first4 temp___87821)) (to_rep (last4 temp___87821))) (+ (- (to_rep (last4 temp___87821)) (to_rep (first4 temp___87821))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
