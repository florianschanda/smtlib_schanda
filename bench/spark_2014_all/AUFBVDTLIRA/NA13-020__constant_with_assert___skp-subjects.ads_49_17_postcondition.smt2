...
(assert (= (bvurem skp__subjects__get_pml4_address__result #x0000000000001000) #x0000000000000000))
(assert (= result skp__subjects__get_pml4_address__result))
(assert (not (= (bvurem skp__subjects__get_pml4_address__result #x0000000000001000) #x0000000000000000)))
(check-sat)
(exit)
