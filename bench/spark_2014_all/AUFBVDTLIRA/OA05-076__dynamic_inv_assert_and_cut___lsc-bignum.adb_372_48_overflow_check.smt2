...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select o62 k)) #x00000000))))
...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (and (= (oeq (omod (oadd (num_of_big_int (mk___t o63 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o63 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true)))
...
(assert (= o1 (+ b_first o)))
(assert (and (= temp___675 o1) (in_range1 o1)))
(assert (and (<= (to_rep (first (rt b))) temp___675) (<= temp___675 (to_rep (last (rt b))))))
(assert (= o2 temp___675))
...
(assert (= a_msw3 o37))
(assert (= o59 (from_word32 #x00000001)))
(assert (and (= o53 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o54 (+ o53 1)))
(assert (and (= o55 o54) (in_range1 o54)))
(assert (and (= o56 o55) (in_range2 o55)))
(assert (= o57 (num_of_big_int m m_first o56)))
(assert (= o52 (from_word32 #x00000002)))
(assert (= o58 (omultiply o52 o57)))
(assert (= o60 (osubtract o58 o59)))
(assert (= o49 (from_word32 a_msw3)))
...
(assert (= o50 (omultiply o48 o49)))
(assert (and (= o38 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o39 (+ o38 1)))
(assert (and (= o40 o39) (in_range1 o39)))
(assert (and (= o41 o40) (in_range2 o40)))
(assert (= o42 (num_of_big_int (mk___t o66 (mk (to_rep a__first) (to_rep a__last))) a_first o41)))
(assert (= o51 (oadd o42 o50)))
(assert (= o61 (olt o51 o60)))
