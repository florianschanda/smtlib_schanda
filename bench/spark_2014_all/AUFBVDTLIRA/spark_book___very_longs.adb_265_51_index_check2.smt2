...
(declare-fun temp_____aggregate_def_998 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1000 (_ BitVec 8))) (forall ((temp___1001 Int) (temp___1002 Int)) (let ((temp___999 (temp_____aggregate_def_998 temp___1000 temp___1001 temp___1002))) (=> (dynamic_invariant temp___1000 true true true true) (and (=> (dynamic_property6 1 65536 temp___1001 temp___1002) (and (= (first5 temp___999) temp___1001) (= (last5 temp___999) temp___1002))) (forall ((temp___1003 Int)) (= (to_rep2 (select (to_array2 temp___999) temp___1003)) temp___1000))))))))
...
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_998 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_998 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___1005 temp___10051) (temp_____aggregate_def_998 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep1 (first4 temp___10051)) (to_rep1 (last4 temp___10051))) (+ (- (to_rep1 (last4 temp___10051)) (to_rep1 (first4 temp___10051))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___1005 temp___1006))
(assert (= (mk1 (to_rep1 (first4 temp___10051)) (to_rep1 (last4 temp___10051))) temp___10061))
(assert (= (ite (<= (to_rep1 (first2 temp___10061)) (to_rep1 (last2 temp___10061))) (+ (- (to_rep1 (last2 temp___10061)) (to_rep1 (first2 temp___10061))) 1) 0) (ite (<= (to_rep1 (first2 result____split_fields1)) (to_rep1 (last2 result____split_fields1))) (+ (- (to_rep1 (last2 result____split_fields1)) (to_rep1 (first2 result____split_fields1))) 1) 0)))
...
(assert (and (and (dynamic_invariant3 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (forall ((temp___1023 Int)) (=> (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___1023) (<= temp___1023 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (or (< (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) temp___1023) (or (< temp___1023 1) (<= i2 temp___1023))) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___1023) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___1023)))))) (and (<= 1 i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
