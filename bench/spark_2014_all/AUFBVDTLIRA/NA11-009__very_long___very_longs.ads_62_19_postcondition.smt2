...
(declare-datatypes () ((tT98bP1__ref (mk_tT98bP1__ref (tT98bP1__content tdigit_count_typeB)))))
(define-fun tT98bP1__ref___projection ((a tT98bP1__ref)) tdigit_count_typeB (tT98bP1__content a))
(declare-sort t1 0)
...
(define-fun us_split_fields_Long_Digits__27__projection ((a us_split_fields2)) us_t1 (rec__very_longs__very_long__long_digits1 a))
(declare-datatypes () ((us_split_fields__ref1 (mk___split_fields__ref1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref___27__projection ((a us_split_fields__ref1)) us_split_fields2 (us_split_fields__content1 a))
(declare-datatypes () ((us_rep1 (mk___rep1 (us_split_discrs2 us_split_discrs) (us_split_fields3 us_split_fields2)))))
(define-fun us_rep___53__projection ((a us_rep1)) us_split_discrs (us_split_discrs2 a))
(define-fun us_rep___54__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___206 (rec__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___206) (first3 temp___206) (last3 temp___206))))))
(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1) (mk___split_fields1 (let ((temp___205 (rec__very_longs__very_long__long_digits (us_split_fields1 r1)))) (of_array1 (to_array temp___205) (first1 temp___205) (last1 temp___205))))))
...
(define-fun dynamic_invariant4 ((temp___expr_712 us_rep1) (temp___is_init_708 Bool) (temp___skip_constant_709 Bool) (temp___do_toplevel_710 Bool) (temp___do_typ_inv_711 Bool)) Bool (and (=> (not (= temp___skip_constant_709 true)) (in_range4 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))) (to_base temp___expr_712))) (and (dynamic_property3 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))) (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_712))) (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_712)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_712))) 1) (= (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_712))) (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))))
(define-fun default_initial_assumption ((temp___expr_715 us_rep1) (temp___skip_top_level_716 Bool)) Bool (= (to_rep (rec__very_longs__very_long__length (us_split_discrs2 temp___expr_715))) (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))))
...
(declare-datatypes () ((t99b__ref (mk_t99b__ref (t99b__content tdigit_count_typeB)))))
(define-fun t99b__ref___projection ((a t99b__ref)) tdigit_count_typeB (t99b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t100b__ref (mk_t100b__ref (t100b__content us_t2)))))
(define-fun t100b__ref___projection ((a t100b__ref)) us_t2 (t100b__content a))
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-fun temp_____aggregate_def_1080 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1082 (_ BitVec 8))) (forall ((temp___1083 Int) (temp___1084 Int)) (let ((temp___1081 (temp_____aggregate_def_1080 temp___1082 temp___1083 temp___1084))) (=> (dynamic_invariant temp___1082 true true true true) (and (=> (dynamic_property6 1 65536 temp___1083 temp___1084) (and (= (first5 temp___1081) temp___1083) (= (last5 temp___1081) temp___1084))) (forall ((temp___1085 Int)) (= (to_rep2 (select (to_array2 temp___1081) temp___1085)) temp___1082))))))))
...
(declare-const j Int)
(declare-const i Int)
(declare-const very_longs__Omultiply__result digit_index_type)
(declare-const very_longs__Omultiply__result1 (Array Int octet))
(declare-const very_longs__Omultiply__result2 t)
(declare-const us Int)
(declare-const temp___1087 (Array Int octet))
(declare-const temp___10871 t2)
(declare-const temp___1088 (Array Int octet))
(declare-const temp___10881 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___1091 digit_index_type)
(declare-const temp___10911 (Array Int octet))
(declare-const temp___10912 t1)
(declare-const temp___1123 (_ BitVec 16))
(declare-const temp___1122 (_ BitVec 16))
(declare-const temp___1121 (_ BitVec 16))
(declare-const temp___1120 (_ BitVec 16))
(declare-const temp___1117 us_rep1)
(declare-const temp___1116 (_ BitVec 16))
(declare-const temp___1111 (_ BitVec 16))
(declare-const temp___1110 (_ BitVec 16))
(declare-const temp___1109 (_ BitVec 16))
(declare-const temp___1108 (_ BitVec 16))
(declare-const temp___1105 us_rep1)
(declare-const temp___1104 (_ BitVec 16))
...
(declare-const very_longs__Omultiply__result3 us_rep)
(declare-const very_longs__Omultiply__result4 very_long__ref)
(declare-const very_longs__Omultiply__result5 us_rep)
...
(declare-const very_longs__Omultiply__result6 very_long__ref)
...
(declare-const very_longs__Omultiply__result7 us_rep)
...
(assert (and (= us (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))) (in_range1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))
(assert (= (to_rep (rec__very_longs__very_long__length result____split_discrs)) (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))))
...
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_1080 #x00 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_1080 #x00 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))) (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))))
(assert (= (mk___t2 temp___1087 temp___10871) (temp_____aggregate_def_1080 #x00 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))
(assert (= (ite (<= (to_rep1 (first4 temp___10871)) (to_rep1 (last4 temp___10871))) (+ (- (to_rep1 (last4 temp___10871)) (to_rep1 (first4 temp___10871))) 1) 0) (ite (<= 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))) (+ (- (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))) 1) 1) 0)))
(assert (= temp___1087 temp___1088))
(assert (= (mk1 (to_rep1 (first4 temp___10871)) (to_rep1 (last4 temp___10871))) temp___10881))
(assert (= (ite (<= (to_rep1 (first2 temp___10881)) (to_rep1 (last2 temp___10881))) (+ (- (to_rep1 (last2 temp___10881)) (to_rep1 (first2 temp___10881))) 1) 0) (ite (<= (to_rep1 (first2 result____split_fields1)) (to_rep1 (last2 result____split_fields1))) (+ (- (to_rep1 (last2 result____split_fields1)) (to_rep1 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___1088 temp___10881)))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1091)))
(assert (= temp___10911 o2))
(assert (= temp___10912 o3))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___10911 temp___10912))))
(assert (= result____split_discrs (mk___split_discrs temp___1091)))
(assert (= result1 (mk_int__ref j)))
(assert (= j1 1))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1123 t_digit)))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1122 r_digit)))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1121 l_digit)))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1120 carry)))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1117 (mk___rep1 result____split_discrs result____split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1116 temp)))
...
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1111 t_digit2))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1110 r_digit2))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1109 l_digit2))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1108 carry3))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1105 (mk___rep1 result____split_discrs result____split_fields3)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1104 temp2))))
...
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1099 (- o12 1)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1099) (<= temp___1099 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o13 temp___1099))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o14 (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields4)) o13)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o15 (to_rep2 o14)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o16 ((_ zero_extend 8) o15)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= result6 (mk_t__ref1 t_digit3)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= t_digit4 o16))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= result7 (mk_t__ref1 temp3)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp4 (bvadd (bvadd (bvmul l_digit4 r_digit4) t_digit4) carry4)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o18 (takelsb_from16 temp4)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= (to_rep2 o19) o18))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (and (= o17 (+ i4 j2)) (in_range2 (+ i4 j2))))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1101 (- o17 1)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1101) (<= temp___1101 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o20 temp___1101))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o21 (store (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields4)) o20 o19)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o22 (mk___t1 o21 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o23 (mk___split_fields1 o22)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1103 (mk___rep1 result____split_discrs o23)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= result8 (mk___split_fields__ref1 result____split_fields4)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= result____split_fields5 (us_split_fields3 temp___1103)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= result____split_discrs (us_split_discrs2 temp___1103)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (and (= o24 (shift_right temp4 8)) (= o24 (bvudiv temp4 (ite (< 8 65536) (bvshl #x0001 ((_ int2bv 16) 8)) #x0000)))))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= result9 (mk_t__ref1 carry4)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= carry5 o24))))
...
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= o25 (takelsb_from16 (t__content1 carry8)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= (to_rep2 o26) o25)))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (and (= temp___1113 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) j2)) (in_range2 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) j2)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 result____split_fields8))))) temp___1113) (<= temp___1113 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 result____split_fields8)))))))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= o27 temp___1113)))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= o28 (store (elts1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 result____split_fields8))) o27 o26))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= o29 (mk___t1 o28 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 result____split_fields8)))))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= o30 (mk___split_fields1 o29))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1115 (mk___rep1 result____split_discrs o30))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= result10 result____split_fields8)))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= result____split_fields10 (us_split_fields3 temp___1115))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= result____split_discrs (us_split_discrs2 temp___1115))))
...
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= result____split_fields11 (mk___split_fields__ref1 result____split_fields10))))
...
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= result____split_fields14 result____split_fields12)))
...
(assert (=> (not (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r)))))))) (= result____split_fields13 (mk___split_fields__ref1 result____split_fields2))))
...
(assert (=> (not (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r)))))))) (= result____split_fields14 result____split_fields2)))
(assert (= very_longs__Omultiply__result4 (mk_very_long__ref very_longs__Omultiply__result3)))
(assert (= very_longs__Omultiply__result5 very_longs__Omultiply__result3))
(assert (= result11 (mk_very_long__ref (mk___rep (mk___split_discrs very_longs__Omultiply__result) (mk___split_fields (mk___t very_longs__Omultiply__result1 very_longs__Omultiply__result2))))))
(assert (= very_longs__Omultiply__result3 (to_base (mk___rep1 result____split_discrs (us_split_fields__content1 result____split_fields13)))))
(assert (= very_longs__Omultiply__result6 very_longs__Omultiply__result4))
(assert (= i13 i11))
(assert (= j7 j5))
...
(assert (= very_longs__Omultiply__result7 very_longs__Omultiply__result5))
(assert (= i14 i12))
(assert (= j8 j6))
...
(assert (= (mk___rep (mk___split_discrs result12) (mk___split_fields (mk___t result13 result14))) (very_long__content very_longs__Omultiply__result6)))
(assert (not (= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 (very_long__content very_longs__Omultiply__result6)))) (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))
(check-sat)
(exit)
