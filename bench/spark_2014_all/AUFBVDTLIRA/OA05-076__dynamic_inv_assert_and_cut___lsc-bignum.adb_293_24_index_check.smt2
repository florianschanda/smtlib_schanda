...
(assert (= o6 (+ c_first o5)))
(assert (and (= temp___799 o6) (in_range1 o6)))
(assert (and (<= (to_rep (first (rt c))) temp___799) (<= temp___799 (to_rep (last (rt c))))))
(assert (= o7 temp___799))
...
(assert (not (<= temp___798 (to_rep (last (rt b))))))
(check-sat)
(exit)
