...
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number)))))))
(assert (and (and (dynamic_invariant3 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1567 Int)) (=> (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) temp___1567) (<= temp___1567 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))) (=> (or (< (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))))) temp___1567) (or (< temp___1567 1) (<= i2 temp___1567))) (= (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) temp___1567) (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields2)) temp___1567)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
(assert (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))))) i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= o5 i2))
(assert (= o6 (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))) o5)))
(assert (= o7 (to_rep1 o6)))
(assert (= o8 (bvand o7 overflow_mask1)))
(assert (and (= o9 (shift_right o8 (- 8 distance))) (= o9 (bvudiv o8 (ite (< (- 8 distance) 256) (bvshl #x01 ((_ int2bv 8) (- 8 distance))) #x00)))))
(assert (= result4 (mk_t__ref new_overflow)))
(assert (= new_overflow1 o9))
(assert (=> (< distance 8) (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))))) i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
(assert (=> (< distance 8) (= o10 i2)))
(assert (=> (< distance 8) (= o11 (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))) o10))))
(assert (=> (< distance 8) (= o12 (to_rep1 o11))))
(assert (=> (< distance 8) (= o13 (bvshl o12 ((_ int2bv 8) distance)))))
(assert (=> (not (< distance 8)) (= o13 #x00)))
(assert (= (to_rep1 o14) o13))
(assert (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))))
(assert (= o15 i2))
(assert (= o16 (store (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) o15 o14)))
(assert (= o17 (mk___t o16 (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))
(assert (= o18 (mk___split_fields o17)))
(assert (= temp___1558 (mk___rep result____split_discrs o18)))
(assert (= result5 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___1558)))
(assert (= result____split_discrs (us_split_discrs1 temp___1558)))
(assert (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields4)))) i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields4)))))))
(assert (= o19 i2))
(assert (= o20 (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields4)) o19)))
(assert (= o21 (to_rep1 o20)))
(assert (= o22 (bvor o21 old_overflow2)))
(assert (= (to_rep1 o23) o22))
(assert (not (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields4)))) i2)))
(check-sat)
(exit)
