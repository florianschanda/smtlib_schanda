...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x02))) (=> (in_range3 y) (= (to_rep1 (of_rep1 x)) y))) :pattern ((to_rep1 (of_rep1 x))))))
(define-fun to_int2 ((x bits_1)) Int (bv2nat (to_rep1 x)))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x08))) (=> (in_range4 y) (= (to_rep2 (of_rep2 x)) y))) :pattern ((to_rep2 (of_rep2 x))))))
(define-fun to_int3 ((x bits_3)) Int (bv2nat (to_rep2 x)))
(assert (forall ((x bits_3)) (! (in_range_int1 (to_int3 x)) :pattern ((to_int3 x)))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (and (= (to_rep1 (rec__dw1000__register_types__aon_ctrl_type__restore (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__aon_ctrl_type__restore (us_split_fields1 b)))) (= (to_rep1 (rec__dw1000__register_types__aon_ctrl_type__save (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__aon_ctrl_type__save (us_split_fields1 b))))) (= (to_rep1 (rec__dw1000__register_types__aon_ctrl_type__upl_cfg (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__aon_ctrl_type__upl_cfg (us_split_fields1 b))))) (= (to_rep1 (rec__dw1000__register_types__aon_ctrl_type__dca_read (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__aon_ctrl_type__dca_read (us_split_fields1 b))))) (= (to_rep1 (rec__dw1000__register_types__aon_ctrl_type__dca_enab (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__aon_ctrl_type__dca_enab (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__aon_ctrl_type__reserved (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__aon_ctrl_type__reserved (us_split_fields1 b))))) true false))
...
(declare-fun user_eq5 (bits_8 bits_8) Bool)
(declare-const dummy5 bits_8)
...
(define-fun to_int4 ((x bits_8)) Int (bv2nat (to_rep3 x)))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep3 (rec__dw1000__register_types__aon_rdat_type__aon_rdat (us_split_fields3 a))) (to_rep3 (rec__dw1000__register_types__aon_rdat_type__aon_rdat (us_split_fields3 b)))) true false))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (= (to_rep3 (rec__dw1000__register_types__aon_addr_type__aon_addr (us_split_fields5 a))) (to_rep3 (rec__dw1000__register_types__aon_addr_type__aon_addr (us_split_fields5 b)))) true false))
...
(assert (forall ((a (Array Int bits_8)) (b (Array Int bits_8))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep3 (select a temp___idx_154)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_154)))))))))))
(declare-sort t 0)
...
(define-fun bool_eq4 ((x us_t) (y us_t)) Bool (bool_eq3 (elts x) (to_rep (first (rt x))) (to_rep (last (rt x))) (elts y) (to_rep (first (rt y))) (to_rep (last (rt y)))))
...
(define-fun dynamic_invariant1 ((temp___expr_756 us_t) (temp___is_init_752 Bool) (temp___skip_constant_753 Bool) (temp___do_toplevel_754 Bool) (temp___do_typ_inv_755 Bool)) Bool (=> (not (= temp___skip_constant_753 true)) (dynamic_property 0 2147483647 (first1 temp___expr_756) (last1 temp___expr_756))))
(declare-const addresses us_t)
...
(define-fun bool_eq5 ((x us_t1) (y us_t1)) Bool (bool_eq3 (elts1 x) (to_rep (first2 (rt1 x))) (to_rep (last2 (rt1 x))) (elts1 y) (to_rep (first2 (rt1 y))) (to_rep (last2 (rt1 y)))))
...
(declare-fun temp_____aggregate_def_3713 ((_ BitVec 8) Int Int) us_t1)
...
(define-fun dynamic_invariant3 ((temp___expr_357 (_ BitVec 8)) (temp___is_init_353 Bool) (temp___skip_constant_354 Bool) (temp___do_toplevel_355 Bool) (temp___do_typ_inv_356 Bool)) Bool true)
(assert (forall ((temp___3715 (_ BitVec 8))) (forall ((temp___3716 Int) (temp___3717 Int)) (let ((temp___3714 (temp_____aggregate_def_3713 temp___3715 temp___3716 temp___3717))) (=> (dynamic_invariant3 temp___3715 true true true true) (and (=> (dynamic_property 0 2147483647 temp___3716 temp___3717) (and (= (first3 temp___3714) temp___3716) (= (last3 temp___3714) temp___3717))) (forall ((temp___3718 Int)) (= (to_rep3 (select (to_array1 temp___3714) temp___3718)) temp___3715))))))))
(define-fun dynamic_invariant4 ((temp___expr_308 (_ BitVec 8)) (temp___is_init_304 Bool) (temp___skip_constant_305 Bool) (temp___do_toplevel_306 Bool) (temp___do_typ_inv_307 Bool)) Bool (=> (or (= temp___is_init_304 true) (bvule #x00 #x01)) (in_range3 temp___expr_308)))
...
(declare-const data (Array Int bits_8))
(declare-const temp___3720 (Array Int bits_8))
(declare-const temp___37201 t1)
(declare-const temp___3721 (Array Int bits_8))
(declare-const temp___37211 t)
(declare-const temp___3722 (Array Int bits_8))
(declare-const temp___37221 t)
(declare-const o (Array Int bits_8))
(declare-const o1 Int)
(declare-const result (Array Int bits_8))
(declare-const data1 (Array Int bits_8))
(assert (dynamic_invariant1 addresses true false true true))
(assert (dynamic_property 0 2147483647 (to_rep data__first) (to_rep data__last)))
(assert (= (length addresses) (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0)))
...
(assert (= (to_rep (first2 (rt1 (temp_____aggregate_def_3713 #x00 (to_rep data__first) (to_rep data__last))))) (to_rep data__first)))
(assert (= (to_rep (last2 (rt1 (temp_____aggregate_def_3713 #x00 (to_rep data__first) (to_rep data__last))))) (to_rep data__last)))
(assert (= (mk___t1 temp___3720 temp___37201) (temp_____aggregate_def_3713 #x00 (to_rep data__first) (to_rep data__last))))
(assert (= temp___3720 temp___3721))
(assert (= (mk (to_rep (first2 temp___37201)) (to_rep (last2 temp___37201))) temp___37211))
(assert (= (ite (<= (to_rep (first temp___37211)) (to_rep (last temp___37211))) (+ (- (to_rep (last temp___37211)) (to_rep (first temp___37211))) 1) 0) (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0)))
(assert (= (mk___t temp___3722 temp___37221) (mk___t temp___3721 temp___37211)))
(assert (= o (slide temp___3722 (to_rep (first temp___37221)) (to_rep data__first))))
(assert (= result data))
(assert (= data1 o))
(assert (=> (<= (to_rep data__first) (to_rep data__last)) (= o1 (+ (- (to_rep data__last) (to_rep data__first)) 1))))
(assert (=> (not (<= (to_rep data__first) (to_rep data__last))) (= o1 0)))
