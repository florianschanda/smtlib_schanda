...
(declare-const o15 name_id)
(declare-const o16 char_table_index)
...
(assert (=> (in_range11 n3) (and (= o19 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) (= (bool_eq4 o19 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) true))))
...
(assert (and (= temp___7143 (get (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields1)) o11)) (= (bool_eq4 temp___7143 (get (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields1)) o11)) true)))
(assert (= (to_rep4 o12) n12))
(assert (= temp___714 o13))
(assert (= temp___7141 o14))
(assert (= o12 o15))
(assert (= o16 o13))
(assert (= o17 o14))
(assert (= o18 o15))
(assert (not (in_range13 (int__content ptr10))))
(check-sat)
(exit)
