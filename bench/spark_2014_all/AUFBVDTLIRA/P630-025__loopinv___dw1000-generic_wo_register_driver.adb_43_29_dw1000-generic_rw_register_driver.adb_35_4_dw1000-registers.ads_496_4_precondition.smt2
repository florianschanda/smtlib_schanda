...
(define-fun tregister_byte_arrayP1__ref___115__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___49__projection ((a target__ref)) us_t1 (target__content a))
...
(declare-fun user_eq7 (bits_3 bits_3) Bool)
(declare-const dummy7 bits_3)
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x08))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (and (= (to_rep2 (rec__dw1000__register_types__aon_ctrl_type__restore (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__aon_ctrl_type__restore (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__aon_ctrl_type__save (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__aon_ctrl_type__save (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__aon_ctrl_type__upl_cfg (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__aon_ctrl_type__upl_cfg (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__aon_ctrl_type__dca_read (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__aon_ctrl_type__dca_read (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__aon_ctrl_type__dca_enab (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__aon_ctrl_type__dca_enab (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__aon_ctrl_type__reserved (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__aon_ctrl_type__reserved (us_split_fields1 b))))) true false))
...
(define-fun source__ref___49__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_6566 us_t1) (temp___is_init_6562 Bool) (temp___skip_constant_6563 Bool) (temp___do_toplevel_6564 Bool) (temp___do_typ_inv_6565 Bool)) Bool (=> (not (= temp___skip_constant_6563 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6566) (last3 temp___expr_6566)) (and (= (first3 temp___expr_6566) 1) (= (last3 temp___expr_6566) 1)))))
...
(define-fun register_type__ref___163__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___115__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_6543 us_t2) (temp___is_init_6539 Bool) (temp___skip_constant_6540 Bool) (temp___do_toplevel_6541 Bool) (temp___do_typ_inv_6542 Bool)) Bool (=> (not (= temp___skip_constant_6540 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6543) (last5 temp___expr_6543)) (and (= (first5 temp___expr_6543) 1) (= (last5 temp___expr_6543) 1)))))
...
(declare-const temp___8841 (Array Int bits_8))
(declare-const temp___88411 t1)
(declare-const temp___8842 (Array Int bits_8))
(declare-const temp___88421 t2)
...
(define-fun temp___88412 () us_t1 (mk___t1 temp___8841 temp___88411))
...
(assert (and (= temp___88412 (register_to_bytes reg)) (dynamic_invariant temp___88412 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___88411)) (to_rep (last2 temp___88411))) (+ (- (to_rep (last2 temp___88411)) (to_rep (first2 temp___88411))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8841 temp___8842))
(assert (= (mk2 (to_rep (first2 temp___88411)) (to_rep (last2 temp___88411))) temp___88421))
(assert (= (ite (<= (to_rep (first4 temp___88421)) (to_rep (last4 temp___88421))) (+ (- (to_rep (last4 temp___88421)) (to_rep (first4 temp___88421))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8842 temp___88421)))
(assert (= o2 o))
