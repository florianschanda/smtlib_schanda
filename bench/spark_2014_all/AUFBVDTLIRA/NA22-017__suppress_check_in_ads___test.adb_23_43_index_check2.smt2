...
(assert (and (<= (to_rep (first (rt left))) i1) (<= i1 (to_rep (last (rt left))))))
(assert (= o i1))
...
(assert (= result__1 o8))
(assert (forall ((pos1 Int)) (=> (and (<= (to_rep result____first) pos1) (<= pos1 i2)) (= (to_rep1 (select result__2 pos1)) (xor2 (to_rep1 (select (elts left) pos1)) (to_rep1 (select (elts right) pos1)))))))
(assert (and (and (forall ((temp___324 Int)) (=> (and (<= (to_rep result____first) temp___324) (<= temp___324 (to_rep result____last))) (=> (or (< (to_rep result____last) temp___324) (or (< temp___324 (to_rep result____first)) (< i2 temp___324))) (= (select result__2 temp___324) (select result__ temp___324))))) (=> (<= (to_rep result____first) (to_rep result____last)) (dynamic_property1 (to_rep result____first) (to_rep result____last) i2))) (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last)))))
(assert (<= (to_rep result____first) pos))
(assert (<= pos i2))
(assert (and (<= (to_rep (first (rt right))) pos) (<= pos (to_rep (last (rt right))))))
(assert (= o9 pos))
(assert (= o10 (select (elts right) o9)))
(assert (= o11 (to_rep1 o10)))
(assert (not (<= (to_rep (first (rt left))) pos)))
(check-sat)
(exit)
