...
(define-fun in_range ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x01)))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x02))) (=> (in_range y) (= (to_rep (of_rep x)) y))) :pattern ((to_rep (of_rep x))))))
...
(define-fun in_range1 ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x1F)))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x20))) (=> (in_range1 y) (= (to_rep1 (of_rep1 x)) y))) :pattern ((to_rep1 (of_rep1 x))))))
...
(define-fun in_range3 ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x01)))
(define-fun in_range_int2 ((x Int)) Bool (and (<= 0 x) (<= x 1)))
(declare-fun attr__ATTRIBUTE_IMAGE3 ((_ BitVec 8)) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) (_ BitVec 8))
(declare-fun user_eq4 (rx_frame_queue_index rx_frame_queue_index) Bool)
(declare-const dummy4 rx_frame_queue_index)
...
(assert (forall ((i frame_length)) (and (<= 0 (frame_lengthqtint i)) (<= (frame_lengthqtint i) 1024))))
(define-fun in_range4 ((x Int)) Bool (and (<= 0 x) (<= x 1024)))
(declare-fun attr__ATTRIBUTE_IMAGE4 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Int)
(declare-fun user_eq5 (frame_length frame_length) Bool)
(declare-const dummy5 frame_length)
...
(define-fun to_rep2 ((x frame_length)) Int (frame_lengthqtint x))
(declare-fun of_rep2 (Int) frame_length)
(assert (forall ((x frame_length)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x frame_length)) (! (in_range4 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(declare-fun user_eq6 (rx_errors rx_errors) Bool)
(declare-const dummy6 rx_errors)
...
(assert (forall ((x rx_errors)) (! (in_range5 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun bool_eq1 ((a (Array Int bits_8)) (a__first Int) (a__last Int) (b (Array Int bits_8)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep4 (select a temp___idx_154)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(declare-const dummy8 (Array Int bits_8))
...
(declare-fun user_eq8 ((Array Int bits_8) (Array Int bits_8)) Bool)
...
(define-fun us_split_fields_Size__3__projection ((a us_split_fields2)) frame_length (rec__decadriver__rx_frame_type__size a))
...
(define-fun us_split_fields__ref___140__projection ((a us_split_fields__ref1)) us_split_fields2 (us_split_fields__content1 a))
(declare-datatypes () ((us_rep1 (mk___rep1 (us_split_fields3 us_split_fields2)))))
(define-fun us_rep___142__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
...
(define-fun bool_eq3 ((a (Array (_ BitVec 8) us_rep1)) (a__first (_ BitVec 8)) (a__last (_ BitVec 8)) (b (Array (_ BitVec 8) us_rep1)) (b__first (_ BitVec 8)) (b__last (_ BitVec 8))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_205 (_ BitVec 8))) (=> (and (bvule a__first temp___idx_205) (bvule temp___idx_205 a__last)) (= (bool_eq2 (select a temp___idx_205) (select b (bvadd (bvsub b__first a__first) temp___idx_205))) true)))) true false))
(assert (forall ((a (Array (_ BitVec 8) us_rep1)) (b (Array (_ BitVec 8) us_rep1))) (forall ((a__first (_ BitVec 8)) (a__last (_ BitVec 8)) (b__first (_ BitVec 8)) (b__last (_ BitVec 8))) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_205 (_ BitVec 8))) (=> (and (bvule a__first temp___idx_205) (bvule temp___idx_205 a__last)) (= (bool_eq2 (select a temp___idx_205) (select b (bvadd (bvsub b__first a__first) temp___idx_205))) true))))))))
...
(define-fun us_split_fields__ref___141__projection ((a us_split_fields__ref2)) us_split_fields4 (us_split_fields__content2 a))
(declare-datatypes () ((us_rep2 (mk___rep2 (us_split_fields5 us_split_fields4)))))
(define-fun us_rep___143__projection ((a us_rep2)) us_split_fields4 (us_split_fields5 a))
...
(assert (forall ((x natural)) (! (in_range2 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((x rx_frame_queue_index)) (! (in_range3 (to_rep6 x)) :pattern ((to_rep6 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x02))) (=> (in_range3 y) (= (to_rep6 (of_rep6 x)) y))) :pattern ((to_rep6 (of_rep6 x))))))
(define-fun to_int5 ((x rx_frame_queue_index)) Int (bv2nat (to_rep6 x)))
(assert (forall ((x rx_frame_queue_index)) (! (in_range_int2 (to_int5 x)) :pattern ((to_int5 x)))))
(declare-fun temp_____aggregate_def_5014 (us_rep1) (Array (_ BitVec 8) us_rep1))
(declare-fun temp_____aggregate_def_5018 ((_ BitVec 8)) (Array Int bits_8))
(define-fun dynamic_invariant ((temp___expr_5008 us_rep2) (temp___is_init_5004 Bool) (temp___skip_constant_5005 Bool) (temp___do_toplevel_5006 Bool) (temp___do_typ_inv_5007 Bool)) Bool (forall ((temp___5009 (_ BitVec 8))) (=> (and (bvule #x00 temp___5009) (bvule temp___5009 #x01)) (let ((temp___5010 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields5 temp___expr_5008)) temp___5009))) (ite (= (to_rep3 (rec__decadriver__rx_frame_type__error (us_split_fields3 temp___5010))) 0) (< 0 (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___5010)))) (= (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___5010))) 0))))))
(declare-const rliteral frame_length)
(assert (= (frame_lengthqtint rliteral) 0))
(define-fun default_initial_assumption ((temp___expr_5012 us_rep2) (temp___skip_top_level_5013 Bool)) Bool (and (and (and (and (= (rec__decadriver__receiver_type__frame_queue (us_split_fields5 temp___expr_5012)) (temp_____aggregate_def_5014 (mk___rep1 (mk___split_fields1 rliteral (temp_____aggregate_def_5018 #x00) (of_rep3 0) (distinct 0 0))))) (= (to_rep6 (rec__decadriver__receiver_type__queue_head (us_split_fields5 temp___expr_5012))) #x01)) (= (to_rep5 (rec__decadriver__receiver_type__rx_count (us_split_fields5 temp___expr_5012))) 0)) (= (rec__decadriver__receiver_type__overrun_occurred (us_split_fields5 temp___expr_5012)) (distinct 0 0))) (= (rec__decadriver__receiver_type__frame_ready (us_split_fields5 temp___expr_5012)) (distinct 0 0))))
...
(define-fun us_split_fields__ref___142__projection ((a us_split_fields__ref3)) us_split_fields6 (us_split_fields__content3 a))
(declare-datatypes () ((us_rep3 (mk___rep3 (us_split_fields7 us_split_fields6)))))
(define-fun us_rep___144__projection ((a us_rep3)) us_split_fields6 (us_split_fields7 a))
...
(define-fun default_initial_assumption1 ((temp___expr_5030 us_rep3) (temp___skip_top_level_5031 Bool)) Bool (= (rec__decadriver__transmitter_type__tx_idle (us_split_fields7 temp___expr_5030)) (distinct 1 0)))
...
(define-fun in_range7 ((x Int)) Bool (and (<= 0 x) (<= x 97)))
(declare-fun attr__ATTRIBUTE_IMAGE8 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check8 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE8 (us_image) Int)
(declare-fun user_eq12 (priority priority) Bool)
(declare-const dummy10 priority)
...
(define-fun in_range8 ((x Int)) Bool (and (<= 98 x) (<= x 98)))
(declare-fun attr__ATTRIBUTE_IMAGE9 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check9 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE9 (us_image) Int)
(declare-fun user_eq13 (interrupt_priority interrupt_priority) Bool)
(declare-const dummy11 interrupt_priority)
...
(define-fun to_int7 ((x (_ BitVec 32))) Int (ite (bvsge x (_ bv0 32)) (bv2nat x) (- (- 4294967296 (bv2nat x)))))
...
(define-fun in_range9 ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x03)))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x04))) (=> (in_range9 y) (= (to_rep7 (of_rep7 x)) y))) :pattern ((to_rep7 (of_rep7 x))))))
(define-fun to_int8 ((x bits_2)) Int (bv2nat (to_rep7 x)))
(assert (forall ((x bits_2)) (! (in_range_int3 (to_int8 x)) :pattern ((to_int8 x)))))
(declare-sort bits_3 0)
(define-fun in_range10 ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x07)))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x08))) (=> (in_range10 y) (= (to_rep8 (of_rep8 x)) y))) :pattern ((to_rep8 (of_rep8 x))))))
(define-fun to_int9 ((x bits_3)) Int (bv2nat (to_rep8 x)))
...
(define-fun to_int10 ((x bits_32)) Int (bv2nat (to_rep9 x)))
(assert (forall ((x bits_32)) (! (uint_in_range2 (to_int10 x)) :pattern ((to_int10 x)))))
...
(define-fun bool_eq5 ((a (Array Int bits_32)) (a__first Int) (a__last Int) (b (Array Int bits_32)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_206 Int)) (=> (and (<= a__first temp___idx_206) (<= temp___idx_206 a__last)) (= (to_rep9 (select a temp___idx_206)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_206))))))) true false))
(assert (forall ((a (Array Int bits_32)) (b (Array Int bits_32))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_206 Int)) (=> (and (<= a__first temp___idx_206) (<= temp___idx_206 a__last)) (= (to_rep9 (select a temp___idx_206)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_206)))))))))))
...
(define-fun us_split_fields__ref___143__projection ((a us_split_fields__ref5)) us_split_fields10 (us_split_fields__content5 a))
(declare-datatypes () ((us_rep5 (mk___rep5 (us_split_fields11 us_split_fields10)))))
(define-fun us_rep___145__projection ((a us_rep5)) us_split_fields10 (us_split_fields11 a))
...
(define-fun to_int11 ((x bits_16)) Int (bv2nat (to_rep10 x)))
(assert (forall ((x bits_16)) (! (uint_in_range1 (to_int11 x)) :pattern ((to_int11 x)))))
(declare-fun temp_____aggregate_def_5041 ((_ BitVec 32)) (Array Int bits_32))
(define-fun default_initial_assumption2 ((temp___expr_5039 us_rep5) (temp___skip_top_level_5040 Bool)) Bool (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep9 (rec__decadriver__driver_type__part_id (us_split_fields11 temp___expr_5039))) #x00000000) (= (to_rep9 (rec__decadriver__driver_type__lot_id (us_split_fields11 temp___expr_5039))) #x00000000)) (= (to_rep10 (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields11 temp___expr_5039))) #x0000)) (= (to_rep10 (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields11 temp___expr_5039))) #x0000)) (= (to_rep1 (rec__decadriver__driver_type__xtal_trim (us_split_fields11 temp___expr_5039))) #x10)) (= (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields11 temp___expr_5039)) (temp_____aggregate_def_5041 #x00000000))) (= (rec__decadriver__driver_type__long_frames (us_split_fields11 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields11 temp___expr_5039)) (mk___rep4 (mk___split_fields4 (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep7 #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep8 #x00) (of_rep1 #x00))))) (= (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields11 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields11 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields11 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_phr_error (us_split_fields11 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_rs_error (us_split_fields11 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_fcs_error (us_split_fields11 temp___expr_5039)) (distinct 0 0))))
...
(define-fun dynamic_invariant2 ((temp___expr_4940 Int) (temp___is_init_4936 Bool) (temp___skip_constant_4937 Bool) (temp___do_toplevel_4938 Bool) (temp___do_typ_inv_4939 Bool)) Bool (=> (or (= temp___is_init_4936 true) (<= 0 1024)) (in_range4 temp___expr_4940)))
(define-fun dynamic_invariant3 ((temp___expr_4947 Int) (temp___is_init_4943 Bool) (temp___skip_constant_4944 Bool) (temp___do_toplevel_4945 Bool) (temp___do_typ_inv_4946 Bool)) Bool (=> (or (= temp___is_init_4943 true) (<= 0 5)) (in_range5 temp___expr_4947)))
(define-fun dynamic_invariant4 ((temp___expr_4954 us_rep1) (temp___is_init_4950 Bool) (temp___skip_constant_4951 Bool) (temp___do_toplevel_4952 Bool) (temp___do_typ_inv_4953 Bool)) Bool (=> (= temp___do_toplevel_4952 true) (=> (= temp___is_init_4950 true) (ite (= (to_rep3 (rec__decadriver__rx_frame_type__error (us_split_fields3 temp___expr_4954))) 0) (< 0 (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___expr_4954)))) (= (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___expr_4954))) 0)))))
(define-fun dynamic_predicate ((temp___4965 us_rep1)) Bool (ite (= (to_rep3 (rec__decadriver__rx_frame_type__error (us_split_fields3 temp___4965))) 0) (< 0 (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___4965)))) (= (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___4965))) 0)))
(define-fun dynamic_invariant5 ((temp___expr_4973 (_ BitVec 8)) (temp___is_init_4969 Bool) (temp___skip_constant_4970 Bool) (temp___do_toplevel_4971 Bool) (temp___do_typ_inv_4972 Bool)) Bool (=> (or (= temp___is_init_4969 true) (bvule #x00 #x01)) (in_range3 temp___expr_4973)))
(assert (forall ((temp___5016 us_rep1)) (=> (dynamic_invariant4 temp___5016 true true true true) (forall ((temp___5017 (_ BitVec 8))) (= (select (temp_____aggregate_def_5014 temp___5016) temp___5017) temp___5016)))))
(define-fun dynamic_invariant6 ((temp___expr_532 (_ BitVec 32)) (temp___is_init_528 Bool) (temp___skip_constant_529 Bool) (temp___do_toplevel_530 Bool) (temp___do_typ_inv_531 Bool)) Bool true)
(assert (forall ((temp___5043 (_ BitVec 32))) (=> (dynamic_invariant6 temp___5043 true true true true) (forall ((temp___5044 Int)) (= (to_rep9 (select (temp_____aggregate_def_5041 temp___5043) temp___5044)) temp___5043)))))
(define-fun dynamic_invariant7 ((temp___expr_802 Int) (temp___is_init_798 Bool) (temp___skip_constant_799 Bool) (temp___do_toplevel_800 Bool) (temp___do_typ_inv_801 Bool)) Bool (=> (or (= temp___is_init_798 true) (<= 0 97)) (in_range7 temp___expr_802)))
(define-fun dynamic_invariant8 ((temp___expr_809 Int) (temp___is_init_805 Bool) (temp___skip_constant_806 Bool) (temp___do_toplevel_807 Bool) (temp___do_typ_inv_808 Bool)) Bool (=> (or (= temp___is_init_805 true) (<= 98 98)) (in_range8 temp___expr_809)))
(define-fun dynamic_invariant9 ((temp___expr_315 (_ BitVec 8)) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (=> (or (= temp___is_init_311 true) (bvule #x00 #x01)) (in_range temp___expr_315)))
(define-fun dynamic_invariant10 ((temp___expr_322 (_ BitVec 8)) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool) (temp___do_typ_inv_321 Bool)) Bool (=> (or (= temp___is_init_318 true) (bvule #x00 #x03)) (in_range9 temp___expr_322)))
(define-fun dynamic_invariant11 ((temp___expr_329 (_ BitVec 8)) (temp___is_init_325 Bool) (temp___skip_constant_326 Bool) (temp___do_toplevel_327 Bool) (temp___do_typ_inv_328 Bool)) Bool (=> (or (= temp___is_init_325 true) (bvule #x00 #x07)) (in_range10 temp___expr_329)))
(define-fun dynamic_invariant12 ((temp___expr_343 (_ BitVec 8)) (temp___is_init_339 Bool) (temp___skip_constant_340 Bool) (temp___do_toplevel_341 Bool) (temp___do_typ_inv_342 Bool)) Bool (=> (or (= temp___is_init_339 true) (bvule #x00 #x1F)) (in_range1 temp___expr_343)))
(define-fun dynamic_invariant13 ((temp___expr_364 (_ BitVec 8)) (temp___is_init_360 Bool) (temp___skip_constant_361 Bool) (temp___do_toplevel_362 Bool) (temp___do_typ_inv_363 Bool)) Bool true)
(define-fun dynamic_invariant14 ((temp___expr_420 (_ BitVec 16)) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool true)
(assert (forall ((temp___5020 (_ BitVec 8))) (=> (dynamic_invariant13 temp___5020 true true true true) (forall ((temp___5021 Int)) (= (to_rep4 (select (temp_____aggregate_def_5018 temp___5020) temp___5021)) temp___5020)))))
...
(declare-const temp___5148 us_rep)
...
(declare-const us_self__compl10 us_rep2)
...
(assert (dynamic_invariant (mk___rep2 (mk___split_fields2 receiver__split_fields receiver__split_fields1 receiver__split_fields2 receiver__split_fields3 receiver__split_fields4)) true false true true))
(assert (= (to_rep1 o) #x00))
(assert (= (to_rep o1) #x00))
(assert (= (to_rep o2) #x00))
(assert (= (to_rep o3) #x00))
(assert (= (to_rep o4) #x00))
(assert (= (to_rep o5) #x00))
(assert (= (to_rep o6) #x00))
(assert (= (to_rep o7) #x00))
(assert (= (to_rep o8) #x00))
(assert (= (to_rep o9) #x00))
(assert (= (to_rep o10) #x00))
(assert (= (to_rep o11) #x00))
(assert (= (to_rep o12) #x00))
(assert (= (to_rep o13) #x00))
(assert (= (to_rep o14) #x00))
(assert (= (to_rep o15) #x00))
(assert (= (to_rep o16) #x00))
(assert (= (to_rep o17) #x00))
(assert (= (to_rep o18) #x00))
(assert (= (to_rep o19) #x00))
(assert (= (to_rep o20) #x00))
(assert (= (to_rep o21) #x00))
(assert (= (to_rep o22) #x00))
(assert (= (to_rep o23) #x00))
(assert (= (to_rep o24) #x00))
(assert (= (to_rep o25) #x00))
(assert (= (to_rep o26) #x00))
(assert (= (to_rep o27) #x00))
(assert (= (to_rep o28) #x00))
(assert (= (to_rep o29) #x00))
(assert (= (to_rep o30) #x00))
(assert (= (to_rep o31) #x00))
(assert (= (to_rep o32) #x00))
(assert (= (to_rep o33) #x00))
(assert (= (to_rep o34) #x00))
(assert (= (to_rep o35) #x00))
...
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (=> (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 (driver_type__content self__))) true) (dynamic_invariant (mk___rep2 receiver__split_fields6) true true true true))))
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (=> (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 (driver_type__content self__))) true) (= receiver__split_fields6 (mk___split_fields2 o37 o38 o39 o40 o41)))))
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (=> (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 (driver_type__content self__))) true) (= us_self__compl o37))))
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (=> (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 (driver_type__content self__))) true) (= us_self__compl1 o38))))
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (=> (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 (driver_type__content self__))) true) (= us_self__compl2 o39))))
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (=> (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 (driver_type__content self__))) true) (= us_self__compl3 o40))))
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (=> (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 (driver_type__content self__))) true) (= us_self__compl4 o41))))
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (=> (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 (driver_type__content self__))) true) (dynamic_invariant us_self__compl10 true true true true))))
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (=> (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 (driver_type__content self__))) true) (= result2 (mk___split_fields__ref2 receiver__split_fields6)))))
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (=> (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 (driver_type__content self__))) true) (= receiver__split_fields7 (us_split_fields5 us_self__compl10)))))
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (=> (not (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 (driver_type__content self__))) true)) (= receiver__split_fields7 (mk___split_fields2 receiver__split_fields receiver__split_fields1 receiver__split_fields2 receiver__split_fields3 receiver__split_fields4)))))
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (=> (not (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 (driver_type__content self__))) true)) (= receiver__split_fields7 receiver__split_fields5))))
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (= (to_rep o42) #x01)))
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (= o43 (mk___split_fields (rec__dw1000__register_types__sys_status_type__irqs (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__cplock (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__esyncr (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__aat (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__txfrb (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__txprs (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__txphs (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__txfrs (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__rxprd (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__rxsfdd (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__ldedone (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__rxphd (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__rxphe (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__rxdfr (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__rxfcg (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__rxfce (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__rxrfsl (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) o42 (rec__dw1000__register_types__sys_status_type__ldeerr (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__rxovrr (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__rxpto (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__gpioirq (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__slp2init (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__rfpll_ll (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__clkpll_ll (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__rxsfdto (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__hpdwarn (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__txberr (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__affrej (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__hsrbp (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__icrbp (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__rxrscs (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__rxprej (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__txpute (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__reserved_1 (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1)) (rec__dw1000__register_types__sys_status_type__reserved_2 (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields1))))))
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (= temp___5148 (mk___rep o43))))
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (= result3 (let ((subject sys_status_clear__split_fields)) (mk___split_fields__ref sys_status_clear__split_fields1)))))
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01) (= (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields2) (us_split_fields1 temp___5148))))
(assert (=> (not (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01)) (= (let ((subject sys_status_clear__split_fields)) (mk___split_fields__ref sys_status_clear__split_fields2)) (let ((subject sys_status_clear__split_fields)) (mk___split_fields__ref sys_status_clear__split_fields1)))))
(assert (=> (not (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01)) (= receiver__split_fields7 (mk___split_fields2 receiver__split_fields receiver__split_fields1 receiver__split_fields2 receiver__split_fields3 receiver__split_fields4))))
(assert (=> (not (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01)) (= sys_status_clear__split_fields2 sys_status_clear__split_fields1)))
(assert (=> (not (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01)) (= receiver__split_fields7 receiver__split_fields5)))
(assert (= (to_rep (rec__dw1000__register_types__sys_status_type__rxsfdto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) #x01))
(assert (= (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields11 (driver_type__content self__))) true))
(assert (dynamic_invariant (mk___rep2 receiver__split_fields8) true true true true))
(assert (= receiver__split_fields8 (mk___split_fields2 o44 o45 o46 o47 o48)))
(assert (= us_self__compl5 o44))
(assert (= us_self__compl6 o45))
(assert (= us_self__compl7 o46))
(assert (= us_self__compl8 o47))
(assert (= us_self__compl9 o48))
(assert (not (not (= 3 0))))
(check-sat)
(exit)
