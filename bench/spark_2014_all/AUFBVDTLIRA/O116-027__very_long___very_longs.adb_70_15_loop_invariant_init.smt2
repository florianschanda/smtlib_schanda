...
(assert (not (= (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) (to_rep1 (last (rt (rec__very_longs__very_long__long_digits result____split_fields2)))))))
(check-sat)
(exit)
