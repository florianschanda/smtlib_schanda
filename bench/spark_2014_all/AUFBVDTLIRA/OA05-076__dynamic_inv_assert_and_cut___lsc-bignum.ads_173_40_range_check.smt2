...
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___684 o9)))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (omod (oadd (num_of_big_int (mk___t o11 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw3))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- (+ i2 1) a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- (+ i2 1) a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o11 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw3))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o12 (mk_map__ref o11))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a (mk_map__ref o11))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= o14 (mk_map__ref o9))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a1 (mk_map__ref o9))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= o15 o9)))
...
(assert (=> (not (= result2 true)) (= o18 o15)))
(assert (= i7 i5))
(assert (= u7 u5))
(assert (= bi7 bi5))
