...
(define-fun tregister_byte_arrayP1__ref___117__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___50__projection ((a target__ref)) us_t1 (target__content a))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__aon_rdat_type__aon_rdat bits_8)))))
(define-fun us_split_fields_AON_RDAT__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__aon_rdat_type__aon_rdat a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___69__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___69__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep1 (rec__dw1000__register_types__aon_rdat_type__aon_rdat (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__aon_rdat_type__aon_rdat (us_split_fields1 b)))) true false))
...
(declare-datatypes () ((aon_rdat_type__ref (mk_aon_rdat_type__ref (aon_rdat_type__content us_rep)))))
(define-fun aon_rdat_type__ref___projection ((a aon_rdat_type__ref)) us_rep (aon_rdat_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___50__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_6630 us_t1) (temp___is_init_6626 Bool) (temp___skip_constant_6627 Bool) (temp___do_toplevel_6628 Bool) (temp___do_typ_inv_6629 Bool)) Bool (=> (not (= temp___skip_constant_6627 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6630) (last3 temp___expr_6630)) (and (= (first3 temp___expr_6630) 1) (= (last3 temp___expr_6630) 1)))))
...
(define-fun register_type__ref___166__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___117__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_6612 us_t2) (temp___is_init_6608 Bool) (temp___skip_constant_6609 Bool) (temp___do_toplevel_6610 Bool) (temp___do_typ_inv_6611 Bool)) Bool (=> (not (= temp___skip_constant_6609 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6612) (last5 temp___expr_6612)) (and (= (first5 temp___expr_6612) 1) (= (last5 temp___expr_6612) 1)))))
...
(declare-const temp___8848 (Array Int bits_8))
(declare-const temp___88481 t1)
(declare-const temp___8849 (Array Int bits_8))
(declare-const temp___88491 t2)
...
(define-fun temp___88482 () us_t1 (mk___t1 temp___8848 temp___88481))
...
(assert (and (= temp___88482 (register_to_bytes reg)) (dynamic_invariant temp___88482 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___88481)) (to_rep (last2 temp___88481))) (+ (- (to_rep (last2 temp___88481)) (to_rep (first2 temp___88481))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8848 temp___8849))
(assert (= (mk2 (to_rep (first2 temp___88481)) (to_rep (last2 temp___88481))) temp___88491))
(assert (= (ite (<= (to_rep (first4 temp___88491)) (to_rep (last4 temp___88491))) (+ (- (to_rep (last4 temp___88491)) (to_rep (first4 temp___88491))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8849 temp___88491)))
(assert (= o2 o))
