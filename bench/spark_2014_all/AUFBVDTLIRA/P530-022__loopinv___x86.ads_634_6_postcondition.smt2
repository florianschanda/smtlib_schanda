...
(assert (and (= (to_rep (select memory4 (bvadd addr #x0000000000000003))) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 32) 24)) #x000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000003))) (= (to_rep (select memory4 i)) (to_rep (select memory3 i))))))))
(assert (= memory4 memory5))
(assert (= memory6 memory4))
(assert (not (= (bvand val__ #x0000FF00) (bvmul ((_ zero_extend 24) (to_rep (select memory5 (bvadd addr #x0000000000000001)))) #x00000100))))
(check-sat)
(exit)
