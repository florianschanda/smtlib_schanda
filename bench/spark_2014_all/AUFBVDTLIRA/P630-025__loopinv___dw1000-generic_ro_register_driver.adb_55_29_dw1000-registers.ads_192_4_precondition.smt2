...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__dev_id_type__rev bits_4) (rec__dw1000__register_types__dev_id_type__ver bits_4) (rec__dw1000__register_types__dev_id_type__model bits_8) (rec__dw1000__register_types__dev_id_type__ridtag bits_16)))))
(define-fun us_split_fields_REV__projection ((a us_split_fields)) bits_4 (rec__dw1000__register_types__dev_id_type__rev a))
(define-fun us_split_fields_VER__projection ((a us_split_fields)) bits_4 (rec__dw1000__register_types__dev_id_type__ver a))
(define-fun us_split_fields_MODEL__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__dev_id_type__model a))
(define-fun us_split_fields_RIDTAG__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__dev_id_type__ridtag a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep2 (rec__dw1000__register_types__dev_id_type__rev (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__dev_id_type__rev (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__dev_id_type__ver (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__dev_id_type__ver (us_split_fields1 b))))) (= (to_rep1 (rec__dw1000__register_types__dev_id_type__model (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__dev_id_type__model (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__dev_id_type__ridtag (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__dev_id_type__ridtag (us_split_fields1 b))))) true false))
...
(assert (< dw1000__register_types__dev_id_type__rev__first__bit dw1000__register_types__dev_id_type__rev__last__bit))
...
(assert (< dw1000__register_types__dev_id_type__ver__first__bit dw1000__register_types__dev_id_type__ver__last__bit))
...
(assert (< dw1000__register_types__dev_id_type__model__first__bit dw1000__register_types__dev_id_type__model__last__bit))
...
(assert (< dw1000__register_types__dev_id_type__ridtag__first__bit dw1000__register_types__dev_id_type__ridtag__last__bit))
(assert (<= 0 dw1000__register_types__dev_id_type__ridtag__position))
(declare-fun user_eq6 (us_rep us_rep) Bool)
(declare-const dummy6 us_rep)
(declare-datatypes () ((dev_id_type__ref (mk_dev_id_type__ref (dev_id_type__content us_rep)))))
(define-fun dev_id_type__ref___projection ((a dev_id_type__ref)) us_rep (dev_id_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_2048 us_t1) (temp___is_init_2044 Bool) (temp___skip_constant_2045 Bool) (temp___do_toplevel_2046 Bool) (temp___do_typ_inv_2047 Bool)) Bool (=> (not (= temp___skip_constant_2045 true)) (and (dynamic_property2 1 4 (first3 temp___expr_2048) (last3 temp___expr_2048)) (and (= (first3 temp___expr_2048) 1) (= (last3 temp___expr_2048) 4)))))
