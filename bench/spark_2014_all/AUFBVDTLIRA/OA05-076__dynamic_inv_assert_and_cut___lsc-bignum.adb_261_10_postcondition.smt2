...
(assert (= a9 a7))
(assert (not (= (oeq (oadd (oadd (oadd (oadd (num_of_big_int (mk___t a (mk (to_rep a__first) (to_rep a__last))) (+ a_first 1) (+ (- a_last a_first) 1)) (omultiply (num_of_big_int b b_first (+ (- a_last a_first) 1)) (from_word32 x))) (omultiply (num_of_big_int c c_first (+ (- a_last a_first) 1)) (from_word32 y))) (from_word32 carry1)) (omultiply (base Tuple0) (from_word32 carry2))) (oadd (num_of_big_int (mk___t (map__content a8) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (oadd (from_word32 (t__content carry18)) (omultiply (base Tuple0) (from_word32 (t__content carry28))))))) true)))
(check-sat)
(exit)
