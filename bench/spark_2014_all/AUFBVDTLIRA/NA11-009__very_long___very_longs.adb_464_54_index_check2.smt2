...
(assert (= temp___1327 (- o38 2)))
(assert (and (<= (to_rep1 (first2 u__split_fields1)) temp___1327) (<= temp___1327 (to_rep1 (last3 u__split_fields1)))))
(assert (= o39 temp___1327))
(assert (= o40 (select u__split_fields o39)))
(assert (= o41 (to_rep2 o40)))
(assert (= o42 ((_ zero_extend 8) o41)))
(assert (= o43 (bvadd (bvmul #x0100 r_hat2) o42)))
