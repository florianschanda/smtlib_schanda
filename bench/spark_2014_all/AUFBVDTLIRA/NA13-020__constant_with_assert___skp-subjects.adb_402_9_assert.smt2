...
(assert (not (not (= (to_rep (rec__skp__subjects__event_entry_type__dst_subject (us_split_fields1 (select (rec__skp__subjects__subject_spec_type__event_table (us_split_fields7 (select subject_specs 0))) 1)))) 0))))
(check-sat)
(exit)
