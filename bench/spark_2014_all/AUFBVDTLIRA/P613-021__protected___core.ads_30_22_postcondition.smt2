...
(declare-const o24 message_count)
(declare-const o25 (Array (_ BitVec 8) us_rep))
(declare-const o26 message_index)
(declare-const o27 message_index)
(declare-const o28 message_count)
...
(declare-const self__8 (Array (_ BitVec 8) us_rep))
(declare-const self__9 message_index)
(declare-const self__10 message_index)
(declare-const self__11 message_count)
(declare-const result4 mailboxT__ref)
(declare-const self__12 us_rep1)
(declare-const result5 mailboxT__ref)
(declare-const self__13 us_rep1)
(declare-const result6 mailboxT__ref)
(declare-const self__14 us_rep1)
(declare-const self__15 mailboxT__ref)
(declare-const self__16 us_rep1)
(define-fun self__17 () us_rep1 (mk___rep1 (mk___split_fields1 self__8 self__9 self__10 self__11)))
(assert (in_range n))
(assert (=> (< (to_rep2 self__3) 16) (= (to_rep o) n)))
(assert (=> (< (to_rep2 self__3) 16) (= o o1)))
(assert (=> (< (to_rep2 self__3) 16) (= (rec__core__message_record__size (us_split_fields1 (select self__ (to_rep3 self__1)))) o2)))
(assert (=> (< (to_rep2 self__3) 16) (= o3 o1)))
(assert (=> (< (to_rep2 self__3) 16) (= o4 o2)))
(assert (=> (< (to_rep2 self__3) 16) (= o5 (store self__ (to_rep3 self__1) (mk___rep (mk___split_fields o3 o4))))))
(assert (=> (< (to_rep2 self__3) 16) (= o5 o6)))
(assert (=> (< (to_rep2 self__3) 16) (= self__1 o7)))
(assert (=> (< (to_rep2 self__3) 16) (= self__2 o8)))
(assert (=> (< (to_rep2 self__3) 16) (= self__3 o9)))
(assert (=> (< (to_rep2 self__3) 16) (= o10 o6)))
(assert (=> (< (to_rep2 self__3) 16) (= o11 o7)))
(assert (=> (< (to_rep2 self__3) 16) (= o12 o8)))
(assert (=> (< (to_rep2 self__3) 16) (= o13 o9)))
(assert (=> (< (to_rep2 self__3) 16) (= (mk_mailboxT__ref (mk___rep1 (mk___split_fields1 result result1 result2 result3))) (mk_mailboxT__ref (mk___rep1 (mk___split_fields1 self__ self__1 self__2 self__3))))))
(assert (=> (< (to_rep2 self__3) 16) (= self__17 (mk___rep1 (mk___split_fields1 o10 o11 o12 o13)))))
(assert (=> (< (to_rep2 self__3) 16) (= result4 (mk_mailboxT__ref self__17))))
(assert (=> (< (to_rep2 self__3) 16) (= self__12 (mk___rep1 (mk___split_fields1 (store self__8 (to_rep3 self__9) (mk___rep (mk___split_fields (rec__core__message_record__value (us_split_fields1 (select self__8 (to_rep3 self__9)))) rliteral1))) self__9 self__10 self__11)))))
(assert (=> (< (to_rep2 self__3) 16) (= (to_rep3 o14) (bvurem (bvadd (to_rep3 (rec__core__mailboxT__next_in (us_split_fields3 self__12))) #x01) #x10))))
(assert (=> (< (to_rep2 self__3) 16) (= (rec__core__mailboxT__messages (us_split_fields3 self__12)) o15)))
(assert (=> (< (to_rep2 self__3) 16) (= o14 o16)))
(assert (=> (< (to_rep2 self__3) 16) (= (rec__core__mailboxT__next_out (us_split_fields3 self__12)) o17)))
(assert (=> (< (to_rep2 self__3) 16) (= (rec__core__mailboxT__count (us_split_fields3 self__12)) o18)))
(assert (=> (< (to_rep2 self__3) 16) (= o19 o15)))
(assert (=> (< (to_rep2 self__3) 16) (= o20 o16)))
(assert (=> (< (to_rep2 self__3) 16) (= o21 o17)))
(assert (=> (< (to_rep2 self__3) 16) (= o22 o18)))
(assert (=> (< (to_rep2 self__3) 16) (= result5 (mk_mailboxT__ref self__12))))
(assert (=> (< (to_rep2 self__3) 16) (= self__13 (mk___rep1 (mk___split_fields1 o19 o20 o21 o22)))))
(assert (=> (< (to_rep2 self__3) 16) (and (= o23 (+ (to_rep2 (rec__core__mailboxT__count (us_split_fields3 self__13))) 1)) (in_range3 (+ (to_rep2 (rec__core__mailboxT__count (us_split_fields3 self__13))) 1)))))
(assert (=> (< (to_rep2 self__3) 16) (= (to_rep2 o24) o23)))
(assert (=> (< (to_rep2 self__3) 16) (= (rec__core__mailboxT__messages (us_split_fields3 self__13)) o25)))
(assert (=> (< (to_rep2 self__3) 16) (= (rec__core__mailboxT__next_in (us_split_fields3 self__13)) o26)))
(assert (=> (< (to_rep2 self__3) 16) (= (rec__core__mailboxT__next_out (us_split_fields3 self__13)) o27)))
(assert (=> (< (to_rep2 self__3) 16) (= o24 o28)))
(assert (=> (< (to_rep2 self__3) 16) (= o29 o25)))
(assert (=> (< (to_rep2 self__3) 16) (= o30 o26)))
(assert (=> (< (to_rep2 self__3) 16) (= o31 o27)))
(assert (=> (< (to_rep2 self__3) 16) (= o32 o28)))
(assert (=> (< (to_rep2 self__3) 16) (= result6 (mk_mailboxT__ref self__13))))
(assert (=> (< (to_rep2 self__3) 16) (= self__14 (mk___rep1 (mk___split_fields1 o29 o30 o31 o32)))))
(assert (=> (not (< (to_rep2 self__3) 16)) (= self__14 (mk___rep1 (mk___split_fields1 self__ self__1 self__2 self__3)))))
(assert (=> (not (< (to_rep2 self__3) 16)) (= self__14 (mk___rep1 (mk___split_fields1 self__4 self__5 self__6 self__7)))))
(assert (= self__15 (mk_mailboxT__ref self__14)))
(assert (= self__16 self__14))
(assert (not (< 0 (item_count (mailboxT__content self__15)))))
(check-sat)
(exit)
