...
(assert (not (= (length1 (mk___rep char_table__split_discrs char_table__split_fields2)) (+ (length1 (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) i1))))
(check-sat)
(exit)
