...
(define-fun tregister_byte_arrayP1__ref___46__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___19__projection ((a target__ref)) us_t1 (target__content a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__agc_tune2_type__agc_tune2 bits_32)))))
(define-fun us_split_fields_AGC_TUNE2__projection ((a us_split_fields)) bits_32 (rec__dw1000__register_types__agc_tune2_type__agc_tune2 a))
...
(define-fun us_rep___28__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__agc_tune2_type__agc_tune2 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__agc_tune2_type__agc_tune2 (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__agc_tune2_type__agc_tune2__first__bit Int)
(declare-const dw1000__register_types__agc_tune2_type__agc_tune2__last__bit Int)
(declare-const dw1000__register_types__agc_tune2_type__agc_tune2__position Int)
(assert (<= 0 dw1000__register_types__agc_tune2_type__agc_tune2__first__bit))
(assert (< dw1000__register_types__agc_tune2_type__agc_tune2__first__bit dw1000__register_types__agc_tune2_type__agc_tune2__last__bit))
(assert (<= 0 dw1000__register_types__agc_tune2_type__agc_tune2__position))
(declare-fun user_eq7 (us_rep us_rep) Bool)
(declare-const dummy7 us_rep)
(declare-datatypes () ((agc_tune2_type__ref (mk_agc_tune2_type__ref (agc_tune2_type__content us_rep)))))
(define-fun agc_tune2_type__ref___projection ((a agc_tune2_type__ref)) us_rep (agc_tune2_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___19__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_3938 us_t1) (temp___is_init_3934 Bool) (temp___skip_constant_3935 Bool) (temp___do_toplevel_3936 Bool) (temp___do_typ_inv_3937 Bool)) Bool (=> (not (= temp___skip_constant_3935 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3938) (last3 temp___expr_3938)) (and (= (first3 temp___expr_3938) 1) (= (last3 temp___expr_3938) 4)))))
...
(define-fun register_type__ref___64__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___46__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_3920 us_t2) (temp___is_init_3916 Bool) (temp___skip_constant_3917 Bool) (temp___do_toplevel_3918 Bool) (temp___do_typ_inv_3919 Bool)) Bool (=> (not (= temp___skip_constant_3917 true)) (and (dynamic_property3 1 4 (first5 temp___expr_3920) (last5 temp___expr_3920)) (and (= (first5 temp___expr_3920) 1) (= (last5 temp___expr_3920) 4)))))
...
(declare-const temp___8612 (Array Int bits_8))
(declare-const temp___86121 t1)
(declare-const temp___8613 (Array Int bits_8))
(declare-const temp___86131 t2)
(define-fun temp___86122 () us_t1 (mk___t1 temp___8612 temp___86121))
...
(assert (and (= temp___86122 (register_to_bytes reg)) (dynamic_invariant temp___86122 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___86121)) (to_rep (last2 temp___86121))) (+ (- (to_rep (last2 temp___86121)) (to_rep (first2 temp___86121))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8612 temp___8613))
(assert (= (mk2 (to_rep (first2 temp___86121)) (to_rep (last2 temp___86121))) temp___86131))
(assert (not (= (ite (<= (to_rep (first4 temp___86131)) (to_rep (last4 temp___86131))) (+ (- (to_rep (last4 temp___86131)) (to_rep (first4 temp___86131))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
