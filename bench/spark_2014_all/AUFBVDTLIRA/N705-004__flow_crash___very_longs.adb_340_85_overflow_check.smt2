...
(assert (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= o i1))
(assert (= o1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) o)))
(assert (= o2 (to_rep2 o1)))
(assert (= o3 (ite (= o2 #x00) true false)))
