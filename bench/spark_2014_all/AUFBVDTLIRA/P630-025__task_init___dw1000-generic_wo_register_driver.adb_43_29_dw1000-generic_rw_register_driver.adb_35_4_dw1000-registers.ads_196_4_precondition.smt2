...
(assert (= (ite (<= (to_rep (first2 temp___84651)) (to_rep (last2 temp___84651))) (+ (- (to_rep (last2 temp___84651)) (to_rep (first2 temp___84651))) 1) 0) (ite (<= 1 8) (+ (- 8 1) 1) 0)))
(assert (= temp___8465 temp___8466))
(assert (= (mk2 (to_rep (first2 temp___84651)) (to_rep (last2 temp___84651))) temp___84661))
(assert (= (ite (<= (to_rep (first4 temp___84661)) (to_rep (last4 temp___84661))) (+ (- (to_rep (last4 temp___84661)) (to_rep (first4 temp___84661))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8466 temp___84661)))
(assert (= o2 o))
