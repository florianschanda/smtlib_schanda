...
(assert (and (= o7 o6) (in_range13 o6)))
(assert (and (= o8 (get (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) o7)) (and (in_range9 o8) (= o8 (get (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) o7)))))
(assert (= (to_rep o9) o8))
