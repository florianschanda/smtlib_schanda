...
(declare-fun temp_____aggregate_def_186 ((_ BitVec 8) (_ BitVec 64) (_ BitVec 64)) us_t1)
...
(assert (forall ((temp___188 (_ BitVec 8))) (forall ((temp___189 (_ BitVec 64)) (temp___190 (_ BitVec 64))) (let ((temp___187 (temp_____aggregate_def_186 temp___188 temp___189 temp___190))) (=> (dynamic_invariant1 temp___188 true true true true) (and (=> (dynamic_property #x0000000000000000 #xFFFFFFFFFFFFFFFF temp___189 temp___190) (and (= (first3 temp___187) temp___189) (= (last3 temp___187) temp___190))) (forall ((temp___191 (_ BitVec 64))) (= (to_rep1 (select (to_array1 temp___187) temp___191)) temp___188))))))))
...
(assert (= (to_rep (first2 (rt1 (temp_____aggregate_def_186 #x00 (to_rep x__first) (to_rep x__last))))) (to_rep x__first)))
(assert (= (to_rep (last2 (rt1 (temp_____aggregate_def_186 #x00 (to_rep x__first) (to_rep x__last))))) (to_rep x__last)))
(assert (= (mk___t1 temp___193 temp___1931) (temp_____aggregate_def_186 #x00 (to_rep x__first) (to_rep x__last))))
