...
(assert (= (= o11 true) (forall ((k Int)) (=> (and (<= i2 k) (<= k a_last)) (= (to_rep1 (select a1 k)) (to_rep1 (select a k)))))))
...
(assert (= o3 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first o2)))
