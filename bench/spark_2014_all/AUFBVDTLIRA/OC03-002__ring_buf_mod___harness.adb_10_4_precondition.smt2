...
(define-fun r__split_fields3 () us_split_fields (mk___split_fields r__split_fields r__split_fields1 r__split_fields2))
(assert (in_range x))
(assert (in_range y))
(assert (in_range z))
(assert (=> (<= (- 2147483648) 2147483647) (in_range h)))
(assert (= (let ((temp___250 (to_model (mk___rep r__split_fields3)))) (bool_eq (elts temp___250) (to_rep (first (rt temp___250))) (to_rep (last (rt temp___250))) (temp_____aggregate_def_246 0) #x0001 #x0000)) true))
(assert (not (not (= (is_full (mk___rep r__split_fields3)) true))))
(check-sat)
(exit)
