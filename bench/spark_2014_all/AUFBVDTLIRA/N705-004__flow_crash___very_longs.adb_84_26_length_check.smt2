...
(assert (not (= (ite (<= (to_rep1 (first2 temp___12481)) (to_rep1 (last2 temp___12481))) (+ (- (to_rep1 (last2 temp___12481)) (to_rep1 (first2 temp___12481))) 1) 0) (ite (<= (to_rep1 (first result____split_fields1)) (to_rep1 (last result____split_fields1))) (+ (- (to_rep1 (last result____split_fields1)) (to_rep1 (first result____split_fields1))) 1) 0))))
(check-sat)
(exit)
