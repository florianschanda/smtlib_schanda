...
(assert (=> (and (< begidx2 zlength) (< endidx1 zlength)) (and (and (and (and (<= begidx4 endidx2) (<= begidx4 zlength)) (<= endidx2 zlength)) (=> (= foundtype2 1) (forall ((i Int)) (=> (and (<= begidx4 i) (<= i endidx2)) (and (<= 48 (to_rep (select zonefileline i))) (<= (to_rep (select zonefileline i)) 57)))))) (and (and (in_range4 begidx4) (in_range4 endidx2)) (in_range3 foundtype2)))))
