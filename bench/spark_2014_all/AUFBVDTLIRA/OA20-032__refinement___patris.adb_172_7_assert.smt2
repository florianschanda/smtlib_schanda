...
(declare-const temp___2437 (_ BitVec 32))
(declare-const temp___2436 Int)
(declare-const temp___2434 (Array Int (Array Int cell)))
...
(assert (= del_line1 1))
(assert (=> (and (<= 1 del_line1) (<= del_line1 20)) (= temp___2438 del_line1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 20)) (= temp___2437 complete_lines1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 20)) (= temp___2436 to_line1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 20)) (= temp___2434 cur_board)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 20)) (and (= result3 (is_complete_line (select cur_board del_line1))) (= (= result3 true) (forall ((x Int)) (=> (and (<= 1 x) (<= x 10)) (not (= (to_rep4 (select (select cur_board del_line1) x)) 0))))))))
...
(assert (=> (and (<= 1 del_line1) (<= del_line1 20)) (=> (= result3 true) (= (to_rep4 (select (select cur_board2 del_line1) 1)) 0))))
...
(assert (=> (and (<= 1 del_line1) (<= del_line1 20)) (and (and (and (and (forall ((temp___2435 Int)) (=> (and (<= 1 temp___2435) (<= temp___2435 20)) (=> (or (< 20 temp___2435) (or (< temp___2435 1) (< del_line2 temp___2435))) (= (select cur_board3 temp___2435) (select temp___2434 temp___2435))))) (=> (<= 1 20) (in_range9 to_line3))) (=> (bvule #x00000000 #x0001869F) (in_range8 complete_lines3))) (=> (<= 1 20) (in_range9 del_line2))) (and (<= 1 del_line2) (<= del_line2 20)))))
...
(assert (not (= (no_complete_lines (map__content1 cur_board6)) true)))
(check-sat)
(exit)
