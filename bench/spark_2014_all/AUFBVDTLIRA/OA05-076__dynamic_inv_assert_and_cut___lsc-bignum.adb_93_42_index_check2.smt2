...
(assert (= o26 (ite (<= b_first k) o25 false)))
(assert (= result2 (ite (not (= o26 true)) true false)))
(assert (=> (= result2 true) (and (<= (to_rep b__first) k) (<= k (to_rep b__last)))))
(assert (=> (= result2 true) (= o29 k)))
(assert (=> (= result2 true) (= o30 (select b o29))))
(assert (=> (= result2 true) (= o31 (to_rep1 o30))))
(assert (=> (= result2 true) (and (<= (to_rep b__first) k) (<= k (to_rep b__last)))))
(assert (=> (= result2 true) (= o27 k)))
(assert (=> (= result2 true) (= o28 (select b2 o27))))
(assert (=> (= result2 true) (= o32 (to_rep1 o28))))
(assert (=> (= result2 true) (= o33 (ite (= o32 o31) true false))))
(assert (=> (not (= result2 true)) (= o33 (distinct 1 0))))
...
(assert (and (= temp___631 o17) (in_range1 o17)))
(assert (not (<= (to_rep (first (rt a))) temp___631)))
(check-sat)
(exit)
