...
(assert (< 65535 (- (+ (bv2nat (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r)))) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r)))) 1)))
(assert (and (= o (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r)))) (uint_in_range (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))))
