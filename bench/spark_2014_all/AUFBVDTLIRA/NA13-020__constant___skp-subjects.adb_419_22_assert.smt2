...
(assert (not (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs 3)))) #x0000000000001000) #x0000000000000000)))
(check-sat)
(exit)
