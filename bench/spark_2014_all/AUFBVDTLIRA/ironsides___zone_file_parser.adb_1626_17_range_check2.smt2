...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= tokentype1 1) (forall ((i7 Int)) (=> (and (<= begidx2 i7) (<= i7 endidx1)) (and (<= 48 (to_rep (select zonefileline i7))) (<= (to_rep (select zonefileline i7)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 tokentype1))))
...
(assert (= i1 r109b))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= temp___1832 token1)))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= temp___1834 i1)))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (and (<= 1 begidx2) (<= begidx2 endidx1))))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (and (=> (<= r109b r110b) (dynamic_property r109b r110b i2)) (and (<= r109b i2) (<= i2 r110b)))))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= (to_rep o3) (to_rep (select zonefileline i2)))))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (and (= o1 (+ i2 1)) (in_range1 (+ i2 1)))))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= o2 (- o1 begidx2))))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (and (= temp___1831 o2) (in_range1 o2))))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (and (<= 1 temp___1831) (<= temp___1831 256))))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= o4 temp___1831)))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= o5 (store token2 o4 o3))))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= result5 (mk_map__ref token2))))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= token3 o5)))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= i2 r110b)))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= token4 (mk_map__ref token3))))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= i4 i2)))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= token5 token3)))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= i5 i3)))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= token6 token4)))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= i6 i4)))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= token7 token5)))
(assert (=> (not (and (<= r109b i1) (<= i1 r110b))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= r109b i1) (<= i1 r110b))) (= token6 (mk_map__ref token1))))
(assert (=> (not (and (<= r109b i1) (<= i1 r110b))) (= i6 i1)))
(assert (=> (not (and (<= r109b i1) (<= i1 r110b))) (= token7 token1)))
