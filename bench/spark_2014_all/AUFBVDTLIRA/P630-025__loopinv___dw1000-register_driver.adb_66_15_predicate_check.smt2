...
(declare-const temp___864 bits_6)
(declare-const temp___8641 sub_index_type)
(declare-const temp___8642 operation_type)
(declare-const temp___8643 bits_7)
(declare-const temp___8644 extended_address_type)
...
(assert (= o1 o8))
(assert (= o o9))
(assert (= temp___864 o5))
(assert (= temp___8641 o6))
(assert (= temp___8642 o7))
(assert (= temp___8643 o8))
(assert (= temp___8644 o9))
(assert (not (= (to_rep6 temp___8644) 0)))
(check-sat)
(exit)
