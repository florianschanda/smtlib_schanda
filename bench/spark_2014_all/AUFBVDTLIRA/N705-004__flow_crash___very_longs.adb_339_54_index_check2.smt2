...
(assert (= (= o6 true) (exists ((j1 Int)) (and (and (<= (+ i2 1) j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (not (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j1)) #x00))))))
(assert (not (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) digit_index3)))
(check-sat)
(exit)
