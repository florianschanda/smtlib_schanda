...
(define-fun target__ref___16__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (bool_eq (rec__dw1000__register_types__usr_sfd_type__sub_registers (us_split_fields1 a)) 0 40 (rec__dw1000__register_types__usr_sfd_type__sub_registers (us_split_fields1 b)) 0 40) true) true false))
...
(define-fun dynamic_invariant ((temp___expr_3740 us_t1) (temp___is_init_3736 Bool) (temp___skip_constant_3737 Bool) (temp___do_toplevel_3738 Bool) (temp___do_typ_inv_3739 Bool)) Bool (=> (not (= temp___skip_constant_3737 true)) (and (dynamic_property2 1 41 (first3 temp___expr_3740) (last3 temp___expr_3740)) (and (= (first3 temp___expr_3740) 1) (= (last3 temp___expr_3740) 41)))))
...
(define-fun register_byte_array__ref___40__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_3719 us_t2) (temp___is_init_3715 Bool) (temp___skip_constant_3716 Bool) (temp___do_toplevel_3717 Bool) (temp___do_typ_inv_3718 Bool)) Bool (=> (not (= temp___skip_constant_3716 true)) (and (dynamic_property3 1 41 (first5 temp___expr_3719) (last5 temp___expr_3719)) (and (= (first5 temp___expr_3719) 1) (= (last5 temp___expr_3719) 41)))))
...
(declare-const temp___85891 t1)
(declare-const temp___8590 (Array Int bits_8))
(declare-const temp___85901 t2)
...
(define-fun temp___85892 () us_t1 (mk___t1 temp___8589 temp___85891))
(assert (and (dynamic_property3 1 41 (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 41))))
(assert (and (= temp___85892 (register_to_bytes reg)) (dynamic_invariant temp___85892 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___85891)) (to_rep (last2 temp___85891))) (+ (- (to_rep (last2 temp___85891)) (to_rep (first2 temp___85891))) 1) 0) (ite (<= 1 41) (+ (- 41 1) 1) 0)))
(assert (= temp___8589 temp___8590))
(assert (= (mk2 (to_rep (first2 temp___85891)) (to_rep (last2 temp___85891))) temp___85901))
(assert (= (ite (<= (to_rep (first4 temp___85901)) (to_rep (last4 temp___85901))) (+ (- (to_rep (last4 temp___85901)) (to_rep (first4 temp___85901))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8590 temp___85901)))
(assert (= o2 o))
