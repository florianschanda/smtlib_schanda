...
(declare-const temp___413 (_ BitVec 32))
(declare-const result1 (_ BitVec 32))
(declare-const temp___4131 (_ BitVec 32))
...
(assert (= result1 temp___413))
(assert (= temp___4131 (ecx rcx1)))
...
(assert (not (bvult (ecx rcx2) temp___4131)))
(check-sat)
(exit)
