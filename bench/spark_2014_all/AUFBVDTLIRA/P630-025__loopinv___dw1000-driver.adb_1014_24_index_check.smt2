...
(declare-const temp___3724 Int)
(declare-const temp___3725 Int)
...
(assert (= temp___3724 (- o2 1)))
(assert (= result1 i))
(assert (= i1 0))
(assert (<= 0 i1))
(assert (<= i1 temp___3724))
(assert (and (<= 0 i2) (<= i2 (- (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0) 1))))
(assert (and (= temp___3725 (+ a_first i2)) (in_range1 (+ a_first i2))))
(assert (and (<= (to_rep (first (rt addresses))) temp___3725) (<= temp___3725 (to_rep (last (rt addresses))))))
(assert (= o3 temp___3725))
...
(assert (and (= temp___3727 (+ d_first i2)) (in_range1 (+ d_first i2))))
(assert (not (<= temp___3727 (to_rep data__last))))
(check-sat)
(exit)
