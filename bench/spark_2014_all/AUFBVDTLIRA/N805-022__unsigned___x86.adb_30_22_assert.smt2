...
(assert (=> (and (= (bvadd ((_ zero_extend 24) (to_rep (select xcx4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 1))) #x00000100)) (bvurem val__ #x00010000)) (= (bvadd ((_ zero_extend 24) (to_rep (select xcx4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 3))) #x00000100)) (bvurem (bvudiv val__ #x00010000) #x00010000))) (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 3))) #x01000000)) val__)))
(assert (not (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 3))) #x01000000)) val__)))
(check-sat)
(exit)
