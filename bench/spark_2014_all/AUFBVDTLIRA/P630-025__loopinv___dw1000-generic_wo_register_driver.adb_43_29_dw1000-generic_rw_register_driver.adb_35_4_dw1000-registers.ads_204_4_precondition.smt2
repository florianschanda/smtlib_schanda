...
(declare-const temp___8480 (Array Int bits_8))
(declare-const temp___84801 t2)
...
(assert (= (ite (<= (to_rep (first2 temp___84791)) (to_rep (last2 temp___84791))) (+ (- (to_rep (last2 temp___84791)) (to_rep (first2 temp___84791))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8479 temp___8480))
(assert (= (mk2 (to_rep (first2 temp___84791)) (to_rep (last2 temp___84791))) temp___84801))
(assert (= (ite (<= (to_rep (first4 temp___84801)) (to_rep (last4 temp___84801))) (+ (- (to_rep (last4 temp___84801)) (to_rep (first4 temp___84801))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8480 temp___84801)))
(assert (= o2 o))
