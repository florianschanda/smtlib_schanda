...
(assert (= temp___1099 (- o12 1)))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1099) (<= temp___1099 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))))
...
(assert (= (to_rep2 o19) o18))
(assert (and (= o17 (+ i2 j2)) (in_range2 (+ i2 j2))))
(assert (= temp___1101 (- o17 1)))
