...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select o31 k)) #x00000000))))
(assert (= (mk_t__ref result) (mk_t__ref a_msw)))
(assert (= a_msw1 #x00000000))
(assert (= (mk_int__ref result1) (mk_int__ref i)))
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___684 o31)))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (omod (oadd (num_of_big_int (mk___t o32 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o32 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (and (<= a_first i2) (<= i2 a_last)))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (omod (oadd (num_of_big_int (mk___t o33 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw3))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- (+ i2 1) a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- (+ i2 1) a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o33 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw3))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o34 (mk_map__ref o33))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a (mk_map__ref o33))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o35 o33)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o36 o34)))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o37 o35)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= o36 (mk_map__ref o31))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a1 (mk_map__ref o31))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= o37 o31)))
...
(assert (= o24 (omultiply o11 o23)))
(assert (= o30 (omod o24 o29)))
