...
(declare-fun temp_____aggregate_def_292 (Int Int Int) us_t1)
...
(assert (forall ((temp___294 Int) (temp___295 Int) (temp___296 Int)) (let ((temp___293 (temp_____aggregate_def_292 temp___294 temp___295 temp___296))) (=> (dynamic_invariant5 temp___294 true true true true) (and (=> (dynamic_property 1 2147483647 temp___295 temp___296) (and (= (first3 temp___293) temp___295) (= (last3 temp___293) temp___296))) (forall ((temp___297 Int)) (= (to_rep (select (to_array1 temp___293) temp___297)) temp___294)))))))
...
(assert (= (to_rep1 (first2 (rt1 (temp_____aggregate_def_292 32 (to_rep1 buffer__first) (to_rep1 buffer__last))))) (to_rep1 buffer__first)))
(assert (= (to_rep1 (last2 (rt1 (temp_____aggregate_def_292 32 (to_rep1 buffer__first) (to_rep1 buffer__last))))) (to_rep1 buffer__last)))
(assert (= (mk___t1 temp___299 temp___2991) (temp_____aggregate_def_292 32 (to_rep1 buffer__first) (to_rep1 buffer__last))))
...
(assert (= status1 0))
(assert (not (<= count1 (ite (<= (to_rep1 buffer__first) (to_rep1 buffer__last)) (+ (- (to_rep1 buffer__last) (to_rep1 buffer__first)) 1) 0))))
(check-sat)
(exit)
