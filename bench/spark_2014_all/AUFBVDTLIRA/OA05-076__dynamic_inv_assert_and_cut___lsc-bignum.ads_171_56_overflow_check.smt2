...
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___684 o20)))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o23 (mk_map__ref o22))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a (mk_map__ref o22))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o24 o22)))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= o25 (mk_map__ref o20))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a1 (mk_map__ref o20))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= o26 o20)))
...
(assert (=> (= result2 true) (= (oeq (osubtract (num_of_big_int (mk___t (map__content a1) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (osubtract (num_of_big_int (mk___t (let ((subject a1)) o27) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (num_of_boolean carry4)))) true)))
(assert (=> (= result2 true) (= o28 (mk_map__ref o27))))
(assert (=> (= result2 true) (= carry5 (mk_bool__ref carry4))))
(assert (=> (= result2 true) (= a2 (mk_map__ref o27))))
(assert (=> (= result2 true) (= carry6 carry4)))
(assert (=> (= result2 true) (= o29 o27)))
(assert (=> (not (= result2 true)) (= o28 o25)))
