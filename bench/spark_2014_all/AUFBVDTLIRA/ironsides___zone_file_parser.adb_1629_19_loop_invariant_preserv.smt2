...
(declare-const newowner4 map__ref)
(declare-const i11 int__ref)
(declare-const newowner5 (Array Int character))
...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= tokentype1 1) (forall ((i13 Int)) (=> (and (<= begidx2 i13) (<= i13 endidx1)) (and (<= 48 (to_rep (select zonefileline i13))) (<= (to_rep (select zonefileline i13)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 tokentype1))))
...
(assert (and (<= 1 i9) (<= i9 128)))
(assert (= o7 i9))
(assert (= o8 (store newowner2 o7 o6)))
(assert (= result8 (mk_map__ref newowner2)))
(assert (= newowner3 o8))
(assert (not (= i9 r112b)))
(assert (= result9 (mk_int__ref i9)))
(assert (= i10 (+ i9 1)))
(assert (= i11 (mk_int__ref i10)))
(assert (= newowner4 (mk_map__ref newowner3)))
(assert (= i12 i10))
(assert (= newowner5 newowner3))
