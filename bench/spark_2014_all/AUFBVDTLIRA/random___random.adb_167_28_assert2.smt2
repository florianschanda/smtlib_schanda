...
(define-fun x7 () t__ref (mk_t__ref x4))
(define-fun g__split_fields11 () us_split_fields (mk___split_fields g__split_fields6 g__split_fields7))
...
(assert (= (bvadd (bvurem #xFFFFFFFF n) #x00000001) slop))
(assert (and (= g__split_fields temp___367) (= g__split_fields1 temp___3671)))
(assert (= temp___366 x))
(assert (or (= slop n) (bvule x1 (bvsub #xFFFFFFFF slop))))
(assert (= x1 x2))
(assert (= g__split_fields4 g__split_fields2))
(assert (= g__split_fields5 g__split_fields3))
(assert (= x3 x1))
(assert (= g__split_fields11 (mk___split_fields g__split_fields2 g__split_fields3)))
(assert (= x7 (mk_t__ref x2)))
(assert (= (mk___split_fields__ref (mk___split_fields g__split_fields8 g__split_fields9)) (mk___split_fields__ref (mk___split_fields g__split_fields4 g__split_fields5))))
(assert (= x5 x3))
(assert (= g__split_fields10 g__split_fields11))
(assert (= result x7))
(assert (= x6 (bvurem x4 n)))
(assert (not (bvule #x00000000 x6)))
(check-sat)
(exit)
