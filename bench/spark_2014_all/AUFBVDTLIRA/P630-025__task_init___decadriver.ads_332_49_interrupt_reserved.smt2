...
(define-fun us_split_fields__ref___143__projection ((a us_split_fields__ref1)) us_split_fields2 (us_split_fields__content1 a))
(declare-datatypes () ((us_rep1 (mk___rep1 (us_split_fields3 us_split_fields2)))))
(define-fun us_rep___145__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
...
(define-fun default_initial_assumption ((temp___expr_5039 us_rep1) (temp___skip_top_level_5040 Bool)) Bool (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep4 (rec__decadriver__driver_type__part_id (us_split_fields3 temp___expr_5039))) #x00000000) (= (to_rep4 (rec__decadriver__driver_type__lot_id (us_split_fields3 temp___expr_5039))) #x00000000)) (= (to_rep5 (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields3 temp___expr_5039))) #x0000)) (= (to_rep5 (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields3 temp___expr_5039))) #x0000)) (= (to_rep3 (rec__decadriver__driver_type__xtal_trim (us_split_fields3 temp___expr_5039))) #x10)) (= (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields3 temp___expr_5039)) (temp_____aggregate_def_5041 #x00000000))) (= (rec__decadriver__driver_type__long_frames (us_split_fields3 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields3 temp___expr_5039)) (mk___rep (mk___split_fields (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep1 #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep2 #x00) (of_rep3 #x00))))) (= (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields3 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields3 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields3 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields3 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_phr_error (us_split_fields3 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_rs_error (us_split_fields3 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_fcs_error (us_split_fields3 temp___expr_5039)) (distinct 0 0))))
...
(assert (forall ((temp___5043 (_ BitVec 32))) (=> (dynamic_invariant temp___5043 true true true true) (forall ((temp___5044 Int)) (= (to_rep4 (select (temp_____aggregate_def_5041 temp___5043) temp___5044)) temp___5043)))))
...
(declare-const temp___5143 Bool)
(assert (not (= temp___5143 false)))
(check-sat)
(exit)
