...
(assert (< 0 (length a)))
(assert (and (= result1 (has_key (model__ m) e)) (= (= result1 true) (= (has_key (model__ m) e) true))))
(assert (=> (= result1 true) (and (= o1 (get (model__ m) e)) (and (in_range3 o1) (= o1 (get (model__ m) e))))))
(assert (=> (= result1 true) (= o2 (ite (<= o1 (to_rep3 (last (rt a)))) true false))))
(assert (=> (= result1 true) (and (= o (get (model__ m) e)) (and (in_range3 o) (= o (get (model__ m) e))))))
(assert (=> (= result1 true) (= o3 (ite (<= (to_rep3 (first (rt a))) o) true false))))
(assert (=> (= result1 true) (= result (ite (= o3 true) o2 false))))
(assert (=> (not (= result1 true)) (= result (distinct 1 0))))
(assert (= result true))
(assert (<= (to_rep3 (first (rt a))) (- (get (model__ m) e) 1)))
(assert (not (<= 1 (to_rep3 (first (rt a))))))
(check-sat)
(exit)
