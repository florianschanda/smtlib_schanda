...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i34 Int)) (=> (and (<= begidx2 i34) (<= i34 endidx1)) (and (<= 48 (to_rep (select zonefileline i34))) (<= (to_rep (select zonefileline i34)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 foundtype1))))
...
(assert (=> (and (not (= foundtype1 3)) (< endidx1 zlength)) (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i34 Int)) (=> (and (<= begidx5 i34) (<= i34 endidx3)) (and (<= 48 (to_rep (select zonefileline i34))) (<= (to_rep (select zonefileline i34)) 57)))))) (and (and (in_range4 begidx5) (in_range4 endidx3)) (in_range3 foundtype3)))))
...
(assert (= begidx10 o1))
(assert (and (and (and (and (<= begidx11 endidx8) (<= begidx11 zlength)) (<= endidx8 zlength)) (=> (= foundtype8 1) (forall ((i34 Int)) (=> (and (<= begidx11 i34) (<= i34 endidx8)) (and (<= 48 (to_rep (select zonefileline i34))) (<= (to_rep (select zonefileline i34)) 57)))))) (and (and (in_range4 begidx11) (in_range4 endidx8)) (in_range3 foundtype8))))
(assert (= foundtype8 1))
...
(assert (= i5 r83b))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= temp___1762 i5)))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= temp___1761 tmpval1)))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= temp___1760 digitval)))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (and (<= 1 begidx11) (bvule tmpval2 #x7FFF))))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (and (=> (<= r83b r84b) (dynamic_property r83b r84b i6)) (and (<= r83b i6) (<= i6 r84b)))))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= result9 (mk_t__ref digitval2))))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= digitval3 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i6))) #x0030))))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= result10 (mk_t__ref tmpval2))))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= tmpval3 (bvadd (bvmul #x000A tmpval2) digitval3))))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (or (bvugt tmpval3 #x7FFF) (and (not (bvugt tmpval3 #x7FFF)) (= i6 r84b)))))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= i7 (mk_int__ref i6))))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= tmpval4 (mk_t__ref tmpval3))))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= digitval4 (mk_t__ref digitval3))))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= i8 i6)))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= tmpval5 tmpval3)))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= digitval5 digitval3)))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= i9 i7)))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= tmpval6 tmpval4)))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= digitval6 digitval4)))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= i10 i8)))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= tmpval7 tmpval5)))
(assert (=> (and (<= r83b i5) (<= i5 r84b)) (= digitval7 digitval5)))
(assert (=> (not (and (<= r83b i5) (<= i5 r84b))) (= i9 (mk_int__ref i5))))
(assert (=> (not (and (<= r83b i5) (<= i5 r84b))) (= tmpval6 (mk_t__ref tmpval1))))
(assert (=> (not (and (<= r83b i5) (<= i5 r84b))) (= digitval6 (mk_t__ref digitval))))
(assert (=> (not (and (<= r83b i5) (<= i5 r84b))) (= i10 i5)))
(assert (=> (not (and (<= r83b i5) (<= i5 r84b))) (= tmpval7 tmpval1)))
(assert (=> (not (and (<= r83b i5) (<= i5 r84b))) (= digitval7 digitval1)))
...
(assert (= begidx12 o2))
(assert (and (and (and (and (<= begidx13 endidx9) (<= begidx13 zlength)) (<= endidx9 zlength)) (=> (= foundtype9 1) (forall ((i34 Int)) (=> (and (<= begidx13 i34) (<= i34 endidx9)) (and (<= 48 (to_rep (select zonefileline i34))) (<= (to_rep (select zonefileline i34)) 57)))))) (and (and (in_range4 begidx13) (in_range4 endidx9)) (in_range3 foundtype9))))
(assert (= foundtype9 1))
...
(assert (= i11 r86b))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= temp___1767 i11)))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= temp___1766 tmpval8)))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= temp___1765 (t__content digitval6))))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (and (<= 1 begidx13) (bvule tmpval9 #x7FFF))))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (and (=> (<= r86b r87b) (dynamic_property1 r86b r87b i12)) (and (<= r86b i12) (<= i12 r87b)))))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= result15 (mk_t__ref digitval8))))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= digitval9 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i12))) #x0030))))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= result16 (mk_t__ref tmpval9))))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= tmpval10 (bvadd (bvmul #x000A tmpval9) digitval9))))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (or (bvugt tmpval10 #x7FFF) (and (not (bvugt tmpval10 #x7FFF)) (= i12 r87b)))))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= i13 (mk_int__ref i12))))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= tmpval11 (mk_t__ref tmpval10))))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= digitval10 (mk_t__ref digitval9))))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= i14 i12)))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= tmpval12 tmpval10)))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= digitval11 digitval9)))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= i15 i13)))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= tmpval13 tmpval11)))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= digitval12 digitval10)))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= i16 i14)))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= tmpval14 tmpval12)))
(assert (=> (and (<= r86b i11) (<= i11 r87b)) (= digitval13 digitval11)))
(assert (=> (not (and (<= r86b i11) (<= i11 r87b))) (= i15 (mk_int__ref i11))))
(assert (=> (not (and (<= r86b i11) (<= i11 r87b))) (= tmpval13 (mk_t__ref tmpval8))))
(assert (=> (not (and (<= r86b i11) (<= i11 r87b))) (= digitval12 digitval6)))
(assert (=> (not (and (<= r86b i11) (<= i11 r87b))) (= i16 i11)))
(assert (=> (not (and (<= r86b i11) (<= i11 r87b))) (= tmpval14 tmpval8)))
(assert (=> (not (and (<= r86b i11) (<= i11 r87b))) (= digitval13 digitval7)))
...
(assert (= begidx14 o3))
(assert (and (and (and (and (<= begidx15 endidx10) (<= begidx15 zlength)) (<= endidx10 zlength)) (=> (= foundtype10 1) (forall ((i34 Int)) (=> (and (<= begidx15 i34) (<= i34 endidx10)) (and (<= 48 (to_rep (select zonefileline i34))) (<= (to_rep (select zonefileline i34)) 57)))))) (and (and (in_range4 begidx15) (in_range4 endidx10)) (in_range3 foundtype10))))
...
(assert (= i17 r89b))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= temp___1772 i17)))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= temp___1771 tmpval15)))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= temp___1770 (t__content digitval12))))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (and (<= 1 begidx15) (bvule tmpval16 #x7FFF))))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (and (=> (<= r89b r90b) (dynamic_property2 r89b r90b i18)) (and (<= r89b i18) (<= i18 r90b)))))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= result21 (mk_t__ref digitval14))))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= digitval15 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i18))) #x0030))))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= result22 (mk_t__ref tmpval16))))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= tmpval17 (bvadd (bvmul #x000A tmpval16) digitval15))))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (or (bvugt tmpval17 #x7FFF) (and (not (bvugt tmpval17 #x7FFF)) (= i18 r90b)))))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= i19 (mk_int__ref i18))))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= tmpval18 (mk_t__ref tmpval17))))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= digitval16 (mk_t__ref digitval15))))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= i20 i18)))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= tmpval19 tmpval17)))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= digitval17 digitval15)))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= i21 i19)))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= tmpval20 tmpval18)))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= digitval18 digitval16)))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= i22 i20)))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= tmpval21 tmpval19)))
(assert (=> (and (<= r89b i17) (<= i17 r90b)) (= digitval19 digitval17)))
(assert (=> (not (and (<= r89b i17) (<= i17 r90b))) (= i21 (mk_int__ref i17))))
(assert (=> (not (and (<= r89b i17) (<= i17 r90b))) (= tmpval20 (mk_t__ref tmpval15))))
(assert (=> (not (and (<= r89b i17) (<= i17 r90b))) (= digitval18 digitval12)))
(assert (=> (not (and (<= r89b i17) (<= i17 r90b))) (= i22 i17)))
(assert (=> (not (and (<= r89b i17) (<= i17 r90b))) (= tmpval21 tmpval15)))
(assert (=> (not (and (<= r89b i17) (<= i17 r90b))) (= digitval19 digitval13)))
...
(assert (= begidx16 o4))
(assert (and (and (and (and (<= begidx17 endidx11) (<= begidx17 zlength)) (<= endidx11 zlength)) (=> (= foundtype11 1) (forall ((i34 Int)) (=> (and (<= begidx17 i34) (<= i34 endidx11)) (and (<= 48 (to_rep (select zonefileline i34))) (<= (to_rep (select zonefileline i34)) 57)))))) (and (and (in_range4 begidx17) (in_range4 endidx11)) (in_range3 foundtype11))))
...
(assert (= i23 r92b))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= temp___1779 endidx11)))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= temp___1777 newdomainname1)))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= temp___1776 i23)))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (and (and (<= 1 begidx17) (<= (+ (- endidx11 begidx17) 1) 128)) (= endidx11 temp___1779))))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (and (=> (<= r92b r93b) (dynamic_property3 r92b r93b i24)) (and (<= r92b i24) (<= i24 r93b)))))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= (to_rep o8) (to_rep (select zonefileline i24)))))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (and (= o6 (+ i24 1)) (in_range1 (+ i24 1)))))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= o7 (- o6 begidx17))))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (and (= temp___1775 o7) (in_range1 o7))))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (and (<= 1 temp___1775) (<= temp___1775 128))))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= o9 temp___1775)))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= o10 (store newdomainname2 o9 o8))))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= result27 (mk_map__ref newdomainname2))))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= newdomainname3 o10)))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= i24 r93b)))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= i25 (mk_int__ref i24))))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= newdomainname4 (mk_map__ref newdomainname3))))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= i26 i24)))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= newdomainname5 newdomainname3)))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= i27 i25)))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= newdomainname6 newdomainname4)))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= i28 i26)))
(assert (=> (and (<= r92b i23) (<= i23 r93b)) (= newdomainname7 newdomainname5)))
(assert (=> (not (and (<= r92b i23) (<= i23 r93b))) (= i27 (mk_int__ref i23))))
(assert (=> (not (and (<= r92b i23) (<= i23 r93b))) (= newdomainname6 (mk_map__ref newdomainname1))))
(assert (=> (not (and (<= r92b i23) (<= i23 r93b))) (= i28 i23)))
(assert (=> (not (and (<= r92b i23) (<= i23 r93b))) (= newdomainname7 newdomainname1)))
(assert (= (+ endidx11 1) r95b))
(assert (in_range1 r95b))
(assert (= result28 (mk_int__ref i4)))
(assert (= i29 r95b))
(assert (<= r95b i29))
(assert (<= i29 128))
(assert (<= 1 endidx11))
(assert (and (and (=> (<= r95b 128) (dynamic_property4 r95b 128 i30)) (forall ((temp___1784 Int)) (=> (and (<= 1 temp___1784) (<= temp___1784 128)) (=> (or (< 128 temp___1784) (or (< temp___1784 r95b) (<= i30 temp___1784))) (= (select newdomainname8 temp___1784) (select (map__content newdomainname6) temp___1784)))))) (and (<= r95b i30) (<= i30 128))))
(assert (= (to_rep o11) 32))
(assert (= o12 (store newdomainname8 i30 o11)))
(assert (= result29 (mk_map__ref newdomainname8)))
(assert (= newdomainname9 o12))
(assert (not (= i30 128)))
(assert (= result30 (mk_int__ref i30)))
(assert (= i31 (+ i30 1)))
