...
(assert (= begidx1 1))
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i14 Int)) (=> (and (<= begidx2 i14) (<= i14 endidx1)) (and (<= 48 (to_rep (select zonefileline i14))) (<= (to_rep (select zonefileline i14)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 foundtype1))))
...
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= temp___1533 timestring1)))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= temp___1537 zlength)))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= temp___1536 endidx1)))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= temp___1535 begidx2)))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= temp___1532 i2)))
(assert (=> (and (<= 1 i2) (<= i2 14)) (and (and (and (and (and (= begidx2 temp___1535) (= endidx1 temp___1536)) (= zlength temp___1537)) (<= endidx1 zlength)) (= (- endidx1 begidx2) 13)) (<= i3 14))))
(assert (=> (and (<= 1 i2) (<= i2 14)) (and (and (=> (<= 1 14) (in_range8 i3)) (forall ((temp___1534 Int)) (=> (and (<= 1 temp___1534) (<= temp___1534 14)) (=> (or (< 14 temp___1534) (or (< temp___1534 1) (<= i3 temp___1534))) (= (select timestring2 temp___1534) (select temp___1533 temp___1534)))))) (and (<= 1 i3) (<= i3 14)))))
...
(assert (= i8 1))
(assert (=> (and (<= 1 i8) (<= i8 14)) (= temp___1541 success1)))
(assert (=> (and (<= 1 i8) (<= i8 14)) (= temp___1540 i8)))
