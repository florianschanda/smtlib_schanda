...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__fixed_stream__object__width (us_split_fields1 a))) (to_rep2 (rec__fixed_stream__object__width (us_split_fields1 b)))) (= (bool_eq (rec__fixed_stream__object__name (us_split_fields1 a)) 1 20 (rec__fixed_stream__object__name (us_split_fields1 b)) 1 20) true)) true false))
...
(define-fun default_initial_assumption ((temp___expr_200 us_rep) (temp___skip_top_level_201 Bool)) Bool (and (= (attr__tag temp___expr_200) us_tag) (and (= (to_rep2 (rec__fixed_stream__object__width (us_split_fields1 temp___expr_200))) 0) (= (rec__fixed_stream__object__name (us_split_fields1 temp___expr_200)) (temp_____aggregate_def_202 0)))))
...
(declare-fun user_eq8 (tstream_element_offsetB tstream_element_offsetB) Bool)
(declare-const dummy8 tstream_element_offsetB)
...
(declare-fun user_eq9 (stream_element_offset stream_element_offset) Bool)
(declare-const dummy9 stream_element_offset)
...
(assert (forall ((a (Array Int stream_element)) (b (Array Int stream_element))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep4 (select a temp___idx_154)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_154)))))))))))
(declare-sort t1 0)
...
(define-fun bool_eq4 ((x us_t1) (y us_t1)) Bool (bool_eq3 (elts1 x) (to_rep3 (first2 (rt1 x))) (to_rep3 (last2 (rt1 x))) (elts1 y) (to_rep3 (first2 (rt1 y))) (to_rep3 (last2 (rt1 y)))))
...
(assert (forall ((temp___204 Int)) (=> (dynamic_invariant5 temp___204 true true true true) (forall ((temp___205 Int)) (= (to_rep (select (temp_____aggregate_def_202 temp___204) temp___205)) temp___204)))))
...
(declare-const i Int)
(declare-const fixed_stream__convert__result (Array Int stream_element))
(declare-const fixed_stream__convert__result1 t1)
(declare-const o Int)
...
(declare-const temp___303 (Array Int stream_element))
...
(declare-const o8 stream_element)
(declare-const o9 Int)
(declare-const o10 (Array Int stream_element))
...
(declare-const out_stream2 (Array Int stream_element))
(declare-const i2 Int)
(declare-const result3 (Array Int stream_element))
(declare-const out_stream3 (Array Int stream_element))
(declare-const out_stream4 (Array Int stream_element))
(declare-const i3 Int)
(declare-const out_stream5 (Array Int stream_element))
(declare-const i4 Int)
(declare-const out_stream6 (Array Int stream_element))
(declare-const i5 Int)
(declare-const out_stream7 (Array Int stream_element))
(declare-const i6 Int)
(declare-const result4 (Array Int stream_element))
(declare-const result5 t1)
(declare-const fixed_stream__convert__result2 (Array Int stream_element))
(declare-const fixed_stream__convert__result3 t1)
(declare-const fixed_stream__convert__result4 (Array Int stream_element))
(declare-const fixed_stream__convert__result5 t1)
(declare-const fixed_stream__convert__result6 us_t1)
(declare-const len2 int__ref)
(declare-const out_stream8 map__ref1)
(declare-const i7 int__ref)
(declare-const fixed_stream__convert__result7 stream_element_array__ref)
(declare-const len3 Int)
(declare-const out_stream9 (Array Int stream_element))
(declare-const i8 Int)
(declare-const fixed_stream__convert__result8 us_t1)
(define-fun i9 () int__ref (mk_int__ref i5))
(define-fun out_stream10 () map__ref1 (mk_map__ref1 out_stream6))
...
(assert (= (to_rep3 out_stream__first) (to_rep3 (first2 fixed_stream__convert__out_stream__assume1))))
(assert (= (to_rep3 out_stream__last) (to_rep3 (last2 fixed_stream__convert__out_stream__assume1))))
(assert (dynamic_property1 (- 9223372036854775808) 9223372036854775807 (to_rep3 out_stream__first) (to_rep3 out_stream__last)))
(assert (= (- len1 1) r19b))
(assert (in_range1 r19b))
(assert (= (mk_int__ref result2) (mk_int__ref i)))
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= temp___303 out_stream1)))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (and (<= 1 i2) (<= i2 r19b))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (and (= temp___300 (+ (to_rep1 (first (rt in_string))) i2)) (in_range1 (+ (to_rep1 (first (rt in_string))) i2)))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (and (<= (to_rep1 (first (rt in_string))) temp___300) (<= temp___300 (to_rep1 (last (rt in_string)))))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= o3 temp___300)))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= o4 (select (elts in_string) o3))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= o5 (to_rep o4))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (and (= o6 o5) (uint_in_range o5))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= o7 ((_ int2bv 8) o6))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= (to_rep4 o8) o7)))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (and (= temp___301 (+ (to_rep3 out_stream__first) i2)) (in_range5 (+ (to_rep3 out_stream__first) i2)))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (and (<= (to_rep3 out_stream__first) temp___301) (<= temp___301 (to_rep3 out_stream__last)))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= o9 temp___301)))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= o10 (store out_stream2 o9 o8))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= out_stream2 result3)))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= out_stream3 o10)))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= i2 r19b)))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= i2 i3)))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= out_stream3 out_stream4)))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= i4 i2)))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= out_stream5 out_stream3)))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= i9 (mk_int__ref i3))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= out_stream10 (mk_map__ref1 out_stream4))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= i6 i4)))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= out_stream7 out_stream5)))
(assert (=> (not (and (<= 1 i1) (<= i1 r19b))) (= i1 i5)))
(assert (=> (not (and (<= 1 i1) (<= i1 r19b))) (= out_stream1 out_stream6)))
(assert (=> (not (and (<= 1 i1) (<= i1 r19b))) (= i6 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 r19b))) (= out_stream7 out_stream1)))
(assert (= fixed_stream__convert__result4 fixed_stream__convert__result2))
(assert (= fixed_stream__convert__result5 fixed_stream__convert__result3))
(assert (= fixed_stream__convert__result6 (mk___t1 fixed_stream__convert__result2 fixed_stream__convert__result3)))
(assert (= (mk_stream_element_array__ref (mk___t1 result4 result5)) (mk_stream_element_array__ref (mk___t1 fixed_stream__convert__result fixed_stream__convert__result1))))
(assert (= out_stream6 fixed_stream__convert__result2))
(assert (= (mk1 (to_rep3 out_stream__first) (to_rep3 out_stream__last)) fixed_stream__convert__result3))
(assert (= fixed_stream__convert__result7 (mk_stream_element_array__ref (mk___t1 fixed_stream__convert__result4 fixed_stream__convert__result5))))
(assert (= i7 i9))
(assert (= out_stream8 out_stream10))
(assert (= len2 (mk_int__ref len1)))
(assert (= fixed_stream__convert__result8 fixed_stream__convert__result6))
(assert (= i8 i6))
(assert (= out_stream9 out_stream7))
(assert (= len3 len1))
(assert (and (= o11 (elements this)) (and (in_range4 o11) (= o11 (to_rep2 (rec__fixed_stream__object__width (us_split_fields1 this)))))))
(assert (not (in_range1 (length1 (stream_element_array__content fixed_stream__convert__result7)))))
(check-sat)
(exit)
