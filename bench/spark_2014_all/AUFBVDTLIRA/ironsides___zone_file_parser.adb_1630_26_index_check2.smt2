...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= tokentype1 1) (forall ((i10 Int)) (=> (and (<= begidx2 i10) (<= i10 endidx1)) (and (<= 48 (to_rep (select zonefileline i10))) (<= (to_rep (select zonefileline i10)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 tokentype1))))
...
(assert (= i2 r109b))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= temp___1832 token1)))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= temp___1834 i2)))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (and (<= 1 begidx2) (<= begidx2 endidx1))))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (and (=> (<= r109b r110b) (dynamic_property r109b r110b i3)) (and (<= r109b i3) (<= i3 r110b)))))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= (to_rep o3) (to_rep (select zonefileline i3)))))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (and (= o1 (+ i3 1)) (in_range1 (+ i3 1)))))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= o2 (- o1 begidx2))))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (and (= temp___1831 o2) (in_range1 o2))))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (and (<= 1 temp___1831) (<= temp___1831 256))))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= o4 temp___1831)))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= o5 (store token2 o4 o3))))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= result5 (mk_map__ref token2))))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= token3 o5)))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= i3 r110b)))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= i4 (mk_int__ref i3))))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= token4 (mk_map__ref token3))))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= i5 i3)))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= token5 token3)))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= i6 i4)))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= token6 token4)))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= i7 i5)))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= token7 token5)))
(assert (=> (not (and (<= r109b i2) (<= i2 r110b))) (= i6 (mk_int__ref i2))))
(assert (=> (not (and (<= r109b i2) (<= i2 r110b))) (= token6 (mk_map__ref token1))))
(assert (=> (not (and (<= r109b i2) (<= i2 r110b))) (= i7 i2)))
(assert (=> (not (and (<= r109b i2) (<= i2 r110b))) (= token7 token1)))
(assert (not (<= 128 lengthoftoken1)))
(assert (= result6 (mk_map__ref newowner)))
(assert (= newowner1 blankdomainname))
(assert (= lengthoftoken1 r112b))
(assert (in_range4 r112b))
(assert (= result7 (mk_int__ref i1)))
(assert (= i8 1))
(assert (<= 1 i8))
(assert (<= i8 r112b))
(assert (< lengthoftoken1 128))
(assert (and (and (=> (<= 1 r112b) (dynamic_property1 1 r112b i9)) (forall ((temp___1839 Int)) (=> (and (<= 1 temp___1839) (<= temp___1839 128)) (=> (or (< r112b temp___1839) (or (< temp___1839 1) (<= i9 temp___1839))) (= (select newowner2 temp___1839) (select newowner1 temp___1839)))))) (and (<= 1 i9) (<= i9 r112b))))
(assert (= (to_rep o6) (to_rep (select (map__content token6) i9))))
(assert (not (<= 1 i9)))
(check-sat)
(exit)
