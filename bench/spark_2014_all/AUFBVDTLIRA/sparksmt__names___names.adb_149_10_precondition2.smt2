...
(declare-const temp___714 char_table_index)
(declare-const temp___7141 positive)
(declare-const temp___7142 name_id)
(declare-const o13 name_id)
...
(define-fun temp___7143 () us_rep3 (mk___rep2 (mk___split_fields2 temp___714 temp___7141 temp___7142)))
(define-fun o20 () us_rep3 (mk___rep2 (mk___split_fields2 o3 o4 o5)))
...
(assert (=> (in_range11 n3) (= result2 (mk_int__ref ptr1))))
(assert (=> (in_range11 n3) (= ptr2 n3)))
(assert (=> (in_range11 n3) (= temp___713 n3)))
(assert (=> (in_range11 n3) (= temp___712 ptr2)))
(assert (=> (in_range11 n3) (and (= temp___7112 (to_string1 ptr2 hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields))) (dynamic_invariant temp___7112 true false true true))))
(assert (=> (in_range11 n3) (= result3 (bool_eq temp___711 (to_rep1 (first temp___7111)) (to_rep1 (last temp___7111)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))))))
(assert (=> (in_range11 n3) (not (= result3 true))))
(assert (=> (in_range11 n3) (= n4 n3)))
(assert (=> (in_range11 n3) (and (and (in_range11 ptr3) (<= ptr3 (last2 (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields)))))) (= (invariant__ hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields)) true))))
(assert (=> (in_range11 n3) (and (=> (<= 0 2147483647) (in_range8 ptr3)) (=> (<= 0 2147483647) (in_range8 n5)))))
(assert (=> (in_range11 n3) (= ptr4 (mk_int__ref ptr3))))
(assert (=> (in_range11 n3) (= ptr5 ptr3)))
(assert (=> (in_range11 n3) (and (= o2 ptr3) (in_range13 ptr3))))
(assert (=> (in_range11 n3) (and (= o20 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) (= (bool_eq4 o20 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) true))))
(assert (=> (in_range11 n3) (= o3 o6)))
(assert (=> (in_range11 n3) (= o4 o7)))
(assert (=> (in_range11 n3) (= o5 o8)))
(assert (=> (in_range11 n3) (= o9 o8)))
(assert (=> (in_range11 n3) (= o10 (to_rep4 o9))))
(assert (=> (in_range11 n3) (= result4 (ite (= o10 0) true false))))
(assert (=> (in_range11 n3) (= result4 true)))
(assert (=> (in_range11 n3) (= ptr6 ptr4)))
(assert (=> (in_range11 n3) (= n6 (mk_int__ref n5))))
(assert (=> (in_range11 n3) (= ptr7 ptr5)))
(assert (=> (in_range11 n3) (= n7 n5)))
(assert (=> (in_range11 n3) (= ptr8 ptr6)))
(assert (=> (in_range11 n3) (= n8 n6)))
(assert (=> (in_range11 n3) (= ptr9 ptr7)))
(assert (=> (in_range11 n3) (= n9 n7)))
(assert (=> (in_range11 n3) (= ptr10 ptr8)))
(assert (=> (in_range11 n3) (= n10 n8)))
(assert (=> (in_range11 n3) (= ptr11 ptr9)))
(assert (=> (in_range11 n3) (= n11 n9)))
(assert (=> (not (in_range11 n3)) (= ptr10 (mk_int__ref ptr1))))
(assert (=> (not (in_range11 n3)) (= n10 (mk_int__ref n3))))
(assert (=> (not (in_range11 n3)) (= ptr11 ptr1)))
(assert (=> (not (in_range11 n3)) (= n11 n3)))
(assert (and (and (and (and (= (invariant__ hash_table char_table__split_fields1 entry_table__split_fields1) true) (= (length2 (mk___rep1 entry_table__split_discrs entry_table__split_fields1)) (+ (length2 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) 1))) (<= (length3 (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) (length3 (mk___rep char_table__split_discrs char_table__split_fields1)))) (= n12 (last2 (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields1))))) (in_range8 n12)))
(assert (in_range11 (int__content ptr10)))
(assert (and (= o12 (int__content ptr10)) (in_range13 (int__content ptr10))))
(assert (and (= temp___7143 (get (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields1)) o12)) (= (bool_eq4 temp___7143 (get (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields1)) o12)) true)))
(assert (= (to_rep4 o13) n12))
(assert (= temp___714 o14))
(assert (= temp___7141 o15))
(assert (= o13 o16))
(assert (= o17 o14))
(assert (= o18 o15))
(assert (= o19 o16))
(assert (and (= o11 (int__content ptr10)) (in_range13 (int__content ptr10))))
(assert (not (<= 1 o11)))
(check-sat)
(exit)
