...
(assert (= o47 (bvadd src_index1 #x0000000000000006)))
(assert (= o48 (select (elts block) o47)))
(assert (= o49 (to_rep5 o48)))
(assert (= o50 ((_ zero_extend 56) o49)))
(assert (= o51 (bvshl o50 ((_ int2bv 64) 48))))
(assert (not (bvule (to_rep6 (first (rt block))) (bvadd src_index1 #x0000000000000005))))
(check-sat)
(exit)
