...
(define-fun tregister_byte_arrayP1__ref___48__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___20__projection ((a target__ref)) us_t1 (target__content a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__agc_tune3_type__agc_tune3 bits_16)))))
(define-fun us_split_fields_AGC_TUNE3__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__agc_tune3_type__agc_tune3 a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__agc_tune3_type__agc_tune3 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__agc_tune3_type__agc_tune3 (us_split_fields1 b)))) true false))
...
(assert (<= 0 dw1000__register_types__agc_tune3_type__agc_tune3__first__bit))
(assert (< dw1000__register_types__agc_tune3_type__agc_tune3__first__bit dw1000__register_types__agc_tune3_type__agc_tune3__last__bit))
(assert (<= 0 dw1000__register_types__agc_tune3_type__agc_tune3__position))
(declare-fun user_eq7 (us_rep us_rep) Bool)
(declare-const dummy7 us_rep)
(declare-datatypes () ((agc_tune3_type__ref (mk_agc_tune3_type__ref (agc_tune3_type__content us_rep)))))
(define-fun agc_tune3_type__ref___projection ((a agc_tune3_type__ref)) us_rep (agc_tune3_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___20__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_4002 us_t1) (temp___is_init_3998 Bool) (temp___skip_constant_3999 Bool) (temp___do_toplevel_4000 Bool) (temp___do_typ_inv_4001 Bool)) Bool (=> (not (= temp___skip_constant_3999 true)) (and (dynamic_property2 1 2 (first3 temp___expr_4002) (last3 temp___expr_4002)) (and (= (first3 temp___expr_4002) 1) (= (last3 temp___expr_4002) 2)))))
...
(define-fun register_byte_array__ref___48__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_3984 us_t2) (temp___is_init_3980 Bool) (temp___skip_constant_3981 Bool) (temp___do_toplevel_3982 Bool) (temp___do_typ_inv_3983 Bool)) Bool (=> (not (= temp___skip_constant_3981 true)) (and (dynamic_property3 1 2 (first5 temp___expr_3984) (last5 temp___expr_3984)) (and (= (first5 temp___expr_3984) 1) (= (last5 temp___expr_3984) 2)))))
...
(declare-const temp___8619 (Array Int bits_8))
(declare-const temp___86191 t1)
(declare-const temp___8620 (Array Int bits_8))
(declare-const temp___86201 t2)
...
(define-fun temp___86192 () us_t1 (mk___t1 temp___8619 temp___86191))
...
(assert (and (= temp___86192 (register_to_bytes reg)) (dynamic_invariant temp___86192 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___86191)) (to_rep (last2 temp___86191))) (+ (- (to_rep (last2 temp___86191)) (to_rep (first2 temp___86191))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8619 temp___8620))
(assert (= (mk2 (to_rep (first2 temp___86191)) (to_rep (last2 temp___86191))) temp___86201))
(assert (= (ite (<= (to_rep (first4 temp___86201)) (to_rep (last4 temp___86201))) (+ (- (to_rep (last4 temp___86201)) (to_rep (first4 temp___86201))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8620 temp___86201)))
(assert (= o2 o))
