...
(declare-datatypes () ((tT61bP1__ref (mk_tT61bP1__ref (tT61bP1__content tdigit_index_typeB)))))
(define-fun tT61bP1__ref___projection ((a tT61bP1__ref)) tdigit_index_typeB (tT61bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t61b__ref (mk_t61b__ref (t61b__content us_t1)))))
(define-fun t61b__ref___projection ((a t61b__ref)) us_t1 (t61b__content a))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__very_longs__very_long__long_digits1 us_t1)))))
(define-fun us_split_fields_Long_Digits__17__projection ((a us_split_fields2)) us_t1 (rec__very_longs__very_long__long_digits1 a))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___186 (rec__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___186) (first3 temp___186) (last3 temp___186))))))
(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1) (mk___split_fields1 (let ((temp___185 (rec__very_longs__very_long__long_digits (us_split_fields1 r1)))) (of_array1 (to_array temp___185) (first1 temp___185) (last1 temp___185))))))
...
(define-fun dynamic_invariant4 ((temp___expr_591 us_rep1) (temp___is_init_587 Bool) (temp___skip_constant_588 Bool) (temp___do_toplevel_589 Bool) (temp___do_typ_inv_590 Bool)) Bool (and (=> (not (= temp___skip_constant_588 true)) (in_range4 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_base temp___expr_591))) (and (dynamic_property3 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_591))) (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_591)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_591))) 1) (= (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_591))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))))
(define-fun default_initial_assumption ((temp___expr_594 us_rep1) (temp___skip_top_level_595 Bool)) Bool (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_594))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))))
...
(declare-datatypes () ((t62b__ref (mk_t62b__ref (t62b__content tdigit_index_typeB)))))
(define-fun t62b__ref___projection ((a t62b__ref)) tdigit_index_typeB (t62b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t63b__ref (mk_t63b__ref (t63b__content us_t2)))))
(define-fun t63b__ref___projection ((a t63b__ref)) us_t2 (t63b__content a))
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-fun temp_____aggregate_def_972 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___974 (_ BitVec 8))) (forall ((temp___975 Int) (temp___976 Int)) (let ((temp___973 (temp_____aggregate_def_972 temp___974 temp___975 temp___976))) (=> (dynamic_invariant temp___974 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___975 temp___976) (and (= (first5 temp___973) temp___975) (= (last5 temp___973) temp___976))) (forall ((temp___977 Int)) (= (to_rep2 (select (to_array2 temp___973) temp___977)) temp___974))))))))
...
(declare-const temp___979 (Array Int octet))
(declare-const temp___9791 t2)
(declare-const temp___980 (Array Int octet))
(declare-const temp___9801 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___983 digit_index_type)
(declare-const temp___9831 (Array Int octet))
(declare-const temp___9832 t1)
...
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_972 #x00 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_972 #x00 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___979 temp___9791) (temp_____aggregate_def_972 #x00 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep1 (first4 temp___9791)) (to_rep1 (last4 temp___9791))) (+ (- (to_rep1 (last4 temp___9791)) (to_rep1 (first4 temp___9791))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___979 temp___980))
(assert (= (mk1 (to_rep1 (first4 temp___9791)) (to_rep1 (last4 temp___9791))) temp___9801))
(assert (= (ite (<= (to_rep1 (first2 temp___9801)) (to_rep1 (last2 temp___9801))) (+ (- (to_rep1 (last2 temp___9801)) (to_rep1 (first2 temp___9801))) 1) 0) (ite (<= (to_rep1 (first2 result____split_fields1)) (to_rep1 (last2 result____split_fields1))) (+ (- (to_rep1 (last2 result____split_fields1)) (to_rep1 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___980 temp___9801)))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___983)))
(assert (= temp___9831 o2))
(assert (= temp___9832 o3))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___9831 temp___9832))))
(assert (= result____split_discrs (mk___split_discrs temp___983)))
...
(assert (and (and (dynamic_invariant4 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (forall ((temp___996 Int)) (=> (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___996) (<= temp___996 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (or (< (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) temp___996) (or (< temp___996 1) (<= i2 temp___996))) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___996) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___996)))))) (and (<= 1 i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (= l_digit1 o7))
(assert (not (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))) i2)))
(check-sat)
(exit)
