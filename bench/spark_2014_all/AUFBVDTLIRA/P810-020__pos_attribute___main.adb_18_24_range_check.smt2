...
(assert (and (= main__off_c2__assume main__some_record__c2__position) (in_range main__some_record__c2__position)))
(assert (= main__off_c2__assume off_c2))
(assert (in_range off_c2))
(assert (< off_c1 10000))
(assert (= off_c2 0))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE off_c1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE off_c1)))))) (= o (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE off_c1))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE off_c1)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE off_c1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE off_c1))))))) (= o 0)))
(assert (=> (<= 1 7) (= o1 (+ (- 7 1) 1))))
(assert (=> (not (<= 1 7)) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ 1 o2)))
