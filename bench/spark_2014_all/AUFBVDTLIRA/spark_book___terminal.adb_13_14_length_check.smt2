...
(assert (not (= (ite (<= (to_rep1 (first temp___3001)) (to_rep1 (last temp___3001))) (+ (- (to_rep1 (last temp___3001)) (to_rep1 (first temp___3001))) 1) 0) (ite (<= (to_rep1 buffer__first) (to_rep1 buffer__last)) (+ (- (to_rep1 buffer__last) (to_rep1 buffer__first)) 1) 0))))
(check-sat)
(exit)
