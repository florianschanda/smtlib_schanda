...
(declare-const temp___803 (Array Int word32))
(declare-const temp___812 (Array Int word32))
(declare-const temp___814 (_ BitVec 32))
(declare-const temp___815 (Array Int word32))
(declare-const temp___802 (_ BitVec 32))
(declare-const temp___808 (_ BitVec 32))
(declare-const temp___800 (Array Int word32))
(declare-const temp___813 (_ BitVec 32))
(declare-const temp___801 (_ BitVec 32))
(declare-const temp___807 (_ BitVec 32))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___803 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___812 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___814 carry2)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___815 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___802 carry2)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___808 carry2)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___800 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___813 carry1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___801 carry1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___807 carry1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___806 i1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___805 temp)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (oadd (oadd (oadd (oadd (num_of_big_int (mk___t temp___812 (mk (to_rep a__first) (to_rep a__last))) (+ a_first 1) (- i2 a_first)) (omultiply (num_of_big_int b b_first (- i2 a_first)) (from_word32 x))) (omultiply (num_of_big_int c c_first (- i2 a_first)) (from_word32 y))) (from_word32 temp___813)) (omultiply (base Tuple0) (from_word32 temp___814))) (oadd (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first (- i2 a_first)) (omultiply (oexpon (base Tuple0) (- i2 a_first)) (oadd (from_word32 carry12) (omultiply (base Tuple0) (from_word32 carry22)))))) true) (forall ((k Int)) (=> (and (<= i2 k) (<= k (+ a_last 1))) (= (to_rep1 (select a2 k)) (to_rep1 (select temp___815 k))))))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (forall ((temp___811 Int)) (=> (and (<= (to_rep a__first) temp___811) (<= temp___811 (to_rep a__last))) (=> (or (< a_last temp___811) (or (< temp___811 a_first) (<= i2 temp___811))) (= (select a2 temp___811) (select temp___810 temp___811)))))) (and (<= a_first i2) (<= i2 a_last)))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (oadd (oadd (oadd (oadd (num_of_big_int (mk___t temp___800 (mk (to_rep a__first) (to_rep a__last))) (+ a_first 1) (- (+ i2 1) a_first)) (omultiply (num_of_big_int b b_first (- (+ i2 1) a_first)) (from_word32 x))) (omultiply (num_of_big_int c c_first (- (+ i2 1) a_first)) (from_word32 y))) (from_word32 temp___801)) (omultiply (base Tuple0) (from_word32 temp___802))) (oadd (num_of_big_int (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) a_first (- (+ i2 1) a_first)) (omultiply (oexpon (base Tuple0) (- (+ i2 1) a_first)) (oadd (from_word32 carry13) (omultiply (base Tuple0) (from_word32 carry23)))))) true) (forall ((k Int)) (=> (and (<= (+ i2 1) k) (<= k (+ a_last 1))) (= (to_rep1 (select a3 k)) (to_rep1 (select temp___803 k))))))))
...
(assert (= a9 a7))
(assert (= o31 (from_word32 (t__content carry28))))
(assert (and (= o30 (base Tuple0)) (= o30 (oexpon (from_word32 #x00000002) 32))))
(assert (= o32 (omultiply o30 o31)))
(assert (= o29 (from_word32 (t__content carry18))))
(assert (= o33 (oadd o29 o32)))
...
(assert (= o34 (omultiply o28 o33)))
(assert (and (= o18 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o19 (+ o18 1)))
(assert (and (= o20 o19) (in_range1 o19)))
(assert (and (= o21 o20) (in_range2 o20)))
(assert (= o22 (num_of_big_int (mk___t (map__content a8) (mk (to_rep a__first) (to_rep a__last))) a_first o21)))
(assert (= o35 (oadd o22 o34)))
(assert (= o16 (from_word32 carry2)))
(assert (and (= o15 (base Tuple0)) (= o15 (oexpon (from_word32 #x00000002) 32))))
(assert (= o17 (omultiply o15 o16)))
(assert (= o14 (from_word32 carry1)))
(assert (= o12 (from_word32 y)))
(assert (and (= o7 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o8 (+ o7 1)))
(assert (and (= o9 o8) (in_range1 o8)))
(assert (and (= o10 o9) (in_range2 o9)))
(assert (= o11 (num_of_big_int c c_first o10)))
(assert (= o13 (omultiply o11 o12)))
(assert (= o5 (from_word32 x)))
(assert (and (= o (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o1 (+ o 1)))
(assert (and (= o2 o1) (in_range1 o1)))
(assert (and (= o3 o2) (in_range2 o2)))
(assert (= o4 (num_of_big_int b b_first o3)))
(assert (= o6 (omultiply o4 o5)))
