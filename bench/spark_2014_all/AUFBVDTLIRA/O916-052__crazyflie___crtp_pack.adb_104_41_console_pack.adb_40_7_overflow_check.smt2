...
(declare-const temp___4250 (Array Int t_uint8))
(declare-const temp___42501 t)
(declare-const temp___4252 (Array Int t_uint8))
(declare-const temp___42521 t)
...
(declare-const temp___4256 crpt_packet_representation)
(declare-const temp___42561 t_uint8)
(declare-const temp___42562 crtp_channel)
(declare-const temp___42563 crtp_reserved)
(declare-const temp___42564 crtp_port)
(declare-const temp___42565 (Array Int t_uint8))
(declare-const temp___42566 t_uint8)
(declare-const temp___42567 (Array Int t_uint8))
(declare-const temp___42568 (Array Int t_uint8))
(declare-const temp___42569 Bool)
(declare-const temp___425610 positive)
(declare-const o34 t_uint8)
(declare-const o35 us_split_fields)
(declare-const o36 us_rep)
(declare-const o37 us_split_fields2)
(declare-const temp___4259 us_rep1)
...
(assert (=> (<= r6b r7b) (and (and (<= 1 r6b) (<= r6b 30)) (and (<= 1 r7b) (<= r7b 30)))))
(assert (= o3 handler__split_fields5))
(assert (= o3 temp___4250))
(assert (= (mk r6b r7b) temp___42501))
(assert (= (ite (<= (to_rep6 (first temp___42481)) (to_rep6 (last temp___42481))) (+ (- (to_rep6 (last temp___42481)) (to_rep6 (first temp___42481))) 1) 0) (ite (<= (to_rep6 (first temp___42501)) (to_rep6 (last temp___42501))) (+ (- (to_rep6 (last temp___42501)) (to_rep6 (first temp___42501))) 1) 0)))
(assert (= (mk___t temp___4252 temp___42521) (mk___t temp___4248 temp___42481)))
(assert (forall ((temp___4253 Int)) (ite (and (<= r6b temp___4253) (<= temp___4253 r7b)) (= (select o4 temp___4253) (select temp___4252 temp___4253)) (= (select o4 temp___4253) (select handler__split_fields5 temp___4253)))))
(assert (= handler__split_fields1 o5))
(assert (= handler__split_fields2 o6))
(assert (= handler__split_fields3 o7))
(assert (= handler__split_fields4 o8))
(assert (= o4 o9))
(assert (= handler__split_fields6 o10))
(assert (= handler__split_fields7 o11))
(assert (= handler__split_fields8 o12))
(assert (= handler__split_fields o13))
(assert (= o14 o5))
(assert (= o15 o6))
(assert (= o16 o7))
(assert (= o17 o8))
...
(assert (= o20 o11))
(assert (= o21 o12))
(assert (= handler__split_fields9 o22))
(assert (= o23 o13))
(assert (= o24 o14))
(assert (= o25 o15))
(assert (= o26 o16))
...
(assert (= o31 o21))
(assert (= o32 o22))
(assert (= handler__split_fields10 o33))
(assert (= temp___4256 o23))
(assert (= temp___42561 o24))
(assert (= temp___42562 o25))
(assert (= temp___42563 o26))
(assert (= temp___42564 o27))
(assert (= temp___42565 o28))
(assert (= temp___42566 o29))
(assert (= temp___42567 o30))
(assert (= temp___42568 o31))
(assert (= temp___42569 o32))
(assert (= temp___425610 o33))
(assert (= result1 (mk___split_fields__ref1 (mk___split_fields1 (mk___rep (mk___split_discrs handler__split_fields) (mk___split_fields handler__split_fields1 handler__split_fields2 handler__split_fields3 handler__split_fields4 handler__split_fields5 handler__split_fields6 handler__split_fields7 handler__split_fields8) handler__split_fields9) handler__split_fields10))))
(assert (= handler__split_fields11 (mk___split_fields1 (mk___rep (mk___split_discrs temp___4256) (mk___split_fields temp___42561 temp___42562 temp___42563 temp___42564 temp___42565 temp___42566 temp___42567 temp___42568) temp___42569) temp___425610)))
(assert (= (to_rep1 o34) (bvadd (to_rep1 (rec__crtp_pack__crtp_packet__size (us_split_fields1 (rec__crtp_pack__crtp_packet_handler__packet handler__split_fields11)))) #x01)))
(assert (= o35 (mk___split_fields o34 (rec__crtp_pack__crtp_packet__channel (us_split_fields1 (rec__crtp_pack__crtp_packet_handler__packet handler__split_fields11))) (rec__crtp_pack__crtp_packet__reserved (us_split_fields1 (rec__crtp_pack__crtp_packet_handler__packet handler__split_fields11))) (rec__crtp_pack__crtp_packet__port (us_split_fields1 (rec__crtp_pack__crtp_packet_handler__packet handler__split_fields11))) (rec__crtp_pack__crtp_packet__data_1 (us_split_fields1 (rec__crtp_pack__crtp_packet_handler__packet handler__split_fields11))) (rec__crtp_pack__crtp_packet__header (us_split_fields1 (rec__crtp_pack__crtp_packet_handler__packet handler__split_fields11))) (rec__crtp_pack__crtp_packet__data_2 (us_split_fields1 (rec__crtp_pack__crtp_packet_handler__packet handler__split_fields11))) (rec__crtp_pack__crtp_packet__raw (us_split_fields1 (rec__crtp_pack__crtp_packet_handler__packet handler__split_fields11))))))
(assert (= o36 (mk___rep (us_split_discrs1 (rec__crtp_pack__crtp_packet_handler__packet handler__split_fields11)) o35 (attr__constrained (rec__crtp_pack__crtp_packet_handler__packet handler__split_fields11)))))
(assert (= o37 (mk___split_fields1 o36 (rec__crtp_pack__crtp_packet_handler__index handler__split_fields11))))
(assert (= temp___4259 (mk___rep1 o37)))
(assert (= result2 (mk___split_fields__ref1 handler__split_fields11)))
(assert (= handler__split_fields12 (us_split_fields3 temp___4259)))
(assert (not (in_range1 (+ (to_rep (rec__crtp_pack__crtp_packet_handler__index handler__split_fields12)) 1))))
(check-sat)
(exit)
