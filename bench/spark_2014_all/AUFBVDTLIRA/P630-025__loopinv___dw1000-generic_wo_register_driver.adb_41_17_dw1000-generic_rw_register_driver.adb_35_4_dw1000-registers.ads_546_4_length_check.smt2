...
(define-fun target__ref___58__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__otp_srdat_type__otp_srdat (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__otp_srdat_type__otp_srdat (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_7240 us_t1) (temp___is_init_7236 Bool) (temp___skip_constant_7237 Bool) (temp___do_toplevel_7238 Bool) (temp___do_typ_inv_7239 Bool)) Bool (=> (not (= temp___skip_constant_7237 true)) (and (dynamic_property2 1 4 (first3 temp___expr_7240) (last3 temp___expr_7240)) (and (= (first3 temp___expr_7240) 1) (= (last3 temp___expr_7240) 4)))))
...
(define-fun register_byte_array__ref___134__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_7222 us_t2) (temp___is_init_7218 Bool) (temp___skip_constant_7219 Bool) (temp___do_toplevel_7220 Bool) (temp___do_typ_inv_7221 Bool)) Bool (=> (not (= temp___skip_constant_7219 true)) (and (dynamic_property3 1 4 (first5 temp___expr_7222) (last5 temp___expr_7222)) (and (= (first5 temp___expr_7222) 1) (= (last5 temp___expr_7222) 4)))))
...
(declare-const temp___89061 t1)
(declare-const temp___8907 (Array Int bits_8))
(declare-const temp___89071 t2)
(define-fun temp___89062 () us_t1 (mk___t1 temp___8906 temp___89061))
...
(assert (and (= temp___89062 (register_to_bytes reg)) (dynamic_invariant temp___89062 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___89061)) (to_rep (last2 temp___89061))) (+ (- (to_rep (last2 temp___89061)) (to_rep (first2 temp___89061))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8906 temp___8907))
(assert (= (mk2 (to_rep (first2 temp___89061)) (to_rep (last2 temp___89061))) temp___89071))
(assert (not (= (ite (<= (to_rep (first4 temp___89071)) (to_rep (last4 temp___89071))) (+ (- (to_rep (last4 temp___89071)) (to_rep (first4 temp___89071))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
