...
(define-fun tregister_byte_arrayP1__ref___99__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___42__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun in_range3 ((x (_ BitVec 16))) Bool (and (bvule #x0000 x) (bvule x #x7FFF)))
...
(declare-fun user_eq7 (bits_15 bits_15) Bool)
(declare-const dummy7 bits_15)
...
(assert (forall ((x bits_15)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x bits_15)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x #x8000))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int5 ((x bits_15)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x bits_15)) (! (in_range_int1 (to_int5 x)) :pattern ((to_int5 x)))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__tc_sarc_type__sar_ctrl bits_1) (rec__dw1000__register_types__tc_sarc_type__reserved bits_15)))))
(define-fun us_split_fields_SAR_CTRL__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__tc_sarc_type__sar_ctrl a))
(define-fun us_split_fields_Reserved__15__projection ((a us_split_fields)) bits_15 (rec__dw1000__register_types__tc_sarc_type__reserved a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___59__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___59__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__dw1000__register_types__tc_sarc_type__sar_ctrl (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__tc_sarc_type__sar_ctrl (us_split_fields1 b)))) (= (to_rep3 (rec__dw1000__register_types__tc_sarc_type__reserved (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__tc_sarc_type__reserved (us_split_fields1 b))))) true false))
...
(assert (< dw1000__register_types__tc_sarc_type__sar_ctrl__first__bit dw1000__register_types__tc_sarc_type__sar_ctrl__last__bit))
...
(assert (< dw1000__register_types__tc_sarc_type__reserved__first__bit dw1000__register_types__tc_sarc_type__reserved__last__bit))
(assert (<= 0 dw1000__register_types__tc_sarc_type__reserved__position))
(declare-fun user_eq8 (us_rep us_rep) Bool)
(declare-const dummy8 us_rep)
(declare-datatypes () ((tc_sarc_type__ref (mk_tc_sarc_type__ref (tc_sarc_type__content us_rep)))))
(define-fun tc_sarc_type__ref___projection ((a tc_sarc_type__ref)) us_rep (tc_sarc_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___42__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_6011 us_t1) (temp___is_init_6007 Bool) (temp___skip_constant_6008 Bool) (temp___do_toplevel_6009 Bool) (temp___do_typ_inv_6010 Bool)) Bool (=> (not (= temp___skip_constant_6008 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6011) (last3 temp___expr_6011)) (and (= (first3 temp___expr_6011) 1) (= (last3 temp___expr_6011) 2)))))
...
(define-fun register_type__ref___140__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___99__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_5992 us_t2) (temp___is_init_5988 Bool) (temp___skip_constant_5989 Bool) (temp___do_toplevel_5990 Bool) (temp___do_typ_inv_5991 Bool)) Bool (=> (not (= temp___skip_constant_5989 true)) (and (dynamic_property3 1 2 (first5 temp___expr_5992) (last5 temp___expr_5992)) (and (= (first5 temp___expr_5992) 1) (= (last5 temp___expr_5992) 2)))))
...
(declare-const temp___8788 (Array Int bits_8))
(declare-const temp___87881 t1)
(define-fun temp___87882 () us_t1 (mk___t1 temp___8788 temp___87881))
...
(assert (and (= temp___87882 (register_to_bytes reg)) (dynamic_invariant temp___87882 true false true true)))
(assert (not (= (ite (<= (to_rep (first2 temp___87881)) (to_rep (last2 temp___87881))) (+ (- (to_rep (last2 temp___87881)) (to_rep (first2 temp___87881))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
