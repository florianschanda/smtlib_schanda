...
(assert (=> (<= (bv2nat (to_rep1 (first (rt m)))) (bv2nat (to_rep1 (last (rt m))))) (= o (+ (- (bv2nat (to_rep1 (last (rt m)))) (bv2nat (to_rep1 (first (rt m))))) 1))))
(assert (=> (not (<= (bv2nat (to_rep1 (first (rt m)))) (bv2nat (to_rep1 (last (rt m)))))) (= o 0)))
(assert (= o1 (+ o 1)))
(assert (= o2 (+ (bv2nat (to_rep1 (first (rt m)))) o1)))
(assert (= o3 (- o2 1)))
(assert (not (uint_in_range o3)))
(check-sat)
(exit)
