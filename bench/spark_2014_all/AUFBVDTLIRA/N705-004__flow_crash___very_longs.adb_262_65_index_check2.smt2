...
(assert (= r_digit1 o11))
(assert (= (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) r84b))
(assert (in_range2 r84b))
...
(assert (= temp___1061 (- o18 1)))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1061)))
(check-sat)
(exit)
