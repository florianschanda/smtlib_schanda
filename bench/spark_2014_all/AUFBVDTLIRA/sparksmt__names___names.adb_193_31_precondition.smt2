...
(define-fun in_range2 ((rec__names__data__char_tables__vector__capacity1 Int) (a us_rep)) Bool (= rec__names__data__char_tables__vector__capacity1 (to_rep (rec__names__data__char_tables__vector__capacity (us_split_discrs1 a)))))
...
(define-fun in_range4 ((rec__names__data__entry_tables__vector__capacity1 Int) (a us_rep1)) Bool (= rec__names__data__entry_tables__vector__capacity1 (to_rep1 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 a)))))
...
(define-fun dynamic_invariant ((temp___expr_629 us_rep) (temp___is_init_625 Bool) (temp___skip_constant_626 Bool) (temp___do_toplevel_627 Bool) (temp___do_typ_inv_628 Bool)) Bool (=> (not (= temp___skip_constant_626 true)) (in_range2 1024 temp___expr_629)))
...
(define-fun dynamic_invariant1 ((temp___expr_639 us_rep1) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (not (= temp___skip_constant_636 true)) (in_range4 256 temp___expr_639)))
...
(define-fun dynamic_invariant3 ((temp___expr_210 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 2147483647)) (in_range5 temp___expr_210)))
...
(assert (and (= o (valid_hashes hash_table (mk___split_fields1 entry_table__split_fields))) (= (= o true) (forall ((h (_ BitVec 32))) (=> (and (bvule #x00000000 h) (bvule h #x000000FF)) (<= (to_rep2 (select hash_table h)) (last1 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))))))))))
