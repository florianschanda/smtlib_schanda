...
(declare-const temp___3162 (Array Int unsigned_32))
(declare-const temp___3163 state_range)
...
(declare-const temp___3202 (Array Int unsigned_32))
(declare-const temp___3203 state_range)
...
(assert (= j2 o25))
(assert (and (< 0 i4) (and (<= (to_rep2 (first (rt initiator))) j3) (<= j3 (to_rep2 (last (rt initiator)))))))
(assert (and (and (and (and (= (rec__random__generator__index g__split_fields5) (rec__random__generator__index g__split_fields2)) (=> (<= 1 (ite (< 624 (length initiator)) (length initiator) 624)) (dynamic_property1 1 (ite (< 624 (length initiator)) (length initiator) 624) k2))) (=> (<= 0 623) (in_range4 i4))) (=> (<= 0 2147483647) (in_range3 j3))) (and (<= 1 k2) (<= k2 (ite (< 624 (length initiator)) (length initiator) 624)))))
(assert (not (= k2 (ite (< 624 (length initiator)) (length initiator) 624))))
(assert (= result9 (mk_int__ref k2)))
(assert (= k3 (+ k2 1)))
(assert (and (= o39 (to_state__2 j3)) (= o39 ((_ int2bv 32) j3))))
(assert (and (<= (to_rep2 (first (rt initiator))) j3) (<= j3 (to_rep2 (last (rt initiator))))))
(assert (= o35 j3))
(assert (= o36 (select (elts initiator) o35)))
(assert (= o37 (to_rep1 o36)))
(assert (and (<= 0 (- i4 1)) (<= (- i4 1) 623)))
(assert (= o28 (- i4 1)))
(assert (= o29 (select (rec__random__generator__state g__split_fields5) o28)))
(assert (= o30 (to_rep1 o29)))
(assert (= o31 (bvlshr o30 ((_ int2bv 32) 30))))
(assert (and (<= 0 (- i4 1)) (<= (- i4 1) 623)))
(assert (= o26 (- i4 1)))
(assert (= o27 (select (rec__random__generator__state g__split_fields5) o26)))
(assert (= o32 (to_rep1 o27)))
(assert (= o33 (bvxor o32 o31)))
(assert (= o34 (bvmul o33 #x0019660D)))
(assert (= o38 (bvxor (to_rep1 (select (rec__random__generator__state g__split_fields5) i4)) o34)))
(assert (= o40 (bvadd o38 o37)))
(assert (= o41 (bvadd o40 o39)))
(assert (= (to_rep1 o42) o41))
(assert (= o43 (store (rec__random__generator__state g__split_fields5) i4 o42)))
(assert (= o43 o44))
(assert (= (rec__random__generator__index g__split_fields5) o45))
(assert (= temp___3162 o44))
(assert (= temp___3163 o45))
(assert (= result10 (mk___split_fields__ref g__split_fields5)))
(assert (= g__split_fields6 (mk___split_fields temp___3162 temp___3163)))
(assert (=> (= i4 623) (= (to_rep1 o46) (to_rep1 (select (rec__random__generator__state g__split_fields6) 623)))))
(assert (=> (= i4 623) (= o47 (store (rec__random__generator__state g__split_fields6) 0 o46))))
(assert (=> (= i4 623) (= o47 o48)))
(assert (=> (= i4 623) (= (rec__random__generator__index g__split_fields6) o49)))
(assert (=> (= i4 623) (= temp___3202 o48)))
(assert (=> (= i4 623) (= temp___3203 o49)))
(assert (=> (= i4 623) (= result11 (mk___split_fields__ref g__split_fields6))))
(assert (=> (= i4 623) (= g__split_fields7 (mk___split_fields temp___3202 temp___3203))))
(assert (=> (= i4 623) (= result12 (mk_int__ref i4))))
(assert (=> (= i4 623) (= i5 1)))
(assert (=> (not (= i4 623)) (and (= o50 (+ i4 1)) (in_range4 (+ i4 1)))))
(assert (=> (not (= i4 623)) (= result13 (mk_int__ref i4))))
(assert (=> (not (= i4 623)) (= i6 o50)))
(assert (=> (not (= i4 623)) (= g__split_fields7 g__split_fields6)))
(assert (=> (not (= i4 623)) (= i5 i6)))
(assert (=> (= j3 (to_rep2 (last (rt initiator)))) (= o51 0)))
(assert (=> (not (= j3 (to_rep2 (last (rt initiator))))) (and (= o51 (+ j3 1)) (in_range1 (+ j3 1)))))
(assert (= result14 (mk_int__ref j3)))
(assert (= j4 o51))
(assert (not (<= (to_rep2 (first (rt initiator))) j4)))
(check-sat)
(exit)
