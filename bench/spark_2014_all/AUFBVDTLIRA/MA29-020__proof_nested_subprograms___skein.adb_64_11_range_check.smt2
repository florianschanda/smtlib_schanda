...
(declare-fun user_eq1 (skein_512_block_bytes_index skein_512_block_bytes_index) Bool)
...
(define-fun dynamic_invariant ((temp___expr_566 (_ BitVec 64)) (temp___is_init_562 Bool) (temp___skip_constant_563 Bool) (temp___do_toplevel_564 Bool) (temp___do_typ_inv_565 Bool)) Bool (=> (or (= temp___is_init_562 true) (bvule #x0000000000000000 #x000000000000003F)) (in_range1 temp___expr_566)))
(declare-sort u64 0)
...
(assert (forall ((x hash_bit_length)) (! (in_range_int1 (to_int5 x)) :pattern ((to_int5 x)))))
...
(assert (forall ((x u7)) (! (in_range_int2 (to_int10 x)) :pattern ((to_int10 x)))))
(declare-sort u6 0)
...
(assert (forall ((x u6)) (! (in_range_int3 (to_int11 x)) :pattern ((to_int11 x)))))
...
(assert (forall ((a (Array (_ BitVec 64) u64))) (forall ((first (_ BitVec 64))) (! (= (slide1 a first first) a) :pattern ((slide1 a first first))))))
...
(define-fun bool_eq3 ((a (Array (_ BitVec 64) u64)) (a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b (Array (_ BitVec 64) u64)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_155 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_155) (bvule temp___idx_155 a__last)) (= (to_rep1 (select a temp___idx_155)) (to_rep1 (select b (bvadd (bvsub b__first a__first) temp___idx_155))))))) true false))
(assert (forall ((a (Array (_ BitVec 64) u64)) (b (Array (_ BitVec 64) u64))) (forall ((a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_155 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_155) (bvule temp___idx_155 a__last)) (= (to_rep1 (select a temp___idx_155)) (to_rep1 (select b (bvadd (bvsub b__first a__first) temp___idx_155)))))))))))
...
(declare-fun user_eq10 ((Array (_ BitVec 64) u64) (Array (_ BitVec 64) u64)) Bool)
...
(assert (forall ((a (Array (_ BitVec 64) byte))) (<= 0 (object__alignment3 a))))
(declare-fun user_eq11 ((Array (_ BitVec 64) byte) (Array (_ BitVec 64) byte)) Bool)
...
(define-fun bool_eq4 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (= (bool_eq2 (rec__skein__skein_512_context__h (us_split_fields5 a)) (rec__skein__skein_512_context__h (us_split_fields5 b))) true) (= (bool_eq3 (rec__skein__skein_512_context__x (us_split_fields5 a)) #x0000000000000000 #x0000000000000007 (rec__skein__skein_512_context__x (us_split_fields5 b)) #x0000000000000000 #x0000000000000007) true)) (= (bool_eq (rec__skein__skein_512_context__b (us_split_fields5 a)) #x0000000000000000 #x000000000000003F (rec__skein__skein_512_context__b (us_split_fields5 b)) #x0000000000000000 #x000000000000003F) true)) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_311 (_ BitVec 8)) (temp___is_init_307 Bool) (temp___skip_constant_308 Bool) (temp___do_toplevel_309 Bool) (temp___do_typ_inv_310 Bool)) Bool true)
(define-fun dynamic_invariant2 ((temp___expr_318 (_ BitVec 16)) (temp___is_init_314 Bool) (temp___skip_constant_315 Bool) (temp___do_toplevel_316 Bool) (temp___do_typ_inv_317 Bool)) Bool true)
(define-fun dynamic_invariant3 ((temp___expr_325 (_ BitVec 32)) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool) (temp___do_typ_inv_324 Bool)) Bool true)
(define-fun dynamic_invariant4 ((temp___expr_332 (_ BitVec 64)) (temp___is_init_328 Bool) (temp___skip_constant_329 Bool) (temp___do_toplevel_330 Bool) (temp___do_typ_inv_331 Bool)) Bool true)
(define-fun dynamic_invariant5 ((temp___expr_528 (_ BitVec 64)) (temp___is_init_524 Bool) (temp___skip_constant_525 Bool) (temp___do_toplevel_526 Bool) (temp___do_typ_inv_527 Bool)) Bool (=> (or (= temp___is_init_524 true) (bvule #x0000000000000000 #xFFFFFFFFFFFFFFF8)) (in_range2 temp___expr_528)))
(define-fun dynamic_invariant6 ((temp___expr_621 (_ BitVec 8)) (temp___is_init_617 Bool) (temp___skip_constant_618 Bool) (temp___do_toplevel_619 Bool) (temp___do_typ_inv_620 Bool)) Bool (=> (or (= temp___is_init_617 true) (bvule #x00 #x3F)) (in_range4 temp___expr_621)))
