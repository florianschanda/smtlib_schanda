...
(define-fun target__ref___63__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__lde_repc_type__lde_repc (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__lde_repc_type__lde_repc (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_7634 us_t1) (temp___is_init_7630 Bool) (temp___skip_constant_7631 Bool) (temp___do_toplevel_7632 Bool) (temp___do_typ_inv_7633 Bool)) Bool (=> (not (= temp___skip_constant_7631 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7634) (last3 temp___expr_7634)) (and (= (first3 temp___expr_7634) 1) (= (last3 temp___expr_7634) 2)))))
...
(define-fun register_byte_array__ref___147__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_7616 us_t2) (temp___is_init_7612 Bool) (temp___skip_constant_7613 Bool) (temp___do_toplevel_7614 Bool) (temp___do_typ_inv_7615 Bool)) Bool (=> (not (= temp___skip_constant_7613 true)) (and (dynamic_property3 1 2 (first5 temp___expr_7616) (last5 temp___expr_7616)) (and (= (first5 temp___expr_7616) 1) (= (last5 temp___expr_7616) 2)))))
...
(declare-const temp___89471 t1)
(define-fun temp___89472 () us_t1 (mk___t1 temp___8947 temp___89471))
...
(assert (and (= temp___89472 (register_to_bytes reg)) (dynamic_invariant temp___89472 true false true true)))
(assert (not (= (ite (<= (to_rep (first2 temp___89471)) (to_rep (last2 temp___89471))) (+ (- (to_rep (last2 temp___89471)) (to_rep (first2 temp___89471))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
