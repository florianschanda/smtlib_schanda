...
(assert (not (= (length3 (mk___rep1 entry_table__split_discrs (us_split_fields__content1 entry_table__split_fields2))) (+ (length3 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) 1))))
(check-sat)
(exit)
