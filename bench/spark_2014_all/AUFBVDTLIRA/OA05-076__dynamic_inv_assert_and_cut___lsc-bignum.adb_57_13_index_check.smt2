...
(assert (and (and (forall ((temp___622 Int)) (=> (and (<= (to_rep a__first) temp___622) (<= temp___622 (to_rep a__last))) (=> (or (< a_last temp___622) (or (< temp___622 a_first) (<= i2 temp___622))) (= (select a1 temp___622) (select a temp___622))))) (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2))) (and (<= a_first i2) (<= i2 a_last))))
(assert (= (to_rep1 o) #x00000000))
(assert (not (<= i2 (to_rep a__last))))
(check-sat)
(exit)
