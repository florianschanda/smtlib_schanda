...
(declare-const temp___386 us_rep2)
...
(assert (= count3 o23))
(assert (not (= count3 #x0000)))
(assert (= (to_rep2 (rec__parse__parse_result_t__return_code result____split_discrs7)) r26b))
(assert (in_range3 r26b))
(assert (= (to_rep2 o24) 1))
(assert (= o25 (mk___split_discrs o24)))
(assert (= temp___386 (mk___rep2 o25 (mk___split_fields2 dummy8) true)))
(assert (= result____attr__constrained true))
(assert (not (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___386)) (rec__parse__parse_result_t__return_code result____split_discrs7))))
(check-sat)
(exit)
