...
(assert (not (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 3))) #x01000000)) val__)))
(check-sat)
(exit)
