...
(assert (forall ((x octet)) (! (uint_in_range1 (to_int3 x)) :pattern ((to_int3 x)))))
...
(assert (forall ((l us_rep) (r us_rep)) (! (=> (and (and (dynamic_invariant l true true true true) (dynamic_invariant r true true true true)) (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))) (let ((result (modsubtract l r))) (and (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 result))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (dynamic_invariant result true false true true)))) :pattern ((modsubtract l r)))))
...
(declare-datatypes () ((tT150bP1__ref (mk_tT150bP1__ref (tT150bP1__content tdigit_index_typeB)))))
(define-fun tT150bP1__ref___projection ((a tT150bP1__ref)) tdigit_index_typeB (tT150bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t150b__ref (mk_t150b__ref (t150b__content us_t1)))))
(define-fun t150b__ref___projection ((a t150b__ref)) us_t1 (t150b__content a))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__aco__math__very_longs__very_long__long_digits1 us_t1)))))
(define-fun us_split_fields_Long_Digits__36__projection ((a us_split_fields2)) us_t1 (rec__aco__math__very_longs__very_long__long_digits1 a))
(declare-datatypes () ((us_split_fields__ref1 (mk___split_fields__ref1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref___36__projection ((a us_split_fields__ref1)) us_split_fields2 (us_split_fields__content1 a))
(declare-datatypes () ((us_rep1 (mk___rep1 (us_split_discrs2 us_split_discrs) (us_split_fields3 us_split_fields2)))))
(define-fun us_rep___71__projection ((a us_rep1)) us_split_discrs (us_split_discrs2 a))
(define-fun us_rep___72__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___227 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___227) (first3 temp___227) (last3 temp___227))))))
(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1) (mk___split_fields1 (let ((temp___226 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r1)))) (of_array1 (to_array temp___226) (first1 temp___226) (last1 temp___226))))))
...
(define-fun in_range3 ((rec__aco__math__very_longs__very_long__octet_length1 Int) (a us_rep)) Bool (= rec__aco__math__very_longs__very_long__octet_length1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 a)))))
...
(define-fun tresultS__ref___6__projection ((a tresultS__ref)) us_rep1 (tresultS__content a))
(define-fun dynamic_invariant2 ((temp___expr_1034 us_rep1) (temp___is_init_1030 Bool) (temp___skip_constant_1031 Bool) (temp___do_toplevel_1032 Bool) (temp___do_typ_inv_1033 Bool)) Bool (and (=> (not (= temp___skip_constant_1031 true)) (in_range3 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_base temp___expr_1034))) (and (dynamic_property3 1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_1034))) (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_1034)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_1034))) 1) (= (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_1034))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))))
(define-fun default_initial_assumption ((temp___expr_1037 us_rep1) (temp___skip_top_level_1038 Bool)) Bool (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_1037))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))))
(declare-const result____split_discrs us_split_discrs)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(define-fun dynamic_invariant3 ((temp___expr_302 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool) (temp___do_typ_inv_301 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 1 2147483647)) (in_range1 temp___expr_302)))
(define-fun dynamic_invariant4 ((temp___expr_242 (_ BitVec 8)) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool true)
...
(declare-const aco__math__very_longs__modadd_and_carry__result__fields us_split_fields)
(declare-const result us_split_fields__ref1)
(declare-const result____split_fields2 us_split_fields2)
(declare-const result1 Bool)
(define-fun o3 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields (mk___t o1 o2))))
...
(assert (and (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))) (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 p))))))
(assert (and (= us (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
...
(assert (dynamic_invariant2 (mk___rep1 result____split_discrs (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1))) false false true true))
(assert (and (= (to_rep (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (dynamic_invariant (mk___rep result____split_discrs aco__math__very_longs__modadd_and_carry__result__fields) true true true true)))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (us_split_fields3 (of_base (mk___rep result____split_discrs aco__math__very_longs__modadd_and_carry__result__fields)))))
(assert (= result____split_discrs (us_split_discrs2 (of_base (mk___rep result____split_discrs aco__math__very_longs__modadd_and_carry__result__fields)))))
(assert (=> (= carry #x0001) (= result1 true)))
(assert (=> (not (= carry #x0001)) (= result1 (oge (to_base (mk___rep1 result____split_discrs result____split_fields2)) p))))
(assert (= result1 true))
(assert (and (= o3 (modsubtract (to_base (mk___rep1 result____split_discrs result____split_fields2)) p)) (and (dynamic_invariant o3 true false true true) (= (to_rep o) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 (to_base (mk___rep1 result____split_discrs result____split_fields2)))))))))
(assert (not (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep o))))
(check-sat)
(exit)
