...
(assert (= (= o32 true) (forall ((k1 Int)) (=> (and (<= i2 k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a1 k1)) (to_rep1 (select a k1)))))))
...
(assert (= o18 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first o17)))
