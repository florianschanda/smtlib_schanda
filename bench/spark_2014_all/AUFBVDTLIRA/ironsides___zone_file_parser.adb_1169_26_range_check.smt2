...
(declare-const temp___1744 (Array Int character))
(declare-const temp___1743 Int)
...
(assert (=> (and (not (= foundtype1 3)) (< endidx1 zlength)) (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i14 Int)) (=> (and (<= begidx5 i14) (<= i14 endidx3)) (and (<= 48 (to_rep (select zonefileline i14))) (<= (to_rep (select zonefileline i14)) 57)))))) (and (and (in_range4 begidx5) (in_range4 endidx3)) (in_range3 foundtype3)))))
...
(assert (= begidx10 o1))
(assert (and (and (and (and (<= begidx11 endidx8) (<= begidx11 zlength)) (<= endidx8 zlength)) (=> (= foundtype8 1) (forall ((i14 Int)) (=> (and (<= begidx11 i14) (<= i14 endidx8)) (and (<= 48 (to_rep (select zonefileline i14))) (<= (to_rep (select zonefileline i14)) 57)))))) (and (and (in_range4 begidx11) (in_range4 endidx8)) (in_range3 foundtype8))))
(assert (= foundtype8 1))
...
(assert (= begidx12 o2))
(assert (and (and (and (and (<= begidx13 endidx9) (<= begidx13 zlength)) (<= endidx9 zlength)) (=> (= foundtype9 1) (forall ((i14 Int)) (=> (and (<= begidx13 i14) (<= i14 endidx9)) (and (<= 48 (to_rep (select zonefileline i14))) (<= (to_rep (select zonefileline i14)) 57)))))) (and (and (in_range4 begidx13) (in_range4 endidx9)) (in_range3 foundtype9))))
...
(assert (= i8 r78b))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= temp___1744 newdomainname1)))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= temp___1743 i8)))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= temp___1746 endidx9)))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (and (and (<= 1 begidx13) (<= (+ (- endidx9 begidx13) 1) 128)) (= endidx9 temp___1746))))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (and (=> (<= r78b r79b) (dynamic_property1 r78b r79b i9)) (and (<= r78b i9) (<= i9 r79b)))))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= (to_rep o6) (to_rep (select zonefileline i9)))))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (and (= o4 (+ i9 1)) (in_range1 (+ i9 1)))))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= o5 (- o4 begidx13))))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (and (= temp___1742 o5) (in_range1 o5))))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (and (<= 1 temp___1742) (<= temp___1742 128))))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= o7 temp___1742)))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= o8 (store newdomainname2 o7 o6))))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= result13 (mk_map__ref newdomainname2))))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= newdomainname3 o8)))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= i9 r79b)))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= i10 (mk_int__ref i9))))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= newdomainname4 (mk_map__ref newdomainname3))))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= i11 i9)))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= newdomainname5 newdomainname3)))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= i12 i10)))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= newdomainname6 newdomainname4)))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= i13 i11)))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= newdomainname7 newdomainname5)))
(assert (=> (not (and (<= r78b i8) (<= i8 r79b))) (= i12 (mk_int__ref i8))))
(assert (=> (not (and (<= r78b i8) (<= i8 r79b))) (= newdomainname6 (mk_map__ref newdomainname1))))
(assert (=> (not (and (<= r78b i8) (<= i8 r79b))) (= i13 i8)))
(assert (=> (not (and (<= r78b i8) (<= i8 r79b))) (= newdomainname7 newdomainname1)))
