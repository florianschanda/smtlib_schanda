...
(assert (forall ((x bits_8)) (! (uint_in_range (to_int2 x)) :pattern ((to_int2 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_4940 Int) (temp___is_init_4936 Bool) (temp___skip_constant_4937 Bool) (temp___do_toplevel_4938 Bool) (temp___do_typ_inv_4939 Bool)) Bool (=> (or (= temp___is_init_4936 true) (<= 0 1024)) (in_range3 temp___expr_4940)))
...
(define-fun dynamic_invariant2 ((temp___expr_4947 Int) (temp___is_init_4943 Bool) (temp___skip_constant_4944 Bool) (temp___do_toplevel_4945 Bool) (temp___do_typ_inv_4946 Bool)) Bool (=> (or (= temp___is_init_4943 true) (<= 0 5)) (in_range4 temp___expr_4947)))
...
(define-fun us_split_fields_Size__3__projection ((a us_split_fields)) frame_length (rec__decadriver__rx_frame_type__size a))
...
(define-fun us_split_fields__ref___140__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___142__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
...
(assert (forall ((x rx_frame_queue_index)) (! (in_range_int (to_int3 x)) :pattern ((to_int3 x)))))
...
(define-fun us_split_fields__ref___141__projection ((a us_split_fields__ref1)) us_split_fields2 (us_split_fields__content1 a))
(declare-datatypes () ((us_rep1 (mk___rep1 (us_split_fields3 us_split_fields2)))))
(define-fun us_rep___143__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
...
(declare-fun temp_____aggregate_def_5014 (us_rep) (Array (_ BitVec 8) us_rep))
(declare-fun temp_____aggregate_def_5018 ((_ BitVec 8)) (Array Int bits_8))
(define-fun dynamic_invariant3 ((temp___expr_5008 us_rep1) (temp___is_init_5004 Bool) (temp___skip_constant_5005 Bool) (temp___do_toplevel_5006 Bool) (temp___do_typ_inv_5007 Bool)) Bool (forall ((temp___5009 (_ BitVec 8))) (=> (and (bvule #x00 temp___5009) (bvule temp___5009 #x01)) (let ((temp___5010 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields3 temp___expr_5008)) temp___5009))) (ite (= (to_rep4 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___5010))) 0) (< 0 (to_rep3 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___5010)))) (= (to_rep3 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___5010))) 0))))))
(declare-const rliteral frame_length)
(assert (= (frame_lengthqtint rliteral) 0))
(define-fun default_initial_assumption ((temp___expr_5012 us_rep1) (temp___skip_top_level_5013 Bool)) Bool (and (and (and (and (= (rec__decadriver__receiver_type__frame_queue (us_split_fields3 temp___expr_5012)) (temp_____aggregate_def_5014 (mk___rep (mk___split_fields rliteral (temp_____aggregate_def_5018 #x00) (of_rep4 0) (distinct 0 0))))) (= (to_rep5 (rec__decadriver__receiver_type__queue_head (us_split_fields3 temp___expr_5012))) #x01)) (= (to_rep (rec__decadriver__receiver_type__rx_count (us_split_fields3 temp___expr_5012))) 0)) (= (rec__decadriver__receiver_type__overrun_occurred (us_split_fields3 temp___expr_5012)) (distinct 0 0))) (= (rec__decadriver__receiver_type__frame_ready (us_split_fields3 temp___expr_5012)) (distinct 0 0))))
...
(define-fun dynamic_invariant5 ((temp___expr_4954 us_rep) (temp___is_init_4950 Bool) (temp___skip_constant_4951 Bool) (temp___do_toplevel_4952 Bool) (temp___do_typ_inv_4953 Bool)) Bool (=> (= temp___do_toplevel_4952 true) (=> (= temp___is_init_4950 true) (ite (= (to_rep4 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___expr_4954))) 0) (< 0 (to_rep3 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4954)))) (= (to_rep3 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4954))) 0)))))
(define-fun dynamic_predicate ((temp___4965 us_rep)) Bool (ite (= (to_rep4 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___4965))) 0) (< 0 (to_rep3 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4965)))) (= (to_rep3 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4965))) 0)))
(define-fun dynamic_invariant6 ((temp___expr_4973 (_ BitVec 8)) (temp___is_init_4969 Bool) (temp___skip_constant_4970 Bool) (temp___do_toplevel_4971 Bool) (temp___do_typ_inv_4972 Bool)) Bool (=> (or (= temp___is_init_4969 true) (bvule #x00 #x01)) (in_range5 temp___expr_4973)))
(assert (forall ((temp___5016 us_rep)) (=> (dynamic_invariant5 temp___5016 true true true true) (forall ((temp___5017 (_ BitVec 8))) (= (select (temp_____aggregate_def_5014 temp___5016) temp___5017) temp___5016)))))
(define-fun dynamic_invariant7 ((temp___expr_364 (_ BitVec 8)) (temp___is_init_360 Bool) (temp___skip_constant_361 Bool) (temp___do_toplevel_362 Bool) (temp___do_typ_inv_363 Bool)) Bool true)
(define-fun dynamic_invariant8 ((temp___expr_763 us_t) (temp___is_init_759 Bool) (temp___skip_constant_760 Bool) (temp___do_toplevel_761 Bool) (temp___do_typ_inv_762 Bool)) Bool (=> (not (= temp___skip_constant_760 true)) (dynamic_property 0 2147483647 (first1 temp___expr_763) (last1 temp___expr_763))))
(assert (forall ((temp___5020 (_ BitVec 8))) (=> (dynamic_invariant7 temp___5020 true true true true) (forall ((temp___5021 Int)) (= (to_rep2 (select (temp_____aggregate_def_5018 temp___5020) temp___5021)) temp___5020)))))
...
(declare-const temp___5093 (Array Int bits_8))
(declare-const temp___50931 t2)
(declare-const temp___5094 (Array Int bits_8))
(declare-const temp___50941 t1)
(declare-const o3 (Array Int bits_8))
(declare-const temp___5096 (Array Int bits_8))
(declare-const temp___50961 t1)
(declare-const temp___5097 (Array Int bits_8))
(declare-const temp___50971 t1)
(declare-const o4 (Array Int bits_8))
(declare-const o5 Int)
(declare-const temp___5084 Int)
(declare-const o6 (Array Int bits_8))
(declare-const temp___5087 (Array Int bits_8))
(declare-const temp___50871 t3)
(declare-const temp___5088 (Array Int bits_8))
(declare-const temp___50881 t)
(declare-const temp___5089 (Array Int bits_8))
(declare-const temp___50891 t)
...
(define-fun frame6 () map__ref (mk_map__ref frame))
(assert (dynamic_invariant3 (mk___rep1 (mk___split_fields1 self__ self__1 self__2 self__3 self__4)) true false true true))
...
(assert (=> (= error1 0) (=> (<= (to_rep1 frame__first) (to_rep1 frame__last)) (= o (+ (- (to_rep1 frame__last) (to_rep1 frame__first)) 1)))))
(assert (=> (= error1 0) (=> (not (<= (to_rep1 frame__first) (to_rep1 frame__last))) (= o 0))))
(assert (=> (= error1 0) (and (= o1 o) (in_range1 o))))
(assert (=> (= error1 0) (= result2 (ite (<= size1 o1) true false))))
(assert (=> (= error1 0) (=> (= result2 true) (and (= decadriver__receiver_type__wait__R6b__assume (+ (to_rep1 frame__first) (- size1 1))) (in_range1 (+ (to_rep1 frame__first) (- size1 1)))))))
(assert (=> (= error1 0) (=> (= result2 true) (= decadriver__receiver_type__wait__R6b__assume r6b))))
(assert (=> (= error1 0) (=> (= result2 true) (in_range1 r6b))))
(assert (=> (= error1 0) (=> (= result2 true) (= size1 r9b))))
(assert (=> (= error1 0) (=> (= result2 true) (in_range3 r9b))))
(assert (=> (= error1 0) (=> (= result2 true) (=> (<= 1 r9b) (and (and (<= 0 1) (<= 1 1024)) (and (<= 0 r9b) (<= r9b 1024)))))))
(assert (=> (= error1 0) (=> (= result2 true) (= o2 (rec__decadriver__rx_frame_type__frame (us_split_fields1 (select self__ (to_rep5 self__1))))))))
(assert (=> (= error1 0) (=> (= result2 true) (= o2 temp___5093))))
(assert (=> (= error1 0) (=> (= result2 true) (= (mk2 1 r9b) temp___50931))))
(assert (=> (= error1 0) (=> (= result2 true) (= (ite (<= (to_rep1 (first4 temp___50931)) (to_rep1 (last4 temp___50931))) (+ (- (to_rep1 (last4 temp___50931)) (to_rep1 (first4 temp___50931))) 1) 0) (ite (<= (to_rep1 frame__first) r6b) (+ (- r6b (to_rep1 frame__first)) 1) 0)))))
(assert (=> (= error1 0) (=> (= result2 true) (= (slide temp___5093 (to_rep1 (first4 temp___50931)) (to_rep1 frame__first)) temp___5094))))
(assert (=> (= error1 0) (=> (= result2 true) (= (mk1 (to_rep1 frame__first) r6b) temp___50941))))
(assert (=> (= error1 0) (=> (= result2 true) (=> (<= (to_rep1 frame__first) r6b) (and (and (<= (to_rep1 frame__first) (to_rep1 frame__first)) (<= (to_rep1 frame__first) (to_rep1 frame__last))) (and (<= (to_rep1 frame__first) r6b) (<= r6b (to_rep1 frame__last))))))))
(assert (=> (= error1 0) (=> (= result2 true) (= o3 frame))))
(assert (=> (= error1 0) (=> (= result2 true) (= o3 temp___5096))))
(assert (=> (= error1 0) (=> (= result2 true) (= (mk1 (to_rep1 frame__first) r6b) temp___50961))))
(assert (=> (= error1 0) (=> (= result2 true) (= (ite (<= (to_rep1 (first2 temp___50941)) (to_rep1 (last2 temp___50941))) (+ (- (to_rep1 (last2 temp___50941)) (to_rep1 (first2 temp___50941))) 1) 0) (ite (<= (to_rep1 (first2 temp___50961)) (to_rep1 (last2 temp___50961))) (+ (- (to_rep1 (last2 temp___50961)) (to_rep1 (first2 temp___50961))) 1) 0)))))
(assert (=> (= error1 0) (=> (= result2 true) (= (mk___t1 temp___5097 temp___50971) (mk___t1 temp___5094 temp___50941)))))
(assert (=> (= error1 0) (=> (= result2 true) (forall ((temp___5098 Int)) (ite (and (<= (to_rep1 frame__first) temp___5098) (<= temp___5098 r6b)) (= (select o4 temp___5098) (select temp___5097 temp___5098)) (= (select o4 temp___5098) (select frame temp___5098)))))))
(assert (=> (= error1 0) (=> (= result2 true) (= result3 frame6))))
(assert (=> (= error1 0) (=> (= result2 true) (= frame2 o4))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (=> (<= (to_rep1 frame__first) (to_rep1 frame__last)) (= o5 (+ (- (to_rep1 frame__last) (to_rep1 frame__first)) 1))))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (=> (not (<= (to_rep1 frame__first) (to_rep1 frame__last))) (= o5 0)))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (and (= temp___5084 o5) (in_range1 o5)))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (=> (<= 1 temp___5084) (and (and (<= 0 1) (<= 1 1024)) (and (<= 0 temp___5084) (<= temp___5084 1024)))))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= o6 (rec__decadriver__rx_frame_type__frame (us_split_fields1 (select self__ (to_rep5 self__1))))))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= o6 temp___5087))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= (mk3 1 temp___5084) temp___50871))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= temp___5087 temp___5088))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= (mk (to_rep1 (first6 temp___50871)) (to_rep1 (last6 temp___50871))) temp___50881))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= (ite (<= (to_rep1 (first temp___50881)) (to_rep1 (last temp___50881))) (+ (- (to_rep1 (last temp___50881)) (to_rep1 (first temp___50881))) 1) 0) (ite (<= (to_rep1 frame__first) (to_rep1 frame__last)) (+ (- (to_rep1 frame__last) (to_rep1 frame__first)) 1) 0)))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= (mk___t temp___5089 temp___50891) (mk___t temp___5088 temp___50881)))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= o7 (slide temp___5089 (to_rep1 (first temp___50891)) (to_rep1 frame__first))))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= result4 frame6))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= frame3 o7))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= frame2 frame3))))
(assert (=> (not (= error1 0)) (= frame2 frame)))
(assert (=> (not (= error1 0)) (= frame2 frame1)))
(assert (= (to_rep5 o8) (bvurem (bvadd (to_rep5 self__1) #x01) #x02)))
(assert (= self__ o9))
(assert (= o8 o10))
(assert (= self__2 o11))
(assert (= self__3 o12))
...
(assert (= o17 o12))
(assert (= o18 o13))
(assert (= result5 (mk_receiver_type__ref (mk___rep1 (mk___split_fields1 self__ self__1 self__2 self__3 self__4)))))
(assert (= self__5 (mk___rep1 (mk___split_fields1 o14 o15 o16 o17 o18))))
(assert (and (= o19 (- (to_rep (rec__decadriver__receiver_type__rx_count (us_split_fields3 self__5))) 1)) (in_range2 (- (to_rep (rec__decadriver__receiver_type__rx_count (us_split_fields3 self__5))) 1))))
(assert (= (to_rep o20) o19))
(assert (= (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__5)) o21))
(assert (= (rec__decadriver__receiver_type__queue_head (us_split_fields3 self__5)) o22))
(assert (= o20 o23))
(assert (= (rec__decadriver__receiver_type__overrun_occurred (us_split_fields3 self__5)) o24))
(assert (= (rec__decadriver__receiver_type__frame_ready (us_split_fields3 self__5)) o25))
(assert (= o26 o21))
(assert (= o27 o22))
(assert (= o28 o23))
(assert (= o29 o24))
(assert (= o30 o25))
(assert (= result6 (mk_receiver_type__ref self__5)))
(assert (= self__6 (mk___rep1 (mk___split_fields1 o26 o27 o28 o29 o30))))
(assert (= result7 (mk_receiver_type__ref self__6)))
(assert (= self__7 (mk___rep1 (mk___split_fields1 (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__6)) (rec__decadriver__receiver_type__queue_head (us_split_fields3 self__6)) (rec__decadriver__receiver_type__rx_count (us_split_fields3 self__6)) (rec__decadriver__receiver_type__overrun_occurred (us_split_fields3 self__6)) (ite (< 0 (to_rep (rec__decadriver__receiver_type__rx_count (us_split_fields3 self__6)))) true false)))))
(assert (= self__8 (mk_receiver_type__ref self__7)))
(assert (= error2 (mk_int__ref error1)))
(assert (= size2 (mk_int__ref size1)))
(assert (= frame4 (mk_map__ref frame2)))
(assert (= self__9 self__7))
(assert (= error3 error1))
(assert (= size3 size1))
(assert (= frame5 frame2))
(assert (= (int__content error2) 0))
(assert (not (<= (int__content size2) 1024)))
(check-sat)
(exit)
