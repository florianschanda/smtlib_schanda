...
(assert (and (and (=> (<= 1 r21b) (dynamic_property 1 r21b from_line2)) (=> (<= 1 20) (in_range9 to_line8))) (and (<= 1 from_line2) (<= from_line2 r21b))))
(assert (and (= o1 (is_empty_line (select cur_board8 from_line2))) (= (= o1 true) (forall ((x Int)) (=> (and (<= 1 x) (<= x 10)) (= (to_rep4 (select (select cur_board8 from_line2) x)) 0))))))
