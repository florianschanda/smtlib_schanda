...
(define-fun dynamic_invariant ((temp___expr_331 (_ BitVec 64)) (temp___is_init_327 Bool) (temp___skip_constant_328 Bool) (temp___do_toplevel_329 Bool) (temp___do_typ_inv_330 Bool)) Bool true)
...
(assert (forall ((temp___708 Bool)) (forall ((temp___709 (_ BitVec 64)) (temp___710 (_ BitVec 64))) (let ((temp___707 (fail__create__r__aggregate_def temp___708 temp___709 temp___710))) (and (=> (dynamic_property #x0000000000000000 #xFFFFFFFFFFFFFFFF temp___709 temp___710) (and (= (first5 temp___707) temp___709) (= (last6 temp___707) temp___710))) (forall ((temp___711 (_ BitVec 64))) (= (select (to_array2 temp___707) temp___711) temp___708)))))))
(define-fun dynamic_invariant1 ((temp___expr_338 us_t) (temp___is_init_334 Bool) (temp___skip_constant_335 Bool) (temp___do_toplevel_336 Bool) (temp___do_typ_inv_337 Bool)) Bool (=> (not (= temp___skip_constant_335 true)) (dynamic_property #x0000000000000000 #xFFFFFFFFFFFFFFFF (first1 temp___expr_338) (last1 temp___expr_338))))
(define-fun dynamic_invariant2 ((temp___expr_701 us_t1) (temp___is_init_697 Bool) (temp___skip_constant_698 Bool) (temp___do_toplevel_699 Bool) (temp___do_typ_inv_700 Bool)) Bool (=> (not (= temp___skip_constant_698 true)) (and (dynamic_property2 #x0000000000000000 last2 (first3 temp___expr_701) (last4 temp___expr_701)) (and (= (first3 temp___expr_701) #x0000000000000000) (= (last4 temp___expr_701) last2)))))
(declare-const temp___713 (Array (_ BitVec 64) Bool))
(declare-const temp___7131 t2)
(assert (= (to_rep (first4 (rt2 (fail__create__r__aggregate_def (distinct 0 0) #x0000000000000000 last2)))) #x0000000000000000))
(assert (= (to_rep (last5 (rt2 (fail__create__r__aggregate_def (distinct 0 0) #x0000000000000000 last2)))) last2))
(assert (= (mk___t2 temp___713 temp___7131) (fail__create__r__aggregate_def (distinct 0 0) #x0000000000000000 last2)))
(assert (not (= (ite (<= (bv2nat (to_rep (first4 temp___7131))) (bv2nat (to_rep (last5 temp___7131)))) (+ (- (bv2nat (to_rep (last5 temp___7131))) (bv2nat (to_rep (first4 temp___7131)))) 1) 0) (ite (<= (bv2nat #x0000000000000000) (bv2nat last2)) (+ (- (bv2nat last2) (bv2nat #x0000000000000000)) 1) 0))))
(check-sat)
(exit)
