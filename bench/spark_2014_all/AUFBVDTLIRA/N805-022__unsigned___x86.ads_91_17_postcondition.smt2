...
(assert (forall ((x unsigned_8)) (! (uint_in_range3 (to_int5 x)) :pattern ((to_int5 x)))))
...
(declare-fun readmem16 ((_ BitVec 64) (Array (_ BitVec 64) unsigned_8)) (_ BitVec 16))
(declare-fun readmem16__function_guard ((_ BitVec 16) (_ BitVec 64) (Array (_ BitVec 64) unsigned_8)) Bool)
...
(define-fun dynamic_invariant1 ((temp___expr_174 (_ BitVec 16)) (temp___is_init_170 Bool) (temp___skip_constant_171 Bool) (temp___do_toplevel_172 Bool) (temp___do_typ_inv_173 Bool)) Bool true)
(assert (forall ((addr (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned_8))) (! (=> (dynamic_invariant addr true true true true) (let ((result (readmem16 addr x86__memory))) (and (and (= result (bvadd ((_ zero_extend 8) (to_rep (select x86__memory addr))) (bvmul ((_ zero_extend 8) (to_rep (select x86__memory (bvadd addr #x0000000000000001)))) #x0100))) (bvuge result #x0000)) (dynamic_invariant1 result true false true true)))) :pattern ((readmem16 addr x86__memory))))))
...
(declare-const x86__readmem32__result1 (_ BitVec 32))
(declare-const x86__readmem32__result2 (_ BitVec 32))
(declare-const x86__readmem32__result3 (_ BitVec 32))
...
(assert (and (= o1 (readmem16 (bvadd addr #x0000000000000002) memory)) (and (= o1 (bvadd ((_ zero_extend 8) (to_rep (select memory (bvadd addr #x0000000000000002)))) (bvmul ((_ zero_extend 8) (to_rep (select memory (bvadd (bvadd addr #x0000000000000002) #x0000000000000001)))) #x0100))) (bvuge o1 #x0000))))
(assert (= o2 ((_ zero_extend 16) o1)))
(assert (= o3 (bvmul o2 #x00010000)))
(assert (and (= o (readmem16 addr memory)) (and (= o (bvadd ((_ zero_extend 8) (to_rep (select memory addr))) (bvmul ((_ zero_extend 8) (to_rep (select memory (bvadd addr #x0000000000000001)))) #x0100))) (bvuge o #x0000))))
(assert (= o4 ((_ zero_extend 16) o)))
(assert (= o5 (bvadd o4 o3)))
(assert (= result x86__readmem32__result))
(assert (= x86__readmem32__result1 o5))
(assert (= (mk_t__ref1 x86__readmem32__result4) (mk_t__ref1 x86__readmem32__result2)))
(assert (= x86__readmem32__result5 x86__readmem32__result3))
(assert (= result1 x86__readmem32__result4))
(assert (not (bvuge x86__readmem32__result4 #x00000000)))
(check-sat)
(exit)
