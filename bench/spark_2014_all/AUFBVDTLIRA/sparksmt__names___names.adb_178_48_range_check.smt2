...
(assert (= i2 result2))
(assert (= i3 (+ i2 1)))
(assert (and (= o6 (+ (to_rep6 (rec__names__data__name_entry__table_index (us_split_fields5 e))) (- i3 1))) (in_range12 (+ (to_rep6 (rec__names__data__name_entry__table_index (us_split_fields5 e))) (- i3 1)))))
(assert (not (in_range13 o6)))
(check-sat)
(exit)
