...
(assert (and (= temp___300 (+ (to_rep1 (first (rt in_string))) i2)) (in_range1 (+ (to_rep1 (first (rt in_string))) i2))))
(assert (and (<= (to_rep1 (first (rt in_string))) temp___300) (<= temp___300 (to_rep1 (last (rt in_string))))))
(assert (= o3 temp___300))
(assert (= o4 (select (elts in_string) o3)))
(assert (= o5 (to_rep o4)))
(assert (and (= o6 o5) (uint_in_range o5)))
(assert (= o7 ((_ int2bv 8) o6)))
(assert (= (to_rep4 o8) o7))
(assert (not (in_range5 (+ (to_rep3 out_stream__first) i2))))
(check-sat)
(exit)
