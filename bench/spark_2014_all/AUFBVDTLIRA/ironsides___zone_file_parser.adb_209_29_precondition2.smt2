...
(declare-const temp___1866 query_type)
(declare-const temp___18661 unsigned8)
(declare-const temp___18662 unsigned8)
(declare-const temp___18663 unsigned32)
(declare-const temp___18664 unsigned32)
(declare-const temp___18665 unsigned32)
(declare-const temp___18666 unsigned16)
(declare-const temp___18667 (Array Int character))
(declare-const temp___18668 (Array Int character))
(declare-const temp___18669 siglengthvaluetype)
(declare-const temp___186610 unsigned32)
(declare-const temp___186611 classtype)
(declare-const temp___186612 us_private)
(declare-const temp___186613 Int)
...
(assert (=> (= success1 true) (=> (not (= success2 true)) (= rrsig_rec__split_fields40 rrsig_rec__split_fields41))))
...
(assert (=> (not (= success1 true)) (= rrsig_rec__split_fields40 rrsig_rec__split_fields41)))
(assert (= result16 success2))
(assert (= success3 (ite (= success2 true) (ite (< endidx2 zlength) true false) false)))
(assert (=> (= success3 true) (and (= o16 (+ endidx2 1)) (in_range3 (+ endidx2 1)))))
(assert (=> (= success3 true) (= begidx3 result17)))
(assert (=> (= success3 true) (= begidx4 o16)))
(assert (=> (= success3 true) (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i Int)) (=> (and (<= begidx5 i) (<= i endidx3)) (and (<= 48 (to_rep (select zonefileline i))) (<= (to_rep (select zonefileline i)) 57)))))) (and (and (in_range3 begidx5) (in_range3 endidx3)) (in_range2 foundtype3)))))
(assert (=> (= success3 true) (= result18 (mk_bool__ref success3))))
(assert (=> (= success3 true) (= success4 (ite (= foundtype3 1) true false))))
(assert (=> (= success3 true) (=> (= success4 true) (= (to_rep1 o17) parser_utilities__convert8bitunsigned__value))))
(assert (=> (= success3 true) (=> (= success4 true) (= rrsig_rec__split_fields26 o18))))
(assert (=> (= success3 true) (=> (= success4 true) (= o17 o19))))
(assert (=> (= success3 true) (=> (= success4 true) (= rrsig_rec__split_fields28 o20))))
(assert (=> (= success3 true) (=> (= success4 true) (= rrsig_rec__split_fields29 o21))))
(assert (=> (= success3 true) (=> (= success4 true) (= rrsig_rec__split_fields30 o22))))
(assert (=> (= success3 true) (=> (= success4 true) (= rrsig_rec__split_fields31 o23))))
(assert (=> (= success3 true) (=> (= success4 true) (= rrsig_rec__split_fields32 o24))))
(assert (=> (= success3 true) (=> (= success4 true) (= rrsig_rec__split_fields33 o25))))
(assert (=> (= success3 true) (=> (= success4 true) (= rrsig_rec__split_fields34 o26))))
(assert (=> (= success3 true) (=> (= success4 true) (= rrsig_rec__split_fields35 o27))))
(assert (=> (= success3 true) (=> (= success4 true) (= rrsig_rec__split_fields36 o28))))
(assert (=> (= success3 true) (=> (= success4 true) (= rrsig_rec__split_fields37 o29))))
(assert (=> (= success3 true) (=> (= success4 true) (= rrsig_rec__split_fields38 o30))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___1866 o18))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18661 o19))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18662 o20))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18663 o21))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18664 o22))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18665 o23))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18666 o24))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18667 o25))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18668 o26))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18669 o27))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___186610 o28))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___186611 o29))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___186612 o30))))
(assert (=> (= success3 true) (=> (= success4 true) (= rrsig_rec__attr__tag temp___186613))))
(assert (=> (= success3 true) (=> (= success4 true) (= result19 (mk___split_fields__ref1 rrsig_rec__split_fields40)))))
(assert (=> (= success3 true) (=> (= success4 true) (= rrsig_rec__split_fields39 (mk___split_fields1 temp___1866 temp___18661 temp___18662 temp___18663 temp___18664 temp___18665 temp___18666 temp___18667 temp___18668 temp___18669 temp___186610 temp___186611 temp___186612)))))
(assert (=> (= success3 true) (=> (not (= success4 true)) (= success5 success4))))
(assert (=> (= success3 true) (=> (not (= success4 true)) (= rrsig_rec__split_fields39 rrsig_rec__split_fields40))))
(assert (=> (not (= success3 true)) (= foundtype3 foundtype2)))
(assert (=> (not (= success3 true)) (= begidx5 begidx3)))
(assert (=> (not (= success3 true)) (= success5 success3)))
(assert (=> (not (= success3 true)) (= endidx3 endidx2)))
(assert (=> (not (= success3 true)) (= rrsig_rec__split_fields39 rrsig_rec__split_fields40)))
(assert (= result20 (mk_bool__ref success5)))
(assert (= success6 (ite (= success5 true) (ite (< endidx3 zlength) true false) false)))
(assert (= success6 true))
(assert (and (= o31 (+ endidx3 1)) (in_range3 (+ endidx3 1))))
(assert (= result21 (mk_int__ref begidx5)))
(assert (= begidx6 o31))
(assert (and (and (and (and (<= begidx7 endidx4) (<= begidx7 zlength)) (<= endidx4 zlength)) (=> (= foundtype4 1) (forall ((i Int)) (=> (and (<= begidx7 i) (<= i endidx4)) (and (<= 48 (to_rep (select zonefileline i))) (<= (to_rep (select zonefileline i)) 57)))))) (and (and (in_range3 begidx7) (in_range3 endidx4)) (in_range2 foundtype4))))
(assert (= result22 (mk_bool__ref success6)))
(assert (= success7 (ite (= foundtype4 1) true false)))
