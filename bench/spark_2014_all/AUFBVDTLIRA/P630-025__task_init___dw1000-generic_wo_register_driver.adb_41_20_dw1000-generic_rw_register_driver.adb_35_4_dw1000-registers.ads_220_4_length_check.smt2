...
(define-fun tregister_byte_arrayP1__ref___13__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___6__projection ((a target__ref)) us_t1 (target__content a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__dx_time_type__dx_time bits_40)))))
(define-fun us_split_fields_DX_TIME__projection ((a us_split_fields)) bits_40 (rec__dw1000__register_types__dx_time_type__dx_time a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__dx_time_type__dx_time (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__dx_time_type__dx_time (us_split_fields1 b)))) true false))
...
(assert (< dw1000__register_types__dx_time_type__dx_time__first__bit dw1000__register_types__dx_time_type__dx_time__last__bit))
(assert (<= 0 dw1000__register_types__dx_time_type__dx_time__position))
(declare-fun user_eq7 (us_rep us_rep) Bool)
(declare-const dummy7 us_rep)
(declare-datatypes () ((dx_time_type__ref (mk_dx_time_type__ref (dx_time_type__content us_rep)))))
(define-fun dx_time_type__ref___projection ((a dx_time_type__ref)) us_rep (dx_time_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___6__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_2567 us_t1) (temp___is_init_2563 Bool) (temp___skip_constant_2564 Bool) (temp___do_toplevel_2565 Bool) (temp___do_typ_inv_2566 Bool)) Bool (=> (not (= temp___skip_constant_2564 true)) (and (dynamic_property2 1 5 (first3 temp___expr_2567) (last3 temp___expr_2567)) (and (= (first3 temp___expr_2567) 1) (= (last3 temp___expr_2567) 5)))))
...
(define-fun register_type__ref___18__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___13__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_2549 us_t2) (temp___is_init_2545 Bool) (temp___skip_constant_2546 Bool) (temp___do_toplevel_2547 Bool) (temp___do_typ_inv_2548 Bool)) Bool (=> (not (= temp___skip_constant_2546 true)) (and (dynamic_property3 1 5 (first5 temp___expr_2549) (last5 temp___expr_2549)) (and (= (first5 temp___expr_2549) 1) (= (last5 temp___expr_2549) 5)))))
...
(declare-const temp___8501 (Array Int bits_8))
(declare-const temp___85011 t1)
(define-fun temp___85012 () us_t1 (mk___t1 temp___8501 temp___85011))
...
(assert (and (= temp___85012 (register_to_bytes reg)) (dynamic_invariant temp___85012 true false true true)))
(assert (not (= (ite (<= (to_rep (first2 temp___85011)) (to_rep (last2 temp___85011))) (+ (- (to_rep (last2 temp___85011)) (to_rep (first2 temp___85011))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0))))
(check-sat)
(exit)
