...
(declare-datatypes () ((sequence__ref (mk_sequence__ref (sequence__content us_t)))))
(define-fun sequence__ref___projection ((a sequence__ref)) us_t (sequence__content a))
...
(define-fun dynamic_invariant2 ((temp___expr_236 us_t) (temp___is_init_232 Bool) (temp___skip_constant_233 Bool) (temp___do_toplevel_234 Bool) (temp___do_typ_inv_235 Bool)) Bool (and (=> (not (= temp___skip_constant_233 true)) (dynamic_property 0 2147483647 (first1 temp___expr_236) (last1 temp___expr_236))) (=> (= temp___do_toplevel_234 true) (=> (= temp___is_init_232 true) (= (first1 temp___expr_236) 0)))))
(define-fun dynamic_predicate ((temp___239 us_t)) Bool (= (first1 temp___239) 0))
...
(assert (and (dynamic_property 0 2147483647 (to_rep sq__first) (to_rep sq__last)) (= (to_rep sq__first) 0)))
(assert (= result i))
(assert (= i1 0))
(assert (<= 0 i1))
(assert (<= i1 (to_rep sq__last)))
(assert (forall ((j1 Int)) (=> (and (<= i2 j1) (<= j1 (to_rep sq__last))) (= (to_rep1 (select sq1 j1)) (to_rep1 (select sq j1))))))
(assert (and (and (and (=> (<= 0 (to_rep sq__last)) (dynamic_property1 0 (to_rep sq__last) i2)) (= (to_rep sq__first) 0)) (forall ((temp___269 Int)) (=> (and (<= (to_rep sq__first) temp___269) (<= temp___269 (to_rep sq__last))) (=> (or (< (to_rep sq__last) temp___269) (or (< temp___269 0) (<= i2 temp___269))) (= (select sq1 temp___269) (select sq temp___269)))))) (and (<= 0 i2) (<= i2 (to_rep sq__last)))))
(assert (<= i2 j))
(assert (<= j (to_rep sq__last)))
(assert (not (<= j (to_rep sq__last))))
(check-sat)
(exit)
