...
(assert (bvule j #x0000000000000007))
(assert (not (= (to_rep (select memory (bvadd (bvadd rdi_start (bvmul i1 #x0000000000000008)) j))) (to_rep (select mem (bvadd (bvadd rdi_start (bvmul i1 #x0000000000000008)) j))))))
(check-sat)
(exit)
