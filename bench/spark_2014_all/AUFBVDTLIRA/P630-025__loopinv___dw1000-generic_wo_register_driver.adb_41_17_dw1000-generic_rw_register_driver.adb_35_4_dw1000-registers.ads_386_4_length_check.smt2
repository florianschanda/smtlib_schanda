...
(assert (not (= (ite (<= (to_rep (first4 temp___87081)) (to_rep (last4 temp___87081))) (+ (- (to_rep (last4 temp___87081)) (to_rep (first4 temp___87081))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
