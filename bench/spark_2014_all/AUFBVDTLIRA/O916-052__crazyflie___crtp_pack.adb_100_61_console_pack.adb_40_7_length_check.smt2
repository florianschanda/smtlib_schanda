...
(assert (= data_size 1))
(declare-const handler__split_fields (Array Int t_uint8))
...
(assert (= o3 handler__split_fields))
(assert (= o3 temp___4250))
(assert (= (mk r6b r7b) temp___42501))
(assert (not (= (ite (<= (to_rep6 (first temp___42481)) (to_rep6 (last temp___42481))) (+ (- (to_rep6 (last temp___42481)) (to_rep6 (first temp___42481))) 1) 0) (ite (<= (to_rep6 (first temp___42501)) (to_rep6 (last temp___42501))) (+ (- (to_rep6 (last temp___42501)) (to_rep6 (first temp___42501))) 1) 0))))
(check-sat)
(exit)
