...
(assert (= o11 (ite (= o10 76) true false)))
(assert (and (<= 1 (+ begidx2 2)) (<= (+ begidx2 2) 256)))
(assert (= o3 (+ begidx2 2)))
(assert (= o4 (select zonefileline o3)))
(assert (= o5 (to_rep o4)))
(assert (= o6 (ite (= o5 84) true false)))
(assert (and (<= 1 (+ begidx2 1)) (<= (+ begidx2 1) 256)))
(assert (= o (+ begidx2 1)))
(assert (= o1 (select zonefileline o)))
(assert (= o2 (to_rep o1)))
(assert (= o7 (ite (= o2 84) true false)))
(assert (= o12 (ite (= o7 true) o6 false)))
(assert (= result2 (ite (= o12 true) o11 false)))
(assert (= result2 true))
(assert (=> (and (< begidx2 zlength) (< endidx1 zlength)) (and (= o13 (+ endidx1 1)) (in_range4 (+ endidx1 1)))))
(assert (=> (and (< begidx2 zlength) (< endidx1 zlength)) (= begidx2 result3)))
(assert (=> (and (< begidx2 zlength) (< endidx1 zlength)) (= begidx3 o13)))
...
(assert (not (and (not (= foundtype2 0)) (not (= foundtype2 1)))))
(assert (= begidx4 r69b))
(assert (in_range4 r69b))
(assert (= endidx2 r70b))
(assert (in_range4 r70b))
(assert (<= r69b r70b))
(assert (not (<= r70b 2147483647)))
(check-sat)
(exit)
