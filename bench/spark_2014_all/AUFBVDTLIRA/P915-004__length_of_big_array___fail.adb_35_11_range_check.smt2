...
(define-fun dynamic_invariant5 ((temp___expr_32 Int) (temp___is_init_28 Bool) (temp___skip_constant_29 Bool) (temp___do_toplevel_30 Bool) (temp___do_typ_inv_31 Bool)) Bool (=> (or (= temp___is_init_28 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range4 temp___expr_32)))
(define-fun dynamic_invariant6 ((temp___expr_331 (_ BitVec 64)) (temp___is_init_327 Bool) (temp___skip_constant_328 Bool) (temp___do_toplevel_329 Bool) (temp___do_typ_inv_330 Bool)) Bool true)
(assert (forall ((last4 (_ BitVec 64))) (! (=> (dynamic_invariant6 last4 true true true true) (let ((result (create last4))) (and (and (= (last3 result) last4) (= (first3 result) #x0000000000000000)) (dynamic_invariant result true false true true)))) :pattern ((create last4)))))
...
(assert (not (in_range4 (length1 c))))
(check-sat)
(exit)
