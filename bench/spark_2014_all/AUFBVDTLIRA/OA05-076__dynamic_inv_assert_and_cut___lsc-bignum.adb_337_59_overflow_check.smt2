...
(assert (= o45 (num_of_big_int (mk___t o66 (mk (to_rep a__first) (to_rep a__last))) a_first o44)))
...
(assert (and (= o31 (- i2 a_first)) (in_range1 (- i2 a_first))))
