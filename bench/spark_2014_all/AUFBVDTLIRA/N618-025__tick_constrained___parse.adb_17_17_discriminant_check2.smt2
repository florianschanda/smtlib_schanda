...
(declare-const temp___362 return_code_t)
(declare-const temp___3621 unsigned_16)
(declare-const temp___3622 query_opcode)
(declare-const temp___3623 qdcount_range)
(declare-const temp___3624 Bool)
...
(assert (= (to_rep2 o7) 1))
(assert (= o7 o8))
(assert (= temp___362 o8))
(assert (= dummy8 (mk___rep1 (mk___split_fields1 temp___3621 temp___3622 temp___3623))))
(assert (= true temp___3624))
(assert (= result____attr__constrained true))
(assert (not (= temp___362 result____split_discrs)))
(check-sat)
(exit)
