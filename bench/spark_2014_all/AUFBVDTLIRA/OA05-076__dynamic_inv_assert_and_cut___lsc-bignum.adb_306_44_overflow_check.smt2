...
(assert (= o31 (ite (<= o28 k) true false)))
(assert (= result3 (ite (= o31 true) o30 false)))
(assert (= (= o32 true) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a2 k1)) (to_rep1 (select a k1)))))))
(assert (= o24 (from_word32 carry22)))
(assert (and (= o23 (base Tuple0)) (= o23 (oexpon (from_word32 #x00000002) 32))))
(assert (= o25 (omultiply o23 o24)))
(assert (= o22 (from_word32 carry12)))
