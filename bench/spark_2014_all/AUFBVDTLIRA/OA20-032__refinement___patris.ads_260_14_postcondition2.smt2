...
(assert (forall ((x cell)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x shape)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_2192 Int) (temp___is_init_2188 Bool) (temp___skip_constant_2189 Bool) (temp___do_toplevel_2190 Bool) (temp___do_typ_inv_2191 Bool)) Bool (=> (or (= temp___is_init_2188 true) (<= 0 4)) (in_range7 temp___expr_2192)))
...
(declare-fun is_empty__2 ((Array Int (Array Int cell))) Bool)
(declare-fun is_empty__2__function_guard (Bool (Array Int (Array Int cell))) Bool)
(declare-fun is_empty_line ((Array Int cell)) Bool)
(declare-fun is_empty_line__function_guard (Bool (Array Int cell)) Bool)
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (! (= (= (is_empty__2 b) true) (forall ((y Int)) (=> (and (<= 1 y) (<= y 20)) (= (is_empty_line (select b y)) true)))) :pattern ((is_empty__2 b)))))
...
(declare-fun temp_____aggregate_def_2462 ((Array Int cell)) (Array Int (Array Int cell)))
(declare-fun temp_____aggregate_def_2466 (Int) (Array Int cell))
...
(define-fun dynamic_invariant3 ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range9 temp___expr_18)))
(assert (forall ((temp___2464 (Array Int cell))) (forall ((temp___2465 Int)) (= (select (temp_____aggregate_def_2462 temp___2464) temp___2465) temp___2464))))
(define-fun dynamic_invariant4 ((temp___expr_2094 Int) (temp___is_init_2090 Bool) (temp___skip_constant_2091 Bool) (temp___do_toplevel_2092 Bool) (temp___do_typ_inv_2093 Bool)) Bool (=> (or (= temp___is_init_2090 true) (<= 0 7)) (in_range2 temp___expr_2094)))
(assert (forall ((temp___2468 Int)) (=> (dynamic_invariant4 temp___2468 true true true true) (forall ((temp___2469 Int)) (= (to_rep (select (temp_____aggregate_def_2466 temp___2468) temp___2469)) temp___2468)))))
(define-fun dynamic_invariant5 ((temp___expr_2101 Int) (temp___is_init_2097 Bool) (temp___skip_constant_2098 Bool) (temp___do_toplevel_2099 Bool) (temp___do_typ_inv_2100 Bool)) Bool (=> (or (= temp___is_init_2097 true) (<= 1 7)) (in_range3 temp___expr_2101)))
...
(define-fun dynamic_invariant7 ((temp___expr_2122 Int) (temp___is_init_2118 Bool) (temp___skip_constant_2119 Bool) (temp___do_toplevel_2120 Bool) (temp___do_typ_inv_2121 Bool)) Bool (=> (or (= temp___is_init_2118 true) (<= 1 20)) (in_range11 temp___expr_2122)))
(define-fun dynamic_invariant8 ((temp___expr_2160 Int) (temp___is_init_2156 Bool) (temp___skip_constant_2157 Bool) (temp___do_toplevel_2158 Bool) (temp___do_typ_inv_2159 Bool)) Bool (=> (or (= temp___is_init_2156 true) (<= (- 1) 9)) (in_range4 temp___expr_2160)))
(define-fun dynamic_invariant9 ((temp___expr_2167 Int) (temp___is_init_2163 Bool) (temp___skip_constant_2164 Bool) (temp___do_toplevel_2165 Bool) (temp___do_typ_inv_2166 Bool)) Bool (=> (or (= temp___is_init_2163 true) (<= (- 1) 19)) (in_range5 temp___expr_2167)))
(define-fun dynamic_invariant10 ((temp___expr_2174 Int) (temp___is_init_2170 Bool) (temp___skip_constant_2171 Bool) (temp___do_toplevel_2172 Bool) (temp___do_typ_inv_2173 Bool)) Bool (=> (or (= temp___is_init_2170 true) (<= 0 3)) (in_range6 temp___expr_2174)))
(assert true)
...
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (forall ((y Int) (x Int)) (! (= (= (is_empty b y x) true) (and (and (in_range10 x) (in_range11 y)) (= (to_rep (let ((temp___2238 (select b y))) (select temp___2238 x))) 0))) :pattern ((is_empty b y x))))))
...
(assert (= (px_coordqtint rliteral) 0))
(declare-const rliteral1 py_coord)
(assert (= (py_coordqtint rliteral1) 0))
...
(declare-const o direction)
(declare-const o1 shape)
(declare-const o2 shape)
(declare-const o3 direction)
(declare-const o4 px_coord)
(declare-const o5 py_coord)
(declare-const temp___2470 shape)
(declare-const temp___24701 direction)
(declare-const temp___24702 px_coord)
(declare-const temp___24703 py_coord)
(declare-const o6 direction)
(declare-const o7 shape)
(declare-const o8 shape)
(declare-const o9 direction)
(declare-const o10 px_coord)
(declare-const o11 py_coord)
(declare-const temp___2471 shape)
(declare-const temp___24711 direction)
(declare-const temp___24712 px_coord)
(declare-const temp___24713 py_coord)
...
(declare-const score_nbr2 t__ref)
(declare-const level_nbr2 t__ref)
(declare-const line_counter2 t__ref)
(declare-const cur_board2 map__ref1)
(declare-const cur_piece__split_fields5 us_split_fields__ref)
(declare-const next_piece__split_fields5 us_split_fields__ref)
(declare-const cur_state2 int__ref)
(declare-const action_request_nbr2 int__ref)
(declare-const speed_up2 bool__ref)
(declare-const score_nbr3 (_ BitVec 32))
(declare-const level_nbr3 (_ BitVec 32))
(declare-const line_counter3 (_ BitVec 32))
...
(declare-const action_request_nbr3 Int)
(declare-const speed_up3 Bool)
(assert (=> (bvule #x00000000 #x0001869F) (in_range8 score_nbr)))
(assert (=> (bvule #x00000000 #x0001869F) (in_range8 level_nbr)))
(assert (=> (bvule #x00000000 #x0001869F) (in_range8 line_counter)))
(assert (=> (<= 0 4) (in_range7 cur_state)))
(assert (=> (<= 0 2147483647) (in_range1 action_request_nbr)))
(assert (= result level_nbr))
(assert (= level_nbr1 #x00000000))
(assert (= result1 score_nbr))
(assert (= score_nbr1 #x00000000))
(assert (= result2 line_counter))
(assert (= line_counter1 #x00000000))
(assert (= result3 cur_board))
(assert (= cur_board1 (temp_____aggregate_def_2462 (temp_____aggregate_def_2466 0))))
(assert (= (to_rep4 o) 0))
(assert (= (to_rep1 o1) 1))
(assert (= o1 o2))
(assert (= o o3))
(assert (= rliteral o4))
(assert (= rliteral1 o5))
(assert (= temp___2470 o2))
(assert (= temp___24701 o3))
(assert (= temp___24702 o4))
(assert (= temp___24703 o5))
(assert (= result4 (mk___split_fields__ref (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 cur_piece__split_fields3))))
(assert (= cur_piece__split_fields4 (mk___split_fields temp___2470 temp___24701 temp___24702 temp___24703)))
(assert (= (to_rep4 o6) 0))
(assert (= (to_rep1 o7) 1))
(assert (= o7 o8))
(assert (= o6 o9))
(assert (= rliteral o10))
(assert (= rliteral1 o11))
(assert (= temp___2471 o8))
(assert (= temp___24711 o9))
(assert (= temp___24712 o10))
(assert (= temp___24713 o11))
(assert (= result5 (mk___split_fields__ref (mk___split_fields next_piece__split_fields next_piece__split_fields1 next_piece__split_fields2 next_piece__split_fields3))))
(assert (= next_piece__split_fields4 (mk___split_fields temp___2471 temp___24711 temp___24712 temp___24713)))
(assert (= result6 (mk_int__ref cur_state)))
(assert (= cur_state1 3))
(assert (= result7 (mk_int__ref action_request_nbr)))
(assert (= action_request_nbr1 0))
(assert (= result8 (mk_bool__ref speed_up)))
(assert (= speed_up1 (distinct 0 0)))
(assert (= speed_up2 (mk_bool__ref speed_up1)))
(assert (= action_request_nbr2 (mk_int__ref action_request_nbr1)))
(assert (= cur_state2 (mk_int__ref cur_state1)))
(assert (= next_piece__split_fields5 (mk___split_fields__ref next_piece__split_fields4)))
(assert (= cur_piece__split_fields5 (mk___split_fields__ref cur_piece__split_fields4)))
(assert (= cur_board2 (mk_map__ref1 cur_board1)))
(assert (= line_counter2 (mk_t__ref line_counter1)))
(assert (= level_nbr2 (mk_t__ref level_nbr1)))
(assert (= score_nbr2 (mk_t__ref score_nbr1)))
(assert (= speed_up3 speed_up1))
(assert (= action_request_nbr3 action_request_nbr1))
(assert (= cur_state3 cur_state1))
(assert (= next_piece__split_fields6 next_piece__split_fields4))
(assert (= cur_piece__split_fields6 cur_piece__split_fields4))
(assert (= cur_board3 cur_board1))
(assert (= line_counter3 line_counter1))
(assert (= level_nbr3 level_nbr1))
(assert (= score_nbr3 score_nbr1))
(assert (not (= (get_state (int__content cur_state2)) 3)))
(check-sat)
(exit)
