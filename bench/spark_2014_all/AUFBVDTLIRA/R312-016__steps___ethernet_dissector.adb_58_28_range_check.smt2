...
(assert (= o36 (convert_to_two_octets (mk___t ethertype_length_31 (mk 1 2)))))
(assert (= o37 (ite (bvule o36 #x05FF) true false)))
(assert (= o35 (convert_to_two_octets (mk___t ethertype_length_31 (mk 1 2)))))
(assert (= o38 (ite (bvule #x05DD o35) true false)))
(assert (= result11 (ite (= o38 true) o37 false)))
(assert (not (= result11 true)))
(assert (and (= o39 (+ (to_rep (first (rt buffer))) 12)) (in_range1 (+ (to_rep (first (rt buffer))) 12))))
(assert (= o40 (+ o39 offset2)))
(assert (and (= ethernet_dissector__match__R37b__assume o40) (in_range1 o40)))
(assert (= ethernet_dissector__match__R37b__assume r37b))
(assert (in_range1 r37b))
(assert (and (= o41 (+ (to_rep (first (rt buffer))) 13)) (in_range1 (+ (to_rep (first (rt buffer))) 13))))
(assert (= o42 (+ o41 offset2)))
(assert (and (= ethernet_dissector__match__R38b__assume o42) (in_range1 o42)))
(assert (= ethernet_dissector__match__R38b__assume r38b))
(assert (in_range1 r38b))
(assert (=> (<= r37b r38b) (and (and (<= (to_rep (first (rt buffer))) r37b) (<= r37b (to_rep (last (rt buffer))))) (and (<= (to_rep (first (rt buffer))) r38b) (<= r38b (to_rep (last (rt buffer))))))))
(assert (= o43 (elts buffer)))
(assert (= temp___737 (mk___t11 o43 (mk11 r37b r38b))))
(assert (= o44 (mk___t (elts11 temp___737) (mk (to_rep (first22 (rt11 temp___737))) (to_rep (last22 (rt11 temp___737)))))))
(assert (and (= o45 (length buffer)) (in_range1 (length buffer))))
(assert (= o46 (+ (to_rep (first (rt buffer))) o45)))
(assert (and (= o47 o46) (in_range1 o46)))
(assert (= o48 (- o47 15)))
(assert (and (= o49 o48) (in_range1 o48)))
(assert (= o50 (- o49 offset2)))
(assert (and (= ethernet_dissector__match__R41b__assume o50) (in_range1 o50)))
(assert (= ethernet_dissector__match__R41b__assume r41b))
(assert (in_range1 r41b))
(assert (<= (to_rep (first (rt buffer))) r41b))
(assert (not (<= (to_rep (first (rt buffer))) (to_rep (last (rt buffer))))))
(check-sat)
(exit)
