...
(define-fun dynamic_invariant ((temp___expr_4947 Int) (temp___is_init_4943 Bool) (temp___skip_constant_4944 Bool) (temp___do_toplevel_4945 Bool) (temp___do_typ_inv_4946 Bool)) Bool (=> (or (= temp___is_init_4943 true) (<= 0 5)) (in_range4 temp___expr_4947)))
(declare-fun to_rep1 (rx_errors) Int)
(declare-fun of_rep1 (Int) rx_errors)
(assert (forall ((x rx_errors)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x rx_errors)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x frame_length)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun to_int2 ((x bits_8)) Int (bv2nat (to_rep3 x)))
...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields1 a))) (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields1 b)))) (= (bool_eq (rec__decadriver__rx_frame_type__frame (us_split_fields1 a)) 0 1024 (rec__decadriver__rx_frame_type__frame (us_split_fields1 b)) 0 1024) true)) (= (to_rep1 (rec__decadriver__rx_frame_type__error (us_split_fields1 a))) (to_rep1 (rec__decadriver__rx_frame_type__error (us_split_fields1 b))))) (= (rec__decadriver__rx_frame_type__overrun (us_split_fields1 a)) (rec__decadriver__rx_frame_type__overrun (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_4954 us_rep) (temp___is_init_4950 Bool) (temp___skip_constant_4951 Bool) (temp___do_toplevel_4952 Bool) (temp___do_typ_inv_4953 Bool)) Bool (=> (= temp___do_toplevel_4952 true) (=> (= temp___is_init_4950 true) (ite (= (to_rep1 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___expr_4954))) 0) (< 0 (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4954)))) (= (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4954))) 0)))))
(define-fun dynamic_predicate ((temp___4965 us_rep)) Bool (ite (= (to_rep1 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___4965))) 0) (< 0 (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4965)))) (= (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4965))) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_4973 (_ BitVec 8)) (temp___is_init_4969 Bool) (temp___skip_constant_4970 Bool) (temp___do_toplevel_4971 Bool) (temp___do_typ_inv_4972 Bool)) Bool (=> (or (= temp___is_init_4969 true) (bvule #x00 #x01)) (in_range5 temp___expr_4973)))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x02))) (=> (in_range5 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
...
(define-fun dynamic_invariant6 ((temp___expr_4940 Int) (temp___is_init_4936 Bool) (temp___skip_constant_4937 Bool) (temp___do_toplevel_4938 Bool) (temp___do_typ_inv_4939 Bool)) Bool (=> (or (= temp___is_init_4936 true) (<= 0 1024)) (in_range3 temp___expr_4940)))
(assert (forall ((temp___5016 us_rep)) (=> (dynamic_invariant1 temp___5016 true true true true) (forall ((temp___5017 (_ BitVec 8))) (= (select (temp_____aggregate_def_5014 temp___5016) temp___5017) temp___5016)))))
...
(assert (forall ((temp___5020 (_ BitVec 8))) (=> (dynamic_invariant7 temp___5020 true true true true) (forall ((temp___5021 Int)) (= (to_rep3 (select (temp_____aggregate_def_5018 temp___5020) temp___5021)) temp___5020)))))
...
(declare-const o17 (Array Int bits_8))
(declare-const o18 rx_errors)
...
(declare-const o31 rx_errors)
(declare-const o32 frame_length)
(declare-const o33 (Array Int bits_8))
(declare-const o34 rx_errors)
(declare-const o35 Bool)
(declare-const temp___5136 frame_length)
(declare-const temp___51361 (Array Int bits_8))
(declare-const temp___51362 rx_errors)
(declare-const temp___51363 Bool)
(declare-const o36 frame_length)
(declare-const o37 (Array Int bits_8))
(declare-const o38 rx_errors)
(declare-const o39 Bool)
(declare-const o40 (Array (_ BitVec 8) us_rep))
(declare-const o41 (Array (_ BitVec 8) us_rep))
(declare-const o42 rx_frame_queue_index)
...
(define-fun o51 () us_rep (mk___rep (mk___split_fields o36 o37 o38 o39)))
(define-fun temp___51364 () us_rep (mk___rep (mk___split_fields temp___5136 temp___51361 temp___51362 temp___51363)))
...
(assert (not (= error 0)))
(assert (=> (bvule #x00 #x01) (in_range5 next_idx)))
...
(assert (dynamic_predicate (mk___rep (mk___split_fields rliteral (rec__decadriver__rx_frame_type__frame (us_split_fields1 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__5)) next_idx1))) (rec__decadriver__rx_frame_type__error (us_split_fields1 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__5)) next_idx1))) (rec__decadriver__rx_frame_type__overrun (us_split_fields1 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__5)) next_idx1)))))))
(assert (= rliteral o16))
(assert (= (rec__decadriver__rx_frame_type__frame (us_split_fields1 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__5)) next_idx1))) o17))
(assert (= (rec__decadriver__rx_frame_type__error (us_split_fields1 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__5)) next_idx1))) o18))
(assert (= (rec__decadriver__rx_frame_type__overrun (us_split_fields1 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__5)) next_idx1))) o19))
(assert (= o20 (store (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__5)) next_idx1 (mk___rep (mk___split_fields o16 o17 o18 o19)))))
(assert (= o20 o21))
(assert (= (rec__decadriver__receiver_type__queue_head (us_split_fields3 self__5)) o22))
(assert (= (rec__decadriver__receiver_type__rx_count (us_split_fields3 self__5)) o23))
...
(assert (= (to_rep1 o31) error))
(assert (= (rec__decadriver__rx_frame_type__size (us_split_fields1 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__6)) next_idx1))) o32))
(assert (= (rec__decadriver__rx_frame_type__frame (us_split_fields1 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__6)) next_idx1))) o33))
(assert (= o31 o34))
(assert (= (rec__decadriver__rx_frame_type__overrun (us_split_fields1 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__6)) next_idx1))) o35))
(assert (= temp___5136 o32))
(assert (= temp___51361 o33))
(assert (= temp___51362 o34))
(assert (= temp___51363 o35))
(assert (dynamic_predicate temp___51364))
(assert (= o51 temp___51364))
(assert (= o40 (store (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__6)) next_idx1 o51)))
(assert (= o40 o41))
(assert (= (rec__decadriver__receiver_type__queue_head (us_split_fields3 self__6)) o42))
(assert (= (rec__decadriver__receiver_type__rx_count (us_split_fields3 self__6)) o43))
(assert (= (rec__decadriver__receiver_type__overrun_occurred (us_split_fields3 self__6)) o44))
(assert (= (rec__decadriver__receiver_type__frame_ready (us_split_fields3 self__6)) o45))
(assert (= o46 o41))
(assert (= o47 o42))
(assert (= o48 o43))
(assert (= o49 o44))
...
(assert (= self__7 (mk___rep1 (mk___split_fields1 o46 o47 o48 o49 o50))))
