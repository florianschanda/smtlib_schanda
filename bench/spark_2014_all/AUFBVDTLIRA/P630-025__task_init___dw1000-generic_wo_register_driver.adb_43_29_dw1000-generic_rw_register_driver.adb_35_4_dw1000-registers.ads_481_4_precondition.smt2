...
(assert (= (ite (<= (to_rep (first4 temp___88211)) (to_rep (last4 temp___88211))) (+ (- (to_rep (last4 temp___88211)) (to_rep (first4 temp___88211))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8821 temp___88211)))
(assert (= o2 o))
