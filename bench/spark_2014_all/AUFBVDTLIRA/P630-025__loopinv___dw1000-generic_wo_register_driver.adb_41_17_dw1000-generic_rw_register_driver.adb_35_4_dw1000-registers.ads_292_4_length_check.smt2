...
(define-fun target__ref___17__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__dw1000__register_types__agc_ctrl1_type__dis_am (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__agc_ctrl1_type__dis_am (us_split_fields1 b)))) (= (to_rep3 (rec__dw1000__register_types__agc_ctrl1_type__reserved (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__agc_ctrl1_type__reserved (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant ((temp___expr_3810 us_t1) (temp___is_init_3806 Bool) (temp___skip_constant_3807 Bool) (temp___do_toplevel_3808 Bool) (temp___do_typ_inv_3809 Bool)) Bool (=> (not (= temp___skip_constant_3807 true)) (and (dynamic_property2 1 2 (first3 temp___expr_3810) (last3 temp___expr_3810)) (and (= (first3 temp___expr_3810) 1) (= (last3 temp___expr_3810) 2)))))
...
(define-fun register_byte_array__ref___42__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_3791 us_t2) (temp___is_init_3787 Bool) (temp___skip_constant_3788 Bool) (temp___do_toplevel_3789 Bool) (temp___do_typ_inv_3790 Bool)) Bool (=> (not (= temp___skip_constant_3788 true)) (and (dynamic_property3 1 2 (first5 temp___expr_3791) (last5 temp___expr_3791)) (and (= (first5 temp___expr_3791) 1) (= (last5 temp___expr_3791) 2)))))
...
(declare-const temp___85981 t1)
(declare-const temp___8599 (Array Int bits_8))
(declare-const temp___85991 t2)
(define-fun temp___85982 () us_t1 (mk___t1 temp___8598 temp___85981))
...
(assert (and (= temp___85982 (register_to_bytes reg)) (dynamic_invariant temp___85982 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___85981)) (to_rep (last2 temp___85981))) (+ (- (to_rep (last2 temp___85981)) (to_rep (first2 temp___85981))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8598 temp___8599))
(assert (= (mk2 (to_rep (first2 temp___85981)) (to_rep (last2 temp___85981))) temp___85991))
(assert (not (= (ite (<= (to_rep (first4 temp___85991)) (to_rep (last4 temp___85991))) (+ (- (to_rep (last4 temp___85991)) (to_rep (first4 temp___85991))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
