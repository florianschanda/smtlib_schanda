...
(assert (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1061) (<= temp___1061 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))))
(assert (= o19 temp___1061))
...
(assert (= temp___1063 (- o23 1)))
(assert (not (<= temp___1063 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))))
(check-sat)
(exit)
