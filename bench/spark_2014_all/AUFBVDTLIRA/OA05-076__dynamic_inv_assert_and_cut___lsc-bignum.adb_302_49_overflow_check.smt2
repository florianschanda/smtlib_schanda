...
(assert (= a1 result2))
(assert (= a2 o15))
(assert (and (= o42 (+ a_last 1)) (in_range1 (+ a_last 1))))
(assert (= o43 (ite (<= k o42) true false)))
(assert (and (= o41 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o44 (ite (<= o41 k) true false)))
(assert (= result3 (ite (= o44 true) o43 false)))
(assert (= (= o45 true) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a2 k1)) (to_rep1 (select a k1)))))))
(assert (= o36 (from_word32 carry22)))
(assert (and (= o35 (base Tuple0)) (= o35 (oexpon (from_word32 #x00000002) 32))))
(assert (= o37 (omultiply o35 o36)))
(assert (= o34 (from_word32 carry12)))
(assert (= o38 (oadd o34 o37)))
(assert (and (= o29 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o30 (- o29 a_first)))
...
(assert (= o33 (oexpon o28 o32)))
(assert (= o39 (omultiply o33 o38)))
(assert (and (= o23 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o24 (- o23 a_first)))
(assert (and (= o25 o24) (in_range1 o24)))
(assert (and (= o26 o25) (in_range2 o25)))
(assert (= o27 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o26)))
(assert (= o40 (oadd o27 o39)))
(assert (= o21 (from_word32 carry2)))
(assert (and (= o20 (base Tuple0)) (= o20 (oexpon (from_word32 #x00000002) 32))))
(assert (= o22 (omultiply o20 o21)))
(assert (= o19 (from_word32 carry1)))
(assert (= o18 (from_word32 y)))
