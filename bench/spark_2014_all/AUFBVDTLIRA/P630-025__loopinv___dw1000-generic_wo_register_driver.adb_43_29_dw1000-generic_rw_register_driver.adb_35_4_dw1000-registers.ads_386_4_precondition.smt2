...
(define-fun target__ref___31__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__drx_tune0b_type__drx_tune0b (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__drx_tune0b_type__drx_tune0b (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_5243 us_t1) (temp___is_init_5239 Bool) (temp___skip_constant_5240 Bool) (temp___do_toplevel_5241 Bool) (temp___do_typ_inv_5242 Bool)) Bool (=> (not (= temp___skip_constant_5240 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5243) (last3 temp___expr_5243)) (and (= (first3 temp___expr_5243) 1) (= (last3 temp___expr_5243) 2)))))
...
(define-fun register_byte_array__ref___75__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_5225 us_t2) (temp___is_init_5221 Bool) (temp___skip_constant_5222 Bool) (temp___do_toplevel_5223 Bool) (temp___do_typ_inv_5224 Bool)) Bool (=> (not (= temp___skip_constant_5222 true)) (and (dynamic_property3 1 2 (first5 temp___expr_5225) (last5 temp___expr_5225)) (and (= (first5 temp___expr_5225) 1) (= (last5 temp___expr_5225) 2)))))
...
(declare-const temp___87071 t1)
(declare-const temp___8708 (Array Int bits_8))
(declare-const temp___87081 t2)
...
(define-fun temp___87072 () us_t1 (mk___t1 temp___8707 temp___87071))
...
(assert (and (= temp___87072 (register_to_bytes reg)) (dynamic_invariant temp___87072 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___87071)) (to_rep (last2 temp___87071))) (+ (- (to_rep (last2 temp___87071)) (to_rep (first2 temp___87071))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8707 temp___8708))
(assert (= (mk2 (to_rep (first2 temp___87071)) (to_rep (last2 temp___87071))) temp___87081))
(assert (= (ite (<= (to_rep (first4 temp___87081)) (to_rep (last4 temp___87081))) (+ (- (to_rep (last4 temp___87081)) (to_rep (first4 temp___87081))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8708 temp___87081)))
(assert (= o2 o))
