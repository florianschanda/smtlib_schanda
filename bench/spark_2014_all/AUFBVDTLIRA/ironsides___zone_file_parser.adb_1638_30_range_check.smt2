...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= tokentype1 1) (forall ((i18 Int)) (=> (and (<= begidx2 i18) (<= i18 endidx1)) (and (<= 48 (to_rep (select zonefileline i18))) (<= (to_rep (select zonefileline i18)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 tokentype1))))
...
(assert (= i3 r109b))
(assert (=> (and (<= r109b i3) (<= i3 r110b)) (= temp___1832 token1)))
(assert (=> (and (<= r109b i3) (<= i3 r110b)) (= temp___1834 i3)))
...
(assert (=> (and (<= r109b i3) (<= i3 r110b)) (and (= temp___1831 o2) (in_range1 o2))))
(assert (=> (and (<= r109b i3) (<= i3 r110b)) (and (<= 1 temp___1831) (<= temp___1831 256))))
(assert (=> (and (<= r109b i3) (<= i3 r110b)) (= o4 temp___1831)))
...
(assert (=> (not (<= 128 lengthoftoken1)) (in_range4 r112b)))
(assert (=> (not (<= 128 lengthoftoken1)) (= result8 i17)))
(assert (=> (not (<= 128 lengthoftoken1)) (= i9 1)))
(assert (=> (not (<= 128 lengthoftoken1)) (=> (and (<= 1 i9) (<= i9 r112b)) (= temp___1838 newowner2))))
(assert (=> (not (<= 128 lengthoftoken1)) (=> (and (<= 1 i9) (<= i9 r112b)) (= temp___1837 i9))))
(assert (=> (not (<= 128 lengthoftoken1)) (=> (and (<= 1 i9) (<= i9 r112b)) (= temp___1840 lengthoftoken1))))
(assert (=> (not (<= 128 lengthoftoken1)) (=> (and (<= 1 i9) (<= i9 r112b)) (and (= lengthoftoken1 temp___1840) (< lengthoftoken1 128)))))
(assert (=> (not (<= 128 lengthoftoken1)) (=> (and (<= 1 i9) (<= i9 r112b)) (and (and (=> (<= 1 r112b) (dynamic_property1 1 r112b i10)) (forall ((temp___1839 Int)) (=> (and (<= 1 temp___1839) (<= temp___1839 128)) (=> (or (< r112b temp___1839) (or (< temp___1839 1) (<= i10 temp___1839))) (= (select newowner3 temp___1839) (select temp___1838 temp___1839)))))) (and (<= 1 i10) (<= i10 r112b))))))
...
(assert (not (in_range4 (+ endidx1 1))))
(check-sat)
(exit)
