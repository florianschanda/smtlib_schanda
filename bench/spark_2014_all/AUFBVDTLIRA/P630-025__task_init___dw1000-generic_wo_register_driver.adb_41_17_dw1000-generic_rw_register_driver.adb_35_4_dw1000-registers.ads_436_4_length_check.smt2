...
(assert (= (ite (<= (to_rep (first2 temp___87721)) (to_rep (last2 temp___87721))) (+ (- (to_rep (last2 temp___87721)) (to_rep (first2 temp___87721))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8772 temp___8773))
(assert (= (mk2 (to_rep (first2 temp___87721)) (to_rep (last2 temp___87721))) temp___87731))
(assert (not (= (ite (<= (to_rep (first4 temp___87731)) (to_rep (last4 temp___87731))) (+ (- (to_rep (last4 temp___87731)) (to_rep (first4 temp___87731))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
