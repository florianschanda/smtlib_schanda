...
(declare-const o16 t)
(declare-const temp___1578 digit_index_type)
(declare-const temp___15781 (Array Int octet))
(declare-const temp___15782 t)
...
(assert (= (to_rep2 (last number__split_fields1)) r126b))
(assert (in_range3 r126b))
(assert (= result2 i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 r126b))
(assert (and (and (dynamic_invariant2 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true true) (forall ((temp___1587 Int)) (=> (and (<= (to_rep2 (first number__split_fields3)) temp___1587) (<= temp___1587 (to_rep2 (last number__split_fields3)))) (=> (or (< r126b temp___1587) (or (< temp___1587 1) (<= i2 temp___1587))) (= (select number__split_fields2 temp___1587) (select number__split_fields temp___1587)))))) (and (<= 1 i2) (<= i2 r126b))))
...
(assert (and (= o5 (shift_right o4 (- 8 distance))) (= o5 (bvudiv o4 (ite (< (- 8 distance) 256) (bvshl #x01 ((_ int2bv 8) (- 8 distance))) #x00)))))
(assert (= result3 new_overflow))
(assert (= new_overflow1 o5))
(assert (=> (< distance 8) (and (<= (to_rep2 (first number__split_fields3)) i2) (<= i2 (to_rep2 (last number__split_fields3))))))
(assert (=> (< distance 8) (= o6 i2)))
(assert (=> (< distance 8) (= o7 (select number__split_fields2 o6))))
(assert (=> (< distance 8) (= o8 (to_rep1 o7))))
...
(assert (= o15 o13))
(assert (= o16 o14))
(assert (= number__split_discrs (mk___split_discrs temp___1578)))
(assert (= temp___15781 o15))
(assert (= temp___15782 o16))
(assert (= result4 number__split_fields2))
(assert (= result5 number__split_fields3))
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___15781 temp___15782))))
(assert (= number__split_discrs (mk___split_discrs temp___1578)))
