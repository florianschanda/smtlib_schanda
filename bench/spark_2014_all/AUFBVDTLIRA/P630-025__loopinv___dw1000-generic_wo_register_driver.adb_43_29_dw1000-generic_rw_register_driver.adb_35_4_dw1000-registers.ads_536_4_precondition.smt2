...
(assert (= (ite (<= (to_rep (first2 temp___88971)) (to_rep (last2 temp___88971))) (+ (- (to_rep (last2 temp___88971)) (to_rep (first2 temp___88971))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8897 temp___8898))
(assert (= (mk2 (to_rep (first2 temp___88971)) (to_rep (last2 temp___88971))) temp___88981))
(assert (= (ite (<= (to_rep (first4 temp___88981)) (to_rep (last4 temp___88981))) (+ (- (to_rep (last4 temp___88981)) (to_rep (first4 temp___88981))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8898 temp___88981)))
(assert (= o2 o))
