...
(define-fun tregister_byte_arrayP1__ref___10__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___4__projection ((a target__ref)) us_t1 (target__content a))
...
(declare-fun user_eq8 (bits_3 bits_3) Bool)
(declare-const dummy8 bits_3)
...
(declare-fun user_eq9 (bits_7 bits_7) Bool)
(declare-const dummy9 bits_7)
...
(assert (forall ((x bits_7)) (! (in_range_int3 (to_int7 x)) :pattern ((to_int7 x)))))
...
(declare-fun user_eq10 (bits_10 bits_10) Bool)
(declare-const dummy10 bits_10)
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (and (and (and (and (and (= (to_rep5 (rec__dw1000__register_types__tx_fctrl_type__tflen (us_split_fields1 a))) (to_rep5 (rec__dw1000__register_types__tx_fctrl_type__tflen (us_split_fields1 b)))) (= (to_rep4 (rec__dw1000__register_types__tx_fctrl_type__tfle (us_split_fields1 a))) (to_rep4 (rec__dw1000__register_types__tx_fctrl_type__tfle (us_split_fields1 b))))) (= (to_rep4 (rec__dw1000__register_types__tx_fctrl_type__r (us_split_fields1 a))) (to_rep4 (rec__dw1000__register_types__tx_fctrl_type__r (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__tx_fctrl_type__txbr (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__tx_fctrl_type__txbr (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__tx_fctrl_type__tr (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__tx_fctrl_type__tr (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__tx_fctrl_type__txprf (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__tx_fctrl_type__txprf (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__tx_fctrl_type__txpsr (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__tx_fctrl_type__txpsr (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__tx_fctrl_type__pe (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__tx_fctrl_type__pe (us_split_fields1 b))))) (= (to_rep6 (rec__dw1000__register_types__tx_fctrl_type__txboffs (us_split_fields1 a))) (to_rep6 (rec__dw1000__register_types__tx_fctrl_type__txboffs (us_split_fields1 b))))) (= (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__ifsdelay (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__ifsdelay (us_split_fields1 b))))) true false))
...
(define-fun source__ref___4__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_2456 us_t1) (temp___is_init_2452 Bool) (temp___skip_constant_2453 Bool) (temp___do_toplevel_2454 Bool) (temp___do_typ_inv_2455 Bool)) Bool (=> (not (= temp___skip_constant_2453 true)) (and (dynamic_property2 1 5 (first3 temp___expr_2456) (last3 temp___expr_2456)) (and (= (first3 temp___expr_2456) 1) (= (last3 temp___expr_2456) 5)))))
...
(define-fun register_type__ref___14__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___10__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_2429 us_t2) (temp___is_init_2425 Bool) (temp___skip_constant_2426 Bool) (temp___do_toplevel_2427 Bool) (temp___do_typ_inv_2428 Bool)) Bool (=> (not (= temp___skip_constant_2426 true)) (and (dynamic_property3 1 5 (first5 temp___expr_2429) (last5 temp___expr_2429)) (and (= (first5 temp___expr_2429) 1) (= (last5 temp___expr_2429) 5)))))
...
(declare-const temp___8488 (Array Int bits_8))
(declare-const temp___84881 t1)
(declare-const temp___8489 (Array Int bits_8))
(declare-const temp___84891 t2)
...
(define-fun temp___84882 () us_t1 (mk___t1 temp___8488 temp___84881))
...
(assert (and (= temp___84882 (register_to_bytes reg)) (dynamic_invariant temp___84882 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___84881)) (to_rep (last2 temp___84881))) (+ (- (to_rep (last2 temp___84881)) (to_rep (first2 temp___84881))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))
(assert (= temp___8488 temp___8489))
(assert (= (mk2 (to_rep (first2 temp___84881)) (to_rep (last2 temp___84881))) temp___84891))
(assert (= (ite (<= (to_rep (first4 temp___84891)) (to_rep (last4 temp___84891))) (+ (- (to_rep (last4 temp___84891)) (to_rep (first4 temp___84891))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8489 temp___84891)))
(assert (= o2 o))
