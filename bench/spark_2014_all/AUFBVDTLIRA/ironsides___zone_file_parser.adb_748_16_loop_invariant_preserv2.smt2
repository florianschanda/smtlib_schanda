...
(assert (=> (= foundtype3 3) (and (= o22 (getrecordtype rrstring begidx4 endidx3)) (in_range5 o22))))
(assert (=> (= foundtype3 3) (= result17 (mk_int__ref recordtype2))))
(assert (=> (= foundtype3 3) (= recordtype3 o22)))
(assert (=> (= foundtype3 3) (and (= o23 (+ numberofrecordtypes3 1)) (in_range7 (+ numberofrecordtypes3 1)))))
(assert (=> (= foundtype3 3) (= result18 (mk_int__ref numberofrecordtypes3))))
(assert (=> (= foundtype3 3) (= numberofrecordtypes4 o23)))
(assert (=> (= foundtype3 3) (= (to_rep2 o24) recordtype3)))
(assert (=> (= foundtype3 3) (and (<= 1 numberofrecordtypes4) (<= numberofrecordtypes4 32))))
(assert (=> (= foundtype3 3) (= o25 numberofrecordtypes4)))
(assert (=> (= foundtype3 3) (= o26 (store recordtypes3 o25 o24))))
(assert (=> (= foundtype3 3) (= result19 (mk_map__ref2 recordtypes3))))
(assert (=> (= foundtype3 3) (= recordtypes4 o26)))
(assert (=> (= foundtype3 3) (= o27 (from_query_type recordtype3))))
(assert (=> (= foundtype3 3) (= o28 (bvudiv o27 #x0100))))
(assert (=> (= foundtype3 3) (= o29 (bvurem o28 #x0100))))
(assert (=> (= foundtype3 3) (= o30 o29)))
(assert (=> (= foundtype3 3) (= o31 ((_ extract 7 0) o30))))
(assert (=> (= foundtype3 3) (= result20 (mk_t__ref blocknumber))))
(assert (=> (= foundtype3 3) (= blocknumber1 o31)))
(assert (=> (= foundtype3 3) (= result21 (mk_map__ref5 blockmap3))))
(assert (=> (= foundtype3 3) (= blockmap4 (store blockmap3 blocknumber1 (distinct 1 0)))))
(assert (=> (= foundtype3 3) (= o32 (from_query_type recordtype3))))
(assert (=> (= foundtype3 3) (= o33 (bvudiv o32 #x0100))))
(assert (=> (= foundtype3 3) (= o34 (bvmul #x0100 o33))))
(assert (=> (= foundtype3 3) (= o35 (from_query_type recordtype3))))
(assert (=> (= foundtype3 3) (= o36 (bvsub o35 o34))))
(assert (=> (= foundtype3 3) (= o37 (bvudiv o36 #x0008))))
(assert (=> (= foundtype3 3) (= o38 (bvurem o37 #x0020))))
(assert (=> (= foundtype3 3) (= o39 (bvadd o38 #x0001))))
(assert (=> (= foundtype3 3) (= o40 (bv2nat o39))))
(assert (=> (= foundtype3 3) (= result22 (mk_int__ref bytenumber2))))
(assert (=> (= foundtype3 3) (= bytenumber3 o40)))
(assert (=> (= foundtype3 3) (=> (< (to_rep3 (select blocklengthmap3 blocknumber1)) bytenumber3) (= (to_rep3 o41) bytenumber3))))
(assert (=> (= foundtype3 3) (=> (< (to_rep3 (select blocklengthmap3 blocknumber1)) bytenumber3) (= o42 (store blocklengthmap3 blocknumber1 o41)))))
(assert (=> (= foundtype3 3) (=> (< (to_rep3 (select blocklengthmap3 blocknumber1)) bytenumber3) (= result23 (mk_map__ref6 blocklengthmap3)))))
(assert (=> (= foundtype3 3) (=> (< (to_rep3 (select blocklengthmap3 blocknumber1)) bytenumber3) (= blocklengthmap4 o42))))
(assert (=> (= foundtype3 3) (=> (not (< (to_rep3 (select blocklengthmap3 blocknumber1)) bytenumber3)) (= blocklengthmap4 blocklengthmap3))))
(assert (=> (not (= foundtype3 3)) (= bytenumber3 bytenumber2)))
(assert (=> (not (= foundtype3 3)) (= blocknumber1 blocknumber)))
(assert (=> (not (= foundtype3 3)) (= recordtype3 recordtype2)))
(assert (=> (not (= foundtype3 3)) (= blocklengthmap4 blocklengthmap3)))
(assert (=> (not (= foundtype3 3)) (= blockmap4 blockmap3)))
(assert (=> (not (= foundtype3 3)) (= recordtypes4 recordtypes3)))
(assert (=> (not (= foundtype3 3)) (= numberofrecordtypes4 numberofrecordtypes3)))
(assert (= foundtype3 3))
(assert (< endidx3 256))
(assert (< numberofrecordtypes4 32))
(assert (not (<= 0 endidx3)))
(check-sat)
(exit)
