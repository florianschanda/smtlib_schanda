...
(define-fun target__ref___36__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__drx_pretoc_type__drx_pretoc (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__drx_pretoc_type__drx_pretoc (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_5563 us_t1) (temp___is_init_5559 Bool) (temp___skip_constant_5560 Bool) (temp___do_toplevel_5561 Bool) (temp___do_typ_inv_5562 Bool)) Bool (=> (not (= temp___skip_constant_5560 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5563) (last3 temp___expr_5563)) (and (= (first3 temp___expr_5563) 1) (= (last3 temp___expr_5563) 2)))))
...
(define-fun register_byte_array__ref___85__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_5545 us_t2) (temp___is_init_5541 Bool) (temp___skip_constant_5542 Bool) (temp___do_toplevel_5543 Bool) (temp___do_typ_inv_5544 Bool)) Bool (=> (not (= temp___skip_constant_5542 true)) (and (dynamic_property3 1 2 (first5 temp___expr_5545) (last5 temp___expr_5545)) (and (= (first5 temp___expr_5545) 1) (= (last5 temp___expr_5545) 2)))))
...
(declare-const temp___8742 (Array Int bits_8))
(declare-const temp___87421 t1)
(declare-const temp___8743 (Array Int bits_8))
(declare-const temp___87431 t2)
...
(define-fun temp___87422 () us_t1 (mk___t1 temp___8742 temp___87421))
...
(assert (and (= temp___87422 (register_to_bytes reg)) (dynamic_invariant temp___87422 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___87421)) (to_rep (last2 temp___87421))) (+ (- (to_rep (last2 temp___87421)) (to_rep (first2 temp___87421))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8742 temp___8743))
(assert (= (mk2 (to_rep (first2 temp___87421)) (to_rep (last2 temp___87421))) temp___87431))
(assert (= (ite (<= (to_rep (first4 temp___87431)) (to_rep (last4 temp___87431))) (+ (- (to_rep (last4 temp___87431)) (to_rep (first4 temp___87431))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8743 temp___87431)))
(assert (= o2 o))
