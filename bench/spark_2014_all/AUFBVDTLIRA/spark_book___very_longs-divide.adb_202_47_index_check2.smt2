...
(assert (and (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields2) true true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r128b))))
(assert (not (<= (to_rep1 (first4 v__split_fields1)) divisor_index2)))
(check-sat)
(exit)
