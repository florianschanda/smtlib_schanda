...
(declare-const temp___1120 us_rep1)
(declare-const temp___1119 (_ BitVec 16))
(declare-const temp___1118 (_ BitVec 16))
(declare-const temp___1117 (_ BitVec 16))
...
(assert (= j1 1))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1123 carry)))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1120 (mk___rep1 result____split_discrs result____split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1119 temp)))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1118 t_digit)))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1117 r_digit)))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1116 l_digit)))
...
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1111 carry3))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1108 (mk___rep1 result____split_discrs result____split_fields3)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1107 temp2))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1106 t_digit2))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1105 r_digit2))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1104 l_digit2))))
