...
(assert (forall ((x unsigned_8)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert true)
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__main2__some_record__c1 unsigned_8) (rec__main2__some_record__c2 unsigned_8)))))
(define-fun us_split_fields_c1__projection ((a us_split_fields)) unsigned_8 (rec__main2__some_record__c1 a))
(define-fun us_split_fields_c2__projection ((a us_split_fields)) unsigned_8 (rec__main2__some_record__c2 a))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__main2__some_record__c1 (us_split_fields1 a))) (to_rep2 (rec__main2__some_record__c1 (us_split_fields1 b)))) (= (to_rep2 (rec__main2__some_record__c2 (us_split_fields1 a))) (to_rep2 (rec__main2__some_record__c2 (us_split_fields1 b))))) true false))
...
(assert (< main2__some_record__c1__first__bit main2__some_record__c1__last__bit))
...
(assert (< main2__some_record__c2__first__bit main2__some_record__c2__last__bit))
(assert (<= 0 main2__some_record__c2__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((some_record__ref (mk_some_record__ref (some_record__content us_rep)))))
(define-fun some_record__ref___projection ((a some_record__ref)) us_rep (some_record__content a))
(define-fun default_initial_assumption ((temp___expr_573 us_rep) (temp___skip_top_level_574 Bool)) Bool (and (= (to_rep2 (rec__main2__some_record__c1 (us_split_fields1 temp___expr_573))) #x00) (= (to_rep2 (rec__main2__some_record__c2 (us_split_fields1 temp___expr_573))) #x00)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_577 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_577 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_577 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_577 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_577 us_void_param) 5)) 99)) (= (to_rep (select (temp___String_Literal_577 us_void_param) 6)) 49)) (= (to_rep (select (temp___String_Literal_577 us_void_param) 7)) 61)) :pattern ((temp___String_Literal_577 us_void_param)))))
(declare-fun temp___String_Literal_580 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_580 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_580 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_580 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_580 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_580 us_void_param) 5)) 99)) (= (to_rep (select (temp___String_Literal_580 us_void_param) 6)) 50)) (= (to_rep (select (temp___String_Literal_580 us_void_param) 7)) 61)) :pattern ((temp___String_Literal_580 us_void_param)))))
...
(assert (= off_c1 0))
(assert (= off_c2 1))
(define-fun dynamic_invariant4 ((temp___expr_205 (_ BitVec 8)) (temp___is_init_201 Bool) (temp___skip_constant_202 Bool) (temp___do_toplevel_203 Bool) (temp___do_typ_inv_204 Bool)) Bool true)
(declare-const foo__split_fields unsigned_8)
(declare-const foo__split_fields1 unsigned_8)
(assert (and (= (to_rep2 foo__split_fields) #x00) (= (to_rep2 foo__split_fields1) #x00)))
