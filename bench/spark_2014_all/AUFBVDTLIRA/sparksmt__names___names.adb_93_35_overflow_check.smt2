...
(define-fun char_table__split_fields3 () us_split_fields (mk___split_fields char_table__split_fields2))
...
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 temp___745))
(assert (and (= o (- (to_rep1 (first (rt s))) 1)) (in_range1 (- (to_rep1 (first (rt s))) 1))))
(assert (= o1 (+ i1 o)))
(assert (and (= temp___746 o1) (in_range1 o1)))
(assert (and (<= (to_rep1 (first (rt s))) temp___746) (<= temp___746 (to_rep1 (last (rt s))))))
(assert (= o2 temp___746))
(assert (= o3 (select (elts s) o2)))
(assert (= o4 (to_rep o3)))
(assert (and (and (= (length1 (mk___rep char_table__split_discrs names__data__char_tables__append__2__container__fields1)) (+ (length1 (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) 1)) (= (olt (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) (model__ (mk___rep char_table__split_discrs names__data__char_tables__append__2__container__fields1))) true)) (= (get (model__ (mk___rep char_table__split_discrs names__data__char_tables__append__2__container__fields1)) (+ (last2 (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields)))) 1)) o4)))
(assert (= (mk___split_fields__ref (mk___split_fields result1)) (mk___split_fields__ref (mk___split_fields char_table__split_fields))))
(assert (= (mk___split_fields char_table__split_fields1) names__data__char_tables__append__2__container__fields1))
(assert (and (= (invariant__ hash_table char_table__split_fields3 (mk___split_fields1 entry_table__split_fields)) true) (= (length1 (mk___rep char_table__split_discrs char_table__split_fields3)) (+ (length1 (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) i2))))
(assert (and (=> (<= 1 (length s)) (dynamic_property1 1 (length s) i2)) (and (<= 1 i2) (<= i2 (length s)))))
(assert (not (= i2 temp___745)))
(assert (= i2 result2))
(assert (= i3 (+ i2 1)))
(assert (and (= o5 (- (to_rep1 (first (rt s))) 1)) (in_range1 (- (to_rep1 (first (rt s))) 1))))
(assert (= o6 (+ i3 o5)))
