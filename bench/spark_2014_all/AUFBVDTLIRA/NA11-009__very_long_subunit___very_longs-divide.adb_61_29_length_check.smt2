...
(assert (not (= (ite (<= (to_rep1 (first4 temp___12551)) (to_rep1 (last4 temp___12551))) (+ (- (to_rep1 (last4 temp___12551)) (to_rep1 (first4 temp___12551))) 1) 0) (ite (<= 1 r116b) (+ (- r116b 1) 1) 0))))
(check-sat)
(exit)
