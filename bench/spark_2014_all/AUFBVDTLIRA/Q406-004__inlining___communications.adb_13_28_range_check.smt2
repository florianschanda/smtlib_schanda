...
(define-fun dynamic_invariant1 ((temp___expr_208 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool) (temp___do_typ_inv_207 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 16)) (in_range2 temp___expr_208)))
(define-fun to_rep1 ((x message_count)) Int (message_countqtint x))
(declare-fun of_rep1 (Int) message_count)
(assert (forall ((x message_count)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x message_count)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x message_index)) (! (in_range1 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x10))) (=> (in_range1 y) (= (to_rep2 (of_rep2 x)) y))) :pattern ((to_rep2 (of_rep2 x))))))
...
(define-fun default_initial_assumption ((temp___expr_227 us_rep) (temp___skip_top_level_228 Bool)) Bool (and (and (and (= (rec__communications__mailboxT__messages (us_split_fields1 temp___expr_227)) (temp_____aggregate_def_229 0)) (= (to_rep2 (rec__communications__mailboxT__next_in (us_split_fields1 temp___expr_227))) #x00)) (= (to_rep2 (rec__communications__mailboxT__next_out (us_split_fields1 temp___expr_227))) #x00)) (= (to_rep1 (rec__communications__mailboxT__count (us_split_fields1 temp___expr_227))) 0)))
(assert (forall ((self__ us_rep)) (! (dynamic_invariant1 (item_count self__) true false true true) :pattern ((item_count self__)))))
(assert (forall ((self__ us_rep)) (! (= (item_count self__) (to_rep1 (rec__communications__mailboxT__count (us_split_fields1 self__)))) :pattern ((item_count self__)))))
(declare-const n Int)
...
(assert (in_range n))
(assert (< (to_rep1 self__3) 16))
(assert (= (to_rep o) n))
(assert (= o1 (store self__ (to_rep2 self__1) o)))
(assert (= o1 o2))
(assert (= self__1 o3))
(assert (= self__2 o4))
(assert (= self__3 o5))
...
(assert (= o8 o4))
(assert (= o9 o5))
(assert (= (mk_mailboxT__ref (mk___rep (mk___split_fields result result1 result2 result3))) (mk_mailboxT__ref (mk___rep (mk___split_fields self__ self__1 self__2 self__3)))))
(assert (= (mk___rep (mk___split_fields self__4 self__5 self__6 self__7)) (mk___rep (mk___split_fields o6 o7 o8 o9))))
(assert (= (to_rep2 o10) (bvurem (bvadd (to_rep2 self__5) #x01) #x10)))
(assert (= self__4 o11))
(assert (= o10 o12))
(assert (= self__6 o13))
(assert (= self__7 o14))
...
(assert (not (in_range2 (+ (to_rep1 (rec__communications__mailboxT__count (us_split_fields1 self__8))) 1))))
(check-sat)
(exit)
