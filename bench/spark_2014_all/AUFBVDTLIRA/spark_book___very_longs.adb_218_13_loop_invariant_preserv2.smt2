...
(assert (= index1 1))
(assert (<= 1 index1))
(assert (<= index1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
(assert (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) index1) (<= index1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= o1 index1))
...
(assert (=> (= result3 true) (and (= o5 index1) (in_range3 index1))))
...
(assert (and (=> (< 0 digit_count3) (and (not (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) digit_count3)) #x00)) (and (<= 1 digit_count3) (<= digit_count3 index2)))) (=> (< digit_count3 index2) (forall ((j Int)) (=> (and (<= (+ digit_count3 1) j) (<= j index2)) (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j)) #x00))))))
(assert (and (and (=> (<= 1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))) (dynamic_property2 1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) index2)) (=> (<= 0 65536) (in_range3 digit_count3))) (and (<= 1 index2) (<= index2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
(assert (not (= index2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= index2 result5))
(assert (= index3 (+ index2 1)))
(assert (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) index3) (<= index3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= o6 index3))
(assert (= o7 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) o6)))
(assert (= o8 (to_rep2 o7)))
(assert (= o9 (ite (= o8 #x00) true false)))
(assert (= result6 (ite (not (= o9 true)) true false)))
(assert (=> (= result6 true) (and (= o10 index3) (in_range3 index3))))
(assert (=> (= result6 true) (= result7 digit_count3)))
(assert (=> (= result6 true) (= digit_count4 o10)))
(assert (=> (not (= result6 true)) (= digit_count4 digit_count3)))
(assert (< 0 digit_count4))
(assert (not (not (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) digit_count4)) #x00))))
(check-sat)
(exit)
