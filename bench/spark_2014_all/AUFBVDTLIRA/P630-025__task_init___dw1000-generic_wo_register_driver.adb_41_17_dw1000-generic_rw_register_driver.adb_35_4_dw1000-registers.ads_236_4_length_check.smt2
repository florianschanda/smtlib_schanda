...
(assert (= (ite (<= (to_rep (first2 temp___85291)) (to_rep (last2 temp___85291))) (+ (- (to_rep (last2 temp___85291)) (to_rep (first2 temp___85291))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))
(assert (= temp___8529 temp___8530))
(assert (= (mk2 (to_rep (first2 temp___85291)) (to_rep (last2 temp___85291))) temp___85301))
(assert (not (= (ite (<= (to_rep (first4 temp___85301)) (to_rep (last4 temp___85301))) (+ (- (to_rep (last4 temp___85301)) (to_rep (first4 temp___85301))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
