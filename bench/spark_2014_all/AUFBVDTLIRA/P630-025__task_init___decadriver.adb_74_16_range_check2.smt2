...
(assert (= o2 temp___5093))
(assert (= (mk2 1 r9b) temp___50931))
(assert (= (ite (<= (to_rep1 (first4 temp___50931)) (to_rep1 (last4 temp___50931))) (+ (- (to_rep1 (last4 temp___50931)) (to_rep1 (first4 temp___50931))) 1) 0) (ite (<= (to_rep1 frame__first) r6b) (+ (- r6b (to_rep1 frame__first)) 1) 0)))
(assert (= (slide temp___5093 (to_rep1 (first4 temp___50931)) (to_rep1 frame__first)) temp___5094))
(assert (= (mk1 (to_rep1 frame__first) r6b) temp___50941))
