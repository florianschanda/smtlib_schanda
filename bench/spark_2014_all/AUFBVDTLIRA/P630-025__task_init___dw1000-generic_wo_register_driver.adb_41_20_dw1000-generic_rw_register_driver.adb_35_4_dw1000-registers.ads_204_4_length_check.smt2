...
(define-fun target__ref___3__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun dynamic_invariant ((temp___expr_2338 us_t1) (temp___is_init_2334 Bool) (temp___skip_constant_2335 Bool) (temp___do_toplevel_2336 Bool) (temp___do_typ_inv_2337 Bool)) Bool (=> (not (= temp___skip_constant_2335 true)) (and (dynamic_property2 1 4 (first3 temp___expr_2338) (last3 temp___expr_2338)) (and (= (first3 temp___expr_2338) 1) (= (last3 temp___expr_2338) 4)))))
...
(define-fun register_byte_array__ref___7__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_2296 us_t2) (temp___is_init_2292 Bool) (temp___skip_constant_2293 Bool) (temp___do_toplevel_2294 Bool) (temp___do_typ_inv_2295 Bool)) Bool (=> (not (= temp___skip_constant_2293 true)) (and (dynamic_property3 1 4 (first5 temp___expr_2296) (last5 temp___expr_2296)) (and (= (first5 temp___expr_2296) 1) (= (last5 temp___expr_2296) 4)))))
...
(declare-const temp___84791 t1)
(define-fun temp___84792 () us_t1 (mk___t1 temp___8479 temp___84791))
...
(assert (and (= temp___84792 (register_to_bytes reg)) (dynamic_invariant temp___84792 true false true true)))
(assert (not (= (ite (<= (to_rep (first2 temp___84791)) (to_rep (last2 temp___84791))) (+ (- (to_rep (last2 temp___84791)) (to_rep (first2 temp___84791))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
