...
(declare-const pointers (Array Int us_rep1))
(declare-const c66b (_ BitVec 8))
(declare-const o (_ BitVec 8))
(declare-const o1 (_ BitVec 8))
(declare-const o2 (_ BitVec 8))
(declare-const o3 ring_range)
(declare-const o4 ring_range)
(declare-const o5 ring_range)
(declare-const o6 Bool)
(declare-const o7 ring_range)
(declare-const o8 Bool)
(declare-const o9 ring_range)
(declare-const o10 ring_range)
(declare-const o11 Bool)
(declare-const o12 ring_range)
(declare-const o13 Bool)
(declare-const o14 (Array Int us_rep1))
(declare-const result (_ BitVec 8))
(declare-const c66b1 (_ BitVec 8))
(declare-const result1 (Array Int us_rep1))
(declare-const pointers1 (Array Int us_rep1))
(assert (in_range4 ep))
(assert (in_range1 length))
(assert (and (and (<= length 65536) (= (bvudiv buf_addr #x0000000000010000) (bvudiv (bvsub (bvadd buf_addr ((_ int2bv 64) length)) #x0000000000000001) #x0000000000010000))) (bvule (bvsub (bvadd buf_addr ((_ int2bv 64) length)) #x0000000000000001) #xFFFFFFFFFFFFFFFF)))
(assert (= (to_rep2 (rec__hw__dbc__transfer_rings__transfer_pointers__enqueue (us_split_fields3 (select pointers ep)))) c65b))
(assert (in_range2 c65b))
(assert (=> (bvule #x00 #x3F) (in_range2 c66b)))
(assert (=> (= c65b #x00) (= o #x02)))
(assert (=> (not (= c65b #x00)) (= o #x01)))
(assert (= o1 (bvsub c65b o)))
(assert (= o2 (bvurem o1 #x40)))
(assert (= result c66b))
(assert (= c66b1 o2))
(assert (= (to_rep2 o3) c66b1))
(assert (= o3 o4))
(assert (= (rec__hw__dbc__transfer_rings__transfer_pointers__dequeue (us_split_fields3 (select pointers ep))) o5))
(assert (= (rec__hw__dbc__transfer_rings__transfer_pointers__full (us_split_fields3 (select pointers ep))) o6))
(assert (= (rec__hw__dbc__transfer_rings__transfer_pointers__toggle (us_split_fields3 (select pointers ep))) o7))
(assert (= (rec__hw__dbc__transfer_rings__transfer_pointers__overrun (us_split_fields3 (select pointers ep))) o8))
(assert (= o9 o4))
(assert (= o10 o5))
(assert (= o11 o6))
(assert (= o12 o7))
(assert (= o13 o8))
(assert (= o14 (store pointers ep (mk___rep1 (mk___split_fields1 o9 o10 o11 o12 o13)))))
(assert (= result1 pointers))
(assert (= pointers1 o14))
(assert (not (<= length 65536)))
(check-sat)
(exit)
