...
(declare-fun temp_____aggregate_def_1464 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1466 (_ BitVec 8))) (forall ((temp___1467 Int) (temp___1468 Int)) (let ((temp___1465 (temp_____aggregate_def_1464 temp___1466 temp___1467 temp___1468))) (=> (dynamic_invariant temp___1466 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1467 temp___1468) (and (= (first5 temp___1465) temp___1467) (= (last5 temp___1465) temp___1468))) (forall ((temp___1469 Int)) (= (to_rep1 (select (to_array2 temp___1465) temp___1469)) temp___1466))))))))
...
(assert (= (to_rep (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) r8b))
(assert (in_range2 r8b))
(assert (= (to_rep2 (first4 (rt2 (temp_____aggregate_def_1464 #x00 1 r8b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp_____aggregate_def_1464 #x00 1 r8b)))) r8b))
(assert (= (mk___t2 temp___1471 temp___14711) (temp_____aggregate_def_1464 #x00 1 r8b)))
...
(assert (and (and (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1486 Int)) (=> (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) temp___1486) (<= temp___1486 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))) (=> (or (< (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))) temp___1486) (or (< temp___1486 1) (<= i2 temp___1486))) (= (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) temp___1486) (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields2)) temp___1486)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (not (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))))
(check-sat)
(exit)
