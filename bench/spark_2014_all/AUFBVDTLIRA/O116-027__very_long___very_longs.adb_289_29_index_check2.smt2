...
(declare-fun temp_____aggregate_def_996 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___998 (_ BitVec 8))) (forall ((temp___999 Int) (temp___1000 Int)) (let ((temp___997 (temp_____aggregate_def_996 temp___998 temp___999 temp___1000))) (=> (dynamic_invariant temp___998 true true true true) (and (=> (dynamic_property6 1 65536 temp___999 temp___1000) (and (= (first5 temp___997) temp___999) (= (last5 temp___997) temp___1000))) (forall ((temp___1001 Int)) (= (to_rep2 (select (to_array2 temp___997) temp___1001)) temp___998))))))))
...
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_996 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_996 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___1003 temp___10031) (temp_____aggregate_def_996 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep1 (first4 temp___10031)) (to_rep1 (last4 temp___10031))) (+ (- (to_rep1 (last4 temp___10031)) (to_rep1 (first4 temp___10031))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___1003 temp___1004))
(assert (= (mk1 (to_rep1 (first4 temp___10031)) (to_rep1 (last4 temp___10031))) temp___10041))
(assert (= (ite (<= (to_rep1 (first2 temp___10041)) (to_rep1 (last2 temp___10041))) (+ (- (to_rep1 (last2 temp___10041)) (to_rep1 (first2 temp___10041))) 1) 0) (ite (<= (to_rep1 (first2 result____split_fields1)) (to_rep1 (last2 result____split_fields1))) (+ (- (to_rep1 (last2 result____split_fields1)) (to_rep1 (first2 result____split_fields1))) 1) 0)))
...
(assert (and (and (dynamic_invariant3 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (forall ((temp___1017 Int)) (=> (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___1017) (<= temp___1017 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (or (< (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) temp___1017) (or (< temp___1017 1) (<= i2 temp___1017))) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___1017) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___1017)))))) (and (<= 1 i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (not (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) i2)))
(check-sat)
(exit)
