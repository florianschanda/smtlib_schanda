...
(assert (= i1 r83b))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= temp___1762 i1)))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= temp___1761 tmpval1)))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= temp___1760 digitval)))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (and (<= 1 begidx11) (bvule tmpval2 #x7FFF))))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (and (=> (<= r83b r84b) (dynamic_property r83b r84b i2)) (and (<= r83b i2) (<= i2 r84b)))))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= result9 (mk_t__ref digitval2))))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= digitval3 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i2))) #x0030))))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= result10 (mk_t__ref tmpval2))))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= tmpval3 (bvadd (bvmul #x000A tmpval2) digitval3))))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (or (bvugt tmpval3 #x7FFF) (and (not (bvugt tmpval3 #x7FFF)) (= i2 r84b)))))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= tmpval4 (mk_t__ref tmpval3))))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= digitval4 (mk_t__ref digitval3))))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= i4 i2)))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= tmpval5 tmpval3)))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= digitval5 digitval3)))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= i5 i3)))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= tmpval6 tmpval4)))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= digitval6 digitval4)))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= i6 i4)))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= tmpval7 tmpval5)))
(assert (=> (and (<= r83b i1) (<= i1 r84b)) (= digitval7 digitval5)))
(assert (=> (not (and (<= r83b i1) (<= i1 r84b))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= r83b i1) (<= i1 r84b))) (= tmpval6 (mk_t__ref tmpval1))))
(assert (=> (not (and (<= r83b i1) (<= i1 r84b))) (= digitval6 (mk_t__ref digitval))))
(assert (=> (not (and (<= r83b i1) (<= i1 r84b))) (= i6 i1)))
(assert (=> (not (and (<= r83b i1) (<= i1 r84b))) (= tmpval7 tmpval1)))
(assert (=> (not (and (<= r83b i1) (<= i1 r84b))) (= digitval7 digitval1)))
