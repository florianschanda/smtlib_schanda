...
(assert (and (forall ((i4 (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i4) (bvule i4 (bvsub rcx_start rcx))) (=> (not (= i4 (bvsub rcx_start rcx))) (= (hasmem64 mem (bvadd rdi_start (bvmul i4 #x0000000000000008)) rax) true)))) (and (= rdi (bvadd rdi_start (bvmul (bvsub rcx_start rcx) #x0000000000000008))) (and (bvule rcx rcx_start) (and (bvult rcx_start #x1FFFFFFFFFFFFFFF) (and (= (nooverlap8equal memory mem rdi) true) (forall ((i4 (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i4) (bvule i4 (bvsub rcx_start rcx))) (=> (not (= i4 (bvsub rcx_start rcx))) (= (nooverlap8 (bvadd rdi_start (bvmul i4 #x0000000000000008)) rdi) true))))))))))
(assert (= (bvsub rcx_start rcx) r75b))
(assert (= (mk_t__ref1 result) (mk_t__ref1 i)))
(assert (= i1 #x0000000000000000))
(assert (bvule #x0000000000000000 i1))
(assert (bvule i1 r75b))
(assert (=> (not (= i1 (bvsub rcx_start rcx))) (forall ((j (_ BitVec 64))) (=> (and (bvule #x0000000000000000 j) (bvule j #x0000000000000007)) (= (to_rep (select memory (bvadd (bvadd rdi_start (bvmul i1 #x0000000000000008)) j))) (to_rep (select mem (bvadd (bvadd rdi_start (bvmul i1 #x0000000000000008)) j))))))))
(assert (=> (not (= i1 (bvsub rcx_start rcx))) (= (hasmem64 memory (bvadd rdi_start (bvmul i1 #x0000000000000008)) rax) true)))
(assert (forall ((j (_ BitVec 64))) (=> (and (bvule #x0000000000000000 j) (bvule j i2)) (=> (not (= j (bvsub rcx_start rcx))) (= (hasmem64 memory (bvadd rdi_start (bvmul j #x0000000000000008)) rax) true)))))
(assert (and (=> (bvule #x0000000000000000 r75b) (dynamic_property #x0000000000000000 r75b i2)) (and (bvule #x0000000000000000 i2) (bvule i2 r75b))))
(assert (not (= i2 r75b)))
(assert (= i2 result1))
(assert (= i3 (bvadd i2 #x0000000000000001)))
(assert (=> (not (= i3 (bvsub rcx_start rcx))) (forall ((j (_ BitVec 64))) (=> (and (bvule #x0000000000000000 j) (bvule j #x0000000000000007)) (= (to_rep (select memory (bvadd (bvadd rdi_start (bvmul i3 #x0000000000000008)) j))) (to_rep (select mem (bvadd (bvadd rdi_start (bvmul i3 #x0000000000000008)) j))))))))
(assert (=> (not (= i3 (bvsub rcx_start rcx))) (= (hasmem64 memory (bvadd rdi_start (bvmul i3 #x0000000000000008)) rax) true)))
(declare-const j (_ BitVec 64))
(assert (bvule #x0000000000000000 j))
(assert (bvule j i3))
(assert (not (= j (bvsub rcx_start rcx))))
(assert (not (= (hasmem64 memory (bvadd rdi_start (bvmul j #x0000000000000008)) rax) true)))
(check-sat)
(exit)
