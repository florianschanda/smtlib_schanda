...
(assert (= memory4 o7))
(assert (= (bvadd ((_ zero_extend 24) (to_rep (select memory4 addr))) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000001)))) #x00000100)) (bvurem val__ #x00010000)))
(assert (= (bvadd ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000002)))) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000003)))) #x00000100)) (bvurem (bvudiv val__ #x00010000) #x00010000)))
(assert (= (bvadd (bvurem val__ #x00010000) (bvmul (bvurem (bvudiv val__ #x00010000) #x00010000) #x00010000)) val__))
(assert (=> (and (= (bvadd ((_ zero_extend 24) (to_rep (select memory4 addr))) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000001)))) #x00000100)) (bvurem val__ #x00010000)) (= (bvadd ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000002)))) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000003)))) #x00000100)) (bvurem (bvudiv val__ #x00010000) #x00010000))) (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select memory4 addr))) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000001)))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000002)))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000003)))) #x01000000)) val__)))
(assert (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select memory4 addr))) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000001)))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000002)))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000003)))) #x01000000)) val__))
...
(assert (not (= (to_rep (select memory5 i)) (to_rep (select memory i)))))
(check-sat)
(exit)
