...
(assert (and (and (forall ((temp___1590 Int)) (=> (and (<= 1 temp___1590) (<= temp___1590 256)) (=> (or (< r67b temp___1590) (or (< temp___1590 r66b) (<= i2 temp___1590))) (= (select tmpline2 temp___1590) (select tmpline1 temp___1590))))) (=> (<= r66b r67b) (dynamic_property r66b r67b i2))) (and (<= r66b i2) (<= i2 r67b))))
