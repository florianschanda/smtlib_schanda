...
(assert (and (and (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (forall ((temp___655 Int)) (=> (and (<= (to_rep a__first) temp___655) (<= temp___655 (to_rep a__last))) (=> (or (< a_last temp___655) (or (< temp___655 a_first) (<= i2 temp___655))) (= (select a1 temp___655) (select a temp___655)))))) (=> (<= 0 2147483647) (in_range2 j1))) (and (<= a_first i2) (<= i2 a_last))))
...
(assert (and (= o47 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o48 (ite (<= o47 k) true false)))
(assert (= result7 (ite (= o48 true) (ite (<= k a_last) true false) false)))
(assert (= (= o49 true) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 a_last)) (= (to_rep1 (select a2 k1)) (to_rep1 (select a k1)))))))
(assert (= o44 (num_of_boolean carry3)))
(assert (and (= o39 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o40 (- o39 a_first)))
...
(assert (= o43 (oexpon o38 o42)))
(assert (= o45 (omultiply o43 o44)))
(assert (and (= o33 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o34 (- o33 a_first)))
(assert (and (= o35 o34) (in_range1 o34)))
(assert (and (= o36 o35) (in_range2 o35)))
(assert (= o37 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o36)))
(assert (= o46 (osubtract o37 o45)))
(assert (and (= o30 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o31 (- o30 a_first)))
(assert (and (= o32 o31) (in_range1 o31)))
(assert (not (in_range2 o32)))
(check-sat)
(exit)
