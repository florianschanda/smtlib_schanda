...
(define-fun o32 () us_rep4 (mk___rep2 (mk___split_fields2 o3 o4 o5)))
...
(assert (=> (in_range12 n3) (and (= o32 (get1 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) (= (bool_eq4 o32 (get1 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) true))))
...
(assert (and (= o28 (int__content ptr10)) (in_range15 (int__content ptr10))))
(assert (and (= temp___675 (get1 (model__1 (mk___rep1 entry_table__split_discrs entry_table__split_fields1)) o28)) (= (bool_eq4 temp___675 (get1 (model__1 (mk___rep1 entry_table__split_discrs entry_table__split_fields1)) o28)) true)))
(assert (= (to_rep5 o29) n12))
(assert (= o30 (mk___split_fields2 (rec__names__name_entry__table_index (us_split_fields5 temp___675)) (rec__names__name_entry__length (us_split_fields5 temp___675)) o29)))
