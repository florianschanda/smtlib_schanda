...
(assert (forall ((x unsigned8)) (! (uint_in_range3 (to_int5 x)) :pattern ((to_int5 x)))))
...
(assert (forall ((addr (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (=> (dynamic_invariant addr true true true true) (let ((result (readmem16 addr x86__memory))) (and (= result (bvor ((_ zero_extend 8) (to_rep (select x86__memory addr))) (ite (< 8 16) (bvshl ((_ zero_extend 8) (to_rep (select x86__memory (bvadd addr #x0000000000000001)))) ((_ int2bv 16) 8)) #x0000))) (dynamic_invariant1 result true false true true)))) :pattern ((readmem16 addr x86__memory))))))
(assert (forall ((addr (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (=> (dynamic_invariant addr true true true true) (let ((result (readmem32 addr x86__memory))) (and (= result (bvor ((_ zero_extend 16) (readmem16 addr x86__memory)) (bvshl ((_ zero_extend 16) (readmem16 (bvadd addr #x0000000000000002) x86__memory)) ((_ int2bv 32) 16)))) (dynamic_invariant2 result true false true true)))) :pattern ((readmem32 addr x86__memory))))))
...
(assert (and (and (bvugt rsp #xFFFFFFFF00000000) (bvult rsp #xFFFFFFFFFFFFFF00)) (or (and (bvugt rsi (bvadd rsp #x0000000000000008)) (bvult rsp #xFFFFFFFFFFFFFF00)) (and (bvult rsi #xFFFF000000000000) (bvugt rsi #x0000000000000100)))))
(assert (and (= (readmem64 (bvsub rsp #x0000000000000008) memory1) rbp) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (and (and (and (and (and (and (and (not (= i (bvsub rsp #x0000000000000008))) (not (= i (bvadd (bvsub rsp #x0000000000000008) #x0000000000000001)))) (not (= i (bvadd (bvsub rsp #x0000000000000008) #x0000000000000002)))) (not (= i (bvadd (bvsub rsp #x0000000000000008) #x0000000000000003)))) (not (= i (bvadd (bvsub rsp #x0000000000000008) #x0000000000000004)))) (not (= i (bvadd (bvsub rsp #x0000000000000008) #x0000000000000005)))) (not (= i (bvadd (bvsub rsp #x0000000000000008) #x0000000000000006)))) (not (= i (bvadd (bvsub rsp #x0000000000000008) #x0000000000000007)))) (= (to_rep (select memory1 i)) (to_rep (select memory i))))))))
(assert (= result rsp))
(assert (= rsp1 (bvsub rsp #x0000000000000008)))
(assert (= result1 rbp))
(assert (= rbp1 rsp1))
(assert (and (= (readmem64 (bvsub rbp1 #x0000000000000010) memory2) rsi) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (and (and (and (and (and (and (and (not (= i (bvsub rbp1 #x0000000000000010))) (not (= i (bvadd (bvsub rbp1 #x0000000000000010) #x0000000000000001)))) (not (= i (bvadd (bvsub rbp1 #x0000000000000010) #x0000000000000002)))) (not (= i (bvadd (bvsub rbp1 #x0000000000000010) #x0000000000000003)))) (not (= i (bvadd (bvsub rbp1 #x0000000000000010) #x0000000000000004)))) (not (= i (bvadd (bvsub rbp1 #x0000000000000010) #x0000000000000005)))) (not (= i (bvadd (bvsub rbp1 #x0000000000000010) #x0000000000000006)))) (not (= i (bvadd (bvsub rbp1 #x0000000000000010) #x0000000000000007)))) (= (to_rep (select memory2 i)) (to_rep (select memory1 i))))))))
(assert (= (readmem64 (bvsub rbp1 #x0000000000000010) memory2) rsi))
(assert (and (= (readmem32 (bvsub rbp1 #x0000000000000034) memory3) #x00000000) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (and (and (and (not (= i (bvsub rbp1 #x0000000000000034))) (not (= i (bvadd (bvsub rbp1 #x0000000000000034) #x0000000000000001)))) (not (= i (bvadd (bvsub rbp1 #x0000000000000034) #x0000000000000002)))) (not (= i (bvadd (bvsub rbp1 #x0000000000000034) #x0000000000000003)))) (= (to_rep (select memory3 i)) (to_rep (select memory2 i))))))))
(assert (not (= (readmem64 (bvsub rbp1 #x0000000000000010) memory3) rsi)))
(check-sat)
(exit)
