...
(define-fun tregister_byte_arrayP1__ref___94__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___40__projection ((a target__ref)) us_t1 (target__content a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__rf_txctrl_type__rf_txctrl bits_32)))))
(define-fun us_split_fields_RF_TXCTRL__projection ((a us_split_fields)) bits_32 (rec__dw1000__register_types__rf_txctrl_type__rf_txctrl a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___56__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___56__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__rf_txctrl_type__rf_txctrl (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rf_txctrl_type__rf_txctrl (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__rf_txctrl_type__rf_txctrl__first__bit Int)
(declare-const dw1000__register_types__rf_txctrl_type__rf_txctrl__last__bit Int)
(declare-const dw1000__register_types__rf_txctrl_type__rf_txctrl__position Int)
(assert (<= 0 dw1000__register_types__rf_txctrl_type__rf_txctrl__first__bit))
(assert (< dw1000__register_types__rf_txctrl_type__rf_txctrl__first__bit dw1000__register_types__rf_txctrl_type__rf_txctrl__last__bit))
(assert (<= 0 dw1000__register_types__rf_txctrl_type__rf_txctrl__position))
(declare-fun user_eq7 (us_rep us_rep) Bool)
(declare-const dummy7 us_rep)
(declare-datatypes () ((rf_txctrl_type__ref (mk_rf_txctrl_type__ref (rf_txctrl_type__content us_rep)))))
(define-fun rf_txctrl_type__ref___projection ((a rf_txctrl_type__ref)) us_rep (rf_txctrl_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___40__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_5857 us_t1) (temp___is_init_5853 Bool) (temp___skip_constant_5854 Bool) (temp___do_toplevel_5855 Bool) (temp___do_typ_inv_5856 Bool)) Bool (=> (not (= temp___skip_constant_5854 true)) (and (dynamic_property2 1 4 (first3 temp___expr_5857) (last3 temp___expr_5857)) (and (= (first3 temp___expr_5857) 1) (= (last3 temp___expr_5857) 4)))))
...
(define-fun register_type__ref___133__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___94__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_5839 us_t2) (temp___is_init_5835 Bool) (temp___skip_constant_5836 Bool) (temp___do_toplevel_5837 Bool) (temp___do_typ_inv_5838 Bool)) Bool (=> (not (= temp___skip_constant_5836 true)) (and (dynamic_property3 1 4 (first5 temp___expr_5839) (last5 temp___expr_5839)) (and (= (first5 temp___expr_5839) 1) (= (last5 temp___expr_5839) 4)))))
...
(declare-const temp___8772 (Array Int bits_8))
(declare-const temp___87721 t1)
(define-fun temp___87722 () us_t1 (mk___t1 temp___8772 temp___87721))
...
(assert (and (= temp___87722 (register_to_bytes reg)) (dynamic_invariant temp___87722 true false true true)))
(assert (not (= (ite (<= (to_rep (first2 temp___87721)) (to_rep (last2 temp___87721))) (+ (- (to_rep (last2 temp___87721)) (to_rep (first2 temp___87721))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
