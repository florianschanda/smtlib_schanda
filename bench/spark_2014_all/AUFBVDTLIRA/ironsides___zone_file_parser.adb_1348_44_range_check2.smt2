...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i21 Int)) (=> (and (<= begidx2 i21) (<= i21 endidx1)) (and (<= 48 (to_rep (select zonefileline i21))) (<= (to_rep (select zonefileline i21)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 foundtype1))))
...
(assert (=> (and (not (= foundtype1 3)) (< endidx1 zlength)) (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i21 Int)) (=> (and (<= begidx5 i21) (<= i21 endidx3)) (and (<= 48 (to_rep (select zonefileline i21))) (<= (to_rep (select zonefileline i21)) 57)))))) (and (and (in_range4 begidx5) (in_range4 endidx3)) (in_range3 foundtype3)))))
...
(assert (= begidx10 o1))
(assert (and (and (and (and (<= begidx11 endidx8) (<= begidx11 zlength)) (<= endidx8 zlength)) (=> (= foundtype8 1) (forall ((i21 Int)) (=> (and (<= begidx11 i21) (<= i21 endidx8)) (and (<= 48 (to_rep (select zonefileline i21))) (<= (to_rep (select zonefileline i21)) 57)))))) (and (and (in_range4 begidx11) (in_range4 endidx8)) (in_range3 foundtype8))))
(assert (= foundtype8 1))
...
(assert (= i3 r83b))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= temp___1762 i3)))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= temp___1761 tmpval1)))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= temp___1760 digitval)))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (and (<= 1 begidx11) (bvule tmpval2 #x7FFF))))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (and (=> (<= r83b r84b) (dynamic_property r83b r84b i4)) (and (<= r83b i4) (<= i4 r84b)))))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= result9 (mk_t__ref digitval2))))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= digitval3 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i4))) #x0030))))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= result10 (mk_t__ref tmpval2))))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= tmpval3 (bvadd (bvmul #x000A tmpval2) digitval3))))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (or (bvugt tmpval3 #x7FFF) (and (not (bvugt tmpval3 #x7FFF)) (= i4 r84b)))))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= i5 (mk_int__ref i4))))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= tmpval4 (mk_t__ref tmpval3))))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= digitval4 (mk_t__ref digitval3))))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= i6 i4)))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= tmpval5 tmpval3)))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= digitval5 digitval3)))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= i7 i5)))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= tmpval6 tmpval4)))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= digitval6 digitval4)))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= i8 i6)))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= tmpval7 tmpval5)))
(assert (=> (and (<= r83b i3) (<= i3 r84b)) (= digitval7 digitval5)))
(assert (=> (not (and (<= r83b i3) (<= i3 r84b))) (= i7 (mk_int__ref i3))))
(assert (=> (not (and (<= r83b i3) (<= i3 r84b))) (= tmpval6 (mk_t__ref tmpval1))))
(assert (=> (not (and (<= r83b i3) (<= i3 r84b))) (= digitval6 (mk_t__ref digitval))))
(assert (=> (not (and (<= r83b i3) (<= i3 r84b))) (= i8 i3)))
(assert (=> (not (and (<= r83b i3) (<= i3 r84b))) (= tmpval7 tmpval1)))
(assert (=> (not (and (<= r83b i3) (<= i3 r84b))) (= digitval7 digitval1)))
...
(assert (= begidx12 o2))
(assert (and (and (and (and (<= begidx13 endidx9) (<= begidx13 zlength)) (<= endidx9 zlength)) (=> (= foundtype9 1) (forall ((i21 Int)) (=> (and (<= begidx13 i21) (<= i21 endidx9)) (and (<= 48 (to_rep (select zonefileline i21))) (<= (to_rep (select zonefileline i21)) 57)))))) (and (and (in_range4 begidx13) (in_range4 endidx9)) (in_range3 foundtype9))))
(assert (= foundtype9 1))
...
(assert (= i9 r86b))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= temp___1767 i9)))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= temp___1766 tmpval8)))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= temp___1765 (t__content digitval6))))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (and (<= 1 begidx13) (bvule tmpval9 #x7FFF))))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (and (=> (<= r86b r87b) (dynamic_property1 r86b r87b i10)) (and (<= r86b i10) (<= i10 r87b)))))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= result15 (mk_t__ref digitval8))))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= digitval9 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i10))) #x0030))))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= result16 (mk_t__ref tmpval9))))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= tmpval10 (bvadd (bvmul #x000A tmpval9) digitval9))))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (or (bvugt tmpval10 #x7FFF) (and (not (bvugt tmpval10 #x7FFF)) (= i10 r87b)))))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= i11 (mk_int__ref i10))))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= tmpval11 (mk_t__ref tmpval10))))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= digitval10 (mk_t__ref digitval9))))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= i12 i10)))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= tmpval12 tmpval10)))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= digitval11 digitval9)))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= i13 i11)))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= tmpval13 tmpval11)))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= digitval12 digitval10)))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= i14 i12)))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= tmpval14 tmpval12)))
(assert (=> (and (<= r86b i9) (<= i9 r87b)) (= digitval13 digitval11)))
(assert (=> (not (and (<= r86b i9) (<= i9 r87b))) (= i13 (mk_int__ref i9))))
(assert (=> (not (and (<= r86b i9) (<= i9 r87b))) (= tmpval13 (mk_t__ref tmpval8))))
(assert (=> (not (and (<= r86b i9) (<= i9 r87b))) (= digitval12 digitval6)))
(assert (=> (not (and (<= r86b i9) (<= i9 r87b))) (= i14 i9)))
(assert (=> (not (and (<= r86b i9) (<= i9 r87b))) (= tmpval14 tmpval8)))
(assert (=> (not (and (<= r86b i9) (<= i9 r87b))) (= digitval13 digitval7)))
...
(assert (= begidx14 o3))
(assert (and (and (and (and (<= begidx15 endidx10) (<= begidx15 zlength)) (<= endidx10 zlength)) (=> (= foundtype10 1) (forall ((i21 Int)) (=> (and (<= begidx15 i21) (<= i21 endidx10)) (and (<= 48 (to_rep (select zonefileline i21))) (<= (to_rep (select zonefileline i21)) 57)))))) (and (and (in_range4 begidx15) (in_range4 endidx10)) (in_range3 foundtype10))))
...
(assert (= i15 r89b))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= temp___1772 i15)))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= temp___1771 tmpval15)))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= temp___1770 (t__content digitval12))))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (and (<= 1 begidx15) (bvule tmpval16 #x7FFF))))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (and (=> (<= r89b r90b) (dynamic_property2 r89b r90b i16)) (and (<= r89b i16) (<= i16 r90b)))))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= result21 (mk_t__ref digitval14))))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= digitval15 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i16))) #x0030))))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= result22 (mk_t__ref tmpval16))))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= tmpval17 (bvadd (bvmul #x000A tmpval16) digitval15))))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (or (bvugt tmpval17 #x7FFF) (and (not (bvugt tmpval17 #x7FFF)) (= i16 r90b)))))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= i17 (mk_int__ref i16))))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= tmpval18 (mk_t__ref tmpval17))))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= digitval16 (mk_t__ref digitval15))))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= i18 i16)))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= tmpval19 tmpval17)))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= digitval17 digitval15)))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= i19 i17)))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= tmpval20 tmpval18)))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= digitval18 digitval16)))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= i20 i18)))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= tmpval21 tmpval19)))
(assert (=> (and (<= r89b i15) (<= i15 r90b)) (= digitval19 digitval17)))
(assert (=> (not (and (<= r89b i15) (<= i15 r90b))) (= i19 (mk_int__ref i15))))
(assert (=> (not (and (<= r89b i15) (<= i15 r90b))) (= tmpval20 (mk_t__ref tmpval15))))
(assert (=> (not (and (<= r89b i15) (<= i15 r90b))) (= digitval18 digitval12)))
(assert (=> (not (and (<= r89b i15) (<= i15 r90b))) (= i20 i15)))
(assert (=> (not (and (<= r89b i15) (<= i15 r90b))) (= tmpval21 tmpval15)))
(assert (=> (not (and (<= r89b i15) (<= i15 r90b))) (= digitval19 digitval13)))
...
(assert (= begidx16 o4))
(assert (and (and (and (and (<= begidx17 endidx11) (<= begidx17 zlength)) (<= endidx11 zlength)) (=> (= foundtype11 1) (forall ((i21 Int)) (=> (and (<= begidx17 i21) (<= i21 endidx11)) (and (<= 48 (to_rep (select zonefileline i21))) (<= (to_rep (select zonefileline i21)) 57)))))) (and (and (in_range4 begidx17) (in_range4 endidx11)) (in_range3 foundtype11))))
