...
(define-fun target__ref___33__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__drx_tune1b_type__drx_tune1b (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__drx_tune1b_type__drx_tune1b (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_5371 us_t1) (temp___is_init_5367 Bool) (temp___skip_constant_5368 Bool) (temp___do_toplevel_5369 Bool) (temp___do_typ_inv_5370 Bool)) Bool (=> (not (= temp___skip_constant_5368 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5371) (last3 temp___expr_5371)) (and (= (first3 temp___expr_5371) 1) (= (last3 temp___expr_5371) 2)))))
...
(define-fun register_byte_array__ref___79__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_5353 us_t2) (temp___is_init_5349 Bool) (temp___skip_constant_5350 Bool) (temp___do_toplevel_5351 Bool) (temp___do_typ_inv_5352 Bool)) Bool (=> (not (= temp___skip_constant_5350 true)) (and (dynamic_property3 1 2 (first5 temp___expr_5353) (last5 temp___expr_5353)) (and (= (first5 temp___expr_5353) 1) (= (last5 temp___expr_5353) 2)))))
...
(declare-const temp___87211 t1)
(declare-const temp___8722 (Array Int bits_8))
(declare-const temp___87221 t2)
(define-fun temp___87212 () us_t1 (mk___t1 temp___8721 temp___87211))
...
(assert (and (= temp___87212 (register_to_bytes reg)) (dynamic_invariant temp___87212 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___87211)) (to_rep (last2 temp___87211))) (+ (- (to_rep (last2 temp___87211)) (to_rep (first2 temp___87211))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8721 temp___8722))
(assert (= (mk2 (to_rep (first2 temp___87211)) (to_rep (last2 temp___87211))) temp___87221))
(assert (not (= (ite (<= (to_rep (first4 temp___87221)) (to_rep (last4 temp___87221))) (+ (- (to_rep (last4 temp___87221)) (to_rep (first4 temp___87221))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
