...
(declare-fun user_eq12 (initialized_hash_bit_length initialized_hash_bit_length) Bool)
(declare-const dummy12 initialized_hash_bit_length)
...
(declare-fun user_eq13 (skein_512_block_bytes_count skein_512_block_bytes_count) Bool)
(declare-const dummy13 skein_512_block_bytes_count)
...
(declare-fun user_eq14 (unsigned_64 unsigned_64) Bool)
(declare-const dummy14 unsigned_64)
...
(assert (forall ((x unsigned_64)) (! (uint_in_range (to_int12 x)) :pattern ((to_int12 x)))))
(declare-sort t 0)
...
(declare-fun user_eq16 (skein_512_block_bytes_index skein_512_block_bytes_index) Bool)
...
(define-fun in_range7 ((x (_ BitVec 64))) Bool (and (bvule #x0000000000000000 x) (bvule x #x000000000000003F)))
...
(declare-fun user_eq17 (skein_512_state_bytes_index skein_512_state_bytes_index) Bool)
(declare-const dummy17 skein_512_state_bytes_index)
...
(define-fun dynamic_invariant3 ((temp___expr_657 (Array (_ BitVec 64) byte)) (temp___is_init_653 Bool) (temp___skip_constant_654 Bool) (temp___do_toplevel_655 Bool) (temp___do_typ_inv_656 Bool)) Bool (=> (= temp___do_toplevel_655 true) (=> (= temp___is_init_653 true) (bvult (last1 (of_array temp___expr_657 #x0000000000000000 #x000000000000003F)) #xFFFFFFFFFFFFFFFF))))
...
(define-fun dynamic_invariant7 ((temp___expr_588 (_ BitVec 64)) (temp___is_init_584 Bool) (temp___skip_constant_585 Bool) (temp___do_toplevel_586 Bool) (temp___do_typ_inv_587 Bool)) Bool (=> (or (= temp___is_init_584 true) (bvule #x0000000000000000 #xFFFFFFFFFFFFFFF8)) (in_range1 temp___expr_588)))
(define-fun dynamic_invariant8 ((temp___expr_595 (_ BitVec 64)) (temp___is_init_591 Bool) (temp___skip_constant_592 Bool) (temp___do_toplevel_593 Bool) (temp___do_typ_inv_594 Bool)) Bool (=> (or (= temp___is_init_591 true) (bvule #x0000000000000001 #xFFFFFFFFFFFFFFF8)) (in_range4 temp___expr_595)))
(define-fun dynamic_invariant9 ((temp___expr_619 (_ BitVec 64)) (temp___is_init_615 Bool) (temp___skip_constant_616 Bool) (temp___do_toplevel_617 Bool) (temp___do_typ_inv_618 Bool)) Bool (=> (or (= temp___is_init_615 true) (bvule #x0000000000000000 #x0000000000000040)) (in_range5 temp___expr_619)))
(define-fun dynamic_invariant10 ((temp___expr_626 (_ BitVec 64)) (temp___is_init_622 Bool) (temp___skip_constant_623 Bool) (temp___do_toplevel_624 Bool) (temp___do_typ_inv_625 Bool)) Bool (=> (or (= temp___is_init_622 true) (bvule #x0000000000000000 #x000000000000003F)) (in_range6 temp___expr_626)))
...
(define-fun dynamic_invariant12 ((temp___expr_650 (_ BitVec 64)) (temp___is_init_646 Bool) (temp___skip_constant_647 Bool) (temp___do_toplevel_648 Bool) (temp___do_typ_inv_649 Bool)) Bool (=> (or (= temp___is_init_646 true) (bvule #x0000000000000000 #x000000000000003F)) (in_range7 temp___expr_650)))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant1 ctx true true true true) (dynamic_invariant7 (hash_bit_len_of ctx) true false true true)) :pattern ((hash_bit_len_of ctx)))))
...
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant1 ctx true true true true) (dynamic_invariant (byte_count_of ctx) true false true true)) :pattern ((byte_count_of ctx)))))
...
(define-fun dynamic_invariant13 ((temp___expr_695 (_ BitVec 8)) (temp___is_init_691 Bool) (temp___skip_constant_692 Bool) (temp___do_toplevel_693 Bool) (temp___do_typ_inv_694 Bool)) Bool (=> (or (= temp___is_init_691 true) (bvule #x00 #x3F)) (in_range3 temp___expr_695)))
(define-fun dynamic_invariant14 ((temp___expr_688 (_ BitVec 8)) (temp___is_init_684 Bool) (temp___skip_constant_685 Bool) (temp___do_toplevel_686 Bool) (temp___do_typ_inv_687 Bool)) Bool (=> (or (= temp___is_init_684 true) (bvule #x00 #x7F)) (in_range2 temp___expr_688)))
...
(assert (and (and (= (to_rep7 (first (rt data))) #x0000000000000000) (= (add_in_range (to_rep7 (last (rt data))) #x0000000000000040) true)) (bvult (bvadd (to_rep7 (last (rt data))) #x0000000000000040) #xFFFFFFFFFFFFFFFF)))
(assert (and (and (and (and (in_range4 (hash_bit_len_of (mk___rep2 ctx__split_fields25))) (= (hash_bit_len_of (mk___rep2 ctx__split_fields25)) #x0000000000000200)) (= (byte_count_of (mk___rep2 ctx__split_fields25)) #x0000000000000000)) (in_range5 (byte_count_of (mk___rep2 ctx__split_fields25)))) (bvult (to_rep7 (last (mk #x0000000000000000 #x000000000000003F))) #xFFFFFFFFFFFFFFFF)))
(assert (and (and (and (in_range4 (hash_bit_len_of (mk___rep2 ctx__split_fields24))) (= (hash_bit_len_of (mk___rep2 ctx__split_fields24)) (hash_bit_len_of (mk___rep2 ctx__split_fields25)))) (in_range5 (byte_count_of (mk___rep2 ctx__split_fields24)))) (bvult (to_rep7 (last (mk #x0000000000000000 #x000000000000003F))) #xFFFFFFFFFFFFFFFF)))
(assert (= (to_rep7 o1) #x000000000000003F))
(assert (= (to_rep7 o) #x0000000000000000))
(assert (bvult (to_rep7 o1) #xFFFFFFFFFFFFFFFF))
(assert (= result result__))
(assert (= result__1 (slide1 skein__skein_512_final__hash (to_rep7 (first (mk #x0000000000000000 #x000000000000003F))) #x0000000000000000)))
