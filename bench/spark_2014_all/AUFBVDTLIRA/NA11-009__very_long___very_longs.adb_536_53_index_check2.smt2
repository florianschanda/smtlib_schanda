...
(declare-const temp___1381 us_rep1)
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1385 sum)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1384 carry1)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1381 (mk___rep1 u__split_discrs (mk___split_fields1 (mk___t1 u__split_fields u__split_fields1))))))
...
(assert (not (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields7))))) temp___1387)))
(check-sat)
(exit)
