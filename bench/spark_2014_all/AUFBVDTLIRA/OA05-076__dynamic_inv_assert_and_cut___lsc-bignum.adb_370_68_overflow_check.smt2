...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select o74 k)) #x00000000))))
...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (and (= (oeq (omod (oadd (num_of_big_int (mk___t o75 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o75 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true)))
...
(assert (= a_msw3 o37))
(assert (= o71 (from_word32 #x00000001)))
...
(assert (= o64 (from_word32 #x00000002)))
(assert (= o70 (omultiply o64 o69)))
(assert (= o72 (osubtract o70 o71)))
(assert (= o61 (from_word32 a_msw3)))
(assert (and (= o56 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o57 (+ o56 1)))
(assert (and (= o58 o57) (in_range1 o57)))
(assert (and (= o59 o58) (in_range2 o58)))
(assert (and (= o55 (base Tuple0)) (= o55 (oexpon (from_word32 #x00000002) 32))))
(assert (= o60 (oexpon o55 o59)))
(assert (= o62 (omultiply o60 o61)))
(assert (and (= o50 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o51 (+ o50 1)))
(assert (and (= o52 o51) (in_range1 o51)))
(assert (and (= o53 o52) (in_range2 o52)))
(assert (= o54 (num_of_big_int (mk___t o78 (mk (to_rep a__first) (to_rep a__last))) a_first o53)))
(assert (= o63 (oadd o54 o62)))
(assert (= o73 (olt o63 o72)))
