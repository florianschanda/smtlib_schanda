...
(declare-fun temp_____aggregate_def_1031 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1033 (_ BitVec 8))) (forall ((temp___1034 Int) (temp___1035 Int)) (let ((temp___1032 (temp_____aggregate_def_1031 temp___1033 temp___1034 temp___1035))) (=> (dynamic_invariant temp___1033 true true true true) (and (=> (dynamic_property6 1 65536 temp___1034 temp___1035) (and (= (first5 temp___1032) temp___1034) (= (last5 temp___1032) temp___1035))) (forall ((temp___1036 Int)) (= (to_rep2 (select (to_array2 temp___1032) temp___1036)) temp___1033))))))))
...
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_1031 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_1031 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___1038 temp___10381) (temp_____aggregate_def_1031 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep1 (first4 temp___10381)) (to_rep1 (last4 temp___10381))) (+ (- (to_rep1 (last4 temp___10381)) (to_rep1 (first4 temp___10381))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___1038 temp___1039))
(assert (= (mk1 (to_rep1 (first4 temp___10381)) (to_rep1 (last4 temp___10381))) temp___10391))
(assert (= (ite (<= (to_rep1 (first2 temp___10391)) (to_rep1 (last2 temp___10391))) (+ (- (to_rep1 (last2 temp___10391)) (to_rep1 (first2 temp___10391))) 1) 0) (ite (<= (to_rep1 (first2 result____split_fields1)) (to_rep1 (last2 result____split_fields1))) (+ (- (to_rep1 (last2 result____split_fields1)) (to_rep1 (first2 result____split_fields1))) 1) 0)))
...
(assert (= r_digit1 o11))
(assert (= (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) r92b))
(assert (in_range2 r92b))
