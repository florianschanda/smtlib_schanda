...
(define-fun dynamic_invariant ((temp___expr_243 (_ BitVec 32)) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool true)
(assert (forall ((v0 (_ BitVec 32)) (v1 (_ BitVec 32))) (! (=> (and (dynamic_invariant v0 true true true true) (dynamic_invariant v1 true true true true)) (let ((result (xor2 v0 v1))) (and (= result (bvxor v0 v1)) (dynamic_invariant result true false true true)))) :pattern ((xor2 v0 v1)))))
...
(assert (forall ((i index)) (and (<= 0 (indexqtint i)) (<= (indexqtint i) 79))))
...
(define-fun bool_eq ((a (Array Int word32)) (a__first Int) (a__last Int) (b (Array Int word32)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep1 (select a temp___idx_154)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_250 us_t) (temp___is_init_246 Bool) (temp___skip_constant_247 Bool) (temp___do_toplevel_248 Bool) (temp___do_typ_inv_249 Bool)) Bool (=> (not (= temp___skip_constant_247 true)) (dynamic_property 0 79 (first1 temp___expr_250) (last1 temp___expr_250))))
...
(define-fun dynamic_invariant2 ((temp___expr_236 Int) (temp___is_init_232 Bool) (temp___skip_constant_233 Bool) (temp___do_toplevel_234 Bool) (temp___do_typ_inv_235 Bool)) Bool (=> (or (= temp___is_init_232 true) (<= 0 79)) (in_range2 temp___expr_236)))
(declare-const result__ (Array Int word32))
(declare-const i Int)
(declare-const temp___325 Int)
(declare-const temp___323 (Array Int word32))
(declare-const o Int)
...
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= temp___325 i2)))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= temp___323 result__)))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (and (<= (to_rep (first (rt right))) i2) (<= i2 (to_rep (last (rt right)))))))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= o3 i2)))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= o4 (select (elts right) o3))))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= o5 (to_rep1 o4))))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (and (<= (to_rep (first (rt left))) i2) (<= i2 (to_rep (last (rt left)))))))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= o i2)))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= o1 (select (elts left) o))))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= o2 (to_rep1 o1))))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (and (= o6 (xor2 o2 o5)) (= o6 (bvxor o2 o5)))))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= (to_rep1 o7) o6)))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= o8 (store result__ i2 o7))))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= (mk_map__ref result1) result__11)))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= result__2 o8)))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (forall ((pos Int)) (=> (and (<= (to_rep result____first) pos) (<= pos i3)) (= (to_rep1 (select result__3 pos)) (xor2 (to_rep1 (select (elts left) pos)) (to_rep1 (select (elts right) pos))))))))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (and (and (forall ((temp___324 Int)) (=> (and (<= (to_rep result____first) temp___324) (<= temp___324 (to_rep result____last))) (=> (or (< (to_rep result____last) temp___324) (or (< temp___324 (to_rep result____first)) (< i3 temp___324))) (= (select result__3 temp___324) (select temp___323 temp___324))))) (=> (<= (to_rep result____first) (to_rep result____last)) (dynamic_property1 (to_rep result____first) (to_rep result____last) i3))) (and (<= (to_rep result____first) i3) (<= i3 (to_rep result____last))))))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= i3 (to_rep result____last))))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= i3 i4)))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= result__3 result__4)))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= i5 i3)))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= result__5 result__3)))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= i10 (mk_int__ref i4))))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= result__10 (mk_map__ref result__4))))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= i7 i5)))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= result__7 result__5)))
(assert (=> (not (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last)))) (= i2 i6)))
(assert (=> (not (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last)))) (= result__10 result__11)))
(assert (=> (not (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last)))) (= i7 i2)))
(assert (=> (not (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last)))) (= result__7 result__1)))
(assert (= (mk_int__ref i8) i10))
(assert (= (mk_map__ref result__8) result__10))
(assert (= i9 i7))
(assert (= result__9 result__7))
(assert (<= (to_rep (first (rt left))) i1))
(assert (<= i1 (to_rep (last (rt left)))))
(assert (and (<= (to_rep (first (rt right))) i1) (<= i1 (to_rep (last (rt right))))))
(assert (= o9 i1))
(assert (= o10 (select (elts right) o9)))
(assert (= o11 (to_rep1 o10)))
(assert (not (<= (to_rep (first (rt left))) i1)))
(check-sat)
(exit)
