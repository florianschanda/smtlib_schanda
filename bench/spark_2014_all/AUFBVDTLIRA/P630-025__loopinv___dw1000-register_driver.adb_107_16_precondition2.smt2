...
(declare-const temp___874 bits_6)
(declare-const temp___8741 sub_index_type)
(declare-const temp___8742 operation_type)
...
(define-fun dw1000__register_driver__write_register__B_4__header__assume3 () us_rep (mk___rep (mk___split_fields dw1000__register_driver__write_register__B_4__header__assume dw1000__register_driver__write_register__B_4__header__assume1 dw1000__register_driver__write_register__B_4__header__assume2)))
...
(assert (= sub_address #x0000))
(assert (= (to_rep3 o) 1))
(assert (= (to_rep4 o1) 0))
(assert (= (to_rep2 o2) register_id))
(assert (= o2 o3))
(assert (= o1 o4))
(assert (= o o5))
(assert (= temp___874 o3))
(assert (= temp___8741 o4))
(assert (= temp___8742 o5))
(assert (= (to_rep4 temp___8741) 0))
(assert (= dw1000__register_driver__write_register__B_4__header__assume3 (mk___rep (mk___split_fields temp___874 temp___8741 temp___8742))))
(assert (= dw1000__register_driver__write_register__B_4__header__assume3 header))
(assert (= (to_rep4 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 header))) 0))
(assert (= (to_rep4 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 header))) 0))
(assert (= o12 header))
(assert (= o9 (to_bytes o12)))
(assert (= o9 o10))
(assert (= (mk 1 1) o11))
(assert (not (<= 1 (length (mk___t o10 o11)))))
(check-sat)
(exit)
