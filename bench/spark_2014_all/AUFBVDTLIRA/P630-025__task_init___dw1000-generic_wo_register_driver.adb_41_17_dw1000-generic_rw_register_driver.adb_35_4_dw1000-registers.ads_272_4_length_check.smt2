...
(define-fun target__ref___12__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep3 (rec__dw1000__register_types__ack_resp_t_type__w4d_tim (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__ack_resp_t_type__w4d_tim (us_split_fields1 b)))) (= (to_rep1 (rec__dw1000__register_types__ack_resp_t_type__ack_tim (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__ack_resp_t_type__ack_tim (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__ack_resp_t_type__reserved (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__ack_resp_t_type__reserved (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant ((temp___expr_3412 us_t1) (temp___is_init_3408 Bool) (temp___skip_constant_3409 Bool) (temp___do_toplevel_3410 Bool) (temp___do_typ_inv_3411 Bool)) Bool (=> (not (= temp___skip_constant_3409 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3412) (last3 temp___expr_3412)) (and (= (first3 temp___expr_3412) 1) (= (last3 temp___expr_3412) 4)))))
...
(define-fun register_byte_array__ref___32__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_3392 us_t2) (temp___is_init_3388 Bool) (temp___skip_constant_3389 Bool) (temp___do_toplevel_3390 Bool) (temp___do_typ_inv_3391 Bool)) Bool (=> (not (= temp___skip_constant_3389 true)) (and (dynamic_property3 1 4 (first5 temp___expr_3392) (last5 temp___expr_3392)) (and (= (first5 temp___expr_3392) 1) (= (last5 temp___expr_3392) 4)))))
...
(declare-const temp___8558 (Array Int bits_8))
(declare-const temp___85581 t1)
(declare-const temp___8559 (Array Int bits_8))
(declare-const temp___85591 t2)
(define-fun temp___85582 () us_t1 (mk___t1 temp___8558 temp___85581))
...
(assert (and (= temp___85582 (register_to_bytes reg)) (dynamic_invariant temp___85582 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___85581)) (to_rep (last2 temp___85581))) (+ (- (to_rep (last2 temp___85581)) (to_rep (first2 temp___85581))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8558 temp___8559))
(assert (= (mk2 (to_rep (first2 temp___85581)) (to_rep (last2 temp___85581))) temp___85591))
(assert (not (= (ite (<= (to_rep (first4 temp___85591)) (to_rep (last4 temp___85591))) (+ (- (to_rep (last4 temp___85591)) (to_rep (first4 temp___85591))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
