...
(assert (= a1 result2))
(assert (= a2 o15))
(assert (and (= o31 (+ a_last 1)) (in_range1 (+ a_last 1))))
(assert (= o32 (ite (<= k o31) true false)))
(assert (and (= o30 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o33 (ite (<= o30 k) true false)))
(assert (= result3 (ite (= o33 true) o32 false)))
(assert (= (= o34 true) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a2 k1)) (to_rep1 (select a k1)))))))
(assert (= o26 (from_word32 carry22)))
(assert (and (= o25 (base Tuple0)) (= o25 (oexpon (from_word32 #x00000002) 32))))
(assert (= o27 (omultiply o25 o26)))
(assert (= o24 (from_word32 carry12)))
(assert (= o28 (oadd o24 o27)))
