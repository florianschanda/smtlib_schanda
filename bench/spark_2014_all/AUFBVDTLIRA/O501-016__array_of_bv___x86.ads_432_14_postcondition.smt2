...
(declare-const tmp1 (_ BitVec 16))
...
(declare-const tmp2 (_ BitVec 16))
(declare-const memory4 (Array (_ BitVec 64) unsigned8))
(declare-const tmp3 (_ BitVec 16))
(assert (= (mk_t__ref1 result) (mk_t__ref1 tmp)))
(assert (= tmp1 val__))
(assert (and (= (readmem8 addr memory1) ((_ extract 7 0) (bvand val__ #x00FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i addr)) (= (to_rep (select memory1 i)) (to_rep (select memory i))))))))
(assert (=> (< 8 16) (= o (bvlshr val__ ((_ int2bv 16) 8)))))
(assert (=> (not (< 8 16)) (= o #x0000)))
(assert (= o1 (bvand o #x00FF)))
(assert (= o2 o1))
(assert (= o3 ((_ extract 7 0) o2)))
(assert (and (= (readmem8 (bvadd addr #x0000000000000001) memory2) o3) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000001))) (= (to_rep (select memory2 i)) (to_rep (select memory1 i))))))))
(assert (= tmp2 tmp1))
