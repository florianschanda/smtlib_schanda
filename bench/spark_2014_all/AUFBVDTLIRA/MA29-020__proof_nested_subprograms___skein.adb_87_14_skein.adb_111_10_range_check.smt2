...
(assert (= (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) r14b))
(assert (bvule r14b #x000000000000003F))
