...
(assert (= o53 (- o52 1)))
(assert (and (= ethernet_dissector__match__R33b__assume o53) (in_range1 o53)))
(assert (= ethernet_dissector__match__R33b__assume r33b))
(assert (in_range1 r33b))
(assert (<= (to_rep (first (rt buffer))) r33b))
