...
(assert (and (and (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1213 Int)) (=> (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1213) (<= temp___1213 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (or (< (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) temp___1213) (or (< temp___1213 1) (<= i2 temp___1213))) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1213) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1213)))))) (and (<= 1 i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
