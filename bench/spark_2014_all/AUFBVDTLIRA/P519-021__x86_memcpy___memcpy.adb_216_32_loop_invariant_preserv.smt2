...
(assert (= (inrange64 (bvadd rdx2 #x0000000000000001) saved_rbp_161 saved_rbp_721) true))
(assert (= (inrange64 (bvadd rdx2 #x0000000000000002) saved_rbp_161 saved_rbp_721) true))
(assert (= (inrange64 (bvadd rdx2 #x0000000000000003) saved_rbp_161 saved_rbp_721) true))
(assert (= (inrange64 (bvadd rdx2 #x0000000000000004) saved_rbp_161 saved_rbp_721) true))
(assert (= (inrange64 (bvadd rdx2 #x0000000000000005) saved_rbp_161 saved_rbp_721) true))
(assert (= (inrange64 (bvadd rdx2 #x0000000000000006) saved_rbp_161 saved_rbp_721) true))
(assert (= (inrange64 (bvadd rdx2 #x0000000000000007) saved_rbp_161 saved_rbp_721) true))
(assert (and (and (and (and (and (and (and (and (= (bvand rax9 #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory2 rdx2)))) (= (bvand rax9 #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rdx2 #x0000000000000001)))) #x0000000000000100))) (= (bvand rax9 #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rdx2 #x0000000000000002)))) #x0000000000010000))) (= (bvand rax9 #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rdx2 #x0000000000000003)))) #x0000000001000000))) (= (bvand rax9 #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rdx2 #x0000000000000004)))) #x0000000100000000))) (= (bvand rax9 #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rdx2 #x0000000000000005)))) #x0000010000000000))) (= (bvand rax9 #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rdx2 #x0000000000000006)))) #x0001000000000000))) (= (bvand rax9 #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rdx2 #x0000000000000007)))) #x0100000000000000))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (and (and (and (and (and (and (and (not (= i rdx2)) (not (= i (bvadd rdx2 #x0000000000000001)))) (not (= i (bvadd rdx2 #x0000000000000002)))) (not (= i (bvadd rdx2 #x0000000000000003)))) (not (= i (bvadd rdx2 #x0000000000000004)))) (not (= i (bvadd rdx2 #x0000000000000005)))) (not (= i (bvadd rdx2 #x0000000000000006)))) (not (= i (bvadd rdx2 #x0000000000000007)))) (= (to_rep (select memory2 i)) (to_rep (select memory1 i))))))))
(assert (= result25 (mk_t__ref1 tmp_register2)))
(assert (= tmp_register3 (bvadd tmp_register2 #x0000000000000001)))
(assert (and (= o14 (readmem64 (bvsub rbp #x0000000000000048) memory2)) (and (and (and (and (and (and (and (= (bvand o14 #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory2 (bvsub rbp #x0000000000000048))))) (= (bvand o14 #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd (bvsub rbp #x0000000000000048) #x0000000000000001)))) #x0000000000000100))) (= (bvand o14 #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd (bvsub rbp #x0000000000000048) #x0000000000000002)))) #x0000000000010000))) (= (bvand o14 #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd (bvsub rbp #x0000000000000048) #x0000000000000003)))) #x0000000001000000))) (= (bvand o14 #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd (bvsub rbp #x0000000000000048) #x0000000000000004)))) #x0000000100000000))) (= (bvand o14 #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd (bvsub rbp #x0000000000000048) #x0000000000000005)))) #x0000010000000000))) (= (bvand o14 #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd (bvsub rbp #x0000000000000048) #x0000000000000006)))) #x0001000000000000))) (= (bvand o14 #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd (bvsub rbp #x0000000000000048) #x0000000000000007)))) #x0100000000000000)))))
(assert (= result26 (mk_t__ref1 rax9)))
(assert (= rax10 o14))
(assert (= result27 (mk_t__ref1 rax10)))
(assert (= rax11 (bvudiv rax10 #x0000000000000008)))
(assert (= result28 (mk_bool__ref zeroflag4)))
(assert (= zeroflag5 (ite (= (bvsub rax11 tmp_register3) #x0000000000000000) true false)))
(assert (= result29 (mk_bool__ref signflag4)))
(assert (= signflag5 (ite (bvugt (bvsub rax11 tmp_register3) #x7FFFFFFFFFFFFFFF) true false)))
...
(assert (= overflowflag3 (ite (and (and (= signflag5 true) (bvugt tmp_register3 #x7FFFFFFFFFFFFFFF)) (bvule rax11 #x7FFFFFFFFFFFFFFF)) true (ite (and (and (not (= signflag5 true)) (bvugt rax11 #x7FFFFFFFFFFFFFFF)) (bvule tmp_register3 #x7FFFFFFFFFFFFFFF)) true false))))
(assert (not (= (ite (= carryflag3 false) zeroflag5 true) true)))
(assert (not (= saved_rbp_161 (readmem64 (bvsub rbp #x0000000000000010) memory2))))
(check-sat)
(exit)
