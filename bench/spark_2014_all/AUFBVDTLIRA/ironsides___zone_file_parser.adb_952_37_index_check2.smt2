...
(assert (= o16 (+ begidx2 6)))
(assert (= o17 (select zonefileline o16)))
(assert (= o18 (to_rep o17)))
(assert (= o19 (ite (= o18 78) true false)))
(assert (and (<= 1 (+ begidx2 5)) (<= (+ begidx2 5) 256)))
(assert (= o12 (+ begidx2 5)))
(assert (= o13 (select zonefileline o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (= o14 73) true false)))
(assert (and (<= 1 (+ begidx2 4)) (<= (+ begidx2 4) 256)))
(assert (= o8 (+ begidx2 4)))
(assert (= o9 (select zonefileline o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (= o10 71) true false)))
(assert (and (<= 1 (+ begidx2 3)) (<= (+ begidx2 3) 256)))
(assert (= o4 (+ begidx2 3)))
(assert (= o5 (select zonefileline o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 73) true false)))
(assert (and (<= 1 (+ begidx2 2)) (<= (+ begidx2 2) 256)))
(assert (= o (+ begidx2 2)))
(assert (= o1 (select zonefileline o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 82) true false)))
(assert (not (<= 1 (+ begidx2 1))))
(check-sat)
(exit)
