...
(declare-datatypes () ((t59b__ref (mk_t59b__ref (t59b__content tdigit_count_typeB)))))
(define-fun t59b__ref___projection ((a t59b__ref)) tdigit_count_typeB (t59b__content a))
...
(assert (not (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(check-sat)
(exit)
