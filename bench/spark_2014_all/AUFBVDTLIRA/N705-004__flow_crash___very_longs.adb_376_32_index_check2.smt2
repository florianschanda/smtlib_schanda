...
(define-fun dynamic_invariant2 ((temp___expr_223 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool) (temp___do_typ_inv_222 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= 1 2147483647)) (in_range1 temp___expr_223)))
...
(define-fun dynamic_invariant4 ((temp___expr_761 Int) (temp___is_init_757 Bool) (temp___skip_constant_758 Bool) (temp___do_toplevel_759 Bool) (temp___do_typ_inv_760 Bool)) Bool (=> (or (= temp___is_init_757 true) (<= 0 7)) (in_range4 temp___expr_761)))
...
(declare-datatypes () ((tS123bP1__ref (mk_tS123bP1__ref (tS123bP1__content tdigit_index_typeB)))))
(define-fun tS123bP1__ref___projection ((a tS123bP1__ref)) tdigit_index_typeB (tS123bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t125b__ref (mk_t125b__ref (t125b__content tdigit_index_typeB)))))
(define-fun t125b__ref___projection ((a t125b__ref)) tdigit_index_typeB (t125b__content a))
(declare-sort t2 0)
...
(declare-fun temp_____aggregate_def_1288 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1290 (_ BitVec 8))) (forall ((temp___1291 Int) (temp___1292 Int)) (let ((temp___1289 (temp_____aggregate_def_1288 temp___1290 temp___1291 temp___1292))) (=> (dynamic_invariant1 temp___1290 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1291 temp___1292) (and (= (first5 temp___1289) temp___1291) (= (last5 temp___1289) temp___1292))) (forall ((temp___1293 Int)) (= (to_rep2 (select (to_array2 temp___1289) temp___1293)) temp___1290))))))))
...
(define-fun dynamic_invariant6 ((temp___expr_824 us_t1) (temp___is_init_820 Bool) (temp___skip_constant_821 Bool) (temp___do_toplevel_822 Bool) (temp___do_typ_inv_823 Bool)) Bool (=> (not (= temp___skip_constant_821 true)) (and (dynamic_property3 1 r124b (first3 temp___expr_824) (last3 temp___expr_824)) (and (= (first3 temp___expr_824) 1) (= (last3 temp___expr_824) r124b)))))
...
(declare-const temp___12951 t2)
(declare-const temp___1296 (Array Int octet))
(declare-const temp___12961 t1)
(declare-const temp___1298 (Array Int octet))
(declare-const temp___12981 t1)
...
(declare-const temp___1307 us_rep)
...
(assert (= (to_rep (rec__very_longs__very_long__octet_length result____split_discrs)) (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 number))) 1)))
(assert (= result (mk_t__ref old_overflow)))
(assert (= old_overflow1 #x00))
(assert (= (to_rep (rec__very_longs__very_long__octet_length result____split_discrs)) r124b))
(assert (in_range1 r124b))
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_1288 #x00 1 r124b)))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_1288 #x00 1 r124b)))) r124b))
(assert (= (mk___t2 temp___1295 temp___12951) (temp_____aggregate_def_1288 #x00 1 r124b)))
(assert (= (ite (<= (to_rep1 (first4 temp___12951)) (to_rep1 (last4 temp___12951))) (+ (- (to_rep1 (last4 temp___12951)) (to_rep1 (first4 temp___12951))) 1) 0) (ite (<= 1 r124b) (+ (- r124b 1) 1) 0)))
(assert (= temp___1295 temp___1296))
(assert (= (mk1 (to_rep1 (first4 temp___12951)) (to_rep1 (last4 temp___12951))) temp___12961))
(assert (= (ite (<= (to_rep1 (first2 temp___12961)) (to_rep1 (last2 temp___12961))) (+ (- (to_rep1 (last2 temp___12961)) (to_rep1 (first2 temp___12961))) 1) 0) (ite (<= (to_rep1 (first result____split_fields1)) (to_rep1 (last result____split_fields1))) (+ (- (to_rep1 (last result____split_fields1)) (to_rep1 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1298 temp___12981) (mk___t1 temp___1296 temp___12961)))
(assert (= temp___1298 o))
(assert (= (mk (to_rep1 (first2 temp___12981)) (to_rep1 (last2 temp___12981))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1300)))
(assert (= temp___13001 o2))
(assert (= temp___13002 o3))
(assert (= result1 (mk___split_fields__ref (mk___split_fields (mk___t result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___13001 temp___13002))))
(assert (= result____split_discrs (mk___split_discrs temp___1300)))
...
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
(assert (and (and (dynamic_invariant3 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1315 Int)) (=> (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1315) (<= temp___1315 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (or (< (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) temp___1315) (or (< temp___1315 1) (<= i2 temp___1315))) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1315) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1315)))))) (and (<= 1 i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
(assert (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= o5 i2))
(assert (= o6 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) o5)))
(assert (= o7 (to_rep2 o6)))
(assert (= o8 (bvand o7 overflow_mask1)))
(assert (and (= o9 (shift_right__2 o8 (- 8 distance))) (= o9 (bvudiv o8 (ite (< (- 8 distance) 256) (bvshl #x01 ((_ int2bv 8) (- 8 distance))) #x00)))))
(assert (= result4 (mk_t__ref new_overflow)))
(assert (= new_overflow1 o9))
(assert (=> (< distance 8) (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
(assert (=> (< distance 8) (= o10 i2)))
(assert (=> (< distance 8) (= o11 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) o10))))
(assert (=> (< distance 8) (= o12 (to_rep2 o11))))
(assert (=> (< distance 8) (= o13 (bvshl o12 ((_ int2bv 8) distance)))))
(assert (=> (not (< distance 8)) (= o13 #x00)))
(assert (= (to_rep2 o14) o13))
(assert (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))))
(assert (= o15 i2))
(assert (= o16 (store (elts (rec__very_longs__very_long__long_digits result____split_fields3)) o15 o14)))
(assert (= o17 (mk___t o16 (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))
(assert (= o18 (mk___split_fields o17)))
(assert (= temp___1307 (mk___rep result____split_discrs o18)))
(assert (= result5 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___1307)))
(assert (= result____split_discrs (us_split_discrs1 temp___1307)))
(assert (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits result____split_fields4)))) i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits result____split_fields4)))))))
(assert (= o19 i2))
(assert (= o20 (select (elts (rec__very_longs__very_long__long_digits result____split_fields4)) o19)))
(assert (= o21 (to_rep2 o20)))
(assert (= o22 (bvor o21 old_overflow2)))
(assert (= (to_rep2 o23) o22))
(assert (not (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits result____split_fields4)))) i2)))
(check-sat)
(exit)
