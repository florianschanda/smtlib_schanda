...
(assert (= result x))
(assert (= x1 (p_bv__x__aggregate_def (temp_____aggregate_def_281 (temp_____aggregate_def_286 0)))))
(assert (= x1 y))
(assert (= result1 i3))
...
(assert (= (bool_eq2 x28 (to_rep1 (first (mk (bvadd i31 #x00000001) #x00000003))) (to_rep1 (last (mk (bvadd i31 #x00000001) #x00000003))) y (to_rep1 (first2 (mk1 (bvadd i31 #x00000001) #x00000003))) (to_rep1 (last2 (mk1 (bvadd i31 #x00000001) #x00000003)))) true))
(assert (= result68 (mk_t__ref1 i31)))
(assert (= i32 #x00000002))
(assert (= result69 (mk_int__ref i213)))
(assert (= i214 1))
(assert (= result70 (mk_t__ref i229)))
(assert (= i2210 #x0001))
...
(assert (= result77 (mk_t__ref i2210)))
(assert (= i2211 #x0002))
...
(assert (= result84 (mk_t__ref i2211)))
(assert (= i2212 #x0003))
...
(assert (= i215 2))
(assert (= result92 (mk_t__ref i2212)))
(assert (= i2213 #x0001))
...
(assert (= result99 (mk_t__ref i2213)))
(assert (= i2214 #x0002))
...
(assert (= result106 (mk_t__ref i2214)))
(assert (= i2215 #x0003))
...
(assert (= i216 3))
(assert (= result114 (mk_t__ref i2215)))
(assert (= i2216 #x0001))
...
(assert (= result121 (mk_t__ref i2216)))
(assert (= i2217 #x0002))
...
(assert (= result128 (mk_t__ref i2217)))
(assert (= i2218 #x0003))
...
(assert (not (= (bool_eq2 x55 (to_rep1 (first (mk (bvadd i32 #x00000001) #x00000003))) (to_rep1 (last (mk (bvadd i32 #x00000001) #x00000003))) y (to_rep1 (first2 (mk1 (bvadd i32 #x00000001) #x00000003))) (to_rep1 (last2 (mk1 (bvadd i32 #x00000001) #x00000003)))) true)))
(check-sat)
(exit)
