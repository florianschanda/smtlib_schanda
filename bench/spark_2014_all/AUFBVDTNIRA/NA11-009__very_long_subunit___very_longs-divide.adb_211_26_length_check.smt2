...
(assert (not (= (ite (<= (to_rep1 (first7 temp___11441)) (to_rep1 (last8 temp___11441))) (+ (- (to_rep1 (last8 temp___11441)) (to_rep1 (first7 temp___11441))) 1) 0) (ite (<= (to_rep1 (first quotient__split_fields1)) (to_rep1 (last quotient__split_fields1))) (+ (- (to_rep1 (last quotient__split_fields1)) (to_rep1 (first quotient__split_fields1))) 1) 0))))
(check-sat)
(exit)
