...
(assert (<= 1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 divisor)))))
(assert (not (<= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 divisor))) 2147483647)))
(check-sat)
(exit)
