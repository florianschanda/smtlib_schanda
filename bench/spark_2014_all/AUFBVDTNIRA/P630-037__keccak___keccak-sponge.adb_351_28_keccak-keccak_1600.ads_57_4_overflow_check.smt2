...
(assert (=> (<= (to_rep digest__first) (to_rep digest__last)) (= o15 (+ (- (to_rep digest__last) (to_rep digest__first)) 1))))
(assert (=> (not (<= (to_rep digest__first) (to_rep digest__last))) (= o15 0)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (not (in_range1 (+ offset1 remaining1))))
(check-sat)
(exit)
