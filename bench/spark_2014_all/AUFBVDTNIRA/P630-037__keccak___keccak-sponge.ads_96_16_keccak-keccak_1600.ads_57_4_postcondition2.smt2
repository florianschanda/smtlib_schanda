...
(declare-const o4 bit_absorption_number)
(declare-const o5 byte_absorption_number)
(declare-const o6 rate_number)
(declare-const o7 states)
...
(declare-const result24 map1)
(declare-const result25 (Array Int byte))
(declare-const result26 bit_absorption_number)
(declare-const result27 byte_absorption_number)
(declare-const result28 rate_number)
(declare-const result29 states)
...
(assert (and (= o (div1 (- 1600 capacity) 8)) (in_range5 (div1 (- 1600 capacity) 8))))
(assert (= (to_rep5 o1) o))
(assert (= ctx__split_fields24 o2))
(assert (= ctx__split_fields25 o3))
(assert (= ctx__split_fields26 o4))
(assert (= ctx__split_fields27 o5))
(assert (= o1 o6))
(assert (= ctx__split_fields29 o7))
(assert (= temp___879 o2))
(assert (= temp___8791 o3))
(assert (= temp___8792 o4))
(assert (= temp___8793 o5))
(assert (= temp___8794 o6))
(assert (= temp___8795 o7))
(assert (= result24 ctx__split_fields24))
(assert (= result25 ctx__split_fields25))
(assert (= result26 ctx__split_fields26))
(assert (= result27 ctx__split_fields27))
(assert (= result28 ctx__split_fields28))
(assert (= result29 ctx__split_fields29))
(assert (= ctx__split_fields30 (mk___split_fields temp___879 temp___8791 temp___8792 temp___8793 temp___8794 temp___8795)))
(assert (= (to_rep1 o8) 0))
(assert (= (rec__keccak__keccak_1600__sponge__context__state ctx__split_fields30) o9))
(assert (= (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields30) o10))
(assert (= (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields30) o11))
(assert (= (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields30) o12))
(assert (= (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields30) o13))
(assert (= o8 o14))
(assert (= temp___881 o9))
(assert (= temp___8811 o10))
(assert (= temp___8812 o11))
(assert (= temp___8813 o12))
(assert (= temp___8814 o13))
(assert (= temp___8815 o14))
(assert (= result30 (mk___split_fields__ref ctx__split_fields30)))
(assert (= ctx__split_fields31 (mk___split_fields temp___881 temp___8811 temp___8812 temp___8813 temp___8814 temp___8815)))
(assert (= ctx__split_fields32 (mk___split_fields__ref ctx__split_fields31)))
(assert (= ctx__split_fields33 ctx__split_fields31))
