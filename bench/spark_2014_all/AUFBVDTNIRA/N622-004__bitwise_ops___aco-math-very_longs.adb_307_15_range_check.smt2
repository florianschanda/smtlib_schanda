...
(assert (<= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 divisor))) (- (* 2 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1)))
(assert (not (<= (- (* 2 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1) 2147483647)))
(check-sat)
(exit)
