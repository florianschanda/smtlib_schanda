...
(assert (= (oeq (num_of_big_int (mk___t o9 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- o6 aux3_first) 1)) (omod (omultiply (omultiply (num_of_big_int r r_first (+ (- o6 aux3_first) 1)) (num_of_big_int (mk___t o8 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ (- o6 aux3_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- o6 aux3_first) 1)) (base Tuple0)) (+ (- o6 aux3_first) 1))) (num_of_big_int m m_first (+ (- o6 aux3_first) 1)))) true))
