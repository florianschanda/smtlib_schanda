...
(assert (=> (< (mod2 bit_length 8) 8) (= o18 (bvshl suffix ((_ int2bv 8) (mod2 bit_length 8))))))
(assert (=> (not (< (mod2 bit_length 8) 8)) (= o18 #x00)))
(assert (=> (< (mod2 bit_length 8) 256) (= o16 (bvshl #x01 ((_ int2bv 8) (mod2 bit_length 8))))))
(assert (=> (not (< (mod2 bit_length 8) 256)) (= o16 #x00)))
(assert (= o17 (bvsub o16 #x01)))
(assert (not (<= (to_rep6 (first (rt message))) (to_rep6 (last (rt message))))))
(check-sat)
(exit)
