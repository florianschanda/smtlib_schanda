...
(define-fun o5 () us_t1 (mk___t1 o o1))
...
(assert (=> (= (select issystem retvalini1) true) (= o5 temp___19322)))
(assert (=> (= (select issystem retvalini1) true) (= o2 (convertretvaltotext retvalini1 o5))))
...
(assert (= (temp___String_Literal_1933 Tuple0) temp___1934))
(assert (= (mk1 1 12) temp___19341))
(assert (not (dynamic_predicate (mk___t1 temp___1934 temp___19341))))
(check-sat)
(exit)
