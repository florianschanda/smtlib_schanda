...
(assert (and (= o (+ (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range1 (+ (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o1 (- o (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
(assert (and (= o2 o1) (in_range1 o1)))
(assert (and (= o3 o2) (in_range2 o2)))
(assert (= o4 (power 2 o3)))
(assert (and (= o5 o4) (in_range3 o4)))
(assert (not (uint_in_range1 o5)))
(check-sat)
(exit)
