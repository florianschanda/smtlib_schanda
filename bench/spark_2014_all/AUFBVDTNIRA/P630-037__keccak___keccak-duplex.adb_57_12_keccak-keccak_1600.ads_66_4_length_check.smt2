...
(assert (=> (<= 0 (- num_bytes 1)) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 (- num_bytes 1)) (<= (- num_bytes 1) 199)))))
(assert (= o3 block1))
(assert (= o3 temp___1128))
(assert (= (mk1 0 (- num_bytes 1)) temp___11281))
(assert (not (= (ite (<= (to_rep (first2 temp___11251)) (to_rep (last2 temp___11251))) (+ (- (to_rep (last2 temp___11251)) (to_rep (first2 temp___11251))) 1) 0) (ite (<= (to_rep (first2 temp___11281)) (to_rep (last2 temp___11281))) (+ (- (to_rep (last2 temp___11281)) (to_rep (first2 temp___11281))) 1) 0))))
(check-sat)
(exit)
