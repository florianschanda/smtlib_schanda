...
(assert (and (= o29 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o30 (- o29 1)))
(assert (and (= o31 o30) (in_range1 o30)))
(assert (= o32 (ite (<= n o31) true false)))
(assert (= result2 (ite (<= 0 n) o32 false)))
(assert (= (= o33 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux41) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
...
(assert (= o17 (from_word32 #x00000001)))
(assert (= o16 (from_word64 i2)))
(assert (= o18 (oadd o16 o17)))
(assert (= o15 (from_word32 #x00000002)))
(assert (= o19 (oexpon__2 o15 o18)))
