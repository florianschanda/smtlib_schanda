...
(assert (and (forall ((i3 Int)) (=> (and (<= 0 i3) (<= i3 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (=> (not (= i3 o9)) (= (= (nth8_stream (mk___t o10 (mk (to_rep addr__first) (to_rep addr__last))) i3) true) (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i3) true))))) (= (= (nth8_stream (mk___t o10 (mk (to_rep addr__first) (to_rep addr__last))) o9) true) (= flag1 true))))
(assert (not (in_range2 (- (- len i2) 1))))
(check-sat)
(exit)
