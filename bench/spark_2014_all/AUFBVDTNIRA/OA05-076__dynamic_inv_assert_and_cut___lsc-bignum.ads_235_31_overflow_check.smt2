...
(assert (= o32 (+ x_first o31)))
(assert (and (= o33 o32) (in_range1 o32)))
(assert (= o34 (ite (<= o33 (to_rep (last (rt x)))) true false)))
(assert (and (= o28 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o29 (+ x_first o28)))
(assert (and (= o30 o29) (in_range1 o29)))
(assert (= o35 (ite (<= (to_rep (first (rt x))) o30) true false)))
...
(assert (= o24 (+ m_first o23)))
(assert (and (= o25 o24) (in_range1 o24)))
(assert (= o26 (ite (<= o25 (to_rep (last (rt m)))) true false)))
(assert (and (= o20 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o21 (+ m_first o20)))
(assert (and (= o22 o21) (in_range1 o21)))
(assert (= o27 (ite (<= (to_rep (first (rt m))) o22) true false)))
...
(assert (= o16 (+ aux1_first o15)))
(assert (and (= o17 o16) (in_range1 o16)))
(assert (= o18 (ite (<= o17 (to_rep aux1__last)) true false)))
(assert (and (= o12 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o13 (+ aux1_first o12)))
(assert (and (= o14 o13) (in_range1 o13)))
(assert (= o19 (ite (<= (to_rep aux1__first) o14) true false)))
...
(assert (= o8 (+ aux2_first o7)))
(assert (and (= o9 o8) (in_range1 o8)))
(assert (= o10 (ite (<= o9 (to_rep aux2__last)) true false)))
(assert (and (= o4 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o5 (+ aux2_first o4)))
(assert (and (= o6 o5) (in_range1 o5)))
(assert (= o11 (ite (<= (to_rep aux2__first) o6) true false)))
...
(assert (= o3 (ite (<= o2 (to_rep aux3__last)) true false)))
