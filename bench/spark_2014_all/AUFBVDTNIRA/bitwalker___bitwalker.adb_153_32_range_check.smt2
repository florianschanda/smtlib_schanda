...
(declare-const o18 (Array Int unsigned_8))
...
(assert (and (forall ((i3 Int)) (=> (and (<= 0 i3) (<= i3 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (=> (not (= i3 o9)) (= (= (nth8_stream (mk___t o18 (mk (to_rep addr__first) (to_rep addr__last))) i3) true) (= (nth8_stream (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i3) true))))) (= (= (nth8_stream (mk___t o18 (mk (to_rep addr__first) (to_rep addr__last))) o9) true) (= flag1 true))))
(assert (= (= (nth8_stream (mk___t o18 (mk (to_rep addr__first) (to_rep addr__last))) (+ start i2)) true) (= (nth value (- (- len i2) 1)) true)))
(assert (<= start k))
(assert (<= k (- (+ start i2) 1)))
