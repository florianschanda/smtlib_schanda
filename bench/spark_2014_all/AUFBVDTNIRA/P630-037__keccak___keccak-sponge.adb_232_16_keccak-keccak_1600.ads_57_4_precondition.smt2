...
(assert (=> (<= (to_rep6 (first (rt message))) r108s) (and (and (<= (to_rep6 (first (rt message))) (to_rep6 (first (rt message)))) (<= (to_rep6 (first (rt message))) (to_rep6 (last (rt message))))) (and (<= (to_rep6 (first (rt message))) r108s) (<= r108s (to_rep6 (last (rt message))))))))
(assert (= o11 (elts message)))
(assert (= o11 temp___950))
(assert (= (mk2 (to_rep6 (first (rt message))) r108s) temp___9501))
(assert (= temp___950 o12))
(assert (= (mk (to_rep6 (first4 temp___9501)) (to_rep6 (last4 temp___9501))) o13))
