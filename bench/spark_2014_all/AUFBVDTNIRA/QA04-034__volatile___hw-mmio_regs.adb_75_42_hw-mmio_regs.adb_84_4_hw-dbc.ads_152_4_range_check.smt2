...
(define-fun dynamic_invariant4 ((temp___expr_1034 Int) (temp___is_init_1030 Bool) (temp___skip_constant_1031 Bool) (temp___do_toplevel_1032 Bool) (temp___do_typ_inv_1033 Bool)) Bool (=> (or (= temp___is_init_1030 true) (<= 0 1)) (in_range3 temp___expr_1034)))
...
(define-fun word_t__ref___30__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_1129 (_ BitVec 16)) (temp___is_init_1125 Bool) (temp___skip_constant_1126 Bool) (temp___do_toplevel_1127 Bool) (temp___do_typ_inv_1128 Bool)) Bool true)
...
(assert (= (naturalqtint rliteral1) 16))
(declare-const rliteral2 natural)
(assert (= (naturalqtint rliteral2) 24))
(assert (= legacy_support_reg_descs (hw__dbc__legacy_support_reg_descs__aggregate_def (mk___rep (mk___split_fields rliteral rliteral1 rliteral1)) (mk___rep (mk___split_fields rliteral rliteral2 rliteral2)))))
...
(declare-const hw__dbc__legacy_support_regs__write_i__2__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__legacy_support_regs__write_i__2__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__legacy_support_regs__write_i__2__off__assume off))
...
(assert (= o5 (bvsub o4 (bvshl #x0000000000000001 ((_ int2bv 64) (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))))
(assert (= o6 o5))
(assert (= result mask))
(assert (= mask1 o6))
...
(assert (not (bvule (bvor (bvand ((_ zero_extend 32) temp) (bvnot mask1)) (bvshl ((_ zero_extend 48) value) ((_ int2bv 64) (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx))))))) ((_ zero_extend 32) #xFFFFFFFF))))
(check-sat)
(exit)
