...
(define-fun dynamic_invariant3 ((temp___expr_244 Int) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool) (temp___do_typ_inv_243 Bool)) Bool (=> (or (= temp___is_init_240 true) (<= 0 4294967295)) (in_range12 temp___expr_244)))
...
(assert (forall ((a (Array Int unsigned32t))) (forall ((first4 Int)) (! (= (slide5 a first4 first4) a) :pattern ((slide5 a first4 first4))))))
...
(assert (forall ((a (Array Int unsigned32t)) (b (Array Int unsigned32t))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq12 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_189 Int)) (=> (and (<= a__first temp___idx_189) (<= temp___idx_189 a__last)) (= (to_rep9 (select a temp___idx_189)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_189)))))))))))
...
(declare-fun user_eq25 (descriptioni descriptioni) Bool)
(declare-const dummy25 descriptioni)
...
(declare-fun temp_____aggregate_def_1927 (Int) (Array Int unsigned32t))
(declare-fun temp___String_Literal_1931 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1931 us_void_param) 1)) 70) (= (to_rep (select (temp___String_Literal_1931 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1931 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_1931 us_void_param) 4)) 100)) (= (to_rep (select (temp___String_Literal_1931 us_void_param) 5)) 79)) (= (to_rep (select (temp___String_Literal_1931 us_void_param) 6)) 98)) (= (to_rep (select (temp___String_Literal_1931 us_void_param) 7)) 106)) (= (to_rep (select (temp___String_Literal_1931 us_void_param) 8)) 101)) (= (to_rep (select (temp___String_Literal_1931 us_void_param) 9)) 99)) (= (to_rep (select (temp___String_Literal_1931 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1931 us_void_param) 11)) 115)) (= (to_rep (select (temp___String_Literal_1931 us_void_param) 12)) 73)) (= (to_rep (select (temp___String_Literal_1931 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_1931 us_void_param) 14)) 105)) (= (to_rep (select (temp___String_Literal_1931 us_void_param) 15)) 116)) (= (to_rep (select (temp___String_Literal_1931 us_void_param) 16)) 32)) :pattern ((temp___String_Literal_1931 us_void_param)))))
(declare-fun temp___String_Literal_1933 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1933 us_void_param) 1)) 70) (= (to_rep (select (temp___String_Literal_1933 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1933 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_1933 us_void_param) 4)) 100)) (= (to_rep (select (temp___String_Literal_1933 us_void_param) 5)) 79)) (= (to_rep (select (temp___String_Literal_1933 us_void_param) 6)) 98)) (= (to_rep (select (temp___String_Literal_1933 us_void_param) 7)) 106)) (= (to_rep (select (temp___String_Literal_1933 us_void_param) 8)) 101)) (= (to_rep (select (temp___String_Literal_1933 us_void_param) 9)) 99)) (= (to_rep (select (temp___String_Literal_1933 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1933 us_void_param) 11)) 115)) (= (to_rep (select (temp___String_Literal_1933 us_void_param) 12)) 32)) :pattern ((temp___String_Literal_1933 us_void_param)))))
(declare-fun temp___String_Literal_1935 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1935 us_void_param) 1)) 70) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 4)) 100)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 5)) 79)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 6)) 98)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 7)) 106)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 8)) 101)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 9)) 99)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 11)) 115)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 12)) 70)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 13)) 105)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 14)) 110)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 15)) 97)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 16)) 108)) (= (to_rep (select (temp___String_Literal_1935 us_void_param) 17)) 32)) :pattern ((temp___String_Literal_1935 us_void_param)))))
...
(declare-const rliteral2 unsigned32t)
(assert (= (unsigned32tqtint rliteral2) 0))
(assert (forall ((temp___1929 Int)) (=> (dynamic_invariant3 temp___1929 true true true true) (forall ((temp___1930 Int)) (= (select (temp_____aggregate_def_1927 temp___1929) temp___1930) rliteral2)))))
...
(define-fun dynamic_invariant12 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 1 150)) (in_range15 temp___expr_471)))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(define-fun dynamic_invariant13 ((temp___expr_1207 Int) (temp___is_init_1203 Bool) (temp___skip_constant_1204 Bool) (temp___do_toplevel_1205 Bool) (temp___do_typ_inv_1206 Bool)) Bool (=> (or (= temp___is_init_1203 true) (<= 0 17)) (in_range7 temp___expr_1207)))
(define-fun dynamic_invariant14 ((temp___expr_1214 Int) (temp___is_init_1210 Bool) (temp___skip_constant_1211 Bool) (temp___do_toplevel_1212 Bool) (temp___do_typ_inv_1213 Bool)) Bool (=> (or (= temp___is_init_1210 true) (<= 1 17)) (in_range5 temp___expr_1214)))
(define-fun dynamic_invariant15 ((temp___expr_1340 Int) (temp___is_init_1336 Bool) (temp___skip_constant_1337 Bool) (temp___do_toplevel_1338 Bool) (temp___do_typ_inv_1339 Bool)) Bool (=> (or (= temp___is_init_1336 true) (<= 0 2)) (in_range4 temp___expr_1340)))
(define-fun dynamic_invariant16 ((temp___expr_1221 Int) (temp___is_init_1217 Bool) (temp___skip_constant_1218 Bool) (temp___do_toplevel_1219 Bool) (temp___do_typ_inv_1220 Bool)) Bool (=> (or (= temp___is_init_1217 true) (<= 0 17408)) (in_range6 temp___expr_1221)))
(define-fun dynamic_invariant17 ((temp___expr_1252 Int) (temp___is_init_1248 Bool) (temp___skip_constant_1249 Bool) (temp___do_toplevel_1250 Bool) (temp___do_typ_inv_1251 Bool)) Bool (=> (or (= temp___is_init_1248 true) (<= 0 1024)) (in_range8 temp___expr_1252)))
(assert true)
...
(declare-const rliteral3 fileentrycountt)
(assert (= (fileentrycounttqtint rliteral3) 0))
(assert (forall ((temp___1281 Int)) (=> (dynamic_invariant17 temp___1281 true true true true) (forall ((temp___1282 Int)) (= (select (temp_____aggregate_def_1279 temp___1281) temp___1282) rliteral3)))))
(define-fun dynamic_invariant18 ((temp___expr_1618 (_ BitVec 32)) (temp___is_init_1614 Bool) (temp___skip_constant_1615 Bool) (temp___do_toplevel_1616 Bool) (temp___do_typ_inv_1617 Bool)) Bool (=> (or (= temp___is_init_1614 true) (bvule #x00000000 #x0000000F)) (in_range13 temp___expr_1618)))
(assert (forall ((temp___1277 Int)) (=> (dynamic_invariant14 temp___1277 true true true true) (forall ((temp___1278 Int)) (= (select (temp_____aggregate_def_1275 temp___1277) temp___1278) rliteral)))))
...
(define-fun o10 () us_t1 (mk___t1 o5 o6))
(define-fun temp___19342 () us_t1 (mk___t1 temp___1934 temp___19341))
(define-fun o11 () us_t1 (mk___t1 o o1))
(define-fun temp___19322 () us_t1 (mk___t1 temp___1932 temp___19321))
...
(assert (= retvaldo1 0))
(assert (in_range14 retvaldo1))
(assert (= result1 (mk_int__ref retvalfin)))
(assert (= retvalfin1 0))
(assert (in_range14 retvalfin1))
(assert (= result2 (mk_map__ref5 handles)))
(assert (= handles1 (temp_____aggregate_def_1927 0)))
(assert (in_range14 retvalini1))
(assert (=> (= retvalini1 0) (and (in_range12 handlecount2) (in_range14 retvaldo2))))
(assert (=> (= retvalini1 0) (=> (= retvalini1 0) (in_range14 retvalfin2))))
...
(assert (=> (= (select issystem retvalini1) true) (dynamic_property1 1 2147483647 1 16)))
(assert (=> (= (select issystem retvalini1) true) (= (temp___String_Literal_1931 Tuple0) temp___1932)))
(assert (=> (= (select issystem retvalini1) true) (= (mk1 1 16) temp___19321)))
(assert (=> (= (select issystem retvalini1) true) (dynamic_predicate temp___19322)))
(assert (=> (= (select issystem retvalini1) true) (= o11 temp___19322)))
(assert (=> (= (select issystem retvalini1) true) (= o2 (convertretvaltotext retvalini1 o11))))
(assert (=> (= (select issystem retvalini1) true) (= o2 o3)))
(assert (=> (= (select issystem retvalini1) true) (= (mk 1 150) o4)))
(assert (=> (= (select issystem retvalini1) true) (and (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range9 auditalarm2))))
...
(assert (=> (= (select issystem retvaldo2) true) (dynamic_property1 1 2147483647 1 12)))
(assert (=> (= (select issystem retvaldo2) true) (= (temp___String_Literal_1933 Tuple0) temp___1934)))
(assert (=> (= (select issystem retvaldo2) true) (= (mk1 1 12) temp___19341)))
(assert (=> (= (select issystem retvaldo2) true) (dynamic_predicate temp___19342)))
(assert (=> (= (select issystem retvaldo2) true) (= o10 temp___19342)))
(assert (=> (= (select issystem retvaldo2) true) (= o7 (convertretvaltotext retvaldo2 o10))))
(assert (=> (= (select issystem retvaldo2) true) (= o7 o8)))
(assert (=> (= (select issystem retvaldo2) true) (= (mk 1 150) o9)))
(assert (=> (= (select issystem retvaldo2) true) (and (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range9 auditalarm3))))
