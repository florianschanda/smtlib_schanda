...
(assert (= temp___1364 (- o22 3)))
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1364) (<= temp___1364 (to_rep2 (last3 u__split_fields1)))))
(assert (= o23 temp___1364))
(assert (= o24 (select u__split_fields o23)))
(assert (= o25 (to_rep o24)))
(assert (= o26 ((_ zero_extend 8) o25)))
(assert (= o27 (bvadd (bvmul #x0100 r_hat1) o26)))
