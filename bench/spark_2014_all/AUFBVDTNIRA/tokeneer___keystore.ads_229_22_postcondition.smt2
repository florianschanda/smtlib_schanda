...
(declare-fun privatekeypresent (us_split_fields6) Bool)
(declare-fun privatekeypresent__function_guard (Bool us_split_fields6) Bool)
(assert true)
(assert (forall ((keystore__thistisinfo__fields us_split_fields6)) (! (= (= (privatekeypresent keystore__thistisinfo__fields) true) (= (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields7 (mk___rep3 keystore__thistisinfo__fields))) true)) :pattern ((privatekeypresent keystore__thistisinfo__fields)))))
...
(declare-fun user_eq22 (maskt maskt) Bool)
(declare-const dummy22 maskt)
...
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__keystore__interfac__keytemplatet__attrmask maskt) (rec__keystore__interfac__keytemplatet__owner us_rep3) (rec__keystore__interfac__keytemplatet__keyid unsigned32t) (rec__keystore__interfac__keytemplatet__keylength unsigned32t) (rec__keystore__interfac__keytemplatet__ispublic Bool)))))
(define-fun us_split_fields_AttrMask__projection ((a us_split_fields8)) maskt (rec__keystore__interfac__keytemplatet__attrmask a))
(define-fun us_split_fields_Owner__2__projection ((a us_split_fields8)) us_rep3 (rec__keystore__interfac__keytemplatet__owner a))
(define-fun us_split_fields_KeyID__2__projection ((a us_split_fields8)) unsigned32t (rec__keystore__interfac__keytemplatet__keyid a))
(define-fun us_split_fields_KeyLength__2__projection ((a us_split_fields8)) unsigned32t (rec__keystore__interfac__keytemplatet__keylength a))
(define-fun us_split_fields_IsPublic__projection ((a us_split_fields8)) Bool (rec__keystore__interfac__keytemplatet__ispublic a))
...
(define-fun bool_eq12 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (and (and (= (to_rep10 (rec__keystore__interfac__keytemplatet__attrmask (us_split_fields9 a))) (to_rep10 (rec__keystore__interfac__keytemplatet__attrmask (us_split_fields9 b)))) (= (bool_eq10 (rec__keystore__interfac__keytemplatet__owner (us_split_fields9 a)) (rec__keystore__interfac__keytemplatet__owner (us_split_fields9 b))) true)) (= (to_rep9 (rec__keystore__interfac__keytemplatet__keyid (us_split_fields9 a))) (to_rep9 (rec__keystore__interfac__keytemplatet__keyid (us_split_fields9 b))))) (= (to_rep9 (rec__keystore__interfac__keytemplatet__keylength (us_split_fields9 a))) (to_rep9 (rec__keystore__interfac__keytemplatet__keylength (us_split_fields9 b))))) (= (rec__keystore__interfac__keytemplatet__ispublic (us_split_fields9 a)) (rec__keystore__interfac__keytemplatet__ispublic (us_split_fields9 b)))) true false))
...
(declare-datatypes () ((keytemplatet__ref (mk_keytemplatet__ref (keytemplatet__content us_rep5)))))
(define-fun keytemplatet__ref___projection ((a keytemplatet__ref)) us_rep5 (keytemplatet__content a))
...
(define-fun dynamic_invariant2 ((temp___expr_1684 Int) (temp___is_init_1680 Bool) (temp___skip_constant_1681 Bool) (temp___do_toplevel_1682 Bool) (temp___do_typ_inv_1683 Bool)) Bool (=> (or (= temp___is_init_1680 true) (<= 0 28)) (in_range14 temp___expr_1684)))
...
(declare-fun user_eq25 (us_t2 us_t2) Bool)
(declare-const dummy25 us_t2)
...
(declare-fun user_eq26 (descriptioni descriptioni) Bool)
(declare-const dummy26 descriptioni)
...
(declare-fun user_eq29 (algorithmt algorithmt) Bool)
(declare-const dummy29 algorithmt)
...
(assert (forall ((x algorithmt)) (! (in_range18 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun bool_eq14 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (= (to_rep13 (rec__cryptotypes__keypartt__algorithmid (us_split_fields11 a))) (to_rep13 (rec__cryptotypes__keypartt__algorithmid (us_split_fields11 b)))) (= (to_rep11 (rec__cryptotypes__keypartt__keyid (us_split_fields11 a))) (to_rep11 (rec__cryptotypes__keypartt__keyid (us_split_fields11 b))))) (= (to_rep12 (rec__cryptotypes__keypartt__keylength (us_split_fields11 a))) (to_rep12 (rec__cryptotypes__keypartt__keylength (us_split_fields11 b))))) true false))
...
(declare-const theowner us_rep3)
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-const thekey us_rep6)
...
(declare-fun temp___String_Literal_1859 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1859 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_1859 us_void_param) 2)) 100)) (= (to_rep (select (temp___String_Literal_1859 us_void_param) 3)) 100)) (= (to_rep (select (temp___String_Literal_1859 us_void_param) 4)) 75)) (= (to_rep (select (temp___String_Literal_1859 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1859 us_void_param) 6)) 121)) :pattern ((temp___String_Literal_1859 us_void_param)))))
...
(define-fun dynamic_invariant8 ((temp___expr_244 Int) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool) (temp___do_typ_inv_243 Bool)) Bool (=> (or (= temp___is_init_240 true) (<= 0 4294967295)) (in_range12 temp___expr_244)))
...
(define-fun dynamic_invariant10 ((temp___expr_990 Int) (temp___is_init_986 Bool) (temp___skip_constant_987 Bool) (temp___do_toplevel_988 Bool) (temp___do_typ_inv_989 Bool)) Bool (=> (or (= temp___is_init_986 true) (<= 0 40)) (in_range10 temp___expr_990)))
(define-fun dynamic_invariant11 ((temp___expr_1014 Int) (temp___is_init_1010 Bool) (temp___skip_constant_1011 Bool) (temp___do_toplevel_1012 Bool) (temp___do_typ_inv_1013 Bool)) Bool (=> (or (= temp___is_init_1010 true) (<= 0 4294967295)) (in_range11 temp___expr_1014)))
(define-fun dynamic_invariant12 ((temp___expr_1038 Int) (temp___is_init_1034 Bool) (temp___skip_constant_1035 Bool) (temp___do_toplevel_1036 Bool) (temp___do_typ_inv_1037 Bool)) Bool (=> (or (= temp___is_init_1034 true) (<= 0 10)) (in_range18 temp___expr_1038)))
(define-fun dynamic_invariant13 ((temp___expr_1052 Int) (temp___is_init_1048 Bool) (temp___skip_constant_1049 Bool) (temp___do_toplevel_1050 Bool) (temp___do_typ_inv_1051 Bool)) Bool (=> (or (= temp___is_init_1048 true) (<= 0 4294967295)) (in_range16 temp___expr_1052)))
(define-fun dynamic_invariant14 ((temp___expr_1059 Int) (temp___is_init_1055 Bool) (temp___skip_constant_1056 Bool) (temp___do_toplevel_1057 Bool) (temp___do_typ_inv_1058 Bool)) Bool (=> (or (= temp___is_init_1055 true) (<= 0 128)) (in_range17 temp___expr_1059)))
(define-fun dynamic_invariant15 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 1 150)) (in_range15 temp___expr_471)))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(define-fun dynamic_invariant16 ((temp___expr_1207 Int) (temp___is_init_1203 Bool) (temp___skip_constant_1204 Bool) (temp___do_toplevel_1205 Bool) (temp___do_typ_inv_1206 Bool)) Bool (=> (or (= temp___is_init_1203 true) (<= 0 17)) (in_range7 temp___expr_1207)))
(define-fun dynamic_invariant17 ((temp___expr_1214 Int) (temp___is_init_1210 Bool) (temp___skip_constant_1211 Bool) (temp___do_toplevel_1212 Bool) (temp___do_typ_inv_1213 Bool)) Bool (=> (or (= temp___is_init_1210 true) (<= 1 17)) (in_range5 temp___expr_1214)))
(define-fun dynamic_invariant18 ((temp___expr_1340 Int) (temp___is_init_1336 Bool) (temp___skip_constant_1337 Bool) (temp___do_toplevel_1338 Bool) (temp___do_typ_inv_1339 Bool)) Bool (=> (or (= temp___is_init_1336 true) (<= 0 2)) (in_range4 temp___expr_1340)))
(define-fun dynamic_invariant19 ((temp___expr_1221 Int) (temp___is_init_1217 Bool) (temp___skip_constant_1218 Bool) (temp___do_toplevel_1219 Bool) (temp___do_typ_inv_1220 Bool)) Bool (=> (or (= temp___is_init_1217 true) (<= 0 17408)) (in_range6 temp___expr_1221)))
(define-fun dynamic_invariant20 ((temp___expr_1252 Int) (temp___is_init_1248 Bool) (temp___skip_constant_1249 Bool) (temp___do_toplevel_1250 Bool) (temp___do_typ_inv_1251 Bool)) Bool (=> (or (= temp___is_init_1248 true) (<= 0 1024)) (in_range8 temp___expr_1252)))
(assert true)
...
(assert (forall ((temp___1281 Int)) (=> (dynamic_invariant20 temp___1281 true true true true) (forall ((temp___1282 Int)) (= (select (temp_____aggregate_def_1279 temp___1281) temp___1282) rliteral2)))))
(define-fun dynamic_invariant21 ((temp___expr_1618 (_ BitVec 32)) (temp___is_init_1614 Bool) (temp___skip_constant_1615 Bool) (temp___do_toplevel_1616 Bool) (temp___do_typ_inv_1617 Bool)) Bool (=> (or (= temp___is_init_1614 true) (bvule #x00000000 #x0000000F)) (in_range13 temp___expr_1618)))
(assert (forall ((temp___1277 Int)) (=> (dynamic_invariant17 temp___1277 true true true true) (forall ((temp___1278 Int)) (= (select (temp_____aggregate_def_1275 temp___1277) temp___1278) rliteral)))))
...
(declare-const temp___1857 us_rep5)
(declare-const temp___1860 us_t1)
...
(declare-const thekeytemplate__split_fields7 us_split_fields8)
...
(declare-const thekeytemplate__split_fields8 us_split_fields__ref4)
...
(declare-const thekeytemplate__split_fields9 us_split_fields8)
...
(assert (=> (<= 0 28) (in_range14 retval)))
(assert (= (to_rep9 o) (to_rep12 (rec__cryptotypes__keypartt__keylength (us_split_fields11 thekey)))))
(assert (= (to_rep9 o1) (to_rep11 (rec__cryptotypes__keypartt__keyid (us_split_fields11 thekey)))))
(assert (= (to_rep10 o2) #x0000000F))
(assert (= o3 (mk___split_fields4 o2 theowner o1 o ispublic)))
(assert (= temp___1857 (mk___rep4 o3)))
(assert (= result (mk___split_fields__ref4 (mk___split_fields4 thekeytemplate__split_fields (mk___rep2 (mk___split_fields2 thekeytemplate__split_fields1 thekeytemplate__split_fields2 thekeytemplate__split_fields3)) thekeytemplate__split_fields4 thekeytemplate__split_fields5 thekeytemplate__split_fields6))))
(assert (= thekeytemplate__split_fields7 (us_split_fields9 temp___1857)))
(assert (in_range14 retval1))
(assert (= result1 (mk_bool__ref added)))
(assert (= added1 (ite (= retval1 0) true false)))
(assert (=> (ite (= added1 true) (not (= ispublic true)) false) (= result2 (mk___split_fields__ref3 (mk___split_fields3 thistisinfo__split_fields (mk___rep2 (mk___split_fields2 thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3)))))))
(assert (=> (ite (= added1 true) (not (= ispublic true)) false) (= thistisinfo__split_fields5 (mk___split_fields3 (distinct 1 0) theowner))))
(assert (=> (not (ite (= added1 true) (not (= ispublic true)) false)) (= thistisinfo__split_fields5 (mk___split_fields3 thistisinfo__split_fields (mk___rep2 (mk___split_fields2 thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))))))
...
(assert (=> (= (select issystem retval1) true) (= temp___1860 (mk___t1 (temp___String_Literal_1859 Tuple0) (mk1 1 6)))))
(assert (=> (= (select issystem retval1) true) (dynamic_predicate temp___1860)))
(assert (=> (= (select issystem retval1) true) (= o4 temp___1860)))
...
(assert (= thekeytemplate__split_fields8 (mk___split_fields__ref4 thekeytemplate__split_fields7)))
...
(assert (= logfilestate__split_fields9 (mk___split_fields__ref1 logfilestate__split_fields8)))
...
(assert (not (ite (= (ite (= (ite (= (bool__content added2) true) (ite (= ispublic false) (privatekeypresent (us_split_fields__content3 thistisinfo__split_fields6)) false) false) false) (ite (= (bool__content added2) true) (ite (= ispublic false) false (= (ite (privatekeypresent (us_split_fields__content3 thistisinfo__split_fields6)) 1 0) (ite (privatekeypresent (mk___split_fields3 thistisinfo__split_fields (mk___rep2 (mk___split_fields2 thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3)))) 1 0))) (= (ite (privatekeypresent (us_split_fields__content3 thistisinfo__split_fields6)) 1 0) (ite (privatekeypresent (mk___split_fields3 thistisinfo__split_fields (mk___rep2 (mk___split_fields2 thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3)))) 1 0))) true) true) (ite (= (ite (= (ite (= (bool__content added2) true) (ite (= ispublic false) (privatekeypresent (us_split_fields__content3 thistisinfo__split_fields6)) false) false) true) (ite (= (bool__content added2) true) (ite (= ispublic false) false (= (ite (privatekeypresent (us_split_fields__content3 thistisinfo__split_fields6)) 1 0) (ite (privatekeypresent (mk___split_fields3 thistisinfo__split_fields (mk___rep2 (mk___split_fields2 thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3)))) 1 0))) (= (ite (privatekeypresent (us_split_fields__content3 thistisinfo__split_fields6)) 1 0) (ite (privatekeypresent (mk___split_fields3 thistisinfo__split_fields (mk___rep2 (mk___split_fields2 thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3)))) 1 0))) false) false) true false) true)))
(check-sat)
(exit)
