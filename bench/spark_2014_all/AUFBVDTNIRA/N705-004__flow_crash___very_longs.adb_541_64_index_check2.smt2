...
(declare-const temp___1184 (_ BitVec 16))
(declare-const temp___1183 Int)
(declare-const temp___1182 us_rep)
(declare-const temp___1181 us_rep1)
(declare-const temp___1180 (_ BitVec 16))
...
(assert (and (= o (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))))) (in_range2 (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))))))
(assert (= o1 (+ o 1)))
...
(assert (and (= us1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) (in_range1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))))))
...
(assert (= (to_rep1 (first9 (rt4 (temp_____aggregate_def_1147 #x00 1 r137b)))) 1))
(assert (= (to_rep1 (last10 (rt4 (temp_____aggregate_def_1147 #x00 1 r137b)))) r137b))
(assert (= (mk___t4 temp___1154 temp___11541) (temp_____aggregate_def_1147 #x00 1 r137b)))
(assert (= (ite (<= (to_rep1 (first9 temp___11541)) (to_rep1 (last10 temp___11541))) (+ (- (to_rep1 (last10 temp___11541)) (to_rep1 (first9 temp___11541))) 1) 0) (ite (<= 1 r137b) (+ (- r137b 1) 1) 0)))
(assert (= temp___1154 temp___1155))
(assert (= (mk3 (to_rep1 (first9 temp___11541)) (to_rep1 (last10 temp___11541))) temp___11551))
(assert (= (ite (<= (to_rep1 (first7 temp___11551)) (to_rep1 (last8 temp___11551))) (+ (- (to_rep1 (last8 temp___11551)) (to_rep1 (first7 temp___11551))) 1) 0) (ite (<= (to_rep1 (first quotient__split_fields1)) (to_rep1 (last quotient__split_fields1))) (+ (- (to_rep1 (last quotient__split_fields1)) (to_rep1 (first quotient__split_fields1))) 1) 0)))
(assert (= temp___1157 (mk___t3 temp___1155 temp___11551)))
(assert (= o3 (mk___t (elts3 temp___1157) (mk (to_rep1 (first7 (rt3 temp___1157))) (to_rep1 (last8 (rt3 temp___1157)))))))
...
(assert (in_range1 r141b))
(assert (= (to_rep1 (first13 (rt6 (temp_____aggregate_def_1160 #x00 1 r141b)))) 1))
(assert (= (to_rep1 (last14 (rt6 (temp_____aggregate_def_1160 #x00 1 r141b)))) r141b))
(assert (= temp___1167 (temp_____aggregate_def_1160 #x00 1 r141b)))
(assert (= (ite (<= (to_rep1 (first13 (rt6 temp___1167))) (to_rep1 (last14 (rt6 temp___1167)))) (+ (- (to_rep1 (last14 (rt6 temp___1167))) (to_rep1 (first13 (rt6 temp___1167)))) 1) 0) (ite (<= 1 r141b) (+ (- r141b 1) 1) 0)))
(assert (= temp___1168 (mk___t5 (elts6 temp___1167) (mk5 (to_rep1 (first13 (rt6 temp___1167))) (to_rep1 (last14 (rt6 temp___1167)))))))
(assert (= (ite (<= (to_rep1 (first11 (rt5 temp___1168))) (to_rep1 (last12 (rt5 temp___1168)))) (+ (- (to_rep1 (last12 (rt5 temp___1168))) (to_rep1 (first11 (rt5 temp___1168)))) 1) 0) (ite (<= (to_rep1 (first remainder__split_fields1)) (to_rep1 (last remainder__split_fields1))) (+ (- (to_rep1 (last remainder__split_fields1)) (to_rep1 (first remainder__split_fields1))) 1) 0)))
(assert (= temp___1170 temp___1168))
(assert (= o5 (mk___t (elts5 temp___1170) (mk (to_rep1 (first11 (rt5 temp___1170))) (to_rep1 (last12 (rt5 temp___1170)))))))
...
(assert (and (= o7 (get_msd divisor)) (and (in_range1 o7) (and (not (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) o7)) #x00)) (forall ((i Int)) (=> (and (<= (+ o7 1) i) (<= i (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))))) (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) i)) #x00)))))))
(assert (= o8 (+ o7 1)))
(assert (and (= temp___1173 o8) (in_range2 o8)))
(assert (and (= us2 temp___1173) (dynamic_property6 1 last6 temp___1173)))
...
(assert (= m1 o10))
(assert (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))) (- n1 1)) (<= (- n1 1) (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))))))
(assert (= o11 (- n1 1)))
...
(assert (dynamic_invariant (mk___rep u__split_discrs very_longs__divide__full_left_shift__result__fields) true true true true))
...
(assert (dynamic_invariant (mk___rep v__split_discrs very_longs__divide__left_shift__number__fields) true true true true))
...
(assert (= j1 m1))
(assert (= temp___1184 q_hat))
(assert (= temp___1183 j1))
(assert (= temp___1182 (mk___rep quotient__split_discrs quotient__split_fields2)))
(assert (= temp___1181 (mk___rep1 u__split_discrs u__split_fields2)))
(assert (= temp___1180 current_borrow))
(assert (and (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields3) false true true true) (dynamic_invariant (mk___rep quotient__split_discrs quotient__split_fields3) false true true true)) (=> (<= 1 2147483647) (in_range1 j2))))
(assert (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields4) true true true true))
(assert (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields5) true true true true) (dynamic_invariant (mk___rep quotient__split_discrs quotient__split_fields4) true true true true)))
...
(assert (= n1 r144b))
(assert (dynamic_property6 1 last6 r144b))
(assert (= result9 (mk_int__ref divisor_index)))
(assert (= divisor_index1 1))
(assert (<= 1 divisor_index1))
(assert (<= divisor_index1 r144b))
(assert (and (and (dynamic_invariant (mk___rep remainder__split_discrs remainder__split_fields3) false true true true) (forall ((temp___1193 Int)) (=> (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))) temp___1193) (<= temp___1193 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))))) (=> (or (< r144b temp___1193) (or (< temp___1193 1) (<= divisor_index2 temp___1193))) (= (select (elts (rec__very_longs__very_long__long_digits remainder__split_fields3)) temp___1193) (select (elts (rec__very_longs__very_long__long_digits remainder__split_fields2)) temp___1193)))))) (and (<= 1 divisor_index2) (<= divisor_index2 r144b))))
