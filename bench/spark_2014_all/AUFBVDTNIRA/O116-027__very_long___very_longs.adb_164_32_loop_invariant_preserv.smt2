...
(assert (=> (<= 1 65536) (in_range4 index)))
(assert (=> (<= 1 2147483647) (in_range2 string_index)))
(assert (= (to_rep2 (rec__very_longs__very_long__length result____split_discrs)) r32b))
(assert (in_range4 r32b))
(assert (= (to_rep3 (first6 (rt3 (temp_____aggregate_def_886 #x00 1 r32b)))) 1))
(assert (= (to_rep3 (last6 (rt3 (temp_____aggregate_def_886 #x00 1 r32b)))) r32b))
(assert (= (mk___t3 temp___893 temp___8931) (temp_____aggregate_def_886 #x00 1 r32b)))
(assert (= (ite (<= (to_rep3 (first6 temp___8931)) (to_rep3 (last6 temp___8931))) (+ (- (to_rep3 (last6 temp___8931)) (to_rep3 (first6 temp___8931))) 1) 0) (ite (<= 1 r32b) (+ (- r32b 1) 1) 0)))
...
(assert (and (= o4 (to_rep3 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields2))))) (in_range4 (to_rep3 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields2)))))))
...
(assert (= (div1 (+ (- (to_rep1 (last (rt number))) string_index2) 1) 2) (+ (- index2 1) 1)))
(assert (and (<= (to_rep1 (first (rt number))) string_index2) (<= string_index2 (to_rep1 (last (rt number))))))
(assert (and (<= 1 index2) (<= index2 (to_rep3 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))))))
(assert (and (and (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true true) (=> (<= 1 65536) (in_range4 index2))) (=> (<= 1 2147483647) (in_range2 string_index2))))
(assert (and (<= (to_rep1 (first (rt number))) string_index2) (<= string_index2 (to_rep1 (last (rt number))))))
...
(assert (= (to_rep3 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) r35b))
(assert (in_range5 r35b))
(assert (and (<= 1 index2) (<= index2 r35b)))
(assert (= (to_rep4 o12) (bvadd (bvmul #x10 h_digit) l_digit)))
(assert (and (<= (to_rep3 (first2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) index2) (<= index2 (to_rep3 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))))))
(assert (= o13 index2))
...
(assert (not (= index2 1)))
(assert (and (= o18 (- index2 1)) (in_range4 (- index2 1))))
...
(assert (not (<= index3 (to_rep3 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields4)))))))
(check-sat)
(exit)
