...
(assert (= o24 (+ x_first o23)))
(assert (and (= o25 o24) (in_range1 o24)))
(assert (= o26 (ite (<= o25 (to_rep (last (rt x)))) true false)))
(assert (and (= o20 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o21 (+ x_first o20)))
(assert (and (= o22 o21) (in_range1 o21)))
(assert (= o27 (ite (<= (to_rep (first (rt x))) o22) true false)))
...
(assert (= result1 (ite (= o19 true) o18 false)))
(assert (= result1 true))
...
(assert (= o8 (+ aux1_first o7)))
(assert (and (= o9 o8) (in_range1 o8)))
(assert (= o10 (ite (<= o9 (to_rep aux1__last)) true false)))
(assert (and (= o4 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o5 (+ aux1_first o4)))
(assert (and (= o6 o5) (in_range1 o5)))
(assert (= o11 (ite (<= (to_rep aux1__first) o6) true false)))
...
(assert (= o3 (ite (<= o2 (to_rep aux2__last)) true false)))
