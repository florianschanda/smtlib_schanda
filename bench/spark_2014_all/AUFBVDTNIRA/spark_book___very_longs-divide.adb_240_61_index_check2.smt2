...
(declare-const temp___1145 (Array Int octet))
(declare-const temp___11451 t4)
(declare-const temp___1146 (Array Int octet))
(declare-const temp___11461 t3)
(declare-const temp___1148 us_t3)
(declare-const o us_t)
(declare-const o1 us_split_fields)
(declare-const temp___1150 us_rep)
(declare-const temp___1158 us_t6)
(declare-const temp___1159 us_t5)
(declare-const temp___1161 us_t5)
(declare-const o2 us_t)
(declare-const o3 us_split_fields)
(declare-const temp___1163 us_rep)
...
(declare-const very_longs__divide__L_7__R138b__assume Int)
(declare-const temp___1175 (_ BitVec 16))
(declare-const temp___1174 (_ BitVec 16))
(declare-const temp___1173 us_rep)
(declare-const temp___1172 us_rep1)
...
(assert (and (= us (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 dividend))) 1)) (in_range1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 dividend))) 1))))
...
(assert (and (= us1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor)))) (in_range1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor))))))
...
(assert (dynamic_invariant9 (mk___rep2 v__split_discrs (mk___split_fields2 (mk___t2 v__split_fields v__split_fields1))) false false true true))
(assert (= (to_rep (rec__very_longs__very_long__length quotient__split_discrs)) r131b))
(assert (in_range1 r131b))
(assert (= (to_rep1 (first9 (rt4 (temp_____aggregate_def_1138 #x00 1 r131b)))) 1))
(assert (= (to_rep1 (last10 (rt4 (temp_____aggregate_def_1138 #x00 1 r131b)))) r131b))
(assert (= (mk___t4 temp___1145 temp___11451) (temp_____aggregate_def_1138 #x00 1 r131b)))
(assert (= (ite (<= (to_rep1 (first9 temp___11451)) (to_rep1 (last10 temp___11451))) (+ (- (to_rep1 (last10 temp___11451)) (to_rep1 (first9 temp___11451))) 1) 0) (ite (<= 1 r131b) (+ (- r131b 1) 1) 0)))
(assert (= temp___1145 temp___1146))
(assert (= (mk3 (to_rep1 (first9 temp___11451)) (to_rep1 (last10 temp___11451))) temp___11461))
(assert (= (ite (<= (to_rep1 (first7 temp___11461)) (to_rep1 (last8 temp___11461))) (+ (- (to_rep1 (last8 temp___11461)) (to_rep1 (first7 temp___11461))) 1) 0) (ite (<= (to_rep1 (first quotient__split_fields1)) (to_rep1 (last quotient__split_fields1))) (+ (- (to_rep1 (last quotient__split_fields1)) (to_rep1 (first quotient__split_fields1))) 1) 0)))
(assert (= temp___1148 (mk___t3 temp___1146 temp___11461)))
(assert (= o (mk___t (elts3 temp___1148) (mk (to_rep1 (first7 (rt3 temp___1148))) (to_rep1 (last8 (rt3 temp___1148)))))))
(assert (= o1 (mk___split_fields o)))
(assert (= temp___1150 (mk___rep quotient__split_discrs o1)))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t quotient__split_fields quotient__split_fields1)))))
(assert (= quotient__split_fields2 (us_split_fields1 temp___1150)))
(assert (= quotient__split_discrs (us_split_discrs1 temp___1150)))
(assert (= (to_rep (rec__very_longs__very_long__length remainder__split_discrs)) r135b))
(assert (in_range1 r135b))
(assert (= (to_rep1 (first13 (rt6 (temp_____aggregate_def_1151 #x00 1 r135b)))) 1))
(assert (= (to_rep1 (last14 (rt6 (temp_____aggregate_def_1151 #x00 1 r135b)))) r135b))
(assert (= temp___1158 (temp_____aggregate_def_1151 #x00 1 r135b)))
(assert (= (ite (<= (to_rep1 (first13 (rt6 temp___1158))) (to_rep1 (last14 (rt6 temp___1158)))) (+ (- (to_rep1 (last14 (rt6 temp___1158))) (to_rep1 (first13 (rt6 temp___1158)))) 1) 0) (ite (<= 1 r135b) (+ (- r135b 1) 1) 0)))
(assert (= temp___1159 (mk___t5 (elts6 temp___1158) (mk5 (to_rep1 (first13 (rt6 temp___1158))) (to_rep1 (last14 (rt6 temp___1158)))))))
(assert (= (ite (<= (to_rep1 (first11 (rt5 temp___1159))) (to_rep1 (last12 (rt5 temp___1159)))) (+ (- (to_rep1 (last12 (rt5 temp___1159))) (to_rep1 (first11 (rt5 temp___1159)))) 1) 0) (ite (<= (to_rep1 (first remainder__split_fields1)) (to_rep1 (last remainder__split_fields1))) (+ (- (to_rep1 (last remainder__split_fields1)) (to_rep1 (first remainder__split_fields1))) 1) 0)))
(assert (= temp___1161 temp___1159))
(assert (= o2 (mk___t (elts5 temp___1161) (mk (to_rep1 (first11 (rt5 temp___1161))) (to_rep1 (last12 (rt5 temp___1161)))))))
(assert (= o3 (mk___split_fields o2)))
(assert (= temp___1163 (mk___rep remainder__split_discrs o3)))
(assert (= result1 (mk___split_fields__ref (mk___split_fields (mk___t remainder__split_fields remainder__split_fields1)))))
(assert (= remainder__split_fields2 (us_split_fields1 temp___1163)))
(assert (= remainder__split_discrs (us_split_discrs1 temp___1163)))
(assert (and (= temp___1164 (number_of_digits1 divisor)) (and (in_range3 temp___1164) (and (and (<= temp___1164 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor)))) (=> (< 0 temp___1164) (not (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) temp___1164)) #x00)))) (forall ((j7 Int)) (=> (and (<= (+ temp___1164 1) j7) (<= j7 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))))) (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))) j7)) #x00)))))))
(assert (and (= us2 temp___1164) (dynamic_property6 1 last6 temp___1164)))
(assert (= o4 temp___1164))
(assert (= result2 (mk_int__ref n)))
(assert (= n1 o4))
(assert (and (= us3 (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 dividend))) n1)) (dynamic_property7 first6 last7 (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 dividend))) n1))))
(assert (= o5 (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 dividend))) n1)))
(assert (= result3 (mk_int__ref m)))
(assert (= m1 o5))
(assert (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))) n1) (<= n1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))))))
(assert (= o6 n1))
...
(assert (and (= very_longs__divide__L_7__R138b__assume (+ m1 1)) (in_range2 (+ m1 1))))
(assert (= very_longs__divide__L_7__R138b__assume r138b))
(assert (in_range2 r138b))
(assert (= result8 (mk_int__ref j)))
(assert (= j1 r138b))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= temp___1175 current_borrow)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= temp___1174 q_hat)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= temp___1173 (mk___rep quotient__split_discrs quotient__split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= temp___1172 (mk___rep1 u__split_discrs u__split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields3) false true true true) (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields3) false true true true)) (and (<= 1 j2) (<= j2 r138b)))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (= o10 j2) (in_range1 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (= o11 j2) (in_range1 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields4) true true true true)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (= o12 j2) (in_range1 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields5) true true true true) (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields4) true true true true))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= j2 1)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= j3 (mk_int__ref j2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= current_borrow3 (mk_t__ref1 current_borrow2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= q_hat3 (mk_t__ref1 q_hat2))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= u__split_fields6 (mk___split_fields__ref1 u__split_fields5))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= quotient__split_fields5 (mk___split_fields__ref quotient__split_fields4))))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= j4 j2)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= current_borrow4 current_borrow2)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= q_hat4 q_hat2)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= u__split_fields7 u__split_fields5)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= quotient__split_fields6 quotient__split_fields4)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= j5 j3)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= current_borrow5 current_borrow3)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= q_hat5 q_hat3)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= u__split_fields8 u__split_fields6)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= quotient__split_fields7 quotient__split_fields5)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= j6 j4)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= current_borrow6 current_borrow4)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= q_hat6 q_hat4)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= u__split_fields9 u__split_fields7)))
(assert (=> (and (<= 1 j1) (<= j1 r138b)) (= quotient__split_fields8 quotient__split_fields6)))
(assert (=> (not (and (<= 1 j1) (<= j1 r138b))) (= j5 (mk_int__ref j1))))
(assert (=> (not (and (<= 1 j1) (<= j1 r138b))) (= current_borrow5 (mk_t__ref1 current_borrow))))
(assert (=> (not (and (<= 1 j1) (<= j1 r138b))) (= q_hat5 (mk_t__ref1 q_hat))))
(assert (=> (not (and (<= 1 j1) (<= j1 r138b))) (= u__split_fields8 (mk___split_fields__ref1 u__split_fields2))))
(assert (=> (not (and (<= 1 j1) (<= j1 r138b))) (= quotient__split_fields7 (mk___split_fields__ref quotient__split_fields2))))
(assert (=> (not (and (<= 1 j1) (<= j1 r138b))) (= j6 j1)))
(assert (=> (not (and (<= 1 j1) (<= j1 r138b))) (= current_borrow6 current_borrow1)))
(assert (=> (not (and (<= 1 j1) (<= j1 r138b))) (= q_hat6 q_hat1)))
(assert (=> (not (and (<= 1 j1) (<= j1 r138b))) (= u__split_fields9 u__split_fields2)))
(assert (=> (not (and (<= 1 j1) (<= j1 r138b))) (= quotient__split_fields8 quotient__split_fields2)))
(assert (= n1 r140b))
(assert (dynamic_property6 1 last6 r140b))
(assert (= result9 (mk_int__ref divisor_index)))
(assert (= divisor_index1 1))
(assert (<= 1 divisor_index1))
(assert (<= divisor_index1 r140b))
(assert (and (and (dynamic_invariant1 (mk___rep remainder__split_discrs remainder__split_fields3) false true true true) (forall ((temp___1184 Int)) (=> (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))) temp___1184) (<= temp___1184 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))))) (=> (or (< r140b temp___1184) (or (< temp___1184 1) (<= divisor_index2 temp___1184))) (= (select (elts (rec__very_longs__very_long__long_digits remainder__split_fields3)) temp___1184) (select (elts (rec__very_longs__very_long__long_digits remainder__split_fields2)) temp___1184)))))) (and (<= 1 divisor_index2) (<= divisor_index2 r140b))))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields8))))) divisor_index2)))
(check-sat)
(exit)
