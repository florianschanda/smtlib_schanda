...
(assert (= m1 o5))
(assert (not (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 divisor))))) n1)))
(check-sat)
(exit)
