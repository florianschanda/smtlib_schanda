...
(assert (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields8))))) divisor_index2) (<= divisor_index2 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields8))))))))
...
(assert (= o15 (to_rep2 o14)))
(assert (= (to_rep2 o16) o15))
(assert (not (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))) divisor_index2)))
(check-sat)
(exit)
