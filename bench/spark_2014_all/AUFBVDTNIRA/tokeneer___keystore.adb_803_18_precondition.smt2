...
(assert (= temp___1860 (mk___t1 (temp___String_Literal_1859 Tuple0) (mk1 1 6))))
(assert (dynamic_predicate temp___1860))
(assert (= o4 temp___1860))
(assert (= o5 (convertretvaltotext retval1 o4)))
(assert (= o6 (mk___t o5 (mk 1 150))))
(assert (not (= (to_rep1 (first (rt o6))) 1)))
(check-sat)
(exit)
