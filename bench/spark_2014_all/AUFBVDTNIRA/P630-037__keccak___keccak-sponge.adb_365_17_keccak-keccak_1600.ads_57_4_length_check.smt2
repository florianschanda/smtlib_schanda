...
(assert (not (= (ite (<= (to_rep (first6 temp___9881)) (to_rep (last6 temp___9881))) (+ (- (to_rep (last6 temp___9881)) (to_rep (first6 temp___9881))) 1) 0) (ite (<= (to_rep (first6 temp___9891)) (to_rep (last6 temp___9891))) (+ (- (to_rep (last6 temp___9891)) (to_rep (first6 temp___9891))) 1) 0))))
(check-sat)
(exit)
