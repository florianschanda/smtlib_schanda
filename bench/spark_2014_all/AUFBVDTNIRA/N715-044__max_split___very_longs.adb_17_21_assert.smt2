...
(declare-const temp___239 digit_index_type)
(declare-const temp___2391 (Array Int octet))
(declare-const temp___2392 t1)
...
(declare-const temp___237 us_rep1)
...
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 r4b)) (and (= result____split_discrs (mk___split_discrs temp___239)) (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___2391 temp___2392))))))
(assert (=> (and (<= 1 index1) (<= index1 r4b)) (= temp___238 temp1)))
(assert (=> (and (<= 1 index1) (<= index1 r4b)) (and (and (and (=> (<= 0 2147483647) (in_range1 temp2)) (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true true)) (forall ((temp___241 Int)) (=> (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___241) (<= temp___241 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (or (< r4b temp___241) (or (< temp___241 1) (<= index2 temp___241))) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___241) (select temp___2391 temp___241)))))) (and (<= 1 index2) (<= index2 r4b)))))
...
(assert (=> (and (<= 1 index1) (<= index1 r4b)) (= (to_rep2 o6) o5)))
(assert (=> (and (<= 1 index1) (<= index1 r4b)) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) index2) (<= index2 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3))))))))
...
(assert (=> (and (<= 1 index1) (<= index1 r4b)) (= temp___237 (mk___rep1 result____split_discrs o10))))
(assert (=> (and (<= 1 index1) (<= index1 r4b)) (= result3 (mk___split_fields__ref1 result____split_fields3))))
(assert (=> (and (<= 1 index1) (<= index1 r4b)) (= result____split_fields4 (us_split_fields3 temp___237))))
(assert (=> (and (<= 1 index1) (<= index1 r4b)) (= result____split_discrs (us_split_discrs2 temp___237))))
...
(assert (not (= (to_rep (rec__very_longs__very_long__digit_length result____split_discrs)) digit_length)))
(check-sat)
(exit)
