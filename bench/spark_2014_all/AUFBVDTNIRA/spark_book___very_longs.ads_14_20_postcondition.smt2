...
(declare-const temp___881 digit_index_type)
(declare-const temp___8811 (Array Int octet))
(declare-const temp___8812 t1)
...
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (and (= result____split_discrs (mk___split_discrs temp___881)) (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___8811 temp___8812))))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= temp___880 temp1)))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (and (and (and (=> (<= 0 2147483647) (in_range1 temp2)) (dynamic_invariant2 (mk___rep1 result____split_discrs result____split_fields3) false true true true)) (forall ((temp___883 Int)) (=> (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___883) (<= temp___883 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (or (< r26b temp___883) (or (< temp___883 1) (<= index2 temp___883))) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___883) (select temp___8811 temp___883)))))) (and (<= 1 index2) (<= index2 r26b)))))
...
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= (to_rep2 o6) o5)))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) index2) (<= index2 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3))))))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= o7 index2)))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= o8 (store (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) o7 o6))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= o9 (mk___t1 o8 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3))))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= o10 (mk___split_fields1 o9))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= temp___879 (mk___rep1 result____split_discrs o10))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= result3 (mk___split_fields__ref1 result____split_fields3))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= result____split_fields4 (us_split_fields3 temp___879))))
(assert (=> (and (<= 1 index1) (<= index1 r26b)) (= result____split_discrs (us_split_discrs2 temp___879))))
...
(assert (= very_longs__make_from_natural__result4 (mk_very_long__ref very_longs__make_from_natural__result3)))
(assert (= very_longs__make_from_natural__result5 very_longs__make_from_natural__result3))
(assert (= result5 (mk_very_long__ref (mk___rep (mk___split_discrs very_longs__make_from_natural__result) (mk___split_fields (mk___t very_longs__make_from_natural__result1 very_longs__make_from_natural__result2))))))
(assert (= very_longs__make_from_natural__result3 (to_base (mk___rep1 result____split_discrs (us_split_fields__content1 result____split_fields7)))))
(assert (= very_longs__make_from_natural__result6 very_longs__make_from_natural__result4))
(assert (= index7 index5))
(assert (= temp8 temp6))
(assert (= result____split_fields9 result____split_fields7))
(assert (= very_longs__make_from_natural__result7 very_longs__make_from_natural__result5))
(assert (= index8 index6))
(assert (= temp9 temp7))
(assert (= result____split_fields10 result____split_fields8))
(assert (= (mk___rep (mk___split_discrs result6) (mk___split_fields (mk___t result7 result8))) (very_long__content very_longs__make_from_natural__result6)))
(assert (not (= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 (very_long__content very_longs__make_from_natural__result6)))) length1)))
(check-sat)
(exit)
