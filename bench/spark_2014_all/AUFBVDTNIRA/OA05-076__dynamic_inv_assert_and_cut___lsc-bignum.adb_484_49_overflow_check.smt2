...
(assert (= (= o23 true) (forall ((n Int)) (=> (and (<= 0 n) (<= n (- h2 1))) (= (oeq (num_of_big_int (mk___t o28 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
