...
(declare-const o16 (Array Int unsigned_8))
...
(assert (or (and (and (and (= i8 i13) (and (= flag8 flag13) (and (= result__7 (mk_int__ref result__4)) (= addr11 addr13)))) (and (= i9 i1) (and (= flag9 flag1) (and (= result__8 result__5) (= addr8 addr1))))) (and (and (and (and (and (ite (<= (to_rep addr__first) (to_rep addr__last)) (= o (+ (- (to_rep addr__last) (to_rep addr__first)) 1)) (= o 0)) (and (= o1 o) (in_range1 o))) (= o2 (* o1 8))) (and (= o3 o2) (in_range1 o2))) (and (and (= o4 (+ start len)) (in_range1 (+ start len))) (= result (ite (< o3 o4) true false)))) (ite (= result true) (and (and (= result__2 result__4) (= result__5 result__2)) (and (= (mk_int__ref result1) result__11) (= result__2 (- 1)))) (and (and (= result__3 result__4) (= result__5 result__3)) (and (and (and (= o5 (maxvalue len)) (= o5 (bvshl #x0000000000000001 ((_ int2bv 64) len)))) (= result2 (ite (bvuge value o5) true false))) (and (= result2 true) (and (= (mk_int__ref result3) result__11) (= result__3 (- 2))))))))) (and (and (and (and (and (and (ite (<= (to_rep addr__first) (to_rep addr__last)) (= o (+ (- (to_rep addr__last) (to_rep addr__first)) 1)) (= o 0)) (and (= o1 o) (in_range1 o))) (= o2 (* o1 8))) (and (= o3 o2) (in_range1 o2))) (and (and (= o4 (+ start len)) (in_range1 (+ start len))) (= result (ite (< o3 o4) true false)))) (and (not (= result true)) (and (and (and (and (= o5 (maxvalue len)) (= o5 (bvshl #x0000000000000001 ((_ int2bv 64) len)))) (= result2 (ite (bvuge value o5) true false))) (and (not (= result2 true)) (and (= result__3 result__) (= result__3 result__1)))) (= result__2 result__3)))) (and (and (and (= i8 i12) (and (= flag8 flag12) (and (= result__7 (mk_int__ref result__6)) (= addr11 addr12)))) (and (= i9 i7) (and (= flag9 flag7) (and (= result__8 result__6) (= addr8 addr6))))) (and (and (and (= (mk_int__ref result4) i13) (= i2 0)) (ite (and (<= 0 i2) (<= i2 (- len 1))) (and (and (and (= temp___342 i2) (and (= temp___343 addr) (and (= temp___341 addr) (and (= temp___339 flag) (and (= temp___344 addr) (and (and (and (<= 0 i3) (<= i3 len)) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j (- start 1))) (= (= (nth8_stream (mk___t temp___343 (mk (to_rep addr__first) (to_rep addr__last))) j) true) (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) j) true)))) (and (forall ((j Int)) (=> (and (<= start j) (<= j (- (+ start i3) 1))) (= (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) j) true) (= (nth value (+ (- (- len j) 1) start)) true)))) (forall ((j Int)) (=> (and (<= (+ start i3) j) (<= j (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (= (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) j) true) (= (nth8_stream (mk___t temp___344 (mk (to_rep addr__first) (to_rep addr__last))) j) true))))))) (and (and (=> (<= 0 (- len 1)) (dynamic_property1 0 (- len 1) i3)) (and (<= 0 i3) (<= i3 (- len 1)))) (and (and (and (and (and (= o6 (+ (- 64 len) i3)) (in_range1 (+ (- 64 len) i3))) (and (= o7 o6) (in_range2 o6))) (and (= o8 (peekbit64 value o7)) (and (= (= o8 true) (not (= (bvand value (bvshl #x0000000000000001 ((_ int2bv 64) (- 63 o7)))) #x0000000000000000))) (= (= o8 true) (= (nth value (- 63 o7)) true))))) (and (= flag2 result5) (= flag3 o8))) (and (and (and (= o9 (+ start i3)) (in_range1 (+ start i3))) (and (forall ((i14 Int)) (=> (and (<= 0 i14) (<= i14 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (=> (not (= i14 o9)) (= (= (nth8_stream (mk___t o16 (mk (to_rep addr__first) (to_rep addr__last))) i14) true) (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) i14) true))))) (= (= (nth8_stream (mk___t o16 (mk (to_rep addr__first) (to_rep addr__last))) o9) true) (= flag3 true)))) (and (= (= (nth8_stream (mk___t o16 (mk (to_rep addr__first) (to_rep addr__last))) (+ start i3)) true) (= (nth value (- (- len i3) 1)) true)) (and (forall ((k Int)) (=> (and (<= start k) (<= k (- (+ start i3) 1))) (and (and (not (= k (+ start i3))) (and (<= 0 k) (<= k (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1)))) (= (= (nth8_stream (mk___t o16 (mk (to_rep addr__first) (to_rep addr__last))) k) true) (= (nth value (- (- (+ start len) k) 1)) true))))) (= i3 (- len 1))))))))))))) (and (and (= i3 i4) (and (= flag3 flag4) (= o16 addr3))) (and (= i5 i3) (and (= flag5 flag3) (= addr4 o16))))) (and (and (= i12 (mk_int__ref i4)) (and (= flag12 (mk_bool__ref flag4)) (= addr12 (mk_map__ref addr3)))) (and (= i7 i5) (and (= flag7 flag5) (= addr6 addr4))))) (and (and (= i2 i6) (and (= flag12 flag13) (= addr12 addr13))) (and (= i7 i2) (and (= flag7 flag1) (= addr6 addr1)))))) (and (= result__2 result6) (= result__6 0)))))))
(assert (= i10 i8))
(assert (= flag10 flag8))
...
(assert (= result7 (ite (= (ite (ite (= (int__content result__9) (- 1)) true false) 1 0) o15) true false)))
(assert (= result7 true))
