...
(define-fun word_t__ref___38__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_1258 (_ BitVec 16)) (temp___is_init_1254 Bool) (temp___skip_constant_1255 Bool) (temp___do_toplevel_1256 Bool) (temp___do_typ_inv_1257 Bool)) Bool true)
...
(declare-const hw__dbc__regs__write_i__2__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__regs__write_i__2__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__regs__write_i__2__off__assume off))
...
(assert (= result mask))
(assert (= mask1 o6))
(assert (not (in_range (- (to_rep (rec__hw__dbc__s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(check-sat)
(exit)
