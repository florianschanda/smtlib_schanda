...
(assert (forall ((i source)) (and (<= (- 9223372036854775808) (sourceqtint i)) (<= (sourceqtint i) 9223372036854775807))))
...
(define-fun dynamic_invariant1 ((temp___expr_290 Int) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool) (temp___do_typ_inv_289 Bool)) Bool (=> (or (= temp___is_init_286 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range3 temp___expr_290)))
...
(assert (forall ((s Int)) (! (=> (dynamic_invariant1 s true true true true) (dynamic_invariant2 (xdr_hyper_to_unsigned s) true false true true)) :pattern ((xdr_hyper_to_unsigned s)))))
...
(define-fun dynamic_invariant3 ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range4 temp___expr_180)))
