...
(assert (= (to_rep3 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) r34b))
(assert (in_range5 r34b))
...
(assert (not (<= string_index3 (to_rep1 (last (rt number))))))
(check-sat)
(exit)
