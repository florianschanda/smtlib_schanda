...
(assert (<= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor))) (- (* 2 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor)))) 1)))
(assert (not (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor))))))
(check-sat)
(exit)
