...
(assert (and (= o59 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o60 (+ x_first o59)))
(assert (and (= o61 o60) (in_range1 o60)))
(assert (= o62 (ite (<= o61 (to_rep (last (rt x)))) true false)))
(assert (and (= o56 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o57 (+ x_first o56)))
(assert (and (= o58 o57) (in_range1 o57)))
(assert (= o63 (ite (<= (to_rep (first (rt x))) o58) true false)))
(assert (= result (ite (= o63 true) o62 false)))
(assert (= result true))
...
(assert (and (= o51 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o52 (+ m_first o51)))
(assert (and (= o53 o52) (in_range1 o52)))
(assert (= o54 (ite (<= o53 (to_rep (last (rt m)))) true false)))
(assert (and (= o48 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o49 (+ m_first o48)))
(assert (and (= o50 o49) (in_range1 o49)))
(assert (= o55 (ite (<= (to_rep (first (rt m))) o50) true false)))
(assert (= result1 (ite (= o55 true) o54 false)))
(assert (= result1 true))
...
(assert (= o44 (+ aux1_first o43)))
(assert (and (= o45 o44) (in_range1 o44)))
(assert (= o46 (ite (<= o45 (to_rep aux1__last)) true false)))
(assert (and (= o40 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o41 (+ aux1_first o40)))
(assert (and (= o42 o41) (in_range1 o41)))
(assert (= o47 (ite (<= (to_rep aux1__first) o42) true false)))
(assert (= result2 (ite (= o47 true) o46 false)))
(assert (= result2 true))
(assert (<= (to_rep aux2__first) aux2_first))
(assert (<= aux2_first (to_rep aux2__last)))
(assert (and (= o35 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o36 (+ aux2_first o35)))
(assert (and (= o37 o36) (in_range1 o36)))
(assert (= o38 (ite (<= o37 (to_rep aux2__last)) true false)))
(assert (and (= o32 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o33 (+ aux2_first o32)))
(assert (and (= o34 o33) (in_range1 o33)))
(assert (= o39 (ite (<= (to_rep aux2__first) o34) true false)))
(assert (= result3 (ite (= o39 true) o38 false)))
(assert (= result3 true))
...
(assert (= o28 (+ aux3_first o27)))
(assert (and (= o29 o28) (in_range1 o28)))
(assert (= o30 (ite (<= o29 (to_rep aux3__last)) true false)))
(assert (and (= o24 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o25 (+ aux3_first o24)))
(assert (and (= o26 o25) (in_range1 o25)))
(assert (= o31 (ite (<= (to_rep aux3__first) o26) true false)))
(assert (= result4 (ite (= o31 true) o30 false)))
(assert (= result4 true))
(assert (<= (to_rep aux4__first) aux4_first))
(assert (<= aux4_first (to_rep aux4__last)))
(assert (and (= o12 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o13 (+ o12 1)))
(assert (and (= o14 o13) (in_range1 o13)))
(assert (and (= o15 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o16 (* o15 o14)))
(assert (and (= o17 o16) (in_range1 o16)))
(assert (= o18 (- o17 1)))
(assert (and (= o19 o18) (in_range1 o18)))
(assert (= o20 (+ aux4_first o19)))
(assert (and (= o21 o20) (in_range1 o20)))
(assert (= o22 (ite (<= o21 (to_rep aux4__last)) true false)))
(assert (and (= o2 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o3 (+ o2 1)))
(assert (and (= o4 o3) (in_range1 o3)))
(assert (and (= o5 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o6 (* o5 o4)))
(assert (and (= o7 o6) (in_range1 o6)))
(assert (= o8 (- o7 1)))
(assert (and (= o9 o8) (in_range1 o8)))
(assert (= o10 (+ aux4_first o9)))
(assert (and (= o11 o10) (in_range1 o10)))
(assert (= o23 (ite (<= (to_rep aux4__first) o11) true false)))
(assert (= result5 (ite (= o23 true) o22 false)))
(assert (= result5 true))
(assert (<= k 30))
