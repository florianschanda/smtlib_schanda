...
(assert (= v1 o1))
(assert (and (and (and (<= (- 2) result__1) (<= result__1 0)) (and (= (= result__1 (- 1)) (< (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) (+ start len))) (and (= (= result__1 (- 2)) (and (bvule (maxvalue len) value1) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (= (= result__1 0) (and (bvugt (maxvalue len) value1) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (=> (= result__1 0) (forall ((i1 Int)) (=> (and (<= 0 i1) (<= i1 (- start 1))) (= (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i1) true) (= (nth8_stream (mk___t o5 (mk (to_rep addr__first) (to_rep addr__last))) i1) true))))) (and (=> (= result__1 0) (forall ((i1 Int)) (=> (and (<= start i1) (<= i1 (- (+ start len) 1))) (= (= (nth8_stream (mk___t o5 (mk (to_rep addr__first) (to_rep addr__last))) i1) true) (= (nth value1 (+ (- (- len i1) 1) start)) true))))) (=> (= result__1 0) (forall ((i1 Int)) (=> (and (<= (+ start len) i1) (<= i1 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (= (= (nth8_stream (mk___t o5 (mk (to_rep addr__first) (to_rep addr__last))) i1) true) (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i1) true))))))))))) (in_range1 result__1)))
(assert (= result__1 0))
(assert (<= start i))
(assert (<= i (- (+ start len) 1)))
(assert (and (= o2 i) (in_range2 i)))
(assert (and (= o3 (nth8_stream addrold o2)) (= (= o3 true) (= (nth1 (to_rep1 (select (elts addrold) (div1 o2 8))) (- 7 (mod1 o2 8))) true))))
