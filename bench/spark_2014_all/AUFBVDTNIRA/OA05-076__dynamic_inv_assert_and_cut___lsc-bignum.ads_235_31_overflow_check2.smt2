...
(assert (= o28 (+ x_first o27)))
(assert (and (= o29 o28) (in_range1 o28)))
(assert (= o30 (ite (<= o29 (to_rep (last (rt x)))) true false)))
(assert (and (= o24 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o25 (+ x_first o24)))
(assert (and (= o26 o25) (in_range1 o25)))
(assert (= o31 (ite (<= (to_rep (first (rt x))) o26) true false)))
...
(assert (= result1 (ite (= o23 true) o22 false)))
(assert (= result1 true))
...
(assert (= o12 (+ aux1_first o11)))
(assert (and (= o13 o12) (in_range1 o12)))
(assert (= o14 (ite (<= o13 (to_rep aux1__last)) true false)))
(assert (and (= o8 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o9 (+ aux1_first o8)))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (= o15 (ite (<= (to_rep aux1__first) o10) true false)))
(assert (= result2 (ite (= o15 true) o14 false)))
(assert (= result2 true))
