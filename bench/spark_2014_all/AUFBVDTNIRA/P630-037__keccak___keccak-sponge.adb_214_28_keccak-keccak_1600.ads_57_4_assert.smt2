...
(declare-const temp___954 (Array Int byte))
...
(define-fun ctx__split_fields18 () us_split_fields (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17))
...
(assert (= o5 (div1 o4 8)))
(assert (= o6 (- o5 1)))
(assert (= o7 (+ (to_rep6 (first (rt message))) o6)))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (and (= o9 o8) (in_range8 o8)))
(assert (= (mk_int__ref result3) (mk_int__ref message_last)))
(assert (= message_last1 o9))
(assert (and (<= (to_rep6 (first (rt message))) message_last1) (<= message_last1 (to_rep6 (last (rt message))))))
(assert (and (= o10 (+ (mod2 bit_length 8) suffix_len)) (in_range1 (+ (mod2 bit_length 8) suffix_len))))
(assert (= result4 (ite (<= o10 8) true false)))
(assert (= result4 true))
(assert (=> (< 1 message_byte_length1) (< (to_rep6 (first (rt message))) message_last1)))
(assert (=> (< 1 message_byte_length1) (= (- message_last1 1) r105s)))
(assert (=> (< 1 message_byte_length1) (in_range1 r105s)))
(assert (=> (< 1 message_byte_length1) (and (= o14 (- bit_length (mod2 bit_length 8))) (in_range1 (- bit_length (mod2 bit_length 8))))))
(assert (=> (< 1 message_byte_length1) (and (= o15 o14) (in_range2 o14))))
(assert (=> (< 1 message_byte_length1) (=> (<= (to_rep6 (first (rt message))) r105s) (and (and (<= (to_rep6 (first (rt message))) (to_rep6 (first (rt message)))) (<= (to_rep6 (first (rt message))) (to_rep6 (last (rt message))))) (and (<= (to_rep6 (first (rt message))) r105s) (<= r105s (to_rep6 (last (rt message)))))))))
(assert (=> (< 1 message_byte_length1) (= o11 (elts message))))
(assert (=> (< 1 message_byte_length1) (= o11 temp___954)))
(assert (=> (< 1 message_byte_length1) (= (mk1 (to_rep6 (first (rt message))) r105s) temp___9541)))
(assert (=> (< 1 message_byte_length1) (= temp___954 o12)))
(assert (=> (< 1 message_byte_length1) (= (mk (to_rep6 (first2 temp___9541)) (to_rep6 (last2 temp___9541))) o13)))
(assert (=> (< 1 message_byte_length1) (and (and (and (= (state_of (mk___rep ctx__split_fields18)) 0) (= (rate_of (mk___rep ctx__split_fields18)) (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields18)) 8) (mod2 o15 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields18)) (rate_of (mk___rep ctx__split_fields18))))))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields ctx__split_fields12)))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields1 ctx__split_fields13)))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields2 ctx__split_fields14)))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields3 ctx__split_fields15)))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields4 ctx__split_fields16)))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields5 ctx__split_fields17)))
(assert (=> (not (< 1 message_byte_length1)) (= ctx__split_fields18 (mk___split_fields ctx__split_fields6 ctx__split_fields7 ctx__split_fields8 ctx__split_fields9 ctx__split_fields10 ctx__split_fields11))))
(assert (=> (< (mod2 bit_length 8) 8) (= o21 (bvshl suffix ((_ int2bv 8) (mod2 bit_length 8))))))
(assert (=> (not (< (mod2 bit_length 8) 8)) (= o21 #x00)))
(assert (=> (< (mod2 bit_length 8) 256) (= o18 (bvshl #x01 ((_ int2bv 8) (mod2 bit_length 8))))))
(assert (=> (not (< (mod2 bit_length 8) 256)) (= o18 #x00)))
(assert (= o19 (bvsub o18 #x01)))
(assert (and (<= (to_rep6 (first (rt message))) message_last1) (<= message_last1 (to_rep6 (last (rt message))))))
(assert (= o16 message_last1))
(assert (= o17 (select (elts message) o16)))
(assert (= o20 (to_rep3 o17)))
(assert (= o22 (bvand o20 o19)))
(assert (= o23 (bvor o22 o21)))
(assert (= (to_rep3 o24) o23))
(assert (= o25 (store suffix_array1 0 o24)))
(assert (= result5 (mk_map__ref1 suffix_array1)))
(assert (= suffix_array2 o25))
(assert (not (< 0 (+ (mod2 bit_length 8) suffix_len))))
(check-sat)
(exit)
