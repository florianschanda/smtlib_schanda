...
(assert (not (in_range2 (- (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) (to_rep4 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10))))))
(check-sat)
(exit)
