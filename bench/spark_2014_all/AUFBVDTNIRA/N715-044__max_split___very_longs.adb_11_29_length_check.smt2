...
(assert (not (= (ite (<= (to_rep1 (first4 temp___2281)) (to_rep1 (last4 temp___2281))) (+ (- (to_rep1 (last4 temp___2281)) (to_rep1 (first4 temp___2281))) 1) 0) (ite (<= 1 digit_length) (+ (- digit_length 1) 1) 0))))
(check-sat)
(exit)
