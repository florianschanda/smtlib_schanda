...
(define-fun index_t__ref___2__projection ((a index_t__ref1)) index_t1 (index_t__content1 a))
(define-fun dynamic_invariant4 ((temp___expr_647 Int) (temp___is_init_643 Bool) (temp___skip_constant_644 Bool) (temp___do_toplevel_645 Bool) (temp___do_typ_inv_646 Bool)) Bool (=> (or (= temp___is_init_643 true) (<= 0 1)) (in_range3 temp___expr_647)))
...
(define-fun word_t__ref___8__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_760 (_ BitVec 64)) (temp___is_init_756 Bool) (temp___skip_constant_757 Bool) (temp___do_toplevel_758 Bool) (temp___do_typ_inv_759 Bool)) Bool true)
...
(assert (= (naturalqtint rliteral2) 16))
(declare-const rliteral3 natural)
(assert (= (naturalqtint rliteral3) 31))
(assert (= cap_reg_descs (hw__dbc__cap_reg_descs__aggregate_def (mk___rep (mk___split_fields rliteral rliteral1 rliteral)) (mk___rep (mk___split_fields rliteral2 rliteral3 rliteral2)))))
(assert (forall ((temp___160 us_rep) (temp___161 us_rep)) (let ((temp___159 (hw__dbc__cap_reg_descs__aggregate_def temp___160 temp___161))) (and (= (select temp___159 0) temp___160) (= (select temp___159 1) temp___161)))))
...
(declare-const hw__dbc__cap_regs__write_i__4__off__assume Int)
...
(assert (and (= o (+ byte_offset (to_rep (rec__hw__dbc__cap_s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range (+ byte_offset (to_rep (rec__hw__dbc__cap_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__cap_regs__write_i__4__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__cap_regs__write_i__4__off__assume off))
(assert (in_range2 off))
(assert (and (= o2 (+ (to_rep (rec__hw__dbc__cap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range (+ (to_rep (rec__hw__dbc__cap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o3 ((_ int2bv 64) o2)))
(assert (= o4 (bvshl #x0000000000000001 o3)))
(assert (= o5 (bvsub o4 (bvshl #x0000000000000001 ((_ int2bv 64) (to_rep (rec__hw__dbc__cap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))))
(assert (= o6 o5))
(assert (= result mask))
(assert (= mask1 o6))
(assert (and (= o7 (- (to_rep (rec__hw__dbc__cap_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__cap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range (- (to_rep (rec__hw__dbc__cap_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__cap_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o8 (+ o7 1)))
(assert (and (= o9 o8) (in_range o8)))
(assert (= result1 (ite (= o9 32) true false)))
(assert (not (= result1 true)))
(assert (not (bvule ((_ zero_extend 32) #x00000000) (bvor (bvand ((_ zero_extend 32) temp) (bvnot mask1)) (bvshl value ((_ int2bv 64) (to_rep (rec__hw__dbc__cap_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))))
(check-sat)
(exit)
