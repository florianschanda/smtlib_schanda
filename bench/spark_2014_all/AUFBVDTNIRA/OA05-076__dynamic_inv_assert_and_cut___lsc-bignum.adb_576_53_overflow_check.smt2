...
(assert (= o39 (from_integer j3)))
(assert (= o43 (ole o39 o42)))
(assert (and (= o37 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o38 (ite (<= j3 o37) true false)))
(assert (= o33 (from_word32 #x00000002)))
(assert (= o34 (oexpon o33 j3)))
(assert (= o28 (from_word32 #x00000001)))
(assert (= o27 (from_integer j3)))
(assert (= o29 (osubtract o27 o28)))
(assert (= o26 (from_word64 i2)))
(assert (= o30 (osubtract o26 o29)))
...
(assert (and (= o14 (- j3 s3)) (in_range1 (- j3 s3))))
(assert (= o15 (- o14 1)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (and (= o17 o16) (in_range2 o16)))
(assert (= o13 (from_word32 #x00000002)))
(assert (= o18 (oexpon o13 o17)))
(assert (= o12 (from_word32 w2)))
(assert (= o19 (omultiply o12 o18)))
(assert (= o36 (oeq o19 o35)))
