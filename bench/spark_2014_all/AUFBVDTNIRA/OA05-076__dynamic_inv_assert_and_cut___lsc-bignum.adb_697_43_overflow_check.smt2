...
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___742 o76))))
...
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= o80 (mk_map__ref o79)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h10 (mk_int__ref h9)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= aux3 (mk_map__ref o79)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a7 (mk_map__ref o78)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h11 h9))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= o81 o79))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a8 o78))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= o82 o80))))
...
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= o83 o81))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a10 a8))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= o82 (mk_map__ref o76)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= h12 (mk_int__ref h8)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= aux31 (mk_map__ref o76)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= a9 (mk_map__ref a6)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= h13 h8))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= o83 o76))))
...
(assert (=> (not (= result2 true)) (= aux32 (mk_map__ref o87))))
(assert (=> (not (= result2 true)) (= a11 (mk_map__ref o86))))
(assert (=> (not (= result2 true)) (= h15 h7)))
(assert (=> (not (= result2 true)) (= w10 w)))
(assert (=> (not (= result2 true)) (= s13 s11)))
(assert (=> (not (= result2 true)) (= j11 j1)))
(assert (=> (not (= result2 true)) (= o89 o87)))
(assert (=> (not (= result2 true)) (= a12 o86)))
...
(assert (= (= o53 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux41) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
...
(assert (= o24 (num_of_big_int (mk___t (map__content aux32) (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o23)))
