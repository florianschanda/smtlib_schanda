...
(assert (not (= (ite (<= (to_rep1 (first4 temp___8701)) (to_rep1 (last4 temp___8701))) (+ (- (to_rep1 (last4 temp___8701)) (to_rep1 (first4 temp___8701))) 1) 0) (ite (<= 1 length1) (+ (- length1 1) 1) 0))))
(check-sat)
(exit)
