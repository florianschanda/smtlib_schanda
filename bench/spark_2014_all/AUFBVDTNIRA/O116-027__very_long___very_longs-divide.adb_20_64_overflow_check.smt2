...
(assert (and (= o (* 2 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor))))) (in_range2 (* 2 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor)))))))
(assert (= o1 (- o 1)))
