...
(assert (= (ite (<= (to_rep1 (first2 temp___9281)) (to_rep1 (last2 temp___9281))) (+ (- (to_rep1 (last2 temp___9281)) (to_rep1 (first2 temp___9281))) 1) 0) (ite (<= (to_rep1 (first2 temp___9301)) (to_rep1 (last2 temp___9301))) (+ (- (to_rep1 (last2 temp___9301)) (to_rep1 (first2 temp___9301))) 1) 0)))
(assert (= (mk___t1 temp___932 temp___9321) (mk___t1 temp___928 temp___9281)))
(assert (forall ((temp___933 Int)) (ite (and (<= r74s temp___933) (<= temp___933 r75s)) (= (select o13 temp___933) (select temp___932 temp___933)) (= (select o13 temp___933) (select ctx__split_fields1 temp___933)))))
...
(assert (= temp___935 o14))
(assert (= temp___9351 o15))
(assert (= temp___9352 o16))
(assert (= temp___9353 o17))
(assert (= temp___9354 o18))
(assert (= temp___9355 o19))
...
(assert (= ctx__split_fields6 (mk___split_fields temp___935 temp___9351 temp___9352 temp___9353 temp___9354 temp___9355)))
(assert (and (= o20 (+ (to_rep5 (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields6)) bit_length)) (in_range1 (+ (to_rep5 (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields6)) bit_length))))
(assert (not (in_range7 o20)))
(check-sat)
(exit)
