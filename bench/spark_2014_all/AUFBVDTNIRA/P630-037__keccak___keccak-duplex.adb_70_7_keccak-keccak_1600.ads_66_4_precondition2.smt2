...
(assert (forall ((i rate_number)) (and (<= 3 (rate_numberqtint i)) (<= (rate_numberqtint i) 1599))))
...
(define-fun rate_number__ref___2__projection ((a rate_number__ref)) rate_number (rate_number__content a))
(define-fun to_rep3 ((x rate_number)) Int (rate_numberqtint x))
(declare-fun of_rep3 (Int) rate_number)
(assert (forall ((x rate_number)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x rate_number)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x Int)) (! (=> (in_range3 x) (= (to_rep3 (of_rep3 x)) x)) :pattern ((to_rep3 (of_rep3 x))))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__keccak__keccak_1600__duplex__context__state map1) (rec__keccak__keccak_1600__duplex__context__rate rate_number)))))
(define-fun us_split_fields_State__2__projection ((a us_split_fields)) map1 (rec__keccak__keccak_1600__duplex__context__state a))
(define-fun us_split_fields_Rate__2__projection ((a us_split_fields)) rate_number (rec__keccak__keccak_1600__duplex__context__rate a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (= (bool_eq2 (rec__keccak__keccak_1600__duplex__context__state (us_split_fields1 a)) #x00 #x04 #x00 #x04 (rec__keccak__keccak_1600__duplex__context__state (us_split_fields1 b)) #x00 #x04 #x00 #x04) true) (= (to_rep3 (rec__keccak__keccak_1600__duplex__context__rate (us_split_fields1 a))) (to_rep3 (rec__keccak__keccak_1600__duplex__context__rate (us_split_fields1 b))))) true false))
...
(assert (< keccak__keccak_1600__duplex__context__state__first__bit keccak__keccak_1600__duplex__context__state__last__bit))
...
(assert (< keccak__keccak_1600__duplex__context__rate__first__bit keccak__keccak_1600__duplex__context__rate__last__bit))
...
(define-fun context__ref___2__projection ((a context__ref)) us_rep (context__content a))
(declare-fun rate_of (us_rep) Int)
(declare-fun rate_of__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant2 ((temp___expr_572 Int) (temp___is_init_568 Bool) (temp___skip_constant_569 Bool) (temp___do_toplevel_570 Bool) (temp___do_typ_inv_571 Bool)) Bool (=> (or (= temp___is_init_568 true) (<= 3 1599)) (in_range3 temp___expr_572)))
(assert (forall ((ctx us_rep)) (! (dynamic_invariant2 (rate_of ctx) true false true true) :pattern ((rate_of ctx)))))
(assert (forall ((ctx us_rep)) (! (= (rate_of ctx) (to_rep3 (rec__keccak__keccak_1600__duplex__context__rate (us_split_fields1 ctx)))) :pattern ((rate_of ctx)))))
...
(assert (forall ((ctx us_rep)) (! (dynamic_invariant3 (max_input_length ctx) true false true true) :pattern ((max_input_length ctx)))))
(assert (forall ((ctx us_rep)) (! (= (max_input_length ctx) (- (rate_of ctx) 2)) :pattern ((max_input_length ctx)))))
...
(assert (forall ((i tTblockSP1)) (and (<= 0 (tTblockSP1qtint i)) (<= (tTblockSP1qtint i) 199))))
...
(declare-datatypes () ((tTblockSP1__ref (mk_tTblockSP1__ref (tTblockSP1__content tTblockSP1)))))
(define-fun tTblockSP1__ref___projection ((a tTblockSP1__ref)) tTblockSP1 (tTblockSP1__content a))
...
(declare-datatypes () ((t172s__ref (mk_t172s__ref (t172s__content integer)))))
(define-fun t172s__ref___projection ((a t172s__ref)) integer (t172s__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t174s__ref (mk_t174s__ref (t174s__content integer)))))
(define-fun t174s__ref___projection ((a t174s__ref)) integer (t174s__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t177s__ref (mk_t177s__ref (t177s__content integer)))))
(define-fun t177s__ref___projection ((a t177s__ref)) integer (t177s__content a))
(declare-sort t3 0)
...
(declare-datatypes () ((t180s__ref (mk_t180s__ref (t180s__content integer)))))
(define-fun t180s__ref___projection ((a t180s__ref)) integer (t180s__content a))
(declare-sort t4 0)
...
(define-fun dynamic_invariant6 ((temp___expr_293 Int) (temp___is_init_289 Bool) (temp___skip_constant_290 Bool) (temp___do_toplevel_291 Bool) (temp___do_typ_inv_292 Bool)) Bool (=> (or (= temp___is_init_289 true) (<= 0 2147483647)) (in_range2 temp___expr_293)))
(assert (forall ((temp___1120 (_ BitVec 8))) (=> (dynamic_invariant5 temp___1120 true true true true) (forall ((temp___1121 Int)) (= (to_rep1 (select (keccak__keccak_1600__duplex__duplex__block__aggregate_def temp___1120) temp___1121)) temp___1120)))))
...
(declare-const temp___1124 (Array Int byte))
(declare-const temp___11241 t2)
(declare-const temp___1125 (Array Int byte))
(declare-const temp___11251 t1)
(declare-const o3 (Array Int byte))
(declare-const temp___1128 (Array Int byte))
(declare-const temp___11281 t1)
(declare-const temp___1129 (Array Int byte))
(declare-const temp___11291 t1)
...
(declare-const temp___1136 (Array Int byte))
(declare-const temp___11361 t4)
...
(assert (dynamic_property 0 2147483647 (to_rep out_data__first) (to_rep out_data__last)))
(assert (in_range1 out_data_bit_length))
(assert (and (<= in_data_bit_length (max_input_length (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (<= (div1 (+ in_data_bit_length 7) 8) (length in_data)) (and (<= out_data_bit_length (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (= (ite (<= (to_rep out_data__first) (to_rep out_data__last)) (+ (- (to_rep out_data__last) (to_rep out_data__first)) 1) 0) (div1 (+ out_data_bit_length 7) 8))))))
(assert (= (mk_map__ref result) (mk_map__ref block)))
(assert (= block1 (keccak__keccak_1600__duplex__duplex__block__aggregate_def #x00)))
(assert (and (= o (+ in_data_bit_length 7)) (in_range (+ in_data_bit_length 7))))
(assert (= o1 (div1 o 8)))
(assert (and (= keccak__keccak_1600__duplex__duplex__num_bytes__assume o1) (in_range1 o1)))
(assert (= keccak__keccak_1600__duplex__duplex__num_bytes__assume num_bytes))
(assert (in_range1 num_bytes))
(assert (=> (< 0 num_bytes) (and (= temp___1123 (+ (to_rep (first (rt in_data))) (- num_bytes 1))) (in_range (+ (to_rep (first (rt in_data))) (- num_bytes 1))))))
(assert (=> (< 0 num_bytes) (=> (<= (to_rep (first (rt in_data))) temp___1123) (and (and (<= (to_rep (first (rt in_data))) (to_rep (first (rt in_data)))) (<= (to_rep (first (rt in_data))) (to_rep (last (rt in_data))))) (and (<= (to_rep (first (rt in_data))) temp___1123) (<= temp___1123 (to_rep (last (rt in_data)))))))))
(assert (=> (< 0 num_bytes) (= o2 (elts in_data))))
(assert (=> (< 0 num_bytes) (= o2 temp___1124)))
(assert (=> (< 0 num_bytes) (= (mk2 (to_rep (first (rt in_data))) temp___1123) temp___11241)))
(assert (=> (< 0 num_bytes) (= (ite (<= (to_rep (first4 temp___11241)) (to_rep (last4 temp___11241))) (+ (- (to_rep (last4 temp___11241)) (to_rep (first4 temp___11241))) 1) 0) (ite (<= 0 (- num_bytes 1)) (+ (- (- num_bytes 1) 0) 1) 0))))
(assert (=> (< 0 num_bytes) (= (slide temp___1124 (to_rep (first4 temp___11241)) 0) temp___1125)))
(assert (=> (< 0 num_bytes) (= (mk1 0 (- num_bytes 1)) temp___11251)))
(assert (=> (< 0 num_bytes) (=> (<= 0 (- num_bytes 1)) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 (- num_bytes 1)) (<= (- num_bytes 1) 199))))))
(assert (=> (< 0 num_bytes) (= o3 block1)))
(assert (=> (< 0 num_bytes) (= o3 temp___1128)))
(assert (=> (< 0 num_bytes) (= (mk1 0 (- num_bytes 1)) temp___11281)))
(assert (=> (< 0 num_bytes) (= (ite (<= (to_rep (first2 temp___11251)) (to_rep (last2 temp___11251))) (+ (- (to_rep (last2 temp___11251)) (to_rep (first2 temp___11251))) 1) 0) (ite (<= (to_rep (first2 temp___11281)) (to_rep (last2 temp___11281))) (+ (- (to_rep (last2 temp___11281)) (to_rep (first2 temp___11281))) 1) 0))))
(assert (=> (< 0 num_bytes) (= (mk___t1 temp___1129 temp___11291) (mk___t1 temp___1125 temp___11251))))
(assert (=> (< 0 num_bytes) (forall ((temp___1130 Int)) (ite (and (<= 0 temp___1130) (<= temp___1130 (- num_bytes 1))) (= (select o4 temp___1130) (select temp___1129 temp___1130)) (= (select o4 temp___1130) (select block1 temp___1130))))))
(assert (=> (< 0 num_bytes) (= block1 result1)))
(assert (=> (< 0 num_bytes) (= block2 o4)))
(assert (=> (not (< 0 num_bytes)) (= block2 block1)))
(assert (and (= o5 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o5) (= o5 (to_rep3 ctx__split_fields1)))))
(assert (= o6 (+ o5 7)))
(assert (= o7 (div1 o6 8)))
...
(assert (=> (<= 0 r176s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r176s) (<= r176s 199)))))
(assert (= o8 block2))
(assert (= o8 keccak__padding__pad101_single_block__block__compl))
(assert (= (mk3 0 r176s) keccak__padding__pad101_single_block__block__compl1))
(assert (and (= o11 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o11) (= o11 (to_rep3 ctx__split_fields1)))))
(assert (= (to_rep o10) (to_rep (last6 keccak__padding__pad101_single_block__block__compl1))))
(assert (= (to_rep o9) (to_rep (first6 keccak__padding__pad101_single_block__block__compl1))))
(assert (forall ((temp___1134 Int)) (ite (and (<= 0 temp___1134) (<= temp___1134 r176s)) (= (select o12 temp___1134) (select (slide keccak__padding__pad101_single_block__block (to_rep (first (mk (to_rep (first6 keccak__padding__pad101_single_block__block__compl1)) (to_rep (last6 keccak__padding__pad101_single_block__block__compl1))))) 0) temp___1134)) (= (select o12 temp___1134) (select block2 temp___1134)))))
(assert (= block2 result2))
(assert (= block3 o12))
(assert (= (- (div1 (+ (to_rep3 ctx__split_fields1) 7) 8) 1) r179s))
(assert (in_range r179s))
(assert (and (= o16 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o16) (= o16 (to_rep3 ctx__split_fields1)))))
(assert (=> (<= 0 r179s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r179s) (<= r179s 199)))))
(assert (= o13 block3))
(assert (= o13 temp___1136))
(assert (= (mk4 0 r179s) temp___11361))
(assert (= temp___1136 o14))
(assert (= (mk (to_rep (first8 temp___11361)) (to_rep (last8 temp___11361))) o15))
(assert (= (mk___split_fields__ref (mk___split_fields result3 result4)) (mk___split_fields__ref (mk___split_fields ctx__split_fields ctx__split_fields1))))
(assert (= keccak__keccak_1600__keccakf_1600_lanes__xor_bits_into_state__a ctx__split_fields2))
(assert (= ctx__split_fields1 ctx__split_fields3))
(assert (= result5 ctx__split_fields2))
(assert (= result6 ctx__split_fields3))
(assert (= keccak__keccak_1600__keccakf_1600_permutation__permute__a ctx__split_fields4))
(assert (= ctx__split_fields3 ctx__split_fields5))
(assert (not (<= out_data_bit_length 1600)))
(check-sat)
(exit)
