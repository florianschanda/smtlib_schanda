...
(define-fun dynamic_invariant1 ((temp___expr_715 (_ BitVec 32)) (temp___is_init_711 Bool) (temp___skip_constant_712 Bool) (temp___do_toplevel_713 Bool) (temp___do_typ_inv_714 Bool)) Bool true)
...
(define-fun dynamic_invariant3 ((temp___expr_647 Int) (temp___is_init_643 Bool) (temp___skip_constant_644 Bool) (temp___do_toplevel_645 Bool) (temp___do_typ_inv_646 Bool)) Bool (=> (or (= temp___is_init_643 true) (<= 0 1)) (in_range3 temp___expr_647)))
...
(assert (not (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__cap_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(check-sat)
(exit)
