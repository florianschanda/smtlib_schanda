...
(define-fun dynamic_invariant1 ((temp___expr_612 (_ BitVec 32)) (temp___is_init_608 Bool) (temp___skip_constant_609 Bool) (temp___do_toplevel_610 Bool) (temp___do_typ_inv_611 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_355 (_ BitVec 64)) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool) (temp___do_typ_inv_354 Bool)) Bool true)
(declare-sort index_t 0)
(declare-fun index_tqtint (index_t) Int)
(assert (forall ((i index_t)) (and (<= 0 (index_tqtint i)) (<= (index_tqtint i) 16383))))
...
(define-fun dynamic_invariant3 ((temp___expr_619 Int) (temp___is_init_615 Bool) (temp___skip_constant_616 Bool) (temp___do_toplevel_617 Bool) (temp___do_typ_inv_618 Bool)) Bool (=> (or (= temp___is_init_615 true) (<= 0 16383)) (in_range2 temp___expr_619)))
(declare-sort index_t1 0)
(define-fun in_range3 ((x Int)) Bool (and (<= 0 x) (<= x 1)))
(declare-fun attr__ATTRIBUTE_IMAGE6 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check6 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE6 (us_image) Int)
(declare-fun user_eq6 (index_t1 index_t1) Bool)
(declare-const dummy6 index_t1)
(declare-datatypes () ((index_t__ref1 (mk_index_t__ref1 (index_t__content1 index_t1)))))
(define-fun index_t__ref___4__projection ((a index_t__ref1)) index_t1 (index_t__content1 a))
(define-fun dynamic_invariant4 ((temp___expr_905 Int) (temp___is_init_901 Bool) (temp___skip_constant_902 Bool) (temp___do_toplevel_903 Bool) (temp___do_typ_inv_904 Bool)) Bool (=> (or (= temp___is_init_901 true) (<= 0 1)) (in_range3 temp___expr_905)))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__hw__dbc__xcap_s_regs__t__byte_offset natural) (rec__hw__dbc__xcap_s_regs__t__msb natural) (rec__hw__dbc__xcap_s_regs__t__lsb natural)))))
(define-fun us_split_fields_Byte_Offset__3__projection ((a us_split_fields)) natural (rec__hw__dbc__xcap_s_regs__t__byte_offset a))
(define-fun us_split_fields_MSB__3__projection ((a us_split_fields)) natural (rec__hw__dbc__xcap_s_regs__t__msb a))
(define-fun us_split_fields_LSB__3__projection ((a us_split_fields)) natural (rec__hw__dbc__xcap_s_regs__t__lsb a))
...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__hw__dbc__xcap_s_regs__t__byte_offset (us_split_fields1 a))) (to_rep (rec__hw__dbc__xcap_s_regs__t__byte_offset (us_split_fields1 b)))) (= (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 a))) (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 b))))) (= (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 a))) (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 b))))) true false))
...
(declare-const hw__dbc__xcap_s_regs__t__byte_offset__first__bit Int)
(declare-const hw__dbc__xcap_s_regs__t__byte_offset__last__bit Int)
(declare-const hw__dbc__xcap_s_regs__t__byte_offset__position Int)
(assert (<= 0 hw__dbc__xcap_s_regs__t__byte_offset__first__bit))
(assert (< hw__dbc__xcap_s_regs__t__byte_offset__first__bit hw__dbc__xcap_s_regs__t__byte_offset__last__bit))
(assert (<= 0 hw__dbc__xcap_s_regs__t__byte_offset__position))
(declare-const hw__dbc__xcap_s_regs__t__msb__first__bit Int)
(declare-const hw__dbc__xcap_s_regs__t__msb__last__bit Int)
(declare-const hw__dbc__xcap_s_regs__t__msb__position Int)
(assert (<= 0 hw__dbc__xcap_s_regs__t__msb__first__bit))
(assert (< hw__dbc__xcap_s_regs__t__msb__first__bit hw__dbc__xcap_s_regs__t__msb__last__bit))
(assert (<= 0 hw__dbc__xcap_s_regs__t__msb__position))
(declare-const hw__dbc__xcap_s_regs__t__lsb__first__bit Int)
(declare-const hw__dbc__xcap_s_regs__t__lsb__last__bit Int)
(declare-const hw__dbc__xcap_s_regs__t__lsb__position Int)
(assert (<= 0 hw__dbc__xcap_s_regs__t__lsb__first__bit))
(assert (< hw__dbc__xcap_s_regs__t__lsb__first__bit hw__dbc__xcap_s_regs__t__lsb__last__bit))
(assert (<= 0 hw__dbc__xcap_s_regs__t__lsb__position))
(declare-fun user_eq7 (us_rep us_rep) Bool)
(declare-const dummy7 us_rep)
(declare-datatypes () ((t__ref2 (mk_t__ref2 (t__content2 us_rep)))))
(define-fun t__ref___3__projection ((a t__ref2)) us_rep (t__content2 a))
...
(define-fun bool_eq2 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_170 Int)) (=> (and (<= a__first temp___idx_170) (<= temp___idx_170 a__last)) (= (bool_eq1 (select a temp___idx_170) (select b (+ (- b__first a__first) temp___idx_170))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_170 Int)) (=> (and (<= a__first temp___idx_170) (<= temp___idx_170 a__last)) (= (bool_eq1 (select a temp___idx_170) (select b (+ (- b__first a__first) temp___idx_170))) true))))))))
(declare-const xcap_reg_descs (Array Int us_rep))
...
(declare-fun user_eq8 (word_t word_t) Bool)
(declare-const dummy8 word_t)
(declare-datatypes () ((word_t__ref (mk_word_t__ref (word_t__content word_t)))))
(define-fun word_t__ref___23__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_1009 (_ BitVec 32)) (temp___is_init_1005 Bool) (temp___skip_constant_1006 Bool) (temp___do_toplevel_1007 Bool) (temp___do_typ_inv_1008 Bool)) Bool true)
...
(declare-fun hw__dbc__xcap_reg_descs__aggregate_def (us_rep us_rep) (Array Int us_rep))
(declare-const rliteral natural)
(assert (= (naturalqtint rliteral) 0))
(declare-const rliteral1 natural)
(assert (= (naturalqtint rliteral1) 7))
(declare-const rliteral2 natural)
(assert (= (naturalqtint rliteral2) 15))
(declare-const rliteral3 natural)
(assert (= (naturalqtint rliteral3) 8))
(assert (= xcap_reg_descs (hw__dbc__xcap_reg_descs__aggregate_def (mk___rep (mk___split_fields rliteral rliteral1 rliteral)) (mk___rep (mk___split_fields rliteral rliteral2 rliteral3)))))
(assert (forall ((temp___172 us_rep) (temp___173 us_rep)) (let ((temp___171 (hw__dbc__xcap_reg_descs__aggregate_def temp___172 temp___173))) (and (= (select temp___171 0) temp___172) (= (select temp___171 1) temp___173)))))
(define-fun dynamic_invariant7 ((temp___expr_348 (_ BitVec 32)) (temp___is_init_344 Bool) (temp___skip_constant_345 Bool) (temp___do_toplevel_346 Bool) (temp___do_typ_inv_347 Bool)) Bool true)
(assert (= regs xcap_reg_descs))
(declare-const byte_offset Int)
(declare-const mask (_ BitVec 64))
(declare-const o Int)
(declare-const o1 Int)
(declare-const hw__dbc__xcap_regs__write_i__3__off__assume Int)
...
(assert (= xcap_reg_descs regs))
(assert (in_range1 byte_offset))
(assert (in_range3 idx))
(assert (and (= o (+ byte_offset (to_rep (rec__hw__dbc__xcap_s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range (+ byte_offset (to_rep (rec__hw__dbc__xcap_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__xcap_regs__write_i__3__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__xcap_regs__write_i__3__off__assume off))
(assert (in_range2 off))
(assert (and (= o2 (+ (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range (+ (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o3 ((_ int2bv 64) o2)))
(assert (= o4 (bvshl #x0000000000000001 o3)))
(assert (= o5 (bvsub o4 (bvshl #x0000000000000001 ((_ int2bv 64) (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))))
(assert (= o6 o5))
(assert (= result mask))
(assert (= mask1 o6))
(assert (and (= o7 (- (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range (- (to_rep (rec__hw__dbc__xcap_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o8 (+ o7 1)))
(assert (and (= o9 o8) (in_range o8)))
(assert (= result1 (ite (= o9 32) true false)))
(assert (not (= result1 true)))
(assert (not (bvule ((_ zero_extend 32) #x00000000) (bvor (bvand ((_ zero_extend 32) temp) (bvnot mask1)) (bvshl ((_ zero_extend 32) value) ((_ int2bv 64) (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))))
(check-sat)
(exit)
