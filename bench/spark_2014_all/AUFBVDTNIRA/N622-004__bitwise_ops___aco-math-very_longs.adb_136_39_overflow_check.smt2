...
(declare-const temp___1153 us_rep)
...
(assert (= o8 (to_rep o7)))
(assert (and (= temp___1150 (+ string_index2 1)) (in_range1 (+ string_index2 1))))
(assert (and (<= (to_rep1 (first (rt number))) temp___1150) (<= temp___1150 (to_rep1 (last (rt number))))))
(assert (= o9 temp___1150))
...
(assert (and (<= (to_rep4 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) index2) (<= index2 (to_rep4 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))))
(assert (= o13 index2))
(assert (= o14 (store (elts1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) o13 o12)))
(assert (= o14 o15))
(assert (= (rt1 (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) o16))
(assert (= o17 (mk___split_fields (mk___t1 o15 o16))))
(assert (= temp___1153 (mk___rep result____split_discrs o17)))
(assert (= result4 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___1153)))
(assert (= result____split_discrs (us_split_discrs1 temp___1153)))
(assert (not (= index2 1)))
(assert (and (= o18 (- index2 1)) (in_range4 (- index2 1))))
(assert (= result5 (mk_int__ref index2)))
(assert (= index3 o18))
(assert (not (in_range1 (+ string_index2 2))))
(check-sat)
(exit)
