...
(assert (and (= o6 (- (to_rep3 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) index2)) (in_range6 (- (to_rep3 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) index2))))
(assert (= o7 (* 2 o6)))
