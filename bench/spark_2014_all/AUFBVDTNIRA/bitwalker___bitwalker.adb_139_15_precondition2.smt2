...
(assert (and (= o13 (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) o12)) (= (= o13 true) (= (nth1 (to_rep1 (select addr (div1 o12 8))) (- 7 (mod1 o12 8))) true))))
(assert (= o14 (ite o13 1 0)))
