...
(assert (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o55 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o58 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o56 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o57 (mk (to_rep aux4__first) (to_rep aux4__last))) aux4_first (+ l1 1)) (omod (omultiply (num_of_big_int x x_first (+ l1 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))
...
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= temp___703 o57)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o55 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o58 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o56 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- h2 1))) (= (oeq (num_of_big_int (mk___t o59 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true))))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (and (=> (<= 1 (- (power 2 k) 1)) (dynamic_property1 1 (- (power 2 k) 1) h2)) (and (<= 1 h2) (<= h2 (- (power 2 k) 1))))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o55 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o58 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o56 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 h2)) (= (oeq (num_of_big_int (mk___t o61 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true))))))
...
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= o62 (mk_map__ref o61))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= h3 (mk_int__ref h2))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= aux4 (mk_map__ref o61))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= a2 (mk_map__ref o60))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= h4 h2)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= o63 o61)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= a3 o60)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= o64 o62)))
...
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= o65 o63)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= a5 a3)))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= o64 (mk_map__ref o57))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= h5 (mk_int__ref h1))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= aux41 (mk_map__ref o57))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= a4 (mk_map__ref a))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= h6 h1)))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= o65 o57)))
...
(assert (= i1 o7))
(assert (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o55 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o58 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o66 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 #x00000002) (oadd (from_word64 i2) (from_word32 #x00000001))))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux41) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) #x0000000000000001) #x0000000000000020))))
...
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___742 o66))))
...
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= o70 (mk_map__ref o69)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h10 (mk_int__ref h9)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= aux3 (mk_map__ref o69)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a7 (mk_map__ref o68)))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h11 h9))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= o71 o69))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a8 o68))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= o72 o70))))
...
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= o73 o71))))
(assert (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a10 a8))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= o72 (mk_map__ref o66)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= h12 (mk_int__ref h8)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= aux31 (mk_map__ref o66)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= a9 (mk_map__ref a6)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= h13 h8))))
(assert (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= o73 o66))))
...
(assert (=> (= result2 true) (= (oeq (num_of_big_int (mk___t (let ((subject a9)) o74) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t (map__content aux31) (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1)) (num_of_big_int (mk___t (map__content aux41) (mk (to_rep aux4__first) (to_rep aux4__last))) o15 (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true)))
(assert (=> (= result2 true) (forall ((k1 Int)) (=> (and (<= (to_rep aux3__first) k1) (<= k1 (to_rep aux3__last))) (and (=> (and (<= aux3_first k1) (<= k1 (- (+ aux3_first a_last) a_first))) (= (to_rep1 (select (let ((subject aux31)) o75) k1)) (to_rep1 (select o74 (- (+ a_first k1) aux3_first))))) (=> (=> (<= aux3_first k1) (not (<= k1 (- (+ aux3_first a_last) a_first)))) (= (to_rep1 (select (let ((subject aux31)) o75) k1)) (to_rep1 (select (map__content aux31) k1)))))))))
(assert (=> (= result2 true) (= o78 (mk_map__ref o75))))
(assert (=> (= result2 true) (= h14 h12)))
(assert (=> (= result2 true) (= w9 w7)))
(assert (=> (= result2 true) (= s12 (mk_int__ref s10))))
(assert (=> (= result2 true) (= j10 j8)))
(assert (=> (= result2 true) (= aux32 (mk_map__ref o75))))
(assert (=> (= result2 true) (= a11 (mk_map__ref o74))))
(assert (=> (= result2 true) (= h15 h13)))
(assert (=> (= result2 true) (= w10 w8)))
(assert (=> (= result2 true) (= s13 s10)))
(assert (=> (= result2 true) (= j11 j9)))
(assert (=> (= result2 true) (= o79 o75)))
(assert (=> (= result2 true) (= a12 o74)))
(assert (=> (not (= result2 true)) (= result8 (mk_int__ref s1))))
(assert (=> (not (= result2 true)) (= s11 1)))
(assert (=> (not (= result2 true)) (= (oeq (num_of_big_int (mk___t o76 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t o66 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1)) (num_of_big_int (mk___t o66 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true)))
(assert (=> (not (= result2 true)) (forall ((k1 Int)) (=> (and (<= (to_rep aux3__first) k1) (<= k1 (to_rep aux3__last))) (and (=> (and (<= aux3_first k1) (<= k1 (- (+ aux3_first a_last) a_first))) (= (to_rep1 (select o77 k1)) (to_rep1 (select o76 (- (+ a_first k1) aux3_first))))) (=> (=> (<= aux3_first k1) (not (<= k1 (- (+ aux3_first a_last) a_first)))) (= (to_rep1 (select o77 k1)) (to_rep1 (select o66 k1)))))))))
(assert (=> (not (= result2 true)) (= o78 (mk_map__ref o77))))
...
(assert (=> (not (= result2 true)) (= aux32 (mk_map__ref o77))))
(assert (=> (not (= result2 true)) (= a11 (mk_map__ref o76))))
(assert (=> (not (= result2 true)) (= h15 h7)))
(assert (=> (not (= result2 true)) (= w10 w)))
(assert (=> (not (= result2 true)) (= s13 s11)))
(assert (=> (not (= result2 true)) (= j11 j1)))
(assert (=> (not (= result2 true)) (= o79 o77)))
(assert (=> (not (= result2 true)) (= a12 o76)))
(assert (and (= o49 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o50 o49) (uint_in_range1 o49)))
(assert (= o51 ((_ int2bv 64) o50)))
(assert (= o52 (bvadd o51 #x0000000000000001)))
(assert (= o53 (bvmul o52 #x0000000000000020)))
(assert (= o54 (ite (bvult i2 o53) true false)))
(assert (= o46 (from_word32 #x00000001)))
(assert (= o45 (from_word64 i2)))
(assert (= o47 (oadd o45 o46)))
(assert (= o44 (from_integer (int__content s12))))
(assert (= o48 (ole o44 o47)))
(assert (and (= o39 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o40 (- o39 1)))
(assert (and (= o41 o40) (in_range1 o40)))
(assert (= o42 (ite (<= n o41) true false)))
(assert (= result9 (ite (<= 0 n) o42 false)))
(assert (= (= o43 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux41) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
...
(assert (= o27 (from_word32 #x00000001)))
(assert (= o25 (from_integer (int__content s12))))
(assert (= o24 (from_word64 i2)))
(assert (= o26 (osubtract o24 o25)))
(assert (= o28 (oadd o26 o27)))
(assert (= o23 (from_word32 #x00000002)))
(assert (= o29 (oexpon__2 o23 o28)))
(assert (and (= o18 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o19 (+ o18 1)))
(assert (and (= o20 o19) (in_range1 o19)))
(assert (and (= o21 o20) (in_range2 o20)))
(assert (= o22 (num_of_big_int e e_first o21)))
(assert (= o30 (odivide o22 o29)))
(assert (and (= o16 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o17 (num_of_big_int x x_first o16)))
(assert (= o31 (oexpon__2 o17 o30)))
