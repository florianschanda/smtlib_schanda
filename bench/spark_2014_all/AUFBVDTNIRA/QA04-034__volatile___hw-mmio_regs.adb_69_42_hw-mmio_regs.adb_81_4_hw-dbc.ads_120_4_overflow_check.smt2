...
(define-fun word_t__ref___5__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_733 (_ BitVec 8)) (temp___is_init_729 Bool) (temp___skip_constant_730 Bool) (temp___do_toplevel_731 Bool) (temp___do_typ_inv_732 Bool)) Bool true)
...
(declare-const hw__dbc__cap_regs__write_i__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__cap_regs__write_i__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__cap_regs__write_i__off__assume off))
