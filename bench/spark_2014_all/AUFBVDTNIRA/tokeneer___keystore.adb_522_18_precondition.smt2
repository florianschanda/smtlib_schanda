...
(declare-fun user_eq20 (returnvaluet returnvaluet) Bool)
(declare-const dummy20 returnvaluet)
...
(define-fun dynamic_invariant2 ((temp___expr_1684 Int) (temp___is_init_1680 Bool) (temp___skip_constant_1681 Bool) (temp___do_toplevel_1682 Bool) (temp___do_typ_inv_1683 Bool)) Bool (=> (or (= temp___is_init_1680 true) (<= 0 28)) (in_range12 temp___expr_1684)))
...
(assert (forall ((x unsigned32t)) (! (in_range13 (to_rep9 x)) :pattern ((to_rep9 x)))))
(assert (forall ((x Int)) (! (=> (in_range13 x) (= (to_rep9 (of_rep9 x)) x)) :pattern ((to_rep9 (of_rep9 x))))))
(declare-sort maskt 0)
(define-fun in_range14 ((x (_ BitVec 32))) Bool (and (bvule #x00000000 x) (bvule x #x0000000F)))
...
(assert (forall ((x (_ BitVec 32))) (! (let ((y (bvurem x #x00000010))) (=> (in_range14 y) (= (to_rep10 (of_rep10 x)) y))) :pattern ((to_rep10 (of_rep10 x))))))
...
(assert true)
(define-fun dynamic_invariant4 ((temp___expr_244 Int) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool) (temp___do_typ_inv_243 Bool)) Bool (=> (or (= temp___is_init_240 true) (<= 0 4294967295)) (in_range13 temp___expr_244)))
...
(declare-const nullissuer us_rep3)
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__keystore__optionalprivatekeyt__ispresent Bool) (rec__keystore__optionalprivatekeyt__owner us_rep3)))))
(define-fun us_split_fields_IsPresent__projection ((a us_split_fields8)) Bool (rec__keystore__optionalprivatekeyt__ispresent a))
(define-fun us_split_fields_Owner__projection ((a us_split_fields8)) us_rep3 (rec__keystore__optionalprivatekeyt__owner a))
...
(declare-fun temp___String_Literal_1780 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1780 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1780 us_void_param) 2)) 110)) (= (to_rep (select (temp___String_Literal_1780 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_1780 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1780 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1780 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_1780 us_void_param) 7)) 108)) (= (to_rep (select (temp___String_Literal_1780 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1780 us_void_param) 9)) 122)) (= (to_rep (select (temp___String_Literal_1780 us_void_param) 10)) 101)) :pattern ((temp___String_Literal_1780 us_void_param)))))
...
(assert (forall ((temp___162 Int)) (=> (dynamic_invariant6 temp___162 true true true true) (forall ((temp___163 Int)) (= (to_rep (select (cryptotypes__blankname__aggregate_def temp___162) temp___163)) temp___162)))))
...
(declare-const rliteral2 issueridt)
(assert (= (issueridtqtint rliteral2) 0))
(declare-const rliteral3 namecountt)
(assert (= (namecounttqtint rliteral3) 0))
(assert (= nullissuer (mk___rep2 (mk___split_fields2 rliteral2 rliteral3 blankname))))
...
(assert (forall ((temp___1281 Int)) (=> (dynamic_invariant17 temp___1281 true true true true) (forall ((temp___1282 Int)) (= (select (temp_____aggregate_def_1279 temp___1281) temp___1282) rliteral4)))))
(define-fun dynamic_invariant18 ((temp___expr_1618 (_ BitVec 32)) (temp___is_init_1614 Bool) (temp___skip_constant_1615 Bool) (temp___do_toplevel_1616 Bool) (temp___do_typ_inv_1617 Bool)) Bool (=> (or (= temp___is_init_1614 true) (bvule #x00000000 #x0000000F)) (in_range14 temp___expr_1618)))
...
(declare-const rliteral5 unsigned32t)
(assert (= (unsigned32tqtint rliteral5) 0))
...
(declare-const temp___1781 us_t1)
...
(declare-const theprivatekey__split_fields7 us_split_fields6)
...
(assert (= (mk___rep2 (mk___split_fields2 rliteral2 rliteral3 blankname)) nullissuer))
...
(assert (=> (<= 0 4294967295) (in_range13 theprivatekeyh)))
(assert (= (to_rep10 o) #x00000001))
(assert (= o o1))
(assert (= nullissuer (mk___rep2 (mk___split_fields2 o2 o3 o4))))
(assert (= rliteral5 o5))
(assert (= rliteral5 o6))
(assert (= (distinct 0 0) o7))
(assert (= keystore__init__theprivatekey__assume o1))
(assert (= keystore__init__theprivatekey__assume1 o2))
(assert (= keystore__init__theprivatekey__assume2 o3))
(assert (= keystore__init__theprivatekey__assume3 o4))
(assert (= keystore__init__theprivatekey__assume4 o5))
(assert (= keystore__init__theprivatekey__assume5 o6))
(assert (= keystore__init__theprivatekey__assume6 o7))
(assert (= result (mk___split_fields__ref3 (mk___split_fields3 theprivatekey__split_fields (mk___rep2 (mk___split_fields2 theprivatekey__split_fields1 theprivatekey__split_fields2 theprivatekey__split_fields3)) theprivatekey__split_fields4 theprivatekey__split_fields5 theprivatekey__split_fields6))))
(assert (= theprivatekey__split_fields7 (mk___split_fields3 keystore__init__theprivatekey__assume (mk___rep2 (mk___split_fields2 keystore__init__theprivatekey__assume1 keystore__init__theprivatekey__assume2 keystore__init__theprivatekey__assume3)) keystore__init__theprivatekey__assume4 keystore__init__theprivatekey__assume5 keystore__init__theprivatekey__assume6)))
(assert (in_range12 retval1))
(assert (= (select issystem retval1) true))
(assert (dynamic_property1 1 2147483647 1 10))
(assert (= temp___1781 (mk___t1 (temp___String_Literal_1780 Tuple0) (mk1 1 10))))
(assert (dynamic_predicate temp___1781))
(assert (= o8 temp___1781))
(assert (= o9 (convertretvaltotext retval1 o8)))
(assert (= o10 (mk___t o9 (mk 1 150))))
(assert (not (= (to_rep1 (first (rt o10))) 1)))
(check-sat)
(exit)
