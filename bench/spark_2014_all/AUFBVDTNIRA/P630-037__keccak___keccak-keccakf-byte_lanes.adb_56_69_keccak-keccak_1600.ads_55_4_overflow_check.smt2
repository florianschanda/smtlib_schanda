...
(assert (and (= (mod2 offset2 8) 0) (= (+ offset2 (div1 (+ remaining_bits2 7) 8)) initial_byte_len1)))
(assert (and (and (and (and (=> (bvule #x00 #x04) (in_range4 x2)) (=> (bvule #x00 #x04) (in_range5 y2))) (=> (<= 0 2147483647) (in_range2 remaining_bits2))) (=> (<= 0 2147483647) (in_range2 offset2))) (<= 64 remaining_bits2)))
(assert (= temp___797 result5))
(assert (= temp___7971 offset2))
(assert (= temp___796 result6))
(assert (= temp___7961 remaining_bits2))
(assert (= lane result7))
(assert (= lane1 #x0000000000000000))
(assert (= result8 (mk_int__ref i)))
(assert (= i1 0))
(assert (and (= o8 (* i1 8)) (in_range1 (* i1 8))))
(assert (and (= o9 o8) (in_range2 o8)))
(assert (= o10 ((_ int2bv 64) o9)))
(assert (and (= o3 (+ (to_rep1 (first (rt data))) offset2)) (in_range1 (+ (to_rep1 (first (rt data))) offset2))))
(assert (= o4 (+ o3 i1)))
(assert (and (= temp___785 o4) (in_range1 o4)))
(assert (and (<= (to_rep1 (first (rt data))) temp___785) (<= temp___785 (to_rep1 (last (rt data))))))
(assert (= o5 temp___785))
...
(assert (= i2 1))
(assert (and (= o14 (* i2 8)) (in_range1 (* i2 8))))
(assert (and (= o15 o14) (in_range2 o14)))
(assert (= o16 ((_ int2bv 64) o15)))
(assert (not (in_range1 (+ (to_rep1 (first (rt data))) offset2))))
(check-sat)
(exit)
