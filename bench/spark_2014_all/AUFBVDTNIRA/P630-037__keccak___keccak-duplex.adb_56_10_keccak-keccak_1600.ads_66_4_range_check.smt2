...
(assert (=> (<= (to_rep (first (rt in_data))) temp___1123) (and (and (<= (to_rep (first (rt in_data))) (to_rep (first (rt in_data)))) (<= (to_rep (first (rt in_data))) (to_rep (last (rt in_data))))) (and (<= (to_rep (first (rt in_data))) temp___1123) (<= temp___1123 (to_rep (last (rt in_data))))))))
(assert (= o2 (elts in_data)))
(assert (= o2 temp___1124))
(assert (= (mk2 (to_rep (first (rt in_data))) temp___1123) temp___11241))
(assert (= (ite (<= (to_rep (first4 temp___11241)) (to_rep (last4 temp___11241))) (+ (- (to_rep (last4 temp___11241)) (to_rep (first4 temp___11241))) 1) 0) (ite (<= 0 (- num_bytes 1)) (+ (- (- num_bytes 1) 0) 1) 0)))
(assert (= (slide temp___1124 (to_rep (first4 temp___11241)) 0) temp___1125))
(assert (= (mk1 0 (- num_bytes 1)) temp___11251))
(assert (<= 0 (- num_bytes 1)))
(assert (not (<= 0 199)))
(check-sat)
(exit)
