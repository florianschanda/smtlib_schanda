...
(assert (= (= result1 true) (forall ((i1 Int)) (=> (and (<= 0 i1) (<= i1 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (=> (not (= i1 left)) (= (= (nth8_stream (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) i1) true) (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i1) true)))))))
(assert (= result1 true))
