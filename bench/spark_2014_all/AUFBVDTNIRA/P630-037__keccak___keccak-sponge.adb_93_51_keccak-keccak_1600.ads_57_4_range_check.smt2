...
(assert (< 0 free_bits_in_block1))
(assert (= result8 (mk_int__ref block_offset)))
(assert (= block_offset1 (div1 (to_rep5 ctx__split_fields2) 8)))
(assert (= block_offset1 r81s))
(assert (in_range2 r81s))
(assert (and (= keccak__keccak_1600__sponge__absorb__R82s__assume (+ block_offset1 (- free_bytes_in_block1 1))) (in_range1 (+ block_offset1 (- free_bytes_in_block1 1)))))
(assert (= keccak__keccak_1600__sponge__absorb__R82s__assume r82s))
(assert (in_range1 r82s))
(assert (and (= keccak__keccak_1600__sponge__absorb__R85s__assume (+ (to_rep1 (first (rt data))) (- free_bytes_in_block1 1))) (in_range1 (+ (to_rep1 (first (rt data))) (- free_bytes_in_block1 1)))))
(assert (= keccak__keccak_1600__sponge__absorb__R85s__assume r85s))
(assert (in_range1 r85s))
(assert (=> (<= (to_rep1 (first (rt data))) r85s) (and (and (<= (to_rep1 (first (rt data))) (to_rep1 (first (rt data)))) (<= (to_rep1 (first (rt data))) (to_rep1 (last (rt data))))) (and (<= (to_rep1 (first (rt data))) r85s) (<= r85s (to_rep1 (last (rt data))))))))
(assert (= o10 (elts data)))
(assert (= temp___886 (mk___t4 o10 (mk4 (to_rep1 (first (rt data))) r85s))))
(assert (= (ite (<= (to_rep1 (first8 (rt4 temp___886))) (to_rep1 (last8 (rt4 temp___886)))) (+ (- (to_rep1 (last8 (rt4 temp___886))) (to_rep1 (first8 (rt4 temp___886)))) 1) 0) (ite (<= r81s r82s) (+ (- r82s r81s) 1) 0)))
(assert (= temp___887 (mk___t3 (slide1 (elts4 temp___886) (to_rep1 (first8 (rt4 temp___886))) r81s) (mk3 r81s r82s))))
(assert (=> (<= r81s r82s) (and (and (<= 0 r81s) (<= r81s 199)) (and (<= 0 r82s) (<= r82s 199)))))
(assert (= o11 ctx__split_fields1))
(assert (= temp___889 (mk___t3 o11 (mk3 r81s r82s))))
(assert (= (ite (<= (to_rep1 (first6 (rt3 temp___887))) (to_rep1 (last6 (rt3 temp___887)))) (+ (- (to_rep1 (last6 (rt3 temp___887))) (to_rep1 (first6 (rt3 temp___887)))) 1) 0) (ite (<= (to_rep1 (first6 (rt3 temp___889))) (to_rep1 (last6 (rt3 temp___889)))) (+ (- (to_rep1 (last6 (rt3 temp___889))) (to_rep1 (first6 (rt3 temp___889)))) 1) 0)))
(assert (= temp___891 temp___887))
(assert (forall ((temp___892 Int)) (ite (and (<= r81s temp___892) (<= temp___892 r82s)) (= (select o12 temp___892) (select (elts3 temp___891) temp___892)) (= (select o12 temp___892) (select ctx__split_fields1 temp___892)))))
(assert (= o13 (mk___split_fields ctx__split_fields o12 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5)))
(assert (= temp___894 (mk___rep o13)))
(assert (= result9 (mk___split_fields__ref (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))
(assert (= ctx__split_fields6 (us_split_fields1 temp___894)))
(assert (and (= o14 (+ offset1 free_bytes_in_block1)) (in_range1 (+ offset1 free_bytes_in_block1))))
(assert (= result10 (mk_int__ref offset1)))
(assert (= offset2 o14))
(assert (and (= o15 (- remaining_bytes1 free_bytes_in_block1)) (in_range1 (- remaining_bytes1 free_bytes_in_block1))))
