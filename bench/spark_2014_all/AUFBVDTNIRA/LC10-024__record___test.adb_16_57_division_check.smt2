...
(declare-const temp___203 (_ BitVec 8))
...
(assert (and (= o5 (mod1 (to_rep s__split_fields3) 5)) (in_range_int (mod1 (to_rep s__split_fields3) 5))))
(assert (= o6 ((_ int2bv 8) o5)))
(assert (= temp___203 (bvadd (to_rep1 s__split_fields4) o6)))
(assert (not (not (= 5 0))))
(check-sat)
(exit)
