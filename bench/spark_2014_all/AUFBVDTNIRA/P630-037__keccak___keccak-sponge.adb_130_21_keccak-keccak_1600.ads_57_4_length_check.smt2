...
(assert (not (= (ite (<= (to_rep1 (first16 (rt8 temp___914))) (to_rep1 (last16 (rt8 temp___914)))) (+ (- (to_rep1 (last16 (rt8 temp___914))) (to_rep1 (first16 (rt8 temp___914)))) 1) 0) (ite (<= 0 r95s) (+ (- r95s 0) 1) 0))))
(check-sat)
(exit)
