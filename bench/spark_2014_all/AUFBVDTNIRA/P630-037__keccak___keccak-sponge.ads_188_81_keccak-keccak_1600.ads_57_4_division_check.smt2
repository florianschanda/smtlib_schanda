...
(assert (and (= o14 (rate_of (mk___rep (us_split_fields__content ctx__split_fields32)))) (and (in_range3 o14) (and (= o14 (* (to_rep5 (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields__content ctx__split_fields32))) 8)) (< o14 1600)))))
(assert (and (= o15 (in_queue_bit_length (mk___rep (us_split_fields__content ctx__split_fields32)))) (and (in_range2 o15) (and (= o15 (to_rep4 (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields__content ctx__split_fields32)))) (< o15 1600)))))
