...
(assert (<= divisor_index1 r130b))
(assert (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields2) true true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r130b))))
...
(assert (= result3 (mk_t__ref1 product1)))
(assert (= product2 o5))
(assert (and (= o6 (shift_right product2 8)) (= o6 (bvudiv product2 (ite (< 8 65536) (bvshl #x0001 ((_ int2bv 16) 8)) #x0000)))))
(assert (= result4 (mk_t__ref1 carry2)))
(assert (= carry3 o6))
(assert (= result5 (mk_t__ref1 temporary_digit)))
(assert (= temporary_digit1 (bvand product2 #x00FF)))
(assert (and (= o7 (+ j divisor_index2)) (in_range2 (+ j divisor_index2))))
(assert (= temp___1630 (- o7 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1630) (<= temp___1630 (to_rep2 (last3 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields2)))))))
(assert (= o8 temp___1630))
(assert (= o9 (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields2)) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 ((_ zero_extend 8) o10)))
(assert (= result6 (ite (bvuge o11 (bvadd temporary_digit1 current_borrow2)) true false)))
(assert (=> (= result6 true) (= result7 (mk_t__ref1 future_borrow))))
(assert (=> (= result6 true) (= future_borrow1 #x0000)))
(assert (=> (not (= result6 true)) (= result8 (mk_t__ref1 future_borrow))))
(assert (=> (not (= result6 true)) (= future_borrow2 #x0001)))
(assert (=> (not (= result6 true)) (= future_borrow1 future_borrow2)))
(assert (and (= o13 (+ j divisor_index2)) (in_range2 (+ j divisor_index2))))
(assert (= temp___1632 (- o13 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1632) (<= temp___1632 (to_rep2 (last3 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields2)))))))
(assert (= o14 temp___1632))
(assert (= o15 (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields2)) o14)))
(assert (= o16 (to_rep o15)))
(assert (= o17 ((_ zero_extend 8) o16)))
(assert (= o18 (bvsub o17 temporary_digit1)))
(assert (= o19 (bvsub o18 current_borrow2)))
(assert (= o20 (bvand o19 #x00FF)))
(assert (= o21 o20))
(assert (= o22 ((_ extract 7 0) o21)))
(assert (= (to_rep o23) o22))
(assert (and (= o12 (+ j divisor_index2)) (in_range2 (+ j divisor_index2))))
(assert (= temp___1634 (- o12 1)))
(assert (not (<= temp___1634 (to_rep2 (last3 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields2)))))))
(check-sat)
(exit)
