...
(assert (= result1 i))
(assert (= i1 0))
(assert (and (= o3 (power 256 i1)) (in_range2 (power 256 i1))))
(assert (and (= o4 o3) (uint_in_range1 o3)))
(assert (= o5 ((_ int2bv 32) o4)))
(assert (and (= temp___749 (- (to_rep1 (last (rt buffer))) i1)) (in_range1 (- (to_rep1 (last (rt buffer))) i1))))
(assert (and (<= (to_rep1 (first (rt buffer))) temp___749) (<= temp___749 (to_rep1 (last (rt buffer))))))
(assert (= o temp___749))
(assert (= o1 (select (elts buffer) o)))
(assert (= o2 (to_rep o1)))
(assert (= o6 ((_ zero_extend 24) o2)))
(assert (= o7 (bvmul o6 o5)))
(assert (= o8 (bvadd value1 o7)))
(assert (= result2 value1))
(assert (= value2 o8))
(assert (= result3 i1))
(assert (= i2 1))
(assert (and (= o9 (power 256 i2)) (in_range2 (power 256 i2))))
(assert (and (= o10 o9) (uint_in_range1 o9)))
(assert (= o11 ((_ int2bv 32) o10)))
(assert (not (in_range1 (- (to_rep1 (last (rt buffer))) i2))))
(check-sat)
(exit)
