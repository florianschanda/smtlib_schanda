...
(assert (= temporary_21 (bvurem temporary_11 #x00000100)))
(assert (= (to_rep1 o) ((_ extract 7 0) temporary_21)))
(assert (and (<= (to_rep data__first) (+ position (- 4 i1))) (<= (+ position (- 4 i1)) (to_rep data__last))))
(assert (= o1 (+ position (- 4 i1))))
(assert (= o2 (store data o1 o)))
(assert (= (mk_map__ref result3) (mk_map__ref data)))
(assert (= data1 o2))
(assert (= temporary_11 result4))
(assert (= temporary_12 (bvudiv temporary_11 #x00000100)))
(assert (= i1 result5))
(assert (= i2 2))
(assert (= temporary_21 result6))
(assert (= temporary_22 (bvurem temporary_12 #x00000100)))
(assert (= (to_rep1 o3) ((_ extract 7 0) temporary_22)))
(assert (and (<= (to_rep data__first) (+ position (- 4 i2))) (<= (+ position (- 4 i2)) (to_rep data__last))))
(assert (= o4 (+ position (- 4 i2))))
