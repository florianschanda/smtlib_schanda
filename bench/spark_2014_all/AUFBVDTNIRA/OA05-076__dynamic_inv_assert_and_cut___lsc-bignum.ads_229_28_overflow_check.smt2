...
(assert (= o8 (+ x_first o7)))
(assert (and (= o9 o8) (in_range1 o8)))
(assert (= o10 (ite (<= o9 (to_rep (last (rt x)))) true false)))
(assert (and (= o4 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o5 (+ x_first o4)))
(assert (and (= o6 o5) (in_range1 o5)))
(assert (= o11 (ite (<= (to_rep (first (rt x))) o6) true false)))
...
(assert (= o3 (ite (<= o2 (to_rep (last (rt m)))) true false)))
