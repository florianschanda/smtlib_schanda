...
(assert (and (= o41 (- j3 s3)) (in_range1 (- j3 s3))))
(assert (= o42 (- o41 1)))
(assert (and (= o43 o42) (in_range1 o42)))
(assert (and (= o44 o43) (in_range2 o43)))
(assert (= o40 (from_word32 #x00000002)))
(assert (= o45 (oexpon o40 o44)))
(assert (= o39 (from_word32 w2)))
(assert (= o46 (omultiply o39 o45)))
...
(assert (= result6 (ite (<= 0 n) o37 false)))
(assert (= (= o38 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux41) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o30 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o31 (num_of_big_int m m_first o30)))
(assert (and (= o27 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o26 (base Tuple0)) (= o26 (oexpon (from_word32 #x00000002) 32))))
(assert (= o28 (oexpon o26 o27)))
(assert (= o21 (from_word32 #x00000001)))
(assert (= o20 (from_word64 i2)))
(assert (= o22 (oadd o20 o21)))
(assert (= o19 (from_word32 #x00000002)))
(assert (= o23 (oexpon__2 o19 o22)))
(assert (and (= o14 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o15 (+ o14 1)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (and (= o17 o16) (in_range2 o16)))
(assert (= o18 (num_of_big_int e e_first o17)))
(assert (= o24 (odivide o18 o23)))
(assert (and (= o12 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o13 (num_of_big_int x x_first o12)))
(assert (= o25 (oexpon__2 o13 o24)))
(assert (= o29 (omultiply o25 o28)))
(assert (= o32 (omod o29 o31)))
(assert (and (= o10 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o11 (num_of_big_int (mk___t o88 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o10)))
(assert (= o33 (oeq o11 o32)))
(assert (and (= o8 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o9 (num_of_big_int m m_first o8)))
