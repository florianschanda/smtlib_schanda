...
(assert (= offset2 o31))
(assert (and (= o32 (- remaining1 bytes_to_squeeze2)) (in_range1 (- remaining1 bytes_to_squeeze2))))
(assert (and (= o33 o32) (in_range2 o32)))
(assert (= result13 (mk_int__ref remaining1)))
(assert (= remaining2 o33))
(assert (<= (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields11)) (to_rep4 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields11))))
...
(assert (= (- (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields12)) 1) r148s))
(assert (in_range1 r148s))
(assert (=> (<= 0 r148s) (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r148s) (<= r148s 199)))))
(assert (= o34 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields12)))
(assert (= keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl2 (mk___t5 o34 (mk5 0 r148s))))
(assert (= (to_rep o36) (to_rep (last10 (rt5 keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl2)))))
(assert (= (to_rep o35) (to_rep (first10 (rt5 keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl2)))))
(assert (not (<= (ite (<= (to_rep o35) (to_rep o36)) (+ (- (to_rep o36) (to_rep o35)) 1) 0) 200)))
(check-sat)
(exit)
