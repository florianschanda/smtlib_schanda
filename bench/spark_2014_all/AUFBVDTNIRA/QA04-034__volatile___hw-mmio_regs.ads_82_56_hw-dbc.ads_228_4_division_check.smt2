...
(assert (and (= o9 (+ (to_rep (rec__hw__dbc__s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range1 (+ (to_rep (rec__hw__dbc__s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o10 (- o9 (to_rep (rec__hw__dbc__s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
...
(assert (and (= o4 (- (to_rep (rec__hw__dbc__s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range1 (- (to_rep (rec__hw__dbc__s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o5 (+ o4 1)))
(assert (and (= o7 o5) (in_range1 o5)))
(assert (= o8 (ite (<= o7 o6) true false)))
(assert (and (= o1 (+ byte_offset (to_rep (rec__hw__dbc__s_regs__t__byte_offset (us_split_fields1 (select regs idx)))))) (in_range1 (+ byte_offset (to_rep (rec__hw__dbc__s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(assert (= o2 (div1 o1 4)))
