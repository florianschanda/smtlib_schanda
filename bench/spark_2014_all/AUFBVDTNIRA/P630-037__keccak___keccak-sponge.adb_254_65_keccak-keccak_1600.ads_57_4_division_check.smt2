...
(assert (and (= o22 (rate_of (mk___rep ctx__split_fields7))) (and (in_range3 o22) (and (= o22 (* (to_rep5 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields7)) 8)) (< o22 1600)))))
(assert (= o23 (ite (= o22 initial_rate1) true false)))
(assert (and (= o19 (rate_of (mk___rep ctx__split_fields7))) (and (in_range3 o19) (and (= o19 (* (to_rep5 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields7)) 8)) (< o19 1600)))))
(assert (and (= o20 (in_queue_bit_length (mk___rep ctx__split_fields7))) (and (in_range2 o20) (and (= o20 (to_rep4 (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields7))) (< o20 1600)))))
...
(assert (and (= o16 (in_queue_bit_length (mk___rep ctx__split_fields7))) (and (in_range2 o16) (and (= o16 (to_rep4 (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields7))) (< o16 1600)))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
