...
(assert (forall ((x tdigit_index_typeB)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x tdigit_index_typeB)) (! (in_range5 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun bool_eq4 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__very_longs__very_long__octet_length (us_split_discrs1 a))) (to_rep2 (rec__very_longs__very_long__octet_length (us_split_discrs1 b)))) (= (bool_eq3 (rec__very_longs__very_long__long_digits (us_split_fields1 a)) (rec__very_longs__very_long__long_digits (us_split_fields1 b))) true)) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_223 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool) (temp___do_typ_inv_222 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= 1 2147483647)) (in_range4 temp___expr_223)))
(define-fun dynamic_invariant4 ((temp___expr_243 us_rep) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool (let ((temp___244 (rec__very_longs__very_long__octet_length (us_split_discrs1 temp___expr_243)))) (and (dynamic_property2 1 (to_rep2 temp___244) (first3 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_243))) (last3 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_243)))) (and (= (first3 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_243))) 1) (= (last3 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_243))) (to_rep2 temp___244))))))
...
(declare-datatypes () ((tS32bP1__ref (mk_tS32bP1__ref (tS32bP1__content tdigit_index_typeB)))))
(define-fun tS32bP1__ref___projection ((a tS32bP1__ref)) tdigit_index_typeB (tS32bP1__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t34b__ref (mk_t34b__ref (t34b__content tdigit_index_typeB)))))
(define-fun t34b__ref___projection ((a t34b__ref)) tdigit_index_typeB (t34b__content a))
(declare-sort t3 0)
...
(declare-fun temp_____aggregate_def_912 ((_ BitVec 8) Int Int) us_t3)
...
(assert (forall ((temp___914 (_ BitVec 8))) (forall ((temp___915 Int) (temp___916 Int)) (let ((temp___913 (temp_____aggregate_def_912 temp___914 temp___915 temp___916))) (=> (dynamic_invariant2 temp___914 true true true true) (and (=> (dynamic_property7 1 2147483647 temp___915 temp___916) (and (= (first7 temp___913) temp___915) (= (last7 temp___913) temp___916))) (forall ((temp___917 Int)) (= (to_rep4 (select (to_array3 temp___913) temp___917)) temp___914))))))))
(define-fun dynamic_invariant7 ((temp___expr_237 us_t4) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool) (temp___do_typ_inv_236 Bool)) Bool (=> (not (= temp___skip_constant_234 true)) (dynamic_property7 1 2147483647 (first9 temp___expr_237) (last9 temp___expr_237))))
(define-fun dynamic_invariant8 ((temp___expr_451 us_t2) (temp___is_init_447 Bool) (temp___skip_constant_448 Bool) (temp___do_toplevel_449 Bool) (temp___do_typ_inv_450 Bool)) Bool (=> (not (= temp___skip_constant_448 true)) (and (dynamic_property4 1 r33b (first5 temp___expr_451) (last5 temp___expr_451)) (and (= (first5 temp___expr_451) 1) (= (last5 temp___expr_451) r33b)))))
...
(declare-const temp___919 (Array Int octet))
(declare-const temp___9191 t3)
(declare-const temp___920 (Array Int octet))
(declare-const temp___9201 t2)
(declare-const temp___922 (Array Int octet))
(declare-const temp___9221 t2)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___924 digit_index_type)
(declare-const temp___9241 (Array Int octet))
(declare-const temp___9242 t1)
...
(assert (= (length number) (* 2 (to_rep2 (rec__very_longs__very_long__octet_length result____split_discrs)))))
(assert (=> (<= 1 2147483647) (in_range4 index)))
(assert (=> (<= 1 2147483647) (in_range2 string_index)))
(assert (= (to_rep2 (rec__very_longs__very_long__octet_length result____split_discrs)) r33b))
(assert (in_range4 r33b))
(assert (= (to_rep3 (first6 (rt3 (temp_____aggregate_def_912 #x00 1 r33b)))) 1))
(assert (= (to_rep3 (last6 (rt3 (temp_____aggregate_def_912 #x00 1 r33b)))) r33b))
(assert (= (mk___t3 temp___919 temp___9191) (temp_____aggregate_def_912 #x00 1 r33b)))
(assert (= (ite (<= (to_rep3 (first6 temp___9191)) (to_rep3 (last6 temp___9191))) (+ (- (to_rep3 (last6 temp___9191)) (to_rep3 (first6 temp___9191))) 1) 0) (ite (<= 1 r33b) (+ (- r33b 1) 1) 0)))
(assert (= temp___919 temp___920))
(assert (= (mk2 (to_rep3 (first6 temp___9191)) (to_rep3 (last6 temp___9191))) temp___9201))
(assert (= (ite (<= (to_rep3 (first4 temp___9201)) (to_rep3 (last4 temp___9201))) (+ (- (to_rep3 (last4 temp___9201)) (to_rep3 (first4 temp___9201))) 1) 0) (ite (<= (to_rep3 (first2 result____split_fields1)) (to_rep3 (last2 result____split_fields1))) (+ (- (to_rep3 (last2 result____split_fields1)) (to_rep3 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t2 temp___922 temp___9221) (mk___t2 temp___920 temp___9201)))
(assert (= temp___922 o))
(assert (= (mk1 (to_rep3 (first4 temp___9221)) (to_rep3 (last4 temp___9221))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___924)))
(assert (= temp___9241 o2))
(assert (= temp___9242 o3))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields (mk___t1 temp___9241 temp___9242))))
(assert (= result____split_discrs (mk___split_discrs temp___924)))
...
(assert (= string_index2 (+ (* 2 (- (to_rep3 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) index2)) 1)))
...
(assert (and (= o6 (- (to_rep3 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) index2)) (in_range5 (- (to_rep3 (last2 (rt1 (rec__very_longs__very_long__long_digits result____split_fields3)))) index2))))
(assert (= o7 (* 2 o6)))
(assert (and (= o8 o7) (in_range5 o7)))
(assert (= o9 (+ o8 1)))
(assert (not (in_range5 o9)))
(check-sat)
(exit)
