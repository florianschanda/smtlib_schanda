...
(assert (=> (< (mod2 bit_len 8) 256) (= o2 (bvshl #x01 ((_ int2bv 8) (mod2 bit_len 8))))))
(assert (=> (not (< (mod2 bit_len 8) 256)) (= o2 #x00)))
(assert (= o3 (bvsub o2 #x01)))
(assert (and (<= (to_rep data__first) (to_rep data__last)) (<= (to_rep data__last) (to_rep data__last))))
(assert (= o (to_rep data__last)))
(assert (= o1 (select o7 o)))
(assert (= o4 (to_rep1 o1)))
(assert (= o5 (bvand o4 o3)))
(assert (= (to_rep1 o6) o5))
(assert (not (<= (to_rep data__first) (to_rep data__last))))
(check-sat)
(exit)
