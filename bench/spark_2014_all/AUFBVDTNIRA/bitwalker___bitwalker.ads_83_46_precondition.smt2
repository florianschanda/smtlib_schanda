...
(declare-const o6 (Array Int unsigned_8))
(declare-const i Int)
...
(assert (and (= o3 (pokebit8 o2 (mod1 left 8) flag)) (and (forall ((i1 Int)) (=> (and (<= 0 i1) (<= i1 7)) (=> (not (= i1 (- 7 (mod1 left 8)))) (= (= (nth o3 i1) true) (= (nth o2 i1) true))))) (= (= (nth o3 (- 7 (mod1 left 8))) true) (= flag true)))))
...
(assert (= addr1 addr2))
(assert (= addr3 addr1))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o7 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o7 0)))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (= o9 (* 8 o8)))
(assert (= o10 (- o9 1)))
(assert (= o11 (ite (<= i o10) true false)))
(assert (= result1 (ite (<= 0 i) o11 false)))
(assert (= result1 true))
(assert (not (= i left)))
