...
(define-fun dynamic_invariant1 ((temp___expr_853 (_ BitVec 64)) (temp___is_init_849 Bool) (temp___skip_constant_850 Bool) (temp___do_toplevel_851 Bool) (temp___do_typ_inv_852 Bool)) Bool true)
...
(assert (= o7 (ite (<= o6 64) true false)))
