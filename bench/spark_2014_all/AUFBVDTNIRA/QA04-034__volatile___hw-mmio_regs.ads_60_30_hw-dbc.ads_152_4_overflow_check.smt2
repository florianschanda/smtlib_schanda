...
(assert (and (= o (- (to_rep (rec__hw__dbc__legacy_support_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range1 (- (to_rep (rec__hw__dbc__legacy_support_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o1 (+ o 1)))
(assert (and (= o2 o1) (in_range1 o1)))
(assert (= o3 (ite (<= o2 32) true false)))
