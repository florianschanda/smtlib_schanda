...
(assert (= o34 (+ x_first o33)))
(assert (and (= o35 o34) (in_range1 o34)))
(assert (= o36 (ite (<= o35 (to_rep (last (rt x)))) true false)))
(assert (and (= o30 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o31 (+ x_first o30)))
(assert (and (= o32 o31) (in_range1 o31)))
(assert (= o37 (ite (<= (to_rep (first (rt x))) o32) true false)))
(assert (= result (ite (= o37 true) o36 false)))
(assert (= result true))
...
(assert (= o26 (+ m_first o25)))
(assert (and (= o27 o26) (in_range1 o26)))
(assert (= o28 (ite (<= o27 (to_rep (last (rt m)))) true false)))
(assert (and (= o22 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o23 (+ m_first o22)))
(assert (and (= o24 o23) (in_range1 o23)))
(assert (= o29 (ite (<= (to_rep (first (rt m))) o24) true false)))
(assert (= result1 (ite (= o29 true) o28 false)))
(assert (= result1 true))
...
(assert (= o18 (+ aux1_first o17)))
(assert (and (= o19 o18) (in_range1 o18)))
(assert (= o20 (ite (<= o19 (to_rep aux1__last)) true false)))
(assert (and (= o14 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o15 (+ aux1_first o14)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (= o21 (ite (<= (to_rep aux1__first) o16) true false)))
...
(assert (= o10 (+ aux2_first o9)))
(assert (and (= o11 o10) (in_range1 o10)))
(assert (= o12 (ite (<= o11 (to_rep aux2__last)) true false)))
(assert (and (= o6 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o7 (+ aux2_first o6)))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (= o13 (ite (<= (to_rep aux2__first) o8) true false)))
(assert (= result3 (ite (= o13 true) o12 false)))
(assert (= result3 true))
...
(assert (= o5 (ite (<= o4 (to_rep aux3__last)) true false)))
