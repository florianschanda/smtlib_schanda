...
(assert (and (= o1 (+ (to_rep (rec__hw__dbc__s_regs__t__msb (us_split_fields1 (select regs idx)))) 1)) (in_range1 (+ (to_rep (rec__hw__dbc__s_regs__t__msb (us_split_fields1 (select regs idx)))) 1))))
(assert (= o2 (- o1 (to_rep (rec__hw__dbc__s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
...
(assert (= o9 (ite (bvult ((_ zero_extend 32) value) o8) true false)))
(assert (and (= o 32) (in_range1 32)))
