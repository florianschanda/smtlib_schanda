...
(assert (= o62 (+ x_first o61)))
(assert (and (= o63 o62) (in_range1 o62)))
(assert (= o64 (ite (<= o63 (to_rep (last (rt x)))) true false)))
(assert (and (= o58 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o59 (+ x_first o58)))
(assert (and (= o60 o59) (in_range1 o59)))
(assert (= o65 (ite (<= (to_rep (first (rt x))) o60) true false)))
(assert (= result (ite (= o65 true) o64 false)))
(assert (= result true))
...
(assert (= o54 (+ m_first o53)))
(assert (and (= o55 o54) (in_range1 o54)))
(assert (= o56 (ite (<= o55 (to_rep (last (rt m)))) true false)))
(assert (and (= o50 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o51 (+ m_first o50)))
(assert (and (= o52 o51) (in_range1 o51)))
(assert (= o57 (ite (<= (to_rep (first (rt m))) o52) true false)))
(assert (= result1 (ite (= o57 true) o56 false)))
(assert (= result1 true))
...
(assert (= o46 (+ aux1_first o45)))
(assert (and (= o47 o46) (in_range1 o46)))
(assert (= o48 (ite (<= o47 (to_rep aux1__last)) true false)))
(assert (and (= o42 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o43 (+ aux1_first o42)))
(assert (and (= o44 o43) (in_range1 o43)))
(assert (= o49 (ite (<= (to_rep aux1__first) o44) true false)))
(assert (= result2 (ite (= o49 true) o48 false)))
(assert (= result2 true))
...
(assert (= o38 (+ aux2_first o37)))
(assert (and (= o39 o38) (in_range1 o38)))
(assert (= o40 (ite (<= o39 (to_rep aux2__last)) true false)))
(assert (and (= o34 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o35 (+ aux2_first o34)))
(assert (and (= o36 o35) (in_range1 o35)))
(assert (= o41 (ite (<= (to_rep aux2__first) o36) true false)))
(assert (= result3 (ite (= o41 true) o40 false)))
(assert (= result3 true))
...
(assert (= o30 (+ aux3_first o29)))
(assert (and (= o31 o30) (in_range1 o30)))
(assert (= o32 (ite (<= o31 (to_rep aux3__last)) true false)))
(assert (and (= o26 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o27 (+ aux3_first o26)))
(assert (and (= o28 o27) (in_range1 o27)))
(assert (= o33 (ite (<= (to_rep aux3__first) o28) true false)))
(assert (= result4 (ite (= o33 true) o32 false)))
(assert (= result4 true))
...
(assert (= o3 (ite (<= o2 (to_rep (last (rt r)))) true false)))
