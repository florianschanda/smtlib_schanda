...
(declare-const o35 (Array Int unsigned_8))
...
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o30 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o30 0)))
(assert (and (= o31 o30) (in_range1 o30)))
(assert (= o32 (* 8 o31)))
(assert (= o33 (ite (< o32 (+ start len)) true false)))
(assert (= o34 (ite o33 1 0)))
(assert (= result7 (ite (= (ite (ite (= (int__content result__9) (- 1)) true false) 1 0) o34) true false)))
(assert (= result7 true))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o23 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o23 0)))
(assert (and (= o24 o23) (in_range1 o23)))
(assert (= o25 (* 8 o24)))
(assert (= o26 (ite (<= (+ start len) o25) true false)))
(assert (and (= o22 (maxvalue len)) (= o22 (bvshl #x0000000000000001 ((_ int2bv 64) len)))))
(assert (= o27 (ite (bvule o22 value) true false)))
(assert (= o28 (ite (= o27 true) o26 false)))
(assert (= o29 (ite o28 1 0)))
(assert (= result8 (ite (= (ite (ite (= (int__content result__9) (- 2)) true false) 1 0) o29) true false)))
(assert (= result8 true))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o15 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o15 0)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (= o17 (* 8 o16)))
(assert (= o18 (ite (<= (+ start len) o17) true false)))
(assert (and (= o14 (maxvalue len)) (= o14 (bvshl #x0000000000000001 ((_ int2bv 64) len)))))
(assert (= o19 (ite (bvugt o14 value) true false)))
(assert (= o20 (ite (= o19 true) o18 false)))
(assert (= o21 (ite o20 1 0)))
(assert (= result9 (ite (= (ite (ite (= (int__content result__9) 0) true false) 1 0) o21) true false)))
(assert (= result9 true))
...
(assert (and (= o11 (+ (- (- len i1) 1) start)) (in_range2 (+ (- (- len i1) 1) start))))
(assert (= o12 (nth value o11)))
(assert (= o13 (ite o12 1 0)))
(assert (and (= o10 i1) (in_range2 i1)))
