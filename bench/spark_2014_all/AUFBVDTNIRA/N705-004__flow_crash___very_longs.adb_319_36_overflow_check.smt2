...
(assert true)
(assert (forall ((number us_rep)) (! (= (= (is_zero number) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) (= (to_rep2 (let ((temp___304 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___304) i))) #x00)))) :pattern ((is_zero number)))))
(declare-fun get_msd (us_rep) Int)
(declare-fun get_msd__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant1 ((temp___expr_223 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool) (temp___do_typ_inv_222 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= 1 2147483647)) (in_range1 temp___expr_223)))
(assert (forall ((number us_rep)) (! (=> (and (dynamic_invariant number true true true true) (not (= (is_zero number) true))) (let ((result (get_msd number))) (and (and (not (= (to_rep2 (let ((temp___792 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___792) result))) #x00)) (forall ((i Int)) (=> (and (<= (+ result 1) i) (<= i (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) (= (to_rep2 (let ((temp___793 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___793) i))) #x00)))) (dynamic_invariant1 result true false true true)))) :pattern ((get_msd number)))))
...
(define-fun dynamic_invariant3 ((temp___expr_761 Int) (temp___is_init_757 Bool) (temp___skip_constant_758 Bool) (temp___do_toplevel_759 Bool) (temp___do_typ_inv_760 Bool)) Bool (=> (or (= temp___is_init_757 true) (<= 0 7)) (in_range3 temp___expr_761)))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___210 (rec__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___210) (first3 temp___210) (last3 temp___210))))))
...
(define-fun to_base1 ((a us_rep2)) us_rep (mk___rep (us_split_discrs3 a) (mk___split_fields (let ((temp___212 (rec__very_longs__very_long__long_digits2 (us_split_fields5 a)))) (of_array (to_array2 temp___212) (first5 temp___212) (last5 temp___212))))))
...
(define-fun dynamic_invariant4 ((temp___expr_349 (_ BitVec 16)) (temp___is_init_345 Bool) (temp___skip_constant_346 Bool) (temp___do_toplevel_347 Bool) (temp___do_typ_inv_348 Bool)) Bool true)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-const divisor us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(define-fun dynamic_invariant5 ((temp___expr_768 us_rep1) (temp___is_init_764 Bool) (temp___skip_constant_765 Bool) (temp___do_toplevel_766 Bool) (temp___do_typ_inv_767 Bool)) Bool (and (=> (not (= temp___skip_constant_765 true)) (in_range4 (+ (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1) (to_base temp___expr_768))) (and (dynamic_property3 1 (+ (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1) (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_768))) (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_768)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_768))) 1) (= (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_768))) (+ (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1))))))
...
(define-fun dynamic_invariant6 ((temp___expr_747 Int) (temp___is_init_743 Bool) (temp___skip_constant_744 Bool) (temp___do_toplevel_745 Bool) (temp___do_typ_inv_746 Bool)) Bool (=> (or (= temp___is_init_743 true) (<= 1 last6)) (dynamic_property6 1 last6 temp___expr_747)))
(assert (= last6 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))))
...
(define-fun dynamic_invariant7 ((temp___expr_754 Int) (temp___is_init_750 Bool) (temp___skip_constant_751 Bool) (temp___do_toplevel_752 Bool) (temp___do_typ_inv_753 Bool)) Bool (=> (or (= temp___is_init_750 true) (<= first6 last7)) (dynamic_property7 first6 last7 temp___expr_754)))
(assert (= first6 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))))
(assert (= last7 (- (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1)))
(declare-const attr__ATTRIBUTE_ADDRESS10 Int)
(declare-const attr__ATTRIBUTE_ADDRESS11 Int)
(define-fun dynamic_invariant8 ((temp___expr_781 us_rep2) (temp___is_init_777 Bool) (temp___skip_constant_778 Bool) (temp___do_toplevel_779 Bool) (temp___do_typ_inv_780 Bool)) Bool (and (=> (not (= temp___skip_constant_778 true)) (in_range5 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))) (to_base1 temp___expr_781))) (and (dynamic_property5 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))) (first5 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_781))) (last5 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_781)))) (and (= (first5 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_781))) 1) (= (last5 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_781))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor))))))))
...
(declare-fun temp_____aggregate_def_1147 ((_ BitVec 8) Int Int) us_t4)
(declare-fun temp_____aggregate_def_1160 ((_ BitVec 8) Int Int) us_t6)
(declare-sort t7 0)
...
(assert (forall ((temp___1149 (_ BitVec 8))) (forall ((temp___1150 Int) (temp___1151 Int)) (let ((temp___1148 (temp_____aggregate_def_1147 temp___1149 temp___1150 temp___1151))) (=> (dynamic_invariant2 temp___1149 true true true true) (and (=> (dynamic_property16 1 2147483647 temp___1150 temp___1151) (and (= (first10 temp___1148) temp___1150) (= (last11 temp___1148) temp___1151))) (forall ((temp___1152 Int)) (= (to_rep2 (select (to_array4 temp___1148) temp___1152)) temp___1149))))))))
(assert (forall ((temp___1162 (_ BitVec 8))) (forall ((temp___1163 Int) (temp___1164 Int)) (let ((temp___1161 (temp_____aggregate_def_1160 temp___1162 temp___1163 temp___1164))) (=> (dynamic_invariant2 temp___1162 true true true true) (and (=> (dynamic_property16 1 2147483647 temp___1163 temp___1164) (and (= (first14 temp___1161) temp___1163) (= (last15 temp___1161) temp___1164))) (forall ((temp___1165 Int)) (= (to_rep2 (select (to_array6 temp___1161) temp___1165)) temp___1162))))))))
...
(assert (not (in_range2 (* 2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))))))
(check-sat)
(exit)
