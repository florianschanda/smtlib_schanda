...
(assert (and (= o7 (mod1 (to_rep s__split_fields3) 5)) (in_range_int (mod1 (to_rep s__split_fields3) 5))))
(assert (= o8 ((_ int2bv 8) o7)))
(assert (= result3 (ite (bvule (bvsub #x05 (to_rep1 s__split_fields4)) o8) true false)))
(assert (=> (= result3 true) (= o9 (bvsub temp___203 #x05))))
(assert (=> (not (= result3 true)) (= o9 temp___203)))
