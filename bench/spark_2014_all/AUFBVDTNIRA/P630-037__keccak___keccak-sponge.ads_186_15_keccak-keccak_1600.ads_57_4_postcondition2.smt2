...
(declare-const suffix_array5 map__ref1)
...
(define-fun ctx__split_fields34 () us_split_fields (mk___split_fields ctx__split_fields24 ctx__split_fields25 ctx__split_fields26 ctx__split_fields27 ctx__split_fields28 ctx__split_fields29))
(define-fun ctx__split_fields35 () us_split_fields (mk___split_fields ctx__split_fields18 ctx__split_fields19 ctx__split_fields20 ctx__split_fields21 ctx__split_fields22 ctx__split_fields23))
(define-fun ctx__split_fields36 () us_split_fields (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17))
(define-fun ctx__split_fields37 () us_split_fields (mk___split_fields ctx__split_fields6 ctx__split_fields7 ctx__split_fields8 ctx__split_fields9 ctx__split_fields10 ctx__split_fields11))
...
(assert (=> (and (= bit_length 0) (< 0 suffix_len)) (and (and (and (= (state_of (mk___rep ctx__split_fields37)) 0) (= (rate_of (mk___rep ctx__split_fields37)) (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields37)) 8) (mod2 suffix_len 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields37)) (rate_of (mk___rep ctx__split_fields37))))))
...
(assert (=> (and (= bit_length 0) (< 0 suffix_len)) (= suffix_array2 suffix_array1)))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (= suffix_len 0) (and (and (and (= (state_of (mk___rep ctx__split_fields36)) 0) (= (rate_of (mk___rep ctx__split_fields36)) (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5))))) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields36)) 8) (mod2 bit_length 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields36)) (rate_of (mk___rep ctx__split_fields36)))))))
...
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (= (mod2 bit_length 8) 0) (and (and (and (= (state_of (mk___rep ctx__split_fields34)) 0) (= (rate_of (mk___rep ctx__split_fields34)) (rate_of (mk___rep ctx__split_fields35)))) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields34)) 8) (mod2 suffix_len 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields34)) (rate_of (mk___rep ctx__split_fields34))))))))
...
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (=> (not (= (mod2 bit_length 8) 0)) (= ctx__split_fields34 ctx__split_fields30)))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (=> (not (= suffix_len 0)) (= ctx__split_fields36 ctx__split_fields34))))
(assert (=> (not (and (= bit_length 0) (< 0 suffix_len))) (= ctx__split_fields37 ctx__split_fields36)))
(assert (and (and (and (= (state_of (mk___rep ctx__split_fields37)) 0) (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields37)) 8) (mod2 (+ bit_length suffix_len) 8))) (< (in_queue_bit_length (mk___rep ctx__split_fields37)) (rate_of (mk___rep ctx__split_fields37)))) (= (rate_of (mk___rep ctx__split_fields37)) initial_rate1)))
...
(assert (= suffix_array5 (mk_map__ref1 suffix_array2)))
(assert (= ctx__split_fields32 (mk___split_fields__ref ctx__split_fields37)))
...
(assert (not (= (state_of (mk___rep (us_split_fields__content ctx__split_fields32))) 0)))
(check-sat)
(exit)
