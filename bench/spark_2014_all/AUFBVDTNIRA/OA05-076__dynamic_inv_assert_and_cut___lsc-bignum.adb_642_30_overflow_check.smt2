...
(declare-const o103 (Array Int word32))
(declare-const h9 Int)
(declare-const o104 (Array Int word32))
(declare-const o105 (Array Int word32))
...
(assert (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o91 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o94 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o92 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o93 (mk (to_rep aux4__first) (to_rep aux4__last))) aux4_first (+ l1 1)) (omod (omultiply (num_of_big_int x x_first (+ l1 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))
...
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= temp___703 o93)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o91 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o94 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o92 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- h2 1))) (= (oeq (num_of_big_int (mk___t o95 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true))))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (and (=> (<= 1 (- (power 2 k) 1)) (dynamic_property1 1 (- (power 2 k) 1) h2)) (and (<= 1 h2) (<= h2 (- (power 2 k) 1))))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o91 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o94 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o92 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 h2)) (= (oeq (num_of_big_int (mk___t o97 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true))))))
...
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= o98 (mk_map__ref o97))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= h3 (mk_int__ref h2))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= aux4 (mk_map__ref o97))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= a2 (mk_map__ref o96))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= h4 h2)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= o99 o97)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= a3 o96)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= o100 o98)))
...
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= o101 o99)))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (= a5 a3)))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= o100 (mk_map__ref o93))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= h5 (mk_int__ref h1))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= aux41 (mk_map__ref o93))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= a4 (mk_map__ref a))))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= h6 h1)))
(assert (=> (not (and (<= 1 h1) (<= h1 temp___695))) (= o101 o93)))
...
(assert (= i1 o7))
(assert (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o91 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o94 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o102 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 #x00000002) (oadd (from_word64 i2) (from_word32 #x00000001))))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux41) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) #x0000000000000001) #x0000000000000020))))
...
(assert (<= 1 h8))
(assert (<= h8 r94b))
(assert (and (and (and (and (and (and (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o91 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o94 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o103 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (omultiply (oexpon__2 (num_of_big_int x x_first (+ l1 1)) (omultiply (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 #x00000002) (oadd (from_word64 i2) (from_word32 #x00000001)))) (oexpon (from_word32 #x00000002) (- h9 1)))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux41) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))) (= (oeq (from_word32 (t__content w7)) (omod (odivide (num_of_big_int e e_first (+ (- e_last e_first) 1)) (oexpon__2 (from_word32 #x00000002) (osubtract (from_word64 i2) (osubtract (from_integer s10) (from_word32 #x00000001))))) (oexpon (from_word32 #x00000002) s10))) true)) (= (bvurem (t__content w7) #x00000002) #x00000001)) (<= 0 s10)) (<= s10 (+ k 1))) (= (ole (from_integer s10) (oadd (from_word64 i2) (from_word32 #x00000001))) true)) (bvult i2 (bvmul (bvadd ((_ int2bv 64) (- e_last e_first)) #x0000000000000001) #x0000000000000020))))
(assert (and (=> (<= 1 r94b) (dynamic_property2 1 r94b h9)) (and (<= 1 h9) (<= h9 r94b))))
(assert (= (oeq (num_of_big_int (mk___t o104 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t o103 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1)) (num_of_big_int (mk___t o103 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep aux3__first) k1) (<= k1 (to_rep aux3__last))) (and (=> (and (<= aux3_first k1) (<= k1 (- (+ aux3_first a_last) a_first))) (= (to_rep1 (select o105 k1)) (to_rep1 (select o104 (- (+ a_first k1) aux3_first))))) (=> (=> (<= aux3_first k1) (not (<= k1 (- (+ aux3_first a_last) a_first)))) (= (to_rep1 (select o105 k1)) (to_rep1 (select o103 k1))))))))
(assert (and (= o85 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (and (= o86 o85) (uint_in_range1 o85)))
(assert (= o87 ((_ int2bv 64) o86)))
(assert (= o88 (bvadd o87 #x0000000000000001)))
(assert (= o89 (bvmul o88 #x0000000000000020)))
(assert (= o90 (ite (bvult i2 o89) true false)))
(assert (= o82 (from_word32 #x00000001)))
(assert (= o81 (from_word64 i2)))
(assert (= o83 (oadd o81 o82)))
(assert (= o80 (from_integer s10)))
(assert (= o84 (ole o80 o83)))
(assert (and (= o78 (+ k 1)) (in_range1 (+ k 1))))
(assert (= o79 (ite (<= s10 o78) true false)))
(assert (= o74 (from_word32 #x00000002)))
(assert (= o75 (oexpon o74 s10)))
(assert (= o69 (from_word32 #x00000001)))
(assert (= o68 (from_integer s10)))
(assert (= o70 (osubtract o68 o69)))
(assert (= o67 (from_word64 i2)))
(assert (= o71 (osubtract o67 o70)))
(assert (= o66 (from_word32 #x00000002)))
...
(assert (= o60 (from_word32 (t__content w7))))
(assert (= o77 (oeq o60 o76)))
(assert (and (= o55 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o56 (- o55 1)))
(assert (and (= o57 o56) (in_range1 o56)))
(assert (= o58 (ite (<= n o57) true false)))
(assert (= result8 (ite (<= 0 n) o58 false)))
(assert (= (= o59 true) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1))) (= (oeq (num_of_big_int (mk___t (map__content aux41) (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)))))
(assert (and (= o51 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o52 (num_of_big_int m m_first o51)))
(assert (and (= o48 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (and (= o47 (base Tuple0)) (= o47 (oexpon (from_word32 #x00000002) 32))))
(assert (= o49 (oexpon o47 o48)))
(assert (= o43 (from_word32 #x00000002)))
(assert (= o44 (oexpon o43 h9)))
(assert (= o39 (from_word32 #x00000001)))
(assert (= o38 (from_word64 i2)))
(assert (= o40 (oadd o38 o39)))
(assert (= o37 (from_word32 #x00000002)))
(assert (= o41 (oexpon__2 o37 o40)))
(assert (and (= o32 (- e_last e_first)) (in_range1 (- e_last e_first))))
(assert (= o33 (+ o32 1)))
(assert (and (= o34 o33) (in_range1 o33)))
(assert (and (= o35 o34) (in_range2 o34)))
(assert (= o36 (num_of_big_int e e_first o35)))
(assert (= o42 (odivide o36 o41)))
(assert (= o45 (omultiply o42 o44)))
(assert (and (= o30 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o31 (num_of_big_int x x_first o30)))
(assert (= o46 (oexpon__2 o31 o45)))
(assert (= o50 (omultiply o46 o49)))
(assert (= o53 (omod o50 o52)))
(assert (and (= o28 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o29 (num_of_big_int (mk___t o105 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o28)))
(assert (= o54 (oeq o29 o53)))
...
(assert (= o14 (num_of_big_int (mk___t o94 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first o13)))
(assert (= o27 (oeq o14 o26)))
(assert (= o11 (from_word32 #x00000001)))
(assert (and (= o9 (+ l1 1)) (in_range1 (+ l1 1))))
(assert (= o10 (num_of_big_int (mk___t o91 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first o9)))
