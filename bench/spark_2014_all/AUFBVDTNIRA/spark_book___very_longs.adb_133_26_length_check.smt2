...
(assert (not (= (ite (<= (to_rep3 (first4 temp___8941)) (to_rep3 (last4 temp___8941))) (+ (- (to_rep3 (last4 temp___8941)) (to_rep3 (first4 temp___8941))) 1) 0) (ite (<= (to_rep3 (first2 result____split_fields1)) (to_rep3 (last2 result____split_fields1))) (+ (- (to_rep3 (last2 result____split_fields1)) (to_rep3 (first2 result____split_fields1))) 1) 0))))
(check-sat)
(exit)
