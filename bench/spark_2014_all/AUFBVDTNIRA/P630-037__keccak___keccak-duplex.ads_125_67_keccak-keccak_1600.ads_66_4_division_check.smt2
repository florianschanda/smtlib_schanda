...
(assert (and (= o5 (max_input_length (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range4 o5) (= o5 (- (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))) 2)))))
(assert (= result (ite (<= in_data_bit_length o5) true false)))
(assert (= result true))
(assert (and (= o2 (+ in_data_bit_length 7)) (in_range (+ in_data_bit_length 7))))
(assert (= o3 (div1 o2 8)))
(assert (and (= o4 (length in_data)) (in_range (length in_data))))
(assert (= result1 (ite (<= o3 o4) true false)))
(assert (= result1 true))
(assert (and (= o1 (rate_of (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1)))) (and (in_range3 o1) (= o1 (to_rep3 ctx__split_fields1)))))
(assert (= result2 (ite (<= out_data_bit_length o1) true false)))
(assert (= result2 true))
(assert (and (= o (+ out_data_bit_length 7)) (in_range (+ out_data_bit_length 7))))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
