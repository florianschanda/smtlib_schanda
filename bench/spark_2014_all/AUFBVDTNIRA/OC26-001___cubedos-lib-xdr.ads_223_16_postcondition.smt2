...
(declare-datatypes () ((xdr_boolean__ref (mk_xdr_boolean__ref (xdr_boolean__content xdr_boolean)))))
(define-fun xdr_boolean__ref___projection ((a xdr_boolean__ref)) xdr_boolean (xdr_boolean__content a))
(define-fun dynamic_invariant2 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 1)) (in_range3 temp___expr_173)))
...
(assert (and (= last3 (+ position 3)) (in_range1 last3)))
(assert (=> (not (= temporary #x00000000)) (= result value)))
(assert (=> (not (= temporary #x00000000)) (= value1 1)))
(assert (=> (not (not (= temporary #x00000000))) (= result1 value)))
(assert (=> (not (not (= temporary #x00000000))) (= value2 0)))
(assert (=> (not (not (= temporary #x00000000))) (= value1 value2)))
(assert (= temporary temporary1))
(assert (= last3 last4))
(assert (= value1 value3))
(assert (= temporary2 temporary))
(assert (= last5 last3))
