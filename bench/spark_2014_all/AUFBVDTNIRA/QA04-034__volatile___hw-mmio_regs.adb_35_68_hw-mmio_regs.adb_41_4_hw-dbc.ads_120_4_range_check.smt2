...
(define-fun t__ref___projection ((a t__ref3)) us_rep (t__content3 a))
...
(define-fun word_t__ref___2__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_706 (_ BitVec 16)) (temp___is_init_702 Bool) (temp___skip_constant_703 Bool) (temp___do_toplevel_704 Bool) (temp___do_typ_inv_705 Bool)) Bool true)
...
(declare-const hw__dbc__cap_regs__read_i__2__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__cap_regs__read_i__2__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__cap_regs__read_i__2__off__assume off))
...
(assert (= o3 (- o2 (to_rep (rec__hw__dbc__cap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))))
...
(assert (= result mask))
(assert (= mask1 o9))
(assert (not (bvule (bvand (bvlshr ((_ zero_extend 32) temp) ((_ int2bv 64) (to_rep (rec__hw__dbc__cap_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) mask1) ((_ zero_extend 48) #xFFFF))))
(check-sat)
(exit)
