...
(define-fun dynamic_invariant1 ((temp___expr_1102 (_ BitVec 32)) (temp___is_init_1098 Bool) (temp___skip_constant_1099 Bool) (temp___do_toplevel_1100 Bool) (temp___do_typ_inv_1101 Bool)) Bool true)
...
(define-fun t__ref___4__projection ((a t__ref1)) us_rep (t__content1 a))
...
(assert (and (= o1 (- (to_rep (rec__hw__dbc__legacy_support_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) (in_range1 (- (to_rep (rec__hw__dbc__legacy_support_s_regs__t__msb (us_split_fields1 (select regs idx)))) (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))
(assert (= o2 (+ o1 1)))
