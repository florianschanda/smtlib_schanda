...
(assert (and (= o23 (rate_of (mk___rep ctx__split_fields10))) (and (in_range3 o23) (and (= o23 (* (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) 8)) (< o23 1600)))))
(assert (= o24 (ite (= o23 initial_bit_rate1) true false)))
(assert (and (= o21 (state_of (mk___rep ctx__split_fields10))) (and (in_range5 o21) (= o21 (to_rep3 (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields10))))))
(assert (= o22 (ite (= o21 0) true false)))
(assert (not (not (= 8 0))))
(check-sat)
(exit)
