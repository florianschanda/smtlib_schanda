...
(assert (not (= (ite (<= (to_rep1 (first9 temp___11451)) (to_rep1 (last10 temp___11451))) (+ (- (to_rep1 (last10 temp___11451)) (to_rep1 (first9 temp___11451))) 1) 0) (ite (<= 1 r131b) (+ (- r131b 1) 1) 0))))
(check-sat)
(exit)
