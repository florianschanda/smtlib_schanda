...
(assert (and (= o56 (rate_of (mk___rep (us_split_fields__content ctx__split_fields27)))) (and (in_range3 o56) (and (= o56 (* (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields__content ctx__split_fields27))) 8)) (< o56 1600)))))
(assert (and (= o57 (in_queue_bit_length (mk___rep (us_split_fields__content ctx__split_fields27)))) (and (in_range2 o57) (and (= o57 (to_rep5 (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields__content ctx__split_fields27)))) (< o57 1600)))))
