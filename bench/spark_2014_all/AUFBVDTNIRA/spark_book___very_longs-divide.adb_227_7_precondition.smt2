...
(assert (<= 1 j1))
(assert (<= j1 r138b))
(assert (and (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields3) false true true true) (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields3) false true true true)) (and (<= 1 j2) (<= j2 r138b))))
(assert (and (= o10 j2) (in_range1 j2)))
(assert (not (<= (+ o10 n1) (to_rep (rec__very_longs__very_long__length u__split_discrs)))))
(check-sat)
(exit)
