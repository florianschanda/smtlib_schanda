...
(define-fun word_t__ref___31__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_1138 (_ BitVec 32)) (temp___is_init_1134 Bool) (temp___skip_constant_1135 Bool) (temp___do_toplevel_1136 Bool) (temp___do_typ_inv_1137 Bool)) Bool true)
...
(assert (not (in_range (+ byte_offset (to_rep (rec__hw__dbc__legacy_support_s_regs__t__byte_offset (us_split_fields1 (select regs idx))))))))
(check-sat)
(exit)
