...
(assert (not (= (valid_configuration__2 cur_state (mk___split_fields cur_piece__split_fields cur_piece__split_fields1 cur_piece__split_fields2 cur_piece__split_fields3) cur_board) true)))
(check-sat)
(exit)
