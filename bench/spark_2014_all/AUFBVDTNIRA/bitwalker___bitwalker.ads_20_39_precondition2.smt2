...
(assert true)
(assert (forall ((stream us_t)) (forall ((pos Int)) (! (= (= (nth8_stream stream pos) true) (= (nth (to_rep1 (select (to_array stream) (div1 pos 8))) (- 7 (mod1 pos 8))) true)) :pattern ((nth8_stream stream pos))))))
...
(assert (forall ((byte (_ BitVec 8))) (forall ((left Int)) (! (=> (and (and (dynamic_invariant2 byte true true true true) (dynamic_invariant left true true true true)) (< left 8)) (= (= (peekbit8 byte left) true) (= (nth byte (- 7 left)) true))) :pattern ((peekbit8 byte left))))))
...
(declare-const bitwalker__peekbit8array__result Bool)
(declare-const o Int)
(declare-const o1 unsigned_8)
(declare-const o2 (_ BitVec 8))
(declare-const o3 Bool)
(declare-const result Bool)
(declare-const bitwalker__peekbit8array__result1 Bool)
(declare-const bitwalker__peekbit8array__result2 Bool)
(declare-const bitwalker__peekbit8array__result3 Bool)
(declare-const bitwalker__peekbit8array__result4 Bool)
(declare-const bitwalker__peekbit8array__result5 Bool)
(assert (dynamic_invariant1 addr true false true true))
(assert (in_range2 left))
(assert (and (= (to_rep (first (rt addr))) 0) (< left (* 8 (length addr)))))
(assert (= bitwalker__peekbit8array__result1 bitwalker__peekbit8array__result2))
(assert (= bitwalker__peekbit8array__result3 bitwalker__peekbit8array__result1))
(assert (and (<= (to_rep (first (rt addr))) (div1 left 8)) (<= (div1 left 8) (to_rep (last (rt addr))))))
(assert (= o (div1 left 8)))
(assert (= o1 (select (elts addr) o)))
(assert (= o2 (to_rep1 o1)))
(assert (and (= o3 (peekbit8 o2 (mod1 left 8))) (= (= o3 true) (= (nth o2 (- 7 (mod1 left 8))) true))))
(assert (= (mk_bool__ref result) (mk_bool__ref bitwalker__peekbit8array__result)))
(assert (= bitwalker__peekbit8array__result1 o3))
(assert (= (mk_bool__ref bitwalker__peekbit8array__result4) (mk_bool__ref bitwalker__peekbit8array__result2)))
(assert (= bitwalker__peekbit8array__result5 bitwalker__peekbit8array__result3))
