...
(declare-const o9 (Array Int unsigned_8))
...
(assert (= v1 o1))
(assert (and (and (and (<= (- 2) result__1) (<= result__1 0)) (and (= (= result__1 (- 1)) (< (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) (+ start len))) (and (= (= result__1 (- 2)) (and (bvule (maxvalue len) value1) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (= (= result__1 0) (and (bvugt (maxvalue len) value1) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (=> (= result__1 0) (forall ((i1 Int)) (=> (and (<= 0 i1) (<= i1 (- start 1))) (= (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i1) true) (= (nth8_stream (mk___t o9 (mk (to_rep addr__first) (to_rep addr__last))) i1) true))))) (and (=> (= result__1 0) (forall ((i1 Int)) (=> (and (<= start i1) (<= i1 (- (+ start len) 1))) (= (= (nth8_stream (mk___t o9 (mk (to_rep addr__first) (to_rep addr__last))) i1) true) (= (nth value1 (+ (- (- len i1) 1) start)) true))))) (=> (= result__1 0) (forall ((i1 Int)) (=> (and (<= (+ start len) i1) (<= i1 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (= (= (nth8_stream (mk___t o9 (mk (to_rep addr__first) (to_rep addr__last))) i1) true) (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i1) true))))))))))) (in_range1 result__1)))
(assert (= result__1 0))
(assert (forall ((i1 Int)) (=> (and (<= start i1) (<= i1 (- (+ start len) 1))) (= (= (nth8_stream (mk___t o9 (mk (to_rep addr__first) (to_rep addr__last))) i1) true) (= (nth8_stream addrold i1) true)))))
(assert (= v1 v2))
...
(assert (= result2 true))
(assert (and (= o7 (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i)) (= (= o7 true) (= (nth1 (to_rep1 (select addr (div1 i 8))) (- 7 (mod1 i 8))) true))))
(assert (= o8 (ite o7 1 0)))
(assert (not (<= (div1 i 8) (to_rep (last (mk (to_rep addr__first) (to_rep addr__last)))))))
(check-sat)
(exit)
