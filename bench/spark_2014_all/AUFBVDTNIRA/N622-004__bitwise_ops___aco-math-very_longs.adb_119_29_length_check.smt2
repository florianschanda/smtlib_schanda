...
(assert (not (= (ite (<= (to_rep4 (first6 temp___11441)) (to_rep4 (last6 temp___11441))) (+ (- (to_rep4 (last6 temp___11441)) (to_rep4 (first6 temp___11441))) 1) 0) (ite (<= 1 r31b) (+ (- r31b 1) 1) 0))))
(check-sat)
(exit)
