...
(assert (= v1 o))
(assert (and (and (and (<= (- 2) pokeresult1) (<= pokeresult1 0)) (and (= (= pokeresult1 (- 1)) (< (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) (+ start len))) (and (= (= pokeresult1 (- 2)) (and (bvule (maxvalue len) value) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (= (= pokeresult1 0) (and (bvugt (maxvalue len) value) (<= (+ start len) (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0))))) (and (=> (= pokeresult1 0) (forall ((i Int)) (=> (and (<= 0 i) (<= i (- start 1))) (= (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i) true) (= (nth8_stream (mk___t o2 (mk (to_rep addr__first) (to_rep addr__last))) i) true))))) (and (=> (= pokeresult1 0) (forall ((i Int)) (=> (and (<= start i) (<= i (- (+ start len) 1))) (= (= (nth8_stream (mk___t o2 (mk (to_rep addr__first) (to_rep addr__last))) i) true) (= (nth value (+ (- (- len i) 1) start)) true))))) (=> (= pokeresult1 0) (forall ((i Int)) (=> (and (<= (+ start len) i) (<= i (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last)) (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1))) (= (= (nth8_stream (mk___t o2 (mk (to_rep addr__first) (to_rep addr__last))) i) true) (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) i) true))))))))))) (in_range1 pokeresult1)))
(assert (= pokeresult1 0))
(assert (and (= o1 (peek start len (mk___t o2 (mk (to_rep addr__first) (to_rep addr__last))))) (ite (= (> (+ start len) (* 8 (length (mk___t o2 (mk (to_rep addr__first) (to_rep addr__last)))))) true) (= o1 #x0000000000000000) (=> (= (<= (+ start len) (* 8 (length (mk___t o2 (mk (to_rep addr__first) (to_rep addr__last)))))) true) (and (forall ((i Int)) (=> (and (<= 0 i) (<= i (- len 1))) (= (= (nth8_stream (mk___t o2 (mk (to_rep addr__first) (to_rep addr__last))) (- (- (+ start len) i) 1)) true) (= (nth o1 i) true)))) (forall ((i Int)) (=> (and (<= len i) (<= i 63)) (not (= (nth o1 i) true)))))))))
(assert (= (mk_t__ref result1) (mk_t__ref result__)))
(assert (= result__1 o1))
(assert (= (eq__logic result__1 value) true))
(assert (= v1 v2))
(assert (= pokeresult1 pokeresult2))
(assert (= result__1 result__2))
(assert (= o2 addr1))
(assert (= v3 v1))
(assert (= pokeresult3 pokeresult1))
