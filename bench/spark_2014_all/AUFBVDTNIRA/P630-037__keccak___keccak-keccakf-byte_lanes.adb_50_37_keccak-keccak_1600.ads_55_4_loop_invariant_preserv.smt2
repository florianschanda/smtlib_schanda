...
(assert (and (= o95 (+ offset2 8)) (in_range1 (+ offset2 8))))
(assert (= result27 (mk_int__ref offset2)))
(assert (= offset3 o95))
(assert (and (= o96 (- remaining_bits2 64)) (in_range2 (- remaining_bits2 64))))
(assert (= result28 (mk_int__ref remaining_bits2)))
(assert (= remaining_bits3 o96))
(assert (<= 64 remaining_bits3))
(assert (not (= (+ offset3 (div1 (+ remaining_bits3 7) 8)) initial_byte_len1)))
(check-sat)
(exit)
