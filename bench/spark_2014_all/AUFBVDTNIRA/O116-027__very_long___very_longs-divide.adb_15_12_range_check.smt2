...
(assert (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor)))))
(assert (not (<= (to_rep (rec__very_longs__very_long__length (us_split_discrs1 divisor))) 65536)))
(check-sat)
(exit)
