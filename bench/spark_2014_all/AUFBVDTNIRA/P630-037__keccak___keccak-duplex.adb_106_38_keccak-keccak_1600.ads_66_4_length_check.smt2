...
(assert (not (= (ite (<= (to_rep (first2 temp___11721)) (to_rep (last2 temp___11721))) (+ (- (to_rep (last2 temp___11721)) (to_rep (first2 temp___11721))) 1) 0) (ite (<= (to_rep (first2 temp___11751)) (to_rep (last2 temp___11751))) (+ (- (to_rep (last2 temp___11751)) (to_rep (first2 temp___11751))) 1) 0))))
(check-sat)
(exit)
