...
(declare-const o37 (Array Int unsigned_8))
...
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o32 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o32 0)))
(assert (and (= o33 o32) (in_range1 o32)))
(assert (= o34 (* 8 o33)))
(assert (= o35 (ite (< o34 (+ start len)) true false)))
(assert (= o36 (ite o35 1 0)))
(assert (= result7 (ite (= (ite (ite (= (int__content result__9) (- 1)) true false) 1 0) o36) true false)))
(assert (= result7 true))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o25 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o25 0)))
(assert (and (= o26 o25) (in_range1 o25)))
(assert (= o27 (* 8 o26)))
(assert (= o28 (ite (<= (+ start len) o27) true false)))
(assert (and (= o24 (maxvalue len)) (= o24 (bvshl #x0000000000000001 ((_ int2bv 64) len)))))
(assert (= o29 (ite (bvule o24 value) true false)))
(assert (= o30 (ite (= o29 true) o28 false)))
(assert (= o31 (ite o30 1 0)))
(assert (= result8 (ite (= (ite (ite (= (int__content result__9) (- 2)) true false) 1 0) o31) true false)))
(assert (= result8 true))
(assert (=> (<= (to_rep addr__first) (to_rep addr__last)) (= o17 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
(assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o17 0)))
(assert (and (= o18 o17) (in_range1 o17)))
(assert (= o19 (* 8 o18)))
(assert (= o20 (ite (<= (+ start len) o19) true false)))
(assert (and (= o16 (maxvalue len)) (= o16 (bvshl #x0000000000000001 ((_ int2bv 64) len)))))
(assert (= o21 (ite (bvugt o16 value) true false)))
(assert (= o22 (ite (= o21 true) o20 false)))
(assert (= o23 (ite o22 1 0)))
(assert (= result9 (ite (= (ite (ite (= (int__content result__9) 0) true false) 1 0) o23) true false)))
(assert (= result9 true))
