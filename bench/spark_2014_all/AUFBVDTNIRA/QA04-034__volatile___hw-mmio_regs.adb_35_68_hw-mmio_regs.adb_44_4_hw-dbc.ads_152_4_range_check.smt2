...
(assert (= result mask))
(assert (= mask1 o9))
(assert (not (bvule (bvand (bvlshr ((_ zero_extend 32) temp) ((_ int2bv 64) (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) mask1) ((_ zero_extend 32) #xFFFFFFFF))))
(check-sat)
(exit)
