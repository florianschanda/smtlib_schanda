...
(assert (and (= o20 (rate_of (mk___rep ctx__split_fields11))) (and (in_range7 o20) (and (= o20 (* (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields11)) 8)) (< o20 1600)))))
(assert (<= 0 r125s))
(assert (not (<= 0 199)))
(check-sat)
(exit)
