...
(assert (= o56 (+ x_first o55)))
(assert (and (= o57 o56) (in_range1 o56)))
(assert (= o58 (ite (<= o57 (to_rep (last (rt x)))) true false)))
(assert (and (= o52 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o53 (+ x_first o52)))
(assert (and (= o54 o53) (in_range1 o53)))
(assert (= o59 (ite (<= (to_rep (first (rt x))) o54) true false)))
(assert (= result (ite (= o59 true) o58 false)))
(assert (= result true))
...
(assert (and (= o47 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o48 (+ m_first o47)))
(assert (and (= o49 o48) (in_range1 o48)))
(assert (= o50 (ite (<= o49 (to_rep (last (rt m)))) true false)))
(assert (and (= o44 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o45 (+ m_first o44)))
(assert (and (= o46 o45) (in_range1 o45)))
(assert (= o51 (ite (<= (to_rep (first (rt m))) o46) true false)))
(assert (= result1 (ite (= o51 true) o50 false)))
(assert (= result1 true))
...
(assert (= o40 (+ aux1_first o39)))
(assert (and (= o41 o40) (in_range1 o40)))
(assert (= o42 (ite (<= o41 (to_rep aux1__last)) true false)))
(assert (and (= o36 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o37 (+ aux1_first o36)))
(assert (and (= o38 o37) (in_range1 o37)))
(assert (= o43 (ite (<= (to_rep aux1__first) o38) true false)))
(assert (= result2 (ite (= o43 true) o42 false)))
(assert (= result2 true))
...
(assert (= o32 (+ aux2_first o31)))
(assert (and (= o33 o32) (in_range1 o32)))
(assert (= o34 (ite (<= o33 (to_rep aux2__last)) true false)))
(assert (and (= o28 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o29 (+ aux2_first o28)))
(assert (and (= o30 o29) (in_range1 o29)))
(assert (= o35 (ite (<= (to_rep aux2__first) o30) true false)))
(assert (= result3 (ite (= o35 true) o34 false)))
(assert (= result3 true))
...
(assert (= o24 (+ aux3_first o23)))
(assert (and (= o25 o24) (in_range1 o24)))
(assert (= o26 (ite (<= o25 (to_rep aux3__last)) true false)))
(assert (and (= o20 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o21 (+ aux3_first o20)))
(assert (and (= o22 o21) (in_range1 o21)))
(assert (= o27 (ite (<= (to_rep aux3__first) o22) true false)))
(assert (= result4 (ite (= o27 true) o26 false)))
(assert (= result4 true))
...
(assert (and (= o12 (power 2 k)) (in_range1 (power 2 k))))
(assert (= o13 (* o12 o11)))
...
(assert (= o19 (ite (<= o18 (to_rep aux4__last)) true false)))
