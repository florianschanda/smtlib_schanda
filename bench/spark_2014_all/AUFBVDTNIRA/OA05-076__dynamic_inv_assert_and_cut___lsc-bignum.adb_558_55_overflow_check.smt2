...
(assert (= o25 (num_of_big_int (mk___t o102 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o24)))
...
(assert (= o10 (num_of_big_int (mk___t o94 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first o9)))
