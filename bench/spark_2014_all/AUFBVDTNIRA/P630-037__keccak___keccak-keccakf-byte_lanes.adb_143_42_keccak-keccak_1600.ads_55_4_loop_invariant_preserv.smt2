...
(declare-const data17 map__ref)
(declare-const remaining_bytes10 int__ref)
(declare-const offset10 int__ref)
(declare-const shift4 int__ref)
(declare-const temp___8442 int__ref)
(declare-const temp___8432 int__ref)
(declare-const temp___8422 int__ref)
(declare-const data18 (Array Int byte))
(declare-const remaining_bytes11 Int)
(declare-const offset11 Int)
(declare-const shift5 Int)
(declare-const temp___8443 Int)
(declare-const temp___8433 Int)
(declare-const temp___8423 Int)
...
(assert (= temp___8422 (mk_int__ref temp___8421)))
(assert (= temp___8432 (mk_int__ref temp___8431)))
(assert (= temp___8442 (mk_int__ref temp___8441)))
(assert (= shift4 (mk_int__ref shift3)))
(assert (= offset10 (mk_int__ref offset9)))
(assert (= remaining_bytes10 (mk_int__ref remaining_bytes9)))
(assert (= data17 (mk_map__ref data16)))
(assert (= temp___8423 temp___8421))
(assert (= temp___8433 temp___8431))
(assert (= temp___8443 temp___8441))
(assert (= shift5 shift3))
(assert (= offset11 offset9))
(assert (= remaining_bytes11 remaining_bytes9))
(assert (= data18 data16))
(assert (not (= (mod2 (int__content shift4) 8) 0)))
(check-sat)
(exit)
