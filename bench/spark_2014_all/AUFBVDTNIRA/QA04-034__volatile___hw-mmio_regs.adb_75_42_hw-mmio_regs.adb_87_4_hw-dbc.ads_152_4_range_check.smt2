...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__legacy_support_regs__write_i__3__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__legacy_support_regs__write_i__3__off__assume off))
...
(assert (not (bvule (bvor (bvand ((_ zero_extend 32) temp) (bvnot mask1)) (bvshl ((_ zero_extend 32) value) ((_ int2bv 64) (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx))))))) ((_ zero_extend 32) #xFFFFFFFF))))
(check-sat)
(exit)
