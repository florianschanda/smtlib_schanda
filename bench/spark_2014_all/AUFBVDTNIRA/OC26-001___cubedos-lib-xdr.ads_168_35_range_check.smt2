...
(assert (=> (<= (to_rep1 data__first) (to_rep1 data__last)) (= o6 (+ (- (to_rep1 data__last) (to_rep1 data__first)) 1))))
(assert (=> (not (<= (to_rep1 data__first) (to_rep1 data__last))) (= o6 0)))
(assert (= result (ite (< 0 o6) true false)))
(assert (= result true))
(assert (=> (<= (to_rep1 data__first) (to_rep1 data__last)) (= o4 (+ (- (to_rep1 data__last) (to_rep1 data__first)) 1))))
(assert (=> (not (<= (to_rep1 data__first) (to_rep1 data__last))) (= o4 0)))
(assert (= o5 (mod1 o4 4)))
...
(assert (and (= o (- (to_rep1 data__last) position)) (in_range1 (- (to_rep1 data__last) position))))
(assert (= o1 (+ o 1)))
(assert (and (= o2 o1) (in_range1 o1)))
(assert (not (in_range4 (length value))))
(check-sat)
(exit)
