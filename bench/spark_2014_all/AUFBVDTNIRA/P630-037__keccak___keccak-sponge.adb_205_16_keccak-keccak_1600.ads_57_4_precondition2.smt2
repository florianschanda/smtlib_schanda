...
(assert (=> (<= (to_rep6 (first (rt message))) r105s) (and (and (<= (to_rep6 (first (rt message))) (to_rep6 (first (rt message)))) (<= (to_rep6 (first (rt message))) (to_rep6 (last (rt message))))) (and (<= (to_rep6 (first (rt message))) r105s) (<= r105s (to_rep6 (last (rt message))))))))
(assert (= o11 (elts message)))
(assert (= o11 temp___954))
(assert (= (mk1 (to_rep6 (first (rt message))) r105s) temp___9541))
(assert (= temp___954 o12))
(assert (= (mk (to_rep6 (first2 temp___9541)) (to_rep6 (last2 temp___9541))) o13))
