...
(assert (and (= o31 (rate_of (mk___rep ctx__split_fields18))) (and (in_range3 o31) (and (= o31 (* (to_rep5 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields18)) 8)) (< o31 1600)))))
(assert (= o32 (ite (= o31 initial_rate1) true false)))
(assert (and (= o28 (rate_of (mk___rep ctx__split_fields18))) (and (in_range3 o28) (and (= o28 (* (to_rep5 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields18)) 8)) (< o28 1600)))))
(assert (and (= o29 (in_queue_bit_length (mk___rep ctx__split_fields18))) (and (in_range2 o29) (and (= o29 (to_rep4 (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields18))) (< o29 1600)))))
