...
(assert (= o41 (+ x_first o40)))
(assert (and (= o42 o41) (in_range1 o41)))
(assert (= o43 (ite (<= o42 (to_rep (last (rt x)))) true false)))
(assert (and (= o37 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o38 (+ x_first o37)))
(assert (and (= o39 o38) (in_range1 o38)))
(assert (= o44 (ite (<= (to_rep (first (rt x))) o39) true false)))
(assert (= result (ite (= o44 true) o43 false)))
(assert (= result true))
...
(assert (= o33 (+ m_first o32)))
(assert (and (= o34 o33) (in_range1 o33)))
(assert (= o35 (ite (<= o34 (to_rep (last (rt m)))) true false)))
(assert (and (= o29 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o30 (+ m_first o29)))
(assert (and (= o31 o30) (in_range1 o30)))
(assert (= o36 (ite (<= (to_rep (first (rt m))) o31) true false)))
(assert (= result1 (ite (= o36 true) o35 false)))
(assert (= result1 true))
...
(assert (= o25 (+ aux1_first o24)))
(assert (and (= o26 o25) (in_range1 o25)))
(assert (= o27 (ite (<= o26 (to_rep aux1__last)) true false)))
(assert (and (= o21 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o22 (+ aux1_first o21)))
(assert (and (= o23 o22) (in_range1 o22)))
(assert (= o28 (ite (<= (to_rep aux1__first) o23) true false)))
(assert (= result2 (ite (= o28 true) o27 false)))
(assert (= result2 true))
...
(assert (= o17 (+ aux2_first o16)))
(assert (and (= o18 o17) (in_range1 o17)))
(assert (= o19 (ite (<= o18 (to_rep aux2__last)) true false)))
(assert (and (= o13 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o14 (+ aux2_first o13)))
(assert (and (= o15 o14) (in_range1 o14)))
(assert (= o20 (ite (<= (to_rep aux2__first) o15) true false)))
(assert (= result3 (ite (= o20 true) o19 false)))
(assert (= result3 true))
...
(assert (= o9 (+ aux3_first o8)))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (= o11 (ite (<= o10 (to_rep aux3__last)) true false)))
(assert (and (= o5 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o6 (+ aux3_first o5)))
(assert (and (= o7 o6) (in_range1 o6)))
(assert (= o12 (ite (<= (to_rep aux3__first) o7) true false)))
(assert (= result4 (ite (= o12 true) o11 false)))
(assert (= result4 true))
