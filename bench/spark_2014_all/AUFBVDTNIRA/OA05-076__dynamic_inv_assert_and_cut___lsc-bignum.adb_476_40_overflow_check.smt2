...
(assert (forall ((k1 Int)) (=> (and (<= aux1_first k1) (<= k1 o2)) (= (to_rep1 (select o9 k1)) #x00000000))))
(assert (= (to_rep1 o3) #x00000001))
(assert (and (<= (to_rep aux1__first) aux1_first) (<= aux1_first (to_rep aux1__last))))
(assert (= o4 aux1_first))
(assert (= o5 (store o9 o4 o3)))
(assert (= o9 result1))
(assert (= o10 o5))
(assert (and (= o6 (+ aux3_first l1)) (in_range1 (+ aux3_first l1))))
(assert (= (oeq (num_of_big_int (mk___t o11 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ (- o6 aux3_first) 1)) (omod (omultiply (omultiply (num_of_big_int r r_first (+ (- o6 aux3_first) 1)) (num_of_big_int (mk___t o10 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ (- o6 aux3_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- o6 aux3_first) 1)) (base Tuple0)) (+ (- o6 aux3_first) 1))) (num_of_big_int m m_first (+ (- o6 aux3_first) 1)))) true))
(assert (and (= o7 (+ aux4_first l1)) (in_range1 (+ aux4_first l1))))
(assert (= (oeq (num_of_big_int (mk___t o12 (mk (to_rep aux4__first) (to_rep aux4__last))) aux4_first (+ (- o7 aux4_first) 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ (- o7 aux4_first) 1)) (num_of_big_int r r_first (+ (- o7 aux4_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- o7 aux4_first) 1)) (base Tuple0)) (+ (- o7 aux4_first) 1))) (num_of_big_int m m_first (+ (- o7 aux4_first) 1)))) true))
(assert (and (= o8 (+ aux2_first l1)) (in_range1 (+ aux2_first l1))))
(assert (= (oeq (num_of_big_int (mk___t o13 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ (- o8 aux2_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t o12 (mk (to_rep aux4__first) (to_rep aux4__last))) aux4_first (+ (- o8 aux2_first) 1)) (num_of_big_int (mk___t o12 (mk (to_rep aux4__first) (to_rep aux4__last))) aux4_first (+ (- o8 aux2_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- o8 aux2_first) 1)) (base Tuple0)) (+ (- o8 aux2_first) 1))) (num_of_big_int m m_first (+ (- o8 aux2_first) 1)))) true))
