...
(declare-const temp___1822 (_ BitVec 32))
...
(assert (= i1 r72b))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= temp___1823 tmpval1)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= temp___1822 digitval)))
(assert (=> (and (<= r72b i1) (<= i1 r73b)) (= temp___1821 i1)))
