...
(assert (= j1 r137b))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= temp___1173 current_borrow)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= temp___1172 q_hat)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= temp___1171 (mk___rep quotient__split_discrs quotient__split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= temp___1170 (mk___rep1 u__split_discrs u__split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields3) false true true true) (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields3) false true true true)) (and (<= 1 j2) (<= j2 r137b)))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (= o10 j2) (in_range1 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (= o11 j2) (in_range1 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields4) true true true true)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (= o12 j2) (in_range1 j2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields5) true true true true) (dynamic_invariant1 (mk___rep quotient__split_discrs quotient__split_fields4) true true true true))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= j2 1)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= j3 (mk_int__ref j2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= current_borrow3 (mk_t__ref1 current_borrow2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= q_hat3 (mk_t__ref1 q_hat2))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= u__split_fields6 (mk___split_fields__ref1 u__split_fields5))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= quotient__split_fields5 (mk___split_fields__ref quotient__split_fields4))))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= j4 j2)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= current_borrow4 current_borrow2)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= q_hat4 q_hat2)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= u__split_fields7 u__split_fields5)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= quotient__split_fields6 quotient__split_fields4)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= j5 j3)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= current_borrow5 current_borrow3)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= q_hat5 q_hat3)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= u__split_fields8 u__split_fields6)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= quotient__split_fields7 quotient__split_fields5)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= j6 j4)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= current_borrow6 current_borrow4)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= q_hat6 q_hat4)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= u__split_fields9 u__split_fields7)))
(assert (=> (and (<= 1 j1) (<= j1 r137b)) (= quotient__split_fields8 quotient__split_fields6)))
(assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= j5 (mk_int__ref j1))))
(assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= current_borrow5 (mk_t__ref1 current_borrow))))
(assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= q_hat5 (mk_t__ref1 q_hat))))
(assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= u__split_fields8 (mk___split_fields__ref1 u__split_fields2))))
(assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= quotient__split_fields7 (mk___split_fields__ref quotient__split_fields2))))
(assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= j6 j1)))
(assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= current_borrow6 current_borrow1)))
(assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= q_hat6 q_hat1)))
(assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= u__split_fields9 u__split_fields2)))
(assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= quotient__split_fields8 quotient__split_fields2)))
(assert (= n1 r139b))
(assert (dynamic_property6 1 last6 r139b))
(assert (<= 1 r139b))
(assert (not (<= 1 1)))
(check-sat)
(exit)
