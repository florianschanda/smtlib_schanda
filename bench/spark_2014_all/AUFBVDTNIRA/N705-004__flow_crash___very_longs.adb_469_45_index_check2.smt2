...
(assert (= temp___1383 (- o12 1)))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1383)))
(check-sat)
(exit)
