...
(assert (not (= (ite (<= (to_rep1 (first9 temp___11431)) (to_rep1 (last10 temp___11431))) (+ (- (to_rep1 (last10 temp___11431)) (to_rep1 (first9 temp___11431))) 1) 0) (ite (<= 1 r130b) (+ (- r130b 1) 1) 0))))
(check-sat)
(exit)
