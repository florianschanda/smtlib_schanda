...
(assert (= (oeq (num_of_big_int (mk___t o17 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omod (omultiply (omultiply (num_of_big_int (mk___t o16 (mk (to_rep aux4__first) (to_rep aux4__last))) o7 (+ (- a_last a_first) 1)) (num_of_big_int (mk___t o15 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (+ (- a_last a_first) 1))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true))
