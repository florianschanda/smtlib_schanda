...
(assert (=> (and (<= (to_rep1 (first (rt value))) i1) (<= i1 (to_rep1 (last (rt value))))) (= (mk_int__ref i5) (mk_int__ref i3))))
(assert (=> (and (<= (to_rep1 (first (rt value))) i1) (<= i1 (to_rep1 (last (rt value))))) (= (mk_map__ref1 temporary_array6) (mk_map__ref1 temporary_array4))))
