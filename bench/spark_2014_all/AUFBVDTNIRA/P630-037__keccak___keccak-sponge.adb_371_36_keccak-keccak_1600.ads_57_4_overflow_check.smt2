...
(assert (< 0 (to_rep4 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10))))
(assert (and (= o15 (- (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) (to_rep4 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10)))) (in_range2 (- (to_rep6 (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10)) (to_rep4 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10))))))
(assert (= result8 (mk_int__ref bytes_to_squeeze)))
(assert (= bytes_to_squeeze1 o15))
(assert (in_range2 bytes_to_squeeze1))
(assert (=> (< remaining1 bytes_to_squeeze1) (= result9 (mk_int__ref bytes_to_squeeze1))))
(assert (=> (< remaining1 bytes_to_squeeze1) (= bytes_to_squeeze2 remaining1)))
(assert (=> (not (< remaining1 bytes_to_squeeze1)) (= bytes_to_squeeze2 bytes_to_squeeze1)))
(assert (and (= keccak__keccak_1600__sponge__squeeze__B_2__R140s__assume (+ (to_rep digest__first) offset1)) (in_range1 (+ (to_rep digest__first) offset1))))
(assert (= keccak__keccak_1600__sponge__squeeze__B_2__R140s__assume r140s))
(assert (in_range1 r140s))
(assert (and (= o16 (+ offset1 bytes_to_squeeze2)) (in_range1 (+ offset1 bytes_to_squeeze2))))
(assert (= o17 (- o16 1)))
(assert (= o18 (+ (to_rep digest__first) o17)))
(assert (and (= keccak__keccak_1600__sponge__squeeze__B_2__R141s__assume o18) (in_range1 o18)))
(assert (= keccak__keccak_1600__sponge__squeeze__B_2__R141s__assume r141s))
(assert (in_range1 r141s))
(assert (= (to_rep4 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10)) r144s))
(assert (in_range6 r144s))
(assert (and (= keccak__keccak_1600__sponge__squeeze__B_2__R145s__assume (+ (to_rep4 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10)) (- bytes_to_squeeze2 1))) (in_range1 (+ (to_rep4 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10)) (- bytes_to_squeeze2 1)))))
(assert (= keccak__keccak_1600__sponge__squeeze__B_2__R145s__assume r145s))
(assert (in_range1 r145s))
(assert (=> (<= r144s r145s) (and (and (<= 0 r144s) (<= r144s 199)) (and (<= 0 r145s) (<= r145s 199)))))
(assert (= o19 (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields10)))
(assert (= o19 temp___987))
(assert (= (mk4 r144s r145s) temp___9871))
(assert (= (ite (<= (to_rep (first8 temp___9871)) (to_rep (last8 temp___9871))) (+ (- (to_rep (last8 temp___9871)) (to_rep (first8 temp___9871))) 1) 0) (ite (<= r140s r141s) (+ (- r141s r140s) 1) 0)))
(assert (= (slide1 temp___987 (to_rep (first8 temp___9871)) r140s) temp___988))
(assert (= (mk3 r140s r141s) temp___9881))
(assert (=> (<= r140s r141s) (and (and (<= (to_rep digest__first) r140s) (<= r140s (to_rep digest__last))) (and (<= (to_rep digest__first) r141s) (<= r141s (to_rep digest__last))))))
(assert (= o20 digest1))
(assert (= o20 temp___989))
(assert (= (mk3 r140s r141s) temp___9891))
(assert (= (ite (<= (to_rep (first6 temp___9881)) (to_rep (last6 temp___9881))) (+ (- (to_rep (last6 temp___9881)) (to_rep (first6 temp___9881))) 1) 0) (ite (<= (to_rep (first6 temp___9891)) (to_rep (last6 temp___9891))) (+ (- (to_rep (last6 temp___9891)) (to_rep (first6 temp___9891))) 1) 0)))
(assert (= (mk___t3 temp___990 temp___9901) (mk___t3 temp___988 temp___9881)))
(assert (forall ((temp___991 Int)) (ite (and (<= r140s temp___991) (<= temp___991 r141s)) (= (select o21 temp___991) (select temp___990 temp___991)) (= (select o21 temp___991) (select digest1 temp___991)))))
(assert (= result10 (mk_map__ref1 digest1)))
(assert (= digest2 o21))
(assert (and (= o22 (+ (to_rep4 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10)) bytes_to_squeeze2)) (in_range1 (+ (to_rep4 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed ctx__split_fields10)) bytes_to_squeeze2))))
(assert (and (= o23 o22) (in_range6 o22)))
(assert (= (to_rep4 o24) o23))
(assert (= (rec__keccak__keccak_1600__sponge__context__state ctx__split_fields10) o25))
(assert (= (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields10) o26))
(assert (= (rec__keccak__keccak_1600__sponge__context__bits_absorbed ctx__split_fields10) o27))
(assert (= o24 o28))
(assert (= (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields10) o29))
(assert (= (rec__keccak__keccak_1600__sponge__context__curr_state ctx__split_fields10) o30))
(assert (= temp___993 o25))
(assert (= temp___9931 o26))
(assert (= temp___9932 o27))
(assert (= temp___9933 o28))
(assert (= temp___9934 o29))
(assert (= temp___9935 o30))
(assert (= result11 (mk___split_fields__ref ctx__split_fields10)))
(assert (= ctx__split_fields11 (mk___split_fields temp___993 temp___9931 temp___9932 temp___9933 temp___9934 temp___9935)))
(assert (and (= o31 (+ offset1 bytes_to_squeeze2)) (in_range1 (+ offset1 bytes_to_squeeze2))))
(assert (= result12 (mk_int__ref offset1)))
(assert (= offset2 o31))
(assert (not (in_range1 (- remaining1 bytes_to_squeeze2))))
(check-sat)
(exit)
