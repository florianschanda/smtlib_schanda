...
(assert (=> (<= (to_rep1 data__first) (to_rep1 data__last)) (= o3 (+ (- (to_rep1 data__last) (to_rep1 data__first)) 1))))
(assert (=> (not (<= (to_rep1 data__first) (to_rep1 data__last))) (= o3 0)))
(assert (= result (ite (< 0 o3) true false)))
(assert (= result true))
(assert (=> (<= (to_rep1 data__first) (to_rep1 data__last)) (= o1 (+ (- (to_rep1 data__last) (to_rep1 data__first)) 1))))
(assert (=> (not (<= (to_rep1 data__first) (to_rep1 data__last))) (= o1 0)))
(assert (= o2 (mod1 o1 4)))
(assert (= result1 (ite (= o2 0) true false)))
(assert (= result1 true))
(assert (and (= o (length value)) (in_range1 (length value))))
(assert (= result2 (ite (<= o 65536) true false)))
(assert (= result2 true))
(assert (<= (to_rep1 data__first) position))
(assert (<= position (to_rep1 data__last)))
(assert (not (in_range1 (- (to_rep1 data__last) position))))
(check-sat)
(exit)
