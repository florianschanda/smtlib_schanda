...
(define-fun word_t__ref___12__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_853 (_ BitVec 64)) (temp___is_init_849 Bool) (temp___skip_constant_850 Bool) (temp___do_toplevel_851 Bool) (temp___do_typ_inv_852 Bool)) Bool true)
...
(declare-const hw__dbc__op_regs__read_i__4__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__op_regs__read_i__4__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__op_regs__read_i__4__off__assume off))
