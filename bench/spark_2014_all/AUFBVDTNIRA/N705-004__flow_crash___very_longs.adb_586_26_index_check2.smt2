...
(assert (and (<= (to_rep1 (first number__split_fields1)) digit_number1) (<= digit_number1 (to_rep1 (last number__split_fields1)))))
(assert (= o digit_number1))
(assert (= o1 (select number__split_fields o)))
(assert (= o2 (to_rep2 o1)))
(assert (= result2 digit))
(assert (= digit1 o2))
(assert (=> (= bit_value 1) (=> (< bit_position1 8) (= o3 (bvshl #x01 ((_ int2bv 8) bit_position1))))))
(assert (=> (= bit_value 1) (=> (not (< bit_position1 8)) (= o3 #x00))))
(assert (=> (= bit_value 1) (= o4 (bvor digit1 o3))))
(assert (=> (= bit_value 1) (= result3 digit1)))
(assert (=> (= bit_value 1) (= digit2 o4)))
(assert (=> (not (= bit_value 1)) (=> (< bit_position1 8) (= o5 (bvshl #x01 ((_ int2bv 8) bit_position1))))))
(assert (=> (not (= bit_value 1)) (=> (not (< bit_position1 8)) (= o5 #x00))))
