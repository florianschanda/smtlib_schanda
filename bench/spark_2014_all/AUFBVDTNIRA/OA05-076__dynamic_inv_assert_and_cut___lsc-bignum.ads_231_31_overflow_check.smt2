...
(assert (= o16 (+ x_first o15)))
(assert (and (= o17 o16) (in_range1 o16)))
(assert (= o18 (ite (<= o17 (to_rep (last (rt x)))) true false)))
(assert (and (= o12 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o13 (+ x_first o12)))
(assert (and (= o14 o13) (in_range1 o13)))
(assert (= o19 (ite (<= (to_rep (first (rt x))) o14) true false)))
...
(assert (= o8 (+ m_first o7)))
(assert (and (= o9 o8) (in_range1 o8)))
(assert (= o10 (ite (<= o9 (to_rep (last (rt m)))) true false)))
(assert (and (= o4 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o5 (+ m_first o4)))
(assert (and (= o6 o5) (in_range1 o5)))
(assert (= o11 (ite (<= (to_rep (first (rt m))) o6) true false)))
...
(assert (= o3 (ite (<= o2 (to_rep aux1__last)) true false)))
