...
(define-fun word_t__ref___39__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_1267 (_ BitVec 32)) (temp___is_init_1263 Bool) (temp___skip_constant_1264 Bool) (temp___do_toplevel_1265 Bool) (temp___do_typ_inv_1266 Bool)) Bool true)
...
(declare-const hw__dbc__regs__write_i__3__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__regs__write_i__3__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__regs__write_i__3__off__assume off))
