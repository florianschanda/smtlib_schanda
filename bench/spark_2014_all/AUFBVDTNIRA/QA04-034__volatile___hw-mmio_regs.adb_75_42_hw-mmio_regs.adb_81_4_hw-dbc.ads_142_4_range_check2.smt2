...
(define-fun word_t__ref___21__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_991 (_ BitVec 8)) (temp___is_init_987 Bool) (temp___skip_constant_988 Bool) (temp___do_toplevel_989 Bool) (temp___do_typ_inv_990 Bool)) Bool true)
...
(declare-const hw__dbc__xcap_regs__write_i__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__xcap_regs__write_i__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__xcap_regs__write_i__off__assume off))
...
(assert (not (bvule ((_ zero_extend 32) #x00000000) (bvor (bvand ((_ zero_extend 32) temp) (bvnot mask1)) (bvshl ((_ zero_extend 56) value) ((_ int2bv 64) (to_rep (rec__hw__dbc__xcap_s_regs__t__lsb (us_split_fields1 (select regs idx))))))))))
(check-sat)
(exit)
