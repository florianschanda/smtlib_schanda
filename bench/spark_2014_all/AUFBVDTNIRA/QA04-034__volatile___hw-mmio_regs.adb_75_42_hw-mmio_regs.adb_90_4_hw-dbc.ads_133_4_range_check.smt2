...
(assert (not (bvule (bvor (bvand ((_ zero_extend 32) temp) (bvnot mask1)) (bvshl value ((_ int2bv 64) (to_rep (rec__hw__dbc__op_s_regs__t__lsb (us_split_fields1 (select regs idx))))))) ((_ zero_extend 32) #xFFFFFFFF))))
(check-sat)
(exit)
