...
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o27 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o30 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o28 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 (- h2 1))) (= (oeq (num_of_big_int (mk___t o31 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true))))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (and (=> (<= 1 (- (power 2 k) 1)) (dynamic_property1 1 (- (power 2 k) 1) h2)) (and (<= 1 h2) (<= h2 (- (power 2 k) 1))))))
(assert (=> (and (<= 1 h1) (<= h1 temp___695)) (and (and (and (and (= l1 (- a_last a_first)) (= (oeq (num_of_big_int (mk___t o27 (mk (to_rep aux1__first) (to_rep aux1__last))) aux1_first (+ l1 1)) (from_word32 #x00000001)) true)) (= (oeq (num_of_big_int (mk___t o30 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first (+ l1 1)) (omod (omultiply (omultiply (num_of_big_int x x_first (+ l1 1)) (num_of_big_int x x_first (+ l1 1))) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true)) (= (oeq (num_of_big_int (mk___t o28 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first (+ l1 1)) (omod (oexpon (base Tuple0) (+ l1 1)) (num_of_big_int m m_first (+ l1 1)))) true)) (forall ((n1 Int)) (=> (and (<= 0 n1) (<= n1 h2)) (= (oeq (num_of_big_int (mk___t o33 (mk (to_rep aux4__first) (to_rep aux4__last))) (+ aux4_first (* n1 (+ l1 1))) (+ l1 1)) (omod (omultiply (oexpon (num_of_big_int x x_first (+ l1 1)) (+ (* 2 n1) 1)) (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true))))))
