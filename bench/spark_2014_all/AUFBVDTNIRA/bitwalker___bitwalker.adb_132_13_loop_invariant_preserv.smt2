...
(assert (<= 0 j))
(assert (<= j (- start 1)))
(assert (= (nth8_stream (mk___t o10 (mk (to_rep addr__first) (to_rep addr__last))) j) true))
(assert (not (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last))) j) true)))
(check-sat)
(exit)
