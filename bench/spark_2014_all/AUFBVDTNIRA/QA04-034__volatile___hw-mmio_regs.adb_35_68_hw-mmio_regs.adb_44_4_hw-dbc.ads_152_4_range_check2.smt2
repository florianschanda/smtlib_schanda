...
(define-fun word_t__ref___27__projection ((a word_t__ref)) word_t (word_t__content a))
(define-fun dynamic_invariant5 ((temp___expr_1102 (_ BitVec 32)) (temp___is_init_1098 Bool) (temp___skip_constant_1099 Bool) (temp___do_toplevel_1100 Bool) (temp___do_typ_inv_1101 Bool)) Bool true)
...
(declare-const hw__dbc__legacy_support_regs__read_i__3__off__assume Int)
...
(assert (= o1 (div1 o 4)))
(assert (and (= hw__dbc__legacy_support_regs__read_i__3__off__assume o1) (in_range2 o1)))
(assert (= hw__dbc__legacy_support_regs__read_i__3__off__assume off))
...
(assert (= result mask))
(assert (= mask1 o9))
(assert (not (bvule ((_ zero_extend 32) #x00000000) (bvand (bvlshr ((_ zero_extend 32) temp) ((_ int2bv 64) (to_rep (rec__hw__dbc__legacy_support_s_regs__t__lsb (us_split_fields1 (select regs idx)))))) mask1))))
(check-sat)
(exit)
