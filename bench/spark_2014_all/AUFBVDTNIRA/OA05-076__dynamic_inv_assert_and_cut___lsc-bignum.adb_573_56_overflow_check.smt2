...
(assert (and (= o33 (- j3 s3)) (in_range1 (- j3 s3))))
(assert (= o34 (- o33 1)))
(assert (and (= o35 o34) (in_range1 o34)))
(assert (and (= o36 o35) (in_range2 o35)))
(assert (= o32 (from_word32 #x00000002)))
(assert (= o37 (oexpon o32 o36)))
(assert (= o31 (from_word32 w2)))
(assert (= o38 (omultiply o31 o37)))
...
(assert (and (= o24 (base Tuple0)) (= o24 (oexpon (from_word32 #x00000002) 32))))
