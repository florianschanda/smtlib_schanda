...
(define-fun dynamic_invariant4 ((temp___expr_194 (_ BitVec 8)) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool true)
...
(assert (and (and (and (= (mod1 position 4) 0) (= (mod1 (length data) 4) 0)) (and (<= (to_rep1 (first (rt data))) position) (<= position (to_rep1 (last (rt data)))))) (<= (+ position 3) (to_rep1 (last (rt data))))))
...
(assert (= temporary_21 (bvmul temporary_11 #x00000100)))
...
(assert (= temporary_23 (bvmul temporary_12 #x00000100)))
...
(assert (= temporary_25 (bvmul temporary_13 #x00000100)))
...
(assert (not (= (int__content last4) (+ position 3))))
(check-sat)
(exit)
