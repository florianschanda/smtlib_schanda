...
(define-fun dynamic_invariant ((temp___expr_215 Int) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool (=> (or (= temp___is_init_211 true) (<= 0 65536)) (in_range4 temp___expr_215)))
(assert (forall ((length1 Int)) (! (=> (dynamic_invariant length1 true true true true) (dynamic_invariant (length_with_padding length1) true false true true)) :pattern ((length_with_padding length1)))))
(assert (forall ((length1 Int)) (! (=> (dynamic_invariant length1 true true true true) (= (length_with_padding length1) (+ length1 (ite (= (mod1 length1 4) 0) 0 (- 4 (mod1 length1 4)))))) :pattern ((length_with_padding length1)))))
...
(define-fun dynamic_invariant1 ((temp___expr_201 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 65535)) (in_range5 temp___expr_201)))
...
(declare-fun user_eq7 (octet_array_extended_index octet_array_extended_index) Bool)
(declare-const dummy7 octet_array_extended_index)
...
(define-fun dynamic_invariant3 ((temp___expr_222 us_t1) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (not (= temp___skip_constant_219 true)) (dynamic_property1 0 65535 (first3 temp___expr_222) (last3 temp___expr_222))))
...
(declare-fun temp_____aggregate_def_601 (Int Int Int) us_t2)
...
(assert (forall ((temp___603 Int) (temp___604 Int) (temp___605 Int)) (let ((temp___602 (temp_____aggregate_def_601 temp___603 temp___604 temp___605))) (=> (dynamic_invariant5 temp___603 true true true true) (and (=> (dynamic_property 1 2147483647 temp___604 temp___605) (and (= (first5 temp___602) temp___604) (= (last5 temp___602) temp___605))) (forall ((temp___606 Int)) (= (to_rep (select (to_array2 temp___602) temp___606)) temp___603)))))))
...
(declare-const temp___615 (Array Int character))
...
(assert (=> (<= (- 1) 65535) (in_range6 last6)))
...
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_601 32 (to_rep1 value__first) (to_rep1 value__last))))) (to_rep1 value__first)))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_601 32 (to_rep1 value__first) (to_rep1 value__last))))) (to_rep1 value__last)))
(assert (= (mk___t2 temp___608 temp___6081) (temp_____aggregate_def_601 32 (to_rep1 value__first) (to_rep1 value__last))))
(assert (= temp___608 temp___609))
(assert (= (mk (to_rep1 (first4 temp___6081)) (to_rep1 (last4 temp___6081))) temp___6091))
(assert (= (ite (<= (to_rep1 (first temp___6091)) (to_rep1 (last temp___6091))) (+ (- (to_rep1 (last temp___6091)) (to_rep1 (first temp___6091))) 1) 0) (ite (<= (to_rep1 value__first) (to_rep1 value__last)) (+ (- (to_rep1 value__last) (to_rep1 value__first)) 1) 0)))
(assert (= (mk___t temp___610 temp___6101) (mk___t temp___609 temp___6091)))
(assert (= o (slide temp___610 (to_rep1 (first temp___6101)) (to_rep1 value__first))))
...
(assert (= temp___612 (- o4 1)))
(assert (= (mk_int__ref result1) (mk_int__ref i)))
(assert (= i1 position))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= temp___615 value1)))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (and (<= position i2) (<= i2 (- (+ position (ite (<= (to_rep1 value__first) (to_rep1 value__last)) (+ (- (to_rep1 value__last) (to_rep1 value__first)) 1) 0)) 1)))))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (and (<= (to_rep1 (first2 (rt1 data))) i2) (<= i2 (to_rep1 (last2 (rt1 data)))))))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= o7 i2)))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= o8 (select (elts1 data) o7))))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= o9 (to_rep2 o8))))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= o10 (bv2nat o9))))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= (to_rep o11) o10)))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (and (= o5 (- i2 position)) (in_range1 (- i2 position)))))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= o6 (+ (to_rep1 value__first) o5))))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (and (= temp___613 o6) (in_range1 o6))))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (and (<= (to_rep1 value__first) temp___613) (<= temp___613 (to_rep1 value__last)))))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= o12 temp___613)))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= o13 (store value2 o12 o11))))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= value2 result2)))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= value3 o13)))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= i2 temp___612)))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= i2 i3)))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= value3 value4)))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= i4 i2)))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= value5 value3)))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= (mk_int__ref i5) (mk_int__ref i3))))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= (mk_map__ref value6) (mk_map__ref value4))))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= i6 i4)))
(assert (=> (and (<= position i1) (<= i1 temp___612)) (= value7 value5)))
(assert (=> (not (and (<= position i1) (<= i1 temp___612))) (= i1 i5)))
(assert (=> (not (and (<= position i1) (<= i1 temp___612))) (= value1 value6)))
(assert (=> (not (and (<= position i1) (<= i1 temp___612))) (= i6 i1)))
(assert (=> (not (and (<= position i1) (<= i1 temp___612))) (= value7 value1)))
