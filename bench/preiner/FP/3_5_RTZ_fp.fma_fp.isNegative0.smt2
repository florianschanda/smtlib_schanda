...
(define-fun IC ((s FP) (t FP)) Bool (and (not (fp.isNaN s)) (not (fp.isNaN t)) (=> (fp.isPositive t) (and (not (fp.isInfinite t)) (ite (= R RTN) (=> (fp.isZero s) (fp.isZero t)) (not (fp.isZero s)))))))

(assert
 (distinct
  (IC s u)
  (exists ((x FP)) (fp.isNegative (fp.fma RTZ x s u)))
 )
)
