...
(define-fun IC ((s FP) (t FP)) Bool (and (ite (fp.isInfinite t) (and (ite (fp.isNegative t) (fp.isNegative s) (fp.isPositive s)) (not (fp.isZero s))) (and (or (and (ite (fp.isNegative t) (fp.isNegative s) (fp.isPositive s)) (not (fp.isZero t))) (not (fp.isInfinite s))) (not (fp.isNaN s)))) (not (fp.isNaN t))))

(assert
 (distinct
  (IC s u)
  (exists ((x FP)) (fp.isPositive (fp.fma RTN s u x)))
 )
)
