...
(define-fun IC ((s FP) (t FP)) Bool (ite (fp.isNegative s) (not (fp.isNaN t)) (ite (fp.isInfinite s) (and (fp.isInfinite t) (fp.isNegative t)) (and (fp.isPositive s) (not (fp.isNaN t))))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (fp.geq (fp.sub RTP x s) t))
 )
)
