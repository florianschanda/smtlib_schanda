...
(define-fun IC ((s FP) (t FP)) Bool (ite (fp.isZero s) (fp.isInfinite t) (and (or (fp.isInfinite t) (fp.isNormal t) (fp.isSubnormal t) (fp.isZero t)) (not (fp.isNaN s)))))

(assert
 (distinct
  (IC s u)
  (exists ((x FP)) (fp.isInfinite (fp.fma RNE x s u)))
 )
)
