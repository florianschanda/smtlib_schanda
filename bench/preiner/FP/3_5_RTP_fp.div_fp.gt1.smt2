...
(define-fun IC ((s FP) (t FP)) Bool (ite (fp.isNegative t) (and (not (fp.isNaN s)) (or (not (fp.isZero t)) (not (fp.isZero s)))) (and (not (fp.isNaN s)) (not (fp.isZero s)) (not (fp.isNaN t)) (not (fp.isInfinite t)))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (fp.gt (fp.div RTP s x) t))
 )
)
