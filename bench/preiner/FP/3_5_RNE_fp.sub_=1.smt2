...
(define-fun IC ((s FP) (t FP)) Bool (or (= t (fp.sub R s (fp.sub RTP s t))) (= t (fp.sub R s (fp.sub RTN s t))) (and (= s t) (fp.isInfinite s) (fp.isInfinite t))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (= (fp.sub RNE s x) t))
 )
)
