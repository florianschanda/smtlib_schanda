...
(define-fun IC ((s FP) (t FP)) Bool (and (or (fp.isZero t) (not (fp.isNegative t)) (not (fp.isInfinite s))) (not (fp.isNaN s)) (not (fp.isNaN t))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (fp.leq (fp.div RTP x s) t))
 )
)
