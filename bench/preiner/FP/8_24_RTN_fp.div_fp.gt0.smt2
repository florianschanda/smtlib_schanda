...
(define-fun IC ((s FP) (t FP)) Bool (ite (fp.isNegative t) (and (or (not (fp.isInfinite s)) (not (fp.isZero t))) (not (fp.isNaN s))) (and (not (fp.isInfinite s)) (not (fp.isNaN s)) (not (fp.isNaN t)) (not (fp.isInfinite t)))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (fp.gt (fp.div RTN x s) t))
 )
)
