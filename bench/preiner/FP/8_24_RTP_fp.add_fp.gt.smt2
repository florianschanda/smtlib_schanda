...
(define-fun IC ((s FP) (t FP)) Bool (and (ite (fp.isPositive s) (or (fp.isNegative t) (not (fp.isInfinite t))) (and (fp.isNegative s) (or (fp.isNegative t) (not (fp.isInfinite t))) (not (fp.isInfinite s)))) (not (fp.isNaN t))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (fp.gt (fp.add RTP x s) t))
 )
)
