...
(define-fun IC ((s FP) (t FP)) Bool (and (ite (fp.isInfinite s) (and (not (fp.isNegative t)) (not (fp.isZero t))) (or (not (fp.isNegative t)) (not (fp.isInfinite t)))) (not (fp.isNaN s)) (not (fp.isNaN t))))

(assert
 (distinct
  (IC s t)
  (exists ((x FP)) (fp.lt (fp.div RNE x s) t))
 )
)
