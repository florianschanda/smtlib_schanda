...
(define-fun IC ((s FP)) Bool (ite (fp.isSubnormal s) (or (fp.isPositive s) (not (= (fp.abs s) (fp.mul RTP s s)))) (and (not (and (fp.isZero s) (fp.isNegative s))) (not (fp.isInfinite s)) (not (fp.isNaN s)))))

(assert
 (distinct
  (IC s)
  (exists ((x FP)) (fp.isPositive (fp.rem s x)))
 )
)
