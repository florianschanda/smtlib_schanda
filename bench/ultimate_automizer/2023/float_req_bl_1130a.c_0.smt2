...
(assert (and (exists ((|v_ULTIMATE.start_fmod_float_~#gf_u~0#1.base_6| (_ BitVec 64))) (let ((_cse0 (select (select |c_#memory_int| |v_ULTIMATE.start_fmod_float_~#gf_u~0#1.base_6|) (_ bv0 64)))) (and (= (fp ((_ extract 31 31) _cse0) ((_ extract 30 23) _cse0) ((_ extract 22 0) _cse0)) (_ +zero 8 24)) (= |c_ULTIMATE.start_fmod_float_~hx~0#1| _cse0)))) (= |c_ULTIMATE.start_fmod_float_~x#1| (_ +zero 8 24)) (or (fp.gt |c_ULTIMATE.start_fmod_float_~y#1| (_ +zero 8 24)) (fp.lt |c_ULTIMATE.start_fmod_float_~y#1| (_ +zero 8 24))) (= |c_ULTIMATE.start_main_~x~0#1| (_ +zero 8 24))))
