...
(assert (not (and (exists ((|v_returnsStructure_~#c~1.base_18| (_ BitVec 64))) (and (= (select (select |c_#memory_int| |v_returnsStructure_~#c~1.base_18|) (_ bv0 64)) (_ bv0 32)) (not (= |v_returnsStructure_~#c~1.base_18| |c_ULTIMATE.start_testOne_~#f1~0#1.base_Hier|)))) (= (bvadd (select |c_#valid| |c_ULTIMATE.start_testOne_~#f1~0#1.base_Hier|) (_ bv1 1)) (_ bv0 1)) (= (let ((_cse0 (select (select |c_#memory_int| |c_ULTIMATE.start_testOne_~#f1~0#1.base_Hier|) |c_ULTIMATE.start_testOne_~#f1~0#1.offset_Hier|))) (fp ((_ extract 31 31) _cse0) ((_ extract 30 23) _cse0) ((_ extract 22 0) _cse0))) (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))) (not (= |c_ULTIMATE.start_testOne_~#f2~0#1.base_Hier| |c_ULTIMATE.start_testOne_~#f1~0#1.base_Hier|)))))
(check-sat)
(exit)
