...
(assert (not (and (= (bvadd (select |c_#valid| |c_ULTIMATE.start_testOne_~#f1~0#1.base|) (_ bv1 1)) (_ bv0 1)) (exists ((|v_returnsStructure_~#c~1.base_8| (_ BitVec 64))) (and (= (_ bv0 32) (select (select |c_#memory_int_primed| |v_returnsStructure_~#c~1.base_8|) (_ bv0 64))) (not (= |v_returnsStructure_~#c~1.base_8| |c_ULTIMATE.start_testOne_~#f1~0#1.base|)))) (= (_ bv0 64) |c_ULTIMATE.start_testOne_~#f2~0#1.offset|) (not (= |c_ULTIMATE.start_testOne_~#f2~0#1.base| |c_ULTIMATE.start_testOne_~#f1~0#1.base|)) (= (_ bv0 64) |c_ULTIMATE.start_testOne_~#f1~0#1.offset|) (= (let ((_cse0 (select (select |c_#memory_int_primed| |c_ULTIMATE.start_testOne_~#f1~0#1.base|) (_ bv0 64)))) (fp ((_ extract 31 31) _cse0) ((_ extract 30 23) _cse0) ((_ extract 22 0) _cse0))) (fp (_ bv0 1) (_ bv0 8) (_ bv0 23))))))
(check-sat)
(exit)
