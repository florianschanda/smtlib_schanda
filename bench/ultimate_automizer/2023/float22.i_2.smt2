...
(assert (not (exists ((|v_returnsStructure_~#c~1.base_18| (_ BitVec 64)) (v_ArrVal_118 (_ BitVec 1))) (let ((_cse0 (select (select |c_#memory_int| |v_returnsStructure_~#c~1.base_18|) (_ bv0 64)))) (and (= |c_#valid| (store |c_old(#valid)| |v_returnsStructure_~#c~1.base_18| v_ArrVal_118)) (= (bvand |c_returnsStructure_#in~index| (_ bv1 32)) _cse0) (= |c_returnsStructure_#res.f| (fp ((_ extract 31 31) _cse0) ((_ extract 30 23) _cse0) ((_ extract 22 0) _cse0))) (= (select |c_old(#valid)| |v_returnsStructure_~#c~1.base_18|) (_ bv0 1)))))))
(check-sat)
(exit)
