...
(assert (and (fp.geq c_main_~E1~7 (fp.neg ((_ to_fp 11 53) RNE 1))) (= ((_ to_fp 11 53) RNE (_ bv0 32)) c_main_~S~7) (fp.geq c_main_~E0~7 (fp.neg ((_ to_fp 11 53) RNE 1))) (fp.leq c_main_~E0~7 ((_ to_fp 11 53) RNE 1)) (fp.leq c_main_~E1~7 ((_ to_fp 11 53) RNE 1))))
