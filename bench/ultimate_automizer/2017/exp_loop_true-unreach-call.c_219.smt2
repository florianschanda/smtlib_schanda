...
(assert (exists ((main_~a~17 (_ FloatingPoint 8 24))) (and (= c_main_~b~17 (fp.div RNE main_~a~17 ((_ to_fp 8 24) RNE 2))) (not (fp.leq ((_ to_fp 8 24) RNE 2) main_~a~17)) (fp.geq main_~a~17 ((_ to_fp 8 24) RNE 1)))))
(check-sat)
(exit)
