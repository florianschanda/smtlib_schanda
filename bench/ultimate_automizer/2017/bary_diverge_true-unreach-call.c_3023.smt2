...
(assert (and (fp.gt c_~C1 (_ +zero 8 24)) (fp.leq c_~Z~8 ((_ to_fp 8 24) RNE 1)) (= c_~X~8 c_~I) (fp.geq c_~Z~8 (fp.neg ((_ to_fp 8 24) RNE 1))) (= (bvadd |c___VERIFIER_assert_#in~cond| (_ bv4294967295 32)) (_ bv0 32)) (= c_~X~8 c_~Z~8) (= c_~X~8 c_~Y~8)))
