...
(assert (not (exists ((main_~D~6 (_ FloatingPoint 8 24))) (and (fp.geq main_~D~6 (_ +zero 8 24)) (fp.leq main_~D~6 ((_ to_fp 8 24) RNE 16)) (= (fp.sub RNE ((_ to_fp 8 24) RNE (_ bv0 32)) main_~D~6) c_main_~Y~6_Hier)))))
(check-sat)
(exit)
