...
(assert (= |c___VERIFIER_assert_#in~cond_primed| (ite (and (fp.geq c_main_~Y~6 (fp.neg ((_ to_fp 8 24) RNE 129))) (fp.leq c_main_~Y~6 ((_ to_fp 8 24) RNE 129))) (_ bv1 32) (_ bv0 32))))
