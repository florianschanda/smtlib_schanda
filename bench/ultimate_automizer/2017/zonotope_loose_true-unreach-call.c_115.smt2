...
(assert (let ((v_main_~y~6_BEFORE_CALL_2 v_main_~y~6_BEFORE_CALL_2_const_1133159894)) (and (exists ((main_~x~6 (_ FloatingPoint 11 53))) (and (not (fp.geq (fp.sub RNE (fp.mul RNE main_~x~6 main_~x~6) main_~x~6) ((_ to_fp 11 53) RNE (_ bv0 32)))) (fp.leq main_~x~6 ((_ to_fp 11 53) RNE 10)) (= (fp.add RNE (fp.mul RNE main_~x~6 main_~x~6) ((_ to_fp 11 53) RNE 2)) v_main_~y~6_BEFORE_CALL_2))) (or (not (fp.geq v_main_~y~6_BEFORE_CALL_2 (_ +zero 11 53))) (not (fp.leq v_main_~y~6_BEFORE_CALL_2 ((_ to_fp 11 53) RNE 105)))))))
(check-sat)
(exit)
