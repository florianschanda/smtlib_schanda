...
(assert (exists ((main_~x~6 (_ FloatingPoint 11 53))) (and (not (fp.geq (fp.sub RNE (fp.mul RNE main_~x~6 main_~x~6) main_~x~6) ((_ to_fp 11 53) RNE (_ bv0 32)))) (fp.leq main_~x~6 ((_ to_fp 11 53) RNE 10)) (= (fp.add RNE (fp.mul RNE main_~x~6 main_~x~6) ((_ to_fp 11 53) RNE 2)) c_main_~y~6))))
(check-sat)
(exit)
