...
(declare-fun main_~Y~6_const_259330586 () (_ FloatingPoint 8 24))
(declare-fun main_~D~6_const_259433799 () (_ FloatingPoint 8 24))
(declare-fun main_~S~6_const_259456400 () (_ FloatingPoint 8 24))
(assert (= ((_ to_fp 8 24) RNE (_ bv0 32)) main_~S~6_const_259456400))
(assert (fp.leq main_~D~6_const_259433799 ((_ to_fp 8 24) RNE 16)))
(assert (fp.geq main_~D~6_const_259433799 (_ +zero 8 24)))
(assert (not (exists ((main_~D~6 (_ FloatingPoint 8 24)) (v_prenex_2 (_ FloatingPoint 8 24)) (main_~X~6 (_ FloatingPoint 8 24))) (and (fp.leq v_prenex_2 ((_ to_fp 8 24) RNE 16)) (fp.geq v_prenex_2 (_ +zero 8 24)) (fp.geq main_~D~6 (_ +zero 8 24)) (= main_~Y~6_const_259330586 (fp.add RNE (fp.sub RNE ((_ to_fp 8 24) RNE (_ bv0 32)) v_prenex_2) main_~D~6)) (fp.leq main_~D~6 ((_ to_fp 8 24) RNE 16)) (fp.geq (fp.sub RNE main_~X~6 (fp.sub RNE ((_ to_fp 8 24) RNE (_ bv0 32)) v_prenex_2)) main_~D~6)))))
(check-sat)
(exit)
