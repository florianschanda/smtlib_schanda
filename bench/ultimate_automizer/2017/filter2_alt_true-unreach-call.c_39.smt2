...
(declare-fun c_~INIT () (_ BitVec 32))
(declare-fun c_~E~7 () (Array (_ BitVec 32) (_ FloatingPoint 8 24)))
(declare-fun c_~S~7 () (Array (_ BitVec 32) (_ FloatingPoint 8 24)))
(assert (= ~unnamed0~FALSE (_ bv0 32)))
(assert (= ~unnamed0~TRUE (_ bv1 32)))
(assert (and (= c_~INIT (_ bv0 32)) (= c_~P_primed (fp.sub RNE (fp.add RNE (fp.add RNE (fp.sub RNE (fp.mul RNE ((_ to_fp 8 24) RNE 0.4677826) c_~X) (fp.mul RNE (select c_~E~7 (_ bv0 32)) ((_ to_fp 8 24) RNE 0.7700725))) (fp.mul RNE (select c_~E~7 (_ bv1 32)) ((_ to_fp 8 24) RNE 0.4344376))) (fp.mul RNE (select c_~S~7 (_ bv0 32)) ((_ to_fp 8 24) RNE 1.5419))) (fp.mul RNE (select c_~S~7 (_ bv1 32)) ((_ to_fp 8 24) RNE 0.6740477))))))
(assert (not (= ~unnamed0~TRUE c_~INIT)))
(check-sat)
(exit)
