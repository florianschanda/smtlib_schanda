...
(assert (and (bvslt c_main_~i~4 (_ bv100 32)) (= c_main_~x2~4_primed (fp.sub RNE ((_ to_fp 11 53) RNE 111) (fp.div RNE (fp.sub RNE ((_ to_fp 11 53) RNE 1130) (fp.div RNE ((_ to_fp 11 53) RNE 3000) c_main_~x0~4)) c_main_~x1~4))) (= c_main_~x0~4_primed c_main_~x1~4) (= c_main_~x1~4_primed c_main_~x2~4_primed)))
(assert (= (bvadd c_main_~i~4 (_ bv4294967295 32)) (_ bv0 32)))
(check-sat)
(exit)
