...
(assert (= |c___VERIFIER_assert_#in~cond| (ite (and (fp.geq c_main_~Y~6_Hier (fp.neg ((_ to_fp 8 24) RNE 129))) (fp.leq c_main_~Y~6_Hier ((_ to_fp 8 24) RNE 129))) (_ bv1 32) (_ bv0 32))))
