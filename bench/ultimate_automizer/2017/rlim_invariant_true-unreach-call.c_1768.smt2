...
(assert (and (fp.leq c_main_~Y~6 ((_ to_fp 8 24) RNE 128)) (fp.leq c_main_~S~6 ((_ to_fp 8 24) RNE 128)) (fp.geq c_main_~Y~6 (fp.neg ((_ to_fp 8 24) RNE 128))) (exists ((v_prenex_4 (_ FloatingPoint 8 24))) (and (fp.geq v_prenex_4 (_ +zero 8 24)) (not (fp.leq (fp.sub RNE c_main_~S~6 ((_ to_fp 8 24) RNE (_ bv0 32))) (fp.neg v_prenex_4))) (fp.leq v_prenex_4 ((_ to_fp 8 24) RNE 16)))) (fp.geq c_main_~D~6 (_ +zero 8 24)) (= c_main_~R~6 (fp.sub RNE c_main_~Y~6 ((_ to_fp 8 24) RNE (_ bv0 32)))) (fp.leq c_main_~D~6 ((_ to_fp 8 24) RNE 16)) (exists ((main_~X~6 (_ FloatingPoint 8 24))) (= c_main_~R~6 (fp.sub RNE main_~X~6 c_main_~S~6)))))
(assert (not (and (fp.leq c_main_~Y~6_primed ((_ to_fp 8 24) RNE 128)) (exists ((main_~D~6 (_ FloatingPoint 8 24))) (and (fp.geq main_~D~6 (_ +zero 8 24)) (fp.leq main_~D~6 ((_ to_fp 8 24) RNE 16)) (not (fp.leq (fp.sub RNE c_main_~Y~6_primed ((_ to_fp 8 24) RNE (_ bv0 32))) (fp.neg main_~D~6))))))))
(check-sat)
(exit)
