...
(assert (exists ((main_~x~6 (_ FloatingPoint 11 53))) (and (= (fp.div RNE main_~x~6 ((_ to_fp 11 53) RNE 10)) c_main_~y~6) (fp.geq (fp.sub RNE (fp.mul RNE main_~x~6 main_~x~6) main_~x~6) ((_ to_fp 11 53) RNE (_ bv0 32))) (fp.leq main_~x~6 ((_ to_fp 11 53) RNE 10)) (fp.geq main_~x~6 (_ +zero 11 53)))))
(check-sat)
(exit)
