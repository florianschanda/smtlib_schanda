...
(assert (not (exists ((~Y~8 (_ FloatingPoint 8 24))) (and (fp.geq ~Y~8 (fp.neg ((_ to_fp 8 24) RNE 1))) (fp.leq ~Y~8 ((_ to_fp 8 24) RNE 1)) (= c_~X~8 (fp.add RNE (fp.add RNE (fp.mul RNE ((_ to_fp 8 24) RNE 0.50000001) ~Y~8) (fp.mul RNE ((_ to_fp 8 24) RNE 0.30000001) ~Y~8)) (fp.mul RNE ((_ to_fp 8 24) RNE 0.20000001) ~Y~8)))))))
(check-sat)
(exit)
