...
(assert (and (fp.gt c_~C1 (_ +zero 8 24)) (fp.geq c_~I (fp.neg ((_ to_fp 8 24) RNE 1))) (fp.leq c_~I ((_ to_fp 8 24) RNE 1)) (fp.leq c_~Z~8 ((_ to_fp 8 24) RNE 1)) (fp.geq c_~Z~8 (fp.neg ((_ to_fp 8 24) RNE 1))) (= c_~X~8 c_~Z~8) (= c_~X~8 c_~Y~8)))
