...
(assert (and (fp.gt c_~C1 (_ +zero 8 24)) (fp.geq c_~I (fp.neg ((_ to_fp 8 24) RNE 1))) (fp.leq c_~I ((_ to_fp 8 24) RNE 1)) (= c___VERIFIER_assert_~cond |c___VERIFIER_assert_#in~cond|)))
