...
(assert (not (exists ((main_~E0~7 (_ FloatingPoint 11 53))) (and (= (fp.sub RNE (fp.add RNE (fp.mul RNE ((_ to_fp 11 53) RNE 0.999) ((_ to_fp 11 53) RNE (_ bv0 32))) main_~E0~7) ((_ to_fp 11 53) RNE (_ bv0 32))) c_main_~S~7_primed) (fp.geq main_~E0~7 (fp.neg ((_ to_fp 11 53) RNE 1))) (fp.leq main_~E0~7 ((_ to_fp 11 53) RNE 1))))))
(check-sat)
(exit)
