...
(assert (and (fp.gt c_~C1 (_ +zero 8 24)) (fp.geq c_~I (fp.neg ((_ to_fp 8 24) RNE 1))) (fp.geq |c_RANDOM_INPUT_#res| (fp.neg ((_ to_fp 8 24) RNE 1))) (fp.leq c_~I ((_ to_fp 8 24) RNE 1)) (fp.leq |c_RANDOM_INPUT_#res| ((_ to_fp 8 24) RNE 1))))
