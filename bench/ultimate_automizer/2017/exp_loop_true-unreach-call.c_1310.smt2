...
(assert (exists ((main_~a~17 (_ FloatingPoint 8 24))) (and (= c_main_~c~17 (fp.mul RNE (fp.div RNE main_~a~17 (fp.mul RNE ((_ to_fp 8 24) RNE 0.5) ((_ to_fp 8 24) RNE 2))) ((_ to_fp 8 24) RNE ((_ to_fp 11 53) RNE 1)))) (fp.geq main_~a~17 (_ +zero 8 24)) (not (fp.geq main_~a~17 ((_ to_fp 8 24) RNE 1))) (not (fp.gt ((_ to_fp 8 24) RNE 0.5) main_~a~17)))))
(check-sat)
(exit)
