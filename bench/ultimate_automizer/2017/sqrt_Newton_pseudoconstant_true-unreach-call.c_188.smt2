...
(assert (and (not (= c_SqrtR_~cond~6 (_ bv0 32))) (= c_SqrtR_~xnp1~6_primed (fp.add RNE c_SqrtR_~xn~6 (fp.div RNE (fp.mul RNE c_SqrtR_~xn~6 (fp.sub RNE ((_ to_fp 11 53) RNE (_ bv1 32)) (fp.mul RNE (fp.mul RNE c_SqrtR_~Input c_SqrtR_~xn~6) c_SqrtR_~xn~6))) ((_ to_fp 11 53) RNE 2)))) (= c_SqrtR_~residu~6_primed (fp.mul RNE ((_ to_fp 11 53) RNE 2) (fp.sub RNE c_SqrtR_~xnp1~6_primed c_SqrtR_~xn~6))) (= c_SqrtR_~xn~6_primed c_SqrtR_~xnp1~6_primed) (= c_SqrtR_~lsup~6_primed (fp.mul RNE c_~_EPS (fp.add RNE c_SqrtR_~xn~6_primed c_SqrtR_~xnp1~6_primed))) (= c_SqrtR_~linf~6_primed (fp.neg c_SqrtR_~lsup~6_primed)) (= c_SqrtR_~cond~6_primed (ite (or (fp.gt c_SqrtR_~residu~6_primed c_SqrtR_~lsup~6_primed) (fp.lt c_SqrtR_~residu~6_primed c_SqrtR_~linf~6_primed)) (_ bv1 32) (_ bv0 32))) (= (bvadd c_SqrtR_~i~6_primed (_ bv4294967295 32)) c_SqrtR_~i~6)))
(assert (not (= ((_ to_fp 11 53) RNE 1) c_SqrtR_~xnp1~6_primed)))
(check-sat)
(exit)
