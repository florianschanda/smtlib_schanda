...
(assert (exists ((main_~a~17 (_ FloatingPoint 8 24))) (and (not (fp.leq ((_ to_fp 8 24) RNE 2) main_~a~17)) (= (fp.mul RNE (fp.div RNE main_~a~17 ((_ to_fp 8 24) RNE 2)) ((_ to_fp 8 24) RNE ((_ to_fp 11 53) RNE 1))) |c_main_#t~ret9|) (fp.geq main_~a~17 ((_ to_fp 8 24) RNE 1)))))
(assert (not (= (fp.mul RNE |c_LDEXP_#in~d| ((_ to_fp 8 24) RNE ((_ to_fp 11 53) RNE 1))) |c_LDEXP_#res|)))
(check-sat)
(exit)
