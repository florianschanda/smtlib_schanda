...
(assert (not (or (not (let ((_cse0 (fp.sub c_currentRoundingMode c_cos_double_~x c_cos_double_~x))) (fp.eq _cse0 _cse0))) (let ((_cse1 (fp.sub c_currentRoundingMode |c_cos_double_#in~x| |c_cos_double_#in~x|))) (fp.eq _cse1 _cse1)))))
(check-sat)
(exit)
