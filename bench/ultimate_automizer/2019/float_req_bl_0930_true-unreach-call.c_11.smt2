...
(assert (not (exists ((v___ieee754_logf_~ix~0_63 (_ BitVec 32))) (and (not (bvslt v___ieee754_logf_~ix~0_63 (_ bv0 32))) (= (bvadd (bvashr v___ieee754_logf_~ix~0_63 (_ bv23 32)) (_ bv4294967169 32)) c___ieee754_logf_~k~0) (= (fp ((_ extract 31 31) v___ieee754_logf_~ix~0_63) ((_ extract 30 23) v___ieee754_logf_~ix~0_63) ((_ extract 22 0) v___ieee754_logf_~ix~0_63)) |c___ieee754_logf_#in~x|) (= (bvand (_ bv8388608 32) (bvadd (bvand (_ bv8388607 32) v___ieee754_logf_~ix~0_63) (_ bv4913952 32))) c___ieee754_logf_~i~0_primed)))))
(check-sat)
(exit)
