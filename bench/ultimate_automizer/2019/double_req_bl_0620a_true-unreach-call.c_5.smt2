...
(assert (and (= c_atan_double_~x_primed (fp.div c_currentRoundingMode (fp.neg ((_ to_fp 11 53) c_currentRoundingMode 1)) c_atan_double_~x)) (= c_atan_double_~id~0_primed (_ bv3 32)) (not (bvslt c_atan_double_~ix~0 (_ bv1073971200 32)))))
