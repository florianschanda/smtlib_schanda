...
(assert (and (exists ((v_skolemized_v_prenex_5_3 (_ BitVec 64))) (let ((_cse0 (bvand (_ bv2147483647 32) ((_ extract 63 32) v_skolemized_v_prenex_5_3)))) (and (= |c___ieee754_asin_#in~x| (fp ((_ extract 63 63) v_skolemized_v_prenex_5_3) ((_ extract 62 52) v_skolemized_v_prenex_5_3) ((_ extract 51 0) v_skolemized_v_prenex_5_3))) (not (bvslt _cse0 (_ bv1044381696 32))) (not (bvsge _cse0 (_ bv1072693248 32)))))) (exists ((v_skolemized_v_prenex_5_3 (_ BitVec 64))) (and (= |c___ieee754_asin_#in~x| (fp ((_ extract 63 63) v_skolemized_v_prenex_5_3) ((_ extract 62 52) v_skolemized_v_prenex_5_3) ((_ extract 51 0) v_skolemized_v_prenex_5_3))) (= c___ieee754_asin_~ix~0 (bvand (_ bv2147483647 32) ((_ extract 63 32) v_skolemized_v_prenex_5_3))))) (= |c___ieee754_asin_#in~x| c___ieee754_asin_~x) (exists ((v_skolemized_v_prenex_5_3 (_ BitVec 64))) (and (= |c___ieee754_asin_#in~x| (fp ((_ extract 63 63) v_skolemized_v_prenex_5_3) ((_ extract 62 52) v_skolemized_v_prenex_5_3) ((_ extract 51 0) v_skolemized_v_prenex_5_3))) (= ((_ extract 63 32) v_skolemized_v_prenex_5_3) c___ieee754_asin_~hx~0)))))
(assert (not false))
(check-sat)
(exit)
