...
(declare-fun c___ieee754_logf_~x () (_ FloatingPoint 8 24))
...
(assert (not (or (forall ((|v_skolemized_q#valueAsBitvector_10| (_ BitVec 32))) (or (not (= (fp.add c_currentRoundingMode c___ieee754_logf_~x c___ieee754_logf_~x) (fp ((_ extract 31 31) |v_skolemized_q#valueAsBitvector_10|) ((_ extract 30 23) |v_skolemized_q#valueAsBitvector_10|) ((_ extract 22 0) |v_skolemized_q#valueAsBitvector_10|)))) (= (bvadd ((_ sign_extend 32) (bvand (_ bv2147483647 32) |v_skolemized_q#valueAsBitvector_10|)) (_ bv18446744071570456576 64)) (_ bv0 64)))) (exists ((v_prenex_7 (_ BitVec 32))) (and (= (fp ((_ extract 31 31) v_prenex_7) ((_ extract 30 23) v_prenex_7) ((_ extract 22 0) v_prenex_7)) (fp.add c_currentRoundingMode |c___ieee754_logf_#in~x| |c___ieee754_logf_#in~x|)) (not (= (bvadd ((_ sign_extend 32) (bvand (_ bv2147483647 32) v_prenex_7)) (_ bv18446744071570456576 64)) (_ bv0 64))))))))
(check-sat)
(exit)
