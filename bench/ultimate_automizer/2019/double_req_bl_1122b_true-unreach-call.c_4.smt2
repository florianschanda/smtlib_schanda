...
(assert (and (= (let ((_cse0 (fp.mul v_currentRoundingMode_15 v_fmod_double_~x_14 v_fmod_double_~y_8))) (fp.div v_currentRoundingMode_15 _cse0 _cse0)) |v_fmod_double_#res_12|) (= |v_fmod_double_#in~x_5| v_fmod_double_~x_14) (= |v_fmod_double_#res_12| |v_main_#t~ret17_10|) (= |v_fmod_double_#in~x_5| v_main_~x~0_4)))
(check-sat)
(exit)
