...
(assert (not (exists ((currentRoundingMode RoundingMode)) (= (fp.div currentRoundingMode (fp.neg ((_ to_fp 8 24) currentRoundingMode ((_ to_fp 11 53) currentRoundingMode 33554432))) ((_ to_fp 8 24) currentRoundingMode (_ +zero 11 53))) |c_main_#t~ret8|))))
(check-sat)
(exit)
