...
(assert (or (exists ((v_prenex_5 (_ BitVec 32))) (and (bvslt v_prenex_5 (_ bv0 32)) (= |c___ieee754_logf_#in~x| (fp ((_ extract 31 31) v_prenex_5) ((_ extract 30 23) v_prenex_5) ((_ extract 22 0) v_prenex_5))))) (not (bvslt c___ieee754_logf_~ix~0 (_ bv0 32)))))
(assert (not false))
(check-sat)
(exit)
