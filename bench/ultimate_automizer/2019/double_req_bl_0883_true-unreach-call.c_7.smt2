...
(declare-fun |c___ieee754_pow_#res_primed| () (_ FloatingPoint 11 53))
...
(assert (and (= |c___ieee754_pow_#res_primed| (fp.div c_currentRoundingMode c_~one_pow~0 c___ieee754_pow_~x)) (bvslt c___ieee754_pow_~hy~1 (_ bv0 32))))
...
(assert (not (exists ((__ieee754_pow_~lx~1 (_ BitVec 32)) (v_skolemized_v_prenex_12_3 (_ BitVec 64))) (and (= (bvor (bvadd (bvand (_ bv2147483647 32) ((_ extract 63 32) v_skolemized_v_prenex_12_3)) (_ bv3222274048 32)) __ieee754_pow_~lx~1) (_ bv0 32)) (= (fp ((_ extract 63 63) v_skolemized_v_prenex_12_3) ((_ extract 62 52) v_skolemized_v_prenex_12_3) ((_ extract 51 0) v_skolemized_v_prenex_12_3)) |c___ieee754_pow_#in~x|)))))
(check-sat)
(exit)
