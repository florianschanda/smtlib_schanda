...
(assert (not (= |c___ieee754_logf_#in~x| (fp ((_ extract 31 31) c___ieee754_logf_~ix~0) ((_ extract 30 23) c___ieee754_logf_~ix~0) ((_ extract 22 0) c___ieee754_logf_~ix~0)))))
(check-sat)
(exit)
