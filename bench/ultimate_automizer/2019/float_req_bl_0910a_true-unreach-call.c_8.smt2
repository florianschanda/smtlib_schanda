...
(assert (and (= c___ieee754_logf_~t2~0_primed (fp.mul c_currentRoundingMode c___ieee754_logf_~z~0_primed (fp.add c_currentRoundingMode c_~Lg1_log~0 (fp.mul c_currentRoundingMode c___ieee754_logf_~w~0_primed (fp.add c_currentRoundingMode c_~Lg3_log~0 (fp.mul c_currentRoundingMode c___ieee754_logf_~w~0_primed (fp.add c_currentRoundingMode c_~Lg5_log~0 (fp.mul c_currentRoundingMode c___ieee754_logf_~w~0_primed c_~Lg7_log~0)))))))) (= c___ieee754_logf_~s~0_primed (fp.div c_currentRoundingMode c___ieee754_logf_~f~0 (fp.add c_currentRoundingMode ((_ to_fp 8 24) c_currentRoundingMode ((_ to_fp 11 53) c_currentRoundingMode 2)) c___ieee754_logf_~f~0))) (= c___ieee754_logf_~z~0_primed (fp.mul c_currentRoundingMode c___ieee754_logf_~s~0_primed c___ieee754_logf_~s~0_primed)) (= c___ieee754_logf_~R~0_primed (fp.add c_currentRoundingMode c___ieee754_logf_~t2~0_primed c___ieee754_logf_~t1~0_primed)) (not (bvslt (bvand (_ bv8388607 32) (bvadd c___ieee754_logf_~ix~1 (_ bv15 32))) (_ bv16 32))) (= (bvor (bvadd c___ieee754_logf_~ix~1 (_ bv4291779632 32)) c___ieee754_logf_~j~0_primed) c___ieee754_logf_~i~0_primed) (= c___ieee754_logf_~t1~0_primed (fp.mul c_currentRoundingMode c___ieee754_logf_~w~0_primed (fp.add c_currentRoundingMode c_~Lg2_log~0 (fp.mul c_currentRoundingMode c___ieee754_logf_~w~0_primed (fp.add c_currentRoundingMode c_~Lg4_log~0 (fp.mul c_currentRoundingMode c___ieee754_logf_~w~0_primed c_~Lg6_log~0)))))) (= c___ieee754_logf_~dk~0_primed ((_ to_fp 8 24) c_currentRoundingMode c___ieee754_logf_~k~0)) (= c___ieee754_logf_~j~0_primed (bvadd (bvneg c___ieee754_logf_~ix~1) (_ bv3523208 32))) (= c___ieee754_logf_~w~0_primed (fp.mul c_currentRoundingMode c___ieee754_logf_~z~0_primed c___ieee754_logf_~z~0_primed))))
(assert (or (exists ((v_prenex_6 (_ BitVec 32))) (and (bvslt v_prenex_6 (_ bv0 32)) (= |c___ieee754_logf_#in~x| (fp ((_ extract 31 31) v_prenex_6) ((_ extract 30 23) v_prenex_6) ((_ extract 22 0) v_prenex_6))))) (not (bvslt c___ieee754_logf_~ix~1 (_ bv0 32)))))
(assert (not (exists ((__ieee754_logf_~ix~1 (_ BitVec 32))) (and (= (fp ((_ extract 31 31) __ieee754_logf_~ix~1) ((_ extract 30 23) __ieee754_logf_~ix~1) ((_ extract 22 0) __ieee754_logf_~ix~1)) |c___ieee754_logf_#in~x|) (bvslt __ieee754_logf_~ix~1 (_ bv0 32))))))
(check-sat)
(exit)
