...
(assert (not (= (let ((_cse0 (fp.sub c_currentRoundingMode |c___ieee754_asinf_#in~x| |c___ieee754_asinf_#in~x|))) (fp.div c_currentRoundingMode _cse0 _cse0)) |c___ieee754_asinf_#res_primed|)))
(check-sat)
(exit)
