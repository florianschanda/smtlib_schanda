...
(assert (and (or (not (bvsgt c___ieee754_logf_~i~0 (_ bv0 32))) (exists ((__ieee754_logf_~j~0 (_ BitVec 32)) (v___ieee754_logf_~ix~0_38 (_ BitVec 32))) (and (= (fp ((_ extract 31 31) v___ieee754_logf_~ix~0_38) ((_ extract 30 23) v___ieee754_logf_~ix~0_38) ((_ extract 22 0) v___ieee754_logf_~ix~0_38)) |c___ieee754_logf_#in~x|) (bvsgt (bvor (bvadd (bvand (_ bv8388607 32) v___ieee754_logf_~ix~0_38) (_ bv4291779632 32)) __ieee754_logf_~j~0) (_ bv0 32))))) (exists ((v___ieee754_logf_~ix~0_38 (_ BitVec 32))) (and (= (fp ((_ extract 31 31) v___ieee754_logf_~ix~0_38) ((_ extract 30 23) v___ieee754_logf_~ix~0_38) ((_ extract 22 0) v___ieee754_logf_~ix~0_38)) |c___ieee754_logf_#in~x|) (= (bvand (_ bv8388607 32) v___ieee754_logf_~ix~0_38) c___ieee754_logf_~ix~0)))))
(assert (not false))
(check-sat)
(exit)
