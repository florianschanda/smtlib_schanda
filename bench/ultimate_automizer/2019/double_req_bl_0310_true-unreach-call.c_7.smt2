...
(assert (not (or (not (bvsge c_cos_double_~ix~3 (_ bv2146435072 32))) (not (let ((_cse0 (fp.sub c_currentRoundingMode c_cos_double_~x c_cos_double_~x))) (fp.eq _cse0 _cse0))))))
(check-sat)
(exit)
