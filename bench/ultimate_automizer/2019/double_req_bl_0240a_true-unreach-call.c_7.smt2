...
(assert (not (or (not (fp.eq |c_sin_double_#res| |c_sin_double_#res|)) (let ((_cse0 (fp.sub c_currentRoundingMode |c_sin_double_#in~x| |c_sin_double_#in~x|))) (fp.eq _cse0 _cse0)))))
(check-sat)
(exit)
