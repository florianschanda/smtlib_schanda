...
(assert (and (not (bvslt c_atan_double_~ix~0 (_ bv1072037888 32))) (= c_atan_double_~x_primed (fp.div c_currentRoundingMode (fp.sub c_currentRoundingMode c_atan_double_~x c_~one_atan~0) (fp.add c_currentRoundingMode c_atan_double_~x c_~one_atan~0))) (= c_atan_double_~id~0_primed (_ bv1 32))))
