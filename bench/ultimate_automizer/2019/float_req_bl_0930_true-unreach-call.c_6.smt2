...
(assert (not (exists ((v___ieee754_logf_~ix~0_47 (_ BitVec 32))) (and (= (bvand (_ bv8388607 32) v___ieee754_logf_~ix~0_47) c___ieee754_logf_~ix~0) (= (fp ((_ extract 31 31) v___ieee754_logf_~ix~0_47) ((_ extract 30 23) v___ieee754_logf_~ix~0_47) ((_ extract 22 0) v___ieee754_logf_~ix~0_47)) |c___ieee754_logf_#in~x|)))))
(check-sat)
(exit)
