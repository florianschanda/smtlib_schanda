...
(assert (not (or (forall ((|v_skolemized_q#valueAsBitvector_7| (_ BitVec 32))) (or (not (bvslt |v_skolemized_q#valueAsBitvector_7| (_ bv0 32))) (not (= c___ieee754_logf_~x (fp ((_ extract 31 31) |v_skolemized_q#valueAsBitvector_7|) ((_ extract 30 23) |v_skolemized_q#valueAsBitvector_7|) ((_ extract 22 0) |v_skolemized_q#valueAsBitvector_7|)))))) (exists ((v_prenex_6 (_ BitVec 32))) (and (bvslt v_prenex_6 (_ bv0 32)) (= |c___ieee754_logf_#in~x| (fp ((_ extract 31 31) v_prenex_6) ((_ extract 30 23) v_prenex_6) ((_ extract 22 0) v_prenex_6))))))))
(check-sat)
(exit)
