...
(assert (not (exists ((fabs_float_~ix~4 (_ BitVec 32))) (and (= |c_fabs_float_#res| (let ((_cse0 (bvand (_ bv2147483647 32) fabs_float_~ix~4))) (fp ((_ extract 31 31) _cse0) ((_ extract 30 23) _cse0) ((_ extract 22 0) _cse0)))) (= (fp ((_ extract 31 31) fabs_float_~ix~4) ((_ extract 30 23) fabs_float_~ix~4) ((_ extract 22 0) fabs_float_~ix~4)) |c_fabs_float_#in~x|)))))
(check-sat)
(exit)
