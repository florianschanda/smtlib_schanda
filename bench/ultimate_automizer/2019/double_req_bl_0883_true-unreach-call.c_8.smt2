...
(assert (and (= c___ieee754_pow_~w~0_primed (fp.mul c_currentRoundingMode (fp.mul c_currentRoundingMode c___ieee754_pow_~t~1_primed c___ieee754_pow_~t~1_primed) (fp.sub c_currentRoundingMode ((_ to_fp 11 53) c_currentRoundingMode (/ 1 2)) (fp.mul c_currentRoundingMode c___ieee754_pow_~t~1_primed (fp.sub c_currentRoundingMode ((_ to_fp 11 53) c_currentRoundingMode (/ 3333333333333333333333 10000000000000000000000)) (fp.mul c_currentRoundingMode c___ieee754_pow_~t~1_primed ((_ to_fp 11 53) c_currentRoundingMode (/ 1 4)))))))) (= c___ieee754_pow_~t1~1_primed (fp.add c_currentRoundingMode c___ieee754_pow_~u~0_primed c___ieee754_pow_~v~0_primed)) (= c___ieee754_pow_~u~0_primed (fp.mul c_currentRoundingMode c_~ivln2_h_pow~0 c___ieee754_pow_~t~1_primed)) (= c___ieee754_pow_~t~1_primed (fp.sub c_currentRoundingMode c___ieee754_pow_~ax~0 ((_ to_fp 11 53) c_currentRoundingMode (_ bv1 32)))) (= c___ieee754_pow_~v~0_primed (fp.sub c_currentRoundingMode (fp.mul c_currentRoundingMode c___ieee754_pow_~t~1_primed c_~ivln2_l_pow~0) (fp.mul c_currentRoundingMode c___ieee754_pow_~w~0_primed c_~ivln2_pow~0))) (not (bvsgt c___ieee754_pow_~ix~0 (_ bv1072693248 32)))))
