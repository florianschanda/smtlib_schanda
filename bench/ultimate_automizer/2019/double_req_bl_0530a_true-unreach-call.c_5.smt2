...
(assert (not (exists ((|v_skolemized_q#valueAsBitvector_107| (_ BitVec 64))) (let ((_cse0 (bvand (_ bv2147483647 32) ((_ extract 63 32) |v_skolemized_q#valueAsBitvector_107|)))) (and (not (bvsge _cse0 (_ bv1072010280 32))) (not (bvslt _cse0 (_ bv1043333120 32))) (= |c_tan_double_#in~x| (fp ((_ extract 63 63) |v_skolemized_q#valueAsBitvector_107|) ((_ extract 62 52) |v_skolemized_q#valueAsBitvector_107|) ((_ extract 51 0) |v_skolemized_q#valueAsBitvector_107|))))))))
(check-sat)
(exit)
