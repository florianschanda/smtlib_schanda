...
(assert (and (= ((_ to_fp 8 24) c_currentRoundingMode ((_ to_fp 11 53) c_currentRoundingMode 33554432)) c_~two25_log~0) (= |c_isinf_float_#in~x| c_isinf_float_~x) (= ((_ to_fp 8 24) c_currentRoundingMode (_ +zero 11 53)) c_~zero_log~0) (= |c_isinf_float_#in~x| (fp ((_ extract 31 31) c_isinf_float_~ix~0) ((_ extract 30 23) c_isinf_float_~ix~0) ((_ extract 22 0) c_isinf_float_~ix~0)))))
