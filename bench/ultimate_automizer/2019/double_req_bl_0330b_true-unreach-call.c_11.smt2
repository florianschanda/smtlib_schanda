...
(assert (not (or (let ((_cse0 (fp.sub c_currentRoundingMode |c_cos_double_#in~x| |c_cos_double_#in~x|))) (fp.eq _cse0 _cse0)) (not (fp.eq |c_cos_double_#res| |c_cos_double_#res|)))))
(check-sat)
(exit)
