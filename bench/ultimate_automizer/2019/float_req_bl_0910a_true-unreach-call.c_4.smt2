...
(assert (not (or (= (bvadd ((_ sign_extend 32) (bvand (_ bv2147483647 32) c_isinf_float_~ix~0)) (_ bv18446744071570456576 64)) (_ bv0 64)) (exists ((v_skolemized_v_prenex_1_6 (_ BitVec 32))) (and (= (fp ((_ extract 31 31) v_skolemized_v_prenex_1_6) ((_ extract 30 23) v_skolemized_v_prenex_1_6) ((_ extract 22 0) v_skolemized_v_prenex_1_6)) |c_isinf_float_#in~x|) (not (= (_ bv2139095040 64) ((_ sign_extend 32) (bvand (_ bv2147483647 32) v_skolemized_v_prenex_1_6)))))))))
(check-sat)
(exit)
