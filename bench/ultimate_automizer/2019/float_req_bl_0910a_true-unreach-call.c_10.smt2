...
(assert (or (bvslt ((_ sign_extend 32) c___ieee754_logf_~ix~1) (_ bv2139095040 64)) (exists ((v_prenex_7 (_ BitVec 32))) (and (not (bvslt v_prenex_7 (_ bv0 32))) (not (bvslt ((_ sign_extend 32) v_prenex_7) (_ bv2139095040 64))) (= (fp ((_ extract 31 31) v_prenex_7) ((_ extract 30 23) v_prenex_7) ((_ extract 22 0) v_prenex_7)) |c___ieee754_logf_#in~x|)))))
(assert (not (or (exists ((v_prenex_7 (_ BitVec 32))) (and (not (bvslt v_prenex_7 (_ bv0 32))) (not (bvslt ((_ sign_extend 32) v_prenex_7) (_ bv2139095040 64))) (= (fp ((_ extract 31 31) v_prenex_7) ((_ extract 30 23) v_prenex_7) ((_ extract 22 0) v_prenex_7)) |c___ieee754_logf_#in~x|))) (forall ((|v_skolemized_q#valueAsBitvector_9| (_ BitVec 32))) (or (not (= c___ieee754_logf_~x (fp ((_ extract 31 31) |v_skolemized_q#valueAsBitvector_9|) ((_ extract 30 23) |v_skolemized_q#valueAsBitvector_9|) ((_ extract 22 0) |v_skolemized_q#valueAsBitvector_9|)))) (bvslt ((_ sign_extend 32) |v_skolemized_q#valueAsBitvector_9|) (_ bv2139095040 64)))))))
(check-sat)
(exit)
