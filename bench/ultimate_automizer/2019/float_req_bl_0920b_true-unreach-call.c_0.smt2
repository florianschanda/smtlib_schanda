...
(assert (and (not (bvslt (bvand (_ bv8388607 32) (bvadd c___ieee754_logf_~ix~1 (_ bv15 32))) (_ bv16 32))) (= c___ieee754_logf_~s~0_primed (fp.div c_currentRoundingMode c___ieee754_logf_~f~0 (fp.add c_currentRoundingMode ((_ to_fp 8 24) c_currentRoundingMode ((_ to_fp 11 53) c_currentRoundingMode 2)) c___ieee754_logf_~f~0))) (= c___ieee754_logf_~dk~0_primed ((_ to_fp 8 24) c_currentRoundingMode c___ieee754_logf_~k~0)) (= c___ieee754_logf_~w~0_primed (fp.mul c_currentRoundingMode c___ieee754_logf_~z~0_primed c___ieee754_logf_~z~0_primed)) (= c___ieee754_logf_~z~0_primed (fp.mul c_currentRoundingMode c___ieee754_logf_~s~0_primed c___ieee754_logf_~s~0_primed)) (= c___ieee754_logf_~t1~0_primed (fp.mul c_currentRoundingMode c___ieee754_logf_~w~0_primed (fp.add c_currentRoundingMode c_~Lg2_log~0 (fp.mul c_currentRoundingMode c___ieee754_logf_~w~0_primed (fp.add c_currentRoundingMode c_~Lg4_log~0 (fp.mul c_currentRoundingMode c___ieee754_logf_~w~0_primed c_~Lg6_log~0)))))) (= c___ieee754_logf_~t2~0_primed (fp.mul c_currentRoundingMode c___ieee754_logf_~z~0_primed (fp.add c_currentRoundingMode c_~Lg1_log~0 (fp.mul c_currentRoundingMode c___ieee754_logf_~w~0_primed (fp.add c_currentRoundingMode c_~Lg3_log~0 (fp.mul c_currentRoundingMode c___ieee754_logf_~w~0_primed (fp.add c_currentRoundingMode c_~Lg5_log~0 (fp.mul c_currentRoundingMode c___ieee754_logf_~w~0_primed c_~Lg7_log~0)))))))) (= (bvor (bvadd c___ieee754_logf_~ix~1 (_ bv4291779632 32)) c___ieee754_logf_~j~0_primed) c___ieee754_logf_~i~0_primed) (= c___ieee754_logf_~j~0_primed (bvadd (bvneg c___ieee754_logf_~ix~1) (_ bv3523208 32))) (= c___ieee754_logf_~R~0_primed (fp.add c_currentRoundingMode c___ieee754_logf_~t2~0_primed c___ieee754_logf_~t1~0_primed))))
