...
(assert (and (= ((_ to_fp 8 24) c_currentRoundingMode ((_ to_fp 11 53) c_currentRoundingMode 33554432)) c_~two25_log~0) (= ((_ to_fp 8 24) c_currentRoundingMode (_ +zero 11 53)) c_~zero_log~0)))
(assert (not (or (exists ((v_skolemized_v_prenex_1_6 (_ BitVec 32))) (and (= (fp ((_ extract 31 31) v_skolemized_v_prenex_1_6) ((_ extract 30 23) v_skolemized_v_prenex_1_6) ((_ extract 22 0) v_skolemized_v_prenex_1_6)) |c_isinf_float_#in~x|) (not (= (_ bv2139095040 64) ((_ sign_extend 32) (bvand (_ bv2147483647 32) v_skolemized_v_prenex_1_6)))))) (not (= (_ bv0 32) |c_isinf_float_#res|)))))
(check-sat)
(exit)
