...
(assert (not (or (forall ((v_prenex_5 (_ BitVec 32))) (or (not (= |c___ieee754_logf_#res| (fp ((_ extract 31 31) v_prenex_5) ((_ extract 30 23) v_prenex_5) ((_ extract 22 0) v_prenex_5)))) (= (_ bv2139095040 64) ((_ sign_extend 32) (bvand (_ bv2147483647 32) v_prenex_5))))) (exists ((v_skolemized_v_prenex_1_6 (_ BitVec 32))) (and (= (fp.div c_currentRoundingMode (fp.neg c_~two25_log~0) c_~zero_log~0) (fp ((_ extract 31 31) v_skolemized_v_prenex_1_6) ((_ extract 30 23) v_skolemized_v_prenex_1_6) ((_ extract 22 0) v_skolemized_v_prenex_1_6))) (not (= (_ bv2139095040 64) ((_ sign_extend 32) (bvand (_ bv2147483647 32) v_skolemized_v_prenex_1_6)))))))))
(check-sat)
(exit)
