...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.17*u + -0.01*v + 1.0*u^2 + 0.04*u*v + 0.1*v^2 <= 1.26
 and
   u in [-1.1,1.3]
   v in [-3.4,3.5]
...
(assert
 (let ((?x105 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7b #b10011001100110011001100) v!FP) v!FP)))
 (let ((?x305 (fp.add roundNearestTiesToEven ?x105 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b01011100001010001111010) u!FP))))
 ...
 (let ((?x43 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x190 ?x305))))
 (let ((?x183 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x78 #b01000111101011100001010) v!FP) ?x43)))
 (let (($x99 (fp.leq ?x183 (fp #b0 #x7f #b01000010100011110101110))))
 ...
 (let ((?x24 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7b #b10011001100110011001100) vFP) vFP)))
 (let ((?x181 (fp.add roundNearestTiesToEven ?x24 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b01011100001010001111010) uFP))))
 ...
 (let ((?x45 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x300 ?x181))))
 (let ((?x237 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x78 #b01000111101011100001010) vFP) ?x45)))
 (let (($x182 (fp.leq ?x237 (fp #b0 #x7f #b01000010100011110101110))))
 ...
 (and (and (and $x16 $x185 $x132 $x100) $x182 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x257 $x41 $x197 $x280) $x99 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
