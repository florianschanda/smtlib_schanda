...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.19*u + -0.04*v + 1.0*u^2 + 0.03*u*v + 0.1*v^2 <= 0.83
 and
   u in [-0.8,1.0]
   v in [-2.8,3.0]
...
(assert
 ...
 (let ((?x185 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x7a #b01000111101011100001010) v!FP) ?x115)))
 (let (($x113 (fp.leq ?x185 (fp #b0 #x7e #b10101000111101011100001))))
 ...
 (let ((?x311 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x7a #b01000111101011100001010) vFP) ?x143)))
 (let (($x312 (fp.leq ?x311 (fp #b0 #x7e #b10101000111101011100001))))
 ...
 (and (and (and $x109 $x17 $x304 $x104) $x312 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x134 $x205 $x349 $x137) $x113 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
