...
(assert
 (let ((?x253 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7b #b11000010100011110101110) v!FP) v!FP)))
 (let ((?x256 (fp.add roundNearestTiesToEven ?x253 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b00110011001100110011001) u!FP))))
 ...
 (let ((?x232 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x114 ?x256))))
 (let ((?x236 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) v!FP) ?x232)))
 (let (($x241 (fp.leq ?x236 (fp #b0 #x7f #b00110011001100110011001))))
 ...
 (let ((?x200 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7b #b11000010100011110101110) vFP) vFP)))
 (let ((?x283 (fp.add roundNearestTiesToEven ?x200 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b00110011001100110011001) uFP))))
 ...
 (let ((?x206 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x205 ?x283))))
 (let ((?x325 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) vFP) ?x206)))
 (let (($x220 (fp.leq ?x325 (fp #b0 #x7f #b00110011001100110011001))))
 ...
 (and (and (and $x338 $x198 $x29 $x227) $x220 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x124 $x209 $x213 $x308) $x241 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
