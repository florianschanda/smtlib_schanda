...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.15*u + -0.02*v + 1.0*u^2 + 0.04*u*v + 0.1*v^2 <= 1.16
 and
   u in [-1.0,1.2]
   v in [-3.3,3.4]
...
(assert
 (let ((?x123 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7b #b10011001100110011001100) v!FP) v!FP)))
 (let ((?x109 (fp.add roundNearestTiesToEven ?x123 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b00110011001100110011001) u!FP))))
 ...
 (let ((?x276 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x114 ?x109))))
 (let ((?x193 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) v!FP) ?x276)))
 (let (($x245 (fp.leq ?x193 (fp #b0 #x7f #b00101000111101011100001))))
 ...
 (let ((?x41 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7b #b10011001100110011001100) vFP) vFP)))
 (let ((?x47 (fp.add roundNearestTiesToEven ?x41 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b00110011001100110011001) uFP))))
 ...
 (let ((?x105 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x205 ?x47))))
 (let ((?x303 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) vFP) ?x105)))
 (let (($x301 (fp.leq ?x303 (fp #b0 #x7f #b00101000111101011100001))))
 ...
 (and (and (and $x338 $x198 $x29 $x227) $x301 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x124 $x209 $x213 $x308) $x245 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
