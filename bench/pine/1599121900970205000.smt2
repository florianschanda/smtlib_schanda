...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.16*u + -0.02*v + 1.0*u^2 + 0.03*u*v + 0.1*v^2 <= 0.92
 and
   u in [-0.9,1.1]
   v in [-3.0,3.1]
...
(assert
 ...
 (let ((?x229 (fp.add roundNearestTiesToEven ?x239 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b01000111101011100001010) u!FP))))
 ...
 (let ((?x221 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x127 ?x229))))
 (let ((?x259 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) v!FP) ?x221)))
 (let (($x121 (fp.leq ?x259 (fp #b0 #x7e #b11010111000010100011110))))
 ...
 (let ((?x115 (fp.add roundNearestTiesToEven ?x139 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b01000111101011100001010) uFP))))
 ...
 (let ((?x201 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x264 ?x115))))
 (let ((?x233 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) vFP) ?x201)))
 (let (($x282 (fp.leq ?x233 (fp #b0 #x7e #b11010111000010100011110))))
 ...
 (and (and (and $x281 $x134 $x261 $x277) $x282 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x198 $x191 $x181 $x260) $x121 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
