...
(assert
 ...
 (let (($x245 (fp.leq ?x228 (fp #b0 #x7f #b00111000010100011110101))))
 ...
 (let (($x124 (fp.leq ?x200 (fp #b0 #x7f #b00111000010100011110101))))
 ...
 (and (and (and $x16 $x198 $x29 $x227) $x124 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x257 $x209 $x213 $x308) $x245 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
