...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.13*u + -0.02*v + 1.0*u^2 + 0.04*u*v + 0.1*v^2 <= 0.99
 and
   u in [-1.0,1.1]
   v in [-3.0,3.1]
...
(assert
 ...
 (let ((?x197 (fp.add roundNearestTiesToEven ?x239 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b00001010001111010111000) u!FP))))
 ...
 (let ((?x149 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x223 ?x197))))
 (let ((?x231 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) v!FP) ?x149)))
 (let (($x179 (fp.leq ?x231 (fp #b0 #x7e #b11111010111000010100011))))
 ...
 (let ((?x208 (fp.add roundNearestTiesToEven ?x139 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b00001010001111010111000) uFP))))
 ...
 (let ((?x287 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x259 ?x208))))
 (let ((?x252 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) vFP) ?x287)))
 (let (($x196 (fp.leq ?x252 (fp #b0 #x7e #b11111010111000010100011))))
 ...
 (and (and (and $x338 $x134 $x261 $x277) $x196 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x124 $x191 $x181 $x260) $x179 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
