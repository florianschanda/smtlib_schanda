...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -1.0*x1 + -0.33*x2 + 0.85*x1^2 + 0.18*x1*x2 + 0.73*x2^2 <= 0.44
 and
   x1 in [-0.4,1.4]
   x2 in [-0.8,1.0]
...
(assert
 (let ((?x65 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7e #b01110101110000101000111) x2!FP) x2!FP)))
 (let ((?x79 (fp.add roundNearestTiesToEven ?x65 (fp.mul roundNearestTiesToEven (fp #b1 #x7f #b00000000000000000000000) x1!FP))))
 (let ((?x162 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7c #b01110000101000111101011) x1!FP) x2!FP)))
 (let ((?x244 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7e #b10110011001100110011001) x1!FP) x1!FP)))
 (let ((?x219 (fp.add roundNearestTiesToEven ?x244 (fp.add roundNearestTiesToEven ?x162 ?x79))))
 (let ((?x177 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x7d #b01010001111010111000010) x2!FP) ?x219)))
 (let (($x19 (fp.leq ?x177 (fp #b0 #x7d #b11000010100011110101110))))
 ...
 (let ((?x144 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7e #b01110101110000101000111) x2FP) x2FP)))
 (let ((?x115 (fp.add roundNearestTiesToEven ?x144 (fp.mul roundNearestTiesToEven (fp #b1 #x7f #b00000000000000000000000) x1FP))))
 (let ((?x182 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7c #b01110000101000111101011) x1FP) x2FP)))
 (let ((?x135 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7e #b10110011001100110011001) x1FP) x1FP)))
 (let ((?x189 (fp.add roundNearestTiesToEven ?x135 (fp.add roundNearestTiesToEven ?x182 ?x115))))
 (let ((?x229 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x7d #b01010001111010111000010) x2FP) ?x189)))
 (let (($x178 (fp.leq ?x229 (fp #b0 #x7d #b11000010100011110101110))))
 ...
 (and (and (and $x190 $x212 $x142 $x17) $x178 ) (and $x111 (fp.eq x2!FP ?x133)) (not (and (and $x83 $x183 $x138 $x132) $x19 ))))))))))))))))))))))))))))))
(check-sat)
(exit)
