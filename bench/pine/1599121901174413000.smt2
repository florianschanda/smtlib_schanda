...
(assert
 ...
 (let ((?x218 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x127 ?x204))))
 (let ((?x200 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) v!FP) ?x218)))
 (let (($x228 (fp.leq ?x200 (fp #b0 #x7e #b11101011100001010001111))))
 ...
 (let ((?x254 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x264 ?x295))))
 (let ((?x304 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) vFP) ?x254)))
 (let (($x47 (fp.leq ?x304 (fp #b0 #x7e #b11101011100001010001111))))
 ...
 (and (and (and $x281 $x134 $x261 $x277) $x47 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x198 $x191 $x181 $x260) $x228 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
