...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.16*u + 1.0*u^2 + 0.04*u*v + 0.11*v^2 <= 1.43
 and
   u in [-1.2,1.3]
   v in [-3.6,3.5]
...
(assert
 ...
 (let ((?x241 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7a #b01000111101011100001010) u!FP) v!FP)))
 (let ((?x141 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7f #b00000000000000000000000) u!FP) u!FP)))
 (let ((?x198 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x241 ?x296))))
 (let (($x324 (fp.leq ?x198 (fp #b0 #x7f #b01101110000101000111101))))
 ...
 (let ((?x265 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7a #b01000111101011100001010) uFP) vFP)))
 (let ((?x119 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7f #b00000000000000000000000) uFP) uFP)))
 (let ((?x8 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x265 ?x71))))
 (let (($x357 (fp.leq ?x8 (fp #b0 #x7f #b01101110000101000111101))))
 ...
 (and (and (and $x274 $x185 $x34 $x100) $x357 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x283 $x41 $x226 $x280) $x324 )))))))))))))))))))))))))))))))))
(check-sat)
(exit)
