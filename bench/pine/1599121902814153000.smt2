...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.16*u + -0.02*v + 1.0*u^2 + 0.04*u*v + 0.1*v^2 <= 1.1
 and
   u in [-1.0,1.2]
   v in [-3.3,3.4]
...
(assert
 ...
 (let ((?x39 (fp.add roundNearestTiesToEven ?x285 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b01000111101011100001010) u!FP))))
 ...
 (let ((?x324 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x114 ?x39))))
 (let ((?x310 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) v!FP) ?x324)))
 (let (($x144 (fp.leq ?x310 (fp #b0 #x7f #b00011001100110011001100))))
 ...
 (let ((?x197 (fp.add roundNearestTiesToEven ?x272 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b01000111101011100001010) uFP))))
 ...
 (let ((?x238 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x205 ?x197))))
 (let ((?x134 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) vFP) ?x238)))
 (let (($x131 (fp.leq ?x134 (fp #b0 #x7f #b00011001100110011001100))))
 ...
 (and (and (and $x338 $x198 $x29 $x227) $x131 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x124 $x209 $x213 $x308) $x144 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
