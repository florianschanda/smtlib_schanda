...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.04*u + 0.03*v + 1.0*u^2 + 0.03*u*v + 0.12*v^2 <= 1.51
 and
   u in [-1.2,1.2]
   v in [-3.6,3.4]
...
(assert
 ...
 (let ((?x60 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x79 #b11101011100001010001111) u!FP) v!FP)))
 (let ((?x55 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7f #b00000000000000000000000) u!FP) u!FP)))
 (let ((?x26 (fp.add roundNearestTiesToEven ?x55 (fp.add roundNearestTiesToEven ?x60 ?x276))))
 (let ((?x262 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x79 #b11101011100001010001111) v!FP) ?x26)))
 (let (($x84 (fp.leq ?x262 (fp #b0 #x7f #b10000010100011110101110))))
 ...
 (let ((?x89 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x79 #b11101011100001010001111) uFP) vFP)))
 (let ((?x67 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7f #b00000000000000000000000) uFP) uFP)))
 (let ((?x106 (fp.add roundNearestTiesToEven ?x67 (fp.add roundNearestTiesToEven ?x89 ?x105))))
 (let ((?x246 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x79 #b11101011100001010001111) vFP) ?x106)))
 (let (($x25 (fp.leq ?x246 (fp #b0 #x7f #b10000010100011110101110))))
 ...
 (and (and (and $x45 $x138 $x168 $x139) $x25 ) (and $x208 (fp.eq v!FP ?x209)) (not (and (and $x241 $x183 $x20 $x148) $x84 )))))))))))))))))))))))))))))))
(check-sat)
(exit)
