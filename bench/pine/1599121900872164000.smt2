...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.15*u + -0.02*v + 1.0*u^2 + 0.03*u*v + 0.1*v^2 <= 0.92
 and
   u in [-0.9,1.1]
   v in [-2.9,3.0]
...
(assert
 ...
 (let ((?x236 (fp.add roundNearestTiesToEven ?x239 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b00110011001100110011001) u!FP))))
 ...
 (let ((?x143 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x127 ?x236))))
 (let ((?x217 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) v!FP) ?x143)))
 (let (($x240 (fp.leq ?x217 (fp #b0 #x7e #b11010111000010100011110))))
 ...
 (let ((?x113 (fp.add roundNearestTiesToEven ?x139 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b00110011001100110011001) uFP))))
 ...
 (let ((?x111 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x264 ?x113))))
 (let ((?x326 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) vFP) ?x111)))
 (let (($x280 (fp.leq ?x326 (fp #b0 #x7e #b11010111000010100011110))))
 ...
 (and (and (and $x281 $x134 $x301 $x104) $x280 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x198 $x191 $x243 $x137) $x240 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
