...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.18*u + -0.01*v + 1.0*u^2 + 0.03*u*v + 0.11*v^2 <= 1.33
 and
   u in [-1.1,1.3]
   v in [-3.5,3.5]
...
(assert
 ...
 (let ((?x43 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x277 ?x306))))
 (let ((?x244 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x78 #b01000111101011100001010) v!FP) ?x43)))
 (let (($x226 (fp.leq ?x244 (fp #b0 #x7f #b01010100011110101110000))))
 ...
 (let ((?x205 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x301 ?x351))))
 (let ((?x336 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x78 #b01000111101011100001010) vFP) ?x205)))
 (let (($x262 (fp.leq ?x336 (fp #b0 #x7f #b01010100011110101110000))))
 ...
 (and (and (and $x16 $x185 $x113 $x100) $x262 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x257 $x41 $x281 $x280) $x226 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
