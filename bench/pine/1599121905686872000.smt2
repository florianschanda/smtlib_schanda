...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.15*u + -0.01*v + 1.0*u^2 + 0.04*u*v + 0.11*v^2 <= 1.39
 and
   u in [-1.1,1.3]
   v in [-3.5,3.5]
...
(assert
 ...
 (let ((?x39 (fp.add roundNearestTiesToEven ?x349 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b00110011001100110011001) u!FP))))
 ...
 (let ((?x115 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x45 ?x39))))
 (let ((?x239 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x78 #b01000111101011100001010) v!FP) ?x115)))
 (let (($x237 (fp.leq ?x239 (fp #b0 #x7f #b01100011110101110000101))))
 ...
 (let ((?x193 (fp.add roundNearestTiesToEven ?x342 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b00110011001100110011001) uFP))))
 ...
 (let ((?x344 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x227 ?x193))))
 (let ((?x120 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x78 #b01000111101011100001010) vFP) ?x344)))
 (let (($x316 (fp.leq ?x120 (fp #b0 #x7f #b01100011110101110000101))))
 ...
 (and (and (and $x16 $x185 $x113 $x100) $x316 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x257 $x41 $x281 $x280) $x237 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
