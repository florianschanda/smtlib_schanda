...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -1.0*x1 + -0.37*x2 + 0.88*x1^2 + 0.26*x1*x2 + 0.87*x2^2 <= 0.69
 and
   x1 in [-0.5,1.5]
   x2 in [-1.0,1.0]
...
(assert
 (let ((?x115 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7e #b10111101011100001010001) x2!FP) x2!FP)))
 (let ((?x203 (fp.add roundNearestTiesToEven ?x115 (fp.mul roundNearestTiesToEven (fp #b1 #x7f #b00000000000000000000000) x1!FP))))
 (let ((?x191 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7d #b00001010001111010111000) x1!FP) x2!FP)))
 (let ((?x15 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7e #b11000010100011110101110) x1!FP) x1!FP)))
 (let ((?x16 (fp.add roundNearestTiesToEven ?x15 (fp.add roundNearestTiesToEven ?x191 ?x203))))
 (let ((?x55 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x7d #b01111010111000010100011) x2!FP) ?x16)))
 (let (($x67 (fp.leq ?x55 (fp #b0 #x7e #b01100001010001111010111))))
 ...
 (let ((?x247 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7e #b10111101011100001010001) x2FP) x2FP)))
 (let ((?x147 (fp.add roundNearestTiesToEven ?x247 (fp.mul roundNearestTiesToEven (fp #b1 #x7f #b00000000000000000000000) x1FP))))
 ...
 (let ((?x182 (fp.add roundNearestTiesToEven ?x208 (fp.add roundNearestTiesToEven ?x205 ?x147))))
 (let ((?x112 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x7d #b01111010111000010100011) x2FP) ?x182)))
 (let (($x196 (fp.leq ?x112 (fp #b0 #x7e #b01100001010001111010111))))
 ...
 (and (and (and $x97 $x106 $x93 $x17) $x196 ) (and $x111 (fp.eq x2!FP ?x133)) (not (and (and $x189 $x161 $x264 $x132) $x67 ))))))))))))))))))))))))))))))
(check-sat)
(exit)
