...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.15*u + 1.0*u^2 + 0.03*u*v + 0.12*v^2 <= 1.48
 and
   u in [-1.2,1.3]
   v in [-3.6,3.5]
...
(assert
 ...
 (let ((?x114 (fp.add roundNearestTiesToEven ?x311 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b00110011001100110011001) u!FP))))
 ...
 (let ((?x308 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x301 ?x114))))
 (let (($x27 (fp.leq ?x308 (fp #b0 #x7f #b01111010111000010100011))))
 ...
 (let ((?x219 (fp.add roundNearestTiesToEven ?x109 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b00110011001100110011001) uFP))))
 ...
 (let ((?x137 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x136 ?x219))))
 (let (($x45 (fp.leq ?x137 (fp #b0 #x7f #b01111010111000010100011))))
 ...
 (and (and (and $x274 $x185 $x34 $x100) $x45 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x283 $x41 $x226 $x280) $x27 )))))))))))))))))))))))))))))))))
(check-sat)
(exit)
