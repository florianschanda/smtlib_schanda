...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.17*u + -0.04*v + 1.0*u^2 + 0.03*u*v + 0.1*v^2 <= 0.8
 and
   u in [-0.8,1.0]
   v in [-2.7,3.0]
...
(assert
 ...
 (let ((?x305 (fp.add roundNearestTiesToEven ?x239 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b01011100001010001111010) u!FP))))
 ...
 (let ((?x111 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x127 ?x305))))
 (let ((?x147 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x7a #b01000111101011100001010) v!FP) ?x111)))
 (let (($x304 (fp.leq ?x147 (fp #b0 #x7e #b10011001100110011001100))))
 ...
 (let ((?x260 (fp.add roundNearestTiesToEven ?x139 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b01011100001010001111010) uFP))))
 ...
 (let ((?x198 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x264 ?x260))))
 (let ((?x142 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x7a #b01000111101011100001010) vFP) ?x198)))
 (let (($x202 (fp.leq ?x142 (fp #b0 #x7e #b10011001100110011001100))))
 ...
 (and (and (and $x109 $x17 $x183 $x104) $x202 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x134 $x205 $x258 $x137) $x304 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
