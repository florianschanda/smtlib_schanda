...
(assert
 ...
 (let ((?x240 (fp.add roundNearestTiesToEven ?x239 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b00011110101110000101000) u!FP))))
 ...
 (let ((?x132 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x127 ?x240))))
 (let ((?x133 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x7a #b01000111101011100001010) v!FP) ?x132)))
 (let (($x281 (fp.leq ?x133 (fp #b0 #x7e #b10011001100110011001100))))
 ...
 (let ((?x208 (fp.add roundNearestTiesToEven ?x139 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b00011110101110000101000) uFP))))
 ...
 (let ((?x265 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x264 ?x208))))
 (let ((?x136 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x7a #b01000111101011100001010) vFP) ?x265)))
 (let (($x130 (fp.leq ?x136 (fp #b0 #x7e #b10011001100110011001100))))
 ...
 (and (and (and $x109 $x17 $x183 $x104) $x130 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x134 $x205 $x258 $x137) $x281 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
