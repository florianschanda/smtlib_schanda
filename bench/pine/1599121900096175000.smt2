...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.2*u + -0.04*v + 1.0*u^2 + 0.03*u*v + 0.1*v^2 <= 0.82
 and
   u in [-0.8,1.0]
   v in [-2.7,3.0]
...
(assert
 ...
 (let ((?x42 (fp.add roundNearestTiesToEven ?x239 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b10011001100110011001100) u!FP))))
 ...
 (let ((?x130 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x127 ?x42))))
 (let ((?x150 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x7a #b01000111101011100001010) v!FP) ?x130)))
 (let (($x186 (fp.leq ?x150 (fp #b0 #x7e #b10100011110101110000101))))
 ...
 (let ((?x227 (fp.add roundNearestTiesToEven ?x139 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b10011001100110011001100) uFP))))
 ...
 (let ((?x265 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x264 ?x227))))
 (let ((?x121 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x7a #b01000111101011100001010) vFP) ?x265)))
 (let (($x242 (fp.leq ?x121 (fp #b0 #x7e #b10100011110101110000101))))
 ...
 (and (and (and $x109 $x17 $x183 $x104) $x242 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x134 $x205 $x258 $x137) $x186 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
