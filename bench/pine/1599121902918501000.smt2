...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.17*u + -0.02*v + 1.0*u^2 + 0.04*u*v + 0.1*v^2 <= 1.11
 and
   u in [-1.0,1.2]
   v in [-3.3,3.4]
...
(assert
 ...
 (let ((?x145 (fp.add roundNearestTiesToEven ?x285 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b01011100001010001111010) u!FP))))
 ...
 (let ((?x203 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x114 ?x145))))
 (let ((?x111 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) v!FP) ?x203)))
 (let (($x128 (fp.leq ?x111 (fp #b0 #x7f #b00011100001010001111010))))
 ...
 (let ((?x125 (fp.add roundNearestTiesToEven ?x272 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b01011100001010001111010) uFP))))
 ...
 (let ((?x45 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x205 ?x125))))
 (let ((?x32 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) vFP) ?x45)))
 (let (($x262 (fp.leq ?x32 (fp #b0 #x7f #b00011100001010001111010))))
 ...
 (and (and (and $x338 $x198 $x29 $x227) $x262 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x124 $x209 $x213 $x308) $x128 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
