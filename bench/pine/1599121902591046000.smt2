...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.16*u + -0.02*v + 1.0*u^2 + 0.05*u*v + 0.1*v^2 <= 1.12
 and
   u in [-1.0,1.2]
   v in [-3.2,3.2]
...
(assert
 ...
 (let ((?x138 (fp.add roundNearestTiesToEven ?x285 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b01000111101011100001010) u!FP))))
 (let ((?x183 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7a #b10011001100110011001100) u!FP) v!FP)))
 (let ((?x141 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7f #b00000000000000000000000) u!FP) u!FP)))
 (let ((?x245 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x183 ?x138))))
 (let ((?x191 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) v!FP) ?x245)))
 (let (($x312 (fp.leq ?x191 (fp #b0 #x7f #b00011110101110000101000))))
 ...
 (let ((?x259 (fp.add roundNearestTiesToEven ?x272 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b01000111101011100001010) uFP))))
 (let ((?x211 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7a #b10011001100110011001100) uFP) vFP)))
 (let ((?x119 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7f #b00000000000000000000000) uFP) uFP)))
 (let ((?x280 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x211 ?x259))))
 (let ((?x301 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) vFP) ?x280)))
 (let (($x262 (fp.leq ?x301 (fp #b0 #x7f #b00011110101110000101000))))
 ...
 (and (and (and $x338 $x198 $x263 $x45) $x262 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x124 $x209 $x193 $x35) $x312 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
