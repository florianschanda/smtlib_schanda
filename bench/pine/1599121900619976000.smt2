...
(assert
 ...
 (let (($x228 (fp.leq ?x294 (fp #b0 #x7e #b11000111101011100001010))))
 ...
 (let (($x42 (fp.leq ?x242 (fp #b0 #x7e #b11000111101011100001010))))
 ...
 (and (and (and $x281 $x134 $x301 $x104) $x42 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x198 $x191 $x243 $x137) $x228 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
