...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.16*u + -0.02*v + 1.0*u^2 + 0.04*u*v + 0.11*v^2 <= 1.21
 and
   u in [-1.1,1.2]
   v in [-3.3,3.4]
...
(assert
 ...
 (let (($x242 (fp.leq ?x228 (fp #b0 #x7f #b00110101110000101000111))))
 ...
 (let (($x235 (fp.leq ?x200 (fp #b0 #x7f #b00110101110000101000111))))
 ...
 (and (and (and $x16 $x198 $x29 $x227) $x235 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x257 $x209 $x213 $x308) $x242 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
