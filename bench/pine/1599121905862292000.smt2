...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.16*u + 1.0*u^2 + 0.03*u*v + 0.11*v^2 <= 1.41
 and
   u in [-1.1,1.3]
   v in [-3.6,3.5]
...
(assert
 ...
 (let ((?x267 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x79 #b11101011100001010001111) u!FP) v!FP)))
 (let ((?x141 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7f #b00000000000000000000000) u!FP) u!FP)))
 (let ((?x224 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x267 ?x296))))
 (let (($x244 (fp.leq ?x224 (fp #b0 #x7f #b01101000111101011100001))))
 ...
 (let ((?x279 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x79 #b11101011100001010001111) uFP) vFP)))
 (let ((?x119 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7f #b00000000000000000000000) uFP) uFP)))
 (let ((?x143 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x279 ?x71))))
 (let (($x125 (fp.leq ?x143 (fp #b0 #x7f #b01101000111101011100001))))
 ...
 (and (and (and $x16 $x185 $x34 $x100) $x125 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x257 $x41 $x226 $x280) $x244 )))))))))))))))))))))))))))))))))
(check-sat)
(exit)
