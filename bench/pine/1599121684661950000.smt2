...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.02*x + -0.09*y + 0.45*x^2 + 1.0*x*y + 0.82*y^2 <= 0.02
 and
   x in [-0.5,0.3]
   y in [-0.2,0.4]
...
(assert
 (let ((?x130 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7e #b10100011110101110000101) y!FP) y!FP)))
 (let ((?x99 (fp.add roundNearestTiesToEven ?x130 (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) x!FP))))
 ...
 (let ((?x214 (fp.add roundNearestTiesToEven ?x135 (fp.add roundNearestTiesToEven ?x234 ?x99))))
 (let ((?x216 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x7b #b01110000101000111101011) y!FP) ?x214)))
 (let (($x133 (fp.leq ?x216 (fp #b0 #x79 #b01000111101011100001010))))
 ...
 (let ((?x110 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b0 #x7e #b10100011110101110000101) yFP) yFP)))
 (let ((?x279 (fp.add roundNearestTiesToEven ?x110 (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) xFP))))
 ...
 (let ((?x202 (fp.add roundNearestTiesToEven ?x132 (fp.add roundNearestTiesToEven ?x259 ?x279))))
 (let ((?x191 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x7b #b01110000101000111101011) yFP) ?x202)))
 (let (($x211 (fp.leq ?x191 (fp #b0 #x79 #b01000111101011100001010))))
 ...
 (and (and (and $x181 $x124 $x160 $x258) $x211 ) $x159 (not (and (and $x219 $x176 $x168 $x221) $x133 )))))))))))))))))))))))))))))))))
(check-sat)
(exit)
