...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.17*u + -0.02*v + 1.0*u^2 + 0.03*u*v + 0.1*v^2 <= 0.9
 and
   u in [-0.9,1.1]
   v in [-2.9,3.0]
...
(assert
 ...
 (let ((?x132 (fp.add roundNearestTiesToEven ?x239 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b01011100001010001111010) u!FP))))
 ...
 (let ((?x265 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x127 ?x132))))
 (let ((?x294 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) v!FP) ?x265)))
 (let (($x313 (fp.leq ?x294 (fp #b0 #x7e #b11001100110011001100110))))
 (let (($x137 (fp.leq v!FP (fp #b0 #x80 #b10000000000000000000000))))
 (let (($x243 (fp.leq (fp #b1 #x80 #b01110011001100110011001) v!FP)))
 ...
 (let ((?x285 (fp.add roundNearestTiesToEven ?x139 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b01011100001010001111010) uFP))))
 ...
 (let ((?x258 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x264 ?x285))))
 (let ((?x242 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x79 #b01000111101011100001010) vFP) ?x258)))
 (let (($x312 (fp.leq ?x242 (fp #b0 #x7e #b11001100110011001100110))))
 (let (($x104 (fp.leq vFP (fp #b0 #x80 #b10000000000000000000000))))
 (let (($x301 (fp.leq (fp #b1 #x80 #b01110011001100110011001) vFP)))
 (let (($x134 (fp.leq uFP (fp #b0 #x7f #b00011001100110011001100))))
 (let (($x281 (fp.leq (fp #b1 #x7e #b11001100110011001100110) uFP)))
 (and (and (and $x281 $x134 $x301 $x104) $x312 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x198 $x191 $x243 $x137) $x313 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
