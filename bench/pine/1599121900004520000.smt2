...
[2] A.Izycheva, E.Darulova, H.Seidl, SAS'20, "Counterexample- and Simulation-Guided Floating-Point Loop Invariant Synthesis"
 ...
 Invariant:
   -0.16*u + -0.04*v + 1.0*u^2 + 0.03*u*v + 0.1*v^2 <= 0.81
 and
   u in [-0.8,1.0]
   v in [-2.7,3.0]
...
(assert
 ...
 (let ((?x112 (fp.add roundNearestTiesToEven ?x239 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b01000111101011100001010) u!FP))))
 ...
 (let ((?x128 (fp.add roundNearestTiesToEven ?x141 (fp.add roundNearestTiesToEven ?x127 ?x112))))
 (let ((?x133 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x7a #b01000111101011100001010) v!FP) ?x128)))
 (let (($x187 (fp.leq ?x133 (fp #b0 #x7e #b10011110101110000101000))))
 ...
 (let ((?x131 (fp.add roundNearestTiesToEven ?x139 (fp.mul roundNearestTiesToEven (fp #b1 #x7c #b01000111101011100001010) uFP))))
 ...
 (let ((?x228 (fp.add roundNearestTiesToEven ?x119 (fp.add roundNearestTiesToEven ?x264 ?x131))))
 (let ((?x226 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (fp #b1 #x7a #b01000111101011100001010) vFP) ?x228)))
 (let (($x193 (fp.leq ?x226 (fp #b0 #x7e #b10011110101110000101000))))
 ...
 (and (and (and $x109 $x17 $x183 $x104) $x193 ) (and $x156 (fp.eq v!FP ?x174)) (not (and (and $x134 $x205 $x258 $x137) $x187 )))))))))))))))))))))))))))))))))))
(check-sat)
(exit)
