...
(define-fun B18 () Bool (bvsge |argc'#0| (_ bv0 32)))

; convert
; Converting var_no 19 with expr ID of and
(define-fun B19 () Bool (and (fp.geq |main::1::2::in0!0@1#1| (fp #b1 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.leq |main::1::2::in0!0@1#1| (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
...
(define-fun B22 () Bool (not B20))

; convert
; Converting var_no 23 with expr ID of not
(define-fun B23 () Bool (not B21))
