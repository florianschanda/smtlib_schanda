...
(declare-fun array.3 () (Array (_ BitVec 64) (_ FloatingPoint 8 24)))
(assert (= (select array.3 (_ bv0 64)) (fp #b0 #b01111111 #b00000000000000000000000)))
(assert (= (select array.3 (_ bv1 64)) (fp #b0 #b10000001 #b01000000000000000000000)))
(assert (= (select array.3 (_ bv2 64)) (fp #b1 #b10000010 #b01000000000000000000000)))
(assert (= (select array.3 (_ bv3 64)) (fp #b0 #b10000011 #b11100000000000000000000)))
(assert (= (select array.3 (_ bv4 64)) (fp #b0 #b10000011 #b01000000000000000000000)))
(define-fun |main::1::org!0@1#2| () (Array (_ BitVec 64) (_ FloatingPoint 8 24)) array.3)
(declare-fun array.4 () (Array (_ BitVec 64) (_ FloatingPoint 8 24)))
(assert (= (select array.4 (_ bv0 64)) (fp #b0 #b10000001 #b00000000000000000000000)))
(assert (= (select array.4 (_ bv1 64)) (fp #b1 #b10000010 #b11100000000000000000000)))
(assert (= (select array.4 (_ bv2 64)) (fp #b0 #b10000100 #b01000000000000000000000)))
(assert (= (select array.4 (_ bv3 64)) (fp #b1 #b10000010 #b01000000000000000000000)))
(assert (= (select array.4 (_ bv4 64)) (fp #b0 #b00000000 #b00000000000000000000000)))
(define-fun |main::1::slope!0@1#2| () (Array (_ BitVec 64) (_ FloatingPoint 8 24)) array.4)
...
(define-fun |main::1::z!0@1#2| () (_ FloatingPoint 8 24) (fp.add roundNearestTiesToEven (select array.3 ((_ sign_extend 32) |main::1::i!0@1#12|)) (fp.div roundNearestTiesToEven (fp.mul roundNearestTiesToEven (select array.4 ((_ sign_extend 32) |main::1::i!0@1#12|)) (fp.sub roundNearestTiesToEven |main::1::t!0@1#2| (select array.1 ((_ sign_extend 32) |main::1::i!0@1#12|)))) (fp.sub roundNearestTiesToEven (select array.2 ((_ sign_extend 32) |main::1::i!0@1#12|)) (select array.1 ((_ sign_extend 32) |main::1::i!0@1#12|))))))
(define-fun |__VERIFIER_assert::cond!0@1#1| () (_ BitVec 32) (ite (and (fp.leq |main::1::z!0@1#2| (fp #b0 #b10000011 #b11100000000000000000000)) (fp.geq |main::1::z!0@1#2| (fp #b1 #b10000010 #b01000000000000000000000))) (_ bv1 32) (_ bv0 32)))
...
(define-fun B28 () Bool (= |main::1::org!0@1#1| |main::1::org!0@1#1|))
(declare-fun |main::1::slope!0@1#1| () (Array (_ BitVec 64) (_ FloatingPoint 8 24)))
(define-fun B29 () Bool (= |main::1::slope!0@1#1| |main::1::slope!0@1#1|))
(define-fun B30 () Bool (= |main::$tmp::::tmp_if_expr$1!0@1#1| |main::$tmp::::tmp_if_expr$1!0@1#1|))
(define-fun B31 () Bool |main::$tmp::::tmp_if_expr$1!0@1#5|)
(assert |main::$tmp::::tmp_if_expr$1!0@1#5|)
(assert |goto_symex::&92;guard#7|)
(define-fun B32 () Bool (not (fp.geq |main::1::t!0@1#2| (fp #b0 #b10000001 #b01000000000000000000000))))
(define-fun B33 () Bool (fp.leq |main::1::t!0@1#2| (fp #b0 #b10000010 #b01000000000000000000000)))
(define-fun B34 () Bool (fp.leq |main::1::t!0@1#2| (fp #b0 #b10000010 #b10000000000000000000000)))
(define-fun B35 () Bool (fp.leq |main::1::t!0@1#2| (fp #b0 #b10000011 #b11100000000000000000000)))
(define-fun B36 () Bool (fp.leq |main::1::t!0@1#2| (fp #b0 #b10000110 #b00101100000000000000000)))
(define-fun B37 () Bool (fp.leq |main::1::t!0@1#2| (fp #b0 #b10000111 #b00101100000000000000000)))
(define-fun B38 () Bool (not (= |__VERIFIER_assert::cond!0@1#1| (_ bv0 32))))
(check-sat)
(exit)
