...
(assert (= |goto_symex::&92;guard#1| (not (or (not (fp.leq |main::1::x!0@1#2| (fp #b0 #b11111111010 #b1100011110110001111100111100101011000111010000110011))) (not (fp.geq |main::1::x!0@1#2| (fp #b1 #b11111111010 #b1100011110110001111100111100101011000111010000110011)))))))
(define-fun |__VERIFIER_assert::cond!0@1#1| () (_ BitVec 32) (ite (not (fp.isNaN |main::1::x!0@1#2|)) (_ bv1 32) (_ bv0 32)))
...
(define-fun B6 () Bool (or (not (fp.leq |main::1::x!0@1#2| (fp #b0 #b11111111010 #b1100011110110001111100111100101011000111010000110011))) (not (fp.geq |main::1::x!0@1#2| (fp #b1 #b11111111010 #b1100011110110001111100111100101011000111010000110011)))))
(define-fun B7 () Bool (not (= |__VERIFIER_assert::cond!0@1#1| (_ bv0 32))))
(check-sat)
(exit)
