...
(declare-fun RRL1WVSHDX () (_ BitVec 32))
(declare-fun K66AHUJV0H () (_ BitVec 32))
(assert (let ((a!1 (fp.mul roundTowardPositive
                   ((_ to_fp_unsigned 8 24) roundTowardPositive K66AHUJV0H)
                   (fp.div roundTowardPositive
                           ((_ to_fp_unsigned 8 24)
                             roundTowardPositive
                             RRL1WVSHDX)
                           (fp #b0 #x85 #b10010000000000000000000)))))
  (and (distinct a!1 (_ NaN 8 24))
       (distinct a!1 (_ +oo 8 24))
       (distinct a!1 (_ -oo 8 24))
       (fp.geq a!1 (_ +zero 8 24))
       (fp.leq a!1 (fp #b0 #x9f #b00000000000000000000000)))))
(check-sat)
(exit)