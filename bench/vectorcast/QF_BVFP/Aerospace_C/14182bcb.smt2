...
(declare-fun FWXG3T477U () (_ FloatingPoint 8 24))
(declare-fun X7H3B1VQB0 () (_ BitVec 16))
(assert (let ((a!1 (fp.mul roundTowardPositive
                   (fp.mul roundTowardPositive
                           ((_ to_fp 8 24)
                             roundTowardPositive
                             ((_ sign_extend 16) X7H3B1VQB0))
                           FWXG3T477U)
                   (fp #b0 #x79 #b00011101111101000110101))))
  (not (distinct (ite (fp.lt a!1 (_ +zero 8 24)) #x00000001 #x00000000)
                 #x00000000))))
(check-sat)
(exit)