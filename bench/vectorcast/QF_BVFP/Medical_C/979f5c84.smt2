...
(declare-fun JMHDDFE98V () (_ FloatingPoint 8 24))
(declare-fun JZ46ALQQ3U () (_ BitVec 1))
(assert (let ((a!1 (and (distinct JZ46ALQQ3U #b0)
                (distinct (ite (fp.eq JMHDDFE98V (_ +zero 8 24)) #b1 #b0) #b0))))
