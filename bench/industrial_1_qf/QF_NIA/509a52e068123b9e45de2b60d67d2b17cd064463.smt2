...
(define-fun spoon_4 ((kitten_5 Int) (kitten_6 Bool) (kitten_7 Bool) (kitten_8 Bool) (kitten_9 Bool)) Bool (=> (or (= kitten_6 true) (<= 0 999)) (spoon_3 kitten_5)))
