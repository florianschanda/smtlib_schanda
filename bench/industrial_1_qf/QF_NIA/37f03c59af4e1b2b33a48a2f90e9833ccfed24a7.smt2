...
(assert (=> (not (= (spoon_1 cat_5 10) 0)) (and (= cat_10 (* cat_29 10)) (spoon_2 (* cat_29 10)))))
(assert (=> (not (= (spoon_1 cat_5 10) 0)) (= cat_15 (ite (< 999 cat_10) true false))))
(assert (=> (not (= (spoon_1 cat_5 10) 0)) (=> (= cat_15 true) (= cat_14 cat_16))))
(assert (=> (not (= (spoon_1 cat_5 10) 0)) (=> (= cat_15 true) (= cat_17 990))))
(assert (=> (not (= (spoon_1 cat_5 10) 0)) (=> (not (= cat_15 true)) (and (= cat_11 (* cat_29 10)) (spoon_2 (* cat_29 10))))))
(assert (=> (not (= (spoon_1 cat_5 10) 0)) (=> (not (= cat_15 true)) (and (= cat_12 cat_11) (spoon_3 cat_11)))))
(assert (=> (not (= (spoon_1 cat_5 10) 0)) (=> (not (= cat_15 true)) (= cat_14 cat_18))))
(assert (=> (not (= (spoon_1 cat_5 10) 0)) (=> (not (= cat_15 true)) (= cat_19 cat_12))))
(assert (=> (not (= (spoon_1 cat_5 10) 0)) (=> (not (= cat_15 true)) (= cat_17 cat_19))))
(assert (=> (= (spoon_1 cat_5 10) 0) (= cat_17 cat_14)))
(assert (= cat_21 cat_22))
(assert (= cat_23 cat_21))
(assert (= cat_21 cat_17))
(assert (= cat_17 cat_24))
(assert (= cat_27 cat_23))
(assert (= cat_26 cat_17))
(assert (= cat_28 cat_25))
(assert (not (= (spoon_1 cat_25 10) 0)))
(check-sat)
