...
(define-fun spoon_26 ((kitten_26 Float32)) Bool (and (spoon_1 kitten_26) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_26) (fp.leq kitten_26 (fp #b0 #b10001001 #b01110111000000000000000)))))
...
(define-fun spoon_38 ((kitten_27 Float32) (kitten_28 Bool) (kitten_29 Bool) (kitten_30 Bool) (kitten_31 Bool)) Bool (=> (or (= kitten_28 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_15 kitten_27)))
(define-fun spoon_39 ((kitten_32 Float32) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool) (kitten_36 Bool)) Bool (=> (or (= kitten_33 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001001 #b01110111000000000000000))) (spoon_26 kitten_32)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_24 cat_40)))
(assert (= cat_43 cat_40))
(assert (= cat_44 cat_41))
(assert (not false))
(check-sat)
