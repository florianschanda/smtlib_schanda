...
(define-fun spoon_15 ((kitten_19 Float32)) Bool (and (spoon_1 kitten_19) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_19) (fp.leq kitten_19 (fp #b0 #b10010011 #b00000001101101110000000)))))
(define-fun spoon_16 ((kitten_20 Float32) (kitten_21 Bool) (kitten_22 Bool) (kitten_23 Bool) (kitten_24 Bool)) Bool (=> (or (= kitten_21 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000))) (spoon_15 kitten_20)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000)) (spoon_15 cat_22)))
(assert (=> (fp.lt cat_17 cat_19) (= cat_25 cat_22)))
(assert (=> (fp.lt cat_17 cat_19) (= cat_26 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (fp.lt cat_17 cat_19)) (and (= cat_24 (fp.sub RNE cat_17 cat_19)) (spoon_1 (fp.sub RNE cat_17 cat_19)))))
(assert (=> (not (fp.lt cat_17 cat_19)) (= cat_27 cat_22)))
(assert (=> (not (fp.lt cat_17 cat_19)) (= cat_28 cat_24)))
(assert (=> (not (fp.lt cat_17 cat_19)) (= cat_26 cat_28)))
(assert (= cat_30 cat_31))
(assert (= cat_32 cat_30))
(assert (= cat_29 cat_23))
(assert (= cat_30 cat_26))
(assert (= cat_33 cat_26))
(assert (= cat_36 cat_32))
(assert (= cat_35 cat_26))
(assert (= cat_37 cat_34))
(assert (not (fp.eq cat_34 (fp.max (fp #b0 #b00000000 #b00000000000000000000000) (fp.sub RNE cat_17 cat_19)))))
(check-sat)
