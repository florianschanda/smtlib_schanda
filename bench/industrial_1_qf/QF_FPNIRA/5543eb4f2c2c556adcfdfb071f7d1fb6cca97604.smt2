...
(assert (and (= cat_111 (fp.mul RNE cat_148 cat_149)) (spoon_1 (fp.mul RNE cat_148 cat_149))))
(assert (= cat_112 (fp.sub RNE cat_111 cat_110)))
(assert (and (= cat_113 cat_112) (spoon_1 cat_112)))
(assert (= cat_153 cat_113))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_153) (and (= cat_122 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_153)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_153)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_153) (and (= cat_123 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_152)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_152)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_153) (= cat_124 (ite (fp.leq cat_123 cat_122) true false))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_153) (and (= cat_120 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_152)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_152)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_153) (and (= cat_121 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_153)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_153)))))
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_153) (= cat_125 (ite (fp.leq cat_121 cat_120) true false))))
(declare-const cat_157 Bool)
(assert (=> (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_153) (= cat_155 cat_157)))
(assert (=> (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_153)) (= cat_155 false)))
(assert (=> (= cat_155 true) (= cat_154 true)))
(assert (=> (not (= cat_155 true)) (=> (fp.lt cat_153 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_116 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_153)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_153))))))
(assert (=> (not (= cat_155 true)) (=> (fp.lt cat_153 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_117 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_152)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_152))))))
(assert (=> (not (= cat_155 true)) (=> (fp.lt cat_153 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_118 (ite (fp.leq cat_117 cat_116) true false)))))
(assert (=> (not (= cat_155 true)) (=> (fp.lt cat_153 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_114 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_152)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_152))))))
(assert (=> (not (= cat_155 true)) (=> (fp.lt cat_153 (fp #b0 #b00000000 #b00000000000000000000000)) (and (= cat_115 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_153)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_153))))))
(assert (=> (not (= cat_155 true)) (=> (fp.lt cat_153 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_119 (ite (fp.leq cat_115 cat_114) true false)))))
(declare-const cat_158 Bool)
(assert (=> (not (= cat_155 true)) (=> (fp.lt cat_153 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_154 cat_158))))
(assert (=> (not (= cat_155 true)) (=> (not (fp.lt cat_153 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_154 false))))
(assert (= cat_154 true))
(assert (and (= cat_126 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_152)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_152))))
(assert (= cat_127 (fp.div RNE cat_126 cat_153)))
(assert (and (= cat_128 cat_127) (spoon_1 cat_127)))
(assert (not (spoon_45 cat_128)))
(check-sat)
