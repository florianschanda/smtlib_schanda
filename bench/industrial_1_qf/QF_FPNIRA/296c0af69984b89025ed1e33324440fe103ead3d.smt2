...
(define-fun spoon_17 ((kitten_25 Float32)) Bool (and (spoon_1 kitten_25) (and (fp.leq (fp.neg (fp #b0 #b10000111 #b01101000000000000000000)) kitten_25) (fp.leq kitten_25 (fp #b0 #b10000111 #b01101000000000000000000)))))
(define-fun spoon_18 ((kitten_26 Float32) (kitten_27 Bool) (kitten_28 Bool) (kitten_29 Bool) (kitten_30 Bool)) Bool (=> (or (= kitten_27 true) (fp.leq (fp.neg (fp #b0 #b10000111 #b01101000000000000000000)) (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_17 kitten_26)))
...
(assert (spoon_17 cat_19))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000)) (spoon_15 cat_22)))
(assert (fp.lt cat_19 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (not (spoon_15 (fp.add RNE cat_19 (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
