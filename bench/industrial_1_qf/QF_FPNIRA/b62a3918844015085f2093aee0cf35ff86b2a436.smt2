...
(assert (and (= cat_140 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_162)) (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) cat_162))))
(assert (= cat_141 (ite (fp.leq cat_172 cat_140) true false)))
