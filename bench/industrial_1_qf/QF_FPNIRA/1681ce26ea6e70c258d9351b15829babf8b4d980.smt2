...
(assert (= cat_141 true))
(assert (= cat_142 true))
(assert (= cat_146 (fp.mul RNE cat_69 cat_69)))
(assert (= cat_147 ((_ to_fp 8 24) RNE (fp.sub RNE (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) (fp.mul RNE cat_65 cat_65)))))
(assert (not (or (fp.isZero cat_147) (fp.isPositive cat_147))))
(check-sat)
