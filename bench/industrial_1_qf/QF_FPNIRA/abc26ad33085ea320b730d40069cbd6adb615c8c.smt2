...
(assert (not (fp.lt cat_157 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_157)))
(assert (not (spoon_59 cat_157)))
(check-sat)
