...
(assert (and (= cat_75 (fp.mul RNE (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) cat_89)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) cat_89))))
(assert (= cat_78 (ite (fp.leq cat_75 cat_87) true false)))
(declare-const cat_92 Bool)
(assert (= cat_79 cat_92))
(assert (= cat_90 (ite (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_89) cat_79 false)))
(assert (= cat_90 true))
(assert (and (= cat_80 (fp.div RNE cat_87 cat_89)) (spoon_1 (fp.div RNE cat_87 cat_89))))
(assert (not (spoon_48 cat_80)))
(check-sat)
