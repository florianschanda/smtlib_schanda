...
(assert (=> (=> (not (fp.lt cat_37 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_37)) (=> (not (fp.lt cat_39 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_39)))) (and (and (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_40) (fp.leq cat_40 (fp #b0 #b10001011 #b00000000000000000000000))) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) cat_41) (fp.leq cat_41 (fp #b0 #b10001011 #b00000000000000000000000)))) (and (spoon_29 cat_41) (spoon_29 cat_40)))))
(assert (=> (not (=> (not (fp.lt cat_37 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_37)) (=> (not (fp.lt cat_39 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_39))))) (= cat_41 cat_39)))
(assert (=> (not (=> (not (fp.lt cat_37 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_37)) (=> (not (fp.lt cat_39 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)))) (fp.lt (fp #b0 #b10001011 #b00000000000000000000000) cat_39))))) (= cat_40 cat_37)))
(assert (and (= cat_35 cat_41) (spoon_1 cat_41)))
(assert (not (spoon_16 cat_40)))
(check-sat)
