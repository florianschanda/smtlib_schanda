...
(assert (not (= cat_155 true)))
(assert (fp.lt cat_153 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (and (= cat_116 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_153)) (spoon_1 (fp.mul RNE (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_153))))
(assert (and (= cat_117 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_152)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_152))))
(assert (= cat_118 (ite (fp.leq cat_117 cat_116) true false)))
(assert (not (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_152))))
(check-sat)
