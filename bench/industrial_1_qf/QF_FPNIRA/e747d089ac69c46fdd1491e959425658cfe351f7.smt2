...
(assert (= cat_142 true))
(assert (and (= cat_99 (fp.sub RNE cat_147 cat_146)) (spoon_1 (fp.sub RNE cat_147 cat_146))))
(assert (= cat_100 (fp.add RNE cat_99 (fp.mul RNE cat_143 cat_143))))
(assert (and (= cat_101 cat_100) (spoon_1 cat_100)))
(assert (= cat_149 cat_101))
(assert (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) cat_149))
(assert (not (or (fp.isZero cat_149) (fp.isPositive cat_149))))
(check-sat)
