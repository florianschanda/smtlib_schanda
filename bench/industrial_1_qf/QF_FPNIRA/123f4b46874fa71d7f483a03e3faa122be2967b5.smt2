...
(define-fun spoon_39 ((kitten_28 Float32)) Bool (and (spoon_1 kitten_28) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_28) (fp.leq kitten_28 (fp #b0 #b10010011 #b00000001101101110000000)))))
(define-fun spoon_40 ((kitten_29 Float32) (kitten_30 Bool) (kitten_31 Bool) (kitten_32 Bool) (kitten_33 Bool)) Bool (=> (or (= kitten_30 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10010011 #b00000001101101110000000))) (spoon_39 kitten_29)))
(define-fun spoon_41 ((kitten_34 Int)) Bool (and (<= 1 kitten_34) (<= kitten_34 30)))
(define-fun spoon_42 ((kitten_35 Int) (kitten_36 Bool) (kitten_37 Bool) (kitten_38 Bool) (kitten_39 Bool)) Bool (=> (or (= kitten_36 true) (<= 1 30)) (spoon_41 kitten_35)))
...
(define-fun spoon_52 ((kitten_40 Float32) (kitten_41 Bool) (kitten_42 Bool) (kitten_43 Bool) (kitten_44 Bool)) Bool (=> (or (= kitten_41 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_17 kitten_40)))
(define-fun spoon_53 ((kitten_45 Int) (kitten_46 Bool) (kitten_47 Bool) (kitten_48 Bool) (kitten_49 Bool)) Bool (=> (or (= kitten_46 true) (<= 3 30)) (spoon_16 kitten_45)))
...
(assert (spoon_39 cat_46))
(assert (= cat_57 cat_54))
(assert (= cat_58 (distinct 0 0)))
(assert (=> (<= 1 30) (spoon_41 cat_55)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_37 cat_56)))
