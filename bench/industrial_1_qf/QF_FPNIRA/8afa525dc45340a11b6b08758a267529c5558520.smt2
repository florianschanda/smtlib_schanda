...
(assert (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) cat_153))
(assert (and (= cat_122 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_153)) (spoon_1 (fp.mul RNE (fp #b0 #b10000101 #b01101000000000000000000) cat_153))))
(assert (and (= cat_123 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_152)) (spoon_1 (fp.mul RNE (fp #b0 #b10000100 #b11001010010111011100000) cat_152))))
(assert (= cat_124 (ite (fp.leq cat_123 cat_122) true false)))
