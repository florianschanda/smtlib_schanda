...
(define-fun spoon_16 ((kitten_24 Float32)) Bool (and (spoon_1 kitten_24) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_24) (fp.leq kitten_24 (fp #b0 #b10000110 #b01101000000000000000000)))))
...
(define-fun spoon_22 ((kitten_31 Float32) (kitten_32 Bool) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool)) Bool (=> (or (= kitten_32 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000110 #b01101000000000000000000))) (spoon_16 kitten_31)))
...
(assert (and (= cat_24 cat_32) (and (spoon_1 cat_24) (=> (fp.eq cat_19 (fp #b0 #b01111111 #b00000000000000000000000)) (fp.eq cat_24 (fp #b0 #b00000000 #b00000000000000000000000))))))
(assert (= cat_26 cat_23))
(assert (= cat_27 cat_24))
(assert (=> (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_27) (= cat_28 cat_27)))
(assert (=> (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_27) (= cat_29 (fp #b0 #b10000110 #b01101000000000000000000))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_27)) (=> (fp.lt cat_27 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_30 cat_27))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_27)) (=> (fp.lt cat_27 (fp #b0 #b00000000 #b00000000000000000000000)) (= cat_31 (fp #b0 #b00000000 #b00000000000000000000000)))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_27)) (=> (not (fp.lt cat_27 (fp #b0 #b00000000 #b00000000000000000000000))) (= cat_31 cat_27))))
(assert (=> (not (fp.lt (fp #b0 #b10000110 #b01101000000000000000000) cat_27)) (= cat_29 cat_31)))
