...
(define-fun spoon_15 ((kitten_19 Float32)) Bool (and (spoon_1 kitten_19) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_19) (fp.leq kitten_19 (fp #b0 #b10000111 #b01101000000000000000000)))))
(define-fun spoon_16 ((kitten_20 Float32) (kitten_21 Bool) (kitten_22 Bool) (kitten_23 Bool) (kitten_24 Bool)) Bool (=> (or (= kitten_21 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000))) (spoon_15 kitten_20)))
(declare-const cat_17 Float32)
(declare-const cat_18 Int)
(declare-const cat_19 Float32)
(declare-const cat_20 Int)
(define-fun spoon_21 ((kitten_25 Float32)) Bool (and (spoon_1 kitten_25) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) kitten_25) (fp.leq kitten_25 (fp #b0 #b10001000 #b01101000000000000000000)))))
(define-fun spoon_22 ((kitten_26 Float32) (kitten_27 Bool) (kitten_28 Bool) (kitten_29 Bool) (kitten_30 Bool)) Bool (=> (or (= kitten_27 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001000 #b01101000000000000000000))) (spoon_21 kitten_26)))
...
(assert (spoon_15 cat_17))
(assert (spoon_15 cat_19))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001000 #b01101000000000000000000)) (spoon_21 cat_24)))
(assert (= cat_28 cat_24))
(assert (= cat_29 (fp.add RNE cat_17 cat_19)))
(assert (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_29))
(assert (not (spoon_21 (fp.sub RNE cat_29 (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
