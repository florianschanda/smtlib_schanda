...
(assert (fp.lt cat_69 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))))
(assert (= cat_69 cat_74))
(assert (= cat_75 (fp.neg (fp #b0 #b10001011 #b00000000000000000000000))))
(assert (not (spoon_1 cat_42)))
(check-sat)
