...
(assert (= cat_84 cat_65))
(assert (= cat_55 cat_83))
(assert (= cat_53 cat_82))
(assert (= cat_87 cat_65))
(assert (= cat_86 cat_55))
(assert (= cat_85 cat_53))
(assert (not (fp.leq cat_83 (fp #b0 #b10001011 #b00000000000000000000000))))
(check-sat)
