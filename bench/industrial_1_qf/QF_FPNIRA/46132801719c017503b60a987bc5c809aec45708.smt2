...
(define-fun spoon_17 ((kitten_25 Float32)) Bool (and (spoon_1 kitten_25) (and (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) kitten_25) (fp.leq kitten_25 (fp #b0 #b10000110 #b01101000000000000000000)))))
(define-fun spoon_18 ((kitten_26 Float32)) Bool (and (spoon_1 kitten_26) (and (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) kitten_26) (fp.leq kitten_26 (fp #b0 #b10001100 #b00000000000000000000000)))))
(define-fun spoon_19 ((kitten_27 Float32) (kitten_28 Bool) (kitten_29 Bool) (kitten_30 Bool) (kitten_31 Bool)) Bool (=> (or (= kitten_28 true) (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000))) (spoon_18 kitten_27)))
(declare-const cat_20 Float32)
(declare-const cat_21 Int)
(declare-const cat_22 Float32)
(declare-const cat_23 Int)
(declare-const cat_24 Int)
(define-fun spoon_25 ((kitten_32 Float32) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool) (kitten_36 Bool)) Bool (=> (or (= kitten_33 true) (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) (fp #b0 #b10000110 #b01101000000000000000000))) (spoon_17 kitten_32)))
...
(assert (spoon_18 cat_20))
(assert (spoon_18 cat_22))
(assert (or (not (fp.eq cat_20 (fp #b0 #b00000000 #b00000000000000000000000))) (not (fp.eq cat_22 (fp #b0 #b00000000 #b00000000000000000000000)))))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (spoon_1 cat_26)))
