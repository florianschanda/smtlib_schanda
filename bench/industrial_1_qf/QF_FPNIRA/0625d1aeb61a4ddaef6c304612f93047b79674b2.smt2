...
(assert (fp.lt cat_51 cat_50))
(assert (= cat_57 (fp.mul RNE cat_56 cat_51)))
(assert (and (= cat_58 cat_57) (spoon_1 cat_57)))
(assert (and (= cat_59 cat_58) (spoon_1 cat_58)))
(assert (= cat_53 (fp.mul RNE cat_52 cat_51)))
(assert (and (= cat_54 cat_53) (spoon_1 cat_53)))
(assert (and (= cat_55 cat_54) (spoon_1 cat_54)))
(assert (not false))
(check-sat)
