...
(define-fun spoon_17 ((kitten_25 Float32)) Bool (and (spoon_1 kitten_25) (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)) kitten_25) (fp.leq kitten_25 (fp #b0 #b10000101 #b01100111111101011101000)))))
(define-fun spoon_18 ((kitten_26 Float32) (kitten_27 Bool) (kitten_28 Bool) (kitten_29 Bool) (kitten_30 Bool)) Bool (=> (or (= kitten_27 true) (fp.leq (fp.neg (fp #b0 #b10000101 #b01100111111101011101000)) (fp #b0 #b10000101 #b01100111111101011101000))) (spoon_17 kitten_26)))
(define-fun spoon_19 ((kitten_31 Float32)) Bool (and (spoon_1 kitten_31) (and (fp.leq (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)) kitten_31) (fp.leq kitten_31 (fp #b0 #b10001011 #b01101010100000000000000)))))
(declare-const cat_20 Float32)
(declare-const cat_21 Int)
(declare-const cat_22 Int)
(define-fun spoon_23 ((kitten_32 Float32) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool) (kitten_36 Bool)) Bool (=> (or (= kitten_33 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b01101010100000000000000)) (fp #b0 #b10001011 #b01101010100000000000000))) (spoon_19 kitten_32)))
...
(assert (spoon_17 cat_20))
(assert (and (fp.lt (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) cat_20) (fp.lt cat_20 (fp #b0 #b10000101 #b01101000000000000000000))))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (spoon_1 cat_24)))
