...
(define-fun spoon_49 ((kitten_34 Int) (kitten_35 Bool) (kitten_36 Bool) (kitten_37 Bool) (kitten_38 Bool)) Bool (=> (or (= kitten_35 true) (<= 1 100)) (spoon_39 kitten_34)))
(define-fun spoon_50 ((kitten_39 Int) (kitten_40 Bool) (kitten_41 Bool) (kitten_42 Bool) (kitten_43 Bool)) Bool (=> (or (= kitten_40 true) (<= 3 100)) (spoon_16 kitten_39)))
