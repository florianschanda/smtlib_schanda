...
(assert (not (fp.leq (fp #b0 #b10000111 #b01101000000000000000000) cat_29)))
(assert (fp.lt cat_29 (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (not (spoon_21 (fp.add RNE cat_29 (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
