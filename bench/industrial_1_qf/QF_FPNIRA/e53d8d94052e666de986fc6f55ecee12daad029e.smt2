...
(define-fun spoon_47 ((kitten_28 Float32) (kitten_29 Bool) (kitten_30 Bool) (kitten_31 Bool) (kitten_32 Bool)) Bool (=> (or (= kitten_29 true) (fp.leq (fp.neg (fp #b0 #b10001100 #b00000000000000000000000)) (fp #b0 #b10001100 #b00000000000000000000000))) (spoon_27 kitten_28)))
(define-fun spoon_48 ((kitten_33 Float32) (kitten_34 Bool) (kitten_35 Bool) (kitten_36 Bool) (kitten_37 Bool)) Bool (=> (or (= kitten_34 true) (fp.leq (fp.neg (fp #b0 #b10001011 #b00000000000000000000000)) (fp #b0 #b10001011 #b00000000000000000000000))) (spoon_16 kitten_33)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_25 cat_49)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b01101010100000000000000)) (spoon_25 cat_50)))
(assert (= cat_54 cat_51))
(assert (= cat_55 (distinct 0 0)))
(assert (= cat_56 cat_52))
(assert (= cat_57 cat_53))
(assert (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_56))
(assert (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_57))
(assert (not (fp.lt (fp #b0 #b01110101 #b00000110001001001101111) cat_57)))
(check-sat)
