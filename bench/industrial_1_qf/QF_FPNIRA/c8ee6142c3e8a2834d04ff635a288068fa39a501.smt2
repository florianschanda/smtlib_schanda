...
(define-fun spoon_4 ((kitten_4 Int)) Bool (and (<= 3 kitten_4) (<= kitten_4 30)))
...
(define-fun spoon_44 ((kitten_28 Int) (kitten_29 Bool) (kitten_30 Bool) (kitten_31 Bool) (kitten_32 Bool)) Bool (=> (or (= kitten_29 true) (<= 1 30)) (spoon_37 kitten_28)))
(define-fun spoon_45 ((kitten_33 Int) (kitten_34 Bool) (kitten_35 Bool) (kitten_36 Bool) (kitten_37 Bool)) Bool (=> (or (= kitten_34 true) (<= 3 30)) (spoon_4 kitten_33)))
...
(assert (= cat_52 cat_47))
(assert (= cat_53 1))
(assert (not (= cat_62 true)))
(assert (not (<= 1 1)))
(check-sat)
