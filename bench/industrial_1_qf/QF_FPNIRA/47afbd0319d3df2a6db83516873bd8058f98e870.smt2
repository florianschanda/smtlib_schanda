...
(define-fun spoon_16 ((kitten_24 Float32)) Bool (and (spoon_1 kitten_24) (and (fp.leq (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) kitten_24) (fp.leq kitten_24 (fp #b0 #b10000101 #b01101000000000000000000)))))
(define-fun spoon_17 ((kitten_25 Float32)) Bool (and (spoon_1 kitten_25) (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) kitten_25) (fp.leq kitten_25 (fp #b0 #b01111111 #b00000000000000000000000)))))
(define-fun spoon_18 ((kitten_26 Float32) (kitten_27 Bool) (kitten_28 Bool) (kitten_29 Bool) (kitten_30 Bool)) Bool (=> (or (= kitten_27 true) (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) (fp #b0 #b01111111 #b00000000000000000000000))) (spoon_17 kitten_26)))
(declare-const cat_19 Float32)
(declare-const cat_20 Int)
(declare-const cat_21 Int)
(define-fun spoon_22 ((kitten_31 Float32) (kitten_32 Bool) (kitten_33 Bool) (kitten_34 Bool) (kitten_35 Bool)) Bool (=> (or (= kitten_32 true) (fp.leq (fp.neg (fp #b0 #b10000101 #b01101000000000000000000)) (fp #b0 #b10000101 #b01101000000000000000000))) (spoon_16 kitten_31)))
...
(assert (not (fp.leq (fp.abs cat_19) (fp #b0 #b01111111 #b00000000000000000000000))))
(check-sat)
