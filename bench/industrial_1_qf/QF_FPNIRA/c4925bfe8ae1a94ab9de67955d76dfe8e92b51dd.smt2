...
(assert (and (= cat_112 (fp.mul RNE cat_151 ((_ to_fp 11 53) RNE cat_63))) (spoon_3 (fp.mul RNE cat_151 ((_ to_fp 11 53) RNE cat_63)))))
(assert (= cat_113 (fp.mul RNE cat_112 cat_154)))
(assert (and (= cat_114 cat_113) (spoon_3 cat_113)))
(assert (and (= cat_108 (fp.sub RNE cat_152 cat_149)) (spoon_3 (fp.sub RNE cat_152 cat_149))))
(assert (= cat_109 (fp.sub RNE cat_108 cat_150)))
(assert (and (= cat_110 cat_109) (spoon_3 cat_109)))
...
(assert (= cat_155 cat_117))
(assert (and (= cat_118 (fp.add RNE cat_152 cat_149)) (spoon_3 (fp.add RNE cat_152 cat_149))))
(assert (= cat_119 (fp.add RNE cat_118 cat_150)))
(assert (and (= cat_120 cat_119) (spoon_3 cat_119)))
(assert (= cat_156 cat_120))
(assert (and (= cat_121 (fp.div RNE cat_155 cat_156)) (spoon_3 (fp.div RNE cat_155 cat_156))))
(assert (= cat_157 cat_121))
(assert (=> (fp.lt cat_157 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (= cat_158 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_157 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_157) (= cat_159 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
(assert (=> (not (fp.lt cat_157 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_157)) (and (= cat_122 cat_157) (spoon_3 cat_157)))))
(assert (=> (not (fp.lt cat_157 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_157)) (= cat_160 cat_122))))
(assert (=> (not (fp.lt cat_157 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (=> (not (fp.lt (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) cat_157)) (= cat_159 cat_160))))
(assert (=> (not (fp.lt cat_157 (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))) (= cat_158 cat_159)))
(assert (and (= cat_123 (fp.mul RNE cat_151 ((_ to_fp 11 53) RNE cat_61))) (spoon_3 (fp.mul RNE cat_151 ((_ to_fp 11 53) RNE cat_61)))))
(assert (= cat_161 cat_123))
(assert (and (= cat_128 (fp.mul RNE cat_151 ((_ to_fp 11 53) RNE cat_63))) (spoon_3 (fp.mul RNE cat_151 ((_ to_fp 11 53) RNE cat_63)))))
(assert (= cat_129 (fp.mul RNE cat_128 cat_153)))
(assert (and (= cat_130 cat_129) (spoon_3 cat_129)))
(assert (and (= cat_124 (fp.sub RNE cat_152 cat_149)) (spoon_3 (fp.sub RNE cat_152 cat_149))))
(assert (= cat_125 (fp.sub RNE cat_124 cat_150)))
(assert (and (= cat_126 cat_125) (spoon_3 cat_125)))
(assert (= cat_127 (fp.mul RNE cat_126 cat_154)))
(assert (and (= cat_131 cat_127) (spoon_3 cat_127)))
(assert (= cat_132 (fp.sub RNE cat_131 cat_130)))
(assert (and (= cat_133 cat_132) (spoon_3 cat_132)))
(assert (= cat_162 cat_133))
(assert (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) cat_162))
(assert (and (= cat_139 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_162)) (spoon_3 (fp.mul RNE (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000) cat_162))))
(assert (= cat_140 (ite (fp.leq cat_161 cat_139) true false)))
(assert (not (spoon_3 (fp.mul RNE (fp.neg (fp #b0 #b10000001011 #b0110101010000000000000000000000000000000000000000000)) cat_162))))
(check-sat)
