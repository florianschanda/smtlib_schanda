...
(assert (= y (fp #b0 #b10010101 #b01101001010001101001001)))
;; y should be Float32(0x4AB4A349 [Rational(11838281, 2), 5919140.500000])

(declare-const result Float32)
(assert (= result (fp.div RNA x y)))
(assert (not (= result ((_ to_fp 8 24) #x743566D2))))
(check-sat)
(exit)
