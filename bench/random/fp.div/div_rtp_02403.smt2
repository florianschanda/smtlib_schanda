...
(assert (= y (fp #b0 #b10010010 #b00101011010101001011000)))
;; y should be Float32(0x4915AA58 [Rational(1226059, 2), 613029.500000])

(declare-const result Float32)
(assert (= result (fp.div RTP x y)))
(assert (= result (fp #b1 #b00000000 #b00000000000000000001101)))
(check-sat)
(exit)
