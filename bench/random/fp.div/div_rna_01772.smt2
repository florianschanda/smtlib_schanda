...
(assert (= y ((_ to_fp 8 24) #xBF5C167B)))
;; y should be Float32(0xBF5C167B [Rational(-14423675, 16777216), -0.859718])

(declare-const result Float32)
(assert (= result (fp.div RNA x y)))
(assert (not (= result (fp #b0 #b00000001 #b00101001110001011010001))))
(check-sat)
(exit)
