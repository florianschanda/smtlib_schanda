...
(assert (= x (fp #b1 #b10010011 #b00010011101000111001100)))
;; x should be Float32(0xC989D1CC [Rational(-2258035, 2), -1129017.500000])
...
(assert (not (= result (fp #b1 #b00010011 #b00010011101000111001101))))
(check-sat)
(exit)
