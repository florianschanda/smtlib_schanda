...
(assert (= x (fp #b1 #b10000111 #b11110011111010110000001)))
;; x should be Float32(0xC3F9F581 [Rational(-16381313, 32768), -499.917999])
...
(assert (not (= result ((_ to_fp 8 24) #x83F9F581))))
(check-sat)
(exit)
