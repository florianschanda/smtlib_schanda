...
(assert (= y (fp #b0 #b00000000 #b00011111011100111100100)))
;; y should be Float32(0x000FB9E4 [Rational(257657, 178405961588244985132285746181186892047843328), 0.000000])
