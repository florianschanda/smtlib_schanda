...
(assert (= y (fp #b0 #b00000000 #b01101110010010100001110)))
;; y should be Float32(0x0037250E [Rational(1806983, 356811923176489970264571492362373784095686656), 0.000000])
