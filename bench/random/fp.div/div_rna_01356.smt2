...
(assert (= x (fp #b0 #b10010011 #b01101111100111000110100)))
;; x should be Float32(0x49B7CE34 [Rational(3011469, 2), 1505734.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x89B7CE35))))
(check-sat)
(exit)
