...
(assert (= y ((_ to_fp 8 24) #x4A39D8BA)))
;; y should be Float32(0x4A39D8BA [Rational(6089821, 2), 3044910.500000])

(declare-const result Float32)
(assert (= result (fp.div RTP x y)))
(assert (not (= result (fp #b0 #b11101001 #b01100000101000101000101))))
(check-sat)
(exit)
