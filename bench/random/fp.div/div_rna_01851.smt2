...
(assert (= x (fp #b1 #b10000010 #b01111010010101111000000)))
;; x should be Float32(0xC13D2BC0 [Rational(-193711, 16384), -11.823181])
...
(assert (= result (fp #b1 #b00000010 #b01111010010101111000001)))
(check-sat)
(exit)
