...
(assert (= x (fp #b1 #b00000000 #b01110101001111111011010)))
;; x should be Float32(0x803A9FDA [Rational(-1921005, 356811923176489970264571492362373784095686656), -0.000000])
