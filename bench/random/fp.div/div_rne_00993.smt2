...
(assert (= x (fp #b1 #b10010010 #b10100001100101110011000)))
;; x should be Float32(0xC950CB98 [Rational(-1710451, 2), -855225.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8950CB99))))
(check-sat)
(exit)
