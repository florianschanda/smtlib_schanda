...
(assert (= x (fp #b0 #b11011000 #b00101011111001010000100)))
;; x should be Float32(0x6C15F284 [Rational(725100779126607723334991872), 725100779126607723334991872.000000])
