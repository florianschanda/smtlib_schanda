...
(assert (= x (fp #b0 #b00000000 #b00001000100010100111101)))
;; x should be Float32(0x0004453D [Rational(279869, 713623846352979940529142984724747568191373312), 0.000000])
