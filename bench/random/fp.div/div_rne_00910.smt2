...
(assert (= x (fp #b0 #b11111011 #b11001100100111011101101)))
;; x should be Float32(0x7DE64EED [Rational(38266530639571554096098934759589150720), 38266530639571554096098934759589150720.000000])
