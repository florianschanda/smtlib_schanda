...
(assert (= y ((_ to_fp 8 24) #x7E4F7C84)))
;; y should be Float32(0x7E4F7C84 [Rational(68949179304000896584380451015006093312), 68949179304000896584380451015006093312.000000])
