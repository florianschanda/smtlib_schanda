...
(assert (= x (fp #b1 #b00000000 #b00000111110010111000110)))
;; x should be Float32(0x8003E5C6 [Rational(-127715, 356811923176489970264571492362373784095686656), -0.000000])
