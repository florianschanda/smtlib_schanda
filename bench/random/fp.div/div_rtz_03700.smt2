...
(assert (= y (fp #b1 #b00000000 #b01111010111011101001010)))
;; y should be Float32(0x803D774A [Rational(-2014117, 356811923176489970264571492362373784095686656), -0.000000])
