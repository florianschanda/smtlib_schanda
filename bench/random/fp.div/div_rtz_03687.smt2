...
(assert (= y (fp #b1 #b10010101 #b10100001100101111011111)))
;; y should be Float32(0xCAD0CBDF [Rational(-13683679, 2), -6841839.500000])

(declare-const result Float32)
(assert (= result (fp.div RTZ x y)))
(assert (not (= result (fp #b0 #b11101000 #b00111001111000000000101))))
(check-sat)
(exit)
