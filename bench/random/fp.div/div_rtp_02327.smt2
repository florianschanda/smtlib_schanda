...
(assert (= x (fp #b1 #b10010101 #b00111011100000010010011)))
;; x should be Float32(0xCA9DC093 [Rational(-10338451, 2), -5169225.500000])
...
(assert (= result ((_ to_fp 8 24) #x0A9DC094)))
(check-sat)
(exit)
