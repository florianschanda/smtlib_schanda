...
(assert (= y (fp #b0 #b00000000 #b01011101111001110000010)))
;; y should be Float32(0x002EF382 [Rational(1538497, 356811923176489970264571492362373784095686656), 0.000000])
