...
(assert (= y (fp #b1 #b10001110 #b00110110101010010000000)))
;; y should be Float32(0xC71B5480 [Rational(-79529, 2), -39764.500000])

(declare-const result Float32)
(assert (= result (fp.div RTZ x y)))
(assert (= result (fp #b1 #b00000000 #b00000000000000011010010)))
(check-sat)
(exit)
