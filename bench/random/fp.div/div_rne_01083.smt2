...
(assert (= y (fp #b1 #b00000000 #b00011110000010011101111)))
;; y should be Float32(0x800F04EF [Rational(-984303, 713623846352979940529142984724747568191373312), -0.000000])
