...
(assert (= y ((_ to_fp 8 24) #x49DEF2B4)))
;; y should be Float32(0x49DEF2B4 [Rational(3652781, 2), 1826390.500000])

(declare-const result Float32)
(assert (= result (fp.div RTZ x y)))
(assert (not (= result (fp #b0 #b11101010 #b00100101111100111010110))))
(check-sat)
(exit)
