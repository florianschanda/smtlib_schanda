...
(assert (= x ((_ to_fp 8 24) #x803E4828)))
;; x should be Float32(0x803E4828 [Rational(-510213, 89202980794122492566142873090593446023921664), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x4A7920A0))))
(check-sat)
(exit)
