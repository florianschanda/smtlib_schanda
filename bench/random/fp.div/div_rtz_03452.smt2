...
(assert (= y (fp #b1 #b11110001 #b10100100100100110101101)))
;; y should be Float32(0xF8D249AD [Rational(-34121145708296729426961126924484608), -34121145708296729426961126924484608.000000])
