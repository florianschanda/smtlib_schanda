...
(assert (= y ((_ to_fp 8 24) #x8023AED0)))
;; y should be Float32(0x8023AED0 [Rational(-146157, 44601490397061246283071436545296723011960832), -0.000000])

(declare-const result Float32)
(assert (= result (fp.div RTZ x y)))
(assert (= result ((_ to_fp 8 24) #xC06593F6)))
(check-sat)
(exit)
