...
(assert (= y ((_ to_fp 8 24) #x4AE0FF9F)))
;; y should be Float32(0x4AE0FF9F [Rational(14745503, 2), 7372751.500000])

(declare-const result Float32)
(assert (= result (fp.div RNA x y)))
(assert (not (= result (fp #b0 #b11101000 #b00100011010001011110010))))
(check-sat)
(exit)
