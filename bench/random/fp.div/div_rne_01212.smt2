...
(assert (= x ((_ to_fp 8 24) #xE1DC3932)))
;; x should be Float32(0xE1DC3932 [Rational(-507800631603137347584), -507800631603137347584.000000])
...
(assert (not (= result (fp #b0 #b01000011 #b10111000011100100110011))))
(check-sat)
(exit)
