...
(assert (= y ((_ to_fp 8 24) #x9C071A42)))
;; y should be Float32(0x9C071A42 [Rational(-4427041, 9903520314283042199192993792), -0.000000])

(declare-const result Float32)
(assert (= result (fp.div RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #xA3F28AA9))))
(check-sat)
(exit)
