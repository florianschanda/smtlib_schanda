...
(assert (= x ((_ to_fp 8 24) #x1242146E)))
;; x should be Float32(0x1242146E [Rational(6359607, 10384593717069655257060992658440192), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xD1421470))))
(check-sat)
(exit)
