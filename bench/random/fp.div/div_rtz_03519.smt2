...
(assert (= x (fp #b0 #b11010110 #b11011100000011101000101)))
;; x should be Float32(0x6B6E0745 [Rational(287758674459002917055627264), 287758674459002917055627264.000000])
