...
(assert (= y ((_ to_fp 8 24) #x163C713F)))
;; y should be Float32(0x163C713F [Rational(12349759, 81129638414606681695789005144064), 0.000000])

(declare-const result Float32)
(assert (= result (fp.div RNE x y)))
(assert (= result ((_ to_fp 8 24) #x29ADE381)))
(check-sat)
(exit)
