...
(assert (= x (fp #b0 #b01101100 #b10110110101111000010001)))
;; x should be Float32(0x365B5E11 [Rational(14376465, 4398046511104), 0.000003])
...
(assert (= result ((_ to_fp 8 24) #xF55B5E13)))
(check-sat)
(exit)
