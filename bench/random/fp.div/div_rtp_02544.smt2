...
(assert (= x ((_ to_fp 8 24) #x8047B793)))
;; x should be Float32(0x8047B793 [Rational(-4700051, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xCA8F6F26))))
(check-sat)
(exit)
