...
(assert (= y ((_ to_fp 8 24) #x00454FD8)))
;; y should be Float32(0x00454FD8 [Rational(567803, 89202980794122492566142873090593446023921664), 0.000000])

(declare-const result Float32)
(assert (= result (fp.div RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #xBFEC617A))))
(check-sat)
(exit)
