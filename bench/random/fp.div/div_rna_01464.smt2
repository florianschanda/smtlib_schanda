...
(assert (= y ((_ to_fp 8 24) #xB29B6673)))
;; y should be Float32(0xB29B6673 [Rational(-10184307, 562949953421312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.div RNA x y)))
(assert (not (= result (fp #b1 #b00011010 #b10100101101110010101100))))
(check-sat)
(exit)
