...
(assert (= x (fp #b1 #b00000000 #b11010111100110101010100)))
;; x should be Float32(0x806BCD54 [Rational(-1766229, 178405961588244985132285746181186892047843328), -0.000000])
