...
(assert (= x ((_ to_fp 8 24) #x49E5F334)))
;; x should be Float32(0x49E5F334 [Rational(3767501, 2), 1883750.500000])
...
(assert (not (= result (fp #b0 #b00010011 #b11001011111001100110100))))
(check-sat)
(exit)
