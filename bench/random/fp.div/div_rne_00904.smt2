...
(assert (= x (fp #b0 #b10100110 #b11000000010011011110101)))
;; x should be Float32(0x536026F5 [Rational(962726264832), 962726264832.000000])
...
(assert (= result (fp #b1 #b00100110 #b11000000010011011110110)))
(check-sat)
(exit)
