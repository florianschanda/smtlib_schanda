...
(assert (= y (fp #b1 #b01011101 #b00010100001100111111011)))
;; y should be Float32(0xAE8A19FB [Rational(-9050619, 144115188075855872), -0.000000])

(declare-const result Float32)
(assert (= result (fp.div RNE x y)))
(assert (= result ((_ to_fp 8 24) #x916D4658)))
(check-sat)
(exit)
