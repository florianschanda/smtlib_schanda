...
(assert (= y ((_ to_fp 8 24) #x497D47E8)))
;; y should be Float32(0x497D47E8 [Rational(2074877, 2), 1037438.500000])

(declare-const result Float32)
(assert (= result (fp.div RNA x y)))
(assert (not (= result (fp #b1 #b11101011 #b00000010101111111001000))))
(check-sat)
(exit)
