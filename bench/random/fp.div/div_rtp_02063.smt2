...
(assert (= y ((_ to_fp 8 24) #x4AD42679)))
;; y should be Float32(0x4AD42679 [Rational(13903481, 2), 6951740.500000])

(declare-const result Float32)
(assert (= result (fp.div RTP x y)))
(assert (= result (fp #b0 #b11101000 #b00110100111010011100000)))
(check-sat)
(exit)
