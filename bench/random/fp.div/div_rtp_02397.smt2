...
(assert (= y (fp #b1 #b00000000 #b10111011010010011011010)))
;; y should be Float32(0x805DA4DA [Rational(-3068525, 356811923176489970264571492362373784095686656), -0.000000])
