...
(assert (= x (fp #b1 #b10010100 #b01011110010001010010110)))
;; x should be Float32(0xCA2F2296 [Rational(-5738827, 2), -2869413.500000])
...
(assert (not (= result (fp #b0 #b00010100 #b01011110010001010010110))))
(check-sat)
(exit)
