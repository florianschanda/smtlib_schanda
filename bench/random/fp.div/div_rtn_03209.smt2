...
(assert (= x (fp #b1 #b00000000 #b11101110100010100110001)))
;; x should be Float32(0x80774531 [Rational(-7816497, 713623846352979940529142984724747568191373312), -0.000000])
