...
(assert (= y (fp #b1 #b10010101 #b01011100111110010101011)))
;; y should be Float32(0xCAAE7CAB [Rational(-11435179, 2), -5717589.500000])

(declare-const result Float32)
(assert (= result (fp.div RNA x y)))
(assert (= result ((_ to_fp 8 24) #xF43BCBD6)))
(check-sat)
(exit)
