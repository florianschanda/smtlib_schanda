...
(assert (= x ((_ to_fp 8 24) #x000AC5CA)))
;; x should be Float32(0x000AC5CA [Rational(352997, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBDAC5CA2)))
(check-sat)
(exit)
