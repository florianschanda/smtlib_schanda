...
(assert (= x ((_ to_fp 8 24) #xB7A489C3)))
;; x should be Float32(0xB7A489C3 [Rational(-10783171, 549755813888), -0.000020])
...
(assert (= result (fp #b1 #b00000000 #b00000000000000000101001)))
(check-sat)
(exit)
