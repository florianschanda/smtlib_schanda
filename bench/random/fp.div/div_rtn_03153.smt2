...
(assert (= x ((_ to_fp 8 24) #xC32BC0F4)))
;; x should be Float32(0xC32BC0F4 [Rational(-2814013, 16384), -171.753723])
...
(assert (not (= result (fp #b1 #b00000110 #b01010111100000011110101))))
(check-sat)
(exit)
