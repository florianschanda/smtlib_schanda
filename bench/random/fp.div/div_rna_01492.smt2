...
(assert (= y (fp #b1 #b01101000 #b10011011100000010110101)))
;; y should be Float32(0xB44DC0B5 [Rational(-13484213, 70368744177664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.div RNA x y)))
(assert (= result ((_ to_fp 8 24) #x8B9F4254)))
(check-sat)
(exit)
