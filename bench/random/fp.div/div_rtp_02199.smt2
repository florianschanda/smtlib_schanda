...
(assert (= x (fp #b0 #b11000001 #b10010100000000001100101)))
;; x should be Float32(0x60CA0065 [Rational(116445960370686787584), 116445960370686787584.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x20CA0066))))
(check-sat)
(exit)
