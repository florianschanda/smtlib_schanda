...
(assert (= x (fp #b1 #b00000000 #b10011111111110000110110)))
;; x should be Float32(0x804FFC36 [Rational(-2620955, 356811923176489970264571492362373784095686656), -0.000000])
