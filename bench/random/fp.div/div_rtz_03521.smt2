...
(assert (= x ((_ to_fp 8 24) #x27CCAB59)))
;; x should be Float32(0x27CCAB59 [Rational(13413209, 2361183241434822606848), 0.000000])
...
(assert (= result (fp #b1 #b11001101 #b10011001010101101011001)))
(check-sat)
(exit)
