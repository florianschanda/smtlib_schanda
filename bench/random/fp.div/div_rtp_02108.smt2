...
(assert (= y ((_ to_fp 8 24) #x006655E7)))
;; y should be Float32(0x006655E7 [Rational(6706663, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.div RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #x3FA019CA))))
(check-sat)
(exit)
