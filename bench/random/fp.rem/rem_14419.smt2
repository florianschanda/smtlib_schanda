...
(assert (= y (fp #b1 #b01110101 #b11000011100111110101001)))
;; y should be Float32(0xBAE1CFA9 [Rational(-14798761, 8589934592), -0.001723])

(declare-const result Float32)
(assert (= result (fp.rem x y)))
(assert (= result (fp #b0 #b01110100 #b01100111000001011011110)))
(check-sat)
(exit)
