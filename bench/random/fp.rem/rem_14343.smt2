...
(assert (= x (fp #b0 #b10010101 #b01111000111100111110111)))
;; x should be Float32(0x4ABC79F7 [Rational(12351991, 2), 6175995.500000])
...
(assert (= result ((_ to_fp 8 24) #x80181E1C)))
(check-sat)
(exit)
