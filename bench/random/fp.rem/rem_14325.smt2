...
(assert (= x ((_ to_fp 8 24) #x4AF2B433)))
;; x should be Float32(0x4AF2B433 [Rational(15905843, 2), 7952921.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b01011110010110001101010))))
(check-sat)
(exit)
