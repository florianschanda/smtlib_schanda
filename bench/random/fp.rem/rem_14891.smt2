...
(assert (= x ((_ to_fp 8 24) #x8043695B)))
;; x should be Float32(0x8043695B [Rational(-4417883, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x8043695B))))
(check-sat)
(exit)
