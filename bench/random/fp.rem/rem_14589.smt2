...
(assert (= x (fp #b0 #b00000000 #b01010111101111001000010)))
;; x should be Float32(0x002BDE42 [Rational(1437473, 356811923176489970264571492362373784095686656), 0.000000])
