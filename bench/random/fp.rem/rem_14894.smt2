...
(assert (= x ((_ to_fp 8 24) #x80567095)))
;; x should be Float32(0x80567095 [Rational(-5664917, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x00298F6A)))
(check-sat)
(exit)
