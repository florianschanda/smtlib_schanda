...
(assert (= x (fp #b0 #b10010100 #b10000101010101010111110)))
;; x should be Float32(0x4A42AABE [Rational(6378847, 2), 3189423.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x802A80F5))))
(check-sat)
(exit)
