...
(assert (= x ((_ to_fp 8 24) #x41D49A93)))
;; x should be Float32(0x41D49A93 [Rational(13933203, 524288), 26.575476])
...
(assert (not (= result (fp #b1 #b00000000 #b01101011010101101100101))))
(check-sat)
(exit)
