...
(assert (= x (fp #b0 #b00111001 #b10111011111011110111000)))
;; x should be Float32(0x1CDDF7B8 [Rational(1818359, 1237940039285380274899124224), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x1CDDF7B8)))
(check-sat)
(exit)
