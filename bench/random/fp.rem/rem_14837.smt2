...
(assert (= x ((_ to_fp 8 24) #xE1EB576E)))
;; x should be Float32(0xE1EB576E [Rational(-542660603781310316544), -542660603781310316544.000000])
...
(assert (= result ((_ to_fp 8 24) #x002240A5)))
(check-sat)
(exit)
