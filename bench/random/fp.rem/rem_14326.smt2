...
(assert (= x ((_ to_fp 8 24) #x4AF3750D)))
;; x should be Float32(0x4AF3750D [Rational(15955213, 2), 7977606.500000])
...
(assert (= result (fp #b1 #b00000000 #b01010111100010001100100)))
(check-sat)
(exit)
