...
(assert (= y ((_ to_fp 8 24) #xE0437189)))
;; y should be Float32(0xE0437189 [Rational(-56332752571429027840), -56332752571429027840.000000])

(declare-const result Float32)
(assert (= result (fp.rem x y)))
(assert (= result (fp #b0 #b10111111 #b01111000101000111101100)))
(check-sat)
(exit)
