...
(assert (= y ((_ to_fp 8 24) #x0AC2FB8E)))
;; y should be Float32(0x0AC2FB8E [Rational(6389191, 340282366920938463463374607431768211456), 0.000000])

(declare-const result Float32)
(assert (= result (fp.rem x y)))
(assert (= result (fp #b0 #b00010010 #b00001011000011111100000)))
(check-sat)
(exit)
