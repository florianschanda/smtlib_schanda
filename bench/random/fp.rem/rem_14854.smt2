...
(assert (= x ((_ to_fp 8 24) #x92EC8CBA)))
;; x should be Float32(0x92EC8CBA [Rational(-7751261, 5192296858534827628530496329220096), -0.000000])
...
(assert (not (= result (fp #b1 #b00100101 #b11011001000110010111010))))
(check-sat)
(exit)
