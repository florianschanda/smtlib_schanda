...
(assert (= x (fp #b0 #b00000000 #b01011100000011100010010)))
;; x should be Float32(0x002E0712 [Rational(1508233, 356811923176489970264571492362373784095686656), 0.000000])
