...
(assert (= x ((_ to_fp 8 24) #x807B5F13)))
;; x should be Float32(0x807B5F13 [Rational(-8085267, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x0004A0EC))))
(check-sat)
(exit)
