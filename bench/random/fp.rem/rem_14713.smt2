...
(assert (= y (fp #b0 #b00000000 #b01000110000101001000101)))
;; y should be Float32(0x00230A45 [Rational(2296389, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.rem x y)))
(assert (not (= result ((_ to_fp 8 24) #x0006FB85))))
(check-sat)
(exit)
