...
(assert (= x (fp #b1 #b00000000 #b10100111100010010111101)))
;; x should be Float32(0x8053C4BD [Rational(-5489853, 713623846352979940529142984724747568191373312), -0.000000])
