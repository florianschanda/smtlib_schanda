...
(assert (= y ((_ to_fp 8 24) #x001E78EC)))
;; y should be Float32(0x001E78EC [Rational(499259, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.rem x y)))
(assert (= result ((_ to_fp 8 24) #x80061C4F)))
(check-sat)
(exit)
