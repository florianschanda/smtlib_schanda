...
(assert (= y ((_ to_fp 8 24) #xA90E3BE7)))
;; y should be Float32(0xA90E3BE7 [Rational(-9321447, 295147905179352825856), -0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RTP x y)))
(assert (not (= result (fp #b0 #b01010010 #b00011100011101111101000))))
(check-sat)
(exit)
