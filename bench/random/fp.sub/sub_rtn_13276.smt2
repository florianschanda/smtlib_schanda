...
(assert (= x (fp #b0 #b00000000 #b11100110000010111001011)))
;; x should be Float32(0x007305CB [Rational(7538123, 713623846352979940529142984724747568191373312), 0.000000])
