...
(assert (= x (fp #b0 #b00000000 #b01101011111111110100110)))
;; x should be Float32(0x0035FFA6 [Rational(1769427, 356811923176489970264571492362373784095686656), 0.000000])
