...
(assert (= y (fp #b1 #b10010101 #b11101010110101011010111)))
;; y should be Float32(0xCAF56AD7 [Rational(-16083671, 2), -8041835.500000])

(declare-const result Float32)
(assert (= result (fp.sub RNA x y)))
(assert (not (= result ((_ to_fp 8 24) #x4AF56AD7))))
(check-sat)
(exit)
