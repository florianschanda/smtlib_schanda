...
(assert (= y ((_ to_fp 8 24) #x4A7E35F6)))
;; y should be Float32(0x4A7E35F6 [Rational(8329979, 2), 4164989.500000])

(declare-const result Float32)
(assert (= result (fp.sub RTN x y)))
(assert (not (= result (fp #b1 #b10010100 #b11111100011010111110110))))
(check-sat)
(exit)
