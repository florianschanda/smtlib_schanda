...
(assert (= x ((_ to_fp 8 24) #x64C89381)))
;; x should be Float32(0x64C89381 [Rational(29599820730699851235328), 29599820730699851235328.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x64C89381))))
(check-sat)
(exit)
