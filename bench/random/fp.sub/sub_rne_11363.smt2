...
(assert (= x (fp #b0 #b00000000 #b11111001101001100010110)))
;; x should be Float32(0x007CD316 [Rational(4090251, 356811923176489970264571492362373784095686656), 0.000000])
