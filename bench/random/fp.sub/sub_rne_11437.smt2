...
(assert (= x ((_ to_fp 8 24) #xCAB6383B)))
;; x should be Float32(0xCAB6383B [Rational(-11941947, 2), -5970973.500000])
...
(assert (not (= result (fp #b1 #b10010101 #b01101100011100000111011))))
(check-sat)
(exit)
