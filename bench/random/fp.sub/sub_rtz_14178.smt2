...
(assert (= x (fp #b1 #b01111001 #b00111110110011011011101)))
;; x should be Float32(0xBC9F66DD [Rational(-10446557, 536870912), -0.019458])
...
(assert (= result (fp #b1 #b01111001 #b00111110110011011011101)))
(check-sat)
(exit)
