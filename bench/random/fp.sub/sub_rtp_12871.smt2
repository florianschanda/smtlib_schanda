...
(assert (= y (fp #b1 #b10010100 #b11100011110010000000010)))
;; y should be Float32(0xCA71E402 [Rational(-7926273, 2), -3963136.500000])

(declare-const result Float32)
(assert (= result (fp.sub RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #x4A71E402))))
(check-sat)
(exit)
