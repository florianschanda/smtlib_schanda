...
(assert (= x ((_ to_fp 8 24) #xCC626C82)))
;; x should be Float32(0xCC626C82 [Rational(-59355656), -59355656.000000])
...
(assert (not (= result (fp #b1 #b10011000 #b11000100110110010000001))))
(check-sat)
(exit)
