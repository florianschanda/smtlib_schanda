...
(assert (= y ((_ to_fp 8 24) #x4AFE406F)))
;; y should be Float32(0x4AFE406F [Rational(16662639, 2), 8331319.500000])

(declare-const result Float32)
(assert (= result (fp.sub RNE x y)))
(assert (not (= result (fp #b1 #b10010101 #b11111100100000001101111))))
(check-sat)
(exit)
