...
(assert (= x (fp #b0 #b00000000 #b10001100111011100011001)))
;; x should be Float32(0x00467719 [Rational(4618009, 713623846352979940529142984724747568191373312), 0.000000])
