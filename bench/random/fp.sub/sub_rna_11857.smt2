...
(assert (= y ((_ to_fp 8 24) #x46BA8A57)))
;; y should be Float32(0x46BA8A57 [Rational(12225111, 512), 23877.169922])

(declare-const result Float32)
(assert (= result (fp.sub RNA x y)))
(assert (not (= result (fp #b1 #b10001101 #b01110101000101001010111))))
(check-sat)
(exit)
