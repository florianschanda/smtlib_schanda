...
(assert (= y ((_ to_fp 8 24) #xC988A0C4)))
;; y should be Float32(0xC988A0C4 [Rational(-2238513, 2), -1119256.500000])

(declare-const result Float32)
(assert (= result (fp.sub RNA x y)))
(assert (not (= result (fp #b0 #b10010011 #b00010001010000011000100))))
(check-sat)
(exit)
