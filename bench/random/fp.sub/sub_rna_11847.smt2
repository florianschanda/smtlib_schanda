...
(assert (= y ((_ to_fp 8 24) #x4AF7B7F1)))
;; y should be Float32(0x4AF7B7F1 [Rational(16234481, 2), 8117240.500000])

(declare-const result Float32)
(assert (= result (fp.sub RNA x y)))
(assert (= result (fp #b1 #b10010101 #b11101111011011111110001)))
(check-sat)
(exit)
