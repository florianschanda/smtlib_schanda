...
(assert (= x ((_ to_fp 8 24) #x4AF30A4B)))
;; x should be Float32(0x4AF30A4B [Rational(15927883, 2), 7963941.500000])
...
(assert (= result (fp #b0 #b10010101 #b11100110000101001001010)))
(check-sat)
(exit)
