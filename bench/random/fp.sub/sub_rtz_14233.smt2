...
(assert (= x ((_ to_fp 8 24) #x803B4274)))
;; x should be Float32(0x803B4274 [Rational(-970909, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x0044BD8B))))
(check-sat)
(exit)
