...
(assert (= y ((_ to_fp 8 24) #xCAF04077)))
;; y should be Float32(0xCAF04077 [Rational(-15745143, 2), -7872571.500000])

(declare-const result Float32)
(assert (= result (fp.sub RTZ x y)))
(assert (not (= result (fp #b0 #b10010101 #b11100000100000001110110))))
(check-sat)
(exit)
