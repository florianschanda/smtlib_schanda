...
(assert (= y ((_ to_fp 8 24) #xCADCCF19)))
;; y should be Float32(0xCADCCF19 [Rational(-14470937, 2), -7235468.500000])

(declare-const result Float32)
(assert (= result (fp.sub RNA x y)))
(assert (not (= result (fp #b0 #b10010101 #b10111001100111100011001))))
(check-sat)
(exit)
