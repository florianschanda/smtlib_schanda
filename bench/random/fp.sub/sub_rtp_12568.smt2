...
(assert (= y (fp #b1 #b10010101 #b00010101010000110101011)))
;; y should be Float32(0xCA8AA1AB [Rational(-9085355, 2), -4542677.500000])

(declare-const result Float32)
(assert (= result (fp.sub RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #x4A8AA1AC))))
(check-sat)
(exit)
