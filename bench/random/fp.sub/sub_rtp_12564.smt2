...
(assert (= y ((_ to_fp 8 24) #x005A8DB7)))
;; y should be Float32(0x005A8DB7 [Rational(5934519, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #x805A8DB6))))
(check-sat)
(exit)
