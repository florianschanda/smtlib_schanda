...
(assert (= x (fp #b0 #b01110010 #b10011101010000110010000)))
;; x should be Float32(0x394EA190 [Rational(846361, 4294967296), 0.000197])
...
(assert (= result ((_ to_fp 8 24) #x394EA190)))
(check-sat)
(exit)
