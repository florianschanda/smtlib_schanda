...
(assert (= x ((_ to_fp 8 24) #x02F098E1)))
;; x should be Float32(0x02F098E1 [Rational(15767777, 44601490397061246283071436545296723011960832), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x02F898E1)))
(check-sat)
(exit)
