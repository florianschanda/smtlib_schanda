...
(assert (= x ((_ to_fp 8 24) #x8002F035)))
;; x should be Float32(0x8002F035 [Rational(-192565, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x8002F034)))
(check-sat)
(exit)
