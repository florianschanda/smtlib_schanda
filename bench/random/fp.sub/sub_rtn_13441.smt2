...
(assert (= y (fp #b0 #b10010101 #b10010111010001000110111)))
;; y should be Float32(0x4ACBA237 [Rational(13345335, 2), 6672667.500000])

(declare-const result Float32)
(assert (= result (fp.sub RTN x y)))
(assert (= result (fp #b1 #b10010101 #b10010111010001000111000)))
(check-sat)
(exit)
