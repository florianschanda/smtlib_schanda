...
(assert (= x (fp #b1 #b10010101 #b00100100101101001101111)))
;; x should be Float32(0xCA925A6F [Rational(-9591407, 2), -4795703.500000])
...
(assert (not (= result (fp #b1 #b10010101 #b00100100101101001101110))))
(check-sat)
(exit)
