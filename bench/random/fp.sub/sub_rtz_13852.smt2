...
(assert (= y (fp #b0 #b10010101 #b01100011010111010111011)))
;; y should be Float32(0x4AB1AEBB [Rational(11644603, 2), 5822301.500000])

(declare-const result Float32)
(assert (= result (fp.sub RTZ x y)))
(assert (= result ((_ to_fp 8 24) #xCAB1AEBA)))
(check-sat)
(exit)
