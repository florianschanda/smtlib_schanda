...
(assert (= y ((_ to_fp 8 24) #xB3A64A92)))
;; y should be Float32(0xB3A64A92 [Rational(-5449033, 70368744177664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RNE x y)))
(assert (= result (fp #b0 #b01100111 #b01001100100101010010010)))
(check-sat)
(exit)
