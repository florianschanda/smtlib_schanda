...
(assert (= x ((_ to_fp 8 24) #x468C90BB)))
;; x should be Float32(0x468C90BB [Rational(9212091, 512), 17992.365234])
...
(assert (not (= result (fp #b0 #b10001101 #b00011001001000010111011))))
(check-sat)
(exit)
