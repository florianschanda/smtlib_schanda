...
(assert (= x (fp #b0 #b10010101 #b11110101001011110001111)))
;; x should be Float32(0x4AFA978F [Rational(16422799, 2), 8211399.500000])
...
(assert (= result ((_ to_fp 8 24) #x4AFA978F)))
(check-sat)
(exit)
