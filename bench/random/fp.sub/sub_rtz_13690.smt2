...
(assert (= x ((_ to_fp 8 24) #x4A9BD50D)))
;; x should be Float32(0x4A9BD50D [Rational(10212621, 2), 5106310.500000])
...
(assert (not (= result (fp #b0 #b10010101 #b00110111101010100001100))))
(check-sat)
(exit)
