...
(assert (= x (fp #b1 #b00000000 #b10010011000001101000110)))
;; x should be Float32(0x80498346 [Rational(-2408867, 356811923176489970264571492362373784095686656), -0.000000])
