...
(assert (= x ((_ to_fp 8 24) #xCAC47943)))
;; x should be Float32(0xCAC47943 [Rational(-12876099, 2), -6438049.500000])
...
(assert (not (= result (fp #b1 #b10010101 #b10001000111100101000011))))
(check-sat)
(exit)
