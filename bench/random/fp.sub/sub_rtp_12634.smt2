...
(assert (= x ((_ to_fp 8 24) #x00383410)))
;; x should be Float32(0x00383410 [Rational(230209, 44601490397061246283071436545296723011960832), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x0038340F))))
(check-sat)
(exit)
