...
(assert (= x ((_ to_fp 8 24) #x800EC809)))
;; x should be Float32(0x800EC809 [Rational(-968713, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x808EC808))))
(check-sat)
(exit)
