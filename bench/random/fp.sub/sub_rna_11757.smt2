...
(assert (= x (fp #b0 #b10010101 #b01100100111011000000001)))
;; x should be Float32(0x4AB27601 [Rational(11695617, 2), 5847808.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x4AB27601))))
(check-sat)
(exit)
