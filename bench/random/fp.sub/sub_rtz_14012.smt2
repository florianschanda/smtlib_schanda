...
(assert (= x (fp #b1 #b10010101 #b00111001010110110000011)))
;; x should be Float32(0xCA9CAD83 [Rational(-10268035, 2), -5134017.500000])
...
(assert (not (= result ((_ to_fp 8 24) #xCA9CAD82))))
(check-sat)
(exit)
