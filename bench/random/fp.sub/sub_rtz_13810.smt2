...
(assert (= y (fp #b1 #b10100100 #b10011011000000110001101)))
;; y should be Float32(0xD24D818D [Rational(-220660449280), -220660449280.000000])

(declare-const result Float32)
(assert (= result (fp.sub RTZ x y)))
(assert (= result ((_ to_fp 8 24) #x524D818D)))
(check-sat)
(exit)
