...
(assert (= x (fp #b1 #b10010101 #b00101001101011111000101)))
;; x should be Float32(0xCA94D7C5 [Rational(-9754565, 2), -4877282.500000])
...
(assert (not (= result (fp #b1 #b10010101 #b00101001101011111000101))))
(check-sat)
(exit)
