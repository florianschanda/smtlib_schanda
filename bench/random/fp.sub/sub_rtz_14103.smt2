...
(assert (= y ((_ to_fp 8 24) #x92026F0A)))
;; y should be Float32(0x92026F0A [Rational(-4274053, 10384593717069655257060992658440192), -0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RTZ x y)))
(assert (= result ((_ to_fp 8 24) #x12026F09)))
(check-sat)
(exit)
