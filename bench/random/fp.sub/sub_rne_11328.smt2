...
(assert (= x ((_ to_fp 8 24) #x48FAFADC)))
;; x should be Float32(0x48FAFADC [Rational(4112055, 8), 514006.875000])
...
(assert (not (= result (fp #b0 #b10010001 #b11110101111101011011100))))
(check-sat)
(exit)
