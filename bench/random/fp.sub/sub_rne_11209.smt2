...
(assert (= y (fp #b0 #b10010101 #b10111000001100101010111)))
;; y should be Float32(0x4ADC1957 [Rational(14424407, 2), 7212203.500000])

(declare-const result Float32)
(assert (= result (fp.sub RNE x y)))
(assert (not (= result ((_ to_fp 8 24) #xCADC1957))))
(check-sat)
(exit)
