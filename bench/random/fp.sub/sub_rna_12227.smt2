...
(assert (= y ((_ to_fp 8 24) #x000088D6)))
;; y should be Float32(0x000088D6 [Rational(17515, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RNA x y)))
(assert (not (= result ((_ to_fp 8 24) #x800088D7))))
(check-sat)
(exit)
