...
(assert (= y ((_ to_fp 8 24) #xCAF6562D)))
;; y should be Float32(0xCAF6562D [Rational(-16143917, 2), -8071958.500000])

(declare-const result Float32)
(assert (= result (fp.sub RNE x y)))
(assert (not (= result (fp #b0 #b10010101 #b11101100101011000101101))))
(check-sat)
(exit)
