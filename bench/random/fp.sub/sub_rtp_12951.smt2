...
(assert (= x (fp #b1 #b00000000 #b00101011110101001110100)))
;; x should be Float32(0x8015EA74 [Rational(-359069, 178405961588244985132285746181186892047843328), -0.000000])
