...
(assert (= y (fp #b1 #b10100001 #b00111111110001000000010)))
;; y should be Float32(0xD09FE202 [Rational(-21459111936), -21459111936.000000])

(declare-const result Float32)
(assert (= result (fp.sub RNE x y)))
(assert (= result (fp #b0 #b10100001 #b00111111110001000000010)))
(check-sat)
(exit)
