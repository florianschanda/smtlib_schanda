...
(assert (= y ((_ to_fp 8 24) #x005AA4E7)))
;; y should be Float32(0x005AA4E7 [Rational(5940455, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RNE x y)))
(assert (= result ((_ to_fp 8 24) #x80DAA4E6)))
(check-sat)
(exit)
