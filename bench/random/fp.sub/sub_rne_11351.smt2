...
(assert (= x ((_ to_fp 8 24) #x002A24D9)))
;; x should be Float32(0x002A24D9 [Rational(2761945, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x002A24D8)))
(check-sat)
(exit)
