...
(assert (= y (fp #b0 #b01010010 #b10110011111010001110000)))
;; y should be Float32(0x2959F470 [Rational(892743, 18446744073709551616), 0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RNE x y)))
(assert (= result ((_ to_fp 8 24) #xA959F470)))
(check-sat)
(exit)
