...
(assert (= x (fp #b1 #b00000000 #b11000110101011001111101)))
;; x should be Float32(0x8063567D [Rational(-6510205, 713623846352979940529142984724747568191373312), -0.000000])
