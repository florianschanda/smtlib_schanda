...
(assert (= x (fp #b1 #b10010100 #b01011011011101101110011)))
;; x should be Float32(0xCA2DBB73 [Rational(-11385715, 4), -2846428.750000])
...
(assert (not (= result ((_ to_fp 8 24) #xCA2DBB74))))
(check-sat)
(exit)
