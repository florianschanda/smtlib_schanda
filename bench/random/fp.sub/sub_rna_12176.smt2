...
(assert (= y ((_ to_fp 8 24) #xE12A2C69)))
;; y should be Float32(0xE12A2C69 [Rational(-196196661346302951424), -196196661346302951424.000000])

(declare-const result Float32)
(assert (= result (fp.sub RNA x y)))
(assert (= result ((_ to_fp 8 24) #x612A2C69)))
(check-sat)
(exit)
