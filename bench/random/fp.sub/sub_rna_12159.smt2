...
(assert (= y ((_ to_fp 8 24) #x54777CFF)))
;; y should be Float32(0x54777CFF [Rational(4251816034304), 4251816034304.000000])

(declare-const result Float32)
(assert (= result (fp.sub RNA x y)))
(assert (= result (fp #b1 #b10101000 #b11101110111110011111111)))
(check-sat)
(exit)
