...
(assert (= x (fp #b1 #b11111000 #b10011001111111110000100)))
;; x should be Float32(0xFC4CFF84 [Rational(-4257644126829951580283560592161112064), -4257644126829951580283560592161112064.000000])
