...
(assert (= x ((_ to_fp 8 24) #xCAFADA77)))
;; x should be Float32(0xCAFADA77 [Rational(-16439927, 2), -8219963.500000])
...
(assert (not (= result (fp #b1 #b10010101 #b11110101101101001110111))))
(check-sat)
(exit)
