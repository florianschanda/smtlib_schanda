...
(assert (= x ((_ to_fp 8 24) #x006ED549)))
;; x should be Float32(0x006ED549 [Rational(7263561, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x00EED548)))
(check-sat)
(exit)
