...
(assert (= y ((_ to_fp 8 24) #x12382348)))
;; y should be Float32(0x12382348 [Rational(1508457, 2596148429267413814265248164610048), 0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RTN x y)))
(assert (= result ((_ to_fp 8 24) #x92382349)))
(check-sat)
(exit)
