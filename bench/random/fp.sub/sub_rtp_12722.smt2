...
(assert (= x ((_ to_fp 8 24) #xCAA6CB81)))
;; x should be Float32(0xCAA6CB81 [Rational(-10931073, 2), -5465536.500000])
...
(assert (= result (fp #b1 #b10010101 #b01001101100101110000000)))
(check-sat)
(exit)
