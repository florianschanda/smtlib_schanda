...
(assert (= y (fp #b1 #b00000000 #b10110111000001101010011)))
;; y should be Float32(0x805B8353 [Rational(-5997395, 713623846352979940529142984724747568191373312), -0.000000])
