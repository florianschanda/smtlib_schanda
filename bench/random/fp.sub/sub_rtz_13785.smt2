...
(assert (= y (fp #b0 #b10010101 #b01111111011100010111001)))
;; y should be Float32(0x4ABFB8B9 [Rational(12564665, 2), 6282332.500000])

(declare-const result Float32)
(assert (= result (fp.sub RTZ x y)))
(assert (= result ((_ to_fp 8 24) #xCABFB8B8)))
(check-sat)
(exit)
