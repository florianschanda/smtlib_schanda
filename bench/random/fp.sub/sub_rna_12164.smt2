...
(assert (= y (fp #b1 #b10010101 #b11010110101010111011011)))
;; y should be Float32(0xCAEB55DB [Rational(-15422939, 2), -7711469.500000])

(declare-const result Float32)
(assert (= result (fp.sub RNA x y)))
(assert (= result (fp #b0 #b10010101 #b11010110101010111011011)))
(check-sat)
(exit)
