...
(assert (= x ((_ to_fp 8 24) #x4A8CAE63)))
;; x should be Float32(0x4A8CAE63 [Rational(9219683, 2), 4609841.500000])
...
(assert (not (= result (fp #b0 #b10010101 #b00011001010111001100100))))
(check-sat)
(exit)
