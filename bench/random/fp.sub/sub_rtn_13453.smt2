...
(assert (= y ((_ to_fp 8 24) #x00310EAC)))
;; y should be Float32(0x00310EAC [Rational(803755, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.sub RTN x y)))
(assert (not (= result ((_ to_fp 8 24) #x80B10EAB))))
(check-sat)
(exit)
