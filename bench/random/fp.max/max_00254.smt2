...
(assert (= x ((_ to_fp 8 24) #x67C123AD)))
;; x should be Float32(0x67C123AD [Rational(1824149666400379844165632), 1824149666400379844165632.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x67C123AD))))
(check-sat)
(exit)
