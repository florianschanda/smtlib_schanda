...
(assert (= x (fp #b0 #b00000000 #b11101001101011010001111)))
;; x should be Float32(0x0074D68F [Rational(7657103, 713623846352979940529142984724747568191373312), 0.000000])
