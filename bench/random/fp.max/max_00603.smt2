...
(assert (= x (fp #b1 #b00000000 #b00100000010110111001001)))
;; x should be Float32(0x80102DC9 [Rational(-1060297, 713623846352979940529142984724747568191373312), -0.000000])
