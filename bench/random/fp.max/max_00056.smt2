...
(assert (= x (fp #b0 #b10010001 #b10010101100100011110000)))
;; x should be Float32(0x48CAC8F0 [Rational(830607, 2), 415303.500000])
...
(assert (= result (fp #b0 #b10010001 #b10010101100100011110000)))
(check-sat)
(exit)
