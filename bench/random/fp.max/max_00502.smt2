...
(assert (= y (fp #b0 #b10010101 #b01010101111011100000001)))
;; y should be Float32(0x4AAAF701 [Rational(11204353, 2), 5602176.500000])

(declare-const result Float32)
(assert (= result (fp.max x y)))
(assert (= result ((_ to_fp 8 24) #x4AAAF701)))
(check-sat)
(exit)
