...
(assert (= y (fp #b1 #b00000000 #b10010110011010010101110)))
;; y should be Float32(0x804B34AE [Rational(-2464343, 356811923176489970264571492362373784095686656), -0.000000])
