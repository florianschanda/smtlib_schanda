...
(assert (= x (fp #b0 #b10010011 #b10100101111000010100100)))
;; x should be Float32(0x49D2F0A4 [Rational(3456041, 2), 1728020.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x49D2F0A4))))
(check-sat)
(exit)
