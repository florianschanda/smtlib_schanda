...
(assert (= x ((_ to_fp 8 24) #x79DE6E35)))
;; x should be Float32(0x79DE6E35 [Rational(144365645842968334161287105069711360), 144365645842968334161287105069711360.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x79DE6E35))))
(check-sat)
(exit)
