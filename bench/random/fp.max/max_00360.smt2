...
(assert (= x ((_ to_fp 8 24) #xCA6B0EFA)))
;; x should be Float32(0xCA6B0EFA [Rational(-7702397, 2), -3851198.500000])
...
(assert (not (= result (fp #b1 #b10010100 #b11010110000111011111010))))
(check-sat)
(exit)
