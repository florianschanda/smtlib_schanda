...
(assert (= y ((_ to_fp 8 24) #x5800A982)))
;; y should be Float32(0x5800A982 [Rational(565862075465728), 565862075465728.000000])

(declare-const result Float32)
(assert (= result (fp.max x y)))
(assert (not (= result (fp #b0 #b10110000 #b00000001010100110000010))))
(check-sat)
(exit)
