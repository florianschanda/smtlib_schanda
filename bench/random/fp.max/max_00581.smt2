...
(assert (= x (fp #b1 #b00000000 #b01011101101010000010010)))
;; x should be Float32(0x802ED412 [Rational(-1534473, 356811923176489970264571492362373784095686656), -0.000000])
