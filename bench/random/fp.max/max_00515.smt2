...
(assert (= y ((_ to_fp 8 24) #x3B125F0B)))
;; y should be Float32(0x3B125F0B [Rational(9592587, 4294967296), 0.002233])

(declare-const result Float32)
(assert (= result (fp.max x y)))
(assert (= result (fp #b0 #b01110110 #b00100100101111100001011)))
(check-sat)
(exit)
