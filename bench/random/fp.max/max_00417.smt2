...
(assert (= y ((_ to_fp 8 24) #x33402DB7)))
;; y should be Float32(0x33402DB7 [Rational(12594615, 281474976710656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.max x y)))
(assert (= result (fp #b0 #b01100110 #b10000000010110110110111)))
(check-sat)
(exit)
