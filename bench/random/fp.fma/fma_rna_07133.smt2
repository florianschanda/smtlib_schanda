...
(assert (= z ((_ to_fp 8 24) #x16F2AFAF)))
;; z should be Float32(0x16F2AFAF [Rational(15904687, 40564819207303340847894502572032), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x16F2AFAF))))
(check-sat)
(exit)
