...
(assert (= x (fp #b0 #b00000000 #b11111010001111111011100)))
;; x should be Float32(0x007D1FDC [Rational(2050039, 178405961588244985132285746181186892047843328), 0.000000])
