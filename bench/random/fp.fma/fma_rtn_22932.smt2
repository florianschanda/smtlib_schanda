...
(assert (= z ((_ to_fp 8 24) #x804DB29B)))
;; z should be Float32(0x804DB29B [Rational(-5091995, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b00000000 #b10011011011001010011011)))
(check-sat)
(exit)
