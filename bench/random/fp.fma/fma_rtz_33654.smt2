...
(assert (= x (fp #b1 #b00000000 #b00011111110101111110111)))
;; x should be Float32(0x800FEBF7 [Rational(-1043447, 713623846352979940529142984724747568191373312), -0.000000])
