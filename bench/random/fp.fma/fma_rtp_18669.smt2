...
(assert (= z (fp #b1 #b10010101 #b10100110100000000011001)))
;; z should be Float32(0xCAD34019 [Rational(-13844505, 2), -6922252.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #xCAD34018)))
(check-sat)
(exit)
