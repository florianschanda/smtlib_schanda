...
(assert (= y (fp #b0 #b00000000 #b00100101100011001110111)))
;; y should be Float32(0x0012C677 [Rational(1230455, 713623846352979940529142984724747568191373312), 0.000000])
