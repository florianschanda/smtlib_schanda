...
(assert (= x (fp #b1 #b10010101 #b11111001101010001001101)))
;; x should be Float32(0xCAFCD44D [Rational(-16569421, 2), -8284710.500000])
...
(assert (= result (fp #b0 #b00010111 #b11111001101010001001010)))
(check-sat)
(exit)
