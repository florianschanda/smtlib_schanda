...
(assert (= z ((_ to_fp 8 24) #x7198EBB2)))
;; z should be Float32(0x7198EBB2 [Rational(1514453108534010851170262712320), 1514453108534010851170262712320.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x7198EBB3)))
(check-sat)
(exit)
