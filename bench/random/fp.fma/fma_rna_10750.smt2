...
(assert (= x (fp #b1 #b10010100 #b11110110110100011111110)))
;; x should be Float32(0xCA7B68FE [Rational(-8238207, 2), -4119103.500000])
...
(assert (= result (fp #b0 #b00010110 #b11110110110100011111010)))
(check-sat)
(exit)
