...
(assert (= y ((_ to_fp 8 24) #x4AC7C089)))
;; y should be Float32(0x4AC7C089 [Rational(13090953, 2), 6545476.500000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xCAFFDAB5)))
;; z should be Float32(0xCAFFDAB5 [Rational(-16767669, 2), -8383834.500000])
