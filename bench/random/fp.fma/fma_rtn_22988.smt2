...
(assert (= z (fp #b1 #b01101100 #b00001111101011001100111)))
;; z should be Float32(0xB607D667 [Rational(-8902247, 4398046511104), -0.000002])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b01101100 #b01001111101011001100111))))
(check-sat)
(exit)
