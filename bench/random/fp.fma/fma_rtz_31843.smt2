...
(assert (= z (fp #b1 #b00000000 #b10100111011110110100110)))
;; z should be Float32(0x8053BDA6 [Rational(-2744019, 356811923176489970264571492362373784095686656), -0.000000])
