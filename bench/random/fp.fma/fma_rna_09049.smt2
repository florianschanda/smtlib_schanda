...
(assert (= y (fp #b0 #b10010100 #b01010001101101000111010)))
;; y should be Float32(0x4A28DA3A [Rational(5532957, 2), 2766478.500000])
...
(assert (not (= result (fp #b0 #b00000001 #b01010100011011010001110))))
(check-sat)
(exit)
