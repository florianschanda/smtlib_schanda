...
(assert (= z (fp #b0 #b00010011 #b11110111010110010001011)))
;; z should be Float32(0x09FBAC8B [Rational(16493707, 2722258935367507707706996859454145691648), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x09FBAC8B)))
(check-sat)
(exit)
