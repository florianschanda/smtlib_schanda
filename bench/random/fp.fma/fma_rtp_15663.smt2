...
(assert (= y (fp #b0 #b10011001 #b11110000110100000011011)))
;; y should be Float32(0x4CF8681B [Rational(130236632), 130236632.000000])
...
(assert (= result ((_ to_fp 8 24) #x0DF8681C)))
(check-sat)
(exit)
