...
(assert (= x (fp #b0 #b00000000 #b11000001001101111001111)))
;; x should be Float32(0x00609BCF [Rational(6331343, 713623846352979940529142984724747568191373312), 0.000000])
