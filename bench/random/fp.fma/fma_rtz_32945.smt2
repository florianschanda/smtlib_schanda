...
(assert (= z (fp #b1 #b00000000 #b00111100111100111000000)))
;; z should be Float32(0x801E79C0 [Rational(-31207, 11150372599265311570767859136324180752990208), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x801E79C0)))
(check-sat)
(exit)
