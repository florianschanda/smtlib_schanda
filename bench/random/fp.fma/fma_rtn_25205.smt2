...
(assert (= z (fp #b1 #b10010101 #b11011111000010111100111)))
;; z should be Float32(0xCAEF85E7 [Rational(-15697383, 2), -7848691.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10010101 #b11011111000010111100111))))
(check-sat)
(exit)
