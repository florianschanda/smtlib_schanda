...
(assert (= y ((_ to_fp 8 24) #xC9E83F64)))
;; y should be Float32(0xC9E83F64 [Rational(-3805145, 2), -1902572.500000])
...
(assert (not (= result (fp #b0 #b00010101 #b11010000011111101011100))))
(check-sat)
(exit)
