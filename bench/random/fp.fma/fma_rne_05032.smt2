...
(assert (= y (fp #b1 #b00000000 #b01001001011001001101100)))
;; y should be Float32(0x8024B26C [Rational(-601243, 178405961588244985132285746181186892047843328), -0.000000])
