...
(assert (= y (fp #b0 #b01101011 #b01100001101100110111000)))
;; y should be Float32(0x35B0D9B8 [Rational(1448759, 1099511627776), 0.000001])
...
(assert (= result ((_ to_fp 8 24) #x807FFFF4)))
(check-sat)
(exit)
