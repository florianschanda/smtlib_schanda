...
(assert (= z (fp #b1 #b10010101 #b01110000011101110001101)))
;; z should be Float32(0xCAB83B8D [Rational(-12073869, 2), -6036934.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAB83B8D))))
(check-sat)
(exit)
