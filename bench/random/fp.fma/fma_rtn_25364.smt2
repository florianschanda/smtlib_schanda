...
(assert (= z (fp #b1 #b00000000 #b10010000110001000101010)))
;; z should be Float32(0x8048622A [Rational(-2371861, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b00000000 #b10010000110001000101011))))
(check-sat)
(exit)
