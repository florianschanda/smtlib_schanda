...
(assert (= z ((_ to_fp 8 24) #x9F974794)))
;; z should be Float32(0x9F974794 [Rational(-2478565, 38685626227668133590597632), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x9F974793)))
(check-sat)
(exit)
