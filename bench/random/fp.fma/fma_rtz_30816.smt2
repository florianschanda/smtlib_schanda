...
(assert (= z (fp #b1 #b01100101 #b01001101110011000101001)))
;; z should be Float32(0xB2A6E629 [Rational(-10937897, 562949953421312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b01100101 #b01001101110011000101001)))
(check-sat)
(exit)
