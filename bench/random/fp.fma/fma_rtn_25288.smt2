...
(assert (= z (fp #b1 #b00000000 #b10100110011001100010001)))
;; z should be Float32(0x80533311 [Rational(-5452561, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x80533311)))
(check-sat)
(exit)
