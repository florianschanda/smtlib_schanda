...
(assert (= x (fp #b0 #b00000000 #b10111000001001111011100)))
;; x should be Float32(0x005C13DC [Rational(1508599, 178405961588244985132285746181186892047843328), 0.000000])
