...
(assert (= y ((_ to_fp 8 24) #x0038215F)))
;; y should be Float32(0x0038215F [Rational(3678559, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b0 #b01111111 #b11000001000010101111011))))
(check-sat)
(exit)
