...
(assert (= x (fp #b1 #b00000000 #b00000010110001001010111)))
;; x should be Float32(0x80016257 [Rational(-90711, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xFFA9B6CB)))
