...
(assert (= z ((_ to_fp 8 24) #xEC4961A2)))
;; z should be Float32(0xEC4961A2 [Rational(-973820590655675042596126720), -973820590655675042596126720.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b11011000 #b10010010110000110100001))))
(check-sat)
(exit)
