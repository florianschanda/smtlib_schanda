...
(assert (= x (fp #b1 #b11101100 #b00011110010011000001110)))
;; x should be Float32(0xF60F260E [Rational(-725849894071967103570993437736960), -725849894071967103570993437736960.000000])
...
(assert (= result (fp #b1 #b01101110 #b00011110010011000001110)))
(check-sat)
(exit)
