...
(assert (= y (fp #b0 #b00000000 #b01100011101001111010101)))
;; y should be Float32(0x0031D3D5 [Rational(3265493, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b1 #b01111111 #b10001110100111101010011))))
(check-sat)
(exit)
