...
(assert (= y ((_ to_fp 8 24) #x4ACF5517)))
;; y should be Float32(0x4ACF5517 [Rational(13587735, 2), 6793867.500000])
...
(assert (= result (fp #b1 #b00000000 #b11001111010101010001100)))
(check-sat)
(exit)
