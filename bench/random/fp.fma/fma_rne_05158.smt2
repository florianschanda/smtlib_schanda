...
(assert (= z ((_ to_fp 8 24) #x0078B058)))
;; z should be Float32(0x0078B058 [Rational(988683, 89202980794122492566142873090593446023921664), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b00000000 #b11110001011000001011000))))
(check-sat)
(exit)
