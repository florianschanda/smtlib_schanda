...
(assert (= y (fp #b1 #b10010100 #b11001001001101110111010)))
;; y should be Float32(0xCA649BBA [Rational(-7491037, 2), -3745518.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b11001001001101110111100))))
(check-sat)
(exit)
