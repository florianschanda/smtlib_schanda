...
(assert (= z (fp #b0 #b00000000 #b10001100011010011011100)))
;; z should be Float32(0x004634DC [Rational(1150263, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b00000000 #b10001100011010011011100)))
(check-sat)
(exit)
