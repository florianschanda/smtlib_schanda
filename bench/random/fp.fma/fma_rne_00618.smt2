...
(assert (= x (fp #b0 #b10010010 #b10100111001101001111000)))
;; x should be Float32(0x49539A78 [Rational(1733455, 2), 866727.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8A539A76))))
(check-sat)
(exit)
