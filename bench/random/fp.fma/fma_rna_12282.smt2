...
(assert (= z ((_ to_fp 8 24) #x6371E348)))
;; z should be Float32(0x6371E348 [Rational(4462042661808934748160), 4462042661808934748160.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x6371E348)))
(check-sat)
(exit)
