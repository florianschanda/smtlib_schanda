...
(assert (= y ((_ to_fp 8 24) #xCA28F49E)))
;; y should be Float32(0xCA28F49E [Rational(-5536335, 2), -2768167.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b10101011100001011011001))))
(check-sat)
(exit)
