...
(assert (= z ((_ to_fp 8 24) #xC911D6D8)))
;; z should be Float32(0xC911D6D8 [Rational(-1194715, 2), -597357.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010010 #b00100011101011011011000))))
(check-sat)
(exit)
