...
(assert (= z (fp #b1 #b01011110 #b10101111101110110000011)))
;; z should be Float32(0xAF57DD83 [Rational(-14146947, 72057594037927936), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b01011110 #b10101111101110110000011)))
(check-sat)
(exit)
