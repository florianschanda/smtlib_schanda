...
(assert (= y (fp #b1 #b11001110 #b10000011010111000101011)))
;; y should be Float32(0xE741AE2B [Rational(-914629563139210619125760), -914629563139210619125760.000000])
...
(assert (= result (fp #b0 #b01010000 #b10000011010111000101100)))
(check-sat)
(exit)
