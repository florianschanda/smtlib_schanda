...
(assert (= z (fp #b1 #b00000000 #b01110110010010011101101)))
;; z should be Float32(0x803B24ED [Rational(-3876077, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b00000000 #b01110110010010011101100))))
(check-sat)
(exit)
