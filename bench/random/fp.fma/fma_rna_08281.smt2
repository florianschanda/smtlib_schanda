...
(assert (= y ((_ to_fp 8 24) #x802AC734)))
;; y should be Float32(0x802AC734 [Rational(-700877, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBFAB1CCF))))
(check-sat)
(exit)
