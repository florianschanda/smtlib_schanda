...
(assert (= z (fp #b1 #b11011000 #b01101011011000001100011)))
;; z should be Float32(0xEC35B063 [Rational(-878594144315584941700153344), -878594144315584941700153344.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b11011000 #b01101011011000001100011)))
(check-sat)
(exit)
