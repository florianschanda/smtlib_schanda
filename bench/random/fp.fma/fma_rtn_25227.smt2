...
(assert (= y (fp #b1 #b00010100 #b11001101001000011100000)))
;; y should be Float32(0x8A6690E0 [Rational(-472199, 42535295865117307932921825928971026432), -0.000000])
...
(assert (= result (fp #b0 #b10010100 #b11001101001000011011111)))
(check-sat)
(exit)
