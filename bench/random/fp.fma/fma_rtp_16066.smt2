...
(assert (= z (fp #b1 #b10010100 #b00001110011110011101110)))
;; z should be Float32(0xCA073CEE [Rational(-4431479, 2), -2215739.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA073CEE))))
(check-sat)
(exit)
