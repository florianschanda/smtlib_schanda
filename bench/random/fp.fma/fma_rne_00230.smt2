...
(assert (= z ((_ to_fp 8 24) #x4A834175)))
;; z should be Float32(0x4A834175 [Rational(8601973, 2), 4300986.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010101 #b00000110100000101110101))))
(check-sat)
(exit)
