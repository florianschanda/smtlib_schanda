...
(assert (= x (fp #b1 #b00000000 #b11110100000000010010010)))
;; x should be Float32(0x807A0092 [Rational(-3997769, 356811923176489970264571492362373784095686656), -0.000000])
