...
(assert (= x (fp #b1 #b00000000 #b01100001111100100001010)))
;; x should be Float32(0x8030F90A [Rational(-1604741, 356811923176489970264571492362373784095686656), -0.000000])
