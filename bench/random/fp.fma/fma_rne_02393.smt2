...
(assert (= z (fp #b1 #b00000000 #b00111100011011001101100)))
;; z should be Float32(0x801E366C [Rational(-495003, 178405961588244985132285746181186892047843328), -0.000000])
