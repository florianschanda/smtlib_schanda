...
(assert (= z (fp #b1 #b10010100 #b00111100101000011110010)))
;; z should be Float32(0xCA1E50F2 [Rational(-5187705, 2), -2593852.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010100 #b00111100101000011110010))))
(check-sat)
(exit)
