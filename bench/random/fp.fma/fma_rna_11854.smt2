...
(assert (= z ((_ to_fp 8 24) #xF932CDDC)))
;; z should be Float32(0xF932CDDC [Rational(-58025260311481315529350507048992768), -58025260311481315529350507048992768.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b11110010 #b01100101100110111011100))))
(check-sat)
(exit)
