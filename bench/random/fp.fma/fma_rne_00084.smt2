...
(assert (= z (fp #b0 #b01101111 #b01100100000010011110001)))
;; z should be Float32(0x37B204F1 [Rational(11666673, 549755813888), 0.000021])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x37B204F1))))
(check-sat)
(exit)
