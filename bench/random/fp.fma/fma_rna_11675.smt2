...
(assert (= z ((_ to_fp 8 24) #x001B9225)))
;; z should be Float32(0x001B9225 [Rational(1806885, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x001B9225)))
(check-sat)
(exit)
