...
(assert (= y ((_ to_fp 8 24) #xCAA1BB93)))
;; y should be Float32(0xCAA1BB93 [Rational(-10599315, 2), -5299657.500000])
...
(assert (= result (fp #b0 #b00000000 #b10100001101110111001001)))
(check-sat)
(exit)
