...
(assert (= x (fp #b1 #b00000000 #b00010100011000001001010)))
;; x should be Float32(0x800A304A [Rational(-333861, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3EA3049F))))
(check-sat)
(exit)
