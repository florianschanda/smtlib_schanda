...
(assert (= z ((_ to_fp 8 24) #x2A9908FC)))
;; z should be Float32(0x2A9908FC [Rational(2507327, 9223372036854775808), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b01010101 #b00110010000100011111100))))
(check-sat)
(exit)
