...
(assert (= x ((_ to_fp 8 24) #x0025882C)))
;; x should be Float32(0x0025882C [Rational(614923, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (not (= result (fp #b0 #b01111111 #b00101100010000010101111))))
(check-sat)
(exit)
