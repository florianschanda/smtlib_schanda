...
(assert (= x ((_ to_fp 8 24) #xFFA303EA)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b1 #b00000000 #b10000110000011111101101)))
;; y should be Float32(0x804307ED [Rational(-4392941, 713623846352979940529142984724747568191373312), -0.000000])
