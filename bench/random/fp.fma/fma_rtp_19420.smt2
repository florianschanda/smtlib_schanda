...
(assert (= z (fp #b0 #b10010100 #b00110000101100011001010)))
;; z should be Float32(0x4A1858CA [Rational(4992101, 2), 2496050.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010100 #b00110000101100011001011))))
(check-sat)
(exit)
