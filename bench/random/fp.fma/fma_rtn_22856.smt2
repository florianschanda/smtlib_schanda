...
(assert (= z (fp #b1 #b00000000 #b00010100100000100000111)))
;; z should be Float32(0x800A4107 [Rational(-672007, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x800A4107))))
(check-sat)
(exit)
