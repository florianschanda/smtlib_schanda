...
(assert (= z (fp #b1 #b00110001 #b01100001101000111111010)))
;; z should be Float32(0x98B0D1FA [Rational(-5794045, 1267650600228229401496703205376), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x98B0D1FA)))
(check-sat)
(exit)
