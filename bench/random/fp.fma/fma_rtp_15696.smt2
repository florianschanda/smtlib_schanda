...
(assert (= z (fp #b0 #b10010011 #b10011111100100010111100)))
;; z should be Float32(0x49CFC8BC [Rational(3404335, 2), 1702167.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10010011 #b10011111100100010111100)))
(check-sat)
(exit)
