...
(assert (= y (fp #b1 #b00000000 #b11000011011001011010100)))
;; y should be Float32(0x8061B2D4 [Rational(-1600693, 178405961588244985132285746181186892047843328), -0.000000])
