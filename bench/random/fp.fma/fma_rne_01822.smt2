...
(assert (= z (fp #b1 #b01100000 #b10111000111010010101111)))
;; z should be Float32(0xB05C74AF [Rational(-14447791, 18014398509481984), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b01100000 #b10111000111010010101111)))
(check-sat)
(exit)
