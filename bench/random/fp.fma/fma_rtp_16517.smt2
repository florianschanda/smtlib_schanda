...
(assert (= x ((_ to_fp 8 24) #x42934A1E)))
;; x should be Float32(0x42934A1E [Rational(4826383, 65536), 73.644760])
...
(assert (not (= result (fp #b1 #b00000111 #b00100010100101000011110))))
(check-sat)
(exit)
