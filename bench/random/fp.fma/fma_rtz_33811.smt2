...
(assert (= x (fp #b1 #b00000000 #b11001010011100101110000)))
;; x should be Float32(0x80653970 [Rational(-414615, 44601490397061246283071436545296723011960832), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x404A72DF)))
(check-sat)
(exit)
