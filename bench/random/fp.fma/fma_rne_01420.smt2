...
(assert (= y (fp #b1 #b00000000 #b10111001111100000100011)))
;; y should be Float32(0x805CF823 [Rational(-6092835, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC039F045)))
(check-sat)
(exit)
