...
(assert (= z ((_ to_fp 8 24) #xCABA9F1D)))
;; z should be Float32(0xCABA9F1D [Rational(-12230429, 2), -6115214.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10010101 #b01110101001111100011110))))
(check-sat)
(exit)
