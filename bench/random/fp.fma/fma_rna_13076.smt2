...
(assert (= x (fp #b1 #b00000000 #b10100110001110011101010)))
;; x should be Float32(0x80531CEA [Rational(-2723445, 356811923176489970264571492362373784095686656), -0.000000])
