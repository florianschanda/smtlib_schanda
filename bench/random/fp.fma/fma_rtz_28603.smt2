...
(assert (= z (fp #b0 #b11100110 #b00010001100100110110011)))
;; z should be Float32(0x7308C9B3 [Rational(10837452986635751290157930643456), 10837452986635751290157930643456.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b11100110 #b00010001100100110110011))))
(check-sat)
(exit)
