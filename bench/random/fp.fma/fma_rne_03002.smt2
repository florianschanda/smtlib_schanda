...
(assert (= x (fp #b0 #b00000000 #b11001100100001111011000)))
;; x should be Float32(0x006643D8 [Rational(837755, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (= z ((_ to_fp 8 24) #xFFC799AA)))
