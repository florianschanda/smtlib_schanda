...
(assert (= x ((_ to_fp 8 24) #x4A81BDEB)))
;; x should be Float32(0x4A81BDEB [Rational(8502763, 2), 4251381.500000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xE1E40668)))
;; y should be Float32(0xE1E40668 [Rational(-525789908470947905536), -525789908470947905536.000000])
