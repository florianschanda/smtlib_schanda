...
(assert (= z ((_ to_fp 8 24) #x5AAEB873)))
;; z should be Float32(0x5AAEB873 [Rational(24589725004201984), 24589725004201984.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10110101 #b01011101011100001110011))))
(check-sat)
(exit)
