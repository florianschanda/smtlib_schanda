...
(assert (= x (fp #b0 #b10010101 #b00101100101101010001111)))
;; x should be Float32(0x4A965A8F [Rational(9853583, 2), 4926791.500000])
...
(assert (= result (fp #b0 #b00000001 #b10010110010110101000111)))
(check-sat)
(exit)
