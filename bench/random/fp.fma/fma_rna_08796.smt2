...
(assert (= z (fp #b1 #b00000000 #b00010010111101010101000)))
;; z should be Float32(0x80097AA8 [Rational(-77653, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x80097AA8)))
(check-sat)
(exit)
