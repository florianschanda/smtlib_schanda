...
(assert (= x (fp #b0 #b00000000 #b11001001011111000010101)))
;; x should be Float32(0x0064BE15 [Rational(6602261, 713623846352979940529142984724747568191373312), 0.000000])
