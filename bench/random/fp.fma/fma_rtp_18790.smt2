...
(assert (= z (fp #b1 #b00000000 #b11101000100001100110000)))
;; z should be Float32(0x80744330 [Rational(-476211, 44601490397061246283071436545296723011960832), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x80744330))))
(check-sat)
(exit)
