...
(assert (= y ((_ to_fp 8 24) #x1334C2E4)))
;; y should be Float32(0x1334C2E4 [Rational(2961593, 1298074214633706907132624082305024), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x5334C2E3)))
(check-sat)
(exit)
