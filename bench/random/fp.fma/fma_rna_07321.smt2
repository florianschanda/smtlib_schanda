...
(assert (= x (fp #b0 #b10010100 #b01011010110011010111010)))
;; x should be Float32(0x4A2D66BA [Rational(5682013, 2), 2841006.500000])
...
(assert (= result (fp #b0 #b00010110 #b01011010110011010111110)))
(check-sat)
(exit)
