...
(assert (= z ((_ to_fp 8 24) #x00300A5C)))
;; z should be Float32(0x00300A5C [Rational(787095, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b00000000 #b01100000000101001011011))))
(check-sat)
(exit)
