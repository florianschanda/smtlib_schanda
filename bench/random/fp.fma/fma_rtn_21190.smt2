...
(assert (= x ((_ to_fp 8 24) #x4AE082E5)))
;; x should be Float32(0x4AE082E5 [Rational(14713573, 2), 7356786.500000])
...
(assert (= result (fp #b1 #b00010111 #b11000001000001011100010)))
(check-sat)
(exit)
