...
(assert (= x ((_ to_fp 8 24) #xF41CB307)))
;; x should be Float32(0xF41CB307 [Rational(-49659998525855978937195260018688), -49659998525855978937195260018688.000000])
...
(assert (= z (fp #b1 #b11111111 #b11000010000011101100111)))
