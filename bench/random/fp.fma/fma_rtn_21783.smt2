...
(assert (= z (fp #b0 #b00000000 #b11000101001001011000110)))
;; z should be Float32(0x006292C6 [Rational(3230051, 356811923176489970264571492362373784095686656), 0.000000])
