...
(assert (= y (fp #b0 #b10010001 #b01010000001111111110000)))
;; y should be Float32(0x48A81FF0 [Rational(688639, 2), 344319.500000])
...
(assert (not (= result (fp #b0 #b00010011 #b01010000001111111010000))))
(check-sat)
(exit)
