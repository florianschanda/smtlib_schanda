...
(assert (= z (fp #b1 #b00000010 #b11001011011101100100100)))
;; z should be Float32(0x8165BB24 [Rational(-3763913, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #xB5000000)))
(check-sat)
(exit)
