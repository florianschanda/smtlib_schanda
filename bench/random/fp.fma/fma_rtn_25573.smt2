...
(assert (= z ((_ to_fp 8 24) #x80341CBA)))
;; z should be Float32(0x80341CBA [Rational(-1707613, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b00000000 #b01101000001110010111010)))
(check-sat)
(exit)
