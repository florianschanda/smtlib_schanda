...
(assert (= y (fp #b0 #b11111111 #b01011011010000010100111)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b10010101 #b11111000010111011010101)))
;; z should be Float32(0xCAFC2ED5 [Rational(-16527061, 2), -8263530.500000])
