...
(assert (= z ((_ to_fp 8 24) #x806DD628)))
;; z should be Float32(0x806DD628 [Rational(-899781, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x806DD628)))
(check-sat)
(exit)
