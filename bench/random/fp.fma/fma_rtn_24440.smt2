...
(assert (= x (fp #b1 #b10010010 #b01111111001111011111000)))
;; x should be Float32(0xC93F9EF8 [Rational(-1569759, 2), -784879.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0A3F9F06))))
(check-sat)
(exit)
