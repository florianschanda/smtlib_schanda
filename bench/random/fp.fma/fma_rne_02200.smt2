...
(assert (= y (fp #b0 #b10010101 #b10011011001000110010001)))
;; y should be Float32(0x4ACD9191 [Rational(13472145, 2), 6736072.500000])
...
(assert (= result (fp #b1 #b00000000 #b00110010011011100111000)))
(check-sat)
(exit)
