...
(assert (= z (fp #b0 #b10010101 #b01100111101101000010101)))
;; z should be Float32(0x4AB3DA15 [Rational(11786773, 2), 5893386.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4AB3DA15))))
(check-sat)
(exit)
