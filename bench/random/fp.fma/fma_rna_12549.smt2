...
(assert (= z (fp #b0 #b00000000 #b01000011111111011111111)))
;; z should be Float32(0x0021FEFF [Rational(2227967, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b00000000 #b01000011111111011111111)))
(check-sat)
(exit)
