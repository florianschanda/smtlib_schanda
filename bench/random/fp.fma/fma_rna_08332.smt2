...
(assert (= y ((_ to_fp 8 24) #x4ADC8B8B)))
;; y should be Float32(0x4ADC8B8B [Rational(14453643, 2), 7226821.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b10111001000101110001001))))
(check-sat)
(exit)
