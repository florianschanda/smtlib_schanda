...
(assert (= y ((_ to_fp 8 24) #x0043D6A8)))
;; y should be Float32(0x0043D6A8 [Rational(555733, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b00001111010110101001111))))
(check-sat)
(exit)
