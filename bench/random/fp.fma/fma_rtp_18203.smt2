...
(assert (= y ((_ to_fp 8 24) #x0073F825)))
;; y should be Float32(0x0073F825 [Rational(7600165, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b11001111111000001001001))))
(check-sat)
(exit)
