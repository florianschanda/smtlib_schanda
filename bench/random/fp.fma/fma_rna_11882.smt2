...
(assert (= y (fp #b1 #b00000000 #b01001000101110000010010)))
;; y should be Float32(0x80245C12 [Rational(-1191433, 356811923176489970264571492362373784095686656), -0.000000])
