...
(assert (= z (fp #b1 #b00000000 #b00000101100100011001000)))
;; z should be Float32(0x8002C8C8 [Rational(-22809, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b00000000 #b00000101100100011001000)))
(check-sat)
(exit)
