...
(assert (= y ((_ to_fp 8 24) #x8003960B)))
;; y should be Float32(0x8003960B [Rational(-235019, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b1 #b01111011 #b11001011000001011000000)))
(check-sat)
(exit)
