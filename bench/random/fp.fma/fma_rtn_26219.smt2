...
(assert (= z (fp #b1 #b00000000 #b00100010001110101111101)))
;; z should be Float32(0x80111D7D [Rational(-1121661, 713623846352979940529142984724747568191373312), -0.000000])
