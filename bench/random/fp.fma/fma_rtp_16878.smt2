...
(assert (= x (fp #b0 #b00000000 #b00110100101011011101110)))
;; x should be Float32(0x001A56EE [Rational(863095, 356811923176489970264571492362373784095686656), 0.000000])
