...
(assert (= y (fp #b1 #b00000111 #b10111001100011011000101)))
;; y should be Float32(0x83DCC6C5 [Rational(-14468805, 11150372599265311570767859136324180752990208), -0.000000])
...
(assert (= result (fp #b1 #b10000111 #b10111001100011011000101)))
(check-sat)
(exit)
