...
(assert (= x ((_ to_fp 8 24) #x16D572C5)))
;; x should be Float32(0x16D572C5 [Rational(13988549, 40564819207303340847894502572032), 0.000000])
...
(assert (= result (fp #b0 #b10101101 #b10101010111001011000101)))
(check-sat)
(exit)
