...
(assert (= y ((_ to_fp 8 24) #x0073861F)))
;; y should be Float32(0x0073861F [Rational(7570975, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b11001110000110000111101))))
(check-sat)
(exit)
