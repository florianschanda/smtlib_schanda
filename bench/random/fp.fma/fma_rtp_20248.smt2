...
(assert (= x (fp #b0 #b11111111 #b10011011100000110111000)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b10010101 #b11000011010110011011101)))
;; y should be Float32(0x4AE1ACDD [Rational(14789853, 2), 7394926.500000])
