...
(assert (= z (fp #b0 #b00000000 #b01100111001101000111000)))
;; z should be Float32(0x00339A38 [Rational(422727, 89202980794122492566142873090593446023921664), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b00000000 #b01100111001101000111001))))
(check-sat)
(exit)
