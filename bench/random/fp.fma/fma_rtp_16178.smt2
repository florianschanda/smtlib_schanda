...
(assert (= z ((_ to_fp 8 24) #x006C0BA3)))
;; z should be Float32(0x006C0BA3 [Rational(7080867, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x006C0BA3))))
(check-sat)
(exit)
