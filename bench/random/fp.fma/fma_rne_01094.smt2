...
(assert (= z (fp #b1 #b10010101 #b01011010000101111101101)))
;; z should be Float32(0xCAAD0BED [Rational(-11340781, 2), -5670390.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010101 #b01011010000101111101101))))
(check-sat)
(exit)
