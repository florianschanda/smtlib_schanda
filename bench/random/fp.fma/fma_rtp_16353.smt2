...
(assert (= x (fp #b0 #b11110001 #b11001000110110010101010)))
;; x should be Float32(0x78E46CAA [Rational(37063989149086328270254074021019648), 37063989149086328270254074021019648.000000])
