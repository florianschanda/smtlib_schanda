...
(assert (= x (fp #b0 #b11001101 #b00110001100110101100010)))
;; x should be Float32(0x6698CD62 [Rational(360794174787756123750400), 360794174787756123750400.000000])
...
(assert (= result (fp #b0 #b01001111 #b00110001100110101100011)))
(check-sat)
(exit)
