...
(assert (= z ((_ to_fp 8 24) #xAA17B882)))
;; z should be Float32(0xAA17B882 [Rational(-4971585, 36893488147419103232), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b01010100 #b00101111011100010000010))))
(check-sat)
(exit)
