...
(assert (= y ((_ to_fp 8 24) #xFA29F14A)))
;; y should be Float32(0xFA29F14A [Rational(-220598023172722994338701772362612736), -220598023172722994338701772362612736.000000])
...
(assert (not (= result (fp #b0 #b01110110 #b01010011111000101001000))))
(check-sat)
(exit)
