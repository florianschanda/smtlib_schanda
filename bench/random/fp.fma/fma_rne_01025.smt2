...
(assert (= z (fp #b1 #b00000000 #b10000001110111100100010)))
;; z should be Float32(0x8040EF22 [Rational(-2127761, 356811923176489970264571492362373784095686656), -0.000000])
