...
(assert (= y (fp #b1 #b11111111 #b11100000011100000110010)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b01101110 #b01011011111100111100111)))
;; z should be Float32(0xB72DF9E7 [Rational(-11401703, 1099511627776), -0.000010])
