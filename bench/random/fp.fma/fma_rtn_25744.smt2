...
(assert (= z (fp #b1 #b00000000 #b10110010011000100011111)))
;; z should be Float32(0x8059311F [Rational(-5845279, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b00000000 #b10110010011000100100000)))
(check-sat)
(exit)
