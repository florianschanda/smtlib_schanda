...
(assert (= y (fp #b1 #b00110100 #b01010000101111010110101)))
;; y should be Float32(0x9A285EB5 [Rational(-11034293, 316912650057057350374175801344), -0.000000])
...
(assert (not (= result (fp #b0 #b10110100 #b01010000101111010110100))))
(check-sat)
(exit)
