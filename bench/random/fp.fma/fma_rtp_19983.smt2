...
(assert (= x (fp #b1 #b00000000 #b10100000011110001010101)))
;; x should be Float32(0x80503C55 [Rational(-5258325, 713623846352979940529142984724747568191373312), -0.000000])
