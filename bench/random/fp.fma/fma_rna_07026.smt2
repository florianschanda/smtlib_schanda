...
(assert (= y (fp #b0 #b00000000 #b11111110100010100001100)))
;; y should be Float32(0x007F450C [Rational(2085187, 178405961588244985132285746181186892047843328), 0.000000])
