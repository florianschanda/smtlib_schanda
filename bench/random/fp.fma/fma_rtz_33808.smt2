...
(assert (= x (fp #b1 #b00000000 #b11110100000110001100000)))
;; x should be Float32(0x807A0C60 [Rational(-249955, 22300745198530623141535718272648361505980416), -0.000000])
...
(assert (= result (fp #b0 #b10000000 #b11101000001100010111111)))
(check-sat)
(exit)
