...
(assert (= z ((_ to_fp 8 24) #x004488E9)))
;; z should be Float32(0x004488E9 [Rational(4491497, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x004488E9)))
(check-sat)
(exit)
