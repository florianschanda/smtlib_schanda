...
(assert (= y ((_ to_fp 8 24) #x5997916B)))
;; y should be Float32(0x5997916B [Rational(5332826278854656), 5332826278854656.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x0F17916A))))
(check-sat)
(exit)
