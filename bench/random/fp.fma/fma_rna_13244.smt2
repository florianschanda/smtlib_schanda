...
(assert (= x (fp #b1 #b00000000 #b01001101010101000010110)))
;; x should be Float32(0x8026AA16 [Rational(-1266955, 356811923176489970264571492362373784095686656), -0.000000])
