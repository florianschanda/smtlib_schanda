...
(assert (= z ((_ to_fp 8 24) #x007ECA52)))
;; z should be Float32(0x007ECA52 [Rational(4154665, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10000000 #b11111111111111111111111))))
(check-sat)
(exit)
