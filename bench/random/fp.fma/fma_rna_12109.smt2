...
(assert (= y (fp #b1 #b10010101 #b10111101111000001110001)))
;; y should be Float32(0xCADEF071 [Rational(-14610545, 2), -7305272.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b10111101111000001110011))))
(check-sat)
(exit)
