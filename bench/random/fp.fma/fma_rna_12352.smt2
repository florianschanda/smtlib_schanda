...
(assert (= z ((_ to_fp 8 24) #x49A96D04)))
;; z should be Float32(0x49A96D04 [Rational(2775873, 2), 1387936.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010011 #b01010010110110100000100))))
(check-sat)
(exit)
