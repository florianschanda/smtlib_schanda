...
(assert (= x (fp #b1 #b00000000 #b01000101111010011001011)))
;; x should be Float32(0x8022F4CB [Rational(-2290891, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBF8BD32B))))
(check-sat)
(exit)
