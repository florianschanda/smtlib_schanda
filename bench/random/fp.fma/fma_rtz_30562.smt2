...
(assert (= x ((_ to_fp 8 24) #x002CC7D9)))
;; x should be Float32(0x002CC7D9 [Rational(2934745, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b1 #b01111111 #b01100110001111101100011))))
(check-sat)
(exit)
