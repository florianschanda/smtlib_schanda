...
(assert (= z (fp #b0 #b00000000 #b10111011011001001001110)))
;; z should be Float32(0x005DB24E [Rational(3070247, 356811923176489970264571492362373784095686656), 0.000000])
