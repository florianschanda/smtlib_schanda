...
(assert (= z ((_ to_fp 8 24) #x09D22F4B)))
;; z should be Float32(0x09D22F4B [Rational(13774667, 2722258935367507707706996859454145691648), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b00010011 #b10100100010111101001011))))
(check-sat)
(exit)
