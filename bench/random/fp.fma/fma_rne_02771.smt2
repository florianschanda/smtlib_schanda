...
(assert (= x ((_ to_fp 8 24) #x01746210)))
;; x should be Float32(0x01746210 [Rational(1000993, 22300745198530623141535718272648361505980416), 0.000000])
...
(assert (= result (fp #b1 #b10000010 #b11101000110001000001111)))
(check-sat)
(exit)
