...
(assert (= z ((_ to_fp 8 24) #xCAA65B41)))
;; z should be Float32(0xCAA65B41 [Rational(-10902337, 2), -5451168.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010101 #b01001100101101100111001)))
(check-sat)
(exit)
