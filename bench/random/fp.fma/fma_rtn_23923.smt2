...
(assert (= z (fp #b0 #b10010101 #b10100010110100100010001)))
;; z should be Float32(0x4AD16911 [Rational(13723921, 2), 6861960.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x4AD16911)))
(check-sat)
(exit)
