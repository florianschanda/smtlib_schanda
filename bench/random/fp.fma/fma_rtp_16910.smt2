...
(assert (= x ((_ to_fp 8 24) #x00661C3E)))
;; x should be Float32(0x00661C3E [Rational(3345951, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= z (fp #b0 #b11111111 #b11100010011100101001010)))
