...
(assert (= x ((_ to_fp 8 24) #xFFC4B769)))
...
(assert (= z (fp #b1 #b00100100 #b01010000001101010000101)))
;; z should be Float32(0x92281A85 [Rational(-11016837, 20769187434139310514121985316880384), -0.000000])
