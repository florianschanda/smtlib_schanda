...
(assert (= x ((_ to_fp 8 24) #x80014979)))
;; x should be Float32(0x80014979 [Rational(-84345, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b10101101011111000111111)))
