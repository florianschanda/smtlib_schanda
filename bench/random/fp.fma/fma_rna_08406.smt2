...
(assert (= z (fp #b0 #b00100111 #b00110000110000010011000)))
;; z should be Float32(0x13986098 [Rational(1248275, 324518553658426726783156020576256), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x13986098))))
(check-sat)
(exit)
