...
(assert (= x (fp #b1 #b11111111 #b00100001011011010110011)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xD986F9C9)))
;; y should be Float32(0xD986F9C9 [Rational(-4749036070371328), -4749036070371328.000000])
