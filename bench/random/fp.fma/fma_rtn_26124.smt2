...
(assert (= z ((_ to_fp 8 24) #x80785710)))
;; z should be Float32(0x80785710 [Rational(-492913, 44601490397061246283071436545296723011960832), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x80785711))))
(check-sat)
(exit)
