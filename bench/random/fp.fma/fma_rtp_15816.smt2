...
(assert (= z ((_ to_fp 8 24) #x63FC26C0)))
;; z should be Float32(0x63FC26C0 [Rational(9302743476687553429504), 9302743476687553429504.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x63FC26C0))))
(check-sat)
(exit)
