...
(assert (= y (fp #b0 #b00110000 #b00110001010110110001110)))
;; y should be Float32(0x1818AD8E [Rational(5002951, 2535301200456458802993406410752), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xD818AD8D))))
(check-sat)
(exit)
