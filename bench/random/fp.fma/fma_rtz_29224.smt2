...
(assert (= y (fp #b0 #b11111111 #b10000111100100111100000)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b0 #b10010100 #b11100100100100110001010)))
;; z should be Float32(0x4A72498A [Rational(7939269, 2), 3969634.500000])
