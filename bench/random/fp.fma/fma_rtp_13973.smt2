...
(assert (= z (fp #b0 #b01100000 #b01100010011111100111001)))
;; z should be Float32(0x30313F39 [Rational(11616057, 18014398509481984), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x30313F39))))
(check-sat)
(exit)
