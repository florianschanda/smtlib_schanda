...
(assert (= x ((_ to_fp 8 24) #x2D505D0A)))
;; x should be Float32(0x2D505D0A [Rational(6827653, 576460752303423488), 0.000000])
...
(assert (= result (fp #b0 #b11011010 #b10100000101110100001010)))
(check-sat)
(exit)
