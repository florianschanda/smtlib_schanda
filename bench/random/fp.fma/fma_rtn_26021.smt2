...
(assert (= y ((_ to_fp 8 24) #x499B946C)))
;; y should be Float32(0x499B946C [Rational(2549019, 2), 1274509.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b00100110111001010001110))))
(check-sat)
(exit)
