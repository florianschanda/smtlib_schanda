...
(assert (= x (fp #b1 #b10010101 #b01101111101011100000111)))
;; x should be Float32(0xCAB7D707 [Rational(-12048135, 2), -6024067.500000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b00100111111001010111101)))
