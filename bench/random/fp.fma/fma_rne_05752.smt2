...
(assert (= y (fp #b1 #b00000000 #b01110011100100101011010)))
;; y should be Float32(0x8039C95A [Rational(-1893549, 356811923176489970264571492362373784095686656), -0.000000])
