...
(assert (= z ((_ to_fp 8 24) #x005D99CE)))
;; z should be Float32(0x005D99CE [Rational(3067111, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b00000000 #b10111011001100111001110))))
(check-sat)
(exit)
