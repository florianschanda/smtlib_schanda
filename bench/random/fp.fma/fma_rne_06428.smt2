...
(assert (= x (fp #b1 #b00000000 #b10101110001111100001111)))
;; x should be Float32(0x80571F0F [Rational(-5709583, 713623846352979940529142984724747568191373312), -0.000000])
