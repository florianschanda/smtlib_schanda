...
(assert (= y ((_ to_fp 8 24) #x717FDDA9)))
;; y should be Float32(0x717FDDA9 [Rational(1266986371048214888679525580800), 1266986371048214888679525580800.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x327FDDA9))))
(check-sat)
(exit)
