...
(assert (= x (fp #b1 #b01101000 #b10010111111001010101000)))
;; x should be Float32(0xB44BF2A8 [Rational(-1670741, 8796093022208), -0.000000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b01101100001100001110110)))
