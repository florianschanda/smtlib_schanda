...
(assert (= z (fp #b0 #b10010101 #b10101101011011110011011)))
;; z should be Float32(0x4AD6B79B [Rational(14071707, 2), 7035853.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b10101101011011110100010)))
(check-sat)
(exit)
