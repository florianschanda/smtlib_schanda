...
(assert (= x (fp #b0 #b00000000 #b11101100111011011101100)))
;; x should be Float32(0x007676EC [Rational(1940923, 178405961588244985132285746181186892047843328), 0.000000])
