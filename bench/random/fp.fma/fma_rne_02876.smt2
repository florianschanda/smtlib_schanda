...
(assert (= x ((_ to_fp 8 24) #x71DD24AE)))
;; x should be Float32(0x71DD24AE [Rational(2190096966137324997015463002112), 2190096966137324997015463002112.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7F9BA095)))
