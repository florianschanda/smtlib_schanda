...
(assert (= z ((_ to_fp 8 24) #x80052E9E)))
;; z should be Float32(0x80052E9E [Rational(-169807, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x80052E9D)))
(check-sat)
(exit)
