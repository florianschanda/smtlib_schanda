...
(assert (= x (fp #b1 #b10000010 #b10000100001011111101101)))
;; x should be Float32(0xC14217ED [Rational(-12720109, 1048576), -12.130841])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b11000111110111110001110)))
