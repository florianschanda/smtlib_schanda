...
(assert (= x (fp #b1 #b00000000 #b11001111100001101100101)))
;; x should be Float32(0x8067C365 [Rational(-6800229, 713623846352979940529142984724747568191373312), -0.000000])
