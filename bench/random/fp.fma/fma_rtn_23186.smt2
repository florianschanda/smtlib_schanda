...
(assert (= x ((_ to_fp 8 24) #x6D598A95)))
;; x should be Float32(0x6D598A95 [Rational(4207861407934040394782736384), 4207861407934040394782736384.000000])
...
(assert (= result (fp #b0 #b01011100 #b10110011000101010010011)))
(check-sat)
(exit)
