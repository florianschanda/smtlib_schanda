...
(assert (= z ((_ to_fp 8 24) #x519A92C9)))
;; z should be Float32(0x519A92C9 [Rational(82985951232), 82985951232.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10100011 #b00110101001001011001000)))
(check-sat)
(exit)
