...
(assert (= x (fp #b0 #b11111111 #b00100000111111110001011)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b1 #b10000101 #b11100110101000001111110)))
;; y should be Float32(0xC2F3507E [Rational(-7972927, 65536), -121.657211])
