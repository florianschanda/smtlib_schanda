...
(assert (= z (fp #b1 #b10001110 #b00010001101100000101000)))
;; z should be Float32(0xC708D828 [Rational(-1121029, 32), -35032.156250])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b10001110 #b00010001101010000101000)))
(check-sat)
(exit)
