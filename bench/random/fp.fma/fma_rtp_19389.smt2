...
(assert (= z ((_ to_fp 8 24) #x003F0EB1)))
;; z should be Float32(0x003F0EB1 [Rational(4132529, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x003F0EB2))))
(check-sat)
(exit)
