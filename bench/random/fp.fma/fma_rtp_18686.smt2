...
(assert (= z ((_ to_fp 8 24) #x006A1584)))
;; z should be Float32(0x006A1584 [Rational(1738081, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x006A1585))))
(check-sat)
(exit)
