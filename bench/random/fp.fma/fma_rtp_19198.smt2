...
(assert (= z (fp #b0 #b10110000 #b01110010001110111000011)))
;; z should be Float32(0x58391DC3 [Rational(814149906989056), 814149906989056.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x58391DC3))))
(check-sat)
(exit)
