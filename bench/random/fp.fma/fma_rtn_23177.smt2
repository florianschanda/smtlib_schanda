...
(assert (= x (fp #b0 #b00110001 #b00100010001000100000111)))
;; x should be Float32(0x18911107 [Rational(9507079, 2535301200456458802993406410752), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x58911106)))
(check-sat)
(exit)
