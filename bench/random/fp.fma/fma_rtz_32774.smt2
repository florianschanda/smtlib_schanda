...
(assert (= z ((_ to_fp 8 24) #x800B8EBA)))
;; z should be Float32(0x800B8EBA [Rational(-378717, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00010111000111010111001))))
(check-sat)
(exit)
