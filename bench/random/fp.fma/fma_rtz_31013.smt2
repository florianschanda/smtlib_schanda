...
(assert (= y (fp #b1 #b00000000 #b00100101000100011101100)))
;; y should be Float32(0x801288EC [Rational(-303675, 178405961588244985132285746181186892047843328), -0.000000])
