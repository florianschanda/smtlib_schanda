...
(assert (= z (fp #b1 #b11001011 #b11000101001100110000011)))
;; z should be Float32(0xE5E29983 [Rational(-133760827064579543531520), -133760827064579543531520.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b11001011 #b11000101001100110000011))))
(check-sat)
(exit)
