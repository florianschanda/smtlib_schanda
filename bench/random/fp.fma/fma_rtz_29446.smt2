...
(assert (= y ((_ to_fp 8 24) #xCA17A69E)))
;; y should be Float32(0xCA17A69E [Rational(-4969295, 2), -2484647.500000])
...
(assert (not (= result (fp #b1 #b00010110 #b00101111010011010100010))))
(check-sat)
(exit)
