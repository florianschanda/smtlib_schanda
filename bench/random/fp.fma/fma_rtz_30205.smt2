...
(assert (= x ((_ to_fp 8 24) #x7CFDE78F)))
;; x should be Float32(0x7CFDE78F [Rational(10546781371639955725491386104997216256), 10546781371639955725491386104997216256.000000])
