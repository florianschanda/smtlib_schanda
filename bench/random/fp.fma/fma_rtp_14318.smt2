...
(assert (= x (fp #b0 #b10010101 #b00000000110110110010111)))
;; x should be Float32(0x4A806D97 [Rational(8416663, 2), 4208331.500000])
...
(assert (= z ((_ to_fp 8 24) #xCAD3322B)))
;; z should be Float32(0xCAD3322B [Rational(-13840939, 2), -6920469.500000])
