...
(assert (= x ((_ to_fp 8 24) #xCAC59579)))
;; x should be Float32(0xCAC59579 [Rational(-12948857, 2), -6474428.500000])
...
(assert (= result (fp #b1 #b00010111 #b10001011001010101110101)))
(check-sat)
(exit)
