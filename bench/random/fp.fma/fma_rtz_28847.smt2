...
(assert (= y (fp #b1 #b00000000 #b11110001001100010001000)))
;; y should be Float32(0x80789888 [Rational(-987921, 89202980794122492566142873090593446023921664), -0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b11100010011000100001111))))
(check-sat)
(exit)
