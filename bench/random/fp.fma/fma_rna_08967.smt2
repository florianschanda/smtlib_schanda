...
(assert (= z (fp #b1 #b00000000 #b11101010001101000010110)))
;; z should be Float32(0x80751A16 [Rational(-3837195, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b00000000 #b11101010001101000010110))))
(check-sat)
(exit)
