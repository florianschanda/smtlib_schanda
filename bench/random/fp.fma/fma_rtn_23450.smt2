...
(assert (= x ((_ to_fp 8 24) #x770ECB37)))
;; x should be Float32(0x770ECB37 [Rational(2896202502384473034710778967490560), 2896202502384473034710778967490560.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xFFD82345)))
