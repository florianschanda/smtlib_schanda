...
(assert (= z ((_ to_fp 8 24) #x0068FCFF)))
;; z should be Float32(0x0068FCFF [Rational(6880511, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b00000000 #b11010001111110011111111)))
(check-sat)
(exit)
