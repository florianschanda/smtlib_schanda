...
(assert (= x (fp #b0 #b10010101 #b11011010000101110101011)))
;; x should be Float32(0x4AED0BAB [Rational(15535019, 2), 7767509.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BED0BA9))))
(check-sat)
(exit)
