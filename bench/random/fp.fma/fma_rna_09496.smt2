...
(assert (= x (fp #b0 #b11100110 #b01110101100111110110111)))
;; x should be Float32(0x733ACFB7 [Rational(14800722858111174698764175671296), 14800722858111174698764175671296.000000])
...
(assert (not (= result (fp #b0 #b01101000 #b01110101100111110110111))))
(check-sat)
(exit)
