...
(assert (= x (fp #b0 #b00000000 #b01101111101000111110101)))
;; x should be Float32(0x0037D1F5 [Rational(3658229, 713623846352979940529142984724747568191373312), 0.000000])
