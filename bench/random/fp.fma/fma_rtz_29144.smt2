...
(assert (= z (fp #b1 #b01110011 #b00010001001010011010110)))
;; z should be Float32(0xB98894D6 [Rational(-4475499, 17179869184), -0.000261])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b01110011 #b00010001001010011010110)))
(check-sat)
(exit)
