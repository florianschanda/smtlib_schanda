...
(assert (= x (fp #b1 #b00000000 #b01100001001111001001100)))
;; x should be Float32(0x80309E4C [Rational(-796563, 178405961588244985132285746181186892047843328), -0.000000])
