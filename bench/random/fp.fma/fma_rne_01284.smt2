...
(assert (= y ((_ to_fp 8 24) #xCA718082)))
;; y should be Float32(0xCA718082 [Rational(-7913537, 2), -3956768.500000])

(declare-const z Float32)
(assert (= z (fp #b1 #b10010101 #b00011000110011001011001)))
;; z should be Float32(0xCA8C6659 [Rational(-9201241, 2), -4600620.500000])
