...
(assert (= y ((_ to_fp 8 24) #xDBF73CAD)))
;; y should be Float32(0xDBF73CAD [Rational(-139182065949081600), -139182065949081600.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xCAA923F1)))
;; z should be Float32(0xCAA923F1 [Rational(-11084785, 2), -5542392.500000])
