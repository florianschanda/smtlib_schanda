...
(assert (= y (fp #b1 #b10010100 #b00100010000000110111110)))
;; y should be Float32(0xCA1101BE [Rational(-4751583, 2), -2375791.500000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b10001001101111001011011)))
