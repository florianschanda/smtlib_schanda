...
(assert (= x (fp #b0 #b11101101 #b00110001001101001010110)))
;; x should be Float32(0x76989A56 [Rational(1547577006246547624052649147498496), 1547577006246547624052649147498496.000000])
...
(assert (= result (fp #b1 #b01011000 #b00110001001101001010110)))
(check-sat)
(exit)
