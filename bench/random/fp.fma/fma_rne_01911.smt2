...
(assert (= z (fp #b1 #b10010101 #b11010100011110101101111)))
;; z should be Float32(0xCAEA3D6F [Rational(-15351151, 2), -7675575.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAEA3D6F))))
(check-sat)
(exit)
