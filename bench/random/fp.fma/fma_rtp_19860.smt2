...
(assert (= x (fp #b1 #b00000000 #b11000101011100111010110)))
;; x should be Float32(0x8062B9D6 [Rational(-3235051, 356811923176489970264571492362373784095686656), -0.000000])
