...
(assert (= x (fp #b0 #b10010100 #b10010011010111010111010)))
;; x should be Float32(0x4A49AEBA [Rational(6608733, 2), 3304366.500000])
...
(assert (= result (fp #b1 #b00010110 #b10010011010111010111000)))
(check-sat)
(exit)
