...
(assert (= z ((_ to_fp 8 24) #xCA55FDB7)))
;; z should be Float32(0xCA55FDB7 [Rational(-14024119, 4), -3506029.750000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010100 #b10101011111110110110111))))
(check-sat)
(exit)
