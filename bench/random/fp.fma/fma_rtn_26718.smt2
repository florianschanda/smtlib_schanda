...
(assert (= x (fp #b1 #b00000000 #b11001100001011110000010)))
;; x should be Float32(0x80661782 [Rational(-3345345, 356811923176489970264571492362373784095686656), -0.000000])
