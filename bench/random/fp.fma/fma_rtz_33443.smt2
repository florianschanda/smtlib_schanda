...
(assert (= x (fp #b1 #b11011010 #b11101010110001101000101)))
;; x should be Float32(0xED756345 [Rational(-4746489806603669258211688448), -4746489806603669258211688448.000000])
