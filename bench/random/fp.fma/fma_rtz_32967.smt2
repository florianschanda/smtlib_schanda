...
(assert (= z (fp #b0 #b10010100 #b11100011010010110100110)))
;; z should be Float32(0x4A71A5A6 [Rational(7918291, 2), 3959145.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010100 #b11100011010010110100101))))
(check-sat)
(exit)
