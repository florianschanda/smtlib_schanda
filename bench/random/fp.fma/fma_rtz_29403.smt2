...
(assert (= y (fp #b0 #b00000000 #b01100001001110001110001)))
;; y should be Float32(0x00309C71 [Rational(3185777, 713623846352979940529142984724747568191373312), 0.000000])
