...
(assert (= x (fp #b1 #b11111111 #b00101100011110110010111)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xD6463643)))
;; y should be Float32(0xD6463643 [Rational(-54484088651776), -54484088651776.000000])
