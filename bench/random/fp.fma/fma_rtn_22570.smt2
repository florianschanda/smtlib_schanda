...
(assert (= z (fp #b1 #b01111010 #b10101111000010011001010)))
;; z should be Float32(0xBD5784CA [Rational(-7062117, 134217728), -0.052617])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b01111010 #b10101111000010011001010)))
(check-sat)
(exit)
