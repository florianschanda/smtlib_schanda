...
(assert (= z (fp #b1 #b10010001 #b11100110100110110110000)))
;; z should be Float32(0xC8F34DB0 [Rational(-996571, 2), -498285.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10010001 #b11100110100110110110001)))
(check-sat)
(exit)
