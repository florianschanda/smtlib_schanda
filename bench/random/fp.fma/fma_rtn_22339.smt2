...
(assert (= y (fp #b1 #b01110001 #b11011101110011011011000)))
;; y should be Float32(0xB8EEE6D8 [Rational(-1957083, 17179869184), -0.000114])
...
(assert (= result (fp #b1 #b00000001 #b00000000000001110111011)))
(check-sat)
(exit)
