...
(assert (= x ((_ to_fp 8 24) #x7FE9113B)))
...
(assert (= z (fp #b1 #b00010110 #b01010000101100101010110)))
;; z should be Float32(0x8B285956 [Rational(-5516459, 170141183460469231731687303715884105728), -0.000000])
