...
(assert (= x (fp #b1 #b00000000 #b00100000110110110001111)))
;; x should be Float32(0x80106D8F [Rational(-1076623, 713623846352979940529142984724747568191373312), -0.000000])
