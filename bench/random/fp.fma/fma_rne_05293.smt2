...
(assert (= z ((_ to_fp 8 24) #xC9C6EFE4)))
;; z should be Float32(0xC9C6EFE4 [Rational(-3259385, 2), -1629692.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010011 #b10001101110111111000100))))
(check-sat)
(exit)
