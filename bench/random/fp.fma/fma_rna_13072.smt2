...
(assert (= x (fp #b1 #b00000000 #b00100100000010010111010)))
;; x should be Float32(0x801204BA [Rational(-590429, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7F99A000)))
