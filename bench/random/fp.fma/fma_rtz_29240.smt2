...
(assert (= y (fp #b1 #b11111111 #b10000001000100011010001)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x80480A3F)))
;; z should be Float32(0x80480A3F [Rational(-4721215, 713623846352979940529142984724747568191373312), -0.000000])
