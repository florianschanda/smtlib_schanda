...
(assert (= y ((_ to_fp 8 24) #xFF834B6E)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x8052D77B)))
;; z should be Float32(0x8052D77B [Rational(-5429115, 713623846352979940529142984724747568191373312), -0.000000])
