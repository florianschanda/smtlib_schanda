...
(assert (= z ((_ to_fp 8 24) #x4ACA3EFF)))
;; z should be Float32(0x4ACA3EFF [Rational(13254399, 2), 6627199.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010101 #b10010100011111011111111))))
(check-sat)
(exit)
