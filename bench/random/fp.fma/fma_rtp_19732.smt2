...
(assert (= x ((_ to_fp 8 24) #xA60160CF)))
;; x should be Float32(0xA60160CF [Rational(-8478927, 18889465931478580854784), -0.000000])
...
(assert (not (= result (fp #b0 #b11001100 #b00000010110000011001111))))
(check-sat)
(exit)
