...
(assert (= z ((_ to_fp 8 24) #x0029841B)))
;; z should be Float32(0x0029841B [Rational(2720795, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x0029841B))))
(check-sat)
(exit)
