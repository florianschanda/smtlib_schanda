...
(assert (= x (fp #b1 #b00000000 #b10001010001010101111010)))
;; x should be Float32(0x8045157A [Rational(-2263741, 356811923176489970264571492362373784095686656), -0.000000])
