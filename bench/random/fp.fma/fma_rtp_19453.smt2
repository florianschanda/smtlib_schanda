...
(assert (= y ((_ to_fp 8 24) #xC8F848AF)))
;; y should be Float32(0xC8F848AF [Rational(-16271535, 32), -508485.468750])
...
(assert (not (= result (fp #b0 #b00000000 #b00001111100001001000101))))
(check-sat)
(exit)
