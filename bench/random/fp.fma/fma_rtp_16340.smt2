...
(assert (= x (fp #b0 #b01011111 #b00011111000110100101100)))
;; x should be Float32(0x2F8F8D2C [Rational(2351947, 9007199254740992), 0.000000])
...
(assert (= z (fp #b0 #b11111111 #b01101001000101111011010)))
