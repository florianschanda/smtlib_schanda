...
(assert (= z ((_ to_fp 8 24) #x4AC072CD)))
;; z should be Float32(0x4AC072CD [Rational(12612301, 2), 6306150.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010101 #b10000000111001011010101))))
(check-sat)
(exit)
