...
(assert (= y ((_ to_fp 8 24) #x80268F6A)))
;; y should be Float32(0x80268F6A [Rational(-1263541, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result (fp #b0 #b01111111 #b00110100011110110100111)))
(check-sat)
(exit)
