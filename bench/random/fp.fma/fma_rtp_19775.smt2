...
(assert (= x (fp #b1 #b10110101 #b11111111011011101010000)))
;; x should be Float32(0xDAFFB750 [Rational(-35988836643241984), -35988836643241984.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x1BFFB750))))
(check-sat)
(exit)
