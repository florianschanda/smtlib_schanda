...
(assert (= z (fp #b1 #b00000000 #b10011011001111000000110)))
;; z should be Float32(0x804D9E06 [Rational(-2543363, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x804D9E06))))
(check-sat)
(exit)
