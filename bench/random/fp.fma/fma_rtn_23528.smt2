...
(assert (= x (fp #b0 #b00000000 #b11000111000110000110011)))
;; x should be Float32(0x00638C33 [Rational(6523955, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x40471865)))
(check-sat)
(exit)
