...
(assert (= z (fp #b1 #b10010101 #b11101011011000001110111)))
;; z should be Float32(0xCAF5B077 [Rational(-16101495, 2), -8050747.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAF5B077))))
(check-sat)
(exit)
