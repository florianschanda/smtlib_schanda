...
(assert (= x (fp #b1 #b10001101 #b10000101000111001001011)))
;; x should be Float32(0xC6C28E4B [Rational(-12750411, 512), -24903.146484])
...
(assert (= result ((_ to_fp 8 24) #x07C28E49)))
(check-sat)
(exit)
