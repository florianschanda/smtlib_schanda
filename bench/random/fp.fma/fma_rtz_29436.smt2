...
(assert (= y (fp #b1 #b10010101 #b10100100000100111111011)))
;; y should be Float32(0xCAD209FB [Rational(-13765115, 2), -6882557.500000])
...
(assert (= result ((_ to_fp 8 24) #x8BD209F9)))
(check-sat)
(exit)
