...
(assert (= z (fp #b1 #b10010100 #b10101111000111111101010)))
;; z should be Float32(0xCA578FEA [Rational(-7063541, 2), -3531770.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010100 #b10101111000111111011010)))
(check-sat)
(exit)
