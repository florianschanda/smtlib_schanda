...
(assert (= x (fp #b0 #b11111010 #b00000110111000110101111)))
;; x should be Float32(0x7D0371AF [Rational(10919946650907440869671678859431378944), 10919946650907440869671678859431378944.000000])
