...
(assert (= z (fp #b1 #b00000000 #b01001101010101000100000)))
;; z should be Float32(0x8026AA20 [Rational(-79185, 22300745198530623141535718272648361505980416), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b00000000 #b01001101010101000100000)))
(check-sat)
(exit)
