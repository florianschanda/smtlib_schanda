...
(assert (= y (fp #b0 #b10010101 #b11010011000110111111101)))
;; y should be Float32(0x4AE98DFD [Rational(15306237, 2), 7653118.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b11010011000110111111101))))
(check-sat)
(exit)
