...
(assert (= y ((_ to_fp 8 24) #xEA5F20BB)))
;; y should be Float32(0xEA5F20BB [Rational(-67436255760663979573116928), -67436255760663979573116928.000000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b01011001010010111010110)))
