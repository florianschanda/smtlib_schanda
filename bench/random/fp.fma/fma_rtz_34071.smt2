...
(assert (= x ((_ to_fp 8 24) #xFF8C4263)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b10101111 #b10011101000110000111110)))
;; y should be Float32(0x57CE8C3E [Rational(454203461861376), 454203461861376.000000])
