...
(assert (= x (fp #b0 #b00001010 #b10011011101000011011101)))
;; x should be Float32(0x054DD0DD [Rational(13488349, 1393796574908163946345982392040522594123776), 0.000000])
