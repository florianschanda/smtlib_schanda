...
(assert (= x ((_ to_fp 8 24) #x743DC276)))
;; x should be Float32(0x743DC276 [Rational(60137221841392061099020117868544), 60137221841392061099020117868544.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b10011010111111011100001)))
