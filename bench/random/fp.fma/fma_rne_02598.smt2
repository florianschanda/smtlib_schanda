...
(assert (= x (fp #b0 #b01001101 #b01101101011011111111101)))
;; x should be Float32(0x26B6B7FD [Rational(11974653, 9444732965739290427392), 0.000000])
...
(assert (= result (fp #b0 #b11001101 #b01101101011011111111100)))
(check-sat)
(exit)
