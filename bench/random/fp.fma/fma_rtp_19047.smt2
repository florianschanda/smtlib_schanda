...
(assert (= z (fp #b0 #b00000000 #b01110000000100010001111)))
;; z should be Float32(0x0038088F [Rational(3672207, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x00380890)))
(check-sat)
(exit)
