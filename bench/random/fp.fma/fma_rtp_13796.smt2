...
(assert (= z ((_ to_fp 8 24) #x4AFD9E09)))
;; z should be Float32(0x4AFD9E09 [Rational(16621065, 2), 8310532.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11111011001111000001001))))
(check-sat)
(exit)
