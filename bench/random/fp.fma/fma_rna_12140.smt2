...
(assert (= z (fp #b1 #b00000000 #b00100101111001010110110)))
;; z should be Float32(0x8012F2B6 [Rational(-620891, 356811923176489970264571492362373784095686656), -0.000000])
