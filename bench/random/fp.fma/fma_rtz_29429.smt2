...
(assert (= z ((_ to_fp 8 24) #xBB95A687)))
;; z should be Float32(0xBB95A687 [Rational(-9807495, 2147483648), -0.004567])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b01110111 #b00101011010011010000111))))
(check-sat)
(exit)
