...
(assert (= z (fp #b1 #b10010101 #b10110010001111111110111)))
;; z should be Float32(0xCAD91FF7 [Rational(-14229495, 2), -7114747.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #xCAD91FF7)))
(check-sat)
(exit)
