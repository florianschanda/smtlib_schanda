...
(assert (= y ((_ to_fp 8 24) #x01619B92)))
;; y should be Float32(0x01619B92 [Rational(7392713, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (not (= result (fp #b0 #b10000010 #b11000011001101110010001))))
(check-sat)
(exit)
