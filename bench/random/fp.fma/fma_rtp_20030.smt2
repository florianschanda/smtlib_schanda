...
(assert (= x (fp #b1 #b00000000 #b10000101110010001011010)))
;; x should be Float32(0x8042E45A [Rational(-2191917, 356811923176489970264571492362373784095686656), -0.000000])
