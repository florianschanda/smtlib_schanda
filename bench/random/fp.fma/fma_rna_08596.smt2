...
(assert (= z ((_ to_fp 8 24) #x6FCC5797)))
;; z should be Float32(0x6FCC5797 [Rational(126481663254399560148964081664), 126481663254399560148964081664.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x6FCC5797))))
(check-sat)
(exit)
