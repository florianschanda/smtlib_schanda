...
(assert (= x (fp #b0 #b00000000 #b00010101100010100100101)))
;; x should be Float32(0x000AC525 [Rational(705829, 713623846352979940529142984724747568191373312), 0.000000])
