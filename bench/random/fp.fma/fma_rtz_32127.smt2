...
(assert (= y (fp #b0 #b11111111 #b10001011110110001010000)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b01011000 #b01001111101110100001111)))
;; z should be Float32(0xAC27DD0F [Rational(-11001103, 4611686018427387904), -0.000000])
