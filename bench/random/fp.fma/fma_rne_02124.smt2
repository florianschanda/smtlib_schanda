...
(assert (= y ((_ to_fp 8 24) #xF812809D)))
;; y should be Float32(0xF812809D [Rational(-11885686384326046673136248416108544), -11885686384326046673136248416108544.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xB912809D))))
(check-sat)
(exit)
