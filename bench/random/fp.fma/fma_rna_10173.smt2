...
(assert (= z ((_ to_fp 8 24) #x235A5CAD)))
;; z should be Float32(0x235A5CAD [Rational(14310573, 1208925819614629174706176), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x235A5CAD))))
(check-sat)
(exit)
