...
(assert (= x (fp #b0 #b10010100 #b01000000001011011100110)))
;; x should be Float32(0x4A2016E6 [Rational(5245811, 2), 2622905.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b01010000000010110111010))))
(check-sat)
(exit)
