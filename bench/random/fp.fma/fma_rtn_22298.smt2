...
(assert (= z ((_ to_fp 8 24) #xC9274E58)))
;; z should be Float32(0xC9274E58 [Rational(-1370571, 2), -685285.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10010010 #b01001110100111001011001))))
(check-sat)
(exit)
