...
(assert (= y (fp #b1 #b11111111 #b00110000000100011010011)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b0 #b00000000 #b11110100110100100010111)))
;; z should be Float32(0x007A6917 [Rational(8022295, 713623846352979940529142984724747568191373312), 0.000000])
