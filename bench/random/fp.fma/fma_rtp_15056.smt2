...
(assert (= z ((_ to_fp 8 24) #x428FA3F2)))
;; z should be Float32(0x428FA3F2 [Rational(4706809, 65536), 71.820206])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10000101 #b00001111010001111110011))))
(check-sat)
(exit)
