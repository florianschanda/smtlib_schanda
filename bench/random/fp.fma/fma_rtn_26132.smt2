...
(assert (= y (fp #b0 #b10100010 #b01110000011110000011000)))
;; y should be Float32(0x51383C18 [Rational(49455136768), 49455136768.000000])
...
(assert (= result ((_ to_fp 8 24) #x86B83C18)))
(check-sat)
(exit)
