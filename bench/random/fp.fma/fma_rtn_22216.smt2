...
(assert (= y (fp #b1 #b10010101 #b10011000110000100011001)))
;; y should be Float32(0xCACC6119 [Rational(-13394201, 2), -6697100.500000])
...
(assert (= result (fp #b1 #b00010111 #b10011000110000100010110)))
(check-sat)
(exit)
