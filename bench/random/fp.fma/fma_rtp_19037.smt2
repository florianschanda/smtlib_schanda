...
(assert (= z (fp #b1 #b00000000 #b00101000100010111001011)))
;; z should be Float32(0x801445CB [Rational(-1328587, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00101000100010111001010))))
(check-sat)
(exit)
