...
(assert (= y (fp #b1 #b00000000 #b10100101001001011010110)))
;; y should be Float32(0x805292D6 [Rational(-2705771, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x402525AB)))
(check-sat)
(exit)
