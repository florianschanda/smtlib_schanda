...
(assert (= x (fp #b0 #b00000000 #b01110110001001111001110)))
;; x should be Float32(0x003B13CE [Rational(1935847, 356811923176489970264571492362373784095686656), 0.000000])
