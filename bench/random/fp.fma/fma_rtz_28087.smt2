...
(assert (= x (fp #b0 #b10010101 #b01011110100011010001011)))
;; x should be Float32(0x4AAF468B [Rational(11486859, 2), 5743429.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b01010000101110010111001))))
(check-sat)
(exit)
