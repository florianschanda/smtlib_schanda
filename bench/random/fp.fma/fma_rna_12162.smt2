...
(assert (= z ((_ to_fp 8 24) #x4A7F93B2)))
;; z should be Float32(0x4A7F93B2 [Rational(8374745, 2), 4187372.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010100 #b11111111001001110110010))))
(check-sat)
(exit)
