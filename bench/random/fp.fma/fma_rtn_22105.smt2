...
(assert (= z ((_ to_fp 8 24) #x1BD1D041)))
;; z should be Float32(0x1BD1D041 [Rational(13750337, 39614081257132168796771975168), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x1BD1D041)))
(check-sat)
(exit)
