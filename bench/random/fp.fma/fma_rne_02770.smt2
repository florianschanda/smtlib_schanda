...
(assert (= x ((_ to_fp 8 24) #x7B9A0297)))
;; x should be Float32(0x7B9A0297 [Rational(1599332488972220824099041908677935104), 1599332488972220824099041908677935104.000000])
