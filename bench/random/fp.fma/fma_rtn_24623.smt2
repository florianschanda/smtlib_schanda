...
(assert (= z (fp #b1 #b00000000 #b00111101010011110001110)))
;; z should be Float32(0x801EA78E [Rational(-1004487, 356811923176489970264571492362373784095686656), -0.000000])
