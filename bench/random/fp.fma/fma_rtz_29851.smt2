...
(assert (= z ((_ to_fp 8 24) #x4A8A3241)))
;; z should be Float32(0x4A8A3241 [Rational(9056833, 2), 4528416.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010101 #b00010100011001001000000))))
(check-sat)
(exit)
