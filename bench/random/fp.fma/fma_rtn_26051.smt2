...
(assert (= z (fp #b0 #b10010101 #b11110010101110111001111)))
;; z should be Float32(0x4AF95DCF [Rational(16342479, 2), 8171239.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b11110010101110111001110)))
(check-sat)
(exit)
