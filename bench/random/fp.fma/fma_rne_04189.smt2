...
(assert (= z (fp #b0 #b00000000 #b00100011100110110000110)))
;; z should be Float32(0x0011CD86 [Rational(583363, 356811923176489970264571492362373784095686656), 0.000000])
