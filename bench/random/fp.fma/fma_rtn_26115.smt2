...
(assert (= z (fp #b0 #b00000000 #b01010110011101110011101)))
;; z should be Float32(0x002B3B9D [Rational(2833309, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b00000000 #b01010110011101110011100)))
(check-sat)
(exit)
