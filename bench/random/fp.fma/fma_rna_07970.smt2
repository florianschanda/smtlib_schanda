...
(assert (= y ((_ to_fp 8 24) #x4ABB7319)))
;; y should be Float32(0x4ABB7319 [Rational(12284697, 2), 6142348.500000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x005F3F69)))
;; z should be Float32(0x005F3F69 [Rational(6242153, 713623846352979940529142984724747568191373312), 0.000000])
