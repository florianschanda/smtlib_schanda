...
(assert (= x ((_ to_fp 8 24) #xCAC38543)))
;; x should be Float32(0xCAC38543 [Rational(-12813635, 2), -6406817.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b10000111000010100111111))))
(check-sat)
(exit)
