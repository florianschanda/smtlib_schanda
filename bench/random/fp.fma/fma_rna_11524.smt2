...
(assert (= y ((_ to_fp 8 24) #x802B692A)))
;; y should be Float32(0x802B692A [Rational(-1422485, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (not (= result (fp #b0 #b01111111 #b01011011010010010100111))))
(check-sat)
(exit)
