...
(assert (= x (fp #b0 #b00000000 #b00110001001000010110111)))
;; x should be Float32(0x001890B7 [Rational(1609911, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3F4485B7))))
(check-sat)
(exit)
