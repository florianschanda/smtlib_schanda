...
(assert (= y (fp #b0 #b01011101 #b01100001011110011001000)))
;; y should be Float32(0x2EB0BCC8 [Rational(1447833, 18014398509481984), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xEEB0BCC7))))
(check-sat)
(exit)
