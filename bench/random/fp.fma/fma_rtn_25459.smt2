...
(assert (= z ((_ to_fp 8 24) #x8042D924)))
;; z should be Float32(0x8042D924 [Rational(-1095241, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b00000000 #b10000101101100100100100)))
(check-sat)
(exit)
