...
(assert (= y (fp #b1 #b10010100 #b01000110000110000011110)))
;; y should be Float32(0xCA230C1E [Rational(-5342735, 2), -2671367.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x00A8C306))))
(check-sat)
(exit)
