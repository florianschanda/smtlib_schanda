...
(assert (= x (fp #b1 #b10010101 #b11111110100101100101111)))
;; x should be Float32(0xCAFF4B2F [Rational(-16730927, 2), -8365463.500000])
...
(assert (= result ((_ to_fp 8 24) #x0BFF4B2D)))
(check-sat)
(exit)
