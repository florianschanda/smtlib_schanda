...
(assert (= x (fp #b0 #b00000000 #b10110110111101010100111)))
;; x should be Float32(0x005B7AA7 [Rational(5995175, 713623846352979940529142984724747568191373312), 0.000000])
