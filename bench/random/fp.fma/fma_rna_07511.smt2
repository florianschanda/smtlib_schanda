...
(assert (= x (fp #b0 #b10010101 #b00000000101010010001011)))
;; x should be Float32(0x4A80548B [Rational(8410251, 2), 4205125.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x003FD5BB))))
(check-sat)
(exit)
