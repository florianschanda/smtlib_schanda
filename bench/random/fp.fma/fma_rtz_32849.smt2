...
(assert (= y ((_ to_fp 8 24) #xFFF1646E)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x86DAAE60)))
;; z should be Float32(0x86DAAE60 [Rational(-447859, 5444517870735015415413993718908291383296), -0.000000])
