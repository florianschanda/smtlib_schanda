...
(assert (= x ((_ to_fp 8 24) #x00033EA2)))
;; x should be Float32(0x00033EA2 [Rational(106321, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result (fp #b0 #b01111011 #b10011111010100001111111))))
(check-sat)
(exit)
