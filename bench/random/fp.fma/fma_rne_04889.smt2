...
(assert (= y ((_ to_fp 8 24) #xC97C3258)))
;; y should be Float32(0xC97C3258 [Rational(-2065995, 2), -1032997.500000])
...
(assert (not (= result (fp #b0 #b00010100 #b11111000011001001100110))))
(check-sat)
(exit)
