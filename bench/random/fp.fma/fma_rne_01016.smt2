...
(assert (= z (fp #b0 #b00000000 #b10001101011111000011100)))
;; z should be Float32(0x0046BE1C [Rational(1159047, 178405961588244985132285746181186892047843328), 0.000000])
