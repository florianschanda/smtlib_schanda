...
(assert (= z ((_ to_fp 8 24) #xE5034F4A)))
;; z should be Float32(0xE5034F4A [Rational(-38755789643731586514944), -38755789643731586514944.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b11001010 #b00000110100111101001011)))
(check-sat)
(exit)
