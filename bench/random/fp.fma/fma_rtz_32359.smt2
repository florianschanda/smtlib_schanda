...
(assert (= z (fp #b0 #b10010101 #b00111011011001111110001)))
;; z should be Float32(0x4A9DB3F1 [Rational(10335217, 2), 5167608.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x4A9DB3F8)))
(check-sat)
(exit)
