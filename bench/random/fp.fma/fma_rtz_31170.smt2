...
(assert (= x ((_ to_fp 8 24) #xCA9D3331)))
;; x should be Float32(0xCA9D3331 [Rational(-10302257, 2), -5151128.500000])
...
(assert (= result (fp #b1 #b00000000 #b10011101001100110011000)))
(check-sat)
(exit)
