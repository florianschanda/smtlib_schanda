...
(assert (= y (fp #b0 #b00000000 #b10101011111011001001010)))
;; y should be Float32(0x0055F64A [Rational(2816805, 356811923176489970264571492362373784095686656), 0.000000])
