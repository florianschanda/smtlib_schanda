...
(assert (= y (fp #b0 #b10010011 #b11010010011001011001100)))
;; y should be Float32(0x49E932CC [Rational(3820723, 2), 1910361.500000])
...
(assert (= result (fp #b0 #b00010101 #b11010010011001011000011)))
(check-sat)
(exit)
