...
(assert (= x (fp #b0 #b00000000 #b01101111101110100101110)))
;; x should be Float32(0x0037DD2E [Rational(1830551, 356811923176489970264571492362373784095686656), 0.000000])
