...
(assert (= x ((_ to_fp 8 24) #x1714E378)))
;; x should be Float32(0x1714E378 [Rational(1219695, 2535301200456458802993406410752), 0.000000])
...
(assert (= z (fp #b0 #b11111111 #b10000000110010010100010)))
