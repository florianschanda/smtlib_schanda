...
(assert (= x ((_ to_fp 8 24) #x7FF315CF)))
...
(assert (= z (fp #b1 #b00000000 #b10110100110001000001111)))
;; z should be Float32(0x805A620F [Rational(-5923343, 713623846352979940529142984724747568191373312), -0.000000])
