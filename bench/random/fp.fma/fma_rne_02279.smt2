...
(assert (= z (fp #b1 #b00000000 #b11110101000010111110010)))
;; z should be Float32(0x807A85F2 [Rational(-4014841, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b00000000 #b11110101000010111110010)))
(check-sat)
(exit)
