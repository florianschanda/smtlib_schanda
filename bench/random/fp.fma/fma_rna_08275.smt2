...
(assert (= y (fp #b1 #b00000000 #b11000100010000010100110)))
;; y should be Float32(0x806220A6 [Rational(-3215443, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC044414B)))
(check-sat)
(exit)
