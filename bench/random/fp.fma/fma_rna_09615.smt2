...
(assert (= x (fp #b0 #b11110100 #b11010000000001101001101)))
;; x should be Float32(0x7A68034D [Rational(301169954744351140796085423254274048), 301169954744351140796085423254274048.000000])
