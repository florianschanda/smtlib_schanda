...
(assert (= z (fp #b1 #b00011001 #b01010000100111011011011)))
;; z should be Float32(0x8CA84EDB [Rational(-11030235, 42535295865117307932921825928971026432), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x8CA84EDB))))
(check-sat)
(exit)
