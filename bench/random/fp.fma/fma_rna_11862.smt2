...
(assert (= y ((_ to_fp 8 24) #xC1669C0E)))
;; y should be Float32(0xC1669C0E [Rational(-7556615, 524288), -14.413099])
...
(assert (not (= result (fp #b0 #b00000100 #b11101101001110000001100))))
(check-sat)
(exit)
