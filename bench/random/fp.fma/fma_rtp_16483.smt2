...
(assert (= x ((_ to_fp 8 24) #x01C9920D)))
;; x should be Float32(0x01C9920D [Rational(13210125, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC1C9920C))))
(check-sat)
(exit)
