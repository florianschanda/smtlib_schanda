...
(assert (= z (fp #b0 #b00010111 #b01111001001100110110110)))
;; z should be Float32(0x0BBC99B6 [Rational(6180059, 85070591730234615865843651857942052864), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b00010111 #b01111001001100110110110)))
(check-sat)
(exit)
