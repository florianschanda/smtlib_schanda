...
(assert (= z (fp #b0 #b10010101 #b11110100110000101011001)))
;; z should be Float32(0x4AFA6159 [Rational(16408921, 2), 8204460.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11110100110000101011000))))
(check-sat)
(exit)
