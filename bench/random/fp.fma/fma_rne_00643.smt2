...
(assert (= x ((_ to_fp 8 24) #x4ADCF919)))
;; x should be Float32(0x4ADCF919 [Rational(14481689, 2), 7240844.500000])
...
(assert (= result (fp #b1 #b00010111 #b10111001111100100011001)))
(check-sat)
(exit)
