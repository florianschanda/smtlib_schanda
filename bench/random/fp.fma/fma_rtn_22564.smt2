...
(assert (= z (fp #b1 #b10010011 #b00000111100111010010100)))
;; z should be Float32(0xC983CE94 [Rational(-2159525, 2), -1079762.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10010011 #b00000111100111010010100))))
(check-sat)
(exit)
