...
(assert (= y ((_ to_fp 8 24) #x0032F9C2)))
;; y should be Float32(0x0032F9C2 [Rational(1670369, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3FCBE708)))
(check-sat)
(exit)
