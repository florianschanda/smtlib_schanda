...
(assert (= z ((_ to_fp 8 24) #x735E4DF4)))
;; z should be Float32(0x735E4DF4 [Rational(17612777401822912485577193422848), 17612777401822912485577193422848.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b11100110 #b10111100100110111110011)))
(check-sat)
(exit)
