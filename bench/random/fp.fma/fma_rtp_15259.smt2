...
(assert (= z (fp #b0 #b10010101 #b00110001111010100001111)))
;; z should be Float32(0x4A98F50F [Rational(10024207, 2), 5012103.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10010101 #b00110001111010100010000)))
(check-sat)
(exit)
