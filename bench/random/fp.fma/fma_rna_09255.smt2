...
(assert (= z (fp #b0 #b10010001 #b11110111110010111110000)))
;; z should be Float32(0x48FBE5F0 [Rational(1031775, 2), 515887.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010001 #b11110111110010111110000)))
(check-sat)
(exit)
