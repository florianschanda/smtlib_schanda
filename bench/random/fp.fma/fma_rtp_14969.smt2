...
(assert (= y ((_ to_fp 8 24) #x006CE74E)))
;; y should be Float32(0x006CE74E [Rational(3568551, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x4059CE9C))))
(check-sat)
(exit)
