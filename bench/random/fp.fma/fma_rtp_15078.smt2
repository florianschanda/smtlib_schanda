...
(assert (= z (fp #b1 #b10010101 #b10110010101000001111101)))
;; z should be Float32(0xCAD9507D [Rational(-14241917, 2), -7120958.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010101 #b10110010101000010000100))))
(check-sat)
(exit)
