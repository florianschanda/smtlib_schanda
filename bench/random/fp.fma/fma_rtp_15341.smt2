...
(assert (= z (fp #b0 #b01000110 #b00110000000011000101010)))
;; z should be Float32(0x2318062A [Rational(4981525, 604462909807314587353088), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x2318062A)))
(check-sat)
(exit)
