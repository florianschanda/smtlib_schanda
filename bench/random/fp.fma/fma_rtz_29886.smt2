...
(assert (= z ((_ to_fp 8 24) #x804FCA4B)))
;; z should be Float32(0x804FCA4B [Rational(-5229131, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x804FCA4B))))
(check-sat)
(exit)
