...
(assert (= x ((_ to_fp 8 24) #x8039D3B0)))
;; x should be Float32(0x8039D3B0 [Rational(-236859, 44601490397061246283071436545296723011960832), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBFE74EC0))))
(check-sat)
(exit)
