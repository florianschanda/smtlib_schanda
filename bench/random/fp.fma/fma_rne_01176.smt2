...
(assert (= z ((_ to_fp 8 24) #xF35F4AC8)))
;; z should be Float32(0xF35F4AC8 [Rational(-17691023916571649744280875958272), -17691023916571649744280875958272.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b11100110 #b10111110100101011001000))))
(check-sat)
(exit)
