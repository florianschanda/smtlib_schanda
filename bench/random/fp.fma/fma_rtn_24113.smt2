...
(assert (= z ((_ to_fp 8 24) #x4AD67B91)))
;; z should be Float32(0x4AD67B91 [Rational(14056337, 2), 7028168.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b10101100111101110010001)))
(check-sat)
(exit)
