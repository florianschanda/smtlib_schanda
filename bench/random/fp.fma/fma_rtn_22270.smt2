...
(assert (= z (fp #b0 #b10010101 #b01111001101100010000111)))
;; z should be Float32(0x4ABCD887 [Rational(12376199, 2), 6188099.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x4ABCD886)))
(check-sat)
(exit)
