...
(assert (= y (fp #b0 #b11111111 #b11000111010011011101011)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xDF2CEABC)))
;; z should be Float32(0xDF2CEABC [Rational(-12459978027259920384), -12459978027259920384.000000])
