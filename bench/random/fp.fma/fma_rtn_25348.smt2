...
(assert (= z (fp #b0 #b10010001 #b10011010001000001110000)))
;; z should be Float32(0x48CD1070 [Rational(839943, 2), 419971.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010001 #b10011010001000001101111)))
(check-sat)
(exit)
