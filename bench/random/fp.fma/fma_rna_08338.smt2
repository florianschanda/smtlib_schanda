...
(assert (= y (fp #b0 #b10010101 #b11010011011001010000111)))
;; y should be Float32(0x4AE9B287 [Rational(15315591, 2), 7657795.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BE9B285))))
(check-sat)
(exit)
