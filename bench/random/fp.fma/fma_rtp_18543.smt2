...
(assert (= z (fp #b1 #b00000000 #b01111111100001000001011)))
;; z should be Float32(0x803FC20B [Rational(-4178443, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b00000000 #b01111111100001000001011))))
(check-sat)
(exit)
