...
(assert (= y (fp #b1 #b11000010 #b01110000000101111101011)))
;; y should be Float32(0xE1380BEB [Rational(-212191230607281356800), -212191230607281356800.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xA2380BEA))))
(check-sat)
(exit)
