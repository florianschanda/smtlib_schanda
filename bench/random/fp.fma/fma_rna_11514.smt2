...
(assert (= y (fp #b1 #b11100000 #b00101000100110010101001)))
;; y should be Float32(0xF0144CA9 [Rational(-183585831583141547834345521152), -183585831583141547834345521152.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFF1E344)))
