...
(assert (= z ((_ to_fp 8 24) #x47E58DF2)))
;; z should be Float32(0x47E58DF2 [Rational(7522041, 64), 117531.890625])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10001111 #b11001011000110111110010))))
(check-sat)
(exit)
