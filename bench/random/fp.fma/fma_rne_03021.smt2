...
(assert (= x (fp #b0 #b00000000 #b11001111110101001101010)))
;; x should be Float32(0x0067EA6A [Rational(3405109, 356811923176489970264571492362373784095686656), 0.000000])
