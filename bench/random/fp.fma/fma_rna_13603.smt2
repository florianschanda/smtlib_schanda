...
(assert (= x (fp #b0 #b11111111 #b00000010101111111110101)))
...
(assert (= z ((_ to_fp 8 24) #x806A0FF0)))
;; z should be Float32(0x806A0FF0 [Rational(-434431, 44601490397061246283071436545296723011960832), -0.000000])
