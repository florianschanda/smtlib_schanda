...
(assert (= y ((_ to_fp 8 24) #xE2810AA1)))
;; y should be Float32(0xE2810AA1 [Rational(-1190197939460080926720), -1190197939460080926720.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FB2FC8F)))
