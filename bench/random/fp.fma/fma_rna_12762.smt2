...
(assert (= x ((_ to_fp 8 24) #xFB4674A0)))
;; x should be Float32(0xFB4674A0 [Rational(-1030440214009921746512231121366810624), -1030440214009921746512231121366810624.000000])
