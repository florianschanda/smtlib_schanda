...
(assert (= z (fp #b1 #b00000000 #b11011010110111010100101)))
;; z should be Float32(0x806D6EA5 [Rational(-7171749, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b00000000 #b11011010110111010100101)))
(check-sat)
(exit)
