...
(assert (= z (fp #b0 #b00000000 #b11101111010101011010000)))
;; z should be Float32(0x0077AAD0 [Rational(490157, 44601490397061246283071436545296723011960832), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x0077AAD0)))
(check-sat)
(exit)
