...
(assert (= z ((_ to_fp 8 24) #xE11771F5)))
;; z should be Float32(0xE11771F5 [Rational(-174604364039107641344), -174604364039107641344.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b11000010 #b00101110111000111110101)))
(check-sat)
(exit)
