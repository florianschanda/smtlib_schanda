...
(assert (= z (fp #b1 #b00000000 #b10001100000000001001000)))
;; z should be Float32(0x80460048 [Rational(-573449, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x80460048)))
(check-sat)
(exit)
