...
(assert (= y (fp #b1 #b11111111 #b00111010001000111110011)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xD21B6815)))
;; z should be Float32(0xD21B6815 [Rational(-166866534400), -166866534400.000000])
