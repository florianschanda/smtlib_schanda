...
(assert (= x (fp #b0 #b00000000 #b11001100110010001100000)))
;; x should be Float32(0x00666460 [Rational(209699, 22300745198530623141535718272648361505980416), 0.000000])
...
(assert (= z (fp #b1 #b11111111 #b11011010111110101111010)))
