...
(assert (= y ((_ to_fp 8 24) #x0024E534)))
;; y should be Float32(0x0024E534 [Rational(604493, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBF9394CF))))
(check-sat)
(exit)
