...
(assert (= x ((_ to_fp 8 24) #x80350315)))
;; x should be Float32(0x80350315 [Rational(-3474197, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b1 #b01111111 #b10101000000110001010011)))
(check-sat)
(exit)
