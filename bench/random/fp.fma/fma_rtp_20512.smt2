...
(assert (= x (fp #b0 #b11111111 #b10111111011000100011100)))
...
(assert (= z (fp #b1 #b10010101 #b11101000100111101011111)))
;; z should be Float32(0xCAF44F5F [Rational(-16011103, 2), -8005551.500000])
