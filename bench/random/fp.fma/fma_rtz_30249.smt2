...
(assert (= x ((_ to_fp 8 24) #x6061B497)))
;; x should be Float32(0x6061B497 [Rational(65055160722389991424), 65055160722389991424.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x95E1B497))))
(check-sat)
(exit)
