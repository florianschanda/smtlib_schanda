...
(assert (= y (fp #b0 #b10010100 #b00011011101110011101110)))
;; y should be Float32(0x4A0DDCEE [Rational(4648567, 2), 2324283.500000])
...
(assert (= result (fp #b0 #b00010110 #b00011011101110011101000)))
(check-sat)
(exit)
