...
(assert (= y (fp #b0 #b10010101 #b01101111101001010001111)))
;; y should be Float32(0x4AB7D28F [Rational(12046991, 2), 6023495.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BB7D28F))))
(check-sat)
(exit)
