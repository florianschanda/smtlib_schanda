...
(assert (= x ((_ to_fp 8 24) #xFFBD7777)))
...
(assert (= z ((_ to_fp 8 24) #x0032AC37)))
;; z should be Float32(0x0032AC37 [Rational(3320887, 713623846352979940529142984724747568191373312), 0.000000])
