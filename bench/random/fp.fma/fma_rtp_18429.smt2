...
(assert (= z ((_ to_fp 8 24) #x80255FC0)))
;; z should be Float32(0x80255FC0 [Rational(-38271, 11150372599265311570767859136324180752990208), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b00000000 #b01001010101111111000000)))
(check-sat)
(exit)
