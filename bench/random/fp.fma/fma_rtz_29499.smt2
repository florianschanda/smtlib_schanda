...
(assert (= z (fp #b1 #b10010101 #b11011101110111000010011)))
;; z should be Float32(0xCAEEEE13 [Rational(-15658515, 2), -7829257.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010101 #b11011101110111000010011))))
(check-sat)
(exit)
