...
(assert (= y (fp #b1 #b00000000 #b10100001110000111001111)))
;; y should be Float32(0x8050E1CF [Rational(-5300687, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x4021C39E))))
(check-sat)
(exit)
