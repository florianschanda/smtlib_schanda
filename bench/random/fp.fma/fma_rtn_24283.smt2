...
(assert (= x (fp #b1 #b10010101 #b11101110000001100011101)))
;; x should be Float32(0xCAF7031D [Rational(-16188189, 2), -8094094.500000])
...
(assert (= result ((_ to_fp 8 24) #x8BF7031D)))
(check-sat)
(exit)
