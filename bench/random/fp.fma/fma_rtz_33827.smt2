...
(assert (= x (fp #b1 #b00000000 #b11111100111001000011000)))
;; x should be Float32(0x807E7218 [Rational(-1035843, 89202980794122492566142873090593446023921664), -0.000000])
