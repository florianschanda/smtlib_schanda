...
(assert (= x (fp #b0 #b00000000 #b00111010011010101001010)))
;; x should be Float32(0x001D354A [Rational(957093, 356811923176489970264571492362373784095686656), 0.000000])
