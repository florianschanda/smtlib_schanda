...
(assert (= x (fp #b1 #b00000000 #b11101111011101001011011)))
;; x should be Float32(0x8077BA5B [Rational(-7846491, 713623846352979940529142984724747568191373312), -0.000000])
