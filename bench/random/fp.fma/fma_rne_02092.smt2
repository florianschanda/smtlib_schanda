...
(assert (= z (fp #b0 #b10010100 #b00010011110000110101010)))
;; z should be Float32(0x4A09E1AA [Rational(4518101, 2), 2259050.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010100 #b00010011110000110101010))))
(check-sat)
(exit)
