...
(assert (= x ((_ to_fp 8 24) #x002CD748)))
;; x should be Float32(0x002CD748 [Rational(367337, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (not (= result (fp #b0 #b01111111 #b01100110101110100011111))))
(check-sat)
(exit)
