...
(assert (= z ((_ to_fp 8 24) #x807F5ABB)))
;; z should be Float32(0x807F5ABB [Rational(-8346299, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x807F5ABB)))
(check-sat)
(exit)
