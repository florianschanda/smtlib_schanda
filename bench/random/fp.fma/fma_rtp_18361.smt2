...
(assert (= y ((_ to_fp 8 24) #x87177794)))
;; y should be Float32(0x87177794 [Rational(-2481637, 21778071482940061661655974875633165533184), -0.000000])
...
(assert (= result (fp #b0 #b10001110 #b00101110111011110010100)))
(check-sat)
(exit)
