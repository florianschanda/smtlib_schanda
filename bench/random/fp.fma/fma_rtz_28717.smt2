...
(assert (= y ((_ to_fp 8 24) #xCA31A53E)))
;; y should be Float32(0xCA31A53E [Rational(-5821087, 2), -2910543.500000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x3D98DCC1)))
;; z should be Float32(0x3D98DCC1 [Rational(10017985, 134217728), 0.074640])
