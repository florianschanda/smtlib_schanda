...
(assert (= z ((_ to_fp 8 24) #xCA86C3A1)))
;; z should be Float32(0xCA86C3A1 [Rational(-8831905, 2), -4415952.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010101 #b00001101100001110100001))))
(check-sat)
(exit)
