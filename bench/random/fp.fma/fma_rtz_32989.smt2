...
(assert (= y (fp #b0 #b10100111 #b11110011100111101001011)))
;; y should be Float32(0x53F9CF4B [Rational(2145849311232), 2145849311232.000000])
...
(assert (= result ((_ to_fp 8 24) #x8979CF0B)))
(check-sat)
(exit)
