...
(assert (= z ((_ to_fp 8 24) #x801EEC5B)))
;; z should be Float32(0x801EEC5B [Rational(-2026587, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x801EEC5B)))
(check-sat)
(exit)
