...
(assert (= z ((_ to_fp 8 24) #xC7F5C040)))
;; z should be Float32(0xC7F5C040 [Rational(-251649, 2), -125824.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10001111 #b11101011100000001000000))))
(check-sat)
(exit)
