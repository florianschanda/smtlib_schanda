...
(assert (= y (fp #b0 #b11101011 #b10010110000011000111101)))
;; y should be Float32(0x75CB063D [Rational(514727924637746723017005685800960), 514727924637746723017005685800960.000000])
