...
(assert (= x (fp #b1 #b00000000 #b11111010001100100010001)))
;; x should be Float32(0x807D1911 [Rational(-8198417, 713623846352979940529142984724747568191373312), -0.000000])
