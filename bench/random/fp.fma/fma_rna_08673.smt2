...
(assert (= z (fp #b0 #b00000000 #b01010000010010111100111)))
;; z should be Float32(0x002825E7 [Rational(2631143, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x002825E7))))
(check-sat)
(exit)
