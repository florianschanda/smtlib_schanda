...
(assert (= z (fp #b1 #b10010100 #b01011100000100111000010)))
;; z should be Float32(0xCA2E09C2 [Rational(-5702881, 2), -2851440.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA2E09C2))))
(check-sat)
(exit)
