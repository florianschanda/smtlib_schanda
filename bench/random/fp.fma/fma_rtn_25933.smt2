...
(assert (= z ((_ to_fp 8 24) #x8A221154)))
;; z should be Float32(0x8A221154 [Rational(-2655317, 340282366920938463463374607431768211456), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x8A221154))))
(check-sat)
(exit)
