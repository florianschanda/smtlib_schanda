...
(assert (= y (fp #b0 #b11000101 #b11010111100100110111100)))
;; y should be Float32(0x62EBC9BC [Rational(2174760675509494874112), 2174760675509494874112.000000])
...
(assert (= result ((_ to_fp 8 24) #x186BC9BC)))
(check-sat)
(exit)
