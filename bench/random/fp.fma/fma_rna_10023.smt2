...
(assert (= x (fp #b0 #b00000000 #b10100101001001001000111)))
;; x should be Float32(0x00529247 [Rational(5411399, 713623846352979940529142984724747568191373312), 0.000000])
