...
(assert (= x (fp #b0 #b11111111 #b11001001001010111100110)))
...
(assert (= z ((_ to_fp 8 24) #x0ACD7BAD)))
;; z should be Float32(0x0ACD7BAD [Rational(13466541, 680564733841876926926749214863536422912), 0.000000])
