...
(assert (= x ((_ to_fp 8 24) #x8059249D)))
;; x should be Float32(0x8059249D [Rational(-5842077, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= z (fp #b0 #b11111111 #b10011010101000100011010)))
