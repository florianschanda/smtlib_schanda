...
(assert (= z (fp #b1 #b01110101 #b01111100111011010011000)))
;; z should be Float32(0xBABE7698 [Rational(-1560275, 1073741824), -0.001453])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #xBABE7698)))
(check-sat)
(exit)
