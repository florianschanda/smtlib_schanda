...
(assert (= z (fp #b1 #b00000000 #b00101011000010111101001)))
;; z should be Float32(0x801585E9 [Rational(-1410537, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x801585E9)))
(check-sat)
(exit)
