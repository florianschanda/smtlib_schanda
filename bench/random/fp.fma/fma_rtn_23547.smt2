...
(assert (= x (fp #b0 #b00000000 #b11111100111101111100001)))
;; x should be Float32(0x007E7BE1 [Rational(8289249, 713623846352979940529142984724747568191373312), 0.000000])
