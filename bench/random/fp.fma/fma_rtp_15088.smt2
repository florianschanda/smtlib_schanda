...
(assert (= z (fp #b0 #b10010101 #b01101001010011001111111)))
;; z should be Float32(0x4AB4A67F [Rational(11839103, 2), 5919551.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4AB4A67F))))
(check-sat)
(exit)
