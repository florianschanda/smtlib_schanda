...
(assert (= y (fp #b0 #b00101111 #b01010110011001001101100)))
;; y should be Float32(0x17AB326C [Rational(2804891, 2535301200456458802993406410752), 0.000000])
...
(assert (= result (fp #b0 #b10101111 #b01010110011001001101100)))
(check-sat)
(exit)
