...
(assert (= z (fp #b1 #b10010001 #b00001100011000010010000)))
;; z should be Float32(0xC8863090 [Rational(-549641, 2), -274820.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xC8863090))))
(check-sat)
(exit)
