...
(assert (= z (fp #b1 #b10010101 #b11011010000111111100101)))
;; z should be Float32(0xCAED0FE5 [Rational(-15536101, 2), -7768050.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAED0FE5))))
(check-sat)
(exit)
