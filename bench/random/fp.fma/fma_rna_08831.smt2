...
(assert (= y (fp #b0 #b00000000 #b11101111001001111111111)))
;; y should be Float32(0x007793FF [Rational(7836671, 713623846352979940529142984724747568191373312), 0.000000])
