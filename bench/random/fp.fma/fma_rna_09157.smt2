...
(assert (= z ((_ to_fp 8 24) #x805A3E87)))
;; z should be Float32(0x805A3E87 [Rational(-5914247, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x805A3E87))))
(check-sat)
(exit)
