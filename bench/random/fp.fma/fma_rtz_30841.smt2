...
(assert (= y (fp #b0 #b00000000 #b10101101100101100110110)))
;; y should be Float32(0x0056CB36 [Rational(2844059, 356811923176489970264571492362373784095686656), 0.000000])
