...
(assert (= x (fp #b0 #b11100111 #b10111010000000100111101)))
;; x should be Float32(0x73DD013D [Rational(35019614290274472891243189764096), 35019614290274472891243189764096.000000])
