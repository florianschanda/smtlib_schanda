...
(assert (= z (fp #b0 #b01101001 #b11011000111101011111001)))
;; z should be Float32(0x34EC7AF9 [Rational(15497977, 35184372088832), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x34EC7AF9))))
(check-sat)
(exit)
