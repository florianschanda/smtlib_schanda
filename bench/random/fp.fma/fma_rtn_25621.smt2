...
(assert (= y (fp #b1 #b11111111 #b10010011011101111011101)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b0 #b00000000 #b01010010110000110001000)))
;; z should be Float32(0x00296188 [Rational(338993, 89202980794122492566142873090593446023921664), 0.000000])
