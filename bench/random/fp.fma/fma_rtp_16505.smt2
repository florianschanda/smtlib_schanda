...
(assert (= x (fp #b0 #b11101100 #b10010111010000111001011)))
;; x should be Float32(0x764BA1CB [Rational(1032536927290769846865700929404928), 1032536927290769846865700929404928.000000])
