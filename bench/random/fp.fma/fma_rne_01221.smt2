...
(assert (= y (fp #b0 #b00000001 #b10000000101111011110100)))
;; y should be Float32(0x00C05EF4 [Rational(3151805, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x40C05EF3))))
(check-sat)
(exit)
