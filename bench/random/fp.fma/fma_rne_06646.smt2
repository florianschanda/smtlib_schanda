...
(assert (= x ((_ to_fp 8 24) #x7F8B5590)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b00101100 #b10101110000001010111111)))
;; y should be Float32(0x165702BF [Rational(14090943, 81129638414606681695789005144064), 0.000000])
