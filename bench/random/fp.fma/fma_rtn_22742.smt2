...
(assert (= y (fp #b1 #b11111111 #b11000011010111000111110)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x8010A42E)))
;; z should be Float32(0x8010A42E [Rational(-545303, 356811923176489970264571492362373784095686656), -0.000000])
