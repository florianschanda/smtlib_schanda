...
(assert (= y (fp #b0 #b10010011 #b11000111110100101011100)))
;; y should be Float32(0x49E3E95C [Rational(3734103, 2), 1867051.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b00111000111110100101101))))
(check-sat)
(exit)
