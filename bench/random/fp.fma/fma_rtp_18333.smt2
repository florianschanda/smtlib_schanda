...
(assert (= z (fp #b1 #b10011110 #b00100100100010111100100)))
;; z should be Float32(0xCF1245E4 [Rational(-2454053888), -2454053888.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCF1245E3))))
(check-sat)
(exit)
