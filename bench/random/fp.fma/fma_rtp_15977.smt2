...
(assert (= z ((_ to_fp 8 24) #x9579529B)))
;; z should be Float32(0x9579529B [Rational(-16339611, 324518553658426726783156020576256), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b00101010 #b11110010101001010011010))))
(check-sat)
(exit)
