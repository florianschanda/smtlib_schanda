...
(assert (= y (fp #b0 #b10010101 #b11100111011111010111101)))
;; y should be Float32(0x4AF3BEBD [Rational(15974077, 2), 7987038.500000])
...
(assert (= result (fp #b0 #b00010111 #b11100111011111010111101)))
(check-sat)
(exit)
