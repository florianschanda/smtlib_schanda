...
(assert (= x (fp #b1 #b10010101 #b00101100110011010110101)))
;; x should be Float32(0xCA9666B5 [Rational(-9856693, 2), -4928346.500000])
...
(assert (= z (fp #b0 #b11111111 #b10001010111111010000001)))
