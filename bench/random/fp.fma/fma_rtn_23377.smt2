...
(assert (= x ((_ to_fp 8 24) #x74767718)))
;; x should be Float32(0x74767718 [Rational(78107942835589751449161014706176), 78107942835589751449161014706176.000000])
...
(assert (= result ((_ to_fp 8 24) #xB5767718)))
(check-sat)
(exit)
