...
(assert (= z (fp #b0 #b10101000 #b10001011010100101110101)))
;; z should be Float32(0x5445A975 [Rational(3395806298112), 3395806298112.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10101000 #b10001011010100101110101))))
(check-sat)
(exit)
