...
(assert (= z (fp #b1 #b01111111 #b10111101011110000101011)))
;; z should be Float32(0xBFDEBC2B [Rational(-14597163, 8388608), -1.740117])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b01111111 #b10111101011110000100111)))
(check-sat)
(exit)
