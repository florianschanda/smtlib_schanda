...
(assert (= z (fp #b0 #b01001011 #b11111111111111010000011)))
;; z should be Float32(0x25FFFE83 [Rational(16776835, 37778931862957161709568), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b01001011 #b11111111111111010000011))))
(check-sat)
(exit)
