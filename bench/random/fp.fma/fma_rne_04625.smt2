...
(assert (= z ((_ to_fp 8 24) #x7859A4AE)))
;; z should be Float32(0x7859A4AE [Rational(17657320612145842989615411395297280), 17657320612145842989615411395297280.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b11110000 #b10110011010010010101110))))
(check-sat)
(exit)
