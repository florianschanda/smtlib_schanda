...
(assert (= z (fp #b0 #b10010011 #b10100101101111001010100)))
;; z should be Float32(0x49D2DE54 [Rational(3454869, 2), 1727434.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010011 #b10100101101111001010100)))
(check-sat)
(exit)
