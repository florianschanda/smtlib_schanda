...
(assert (= z (fp #b1 #b10010100 #b10011010100001110100110)))
;; z should be Float32(0xCA4D43A6 [Rational(-6726099, 2), -3363049.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10010100 #b10011010100001110100110)))
(check-sat)
(exit)
