...
(assert (= y (fp #b0 #b01010011 #b01001111010111110010000)))
;; y should be Float32(0x29A7AF90 [Rational(686841, 9223372036854775808), 0.000000])
...
(assert (= result (fp #b0 #b11010011 #b01001111010111110001111)))
(check-sat)
(exit)
