...
(assert (= y (fp #b1 #b00000000 #b11010010100110000011100)))
;; y should be Float32(0x80694C1C [Rational(-1725191, 178405961588244985132285746181186892047843328), -0.000000])
