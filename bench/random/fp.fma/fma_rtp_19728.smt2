...
(assert (= x (fp #b1 #b01001100 #b00100110110100111001000)))
;; x should be Float32(0xA61369C8 [Rational(-1207609, 2361183241434822606848), -0.000000])
...
(assert (= result (fp #b0 #b11001100 #b00100110110100111001000)))
(check-sat)
(exit)
