...
(assert (= x (fp #b0 #b10010100 #b10110110101100001011010)))
;; x should be Float32(0x4A5B585A [Rational(7187501, 2), 3593750.500000])
...
(assert (= result (fp #b0 #b00010110 #b10110110101100001011001)))
(check-sat)
(exit)
