...
(assert (= y (fp #b0 #b10010101 #b10001111000110100000101)))
;; y should be Float32(0x4AC78D05 [Rational(13077765, 2), 6538882.500000])
...
(assert (= result (fp #b0 #b00010111 #b10001111000110100000011)))
(check-sat)
(exit)
