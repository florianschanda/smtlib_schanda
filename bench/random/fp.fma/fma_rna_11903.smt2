...
(assert (= y ((_ to_fp 8 24) #xFF8F9297)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x003F70B1)))
;; z should be Float32(0x003F70B1 [Rational(4157617, 713623846352979940529142984724747568191373312), 0.000000])
