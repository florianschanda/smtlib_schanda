...
(assert (= y ((_ to_fp 8 24) #xAAB5E242)))
;; y should be Float32(0xAAB5E242 [Rational(-5959969, 18446744073709551616), -0.000000])
...
(assert (not (= result (fp #b1 #b11010101 #b01101011110001001000010))))
(check-sat)
(exit)
