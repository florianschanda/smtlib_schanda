...
(assert (= x ((_ to_fp 8 24) #x007DC759)))
;; x should be Float32(0x007DC759 [Rational(8243033, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC07B8EB1))))
(check-sat)
(exit)
