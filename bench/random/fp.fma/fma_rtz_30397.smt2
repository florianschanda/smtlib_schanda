...
(assert (= x (fp #b0 #b00000000 #b01010011110100100001000)))
;; x should be Float32(0x0029E908 [Rational(343329, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3FA7A41F)))
(check-sat)
(exit)
