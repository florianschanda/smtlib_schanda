...
(assert (= y (fp #b1 #b00000000 #b01011101001111001000110)))
;; y should be Float32(0x802E9E46 [Rational(-1527587, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b11100011100000001101010)))
