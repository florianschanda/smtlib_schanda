...
(assert (= z (fp #b0 #b10010101 #b10100100011001100101111)))
;; z should be Float32(0x4AD2332F [Rational(13775663, 2), 6887831.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10010101 #b10100100011001100110111)))
(check-sat)
(exit)
