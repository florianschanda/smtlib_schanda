...
(assert (= x ((_ to_fp 8 24) #x00595F6E)))
;; x should be Float32(0x00595F6E [Rational(2928567, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x4032BEDB)))
(check-sat)
(exit)
