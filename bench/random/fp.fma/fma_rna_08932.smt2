...
(assert (= z (fp #b0 #b10010101 #b10000100000101110000101)))
;; z should be Float32(0x4AC20B85 [Rational(12716933, 2), 6358466.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010101 #b10000100000101110000101)))
(check-sat)
(exit)
