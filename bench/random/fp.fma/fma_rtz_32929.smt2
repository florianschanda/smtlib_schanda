...
(assert (= z ((_ to_fp 8 24) #x4A951BFF)))
;; z should be Float32(0x4A951BFF [Rational(9772031, 2), 4886015.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010101 #b00101010001101111111110))))
(check-sat)
(exit)
