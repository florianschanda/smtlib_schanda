...
(assert (= x (fp #b0 #b00000000 #b11110100010110110101010)))
;; x should be Float32(0x007A2DAA [Rational(4003541, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result (fp #b0 #b10000000 #b11101000101101101010011)))
(check-sat)
(exit)
