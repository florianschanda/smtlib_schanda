...
(assert (= y ((_ to_fp 8 24) #x003087B5)))
;; y should be Float32(0x003087B5 [Rational(3180469, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b0 #b01111111 #b10000100001111011010011))))
(check-sat)
(exit)
