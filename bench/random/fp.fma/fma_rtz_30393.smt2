...
(assert (= x (fp #b0 #b00000000 #b00011011000101101011011)))
;; x should be Float32(0x000D8B5B [Rational(887643, 713623846352979940529142984724747568191373312), 0.000000])
