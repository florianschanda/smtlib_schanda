...
(assert (= z ((_ to_fp 8 24) #x6CF8D53A)))
;; z should be Float32(0x6CF8D53A [Rational(2406564297891484359293140992), 2406564297891484359293140992.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b11011001 #b11110001101010100111010)))
(check-sat)
(exit)
