...
(assert (= y (fp #b0 #b11111111 #b11001110010110100011111)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7B366E9C)))
;; z should be Float32(0x7B366E9C [Rational(947241452903092537375849122415771648), 947241452903092537375849122415771648.000000])
