...
(assert (= x (fp #b0 #b01110001 #b01101010110000001100110)))
;; x should be Float32(0x38B56066 [Rational(5943347, 68719476736), 0.000086])
...
(assert (= result ((_ to_fp 8 24) #x78B56065)))
(check-sat)
(exit)
