...
(assert (= y (fp #b1 #b00000000 #b10111010110000010110111)))
;; y should be Float32(0x805D60B7 [Rational(-6119607, 713623846352979940529142984724747568191373312), -0.000000])
