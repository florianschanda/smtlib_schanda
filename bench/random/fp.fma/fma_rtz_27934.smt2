...
(assert (= x ((_ to_fp 8 24) #x4A8FEA85)))
;; x should be Float32(0x4A8FEA85 [Rational(9431685, 2), 4715842.500000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x23AF2A92)))
;; y should be Float32(0x23AF2A92 [Rational(5739849, 302231454903657293676544), 0.000000])
