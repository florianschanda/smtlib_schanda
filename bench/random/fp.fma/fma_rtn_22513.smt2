...
(assert (= z (fp #b1 #b01100001 #b01111100010011110011100)))
;; z should be Float32(0xB0BE279C [Rational(-3115495, 2251799813685248), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b01100001 #b01111100010011110011100)))
(check-sat)
(exit)
