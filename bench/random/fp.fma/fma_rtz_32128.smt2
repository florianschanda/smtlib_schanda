...
(assert (= z (fp #b1 #b00000000 #b11000000010000001011010)))
;; z should be Float32(0x8060205A [Rational(-3149869, 356811923176489970264571492362373784095686656), -0.000000])
