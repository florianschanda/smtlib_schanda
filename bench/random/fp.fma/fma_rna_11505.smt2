...
(assert (= y ((_ to_fp 8 24) #x893ED120)))
;; y should be Float32(0x893ED120 [Rational(-390793, 170141183460469231731687303715884105728), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x493ED11F))))
(check-sat)
(exit)
