...
(assert (= x ((_ to_fp 8 24) #x8008D2C8)))
;; x should be Float32(0x8008D2C8 [Rational(-72281, 89202980794122492566142873090593446023921664), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7FE701A6)))
