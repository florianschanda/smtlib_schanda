...
(assert (= x (fp #b0 #b10010101 #b00010011101100111100011)))
;; x should be Float32(0x4A89D9E3 [Rational(9034211, 2), 4517105.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b00010011101100111100011))))
(check-sat)
(exit)
