...
(assert (= x (fp #b0 #b00000000 #b10101011000111100001100)))
;; x should be Float32(0x00558F0C [Rational(1401795, 178405961588244985132285746181186892047843328), 0.000000])
