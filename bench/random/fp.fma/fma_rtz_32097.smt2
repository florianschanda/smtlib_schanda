...
(assert (= y (fp #b1 #b00000000 #b01001110001110000101101)))
;; y should be Float32(0x80271C2D [Rational(-2563117, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3F9C70B3)))
(check-sat)
(exit)
