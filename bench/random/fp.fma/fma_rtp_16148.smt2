...
(assert (= z (fp #b1 #b10000100 #b10010111100010110100111)))
;; z should be Float32(0xC24BC5A7 [Rational(-13354407, 262144), -50.943020])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xC24BC5A7))))
(check-sat)
(exit)
