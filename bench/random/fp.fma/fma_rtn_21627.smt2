...
(assert (= y (fp #b1 #b00000000 #b00000110001111011101110)))
;; y should be Float32(0x80031EEE [Rational(-102263, 356811923176489970264571492362373784095686656), -0.000000])
