...
(assert (= z (fp #b1 #b10010100 #b11101010101100000011010)))
;; z should be Float32(0xCA75581A [Rational(-8039437, 2), -4019718.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10010100 #b11101010101100000101001)))
(check-sat)
(exit)
