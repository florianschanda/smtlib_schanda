...
(assert (= y (fp #b1 #b11010011 #b01101111111011010111000)))
;; y should be Float32(0xE9B7F6B8 [Rational(-27799815168146579281412096), -27799815168146579281412096.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x2AB7F6B7))))
(check-sat)
(exit)
