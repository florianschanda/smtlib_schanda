...
(assert (= z (fp #b0 #b00000000 #b11000101101000110111010)))
;; z should be Float32(0x0062D1BA [Rational(3238109, 356811923176489970264571492362373784095686656), 0.000000])
