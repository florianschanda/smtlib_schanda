...
(assert (= y (fp #b1 #b10010000 #b00000000110100010100000)))
;; y should be Float32(0xC80068A0 [Rational(-262981, 2), -131490.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x800201A2))))
(check-sat)
(exit)
