...
(assert (= z (fp #b0 #b01001111 #b01101010011011011100101)))
;; z should be Float32(0x27B536E5 [Rational(11876069, 2361183241434822606848), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x27B536E6)))
(check-sat)
(exit)
