...
(assert (= y (fp #b0 #b10010101 #b00100101100110001001001)))
;; y should be Float32(0x4A92CC49 [Rational(9620553, 2), 4810276.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8B92CC49))))
(check-sat)
(exit)
