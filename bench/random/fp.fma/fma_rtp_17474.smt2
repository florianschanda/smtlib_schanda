...
(assert (= x (fp #b1 #b10010000 #b11110110101010011100000)))
;; x should be Float32(0xC87B54E0 [Rational(-514727, 2), -257363.500000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x320A37DD)))
;; y should be Float32(0x320A37DD [Rational(9058269, 1125899906842624), 0.000000])
