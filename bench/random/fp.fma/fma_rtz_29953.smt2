...
(assert (= z (fp #b0 #b00000000 #b11010101000110110011110)))
;; z should be Float32(0x006A8D9E [Rational(3491535, 356811923176489970264571492362373784095686656), 0.000000])
