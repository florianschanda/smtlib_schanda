...
(assert (= z (fp #b0 #b10010101 #b01000111000011001111111)))
;; z should be Float32(0x4AA3867F [Rational(10716799, 2), 5358399.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x4AA3867F)))
(check-sat)
(exit)
