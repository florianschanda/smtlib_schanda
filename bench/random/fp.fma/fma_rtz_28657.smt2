...
(assert (= y ((_ to_fp 8 24) #x0204E795)))
;; y should be Float32(0x0204E795 [Rational(8710037, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x4204E794))))
(check-sat)
(exit)
