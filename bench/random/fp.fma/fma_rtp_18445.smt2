...
(assert (= y (fp #b0 #b10010010 #b01101001100010110101000)))
;; y should be Float32(0x4934C5A8 [Rational(1480885, 2), 740442.500000])
...
(assert (= result (fp #b1 #b00010100 #b01101001100010110110110)))
(check-sat)
(exit)
