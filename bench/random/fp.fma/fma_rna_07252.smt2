...
(assert (= x (fp #b0 #b10001111 #b00001101111010001000000)))
;; x should be Float32(0x4786F440 [Rational(138193, 2), 69096.500000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x4AC5254F)))
;; y should be Float32(0x4AC5254F [Rational(12920143, 2), 6460071.500000])
