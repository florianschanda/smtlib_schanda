...
(assert (= y ((_ to_fp 8 24) #x00653F43)))
;; y should be Float32(0x00653F43 [Rational(6635331, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result (fp #b0 #b00000001 #b00000000000000000000001)))
(check-sat)
(exit)
