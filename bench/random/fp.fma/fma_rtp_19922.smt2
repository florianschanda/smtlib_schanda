...
(assert (= x ((_ to_fp 8 24) #x80791772)))
;; x should be Float32(0x80791772 [Rational(-3967929, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result (fp #b1 #b10000000 #b11100100010111011100011)))
(check-sat)
(exit)
