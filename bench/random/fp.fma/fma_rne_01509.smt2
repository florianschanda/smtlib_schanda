...
(assert (= z (fp #b0 #b11011111 #b10100110110011111110100)))
;; z should be Float32(0x6FD367F4 [Rational(130854017378291872998711361536), 130854017378291872998711361536.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x6FD367F4)))
(check-sat)
(exit)
