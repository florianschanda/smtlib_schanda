...
(assert (= y (fp #b0 #b10010101 #b01110100001001001110011)))
;; y should be Float32(0x4ABA1273 [Rational(12194419, 2), 6097209.500000])
...
(assert (= result ((_ to_fp 8 24) #x005D093A)))
(check-sat)
(exit)
