...
(assert (= x ((_ to_fp 8 24) #xCAF158D7)))
;; x should be Float32(0xCAF158D7 [Rational(-15816919, 2), -7908459.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b11100010101100011011000))))
(check-sat)
(exit)
