...
(assert (= z ((_ to_fp 8 24) #x0063B360)))
;; z should be Float32(0x0063B360 [Rational(204187, 22300745198530623141535718272648361505980416), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x0063B360)))
(check-sat)
(exit)
