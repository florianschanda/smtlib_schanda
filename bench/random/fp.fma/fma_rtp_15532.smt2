...
(assert (= z ((_ to_fp 8 24) #x003A7110)))
;; z should be Float32(0x003A7110 [Rational(239377, 44601490397061246283071436545296723011960832), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00000000 #b01110100111000100010000)))
(check-sat)
(exit)
