...
(assert (= x ((_ to_fp 8 24) #x4ABCF2F7)))
;; x should be Float32(0x4ABCF2F7 [Rational(12382967, 2), 6191483.500000])
...
(assert (not (= result (fp #b1 #b00000001 #b10111100111100101111011))))
(check-sat)
(exit)
