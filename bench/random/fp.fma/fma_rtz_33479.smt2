...
(assert (= x (fp #b1 #b10001100 #b10011101101011110101000)))
;; x should be Float32(0xC64ED7A8 [Rational(-1694453, 128), -13237.914062])
...
(assert (not (= result ((_ to_fp 8 24) #x074ED7A8))))
(check-sat)
(exit)
