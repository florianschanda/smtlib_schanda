...
(assert (= z (fp #b1 #b10010101 #b11011111000101100101101)))
;; z should be Float32(0xCAEF8B2D [Rational(-15698733, 2), -7849366.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010101 #b11011111000101100101101))))
(check-sat)
(exit)
