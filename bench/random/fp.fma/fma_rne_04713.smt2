...
(assert (= y (fp #b0 #b10010100 #b01110011010010101000110)))
;; y should be Float32(0x4A39A546 [Rational(6083235, 2), 3041617.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8B39A545))))
(check-sat)
(exit)
