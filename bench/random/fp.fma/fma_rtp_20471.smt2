...
(assert (= x ((_ to_fp 8 24) #xFFED0360)))
...
(assert (= z ((_ to_fp 8 24) #x0AF6C550)))
;; z should be Float32(0x0AF6C550 [Rational(1010773, 42535295865117307932921825928971026432), 0.000000])
