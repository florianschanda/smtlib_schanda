...
(assert (= z (fp #b0 #b10000010 #b01000001001100101101110)))
;; z should be Float32(0x4120996E [Rational(5262519, 524288), 10.037458])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10000010 #b01000001001100101101110))))
(check-sat)
(exit)
