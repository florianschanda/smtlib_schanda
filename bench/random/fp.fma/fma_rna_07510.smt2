...
(assert (= x (fp #b0 #b10010010 #b10010010110101101101000)))
;; x should be Float32(0x49496B68 [Rational(1650029, 2), 825014.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b11100110110100101001001))))
(check-sat)
(exit)
