...
(assert (= x (fp #b1 #b00000000 #b01101101001000000001111)))
;; x should be Float32(0x8036900F [Rational(-3575823, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7FE2F46D)))
