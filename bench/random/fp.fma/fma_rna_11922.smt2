...
(assert (= z ((_ to_fp 8 24) #x007AF744)))
;; z should be Float32(0x007AF744 [Rational(2014673, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b00000000 #b11110101111011101000100))))
(check-sat)
(exit)
