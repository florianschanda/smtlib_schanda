...
(assert (= z ((_ to_fp 8 24) #xCABBE5FB)))
;; z should be Float32(0xCABBE5FB [Rational(-12314107, 2), -6157053.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010101 #b01110111110010111111011))))
(check-sat)
(exit)
