...
(assert (= y (fp #b0 #b00000000 #b01010000011000111001100)))
;; y should be Float32(0x002831CC [Rational(658547, 178405961588244985132285746181186892047843328), 0.000000])
