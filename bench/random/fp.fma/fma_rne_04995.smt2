...
(assert (= z (fp #b1 #b10011111 #b00110110110010001011110)))
;; z should be Float32(0xCF9B645E [Rational(-5214092288), -5214092288.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #xCF9B645E)))
(check-sat)
(exit)
