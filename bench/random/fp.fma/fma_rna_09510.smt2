...
(assert (= x (fp #b0 #b11001010 #b00000111110110000010011)))
;; x should be Float32(0x6503EC13 [Rational(38936550621975356112896), 38936550621975356112896.000000])
...
(assert (not (= result (fp #b0 #b00110101 #b00000111110110000010011))))
(check-sat)
(exit)
