...
(assert (= z ((_ to_fp 8 24) #xB8144CEC)))
;; z should be Float32(0xB8144CEC [Rational(-2429755, 68719476736), -0.000035])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b01110000 #b00101000100110011101100)))
(check-sat)
(exit)
