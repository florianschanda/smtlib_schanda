...
(assert (= z (fp #b0 #b10010101 #b10111110010100010000001)))
;; z should be Float32(0x4ADF2881 [Rational(14624897, 2), 7312448.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010101 #b10111110010100010000001)))
(check-sat)
(exit)
