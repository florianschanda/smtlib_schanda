...
(assert (= z (fp #b1 #b11110100 #b10011010110100100101110)))
;; z should be Float32(0xFA4D692E [Rational(-266638538375874686350698877974216704), -266638538375874686350698877974216704.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #xFA4D692F)))
(check-sat)
(exit)
