...
(assert (= z (fp #b1 #b00010101 #b10100111100001001011110)))
;; z should be Float32(0x8AD3C25E [Rational(-6938927, 340282366920938463463374607431768211456), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b00010101 #b10100111100001001011110)))
(check-sat)
(exit)
