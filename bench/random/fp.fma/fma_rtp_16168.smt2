...
(assert (= z (fp #b1 #b00000000 #b01110011011100011110101)))
;; z should be Float32(0x8039B8F5 [Rational(-3782901, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b00000000 #b01110011011100011110101))))
(check-sat)
(exit)
