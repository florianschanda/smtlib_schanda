...
(assert (= y (fp #b0 #b10010100 #b01110101101110010101010)))
;; y should be Float32(0x4A3ADCAA [Rational(6123093, 2), 3061546.500000])
...
(assert (= result (fp #b1 #b00000001 #b01011101011011100101011)))
(check-sat)
(exit)
