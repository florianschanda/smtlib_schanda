...
(assert (= x ((_ to_fp 8 24) #x7FB4300F)))
...
(assert (= z (fp #b0 #b10100011 #b11110101001001100111100)))
;; z should be Float32(0x51FA933C [Rational(134526500864), 134526500864.000000])
