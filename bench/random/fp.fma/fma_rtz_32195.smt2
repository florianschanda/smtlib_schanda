...
(assert (= z (fp #b0 #b00000000 #b00101100000000000001110)))
;; z should be Float32(0x0016000E [Rational(720903, 356811923176489970264571492362373784095686656), 0.000000])
