...
(assert (= z (fp #b1 #b00000000 #b10010010000100011100101)))
;; z should be Float32(0x804908E5 [Rational(-4786405, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x804908E4))))
(check-sat)
(exit)
