...
(assert (= x (fp #b0 #b10010101 #b10010101111100101110001)))
;; x should be Float32(0x4ACAF971 [Rational(13302129, 2), 6651064.500000])
...
(assert (= result ((_ to_fp 8 24) #x0BCAF971)))
(check-sat)
(exit)
