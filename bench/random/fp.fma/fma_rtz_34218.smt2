...
(assert (= x ((_ to_fp 8 24) #xFFE358C6)))
...
(assert (= z ((_ to_fp 8 24) #x8023E332)))
;; z should be Float32(0x8023E332 [Rational(-1175961, 356811923176489970264571492362373784095686656), -0.000000])
