...
(assert (= z ((_ to_fp 8 24) #x0017363A)))
;; z should be Float32(0x0017363A [Rational(760605, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00000000 #b00101110011011000111010)))
(check-sat)
(exit)
