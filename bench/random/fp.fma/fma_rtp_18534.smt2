...
(assert (= z ((_ to_fp 8 24) #x0076F07A)))
;; z should be Float32(0x0076F07A [Rational(3897405, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b00000000 #b11101101111000001111010))))
(check-sat)
(exit)
