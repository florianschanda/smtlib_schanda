...
(assert (= x ((_ to_fp 8 24) #x73AA3043)))
;; x should be Float32(0x73AA3043 [Rational(26967447811852552268711932723200), 26967447811852552268711932723200.000000])
...
(assert (= result ((_ to_fp 8 24) #x292A3043)))
(check-sat)
(exit)
