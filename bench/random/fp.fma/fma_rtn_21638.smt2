...
(assert (= y (fp #b1 #b00000000 #b00101101001111101010110)))
;; y should be Float32(0x80169F56 [Rational(-741291, 356811923176489970264571492362373784095686656), -0.000000])
