...
(assert (= z (fp #b0 #b10010101 #b11010110101110000111001)))
;; z should be Float32(0x4AEB5C39 [Rational(15424569, 2), 7712284.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11010110101110000111001))))
(check-sat)
(exit)
