...
(assert (= x ((_ to_fp 8 24) #x00435AA3)))
;; x should be Float32(0x00435AA3 [Rational(4414115, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x4006B545)))
(check-sat)
(exit)
