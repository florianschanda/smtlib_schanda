...
(assert (= y ((_ to_fp 8 24) #x8042A0EF)))
;; y should be Float32(0x8042A0EF [Rational(-4366575, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x400541DD)))
(check-sat)
(exit)
