...
(assert (= y (fp #b1 #b11111001 #b00011010111100011010010)))
;; y should be Float32(0xFC8D78D2 [Rational(-5876515072959815132676546374431408128), -5876515072959815132676546374431408128.000000])
