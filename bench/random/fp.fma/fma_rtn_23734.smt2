...
(assert (= x (fp #b0 #b00000000 #b11111011001010000100100)))
;; x should be Float32(0x007D9424 [Rational(2057481, 178405961588244985132285746181186892047843328), 0.000000])
