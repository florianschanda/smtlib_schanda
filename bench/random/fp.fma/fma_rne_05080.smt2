...
(assert (= y (fp #b0 #b10010011 #b00110001110111001000100)))
;; y should be Float32(0x4998EE44 [Rational(2505617, 2), 1252808.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8A98EE44))))
(check-sat)
(exit)
