...
(assert (= x ((_ to_fp 8 24) #xEE5D84C3)))
;; x should be Float32(0xEE5D84C3 [Rational(-17139171560042637705013624832), -17139171560042637705013624832.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7FD01D93)))
