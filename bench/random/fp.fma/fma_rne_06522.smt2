...
(assert (= x (fp #b0 #b11111111 #b10111001000000001010101)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b10010011 #b01001011101100001010100)))
;; y should be Float32(0x49A5D854 [Rational(2717205, 2), 1358602.500000])
