...
(assert (= x (fp #b0 #b00000000 #b01000000101010111110001)))
;; x should be Float32(0x002055F1 [Rational(2119153, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7FF14A98)))
