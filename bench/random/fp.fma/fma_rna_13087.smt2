...
(assert (= x (fp #b1 #b00000000 #b11111011111110010110010)))
;; x should be Float32(0x807DFCB2 [Rational(-4128345, 356811923176489970264571492362373784095686656), -0.000000])
