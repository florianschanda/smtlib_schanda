...
(assert (= x ((_ to_fp 8 24) #x0057DE16)))
;; x should be Float32(0x0057DE16 [Rational(2879243, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= z (fp #b1 #b11111111 #b01010101100110111100101)))
