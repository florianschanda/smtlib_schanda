...
(assert (= y ((_ to_fp 8 24) #x62ABF9F2)))
;; y should be Float32(0x62ABF9F2 [Rational(1586201847232070680576), 1586201847232070680576.000000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b10111111000101011101100)))
