...
(assert (= x ((_ to_fp 8 24) #x190E85CD)))
;; x should be Float32(0x190E85CD [Rational(9340365, 1267650600228229401496703205376), 0.000000])
...
(assert (= result (fp #b1 #b10110010 #b00011101000010111001100)))
(check-sat)
(exit)
