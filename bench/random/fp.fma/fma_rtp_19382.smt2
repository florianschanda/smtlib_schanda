...
(assert (= z ((_ to_fp 8 24) #x4AF8347B)))
;; z should be Float32(0x4AF8347B [Rational(16266363, 2), 8133181.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11110000011010001111100))))
(check-sat)
(exit)
