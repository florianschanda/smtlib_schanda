...
(assert (= z (fp #b1 #b00000000 #b01001000111000100000000)))
;; z should be Float32(0x80247100 [Rational(-9329, 2787593149816327892691964784081045188247552), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x80247100)))
(check-sat)
(exit)
