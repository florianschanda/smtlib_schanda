...
(assert (= y ((_ to_fp 8 24) #xEC5494EB)))
;; y should be Float32(0xEC5494EB [Rational(-1027982075930493657095864320), -1027982075930493657095864320.000000])
...
(assert (= result ((_ to_fp 8 24) #x2D5494E9)))
(check-sat)
(exit)
