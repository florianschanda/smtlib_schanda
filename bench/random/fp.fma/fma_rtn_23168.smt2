...
(assert (= x (fp #b0 #b01101001 #b11010101101000010000001)))
;; x should be Float32(0x34EAD081 [Rational(15388801, 35184372088832), 0.000000])
...
(assert (not (= result (fp #b0 #b11101001 #b11010101101000010000000))))
(check-sat)
(exit)
