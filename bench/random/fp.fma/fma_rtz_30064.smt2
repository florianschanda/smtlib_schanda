...
(assert (= x (fp #b0 #b11000111 #b10000100100100011101101)))
;; x should be Float32(0x63C248ED [Rational(7167846413279728500736), 7167846413279728500736.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x24C248ED))))
(check-sat)
(exit)
