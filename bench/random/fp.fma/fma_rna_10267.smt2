...
(assert (= y (fp #b0 #b00000000 #b10011111100001110000110)))
;; y should be Float32(0x004FC386 [Rational(2613699, 356811923176489970264571492362373784095686656), 0.000000])
