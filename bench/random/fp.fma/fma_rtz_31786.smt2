...
(assert (= z ((_ to_fp 8 24) #x80471970)))
;; z should be Float32(0x80471970 [Rational(-291223, 44601490397061246283071436545296723011960832), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x80471970))))
(check-sat)
(exit)
