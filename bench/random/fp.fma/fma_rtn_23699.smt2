...
(assert (= x (fp #b0 #b00000000 #b11010001100101101110111)))
;; x should be Float32(0x0068CB77 [Rational(6867831, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b10100011001011011101110))))
(check-sat)
(exit)
