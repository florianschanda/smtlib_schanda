...
(assert (= x (fp #b1 #b00000000 #b10100100101100011101010)))
;; x should be Float32(0x805258EA [Rational(-2698357, 356811923176489970264571492362373784095686656), -0.000000])
