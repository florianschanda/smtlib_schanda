...
(assert (= x (fp #b1 #b11111111 #b11110011010111011010100)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x004A1250)))
;; y should be Float32(0x004A1250 [Rational(303397, 44601490397061246283071436545296723011960832), 0.000000])
