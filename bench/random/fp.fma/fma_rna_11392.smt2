...
(assert (= y (fp #b1 #b10010101 #b01111001111000101101111)))
;; y should be Float32(0xCABCF16F [Rational(-12382575, 2), -6191287.500000])

(declare-const z Float32)
(assert (= z (fp #b1 #b10010010 #b10110011001000011101000)))
;; z should be Float32(0xC95990E8 [Rational(-1782301, 2), -891150.500000])
