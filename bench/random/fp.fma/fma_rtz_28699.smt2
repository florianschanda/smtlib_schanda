...
(assert (= z (fp #b0 #b00000000 #b01011100100001000100000)))
;; z should be Float32(0x002E4220 [Rational(94737, 22300745198530623141535718272648361505980416), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b00000000 #b01011100100001000100000)))
(check-sat)
(exit)
