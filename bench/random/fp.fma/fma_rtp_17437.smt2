...
(assert (= x (fp #b1 #b10001111 #b01100001100011111000000)))
;; x should be Float32(0xC7B0C7C0 [Rational(-181023, 2), -90511.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x88B0C83F))))
(check-sat)
(exit)
