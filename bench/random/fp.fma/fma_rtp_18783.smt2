...
(assert (= z ((_ to_fp 8 24) #xCABF158D)))
;; z should be Float32(0xCABF158D [Rational(-12522893, 2), -6261446.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10010101 #b01111110001010110001101)))
(check-sat)
(exit)
