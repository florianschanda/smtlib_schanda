...
(assert (= x (fp #b0 #b00000000 #b10011011001100010010010)))
;; x should be Float32(0x004D9892 [Rational(2542665, 356811923176489970264571492362373784095686656), 0.000000])
