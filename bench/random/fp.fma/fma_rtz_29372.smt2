...
(assert (= z (fp #b1 #b00010100 #b00111011100011111110101)))
;; z should be Float32(0x8A1DC7F5 [Rational(-10340341, 1361129467683753853853498429727072845824), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b00010100 #b00111011100011111110100)))
(check-sat)
(exit)
