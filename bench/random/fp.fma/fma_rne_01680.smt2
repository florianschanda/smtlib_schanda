...
(assert (= z ((_ to_fp 8 24) #x630956DA)))
;; z should be Float32(0x630956DA [Rational(2533462252730393296896), 2533462252730393296896.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x630956DA)))
(check-sat)
(exit)
