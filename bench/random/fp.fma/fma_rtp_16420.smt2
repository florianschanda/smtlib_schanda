...
(assert (= x (fp #b0 #b11100011 #b10010001101100011100100)))
;; x should be Float32(0x71C8D8E4 [Rational(1989094612507643773625646972928), 1989094612507643773625646972928.000000])
