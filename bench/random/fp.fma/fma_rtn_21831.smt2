...
(assert (= y (fp #b0 #b00000000 #b11100010000110010101101)))
;; y should be Float32(0x00710CAD [Rational(7408813, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7F867237)))
