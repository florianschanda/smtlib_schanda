...
(assert (= x (fp #b0 #b00000000 #b11101001000010011100110)))
;; x should be Float32(0x007484E6 [Rational(3818099, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result (fp #b1 #b10000000 #b11010010000100111001011)))
(check-sat)
(exit)
