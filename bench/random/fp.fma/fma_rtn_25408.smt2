...
(assert (= y (fp #b0 #b11001110 #b00100001100001111001001)))
;; y should be Float32(0x6710C3C9 [Rational(683632372204003896852480), 683632372204003896852480.000000])
...
(assert (not (= result (fp #b1 #b01010000 #b00100001100001111001000))))
(check-sat)
(exit)
