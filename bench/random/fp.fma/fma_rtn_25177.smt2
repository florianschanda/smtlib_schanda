...
(assert (= z ((_ to_fp 8 24) #x4AE2A709)))
;; z should be Float32(0x4AE2A709 [Rational(14853897, 2), 7426948.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b11000101010011100010000)))
(check-sat)
(exit)
