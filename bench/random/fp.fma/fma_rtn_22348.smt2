...
(assert (= y (fp #b1 #b00000000 #b00011001001110011001010)))
;; y should be Float32(0x800C9CCA [Rational(-413285, 356811923176489970264571492362373784095686656), -0.000000])
