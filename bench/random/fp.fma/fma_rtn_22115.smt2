...
(assert (= z (fp #b1 #b00000000 #b10010100000100000110010)))
;; z should be Float32(0x804A0832 [Rational(-2425881, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x804A0832))))
(check-sat)
(exit)
