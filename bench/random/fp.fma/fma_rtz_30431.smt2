...
(assert (= x (fp #b0 #b00000000 #b11010000011001111000101)))
;; x should be Float32(0x006833C5 [Rational(6828997, 713623846352979940529142984724747568191373312), 0.000000])
