...
(assert (= z ((_ to_fp 8 24) #x005C3ED4)))
;; z should be Float32(0x005C3ED4 [Rational(1511349, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x005C3ED4))))
(check-sat)
(exit)
