...
(assert (= z (fp #b0 #b10010011 #b01011101100101011101100)))
;; z should be Float32(0x49AECAEC [Rational(2863803, 2), 1431901.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010011 #b01011101100101011101100))))
(check-sat)
(exit)
