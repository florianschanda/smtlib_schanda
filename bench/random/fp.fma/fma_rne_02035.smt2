...
(assert (= z (fp #b0 #b10010101 #b00000011000110111101011)))
;; z should be Float32(0x4A818DEB [Rational(8490475, 2), 4245237.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10010101 #b00000011000110111100011)))
(check-sat)
(exit)
