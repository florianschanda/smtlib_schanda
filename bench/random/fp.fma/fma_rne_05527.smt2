...
(assert (= z ((_ to_fp 8 24) #xC8A5FE29)))
;; z should be Float32(0xC8A5FE29 [Rational(-10878505, 32), -339953.281250])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010001 #b01001011111111000101001))))
(check-sat)
(exit)
