...
(assert (= z ((_ to_fp 8 24) #x0033DFE0)))
;; z should be Float32(0x0033DFE0 [Rational(106239, 22300745198530623141535718272648361505980416), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x0033DFE0))))
(check-sat)
(exit)
