...
(assert (= y (fp #b0 #b00000000 #b10100011001000011111101)))
;; y should be Float32(0x005190FD [Rational(5345533, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b0 #b10000000 #b01000110010000111111001))))
(check-sat)
(exit)
