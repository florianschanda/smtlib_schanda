...
(assert (= y ((_ to_fp 8 24) #x69306440)))
;; y should be Float32(0x69306440 [Rational(13327772593255151042560000), 13327772593255151042560000.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xAA306440))))
(check-sat)
(exit)
