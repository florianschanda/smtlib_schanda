...
(assert (= x ((_ to_fp 8 24) #x4AEC4B97)))
;; x should be Float32(0x4AEC4B97 [Rational(15485847, 2), 7742923.500000])
...
(assert (= result (fp #b1 #b00010111 #b11011000100101110011000)))
(check-sat)
(exit)
