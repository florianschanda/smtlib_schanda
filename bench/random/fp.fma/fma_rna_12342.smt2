...
(assert (= z (fp #b1 #b10010101 #b00001010100000101110001)))
;; z should be Float32(0xCA854171 [Rational(-8733041, 2), -4366520.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b10010101 #b00001010100000101110001)))
(check-sat)
(exit)
