...
(assert (= x ((_ to_fp 8 24) #xA356A45A)))
;; x should be Float32(0xA356A45A [Rational(-7033389, 604462909807314587353088), -0.000000])
...
(assert (not (= result (fp #b0 #b11000110 #b10101101010010001011001))))
(check-sat)
(exit)
