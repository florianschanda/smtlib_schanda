...
(assert (= z ((_ to_fp 8 24) #x15C1E589)))
;; z should be Float32(0x15C1E589 [Rational(12707209, 162259276829213363391578010288128), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x15C1E589)))
(check-sat)
(exit)
