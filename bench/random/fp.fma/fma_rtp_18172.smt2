...
(assert (= z ((_ to_fp 8 24) #x5CABFAFE)))
;; z should be Float32(0x5CABFAFE [Rational(387265518769274880), 387265518769274880.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10111001 #b01010111111101011111110))))
(check-sat)
(exit)
