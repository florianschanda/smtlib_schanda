...
(assert (= x (fp #b1 #b00000000 #b00010010001011110001101)))
;; x should be Float32(0x8009178D [Rational(-595853, 713623846352979940529142984724747568191373312), -0.000000])
