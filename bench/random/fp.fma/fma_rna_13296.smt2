...
(assert (= x (fp #b1 #b00000000 #b10110011110111110100100)))
;; x should be Float32(0x8059EFA4 [Rational(-1473513, 178405961588244985132285746181186892047843328), -0.000000])
