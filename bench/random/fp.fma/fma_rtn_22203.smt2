...
(assert (= z (fp #b1 #b10010100 #b11000001010000000000010)))
;; z should be Float32(0xCA60A002 [Rational(-7360513, 2), -3680256.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA60A002))))
(check-sat)
(exit)
