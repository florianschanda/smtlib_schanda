...
(assert (= x (fp #b1 #b01101101 #b00000001001111100010001)))
;; x should be Float32(0xB6809F11 [Rational(-8429329, 2199023255552), -0.000004])
...
(assert (= z ((_ to_fp 8 24) #xFFAB1304)))
