...
(assert (= z (fp #b0 #b00000000 #b11111100000010101110001)))
;; z should be Float32(0x007E0571 [Rational(8258929, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x007E0571)))
(check-sat)
(exit)
