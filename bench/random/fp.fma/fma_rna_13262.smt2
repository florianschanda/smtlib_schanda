...
(assert (= x ((_ to_fp 8 24) #x802D8735)))
;; x should be Float32(0x802D8735 [Rational(-2983733, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #xFFC422C5)))
