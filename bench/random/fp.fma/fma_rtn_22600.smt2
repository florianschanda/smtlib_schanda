...
(assert (= z (fp #b0 #b00000000 #b11101001101001011110011)))
;; z should be Float32(0x0074D2F3 [Rational(7656179, 713623846352979940529142984724747568191373312), 0.000000])
