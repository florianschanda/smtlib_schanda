...
(assert (= y ((_ to_fp 8 24) #x8ECEEE70)))
;; y should be Float32(0x8ECEEE70 [Rational(-847591, 166153499473114484112975882535043072), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xCECEEE6F)))
(check-sat)
(exit)
