...
(assert (= x ((_ to_fp 8 24) #x8046FB8B)))
;; x should be Float32(0x8046FB8B [Rational(-4651915, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC00DF715)))
(check-sat)
(exit)
