...
(assert (= x (fp #b0 #b00000000 #b00001101100111011010011)))
;; x should be Float32(0x0006CED3 [Rational(446163, 713623846352979940529142984724747568191373312), 0.000000])
