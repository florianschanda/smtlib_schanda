...
(assert (= z ((_ to_fp 8 24) #x0BFCDF21)))
;; z should be Float32(0x0BFCDF21 [Rational(16572193, 170141183460469231731687303715884105728), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x0BFCDF21))))
(check-sat)
(exit)
