...
(assert (= z ((_ to_fp 8 24) #x8039D1E7)))
;; z should be Float32(0x8039D1E7 [Rational(-3789287, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b00000000 #b01110011101000111100110))))
(check-sat)
(exit)
