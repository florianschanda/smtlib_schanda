...
(assert (= z ((_ to_fp 8 24) #xCAF5530F)))
;; z should be Float32(0xCAF5530F [Rational(-16077583, 2), -8038791.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10010101 #b11101010101001100001000)))
(check-sat)
(exit)
