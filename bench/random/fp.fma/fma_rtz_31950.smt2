...
(assert (= z (fp #b1 #b10010100 #b01001010001011010011110)))
;; z should be Float32(0xCA25169E [Rational(-5409615, 2), -2704807.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010100 #b01001010001011010011110))))
(check-sat)
(exit)
