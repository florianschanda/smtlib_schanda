...
(assert (= y (fp #b0 #b00000000 #b01010001101111000100001)))
;; y should be Float32(0x0028DE21 [Rational(2678305, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b01001000010000011010011)))
