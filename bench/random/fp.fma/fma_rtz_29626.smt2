...
(assert (= y (fp #b0 #b10010011 #b01001111000110111101100)))
;; y should be Float32(0x49A78DEC [Rational(2745211, 2), 1372605.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0094F1BC))))
(check-sat)
(exit)
