...
(assert (= x (fp #b0 #b11010000 #b10001011001101100011110)))
;; x should be Float32(0x68459B1E [Rational(3732670416738264901746688), 3732670416738264901746688.000000])
...
(assert (= result ((_ to_fp 8 24) #xA9459B1C)))
(check-sat)
(exit)
