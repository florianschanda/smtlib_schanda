...
(assert (= x ((_ to_fp 8 24) #xE19B4AF5)))
;; x should be Float32(0xE19B4AF5 [Rational(-358080819344135159808), -358080819344135159808.000000])
...
(assert (not (= result (fp #b1 #b01000101 #b00110110100101011110101))))
(check-sat)
(exit)
