...
(assert (= z ((_ to_fp 8 24) #x801A829E)))
;; z should be Float32(0x801A829E [Rational(-868687, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x801A829E)))
(check-sat)
(exit)
