...
(assert (= z ((_ to_fp 8 24) #x005D661B)))
;; z should be Float32(0x005D661B [Rational(6120987, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b00000000 #b10111010110011000011010))))
(check-sat)
(exit)
