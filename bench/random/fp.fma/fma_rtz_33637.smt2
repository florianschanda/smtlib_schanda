...
(assert (= x (fp #b1 #b00000000 #b00100010000110001110111)))
;; x should be Float32(0x80110C77 [Rational(-1117303, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result (fp #b1 #b01111110 #b00010000110001110110111))))
(check-sat)
(exit)
