...
(assert (= z ((_ to_fp 8 24) #x497E9B08)))
;; z should be Float32(0x497E9B08 [Rational(2085729, 2), 1042864.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010010 #b11111101001101100001000))))
(check-sat)
(exit)
