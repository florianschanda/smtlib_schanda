...
(assert (= y (fp #b0 #b11111010 #b01011001010111011000010)))
;; y should be Float32(0x7D2CAEC2 [Rational(14345913107240856160680085406015815680), 14345913107240856160680085406015815680.000000])
...
(assert (= result ((_ to_fp 8 24) #x3E2CAEC1)))
(check-sat)
(exit)
