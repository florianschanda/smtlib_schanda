...
(assert (= x (fp #b1 #b10010011 #b01101111101000011000100)))
;; x should be Float32(0xC9B7D0C4 [Rational(-3011633, 2), -1505816.500000])
...
(assert (= result (fp #b1 #b00010101 #b01101111101000011001011)))
(check-sat)
(exit)
