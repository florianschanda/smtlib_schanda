...
(assert (= y (fp #b1 #b11111111 #b01010001001000011100101)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xAD1DA529)))
;; z should be Float32(0xAD1DA529 [Rational(-10331433, 1152921504606846976), -0.000000])
