...
(assert (= y ((_ to_fp 8 24) #xCAF2696F)))
;; y should be Float32(0xCAF2696F [Rational(-15886703, 2), -7943351.500000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x002B27C9)))
;; z should be Float32(0x002B27C9 [Rational(2828233, 713623846352979940529142984724747568191373312), 0.000000])
