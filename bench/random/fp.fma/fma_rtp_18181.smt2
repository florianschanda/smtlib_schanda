...
(assert (= z (fp #b1 #b10111001 #b00101111010010111001011)))
;; z should be Float32(0xDC97A5CB [Rational(-341480102242025472), -341480102242025472.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xDC97A5CB))))
(check-sat)
(exit)
