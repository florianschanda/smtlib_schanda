...
(assert (= y ((_ to_fp 8 24) #x3FAC90B3)))
;; y should be Float32(0x3FAC90B3 [Rational(11309235, 8388608), 1.348166])
...
(assert (not (= result (fp #b1 #b00000001 #b01011001001000010110010))))
(check-sat)
(exit)
