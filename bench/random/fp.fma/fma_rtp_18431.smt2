...
(assert (= y (fp #b0 #b10010101 #b01101001001101011001001)))
;; y should be Float32(0x4AB49AC9 [Rational(11836105, 2), 5918052.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b01101001001101011000111))))
(check-sat)
(exit)
