...
(assert (= y (fp #b0 #b10010011 #b00101101110011011000100)))
;; y should be Float32(0x4996E6C4 [Rational(2472369, 2), 1236184.500000])
...
(assert (= result (fp #b0 #b00010101 #b00101101110011011001100)))
(check-sat)
(exit)
