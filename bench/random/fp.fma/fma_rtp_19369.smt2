...
(assert (= z ((_ to_fp 8 24) #x7D941C9F)))
;; z should be Float32(0x7D941C9F [Rational(24609294073916688122369963303957954560), 24609294073916688122369963303957954560.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x7D941CA0)))
(check-sat)
(exit)
