...
(assert (= x ((_ to_fp 8 24) #x96107BCF)))
;; x should be Float32(0x96107BCF [Rational(-9468879, 81129638414606681695789005144064), -0.000000])
...
(assert (= result (fp #b0 #b10101100 #b00100000111101111001110)))
(check-sat)
(exit)
