...
(assert (= z ((_ to_fp 8 24) #x804D8E8C)))
;; z should be Float32(0x804D8E8C [Rational(-1270691, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x804D8E8C))))
(check-sat)
(exit)
