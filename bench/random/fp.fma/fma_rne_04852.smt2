...
(assert (= y (fp #b0 #b00000000 #b11001100001110001111010)))
;; y should be Float32(0x00661C7A [Rational(3345981, 356811923176489970264571492362373784095686656), 0.000000])
