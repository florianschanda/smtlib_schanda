...
(assert (= x ((_ to_fp 8 24) #xFA273B24)))
;; x should be Float32(0xFA273B24 [Rational(-217078272438945544008939785596960768), -217078272438945544008939785596960768.000000])
...
(assert (not (= result (fp #b0 #b01110110 #b01001110011101100100100))))
(check-sat)
(exit)
