...
(assert (= z (fp #b1 #b11000001 #b11110001001010110000011)))
;; z should be Float32(0xE0F89583 [Rational(-143298937031674036224), -143298937031674036224.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xE0F89583))))
(check-sat)
(exit)
