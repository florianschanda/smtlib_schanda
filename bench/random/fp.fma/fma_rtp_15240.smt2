...
(assert (= z (fp #b0 #b10010101 #b01101110110110011111101)))
;; z should be Float32(0x4AB76CFD [Rational(12020989, 2), 6010494.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010101 #b01101110110110011111110))))
(check-sat)
(exit)
