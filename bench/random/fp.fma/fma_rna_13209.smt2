...
(assert (= x (fp #b1 #b00000000 #b10000100000000110100010)))
;; x should be Float32(0x804201A2 [Rational(-2162897, 356811923176489970264571492362373784095686656), -0.000000])
