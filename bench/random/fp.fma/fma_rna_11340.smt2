...
(assert (= y (fp #b0 #b11110100 #b11111000001001010100010)))
;; y should be Float32(0x7A7C12A2 [Rational(327209181671492400820001569901641728), 327209181671492400820001569901641728.000000])
