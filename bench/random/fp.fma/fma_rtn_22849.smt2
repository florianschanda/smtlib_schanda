...
(assert (= z (fp #b1 #b10010101 #b10001000011000111000011)))
;; z should be Float32(0xCAC431C3 [Rational(-12857795, 2), -6428897.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10010101 #b10001000011000111000011))))
(check-sat)
(exit)
