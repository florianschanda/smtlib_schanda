...
(assert (= z (fp #b0 #b11000010 #b01100110110011101010000)))
;; z should be Float32(0x61336750 [Rational(206838227461128323072), 206838227461128323072.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x6133674F)))
(check-sat)
(exit)
