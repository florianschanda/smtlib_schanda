...
(assert (= z ((_ to_fp 8 24) #x49021848)))
;; z should be Float32(0x49021848 [Rational(1065737, 2), 532868.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010010 #b00000100001100001001000))))
(check-sat)
(exit)
