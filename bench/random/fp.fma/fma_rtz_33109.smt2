...
(assert (= z (fp #b1 #b10010101 #b10011010111101110010001)))
;; z should be Float32(0xCACD7B91 [Rational(-13466513, 2), -6733256.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010101 #b10011010111101110010000)))
(check-sat)
(exit)
