...
(assert (= y (fp #b1 #b00000000 #b00000111010010111010010)))
;; y should be Float32(0x8003A5D2 [Rational(-119529, 356811923176489970264571492362373784095686656), -0.000000])
