...
(assert (= z ((_ to_fp 8 24) #x00435482)))
;; z should be Float32(0x00435482 [Rational(2206273, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00000000 #b10000110101010010000010)))
(check-sat)
(exit)
