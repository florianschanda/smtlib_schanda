...
(assert (= x (fp #b0 #b10010011 #b11011010100001110110100)))
;; x should be Float32(0x49ED43B4 [Rational(3887341, 2), 1943670.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0AED43BA))))
(check-sat)
(exit)
