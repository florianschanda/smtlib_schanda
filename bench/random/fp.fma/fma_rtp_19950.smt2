...
(assert (= x ((_ to_fp 8 24) #x80331D25)))
;; x should be Float32(0x80331D25 [Rational(-3349797, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= z (fp #b0 #b11111111 #b10010100110011100000111)))
