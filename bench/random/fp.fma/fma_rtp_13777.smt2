...
(assert (= z ((_ to_fp 8 24) #x4AC35335)))
;; z should be Float32(0x4AC35335 [Rational(12800821, 2), 6400410.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010101 #b10000110101001100110101))))
(check-sat)
(exit)
