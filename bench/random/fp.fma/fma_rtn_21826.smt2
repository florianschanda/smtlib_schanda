...
(assert (= y (fp #b0 #b00000000 #b00010000110100000100010)))
;; y should be Float32(0x00086822 [Rational(275473, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result (fp #b0 #b01111101 #b00001101000001000011111)))
(check-sat)
(exit)
