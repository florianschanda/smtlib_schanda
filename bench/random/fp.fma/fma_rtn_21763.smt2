...
(assert (= z ((_ to_fp 8 24) #x673ED310)))
;; z should be Float32(0x673ED310 [Rational(901143047666289912840192), 901143047666289912840192.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b11001110 #b01111101101001100010000)))
(check-sat)
(exit)
