...
(assert (= y ((_ to_fp 8 24) #xF08BF52E)))
;; y should be Float32(0xF08BF52E [Rational(-346518563358646085633819279360), -346518563358646085633819279360.000000])
...
(assert (= result (fp #b1 #b01100011 #b00010111111010100101100)))
(check-sat)
(exit)
