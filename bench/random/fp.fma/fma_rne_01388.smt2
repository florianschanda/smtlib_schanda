...
(assert (= y (fp #b1 #b00011100 #b11101110100111010111100)))
;; y should be Float32(0x8E774EBC [Rational(-4051887, 1329227995784915872903807060280344576), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xCE774EBB)))
(check-sat)
(exit)
