...
(assert (= z (fp #b0 #b01101111 #b00101110111101000011011)))
;; z should be Float32(0x37977A1B [Rational(9927195, 549755813888), 0.000018])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b01101111 #b00101110111101000011011)))
(check-sat)
(exit)
