...
(assert (= z (fp #b0 #b10010101 #b00101101110001101111111)))
;; z should be Float32(0x4A96E37F [Rational(9888639, 2), 4944319.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10010101 #b00101101110001101111111)))
(check-sat)
(exit)
