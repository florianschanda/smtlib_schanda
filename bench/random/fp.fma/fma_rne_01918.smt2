...
(assert (= z (fp #b1 #b00000000 #b01001010000011100100110)))
;; z should be Float32(0x80250726 [Rational(-1213331, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b00000000 #b01001010000011100100110))))
(check-sat)
(exit)
