...
(assert (= z (fp #b0 #b10010100 #b00101100100100010110010)))
;; z should be Float32(0x4A1648B2 [Rational(4924505, 2), 2462252.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010100 #b00101100100100011000010))))
(check-sat)
(exit)
