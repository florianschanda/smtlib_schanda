...
(assert (= z (fp #b1 #b11001110 #b00001100001110111111000)))
;; z should be Float32(0xE7061DF8 [Rational(-633349934565991441760256), -633349934565991441760256.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #xE7061DF8)))
(check-sat)
(exit)
