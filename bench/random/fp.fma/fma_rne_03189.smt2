...
(assert (= x (fp #b0 #b00000000 #b11001001011101011111011)))
;; x should be Float32(0x0064BAFB [Rational(6601467, 713623846352979940529142984724747568191373312), 0.000000])
