...
(assert (= x (fp #b0 #b00000000 #b00101111001100101001101)))
;; x should be Float32(0x0017994D [Rational(1546573, 713623846352979940529142984724747568191373312), 0.000000])
