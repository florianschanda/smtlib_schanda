...
(assert (= x (fp #b1 #b00000000 #b01110000110111111010011)))
;; x should be Float32(0x80386FD3 [Rational(-3698643, 713623846352979940529142984724747568191373312), -0.000000])
