...
(assert (= z (fp #b0 #b00000000 #b00011110000100110100110)))
;; z should be Float32(0x000F09A6 [Rational(492755, 356811923176489970264571492362373784095686656), 0.000000])
