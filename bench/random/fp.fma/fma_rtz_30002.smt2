...
(assert (= x ((_ to_fp 8 24) #x7F720A5D)))
;; x should be Float32(0x7F720A5D [Rational(321726984212628129124356040645505187840), 321726984212628129124356040645505187840.000000])
