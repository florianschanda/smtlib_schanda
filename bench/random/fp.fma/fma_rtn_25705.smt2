...
(assert (= z (fp #b1 #b11101010 #b00110000101100011100001)))
;; z should be Float32(0xF51858E1 [Rational(-193122998261469935549292321177600), -193122998261469935549292321177600.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #xF51858E2)))
(check-sat)
(exit)
