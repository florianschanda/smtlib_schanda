...
(assert (= y (fp #b1 #b10010101 #b00010001001110101010111)))
;; y should be Float32(0xCA889D57 [Rational(-8953175, 2), -4476587.500000])
...
(assert (= result (fp #b1 #b00010111 #b00010001001110101010100)))
(check-sat)
(exit)
