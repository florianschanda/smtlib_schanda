...
(assert (= z ((_ to_fp 8 24) #x4AAF7475)))
;; z should be Float32(0x4AAF7475 [Rational(11498613, 2), 5749306.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010101 #b01011110111010001101110))))
(check-sat)
(exit)
