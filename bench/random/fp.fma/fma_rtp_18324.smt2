...
(assert (= z (fp #b0 #b11111110 #b11110000011000011001101)))
;; z should be Float32(0x7F7830CD [Rational(329901931097837556798750523959841652736), 329901931097837556798750523959841652736.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x7F7830CE)))
(check-sat)
(exit)
