...
(assert (= x ((_ to_fp 8 24) #xDA39A0D0)))
;; x should be Float32(0xDA39A0D0 [Rational(-13062421476278272), -13062421476278272.000000])
...
(assert (not (= result (fp #b1 #b00110110 #b01110011010000011010000))))
(check-sat)
(exit)
