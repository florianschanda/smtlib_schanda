...
(assert (= z (fp #b1 #b10010010 #b11111100101110101011000)))
;; z should be Float32(0xC97E5D58 [Rational(-2083755, 2), -1041877.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010010 #b11111100101110101010111))))
(check-sat)
(exit)
