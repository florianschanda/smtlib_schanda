...
(assert (= x (fp #b0 #b10010101 #b01000100101000110011101)))
;; x should be Float32(0x4AA2519D [Rational(10637725, 2), 5318862.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BA2519C))))
(check-sat)
(exit)
