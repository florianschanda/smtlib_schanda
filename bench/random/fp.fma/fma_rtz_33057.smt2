...
(assert (= y ((_ to_fp 8 24) #xCAA9C3AD)))
;; y should be Float32(0xCAA9C3AD [Rational(-11125677, 2), -5562838.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b10101001110000111010101))))
(check-sat)
(exit)
