...
(assert (= x (fp #b1 #b00000000 #b00111101001010001100110)))
;; x should be Float32(0x801E9466 [Rational(-1002035, 356811923176489970264571492362373784095686656), -0.000000])
