...
(assert (= z (fp #b1 #b10010101 #b01000110101111011000101)))
;; z should be Float32(0xCAA35EC5 [Rational(-10706629, 2), -5353314.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #xCAA35EC4)))
(check-sat)
(exit)
