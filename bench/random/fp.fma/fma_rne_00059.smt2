...
(assert (= z ((_ to_fp 8 24) #x4AFCAD6F)))
;; z should be Float32(0x4AFCAD6F [Rational(16559471, 2), 8279735.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11111001010110101101111))))
(check-sat)
(exit)
