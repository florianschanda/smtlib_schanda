...
(assert (= y ((_ to_fp 8 24) #x85630A33)))
;; y should be Float32(0x85630A33 [Rational(-14879283, 1393796574908163946345982392040522594123776), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC5630A32)))
(check-sat)
(exit)
