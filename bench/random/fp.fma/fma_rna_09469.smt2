...
(assert (= x (fp #b0 #b10011101 #b10001100100000011100101)))
;; x should be Float32(0x4EC640E5 [Rational(1663070848), 1663070848.000000])
...
(assert (= result ((_ to_fp 8 24) #x0FC640E3)))
(check-sat)
(exit)
