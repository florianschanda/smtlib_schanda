...
(assert (= y (fp #b0 #b11011001 #b00001100110011011111000)))
;; y should be Float32(0x6C8666F8 [Rational(1299858528017146345529802752), 1299858528017146345529802752.000000])
...
(assert (= result (fp #b1 #b01011011 #b00001100110011011111000)))
(check-sat)
(exit)
