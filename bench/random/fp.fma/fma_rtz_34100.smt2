...
(assert (= y (fp #b0 #b00000000 #b10011001010001100101010)))
;; y should be Float32(0x004CA32A [Rational(2511253, 356811923176489970264571492362373784095686656), 0.000000])
