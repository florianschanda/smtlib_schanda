...
(assert (= x (fp #b0 #b11100011 #b11001101101010101011111)))
;; x should be Float32(0x71E6D55F [Rational(2286064066665700941990635503616), 2286064066665700941990635503616.000000])
