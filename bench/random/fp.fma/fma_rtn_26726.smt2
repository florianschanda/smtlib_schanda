...
(assert (= x (fp #b1 #b00000000 #b11101100011101001100100)))
;; x should be Float32(0x80763A64 [Rational(-1937049, 178405961588244985132285746181186892047843328), -0.000000])
