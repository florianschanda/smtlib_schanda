...
(assert (= y (fp #b0 #b10000111 #b00000000000101001100010)))
;; y should be Float32(0x43800A62 [Rational(4195633, 16384), 256.081116])
...
(assert (not (= result ((_ to_fp 8 24) #x847F14C2))))
(check-sat)
(exit)
