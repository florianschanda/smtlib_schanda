...
(assert (= x (fp #b1 #b00000000 #b11011010000110011001110)))
;; x should be Float32(0x806D0CCE [Rational(-3573351, 356811923176489970264571492362373784095686656), -0.000000])
