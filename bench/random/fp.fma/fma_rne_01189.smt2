...
(assert (= z ((_ to_fp 8 24) #xC9A0803C)))
;; z should be Float32(0xC9A0803C [Rational(-2629647, 2), -1314823.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010011 #b01000001000000000011100))))
(check-sat)
(exit)
