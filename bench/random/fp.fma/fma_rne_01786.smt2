...
(assert (= y (fp #b1 #b00000000 #b10100000011011011110110)))
;; y should be Float32(0x805036F6 [Rational(-2628475, 356811923176489970264571492362373784095686656), -0.000000])
