...
(assert (= z (fp #b1 #b00000000 #b11111000110110100101101)))
;; z should be Float32(0x807C6D2D [Rational(-8154413, 713623846352979940529142984724747568191373312), -0.000000])
