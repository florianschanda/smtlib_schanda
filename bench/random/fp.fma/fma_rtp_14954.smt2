...
(assert (= y ((_ to_fp 8 24) #x000D39E9)))
;; y should be Float32(0x000D39E9 [Rational(866793, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result (fp #b0 #b01111101 #b10100111001111010010000)))
(check-sat)
(exit)
