...
(assert (= z ((_ to_fp 8 24) #x4A3EBAF2)))
;; z should be Float32(0x4A3EBAF2 [Rational(6249849, 2), 3124924.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10010100 #b01111101011101011110010))))
(check-sat)
(exit)
