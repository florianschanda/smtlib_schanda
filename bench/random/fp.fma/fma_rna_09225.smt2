...
(assert (= y (fp #b1 #b10010101 #b11110010011000000101001)))
;; y should be Float32(0xCAF93029 [Rational(-16330793, 2), -8165396.500000])
...
(assert (= result (fp #b1 #b00000000 #b11111001001100000010101)))
(check-sat)
(exit)
