...
(assert (= x ((_ to_fp 8 24) #xFF91C279)))
...
(assert (= z (fp #b1 #b00000000 #b00101011101111100011001)))
;; z should be Float32(0x8015DF19 [Rational(-1433369, 713623846352979940529142984724747568191373312), -0.000000])
