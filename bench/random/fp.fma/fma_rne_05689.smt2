...
(assert (= z ((_ to_fp 8 24) #x13B0FDBE)))
;; z should be Float32(0x13B0FDBE [Rational(5799647, 1298074214633706907132624082305024), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b00100111 #b01100001111110110111110)))
(check-sat)
(exit)
