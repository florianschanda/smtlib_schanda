...
(assert (= z (fp #b1 #b00000000 #b01001111000010111100110)))
;; z should be Float32(0x802785E6 [Rational(-1295091, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x802785E6))))
(check-sat)
(exit)
