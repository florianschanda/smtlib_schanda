...
(assert (= z ((_ to_fp 8 24) #x35058D76)))
;; z should be Float32(0x35058D76 [Rational(4376251, 8796093022208), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b01101010 #b00001011000110101110110))))
(check-sat)
(exit)
