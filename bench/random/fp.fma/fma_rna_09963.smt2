...
(assert (= x (fp #b0 #b00000000 #b00100111111100001011111)))
;; x should be Float32(0x0013F85F [Rational(1308767, 713623846352979940529142984724747568191373312), 0.000000])
