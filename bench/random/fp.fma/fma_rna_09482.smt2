...
(assert (= x ((_ to_fp 8 24) #x638D8FBD)))
;; x should be Float32(0x638D8FBD [Rational(5222696698222137573376), 5222696698222137573376.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x248D8FBD))))
(check-sat)
(exit)
