...
(assert (= z (fp #b0 #b01001000 #b10101001010100010000101)))
;; z should be Float32(0x2454A885 [Rational(13936773, 302231454903657293676544), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b01001000 #b10101001010100010000101))))
(check-sat)
(exit)
