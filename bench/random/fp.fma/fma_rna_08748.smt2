...
(assert (= z (fp #b0 #b11011010 #b01111001010000110101100)))
;; z should be Float32(0x6D3CA1AC [Rational(3648664446900367612272705536), 3648664446900367612272705536.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x6D3CA1AC))))
(check-sat)
(exit)
