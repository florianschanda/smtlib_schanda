...
(assert (= x ((_ to_fp 8 24) #xA687DDAE)))
;; x should be Float32(0xA687DDAE [Rational(-4452055, 4722366482869645213696), -0.000000])
...
(assert (= result (fp #b0 #b11001101 #b00001111101110110101101)))
(check-sat)
(exit)
