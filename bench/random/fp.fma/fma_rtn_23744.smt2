...
(assert (= x (fp #b0 #b00000000 #b11100100010110110101011)))
;; x should be Float32(0x00722DAB [Rational(7482795, 713623846352979940529142984724747568191373312), 0.000000])
