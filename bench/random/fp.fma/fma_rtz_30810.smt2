...
(assert (= z (fp #b1 #b10010011 #b01010000011110100000100)))
;; z should be Float32(0xC9A83D04 [Rational(-2756417, 2), -1378208.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xC9A83D04))))
(check-sat)
(exit)
