...
(assert (= z ((_ to_fp 8 24) #x8008766C)))
;; z should be Float32(0x8008766C [Rational(-138651, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x8008766C))))
(check-sat)
(exit)
