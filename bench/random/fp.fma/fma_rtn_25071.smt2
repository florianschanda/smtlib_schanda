...
(assert (= y ((_ to_fp 8 24) #x005F13CD)))
;; y should be Float32(0x005F13CD [Rational(6230989, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b01111100010011110011010))))
(check-sat)
(exit)
