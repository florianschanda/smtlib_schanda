...
(assert (= y (fp #b0 #b00100001 #b00000010011101010010011)))
;; y should be Float32(0x10813A93 [Rational(8469139, 166153499473114484112975882535043072), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xD0813A92)))
(check-sat)
(exit)
