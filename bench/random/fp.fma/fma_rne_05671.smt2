...
(assert (= z ((_ to_fp 8 24) #x0043B749)))
;; z should be Float32(0x0043B749 [Rational(4437833, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b00000000 #b10000111011011101001001)))
(check-sat)
(exit)
