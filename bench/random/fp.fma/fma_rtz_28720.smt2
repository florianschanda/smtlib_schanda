...
(assert (= y ((_ to_fp 8 24) #xCA7329DE)))
;; y should be Float32(0xCA7329DE [Rational(-7967983, 2), -3983991.500000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xCAF6CD3B)))
;; z should be Float32(0xCAF6CD3B [Rational(-16174395, 2), -8087197.500000])
