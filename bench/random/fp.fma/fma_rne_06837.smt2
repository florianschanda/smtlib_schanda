...
(assert (= x (fp #b1 #b11111111 #b01100011101110100010001)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x80499B68)))
;; y should be Float32(0x80499B68 [Rational(-602989, 89202980794122492566142873090593446023921664), -0.000000])
