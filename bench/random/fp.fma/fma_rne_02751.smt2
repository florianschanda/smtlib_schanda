...
(assert (= x ((_ to_fp 8 24) #x7AFBB63A)))
;; x should be Float32(0x7AFBB63A [Rational(653481252636766083054946701958709248), 653481252636766083054946701958709248.000000])
