...
(assert (= x ((_ to_fp 8 24) #xCAF00725)))
;; x should be Float32(0xCAF00725 [Rational(-15730469, 2), -7865234.500000])

(declare-const y Float32)
(assert (= y (fp #b1 #b10010101 #b11111111101101011001101)))
;; y should be Float32(0xCAFFDACD [Rational(-16767693, 2), -8383846.500000])
