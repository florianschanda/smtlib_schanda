...
(assert (= z ((_ to_fp 8 24) #x660444D8)))
;; z should be Float32(0x660444D8 [Rational(156155579694029402537984), 156155579694029402537984.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x660444D8)))
(check-sat)
(exit)
