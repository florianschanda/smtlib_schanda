...
(assert (= x (fp #b0 #b00000000 #b00001100101010001000100)))
;; x should be Float32(0x00065444 [Rational(103697, 178405961588244985132285746181186892047843328), 0.000000])
