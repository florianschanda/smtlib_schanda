...
(assert (= y (fp #b1 #b00000000 #b00001110011101000111101)))
;; y should be Float32(0x80073A3D [Rational(-473661, 713623846352979940529142984724747568191373312), -0.000000])
