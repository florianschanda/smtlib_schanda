...
(assert (= z ((_ to_fp 8 24) #x0019520D)))
;; z should be Float32(0x0019520D [Rational(1659405, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x0019520D)))
(check-sat)
(exit)
