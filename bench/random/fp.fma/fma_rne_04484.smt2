...
(assert (= y (fp #b0 #b00101111 #b10010001110011100011000)))
;; y should be Float32(0x17C8E718 [Rational(1645795, 1267650600228229401496703205376), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFF82C2BB)))
