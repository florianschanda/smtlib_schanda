...
(assert (= x (fp #b0 #b00000000 #b00001000111110000110111)))
;; x should be Float32(0x00047C37 [Rational(293943, 713623846352979940529142984724747568191373312), 0.000000])
