...
(assert (= y (fp #b1 #b11101011 #b01001010111111011011100)))
;; y should be Float32(0xF5A57EDC [Rational(-419581052472685452800400306470912), -419581052472685452800400306470912.000000])
