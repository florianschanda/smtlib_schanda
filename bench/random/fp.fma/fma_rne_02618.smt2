...
(assert (= x (fp #b0 #b10101100 #b01010111000101000111101)))
;; x should be Float32(0x562B8A3D [Rational(47152554311680), 47152554311680.000000])
...
(assert (not (= result (fp #b0 #b00101110 #b01010111000101000111100))))
(check-sat)
(exit)
