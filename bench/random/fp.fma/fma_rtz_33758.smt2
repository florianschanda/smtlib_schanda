...
(assert (= x (fp #b1 #b00000000 #b00000110111101000011110)))
;; x should be Float32(0x80037A1E [Rational(-113935, 356811923176489970264571492362373784095686656), -0.000000])
