...
(assert (= z (fp #b1 #b00000000 #b00111001100110010000011)))
;; z should be Float32(0x801CCC83 [Rational(-1887363, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x801CCC83)))
(check-sat)
(exit)
