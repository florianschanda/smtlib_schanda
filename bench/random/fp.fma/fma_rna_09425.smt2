...
(assert (= x (fp #b0 #b11011001 #b11000010111111100110100)))
;; x should be Float32(0x6CE17F34 [Rational(2180872073498462737181704192), 2180872073498462737181704192.000000])
