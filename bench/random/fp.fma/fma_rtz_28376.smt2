...
(assert (= z (fp #b0 #b00000000 #b11110001110011010111111)))
;; z should be Float32(0x0078E6BF [Rational(7923391, 713623846352979940529142984724747568191373312), 0.000000])
