...
(assert (= z ((_ to_fp 8 24) #xA5CEC59D)))
;; z should be Float32(0xA5CEC59D [Rational(-13551005, 37778931862957161709568), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b01001011 #b10011101100010110011101))))
(check-sat)
(exit)
