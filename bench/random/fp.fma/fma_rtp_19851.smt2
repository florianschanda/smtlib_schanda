...
(assert (= x (fp #b1 #b11111110 #b11010011110100000001010)))
;; x should be Float32(0xFF69E80A [Rational(-310914938713161514913110359666212208640), -310914938713161514913110359666212208640.000000])
