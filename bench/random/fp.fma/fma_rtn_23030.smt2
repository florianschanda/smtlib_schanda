...
(assert (= z (fp #b0 #b10010101 #b10101111000101001011011)))
;; z should be Float32(0x4AD78A5B [Rational(14125659, 2), 7062829.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x4AD78A5A)))
(check-sat)
(exit)
