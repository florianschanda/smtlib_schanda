...
(assert (= x (fp #b1 #b00000000 #b11111100101000100101110)))
;; x should be Float32(0x807E512E [Rational(-4139159, 356811923176489970264571492362373784095686656), -0.000000])
