...
(assert (= y ((_ to_fp 8 24) #x0050E57F)))
;; y should be Float32(0x0050E57F [Rational(5301631, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b0 #b10000000 #b01000011100101011111101))))
(check-sat)
(exit)
