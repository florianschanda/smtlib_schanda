...
(assert (= y ((_ to_fp 8 24) #x6A94E23F)))
;; y should be Float32(0x6A94E23F [Rational(89994719136485150688280576), 89994719136485150688280576.000000])
...
(assert (= result (fp #b1 #b01010111 #b00101001110001000111111)))
(check-sat)
(exit)
