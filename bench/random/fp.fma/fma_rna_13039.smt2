...
(assert (= x (fp #b1 #b00000000 #b00110010111001110110100)))
;; x should be Float32(0x801973B4 [Rational(-417005, 178405961588244985132285746181186892047843328), -0.000000])
