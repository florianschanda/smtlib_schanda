...
(assert (= y ((_ to_fp 8 24) #x7FA9792D)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x803DA719)))
;; z should be Float32(0x803DA719 [Rational(-4040473, 713623846352979940529142984724747568191373312), -0.000000])
