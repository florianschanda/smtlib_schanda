...
(assert (= x (fp #b1 #b00000000 #b00001010101100010010110)))
;; x should be Float32(0x80055896 [Rational(-175179, 356811923176489970264571492362373784095686656), -0.000000])
