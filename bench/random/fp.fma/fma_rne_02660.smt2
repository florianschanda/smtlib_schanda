...
(assert (= x (fp #b0 #b10011010 #b00111101100101110000111)))
;; x should be Float32(0x4D1ECB87 [Rational(166508656), 166508656.000000])
...
(assert (= z (fp #b1 #b11111111 #b01011100011000110100011)))
