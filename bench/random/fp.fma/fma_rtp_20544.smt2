...
(assert (= x (fp #b1 #b11111111 #b00011101100001001110100)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x804CB2D7)))
;; y should be Float32(0x804CB2D7 [Rational(-5026519, 713623846352979940529142984724747568191373312), -0.000000])
