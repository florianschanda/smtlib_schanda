...
(assert (= x (fp #b0 #b10010000 #b10011101100110011100000)))
;; x should be Float32(0x484ECCE0 [Rational(423527, 2), 211763.500000])
...
(assert (= result (fp #b0 #b00010010 #b10011101100110010100000)))
(check-sat)
(exit)
