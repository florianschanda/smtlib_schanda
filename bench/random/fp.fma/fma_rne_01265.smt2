...
(assert (= z (fp #b1 #b10010101 #b01011010101001111000101)))
;; z should be Float32(0xCAAD53C5 [Rational(-11359173, 2), -5679586.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAAD53C5))))
(check-sat)
(exit)
