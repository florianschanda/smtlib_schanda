...
(assert (= y (fp #b0 #b10001010 #b01110010010011000101111)))
;; y should be Float32(0x4539262F [Rational(12133935, 4096), 2962.386475])
...
(assert (not (= result ((_ to_fp 8 24) #x8639262F))))
(check-sat)
(exit)
