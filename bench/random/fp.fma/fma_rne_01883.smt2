...
(assert (= z (fp #b0 #b10010101 #b11011110101010001001011)))
;; z should be Float32(0x4AEF544B [Rational(15684683, 2), 7842341.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11011110101010001001011))))
(check-sat)
(exit)
