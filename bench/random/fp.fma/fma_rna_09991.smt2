...
(assert (= x ((_ to_fp 8 24) #x004F3247)))
;; x should be Float32(0x004F3247 [Rational(5190215, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result (fp #b1 #b10000000 #b00111100110010010001101)))
(check-sat)
(exit)
