...
(assert (= x (fp #b0 #b00000000 #b01110000110000110011111)))
;; x should be Float32(0x0038619F [Rational(3695007, 713623846352979940529142984724747568191373312), 0.000000])
