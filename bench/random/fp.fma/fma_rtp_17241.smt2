...
(assert (= z (fp #b0 #b01000100 #b11001010001100110100010)))
;; z should be Float32(0x226519A2 [Rational(7507153, 2417851639229258349412352), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x226519A2)))
(check-sat)
(exit)
