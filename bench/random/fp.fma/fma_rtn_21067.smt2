...
(assert (= x ((_ to_fp 8 24) #x4A99E6F7)))
;; x should be Float32(0x4A99E6F7 [Rational(10086135, 2), 5043067.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b01100110000110010000101))))
(check-sat)
(exit)
