...
(assert (= y ((_ to_fp 8 24) #x806F1B5B)))
;; y should be Float32(0x806F1B5B [Rational(-7281499, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC05E36B5))))
(check-sat)
(exit)
