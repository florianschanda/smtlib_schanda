...
(assert (= z ((_ to_fp 8 24) #x00436E75)))
;; z should be Float32(0x00436E75 [Rational(4419189, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b00000000 #b10000110110111001110101)))
(check-sat)
(exit)
