...
(assert (= y (fp #b0 #b00000000 #b11111100110000001001010)))
;; y should be Float32(0x007E604A [Rational(4141093, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b01001011011001001000101)))
