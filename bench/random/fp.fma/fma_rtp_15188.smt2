...
(assert (= y (fp #b0 #b10010001 #b10011010010110100010000)))
;; y should be Float32(0x48CD2D10 [Rational(840401, 2), 420200.500000])
...
(assert (not (= result (fp #b0 #b00010011 #b10011010010110100001111))))
(check-sat)
(exit)
