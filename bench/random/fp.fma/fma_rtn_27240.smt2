...
(assert (= x (fp #b0 #b11111111 #b11110011100001000110011)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b00000000 #b01111111110010111000101)))
;; y should be Float32(0x003FE5C5 [Rational(4187589, 713623846352979940529142984724747568191373312), 0.000000])
