...
(assert (= x (fp #b0 #b10011011 #b01110111010001010100010)))
;; x should be Float32(0x4DBBA2A2 [Rational(393499712), 393499712.000000])
...
(assert (= result ((_ to_fp 8 24) #x0EBBA2A1)))
(check-sat)
(exit)
