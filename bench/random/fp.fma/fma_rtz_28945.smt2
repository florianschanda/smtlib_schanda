...
(assert (= z ((_ to_fp 8 24) #x7DBF9C6A)))
;; z should be Float32(0x7DBF9C6A [Rational(31836836930033543988967855543692558336), 31836836930033543988967855543692558336.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b11111011 #b01111111001110001101010)))
(check-sat)
(exit)
