...
(assert (= z (fp #b1 #b00000000 #b00011111010011101110111)))
;; z should be Float32(0x800FA777 [Rational(-1025911, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x800FA777)))
(check-sat)
(exit)
