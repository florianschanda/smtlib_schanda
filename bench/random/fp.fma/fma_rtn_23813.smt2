...
(assert (= x (fp #b0 #b00000000 #b10110010011001101000001)))
;; x should be Float32(0x00593341 [Rational(5845825, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b10000001000111111110000)))
