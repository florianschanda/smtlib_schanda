...
(assert (= x (fp #b1 #b11001110 #b01011000110110001100101)))
;; x should be Float32(0xE72C6C65 [Rational(-814246561230537439051776), -814246561230537439051776.000000])
...
(assert (not (= result (fp #b1 #b01010000 #b01011000110110001100101))))
(check-sat)
(exit)
