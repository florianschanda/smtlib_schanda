...
(assert (= x (fp #b1 #b00000000 #b01000010110000111001101)))
;; x should be Float32(0x802161CD [Rational(-2187725, 713623846352979940529142984724747568191373312), -0.000000])
