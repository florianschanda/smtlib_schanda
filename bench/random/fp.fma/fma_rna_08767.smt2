...
(assert (= z (fp #b0 #b11111001 #b00101110010111001100000)))
;; z should be Float32(0x7C972E60 [Rational(6279819379073026544992123995924987904), 6279819379073026544992123995924987904.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x7C972E60))))
(check-sat)
(exit)
