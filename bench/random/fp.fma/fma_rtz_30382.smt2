...
(assert (= x (fp #b0 #b00000000 #b01001010100001111111100)))
;; x should be Float32(0x002543FC [Rational(610559, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3F950FEF))))
(check-sat)
(exit)
