...
(assert (= z ((_ to_fp 8 24) #x3E7B5A8A)))
;; z should be Float32(0x3E7B5A8A [Rational(8236357, 33554432), 0.245463])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b01111100 #b11110110101101010001010))))
(check-sat)
(exit)
