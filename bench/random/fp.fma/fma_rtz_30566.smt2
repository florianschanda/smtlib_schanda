...
(assert (= x ((_ to_fp 8 24) #x0014897C)))
;; x should be Float32(0x0014897C [Rational(336479, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (= result (fp #b1 #b01111110 #b01001000100101111011111)))
(check-sat)
(exit)
