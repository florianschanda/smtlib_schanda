...
(assert (= y ((_ to_fp 8 24) #x7A0E8B5D)))
;; y should be Float32(0x7A0E8B5D [Rational(185033194266491733005913836566347776), 185033194266491733005913836566347776.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FEB62E5)))
