...
(assert (= x (fp #b0 #b11111111 #b01001010100001101101001)))
...
(assert (= z (fp #b0 #b00000000 #b11110111010110110100110)))
;; z should be Float32(0x007BADA6 [Rational(4052691, 356811923176489970264571492362373784095686656), 0.000000])
