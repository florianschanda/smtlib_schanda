...
(assert (= x (fp #b0 #b11111111 #b11010011011110101001100)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b1 #b01100110 #b00011001010001100011010)))
;; y should be Float32(0xB30CA31A [Rational(-4608397, 140737488355328), -0.000000])
