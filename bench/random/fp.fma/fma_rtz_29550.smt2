...
(assert (= y (fp #b1 #b11000011 #b11100101000001101010011)))
;; y should be Float32(0xE1F28353 [Rational(-559196871634968379392), -559196871634968379392.000000])
...
(assert (= result (fp #b1 #b01000101 #b11100101000001101010010)))
(check-sat)
(exit)
