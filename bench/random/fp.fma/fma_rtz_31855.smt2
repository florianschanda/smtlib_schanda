...
(assert (= z ((_ to_fp 8 24) #xCAAF1C3D)))
;; z should be Float32(0xCAAF1C3D [Rational(-11476029, 2), -5738014.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010101 #b01011110001110001000100))))
(check-sat)
(exit)
