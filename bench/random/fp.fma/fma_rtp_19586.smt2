...
(assert (= x ((_ to_fp 8 24) #xEE073D2D)))
;; x should be Float32(0xEE073D2D [Rational(-10463608326842451447884283904), -10463608326842451447884283904.000000])
...
(assert (= result ((_ to_fp 8 24) #xAF073D2B)))
(check-sat)
(exit)
