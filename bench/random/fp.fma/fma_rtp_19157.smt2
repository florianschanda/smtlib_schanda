...
(assert (= y ((_ to_fp 8 24) #x4ACEDBFB)))
;; y should be Float32(0x4ACEDBFB [Rational(13556731, 2), 6778365.500000])
...
(assert (= result (fp #b0 #b00000000 #b00110001001001000000010)))
(check-sat)
(exit)
