...
(assert (= z ((_ to_fp 8 24) #x4AADF245)))
;; z should be Float32(0x4AADF245 [Rational(11399749, 2), 5699874.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010101 #b01011011111001001000101))))
(check-sat)
(exit)
