...
(assert (= z (fp #b0 #b10010011 #b10010001001010110010100)))
;; z should be Float32(0x49C89594 [Rational(3286373, 2), 1643186.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x49C89593))))
(check-sat)
(exit)
