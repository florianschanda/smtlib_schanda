...
(assert (= y ((_ to_fp 8 24) #x49DF01EC)))
;; y should be Float32(0x49DF01EC [Rational(3653755, 2), 1826877.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b00110111110000000111101))))
(check-sat)
(exit)
