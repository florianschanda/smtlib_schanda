...
(assert (= z (fp #b1 #b10010101 #b11100111110101110100111)))
;; z should be Float32(0xCAF3EBA7 [Rational(-15985575, 2), -7992787.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAF3EBA7))))
(check-sat)
(exit)
