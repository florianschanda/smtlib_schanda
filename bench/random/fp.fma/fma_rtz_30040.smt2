...
(assert (= x (fp #b0 #b11010011 #b10111110011111111110011)))
;; x should be Float32(0x69DF3FF3 [Rational(33736556177661625628622848), 33736556177661625628622848.000000])
...
(assert (= result ((_ to_fp 8 24) #x2ADF3FF1)))
(check-sat)
(exit)
