...
(assert (= x ((_ to_fp 8 24) #x003B3887)))
;; x should be Float32(0x003B3887 [Rational(3881095, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b00101001110010100110011)))
