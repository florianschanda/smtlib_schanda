...
(assert (= z ((_ to_fp 8 24) #x00089907)))
;; z should be Float32(0x00089907 [Rational(563463, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b00000000 #b00010001001100100000111))))
(check-sat)
(exit)
