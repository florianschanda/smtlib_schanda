...
(assert (= z ((_ to_fp 8 24) #x20CCC747)))
;; z should be Float32(0x20CCC747 [Rational(13420359, 38685626227668133590597632), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x20CCC747)))
(check-sat)
(exit)
