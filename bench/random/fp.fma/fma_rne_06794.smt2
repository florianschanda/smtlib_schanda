...
(assert (= x (fp #b1 #b11111111 #b11111101011011000111001)))
...
(assert (= z (fp #b1 #b10010011 #b01110000111100100010100)))
;; z should be Float32(0xC9B87914 [Rational(-3022405, 2), -1511202.500000])
