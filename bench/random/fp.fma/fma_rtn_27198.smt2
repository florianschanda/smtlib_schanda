...
(assert (= x ((_ to_fp 8 24) #xFFB4F926)))
...
(assert (= z (fp #b0 #b00000000 #b10011111110101100010011)))
;; z should be Float32(0x004FEB13 [Rational(5237523, 713623846352979940529142984724747568191373312), 0.000000])
