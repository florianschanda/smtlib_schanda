...
(assert (= z (fp #b1 #b00000000 #b10100101100001111111101)))
;; z should be Float32(0x8052C3FD [Rational(-5424125, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b00000000 #b10100101100001111111101))))
(check-sat)
(exit)
