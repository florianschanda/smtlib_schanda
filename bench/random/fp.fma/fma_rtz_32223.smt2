...
(assert (= z (fp #b1 #b00000000 #b11111110111010101100101)))
;; z should be Float32(0x807F7565 [Rational(-8353125, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b00000000 #b11111110111010101100101)))
(check-sat)
(exit)
