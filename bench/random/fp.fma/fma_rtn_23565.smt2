...
(assert (= x (fp #b0 #b00000000 #b10010100101001100110010)))
;; x should be Float32(0x004A5332 [Rational(2435481, 356811923176489970264571492362373784095686656), 0.000000])
