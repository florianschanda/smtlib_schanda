...
(assert (= z (fp #b1 #b11111100 #b11111110111110110100110)))
;; z should be Float32(0xFE7F7DA6 [Rational(-84901385728116151805331871914088464384), -84901385728116151805331871914088464384.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xFE7F7DA6))))
(check-sat)
(exit)
