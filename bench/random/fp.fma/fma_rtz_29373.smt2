...
(assert (= z (fp #b1 #b00000000 #b01001000100111101110011)))
;; z should be Float32(0x80244F73 [Rational(-2379635, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b00000000 #b01001000100111101110010))))
(check-sat)
(exit)
