...
(assert (= y (fp #b1 #b00000000 #b01010011100100110110010)))
;; y should be Float32(0x8029C9B2 [Rational(-1369305, 356811923176489970264571492362373784095686656), -0.000000])
