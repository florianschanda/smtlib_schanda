...
(assert (= z ((_ to_fp 8 24) #xC9E0D4CC)))
;; z should be Float32(0xC9E0D4CC [Rational(-3683635, 2), -1841817.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010011 #b11000001101010011001100))))
(check-sat)
(exit)
