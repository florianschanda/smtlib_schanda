...
(assert (= x ((_ to_fp 8 24) #x1936F478)))
;; x should be Float32(0x1936F478 [Rational(1498767, 158456325028528675187087900672), 0.000000])
...
(assert (= z (fp #b0 #b11111111 #b00001001011010010001010)))
