...
(assert (= x (fp #b0 #b11111111 #b00000001100010011101001)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x27085DB2)))
;; y should be Float32(0x27085DB2 [Rational(4468441, 2361183241434822606848), 0.000000])
