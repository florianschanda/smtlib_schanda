...
(assert (= y (fp #b1 #b00000000 #b11011100100010000100010)))
;; y should be Float32(0x806E4422 [Rational(-3613201, 356811923176489970264571492362373784095686656), -0.000000])
