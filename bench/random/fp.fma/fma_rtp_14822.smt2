...
(assert (= y ((_ to_fp 8 24) #x4AAB05E7)))
;; y should be Float32(0x4AAB05E7 [Rational(11208167, 2), 5604083.500000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x4AC86149)))
;; z should be Float32(0x4AC86149 [Rational(13132105, 2), 6566052.500000])
