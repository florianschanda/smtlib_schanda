...
(assert (= y (fp #b0 #b00000000 #b11111010101000011011000)))
;; y should be Float32(0x007D50D8 [Rational(1026587, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b11110101010000110101111))))
(check-sat)
(exit)
