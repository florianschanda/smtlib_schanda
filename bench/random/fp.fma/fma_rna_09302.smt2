...
(assert (= z (fp #b1 #b10010011 #b00110110001011101001100)))
;; z should be Float32(0xC99B174C [Rational(-2541011, 2), -1270505.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #xC99B174C))))
(check-sat)
(exit)
