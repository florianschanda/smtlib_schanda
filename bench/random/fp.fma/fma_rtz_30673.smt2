...
(assert (= x ((_ to_fp 8 24) #x0004BA9E)))
;; x should be Float32(0x0004BA9E [Rational(154959, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b01111110010000110101110)))
