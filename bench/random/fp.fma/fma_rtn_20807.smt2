...
(assert (= z ((_ to_fp 8 24) #x4AC04A77)))
;; z should be Float32(0x4AC04A77 [Rational(12601975, 2), 6300987.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10010101 #b10000000100101001110111))))
(check-sat)
(exit)
