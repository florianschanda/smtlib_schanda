...
(assert (= z ((_ to_fp 8 24) #x839695D5)))
;; z should be Float32(0x839695D5 [Rational(-9868757, 11150372599265311570767859136324180752990208), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b00000111 #b00101101001010111010101))))
(check-sat)
(exit)
