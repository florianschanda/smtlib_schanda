...
(assert (= z (fp #b0 #b00000000 #b01011101110101110001111)))
;; z should be Float32(0x002EEB8F [Rational(3074959, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x002EEB8F)))
(check-sat)
(exit)
