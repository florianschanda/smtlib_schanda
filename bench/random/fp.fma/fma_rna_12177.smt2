...
(assert (= z (fp #b1 #b11110110 #b11000110001111111100000)))
;; z should be Float32(0xFB631FE0 [Rational(-1179297888693522268671185985367703552), -1179297888693522268671185985367703552.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b11110110 #b11000110001111111100000))))
(check-sat)
(exit)
