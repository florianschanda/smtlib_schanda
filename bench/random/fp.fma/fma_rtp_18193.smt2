...
(assert (= y (fp #b0 #b00010100 #b10111010100101001011000)))
;; y should be Float32(0x0A5D4A58 [Rational(1812811, 170141183460469231731687303715884105728), 0.000000])
...
(assert (= result (fp #b1 #b10010100 #b10111010100101001010111)))
(check-sat)
(exit)
