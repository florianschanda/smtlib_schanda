...
(assert (= z (fp #b1 #b00010110 #b00010110001010111010001)))
;; z should be Float32(0x8B0B15D1 [Rational(-9115089, 340282366920938463463374607431768211456), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b00010110 #b00010110001010111010001)))
(check-sat)
(exit)
