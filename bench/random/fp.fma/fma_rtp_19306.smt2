...
(assert (= z ((_ to_fp 8 24) #x4ACB35F3)))
;; z should be Float32(0x4ACB35F3 [Rational(13317619, 2), 6658809.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010101 #b10010110011010111110011))))
(check-sat)
(exit)
