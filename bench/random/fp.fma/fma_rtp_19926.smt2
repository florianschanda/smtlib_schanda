...
(assert (= x ((_ to_fp 8 24) #x80086EE1)))
;; x should be Float32(0x80086EE1 [Rational(-552673, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBE86EE0F))))
(check-sat)
(exit)
