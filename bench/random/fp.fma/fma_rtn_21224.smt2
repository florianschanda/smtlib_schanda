...
(assert (= x (fp #b0 #b10010101 #b01011111001001111011001)))
;; x should be Float32(0x4AAF93D9 [Rational(11506649, 2), 5753324.500000])
...
(assert (= result (fp #b1 #b00000000 #b10101111100100111101101)))
(check-sat)
(exit)
