...
(assert (= z ((_ to_fp 8 24) #x0C976CE4)))
;; z should be Float32(0x0C976CE4 [Rational(2480953, 10633823966279326983230456482242756608), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x0C976CE4)))
(check-sat)
(exit)
