...
(assert (= x ((_ to_fp 8 24) #x8043EB06)))
;; x should be Float32(0x8043EB06 [Rational(-2225539, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result (fp #b1 #b10000000 #b00001111101011000001100)))
(check-sat)
(exit)
