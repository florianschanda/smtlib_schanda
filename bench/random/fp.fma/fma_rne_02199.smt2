...
(assert (= y (fp #b0 #b10010101 #b11101001111011011100101)))
;; y should be Float32(0x4AF4F6E5 [Rational(16053989, 2), 8026994.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8005848C))))
(check-sat)
(exit)
