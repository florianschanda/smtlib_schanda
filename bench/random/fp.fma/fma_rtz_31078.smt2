...
(assert (= x (fp #b1 #b10010000 #b00010101101000110100000)))
;; x should be Float32(0xC80AD1A0 [Rational(-284301, 2), -142150.500000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x4A0C0762)))
;; y should be Float32(0x4A0C0762 [Rational(4588465, 2), 2294232.500000])
