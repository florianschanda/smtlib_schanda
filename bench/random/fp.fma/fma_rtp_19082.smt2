...
(assert (= y (fp #b1 #b11011101 #b11010001111011001110010)))
;; y should be Float32(0xEEE8F672 [Rational(-36049228189978150930340642816), -36049228189978150930340642816.000000])
...
(assert (= result ((_ to_fp 8 24) #x2FE8F673)))
(check-sat)
(exit)
