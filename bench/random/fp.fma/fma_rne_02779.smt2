...
(assert (= x ((_ to_fp 8 24) #x3ED1BB1F)))
;; x should be Float32(0x3ED1BB1F [Rational(13744927, 33554432), 0.409631])
...
(assert (= result (fp #b0 #b00000000 #b10010111001000100111000)))
(check-sat)
(exit)
