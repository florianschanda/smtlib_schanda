...
(assert (= y (fp #b1 #b00000000 #b11001000010111111111110)))
;; y should be Float32(0x80642FFE [Rational(-3282943, 356811923176489970264571492362373784095686656), -0.000000])
