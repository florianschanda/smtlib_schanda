...
(assert (= x (fp #b1 #b10110110 #b00010100100001000100010)))
;; x should be Float32(0xDB0A4222 [Rational(-38916260582391808), -38916260582391808.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x1C0A4222))))
(check-sat)
(exit)
