...
(assert (= z ((_ to_fp 8 24) #xCAD9A49B)))
;; z should be Float32(0xCAD9A49B [Rational(-14263451, 2), -7131725.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b10010101 #b10110011010010010100011)))
(check-sat)
(exit)
