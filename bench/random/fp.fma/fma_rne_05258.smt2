...
(assert (= y ((_ to_fp 8 24) #xCAF8B2ED)))
;; y should be Float32(0xCAF8B2ED [Rational(-16298733, 2), -8149366.500000])
...
(assert (= result (fp #b0 #b00010111 #b11110001011001011101011)))
(check-sat)
(exit)
