...
(assert (= z (fp #b1 #b00000000 #b01110011111111000000100)))
;; z should be Float32(0x8039FE04 [Rational(-950145, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b00000000 #b01110011111111000000100))))
(check-sat)
(exit)
