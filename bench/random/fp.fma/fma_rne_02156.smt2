...
(assert (= y (fp #b1 #b11111111 #b01001110101100000100101)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x0048CD80)))
;; z should be Float32(0x0048CD80 [Rational(37275, 5575186299632655785383929568162090376495104), 0.000000])
