...
(assert (= x ((_ to_fp 8 24) #x7FF563B3)))
...
(assert (= z ((_ to_fp 8 24) #x80037839)))
;; z should be Float32(0x80037839 [Rational(-227385, 713623846352979940529142984724747568191373312), -0.000000])
