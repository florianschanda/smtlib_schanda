...
(assert (= x (fp #b0 #b00000000 #b01000011000100100101111)))
;; x should be Float32(0x0021892F [Rational(2197807, 713623846352979940529142984724747568191373312), 0.000000])
