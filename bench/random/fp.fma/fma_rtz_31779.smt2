...
(assert (= z (fp #b1 #b10010100 #b11000010000000111001010)))
;; z should be Float32(0xCA6101CA [Rational(-7373029, 2), -3686514.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010100 #b11000010000000111001010))))
(check-sat)
(exit)
