...
(assert (= z (fp #b0 #b01111001 #b10100010000000111010010)))
;; z should be Float32(0x3CD101D2 [Rational(6848745, 268435456), 0.025514])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b01111001 #b10100010000000111010010))))
(check-sat)
(exit)
