...
(assert (= y (fp #b1 #b10010101 #b11001110100010010001101)))
;; y should be Float32(0xCAE7448D [Rational(-15156365, 2), -7578182.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BE7448F))))
(check-sat)
(exit)
