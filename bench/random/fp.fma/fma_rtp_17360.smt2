...
(assert (= x ((_ to_fp 8 24) #xCAC6CC75)))
;; x should be Float32(0xCAC6CC75 [Rational(-13028469, 2), -6514234.500000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x4998C5D4)))
;; y should be Float32(0x4998C5D4 [Rational(2503029, 2), 1251514.500000])
