...
(assert (= x (fp #b1 #b11010110 #b01101111010010010011011)))
;; x should be Float32(0xEB37A49B [Rational(-222010752337999185766776832), -222010752337999185766776832.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xAC37A49C))))
(check-sat)
(exit)
