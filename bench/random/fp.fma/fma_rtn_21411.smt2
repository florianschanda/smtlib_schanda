...
(assert (= z (fp #b1 #b11101010 #b00101001010001011010000)))
;; z should be Float32(0xF514A2D0 [Rational(-188418497284362555325540129046528), -188418497284362555325540129046528.000000])
