...
(assert (= y (fp #b1 #b00000000 #b00111100001101000101100)))
;; y should be Float32(0x801E1A2C [Rational(-493195, 178405961588244985132285746181186892047843328), -0.000000])
