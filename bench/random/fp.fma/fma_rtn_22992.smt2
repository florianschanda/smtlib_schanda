...
(assert (= z ((_ to_fp 8 24) #x4A8BF93F)))
;; z should be Float32(0x4A8BF93F [Rational(9173311, 2), 4586655.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10010101 #b00010111111100100111110))))
(check-sat)
(exit)
