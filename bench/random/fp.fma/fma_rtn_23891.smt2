...
(assert (= z (fp #b0 #b01101001 #b10001001000011000110000)))
;; z should be Float32(0x34C48630 [Rational(804963, 2199023255552), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b01101001 #b10001001000011000110000)))
(check-sat)
(exit)
