...
(assert (= z ((_ to_fp 8 24) #x5BF1AF8C)))
;; z should be Float32(0x5BF1AF8C [Rational(136056970435100672), 136056970435100672.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x5BF1AF8C)))
(check-sat)
(exit)
