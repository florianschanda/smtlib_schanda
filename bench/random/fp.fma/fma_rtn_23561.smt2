...
(assert (= x (fp #b0 #b00000000 #b11010100010011001000101)))
;; x should be Float32(0x006A2645 [Rational(6956613, 713623846352979940529142984724747568191373312), 0.000000])
