...
(assert (= x (fp #b1 #b00000000 #b11000100000100000000000)))
;; x should be Float32(0x80620800 [Rational(-3137, 348449143727040986586495598010130648530944), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC0440FFF))))
(check-sat)
(exit)
