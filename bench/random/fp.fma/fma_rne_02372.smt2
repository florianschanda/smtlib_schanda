...
(assert (= y (fp #b1 #b10010010 #b01100000000010011001000)))
;; y should be Float32(0xC93004C8 [Rational(-1441945, 2), -720972.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b00010110000000001001110))))
(check-sat)
(exit)
