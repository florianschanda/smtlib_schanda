...
(assert (= z (fp #b0 #b10010101 #b10110000011011010011101)))
;; z should be Float32(0x4AD8369D [Rational(14169757, 2), 7084878.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x4AD8369D)))
(check-sat)
(exit)
