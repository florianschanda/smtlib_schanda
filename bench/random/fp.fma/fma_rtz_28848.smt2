...
(assert (= y ((_ to_fp 8 24) #x804CAA99)))
;; y should be Float32(0x804CAA99 [Rational(-5024409, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b1 #b10000000 #b00110010101010100110001)))
(check-sat)
(exit)
