...
(assert (= z (fp #b1 #b01101000 #b00011110000010100000100)))
;; z should be Float32(0xB40F0504 [Rational(-2343233, 17592186044416), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #xB40F0504)))
(check-sat)
(exit)
