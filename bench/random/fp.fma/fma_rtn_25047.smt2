...
(assert (= y ((_ to_fp 8 24) #x0F1CB914)))
;; y should be Float32(0x0F1CB914 [Rational(2567749, 332306998946228968225951765070086144), 0.000000])
...
(assert (= result (fp #b1 #b10011110 #b00111001011100100010100)))
(check-sat)
(exit)
