...
(assert (= z (fp #b1 #b00000111 #b00001101100011011010001)))
;; z should be Float32(0x8386C6D1 [Rational(-8832721, 11150372599265311570767859136324180752990208), -0.000000])
