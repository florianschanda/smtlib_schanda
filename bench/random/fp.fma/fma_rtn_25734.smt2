...
(assert (= z (fp #b0 #b01000010 #b01000001000010011110011)))
;; z should be Float32(0x212084F3 [Rational(10519795, 19342813113834066795298816), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x212084F2))))
(check-sat)
(exit)
