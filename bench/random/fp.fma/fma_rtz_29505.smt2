...
(assert (= z (fp #b1 #b10010101 #b11110101000011011011111)))
;; z should be Float32(0xCAFA86DF [Rational(-16418527, 2), -8209263.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010101 #b11110101000011011011111))))
(check-sat)
(exit)
