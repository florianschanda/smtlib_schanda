...
(assert (= z (fp #b1 #b00100101 #b01011100000100001000001)))
;; z should be Float32(0x92AE0841 [Rational(-11405377, 10384593717069655257060992658440192), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b00100101 #b01011100000100001000001))))
(check-sat)
(exit)
