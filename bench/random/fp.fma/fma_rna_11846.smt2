...
(assert (= z ((_ to_fp 8 24) #x0059AF40)))
;; z should be Float32(0x0059AF40 [Rational(91837, 11150372599265311570767859136324180752990208), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x0059AF40)))
(check-sat)
(exit)
