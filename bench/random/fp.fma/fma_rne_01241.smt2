...
(assert (= y ((_ to_fp 8 24) #x0020D90F)))
;; y should be Float32(0x0020D90F [Rational(2152719, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3F83643B))))
(check-sat)
(exit)
