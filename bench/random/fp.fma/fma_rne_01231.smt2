...
(assert (= y ((_ to_fp 8 24) #x0D2DE476)))
;; y should be Float32(0x0D2DE476 [Rational(5698107, 10633823966279326983230456482242756608), 0.000000])
...
(assert (= result (fp #b0 #b10011010 #b01011011110010001110101)))
(check-sat)
(exit)
