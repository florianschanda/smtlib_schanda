...
(assert (= x (fp #b0 #b00000000 #b01000010001001101000011)))
;; x should be Float32(0x00211343 [Rational(2167619, 713623846352979940529142984724747568191373312), 0.000000])
