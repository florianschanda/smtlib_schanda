...
(assert (= y ((_ to_fp 8 24) #xDB8261AB)))
;; y should be Float32(0xDB8261AB [Rational(-73398268079374336), -73398268079374336.000000])
...
(assert (not (= result (fp #b1 #b00111001 #b00000100110000110101001))))
(check-sat)
(exit)
