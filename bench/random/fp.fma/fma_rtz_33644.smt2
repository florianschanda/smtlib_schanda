...
(assert (= x (fp #b1 #b00000000 #b00001111110010000100110)))
;; x should be Float32(0x8007E426 [Rational(-258579, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result (fp #b1 #b01111100 #b11111001000010010111111)))
(check-sat)
(exit)
