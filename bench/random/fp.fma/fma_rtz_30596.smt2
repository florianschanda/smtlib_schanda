...
(assert (= x (fp #b0 #b00000000 #b10100101000001011001111)))
;; x should be Float32(0x005282CF [Rational(5407439, 713623846352979940529142984724747568191373312), 0.000000])
