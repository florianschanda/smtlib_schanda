...
(assert (= z (fp #b0 #b00000000 #b01010100001101001110101)))
;; z should be Float32(0x002A1A75 [Rational(2759285, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b00000000 #b01010100001101001110101))))
(check-sat)
(exit)
