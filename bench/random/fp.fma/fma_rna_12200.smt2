...
(assert (= z (fp #b0 #b10010101 #b00110000000100001011111)))
;; z should be Float32(0x4A98085F [Rational(9963615, 2), 4981807.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010101 #b00110000000100001011111))))
(check-sat)
(exit)
