...
(assert (= z (fp #b1 #b00000000 #b10001100011011000110100)))
;; z should be Float32(0x80463634 [Rational(-1150349, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x80463634))))
(check-sat)
(exit)
