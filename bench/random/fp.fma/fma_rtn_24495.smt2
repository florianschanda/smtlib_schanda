...
(assert (= x ((_ to_fp 8 24) #xCA1B48EA)))
;; x should be Float32(0xCA1B48EA [Rational(-5088373, 2), -2544186.500000])

(declare-const y Float32)
(assert (= y (fp #b1 #b10010111 #b10001010001001101010001)))
;; y should be Float32(0xCBC51351 [Rational(-25831074), -25831074.000000])
