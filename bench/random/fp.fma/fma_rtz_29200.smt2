...
(assert (= y (fp #b1 #b01110101 #b11100010001010001000000)))
;; y should be Float32(0xBAF11440 [Rational(-246865, 134217728), -0.001839])
...
(assert (not (= result ((_ to_fp 8 24) #x80003C46))))
(check-sat)
(exit)
