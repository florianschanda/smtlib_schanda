...
(assert (= y (fp #b1 #b00000000 #b10101000110100000011010)))
;; y should be Float32(0x8054681A [Rational(-2765837, 356811923176489970264571492362373784095686656), -0.000000])
