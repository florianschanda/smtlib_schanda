...
(assert (= x (fp #b0 #b10010100 #b01011000011010110100110)))
;; x should be Float32(0x4A2C35A6 [Rational(5642963, 2), 2821481.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0B2C35A9))))
(check-sat)
(exit)
