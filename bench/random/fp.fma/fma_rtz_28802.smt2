...
(assert (= z (fp #b1 #b11010110 #b01101010000111010101000)))
;; z should be Float32(0xEB350EA8 [Rational(-218884785534012438859481088), -218884785534012438859481088.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b11010110 #b01101010000111010101000)))
(check-sat)
(exit)
