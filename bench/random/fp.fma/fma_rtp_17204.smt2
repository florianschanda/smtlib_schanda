...
(assert (= z (fp #b0 #b00000000 #b11011000111001000100110)))
;; z should be Float32(0x006C7226 [Rational(3553555, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b00000000 #b11011000111001000100110))))
(check-sat)
(exit)
