...
(assert (= z (fp #b1 #b10010101 #b01110110011011100110111)))
;; z should be Float32(0xCABB3737 [Rational(-12269367, 2), -6134683.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10010101 #b01110110011011100110111))))
(check-sat)
(exit)
