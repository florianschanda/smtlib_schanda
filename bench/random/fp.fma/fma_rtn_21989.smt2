...
(assert (= y (fp #b1 #b00000000 #b01011111101001100111100)))
;; y should be Float32(0x802FD33C [Rational(-783567, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (= result (fp #b1 #b01111111 #b01111110100110011110000)))
(check-sat)
(exit)
