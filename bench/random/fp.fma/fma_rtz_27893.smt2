...
(assert (= x ((_ to_fp 8 24) #x49AA439C)))
;; x should be Float32(0x49AA439C [Rational(2789607, 2), 1394803.500000])
...
(assert (not (= result (fp #b0 #b00010101 #b01010100100001110011100))))
(check-sat)
(exit)
