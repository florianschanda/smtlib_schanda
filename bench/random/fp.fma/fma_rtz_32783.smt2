...
(assert (= z (fp #b0 #b01111101 #b00111110101011110101001)))
;; z should be Float32(0x3E9F57A9 [Rational(10442665, 33554432), 0.311216])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b01111101 #b00111110101011110101001)))
(check-sat)
(exit)
