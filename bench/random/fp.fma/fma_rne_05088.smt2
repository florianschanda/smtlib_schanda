...
(assert (= y (fp #b0 #b10010101 #b01011100010001110011101)))
;; y should be Float32(0x4AAE239D [Rational(11412381, 2), 5706190.500000])
...
(assert (= result ((_ to_fp 8 24) #x8BAE239F)))
(check-sat)
(exit)
