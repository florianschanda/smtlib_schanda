...
(assert (= x ((_ to_fp 8 24) #x4A36E5AA)))
;; x should be Float32(0x4A36E5AA [Rational(5993173, 2), 2996586.500000])
...
(assert (not (= result (fp #b1 #b00010110 #b01101101110010110101101))))
(check-sat)
(exit)
