...
(assert (= x (fp #b1 #b10010101 #b10101101111101110101011)))
;; x should be Float32(0xCAD6FBAB [Rational(-14089131, 2), -7044565.500000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b01011110011110100000010)))
