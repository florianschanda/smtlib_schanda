...
(assert (= y (fp #b1 #b00000000 #b10111001011101101010001)))
;; y should be Float32(0x805CBB51 [Rational(-6077265, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7F92CE1C)))
