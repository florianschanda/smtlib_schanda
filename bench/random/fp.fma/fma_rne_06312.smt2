...
(assert (= x (fp #b1 #b00000000 #b01011010110011001001100)))
;; x should be Float32(0x802D664C [Rational(-743827, 178405961588244985132285746181186892047843328), -0.000000])
