...
(assert (= y (fp #b0 #b10101111 #b00101001001111001000101)))
;; y should be Float32(0x57949E45 [Rational(326814966743040), 326814966743040.000000])
...
(assert (= result (fp #b0 #b00011010 #b00101001001111001000110)))
(check-sat)
(exit)
