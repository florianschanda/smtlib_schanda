...
(assert (= y ((_ to_fp 8 24) #xCAC30C2D)))
;; y should be Float32(0xCAC30C2D [Rational(-12782637, 2), -6391318.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b10000110000110000101011))))
(check-sat)
(exit)
