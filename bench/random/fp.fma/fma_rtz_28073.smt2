...
(assert (= x (fp #b0 #b10010101 #b01110110110001011010001)))
;; x should be Float32(0x4ABB62D1 [Rational(12280529, 2), 6140264.500000])
...
(assert (= result (fp #b1 #b00010111 #b01110110110001011010001)))
(check-sat)
(exit)
