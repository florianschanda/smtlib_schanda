...
(assert (= x ((_ to_fp 8 24) #x7F91F3B7)))
...
(assert (= z ((_ to_fp 8 24) #x006526EB)))
;; z should be Float32(0x006526EB [Rational(6629099, 713623846352979940529142984724747568191373312), 0.000000])
