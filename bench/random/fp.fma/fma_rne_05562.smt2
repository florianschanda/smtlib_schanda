...
(assert (= y (fp #b0 #b11110001 #b00001011110110000101100)))
;; y should be Float32(0x7885EC2C [Rational(21730175527835765513920677469487104), 21730175527835765513920677469487104.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xAE05EC2C))))
(check-sat)
(exit)
