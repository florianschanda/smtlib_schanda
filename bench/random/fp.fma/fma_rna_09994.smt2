...
(assert (= x (fp #b0 #b00000000 #b11000100001100000101000)))
;; x should be Float32(0x00621828 [Rational(803589, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (= z (fp #b0 #b11111111 #b00011100111101001110011)))
