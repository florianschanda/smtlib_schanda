...
(assert (= z ((_ to_fp 8 24) #x25096D92)))
;; z should be Float32(0x25096D92 [Rational(4503241, 37778931862957161709568), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x25096D92))))
(check-sat)
(exit)
