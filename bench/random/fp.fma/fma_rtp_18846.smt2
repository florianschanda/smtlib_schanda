...
(assert (= z (fp #b1 #b10101101 #b10101011111110110110000)))
;; z should be Float32(0xD6D5FDB0 [Rational(-117642778116096), -117642778116096.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xD6D5FDB0))))
(check-sat)
(exit)
