...
(assert (= y (fp #b0 #b10010101 #b10011110010000011011101)))
;; y should be Float32(0x4ACF20DD [Rational(13574365, 2), 6787182.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BCF20DC))))
(check-sat)
(exit)
