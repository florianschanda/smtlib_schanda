...
(assert (= x (fp #b1 #b00000000 #b10100110010111110010010)))
;; x should be Float32(0x80532F92 [Rational(-2725833, 356811923176489970264571492362373784095686656), -0.000000])
