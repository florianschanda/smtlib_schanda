...
(assert (= y (fp #b1 #b10001111 #b00001100000000111000000)))
;; y should be Float32(0xC78601C0 [Rational(-137223, 2), -68611.500000])
...
(assert (not (= result (fp #b1 #b00000001 #b00000010000110000000100))))
(check-sat)
(exit)
