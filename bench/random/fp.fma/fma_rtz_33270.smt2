...
(assert (= x (fp #b1 #b00001010 #b00001000001000100000011)))
;; x should be Float32(0x85041103 [Rational(-8655107, 1393796574908163946345982392040522594123776), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC5041102))))
(check-sat)
(exit)
