...
(assert (= x (fp #b1 #b11111111 #b00101110001011001101111)))
...
(assert (= z (fp #b1 #b10010100 #b01001011111111101010010)))
;; z should be Float32(0xCA25FF52 [Rational(-5439401, 2), -2719700.500000])
