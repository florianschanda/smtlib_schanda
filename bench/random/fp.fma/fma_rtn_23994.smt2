...
(assert (= y (fp #b0 #b00000000 #b00101101100011110010100)))
;; y should be Float32(0x0016C794 [Rational(373221, 178405961588244985132285746181186892047843328), 0.000000])
