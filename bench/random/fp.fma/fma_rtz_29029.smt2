...
(assert (= y (fp #b0 #b10100110 #b11000100111101111011000)))
;; y should be Float32(0x53627BD8 [Rational(972740362240), 972740362240.000000])
...
(assert (= result (fp #b0 #b00101000 #b11000100111101111010110)))
(check-sat)
(exit)
