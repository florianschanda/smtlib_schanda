...
(assert (= z (fp #b1 #b11010001 #b00010010100110010010110)))
;; z should be Float32(0xE8894C96 [Rational(-5187015754734792075116544), -5187015754734792075116544.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #xE8894C96)))
(check-sat)
(exit)
