...
(assert (= y (fp #b0 #b10010101 #b00101010010011100111001)))
;; y should be Float32(0x4A952739 [Rational(9774905, 2), 4887452.500000])
...
(assert (not (= result (fp #b1 #b00000001 #b10010101001001110011100))))
(check-sat)
(exit)
