...
(assert (= x (fp #b0 #b00000000 #b01111000101000000001011)))
;; x should be Float32(0x003C500B [Rational(3952651, 713623846352979940529142984724747568191373312), 0.000000])
