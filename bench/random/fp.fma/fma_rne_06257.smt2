...
(assert (= x (fp #b1 #b00000000 #b00001011100001010111011)))
;; x should be Float32(0x8005C2BB [Rational(-377531, 713623846352979940529142984724747568191373312), -0.000000])
