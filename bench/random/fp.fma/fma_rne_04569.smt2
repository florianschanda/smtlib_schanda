...
(assert (= z (fp #b0 #b00000000 #b11100101001111001111110)))
;; z should be Float32(0x00729E7E [Rational(3755839, 356811923176489970264571492362373784095686656), 0.000000])
