...
(assert (= y (fp #b1 #b00000000 #b10111110010110111111110)))
;; y should be Float32(0x805F2DFE [Rational(-3118847, 356811923176489970264571492362373784095686656), -0.000000])
