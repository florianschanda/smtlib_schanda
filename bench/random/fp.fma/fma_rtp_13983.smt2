...
(assert (= z ((_ to_fp 8 24) #x8070AAD3)))
;; z should be Float32(0x8070AAD3 [Rational(-7383763, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b00000000 #b11100001010101011010011)))
(check-sat)
(exit)
