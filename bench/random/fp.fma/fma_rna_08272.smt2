...
(assert (= y ((_ to_fp 8 24) #x802F067B)))
;; y should be Float32(0x802F067B [Rational(-3081851, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b1 #b01111111 #b01111000001100111101011)))
(check-sat)
(exit)
