...
(assert (= z (fp #b0 #b10010011 #b00011101000010111011100)))
;; z should be Float32(0x498E85DC [Rational(2335095, 2), 1167547.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010011 #b00011101000010111011100))))
(check-sat)
(exit)
