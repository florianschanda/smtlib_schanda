...
(assert (= z (fp #b0 #b10010100 #b11101001011001100101010)))
;; z should be Float32(0x4A74B32A [Rational(8018325, 2), 4009162.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4A74B329))))
(check-sat)
(exit)
