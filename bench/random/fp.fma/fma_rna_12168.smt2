...
(assert (= z ((_ to_fp 8 24) #x30BF733A)))
;; z should be Float32(0x30BF733A [Rational(6273437, 4503599627370496), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b01100001 #b01111110111001100111010)))
(check-sat)
(exit)
