...
(assert (= x ((_ to_fp 8 24) #x54810B0E)))
;; x should be Float32(0x54810B0E [Rational(4433889984512), 4433889984512.000000])
...
(assert (= z ((_ to_fp 8 24) #x4A21CA42)))
;; z should be Float32(0x4A21CA42 [Rational(5301537, 2), 2650768.500000])
