...
(assert (= z ((_ to_fp 8 24) #x046939C6)))
;; z should be Float32(0x046939C6 [Rational(7642339, 2787593149816327892691964784081045188247552), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00001000 #b11010010011100111000111)))
(check-sat)
(exit)
