...
(assert (= x (fp #b1 #b00000000 #b00000100101001010111101)))
;; x should be Float32(0x800252BD [Rational(-152253, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b0 #b01111011 #b00101001010111100111111)))
(check-sat)
(exit)
