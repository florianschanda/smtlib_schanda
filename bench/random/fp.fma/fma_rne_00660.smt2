...
(assert (= x (fp #b0 #b10010100 #b10000110001100110111110)))
;; x should be Float32(0x4A4319BE [Rational(6393055, 2), 3196527.500000])
...
(assert (= result (fp #b1 #b00000001 #b01100001100011001101110)))
(check-sat)
(exit)
