...
(assert (= x (fp #b0 #b00000000 #b01110100101010000010010)))
;; x should be Float32(0x003A5412 [Rational(1911305, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7FAD1668)))
