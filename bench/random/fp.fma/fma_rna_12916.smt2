...
(assert (= x (fp #b1 #b11011100 #b11100111111100100000101)))
;; x should be Float32(0xEE73F905 [Rational(-18876475881875827178212425728), -18876475881875827178212425728.000000])
...
(assert (= result (fp #b0 #b01011110 #b11100111111100100000101)))
(check-sat)
(exit)
