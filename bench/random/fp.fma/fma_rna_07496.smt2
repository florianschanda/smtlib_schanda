...
(assert (= x ((_ to_fp 8 24) #x4A911DBF)))
;; x should be Float32(0x4A911DBF [Rational(9510335, 2), 4755167.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b00100010001110110111111))))
(check-sat)
(exit)
