...
(assert (= x ((_ to_fp 8 24) #xC9E97BD4)))
;; x should be Float32(0xC9E97BD4 [Rational(-3825397, 2), -1912698.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b00111010010111101111011))))
(check-sat)
(exit)
