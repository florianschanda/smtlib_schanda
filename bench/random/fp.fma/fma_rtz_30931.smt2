...
(assert (= z (fp #b1 #b00000000 #b10010111010100101001011)))
;; z should be Float32(0x804BA94B [Rational(-4958539, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x804BA94B))))
(check-sat)
(exit)
