...
(assert (= x ((_ to_fp 8 24) #x7877367C)))
;; x should be Float32(0x7877367C [Rational(20056287476075802862934177255260160), 20056287476075802862934177255260160.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x2DF7367C))))
(check-sat)
(exit)
