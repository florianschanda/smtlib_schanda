...
(assert (= y (fp #b1 #b00000000 #b11011100110010101001011)))
;; y should be Float32(0x806E654B [Rational(-7234891, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC05CCA95)))
(check-sat)
(exit)
