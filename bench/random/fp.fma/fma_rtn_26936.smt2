...
(assert (= x (fp #b1 #b00000000 #b00011110011111100011011)))
;; x should be Float32(0x800F3F1B [Rational(-999195, 713623846352979940529142984724747568191373312), -0.000000])
