...
(assert (= y (fp #b1 #b10101100 #b00000010111000000100010)))
;; y should be Float32(0xD6017022 [Rational(-35579651686400), -35579651686400.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFEDBAF5)))
