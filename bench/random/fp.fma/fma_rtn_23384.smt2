...
(assert (= x (fp #b0 #b11011110 #b00011000111110011110010)))
;; x should be Float32(0x6F0C7CF2 [Rational(43478950989309378093274628096), 43478950989309378093274628096.000000])
...
(assert (= result ((_ to_fp 8 24) #xB00C7CF3)))
(check-sat)
(exit)
