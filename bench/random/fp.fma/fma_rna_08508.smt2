...
(assert (= y (fp #b1 #b10010011 #b10001010011100111001100)))
;; y should be Float32(0xC9C539CC [Rational(-3231347, 2), -1615673.500000])
...
(assert (= result (fp #b1 #b00010101 #b10001010011100111010010)))
(check-sat)
(exit)
