...
(assert (= x (fp #b1 #b00000000 #b10000101011010111011110)))
;; x should be Float32(0x8042B5DE [Rational(-2185967, 356811923176489970264571492362373784095686656), -0.000000])
