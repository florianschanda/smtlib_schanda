...
(assert (= x (fp #b1 #b10010101 #b00011101101100111000001)))
;; x should be Float32(0xCA8ED9C1 [Rational(-9361857, 2), -4680928.500000])
...
(assert (= z ((_ to_fp 8 24) #x407D5439)))
;; z should be Float32(0x407D5439 [Rational(16602169, 4194304), 3.958266])
