...
(assert (= z (fp #b0 #b11000001 #b10101110101110001010010)))
;; z should be Float32(0x60D75C52 [Rational(124146948607722913792), 124146948607722913792.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x60D75C52)))
(check-sat)
(exit)
