...
(assert (= z ((_ to_fp 8 24) #x0070ADB2)))
;; z should be Float32(0x0070ADB2 [Rational(3692249, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b00000000 #b11100001010110110110010))))
(check-sat)
(exit)
