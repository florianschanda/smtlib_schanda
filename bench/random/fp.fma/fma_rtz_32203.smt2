...
(assert (= z ((_ to_fp 8 24) #xF403D968)))
;; z should be Float32(0xF403D968 [Rational(-41784693059140400104406817701888), -41784693059140400104406817701888.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xF403D968))))
(check-sat)
(exit)
