...
(assert (= x (fp #b1 #b00000000 #b10101010010100001001110)))
;; x should be Float32(0x8055284E [Rational(-2790439, 356811923176489970264571492362373784095686656), -0.000000])
