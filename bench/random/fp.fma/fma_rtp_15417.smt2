...
(assert (= z (fp #b0 #b00011110 #b11001101111001101111101)))
;; z should be Float32(0x0F66F37D [Rational(15135613, 1329227995784915872903807060280344576), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b00011110 #b11001101111001101111101))))
(check-sat)
(exit)
