...
(assert (= z (fp #b0 #b10010100 #b00100101110110000110010)))
;; z should be Float32(0x4A12EC32 [Rational(4814361, 2), 2407180.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010100 #b00100101110110000110010))))
(check-sat)
(exit)
