...
(assert (= x (fp #b0 #b00000000 #b10010011001110101011101)))
;; x should be Float32(0x00499D5D [Rational(4824413, 713623846352979940529142984724747568191373312), 0.000000])
