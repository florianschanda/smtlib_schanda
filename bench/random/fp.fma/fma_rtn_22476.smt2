...
(assert (= z ((_ to_fp 8 24) #x8026DE87)))
;; z should be Float32(0x8026DE87 [Rational(-2547335, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b00000000 #b01001101101111010000111))))
(check-sat)
(exit)
