...
(assert (= z (fp #b1 #b10010100 #b10000000000011100001110)))
;; z should be Float32(0xCA40070E [Rational(-6292359, 2), -3146179.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA40070E))))
(check-sat)
(exit)
