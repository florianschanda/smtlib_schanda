...
(assert (= x ((_ to_fp 8 24) #x80296355)))
;; x should be Float32(0x80296355 [Rational(-2712405, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #xFF839310)))
