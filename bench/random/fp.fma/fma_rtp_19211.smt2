...
(assert (= z ((_ to_fp 8 24) #x4ABED0B9)))
;; z should be Float32(0x4ABED0B9 [Rational(12505273, 2), 6252636.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10010101 #b01111101101000010111001)))
(check-sat)
(exit)
