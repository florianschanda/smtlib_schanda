...
(assert (= z ((_ to_fp 8 24) #x62EB2B64)))
;; z should be Float32(0x62EB2B64 [Rational(2169055740681523298304), 2169055740681523298304.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x62EB2B64)))
(check-sat)
(exit)
