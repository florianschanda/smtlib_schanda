...
(assert (= z ((_ to_fp 8 24) #x802D28D8)))
;; z should be Float32(0x802D28D8 [Rational(-369947, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x802D28D8))))
(check-sat)
(exit)
