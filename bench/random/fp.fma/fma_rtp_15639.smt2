...
(assert (= z (fp #b0 #b10010101 #b00101001101011011001101)))
;; z should be Float32(0x4A94D6CD [Rational(9754317, 2), 4877158.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10010101 #b00101001101011011001110)))
(check-sat)
(exit)
