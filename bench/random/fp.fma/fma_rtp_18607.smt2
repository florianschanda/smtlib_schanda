...
(assert (= y ((_ to_fp 8 24) #xCA9EB93F)))
;; y should be Float32(0xCA9EB93F [Rational(-10402111, 2), -5201055.500000])
...
(assert (= result (fp #b0 #b00010111 #b00111101011100101000000)))
(check-sat)
(exit)
