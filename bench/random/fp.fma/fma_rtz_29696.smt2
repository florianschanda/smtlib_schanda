...
(assert (= z (fp #b1 #b00000000 #b10011110101111010100001)))
;; z should be Float32(0x804F5EA1 [Rational(-5201569, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x804F5EA0)))
(check-sat)
(exit)
