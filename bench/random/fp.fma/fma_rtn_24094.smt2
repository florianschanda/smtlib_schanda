...
(assert (= z ((_ to_fp 8 24) #x4ADB9457)))
;; z should be Float32(0x4ADB9457 [Rational(14390359, 2), 7195179.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b10110111001010001010111)))
(check-sat)
(exit)
