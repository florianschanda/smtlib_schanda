...
(assert (= x ((_ to_fp 8 24) #x7FA56385)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b10110001 #b11110011000100100101100)))
;; y should be Float32(0x58F9892C [Rational(2194940352266240), 2194940352266240.000000])
