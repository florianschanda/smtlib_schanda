...
(assert (= y (fp #b1 #b00000000 #b10111001000001111000110)))
;; y should be Float32(0x805C83C6 [Rational(-3031523, 356811923176489970264571492362373784095686656), -0.000000])
