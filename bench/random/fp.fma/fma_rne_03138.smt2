...
(assert (= x (fp #b0 #b00000000 #b00010011111110110110001)))
;; x should be Float32(0x0009FDB1 [Rational(654769, 713623846352979940529142984724747568191373312), 0.000000])
