...
(assert (= x (fp #b1 #b11111111 #b10010100111111001010101)))
...
(assert (= z (fp #b0 #b00000000 #b00110100010000011000010)))
;; z should be Float32(0x001A20C2 [Rational(856161, 356811923176489970264571492362373784095686656), 0.000000])
