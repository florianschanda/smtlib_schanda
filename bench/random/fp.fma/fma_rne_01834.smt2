...
(assert (= y (fp #b0 #b10010101 #b10110010111101010010101)))
;; y should be Float32(0x4AD97A95 [Rational(14252693, 2), 7126346.500000])
...
(assert (= result ((_ to_fp 8 24) #x0BD97A95)))
(check-sat)
(exit)
