...
(assert (= x (fp #b1 #b11101011 #b10110110100010000001000)))
;; x should be Float32(0xF5DB4408 [Rational(-555904711766345546070169852313600), -555904711766345546070169852313600.000000])
