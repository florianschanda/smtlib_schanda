...
(assert (= x ((_ to_fp 8 24) #xFF85395A)))
...
(assert (= z ((_ to_fp 8 24) #x802C077D)))
;; z should be Float32(0x802C077D [Rational(-2885501, 713623846352979940529142984724747568191373312), -0.000000])
