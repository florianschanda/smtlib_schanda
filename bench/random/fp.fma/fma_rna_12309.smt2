...
(assert (= y (fp #b0 #b10010101 #b01000100000101011001101)))
;; y should be Float32(0x4AA20ACD [Rational(10619597, 2), 5309798.500000])
...
(assert (= result (fp #b1 #b00000000 #b10100010000010101101000)))
(check-sat)
(exit)
