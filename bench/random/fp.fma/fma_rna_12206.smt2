...
(assert (= z ((_ to_fp 8 24) #x05F42FBD)))
;; z should be Float32(0x05F42FBD [Rational(16003005, 696898287454081973172991196020261297061888), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x05F42FBD))))
(check-sat)
(exit)
