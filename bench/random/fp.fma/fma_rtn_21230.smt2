...
(assert (= x ((_ to_fp 8 24) #x4ACC284F)))
;; x should be Float32(0x4ACC284F [Rational(13379663, 2), 6689831.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b11001100001010000100111))))
(check-sat)
(exit)
