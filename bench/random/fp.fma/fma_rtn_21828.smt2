...
(assert (= y ((_ to_fp 8 24) #x00055CA3)))
;; y should be Float32(0x00055CA3 [Rational(351395, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3E2B945F))))
(check-sat)
(exit)
