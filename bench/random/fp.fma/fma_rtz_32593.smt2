...
(assert (= z (fp #b0 #b00000010 #b01101000000011000011111)))
;; z should be Float32(0x0134061F [Rational(11798047, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b00000010 #b01101000000011000011110)))
(check-sat)
(exit)
