...
(assert (= x (fp #b1 #b10010101 #b00010001101000010001101)))
;; x should be Float32(0xCA88D08D [Rational(-8966285, 2), -4483142.500000])
...
(assert (= result (fp #b1 #b00010111 #b00010001101000010001101)))
(check-sat)
(exit)
