...
(assert (= x ((_ to_fp 8 24) #x8068A900)))
;; x should be Float32(0x8068A900 [Rational(-26793, 2787593149816327892691964784081045188247552), -0.000000])
...
(assert (= result (fp #b1 #b10000000 #b10100010101000111111111)))
(check-sat)
(exit)
