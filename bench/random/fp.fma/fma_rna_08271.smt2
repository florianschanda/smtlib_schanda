...
(assert (= y ((_ to_fp 8 24) #x803F8E98)))
;; y should be Float32(0x803F8E98 [Rational(-520659, 89202980794122492566142873090593446023921664), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBFFE3A5F))))
(check-sat)
(exit)
