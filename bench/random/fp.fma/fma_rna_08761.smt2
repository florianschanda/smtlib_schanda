...
(assert (= z (fp #b0 #b10010101 #b00010011111001100111111)))
;; z should be Float32(0x4A89F33F [Rational(9040703, 2), 4520351.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010101 #b00010011111001100111111))))
(check-sat)
(exit)
