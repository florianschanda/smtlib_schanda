...
(assert (= z (fp #b0 #b10010101 #b01000101000101101100011)))
;; z should be Float32(0x4AA28B63 [Rational(10652515, 2), 5326257.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4AA28B63))))
(check-sat)
(exit)
