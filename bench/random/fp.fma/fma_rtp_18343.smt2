...
(assert (= z (fp #b0 #b01011111 #b10100011100101100000100)))
;; z should be Float32(0x2FD1CB04 [Rational(3437249, 9007199254740992), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b01101010 #b00000000001101000111001))))
(check-sat)
(exit)
