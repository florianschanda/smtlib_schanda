...
(assert (= x ((_ to_fp 8 24) #xCAECF5B5)))
;; x should be Float32(0xCAECF5B5 [Rational(-15529397, 2), -7764698.500000])

(declare-const y Float32)
(assert (= y (fp #b1 #b10010101 #b01010000111001001010011)))
;; y should be Float32(0xCAA87253 [Rational(-11039315, 2), -5519657.500000])
