...
(assert (= x (fp #b0 #b11011101 #b11111101010011100011010)))
;; x should be Float32(0x6EFEA71A [Rational(39405602944012922569522937856), 39405602944012922569522937856.000000])
