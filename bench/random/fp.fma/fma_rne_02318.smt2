...
(assert (= y ((_ to_fp 8 24) #x10B6764B)))
;; y should be Float32(0x10B6764B [Rational(11957835, 166153499473114484112975882535043072), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFC1C75F)))
