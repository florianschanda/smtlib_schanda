...
(assert (= x (fp #b1 #b00000000 #b00111111101000011000011)))
;; x should be Float32(0x801FD0C3 [Rational(-2085059, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7FAB9758)))
