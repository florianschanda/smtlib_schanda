...
(assert (= z (fp #b1 #b10010011 #b11110100000010100111100)))
;; z should be Float32(0xC9FA053C [Rational(-4096335, 2), -2048167.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xC9FA053B))))
(check-sat)
(exit)
