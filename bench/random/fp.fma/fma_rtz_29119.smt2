...
(assert (= z (fp #b1 #b10010010 #b01010010111101101001000)))
;; z should be Float32(0xC9297B48 [Rational(-1388393, 2), -694196.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010010 #b01010010111101110000111)))
(check-sat)
(exit)
