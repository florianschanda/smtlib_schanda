...
(assert (= x (fp #b1 #b10010101 #b10001000100101111011111)))
;; x should be Float32(0xCAC44BDF [Rational(-12864479, 2), -6432239.500000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x469105CD)))
;; y should be Float32(0x469105CD [Rational(9504205, 512), 18562.900391])
