...
(assert (= y (fp #b1 #b10010100 #b00010001001111001001010)))
;; y should be Float32(0xCA089E4A [Rational(-4476709, 2), -2238354.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8B089E48))))
(check-sat)
(exit)
