...
(assert (= z ((_ to_fp 8 24) #x853654F4)))
;; z should be Float32(0x853654F4 [Rational(-2987325, 348449143727040986586495598010130648530944), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b00001010 #b01101100101010011110100))))
(check-sat)
(exit)
