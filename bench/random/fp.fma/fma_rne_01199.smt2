...
(assert (= z (fp #b0 #b10010100 #b01010110010111001110110)))
;; z should be Float32(0x4A2B2E76 [Rational(5609275, 2), 2804637.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10010100 #b01010110010111001110110)))
(check-sat)
(exit)
