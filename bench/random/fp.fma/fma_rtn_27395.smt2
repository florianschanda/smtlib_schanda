...
(assert (= x (fp #b0 #b11111111 #b11110111111000110101010)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b1 #b10101110 #b10100100110011000011000)))
;; y should be Float32(0xD7526618 [Rational(-231335931150336), -231335931150336.000000])
