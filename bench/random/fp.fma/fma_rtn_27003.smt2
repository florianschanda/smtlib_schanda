...
(assert (= x (fp #b1 #b00000000 #b01001001000010001100001)))
;; x should be Float32(0x80248461 [Rational(-2393185, 713623846352979940529142984724747568191373312), -0.000000])
