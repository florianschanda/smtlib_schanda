...
(assert (= z ((_ to_fp 8 24) #xE9CA16B6)))
;; z should be Float32(0xE9CA16B6 [Rational(-30538783116524955077967872), -30538783116524955077967872.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b11010011 #b10010100001011010110110))))
(check-sat)
(exit)
