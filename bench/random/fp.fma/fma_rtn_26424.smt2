...
(assert (= x (fp #b1 #b01010000 #b10000011111110000110101)))
;; x should be Float32(0xA841FC35 [Rational(-12713013, 1180591620717411303424), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xE841FC35))))
(check-sat)
(exit)
