...
(assert (= z (fp #b0 #b00000000 #b01000000101010001000000)))
;; z should be Float32(0x00205440 [Rational(33105, 11150372599265311570767859136324180752990208), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00000000 #b01000000101010001000001)))
(check-sat)
(exit)
