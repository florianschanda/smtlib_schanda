...
(assert (= y (fp #b1 #b10010100 #b11101111110011100000110)))
;; y should be Float32(0xCA77E706 [Rational(-8123267, 2), -4061633.500000])
...
(assert (= result (fp #b1 #b00010110 #b11101111110011100000000)))
(check-sat)
(exit)
