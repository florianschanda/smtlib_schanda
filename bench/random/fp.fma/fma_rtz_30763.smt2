...
(assert (= z (fp #b0 #b10010011 #b10100000110001000111100)))
;; z should be Float32(0x49D0623C [Rational(3414159, 2), 1707079.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b10010011 #b10100000110001000111100)))
(check-sat)
(exit)
