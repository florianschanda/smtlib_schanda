...
(assert (= y (fp #b1 #b10101101 #b01100000011101110000101)))
;; y should be Float32(0xD6B03B85 [Rational(-96884840464384), -96884840464384.000000])
...
(assert (= result ((_ to_fp 8 24) #x8C303B86)))
(check-sat)
(exit)
