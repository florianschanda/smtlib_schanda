...
(assert (= z ((_ to_fp 8 24) #x802237C2)))
;; z should be Float32(0x802237C2 [Rational(-1121249, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x802237C1)))
(check-sat)
(exit)
