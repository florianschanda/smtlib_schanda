...
(assert (= z ((_ to_fp 8 24) #xD5C21DA3)))
;; z should be Float32(0xD5C21DA3 [Rational(-26679068065792), -26679068065792.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10101011 #b10000100001110110100011))))
(check-sat)
(exit)
