...
(assert (= z ((_ to_fp 8 24) #xE3F7631D)))
;; z should be Float32(0xE3F7631D [Rational(-9126975301580677447680), -9126975301580677447680.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b11000111 #b11101110110001100011101))))
(check-sat)
(exit)
