...
(assert (= z (fp #b1 #b10010100 #b00100011011101110110110)))
;; z should be Float32(0xCA11BBB6 [Rational(-4775387, 2), -2387693.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010100 #b00100011011101110110110))))
(check-sat)
(exit)
