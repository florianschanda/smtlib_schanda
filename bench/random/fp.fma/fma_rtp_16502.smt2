...
(assert (= x (fp #b0 #b11001010 #b01101101011101111111101)))
;; x should be Float32(0x6536BBFD [Rational(53933654474709419425792), 53933654474709419425792.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xA636BBFB))))
(check-sat)
(exit)
