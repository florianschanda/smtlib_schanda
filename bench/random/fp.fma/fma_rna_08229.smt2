...
(assert (= z (fp #b0 #b10010101 #b01000111010000011001001)))
;; z should be Float32(0x4AA3A0C9 [Rational(10723529, 2), 5361764.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x4AA3A0C9)))
(check-sat)
(exit)
