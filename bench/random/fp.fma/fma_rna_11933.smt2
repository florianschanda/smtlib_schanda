...
(assert (= y ((_ to_fp 8 24) #x4A9390DB)))
;; y should be Float32(0x4A9390DB [Rational(9670875, 2), 4835437.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b00100111001000011011011))))
(check-sat)
(exit)
