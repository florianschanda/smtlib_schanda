...
(assert (= z ((_ to_fp 8 24) #x00370AF4)))
;; z should be Float32(0x00370AF4 [Rational(901821, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x00370AF4)))
(check-sat)
(exit)
