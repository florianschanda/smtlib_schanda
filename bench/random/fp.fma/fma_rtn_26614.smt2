...
(assert (= x (fp #b1 #b11010010 #b01100010100001111111100)))
;; x should be Float32(0xE93143FC [Rational(-13393807325353012809957376), -13393807325353012809957376.000000])
...
(assert (= result ((_ to_fp 8 24) #x2A3143FA)))
(check-sat)
(exit)
