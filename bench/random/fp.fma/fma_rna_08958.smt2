...
(assert (= z (fp #b0 #b00000000 #b10111010000010101101110)))
;; z should be Float32(0x005D056E [Rational(3048119, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x005D056E)))
(check-sat)
(exit)
