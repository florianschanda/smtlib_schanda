...
(assert (= y (fp #b1 #b00000000 #b10101100110000101101000)))
;; y should be Float32(0x80566168 [Rational(-707629, 89202980794122492566142873090593446023921664), -0.000000])
...
(assert (not (= result (fp #b0 #b10000000 #b01011001100001011001111))))
(check-sat)
(exit)
