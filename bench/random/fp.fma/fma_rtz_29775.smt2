...
(assert (= z ((_ to_fp 8 24) #x4ABA6E1F)))
;; z should be Float32(0x4ABA6E1F [Rational(12217887, 2), 6108943.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b10010101 #b01110100110111000011111)))
(check-sat)
(exit)
