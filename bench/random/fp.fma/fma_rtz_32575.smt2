...
(assert (= z ((_ to_fp 8 24) #x007506A4)))
;; z should be Float32(0x007506A4 [Rational(1917353, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b00000000 #b11101010000011010100011))))
(check-sat)
(exit)
