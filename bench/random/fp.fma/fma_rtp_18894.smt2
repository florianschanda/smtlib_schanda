...
(assert (= z ((_ to_fp 8 24) #x6FE8A2AC)))
;; z should be Float32(0x6FE8A2AC [Rational(143994361016729358898856722432), 143994361016729358898856722432.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b11011111 #b11010001010001010101100)))
(check-sat)
(exit)
