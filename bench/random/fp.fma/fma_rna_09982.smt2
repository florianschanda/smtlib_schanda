...
(assert (= x ((_ to_fp 8 24) #x005D89C6)))
;; x should be Float32(0x005D89C6 [Rational(3065059, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC03B138B)))
(check-sat)
(exit)
