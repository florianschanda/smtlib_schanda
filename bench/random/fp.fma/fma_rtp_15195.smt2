...
(assert (= y ((_ to_fp 8 24) #x4914E1E8)))
;; y should be Float32(0x4914E1E8 [Rational(1219645, 2), 609822.500000])
...
(assert (not (= result (fp #b0 #b00010100 #b00101001110000111010111))))
(check-sat)
(exit)
