...
(assert (= x ((_ to_fp 8 24) #x3CE1667D)))
;; x should be Float32(0x3CE1667D [Rational(14771837, 536870912), 0.027515])
...
(assert (= result (fp #b1 #b00000000 #b11111000111101001100110)))
(check-sat)
(exit)
