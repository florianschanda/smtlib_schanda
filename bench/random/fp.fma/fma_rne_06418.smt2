...
(assert (= x (fp #b1 #b00000000 #b01010000010111110111100)))
;; x should be Float32(0x80282FBC [Rational(-658415, 178405961588244985132285746181186892047843328), -0.000000])
