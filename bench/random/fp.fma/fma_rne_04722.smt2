...
(assert (= y ((_ to_fp 8 24) #x4AA5CAD9)))
;; y should be Float32(0x4AA5CAD9 [Rational(10865369, 2), 5432684.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b01001011100101011011000))))
(check-sat)
(exit)
