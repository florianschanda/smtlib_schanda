...
(assert (= y (fp #b0 #b00000000 #b10100010000111001011000)))
;; y should be Float32(0x00510E58 [Rational(664011, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (not (= result (fp #b0 #b10000000 #b01000100001110010101111))))
(check-sat)
(exit)
