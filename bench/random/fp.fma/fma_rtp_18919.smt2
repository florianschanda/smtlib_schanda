...
(assert (= y (fp #b0 #b10101110 #b11001000011111100010101)))
;; y should be Float32(0x57643F15 [Rational(250959586394112), 250959586394112.000000])
...
(assert (= result (fp #b1 #b00110000 #b11001000011111100010101)))
(check-sat)
(exit)
