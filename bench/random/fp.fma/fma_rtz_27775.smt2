...
(assert (= y (fp #b1 #b00000000 #b11001000100111101101010)))
;; y should be Float32(0x80644F6A [Rational(-3286965, 356811923176489970264571492362373784095686656), -0.000000])
