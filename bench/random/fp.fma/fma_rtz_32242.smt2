...
(assert (= z ((_ to_fp 8 24) #x800B19FC)))
;; z should be Float32(0x800B19FC [Rational(-181887, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00010110001100111111100))))
(check-sat)
(exit)
