...
(assert (= y (fp #b0 #b00000000 #b10100110100100000000010)))
;; y should be Float32(0x00534802 [Rational(2728961, 356811923176489970264571492362373784095686656), 0.000000])
