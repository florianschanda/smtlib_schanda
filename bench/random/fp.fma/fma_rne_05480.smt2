...
(assert (= z ((_ to_fp 8 24) #x6E8377AE)))
;; z should be Float32(0x6E8377AE [Rational(20343610075449182096501768192), 20343610075449182096501768192.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b11011101 #b00000110111011110101110))))
(check-sat)
(exit)
