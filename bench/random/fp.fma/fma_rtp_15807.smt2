...
(assert (= z (fp #b1 #b00000000 #b10001110000100011010100)))
;; z should be Float32(0x804708D4 [Rational(-1163829, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b00000000 #b10001110000100011010100)))
(check-sat)
(exit)
