...
(assert (= x (fp #b1 #b01110000 #b11100110010000101100111)))
;; x should be Float32(0xB8732167 [Rational(-15933799, 274877906944), -0.000058])
...
(assert (not (= result (fp #b1 #b11110000 #b11100110010000101100110))))
(check-sat)
(exit)
