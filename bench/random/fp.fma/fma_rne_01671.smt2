...
(assert (= z (fp #b1 #b00000000 #b10000010101010110111110)))
;; z should be Float32(0x804155BE [Rational(-2140895, 356811923176489970264571492362373784095686656), -0.000000])
