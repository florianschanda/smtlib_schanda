...
(assert (= y (fp #b1 #b10010100 #b10101000100010101011110)))
;; y should be Float32(0xCA54455E [Rational(-6955695, 2), -3477847.500000])
...
(assert (= result (fp #b0 #b00010110 #b10101000100010101011111)))
(check-sat)
(exit)
