...
(assert (= z (fp #b1 #b01001100 #b01110101000101010000110)))
;; z should be Float32(0xA63A8A86 [Rational(-6112579, 9444732965739290427392), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b01001100 #b01110101000101010000110)))
(check-sat)
(exit)
