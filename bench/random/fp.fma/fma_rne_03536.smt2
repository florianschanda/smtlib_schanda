...
(assert (= z ((_ to_fp 8 24) #x4AD6C86B)))
;; z should be Float32(0x4AD6C86B [Rational(14076011, 2), 7038005.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10010101 #b10101101100100001101011)))
(check-sat)
(exit)
