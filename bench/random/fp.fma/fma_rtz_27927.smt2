...
(assert (= x (fp #b0 #b10010100 #b01000000011101010111010)))
;; x should be Float32(0x4A203ABA [Rational(5250397, 2), 2625198.500000])
...
(assert (= result (fp #b0 #b00000000 #b01010000000111010101101)))
(check-sat)
(exit)
