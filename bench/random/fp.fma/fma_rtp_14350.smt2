...
(assert (= x ((_ to_fp 8 24) #x494AA528)))
;; x should be Float32(0x494AA528 [Rational(1660069, 2), 830034.500000])
...
(assert (not (= result (fp #b1 #b00010100 #b10010101010010100011000))))
(check-sat)
(exit)
