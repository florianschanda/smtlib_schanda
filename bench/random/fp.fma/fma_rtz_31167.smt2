...
(assert (= x (fp #b1 #b10010100 #b01100100001001000111010)))
;; x should be Float32(0xCA32123A [Rational(-5835037, 2), -2917518.500000])
...
(assert (= result (fp #b1 #b00000000 #b01011001000010010001101)))
(check-sat)
(exit)
