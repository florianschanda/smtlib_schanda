...
(assert (= z ((_ to_fp 8 24) #xDFF9FBE8)))
;; z should be Float32(0xDFF9FBE8 [Rational(-36026492442592149504), -36026492442592149504.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10111111 #b11110011111101111101000))))
(check-sat)
(exit)
