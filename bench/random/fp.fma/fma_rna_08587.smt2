...
(assert (= z (fp #b1 #b00000000 #b11101001010011000111000)))
;; z should be Float32(0x8074A638 [Rational(-955591, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x8074A638))))
(check-sat)
(exit)
