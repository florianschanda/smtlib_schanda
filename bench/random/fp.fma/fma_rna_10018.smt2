...
(assert (= x (fp #b0 #b00000000 #b10101011010100011100110)))
;; x should be Float32(0x0055A8E6 [Rational(2806899, 356811923176489970264571492362373784095686656), 0.000000])
