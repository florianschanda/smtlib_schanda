...
(assert (= z ((_ to_fp 8 24) #x2991EEF6)))
;; z should be Float32(0x2991EEF6 [Rational(4781947, 73786976294838206464), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b01010011 #b00100011110111011110110))))
(check-sat)
(exit)
