...
(assert (= x (fp #b0 #b10010101 #b01111011011110110111001)))
;; x should be Float32(0x4ABDBDB9 [Rational(12434873, 2), 6217436.500000])
...
(assert (= result ((_ to_fp 8 24) #x005EDEDC)))
(check-sat)
(exit)
