...
(assert (= x ((_ to_fp 8 24) #x8018E287)))
;; x should be Float32(0x8018E287 [Rational(-1630855, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7F9AEC74)))
