...
(assert (= z (fp #b1 #b00000000 #b11010010111101101001001)))
;; z should be Float32(0x80697B49 [Rational(-6912841, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b00000000 #b11010010111101101001001)))
(check-sat)
(exit)
