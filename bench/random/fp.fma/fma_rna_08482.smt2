...
(assert (= z (fp #b0 #b01010011 #b00100110111111100001011)))
;; z should be Float32(0x29937F0B [Rational(9666315, 147573952589676412928), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x29937F0B)))
(check-sat)
(exit)
