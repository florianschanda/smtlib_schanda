...
(assert (= y (fp #b1 #b10010101 #b11000100001010001000011)))
;; y should be Float32(0xCAE21443 [Rational(-14816323, 2), -7408161.500000])

(declare-const z Float32)
(assert (= z (fp #b0 #b11111111 #b11110000011101110111110)))
