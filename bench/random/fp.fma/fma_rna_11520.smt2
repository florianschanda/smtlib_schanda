...
(assert (= y ((_ to_fp 8 24) #x8034DB96)))
;; y should be Float32(0x8034DB96 [Rational(-1732043, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (not (= result (fp #b0 #b01111111 #b10100110110111001010111))))
(check-sat)
(exit)
