...
(assert (= x ((_ to_fp 8 24) #x4A5510D2)))
;; x should be Float32(0x4A5510D2 [Rational(6981737, 2), 3490868.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b10101010001000011010101))))
(check-sat)
(exit)
