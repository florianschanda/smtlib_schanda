...
(assert (= x (fp #b0 #b00000000 #b11100110111111110011010)))
;; x should be Float32(0x00737F9A [Rational(3784653, 356811923176489970264571492362373784095686656), 0.000000])
