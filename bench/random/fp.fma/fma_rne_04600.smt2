...
(assert (= z (fp #b0 #b10010101 #b01011001000011011011011)))
;; z should be Float32(0x4AAC86DB [Rational(11306715, 2), 5653357.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10010101 #b01011001000011011100011)))
(check-sat)
(exit)
