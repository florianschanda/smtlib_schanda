...
(assert (= z (fp #b0 #b11001001 #b01001001001000001101001)))
;; z should be Float32(0x64A49069 [Rational(24285375012019061653504), 24285375012019061653504.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b11001001 #b01001001001000001101000))))
(check-sat)
(exit)
