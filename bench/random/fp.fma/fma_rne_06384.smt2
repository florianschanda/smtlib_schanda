...
(assert (= x (fp #b1 #b00000000 #b01001001001001100101101)))
;; x should be Float32(0x8024932D [Rational(-2396973, 713623846352979940529142984724747568191373312), -0.000000])
