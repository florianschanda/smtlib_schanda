...
(assert (= x ((_ to_fp 8 24) #x8031E5A4)))
;; x should be Float32(0x8031E5A4 [Rational(-817513, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b00001100110001111101101)))
