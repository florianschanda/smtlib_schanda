...
(assert (= z ((_ to_fp 8 24) #x001A523C)))
;; z should be Float32(0x001A523C [Rational(431247, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x001A523C))))
(check-sat)
(exit)
