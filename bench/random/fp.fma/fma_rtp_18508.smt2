...
(assert (= z ((_ to_fp 8 24) #x4AEEB789)))
;; z should be Float32(0x4AEEB789 [Rational(15644553, 2), 7822276.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10010101 #b11011101011011110001001)))
(check-sat)
(exit)
