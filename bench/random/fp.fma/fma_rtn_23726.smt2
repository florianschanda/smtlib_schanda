...
(assert (= x (fp #b0 #b00000000 #b10001011111111101111101)))
;; x should be Float32(0x0045FF7D [Rational(4587389, 713623846352979940529142984724747568191373312), 0.000000])
