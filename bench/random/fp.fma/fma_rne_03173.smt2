...
(assert (= x (fp #b0 #b00000000 #b10001101101011011010110)))
;; x should be Float32(0x0046D6D6 [Rational(2321259, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= z ((_ to_fp 8 24) #xFFADBF2A)))
