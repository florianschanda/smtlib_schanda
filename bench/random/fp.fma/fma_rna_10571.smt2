...
(assert (= x ((_ to_fp 8 24) #xCABCE2FB)))
;; x should be Float32(0xCABCE2FB [Rational(-12378875, 2), -6189437.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b01111001110001011111011))))
(check-sat)
(exit)
