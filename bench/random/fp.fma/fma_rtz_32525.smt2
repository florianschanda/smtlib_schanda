...
(assert (= y (fp #b0 #b10010101 #b11110010101000101100011)))
;; y should be Float32(0x4AF95163 [Rational(16339299, 2), 8169649.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b11110010101000101100011))))
(check-sat)
(exit)
