...
(assert (= x (fp #b0 #b11110011 #b10000101010001010100001)))
;; x should be Float32(0x79C2A2A1 [Rational(126325512080714115887743537894129664), 126325512080714115887743537894129664.000000])
