...
(assert (= x (fp #b0 #b11101111 #b10001101010000001001001)))
;; x should be Float32(0x77C6A049 [Rational(8057232399862059992293079391404032), 8057232399862059992293079391404032.000000])
