...
(assert (= y ((_ to_fp 8 24) #xE41EDC6B)))
;; y should be Float32(0xE41EDC6B [Rational(-11721873408627845365760), -11721873408627845365760.000000])
...
(assert (= result ((_ to_fp 8 24) #xA51EDC6B)))
(check-sat)
(exit)
