...
(assert (= z (fp #b0 #b00000000 #b10111001010000111111111)))
;; z should be Float32(0x005CA1FF [Rational(6070783, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b00000000 #b10111001010000111111111)))
(check-sat)
(exit)
