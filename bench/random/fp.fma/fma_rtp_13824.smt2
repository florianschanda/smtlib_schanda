...
(assert (= z (fp #b1 #b10010100 #b11101110100111011101110)))
;; z should be Float32(0xCA774EEE [Rational(-8103799, 2), -4051899.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA774EEE))))
(check-sat)
(exit)
