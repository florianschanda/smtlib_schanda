...
(assert (= y (fp #b1 #b00000000 #b01000101110010011110110)))
;; y should be Float32(0x8022E4F6 [Rational(-1143419, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (not (= result (fp #b0 #b01111111 #b00010111001001111011000))))
(check-sat)
(exit)
