...
(assert (= x (fp #b1 #b00000000 #b01100111000111010101111)))
;; x should be Float32(0x80338EAF [Rational(-3378863, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3FCE3ABC))))
(check-sat)
(exit)
