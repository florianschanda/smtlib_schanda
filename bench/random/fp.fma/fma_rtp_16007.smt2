...
(assert (= z ((_ to_fp 8 24) #x0068E1A6)))
;; z should be Float32(0x0068E1A6 [Rational(3436755, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x0068E1A7)))
(check-sat)
(exit)
