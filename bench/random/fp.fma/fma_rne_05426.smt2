...
(assert (= z ((_ to_fp 8 24) #xC9361CC8)))
;; z should be Float32(0xC9361CC8 [Rational(-1491865, 2), -745932.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010010 #b01101100001110011001000))))
(check-sat)
(exit)
