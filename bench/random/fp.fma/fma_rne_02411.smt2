...
(assert (= z (fp #b1 #b10101011 #b10010111000001011110000)))
;; z should be Float32(0xD5CB82F0 [Rational(-27970404089856), -27970404089856.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10101011 #b10010111000001011110000))))
(check-sat)
(exit)
