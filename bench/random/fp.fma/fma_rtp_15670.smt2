...
(assert (= y (fp #b0 #b11011010 #b11100110110011010000001)))
;; y should be Float32(0x6D736681 [Rational(4708048562841489628760899584), 4708048562841489628760899584.000000])
...
(assert (not (= result (fp #b0 #b01011100 #b11100110110011010000001))))
(check-sat)
(exit)
