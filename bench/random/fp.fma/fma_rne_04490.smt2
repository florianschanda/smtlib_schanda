...
(assert (= y ((_ to_fp 8 24) #x0066A54D)))
;; y should be Float32(0x0066A54D [Rational(6726989, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b10011010100101010011001))))
(check-sat)
(exit)
