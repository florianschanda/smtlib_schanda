...
(assert (= x (fp #b1 #b00000000 #b10011110000100001001001)))
;; x should be Float32(0x804F0849 [Rational(-5179465, 713623846352979940529142984724747568191373312), -0.000000])
