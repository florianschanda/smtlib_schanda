...
(assert (= x ((_ to_fp 8 24) #xC9278C88)))
;; x should be Float32(0xC9278C88 [Rational(-1372561, 2), -686280.500000])
...
(assert (not (= result (fp #b1 #b00010100 #b01001111000110010011000))))
(check-sat)
(exit)
