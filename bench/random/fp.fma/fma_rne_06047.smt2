...
(assert (= x (fp #b1 #b10010110 #b11101100011001000010011)))
;; x should be Float32(0xCB763213 [Rational(-16134675), -16134675.000000])
...
(assert (not (= result (fp #b0 #b00011000 #b11101100011001000010100))))
(check-sat)
(exit)
