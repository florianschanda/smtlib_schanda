...
(assert (= x (fp #b1 #b00101111 #b11111111001011101110110)))
;; x should be Float32(0x97FF9776 [Rational(-8375227, 5070602400912917605986812821504), -0.000000])
...
(assert (= z (fp #b0 #b11111111 #b10000111011011110001000)))
