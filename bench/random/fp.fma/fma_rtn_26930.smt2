...
(assert (= x (fp #b1 #b00000000 #b11101011100101101111001)))
;; x should be Float32(0x8075CB79 [Rational(-7719801, 713623846352979940529142984724747568191373312), -0.000000])
