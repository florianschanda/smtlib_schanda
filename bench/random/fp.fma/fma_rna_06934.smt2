...
(assert (= z ((_ to_fp 8 24) #x805F2EB0)))
;; z should be Float32(0x805F2EB0 [Rational(-389867, 44601490397061246283071436545296723011960832), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x805F2EB0))))
(check-sat)
(exit)
