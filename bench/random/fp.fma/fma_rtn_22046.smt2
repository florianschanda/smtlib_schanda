...
(assert (= y ((_ to_fp 8 24) #x4AA37E35)))
;; y should be Float32(0x4AA37E35 [Rational(10714677, 2), 5357338.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b01000110111111000110101))))
(check-sat)
(exit)
