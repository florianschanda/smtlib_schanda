...
(assert (= z (fp #b0 #b00000000 #b11111111110001111001001)))
;; z should be Float32(0x007FE3C9 [Rational(8381385, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x007FE3C9))))
(check-sat)
(exit)
