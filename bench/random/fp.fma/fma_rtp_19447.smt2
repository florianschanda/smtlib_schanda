...
(assert (= y ((_ to_fp 8 24) #xE8AC497B)))
;; y should be Float32(0xE8AC497B [Rational(-6508820083640211513278464), -6508820083640211513278464.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x1E2C497B))))
(check-sat)
(exit)
