...
(assert (= z (fp #b0 #b10010001 #b10111111111100010110000)))
;; z should be Float32(0x48DFF8B0 [Rational(917387, 2), 458693.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b10010001 #b10111111111100010110000)))
(check-sat)
(exit)
