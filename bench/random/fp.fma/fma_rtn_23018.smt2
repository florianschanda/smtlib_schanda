...
(assert (= z ((_ to_fp 8 24) #x00287E26)))
;; z should be Float32(0x00287E26 [Rational(1326867, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x00287E25))))
(check-sat)
(exit)
