...
(assert (= z (fp #b1 #b10010101 #b10000110001000001100111)))
;; z should be Float32(0xCAC31067 [Rational(-12783719, 2), -6391859.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010101 #b10000110001000001100111))))
(check-sat)
(exit)
