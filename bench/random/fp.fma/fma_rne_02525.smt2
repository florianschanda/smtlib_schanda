...
(assert (= y ((_ to_fp 8 24) #xFFBB87CC)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xF08F7A24)))
;; z should be Float32(0xF08F7A24 [Rational(-355232122877109703153484300288), -355232122877109703153484300288.000000])
