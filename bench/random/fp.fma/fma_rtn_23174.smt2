...
(assert (= x (fp #b0 #b01110000 #b11011100100110100101100)))
;; x should be Float32(0x386E4D2C [Rational(3904331, 68719476736), 0.000057])
...
(assert (not (= result ((_ to_fp 8 24) #xFF7FFC46))))
(check-sat)
(exit)
