...
(assert (= x ((_ to_fp 8 24) #xE22159FA)))
;; x should be Float32(0xE22159FA [Rational(-744102322620197765120), -744102322620197765120.000000])
...
(assert (= result ((_ to_fp 8 24) #x232159F9)))
(check-sat)
(exit)
