...
(assert (= y (fp #b1 #b10010101 #b10000010100101011111001)))
;; y should be Float32(0xCAC14AF9 [Rational(-12667641, 2), -6333820.500000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b11101101111101011011000)))
