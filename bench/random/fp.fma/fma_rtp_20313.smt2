...
(assert (= x (fp #b1 #b11111111 #b01001010110000100011000)))
...
(assert (= z (fp #b0 #b10010011 #b11100100111100000100100)))
;; z should be Float32(0x49F27824 [Rational(3972617, 2), 1986308.500000])
