...
(assert (= z ((_ to_fp 8 24) #x0CED025F)))
;; z should be Float32(0x0CED025F [Rational(15532639, 42535295865117307932921825928971026432), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x0CED025E)))
(check-sat)
(exit)
