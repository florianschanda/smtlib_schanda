...
(assert (= z (fp #b1 #b01001011 #b10000001010100001111010)))
;; z should be Float32(0xA5C0A87A [Rational(-6313021, 18889465931478580854784), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xA5C0A87A))))
(check-sat)
(exit)
