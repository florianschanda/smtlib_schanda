...
(assert (= z ((_ to_fp 8 24) #xCAC36A17)))
;; z should be Float32(0xCAC36A17 [Rational(-12806679, 2), -6403339.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010101 #b10000110110101000010111))))
(check-sat)
(exit)
