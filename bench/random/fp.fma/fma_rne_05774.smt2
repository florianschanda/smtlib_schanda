...
(assert (= y ((_ to_fp 8 24) #xFFFA82BE)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b11000110 #b00101111001110001001011)))
;; z should be Float32(0xE3179C4B [Rational(-2796720450423312351232), -2796720450423312351232.000000])
