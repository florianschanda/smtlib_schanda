...
(assert (= z (fp #b0 #b01110001 #b10000001100000001000100)))
;; z should be Float32(0x38C0C044 [Rational(3158033, 34359738368), 0.000092])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x38C0C044)))
(check-sat)
(exit)
