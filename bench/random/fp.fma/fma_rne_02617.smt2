...
(assert (= x ((_ to_fp 8 24) #x4AEE7814)))
;; x should be Float32(0x4AEE7814 [Rational(7814154), 7814154.000000])
...
(assert (not (= result (fp #b0 #b00010111 #b11011100111100000010000))))
(check-sat)
(exit)
