...
(assert (= z (fp #b1 #b10101010 #b10010110011101110011011)))
;; z should be Float32(0xD54B3B9B [Rational(-13966053998592), -13966053998592.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xD54B3B9B))))
(check-sat)
(exit)
