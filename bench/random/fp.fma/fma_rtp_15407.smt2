...
(assert (= z ((_ to_fp 8 24) #xF18F235E)))
;; z should be Float32(0xF18F235E [Rational(-1417571606738823891053071826944), -1417571606738823891053071826944.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b11100011 #b00011110010001101011110))))
(check-sat)
(exit)
