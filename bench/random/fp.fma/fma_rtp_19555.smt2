...
(assert (= x (fp #b1 #b11011100 #b10000011000110000000110)))
;; x should be Float32(0xEE418C06 [Rational(-14974971211116135891553222656), -14974971211116135891553222656.000000])
