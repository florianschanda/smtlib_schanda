...
(assert (= z (fp #b1 #b10010101 #b01010000110100011110001)))
;; z should be Float32(0xCAA868F1 [Rational(-11036913, 2), -5518456.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010101 #b01010000110100011101001)))
(check-sat)
(exit)
