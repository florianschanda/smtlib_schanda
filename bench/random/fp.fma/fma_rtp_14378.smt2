...
(assert (= x (fp #b0 #b10010011 #b11110101110011011111100)))
;; x should be Float32(0x49FAE6FC [Rational(4110783, 2), 2055391.500000])
...
(assert (= result (fp #b1 #b00000001 #b00111110101110011011110)))
(check-sat)
(exit)
