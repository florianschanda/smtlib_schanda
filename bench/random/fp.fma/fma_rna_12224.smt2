...
(assert (= y ((_ to_fp 8 24) #xF4CBC6E4)))
;; y should be Float32(0xF4CBC6E4 [Rational(-129158965259417271924390092603392), -129158965259417271924390092603392.000000])
...
(assert (= result (fp #b0 #b01101011 #b10010111100011011100100)))
(check-sat)
(exit)
