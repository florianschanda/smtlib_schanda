...
(assert (= z (fp #b1 #b00000000 #b01110101010101101011001)))
;; z should be Float32(0x803AAB59 [Rational(-3844953, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x803AAB59))))
(check-sat)
(exit)
