...
(assert (= y (fp #b0 #b00000001 #b01011000010010001001100)))
;; y should be Float32(0x00AC244C [Rational(2820371, 178405961588244985132285746181186892047843328), 0.000000])
