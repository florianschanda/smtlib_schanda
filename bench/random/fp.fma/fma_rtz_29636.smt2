...
(assert (= y (fp #b0 #b10010101 #b01110001011011111011011)))
;; y should be Float32(0x4AB8B7DB [Rational(12105691, 2), 6052845.500000])
...
(assert (= result (fp #b1 #b00000000 #b01000111010010000010010)))
(check-sat)
(exit)
