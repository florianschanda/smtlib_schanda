...
(assert (= y (fp #b0 #b11111111 #b11100010001011001010100)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x5B8C11B2)))
;; z should be Float32(0x5B8C11B2 [Rational(78851905882685440), 78851905882685440.000000])
