...
(assert (= x (fp #b1 #b10010101 #b01001111001001010110001)))
;; x should be Float32(0xCAA792B1 [Rational(-10982065, 2), -5491032.500000])
...
(assert (= result (fp #b1 #b00000001 #b10100111100100101011000)))
(check-sat)
(exit)
