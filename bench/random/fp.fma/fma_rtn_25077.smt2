...
(assert (= y ((_ to_fp 8 24) #x0012076A)))
;; y should be Float32(0x0012076A [Rational(590773, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBF103B50))))
(check-sat)
(exit)
