...
(assert (= x (fp #b0 #b00000000 #b00100100001000110011110)))
;; x should be Float32(0x0012119E [Rational(592079, 356811923176489970264571492362373784095686656), 0.000000])
