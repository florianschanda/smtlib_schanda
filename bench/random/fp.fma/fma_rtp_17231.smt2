...
(assert (= z ((_ to_fp 8 24) #xB8FFB304)))
;; z should be Float32(0xB8FFB304 [Rational(-4189377, 34359738368), -0.000122])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b01110001 #b11111111011001100000100))))
(check-sat)
(exit)
