...
(assert (= z (fp #b0 #b00000011 #b11011111101000100010001)))
;; z should be Float32(0x01EFD111 [Rational(15716625, 178405961588244985132285746181186892047843328), 0.000000])
