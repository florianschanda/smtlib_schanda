...
(assert (= x ((_ to_fp 8 24) #x805D4CCE)))
;; x should be Float32(0x805D4CCE [Rational(-3057255, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #xFFC82303)))
