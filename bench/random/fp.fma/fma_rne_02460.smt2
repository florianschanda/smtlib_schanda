...
(assert (= z (fp #b0 #b00000000 #b00100111110111000001110)))
;; z should be Float32(0x0013EE0E [Rational(653063, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b00000000 #b00100111110111000001110)))
(check-sat)
(exit)
