...
(assert (= y (fp #b0 #b11101000 #b10111001001110011111111)))
;; y should be Float32(0x745C9CFF [Rational(69915134763017143326961139974144), 69915134763017143326961139974144.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FDD3A0B)))
