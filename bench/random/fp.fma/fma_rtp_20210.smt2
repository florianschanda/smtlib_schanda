...
(assert (= x ((_ to_fp 8 24) #x8023990A)))
;; x should be Float32(0x8023990A [Rational(-1166469, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7FAD2E55)))
