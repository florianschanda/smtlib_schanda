...
(assert (= x ((_ to_fp 8 24) #x80267D87)))
;; x should be Float32(0x80267D87 [Rational(-2522503, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b10101111011101111101100)))
