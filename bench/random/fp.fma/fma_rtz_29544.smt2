...
(assert (= z ((_ to_fp 8 24) #x8078AC56)))
;; z should be Float32(0x8078AC56 [Rational(-3954219, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x8078AC56)))
(check-sat)
(exit)
