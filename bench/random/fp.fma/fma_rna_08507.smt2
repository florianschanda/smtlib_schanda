...
(assert (= y (fp #b1 #b10010101 #b01001000000001110110111)))
;; y should be Float32(0xCAA403B7 [Rational(-10748855, 2), -5374427.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b01001000000001110111000))))
(check-sat)
(exit)
