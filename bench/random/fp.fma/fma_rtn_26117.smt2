...
(assert (= z (fp #b1 #b10010101 #b11010111100011010011101)))
;; z should be Float32(0xCAEBC69D [Rational(-15451805, 2), -7725902.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10010101 #b11010111100011010011110)))
(check-sat)
(exit)
