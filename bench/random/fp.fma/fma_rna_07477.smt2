...
(assert (= x (fp #b0 #b10010101 #b01001011011100010011101)))
;; x should be Float32(0x4AA5B89D [Rational(10860701, 2), 5430350.500000])
...
(assert (= result ((_ to_fp 8 24) #x8BA5B89C)))
(check-sat)
(exit)
