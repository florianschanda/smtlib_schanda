...
(assert (= y (fp #b1 #b10010101 #b11111010001101010011001)))
;; y should be Float32(0xCAFD1A99 [Rational(-16587417, 2), -8293708.500000])
...
(assert (= result (fp #b0 #b00010111 #b11111010001101010011000)))
(check-sat)
(exit)
