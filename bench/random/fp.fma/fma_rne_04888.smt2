...
(assert (= y ((_ to_fp 8 24) #xCACC35DB)))
;; y should be Float32(0xCACC35DB [Rational(-13383131, 2), -6691565.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b10011000011010111011011))))
(check-sat)
(exit)
