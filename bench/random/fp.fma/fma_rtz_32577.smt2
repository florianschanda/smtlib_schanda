...
(assert (= z (fp #b1 #b10010101 #b00101011110000000010101)))
;; z should be Float32(0xCA95E015 [Rational(-9822229, 2), -4911114.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA95E015))))
(check-sat)
(exit)
