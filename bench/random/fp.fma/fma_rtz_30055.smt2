...
(assert (= x (fp #b0 #b10110001 #b00100001001111101111101)))
;; x should be Float32(0x58909F7D [Rational(1272117370814464), 1272117370814464.000000])
...
(assert (not (= result (fp #b0 #b00110011 #b00100001001111101111011))))
(check-sat)
(exit)
