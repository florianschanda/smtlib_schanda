...
(assert (= x (fp #b1 #b10010001 #b11111000001001010010000)))
;; x should be Float32(0xC8FC1290 [Rational(-1032489, 2), -516244.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b11110000001111101101010))))
(check-sat)
(exit)
