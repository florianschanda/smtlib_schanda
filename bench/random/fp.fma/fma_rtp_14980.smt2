...
(assert (= z (fp #b0 #b11101101 #b01100000100001011111000)))
;; z should be Float32(0x76B042F8 [Rational(1787504950625535567236466936381440), 1787504950625535567236466936381440.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x76B042F8)))
(check-sat)
(exit)
