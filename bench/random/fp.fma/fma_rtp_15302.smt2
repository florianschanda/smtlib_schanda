...
(assert (= y ((_ to_fp 8 24) #x68A85A02)))
;; y should be Float32(0x68A85A02 [Rational(6360143361631378651217920), 6360143361631378651217920.000000])
...
(assert (= result ((_ to_fp 8 24) #x29A85A01)))
(check-sat)
(exit)
