...
(assert (= y (fp #b1 #b00000000 #b01110101011011000000100)))
;; y should be Float32(0x803AB604 [Rational(-961921, 178405961588244985132285746181186892047843328), -0.000000])
