...
(assert (= z (fp #b0 #b10010101 #b10110110100111100000101)))
;; z should be Float32(0x4ADB4F05 [Rational(14372613, 2), 7186306.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b10110110100111100001100)))
(check-sat)
(exit)
