...
(assert (= z (fp #b1 #b00000000 #b11000010010000000011100)))
;; z should be Float32(0x8061201C [Rational(-1591303, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b00000000 #b11000010010000000011101))))
(check-sat)
(exit)
