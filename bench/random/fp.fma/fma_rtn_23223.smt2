...
(assert (= x ((_ to_fp 8 24) #x70DBE30C)))
;; x should be Float32(0x70DBE30C [Rational(544413599842599082473023340544), 544413599842599082473023340544.000000])
...
(assert (= result ((_ to_fp 8 24) #x265BE30C)))
(check-sat)
(exit)
