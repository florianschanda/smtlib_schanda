...
(assert (= z ((_ to_fp 8 24) #xC9C8DEB4)))
;; z should be Float32(0xC9C8DEB4 [Rational(-3291053, 2), -1645526.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010011 #b10010001101111010110100))))
(check-sat)
(exit)
