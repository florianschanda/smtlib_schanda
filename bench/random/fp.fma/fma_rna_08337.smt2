...
(assert (= y (fp #b0 #b10010101 #b00000100101101000111111)))
;; y should be Float32(0x4A825A3F [Rational(8542783, 2), 4271391.500000])
...
(assert (= result (fp #b0 #b00010111 #b00000100101101000111100)))
(check-sat)
(exit)
