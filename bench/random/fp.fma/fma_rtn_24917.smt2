...
(assert (= z ((_ to_fp 8 24) #x42178864)))
;; z should be Float32(0x42178864 [Rational(2482713, 65536), 37.883194])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10000100 #b00101111000100001100100))))
(check-sat)
(exit)
