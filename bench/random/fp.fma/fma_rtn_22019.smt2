...
(assert (= y ((_ to_fp 8 24) #x7FF5C660)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b11110100 #b10011000111100001001001)))
;; z should be Float32(0xFA4C7849 [Rational(-265417057987351644491934812505899008), -265417057987351644491934812505899008.000000])
