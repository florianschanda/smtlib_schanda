...
(assert (= y (fp #b1 #b10010101 #b10011001000100011101111)))
;; y should be Float32(0xCACC88EF [Rational(-13404399, 2), -6702199.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8BCC88EB))))
(check-sat)
(exit)
