...
(assert (= y (fp #b0 #b00000000 #b01001110011110101001101)))
;; y should be Float32(0x00273D4D [Rational(2571597, 713623846352979940529142984724747568191373312), 0.000000])
