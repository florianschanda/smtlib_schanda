...
(assert (= z ((_ to_fp 8 24) #x7210B1F4)))
;; z should be Float32(0x7210B1F4 [Rational(2865982306673107165038310850560), 2865982306673107165038310850560.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b11100100 #b00100001011000111110011))))
(check-sat)
(exit)
