...
(assert (= x (fp #b1 #b00000000 #b00111110011000011001100)))
;; x should be Float32(0x801F30CC [Rational(-511027, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3F79865F)))
(check-sat)
(exit)
