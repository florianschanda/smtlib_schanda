...
(assert (= x (fp #b0 #b00000000 #b01110011101100111100010)))
;; x should be Float32(0x0039D9E2 [Rational(1895665, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBFE76788)))
(check-sat)
(exit)
