...
(assert (= z (fp #b1 #b10010100 #b01110001000110001110010)))
;; z should be Float32(0xCA388C72 [Rational(-6047289, 2), -3023644.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010100 #b01110001000110001110010))))
(check-sat)
(exit)
