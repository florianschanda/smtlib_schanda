...
(assert (= y (fp #b0 #b10010100 #b00101101000010001111110)))
;; y should be Float32(0x4A16847E [Rational(4932159, 2), 2466079.500000])
...
(assert (not (= result (fp #b1 #b00010110 #b00101101000010010000001))))
(check-sat)
(exit)
