...
(assert (= x ((_ to_fp 8 24) #xFF82E9DA)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x802FCA16)))
;; y should be Float32(0x802FCA16 [Rational(-1565963, 356811923176489970264571492362373784095686656), -0.000000])
