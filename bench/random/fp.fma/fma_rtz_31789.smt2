...
(assert (= y ((_ to_fp 8 24) #x4A0404EA)))
;; y should be Float32(0x4A0404EA [Rational(4326005, 2), 2163002.500000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x4A16C90A)))
;; z should be Float32(0x4A16C90A [Rational(4940933, 2), 2470466.500000])
