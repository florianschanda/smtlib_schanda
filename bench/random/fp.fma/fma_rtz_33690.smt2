...
(assert (= x (fp #b1 #b00000000 #b01101000001001101010110)))
;; x should be Float32(0x80341356 [Rational(-1706411, 356811923176489970264571492362373784095686656), -0.000000])
