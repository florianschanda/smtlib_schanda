...
(assert (= z (fp #b1 #b01001111 #b01011100101001100100100)))
;; z should be Float32(0xA7AE5324 [Rational(-2856137, 590295810358705651712), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xA7AE5323))))
(check-sat)
(exit)
