...
(assert (= y (fp #b1 #b00000000 #b00010011010011000000100)))
;; y should be Float32(0x8009A604 [Rational(-158081, 178405961588244985132285746181186892047843328), -0.000000])
