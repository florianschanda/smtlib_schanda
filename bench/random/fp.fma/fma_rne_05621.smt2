...
(assert (= y (fp #b1 #b10010101 #b01100111110101000000111)))
;; y should be Float32(0xCAB3EA07 [Rational(-11790855, 2), -5895427.500000])
...
(assert (= result ((_ to_fp 8 24) #x0059F502)))
(check-sat)
(exit)
