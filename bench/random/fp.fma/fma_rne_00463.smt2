...
(assert (= x ((_ to_fp 8 24) #x4A1B4076)))
;; x should be Float32(0x4A1B4076 [Rational(5087291, 2), 2543645.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b00110110100000001110110))))
(check-sat)
(exit)
