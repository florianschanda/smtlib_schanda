...
(assert (= y (fp #b1 #b01010101 #b11100100101101011010000)))
;; y should be Float32(0xAAF25AD0 [Rational(-992685, 2305843009213693952), -0.000000])
...
(assert (= result (fp #b0 #b11010101 #b11100100101101011010000)))
(check-sat)
(exit)
