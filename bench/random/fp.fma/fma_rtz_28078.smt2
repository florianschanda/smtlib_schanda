...
(assert (= x (fp #b0 #b10010101 #b01001110010000010011111)))
;; x should be Float32(0x4AA7209F [Rational(10952863, 2), 5476431.500000])
...
(assert (= result (fp #b1 #b00010111 #b01001110010000010100001)))
(check-sat)
(exit)
