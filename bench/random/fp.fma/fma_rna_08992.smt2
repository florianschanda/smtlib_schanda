...
(assert (= y (fp #b1 #b00000000 #b00011000011100011011100)))
;; y should be Float32(0x800C38DC [Rational(-200247, 178405961588244985132285746181186892047843328), -0.000000])
