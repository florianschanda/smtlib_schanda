...
(assert (= y (fp #b0 #b00000000 #b01001111100001011010010)))
;; y should be Float32(0x0027C2D2 [Rational(1302889, 356811923176489970264571492362373784095686656), 0.000000])
