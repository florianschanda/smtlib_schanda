...
(assert (= x (fp #b0 #b00000000 #b10001101111010011100110)))
;; x should be Float32(0x0046F4E6 [Rational(2325107, 356811923176489970264571492362373784095686656), 0.000000])
