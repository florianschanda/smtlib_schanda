...
(assert (= x (fp #b0 #b10010101 #b00101001001001101000111)))
;; x should be Float32(0x4A949347 [Rational(9737031, 2), 4868515.500000])
...
(assert (= z (fp #b0 #b11111111 #b01111110111110100101110)))
