...
(assert (= y ((_ to_fp 8 24) #xCAA6DB63)))
;; y should be Float32(0xCAA6DB63 [Rational(-10935139, 2), -5467569.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b01001101101101101100101))))
(check-sat)
(exit)
