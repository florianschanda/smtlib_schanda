...
(assert (= z (fp #b0 #b10010011 #b01110011110011100110100)))
;; z should be Float32(0x49B9E734 [Rational(3045837, 2), 1522918.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010011 #b01110011110011100110100))))
(check-sat)
(exit)
