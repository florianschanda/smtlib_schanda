...
(assert (= z ((_ to_fp 8 24) #xCAF87929)))
;; z should be Float32(0xCAF87929 [Rational(-16283945, 2), -8141972.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010101 #b11110000111100100101000)))
(check-sat)
(exit)
