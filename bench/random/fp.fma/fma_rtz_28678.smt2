...
(assert (= y (fp #b0 #b00000000 #b10011101101011100000110)))
;; y should be Float32(0x004ED706 [Rational(2583427, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x401DAE0B)))
(check-sat)
(exit)
