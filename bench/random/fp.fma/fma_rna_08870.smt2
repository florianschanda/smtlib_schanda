...
(assert (= y ((_ to_fp 8 24) #xCAAE4575)))
;; y should be Float32(0xCAAE4575 [Rational(-11421045, 2), -5710522.500000])
...
(assert (= result (fp #b1 #b00010111 #b01011100100010101110101)))
(check-sat)
(exit)
