...
(assert (= z ((_ to_fp 8 24) #xF6970054)))
;; z should be Float32(0xF6970054 [Rational(-1531334923446113613500903912898560), -1531334923446113613500903912898560.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #xF6970054))))
(check-sat)
(exit)
