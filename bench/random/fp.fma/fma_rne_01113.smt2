...
(assert (= y (fp #b0 #b10010101 #b00110110110101001101101)))
;; y should be Float32(0x4A9B6A6D [Rational(10185325, 2), 5092662.500000])

(declare-const z Float32)
(assert (= z (fp #b1 #b10010011 #b11011101010000010100100)))
;; z should be Float32(0xC9EEA0A4 [Rational(-3909673, 2), -1954836.500000])
