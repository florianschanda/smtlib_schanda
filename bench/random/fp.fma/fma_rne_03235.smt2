...
(assert (= x (fp #b0 #b00000000 #b01011000110000100100000)))
;; x should be Float32(0x002C6120 [Rational(90889, 22300745198530623141535718272648361505980416), 0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xFF968662)))
