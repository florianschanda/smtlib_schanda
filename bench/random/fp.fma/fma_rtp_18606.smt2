...
(assert (= y (fp #b1 #b10010010 #b01001101101100111111000)))
;; y should be Float32(0xC926D9F8 [Rational(-1366847, 2), -683423.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0A26DA07))))
(check-sat)
(exit)
