...
(assert (= y ((_ to_fp 8 24) #x67A4CC24)))
;; y should be Float32(0x67A4CC24 [Rational(1556467666110087857963008), 1556467666110087857963008.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xA8A4CC23))))
(check-sat)
(exit)
