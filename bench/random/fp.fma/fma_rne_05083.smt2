...
(assert (= y ((_ to_fp 8 24) #x4A856AC1)))
;; y should be Float32(0x4A856AC1 [Rational(8743617, 2), 4371808.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b00001010110101011000001))))
(check-sat)
(exit)
