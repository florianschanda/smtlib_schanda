...
(assert (= z (fp #b0 #b10010101 #b00100010110011111101011)))
;; z should be Float32(0x4A9167EB [Rational(9529323, 2), 4764661.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4A9167EA))))
(check-sat)
(exit)
