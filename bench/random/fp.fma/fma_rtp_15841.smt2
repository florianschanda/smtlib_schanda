...
(assert (= y ((_ to_fp 8 24) #xDE3EA867)))
;; y should be Float32(0xDE3EA867 [Rational(-3434585978247839744), -3434585978247839744.000000])
...
(assert (= result (fp #b1 #b00111110 #b01111101010100001100111)))
(check-sat)
(exit)
