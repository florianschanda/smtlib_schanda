...
(assert (= y ((_ to_fp 8 24) #xFF9857F3)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x807EE739)))
;; z should be Float32(0x807EE739 [Rational(-8316729, 713623846352979940529142984724747568191373312), -0.000000])
