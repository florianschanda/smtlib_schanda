...
(assert (= z (fp #b1 #b00000000 #b11000100111010101010100)))
;; z should be Float32(0x80627554 [Rational(-1613141, 178405961588244985132285746181186892047843328), -0.000000])
