...
(assert (= z (fp #b0 #b10010100 #b00010100100101110110010)))
;; z should be Float32(0x4A0A4BB2 [Rational(4531673, 2), 2265836.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4A0A4BB3))))
(check-sat)
(exit)
