...
(assert (= z ((_ to_fp 8 24) #x090486A1)))
;; z should be Float32(0x090486A1 [Rational(8685217, 5444517870735015415413993718908291383296), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x090486A1))))
(check-sat)
(exit)
