...
(assert (= y (fp #b1 #b00000000 #b11110010100111010001111)))
;; y should be Float32(0x80794E8F [Rational(-7949967, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFA07906)))
