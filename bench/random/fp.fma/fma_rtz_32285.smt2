...
(assert (= y (fp #b0 #b00000000 #b01101011110111101100100)))
;; y should be Float32(0x0035EF64 [Rational(883673, 178405961588244985132285746181186892047843328), 0.000000])
