...
(assert (= x (fp #b0 #b10010101 #b10001011011011110110111)))
;; x should be Float32(0x4AC5B7B7 [Rational(12957623, 2), 6478811.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b10001011011011110111001))))
(check-sat)
(exit)
