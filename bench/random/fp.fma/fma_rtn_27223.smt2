...
(assert (= x ((_ to_fp 8 24) #x7FC36E99)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b10110111 #b10110100111101011110011)))
;; y should be Float32(0x5BDA7AF3 [Rational(122993458037129216), 122993458037129216.000000])
