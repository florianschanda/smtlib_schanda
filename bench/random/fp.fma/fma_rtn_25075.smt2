...
(assert (= y ((_ to_fp 8 24) #x003C1CF5)))
;; y should be Float32(0x003C1CF5 [Rational(3939573, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBFF073D4)))
(check-sat)
(exit)
