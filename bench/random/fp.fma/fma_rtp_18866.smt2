...
(assert (= z (fp #b1 #b00000000 #b10111001011000110011100)))
;; z should be Float32(0x805CB19C [Rational(-1518695, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b00000000 #b10111001011000110011100)))
(check-sat)
(exit)
