...
(assert (= z ((_ to_fp 8 24) #x07C45ADC)))
;; z should be Float32(0x07C45ADC [Rational(3217079, 10889035741470030830827987437816582766592), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x07C45ADC)))
(check-sat)
(exit)
