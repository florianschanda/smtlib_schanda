...
(assert (= x (fp #b0 #b00000000 #b10001011011001010110111)))
;; x should be Float32(0x0045B2B7 [Rational(4567735, 713623846352979940529142984724747568191373312), 0.000000])
