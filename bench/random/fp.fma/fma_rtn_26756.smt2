...
(assert (= x (fp #b1 #b00000000 #b11010100001101111101010)))
;; x should be Float32(0x806A1BEA [Rational(-3476981, 356811923176489970264571492362373784095686656), -0.000000])
