...
(assert (= x (fp #b0 #b10010100 #b11010101010100101011110)))
;; x should be Float32(0x4A6AA95E [Rational(7689391, 2), 3844695.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b10001010101010110101000))))
(check-sat)
(exit)
