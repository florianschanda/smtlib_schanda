...
(assert (= y (fp #b0 #b00000000 #b11000000110000110000001)))
;; y should be Float32(0x00606181 [Rational(6316417, 713623846352979940529142984724747568191373312), 0.000000])
