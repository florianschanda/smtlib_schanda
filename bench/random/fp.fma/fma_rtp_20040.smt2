...
(assert (= x (fp #b1 #b00000000 #b10101000111100111101100)))
;; x should be Float32(0x805479EC [Rational(-1384059, 178405961588244985132285746181186892047843328), -0.000000])
