...
(assert (= x (fp #b0 #b00100010 #b11101000100001000000110)))
;; x should be Float32(0x11744206 [Rational(8003843, 41538374868278621028243970633760768), 0.000000])
...
(assert (= result (fp #b0 #b10100010 #b11101000100001000000101)))
(check-sat)
(exit)
