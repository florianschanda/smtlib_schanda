...
(assert (= x (fp #b1 #b00000000 #b10011001001010011000110)))
;; x should be Float32(0x804C94C6 [Rational(-2509411, 356811923176489970264571492362373784095686656), -0.000000])
