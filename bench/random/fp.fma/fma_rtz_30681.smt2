...
(assert (= x (fp #b0 #b00000000 #b00111101111000101101100)))
;; x should be Float32(0x001EF16C [Rational(506971, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xFFB9C7FF)))
