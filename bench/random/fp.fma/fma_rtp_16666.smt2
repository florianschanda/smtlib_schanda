...
(assert (= x (fp #b0 #b00000000 #b10000001111011100000100)))
;; x should be Float32(0x0040F704 [Rational(1064385, 178405961588244985132285746181186892047843328), 0.000000])
