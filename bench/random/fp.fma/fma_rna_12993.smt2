...
(assert (= x ((_ to_fp 8 24) #xE3C7831E)))
;; x should be Float32(0xE3C7831E [Rational(-7360700119472941301760), -7360700119472941301760.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7FD11E4E)))
