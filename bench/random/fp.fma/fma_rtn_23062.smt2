...
(assert (= y ((_ to_fp 8 24) #xEA532BA0)))
;; y should be Float32(0xEA532BA0 [Rational(-63822340294125486033862656), -63822340294125486033862656.000000])
...
(assert (not (= result (fp #b1 #b00111111 #b10100110010101110100001))))
(check-sat)
(exit)
