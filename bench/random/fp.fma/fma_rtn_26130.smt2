...
(assert (= y (fp #b0 #b11101110 #b01011111101111101110001)))
;; y should be Float32(0x772FDF71 [Rational(3567124532685833083466895176237056), 3567124532685833083466895176237056.000000])
...
(assert (= result ((_ to_fp 8 24) #xACAFDF71)))
(check-sat)
(exit)
