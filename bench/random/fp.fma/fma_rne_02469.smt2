...
(assert (= z (fp #b1 #b00000000 #b10011110000001101001101)))
;; z should be Float32(0x804F034D [Rational(-5178189, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x804F034D)))
(check-sat)
(exit)
