...
(assert (= x ((_ to_fp 8 24) #x4A55875E)))
;; x should be Float32(0x4A55875E [Rational(6996911, 2), 3498455.500000])
...
(assert (not (= result (fp #b1 #b00010110 #b10101011000011101100000))))
(check-sat)
(exit)
