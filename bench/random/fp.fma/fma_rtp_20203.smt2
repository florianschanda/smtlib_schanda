...
(assert (= x ((_ to_fp 8 24) #x8056706F)))
;; x should be Float32(0x8056706F [Rational(-5664879, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b11111100011001101110101)))
