...
(assert (= z (fp #b1 #b00000000 #b00101010010011011010000)))
;; z should be Float32(0x801526D0 [Rational(-86637, 44601490397061246283071436545296723011960832), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00101010010011011010000))))
(check-sat)
(exit)
