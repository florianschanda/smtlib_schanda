...
(assert (= z (fp #b0 #b10010101 #b00011000010101110011111)))
;; z should be Float32(0x4A8C2B9F [Rational(9186207, 2), 4593103.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b00011000010101110011111)))
(check-sat)
(exit)
