...
(assert (= x ((_ to_fp 8 24) #xFF956939)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x00013B10)))
;; y should be Float32(0x00013B10 [Rational(5041, 44601490397061246283071436545296723011960832), 0.000000])
