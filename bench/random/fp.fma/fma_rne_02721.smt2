...
(assert (= x (fp #b0 #b01100111 #b00000110111111110010110)))
;; x should be Float32(0x33837F96 [Rational(4308939, 70368744177664), 0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xCA511FE6)))
;; y should be Float32(0xCA511FE6 [Rational(-6852595, 2), -3426297.500000])
