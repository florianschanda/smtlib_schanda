...
(assert (= z (fp #b0 #b00000000 #b00100110111110000011101)))
;; z should be Float32(0x00137C1D [Rational(1276957, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x00137C1D)))
(check-sat)
(exit)
