...
(assert (= x (fp #b0 #b00000000 #b00100010100001011101011)))
;; x should be Float32(0x001142EB [Rational(1131243, 713623846352979940529142984724747568191373312), 0.000000])
