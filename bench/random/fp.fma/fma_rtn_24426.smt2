...
(assert (= x ((_ to_fp 8 24) #xCA0024B6)))
;; x should be Float32(0xCA0024B6 [Rational(-4199003, 2), -2099501.500000])
...
(assert (= z ((_ to_fp 8 24) #xCAB17331)))
;; z should be Float32(0xCAB17331 [Rational(-11629361, 2), -5814680.500000])
