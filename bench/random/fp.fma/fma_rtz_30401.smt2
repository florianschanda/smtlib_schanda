...
(assert (= x (fp #b0 #b00000000 #b11010110011010001100100)))
;; x should be Float32(0x006B3464 [Rational(1756441, 178405961588244985132285746181186892047843328), 0.000000])
