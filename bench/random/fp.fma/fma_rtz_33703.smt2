...
(assert (= x (fp #b1 #b00000000 #b11010011010100100000100)))
;; x should be Float32(0x8069A904 [Rational(-1731137, 178405961588244985132285746181186892047843328), -0.000000])
