...
(assert (= x (fp #b0 #b11011000 #b11110100010000010010100)))
;; x should be Float32(0x6C7A2094 [Rational(1209541202996928125348085760), 1209541202996928125348085760.000000])
...
(assert (= z ((_ to_fp 8 24) #xFFB5925F)))
