...
(assert (= x (fp #b1 #b11111111 #b00010001001100000101101)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x8054EAA9)))
;; y should be Float32(0x8054EAA9 [Rational(-5565097, 713623846352979940529142984724747568191373312), -0.000000])
