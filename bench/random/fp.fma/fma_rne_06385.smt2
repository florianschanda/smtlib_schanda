...
(assert (= x (fp #b1 #b00000000 #b10101000100000010010111)))
;; x should be Float32(0x80544097 [Rational(-5521559, 713623846352979940529142984724747568191373312), -0.000000])
