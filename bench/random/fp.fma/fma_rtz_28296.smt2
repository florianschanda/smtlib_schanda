...
(assert (= y (fp #b0 #b11100100 #b00110010000010011000111)))
;; y should be Float32(0x721904C7 [Rational(3030846845239958085823222513664), 3030846845239958085823222513664.000000])
