...
(assert (= y (fp #b0 #b00000000 #b10001110110000111111000)))
;; y should be Float32(0x004761F8 [Rational(584767, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (not (= result (fp #b0 #b10000000 #b00011101100001111101111))))
(check-sat)
(exit)
