...
(assert (= y ((_ to_fp 8 24) #x39086FFB)))
;; y should be Float32(0x39086FFB [Rational(8941563, 68719476736), 0.000130])
...
(assert (= result (fp #b1 #b11110010 #b00010000110111111111011)))
(check-sat)
(exit)
