...
(assert (= x (fp #b1 #b10101110 #b11100110100101111101101)))
;; x should be Float32(0xD7734BED [Rational(-267507424296960), -267507424296960.000000])
...
(assert (= result (fp #b1 #b00110000 #b11100110100101111101101)))
(check-sat)
(exit)
