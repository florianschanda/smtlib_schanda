...
(assert (= x ((_ to_fp 8 24) #x7FE79DE7)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b1 #b00000000 #b00111110011010011100010)))
;; y should be Float32(0x801F34E2 [Rational(-1022577, 356811923176489970264571492362373784095686656), -0.000000])
