...
(assert (= x (fp #b0 #b00000000 #b11010000111100101110111)))
;; x should be Float32(0x00687977 [Rational(6846839, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b10100001111001011101101))))
(check-sat)
(exit)
