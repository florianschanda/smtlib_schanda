...
(assert (= z (fp #b0 #b10010100 #b11011101111011110101010)))
;; z should be Float32(0x4A6EF7AA [Rational(7830485, 2), 3915242.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010100 #b11011101111011110101001)))
(check-sat)
(exit)
