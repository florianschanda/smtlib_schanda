...
(assert (= x (fp #b0 #b00000000 #b01001000101010110100110)))
;; x should be Float32(0x002455A6 [Rational(1190611, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result (fp #b1 #b01111111 #b00100010101011010010111))))
(check-sat)
(exit)
