...
(assert (= y (fp #b1 #b11000000 #b11101110001011011000000)))
;; y should be Float32(0xE07716C0 [Rational(-71218517132353470464), -71218517132353470464.000000])
...
(assert (= result (fp #b0 #b00101011 #b11101110001011011000000)))
(check-sat)
(exit)
