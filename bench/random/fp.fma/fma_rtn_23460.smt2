...
(assert (= x (fp #b0 #b10100011 #b10000100111011000001111)))
;; x should be Float32(0x51C2760F [Rational(104400543744), 104400543744.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b01011001111001000000010)))
