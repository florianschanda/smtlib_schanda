...
(assert (= x (fp #b0 #b00000000 #b01010010111010101101101)))
;; x should be Float32(0x0029756D [Rational(2717037, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBFA5D5B3)))
(check-sat)
(exit)
