...
(assert (= y (fp #b0 #b10010100 #b10000111100011110011010)))
;; y should be Float32(0x4A43C79A [Rational(6415309, 2), 3207654.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0B43C798))))
(check-sat)
(exit)
