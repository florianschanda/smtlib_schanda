...
(assert (= z ((_ to_fp 8 24) #xCACD8B57)))
;; z should be Float32(0xCACD8B57 [Rational(-13470551, 2), -6735275.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010101 #b10011011000101101010111))))
(check-sat)
(exit)
