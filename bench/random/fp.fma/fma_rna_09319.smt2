...
(assert (= z (fp #b0 #b00000000 #b00000101110000011000001)))
;; z should be Float32(0x0002E0C1 [Rational(188609, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b00000000 #b00000101110000011000001)))
(check-sat)
(exit)
