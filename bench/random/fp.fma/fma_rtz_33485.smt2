...
(assert (= x ((_ to_fp 8 24) #xE785017C)))
;; x should be Float32(0xE785017C [Rational(-1256204248214794452074496), -1256204248214794452074496.000000])
...
(assert (= result (fp #b0 #b01010001 #b00001010000000101111100)))
(check-sat)
(exit)
