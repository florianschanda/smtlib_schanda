...
(assert (= y (fp #b0 #b11111111 #b11101111010010101010000)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b10010001 #b11011110000011000110000)))
;; z should be Float32(0xC8EF0630 [Rational(-979043, 2), -489521.500000])
