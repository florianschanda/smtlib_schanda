...
(assert (= z ((_ to_fp 8 24) #x6E915310)))
;; z should be Float32(0x6E915310 [Rational(22487871412493387550458642432), 22487871412493387550458642432.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x6E915310))))
(check-sat)
(exit)
