...
(assert (= x (fp #b0 #b00000000 #b11011011111111011111100)))
;; x should be Float32(0x006DFEFC [Rational(1802175, 178405961588244985132285746181186892047843328), 0.000000])
