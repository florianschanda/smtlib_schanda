...
(assert (= y (fp #b1 #b00000000 #b10111001001001110010001)))
;; y should be Float32(0x805C9391 [Rational(-6067089, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC0392721))))
(check-sat)
(exit)
