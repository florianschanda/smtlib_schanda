...
(assert (= z (fp #b0 #b11010001 #b01010010010010100010010)))
;; z should be Float32(0x68A92512 [Rational(6390110097379119817818112), 6390110097379119817818112.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x68A92512)))
(check-sat)
(exit)
