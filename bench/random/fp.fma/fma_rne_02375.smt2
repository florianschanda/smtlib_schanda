...
(assert (= y (fp #b1 #b10010011 #b11110011110110101101100)))
;; y should be Float32(0xC9F9ED6C [Rational(-4094811, 2), -2047405.500000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b00110000001110001000001)))
