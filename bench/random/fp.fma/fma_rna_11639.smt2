...
(assert (= z (fp #b1 #b10010011 #b11010101110100110001100)))
;; z should be Float32(0xC9EAE98C [Rational(-3848803, 2), -1924401.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b10010011 #b11010101110100110001100)))
(check-sat)
(exit)
