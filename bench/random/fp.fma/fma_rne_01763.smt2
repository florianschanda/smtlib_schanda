...
(assert (= y ((_ to_fp 8 24) #xF8D869A0)))
;; y should be Float32(0xF8D869A0 [Rational(-35114951592434639857847394860269568), -35114951592434639857847394860269568.000000])
...
(assert (= result ((_ to_fp 8 24) #xB9D8699E)))
(check-sat)
(exit)
