...
(assert (= x ((_ to_fp 8 24) #xD0159A7F)))
;; x should be Float32(0xD0159A7F [Rational(-10039720960), -10039720960.000000])
...
(assert (not (= result (fp #b0 #b00001011 #b00101011001101001111111))))
(check-sat)
(exit)
