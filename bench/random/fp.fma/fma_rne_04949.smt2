...
(assert (= z ((_ to_fp 8 24) #x0057FFE0)))
;; z should be Float32(0x0057FFE0 [Rational(180223, 22300745198530623141535718272648361505980416), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b00000000 #b10101111111111111100000)))
(check-sat)
(exit)
