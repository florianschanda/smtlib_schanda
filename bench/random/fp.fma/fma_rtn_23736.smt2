...
(assert (= x (fp #b0 #b00000000 #b00011110001000000010101)))
;; x should be Float32(0x000F1015 [Rational(987157, 713623846352979940529142984724747568191373312), 0.000000])
