...
(assert (= x (fp #b0 #b10010101 #b01111101001001110000101)))
;; x should be Float32(0x4ABE9385 [Rational(12489605, 2), 6244802.500000])
...
(assert (= z (fp #b0 #b11111111 #b01000111000011100100111)))
