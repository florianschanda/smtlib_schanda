...
(assert (= z ((_ to_fp 8 24) #xBF1A919C)))
;; z should be Float32(0xBF1A919C [Rational(-2532455, 4194304), -0.603784])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b01111110 #b00110101001000110010100))))
(check-sat)
(exit)
