...
(assert (= y (fp #b1 #b10100001 #b10111100111100101011001)))
;; y should be Float32(0xD0DE7959 [Rational(-29859956736), -29859956736.000000])
...
(assert (= result ((_ to_fp 8 24) #x91DE7959)))
(check-sat)
(exit)
