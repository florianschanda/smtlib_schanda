...
(assert (= z ((_ to_fp 8 24) #x4A8EF609)))
;; z should be Float32(0x4A8EF609 [Rational(9369097, 2), 4684548.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10010101 #b00011101111011000001001))))
(check-sat)
(exit)
