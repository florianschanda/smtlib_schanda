...
(assert (= y (fp #b0 #b11010101 #b10010110100101010111001)))
;; y should be Float32(0x6ACB4AB9 [Rational(122882404574577856239108096), 122882404574577856239108096.000000])
...
(assert (not (= result (fp #b1 #b01010111 #b10010110100101010111010))))
(check-sat)
(exit)
