...
(assert (= x (fp #b0 #b10010101 #b10010111000101000111101)))
;; x should be Float32(0x4ACB8A3D [Rational(13339197, 2), 6669598.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0065C51E))))
(check-sat)
(exit)
