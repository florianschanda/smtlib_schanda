...
(assert (= z ((_ to_fp 8 24) #xF2C318FB)))
;; z should be Float32(0xF2C318FB [Rational(-7728611385448990692156658155520), -7728611385448990692156658155520.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b11100101 #b10000110001100011111011))))
(check-sat)
(exit)
