...
(assert (= z (fp #b1 #b00000000 #b11011111010111001000010)))
;; z should be Float32(0x806FAE42 [Rational(-3659553, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b00000000 #b11011111010111001000001))))
(check-sat)
(exit)
