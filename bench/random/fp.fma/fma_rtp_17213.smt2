...
(assert (= z ((_ to_fp 8 24) #x8042A73A)))
;; z should be Float32(0x8042A73A [Rational(-2184093, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b00000000 #b10000101010011100111010))))
(check-sat)
(exit)
