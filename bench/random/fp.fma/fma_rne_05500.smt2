...
(assert (= z ((_ to_fp 8 24) #x0038A28A)))
;; z should be Float32(0x0038A28A [Rational(1855813, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b00000000 #b01110001010001010001010)))
(check-sat)
(exit)
