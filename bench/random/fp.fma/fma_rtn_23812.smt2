...
(assert (= x ((_ to_fp 8 24) #x007AC3C6)))
;; x should be Float32(0x007AC3C6 [Rational(4022755, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xFFAFC247)))
