...
(assert (= x (fp #b1 #b00000000 #b11110111101111011111111)))
;; x should be Float32(0x807BDEFF [Rational(-8118015, 713623846352979940529142984724747568191373312), -0.000000])
