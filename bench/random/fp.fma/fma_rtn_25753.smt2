...
(assert (= z (fp #b0 #b01110001 #b01100000100011001100000)))
;; z should be Float32(0x38B04660 [Rational(361011, 4294967296), 0.000084])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b01110001 #b01100000100011001011111))))
(check-sat)
(exit)
