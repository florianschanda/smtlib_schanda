...
(assert (= x (fp #b1 #b11011111 #b01111000010000101010111)))
;; x should be Float32(0xEFBC2157 [Rational(-116446974488688330684315467776), -116446974488688330684315467776.000000])
