...
(assert (= y (fp #b1 #b00000000 #b10001101100100101001010)))
;; y should be Float32(0x8046C94A [Rational(-2319525, 356811923176489970264571492362373784095686656), -0.000000])
