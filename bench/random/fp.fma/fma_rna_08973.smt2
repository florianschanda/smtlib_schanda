...
(assert (= y ((_ to_fp 8 24) #xF95192C1)))
;; y should be Float32(0xF95192C1 [Rational(-68010410391954835703870349092323328), -68010410391954835703870349092323328.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBA5192C1))))
(check-sat)
(exit)
