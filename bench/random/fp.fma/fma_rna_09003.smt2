...
(assert (= y (fp #b1 #b00000000 #b01111100000010000100100)))
;; y should be Float32(0x803E0424 [Rational(-1016073, 178405961588244985132285746181186892047843328), -0.000000])
