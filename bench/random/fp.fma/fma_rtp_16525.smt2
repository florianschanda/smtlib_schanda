...
(assert (= x (fp #b0 #b10111100 #b11110001011100000011110)))
;; x should be Float32(0x5E78B81E [Rational(4480526925617430528), 4480526925617430528.000000])
...
(assert (= result ((_ to_fp 8 24) #x9F78B81E)))
(check-sat)
(exit)
