...
(assert (= x (fp #b1 #b00000100 #b00010111110100011011011)))
;; x should be Float32(0x820BE8DB [Rational(-9169115, 89202980794122492566142873090593446023921664), -0.000000])
