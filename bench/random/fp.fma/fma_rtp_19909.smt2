...
(assert (= x (fp #b1 #b00000000 #b00000101100001000000111)))
;; x should be Float32(0x8002C207 [Rational(-180743, 713623846352979940529142984724747568191373312), -0.000000])
