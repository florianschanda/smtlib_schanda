...
(assert (= y ((_ to_fp 8 24) #x00026455)))
;; y should be Float32(0x00026455 [Rational(156757, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const z Float32)
(assert (= z (fp #b0 #b11111111 #b01110101010001101101100)))
