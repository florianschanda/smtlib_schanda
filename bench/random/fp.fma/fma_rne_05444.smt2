...
(assert (= y ((_ to_fp 8 24) #x4AFBDA5B)))
;; y should be Float32(0x4AFBDA5B [Rational(16505435, 2), 8252717.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b11111011110110100101110))))
(check-sat)
(exit)
