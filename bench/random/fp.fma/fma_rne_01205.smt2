...
(assert (= z ((_ to_fp 8 24) #x2FA5BFF4)))
;; z should be Float32(0x2FA5BFF4 [Rational(2715645, 9007199254740992), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b01101010 #b00000000001010010110111)))
(check-sat)
(exit)
