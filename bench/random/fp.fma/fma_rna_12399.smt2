...
(assert (= z (fp #b1 #b10010101 #b10100001101110011111001)))
;; z should be Float32(0xCAD0DCF9 [Rational(-13688057, 2), -6844028.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b10010101 #b10100001101110011111001)))
(check-sat)
(exit)
