...
(assert (= z ((_ to_fp 8 24) #x3DEFF54B)))
;; z should be Float32(0x3DEFF54B [Rational(15725899, 134217728), 0.117167])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b01111011 #b11011111111010101001011)))
(check-sat)
(exit)
