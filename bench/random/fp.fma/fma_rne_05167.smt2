...
(assert (= z (fp #b1 #b00000000 #b01011110001001011010001)))
;; z should be Float32(0x802F12D1 [Rational(-3085009, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x802F12D1))))
(check-sat)
(exit)
