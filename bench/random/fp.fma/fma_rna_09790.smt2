...
(assert (= x (fp #b0 #b00000000 #b10001101011100111100110)))
;; x should be Float32(0x0046B9E6 [Rational(2317555, 356811923176489970264571492362373784095686656), 0.000000])
