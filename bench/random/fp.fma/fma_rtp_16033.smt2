...
(assert (= y ((_ to_fp 8 24) #x635CCD0E)))
;; y should be Float32(0x635CCD0E [Rational(4073059443643550531584), 4073059443643550531584.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x18DCCD0E))))
(check-sat)
(exit)
