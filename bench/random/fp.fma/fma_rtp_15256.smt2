...
(assert (= z ((_ to_fp 8 24) #x80175926)))
;; z should be Float32(0x80175926 [Rational(-765075, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x80175925)))
(check-sat)
(exit)
