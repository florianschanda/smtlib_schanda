...
(assert (= z ((_ to_fp 8 24) #x8046899F)))
;; z should be Float32(0x8046899F [Rational(-4622751, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b00000000 #b10001101000100110011111))))
(check-sat)
(exit)
