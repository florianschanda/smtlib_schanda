...
(assert (= x (fp #b0 #b10010100 #b01011001100100010101010)))
;; x should be Float32(0x4A2CC8AA [Rational(5661781, 2), 2830890.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b01011001100100010100110))))
(check-sat)
(exit)
