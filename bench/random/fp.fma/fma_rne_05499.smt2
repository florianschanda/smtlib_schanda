...
(assert (= z ((_ to_fp 8 24) #x5C9B3E14)))
;; z should be Float32(0x5C9B3E14 [Rational(349575016083357696), 349575016083357696.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10111001 #b00110110011111000010100))))
(check-sat)
(exit)
