...
(assert (= y (fp #b1 #b00000000 #b01100110000010100110100)))
;; y should be Float32(0x80330534 [Rational(-835917, 178405961588244985132285746181186892047843328), -0.000000])
