...
(assert (= y (fp #b1 #b00000000 #b00001111100000100000001)))
;; y should be Float32(0x8007C101 [Rational(-508161, 713623846352979940529142984724747568191373312), -0.000000])
