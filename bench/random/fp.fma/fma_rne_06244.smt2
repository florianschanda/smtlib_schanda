...
(assert (= x (fp #b1 #b00000000 #b00111001101111011010101)))
;; x should be Float32(0x801CDED5 [Rational(-1892053, 713623846352979940529142984724747568191373312), -0.000000])
