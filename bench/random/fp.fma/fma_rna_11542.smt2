...
(assert (= y ((_ to_fp 8 24) #x7F9D9296)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x0056E18F)))
;; z should be Float32(0x0056E18F [Rational(5693839, 713623846352979940529142984724747568191373312), 0.000000])
