...
(assert (= x ((_ to_fp 8 24) #x0028AE3E)))
;; x should be Float32(0x0028AE3E [Rational(1333023, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3FA2B8F8))))
(check-sat)
(exit)
