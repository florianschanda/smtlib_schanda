...
(assert (= z ((_ to_fp 8 24) #x05B12ED5)))
;; z should be Float32(0x05B12ED5 [Rational(11611861, 696898287454081973172991196020261297061888), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x05B12ED5)))
(check-sat)
(exit)
