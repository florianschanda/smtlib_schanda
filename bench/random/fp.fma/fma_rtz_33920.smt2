...
(assert (= x ((_ to_fp 8 24) #x806794A6)))
;; x should be Float32(0x806794A6 [Rational(-3394131, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7F91A902)))
