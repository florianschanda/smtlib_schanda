...
(assert (= y (fp #b1 #b10011010 #b00110001001011000111000)))
;; y should be Float32(0xCD189638 [Rational(-159998848), -159998848.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x82989637))))
(check-sat)
(exit)
