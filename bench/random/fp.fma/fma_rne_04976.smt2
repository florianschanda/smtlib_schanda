...
(assert (= z ((_ to_fp 8 24) #xFF48660B)))
;; z should be Float32(0xFF48660B [Rational(-266375436543059367167246186101413511168), -266375436543059367167246186101413511168.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b11111110 #b10010000110011000001011))))
(check-sat)
(exit)
