...
(assert (= z (fp #b0 #b10010101 #b11001001111001110001001)))
;; z should be Float32(0x4AE4F389 [Rational(15004553, 2), 7502276.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4AE4F389))))
(check-sat)
(exit)
