...
(assert (= z ((_ to_fp 8 24) #x004B5983)))
;; z should be Float32(0x004B5983 [Rational(4938115, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x004B5982)))
(check-sat)
(exit)
