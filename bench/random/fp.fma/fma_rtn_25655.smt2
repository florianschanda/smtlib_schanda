...
(assert (= y (fp #b0 #b10010100 #b11111100010100101101010)))
;; y should be Float32(0x4A7E296A [Rational(8328373, 2), 4164186.500000])
...
(assert (not (= result (fp #b1 #b00010110 #b11111100010100101100111))))
(check-sat)
(exit)
