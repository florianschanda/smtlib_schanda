...
(assert (= y ((_ to_fp 8 24) #x8060C9B6)))
;; y should be Float32(0x8060C9B6 [Rational(-3171547, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x4041936B)))
(check-sat)
(exit)
