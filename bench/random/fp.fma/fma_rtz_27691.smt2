...
(assert (= z (fp #b0 #b10101110 #b10110100101101111001000)))
;; z should be Float32(0x575A5BC8 [Rational(240087732322304), 240087732322304.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x575A5BC8))))
(check-sat)
(exit)
