...
(assert (= x ((_ to_fp 8 24) #xCC75B6EF)))
;; x should be Float32(0xCC75B6EF [Rational(-64412604), -64412604.000000])
...
(assert (not (= result (fp #b0 #b00000011 #b11101011011011011101111))))
(check-sat)
(exit)
