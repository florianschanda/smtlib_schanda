...
(assert (= x (fp #b0 #b00000000 #b11001011111001111010100)))
;; x should be Float32(0x0065F3D4 [Rational(1670389, 178405961588244985132285746181186892047843328), 0.000000])
