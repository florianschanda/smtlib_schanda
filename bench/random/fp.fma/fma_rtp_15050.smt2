...
(assert (= z ((_ to_fp 8 24) #x4ADE5A57)))
;; z should be Float32(0x4ADE5A57 [Rational(14572119, 2), 7286059.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10010101 #b10111100101101001010000)))
(check-sat)
(exit)
