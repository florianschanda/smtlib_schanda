...
(assert (= x (fp #b0 #b11001100 #b01010011100101000000111)))
;; x should be Float32(0x6629CA07 [Rational(200451670577754409009152), 200451670577754409009152.000000])
...
(assert (not (= result (fp #b1 #b01001110 #b01010011100101000000110))))
(check-sat)
(exit)
