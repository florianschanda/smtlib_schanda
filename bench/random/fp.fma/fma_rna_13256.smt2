...
(assert (= x (fp #b1 #b00000000 #b01001011100010111000110)))
;; x should be Float32(0x8025C5C6 [Rational(-1237731, 356811923176489970264571492362373784095686656), -0.000000])
