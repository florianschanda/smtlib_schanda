...
(assert (= x (fp #b1 #b00000000 #b01101001101101101000100)))
;; x should be Float32(0x8034DB44 [Rational(-866001, 178405961588244985132285746181186892047843328), -0.000000])
