...
(assert (= x ((_ to_fp 8 24) #x8006E0C3)))
;; x should be Float32(0x8006E0C3 [Rational(-450755, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b1 #b01111100 #b10111000001100001011111)))
(check-sat)
(exit)
