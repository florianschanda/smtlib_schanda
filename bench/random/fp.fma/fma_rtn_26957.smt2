...
(assert (= x ((_ to_fp 8 24) #x8039ED93)))
;; x should be Float32(0x8039ED93 [Rational(-3796371, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3FE7B64B))))
(check-sat)
(exit)
