...
(assert (= y (fp #b0 #b10010100 #b00111111100010010100010)))
;; y should be Float32(0x4A1FC4A2 [Rational(5235281, 2), 2617640.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8B1FC4A4))))
(check-sat)
(exit)
