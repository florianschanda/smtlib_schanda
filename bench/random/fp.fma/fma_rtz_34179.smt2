...
(assert (= x ((_ to_fp 8 24) #x7F99EA72)))
...
(assert (= z ((_ to_fp 8 24) #xEC828D1D)))
;; z should be Float32(0xEC828D1D [Rational(-1262613961436516402111447040), -1262613961436516402111447040.000000])
