...
(assert (= x (fp #b0 #b10010100 #b00101000011010011001110)))
;; x should be Float32(0x4A1434CE [Rational(4856423, 2), 2428211.500000])
...
(assert (not (= result (fp #b1 #b00010110 #b00101000011010011010010))))
(check-sat)
(exit)
