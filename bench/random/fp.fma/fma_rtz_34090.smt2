...
(assert (= x (fp #b0 #b11111111 #b11011110110000011100001)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b00000000 #b11001100000010110011110)))
;; y should be Float32(0x0066059E [Rational(3343055, 356811923176489970264571492362373784095686656), 0.000000])
