...
(assert (= z (fp #b1 #b10011011 #b10000110000011101101001)))
;; z should be Float32(0xCDC30769 [Rational(-409005344), -409005344.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCDC30769))))
(check-sat)
(exit)
