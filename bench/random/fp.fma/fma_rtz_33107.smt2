...
(assert (= z ((_ to_fp 8 24) #x00531B49)))
;; z should be Float32(0x00531B49 [Rational(5446473, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b00000000 #b10100110001101101001001)))
(check-sat)
(exit)
