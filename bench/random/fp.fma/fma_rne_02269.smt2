...
(assert (= z ((_ to_fp 8 24) #x27C56719)))
;; z should be Float32(0x27C56719 [Rational(12936985, 2361183241434822606848), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b01001111 #b10001010110011100011001)))
(check-sat)
(exit)
