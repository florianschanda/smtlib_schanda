...
(assert (= z (fp #b0 #b10010101 #b00100111000101010110001)))
;; z should be Float32(0x4A938AB1 [Rational(9669297, 2), 4834648.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4A938AB2))))
(check-sat)
(exit)
