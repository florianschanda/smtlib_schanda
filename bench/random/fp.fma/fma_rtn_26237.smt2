...
(assert (= z ((_ to_fp 8 24) #xE5B19A59)))
;; z should be Float32(0xE5B19A59 [Rational(-104838259897643481169920), -104838259897643481169920.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b11001011 #b01100011001101001011001)))
(check-sat)
(exit)
