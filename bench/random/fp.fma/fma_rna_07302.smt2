...
(assert (= x (fp #b0 #b10010010 #b01011001101100111011000)))
;; x should be Float32(0x492CD9D8 [Rational(1415995, 2), 707997.500000])
...
(assert (not (= result (fp #b0 #b00010100 #b01011001101100111100111))))
(check-sat)
(exit)
