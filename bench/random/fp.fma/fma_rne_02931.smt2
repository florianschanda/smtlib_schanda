...
(assert (= x (fp #b0 #b00000000 #b01111110001111100110001)))
;; x should be Float32(0x003F1F31 [Rational(4136753, 713623846352979940529142984724747568191373312), 0.000000])
