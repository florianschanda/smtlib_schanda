...
(assert (= z (fp #b0 #b10010001 #b11011101011100110010000)))
;; z should be Float32(0x48EEB990 [Rational(977817, 2), 488908.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010001 #b11011101011100110010000))))
(check-sat)
(exit)
