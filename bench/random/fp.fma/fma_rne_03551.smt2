...
(assert (= z ((_ to_fp 8 24) #x9EE523A5)))
;; z should be Float32(0x9EE523A5 [Rational(-15016869, 618970019642690137449562112), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x9EE523A5))))
(check-sat)
(exit)
