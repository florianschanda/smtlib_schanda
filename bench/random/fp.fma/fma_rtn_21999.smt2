...
(assert (= y (fp #b1 #b00000000 #b11010001100000000001101)))
;; y should be Float32(0x8068C00D [Rational(-6864909, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC051801A)))
(check-sat)
(exit)
