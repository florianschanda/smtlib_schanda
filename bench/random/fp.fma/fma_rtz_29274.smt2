...
(assert (= y (fp #b0 #b10010101 #b00010011101010111100001)))
;; y should be Float32(0x4A89D5E1 [Rational(9033185, 2), 4516592.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b00010011101010111011111))))
(check-sat)
(exit)
