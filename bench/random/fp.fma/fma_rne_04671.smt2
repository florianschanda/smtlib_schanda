...
(assert (= y (fp #b1 #b00000000 #b11111000011110111010011)))
;; y should be Float32(0x807C3DD3 [Rational(-8142291, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b0 #b10000000 #b11110000111101110100101)))
(check-sat)
(exit)
