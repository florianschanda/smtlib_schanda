...
(assert (= z ((_ to_fp 8 24) #x4AE7530B)))
;; z should be Float32(0x4AE7530B [Rational(15160075, 2), 7580037.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010101 #b11001110101001100001011)))
(check-sat)
(exit)
