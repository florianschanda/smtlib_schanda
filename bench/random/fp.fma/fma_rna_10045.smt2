...
(assert (= x (fp #b0 #b00000000 #b01010001111000011001110)))
;; x should be Float32(0x0028F0CE [Rational(1341543, 356811923176489970264571492362373784095686656), 0.000000])
