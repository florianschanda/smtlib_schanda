...
(assert (= z (fp #b1 #b10010101 #b01001010001111011000101)))
;; z should be Float32(0xCAA51EC5 [Rational(-10821317, 2), -5410658.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b10010101 #b01001010001111011000101)))
(check-sat)
(exit)
