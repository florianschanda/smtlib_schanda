...
(assert (= y (fp #b0 #b10010000 #b00101111110010010100000)))
;; y should be Float32(0x4817E4A0 [Rational(311077, 2), 155538.500000])
...
(assert (= result (fp #b0 #b00000000 #b00000100101111110010010)))
(check-sat)
(exit)
