...
(assert (= y ((_ to_fp 8 24) #xDDF6AE30)))
;; y should be Float32(0xDDF6AE30 [Rational(-2221899694479507456), -2221899694479507456.000000])
...
(assert (= result (fp #b0 #b00100110 #b11101101010111000110000)))
(check-sat)
(exit)
