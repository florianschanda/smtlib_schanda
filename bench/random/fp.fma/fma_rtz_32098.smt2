...
(assert (= y ((_ to_fp 8 24) #x807C85B0)))
;; y should be Float32(0x807C85B0 [Rational(-510043, 44601490397061246283071436545296723011960832), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x40790B5F)))
(check-sat)
(exit)
