...
(assert (= y (fp #b1 #b11100011 #b01001100011001111001100)))
;; y should be Float32(0xF1A633CC [Rational(-1645988166716996252923112456192), -1645988166716996252923112456192.000000])
...
(assert (= result (fp #b0 #b01001110 #b01001100011001111001100)))
(check-sat)
(exit)
