...
(assert (= x (fp #b0 #b00000000 #b00010001010001111011110)))
;; x should be Float32(0x0008A3DE [Rational(283119, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result (fp #b0 #b01111101 #b00010100011110111011111))))
(check-sat)
(exit)
