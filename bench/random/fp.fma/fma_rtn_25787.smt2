...
(assert (= y (fp #b0 #b00000000 #b00010000110010100001110)))
;; y should be Float32(0x0008650E [Rational(275079, 356811923176489970264571492362373784095686656), 0.000000])
