...
(assert (= z ((_ to_fp 8 24) #x08F4607D)))
;; z should be Float32(0x08F4607D [Rational(16015485, 10889035741470030830827987437816582766592), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b00010001 #b11101000110000001111101))))
(check-sat)
(exit)
