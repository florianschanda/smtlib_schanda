...
(assert (= x ((_ to_fp 8 24) #x8070F297)))
;; x should be Float32(0x8070F297 [Rational(-7402135, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= z (fp #b0 #b11111111 #b11100001000100100101010)))
