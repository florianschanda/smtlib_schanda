...
(assert (= z ((_ to_fp 8 24) #xED91207D)))
;; z should be Float32(0xED91207D [Rational(-5614325293266632725541945344), -5614325293266632725541945344.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b11011011 #b00100010010000001111101))))
(check-sat)
(exit)
