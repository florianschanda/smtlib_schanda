...
(assert (= z ((_ to_fp 8 24) #x3BCF7839)))
;; z should be Float32(0x3BCF7839 [Rational(13596729, 2147483648), 0.006331])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b01110111 #b10011110111100000111001))))
(check-sat)
(exit)
