...
(assert (= z ((_ to_fp 8 24) #x0033F760)))
;; z should be Float32(0x0033F760 [Rational(106427, 22300745198530623141535718272648361505980416), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x0033F760)))
(check-sat)
(exit)
