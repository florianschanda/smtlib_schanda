...
(assert (= y ((_ to_fp 8 24) #x1E619E80)))
;; y should be Float32(0x1E619E80 [Rational(115517, 9671406556917033397649408), 0.000000])

(declare-const z Float32)
(assert (= z (fp #b0 #b11111111 #b00110110001111010111010)))
