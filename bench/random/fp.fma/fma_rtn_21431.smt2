...
(assert (= z (fp #b1 #b00000000 #b00101000011001100000011)))
;; z should be Float32(0x80143303 [Rational(-1323779, 713623846352979940529142984724747568191373312), -0.000000])
