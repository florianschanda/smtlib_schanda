...
(assert (= z (fp #b0 #b00000000 #b10010111010111111110010)))
;; z should be Float32(0x004BAFF2 [Rational(2480121, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b00000000 #b10010111010111111110010)))
(check-sat)
(exit)
