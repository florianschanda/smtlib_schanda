...
(assert (= y (fp #b0 #b11111111 #b10100110001110001001110)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x0001DACB)))
;; z should be Float32(0x0001DACB [Rational(121547, 713623846352979940529142984724747568191373312), 0.000000])
