...
(assert (= x ((_ to_fp 8 24) #x0043D339)))
;; x should be Float32(0x0043D339 [Rational(4444985, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result (fp #b0 #b10000000 #b00001111010011001110001)))
(check-sat)
(exit)
