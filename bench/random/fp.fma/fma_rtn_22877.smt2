...
(assert (= y (fp #b0 #b10011001 #b01011000001100000111011)))
;; y should be Float32(0x4CAC183B [Rational(90227160), 90227160.000000])
...
(assert (not (= result (fp #b0 #b00000100 #b01011000001100000111011))))
(check-sat)
(exit)
