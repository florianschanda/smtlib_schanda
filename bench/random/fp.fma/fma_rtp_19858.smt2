...
(assert (= x (fp #b1 #b00000000 #b00011010001001000101111)))
;; x should be Float32(0x800D122F [Rational(-856623, 713623846352979940529142984724747568191373312), -0.000000])
