...
(assert (= x (fp #b0 #b00000000 #b11111101011101110101100)))
;; x should be Float32(0x007EBBAC [Rational(2076395, 178405961588244985132285746181186892047843328), 0.000000])
