...
(assert (= x ((_ to_fp 8 24) #xEC23EE21)))
;; x should be Float32(0xEC23EE21 [Rational(-792717762250647853812678656), -792717762250647853812678656.000000])
...
(assert (not (= result (fp #b0 #b01011010 #b01000111110111000100000))))
(check-sat)
(exit)
