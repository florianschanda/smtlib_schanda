...
(assert (= x (fp #b0 #b11111111 #b10100110010110000111010)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b1 #b10010101 #b01010010010010111001011)))
;; y should be Float32(0xCAA925CB [Rational(-11085259, 2), -5542629.500000])
