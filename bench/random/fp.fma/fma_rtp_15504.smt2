...
(assert (= y ((_ to_fp 8 24) #x80441CB8)))
;; y should be Float32(0x80441CB8 [Rational(-557975, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFC1BA81)))
