...
(assert (= z ((_ to_fp 8 24) #xD45C2088)))
;; z should be Float32(0xD45C2088 [Rational(-3781754355712), -3781754355712.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b10101000 #b10111000010000010001000)))
(check-sat)
(exit)
