...
(assert (= x (fp #b1 #b10010101 #b01011001000110010101111)))
;; x should be Float32(0xCAAC8CAF [Rational(-11308207, 2), -5654103.500000])
...
(assert (= result ((_ to_fp 8 24) #x8BAC8CAF)))
(check-sat)
(exit)
