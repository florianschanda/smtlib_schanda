...
(assert (= y (fp #b0 #b00000000 #b00101011100010110001100)))
;; y should be Float32(0x0015C58C [Rational(356707, 178405961588244985132285746181186892047843328), 0.000000])
