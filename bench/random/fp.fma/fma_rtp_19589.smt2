...
(assert (= x ((_ to_fp 8 24) #xDBFE4137)))
;; x should be Float32(0xDBFE4137 [Rational(-143132697127026688), -143132697127026688.000000])
...
(assert (= z (fp #b0 #b11111111 #b00110100111100000101011)))
