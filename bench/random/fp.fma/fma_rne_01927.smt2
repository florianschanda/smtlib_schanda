...
(assert (= z ((_ to_fp 8 24) #x630A738B)))
;; z should be Float32(0x630A738B [Rational(2553976430508042616832), 2553976430508042616832.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b11000110 #b00010100111001110001011)))
(check-sat)
(exit)
