...
(assert (= x (fp #b1 #b10110100 #b11001111010110110010011)))
;; x should be Float32(0xDA67AD93 [Rational(-16302891622989824), -16302891622989824.000000])
...
(assert (= result ((_ to_fp 8 24) #x9B67AD91)))
(check-sat)
(exit)
