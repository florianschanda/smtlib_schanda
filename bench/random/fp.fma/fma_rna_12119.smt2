...
(assert (= y (fp #b1 #b10010100 #b01001100010101110111110)))
;; y should be Float32(0xCA262BBE [Rational(-5445087, 2), -2722543.500000])
...
(assert (= result (fp #b0 #b00010110 #b01001100010101110111110)))
(check-sat)
(exit)
