...
(assert (= x (fp #b0 #b10010010 #b01111110011000011011000)))
;; x should be Float32(0x493F30D8 [Rational(1566235, 2), 783117.500000])
...
(assert (= result (fp #b1 #b00010100 #b01111110011000011001000)))
(check-sat)
(exit)
