...
(assert (= x ((_ to_fp 8 24) #x802BA5D8)))
;; x should be Float32(0x802BA5D8 [Rational(-357563, 89202980794122492566142873090593446023921664), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #xFFF90769)))
