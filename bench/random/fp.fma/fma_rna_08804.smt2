...
(assert (= y (fp #b0 #b10101011 #b00100000100101011100000)))
;; y should be Float32(0x55904AE0 [Rational(19831407509504), 19831407509504.000000])
...
(assert (= result (fp #b0 #b00101101 #b00100000100101011100000)))
(check-sat)
(exit)
