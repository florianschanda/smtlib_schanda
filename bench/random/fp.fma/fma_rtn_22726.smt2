...
(assert (= y (fp #b1 #b11111111 #b10011101010111100000001)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b0 #b10010100 #b01000100010101011000010)))
;; z should be Float32(0x4A222AC2 [Rational(5313889, 2), 2656944.500000])
