...
(assert (= z (fp #b1 #b10010011 #b11111001100110001111100)))
;; z should be Float32(0xC9FCCC7C [Rational(-4141855, 2), -2070927.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b10010011 #b11111001100110001111100)))
(check-sat)
(exit)
