...
(assert (= z (fp #b0 #b00000000 #b01010000001000111000111)))
;; z should be Float32(0x002811C7 [Rational(2625991, 713623846352979940529142984724747568191373312), 0.000000])
