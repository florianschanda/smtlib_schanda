...
(assert (= z ((_ to_fp 8 24) #x7AF5E400)))
;; z should be Float32(0x7AF5E400 [Rational(638368559865332674923315786976067584), 638368559865332674923315786976067584.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x7AF5E3FF)))
(check-sat)
(exit)
