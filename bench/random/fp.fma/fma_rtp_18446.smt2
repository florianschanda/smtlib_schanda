...
(assert (= y (fp #b0 #b10010011 #b10001100111101000111100)))
;; y should be Float32(0x49C67A3C [Rational(3251855, 2), 1625927.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8AC67A3A))))
(check-sat)
(exit)
