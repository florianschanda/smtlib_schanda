...
(assert (= z ((_ to_fp 8 24) #x00625A1F)))
;; z should be Float32(0x00625A1F [Rational(6445599, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x00625A1F)))
(check-sat)
(exit)
