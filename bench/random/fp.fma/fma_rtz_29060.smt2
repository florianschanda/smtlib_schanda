...
(assert (= z ((_ to_fp 8 24) #x0064D6FD)))
;; z should be Float32(0x0064D6FD [Rational(6608637, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x0064D6FD)))
(check-sat)
(exit)
