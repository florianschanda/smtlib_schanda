...
(assert (= z (fp #b1 #b11100101 #b01000101111111001111001)))
;; z should be Float32(0xF2A2FE79 [Rational(-6456858899914808853870176894976), -6456858899914808853870176894976.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xF2A2FE79))))
(check-sat)
(exit)
