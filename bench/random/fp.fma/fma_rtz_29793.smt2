...
(assert (= y (fp #b1 #b10010101 #b01010110111111111101101)))
;; y should be Float32(0xCAAB7FED [Rational(-11239405, 2), -5619702.500000])
...
(assert (= result (fp #b1 #b00000000 #b10101011011111111110110)))
(check-sat)
(exit)
