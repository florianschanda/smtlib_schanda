...
(assert (= z (fp #b1 #b00000000 #b00101001001001001100111)))
;; z should be Float32(0x80149267 [Rational(-1348199, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x80149267))))
(check-sat)
(exit)
