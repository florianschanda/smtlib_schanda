...
(assert (= x ((_ to_fp 8 24) #x4AE35D7B)))
;; x should be Float32(0x4AE35D7B [Rational(14900603, 2), 7450301.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b11000110101110101110111))))
(check-sat)
(exit)
