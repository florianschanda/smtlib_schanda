...
(assert (= y (fp #b1 #b10010101 #b01011000100001100111011)))
;; y should be Float32(0xCAAC433B [Rational(-11289403, 2), -5644701.500000])
...
(assert (= result (fp #b1 #b00010111 #b01011000100001100111011)))
(check-sat)
(exit)
