...
(assert (= z ((_ to_fp 8 24) #xDE230A89)))
;; z should be Float32(0xDE230A89 [Rational(-2937088302760591360), -2937088302760591360.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10111100 #b01000110000101010001001))))
(check-sat)
(exit)
