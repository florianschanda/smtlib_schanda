...
(assert (= y ((_ to_fp 8 24) #x407CB273)))
;; y should be Float32(0x407CB273 [Rational(16560755, 4194304), 3.948392])
...
(assert (= result (fp #b0 #b00000000 #b11111111111111111111011)))
(check-sat)
(exit)
