...
(assert (= x (fp #b1 #b10010100 #b01011001011111111100010)))
;; x should be Float32(0xCA2CBFE2 [Rational(-5660657, 2), -2830328.500000])
...
(assert (= result (fp #b0 #b00010110 #b01011001011111111100010)))
(check-sat)
(exit)
