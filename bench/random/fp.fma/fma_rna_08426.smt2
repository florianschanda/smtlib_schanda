...
(assert (= z (fp #b0 #b00000000 #b01000111000000010111011)))
;; z should be Float32(0x002380BB [Rational(2326715, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b00000000 #b01000111000000010111011)))
(check-sat)
(exit)
