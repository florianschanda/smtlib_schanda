...
(assert (= z (fp #b0 #b10010101 #b10011111011001101001101)))
;; z should be Float32(0x4ACFB34D [Rational(13611853, 2), 6805926.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10010101 #b10011111011001101000101))))
(check-sat)
(exit)
