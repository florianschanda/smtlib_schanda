...
(assert (= x (fp #b0 #b00000000 #b00111110100101011011110)))
;; x should be Float32(0x001F4ADE [Rational(1025391, 356811923176489970264571492362373784095686656), 0.000000])
