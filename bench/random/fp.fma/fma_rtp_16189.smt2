...
(assert (= y ((_ to_fp 8 24) #xE61FEABA)))
;; y should be Float32(0xE61FEABA [Rational(-188796552900503169662976), -188796552900503169662976.000000])
...
(assert (= result ((_ to_fp 8 24) #x9B9FEABA)))
(check-sat)
(exit)
