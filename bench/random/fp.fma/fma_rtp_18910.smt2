...
(assert (= y (fp #b0 #b01101111 #b10101110001111101011110)))
;; y should be Float32(0x37D71F5E [Rational(7049135, 274877906944), 0.000026])
...
(assert (not (= result (fp #b0 #b00000000 #b11111111111111100101000))))
(check-sat)
(exit)
