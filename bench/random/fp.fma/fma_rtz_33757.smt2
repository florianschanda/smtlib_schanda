...
(assert (= x (fp #b1 #b00000000 #b01000100110111001101001)))
;; x should be Float32(0x80226E69 [Rational(-2256489, 713623846352979940529142984724747568191373312), -0.000000])
