...
(assert (= z ((_ to_fp 8 24) #x803A882B)))
;; z should be Float32(0x803A882B [Rational(-3835947, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x803A882B)))
(check-sat)
(exit)
