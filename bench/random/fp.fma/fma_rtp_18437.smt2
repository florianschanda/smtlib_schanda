...
(assert (= y ((_ to_fp 8 24) #x4A8AD4CD)))
;; y should be Float32(0x4A8AD4CD [Rational(9098445, 2), 4549222.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b00010101101010011001011))))
(check-sat)
(exit)
