...
(assert (= x ((_ to_fp 8 24) #x00200FEE)))
;; x should be Float32(0x00200FEE [Rational(1050615, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result (fp #b0 #b01111111 #b00000000011111110110111))))
(check-sat)
(exit)
