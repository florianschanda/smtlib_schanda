...
(assert (= z ((_ to_fp 8 24) #x007BE4A9)))
;; z should be Float32(0x007BE4A9 [Rational(8119465, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x007BE4A9)))
(check-sat)
(exit)
