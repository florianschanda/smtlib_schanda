...
(assert (= x (fp #b0 #b00000000 #b11100101100000100101100)))
;; x should be Float32(0x0072C12C [Rational(1880139, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (= result (fp #b1 #b10000000 #b11001011000001001010111)))
(check-sat)
(exit)
