...
(assert (= x (fp #b1 #b10010101 #b00101101000111110000111)))
;; x should be Float32(0xCA968F87 [Rational(-9867143, 2), -4933571.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b00101101000111110000111))))
(check-sat)
(exit)
