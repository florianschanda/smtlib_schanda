...
(assert (= z (fp #b1 #b10001100 #b11001111000011000110101)))
;; z should be Float32(0xC6678635 [Rational(-15173173, 1024), -14817.551758])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #xC6678635))))
(check-sat)
(exit)
