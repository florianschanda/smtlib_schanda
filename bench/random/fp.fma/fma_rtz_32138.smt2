...
(assert (= z ((_ to_fp 8 24) #x00247C5F)))
;; z should be Float32(0x00247C5F [Rational(2391135, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b00000000 #b01001000111110001011111))))
(check-sat)
(exit)
