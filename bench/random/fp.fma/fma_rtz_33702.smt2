...
(assert (= x (fp #b1 #b00000000 #b10011110001010000001110)))
;; x should be Float32(0x804F140E [Rational(-2591239, 356811923176489970264571492362373784095686656), -0.000000])
