...
(assert (= x (fp #b1 #b10010100 #b01110101011111110100010)))
;; x should be Float32(0xCA3ABFA2 [Rational(-6119377, 2), -3059688.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b01011101010111111101010))))
(check-sat)
(exit)
