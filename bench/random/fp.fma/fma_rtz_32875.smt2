...
(assert (= y (fp #b0 #b10010011 #b10010101111100100101100)))
;; y should be Float32(0x49CAF92C [Rational(3325515, 2), 1662757.500000])
...
(assert (= result (fp #b0 #b00000000 #b11001101010000011011001)))
(check-sat)
(exit)
