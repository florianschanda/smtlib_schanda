...
(assert (= y ((_ to_fp 8 24) #x807F3618)))
;; y should be Float32(0x807F3618 [Rational(-1042115, 89202980794122492566142873090593446023921664), -0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b11111100110110000101111))))
(check-sat)
(exit)
