...
(assert (= z ((_ to_fp 8 24) #x0013F0C8)))
;; z should be Float32(0x0013F0C8 [Rational(163353, 89202980794122492566142873090593446023921664), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00000000 #b00100111111000011001000)))
(check-sat)
(exit)
