...
(assert (= z ((_ to_fp 8 24) #x23358A76)))
;; z should be Float32(0x23358A76 [Rational(5948731, 604462909807314587353088), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b01000110 #b01101011000101001110110)))
(check-sat)
(exit)
