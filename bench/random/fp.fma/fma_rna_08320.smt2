...
(assert (= z ((_ to_fp 8 24) #x94BE821E)))
;; z should be Float32(0x94BE821E [Rational(-6242575, 324518553658426726783156020576256), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b00101001 #b01111101000001000011110)))
(check-sat)
(exit)
