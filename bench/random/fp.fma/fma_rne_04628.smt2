...
(assert (= z ((_ to_fp 8 24) #xCA98A31F)))
;; z should be Float32(0xCA98A31F [Rational(-10003231, 2), -5001615.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010101 #b00110001010001100011111))))
(check-sat)
(exit)
