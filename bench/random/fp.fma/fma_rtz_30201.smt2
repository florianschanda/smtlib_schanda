...
(assert (= x (fp #b0 #b11110000 #b11101000110110000101001)))
;; x should be Float32(0x78746C29 [Rational(19829909094911803228204199105789952), 19829909094911803228204199105789952.000000])
