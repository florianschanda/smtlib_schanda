...
(assert (= z ((_ to_fp 8 24) #x002B8C9F)))
;; z should be Float32(0x002B8C9F [Rational(2854047, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x002B8C9F)))
(check-sat)
(exit)
