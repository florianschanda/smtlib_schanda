...
(assert (= y (fp #b1 #b00000000 #b11010010011011011111100)))
;; y should be Float32(0x806936FC [Rational(-1723839, 178405961588244985132285746181186892047843328), -0.000000])
