...
(assert (= y (fp #b0 #b10010101 #b01000100111110010110001)))
;; y should be Float32(0x4AA27CB1 [Rational(10648753, 2), 5324376.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BA27CB2))))
(check-sat)
(exit)
