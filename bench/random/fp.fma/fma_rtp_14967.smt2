...
(assert (= y ((_ to_fp 8 24) #x0017966A)))
;; y should be Float32(0x0017966A [Rational(772917, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3F3CB350)))
(check-sat)
(exit)
