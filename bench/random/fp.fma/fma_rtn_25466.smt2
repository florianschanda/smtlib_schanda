...
(assert (= y (fp #b1 #b10010101 #b11110111101111000101001)))
;; y should be Float32(0xCAFBDE29 [Rational(-16506409, 2), -8253204.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BFBDE29))))
(check-sat)
(exit)
