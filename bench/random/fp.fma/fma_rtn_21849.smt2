...
(assert (= z (fp #b1 #b00000000 #b01110001010001101001000)))
;; z should be Float32(0x8038A348 [Rational(-463977, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x8038A348)))
(check-sat)
(exit)
