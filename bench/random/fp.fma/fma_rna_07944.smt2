...
(assert (= z (fp #b0 #b10010101 #b11111101101100100110011)))
;; z should be Float32(0x4AFED933 [Rational(16701747, 2), 8350873.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010101 #b11111101101100100110011)))
(check-sat)
(exit)
