...
(assert (= x (fp #b0 #b11011011 #b01111001110101111101111)))
;; x should be Float32(0x6DBCEBEF [Rational(7308551007451464577690107904), 7308551007451464577690107904.000000])
