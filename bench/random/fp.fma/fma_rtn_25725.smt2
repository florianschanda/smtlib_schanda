...
(assert (= z (fp #b1 #b00000000 #b10100111111100101100110)))
;; z should be Float32(0x8053F966 [Rational(-2751667, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x8053F967)))
(check-sat)
(exit)
