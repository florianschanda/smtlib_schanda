...
(assert (= y (fp #b1 #b10001010 #b11111111001000100110010)))
;; y should be Float32(0xC57F9132 [Rational(-8374425, 2048), -4089.074707])
...
(assert (not (= result (fp #b0 #b00001100 #b11111111001000100110000))))
(check-sat)
(exit)
