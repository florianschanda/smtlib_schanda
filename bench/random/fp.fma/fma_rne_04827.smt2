...
(assert (= y ((_ to_fp 8 24) #x39A04E3D)))
;; y should be Float32(0x39A04E3D [Rational(10505789, 34359738368), 0.000306])
...
(assert (not (= result (fp #b1 #b00000000 #b00000000000101000000101))))
(check-sat)
(exit)
