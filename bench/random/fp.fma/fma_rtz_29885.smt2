...
(assert (= z (fp #b1 #b10111001 #b01111001001010101001100)))
;; z should be Float32(0xDCBC954C [Rational(-424651594173251584), -424651594173251584.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10111001 #b01111001001010101001100))))
(check-sat)
(exit)
