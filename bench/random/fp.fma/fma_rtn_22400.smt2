...
(assert (= z (fp #b1 #b00000000 #b01101110010010100101111)))
;; z should be Float32(0x8037252F [Rational(-3613999, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b00000000 #b01101110010010100101111))))
(check-sat)
(exit)
