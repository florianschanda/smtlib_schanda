...
(assert (= x ((_ to_fp 8 24) #xB7D5E521)))
;; x should be Float32(0xB7D5E521 [Rational(-14017825, 549755813888), -0.000025])
...
(assert (not (= result (fp #b0 #b00000000 #b00000000000000011010110))))
(check-sat)
(exit)
