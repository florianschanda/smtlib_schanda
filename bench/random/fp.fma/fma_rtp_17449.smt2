...
(assert (= x (fp #b1 #b10010101 #b10000010000011000001111)))
;; x should be Float32(0xCAC1060F [Rational(-12649999, 2), -6324999.500000])
...
(assert (= result (fp #b1 #b00000000 #b11000001000001100000110)))
(check-sat)
(exit)
