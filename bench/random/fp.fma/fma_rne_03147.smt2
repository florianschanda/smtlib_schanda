...
(assert (= x (fp #b0 #b00000000 #b11010001100111100010110)))
;; x should be Float32(0x0068CF16 [Rational(3434379, 356811923176489970264571492362373784095686656), 0.000000])
