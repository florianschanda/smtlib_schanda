...
(assert (= z (fp #b0 #b00000000 #b10110111011001011100011)))
;; z should be Float32(0x005BB2E3 [Rational(6009571, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b00000000 #b10110111011001011100011)))
(check-sat)
(exit)
