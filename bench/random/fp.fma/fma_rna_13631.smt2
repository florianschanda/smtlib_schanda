...
(assert (= x ((_ to_fp 8 24) #xFFF5F125)))
...
(assert (= z ((_ to_fp 8 24) #x61ABDAEE)))
;; z should be Float32(0x61ABDAEE [Rational(396271097893632344064), 396271097893632344064.000000])
