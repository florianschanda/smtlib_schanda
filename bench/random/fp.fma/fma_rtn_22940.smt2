...
(assert (= y ((_ to_fp 8 24) #xCAC2FD39)))
;; y should be Float32(0xCAC2FD39 [Rational(-12778809, 2), -6389404.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b11000010111111010011100))))
(check-sat)
(exit)
