...
(assert (= x (fp #b1 #b00000000 #b00111010110101100011110)))
;; x should be Float32(0x801D6B1E [Rational(-963983, 356811923176489970264571492362373784095686656), -0.000000])
