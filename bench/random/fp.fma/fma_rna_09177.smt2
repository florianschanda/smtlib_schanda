...
(assert (= y ((_ to_fp 8 24) #x6DAA9423)))
;; y should be Float32(0x6DAA9423 [Rational(6598942246719815904831471616), 6598942246719815904831471616.000000])

(declare-const z Float32)
(assert (= z (fp #b0 #b11111111 #b11000110111011101101100)))
