...
(assert (= y (fp #b0 #b00000000 #b10101101101001110101011)))
;; y should be Float32(0x0056D3AB [Rational(5690283, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b0 #b10000000 #b01011011010011101010101))))
(check-sat)
(exit)
