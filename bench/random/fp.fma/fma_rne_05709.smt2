...
(assert (= z ((_ to_fp 8 24) #x007CDBB7)))
;; z should be Float32(0x007CDBB7 [Rational(8182711, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b00000000 #b11111001101101110110111))))
(check-sat)
(exit)
