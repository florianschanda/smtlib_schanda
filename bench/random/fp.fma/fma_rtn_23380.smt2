...
(assert (= x (fp #b0 #b01111010 #b10111001111101000010111)))
;; x should be Float32(0x3D5CFA17 [Rational(14481943, 268435456), 0.053949])
...
(assert (= result ((_ to_fp 8 24) #x8006E7D1)))
(check-sat)
(exit)
