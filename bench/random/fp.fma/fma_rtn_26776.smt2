...
(assert (= x (fp #b1 #b00000000 #b01010110010111111100100)))
;; x should be Float32(0x802B2FE4 [Rational(-707577, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (= result (fp #b1 #b01111111 #b01011001011111110010000)))
(check-sat)
(exit)
