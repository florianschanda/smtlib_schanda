...
(assert (= z (fp #b1 #b00000101 #b00101010101010100011001)))
;; z should be Float32(0x82955519 [Rational(-9786649, 44601490397061246283071436545296723011960832), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x82955519)))
(check-sat)
(exit)
