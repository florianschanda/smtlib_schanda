...
(assert (= z (fp #b0 #b00111000 #b10101010100000000001111)))
;; z should be Float32(0x1C55400F [Rational(13975567, 19807040628566084398385987584), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x1C55400E)))
(check-sat)
(exit)
