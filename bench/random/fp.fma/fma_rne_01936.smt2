...
(assert (= z ((_ to_fp 8 24) #x9C85364C)))
;; z should be Float32(0x9C85364C [Rational(-2182547, 2475880078570760549798248448), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x9C85364C))))
(check-sat)
(exit)
