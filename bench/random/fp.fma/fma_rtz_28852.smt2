...
(assert (= y (fp #b1 #b00000000 #b01010111001101010001100)))
;; y should be Float32(0x802B9A8C [Rational(-714403, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (not (= result (fp #b1 #b01111111 #b01011100110101000101111))))
(check-sat)
(exit)
