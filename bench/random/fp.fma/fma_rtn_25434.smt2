...
(assert (= y (fp #b0 #b00000000 #b10001101110111000100110)))
;; y should be Float32(0x0046EE26 [Rational(2324243, 356811923176489970264571492362373784095686656), 0.000000])
