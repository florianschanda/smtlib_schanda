...
(assert (= z (fp #b0 #b10010101 #b11000011111111001011001)))
;; z should be Float32(0x4AE1FE59 [Rational(14810713, 2), 7405356.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10010101 #b11000011111111001011001)))
(check-sat)
(exit)
