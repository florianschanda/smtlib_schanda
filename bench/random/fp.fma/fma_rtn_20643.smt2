...
(assert (= z ((_ to_fp 8 24) #x007088D2)))
;; z should be Float32(0x007088D2 [Rational(3687529, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b00000000 #b11100001000100011010010)))
(check-sat)
(exit)
