...
(assert (= z ((_ to_fp 8 24) #x0D92D3C0)))
;; z should be Float32(0x0D92D3C0 [Rational(150351, 166153499473114484112975882535043072), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x0D92D3C0))))
(check-sat)
(exit)
