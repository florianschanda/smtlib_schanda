...
(assert (= z (fp #b1 #b10010101 #b11100010111101111010111)))
;; z should be Float32(0xCAF17BD7 [Rational(-15825879, 2), -7912939.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10010101 #b11100010111101111011110)))
(check-sat)
(exit)
