...
(assert (= x (fp #b0 #b00000000 #b10000000100101101111010)))
;; x should be Float32(0x00404B7A [Rational(2106813, 356811923176489970264571492362373784095686656), 0.000000])
