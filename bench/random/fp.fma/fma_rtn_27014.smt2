...
(assert (= x (fp #b1 #b00000000 #b10011101000110111011101)))
;; x should be Float32(0x804E8DDD [Rational(-5148125, 713623846352979940529142984724747568191373312), -0.000000])
