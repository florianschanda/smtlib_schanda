...
(assert (= y (fp #b0 #b00000000 #b11100100000100000011001)))
;; y should be Float32(0x00720819 [Rational(7473177, 713623846352979940529142984724747568191373312), 0.000000])
