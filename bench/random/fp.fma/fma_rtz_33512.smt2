...
(assert (= x (fp #b1 #b10001011 #b00100001001101111110001)))
;; x should be Float32(0xC5909BF1 [Rational(-9477105, 2048), -4627.492676])
...
(assert (not (= result (fp #b1 #b00000000 #b11111111110110111101100))))
(check-sat)
(exit)
