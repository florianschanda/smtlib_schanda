...
(assert (= z (fp #b1 #b10010101 #b01101000100011000010111)))
;; z should be Float32(0xCAB44617 [Rational(-11814423, 2), -5907211.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b10010101 #b01101000100011000010111)))
(check-sat)
(exit)
