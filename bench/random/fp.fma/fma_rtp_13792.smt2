...
(assert (= z ((_ to_fp 8 24) #xE807656D)))
;; z should be Float32(0xE807656D [Rational(-2557561802466387610828800), -2557561802466387610828800.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #xE807656D)))
(check-sat)
(exit)
