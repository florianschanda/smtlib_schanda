...
(assert (= z ((_ to_fp 8 24) #x1F043FFD)))
;; z should be Float32(0x1F043FFD [Rational(8667133, 309485009821345068724781056), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x1F043FFD))))
(check-sat)
(exit)
