...
(assert (= x (fp #b1 #b11011111 #b11110111111011000101110)))
;; x should be Float32(0xEFFBF62E [Rational(-155956700891282046061155188736), -155956700891282046061155188736.000000])
...
(assert (= result ((_ to_fp 8 24) #x257BF62E)))
(check-sat)
(exit)
