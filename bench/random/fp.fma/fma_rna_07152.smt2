...
(assert (= z (fp #b0 #b10001000 #b00010011111010010100110)))
;; z should be Float32(0x4409F4A6 [Rational(4520531, 8192), 551.822632])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4409F4A6))))
(check-sat)
(exit)
