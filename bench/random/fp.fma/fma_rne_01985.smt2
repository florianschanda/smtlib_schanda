...
(assert (= z (fp #b0 #b00000000 #b11100001000011110100000)))
;; z should be Float32(0x007087A0 [Rational(230461, 22300745198530623141535718272648361505980416), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b00000000 #b11100001000011110100000)))
(check-sat)
(exit)
