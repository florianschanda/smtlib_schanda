...
(assert (= x (fp #b0 #b10010100 #b11101111001111001101010)))
;; x should be Float32(0x4A779E6A [Rational(8113973, 2), 4056986.500000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x4A5A289A)))
;; y should be Float32(0x4A5A289A [Rational(7148621, 2), 3574310.500000])
