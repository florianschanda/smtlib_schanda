...
(assert (= x (fp #b1 #b00000000 #b01010101100110101101101)))
;; x should be Float32(0x802ACD6D [Rational(-2805101, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3FAB35B3)))
(check-sat)
(exit)
