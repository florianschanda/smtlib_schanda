...
(assert (= x (fp #b1 #b11111111 #b01100001101001111101100)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x2DF0A8E7)))
;; y should be Float32(0x2DF0A8E7 [Rational(15771879, 576460752303423488), 0.000000])
