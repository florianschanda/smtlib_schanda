...
(assert (= x ((_ to_fp 8 24) #x9F116CE0)))
;; x should be Float32(0x9F116CE0 [Rational(-297831, 9671406556917033397649408), -0.000000])
...
(assert (not (= result (fp #b1 #b10111110 #b00100010110110011011111))))
(check-sat)
(exit)
