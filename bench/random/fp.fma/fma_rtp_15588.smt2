...
(assert (= z ((_ to_fp 8 24) #x7ED4AE87)))
;; z should be Float32(0x7ED4AE87 [Rational(141351266442541859019239318009820479488), 141351266442541859019239318009820479488.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x7ED4AE88)))
(check-sat)
(exit)
