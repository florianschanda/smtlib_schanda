...
(assert (= y (fp #b0 #b00000000 #b11111101111111010001000)))
;; y should be Float32(0x007EFE88 [Rational(1040337, 89202980794122492566142873090593446023921664), 0.000000])
