...
(assert (= y (fp #b0 #b01111011 #b00110011100111101000001)))
;; y should be Float32(0x3D99CF41 [Rational(10080065, 134217728), 0.075102])
...
(assert (= result (fp #b0 #b11111011 #b00110011100111101000000)))
(check-sat)
(exit)
