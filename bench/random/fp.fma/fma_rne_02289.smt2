...
(assert (= z (fp #b0 #b00000000 #b10001001111110010001000)))
;; z should be Float32(0x0044FC88 [Rational(565137, 89202980794122492566142873090593446023921664), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x0044FC88))))
(check-sat)
(exit)
