...
(assert (= z (fp #b1 #b10010010 #b00111011000111011110111)))
;; z should be Float32(0xC91D8EF7 [Rational(-10325751, 16), -645359.437500])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #xC91D8EF7)))
(check-sat)
(exit)
