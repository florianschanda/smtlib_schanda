...
(assert (= y (fp #b0 #b00000000 #b10000100101010001000001)))
;; y should be Float32(0x00425441 [Rational(4346945, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x4004A881))))
(check-sat)
(exit)
