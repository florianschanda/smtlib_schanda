...
(assert (= z ((_ to_fp 8 24) #x806576A2)))
;; z should be Float32(0x806576A2 [Rational(-3324753, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x806576A2)))
(check-sat)
(exit)
