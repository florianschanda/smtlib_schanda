...
(assert (= z (fp #b1 #b00000000 #b00111001010010100011010)))
;; z should be Float32(0x801CA51A [Rational(-938637, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00111001010010100011010))))
(check-sat)
(exit)
