...
(assert (= x ((_ to_fp 8 24) #xB27D1FDA)))
;; x should be Float32(0xB27D1FDA [Rational(-8294381, 562949953421312), -0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x90D07267)))
;; y should be Float32(0x90D07267 [Rational(-13660775, 166153499473114484112975882535043072), -0.000000])
