...
(assert (= z (fp #b1 #b00000000 #b00100000111110001000001)))
;; z should be Float32(0x80107C41 [Rational(-1080385, 713623846352979940529142984724747568191373312), -0.000000])
