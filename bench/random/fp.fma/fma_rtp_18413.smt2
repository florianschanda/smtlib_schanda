...
(assert (= z (fp #b0 #b10010101 #b01010100011100111100101)))
;; z should be Float32(0x4AAA39E5 [Rational(11155941, 2), 5577970.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4AAA39E5))))
(check-sat)
(exit)
