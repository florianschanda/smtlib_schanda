...
(assert (= z (fp #b1 #b00101110 #b00101000100010100101110)))
;; z should be Float32(0x9714452E [Rational(-4858519, 10141204801825835211973625643008), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x9714452D))))
(check-sat)
(exit)
