...
(assert (= z ((_ to_fp 8 24) #xDAC03396)))
;; z should be Float32(0xDAC03396 [Rational(-27049957433278464), -27049957433278464.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10110101 #b10000000011001110010110))))
(check-sat)
(exit)
