...
(assert (= z (fp #b0 #b10010101 #b11100011111010001100001)))
;; z should be Float32(0x4AF1F461 [Rational(15856737, 2), 7928368.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x4AF1F461)))
(check-sat)
(exit)
