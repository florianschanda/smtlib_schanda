...
(assert (= z ((_ to_fp 8 24) #x00281DEE)))
;; z should be Float32(0x00281DEE [Rational(1314551, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x00281DEE))))
(check-sat)
(exit)
