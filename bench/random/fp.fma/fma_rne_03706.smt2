...
(assert (= x (fp #b1 #b10010100 #b11000000011001110000110)))
;; x should be Float32(0xCA603386 [Rational(-7346627, 2), -3673313.500000])
...
(assert (not (= result (fp #b1 #b00010110 #b11000000011001110000110))))
(check-sat)
(exit)
