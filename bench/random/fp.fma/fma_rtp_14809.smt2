...
(assert (= z (fp #b0 #b10001100 #b01100111011011100111011)))
;; z should be Float32(0x4633B73B [Rational(11777851, 1024), 11501.807617])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4633B73B))))
(check-sat)
(exit)
