...
(assert (= z ((_ to_fp 8 24) #x5B3472E9)))
;; z should be Float32(0x5B3472E9 [Rational(50791840860864512), 50791840860864512.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10110110 #b01101000111001011101001)))
(check-sat)
(exit)
