...
(assert (= z ((_ to_fp 8 24) #xC731DA94)))
;; z should be Float32(0xC731DA94 [Rational(-2913957, 64), -45530.578125])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10001110 #b01100011101101010010011))))
(check-sat)
(exit)
