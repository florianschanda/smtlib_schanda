...
(assert (= z ((_ to_fp 8 24) #x806588A7)))
;; z should be Float32(0x806588A7 [Rational(-6654119, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b00000000 #b11001011000100010100111))))
(check-sat)
(exit)
