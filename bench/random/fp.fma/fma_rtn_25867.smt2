...
(assert (= z (fp #b0 #b11111100 #b00011100011100111111001)))
;; z should be Float32(0x7E0E39F9 [Rational(47262846660596462098275600929036173312), 47262846660596462098275600929036173312.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b11111100 #b00011100011100111111001)))
(check-sat)
(exit)
