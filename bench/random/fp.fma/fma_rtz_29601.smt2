...
(assert (= y ((_ to_fp 8 24) #xFFCAAB88)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x80671CDF)))
;; z should be Float32(0x80671CDF [Rational(-6757599, 713623846352979940529142984724747568191373312), -0.000000])
