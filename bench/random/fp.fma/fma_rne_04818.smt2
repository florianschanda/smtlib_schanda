...
(assert (= z (fp #b1 #b10010100 #b11001000011000111100110)))
;; z should be Float32(0xCA6431E6 [Rational(-7477491, 2), -3738745.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b10010100 #b11001000011000111100110)))
(check-sat)
(exit)
