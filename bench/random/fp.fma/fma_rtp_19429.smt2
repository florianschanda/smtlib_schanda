...
(assert (= z (fp #b1 #b10010101 #b01011101111000000100001)))
;; z should be Float32(0xCAAEF021 [Rational(-11464737, 2), -5732368.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010101 #b01011101111000000100000))))
(check-sat)
(exit)
