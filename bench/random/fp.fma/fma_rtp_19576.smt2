...
(assert (= x ((_ to_fp 8 24) #xE66554BC)))
;; x should be Float32(0xE66554BC [Rational(-270746249476754871681024), -270746249476754871681024.000000])
...
(assert (= result (fp #b1 #b01001110 #b11001010101010010111010)))
(check-sat)
(exit)
