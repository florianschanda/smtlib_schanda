...
(assert (= z (fp #b0 #b00000000 #b10101010100101110010011)))
;; z should be Float32(0x00554B93 [Rational(5589907, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b00000000 #b10101010100101110010011)))
(check-sat)
(exit)
