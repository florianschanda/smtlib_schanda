...
(assert (= y (fp #b1 #b10010101 #b01110010001111110100101)))
;; y should be Float32(0xCAB91FA5 [Rational(-12132261, 2), -6066130.500000])
...
(assert (= result ((_ to_fp 8 24) #x0BB91FA3)))
(check-sat)
(exit)
