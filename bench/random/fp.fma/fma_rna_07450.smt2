...
(assert (= x ((_ to_fp 8 24) #x4A36AE1A)))
;; x should be Float32(0x4A36AE1A [Rational(5986061, 2), 2993030.500000])
...
(assert (= z ((_ to_fp 8 24) #x49E20B5C)))
;; z should be Float32(0x49E20B5C [Rational(3703511, 2), 1851755.500000])
