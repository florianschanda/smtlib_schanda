...
(assert (= z (fp #b0 #b00000000 #b11111111111010111111101)))
;; z should be Float32(0x007FF5FD [Rational(8386045, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10000000 #b11111111111111111111110)))
(check-sat)
(exit)
