...
(assert (= y (fp #b0 #b10010100 #b01010010000011101100010)))
;; y should be Float32(0x4A290762 [Rational(5538737, 2), 2769368.500000])

(declare-const z Float32)
(assert (= z (fp #b0 #b11111111 #b01100001000011100111110)))
