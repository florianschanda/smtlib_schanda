...
(assert (= y ((_ to_fp 8 24) #x802146D4)))
;; y should be Float32(0x802146D4 [Rational(-545205, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBF851B4F))))
(check-sat)
(exit)
