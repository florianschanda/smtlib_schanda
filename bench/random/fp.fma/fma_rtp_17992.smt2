...
(assert (= z (fp #b1 #b00000000 #b01101110101010001010110)))
;; z should be Float32(0x80375456 [Rational(-1813035, 356811923176489970264571492362373784095686656), -0.000000])
