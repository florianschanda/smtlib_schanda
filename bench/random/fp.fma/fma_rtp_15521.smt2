...
(assert (= y ((_ to_fp 8 24) #xFFC4CE5C)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b00111011 #b01001111111111001000001)))
;; z should be Float32(0x9DA7FE41 [Rational(-11009601, 2475880078570760549798248448), -0.000000])
