...
(assert (= y (fp #b0 #b00000000 #b00001001100011010100001)))
;; y should be Float32(0x0004C6A1 [Rational(312993, 713623846352979940529142984724747568191373312), 0.000000])
