...
(assert (= z (fp #b0 #b00000000 #b01001000011010110010110)))
;; z should be Float32(0x00243596 [Rational(1186507, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00000000 #b01001000011010110010110)))
(check-sat)
(exit)
