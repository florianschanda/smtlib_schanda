...
(assert (= x (fp #b0 #b00000000 #b11011000001101101101100)))
;; x should be Float32(0x006C1B6C [Rational(1771227, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x405836D8))))
(check-sat)
(exit)
