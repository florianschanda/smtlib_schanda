...
(assert (= x ((_ to_fp 8 24) #xD957ED02)))
;; x should be Float32(0xD957ED02 [Rational(-3798607052406784), -3798607052406784.000000])
...
(assert (= result (fp #b0 #b00011101 #b10101111110110100000010)))
(check-sat)
(exit)
