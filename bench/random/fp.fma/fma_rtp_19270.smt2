...
(assert (= y ((_ to_fp 8 24) #x7DE1D7A6)))
;; y should be Float32(0x7DE1D7A6 [Rational(37524501219523158190097627564696666112), 37524501219523158190097627564696666112.000000])
