...
(assert (= z (fp #b1 #b11101110 #b00101000001111100000110)))
;; z should be Float32(0xF7141F06 [Rational(-3004254551288448345280005401477120), -3004254551288448345280005401477120.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b11101110 #b00101000001111100000110)))
(check-sat)
(exit)
