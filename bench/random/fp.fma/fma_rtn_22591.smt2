...
(assert (= y (fp #b1 #b10010010 #b10001010001010100011000)))
;; y should be Float32(0xC9451518 [Rational(-1614499, 2), -807249.500000])

(declare-const z Float32)
(assert (= z (fp #b0 #b11111111 #b10101100000111010011011)))
