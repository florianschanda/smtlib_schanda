...
(assert (= x (fp #b1 #b00000000 #b11110001101010111101011)))
;; x should be Float32(0x8078D5EB [Rational(-7919083, 713623846352979940529142984724747568191373312), -0.000000])
