...
(assert (= z (fp #b0 #b00000000 #b00011001101010000011001)))
;; z should be Float32(0x000CD419 [Rational(840729, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b00000000 #b00011001101010000011000))))
(check-sat)
(exit)
