...
(assert (= y (fp #b1 #b00000000 #b01000000000110001101010)))
;; y should be Float32(0x80200C6A [Rational(-1050165, 356811923176489970264571492362373784095686656), -0.000000])
