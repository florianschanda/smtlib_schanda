...
(assert (= z ((_ to_fp 8 24) #x4ABF88E3)))
;; z should be Float32(0x4ABF88E3 [Rational(12552419, 2), 6276209.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010101 #b01111111000100011100011)))
(check-sat)
(exit)
