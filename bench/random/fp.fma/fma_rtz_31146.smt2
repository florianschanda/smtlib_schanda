...
(assert (= x ((_ to_fp 8 24) #xCAB12151)))
;; x should be Float32(0xCAB12151 [Rational(-11608401, 2), -5804200.500000])
...
(assert (= result (fp #b1 #b00010111 #b01100010010000101001111)))
(check-sat)
(exit)
