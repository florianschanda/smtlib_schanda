...
(assert (= z ((_ to_fp 8 24) #x805F89C3)))
;; z should be Float32(0x805F89C3 [Rational(-6261187, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x805F89C2)))
(check-sat)
(exit)
