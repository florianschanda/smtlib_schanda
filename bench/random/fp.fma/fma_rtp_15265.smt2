...
(assert (= z ((_ to_fp 8 24) #x0C7C3DD9)))
;; z should be Float32(0x0C7C3DD9 [Rational(16530905, 85070591730234615865843651857942052864), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00011000 #b11111000011110111011010)))
(check-sat)
(exit)
