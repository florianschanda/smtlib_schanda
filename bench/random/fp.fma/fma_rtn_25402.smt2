...
(assert (= z (fp #b1 #b00000000 #b01011111011111101101110)))
;; z should be Float32(0x802FBF6E [Rational(-1564599, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b00000000 #b01011111011111101101111)))
(check-sat)
(exit)
