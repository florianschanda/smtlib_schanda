...
(assert (= y (fp #b1 #b00000000 #b11110110000111001100100)))
;; y should be Float32(0x807B0E64 [Rational(-2016153, 178405961588244985132285746181186892047843328), -0.000000])
