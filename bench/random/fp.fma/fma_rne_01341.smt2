...
(assert (= z (fp #b1 #b10010011 #b11111011001101001011100)))
;; z should be Float32(0xC9FD9A5C [Rational(-4155031, 2), -2077515.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010011 #b11111011001101001111100))))
(check-sat)
(exit)
