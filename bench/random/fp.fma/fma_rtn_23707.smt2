...
(assert (= x (fp #b0 #b00000000 #b01100011100101000001000)))
;; x should be Float32(0x0031CA08 [Rational(407873, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBFC72820))))
(check-sat)
(exit)
