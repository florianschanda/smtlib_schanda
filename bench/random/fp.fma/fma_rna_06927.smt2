...
(assert (= z (fp #b1 #b10010101 #b10110001000110111010101)))
;; z should be Float32(0xCAD88DD5 [Rational(-14192085, 2), -7096042.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010101 #b10110001000110111010101))))
(check-sat)
(exit)
