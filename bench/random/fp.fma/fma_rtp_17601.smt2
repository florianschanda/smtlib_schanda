...
(assert (= x (fp #b1 #b10010101 #b01010110011110011110111)))
;; x should be Float32(0xCAAB3CF7 [Rational(-11222263, 2), -5611131.500000])
...
(assert (= result ((_ to_fp 8 24) #x0BAB3CF8)))
(check-sat)
(exit)
