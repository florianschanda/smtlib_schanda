...
(assert (= z ((_ to_fp 8 24) #x5B887EB5)))
;; z should be Float32(0x5B887EB5 [Rational(76839825373659136), 76839825373659136.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10110111 #b00010000111111010110101))))
(check-sat)
(exit)
