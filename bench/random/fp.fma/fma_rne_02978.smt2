...
(assert (= x (fp #b0 #b00000000 #b11001101000001001111100)))
;; x should be Float32(0x0066827C [Rational(1679519, 178405961588244985132285746181186892047843328), 0.000000])
