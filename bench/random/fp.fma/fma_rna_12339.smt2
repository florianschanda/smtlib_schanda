...
(assert (= z ((_ to_fp 8 24) #x3AB608F6)))
;; z should be Float32(0x3AB608F6 [Rational(5964923, 4294967296), 0.001389])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b01110101 #b01101011111100011110110))))
(check-sat)
(exit)
