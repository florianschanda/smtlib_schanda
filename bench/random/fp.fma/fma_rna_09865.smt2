...
(assert (= x (fp #b0 #b00000000 #b00100000111101001001001)))
;; x should be Float32(0x00107A49 [Rational(1079881, 713623846352979940529142984724747568191373312), 0.000000])
