...
(assert (= z (fp #b0 #b00000000 #b11011110001101110101110)))
;; z should be Float32(0x006F1BAE [Rational(3640791, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b00000000 #b11011110001101110101110))))
(check-sat)
(exit)
