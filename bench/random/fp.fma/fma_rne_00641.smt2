...
(assert (= x ((_ to_fp 8 24) #x4AAEE17D)))
;; x should be Float32(0x4AAEE17D [Rational(11460989, 2), 5730494.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b01011101110000101111111))))
(check-sat)
(exit)
