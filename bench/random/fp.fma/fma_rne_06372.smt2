...
(assert (= x ((_ to_fp 8 24) #x80197CA2)))
;; x should be Float32(0x80197CA2 [Rational(-835153, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3F4BE50F)))
(check-sat)
(exit)
