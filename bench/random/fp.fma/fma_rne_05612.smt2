...
(assert (= y ((_ to_fp 8 24) #xCA9516D3)))
;; y should be Float32(0xCA9516D3 [Rational(-9770707, 2), -4885353.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b10010101000101101101010))))
(check-sat)
(exit)
