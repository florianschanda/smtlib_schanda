...
(assert (= z ((_ to_fp 8 24) #x80335F28)))
;; z should be Float32(0x80335F28 [Rational(-420837, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b00000000 #b01100110101111100101000)))
(check-sat)
(exit)
