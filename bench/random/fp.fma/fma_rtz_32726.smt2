...
(assert (= z (fp #b0 #b11101000 #b00100000110001100110101)))
;; z should be Float32(0x74106335 [Rational(45758233964379269402481366401024), 45758233964379269402481366401024.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x74106335)))
(check-sat)
(exit)
