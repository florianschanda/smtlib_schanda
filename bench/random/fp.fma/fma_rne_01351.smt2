...
(assert (= z (fp #b0 #b10010101 #b10101011110001010001111)))
;; z should be Float32(0x4AD5E28F [Rational(14017167, 2), 7008583.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010101 #b10101011110001010000111))))
(check-sat)
(exit)
