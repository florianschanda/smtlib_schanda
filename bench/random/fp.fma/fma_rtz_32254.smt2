...
(assert (= z (fp #b1 #b10010000 #b10000110000011100100000)))
;; z should be Float32(0xC8430720 [Rational(-399417, 2), -199708.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010000 #b10000110000011100100000))))
(check-sat)
(exit)
