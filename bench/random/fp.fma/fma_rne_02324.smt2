...
(assert (= y (fp #b0 #b00000000 #b01111001011010110110010)))
;; y should be Float32(0x003CB5B2 [Rational(1989337, 356811923176489970264571492362373784095686656), 0.000000])
