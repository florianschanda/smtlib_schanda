...
(assert (= x (fp #b0 #b10010101 #b10111111111001101010001)))
;; x should be Float32(0x4ADFF351 [Rational(14676817, 2), 7338408.500000])
...
(assert (= result ((_ to_fp 8 24) #x8BDFF34F)))
(check-sat)
(exit)
