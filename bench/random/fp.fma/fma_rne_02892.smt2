...
(assert (= x (fp #b0 #b00000000 #b11010011010011001111010)))
;; x should be Float32(0x0069A67A [Rational(3461949, 356811923176489970264571492362373784095686656), 0.000000])
