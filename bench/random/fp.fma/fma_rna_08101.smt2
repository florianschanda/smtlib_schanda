...
(assert (= y ((_ to_fp 8 24) #x00344278)))
;; y should be Float32(0x00344278 [Rational(428111, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3FD109DF))))
(check-sat)
(exit)
