...
(assert (= z (fp #b1 #b10010100 #b10111101011110101000010)))
;; z should be Float32(0xCA5EBD42 [Rational(-7298721, 2), -3649360.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA5EBD42))))
(check-sat)
(exit)
