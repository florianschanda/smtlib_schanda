...
(assert (= x (fp #b0 #b00000000 #b10011001111100010110110)))
;; x should be Float32(0x004CF8B6 [Rational(2522203, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result (fp #b0 #b10000000 #b00110011111000101101100))))
(check-sat)
(exit)
