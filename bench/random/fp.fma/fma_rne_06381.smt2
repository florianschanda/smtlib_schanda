...
(assert (= x ((_ to_fp 8 24) #x8041F967)))
;; x should be Float32(0x8041F967 [Rational(-4323687, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x4003F2CD)))
(check-sat)
(exit)
