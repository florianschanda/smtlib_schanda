...
(assert (= y (fp #b1 #b10010101 #b11100100001111111100101)))
;; y should be Float32(0xCAF21FE5 [Rational(-15867877, 2), -7933938.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x80790FF4))))
(check-sat)
(exit)
