...
(assert (= x (fp #b1 #b00000000 #b10101111110010110101011)))
;; x should be Float32(0x8057E5AB [Rational(-5760427, 713623846352979940529142984724747568191373312), -0.000000])
