...
(assert (= z (fp #b0 #b01001110 #b10100000100101100010000)))
;; z should be Float32(0x27504B10 [Rational(853169, 295147905179352825856), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x27504B10)))
(check-sat)
(exit)
