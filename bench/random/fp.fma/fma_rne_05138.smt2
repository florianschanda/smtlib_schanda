...
(assert (= z (fp #b0 #b01101010 #b11100000111100111100001)))
;; z should be Float32(0x357079E1 [Rational(15759841, 17592186044416), 0.000001])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b01101010 #b11100000111100111100001))))
(check-sat)
(exit)
