...
(assert (= y (fp #b0 #b11101111 #b01111001011010000110011)))
;; y should be Float32(0x77BCB433 [Rational(7654739716949165018134852233330688), 7654739716949165018134852233330688.000000])
