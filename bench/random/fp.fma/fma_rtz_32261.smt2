...
(assert (= z ((_ to_fp 8 24) #x802A78CB)))
;; z should be Float32(0x802A78CB [Rational(-2783435, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b00000000 #b01010100111100011001011)))
(check-sat)
(exit)
