...
(assert (= y (fp #b1 #b10010100 #b00100011110101001001010)))
;; y should be Float32(0xCA11EA4A [Rational(-4781349, 2), -2390674.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b00100011110101001001010))))
(check-sat)
(exit)
