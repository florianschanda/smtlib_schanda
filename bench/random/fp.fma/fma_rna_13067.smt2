...
(assert (= x (fp #b1 #b00000000 #b11010100101100000011101)))
;; x should be Float32(0x806A581D [Rational(-6969373, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC054B039)))
(check-sat)
(exit)
