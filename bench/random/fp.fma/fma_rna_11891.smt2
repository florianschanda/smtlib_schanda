...
(assert (= y (fp #b1 #b00000000 #b11011001011000110111100)))
;; y should be Float32(0x806CB1BC [Rational(-1780847, 178405961588244985132285746181186892047843328), -0.000000])
