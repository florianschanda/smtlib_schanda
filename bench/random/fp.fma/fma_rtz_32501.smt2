...
(assert (= z ((_ to_fp 8 24) #xCAA559C5)))
;; z should be Float32(0xCAA559C5 [Rational(-10836421, 2), -5418210.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010101 #b01001010101100111000101))))
(check-sat)
(exit)
