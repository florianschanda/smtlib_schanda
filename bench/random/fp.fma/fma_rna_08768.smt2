...
(assert (= z (fp #b0 #b00000000 #b10000001100111110111010)))
;; z should be Float32(0x0040CFBA [Rational(2123741, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b00000000 #b10000001100111110111010))))
(check-sat)
(exit)
