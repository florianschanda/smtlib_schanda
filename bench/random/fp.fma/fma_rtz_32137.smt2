...
(assert (= z ((_ to_fp 8 24) #x0F347AF2)))
;; z should be Float32(0x0F347AF2 [Rational(5913977, 664613997892457936451903530140172288), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b00011110 #b01101000111101011110010))))
(check-sat)
(exit)
