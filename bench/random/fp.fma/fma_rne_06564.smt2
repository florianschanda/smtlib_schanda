...
(assert (= x (fp #b0 #b11111111 #b00001011000000000001110)))
...
(assert (= z ((_ to_fp 8 24) #x0032DCD6)))
;; z should be Float32(0x0032DCD6 [Rational(1666667, 356811923176489970264571492362373784095686656), 0.000000])
