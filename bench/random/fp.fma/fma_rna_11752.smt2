...
(assert (= y ((_ to_fp 8 24) #xCAED022D)))
;; y should be Float32(0xCAED022D [Rational(-15532589, 2), -7766294.500000])
...
(assert (= result (fp #b0 #b00010111 #b11011010000001000101011)))
(check-sat)
(exit)
