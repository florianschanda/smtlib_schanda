...
(assert (= z (fp #b1 #b00111011 #b00011110010110101111011)))
;; z should be Float32(0x9D8F2D7B [Rational(-9383291, 2475880078570760549798248448), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b00111011 #b00011110010110101111010)))
(check-sat)
(exit)
