...
(assert (= x (fp #b1 #b00011011 #b00010101000100111100100)))
;; x should be Float32(0x8D8A89E4 [Rational(-2269817, 2658455991569831745807614120560689152), -0.000000])
...
(assert (= result (fp #b0 #b10011011 #b00010101000100111100011)))
(check-sat)
(exit)
