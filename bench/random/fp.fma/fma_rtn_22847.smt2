...
(assert (= z (fp #b0 #b00000000 #b01011011010101010010101)))
;; z should be Float32(0x002DAA95 [Rational(2992789, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b00000000 #b01011011010101010010101)))
(check-sat)
(exit)
