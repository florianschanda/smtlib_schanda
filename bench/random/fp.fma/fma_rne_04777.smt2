...
(assert (= z ((_ to_fp 8 24) #x65690FEA)))
;; z should be Float32(0x65690FEA [Rational(68787809571671115825152), 68787809571671115825152.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b11001010 #b11010010000111111101010))))
(check-sat)
(exit)
