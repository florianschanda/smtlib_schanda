...
(assert (= z (fp #b1 #b10010101 #b01111101000011101010111)))
;; z should be Float32(0xCABE8757 [Rational(-12486487, 2), -6243243.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #xCABE8758)))
(check-sat)
(exit)
