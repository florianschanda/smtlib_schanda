...
(assert (= x (fp #b1 #b00000000 #b11001000010001101111011)))
;; x should be Float32(0x8064237B [Rational(-6562683, 713623846352979940529142984724747568191373312), -0.000000])
