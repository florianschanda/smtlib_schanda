...
(assert (= z (fp #b0 #b10010101 #b10100011111110111010001)))
;; z should be Float32(0x4AD1FDD1 [Rational(13762001, 2), 6881000.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x4AD1FDD1)))
(check-sat)
(exit)
