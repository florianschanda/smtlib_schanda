...
(assert (= x (fp #b0 #b01111101 #b01100001011111010101001)))
;; x should be Float32(0x3EB0BEA9 [Rational(11583145, 33554432), 0.345205])
...
(assert (not (= result ((_ to_fp 8 24) #x80AC2FA9))))
(check-sat)
(exit)
