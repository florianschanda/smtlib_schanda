...
(assert (= z ((_ to_fp 8 24) #x00144EFA)))
;; z should be Float32(0x00144EFA [Rational(665469, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b00000000 #b00101000100111011111010))))
(check-sat)
(exit)
