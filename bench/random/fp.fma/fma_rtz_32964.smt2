...
(assert (= z (fp #b1 #b00000000 #b00101000101100110011100)))
;; z should be Float32(0x8014599C [Rational(-333415, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b00000000 #b00101000101100110011100)))
(check-sat)
(exit)
