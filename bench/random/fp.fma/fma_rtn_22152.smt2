...
(assert (= z ((_ to_fp 8 24) #x8C965C35)))
;; z should be Float32(0x8C965C35 [Rational(-9854005, 42535295865117307932921825928971026432), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x8C965C35)))
(check-sat)
(exit)
