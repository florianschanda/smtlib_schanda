...
(assert (= z ((_ to_fp 8 24) #x885999C8)))
;; z should be Float32(0x885999C8 [Rational(-1782585, 2722258935367507707706996859454145691648), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x885999C8)))
(check-sat)
(exit)
