...
(assert (= x (fp #b0 #b11100100 #b01010111011111101101011)))
;; x should be Float32(0x722BBF6B [Rational(3401814195469444350486035562496), 3401814195469444350486035562496.000000])
