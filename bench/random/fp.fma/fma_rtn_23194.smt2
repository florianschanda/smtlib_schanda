...
(assert (= x (fp #b0 #b10101001 #b00001010101011110001111)))
;; x should be Float32(0x5485578F [Rational(4581597118464), 4581597118464.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x1585578D))))
(check-sat)
(exit)
