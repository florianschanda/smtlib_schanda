...
(assert (= z ((_ to_fp 8 24) #x007EE9E3)))
;; z should be Float32(0x007EE9E3 [Rational(8317411, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b00000000 #b11111101110100111100010)))
(check-sat)
(exit)
