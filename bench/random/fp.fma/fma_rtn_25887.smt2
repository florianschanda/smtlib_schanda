...
(assert (= z ((_ to_fp 8 24) #x005984C8)))
;; z should be Float32(0x005984C8 [Rational(733337, 89202980794122492566142873090593446023921664), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b00000000 #b10110011000010011001000)))
(check-sat)
(exit)
