...
(assert (= z (fp #b1 #b10010101 #b01000010010000001000101)))
;; z should be Float32(0xCAA12045 [Rational(-10559557, 2), -5279778.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010101 #b01000010010000001001101))))
(check-sat)
(exit)
