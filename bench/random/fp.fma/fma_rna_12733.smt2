...
(assert (= x (fp #b1 #b11010101 #b11010011101100001001100)))
;; x should be Float32(0xEAE9D84C [Rational(-141350574541529021499310080), -141350574541529021499310080.000000])
