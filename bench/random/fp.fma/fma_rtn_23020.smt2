...
(assert (= z (fp #b1 #b10010010 #b10100011100000111111000)))
;; z should be Float32(0xC951C1F8 [Rational(-1718335, 2), -859167.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10010010 #b10100011100000111111001))))
(check-sat)
(exit)
