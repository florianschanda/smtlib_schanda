...
(assert (= x (fp #b0 #b10010101 #b01111110110010010010101)))
;; x should be Float32(0x4ABF6495 [Rational(12543125, 2), 6271562.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8BBF6495))))
(check-sat)
(exit)
