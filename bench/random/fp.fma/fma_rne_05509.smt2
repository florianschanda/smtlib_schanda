...
(assert (= z ((_ to_fp 8 24) #x80376A0E)))
;; z should be Float32(0x80376A0E [Rational(-1815815, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b00000000 #b01101110110101000001110))))
(check-sat)
(exit)
