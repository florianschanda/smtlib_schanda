...
(assert (= x (fp #b1 #b00000000 #b11100111110111001001001)))
;; x should be Float32(0x8073EE49 [Rational(-7597641, 713623846352979940529142984724747568191373312), -0.000000])
