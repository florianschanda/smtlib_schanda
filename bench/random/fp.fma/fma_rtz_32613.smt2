...
(assert (= z (fp #b0 #b00000000 #b11111110100000101101001)))
;; z should be Float32(0x007F4169 [Rational(8339817, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b00000000 #b11111110100000101101000))))
(check-sat)
(exit)
