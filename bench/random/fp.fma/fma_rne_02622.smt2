...
(assert (= x ((_ to_fp 8 24) #x5F80DF00)))
;; x should be Float32(0x5F80DF00 [Rational(18572281913322504192), 18572281913322504192.000000])
...
(assert (= z (fp #b1 #b11111111 #b01001111011001111100110)))
