...
(assert (= x (fp #b0 #b00000000 #b01101010000011010011111)))
;; x should be Float32(0x0035069F [Rational(3475103, 713623846352979940529142984724747568191373312), 0.000000])
