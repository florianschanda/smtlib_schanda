...
(assert (= z ((_ to_fp 8 24) #x12F7C226)))
;; z should be Float32(0x12F7C226 [Rational(8118547, 5192296858534827628530496329220096), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x12F7C225)))
(check-sat)
(exit)
