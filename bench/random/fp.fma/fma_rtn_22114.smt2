...
(assert (= z ((_ to_fp 8 24) #xA564915B)))
;; z should be Float32(0xA564915B [Rational(-14979419, 75557863725914323419136), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b01001010 #b11001001001000101011011))))
(check-sat)
(exit)
