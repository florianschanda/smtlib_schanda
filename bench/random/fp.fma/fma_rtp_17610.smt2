...
(assert (= x ((_ to_fp 8 24) #xC97A4568)))
;; x should be Float32(0xC97A4568 [Rational(-2050221, 2), -1025110.500000])
...
(assert (not (= result (fp #b0 #b00010100 #b11110100100010101101000))))
(check-sat)
(exit)
