...
(assert (= x (fp #b0 #b11010010 #b10111111010111110001000)))
;; x should be Float32(0x695FAF88 [Rational(16901211291609907398180864), 16901211291609907398180864.000000])
...
(assert (= result ((_ to_fp 8 24) #x2A5FAF89)))
(check-sat)
(exit)
