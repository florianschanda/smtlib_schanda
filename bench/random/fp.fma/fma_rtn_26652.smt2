...
(assert (= x ((_ to_fp 8 24) #xDE16D971)))
;; x should be Float32(0xDE16D971 [Rational(-2717460855112335360), -2717460855112335360.000000])
...
(assert (= result ((_ to_fp 8 24) #x1396D970)))
(check-sat)
(exit)
