...
(assert (= z (fp #b0 #b00101001 #b10011001110100001110111)))
;; z should be Float32(0x14CCE877 [Rational(13428855, 649037107316853453566312041152512), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x14CCE877)))
(check-sat)
(exit)
