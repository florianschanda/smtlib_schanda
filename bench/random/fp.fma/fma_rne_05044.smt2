...
(assert (= y ((_ to_fp 8 24) #x7FF3802A)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x000B659B)))
;; z should be Float32(0x000B659B [Rational(746907, 713623846352979940529142984724747568191373312), 0.000000])
