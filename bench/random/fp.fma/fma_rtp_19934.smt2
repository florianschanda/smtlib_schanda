...
(assert (= x (fp #b1 #b00000000 #b01110001101001011001110)))
;; x should be Float32(0x8038D2CE [Rational(-1861991, 356811923176489970264571492362373784095686656), -0.000000])
