...
(assert (= x ((_ to_fp 8 24) #xCAC001C9)))
;; x should be Float32(0xCAC001C9 [Rational(-12583369, 2), -6291684.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b10000000000000111001010))))
(check-sat)
(exit)
