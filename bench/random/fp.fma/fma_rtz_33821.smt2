...
(assert (= x (fp #b1 #b00000000 #b01000111100000111111100)))
;; x should be Float32(0x8023C1FC [Rational(-585855, 178405961588244985132285746181186892047843328), -0.000000])
