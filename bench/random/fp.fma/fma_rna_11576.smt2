...
(assert (= y (fp #b0 #b10010101 #b10110010001101101001001)))
;; y should be Float32(0x4AD91B49 [Rational(14228297, 2), 7114148.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8BD91B45))))
(check-sat)
(exit)
