...
(assert (= x (fp #b1 #b10010001 #b10000010110010110010000)))
;; x should be Float32(0xC8C16590 [Rational(-792153, 2), -396076.500000])
...
(assert (not (= result (fp #b0 #b00010011 #b10000010110010101101110))))
(check-sat)
(exit)
