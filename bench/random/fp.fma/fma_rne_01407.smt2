...
(assert (= y ((_ to_fp 8 24) #x80132A3A)))
;; y should be Float32(0x80132A3A [Rational(-627997, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result (fp #b1 #b01111110 #b00110010101000111001111)))
(check-sat)
(exit)
