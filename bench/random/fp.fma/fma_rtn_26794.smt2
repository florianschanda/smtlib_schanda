...
(assert (= x (fp #b1 #b00000000 #b10010011011100001111110)))
;; x should be Float32(0x8049B87E [Rational(-2415679, 356811923176489970264571492362373784095686656), -0.000000])
