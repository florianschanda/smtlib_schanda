...
(assert (= z ((_ to_fp 8 24) #xCA6FF722)))
;; z should be Float32(0xCA6FF722 [Rational(-7863185, 2), -3931592.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010100 #b11011111111011100100001))))
(check-sat)
(exit)
