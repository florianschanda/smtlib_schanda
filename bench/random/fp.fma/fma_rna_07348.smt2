...
(assert (= x (fp #b0 #b10010101 #b01111100100011011110001)))
;; x should be Float32(0x4ABE46F1 [Rational(12470001, 2), 6235000.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8020DC87))))
(check-sat)
(exit)
