...
(assert (= z ((_ to_fp 8 24) #x9698C86C)))
;; z should be Float32(0x9698C86C [Rational(-2503195, 10141204801825835211973625643008), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x9698C86C)))
(check-sat)
(exit)
