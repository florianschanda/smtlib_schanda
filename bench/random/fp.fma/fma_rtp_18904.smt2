...
(assert (= z (fp #b1 #b00000000 #b11110110011010011000011)))
;; z should be Float32(0x807B34C3 [Rational(-8074435, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x807B34C3))))
(check-sat)
(exit)
