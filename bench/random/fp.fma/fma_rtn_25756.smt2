...
(assert (= z ((_ to_fp 8 24) #xCAF80243)))
;; z should be Float32(0xCAF80243 [Rational(-16253507, 2), -8126753.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10010101 #b11110000000001001000100)))
(check-sat)
(exit)
