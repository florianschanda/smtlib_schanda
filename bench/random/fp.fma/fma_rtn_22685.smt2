...
(assert (= z ((_ to_fp 8 24) #x8079FBEA)))
;; z should be Float32(0x8079FBEA [Rational(-3997173, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b00000000 #b11110011111101111101011)))
(check-sat)
(exit)
