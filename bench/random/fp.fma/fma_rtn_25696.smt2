...
(assert (= z ((_ to_fp 8 24) #x54146E96)))
;; z should be Float32(0x54146E96 [Rational(2550041935872), 2550041935872.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10101000 #b00101000110111010010101))))
(check-sat)
(exit)
