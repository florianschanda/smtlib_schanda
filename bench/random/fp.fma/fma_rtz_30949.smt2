...
(assert (= z ((_ to_fp 8 24) #xD8D28857)))
;; z should be Float32(0xD8D28857 [Rational(-1851864136024064), -1851864136024064.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10110001 #b10100101000100001010111))))
(check-sat)
(exit)
