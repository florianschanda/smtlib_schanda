...
(assert (= x (fp #b0 #b11111111 #b10001101000000011010101)))
...
(assert (= z (fp #b0 #b10010001 #b10110101101000110111100)))
;; z should be Float32(0x48DAD1BC [Rational(3585135, 8), 448141.875000])
