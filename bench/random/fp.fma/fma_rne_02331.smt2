...
(assert (= y (fp #b0 #b00000000 #b10101110001111110110010)))
;; y should be Float32(0x00571FB2 [Rational(2854873, 356811923176489970264571492362373784095686656), 0.000000])
