...
(assert (= x (fp #b0 #b00000000 #b11001001001110011111101)))
;; x should be Float32(0x00649CFD [Rational(6593789, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xFF8233F1)))
