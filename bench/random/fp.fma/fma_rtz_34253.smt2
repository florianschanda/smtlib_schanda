...
(assert (= x ((_ to_fp 8 24) #xFFE50241)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xEC790EE2)))
;; y should be Float32(0xEC790EE2 [Rational(-1204371244715853991573979136), -1204371244715853991573979136.000000])
