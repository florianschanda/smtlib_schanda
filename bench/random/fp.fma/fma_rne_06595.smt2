...
(assert (= x (fp #b1 #b11111111 #b11111100101011010111100)))
...
(assert (= z (fp #b0 #b10010101 #b00111101111000110100011)))
;; z should be Float32(0x4A9EF1A3 [Rational(10416547, 2), 5208273.500000])
