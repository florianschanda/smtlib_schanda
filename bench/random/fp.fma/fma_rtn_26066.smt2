...
(assert (= z ((_ to_fp 8 24) #xADD2AD9A)))
;; z should be Float32(0xADD2AD9A [Rational(-6903501, 288230376151711744), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b01101010 #b00000000000000110100101)))
(check-sat)
(exit)
