...
(assert (= x ((_ to_fp 8 24) #x7BF347A4)))
;; x should be Float32(0x7BF347A4 [Rational(2526362362248949443368752408099291136), 2526362362248949443368752408099291136.000000])
