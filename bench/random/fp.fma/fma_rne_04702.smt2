...
(assert (= z (fp #b0 #b00000000 #b11111110001010010101000)))
;; z should be Float32(0x007F14A8 [Rational(1041045, 89202980794122492566142873090593446023921664), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b00000000 #b11111110001010010101000)))
(check-sat)
(exit)
