...
(assert (= y ((_ to_fp 8 24) #x801C70B6)))
;; y should be Float32(0x801C70B6 [Rational(-931931, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result (fp #b1 #b01111110 #b11000111000010110101111)))
(check-sat)
(exit)
