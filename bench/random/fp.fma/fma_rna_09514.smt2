...
(assert (= x (fp #b0 #b11101111 #b11000110010110011000001)))
;; x should be Float32(0x77E32CC1 [Rational(9215305499572904673376811716968448), 9215305499572904673376811716968448.000000])
...
(assert (= result (fp #b0 #b01011010 #b11000110010110011000001)))
(check-sat)
(exit)
