...
(assert (= z (fp #b1 #b00000000 #b11101100110000101111011)))
;; z should be Float32(0x8076617B [Rational(-7758203, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x8076617B))))
(check-sat)
(exit)
