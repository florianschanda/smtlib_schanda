...
(assert (= x (fp #b0 #b10010101 #b10111110010011001001111)))
;; x should be Float32(0x4ADF264F [Rational(14624335, 2), 7312167.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x806F9327))))
(check-sat)
(exit)
