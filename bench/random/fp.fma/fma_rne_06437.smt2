...
(assert (= x (fp #b1 #b00000000 #b10010100100001000100100)))
;; x should be Float32(0x804A4224 [Rational(-1216649, 178405961588244985132285746181186892047843328), -0.000000])
