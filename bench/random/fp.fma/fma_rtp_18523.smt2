...
(assert (= z ((_ to_fp 8 24) #xF1B09F74)))
;; z should be Float32(0xF1B09F74 [Rational(-1749188119308399072421905170432), -1749188119308399072421905170432.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #xF1B09F74)))
(check-sat)
(exit)
