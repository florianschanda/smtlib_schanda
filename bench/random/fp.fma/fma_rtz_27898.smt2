...
(assert (= x (fp #b0 #b10010101 #b10101100010001001000101)))
;; x should be Float32(0x4AD62245 [Rational(14033477, 2), 7016738.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b10101100010001001000111))))
(check-sat)
(exit)
