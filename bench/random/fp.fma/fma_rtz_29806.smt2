...
(assert (= y ((_ to_fp 8 24) #xCA533956)))
;; y should be Float32(0xCA533956 [Rational(-6921387, 2), -3460693.500000])
...
(assert (not (= result (fp #b1 #b00000001 #b01101001100111001010100))))
(check-sat)
(exit)
