...
(assert (= z (fp #b1 #b10001010 #b00001011110000001001011)))
;; z should be Float32(0xC505E04B [Rational(-8773707, 4096), -2142.018311])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #xC505E04B))))
(check-sat)
(exit)
