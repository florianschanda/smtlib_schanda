...
(assert (= x (fp #b1 #b10010101 #b00110011111100001000011)))
;; x should be Float32(0xCA99F843 [Rational(-10090563, 2), -5045281.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0B99F840))))
(check-sat)
(exit)
