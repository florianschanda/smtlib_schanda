...
(assert (= z (fp #b1 #b00100111 #b11101101101001000100111)))
;; z should be Float32(0x93F6D227 [Rational(-16175655, 2596148429267413814265248164610048), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x93F6D227))))
(check-sat)
(exit)
