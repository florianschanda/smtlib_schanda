...
(assert (= z (fp #b1 #b00000000 #b01001010010000001011000)))
;; z should be Float32(0x80252058 [Rational(-304139, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x80252058))))
(check-sat)
(exit)
