...
(assert (= y (fp #b1 #b10010001 #b10000110111001100100101)))
;; y should be Float32(0xC8C37325 [Rational(-12808997, 32), -400281.156250])
...
(assert (not (= result (fp #b0 #b00010011 #b10000110111001101000100))))
(check-sat)
(exit)
