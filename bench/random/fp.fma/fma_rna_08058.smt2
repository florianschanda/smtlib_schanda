...
(assert (= z (fp #b0 #b10010101 #b00010001101100100010111)))
;; z should be Float32(0x4A88D917 [Rational(8968471, 2), 4484235.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010101 #b00010001101100100010111))))
(check-sat)
(exit)
