...
(assert (= z ((_ to_fp 8 24) #xCAD09003)))
;; z should be Float32(0xCAD09003 [Rational(-13668355, 2), -6834177.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b10010101 #b10100001001000000000011)))
(check-sat)
(exit)
