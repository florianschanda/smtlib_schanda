...
(assert (= x ((_ to_fp 8 24) #x4A6DC972)))
;; x should be Float32(0x4A6DC972 [Rational(7791801, 2), 3895900.500000])
...
(assert (not (= result (fp #b1 #b00000001 #b01110110111001001011100))))
(check-sat)
(exit)
