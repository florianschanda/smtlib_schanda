...
(assert (= x ((_ to_fp 8 24) #x4AD91CAF)))
;; x should be Float32(0x4AD91CAF [Rational(14228655, 2), 7114327.500000])
...
(assert (= z ((_ to_fp 8 24) #xA81203DD)))
;; z should be Float32(0xA81203DD [Rational(-9569245, 1180591620717411303424), -0.000000])
