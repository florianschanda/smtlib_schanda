...
(assert (= x (fp #b1 #b10010101 #b11111011100100010110011)))
;; x should be Float32(0xCAFDC8B3 [Rational(-16631987, 2), -8315993.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b11111011100100010110010))))
(check-sat)
(exit)
