...
(assert (= z (fp #b1 #b10001010 #b10000011101110001001101)))
;; z should be Float32(0xC541DC4D [Rational(-12704845, 4096), -3101.768799])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10001010 #b10000011101110001001101)))
(check-sat)
(exit)
