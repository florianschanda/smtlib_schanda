...
(assert (= x ((_ to_fp 8 24) #xB9183609)))
;; x should be Float32(0xB9183609 [Rational(-9975305, 68719476736), -0.000145])
...
(assert (= result (fp #b1 #b00000000 #b00000000000010011000001)))
(check-sat)
(exit)
