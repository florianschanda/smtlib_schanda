...
(assert (= x ((_ to_fp 8 24) #x8015F458)))
;; x should be Float32(0x8015F458 [Rational(-179851, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7FC97C92)))
