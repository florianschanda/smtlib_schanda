...
(assert (= z (fp #b0 #b00000000 #b01100110110100101111111)))
;; z should be Float32(0x0033697F [Rational(3369343, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00000000 #b01100110110100110000000)))
(check-sat)
(exit)
