...
(assert (= z (fp #b0 #b10010101 #b11110101110010100111101)))
;; z should be Float32(0x4AFAE53D [Rational(16442685, 2), 8221342.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b11110101110010100111101)))
(check-sat)
(exit)
