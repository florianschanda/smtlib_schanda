...
(assert (= x (fp #b1 #b11011010 #b11011110000111001011001)))
;; x should be Float32(0xED6F0E59 [Rational(-4624016412462065727005786112), -4624016412462065727005786112.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x2E6F0E57))))
(check-sat)
(exit)
