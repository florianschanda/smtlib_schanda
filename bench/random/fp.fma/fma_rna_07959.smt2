...
(assert (= z ((_ to_fp 8 24) #xE4225BD9)))
;; z should be Float32(0xE4225BD9 [Rational(-11979963444273380065280), -11979963444273380065280.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b11001000 #b01000100101101111011001))))
(check-sat)
(exit)
