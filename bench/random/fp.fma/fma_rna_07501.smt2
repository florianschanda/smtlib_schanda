...
(assert (= x ((_ to_fp 8 24) #x4AF62E41)))
;; x should be Float32(0x4AF62E41 [Rational(16133697, 2), 8066848.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b11101100010111001000011))))
(check-sat)
(exit)
