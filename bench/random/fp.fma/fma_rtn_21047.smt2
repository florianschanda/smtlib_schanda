...
(assert (= x ((_ to_fp 8 24) #x4A6671CE)))
;; x should be Float32(0x4A6671CE [Rational(7551207, 2), 3775603.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b11001100111000111001010))))
(check-sat)
(exit)
