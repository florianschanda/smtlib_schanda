...
(assert (= y (fp #b1 #b10010101 #b10110001000111011111101)))
;; y should be Float32(0xCAD88EFD [Rational(-14192381, 2), -7096190.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BD88EFB))))
(check-sat)
(exit)
