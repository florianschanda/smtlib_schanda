...
(assert (= z (fp #b0 #b10010100 #b01010111000100000101110)))
;; z should be Float32(0x4A2B882E [Rational(5620759, 2), 2810379.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4A2B883E))))
(check-sat)
(exit)
