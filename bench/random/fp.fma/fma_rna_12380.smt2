...
(assert (= z (fp #b1 #b10010000 #b11100010110001100100000)))
;; z should be Float32(0xC8716320 [Rational(-494361, 2), -247180.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #xC8716320))))
(check-sat)
(exit)
