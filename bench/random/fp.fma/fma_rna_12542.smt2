...
(assert (= z ((_ to_fp 8 24) #x49E207CC)))
;; z should be Float32(0x49E207CC [Rational(3703283, 2), 1851641.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010011 #b11000100000011111001100))))
(check-sat)
(exit)
