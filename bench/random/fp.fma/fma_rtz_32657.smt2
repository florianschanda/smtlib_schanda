...
(assert (= y (fp #b0 #b00000000 #b00110010100101000101010)))
;; y should be Float32(0x00194A2A [Rational(828693, 356811923176489970264571492362373784095686656), 0.000000])
