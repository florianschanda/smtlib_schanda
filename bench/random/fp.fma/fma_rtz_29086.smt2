...
(assert (= y ((_ to_fp 8 24) #xCAF21CB3)))
;; y should be Float32(0xCAF21CB3 [Rational(-15867059, 2), -7933529.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b11100100001110010110001))))
(check-sat)
(exit)
