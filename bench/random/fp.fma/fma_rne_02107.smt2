...
(assert (= z ((_ to_fp 8 24) #xD3475DF0)))
;; z should be Float32(0xD3475DF0 [Rational(-856274501632), -856274501632.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10100110 #b10001110101110111110000))))
(check-sat)
(exit)
