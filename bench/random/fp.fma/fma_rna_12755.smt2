...
(assert (= x (fp #b1 #b10101101 #b00110011100000011110101)))
;; x should be Float32(0xD699C0F5 [Rational(-84527011594240), -84527011594240.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x8C19C0F4))))
(check-sat)
(exit)
