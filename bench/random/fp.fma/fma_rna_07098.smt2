...
(assert (= z ((_ to_fp 8 24) #xC997F6AC)))
;; z should be Float32(0xC997F6AC [Rational(-2489771, 2), -1244885.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010011 #b00101111111011010101100))))
(check-sat)
(exit)
