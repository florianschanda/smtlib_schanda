...
(assert (= x ((_ to_fp 8 24) #x0013F038)))
;; x should be Float32(0x0013F038 [Rational(163335, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (not (= result (fp #b1 #b01111110 #b00111111000000110111111))))
(check-sat)
(exit)
