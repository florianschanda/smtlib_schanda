...
(assert (= x ((_ to_fp 8 24) #x003D7061)))
;; x should be Float32(0x003D7061 [Rational(4026465, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= z (fp #b0 #b11111111 #b00011000110001100000000)))
