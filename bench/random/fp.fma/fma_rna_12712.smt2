...
(assert (= x (fp #b1 #b10100110 #b01001001000101010110101)))
;; x should be Float32(0xD3248AB5 [Rational(-706701754368), -706701754368.000000])
...
(assert (= result (fp #b1 #b00101000 #b01001001000101010110100)))
(check-sat)
(exit)
