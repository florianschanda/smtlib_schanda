...
(assert (= z (fp #b0 #b10110011 #b01100101101100011111111)))
;; z should be Float32(0x59B2D8FF [Rational(6292641947844608), 6292641947844608.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10110011 #b01100101101100011111110))))
(check-sat)
(exit)
