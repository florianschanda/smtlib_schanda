...
(assert (= z ((_ to_fp 8 24) #x4AED5F8F)))
;; z should be Float32(0x4AED5F8F [Rational(15556495, 2), 7778247.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11011010101111110010110))))
(check-sat)
(exit)
