...
(assert (= y (fp #b0 #b11111100 #b11100001010111110010100)))
;; y should be Float32(0x7E70AF94 [Rational(79981593183811186194782318879521636352), 79981593183811186194782318879521636352.000000])
...
(assert (= result (fp #b0 #b01100111 #b11100001010111110010100)))
(check-sat)
(exit)
