...
(assert (= z (fp #b0 #b00000000 #b01000110000011110001100)))
;; z should be Float32(0x0023078C [Rational(573923, 178405961588244985132285746181186892047843328), 0.000000])
