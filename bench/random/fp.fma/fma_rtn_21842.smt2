...
(assert (= z ((_ to_fp 8 24) #xCA4141FA)))
;; z should be Float32(0xCA4141FA [Rational(-6332669, 2), -3166334.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10010100 #b10000010100000111111010))))
(check-sat)
(exit)
