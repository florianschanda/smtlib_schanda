...
(assert (= x (fp #b1 #b00000000 #b00111010100111010011011)))
;; x should be Float32(0x801D4E9B [Rational(-1920667, 713623846352979940529142984724747568191373312), -0.000000])
