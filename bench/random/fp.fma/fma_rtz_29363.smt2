...
(assert (= z (fp #b0 #b10100111 #b10010101101100111011111)))
;; z should be Float32(0x53CAD9DF [Rational(1742477328384), 1742477328384.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10100111 #b10010101101100111011111))))
(check-sat)
(exit)
