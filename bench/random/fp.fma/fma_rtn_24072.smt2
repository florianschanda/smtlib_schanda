...
(assert (= z ((_ to_fp 8 24) #x8010C72A)))
;; z should be Float32(0x8010C72A [Rational(-549781, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b00000000 #b00100001100011100101010)))
(check-sat)
(exit)
