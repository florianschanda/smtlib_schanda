...
(assert (= x ((_ to_fp 8 24) #xD6AC8DDC)))
;; x should be Float32(0xD6AC8DDC [Rational(-94862640676864), -94862640676864.000000])
...
(assert (= z (fp #b1 #b11111111 #b11101001010101101001001)))
