...
(assert (= y (fp #b1 #b00000000 #b11111110111110000000100)))
;; y should be Float32(0x807F7C04 [Rational(-2088705, 178405961588244985132285746181186892047843328), -0.000000])
