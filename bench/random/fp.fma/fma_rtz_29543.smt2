...
(assert (= z (fp #b1 #b10110010 #b00000000011101000100001)))
;; z should be Float32(0xD9003A21 [Rational(-2255794401705984), -2255794401705984.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10110010 #b00000000011101000100001)))
(check-sat)
(exit)
