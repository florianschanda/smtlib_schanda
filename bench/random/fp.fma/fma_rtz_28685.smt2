...
(assert (= y (fp #b0 #b00000000 #b10010110101101111110101)))
;; y should be Float32(0x004B5BF5 [Rational(4938741, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b0 #b10000000 #b00101101011011111101001))))
(check-sat)
(exit)
