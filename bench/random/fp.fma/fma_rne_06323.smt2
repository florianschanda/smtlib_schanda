...
(assert (= x (fp #b1 #b00000000 #b10101100001100101000001)))
;; x should be Float32(0x80561941 [Rational(-5642561, 713623846352979940529142984724747568191373312), -0.000000])
