...
(assert (= z (fp #b0 #b10010011 #b00011011001110010000100)))
;; z should be Float32(0x498D9C84 [Rational(2320161, 2), 1160080.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010011 #b00011011001110010000100)))
(check-sat)
(exit)
