...
(assert (= x (fp #b0 #b01000110 #b11100010100000010111111)))
;; x should be Float32(0x237140BF [Rational(15810751, 1208925819614629174706176), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x637140BE))))
(check-sat)
(exit)
