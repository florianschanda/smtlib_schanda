...
(assert (= z (fp #b0 #b10001011 #b01000011010101111000001)))
;; z should be Float32(0x45A1ABC1 [Rational(10595265, 2048), 5173.469238])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x45A1CBC1)))
(check-sat)
(exit)
