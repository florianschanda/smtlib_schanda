...
(assert (= x (fp #b0 #b10010101 #b10011001010000110011001)))
;; x should be Float32(0x4ACCA199 [Rational(13410713, 2), 6705356.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x80E650CD))))
(check-sat)
(exit)
