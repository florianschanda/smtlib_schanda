...
(assert (= z (fp #b1 #b10100111 #b01000000100110100000111)))
;; z should be Float32(0xD3A04D07 [Rational(-1376974143488), -1376974143488.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10100111 #b01000000100110100001000))))
(check-sat)
(exit)
