...
(assert (= z (fp #b1 #b10010101 #b10110001101011011001101)))
;; z should be Float32(0xCAD8D6CD [Rational(-14210765, 2), -7105382.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAD8D6CD))))
(check-sat)
(exit)
