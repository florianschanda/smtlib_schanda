...
(assert (= x (fp #b0 #b00000000 #b01110010101011010100101)))
;; x should be Float32(0x003956A5 [Rational(3757733, 713623846352979940529142984724747568191373312), 0.000000])
