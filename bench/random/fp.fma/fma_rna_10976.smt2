...
(assert (= y (fp #b0 #b00000011 #b00110011011100111011101)))
;; y should be Float32(0x0199B9DD [Rational(10074589, 178405961588244985132285746181186892047843328), 0.000000])
