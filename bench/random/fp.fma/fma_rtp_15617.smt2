...
(assert (= z (fp #b1 #b00000000 #b10101011000001110011100)))
;; z should be Float32(0x8055839C [Rational(-1401063, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b00000000 #b10101011000001110011011)))
(check-sat)
(exit)
