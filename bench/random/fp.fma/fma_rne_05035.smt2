...
(assert (= y ((_ to_fp 8 24) #x802C6878)))
;; y should be Float32(0x802C6878 [Rational(-363791, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b01110010011110101000010)))
