...
(assert (= y (fp #b0 #b10111101 #b11010000111011011100100)))
;; y should be Float32(0x5EE876E4 [Rational(8375413276351135744), 8375413276351135744.000000])
...
(assert (= result ((_ to_fp 8 24) #x9FE876E2)))
(check-sat)
(exit)
