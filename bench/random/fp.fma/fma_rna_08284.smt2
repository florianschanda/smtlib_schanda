...
(assert (= y (fp #b1 #b00000000 #b01101111111011100000101)))
;; y should be Float32(0x8037F705 [Rational(-3667717, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FCA2B64)))
