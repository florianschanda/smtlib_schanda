...
(assert (= x (fp #b1 #b00000000 #b00100000111110100001010)))
;; x should be Float32(0x80107D0A [Rational(-540293, 356811923176489970264571492362373784095686656), -0.000000])
