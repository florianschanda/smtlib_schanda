...
(assert (= y ((_ to_fp 8 24) #xBBC26BB2)))
;; y should be Float32(0xBBC26BB2 [Rational(-6370777, 1073741824), -0.005933])
...
(assert (= result (fp #b0 #b11110111 #b10000100110101110110001)))
(check-sat)
(exit)
