...
(assert (= z (fp #b1 #b10010101 #b11110100101110110011011)))
;; z should be Float32(0xCAFA5D9B [Rational(-16407963, 2), -8203981.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010101 #b11110100101110110011011)))
(check-sat)
(exit)
