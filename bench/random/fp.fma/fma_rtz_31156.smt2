...
(assert (= x (fp #b1 #b10010011 #b10011001100011011110100)))
;; x should be Float32(0xC9CCC6F4 [Rational(-3355069, 2), -1677534.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8ACCC6FC))))
(check-sat)
(exit)
