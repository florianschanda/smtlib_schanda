...
(assert (= z ((_ to_fp 8 24) #x80070F4C)))
;; z should be Float32(0x80070F4C [Rational(-115667, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00001110000111101001100))))
(check-sat)
(exit)
