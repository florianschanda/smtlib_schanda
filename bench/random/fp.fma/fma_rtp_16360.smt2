...
(assert (= x (fp #b0 #b11010001 #b01110110010001000100001)))
;; x should be Float32(0x68BB2221 [Rational(7069696795965864250703872), 7069696795965864250703872.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x1E3B2221))))
(check-sat)
(exit)
