...
(assert (= y ((_ to_fp 8 24) #x4AC837BD)))
;; y should be Float32(0x4AC837BD [Rational(13121469, 2), 6560734.500000])
...
(assert (= result (fp #b0 #b00000001 #b11001000001101111011110)))
(check-sat)
(exit)
