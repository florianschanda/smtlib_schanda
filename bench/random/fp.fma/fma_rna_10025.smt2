...
(assert (= x (fp #b0 #b00000000 #b00100101011011000111011)))
;; x should be Float32(0x0012B63B [Rational(1226299, 713623846352979940529142984724747568191373312), 0.000000])
