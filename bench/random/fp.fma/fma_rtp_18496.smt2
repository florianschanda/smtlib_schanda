...
(assert (= z (fp #b0 #b00000000 #b01111111101101110011100)))
;; z should be Float32(0x003FDB9C [Rational(1046247, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b00000000 #b01111111101101110011100))))
(check-sat)
(exit)
