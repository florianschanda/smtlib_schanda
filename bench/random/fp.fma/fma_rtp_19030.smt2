...
(assert (= z ((_ to_fp 8 24) #xCAB8AFD7)))
;; z should be Float32(0xCAB8AFD7 [Rational(-12103639, 2), -6051819.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10010101 #b01110001010111111010110)))
(check-sat)
(exit)
