...
(assert (= z (fp #b0 #b10010101 #b11010101001001100110011)))
;; z should be Float32(0x4AEA9333 [Rational(15373107, 2), 7686553.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11010101001001100111011))))
(check-sat)
(exit)
