...
(assert (= z ((_ to_fp 8 24) #x002DE9CC)))
;; z should be Float32(0x002DE9CC [Rational(752243, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x002DE9CC)))
(check-sat)
(exit)
