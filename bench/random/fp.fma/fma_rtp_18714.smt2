...
(assert (= z (fp #b1 #b00000000 #b10100110110100010011000)))
;; z should be Float32(0x80536898 [Rational(-683283, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x80536897))))
(check-sat)
(exit)
