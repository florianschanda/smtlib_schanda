...
(assert (= z (fp #b1 #b10010101 #b00101110111110010100001)))
;; z should be Float32(0xCA977CA1 [Rational(-9927841, 2), -4963920.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010101 #b00101110111110010100000))))
(check-sat)
(exit)
