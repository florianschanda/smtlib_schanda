...
(assert (= y ((_ to_fp 8 24) #x0072D8C4)))
;; y should be Float32(0x0072D8C4 [Rational(1881649, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC065B187))))
(check-sat)
(exit)
