...
(assert (= x ((_ to_fp 8 24) #x80706BDB)))
;; x should be Float32(0x80706BDB [Rational(-7367643, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x4060D7B5))))
(check-sat)
(exit)
