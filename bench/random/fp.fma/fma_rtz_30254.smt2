...
(assert (= x ((_ to_fp 8 24) #x64896BC0)))
;; x should be Float32(0x64896BC0 [Rational(20279745150846362451968), 20279745150846362451968.000000])
...
(assert (not (= result (fp #b1 #b00110100 #b00010010110101110111111))))
(check-sat)
(exit)
