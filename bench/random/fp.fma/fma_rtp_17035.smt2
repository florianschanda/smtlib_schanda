...
(assert (= z (fp #b1 #b10010101 #b01000000101101100001111)))
;; z should be Float32(0xCAA05B0F [Rational(-10509071, 2), -5254535.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAA05B0F))))
(check-sat)
(exit)
