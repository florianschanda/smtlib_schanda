...
(assert (= y (fp #b0 #b10010101 #b11110001111000001011011)))
;; y should be Float32(0x4AF8F05B [Rational(16314459, 2), 8157229.500000])
...
(assert (= result (fp #b0 #b00010111 #b11110001111000001011011)))
(check-sat)
(exit)
