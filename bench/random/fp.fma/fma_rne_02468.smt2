...
(assert (= z (fp #b1 #b01100011 #b11110010101100111010010)))
;; z should be Float32(0xB1F959D2 [Rational(-8170729, 1125899906842624), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xB1F959D2))))
(check-sat)
(exit)
