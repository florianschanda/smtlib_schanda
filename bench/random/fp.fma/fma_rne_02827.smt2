...
(assert (= x (fp #b0 #b10111100 #b11001000101111000111101)))
;; x should be Float32(0x5E645E3D [Rational(4113914289666916352), 4113914289666916352.000000])
...
(assert (= result (fp #b1 #b00100111 #b11001000101111000111101)))
(check-sat)
(exit)
