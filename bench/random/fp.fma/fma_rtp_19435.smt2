...
(assert (= z ((_ to_fp 8 24) #x8176D0CF)))
;; z should be Float32(0x8176D0CF [Rational(-16175311, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x8176D0CE))))
(check-sat)
(exit)
