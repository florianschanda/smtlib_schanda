...
(assert (= z ((_ to_fp 8 24) #xCABC234B)))
;; z should be Float32(0xCABC234B [Rational(-12329803, 2), -6164901.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010101 #b01111000010001101001011))))
(check-sat)
(exit)
