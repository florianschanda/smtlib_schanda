...
(assert (= y ((_ to_fp 8 24) #xEE54A6C3)))
;; y should be Float32(0xEE54A6C3 [Rational(-16453106157411335648367869952), -16453106157411335648367869952.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xA3D4A6C3))))
(check-sat)
(exit)
