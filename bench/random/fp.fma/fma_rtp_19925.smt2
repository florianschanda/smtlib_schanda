...
(assert (= x (fp #b1 #b00000000 #b01000000010011011001010)))
;; x should be Float32(0x802026CA [Rational(-1053541, 356811923176489970264571492362373784095686656), -0.000000])
