...
(assert (= x (fp #b0 #b00000000 #b00110011000010010111010)))
;; x should be Float32(0x001984BA [Rational(836189, 356811923176489970264571492362373784095686656), 0.000000])
