...
(assert (= x (fp #b0 #b10010101 #b01101100101000101100111)))
;; x should be Float32(0x4AB65167 [Rational(11948391, 2), 5974195.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b01101100101000101100101))))
(check-sat)
(exit)
