...
(assert (= y (fp #b0 #b00000000 #b01101001010001100000110)))
;; y should be Float32(0x0034A306 [Rational(1724803, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBFD28C17))))
(check-sat)
(exit)
