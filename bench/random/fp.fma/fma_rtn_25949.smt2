...
(assert (= y (fp #b1 #b10100010 #b00001011001100010111100)))
;; y should be Float32(0xD10598BC [Rational(-35862069248), -35862069248.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x120598BB))))
(check-sat)
(exit)
