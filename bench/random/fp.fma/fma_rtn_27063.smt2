...
(assert (= x (fp #b1 #b00000000 #b01100110111000100011101)))
;; x should be Float32(0x8033711D [Rational(-3371293, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b01111101100100101011000)))
