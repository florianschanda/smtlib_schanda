...
(assert (= z (fp #b1 #b11100100 #b11110111100110111000110)))
;; z should be Float32(0xF27BCDC6 [Rational(-4987488146351502042911175868416), -4987488146351502042911175868416.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #xF27BCDC5)))
(check-sat)
(exit)
