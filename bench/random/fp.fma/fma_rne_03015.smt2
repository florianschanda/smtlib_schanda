...
(assert (= x (fp #b0 #b00000000 #b00101111101000000010110)))
;; x should be Float32(0x0017D016 [Rational(780299, 356811923176489970264571492362373784095686656), 0.000000])
