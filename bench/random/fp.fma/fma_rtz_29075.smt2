...
(assert (= y ((_ to_fp 8 24) #xCA5CF376)))
;; y should be Float32(0xCA5CF376 [Rational(-7240123, 2), -3620061.500000])
...
(assert (not (= result (fp #b1 #b00010110 #b10111001111001101110000))))
(check-sat)
(exit)
