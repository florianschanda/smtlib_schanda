...
(assert (= z ((_ to_fp 8 24) #x0046DB27)))
;; z should be Float32(0x0046DB27 [Rational(4643623, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b00000000 #b10001101101101100100111))))
(check-sat)
(exit)
