...
(assert (= y ((_ to_fp 8 24) #x007A4768)))
;; y should be Float32(0x007A4768 [Rational(1001709, 89202980794122492566142873090593446023921664), 0.000000])

(declare-const z Float32)
(assert (= z (fp #b0 #b11111111 #b00010111101111101110001)))
