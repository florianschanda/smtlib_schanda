...
(assert (= z ((_ to_fp 8 24) #xFC9D1090)))
;; z should be Float32(0xFC9D1090 [Rational(-6524212273592227347765476400295837696), -6524212273592227347765476400295837696.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b11111001 #b00111010001000010010000))))
(check-sat)
(exit)
