...
(assert (= x (fp #b0 #b00000000 #b00010101110100111100010)))
;; x should be Float32(0x000AE9E2 [Rational(357617, 356811923176489970264571492362373784095686656), 0.000000])
