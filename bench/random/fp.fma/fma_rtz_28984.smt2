...
(assert (= z (fp #b0 #b00000000 #b11011110011010011000110)))
;; z should be Float32(0x006F34C6 [Rational(3644003, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x006F34C6))))
(check-sat)
(exit)
