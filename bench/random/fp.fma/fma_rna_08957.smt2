...
(assert (= z (fp #b0 #b00000010 #b11010001001000100011100)))
;; z should be Float32(0x0168911C [Rational(3810375, 89202980794122492566142873090593446023921664), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x0168911C))))
(check-sat)
(exit)
