...
(assert (= x (fp #b0 #b11011110 #b01011010011110011011110)))
;; x should be Float32(0x6F2D3CDE [Rational(53614490613628771701106933760), 53614490613628771701106933760.000000])
