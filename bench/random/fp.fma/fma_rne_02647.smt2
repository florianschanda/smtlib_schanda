...
(assert (= x (fp #b0 #b11111001 #b11011000011110111111001)))
;; x should be Float32(0x7CEC3DF9 [Rational(9813112107300064992392949667744186368), 9813112107300064992392949667744186368.000000])
...
(assert (= result (fp #b0 #b01100100 #b11011000011110111111001)))
(check-sat)
(exit)
