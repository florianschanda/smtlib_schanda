...
(assert (= z ((_ to_fp 8 24) #x006EB7A2)))
;; z should be Float32(0x006EB7A2 [Rational(3627985, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x006EB7A2)))
(check-sat)
(exit)
