...
(assert (= y (fp #b1 #b10010101 #b01101010010000000001011)))
;; y should be Float32(0xCAB5200B [Rational(-11870219, 2), -5935109.500000])
...
(assert (= result (fp #b0 #b00010111 #b01101010010000000001011)))
(check-sat)
(exit)
