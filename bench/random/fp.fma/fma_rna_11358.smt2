...
(assert (= y ((_ to_fp 8 24) #x0036A6F7)))
;; y should be Float32(0x0036A6F7 [Rational(3581687, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b1 #b01111111 #b10110101001101111011011))))
(check-sat)
(exit)
