...
(assert (= x (fp #b0 #b00000000 #b01101010000110011001101)))
;; x should be Float32(0x00350CCD [Rational(3476685, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b11111010010000110100100)))
