...
(assert (= y (fp #b0 #b00000000 #b01111101010001111110010)))
;; y should be Float32(0x003EA3F2 [Rational(2052601, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result (fp #b1 #b01111111 #b11110101000111111001000))))
(check-sat)
(exit)
