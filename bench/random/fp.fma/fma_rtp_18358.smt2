...
(assert (= y (fp #b1 #b11100111 #b10011000011111111111001)))
;; y should be Float32(0xF3CC3FF9 [Rational(-32364687462115507302154257825792), -32364687462115507302154257825792.000000])
