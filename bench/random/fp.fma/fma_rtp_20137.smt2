...
(assert (= x (fp #b1 #b00000000 #b01100011110101011101111)))
;; x should be Float32(0x8031EAEF [Rational(-3271407, 713623846352979940529142984724747568191373312), -0.000000])
