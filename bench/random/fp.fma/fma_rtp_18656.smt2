...
(assert (= z (fp #b1 #b10111001 #b10111101111011011111010)))
;; z should be Float32(0xDCDEF6FA [Rational(-502071987456180224), -502071987456180224.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10111001 #b10111101111011011111001)))
(check-sat)
(exit)
