...
(assert (= x ((_ to_fp 8 24) #x033FCD2B)))
;; x should be Float32(0x033FCD2B [Rational(12569899, 22300745198530623141535718272648361505980416), 0.000000])
...
(assert (not (= result (fp #b0 #b10000110 #b01111111100110100101010))))
(check-sat)
(exit)
