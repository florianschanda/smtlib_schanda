...
(assert (= x (fp #b1 #b00000000 #b11010001111101001011111)))
;; x should be Float32(0x8068FA5F [Rational(-6879839, 713623846352979940529142984724747568191373312), -0.000000])
