...
(assert (= y ((_ to_fp 8 24) #xCAB94ADB)))
;; y should be Float32(0xCAB94ADB [Rational(-12143323, 2), -6071661.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b01110010100101011011011))))
(check-sat)
(exit)
