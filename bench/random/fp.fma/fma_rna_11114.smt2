...
(assert (= z (fp #b1 #b00000000 #b11010011111010011101110)))
;; z should be Float32(0x8069F4EE [Rational(-3471991, 356811923176489970264571492362373784095686656), -0.000000])
