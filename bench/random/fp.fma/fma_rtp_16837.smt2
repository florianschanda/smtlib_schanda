...
(assert (= x (fp #b0 #b00000000 #b11100000101101111101110)))
;; x should be Float32(0x00705BEE [Rational(3681783, 356811923176489970264571492362373784095686656), 0.000000])
