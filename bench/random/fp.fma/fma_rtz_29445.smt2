...
(assert (= y ((_ to_fp 8 24) #xC95C5B68)))
;; y should be Float32(0xC95C5B68 [Rational(-1805165, 2), -902582.500000])
...
(assert (not (= result (fp #b1 #b00010100 #b10111000101101101110111))))
(check-sat)
(exit)
