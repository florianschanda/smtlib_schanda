...
(assert (= x ((_ to_fp 8 24) #x80429DC4)))
;; x should be Float32(0x80429DC4 [Rational(-1091441, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (= result (fp #b1 #b10000000 #b00001010011101110000111)))
(check-sat)
(exit)
