...
(assert (= y (fp #b0 #b10010101 #b11111111100011011110101)))
;; y should be Float32(0x4AFFC6F5 [Rational(16762613, 2), 8381306.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b11111111110001101111010))))
(check-sat)
(exit)
