...
(assert (= y ((_ to_fp 8 24) #x80045454)))
;; y should be Float32(0x80045454 [Rational(-70933, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FFC30C1)))
