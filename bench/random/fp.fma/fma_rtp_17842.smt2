...
(assert (= y (fp #b0 #b00000000 #b00101101011011010111100)))
;; y should be Float32(0x0016B6BC [Rational(372143, 178405961588244985132285746181186892047843328), 0.000000])
