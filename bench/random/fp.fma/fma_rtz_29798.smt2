...
(assert (= y ((_ to_fp 8 24) #xCADE07D7)))
;; y should be Float32(0xCADE07D7 [Rational(-14550999, 2), -7275499.500000])
...
(assert (= result (fp #b0 #b00000000 #b00100001111110000010100)))
(check-sat)
(exit)
