...
(assert (= z ((_ to_fp 8 24) #x0023DE4C)))
;; z should be Float32(0x0023DE4C [Rational(587667, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x0023DE4C))))
(check-sat)
(exit)
