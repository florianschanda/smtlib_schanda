...
(assert (= y (fp #b1 #b00000000 #b01001100010011100000110)))
;; y should be Float32(0x80262706 [Rational(-1250179, 356811923176489970264571492362373784095686656), -0.000000])
