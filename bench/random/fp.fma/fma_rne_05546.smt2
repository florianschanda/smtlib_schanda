...
(assert (= z (fp #b1 #b01111101 #b00100000010000110011010)))
;; z should be Float32(0xBE90219A [Rational(-4722893, 16777216), -0.281506])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xBE90219A))))
(check-sat)
(exit)
