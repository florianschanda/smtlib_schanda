...
(assert (= x (fp #b0 #b00000000 #b00100011100101100101110)))
;; x should be Float32(0x0011CB2E [Rational(583063, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result (fp #b1 #b01111110 #b00011100101100101101111)))
(check-sat)
(exit)
