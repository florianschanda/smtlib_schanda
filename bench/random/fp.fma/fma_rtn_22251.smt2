...
(assert (= z ((_ to_fp 8 24) #x4A994D1B)))
;; z should be Float32(0x4A994D1B [Rational(10046747, 2), 5023373.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b00110010100110100010011)))
(check-sat)
(exit)
