...
(assert (= y (fp #b1 #b00000000 #b11100110001011111100110)))
;; y should be Float32(0x807317E6 [Rational(-3771379, 356811923176489970264571492362373784095686656), -0.000000])
