...
(assert (= y (fp #b1 #b01100001 #b01010100001010001001101)))
;; y should be Float32(0xB0AA144D [Rational(-11146317, 9007199254740992), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFD31596)))
