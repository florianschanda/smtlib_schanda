...
(assert (= z ((_ to_fp 8 24) #xA16A1C3A)))
;; z should be Float32(0xA16A1C3A [Rational(-7671325, 9671406556917033397649408), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b01000010 #b11010100001110000111010)))
(check-sat)
(exit)
