...
(assert (= y (fp #b0 #b00000000 #b00100110101101011011010)))
;; y should be Float32(0x00135ADA [Rational(634221, 356811923176489970264571492362373784095686656), 0.000000])
