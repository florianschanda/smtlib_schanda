...
(assert (= z ((_ to_fp 8 24) #x8062A7B5)))
;; z should be Float32(0x8062A7B5 [Rational(-6465461, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x8062A7B4)))
(check-sat)
(exit)
