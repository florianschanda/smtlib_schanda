...
(assert (= x ((_ to_fp 8 24) #x804223B6)))
;; x should be Float32(0x804223B6 [Rational(-2167259, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result (fp #b0 #b10000000 #b00001000100011101101011)))
(check-sat)
(exit)
