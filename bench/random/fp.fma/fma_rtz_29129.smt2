...
(assert (= z ((_ to_fp 8 24) #x4AE847E9)))
;; z should be Float32(0x4AE847E9 [Rational(15222761, 2), 7611380.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b10010101 #b11010000100011111101000)))
(check-sat)
(exit)
