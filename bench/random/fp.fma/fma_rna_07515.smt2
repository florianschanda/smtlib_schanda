...
(assert (= x ((_ to_fp 8 24) #x4AFFBCBB)))
;; x should be Float32(0x4AFFBCBB [Rational(16759995, 2), 8379997.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b11111111101111001011110))))
(check-sat)
(exit)
