...
(assert (= y (fp #b0 #b00000000 #b10011110110011101111110)))
;; y should be Float32(0x004F677E [Rational(2601919, 356811923176489970264571492362373784095686656), 0.000000])
