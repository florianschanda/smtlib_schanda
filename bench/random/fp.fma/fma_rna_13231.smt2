...
(assert (= x (fp #b1 #b00000000 #b11101111110110000100011)))
;; x should be Float32(0x8077EC23 [Rational(-7859235, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b0 #b10000000 #b11011111101100001000101)))
(check-sat)
(exit)
