...
(assert (= x ((_ to_fp 8 24) #xE05DAB2A)))
;; x should be Float32(0xE05DAB2A [Rational(-63891626731551850496), -63891626731551850496.000000])
...
(assert (not (= result (fp #b1 #b01000010 #b10111011010101100101001))))
(check-sat)
(exit)
