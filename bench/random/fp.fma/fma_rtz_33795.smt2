...
(assert (= x (fp #b1 #b00000000 #b10110010111100010100100)))
;; x should be Float32(0x805978A4 [Rational(-1465897, 178405961588244985132285746181186892047843328), -0.000000])
