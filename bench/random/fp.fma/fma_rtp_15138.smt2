...
(assert (= y ((_ to_fp 8 24) #x807E1A06)))
;; y should be Float32(0x807E1A06 [Rational(-4132099, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC07C340B))))
(check-sat)
(exit)
