...
(assert (= z (fp #b0 #b10010101 #b00000000101101111000001)))
;; z should be Float32(0x4A805BC1 [Rational(8412097, 2), 4206048.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010101 #b00000000101101110111001)))
(check-sat)
(exit)
