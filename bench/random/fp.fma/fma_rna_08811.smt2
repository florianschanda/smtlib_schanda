...
(assert (= y (fp #b0 #b01111001 #b11111000001101100111111)))
;; y should be Float32(0x3CFC1B3F [Rational(16522047, 536870912), 0.030775])
...
(assert (= result ((_ to_fp 8 24) #x807C0F92)))
(check-sat)
(exit)
