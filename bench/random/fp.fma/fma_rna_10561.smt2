...
(assert (= x (fp #b1 #b10010010 #b11001111101010100101000)))
;; x should be Float32(0xC967D528 [Rational(-1899173, 2), -949586.500000])
...
(assert (= result (fp #b1 #b00010100 #b11001111101010100100110)))
(check-sat)
(exit)
