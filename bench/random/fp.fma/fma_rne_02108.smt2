...
(assert (= z (fp #b1 #b00000000 #b10000011010011100100000)))
;; z should be Float32(0x8041A720 [Rational(-134457, 22300745198530623141535718272648361505980416), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b00000000 #b10000011010011100100000))))
(check-sat)
(exit)
