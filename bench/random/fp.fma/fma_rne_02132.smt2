...
(assert (= y (fp #b1 #b00000000 #b10110011111000000101100)))
;; y should be Float32(0x8059F02C [Rational(-1473547, 178405961588244985132285746181186892047843328), -0.000000])
