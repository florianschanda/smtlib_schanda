...
(assert (= y ((_ to_fp 8 24) #xFFD0FE4E)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x8012C2C8)))
;; z should be Float32(0x8012C2C8 [Rational(-153689, 89202980794122492566142873090593446023921664), -0.000000])
