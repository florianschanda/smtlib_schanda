...
(assert (= z ((_ to_fp 8 24) #xEB3B0066)))
;; z should be Float32(0xEB3B0066 [Rational(-226071009835831174044319744), -226071009835831174044319744.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b11010110 #b01110110000000001100101)))
(check-sat)
(exit)
