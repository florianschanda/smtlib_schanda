...
(assert (= x (fp #b0 #b00000000 #b01101000000011101110111)))
;; x should be Float32(0x00340777 [Rational(3409783, 713623846352979940529142984724747568191373312), 0.000000])
