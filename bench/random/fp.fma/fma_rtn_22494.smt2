...
(assert (= z ((_ to_fp 8 24) #x8C89B40D)))
;; z should be Float32(0x8C89B40D [Rational(-9024525, 42535295865117307932921825928971026432), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x8C89B40D))))
(check-sat)
(exit)
