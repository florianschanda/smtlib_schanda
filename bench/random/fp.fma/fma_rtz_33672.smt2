...
(assert (= x (fp #b1 #b00000000 #b11011110100011010001110)))
;; x should be Float32(0x806F468E [Rational(-3646279, 356811923176489970264571492362373784095686656), -0.000000])
