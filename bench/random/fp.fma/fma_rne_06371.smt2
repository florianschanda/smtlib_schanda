...
(assert (= x ((_ to_fp 8 24) #x802C182E)))
;; x should be Float32(0x802C182E [Rational(-1444887, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3FB060B7)))
(check-sat)
(exit)
