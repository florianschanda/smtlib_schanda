...
(assert (= z ((_ to_fp 8 24) #x4A750C42)))
;; z should be Float32(0x4A750C42 [Rational(8029729, 2), 4014864.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010100 #b11101010000110001000010))))
(check-sat)
(exit)
