...
(assert (= z (fp #b1 #b10010101 #b01010101110111001101111)))
;; z should be Float32(0xCAAAEE6F [Rational(-11202159, 2), -5601079.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010101 #b01010101110111001101111)))
(check-sat)
(exit)
