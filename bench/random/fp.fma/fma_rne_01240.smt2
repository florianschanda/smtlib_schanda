...
(assert (= y ((_ to_fp 8 24) #x007EBF1B)))
;; y should be Float32(0x007EBF1B [Rational(8306459, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x407D7E35))))
(check-sat)
(exit)
