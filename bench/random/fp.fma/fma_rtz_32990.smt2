...
(assert (= y (fp #b0 #b10001111 #b01111101011000100001101)))
;; y should be Float32(0x47BEB10D [Rational(12497165, 128), 97634.101562])
...
(assert (not (= result (fp #b0 #b00000000 #b11111101000001010011101))))
(check-sat)
(exit)
