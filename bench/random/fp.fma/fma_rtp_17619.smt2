...
(assert (= x (fp #b1 #b10010100 #b10011101010100011011010)))
;; x should be Float32(0xCA4EA8DA [Rational(-6771821, 2), -3385910.500000])
...
(assert (= result (fp #b0 #b00000001 #b01100111010101000110111)))
(check-sat)
(exit)
