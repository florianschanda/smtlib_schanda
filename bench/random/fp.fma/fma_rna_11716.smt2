...
(assert (= y (fp #b0 #b00000000 #b10011000000001111110010)))
;; y should be Float32(0x004C03F2 [Rational(2490873, 356811923176489970264571492362373784095686656), 0.000000])
