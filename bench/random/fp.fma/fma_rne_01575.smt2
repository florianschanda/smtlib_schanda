...
(assert (= z (fp #b1 #b11011010 #b00011100010111100000001)))
;; z should be Float32(0xED0E2F01 [Rational(-2750230976907460637485957120), -2750230976907460637485957120.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b11011010 #b00011100010111100000001)))
(check-sat)
(exit)
