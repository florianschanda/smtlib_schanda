...
(assert (= z ((_ to_fp 8 24) #xA9E740FD)))
;; z should be Float32(0xA9E740FD [Rational(-15155453, 147573952589676412928), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xA9E740FD))))
(check-sat)
(exit)
