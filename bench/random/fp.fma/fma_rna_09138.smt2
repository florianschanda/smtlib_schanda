...
(assert (= z (fp #b1 #b00000000 #b10101110111100000010111)))
;; z should be Float32(0x80577817 [Rational(-5732375, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b00000000 #b10101110111100000010111))))
(check-sat)
(exit)
