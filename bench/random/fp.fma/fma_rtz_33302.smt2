...
(assert (= x ((_ to_fp 8 24) #xEAF164C2)))
;; x should be Float32(0xEAF164C2 [Rational(-145913468921881447639285760), -145913468921881447639285760.000000])
...
(assert (not (= result (fp #b1 #b01010111 #b11100010110010011000000))))
(check-sat)
(exit)
