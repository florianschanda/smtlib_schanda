...
(assert (= x ((_ to_fp 8 24) #xCA22132A)))
;; x should be Float32(0xCA22132A [Rational(-5310869, 2), -2655434.500000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x4AC5B281)))
;; y should be Float32(0x4AC5B281 [Rational(12956289, 2), 6478144.500000])
