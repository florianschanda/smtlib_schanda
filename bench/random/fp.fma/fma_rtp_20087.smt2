...
(assert (= x (fp #b1 #b00000000 #b10011000101000011111011)))
;; x should be Float32(0x804C50FB [Rational(-5001467, 713623846352979940529142984724747568191373312), -0.000000])
