...
(assert (= z ((_ to_fp 8 24) #xDD5759EA)))
;; z should be Float32(0xDD5759EA [Rational(-969855704800165888), -969855704800165888.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #xDD5759EA))))
(check-sat)
(exit)
