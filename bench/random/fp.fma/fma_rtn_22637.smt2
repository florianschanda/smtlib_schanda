...
(assert (= z (fp #b0 #b00110110 #b10111001100101001010001)))
;; z should be Float32(0x1B5CCA51 [Rational(14469713, 79228162514264337593543950336), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x1B5CCA50))))
(check-sat)
(exit)
