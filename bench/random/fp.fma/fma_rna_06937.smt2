...
(assert (= z (fp #b0 #b10010100 #b10010001000111100101110)))
;; z should be Float32(0x4A488F2E [Rational(6571927, 2), 3285963.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010100 #b10010001000111100101110))))
(check-sat)
(exit)
