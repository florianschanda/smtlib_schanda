...
(assert (= x (fp #b1 #b11111111 #b01110111110000001111110)))
...
(assert (= z ((_ to_fp 8 24) #x7F5DD3C9)))
;; z should be Float32(0x7F5DD3C9 [Rational(294859038469947590527116508444930080768), 294859038469947590527116508444930080768.000000])
