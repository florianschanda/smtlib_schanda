...
(assert (= y ((_ to_fp 8 24) #x56DA72E9)))
;; y should be Float32(0x56DA72E9 [Rational(120093535109120), 120093535109120.000000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b01111111000101010110011)))
