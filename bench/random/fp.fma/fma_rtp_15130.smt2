...
(assert (= y ((_ to_fp 8 24) #x807847E5)))
;; y should be Float32(0x807847E5 [Rational(-7882725, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC0708FC9))))
(check-sat)
(exit)
