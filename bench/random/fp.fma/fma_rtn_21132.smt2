...
(assert (= x ((_ to_fp 8 24) #x4A7140FA)))
;; x should be Float32(0x4A7140FA [Rational(7905405, 2), 3952702.500000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xCA242A4E)))
;; y should be Float32(0xCA242A4E [Rational(-5379367, 2), -2689683.500000])
