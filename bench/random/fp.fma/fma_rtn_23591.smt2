...
(assert (= x (fp #b0 #b00000000 #b10100000001100110100001)))
;; x should be Float32(0x005019A1 [Rational(5249441, 713623846352979940529142984724747568191373312), 0.000000])
