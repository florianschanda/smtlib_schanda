...
(assert (= z (fp #b0 #b10001000 #b01101010010010001100011)))
;; z should be Float32(0x44352463 [Rational(11871331, 16384), 724.568542])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10001000 #b01101010010010001100011)))
(check-sat)
(exit)
