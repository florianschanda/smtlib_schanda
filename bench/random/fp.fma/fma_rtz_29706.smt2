...
(assert (= z (fp #b0 #b00000000 #b00111100111011001010110)))
;; z should be Float32(0x001E7656 [Rational(998187, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x001E7656)))
(check-sat)
(exit)
