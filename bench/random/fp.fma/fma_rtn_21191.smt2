...
(assert (= x (fp #b0 #b10010101 #b00111010101101000110011)))
;; x should be Float32(0x4A9D5A33 [Rational(10312243, 2), 5156121.500000])
...
(assert (= result (fp #b1 #b00010111 #b00111010101101000110000)))
(check-sat)
(exit)
