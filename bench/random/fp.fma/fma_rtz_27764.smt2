...
(assert (= y (fp #b1 #b00000000 #b00000111101111001111101)))
;; y should be Float32(0x8003DE7D [Rational(-253565, 713623846352979940529142984724747568191373312), -0.000000])
