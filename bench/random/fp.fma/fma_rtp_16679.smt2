...
(assert (= x (fp #b0 #b00000000 #b01110100101100011110101)))
;; x should be Float32(0x003A58F5 [Rational(3823861, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result (fp #b0 #b01111111 #b11010010110001111010100)))
(check-sat)
(exit)
