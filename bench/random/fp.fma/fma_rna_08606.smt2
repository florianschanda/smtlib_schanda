...
(assert (= z (fp #b1 #b00000000 #b00101011010010000101111)))
;; z should be Float32(0x8015A42F [Rational(-1418287, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00101011010010000101111))))
(check-sat)
(exit)
