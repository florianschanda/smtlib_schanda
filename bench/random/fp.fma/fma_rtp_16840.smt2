...
(assert (= x (fp #b0 #b00000000 #b01100000000011001111011)))
;; x should be Float32(0x0030067B [Rational(3147387, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b1 #b01111111 #b10000000001100111101011))))
(check-sat)
(exit)
