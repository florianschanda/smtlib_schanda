...
(assert (= z (fp #b1 #b10010101 #b00010010101101101111101)))
;; z should be Float32(0xCA895B7D [Rational(-9001853, 2), -4500926.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010101 #b00010010101101101111101))))
(check-sat)
(exit)
