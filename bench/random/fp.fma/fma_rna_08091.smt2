...
(assert (= y (fp #b0 #b01111110 #b11011001110101011111100)))
;; y should be Float32(0x3F6CEAFC [Rational(3881663, 4194304), 0.925461])
...
(assert (not (= result ((_ to_fp 8 24) #x7F6CEAFB))))
(check-sat)
(exit)
