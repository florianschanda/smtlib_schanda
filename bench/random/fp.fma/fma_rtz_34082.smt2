...
(assert (= x ((_ to_fp 8 24) #x7FC78D90)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b10111000 #b10010011100000100011000)))
;; y should be Float32(0x5C49C118 [Rational(227155116568870912), 227155116568870912.000000])
