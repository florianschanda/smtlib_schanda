...
(assert (= y ((_ to_fp 8 24) #xCA0BCCE2)))
;; y should be Float32(0xCA0BCCE2 [Rational(-4580977, 2), -2290488.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b01000101111001100111001))))
(check-sat)
(exit)
