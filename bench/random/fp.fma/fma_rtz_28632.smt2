...
(assert (= z (fp #b1 #b00000000 #b11000110000110000110110)))
;; z should be Float32(0x80630C36 [Rational(-3245595, 356811923176489970264571492362373784095686656), -0.000000])
