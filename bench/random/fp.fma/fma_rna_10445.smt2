...
(assert (= y (fp #b1 #b00000000 #b00101011001010001010010)))
;; y should be Float32(0x80159452 [Rational(-707113, 356811923176489970264571492362373784095686656), -0.000000])
