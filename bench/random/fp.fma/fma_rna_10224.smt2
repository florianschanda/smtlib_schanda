...
(assert (= z ((_ to_fp 8 24) #x4AAFF05F)))
;; z should be Float32(0x4AAFF05F [Rational(11530335, 2), 5765167.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010101 #b01011111111000001011111))))
(check-sat)
(exit)
