...
(assert (= y ((_ to_fp 8 24) #x006ACA99)))
;; y should be Float32(0x006ACA99 [Rational(6998681, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result (fp #b0 #b10000000 #b10101011001010100110001)))
(check-sat)
(exit)
