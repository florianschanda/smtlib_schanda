...
(assert (= x ((_ to_fp 8 24) #x003722D2)))
;; x should be Float32(0x003722D2 [Rational(1806697, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= z (fp #b1 #b11111111 #b11011010111001011001000)))
