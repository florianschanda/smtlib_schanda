...
(assert (= z (fp #b1 #b10010101 #b01111001000001011010011)))
;; z should be Float32(0xCABC82D3 [Rational(-12354259, 2), -6177129.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010101 #b01111001000001011010011))))
(check-sat)
(exit)
