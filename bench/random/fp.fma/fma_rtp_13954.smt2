...
(assert (= z ((_ to_fp 8 24) #x6071103F)))
;; z should be Float32(0x6071103F [Rational(69481812128002211840), 69481812128002211840.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x6071103F))))
(check-sat)
(exit)
