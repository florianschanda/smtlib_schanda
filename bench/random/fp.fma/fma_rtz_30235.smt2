...
(assert (= x (fp #b0 #b10111110 #b11100001111110111000101)))
;; x should be Float32(0x5F70FDC5 [Rational(17365252342001172480), 17365252342001172480.000000])
...
(assert (not (= result (fp #b1 #b01000000 #b11100001111110111000100))))
(check-sat)
(exit)
