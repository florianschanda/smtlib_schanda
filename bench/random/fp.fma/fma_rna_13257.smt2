...
(assert (= x (fp #b1 #b00000000 #b10100101001001110010111)))
;; x should be Float32(0x80529397 [Rational(-5411735, 713623846352979940529142984724747568191373312), -0.000000])
