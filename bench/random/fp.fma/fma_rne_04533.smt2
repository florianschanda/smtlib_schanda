...
(assert (= y ((_ to_fp 8 24) #xCA521E02)))
;; y should be Float32(0xCA521E02 [Rational(-6885121, 2), -3442560.500000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xCAA5FC8F)))
;; z should be Float32(0xCAA5FC8F [Rational(-10878095, 2), -5439047.500000])
