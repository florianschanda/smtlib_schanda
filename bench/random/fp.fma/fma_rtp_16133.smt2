...
(assert (= z (fp #b0 #b10001101 #b10101010101101100000000)))
;; z should be Float32(0x46D55B00 [Rational(54619, 2), 27309.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10001101 #b10101010101101100000000))))
(check-sat)
(exit)
