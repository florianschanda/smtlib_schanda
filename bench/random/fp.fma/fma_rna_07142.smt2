...
(assert (= z ((_ to_fp 8 24) #xDE7E3F52)))
;; z should be Float32(0xDE7E3F52 [Rational(-4580112992279986176), -4580112992279986176.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #xDE7E3F52)))
(check-sat)
(exit)
