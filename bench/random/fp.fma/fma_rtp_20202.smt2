...
(assert (= x ((_ to_fp 8 24) #x803B1794)))
;; x should be Float32(0x803B1794 [Rational(-968165, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7FEDC968)))
