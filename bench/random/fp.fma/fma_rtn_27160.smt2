...
(assert (= x ((_ to_fp 8 24) #x7FA61871)))
...
(assert (= z ((_ to_fp 8 24) #x00751877)))
;; z should be Float32(0x00751877 [Rational(7673975, 713623846352979940529142984724747568191373312), 0.000000])
