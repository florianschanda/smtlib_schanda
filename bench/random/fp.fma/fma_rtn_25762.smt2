...
(assert (= z ((_ to_fp 8 24) #x9DFC6D40)))
;; z should be Float32(0x9DFC6D40 [Rational(-258485, 38685626227668133590597632), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b00111011 #b11111000110110101000001))))
(check-sat)
(exit)
