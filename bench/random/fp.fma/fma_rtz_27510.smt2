...
(assert (= z ((_ to_fp 8 24) #xA49D3529)))
;; z should be Float32(0xA49D3529 [Rational(-10302761, 151115727451828646838272), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xA49D3529))))
(check-sat)
(exit)
