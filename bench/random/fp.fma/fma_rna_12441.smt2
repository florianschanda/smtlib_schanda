...
(assert (= y (fp #b0 #b00000000 #b10100100000110001000001)))
;; y should be Float32(0x00520C41 [Rational(5377089, 713623846352979940529142984724747568191373312), 0.000000])
