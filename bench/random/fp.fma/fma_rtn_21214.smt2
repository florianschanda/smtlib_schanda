...
(assert (= x (fp #b0 #b10010101 #b01111100111111001110111)))
;; x should be Float32(0x4ABE7E77 [Rational(12484215, 2), 6242107.500000])
...
(assert (= result (fp #b1 #b00010111 #b01111100111111001110111)))
(check-sat)
(exit)
