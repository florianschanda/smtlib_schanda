...
(assert (= y (fp #b1 #b00000001 #b11100011001010100110010)))
;; y should be Float32(0x80F19532 [Rational(-7916185, 356811923176489970264571492362373784095686656), -0.000000])
