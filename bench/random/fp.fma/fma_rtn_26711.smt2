...
(assert (= x ((_ to_fp 8 24) #x8F7CA503)))
;; x should be Float32(0x8F7CA503 [Rational(-16557315, 1329227995784915872903807060280344576), -0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b00110011010000110000001)))
