...
(assert (= y (fp #b1 #b00000000 #b10101110010000001000110)))
;; y should be Float32(0x80572046 [Rational(-2854947, 356811923176489970264571492362373784095686656), -0.000000])
