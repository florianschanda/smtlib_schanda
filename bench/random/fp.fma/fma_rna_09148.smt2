...
(assert (= z (fp #b0 #b00000000 #b01111101011001110111001)))
;; z should be Float32(0x003EB3B9 [Rational(4109241, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b00000000 #b01111101011001110111001))))
(check-sat)
(exit)
