...
(assert (= y (fp #b0 #b00000000 #b00011001011000111000000)))
;; y should be Float32(0x000CB1C0 [Rational(12999, 11150372599265311570767859136324180752990208), 0.000000])
...
(assert (not (= result (fp #b1 #b01111101 #b10010110001101111111111))))
(check-sat)
(exit)
