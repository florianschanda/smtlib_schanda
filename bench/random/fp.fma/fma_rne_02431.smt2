...
(assert (= z (fp #b1 #b00000000 #b01100110111101000011101)))
;; z should be Float32(0x80337A1D [Rational(-3373597, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x80337A1D))))
(check-sat)
(exit)
