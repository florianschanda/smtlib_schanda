...
(assert (= z (fp #b1 #b10010101 #b11100101101111010011001)))
;; z should be Float32(0xCAF2DE99 [Rational(-15916697, 2), -7958348.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #xCAF2DE99)))
(check-sat)
(exit)
