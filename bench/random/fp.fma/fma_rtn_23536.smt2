...
(assert (= x ((_ to_fp 8 24) #x00531004)))
;; x should be Float32(0x00531004 [Rational(1360897, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (= result (fp #b0 #b10000000 #b01001100010000000000111)))
(check-sat)
(exit)
