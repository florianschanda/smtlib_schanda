...
(assert (= z (fp #b0 #b10110001 #b00001101101001010111100)))
;; z should be Float32(0x5886D2BC [Rational(1185917242966016), 1185917242966016.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10110001 #b00001101101001010111011))))
(check-sat)
(exit)
