...
(assert (= y (fp #b0 #b10001110 #b11110011111001100110000)))
;; y should be Float32(0x4779F330 [Rational(1023795, 16), 63987.187500])
...
(assert (not (= result ((_ to_fp 8 24) #x8879F22E))))
(check-sat)
(exit)
