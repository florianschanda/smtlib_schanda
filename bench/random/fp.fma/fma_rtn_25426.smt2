...
(assert (= y (fp #b0 #b00000000 #b01011011111100111101110)))
;; y should be Float32(0x002DF9EE [Rational(1506551, 356811923176489970264571492362373784095686656), 0.000000])
