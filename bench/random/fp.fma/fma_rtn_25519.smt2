...
(assert (= z ((_ to_fp 8 24) #x4AEB1795)))
;; z should be Float32(0x4AEB1795 [Rational(15406997, 2), 7703498.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11010110001011110010101))))
(check-sat)
(exit)
