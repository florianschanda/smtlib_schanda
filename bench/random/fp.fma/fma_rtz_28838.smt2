...
(assert (= y (fp #b1 #b00100001 #b01101100011011000001110)))
;; y should be Float32(0x90B6360E [Rational(-5970695, 83076749736557242056487941267521536), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xD0B6360D)))
(check-sat)
(exit)
