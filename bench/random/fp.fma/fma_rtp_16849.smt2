...
(assert (= x (fp #b0 #b00000000 #b01111100100010101111000)))
;; x should be Float32(0x003E4578 [Rational(510127, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (= result (fp #b1 #b01111111 #b11110010001010111011111)))
(check-sat)
(exit)
