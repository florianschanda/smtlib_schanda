...
(assert (= y (fp #b1 #b00000000 #b00001111000011011010100)))
;; y should be Float32(0x800786D4 [Rational(-123317, 178405961588244985132285746181186892047843328), -0.000000])
