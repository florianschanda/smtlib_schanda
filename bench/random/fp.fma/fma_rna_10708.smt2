...
(assert (= x ((_ to_fp 8 24) #xCAEDC2E1)))
;; x should be Float32(0xCAEDC2E1 [Rational(-15581921, 2), -7790960.500000])
...
(assert (= z (fp #b1 #b10010101 #b00100001000000000111101)))
;; z should be Float32(0xCA90803D [Rational(-9470013, 2), -4735006.500000])
