...
(assert (= x ((_ to_fp 8 24) #xF0BE9C38)))
;; x should be Float32(0xF0BE9C38 [Rational(-471928069971507887272756248576), -471928069971507887272756248576.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b01101001101110111010011)))
