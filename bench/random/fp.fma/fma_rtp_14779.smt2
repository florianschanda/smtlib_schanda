...
(assert (= y (fp #b1 #b00000000 #b00011001001000011010010)))
;; y should be Float32(0x800C90D2 [Rational(-411753, 356811923176489970264571492362373784095686656), -0.000000])
