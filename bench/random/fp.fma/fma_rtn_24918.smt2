...
(assert (= z ((_ to_fp 8 24) #x0026884D)))
;; z should be Float32(0x0026884D [Rational(2525261, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x0026884D)))
(check-sat)
(exit)
