...
(assert (= x (fp #b1 #b11111111 #b01110000010010100110110)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x255464D2)))
;; y should be Float32(0x255464D2 [Rational(6959721, 37778931862957161709568), 0.000000])
