...
(assert (= x ((_ to_fp 8 24) #x4A38B90E)))
;; x should be Float32(0x4A38B90E [Rational(6052999, 2), 3026499.500000])

(declare-const y Float32)
(assert (= y (fp #b1 #b10010100 #b10010011100110001101110)))
;; y should be Float32(0xCA49CC6E [Rational(-6612535, 2), -3306267.500000])
