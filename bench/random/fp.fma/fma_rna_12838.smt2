...
(assert (= x ((_ to_fp 8 24) #xCD13C579)))
;; x should be Float32(0xCD13C579 [Rational(-154949520), -154949520.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xC6551A00)))
;; y should be Float32(0xC6551A00 [Rational(-27277, 2), -13638.500000])
