...
(assert (= z ((_ to_fp 8 24) #xF515E305)))
;; z should be Float32(0xF515E305 [Rational(-190004085703742875282951158890496), -190004085703742875282951158890496.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b11101010 #b00101011110001100000101)))
(check-sat)
(exit)
