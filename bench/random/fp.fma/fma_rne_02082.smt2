...
(assert (= z (fp #b1 #b10010001 #b00101011111001110010000)))
;; z should be Float32(0xC895F390 [Rational(-614201, 2), -307100.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xC895F390))))
(check-sat)
(exit)
