...
(assert (= y (fp #b0 #b10010100 #b01000010101110111110010)))
;; y should be Float32(0x4A215DF2 [Rational(5287673, 2), 2643836.500000])
...
(assert (not (= result (fp #b0 #b00000001 #b01010000101011101111100))))
(check-sat)
(exit)
