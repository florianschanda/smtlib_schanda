...
(assert (= z (fp #b1 #b11000011 #b00100101010010000010111)))
;; z should be Float32(0xE192A417 [Rational(-338131069263534882816), -338131069263534882816.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b11000011 #b00100101010010000010111)))
(check-sat)
(exit)
