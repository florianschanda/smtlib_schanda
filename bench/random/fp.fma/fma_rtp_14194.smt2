...
(assert (= x (fp #b0 #b10010101 #b01000010010011100010111)))
;; x should be Float32(0x4AA12717 [Rational(10561303, 2), 5280651.500000])
...
(assert (= result ((_ to_fp 8 24) #x0050938C)))
(check-sat)
(exit)
