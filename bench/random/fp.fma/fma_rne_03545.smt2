...
(assert (= z (fp #b1 #b10010101 #b11100011011101010000101)))
;; z should be Float32(0xCAF1BA85 [Rational(-15841925, 2), -7920962.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #xCAF1BA85)))
(check-sat)
(exit)
