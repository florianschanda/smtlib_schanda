...
(assert (= y ((_ to_fp 8 24) #x80643020)))
;; y should be Float32(0x80643020 [Rational(-205185, 22300745198530623141535718272648361505980416), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x4048603F)))
(check-sat)
(exit)
