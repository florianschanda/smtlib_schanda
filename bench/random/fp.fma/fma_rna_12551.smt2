...
(assert (= z (fp #b1 #b10010101 #b10101010011100101000111)))
;; z should be Float32(0xCAD53947 [Rational(-13973831, 2), -6986915.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #xCAD53947)))
(check-sat)
(exit)
