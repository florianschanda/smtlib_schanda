...
(assert (= x (fp #b1 #b00000000 #b11101111100011110011010)))
;; x should be Float32(0x8077C79A [Rational(-3924941, 356811923176489970264571492362373784095686656), -0.000000])
