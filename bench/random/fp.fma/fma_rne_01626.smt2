...
(assert (= z (fp #b1 #b10010001 #b00111100000111101110000)))
;; z should be Float32(0xC89E0F70 [Rational(-647415, 2), -323707.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010001 #b00111100000111101110000))))
(check-sat)
(exit)
