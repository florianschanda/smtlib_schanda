...
(assert (= z (fp #b1 #b00000000 #b11110101110011111011000)))
;; z should be Float32(0x807AE7D8 [Rational(-1006843, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x807AE7D8))))
(check-sat)
(exit)
