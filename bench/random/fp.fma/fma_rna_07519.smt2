...
(assert (= x (fp #b0 #b10001110 #b10000110000111110000000)))
;; x should be Float32(0x47430F80 [Rational(99871, 2), 49935.500000])
...
(assert (not (= result (fp #b1 #b00000001 #b00000001100001100001111))))
(check-sat)
(exit)
