...
(assert (= x (fp #b0 #b11111111 #b01000000001101010100101)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x0013A9CA)))
;; y should be Float32(0x0013A9CA [Rational(644325, 356811923176489970264571492362373784095686656), 0.000000])
