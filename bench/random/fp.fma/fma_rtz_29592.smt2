...
(assert (= y ((_ to_fp 8 24) #x7FD5BBF0)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x001C5AAB)))
;; z should be Float32(0x001C5AAB [Rational(1858219, 713623846352979940529142984724747568191373312), 0.000000])
