...
(assert (= z (fp #b0 #b00000000 #b00110000101110001110101)))
;; z should be Float32(0x00185C75 [Rational(1596533, 713623846352979940529142984724747568191373312), 0.000000])
