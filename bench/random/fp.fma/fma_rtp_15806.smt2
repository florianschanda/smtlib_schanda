...
(assert (= z (fp #b1 #b11010001 #b01111100111101110111001)))
;; z should be Float32(0xE8BE7BB9 [Rational(-7196255295369567056953344), -7196255295369567056953344.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xE8BE7BB9))))
(check-sat)
(exit)
