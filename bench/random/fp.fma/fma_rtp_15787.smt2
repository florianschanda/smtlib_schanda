...
(assert (= z (fp #b1 #b01001111 #b10101100101101101111011)))
;; z should be Float32(0xA7D65B7B [Rational(-14048123, 2361183241434822606848), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b01001111 #b10101100101101101111011)))
(check-sat)
(exit)
