...
(assert (= x (fp #b0 #b00000000 #b11111011111100001110111)))
;; x should be Float32(0x007DF877 [Rational(8255607, 713623846352979940529142984724747568191373312), 0.000000])
