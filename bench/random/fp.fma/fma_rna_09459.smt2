...
(assert (= x ((_ to_fp 8 24) #x2E5CE87E)))
;; x should be Float32(0x2E5CE87E [Rational(7238719, 144115188075855872), 0.000000])
...
(assert (not (= result (fp #b0 #b11011100 #b10111001110100001111101))))
(check-sat)
(exit)
