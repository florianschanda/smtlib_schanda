...
(assert (= x (fp #b0 #b00000000 #b01001010100101000100110)))
;; x should be Float32(0x00254A26 [Rational(1221907, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result (fp #b0 #b01111111 #b00101010010100010010111)))
(check-sat)
(exit)
