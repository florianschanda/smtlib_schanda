...
(assert (= x (fp #b1 #b00000000 #b10100001110001101100000)))
;; x should be Float32(0x8050E360 [Rational(-165659, 22300745198530623141535718272648361505980416), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC021C6BF))))
(check-sat)
(exit)
