...
(assert (= z (fp #b0 #b00000000 #b11000000011111111110000)))
;; z should be Float32(0x00603FF0 [Rational(394239, 44601490397061246283071436545296723011960832), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b00000000 #b11000000011111111110000))))
(check-sat)
(exit)
