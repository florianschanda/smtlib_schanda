...
(assert (= x (fp #b1 #b00000000 #b01110111000110011111101)))
;; x should be Float32(0x803B8CFD [Rational(-3902717, 713623846352979940529142984724747568191373312), -0.000000])
