...
(assert (= y (fp #b0 #b10010101 #b11111001000110000001111)))
;; y should be Float32(0x4AFC8C0F [Rational(16550927, 2), 8275463.500000])
...
(assert (= result (fp #b1 #b00000000 #b11111100100011000000111)))
(check-sat)
(exit)
