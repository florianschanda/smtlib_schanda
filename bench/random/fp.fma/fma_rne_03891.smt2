...
(assert (= x (fp #b1 #b10010101 #b00111100010101101100001)))
;; x should be Float32(0xCA9E2B61 [Rational(-10365793, 2), -5182896.500000])
...
(assert (= result ((_ to_fp 8 24) #x0B9E2B5F)))
(check-sat)
(exit)
