...
(assert (= x (fp #b0 #b00000000 #b01001011011111100011010)))
;; x should be Float32(0x0025BF1A [Rational(1236877, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b00011101111001111100001)))
